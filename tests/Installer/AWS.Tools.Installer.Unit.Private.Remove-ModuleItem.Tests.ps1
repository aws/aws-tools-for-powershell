...
InModuleScope AWS.Tools.Installer {
    Describe -Skip:$SkipInstallerTests -Tag "Smoke", "Low", "Medium", "High" "Installer - Remove-ModuleItem Unit Tests" {
        BeforeAll {
        ...
        Context "Parameter Validation" {
            It "Should accept a single module object" {
                ...
                # Act & Assert
                { Remove-ModuleItem -Module $mockModule -WarningAction SilentlyContinue } | Should -Not -Throw
            }
            ...
            It "Should accept multiple module objects" {
                ...
                # Act
                $result = Remove-ModuleItem -Module $mockModules  -WarningAction SilentlyContinue
            ...
            It "Should accept module objects via pipeline" {
                ...
                # Act
                $result = $mockModules | Remove-ModuleItem  -WarningAction SilentlyContinue
            ...
            It "Should accept custom Reason parameter" {
                ...
                # Act
                Remove-ModuleItem -Module $mockModule -Reason $customReason -WarningAction SilentlyContinue
        ...
        Context "Module Removal Functionality" {
            It "Should call Remove-Item with correct parameters" {
                ...
                # Act
                Remove-ModuleItem -Module $mockModule -WarningAction SilentlyContinue
            ...
            It "Should handle failed removal" {
                ...
                # Act
                $result = Remove-ModuleItem -Module $mockModule -ErrorAction SilentlyContinue -WarningAction SilentlyContinue
        ...
        Context "Error Handling" {
                ...
                It "Should handle invalid module objects" {
                    ...
                    # Act
                    $result = Remove-ModuleItem -Module $invalidModule -ErrorAction SilentlyContinue -WarningAction SilentlyContinue
