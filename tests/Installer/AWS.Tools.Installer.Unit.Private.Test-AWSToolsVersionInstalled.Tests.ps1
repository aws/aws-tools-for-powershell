...
Describe -Skip:$SkipInstallerTests -Tag "Smoke", "Low", "Medium", "High" "Installer - Test-AWSToolsVersionInstalled Unit Tests" {
    ...
    Context "Version Checking" {
        ...
        It "Should check version via web request" {
            InModuleScope AWS.Tools.Installer {
                ...
                Mock Get-InstalledAWSToolsModule { @([PSCustomObject]@{ Name = "AWS.Tools.Common"; Version = [Version]"4.1.853" }) }
                ...
                Should -Invoke Get-InstalledAWSToolsModule -Times 1
            }
        }
