...
Describe -Tag "Smoke" "Common.FileSize" {
    ...
    Context "FileSize" {
        ...
        It "FileSize without a suffix" {
            ...
            $filesize.FileSizeInBytes | Should -Be 345678
        }
        ...
        It "FileSize with a suffix" {
            ...
            $filesize | Should -Not -Be $null
            $filesize.FileSizeInBytes | Should -Be 15360
        }
        ...
        It "FileSize with space between value and suffix" {
            ...
            $filesize | Should -Not -Be $null
            $filesize.FileSizeInBytes | Should -Be 15728640
        }
        ...
        It "FileSize with double value" {
            ...
            $filesize | Should -Not -Be $null
            $filesize.FileSizeInBytes | Should -Be 16642998272
        }
        ...
        It "FileSize with missing value" {
            { New-Object -TypeName "Amazon.PowerShell.Common.FileSize" ("") } | Should -Throw 'Exception calling ".ctor" with "1" argument(s): "Missing value for argument. (Parameter ''rawString'')"'
        }
