...
$projectNameList = @('ACMPCA', 'AlexaForBusiness', 'Amplify', 'APIGateway', 'ApiGatewayManagementApi', 'ApiGatewayV2', 'ApplicationAutoScaling', 'ApplicationDiscoveryService', 'ApplicationInsights', 'AppMesh', 'AppStream', 'AppSync', 'Athena', 'AutoScaling', 'AutoScalingPlans', 'AWSHealth', 'AWSMarketplaceCommerceAnalytics', 'AWSMarketplaceMetering', 'AWSSupport', 'Backup', 'Batch', 'Budgets', 'CertificateManager', 'Chime', 'Cloud9', 'CloudDirectory', 'CloudFormation', 'CloudFront', 'CloudHSMV2', 'CloudSearch', 'CloudSearchDomain', 'CloudTrail', 'CloudWatch', 'CloudWatchLogs', 'CodeBuild', 'CodeCommit', 'CodeDeploy', 'CodePipeline', 'CodeStar', 'CognitoIdentity', 'CognitoIdentityProvider', 'CognitoSync', 'Comprehend', 'ComprehendMedical', 'ConfigService', 'Connect', 'CostAndUsageReport', 'CostExplorer', 'DatabaseMigrationService', 'DataPipeline', 'DataSync', 'DAX', 'DeviceFarm', 'DirectConnect', 'DirectoryService', 'DLM', 'DocDB', 'DynamoDBv2', 'EC2', 'ECR', 'ECS', 'EKS', 'ElastiCache', 'ElasticBeanstalk', 'ElasticFileSystem', 'ElasticLoadBalancing', 'ElasticLoadBalancingV2', 'ElasticMapReduce', 'Elasticsearch', 'ElasticTranscoder', 'EventBridge', 'FMS', 'ForecastQueryService', 'ForecastService', 'FSx', 'GameLift', 'Glacier', 'GlobalAccelerator', 'Glue', 'Greengrass', 'GroundStation', 'GuardDuty', 'IdentityManagement', 'ImportExport', 'Inspector', 'IoT', 'IoTEvents', 'IoTEventsData', 'IoTJobsDataPlane', 'IoTThingsGraph', 'Kafka', 'KeyManagementService', 'Kinesis', 'KinesisAnalyticsV2', 'KinesisFirehose', 'KinesisVideo', 'KinesisVideoMedia', 'LakeFormation', 'Lambda', 'Lex', 'LexModelBuildingService', 'LicenseManager', 'Lightsail', 'MachineLearning', 'Macie', 'ManagedBlockchain', 'MarketplaceEntitlementService', 'MediaConnect', 'MediaConvert', 'MediaLive', 'MediaPackage', 'MediaPackageVod', 'MediaStore', 'MediaStoreData', 'MediaTailor', 'MigrationHub', 'Mobile', 'MQ', 'MTurk', 'Neptune', 'OpsWorks', 'OpsWorksCM', 'Organizations', 'Personalize', 'PersonalizeEvents', 'PersonalizeRuntime', 'PI', 'Pinpoint', 'PinpointEmail', 'Polly', 'Pricing', 'QLDB', 'QLDBSession', 'QuickSight', 'RAM', 'RDS', 'RDSDataService', 'Redshift', 'Rekognition', 'ResourceGroups', 'ResourceGroupsTaggingAPI', 'RoboMaker', 'Route53', 'Route53Domains', 'Route53Resolver', 'S3', 'S3Control', 'SageMaker', 'SageMakerRuntime', 'SecretsManager', 'SecurityHub', 'SecurityToken', 'ServerlessApplicationRepository', 'ServerMigrationService', 'ServiceCatalog', 'ServiceDiscovery', 'ServiceQuotas', 'Shield', 'SimpleEmail', 'SimpleNotificationService', 'SimpleSystemsManagement', 'SimpleWorkflow', 'Snowball', 'SQS', 'StepFunctions', 'StorageGateway', 'Textract', 'TranscribeService', 'Transfer', 'Translate', 'WAF', 'WAFRegional', 'WorkDocs', 'WorkLink', 'WorkMail', 'WorkMailMessageFlow', 'WorkSpaces', 'XRay')
