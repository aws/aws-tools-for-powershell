...
$binFilesSuffixes = @('.dll', '.dll-Help.xml', '.Format.ps1xml')
...
New-Item -Path $modularDeploymentFolder -ItemType Directory | Out-Null

# Note: Format and pshelp files are pre-generated by the 'generate-modular-help' MSBuild target
# using batch mode (single process for all ~410 modules). This script only copies artifacts.

New-Item -Path "$modularDeploymentFolder/AWS.Tools.Common" -ItemType Directory | Out-Null
...
$projectNameList = @('AccessAnalyzer', 'Account', 'AccountAccess', 'ACMPCA', 'AgentRegistry', 'AgentRegistryControl', 'AIOps', 'Amplify', 'AmplifyBackend', 'AmplifyUIBuilder', 'APIGateway', 'ApiGatewayManagementApi', 'ApiGatewayV2', 'AppConfig', 'AppConfigData', 'AppFabric', 'Appflow', 'AppIntegrationsService', 'ApplicationAutoScaling', 'ApplicationCostProfiler', 'ApplicationDiscoveryService', 'ApplicationInsights', 'ApplicationSignals', 'AppMesh', 'AppRegistry', 'AppRunner', 'AppStream', 'AppSync', 'ARCRegionswitch', 'ARCZonalShift', 'Artifact', 'Athena', 'AuditManager', 'AugmentedAIRuntime', 'AutoScaling', 'AutoScalingPlans', 'AWSHealth', 'AWSMarketplaceCommerceAnalytics', 'AWSMarketplaceMetering', 'AWSSupport', 'B2bi', 'Backup', 'BackupGateway', 'BackupSearch', 'Batch', 'BCMDashboards', 'BCMDataExports', 'BCMPricingCalculator', 'BCMRecommendedActions', 'Bedrock', 'BedrockAgent', 'BedrockAgentCore', 'BedrockAgentCoreControl', 'BedrockAgentRuntime', 'BedrockDataAutomation', 'BedrockDataAutomationRuntime', 'BedrockRuntime', 'Billing', 'BillingConductor', 'Braket', 'Budgets', 'CertificateManager', 'Chatbot', 'Chime', 'ChimeSDKIdentity', 'ChimeSDKMediaPipelines', 'ChimeSDKMeetings', 'ChimeSDKMessaging', 'ChimeSDKVoice', 'CleanRooms', 'CleanRoomsML', 'Cloud9', 'CloudControlApi', 'CloudDirectory', 'CloudFormation', 'CloudFront', 'CloudFrontKeyValueStore', 'CloudHSMV2', 'CloudSearch', 'CloudSearchDomain', 'CloudTrail', 'CloudTrailData', 'CloudWatch', 'CloudWatchLogs', 'CloudWatchOmni', 'CloudWatchRUM', 'CodeArtifact', 'CodeBuild', 'CodeCatalyst', 'CodeCommit', 'CodeConnections', 'CodeDeploy', 'CodeGuruProfiler', 'CodeGuruReviewer', 'CodeGuruSecurity', 'CodePipeline', 'CodeStarconnections', 'CodeStarNotifications', 'CognitoIdentity', 'CognitoIdentityProvider', 'CognitoSync', 'Comprehend', 'ComprehendMedical', 'ComputeOptimizer', 'ComputeOptimizerAutomation', 'ConfigService', 'Connect', 'ConnectCampaignService', 'ConnectCampaignsV2', 'ConnectCases', 'ConnectContactLens', 'ConnectHealth', 'ConnectParticipant', 'ConnectWisdomService', 'ControlCatalog', 'ControlTower', 'CostAndUsageReport', 'CostExplorer', 'CostOptimizationHub', 'CustomerProfiles', 'DatabaseMigrationService', 'DataExchange', 'DataPipeline', 'DataSync', 'DataZone', 'DAX', 'Deadline', 'Detective', 'DeviceFarm', 'DevOpsAgent', 'DevOpsGuru', 'DirectConnect', 'DirectoryService', 'DirectoryServiceData', 'DLM', 'DocDB', 'DocDBElastic', 'Drs', 'DSQL', 'DynamoDBStreams', 'DynamoDBv2', 'EBS', 'EC2', 'EC2InstanceConnect', 'ECR', 'ECRPublic', 'ECS', 'EKS', 'EKSAuth', 'ElastiCache', 'ElasticBeanstalk', 'ElasticFileSystem', 'ElasticLoadBalancing', 'ElasticLoadBalancingV2', 'ElasticMapReduce', 'Elasticsearch', 'ElementalInference', 'EMRContainers', 'EMRServerless', 'EntityResolution', 'EventBridge', 'EventBridgeV2', 'Evs', 'Finspace', 'FinSpaceData', 'FIS', 'FMS', 'ForecastQueryService', 'ForecastService', 'FraudDetector', 'FreeTier', 'FSx', 'GameLift', 'GameLiftStreams', 'GeoMaps', 'GeoPlaces', 'GeoRoutes', 'Glacier', 'GlobalAccelerator', 'Glue', 'GlueDataBrew', 'Greengrass', 'GreengrassV2', 'GroundStation', 'GuardDuty', 'HealthLake', 'IAMRolesAnywhere', 'IAMToolbox', 'IdentityManagement', 'IdentityStore', 'Imagebuilder', 'ImportExport', 'Inspector', 'Inspector2', 'InspectorScan', 'Interconnect', 'InternetMonitor', 'Invoicing', 'IoT', 'IoTDeviceAdvisor', 'IoTFleetWise', 'IoTJobsDataPlane', 'IoTManagedIntegrations', 'IoTSecureTunneling', 'IoTSiteWise', 'IoTThingsGraph', 'IoTTwinMaker', 'IoTWireless', 'IVS', 'Ivschat', 'IVSRealTime', 'Kafka', 'KafkaConnect', 'Kendra', 'KendraRanking', 'KeyManagementService', 'Keyspaces', 'KeyspacesStreams', 'Kinesis', 'KinesisAnalyticsV2', 'KinesisFirehose', 'KinesisVideo', 'KinesisVideoMedia', 'KinesisVideoSignalingChannels', 'KinesisVideoWebRTCStorage', 'LakeFormation', 'Lambda', 'LambdaCore', 'LambdaMicrovms', 'LaunchWizard', 'Lex', 'LexModelBuildingService', 'LexModelsV2', 'LexRuntimeV2', 'LicenseManager', 'LicenseManagerLinuxSubscriptions', 'LicenseManagerUserSubscriptions', 'Lightsail', 'LocationService', 'LookoutEquipment', 'MachineLearning', 'Macie2', 'MailManager', 'MainframeModernization', 'ManagedBlockchain', 'ManagedBlockchainQuery', 'ManagedGrafana', 'MarketplaceAgreement', 'MarketplaceCatalog', 'MarketplaceDeployment', 'MarketplaceDiscovery', 'MarketplaceEntitlementService', 'MarketplaceReporting', 'MediaConnect', 'MediaConvert', 'MediaLive', 'MediaPackage', 'MediaPackageV2', 'MediaPackageVod', 'MediaStore', 'MediaStoreData', 'MediaTailor', 'MedicalImaging', 'MemoryDB', 'Mgn', 'MigrationHub', 'MigrationHubConfig', 'MigrationHubOrchestrator', 'MigrationHubRefactorSpaces', 'MigrationHubStrategyRecommendations', 'MPA', 'MQ', 'MTurk', 'MWAA', 'MWAAServerless', 'Neptune', 'Neptunedata', 'NeptuneGraph', 'NetworkFirewall', 'NetworkFlowMonitor', 'NetworkManager', 'NetworkMonitor', 'NetworkSecurityManager', 'Notifications', 'NotificationsContacts', 'NovaAct', 'OAM', 'ObservabilityAdmin', 'Odb', 'Omics', 'OpenSearchServerless', 'OpenSearchService', 'Organizations', 'OSIS', 'Outposts', 'PartnerCentralAccount', 'PartnerCentralBenefits', 'PartnerCentralChannel', 'PartnerCentralRevenueMeasurement', 'PartnerCentralSelling', 'PaymentCryptography', 'PaymentCryptographyData', 'PcaConnectorAd', 'PcaConnectorScep', 'PCS', 'Personalize', 'PersonalizeEvents', 'PersonalizeRuntime', 'PI', 'Pinpoint', 'PinpointEmail', 'PinpointSMSVoiceV2', 'Pipes', 'Polly', 'Pricing', 'PricingPlanManager', 'PrometheusService', 'Proton', 'QApps', 'QBusiness', 'QConnect', 'QuickSight', 'RAM', 'RDS', 'RDSDataService', 'RecycleBin', 'Redshift', 'RedshiftDataAPIService', 'RedshiftServerless', 'Rekognition', 'Repostspace', 'ResilienceHub', 'Resiliencehubv2', 'ResourceExplorer2', 'ResourceGroups', 'ResourceGroupsTaggingAPI', 'Route53', 'Route53Domains', 'Route53GlobalResolver', 'Route53Profiles', 'Route53RecoveryCluster', 'Route53RecoveryControlConfig', 'Route53RecoveryReadiness', 'Route53Resolver', 'RTBFabric', 'S3', 'S3Control', 'S3Files', 'S3Outposts', 'S3Tables', 'S3Vectors', 'SageMaker', 'SagemakerEdgeManager', 'SageMakerFeatureStoreRuntime', 'SageMakerGeospatial', 'SagemakerJobRuntime', 'SageMakerMetrics', 'SageMakerRuntime', 'SavingsPlans', 'Scheduler', 'Schemas', 'SecretsManager', 'SecurityAgent', 'SecurityHub', 'SecurityIR', 'SecurityLake', 'SecurityToken', 'ServerlessApplicationRepository', 'ServiceCatalog', 'ServiceDiscovery', 'ServiceQuotas', 'Shield', 'SignerData', 'Signin', 'SimpleDBv2', 'SimpleEmail', 'SimpleEmailV2', 'SimpleNotificationService', 'SimpleSystemsManagement', 'SimpleWorkflow', 'Snowball', 'SnowDeviceManagement', 'SocialMessaging', 'SQS', 'SSMContacts', 'SSMGuiConnect', 'SSMIncidents', 'SSMQuickSetup', 'SsmSap', 'SSO', 'SSOAdmin', 'SSOOIDC', 'StepFunctions', 'StorageGateway', 'SupplyChain', 'SupportApp', 'SupportAuthZ', 'Sustainability', 'Synthetics', 'TaxSettings', 'Textract', 'TimestreamInfluxDB', 'TimestreamQuery', 'TimestreamWrite', 'Tnb', 'TranscribeService', 'Transfer', 'Translate', 'TrustedAdvisor', 'Uxc', 'VerifiedPermissions', 'VoiceID', 'VPCLattice', 'WAF', 'WAFRegional', 'WAFV2', 'WellArchitected', 'Wickr', 'WorkDocs', 'WorkMail', 'WorkMailMessageFlow', 'WorkSpaces', 'WorkspacesInstances', 'WorkSpacesThinClient', 'WorkSpacesWeb', 'XRay')
...
foreach ($project in $projectNameList)
{
    ...
    New-Item -Path $projectDeploymentFolder -ItemType Directory | Out-Null
    foreach ($suffix in $moduleFilesSuffixes)
    {
...
# AWS.Tools.Installer
# Copy each shipped asset explicitly rather than recursing the whole module folder.
# modules/Installer also contains the AWS.Tools.Installer.Lib C# project (sources,
# .csproj, bin/, obj/); a recursive copy would ship those build intermediates. Only the
# .psd1, .psm1, Public/, Private/, Config/, and the compiled DLL belong in the module.
$installerDeploymentFolder = "$modularDeploymentFolder/AWS.Tools.Installer"
New-Item -Path $installerDeploymentFolder -ItemType Directory | Out-Null
Copy-Item -Path "$installerModuleFolder/AWS.Tools.Installer.psd1" -Destination "$installerDeploymentFolder/AWS.Tools.Installer.psd1"
Copy-Item -Path "$installerModuleFolder/AWS.Tools.Installer.psm1" -Destination "$installerDeploymentFolder/AWS.Tools.Installer.psm1"
Copy-Item -Path "$installerModuleFolder/Public" -Destination "$installerDeploymentFolder/Public" -Recurse
Copy-Item -Path "$installerModuleFolder/Private" -Destination "$installerDeploymentFolder/Private" -Recurse
Copy-Item -Path "$installerModuleFolder/Config" -Destination "$installerDeploymentFolder/Config" -Recurse

Copy-Item -Path "$installerModuleFolder/AWS.Tools.Installer.Lib/$releaseBitPath/AWS.Tools.Installer.dll" -Destination "$installerDeploymentFolder/AWS.Tools.Installer.dll"

# Copy the publish dependency graph to the deployment folder
Copy-Item -Path "$rootFolder/aws-tools-publish-dependency-graph.json" -Destination "$rootFolder/Deployment/aws-tools-publish-dependency-graph.json"
