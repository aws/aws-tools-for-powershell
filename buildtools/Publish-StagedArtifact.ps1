...
.DESCRIPTION
    ...
    is generated during build and copied to Deployment/AWS.Tools/.
...
$depGraphPath = Join-Path $awsPowerShellModularModulesLocation "aws-tools-publish-dependency-graph.json"
