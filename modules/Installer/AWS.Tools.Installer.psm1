...
try {
    # Read this module's own .psd1 directly from $PSScriptRoot. The path is
    # already known, so a targeted Import-PowerShellDataFile is sufficient
    # and does not depend on $env:PSModulePath enumeration.
