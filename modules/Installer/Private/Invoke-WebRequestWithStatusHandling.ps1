...
.Description
    ...
    Uses -UseBasicParsing to prevent PowerShell 5.1 security warning prompts when downloading
    files. This is appropriate for binary file downloads where HTML parsing is not required.
    The parameter is available in PowerShell 3.0+ and is ignored (no-op) in PowerShell 7+.
