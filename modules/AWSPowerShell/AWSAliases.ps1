...
Set-Alias -Name ELB2-DescribeProvisionedCapacity -Value Get-ELB2ProvisionedCapacity
...
Set-Alias -Name ELB2-ModifyProvisionedCapacity -Value Edit-ELB2ProvisionedCapacity
