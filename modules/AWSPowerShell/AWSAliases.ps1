...
Set-Alias -Name INS-ListRuns -Value Get-INSRunList
Set-Alias -Name INS-ListTagsForResource -Value Get-INSTagListForResource
Set-Alias -Name INS-LocalizeText -Value Get-INSLocalizedText
Set-Alias -Name INS-PreviewAgentsForResourceGroup -Value Get-INSResourceGroupAgentPreview
...
Set-Alias -Name INS-RunAssessment -Value Start-INSAssessment
Set-Alias -Name INS-SetTagsForResource -Value Set-INSResourceTag
Set-Alias -Name INS-StartDataCollection -Value Start-INSDataCollection
...
Set-Alias -Name INS-DeleteApplication -Value Remove-INSApplication
Set-Alias -Name Delete-INSAssessment -Value Remove-INSAssessment
Set-Alias -Name INS-DeleteAssessment -Value Remove-INSAssessment
Set-Alias -Name Delete-INSRun -Value Remove-INSRun
Set-Alias -Name INS-DeleteRun -Value Remove-INSRun
Set-Alias -Name Describe-INSApplication -Value Get-INSApplication
Set-Alias -Name INS-DescribeApplication -Value Get-INSApplication
Set-Alias -Name Describe-INSAssessment -Value Get-INSAssessment
Set-Alias -Name INS-DescribeAssessment -Value Get-INSAssessment
...
Set-Alias -Name INS-DescribeFinding -Value Get-INSFinding
Set-Alias -Name Describe-INSResourceGroup -Value Get-INSResourceGroup
Set-Alias -Name INS-DescribeResourceGroup -Value Get-INSResourceGroup
Set-Alias -Name Describe-INSRulesPackage -Value Get-INSRulesPackage
Set-Alias -Name INS-DescribeRulesPackage -Value Get-INSRulesPackage
Set-Alias -Name Describe-INSRun -Value Get-INSRun
Set-Alias -Name INS-DescribeRun -Value Get-INSRun
Set-Alias -Name INS-DetachAssessmentAndRulesPackage -Value Remove-INSAssessmentAndRulesPackage
Set-Alias -Name INS-GetAssessmentTelemetry -Value Get-INSAssessmentTelemetry
Set-Alias -Name List-INSApplicationList -Value Get-INSApplicationList
Set-Alias -Name INS-ListApplications -Value Get-INSApplicationList
Set-Alias -Name List-INSAssessmentAgentList -Value Get-INSAssessmentAgentList
Set-Alias -Name INS-ListAssessmentAgents -Value Get-INSAssessmentAgentList
Set-Alias -Name List-INSAssessmentList -Value Get-INSAssessmentList
Set-Alias -Name INS-ListAssessments -Value Get-INSAssessmentList
Set-Alias -Name List-INSAttachedAssessment -Value Get-INSAttachedAssessment
