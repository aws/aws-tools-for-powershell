...
Set-Alias -Name ADS-ExportConfigurations -Value Get-ADSExportConfiguration
Set-Alias -Name ADS-GetConfigurationAttributes -Value Get-ADSConfigurationAttribute
Set-Alias -Name ADS-GetExportStatus -Value Get-ADSExportStatus
Set-Alias -Name ADS-ListConfigurations -Value Get-ADSConfigurationList
Set-Alias -Name ADS-RemoveConfiguration -Value Remove-ADSConfiguration
