...
$R53_Completers = {
    ...
    switch ($("$commandName/$parameterName"))
    {
        ...
        {
            $v = "ap-northeast-1","ap-northeast-2","ap-south-1","ap-southeast-1","ap-southeast-2","cn-north-1","eu-central-1","eu-west-1","sa-east-1","us-east-1","us-east-2","us-west-1","us-west-2"
            break
        }
