...
$TRS_Completers = {
    ...
    switch ($("$commandName/$parameterName"))
    {
        ...
        {
            $v = "en-AU","en-UK","en-US","es-US","fr-CA"
            break
        }
