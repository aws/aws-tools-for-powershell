...
namespace Amazon.PowerShell.Cmdlets.LMVM2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMVM2MicrovmImageBuild")]
    [OutputType("Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse")]
    [AWSCmdlet("Calls the Lambda MicroVMs GetMicrovmImageBuild API operation.", Operation = new[] {"GetMicrovmImageBuild"}, SelectReturnType = typeof(Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse))]
    [AWSCmdletOutput("Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse",
        "This cmdlet returns an Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse object containing multiple properties."
    )]
    public partial class GetLMVM2MicrovmImageBuildCmdlet : AmazonLambdaMicrovmsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the build to retrieve.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The version of the MicroVM image.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse).
        /// Specifying the name of a property of type Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse, GetLMVM2MicrovmImageBuildCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildRequest();
        ...
        private Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse CallAWSServiceOperation(IAmazonLambdaMicrovms client, Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Lambda MicroVMs", "GetMicrovmImageBuild");
            try
            {
                return client.GetMicrovmImageBuildAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ImageIdentifier { get; set; }
            public System.String ImageVersion { get; set; }
            public System.Func<Amazon.LambdaMicrovms.Model.GetMicrovmImageBuildResponse, GetLMVM2MicrovmImageBuildCmdlet, object> Select { get; set; } =
