...
namespace Amazon.PowerShell.Cmdlets.LMVM2
{
    ...
    /// </summary>
    [Cmdlet("Update", "LMVM2MicrovmImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse")]
    [AWSCmdlet("Calls the Lambda MicroVMs UpdateMicrovmImage API operation.", Operation = new[] {"UpdateMicrovmImage"}, SelectReturnType = typeof(Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse))]
    [AWSCmdletOutput("Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse",
        "This cmdlet returns an Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse object containing multiple properties."
    )]
    public partial class UpdateLMVM2MicrovmImageCmdlet : AmazonLambdaMicrovmsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the base MicroVM image.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the IAM build role.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The description of the MicroVM image.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier (ARN or ID) of the MicroVM image to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse).
        /// Specifying the name of a property of type Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var targetParameterNames = new string[]
            {
                ...
                nameof(this.ImageIdentifier)
            };
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(targetParameterNames, MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-LMVM2MicrovmImage (UpdateMicrovmImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse, UpdateLMVM2MicrovmImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LambdaMicrovms.Model.UpdateMicrovmImageRequest();
        ...
        private Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse CallAWSServiceOperation(IAmazonLambdaMicrovms client, Amazon.LambdaMicrovms.Model.UpdateMicrovmImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Lambda MicroVMs", "UpdateMicrovmImage");
            try
            {
                return client.UpdateMicrovmImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LambdaMicrovms.Model.UpdateMicrovmImageResponse, UpdateLMVM2MicrovmImageCmdlet, object> Select { get; set; } =
