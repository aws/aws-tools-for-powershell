#
# Module manifest for module 'AWS.Tools.LambdaMicrovms'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.LambdaMicrovms.dll'
    ...
    GUID = '6435eef1-5502-42a4-a9aa-75d84bd5a3b7'
    ...
    Description = 'The LambdaMicrovms module of AWS Tools for PowerShell lets developers and administrators manage Lambda MicroVMs from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.LambdaMicrovms.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.LambdaMicrovms.Completers.psm1',
        'AWS.Tools.LambdaMicrovms.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.LambdaMicrovms.dll-Help.xml'
    )
