...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class GetCFNPublisherCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the extension publisher.</para><para>If you don't supply a <c>PublisherId</c>, and you have registered as an extension
        /// publisher, <c>DescribePublisher</c> returns information about your own publisher account.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.CloudFormation.Model.DescribePublisherResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribePublisherRequest request)
        {
            ...
            try
            {
                return client.DescribePublisherAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
