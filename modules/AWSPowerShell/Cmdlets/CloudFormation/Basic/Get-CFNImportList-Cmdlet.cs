...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdlet("Calls the AWS CloudFormation ListImports API operation.", Operation = new[] {"ListImports"}, SelectReturnType = typeof(Amazon.CloudFormation.Model.ListImportsResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudFormation.Model.ListImportsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudFormation.Model.ListImportsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFNImportListCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ExportName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.ListImportsResponse, GetCFNImportListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ExportName;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.ExportName = this.ExportName;
            #if MODULAR
            if (this.ExportName == null && ParameterWasBound(nameof(this.ExportName)))
            {
                WriteWarning("You are passing $null as a value for parameter ExportName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudFormation.Model.ListImportsRequest();
            
            if (cmdletContext.ExportName != null)
            {
                request.ExportName = cmdletContext.ExportName;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ExportName { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudFormation.Model.ListImportsResponse, GetCFNImportListCmdlet, object> Select { get; set; } =
