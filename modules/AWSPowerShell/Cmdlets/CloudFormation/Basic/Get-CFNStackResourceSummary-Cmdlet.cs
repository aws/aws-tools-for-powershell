...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdlet("Calls the AWS CloudFormation ListStackResources API operation.", Operation = new[] {"ListStackResources"}, SelectReturnType = typeof(Amazon.CloudFormation.Model.ListStackResourcesResponse), LegacyAlias="Get-CFNStackResourceSummaries")]
    [AWSCmdletOutput("Amazon.CloudFormation.Model.StackResourceSummary or Amazon.CloudFormation.Model.ListStackResourcesResponse",
        "This cmdlet returns a collection of Amazon.CloudFormation.Model.StackResourceSummary objects.",
        "The service call response (type Amazon.CloudFormation.Model.ListStackResourcesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFNStackResourceSummaryCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StackResourceSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.ListStackResourcesResponse, GetCFNStackResourceSummaryCmdlet>(Select) ??
        ...
        private Amazon.CloudFormation.Model.ListStackResourcesResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.ListStackResourcesRequest request)
        {
            ...
            try
            {
                return client.ListStackResourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.CloudFormation.Model.ListStackResourcesResponse, GetCFNStackResourceSummaryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StackResourceSummaries;
        }
