...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "CFNTypeRegistration")]
    ...
    public partial class GetCFNTypeRegistrationCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// request using <a>RegisterType</a>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.DescribeTypeRegistrationResponse, GetCFNTypeRegistrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFormation.Model.DescribeTypeRegistrationRequest();
        ...
        private Amazon.CloudFormation.Model.DescribeTypeRegistrationResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribeTypeRegistrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudFormation", "DescribeTypeRegistration");
            try
            {
                #if DESKTOP
                return client.DescribeTypeRegistration(request);
                #elif CORECLR
                return client.DescribeTypeRegistrationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RegistrationToken { get; set; }
            public System.Func<Amazon.CloudFormation.Model.DescribeTypeRegistrationResponse, GetCFNTypeRegistrationCmdlet, object> Select { get; set; } =
