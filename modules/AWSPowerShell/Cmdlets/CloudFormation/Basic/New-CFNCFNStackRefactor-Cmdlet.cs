...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class NewCFNCFNStackRefactorCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The mappings for the stack resource <c>Source</c> and stack resource <c>Destination</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The stacks being refactored.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CloudFormation.Model.CreateStackRefactorResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.CreateStackRefactorRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateStackRefactor(request);
                #elif CORECLR
                return client.CreateStackRefactorAsync(request).GetAwaiter().GetResult();
                #else
