...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class NewCFNStackSetCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// custom processing on CloudFormation templates with template macros</a>.</para><important><para>Stack sets with service-managed permissions don't currently support the use of macros
        ...
        /// a maximum length of 51,200 bytes.</para><para>Conditional: You must specify either the TemplateBody or the TemplateURL parameter,
        /// but not both.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// The location for an Amazon S3 bucket must start with <c>https://</c>.</para><para>Conditional: You must specify either the TemplateBody or the TemplateURL parameter,
        /// but not both.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CloudFormation.Model.CreateStackSetResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.CreateStackSetRequest request)
        {
            ...
            try
            {
                return client.CreateStackSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
