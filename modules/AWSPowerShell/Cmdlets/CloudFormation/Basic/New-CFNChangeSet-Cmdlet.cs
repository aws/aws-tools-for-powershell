...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class NewCFNChangeSetCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// AWS::IAM::ManagedPolicy</a></para></li><li><para><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-iam-policy.html">
        /// AWS::IAM::Policy</a></para></li><li><para><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-iam-role.html">
        ...
        /// <summary>
        /// <para>
        /// <para>Indicates if the change set auto-imports resources that already exist. For more information,
        ...
        /// <i>CloudFormation User Guide</i>.</para><note><para>This parameter can only import resources that have custom names in templates. For
        ...
        /// User Guide</i>.</para><note><para>Only one of the <c>Capabilities</c> and <c>ResourceType</c> parameters can be specified.</para></note><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
