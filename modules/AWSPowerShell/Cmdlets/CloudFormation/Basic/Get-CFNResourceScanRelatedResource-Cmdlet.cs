...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdletOutput("Amazon.CloudFormation.Model.ScannedResource or Amazon.CloudFormation.Model.ListResourceScanRelatedResourcesResponse",
        ...
        "The service call response (type Amazon.CloudFormation.Model.ListResourceScanRelatedResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
