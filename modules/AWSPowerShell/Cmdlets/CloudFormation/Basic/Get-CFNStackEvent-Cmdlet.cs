...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class GetCFNStackEventCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StackEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.DescribeStackEventsResponse, GetCFNStackEventCmdlet>(Select) ??
        ...
        private Amazon.CloudFormation.Model.DescribeStackEventsResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribeStackEventsRequest request)
        {
            ...
            try
            {
                return client.DescribeStackEventsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.CloudFormation.Model.DescribeStackEventsResponse, GetCFNStackEventCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StackEvents;
        }
