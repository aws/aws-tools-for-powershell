...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class PublishCFNTypeCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// by one minor version release.</para><para>The first time you publish a type, CloudFormation sets the version number to <code>1.0.0</code>,
        /// regardless of the value you specify.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CloudFormation.Model.PublishTypeResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.PublishTypeRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.PublishType(request);
                #elif CORECLR
                return client.PublishTypeAsync(request).GetAwaiter().GetResult();
                #else
