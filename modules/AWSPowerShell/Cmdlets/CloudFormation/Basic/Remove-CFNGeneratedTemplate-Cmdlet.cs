...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CFNGeneratedTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCFNGeneratedTemplateCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFormation.Model.DeleteGeneratedTemplateResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CFNGeneratedTemplate (DeleteGeneratedTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.DeleteGeneratedTemplateResponse, RemoveCFNGeneratedTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFormation.Model.DeleteGeneratedTemplateRequest();
        ...
        private Amazon.CloudFormation.Model.DeleteGeneratedTemplateResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DeleteGeneratedTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudFormation", "DeleteGeneratedTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteGeneratedTemplate(request);
                #elif CORECLR
                return client.DeleteGeneratedTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GeneratedTemplateName { get; set; }
            public System.Func<Amazon.CloudFormation.Model.DeleteGeneratedTemplateResponse, RemoveCFNGeneratedTemplateCmdlet, object> Select { get; set; } =
