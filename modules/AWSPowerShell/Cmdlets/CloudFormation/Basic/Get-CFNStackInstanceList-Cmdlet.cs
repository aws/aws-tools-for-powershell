...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdletOutput("Amazon.CloudFormation.Model.StackInstanceSummary or Amazon.CloudFormation.Model.ListStackInstancesResponse",
        ...
        "The service call response (type Amazon.CloudFormation.Model.ListStackInstancesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFNStackInstanceListCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filter to apply to stack instances</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Amazon Web Services account that you want to list stack instances
        /// for.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>If the previous request didn't return all the remaining results, the response's <c>NextToken</c>
        ...
        private Amazon.CloudFormation.Model.ListStackInstancesResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.ListStackInstancesRequest request)
        {
            ...
            try
            {
                return client.ListStackInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
