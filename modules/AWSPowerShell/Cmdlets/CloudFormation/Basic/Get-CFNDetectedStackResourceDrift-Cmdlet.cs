...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class GetCFNDetectedStackResourceDriftCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// configuration.</para></li><li><para><c>NOT_CHECKED</c>: CloudFormation doesn't currently return this value.</para></li><li><para><c>UNKNOWN</c>: CloudFormation could not run drift detection for the resource.</para></li></ul><para />
        ...
        private Amazon.CloudFormation.Model.DescribeStackResourceDriftsResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribeStackResourceDriftsRequest request)
        {
            ...
            try
            {
                return client.DescribeStackResourceDriftsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
