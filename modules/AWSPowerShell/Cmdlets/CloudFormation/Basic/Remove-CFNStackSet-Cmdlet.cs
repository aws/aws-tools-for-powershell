...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public partial class RemoveCFNStackSetCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name or unique ID of the StackSet that you're deleting. You can obtain this value
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.DeleteStackSetResponse, RemoveCFNStackSetCmdlet>(Select) ??
        ...
        private Amazon.CloudFormation.Model.DeleteStackSetResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DeleteStackSetRequest request)
        {
            ...
            try
            {
                return client.DeleteStackSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.CloudFormation.CallAs CallAs { get; set; }
            public System.String StackSetName { get; set; }
            public System.Func<Amazon.CloudFormation.Model.DeleteStackSetResponse, RemoveCFNStackSetCmdlet, object> Select { get; set; } =
