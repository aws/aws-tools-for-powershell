...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    /// Limits</a> in the <i>CloudFormation User Guide</i>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCFNAccountLimitCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccountLimits";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFormation.Model.DescribeAccountLimitsResponse, GetCFNAccountLimitCmdlet>(Select) ??
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudFormation.Model.DescribeAccountLimitsResponse, GetCFNAccountLimitCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccountLimits;
        }
