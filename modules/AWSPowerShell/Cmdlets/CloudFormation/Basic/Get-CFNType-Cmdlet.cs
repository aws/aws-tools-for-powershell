...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdletOutput("Amazon.CloudFormation.Model.DescribeTypeResponse",
        "This cmdlet returns an Amazon.CloudFormation.Model.DescribeTypeResponse object containing multiple properties."
    )]
    public partial class GetCFNTypeCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// registered.</para><para>If you specify a <c>VersionId</c>, <c>DescribeType</c> returns information about that
        /// specific extension version. Otherwise, it returns information about the default extension
        /// version.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.CloudFormation.Model.DescribeTypeResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribeTypeRequest request)
        {
            ...
            try
            {
                return client.DescribeTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
