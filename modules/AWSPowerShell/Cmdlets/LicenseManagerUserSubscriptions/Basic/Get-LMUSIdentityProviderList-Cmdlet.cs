...
namespace Amazon.PowerShell.Cmdlets.LMUS
{
    ...
    [AWSCmdlet("Calls the AWS License Manager User Subscription ListIdentityProviders API operation.", Operation = new[] {"ListIdentityProviders"}, SelectReturnType = typeof(Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersResponse))]
    [AWSCmdletOutput("Amazon.LicenseManagerUserSubscriptions.Model.IdentityProviderSummary or Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersResponse",
        "This cmdlet returns a collection of Amazon.LicenseManagerUserSubscriptions.Model.IdentityProviderSummary objects.",
        "The service call response (type Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMUSIdentityProviderListCmdlet : AmazonLicenseManagerUserSubscriptionsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>You can use the following filters to streamline results:</para><ul><li><para>Product</para></li><li><para>DirectoryId</para></li></ul><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IdentityProviderSummaries";
        #endregion
        ...
        private Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersResponse CallAWSServiceOperation(IAmazonLicenseManagerUserSubscriptions client, Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager User Subscription", "ListIdentityProviders");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LicenseManagerUserSubscriptions.Model.ListIdentityProvidersResponse, GetLMUSIdentityProviderListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IdentityProviderSummaries;
        }
