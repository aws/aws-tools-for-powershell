...
namespace Amazon.PowerShell.Cmdlets.TRN
{
    ...
    public partial class RemoveTRNResourceTagCmdlet : AmazonTranslateClientCmdlet, IExecutor
    {
        ...
        /// Keys must be unique and cannot be duplicated for a particular resource. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TRNResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Translate.Model.UntagResourceResponse, RemoveTRNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Translate.Model.UntagResourceRequest();
        ...
        private Amazon.Translate.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonTranslate client, Amazon.Translate.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Translate", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Translate.Model.UntagResourceResponse, RemoveTRNResourceTagCmdlet, object> Select { get; set; } =
