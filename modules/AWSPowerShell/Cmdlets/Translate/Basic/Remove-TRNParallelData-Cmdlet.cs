...
namespace Amazon.PowerShell.Cmdlets.TRN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "TRNParallelData", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveTRNParallelDataCmdlet : AmazonTranslateClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TRNParallelData (DeleteParallelData)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Translate.Model.DeleteParallelDataResponse, RemoveTRNParallelDataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Translate.Model.DeleteParallelDataRequest();
        ...
        private Amazon.Translate.Model.DeleteParallelDataResponse CallAWSServiceOperation(IAmazonTranslate client, Amazon.Translate.Model.DeleteParallelDataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Translate", "DeleteParallelData");
            try
            {
                #if DESKTOP
                return client.DeleteParallelData(request);
                #elif CORECLR
                return client.DeleteParallelDataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Translate.Model.DeleteParallelDataResponse, RemoveTRNParallelDataCmdlet, object> Select { get; set; } =
