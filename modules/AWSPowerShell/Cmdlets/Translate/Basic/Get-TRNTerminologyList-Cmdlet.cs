...
namespace Amazon.PowerShell.Cmdlets.TRN
{
    ...
    /// </summary>
    [Cmdlet("Get", "TRNTerminologyList")]
    [OutputType("Amazon.Translate.Model.TerminologyProperties")]
    [AWSCmdlet("Calls the Amazon Translate ListTerminologies API operation.", Operation = new[] {"ListTerminologies"}, SelectReturnType = typeof(Amazon.Translate.Model.ListTerminologiesResponse))]
    [AWSCmdletOutput("Amazon.Translate.Model.TerminologyProperties or Amazon.Translate.Model.ListTerminologiesResponse",
        "This cmdlet returns a collection of Amazon.Translate.Model.TerminologyProperties objects.",
        "The service call response (type Amazon.Translate.Model.ListTerminologiesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRNTerminologyListCmdlet : AmazonTranslateClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TerminologyPropertiesList";
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Translate.Model.ListTerminologiesRequest();
        ...
        private Amazon.Translate.Model.ListTerminologiesResponse CallAWSServiceOperation(IAmazonTranslate client, Amazon.Translate.Model.ListTerminologiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Translate", "ListTerminologies");
            try
            {
                #if DESKTOP
                return client.ListTerminologies(request);
                #elif CORECLR
                return client.ListTerminologiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Translate.Model.ListTerminologiesResponse, GetTRNTerminologyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TerminologyPropertiesList;
        }
