...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    [AWSCmdlet("Calls the AWS Elastic Beanstalk UpdateApplicationVersion API operation.", Operation = new[] {"UpdateApplicationVersion"})]
    ...
    public partial class UpdateEBApplicationVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        private Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateApplicationVersionAsync(request);
                return task.Result;
                #else
