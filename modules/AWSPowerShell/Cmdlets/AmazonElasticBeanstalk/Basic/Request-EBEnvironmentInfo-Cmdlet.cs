...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type RequestEnvironmentInfoResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RequestEBEnvironmentInfoCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.RequestEnvironmentInfo(request);
