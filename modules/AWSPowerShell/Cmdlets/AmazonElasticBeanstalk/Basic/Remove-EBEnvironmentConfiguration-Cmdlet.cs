...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    public partial class RemoveEBEnvironmentConfigurationCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EBEnvironmentConfiguration (DeleteEnvironmentConfiguration)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticBeanstalk.Model.DeleteEnvironmentConfigurationRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = cmdletContext.EnvironmentName;
        ...
        private Amazon.ElasticBeanstalk.Model.DeleteEnvironmentConfigurationResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.DeleteEnvironmentConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elastic Beanstalk", "DeleteEnvironmentConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteEnvironmentConfiguration(request);
                #elif CORECLR
                return client.DeleteEnvironmentConfigurationAsync(request).GetAwaiter().GetResult();
                #else
