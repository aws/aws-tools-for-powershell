...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    [AWSCmdlet("Invokes the CreatePlatformVersion operation against AWS Elastic Beanstalk.", Operation = new[] {"CreatePlatformVersion"})]
    ...
    public partial class NewEBPlatformVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ElasticBeanstalk.Model.CreatePlatformVersionResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.CreatePlatformVersionRequest request)
        {
            #if DESKTOP
