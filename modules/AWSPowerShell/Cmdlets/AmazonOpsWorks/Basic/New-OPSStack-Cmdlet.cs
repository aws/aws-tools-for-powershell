...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public class NewOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The stack's operating system, which must be set to one of the following.</para><ul><li>Standard operating systems: an Amazon Linux version such as <code>Amazon
        /// Linux 2014.09</code>, <code>Ubuntu 12.04 LTS</code>, or <code>Ubuntu 14.04 LTS</code>.</li><li>Custom AMIs: <code>Custom</code>. You specify the custom AMI you want to use when
        /// you create instances.</li></ul><para> The default option is the current Amazon Linux version.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        /// <summary>
        /// <para>
        /// <para>The stack AWS region, such as "us-east-1". For more information about Amazon regions,
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the VPC that the stack is to be launched into. It must be in the specified
        /// region. All instances are launched into this VPC, and you cannot change the ID later.</para><ul><li>If your account supports EC2 Classic, the default value is no VPC.</li><li>If your account does not support EC2 Classic, the default value is the default
