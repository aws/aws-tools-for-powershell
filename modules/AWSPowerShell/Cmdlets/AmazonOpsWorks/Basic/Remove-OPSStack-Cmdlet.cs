...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public class RemoveOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        private static Amazon.OpsWorks.Model.DeleteStackResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DeleteStackRequest request)
        {
