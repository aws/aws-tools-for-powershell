...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public class UpdateOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        private static Amazon.OpsWorks.Model.UpdateStackResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UpdateStackRequest request)
        {
