...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdlet("Invokes the DescribeStacks operation against AWS OpsWorks.", Operation = new[] {"DescribeStacks"}, LegacyAlias="Get-OPSStacks")]
    ...
    public partial class GetOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.StackIds = cmdletContext.StackIds;
            }
            ...
            try
            {
                ...
                object pipelineOutput = response.Stacks;
