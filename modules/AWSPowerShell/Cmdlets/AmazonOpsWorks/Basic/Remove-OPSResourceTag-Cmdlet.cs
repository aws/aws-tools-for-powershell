...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "OPSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Invokes the UntagResource operation against AWS OpsWorks.", Operation = new[] {"UntagResource"})]
    ...
    public partial class RemoveOPSResourceTagCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OPSResourceTag (UntagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpsWorks.Model.UntagResourceRequest();
        ...
        private Amazon.OpsWorks.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "UntagResource");
            #if DESKTOP
