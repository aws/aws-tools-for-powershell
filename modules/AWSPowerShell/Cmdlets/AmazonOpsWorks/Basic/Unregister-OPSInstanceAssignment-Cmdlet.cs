...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class UnregisterOPSInstanceAssignmentCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-OPSInstanceAssignment (UnassignInstance)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpsWorks.Model.UnassignInstanceRequest();
        ...
        private Amazon.OpsWorks.Model.UnassignInstanceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UnassignInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "UnassignInstance");
            try
            {
                #if DESKTOP
                return client.UnassignInstance(request);
                #elif CORECLR
                return client.UnassignInstanceAsync(request).GetAwaiter().GetResult();
                #else
