...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public class UnregisterOPSInstanceAssignmentCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        private static Amazon.OpsWorks.Model.UnassignInstanceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UnassignInstanceRequest request)
        {
