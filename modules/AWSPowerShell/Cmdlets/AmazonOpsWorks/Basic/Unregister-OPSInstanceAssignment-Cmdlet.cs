...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type UnassignInstanceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class UnregisterOPSInstanceAssignmentCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new UnassignInstanceRequest();
            ...
            try
            {
                var response = client.UnassignInstance(request);
