...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public class GetOPSRaidArraysCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.RaidArrayIds != null)
            {
                request.RaidArrayIds = cmdletContext.RaidArrayIds;
            }
            ...
            try
            {
                var response = client.DescribeRaidArrays(request);
                Dictionary<string, object> notes = null;
                object pipelineOutput = response.RaidArrays;
