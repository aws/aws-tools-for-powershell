...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorks DescribeLoadBasedAutoScaling API operation.", Operation = new[] {"DescribeLoadBasedAutoScaling"})]
    ...
    public partial class GetOPSLoadBasedAutoScalingCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.LoadBasedAutoScalingConfigurations;
