...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class RegisterOPSVolumeCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-OPSVolume (RegisterVolume)"))
            {
                return;
            }
            ...
            context.Ec2VolumeId = this.Ec2VolumeId;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.Ec2VolumeId = cmdletContext.Ec2VolumeId;
            }
            ...
            try
            {
                ...
                object pipelineOutput = response.VolumeId;
        ...
        private Amazon.OpsWorks.Model.RegisterVolumeResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.RegisterVolumeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "RegisterVolume");
            try
            {
                #if DESKTOP
                return client.RegisterVolume(request);
                #elif CORECLR
                return client.RegisterVolumeAsync(request).GetAwaiter().GetResult();
                #else
