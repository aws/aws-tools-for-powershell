...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHVirtualRouter")]
    [OutputType("Amazon.AppMesh.Model.VirtualRouterData")]
    [AWSCmdlet("Calls the AWS App Mesh DescribeVirtualRouter API operation.", Operation = new[] {"DescribeVirtualRouter"}, SelectReturnType = typeof(Amazon.AppMesh.Model.DescribeVirtualRouterResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualRouterData or Amazon.AppMesh.Model.DescribeVirtualRouterResponse",
        "This cmdlet returns an Amazon.AppMesh.Model.VirtualRouterData object.",
        "The service call response (type Amazon.AppMesh.Model.DescribeVirtualRouterResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHVirtualRouterCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DescribeVirtualRouterResponse, GetAMSHVirtualRouterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppMesh.Model.DescribeVirtualRouterRequest();
        ...
        private Amazon.AppMesh.Model.DescribeVirtualRouterResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DescribeVirtualRouterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "DescribeVirtualRouter");
            try
            {
                return client.DescribeVirtualRouterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualRouterName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DescribeVirtualRouterResponse, GetAMSHVirtualRouterCmdlet, object> Select { get; set; } =
