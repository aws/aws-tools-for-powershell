...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdletOutput("Amazon.AppMesh.Model.MeshRef or Amazon.AppMesh.Model.ListMeshesResponse",
        ...
        "The service call response (type Amazon.AppMesh.Model.ListMeshesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
