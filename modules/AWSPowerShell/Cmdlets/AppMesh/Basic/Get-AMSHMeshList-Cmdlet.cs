...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHMeshList")]
    [OutputType("Amazon.AppMesh.Model.MeshRef")]
    [AWSCmdlet("Calls the AWS App Mesh ListMeshes API operation.", Operation = new[] {"ListMeshes"}, SelectReturnType = typeof(Amazon.AppMesh.Model.ListMeshesResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.MeshRef or Amazon.AppMesh.Model.ListMeshesResponse",
        "This cmdlet returns a collection of Amazon.AppMesh.Model.MeshRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListMeshesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHMeshListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>ListMeshes</c> in paginated output. When
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListMeshes</c> request
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Meshes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListMeshesResponse, GetAMSHMeshListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppMesh.Model.ListMeshesRequest();
        ...
        private Amazon.AppMesh.Model.ListMeshesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListMeshesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "ListMeshes");
            try
            {
                return client.ListMeshesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListMeshesResponse, GetAMSHMeshListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Meshes;
        }
