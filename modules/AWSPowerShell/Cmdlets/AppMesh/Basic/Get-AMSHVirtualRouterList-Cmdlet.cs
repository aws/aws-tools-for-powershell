...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHVirtualRouterList")]
    [OutputType("Amazon.AppMesh.Model.VirtualRouterRef")]
    [AWSCmdlet("Calls the AWS App Mesh ListVirtualRouters API operation.", Operation = new[] {"ListVirtualRouters"}, SelectReturnType = typeof(Amazon.AppMesh.Model.ListVirtualRoutersResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualRouterRef or Amazon.AppMesh.Model.ListVirtualRoutersResponse",
        "This cmdlet returns a collection of Amazon.AppMesh.Model.VirtualRouterRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListVirtualRoutersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHVirtualRouterListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>ListVirtualRouters</c> in paginated output.
        /// When you use this parameter, <c>ListVirtualRouters</c> returns only <c>limit</c> results
        /// in a single page along with a <c>nextToken</c> response element. You can see the remaining
        /// results of the initial request by sending another <c>ListVirtualRouters</c> request
        /// with the returned <c>nextToken</c> value. This value can be between 1 and 100. If
        /// you don't use this parameter, <c>ListVirtualRouters</c> returns up to 100 results
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListVirtualRouters</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VirtualRouters";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListVirtualRoutersResponse, GetAMSHVirtualRouterListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppMesh.Model.ListVirtualRoutersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.VirtualRouters?.Count ?? 0;
        ...
        private Amazon.AppMesh.Model.ListVirtualRoutersResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListVirtualRoutersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "ListVirtualRouters");
            try
            {
                return client.ListVirtualRoutersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListVirtualRoutersResponse, GetAMSHVirtualRouterListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VirtualRouters;
        }
