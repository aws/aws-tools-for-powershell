...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualRouterRef or Amazon.AppMesh.Model.ListVirtualRoutersResponse",
        ...
        "The service call response (type Amazon.AppMesh.Model.ListVirtualRoutersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
