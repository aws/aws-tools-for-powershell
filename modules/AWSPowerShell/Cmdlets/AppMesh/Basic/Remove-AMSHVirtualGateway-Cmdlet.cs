...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    public partial class RemoveAMSHVirtualGatewayCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMSHVirtualGateway (DeleteVirtualGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DeleteVirtualGatewayResponse, RemoveAMSHVirtualGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppMesh.Model.DeleteVirtualGatewayRequest();
        ...
        private Amazon.AppMesh.Model.DeleteVirtualGatewayResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DeleteVirtualGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "DeleteVirtualGateway");
            try
            {
                #if DESKTOP
                return client.DeleteVirtualGateway(request);
                #elif CORECLR
                return client.DeleteVirtualGatewayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualGatewayName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DeleteVirtualGatewayResponse, RemoveAMSHVirtualGatewayCmdlet, object> Select { get; set; } =
