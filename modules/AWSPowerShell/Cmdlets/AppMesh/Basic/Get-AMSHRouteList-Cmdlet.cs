...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh ListRoutes API operation.", Operation = new[] {"ListRoutes"}, SelectReturnType = typeof(Amazon.AppMesh.Model.ListRoutesResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.RouteRef or Amazon.AppMesh.Model.ListRoutesResponse",
        "This cmdlet returns a collection of Amazon.AppMesh.Model.RouteRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListRoutesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHRouteListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>ListRoutes</c> in paginated output. When
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListRoutes</c> request
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListRoutesResponse, GetAMSHRouteListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String VirtualRouterName { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListRoutesResponse, GetAMSHRouteListCmdlet, object> Select { get; set; } =
