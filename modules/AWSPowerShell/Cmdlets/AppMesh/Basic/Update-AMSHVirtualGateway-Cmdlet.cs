...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Update", "AMSHVirtualGateway", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AppMesh.Model.VirtualGatewayData")]
    [AWSCmdlet("Calls the AWS App Mesh UpdateVirtualGateway API operation.", Operation = new[] {"UpdateVirtualGateway"}, SelectReturnType = typeof(Amazon.AppMesh.Model.UpdateVirtualGatewayResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualGatewayData or Amazon.AppMesh.Model.UpdateVirtualGatewayResponse",
        "This cmdlet returns an Amazon.AppMesh.Model.VirtualGatewayData object.",
        "The service call response (type Amazon.AppMesh.Model.UpdateVirtualGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAMSHVirtualGatewayCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AMSHVirtualGateway (UpdateVirtualGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.UpdateVirtualGatewayResponse, UpdateAMSHVirtualGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppMesh.Model.UpdateVirtualGatewayRequest();
        ...
        private Amazon.AppMesh.Model.UpdateVirtualGatewayResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.UpdateVirtualGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "UpdateVirtualGateway");
            try
            {
                #if DESKTOP
                return client.UpdateVirtualGateway(request);
                #elif CORECLR
                return client.UpdateVirtualGatewayAsync(request).GetAwaiter().GetResult();
                #else
