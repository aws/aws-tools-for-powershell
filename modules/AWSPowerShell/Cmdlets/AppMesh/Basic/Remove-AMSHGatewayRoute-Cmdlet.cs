...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMSHGatewayRoute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.AppMesh.Model.GatewayRouteData")]
    [AWSCmdlet("Calls the AWS App Mesh DeleteGatewayRoute API operation.", Operation = new[] {"DeleteGatewayRoute"}, SelectReturnType = typeof(Amazon.AppMesh.Model.DeleteGatewayRouteResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.GatewayRouteData or Amazon.AppMesh.Model.DeleteGatewayRouteResponse",
        "This cmdlet returns an Amazon.AppMesh.Model.GatewayRouteData object.",
        "The service call response (type Amazon.AppMesh.Model.DeleteGatewayRouteResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAMSHGatewayRouteCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMSHGatewayRoute (DeleteGatewayRoute)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DeleteGatewayRouteResponse, RemoveAMSHGatewayRouteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppMesh.Model.DeleteGatewayRouteRequest();
        ...
        private Amazon.AppMesh.Model.DeleteGatewayRouteResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DeleteGatewayRouteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "DeleteGatewayRoute");
            try
            {
                #if DESKTOP
                return client.DeleteGatewayRoute(request);
                #elif CORECLR
                return client.DeleteGatewayRouteAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualGatewayName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DeleteGatewayRouteResponse, RemoveAMSHGatewayRouteCmdlet, object> Select { get; set; } =
