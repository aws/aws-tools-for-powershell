...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHVirtualGateway")]
    [OutputType("Amazon.AppMesh.Model.VirtualGatewayData")]
    [AWSCmdlet("Calls the AWS App Mesh DescribeVirtualGateway API operation.", Operation = new[] {"DescribeVirtualGateway"}, SelectReturnType = typeof(Amazon.AppMesh.Model.DescribeVirtualGatewayResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualGatewayData or Amazon.AppMesh.Model.DescribeVirtualGatewayResponse",
        "This cmdlet returns an Amazon.AppMesh.Model.VirtualGatewayData object.",
        "The service call response (type Amazon.AppMesh.Model.DescribeVirtualGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMSHVirtualGatewayCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DescribeVirtualGatewayResponse, GetAMSHVirtualGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppMesh.Model.DescribeVirtualGatewayRequest();
        ...
        private Amazon.AppMesh.Model.DescribeVirtualGatewayResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DescribeVirtualGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "DescribeVirtualGateway");
            try
            {
                #if DESKTOP
                return client.DescribeVirtualGateway(request);
                #elif CORECLR
                return client.DescribeVirtualGatewayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualGatewayName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DescribeVirtualGatewayResponse, GetAMSHVirtualGatewayCmdlet, object> Select { get; set; } =
