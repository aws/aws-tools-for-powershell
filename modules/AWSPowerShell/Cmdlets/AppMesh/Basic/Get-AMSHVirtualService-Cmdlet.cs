...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    public partial class GetAMSHVirtualServiceCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DescribeVirtualServiceResponse, GetAMSHVirtualServiceCmdlet>(Select) ??
        ...
        private Amazon.AppMesh.Model.DescribeVirtualServiceResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DescribeVirtualServiceRequest request)
        {
            ...
            try
            {
                return client.DescribeVirtualServiceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualServiceName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DescribeVirtualServiceResponse, GetAMSHVirtualServiceCmdlet, object> Select { get; set; } =
