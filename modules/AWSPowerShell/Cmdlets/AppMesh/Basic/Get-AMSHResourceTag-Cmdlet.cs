...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHResourceTag")]
    [OutputType("Amazon.AppMesh.Model.TagRef")]
    [AWSCmdlet("Calls the AWS App Mesh ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.AppMesh.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.TagRef or Amazon.AppMesh.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.AppMesh.Model.TagRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListTagsForResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMSHResourceTagCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of tag results returned by <c>ListTagsForResource</c> in paginated
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListTagsForResource</c>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListTagsForResourceResponse, GetAMSHResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppMesh.Model.ListTagsForResourceRequest();
        ...
        private Amazon.AppMesh.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListTagsForResourceResponse, GetAMSHResourceTagCmdlet, object> Select { get; set; } =
