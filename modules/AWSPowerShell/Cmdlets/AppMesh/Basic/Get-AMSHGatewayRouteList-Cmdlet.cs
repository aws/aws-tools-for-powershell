...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdletOutput("Amazon.AppMesh.Model.GatewayRouteRef or Amazon.AppMesh.Model.ListGatewayRoutesResponse",
        ...
        "The service call response (type Amazon.AppMesh.Model.ListGatewayRoutesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHGatewayRouteListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>ListGatewayRoutes</c> in paginated output.
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListGatewayRoutes</c>
        ...
        private Amazon.AppMesh.Model.ListGatewayRoutesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListGatewayRoutesRequest request)
        {
            ...
            try
            {
                return client.ListGatewayRoutesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
