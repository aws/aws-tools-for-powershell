...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    public partial class RemoveAMSHVirtualServiceCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DeleteVirtualServiceResponse, RemoveAMSHVirtualServiceCmdlet>(Select) ??
        ...
        private Amazon.AppMesh.Model.DeleteVirtualServiceResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DeleteVirtualServiceRequest request)
        {
            ...
            try
            {
                return client.DeleteVirtualServiceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualServiceName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DeleteVirtualServiceResponse, RemoveAMSHVirtualServiceCmdlet, object> Select { get; set; } =
