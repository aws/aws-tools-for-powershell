...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh ListVirtualNodes API operation.", Operation = new[] {"ListVirtualNodes"}, SelectReturnType = typeof(Amazon.AppMesh.Model.ListVirtualNodesResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualNodeRef or Amazon.AppMesh.Model.ListVirtualNodesResponse",
        "This cmdlet returns a collection of Amazon.AppMesh.Model.VirtualNodeRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListVirtualNodesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHVirtualNodeListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>ListVirtualNodes</c> in paginated output.
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>ListVirtualNodes</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VirtualNodes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListVirtualNodesResponse, GetAMSHVirtualNodeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.VirtualNodes?.Count ?? 0;
        ...
        private Amazon.AppMesh.Model.ListVirtualNodesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListVirtualNodesRequest request)
        {
            ...
            try
            {
                return client.ListVirtualNodesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListVirtualNodesResponse, GetAMSHVirtualNodeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VirtualNodes;
        }
