...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    public partial class GetAMSHVirtualServiceListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VirtualServices";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.ListVirtualServicesResponse, GetAMSHVirtualServiceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.VirtualServices?.Count ?? 0;
        ...
        private Amazon.AppMesh.Model.ListVirtualServicesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListVirtualServicesRequest request)
        {
            ...
            try
            {
                return client.ListVirtualServicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppMesh.Model.ListVirtualServicesResponse, GetAMSHVirtualServiceListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VirtualServices;
        }
