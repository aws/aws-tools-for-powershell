...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh DescribeVirtualNode API operation.", Operation = new[] {"DescribeVirtualNode"}, SelectReturnType = typeof(Amazon.AppMesh.Model.DescribeVirtualNodeResponse))]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualNodeData or Amazon.AppMesh.Model.DescribeVirtualNodeResponse",
        "This cmdlet returns an Amazon.AppMesh.Model.VirtualNodeData object.",
        "The service call response (type Amazon.AppMesh.Model.DescribeVirtualNodeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMSHVirtualNodeCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppMesh.Model.DescribeVirtualNodeResponse, GetAMSHVirtualNodeCmdlet>(Select) ??
        ...
        private Amazon.AppMesh.Model.DescribeVirtualNodeResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DescribeVirtualNodeRequest request)
        {
            ...
            try
            {
                return client.DescribeVirtualNodeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeshOwner { get; set; }
            public System.String VirtualNodeName { get; set; }
            public System.Func<Amazon.AppMesh.Model.DescribeVirtualNodeResponse, GetAMSHVirtualNodeCmdlet, object> Select { get; set; } =
