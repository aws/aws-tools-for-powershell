...
{
    [AWSClientCmdlet("Amazon API Gateway Management API", "AGM", "2018-11-29", "ApiGatewayManagementApi")]
    public abstract partial class AmazonApiGatewayManagementApiClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonApiGatewayManagementApiConfig.ServiceId.ToString();
