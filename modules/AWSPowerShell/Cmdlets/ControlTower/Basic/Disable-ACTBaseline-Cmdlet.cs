...
namespace Amazon.PowerShell.Cmdlets.ACT
{
    ...
    [AWSCmdlet("Calls the AWS Control Tower DisableBaseline API operation.", Operation = new[] {"DisableBaseline"}, SelectReturnType = typeof(Amazon.ControlTower.Model.DisableBaselineResponse))]
    [AWSCmdletOutput("System.String or Amazon.ControlTower.Model.DisableBaselineResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ControlTower.Model.DisableBaselineResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisableACTBaselineCmdlet : AmazonControlTowerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-ACTBaseline (DisableBaseline)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ControlTower.Model.DisableBaselineResponse, DisableACTBaselineCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ControlTower.Model.DisableBaselineRequest();
        ...
        private Amazon.ControlTower.Model.DisableBaselineResponse CallAWSServiceOperation(IAmazonControlTower client, Amazon.ControlTower.Model.DisableBaselineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Control Tower", "DisableBaseline");
            try
            {
                #if DESKTOP
                return client.DisableBaseline(request);
                #elif CORECLR
                return client.DisableBaselineAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EnabledBaselineIdentifier { get; set; }
            public System.Func<Amazon.ControlTower.Model.DisableBaselineResponse, DisableACTBaselineCmdlet, object> Select { get; set; } =
