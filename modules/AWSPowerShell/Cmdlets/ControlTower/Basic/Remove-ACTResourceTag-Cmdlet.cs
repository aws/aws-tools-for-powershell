...
{
    /// <summary>
    /// Removes tags from a resource. For usage examples, see the <a href="https://docs.aws.amazon.com/controltower/latest/controlreference/control-api-examples-short.html"><i>Controls Reference Guide</i></a>.
    /// </summary>
    [Cmdlet("Remove", "ACTResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveACTResourceTagCmdlet : AmazonControlTowerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tag keys to be removed from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ACTResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ControlTower.Model.UntagResourceResponse, RemoveACTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ControlTower.Model.UntagResourceRequest();
        ...
        private Amazon.ControlTower.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonControlTower client, Amazon.ControlTower.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Control Tower", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ControlTower.Model.UntagResourceResponse, RemoveACTResourceTagCmdlet, object> Select { get; set; } =
