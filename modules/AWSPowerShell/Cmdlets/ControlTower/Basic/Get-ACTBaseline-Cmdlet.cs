...
namespace Amazon.PowerShell.Cmdlets.ACT
{
    ...
    [AWSCmdlet("Calls the AWS Control Tower GetBaseline API operation.", Operation = new[] {"GetBaseline"}, SelectReturnType = typeof(Amazon.ControlTower.Model.GetBaselineResponse))]
    [AWSCmdletOutput("Amazon.ControlTower.Model.GetBaselineResponse",
        "This cmdlet returns an Amazon.ControlTower.Model.GetBaselineResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetACTBaselineCmdlet : AmazonControlTowerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BaselineIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ControlTower.Model.GetBaselineResponse, GetACTBaselineCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.BaselineIdentifier;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ControlTower.Model.GetBaselineRequest();
        ...
        private Amazon.ControlTower.Model.GetBaselineResponse CallAWSServiceOperation(IAmazonControlTower client, Amazon.ControlTower.Model.GetBaselineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Control Tower", "GetBaseline");
            try
            {
                #if DESKTOP
                return client.GetBaseline(request);
                #elif CORECLR
                return client.GetBaselineAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String BaselineIdentifier { get; set; }
            public System.Func<Amazon.ControlTower.Model.GetBaselineResponse, GetACTBaselineCmdlet, object> Select { get; set; } =
