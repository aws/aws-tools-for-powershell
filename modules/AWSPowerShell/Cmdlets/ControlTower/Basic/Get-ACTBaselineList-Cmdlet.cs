...
{
    /// <summary>
    /// Returns a summary list of all available baselines. For usage examples, see <a href="https://docs.aws.amazon.com/controltower/latest/userguide/baseline-api-examples.html"><i>the Amazon Web Services Control Tower User Guide</i></a>.
    /// </summary>
    [Cmdlet("Get", "ACTBaselineList")]
    [OutputType("Amazon.ControlTower.Model.BaselineSummary")]
    ...
    public partial class GetACTBaselineListCmdlet : AmazonControlTowerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Baselines";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ControlTower.Model.ListBaselinesResponse, GetACTBaselineListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ControlTower.Model.ListBaselinesRequest();
        ...
        private Amazon.ControlTower.Model.ListBaselinesResponse CallAWSServiceOperation(IAmazonControlTower client, Amazon.ControlTower.Model.ListBaselinesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Control Tower", "ListBaselines");
            try
            {
                #if DESKTOP
                return client.ListBaselines(request);
                #elif CORECLR
                return client.ListBaselinesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ControlTower.Model.ListBaselinesResponse, GetACTBaselineListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Baselines;
        }
