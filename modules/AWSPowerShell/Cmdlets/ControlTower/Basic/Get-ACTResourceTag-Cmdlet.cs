...
{
    /// <summary>
    /// Returns a list of tags associated with the resource. For usage examples, see the <a href="https://docs.aws.amazon.com/controltower/latest/controlreference/control-api-examples-short.html"><i>Controls Reference Guide</i></a>.
    /// </summary>
    ...
    [AWSCmdletOutput("System.String or Amazon.ControlTower.Model.ListTagsForResourceResponse",
        ...
        "The service call response (type Amazon.ControlTower.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
