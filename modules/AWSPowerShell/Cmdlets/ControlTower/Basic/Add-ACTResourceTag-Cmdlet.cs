...
{
    /// <summary>
    /// Applies tags to a resource. For usage examples, see the <a href="https://docs.aws.amazon.com/controltower/latest/controlreference/control-api-examples-short.html"><i>Controls Reference Guide</i></a>.
    /// </summary>
    ...
    [AWSCmdletOutput("None or Amazon.ControlTower.Model.TagResourceResponse",
        ...
        "The service response (type Amazon.ControlTower.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddACTResourceTagCmdlet : AmazonControlTowerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to be applied to the resource.</para><para />
