...
namespace Amazon.PowerShell.Cmdlets.PIPES
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PIPESPipe", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemovePIPESPipeCmdlet : AmazonPipesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PIPESPipe (DeletePipe)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pipes.Model.DeletePipeResponse, RemovePIPESPipeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pipes.Model.DeletePipeRequest();
        ...
        private Amazon.Pipes.Model.DeletePipeResponse CallAWSServiceOperation(IAmazonPipes client, Amazon.Pipes.Model.DeletePipeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Pipes", "DeletePipe");
            try
            {
                #if DESKTOP
                return client.DeletePipe(request);
                #elif CORECLR
                return client.DeletePipeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Pipes.Model.DeletePipeResponse, RemovePIPESPipeCmdlet, object> Select { get; set; } =
