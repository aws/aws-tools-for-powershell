...
namespace Amazon.PowerShell.Cmdlets.PIPES
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "PIPESResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddPIPESResourceTagCmdlet : AmazonPipesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of key-value pairs associated with the pipe.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-PIPESResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pipes.Model.TagResourceResponse, AddPIPESResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pipes.Model.TagResourceRequest();
        ...
        private Amazon.Pipes.Model.TagResourceResponse CallAWSServiceOperation(IAmazonPipes client, Amazon.Pipes.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Pipes", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Pipes.Model.TagResourceResponse, AddPIPESResourceTagCmdlet, object> Select { get; set; } =
