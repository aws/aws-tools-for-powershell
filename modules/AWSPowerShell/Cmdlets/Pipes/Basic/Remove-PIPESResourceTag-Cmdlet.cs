...
namespace Amazon.PowerShell.Cmdlets.PIPES
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PIPESResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePIPESResourceTagCmdlet : AmazonPipesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of tag keys to remove from the pipe.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PIPESResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pipes.Model.UntagResourceResponse, RemovePIPESResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pipes.Model.UntagResourceRequest();
        ...
        private Amazon.Pipes.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPipes client, Amazon.Pipes.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Pipes", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Pipes.Model.UntagResourceResponse, RemovePIPESResourceTagCmdlet, object> Select { get; set; } =
