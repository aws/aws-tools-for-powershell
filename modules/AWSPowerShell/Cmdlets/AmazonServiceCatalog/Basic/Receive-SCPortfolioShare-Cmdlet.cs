...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Invokes the AcceptPortfolioShare operation against AWS Service Catalog.", Operation = new[] {"AcceptPortfolioShare"})]
    ...
    public partial class ReceiveSCPortfolioShareCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ServiceCatalog.Model.AcceptPortfolioShareResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.AcceptPortfolioShareRequest request)
        {
            #if DESKTOP
            return client.AcceptPortfolioShare(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.AcceptPortfolioShareAsync(request);
            return task.Result;
            #else
