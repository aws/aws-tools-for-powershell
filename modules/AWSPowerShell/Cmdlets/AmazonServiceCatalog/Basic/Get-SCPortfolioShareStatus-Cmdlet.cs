...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog DescribePortfolioShareStatus API operation.", Operation = new[] {"DescribePortfolioShareStatus"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.DescribePortfolioShareStatusResponse",
        "This cmdlet returns a Amazon.ServiceCatalog.Model.DescribePortfolioShareStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSCPortfolioShareStatusCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        private Amazon.ServiceCatalog.Model.DescribePortfolioShareStatusResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DescribePortfolioShareStatusRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribePortfolioShareStatusAsync(request);
                return task.Result;
                #else
