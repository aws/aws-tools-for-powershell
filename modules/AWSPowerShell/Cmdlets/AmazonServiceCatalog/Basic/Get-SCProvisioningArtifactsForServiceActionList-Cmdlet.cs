...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// </summary>
    [Cmdlet("Get", "SCProvisioningArtifactsForServiceActionList")]
    [OutputType("Amazon.ServiceCatalog.Model.ProvisioningArtifactView")]
    [AWSCmdlet("Calls the AWS Service Catalog ListProvisioningArtifactsForServiceAction API operation.", Operation = new[] {"ListProvisioningArtifactsForServiceAction"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ProvisioningArtifactView",
        "This cmdlet returns a collection of ProvisioningArtifactView objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetSCProvisioningArtifactsForServiceActionListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ProvisioningArtifactViews;
                        ...
                        int _receivedThisCall = response.ProvisioningArtifactViews.Count;
        ...
        private Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListProvisioningArtifactsForServiceAction");
            try
            {
                #if DESKTOP
