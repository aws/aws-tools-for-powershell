...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class RemoveSCTagOptionFromResourceCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCTagOptionFromResource (DisassociateTagOptionFromResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceCatalog.Model.DisassociateTagOptionFromResourceRequest();
        ...
        private Amazon.ServiceCatalog.Model.DisassociateTagOptionFromResourceResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DisassociateTagOptionFromResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "DisassociateTagOptionFromResource");
            try
            {
                #if DESKTOP
