...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog GetAWSOrganizationsAccessStatus API operation.", Operation = new[] {"GetAWSOrganizationsAccessStatus"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.AccessStatus",
        "This cmdlet returns a AccessStatus object.",
    ...
    public partial class GetSCAWSOrganizationsAccessStatusCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.AccessStatus;
