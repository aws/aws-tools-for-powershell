...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// </summary>
    [Cmdlet("Get", "SCAcceptedPortfolioSharesList")]
    [OutputType("Amazon.ServiceCatalog.Model.PortfolioDetail")]
    [AWSCmdlet("Invokes the ListAcceptedPortfolioShares operation against AWS Service Catalog.", Operation = new[] {"ListAcceptedPortfolioShares"})]
    ...
    public partial class GetSCAcceptedPortfolioSharesListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesRequest request)
        {
            #if DESKTOP
