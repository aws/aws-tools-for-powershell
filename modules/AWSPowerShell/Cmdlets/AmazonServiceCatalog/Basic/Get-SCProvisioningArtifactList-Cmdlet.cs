...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Invokes the ListProvisioningArtifacts operation against AWS Service Catalog.", Operation = new[] {"ListProvisioningArtifacts"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ProvisioningArtifactDetail",
        "This cmdlet returns a collection of ProvisioningArtifactDetail objects.",
    ...
    public partial class GetSCProvisioningArtifactListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.ProvisioningArtifactDetails;
        ...
        private Amazon.ServiceCatalog.Model.ListProvisioningArtifactsResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListProvisioningArtifactsRequest request)
        {
            ...
            var task = client.ListProvisioningArtifactsAsync(request);
            return task.Result;
            #else
