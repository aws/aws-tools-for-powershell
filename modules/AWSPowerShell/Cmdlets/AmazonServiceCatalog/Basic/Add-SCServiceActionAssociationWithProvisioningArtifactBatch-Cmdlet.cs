...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog BatchAssociateServiceActionWithProvisioningArtifact API operation.", Operation = new[] {"BatchAssociateServiceActionWithProvisioningArtifact"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.FailedServiceActionAssociation",
        ...
        "The service call response (type Amazon.ServiceCatalog.Model.BatchAssociateServiceActionWithProvisioningArtifactResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddSCServiceActionAssociationWithProvisioningArtifactBatchCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        private Amazon.ServiceCatalog.Model.BatchAssociateServiceActionWithProvisioningArtifactResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.BatchAssociateServiceActionWithProvisioningArtifactRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchAssociateServiceActionWithProvisioningArtifact(request);
                #elif CORECLR
                return client.BatchAssociateServiceActionWithProvisioningArtifactAsync(request).GetAwaiter().GetResult();
                #else
