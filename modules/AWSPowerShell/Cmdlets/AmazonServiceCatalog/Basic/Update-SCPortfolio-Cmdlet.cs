...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Invokes the UpdatePortfolio operation against AWS Service Catalog.", Operation = new[] {"UpdatePortfolio"})]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.UpdatePortfolioResponse",
        "This cmdlet returns a Amazon.ServiceCatalog.Model.UpdatePortfolioResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSCPortfolioCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ServiceCatalog.Model.UpdatePortfolioResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.UpdatePortfolioRequest request)
        {
            #if DESKTOP
            return client.UpdatePortfolio(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.UpdatePortfolioAsync(request);
            return task.Result;
            #else
