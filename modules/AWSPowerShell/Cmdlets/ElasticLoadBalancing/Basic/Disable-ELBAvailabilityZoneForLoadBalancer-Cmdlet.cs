...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    [AWSCmdlet("Calls the Elastic Load Balancing DisableAvailabilityZonesForLoadBalancer API operation.", Operation = new[] {"DisableAvailabilityZonesForLoadBalancer"}, SelectReturnType = typeof(Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse))]
    [AWSCmdletOutput("System.String or Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse) can be returned by specifying '-Select *'."
    )]
    public partial class DisableELBAvailabilityZoneForLoadBalancerCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Availability Zones.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse, DisableELBAvailabilityZoneForLoadBalancerCmdlet>(Select) ??
        ...
        private Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerRequest request)
        {
            ...
            try
            {
                return client.DisableAvailabilityZonesForLoadBalancerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LoadBalancerName { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.DisableAvailabilityZonesForLoadBalancerResponse, DisableELBAvailabilityZoneForLoadBalancerCmdlet, object> Select { get; set; } =
