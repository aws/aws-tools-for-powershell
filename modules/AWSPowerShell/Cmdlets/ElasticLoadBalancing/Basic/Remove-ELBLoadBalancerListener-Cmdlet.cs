...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ELBLoadBalancerListener", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Elastic Load Balancing DeleteLoadBalancerListeners API operation.", Operation = new[] {"DeleteLoadBalancerListeners"}, SelectReturnType = typeof(Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse))]
    [AWSCmdletOutput("None or Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveELBLoadBalancerListenerCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The client port numbers of the listeners.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.LoadBalancerPort), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ELBLoadBalancerListener (DeleteLoadBalancerListeners)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse, RemoveELBLoadBalancerListenerCmdlet>(Select) ??
            ...
            {
                context.LoadBalancerPort = new List<System.Int32>(this.LoadBalancerPort);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.LoadBalancerPorts = cmdletContext.LoadBalancerPort;
            }
        ...
        private Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersRequest request)
        {
            ...
            try
            {
                return client.DeleteLoadBalancerListenersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String LoadBalancerName { get; set; }
            public List<System.Int32> LoadBalancerPort { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerListenersResponse, RemoveELBLoadBalancerListenerCmdlet, object> Select { get; set; } =
