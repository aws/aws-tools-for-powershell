...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    public partial class SetELBLoadBalancerListenerSSLCertificateCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.SetLoadBalancerListenerSSLCertificateResponse, SetELBLoadBalancerListenerSSLCertificateCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.SSLCertificateId == null && ParameterWasBound(nameof(this.SSLCertificateId)))
            {
                WriteWarning("You are passing $null as a value for parameter SSLCertificateId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.ElasticLoadBalancing.Model.SetLoadBalancerListenerSSLCertificateResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.SetLoadBalancerListenerSSLCertificateRequest request)
        {
            ...
            try
            {
                return client.SetLoadBalancerListenerSSLCertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? LoadBalancerPort { get; set; }
            public System.String SSLCertificateId { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.SetLoadBalancerListenerSSLCertificateResponse, SetELBLoadBalancerListenerSSLCertificateCmdlet, object> Select { get; set; } =
