...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ELBLoadBalancerPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Elastic Load Balancing DeleteLoadBalancerPolicy API operation.", Operation = new[] {"DeleteLoadBalancerPolicy"}, SelectReturnType = typeof(Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveELBLoadBalancerPolicyCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ELBLoadBalancerPolicy (DeleteLoadBalancerPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse, RemoveELBLoadBalancerPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyRequest();
        ...
        private Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String LoadBalancerName { get; set; }
            public System.String PolicyName { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerPolicyResponse, RemoveELBLoadBalancerPolicyCmdlet, object> Select { get; set; } =
