...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    public partial class RemoveELBLoadBalancerCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerResponse, RemoveELBLoadBalancerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerRequest();
        ...
        private Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Load Balancing", "DeleteLoadBalancer");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String LoadBalancerName { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.DeleteLoadBalancerResponse, RemoveELBLoadBalancerCmdlet, object> Select { get; set; } =
