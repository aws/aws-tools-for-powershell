...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    [OutputType("Amazon.ElasticLoadBalancing.Model.Limit")]
    [AWSCmdlet("Calls the Elastic Load Balancing DescribeAccountLimits API operation.", Operation = new[] {"DescribeAccountLimits"}, SelectReturnType = typeof(Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse))]
    [AWSCmdletOutput("Amazon.ElasticLoadBalancing.Model.Limit or Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse",
        "This cmdlet returns a collection of Amazon.ElasticLoadBalancing.Model.Limit objects.",
        "The service call response (type Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetELBAccountLimitCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Limits";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse, GetELBAccountLimitCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                {
                    int correctPageSize = AutoIterationHelpers.Min(400, _emitLimit.Value);
        ...
        private Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse CallAWSServiceOperation(IAmazonElasticLoadBalancing client, Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Load Balancing", "DescribeAccountLimits");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.ElasticLoadBalancing.Model.DescribeAccountLimitsResponse, GetELBAccountLimitCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Limits;
        }
