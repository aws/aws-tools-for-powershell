...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Analytics V2 DeleteApplicationOutput API operation.", Operation = new[] {"DeleteApplicationOutput"}, SelectReturnType = typeof(Amazon.KinesisAnalyticsV2.Model.DeleteApplicationOutputResponse))]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationOutputResponse",
        "This cmdlet returns an Amazon.KinesisAnalyticsV2.Model.DeleteApplicationOutputResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveKINA2ApplicationOutputCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalyticsV2.Model.DeleteApplicationOutputResponse, RemoveKINA2ApplicationOutputCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int64? CurrentApplicationVersionId { get; set; }
            public System.String OutputId { get; set; }
            public System.Func<Amazon.KinesisAnalyticsV2.Model.DeleteApplicationOutputResponse, RemoveKINA2ApplicationOutputCmdlet, object> Select { get; set; } =
