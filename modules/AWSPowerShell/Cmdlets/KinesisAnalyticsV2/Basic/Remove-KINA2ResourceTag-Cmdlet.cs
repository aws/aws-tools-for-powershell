...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    public partial class RemoveKINA2ResourceTagCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KINA2ResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalyticsV2.Model.UntagResourceResponse, RemoveKINA2ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KinesisAnalyticsV2.Model.UntagResourceRequest();
        ...
        private Amazon.KinesisAnalyticsV2.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics V2", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.KinesisAnalyticsV2.Model.UntagResourceResponse, RemoveKINA2ResourceTagCmdlet, object> Select { get; set; } =
