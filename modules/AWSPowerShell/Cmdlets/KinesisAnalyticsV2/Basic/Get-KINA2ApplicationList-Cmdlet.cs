...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    /// </summary>
    [Cmdlet("Get", "KINA2ApplicationList")]
    [OutputType("Amazon.KinesisAnalyticsV2.Model.ApplicationSummary")]
    [AWSCmdlet("Calls the Amazon Kinesis Analytics V2 ListApplications API operation.", Operation = new[] {"ListApplications"}, SelectReturnType = typeof(Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse))]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.ApplicationSummary or Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse",
        "This cmdlet returns a collection of Amazon.KinesisAnalyticsV2.Model.ApplicationSummary objects.",
        "The service call response (type Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetKINA2ApplicationListCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse, GetKINA2ApplicationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.KinesisAnalyticsV2.Model.ListApplicationsRequest();
        ...
        private Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.ListApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics V2", "ListApplications");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.KinesisAnalyticsV2.Model.ListApplicationsResponse, GetKINA2ApplicationListCmdlet, object> Select { get; set; } =
