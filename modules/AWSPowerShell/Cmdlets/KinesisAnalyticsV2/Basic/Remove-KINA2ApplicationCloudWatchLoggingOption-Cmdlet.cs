...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationCloudWatchLoggingOptionResponse",
        "This cmdlet returns an Amazon.KinesisAnalyticsV2.Model.DeleteApplicationCloudWatchLoggingOptionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveKINA2ApplicationCloudWatchLoggingOptionCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The version ID of the application. You must provide the <code>CurrentApplicationVersionId</code>
