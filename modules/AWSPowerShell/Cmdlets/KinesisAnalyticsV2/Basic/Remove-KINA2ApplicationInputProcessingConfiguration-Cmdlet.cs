...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "KINA2ApplicationInputProcessingConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse")]
    [AWSCmdlet("Calls the Amazon Kinesis Analytics V2 DeleteApplicationInputProcessingConfiguration API operation.", Operation = new[] {"DeleteApplicationInputProcessingConfiguration"}, SelectReturnType = typeof(Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse))]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse",
        "This cmdlet returns an Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveKINA2ApplicationInputProcessingConfigurationCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KINA2ApplicationInputProcessingConfiguration (DeleteApplicationInputProcessingConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse, RemoveKINA2ApplicationInputProcessingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationRequest();
        ...
        private Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics V2", "DeleteApplicationInputProcessingConfiguration");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int64? CurrentApplicationVersionId { get; set; }
            public System.String InputId { get; set; }
            public System.Func<Amazon.KinesisAnalyticsV2.Model.DeleteApplicationInputProcessingConfigurationResponse, RemoveKINA2ApplicationInputProcessingConfigurationCmdlet, object> Select { get; set; } =
