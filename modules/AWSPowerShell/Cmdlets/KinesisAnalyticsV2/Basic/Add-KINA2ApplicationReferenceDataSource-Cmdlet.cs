...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Analytics V2 AddApplicationReferenceDataSource API operation.", Operation = new[] {"AddApplicationReferenceDataSource"}, SelectReturnType = typeof(Amazon.KinesisAnalyticsV2.Model.AddApplicationReferenceDataSourceResponse))]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.AddApplicationReferenceDataSourceResponse",
        "This cmdlet returns an Amazon.KinesisAnalyticsV2.Model.AddApplicationReferenceDataSourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddKINA2ApplicationReferenceDataSourceCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ReferenceDataSource' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalyticsV2.Model.AddApplicationReferenceDataSourceResponse, AddKINA2ApplicationReferenceDataSourceCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ReferenceDataSource;
            }
            ...
            #if MODULAR
            if (this.ReferenceDataSource == null && ParameterWasBound(nameof(this.ReferenceDataSource)))
            {
                WriteWarning("You are passing $null as a value for parameter ReferenceDataSource which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int64? CurrentApplicationVersionId { get; set; }
            public Amazon.KinesisAnalyticsV2.Model.ReferenceDataSource ReferenceDataSource { get; set; }
            public System.Func<Amazon.KinesisAnalyticsV2.Model.AddApplicationReferenceDataSourceResponse, AddKINA2ApplicationReferenceDataSourceCmdlet, object> Select { get; set; } =
