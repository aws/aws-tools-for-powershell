...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class GetGLUEColumnStatisticsForTableCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetColumnStatisticsForTableResponse, GetGLUEColumnStatisticsForTableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetColumnStatisticsForTableRequest();
        ...
        private Amazon.Glue.Model.GetColumnStatisticsForTableResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetColumnStatisticsForTableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetColumnStatisticsForTable");
            try
            {
                #if DESKTOP
                return client.GetColumnStatisticsForTable(request);
                #elif CORECLR
                return client.GetColumnStatisticsForTableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DatabaseName { get; set; }
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.GetColumnStatisticsForTableResponse, GetGLUEColumnStatisticsForTableCmdlet, object> Select { get; set; } =
