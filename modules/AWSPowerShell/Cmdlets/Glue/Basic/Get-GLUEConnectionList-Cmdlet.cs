...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetConnections API operation.", Operation = new[] {"GetConnections"}, SelectReturnType = typeof(Amazon.Glue.Model.GetConnectionsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.Connection or Amazon.Glue.Model.GetConnectionsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.Connection objects.",
        "The service call response (type Amazon.Glue.Model.GetConnectionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEConnectionListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConnectionList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetConnectionsResponse, GetGLUEConnectionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ConnectionList?.Count ?? 0;
        ...
        private Amazon.Glue.Model.GetConnectionsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetConnectionsRequest request)
        {
            ...
            try
            {
                return client.GetConnectionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetConnectionsResponse, GetGLUEConnectionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConnectionList;
        }
