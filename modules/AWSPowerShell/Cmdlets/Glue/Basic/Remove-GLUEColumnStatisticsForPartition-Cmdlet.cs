...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class RemoveGLUEColumnStatisticsForPartitionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUEColumnStatisticsForPartition (DeleteColumnStatisticsForPartition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeleteColumnStatisticsForPartitionResponse, RemoveGLUEColumnStatisticsForPartitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.DeleteColumnStatisticsForPartitionRequest();
        ...
        private Amazon.Glue.Model.DeleteColumnStatisticsForPartitionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteColumnStatisticsForPartitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteColumnStatisticsForPartition");
            try
            {
                #if DESKTOP
                return client.DeleteColumnStatisticsForPartition(request);
                #elif CORECLR
                return client.DeleteColumnStatisticsForPartitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.DeleteColumnStatisticsForPartitionResponse, RemoveGLUEColumnStatisticsForPartitionCmdlet, object> Select { get; set; } =
