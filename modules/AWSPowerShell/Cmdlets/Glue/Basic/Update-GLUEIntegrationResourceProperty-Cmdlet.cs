...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// using it.
    /// </summary>
    [Cmdlet("Update", "GLUEIntegrationResourceProperty", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse")]
    [AWSCmdlet("Calls the AWS Glue UpdateIntegrationResourceProperty API operation.", Operation = new[] {"UpdateIntegrationResourceProperty"}, SelectReturnType = typeof(Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse",
        "This cmdlet returns an Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse object containing multiple properties."
    )]
    public partial class UpdateGLUEIntegrationResourcePropertyCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GLUEIntegrationResourceProperty (UpdateIntegrationResourceProperty)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse, UpdateGLUEIntegrationResourcePropertyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.UpdateIntegrationResourcePropertyRequest();
        ...
        private Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateIntegrationResourcePropertyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "UpdateIntegrationResourceProperty");
            try
            {
                #if DESKTOP
                return client.UpdateIntegrationResourceProperty(request);
                #elif CORECLR
                return client.UpdateIntegrationResourcePropertyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TargetProcessingProperties_KmsArn { get; set; }
            public System.String TargetProcessingProperties_RoleArn { get; set; }
            public System.Func<Amazon.Glue.Model.UpdateIntegrationResourcePropertyResponse, UpdateGLUEIntegrationResourcePropertyCmdlet, object> Select { get; set; } =
