...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GLUEConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue DeleteConnection API operation.", Operation = new[] {"DeleteConnection"}, SelectReturnType = typeof(Amazon.Glue.Model.DeleteConnectionResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.DeleteConnectionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.DeleteConnectionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGLUEConnectionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUEConnection (DeleteConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeleteConnectionResponse, RemoveGLUEConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.DeleteConnectionRequest();
        ...
        private Amazon.Glue.Model.DeleteConnectionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteConnection");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CatalogId { get; set; }
            public System.String ConnectionName { get; set; }
            public System.Func<Amazon.Glue.Model.DeleteConnectionResponse, RemoveGLUEConnectionCmdlet, object> Select { get; set; } =
