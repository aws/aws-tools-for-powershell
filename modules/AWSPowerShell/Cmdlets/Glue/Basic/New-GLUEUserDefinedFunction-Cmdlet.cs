...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue CreateUserDefinedFunction API operation.", Operation = new[] {"CreateUserDefinedFunction"}, SelectReturnType = typeof(Amazon.Glue.Model.CreateUserDefinedFunctionResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.CreateUserDefinedFunctionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.CreateUserDefinedFunctionResponse) be returned by specifying '-Select *'."
    )]
    public partial class NewGLUEUserDefinedFunctionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A <c>FunctionInput</c> object that defines the function to create in the Data Catalog.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^FunctionInput' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.CreateUserDefinedFunctionResponse, NewGLUEUserDefinedFunctionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.FunctionInput;
            }
            ...
            #if MODULAR
            if (this.FunctionInput == null && ParameterWasBound(nameof(this.FunctionInput)))
            {
                WriteWarning("You are passing $null as a value for parameter FunctionInput which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DatabaseName { get; set; }
            public Amazon.Glue.Model.UserDefinedFunctionInput FunctionInput { get; set; }
            public System.Func<Amazon.Glue.Model.CreateUserDefinedFunctionResponse, NewGLUEUserDefinedFunctionCmdlet, object> Select { get; set; } =
