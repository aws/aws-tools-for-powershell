...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class StartGLUEJobRunCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>This field is deprecated. Use <code>MaxCapacity</code> instead.</para><para>The number of Glue data processing units (DPUs) to allocate to this JobRun. From 2
