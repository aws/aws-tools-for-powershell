...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Update", "GLUEUsageProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateGLUEUsageProfileCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A key-value map of configuration parameters for Glue jobs. </para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A key-value map of configuration parameters for Glue sessions. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.UpdateUsageProfileResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.UpdateUsageProfileResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GLUEUsageProfile (UpdateUsageProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdateUsageProfileResponse, UpdateGLUEUsageProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.UpdateUsageProfileRequest();
        ...
        private Amazon.Glue.Model.UpdateUsageProfileResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateUsageProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "UpdateUsageProfile");
            try
            {
                return client.UpdateUsageProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.Glue.Model.UpdateUsageProfileResponse, UpdateGLUEUsageProfileCmdlet, object> Select { get; set; } =
