...
{
    /// <summary>
    /// Retrieves a list of data quality statistics.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "GLUEDataQualityStatisticList")]
    [OutputType("Amazon.Glue.Model.StatisticSummary")]
    [AWSCmdlet("Calls the AWS Glue ListDataQualityStatistics API operation.", Operation = new[] {"ListDataQualityStatistics"}, SelectReturnType = typeof(Amazon.Glue.Model.ListDataQualityStatisticsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.StatisticSummary or Amazon.Glue.Model.ListDataQualityStatisticsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.StatisticSummary objects.",
        "The service call response (type Amazon.Glue.Model.ListDataQualityStatisticsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUEDataQualityStatisticListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.ListDataQualityStatisticsResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.ListDataQualityStatisticsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.ListDataQualityStatisticsResponse, GetGLUEDataQualityStatisticListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.ListDataQualityStatisticsRequest();
        ...
        private Amazon.Glue.Model.ListDataQualityStatisticsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.ListDataQualityStatisticsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "ListDataQualityStatistics");
            try
            {
                #if DESKTOP
                return client.ListDataQualityStatistics(request);
                #elif CORECLR
                return client.ListDataQualityStatisticsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? TimestampFilter_RecordedAfter { get; set; }
            public System.DateTime? TimestampFilter_RecordedBefore { get; set; }
            public System.Func<Amazon.Glue.Model.ListDataQualityStatisticsResponse, GetGLUEDataQualityStatisticListCmdlet, object> Select { get; set; } =
