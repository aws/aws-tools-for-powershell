...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.StartMLEvaluationTaskRunResponse",
        ...
        "The service call response (type Amazon.Glue.Model.StartMLEvaluationTaskRunResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
