...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("New", "GLUECatalog", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue CreateCatalog API operation.", Operation = new[] {"CreateCatalog"}, SelectReturnType = typeof(Amazon.Glue.Model.CreateCatalogResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.CreateCatalogResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.CreateCatalogResponse) be returned by specifying '-Select *'."
    )]
    public partial class NewGLUECatalogCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the catalog to create.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>A map array of key-value pairs, not more than 50 pairs. Each key is a UTF-8 string,
        /// not less than 1 or more than 128 bytes long. Each value is a UTF-8 string, not more
        /// than 256 bytes long. The tags you assign to the catalog.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.CreateCatalogResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-GLUECatalog (CreateCatalog)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.CreateCatalogRequest();
        ...
        private Amazon.Glue.Model.CreateCatalogResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.CreateCatalogRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Glue.Model.CreateCatalogResponse, NewGLUECatalogCmdlet, object> Select { get; set; } =
