...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Write", "GLUEAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Glue.Model.PutAttachmentResponse")]
    [AWSCmdlet("Calls the AWS Glue PutAttachment API operation.", Operation = new[] {"PutAttachment"}, SelectReturnType = typeof(Amazon.Glue.Model.PutAttachmentResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.PutAttachmentResponse",
        "This cmdlet returns an Amazon.Glue.Model.PutAttachmentResponse object containing multiple properties."
    )]
    public partial class WriteGLUEAttachmentCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the asset to attach the form to.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The JSON content of the form, conforming to the schema of the specified form type.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #region Parameter FormTypeId
        /// <summary>
        /// <para>
        /// <para>The identifier of the form type for this attachment.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String FormTypeId { get; set; }
        #endregion
        ...
        /// attachment targets an item within the iterable form rather than the asset itself.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.PutAttachmentResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.PutAttachmentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-GLUEAttachment (PutAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.PutAttachmentResponse, WriteGLUEAttachmentCmdlet>(Select) ??
            ...
            #endif
            context.FormTypeId = this.FormTypeId;
            #if MODULAR
            if (this.FormTypeId == null && ParameterWasBound(nameof(this.FormTypeId)))
            {
                WriteWarning("You are passing $null as a value for parameter FormTypeId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.PutAttachmentRequest();
            ...
            if (cmdletContext.FormTypeId != null)
            {
                request.FormTypeId = cmdletContext.FormTypeId;
            }
        ...
        private Amazon.Glue.Model.PutAttachmentResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.PutAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "PutAttachment");
            try
            {
                return client.PutAttachmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ItemIdentifier { get; set; }
            public System.String IterableFormName { get; set; }
            public System.Func<Amazon.Glue.Model.PutAttachmentResponse, WriteGLUEAttachmentCmdlet, object> Select { get; set; } =
