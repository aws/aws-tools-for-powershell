...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.Glue.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddGLUEResourceTagCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.Collections.Hashtable TagsToAdd { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-GLUEResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.TagResourceResponse, AddGLUEResourceTagCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.TagsToAdd == null && ParameterWasBound(nameof(this.TagsToAdd)))
            {
                WriteWarning("You are passing $null as a value for parameter TagsToAdd which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.TagResourceRequest();
        ...
        {
            public System.String ResourceArn { get; set; }
            public Dictionary<System.String, System.String> TagsToAdd { get; set; }
            public System.Func<Amazon.Glue.Model.TagResourceResponse, AddGLUEResourceTagCmdlet, object> Select { get; set; } =
