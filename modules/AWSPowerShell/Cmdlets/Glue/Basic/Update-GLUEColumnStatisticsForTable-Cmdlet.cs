...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class UpdateGLUEColumnStatisticsForTableCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GLUEColumnStatisticsForTable (UpdateColumnStatisticsForTable)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdateColumnStatisticsForTableResponse, UpdateGLUEColumnStatisticsForTableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.UpdateColumnStatisticsForTableRequest();
        ...
        private Amazon.Glue.Model.UpdateColumnStatisticsForTableResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateColumnStatisticsForTableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "UpdateColumnStatisticsForTable");
            try
            {
                #if DESKTOP
                return client.UpdateColumnStatisticsForTable(request);
                #elif CORECLR
                return client.UpdateColumnStatisticsForTableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DatabaseName { get; set; }
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.UpdateColumnStatisticsForTableResponse, UpdateGLUEColumnStatisticsForTableCmdlet, object> Select { get; set; } =
