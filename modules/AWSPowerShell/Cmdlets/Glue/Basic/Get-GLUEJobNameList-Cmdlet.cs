...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.Glue.Model.ListJobsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.ListJobsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Glue.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEJobNameListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "JobNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.ListJobsResponse, GetGLUEJobNameListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.JobNames?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Glue.Model.ListJobsResponse, GetGLUEJobNameListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.JobNames;
        }
