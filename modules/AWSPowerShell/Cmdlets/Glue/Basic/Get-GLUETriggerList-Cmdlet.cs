...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUETriggerList")]
    [OutputType("Amazon.Glue.Model.Trigger")]
    [AWSCmdlet("Calls the AWS Glue GetTriggers API operation.", Operation = new[] {"GetTriggers"}, SelectReturnType = typeof(Amazon.Glue.Model.GetTriggersResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.Trigger or Amazon.Glue.Model.GetTriggersResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.Trigger objects.",
        "The service call response (type Amazon.Glue.Model.GetTriggersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUETriggerListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Triggers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetTriggersResponse, GetGLUETriggerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.GetTriggersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Triggers?.Count ?? 0;
        ...
        private Amazon.Glue.Model.GetTriggersResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetTriggersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetTriggers");
            try
            {
                #if DESKTOP
                return client.GetTriggers(request);
                #elif CORECLR
                return client.GetTriggersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetTriggersResponse, GetGLUETriggerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Triggers;
        }
