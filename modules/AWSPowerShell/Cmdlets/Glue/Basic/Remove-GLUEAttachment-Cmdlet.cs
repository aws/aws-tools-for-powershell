...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GLUEAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Glue DeleteAttachment API operation.", Operation = new[] {"DeleteAttachment"}, SelectReturnType = typeof(Amazon.Glue.Model.DeleteAttachmentResponse))]
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.DeleteAttachmentResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Glue.Model.DeleteAttachmentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveGLUEAttachmentCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the attachment to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUEAttachment (DeleteAttachment)"))
            {
                return;
            }
        ...
        private Amazon.Glue.Model.DeleteAttachmentResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteAttachment");
            try
            {
