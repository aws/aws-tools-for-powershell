...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// version ID.
    /// </summary>
    [Cmdlet("Remove", "GLUESchemaVersionMetadata", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveGLUESchemaVersionMetadataCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUESchemaVersionMetadata (RemoveSchemaVersionMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.RemoveSchemaVersionMetadataResponse, RemoveGLUESchemaVersionMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.RemoveSchemaVersionMetadataRequest();
        ...
        private Amazon.Glue.Model.RemoveSchemaVersionMetadataResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.RemoveSchemaVersionMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "RemoveSchemaVersionMetadata");
            try
            {
                #if DESKTOP
                return client.RemoveSchemaVersionMetadata(request);
                #elif CORECLR
                return client.RemoveSchemaVersionMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? SchemaVersionNumber_LatestVersion { get; set; }
            public System.Int64? SchemaVersionNumber_VersionNumber { get; set; }
            public System.Func<Amazon.Glue.Model.RemoveSchemaVersionMetadataResponse, RemoveGLUESchemaVersionMetadataCmdlet, object> Select { get; set; } =
