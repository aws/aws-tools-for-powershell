...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// Deletes the session.
    /// </summary>
    [Cmdlet("Remove", "GLUESession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveGLUESessionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUESession (DeleteSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeleteSessionResponse, RemoveGLUESessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.DeleteSessionRequest();
        ...
        private Amazon.Glue.Model.DeleteSessionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String RequestOrigin { get; set; }
            public System.Func<Amazon.Glue.Model.DeleteSessionResponse, RemoveGLUESessionCmdlet, object> Select { get; set; } =
