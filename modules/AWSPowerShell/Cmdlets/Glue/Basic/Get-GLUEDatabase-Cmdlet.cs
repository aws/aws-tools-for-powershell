...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class GetGLUEDatabaseCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetDatabaseResponse, GetGLUEDatabaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetDatabaseRequest();
        ...
        private Amazon.Glue.Model.GetDatabaseResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDatabaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetDatabase");
            try
            {
                return client.GetDatabaseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CatalogId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.Glue.Model.GetDatabaseResponse, GetGLUEDatabaseCmdlet, object> Select { get; set; } =
