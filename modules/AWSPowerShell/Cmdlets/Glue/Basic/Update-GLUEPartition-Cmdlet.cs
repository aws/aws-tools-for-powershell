...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue UpdatePartition API operation.", Operation = new[] {"UpdatePartition"}, SelectReturnType = typeof(Amazon.Glue.Model.UpdatePartitionResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.UpdatePartitionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.UpdatePartitionResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateGLUEPartitionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of partition key values that define the partition to update.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdatePartitionResponse, UpdateGLUEPartitionCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.PartitionValueList == null && ParameterWasBound(nameof(this.PartitionValueList)))
            {
                WriteWarning("You are passing $null as a value for parameter PartitionValueList which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.Glue.Model.UpdatePartitionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdatePartitionRequest request)
        {
            ...
            try
            {
                return client.UpdatePartitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.UpdatePartitionResponse, UpdateGLUEPartitionCmdlet, object> Select { get; set; } =
