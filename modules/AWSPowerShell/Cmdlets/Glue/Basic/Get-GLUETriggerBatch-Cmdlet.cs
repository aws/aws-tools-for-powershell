...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue BatchGetTriggers API operation.", Operation = new[] {"BatchGetTriggers"}, SelectReturnType = typeof(Amazon.Glue.Model.BatchGetTriggersResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.BatchGetTriggersResponse",
        "This cmdlet returns an Amazon.Glue.Model.BatchGetTriggersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUETriggerBatchCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.BatchGetTriggersResponse, GetGLUETriggerBatchCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.TriggerName != null)
            {
                context.TriggerName = new List<System.String>(this.TriggerName);
            }
            #if MODULAR
            if (this.TriggerName == null && ParameterWasBound(nameof(this.TriggerName)))
            {
                WriteWarning("You are passing $null as a value for parameter TriggerName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.TriggerName != null)
            {
                request.TriggerNames = cmdletContext.TriggerName;
            }
        ...
        {
            public List<System.String> TriggerName { get; set; }
            public System.Func<Amazon.Glue.Model.BatchGetTriggersResponse, GetGLUETriggerBatchCmdlet, object> Select { get; set; } =
