...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("None or Amazon.Glue.Model.CreatePartitionIndexResponse",
        ...
        "The service response (type Amazon.Glue.Model.CreatePartitionIndexResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
