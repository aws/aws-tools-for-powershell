...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.ListTableOptimizerRunsResponse",
        "This cmdlet returns an Amazon.Glue.Model.ListTableOptimizerRunsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
