...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUEWorkflowRunList")]
    [OutputType("Amazon.Glue.Model.WorkflowRun")]
    [AWSCmdlet("Calls the AWS Glue GetWorkflowRuns API operation.", Operation = new[] {"GetWorkflowRuns"}, SelectReturnType = typeof(Amazon.Glue.Model.GetWorkflowRunsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.WorkflowRun or Amazon.Glue.Model.GetWorkflowRunsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.WorkflowRun objects.",
        "The service call response (type Amazon.Glue.Model.GetWorkflowRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUEWorkflowRunListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetWorkflowRunsResponse, GetGLUEWorkflowRunListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.GetWorkflowRunsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Runs?.Count ?? 0;
        ...
        private Amazon.Glue.Model.GetWorkflowRunsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetWorkflowRunsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetWorkflowRuns");
            try
            {
                #if DESKTOP
                return client.GetWorkflowRuns(request);
                #elif CORECLR
                return client.GetWorkflowRunsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetWorkflowRunsResponse, GetGLUEWorkflowRunListCmdlet, object> Select { get; set; } =
