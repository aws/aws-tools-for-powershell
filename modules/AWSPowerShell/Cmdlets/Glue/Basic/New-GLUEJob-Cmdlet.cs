...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class NewGLUEJobCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>In Spark jobs, <code>GlueVersion</code> determines the versions of Apache Spark and
        /// Python that Glue available in a job. The Python version indicates the version supported
        /// for jobs of type Spark. </para><para>Ray jobs should set <code>GlueVersion</code> to <code>4.0</code> or greater. However,
        /// the versions of Ray, Python and additional libraries available in your Ray job are
        /// determined by the <code>Runtime</code> parameter of the Job command.</para><para>For more information about the available Glue versions and corresponding Spark and
