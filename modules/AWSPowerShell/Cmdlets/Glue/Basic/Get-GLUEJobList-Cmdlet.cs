...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetJobs API operation.", Operation = new[] {"GetJobs"}, SelectReturnType = typeof(Amazon.Glue.Model.GetJobsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.Job or Amazon.Glue.Model.GetJobsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.Job objects.",
        "The service call response (type Amazon.Glue.Model.GetJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEJobListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetJobsResponse, GetGLUEJobListCmdlet>(Select) ??
        ...
        private Amazon.Glue.Model.GetJobsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetJobsRequest request)
        {
            ...
            try
            {
                return client.GetJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetJobsResponse, GetGLUEJobListCmdlet, object> Select { get; set; } =
