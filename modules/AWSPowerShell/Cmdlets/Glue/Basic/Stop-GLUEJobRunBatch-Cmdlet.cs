...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class StopGLUEJobRunBatchCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of the <c>JobRunIds</c> that should be stopped for that job definition.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.BatchStopJobRunResponse, StopGLUEJobRunBatchCmdlet>(Select) ??
            ...
            {
                context.JobRunId = new List<System.String>(this.JobRunId);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.JobRunIds = cmdletContext.JobRunId;
            }
        ...
        private Amazon.Glue.Model.BatchStopJobRunResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.BatchStopJobRunRequest request)
        {
            ...
            try
            {
                return client.BatchStopJobRunAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String JobName { get; set; }
            public List<System.String> JobRunId { get; set; }
            public System.Func<Amazon.Glue.Model.BatchStopJobRunResponse, StopGLUEJobRunBatchCmdlet, object> Select { get; set; } =
