...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.Database or Amazon.Glue.Model.GetDatabasesResponse",
        ...
        "The service call response (type Amazon.Glue.Model.GetDatabasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEDatabaseListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// doesn’t accept an empty list. The request must include the <c>NAME</c>.</para><para />
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DatabaseList?.Count ?? 0;
        ...
        private Amazon.Glue.Model.GetDatabasesResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDatabasesRequest request)
        {
            ...
            try
            {
                return client.GetDatabasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
