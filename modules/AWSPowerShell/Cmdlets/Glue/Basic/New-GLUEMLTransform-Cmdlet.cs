...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.CreateMLTransformResponse",
        ...
        "The service call response (type Amazon.Glue.Model.CreateMLTransformResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewGLUEMLTransformCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of Glue table definitions used by the transform.</para><para />
        ...
        /// Tags in Glue</a> in the developer guide.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Glue.Model.CreateMLTransformResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.CreateMLTransformRequest request)
        {
            ...
            try
            {
                return client.CreateMLTransformAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
