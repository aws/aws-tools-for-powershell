...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDevEndpoint API operation.", Operation = new[] {"GetDevEndpoint"}, SelectReturnType = typeof(Amazon.Glue.Model.GetDevEndpointResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.DevEndpoint or Amazon.Glue.Model.GetDevEndpointResponse",
        "This cmdlet returns an Amazon.Glue.Model.DevEndpoint object.",
        "The service call response (type Amazon.Glue.Model.GetDevEndpointResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEDevEndpointCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "DevEndpoint";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetDevEndpointResponse, GetGLUEDevEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetDevEndpointRequest();
        ...
        private Amazon.Glue.Model.GetDevEndpointResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDevEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetDevEndpoint");
            try
            {
                return client.GetDevEndpointAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String EndpointName { get; set; }
            public System.Func<Amazon.Glue.Model.GetDevEndpointResponse, GetGLUEDevEndpointCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DevEndpoint;
        }
