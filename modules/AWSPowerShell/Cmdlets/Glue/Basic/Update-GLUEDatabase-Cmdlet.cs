...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue UpdateDatabase API operation.", Operation = new[] {"UpdateDatabase"}, SelectReturnType = typeof(Amazon.Glue.Model.UpdateDatabaseResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.UpdateDatabaseResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.UpdateDatabaseResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateGLUEDatabaseCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdateDatabaseResponse, UpdateGLUEDatabaseCmdlet>(Select) ??
        ...
        private Amazon.Glue.Model.UpdateDatabaseResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateDatabaseRequest request)
        {
            ...
            try
            {
                return client.UpdateDatabaseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Glue.Model.DatabaseInput DatabaseInput { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.Glue.Model.UpdateDatabaseResponse, UpdateGLUEDatabaseCmdlet, object> Select { get; set; } =
