...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class RemoveGLUEPartitionBatchCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PartitionsToDelete' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.BatchDeletePartitionResponse, RemoveGLUEPartitionBatchCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.PartitionsToDelete;
            }
            ...
            #if MODULAR
            if (this.PartitionsToDelete == null && ParameterWasBound(nameof(this.PartitionsToDelete)))
            {
                WriteWarning("You are passing $null as a value for parameter PartitionsToDelete which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.BatchDeletePartitionResponse, RemoveGLUEPartitionBatchCmdlet, object> Select { get; set; } =
