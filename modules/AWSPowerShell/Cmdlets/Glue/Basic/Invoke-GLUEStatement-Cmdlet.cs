...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Invoke", "GLUEStatement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class InvokeGLUEStatementCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Code' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-GLUEStatement (RunStatement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.RunStatementResponse, InvokeGLUEStatementCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Code;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.RunStatementRequest();
        ...
        private Amazon.Glue.Model.RunStatementResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.RunStatementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "RunStatement");
            try
            {
                #if DESKTOP
                return client.RunStatement(request);
                #elif CORECLR
                return client.RunStatementAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RequestOrigin { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.Glue.Model.RunStatementResponse, InvokeGLUEStatementCmdlet, object> Select { get; set; } =
