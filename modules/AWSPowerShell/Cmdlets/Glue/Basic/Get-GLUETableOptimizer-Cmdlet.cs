...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class GetGLUETableOptimizerCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.GetTableOptimizerResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.GetTableOptimizerResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetTableOptimizerResponse, GetGLUETableOptimizerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetTableOptimizerRequest();
        ...
        private Amazon.Glue.Model.GetTableOptimizerResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetTableOptimizerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetTableOptimizer");
            try
            {
                #if DESKTOP
                return client.GetTableOptimizer(request);
                #elif CORECLR
                return client.GetTableOptimizerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public Amazon.Glue.TableOptimizerType Type { get; set; }
            public System.Func<Amazon.Glue.Model.GetTableOptimizerResponse, GetGLUETableOptimizerCmdlet, object> Select { get; set; } =
