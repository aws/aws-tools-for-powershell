...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class GetGLUEEntityRecordCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Connector options that are required to query the data.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para> List of fields that we want to fetch as part of preview data.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Glue.Model.GetEntityRecordsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetEntityRecordsRequest request)
        {
            ...
            try
            {
                return client.GetEntityRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
