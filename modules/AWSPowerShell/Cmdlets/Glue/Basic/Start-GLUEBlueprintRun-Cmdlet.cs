...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.StartBlueprintRunResponse",
        ...
        "The service call response (type Amazon.Glue.Model.StartBlueprintRunResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
