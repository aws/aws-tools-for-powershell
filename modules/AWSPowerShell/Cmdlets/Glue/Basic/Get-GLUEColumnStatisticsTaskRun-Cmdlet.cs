...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.ColumnStatisticsTaskRun or Amazon.Glue.Model.GetColumnStatisticsTaskRunResponse",
        ...
        "The service call response (type Amazon.Glue.Model.GetColumnStatisticsTaskRunResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEColumnStatisticsTaskRunCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ColumnStatisticsTaskRunId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ColumnStatisticsTaskRunId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ColumnStatisticsTaskRunId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ColumnStatisticsTaskRunId;
            }
