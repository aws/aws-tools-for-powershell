...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.SchemaVersionListItem or Amazon.Glue.Model.ListSchemaVersionsResponse",
        ...
        "The service call response (type Amazon.Glue.Model.ListSchemaVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
