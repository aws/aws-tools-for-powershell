...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetJobRuns API operation.", Operation = new[] {"GetJobRuns"}, SelectReturnType = typeof(Amazon.Glue.Model.GetJobRunsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.JobRun or Amazon.Glue.Model.GetJobRunsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.JobRun objects.",
        "The service call response (type Amazon.Glue.Model.GetJobRunsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUEJobRunListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetJobRunsResponse, GetGLUEJobRunListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.JobRuns?.Count ?? 0;
        ...
        private Amazon.Glue.Model.GetJobRunsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetJobRunsRequest request)
        {
            ...
            try
            {
                return client.GetJobRunsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetJobRunsResponse, GetGLUEJobRunListCmdlet, object> Select { get; set; } =
