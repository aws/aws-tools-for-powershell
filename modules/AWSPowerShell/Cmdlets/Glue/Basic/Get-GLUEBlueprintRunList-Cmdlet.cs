...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUEBlueprintRunList")]
    [OutputType("Amazon.Glue.Model.BlueprintRun")]
    [AWSCmdlet("Calls the AWS Glue GetBlueprintRuns API operation.", Operation = new[] {"GetBlueprintRuns"}, SelectReturnType = typeof(Amazon.Glue.Model.GetBlueprintRunsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.BlueprintRun or Amazon.Glue.Model.GetBlueprintRunsResponse",
        "This cmdlet returns a collection of Amazon.Glue.Model.BlueprintRun objects.",
        "The service call response (type Amazon.Glue.Model.GetBlueprintRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUEBlueprintRunListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BlueprintRuns";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetBlueprintRunsResponse, GetGLUEBlueprintRunListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.GetBlueprintRunsRequest();
        ...
        private Amazon.Glue.Model.GetBlueprintRunsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetBlueprintRunsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetBlueprintRuns");
            try
            {
                #if DESKTOP
                return client.GetBlueprintRuns(request);
                #elif CORECLR
                return client.GetBlueprintRunsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Glue.Model.GetBlueprintRunsResponse, GetGLUEBlueprintRunListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BlueprintRuns;
        }
