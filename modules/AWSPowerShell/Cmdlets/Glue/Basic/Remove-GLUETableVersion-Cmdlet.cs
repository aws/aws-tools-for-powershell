...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue DeleteTableVersion API operation.", Operation = new[] {"DeleteTableVersion"}, SelectReturnType = typeof(Amazon.Glue.Model.DeleteTableVersionResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.DeleteTableVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.DeleteTableVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGLUETableVersionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the table version to be deleted. A <c>VersionID</c> is a string representation
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUETableVersion (DeleteTableVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeleteTableVersionResponse, RemoveGLUETableVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.DeleteTableVersionRequest();
        ...
        private Amazon.Glue.Model.DeleteTableVersionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteTableVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteTableVersion");
            try
            {
                #if DESKTOP
                return client.DeleteTableVersion(request);
                #elif CORECLR
                return client.DeleteTableVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public System.String VersionId { get; set; }
            public System.Func<Amazon.Glue.Model.DeleteTableVersionResponse, RemoveGLUETableVersionCmdlet, object> Select { get; set; } =
