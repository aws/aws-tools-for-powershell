...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "GLUEGlossaryTerm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Glue.Model.DisassociateGlossaryTermsResponse")]
    [AWSCmdlet("Calls the AWS Glue DisassociateGlossaryTerms API operation.", Operation = new[] {"DisassociateGlossaryTerms"}, SelectReturnType = typeof(Amazon.Glue.Model.DisassociateGlossaryTermsResponse))]
    [AWSCmdletOutput("Amazon.Glue.Model.DisassociateGlossaryTermsResponse",
        "This cmdlet returns an Amazon.Glue.Model.DisassociateGlossaryTermsResponse object containing multiple properties."
    )]
    public partial class UnregisterGLUEGlossaryTermCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of glossary term identifiers to disassociate from the asset.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.DisassociateGlossaryTermsResponse).
        /// Specifying the name of a property of type Amazon.Glue.Model.DisassociateGlossaryTermsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-GLUEGlossaryTerm (DisassociateGlossaryTerms)"))
            {
                return;
            }
        ...
        private Amazon.Glue.Model.DisassociateGlossaryTermsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DisassociateGlossaryTermsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DisassociateGlossaryTerms");
            try
            {
                return client.DisassociateGlossaryTermsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
