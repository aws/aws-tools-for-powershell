...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.StatisticAnnotation or Amazon.Glue.Model.ListDataQualityStatisticAnnotationsResponse",
        ...
        "The service call response (type Amazon.Glue.Model.ListDataQualityStatisticAnnotationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
