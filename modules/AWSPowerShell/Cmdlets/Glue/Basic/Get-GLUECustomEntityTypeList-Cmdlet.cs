...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUECustomEntityTypeList")]
    [OutputType("Amazon.Glue.Model.CustomEntityType")]
    ...
    public partial class GetGLUECustomEntityTypeListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CustomEntityTypes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.ListCustomEntityTypesResponse, GetGLUECustomEntityTypeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.ListCustomEntityTypesRequest();
        ...
        private Amazon.Glue.Model.ListCustomEntityTypesResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.ListCustomEntityTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "ListCustomEntityTypes");
            try
            {
                #if DESKTOP
                return client.ListCustomEntityTypes(request);
                #elif CORECLR
                return client.ListCustomEntityTypesAsync(request).GetAwaiter().GetResult();
                #else
