...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    public partial class RemoveGLUECrawlerCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GLUECrawler (DeleteCrawler)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeleteCrawlerResponse, RemoveGLUECrawlerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.DeleteCrawlerRequest();
        ...
        private Amazon.Glue.Model.DeleteCrawlerResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeleteCrawlerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "DeleteCrawler");
            try
            {
                #if DESKTOP
                return client.DeleteCrawler(request);
                #elif CORECLR
                return client.DeleteCrawlerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Glue.Model.DeleteCrawlerResponse, RemoveGLUECrawlerCmdlet, object> Select { get; set; } =
