...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "GLUEIntegrationTableProperty", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue UpdateIntegrationTableProperties API operation.", Operation = new[] {"UpdateIntegrationTableProperties"}, SelectReturnType = typeof(Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateGLUEIntegrationTablePropertyCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GLUEIntegrationTableProperty (UpdateIntegrationTableProperties)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse, UpdateGLUEIntegrationTablePropertyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.UpdateIntegrationTablePropertiesRequest();
        ...
        private Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateIntegrationTablePropertiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "UpdateIntegrationTableProperties");
            try
            {
                #if DESKTOP
                return client.UpdateIntegrationTableProperties(request);
                #elif CORECLR
                return client.UpdateIntegrationTablePropertiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TargetTableConfig_TargetTableName { get; set; }
            public Amazon.Glue.UnnestSpec TargetTableConfig_UnnestSpec { get; set; }
            public System.Func<Amazon.Glue.Model.UpdateIntegrationTablePropertiesResponse, UpdateGLUEIntegrationTablePropertyCmdlet, object> Select { get; set; } =
