...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue DeletePartition API operation.", Operation = new[] {"DeletePartition"}, SelectReturnType = typeof(Amazon.Glue.Model.DeletePartitionResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.DeletePartitionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.DeletePartitionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGLUEPartitionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The values that define the partition.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.DeletePartitionResponse, RemoveGLUEPartitionCmdlet>(Select) ??
        ...
        private Amazon.Glue.Model.DeletePartitionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.DeletePartitionRequest request)
        {
            ...
            try
            {
                return client.DeletePartitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableName { get; set; }
            public System.Func<Amazon.Glue.Model.DeletePartitionResponse, RemoveGLUEPartitionCmdlet, object> Select { get; set; } =
