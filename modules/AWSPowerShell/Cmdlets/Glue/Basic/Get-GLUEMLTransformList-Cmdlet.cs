...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.MLTransform or Amazon.Glue.Model.GetMLTransformsResponse",
        ...
        "The service call response (type Amazon.Glue.Model.GetMLTransformsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
