...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.DataQualityRuleRecommendationRunDescription or Amazon.Glue.Model.ListDataQualityRuleRecommendationRunsResponse",
        ...
        "The service call response (type Amazon.Glue.Model.ListDataQualityRuleRecommendationRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
