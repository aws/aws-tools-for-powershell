...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("Amazon.Glue.Model.ColumnStatisticsTaskRun or Amazon.Glue.Model.GetColumnStatisticsTaskRunsResponse",
        ...
        "The service call response (type Amazon.Glue.Model.GetColumnStatisticsTaskRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
