...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Write", "GLUEWorkflowRunProperty", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Glue PutWorkflowRunProperties API operation.", Operation = new[] {"PutWorkflowRunProperties"}, SelectReturnType = typeof(Amazon.Glue.Model.PutWorkflowRunPropertiesResponse))]
    [AWSCmdletOutput("None or Amazon.Glue.Model.PutWorkflowRunPropertiesResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glue.Model.PutWorkflowRunPropertiesResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteGLUEWorkflowRunPropertyCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-GLUEWorkflowRunProperty (PutWorkflowRunProperties)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.PutWorkflowRunPropertiesResponse, WriteGLUEWorkflowRunPropertyCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.RunProperty == null && ParameterWasBound(nameof(this.RunProperty)))
            {
                WriteWarning("You are passing $null as a value for parameter RunProperty which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.PutWorkflowRunPropertiesRequest();
        ...
        private Amazon.Glue.Model.PutWorkflowRunPropertiesResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.PutWorkflowRunPropertiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "PutWorkflowRunProperties");
            try
            {
                #if DESKTOP
                return client.PutWorkflowRunProperties(request);
                #elif CORECLR
                return client.PutWorkflowRunPropertiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Glue.Model.PutWorkflowRunPropertiesResponse, WriteGLUEWorkflowRunPropertyCmdlet, object> Select { get; set; } =
