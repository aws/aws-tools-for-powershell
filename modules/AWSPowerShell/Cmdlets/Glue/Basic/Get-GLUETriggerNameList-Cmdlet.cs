...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue ListTriggers API operation.", Operation = new[] {"ListTriggers"}, SelectReturnType = typeof(Amazon.Glue.Model.ListTriggersResponse))]
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.ListTriggersResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Glue.Model.ListTriggersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGLUETriggerNameListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TriggerNames";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DependentJobName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.ListTriggersResponse, GetGLUETriggerNameListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DependentJobName;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Glue.Model.ListTriggersResponse, GetGLUETriggerNameListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TriggerNames;
        }
