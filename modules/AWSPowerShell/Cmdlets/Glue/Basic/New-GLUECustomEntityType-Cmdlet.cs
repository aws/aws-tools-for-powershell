...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Glue.Model.CreateCustomEntityTypeResponse",
        ...
        "The service call response (type Amazon.Glue.Model.CreateCustomEntityTypeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewGLUECustomEntityTypeCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// of the regular expression the data will not be detected as sensitive data.</para><para>If no context words are passed only a regular expression is checked.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags applied to the custom entity type.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Glue.Model.CreateCustomEntityTypeResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.CreateCustomEntityTypeRequest request)
        {
            ...
            try
            {
                return client.CreateCustomEntityTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
