...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUECrawler")]
    [OutputType("Amazon.Glue.Model.Crawler")]
    ...
    public partial class GetGLUECrawlerCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Crawler";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glue.Model.GetCrawlerResponse, GetGLUECrawlerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetCrawlerRequest();
        ...
        private Amazon.Glue.Model.GetCrawlerResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetCrawlerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetCrawler");
            try
            {
                #if DESKTOP
                return client.GetCrawler(request);
                #elif CORECLR
                return client.GetCrawlerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Glue.Model.GetCrawlerResponse, GetGLUECrawlerCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Crawler;
        }
