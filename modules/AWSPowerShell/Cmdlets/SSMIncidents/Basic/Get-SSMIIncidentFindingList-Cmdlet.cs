...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    /// deployment that can be investigated as a potential cause of the incident.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetSSMIIncidentFindingListCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        private Amazon.SSMIncidents.Model.ListIncidentFindingsResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.ListIncidentFindingsRequest request)
        {
            ...
            try
            {
                return client.ListIncidentFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
