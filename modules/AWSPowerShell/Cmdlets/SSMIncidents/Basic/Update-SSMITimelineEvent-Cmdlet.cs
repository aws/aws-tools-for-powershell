...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    [AWSCmdletOutput("None or Amazon.SSMIncidents.Model.UpdateTimelineEventResponse",
        ...
        "The service response (type Amazon.SSMIncidents.Model.UpdateTimelineEventResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSSMITimelineEventCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Updates all existing references in a <code>TimelineEvent</code>. A reference can be
        ...
        /// is the related item.</para><important><para>This update action overrides all existing references. If you want to keep existing
        /// references, you must specify them in the call. If you don't, this action removes them
        /// and enters only new references.</para></important>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
