...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    public partial class RemoveSSMIResourcePolicyCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSMIResourcePolicy (DeleteResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMIncidents.Model.DeleteResourcePolicyResponse, RemoveSSMIResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMIncidents.Model.DeleteResourcePolicyRequest();
        ...
        private Amazon.SSMIncidents.Model.DeleteResourcePolicyResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.DeleteResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager", "DeleteResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyId { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SSMIncidents.Model.DeleteResourcePolicyResponse, RemoveSSMIResourcePolicyCmdlet, object> Select { get; set; } =
