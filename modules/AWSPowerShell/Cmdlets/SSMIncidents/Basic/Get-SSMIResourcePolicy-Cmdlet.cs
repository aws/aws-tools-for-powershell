...
{
    /// <summary>
    /// Retrieves the resource policies attached to the specified response plan.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "SSMIResourcePolicy")]
    [OutputType("Amazon.SSMIncidents.Model.ResourcePolicy")]
    ...
    public partial class GetSSMIResourcePolicyCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMIncidents.Model.GetResourcePoliciesResponse, GetSSMIResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSMIncidents.Model.GetResourcePoliciesRequest();
        ...
        private Amazon.SSMIncidents.Model.GetResourcePoliciesResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.GetResourcePoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager", "GetResourcePolicies");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SSMIncidents.Model.GetResourcePoliciesResponse, GetSSMIResourcePolicyCmdlet, object> Select { get; set; } =
