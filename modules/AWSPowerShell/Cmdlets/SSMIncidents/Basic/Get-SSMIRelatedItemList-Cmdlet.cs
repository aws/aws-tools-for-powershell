...
{
    /// <summary>
    /// List all related items for an incident record.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.SSMIncidents.Model.RelatedItem or Amazon.SSMIncidents.Model.ListRelatedItemsResponse",
        ...
        "The service call response (type Amazon.SSMIncidents.Model.ListRelatedItemsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMIRelatedItemListCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        private Amazon.SSMIncidents.Model.ListRelatedItemsResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.ListRelatedItemsRequest request)
        {
            ...
            try
            {
                return client.ListRelatedItemsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
