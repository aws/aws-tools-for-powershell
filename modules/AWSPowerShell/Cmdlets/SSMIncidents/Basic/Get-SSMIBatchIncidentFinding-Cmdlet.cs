...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMIBatchIncidentFinding")]
    [OutputType("Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse")]
    [AWSCmdlet("Calls the AWS Systems Manager Incident Manager BatchGetIncidentFindings API operation.", Operation = new[] {"BatchGetIncidentFindings"}, SelectReturnType = typeof(Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse))]
    [AWSCmdletOutput("Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse",
        "This cmdlet returns an Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSMIBatchIncidentFindingCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of IDs of findings for which you want to view details.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the incident for which you want to view finding
        /// details.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse).
        /// Specifying the name of a property of type Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse, GetSSMIBatchIncidentFindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMIncidents.Model.BatchGetIncidentFindingsRequest();
        ...
        private Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.BatchGetIncidentFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager", "BatchGetIncidentFindings");
            try
            {
                #if DESKTOP
                return client.BatchGetIncidentFindings(request);
                #elif CORECLR
                return client.BatchGetIncidentFindingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IncidentRecordArn { get; set; }
            public System.Func<Amazon.SSMIncidents.Model.BatchGetIncidentFindingsResponse, GetSSMIBatchIncidentFindingCmdlet, object> Select { get; set; } =
