...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager Incident Manager PutResourcePolicy API operation.", Operation = new[] {"PutResourcePolicy"}, SelectReturnType = typeof(Amazon.SSMIncidents.Model.PutResourcePolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.SSMIncidents.Model.PutResourcePolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SSMIncidents.Model.PutResourcePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteSSMIResourcePolicyCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-SSMIResourcePolicy (PutResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMIncidents.Model.PutResourcePolicyResponse, WriteSSMIResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMIncidents.Model.PutResourcePolicyRequest();
        ...
        private Amazon.SSMIncidents.Model.PutResourcePolicyResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.PutResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager", "PutResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Policy { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SSMIncidents.Model.PutResourcePolicyResponse, WriteSSMIResourcePolicyCmdlet, object> Select { get; set; } =
