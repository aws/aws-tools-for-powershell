...
namespace Amazon.PowerShell.Cmdlets.SSMI
{
    ...
    /// provided KMS key.
    /// </summary>
    [Cmdlet("New", "SSMIReplicationSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Systems Manager Incident Manager CreateReplicationSet API operation.", Operation = new[] {"CreateReplicationSet"}, SelectReturnType = typeof(Amazon.SSMIncidents.Model.CreateReplicationSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.SSMIncidents.Model.CreateReplicationSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SSMIncidents.Model.CreateReplicationSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSSMIReplicationSetCmdlet : AmazonSSMIncidentsClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        private readonly CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();
        
        #region Parameter ReplicationSetRegions
        /// <summary>
        /// <para>
        /// <para>The Regions that Incident Manager replicates your data to. You can have up to three
        /// Regions in your replication set.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags to add to the replication set.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SSMIReplicationSet (CreateReplicationSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMIncidents.Model.CreateReplicationSetResponse, NewSSMIReplicationSetCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.ClientToken = this.ClientToken;
            if (this.ReplicationSetRegions != null)
            {
            ...
            #if MODULAR
            if (this.ReplicationSetRegions == null && ParameterWasBound(nameof(this.ReplicationSetRegions)))
            {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMIncidents.Model.CreateReplicationSetRequest();
        ...
        private Amazon.SSMIncidents.Model.CreateReplicationSetResponse CallAWSServiceOperation(IAmazonSSMIncidents client, Amazon.SSMIncidents.Model.CreateReplicationSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager", "CreateReplicationSet");
            try
            {
                return client.CreateReplicationSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
