#
# Module manifest for module 'AWS.Tools.SecurityAgent'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SecurityAgent.dll'
    ...
    GUID = '53b910cb-198a-4f11-b682-dafd0a473d07'
    ...
    Description = 'The SecurityAgent module of AWS Tools for PowerShell lets developers and administrators manage AWS Security Agent from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SecurityAgent.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SecurityAgent.Completers.psm1',
        'AWS.Tools.SecurityAgent.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.SecurityAgent.dll-Help.xml'
    )
