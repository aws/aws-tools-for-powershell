...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    /// </summary>
    [Cmdlet("New", "SECAGCodeReview", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SecurityAgent.Model.CreateCodeReviewResponse")]
    [AWSCmdlet("Calls the AWS Security Agent CreateCodeReview API operation.", Operation = new[] {"CreateCodeReview"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.CreateCodeReviewResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.CreateCodeReviewResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.CreateCodeReviewResponse object containing multiple properties."
    )]
    public partial class NewSECAGCodeReviewCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the agent space to create the code review in.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The code remediation strategy for the code review. Valid values are AUTOMATIC and
        /// DISABLED.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The IAM service role to use for the code review.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The title of the code review.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.CreateCodeReviewResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.CreateCodeReviewResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SECAGCodeReview (CreateCodeReview)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.CreateCodeReviewResponse, NewSECAGCodeReviewCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.CreateCodeReviewRequest();
        ...
        private Amazon.SecurityAgent.Model.CreateCodeReviewResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.CreateCodeReviewRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "CreateCodeReview");
            try
            {
                return client.CreateCodeReviewAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
