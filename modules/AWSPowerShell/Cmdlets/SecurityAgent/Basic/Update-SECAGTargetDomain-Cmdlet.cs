...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [AWSCmdlet("Calls the AWS Security Agent UpdateTargetDomain API operation.", Operation = new[] {"UpdateTargetDomain"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.UpdateTargetDomainResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.UpdateTargetDomainResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.UpdateTargetDomainResponse object containing multiple properties."
    )]
    public partial class UpdateSECAGTargetDomainCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.UpdateTargetDomainResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.UpdateTargetDomainResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SECAGTargetDomain (UpdateTargetDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.UpdateTargetDomainResponse, UpdateSECAGTargetDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.UpdateTargetDomainRequest();
        ...
        private Amazon.SecurityAgent.Model.UpdateTargetDomainResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.UpdateTargetDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "UpdateTargetDomain");
            try
            {
                return client.UpdateTargetDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TargetDomainId { get; set; }
            public Amazon.SecurityAgent.DomainVerificationMethod VerificationMethod { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.UpdateTargetDomainResponse, UpdateSECAGTargetDomainCmdlet, object> Select { get; set; } =
