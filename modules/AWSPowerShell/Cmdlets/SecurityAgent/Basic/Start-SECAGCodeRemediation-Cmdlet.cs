...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Security Agent StartCodeRemediation API operation.", Operation = new[] {"StartCodeRemediation"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.StartCodeRemediationResponse))]
    [AWSCmdletOutput("None or Amazon.SecurityAgent.Model.StartCodeRemediationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SecurityAgent.Model.StartCodeRemediationResponse) be returned by specifying '-Select *'."
    )]
    public partial class StartSECAGCodeRemediationCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the code review job that produced the findings. Mutually
        /// exclusive with <c>pentestJobId</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the pentest job that produced the findings. Mutually exclusive
        /// with <c>codeReviewJobId</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.StartCodeRemediationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            var targetParameterNames = new string[]
            {
                ...
                nameof(this.PentestJobId)
            };
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(targetParameterNames, MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-SECAGCodeRemediation (StartCodeRemediation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.StartCodeRemediationResponse, StartSECAGCodeRemediationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.StartCodeRemediationRequest();
            ...
            if (cmdletContext.PentestJobId != null)
            {
                request.PentestJobId = cmdletContext.PentestJobId;
            }
        ...
        private Amazon.SecurityAgent.Model.StartCodeRemediationResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.StartCodeRemediationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "StartCodeRemediation");
            try
            {
                return client.StartCodeRemediationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PentestJobId { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.StartCodeRemediationResponse, StartSECAGCodeRemediationCmdlet, object> Select { get; set; } =
