...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    /// Updates a threat.
    /// </summary>
    [Cmdlet("Update", "SECAGThreat", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SecurityAgent.Model.UpdateThreatResponse")]
    [AWSCmdlet("Calls the AWS Security Agent UpdateThreat API operation.", Operation = new[] {"UpdateThreat"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.UpdateThreatResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.UpdateThreatResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.UpdateThreatResponse object containing multiple properties."
    )]
    public partial class UpdateSECAGThreatCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional customer comment.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Comments")]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated source code files supporting the threat.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The updated list of specific assets affected by the threat.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The updated security goals affected by the threat.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The updated conditions required for the threat to be exploitable.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Prerequisites")]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated recommended mitigation guidance for this threat.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated severity level of the threat.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated natural-language threat statement.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated status of the threat.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SecurityAgent.ThreatStatus")]
        public Amazon.SecurityAgent.ThreatStatus Status { get; set; }
        #endregion
        
        #region Parameter ThreatAction
        /// <summary>
        /// <para>
        /// <para>The updated description of what the threat source can do.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the threat to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated direct consequence of the threat action.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated actor or origin of the threat.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.UpdateThreatResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.UpdateThreatResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ThreatId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SECAGThreat (UpdateThreat)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.UpdateThreatResponse, UpdateSECAGThreatCmdlet>(Select) ??
            ...
            context.ThreatId = this.ThreatId;
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.UpdateThreatRequest();
            ...
            {
                request.ThreatId = cmdletContext.ThreatId;
            }
        ...
        private Amazon.SecurityAgent.Model.UpdateThreatResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.UpdateThreatRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "UpdateThreat");
            try
            {
                return client.UpdateThreatAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ThreatSource { get; set; }
            public System.String Title { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.UpdateThreatResponse, UpdateSECAGThreatCmdlet, object> Select { get; set; } =
