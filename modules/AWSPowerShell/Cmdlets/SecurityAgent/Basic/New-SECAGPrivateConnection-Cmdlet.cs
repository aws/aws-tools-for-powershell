...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    /// </summary>
    [Cmdlet("New", "SECAGPrivateConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse")]
    [AWSCmdlet("Calls the AWS Security Agent CreatePrivateConnection API operation.", Operation = new[] {"CreatePrivateConnection"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse object containing multiple properties."
    )]
    public partial class NewSECAGPrivateConnectionCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The certificate for the private connection.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The DNS resolution mode for the resource gateway. Defaults to PUBLIC when not set.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SecurityAgent.ResourceConfigDnsResolution")]
        public Amazon.SecurityAgent.ResourceConfigDnsResolution Mode_ServiceManaged_DnsResolution { get; set; }
        #endregion
        
        #region Parameter Mode_ServiceManaged_HostAddress
        /// <summary>
        /// <para>
        /// <para>The IP address or DNS name of the target resource.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The IP address type of the service-managed resource gateway.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SecurityAgent.IpAddressType")]
        public Amazon.SecurityAgent.IpAddressType Mode_ServiceManaged_IpAddressType { get; set; }
        #endregion
        
        #region Parameter Mode_ServiceManaged_Ipv4AddressesPerEni
        /// <summary>
        /// <para>
        /// <para>The number of IPv4 addresses in each elastic network interface for the service-managed
        /// resource gateway.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The TCP port ranges that a consumer can use to access the resource.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A unique name for the private connection within your account.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier or ARN of the resource configuration.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The security groups to attach to the service-managed resource gateway.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The subnets that the service-managed resource gateway spans.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to attach to the private connection.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The VPC to create the service-managed resource gateway in.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SECAGPrivateConnection (CreatePrivateConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse, NewSECAGPrivateConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.CreatePrivateConnectionRequest();
            
            
             // populate Mode
            var requestModeIsNull = true;
            request.Mode = new Amazon.SecurityAgent.Model.PrivateConnectionMode();
            Amazon.SecurityAgent.Model.SelfManagedInput requestMode_mode_SelfManaged = null;
            
             // populate SelfManaged
            var requestMode_mode_SelfManagedIsNull = true;
            requestMode_mode_SelfManaged = new Amazon.SecurityAgent.Model.SelfManagedInput();
            ...
            Amazon.SecurityAgent.Model.ServiceManagedInput requestMode_mode_ServiceManaged = null;
            
             // populate ServiceManaged
            var requestMode_mode_ServiceManagedIsNull = true;
            requestMode_mode_ServiceManaged = new Amazon.SecurityAgent.Model.ServiceManagedInput();
            ...
            Amazon.SecurityAgent.ResourceConfigDnsResolution requestMode_mode_ServiceManaged_mode_ServiceManaged_DnsResolution = null;
            ...
            Amazon.SecurityAgent.IpAddressType requestMode_mode_ServiceManaged_mode_ServiceManaged_IpAddressType = null;
        ...
        private Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.CreatePrivateConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "CreatePrivateConnection");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SecurityAgent.Model.CreatePrivateConnectionResponse, NewSECAGPrivateConnectionCmdlet, object> Select { get; set; } =
