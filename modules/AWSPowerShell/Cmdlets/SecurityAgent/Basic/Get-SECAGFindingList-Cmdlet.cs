...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [AWSCmdlet("Calls the AWS Security Agent ListFindings API operation.", Operation = new[] {"ListFindings"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.ListFindingsResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.FindingSummary or Amazon.SecurityAgent.Model.ListFindingsResponse",
        "This cmdlet returns a collection of Amazon.SecurityAgent.Model.FindingSummary objects.",
        "The service call response (type Amazon.SecurityAgent.Model.ListFindingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSECAGFindingListCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SecurityAgent.ConfidenceLevel")]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'FindingsSummaries'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.ListFindingsResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.ListFindingsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FindingsSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.ListFindingsResponse, GetSECAGFindingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityAgent.Model.ListFindingsRequest();
            ...
            {
                request.Confidence = cmdletContext.Confidence;
            }
        ...
        private Amazon.SecurityAgent.Model.ListFindingsResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.ListFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "ListFindings");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RiskType { get; set; }
            public Amazon.SecurityAgent.FindingStatus Status { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.ListFindingsResponse, GetSECAGFindingListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FindingsSummaries;
        }
