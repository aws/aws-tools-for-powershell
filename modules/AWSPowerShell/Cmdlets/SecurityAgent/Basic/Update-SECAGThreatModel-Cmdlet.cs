...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    /// </summary>
    [Cmdlet("Update", "SECAGThreatModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SecurityAgent.Model.UpdateThreatModelResponse")]
    [AWSCmdlet("Calls the AWS Security Agent UpdateThreatModel API operation.", Operation = new[] {"UpdateThreatModel"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.UpdateThreatModelResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.UpdateThreatModelResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.UpdateThreatModelResponse object containing multiple properties."
    )]
    public partial class UpdateSECAGThreatModelCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the agent space that contains the threat model.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated description of the application or system being threat modeled.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated scoped documents for the agent to focus on during threat modeling.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ScopeDocs")]
        public Amazon.SecurityAgent.Model.DocumentInfo[] ScopeDoc { get; set; }
        #endregion
        
        #region Parameter ServiceRole
        /// <summary>
        /// <para>
        /// <para>The updated IAM service role for the threat model.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the threat model to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated title of the threat model.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.UpdateThreatModelResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.UpdateThreatModelResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ThreatModelId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SECAGThreatModel (UpdateThreatModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.UpdateThreatModelResponse, UpdateSECAGThreatModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.UpdateThreatModelRequest();
        ...
        private Amazon.SecurityAgent.Model.UpdateThreatModelResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.UpdateThreatModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "UpdateThreatModel");
            try
            {
                return client.UpdateThreatModelAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ThreatModelId { get; set; }
            public System.String Title { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.UpdateThreatModelResponse, UpdateSECAGThreatModelCmdlet, object> Select { get; set; } =
