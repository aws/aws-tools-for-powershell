...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [AWSCmdlet("Calls the AWS Security Agent GetArtifact API operation.", Operation = new[] {"GetArtifact"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.GetArtifactResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.GetArtifactResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.GetArtifactResponse object containing multiple properties."
    )]
    public partial class GetSECAGArtifactCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.GetArtifactResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.GetArtifactResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.GetArtifactResponse, GetSECAGArtifactCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.GetArtifactRequest();
        ...
        private Amazon.SecurityAgent.Model.GetArtifactResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.GetArtifactRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "GetArtifact");
            try
            {
                return client.GetArtifactAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AgentSpaceId { get; set; }
            public System.String ArtifactId { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.GetArtifactResponse, GetSECAGArtifactCmdlet, object> Select { get; set; } =
