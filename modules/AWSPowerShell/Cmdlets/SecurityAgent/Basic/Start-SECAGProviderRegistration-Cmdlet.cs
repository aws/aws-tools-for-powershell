...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [AWSCmdlet("Calls the AWS Security Agent InitiateProviderRegistration API operation.", Operation = new[] {"InitiateProviderRegistration"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse object containing multiple properties."
    )]
    public partial class StartSECAGProviderRegistrationCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-SECAGProviderRegistration (InitiateProviderRegistration)"))
            {
                return;
            }
        ...
        private Amazon.SecurityAgent.Model.InitiateProviderRegistrationResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.InitiateProviderRegistrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "InitiateProviderRegistration");
            try
            {
                return client.InitiateProviderRegistrationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
