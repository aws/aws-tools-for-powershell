...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    /// </summary>
    [Cmdlet("New", "SECAGAgentSpace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SecurityAgent.Model.CreateAgentSpaceResponse")]
    [AWSCmdlet("Calls the AWS Security Agent CreateAgentSpace API operation.", Operation = new[] {"CreateAgentSpace"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.CreateAgentSpaceResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.CreateAgentSpaceResponse",
        "This cmdlet returns an Amazon.SecurityAgent.Model.CreateAgentSpaceResponse object containing multiple properties."
    )]
    public partial class NewSECAGAgentSpaceCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A description of the agent space.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the AWS KMS key to use for encrypting data in the agent space.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to associate with the agent space.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The list of target domain identifiers to associate with the agent space.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.CreateAgentSpaceResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.CreateAgentSpaceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SECAGAgentSpace (CreateAgentSpace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.CreateAgentSpaceResponse, NewSECAGAgentSpaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityAgent.Model.CreateAgentSpaceRequest();
        ...
        private Amazon.SecurityAgent.Model.CreateAgentSpaceResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.CreateAgentSpaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "CreateAgentSpace");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SecurityAgent.Model.CreateAgentSpaceResponse, NewSECAGAgentSpaceCmdlet, object> Select { get; set; } =
