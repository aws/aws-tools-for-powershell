...
namespace Amazon.PowerShell.Cmdlets.SECAG
{
    ...
    [AWSCmdlet("Calls the AWS Security Agent ListMemberships API operation.", Operation = new[] {"ListMemberships"}, SelectReturnType = typeof(Amazon.SecurityAgent.Model.ListMembershipsResponse))]
    [AWSCmdletOutput("Amazon.SecurityAgent.Model.MembershipSummary or Amazon.SecurityAgent.Model.ListMembershipsResponse",
        "This cmdlet returns a collection of Amazon.SecurityAgent.Model.MembershipSummary objects.",
        "The service call response (type Amazon.SecurityAgent.Model.ListMembershipsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSECAGMembershipListCmdlet : AmazonSecurityAgentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SecurityAgent.MembershipTypeFilter")]
        public Amazon.SecurityAgent.MembershipTypeFilter MemberType { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityAgent.Model.ListMembershipsResponse).
        /// Specifying the name of a property of type Amazon.SecurityAgent.Model.ListMembershipsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityAgent.Model.ListMembershipsResponse, GetSECAGMembershipListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityAgent.Model.ListMembershipsRequest();
        ...
        private Amazon.SecurityAgent.Model.ListMembershipsResponse CallAWSServiceOperation(IAmazonSecurityAgent client, Amazon.SecurityAgent.Model.ListMembershipsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Agent", "ListMemberships");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SecurityAgent.MembershipTypeFilter MemberType { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SecurityAgent.Model.ListMembershipsResponse, GetSECAGMembershipListCmdlet, object> Select { get; set; } =
