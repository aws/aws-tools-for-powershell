...
{
    /// <summary>
    /// Lists all the Amazon Web Services Migration Hub Refactor Spaces routes within an application.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMHRSRouteListCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.ListRoutesResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.ListRoutesRequest request)
        {
            ...
            try
            {
                return client.ListRoutesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
