...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    /// lines.
    /// </summary>
    [Cmdlet("Write", "MHRSResourcePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteMHRSResourcePolicyCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A JSON-formatted string for an Amazon Web Services resource-based policy. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the resource to which the policy is being attached.
        /// </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-MHRSResourcePolicy (PutResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyResponse, WriteMHRSResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyRequest();
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Refactor Spaces", "PutResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Policy { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.MigrationHubRefactorSpaces.Model.PutResourcePolicyResponse, WriteMHRSResourcePolicyCmdlet, object> Select { get; set; } =
