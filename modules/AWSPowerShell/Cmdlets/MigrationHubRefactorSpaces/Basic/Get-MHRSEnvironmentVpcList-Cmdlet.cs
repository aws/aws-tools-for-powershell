...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    /// clouds (VPCs) that are part of the environment.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMHRSEnvironmentVpcListCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.ListEnvironmentVpcsResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.ListEnvironmentVpcsRequest request)
        {
            ...
            try
            {
                return client.ListEnvironmentVpcsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
