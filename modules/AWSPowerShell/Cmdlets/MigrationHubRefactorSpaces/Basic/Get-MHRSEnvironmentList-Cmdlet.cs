...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    /// account or shared with the caller account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.MigrationHubRefactorSpaces.Model.EnvironmentSummary or Amazon.MigrationHubRefactorSpaces.Model.ListEnvironmentsResponse",
        ...
        "The service call response (type Amazon.MigrationHubRefactorSpaces.Model.ListEnvironmentsResponse) can be returned by specifying '-Select *'."
    )]
