...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    public partial class RemoveMHRSResourceTagCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of keys of the tags to be removed from the resource. </para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubRefactorSpaces.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MHRSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubRefactorSpaces.Model.UntagResourceResponse, RemoveMHRSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubRefactorSpaces.Model.UntagResourceRequest();
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Refactor Spaces", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MigrationHubRefactorSpaces.Model.UntagResourceResponse, RemoveMHRSResourceTagCmdlet, object> Select { get; set; } =
