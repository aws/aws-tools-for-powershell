...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    public partial class GetMHRSEnvironmentCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentResponse).
        /// Specifying the name of a property of type Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentResponse, GetMHRSEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentRequest();
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Refactor Spaces", "GetEnvironment");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String EnvironmentIdentifier { get; set; }
            public System.Func<Amazon.MigrationHubRefactorSpaces.Model.GetEnvironmentResponse, GetMHRSEnvironmentCmdlet, object> Select { get; set; } =
