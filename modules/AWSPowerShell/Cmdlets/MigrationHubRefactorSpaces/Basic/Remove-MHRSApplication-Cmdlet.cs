...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    /// application.
    /// </summary>
    [Cmdlet("Remove", "MHRSApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse")]
    [AWSCmdlet("Calls the AWS Migration Hub Refactor Spaces DeleteApplication API operation.", Operation = new[] {"DeleteApplication"}, SelectReturnType = typeof(Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse))]
    [AWSCmdletOutput("Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse",
        "This cmdlet returns an Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveMHRSApplicationCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse).
        /// Specifying the name of a property of type Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ApplicationIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MHRSApplication (DeleteApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse, RemoveMHRSApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationRequest();
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Refactor Spaces", "DeleteApplication");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationIdentifier { get; set; }
            public System.String EnvironmentIdentifier { get; set; }
            public System.Func<Amazon.MigrationHubRefactorSpaces.Model.DeleteApplicationResponse, RemoveMHRSApplicationCmdlet, object> Select { get; set; } =
