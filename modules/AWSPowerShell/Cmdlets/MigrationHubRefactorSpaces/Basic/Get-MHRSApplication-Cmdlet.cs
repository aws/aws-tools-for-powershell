...
namespace Amazon.PowerShell.Cmdlets.MHRS
{
    ...
    public partial class GetMHRSApplicationCmdlet : AmazonMigrationHubRefactorSpacesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubRefactorSpaces.Model.GetApplicationResponse).
        /// Specifying the name of a property of type Amazon.MigrationHubRefactorSpaces.Model.GetApplicationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubRefactorSpaces.Model.GetApplicationResponse, GetMHRSApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubRefactorSpaces.Model.GetApplicationRequest();
        ...
        private Amazon.MigrationHubRefactorSpaces.Model.GetApplicationResponse CallAWSServiceOperation(IAmazonMigrationHubRefactorSpaces client, Amazon.MigrationHubRefactorSpaces.Model.GetApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Refactor Spaces", "GetApplication");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationIdentifier { get; set; }
            public System.String EnvironmentIdentifier { get; set; }
            public System.Func<Amazon.MigrationHubRefactorSpaces.Model.GetApplicationResponse, GetMHRSApplicationCmdlet, object> Select { get; set; } =
