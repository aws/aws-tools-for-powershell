...
{
    [AWSClientCmdlet("Amazon SageMaker Feature Store Runtime", "SMFS", "2020-07-01", "SageMakerFeatureStoreRuntime")]
    public abstract partial class AmazonSageMakerFeatureStoreRuntimeClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonSageMakerFeatureStoreRuntimeConfig.ServiceId.ToString();
