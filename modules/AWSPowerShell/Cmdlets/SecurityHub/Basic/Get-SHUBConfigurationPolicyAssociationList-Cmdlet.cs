...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdletOutput("Amazon.SecurityHub.Model.ConfigurationPolicyAssociationSummary or Amazon.SecurityHub.Model.ListConfigurationPolicyAssociationsResponse",
        ...
        "The service call response (type Amazon.SecurityHub.Model.ListConfigurationPolicyAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
