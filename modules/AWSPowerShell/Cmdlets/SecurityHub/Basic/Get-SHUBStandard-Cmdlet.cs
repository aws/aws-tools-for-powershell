...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Standard or Amazon.SecurityHub.Model.DescribeStandardsResponse",
        ...
        "The service call response (type Amazon.SecurityHub.Model.DescribeStandardsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
