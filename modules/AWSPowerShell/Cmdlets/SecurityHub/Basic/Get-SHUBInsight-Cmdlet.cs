...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetInsights API operation.", Operation = new[] {"GetInsights"}, SelectReturnType = typeof(Amazon.SecurityHub.Model.GetInsightsResponse))]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Insight or Amazon.SecurityHub.Model.GetInsightsResponse",
        "This cmdlet returns a collection of Amazon.SecurityHub.Model.Insight objects.",
        "The service call response (type Amazon.SecurityHub.Model.GetInsightsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSHUBInsightCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityHub.Model.GetInsightsResponse, GetSHUBInsightCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.InsightArn != null)
            {
                context.InsightArn = new List<System.String>(this.InsightArn);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityHub.Model.GetInsightsRequest();
            
            if (cmdletContext.InsightArn != null)
            {
                request.InsightArns = cmdletContext.InsightArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Insights?.Count ?? 0;
        ...
        private Amazon.SecurityHub.Model.GetInsightsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetInsightsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "GetInsights");
            try
            {
                #if DESKTOP
        ...
        {
            public List<System.String> InsightArn { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SecurityHub.Model.GetInsightsResponse, GetSHUBInsightCmdlet, object> Select { get; set; } =
