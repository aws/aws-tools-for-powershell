...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class EnableSHUBStandardsBatchCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StandardsSubscriptionRequest' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.StandardsSubscriptionRequest;
            }
