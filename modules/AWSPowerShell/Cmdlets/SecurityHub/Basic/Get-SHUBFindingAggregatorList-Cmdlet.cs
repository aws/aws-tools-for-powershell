...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class GetSHUBFindingAggregatorListCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FindingAggregators";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityHub.Model.ListFindingAggregatorsResponse, GetSHUBFindingAggregatorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityHub.Model.ListFindingAggregatorsRequest();
        ...
        private Amazon.SecurityHub.Model.ListFindingAggregatorsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.ListFindingAggregatorsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SecurityHub.Model.ListFindingAggregatorsResponse, GetSHUBFindingAggregatorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FindingAggregators;
        }
