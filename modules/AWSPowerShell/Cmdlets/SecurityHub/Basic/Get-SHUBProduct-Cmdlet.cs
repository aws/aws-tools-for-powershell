...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    /// with Security Hub to consolidate findings.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SHUBProduct")]
    [OutputType("Amazon.SecurityHub.Model.Product")]
    [AWSCmdlet("Calls the AWS Security Hub DescribeProducts API operation.", Operation = new[] {"DescribeProducts"}, SelectReturnType = typeof(Amazon.SecurityHub.Model.DescribeProductsResponse))]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Product or Amazon.SecurityHub.Model.DescribeProductsResponse",
        "This cmdlet returns a collection of Amazon.SecurityHub.Model.Product objects.",
        "The service call response (type Amazon.SecurityHub.Model.DescribeProductsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSHUBProductCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Products.Count;
        ...
        private Amazon.SecurityHub.Model.DescribeProductsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DescribeProductsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "DescribeProducts");
            try
            {
                #if DESKTOP
                return client.DescribeProducts(request);
                #elif CORECLR
                return client.DescribeProductsAsync(request).GetAwaiter().GetResult();
                #else
