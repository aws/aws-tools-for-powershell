...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class RemoveSHUBConfigurationPolicyCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityHub.Model.DeleteConfigurationPolicyResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SHUBConfigurationPolicy (DeleteConfigurationPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityHub.Model.DeleteConfigurationPolicyResponse, RemoveSHUBConfigurationPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityHub.Model.DeleteConfigurationPolicyRequest();
        ...
        private Amazon.SecurityHub.Model.DeleteConfigurationPolicyResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DeleteConfigurationPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "DeleteConfigurationPolicy");
            try
            {
                #if DESKTOP
                return client.DeleteConfigurationPolicy(request);
                #elif CORECLR
                return client.DeleteConfigurationPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Identifier { get; set; }
            public System.Func<Amazon.SecurityHub.Model.DeleteConfigurationPolicyResponse, RemoveSHUBConfigurationPolicyCmdlet, object> Select { get; set; } =
