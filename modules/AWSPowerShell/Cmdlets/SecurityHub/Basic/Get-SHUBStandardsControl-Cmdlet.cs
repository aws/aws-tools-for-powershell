...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdletOutput("Amazon.SecurityHub.Model.StandardsControl or Amazon.SecurityHub.Model.DescribeStandardsControlsResponse",
        ...
        "The service call response (type Amazon.SecurityHub.Model.DescribeStandardsControlsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSHUBStandardsControlCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StandardsSubscriptionArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.StandardsSubscriptionArn;
            }
