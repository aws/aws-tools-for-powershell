...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdletOutput("None or Amazon.SecurityHub.Model.EnableOrganizationAdminAccountResponse",
        ...
        "The service response (type Amazon.SecurityHub.Model.EnableOrganizationAdminAccountResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EnableSHUBOrganizationAdminAccountCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-SHUBOrganizationAdminAccount (EnableOrganizationAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityHub.Model.EnableOrganizationAdminAccountResponse, EnableSHUBOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityHub.Model.EnableOrganizationAdminAccountRequest();
        ...
        private Amazon.SecurityHub.Model.EnableOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.EnableOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "EnableOrganizationAdminAccount");
            try
            {
                #if DESKTOP
