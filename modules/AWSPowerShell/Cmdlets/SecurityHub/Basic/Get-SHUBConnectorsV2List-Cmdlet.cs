...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    /// account. This API is in preview release and subject to change.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetSHUBConnectorsV2ListCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        private Amazon.SecurityHub.Model.ListConnectorsV2Response CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.ListConnectorsV2Request request)
        {
            ...
            try
            {
                return client.ListConnectorsV2Async(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
