...
{
    /// <summary>
    /// Returns a list of resources. This API is in private preview and subject to change.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SHUBResourcesV2")]
    [OutputType("Amazon.SecurityHub.Model.ResourceResult")]
    [AWSCmdlet("Calls the AWS Security Hub GetResourcesV2 API operation.", Operation = new[] {"GetResourcesV2"}, SelectReturnType = typeof(Amazon.SecurityHub.Model.GetResourcesV2Response))]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.ResourceResult or Amazon.SecurityHub.Model.GetResourcesV2Response",
        "This cmdlet returns a collection of Amazon.SecurityHub.Model.ResourceResult objects.",
        "The service call response (type Amazon.SecurityHub.Model.GetResourcesV2Response) can be returned by specifying '-Select *'."
    )]
    public partial class GetSHUBResourcesV2Cmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        public Amazon.SecurityHub.Model.ResourcesCompositeFilter[] Filters_CompositeFilter { get; set; }
        #endregion
        
        #region Parameter Filters_CompositeOperator
        /// <summary>
        /// <para>
        /// <para>The logical operator used to combine multiple filter conditions in the structure.</para>
        /// </para>
        /// </summary>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityHub.Model.GetResourcesV2Response).
        /// Specifying the name of a property of type Amazon.SecurityHub.Model.GetResourcesV2Response will result in that property being returned.
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            request.Filters = new Amazon.SecurityHub.Model.ResourcesFilters();
            List<Amazon.SecurityHub.Model.ResourcesCompositeFilter> requestFilters_filters_CompositeFilter = null;
        ...
        private Amazon.SecurityHub.Model.GetResourcesV2Response CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetResourcesV2Request request)
        {
