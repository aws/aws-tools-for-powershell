...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class DisableSHUBOrganizationAdminAccountCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS account identifier of the Security Hub administrator account.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-SHUBOrganizationAdminAccount (DisableOrganizationAdminAccount)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityHub.Model.DisableOrganizationAdminAccountRequest();
        ...
        private Amazon.SecurityHub.Model.DisableOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DisableOrganizationAdminAccountRequest request)
        {
