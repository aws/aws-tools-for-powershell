...
{
    /// <summary>
    /// Returns a list of automation rules and metadata for the calling account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetSHUBAutomationRulesV2ListCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        private Amazon.SecurityHub.Model.ListAutomationRulesV2Response CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.ListAutomationRulesV2Request request)
        {
            ...
            try
            {
                return client.ListAutomationRulesV2Async(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
