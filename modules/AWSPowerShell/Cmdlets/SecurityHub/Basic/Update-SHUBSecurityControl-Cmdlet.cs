...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdletOutput("None or Amazon.SecurityHub.Model.UpdateSecurityControlResponse",
        ...
        "The service response (type Amazon.SecurityHub.Model.UpdateSecurityControlResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSHUBSecurityControlCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SecurityControlId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.SecurityControlId;
            }
        ...
        private Amazon.SecurityHub.Model.UpdateSecurityControlResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.UpdateSecurityControlRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateSecurityControl(request);
                #elif CORECLR
                return client.UpdateSecurityControlAsync(request).GetAwaiter().GetResult();
                #else
