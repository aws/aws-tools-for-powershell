...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class GetSHUBFindingHistoryCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        /// history.</para><para>If you provide values for both <c>StartTime</c> and <c>EndTime</c>, Security Hub CSPM
        ...
        /// Hub CSPM, see <a href="https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps">Timestamps</a>.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN generated by Security Hub CSPM that uniquely identifies a product that generates
        /// findings. This can be the ARN for a third-party product that is integrated with Security
        /// Hub CSPM, or the ARN for a custom integration.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A timestamp that indicates the start time of the requested finding history.</para><para>If you provide values for both <c>StartTime</c> and <c>EndTime</c>, Security Hub CSPM
        /// returns finding history for the specified time period. If you provide a value for
        /// <c>StartTime</c> but not for <c>EndTime</c>, Security Hub CSPM returns finding history
        /// from the <c>StartTime</c> to the time at which the API is called. If you provide a
        /// value for <c>EndTime</c> but not for <c>StartTime</c>, Security Hub CSPM returns finding
        ...
        /// CSPM returns up to 100 results of finding history. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// returns up to 100 results of finding history for each request. </para>
        /// </para>
        /// <para>
