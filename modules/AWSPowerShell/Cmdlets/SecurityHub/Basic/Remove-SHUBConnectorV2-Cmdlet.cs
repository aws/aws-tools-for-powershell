...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    public partial class RemoveSHUBConnectorV2Cmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SHUBConnectorV2 (DeleteConnectorV2)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityHub.Model.DeleteConnectorV2Response, RemoveSHUBConnectorV2Cmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityHub.Model.DeleteConnectorV2Request();
        ...
        private Amazon.SecurityHub.Model.DeleteConnectorV2Response CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DeleteConnectorV2Request request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "DeleteConnectorV2");
            try
            {
                #if DESKTOP
                return client.DeleteConnectorV2(request);
                #elif CORECLR
                return client.DeleteConnectorV2Async(request).GetAwaiter().GetResult();
                #else
