...
namespace Amazon.PowerShell.Cmdlets.EMSD
{
    ...
    public partial class GetEMSDObjectMetadataCmdlet : AmazonMediaStoreDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStoreData.Model.DescribeObjectResponse, GetEMSDObjectMetadataCmdlet>(Select) ??
        ...
        private Amazon.MediaStoreData.Model.DescribeObjectResponse CallAWSServiceOperation(IAmazonMediaStoreData client, Amazon.MediaStoreData.Model.DescribeObjectRequest request)
        {
            ...
            try
            {
                return client.DescribeObjectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Path { get; set; }
            public System.Func<Amazon.MediaStoreData.Model.DescribeObjectResponse, GetEMSDObjectMetadataCmdlet, object> Select { get; set; } =
