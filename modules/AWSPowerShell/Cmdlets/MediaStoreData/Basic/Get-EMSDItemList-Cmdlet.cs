...
namespace Amazon.PowerShell.Cmdlets.EMSD
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaStore Data Plane ListItems API operation.", Operation = new[] {"ListItems"}, SelectReturnType = typeof(Amazon.MediaStoreData.Model.ListItemsResponse))]
    [AWSCmdletOutput("Amazon.MediaStoreData.Model.Item or Amazon.MediaStoreData.Model.ListItemsResponse",
        "This cmdlet returns a collection of Amazon.MediaStoreData.Model.Item objects.",
        "The service call response (type Amazon.MediaStoreData.Model.ListItemsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMSDItemListCmdlet : AmazonMediaStoreDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStoreData.Model.ListItemsResponse, GetEMSDItemListCmdlet>(Select) ??
        ...
        private Amazon.MediaStoreData.Model.ListItemsResponse CallAWSServiceOperation(IAmazonMediaStoreData client, Amazon.MediaStoreData.Model.ListItemsRequest request)
        {
            ...
            try
            {
                return client.ListItemsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String Path { get; set; }
            public System.Func<Amazon.MediaStoreData.Model.ListItemsResponse, GetEMSDItemListCmdlet, object> Select { get; set; } =
