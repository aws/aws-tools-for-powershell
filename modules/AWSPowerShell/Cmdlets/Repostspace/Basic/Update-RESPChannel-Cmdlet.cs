...
namespace Amazon.PowerShell.Cmdlets.RESP
{
    ...
    /// </summary>
    [Cmdlet("Update", "RESPChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS re:Post Private UpdateChannel API operation.", Operation = new[] {"UpdateChannel"}, SelectReturnType = typeof(Amazon.Repostspace.Model.UpdateChannelResponse))]
    [AWSCmdletOutput("None or Amazon.Repostspace.Model.UpdateChannelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Repostspace.Model.UpdateChannelResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateRESPChannelCmdlet : AmazonRepostspaceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Repostspace.Model.UpdateChannelResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-RESPChannel (UpdateChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Repostspace.Model.UpdateChannelResponse, UpdateRESPChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Repostspace.Model.UpdateChannelRequest();
        ...
        private Amazon.Repostspace.Model.UpdateChannelResponse CallAWSServiceOperation(IAmazonRepostspace client, Amazon.Repostspace.Model.UpdateChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS re:Post Private", "UpdateChannel");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelName { get; set; }
            public System.String SpaceId { get; set; }
            public System.Func<Amazon.Repostspace.Model.UpdateChannelResponse, UpdateRESPChannelCmdlet, object> Select { get; set; } =
