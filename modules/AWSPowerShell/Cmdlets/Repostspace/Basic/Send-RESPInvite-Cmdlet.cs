...
namespace Amazon.PowerShell.Cmdlets.RESP
{
    ...
    /// </summary>
    [Cmdlet("Send", "RESPInvite", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class SendRESPInviteCmdlet : AmazonRepostspaceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The body of the invite.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The title of the invite.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Repostspace.Model.SendInvitesResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Send-RESPInvite (SendInvites)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Repostspace.Model.SendInvitesRequest();
        ...
        private Amazon.Repostspace.Model.SendInvitesResponse CallAWSServiceOperation(IAmazonRepostspace client, Amazon.Repostspace.Model.SendInvitesRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SpaceId { get; set; }
            public System.String Title { get; set; }
            public System.Func<Amazon.Repostspace.Model.SendInvitesResponse, SendRESPInviteCmdlet, object> Select { get; set; } =
