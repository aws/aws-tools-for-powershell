...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    [AWSCmdlet("Calls the Elastic Load Balancing DeleteLoadBalancerListeners API operation.", Operation = new[] {"DeleteLoadBalancerListeners"})]
    ...
    public partial class RemoveELBLoadBalancerListenerCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("LoadBalancerPort", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.LoadBalancerPorts != null)
            {
                request.LoadBalancerPorts = cmdletContext.LoadBalancerPorts;
            }
