...
namespace Amazon.PowerShell.Cmdlets.ELB
{
    ...
    public partial class AddELBTagsCmdlet : AmazonElasticLoadBalancingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ELBTags (AddTags)"))
            {
                return;
            }
