...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.InferenceExecutionSummary or Amazon.LookoutEquipment.Model.ListInferenceExecutionsResponse",
        ...
        "The service call response (type Amazon.LookoutEquipment.Model.ListInferenceExecutionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
