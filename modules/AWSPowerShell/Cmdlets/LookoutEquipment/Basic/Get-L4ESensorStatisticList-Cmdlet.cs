...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    /// </summary>
    [Cmdlet("Get", "L4ESensorStatisticList")]
    [OutputType("Amazon.LookoutEquipment.Model.SensorStatisticsSummary")]
    [AWSCmdlet("Calls the Amazon Lookout for Equipment ListSensorStatistics API operation.", Operation = new[] {"ListSensorStatistics"}, SelectReturnType = typeof(Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse))]
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.SensorStatisticsSummary or Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse",
        "This cmdlet returns a collection of Amazon.LookoutEquipment.Model.SensorStatisticsSummary objects.",
        "The service call response (type Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetL4ESensorStatisticListCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SensorStatisticsSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse, GetL4ESensorStatisticListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LookoutEquipment.Model.ListSensorStatisticsRequest();
        ...
        private Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.ListSensorStatisticsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.ListSensorStatisticsResponse, GetL4ESensorStatisticListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SensorStatisticsSummaries;
        }
