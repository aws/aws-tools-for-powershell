...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Lookout for Equipment DeleteModel API operation.", Operation = new[] {"DeleteModel"}, SelectReturnType = typeof(Amazon.LookoutEquipment.Model.DeleteModelResponse))]
    [AWSCmdletOutput("None or Amazon.LookoutEquipment.Model.DeleteModelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LookoutEquipment.Model.DeleteModelResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveL4EModelCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-L4EModel (DeleteModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.DeleteModelResponse, RemoveL4EModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutEquipment.Model.DeleteModelRequest();
        ...
        private Amazon.LookoutEquipment.Model.DeleteModelResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.DeleteModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Equipment", "DeleteModel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.DeleteModelResponse, RemoveL4EModelCmdlet, object> Select { get; set; } =
