...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    /// </summary>
    [Cmdlet("Update", "L4ELabelGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateL4ELabelGroupCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-L4ELabelGroup (UpdateLabelGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.UpdateLabelGroupResponse, UpdateL4ELabelGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutEquipment.Model.UpdateLabelGroupRequest();
        ...
        private Amazon.LookoutEquipment.Model.UpdateLabelGroupResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.UpdateLabelGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Equipment", "UpdateLabelGroup");
            try
            {
                #if DESKTOP
                return client.UpdateLabelGroup(request);
                #elif CORECLR
                return client.UpdateLabelGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LabelGroupName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.UpdateLabelGroupResponse, UpdateL4ELabelGroupCmdlet, object> Select { get; set; } =
