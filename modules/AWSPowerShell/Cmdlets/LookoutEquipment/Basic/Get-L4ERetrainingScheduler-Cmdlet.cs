...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerResponse",
        "This cmdlet returns an Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerResponse object containing multiple properties."
    )]
    public partial class GetL4ERetrainingSchedulerCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the model that the retraining scheduler is attached to. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerResponse, GetL4ERetrainingSchedulerCmdlet>(Select) ??
        ...
        private Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerRequest request)
        {
            ...
            try
            {
                return client.DescribeRetrainingSchedulerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.DescribeRetrainingSchedulerResponse, GetL4ERetrainingSchedulerCmdlet, object> Select { get; set; } =
