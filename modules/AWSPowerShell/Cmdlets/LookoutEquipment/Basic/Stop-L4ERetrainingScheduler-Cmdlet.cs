...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    public partial class StopL4ERetrainingSchedulerCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the model whose retraining scheduler you want to stop.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.StopRetrainingSchedulerResponse, StopL4ERetrainingSchedulerCmdlet>(Select) ??
        ...
        private Amazon.LookoutEquipment.Model.StopRetrainingSchedulerResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.StopRetrainingSchedulerRequest request)
        {
            ...
            try
            {
                return client.StopRetrainingSchedulerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.StopRetrainingSchedulerResponse, StopL4ERetrainingSchedulerCmdlet, object> Select { get; set; } =
