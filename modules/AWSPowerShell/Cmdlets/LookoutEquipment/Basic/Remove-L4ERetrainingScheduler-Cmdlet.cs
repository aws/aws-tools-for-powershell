...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdletOutput("None or Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerResponse",
        ...
        "The service response (type Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveL4ERetrainingSchedulerCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the model whose retraining scheduler you want to delete. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerResponse, RemoveL4ERetrainingSchedulerCmdlet>(Select) ??
        ...
        private Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerRequest request)
        {
            ...
            try
            {
                return client.DeleteRetrainingSchedulerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.DeleteRetrainingSchedulerResponse, RemoveL4ERetrainingSchedulerCmdlet, object> Select { get; set; } =
