...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.CreateLabelGroupResponse",
        "This cmdlet returns an Amazon.LookoutEquipment.Model.CreateLabelGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewL4ELabelGroupCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^LabelGroupName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.LabelGroupName;
            }
        ...
        private Amazon.LookoutEquipment.Model.CreateLabelGroupResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.CreateLabelGroupRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateLabelGroup(request);
                #elif CORECLR
                return client.CreateLabelGroupAsync(request).GetAwaiter().GetResult();
                #else
