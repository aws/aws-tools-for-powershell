...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdlet("Calls the Amazon Lookout for Equipment DescribeDataset API operation.", Operation = new[] {"DescribeDataset"}, SelectReturnType = typeof(Amazon.LookoutEquipment.Model.DescribeDatasetResponse))]
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.DescribeDatasetResponse",
        "This cmdlet returns an Amazon.LookoutEquipment.Model.DescribeDatasetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetL4EDatasetCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.DescribeDatasetResponse, GetL4EDatasetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutEquipment.Model.DescribeDatasetRequest();
        ...
        private Amazon.LookoutEquipment.Model.DescribeDatasetResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.DescribeDatasetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Equipment", "DescribeDataset");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DatasetName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.DescribeDatasetResponse, GetL4EDatasetCmdlet, object> Select { get; set; } =
