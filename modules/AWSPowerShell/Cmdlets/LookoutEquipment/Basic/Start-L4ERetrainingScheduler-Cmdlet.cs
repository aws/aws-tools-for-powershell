...
namespace Amazon.PowerShell.Cmdlets.L4E
{
    ...
    [AWSCmdletOutput("Amazon.LookoutEquipment.Model.StartRetrainingSchedulerResponse",
        "This cmdlet returns an Amazon.LookoutEquipment.Model.StartRetrainingSchedulerResponse object containing multiple properties."
    )]
    public partial class StartL4ERetrainingSchedulerCmdlet : AmazonLookoutEquipmentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the model whose retraining scheduler you want to start.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutEquipment.Model.StartRetrainingSchedulerResponse, StartL4ERetrainingSchedulerCmdlet>(Select) ??
        ...
        private Amazon.LookoutEquipment.Model.StartRetrainingSchedulerResponse CallAWSServiceOperation(IAmazonLookoutEquipment client, Amazon.LookoutEquipment.Model.StartRetrainingSchedulerRequest request)
        {
            ...
            try
            {
                return client.StartRetrainingSchedulerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.LookoutEquipment.Model.StartRetrainingSchedulerResponse, StartL4ERetrainingSchedulerCmdlet, object> Select { get; set; } =
