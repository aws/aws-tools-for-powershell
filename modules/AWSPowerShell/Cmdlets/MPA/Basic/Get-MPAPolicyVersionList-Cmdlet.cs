...
namespace Amazon.PowerShell.Cmdlets.MPA
{
    ...
    /// resources.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetMPAPolicyVersionListCmdlet : AmazonMPAClientCmdlet, IExecutor
    {
        ...
        private Amazon.MPA.Model.ListPolicyVersionsResponse CallAWSServiceOperation(IAmazonMPA client, Amazon.MPA.Model.ListPolicyVersionsRequest request)
        {
            ...
            try
            {
                return client.ListPolicyVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
