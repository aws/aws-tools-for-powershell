...
namespace Amazon.PowerShell.Cmdlets.MAC
{
    ...
    [AWSCmdlet("Calls the Amazon Macie AssociateMemberAccount API operation.", Operation = new[] {"AssociateMemberAccount"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the MemberAccountId parameter. Otherwise, this cmdlet does not return any output. " +
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.MemberAccountId;
