...
namespace Amazon.PowerShell.Cmdlets.MAC
{
    ...
    [AWSCmdlet("Calls the Amazon Macie ListS3Resources API operation.", Operation = new[] {"ListS3Resources"})]
    [AWSCmdletOutput("Amazon.Macie.Model.S3ResourceClassification",
        "This cmdlet returns a collection of S3ResourceClassification objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.S3Resources;
