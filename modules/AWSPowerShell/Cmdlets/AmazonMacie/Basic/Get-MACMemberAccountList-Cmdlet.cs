...
namespace Amazon.PowerShell.Cmdlets.MAC
{
    ...
    [AWSCmdlet("Calls the Amazon Macie ListMemberAccounts API operation.", Operation = new[] {"ListMemberAccounts"})]
    [AWSCmdletOutput("Amazon.Macie.Model.MemberAccount",
        "This cmdlet returns a collection of MemberAccount objects.",
        "The service call response (type Amazon.Macie.Model.ListMemberAccountsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetMACMemberAccountListCmdlet : AmazonMacieClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Macie.Model.ListMemberAccountsRequest();
        ...
        private Amazon.Macie.Model.ListMemberAccountsResponse CallAWSServiceOperation(IAmazonMacie client, Amazon.Macie.Model.ListMemberAccountsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Macie", "ListMemberAccounts");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListMemberAccountsAsync(request);
                return task.Result;
                #else
