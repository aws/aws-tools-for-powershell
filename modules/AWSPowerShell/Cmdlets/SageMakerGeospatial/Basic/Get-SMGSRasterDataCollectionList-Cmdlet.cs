...
{
    /// <summary>
    /// Use this operation to get raster data collections.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetSMGSRasterDataCollectionListCmdlet : AmazonSageMakerGeospatialClientCmdlet, IExecutor
    {
        ...
        private Amazon.SageMakerGeospatial.Model.ListRasterDataCollectionsResponse CallAWSServiceOperation(IAmazonSageMakerGeospatial client, Amazon.SageMakerGeospatial.Model.ListRasterDataCollectionsRequest request)
        {
            ...
            try
            {
                return client.ListRasterDataCollectionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
