...
namespace Amazon.PowerShell.Cmdlets.SMGS
{
    ...
    /// calling Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.SageMakerGeospatial.Model.ListEarthObservationJobOutputConfig or Amazon.SageMakerGeospatial.Model.ListEarthObservationJobsResponse",
        ...
        "The service call response (type Amazon.SageMakerGeospatial.Model.ListEarthObservationJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMGSEarthObservationJobListCmdlet : AmazonSageMakerGeospatialClientCmdlet, IExecutor
    {
        ...
        private Amazon.SageMakerGeospatial.Model.ListEarthObservationJobsResponse CallAWSServiceOperation(IAmazonSageMakerGeospatial client, Amazon.SageMakerGeospatial.Model.ListEarthObservationJobsRequest request)
        {
            ...
            try
            {
                return client.ListEarthObservationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
