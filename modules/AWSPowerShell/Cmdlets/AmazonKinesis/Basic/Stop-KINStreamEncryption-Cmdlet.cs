...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    public partial class StopKINStreamEncryptionCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The encryption type. This parameter can be one of the following values:</para><ul><li><para><code>NONE</code>: Not valid for this operation. An <code>InvalidOperationException</code>
        ...
        /// <summary>
        /// <para>
        /// <para>The GUID for the customer-managed key that was used for encryption.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
