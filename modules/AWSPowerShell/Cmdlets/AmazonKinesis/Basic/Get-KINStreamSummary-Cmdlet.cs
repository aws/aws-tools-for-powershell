...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis DescribeStreamSummary API operation.", Operation = new[] {"DescribeStreamSummary"})]
    [AWSCmdletOutput("Amazon.Kinesis.Model.StreamDescriptionSummary",
        "This cmdlet returns a StreamDescriptionSummary object.",
    ...
    public partial class GetKINStreamSummaryCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.StreamDescriptionSummary;
        ...
        private Amazon.Kinesis.Model.DescribeStreamSummaryResponse CallAWSServiceOperation(IAmazonKinesis client, Amazon.Kinesis.Model.DescribeStreamSummaryRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeStreamSummaryAsync(request);
                return task.Result;
                #else
