...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis DeregisterStreamConsumer API operation.", Operation = new[] {"DeregisterStreamConsumer"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ConsumerARN parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class UnregisterKINStreamConsumerCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ConsumerARN;
        ...
        private Amazon.Kinesis.Model.DeregisterStreamConsumerResponse CallAWSServiceOperation(IAmazonKinesis client, Amazon.Kinesis.Model.DeregisterStreamConsumerRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeregisterStreamConsumerAsync(request);
                return task.Result;
                #else
