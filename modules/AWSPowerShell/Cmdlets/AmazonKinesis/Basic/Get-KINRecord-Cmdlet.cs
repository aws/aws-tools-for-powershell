...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    [AWSCmdlet("Invokes the GetRecords operation against Amazon Kinesis.", Operation = new[] {"GetRecords"})]
    ...
    public class GetKINRecordCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
