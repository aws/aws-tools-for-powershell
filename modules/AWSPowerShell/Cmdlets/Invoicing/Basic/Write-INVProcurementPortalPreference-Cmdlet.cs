...
namespace Amazon.PowerShell.Cmdlets.INV
{
    ...
    /// </summary>
    [Cmdlet("Write", "INVProcurementPortalPreference", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Invoicing PutProcurementPortalPreference API operation.", Operation = new[] {"PutProcurementPortalPreference"}, SelectReturnType = typeof(Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse))]
    [AWSCmdletOutput("System.String or Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class WriteINVProcurementPortalPreferenceCmdlet : AmazonInvoicingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Updated list of contact information for portal administrators and technical contacts.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Updated flag indicating whether e-invoice delivery is enabled for this procurement
        /// portal preference.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated endpoint URL where e-invoices will be delivered to the procurement portal.
        /// Must be a valid HTTPS URL.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated shared secret or authentication credential for the procurement portal.
        /// This value must be encrypted at rest.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Updated flag indicating whether purchase order retrieval is enabled for this procurement
        /// portal preference.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying the name of a property of type Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-INVProcurementPortalPreference (PutProcurementPortalPreference)"))
            {
                return;
            }
        ...
        private Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse CallAWSServiceOperation(IAmazonInvoicing client, Amazon.Invoicing.Model.PutProcurementPortalPreferenceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Invoicing", "PutProcurementPortalPreference");
            try
            {
                #if DESKTOP
                return client.PutProcurementPortalPreference(request);
                #elif CORECLR
                return client.PutProcurementPortalPreferenceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Invoicing.SupplierDomain TestEnvPreference_SupplierDomain { get; set; }
            public System.String TestEnvPreference_SupplierIdentifier { get; set; }
            public System.Func<Amazon.Invoicing.Model.PutProcurementPortalPreferenceResponse, WriteINVProcurementPortalPreferenceCmdlet, object> Select { get; set; } =
