...
namespace Amazon.PowerShell.Cmdlets.INV
{
    ...
    /// </summary>
    [Cmdlet("Remove", "INVInvoiceUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Invoicing DeleteInvoiceUnit API operation.", Operation = new[] {"DeleteInvoiceUnit"}, SelectReturnType = typeof(Amazon.Invoicing.Model.DeleteInvoiceUnitResponse))]
    [AWSCmdletOutput("System.String or Amazon.Invoicing.Model.DeleteInvoiceUnitResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Invoicing.Model.DeleteInvoiceUnitResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveINVInvoiceUnitCmdlet : AmazonInvoicingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-INVInvoiceUnit (DeleteInvoiceUnit)"))
            {
                return;
            }
        ...
        private Amazon.Invoicing.Model.DeleteInvoiceUnitResponse CallAWSServiceOperation(IAmazonInvoicing client, Amazon.Invoicing.Model.DeleteInvoiceUnitRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Invoicing", "DeleteInvoiceUnit");
            try
            {
                #if DESKTOP
                return client.DeleteInvoiceUnit(request);
                #elif CORECLR
                return client.DeleteInvoiceUnitAsync(request).GetAwaiter().GetResult();
                #else
