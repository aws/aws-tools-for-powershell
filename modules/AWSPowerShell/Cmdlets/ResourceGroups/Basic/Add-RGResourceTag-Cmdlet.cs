...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    public partial class AddRGResourceTagCmdlet : AmazonResourceGroupsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-RGResourceTag (Tag)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceGroups.Model.TagResponse, AddRGResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceGroups.Model.TagRequest();
        ...
        private Amazon.ResourceGroups.Model.TagResponse CallAWSServiceOperation(IAmazonResourceGroups client, Amazon.ResourceGroups.Model.TagRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Groups", "Tag");
            try
            {
                return client.TagAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ResourceGroups.Model.TagResponse, AddRGResourceTagCmdlet, object> Select { get; set; } =
