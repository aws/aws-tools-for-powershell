...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    public partial class AddRGResourceCmdlet : AmazonResourceGroupsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-RGResource (GroupResources)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceGroups.Model.GroupResourcesResponse, AddRGResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceGroups.Model.GroupResourcesRequest();
        ...
        private Amazon.ResourceGroups.Model.GroupResourcesResponse CallAWSServiceOperation(IAmazonResourceGroups client, Amazon.ResourceGroups.Model.GroupResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Groups", "GroupResources");
            try
            {
                #if DESKTOP
                return client.GroupResources(request);
                #elif CORECLR
                return client.GroupResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ResourceGroups.Model.GroupResourcesResponse, AddRGResourceCmdlet, object> Select { get; set; } =
