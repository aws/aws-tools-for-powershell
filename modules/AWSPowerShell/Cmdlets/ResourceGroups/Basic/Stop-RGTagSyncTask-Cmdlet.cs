...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    /// </para><ul><li><para><c>resource-groups:CancelTagSyncTask</c> on the application group
    /// </para></li><li><para><c>resource-groups:DeleteGroup</c></para></li></ul>
    /// </summary>
    [Cmdlet("Stop", "RGTagSyncTask", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopRGTagSyncTaskCmdlet : AmazonResourceGroupsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon resource name (ARN) of the tag-sync task. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ResourceGroups.Model.CancelTagSyncTaskResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-RGTagSyncTask (CancelTagSyncTask)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceGroups.Model.CancelTagSyncTaskResponse, StopRGTagSyncTaskCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceGroups.Model.CancelTagSyncTaskRequest();
        ...
        private Amazon.ResourceGroups.Model.CancelTagSyncTaskResponse CallAWSServiceOperation(IAmazonResourceGroups client, Amazon.ResourceGroups.Model.CancelTagSyncTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Groups", "CancelTagSyncTask");
            try
            {
                #if DESKTOP
                return client.CancelTagSyncTask(request);
                #elif CORECLR
                return client.CancelTagSyncTaskAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TaskArn { get; set; }
            public System.Func<Amazon.ResourceGroups.Model.CancelTagSyncTaskResponse, StopRGTagSyncTaskCmdlet, object> Select { get; set; } =
