...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    /// </para><ul><li><para><c>resource-groups:ListGroups</c></para></li></ul><br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetRGGroupListCmdlet : AmazonResourceGroupsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GroupIdentifiers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceGroups.Model.ListGroupsResponse, GetRGGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GroupIdentifiers?.Count ?? 0;
        ...
        private Amazon.ResourceGroups.Model.ListGroupsResponse CallAWSServiceOperation(IAmazonResourceGroups client, Amazon.ResourceGroups.Model.ListGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Groups", "ListGroups");
            try
            {
        ...
        {
            public List<Amazon.ResourceGroups.Model.GroupFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ResourceGroups.Model.ListGroupsResponse, GetRGGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GroupIdentifiers;
        }
