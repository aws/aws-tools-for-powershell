...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email ListDedicatedIpPools API operation.", Operation = new[] {"ListDedicatedIpPools"})]
    ...
    public partial class GetPINEDedicatedIpPoolListCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DedicatedIpPools;
        ...
        private Amazon.PinpointEmail.Model.ListDedicatedIpPoolsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.ListDedicatedIpPoolsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListDedicatedIpPoolsAsync(request);
                return task.Result;
                #else
