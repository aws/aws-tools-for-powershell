...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email GetConfigurationSetEventDestinations API operation.", Operation = new[] {"GetConfigurationSetEventDestinations"})]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.EventDestination",
        "This cmdlet returns a collection of EventDestination objects.",
    ...
    public partial class GetPINEConfigurationSetEventDestinationCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.EventDestinations;
        ...
        private Amazon.PinpointEmail.Model.GetConfigurationSetEventDestinationsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.GetConfigurationSetEventDestinationsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetConfigurationSetEventDestinationsAsync(request);
                return task.Result;
                #else
