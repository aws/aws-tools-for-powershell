...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email PutConfigurationSetDeliveryOptions API operation.", Operation = new[] {"PutConfigurationSetDeliveryOptions"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.PinpointEmail.Model.PutConfigurationSetDeliveryOptionsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WritePINEConfigurationSetDeliveryOptionCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        private Amazon.PinpointEmail.Model.PutConfigurationSetDeliveryOptionsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.PutConfigurationSetDeliveryOptionsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.PutConfigurationSetDeliveryOptionsAsync(request);
                return task.Result;
                #else
