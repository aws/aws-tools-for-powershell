...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    public partial class UpdatePINEConfigurationSetEventDestinationCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-PINEConfigurationSetEventDestination (UpdateConfigurationSetEventDestination)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointEmail.Model.UpdateConfigurationSetEventDestinationRequest();
        ...
        private Amazon.PinpointEmail.Model.UpdateConfigurationSetEventDestinationResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.UpdateConfigurationSetEventDestinationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "UpdateConfigurationSetEventDestination");
            try
            {
                #if DESKTOP
