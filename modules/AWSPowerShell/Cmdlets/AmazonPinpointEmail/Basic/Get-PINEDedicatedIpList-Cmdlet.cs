...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email GetDedicatedIps API operation.", Operation = new[] {"GetDedicatedIps"})]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.DedicatedIp",
        "This cmdlet returns a collection of DedicatedIp objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DedicatedIps;
