...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email ListEmailIdentities API operation.", Operation = new[] {"ListEmailIdentities"})]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.IdentityInfo",
        "This cmdlet returns a collection of IdentityInfo objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.EmailIdentities;
