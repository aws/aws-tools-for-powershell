...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email GetBlacklistReports API operation.", Operation = new[] {"GetBlacklistReports"})]
    ...
    public partial class GetPINEBlacklistReportCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.BlacklistItemNames = new List<System.String>(this.BlacklistItemName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.BlacklistItemNames != null)
            {
                request.BlacklistItemNames = cmdletContext.BlacklistItemNames;
            }
            ...
            try
            {
                ...
                object pipelineOutput = response.BlacklistReport;
        ...
        private Amazon.PinpointEmail.Model.GetBlacklistReportsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.GetBlacklistReportsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetBlacklistReportsAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<System.String> BlacklistItemNames { get; set; }
        }
