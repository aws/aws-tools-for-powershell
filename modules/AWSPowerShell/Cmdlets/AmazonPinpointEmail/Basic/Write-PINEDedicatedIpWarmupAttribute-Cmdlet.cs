...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email PutDedicatedIpWarmupAttributes API operation.", Operation = new[] {"PutDedicatedIpWarmupAttributes"})]
    ...
    public partial class WritePINEDedicatedIpWarmupAttributeCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.Ip = this.Ip;
            if (ParameterWasBound("WarmupPercentage"))
