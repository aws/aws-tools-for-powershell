...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint Email GetDeliverabilityTestReport API operation.", Operation = new[] {"GetDeliverabilityTestReport"})]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.GetDeliverabilityTestReportResponse",
        "This cmdlet returns a Amazon.PinpointEmail.Model.GetDeliverabilityTestReportResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINEDeliverabilityTestReportCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        private Amazon.PinpointEmail.Model.GetDeliverabilityTestReportResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.GetDeliverabilityTestReportRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDeliverabilityTestReportAsync(request);
                return task.Result;
                #else
