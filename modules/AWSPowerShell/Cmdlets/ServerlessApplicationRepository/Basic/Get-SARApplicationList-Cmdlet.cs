...
namespace Amazon.PowerShell.Cmdlets.SAR
{
    ...
    [AWSCmdlet("Calls the AWS Serverless Application Repository ListApplications API operation.", Operation = new[] {"ListApplications"}, SelectReturnType = typeof(Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse))]
    [AWSCmdletOutput("Amazon.ServerlessApplicationRepository.Model.ApplicationSummary or Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse",
        "This cmdlet returns a collection of Amazon.ServerlessApplicationRepository.Model.ApplicationSummary objects.",
        "The service call response (type Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSARApplicationListCmdlet : AmazonServerlessApplicationRepositoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse, GetSARApplicationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Applications?.Count ?? 0;
        ...
        private Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse CallAWSServiceOperation(IAmazonServerlessApplicationRepository client, Amazon.ServerlessApplicationRepository.Model.ListApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Serverless Application Repository", "ListApplications");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxItem { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ServerlessApplicationRepository.Model.ListApplicationsResponse, GetSARApplicationListCmdlet, object> Select { get; set; } =
