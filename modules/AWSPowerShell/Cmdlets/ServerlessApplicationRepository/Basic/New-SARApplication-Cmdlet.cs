...
namespace Amazon.PowerShell.Cmdlets.SAR
{
    ...
    public partial class NewSARApplicationCmdlet : AmazonServerlessApplicationRepositoryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Labels to improve discovery of apps in search results.</para><para>Minimum length=1. Maximum length=127. Maximum number of labels: 10</para><para>Pattern: "^[a-zA-Z0-9+\\-_:\\/@]+$";</para><para />
