...
namespace Amazon.PowerShell.Cmdlets.CGR
{
    ...
    [AWSCmdletOutput("Amazon.CodeGuruReviewer.Model.CodeReviewSummary or Amazon.CodeGuruReviewer.Model.ListCodeReviewsResponse",
        ...
        "The service call response (type Amazon.CodeGuruReviewer.Model.ListCodeReviewsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
