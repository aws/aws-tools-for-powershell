...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Get", "ATHWorkGroupList")]
    [OutputType("Amazon.Athena.Model.WorkGroupSummary")]
    [AWSCmdlet("Calls the Amazon Athena ListWorkGroups API operation.", Operation = new[] {"ListWorkGroups"})]
    [AWSCmdletOutput("Amazon.Athena.Model.WorkGroupSummary",
        "This cmdlet returns a collection of WorkGroupSummary objects.",
    ...
    public partial class GetATHWorkGroupListCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Athena.Model.ListWorkGroupsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.WorkGroups;
        ...
        private Amazon.Athena.Model.ListWorkGroupsResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.ListWorkGroupsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListWorkGroupsAsync(request);
                return task.Result;
                #else
