...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena ListNamedQueries API operation.", Operation = new[] {"ListNamedQueries"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Athena.Model.ListNamedQueriesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetATHNamedQueryListCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Athena.Model.ListNamedQueriesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.NamedQueryIds;
                        ...
                        int _receivedThisCall = response.NamedQueryIds.Count;
        ...
        private Amazon.Athena.Model.ListNamedQueriesResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.ListNamedQueriesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "ListNamedQueries");
            try
            {
                #if DESKTOP
                return client.ListNamedQueries(request);
                #elif CORECLR
                return client.ListNamedQueriesAsync(request).GetAwaiter().GetResult();
                #else
