...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.Athena.Model.Tag",
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                do
                {
                    ...
                    ProcessOutput(output);
                } while (!_userControllingPaging && AutoIterationHelpers.HasValue(_nextMarker) && (!_emitLimit.HasValue || _emitLimit.Value >= 75));
