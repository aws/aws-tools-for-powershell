...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena GetNamedQuery API operation.", Operation = new[] {"GetNamedQuery"})]
    [AWSCmdletOutput("Amazon.Athena.Model.NamedQuery",
        "This cmdlet returns a NamedQuery object.",
        "The service call response (type Amazon.Athena.Model.GetNamedQueryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetATHNamedQueryCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.NamedQuery;
        ...
        private Amazon.Athena.Model.GetNamedQueryResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetNamedQueryRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetNamedQuery(request);
                #elif CORECLR
                return client.GetNamedQueryAsync(request).GetAwaiter().GetResult();
                #else
