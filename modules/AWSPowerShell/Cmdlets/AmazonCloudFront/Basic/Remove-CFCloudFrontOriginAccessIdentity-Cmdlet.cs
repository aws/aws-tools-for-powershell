...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteCloudFrontOriginAccessIdentityResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveCFCloudFrontOriginAccessIdentityCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new DeleteCloudFrontOriginAccessIdentityRequest();
            ...
            try
            {
                var response = client.DeleteCloudFrontOriginAccessIdentity(request);
