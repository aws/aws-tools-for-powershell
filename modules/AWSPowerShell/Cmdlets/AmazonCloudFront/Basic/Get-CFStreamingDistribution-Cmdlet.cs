...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Invokes the GetStreamingDistribution operation against Amazon CloudFront.", Operation = new[] {"GetStreamingDistribution"})]
    ...
    public partial class GetCFStreamingDistributionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        private Amazon.CloudFront.Model.GetStreamingDistributionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetStreamingDistributionRequest request)
        {
            ...
            var task = client.GetStreamingDistributionAsync(request);
            return task.Result;
            #else
