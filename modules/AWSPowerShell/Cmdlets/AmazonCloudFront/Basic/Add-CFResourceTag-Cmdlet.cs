...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Invokes the TagResource operation against Amazon CloudFront.", Operation = new[] {"TagResource"})]
    ...
    public class AddCFResourceTagCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
