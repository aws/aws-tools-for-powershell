...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Invokes the DeleteDistribution operation against Amazon CloudFront.", Operation = new[] {"DeleteDistribution"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteDistributionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveCFDistributionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        /// The distribution id.
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteDistribution(request);
