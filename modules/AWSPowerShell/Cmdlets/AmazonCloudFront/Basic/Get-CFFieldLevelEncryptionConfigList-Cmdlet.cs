...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [OutputType("Amazon.CloudFront.Model.FieldLevelEncryptionList")]
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.FieldLevelEncryptionList",
        "This cmdlet returns a FieldLevelEncryptionList object.",
    ...
    public partial class GetCFFieldLevelEncryptionConfigListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.FieldLevelEncryptionList;
        ...
        private Amazon.CloudFront.Model.ListFieldLevelEncryptionConfigsResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListFieldLevelEncryptionConfigsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListFieldLevelEncryptionConfigsAsync(request);
                return task.Result;
                #else
