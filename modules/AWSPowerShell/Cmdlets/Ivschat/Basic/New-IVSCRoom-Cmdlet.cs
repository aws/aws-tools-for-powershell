...
namespace Amazon.PowerShell.Cmdlets.IVSC
{
    ...
    [AWSCmdletOutput("Amazon.Ivschat.Model.CreateRoomResponse",
        "This cmdlet returns an Amazon.Ivschat.Model.CreateRoomResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIVSCRoomCmdlet : AmazonIvschatClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Maximum number of messages per second that a client can send to the room. Default:
        /// 10.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
