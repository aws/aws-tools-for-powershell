...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ECSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon EC2 Container Service UntagResource API operation.", Operation = new[] {"UntagResource"})]
    ...
    public partial class RemoveECSResourceTagCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ECSResourceTag (UntagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECS.Model.UntagResourceRequest();
        ...
        private Amazon.ECS.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Service", "UntagResource");
            try
            {
                #if DESKTOP
