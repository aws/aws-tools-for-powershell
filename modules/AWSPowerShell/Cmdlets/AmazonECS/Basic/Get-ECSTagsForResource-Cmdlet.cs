...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Service ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.ECS.Model.Tag",
