...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Invokes the ListTaskDefinitionFamilies operation against Amazon EC2 Container Service.", Operation = new[] {"ListTaskDefinitionFamilies"})]
    ...
    public partial class GetECSTaskDefinitionFamiliesCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        private Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.ListTaskDefinitionFamiliesRequest request)
        {
            ...
            var task = client.ListTaskDefinitionFamiliesAsync(request);
            return task.Result;
            #else
