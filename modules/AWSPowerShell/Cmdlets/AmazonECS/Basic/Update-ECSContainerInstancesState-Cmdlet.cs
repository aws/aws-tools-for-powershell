...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Invokes the UpdateContainerInstancesState operation against Amazon EC2 Container Service.", Operation = new[] {"UpdateContainerInstancesState"})]
    ...
    public partial class UpdateECSContainerInstancesStateCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ECS.Model.UpdateContainerInstancesStateResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.UpdateContainerInstancesStateRequest request)
        {
            #if DESKTOP
