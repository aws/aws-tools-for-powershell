...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Service ListTaskDefinitions API operation.", Operation = new[] {"ListTaskDefinitions"}, LegacyAlias="Get-ECSTaskDefinitions")]
