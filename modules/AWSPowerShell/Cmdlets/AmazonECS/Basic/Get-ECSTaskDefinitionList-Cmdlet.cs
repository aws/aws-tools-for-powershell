...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Invokes the ListTaskDefinitions operation against Amazon EC2 Container Service.", Operation = new[] {"ListTaskDefinitions"}, LegacyAlias="Get-ECSTaskDefinitions")]
