...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Service DescribeTaskSets API operation.", Operation = new[] {"DescribeTaskSets"})]
    [AWSCmdletOutput("Amazon.ECS.Model.DescribeTaskSetsResponse",
        "This cmdlet returns a Amazon.ECS.Model.DescribeTaskSetsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetECSTaskSetCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.TaskSets = new List<System.String>(this.TaskSet);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.TaskSets != null)
            {
                request.TaskSets = cmdletContext.TaskSets;
            }
        ...
        private Amazon.ECS.Model.DescribeTaskSetsResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.DescribeTaskSetsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeTaskSets(request);
                #elif CORECLR
                return client.DescribeTaskSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Cluster { get; set; }
            public System.String Service { get; set; }
            public List<System.String> TaskSets { get; set; }
        }
