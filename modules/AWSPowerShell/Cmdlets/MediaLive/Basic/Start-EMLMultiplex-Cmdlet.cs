...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Start", "EMLMultiplex", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartEMLMultiplexCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-EMLMultiplex (StartMultiplex)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.StartMultiplexResponse, StartEMLMultiplexCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.StartMultiplexRequest();
        ...
        private Amazon.MediaLive.Model.StartMultiplexResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.StartMultiplexRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "StartMultiplex");
            try
            {
                #if DESKTOP
                return client.StartMultiplex(request);
                #elif CORECLR
                return client.StartMultiplexAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MultiplexId { get; set; }
            public System.Func<Amazon.MediaLive.Model.StartMultiplexResponse, StartEMLMultiplexCmdlet, object> Select { get; set; } =
