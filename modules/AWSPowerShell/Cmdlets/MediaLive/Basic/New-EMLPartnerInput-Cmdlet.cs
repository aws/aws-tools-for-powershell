...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("New", "EMLPartnerInput", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaLive.Model.Input")]
    [AWSCmdlet("Calls the AWS Elemental MediaLive CreatePartnerInput API operation.", Operation = new[] {"CreatePartnerInput"}, SelectReturnType = typeof(Amazon.MediaLive.Model.CreatePartnerInputResponse))]
    [AWSCmdletOutput("Amazon.MediaLive.Model.Input or Amazon.MediaLive.Model.CreatePartnerInputResponse",
        "This cmdlet returns an Amazon.MediaLive.Model.Input object.",
        "The service call response (type Amazon.MediaLive.Model.CreatePartnerInputResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEMLPartnerInputCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EMLPartnerInput (CreatePartnerInput)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.CreatePartnerInputResponse, NewEMLPartnerInputCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.CreatePartnerInputRequest();
        ...
        private Amazon.MediaLive.Model.CreatePartnerInputResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.CreatePartnerInputRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "CreatePartnerInput");
            try
            {
                #if DESKTOP
                return client.CreatePartnerInput(request);
                #elif CORECLR
                return client.CreatePartnerInputAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MediaLive.Model.CreatePartnerInputResponse, NewEMLPartnerInputCmdlet, object> Select { get; set; } =
