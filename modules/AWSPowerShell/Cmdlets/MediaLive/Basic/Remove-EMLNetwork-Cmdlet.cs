...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMLNetwork", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveEMLNetworkCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaLive.Model.DeleteNetworkResponse).
        /// Specifying the name of a property of type Amazon.MediaLive.Model.DeleteNetworkResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMLNetwork (DeleteNetwork)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.DeleteNetworkResponse, RemoveEMLNetworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.DeleteNetworkRequest();
        ...
        private Amazon.MediaLive.Model.DeleteNetworkResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DeleteNetworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "DeleteNetwork");
            try
            {
        ...
        {
            public System.String NetworkId { get; set; }
            public System.Func<Amazon.MediaLive.Model.DeleteNetworkResponse, RemoveEMLNetworkCmdlet, object> Select { get; set; } =
