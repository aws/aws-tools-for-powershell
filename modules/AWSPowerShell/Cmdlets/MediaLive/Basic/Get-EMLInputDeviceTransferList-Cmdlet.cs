...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMLInputDeviceTransferList")]
    [OutputType("Amazon.MediaLive.Model.TransferringInputDeviceSummary")]
    ...
    public partial class GetEMLInputDeviceTransferListCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        public System.String TransferType { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InputDeviceTransfers";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TransferType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.ListInputDeviceTransfersResponse, GetEMLInputDeviceTransferListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TransferType;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.MaxResult = this.MaxResult;
            context.NextToken = this.NextToken;
            context.TransferType = this.TransferType;
            #if MODULAR
            if (this.TransferType == null && ParameterWasBound(nameof(this.TransferType)))
            {
                WriteWarning("You are passing $null as a value for parameter TransferType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaLive.Model.ListInputDeviceTransfersRequest();
            
            if (cmdletContext.MaxResult != null)
            {
                request.MaxResults = cmdletContext.MaxResult.Value;
            }
            if (cmdletContext.TransferType != null)
            {
                request.TransferType = cmdletContext.TransferType;
            }
        ...
        private Amazon.MediaLive.Model.ListInputDeviceTransfersResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.ListInputDeviceTransfersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "ListInputDeviceTransfers");
            try
            {
                #if DESKTOP
                return client.ListInputDeviceTransfers(request);
                #elif CORECLR
                return client.ListInputDeviceTransfersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TransferType { get; set; }
            public System.Func<Amazon.MediaLive.Model.ListInputDeviceTransfersResponse, GetEMLInputDeviceTransferListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InputDeviceTransfers;
        }
