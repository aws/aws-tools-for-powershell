...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMLChannel")]
    [OutputType("Amazon.MediaLive.Model.DescribeChannelResponse")]
    [AWSCmdlet("Calls the AWS Elemental MediaLive DescribeChannel API operation.", Operation = new[] {"DescribeChannel"}, SelectReturnType = typeof(Amazon.MediaLive.Model.DescribeChannelResponse))]
    [AWSCmdletOutput("Amazon.MediaLive.Model.DescribeChannelResponse",
        "This cmdlet returns an Amazon.MediaLive.Model.DescribeChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMLChannelCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.DescribeChannelResponse, GetEMLChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.DescribeChannelRequest();
        ...
        private Amazon.MediaLive.Model.DescribeChannelResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DescribeChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "DescribeChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ChannelId { get; set; }
            public System.Func<Amazon.MediaLive.Model.DescribeChannelResponse, GetEMLChannelCmdlet, object> Select { get; set; } =
