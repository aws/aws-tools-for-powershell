...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMLSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMLScheduleCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMLSchedule (DeleteSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.DeleteScheduleResponse, RemoveEMLScheduleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.DeleteScheduleRequest();
        ...
        private Amazon.MediaLive.Model.DeleteScheduleResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DeleteScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "DeleteSchedule");
            try
            {
                return client.DeleteScheduleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ChannelId { get; set; }
            public System.Func<Amazon.MediaLive.Model.DeleteScheduleResponse, RemoveEMLScheduleCmdlet, object> Select { get; set; } =
