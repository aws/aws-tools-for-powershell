...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Start", "EMLInputDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StartEMLInputDeviceCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaLive.Model.StartInputDeviceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-EMLInputDevice (StartInputDevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.StartInputDeviceResponse, StartEMLInputDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.StartInputDeviceRequest();
        ...
        private Amazon.MediaLive.Model.StartInputDeviceResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.StartInputDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "StartInputDevice");
            try
            {
                #if DESKTOP
                return client.StartInputDevice(request);
                #elif CORECLR
                return client.StartInputDeviceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String InputDeviceId { get; set; }
            public System.Func<Amazon.MediaLive.Model.StartInputDeviceResponse, StartEMLInputDeviceCmdlet, object> Select { get; set; } =
