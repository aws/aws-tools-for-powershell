...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("New", "EMLSignalMap", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewEMLSignalMapCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaLive.Model.CreateSignalMapResponse).
        /// Specifying the name of a property of type Amazon.MediaLive.Model.CreateSignalMapResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EMLSignalMap (CreateSignalMap)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.CreateSignalMapResponse, NewEMLSignalMapCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.DiscoveryEntryPointArn == null && ParameterWasBound(nameof(this.DiscoveryEntryPointArn)))
            {
                WriteWarning("You are passing $null as a value for parameter DiscoveryEntryPointArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.CreateSignalMapRequest();
        ...
        private Amazon.MediaLive.Model.CreateSignalMapResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.CreateSignalMapRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "CreateSignalMap");
            try
            {
                #if DESKTOP
                return client.CreateSignalMap(request);
                #elif CORECLR
                return client.CreateSignalMapAsync(request).GetAwaiter().GetResult();
                #else
