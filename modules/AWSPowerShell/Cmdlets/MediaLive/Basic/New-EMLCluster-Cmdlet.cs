...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    public partial class NewEMLClusterCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the InstanceRoleArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^InstanceRoleArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^InstanceRoleArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.InstanceRoleArn;
            }
