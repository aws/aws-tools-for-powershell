...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Update", "EMLMultiplexProgram", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaLive.Model.MultiplexProgram")]
    [AWSCmdlet("Calls the AWS Elemental MediaLive UpdateMultiplexProgram API operation.", Operation = new[] {"UpdateMultiplexProgram"}, SelectReturnType = typeof(Amazon.MediaLive.Model.UpdateMultiplexProgramResponse))]
    [AWSCmdletOutput("Amazon.MediaLive.Model.MultiplexProgram or Amazon.MediaLive.Model.UpdateMultiplexProgramResponse",
        "This cmdlet returns an Amazon.MediaLive.Model.MultiplexProgram object.",
        "The service call response (type Amazon.MediaLive.Model.UpdateMultiplexProgramResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateEMLMultiplexProgramCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EMLMultiplexProgram (UpdateMultiplexProgram)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.UpdateMultiplexProgramResponse, UpdateEMLMultiplexProgramCmdlet>(Select) ??
        ...
        private Amazon.MediaLive.Model.UpdateMultiplexProgramResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.UpdateMultiplexProgramRequest request)
        {
            ...
            try
            {
                return client.UpdateMultiplexProgramAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? StatmuxSettings_Priority { get; set; }
            public System.String ProgramName { get; set; }
            public System.Func<Amazon.MediaLive.Model.UpdateMultiplexProgramResponse, UpdateEMLMultiplexProgramCmdlet, object> Select { get; set; } =
