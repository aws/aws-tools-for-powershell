...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    /// </summary>
    [Cmdlet("Deny", "EMLInputDeviceTransfer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class DenyEMLInputDeviceTransferCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-EMLInputDeviceTransfer (RejectInputDeviceTransfer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.RejectInputDeviceTransferResponse, DenyEMLInputDeviceTransferCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaLive.Model.RejectInputDeviceTransferRequest();
        ...
        private Amazon.MediaLive.Model.RejectInputDeviceTransferResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.RejectInputDeviceTransferRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaLive", "RejectInputDeviceTransfer");
            try
            {
                #if DESKTOP
                return client.RejectInputDeviceTransfer(request);
                #elif CORECLR
                return client.RejectInputDeviceTransferAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String InputDeviceId { get; set; }
            public System.Func<Amazon.MediaLive.Model.RejectInputDeviceTransferResponse, DenyEMLInputDeviceTransferCmdlet, object> Select { get; set; } =
