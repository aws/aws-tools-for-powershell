...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    public partial class GetEMLInputSecurityGroupCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaLive.Model.DescribeInputSecurityGroupResponse, GetEMLInputSecurityGroupCmdlet>(Select) ??
        ...
        private Amazon.MediaLive.Model.DescribeInputSecurityGroupResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DescribeInputSecurityGroupRequest request)
        {
            ...
            try
            {
                return client.DescribeInputSecurityGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InputSecurityGroupId { get; set; }
            public System.Func<Amazon.MediaLive.Model.DescribeInputSecurityGroupResponse, GetEMLInputSecurityGroupCmdlet, object> Select { get; set; } =
