...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink ListWebsiteCertificateAuthorities API operation.", Operation = new[] {"ListWebsiteCertificateAuthorities"}, SelectReturnType = typeof(Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesResponse))]
    [AWSCmdletOutput("Amazon.WorkLink.Model.WebsiteCaSummary or Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesResponse",
    ...
    public partial class GetWLWebsiteCertificateAuthorityListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WebsiteCertificateAuthorities";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesResponse, GetWLWebsiteCertificateAuthorityListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WebsiteCertificateAuthorities.Count;
        ...
        private Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "ListWebsiteCertificateAuthorities");
            try
            {
                #if DESKTOP
                return client.ListWebsiteCertificateAuthorities(request);
                #elif CORECLR
                return client.ListWebsiteCertificateAuthoritiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkLink.Model.ListWebsiteCertificateAuthoritiesResponse, GetWLWebsiteCertificateAuthorityListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WebsiteCertificateAuthorities;
        }
