...
{
    /// <summary>
    /// Updates the identity provider configuration for the fleet.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Update", "WLIdentityProviderConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink UpdateIdentityProviderConfiguration API operation.", Operation = new[] {"UpdateIdentityProviderConfiguration"}, SelectReturnType = typeof(Amazon.WorkLink.Model.UpdateIdentityProviderConfigurationResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.UpdateIdentityProviderConfigurationResponse",
    ...
    public partial class UpdateWLIdentityProviderConfigurationCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.UpdateIdentityProviderConfigurationResponse, UpdateWLIdentityProviderConfigurationCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IdentityProviderSamlMetadata { get; set; }
            public Amazon.WorkLink.IdentityProviderType IdentityProviderType { get; set; }
            public System.Func<Amazon.WorkLink.Model.UpdateIdentityProviderConfigurationResponse, UpdateWLIdentityProviderConfigurationCmdlet, object> Select { get; set; } =
