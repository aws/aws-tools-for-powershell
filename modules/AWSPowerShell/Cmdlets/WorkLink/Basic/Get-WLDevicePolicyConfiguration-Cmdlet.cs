...
{
    /// <summary>
    /// Describes the device policy configuration for the specified fleet.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "WLDevicePolicyConfiguration")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon WorkLink DescribeDevicePolicyConfiguration API operation.", Operation = new[] {"DescribeDevicePolicyConfiguration"}, SelectReturnType = typeof(Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse))]
    [AWSCmdletOutput("System.String or Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Amazon WorkLink is no longer supported. This will be removed in a future version of the SDK.")]
    public partial class GetWLDevicePolicyConfigurationCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "DeviceCaCertificate";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse, GetWLDevicePolicyConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationRequest();
        ...
        private Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DescribeDevicePolicyConfiguration");
            try
            {
                #if DESKTOP
                return client.DescribeDevicePolicyConfiguration(request);
                #elif CORECLR
                return client.DescribeDevicePolicyConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.DescribeDevicePolicyConfigurationResponse, GetWLDevicePolicyConfigurationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeviceCaCertificate;
        }
