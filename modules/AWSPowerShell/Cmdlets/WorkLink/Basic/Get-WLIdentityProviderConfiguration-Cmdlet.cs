...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DescribeIdentityProviderConfiguration API operation.", Operation = new[] {"DescribeIdentityProviderConfiguration"}, SelectReturnType = typeof(Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationResponse))]
    ...
    public partial class GetWLIdentityProviderConfigurationCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationResponse, GetWLIdentityProviderConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationRequest();
        ...
        private Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DescribeIdentityProviderConfiguration");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.DescribeIdentityProviderConfigurationResponse, GetWLIdentityProviderConfigurationCmdlet, object> Select { get; set; } =
