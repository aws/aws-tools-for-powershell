...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink RestoreDomainAccess API operation.", Operation = new[] {"RestoreDomainAccess"}, SelectReturnType = typeof(Amazon.WorkLink.Model.RestoreDomainAccessResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.RestoreDomainAccessResponse",
    ...
    public partial class RestoreWLDomainAccessCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-WLDomainAccess (RestoreDomainAccess)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.RestoreDomainAccessResponse, RestoreWLDomainAccessCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.RestoreDomainAccessRequest();
        ...
        private Amazon.WorkLink.Model.RestoreDomainAccessResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.RestoreDomainAccessRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "RestoreDomainAccess");
            try
            {
                #if DESKTOP
                return client.RestoreDomainAccess(request);
                #elif CORECLR
                return client.RestoreDomainAccessAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.RestoreDomainAccessResponse, RestoreWLDomainAccessCmdlet, object> Select { get; set; } =
