...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink SignOutUser API operation.", Operation = new[] {"SignOutUser"}, SelectReturnType = typeof(Amazon.WorkLink.Model.SignOutUserResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.SignOutUserResponse",
    ...
    public partial class DisconnectWLUserCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disconnect-WLUser (SignOutUser)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.SignOutUserResponse, DisconnectWLUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.SignOutUserRequest();
        ...
        private Amazon.WorkLink.Model.SignOutUserResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.SignOutUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "SignOutUser");
            try
            {
                #if DESKTOP
                return client.SignOutUser(request);
                #elif CORECLR
                return client.SignOutUserAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FleetArn { get; set; }
            public System.String Username { get; set; }
            public System.Func<Amazon.WorkLink.Model.SignOutUserResponse, DisconnectWLUserCmdlet, object> Select { get; set; } =
