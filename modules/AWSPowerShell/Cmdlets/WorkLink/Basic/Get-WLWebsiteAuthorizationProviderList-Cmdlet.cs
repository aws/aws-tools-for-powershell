...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink ListWebsiteAuthorizationProviders API operation.", Operation = new[] {"ListWebsiteAuthorizationProviders"}, SelectReturnType = typeof(Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersResponse))]
    [AWSCmdletOutput("Amazon.WorkLink.Model.WebsiteAuthorizationProviderSummary or Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersResponse",
    ...
    public partial class GetWLWebsiteAuthorizationProviderListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WebsiteAuthorizationProviders";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersResponse, GetWLWebsiteAuthorizationProviderListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WebsiteAuthorizationProviders.Count;
        ...
        private Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "ListWebsiteAuthorizationProviders");
            try
            {
                #if DESKTOP
                return client.ListWebsiteAuthorizationProviders(request);
                #elif CORECLR
                return client.ListWebsiteAuthorizationProvidersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkLink.Model.ListWebsiteAuthorizationProvidersResponse, GetWLWebsiteAuthorizationProviderListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WebsiteAuthorizationProviders;
        }
