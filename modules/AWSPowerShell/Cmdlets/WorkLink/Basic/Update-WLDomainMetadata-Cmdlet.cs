...
{
    /// <summary>
    /// Updates domain metadata, such as DisplayName.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Update", "WLDomainMetadata", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink UpdateDomainMetadata API operation.", Operation = new[] {"UpdateDomainMetadata"}, SelectReturnType = typeof(Amazon.WorkLink.Model.UpdateDomainMetadataResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.UpdateDomainMetadataResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WorkLink.Model.UpdateDomainMetadataResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    ...
    public partial class UpdateWLDomainMetadataCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WLDomainMetadata (UpdateDomainMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.UpdateDomainMetadataResponse, UpdateWLDomainMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.UpdateDomainMetadataRequest();
        ...
        private Amazon.WorkLink.Model.UpdateDomainMetadataResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.UpdateDomainMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "UpdateDomainMetadata");
            try
            {
                #if DESKTOP
                return client.UpdateDomainMetadata(request);
                #elif CORECLR
                return client.UpdateDomainMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DomainName { get; set; }
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.UpdateDomainMetadataResponse, UpdateWLDomainMetadataCmdlet, object> Select { get; set; } =
