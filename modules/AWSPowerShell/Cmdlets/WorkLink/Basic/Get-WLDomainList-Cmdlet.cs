...
{
    /// <summary>
    /// Retrieves a list of domains associated to a specified fleet.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "WLDomainList")]
    [OutputType("Amazon.WorkLink.Model.DomainSummary")]
    [AWSCmdlet("Calls the Amazon WorkLink ListDomains API operation.", Operation = new[] {"ListDomains"}, SelectReturnType = typeof(Amazon.WorkLink.Model.ListDomainsResponse))]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DomainSummary or Amazon.WorkLink.Model.ListDomainsResponse",
        "This cmdlet returns a collection of Amazon.WorkLink.Model.DomainSummary objects.",
    ...
    public partial class GetWLDomainListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.ListDomainsResponse, GetWLDomainListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkLink.Model.ListDomainsResponse, GetWLDomainListCmdlet, object> Select { get; set; } =
