...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DescribeCompanyNetworkConfiguration API operation.", Operation = new[] {"DescribeCompanyNetworkConfiguration"}, SelectReturnType = typeof(Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationResponse))]
    ...
    public partial class GetWLCompanyNetworkConfigurationCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationResponse, GetWLCompanyNetworkConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationRequest();
        ...
        private Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DescribeCompanyNetworkConfiguration");
            try
            {
                #if DESKTOP
                return client.DescribeCompanyNetworkConfiguration(request);
                #elif CORECLR
                return client.DescribeCompanyNetworkConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.DescribeCompanyNetworkConfigurationResponse, GetWLCompanyNetworkConfigurationCmdlet, object> Select { get; set; } =
