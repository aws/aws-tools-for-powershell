...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink DeleteFleet API operation.", Operation = new[] {"DeleteFleet"}, SelectReturnType = typeof(Amazon.WorkLink.Model.DeleteFleetResponse))]
    ...
    public partial class RemoveWLFleetCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WLFleet (DeleteFleet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.DeleteFleetResponse, RemoveWLFleetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DeleteFleetRequest();
        ...
        private Amazon.WorkLink.Model.DeleteFleetResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DeleteFleetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DeleteFleet");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.DeleteFleetResponse, RemoveWLFleetCmdlet, object> Select { get; set; } =
