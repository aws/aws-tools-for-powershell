...
{
    /// <summary>
    /// Retrieves a list of devices registered with the specified fleet.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "WLDeviceList")]
    [OutputType("Amazon.WorkLink.Model.DeviceSummary")]
    [AWSCmdlet("Calls the Amazon WorkLink ListDevices API operation.", Operation = new[] {"ListDevices"}, SelectReturnType = typeof(Amazon.WorkLink.Model.ListDevicesResponse))]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DeviceSummary or Amazon.WorkLink.Model.ListDevicesResponse",
        "This cmdlet returns a collection of Amazon.WorkLink.Model.DeviceSummary objects.",
    ...
    public partial class GetWLDeviceListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.ListDevicesResponse, GetWLDeviceListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkLink.Model.ListDevicesResponse, GetWLDeviceListCmdlet, object> Select { get; set; } =
