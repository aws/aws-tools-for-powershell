...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink UpdateFleetMetadata API operation.", Operation = new[] {"UpdateFleetMetadata"}, SelectReturnType = typeof(Amazon.WorkLink.Model.UpdateFleetMetadataResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.UpdateFleetMetadataResponse",
    ...
    public partial class UpdateWLFleetMetadataCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.UpdateFleetMetadataResponse, UpdateWLFleetMetadataCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FleetArn { get; set; }
            public System.Boolean? OptimizeForEndUserLocation { get; set; }
            public System.Func<Amazon.WorkLink.Model.UpdateFleetMetadataResponse, UpdateWLFleetMetadataCmdlet, object> Select { get; set; } =
