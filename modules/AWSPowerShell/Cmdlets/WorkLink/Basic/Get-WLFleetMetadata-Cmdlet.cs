...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DescribeFleetMetadata API operation.", Operation = new[] {"DescribeFleetMetadata"}, SelectReturnType = typeof(Amazon.WorkLink.Model.DescribeFleetMetadataResponse))]
    ...
    public partial class GetWLFleetMetadataCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.DescribeFleetMetadataResponse, GetWLFleetMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DescribeFleetMetadataRequest();
        ...
        private Amazon.WorkLink.Model.DescribeFleetMetadataResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DescribeFleetMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DescribeFleetMetadata");
            try
            {
                #if DESKTOP
                return client.DescribeFleetMetadata(request);
                #elif CORECLR
                return client.DescribeFleetMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FleetArn { get; set; }
            public System.Func<Amazon.WorkLink.Model.DescribeFleetMetadataResponse, GetWLFleetMetadataCmdlet, object> Select { get; set; } =
