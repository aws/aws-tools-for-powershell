...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkLink TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.WorkLink.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.WorkLink.Model.TagResourceResponse",
    ...
    public partial class AddWLResourceTagCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WLResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkLink.Model.TagResourceResponse, AddWLResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.TagResourceRequest();
        ...
        private Amazon.WorkLink.Model.TagResourceResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkLink.Model.TagResourceResponse, AddWLResourceTagCmdlet, object> Select { get; set; } =
