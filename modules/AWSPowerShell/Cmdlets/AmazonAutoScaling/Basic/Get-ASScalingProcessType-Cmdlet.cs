...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling DescribeScalingProcessTypes API operation.", Operation = new[] {"DescribeScalingProcessTypes"})]
    ...
    public partial class GetASScalingProcessTypeCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribeScalingProcessTypes");
            try
            {
                #if DESKTOP
                return client.DescribeScalingProcessTypes(request);
                #elif CORECLR
                return client.DescribeScalingProcessTypesAsync(request).GetAwaiter().GetResult();
                #else
