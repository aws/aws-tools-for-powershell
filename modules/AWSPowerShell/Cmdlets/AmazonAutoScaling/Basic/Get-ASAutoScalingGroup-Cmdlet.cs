...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling DescribeAutoScalingGroups API operation.", Operation = new[] {"DescribeAutoScalingGroups"})]
    ...
    public partial class GetASAutoScalingGroupCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribeAutoScalingGroups");
            try
            {
                #if DESKTOP
