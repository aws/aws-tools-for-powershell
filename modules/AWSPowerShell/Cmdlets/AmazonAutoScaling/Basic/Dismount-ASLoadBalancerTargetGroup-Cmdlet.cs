...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Invokes the DetachLoadBalancerTargetGroups operation against Auto Scaling.", Operation = new[] {"DetachLoadBalancerTargetGroups"})]
    ...
    public class DismountASLoadBalancerTargetGroupCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        private static Amazon.AutoScaling.Model.DetachLoadBalancerTargetGroupsResponse CallAWSServiceOperation(IAmazonAutoScaling client, Amazon.AutoScaling.Model.DetachLoadBalancerTargetGroupsRequest request)
        {
