...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class GetASLaunchConfigurationCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.LaunchConfigurations;
                        ...
                        int _receivedThisCall = response.LaunchConfigurations.Count;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribeLaunchConfigurations");
            try
            {
                #if DESKTOP
                return client.DescribeLaunchConfigurations(request);
                #elif CORECLR
                return client.DescribeLaunchConfigurationsAsync(request).GetAwaiter().GetResult();
                #else
