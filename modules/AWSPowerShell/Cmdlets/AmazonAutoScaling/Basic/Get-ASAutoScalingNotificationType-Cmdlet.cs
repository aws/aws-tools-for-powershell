...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling DescribeAutoScalingNotificationTypes API operation.", Operation = new[] {"DescribeAutoScalingNotificationTypes"})]
    ...
    public partial class GetASAutoScalingNotificationTypeCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.AutoScalingNotificationTypes;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribeAutoScalingNotificationTypes");
            try
            {
                #if DESKTOP
