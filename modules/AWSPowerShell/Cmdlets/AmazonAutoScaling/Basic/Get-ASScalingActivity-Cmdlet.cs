...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling DescribeScalingActivities API operation.", Operation = new[] {"DescribeScalingActivities"})]
    ...
    public partial class GetASScalingActivityCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribeScalingActivities");
            try
            {
                #if DESKTOP
