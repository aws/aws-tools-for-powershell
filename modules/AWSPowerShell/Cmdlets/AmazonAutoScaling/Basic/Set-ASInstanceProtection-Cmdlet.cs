...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling SetInstanceProtection API operation.", Operation = new[] {"SetInstanceProtection"})]
    ...
    public partial class SetASInstanceProtectionCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "SetInstanceProtection");
            try
            {
                #if DESKTOP
                ...
                var task = client.SetInstanceProtectionAsync(request);
                return task.Result;
                #else
