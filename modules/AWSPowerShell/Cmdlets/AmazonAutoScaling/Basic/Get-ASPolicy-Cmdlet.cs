...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the Auto Scaling DescribePolicies API operation.", Operation = new[] {"DescribePolicies"})]
    ...
    public partial class GetASPolicyCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Auto Scaling", "DescribePolicies");
            try
            {
                #if DESKTOP
