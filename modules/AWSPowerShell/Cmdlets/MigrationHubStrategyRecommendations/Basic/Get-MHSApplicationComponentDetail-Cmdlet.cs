...
namespace Amazon.PowerShell.Cmdlets.MHS
{
    ...
    /// </summary>
    [Cmdlet("Get", "MHSApplicationComponentDetail")]
    ...
    public partial class GetMHSApplicationComponentDetailCmdlet : AmazonMigrationHubStrategyRecommendationsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsResponse).
        /// Specifying the name of a property of type Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsResponse, GetMHSApplicationComponentDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsRequest();
        ...
        private Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsResponse CallAWSServiceOperation(IAmazonMigrationHubStrategyRecommendations client, Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Migration Hub Strategy Recommendations", "GetApplicationComponentDetails");
            try
            {
                #if DESKTOP
                return client.GetApplicationComponentDetails(request);
                #elif CORECLR
                return client.GetApplicationComponentDetailsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApplicationComponentId { get; set; }
            public System.Func<Amazon.MigrationHubStrategyRecommendations.Model.GetApplicationComponentDetailsResponse, GetMHSApplicationComponentDetailCmdlet, object> Select { get; set; } =
