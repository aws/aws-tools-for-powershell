...
{
    /// <summary>
    /// Returns a list of all the servers.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.MigrationHubStrategyRecommendations.Model.ServerDetail or Amazon.MigrationHubStrategyRecommendations.Model.ListServersResponse",
        ...
        "The service call response (type Amazon.MigrationHubStrategyRecommendations.Model.ListServersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMHSServerListCmdlet : AmazonMigrationHubStrategyRecommendationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Specifies the group ID to filter on. </para><para />
