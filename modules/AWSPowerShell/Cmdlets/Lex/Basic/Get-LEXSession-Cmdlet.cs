...
namespace Amazon.PowerShell.Cmdlets.LEX
{
    ...
    /// </summary>
    [Cmdlet("Get", "LEXSession")]
    [OutputType("Amazon.Lex.Model.GetSessionResponse")]
    [AWSCmdlet("Calls the Amazon Lex GetSession API operation.", Operation = new[] {"GetSession"}, SelectReturnType = typeof(Amazon.Lex.Model.GetSessionResponse))]
    [AWSCmdletOutput("Amazon.Lex.Model.GetSessionResponse",
        "This cmdlet returns an Amazon.Lex.Model.GetSessionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLEXSessionCmdlet : AmazonLexClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String CheckpointLabelFilter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lex.Model.GetSessionResponse, GetLEXSessionCmdlet>(Select) ??
            ...
            #endif
            context.CheckpointLabelFilter = this.CheckpointLabelFilter;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lex.Model.GetSessionRequest();
            ...
            if (cmdletContext.CheckpointLabelFilter != null)
            {
                request.CheckpointLabelFilter = cmdletContext.CheckpointLabelFilter;
            }
        ...
        private Amazon.Lex.Model.GetSessionResponse CallAWSServiceOperation(IAmazonLex client, Amazon.Lex.Model.GetSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex", "GetSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String CheckpointLabelFilter { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.Lex.Model.GetSessionResponse, GetLEXSessionCmdlet, object> Select { get; set; } =
