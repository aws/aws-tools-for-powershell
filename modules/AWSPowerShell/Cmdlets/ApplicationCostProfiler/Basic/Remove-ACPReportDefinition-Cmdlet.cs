...
namespace Amazon.PowerShell.Cmdlets.ACP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ACPReportDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveACPReportDefinitionCmdlet : AmazonApplicationCostProfilerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ACPReportDefinition (DeleteReportDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationCostProfiler.Model.DeleteReportDefinitionResponse, RemoveACPReportDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationCostProfiler.Model.DeleteReportDefinitionRequest();
        ...
        private Amazon.ApplicationCostProfiler.Model.DeleteReportDefinitionResponse CallAWSServiceOperation(IAmazonApplicationCostProfiler client, Amazon.ApplicationCostProfiler.Model.DeleteReportDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ApplicationCostProfiler", "DeleteReportDefinition");
            try
            {
                return client.DeleteReportDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ReportId { get; set; }
            public System.Func<Amazon.ApplicationCostProfiler.Model.DeleteReportDefinitionResponse, RemoveACPReportDefinitionCmdlet, object> Select { get; set; } =
