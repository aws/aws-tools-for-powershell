...
namespace Amazon.PowerShell.Cmdlets.ACP
{
    ...
    /// </summary>
    [Cmdlet("Write", "ACPReportDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon ApplicationCostProfiler PutReportDefinition API operation.", Operation = new[] {"PutReportDefinition"}, SelectReturnType = typeof(Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse))]
    [AWSCmdletOutput("System.String or Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteACPReportDefinitionCmdlet : AmazonApplicationCostProfilerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-ACPReportDefinition (PutReportDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse, WriteACPReportDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationCostProfiler.Model.PutReportDefinitionRequest();
        ...
        private Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse CallAWSServiceOperation(IAmazonApplicationCostProfiler client, Amazon.ApplicationCostProfiler.Model.PutReportDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ApplicationCostProfiler", "PutReportDefinition");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.ApplicationCostProfiler.ReportFrequency ReportFrequency { get; set; }
            public System.String ReportId { get; set; }
            public System.Func<Amazon.ApplicationCostProfiler.Model.PutReportDefinitionResponse, WriteACPReportDefinitionCmdlet, object> Select { get; set; } =
