...
namespace Amazon.PowerShell.Cmdlets.ACP
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "ACPReportDefinitionList")]
    [OutputType("Amazon.ApplicationCostProfiler.Model.ReportDefinition")]
    ...
    public partial class GetACPReportDefinitionListCmdlet : AmazonApplicationCostProfilerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReportDefinitions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationCostProfiler.Model.ListReportDefinitionsResponse, GetACPReportDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationCostProfiler.Model.ListReportDefinitionsRequest();
        ...
        private Amazon.ApplicationCostProfiler.Model.ListReportDefinitionsResponse CallAWSServiceOperation(IAmazonApplicationCostProfiler client, Amazon.ApplicationCostProfiler.Model.ListReportDefinitionsRequest request)
        {
            ...
            try
            {
                return client.ListReportDefinitionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApplicationCostProfiler.Model.ListReportDefinitionsResponse, GetACPReportDefinitionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReportDefinitions;
        }
