...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    /// in your Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetqappsLibraryItemListCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        private Amazon.QApps.Model.ListLibraryItemsResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.ListLibraryItemsRequest request)
        {
            ...
            try
            {
                return client.ListLibraryItemsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
