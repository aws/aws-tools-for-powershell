...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    public partial class UpdateqappsQAppPermissionCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of permissions to grant for the Amazon Q App.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The list of permissions to revoke for the Amazon Q App.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.QApps.Model.UpdateQAppPermissionsResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.UpdateQAppPermissionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateQAppPermissions(request);
                #elif CORECLR
                return client.UpdateQAppPermissionsAsync(request).GetAwaiter().GetResult();
                #else
