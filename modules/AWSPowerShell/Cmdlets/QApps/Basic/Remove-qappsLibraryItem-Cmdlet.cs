...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    /// </summary>
    [Cmdlet("Remove", "qappsLibraryItem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveqappsLibraryItemCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-qappsLibraryItem (DeleteLibraryItem)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QApps.Model.DeleteLibraryItemResponse, RemoveqappsLibraryItemCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QApps.Model.DeleteLibraryItemRequest();
        ...
        private Amazon.QApps.Model.DeleteLibraryItemResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.DeleteLibraryItemRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Apps", "DeleteLibraryItem");
            try
            {
                #if DESKTOP
                return client.DeleteLibraryItem(request);
                #elif CORECLR
                return client.DeleteLibraryItemAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String LibraryItemId { get; set; }
            public System.Func<Amazon.QApps.Model.DeleteLibraryItemResponse, RemoveqappsLibraryItemCmdlet, object> Select { get; set; } =
