...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    /// </summary>
    [Cmdlet("Stop", "qappsQAppSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopqappsQAppSessionCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-qappsQAppSession (StopQAppSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QApps.Model.StopQAppSessionResponse, StopqappsQAppSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QApps.Model.StopQAppSessionRequest();
        ...
        private Amazon.QApps.Model.StopQAppSessionResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.StopQAppSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Apps", "StopQAppSession");
            try
            {
                #if DESKTOP
                return client.StopQAppSession(request);
                #elif CORECLR
                return client.StopQAppSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.QApps.Model.StopQAppSessionResponse, StopqappsQAppSessionCmdlet, object> Select { get; set; } =
