...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    /// and flow.
    /// </summary>
    [Cmdlet("Get", "qappsQApp")]
    [OutputType("Amazon.QApps.Model.GetQAppResponse")]
    [AWSCmdlet("Calls the Amazon Q Apps GetQApp API operation.", Operation = new[] {"GetQApp"}, SelectReturnType = typeof(Amazon.QApps.Model.GetQAppResponse))]
    [AWSCmdletOutput("Amazon.QApps.Model.GetQAppResponse",
        "This cmdlet returns an Amazon.QApps.Model.GetQAppResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetqappsQAppCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QApps.Model.GetQAppResponse, GetqappsQAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QApps.Model.GetQAppRequest();
        ...
        private Amazon.QApps.Model.GetQAppResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.GetQAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Apps", "GetQApp");
            try
            {
                #if DESKTOP
                return client.GetQApp(request);
                #elif CORECLR
                return client.GetQAppAsync(request).GetAwaiter().GetResult();
                #else
