...
namespace Amazon.PowerShell.Cmdlets.qapps
{
    ...
    /// </summary>
    [Cmdlet("Remove", "qappsResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveqappsResourceTagCmdlet : AmazonQAppsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The keys of the tags to disassociate from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-qappsResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QApps.Model.UntagResourceResponse, RemoveqappsResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QApps.Model.UntagResourceRequest();
        ...
        private Amazon.QApps.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonQApps client, Amazon.QApps.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Apps", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QApps.Model.UntagResourceResponse, RemoveqappsResourceTagCmdlet, object> Select { get; set; } =
