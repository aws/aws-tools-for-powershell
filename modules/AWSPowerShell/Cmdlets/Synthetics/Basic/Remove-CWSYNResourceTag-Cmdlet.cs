...
namespace Amazon.PowerShell.Cmdlets.CWSYN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CWSYNResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCWSYNResourceTagCmdlet : AmazonSyntheticsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWSYNResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Synthetics.Model.UntagResourceResponse, RemoveCWSYNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Synthetics.Model.UntagResourceRequest();
        ...
        private Amazon.Synthetics.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonSynthetics client, Amazon.Synthetics.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Synthetics", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Synthetics.Model.UntagResourceResponse, RemoveCWSYNResourceTagCmdlet, object> Select { get; set; } =
