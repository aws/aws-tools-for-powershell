...
namespace Amazon.PowerShell.Cmdlets.CWSYN
{
    ...
    public partial class UpdateCWSYNCanaryCmdlet : AmazonSyntheticsClientCmdlet, IExecutor
    {
        ...
        #region Parameter RemoveReplicaLocation
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("RemoveReplicaLocations")]
        public System.String[] RemoveReplicaLocation { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.RemoveReplicaLocation != null)
            {
                context.RemoveReplicaLocation = new List<System.String>(this.RemoveReplicaLocation);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (cmdletContext.RemoveReplicaLocation != null)
                {
                    request.RemoveReplicaLocations = cmdletContext.RemoveReplicaLocation;
                }
        ...
        private Amazon.Synthetics.Model.UpdateCanaryResponse CallAWSServiceOperation(IAmazonSynthetics client, Amazon.Synthetics.Model.UpdateCanaryRequest request)
        {
            ...
            try
            {
                return client.UpdateCanaryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
