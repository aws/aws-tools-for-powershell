...
namespace Amazon.PowerShell.Cmdlets.CWSYN
{
    ...
    [AWSCmdletOutput("Amazon.Synthetics.Model.CanaryRun or Amazon.Synthetics.Model.GetCanaryRunsResponse",
        ...
        "The service call response (type Amazon.Synthetics.Model.GetCanaryRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
