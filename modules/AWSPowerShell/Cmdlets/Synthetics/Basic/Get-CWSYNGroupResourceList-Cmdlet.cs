...
namespace Amazon.PowerShell.Cmdlets.CWSYN
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Synthetics.Model.ListGroupResourcesResponse",
        ...
        "The service call response (type Amazon.Synthetics.Model.ListGroupResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
