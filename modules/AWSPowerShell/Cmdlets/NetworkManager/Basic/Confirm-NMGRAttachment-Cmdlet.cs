...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Confirm", "NMGRAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ConfirmNMGRAttachmentCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-NMGRAttachment (AcceptAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.AcceptAttachmentResponse, ConfirmNMGRAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.AcceptAttachmentRequest();
        ...
        private Amazon.NetworkManager.Model.AcceptAttachmentResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.AcceptAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "AcceptAttachment");
            try
            {
                #if DESKTOP
                return client.AcceptAttachment(request);
                #elif CORECLR
                return client.AcceptAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AttachmentId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.AcceptAttachmentResponse, ConfirmNMGRAttachmentCmdlet, object> Select { get; set; } =
