...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NMGRConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveNMGRConnectionCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NMGRConnection (DeleteConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DeleteConnectionResponse, RemoveNMGRConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DeleteConnectionRequest();
        ...
        private Amazon.NetworkManager.Model.DeleteConnectionResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DeleteConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DeleteConnection");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConnectionId { get; set; }
            public System.String GlobalNetworkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DeleteConnectionResponse, RemoveNMGRConnectionCmdlet, object> Select { get; set; } =
