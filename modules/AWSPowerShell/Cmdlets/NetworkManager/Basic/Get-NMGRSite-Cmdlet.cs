...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    [AWSCmdletOutput("Amazon.NetworkManager.Model.Site or Amazon.NetworkManager.Model.GetSitesResponse",
        ...
        "The service call response (type Amazon.NetworkManager.Model.GetSitesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
