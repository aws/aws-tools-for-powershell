...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Write", "NMGRResourcePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteNMGRResourcePolicyCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-NMGRResourcePolicy (PutResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.PutResourcePolicyResponse, WriteNMGRResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.PutResourcePolicyRequest();
        ...
        private Amazon.NetworkManager.Model.PutResourcePolicyResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.PutResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "PutResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyDocument { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.NetworkManager.Model.PutResourcePolicyResponse, WriteNMGRResourcePolicyCmdlet, object> Select { get; set; } =
