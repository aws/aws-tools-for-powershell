...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "NMGRSiteToSiteVpnAttachment")]
    [OutputType("Amazon.NetworkManager.Model.SiteToSiteVpnAttachment")]
    [AWSCmdlet("Calls the AWS Network Manager GetSiteToSiteVpnAttachment API operation.", Operation = new[] {"GetSiteToSiteVpnAttachment"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.SiteToSiteVpnAttachment or Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.SiteToSiteVpnAttachment object.",
        "The service call response (type Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNMGRSiteToSiteVpnAttachmentCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse, GetNMGRSiteToSiteVpnAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentRequest();
        ...
        private Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "GetSiteToSiteVpnAttachment");
            try
            {
                #if DESKTOP
                return client.GetSiteToSiteVpnAttachment(request);
                #elif CORECLR
                return client.GetSiteToSiteVpnAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AttachmentId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.GetSiteToSiteVpnAttachmentResponse, GetNMGRSiteToSiteVpnAttachmentCmdlet, object> Select { get; set; } =
