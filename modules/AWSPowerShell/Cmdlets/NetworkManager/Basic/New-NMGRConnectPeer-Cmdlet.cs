...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    [AWSCmdletOutput("Amazon.NetworkManager.Model.ConnectPeer or Amazon.NetworkManager.Model.CreateConnectPeerResponse",
        ...
        "The service call response (type Amazon.NetworkManager.Model.CreateConnectPeerResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewNMGRConnectPeerCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ConnectAttachmentId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ConnectAttachmentId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ConnectAttachmentId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ConnectAttachmentId;
            }
