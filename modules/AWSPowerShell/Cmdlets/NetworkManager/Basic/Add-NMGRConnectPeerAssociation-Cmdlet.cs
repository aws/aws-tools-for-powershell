...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "NMGRConnectPeerAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkManager.Model.ConnectPeerAssociation")]
    [AWSCmdlet("Calls the AWS Network Manager AssociateConnectPeer API operation.", Operation = new[] {"AssociateConnectPeer"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.AssociateConnectPeerResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.ConnectPeerAssociation or Amazon.NetworkManager.Model.AssociateConnectPeerResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.ConnectPeerAssociation object.",
        "The service call response (type Amazon.NetworkManager.Model.AssociateConnectPeerResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddNMGRConnectPeerAssociationCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-NMGRConnectPeerAssociation (AssociateConnectPeer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.AssociateConnectPeerResponse, AddNMGRConnectPeerAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.AssociateConnectPeerRequest();
        ...
        private Amazon.NetworkManager.Model.AssociateConnectPeerResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.AssociateConnectPeerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "AssociateConnectPeer");
            try
            {
                #if DESKTOP
                return client.AssociateConnectPeer(request);
                #elif CORECLR
                return client.AssociateConnectPeerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String GlobalNetworkId { get; set; }
            public System.String LinkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.AssociateConnectPeerResponse, AddNMGRConnectPeerAssociationCmdlet, object> Select { get; set; } =
