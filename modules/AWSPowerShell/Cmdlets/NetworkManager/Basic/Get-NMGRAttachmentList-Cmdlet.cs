...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "NMGRAttachmentList")]
    [OutputType("Amazon.NetworkManager.Model.Attachment")]
    [AWSCmdlet("Calls the AWS Network Manager ListAttachments API operation.", Operation = new[] {"ListAttachments"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.ListAttachmentsResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.Attachment or Amazon.NetworkManager.Model.ListAttachmentsResponse",
        "This cmdlet returns a collection of Amazon.NetworkManager.Model.Attachment objects.",
        "The service call response (type Amazon.NetworkManager.Model.ListAttachmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNMGRAttachmentListCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.NetworkManager.AttachmentType")]
        public Amazon.NetworkManager.AttachmentType AttachmentType { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.NetworkManager.AttachmentState")]
        public Amazon.NetworkManager.AttachmentState State { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.ListAttachmentsResponse, GetNMGRAttachmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.NetworkManager.Model.ListAttachmentsRequest();
        ...
        private Amazon.NetworkManager.Model.ListAttachmentsResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.ListAttachmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "ListAttachments");
            try
            {
                #if DESKTOP
                return client.ListAttachments(request);
                #elif CORECLR
                return client.ListAttachmentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.NetworkManager.AttachmentState State { get; set; }
            public System.Func<Amazon.NetworkManager.Model.ListAttachmentsResponse, GetNMGRAttachmentListCmdlet, object> Select { get; set; } =
