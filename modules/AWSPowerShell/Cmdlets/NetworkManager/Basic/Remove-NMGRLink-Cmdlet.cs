...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// customer gateways.
    /// </summary>
    [Cmdlet("Remove", "NMGRLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveNMGRLinkCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NMGRLink (DeleteLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DeleteLinkResponse, RemoveNMGRLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DeleteLinkRequest();
        ...
        private Amazon.NetworkManager.Model.DeleteLinkResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DeleteLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DeleteLink");
            try
            {
                #if DESKTOP
                return client.DeleteLink(request);
                #elif CORECLR
                return client.DeleteLinkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GlobalNetworkId { get; set; }
            public System.String LinkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DeleteLinkResponse, RemoveNMGRLinkCmdlet, object> Select { get; set; } =
