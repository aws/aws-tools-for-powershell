...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    [AWSCmdletOutput("Amazon.NetworkManager.Model.ConnectPeerSummary or Amazon.NetworkManager.Model.ListConnectPeersResponse",
        ...
        "The service call response (type Amazon.NetworkManager.Model.ListConnectPeersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
