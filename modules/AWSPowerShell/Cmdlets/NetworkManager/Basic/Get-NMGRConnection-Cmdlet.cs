...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "NMGRConnection")]
    [OutputType("Amazon.NetworkManager.Model.Connection")]
    [AWSCmdlet("Calls the AWS Network Manager GetConnections API operation.", Operation = new[] {"GetConnections"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.GetConnectionsResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.Connection or Amazon.NetworkManager.Model.GetConnectionsResponse",
        "This cmdlet returns a collection of Amazon.NetworkManager.Model.Connection objects.",
        "The service call response (type Amazon.NetworkManager.Model.GetConnectionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNMGRConnectionCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.GetConnectionsResponse, GetNMGRConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.NetworkManager.Model.GetConnectionsRequest();
        ...
        private Amazon.NetworkManager.Model.GetConnectionsResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.GetConnectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "GetConnections");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.NetworkManager.Model.GetConnectionsResponse, GetNMGRConnectionCmdlet, object> Select { get; set; } =
