...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "NMGRLinkAssociation")]
    [OutputType("Amazon.NetworkManager.Model.LinkAssociation")]
    [AWSCmdlet("Calls the AWS Network Manager GetLinkAssociations API operation.", Operation = new[] {"GetLinkAssociations"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.GetLinkAssociationsResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.LinkAssociation or Amazon.NetworkManager.Model.GetLinkAssociationsResponse",
        "This cmdlet returns a collection of Amazon.NetworkManager.Model.LinkAssociation objects.",
        "The service call response (type Amazon.NetworkManager.Model.GetLinkAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNMGRLinkAssociationCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LinkAssociations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.GetLinkAssociationsResponse, GetNMGRLinkAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.NetworkManager.Model.GetLinkAssociationsRequest();
        ...
        private Amazon.NetworkManager.Model.GetLinkAssociationsResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.GetLinkAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "GetLinkAssociations");
            try
            {
                #if DESKTOP
                return client.GetLinkAssociations(request);
                #elif CORECLR
                return client.GetLinkAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.NetworkManager.Model.GetLinkAssociationsResponse, GetNMGRLinkAssociationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LinkAssociations;
        }
