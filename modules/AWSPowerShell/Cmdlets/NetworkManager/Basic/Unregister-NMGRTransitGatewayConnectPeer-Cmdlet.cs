...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "NMGRTransitGatewayConnectPeer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkManager.Model.TransitGatewayConnectPeerAssociation")]
    [AWSCmdlet("Calls the AWS Network Manager DisassociateTransitGatewayConnectPeer API operation.", Operation = new[] {"DisassociateTransitGatewayConnectPeer"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.TransitGatewayConnectPeerAssociation or Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.TransitGatewayConnectPeerAssociation object.",
        "The service call response (type Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnregisterNMGRTransitGatewayConnectPeerCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TransitGatewayConnectPeerArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-NMGRTransitGatewayConnectPeer (DisassociateTransitGatewayConnectPeer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse, UnregisterNMGRTransitGatewayConnectPeerCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TransitGatewayConnectPeerArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerRequest();
        ...
        private Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DisassociateTransitGatewayConnectPeer");
            try
            {
                #if DESKTOP
                return client.DisassociateTransitGatewayConnectPeer(request);
                #elif CORECLR
                return client.DisassociateTransitGatewayConnectPeerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GlobalNetworkId { get; set; }
            public System.String TransitGatewayConnectPeerArn { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DisassociateTransitGatewayConnectPeerResponse, UnregisterNMGRTransitGatewayConnectPeerCmdlet, object> Select { get; set; } =
