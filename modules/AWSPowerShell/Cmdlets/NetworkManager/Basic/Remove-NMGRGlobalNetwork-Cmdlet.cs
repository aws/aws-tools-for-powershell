...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    public partial class RemoveNMGRGlobalNetworkCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NMGRGlobalNetwork (DeleteGlobalNetwork)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DeleteGlobalNetworkResponse, RemoveNMGRGlobalNetworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DeleteGlobalNetworkRequest();
        ...
        private Amazon.NetworkManager.Model.DeleteGlobalNetworkResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DeleteGlobalNetworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DeleteGlobalNetwork");
            try
            {
                #if DESKTOP
                return client.DeleteGlobalNetwork(request);
                #elif CORECLR
                return client.DeleteGlobalNetworkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GlobalNetworkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DeleteGlobalNetworkResponse, RemoveNMGRGlobalNetworkCmdlet, object> Select { get; set; } =
