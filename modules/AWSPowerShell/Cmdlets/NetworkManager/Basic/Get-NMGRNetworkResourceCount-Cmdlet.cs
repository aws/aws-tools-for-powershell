...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "NMGRNetworkResourceCount")]
    [OutputType("Amazon.NetworkManager.Model.NetworkResourceCount")]
    [AWSCmdlet("Calls the AWS Network Manager GetNetworkResourceCounts API operation.", Operation = new[] {"GetNetworkResourceCounts"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.NetworkResourceCount or Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse",
        "This cmdlet returns a collection of Amazon.NetworkManager.Model.NetworkResourceCount objects.",
        "The service call response (type Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNMGRNetworkResourceCountCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NetworkResourceCounts";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse, GetNMGRNetworkResourceCountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.NetworkManager.Model.GetNetworkResourceCountsRequest();
        ...
        private Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.GetNetworkResourceCountsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "GetNetworkResourceCounts");
            try
            {
                #if DESKTOP
                return client.GetNetworkResourceCounts(request);
                #elif CORECLR
                return client.GetNetworkResourceCountsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceType { get; set; }
            public System.Func<Amazon.NetworkManager.Model.GetNetworkResourceCountsResponse, GetNMGRNetworkResourceCountCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NetworkResourceCounts;
        }
