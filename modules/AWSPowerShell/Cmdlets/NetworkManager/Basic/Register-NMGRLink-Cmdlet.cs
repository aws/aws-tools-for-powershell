...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Register", "NMGRLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkManager.Model.LinkAssociation")]
    [AWSCmdlet("Calls the AWS Network Manager AssociateLink API operation.", Operation = new[] {"AssociateLink"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.AssociateLinkResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.LinkAssociation or Amazon.NetworkManager.Model.AssociateLinkResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.LinkAssociation object.",
        "The service call response (type Amazon.NetworkManager.Model.AssociateLinkResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterNMGRLinkCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-NMGRLink (AssociateLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.AssociateLinkResponse, RegisterNMGRLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.AssociateLinkRequest();
        ...
        private Amazon.NetworkManager.Model.AssociateLinkResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.AssociateLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "AssociateLink");
            try
            {
                #if DESKTOP
                return client.AssociateLink(request);
                #elif CORECLR
                return client.AssociateLinkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String GlobalNetworkId { get; set; }
            public System.String LinkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.AssociateLinkResponse, RegisterNMGRLinkCmdlet, object> Select { get; set; } =
