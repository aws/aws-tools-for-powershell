...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Deny", "NMGRAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkManager.Model.Attachment")]
    [AWSCmdlet("Calls the AWS Network Manager RejectAttachment API operation.", Operation = new[] {"RejectAttachment"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.RejectAttachmentResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.Attachment or Amazon.NetworkManager.Model.RejectAttachmentResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.Attachment object.",
        "The service call response (type Amazon.NetworkManager.Model.RejectAttachmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DenyNMGRAttachmentCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-NMGRAttachment (RejectAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.RejectAttachmentResponse, DenyNMGRAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.RejectAttachmentRequest();
        ...
        private Amazon.NetworkManager.Model.RejectAttachmentResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.RejectAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "RejectAttachment");
            try
            {
                #if DESKTOP
                return client.RejectAttachment(request);
                #elif CORECLR
                return client.RejectAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AttachmentId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.RejectAttachmentResponse, DenyNMGRAttachmentCmdlet, object> Select { get; set; } =
