...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NMGRCoreNetwork", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.NetworkManager.Model.CoreNetwork")]
    [AWSCmdlet("Calls the AWS Network Manager DeleteCoreNetwork API operation.", Operation = new[] {"DeleteCoreNetwork"}, SelectReturnType = typeof(Amazon.NetworkManager.Model.DeleteCoreNetworkResponse))]
    [AWSCmdletOutput("Amazon.NetworkManager.Model.CoreNetwork or Amazon.NetworkManager.Model.DeleteCoreNetworkResponse",
        "This cmdlet returns an Amazon.NetworkManager.Model.CoreNetwork object.",
        "The service call response (type Amazon.NetworkManager.Model.DeleteCoreNetworkResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveNMGRCoreNetworkCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NMGRCoreNetwork (DeleteCoreNetwork)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DeleteCoreNetworkResponse, RemoveNMGRCoreNetworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DeleteCoreNetworkRequest();
        ...
        private Amazon.NetworkManager.Model.DeleteCoreNetworkResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DeleteCoreNetworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DeleteCoreNetwork");
            try
            {
                #if DESKTOP
                return client.DeleteCoreNetwork(request);
                #elif CORECLR
                return client.DeleteCoreNetworkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CoreNetworkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DeleteCoreNetworkResponse, RemoveNMGRCoreNetworkCmdlet, object> Select { get; set; } =
