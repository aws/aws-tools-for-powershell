...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NMGRConnectPeerAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveNMGRConnectPeerAssociationCmdlet : AmazonNetworkManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConnectPeerAssociation";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NMGRConnectPeerAssociation (DisassociateConnectPeer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkManager.Model.DisassociateConnectPeerResponse, RemoveNMGRConnectPeerAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkManager.Model.DisassociateConnectPeerRequest();
        ...
        private Amazon.NetworkManager.Model.DisassociateConnectPeerResponse CallAWSServiceOperation(IAmazonNetworkManager client, Amazon.NetworkManager.Model.DisassociateConnectPeerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Manager", "DisassociateConnectPeer");
            try
            {
                #if DESKTOP
                return client.DisassociateConnectPeer(request);
                #elif CORECLR
                return client.DisassociateConnectPeerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConnectPeerId { get; set; }
            public System.String GlobalNetworkId { get; set; }
            public System.Func<Amazon.NetworkManager.Model.DisassociateConnectPeerResponse, RemoveNMGRConnectPeerAssociationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConnectPeerAssociation;
        }
