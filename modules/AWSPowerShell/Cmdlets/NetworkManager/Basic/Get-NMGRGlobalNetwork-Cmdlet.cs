...
namespace Amazon.PowerShell.Cmdlets.NMGR
{
    ...
    [AWSCmdletOutput("Amazon.NetworkManager.Model.GlobalNetwork or Amazon.NetworkManager.Model.DescribeGlobalNetworksResponse",
        ...
        "The service call response (type Amazon.NetworkManager.Model.DescribeGlobalNetworksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
