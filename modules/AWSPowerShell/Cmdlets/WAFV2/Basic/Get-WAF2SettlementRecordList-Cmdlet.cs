...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// value <c>TEST</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAF2SettlementRecordList")]
    [OutputType("Amazon.WAFV2.Model.SettlementRecord")]
    [AWSCmdlet("Calls the AWS WAF V2 ListSettlementRecords API operation.", Operation = new[] {"ListSettlementRecords"}, SelectReturnType = typeof(Amazon.WAFV2.Model.ListSettlementRecordsResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.SettlementRecord or Amazon.WAFV2.Model.ListSettlementRecordsResponse",
        "This cmdlet returns a collection of Amazon.WAFV2.Model.SettlementRecord objects.",
        "The service call response (type Amazon.WAFV2.Model.ListSettlementRecordsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAF2SettlementRecordListCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional filters to narrow the results. You can filter by payer address, status, source
        /// name, network, or other settlement fields.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The field to sort settlement records by: <c>TIMESTAMP</c>, <c>AMOUNT</c>, <c>NAME</c>,
        /// or <c>STATUS</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.WAFV2.SettlementSortBy")]
        public Amazon.WAFV2.SettlementSortBy SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of settlement records to return. Minimum: 1. Maximum: 100.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'Settlements'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFV2.Model.ListSettlementRecordsResponse).
        /// Specifying the name of a property of type Amazon.WAFV2.Model.ListSettlementRecordsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Settlements";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.ListSettlementRecordsResponse, GetWAF2SettlementRecordListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFV2.Model.ListSettlementRecordsRequest();
        ...
        private Amazon.WAFV2.Model.ListSettlementRecordsResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.ListSettlementRecordsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "ListSettlementRecords");
            try
            {
                return client.ListSettlementRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? TimeWindow_EndTime { get; set; }
            public System.DateTime? TimeWindow_StartTime { get; set; }
            public System.Func<Amazon.WAFV2.Model.ListSettlementRecordsResponse, GetWAF2SettlementRecordListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Settlements;
        }
