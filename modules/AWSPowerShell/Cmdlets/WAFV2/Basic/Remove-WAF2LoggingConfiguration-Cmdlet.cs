...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    [AWSCmdletOutput("None or Amazon.WAFV2.Model.DeleteLoggingConfigurationResponse",
        ...
        "The service response (type Amazon.WAFV2.Model.DeleteLoggingConfigurationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAF2LoggingConfigurationCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// </para><para>The log scope <c>CLOUDWATCH_TELEMETRY_RULE_MANAGED</c> indicates a configuration that
        ...
        /// is Amazon CloudWatch Logs ?</a> in the <i>Amazon CloudWatch Logs user guide</i>. </para><para>Default: <c>CUSTOMER</c></para>
        /// </para>
        /// </summary>
