...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    [AWSCmdlet("Calls the AWS WAF V2 CreateRegexPatternSet API operation.", Operation = new[] {"CreateRegexPatternSet"}, SelectReturnType = typeof(Amazon.WAFV2.Model.CreateRegexPatternSetResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.RegexPatternSetSummary or Amazon.WAFV2.Model.CreateRegexPatternSetResponse",
        "This cmdlet returns an Amazon.WAFV2.Model.RegexPatternSetSummary object.",
        "The service call response (type Amazon.WAFV2.Model.CreateRegexPatternSetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWAF2RegexPatternSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        
        #region Parameter Description
        /// <summary>
        /// <para>
        /// <para>A friendly description of the set. You cannot change the description of a set after
        /// you create it.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAF2RegexPatternSet (CreateRegexPatternSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.CreateRegexPatternSetResponse, NewWAF2RegexPatternSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFV2.Model.CreateRegexPatternSetRequest();
        ...
        private Amazon.WAFV2.Model.CreateRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.CreateRegexPatternSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "CreateRegexPatternSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WAFV2.Model.CreateRegexPatternSetResponse, NewWAF2RegexPatternSetCmdlet, object> Select { get; set; } =
