...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "WAF2RegexPatternSet")]
    [OutputType("Amazon.WAFV2.Model.GetRegexPatternSetResponse")]
    [AWSCmdlet("Calls the AWS WAF V2 GetRegexPatternSet API operation.", Operation = new[] {"GetRegexPatternSet"}, SelectReturnType = typeof(Amazon.WAFV2.Model.GetRegexPatternSetResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.GetRegexPatternSetResponse",
        "This cmdlet returns an Amazon.WAFV2.Model.GetRegexPatternSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAF2RegexPatternSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.GetRegexPatternSetResponse, GetWAF2RegexPatternSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFV2.Model.GetRegexPatternSetRequest();
        ...
        private Amazon.WAFV2.Model.GetRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.GetRegexPatternSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "GetRegexPatternSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.GetRegexPatternSetResponse, GetWAF2RegexPatternSetCmdlet, object> Select { get; set; } =
