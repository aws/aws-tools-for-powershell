...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// URI-level statistics.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetWAF2TopPathStatisticsByTrafficCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.WAFV2.Model.GetTopPathStatisticsByTrafficResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.GetTopPathStatisticsByTrafficRequest request)
        {
            ...
            try
            {
                return client.GetTopPathStatisticsByTrafficAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
