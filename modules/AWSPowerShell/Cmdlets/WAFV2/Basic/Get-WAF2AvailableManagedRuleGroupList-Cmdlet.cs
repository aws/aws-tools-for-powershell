...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// groups that you're subscribed to.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAF2AvailableManagedRuleGroupList")]
    [OutputType("Amazon.WAFV2.Model.ManagedRuleGroupSummary")]
    [AWSCmdlet("Calls the AWS WAF V2 ListAvailableManagedRuleGroups API operation.", Operation = new[] {"ListAvailableManagedRuleGroups"}, SelectReturnType = typeof(Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.ManagedRuleGroupSummary or Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse",
        "This cmdlet returns a collection of Amazon.WAFV2.Model.ManagedRuleGroupSummary objects.",
        "The service call response (type Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAF2AvailableManagedRuleGroupListCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ManagedRuleGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse, GetWAF2AvailableManagedRuleGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsRequest();
        ...
        private Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "ListAvailableManagedRuleGroups");
            try
            {
                #if DESKTOP
                return client.ListAvailableManagedRuleGroups(request);
                #elif CORECLR
                return client.ListAvailableManagedRuleGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextMarker { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.ListAvailableManagedRuleGroupsResponse, GetWAF2AvailableManagedRuleGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ManagedRuleGroups;
        }
