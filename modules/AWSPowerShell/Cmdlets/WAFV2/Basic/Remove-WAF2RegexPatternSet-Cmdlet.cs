...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "WAF2RegexPatternSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS WAF V2 DeleteRegexPatternSet API operation.", Operation = new[] {"DeleteRegexPatternSet"}, SelectReturnType = typeof(Amazon.WAFV2.Model.DeleteRegexPatternSetResponse))]
    [AWSCmdletOutput("None or Amazon.WAFV2.Model.DeleteRegexPatternSetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WAFV2.Model.DeleteRegexPatternSetResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveWAF2RegexPatternSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A friendly name of the set. You cannot change the name after you create the set.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAF2RegexPatternSet (DeleteRegexPatternSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.DeleteRegexPatternSetResponse, RemoveWAF2RegexPatternSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFV2.Model.DeleteRegexPatternSetRequest();
        ...
        private Amazon.WAFV2.Model.DeleteRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.DeleteRegexPatternSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "DeleteRegexPatternSet");
            try
            {
                #if DESKTOP
                return client.DeleteRegexPatternSet(request);
                #elif CORECLR
                return client.DeleteRegexPatternSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.DeleteRegexPatternSetResponse, RemoveWAF2RegexPatternSetCmdlet, object> Select { get; set; } =
