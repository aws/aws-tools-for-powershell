...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    [OutputType("Amazon.WAFV2.Model.GetManagedRuleSetResponse")]
    [AWSCmdlet("Calls the AWS WAF V2 GetManagedRuleSet API operation.", Operation = new[] {"GetManagedRuleSet"}, SelectReturnType = typeof(Amazon.WAFV2.Model.GetManagedRuleSetResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.GetManagedRuleSetResponse",
        "This cmdlet returns an Amazon.WAFV2.Model.GetManagedRuleSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAF2ManagedRuleSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.GetManagedRuleSetResponse, GetWAF2ManagedRuleSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFV2.Model.GetManagedRuleSetRequest();
        ...
        private Amazon.WAFV2.Model.GetManagedRuleSetResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.GetManagedRuleSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "GetManagedRuleSet");
            try
            {
                #if DESKTOP
                return client.GetManagedRuleSet(request);
                #elif CORECLR
                return client.GetManagedRuleSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.GetManagedRuleSetResponse, GetWAF2ManagedRuleSetCmdlet, object> Select { get; set; } =
