...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    public partial class UpdateWAF2IPSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// and IPv6 CIDR ranges except for /0. </para><para>Example address strings: </para><ul><li><para>To configure WAF to allow, block, or count requests that originated from the IP address
