...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    public partial class GetWAF2IPSetCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.GetIPSetResponse, GetWAF2IPSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFV2.Model.GetIPSetRequest();
        ...
        private Amazon.WAFV2.Model.GetIPSetResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.GetIPSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "GetIPSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.GetIPSetResponse, GetWAF2IPSetCmdlet, object> Select { get; set; } =
