...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    [OutputType("Amazon.WAFV2.Model.ManagedRuleSetSummary")]
    [AWSCmdlet("Calls the AWS WAF V2 ListManagedRuleSets API operation.", Operation = new[] {"ListManagedRuleSets"}, SelectReturnType = typeof(Amazon.WAFV2.Model.ListManagedRuleSetsResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.ManagedRuleSetSummary or Amazon.WAFV2.Model.ListManagedRuleSetsResponse",
        "This cmdlet returns a collection of Amazon.WAFV2.Model.ManagedRuleSetSummary objects.",
        "The service call response (type Amazon.WAFV2.Model.ListManagedRuleSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAF2ManagedRuleSetListCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ManagedRuleSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.ListManagedRuleSetsResponse, GetWAF2ManagedRuleSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFV2.Model.ListManagedRuleSetsRequest();
        ...
        private Amazon.WAFV2.Model.ListManagedRuleSetsResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.ListManagedRuleSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "ListManagedRuleSets");
            try
            {
                #if DESKTOP
                return client.ListManagedRuleSets(request);
                #elif CORECLR
                return client.ListManagedRuleSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextMarker { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.ListManagedRuleSetsResponse, GetWAF2ManagedRuleSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ManagedRuleSets;
        }
