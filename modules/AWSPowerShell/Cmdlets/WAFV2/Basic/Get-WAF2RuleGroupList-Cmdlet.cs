...
namespace Amazon.PowerShell.Cmdlets.WAF2
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAF2RuleGroupList")]
    [OutputType("Amazon.WAFV2.Model.RuleGroupSummary")]
    [AWSCmdlet("Calls the AWS WAF V2 ListRuleGroups API operation.", Operation = new[] {"ListRuleGroups"}, SelectReturnType = typeof(Amazon.WAFV2.Model.ListRuleGroupsResponse))]
    [AWSCmdletOutput("Amazon.WAFV2.Model.RuleGroupSummary or Amazon.WAFV2.Model.ListRuleGroupsResponse",
        "This cmdlet returns a collection of Amazon.WAFV2.Model.RuleGroupSummary objects.",
        "The service call response (type Amazon.WAFV2.Model.ListRuleGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAF2RuleGroupListCmdlet : AmazonWAFV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFV2.Model.ListRuleGroupsResponse, GetWAF2RuleGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFV2.Model.ListRuleGroupsRequest();
        ...
        private Amazon.WAFV2.Model.ListRuleGroupsResponse CallAWSServiceOperation(IAmazonWAFV2 client, Amazon.WAFV2.Model.ListRuleGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF V2", "ListRuleGroups");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextMarker { get; set; }
            public Amazon.WAFV2.Scope Scope { get; set; }
            public System.Func<Amazon.WAFV2.Model.ListRuleGroupsResponse, GetWAF2RuleGroupListCmdlet, object> Select { get; set; } =
