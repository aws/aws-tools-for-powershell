...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ELB2TrustStore", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveELB2TrustStoreCmdlet : AmazonElasticLoadBalancingV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ELB2TrustStore (DeleteTrustStore)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreResponse, RemoveELB2TrustStoreCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreRequest();
        ...
        private Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreResponse CallAWSServiceOperation(IAmazonElasticLoadBalancingV2 client, Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Load Balancing V2", "DeleteTrustStore");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String TrustStoreArn { get; set; }
            public System.Func<Amazon.ElasticLoadBalancingV2.Model.DeleteTrustStoreResponse, RemoveELB2TrustStoreCmdlet, object> Select { get; set; } =
