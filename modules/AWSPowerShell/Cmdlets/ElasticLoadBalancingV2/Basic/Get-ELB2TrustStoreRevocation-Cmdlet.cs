...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    [AWSCmdletOutput("Amazon.ElasticLoadBalancingV2.Model.DescribeTrustStoreRevocation or Amazon.ElasticLoadBalancingV2.Model.DescribeTrustStoreRevocationsResponse",
        ...
        "The service call response (type Amazon.ElasticLoadBalancingV2.Model.DescribeTrustStoreRevocationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
