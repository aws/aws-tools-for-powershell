...
{
    /// <summary>
    /// Describes all trust stores for a given account by trust store arn’s or name.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ElasticLoadBalancingV2.Model.TrustStore or Amazon.ElasticLoadBalancingV2.Model.DescribeTrustStoresResponse",
        ...
        "The service call response (type Amazon.ElasticLoadBalancingV2.Model.DescribeTrustStoresResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
