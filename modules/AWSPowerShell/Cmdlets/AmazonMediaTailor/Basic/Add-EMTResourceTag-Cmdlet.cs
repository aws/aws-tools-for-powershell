...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// more tags to add.
    /// </summary>
    [Cmdlet("Add", "EMTResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor TagResource API operation.", Operation = new[] {"TagResource"})]
    ...
    public partial class AddEMTResourceTagCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EMTResourceTag (TagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.TagResourceRequest();
        ...
        private Amazon.MediaTailor.Model.TagResourceResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "TagResource");
            try
            {
                #if DESKTOP
