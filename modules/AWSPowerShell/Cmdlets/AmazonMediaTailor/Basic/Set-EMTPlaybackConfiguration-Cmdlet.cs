...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaTailor PutPlaybackConfiguration API operation.", Operation = new[] {"PutPlaybackConfiguration"})]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.PutPlaybackConfigurationResponse",
        "This cmdlet returns a Amazon.MediaTailor.Model.PutPlaybackConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetEMTPlaybackConfigurationCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        private Amazon.MediaTailor.Model.PutPlaybackConfigurationResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.PutPlaybackConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.PutPlaybackConfigurationAsync(request);
                return task.Result;
                #else
