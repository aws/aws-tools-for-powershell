...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaTailor ListPlaybackConfigurations API operation.", Operation = new[] {"ListPlaybackConfigurations"})]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.PlaybackConfiguration",
        "This cmdlet returns a collection of PlaybackConfiguration objects.",
