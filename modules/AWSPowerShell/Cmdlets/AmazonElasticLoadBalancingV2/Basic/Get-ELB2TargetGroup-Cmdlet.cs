...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    public class GetELB2TargetGroupCmdlet : AmazonElasticLoadBalancingV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.TargetGroupArns = new List<System.String>(this.TargetGroupArn);
            }
