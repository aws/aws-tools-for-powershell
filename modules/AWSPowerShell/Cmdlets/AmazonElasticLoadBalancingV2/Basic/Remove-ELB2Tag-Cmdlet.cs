...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Invokes the RemoveTags operation against Elastic Load Balancing V2.", Operation = new[] {"RemoveTags"})]
    ...
    public class RemoveELB2TagCmdlet : AmazonElasticLoadBalancingV2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ElasticLoadBalancingV2.Model.RemoveTagsResponse CallAWSServiceOperation(IAmazonElasticLoadBalancingV2 client, Amazon.ElasticLoadBalancingV2.Model.RemoveTagsRequest request)
        {
