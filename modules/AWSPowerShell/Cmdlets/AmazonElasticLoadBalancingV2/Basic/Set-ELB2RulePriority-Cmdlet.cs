...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    [AWSCmdlet("Invokes the SetRulePriorities operation against Elastic Load Balancing V2.", Operation = new[] {"SetRulePriorities"})]
    ...
    public partial class SetELB2RulePriorityCmdlet : AmazonElasticLoadBalancingV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("RulePriority", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.RulePriorities != null)
            {
                request.RulePriorities = cmdletContext.RulePriorities;
            }
        ...
        {
            public List<Amazon.ElasticLoadBalancingV2.Model.RulePriorityPair> RulePriorities { get; set; }
        }
