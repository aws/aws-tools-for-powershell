...
namespace Amazon.PowerShell.Cmdlets.ELB2
{
    ...
    /// You must specify either a load balancer or one or more listeners.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    [Cmdlet("Get", "ELB2Listener")]
    [OutputType("Amazon.ElasticLoadBalancingV2.Model.Listener")]
    [AWSCmdlet("Invokes the DescribeListeners operation against Elastic Load Balancing V2.", Operation = new[] {"DescribeListeners"})]
    ...
    public class GetELB2ListenerCmdlet : AmazonElasticLoadBalancingV2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ListenerArns != null)
            {
                request.ListenerArns = cmdletContext.ListenerArns;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.Listeners.Count;
        ...
        {
            public List<System.String> ListenerArns { get; set; }
            public System.String LoadBalancerArn { get; set; }
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
        }
