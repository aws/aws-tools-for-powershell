...
namespace Amazon.PowerShell.Cmdlets.PCA
{
    ...
    public partial class GetPCACertificateCmdlet : AmazonACMPCAClientCmdlet, IExecutor
    {
        ...
        /// and must be in the following form: </para><para><code>arn:aws:acm:<i>region</i>:<i>account</i>:certificate-authority/<i>12345678-1234-1234-1234-123456789012</i>/certificate/<i>286535153982981100925020015808220737245</i></code></para>
        /// </para>
        /// </summary>
