...
namespace Amazon.PowerShell.Cmdlets.PCA
{
    ...
    [AWSCmdlet("Calls the AWS Certificate Manager Private Certificate Authority ListCertificateAuthorities API operation.", Operation = new[] {"ListCertificateAuthorities"})]
    [AWSCmdletOutput("Amazon.ACMPCA.Model.CertificateAuthority",
        "This cmdlet returns a collection of CertificateAuthority objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CertificateAuthorities;
                        ...
                        int _receivedThisCall = response.CertificateAuthorities.Count;
