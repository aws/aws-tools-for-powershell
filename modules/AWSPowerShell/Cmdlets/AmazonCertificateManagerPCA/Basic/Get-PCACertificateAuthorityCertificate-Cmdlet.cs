...
namespace Amazon.PowerShell.Cmdlets.PCA
{
    ...
    public partial class GetPCACertificateAuthorityCertificateCmdlet : AmazonACMPCAClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of your private CA. This is of the form:</para><para><code>arn:aws:acm:<i>region</i>:<i>account</i>:certificate-authority/<i>12345678-1234-1234-1234-123456789012</i></code>. </para>
        /// </para>
        /// </summary>
