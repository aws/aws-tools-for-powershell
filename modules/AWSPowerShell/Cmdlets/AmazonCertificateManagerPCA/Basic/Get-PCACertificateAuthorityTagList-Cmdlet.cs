...
namespace Amazon.PowerShell.Cmdlets.PCA
{
    ...
    [AWSCmdlet("Calls the AWS Certificate Manager Private Certificate Authority ListTags API operation.", Operation = new[] {"ListTags"})]
    [AWSCmdletOutput("Amazon.ACMPCA.Model.Tag",
