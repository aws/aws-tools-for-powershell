...
namespace Amazon.PowerShell.Cmdlets.SCH
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Scheduler.Model.CreateScheduleResponse",
        ...
        "The service call response (type Amazon.Scheduler.Model.CreateScheduleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSCHScheduleCmdlet : AmazonSchedulerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The capacity provider strategy to use for the task.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The task placement strategy for a task or service.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_RunTask.html"><c>RunTask</c></a> in the <i>Amazon ECS API Reference</i>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Scheduler.Model.CreateScheduleResponse, NewSCHScheduleCmdlet>(Select) ??
        ...
        private Amazon.Scheduler.Model.CreateScheduleResponse CallAWSServiceOperation(IAmazonScheduler client, Amazon.Scheduler.Model.CreateScheduleRequest request)
        {
            ...
            try
            {
                return client.CreateScheduleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SqsParameters_MessageGroupId { get; set; }
            public System.Func<Amazon.Scheduler.Model.CreateScheduleResponse, NewSCHScheduleCmdlet, object> Select { get; set; } =
