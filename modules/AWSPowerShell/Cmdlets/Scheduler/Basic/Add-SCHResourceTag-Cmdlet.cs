...
namespace Amazon.PowerShell.Cmdlets.SCH
{
    ...
    /// </summary>
    [Cmdlet("Add", "SCHResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddSCHResourceTagCmdlet : AmazonSchedulerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SCHResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Scheduler.Model.TagResourceResponse, AddSCHResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Scheduler.Model.TagResourceRequest();
        ...
        private Amazon.Scheduler.Model.TagResourceResponse CallAWSServiceOperation(IAmazonScheduler client, Amazon.Scheduler.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Scheduler", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Scheduler.Model.TagResourceResponse, AddSCHResourceTagCmdlet, object> Select { get; set; } =
