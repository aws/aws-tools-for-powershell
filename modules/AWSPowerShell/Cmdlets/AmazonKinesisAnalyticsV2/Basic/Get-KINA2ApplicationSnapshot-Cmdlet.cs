...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Analytics (v2) DescribeApplicationSnapshot API operation.", Operation = new[] {"DescribeApplicationSnapshot"})]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.SnapshotDetails",
        "This cmdlet returns a SnapshotDetails object.",
    ...
    public partial class GetKINA2ApplicationSnapshotCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SnapshotDetails;
        ...
        private Amazon.KinesisAnalyticsV2.Model.DescribeApplicationSnapshotResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.DescribeApplicationSnapshotRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeApplicationSnapshotAsync(request);
                return task.Result;
                #else
