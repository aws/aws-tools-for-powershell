...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "KINA2ApplicationReferenceDataSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceResponse")]
    [AWSCmdlet("Calls the Amazon Kinesis Analytics (v2) DeleteApplicationReferenceDataSource API operation.", Operation = new[] {"DeleteApplicationReferenceDataSource"})]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceResponse",
        "This cmdlet returns a Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveKINA2ApplicationReferenceDataSourceCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KINA2ApplicationReferenceDataSource (DeleteApplicationReferenceDataSource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceRequest();
        ...
        private Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.DeleteApplicationReferenceDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics (v2)", "DeleteApplicationReferenceDataSource");
            try
            {
                #if DESKTOP
