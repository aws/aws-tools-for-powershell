...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Analytics (v2) ListApplications API operation.", Operation = new[] {"ListApplications"})]
    [AWSCmdletOutput("Amazon.KinesisAnalyticsV2.Model.ApplicationSummary",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ApplicationSummaries;
