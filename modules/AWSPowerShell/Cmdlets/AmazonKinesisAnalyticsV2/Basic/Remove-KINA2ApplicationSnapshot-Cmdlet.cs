...
namespace Amazon.PowerShell.Cmdlets.KINA2
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Analytics (v2) DeleteApplicationSnapshot API operation.", Operation = new[] {"DeleteApplicationSnapshot"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the SnapshotName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveKINA2ApplicationSnapshotCmdlet : AmazonKinesisAnalyticsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("SnapshotCreationTimestamp"))
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.SnapshotName;
        ...
        private Amazon.KinesisAnalyticsV2.Model.DeleteApplicationSnapshotResponse CallAWSServiceOperation(IAmazonKinesisAnalyticsV2 client, Amazon.KinesisAnalyticsV2.Model.DeleteApplicationSnapshotRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteApplicationSnapshotAsync(request);
                return task.Result;
                #else
