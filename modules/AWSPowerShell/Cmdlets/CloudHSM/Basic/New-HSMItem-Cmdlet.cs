...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    public partial class NewHSMItemCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the IamRoleArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^IamRoleArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^IamRoleArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.IamRoleArn;
            }
        ...
        private Amazon.CloudHSM.Model.CreateHsmResponse CallAWSServiceOperation(IAmazonCloudHSM client, Amazon.CloudHSM.Model.CreateHsmRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.CreateHsmAsync(request).GetAwaiter().GetResult();
                #else
