...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS CloudHSM RemoveTagsFromResource API operation.", Operation = new[] {"RemoveTagsFromResource"}, SelectReturnType = typeof(Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class RemoveHSMResourceTagCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse).
        /// Specifying the name of a property of type Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse, RemoveHSMResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM", "RemoveTagsFromResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudHSM.Model.RemoveTagsFromResourceResponse, RemoveHSMResourceTagCmdlet, object> Select { get; set; } =
