...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS CloudHSM ListHapgs API operation.", Operation = new[] {"ListHapgs"}, SelectReturnType = typeof(Amazon.CloudHSM.Model.ListHapgsResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudHSM.Model.ListHapgsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudHSM.Model.ListHapgsResponse) can be returned by specifying '-Select *'."
    )]
    [System.ObsoleteAttribute("This API is deprecated.")]
    public partial class GetHSMPartitionGroupListCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'HapgList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudHSM.Model.ListHapgsResponse).
        /// Specifying the name of a property of type Amazon.CloudHSM.Model.ListHapgsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HapgList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSM.Model.ListHapgsResponse, GetHSMPartitionGroupListCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM", "ListHapgs");
            try
            {
                return client.ListHapgsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudHSM.Model.ListHapgsResponse, GetHSMPartitionGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HapgList;
        }
