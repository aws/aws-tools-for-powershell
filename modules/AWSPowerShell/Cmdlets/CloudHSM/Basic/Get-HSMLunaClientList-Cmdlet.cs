...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    public partial class GetHSMLunaClientListCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>NextToken</c> value from a previous call to <c>ListLunaClients</c>. Pass null
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ClientList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudHSM.Model.ListLunaClientsResponse).
        /// Specifying the name of a property of type Amazon.CloudHSM.Model.ListLunaClientsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ClientList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSM.Model.ListLunaClientsResponse, GetHSMLunaClientListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudHSM.Model.ListLunaClientsRequest();
        ...
        private Amazon.CloudHSM.Model.ListLunaClientsResponse CallAWSServiceOperation(IAmazonCloudHSM client, Amazon.CloudHSM.Model.ListLunaClientsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM", "ListLunaClients");
            try
            {
                return client.ListLunaClientsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudHSM.Model.ListLunaClientsResponse, GetHSMLunaClientListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ClientList;
        }
