...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    public partial class RemoveHSMPartitionGroupCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudHSM.Model.DeleteHapgResponse).
        /// Specifying the name of a property of type Amazon.CloudHSM.Model.DeleteHapgResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSM.Model.DeleteHapgResponse, RemoveHSMPartitionGroupCmdlet>(Select) ??
        ...
        private Amazon.CloudHSM.Model.DeleteHapgResponse CallAWSServiceOperation(IAmazonCloudHSM client, Amazon.CloudHSM.Model.DeleteHapgRequest request)
        {
            ...
            try
            {
                return client.DeleteHapgAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String HapgArn { get; set; }
            public System.Func<Amazon.CloudHSM.Model.DeleteHapgResponse, RemoveHSMPartitionGroupCmdlet, object> Select { get; set; } =
