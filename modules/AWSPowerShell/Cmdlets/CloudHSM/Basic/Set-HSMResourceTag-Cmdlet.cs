...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    public partial class SetHSMResourceTagCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudHSM.Model.AddTagsToResourceResponse).
        /// Specifying the name of a property of type Amazon.CloudHSM.Model.AddTagsToResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSM.Model.AddTagsToResourceResponse, SetHSMResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM", "AddTagsToResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudHSM.Model.AddTagsToResourceResponse, SetHSMResourceTagCmdlet, object> Select { get; set; } =
