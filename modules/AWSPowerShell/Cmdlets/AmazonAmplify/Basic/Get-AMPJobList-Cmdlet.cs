...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPJobList")]
    [OutputType("Amazon.Amplify.Model.JobSummary")]
    [AWSCmdlet("Calls the AWS Amplify ListJobs API operation.", Operation = new[] {"ListJobs"})]
    [AWSCmdletOutput("Amazon.Amplify.Model.JobSummary",
        "This cmdlet returns a collection of JobSummary objects.",
        "The service call response (type Amazon.Amplify.Model.ListJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetAMPJobListCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Amplify.Model.ListJobsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.JobSummaries;
                        ...
                        int _receivedThisCall = response.JobSummaries.Count;
        ...
        private Amazon.Amplify.Model.ListJobsResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "ListJobs");
            try
            {
                #if DESKTOP
