...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// denied.
    /// </summary>
    [Cmdlet("Remove", "VPCLAuthPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the VPC Lattice DeleteAuthPolicy API operation.", Operation = new[] {"DeleteAuthPolicy"}, SelectReturnType = typeof(Amazon.VPCLattice.Model.DeleteAuthPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.VPCLattice.Model.DeleteAuthPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.VPCLattice.Model.DeleteAuthPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveVPCLAuthPolicyCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-VPCLAuthPolicy (DeleteAuthPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.DeleteAuthPolicyResponse, RemoveVPCLAuthPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.DeleteAuthPolicyRequest();
        ...
        private Amazon.VPCLattice.Model.DeleteAuthPolicyResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.DeleteAuthPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "DeleteAuthPolicy");
            try
            {
                #if DESKTOP
                return client.DeleteAuthPolicy(request);
                #elif CORECLR
                return client.DeleteAuthPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.DeleteAuthPolicyResponse, RemoveVPCLAuthPolicyCmdlet, object> Select { get; set; } =
