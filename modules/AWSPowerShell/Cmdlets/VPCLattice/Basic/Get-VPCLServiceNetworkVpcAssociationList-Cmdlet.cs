...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// identifier or the ID of the VPC.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetVPCLServiceNetworkVpcAssociationListCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        private Amazon.VPCLattice.Model.ListServiceNetworkVpcAssociationsResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.ListServiceNetworkVpcAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListServiceNetworkVpcAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
