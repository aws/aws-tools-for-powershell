...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Get", "VPCLService")]
    [OutputType("Amazon.VPCLattice.Model.GetServiceResponse")]
    [AWSCmdlet("Calls the VPC Lattice GetService API operation.", Operation = new[] {"GetService"}, SelectReturnType = typeof(Amazon.VPCLattice.Model.GetServiceResponse))]
    [AWSCmdletOutput("Amazon.VPCLattice.Model.GetServiceResponse",
        "This cmdlet returns an Amazon.VPCLattice.Model.GetServiceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetVPCLServiceCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.GetServiceResponse, GetVPCLServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.GetServiceRequest();
        ...
        private Amazon.VPCLattice.Model.GetServiceResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.GetServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "GetService");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ServiceIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.GetServiceResponse, GetVPCLServiceCmdlet, object> Select { get; set; } =
