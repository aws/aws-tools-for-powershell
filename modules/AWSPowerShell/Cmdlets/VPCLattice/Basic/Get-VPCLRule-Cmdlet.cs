...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Get", "VPCLRule")]
    [OutputType("Amazon.VPCLattice.Model.GetRuleResponse")]
    [AWSCmdlet("Calls the VPC Lattice GetRule API operation.", Operation = new[] {"GetRule"}, SelectReturnType = typeof(Amazon.VPCLattice.Model.GetRuleResponse))]
    [AWSCmdletOutput("Amazon.VPCLattice.Model.GetRuleResponse",
        "This cmdlet returns an Amazon.VPCLattice.Model.GetRuleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetVPCLRuleCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.GetRuleResponse, GetVPCLRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.GetRuleRequest();
        ...
        private Amazon.VPCLattice.Model.GetRuleResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.GetRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "GetRule");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RuleIdentifier { get; set; }
            public System.String ServiceIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.GetRuleResponse, GetVPCLRuleCmdlet, object> Select { get; set; } =
