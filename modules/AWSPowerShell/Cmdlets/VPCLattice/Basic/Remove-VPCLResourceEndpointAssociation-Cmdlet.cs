...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    public partial class RemoveVPCLResourceEndpointAssociationCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ResourceEndpointAssociationIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ResourceEndpointAssociationIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceEndpointAssociationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceEndpointAssociationIdentifier;
            }
        ...
        private Amazon.VPCLattice.Model.DeleteResourceEndpointAssociationResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.DeleteResourceEndpointAssociationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteResourceEndpointAssociation(request);
                #elif CORECLR
                return client.DeleteResourceEndpointAssociationAsync(request).GetAwaiter().GetResult();
                #else
