...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "VPCLTarget", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UnregisterVPCLTargetCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The targets to deregister.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-VPCLTarget (DeregisterTargets)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.DeregisterTargetsResponse, UnregisterVPCLTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.DeregisterTargetsRequest();
        ...
        private Amazon.VPCLattice.Model.DeregisterTargetsResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.DeregisterTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "DeregisterTargets");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.VPCLattice.Model.DeregisterTargetsResponse, UnregisterVPCLTargetCmdlet, object> Select { get; set; } =
