...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    public partial class GetVPCLServiceNetworkResourceAssociationCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ServiceNetworkResourceAssociationIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ServiceNetworkResourceAssociationIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ServiceNetworkResourceAssociationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ServiceNetworkResourceAssociationIdentifier;
            }
        ...
        private Amazon.VPCLattice.Model.GetServiceNetworkResourceAssociationResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.GetServiceNetworkResourceAssociationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetServiceNetworkResourceAssociation(request);
                #elif CORECLR
                return client.GetServiceNetworkResourceAssociationAsync(request).GetAwaiter().GetResult();
                #else
