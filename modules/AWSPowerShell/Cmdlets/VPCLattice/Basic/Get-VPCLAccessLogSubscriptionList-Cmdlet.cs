...
{
    /// <summary>
    /// Lists the access log subscriptions for the specified service network or service.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetVPCLAccessLogSubscriptionListCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.ListAccessLogSubscriptionsResponse, GetVPCLAccessLogSubscriptionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.VPCLattice.Model.ListAccessLogSubscriptionsRequest();
        ...
        private Amazon.VPCLattice.Model.ListAccessLogSubscriptionsResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.ListAccessLogSubscriptionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "ListAccessLogSubscriptions");
            try
            {
                return client.ListAccessLogSubscriptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.ListAccessLogSubscriptionsResponse, GetVPCLAccessLogSubscriptionListCmdlet, object> Select { get; set; } =
