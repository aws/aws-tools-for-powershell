...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Register", "VPCLTarget", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class RegisterVPCLTargetCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-VPCLTarget (RegisterTargets)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.RegisterTargetsResponse, RegisterVPCLTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.RegisterTargetsRequest();
        ...
        private Amazon.VPCLattice.Model.RegisterTargetsResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.RegisterTargetsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.VPCLattice.Model.RegisterTargetsResponse, RegisterVPCLTargetCmdlet, object> Select { get; set; } =
