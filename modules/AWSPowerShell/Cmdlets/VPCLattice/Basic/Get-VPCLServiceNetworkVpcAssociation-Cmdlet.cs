...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    [AWSCmdlet("Calls the VPC Lattice GetServiceNetworkVpcAssociation API operation.", Operation = new[] {"GetServiceNetworkVpcAssociation"}, SelectReturnType = typeof(Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse))]
    [AWSCmdletOutput("Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse",
        "This cmdlet returns an Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetVPCLServiceNetworkVpcAssociationCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse, GetVPCLServiceNetworkVpcAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationRequest();
        ...
        private Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "GetServiceNetworkVpcAssociation");
            try
            {
                #if DESKTOP
                return client.GetServiceNetworkVpcAssociation(request);
                #elif CORECLR
                return client.GetServiceNetworkVpcAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ServiceNetworkVpcAssociationIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.GetServiceNetworkVpcAssociationResponse, GetVPCLServiceNetworkVpcAssociationCmdlet, object> Select { get; set; } =
