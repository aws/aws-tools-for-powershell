...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Get", "VPCLAuthPolicy")]
    [OutputType("Amazon.VPCLattice.Model.GetAuthPolicyResponse")]
    [AWSCmdlet("Calls the VPC Lattice GetAuthPolicy API operation.", Operation = new[] {"GetAuthPolicy"}, SelectReturnType = typeof(Amazon.VPCLattice.Model.GetAuthPolicyResponse))]
    [AWSCmdletOutput("Amazon.VPCLattice.Model.GetAuthPolicyResponse",
        "This cmdlet returns an Amazon.VPCLattice.Model.GetAuthPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetVPCLAuthPolicyCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VPCLattice.Model.GetAuthPolicyResponse, GetVPCLAuthPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.GetAuthPolicyRequest();
        ...
        private Amazon.VPCLattice.Model.GetAuthPolicyResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.GetAuthPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "VPC Lattice", "GetAuthPolicy");
            try
            {
                #if DESKTOP
                return client.GetAuthPolicy(request);
                #elif CORECLR
                return client.GetAuthPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.GetAuthPolicyResponse, GetVPCLAuthPolicyCmdlet, object> Select { get; set; } =
