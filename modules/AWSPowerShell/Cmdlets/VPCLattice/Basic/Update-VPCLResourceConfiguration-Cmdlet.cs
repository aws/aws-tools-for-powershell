...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    public partial class UpdateVPCLResourceConfigurationCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ResourceConfigurationIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ResourceConfigurationIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceConfigurationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceConfigurationIdentifier;
            }
        ...
        private Amazon.VPCLattice.Model.UpdateResourceConfigurationResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.UpdateResourceConfigurationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateResourceConfiguration(request);
                #elif CORECLR
                return client.UpdateResourceConfigurationAsync(request).GetAwaiter().GetResult();
                #else
