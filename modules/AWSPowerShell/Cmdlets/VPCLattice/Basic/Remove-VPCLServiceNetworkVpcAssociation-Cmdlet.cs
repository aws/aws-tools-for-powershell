...
namespace Amazon.PowerShell.Cmdlets.VPCL
{
    ...
    /// </summary>
    [Cmdlet("Remove", "VPCLServiceNetworkVpcAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveVPCLServiceNetworkVpcAssociationCmdlet : AmazonVPCLatticeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-VPCLServiceNetworkVpcAssociation (DeleteServiceNetworkVpcAssociation)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VPCLattice.Model.DeleteServiceNetworkVpcAssociationRequest();
        ...
        private Amazon.VPCLattice.Model.DeleteServiceNetworkVpcAssociationResponse CallAWSServiceOperation(IAmazonVPCLattice client, Amazon.VPCLattice.Model.DeleteServiceNetworkVpcAssociationRequest request)
        {
        ...
        {
            public System.String ServiceNetworkVpcAssociationIdentifier { get; set; }
            public System.Func<Amazon.VPCLattice.Model.DeleteServiceNetworkVpcAssociationResponse, RemoveVPCLServiceNetworkVpcAssociationCmdlet, object> Select { get; set; } =
