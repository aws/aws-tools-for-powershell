#
# Module manifest for module 'AWS.Tools.VPCLattice'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.VPCLattice.dll'
    ...
    GUID = '88dc8a5c-4fce-4d09-83f4-e23548abd71a'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.VPCLattice.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.VPCLattice.Completers.psm1',
        'AWS.Tools.VPCLattice.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.VPCLattice.dll-Help.xml'
    )
