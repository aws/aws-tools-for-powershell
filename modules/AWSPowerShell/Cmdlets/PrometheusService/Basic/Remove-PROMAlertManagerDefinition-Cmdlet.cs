...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PROMAlertManagerDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePROMAlertManagerDefinitionCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROMAlertManagerDefinition (DeleteAlertManagerDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DeleteAlertManagerDefinitionResponse, RemovePROMAlertManagerDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DeleteAlertManagerDefinitionRequest();
        ...
        private Amazon.PrometheusService.Model.DeleteAlertManagerDefinitionResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DeleteAlertManagerDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DeleteAlertManagerDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteAlertManagerDefinition(request);
                #elif CORECLR
                return client.DeleteAlertManagerDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DeleteAlertManagerDefinitionResponse, RemovePROMAlertManagerDefinitionCmdlet, object> Select { get; set; } =
