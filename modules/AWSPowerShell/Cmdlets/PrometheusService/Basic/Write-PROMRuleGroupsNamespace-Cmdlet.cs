...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    /// </summary>
    [Cmdlet("Write", "PROMRuleGroupsNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class WritePROMRuleGroupsNamespaceCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-PROMRuleGroupsNamespace (PutRuleGroupsNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.PutRuleGroupsNamespaceResponse, WritePROMRuleGroupsNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.PrometheusService.Model.PutRuleGroupsNamespaceRequest();
        ...
        private Amazon.PrometheusService.Model.PutRuleGroupsNamespaceResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.PutRuleGroupsNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "PutRuleGroupsNamespace");
            try
            {
                #if DESKTOP
                return client.PutRuleGroupsNamespace(request);
                #elif CORECLR
                return client.PutRuleGroupsNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.PutRuleGroupsNamespaceResponse, WritePROMRuleGroupsNamespaceCmdlet, object> Select { get; set; } =
