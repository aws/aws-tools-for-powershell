...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class GetPROMScraperCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Scraper";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DescribeScraperResponse, GetPROMScraperCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DescribeScraperRequest();
        ...
        private Amazon.PrometheusService.Model.DescribeScraperResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DescribeScraperRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DescribeScraper");
            try
            {
                #if DESKTOP
                return client.DescribeScraper(request);
                #elif CORECLR
                return client.DescribeScraperAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ScraperId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DescribeScraperResponse, GetPROMScraperCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Scraper;
        }
