...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class GetPROMAlertManagerDefinitionCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "AlertManagerDefinition";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DescribeAlertManagerDefinitionResponse, GetPROMAlertManagerDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DescribeAlertManagerDefinitionRequest();
        ...
        private Amazon.PrometheusService.Model.DescribeAlertManagerDefinitionResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DescribeAlertManagerDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DescribeAlertManagerDefinition");
            try
            {
                #if DESKTOP
                return client.DescribeAlertManagerDefinition(request);
                #elif CORECLR
                return client.DescribeAlertManagerDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DescribeAlertManagerDefinitionResponse, GetPROMAlertManagerDefinitionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AlertManagerDefinition;
        }
