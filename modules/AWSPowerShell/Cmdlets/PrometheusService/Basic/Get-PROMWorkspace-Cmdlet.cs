...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class GetPROMWorkspaceCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DescribeWorkspaceResponse, GetPROMWorkspaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DescribeWorkspaceRequest();
        ...
        private Amazon.PrometheusService.Model.DescribeWorkspaceResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DescribeWorkspaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DescribeWorkspace");
            try
            {
                return client.DescribeWorkspaceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DescribeWorkspaceResponse, GetPROMWorkspaceCmdlet, object> Select { get; set; } =
