...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class UpdatePROMWorkspaceAliasCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-PROMWorkspaceAlias (UpdateWorkspaceAlias)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.UpdateWorkspaceAliasResponse, UpdatePROMWorkspaceAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.UpdateWorkspaceAliasRequest();
        ...
        private Amazon.PrometheusService.Model.UpdateWorkspaceAliasResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.UpdateWorkspaceAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "UpdateWorkspaceAlias");
            try
            {
                #if DESKTOP
                return client.UpdateWorkspaceAlias(request);
                #elif CORECLR
                return client.UpdateWorkspaceAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientToken { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.UpdateWorkspaceAliasResponse, UpdatePROMWorkspaceAliasCmdlet, object> Select { get; set; } =
