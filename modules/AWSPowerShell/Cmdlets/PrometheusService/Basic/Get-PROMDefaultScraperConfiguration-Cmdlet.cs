...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class GetPROMDefaultScraperConfigurationCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.GetDefaultScraperConfigurationResponse, GetPROMDefaultScraperConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.GetDefaultScraperConfigurationRequest();
        ...
        private Amazon.PrometheusService.Model.GetDefaultScraperConfigurationResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.GetDefaultScraperConfigurationRequest request)
        {
        ...
        {
            public System.Func<Amazon.PrometheusService.Model.GetDefaultScraperConfigurationResponse, GetPROMDefaultScraperConfigurationCmdlet, object> Select { get; set; } =
