...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class GetPROMRuleGroupsNamespaceCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RuleGroupsNamespace";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DescribeRuleGroupsNamespaceResponse, GetPROMRuleGroupsNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DescribeRuleGroupsNamespaceRequest();
        ...
        private Amazon.PrometheusService.Model.DescribeRuleGroupsNamespaceResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DescribeRuleGroupsNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DescribeRuleGroupsNamespace");
            try
            {
                #if DESKTOP
                return client.DescribeRuleGroupsNamespace(request);
                #elif CORECLR
                return client.DescribeRuleGroupsNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DescribeRuleGroupsNamespaceResponse, GetPROMRuleGroupsNamespaceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RuleGroupsNamespace;
        }
