...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    /// </summary>
    [Cmdlet("Write", "PROMAlertManagerDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PrometheusService.Model.AlertManagerDefinitionStatus")]
    [AWSCmdlet("Calls the Amazon Prometheus Service PutAlertManagerDefinition API operation.", Operation = new[] {"PutAlertManagerDefinition"}, SelectReturnType = typeof(Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse))]
    [AWSCmdletOutput("Amazon.PrometheusService.Model.AlertManagerDefinitionStatus or Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse",
        "This cmdlet returns an Amazon.PrometheusService.Model.AlertManagerDefinitionStatus object.",
        "The service call response (type Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WritePROMAlertManagerDefinitionCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-PROMAlertManagerDefinition (PutAlertManagerDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse, WritePROMAlertManagerDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.PrometheusService.Model.PutAlertManagerDefinitionRequest();
        ...
        private Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.PutAlertManagerDefinitionRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public byte[] Data { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.PutAlertManagerDefinitionResponse, WritePROMAlertManagerDefinitionCmdlet, object> Select { get; set; } =
