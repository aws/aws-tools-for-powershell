...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    /// </summary>
    [Cmdlet("Write", "PROMAnomalyDetector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PrometheusService.Model.PutAnomalyDetectorResponse")]
    [AWSCmdlet("Calls the Amazon Prometheus Service PutAnomalyDetector API operation.", Operation = new[] {"PutAnomalyDetector"}, SelectReturnType = typeof(Amazon.PrometheusService.Model.PutAnomalyDetectorResponse))]
    [AWSCmdletOutput("Amazon.PrometheusService.Model.PutAnomalyDetectorResponse",
        "This cmdlet returns an Amazon.PrometheusService.Model.PutAnomalyDetectorResponse object containing multiple properties."
    )]
    public partial class WritePROMAnomalyDetectorCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the anomaly detector to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The frequency, in seconds, at which the anomaly detector evaluates metrics.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the workspace containing the anomaly detector to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PrometheusService.Model.PutAnomalyDetectorResponse).
        /// Specifying the name of a property of type Amazon.PrometheusService.Model.PutAnomalyDetectorResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-PROMAnomalyDetector (PutAnomalyDetector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.PutAnomalyDetectorResponse, WritePROMAnomalyDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.PutAnomalyDetectorRequest();
        ...
        private Amazon.PrometheusService.Model.PutAnomalyDetectorResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.PutAnomalyDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "PutAnomalyDetector");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? MissingDataAction_Skip { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.PutAnomalyDetectorResponse, WritePROMAnomalyDetectorCmdlet, object> Select { get; set; } =
