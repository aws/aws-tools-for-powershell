...
namespace Amazon.PowerShell.Cmdlets.PROM
{
    ...
    public partial class RemovePROMRuleGroupsNamespaceCmdlet : AmazonPrometheusServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROMRuleGroupsNamespace (DeleteRuleGroupsNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PrometheusService.Model.DeleteRuleGroupsNamespaceResponse, RemovePROMRuleGroupsNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PrometheusService.Model.DeleteRuleGroupsNamespaceRequest();
        ...
        private Amazon.PrometheusService.Model.DeleteRuleGroupsNamespaceResponse CallAWSServiceOperation(IAmazonPrometheusService client, Amazon.PrometheusService.Model.DeleteRuleGroupsNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Prometheus Service", "DeleteRuleGroupsNamespace");
            try
            {
                #if DESKTOP
                return client.DeleteRuleGroupsNamespace(request);
                #elif CORECLR
                return client.DeleteRuleGroupsNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.PrometheusService.Model.DeleteRuleGroupsNamespaceResponse, RemovePROMRuleGroupsNamespaceCmdlet, object> Select { get; set; } =
