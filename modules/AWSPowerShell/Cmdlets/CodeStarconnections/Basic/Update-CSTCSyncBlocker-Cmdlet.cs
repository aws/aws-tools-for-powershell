...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// syncing to continue.
    /// </summary>
    [Cmdlet("Update", "CSTCSyncBlocker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCSTCSyncBlockerCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CSTCSyncBlocker (UpdateSyncBlocker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.UpdateSyncBlockerResponse, UpdateCSTCSyncBlockerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.UpdateSyncBlockerRequest();
        ...
        private Amazon.CodeStarconnections.Model.UpdateSyncBlockerResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.UpdateSyncBlockerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Connections", "UpdateSyncBlocker");
            try
            {
                return client.UpdateSyncBlockerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceName { get; set; }
            public Amazon.CodeStarconnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeStarconnections.Model.UpdateSyncBlockerResponse, UpdateCSTCSyncBlockerCmdlet, object> Select { get; set; } =
