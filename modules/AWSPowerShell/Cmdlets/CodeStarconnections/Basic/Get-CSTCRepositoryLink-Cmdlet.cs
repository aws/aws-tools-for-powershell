...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// </summary>
    [Cmdlet("Get", "CSTCRepositoryLink")]
    [OutputType("Amazon.CodeStarconnections.Model.RepositoryLinkInfo")]
    [AWSCmdlet("Calls the AWS CodeStar Connections GetRepositoryLink API operation.", Operation = new[] {"GetRepositoryLink"}, SelectReturnType = typeof(Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse))]
    [AWSCmdletOutput("Amazon.CodeStarconnections.Model.RepositoryLinkInfo or Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse",
        "This cmdlet returns an Amazon.CodeStarconnections.Model.RepositoryLinkInfo object.",
        "The service call response (type Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCSTCRepositoryLinkCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse, GetCSTCRepositoryLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.GetRepositoryLinkRequest();
        ...
        private Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.GetRepositoryLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Connections", "GetRepositoryLink");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String RepositoryLinkId { get; set; }
            public System.Func<Amazon.CodeStarconnections.Model.GetRepositoryLinkResponse, GetCSTCRepositoryLinkCmdlet, object> Select { get; set; } =
