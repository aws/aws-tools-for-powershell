...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// </summary>
    [Cmdlet("Add", "CSTCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddCSTCResourceTagCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CSTCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.TagResourceResponse, AddCSTCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.TagResourceRequest();
        ...
        private Amazon.CodeStarconnections.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Connections", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeStarconnections.Model.TagResourceResponse, AddCSTCResourceTagCmdlet, object> Select { get; set; } =
