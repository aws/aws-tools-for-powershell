...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// </summary>
    [Cmdlet("Get", "CSTCSyncConfiguration")]
    ...
    public partial class GetCSTCSyncConfigurationCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.GetSyncConfigurationResponse, GetCSTCSyncConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.GetSyncConfigurationRequest();
        ...
        private Amazon.CodeStarconnections.Model.GetSyncConfigurationResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.GetSyncConfigurationRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceName { get; set; }
            public Amazon.CodeStarconnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeStarconnections.Model.GetSyncConfigurationResponse, GetCSTCSyncConfigurationCmdlet, object> Select { get; set; } =
