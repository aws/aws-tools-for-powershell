...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// resource.
    /// </summary>
    [Cmdlet("Get", "CSTCResourceSyncStatus")]
    ...
    public partial class GetCSTCResourceSyncStatusCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.GetResourceSyncStatusResponse, GetCSTCResourceSyncStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.GetResourceSyncStatusRequest();
        ...
        private Amazon.CodeStarconnections.Model.GetResourceSyncStatusResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.GetResourceSyncStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Connections", "GetResourceSyncStatus");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceName { get; set; }
            public Amazon.CodeStarconnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeStarconnections.Model.GetResourceSyncStatusResponse, GetCSTCResourceSyncStatusCmdlet, object> Select { get; set; } =
