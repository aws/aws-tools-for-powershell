...
namespace Amazon.PowerShell.Cmdlets.CSTC
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "CSTCHost", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCSTCHostCmdlet : AmazonCodeStarconnectionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CSTCHost (DeleteHost)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarconnections.Model.DeleteHostResponse, RemoveCSTCHostCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarconnections.Model.DeleteHostRequest();
        ...
        private Amazon.CodeStarconnections.Model.DeleteHostResponse CallAWSServiceOperation(IAmazonCodeStarconnections client, Amazon.CodeStarconnections.Model.DeleteHostRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Connections", "DeleteHost");
            try
            {
                #if DESKTOP
                return client.DeleteHost(request);
                #elif CORECLR
                return client.DeleteHostAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HostArn { get; set; }
            public System.Func<Amazon.CodeStarconnections.Model.DeleteHostResponse, RemoveCSTCHostCmdlet, object> Select { get; set; } =
