...
namespace Amazon.PowerShell.Cmdlets.SMSAP
{
    ...
    public partial class GetSMSAPOperationCmdlet : AmazonSsmSapClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SsmSap.Model.GetOperationResponse, GetSMSAPOperationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SsmSap.Model.GetOperationRequest();
        ...
        private Amazon.SsmSap.Model.GetOperationResponse CallAWSServiceOperation(IAmazonSsmSap client, Amazon.SsmSap.Model.GetOperationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager for SAP", "GetOperation");
            try
            {
        ...
        {
            public System.String OperationId { get; set; }
            public System.Func<Amazon.SsmSap.Model.GetOperationResponse, GetSMSAPOperationCmdlet, object> Select { get; set; } =
