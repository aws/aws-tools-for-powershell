...
namespace Amazon.PowerShell.Cmdlets.SMSAP
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMSAPResourcePermission")]
    ...
    public partial class GetSMSAPResourcePermissionCmdlet : AmazonSsmSapClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SsmSap.Model.GetResourcePermissionResponse, GetSMSAPResourcePermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SsmSap.Model.GetResourcePermissionRequest();
        ...
        private Amazon.SsmSap.Model.GetResourcePermissionResponse CallAWSServiceOperation(IAmazonSsmSap client, Amazon.SsmSap.Model.GetResourcePermissionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager for SAP", "GetResourcePermission");
            try
            {
                #if DESKTOP
                return client.GetResourcePermission(request);
                #elif CORECLR
                return client.GetResourcePermissionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.SsmSap.PermissionActionType ActionType { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SsmSap.Model.GetResourcePermissionResponse, GetSMSAPResourcePermissionCmdlet, object> Select { get; set; } =
