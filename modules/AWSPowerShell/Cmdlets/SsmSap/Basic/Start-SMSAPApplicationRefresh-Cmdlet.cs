...
namespace Amazon.PowerShell.Cmdlets.SMSAP
{
    ...
    /// </summary>
    [Cmdlet("Start", "SMSAPApplicationRefresh", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartSMSAPApplicationRefreshCmdlet : AmazonSsmSapClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-SMSAPApplicationRefresh (StartApplicationRefresh)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SsmSap.Model.StartApplicationRefreshResponse, StartSMSAPApplicationRefreshCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SsmSap.Model.StartApplicationRefreshRequest();
        ...
        private Amazon.SsmSap.Model.StartApplicationRefreshResponse CallAWSServiceOperation(IAmazonSsmSap client, Amazon.SsmSap.Model.StartApplicationRefreshRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager for SAP", "StartApplicationRefresh");
            try
            {
                #if DESKTOP
                return client.StartApplicationRefresh(request);
                #elif CORECLR
                return client.StartApplicationRefreshAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApplicationId { get; set; }
            public System.Func<Amazon.SsmSap.Model.StartApplicationRefreshResponse, StartSMSAPApplicationRefreshCmdlet, object> Select { get; set; } =
