...
namespace Amazon.PowerShell.Cmdlets.LOM
{
    ...
    /// Deletes an alert.
    /// </summary>
    [Cmdlet("Remove", "LOMAlert", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLOMAlertCmdlet : AmazonLookoutMetricsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the alert to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LookoutMetrics.Model.DeleteAlertResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LOMAlert (DeleteAlert)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutMetrics.Model.DeleteAlertResponse, RemoveLOMAlertCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutMetrics.Model.DeleteAlertRequest();
        ...
        private Amazon.LookoutMetrics.Model.DeleteAlertResponse CallAWSServiceOperation(IAmazonLookoutMetrics client, Amazon.LookoutMetrics.Model.DeleteAlertRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Metrics", "DeleteAlert");
            try
            {
                #if DESKTOP
                return client.DeleteAlert(request);
                #elif CORECLR
                return client.DeleteAlertAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AlertArn { get; set; }
            public System.Func<Amazon.LookoutMetrics.Model.DeleteAlertResponse, RemoveLOMAlertCmdlet, object> Select { get; set; } =
