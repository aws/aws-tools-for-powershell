...
namespace Amazon.PowerShell.Cmdlets.LOM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LOMResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLOMResourceTagCmdlet : AmazonLookoutMetricsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Keys to remove from the resource's tags.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LookoutMetrics.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LOMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutMetrics.Model.UntagResourceResponse, RemoveLOMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutMetrics.Model.UntagResourceRequest();
        ...
        private Amazon.LookoutMetrics.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonLookoutMetrics client, Amazon.LookoutMetrics.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Metrics", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LookoutMetrics.Model.UntagResourceResponse, RemoveLOMResourceTagCmdlet, object> Select { get; set; } =
