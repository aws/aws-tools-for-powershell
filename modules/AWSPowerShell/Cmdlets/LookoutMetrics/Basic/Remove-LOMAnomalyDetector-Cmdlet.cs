...
namespace Amazon.PowerShell.Cmdlets.LOM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LOMAnomalyDetector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLOMAnomalyDetectorCmdlet : AmazonLookoutMetricsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the detector to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LOMAnomalyDetector (DeleteAnomalyDetector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorResponse, RemoveLOMAnomalyDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorRequest();
        ...
        private Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorResponse CallAWSServiceOperation(IAmazonLookoutMetrics client, Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Metrics", "DeleteAnomalyDetector");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String AnomalyDetectorArn { get; set; }
            public System.Func<Amazon.LookoutMetrics.Model.DeleteAnomalyDetectorResponse, RemoveLOMAnomalyDetectorCmdlet, object> Select { get; set; } =
