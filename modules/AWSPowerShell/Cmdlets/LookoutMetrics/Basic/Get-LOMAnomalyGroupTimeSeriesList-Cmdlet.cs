...
namespace Amazon.PowerShell.Cmdlets.LOM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LOMAnomalyGroupTimeSeriesList")]
    ...
    public partial class GetLOMAnomalyGroupTimeSeriesListCmdlet : AmazonLookoutMetricsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the measure field.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesResponse).
        /// Specifying the name of a property of type Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesResponse, GetLOMAnomalyGroupTimeSeriesListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesRequest();
        ...
        private Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesResponse CallAWSServiceOperation(IAmazonLookoutMetrics client, Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Metrics", "ListAnomalyGroupTimeSeries");
            try
            {
                #if DESKTOP
                return client.ListAnomalyGroupTimeSeries(request);
                #elif CORECLR
                return client.ListAnomalyGroupTimeSeriesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MetricName { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LookoutMetrics.Model.ListAnomalyGroupTimeSeriesResponse, GetLOMAnomalyGroupTimeSeriesListCmdlet, object> Select { get; set; } =
