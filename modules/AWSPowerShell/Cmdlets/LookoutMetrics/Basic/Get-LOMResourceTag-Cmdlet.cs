...
namespace Amazon.PowerShell.Cmdlets.LOM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.LookoutMetrics.Model.ListTagsForResourceResponse",
        ...
        "The service call response (type Amazon.LookoutMetrics.Model.ListTagsForResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
