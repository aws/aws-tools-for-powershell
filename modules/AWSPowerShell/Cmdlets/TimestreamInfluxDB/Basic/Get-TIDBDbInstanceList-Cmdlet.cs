...
namespace Amazon.PowerShell.Cmdlets.TIDB
{
    ...
    public partial class GetTIDBDbInstanceListCmdlet : AmazonTimestreamInfluxDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TimestreamInfluxDB.Model.ListDbInstancesResponse, GetTIDBDbInstanceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.TimestreamInfluxDB.Model.ListDbInstancesRequest();
        ...
        private Amazon.TimestreamInfluxDB.Model.ListDbInstancesResponse CallAWSServiceOperation(IAmazonTimestreamInfluxDB client, Amazon.TimestreamInfluxDB.Model.ListDbInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Timestream InfluxDB", "ListDbInstances");
            try
            {
                return client.ListDbInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.TimestreamInfluxDB.Model.ListDbInstancesResponse, GetTIDBDbInstanceListCmdlet, object> Select { get; set; } =
