#
# Module manifest for module 'AWS.Tools.MediaTailor'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.MediaTailor.dll'
    ...
    GUID = 'eeca9757-74a2-4107-a04d-23acce174a89'
    ...
    Description = 'The MediaTailor module of AWS Tools for PowerShell lets developers and administrators manage AWS Elemental MediaTailor from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.MediaTailor.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.MediaTailor.Completers.psm1',
        'AWS.Tools.MediaTailor.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.MediaTailor.dll-Help.xml'
    )
