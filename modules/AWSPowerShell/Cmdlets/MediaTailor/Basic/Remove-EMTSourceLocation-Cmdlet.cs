...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    public partial class RemoveEMTSourceLocationCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMTSourceLocation (DeleteSourceLocation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.DeleteSourceLocationResponse, RemoveEMTSourceLocationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.DeleteSourceLocationRequest();
        ...
        private Amazon.MediaTailor.Model.DeleteSourceLocationResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.DeleteSourceLocationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "DeleteSourceLocation");
            try
            {
                #if DESKTOP
                return client.DeleteSourceLocation(request);
                #elif CORECLR
                return client.DeleteSourceLocationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SourceLocationName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.DeleteSourceLocationResponse, RemoveEMTSourceLocationCmdlet, object> Select { get; set; } =
