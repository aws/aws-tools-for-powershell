...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaTailor DescribeChannel API operation.", Operation = new[] {"DescribeChannel"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.DescribeChannelResponse))]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.DescribeChannelResponse",
        "This cmdlet returns an Amazon.MediaTailor.Model.DescribeChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMTChannelCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.DescribeChannelResponse, GetEMTChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.DescribeChannelRequest();
        ...
        private Amazon.MediaTailor.Model.DescribeChannelResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.DescribeChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "DescribeChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ChannelName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.DescribeChannelResponse, GetEMTChannelCmdlet, object> Select { get; set; } =
