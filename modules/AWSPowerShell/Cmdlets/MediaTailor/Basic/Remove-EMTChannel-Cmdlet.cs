...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMTChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor DeleteChannel API operation.", Operation = new[] {"DeleteChannel"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.DeleteChannelResponse))]
    [AWSCmdletOutput("None or Amazon.MediaTailor.Model.DeleteChannelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.MediaTailor.Model.DeleteChannelResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEMTChannelCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMTChannel (DeleteChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.DeleteChannelResponse, RemoveEMTChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.DeleteChannelRequest();
        ...
        private Amazon.MediaTailor.Model.DeleteChannelResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.DeleteChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "DeleteChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ChannelName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.DeleteChannelResponse, RemoveEMTChannelCmdlet, object> Select { get; set; } =
