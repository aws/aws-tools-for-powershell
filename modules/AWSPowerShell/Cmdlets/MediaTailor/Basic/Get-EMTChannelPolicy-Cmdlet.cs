...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// channel.
    /// </summary>
    [Cmdlet("Get", "EMTChannelPolicy")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor GetChannelPolicy API operation.", Operation = new[] {"GetChannelPolicy"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.GetChannelPolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.MediaTailor.Model.GetChannelPolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.MediaTailor.Model.GetChannelPolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMTChannelPolicyCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.GetChannelPolicyResponse, GetEMTChannelPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.GetChannelPolicyRequest();
        ...
        private Amazon.MediaTailor.Model.GetChannelPolicyResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.GetChannelPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "GetChannelPolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ChannelName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.GetChannelPolicyResponse, GetEMTChannelPolicyCmdlet, object> Select { get; set; } =
