...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    [AWSCmdletOutput("Amazon.MediaTailor.Model.Alert or Amazon.MediaTailor.Model.ListAlertsResponse",
        ...
        "The service call response (type Amazon.MediaTailor.Model.ListAlertsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
