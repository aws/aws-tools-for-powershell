...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMTChannelList")]
    [OutputType("Amazon.MediaTailor.Model.Channel")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor ListChannels API operation.", Operation = new[] {"ListChannels"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.ListChannelsResponse))]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.Channel or Amazon.MediaTailor.Model.ListChannelsResponse",
        "This cmdlet returns a collection of Amazon.MediaTailor.Model.Channel objects.",
        "The service call response (type Amazon.MediaTailor.Model.ListChannelsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMTChannelListCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        /// of <c>NextToken</c> in the response to get the next page of results.</para><para>The default value is 100. MediaTailor uses DynamoDB-based pagination, which means
        ...
        /// Use the token to fetch the next page of results.</para><para>For the first <c>ListChannels</c> request, omit this value. For subsequent requests,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.ListChannelsResponse, GetEMTChannelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaTailor.Model.ListChannelsRequest();
        ...
        private Amazon.MediaTailor.Model.ListChannelsResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.ListChannelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "ListChannels");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MediaTailor.Model.ListChannelsResponse, GetEMTChannelListCmdlet, object> Select { get; set; } =
