...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// </summary>
    [Cmdlet("Update", "EMTSourceLocation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaTailor.Model.UpdateSourceLocationResponse")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor UpdateSourceLocation API operation.", Operation = new[] {"UpdateSourceLocation"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.UpdateSourceLocationResponse))]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.UpdateSourceLocationResponse",
        "This cmdlet returns an Amazon.MediaTailor.Model.UpdateSourceLocationResponse object containing multiple properties."
    )]
    public partial class UpdateEMTSourceLocationCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of the segment delivery configurations associated with this resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EMTSourceLocation (UpdateSourceLocation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.UpdateSourceLocationResponse, UpdateEMTSourceLocationCmdlet>(Select) ??
        ...
        private Amazon.MediaTailor.Model.UpdateSourceLocationResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.UpdateSourceLocationRequest request)
        {
            ...
            try
            {
                return client.UpdateSourceLocationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
