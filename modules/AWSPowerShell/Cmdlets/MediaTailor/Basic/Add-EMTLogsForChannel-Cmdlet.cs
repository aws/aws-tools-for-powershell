...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    /// </summary>
    [Cmdlet("Add", "EMTLogsForChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse")]
    [AWSCmdlet("Calls the AWS Elemental MediaTailor ConfigureLogsForChannel API operation.", Operation = new[] {"ConfigureLogsForChannel"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse))]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse",
        "This cmdlet returns an Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddEMTLogsForChannelCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EMTLogsForChannel (ConfigureLogsForChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse, AddEMTLogsForChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.ConfigureLogsForChannelRequest();
        ...
        private Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.ConfigureLogsForChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "ConfigureLogsForChannel");
            try
            {
                #if DESKTOP
                return client.ConfigureLogsForChannel(request);
                #elif CORECLR
                return client.ConfigureLogsForChannelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MediaTailor.Model.ConfigureLogsForChannelResponse, AddEMTLogsForChannelCmdlet, object> Select { get; set; } =
