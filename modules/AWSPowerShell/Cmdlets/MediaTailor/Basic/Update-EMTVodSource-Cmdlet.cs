...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    public partial class UpdateEMTVodSourceCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EMTVodSource (UpdateVodSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.UpdateVodSourceResponse, UpdateEMTVodSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.UpdateVodSourceRequest();
        ...
        private Amazon.MediaTailor.Model.UpdateVodSourceResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.UpdateVodSourceRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SourceLocationName { get; set; }
            public System.String VodSourceName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.UpdateVodSourceResponse, UpdateEMTVodSourceCmdlet, object> Select { get; set; } =
