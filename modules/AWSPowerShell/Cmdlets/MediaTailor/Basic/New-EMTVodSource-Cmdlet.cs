...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaTailor CreateVodSource API operation.", Operation = new[] {"CreateVodSource"}, SelectReturnType = typeof(Amazon.MediaTailor.Model.CreateVodSourceResponse))]
    [AWSCmdletOutput("Amazon.MediaTailor.Model.CreateVodSourceResponse",
        "This cmdlet returns an Amazon.MediaTailor.Model.CreateVodSourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEMTVodSourceCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EMTVodSource (CreateVodSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.CreateVodSourceResponse, NewEMTVodSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.CreateVodSourceRequest();
        ...
        private Amazon.MediaTailor.Model.CreateVodSourceResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.CreateVodSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "CreateVodSource");
            try
            {
                #if DESKTOP
                return client.CreateVodSource(request);
                #elif CORECLR
                return client.CreateVodSourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VodSourceName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.CreateVodSourceResponse, NewEMTVodSourceCmdlet, object> Select { get; set; } =
