...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    public partial class RemoveEMTChannelPolicyCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMTChannelPolicy (DeleteChannelPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.DeleteChannelPolicyResponse, RemoveEMTChannelPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.DeleteChannelPolicyRequest();
        ...
        private Amazon.MediaTailor.Model.DeleteChannelPolicyResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.DeleteChannelPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "DeleteChannelPolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ChannelName { get; set; }
            public System.Func<Amazon.MediaTailor.Model.DeleteChannelPolicyResponse, RemoveEMTChannelPolicyCmdlet, object> Select { get; set; } =
