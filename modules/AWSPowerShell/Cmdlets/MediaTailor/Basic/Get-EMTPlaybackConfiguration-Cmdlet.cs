...
namespace Amazon.PowerShell.Cmdlets.EMT
{
    ...
    public partial class GetEMTPlaybackConfigurationCmdlet : AmazonMediaTailorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaTailor.Model.GetPlaybackConfigurationResponse, GetEMTPlaybackConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaTailor.Model.GetPlaybackConfigurationRequest();
        ...
        private Amazon.MediaTailor.Model.GetPlaybackConfigurationResponse CallAWSServiceOperation(IAmazonMediaTailor client, Amazon.MediaTailor.Model.GetPlaybackConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaTailor", "GetPlaybackConfiguration");
            try
            {
                #if DESKTOP
                return client.GetPlaybackConfiguration(request);
                #elif CORECLR
                return client.GetPlaybackConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.MediaTailor.Model.GetPlaybackConfigurationResponse, GetEMTPlaybackConfigurationCmdlet, object> Select { get; set; } =
