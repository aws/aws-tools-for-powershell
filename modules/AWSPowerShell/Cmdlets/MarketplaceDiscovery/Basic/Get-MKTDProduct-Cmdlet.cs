...
namespace Amazon.PowerShell.Cmdlets.MKTD
{
    ...
    /// </summary>
    [Cmdlet("Get", "MKTDProduct")]
    [OutputType("Amazon.MarketplaceDiscovery.Model.GetProductResponse")]
    [AWSCmdlet("Calls the AWS Marketplace Discovery GetProduct API operation.", Operation = new[] {"GetProduct"}, SelectReturnType = typeof(Amazon.MarketplaceDiscovery.Model.GetProductResponse))]
    [AWSCmdletOutput("Amazon.MarketplaceDiscovery.Model.GetProductResponse",
        "This cmdlet returns an Amazon.MarketplaceDiscovery.Model.GetProductResponse object containing multiple properties."
    )]
    public partial class GetMKTDProductCmdlet : AmazonMarketplaceDiscoveryClientCmdlet, IExecutor
    {
        ...
        private Amazon.MarketplaceDiscovery.Model.GetProductResponse CallAWSServiceOperation(IAmazonMarketplaceDiscovery client, Amazon.MarketplaceDiscovery.Model.GetProductRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Marketplace Discovery", "GetProduct");
            try
            {
                return client.GetProductAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
