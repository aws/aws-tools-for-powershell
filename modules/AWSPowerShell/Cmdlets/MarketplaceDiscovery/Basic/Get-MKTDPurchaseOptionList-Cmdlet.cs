...
namespace Amazon.PowerShell.Cmdlets.MKTD
{
    ...
    /// </summary>
    [Cmdlet("Get", "MKTDPurchaseOptionList")]
    [OutputType("Amazon.MarketplaceDiscovery.Model.PurchaseOptionSummary")]
    [AWSCmdlet("Calls the AWS Marketplace Discovery ListPurchaseOptions API operation.", Operation = new[] {"ListPurchaseOptions"}, SelectReturnType = typeof(Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse))]
    [AWSCmdletOutput("Amazon.MarketplaceDiscovery.Model.PurchaseOptionSummary or Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse",
        "This cmdlet returns a collection of Amazon.MarketplaceDiscovery.Model.PurchaseOptionSummary objects.",
        "The service call response (type Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMKTDPurchaseOptionListCmdlet : AmazonMarketplaceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PurchaseOptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse, GetMKTDPurchaseOptionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsRequest();
        ...
        private Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse CallAWSServiceOperation(IAmazonMarketplaceDiscovery client, Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Marketplace Discovery", "ListPurchaseOptions");
            try
            {
                return client.ListPurchaseOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MarketplaceDiscovery.Model.ListPurchaseOptionsResponse, GetMKTDPurchaseOptionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PurchaseOptions;
        }
