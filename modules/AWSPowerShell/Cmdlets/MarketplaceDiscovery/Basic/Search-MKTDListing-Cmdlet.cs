...
namespace Amazon.PowerShell.Cmdlets.MKTD
{
    ...
    /// </summary>
    [Cmdlet("Search", "MKTDListing", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MarketplaceDiscovery.Model.SearchListingsResponse")]
    [AWSCmdlet("Calls the AWS Marketplace Discovery SearchListings API operation.", Operation = new[] {"SearchListings"}, SelectReturnType = typeof(Amazon.MarketplaceDiscovery.Model.SearchListingsResponse))]
    [AWSCmdletOutput("Amazon.MarketplaceDiscovery.Model.SearchListingsResponse",
        "This cmdlet returns an Amazon.MarketplaceDiscovery.Model.SearchListingsResponse object containing multiple properties."
    )]
    public partial class SearchMKTDListingCmdlet : AmazonMarketplaceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.MarketplaceDiscovery.SearchListingsSortBy")]
        public Amazon.MarketplaceDiscovery.SearchListingsSortBy SortBy { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.MarketplaceDiscovery.SearchListingsSortOrder")]
        public Amazon.MarketplaceDiscovery.SearchListingsSortOrder SortOrder { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-MKTDListing (SearchListings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MarketplaceDiscovery.Model.SearchListingsResponse, SearchMKTDListingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MarketplaceDiscovery.Model.SearchListingsRequest();
        ...
        private Amazon.MarketplaceDiscovery.Model.SearchListingsResponse CallAWSServiceOperation(IAmazonMarketplaceDiscovery client, Amazon.MarketplaceDiscovery.Model.SearchListingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Marketplace Discovery", "SearchListings");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.MarketplaceDiscovery.SearchListingsSortBy SortBy { get; set; }
            public Amazon.MarketplaceDiscovery.SearchListingsSortOrder SortOrder { get; set; }
            public System.Func<Amazon.MarketplaceDiscovery.Model.SearchListingsResponse, SearchMKTDListingCmdlet, object> Select { get; set; } =
