...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    /// </summary>
    [Cmdlet("New", "DAXSubnetGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DAX.Model.SubnetGroup")]
    [AWSCmdlet("Calls the Amazon DynamoDB Accelerator (DAX) CreateSubnetGroup API operation.", Operation = new[] {"CreateSubnetGroup"}, SelectReturnType = typeof(Amazon.DAX.Model.CreateSubnetGroupResponse))]
    [AWSCmdletOutput("Amazon.DAX.Model.SubnetGroup or Amazon.DAX.Model.CreateSubnetGroupResponse",
        "This cmdlet returns an Amazon.DAX.Model.SubnetGroup object.",
        "The service call response (type Amazon.DAX.Model.CreateSubnetGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewDAXSubnetGroupCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DAXSubnetGroup (CreateSubnetGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.CreateSubnetGroupResponse, NewDAXSubnetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DAX.Model.CreateSubnetGroupRequest();
        ...
        private Amazon.DAX.Model.CreateSubnetGroupResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.CreateSubnetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB Accelerator (DAX)", "CreateSubnetGroup");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DAX.Model.CreateSubnetGroupResponse, NewDAXSubnetGroupCmdlet, object> Select { get; set; } =
