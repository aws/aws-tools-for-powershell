...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    [AWSCmdletOutput("Amazon.DAX.Model.SubnetGroup or Amazon.DAX.Model.DescribeSubnetGroupsResponse",
        ...
        "The service call response (type Amazon.DAX.Model.DescribeSubnetGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDAXSubnetGroupCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the subnet group.</para><para />
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SubnetGroups?.Count ?? 0;
