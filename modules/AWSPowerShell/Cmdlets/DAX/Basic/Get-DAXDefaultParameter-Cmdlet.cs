...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    /// </summary>
    [Cmdlet("Get", "DAXDefaultParameter")]
    ...
    public partial class GetDAXDefaultParameterCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.DescribeDefaultParametersResponse, GetDAXDefaultParameterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DAX.Model.DescribeDefaultParametersRequest();
        ...
        private Amazon.DAX.Model.DescribeDefaultParametersResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.DescribeDefaultParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB Accelerator (DAX)", "DescribeDefaultParameters");
            try
            {
                #if DESKTOP
                return client.DescribeDefaultParameters(request);
                #elif CORECLR
                return client.DescribeDefaultParametersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DAX.Model.DescribeDefaultParametersResponse, GetDAXDefaultParameterCmdlet, object> Select { get; set; } =
