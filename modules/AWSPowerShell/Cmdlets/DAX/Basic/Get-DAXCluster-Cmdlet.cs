...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB Accelerator (DAX) DescribeClusters API operation.", Operation = new[] {"DescribeClusters"}, SelectReturnType = typeof(Amazon.DAX.Model.DescribeClustersResponse))]
    [AWSCmdletOutput("Amazon.DAX.Model.Cluster or Amazon.DAX.Model.DescribeClustersResponse",
        "This cmdlet returns a collection of Amazon.DAX.Model.Cluster objects.",
        "The service call response (type Amazon.DAX.Model.DescribeClustersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDAXClusterCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the DAX clusters being described.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.DescribeClustersResponse, GetDAXClusterCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DAX.Model.DescribeClustersResponse, GetDAXClusterCmdlet, object> Select { get; set; } =
