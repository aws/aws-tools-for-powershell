...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    /// </summary>
    [Cmdlet("Get", "DAXParameterGroup")]
    [OutputType("Amazon.DAX.Model.ParameterGroup")]
    [AWSCmdlet("Calls the Amazon DynamoDB Accelerator (DAX) DescribeParameterGroups API operation.", Operation = new[] {"DescribeParameterGroups"}, SelectReturnType = typeof(Amazon.DAX.Model.DescribeParameterGroupsResponse))]
    [AWSCmdletOutput("Amazon.DAX.Model.ParameterGroup or Amazon.DAX.Model.DescribeParameterGroupsResponse",
        "This cmdlet returns a collection of Amazon.DAX.Model.ParameterGroup objects.",
        "The service call response (type Amazon.DAX.Model.DescribeParameterGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDAXParameterGroupCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the parameter groups.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.DescribeParameterGroupsResponse, GetDAXParameterGroupCmdlet>(Select) ??
            ...
            {
                context.ParameterGroupName = new List<System.String>(this.ParameterGroupName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DAX.Model.DescribeParameterGroupsRequest();
            ...
            {
                request.ParameterGroupNames = cmdletContext.ParameterGroupName;
            }
        ...
        private Amazon.DAX.Model.DescribeParameterGroupsResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.DescribeParameterGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB Accelerator (DAX)", "DescribeParameterGroups");
            try
            {
                return client.DescribeParameterGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> ParameterGroupName { get; set; }
            public System.Func<Amazon.DAX.Model.DescribeParameterGroupsResponse, GetDAXParameterGroupCmdlet, object> Select { get; set; } =
