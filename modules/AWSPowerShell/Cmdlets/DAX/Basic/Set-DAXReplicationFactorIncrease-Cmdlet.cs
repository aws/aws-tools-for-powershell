...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    public partial class SetDAXReplicationFactorIncreaseCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        /// if you want to distribute the nodes across multiple AZs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.IncreaseReplicationFactorResponse, SetDAXReplicationFactorIncreaseCmdlet>(Select) ??
        ...
        private Amazon.DAX.Model.IncreaseReplicationFactorResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.IncreaseReplicationFactorRequest request)
        {
            ...
            try
            {
                return client.IncreaseReplicationFactorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClusterName { get; set; }
            public System.Int32? NewReplicationFactor { get; set; }
            public System.Func<Amazon.DAX.Model.IncreaseReplicationFactorResponse, SetDAXReplicationFactorIncreaseCmdlet, object> Select { get; set; } =
