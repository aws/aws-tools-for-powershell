...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB Accelerator (DAX) DescribeParameters API operation.", Operation = new[] {"DescribeParameters"}, SelectReturnType = typeof(Amazon.DAX.Model.DescribeParametersResponse))]
    [AWSCmdletOutput("Amazon.DAX.Model.Parameter or Amazon.DAX.Model.DescribeParametersResponse",
        "This cmdlet returns a collection of Amazon.DAX.Model.Parameter objects.",
        "The service call response (type Amazon.DAX.Model.DescribeParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDAXParameterCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>How the parameter is defined. For example, <c>system</c> denotes a system-defined
        /// parameter.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.DescribeParametersResponse, GetDAXParameterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DAX.Model.DescribeParametersRequest();
        ...
        private Amazon.DAX.Model.DescribeParametersResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.DescribeParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB Accelerator (DAX)", "DescribeParameters");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ParameterGroupName { get; set; }
            public System.String Source { get; set; }
            public System.Func<Amazon.DAX.Model.DescribeParametersResponse, GetDAXParameterCmdlet, object> Select { get; set; } =
