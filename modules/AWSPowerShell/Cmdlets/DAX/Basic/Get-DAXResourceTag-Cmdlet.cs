...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB Accelerator (DAX) ListTags API operation.", Operation = new[] {"ListTags"}, SelectReturnType = typeof(Amazon.DAX.Model.ListTagsResponse))]
    [AWSCmdletOutput("Amazon.DAX.Model.Tag or Amazon.DAX.Model.ListTagsResponse",
        "This cmdlet returns a collection of Amazon.DAX.Model.Tag objects.",
        "The service call response (type Amazon.DAX.Model.ListTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDAXResourceTagCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DAX.Model.ListTagsResponse, GetDAXResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.DAX.Model.ListTagsResponse, GetDAXResourceTagCmdlet, object> Select { get; set; } =
