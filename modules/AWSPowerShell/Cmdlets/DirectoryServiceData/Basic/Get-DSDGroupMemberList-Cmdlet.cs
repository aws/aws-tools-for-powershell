...
namespace Amazon.PowerShell.Cmdlets.DSD
{
    ...
    /// </summary>
    [Cmdlet("Get", "DSDGroupMemberList")]
    [OutputType("Amazon.DirectoryServiceData.Model.ListGroupMembersResponse")]
    [AWSCmdlet("Calls the AWS Directory Service Data ListGroupMembers API operation.", Operation = new[] {"ListGroupMembers"}, SelectReturnType = typeof(Amazon.DirectoryServiceData.Model.ListGroupMembersResponse))]
    [AWSCmdletOutput("Amazon.DirectoryServiceData.Model.ListGroupMembersResponse",
        "This cmdlet returns an Amazon.DirectoryServiceData.Model.ListGroupMembersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSDGroupMemberListCmdlet : AmazonDirectoryServiceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryServiceData.Model.ListGroupMembersResponse, GetDSDGroupMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DirectoryServiceData.Model.ListGroupMembersRequest();
        ...
        private Amazon.DirectoryServiceData.Model.ListGroupMembersResponse CallAWSServiceOperation(IAmazonDirectoryServiceData client, Amazon.DirectoryServiceData.Model.ListGroupMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service Data", "ListGroupMembers");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Realm { get; set; }
            public System.String SAMAccountName { get; set; }
            public System.Func<Amazon.DirectoryServiceData.Model.ListGroupMembersResponse, GetDSDGroupMemberListCmdlet, object> Select { get; set; } =
