...
namespace Amazon.PowerShell.Cmdlets.DSD
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DSDGroupMember", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Directory Service Data RemoveGroupMember API operation.", Operation = new[] {"RemoveGroupMember"}, SelectReturnType = typeof(Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse))]
    [AWSCmdletOutput("None or Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveDSDGroupMemberCmdlet : AmazonDirectoryServiceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DSDGroupMember (RemoveGroupMember)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse, RemoveDSDGroupMemberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryServiceData.Model.RemoveGroupMemberRequest();
        ...
        private Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse CallAWSServiceOperation(IAmazonDirectoryServiceData client, Amazon.DirectoryServiceData.Model.RemoveGroupMemberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service Data", "RemoveGroupMember");
            try
            {
                #if DESKTOP
                return client.RemoveGroupMember(request);
                #elif CORECLR
                return client.RemoveGroupMemberAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemberName { get; set; }
            public System.String MemberRealm { get; set; }
            public System.Func<Amazon.DirectoryServiceData.Model.RemoveGroupMemberResponse, RemoveDSDGroupMemberCmdlet, object> Select { get; set; } =
