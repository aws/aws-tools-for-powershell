...
namespace Amazon.PowerShell.Cmdlets.DSD
{
    ...
    /// Creates a new group.
    /// </summary>
    [Cmdlet("New", "DSDGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewDSDGroupCmdlet : AmazonDirectoryServiceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DSDGroup (CreateGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryServiceData.Model.CreateGroupResponse, NewDSDGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryServiceData.Model.CreateGroupRequest();
        ...
        private Amazon.DirectoryServiceData.Model.CreateGroupResponse CallAWSServiceOperation(IAmazonDirectoryServiceData client, Amazon.DirectoryServiceData.Model.CreateGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service Data", "CreateGroup");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SAMAccountName { get; set; }
            public System.Func<Amazon.DirectoryServiceData.Model.CreateGroupResponse, NewDSDGroupCmdlet, object> Select { get; set; } =
