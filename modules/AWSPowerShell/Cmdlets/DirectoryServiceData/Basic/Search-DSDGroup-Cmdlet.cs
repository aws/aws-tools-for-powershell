...
namespace Amazon.PowerShell.Cmdlets.DSD
{
    ...
    [AWSCmdletOutput("Amazon.DirectoryServiceData.Model.SearchGroupsResponse",
        "This cmdlet returns an Amazon.DirectoryServiceData.Model.SearchGroupsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
