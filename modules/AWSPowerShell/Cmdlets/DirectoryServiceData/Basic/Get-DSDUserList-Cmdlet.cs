...
namespace Amazon.PowerShell.Cmdlets.DSD
{
    ...
    /// </summary>
    [Cmdlet("Get", "DSDUserList")]
    [OutputType("Amazon.DirectoryServiceData.Model.ListUsersResponse")]
    [AWSCmdlet("Calls the AWS Directory Service Data ListUsers API operation.", Operation = new[] {"ListUsers"}, SelectReturnType = typeof(Amazon.DirectoryServiceData.Model.ListUsersResponse))]
    [AWSCmdletOutput("Amazon.DirectoryServiceData.Model.ListUsersResponse",
        "This cmdlet returns an Amazon.DirectoryServiceData.Model.ListUsersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSDUserListCmdlet : AmazonDirectoryServiceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryServiceData.Model.ListUsersResponse, GetDSDUserListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DirectoryServiceData.Model.ListUsersRequest();
        ...
        private Amazon.DirectoryServiceData.Model.ListUsersResponse CallAWSServiceOperation(IAmazonDirectoryServiceData client, Amazon.DirectoryServiceData.Model.ListUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service Data", "ListUsers");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String Realm { get; set; }
            public System.Func<Amazon.DirectoryServiceData.Model.ListUsersResponse, GetDSDUserListCmdlet, object> Select { get; set; } =
