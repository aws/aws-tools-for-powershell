...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    /// </summary>
    [Cmdlet("Get", "CSTResourceList")]
    [OutputType("Amazon.CodeStar.Model.Resource")]
    [AWSCmdlet("Invokes the ListResources operation against AWS CodeStar.", Operation = new[] {"ListResources"})]
    [AWSCmdletOutput("Amazon.CodeStar.Model.Resource",
        "This cmdlet returns a collection of Resource objects.",
        "The service call response (type Amazon.CodeStar.Model.ListResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetCSTResourceListCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeStar.Model.ListResourcesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Resources;
        ...
        private Amazon.CodeStar.Model.ListResourcesResponse CallAWSServiceOperation(IAmazonCodeStar client, Amazon.CodeStar.Model.ListResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar", "ListResources");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListResourcesAsync(request);
                return task.Result;
                #else
