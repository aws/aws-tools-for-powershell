...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    public partial class GetCSTTeamMemberListCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeStar.Model.ListTeamMembersRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TeamMembers;
                        ...
                        int _receivedThisCall = response.TeamMembers.Count;
        ...
        private Amazon.CodeStar.Model.ListTeamMembersResponse CallAWSServiceOperation(IAmazonCodeStar client, Amazon.CodeStar.Model.ListTeamMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar", "ListTeamMembers");
            try
            {
                #if DESKTOP
                return client.ListTeamMembers(request);
                #elif CORECLR
                return client.ListTeamMembersAsync(request).GetAwaiter().GetResult();
                #else
