...
namespace Amazon.PowerShell.Cmdlets.KINA
{
    ...
    [AWSCmdlet("Invokes the AddApplicationCloudWatchLoggingOption operation against Amazon Kinesis Analytics.", Operation = new[] {"AddApplicationCloudWatchLoggingOption"})]
