...
namespace Amazon.PowerShell.Cmdlets.KINA
{
    ...
    public partial class StopKINAApplicationCmdlet : AmazonKinesisAnalyticsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-KINAApplication (StopApplication)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KinesisAnalytics.Model.StopApplicationRequest();
        ...
        private Amazon.KinesisAnalytics.Model.StopApplicationResponse CallAWSServiceOperation(IAmazonKinesisAnalytics client, Amazon.KinesisAnalytics.Model.StopApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics", "StopApplication");
            try
            {
                #if DESKTOP
