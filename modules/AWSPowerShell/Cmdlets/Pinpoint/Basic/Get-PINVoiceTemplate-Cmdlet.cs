...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINVoiceTemplate")]
    [OutputType("Amazon.Pinpoint.Model.VoiceTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetVoiceTemplate API operation.", Operation = new[] {"GetVoiceTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetVoiceTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.VoiceTemplateResponse or Amazon.Pinpoint.Model.GetVoiceTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.VoiceTemplateResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetVoiceTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINVoiceTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VoiceTemplateResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetVoiceTemplateResponse, GetPINVoiceTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetVoiceTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.GetVoiceTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetVoiceTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetVoiceTemplate");
            try
            {
                #if DESKTOP
                return client.GetVoiceTemplate(request);
                #elif CORECLR
                return client.GetVoiceTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetVoiceTemplateResponse, GetPINVoiceTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VoiceTemplateResponse;
        }
