...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINTemplateVersionList")]
    [OutputType("Amazon.Pinpoint.Model.TemplateVersionsResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint ListTemplateVersions API operation.", Operation = new[] {"ListTemplateVersions"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.ListTemplateVersionsResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.TemplateVersionsResponse or Amazon.Pinpoint.Model.ListTemplateVersionsResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.TemplateVersionsResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.ListTemplateVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINTemplateVersionListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TemplateVersionsResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.ListTemplateVersionsResponse, GetPINTemplateVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.ListTemplateVersionsRequest();
        ...
        private Amazon.Pinpoint.Model.ListTemplateVersionsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.ListTemplateVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "ListTemplateVersions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TemplateName { get; set; }
            public System.String TemplateType { get; set; }
            public System.Func<Amazon.Pinpoint.Model.ListTemplateVersionsResponse, GetPINTemplateVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TemplateVersionsResponse;
        }
