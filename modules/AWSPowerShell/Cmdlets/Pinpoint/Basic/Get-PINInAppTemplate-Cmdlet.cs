...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// the in-app channel.
    /// </summary>
    [Cmdlet("Get", "PINInAppTemplate")]
    [OutputType("Amazon.Pinpoint.Model.InAppTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetInAppTemplate API operation.", Operation = new[] {"GetInAppTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetInAppTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.InAppTemplateResponse or Amazon.Pinpoint.Model.GetInAppTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.InAppTemplateResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetInAppTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINInAppTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'InAppTemplateResponse'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Pinpoint.Model.GetInAppTemplateResponse).
        /// Specifying the name of a property of type Amazon.Pinpoint.Model.GetInAppTemplateResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InAppTemplateResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetInAppTemplateResponse, GetPINInAppTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetInAppTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.GetInAppTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetInAppTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetInAppTemplate");
            try
            {
                #if DESKTOP
                return client.GetInAppTemplate(request);
                #elif CORECLR
                return client.GetInAppTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetInAppTemplateResponse, GetPINInAppTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InAppTemplateResponse;
        }
