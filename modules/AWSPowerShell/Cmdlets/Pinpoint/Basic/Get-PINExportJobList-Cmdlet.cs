...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint GetExportJobs API operation.", Operation = new[] {"GetExportJobs"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetExportJobsResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.ExportJobsResponse or Amazon.Pinpoint.Model.GetExportJobsResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.ExportJobsResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetExportJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINExportJobListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ExportJobsResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetExportJobsResponse, GetPINExportJobListCmdlet>(Select) ??
        ...
        private Amazon.Pinpoint.Model.GetExportJobsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetExportJobsRequest request)
        {
            ...
            try
            {
                return client.GetExportJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageSize { get; set; }
            public System.String Token { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetExportJobsResponse, GetPINExportJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ExportJobsResponse;
        }
