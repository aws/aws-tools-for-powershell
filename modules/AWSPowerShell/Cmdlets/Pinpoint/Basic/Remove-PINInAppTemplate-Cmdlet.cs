...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PINInAppTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Pinpoint.Model.MessageBody")]
    [AWSCmdlet("Calls the Amazon Pinpoint DeleteInAppTemplate API operation.", Operation = new[] {"DeleteInAppTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.DeleteInAppTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.MessageBody or Amazon.Pinpoint.Model.DeleteInAppTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.MessageBody object.",
        "The service call response (type Amazon.Pinpoint.Model.DeleteInAppTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePINInAppTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Pinpoint.Model.DeleteInAppTemplateResponse).
        /// Specifying the name of a property of type Amazon.Pinpoint.Model.DeleteInAppTemplateResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINInAppTemplate (DeleteInAppTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeleteInAppTemplateResponse, RemovePINInAppTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeleteInAppTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.DeleteInAppTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteInAppTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeleteInAppTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteInAppTemplate(request);
                #elif CORECLR
                return client.DeleteInAppTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeleteInAppTemplateResponse, RemovePINInAppTemplateCmdlet, object> Select { get; set; } =
