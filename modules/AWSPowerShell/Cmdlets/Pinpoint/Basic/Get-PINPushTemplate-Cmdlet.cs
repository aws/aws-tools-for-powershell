...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINPushTemplate")]
    [OutputType("Amazon.Pinpoint.Model.PushNotificationTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetPushTemplate API operation.", Operation = new[] {"GetPushTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetPushTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.PushNotificationTemplateResponse or Amazon.Pinpoint.Model.GetPushTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.PushNotificationTemplateResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetPushTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINPushTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PushNotificationTemplateResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetPushTemplateResponse, GetPINPushTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetPushTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.GetPushTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetPushTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetPushTemplate");
            try
            {
                #if DESKTOP
                return client.GetPushTemplate(request);
                #elif CORECLR
                return client.GetPushTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetPushTemplateResponse, GetPINPushTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PushNotificationTemplateResponse;
        }
