...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint GetGcmChannel API operation.", Operation = new[] {"GetGcmChannel"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetGcmChannelResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.GCMChannelResponse or Amazon.Pinpoint.Model.GetGcmChannelResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.GCMChannelResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetGcmChannelResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINGcmChannelCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetGcmChannelResponse, GetPINGcmChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetGcmChannelRequest();
        ...
        private Amazon.Pinpoint.Model.GetGcmChannelResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetGcmChannelRequest request)
        {
            ...
            try
            {
                return client.GetGcmChannelAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ApplicationId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetGcmChannelResponse, GetPINGcmChannelCmdlet, object> Select { get; set; } =
