...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PINSmsTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Pinpoint.Model.MessageBody")]
    [AWSCmdlet("Calls the Amazon Pinpoint DeleteSmsTemplate API operation.", Operation = new[] {"DeleteSmsTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.DeleteSmsTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.MessageBody or Amazon.Pinpoint.Model.DeleteSmsTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.MessageBody object.",
        "The service call response (type Amazon.Pinpoint.Model.DeleteSmsTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePINSmsTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINSmsTemplate (DeleteSmsTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeleteSmsTemplateResponse, RemovePINSmsTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeleteSmsTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.DeleteSmsTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteSmsTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeleteSmsTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteSmsTemplate(request);
                #elif CORECLR
                return client.DeleteSmsTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeleteSmsTemplateResponse, RemovePINSmsTemplateCmdlet, object> Select { get; set; } =
