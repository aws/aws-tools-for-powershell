...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PINRecommenderConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Pinpoint.Model.RecommenderConfigurationResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint DeleteRecommenderConfiguration API operation.", Operation = new[] {"DeleteRecommenderConfiguration"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.RecommenderConfigurationResponse or Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.RecommenderConfigurationResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePINRecommenderConfigurationCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINRecommenderConfiguration (DeleteRecommenderConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse, RemovePINRecommenderConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeleteRecommenderConfigurationRequest();
        ...
        private Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteRecommenderConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeleteRecommenderConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteRecommenderConfiguration(request);
                #elif CORECLR
                return client.DeleteRecommenderConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RecommenderId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeleteRecommenderConfigurationResponse, RemovePINRecommenderConfigurationCmdlet, object> Select { get; set; } =
