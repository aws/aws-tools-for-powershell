...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINEmailTemplate")]
    [OutputType("Amazon.Pinpoint.Model.EmailTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetEmailTemplate API operation.", Operation = new[] {"GetEmailTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetEmailTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.EmailTemplateResponse or Amazon.Pinpoint.Model.GetEmailTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.EmailTemplateResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetEmailTemplateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINEmailTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EmailTemplateResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetEmailTemplateResponse, GetPINEmailTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetEmailTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.GetEmailTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetEmailTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetEmailTemplate");
            try
            {
                return client.GetEmailTemplateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetEmailTemplateResponse, GetPINEmailTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EmailTemplateResponse;
        }
