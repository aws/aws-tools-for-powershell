...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINCampaignDateRangeKpi")]
    [OutputType("Amazon.Pinpoint.Model.CampaignDateRangeKpiResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetCampaignDateRangeKpi API operation.", Operation = new[] {"GetCampaignDateRangeKpi"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.CampaignDateRangeKpiResponse or Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.CampaignDateRangeKpiResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINCampaignDateRangeKpiCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CampaignDateRangeKpiResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse, GetPINCampaignDateRangeKpiCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetCampaignDateRangeKpiRequest();
        ...
        private Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetCampaignDateRangeKpiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetCampaignDateRangeKpi");
            try
            {
                #if DESKTOP
                return client.GetCampaignDateRangeKpi(request);
                #elif CORECLR
                return client.GetCampaignDateRangeKpiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageSize { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetCampaignDateRangeKpiResponse, GetPINCampaignDateRangeKpiCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CampaignDateRangeKpiResponse;
        }
