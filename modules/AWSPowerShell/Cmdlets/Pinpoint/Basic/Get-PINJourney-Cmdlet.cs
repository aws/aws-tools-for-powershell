...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINJourney")]
    [OutputType("Amazon.Pinpoint.Model.JourneyResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetJourney API operation.", Operation = new[] {"GetJourney"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetJourneyResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.JourneyResponse or Amazon.Pinpoint.Model.GetJourneyResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.JourneyResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetJourneyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINJourneyCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetJourneyResponse, GetPINJourneyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetJourneyRequest();
        ...
        private Amazon.Pinpoint.Model.GetJourneyResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetJourneyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetJourney");
            try
            {
                #if DESKTOP
                return client.GetJourney(request);
                #elif CORECLR
                return client.GetJourneyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String JourneyId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetJourneyResponse, GetPINJourneyCmdlet, object> Select { get; set; } =
