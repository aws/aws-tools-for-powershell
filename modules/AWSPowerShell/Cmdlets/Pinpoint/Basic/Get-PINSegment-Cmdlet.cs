...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINSegment")]
    [OutputType("Amazon.Pinpoint.Model.SegmentResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetSegment API operation.", Operation = new[] {"GetSegment"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetSegmentResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.SegmentResponse or Amazon.Pinpoint.Model.GetSegmentResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.SegmentResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetSegmentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINSegmentCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetSegmentResponse, GetPINSegmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetSegmentRequest();
        ...
        private Amazon.Pinpoint.Model.GetSegmentResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetSegmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetSegment");
            try
            {
                return client.GetSegmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String SegmentId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetSegmentResponse, GetPINSegmentCmdlet, object> Select { get; set; } =
