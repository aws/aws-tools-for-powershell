...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// channel.
    /// </summary>
    [Cmdlet("Remove", "PINPushTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Pinpoint.Model.MessageBody")]
    [AWSCmdlet("Calls the Amazon Pinpoint DeletePushTemplate API operation.", Operation = new[] {"DeletePushTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.DeletePushTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.MessageBody or Amazon.Pinpoint.Model.DeletePushTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.MessageBody object.",
        "The service call response (type Amazon.Pinpoint.Model.DeletePushTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePINPushTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINPushTemplate (DeletePushTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeletePushTemplateResponse, RemovePINPushTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeletePushTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.DeletePushTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeletePushTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeletePushTemplate");
            try
            {
                #if DESKTOP
                return client.DeletePushTemplate(request);
                #elif CORECLR
                return client.DeletePushTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeletePushTemplateResponse, RemovePINPushTemplateCmdlet, object> Select { get; set; } =
