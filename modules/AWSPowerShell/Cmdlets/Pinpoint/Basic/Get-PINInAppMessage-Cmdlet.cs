...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINInAppMessage")]
    [OutputType("Amazon.Pinpoint.Model.InAppMessagesResponse")]
    ...
    public partial class GetPINInAppMessageCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'InAppMessagesResponse'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Pinpoint.Model.GetInAppMessagesResponse).
        /// Specifying the name of a property of type Amazon.Pinpoint.Model.GetInAppMessagesResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InAppMessagesResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetInAppMessagesResponse, GetPINInAppMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetInAppMessagesRequest();
        ...
        private Amazon.Pinpoint.Model.GetInAppMessagesResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetInAppMessagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetInAppMessages");
            try
            {
                #if DESKTOP
                return client.GetInAppMessages(request);
                #elif CORECLR
                return client.GetInAppMessagesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String EndpointId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetInAppMessagesResponse, GetPINInAppMessageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InAppMessagesResponse;
        }
