...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// to a journey.
    /// </summary>
    [Cmdlet("Get", "PINJourneyDateRangeKpi")]
    [OutputType("Amazon.Pinpoint.Model.JourneyDateRangeKpiResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetJourneyDateRangeKpi API operation.", Operation = new[] {"GetJourneyDateRangeKpi"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.JourneyDateRangeKpiResponse or Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.JourneyDateRangeKpiResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINJourneyDateRangeKpiCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse, GetPINJourneyDateRangeKpiCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetJourneyDateRangeKpiRequest();
        ...
        private Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetJourneyDateRangeKpiRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageSize { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetJourneyDateRangeKpiResponse, GetPINJourneyDateRangeKpiCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.JourneyDateRangeKpiResponse;
        }
