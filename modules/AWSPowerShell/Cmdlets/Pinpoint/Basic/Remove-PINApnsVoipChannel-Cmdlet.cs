...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    public partial class RemovePINApnsVoipChannelCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeleteApnsVoipChannelResponse, RemovePINApnsVoipChannelCmdlet>(Select) ??
        ...
        private Amazon.Pinpoint.Model.DeleteApnsVoipChannelResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteApnsVoipChannelRequest request)
        {
            ...
            try
            {
                return client.DeleteApnsVoipChannelAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ApplicationId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeleteApnsVoipChannelResponse, RemovePINApnsVoipChannelCmdlet, object> Select { get; set; } =
