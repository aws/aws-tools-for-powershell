...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    public partial class GetPINApplicationSettingListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetApplicationSettingsResponse, GetPINApplicationSettingListCmdlet>(Select) ??
        ...
        private Amazon.Pinpoint.Model.GetApplicationSettingsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetApplicationSettingsRequest request)
        {
            ...
            try
            {
                return client.GetApplicationSettingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ApplicationId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetApplicationSettingsResponse, GetPINApplicationSettingListCmdlet, object> Select { get; set; } =
