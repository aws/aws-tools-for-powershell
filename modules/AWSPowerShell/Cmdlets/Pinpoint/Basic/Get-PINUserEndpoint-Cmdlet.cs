...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint GetUserEndpoints API operation.", Operation = new[] {"GetUserEndpoints"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetUserEndpointsResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.EndpointsResponse or Amazon.Pinpoint.Model.GetUserEndpointsResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.EndpointsResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetUserEndpointsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINUserEndpointCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EndpointsResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetUserEndpointsResponse, GetPINUserEndpointCmdlet>(Select) ??
        ...
        private Amazon.Pinpoint.Model.GetUserEndpointsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetUserEndpointsRequest request)
        {
            ...
            try
            {
                return client.GetUserEndpointsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetUserEndpointsResponse, GetPINUserEndpointCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EndpointsResponse;
        }
