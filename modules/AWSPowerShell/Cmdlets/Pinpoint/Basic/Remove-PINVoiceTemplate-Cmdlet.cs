...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PINVoiceTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Pinpoint.Model.MessageBody")]
    [AWSCmdlet("Calls the Amazon Pinpoint DeleteVoiceTemplate API operation.", Operation = new[] {"DeleteVoiceTemplate"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.MessageBody or Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.MessageBody object.",
        "The service call response (type Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePINVoiceTemplateCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINVoiceTemplate (DeleteVoiceTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse, RemovePINVoiceTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeleteVoiceTemplateRequest();
        ...
        private Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteVoiceTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeleteVoiceTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteVoiceTemplate(request);
                #elif CORECLR
                return client.DeleteVoiceTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.Pinpoint.Model.DeleteVoiceTemplateResponse, RemovePINVoiceTemplateCmdlet, object> Select { get; set; } =
