...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint GetCampaignActivities API operation.", Operation = new[] {"GetCampaignActivities"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetCampaignActivitiesResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.ActivitiesResponse or Amazon.Pinpoint.Model.GetCampaignActivitiesResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.ActivitiesResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetCampaignActivitiesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINCampaignActivityListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ActivitiesResponse";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetCampaignActivitiesResponse, GetPINCampaignActivityListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.GetCampaignActivitiesRequest();
        ...
        private Amazon.Pinpoint.Model.GetCampaignActivitiesResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetCampaignActivitiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "GetCampaignActivities");
            try
            {
                #if DESKTOP
                return client.GetCampaignActivities(request);
                #elif CORECLR
                return client.GetCampaignActivitiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageSize { get; set; }
            public System.String Token { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetCampaignActivitiesResponse, GetPINCampaignActivityListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ActivitiesResponse;
        }
