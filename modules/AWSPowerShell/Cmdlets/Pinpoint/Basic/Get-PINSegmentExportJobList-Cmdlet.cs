...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINSegmentExportJobList")]
    [OutputType("Amazon.Pinpoint.Model.ExportJobsResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint GetSegmentExportJobs API operation.", Operation = new[] {"GetSegmentExportJobs"}, SelectReturnType = typeof(Amazon.Pinpoint.Model.GetSegmentExportJobsResponse))]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.ExportJobsResponse or Amazon.Pinpoint.Model.GetSegmentExportJobsResponse",
        "This cmdlet returns an Amazon.Pinpoint.Model.ExportJobsResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.GetSegmentExportJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPINSegmentExportJobListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pinpoint.Model.GetSegmentExportJobsResponse, GetPINSegmentExportJobListCmdlet>(Select) ??
        ...
        private Amazon.Pinpoint.Model.GetSegmentExportJobsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetSegmentExportJobsRequest request)
        {
            ...
            try
            {
                return client.GetSegmentExportJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SegmentId { get; set; }
            public System.String Token { get; set; }
            public System.Func<Amazon.Pinpoint.Model.GetSegmentExportJobsResponse, GetPINSegmentExportJobListCmdlet, object> Select { get; set; } =
