...
namespace Amazon.PowerShell.Cmdlets.EMP
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaPackage CreateChannel API operation.", Operation = new[] {"CreateChannel"})]
    [AWSCmdletOutput("Amazon.MediaPackage.Model.CreateChannelResponse",
        "This cmdlet returns a Amazon.MediaPackage.Model.CreateChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
