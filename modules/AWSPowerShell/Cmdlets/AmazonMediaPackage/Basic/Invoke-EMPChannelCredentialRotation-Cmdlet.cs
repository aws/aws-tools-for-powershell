...
namespace Amazon.PowerShell.Cmdlets.EMP
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaPackage RotateChannelCredentials API operation.", Operation = new[] {"RotateChannelCredentials"})]
    ...
    public partial class InvokeEMPChannelCredentialRotationCmdlet : AmazonMediaPackageClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-EMPChannelCredentialRotation (RotateChannelCredentials)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackage.Model.RotateChannelCredentialsRequest();
        ...
        private Amazon.MediaPackage.Model.RotateChannelCredentialsResponse CallAWSServiceOperation(IAmazonMediaPackage client, Amazon.MediaPackage.Model.RotateChannelCredentialsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage", "RotateChannelCredentials");
            try
            {
                #if DESKTOP
                return client.RotateChannelCredentials(request);
                #elif CORECLR
                return client.RotateChannelCredentialsAsync(request).GetAwaiter().GetResult();
                #else
