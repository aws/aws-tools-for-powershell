...
namespace Amazon.PowerShell.Cmdlets.EMP
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaPackage DescribeChannel API operation.", Operation = new[] {"DescribeChannel"})]
    [AWSCmdletOutput("Amazon.MediaPackage.Model.DescribeChannelResponse",
        "This cmdlet returns a Amazon.MediaPackage.Model.DescribeChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
