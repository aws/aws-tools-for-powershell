...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdlet("Calls the Amazon Transcribe Service GetMedicalTranscriptionJob API operation.", Operation = new[] {"GetMedicalTranscriptionJob"}, SelectReturnType = typeof(Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse))]
    [AWSCmdletOutput("Amazon.TranscribeService.Model.MedicalTranscriptionJob or Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse",
        "This cmdlet returns an Amazon.TranscribeService.Model.MedicalTranscriptionJob object.",
        "The service call response (type Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRSMedicalTranscriptionJobCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse, GetTRSMedicalTranscriptionJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.GetMedicalTranscriptionJobRequest();
        ...
        private Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.GetMedicalTranscriptionJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "GetMedicalTranscriptionJob");
            try
            {
                #if DESKTOP
                return client.GetMedicalTranscriptionJob(request);
                #elif CORECLR
                return client.GetMedicalTranscriptionJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MedicalTranscriptionJobName { get; set; }
            public System.Func<Amazon.TranscribeService.Model.GetMedicalTranscriptionJobResponse, GetTRSMedicalTranscriptionJobCmdlet, object> Select { get; set; } =
