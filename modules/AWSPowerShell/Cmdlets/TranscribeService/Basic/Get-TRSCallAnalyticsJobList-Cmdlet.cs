...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "TRSCallAnalyticsJobList")]
    [OutputType("Amazon.TranscribeService.Model.CallAnalyticsJobSummary")]
    [AWSCmdlet("Calls the Amazon Transcribe Service ListCallAnalyticsJobs API operation.", Operation = new[] {"ListCallAnalyticsJobs"}, SelectReturnType = typeof(Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse))]
    [AWSCmdletOutput("Amazon.TranscribeService.Model.CallAnalyticsJobSummary or Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse",
        "This cmdlet returns a collection of Amazon.TranscribeService.Model.CallAnalyticsJobSummary objects.",
        "The service call response (type Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRSCallAnalyticsJobListCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your <c>ListCallAnalyticsJobs</c> request returns more results than can be displayed,
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.TranscribeService.CallAnalyticsJobStatus")]
        public Amazon.TranscribeService.CallAnalyticsJobStatus Status { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CallAnalyticsJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse, GetTRSCallAnalyticsJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.TranscribeService.Model.ListCallAnalyticsJobsRequest();
        ...
        private Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.ListCallAnalyticsJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "ListCallAnalyticsJobs");
            try
            {
                #if DESKTOP
                return client.ListCallAnalyticsJobs(request);
                #elif CORECLR
                return client.ListCallAnalyticsJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.TranscribeService.CallAnalyticsJobStatus Status { get; set; }
            public System.Func<Amazon.TranscribeService.Model.ListCallAnalyticsJobsResponse, GetTRSCallAnalyticsJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CallAnalyticsJobSummaries;
        }
