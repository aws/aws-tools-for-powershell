...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class RemoveTRSLanguageModelCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TRSLanguageModel (DeleteLanguageModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.DeleteLanguageModelResponse, RemoveTRSLanguageModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.DeleteLanguageModelRequest();
        ...
        private Amazon.TranscribeService.Model.DeleteLanguageModelResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.DeleteLanguageModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "DeleteLanguageModel");
            try
            {
                #if DESKTOP
                return client.DeleteLanguageModel(request);
                #elif CORECLR
                return client.DeleteLanguageModelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.TranscribeService.Model.DeleteLanguageModelResponse, RemoveTRSLanguageModelCmdlet, object> Select { get; set; } =
