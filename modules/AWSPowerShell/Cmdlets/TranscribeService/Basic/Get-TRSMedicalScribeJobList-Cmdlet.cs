...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdletOutput("Amazon.TranscribeService.Model.MedicalScribeJobSummary or Amazon.TranscribeService.Model.ListMedicalScribeJobsResponse",
        ...
        "The service call response (type Amazon.TranscribeService.Model.ListMedicalScribeJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRSMedicalScribeJobListCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your <code>ListMedicalScribeJobs</code> request returns more results than can be
