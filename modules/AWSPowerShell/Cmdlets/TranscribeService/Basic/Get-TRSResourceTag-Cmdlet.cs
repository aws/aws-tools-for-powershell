...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class GetTRSResourceTagCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// ARNs have the format <c>arn:partition:service:region:account-id:resource-type/resource-id</c>.</para><para>For example, <c>arn:aws:transcribe:us-west-2:111122223333:transcription-job/transcription-job-name</c>.</para><para>Valid values for <c>resource-type</c> are: <c>transcription-job</c>, <c>medical-transcription-job</c>,
        /// <c>vocabulary</c>, <c>medical-vocabulary</c>, <c>vocabulary-filter</c>, and <c>language-model</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.ListTagsForResourceResponse, GetTRSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.ListTagsForResourceRequest();
        ...
        private Amazon.TranscribeService.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.TranscribeService.Model.ListTagsForResourceResponse, GetTRSResourceTagCmdlet, object> Select { get; set; } =
