...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class GetTRSTranscriptionJobListCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your <c>ListTranscriptionJobs</c> request returns more results than can be displayed,
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TranscriptionJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.ListTranscriptionJobsResponse, GetTRSTranscriptionJobListCmdlet>(Select) ??
        ...
        private Amazon.TranscribeService.Model.ListTranscriptionJobsResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.ListTranscriptionJobsRequest request)
        {
            ...
            try
            {
                return client.ListTranscriptionJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.TranscribeService.TranscriptionJobStatus Status { get; set; }
            public System.Func<Amazon.TranscribeService.Model.ListTranscriptionJobsResponse, GetTRSTranscriptionJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TranscriptionJobSummaries;
        }
