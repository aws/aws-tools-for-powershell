...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class AddTRSResourceTagCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <c>arn:partition:service:region:account-id:resource-type/resource-id</c>.</para><para>For example, <c>arn:aws:transcribe:us-west-2:111122223333:transcription-job/transcription-job-name</c>.</para><para>Valid values for <c>resource-type</c> are: <c>transcription-job</c>, <c>medical-transcription-job</c>,
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-TRSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.TagResourceResponse, AddTRSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.TagResourceRequest();
        ...
        private Amazon.TranscribeService.Model.TagResourceResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.TranscribeService.Model.TagResourceResponse, AddTRSResourceTagCmdlet, object> Select { get; set; } =
