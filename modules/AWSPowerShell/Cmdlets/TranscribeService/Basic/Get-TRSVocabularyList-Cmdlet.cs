...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdlet("Calls the Amazon Transcribe Service ListVocabularies API operation.", Operation = new[] {"ListVocabularies"}, SelectReturnType = typeof(Amazon.TranscribeService.Model.ListVocabulariesResponse))]
    [AWSCmdletOutput("Amazon.TranscribeService.Model.VocabularyInfo or Amazon.TranscribeService.Model.ListVocabulariesResponse",
        "This cmdlet returns a collection of Amazon.TranscribeService.Model.VocabularyInfo objects.",
        "The service call response (type Amazon.TranscribeService.Model.ListVocabulariesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetTRSVocabularyListCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your <c>ListVocabularies</c> request returns more results than can be displayed,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.ListVocabulariesResponse, GetTRSVocabularyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.TranscribeService.Model.ListVocabulariesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Vocabularies?.Count ?? 0;
        ...
        private Amazon.TranscribeService.Model.ListVocabulariesResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.ListVocabulariesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "ListVocabularies");
            try
            {
                return client.ListVocabulariesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.TranscribeService.VocabularyState StateEqual { get; set; }
            public System.Func<Amazon.TranscribeService.Model.ListVocabulariesResponse, GetTRSVocabularyListCmdlet, object> Select { get; set; } =
