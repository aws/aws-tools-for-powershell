...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdletOutput("Amazon.TranscribeService.Model.VocabularyInfo or Amazon.TranscribeService.Model.ListVocabulariesResponse",
        ...
        "The service call response (type Amazon.TranscribeService.Model.ListVocabulariesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
