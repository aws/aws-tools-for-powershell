...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Transcribe Service DeleteTranscriptionJob API operation.", Operation = new[] {"DeleteTranscriptionJob"}, SelectReturnType = typeof(Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse))]
    [AWSCmdletOutput("None or Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveTRSTranscriptionJobCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TRSTranscriptionJob (DeleteTranscriptionJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse, RemoveTRSTranscriptionJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.DeleteTranscriptionJobRequest();
        ...
        private Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.DeleteTranscriptionJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "DeleteTranscriptionJob");
            try
            {
                return client.DeleteTranscriptionJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String TranscriptionJobName { get; set; }
            public System.Func<Amazon.TranscribeService.Model.DeleteTranscriptionJobResponse, RemoveTRSTranscriptionJobCmdlet, object> Select { get; set; } =
