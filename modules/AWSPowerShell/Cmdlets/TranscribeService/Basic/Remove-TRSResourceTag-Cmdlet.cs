...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class RemoveTRSResourceTagCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Removes the specified tag keys from the specified Amazon Transcribe resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TRSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TranscribeService.Model.UntagResourceResponse, RemoveTRSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TranscribeService.Model.UntagResourceRequest();
        ...
        private Amazon.TranscribeService.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Transcribe Service", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.TranscribeService.Model.UntagResourceResponse, RemoveTRSResourceTagCmdlet, object> Select { get; set; } =
