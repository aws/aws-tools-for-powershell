...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    public partial class StartTRSTranscriptionJobCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        /// and SubRip (<c>srt</c>) formats, two output files are generated.</para><para />
        ...
        /// languages</a> table.</para><note><para>To transcribe speech in Modern Standard Arabic (<c>ar-SA</c>) in Amazon Web Services
        ...
        /// media file must be encoded at a sample rate of 16,000 Hz or higher.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <c>VocabularyName</c> or <c>VocabularyFilterName</c> (or both) sub-parameter.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// languages</a>.</para><para>To transcribe speech in Modern Standard Arabic (<c>ar-SA</c>)in Amazon Web Services
        /// GovCloud (US) (US-West, us-gov-west-1), Amazon Web Services GovCloud (US) (US-East,
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of a KMS key that you want to use to encrypt your transcription
        /// output.</para><para>KMS key ARNs have the format <c>arn:partition:kms:region:account:key/key-id</c>. For
        ...
        private Amazon.TranscribeService.Model.StartTranscriptionJobResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.StartTranscriptionJobRequest request)
        {
            ...
            try
            {
                return client.StartTranscriptionJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
