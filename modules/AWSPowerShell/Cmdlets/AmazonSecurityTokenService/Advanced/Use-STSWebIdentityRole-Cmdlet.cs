...
namespace Amazon.PowerShell.Cmdlets.STS
{
    ...
    [AWSCmdlet("Calls the AWS Security Token Service AssumeRoleWithWebIdentity API operation.", Operation = new[] { "AssumeRoleWithWebIdentity" })]
    ...
    public class UseSTSWebIdentityRoleCmdlet : BaseCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                output = new CmdletOutput { PipelineOutput = sessionCredentials, ServiceResponse = response };
            }
            catch (Exception e)
            {
