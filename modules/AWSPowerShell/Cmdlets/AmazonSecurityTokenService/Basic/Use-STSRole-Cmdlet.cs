...
namespace Amazon.PowerShell.Cmdlets.STS
{
    ...
    [AWSCmdlet("Calls the AWS Security Token Service AssumeRole API operation.", Operation = new[] {"AssumeRole"})]
    ...
    public partial class UseSTSRoleCmdlet : AmazonSecurityTokenServiceClientCmdlet, IExecutor
    {
        ...
        /// the Maximum Session Duration Setting for a Role</a> in the <i>IAM User Guide</i>.</para><para>By default, the value is set to 3600 seconds. </para><note><para>The <code>DurationSeconds</code> parameter is separate from the duration of a console
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Token Service", "AssumeRole");
            try
            {
                #if DESKTOP
