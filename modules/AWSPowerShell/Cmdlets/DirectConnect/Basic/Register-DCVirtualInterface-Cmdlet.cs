...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Calls the AWS Direct Connect AssociateVirtualInterface API operation.", Operation = new[] {"AssociateVirtualInterface"}, SelectReturnType = typeof(Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse))]
    [AWSCmdletOutput("Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse",
        "This cmdlet returns an Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse object containing multiple properties."
    )]
    public partial class RegisterDCVirtualInterfaceCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse, RegisterDCVirtualInterfaceCmdlet>(Select) ??
        ...
        private Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.AssociateVirtualInterfaceRequest request)
        {
            ...
            try
            {
                return client.AssociateVirtualInterfaceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConnectionId { get; set; }
            public System.String VirtualInterfaceId { get; set; }
            public System.Func<Amazon.DirectConnect.Model.AssociateVirtualInterfaceResponse, RegisterDCVirtualInterfaceCmdlet, object> Select { get; set; } =
