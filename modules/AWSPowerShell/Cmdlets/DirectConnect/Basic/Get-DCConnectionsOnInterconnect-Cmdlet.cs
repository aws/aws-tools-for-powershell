...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    public partial class GetDCConnectionsOnInterconnectCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.DescribeConnectionsOnInterconnectResponse, GetDCConnectionsOnInterconnectCmdlet>(Select) ??
        ...
        private Amazon.DirectConnect.Model.DescribeConnectionsOnInterconnectResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.DescribeConnectionsOnInterconnectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Direct Connect", "DescribeConnectionsOnInterconnect");
            try
            {
                return client.DescribeConnectionsOnInterconnectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InterconnectId { get; set; }
            public System.Func<Amazon.DirectConnect.Model.DescribeConnectionsOnInterconnectResponse, GetDCConnectionsOnInterconnectCmdlet, object> Select { get; set; } =
