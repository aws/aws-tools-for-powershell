...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Direct Connect TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.DirectConnect.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.DirectConnect.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectConnect.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddDCResourceTagCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.TagResourceResponse, AddDCResourceTagCmdlet>(Select) ??
        ...
        private Amazon.DirectConnect.Model.TagResourceResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Direct Connect", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DirectConnect.Model.TagResourceResponse, AddDCResourceTagCmdlet, object> Select { get; set; } =
