...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    public partial class RemoveDCVirtualInterfaceCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.DeleteVirtualInterfaceResponse, RemoveDCVirtualInterfaceCmdlet>(Select) ??
        ...
        private Amazon.DirectConnect.Model.DeleteVirtualInterfaceResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.DeleteVirtualInterfaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Direct Connect", "DeleteVirtualInterface");
            try
            {
                return client.DeleteVirtualInterfaceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VirtualInterfaceId { get; set; }
            public System.Func<Amazon.DirectConnect.Model.DeleteVirtualInterfaceResponse, RemoveDCVirtualInterfaceCmdlet, object> Select { get; set; } =
