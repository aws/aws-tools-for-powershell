...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdletOutput("Amazon.DirectConnect.Model.VirtualInterfaceTestHistory or Amazon.DirectConnect.Model.ListVirtualInterfaceTestHistoryResponse",
        ...
        "The service call response (type Amazon.DirectConnect.Model.ListVirtualInterfaceTestHistoryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
