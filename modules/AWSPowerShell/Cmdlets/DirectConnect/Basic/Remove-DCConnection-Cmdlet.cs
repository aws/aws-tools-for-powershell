...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Calls the AWS Direct Connect DeleteConnection API operation.", Operation = new[] {"DeleteConnection"}, SelectReturnType = typeof(Amazon.DirectConnect.Model.DeleteConnectionResponse))]
    [AWSCmdletOutput("Amazon.DirectConnect.Model.DeleteConnectionResponse",
        "This cmdlet returns an Amazon.DirectConnect.Model.DeleteConnectionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveDCConnectionCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DCConnection (DeleteConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.DeleteConnectionResponse, RemoveDCConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectConnect.Model.DeleteConnectionRequest();
        ...
        private Amazon.DirectConnect.Model.DeleteConnectionResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.DeleteConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Direct Connect", "DeleteConnection");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ConnectionId { get; set; }
            public System.Func<Amazon.DirectConnect.Model.DeleteConnectionResponse, RemoveDCConnectionCmdlet, object> Select { get; set; } =
