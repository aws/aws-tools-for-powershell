...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    public partial class RemoveDCBGPPeerCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        /// The valid range is from 1 to 4294967294 for BGP configuration. </para><para>Note the following limitations when using <c>asnLong</c>:</para><ul><li><para>You can use <c>asnLong</c> or <c>asn</c>, but not both. We recommend using <c>asnLong</c>
