...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Direct Connect UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.DirectConnect.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.DirectConnect.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectConnect.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveDCResourceTagCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag keys of the tags to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectConnect.Model.UntagResourceResponse, RemoveDCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectConnect.Model.UntagResourceRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DirectConnect.Model.UntagResourceResponse, RemoveDCResourceTagCmdlet, object> Select { get; set; } =
