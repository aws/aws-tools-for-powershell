...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Get", "GACLListenerList")]
    [OutputType("Amazon.GlobalAccelerator.Model.Listener")]
    [AWSCmdlet("Calls the AWS Global Accelerator ListListeners API operation.", Operation = new[] {"ListListeners"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.ListListenersResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.Listener or Amazon.GlobalAccelerator.Model.ListListenersResponse",
        "This cmdlet returns a collection of Amazon.GlobalAccelerator.Model.Listener objects.",
        "The service call response (type Amazon.GlobalAccelerator.Model.ListListenersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLListenerListCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.ListListenersResponse, GetGACLListenerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GlobalAccelerator.Model.ListListenersRequest();
        ...
        private Amazon.GlobalAccelerator.Model.ListListenersResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.ListListenersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "ListListeners");
            try
            {
                #if DESKTOP
                return client.ListListeners(request);
                #elif CORECLR
                return client.ListListenersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.ListListenersResponse, GetGACLListenerListCmdlet, object> Select { get; set; } =
