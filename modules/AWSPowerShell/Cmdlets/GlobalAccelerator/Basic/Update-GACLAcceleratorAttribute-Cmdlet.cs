...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdlet("Calls the AWS Global Accelerator UpdateAcceleratorAttributes API operation.", Operation = new[] {"UpdateAcceleratorAttributes"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.AcceleratorAttributes or Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse",
        "This cmdlet returns an Amazon.GlobalAccelerator.Model.AcceleratorAttributes object.",
        "The service call response (type Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateGACLAcceleratorAttributeCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse, UpdateGACLAcceleratorAttributeCmdlet>(Select) ??
        ...
        private Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesRequest request)
        {
            ...
            try
            {
                return client.UpdateAcceleratorAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FlowLogsS3Bucket { get; set; }
            public System.String FlowLogsS3Prefix { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.UpdateAcceleratorAttributesResponse, UpdateGACLAcceleratorAttributeCmdlet, object> Select { get; set; } =
