...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </para></important>
    /// </summary>
    [Cmdlet("Remove", "GACLCustomRoutingAccelerator", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Global Accelerator DeleteCustomRoutingAccelerator API operation.", Operation = new[] {"DeleteCustomRoutingAccelerator"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse))]
    [AWSCmdletOutput("None or Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGACLCustomRoutingAcceleratorCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GACLCustomRoutingAccelerator (DeleteCustomRoutingAccelerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse, RemoveGACLCustomRoutingAcceleratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DeleteCustomRoutingAccelerator");
            try
            {
                #if DESKTOP
                return client.DeleteCustomRoutingAccelerator(request);
                #elif CORECLR
                return client.DeleteCustomRoutingAcceleratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AcceleratorArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingAcceleratorResponse, RemoveGACLCustomRoutingAcceleratorCmdlet, object> Select { get; set; } =
