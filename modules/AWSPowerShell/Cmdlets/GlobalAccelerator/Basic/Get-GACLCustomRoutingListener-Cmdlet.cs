...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Get", "GACLCustomRoutingListener")]
    [OutputType("Amazon.GlobalAccelerator.Model.CustomRoutingListener")]
    [AWSCmdlet("Calls the AWS Global Accelerator DescribeCustomRoutingListener API operation.", Operation = new[] {"DescribeCustomRoutingListener"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.CustomRoutingListener or Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse",
        "This cmdlet returns an Amazon.GlobalAccelerator.Model.CustomRoutingListener object.",
        "The service call response (type Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLCustomRoutingListenerCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse, GetGACLCustomRoutingListenerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DescribeCustomRoutingListener");
            try
            {
                #if DESKTOP
                return client.DescribeCustomRoutingListener(request);
                #elif CORECLR
                return client.DescribeCustomRoutingListenerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ListenerArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DescribeCustomRoutingListenerResponse, GetGACLCustomRoutingListenerCmdlet, object> Select { get; set; } =
