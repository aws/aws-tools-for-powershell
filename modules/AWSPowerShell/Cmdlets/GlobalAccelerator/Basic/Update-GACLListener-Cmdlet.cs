...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.Listener or Amazon.GlobalAccelerator.Model.UpdateListenerResponse",
        ...
        "The service call response (type Amazon.GlobalAccelerator.Model.UpdateListenerResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateGACLListenerCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The updated list of port ranges for the connections from clients to the accelerator.</para><para />
