...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GACLCustomRoutingEndpointGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveGACLCustomRoutingEndpointGroupCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GACLCustomRoutingEndpointGroup (DeleteCustomRoutingEndpointGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingEndpointGroupResponse, RemoveGACLCustomRoutingEndpointGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DeleteCustomRoutingEndpointGroupRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DeleteCustomRoutingEndpointGroupResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DeleteCustomRoutingEndpointGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DeleteCustomRoutingEndpointGroup");
            try
            {
                #if DESKTOP
                return client.DeleteCustomRoutingEndpointGroup(request);
                #elif CORECLR
                return client.DeleteCustomRoutingEndpointGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EndpointGroupArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingEndpointGroupResponse, RemoveGACLCustomRoutingEndpointGroupCmdlet, object> Select { get; set; } =
