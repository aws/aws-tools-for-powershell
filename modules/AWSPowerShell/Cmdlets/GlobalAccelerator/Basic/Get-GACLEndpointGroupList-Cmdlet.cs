...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdlet("Calls the AWS Global Accelerator ListEndpointGroups API operation.", Operation = new[] {"ListEndpointGroups"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.EndpointGroup or Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse",
        "This cmdlet returns a collection of Amazon.GlobalAccelerator.Model.EndpointGroup objects.",
        "The service call response (type Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLEndpointGroupListCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse, GetGACLEndpointGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GlobalAccelerator.Model.ListEndpointGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.EndpointGroups?.Count ?? 0;
        ...
        private Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.ListEndpointGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "ListEndpointGroups");
            try
            {
                #if DESKTOP
                return client.ListEndpointGroups(request);
                #elif CORECLR
                return client.ListEndpointGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.ListEndpointGroupsResponse, GetGACLEndpointGroupListCmdlet, object> Select { get; set; } =
