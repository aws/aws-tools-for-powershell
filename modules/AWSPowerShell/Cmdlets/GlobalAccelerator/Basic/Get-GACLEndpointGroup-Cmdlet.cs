...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    public partial class GetGACLEndpointGroupCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DescribeEndpointGroupResponse, GetGACLEndpointGroupCmdlet>(Select) ??
        ...
        private Amazon.GlobalAccelerator.Model.DescribeEndpointGroupResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DescribeEndpointGroupRequest request)
        {
            ...
            try
            {
                return client.DescribeEndpointGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String EndpointGroupArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DescribeEndpointGroupResponse, GetGACLEndpointGroupCmdlet, object> Select { get; set; } =
