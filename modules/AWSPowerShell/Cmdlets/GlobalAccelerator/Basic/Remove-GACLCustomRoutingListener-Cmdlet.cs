...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GACLCustomRoutingListener", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveGACLCustomRoutingListenerCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GACLCustomRoutingListener (DeleteCustomRoutingListener)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingListenerResponse, RemoveGACLCustomRoutingListenerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DeleteCustomRoutingListenerRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DeleteCustomRoutingListenerResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DeleteCustomRoutingListenerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DeleteCustomRoutingListener");
            try
            {
                #if DESKTOP
                return client.DeleteCustomRoutingListener(request);
                #elif CORECLR
                return client.DeleteCustomRoutingListenerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ListenerArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DeleteCustomRoutingListenerResponse, RemoveGACLCustomRoutingListenerCmdlet, object> Select { get; set; } =
