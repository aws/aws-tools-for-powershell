...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Get", "GACLCustomRoutingEndpointGroupList")]
    [OutputType("Amazon.GlobalAccelerator.Model.CustomRoutingEndpointGroup")]
    [AWSCmdlet("Calls the AWS Global Accelerator ListCustomRoutingEndpointGroups API operation.", Operation = new[] {"ListCustomRoutingEndpointGroups"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.CustomRoutingEndpointGroup or Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse",
        "This cmdlet returns a collection of Amazon.GlobalAccelerator.Model.CustomRoutingEndpointGroup objects.",
        "The service call response (type Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLCustomRoutingEndpointGroupListCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EndpointGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse, GetGACLCustomRoutingEndpointGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsRequest();
        ...
        private Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "ListCustomRoutingEndpointGroups");
            try
            {
                #if DESKTOP
                return client.ListCustomRoutingEndpointGroups(request);
                #elif CORECLR
                return client.ListCustomRoutingEndpointGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.ListCustomRoutingEndpointGroupsResponse, GetGACLCustomRoutingEndpointGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EndpointGroups;
        }
