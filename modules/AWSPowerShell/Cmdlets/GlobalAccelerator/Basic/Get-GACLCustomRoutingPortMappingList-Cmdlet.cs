...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </summary>
    [Cmdlet("Get", "GACLCustomRoutingPortMappingList")]
    [OutputType("Amazon.GlobalAccelerator.Model.PortMapping")]
    [AWSCmdlet("Calls the AWS Global Accelerator ListCustomRoutingPortMappings API operation.", Operation = new[] {"ListCustomRoutingPortMappings"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.PortMapping or Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse",
        "This cmdlet returns a collection of Amazon.GlobalAccelerator.Model.PortMapping objects.",
        "The service call response (type Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLCustomRoutingPortMappingListCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PortMappings";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse, GetGACLCustomRoutingPortMappingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsRequest();
        ...
        private Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "ListCustomRoutingPortMappings");
            try
            {
                #if DESKTOP
                return client.ListCustomRoutingPortMappings(request);
                #elif CORECLR
                return client.ListCustomRoutingPortMappingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsResponse, GetGACLCustomRoutingPortMappingListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PortMappings;
        }
