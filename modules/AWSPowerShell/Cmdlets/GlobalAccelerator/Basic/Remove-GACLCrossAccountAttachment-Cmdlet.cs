...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "GACLCrossAccountAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveGACLCrossAccountAttachmentCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GACLCrossAccountAttachment (DeleteCrossAccountAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DeleteCrossAccountAttachmentResponse, RemoveGACLCrossAccountAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DeleteCrossAccountAttachmentRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DeleteCrossAccountAttachmentResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DeleteCrossAccountAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DeleteCrossAccountAttachment");
            try
            {
                #if DESKTOP
                return client.DeleteCrossAccountAttachment(request);
                #elif CORECLR
                return client.DeleteCrossAccountAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AttachmentArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DeleteCrossAccountAttachmentResponse, RemoveGACLCrossAccountAttachmentCmdlet, object> Select { get; set; } =
