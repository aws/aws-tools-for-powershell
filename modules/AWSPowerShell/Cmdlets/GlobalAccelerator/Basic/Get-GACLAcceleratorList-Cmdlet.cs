...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    public partial class GetGACLAcceleratorListCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Accelerators";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.ListAcceleratorsResponse, GetGACLAcceleratorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GlobalAccelerator.Model.ListAcceleratorsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Accelerators?.Count ?? 0;
        ...
        private Amazon.GlobalAccelerator.Model.ListAcceleratorsResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.ListAcceleratorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "ListAccelerators");
            try
            {
                #if DESKTOP
                return client.ListAccelerators(request);
                #elif CORECLR
                return client.ListAcceleratorsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.ListAcceleratorsResponse, GetGACLAcceleratorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Accelerators;
        }
