...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.DestinationPortMapping or Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsByDestinationResponse",
        ...
        "The service call response (type Amazon.GlobalAccelerator.Model.ListCustomRoutingPortMappingsByDestinationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
