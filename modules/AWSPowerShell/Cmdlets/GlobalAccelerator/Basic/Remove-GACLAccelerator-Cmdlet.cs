...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Global Accelerator DeleteAccelerator API operation.", Operation = new[] {"DeleteAccelerator"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse))]
    [AWSCmdletOutput("None or Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGACLAcceleratorCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GACLAccelerator (DeleteAccelerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse, RemoveGACLAcceleratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DeleteAcceleratorRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DeleteAcceleratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DeleteAccelerator");
            try
            {
                #if DESKTOP
                return client.DeleteAccelerator(request);
                #elif CORECLR
                return client.DeleteAcceleratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AcceleratorArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DeleteAcceleratorResponse, RemoveGACLAcceleratorCmdlet, object> Select { get; set; } =
