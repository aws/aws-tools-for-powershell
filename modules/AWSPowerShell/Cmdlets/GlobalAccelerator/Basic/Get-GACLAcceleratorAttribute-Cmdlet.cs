...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdlet("Calls the AWS Global Accelerator DescribeAcceleratorAttributes API operation.", Operation = new[] {"DescribeAcceleratorAttributes"}, SelectReturnType = typeof(Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse))]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.AcceleratorAttributes or Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse",
        "This cmdlet returns an Amazon.GlobalAccelerator.Model.AcceleratorAttributes object.",
        "The service call response (type Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGACLAcceleratorAttributeCmdlet : AmazonGlobalAcceleratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse, GetGACLAcceleratorAttributeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesRequest();
        ...
        private Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse CallAWSServiceOperation(IAmazonGlobalAccelerator client, Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Global Accelerator", "DescribeAcceleratorAttributes");
            try
            {
                #if DESKTOP
                return client.DescribeAcceleratorAttributes(request);
                #elif CORECLR
                return client.DescribeAcceleratorAttributesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AcceleratorArn { get; set; }
            public System.Func<Amazon.GlobalAccelerator.Model.DescribeAcceleratorAttributesResponse, GetGACLAcceleratorAttributeCmdlet, object> Select { get; set; } =
