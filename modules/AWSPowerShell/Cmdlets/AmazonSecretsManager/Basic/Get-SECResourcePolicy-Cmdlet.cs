...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    [AWSCmdlet("Calls the AWS Secrets Manager GetResourcePolicy API operation.", Operation = new[] {"GetResourcePolicy"})]
    [AWSCmdletOutput("Amazon.SecretsManager.Model.GetResourcePolicyResponse",
        "This cmdlet returns a Amazon.SecretsManager.Model.GetResourcePolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSECResourcePolicyCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecretsManager.Model.GetResourcePolicyRequest();
        ...
        private Amazon.SecretsManager.Model.GetResourcePolicyResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.GetResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Secrets Manager", "GetResourcePolicy");
            try
            {
                #if DESKTOP
