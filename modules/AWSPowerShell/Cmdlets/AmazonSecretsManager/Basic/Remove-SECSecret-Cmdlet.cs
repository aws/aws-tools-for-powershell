...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    public partial class RemoveSECSecretCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>(Optional) Specifies the number of days that AWS Secrets Manager waits before it can
        /// delete the secret.</para><para>This value can range from 7 to 30 days. The default value is 30.</para>
        /// </para>
        /// </summary>
