...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    [AWSCmdlet("Calls the AWS Secrets Manager RestoreSecret API operation.", Operation = new[] {"RestoreSecret"})]
    [AWSCmdletOutput("Amazon.SecretsManager.Model.RestoreSecretResponse",
        "This cmdlet returns a Amazon.SecretsManager.Model.RestoreSecretResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RestoreSECSecretCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-SECSecret (RestoreSecret)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecretsManager.Model.RestoreSecretRequest();
        ...
        private Amazon.SecretsManager.Model.RestoreSecretResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.RestoreSecretRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Secrets Manager", "RestoreSecret");
            try
            {
                #if DESKTOP
                return client.RestoreSecret(request);
                #elif CORECLR
                return client.RestoreSecretAsync(request).GetAwaiter().GetResult();
                #else
