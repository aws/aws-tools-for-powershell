#
# Module manifest for module 'AWS.Tools.SupplyChain'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SupplyChain.dll'
    ...
    GUID = '5752fd5e-8a74-4750-a98e-6d23ba076fa2'
    ...
    Description = 'The SupplyChain module of AWS Tools for PowerShell lets developers and administrators manage AWS Supply Chain from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SupplyChain.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SupplyChain.Completers.psm1',
        'AWS.Tools.SupplyChain.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.SupplyChain.dll-Help.xml'
    )
