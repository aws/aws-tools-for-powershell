...
namespace Amazon.PowerShell.Cmdlets.SUPCH
{
    ...
    /// </summary>
    [Cmdlet("Get", "SUPCHBillOfMaterialsImportJob")]
    [OutputType("Amazon.SupplyChain.Model.BillOfMaterialsImportJob")]
    ...
    public partial class GetSUPCHBillOfMaterialsImportJobCmdlet : AmazonSupplyChainClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SupplyChain.Model.GetBillOfMaterialsImportJobResponse, GetSUPCHBillOfMaterialsImportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SupplyChain.Model.GetBillOfMaterialsImportJobRequest();
        ...
        private Amazon.SupplyChain.Model.GetBillOfMaterialsImportJobResponse CallAWSServiceOperation(IAmazonSupplyChain client, Amazon.SupplyChain.Model.GetBillOfMaterialsImportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Supply Chain", "GetBillOfMaterialsImportJob");
            try
            {
                #if DESKTOP
                return client.GetBillOfMaterialsImportJob(request);
                #elif CORECLR
                return client.GetBillOfMaterialsImportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.SupplyChain.Model.GetBillOfMaterialsImportJobResponse, GetSUPCHBillOfMaterialsImportJobCmdlet, object> Select { get; set; } =
