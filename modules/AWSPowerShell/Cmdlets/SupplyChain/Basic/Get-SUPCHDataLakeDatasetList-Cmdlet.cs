...
namespace Amazon.PowerShell.Cmdlets.SUPCH
{
    ...
    /// such as namespace, schema, and so on for a given instance ID and namespace.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetSUPCHDataLakeDatasetListCmdlet : AmazonSupplyChainClientCmdlet, IExecutor
    {
        ...
        private Amazon.SupplyChain.Model.ListDataLakeDatasetsResponse CallAWSServiceOperation(IAmazonSupplyChain client, Amazon.SupplyChain.Model.ListDataLakeDatasetsRequest request)
        {
            ...
            try
            {
                return client.ListDataLakeDatasetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
