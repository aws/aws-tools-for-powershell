...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "ROBORobotApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveROBORobotApplicationCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ROBORobotApplication (DeleteRobotApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.DeleteRobotApplicationResponse, RemoveROBORobotApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.DeleteRobotApplicationRequest();
        ...
        private Amazon.RoboMaker.Model.DeleteRobotApplicationResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DeleteRobotApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "DeleteRobotApplication");
            try
            {
                #if DESKTOP
                return client.DeleteRobotApplication(request);
                #elif CORECLR
                return client.DeleteRobotApplicationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Application { get; set; }
            public System.String ApplicationVersion { get; set; }
            public System.Func<Amazon.RoboMaker.Model.DeleteRobotApplicationResponse, RemoveROBORobotApplicationCmdlet, object> Select { get; set; } =
