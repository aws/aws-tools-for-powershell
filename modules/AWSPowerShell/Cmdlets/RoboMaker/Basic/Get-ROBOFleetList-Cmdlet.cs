...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOFleetListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListFleets</c> only returns <c>maxResults</c> results
        ...
        /// previous response object's NextToken parameter is set to null. </para><note><para>This token should be treated as an opaque identifier that is only used to retrieve
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FleetDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListFleetsResponse, GetROBOFleetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListFleetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FleetDetails?.Count ?? 0;
        ...
        private Amazon.RoboMaker.Model.ListFleetsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListFleetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListFleets");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListFleetsResponse, GetROBOFleetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FleetDetails;
        }
