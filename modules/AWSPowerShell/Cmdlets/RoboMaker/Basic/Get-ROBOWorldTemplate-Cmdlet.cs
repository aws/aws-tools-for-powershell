...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOWorldTemplateCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.DescribeWorldTemplateResponse, GetROBOWorldTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.DescribeWorldTemplateRequest();
        ...
        private Amazon.RoboMaker.Model.DescribeWorldTemplateResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DescribeWorldTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "DescribeWorldTemplate");
            try
            {
                #if DESKTOP
                return client.DescribeWorldTemplate(request);
                #elif CORECLR
                return client.DescribeWorldTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Template { get; set; }
            public System.Func<Amazon.RoboMaker.Model.DescribeWorldTemplateResponse, GetROBOWorldTemplateCmdlet, object> Select { get; set; } =
