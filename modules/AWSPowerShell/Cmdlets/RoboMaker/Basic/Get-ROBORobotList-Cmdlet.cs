...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListRobots API operation.", Operation = new[] {"ListRobots"}, SelectReturnType = typeof(Amazon.RoboMaker.Model.ListRobotsResponse))]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.Robot or Amazon.RoboMaker.Model.ListRobotsResponse",
        "This cmdlet returns a collection of Amazon.RoboMaker.Model.Robot objects.",
        "The service call response (type Amazon.RoboMaker.Model.ListRobotsResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetROBORobotListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// with the status <c>Registered</c> or the status <c>Available</c>.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListRobots</c> only returns <c>maxResults</c> results
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Robots";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListRobotsResponse, GetROBORobotListCmdlet>(Select) ??
        ...
        private Amazon.RoboMaker.Model.ListRobotsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListRobotsRequest request)
        {
            ...
            try
            {
                return client.ListRobotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListRobotsResponse, GetROBORobotListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Robots;
        }
