...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class StopROBOSimulationJobBatchCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.Batch), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-ROBOSimulationJobBatch (CancelSimulationJobBatch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.CancelSimulationJobBatchResponse, StopROBOSimulationJobBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.CancelSimulationJobBatchRequest();
        ...
        private Amazon.RoboMaker.Model.CancelSimulationJobBatchResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.CancelSimulationJobBatchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "CancelSimulationJobBatch");
            try
            {
                #if DESKTOP
                return client.CancelSimulationJobBatch(request);
                #elif CORECLR
                return client.CancelSimulationJobBatchAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Batch { get; set; }
            public System.Func<Amazon.RoboMaker.Model.CancelSimulationJobBatchResponse, StopROBOSimulationJobBatchCmdlet, object> Select { get; set; } =
