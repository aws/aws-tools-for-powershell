...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdletOutput("Amazon.RoboMaker.Model.CreateSimulationApplicationResponse",
        "This cmdlet returns an Amazon.RoboMaker.Model.CreateSimulationApplicationResponse object containing multiple properties."
    )]
    public partial class NewROBOSimulationApplicationCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The robot software suite used by the simulation application.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The sources of the simulation application.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A map that contains tag keys and tag values that are attached to the simulation application.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.RoboMaker.Model.CreateSimulationApplicationResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.CreateSimulationApplicationRequest request)
        {
            ...
            try
            {
                return client.CreateSimulationApplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
