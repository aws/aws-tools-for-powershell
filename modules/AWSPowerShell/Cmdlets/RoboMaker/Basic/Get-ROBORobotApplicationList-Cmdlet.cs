...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdletOutput("Amazon.RoboMaker.Model.RobotApplicationSummary or Amazon.RoboMaker.Model.ListRobotApplicationsResponse",
        ...
        "The service call response (type Amazon.RoboMaker.Model.ListRobotApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetROBORobotApplicationListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RobotApplicationSummaries.Count;
        ...
        private Amazon.RoboMaker.Model.ListRobotApplicationsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListRobotApplicationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListRobotApplications(request);
                #elif CORECLR
                return client.ListRobotApplicationsAsync(request).GetAwaiter().GetResult();
                #else
