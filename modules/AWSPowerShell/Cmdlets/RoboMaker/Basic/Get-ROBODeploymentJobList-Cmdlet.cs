...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBODeploymentJobListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListDeploymentJobs</c> only returns <c>maxResults</c>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DeploymentJobs?.Count ?? 0;
        ...
        private Amazon.RoboMaker.Model.ListDeploymentJobsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListDeploymentJobsRequest request)
        {
            ...
            try
            {
                return client.ListDeploymentJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
