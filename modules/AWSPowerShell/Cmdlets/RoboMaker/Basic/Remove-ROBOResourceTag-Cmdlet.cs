...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class RemoveROBOResourceTagCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A map that contains tag keys and tag values that will be unattached from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ROBOResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.UntagResourceResponse, RemoveROBOResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.UntagResourceRequest();
        ...
        private Amazon.RoboMaker.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RoboMaker.Model.UntagResourceResponse, RemoveROBOResourceTagCmdlet, object> Select { get; set; } =
