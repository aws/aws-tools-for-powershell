...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "ROBORobot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.RoboMaker.Model.DeregisterRobotResponse")]
    [AWSCmdlet("Calls the AWS RoboMaker DeregisterRobot API operation.", Operation = new[] {"DeregisterRobot"}, SelectReturnType = typeof(Amazon.RoboMaker.Model.DeregisterRobotResponse))]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.DeregisterRobotResponse",
        "This cmdlet returns an Amazon.RoboMaker.Model.DeregisterRobotResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    ...
    public partial class UnregisterROBORobotCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-ROBORobot (DeregisterRobot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.DeregisterRobotResponse, UnregisterROBORobotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.DeregisterRobotRequest();
        ...
        private Amazon.RoboMaker.Model.DeregisterRobotResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DeregisterRobotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "DeregisterRobot");
            try
            {
                #if DESKTOP
                return client.DeregisterRobot(request);
                #elif CORECLR
                return client.DeregisterRobotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Fleet { get; set; }
            public System.String Robot { get; set; }
            public System.Func<Amazon.RoboMaker.Model.DeregisterRobotResponse, UnregisterROBORobotCmdlet, object> Select { get; set; } =
