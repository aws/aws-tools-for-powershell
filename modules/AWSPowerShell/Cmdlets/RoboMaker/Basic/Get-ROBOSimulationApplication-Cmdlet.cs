...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker DescribeSimulationApplication API operation.", Operation = new[] {"DescribeSimulationApplication"}, SelectReturnType = typeof(Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse))]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse",
        "This cmdlet returns an Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetROBOSimulationApplicationCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse, GetROBOSimulationApplicationCmdlet>(Select) ??
        ...
        private Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DescribeSimulationApplicationRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeSimulationApplicationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Application { get; set; }
            public System.String ApplicationVersion { get; set; }
            public System.Func<Amazon.RoboMaker.Model.DescribeSimulationApplicationResponse, GetROBOSimulationApplicationCmdlet, object> Select { get; set; } =
