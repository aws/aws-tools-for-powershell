...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOResourceTagCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListTagsForResourceResponse, GetROBOResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RoboMaker.Model.ListTagsForResourceRequest();
        ...
        private Amazon.RoboMaker.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListTagsForResourceResponse, GetROBOResourceTagCmdlet, object> Select { get; set; } =
