...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOWorldGenerationJobListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional filters to limit results. You can use <c>status</c> and <c>templateId</c>.</para><para />
        ...
        private Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListWorldGenerationJobsRequest request)
        {
            ...
            try
            {
                return client.ListWorldGenerationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
