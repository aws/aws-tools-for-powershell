...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    /// </summary>
    [Cmdlet("Get", "ROBOWorldGenerationJobList")]
    [OutputType("Amazon.RoboMaker.Model.WorldGenerationJobSummary")]
    [AWSCmdlet("Calls the AWS RoboMaker ListWorldGenerationJobs API operation.", Operation = new[] {"ListWorldGenerationJobs"}, SelectReturnType = typeof(Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse))]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.WorldGenerationJobSummary or Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse",
        "This cmdlet returns a collection of Amazon.RoboMaker.Model.WorldGenerationJobSummary objects.",
        "The service call response (type Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetROBOWorldGenerationJobListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional filters to limit results. You can use <c>status</c> and <c>templateId</c>.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListWorldGeneratorJobs</c> only returns <c>maxResults</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WorldGenerationJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse, GetROBOWorldGenerationJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListWorldGenerationJobsRequest();
        ...
        private Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListWorldGenerationJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListWorldGenerationJobs");
            try
            {
                #if DESKTOP
                return client.ListWorldGenerationJobs(request);
                #elif CORECLR
                return client.ListWorldGenerationJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListWorldGenerationJobsResponse, GetROBOWorldGenerationJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WorldGenerationJobSummaries;
        }
