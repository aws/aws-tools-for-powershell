...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOWorldTemplateListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListWorldTemplates</c> only returns <c>maxResults</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TemplateSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListWorldTemplatesResponse, GetROBOWorldTemplateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListWorldTemplatesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TemplateSummaries?.Count ?? 0;
        ...
        private Amazon.RoboMaker.Model.ListWorldTemplatesResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListWorldTemplatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListWorldTemplates");
            try
            {
                #if DESKTOP
                return client.ListWorldTemplates(request);
                #elif CORECLR
                return client.ListWorldTemplatesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListWorldTemplatesResponse, GetROBOWorldTemplateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TemplateSummaries;
        }
