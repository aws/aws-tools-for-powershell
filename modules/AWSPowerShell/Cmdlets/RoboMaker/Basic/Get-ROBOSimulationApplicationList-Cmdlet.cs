...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    public partial class GetROBOSimulationApplicationListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional list of filters to limit results.</para><para>The filter name <c>name</c> is supported. When filtering, you must use the complete
        /// value of the filtered item. You can use up to three filters.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>When this parameter is used, <c>ListSimulationApplications</c> only returns <c>maxResults</c>
        /// results in a single page along with a <c>nextToken</c> response element. The remaining
        /// results of the initial request can be seen by sending another <c>ListSimulationApplications</c>
        /// request with the returned <c>nextToken</c> value. This value can be between 1 and
        /// 100. If this parameter is not used, then <c>ListSimulationApplications</c> returns
        ...
        /// the next set of results, call <c>ListSimulationApplications</c> again and assign that
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SimulationApplicationSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RoboMaker.Model.ListSimulationApplicationsResponse, GetROBOSimulationApplicationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListSimulationApplicationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SimulationApplicationSummaries?.Count ?? 0;
        ...
        private Amazon.RoboMaker.Model.ListSimulationApplicationsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListSimulationApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListSimulationApplications");
            try
            {
                return client.ListSimulationApplicationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String VersionQualifier { get; set; }
            public System.Func<Amazon.RoboMaker.Model.ListSimulationApplicationsResponse, GetROBOSimulationApplicationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SimulationApplicationSummaries;
        }
