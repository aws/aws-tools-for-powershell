...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// account.
    /// </summary>
    [Cmdlet("Get", "CWOADMNTelemetryRuleForOrganization")]
    [OutputType("Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service GetTelemetryRuleForOrganization API operation.", Operation = new[] {"GetTelemetryRuleForOrganization"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse))]
    [AWSCmdletOutput("Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse",
        "This cmdlet returns an Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse object containing multiple properties."
    )]
    public partial class GetCWOADMNTelemetryRuleForOrganizationCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse, GetCWOADMNTelemetryRuleForOrganizationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "GetTelemetryRuleForOrganization");
            try
            {
                #if DESKTOP
                return client.GetTelemetryRuleForOrganization(request);
                #elif CORECLR
                return client.GetTelemetryRuleForOrganizationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RuleIdentifier { get; set; }
            public System.Func<Amazon.ObservabilityAdmin.Model.GetTelemetryRuleForOrganizationResponse, GetCWOADMNTelemetryRuleForOrganizationCmdlet, object> Select { get; set; } =
