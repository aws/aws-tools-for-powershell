...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service ListResourceTelemetryForOrganization API operation.", Operation = new[] {"ListResourceTelemetryForOrganization"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse))]
    [AWSCmdletOutput("Amazon.ObservabilityAdmin.Model.TelemetryConfiguration or Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse",
        "This cmdlet returns a collection of Amazon.ObservabilityAdmin.Model.TelemetryConfiguration objects.",
        "The service call response (type Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWOADMNResourceTelemetryForOrganizationListCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        /// is provided, the service returns the resources in the same order as specified in the
        /// request. Currently supported resource types for discovery are:</para><ul><li><para><c>AWS::EC2::Instance</c></para></li><li><para><c>AWS::EC2::VPC</c></para></li><li><para><c>AWS::Lambda::Function</c></para></li><li><para><c>AWS::EKS::Cluster</c></para></li><li><para><c>AWS::WAFv2::WebACL</c></para></li><li><para><c>AWS::ElasticLoadBalancingV2::LoadBalancer</c> (Network Load Balancers only)</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data
        /// for this property is returned from the service the property will also be null. This
        /// was changed to improve performance and allow the SDK and caller to distinguish between
        /// a property not set or a property being empty to clear out a value. To retain the previous
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse, GetCWOADMNResourceTelemetryForOrganizationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "ListResourceTelemetryForOrganization");
            try
            {
                return client.ListResourceTelemetryForOrganizationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ObservabilityAdmin.Model.ListResourceTelemetryForOrganizationResponse, GetCWOADMNResourceTelemetryForOrganizationListCmdlet, object> Select { get; set; } =
