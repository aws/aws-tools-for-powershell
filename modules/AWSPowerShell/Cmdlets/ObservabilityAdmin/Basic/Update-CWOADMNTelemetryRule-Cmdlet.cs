...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CWOADMNTelemetryRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service UpdateTelemetryRule API operation.", Operation = new[] {"UpdateTelemetryRule"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse))]
    [AWSCmdletOutput("System.String or Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCWOADMNTelemetryRuleCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWOADMNTelemetryRule (UpdateTelemetryRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse, UpdateCWOADMNTelemetryRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "UpdateTelemetryRule");
            try
            {
                #if DESKTOP
                return client.UpdateTelemetryRule(request);
                #elif CORECLR
                return client.UpdateTelemetryRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.ObservabilityAdmin.TelemetryType Rule_TelemetryType { get; set; }
            public System.String RuleIdentifier { get; set; }
            public System.Func<Amazon.ObservabilityAdmin.Model.UpdateTelemetryRuleResponse, UpdateCWOADMNTelemetryRuleCmdlet, object> Select { get; set; } =
