...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWOADMNTelemetryRuleList")]
    [OutputType("Amazon.ObservabilityAdmin.Model.TelemetryRuleSummary")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service ListTelemetryRules API operation.", Operation = new[] {"ListTelemetryRules"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse))]
    [AWSCmdletOutput("Amazon.ObservabilityAdmin.Model.TelemetryRuleSummary or Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse",
        "This cmdlet returns a collection of Amazon.ObservabilityAdmin.Model.TelemetryRuleSummary objects.",
        "The service call response (type Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWOADMNTelemetryRuleListCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse, GetCWOADMNTelemetryRuleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ObservabilityAdmin.Model.ListTelemetryRulesRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.ListTelemetryRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "ListTelemetryRules");
            try
            {
                #if DESKTOP
                return client.ListTelemetryRules(request);
                #elif CORECLR
                return client.ListTelemetryRulesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RuleNamePrefix { get; set; }
            public System.Func<Amazon.ObservabilityAdmin.Model.ListTelemetryRulesResponse, GetCWOADMNTelemetryRuleListCmdlet, object> Select { get; set; } =
