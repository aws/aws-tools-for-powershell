...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWOADMNTelemetryRule")]
    [OutputType("Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service GetTelemetryRule API operation.", Operation = new[] {"GetTelemetryRule"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse))]
    [AWSCmdletOutput("Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse",
        "This cmdlet returns an Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse object containing multiple properties."
    )]
    public partial class GetCWOADMNTelemetryRuleCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse, GetCWOADMNTelemetryRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ObservabilityAdmin.Model.GetTelemetryRuleRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.GetTelemetryRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "GetTelemetryRule");
            try
            {
                #if DESKTOP
                return client.GetTelemetryRule(request);
                #elif CORECLR
                return client.GetTelemetryRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RuleIdentifier { get; set; }
            public System.Func<Amazon.ObservabilityAdmin.Model.GetTelemetryRuleResponse, GetCWOADMNTelemetryRuleCmdlet, object> Select { get; set; } =
