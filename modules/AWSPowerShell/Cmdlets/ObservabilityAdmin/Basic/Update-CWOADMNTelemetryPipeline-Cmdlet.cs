...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    public partial class UpdateCWOADMNTelemetryPipelineCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the PipelineIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^PipelineIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PipelineIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.PipelineIdentifier;
            }
        ...
        private Amazon.ObservabilityAdmin.Model.UpdateTelemetryPipelineResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.UpdateTelemetryPipelineRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateTelemetryPipeline(request);
                #elif CORECLR
                return client.UpdateTelemetryPipelineAsync(request).GetAwaiter().GetResult();
                #else
