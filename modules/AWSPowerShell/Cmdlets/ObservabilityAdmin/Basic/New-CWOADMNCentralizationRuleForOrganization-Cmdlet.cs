...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// </summary>
    [Cmdlet("New", "CWOADMNCentralizationRuleForOrganization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service CreateCentralizationRuleForOrganization API operation.", Operation = new[] {"CreateCentralizationRuleForOrganization"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse))]
    [AWSCmdletOutput("System.String or Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCWOADMNCentralizationRuleForOrganizationCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of source regions from which telemetry data should be centralized.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A unique name for the organization-wide centralization rule being created.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse).
        /// Specifying the name of a property of type Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CWOADMNCentralizationRuleForOrganization (CreateCentralizationRuleForOrganization)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse, NewCWOADMNCentralizationRuleForOrganizationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "CreateCentralizationRuleForOrganization");
            try
            {
                return client.CreateCentralizationRuleForOrganizationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ObservabilityAdmin.Model.CreateCentralizationRuleForOrganizationResponse, NewCWOADMNCentralizationRuleForOrganizationCmdlet, object> Select { get; set; } =
