...
namespace Amazon.PowerShell.Cmdlets.CWOADMN
{
    ...
    /// </summary>
    [Cmdlet("New", "CWOADMNTelemetryRuleForOrganization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the CloudWatch Observability Admin Service CreateTelemetryRuleForOrganization API operation.", Operation = new[] {"CreateTelemetryRuleForOrganization"}, SelectReturnType = typeof(Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationResponse))]
    [AWSCmdletOutput("System.String or Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCWOADMNTelemetryRuleForOrganizationCmdlet : AmazonObservabilityAdminClientCmdlet, IExecutor
    {
        ...
        /// categorization and management purposes. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CWOADMNTelemetryRuleForOrganization (CreateTelemetryRuleForOrganization)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationRequest();
        ...
        private Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationResponse CallAWSServiceOperation(IAmazonObservabilityAdmin client, Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Admin Service", "CreateTelemetryRuleForOrganization");
            try
            {
                #if DESKTOP
                return client.CreateTelemetryRuleForOrganization(request);
                #elif CORECLR
                return client.CreateTelemetryRuleForOrganizationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ObservabilityAdmin.Model.CreateTelemetryRuleForOrganizationResponse, NewCWOADMNTelemetryRuleForOrganizationCmdlet, object> Select { get; set; } =
