#
# Module manifest for module 'AWS.Tools.ObservabilityAdmin'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ObservabilityAdmin.dll'
    ...
    GUID = 'd21251a9-dca7-4718-af8a-b317ce15f9cc'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.ObservabilityAdmin.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ObservabilityAdmin.Completers.psm1',
        'AWS.Tools.ObservabilityAdmin.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'Get-CWOADMNDatasetIntegration', 
        'Get-CWOADMNDatasetIntegrationList', 
        ...
        'Remove-CWOADMNDatasetIntegration', 
        ...
        'Stop-CWOADMNTelemetryEnrichment', 
        ...
        'Update-CWOADMNDatasetIntegration', 
    ...
    FileList = @(
        'AWS.Tools.ObservabilityAdmin.dll-Help.xml'
    )
