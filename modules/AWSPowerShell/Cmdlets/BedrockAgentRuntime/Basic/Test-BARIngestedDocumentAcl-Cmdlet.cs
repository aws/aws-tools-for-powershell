...
namespace Amazon.PowerShell.Cmdlets.BAR
{
    ...
    /// </summary>
    [Cmdlet("Test", "BARIngestedDocumentAcl")]
    [OutputType("System.Boolean")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Runtime CheckIngestedDocumentAcl API operation.", Operation = new[] {"CheckIngestedDocumentAcl"}, SelectReturnType = typeof(Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse",
        "This cmdlet returns a collection of System.Boolean objects.",
        "The service call response (type Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse) can be returned by specifying '-Select *'."
    )]
    public partial class TestBARIngestedDocumentAclCmdlet : AmazonBedrockAgentRuntimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the document to check access for.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'HasAccess'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HasAccess";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse, TestBARIngestedDocumentAclCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclRequest();
        ...
        private Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse CallAWSServiceOperation(IAmazonBedrockAgentRuntime client, Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Runtime", "CheckIngestedDocumentAcl");
            try
            {
                return client.CheckIngestedDocumentAclAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String KnowledgeBaseId { get; set; }
            public System.String UserContext_UserId { get; set; }
            public System.Func<Amazon.BedrockAgentRuntime.Model.CheckIngestedDocumentAclResponse, TestBARIngestedDocumentAclCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HasAccess;
        }
