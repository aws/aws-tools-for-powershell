...
namespace Amazon.PowerShell.Cmdlets.BAR
{
    ...
    [AWSCmdlet("Calls the Amazon Bedrock Agent Runtime StopFlowExecution API operation.", Operation = new[] {"StopFlowExecution"}, SelectReturnType = typeof(Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse",
        "This cmdlet returns an Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse object containing multiple properties."
    )]
    public partial class StopBARFlowExecutionCmdlet : AmazonBedrockAgentRuntimeClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ExecutionIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-BARFlowExecution (StopFlowExecution)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse, StopBARFlowExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentRuntime.Model.StopFlowExecutionRequest();
        ...
        private Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse CallAWSServiceOperation(IAmazonBedrockAgentRuntime client, Amazon.BedrockAgentRuntime.Model.StopFlowExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Runtime", "StopFlowExecution");
            try
            {
                #if DESKTOP
                return client.StopFlowExecution(request);
                #elif CORECLR
                return client.StopFlowExecutionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FlowAliasIdentifier { get; set; }
            public System.String FlowIdentifier { get; set; }
            public System.Func<Amazon.BedrockAgentRuntime.Model.StopFlowExecutionResponse, StopBARFlowExecutionCmdlet, object> Select { get; set; } =
