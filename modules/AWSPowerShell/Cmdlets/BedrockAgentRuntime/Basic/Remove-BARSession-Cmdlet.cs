...
namespace Amazon.PowerShell.Cmdlets.BAR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "BARSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Runtime DeleteSession API operation.", Operation = new[] {"DeleteSession"}, SelectReturnType = typeof(Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse))]
    [AWSCmdletOutput("None or Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBARSessionCmdlet : AmazonBedrockAgentRuntimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier for the session to be deleted. You can specify either the session's
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BARSession (DeleteSession)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentRuntime.Model.DeleteSessionRequest();
        ...
        private Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse CallAWSServiceOperation(IAmazonBedrockAgentRuntime client, Amazon.BedrockAgentRuntime.Model.DeleteSessionRequest request)
        {
        ...
        {
            public System.String SessionIdentifier { get; set; }
            public System.Func<Amazon.BedrockAgentRuntime.Model.DeleteSessionResponse, RemoveBARSessionCmdlet, object> Select { get; set; } =
