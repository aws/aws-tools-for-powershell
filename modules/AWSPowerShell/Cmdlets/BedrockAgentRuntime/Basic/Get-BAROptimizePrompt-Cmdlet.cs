...
namespace Amazon.PowerShell.Cmdlets.BAR
{
    ...
    public partial class GetBAROptimizePromptCmdlet : AmazonBedrockAgentRuntimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TargetModelId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TargetModelId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TargetModelId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TargetModelId;
            }
        ...
        private Amazon.BedrockAgentRuntime.Model.OptimizePromptResponse CallAWSServiceOperation(IAmazonBedrockAgentRuntime client, Amazon.BedrockAgentRuntime.Model.OptimizePromptRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.OptimizePrompt(request);
                #elif CORECLR
                return client.OptimizePromptAsync(request).GetAwaiter().GetResult();
                #else
