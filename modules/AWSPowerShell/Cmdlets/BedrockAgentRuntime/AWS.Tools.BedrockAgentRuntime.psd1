#
# Module manifest for module 'AWS.Tools.BedrockAgentRuntime'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BedrockAgentRuntime.dll'
    ...
    GUID = '12f91a83-4a1d-41a5-9a38-33fe99ce73ce'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.BedrockAgentRuntime.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BedrockAgentRuntime.Completers.psm1',
        'AWS.Tools.BedrockAgentRuntime.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.BedrockAgentRuntime.dll-Help.xml'
    )
