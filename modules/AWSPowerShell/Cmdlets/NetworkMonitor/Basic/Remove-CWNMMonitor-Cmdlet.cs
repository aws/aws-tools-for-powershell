...
namespace Amazon.PowerShell.Cmdlets.CWNM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon CloudWatch Network Monitor DeleteMonitor API operation.", Operation = new[] {"DeleteMonitor"}, SelectReturnType = typeof(Amazon.NetworkMonitor.Model.DeleteMonitorResponse))]
    [AWSCmdletOutput("None or Amazon.NetworkMonitor.Model.DeleteMonitorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.NetworkMonitor.Model.DeleteMonitorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCWNMMonitorCmdlet : AmazonNetworkMonitorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWNMMonitor (DeleteMonitor)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkMonitor.Model.DeleteMonitorResponse, RemoveCWNMMonitorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkMonitor.Model.DeleteMonitorRequest();
        ...
        private Amazon.NetworkMonitor.Model.DeleteMonitorResponse CallAWSServiceOperation(IAmazonNetworkMonitor client, Amazon.NetworkMonitor.Model.DeleteMonitorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Network Monitor", "DeleteMonitor");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String MonitorName { get; set; }
            public System.Func<Amazon.NetworkMonitor.Model.DeleteMonitorResponse, RemoveCWNMMonitorCmdlet, object> Select { get; set; } =
