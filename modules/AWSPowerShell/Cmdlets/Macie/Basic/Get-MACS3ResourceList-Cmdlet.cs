...
namespace Amazon.PowerShell.Cmdlets.MAC
{
    ...
    [AWSCmdlet("Calls the Amazon Macie ListS3Resources API operation.", Operation = new[] {"ListS3Resources"}, SelectReturnType = typeof(Amazon.Macie.Model.ListS3ResourcesResponse))]
    [AWSCmdletOutput("Amazon.Macie.Model.S3ResourceClassification or Amazon.Macie.Model.ListS3ResourcesResponse",
        "This cmdlet returns a collection of Amazon.Macie.Model.S3ResourceClassification objects.",
        "The service call response (type Amazon.Macie.Model.ListS3ResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMACS3ResourceListCmdlet : AmazonMacieClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "S3Resources";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Macie.Model.ListS3ResourcesResponse, GetMACS3ResourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Macie.Model.ListS3ResourcesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.S3Resources.Count;
        ...
        private Amazon.Macie.Model.ListS3ResourcesResponse CallAWSServiceOperation(IAmazonMacie client, Amazon.Macie.Model.ListS3ResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Macie", "ListS3Resources");
            try
            {
                #if DESKTOP
                return client.ListS3Resources(request);
                #elif CORECLR
                return client.ListS3ResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemberAccountId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Macie.Model.ListS3ResourcesResponse, GetMACS3ResourceListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.S3Resources;
        }
