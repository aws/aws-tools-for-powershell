...
namespace Amazon.PowerShell.Cmdlets.MAC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Macie DisassociateMemberAccount API operation.", Operation = new[] {"DisassociateMemberAccount"}, SelectReturnType = typeof(Amazon.Macie.Model.DisassociateMemberAccountResponse))]
    [AWSCmdletOutput("None or Amazon.Macie.Model.DisassociateMemberAccountResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Macie.Model.DisassociateMemberAccountResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveMACMemberAccountCmdlet : AmazonMacieClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MACMemberAccount (DisassociateMemberAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Macie.Model.DisassociateMemberAccountResponse, RemoveMACMemberAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Macie.Model.DisassociateMemberAccountRequest();
        ...
        private Amazon.Macie.Model.DisassociateMemberAccountResponse CallAWSServiceOperation(IAmazonMacie client, Amazon.Macie.Model.DisassociateMemberAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Macie", "DisassociateMemberAccount");
            try
            {
                #if DESKTOP
                return client.DisassociateMemberAccount(request);
                #elif CORECLR
                return client.DisassociateMemberAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MemberAccountId { get; set; }
            public System.Func<Amazon.Macie.Model.DisassociateMemberAccountResponse, RemoveMACMemberAccountCmdlet, object> Select { get; set; } =
