...
{
    /// <summary>
    /// Lists all Amazon Macie member accounts for the current Amazon Macie master account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "MACMemberAccountList")]
    [OutputType("Amazon.Macie.Model.MemberAccount")]
    [AWSCmdlet("Calls the Amazon Macie ListMemberAccounts API operation.", Operation = new[] {"ListMemberAccounts"}, SelectReturnType = typeof(Amazon.Macie.Model.ListMemberAccountsResponse))]
    [AWSCmdletOutput("Amazon.Macie.Model.MemberAccount or Amazon.Macie.Model.ListMemberAccountsResponse",
        "This cmdlet returns a collection of Amazon.Macie.Model.MemberAccount objects.",
    ...
    public partial class GetMACMemberAccountListCmdlet : AmazonMacieClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Macie.Model.ListMemberAccountsResponse, GetMACMemberAccountListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Macie.Model.ListMemberAccountsResponse, GetMACMemberAccountListCmdlet, object> Select { get; set; } =
