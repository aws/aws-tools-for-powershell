...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdlet("Calls the AWS License Manager ListUsageForLicenseConfiguration API operation.", Operation = new[] {"ListUsageForLicenseConfiguration"}, SelectReturnType = typeof(Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse))]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.LicenseConfigurationUsage or Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse",
        "This cmdlet returns a collection of Amazon.LicenseManager.Model.LicenseConfigurationUsage objects.",
        "The service call response (type Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLICMUsageForLicenseConfigurationListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LicenseConfigurationUsageList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse, GetLICMUsageForLicenseConfigurationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.LicenseConfigurationUsageList?.Count ?? 0;
        ...
        private Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationRequest request)
        {
            ...
            try
            {
                return client.ListUsageForLicenseConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse, GetLICMUsageForLicenseConfigurationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LicenseConfigurationUsageList;
        }
