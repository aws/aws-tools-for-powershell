...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LICMToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLICMTokenCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TokenId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.TokenId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LICMToken (DeleteToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.DeleteTokenResponse, RemoveLICMTokenCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TokenId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.DeleteTokenRequest();
        ...
        private Amazon.LicenseManager.Model.DeleteTokenResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.DeleteTokenRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "DeleteToken");
            try
            {
                #if DESKTOP
                return client.DeleteToken(request);
                #elif CORECLR
                return client.DeleteTokenAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TokenId { get; set; }
            public System.Func<Amazon.LicenseManager.Model.DeleteTokenResponse, RemoveLICMTokenCmdlet, object> Select { get; set; } =
