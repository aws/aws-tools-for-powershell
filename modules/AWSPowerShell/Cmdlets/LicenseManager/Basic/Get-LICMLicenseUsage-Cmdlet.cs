...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LICMLicenseUsage")]
    [OutputType("Amazon.LicenseManager.Model.LicenseUsage")]
    ...
    public partial class GetLICMLicenseUsageCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "LicenseUsage";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.GetLicenseUsageResponse, GetLICMLicenseUsageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.GetLicenseUsageRequest();
        ...
        private Amazon.LicenseManager.Model.GetLicenseUsageResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.GetLicenseUsageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "GetLicenseUsage");
            try
            {
                #if DESKTOP
                return client.GetLicenseUsage(request);
                #elif CORECLR
                return client.GetLicenseUsageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String LicenseArn { get; set; }
            public System.Func<Amazon.LicenseManager.Model.GetLicenseUsageResponse, GetLICMLicenseUsageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LicenseUsage;
        }
