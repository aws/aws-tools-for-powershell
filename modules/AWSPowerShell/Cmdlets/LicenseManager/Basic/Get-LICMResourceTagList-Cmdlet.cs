...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    public partial class GetLICMResourceTagListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListTagsForResourceResponse, GetLICMResourceTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.ListTagsForResourceRequest();
        ...
        private Amazon.LicenseManager.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListTagsForResourceResponse, GetLICMResourceTagListCmdlet, object> Select { get; set; } =
