...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LICMReceivedLicenseList")]
    [OutputType("Amazon.LicenseManager.Model.GrantedLicense")]
    ...
    public partial class GetLICMReceivedLicenseListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters to scope the results. The following filters are supported:</para><ul><li><para><code>ProductSKU</code></para></li><li><para><code>Status</code></para></li><li><para><code>KeyFingerprint</code></para></li><li><para><code>Issuer</code></para></li></ul>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListReceivedLicensesResponse, GetLICMReceivedLicenseListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LicenseManager.Model.ListReceivedLicensesRequest();
        ...
        private Amazon.LicenseManager.Model.ListReceivedLicensesResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListReceivedLicensesRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListReceivedLicensesResponse, GetLICMReceivedLicenseListCmdlet, object> Select { get; set; } =
