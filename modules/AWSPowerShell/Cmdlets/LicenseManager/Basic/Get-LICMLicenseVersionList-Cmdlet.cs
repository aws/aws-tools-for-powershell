...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LICMLicenseVersionList")]
    [OutputType("Amazon.LicenseManager.Model.License")]
    [AWSCmdlet("Calls the AWS License Manager ListLicenseVersions API operation.", Operation = new[] {"ListLicenseVersions"}, SelectReturnType = typeof(Amazon.LicenseManager.Model.ListLicenseVersionsResponse))]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.License or Amazon.LicenseManager.Model.ListLicenseVersionsResponse",
        "This cmdlet returns a collection of Amazon.LicenseManager.Model.License objects.",
        "The service call response (type Amazon.LicenseManager.Model.ListLicenseVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLICMLicenseVersionListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListLicenseVersionsResponse, GetLICMLicenseVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LicenseManager.Model.ListLicenseVersionsRequest();
        ...
        private Amazon.LicenseManager.Model.ListLicenseVersionsResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListLicenseVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "ListLicenseVersions");
            try
            {
                #if DESKTOP
                return client.ListLicenseVersions(request);
                #elif CORECLR
                return client.ListLicenseVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListLicenseVersionsResponse, GetLICMLicenseVersionListCmdlet, object> Select { get; set; } =
