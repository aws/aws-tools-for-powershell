...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Approve", "LICMGrant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ApproveLICMGrantCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-LICMGrant (AcceptGrant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.AcceptGrantResponse, ApproveLICMGrantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.AcceptGrantRequest();
        ...
        private Amazon.LicenseManager.Model.AcceptGrantResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.AcceptGrantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "AcceptGrant");
            try
            {
                #if DESKTOP
                return client.AcceptGrant(request);
                #elif CORECLR
                return client.AcceptGrantAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GrantArn { get; set; }
            public System.Func<Amazon.LicenseManager.Model.AcceptGrantResponse, ApproveLICMGrantCmdlet, object> Select { get; set; } =
