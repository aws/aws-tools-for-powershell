...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdlet("Calls the AWS License Manager ListLicenseConfigurations API operation.", Operation = new[] {"ListLicenseConfigurations"}, SelectReturnType = typeof(Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.LicenseConfiguration or Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.LicenseManager.Model.LicenseConfiguration objects.",
        "The service call response (type Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLICMLicenseConfigurationListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse, GetLICMLicenseConfigurationListCmdlet>(Select) ??
        ...
        private Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListLicenseConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListLicenseConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListLicenseConfigurationsResponse, GetLICMLicenseConfigurationListCmdlet, object> Select { get; set; } =
