...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.LicenseManager.Model.GetAccessTokenResponse",
        ...
        "The service call response (type Amazon.LicenseManager.Model.GetAccessTokenResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
