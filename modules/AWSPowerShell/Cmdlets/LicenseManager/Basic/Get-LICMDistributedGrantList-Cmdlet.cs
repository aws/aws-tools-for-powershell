...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdletOutput("Amazon.LicenseManager.Model.Grant or Amazon.LicenseManager.Model.ListDistributedGrantsResponse",
        ...
        "The service call response (type Amazon.LicenseManager.Model.ListDistributedGrantsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLICMDistributedGrantListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters to scope the results. The following filters are supported:</para><ul><li><para><c>LicenseArn</c></para></li><li><para><c>GrantStatus</c></para></li><li><para><c>GranteePrincipalARN</c></para></li><li><para><c>ProductSKU</c></para></li><li><para><c>LicenseIssuerName</c></para></li></ul><para />
        ...
        private Amazon.LicenseManager.Model.ListDistributedGrantsResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListDistributedGrantsRequest request)
        {
            ...
            try
            {
                return client.ListDistributedGrantsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
