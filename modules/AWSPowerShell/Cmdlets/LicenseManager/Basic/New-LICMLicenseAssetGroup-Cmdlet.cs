...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    public partial class NewLICMLicenseAssetGroupCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ARNs of associated license asset rulesets.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>License asset group configurations.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>License asset group properties.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Properties")]
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to add to the license asset group.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.LicenseManager.Model.CreateLicenseAssetGroupResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.CreateLicenseAssetGroupRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateLicenseAssetGroup(request);
                #elif CORECLR
                return client.CreateLicenseAssetGroupAsync(request).GetAwaiter().GetResult();
                #else
