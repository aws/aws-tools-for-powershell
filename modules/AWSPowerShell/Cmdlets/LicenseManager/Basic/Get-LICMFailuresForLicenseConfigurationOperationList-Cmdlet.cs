...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LICMFailuresForLicenseConfigurationOperationList")]
    [OutputType("Amazon.LicenseManager.Model.LicenseOperationFailure")]
    ...
    public partial class GetLICMFailuresForLicenseConfigurationOperationListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LicenseOperationFailureList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.ListFailuresForLicenseConfigurationOperationsResponse, GetLICMFailuresForLicenseConfigurationOperationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LicenseManager.Model.ListFailuresForLicenseConfigurationOperationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.LicenseOperationFailureList?.Count ?? 0;
        ...
        private Amazon.LicenseManager.Model.ListFailuresForLicenseConfigurationOperationsResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListFailuresForLicenseConfigurationOperationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "ListFailuresForLicenseConfigurationOperations");
            try
            {
                #if DESKTOP
                return client.ListFailuresForLicenseConfigurationOperations(request);
                #elif CORECLR
                return client.ListFailuresForLicenseConfigurationOperationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListFailuresForLicenseConfigurationOperationsResponse, GetLICMFailuresForLicenseConfigurationOperationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LicenseOperationFailureList;
        }
