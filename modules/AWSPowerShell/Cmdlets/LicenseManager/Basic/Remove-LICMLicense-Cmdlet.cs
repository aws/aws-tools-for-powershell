...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LICMLicense", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveLICMLicenseCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LICMLicense (DeleteLicense)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.DeleteLicenseResponse, RemoveLICMLicenseCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.SourceVersion == null && ParameterWasBound(nameof(this.SourceVersion)))
            {
                WriteWarning("You are passing $null as a value for parameter SourceVersion which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.DeleteLicenseRequest();
        ...
        private Amazon.LicenseManager.Model.DeleteLicenseResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.DeleteLicenseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "DeleteLicense");
            try
            {
                return client.DeleteLicenseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String LicenseArn { get; set; }
            public System.String SourceVersion { get; set; }
            public System.Func<Amazon.LicenseManager.Model.DeleteLicenseResponse, RemoveLICMLicenseCmdlet, object> Select { get; set; } =
