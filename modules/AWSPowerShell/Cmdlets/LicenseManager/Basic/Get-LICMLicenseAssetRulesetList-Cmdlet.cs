...
{
    /// <summary>
    /// Lists license asset rulesets.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetLICMLicenseAssetRulesetListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters to scope the results. Following filters are supported</para><ul><li><para><c>Name</c></para></li></ul><para />
        ...
        private Amazon.LicenseManager.Model.ListLicenseAssetRulesetsResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListLicenseAssetRulesetsRequest request)
        {
            ...
            try
            {
                return client.ListLicenseAssetRulesetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
