...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.LicenseManager.Model.CreateLicenseManagerReportGeneratorResponse",
        ...
        "The service call response (type Amazon.LicenseManager.Model.CreateLicenseManagerReportGeneratorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewLICMLicenseManagerReportGeneratorCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ReportGeneratorName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ReportGeneratorName;
            }
        ...
        private Amazon.LicenseManager.Model.CreateLicenseManagerReportGeneratorResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.CreateLicenseManagerReportGeneratorRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateLicenseManagerReportGenerator(request);
                #elif CORECLR
                return client.CreateLicenseManagerReportGeneratorAsync(request).GetAwaiter().GetResult();
                #else
