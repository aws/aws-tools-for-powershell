...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    public partial class RemoveLICMLicenseManagerReportGeneratorCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LICMLicenseManagerReportGenerator (DeleteLicenseManagerReportGenerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.DeleteLicenseManagerReportGeneratorResponse, RemoveLICMLicenseManagerReportGeneratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManager.Model.DeleteLicenseManagerReportGeneratorRequest();
        ...
        private Amazon.LicenseManager.Model.DeleteLicenseManagerReportGeneratorResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.DeleteLicenseManagerReportGeneratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "DeleteLicenseManagerReportGenerator");
            try
            {
                #if DESKTOP
                return client.DeleteLicenseManagerReportGenerator(request);
                #elif CORECLR
                return client.DeleteLicenseManagerReportGeneratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String LicenseManagerReportGeneratorArn { get; set; }
            public System.Func<Amazon.LicenseManager.Model.DeleteLicenseManagerReportGeneratorResponse, RemoveLICMLicenseManagerReportGeneratorCmdlet, object> Select { get; set; } =
