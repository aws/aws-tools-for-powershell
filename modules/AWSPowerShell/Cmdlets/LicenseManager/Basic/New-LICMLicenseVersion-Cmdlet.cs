...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("New", "LICMLicenseVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewLICMLicenseVersionCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Asymmetric CMK from AWS Key Management Service. The CMK must have a key usage of sign
        /// and verify, and support the RSASSA-PSS SHA-256 signing algorithm.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.LicenseManager.LicenseStatus")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-LICMLicenseVersion (CreateLicenseVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManager.Model.CreateLicenseVersionResponse, NewLICMLicenseVersionCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Validity_Begin { get; set; }
            public System.String Validity_End { get; set; }
            public System.Func<Amazon.LicenseManager.Model.CreateLicenseVersionResponse, NewLICMLicenseVersionCmdlet, object> Select { get; set; } =
