...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdlet("Calls the AWS License Manager ListAssociationsForLicenseConfiguration API operation.", Operation = new[] {"ListAssociationsForLicenseConfiguration"}, SelectReturnType = typeof(Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationResponse))]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.LicenseConfigurationAssociation or Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationResponse",
        "This cmdlet returns a collection of Amazon.LicenseManager.Model.LicenseConfigurationAssociation objects.",
        "The service call response (type Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLICMAssociationsForLicenseConfigurationListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "ListAssociationsForLicenseConfiguration");
            try
            {
                #if DESKTOP
                return client.ListAssociationsForLicenseConfiguration(request);
                #elif CORECLR
                return client.ListAssociationsForLicenseConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LicenseManager.Model.ListAssociationsForLicenseConfigurationResponse, GetLICMAssociationsForLicenseConfigurationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LicenseConfigurationAssociations;
        }
