...
namespace Amazon.PowerShell.Cmdlets.IOTFH
{
    ...
    public partial class RemoveIOTFHApplicationCmdlet : AmazonIoTFleetHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTFHApplication (DeleteApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetHub.Model.DeleteApplicationResponse, RemoveIOTFHApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetHub.Model.DeleteApplicationRequest();
        ...
        private Amazon.IoTFleetHub.Model.DeleteApplicationResponse CallAWSServiceOperation(IAmazonIoTFleetHub client, Amazon.IoTFleetHub.Model.DeleteApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Fleet Hub", "DeleteApplication");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String ClientToken { get; set; }
            public System.Func<Amazon.IoTFleetHub.Model.DeleteApplicationResponse, RemoveIOTFHApplicationCmdlet, object> Select { get; set; } =
