...
{
    /// <summary>
    /// Lists the target account configurations of the specified experiment template.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetFISTargetAccountConfigurationListCmdlet : AmazonFISClientCmdlet, IExecutor
    {
        ...
        private Amazon.FIS.Model.ListTargetAccountConfigurationsResponse CallAWSServiceOperation(IAmazonFIS client, Amazon.FIS.Model.ListTargetAccountConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListTargetAccountConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
