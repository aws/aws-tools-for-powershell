...
{
    /// <summary>
    /// Lists the resolved targets information of the specified experiment.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetFISExperimentResolvedTargetListCmdlet : AmazonFISClientCmdlet, IExecutor
    {
        ...
        private Amazon.FIS.Model.ListExperimentResolvedTargetsResponse CallAWSServiceOperation(IAmazonFIS client, Amazon.FIS.Model.ListExperimentResolvedTargetsRequest request)
        {
            ...
            try
            {
                return client.ListExperimentResolvedTargetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
