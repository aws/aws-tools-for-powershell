...
namespace Amazon.PowerShell.Cmdlets.FIS
{
    ...
    [AWSCmdletOutput("Amazon.FIS.Model.ExperimentTargetAccountConfiguration or Amazon.FIS.Model.GetExperimentTargetAccountConfigurationResponse",
        ...
        "The service call response (type Amazon.FIS.Model.GetExperimentTargetAccountConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFISExperimentTargetAccountConfigurationCmdlet : AmazonFISClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ExperimentId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ExperimentId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ExperimentId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ExperimentId;
            }
