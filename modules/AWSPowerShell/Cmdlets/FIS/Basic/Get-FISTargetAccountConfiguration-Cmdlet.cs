...
namespace Amazon.PowerShell.Cmdlets.FIS
{
    ...
    /// template.
    /// </summary>
    [Cmdlet("Get", "FISTargetAccountConfiguration")]
    ...
    public partial class GetFISTargetAccountConfigurationCmdlet : AmazonFISClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.FIS.Model.GetTargetAccountConfigurationResponse).
        /// Specifying the name of a property of type Amazon.FIS.Model.GetTargetAccountConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FIS.Model.GetTargetAccountConfigurationResponse, GetFISTargetAccountConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FIS.Model.GetTargetAccountConfigurationRequest();
        ...
        private Amazon.FIS.Model.GetTargetAccountConfigurationResponse CallAWSServiceOperation(IAmazonFIS client, Amazon.FIS.Model.GetTargetAccountConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Fault Injection Simulator", "GetTargetAccountConfiguration");
            try
            {
                #if DESKTOP
                return client.GetTargetAccountConfiguration(request);
                #elif CORECLR
                return client.GetTargetAccountConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String ExperimentTemplateId { get; set; }
            public System.Func<Amazon.FIS.Model.GetTargetAccountConfigurationResponse, GetFISTargetAccountConfigurationCmdlet, object> Select { get; set; } =
