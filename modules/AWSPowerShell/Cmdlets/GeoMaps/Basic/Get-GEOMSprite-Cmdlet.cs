...
namespace Amazon.PowerShell.Cmdlets.GEOM
{
    ...
    public partial class GetGEOMSpriteCmdlet : AmazonGeoMapsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Sets the color tone for the map sprites, such as dark and light.</para><para>Example: <c>Light</c></para><para>Default value: <c>Light</c></para><note><para>Valid values for ColorScheme are case sensitive.</para></note>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.GeoMaps.Model.GetSpritesResponse CallAWSServiceOperation(IAmazonGeoMaps client, Amazon.GeoMaps.Model.GetSpritesRequest request)
        {
            ...
            try
            {
                return client.GetSpritesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
