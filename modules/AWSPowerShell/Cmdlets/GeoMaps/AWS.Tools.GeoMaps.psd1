#
# Module manifest for module 'AWS.Tools.GeoMaps'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.GeoMaps.dll'
    ...
    GUID = '1C662BE7-96B7-4C65-8E25-B6D0769605A4'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.GeoMaps.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.GeoMaps.Completers.psm1',
        'AWS.Tools.GeoMaps.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.GeoMaps.dll-Help.xml'
    )
