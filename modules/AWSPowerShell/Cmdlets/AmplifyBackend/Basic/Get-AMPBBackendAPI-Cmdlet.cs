...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPBBackendAPI")]
    [OutputType("Amazon.AmplifyBackend.Model.GetBackendAPIResponse")]
    [AWSCmdlet("Calls the Amplify Backend GetBackendAPI API operation.", Operation = new[] {"GetBackendAPI"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.GetBackendAPIResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.GetBackendAPIResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.GetBackendAPIResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPBBackendAPICmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.GetBackendAPIResponse, GetAMPBBackendAPICmdlet>(Select) ??
        ...
        private Amazon.AmplifyBackend.Model.GetBackendAPIResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.GetBackendAPIRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "GetBackendAPI");
            try
            {
                #if DESKTOP
                return client.GetBackendAPI(request);
                #elif CORECLR
                return client.GetBackendAPIAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceConfig_TransformSchema { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.GetBackendAPIResponse, GetAMPBBackendAPICmdlet, object> Select { get; set; } =
