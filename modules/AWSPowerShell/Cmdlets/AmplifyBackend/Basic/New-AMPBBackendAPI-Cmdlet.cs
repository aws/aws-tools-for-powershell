...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("New", "AMPBBackendAPI", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewAMPBBackendAPICmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-AMPBBackendAPI (CreateBackendAPI)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.CreateBackendAPIResponse, NewAMPBBackendAPICmdlet>(Select) ??
        ...
        private Amazon.AmplifyBackend.Model.CreateBackendAPIResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.CreateBackendAPIRequest request)
        {
            ...
            try
            {
                return client.CreateBackendAPIAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceConfig_TransformSchema { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.CreateBackendAPIResponse, NewAMPBBackendAPICmdlet, object> Select { get; set; } =
