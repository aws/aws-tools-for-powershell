...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Update", "AMPBBackendJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AmplifyBackend.Model.UpdateBackendJobResponse")]
    [AWSCmdlet("Calls the Amplify Backend UpdateBackendJob API operation.", Operation = new[] {"UpdateBackendJob"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.UpdateBackendJobResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.UpdateBackendJobResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.UpdateBackendJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAMPBBackendJobCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AMPBBackendJob (UpdateBackendJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.UpdateBackendJobResponse, UpdateAMPBBackendJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.UpdateBackendJobRequest();
        ...
        private Amazon.AmplifyBackend.Model.UpdateBackendJobResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.UpdateBackendJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "UpdateBackendJob");
            try
            {
                #if DESKTOP
                return client.UpdateBackendJob(request);
                #elif CORECLR
                return client.UpdateBackendJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Operation { get; set; }
            public System.String Status { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.UpdateBackendJobResponse, UpdateAMPBBackendJobCmdlet, object> Select { get; set; } =
