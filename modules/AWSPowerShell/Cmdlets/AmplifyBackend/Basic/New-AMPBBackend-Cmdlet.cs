...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.CreateBackendResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.CreateBackendResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewAMPBBackendCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The resource configuration for the backend creation request.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.AmplifyBackend.Model.CreateBackendResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.CreateBackendRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateBackend(request);
                #elif CORECLR
                return client.CreateBackendAsync(request).GetAwaiter().GetResult();
                #else
