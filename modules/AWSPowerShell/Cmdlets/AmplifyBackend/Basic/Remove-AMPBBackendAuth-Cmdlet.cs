...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMPBBackendAuth", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse")]
    [AWSCmdlet("Calls the Amplify Backend DeleteBackendAuth API operation.", Operation = new[] {"DeleteBackendAuth"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAMPBBackendAuthCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPBBackendAuth (DeleteBackendAuth)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse, RemoveAMPBBackendAuthCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.DeleteBackendAuthRequest();
        ...
        private Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.DeleteBackendAuthRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "DeleteBackendAuth");
            try
            {
                #if DESKTOP
                return client.DeleteBackendAuth(request);
                #elif CORECLR
                return client.DeleteBackendAuthAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackendEnvironmentName { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.DeleteBackendAuthResponse, RemoveAMPBBackendAuthCmdlet, object> Select { get; set; } =
