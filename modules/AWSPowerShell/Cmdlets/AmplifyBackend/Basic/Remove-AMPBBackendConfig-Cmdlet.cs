...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    public partial class RemoveAMPBBackendConfigCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Error";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPBBackendConfig (RemoveBackendConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.RemoveBackendConfigResponse, RemoveAMPBBackendConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.RemoveBackendConfigRequest();
        ...
        private Amazon.AmplifyBackend.Model.RemoveBackendConfigResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.RemoveBackendConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "RemoveBackendConfig");
            try
            {
                #if DESKTOP
                return client.RemoveBackendConfig(request);
                #elif CORECLR
                return client.RemoveBackendConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppId { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.RemoveBackendConfigResponse, RemoveAMPBBackendConfigCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Error;
        }
