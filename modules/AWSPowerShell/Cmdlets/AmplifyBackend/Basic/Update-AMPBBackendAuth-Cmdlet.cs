...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Update", "AMPBBackendAuth", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateAMPBBackendAuthCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Describes additional constrains on the password requirements to sign in to the auth
        /// resource, configured as a part of your Amplify project.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>A Boolean value that you can set to allow or disallow guest-level authorization into
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AMPBBackendAuth (UpdateBackendAuth)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.UpdateBackendAuthRequest();
            ...
            request.ResourceConfig = new Amazon.AmplifyBackend.Model.UpdateBackendAuthResourceConfig();
            ...
            Amazon.AmplifyBackend.Model.UpdateBackendAuthIdentityPoolConfig requestResourceConfig_resourceConfig_IdentityPoolConfigs = null;
            
             // populate IdentityPoolConfigs
            var requestResourceConfig_resourceConfig_IdentityPoolConfigsIsNull = true;
            requestResourceConfig_resourceConfig_IdentityPoolConfigs = new Amazon.AmplifyBackend.Model.UpdateBackendAuthIdentityPoolConfig();
            ...
            requestResourceConfig_resourceConfig_UserPoolConfigs_resourceConfig_UserPoolConfigs_Mfa = new Amazon.AmplifyBackend.Model.UpdateBackendAuthMFAConfig();
            ...
            requestResourceConfig_resourceConfig_UserPoolConfigs_resourceConfig_UserPoolConfigs_PasswordPolicy = new Amazon.AmplifyBackend.Model.UpdateBackendAuthPasswordPolicyConfig();
            ...
            requestResourceConfig_resourceConfig_UserPoolConfigs_resourceConfig_UserPoolConfigs_ForgotPassword = new Amazon.AmplifyBackend.Model.UpdateBackendAuthForgotPasswordConfig();
            ...
            requestResourceConfig_resourceConfig_UserPoolConfigs_resourceConfig_UserPoolConfigs_OAuth = new Amazon.AmplifyBackend.Model.UpdateBackendAuthOAuthConfig();
        ...
        private Amazon.AmplifyBackend.Model.UpdateBackendAuthResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.UpdateBackendAuthRequest request)
        {
