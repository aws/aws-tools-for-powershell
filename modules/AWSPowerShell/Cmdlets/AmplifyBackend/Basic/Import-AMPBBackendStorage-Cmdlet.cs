...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Import", "AMPBBackendStorage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ImportAMPBBackendStorageCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Import-AMPBBackendStorage (ImportBackendStorage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.ImportBackendStorageResponse, ImportAMPBBackendStorageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.ImportBackendStorageRequest();
        ...
        private Amazon.AmplifyBackend.Model.ImportBackendStorageResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.ImportBackendStorageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "ImportBackendStorage");
            try
            {
                #if DESKTOP
                return client.ImportBackendStorage(request);
                #elif CORECLR
                return client.ImportBackendStorageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BucketName { get; set; }
            public Amazon.AmplifyBackend.ServiceName ServiceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.ImportBackendStorageResponse, ImportAMPBBackendStorageCmdlet, object> Select { get; set; } =
