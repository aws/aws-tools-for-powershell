...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMPBBackendStorage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse")]
    [AWSCmdlet("Calls the Amplify Backend DeleteBackendStorage API operation.", Operation = new[] {"DeleteBackendStorage"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAMPBBackendStorageCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        public Amazon.AmplifyBackend.ServiceName ServiceName { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPBBackendStorage (DeleteBackendStorage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse, RemoveAMPBBackendStorageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.DeleteBackendStorageRequest();
        ...
        private Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.DeleteBackendStorageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "DeleteBackendStorage");
            try
            {
                #if DESKTOP
                return client.DeleteBackendStorage(request);
                #elif CORECLR
                return client.DeleteBackendStorageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceName { get; set; }
            public Amazon.AmplifyBackend.ServiceName ServiceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.DeleteBackendStorageResponse, RemoveAMPBBackendStorageCmdlet, object> Select { get; set; } =
