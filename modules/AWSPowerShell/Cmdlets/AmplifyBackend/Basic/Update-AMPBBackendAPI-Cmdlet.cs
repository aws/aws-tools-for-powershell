...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Update", "AMPBBackendAPI", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse")]
    [AWSCmdlet("Calls the Amplify Backend UpdateBackendAPI API operation.", Operation = new[] {"UpdateBackendAPI"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAMPBBackendAPICmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AMPBBackendAPI (UpdateBackendAPI)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse, UpdateAMPBBackendAPICmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.UpdateBackendAPIRequest();
        ...
        private Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.UpdateBackendAPIRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "UpdateBackendAPI");
            try
            {
                #if DESKTOP
                return client.UpdateBackendAPI(request);
                #elif CORECLR
                return client.UpdateBackendAPIAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceConfig_TransformSchema { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.UpdateBackendAPIResponse, UpdateAMPBBackendAPICmdlet, object> Select { get; set; } =
