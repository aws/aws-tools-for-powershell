...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPBBackendJob")]
    [OutputType("Amazon.AmplifyBackend.Model.GetBackendJobResponse")]
    [AWSCmdlet("Calls the Amplify Backend GetBackendJob API operation.", Operation = new[] {"GetBackendJob"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.GetBackendJobResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.GetBackendJobResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.GetBackendJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPBBackendJobCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.GetBackendJobResponse, GetAMPBBackendJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.GetBackendJobRequest();
        ...
        private Amazon.AmplifyBackend.Model.GetBackendJobResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.GetBackendJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "GetBackendJob");
            try
            {
                #if DESKTOP
                return client.GetBackendJob(request);
                #elif CORECLR
                return client.GetBackendJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackendEnvironmentName { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.GetBackendJobResponse, GetAMPBBackendJobCmdlet, object> Select { get; set; } =
