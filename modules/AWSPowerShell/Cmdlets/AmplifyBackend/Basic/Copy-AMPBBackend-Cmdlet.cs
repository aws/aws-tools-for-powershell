...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Copy", "AMPBBackend", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class CopyAMPBBackendCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        #region Parameter TargetEnvironmentName
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String TargetEnvironmentName { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Copy-AMPBBackend (CloneBackend)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.CloneBackendResponse, CopyAMPBBackendCmdlet>(Select) ??
            ...
            #endif
            context.TargetEnvironmentName = this.TargetEnvironmentName;
            #if MODULAR
            if (this.TargetEnvironmentName == null && ParameterWasBound(nameof(this.TargetEnvironmentName)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetEnvironmentName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.CloneBackendRequest();
            ...
            if (cmdletContext.TargetEnvironmentName != null)
            {
                request.TargetEnvironmentName = cmdletContext.TargetEnvironmentName;
            }
        ...
        private Amazon.AmplifyBackend.Model.CloneBackendResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.CloneBackendRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "CloneBackend");
            try
            {
                #if DESKTOP
                return client.CloneBackend(request);
                #elif CORECLR
                return client.CloneBackendAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackendEnvironmentName { get; set; }
            public System.String TargetEnvironmentName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.CloneBackendResponse, CopyAMPBBackendCmdlet, object> Select { get; set; } =
