...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPBBackendStorage")]
    [OutputType("Amazon.AmplifyBackend.Model.GetBackendStorageResponse")]
    [AWSCmdlet("Calls the Amplify Backend GetBackendStorage API operation.", Operation = new[] {"GetBackendStorage"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.GetBackendStorageResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.GetBackendStorageResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.GetBackendStorageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPBBackendStorageCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.GetBackendStorageResponse, GetAMPBBackendStorageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.GetBackendStorageRequest();
        ...
        private Amazon.AmplifyBackend.Model.GetBackendStorageResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.GetBackendStorageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "GetBackendStorage");
            try
            {
                #if DESKTOP
                return client.GetBackendStorage(request);
                #elif CORECLR
                return client.GetBackendStorageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackendEnvironmentName { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.GetBackendStorageResponse, GetAMPBBackendStorageCmdlet, object> Select { get; set; } =
