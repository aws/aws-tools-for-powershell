...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    [AWSCmdlet("Calls the Amplify Backend GetBackendAuth API operation.", Operation = new[] {"GetBackendAuth"}, SelectReturnType = typeof(Amazon.AmplifyBackend.Model.GetBackendAuthResponse))]
    [AWSCmdletOutput("Amazon.AmplifyBackend.Model.GetBackendAuthResponse",
        "This cmdlet returns an Amazon.AmplifyBackend.Model.GetBackendAuthResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPBBackendAuthCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.GetBackendAuthResponse, GetAMPBBackendAuthCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.GetBackendAuthRequest();
        ...
        private Amazon.AmplifyBackend.Model.GetBackendAuthResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.GetBackendAuthRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "GetBackendAuth");
            try
            {
                #if DESKTOP
                return client.GetBackendAuth(request);
                #elif CORECLR
                return client.GetBackendAuthAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackendEnvironmentName { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.GetBackendAuthResponse, GetAMPBBackendAuthCmdlet, object> Select { get; set; } =
