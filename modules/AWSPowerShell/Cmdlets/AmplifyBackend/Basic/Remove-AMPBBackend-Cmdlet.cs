...
namespace Amazon.PowerShell.Cmdlets.AMPB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMPBBackend", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveAMPBBackendCmdlet : AmazonAmplifyBackendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPBBackend (DeleteBackend)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyBackend.Model.DeleteBackendResponse, RemoveAMPBBackendCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyBackend.Model.DeleteBackendRequest();
        ...
        private Amazon.AmplifyBackend.Model.DeleteBackendResponse CallAWSServiceOperation(IAmazonAmplifyBackend client, Amazon.AmplifyBackend.Model.DeleteBackendRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amplify Backend", "DeleteBackend");
            try
            {
                #if DESKTOP
                return client.DeleteBackend(request);
                #elif CORECLR
                return client.DeleteBackendAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppId { get; set; }
            public System.String BackendEnvironmentName { get; set; }
            public System.Func<Amazon.AmplifyBackend.Model.DeleteBackendResponse, RemoveAMPBBackendCmdlet, object> Select { get; set; } =
