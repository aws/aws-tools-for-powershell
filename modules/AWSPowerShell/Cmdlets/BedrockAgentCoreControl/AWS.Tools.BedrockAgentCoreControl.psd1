#
# Module manifest for module 'AWS.Tools.BedrockAgentCoreControl'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BedrockAgentCoreControl.dll'
    ...
    GUID = '7631d60f-aa2d-452a-a71c-c8ce762edef8'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.BedrockAgentCoreControl.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BedrockAgentCoreControl.Completers.psm1',
        'AWS.Tools.BedrockAgentCoreControl.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.BedrockAgentCoreControl.dll-Help.xml'
    )
