...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class NewBACCOauth2CredentialProviderCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        #region Parameter Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim
        /// <summary>
        /// <para>
        /// <para>A map of additional claims to include in the JWT client assertion header. Standard
        /// header claims such as <c>alg</c> and <c>typ</c> cannot be added.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaims")]
        public System.Collections.Hashtable Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim { get; set; }
        #endregion
        
        #region Parameter Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim
        /// <summary>
        /// <para>
        /// <para>A map of additional claims to include in the JWT client assertion payload. Payload
        /// claims generated by the service, such as <c>iss</c>, <c>sub</c>, <c>jti</c>, and <c>exp</c>,
        /// cannot be added.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaims")]
        public System.Collections.Hashtable Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim { get; set; }
        #endregion
        ...
        #region Parameter Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the KMS key used to sign the JWT client assertion.
        /// The key must be an asymmetric key with key usage SIGN_VERIFY and a key spec compatible
        /// with the configured signing algorithm.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn { get; set; }
        #endregion
        ...
        #region Parameter Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm
        /// <summary>
        /// <para>
        /// <para>The algorithm used to sign the JWT client assertion. Valid values are <c>RS256</c>,
        /// <c>PS256</c>, and <c>ES256</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.BedrockAgentCoreControl.SigningAlgorithm")]
        public Amazon.BedrockAgentCoreControl.SigningAlgorithm Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim != null)
            {
                context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim = new Dictionary<System.String, System.String>(StringComparer.Ordinal);
                foreach (var hashKey in this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim.Keys)
                {
                    context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim.Add((String)hashKey, (System.String)(this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim[hashKey]));
                }
            }
            if (this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim != null)
            {
                context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim = new Dictionary<System.String, System.String>(StringComparer.Ordinal);
                foreach (var hashKey in this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim.Keys)
                {
                    context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim.Add((String)hashKey, (System.String)(this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim[hashKey]));
                }
            }
            context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn = this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn;
            context.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm = this.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            Amazon.BedrockAgentCoreControl.Model.PrivateKeyJwtConfig requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig = null;
            
             // populate PrivateKeyJwtConfig
            var requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull = true;
            requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig = new Amazon.BedrockAgentCoreControl.Model.PrivateKeyJwtConfig();
            Dictionary<System.String, System.String> requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim = null;
            if (cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim = cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig.AdditionalHeaderClaims = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull = false;
            }
            Dictionary<System.String, System.String> requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim = null;
            if (cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim = cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig.AdditionalPayloadClaims = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull = false;
            }
            Amazon.BedrockAgentCoreControl.SigningAlgorithm requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm = null;
            if (cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm = cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig.SigningAlgorithm = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull = false;
            }
            Amazon.BedrockAgentCoreControl.Model.PrivateKeySource requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource = null;
            
             // populate PrivateKeySource
            var requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySourceIsNull = true;
            requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource = new Amazon.BedrockAgentCoreControl.Model.PrivateKeySource();
            Amazon.BedrockAgentCoreControl.Model.KmsKeySourceType requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource = null;
            
             // populate KmsKeySource
            var requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySourceIsNull = true;
            requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource = new Amazon.BedrockAgentCoreControl.Model.KmsKeySourceType();
            System.String requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn = null;
            if (cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn = cmdletContext.Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource.KmsKeyArn = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySourceIsNull = false;
            }
             // determine if requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource should be set to null
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySourceIsNull)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource = null;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource.KmsKeySource = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySourceIsNull = false;
            }
             // determine if requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource should be set to null
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySourceIsNull)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource = null;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig.PrivateKeySource = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull = false;
            }
             // determine if requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig should be set to null
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfigIsNull)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig = null;
            }
            if (requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig != null)
            {
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig.PrivateKeyJwtConfig = requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig;
                requestOauth2ProviderConfigInput_oauth2ProviderConfigInput_CustomOauth2ProviderConfigIsNull = false;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Dictionary<System.String, System.String> Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalHeaderClaim { get; set; }
            public Dictionary<System.String, System.String> Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_AdditionalPayloadClaim { get; set; }
            public System.String Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_PrivateKeySource_KmsKeySource_KmsKeyArn { get; set; }
            public Amazon.BedrockAgentCoreControl.SigningAlgorithm Oauth2ProviderConfigInput_CustomOauth2ProviderConfig_PrivateKeyJwtConfig_SigningAlgorithm { get; set; }
            public System.String GithubOauth2ProviderConfig_ClientId { get; set; }
            public System.String GithubOauth2ProviderConfig_ClientSecret { get; set; }
