...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class RemoveBACCAgentRuntimeCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BACCAgentRuntime (DeleteAgentRuntime)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeResponse, RemoveBACCAgentRuntimeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.DeleteAgentRuntimeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "DeleteAgentRuntime");
            try
            {
                #if DESKTOP
                return client.DeleteAgentRuntime(request);
                #elif CORECLR
                return client.DeleteAgentRuntimeAsync(request).GetAwaiter().GetResult();
                #else
