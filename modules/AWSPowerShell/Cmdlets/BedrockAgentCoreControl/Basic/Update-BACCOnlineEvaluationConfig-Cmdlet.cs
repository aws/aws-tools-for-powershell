...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class UpdateBACCOnlineEvaluationConfigCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The updated list of evaluators to apply during online evaluation. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Evaluators")]
        ...
        /// based on trace properties. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Rule_Filters")]
        ...
        /// <summary>
        /// <para>
        /// <para> The list of CloudWatch log group names to monitor for agent traces.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// to identify relevant agent sessions. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.BedrockAgentCoreControl.Model.UpdateOnlineEvaluationConfigResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.UpdateOnlineEvaluationConfigRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateOnlineEvaluationConfig(request);
                #elif CORECLR
                return client.UpdateOnlineEvaluationConfigAsync(request).GetAwaiter().GetResult();
                #else
