...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class NewBACCAgentRuntimeCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Environment variables to set in the AgentCore Runtime environment.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The version of the runtime platform to use for the AgentCore Runtime.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A list of HTTP request headers that are allowed to be passed through to the runtime.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The runtime environment for executing the agent code. Specify the programming language
        ...
        private Amazon.BedrockAgentCoreControl.Model.CreateAgentRuntimeResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.CreateAgentRuntimeRequest request)
        {
            ...
            try
            {
                return client.CreateAgentRuntimeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
