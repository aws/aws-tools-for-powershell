...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class GetBACCAgentRuntimeVersionListCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsResponse, GetBACCAgentRuntimeVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "ListAgentRuntimeVersions");
            try
            {
                #if DESKTOP
                return client.ListAgentRuntimeVersions(request);
                #elif CORECLR
                return client.ListAgentRuntimeVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeVersionsResponse, GetBACCAgentRuntimeVersionListCmdlet, object> Select { get; set; } =
