...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class GetBACCAgentRuntimeEndpointListCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'RuntimeEndpoints'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RuntimeEndpoints";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsResponse, GetBACCAgentRuntimeEndpointListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "ListAgentRuntimeEndpoints");
            try
            {
                #if DESKTOP
                return client.ListAgentRuntimeEndpoints(request);
                #elif CORECLR
                return client.ListAgentRuntimeEndpointsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BedrockAgentCoreControl.Model.ListAgentRuntimeEndpointsResponse, GetBACCAgentRuntimeEndpointListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RuntimeEndpoints;
        }
