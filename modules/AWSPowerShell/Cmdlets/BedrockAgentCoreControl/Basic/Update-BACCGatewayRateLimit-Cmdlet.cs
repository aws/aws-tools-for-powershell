...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    /// creation.
    /// </summary>
    [Cmdlet("Update", "BACCGatewayRateLimit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Core Control Plane Fronting Layer UpdateGatewayRateLimit API operation.", Operation = new[] {"UpdateGatewayRateLimit"}, SelectReturnType = typeof(Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse",
        "This cmdlet returns an Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse object containing multiple properties."
    )]
    public partial class UpdateBACCGatewayRateLimitCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the rate limit to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-BACCGatewayRateLimit (UpdateGatewayRateLimit)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse, UpdateBACCGatewayRateLimitCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "UpdateGatewayRateLimit");
            try
            {
                return client.UpdateGatewayRateLimitAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String GatewayIdentifier { get; set; }
            public System.String RateLimitId { get; set; }
            public System.Func<Amazon.BedrockAgentCoreControl.Model.UpdateGatewayRateLimitResponse, UpdateBACCGatewayRateLimitCmdlet, object> Select { get; set; } =
