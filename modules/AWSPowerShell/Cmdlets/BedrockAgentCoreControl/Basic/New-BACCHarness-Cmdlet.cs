...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    /// </summary>
    [Cmdlet("New", "BACCHarness", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgentCoreControl.Model.Harness")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Core Control Plane Fronting Layer CreateHarness API operation.", Operation = new[] {"CreateHarness"}, SelectReturnType = typeof(Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentCoreControl.Model.Harness or Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse",
        "This cmdlet returns an Amazon.BedrockAgentCoreControl.Model.Harness object.",
        "The service call response (type Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewBACCHarnessCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        private readonly CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();
        
        #region Parameter Memory_AgentCoreMemoryConfiguration_ActorId
        /// <summary>
        /// <para>
        ...
        public System.String Memory_AgentCoreMemoryConfiguration_ActorId { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The tools that the agent is allowed to use. Supports glob patterns such as * for all
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.BedrockAgentCoreControl.HarnessBedrockApiFormat")]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.BedrockAgentCoreControl.HarnessOpenAiApiFormat")]
        ...
        #region Parameter Memory_AgentCoreMemoryConfiguration_Arn
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String Memory_AgentCoreMemoryConfiguration_Arn { get; set; }
        #endregion
        
        #region Parameter Memory_ManagedMemoryConfiguration_Arn
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String Memory_ManagedMemoryConfiguration_Arn { get; set; }
        #endregion
        
        #region Parameter EnvironmentArtifact_ContainerConfiguration_ContainerUri
        /// <summary>
        /// <para>
        ...
        #region Parameter Memory_Disabled
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public Amazon.BedrockAgentCoreControl.Model.HarnessDisabledMemoryConfiguration Memory_Disabled { get; set; }
        #endregion
        ...
        #region Parameter Memory_ManagedMemoryConfiguration_EncryptionKeyArn
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String Memory_ManagedMemoryConfiguration_EncryptionKeyArn { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>Environment variables to set in the harness runtime environment.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        #region Parameter Memory_ManagedMemoryConfiguration_EventExpiryDuration
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Int32? Memory_ManagedMemoryConfiguration_EventExpiryDuration { get; set; }
        #endregion
        
        #region Parameter ExecutionRoleArn
        /// <summary>
        /// <para>
        /// <para>The ARN of the IAM role that the harness assumes when running. This role must have
        /// permissions for the services the agent needs to access, such as Amazon Bedrock for
        /// model invocation.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #region Parameter HarnessName
        /// <summary>
        /// <para>
        /// <para>The name of the harness. Must start with a letter and contain only alphanumeric characters
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String HarnessName { get; set; }
        #endregion
        
        #region Parameter Hook
        /// <summary>
        /// <para>
        /// <para>The lifecycle hooks to run at defined points in the agent loop.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of iterations the agent loop can execute per invocation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxIterations")]
        ...
        /// calls within a single invocation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxTokens")]
        ...
        #region Parameter Memory_AgentCoreMemoryConfiguration_MessagesCount
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Int32? Memory_AgentCoreMemoryConfiguration_MessagesCount { get; set; }
        #endregion
        ...
        #region Parameter Memory_AgentCoreMemoryConfiguration_RetrievalConfig
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Collections.Hashtable Memory_AgentCoreMemoryConfiguration_RetrievalConfig { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The skills available to the agent. Skills are bundles of files that the agent can
        /// pull into its context on demand.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        #region Parameter Memory_ManagedMemoryConfiguration_Strategy
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Memory_ManagedMemoryConfiguration_Strategies")]
        public System.String[] Memory_ManagedMemoryConfiguration_Strategy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The system prompt that defines the agent's behavior and instructions.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to apply to the harness resource.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum duration in seconds for the agent loop execution per invocation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The tools available to the agent, such as remote MCP servers, AgentCore Gateway, AgentCore
        /// Browser, Code Interpreter, or inline functions.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.HarnessName), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-BACCHarness (CreateHarness)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse, NewBACCHarnessCmdlet>(Select) ??
            ...
            context.EnvironmentArtifact_ContainerConfiguration_ContainerUri = this.EnvironmentArtifact_ContainerConfiguration_ContainerUri;
            ...
            #endif
            context.HarnessName = this.HarnessName;
            #if MODULAR
            if (this.HarnessName == null && ParameterWasBound(nameof(this.HarnessName)))
            {
                WriteWarning("You are passing $null as a value for parameter HarnessName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            if (this.Hook != null)
            {
            ...
            context.Memory_AgentCoreMemoryConfiguration_ActorId = this.Memory_AgentCoreMemoryConfiguration_ActorId;
            context.Memory_AgentCoreMemoryConfiguration_Arn = this.Memory_AgentCoreMemoryConfiguration_Arn;
            context.Memory_AgentCoreMemoryConfiguration_MessagesCount = this.Memory_AgentCoreMemoryConfiguration_MessagesCount;
            if (this.Memory_AgentCoreMemoryConfiguration_RetrievalConfig != null)
            {
                context.Memory_AgentCoreMemoryConfiguration_RetrievalConfig = new Dictionary<System.String, Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryRetrievalConfig>(StringComparer.Ordinal);
                foreach (var hashKey in this.Memory_AgentCoreMemoryConfiguration_RetrievalConfig.Keys)
                {
                    context.Memory_AgentCoreMemoryConfiguration_RetrievalConfig.Add((String)hashKey, (Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryRetrievalConfig)(this.Memory_AgentCoreMemoryConfiguration_RetrievalConfig[hashKey]));
                }
            }
            context.Memory_Disabled = this.Memory_Disabled;
            context.Memory_ManagedMemoryConfiguration_Arn = this.Memory_ManagedMemoryConfiguration_Arn;
            context.Memory_ManagedMemoryConfiguration_EncryptionKeyArn = this.Memory_ManagedMemoryConfiguration_EncryptionKeyArn;
            context.Memory_ManagedMemoryConfiguration_EventExpiryDuration = this.Memory_ManagedMemoryConfiguration_EventExpiryDuration;
            if (this.Memory_ManagedMemoryConfiguration_Strategy != null)
            {
                context.Memory_ManagedMemoryConfiguration_Strategy = new List<System.String>(this.Memory_ManagedMemoryConfiguration_Strategy);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.CreateHarnessRequest();
            ...
            request.EnvironmentArtifact = new Amazon.BedrockAgentCoreControl.Model.HarnessEnvironmentArtifact();
            Amazon.BedrockAgentCoreControl.Model.ContainerConfiguration requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration = null;
            
             // populate ContainerConfiguration
            var requestEnvironmentArtifact_environmentArtifact_ContainerConfigurationIsNull = true;
            requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration = new Amazon.BedrockAgentCoreControl.Model.ContainerConfiguration();
            System.String requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration_environmentArtifact_ContainerConfiguration_ContainerUri = null;
            if (cmdletContext.EnvironmentArtifact_ContainerConfiguration_ContainerUri != null)
            {
                requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration_environmentArtifact_ContainerConfiguration_ContainerUri = cmdletContext.EnvironmentArtifact_ContainerConfiguration_ContainerUri;
            }
            if (requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration_environmentArtifact_ContainerConfiguration_ContainerUri != null)
            {
                requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration.ContainerUri = requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration_environmentArtifact_ContainerConfiguration_ContainerUri;
                requestEnvironmentArtifact_environmentArtifact_ContainerConfigurationIsNull = false;
            }
             // determine if requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration should be set to null
            if (requestEnvironmentArtifact_environmentArtifact_ContainerConfigurationIsNull)
            {
                requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration = null;
            }
            if (requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration != null)
            {
                request.EnvironmentArtifact.ContainerConfiguration = requestEnvironmentArtifact_environmentArtifact_ContainerConfiguration;
            ...
            if (cmdletContext.HarnessName != null)
            {
                request.HarnessName = cmdletContext.HarnessName;
            }
            ...
            request.Memory = new Amazon.BedrockAgentCoreControl.Model.HarnessMemoryConfiguration();
            Amazon.BedrockAgentCoreControl.Model.HarnessDisabledMemoryConfiguration requestMemory_memory_Disabled = null;
            if (cmdletContext.Memory_Disabled != null)
            {
                requestMemory_memory_Disabled = cmdletContext.Memory_Disabled;
            }
            if (requestMemory_memory_Disabled != null)
            {
                request.Memory.Disabled = requestMemory_memory_Disabled;
                requestMemoryIsNull = false;
            }
            Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryConfiguration requestMemory_memory_AgentCoreMemoryConfiguration = null;
            
             // populate AgentCoreMemoryConfiguration
            var requestMemory_memory_AgentCoreMemoryConfigurationIsNull = true;
            requestMemory_memory_AgentCoreMemoryConfiguration = new Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryConfiguration();
            System.String requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_ActorId = null;
            if (cmdletContext.Memory_AgentCoreMemoryConfiguration_ActorId != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_ActorId = cmdletContext.Memory_AgentCoreMemoryConfiguration_ActorId;
            }
            if (requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_ActorId != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration.ActorId = requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_ActorId;
                requestMemory_memory_AgentCoreMemoryConfigurationIsNull = false;
            }
            System.String requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_Arn = null;
            if (cmdletContext.Memory_AgentCoreMemoryConfiguration_Arn != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_Arn = cmdletContext.Memory_AgentCoreMemoryConfiguration_Arn;
            }
            if (requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_Arn != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration.Arn = requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_Arn;
                requestMemory_memory_AgentCoreMemoryConfigurationIsNull = false;
            }
            System.Int32? requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_MessagesCount = null;
            if (cmdletContext.Memory_AgentCoreMemoryConfiguration_MessagesCount != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_MessagesCount = cmdletContext.Memory_AgentCoreMemoryConfiguration_MessagesCount.Value;
            }
            if (requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_MessagesCount != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration.MessagesCount = requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_MessagesCount.Value;
                requestMemory_memory_AgentCoreMemoryConfigurationIsNull = false;
            }
            Dictionary<System.String, Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryRetrievalConfig> requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_RetrievalConfig = null;
            if (cmdletContext.Memory_AgentCoreMemoryConfiguration_RetrievalConfig != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_RetrievalConfig = cmdletContext.Memory_AgentCoreMemoryConfiguration_RetrievalConfig;
            }
            if (requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_RetrievalConfig != null)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration.RetrievalConfig = requestMemory_memory_AgentCoreMemoryConfiguration_memory_AgentCoreMemoryConfiguration_RetrievalConfig;
                requestMemory_memory_AgentCoreMemoryConfigurationIsNull = false;
            }
             // determine if requestMemory_memory_AgentCoreMemoryConfiguration should be set to null
            if (requestMemory_memory_AgentCoreMemoryConfigurationIsNull)
            {
                requestMemory_memory_AgentCoreMemoryConfiguration = null;
            }
            if (requestMemory_memory_AgentCoreMemoryConfiguration != null)
            {
                request.Memory.AgentCoreMemoryConfiguration = requestMemory_memory_AgentCoreMemoryConfiguration;
                requestMemoryIsNull = false;
            }
            Amazon.BedrockAgentCoreControl.Model.HarnessManagedMemoryConfiguration requestMemory_memory_ManagedMemoryConfiguration = null;
            
             // populate ManagedMemoryConfiguration
            var requestMemory_memory_ManagedMemoryConfigurationIsNull = true;
            requestMemory_memory_ManagedMemoryConfiguration = new Amazon.BedrockAgentCoreControl.Model.HarnessManagedMemoryConfiguration();
            System.String requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Arn = null;
            if (cmdletContext.Memory_ManagedMemoryConfiguration_Arn != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Arn = cmdletContext.Memory_ManagedMemoryConfiguration_Arn;
            }
            if (requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Arn != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration.Arn = requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Arn;
                requestMemory_memory_ManagedMemoryConfigurationIsNull = false;
            }
            System.String requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EncryptionKeyArn = null;
            if (cmdletContext.Memory_ManagedMemoryConfiguration_EncryptionKeyArn != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EncryptionKeyArn = cmdletContext.Memory_ManagedMemoryConfiguration_EncryptionKeyArn;
            }
            if (requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EncryptionKeyArn != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration.EncryptionKeyArn = requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EncryptionKeyArn;
                requestMemory_memory_ManagedMemoryConfigurationIsNull = false;
            }
            System.Int32? requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EventExpiryDuration = null;
            if (cmdletContext.Memory_ManagedMemoryConfiguration_EventExpiryDuration != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EventExpiryDuration = cmdletContext.Memory_ManagedMemoryConfiguration_EventExpiryDuration.Value;
            }
            if (requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EventExpiryDuration != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration.EventExpiryDuration = requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_EventExpiryDuration.Value;
                requestMemory_memory_ManagedMemoryConfigurationIsNull = false;
            }
            List<System.String> requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Strategy = null;
            if (cmdletContext.Memory_ManagedMemoryConfiguration_Strategy != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Strategy = cmdletContext.Memory_ManagedMemoryConfiguration_Strategy;
            }
            if (requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Strategy != null)
            {
                requestMemory_memory_ManagedMemoryConfiguration.Strategies = requestMemory_memory_ManagedMemoryConfiguration_memory_ManagedMemoryConfiguration_Strategy;
                requestMemory_memory_ManagedMemoryConfigurationIsNull = false;
            }
             // determine if requestMemory_memory_ManagedMemoryConfiguration should be set to null
            if (requestMemory_memory_ManagedMemoryConfigurationIsNull)
            {
                requestMemory_memory_ManagedMemoryConfiguration = null;
            }
            if (requestMemory_memory_ManagedMemoryConfiguration != null)
            {
                request.Memory.ManagedMemoryConfiguration = requestMemory_memory_ManagedMemoryConfiguration;
                requestMemoryIsNull = false;
            }
            ...
            Amazon.BedrockAgentCoreControl.HarnessBedrockApiFormat requestModel_model_BedrockModelConfig_model_BedrockModelConfig_ApiFormat = null;
            ...
            Amazon.BedrockAgentCoreControl.Model.HarnessLiteLlmModelConfig requestModel_model_LiteLlmModelConfig = null;
            
             // populate LiteLlmModelConfig
            var requestModel_model_LiteLlmModelConfigIsNull = true;
            requestModel_model_LiteLlmModelConfig = new Amazon.BedrockAgentCoreControl.Model.HarnessLiteLlmModelConfig();
        ...
        private Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.CreateHarnessRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "CreateHarness");
            try
            {
                return client.CreateHarnessAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Memory_AgentCoreMemoryConfiguration_Arn { get; set; }
            public System.Int32? Memory_AgentCoreMemoryConfiguration_MessagesCount { get; set; }
            public Dictionary<System.String, Amazon.BedrockAgentCoreControl.Model.HarnessAgentCoreMemoryRetrievalConfig> Memory_AgentCoreMemoryConfiguration_RetrievalConfig { get; set; }
            public Amazon.BedrockAgentCoreControl.Model.HarnessDisabledMemoryConfiguration Memory_Disabled { get; set; }
            public System.String Memory_ManagedMemoryConfiguration_Arn { get; set; }
            public System.String Memory_ManagedMemoryConfiguration_EncryptionKeyArn { get; set; }
            public System.Int32? Memory_ManagedMemoryConfiguration_EventExpiryDuration { get; set; }
            public List<System.String> Memory_ManagedMemoryConfiguration_Strategy { get; set; }
            public System.Management.Automation.PSObject Model_BedrockModelConfig_AdditionalParam { get; set; }
            public Amazon.BedrockAgentCoreControl.HarnessBedrockApiFormat Model_BedrockModelConfig_ApiFormat { get; set; }
            public System.Int32? Model_BedrockModelConfig_MaxToken { get; set; }
            public System.String Model_BedrockModelConfig_ModelId { get; set; }
            ...
            public System.Single? Truncation_Config_Summarization_SummaryRatio { get; set; }
            public Amazon.BedrockAgentCoreControl.HarnessTruncationStrategy Truncation_Strategy { get; set; }
            public System.Func<Amazon.BedrockAgentCoreControl.Model.CreateHarnessResponse, NewBACCHarnessCmdlet, object> Select { get; set; } =
