...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "BACCPaymentManager", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Core Control Plane Fronting Layer CreatePaymentManager API operation.", Operation = new[] {"CreatePaymentManager"}, SelectReturnType = typeof(Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse",
        "This cmdlet returns an Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse object containing multiple properties."
    )]
    public partial class NewBACCPaymentManagerCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of authorizer to use for the payment manager.</para><ul><li><para><c>CUSTOM_JWT</c> - Authorize with a bearer token.</para></li><li><para><c>AWS_IAM</c> - Authorize with your Amazon Web Services IAM credentials.</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A description of the payment manager.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the payment manager.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the IAM role that the payment manager assumes to
        /// access resources on your behalf.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A map of tag keys and values to assign to the payment manager.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-BACCPaymentManager (CreatePaymentManager)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse, NewBACCPaymentManagerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "CreatePaymentManager");
            try
            {
                return client.CreatePaymentManagerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BedrockAgentCoreControl.Model.CreatePaymentManagerResponse, NewBACCPaymentManagerCmdlet, object> Select { get; set; } =
