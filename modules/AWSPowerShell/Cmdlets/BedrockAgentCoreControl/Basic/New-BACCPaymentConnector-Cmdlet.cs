...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    /// </summary>
    [Cmdlet("New", "BACCPaymentConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Core Control Plane Fronting Layer CreatePaymentConnector API operation.", Operation = new[] {"CreatePaymentConnector"}, SelectReturnType = typeof(Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse",
        "This cmdlet returns an Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse object containing multiple properties."
    )]
    public partial class NewBACCPaymentConnectorCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The credential provider configurations for the payment connector. These configurations
        /// specify how the connector authenticates with the payment provider.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A description of the payment connector.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the payment connector.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the payment manager to create the connector for.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The type of payment connector, which determines the payment provider integration.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-BACCPaymentConnector (CreatePaymentConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse, NewBACCPaymentConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.CreatePaymentConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "CreatePaymentConnector");
            try
            {
                return client.CreatePaymentConnectorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
