...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    public partial class UpdateBACCConfigurationBundleCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            #if MODULAR
            if (this.ParentVersionId == null && ParameterWasBound(nameof(this.ParentVersionId)))
            {
                WriteWarning("You are passing $null as a value for parameter ParentVersionId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
