...
namespace Amazon.PowerShell.Cmdlets.BACC
{
    ...
    /// </summary>
    [Cmdlet("Update", "BACCOauth2CredentialProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse")]
    [AWSCmdlet("Calls the Amazon Bedrock Agent Core Control Plane Fronting Layer UpdateOauth2CredentialProvider API operation.", Operation = new[] {"UpdateOauth2CredentialProvider"}, SelectReturnType = typeof(Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse",
        "This cmdlet returns an Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse object containing multiple properties."
    )]
    public partial class UpdateBACCOauth2CredentialProviderCmdlet : AmazonBedrockAgentCoreControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The vendor of the OAuth2 credential provider.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the OAuth2 credential provider to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-BACCOauth2CredentialProvider (UpdateOauth2CredentialProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse, UpdateBACCOauth2CredentialProviderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderRequest();
        ...
        private Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse CallAWSServiceOperation(IAmazonBedrockAgentCoreControl client, Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Agent Core Control Plane Fronting Layer", "UpdateOauth2CredentialProvider");
            try
            {
                #if DESKTOP
                return client.UpdateOauth2CredentialProvider(request);
                #elif CORECLR
                return client.UpdateOauth2CredentialProviderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SlackOauth2ProviderConfig_ClientId { get; set; }
            public System.String SlackOauth2ProviderConfig_ClientSecret { get; set; }
            public System.Func<Amazon.BedrockAgentCoreControl.Model.UpdateOauth2CredentialProviderResponse, UpdateBACCOauth2CredentialProviderCmdlet, object> Select { get; set; } =
