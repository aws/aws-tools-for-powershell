...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    public partial class GetEMCEndpointCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Mode' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.DescribeEndpointsResponse, GetEMCEndpointCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Mode;
            }
        ...
        private Amazon.MediaConvert.Model.DescribeEndpointsResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.DescribeEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "DescribeEndpoints");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.MediaConvert.DescribeEndpointsMode Mode { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MediaConvert.Model.DescribeEndpointsResponse, GetEMCEndpointCmdlet, object> Select { get; set; } =
