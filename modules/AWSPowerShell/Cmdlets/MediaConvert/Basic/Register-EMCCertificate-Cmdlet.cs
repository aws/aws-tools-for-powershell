...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    /// MediaConvert.
    /// </summary>
    [Cmdlet("Register", "EMCCertificate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class RegisterEMCCertificateCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-EMCCertificate (AssociateCertificate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.AssociateCertificateResponse, RegisterEMCCertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConvert.Model.AssociateCertificateRequest();
        ...
        private Amazon.MediaConvert.Model.AssociateCertificateResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.AssociateCertificateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "AssociateCertificate");
            try
            {
                #if DESKTOP
                return client.AssociateCertificate(request);
                #elif CORECLR
                return client.AssociateCertificateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.MediaConvert.Model.AssociateCertificateResponse, RegisterEMCCertificateCmdlet, object> Select { get; set; } =
