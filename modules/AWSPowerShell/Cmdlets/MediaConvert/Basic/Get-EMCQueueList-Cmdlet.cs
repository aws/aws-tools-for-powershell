...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConvert ListQueues API operation.", Operation = new[] {"ListQueues"}, SelectReturnType = typeof(Amazon.MediaConvert.Model.ListQueuesResponse))]
    [AWSCmdletOutput("Amazon.MediaConvert.Model.Queue or Amazon.MediaConvert.Model.ListQueuesResponse",
        "This cmdlet returns a collection of Amazon.MediaConvert.Model.Queue objects.",
        "The service call response (type Amazon.MediaConvert.Model.ListQueuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMCQueueListCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.ListQueuesResponse, GetEMCQueueListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.MediaConvert.Order Order { get; set; }
            public System.Func<Amazon.MediaConvert.Model.ListQueuesResponse, GetEMCQueueListCmdlet, object> Select { get; set; } =
