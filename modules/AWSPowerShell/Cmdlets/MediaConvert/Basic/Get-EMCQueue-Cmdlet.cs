...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    public partial class GetEMCQueueCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.GetQueueResponse, GetEMCQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConvert.Model.GetQueueRequest();
        ...
        private Amazon.MediaConvert.Model.GetQueueResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.GetQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "GetQueue");
            try
            {
                return client.GetQueueAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.MediaConvert.Model.GetQueueResponse, GetEMCQueueCmdlet, object> Select { get; set; } =
