...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMCPresetList")]
    [OutputType("Amazon.MediaConvert.Model.Preset")]
    [AWSCmdlet("Calls the AWS Elemental MediaConvert ListPresets API operation.", Operation = new[] {"ListPresets"}, SelectReturnType = typeof(Amazon.MediaConvert.Model.ListPresetsResponse))]
    [AWSCmdletOutput("Amazon.MediaConvert.Model.Preset or Amazon.MediaConvert.Model.ListPresetsResponse",
        "This cmdlet returns a collection of Amazon.MediaConvert.Model.Preset objects.",
        "The service call response (type Amazon.MediaConvert.Model.ListPresetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMCPresetListCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.MediaConvert.PresetListBy")]
        public Amazon.MediaConvert.PresetListBy ListBy { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.ListPresetsResponse, GetEMCPresetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaConvert.Model.ListPresetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Presets?.Count ?? 0;
        ...
        private Amazon.MediaConvert.Model.ListPresetsResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.ListPresetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "ListPresets");
            try
            {
                return client.ListPresetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.MediaConvert.Order Order { get; set; }
            public System.Func<Amazon.MediaConvert.Model.ListPresetsResponse, GetEMCPresetListCmdlet, object> Select { get; set; } =
