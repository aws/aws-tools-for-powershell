...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    [AWSCmdletOutput("Amazon.MediaConvert.Model.Preset or Amazon.MediaConvert.Model.ListPresetsResponse",
        ...
        "The service call response (type Amazon.MediaConvert.Model.ListPresetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
