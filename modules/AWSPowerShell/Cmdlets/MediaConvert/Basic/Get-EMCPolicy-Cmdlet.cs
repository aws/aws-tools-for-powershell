...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    public partial class GetEMCPolicyCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConvert.Model.GetPolicyResponse).
        /// Specifying the name of a property of type Amazon.MediaConvert.Model.GetPolicyResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.GetPolicyResponse, GetEMCPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConvert.Model.GetPolicyRequest();
        ...
        private Amazon.MediaConvert.Model.GetPolicyResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.GetPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "GetPolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.Func<Amazon.MediaConvert.Model.GetPolicyResponse, GetEMCPolicyCmdlet, object> Select { get; set; } =
