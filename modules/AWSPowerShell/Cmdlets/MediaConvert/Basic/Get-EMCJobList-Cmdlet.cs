...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMCJobList")]
    [OutputType("Amazon.MediaConvert.Model.Job")]
    [AWSCmdlet("Calls the AWS Elemental MediaConvert ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.MediaConvert.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.MediaConvert.Model.Job or Amazon.MediaConvert.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.MediaConvert.Model.Job objects.",
        "The service call response (type Amazon.MediaConvert.Model.ListJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMCJobListCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.ListJobsResponse, GetEMCJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaConvert.Model.ListJobsRequest();
        ...
        private Amazon.MediaConvert.Model.ListJobsResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "ListJobs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Queue { get; set; }
            public Amazon.MediaConvert.JobStatus Status { get; set; }
            public System.Func<Amazon.MediaConvert.Model.ListJobsResponse, GetEMCJobListCmdlet, object> Select { get; set; } =
