...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMCJobTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMCJobTemplateCmdlet : AmazonMediaConvertClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMCJobTemplate (DeleteJobTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConvert.Model.DeleteJobTemplateResponse, RemoveEMCJobTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConvert.Model.DeleteJobTemplateRequest();
        ...
        private Amazon.MediaConvert.Model.DeleteJobTemplateResponse CallAWSServiceOperation(IAmazonMediaConvert client, Amazon.MediaConvert.Model.DeleteJobTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConvert", "DeleteJobTemplate");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.MediaConvert.Model.DeleteJobTemplateResponse, RemoveEMCJobTemplateCmdlet, object> Select { get; set; } =
