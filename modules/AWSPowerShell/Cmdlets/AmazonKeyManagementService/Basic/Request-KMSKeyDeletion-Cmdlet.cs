...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public partial class RequestKMSKeyDeletionCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// the CMK. Examples:</para><ul><li><para>Unique key ID: 1234abcd-12ab-34cd-56ef-1234567890ab</para></li><li><para>Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</para></li></ul><para>To obtain the unique key ID and key ARN for a given CMK, use <a>ListKeys</a> or <a>DescribeKey</a>.</para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.KeyManagementService.Model.ScheduleKeyDeletionResponse CallAWSServiceOperation(IAmazonKeyManagementService client, Amazon.KeyManagementService.Model.ScheduleKeyDeletionRequest request)
        {
            #if DESKTOP
