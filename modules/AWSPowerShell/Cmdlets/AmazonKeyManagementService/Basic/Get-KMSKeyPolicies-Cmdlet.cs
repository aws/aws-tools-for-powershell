...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// </summary>
    [Cmdlet("Get", "KMSKeyPolicies")]
    [OutputType("System.String")]
    [AWSCmdlet("Invokes the ListKeyPolicies operation against AWS Key Management Service.", Operation = new[] {"ListKeyPolicies"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type ListKeyPoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetKMSKeyPoliciesCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specify this parameter only when paginating results to indicate the maximum number
        ...
        /// of the <code>NextMarker</code> in the response you just received. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        [Alias("NextToken")]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListKeyPolicies(request);
