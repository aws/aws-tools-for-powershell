...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    [AWSCmdlet("Calls the AWS Key Management Service GenerateDataKey API operation.", Operation = new[] {"GenerateDataKey"})]
    ...
    public partial class NewKMSDataKeyCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// key.</para><para>To specify a CMK, use its key ID, Amazon Resource Name (ARN), alias name, or alias
