...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    [AWSCmdlet("Invokes the ListKeys operation against AWS Key Management Service.", Operation = new[] {"ListKeys"})]
    ...
    public partial class GetKMSKeysCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.KeyManagementService.Model.ListKeysResponse CallAWSServiceOperation(IAmazonKeyManagementService client, Amazon.KeyManagementService.Model.ListKeysRequest request)
        {
            ...
            var task = client.ListKeysAsync(request);
            return task.Result;
            #else
