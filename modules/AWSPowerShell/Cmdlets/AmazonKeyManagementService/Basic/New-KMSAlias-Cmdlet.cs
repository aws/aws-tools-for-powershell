...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    [AWSCmdlet("Calls the AWS Key Management Service CreateAlias API operation.", Operation = new[] {"CreateAlias"})]
