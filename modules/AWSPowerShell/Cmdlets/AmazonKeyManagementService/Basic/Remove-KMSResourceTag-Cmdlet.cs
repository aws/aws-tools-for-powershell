...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public partial class RemoveKMSResourceTagCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique identifier for the CMK from which you are removing tags. You can use the
        /// unique key ID or the Amazon Resource Name (ARN) of the CMK. Examples:</para><ul><li><para>Unique key ID: <code>1234abcd-12ab-34cd-56ef-1234567890ab</code></para></li><li><para>Key ARN: <code>arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code></para></li></ul>
        /// </para>
        /// </summary>
        ...
        private static Amazon.KeyManagementService.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonKeyManagementService client, Amazon.KeyManagementService.Model.UntagResourceRequest request)
        {
            #if DESKTOP
