...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public class GetKMSGrantsCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// of grants you want listed in the response. If there are additional grants beyond the
        /// maximum you specify, the <code>Truncated</code> response element will be set to <code>true.</code></para>
        /// </para>
        /// </summary>
