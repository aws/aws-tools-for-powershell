...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public class GetKMSKeyCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        /// <para>Unique identifier of the customer master key to be described. This can be an ARN,
        /// an alias, or a globally unique identifier. </para>
        /// </para>
        /// </summary>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DescribeKey(request);
