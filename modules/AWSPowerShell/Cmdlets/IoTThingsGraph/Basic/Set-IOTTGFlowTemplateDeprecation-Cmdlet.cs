...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    public partial class SetIOTTGFlowTemplateDeprecationCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-IOTTGFlowTemplateDeprecation (DeprecateFlowTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateResponse, SetIOTTGFlowTemplateDeprecationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateRequest();
        ...
        private Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Things Graph", "DeprecateFlowTemplate");
            try
            {
                #if DESKTOP
                return client.DeprecateFlowTemplate(request);
                #elif CORECLR
                return client.DeprecateFlowTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.IoTThingsGraph.Model.DeprecateFlowTemplateResponse, SetIOTTGFlowTemplateDeprecationCmdlet, object> Select { get; set; } =
