...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    public partial class RemoveIOTTGEntityFromThingCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.IoTThingsGraph.EntityType")]
        public Amazon.IoTThingsGraph.EntityType EntityType { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTThingsGraph.Model.DissociateEntityFromThingResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTGEntityFromThing (DissociateEntityFromThing)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTThingsGraph.Model.DissociateEntityFromThingResponse, RemoveIOTTGEntityFromThingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTThingsGraph.Model.DissociateEntityFromThingRequest();
        ...
        private Amazon.IoTThingsGraph.Model.DissociateEntityFromThingResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.DissociateEntityFromThingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Things Graph", "DissociateEntityFromThing");
            try
            {
                #if DESKTOP
                return client.DissociateEntityFromThing(request);
                #elif CORECLR
                return client.DissociateEntityFromThingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.IoTThingsGraph.EntityType EntityType { get; set; }
            public System.String ThingName { get; set; }
            public System.Func<Amazon.IoTThingsGraph.Model.DissociateEntityFromThingResponse, RemoveIOTTGEntityFromThingCmdlet, object> Select { get; set; } =
