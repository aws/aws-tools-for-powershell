...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IOTTGSystemInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTTGSystemInstanceCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTThingsGraph.Model.DeleteSystemInstanceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTGSystemInstance (DeleteSystemInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTThingsGraph.Model.DeleteSystemInstanceResponse, RemoveIOTTGSystemInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTThingsGraph.Model.DeleteSystemInstanceRequest();
        ...
        private Amazon.IoTThingsGraph.Model.DeleteSystemInstanceResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.DeleteSystemInstanceRequest request)
        {
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.IoTThingsGraph.Model.DeleteSystemInstanceResponse, RemoveIOTTGSystemInstanceCmdlet, object> Select { get; set; } =
