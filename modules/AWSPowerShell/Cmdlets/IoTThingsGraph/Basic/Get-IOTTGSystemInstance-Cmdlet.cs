...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    public partial class GetIOTTGSystemInstanceCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTThingsGraph.Model.GetSystemInstanceResponse).
        /// Specifying the name of a property of type Amazon.IoTThingsGraph.Model.GetSystemInstanceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTThingsGraph.Model.GetSystemInstanceResponse, GetIOTTGSystemInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTThingsGraph.Model.GetSystemInstanceRequest();
        ...
        private Amazon.IoTThingsGraph.Model.GetSystemInstanceResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.GetSystemInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Things Graph", "GetSystemInstance");
            try
            {
                #if DESKTOP
                return client.GetSystemInstance(request);
                #elif CORECLR
                return client.GetSystemInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.IoTThingsGraph.Model.GetSystemInstanceResponse, GetIOTTGSystemInstanceCmdlet, object> Select { get; set; } =
