...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    /// been deleted.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.<br/><br/>This operation is deprecated.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.IoTThingsGraph.Model.SystemTemplateSummary or Amazon.IoTThingsGraph.Model.GetSystemTemplateRevisionsResponse",
        ...
        "The service call response (type Amazon.IoTThingsGraph.Model.GetSystemTemplateRevisionsResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetIOTTGSystemTemplateRevisionCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the system template.</para><para>The ID should be in the following format.</para><para><c>urn:tdm:REGION/ACCOUNT ID/default:system:SYSTEMNAME</c></para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.IoTThingsGraph.Model.GetSystemTemplateRevisionsResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.GetSystemTemplateRevisionsRequest request)
        {
            ...
            try
            {
                return client.GetSystemTemplateRevisionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
