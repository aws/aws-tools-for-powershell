...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    [AWSCmdletOutput("Amazon.IoTThingsGraph.Model.FlowExecutionMessage or Amazon.IoTThingsGraph.Model.ListFlowExecutionMessagesResponse",
        ...
        "The service call response (type Amazon.IoTThingsGraph.Model.ListFlowExecutionMessagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    ...
    public partial class GetIOTTGFlowExecutionMessageListCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the FlowExecutionId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^FlowExecutionId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^FlowExecutionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.FlowExecutionId;
            }
        ...
        private Amazon.IoTThingsGraph.Model.ListFlowExecutionMessagesResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.ListFlowExecutionMessagesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListFlowExecutionMessages(request);
                #elif CORECLR
                return client.ListFlowExecutionMessagesAsync(request).GetAwaiter().GetResult();
                #else
