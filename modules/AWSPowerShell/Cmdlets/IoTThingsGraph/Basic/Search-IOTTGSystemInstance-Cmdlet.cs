...
{
    /// <summary>
    /// Searches for system instances in the user's account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.<br/><br/>This operation is deprecated.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.IoTThingsGraph.Model.SystemInstanceSummary or Amazon.IoTThingsGraph.Model.SearchSystemInstancesResponse",
        ...
        "The service call response (type Amazon.IoTThingsGraph.Model.SearchSystemInstancesResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class SearchIOTTGSystemInstanceCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTThingsGraph.Model.SearchSystemInstancesResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.SearchSystemInstancesRequest request)
        {
            ...
            try
            {
                return client.SearchSystemInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
