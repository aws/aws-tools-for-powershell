...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    public partial class SearchIOTTGEntityCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the EntityType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^EntityType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^EntityType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.EntityType;
            }
        ...
        private Amazon.IoTThingsGraph.Model.SearchEntitiesResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.SearchEntitiesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.SearchEntities(request);
                #elif CORECLR
