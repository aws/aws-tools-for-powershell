...
namespace Amazon.PowerShell.Cmdlets.IOTTG
{
    ...
    public partial class RemoveIOTTGResourceTagCmdlet : AmazonIoTThingsGraphClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTThingsGraph.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTGResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTThingsGraph.Model.UntagResourceResponse, RemoveIOTTGResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTThingsGraph.Model.UntagResourceRequest();
        ...
        private Amazon.IoTThingsGraph.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonIoTThingsGraph client, Amazon.IoTThingsGraph.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Things Graph", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTThingsGraph.Model.UntagResourceResponse, RemoveIOTTGResourceTagCmdlet, object> Select { get; set; } =
