#
# Module manifest for module 'AWS.Tools.CodeBuild'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.CodeBuild.dll'
    ...
    GUID = '57d87d4c-2d0c-41a8-b870-e1943e5121e5'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.CodeBuild.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.CodeBuild.Completers.psm1',
        'AWS.Tools.CodeBuild.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.CodeBuild.dll-Help.xml'
    )
