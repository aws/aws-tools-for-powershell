...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    public partial class RemoveCBBuildBatchCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the builds to delete.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.BatchDeleteBuildsResponse, RemoveCBBuildBatchCmdlet>(Select) ??
        ...
        private Amazon.CodeBuild.Model.BatchDeleteBuildsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.BatchDeleteBuildsRequest request)
        {
            ...
            try
            {
                return client.BatchDeleteBuildsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeBuild.Model.BatchDeleteBuildsResponse, RemoveCBBuildBatchCmdlet, object> Select { get; set; } =
