...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Calls the AWS CodeBuild ListBuildsForProject API operation.", Operation = new[] {"ListBuildsForProject"}, SelectReturnType = typeof(Amazon.CodeBuild.Model.ListBuildsForProjectResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeBuild.Model.ListBuildsForProjectResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CodeBuild.Model.ListBuildsForProjectResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCBBuildIdListForProjectCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.ListBuildsForProjectResponse, GetCBBuildIdListForProjectCmdlet>(Select) ??
        ...
        private Amazon.CodeBuild.Model.ListBuildsForProjectResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.ListBuildsForProjectRequest request)
        {
            ...
            try
            {
                return client.ListBuildsForProjectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProjectName { get; set; }
            public Amazon.CodeBuild.SortOrderType SortOrder { get; set; }
            public System.Func<Amazon.CodeBuild.Model.ListBuildsForProjectResponse, GetCBBuildIdListForProjectCmdlet, object> Select { get; set; } =
