...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Calls the AWS CodeBuild PutResourcePolicy API operation.", Operation = new[] {"PutResourcePolicy"}, SelectReturnType = typeof(Amazon.CodeBuild.Model.PutResourcePolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeBuild.Model.PutResourcePolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CodeBuild.Model.PutResourcePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteCBResourcePolicyCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        /// a Report Group</a> in the <i>CodeBuild User Guide</i>. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-CBResourcePolicy (PutResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.PutResourcePolicyResponse, WriteCBResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeBuild.Model.PutResourcePolicyRequest();
        ...
        private Amazon.CodeBuild.Model.PutResourcePolicyResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.PutResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeBuild", "PutResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Policy { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.CodeBuild.Model.PutResourcePolicyResponse, WriteCBResourcePolicyCmdlet, object> Select { get; set; } =
