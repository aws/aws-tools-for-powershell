...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    /// </summary>
    [Cmdlet("Get", "CBBuildIdList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS CodeBuild ListBuilds API operation.", Operation = new[] {"ListBuilds"}, SelectReturnType = typeof(Amazon.CodeBuild.Model.ListBuildsResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeBuild.Model.ListBuildsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CodeBuild.Model.ListBuildsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCBBuildIdListCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.ListBuildsResponse, GetCBBuildIdListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeBuild.Model.ListBuildsRequest();
        ...
        private Amazon.CodeBuild.Model.ListBuildsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.ListBuildsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeBuild", "ListBuilds");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public Amazon.CodeBuild.SortOrderType SortOrder { get; set; }
            public System.Func<Amazon.CodeBuild.Model.ListBuildsResponse, GetCBBuildIdListCmdlet, object> Select { get; set; } =
