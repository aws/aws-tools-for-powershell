...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    public partial class GetCBBatchCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array that contains the batch build identifiers to retrieve.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.BatchGetBuildBatchesResponse, GetCBBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeBuild.Model.BatchGetBuildBatchesRequest();
        ...
        private Amazon.CodeBuild.Model.BatchGetBuildBatchesResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.BatchGetBuildBatchesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeBuild", "BatchGetBuildBatches");
            try
            {
                return client.BatchGetBuildBatchesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeBuild.Model.BatchGetBuildBatchesResponse, GetCBBatchCmdlet, object> Select { get; set; } =
