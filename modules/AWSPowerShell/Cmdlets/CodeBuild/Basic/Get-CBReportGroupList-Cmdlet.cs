...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdletOutput("System.String or Amazon.CodeBuild.Model.ListReportGroupsResponse",
        ...
        "The service call response (type Amazon.CodeBuild.Model.ListReportGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
