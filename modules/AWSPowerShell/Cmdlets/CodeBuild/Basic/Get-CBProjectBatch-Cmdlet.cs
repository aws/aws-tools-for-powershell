...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdletOutput("Amazon.CodeBuild.Model.BatchGetProjectsResponse",
        "This cmdlet returns an Amazon.CodeBuild.Model.BatchGetProjectsResponse object containing multiple properties."
    )]
    public partial class GetCBProjectBatchCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeBuild.Model.BatchGetProjectsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.BatchGetProjectsRequest request)
        {
            ...
            try
            {
                return client.BatchGetProjectsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
