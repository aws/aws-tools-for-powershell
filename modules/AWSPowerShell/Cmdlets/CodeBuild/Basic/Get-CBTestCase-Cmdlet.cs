...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdletOutput("Amazon.CodeBuild.Model.TestCase or Amazon.CodeBuild.Model.DescribeTestCasesResponse",
        ...
        "The service call response (type Amazon.CodeBuild.Model.DescribeTestCasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
