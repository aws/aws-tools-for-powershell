...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Calls the AWS CodeBuild BatchGetBuilds API operation.", Operation = new[] {"BatchGetBuilds"}, SelectReturnType = typeof(Amazon.CodeBuild.Model.BatchGetBuildsResponse))]
    [AWSCmdletOutput("Amazon.CodeBuild.Model.BatchGetBuildsResponse",
        "This cmdlet returns an Amazon.CodeBuild.Model.BatchGetBuildsResponse object containing multiple properties."
    )]
    public partial class GetCBBuildBatchCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the builds.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeBuild.Model.BatchGetBuildsResponse, GetCBBuildBatchCmdlet>(Select) ??
        ...
        private Amazon.CodeBuild.Model.BatchGetBuildsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.BatchGetBuildsRequest request)
        {
            ...
            try
            {
                return client.BatchGetBuildsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeBuild.Model.BatchGetBuildsResponse, GetCBBuildBatchCmdlet, object> Select { get; set; } =
