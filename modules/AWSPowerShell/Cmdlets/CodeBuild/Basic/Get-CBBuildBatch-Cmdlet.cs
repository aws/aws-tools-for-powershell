...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdletOutput("Amazon.CodeBuild.Model.BatchGetBuildsResponse",
        "This cmdlet returns an Amazon.CodeBuild.Model.BatchGetBuildsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
