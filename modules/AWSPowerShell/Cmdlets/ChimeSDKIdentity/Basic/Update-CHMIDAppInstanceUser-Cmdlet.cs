...
namespace Amazon.PowerShell.Cmdlets.CHMID
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Identity UpdateAppInstanceUser API operation.", Operation = new[] {"UpdateAppInstanceUser"}, SelectReturnType = typeof(Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse))]
    [AWSCmdletOutput("System.String or Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCHMIDAppInstanceUserCmdlet : AmazonChimeSDKIdentityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse).
        /// Specifying the name of a property of type Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHMIDAppInstanceUser (UpdateAppInstanceUser)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserRequest();
        ...
        private Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse CallAWSServiceOperation(IAmazonChimeSDKIdentity client, Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Identity", "UpdateAppInstanceUser");
            try
            {
                return client.UpdateAppInstanceUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Metadata { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.ChimeSDKIdentity.Model.UpdateAppInstanceUserResponse, UpdateCHMIDAppInstanceUserCmdlet, object> Select { get; set; } =
