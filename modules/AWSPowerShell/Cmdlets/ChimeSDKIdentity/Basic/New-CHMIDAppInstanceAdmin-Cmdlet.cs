...
namespace Amazon.PowerShell.Cmdlets.CHMID
{
    ...
    public partial class NewCHMIDAppInstanceAdminCmdlet : AmazonChimeSDKIdentityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminResponse).
        /// Specifying the name of a property of type Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CHMIDAppInstanceAdmin (CreateAppInstanceAdmin)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminResponse, NewCHMIDAppInstanceAdminCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminRequest();
        ...
        private Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminResponse CallAWSServiceOperation(IAmazonChimeSDKIdentity client, Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Identity", "CreateAppInstanceAdmin");
            try
            {
                return client.CreateAppInstanceAdminAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppInstanceAdminArn { get; set; }
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.ChimeSDKIdentity.Model.CreateAppInstanceAdminResponse, NewCHMIDAppInstanceAdminCmdlet, object> Select { get; set; } =
