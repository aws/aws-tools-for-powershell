...
{
    /// <summary>
    /// List all <c>AppInstanceUsers</c> created under a single <c>AppInstance</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCHMIDAppInstanceUserListCmdlet : AmazonChimeSDKIdentityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersResponse).
        /// Specifying the name of a property of type Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersResponse, GetCHMIDAppInstanceUserListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersRequest();
        ...
        private Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersResponse CallAWSServiceOperation(IAmazonChimeSDKIdentity client, Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Identity", "ListAppInstanceUsers");
            try
            {
                return client.ListAppInstanceUsersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ChimeSDKIdentity.Model.ListAppInstanceUsersResponse, GetCHMIDAppInstanceUserListCmdlet, object> Select { get; set; } =
