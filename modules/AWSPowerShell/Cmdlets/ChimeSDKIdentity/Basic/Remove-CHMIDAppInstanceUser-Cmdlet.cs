...
namespace Amazon.PowerShell.Cmdlets.CHMID
{
    ...
    public partial class RemoveCHMIDAppInstanceUserCmdlet : AmazonChimeSDKIdentityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMIDAppInstanceUser (DeleteAppInstanceUser)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserResponse, RemoveCHMIDAppInstanceUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserRequest();
        ...
        private Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserResponse CallAWSServiceOperation(IAmazonChimeSDKIdentity client, Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Identity", "DeleteAppInstanceUser");
            try
            {
                #if DESKTOP
                return client.DeleteAppInstanceUser(request);
                #elif CORECLR
                return client.DeleteAppInstanceUserAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceUserArn { get; set; }
            public System.Func<Amazon.ChimeSDKIdentity.Model.DeleteAppInstanceUserResponse, RemoveCHMIDAppInstanceUserCmdlet, object> Select { get; set; } =
