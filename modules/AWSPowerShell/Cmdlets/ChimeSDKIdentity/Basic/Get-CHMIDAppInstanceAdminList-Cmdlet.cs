...
{
    /// <summary>
    /// Returns a list of the administrators in the <c>AppInstance</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ChimeSDKIdentity.Model.ListAppInstanceAdminsResponse",
        "This cmdlet returns an Amazon.ChimeSDKIdentity.Model.ListAppInstanceAdminsResponse object containing multiple properties."
    )]
