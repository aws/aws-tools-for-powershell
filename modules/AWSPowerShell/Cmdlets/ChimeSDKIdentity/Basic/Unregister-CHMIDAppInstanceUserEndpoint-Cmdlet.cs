...
namespace Amazon.PowerShell.Cmdlets.CHMID
{
    ...
    public partial class UnregisterCHMIDAppInstanceUserEndpointCmdlet : AmazonChimeSDKIdentityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-CHMIDAppInstanceUserEndpoint (DeregisterAppInstanceUserEndpoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointResponse, UnregisterCHMIDAppInstanceUserEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointRequest();
        ...
        private Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointResponse CallAWSServiceOperation(IAmazonChimeSDKIdentity client, Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Identity", "DeregisterAppInstanceUserEndpoint");
            try
            {
                #if DESKTOP
                return client.DeregisterAppInstanceUserEndpoint(request);
                #elif CORECLR
                return client.DeregisterAppInstanceUserEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppInstanceUserArn { get; set; }
            public System.String EndpointId { get; set; }
            public System.Func<Amazon.ChimeSDKIdentity.Model.DeregisterAppInstanceUserEndpointResponse, UnregisterCHMIDAppInstanceUserEndpointCmdlet, object> Select { get; set; } =
