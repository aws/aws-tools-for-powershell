...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    /// associated with the cell into a single value.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPDCellReadinessSummaryCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        private Amazon.Route53RecoveryReadiness.Model.GetCellReadinessSummaryResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.GetCellReadinessSummaryRequest request)
        {
            ...
            try
            {
                return client.GetCellReadinessSummaryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
