...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    [AWSCmdletOutput("Amazon.Route53RecoveryReadiness.Model.GetCellReadinessSummaryResponse",
        "This cmdlet returns an Amazon.Route53RecoveryReadiness.Model.GetCellReadinessSummaryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
