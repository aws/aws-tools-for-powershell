...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    public partial class GetPDTagsForResourceListCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.ListTagsForResourcesResponse, GetPDTagsForResourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryReadiness.Model.ListTagsForResourcesRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.ListTagsForResourcesResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.ListTagsForResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "ListTagsForResources");
            try
            {
                return client.ListTagsForResourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.ListTagsForResourcesResponse, GetPDTagsForResourceListCmdlet, object> Select { get; set; } =
