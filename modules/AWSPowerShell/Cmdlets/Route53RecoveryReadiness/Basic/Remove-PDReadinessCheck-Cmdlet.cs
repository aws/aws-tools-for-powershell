...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    public partial class RemovePDReadinessCheckCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PDReadinessCheck (DeleteReadinessCheck)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.DeleteReadinessCheckResponse, RemovePDReadinessCheckCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryReadiness.Model.DeleteReadinessCheckRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.DeleteReadinessCheckResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.DeleteReadinessCheckRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "DeleteReadinessCheck");
            try
            {
                #if DESKTOP
                return client.DeleteReadinessCheck(request);
                #elif CORECLR
                return client.DeleteReadinessCheckAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ReadinessCheckName { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.DeleteReadinessCheckResponse, RemovePDReadinessCheckCmdlet, object> Select { get; set; } =
