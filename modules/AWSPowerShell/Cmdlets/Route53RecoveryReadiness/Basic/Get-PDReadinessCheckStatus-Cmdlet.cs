...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    [AWSCmdlet("Calls the AWS Route53 Recovery Readiness GetReadinessCheckStatus API operation.", Operation = new[] {"GetReadinessCheckStatus"}, SelectReturnType = typeof(Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse))]
    [AWSCmdletOutput("Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse",
        "This cmdlet returns an Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPDReadinessCheckStatusCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ReadinessCheckName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse, GetPDReadinessCheckStatusCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ReadinessCheckName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "GetReadinessCheckStatus");
            try
            {
                #if DESKTOP
                return client.GetReadinessCheckStatus(request);
                #elif CORECLR
                return client.GetReadinessCheckStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ReadinessCheckName { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.GetReadinessCheckStatusResponse, GetPDReadinessCheckStatusCmdlet, object> Select { get; set; } =
