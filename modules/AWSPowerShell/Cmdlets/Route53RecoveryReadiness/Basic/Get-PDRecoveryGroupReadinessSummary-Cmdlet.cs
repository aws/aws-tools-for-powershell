...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    /// of each one.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPDRecoveryGroupReadinessSummaryCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.GetRecoveryGroupReadinessSummaryResponse, GetPDRecoveryGroupReadinessSummaryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53RecoveryReadiness.Model.GetRecoveryGroupReadinessSummaryRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.GetRecoveryGroupReadinessSummaryResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.GetRecoveryGroupReadinessSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "GetRecoveryGroupReadinessSummary");
            try
            {
                return client.GetRecoveryGroupReadinessSummaryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RecoveryGroupName { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.GetRecoveryGroupReadinessSummaryResponse, GetPDRecoveryGroupReadinessSummaryCmdlet, object> Select { get; set; } =
