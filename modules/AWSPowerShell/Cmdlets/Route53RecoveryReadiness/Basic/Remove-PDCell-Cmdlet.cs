...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    public partial class RemovePDCellCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PDCell (DeleteCell)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.DeleteCellResponse, RemovePDCellCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryReadiness.Model.DeleteCellRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.DeleteCellResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.DeleteCellRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "DeleteCell");
            try
            {
                #if DESKTOP
                return client.DeleteCell(request);
                #elif CORECLR
                return client.DeleteCellAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CellName { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.DeleteCellResponse, RemovePDCellCmdlet, object> Select { get; set; } =
