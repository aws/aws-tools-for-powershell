...
{
    /// <summary>
    /// Lists the resource sets in an account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Route53RecoveryReadiness.Model.ResourceSetOutput or Amazon.Route53RecoveryReadiness.Model.ListResourceSetsResponse",
        ...
        "The service call response (type Amazon.Route53RecoveryReadiness.Model.ListResourceSetsResponse) can be returned by specifying '-Select *'."
    )]
