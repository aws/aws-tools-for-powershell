...
namespace Amazon.PowerShell.Cmdlets.PD
{
    ...
    public partial class GetPDCellCmdlet : AmazonRoute53RecoveryReadinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryReadiness.Model.GetCellResponse, GetPDCellCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryReadiness.Model.GetCellRequest();
        ...
        private Amazon.Route53RecoveryReadiness.Model.GetCellResponse CallAWSServiceOperation(IAmazonRoute53RecoveryReadiness client, Amazon.Route53RecoveryReadiness.Model.GetCellRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Readiness", "GetCell");
            try
            {
                return client.GetCellAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String CellName { get; set; }
            public System.Func<Amazon.Route53RecoveryReadiness.Model.GetCellResponse, GetPDCellCmdlet, object> Select { get; set; } =
