...
{
    [AWSClientCmdlet("AWS Route53 Recovery Readiness", "PD", "2019-12-02", "Route53RecoveryReadiness")]
    public abstract partial class AmazonRoute53RecoveryReadinessClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonRoute53RecoveryReadinessConfig.ServiceId.ToString();
