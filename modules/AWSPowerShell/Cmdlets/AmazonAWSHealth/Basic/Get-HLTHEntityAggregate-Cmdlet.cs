...
namespace Amazon.PowerShell.Cmdlets.HLTH
{
    ...
    [AWSCmdlet("Invokes the DescribeEntityAggregates operation against AWS Health.", Operation = new[] {"DescribeEntityAggregates"})]
    [AWSCmdletOutput("Amazon.AWSHealth.Model.EntityAggregate",
        "This cmdlet returns a collection of EntityAggregate objects.",
    ...
    public partial class GetHLTHEntityAggregateCmdlet : AmazonAWSHealthClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.EntityAggregates;
        ...
        private static Amazon.AWSHealth.Model.DescribeEntityAggregatesResponse CallAWSServiceOperation(IAmazonAWSHealth client, Amazon.AWSHealth.Model.DescribeEntityAggregatesRequest request)
        {
            #if DESKTOP
            return client.DescribeEntityAggregates(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeEntityAggregatesAsync(request);
            return task.Result;
            #else
