...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3TNamespace")]
    [OutputType("Amazon.S3Tables.Model.GetNamespaceResponse")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetNamespace API operation.", Operation = new[] {"GetNamespace"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetNamespaceResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.GetNamespaceResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.GetNamespaceResponse object containing multiple properties."
    )]
    public partial class GetS3TNamespaceCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetNamespaceResponse, GetS3TNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetNamespaceRequest();
        ...
        private Amazon.S3Tables.Model.GetNamespaceResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetNamespace");
            try
            {
                return client.GetNamespaceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetNamespaceResponse, GetS3TNamespaceCmdlet, object> Select { get; set; } =
