...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Remove", "S3TTableBucketReplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Tables DeleteTableBucketReplication API operation.", Operation = new[] {"DeleteTableBucketReplication"}, SelectReturnType = typeof(Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse))]
    [AWSCmdletOutput("None or Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveS3TTableBucketReplicationCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        /// ensure you're deleting the expected version of the configuration.</para>
        /// </para>
        /// </summary>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3TTableBucketReplication (DeleteTableBucketReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse, RemoveS3TTableBucketReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.DeleteTableBucketReplicationRequest();
        ...
        private Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.DeleteTableBucketReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "DeleteTableBucketReplication");
            try
            {
                #if DESKTOP
                return client.DeleteTableBucketReplication(request);
                #elif CORECLR
                return client.DeleteTableBucketReplicationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TableBucketARN { get; set; }
            public System.String VersionToken { get; set; }
            public System.Func<Amazon.S3Tables.Model.DeleteTableBucketReplicationResponse, RemoveS3TTableBucketReplicationCmdlet, object> Select { get; set; } =
