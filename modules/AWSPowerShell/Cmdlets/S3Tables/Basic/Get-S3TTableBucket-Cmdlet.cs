...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3TTableBucket")]
    [OutputType("Amazon.S3Tables.Model.GetTableBucketResponse")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetTableBucket API operation.", Operation = new[] {"GetTableBucket"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTableBucketResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.GetTableBucketResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.GetTableBucketResponse object containing multiple properties."
    )]
    public partial class GetS3TTableBucketCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTableBucketResponse, GetS3TTableBucketCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTableBucketRequest();
        ...
        private Amazon.S3Tables.Model.GetTableBucketResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTableBucketRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTableBucket");
            try
            {
                #if DESKTOP
                return client.GetTableBucket(request);
                #elif CORECLR
                return client.GetTableBucketAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTableBucketResponse, GetS3TTableBucketCmdlet, object> Select { get; set; } =
