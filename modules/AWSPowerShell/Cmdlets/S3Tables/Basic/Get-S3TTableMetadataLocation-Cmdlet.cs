...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    [AWSCmdlet("Calls the Amazon S3 Tables GetTableMetadataLocation API operation.", Operation = new[] {"GetTableMetadataLocation"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTableMetadataLocationResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.GetTableMetadataLocationResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.GetTableMetadataLocationResponse object containing multiple properties."
    )]
    public partial class GetS3TTableMetadataLocationCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTableMetadataLocationResponse, GetS3TTableMetadataLocationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTableMetadataLocationRequest();
        ...
        private Amazon.S3Tables.Model.GetTableMetadataLocationResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTableMetadataLocationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTableMetadataLocation");
            try
            {
                #if DESKTOP
                return client.GetTableMetadataLocation(request);
                #elif CORECLR
                return client.GetTableMetadataLocationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTableMetadataLocationResponse, GetS3TTableMetadataLocationCmdlet, object> Select { get; set; } =
