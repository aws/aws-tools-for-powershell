...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </summary>
    [Cmdlet("Get", "S3TTableBucketPolicy")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetTableBucketPolicy API operation.", Operation = new[] {"GetTableBucketPolicy"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTableBucketPolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.S3Tables.Model.GetTableBucketPolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.S3Tables.Model.GetTableBucketPolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3TTableBucketPolicyCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTableBucketPolicyResponse, GetS3TTableBucketPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTableBucketPolicyRequest();
        ...
        private Amazon.S3Tables.Model.GetTableBucketPolicyResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTableBucketPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTableBucketPolicy");
            try
            {
                #if DESKTOP
                return client.GetTableBucketPolicy(request);
                #elif CORECLR
                return client.GetTableBucketPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTableBucketPolicyResponse, GetS3TTableBucketPolicyCmdlet, object> Select { get; set; } =
