...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3TTableStorageClass")]
    [OutputType("Amazon.S3Tables.Model.StorageClassConfiguration")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetTableStorageClass API operation.", Operation = new[] {"GetTableStorageClass"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTableStorageClassResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.StorageClassConfiguration or Amazon.S3Tables.Model.GetTableStorageClassResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.StorageClassConfiguration object.",
        "The service call response (type Amazon.S3Tables.Model.GetTableStorageClassResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3TTableStorageClassCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.S3Tables.Model.GetTableStorageClassResponse).
        /// Specifying the name of a property of type Amazon.S3Tables.Model.GetTableStorageClassResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTableStorageClassResponse, GetS3TTableStorageClassCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTableStorageClassRequest();
        ...
        private Amazon.S3Tables.Model.GetTableStorageClassResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTableStorageClassRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTableStorageClass");
            try
            {
                #if DESKTOP
                return client.GetTableStorageClass(request);
                #elif CORECLR
                return client.GetTableStorageClassAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTableStorageClassResponse, GetS3TTableStorageClassCmdlet, object> Select { get; set; } =
