...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Remove", "S3TTablePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Tables DeleteTablePolicy API operation.", Operation = new[] {"DeleteTablePolicy"}, SelectReturnType = typeof(Amazon.S3Tables.Model.DeleteTablePolicyResponse))]
    [AWSCmdletOutput("None or Amazon.S3Tables.Model.DeleteTablePolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Tables.Model.DeleteTablePolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveS3TTablePolicyCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3TTablePolicy (DeleteTablePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.DeleteTablePolicyResponse, RemoveS3TTablePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.DeleteTablePolicyRequest();
        ...
        private Amazon.S3Tables.Model.DeleteTablePolicyResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.DeleteTablePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "DeleteTablePolicy");
            try
            {
                #if DESKTOP
                return client.DeleteTablePolicy(request);
                #elif CORECLR
                return client.DeleteTablePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.DeleteTablePolicyResponse, RemoveS3TTablePolicyCmdlet, object> Select { get; set; } =
