...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// table.
    /// </summary>
    [Cmdlet("Write", "S3TTablePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Tables PutTablePolicy API operation.", Operation = new[] {"PutTablePolicy"}, SelectReturnType = typeof(Amazon.S3Tables.Model.PutTablePolicyResponse))]
    [AWSCmdletOutput("None or Amazon.S3Tables.Model.PutTablePolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Tables.Model.PutTablePolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteS3TTablePolicyCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Number (ARN) of the table bucket that contains the table.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-S3TTablePolicy (PutTablePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.PutTablePolicyResponse, WriteS3TTablePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.PutTablePolicyRequest();
        ...
        private Amazon.S3Tables.Model.PutTablePolicyResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.PutTablePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "PutTablePolicy");
            try
            {
                #if DESKTOP
                return client.PutTablePolicy(request);
                #elif CORECLR
                return client.PutTablePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourcePolicy { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.PutTablePolicyResponse, WriteS3TTablePolicyCmdlet, object> Select { get; set; } =
