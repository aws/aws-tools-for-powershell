...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    [AWSCmdlet("Calls the Amazon S3 Tables CreateNamespace API operation.", Operation = new[] {"CreateNamespace"}, SelectReturnType = typeof(Amazon.S3Tables.Model.CreateNamespaceResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.CreateNamespaceResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.CreateNamespaceResponse object containing multiple properties."
    )]
    public partial class NewS3TNamespaceCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A name for the namespace.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-S3TNamespace (CreateNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.CreateNamespaceResponse, NewS3TNamespaceCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Namespace != null)
            {
                context.Namespace = new List<System.String>(this.Namespace);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.CreateNamespaceRequest();
        ...
        private Amazon.S3Tables.Model.CreateNamespaceResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.CreateNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "CreateNamespace");
            try
            {
        ...
        {
            public List<System.String> Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.CreateNamespaceResponse, NewS3TNamespaceCmdlet, object> Select { get; set; } =
