...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </summary>
    [Cmdlet("Remove", "S3TTableBucket", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Tables DeleteTableBucket API operation.", Operation = new[] {"DeleteTableBucket"}, SelectReturnType = typeof(Amazon.S3Tables.Model.DeleteTableBucketResponse))]
    [AWSCmdletOutput("None or Amazon.S3Tables.Model.DeleteTableBucketResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Tables.Model.DeleteTableBucketResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveS3TTableBucketCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3TTableBucket (DeleteTableBucket)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.DeleteTableBucketResponse, RemoveS3TTableBucketCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.DeleteTableBucketRequest();
        ...
        private Amazon.S3Tables.Model.DeleteTableBucketResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.DeleteTableBucketRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "DeleteTableBucket");
            try
            {
                #if DESKTOP
                return client.DeleteTableBucket(request);
                #elif CORECLR
                return client.DeleteTableBucketAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.DeleteTableBucketResponse, RemoveS3TTableBucketCmdlet, object> Select { get; set; } =
