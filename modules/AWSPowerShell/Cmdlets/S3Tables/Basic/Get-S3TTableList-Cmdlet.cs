...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    public partial class GetS3TTableListCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            #if !MODULAR
            if (ParameterWasBound(nameof(this.MaxTable)) && this.MaxTable.HasValue)
            {
                WriteWarning("AWSPowerShell and AWSPowerShell.NetCore use the MaxTable parameter to limit the total number of items returned by the cmdlet." +
                    " This behavior is obsolete and will be removed in a future version of these modules. Pipe the output of this cmdlet into Select-Object -First to terminate" +
                    " retrieving data pages early and control the number of items returned. AWS.Tools already implements the new behavior of simply passing MaxTable" +
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.MaxTables = AutoIterationHelpers.ConvertEmitLimitToServiceTypeInt32(cmdletContext.MaxTable.Value);
            }
