...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </summary>
    [Cmdlet("Get", "S3TTablePolicy")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetTablePolicy API operation.", Operation = new[] {"GetTablePolicy"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTablePolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.S3Tables.Model.GetTablePolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.S3Tables.Model.GetTablePolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3TTablePolicyCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTablePolicyResponse, GetS3TTablePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTablePolicyRequest();
        ...
        private Amazon.S3Tables.Model.GetTablePolicyResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTablePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTablePolicy");
            try
            {
                #if DESKTOP
                return client.GetTablePolicy(request);
                #elif CORECLR
                return client.GetTablePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTablePolicyResponse, GetS3TTablePolicyCmdlet, object> Select { get; set; } =
