...
namespace Amazon.PowerShell.Cmdlets.S3T
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3TTableMaintenanceJobStatus")]
    [OutputType("Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse")]
    [AWSCmdlet("Calls the Amazon S3 Tables GetTableMaintenanceJobStatus API operation.", Operation = new[] {"GetTableMaintenanceJobStatus"}, SelectReturnType = typeof(Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse))]
    [AWSCmdletOutput("Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse",
        "This cmdlet returns an Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse object containing multiple properties."
    )]
    public partial class GetS3TTableMaintenanceJobStatusCmdlet : AmazonS3TablesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse, GetS3TTableMaintenanceJobStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Tables.Model.GetTableMaintenanceJobStatusRequest();
        ...
        private Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse CallAWSServiceOperation(IAmazonS3Tables client, Amazon.S3Tables.Model.GetTableMaintenanceJobStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Tables", "GetTableMaintenanceJobStatus");
            try
            {
                #if DESKTOP
                return client.GetTableMaintenanceJobStatus(request);
                #elif CORECLR
                return client.GetTableMaintenanceJobStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String TableBucketARN { get; set; }
            public System.Func<Amazon.S3Tables.Model.GetTableMaintenanceJobStatusResponse, GetS3TTableMaintenanceJobStatusCmdlet, object> Select { get; set; } =
