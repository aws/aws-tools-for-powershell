...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [AWSCmdlet("Invokes the UpdateComputeEnvironment operation against AWS Batch.", Operation = new[] {"UpdateComputeEnvironment"})]
    ...
    public partial class UpdateBATComputeEnvironmentCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name or full Amazon Resource Name (ARN) of the IAM role that allows AWS Batch
        /// to make calls to ECS, Auto Scaling, and EC2 on your behalf.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        private static Amazon.Batch.Model.UpdateComputeEnvironmentResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.UpdateComputeEnvironmentRequest request)
        {
            #if DESKTOP
