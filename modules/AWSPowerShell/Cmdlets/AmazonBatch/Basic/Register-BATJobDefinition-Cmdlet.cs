...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [AWSCmdlet("Invokes the RegisterJobDefinition operation against AWS Batch.", Operation = new[] {"RegisterJobDefinition"})]
    ...
    public partial class RegisterBATJobDefinitionCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Batch.Model.RegisterJobDefinitionResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.RegisterJobDefinitionRequest request)
        {
            #if DESKTOP
