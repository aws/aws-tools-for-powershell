...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [AWSCmdlet("Calls the AWS Batch DescribeJobQueues API operation.", Operation = new[] {"DescribeJobQueues"})]
    [AWSCmdletOutput("Amazon.Batch.Model.JobQueueDetail",
        "This cmdlet returns a collection of JobQueueDetail objects.",
    ...
    public partial class GetBATJobQueueCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.JobQueues = new List<System.String>(this.JobQueue);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.JobQueues != null)
            {
                request.JobQueues = cmdletContext.JobQueues;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.JobQueues;
        ...
        {
            public List<System.String> JobQueues { get; set; }
