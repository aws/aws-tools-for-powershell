...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    public partial class GetBATComputeEnvironmentCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ComputeEnvironments = new List<System.String>(this.ComputeEnvironment);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ComputeEnvironments != null)
            {
                request.ComputeEnvironments = cmdletContext.ComputeEnvironments;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ComputeEnvironments;
        ...
        {
            public List<System.String> ComputeEnvironments { get; set; }
