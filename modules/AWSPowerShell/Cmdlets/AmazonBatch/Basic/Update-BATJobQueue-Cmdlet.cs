...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [AWSCmdlet("Invokes the UpdateJobQueue operation against AWS Batch.", Operation = new[] {"UpdateJobQueue"})]
    ...
    public partial class UpdateBATJobQueueCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Batch.Model.UpdateJobQueueResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.UpdateJobQueueRequest request)
        {
            #if DESKTOP
