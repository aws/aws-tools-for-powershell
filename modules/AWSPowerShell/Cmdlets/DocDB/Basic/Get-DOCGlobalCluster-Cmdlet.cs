...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdletOutput("Amazon.DocDB.Model.GlobalCluster or Amazon.DocDB.Model.DescribeGlobalClustersResponse",
        ...
        "The service call response (type Amazon.DocDB.Model.DescribeGlobalClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
