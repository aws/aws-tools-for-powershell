...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    public partial class RemoveDOCResourceTagCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.RemoveTagsFromResourceResponse, RemoveDOCResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "RemoveTagsFromResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DocDB.Model.RemoveTagsFromResourceResponse, RemoveDOCResourceTagCmdlet, object> Select { get; set; } =
