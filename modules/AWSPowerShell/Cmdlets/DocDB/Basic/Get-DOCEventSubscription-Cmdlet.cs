...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdletOutput("Amazon.DocDB.Model.EventSubscription or Amazon.DocDB.Model.DescribeEventSubscriptionsResponse",
        ...
        "The service call response (type Amazon.DocDB.Model.DescribeEventSubscriptionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
