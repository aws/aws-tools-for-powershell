...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    /// subscription.
    /// </summary>
    [Cmdlet("Remove", "DOCSourceIdentifierFromSubscription", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveDOCSourceIdentifierFromSubscriptionCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DOCSourceIdentifierFromSubscription (RemoveSourceIdentifierFromSubscription)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.RemoveSourceIdentifierFromSubscriptionResponse, RemoveDOCSourceIdentifierFromSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DocDB.Model.RemoveSourceIdentifierFromSubscriptionRequest();
        ...
        private Amazon.DocDB.Model.RemoveSourceIdentifierFromSubscriptionResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.RemoveSourceIdentifierFromSubscriptionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "RemoveSourceIdentifierFromSubscription");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SourceIdentifier { get; set; }
            public System.String SubscriptionName { get; set; }
            public System.Func<Amazon.DocDB.Model.RemoveSourceIdentifierFromSubscriptionResponse, RemoveDOCSourceIdentifierFromSubscriptionCmdlet, object> Select { get; set; } =
