...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    public partial class NewDOCDBSubnetGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to be assigned to the subnet group.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DOCDBSubnetGroup (CreateDBSubnetGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.CreateDBSubnetGroupResponse, NewDOCDBSubnetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DocDB.Model.CreateDBSubnetGroupRequest();
        ...
        private Amazon.DocDB.Model.CreateDBSubnetGroupResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.CreateDBSubnetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "CreateDBSubnetGroup");
            try
            {
                return client.CreateDBSubnetGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DocDB.Model.CreateDBSubnetGroupResponse, NewDOCDBSubnetGroupCmdlet, object> Select { get; set; } =
