...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdletOutput("Amazon.DocDB.Model.DBInstance or Amazon.DocDB.Model.CreateDBInstanceResponse",
        ...
        "The service call response (type Amazon.DocDB.Model.CreateDBInstanceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewDOCDBInstanceCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The CA certificate identifier to use for the DB instance's server certificate.</para><para>For more information, see <a href="https://docs.aws.amazon.com/documentdb/latest/devguide/ca_cert_rotation.html">Updating
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to be assigned to the instance. You can assign up to 10 tags to an instance.</para><para />
