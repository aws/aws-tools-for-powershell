...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    public partial class GetDOCResourceTagCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.ListTagsForResourceResponse, GetDOCResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.DocDB.Model.ListTagsForResourceResponse, GetDOCResourceTagCmdlet, object> Select { get; set; } =
