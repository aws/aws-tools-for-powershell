...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    public partial class RemoveDOCDBInstanceCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DOCDBInstance (DeleteDBInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.DeleteDBInstanceResponse, RemoveDOCDBInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DocDB.Model.DeleteDBInstanceRequest();
        ...
        private Amazon.DocDB.Model.DeleteDBInstanceResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.DeleteDBInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "DeleteDBInstance");
            try
            {
                return client.DeleteDBInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DBInstanceIdentifier { get; set; }
            public System.Func<Amazon.DocDB.Model.DeleteDBInstanceResponse, RemoveDOCDBInstanceCmdlet, object> Select { get; set; } =
