...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    public partial class EditDOCEventSubscriptionCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        /// If this value is not specified, all events are returned.</para><para>Valid values: <code>db-instance</code>, <code>db-parameter-group</code>, <code>db-security-group</code>,
