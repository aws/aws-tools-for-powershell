...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB (with MongoDB compatibility) DescribeDBClusters API operation.", Operation = new[] {"DescribeDBClusters"}, SelectReturnType = typeof(Amazon.DocDB.Model.DescribeDBClustersResponse))]
    [AWSCmdletOutput("Amazon.DocDB.Model.DBCluster or Amazon.DocDB.Model.DescribeDBClustersResponse",
        "This cmdlet returns a collection of Amazon.DocDB.Model.DBCluster objects.",
        "The service call response (type Amazon.DocDB.Model.DescribeDBClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDOCDBClusterCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DBClusters";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDB.Model.DescribeDBClustersResponse, GetDOCDBClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DocDB.Model.DescribeDBClustersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DBClusters?.Count ?? 0;
        ...
        private Amazon.DocDB.Model.DescribeDBClustersResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.DescribeDBClustersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB (with MongoDB compatibility)", "DescribeDBClusters");
            try
            {
                #if DESKTOP
                return client.DescribeDBClusters(request);
                #elif CORECLR
                return client.DescribeDBClustersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.DocDB.Model.DescribeDBClustersResponse, GetDOCDBClusterCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DBClusters;
        }
