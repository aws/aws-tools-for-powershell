...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNAccountAssignmentCreationStatusList")]
    [OutputType("Amazon.SSOAdmin.Model.AccountAssignmentOperationStatusMetadata")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin ListAccountAssignmentCreationStatus API operation.", Operation = new[] {"ListAccountAssignmentCreationStatus"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.AccountAssignmentOperationStatusMetadata or Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse",
        "This cmdlet returns a collection of Amazon.SSOAdmin.Model.AccountAssignmentOperationStatusMetadata objects.",
        "The service call response (type Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNAccountAssignmentCreationStatusListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccountAssignmentsCreationStatus";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse, GetSSOADMNAccountAssignmentCreationStatusListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusRequest();
        ...
        private Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListAccountAssignmentCreationStatus");
            try
            {
                #if DESKTOP
                return client.ListAccountAssignmentCreationStatus(request);
                #elif CORECLR
                return client.ListAccountAssignmentCreationStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListAccountAssignmentCreationStatusResponse, GetSSOADMNAccountAssignmentCreationStatusListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccountAssignmentsCreationStatus;
        }
