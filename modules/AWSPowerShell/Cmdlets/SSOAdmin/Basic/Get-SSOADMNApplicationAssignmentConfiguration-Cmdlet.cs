...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNApplicationAssignmentConfiguration")]
    ...
    public partial class GetSSOADMNApplicationAssignmentConfigurationCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.GetApplicationAssignmentConfigurationRequest();
        ...
        private Amazon.SSOAdmin.Model.GetApplicationAssignmentConfigurationResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.GetApplicationAssignmentConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "GetApplicationAssignmentConfiguration");
            try
            {
                #if DESKTOP
                return client.GetApplicationAssignmentConfiguration(request);
                #elif CORECLR
                return client.GetApplicationAssignmentConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApplicationArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.GetApplicationAssignmentConfigurationResponse, GetSSOADMNApplicationAssignmentConfigurationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AssignmentRequired;
        }
