...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSOADMNInlinePolicyFromPermissionSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSOADMNInlinePolicyFromPermissionSetCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSOADMNInlinePolicyFromPermissionSet (DeleteInlinePolicyFromPermissionSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DeleteInlinePolicyFromPermissionSetResponse, RemoveSSOADMNInlinePolicyFromPermissionSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DeleteInlinePolicyFromPermissionSetRequest();
        ...
        private Amazon.SSOAdmin.Model.DeleteInlinePolicyFromPermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteInlinePolicyFromPermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DeleteInlinePolicyFromPermissionSet");
            try
            {
                #if DESKTOP
                return client.DeleteInlinePolicyFromPermissionSet(request);
                #elif CORECLR
                return client.DeleteInlinePolicyFromPermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceArn { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DeleteInlinePolicyFromPermissionSetResponse, RemoveSSOADMNInlinePolicyFromPermissionSetCmdlet, object> Select { get; set; } =
