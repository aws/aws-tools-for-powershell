...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNTrustedTokenIssuerList")]
    [OutputType("Amazon.SSOAdmin.Model.TrustedTokenIssuerMetadata")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin ListTrustedTokenIssuers API operation.", Operation = new[] {"ListTrustedTokenIssuers"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.TrustedTokenIssuerMetadata or Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse",
        "This cmdlet returns a collection of Amazon.SSOAdmin.Model.TrustedTokenIssuerMetadata objects.",
        "The service call response (type Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNTrustedTokenIssuerListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TrustedTokenIssuers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse, GetSSOADMNTrustedTokenIssuerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListTrustedTokenIssuersRequest();
        ...
        private Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListTrustedTokenIssuersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListTrustedTokenIssuers");
            try
            {
                #if DESKTOP
                return client.ListTrustedTokenIssuers(request);
                #elif CORECLR
                return client.ListTrustedTokenIssuersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListTrustedTokenIssuersResponse, GetSSOADMNTrustedTokenIssuerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TrustedTokenIssuers;
        }
