...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNApplicationAuthenticationMethod")]
    [OutputType("Amazon.SSOAdmin.Model.AuthenticationMethod")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin GetApplicationAuthenticationMethod API operation.", Operation = new[] {"GetApplicationAuthenticationMethod"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.AuthenticationMethod or Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse",
        "This cmdlet returns an Amazon.SSOAdmin.Model.AuthenticationMethod object.",
        "The service call response (type Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNApplicationAuthenticationMethodCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AuthenticationMethod";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse, GetSSOADMNApplicationAuthenticationMethodCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodRequest();
        ...
        private Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "GetApplicationAuthenticationMethod");
            try
            {
                #if DESKTOP
                return client.GetApplicationAuthenticationMethod(request);
                #elif CORECLR
                return client.GetApplicationAuthenticationMethodAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public Amazon.SSOAdmin.AuthenticationMethodType AuthenticationMethodType { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.GetApplicationAuthenticationMethodResponse, GetSSOADMNApplicationAuthenticationMethodCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AuthenticationMethod;
        }
