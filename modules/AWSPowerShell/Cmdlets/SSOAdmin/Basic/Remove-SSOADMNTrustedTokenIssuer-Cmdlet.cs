...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    public partial class RemoveSSOADMNTrustedTokenIssuerCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TrustedTokenIssuerArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TrustedTokenIssuerArn;
            }
        ...
        private Amazon.SSOAdmin.Model.DeleteTrustedTokenIssuerResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteTrustedTokenIssuerRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteTrustedTokenIssuer(request);
                #elif CORECLR
                return client.DeleteTrustedTokenIssuerAsync(request).GetAwaiter().GetResult();
                #else
