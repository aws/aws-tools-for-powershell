...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNApplicationAssignmentList")]
    [OutputType("Amazon.SSOAdmin.Model.ApplicationAssignment")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin ListApplicationAssignments API operation.", Operation = new[] {"ListApplicationAssignments"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.ApplicationAssignment or Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse",
        "This cmdlet returns a collection of Amazon.SSOAdmin.Model.ApplicationAssignment objects.",
        "The service call response (type Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNApplicationAssignmentListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse, GetSSOADMNApplicationAssignmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListApplicationAssignmentsRequest();
        ...
        private Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListApplicationAssignmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListApplicationAssignments");
            try
            {
                #if DESKTOP
                return client.ListApplicationAssignments(request);
                #elif CORECLR
                return client.ListApplicationAssignmentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListApplicationAssignmentsResponse, GetSSOADMNApplicationAssignmentListCmdlet, object> Select { get; set; } =
