...
{
    /// <summary>
    /// Lists the assignee of the specified AWS account with the specified permission set.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SSOADMNAccountAssignmentList")]
    [OutputType("Amazon.SSOAdmin.Model.AccountAssignment")]
    ...
    public partial class GetSSOADMNAccountAssignmentListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListAccountAssignmentsResponse, GetSSOADMNAccountAssignmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListAccountAssignmentsRequest();
        ...
        private Amazon.SSOAdmin.Model.ListAccountAssignmentsResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListAccountAssignmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListAccountAssignments");
            try
            {
                #if DESKTOP
                return client.ListAccountAssignments(request);
                #elif CORECLR
                return client.ListAccountAssignmentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListAccountAssignmentsResponse, GetSSOADMNAccountAssignmentListCmdlet, object> Select { get; set; } =
