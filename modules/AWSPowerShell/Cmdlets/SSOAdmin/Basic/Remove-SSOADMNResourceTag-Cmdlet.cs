...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    [AWSCmdletOutput("None or Amazon.SSOAdmin.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.SSOAdmin.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
