...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSOADMNApplicationAccessScope", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSOADMNApplicationAccessScopeCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSOADMNApplicationAccessScope (DeleteApplicationAccessScope)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DeleteApplicationAccessScopeResponse, RemoveSSOADMNApplicationAccessScopeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DeleteApplicationAccessScopeRequest();
        ...
        private Amazon.SSOAdmin.Model.DeleteApplicationAccessScopeResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteApplicationAccessScopeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DeleteApplicationAccessScope");
            try
            {
                #if DESKTOP
                return client.DeleteApplicationAccessScope(request);
                #elif CORECLR
                return client.DeleteApplicationAccessScopeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public System.String Scope { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DeleteApplicationAccessScopeResponse, RemoveSSOADMNApplicationAccessScopeCmdlet, object> Select { get; set; } =
