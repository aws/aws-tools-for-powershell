...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Update", "SSOADMNPermissionSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateSSOADMNPermissionSetCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SSOADMNPermissionSet (UpdatePermissionSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.UpdatePermissionSetResponse, UpdateSSOADMNPermissionSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.UpdatePermissionSetRequest();
        ...
        private Amazon.SSOAdmin.Model.UpdatePermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.UpdatePermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "UpdatePermissionSet");
            try
            {
                #if DESKTOP
                return client.UpdatePermissionSet(request);
                #elif CORECLR
                return client.UpdatePermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RelayState { get; set; }
            public System.String SessionDuration { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.UpdatePermissionSetResponse, UpdateSSOADMNPermissionSetCmdlet, object> Select { get; set; } =
