...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Dismount", "SSOADMNCustomerManagedPolicyReferenceFromPermissionSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class DismountSSOADMNCustomerManagedPolicyReferenceFromPermissionSetCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Dismount-SSOADMNCustomerManagedPolicyReferenceFromPermissionSet (DetachCustomerManagedPolicyReferenceFromPermissionSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse, DismountSSOADMNCustomerManagedPolicyReferenceFromPermissionSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest();
        ...
        private Amazon.SSOAdmin.Model.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DetachCustomerManagedPolicyReferenceFromPermissionSet");
            try
            {
                #if DESKTOP
                return client.DetachCustomerManagedPolicyReferenceFromPermissionSet(request);
                #elif CORECLR
                return client.DetachCustomerManagedPolicyReferenceFromPermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceArn { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse, DismountSSOADMNCustomerManagedPolicyReferenceFromPermissionSetCmdlet, object> Select { get; set; } =
