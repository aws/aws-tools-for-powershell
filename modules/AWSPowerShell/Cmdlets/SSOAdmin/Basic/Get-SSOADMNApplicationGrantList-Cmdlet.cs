...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNApplicationGrantList")]
    [OutputType("Amazon.SSOAdmin.Model.GrantItem")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin ListApplicationGrants API operation.", Operation = new[] {"ListApplicationGrants"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.ListApplicationGrantsResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.GrantItem or Amazon.SSOAdmin.Model.ListApplicationGrantsResponse",
        "This cmdlet returns a collection of Amazon.SSOAdmin.Model.GrantItem objects.",
        "The service call response (type Amazon.SSOAdmin.Model.ListApplicationGrantsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNApplicationGrantListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListApplicationGrantsResponse, GetSSOADMNApplicationGrantListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListApplicationGrantsRequest();
        ...
        private Amazon.SSOAdmin.Model.ListApplicationGrantsResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListApplicationGrantsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListApplicationGrants");
            try
            {
                #if DESKTOP
                return client.ListApplicationGrants(request);
                #elif CORECLR
                return client.ListApplicationGrantsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListApplicationGrantsResponse, GetSSOADMNApplicationGrantListCmdlet, object> Select { get; set; } =
