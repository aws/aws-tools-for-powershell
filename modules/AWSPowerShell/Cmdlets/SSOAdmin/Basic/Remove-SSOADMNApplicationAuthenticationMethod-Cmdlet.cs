...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSOADMNApplicationAuthenticationMethod", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSOADMNApplicationAuthenticationMethodCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSOADMNApplicationAuthenticationMethod (DeleteApplicationAuthenticationMethod)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DeleteApplicationAuthenticationMethodResponse, RemoveSSOADMNApplicationAuthenticationMethodCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DeleteApplicationAuthenticationMethodRequest();
        ...
        private Amazon.SSOAdmin.Model.DeleteApplicationAuthenticationMethodResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteApplicationAuthenticationMethodRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DeleteApplicationAuthenticationMethod");
            try
            {
                #if DESKTOP
                return client.DeleteApplicationAuthenticationMethod(request);
                #elif CORECLR
                return client.DeleteApplicationAuthenticationMethodAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public Amazon.SSOAdmin.AuthenticationMethodType AuthenticationMethodType { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DeleteApplicationAuthenticationMethodResponse, RemoveSSOADMNApplicationAuthenticationMethodCmdlet, object> Select { get; set; } =
