...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSOADMNInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSOADMNInstanceCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSOADMNInstance (DeleteInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DeleteInstanceResponse, RemoveSSOADMNInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DeleteInstanceRequest();
        ...
        private Amazon.SSOAdmin.Model.DeleteInstanceResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DeleteInstance");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String InstanceArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DeleteInstanceResponse, RemoveSSOADMNInstanceCmdlet, object> Select { get; set; } =
