...
{
    /// <summary>
    /// Lists the AWS managed policy that is attached to a specified permission set.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SSOADMNManagedPoliciesInPermissionSetList")]
    [OutputType("Amazon.SSOAdmin.Model.AttachedManagedPolicy")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin ListManagedPoliciesInPermissionSet API operation.", Operation = new[] {"ListManagedPoliciesInPermissionSet"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse))]
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.AttachedManagedPolicy or Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse",
        "This cmdlet returns a collection of Amazon.SSOAdmin.Model.AttachedManagedPolicy objects.",
        "The service call response (type Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNManagedPoliciesInPermissionSetListCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AttachedManagedPolicies";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse, GetSSOADMNManagedPoliciesInPermissionSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetRequest();
        ...
        private Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "ListManagedPoliciesInPermissionSet");
            try
            {
                #if DESKTOP
                return client.ListManagedPoliciesInPermissionSet(request);
                #elif CORECLR
                return client.ListManagedPoliciesInPermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.ListManagedPoliciesInPermissionSetResponse, GetSSOADMNManagedPoliciesInPermissionSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AttachedManagedPolicies;
        }
