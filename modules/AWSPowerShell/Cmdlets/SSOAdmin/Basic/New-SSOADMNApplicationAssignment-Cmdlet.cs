...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("New", "SSOADMNApplicationAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin CreateApplicationAssignment API operation.", Operation = new[] {"CreateApplicationAssignment"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse))]
    [AWSCmdletOutput("None or Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSSOADMNApplicationAssignmentCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SSOADMNApplicationAssignment (CreateApplicationAssignment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse, NewSSOADMNApplicationAssignmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.CreateApplicationAssignmentRequest();
        ...
        private Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.CreateApplicationAssignmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "CreateApplicationAssignment");
            try
            {
                #if DESKTOP
                return client.CreateApplicationAssignment(request);
                #elif CORECLR
                return client.CreateApplicationAssignmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public Amazon.SSOAdmin.PrincipalType PrincipalType { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.CreateApplicationAssignmentResponse, NewSSOADMNApplicationAssignmentCmdlet, object> Select { get; set; } =
