...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSOADMNApplicationGrant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin DeleteApplicationGrant API operation.", Operation = new[] {"DeleteApplicationGrant"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse))]
    [AWSCmdletOutput("None or Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSSOADMNApplicationGrantCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSOADMNApplicationGrant (DeleteApplicationGrant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse, RemoveSSOADMNApplicationGrantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.DeleteApplicationGrantRequest();
        ...
        private Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.DeleteApplicationGrantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "DeleteApplicationGrant");
            try
            {
                #if DESKTOP
                return client.DeleteApplicationGrant(request);
                #elif CORECLR
                return client.DeleteApplicationGrantAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public Amazon.SSOAdmin.GrantType GrantType { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.DeleteApplicationGrantResponse, RemoveSSOADMNApplicationGrantCmdlet, object> Select { get; set; } =
