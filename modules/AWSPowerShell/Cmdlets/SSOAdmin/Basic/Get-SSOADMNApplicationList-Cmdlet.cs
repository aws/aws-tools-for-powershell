...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    [AWSCmdletOutput("Amazon.SSOAdmin.Model.Application or Amazon.SSOAdmin.Model.ListApplicationsResponse",
        ...
        "The service call response (type Amazon.SSOAdmin.Model.ListApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
