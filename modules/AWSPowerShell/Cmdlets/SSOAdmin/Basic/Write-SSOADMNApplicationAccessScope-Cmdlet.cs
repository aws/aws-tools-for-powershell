...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    [AWSCmdletOutput("None or Amazon.SSOAdmin.Model.PutApplicationAccessScopeResponse",
        ...
        "The service response (type Amazon.SSOAdmin.Model.PutApplicationAccessScopeResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
