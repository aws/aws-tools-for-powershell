...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNApplicationGrant")]
    [OutputType("Amazon.SSOAdmin.Model.Grant")]
    ...
    public partial class GetSSOADMNApplicationGrantCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.GetApplicationGrantResponse, GetSSOADMNApplicationGrantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.GetApplicationGrantRequest();
        ...
        private Amazon.SSOAdmin.Model.GetApplicationGrantResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.GetApplicationGrantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "GetApplicationGrant");
            try
            {
                #if DESKTOP
                return client.GetApplicationGrant(request);
                #elif CORECLR
                return client.GetApplicationGrantAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationArn { get; set; }
            public Amazon.SSOAdmin.GrantType GrantType { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.GetApplicationGrantResponse, GetSSOADMNApplicationGrantCmdlet, object> Select { get; set; } =
