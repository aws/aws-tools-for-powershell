...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    [AWSCmdletOutput("None or Amazon.SSOAdmin.Model.DeletePermissionsBoundaryFromPermissionSetResponse",
        ...
        "The service response (type Amazon.SSOAdmin.Model.DeletePermissionsBoundaryFromPermissionSetResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
