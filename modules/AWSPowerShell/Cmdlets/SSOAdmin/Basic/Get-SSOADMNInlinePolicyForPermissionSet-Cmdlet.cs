...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSOADMNInlinePolicyForPermissionSet")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Single Sign-On Admin GetInlinePolicyForPermissionSet API operation.", Operation = new[] {"GetInlinePolicyForPermissionSet"}, SelectReturnType = typeof(Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOADMNInlinePolicyForPermissionSetCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InlinePolicy";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse, GetSSOADMNInlinePolicyForPermissionSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetRequest();
        ...
        private Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "GetInlinePolicyForPermissionSet");
            try
            {
                #if DESKTOP
                return client.GetInlinePolicyForPermissionSet(request);
                #elif CORECLR
                return client.GetInlinePolicyForPermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceArn { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.GetInlinePolicyForPermissionSetResponse, GetSSOADMNInlinePolicyForPermissionSetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InlinePolicy;
        }
