...
namespace Amazon.PowerShell.Cmdlets.SSOADMN
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Write", "SSOADMNInlinePolicyToPermissionSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteSSOADMNInlinePolicyToPermissionSetCmdlet : AmazonSSOAdminClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IAM inline policy to attach to a <a>PermissionSet</a>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        public System.String InlinePolicy { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-SSOADMNInlinePolicyToPermissionSet (PutInlinePolicyToPermissionSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOAdmin.Model.PutInlinePolicyToPermissionSetResponse, WriteSSOADMNInlinePolicyToPermissionSetCmdlet>(Select) ??
            ...
            context.InlinePolicy = this.InlinePolicy;
            #if MODULAR
            if (this.InlinePolicy == null && ParameterWasBound(nameof(this.InlinePolicy)))
            {
                WriteWarning("You are passing $null as a value for parameter InlinePolicy which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOAdmin.Model.PutInlinePolicyToPermissionSetRequest();
            
            if (cmdletContext.InlinePolicy != null)
            {
                request.InlinePolicy = cmdletContext.InlinePolicy;
            }
        ...
        private Amazon.SSOAdmin.Model.PutInlinePolicyToPermissionSetResponse CallAWSServiceOperation(IAmazonSSOAdmin client, Amazon.SSOAdmin.Model.PutInlinePolicyToPermissionSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On Admin", "PutInlinePolicyToPermissionSet");
            try
            {
                #if DESKTOP
                return client.PutInlinePolicyToPermissionSet(request);
                #elif CORECLR
                return client.PutInlinePolicyToPermissionSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceArn { get; set; }
            public System.String PermissionSetArn { get; set; }
            public System.Func<Amazon.SSOAdmin.Model.PutInlinePolicyToPermissionSetResponse, WriteSSOADMNInlinePolicyToPermissionSetCmdlet, object> Select { get; set; } =
