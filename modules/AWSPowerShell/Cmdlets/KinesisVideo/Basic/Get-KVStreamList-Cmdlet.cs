...
namespace Amazon.PowerShell.Cmdlets.KV
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Video Streams ListStreams API operation.", Operation = new[] {"ListStreams"}, SelectReturnType = typeof(Amazon.KinesisVideo.Model.ListStreamsResponse))]
    [AWSCmdletOutput("Amazon.KinesisVideo.Model.StreamInfo or Amazon.KinesisVideo.Model.ListStreamsResponse",
        "This cmdlet returns a collection of Amazon.KinesisVideo.Model.StreamInfo objects.",
        "The service call response (type Amazon.KinesisVideo.Model.ListStreamsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetKVStreamListCmdlet : AmazonKinesisVideoClientCmdlet, IExecutor
    {
        ...
        public Amazon.KinesisVideo.Model.StreamNameCondition StreamNameCondition { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StreamInfoList";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StreamNameCondition' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisVideo.Model.ListStreamsResponse, GetKVStreamListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.StreamNameCondition;
            }
            ...
            context.StreamNameCondition = this.StreamNameCondition;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.KinesisVideo.Model.ListStreamsRequest();
            
            if (cmdletContext.MaxResult != null)
            {
                request.MaxResults = AutoIterationHelpers.ConvertEmitLimitToServiceTypeInt32(cmdletContext.MaxResult.Value);
            }
            if (cmdletContext.StreamNameCondition != null)
            {
                request.StreamNameCondition = cmdletContext.StreamNameCondition;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.StreamInfoList.Count;
        ...
        private Amazon.KinesisVideo.Model.ListStreamsResponse CallAWSServiceOperation(IAmazonKinesisVideo client, Amazon.KinesisVideo.Model.ListStreamsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Video Streams", "ListStreams");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.KinesisVideo.Model.StreamNameCondition StreamNameCondition { get; set; }
            public System.Func<Amazon.KinesisVideo.Model.ListStreamsResponse, GetKVStreamListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StreamInfoList;
        }
