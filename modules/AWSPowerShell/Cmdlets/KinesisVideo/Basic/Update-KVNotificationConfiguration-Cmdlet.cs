...
namespace Amazon.PowerShell.Cmdlets.KV
{
    ...
    [AWSCmdletOutput("None or Amazon.KinesisVideo.Model.UpdateNotificationConfigurationResponse",
        ...
        "The service response (type Amazon.KinesisVideo.Model.UpdateNotificationConfigurationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
