...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListGroupVersions API operation.", Operation = new[] {"ListGroupVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListGroupVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListGroupVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListGroupVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGGroupVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListGroupVersionsResponse, GetGGGroupVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Greengrass.Model.ListGroupVersionsRequest();
        ...
        private Amazon.Greengrass.Model.ListGroupVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListGroupVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "ListGroupVersions");
            try
            {
                #if DESKTOP
                return client.ListGroupVersions(request);
                #elif CORECLR
                return client.ListGroupVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListGroupVersionsResponse, GetGGGroupVersionListCmdlet, object> Select { get; set; } =
