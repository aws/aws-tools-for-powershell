...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class RemoveGGSubscriptionDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SubscriptionDefinitionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGSubscriptionDefinition (DeleteSubscriptionDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.DeleteSubscriptionDefinitionResponse, RemoveGGSubscriptionDefinitionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SubscriptionDefinitionId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.DeleteSubscriptionDefinitionRequest();
        ...
        private Amazon.Greengrass.Model.DeleteSubscriptionDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DeleteSubscriptionDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "DeleteSubscriptionDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteSubscriptionDefinition(request);
                #elif CORECLR
                return client.DeleteSubscriptionDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SubscriptionDefinitionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.DeleteSubscriptionDefinitionResponse, RemoveGGSubscriptionDefinitionCmdlet, object> Select { get; set; } =
