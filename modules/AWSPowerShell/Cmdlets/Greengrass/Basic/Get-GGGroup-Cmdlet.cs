...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetGroup API operation.", Operation = new[] {"GetGroup"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetGroupResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetGroupResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGGroupCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetGroupResponse, GetGGGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.GetGroupRequest();
        ...
        private Amazon.Greengrass.Model.GetGroupResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "GetGroup");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GroupId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetGroupResponse, GetGGGroupCmdlet, object> Select { get; set; } =
