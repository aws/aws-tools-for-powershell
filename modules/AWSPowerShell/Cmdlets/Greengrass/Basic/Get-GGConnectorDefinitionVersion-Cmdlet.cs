...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetConnectorDefinitionVersionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetConnectorDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGConnectorDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ConnectorDefinitionVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ConnectorDefinitionVersionId;
            }
        ...
        private Amazon.Greengrass.Model.GetConnectorDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetConnectorDefinitionVersionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetConnectorDefinitionVersionAsync(request).GetAwaiter().GetResult();
                #else
