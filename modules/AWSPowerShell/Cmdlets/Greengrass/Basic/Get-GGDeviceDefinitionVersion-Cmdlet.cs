...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetDeviceDefinitionVersionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetDeviceDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGDeviceDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DeviceDefinitionVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.DeviceDefinitionVersionId;
            }
        ...
        private Amazon.Greengrass.Model.GetDeviceDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetDeviceDefinitionVersionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetDeviceDefinitionVersionAsync(request).GetAwaiter().GetResult();
                #else
