...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListConnectorDefinitionVersions API operation.", Operation = new[] {"ListConnectorDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGConnectorDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse, GetGGConnectorDefinitionVersionListCmdlet>(Select) ??
        ...
        private Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListConnectorDefinitionVersionsRequest request)
        {
            ...
            try
            {
                return client.ListConnectorDefinitionVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListConnectorDefinitionVersionsResponse, GetGGConnectorDefinitionVersionListCmdlet, object> Select { get; set; } =
