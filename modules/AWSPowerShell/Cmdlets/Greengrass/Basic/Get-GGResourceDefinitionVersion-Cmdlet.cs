...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetResourceDefinitionVersion API operation.", Operation = new[] {"GetResourceDefinitionVersion"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetResourceDefinitionVersionResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetResourceDefinitionVersionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetResourceDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGResourceDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceDefinitionVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetResourceDefinitionVersionResponse, GetGGResourceDefinitionVersionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceDefinitionVersionId;
            }
            ...
            #if MODULAR
            if (this.ResourceDefinitionVersionId == null && ParameterWasBound(nameof(this.ResourceDefinitionVersionId)))
            {
                WriteWarning("You are passing $null as a value for parameter ResourceDefinitionVersionId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceDefinitionId { get; set; }
            public System.String ResourceDefinitionVersionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetResourceDefinitionVersionResponse, GetGGResourceDefinitionVersionCmdlet, object> Select { get; set; } =
