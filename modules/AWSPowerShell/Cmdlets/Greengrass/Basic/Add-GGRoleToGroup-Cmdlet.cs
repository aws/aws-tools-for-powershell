...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class AddGGRoleToGroupCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-GGRoleToGroup (AssociateRoleToGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.AssociateRoleToGroupResponse, AddGGRoleToGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.AssociateRoleToGroupRequest();
        ...
        private Amazon.Greengrass.Model.AssociateRoleToGroupResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.AssociateRoleToGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "AssociateRoleToGroup");
            try
            {
                #if DESKTOP
                return client.AssociateRoleToGroup(request);
                #elif CORECLR
                return client.AssociateRoleToGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupId { get; set; }
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.Greengrass.Model.AssociateRoleToGroupResponse, AddGGRoleToGroupCmdlet, object> Select { get; set; } =
