...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGDeploymentList")]
    [OutputType("Amazon.Greengrass.Model.Deployment")]
    [AWSCmdlet("Calls the AWS Greengrass ListDeployments API operation.", Operation = new[] {"ListDeployments"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListDeploymentsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.Deployment or Amazon.Greengrass.Model.ListDeploymentsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.Deployment objects.",
        "The service call response (type Amazon.Greengrass.Model.ListDeploymentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGDeploymentListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListDeploymentsResponse, GetGGDeploymentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Greengrass.Model.ListDeploymentsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Deployments?.Count ?? 0;
        ...
        private Amazon.Greengrass.Model.ListDeploymentsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListDeploymentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "ListDeployments");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListDeploymentsResponse, GetGGDeploymentListCmdlet, object> Select { get; set; } =
