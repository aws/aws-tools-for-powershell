...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetGroupVersion API operation.", Operation = new[] {"GetGroupVersion"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetGroupVersionResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetGroupVersionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetGroupVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGGroupVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^GroupVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetGroupVersionResponse, GetGGGroupVersionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.GroupVersionId;
            }
            ...
            #if MODULAR
            if (this.GroupVersionId == null && ParameterWasBound(nameof(this.GroupVersionId)))
            {
                WriteWarning("You are passing $null as a value for parameter GroupVersionId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupId { get; set; }
            public System.String GroupVersionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetGroupVersionResponse, GetGGGroupVersionCmdlet, object> Select { get; set; } =
