...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListResourceDefinitionVersions API operation.", Operation = new[] {"ListResourceDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGResourceDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse, GetGGResourceDefinitionVersionListCmdlet>(Select) ??
        ...
        private Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListResourceDefinitionVersionsRequest request)
        {
            ...
            try
            {
                return client.ListResourceDefinitionVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceDefinitionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListResourceDefinitionVersionsResponse, GetGGResourceDefinitionVersionListCmdlet, object> Select { get; set; } =
