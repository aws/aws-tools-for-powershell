...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListGroupCertificateAuthorities API operation.", Operation = new[] {"ListGroupCertificateAuthorities"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GroupCertificateAuthorityProperties or Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.GroupCertificateAuthorityProperties objects.",
        "The service call response (type Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGGroupCertificateAuthorityListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "GroupCertificateAuthorities";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse, GetGGGroupCertificateAuthorityListCmdlet>(Select) ??
        ...
        private Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesRequest request)
        {
            ...
            try
            {
                return client.ListGroupCertificateAuthoritiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String GroupId { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListGroupCertificateAuthoritiesResponse, GetGGGroupCertificateAuthorityListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GroupCertificateAuthorities;
        }
