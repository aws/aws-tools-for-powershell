...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetSubscriptionDefinitionVersion API operation.", Operation = new[] {"GetSubscriptionDefinitionVersion"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGSubscriptionDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        #region Parameter SubscriptionDefinitionVersionId
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SubscriptionDefinitionVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse, GetGGSubscriptionDefinitionVersionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SubscriptionDefinitionVersionId;
            }
            ...
            #if MODULAR
            if (this.SubscriptionDefinitionVersionId == null && ParameterWasBound(nameof(this.SubscriptionDefinitionVersionId)))
            {
                WriteWarning("You are passing $null as a value for parameter SubscriptionDefinitionVersionId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.SubscriptionDefinitionVersionId != null)
            {
                request.SubscriptionDefinitionVersionId = cmdletContext.SubscriptionDefinitionVersionId;
            }
        ...
        private Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "GetSubscriptionDefinitionVersion");
            try
            {
                #if DESKTOP
                return client.GetSubscriptionDefinitionVersion(request);
                #elif CORECLR
                return client.GetSubscriptionDefinitionVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SubscriptionDefinitionId { get; set; }
            public System.String SubscriptionDefinitionVersionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetSubscriptionDefinitionVersionResponse, GetGGSubscriptionDefinitionVersionCmdlet, object> Select { get; set; } =
