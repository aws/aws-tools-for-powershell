...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListBulkDeployments API operation.", Operation = new[] {"ListBulkDeployments"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListBulkDeploymentsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.BulkDeployment or Amazon.Greengrass.Model.ListBulkDeploymentsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.BulkDeployment objects.",
        "The service call response (type Amazon.Greengrass.Model.ListBulkDeploymentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGBulkDeploymentListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BulkDeployments";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListBulkDeploymentsResponse, GetGGBulkDeploymentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BulkDeployments?.Count ?? 0;
        ...
        private Amazon.Greengrass.Model.ListBulkDeploymentsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListBulkDeploymentsRequest request)
        {
            ...
            try
            {
                return client.ListBulkDeploymentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListBulkDeploymentsResponse, GetGGBulkDeploymentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BulkDeployments;
        }
