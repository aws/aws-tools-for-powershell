...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListLoggerDefinitionVersions API operation.", Operation = new[] {"ListLoggerDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListLoggerDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListLoggerDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListLoggerDefinitionVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGLoggerDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^LoggerDefinitionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListLoggerDefinitionVersionsResponse, GetGGLoggerDefinitionVersionListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.LoggerDefinitionId;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListLoggerDefinitionVersionsResponse, GetGGLoggerDefinitionVersionListCmdlet, object> Select { get; set; } =
