...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetResourceDefinition API operation.", Operation = new[] {"GetResourceDefinition"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetResourceDefinitionResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetResourceDefinitionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetResourceDefinitionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGResourceDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetResourceDefinitionResponse, GetGGResourceDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.GetResourceDefinitionRequest();
        ...
        private Amazon.Greengrass.Model.GetResourceDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetResourceDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "GetResourceDefinition");
            try
            {
                #if DESKTOP
                return client.GetResourceDefinition(request);
                #elif CORECLR
                return client.GetResourceDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceDefinitionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetResourceDefinitionResponse, GetGGResourceDefinitionCmdlet, object> Select { get; set; } =
