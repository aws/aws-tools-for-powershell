...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GGRoleFromGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveGGRoleFromGroupCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGRoleFromGroup (DisassociateRoleFromGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.DisassociateRoleFromGroupResponse, RemoveGGRoleFromGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.DisassociateRoleFromGroupRequest();
        ...
        private Amazon.Greengrass.Model.DisassociateRoleFromGroupResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DisassociateRoleFromGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "DisassociateRoleFromGroup");
            try
            {
                return client.DisassociateRoleFromGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String GroupId { get; set; }
            public System.Func<Amazon.Greengrass.Model.DisassociateRoleFromGroupResponse, RemoveGGRoleFromGroupCmdlet, object> Select { get; set; } =
