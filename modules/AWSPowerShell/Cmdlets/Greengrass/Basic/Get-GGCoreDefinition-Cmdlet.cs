...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass GetCoreDefinition API operation.", Operation = new[] {"GetCoreDefinition"}, SelectReturnType = typeof(Amazon.Greengrass.Model.GetCoreDefinitionResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.GetCoreDefinitionResponse",
        "This cmdlet returns an Amazon.Greengrass.Model.GetCoreDefinitionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGCoreDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CoreDefinitionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetCoreDefinitionResponse, GetGGCoreDefinitionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.CoreDefinitionId;
            }
        ...
        private Amazon.Greengrass.Model.GetCoreDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetCoreDefinitionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetCoreDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CoreDefinitionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetCoreDefinitionResponse, GetGGCoreDefinitionCmdlet, object> Select { get; set; } =
