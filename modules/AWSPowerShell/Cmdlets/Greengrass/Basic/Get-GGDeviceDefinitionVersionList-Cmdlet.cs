...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGDeviceDefinitionVersionList")]
    [OutputType("Amazon.Greengrass.Model.VersionInformation")]
    [AWSCmdlet("Calls the AWS Greengrass ListDeviceDefinitionVersions API operation.", Operation = new[] {"ListDeviceDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGDeviceDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse, GetGGDeviceDefinitionVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Greengrass.Model.ListDeviceDefinitionVersionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Versions?.Count ?? 0;
        ...
        private Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListDeviceDefinitionVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "ListDeviceDefinitionVersions");
            try
            {
                #if DESKTOP
                return client.ListDeviceDefinitionVersions(request);
                #elif CORECLR
                return client.ListDeviceDefinitionVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse, GetGGDeviceDefinitionVersionListCmdlet, object> Select { get; set; } =
