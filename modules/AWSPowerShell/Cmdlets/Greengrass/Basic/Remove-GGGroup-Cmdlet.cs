...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// Deletes a group.
    /// </summary>
    [Cmdlet("Remove", "GGGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveGGGroupCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGGroup (DeleteGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.DeleteGroupResponse, RemoveGGGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.DeleteGroupRequest();
        ...
        private Amazon.Greengrass.Model.DeleteGroupResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DeleteGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "DeleteGroup");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GroupId { get; set; }
            public System.Func<Amazon.Greengrass.Model.DeleteGroupResponse, RemoveGGGroupCmdlet, object> Select { get; set; } =
