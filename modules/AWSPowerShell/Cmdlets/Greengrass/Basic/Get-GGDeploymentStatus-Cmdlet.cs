...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class GetGGDeploymentStatusCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetDeploymentStatusResponse, GetGGDeploymentStatusCmdlet>(Select) ??
        ...
        private Amazon.Greengrass.Model.GetDeploymentStatusResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetDeploymentStatusRequest request)
        {
            ...
            try
            {
                return client.GetDeploymentStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DeploymentId { get; set; }
            public System.String GroupId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetDeploymentStatusResponse, GetGGDeploymentStatusCmdlet, object> Select { get; set; } =
