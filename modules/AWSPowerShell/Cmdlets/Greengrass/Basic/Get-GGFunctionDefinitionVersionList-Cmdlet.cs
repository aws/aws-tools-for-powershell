...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass ListFunctionDefinitionVersions API operation.", Operation = new[] {"ListFunctionDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGGFunctionDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse, GetGGFunctionDefinitionVersionListCmdlet>(Select) ??
        ...
        private Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListFunctionDefinitionVersionsRequest request)
        {
            ...
            try
            {
                return client.ListFunctionDefinitionVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse, GetGGFunctionDefinitionVersionListCmdlet, object> Select { get; set; } =
