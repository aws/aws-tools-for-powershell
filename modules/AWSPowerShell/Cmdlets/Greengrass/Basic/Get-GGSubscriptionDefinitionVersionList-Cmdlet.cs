...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGSubscriptionDefinitionVersionList")]
    [OutputType("Amazon.Greengrass.Model.VersionInformation")]
    [AWSCmdlet("Calls the AWS Greengrass ListSubscriptionDefinitionVersions API operation.", Operation = new[] {"ListSubscriptionDefinitionVersions"}, SelectReturnType = typeof(Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse))]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation or Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse",
        "This cmdlet returns a collection of Amazon.Greengrass.Model.VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGSubscriptionDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse, GetGGSubscriptionDefinitionVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsRequest();
        ...
        private Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "ListSubscriptionDefinitionVersions");
            try
            {
                #if DESKTOP
                return client.ListSubscriptionDefinitionVersions(request);
                #elif CORECLR
                return client.ListSubscriptionDefinitionVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SubscriptionDefinitionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.ListSubscriptionDefinitionVersionsResponse, GetGGSubscriptionDefinitionVersionListCmdlet, object> Select { get; set; } =
