...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class UpdateGGGroupCertificateConfigurationCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CertificateExpiryInMillisecond' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CertificateExpiryInMillisecond;
            }
