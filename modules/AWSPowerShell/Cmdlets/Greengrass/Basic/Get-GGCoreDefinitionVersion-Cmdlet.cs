...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGCoreDefinitionVersion")]
    ...
    public partial class GetGGCoreDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CoreDefinitionVersionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Greengrass.Model.GetCoreDefinitionVersionResponse, GetGGCoreDefinitionVersionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.CoreDefinitionVersionId;
            }
            ...
            #endif
            context.CoreDefinitionVersionId = this.CoreDefinitionVersionId;
            #if MODULAR
            if (this.CoreDefinitionVersionId == null && ParameterWasBound(nameof(this.CoreDefinitionVersionId)))
            {
                WriteWarning("You are passing $null as a value for parameter CoreDefinitionVersionId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.GetCoreDefinitionVersionRequest();
            
            if (cmdletContext.CoreDefinitionId != null)
            {
                request.CoreDefinitionId = cmdletContext.CoreDefinitionId;
            }
            if (cmdletContext.CoreDefinitionVersionId != null)
            {
                request.CoreDefinitionVersionId = cmdletContext.CoreDefinitionVersionId;
            }
        ...
        private Amazon.Greengrass.Model.GetCoreDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.GetCoreDefinitionVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "GetCoreDefinitionVersion");
            try
            {
                #if DESKTOP
                return client.GetCoreDefinitionVersion(request);
                #elif CORECLR
                return client.GetCoreDefinitionVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CoreDefinitionId { get; set; }
            public System.String CoreDefinitionVersionId { get; set; }
            public System.Func<Amazon.Greengrass.Model.GetCoreDefinitionVersionResponse, GetGGCoreDefinitionVersionCmdlet, object> Select { get; set; } =
