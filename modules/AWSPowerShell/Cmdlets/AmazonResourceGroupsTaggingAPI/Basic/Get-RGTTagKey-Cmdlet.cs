...
namespace Amazon.PowerShell.Cmdlets.RGT
{
    ...
    [AWSCmdlet("Invokes the GetTagKeys operation against AWS Resource Groups Tagging API.", Operation = new[] {"GetTagKeys"})]
    ...
    public partial class GetRGTTagKeyCmdlet : AmazonResourceGroupsTaggingAPIClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TagKeys;
                        ...
                        {
                            int _receivedThisCall = response.TagKeys.Count;
        ...
        private static Amazon.ResourceGroupsTaggingAPI.Model.GetTagKeysResponse CallAWSServiceOperation(IAmazonResourceGroupsTaggingAPI client, Amazon.ResourceGroupsTaggingAPI.Model.GetTagKeysRequest request)
        {
            ...
            var task = client.GetTagKeysAsync(request);
            return task.Result;
            #else
