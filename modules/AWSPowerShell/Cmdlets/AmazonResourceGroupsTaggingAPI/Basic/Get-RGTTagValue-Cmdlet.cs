...
namespace Amazon.PowerShell.Cmdlets.RGT
{
    ...
    public partial class GetRGTTagValueCmdlet : AmazonResourceGroupsTaggingAPIClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TagValues;
                        ...
                        {
                            int _receivedThisCall = response.TagValues.Count;
        ...
        private static Amazon.ResourceGroupsTaggingAPI.Model.GetTagValuesResponse CallAWSServiceOperation(IAmazonResourceGroupsTaggingAPI client, Amazon.ResourceGroupsTaggingAPI.Model.GetTagValuesRequest request)
        {
            #if DESKTOP
            return client.GetTagValues(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetTagValuesAsync(request);
            return task.Result;
            #else
