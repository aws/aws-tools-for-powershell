...
namespace Amazon.PowerShell.Cmdlets.RGT
{
    ...
    [AWSCmdlet("Invokes the TagResources operation against AWS Resource Groups Tagging API.", Operation = new[] {"TagResources"})]
    ...
    public partial class AddRGTResourceTagCmdlet : AmazonResourceGroupsTaggingAPIClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ResourceGroupsTaggingAPI.Model.TagResourcesResponse CallAWSServiceOperation(IAmazonResourceGroupsTaggingAPI client, Amazon.ResourceGroupsTaggingAPI.Model.TagResourcesRequest request)
        {
            #if DESKTOP
