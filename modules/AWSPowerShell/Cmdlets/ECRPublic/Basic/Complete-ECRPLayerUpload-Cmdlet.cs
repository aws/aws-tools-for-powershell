...
namespace Amazon.PowerShell.Cmdlets.ECRP
{
    ...
    [OutputType("Amazon.ECRPublic.Model.CompleteLayerUploadResponse")]
    [AWSCmdlet("Calls the Amazon Elastic Container Registry Public CompleteLayerUpload API operation.", Operation = new[] {"CompleteLayerUpload"}, SelectReturnType = typeof(Amazon.ECRPublic.Model.CompleteLayerUploadResponse))]
    [AWSCmdletOutput("Amazon.ECRPublic.Model.CompleteLayerUploadResponse",
        "This cmdlet returns an Amazon.ECRPublic.Model.CompleteLayerUploadResponse object containing multiple properties."
    )]
    public partial class CompleteECRPLayerUploadCmdlet : AmazonECRPublicClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>sha256</c> digest of the image layer.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Complete-ECRPLayerUpload (CompleteLayerUpload)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECRPublic.Model.CompleteLayerUploadResponse, CompleteECRPLayerUploadCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECRPublic.Model.CompleteLayerUploadRequest();
        ...
        private Amazon.ECRPublic.Model.CompleteLayerUploadResponse CallAWSServiceOperation(IAmazonECRPublic client, Amazon.ECRPublic.Model.CompleteLayerUploadRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Registry Public", "CompleteLayerUpload");
            try
            {
                return client.CompleteLayerUploadAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RepositoryName { get; set; }
            public System.String UploadId { get; set; }
            public System.Func<Amazon.ECRPublic.Model.CompleteLayerUploadResponse, CompleteECRPLayerUploadCmdlet, object> Select { get; set; } =
