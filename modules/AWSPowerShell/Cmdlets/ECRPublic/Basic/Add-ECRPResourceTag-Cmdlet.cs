...
namespace Amazon.PowerShell.Cmdlets.ECRP
{
    ...
    public partial class AddECRPResourceTagCmdlet : AmazonECRPublicClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ECRPResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECRPublic.Model.TagResourceResponse, AddECRPResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECRPublic.Model.TagResourceRequest();
        ...
        private Amazon.ECRPublic.Model.TagResourceResponse CallAWSServiceOperation(IAmazonECRPublic client, Amazon.ECRPublic.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Registry Public", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ECRPublic.Model.TagResourceResponse, AddECRPResourceTagCmdlet, object> Select { get; set; } =
