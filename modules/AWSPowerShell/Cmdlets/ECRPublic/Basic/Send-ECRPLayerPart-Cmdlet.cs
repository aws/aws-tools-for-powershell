...
namespace Amazon.PowerShell.Cmdlets.ECRP
{
    ...
    [AWSCmdletOutput("Amazon.ECRPublic.Model.UploadLayerPartResponse",
        "This cmdlet returns an Amazon.ECRPublic.Model.UploadLayerPartResponse object containing multiple properties."
    )]
    public partial class SendECRPLayerPartCmdlet : AmazonECRPublicClientCmdlet, IExecutor
    {
        ...
        private Amazon.ECRPublic.Model.UploadLayerPartResponse CallAWSServiceOperation(IAmazonECRPublic client, Amazon.ECRPublic.Model.UploadLayerPartRequest request)
        {
            ...
            try
            {
                return client.UploadLayerPartAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
