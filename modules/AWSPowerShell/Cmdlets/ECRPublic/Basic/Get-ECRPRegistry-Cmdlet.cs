...
{
    /// <summary>
    /// Returns details for a public registry.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetECRPRegistryCmdlet : AmazonECRPublicClientCmdlet, IExecutor
    {
        ...
        private Amazon.ECRPublic.Model.DescribeRegistriesResponse CallAWSServiceOperation(IAmazonECRPublic client, Amazon.ECRPublic.Model.DescribeRegistriesRequest request)
        {
            ...
            try
            {
                return client.DescribeRegistriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
