...
{
    /// <summary>
    /// Returns the image tag details for a repository in a public registry.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetECRPImageTagCmdlet : AmazonECRPublicClientCmdlet, IExecutor
    {
        ...
        private Amazon.ECRPublic.Model.DescribeImageTagsResponse CallAWSServiceOperation(IAmazonECRPublic client, Amazon.ECRPublic.Model.DescribeImageTagsRequest request)
        {
            ...
            try
            {
                return client.DescribeImageTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
