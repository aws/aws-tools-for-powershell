...
{
    /// <summary>
    /// Describes repositories that are in a public registry.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ECRPublic.Model.Repository or Amazon.ECRPublic.Model.DescribeRepositoriesResponse",
        ...
        "The service call response (type Amazon.ECRPublic.Model.DescribeRepositoriesResponse) can be returned by specifying '-Select *'."
    )]
