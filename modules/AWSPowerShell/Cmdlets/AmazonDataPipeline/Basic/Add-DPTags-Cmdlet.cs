...
namespace Amazon.PowerShell.Cmdlets.DP
{
    ...
    /// </summary>
    [Cmdlet("Add", "DPTags", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddDPTagsCmdlet : AmazonDataPipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-DPTags (AddTags)"))
            {
                return;
            }
