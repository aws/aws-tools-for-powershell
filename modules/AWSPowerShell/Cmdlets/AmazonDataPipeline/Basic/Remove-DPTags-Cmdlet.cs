...
namespace Amazon.PowerShell.Cmdlets.DP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DPTags", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Invokes the RemoveTags operation against AWS Data Pipeline.", Operation = new[] {"RemoveTags"})]
    ...
    public partial class RemoveDPTagsCmdlet : AmazonDataPipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DPTags (RemoveTags)"))
            {
                return;
            }
