...
namespace Amazon.PowerShell.Cmdlets.COH
{
    ...
    public partial class GetCOHEfficiencyMetricListCmdlet : AmazonCostOptimizationHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the Granularity parameter.
        /// The -PassThru parameter is deprecated, use -Select '^Granularity' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Granularity' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.Granularity;
            }
        ...
        private Amazon.CostOptimizationHub.Model.ListEfficiencyMetricsResponse CallAWSServiceOperation(IAmazonCostOptimizationHub client, Amazon.CostOptimizationHub.Model.ListEfficiencyMetricsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListEfficiencyMetrics(request);
                #elif CORECLR
                return client.ListEfficiencyMetricsAsync(request).GetAwaiter().GetResult();
                #else
