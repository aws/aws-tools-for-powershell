...
namespace Amazon.PowerShell.Cmdlets.PI
{
    ...
    public partial class GetPIDimensionKeyCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        /// (only Aurora PostgreSQL, RDS PostgreSQL, Aurora MySQL, RDS MySQL, and MariaDB)</para></li><li><para><code>db.session_type.name</code> - The type of the current session (only Aurora
        ...
        /// Aurora PostgreSQL, RDS PostgreSQL, Aurora MySQL, RDS MySQL, and MariaDB)</para></li><li><para><code>db.application</code> - The name of the application that is connected to the
        ...
        /// are returned.</para><para>The value for <code>StartTime</code> must be earlier than the value for <code>EndTime</code>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
