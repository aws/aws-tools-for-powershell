...
namespace Amazon.PowerShell.Cmdlets.PI
{
    ...
    /// based on the start time of each report.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPIPerformanceAnalysisReportListCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        private Amazon.PI.Model.ListPerformanceAnalysisReportsResponse CallAWSServiceOperation(IAmazonPI client, Amazon.PI.Model.ListPerformanceAnalysisReportsRequest request)
        {
            ...
            try
            {
                return client.ListPerformanceAnalysisReportsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
