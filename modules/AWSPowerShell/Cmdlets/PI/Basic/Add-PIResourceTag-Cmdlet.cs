...
namespace Amazon.PowerShell.Cmdlets.PI
{
    ...
    /// </summary>
    [Cmdlet("Add", "PIResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddPIResourceTagCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon RDS Performance Insights resource that the tags are added to. This value
        ...
        /// <summary>
        /// <para>
        /// <para>The metadata assigned to an Amazon RDS resource consisting of a key-value pair.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PI.Model.TagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-PIResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PI.Model.TagResourceResponse, AddPIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PI.Model.TagResourceRequest();
        ...
        private Amazon.PI.Model.TagResourceResponse CallAWSServiceOperation(IAmazonPI client, Amazon.PI.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Performance Insights", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PI.Model.TagResourceResponse, AddPIResourceTagCmdlet, object> Select { get; set; } =
