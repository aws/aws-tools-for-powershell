...
namespace Amazon.PowerShell.Cmdlets.PI
{
    ...
    /// </summary>
    [Cmdlet("Get", "PIResourceTag")]
    [OutputType("Amazon.PI.Model.Tag")]
    ...
    public partial class GetPIResourceTagCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Lists all the tags for the Amazon RDS Performance Insights resource. This value is
        /// an Amazon Resource Name (ARN). For information about creating an ARN, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html#USER_Tagging.ARN.Constructing">
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PI.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.PI.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PI.Model.ListTagsForResourceResponse, GetPIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PI.Model.ListTagsForResourceRequest();
        ...
        private Amazon.PI.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonPI client, Amazon.PI.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Performance Insights", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceARN { get; set; }
            public Amazon.PI.ServiceType ServiceType { get; set; }
            public System.Func<Amazon.PI.Model.ListTagsForResourceResponse, GetPIResourceTagCmdlet, object> Select { get; set; } =
