...
namespace Amazon.PowerShell.Cmdlets.PI
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PIResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePIResourceTagCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The metadata assigned to an Amazon RDS Performance Insights resource consisting of
        /// a key-value pair.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PI.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PIResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PI.Model.UntagResourceResponse, RemovePIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PI.Model.UntagResourceRequest();
        ...
        private Amazon.PI.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPI client, Amazon.PI.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Performance Insights", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PI.Model.UntagResourceResponse, RemovePIResourceTagCmdlet, object> Select { get; set; } =
