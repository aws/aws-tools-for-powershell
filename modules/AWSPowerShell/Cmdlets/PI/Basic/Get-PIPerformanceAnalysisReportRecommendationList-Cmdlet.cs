...
{
    /// <summary>
    /// Retrieves recommendations for a performance analysis report.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "PIPerformanceAnalysisReportRecommendationList")]
    [OutputType("Amazon.PI.Model.Recommendation")]
    [AWSCmdlet("Calls the AWS Performance Insights ListPerformanceAnalysisReportRecommendations API operation.", Operation = new[] {"ListPerformanceAnalysisReportRecommendations"}, SelectReturnType = typeof(Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.PI.Model.Recommendation or Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse",
        "This cmdlet returns a collection of Amazon.PI.Model.Recommendation objects.",
        "The service call response (type Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPIPerformanceAnalysisReportRecommendationListCmdlet : AmazonPIClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of recommendation identifiers to filter the results.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse).
        /// Specifying the name of a property of type Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse, GetPIPerformanceAnalysisReportRecommendationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsRequest();
        ...
        private Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse CallAWSServiceOperation(IAmazonPI client, Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Performance Insights", "ListPerformanceAnalysisReportRecommendations");
            try
            {
                return client.ListPerformanceAnalysisReportRecommendationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.PI.ServiceType ServiceType { get; set; }
            public System.Func<Amazon.PI.Model.ListPerformanceAnalysisReportRecommendationsResponse, GetPIPerformanceAnalysisReportRecommendationListCmdlet, object> Select { get; set; } =
