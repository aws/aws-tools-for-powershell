...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListPortfolios API operation.", Operation = new[] {"ListPortfolios"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListPortfoliosResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.PortfolioDetail or Amazon.ServiceCatalog.Model.ListPortfoliosResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.PortfolioDetail objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListPortfoliosResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCPortfolioListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListPortfoliosResponse, GetSCPortfolioListCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.ListPortfoliosResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListPortfoliosRequest request)
        {
            ...
            try
            {
                return client.ListPortfoliosAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? PageSize { get; set; }
            public System.String PageToken { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListPortfoliosResponse, GetSCPortfolioListCmdlet, object> Select { get; set; } =
