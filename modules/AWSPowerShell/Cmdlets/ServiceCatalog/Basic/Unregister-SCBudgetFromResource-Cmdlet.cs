...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "SCBudgetFromResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UnregisterSCBudgetFromResourceCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-SCBudgetFromResource (DisassociateBudgetFromResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DisassociateBudgetFromResourceResponse, UnregisterSCBudgetFromResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceCatalog.Model.DisassociateBudgetFromResourceRequest();
        ...
        private Amazon.ServiceCatalog.Model.DisassociateBudgetFromResourceResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DisassociateBudgetFromResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "DisassociateBudgetFromResource");
            try
            {
                #if DESKTOP
                return client.DisassociateBudgetFromResource(request);
                #elif CORECLR
                return client.DisassociateBudgetFromResourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BudgetName { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DisassociateBudgetFromResourceResponse, UnregisterSCBudgetFromResourceCmdlet, object> Select { get; set; } =
