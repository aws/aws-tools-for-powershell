...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// </summary>
    [Cmdlet("Get", "SCBudgetsForResource")]
    [OutputType("Amazon.ServiceCatalog.Model.BudgetDetail")]
    [AWSCmdlet("Calls the AWS Service Catalog ListBudgetsForResource API operation.", Operation = new[] {"ListBudgetsForResource"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.BudgetDetail or Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.BudgetDetail objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSCBudgetsForResourceCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse, GetSCBudgetsForResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListBudgetsForResourceRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Budgets?.Count ?? 0;
        ...
        private Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListBudgetsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListBudgetsForResource");
            try
            {
                #if DESKTOP
                return client.ListBudgetsForResource(request);
                #elif CORECLR
                return client.ListBudgetsForResourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListBudgetsForResourceResponse, GetSCBudgetsForResourceCmdlet, object> Select { get; set; } =
