...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// </summary>
    [Cmdlet("Get", "SCServiceActionList")]
    [OutputType("Amazon.ServiceCatalog.Model.ServiceActionSummary")]
    [AWSCmdlet("Calls the AWS Service Catalog ListServiceActions API operation.", Operation = new[] {"ListServiceActions"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListServiceActionsResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ServiceActionSummary or Amazon.ServiceCatalog.Model.ListServiceActionsResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.ServiceActionSummary objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListServiceActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSCServiceActionListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListServiceActionsResponse, GetSCServiceActionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListServiceActionsRequest();
        ...
        private Amazon.ServiceCatalog.Model.ListServiceActionsResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListServiceActionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListServiceActions");
            try
            {
                #if DESKTOP
                return client.ListServiceActions(request);
                #elif CORECLR
                return client.ListServiceActionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? PageSize { get; set; }
            public System.String PageToken { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListServiceActionsResponse, GetSCServiceActionListCmdlet, object> Select { get; set; } =
