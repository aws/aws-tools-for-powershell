...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class RegisterSCPrincipalWithPortfolioCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the principal (user, role, or group). If the <code>PrincipalType</code>
        ...
        /// following format:</para><para><i>arn:partition:iam:::resource-type/resource-id</i></para><para>The ARN resource-id can be either:</para><ul><li><para>A fully formed resource-id. For example, <i>arn:aws:iam:::role/resource-name</i> or
        /// <i>arn:aws:iam:::role/resource-path/resource-name</i></para></li><li><para>A wildcard ARN. The wildcard ARN accepts <code>IAM_PATTERN</code> values with a "*"
        ...
        /// and cannot replace the <b>resource-type</b> or other ARN values. </para><para>The ARN path and principal name allow unlimited wildcard characters.</para></li></ul><para>Examples of an <b>acceptable</b> wildcard ARN:</para><ul><li><para>arn:aws:iam:::role/ResourceName_*</para></li><li><para>arn:aws:iam:::role/*/ResourceName_?</para></li></ul><para>Examples of an <b>unacceptable</b> wildcard ARN:</para><ul><li><para>arn:aws:iam:::*/ResourceName</para></li></ul><para>You can associate multiple <code>IAM_PATTERN</code>s even if the account has no principal
        ...
        /// <code>accountID</code>, with or without wildcard characters. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
