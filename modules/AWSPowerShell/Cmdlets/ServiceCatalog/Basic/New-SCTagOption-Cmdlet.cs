...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog CreateTagOption API operation.", Operation = new[] {"CreateTagOption"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.CreateTagOptionResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.TagOptionDetail or Amazon.ServiceCatalog.Model.CreateTagOptionResponse",
        "This cmdlet returns an Amazon.ServiceCatalog.Model.TagOptionDetail object.",
        "The service call response (type Amazon.ServiceCatalog.Model.CreateTagOptionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSCTagOptionCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TagOptionDetail";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.CreateTagOptionResponse, NewSCTagOptionCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.CreateTagOptionResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.CreateTagOptionRequest request)
        {
            ...
            try
            {
                return client.CreateTagOptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Key { get; set; }
            public System.String Value { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.CreateTagOptionResponse, NewSCTagOptionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TagOptionDetail;
        }
