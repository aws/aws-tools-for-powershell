...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Service Catalog DeleteTagOption API operation.", Operation = new[] {"DeleteTagOption"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.DeleteTagOptionResponse))]
    [AWSCmdletOutput("None or Amazon.ServiceCatalog.Model.DeleteTagOptionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ServiceCatalog.Model.DeleteTagOptionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSCTagOptionCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DeleteTagOptionResponse, RemoveSCTagOptionCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.DeleteTagOptionResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DeleteTagOptionRequest request)
        {
            ...
            try
            {
                return client.DeleteTagOptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DeleteTagOptionResponse, RemoveSCTagOptionCmdlet, object> Select { get; set; } =
