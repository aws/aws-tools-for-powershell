...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListOrganizationPortfolioAccess API operation.", Operation = new[] {"ListOrganizationPortfolioAccess"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.OrganizationNode or Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.OrganizationNode objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCOrganizationPortfolioAccessListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OrganizationNodes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse, GetSCOrganizationPortfolioAccessListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.AcceptLanguage = this.AcceptLanguage;
            context.OrganizationNodeType = this.OrganizationNodeType;
            #if MODULAR
            if (this.OrganizationNodeType == null && ParameterWasBound(nameof(this.OrganizationNodeType)))
            {
                WriteWarning("You are passing $null as a value for parameter OrganizationNodeType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OrganizationNodes?.Count ?? 0;
        ...
        private Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessRequest request)
        {
            ...
            try
            {
                return client.ListOrganizationPortfolioAccessAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String PortfolioId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListOrganizationPortfolioAccessResponse, GetSCOrganizationPortfolioAccessListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OrganizationNodes;
        }
