...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class GetSCRecordCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DescribeRecordResponse, GetSCRecordCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.DescribeRecordResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DescribeRecordRequest request)
        {
            ...
            try
            {
                return client.DescribeRecordAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? PageSize { get; set; }
            public System.String PageToken { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DescribeRecordResponse, GetSCRecordCmdlet, object> Select { get; set; } =
