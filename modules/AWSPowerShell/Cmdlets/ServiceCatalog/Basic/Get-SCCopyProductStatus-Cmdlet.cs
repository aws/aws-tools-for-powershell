...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog DescribeCopyProductStatus API operation.", Operation = new[] {"DescribeCopyProductStatus"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.DescribeCopyProductStatusResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.DescribeCopyProductStatusResponse",
        "This cmdlet returns an Amazon.ServiceCatalog.Model.DescribeCopyProductStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSCCopyProductStatusCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DescribeCopyProductStatusResponse, GetSCCopyProductStatusCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.AcceptLanguage = this.AcceptLanguage;
            context.CopyProductToken = this.CopyProductToken;
            #if MODULAR
            if (this.CopyProductToken == null && ParameterWasBound(nameof(this.CopyProductToken)))
            {
                WriteWarning("You are passing $null as a value for parameter CopyProductToken which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AcceptLanguage { get; set; }
            public System.String CopyProductToken { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DescribeCopyProductStatusResponse, GetSCCopyProductStatusCmdlet, object> Select { get; set; } =
