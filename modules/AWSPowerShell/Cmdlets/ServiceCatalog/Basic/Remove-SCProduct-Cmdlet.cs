...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class RemoveSCProductCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DeleteProductResponse, RemoveSCProductCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.DeleteProductResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DeleteProductRequest request)
        {
            ...
            try
            {
                return client.DeleteProductAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AcceptLanguage { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DeleteProductResponse, RemoveSCProductCmdlet, object> Select { get; set; } =
