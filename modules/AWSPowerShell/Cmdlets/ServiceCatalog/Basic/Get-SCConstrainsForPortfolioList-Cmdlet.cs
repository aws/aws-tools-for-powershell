...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListConstraintsForPortfolio API operation.", Operation = new[] {"ListConstraintsForPortfolio"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ConstraintDetail or Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.ConstraintDetail objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCConstrainsForPortfolioListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConstraintDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse, GetSCConstrainsForPortfolioListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ConstraintDetails?.Count ?? 0;
        ...
        private Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioRequest request)
        {
            ...
            try
            {
                return client.ListConstraintsForPortfolioAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PortfolioId { get; set; }
            public System.String ProductId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListConstraintsForPortfolioResponse, GetSCConstrainsForPortfolioListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConstraintDetails;
        }
