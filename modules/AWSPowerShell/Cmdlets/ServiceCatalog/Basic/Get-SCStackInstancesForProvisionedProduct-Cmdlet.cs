...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// are associated with a specific Amazon Web Services account name or Region.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetSCStackInstancesForProvisionedProductCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StackInstances";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListStackInstancesForProvisionedProductResponse, GetSCStackInstancesForProvisionedProductCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListStackInstancesForProvisionedProductRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.StackInstances?.Count ?? 0;
        ...
        private Amazon.ServiceCatalog.Model.ListStackInstancesForProvisionedProductResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListStackInstancesForProvisionedProductRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListStackInstancesForProvisionedProduct");
            try
            {
                #if DESKTOP
                return client.ListStackInstancesForProvisionedProduct(request);
                #elif CORECLR
                return client.ListStackInstancesForProvisionedProductAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String ProvisionedProductId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListStackInstancesForProvisionedProductResponse, GetSCStackInstancesForProvisionedProductCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StackInstances;
        }
