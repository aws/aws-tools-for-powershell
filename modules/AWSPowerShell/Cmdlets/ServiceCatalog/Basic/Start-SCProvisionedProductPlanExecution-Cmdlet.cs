...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class StartSCProvisionedProductPlanExecutionCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ExecuteProvisionedProductPlanResponse, StartSCProvisionedProductPlanExecutionCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.ExecuteProvisionedProductPlanResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ExecuteProvisionedProductPlanRequest request)
        {
            ...
            try
            {
                return client.ExecuteProvisionedProductPlanAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IdempotencyToken { get; set; }
            public System.String PlanId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ExecuteProvisionedProductPlanResponse, StartSCProvisionedProductPlanExecutionCmdlet, object> Select { get; set; } =
