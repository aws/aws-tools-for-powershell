...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListProvisioningArtifactsForServiceAction API operation.", Operation = new[] {"ListProvisioningArtifactsForServiceAction"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ProvisioningArtifactView or Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.ProvisioningArtifactView objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCProvisioningArtifactsForServiceActionListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ProvisioningArtifactViews";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse, GetSCProvisioningArtifactsForServiceActionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ProvisioningArtifactViews?.Count ?? 0;
        ...
        private Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionRequest request)
        {
            ...
            try
            {
                return client.ListProvisioningArtifactsForServiceActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String ServiceActionId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListProvisioningArtifactsForServiceActionResponse, GetSCProvisioningArtifactsForServiceActionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ProvisioningArtifactViews;
        }
