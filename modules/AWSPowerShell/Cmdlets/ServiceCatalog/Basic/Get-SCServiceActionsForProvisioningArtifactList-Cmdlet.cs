...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListServiceActionsForProvisioningArtifact API operation.", Operation = new[] {"ListServiceActionsForProvisioningArtifact"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ServiceActionSummary or Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.ServiceActionSummary objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCServiceActionsForProvisioningArtifactListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ServiceActionSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse, GetSCServiceActionsForProvisioningArtifactListCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactRequest request)
        {
            ...
            try
            {
                return client.ListServiceActionsForProvisioningArtifactAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProductId { get; set; }
            public System.String ProvisioningArtifactId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListServiceActionsForProvisioningArtifactResponse, GetSCServiceActionsForProvisioningArtifactListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ServiceActionSummaries;
        }
