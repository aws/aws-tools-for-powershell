...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class RemoveSCConstraintCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCConstraint (DeleteConstraint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DeleteConstraintResponse, RemoveSCConstraintCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceCatalog.Model.DeleteConstraintRequest();
        ...
        private Amazon.ServiceCatalog.Model.DeleteConstraintResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DeleteConstraintRequest request)
        {
            ...
            try
            {
                return client.DeleteConstraintAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AcceptLanguage { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DeleteConstraintResponse, RemoveSCConstraintCmdlet, object> Select { get; set; } =
