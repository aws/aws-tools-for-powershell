...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class CopySCProductCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The copy options. If the value is <c>CopyTags</c>, the tags from the source product
        /// are copied to the target product.</para><para />
        ...
        /// to copy. By default, all provisioning artifacts are copied.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.ServiceCatalog.Model.CopyProductResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.CopyProductRequest request)
        {
            ...
            try
            {
                return client.CopyProductAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
