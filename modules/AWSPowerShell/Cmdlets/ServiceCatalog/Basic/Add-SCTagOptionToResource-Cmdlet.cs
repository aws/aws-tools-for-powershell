...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class AddSCTagOptionToResourceCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.TagOptionId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.AssociateTagOptionWithResourceResponse, AddSCTagOptionToResourceCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.AssociateTagOptionWithResourceResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.AssociateTagOptionWithResourceRequest request)
        {
            ...
            try
            {
                return client.AssociateTagOptionWithResourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceId { get; set; }
            public System.String TagOptionId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.AssociateTagOptionWithResourceResponse, AddSCTagOptionToResourceCmdlet, object> Select { get; set; } =
