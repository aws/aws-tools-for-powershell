...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListAcceptedPortfolioShares API operation.", Operation = new[] {"ListAcceptedPortfolioShares"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.PortfolioDetail or Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.PortfolioDetail objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCAcceptedPortfolioShareListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PortfolioDetails";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AcceptLanguage' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse, GetSCAcceptedPortfolioShareListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.AcceptLanguage;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesRequest();
        ...
        private Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListAcceptedPortfolioShares");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public Amazon.ServiceCatalog.PortfolioShareType PortfolioShareType { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListAcceptedPortfolioSharesResponse, GetSCAcceptedPortfolioShareListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PortfolioDetails;
        }
