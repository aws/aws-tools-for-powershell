...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class RemoveSCPortfolioCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCPortfolio (DeletePortfolio)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DeletePortfolioResponse, RemoveSCPortfolioCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceCatalog.Model.DeletePortfolioRequest();
        ...
        private Amazon.ServiceCatalog.Model.DeletePortfolioResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DeletePortfolioRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "DeletePortfolio");
            try
            {
                #if DESKTOP
                return client.DeletePortfolio(request);
                #elif CORECLR
                return client.DeletePortfolioAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AcceptLanguage { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DeletePortfolioResponse, RemoveSCPortfolioCmdlet, object> Select { get; set; } =
