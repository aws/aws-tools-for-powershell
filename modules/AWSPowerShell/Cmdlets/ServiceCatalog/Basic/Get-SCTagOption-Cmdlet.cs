...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    public partial class GetSCTagOptionCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.DescribeTagOptionResponse, GetSCTagOptionCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.DescribeTagOptionResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.DescribeTagOptionRequest request)
        {
            ...
            try
            {
                return client.DescribeTagOptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.DescribeTagOptionResponse, GetSCTagOptionCmdlet, object> Select { get; set; } =
