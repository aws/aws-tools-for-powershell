...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    /// with the specified portfolio.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SCPrincipalsForPortfolio")]
    [OutputType("Amazon.ServiceCatalog.Model.Principal")]
    [AWSCmdlet("Calls the AWS Service Catalog ListPrincipalsForPortfolio API operation.", Operation = new[] {"ListPrincipalsForPortfolio"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.Principal or Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.Principal objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCPrincipalsForPortfolioCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse, GetSCPrincipalsForPortfolioCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioRequest();
        ...
        private Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog", "ListPrincipalsForPortfolio");
            try
            {
                #if DESKTOP
                return client.ListPrincipalsForPortfolio(request);
                #elif CORECLR
                return client.ListPrincipalsForPortfolioAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String PortfolioId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListPrincipalsForPortfolioResponse, GetSCPrincipalsForPortfolioCmdlet, object> Select { get; set; } =
