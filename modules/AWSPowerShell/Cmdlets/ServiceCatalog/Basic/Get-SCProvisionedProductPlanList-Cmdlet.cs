...
namespace Amazon.PowerShell.Cmdlets.SC
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog ListProvisionedProductPlans API operation.", Operation = new[] {"ListProvisionedProductPlans"}, SelectReturnType = typeof(Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse))]
    [AWSCmdletOutput("Amazon.ServiceCatalog.Model.ProvisionedProductPlanSummary or Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse",
        "This cmdlet returns a collection of Amazon.ServiceCatalog.Model.ProvisionedProductPlanSummary objects.",
        "The service call response (type Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCProvisionedProductPlanListCmdlet : AmazonServiceCatalogClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ProvisionedProductPlans";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse, GetSCProvisionedProductPlanListCmdlet>(Select) ??
        ...
        private Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse CallAWSServiceOperation(IAmazonServiceCatalog client, Amazon.ServiceCatalog.Model.ListProvisionedProductPlansRequest request)
        {
            ...
            try
            {
                return client.ListProvisionedProductPlansAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PageToken { get; set; }
            public System.String ProvisionProductId { get; set; }
            public System.Func<Amazon.ServiceCatalog.Model.ListProvisionedProductPlansResponse, GetSCProvisionedProductPlanListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ProvisionedProductPlans;
        }
