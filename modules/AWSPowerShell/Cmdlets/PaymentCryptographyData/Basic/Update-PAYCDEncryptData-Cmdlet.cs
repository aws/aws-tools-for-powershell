...
namespace Amazon.PowerShell.Cmdlets.PAYCD
{
    ...
    /// </para><ul><li><para><b>DUKPT</b>: <c>TDES</c> and <c>AES</c> algorithms. To encrypt using DUKPT, a DUKPT
    ...
    /// </para></li><li><para><b>Asymmetric</b>: <c>RSA</c>. You can use an <c>RSA</c> key on either the incoming
    ...
    public partial class UpdatePAYCDEncryptDataCmdlet : AmazonPaymentCryptographyDataClientCmdlet, IExecutor
    {
        ...
        #region Parameter IncomingEncryptionAttributes_Asymmetric_PaddingType
        /// <summary>
        /// <para>
        ...
        public Amazon.PaymentCryptographyData.PaddingType IncomingEncryptionAttributes_Asymmetric_PaddingType { get; set; }
        #endregion
        ...
        #region Parameter OutgoingEncryptionAttributes_Asymmetric_PaddingType
        /// <summary>
        /// <para>
        /// <para>The padding to be included with the data.</para>
        /// </para>
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.PaymentCryptographyData.PaddingType")]
        public Amazon.PaymentCryptographyData.PaddingType OutgoingEncryptionAttributes_Asymmetric_PaddingType { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            #endif
            context.IncomingEncryptionAttributes_Asymmetric_PaddingType = this.IncomingEncryptionAttributes_Asymmetric_PaddingType;
            ...
            context.OutgoingEncryptionAttributes_Asymmetric_PaddingType = this.OutgoingEncryptionAttributes_Asymmetric_PaddingType;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            Amazon.PaymentCryptographyData.Model.AsymmetricEncryptionAttributes requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric = null;
            
             // populate Asymmetric
            var requestIncomingEncryptionAttributes_incomingEncryptionAttributes_AsymmetricIsNull = true;
            requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric = new Amazon.PaymentCryptographyData.Model.AsymmetricEncryptionAttributes();
            Amazon.PaymentCryptographyData.PaddingType requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric_incomingEncryptionAttributes_Asymmetric_PaddingType = null;
            if (cmdletContext.IncomingEncryptionAttributes_Asymmetric_PaddingType != null)
            {
                requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric_incomingEncryptionAttributes_Asymmetric_PaddingType = cmdletContext.IncomingEncryptionAttributes_Asymmetric_PaddingType;
            }
            if (requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric_incomingEncryptionAttributes_Asymmetric_PaddingType != null)
            {
                requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric.PaddingType = requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric_incomingEncryptionAttributes_Asymmetric_PaddingType;
                requestIncomingEncryptionAttributes_incomingEncryptionAttributes_AsymmetricIsNull = false;
            }
             // determine if requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric should be set to null
            if (requestIncomingEncryptionAttributes_incomingEncryptionAttributes_AsymmetricIsNull)
            {
                requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric = null;
            }
            if (requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric != null)
            {
                request.IncomingEncryptionAttributes.Asymmetric = requestIncomingEncryptionAttributes_incomingEncryptionAttributes_Asymmetric;
            ...
            Amazon.PaymentCryptographyData.Model.AsymmetricEncryptionAttributes requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric = null;
            
             // populate Asymmetric
            var requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_AsymmetricIsNull = true;
            requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric = new Amazon.PaymentCryptographyData.Model.AsymmetricEncryptionAttributes();
            Amazon.PaymentCryptographyData.PaddingType requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric_outgoingEncryptionAttributes_Asymmetric_PaddingType = null;
            if (cmdletContext.OutgoingEncryptionAttributes_Asymmetric_PaddingType != null)
            {
                requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric_outgoingEncryptionAttributes_Asymmetric_PaddingType = cmdletContext.OutgoingEncryptionAttributes_Asymmetric_PaddingType;
            }
            if (requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric_outgoingEncryptionAttributes_Asymmetric_PaddingType != null)
            {
                requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric.PaddingType = requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric_outgoingEncryptionAttributes_Asymmetric_PaddingType;
                requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_AsymmetricIsNull = false;
            }
             // determine if requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric should be set to null
            if (requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_AsymmetricIsNull)
            {
                requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric = null;
            }
            if (requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric != null)
            {
                request.OutgoingEncryptionAttributes.Asymmetric = requestOutgoingEncryptionAttributes_outgoingEncryptionAttributes_Asymmetric;
        ...
        private Amazon.PaymentCryptographyData.Model.ReEncryptDataResponse CallAWSServiceOperation(IAmazonPaymentCryptographyData client, Amazon.PaymentCryptographyData.Model.ReEncryptDataRequest request)
        {
            ...
            try
            {
                return client.ReEncryptDataAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
