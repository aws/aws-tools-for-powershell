...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh ListMeshes API operation.", Operation = new[] {"ListMeshes"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.MeshRef",
        "This cmdlet returns a collection of MeshRef objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Meshes;
