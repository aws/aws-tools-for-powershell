...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHRouteList")]
    [OutputType("Amazon.AppMesh.Model.RouteRef")]
    [AWSCmdlet("Calls the AWS App Mesh ListRoutes API operation.", Operation = new[] {"ListRoutes"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.RouteRef",
        "This cmdlet returns a collection of RouteRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListRoutesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetAMSHRouteListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppMesh.Model.ListRoutesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Routes;
                        ...
                        int _receivedThisCall = response.Routes.Count;
        ...
        private Amazon.AppMesh.Model.ListRoutesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListRoutesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "ListRoutes");
            try
            {
                #if DESKTOP
