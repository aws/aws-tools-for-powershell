...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh ListVirtualRouters API operation.", Operation = new[] {"ListVirtualRouters"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualRouterRef",
        "This cmdlet returns a collection of VirtualRouterRef objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.VirtualRouters;
