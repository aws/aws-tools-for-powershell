...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMSHVirtualNodeList")]
    [OutputType("Amazon.AppMesh.Model.VirtualNodeRef")]
    [AWSCmdlet("Calls the AWS App Mesh ListVirtualNodes API operation.", Operation = new[] {"ListVirtualNodes"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualNodeRef",
        "This cmdlet returns a collection of VirtualNodeRef objects.",
        "The service call response (type Amazon.AppMesh.Model.ListVirtualNodesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetAMSHVirtualNodeListCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        
        #region Parameter MeshName
        /// <summary>
        /// <para>
        /// <para>The name of the service mesh in which to list virtual nodes.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of mesh results returned by <code>ListVirtualNodes</code> in  
        ///       paginated output. When this parameter is used, <code>ListVirtualNodes</code>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppMesh.Model.ListVirtualNodesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.VirtualNodes;
                        ...
                        int _receivedThisCall = response.VirtualNodes.Count;
        ...
        private Amazon.AppMesh.Model.ListVirtualNodesResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.ListVirtualNodesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Mesh", "ListVirtualNodes");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListVirtualNodesAsync(request);
                return task.Result;
                #else
