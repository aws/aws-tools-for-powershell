...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh DeleteVirtualNode API operation.", Operation = new[] {"DeleteVirtualNode"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualNodeData",
        "This cmdlet returns a VirtualNodeData object.",
        "The service call response (type Amazon.AppMesh.Model.DeleteVirtualNodeResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
