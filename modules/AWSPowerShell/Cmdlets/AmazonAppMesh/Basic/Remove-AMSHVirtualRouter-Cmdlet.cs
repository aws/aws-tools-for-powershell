...
namespace Amazon.PowerShell.Cmdlets.AMSH
{
    ...
    [AWSCmdlet("Calls the AWS App Mesh DeleteVirtualRouter API operation.", Operation = new[] {"DeleteVirtualRouter"})]
    [AWSCmdletOutput("Amazon.AppMesh.Model.VirtualRouterData",
        "This cmdlet returns a VirtualRouterData object.",
        "The service call response (type Amazon.AppMesh.Model.DeleteVirtualRouterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAMSHVirtualRouterCmdlet : AmazonAppMeshClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the service mesh in which to delete the virtual router.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.AppMesh.Model.DeleteVirtualRouterResponse CallAWSServiceOperation(IAmazonAppMesh client, Amazon.AppMesh.Model.DeleteVirtualRouterRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteVirtualRouter(request);
                #elif CORECLR
                // todo: handle AggregateException and extract true service exception for rethrow
                var task = client.DeleteVirtualRouterAsync(request);
                return task.Result;
                #else
