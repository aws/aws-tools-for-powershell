...
namespace Amazon.PowerShell.Cmdlets.PAYCC
{
    ...
    public partial class RemovePAYCCResourceTagCmdlet : AmazonPaymentCryptographyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PAYCCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PaymentCryptography.Model.UntagResourceResponse, RemovePAYCCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PaymentCryptography.Model.UntagResourceRequest();
        ...
        private Amazon.PaymentCryptography.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPaymentCryptography client, Amazon.PaymentCryptography.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Payment Cryptography Control Plane", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PaymentCryptography.Model.UntagResourceResponse, RemovePAYCCResourceTagCmdlet, object> Select { get; set; } =
