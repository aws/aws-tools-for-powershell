...
namespace Amazon.PowerShell.Cmdlets.PAYCC
{
    ...
    public partial class GetPAYCCParametersForImportCmdlet : AmazonPaymentCryptographyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies whether to reuse the existing import token and wrapping key certificate.
        ...
        /// a new import token and wrapping key certificate on every call.</para>
        /// </para>
        /// </summary>
