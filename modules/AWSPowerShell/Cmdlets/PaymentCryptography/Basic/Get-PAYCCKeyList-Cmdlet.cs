...
namespace Amazon.PowerShell.Cmdlets.PAYCC
{
    ...
    public partial class GetPAYCCKeyListCmdlet : AmazonPaymentCryptographyClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^KeyState' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.KeyState;
            }
