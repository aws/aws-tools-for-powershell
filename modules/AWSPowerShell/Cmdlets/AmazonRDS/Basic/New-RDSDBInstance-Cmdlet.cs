...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public class NewRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// with Amazon RDS. Not every database engine is available for every AWS region.</para><para><b>Amazon Aurora</b></para><ul><li><para><b>Version 5.6 (only available in AWS regions ap-northeast-1, ap-northeast-2, ap-southeast-2,
        /// eu-west-1, us-east-1, us-west-2):</b><code> 5.6.10a</code></para></li></ul><para><b>MariaDB</b></para><ul><li><para><b>Version 10.0 (available in all AWS regions):</b><code> 10.0.17 | 10.0.24</code></para></li></ul><para><b>Microsoft SQL Server Enterprise Edition (sqlserver-ee)</b></para><ul><li><para><b>Version 11.00 (available in all AWS regions):</b><code> 11.00.2100.60.v1 | 11.00.5058.0.v1
        ...
        /// | 11.00.6020.0.v1</code></para></li><li><para><b>Version 10.50 (available in all AWS regions):</b><code> 10.50.2789.0.v1 | 10.50.6000.34.v1
        /// | 10.50.6529.0.v1</code></para></li></ul><para><b>MySQL</b></para><ul><li><para><b>Version 5.7 (available in all AWS regions):</b><code> 5.7.10 | 5.7.11</code></para></li><li><para><b>Version 5.6 (available in all AWS regions except ap-northeast-2):</b><code> 5.6.19a
        /// | 5.6.19b | 5.6.21 | 5.6.21b | 5.6.22</code></para></li><li><para><b>Version 5.6 (available in all AWS regions):</b><code> 5.6.23 | 5.6.27 | 5.6.29</code></para></li><li><para><b>Version 5.5 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 5.5.40 | 5.5.40a</code></para></li><li><para><b>Version 5.5 (available in all AWS regions except ap-northeast-2):</b><code> 5.5.40b
        /// | 5.5.41</code></para></li><li><para><b>Version 5.5 (available in all AWS regions):</b><code> 5.5.42 | 5.5.46</code></para></li><li><para><b>Version 5.1 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 5.1.73a | 5.1.73b</code></para></li></ul><para><b>Oracle Database Enterprise Edition (oracle-ee)</b></para><ul><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 12.1.0.1.v1 | 12.1.0.1.v2</code></para></li><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 12.1.0.1.v3 | 12.1.0.1.v4</code></para></li><li><para><b>Version 12.1 (available in all AWS regions):</b><code> 12.1.0.2.v1</code></para></li><li><para><b>Version 12.1 (available in all AWS regions except us-gov-west-1):</b><code> 12.1.0.2.v2
        /// | 12.1.0.2.v3</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 | 11.2.0.2.v6 | 11.2.0.2.v7</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 11.2.0.3.v1 | 11.2.0.3.v2 | 11.2.0.3.v3</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 11.2.0.3.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions):</b><code> 11.2.0.4.v1 | 11.2.0.4.v3
        /// | 11.2.0.4.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except us-gov-west-1):</b><code> 11.2.0.4.v5
        /// | 11.2.0.4.v6 | 11.2.0.4.v7</code></para></li></ul><para><b>Oracle Database Standard Edition (oracle-se)</b></para><ul><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 12.1.0.1.v1 | 12.1.0.1.v2</code></para></li><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 12.1.0.1.v3 | 12.1.0.1.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 | 11.2.0.2.v6 | 11.2.0.2.v7</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 11.2.0.3.v1 | 11.2.0.3.v2 | 11.2.0.3.v3</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 11.2.0.3.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions):</b><code> 11.2.0.4.v1 | 11.2.0.4.v3
        /// | 11.2.0.4.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except us-gov-west-1):</b><code> 11.2.0.4.v5
        /// | 11.2.0.4.v6 | 11.2.0.4.v7</code></para></li></ul><para><b>Oracle Database Standard Edition One (oracle-se1)</b></para><ul><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 12.1.0.1.v1 | 12.1.0.1.v2</code></para></li><li><para><b>Version 12.1 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 12.1.0.1.v3 | 12.1.0.1.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 11.2.0.2.v3 | 11.2.0.2.v4 | 11.2.0.2.v5 | 11.2.0.2.v6 | 11.2.0.2.v7</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2):</b><code>
        /// 11.2.0.3.v1 | 11.2.0.3.v2 | 11.2.0.3.v3</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 11.2.0.3.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions):</b><code> 11.2.0.4.v1 | 11.2.0.4.v3
        /// | 11.2.0.4.v4</code></para></li><li><para><b>Version 11.2 (available in all AWS regions except us-gov-west-1):</b><code> 11.2.0.4.v5
        /// | 11.2.0.4.v6 | 11.2.0.4.v7</code></para></li></ul><para><b>Oracle Database Standard Edition Two (oracle-se2)</b></para><ul><li><para><b>Version 12.1 (available in all AWS regions except us-gov-west-1):</b><code> 12.1.0.2.v2
        /// | 12.1.0.2.v3</code></para></li></ul><para><b>PostgreSQL</b></para><ul><li><para><b>Version 9.5 (available in all AWS regions except us-gov-west-1):</b><code> 9.5.2</code></para></li><li><para><b>Version 9.4 (available in all AWS regions):</b><code> 9.4.1 | 9.4.4 | 9.4.5</code></para></li><li><para><b>Version 9.4 (available in all AWS regions except us-gov-west-1):</b><code> 9.4.7</code></para></li><li><para><b>Version 9.3 (available in all AWS regions except eu-central-1, ap-northeast-2):</b><code> 9.3.1 | 9.3.2</code></para></li><li><para><b>Version 9.3 (available in all AWS regions except ap-northeast-2):</b><code> 9.3.10
        /// | 9.3.3 | 9.3.5 | 9.3.6 | 9.3.9</code></para></li><li><para><b>Version 9.3 (available in all AWS regions except ap-northeast-2, us-gov-west-1):</b><code> 9.3.12</code></para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
