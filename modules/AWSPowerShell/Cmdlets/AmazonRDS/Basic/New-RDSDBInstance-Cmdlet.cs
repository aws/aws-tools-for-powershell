...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class NewRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// an Aurora cluster volume.</para><para><b>MySQL</b></para><para>Constraints to the amount of storage for each storage type are the following: </para><ul><li><para>General Purpose (SSD) storage (gp2): Must be an integer from 5 to 16384.</para></li><li><para>Provisioned IOPS storage (io1): Must be an integer from 100 to 16384.</para></li><li><para>Magnetic storage (standard): Must be an integer from 5 to 3072.</para></li></ul><para><b>MariaDB</b></para><para>Constraints to the amount of storage for each storage type are the following: </para><ul><li><para>General Purpose (SSD) storage (gp2): Must be an integer from 5 to 16384.</para></li><li><para>Provisioned IOPS storage (io1): Must be an integer from 100 to 16384.</para></li><li><para>Magnetic storage (standard): Must be an integer from 5 to 3072.</para></li></ul><para><b>PostgreSQL</b></para><para>Constraints to the amount of storage for each storage type are the following: </para><ul><li><para>General Purpose (SSD) storage (gp2): Must be an integer from 5 to 16384.</para></li><li><para>Provisioned IOPS storage (io1): Must be an integer from 100 to 16384.</para></li><li><para>Magnetic storage (standard): Must be an integer from 5 to 3072.</para></li></ul><para><b>Oracle</b></para><para>Constraints to the amount of storage for each storage type are the following: </para><ul><li><para>General Purpose (SSD) storage (gp2): Must be an integer from 10 to 16384.</para></li><li><para>Provisioned IOPS storage (io1): Must be an integer from 100 to 16384.</para></li><li><para>Magnetic storage (standard): Must be an integer from 10 to 3072.</para></li></ul><para><b>SQL Server</b></para><para>Constraints to the amount of storage for each storage type are the following: </para><ul><li><para>General Purpose (SSD) storage (gp2):</para><ul><li><para>Enterprise and Standard editions: Must be an integer from 200 to 16384.</para></li><li><para>Web and Express editions: Must be an integer from 20 to 16384.</para></li></ul></li><li><para>Provisioned IOPS storage (io1):</para><ul><li><para>Enterprise and Standard editions: Must be an integer from 200 to 16384.</para></li><li><para>Web and Express editions: Must be an integer from 100 to 16384.</para></li></ul></li><li><para>Magnetic storage (standard):</para><ul><li><para>Enterprise and Standard editions: Must be an integer from 200 to 1024.</para></li><li><para>Web and Express editions: Must be an integer from 20 to 1024.</para></li></ul></li></ul>
        /// </para>
        /// </summary>
        ...
        /// is managed by the DB cluster. For more information, see <a>CreateDBCluster</a>.</para><para><b>MariaDB</b></para><ul><li><para><code>10.1.26</code> (supported in all AWS Regions)</para></li><li><para><code>10.1.23</code> (supported in all AWS Regions)</para></li><li><para><code>10.1.19</code> (supported in all AWS Regions)</para></li><li><para><code>10.1.14</code> (supported in all AWS Regions except us-east-2)</para></li></ul><ul><li><para><code>10.0.32</code> (supported in all AWS Regions)</para></li><li><para><code>10.0.31</code> (supported in all AWS Regions)</para></li><li><para><code>10.0.28</code> (supported in all AWS Regions)</para></li><li><para><code>10.0.24</code> (supported in all AWS Regions)</para></li><li><para><code>10.0.17</code> (supported in all AWS Regions except us-east-2, ca-central-1,
