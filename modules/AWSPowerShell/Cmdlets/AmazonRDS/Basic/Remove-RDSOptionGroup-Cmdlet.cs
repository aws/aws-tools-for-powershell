...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class RemoveRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RDSOptionGroup (DeleteOptionGroup)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.OptionGroupName;
        ...
        private Amazon.RDS.Model.DeleteOptionGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteOptionGroupRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteOptionGroupAsync(request).GetAwaiter().GetResult();
                #else
