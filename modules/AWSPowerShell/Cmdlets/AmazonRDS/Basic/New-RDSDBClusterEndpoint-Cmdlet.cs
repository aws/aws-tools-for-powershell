...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service CreateDBClusterEndpoint API operation.", Operation = new[] {"CreateDBClusterEndpoint"})]
    [AWSCmdletOutput("Amazon.RDS.Model.CreateDBClusterEndpointResponse",
        "This cmdlet returns a Amazon.RDS.Model.CreateDBClusterEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
