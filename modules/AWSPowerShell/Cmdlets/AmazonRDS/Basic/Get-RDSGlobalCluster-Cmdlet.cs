...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RDSGlobalCluster")]
    [OutputType("Amazon.RDS.Model.GlobalCluster")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeGlobalClusters API operation.", Operation = new[] {"DescribeGlobalClusters"})]
    [AWSCmdletOutput("Amazon.RDS.Model.GlobalCluster",
        "This cmdlet returns a collection of GlobalCluster objects.",
        "The service call response (type Amazon.RDS.Model.DescribeGlobalClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetRDSGlobalClusterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeGlobalClustersRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.GlobalClusters;
                        ...
                        int _receivedThisCall = response.GlobalClusters.Count;
        ...
        private Amazon.RDS.Model.DescribeGlobalClustersResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeGlobalClustersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeGlobalClusters");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeGlobalClustersAsync(request);
                return task.Result;
                #else
