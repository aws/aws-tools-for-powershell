...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Invokes the DescribeDBParameterGroups operation against Amazon Relational Database Service.", Operation = new[] {"DescribeDBParameterGroups"})]
    ...
    public partial class GetRDSDBParameterGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        private Amazon.RDS.Model.DescribeDBParameterGroupsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBParameterGroupsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeDBParameterGroupsAsync(request);
                return task.Result;
                #else
