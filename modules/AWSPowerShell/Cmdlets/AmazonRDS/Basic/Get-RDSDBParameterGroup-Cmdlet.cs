...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBParameterGroups API operation.", Operation = new[] {"DescribeDBParameterGroups"})]
    [AWSCmdletOutput("Amazon.RDS.Model.DBParameterGroup",
        "This cmdlet returns a collection of DBParameterGroup objects.",
    ...
    public partial class GetRDSDBParameterGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBParameterGroupsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DBParameterGroups;
                        ...
                        int _receivedThisCall = response.DBParameterGroups.Count;
        ...
        private Amazon.RDS.Model.DescribeDBParameterGroupsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBParameterGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBParameterGroups");
            try
            {
                #if DESKTOP
                return client.DescribeDBParameterGroups(request);
                #elif CORECLR
                return client.DescribeDBParameterGroupsAsync(request).GetAwaiter().GetResult();
                #else
