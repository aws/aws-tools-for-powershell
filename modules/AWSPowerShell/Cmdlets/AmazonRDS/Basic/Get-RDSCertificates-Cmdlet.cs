...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Invokes the DescribeCertificates operation against Amazon Relational Database Service.", Operation = new[] {"DescribeCertificates"})]
    [AWSCmdletOutput("Amazon.RDS.Model.Certificate",
        "This cmdlet returns a collection of Certificate objects.",
        "The service call response (type DescribeCertificatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetRDSCertificatesCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
