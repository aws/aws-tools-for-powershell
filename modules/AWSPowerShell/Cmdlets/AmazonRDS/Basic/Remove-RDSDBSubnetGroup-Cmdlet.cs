...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteDBSubnetGroup API operation.", Operation = new[] {"DeleteDBSubnetGroup"})]
    ...
    public partial class RemoveRDSDBSubnetGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the database subnet group to delete.</para><note><para>You cannot delete the default subnet group.</para></note><para>Constraints:</para><para>Constraints: Must match the name of an existing DBSubnetGroup. Must not be default.</para><para>Example: <code>mySubnetgroup</code></para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RDSDBSubnetGroup (DeleteDBSubnetGroup)"))
            {
                return;
            }
