...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Invokes the CopyDBClusterParameterGroup operation against Amazon Relational Database Service.", Operation = new[] {"CopyDBClusterParameterGroup"})]
    ...
    public class CopyRDSDBClusterParameterGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        private static Amazon.RDS.Model.CopyDBClusterParameterGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.CopyDBClusterParameterGroupRequest request)
        {
