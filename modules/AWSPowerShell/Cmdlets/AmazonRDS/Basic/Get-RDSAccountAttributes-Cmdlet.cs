...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "RDSAccountAttributes")]
    [OutputType("Amazon.RDS.Model.AccountQuota")]
    [AWSCmdlet("Invokes the DescribeAccountAttributes operation against Amazon Relational Database Service.", Operation = new[] {"DescribeAccountAttributes"})]
    [AWSCmdletOutput("Amazon.RDS.Model.AccountQuota",
    ...
    public partial class GetRDSAccountAttributesCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        private static Amazon.RDS.Model.DescribeAccountAttributesResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeAccountAttributesRequest request)
        {
            #if DESKTOP
