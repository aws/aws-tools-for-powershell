...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// What Is Amazon Aurora?</a> in the <i>Amazon Aurora User Guide.</i></para><br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    ...
    public partial class GetRDSDBClusterSnapshotCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        private Amazon.RDS.Model.DescribeDBClusterSnapshotsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBClusterSnapshotsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeDBClusterSnapshotsAsync(request);
                return task.Result;
                #else
