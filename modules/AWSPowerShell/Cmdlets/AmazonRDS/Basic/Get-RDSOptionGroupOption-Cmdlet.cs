...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class GetRDSOptionGroupOptionCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.OptionGroupOptions;
        ...
        private static Amazon.RDS.Model.DescribeOptionGroupOptionsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeOptionGroupOptionsRequest request)
        {
            #if DESKTOP
            return client.DescribeOptionGroupOptions(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeOptionGroupOptionsAsync(request);
            return task.Result;
            #else
