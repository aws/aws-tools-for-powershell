...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public class CopyRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        /// <para>The identifier or ARN for the source option group. </para><para>Constraints:</para><ul><li>Must specify a valid option group.</li><li>If the source option group is
