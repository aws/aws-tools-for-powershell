...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RDSEventSubscription", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.RDS.Model.EventSubscription")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteEventSubscription API operation.", Operation = new[] {"DeleteEventSubscription"})]
    ...
    public partial class RemoveRDSEventSubscriptionCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RDSEventSubscription (DeleteEventSubscription)"))
            {
                return;
            }
