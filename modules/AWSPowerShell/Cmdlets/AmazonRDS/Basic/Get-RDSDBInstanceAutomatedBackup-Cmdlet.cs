...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBInstanceAutomatedBackups API operation.", Operation = new[] {"DescribeDBInstanceAutomatedBackups"})]
    [AWSCmdletOutput("Amazon.RDS.Model.DBInstanceAutomatedBackup",
        "This cmdlet returns a collection of DBInstanceAutomatedBackup objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DBInstanceAutomatedBackups;
