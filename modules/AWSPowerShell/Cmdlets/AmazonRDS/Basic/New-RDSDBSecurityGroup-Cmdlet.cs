...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public class NewRDSDBSecurityGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// a letter</li><li>Cannot end with a hyphen or contain two consecutive hyphens</li><li>Must not be "Default"</li><li>May not contain spaces</li></ul><para>Example: <code>mysecuritygroup</code></para>
        /// </para>
        /// </summary>
