...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteDBClusterEndpoint API operation.", Operation = new[] {"DeleteDBClusterEndpoint"})]
    [AWSCmdletOutput("Amazon.RDS.Model.DeleteDBClusterEndpointResponse",
        "This cmdlet returns a Amazon.RDS.Model.DeleteDBClusterEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
