...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Invokes the DescribeDBParameters operation against Amazon Relational Database Service.", Operation = new[] {"DescribeDBParameters"})]
    ...
    public partial class GetRDSDBParameterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBParametersRequest();
        ...
        private Amazon.RDS.Model.DescribeDBParametersResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBParameters");
            #if DESKTOP
