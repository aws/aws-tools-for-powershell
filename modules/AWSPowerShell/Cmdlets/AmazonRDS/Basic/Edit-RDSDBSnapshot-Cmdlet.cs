...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EditRDSDBSnapshotCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The engine version to update the DB snapshot to. </para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.RDS.Model.ModifyDBSnapshotResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.ModifyDBSnapshotRequest request)
        {
            #if DESKTOP
