...
{
    /// <summary>
    /// Returns information about endpoints for an Amazon Aurora DB cluster.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    [Cmdlet("Get", "RDSDBClusterEndpoint")]
    [OutputType("Amazon.RDS.Model.DBClusterEndpoint")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBClusterEndpoints API operation.", Operation = new[] {"DescribeDBClusterEndpoints"})]
    [AWSCmdletOutput("Amazon.RDS.Model.DBClusterEndpoint",
        "This cmdlet returns a collection of DBClusterEndpoint objects.",
    ...
    public partial class GetRDSDBClusterEndpointCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DBClusterEndpoints;
        ...
        private Amazon.RDS.Model.DescribeDBClusterEndpointsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBClusterEndpointsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeDBClusterEndpointsAsync(request);
                return task.Result;
                #else
