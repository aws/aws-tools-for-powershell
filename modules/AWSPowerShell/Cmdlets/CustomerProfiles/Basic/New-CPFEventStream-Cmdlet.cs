...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "CPFEventStream", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Connect Customer Profiles CreateEventStream API operation.", Operation = new[] {"CreateEventStream"}, SelectReturnType = typeof(Amazon.CustomerProfiles.Model.CreateEventStreamResponse))]
    [AWSCmdletOutput("System.String or Amazon.CustomerProfiles.Model.CreateEventStreamResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CustomerProfiles.Model.CreateEventStreamResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCPFEventStreamCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EventStreamArn";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CPFEventStream (CreateEventStream)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.CreateEventStreamResponse, NewCPFEventStreamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.CreateEventStreamRequest();
        ...
        private Amazon.CustomerProfiles.Model.CreateEventStreamResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.CreateEventStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "CreateEventStream");
            try
            {
                #if DESKTOP
                return client.CreateEventStream(request);
                #elif CORECLR
                return client.CreateEventStreamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Uri { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.CreateEventStreamResponse, NewCPFEventStreamCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EventStreamArn;
        }
