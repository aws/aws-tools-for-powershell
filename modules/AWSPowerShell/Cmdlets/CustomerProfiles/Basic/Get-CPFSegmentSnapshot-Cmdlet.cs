...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </summary>
    [Cmdlet("Get", "CPFSegmentSnapshot")]
    [OutputType("Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse")]
    [AWSCmdlet("Calls the Amazon Connect Customer Profiles GetSegmentSnapshot API operation.", Operation = new[] {"GetSegmentSnapshot"}, SelectReturnType = typeof(Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse))]
    [AWSCmdletOutput("Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse",
        "This cmdlet returns an Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse object containing multiple properties."
    )]
    public partial class GetCPFSegmentSnapshotCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse, GetCPFSegmentSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.GetSegmentSnapshotRequest();
        ...
        private Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.GetSegmentSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "GetSegmentSnapshot");
            try
            {
                #if DESKTOP
                return client.GetSegmentSnapshot(request);
                #elif CORECLR
                return client.GetSegmentSnapshotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SegmentDefinitionName { get; set; }
            public System.String SnapshotId { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.GetSegmentSnapshotResponse, GetCPFSegmentSnapshotCmdlet, object> Select { get; set; } =
