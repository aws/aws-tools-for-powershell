...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    public partial class GetCPFProfileRecommendationCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        /// for personalized-ranking use cases.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The contextual metadata used to provide dynamic runtime information to tailor recommendations.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// for including or excluding items from the recommendation results.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CustomerProfiles.Model.GetProfileRecommendationsResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.GetProfileRecommendationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetProfileRecommendations(request);
                #elif CORECLR
                return client.GetProfileRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
