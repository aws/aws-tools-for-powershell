...
{
    /// <summary>
    /// Returns a set of <c>MatchIds</c> that belong to the given domain.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCPFRuleBasedMatchListCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        private Amazon.CustomerProfiles.Model.ListRuleBasedMatchesResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.ListRuleBasedMatchesRequest request)
        {
            ...
            try
            {
                return client.ListRuleBasedMatchesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
