...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "CPFProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewCPFProfileCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CPFProfile (CreateProfile)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.CreateProfileRequest();
            ...
            request.Address = new Amazon.CustomerProfiles.Model.Address();
            ...
            request.BillingAddress = new Amazon.CustomerProfiles.Model.Address();
            ...
            request.MailingAddress = new Amazon.CustomerProfiles.Model.Address();
            ...
            request.ShippingAddress = new Amazon.CustomerProfiles.Model.Address();
        ...
        private Amazon.CustomerProfiles.Model.CreateProfileResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.CreateProfileRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ShippingAddress_Province { get; set; }
            public System.String ShippingAddress_State { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.CreateProfileResponse, NewCPFProfileCmdlet, object> Select { get; set; } =
