...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CPFProfileKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Connect Customer Profiles DeleteProfileKey API operation.", Operation = new[] {"DeleteProfileKey"}, SelectReturnType = typeof(Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse))]
    [AWSCmdletOutput("System.String or Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCPFProfileKeyCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CPFProfileKey (DeleteProfileKey)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse, RemoveCPFProfileKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.DeleteProfileKeyRequest();
        ...
        private Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.DeleteProfileKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "DeleteProfileKey");
            try
            {
                #if DESKTOP
                return client.DeleteProfileKey(request);
                #elif CORECLR
                return client.DeleteProfileKeyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CustomerProfiles.Model.DeleteProfileKeyResponse, RemoveCPFProfileKeyCmdlet, object> Select { get; set; } =
