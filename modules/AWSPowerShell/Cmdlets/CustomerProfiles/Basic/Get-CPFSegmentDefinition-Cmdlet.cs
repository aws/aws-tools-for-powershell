...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </summary>
    [Cmdlet("Get", "CPFSegmentDefinition")]
    [OutputType("Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse")]
    [AWSCmdlet("Calls the Amazon Connect Customer Profiles GetSegmentDefinition API operation.", Operation = new[] {"GetSegmentDefinition"}, SelectReturnType = typeof(Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse))]
    [AWSCmdletOutput("Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse",
        "This cmdlet returns an Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse object containing multiple properties."
    )]
    public partial class GetCPFSegmentDefinitionCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse, GetCPFSegmentDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.GetSegmentDefinitionRequest();
        ...
        private Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.GetSegmentDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "GetSegmentDefinition");
            try
            {
                #if DESKTOP
                return client.GetSegmentDefinition(request);
                #elif CORECLR
                return client.GetSegmentDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String SegmentDefinitionName { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.GetSegmentDefinitionResponse, GetCPFSegmentDefinitionCmdlet, object> Select { get; set; } =
