...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CPFDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveCPFDomainCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CPFDomain (DeleteDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.DeleteDomainResponse, RemoveCPFDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.DeleteDomainRequest();
        ...
        private Amazon.CustomerProfiles.Model.DeleteDomainResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.DeleteDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "DeleteDomain");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.DeleteDomainResponse, RemoveCPFDomainCmdlet, object> Select { get; set; } =
