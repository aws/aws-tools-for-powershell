...
namespace Amazon.PowerShell.Cmdlets.CPF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CPFCalculatedAttributeDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCPFCalculatedAttributeDefinitionCmdlet : AmazonCustomerProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CPFCalculatedAttributeDefinition (DeleteCalculatedAttributeDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CustomerProfiles.Model.DeleteCalculatedAttributeDefinitionResponse, RemoveCPFCalculatedAttributeDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CustomerProfiles.Model.DeleteCalculatedAttributeDefinitionRequest();
        ...
        private Amazon.CustomerProfiles.Model.DeleteCalculatedAttributeDefinitionResponse CallAWSServiceOperation(IAmazonCustomerProfiles client, Amazon.CustomerProfiles.Model.DeleteCalculatedAttributeDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Customer Profiles", "DeleteCalculatedAttributeDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteCalculatedAttributeDefinition(request);
                #elif CORECLR
                return client.DeleteCalculatedAttributeDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CalculatedAttributeName { get; set; }
            public System.String DomainName { get; set; }
            public System.Func<Amazon.CustomerProfiles.Model.DeleteCalculatedAttributeDefinitionResponse, RemoveCPFCalculatedAttributeDefinitionCmdlet, object> Select { get; set; } =
