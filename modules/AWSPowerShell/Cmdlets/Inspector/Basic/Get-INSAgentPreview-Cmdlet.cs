...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector PreviewAgents API operation.", Operation = new[] {"PreviewAgents"}, SelectReturnType = typeof(Amazon.Inspector.Model.PreviewAgentsResponse))]
    [AWSCmdletOutput("Amazon.Inspector.Model.AgentPreview or Amazon.Inspector.Model.PreviewAgentsResponse",
        "This cmdlet returns a collection of Amazon.Inspector.Model.AgentPreview objects.",
        "The service call response (type Amazon.Inspector.Model.PreviewAgentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetINSAgentPreviewCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AgentPreviews";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PreviewAgentsArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.PreviewAgentsResponse, GetINSAgentPreviewCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.PreviewAgentsArn;
            }
            ...
            context.PreviewAgentsArn = this.PreviewAgentsArn;
            #if MODULAR
            if (this.PreviewAgentsArn == null && ParameterWasBound(nameof(this.PreviewAgentsArn)))
            {
                WriteWarning("You are passing $null as a value for parameter PreviewAgentsArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Inspector.Model.PreviewAgentsRequest();
            
            if (cmdletContext.MaxResult != null)
            {
                request.MaxResults = AutoIterationHelpers.ConvertEmitLimitToServiceTypeInt32(cmdletContext.MaxResult.Value);
            }
            if (cmdletContext.PreviewAgentsArn != null)
            {
                request.PreviewAgentsArn = cmdletContext.PreviewAgentsArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AgentPreviews.Count;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PreviewAgentsArn { get; set; }
            public System.Func<Amazon.Inspector.Model.PreviewAgentsResponse, GetINSAgentPreviewCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AgentPreviews;
        }
