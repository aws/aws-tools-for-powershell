...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class AddINSFindingAttributeCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The array of attributes that you want to assign to specified findings.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The ARNs that specify the findings that you want to assign attributes to.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Inspector.Model.AddAttributesToFindingsResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.AddAttributesToFindingsRequest request)
        {
            ...
            try
            {
                return client.AddAttributesToFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
