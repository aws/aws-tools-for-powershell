...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector ListRulesPackages API operation.", Operation = new[] {"ListRulesPackages"}, SelectReturnType = typeof(Amazon.Inspector.Model.ListRulesPackagesResponse))]
    [AWSCmdletOutput("System.String or Amazon.Inspector.Model.ListRulesPackagesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Inspector.Model.ListRulesPackagesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetINSRulesPackageListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RulesPackageArns";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.ListRulesPackagesResponse, GetINSRulesPackageListCmdlet>(Select) ??
        ...
        private Amazon.Inspector.Model.ListRulesPackagesResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.ListRulesPackagesRequest request)
        {
            ...
            try
            {
                return client.ListRulesPackagesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Inspector.Model.ListRulesPackagesResponse, GetINSRulesPackageListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RulesPackageArns;
        }
