...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class RegisterINSCrossAccountAccessRoleCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.RegisterCrossAccountAccessRoleResponse, RegisterINSCrossAccountAccessRoleCmdlet>(Select) ??
        ...
        private Amazon.Inspector.Model.RegisterCrossAccountAccessRoleResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.RegisterCrossAccountAccessRoleRequest request)
        {
            ...
            try
            {
                return client.RegisterCrossAccountAccessRoleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.Inspector.Model.RegisterCrossAccountAccessRoleResponse, RegisterINSCrossAccountAccessRoleCmdlet, object> Select { get; set; } =
