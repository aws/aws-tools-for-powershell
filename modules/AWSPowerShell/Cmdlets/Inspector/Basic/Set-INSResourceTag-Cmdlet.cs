...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Inspector SetTagsForResource API operation.", Operation = new[] {"SetTagsForResource"}, SelectReturnType = typeof(Amazon.Inspector.Model.SetTagsForResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Inspector.Model.SetTagsForResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Inspector.Model.SetTagsForResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class SetINSResourceTagCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A collection of key and value pairs that you want to set to the assessment template.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.SetTagsForResourceResponse, SetINSResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.Inspector.Model.Tag>(this.Tag);
            }
        ...
        private Amazon.Inspector.Model.SetTagsForResourceResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.SetTagsForResourceRequest request)
        {
            ...
            try
            {
                return client.SetTagsForResourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ResourceArn { get; set; }
            public List<Amazon.Inspector.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.Inspector.Model.SetTagsForResourceResponse, SetINSResourceTagCmdlet, object> Select { get; set; } =
