...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector DescribeAssessmentTemplates API operation.", Operation = new[] {"DescribeAssessmentTemplates"}, SelectReturnType = typeof(Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse))]
    [AWSCmdletOutput("Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse",
        "This cmdlet returns an Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetINSAssessmentTemplateCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse, GetINSAssessmentTemplateCmdlet>(Select) ??
        ...
        private Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.DescribeAssessmentTemplatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Inspector", "DescribeAssessmentTemplates");
            try
            {
                #if DESKTOP
                return client.DescribeAssessmentTemplates(request);
                #elif CORECLR
                return client.DescribeAssessmentTemplatesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Inspector.Model.DescribeAssessmentTemplatesResponse, GetINSAssessmentTemplateCmdlet, object> Select { get; set; } =
