...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class RemoveINSAssessmentTemplateCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.DeleteAssessmentTemplateResponse, RemoveINSAssessmentTemplateCmdlet>(Select) ??
        ...
        private Amazon.Inspector.Model.DeleteAssessmentTemplateResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.DeleteAssessmentTemplateRequest request)
        {
            ...
            try
            {
                return client.DeleteAssessmentTemplateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AssessmentTemplateArn { get; set; }
            public System.Func<Amazon.Inspector.Model.DeleteAssessmentTemplateResponse, RemoveINSAssessmentTemplateCmdlet, object> Select { get; set; } =
