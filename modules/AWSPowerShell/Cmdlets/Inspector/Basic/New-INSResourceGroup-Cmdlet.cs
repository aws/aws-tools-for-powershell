...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class NewINSResourceGroupCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A collection of keys and an array of possible values, '[{"key":"key1","values":["Value1","Value2"]},{"key":"Key2","values":["Value3"]}]'.</para><para>For example,'[{"key":"Name","values":["TestEC2Instance"]}]'.</para><para />
        ...
        private Amazon.Inspector.Model.CreateResourceGroupResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.CreateResourceGroupRequest request)
        {
            ...
            try
            {
                return client.CreateResourceGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
