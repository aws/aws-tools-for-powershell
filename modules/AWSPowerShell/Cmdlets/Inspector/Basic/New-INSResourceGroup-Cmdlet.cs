...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class NewINSResourceGroupCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceGroupTag' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceGroupTag;
            }
