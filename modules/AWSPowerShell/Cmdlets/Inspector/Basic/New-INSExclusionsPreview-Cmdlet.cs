...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector CreateExclusionsPreview API operation.", Operation = new[] {"CreateExclusionsPreview"}, SelectReturnType = typeof(Amazon.Inspector.Model.CreateExclusionsPreviewResponse))]
    [AWSCmdletOutput("System.String or Amazon.Inspector.Model.CreateExclusionsPreviewResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Inspector.Model.CreateExclusionsPreviewResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewINSExclusionsPreviewCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "PreviewToken";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AssessmentTemplateArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.CreateExclusionsPreviewResponse, NewINSExclusionsPreviewCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.AssessmentTemplateArn;
            }
        ...
        private Amazon.Inspector.Model.CreateExclusionsPreviewResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.CreateExclusionsPreviewRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.CreateExclusionsPreviewAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AssessmentTemplateArn { get; set; }
            public System.Func<Amazon.Inspector.Model.CreateExclusionsPreviewResponse, NewINSExclusionsPreviewCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PreviewToken;
        }
