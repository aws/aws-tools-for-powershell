...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector ListEventSubscriptions API operation.", Operation = new[] {"ListEventSubscriptions"}, SelectReturnType = typeof(Amazon.Inspector.Model.ListEventSubscriptionsResponse))]
    [AWSCmdletOutput("Amazon.Inspector.Model.Subscription or Amazon.Inspector.Model.ListEventSubscriptionsResponse",
        "This cmdlet returns a collection of Amazon.Inspector.Model.Subscription objects.",
        "The service call response (type Amazon.Inspector.Model.ListEventSubscriptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetINSEventSubscriptionCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.ListEventSubscriptionsResponse, GetINSEventSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Inspector.Model.ListEventSubscriptionsRequest();
        ...
        private Amazon.Inspector.Model.ListEventSubscriptionsResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.ListEventSubscriptionsRequest request)
        {
            ...
            try
            {
                return client.ListEventSubscriptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Inspector.Model.ListEventSubscriptionsResponse, GetINSEventSubscriptionCmdlet, object> Select { get; set; } =
