...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdletOutput("Amazon.Inspector.Model.DescribeRulesPackagesResponse",
        "This cmdlet returns an Amazon.Inspector.Model.DescribeRulesPackagesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetINSRulesPackageCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RulesPackageArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RulesPackageArn;
            }
        ...
        private Amazon.Inspector.Model.DescribeRulesPackagesResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.DescribeRulesPackagesRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeRulesPackagesAsync(request).GetAwaiter().GetResult();
                #else
