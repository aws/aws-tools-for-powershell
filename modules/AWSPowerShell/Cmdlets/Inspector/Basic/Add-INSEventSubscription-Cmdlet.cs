...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public partial class AddINSEventSubscriptionCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.SubscribeToEventResponse, AddINSEventSubscriptionCmdlet>(Select) ??
        ...
        private Amazon.Inspector.Model.SubscribeToEventResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.SubscribeToEventRequest request)
        {
            ...
            try
            {
                return client.SubscribeToEventAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceArn { get; set; }
            public System.String TopicArn { get; set; }
            public System.Func<Amazon.Inspector.Model.SubscribeToEventResponse, AddINSEventSubscriptionCmdlet, object> Select { get; set; } =
