...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Calls the Amazon Inspector ListExclusions API operation.", Operation = new[] {"ListExclusions"}, SelectReturnType = typeof(Amazon.Inspector.Model.ListExclusionsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Inspector.Model.ListExclusionsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Inspector.Model.ListExclusionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetINSExclusionListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ExclusionArns";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector.Model.ListExclusionsResponse, GetINSExclusionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ExclusionArns?.Count ?? 0;
        ...
        private Amazon.Inspector.Model.ListExclusionsResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.ListExclusionsRequest request)
        {
            ...
            try
            {
                return client.ListExclusionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Inspector.Model.ListExclusionsResponse, GetINSExclusionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ExclusionArns;
        }
