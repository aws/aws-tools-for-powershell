...
namespace Amazon.PowerShell.Cmdlets.CHAT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHATMicrosoftTeamsConfiguredTeam", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Chatbot DeleteMicrosoftTeamsConfiguredTeam API operation.", Operation = new[] {"DeleteMicrosoftTeamsConfiguredTeam"}, SelectReturnType = typeof(Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse))]
    [AWSCmdletOutput("None or Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHATMicrosoftTeamsConfiguredTeamCmdlet : AmazonChatbotClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHATMicrosoftTeamsConfiguredTeam (DeleteMicrosoftTeamsConfiguredTeam)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse, RemoveCHATMicrosoftTeamsConfiguredTeamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamRequest();
        ...
        private Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse CallAWSServiceOperation(IAmazonChatbot client, Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Chatbot", "DeleteMicrosoftTeamsConfiguredTeam");
            try
            {
                #if DESKTOP
                return client.DeleteMicrosoftTeamsConfiguredTeam(request);
                #elif CORECLR
                return client.DeleteMicrosoftTeamsConfiguredTeamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TeamId { get; set; }
            public System.Func<Amazon.Chatbot.Model.DeleteMicrosoftTeamsConfiguredTeamResponse, RemoveCHATMicrosoftTeamsConfiguredTeamCmdlet, object> Select { get; set; } =
