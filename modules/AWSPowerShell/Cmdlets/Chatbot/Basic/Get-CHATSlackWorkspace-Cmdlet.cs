...
namespace Amazon.PowerShell.Cmdlets.CHAT
{
    ...
    /// Chatbot.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCHATSlackWorkspaceCmdlet : AmazonChatbotClientCmdlet, IExecutor
    {
        ...
        private Amazon.Chatbot.Model.DescribeSlackWorkspacesResponse CallAWSServiceOperation(IAmazonChatbot client, Amazon.Chatbot.Model.DescribeSlackWorkspacesRequest request)
        {
            ...
            try
            {
                return client.DescribeSlackWorkspacesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
