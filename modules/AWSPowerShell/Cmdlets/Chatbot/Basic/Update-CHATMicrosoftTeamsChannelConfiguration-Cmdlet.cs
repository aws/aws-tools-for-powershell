...
namespace Amazon.PowerShell.Cmdlets.CHAT
{
    ...
    /// </summary>
    [Cmdlet("Update", "CHATMicrosoftTeamsChannelConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCHATMicrosoftTeamsChannelConfigurationCmdlet : AmazonChatbotClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Number (ARN) of the TeamsChannelConfiguration to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHATMicrosoftTeamsChannelConfiguration (UpdateMicrosoftTeamsChannelConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chatbot.Model.UpdateMicrosoftTeamsChannelConfigurationResponse, UpdateCHATMicrosoftTeamsChannelConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chatbot.Model.UpdateMicrosoftTeamsChannelConfigurationRequest();
        ...
        private Amazon.Chatbot.Model.UpdateMicrosoftTeamsChannelConfigurationResponse CallAWSServiceOperation(IAmazonChatbot client, Amazon.Chatbot.Model.UpdateMicrosoftTeamsChannelConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Chatbot", "UpdateMicrosoftTeamsChannelConfiguration");
            try
            {
                #if DESKTOP
                return client.UpdateMicrosoftTeamsChannelConfiguration(request);
                #elif CORECLR
                return client.UpdateMicrosoftTeamsChannelConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? UserAuthorizationRequired { get; set; }
            public System.Func<Amazon.Chatbot.Model.UpdateMicrosoftTeamsChannelConfigurationResponse, UpdateCHATMicrosoftTeamsChannelConfigurationCmdlet, object> Select { get; set; } =
