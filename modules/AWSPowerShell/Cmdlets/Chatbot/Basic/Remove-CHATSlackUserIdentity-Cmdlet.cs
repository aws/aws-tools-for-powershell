...
namespace Amazon.PowerShell.Cmdlets.CHAT
{
    ...
    [AWSCmdletOutput("None or Amazon.Chatbot.Model.DeleteSlackUserIdentityResponse",
        ...
        "The service response (type Amazon.Chatbot.Model.DeleteSlackUserIdentityResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
