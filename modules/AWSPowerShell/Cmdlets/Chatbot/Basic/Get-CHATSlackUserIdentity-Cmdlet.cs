...
{
    /// <summary>
    /// Lists all Slack user identities with a mapped role.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCHATSlackUserIdentityCmdlet : AmazonChatbotClientCmdlet, IExecutor
    {
        ...
        private Amazon.Chatbot.Model.DescribeSlackUserIdentitiesResponse CallAWSServiceOperation(IAmazonChatbot client, Amazon.Chatbot.Model.DescribeSlackUserIdentitiesRequest request)
        {
            ...
            try
            {
                return client.DescribeSlackUserIdentitiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
