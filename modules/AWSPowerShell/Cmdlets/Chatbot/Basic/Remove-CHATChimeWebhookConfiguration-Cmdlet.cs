...
namespace Amazon.PowerShell.Cmdlets.CHAT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHATChimeWebhookConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHATChimeWebhookConfigurationCmdlet : AmazonChatbotClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHATChimeWebhookConfiguration (DeleteChimeWebhookConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chatbot.Model.DeleteChimeWebhookConfigurationResponse, RemoveCHATChimeWebhookConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chatbot.Model.DeleteChimeWebhookConfigurationRequest();
        ...
        private Amazon.Chatbot.Model.DeleteChimeWebhookConfigurationResponse CallAWSServiceOperation(IAmazonChatbot client, Amazon.Chatbot.Model.DeleteChimeWebhookConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Chatbot", "DeleteChimeWebhookConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteChimeWebhookConfiguration(request);
                #elif CORECLR
                return client.DeleteChimeWebhookConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ChatConfigurationArn { get; set; }
            public System.Func<Amazon.Chatbot.Model.DeleteChimeWebhookConfigurationResponse, RemoveCHATChimeWebhookConfigurationCmdlet, object> Select { get; set; } =
