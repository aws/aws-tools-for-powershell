...
namespace Amazon.PowerShell.Cmdlets.CGP
{
    ...
    /// </summary>
    [Cmdlet("Add", "CGPNotificationChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddCGPNotificationChannelCmdlet : AmazonCodeGuruProfilerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or 2 channels to report to when anomalies are detected.</para><para />
        ...
        [Alias("Channels")]
        public Amazon.CodeGuruProfiler.Model.Channel[] Channel { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CGPNotificationChannel (AddNotificationChannels)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeGuruProfiler.Model.AddNotificationChannelsResponse, AddCGPNotificationChannelCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Channel != null)
            {
                context.Channel = new List<Amazon.CodeGuruProfiler.Model.Channel>(this.Channel);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeGuruProfiler.Model.AddNotificationChannelsRequest();
        ...
        private Amazon.CodeGuruProfiler.Model.AddNotificationChannelsResponse CallAWSServiceOperation(IAmazonCodeGuruProfiler client, Amazon.CodeGuruProfiler.Model.AddNotificationChannelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CodeGuru Profiler", "AddNotificationChannels");
            try
            {
                return client.AddNotificationChannelsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.CodeGuruProfiler.Model.Channel> Channel { get; set; }
            public System.String ProfilingGroupName { get; set; }
            public System.Func<Amazon.CodeGuruProfiler.Model.AddNotificationChannelsResponse, AddCGPNotificationChannelCmdlet, object> Select { get; set; } =
