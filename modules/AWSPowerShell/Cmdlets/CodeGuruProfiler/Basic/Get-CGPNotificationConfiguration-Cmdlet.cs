...
namespace Amazon.PowerShell.Cmdlets.CGP
{
    ...
    /// </summary>
    [Cmdlet("Get", "CGPNotificationConfiguration")]
    ...
    public partial class GetCGPNotificationConfigurationCmdlet : AmazonCodeGuruProfilerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeGuruProfiler.Model.GetNotificationConfigurationResponse, GetCGPNotificationConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeGuruProfiler.Model.GetNotificationConfigurationRequest();
        ...
        private Amazon.CodeGuruProfiler.Model.GetNotificationConfigurationResponse CallAWSServiceOperation(IAmazonCodeGuruProfiler client, Amazon.CodeGuruProfiler.Model.GetNotificationConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CodeGuru Profiler", "GetNotificationConfiguration");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ProfilingGroupName { get; set; }
            public System.Func<Amazon.CodeGuruProfiler.Model.GetNotificationConfigurationResponse, GetCGPNotificationConfigurationCmdlet, object> Select { get; set; } =
