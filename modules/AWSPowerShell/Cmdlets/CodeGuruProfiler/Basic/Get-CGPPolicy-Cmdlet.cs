...
namespace Amazon.PowerShell.Cmdlets.CGP
{
    ...
    public partial class GetCGPPolicyCmdlet : AmazonCodeGuruProfilerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeGuruProfiler.Model.GetPolicyResponse, GetCGPPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeGuruProfiler.Model.GetPolicyRequest();
        ...
        private Amazon.CodeGuruProfiler.Model.GetPolicyResponse CallAWSServiceOperation(IAmazonCodeGuruProfiler client, Amazon.CodeGuruProfiler.Model.GetPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CodeGuru Profiler", "GetPolicy");
            try
            {
        ...
        {
            public System.String ProfilingGroupName { get; set; }
            public System.Func<Amazon.CodeGuruProfiler.Model.GetPolicyResponse, GetCGPPolicyCmdlet, object> Select { get; set; } =
