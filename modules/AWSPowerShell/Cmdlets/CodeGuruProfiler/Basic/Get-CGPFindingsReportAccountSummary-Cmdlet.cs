...
namespace Amazon.PowerShell.Cmdlets.CGP
{
    ...
    [AWSCmdlet("Calls the Amazon CodeGuru Profiler GetFindingsReportAccountSummary API operation.", Operation = new[] {"GetFindingsReportAccountSummary"}, SelectReturnType = typeof(Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse))]
    [AWSCmdletOutput("Amazon.CodeGuruProfiler.Model.FindingsReportSummary or Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse",
        "This cmdlet returns a collection of Amazon.CodeGuruProfiler.Model.FindingsReportSummary objects.",
        "The service call response (type Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCGPFindingsReportAccountSummaryCmdlet : AmazonCodeGuruProfilerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReportSummaries";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DailyReportsOnly' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse, GetCGPFindingsReportAccountSummaryCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DailyReportsOnly;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryRequest();
        ...
        private Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse CallAWSServiceOperation(IAmazonCodeGuruProfiler client, Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CodeGuru Profiler", "GetFindingsReportAccountSummary");
            try
            {
                #if DESKTOP
                return client.GetFindingsReportAccountSummary(request);
                #elif CORECLR
                return client.GetFindingsReportAccountSummaryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodeGuruProfiler.Model.GetFindingsReportAccountSummaryResponse, GetCGPFindingsReportAccountSummaryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReportSummaries;
        }
