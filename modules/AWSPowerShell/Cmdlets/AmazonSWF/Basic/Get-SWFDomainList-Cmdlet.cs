...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [AWSCmdlet("Calls the AWS Simple Workflow Service ListDomains API operation.", Operation = new[] {"ListDomains"})]
    [AWSCmdletOutput("Amazon.SimpleWorkflow.Model.DomainInfo",
    ...
    public partial class GetSWFDomainListCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DomainInfos.Infos;
                        notes = new Dictionary<string, object>();
                        notes["NextPageToken"] = response.DomainInfos.NextPageToken;
                        ...
                        _nextMarker = response.DomainInfos.NextPageToken;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "ListDomains");
            try
            {
                #if DESKTOP
