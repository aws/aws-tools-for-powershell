...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "SWFDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the AWS Simple Workflow Service DeprecateDomain API operation.", Operation = new[] {"DeprecateDomain"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.SimpleWorkflow.Model.DeprecateDomainResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSWFDomainCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SWFDomain (DeprecateDomain)"))
            {
                return;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "DeprecateDomain");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeprecateDomainAsync(request);
                return task.Result;
                #else
