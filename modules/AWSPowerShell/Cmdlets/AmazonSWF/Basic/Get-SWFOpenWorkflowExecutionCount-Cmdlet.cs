...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [AWSCmdlet("Calls the AWS Simple Workflow Service CountOpenWorkflowExecutions API operation.", Operation = new[] {"CountOpenWorkflowExecutions"})]
    ...
    public partial class GetSWFOpenWorkflowExecutionCountCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "CountOpenWorkflowExecutions");
            try
            {
                #if DESKTOP
