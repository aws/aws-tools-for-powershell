...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [AWSCmdlet("Calls the AWS Simple Workflow Service CountPendingDecisionTasks API operation.", Operation = new[] {"CountPendingDecisionTasks"})]
    ...
    public partial class GetSWFPendingDecisionTaskCountCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "CountPendingDecisionTasks");
            try
            {
                #if DESKTOP
                ...
                var task = client.CountPendingDecisionTasksAsync(request);
                return task.Result;
                #else
