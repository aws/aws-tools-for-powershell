...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [AWSCmdlet("Calls the AWS Simple Workflow Service DescribeWorkflowType API operation.", Operation = new[] {"DescribeWorkflowType"})]
    [AWSCmdletOutput("Amazon.SimpleWorkflow.Model.WorkflowTypeDetail",
        "This cmdlet returns a Amazon.SimpleWorkflow.Model.WorkflowTypeDetail object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSWFWorkflowTypeCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "DescribeWorkflowType");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeWorkflowTypeAsync(request);
                return task.Result;
                #else
