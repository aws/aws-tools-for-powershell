...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [AWSCmdlet("Calls the AWS Simple Workflow Service SignalWorkflowExecution API operation.", Operation = new[] {"SignalWorkflowExecution"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the SignalName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class SendSWFSignalToWorkflowExecutionCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.SignalName;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service", "SignalWorkflowExecution");
            try
            {
                #if DESKTOP
