...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    /// Deletes a workflow.
    /// </summary>
    [Cmdlet("Remove", "OMICSWorkflow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveOMICSWorkflowCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OMICSWorkflow (DeleteWorkflow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.DeleteWorkflowResponse, RemoveOMICSWorkflowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.DeleteWorkflowRequest();
        ...
        private Amazon.Omics.Model.DeleteWorkflowResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.DeleteWorkflowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "DeleteWorkflow");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Omics.Model.DeleteWorkflowResponse, RemoveOMICSWorkflowCmdlet, object> Select { get; set; } =
