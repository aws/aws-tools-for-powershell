...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    /// store.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Omics.Model.ReadSetUploadPartListItem or Amazon.Omics.Model.ListReadSetUploadPartsResponse",
        ...
        "The service call response (type Amazon.Omics.Model.ListReadSetUploadPartsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOMICSReadSetUploadPartListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Omics.Model.ListReadSetUploadPartsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListReadSetUploadPartsRequest request)
        {
            ...
            try
            {
                return client.ListReadSetUploadPartsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
