...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    /// operation to monitor runs and to identify which specific tasks have failed.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetOMICSRunTaskListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.Omics.TaskStatus")]
        public Amazon.Omics.TaskStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.ListRunTasksResponse, GetOMICSRunTaskListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Omics.Model.ListRunTasksRequest();
        ...
        private Amazon.Omics.Model.ListRunTasksResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListRunTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "ListRunTasks");
            try
            {
                return client.ListRunTasksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StartingToken { get; set; }
            public Amazon.Omics.TaskStatus Status { get; set; }
            public System.Func<Amazon.Omics.Model.ListRunTasksResponse, GetOMICSRunTaskListCmdlet, object> Select { get; set; } =
