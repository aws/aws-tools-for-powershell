...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    [AWSCmdlet("Calls the Amazon Omics ListReadSetActivationJobs API operation.", Operation = new[] {"ListReadSetActivationJobs"}, SelectReturnType = typeof(Amazon.Omics.Model.ListReadSetActivationJobsResponse))]
    [AWSCmdletOutput("Amazon.Omics.Model.ActivateReadSetJobItem or Amazon.Omics.Model.ListReadSetActivationJobsResponse",
        "This cmdlet returns a collection of Amazon.Omics.Model.ActivateReadSetJobItem objects.",
        "The service call response (type Amazon.Omics.Model.ListReadSetActivationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOMICSReadSetActivationJobListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Omics.ReadSetActivationJobStatus")]
        public Amazon.Omics.ReadSetActivationJobStatus Filter_Status { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ActivationJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.ListReadSetActivationJobsResponse, GetOMICSReadSetActivationJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.ListReadSetActivationJobsRequest();
            
            
             // populate Filter
            var requestFilterIsNull = true;
            request.Filter = new Amazon.Omics.Model.ActivateReadSetFilter();
            ...
            Amazon.Omics.ReadSetActivationJobStatus requestFilter_filter_Status = null;
        ...
        private Amazon.Omics.Model.ListReadSetActivationJobsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListReadSetActivationJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "ListReadSetActivationJobs");
            try
            {
                #if DESKTOP
                return client.ListReadSetActivationJobs(request);
                #elif CORECLR
                return client.ListReadSetActivationJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SequenceStoreId { get; set; }
            public System.Func<Amazon.Omics.Model.ListReadSetActivationJobsResponse, GetOMICSReadSetActivationJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ActivationJobs;
        }
