...
{
    /// <summary>
    /// Retrieves a list of read set import jobs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "OMICSReadSetImportJobList")]
    [OutputType("Amazon.Omics.Model.ImportReadSetJobItem")]
    ...
    public partial class GetOMICSReadSetImportJobListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Omics.ReadSetImportJobStatus")]
        public Amazon.Omics.ReadSetImportJobStatus Filter_Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.ListReadSetImportJobsResponse, GetOMICSReadSetImportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Omics.Model.ListReadSetImportJobsRequest();
            
            
             // populate Filter
            var requestFilterIsNull = true;
            request.Filter = new Amazon.Omics.Model.ImportReadSetFilter();
            ...
            Amazon.Omics.ReadSetImportJobStatus requestFilter_filter_Status = null;
        ...
        private Amazon.Omics.Model.ListReadSetImportJobsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListReadSetImportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "ListReadSetImportJobs");
            try
            {
                return client.ListReadSetImportJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SequenceStoreId { get; set; }
            public System.Func<Amazon.Omics.Model.ListReadSetImportJobsResponse, GetOMICSReadSetImportJobListCmdlet, object> Select { get; set; } =
