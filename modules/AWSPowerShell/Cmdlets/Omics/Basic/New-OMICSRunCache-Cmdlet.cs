...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    public partial class NewOMICSRunCacheCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the CacheS3Location parameter.
        /// The -PassThru parameter is deprecated, use -Select '^CacheS3Location' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CacheS3Location' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CacheS3Location;
            }
        ...
        private Amazon.Omics.Model.CreateRunCacheResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.CreateRunCacheRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateRunCache(request);
                #elif CORECLR
                return client.CreateRunCacheAsync(request).GetAwaiter().GetResult();
                #else
