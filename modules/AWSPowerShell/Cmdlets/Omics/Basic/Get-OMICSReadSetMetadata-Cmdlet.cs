...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    public partial class GetOMICSReadSetMetadataCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.GetReadSetMetadataResponse, GetOMICSReadSetMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.GetReadSetMetadataRequest();
        ...
        private Amazon.Omics.Model.GetReadSetMetadataResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.GetReadSetMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "GetReadSetMetadata");
            try
            {
                #if DESKTOP
                return client.GetReadSetMetadata(request);
                #elif CORECLR
                return client.GetReadSetMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String SequenceStoreId { get; set; }
            public System.Func<Amazon.Omics.Model.GetReadSetMetadataResponse, GetOMICSReadSetMetadataCmdlet, object> Select { get; set; } =
