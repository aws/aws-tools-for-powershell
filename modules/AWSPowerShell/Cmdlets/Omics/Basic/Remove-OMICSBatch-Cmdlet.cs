...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Omics DeleteBatch API operation.", Operation = new[] {"DeleteBatch"}, SelectReturnType = typeof(Amazon.Omics.Model.DeleteBatchResponse))]
    [AWSCmdletOutput("None or Amazon.Omics.Model.DeleteBatchResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Omics.Model.DeleteBatchResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveOMICSBatchCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Omics.Model.DeleteBatchResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OMICSBatch (DeleteBatch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.DeleteBatchResponse, RemoveOMICSBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.DeleteBatchRequest();
        ...
        private Amazon.Omics.Model.DeleteBatchResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.DeleteBatchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "DeleteBatch");
            try
            {
                #if DESKTOP
                return client.DeleteBatch(request);
                #elif CORECLR
                return client.DeleteBatchAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String BatchId { get; set; }
            public System.Func<Amazon.Omics.Model.DeleteBatchResponse, RemoveOMICSBatchCmdlet, object> Select { get; set; } =
