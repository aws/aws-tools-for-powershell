...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    [AWSCmdletOutput("Amazon.Omics.Model.UpdateVariantStoreResponse",
        "This cmdlet returns an Amazon.Omics.Model.UpdateVariantStoreResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateOMICSVariantStoreCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Omics.Model.UpdateVariantStoreResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.UpdateVariantStoreRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateVariantStore(request);
                #elif CORECLR
                return client.UpdateVariantStoreAsync(request).GetAwaiter().GetResult();
                #else
