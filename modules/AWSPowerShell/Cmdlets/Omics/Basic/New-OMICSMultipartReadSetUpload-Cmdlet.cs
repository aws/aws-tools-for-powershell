...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    public partial class NewOMICSMultipartReadSetUploadCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            #if MODULAR
            if (this.ReferenceArn == null && ParameterWasBound(nameof(this.ReferenceArn)))
            {
                WriteWarning("You are passing $null as a value for parameter ReferenceArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
