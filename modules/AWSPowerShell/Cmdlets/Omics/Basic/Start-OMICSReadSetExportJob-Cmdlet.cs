...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    [AWSCmdlet("Calls the Amazon Omics StartReadSetExportJob API operation.", Operation = new[] {"StartReadSetExportJob"}, SelectReturnType = typeof(Amazon.Omics.Model.StartReadSetExportJobResponse))]
    [AWSCmdletOutput("Amazon.Omics.Model.StartReadSetExportJobResponse",
        "This cmdlet returns an Amazon.Omics.Model.StartReadSetExportJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartOMICSReadSetExportJobCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Sources")]
        public Amazon.Omics.Model.ExportReadSet[] Source { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-OMICSReadSetExportJob (StartReadSetExportJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.StartReadSetExportJobResponse, StartOMICSReadSetExportJobCmdlet>(Select) ??
            ...
            if (this.Source != null)
            {
                context.Source = new List<Amazon.Omics.Model.ExportReadSet>(this.Source);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.StartReadSetExportJobRequest();
        ...
        private Amazon.Omics.Model.StartReadSetExportJobResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.StartReadSetExportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "StartReadSetExportJob");
            try
            {
                #if DESKTOP
                return client.StartReadSetExportJob(request);
                #elif CORECLR
                return client.StartReadSetExportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RoleArn { get; set; }
            public System.String SequenceStoreId { get; set; }
            public List<Amazon.Omics.Model.ExportReadSet> Source { get; set; }
            public System.Func<Amazon.Omics.Model.StartReadSetExportJobResponse, StartOMICSReadSetExportJobCmdlet, object> Select { get; set; } =
