...
{
    /// <summary>
    /// Amazon.Omics.IAmazonOmics.ListAnnotationImportJobs<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetOMICSAnnotationImportJobListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>IDs of annotation import jobs to retrieve.</para><para />
        ...
        private Amazon.Omics.Model.ListAnnotationImportJobsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListAnnotationImportJobsRequest request)
        {
            ...
            try
            {
                return client.ListAnnotationImportJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
