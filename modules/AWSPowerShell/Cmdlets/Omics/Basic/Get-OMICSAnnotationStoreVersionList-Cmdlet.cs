...
{
    /// <summary>
    /// Lists the versions of an annotation store.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "OMICSAnnotationStoreVersionList")]
    [OutputType("Amazon.Omics.Model.AnnotationStoreVersionItem")]
    ...
    public partial class GetOMICSAnnotationStoreVersionListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.Omics.VersionStatus")]
        public Amazon.Omics.VersionStatus Filter_Status { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AnnotationStoreVersions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.ListAnnotationStoreVersionsResponse, GetOMICSAnnotationStoreVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Omics.Model.ListAnnotationStoreVersionsRequest();
            
            
             // populate Filter
            var requestFilterIsNull = true;
            request.Filter = new Amazon.Omics.Model.ListAnnotationStoreVersionsFilter();
            Amazon.Omics.VersionStatus requestFilter_filter_Status = null;
        ...
        private Amazon.Omics.Model.ListAnnotationStoreVersionsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListAnnotationStoreVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "ListAnnotationStoreVersions");
            try
            {
                return client.ListAnnotationStoreVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Omics.Model.ListAnnotationStoreVersionsResponse, GetOMICSAnnotationStoreVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AnnotationStoreVersions;
        }
