...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "OMICSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveOMICSResourceTagCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Keys of tags to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OMICSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.UntagResourceResponse, RemoveOMICSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.UntagResourceRequest();
        ...
        private Amazon.Omics.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Omics.Model.UntagResourceResponse, RemoveOMICSResourceTagCmdlet, object> Select { get; set; } =
