...
{
    /// <summary>
    /// Retrieves a list of workflows.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetOMICSWorkflowListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.ListWorkflowsResponse, GetOMICSWorkflowListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Omics.Model.ListWorkflowsRequest();
        ...
        private Amazon.Omics.Model.ListWorkflowsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListWorkflowsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "ListWorkflows");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StartingToken { get; set; }
            public Amazon.Omics.WorkflowType Type { get; set; }
            public System.Func<Amazon.Omics.Model.ListWorkflowsResponse, GetOMICSWorkflowListCmdlet, object> Select { get; set; } =
