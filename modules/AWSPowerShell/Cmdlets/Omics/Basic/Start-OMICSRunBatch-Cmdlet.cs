...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    public partial class StartOMICSRunBatchCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// 100 runs, use <c>s3UriSettings</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// run-specific values take precedence when keys overlap.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// runs. To tag individual runs, use <c>defaultRunSetting.runTags</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.Omics.Model.StartRunBatchResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.StartRunBatchRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartRunBatch(request);
                #elif CORECLR
                return client.StartRunBatchAsync(request).GetAwaiter().GetResult();
                #else
