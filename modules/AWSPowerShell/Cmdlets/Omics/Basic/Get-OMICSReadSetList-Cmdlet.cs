...
{
    /// <summary>
    /// Retrieves a list of read sets.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Omics.Model.ReadSetListItem or Amazon.Omics.Model.ListReadSetsResponse",
        ...
        "The service call response (type Amazon.Omics.Model.ListReadSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOMICSReadSetListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Omics.Model.ListReadSetsResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListReadSetsRequest request)
        {
            ...
            try
            {
                return client.ListReadSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
