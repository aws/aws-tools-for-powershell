...
{
    /// <summary>
    /// Retrieves a list of annotation stores.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Omics.Model.AnnotationStoreItem or Amazon.Omics.Model.ListAnnotationStoresResponse",
        ...
        "The service call response (type Amazon.Omics.Model.ListAnnotationStoresResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOMICSAnnotationStoreListCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>IDs of stores to list.</para><para />
        ...
        private Amazon.Omics.Model.ListAnnotationStoresResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.ListAnnotationStoresRequest request)
        {
            ...
            try
            {
                return client.ListAnnotationStoresAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
