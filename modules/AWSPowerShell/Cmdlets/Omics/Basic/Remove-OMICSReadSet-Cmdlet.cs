...
namespace Amazon.PowerShell.Cmdlets.OMICS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "OMICSReadSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Omics.Model.ReadSetBatchError")]
    ...
    public partial class RemoveOMICSReadSetCmdlet : AmazonOmicsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The read sets' IDs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OMICSReadSet (BatchDeleteReadSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Omics.Model.BatchDeleteReadSetResponse, RemoveOMICSReadSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Omics.Model.BatchDeleteReadSetRequest();
        ...
        private Amazon.Omics.Model.BatchDeleteReadSetResponse CallAWSServiceOperation(IAmazonOmics client, Amazon.Omics.Model.BatchDeleteReadSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Omics", "BatchDeleteReadSet");
            try
            {
                return client.BatchDeleteReadSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SequenceStoreId { get; set; }
            public System.Func<Amazon.Omics.Model.BatchDeleteReadSetResponse, RemoveOMICSReadSetCmdlet, object> Select { get; set; } =
