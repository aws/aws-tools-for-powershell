...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdletOutput("Amazon.Lambda.Model.GetFunctionResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetFunctionResponse object containing multiple properties."
    )]
    public partial class GetLMFunctionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lambda.Model.GetFunctionResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetFunctionRequest request)
        {
            ...
            try
            {
                return client.GetFunctionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
