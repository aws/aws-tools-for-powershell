...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LMProvisionedConcurrencyConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Lambda DeleteProvisionedConcurrencyConfig API operation.", Operation = new[] {"DeleteProvisionedConcurrencyConfig"}, SelectReturnType = typeof(Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse))]
    [AWSCmdletOutput("None or Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveLMProvisionedConcurrencyConfigCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMProvisionedConcurrencyConfig (DeleteProvisionedConcurrencyConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse, RemoveLMProvisionedConcurrencyConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigRequest();
        ...
        private Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "DeleteProvisionedConcurrencyConfig");
            try
            {
                #if DESKTOP
                return client.DeleteProvisionedConcurrencyConfig(request);
                #elif CORECLR
                return client.DeleteProvisionedConcurrencyConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FunctionName { get; set; }
            public System.String Qualifier { get; set; }
            public System.Func<Amazon.Lambda.Model.DeleteProvisionedConcurrencyConfigResponse, RemoveLMProvisionedConcurrencyConfigCmdlet, object> Select { get; set; } =
