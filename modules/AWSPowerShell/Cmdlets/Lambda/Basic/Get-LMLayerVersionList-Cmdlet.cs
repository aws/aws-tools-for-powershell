...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class GetLMLayerVersionListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LayerVersions";
        #endregion
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListLayerVersionsResponse, GetLMLayerVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LayerVersions;
        }
