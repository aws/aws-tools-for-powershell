...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class RemoveLMLayerVersionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.DeleteLayerVersionResponse, RemoveLMLayerVersionCmdlet>(Select) ??
        ...
        private Amazon.Lambda.Model.DeleteLayerVersionResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.DeleteLayerVersionRequest request)
        {
            ...
            try
            {
                return client.DeleteLayerVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String LayerName { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.Lambda.Model.DeleteLayerVersionResponse, RemoveLMLayerVersionCmdlet, object> Select { get; set; } =
