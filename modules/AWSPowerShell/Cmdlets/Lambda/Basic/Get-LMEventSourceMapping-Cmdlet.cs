...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdletOutput("Amazon.Lambda.Model.GetEventSourceMappingResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetEventSourceMappingResponse object containing multiple properties."
    )]
    public partial class GetLMEventSourceMappingCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lambda.Model.GetEventSourceMappingResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetEventSourceMappingRequest request)
        {
            ...
            try
            {
                return client.GetEventSourceMappingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
