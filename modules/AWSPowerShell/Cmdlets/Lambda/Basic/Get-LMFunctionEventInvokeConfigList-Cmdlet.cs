...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMFunctionEventInvokeConfigList")]
    [OutputType("Amazon.Lambda.Model.FunctionEventInvokeConfig")]
    [AWSCmdlet("Calls the AWS Lambda ListFunctionEventInvokeConfigs API operation.", Operation = new[] {"ListFunctionEventInvokeConfigs"}, SelectReturnType = typeof(Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.FunctionEventInvokeConfig or Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse",
        "This cmdlet returns a collection of Amazon.Lambda.Model.FunctionEventInvokeConfig objects.",
        "The service call response (type Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMFunctionEventInvokeConfigListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FunctionEventInvokeConfigs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse, GetLMFunctionEventInvokeConfigListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lambda.Model.ListFunctionEventInvokeConfigsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FunctionEventInvokeConfigs?.Count ?? 0;
        ...
        private Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.ListFunctionEventInvokeConfigsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "ListFunctionEventInvokeConfigs");
            try
            {
                #if DESKTOP
                return client.ListFunctionEventInvokeConfigs(request);
                #elif CORECLR
                return client.ListFunctionEventInvokeConfigsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListFunctionEventInvokeConfigsResponse, GetLMFunctionEventInvokeConfigListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FunctionEventInvokeConfigs;
        }
