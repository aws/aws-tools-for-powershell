...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class CheckpointLMDurableExecutionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// scheduling a timer. Updates are applied atomically as part of the checkpoint operation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Updates")]
        ...
        private Amazon.Lambda.Model.CheckpointDurableExecutionResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.CheckpointDurableExecutionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CheckpointDurableExecution(request);
                #elif CORECLR
                return client.CheckpointDurableExecutionAsync(request).GetAwaiter().GetResult();
                #else
