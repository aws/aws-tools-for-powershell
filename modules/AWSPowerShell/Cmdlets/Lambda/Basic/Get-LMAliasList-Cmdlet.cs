...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class GetLMAliasListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.ListAliasesResponse, GetLMAliasListCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "ListAliases");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListAliasesResponse, GetLMAliasListCmdlet, object> Select { get; set; } =
