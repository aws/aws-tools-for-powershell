...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class GetLMCodeSigningConfigListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.ListCodeSigningConfigsResponse, GetLMCodeSigningConfigListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lambda.Model.ListCodeSigningConfigsRequest();
        ...
        private Amazon.Lambda.Model.ListCodeSigningConfigsResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.ListCodeSigningConfigsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "ListCodeSigningConfigs");
            try
            {
                #if DESKTOP
                return client.ListCodeSigningConfigs(request);
                #elif CORECLR
                return client.ListCodeSigningConfigsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public System.Int32? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListCodeSigningConfigsResponse, GetLMCodeSigningConfigListCmdlet, object> Select { get; set; } =
