...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda GetFunctionConcurrency API operation.", Operation = new[] {"GetFunctionConcurrency"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetFunctionConcurrencyResponse))]
    [AWSCmdletOutput("System.Int32 or Amazon.Lambda.Model.GetFunctionConcurrencyResponse",
        "This cmdlet returns a System.Int32 object.",
        "The service call response (type Amazon.Lambda.Model.GetFunctionConcurrencyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMFunctionConcurrencyCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetFunctionConcurrencyResponse, GetLMFunctionConcurrencyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.GetFunctionConcurrencyRequest();
        ...
        private Amazon.Lambda.Model.GetFunctionConcurrencyResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetFunctionConcurrencyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "GetFunctionConcurrency");
            try
            {
                #if DESKTOP
                return client.GetFunctionConcurrency(request);
                #elif CORECLR
                return client.GetFunctionConcurrencyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FunctionName { get; set; }
            public System.Func<Amazon.Lambda.Model.GetFunctionConcurrencyResponse, GetLMFunctionConcurrencyCmdlet, object> Select { get; set; } =
