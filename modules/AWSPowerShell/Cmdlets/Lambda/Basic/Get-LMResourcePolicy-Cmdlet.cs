...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdletOutput("Amazon.Lambda.Model.GetResourcePolicyResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetResourcePolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMResourcePolicyCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the function you want to retrieve the policy for.
