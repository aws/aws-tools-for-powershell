...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMDurableExecution")]
    [OutputType("Amazon.Lambda.Model.GetDurableExecutionResponse")]
    [AWSCmdlet("Calls the AWS Lambda GetDurableExecution API operation.", Operation = new[] {"GetDurableExecution"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetDurableExecutionResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.GetDurableExecutionResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetDurableExecutionResponse object containing multiple properties."
    )]
    public partial class GetLMDurableExecutionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Lambda.Model.GetDurableExecutionResponse).
        /// Specifying the name of a property of type Amazon.Lambda.Model.GetDurableExecutionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetDurableExecutionResponse, GetLMDurableExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.GetDurableExecutionRequest();
        ...
        private Amazon.Lambda.Model.GetDurableExecutionResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetDurableExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "GetDurableExecution");
            try
            {
                #if DESKTOP
                return client.GetDurableExecution(request);
                #elif CORECLR
                return client.GetDurableExecutionAsync(request).GetAwaiter().GetResult();
                #else
