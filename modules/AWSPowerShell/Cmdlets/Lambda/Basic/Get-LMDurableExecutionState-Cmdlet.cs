...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMDurableExecutionState")]
    [OutputType("Amazon.Lambda.Model.Operation")]
    [AWSCmdlet("Calls the AWS Lambda GetDurableExecutionState API operation.", Operation = new[] {"GetDurableExecutionState"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetDurableExecutionStateResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.Operation or Amazon.Lambda.Model.GetDurableExecutionStateResponse",
        "This cmdlet returns a collection of Amazon.Lambda.Model.Operation objects.",
        "The service call response (type Amazon.Lambda.Model.GetDurableExecutionStateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMDurableExecutionStateCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A checkpoint token that identifies the current state of the execution. This token
        /// is provided by the Lambda runtime and ensures that state retrieval is consistent with
        /// the current execution context.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// the next page of operations. Each pagination token expires after 24 hours.</para>
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of operations to return per call. You can use <c>Marker</c> to
        /// retrieve additional pages of results. The default is 100 and the maximum allowed is
        /// 1000. A value of 0 uses the default.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxItems")]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Lambda.Model.GetDurableExecutionStateResponse).
        /// Specifying the name of a property of type Amazon.Lambda.Model.GetDurableExecutionStateResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetDurableExecutionStateResponse, GetLMDurableExecutionStateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lambda.Model.GetDurableExecutionStateRequest();
        ...
        private Amazon.Lambda.Model.GetDurableExecutionStateResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetDurableExecutionStateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "GetDurableExecutionState");
            try
            {
                #if DESKTOP
                return client.GetDurableExecutionState(request);
                #elif CORECLR
                return client.GetDurableExecutionStateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.GetDurableExecutionStateResponse, GetLMDurableExecutionStateCmdlet, object> Select { get; set; } =
