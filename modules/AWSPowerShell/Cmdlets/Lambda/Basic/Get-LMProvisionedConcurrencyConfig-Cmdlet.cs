...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMProvisionedConcurrencyConfig")]
    [OutputType("Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse")]
    [AWSCmdlet("Calls the AWS Lambda GetProvisionedConcurrencyConfig API operation.", Operation = new[] {"GetProvisionedConcurrencyConfig"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMProvisionedConcurrencyConfigCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse, GetLMProvisionedConcurrencyConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.GetProvisionedConcurrencyConfigRequest();
        ...
        private Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetProvisionedConcurrencyConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "GetProvisionedConcurrencyConfig");
            try
            {
                #if DESKTOP
                return client.GetProvisionedConcurrencyConfig(request);
                #elif CORECLR
                return client.GetProvisionedConcurrencyConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FunctionName { get; set; }
            public System.String Qualifier { get; set; }
            public System.Func<Amazon.Lambda.Model.GetProvisionedConcurrencyConfigResponse, GetLMProvisionedConcurrencyConfigCmdlet, object> Select { get; set; } =
