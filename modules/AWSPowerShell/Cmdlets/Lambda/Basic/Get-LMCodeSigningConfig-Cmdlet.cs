...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMCodeSigningConfig")]
    [OutputType("Amazon.Lambda.Model.GetCodeSigningConfigResponse")]
    [AWSCmdlet("Calls the AWS Lambda GetCodeSigningConfig API operation.", Operation = new[] {"GetCodeSigningConfig"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetCodeSigningConfigResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.GetCodeSigningConfigResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetCodeSigningConfigResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMCodeSigningConfigCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetCodeSigningConfigResponse, GetLMCodeSigningConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.GetCodeSigningConfigRequest();
        ...
        private Amazon.Lambda.Model.GetCodeSigningConfigResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetCodeSigningConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "GetCodeSigningConfig");
            try
            {
                #if DESKTOP
                return client.GetCodeSigningConfig(request);
                #elif CORECLR
                return client.GetCodeSigningConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CodeSigningConfigArn { get; set; }
            public System.Func<Amazon.Lambda.Model.GetCodeSigningConfigResponse, GetLMCodeSigningConfigCmdlet, object> Select { get; set; } =
