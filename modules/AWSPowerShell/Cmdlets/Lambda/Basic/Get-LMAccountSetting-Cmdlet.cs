...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda GetAccountSettings API operation.", Operation = new[] {"GetAccountSettings"}, SelectReturnType = typeof(Amazon.Lambda.Model.GetAccountSettingsResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.GetAccountSettingsResponse",
        "This cmdlet returns an Amazon.Lambda.Model.GetAccountSettingsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMAccountSettingCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.GetAccountSettingsResponse, GetLMAccountSettingCmdlet>(Select) ??
        ...
        {
            public System.Func<Amazon.Lambda.Model.GetAccountSettingsResponse, GetLMAccountSettingCmdlet, object> Select { get; set; } =
