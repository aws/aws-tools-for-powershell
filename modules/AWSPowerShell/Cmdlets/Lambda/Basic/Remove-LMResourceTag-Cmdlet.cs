...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Lambda UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.Lambda.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Lambda.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Lambda.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveLMResourceTagCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.UntagResourceResponse, RemoveLMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.UntagResourceRequest();
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Lambda.Model.UntagResourceResponse, RemoveLMResourceTagCmdlet, object> Select { get; set; } =
