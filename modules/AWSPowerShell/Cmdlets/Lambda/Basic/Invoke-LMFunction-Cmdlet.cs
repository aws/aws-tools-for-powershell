...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class InvokeLMFunctionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique name for the durable execution. If you invoke a durable function using a
        ...
        /// error.</para><para>If not specified, Lambda generates a unique identifier automatically. For more information,
        ...
        private Amazon.Lambda.Model.InvokeResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.InvokeRequest request)
        {
            ...
            try
            {
                return client.InvokeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
