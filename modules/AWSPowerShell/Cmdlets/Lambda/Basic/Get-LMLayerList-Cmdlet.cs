...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda ListLayers API operation.", Operation = new[] {"ListLayers"}, SelectReturnType = typeof(Amazon.Lambda.Model.ListLayersResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.LayersListItem or Amazon.Lambda.Model.ListLayersResponse",
        "This cmdlet returns a collection of Amazon.Lambda.Model.LayersListItem objects.",
    ...
    public partial class GetLMLayerListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A runtime identifier. For example, <code>go1.x</code>.</para><para>The following list includes deprecated runtimes. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html#runtime-support-policy">Runtime
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CompatibleRuntime' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.ListLayersResponse, GetLMLayerListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListLayersResponse, GetLMLayerListCmdlet, object> Select { get; set; } =
