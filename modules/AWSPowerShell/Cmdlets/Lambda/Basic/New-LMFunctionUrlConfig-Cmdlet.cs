...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    /// </summary>
    [Cmdlet("New", "LMFunctionUrlConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Lambda.Model.CreateFunctionUrlConfigResponse")]
    [AWSCmdlet("Calls the AWS Lambda CreateFunctionUrlConfig API operation.", Operation = new[] {"CreateFunctionUrlConfig"}, SelectReturnType = typeof(Amazon.Lambda.Model.CreateFunctionUrlConfigResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.CreateFunctionUrlConfigResponse",
        "This cmdlet returns an Amazon.Lambda.Model.CreateFunctionUrlConfigResponse object containing multiple properties."
    )]
    public partial class NewLMFunctionUrlConfigCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-LMFunctionUrlConfig (CreateFunctionUrlConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.CreateFunctionUrlConfigResponse, NewLMFunctionUrlConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.CreateFunctionUrlConfigRequest();
        ...
        private Amazon.Lambda.Model.CreateFunctionUrlConfigResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.CreateFunctionUrlConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lambda", "CreateFunctionUrlConfig");
            try
            {
                #if DESKTOP
                return client.CreateFunctionUrlConfig(request);
                #elif CORECLR
                return client.CreateFunctionUrlConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Lambda.InvokeMode InvokeMode { get; set; }
            public System.String Qualifier { get; set; }
            public System.Func<Amazon.Lambda.Model.CreateFunctionUrlConfigResponse, NewLMFunctionUrlConfigCmdlet, object> Select { get; set; } =
