...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class RemoveLMFunctionConcurrencyCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMFunctionConcurrency (DeleteFunctionConcurrency)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.DeleteFunctionConcurrencyResponse, RemoveLMFunctionConcurrencyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lambda.Model.DeleteFunctionConcurrencyRequest();
        ...
        private Amazon.Lambda.Model.DeleteFunctionConcurrencyResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.DeleteFunctionConcurrencyRequest request)
        {
            ...
            try
            {
                return client.DeleteFunctionConcurrencyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String FunctionName { get; set; }
            public System.Func<Amazon.Lambda.Model.DeleteFunctionConcurrencyResponse, RemoveLMFunctionConcurrencyCmdlet, object> Select { get; set; } =
