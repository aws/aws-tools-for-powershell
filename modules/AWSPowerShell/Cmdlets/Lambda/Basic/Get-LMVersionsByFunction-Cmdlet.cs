...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda ListVersionsByFunction API operation.", Operation = new[] {"ListVersionsByFunction"}, SelectReturnType = typeof(Amazon.Lambda.Model.ListVersionsByFunctionResponse))]
    [AWSCmdletOutput("Amazon.Lambda.Model.FunctionConfiguration or Amazon.Lambda.Model.ListVersionsByFunctionResponse",
        "This cmdlet returns a collection of Amazon.Lambda.Model.FunctionConfiguration objects.",
        "The service call response (type Amazon.Lambda.Model.ListVersionsByFunctionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMVersionsByFunctionCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of versions to return. Note that <c>ListVersionsByFunction</c>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lambda.Model.ListVersionsByFunctionResponse, GetLMVersionsByFunctionCmdlet>(Select) ??
        ...
        private Amazon.Lambda.Model.ListVersionsByFunctionResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.ListVersionsByFunctionRequest request)
        {
            ...
            try
            {
                return client.ListVersionsByFunctionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.Lambda.Model.ListVersionsByFunctionResponse, GetLMVersionsByFunctionCmdlet, object> Select { get; set; } =
