...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    public partial class RemoveSDInstanceRegistrationCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.DeregisterInstanceResponse, RemoveSDInstanceRegistrationCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Map", "DeregisterInstance");
            try
            {
                return client.DeregisterInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String ServiceId { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.DeregisterInstanceResponse, RemoveSDInstanceRegistrationCmdlet, object> Select { get; set; } =
