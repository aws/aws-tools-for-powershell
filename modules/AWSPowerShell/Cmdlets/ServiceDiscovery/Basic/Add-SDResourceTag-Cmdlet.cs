...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    /// </summary>
    [Cmdlet("Add", "SDResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddSDResourceTagCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SDResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.TagResourceResponse, AddSDResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceDiscovery.Model.TagResourceRequest();
        ...
        private Amazon.ServiceDiscovery.Model.TagResourceResponse CallAWSServiceOperation(IAmazonServiceDiscovery client, Amazon.ServiceDiscovery.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Map", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ServiceDiscovery.Model.TagResourceResponse, AddSDResourceTagCmdlet, object> Select { get; set; } =
