...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SDNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveSDNamespaceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID or Amazon Resource Name (ARN) of the namespace that you want to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SDNamespace (DeleteNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.DeleteNamespaceResponse, RemoveSDNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceDiscovery.Model.DeleteNamespaceRequest();
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.DeleteNamespaceResponse, RemoveSDNamespaceCmdlet, object> Select { get; set; } =
