...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    public partial class RemoveSDServiceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.DeleteServiceResponse, RemoveSDServiceCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Map", "DeleteService");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.DeleteServiceResponse, RemoveSDServiceCmdlet, object> Select { get; set; } =
