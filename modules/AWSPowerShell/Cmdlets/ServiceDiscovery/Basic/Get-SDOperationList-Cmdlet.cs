...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    /// </summary>
    [Cmdlet("Get", "SDOperationList")]
    [OutputType("Amazon.ServiceDiscovery.Model.OperationSummary")]
    [AWSCmdlet("Calls the AWS Cloud Map ListOperations API operation.", Operation = new[] {"ListOperations"}, SelectReturnType = typeof(Amazon.ServiceDiscovery.Model.ListOperationsResponse))]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.OperationSummary or Amazon.ServiceDiscovery.Model.ListOperationsResponse",
        "This cmdlet returns a collection of Amazon.ServiceDiscovery.Model.OperationSummary objects.",
        "The service call response (type Amazon.ServiceDiscovery.Model.ListOperationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSDOperationListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        [Alias("Filters")]
        public Amazon.ServiceDiscovery.Model.OperationFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.ListOperationsResponse, GetSDOperationListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.ServiceDiscovery.Model.OperationFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceDiscovery.Model.ListOperationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Operations?.Count ?? 0;
        ...
        {
            public List<Amazon.ServiceDiscovery.Model.OperationFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.ListOperationsResponse, GetSDOperationListCmdlet, object> Select { get; set; } =
