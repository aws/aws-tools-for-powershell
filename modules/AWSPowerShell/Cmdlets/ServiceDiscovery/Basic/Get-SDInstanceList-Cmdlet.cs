...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Map ListInstances API operation.", Operation = new[] {"ListInstances"}, SelectReturnType = typeof(Amazon.ServiceDiscovery.Model.ListInstancesResponse))]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.InstanceSummary or Amazon.ServiceDiscovery.Model.ListInstancesResponse",
        "This cmdlet returns a collection of Amazon.ServiceDiscovery.Model.InstanceSummary objects.",
        "The service call response (type Amazon.ServiceDiscovery.Model.ListInstancesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSDInstanceListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID or Amazon Resource Name (ARN) of the service that you want to list instances
        ...
        /// <summary>
        /// <para>
        /// <para>For the first <c>ListInstances</c> request, omit this value.</para><para>If more than <c>MaxResults</c> instances match the specified criteria, you can submit
        /// another <c>ListInstances</c> request to get the next group of results. Specify the
        /// value of <c>NextToken</c> from the previous response in the next request.</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.ListInstancesResponse, GetSDInstanceListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServiceId { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.ListInstancesResponse, GetSDInstanceListCmdlet, object> Select { get; set; } =
