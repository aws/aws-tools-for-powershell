...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdletOutput("System.String or Amazon.ServiceDiscovery.Model.UpdatePrivateDnsNamespaceResponse",
        ...
        "The service call response (type Amazon.ServiceDiscovery.Model.UpdatePrivateDnsNamespaceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSDPrivateDnsNamespaceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique string that identifies the request and that allows failed <code>UpdatePrivateDnsNamespace</code>
