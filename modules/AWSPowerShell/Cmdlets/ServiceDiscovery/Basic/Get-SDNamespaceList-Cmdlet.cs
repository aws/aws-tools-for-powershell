...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Map ListNamespaces API operation.", Operation = new[] {"ListNamespaces"}, SelectReturnType = typeof(Amazon.ServiceDiscovery.Model.ListNamespacesResponse))]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.NamespaceSummary or Amazon.ServiceDiscovery.Model.ListNamespacesResponse",
        "This cmdlet returns a collection of Amazon.ServiceDiscovery.Model.NamespaceSummary objects.",
        "The service call response (type Amazon.ServiceDiscovery.Model.ListNamespacesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSDNamespaceListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// by <c>ListNamespaces</c>.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceDiscovery.Model.ListNamespacesResponse, GetSDNamespaceListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.ServiceDiscovery.Model.NamespaceFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Namespaces?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Map", "ListNamespaces");
            try
            {
        ...
        {
            public List<Amazon.ServiceDiscovery.Model.NamespaceFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ServiceDiscovery.Model.ListNamespacesResponse, GetSDNamespaceListCmdlet, object> Select { get; set; } =
