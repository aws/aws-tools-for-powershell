...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    /// namespaces.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.ServiceSummary or Amazon.ServiceDiscovery.Model.ListServicesResponse",
        ...
        "The service call response (type Amazon.ServiceDiscovery.Model.ListServicesResponse) can be returned by specifying '-Select *'."
    )]
