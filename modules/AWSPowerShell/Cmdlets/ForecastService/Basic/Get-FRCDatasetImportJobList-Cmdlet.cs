...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    [AWSCmdlet("Calls the Amazon Forecast Service ListDatasetImportJobs API operation.", Operation = new[] {"ListDatasetImportJobs"}, SelectReturnType = typeof(Amazon.ForecastService.Model.ListDatasetImportJobsResponse))]
    [AWSCmdletOutput("Amazon.ForecastService.Model.DatasetImportJobSummary or Amazon.ForecastService.Model.ListDatasetImportJobsResponse",
        "This cmdlet returns a collection of Amazon.ForecastService.Model.DatasetImportJobSummary objects.",
        "The service call response (type Amazon.ForecastService.Model.ListDatasetImportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFRCDatasetImportJobListCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        /// datasets, specify <c>IS_NOT</c>.</para></li><li><para><c>Key</c> - The name of the parameter to filter on. Valid values are <c>DatasetArn</c>
        /// and <c>Status</c>.</para></li><li><para><c>Value</c> - The value to match.</para></li></ul><para>For example, to list all dataset import jobs whose status is ACTIVE, you specify the
        /// following filter:</para><para><c>"Filters": [ { "Condition": "IS", "Key": "Status", "Value": "ACTIVE" } ]</c></para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.ListDatasetImportJobsResponse, GetFRCDatasetImportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ForecastService.Model.ListDatasetImportJobsRequest();
        ...
        private Amazon.ForecastService.Model.ListDatasetImportJobsResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.ListDatasetImportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "ListDatasetImportJobs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ForecastService.Model.ListDatasetImportJobsResponse, GetFRCDatasetImportJobListCmdlet, object> Select { get; set; } =
