...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    public partial class RemoveFRCResourceTreeCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FRCResourceTree (DeleteResourceTree)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.DeleteResourceTreeResponse, RemoveFRCResourceTreeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.DeleteResourceTreeRequest();
        ...
        private Amazon.ForecastService.Model.DeleteResourceTreeResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.DeleteResourceTreeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "DeleteResourceTree");
            try
            {
                #if DESKTOP
                return client.DeleteResourceTree(request);
                #elif CORECLR
                return client.DeleteResourceTreeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.ForecastService.Model.DeleteResourceTreeResponse, RemoveFRCResourceTreeCmdlet, object> Select { get; set; } =
