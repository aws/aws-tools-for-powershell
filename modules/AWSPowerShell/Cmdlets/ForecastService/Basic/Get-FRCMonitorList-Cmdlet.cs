...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// </summary>
    [Cmdlet("Get", "FRCMonitorList")]
    [OutputType("Amazon.ForecastService.Model.MonitorSummary")]
    [AWSCmdlet("Calls the Amazon Forecast Service ListMonitors API operation.", Operation = new[] {"ListMonitors"}, SelectReturnType = typeof(Amazon.ForecastService.Model.ListMonitorsResponse))]
    [AWSCmdletOutput("Amazon.ForecastService.Model.MonitorSummary or Amazon.ForecastService.Model.ListMonitorsResponse",
        "This cmdlet returns a collection of Amazon.ForecastService.Model.MonitorSummary objects.",
        "The service call response (type Amazon.ForecastService.Model.ListMonitorsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFRCMonitorListCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.ListMonitorsResponse, GetFRCMonitorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ForecastService.Model.ListMonitorsRequest();
        ...
        private Amazon.ForecastService.Model.ListMonitorsResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.ListMonitorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "ListMonitors");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ForecastService.Model.ListMonitorsResponse, GetFRCMonitorListCmdlet, object> Select { get; set; } =
