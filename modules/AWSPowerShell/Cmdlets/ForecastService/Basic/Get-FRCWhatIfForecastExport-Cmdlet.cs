...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// </summary>
    [Cmdlet("Get", "FRCWhatIfForecastExport")]
    ...
    public partial class GetFRCWhatIfForecastExportCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^WhatIfForecastExportArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.DescribeWhatIfForecastExportResponse, GetFRCWhatIfForecastExportCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.WhatIfForecastExportArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.DescribeWhatIfForecastExportRequest();
        ...
        private Amazon.ForecastService.Model.DescribeWhatIfForecastExportResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.DescribeWhatIfForecastExportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "DescribeWhatIfForecastExport");
            try
            {
                #if DESKTOP
                return client.DescribeWhatIfForecastExport(request);
                #elif CORECLR
                return client.DescribeWhatIfForecastExportAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WhatIfForecastExportArn { get; set; }
            public System.Func<Amazon.ForecastService.Model.DescribeWhatIfForecastExportResponse, GetFRCWhatIfForecastExportCmdlet, object> Select { get; set; } =
