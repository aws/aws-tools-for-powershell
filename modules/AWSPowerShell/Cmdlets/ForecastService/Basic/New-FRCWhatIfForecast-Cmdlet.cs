...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    [AWSCmdletOutput("System.String or Amazon.ForecastService.Model.CreateWhatIfForecastResponse",
        ...
        "The service call response (type Amazon.ForecastService.Model.CreateWhatIfForecastResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewFRCWhatIfForecastCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^WhatIfForecastName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.WhatIfForecastName;
            }
        ...
        private Amazon.ForecastService.Model.CreateWhatIfForecastResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.CreateWhatIfForecastRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateWhatIfForecast(request);
                #elif CORECLR
                return client.CreateWhatIfForecastAsync(request).GetAwaiter().GetResult();
                #else
