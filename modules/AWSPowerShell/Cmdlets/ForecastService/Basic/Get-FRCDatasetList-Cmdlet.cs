...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    [AWSCmdlet("Calls the Amazon Forecast Service ListDatasets API operation.", Operation = new[] {"ListDatasets"}, SelectReturnType = typeof(Amazon.ForecastService.Model.ListDatasetsResponse))]
    [AWSCmdletOutput("Amazon.ForecastService.Model.DatasetSummary or Amazon.ForecastService.Model.ListDatasetsResponse",
        "This cmdlet returns a collection of Amazon.ForecastService.Model.DatasetSummary objects.",
        "The service call response (type Amazon.ForecastService.Model.ListDatasetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFRCDatasetListCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.ListDatasetsResponse, GetFRCDatasetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ForecastService.Model.ListDatasetsRequest();
        ...
        private Amazon.ForecastService.Model.ListDatasetsResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.ListDatasetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "ListDatasets");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ForecastService.Model.ListDatasetsResponse, GetFRCDatasetListCmdlet, object> Select { get; set; } =
