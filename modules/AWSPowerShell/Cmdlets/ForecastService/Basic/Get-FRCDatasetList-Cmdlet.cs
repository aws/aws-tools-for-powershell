...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    [AWSCmdletOutput("Amazon.ForecastService.Model.DatasetSummary or Amazon.ForecastService.Model.ListDatasetsResponse",
        ...
        "The service call response (type Amazon.ForecastService.Model.ListDatasetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
