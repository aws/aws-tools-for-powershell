...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Forecast Service DeleteForecast API operation.", Operation = new[] {"DeleteForecast"}, SelectReturnType = typeof(Amazon.ForecastService.Model.DeleteForecastResponse))]
    [AWSCmdletOutput("None or Amazon.ForecastService.Model.DeleteForecastResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ForecastService.Model.DeleteForecastResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveFRCForecastCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FRCForecast (DeleteForecast)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.DeleteForecastResponse, RemoveFRCForecastCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.DeleteForecastRequest();
        ...
        private Amazon.ForecastService.Model.DeleteForecastResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.DeleteForecastRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "DeleteForecast");
            try
            {
                #if DESKTOP
                return client.DeleteForecast(request);
                #elif CORECLR
                return client.DeleteForecastAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ForecastArn { get; set; }
            public System.Func<Amazon.ForecastService.Model.DeleteForecastResponse, RemoveFRCForecastCmdlet, object> Select { get; set; } =
