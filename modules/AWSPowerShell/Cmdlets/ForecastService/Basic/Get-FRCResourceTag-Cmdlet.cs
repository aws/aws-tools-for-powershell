...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// </summary>
    [Cmdlet("Get", "FRCResourceTag")]
    [OutputType("Amazon.ForecastService.Model.Tag")]
    ...
    public partial class GetFRCResourceTagCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.ListTagsForResourceResponse, GetFRCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.ListTagsForResourceRequest();
        ...
        private Amazon.ForecastService.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.ForecastService.Model.ListTagsForResourceResponse, GetFRCResourceTagCmdlet, object> Select { get; set; } =
