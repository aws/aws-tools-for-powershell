...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// also deleted.
    /// </summary>
    [Cmdlet("Add", "FRCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Forecast Service TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.ForecastService.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.ForecastService.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ForecastService.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddFRCResourceTagCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-FRCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.TagResourceResponse, AddFRCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.TagResourceRequest();
        ...
        private Amazon.ForecastService.Model.TagResourceResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ForecastService.Model.TagResourceResponse, AddFRCResourceTagCmdlet, object> Select { get; set; } =
