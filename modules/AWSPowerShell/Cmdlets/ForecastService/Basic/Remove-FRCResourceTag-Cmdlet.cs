...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "FRCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveFRCResourceTagCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FRCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.UntagResourceResponse, RemoveFRCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.UntagResourceRequest();
        ...
        private Amazon.ForecastService.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ForecastService.Model.UntagResourceResponse, RemoveFRCResourceTagCmdlet, object> Select { get; set; } =
