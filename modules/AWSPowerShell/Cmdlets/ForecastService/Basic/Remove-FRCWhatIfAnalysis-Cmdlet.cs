...
namespace Amazon.PowerShell.Cmdlets.FRC
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "FRCWhatIfAnalysis", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Forecast Service DeleteWhatIfAnalysis API operation.", Operation = new[] {"DeleteWhatIfAnalysis"}, SelectReturnType = typeof(Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse))]
    [AWSCmdletOutput("None or Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveFRCWhatIfAnalysisCmdlet : AmazonForecastServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.WhatIfAnalysisArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FRCWhatIfAnalysis (DeleteWhatIfAnalysis)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse, RemoveFRCWhatIfAnalysisCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ForecastService.Model.DeleteWhatIfAnalysisRequest();
        ...
        private Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse CallAWSServiceOperation(IAmazonForecastService client, Amazon.ForecastService.Model.DeleteWhatIfAnalysisRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Forecast Service", "DeleteWhatIfAnalysis");
            try
            {
                #if DESKTOP
                return client.DeleteWhatIfAnalysis(request);
                #elif CORECLR
                return client.DeleteWhatIfAnalysisAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WhatIfAnalysisArn { get; set; }
            public System.Func<Amazon.ForecastService.Model.DeleteWhatIfAnalysisResponse, RemoveFRCWhatIfAnalysisCmdlet, object> Select { get; set; } =
