...
{
    /// <summary>
    /// Lists all the VPCs that the specified Route 53 Profile is associated with.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetR53PProfileAssociationListCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        private Amazon.Route53Profiles.Model.ListProfileAssociationsResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.ListProfileAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListProfileAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
