...
namespace Amazon.PowerShell.Cmdlets.R53P
{
    ...
    /// </summary>
    [Cmdlet("Remove", "R53PProfileResourceAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Route53Profiles.Model.ProfileResourceAssociation")]
    [AWSCmdlet("Calls the Amazon Route 53 Profiles DisassociateResourceFromProfile API operation.", Operation = new[] {"DisassociateResourceFromProfile"}, SelectReturnType = typeof(Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse))]
    [AWSCmdletOutput("Amazon.Route53Profiles.Model.ProfileResourceAssociation or Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse",
        "This cmdlet returns an Amazon.Route53Profiles.Model.ProfileResourceAssociation object.",
        "The service call response (type Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveR53PProfileResourceAssociationCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-R53PProfileResourceAssociation (DisassociateResourceFromProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse, RemoveR53PProfileResourceAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Profiles.Model.DisassociateResourceFromProfileRequest();
        ...
        private Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.DisassociateResourceFromProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Profiles", "DisassociateResourceFromProfile");
            try
            {
                #if DESKTOP
                return client.DisassociateResourceFromProfile(request);
                #elif CORECLR
                return client.DisassociateResourceFromProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ProfileId { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Route53Profiles.Model.DisassociateResourceFromProfileResponse, RemoveR53PProfileResourceAssociationCmdlet, object> Select { get; set; } =
