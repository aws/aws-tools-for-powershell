...
namespace Amazon.PowerShell.Cmdlets.R53P
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53PProfileResourceAssociation")]
    [OutputType("Amazon.Route53Profiles.Model.ProfileResourceAssociation")]
    [AWSCmdlet("Calls the Amazon Route 53 Profiles GetProfileResourceAssociation API operation.", Operation = new[] {"GetProfileResourceAssociation"}, SelectReturnType = typeof(Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse))]
    [AWSCmdletOutput("Amazon.Route53Profiles.Model.ProfileResourceAssociation or Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse",
        "This cmdlet returns an Amazon.Route53Profiles.Model.ProfileResourceAssociation object.",
        "The service call response (type Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53PProfileResourceAssociationCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse, GetR53PProfileResourceAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Profiles.Model.GetProfileResourceAssociationRequest();
        ...
        private Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.GetProfileResourceAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Profiles", "GetProfileResourceAssociation");
            try
            {
                #if DESKTOP
                return client.GetProfileResourceAssociation(request);
                #elif CORECLR
                return client.GetProfileResourceAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ProfileResourceAssociationId { get; set; }
            public System.Func<Amazon.Route53Profiles.Model.GetProfileResourceAssociationResponse, GetR53PProfileResourceAssociationCmdlet, object> Select { get; set; } =
