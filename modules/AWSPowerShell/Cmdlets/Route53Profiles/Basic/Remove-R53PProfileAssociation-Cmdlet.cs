...
namespace Amazon.PowerShell.Cmdlets.R53P
{
    ...
    /// </summary>
    [Cmdlet("Remove", "R53PProfileAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveR53PProfileAssociationCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-R53PProfileAssociation (DisassociateProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Profiles.Model.DisassociateProfileResponse, RemoveR53PProfileAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Profiles.Model.DisassociateProfileRequest();
        ...
        private Amazon.Route53Profiles.Model.DisassociateProfileResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.DisassociateProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Profiles", "DisassociateProfile");
            try
            {
                #if DESKTOP
                return client.DisassociateProfile(request);
                #elif CORECLR
                return client.DisassociateProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ProfileId { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.Route53Profiles.Model.DisassociateProfileResponse, RemoveR53PProfileAssociationCmdlet, object> Select { get; set; } =
