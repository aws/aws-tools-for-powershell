...
{
    /// <summary>
    /// Lists all the resource associations for the specified Route 53 Profile.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetR53PProfileResourceAssociationListCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        private Amazon.Route53Profiles.Model.ListProfileResourceAssociationsResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.ListProfileResourceAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListProfileResourceAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
