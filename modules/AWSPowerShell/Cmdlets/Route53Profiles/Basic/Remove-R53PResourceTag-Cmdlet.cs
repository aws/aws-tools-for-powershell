...
namespace Amazon.PowerShell.Cmdlets.R53P
{
    ...
    /// </summary>
    [Cmdlet("Remove", "R53PResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveR53PResourceTagCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-R53PResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Profiles.Model.UntagResourceResponse, RemoveR53PResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Profiles.Model.UntagResourceRequest();
        ...
        private Amazon.Route53Profiles.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Profiles", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Route53Profiles.Model.UntagResourceResponse, RemoveR53PResourceTagCmdlet, object> Select { get; set; } =
