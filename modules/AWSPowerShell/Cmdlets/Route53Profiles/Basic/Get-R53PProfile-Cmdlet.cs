...
namespace Amazon.PowerShell.Cmdlets.R53P
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53PProfile")]
    [OutputType("Amazon.Route53Profiles.Model.Profile")]
    [AWSCmdlet("Calls the Amazon Route 53 Profiles GetProfile API operation.", Operation = new[] {"GetProfile"}, SelectReturnType = typeof(Amazon.Route53Profiles.Model.GetProfileResponse))]
    [AWSCmdletOutput("Amazon.Route53Profiles.Model.Profile or Amazon.Route53Profiles.Model.GetProfileResponse",
        "This cmdlet returns an Amazon.Route53Profiles.Model.Profile object.",
        "The service call response (type Amazon.Route53Profiles.Model.GetProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53PProfileCmdlet : AmazonRoute53ProfilesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Profiles.Model.GetProfileResponse, GetR53PProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Profiles.Model.GetProfileRequest();
        ...
        private Amazon.Route53Profiles.Model.GetProfileResponse CallAWSServiceOperation(IAmazonRoute53Profiles client, Amazon.Route53Profiles.Model.GetProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Profiles", "GetProfile");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.Route53Profiles.Model.GetProfileResponse, GetR53PProfileCmdlet, object> Select { get; set; } =
