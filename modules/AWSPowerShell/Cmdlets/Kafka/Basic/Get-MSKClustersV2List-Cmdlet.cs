...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    [AWSCmdletOutput("Amazon.Kafka.Model.Cluster or Amazon.Kafka.Model.ListClustersV2Response",
        ...
        "The service call response (type Amazon.Kafka.Model.ListClustersV2Response) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
