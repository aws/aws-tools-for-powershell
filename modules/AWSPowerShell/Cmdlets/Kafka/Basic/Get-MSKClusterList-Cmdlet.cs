...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKClusterList")]
    [OutputType("Amazon.Kafka.Model.ClusterInfo")]
    [AWSCmdlet("Calls the Amazon Managed Streaming for Apache Kafka (MSK) ListClusters API operation.", Operation = new[] {"ListClusters"}, SelectReturnType = typeof(Amazon.Kafka.Model.ListClustersResponse))]
    [AWSCmdletOutput("Amazon.Kafka.Model.ClusterInfo or Amazon.Kafka.Model.ListClustersResponse",
        "This cmdlet returns a collection of Amazon.Kafka.Model.ClusterInfo objects.",
        "The service call response (type Amazon.Kafka.Model.ListClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKClusterListCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kafka.Model.ListClustersResponse, GetMSKClusterListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kafka.Model.ListClustersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ClusterInfoList?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Kafka.Model.ListClustersResponse, GetMSKClusterListCmdlet, object> Select { get; set; } =
