...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    [AWSCmdletOutput("None or Amazon.Kafka.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.Kafka.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
