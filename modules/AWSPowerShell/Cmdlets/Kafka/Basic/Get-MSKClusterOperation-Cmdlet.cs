...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKClusterOperation")]
    [OutputType("Amazon.Kafka.Model.ClusterOperationInfo")]
    [AWSCmdlet("Calls the Amazon Managed Streaming for Apache Kafka (MSK) DescribeClusterOperation API operation.", Operation = new[] {"DescribeClusterOperation"}, SelectReturnType = typeof(Amazon.Kafka.Model.DescribeClusterOperationResponse))]
    [AWSCmdletOutput("Amazon.Kafka.Model.ClusterOperationInfo or Amazon.Kafka.Model.DescribeClusterOperationResponse",
        "This cmdlet returns an Amazon.Kafka.Model.ClusterOperationInfo object.",
        "The service call response (type Amazon.Kafka.Model.DescribeClusterOperationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKClusterOperationCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kafka.Model.DescribeClusterOperationResponse, GetMSKClusterOperationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kafka.Model.DescribeClusterOperationRequest();
        ...
        private Amazon.Kafka.Model.DescribeClusterOperationResponse CallAWSServiceOperation(IAmazonKafka client, Amazon.Kafka.Model.DescribeClusterOperationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Streaming for Apache Kafka (MSK)", "DescribeClusterOperation");
            try
            {
                #if DESKTOP
                return client.DescribeClusterOperation(request);
                #elif CORECLR
                return client.DescribeClusterOperationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClusterOperationArn { get; set; }
            public System.Func<Amazon.Kafka.Model.DescribeClusterOperationResponse, GetMSKClusterOperationCmdlet, object> Select { get; set; } =
