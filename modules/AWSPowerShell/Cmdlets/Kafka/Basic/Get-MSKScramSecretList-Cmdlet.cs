...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKScramSecretList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Managed Streaming for Apache Kafka (MSK) ListScramSecrets API operation.", Operation = new[] {"ListScramSecrets"}, SelectReturnType = typeof(Amazon.Kafka.Model.ListScramSecretsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Kafka.Model.ListScramSecretsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Kafka.Model.ListScramSecretsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKScramSecretListCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SecretArnList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kafka.Model.ListScramSecretsResponse, GetMSKScramSecretListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kafka.Model.ListScramSecretsRequest();
        ...
        private Amazon.Kafka.Model.ListScramSecretsResponse CallAWSServiceOperation(IAmazonKafka client, Amazon.Kafka.Model.ListScramSecretsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Streaming for Apache Kafka (MSK)", "ListScramSecrets");
            try
            {
                #if DESKTOP
                return client.ListScramSecrets(request);
                #elif CORECLR
                return client.ListScramSecretsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Kafka.Model.ListScramSecretsResponse, GetMSKScramSecretListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SecretArnList;
        }
