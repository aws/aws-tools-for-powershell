...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// request.
    /// </summary>
    [Cmdlet("Remove", "MSKClusterPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMSKClusterPolicyCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MSKClusterPolicy (DeleteClusterPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kafka.Model.DeleteClusterPolicyResponse, RemoveMSKClusterPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kafka.Model.DeleteClusterPolicyRequest();
        ...
        private Amazon.Kafka.Model.DeleteClusterPolicyResponse CallAWSServiceOperation(IAmazonKafka client, Amazon.Kafka.Model.DeleteClusterPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Streaming for Apache Kafka (MSK)", "DeleteClusterPolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ClusterArn { get; set; }
            public System.Func<Amazon.Kafka.Model.DeleteClusterPolicyResponse, RemoveMSKClusterPolicyCmdlet, object> Select { get; set; } =
