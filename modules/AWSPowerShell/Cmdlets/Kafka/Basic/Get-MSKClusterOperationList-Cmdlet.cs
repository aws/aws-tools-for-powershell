...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKClusterOperationList")]
    [OutputType("Amazon.Kafka.Model.ClusterOperationInfo")]
    [AWSCmdlet("Calls the Amazon Managed Streaming for Apache Kafka (MSK) ListClusterOperations API operation.", Operation = new[] {"ListClusterOperations"}, SelectReturnType = typeof(Amazon.Kafka.Model.ListClusterOperationsResponse))]
    [AWSCmdletOutput("Amazon.Kafka.Model.ClusterOperationInfo or Amazon.Kafka.Model.ListClusterOperationsResponse",
        "This cmdlet returns a collection of Amazon.Kafka.Model.ClusterOperationInfo objects.",
        "The service call response (type Amazon.Kafka.Model.ListClusterOperationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKClusterOperationListCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kafka.Model.ListClusterOperationsResponse, GetMSKClusterOperationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kafka.Model.ListClusterOperationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ClusterOperationInfoList?.Count ?? 0;
        ...
        private Amazon.Kafka.Model.ListClusterOperationsResponse CallAWSServiceOperation(IAmazonKafka client, Amazon.Kafka.Model.ListClusterOperationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Streaming for Apache Kafka (MSK)", "ListClusterOperations");
            try
            {
                #if DESKTOP
                return client.ListClusterOperations(request);
                #elif CORECLR
                return client.ListClusterOperationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Kafka.Model.ListClusterOperationsResponse, GetMSKClusterOperationListCmdlet, object> Select { get; set; } =
