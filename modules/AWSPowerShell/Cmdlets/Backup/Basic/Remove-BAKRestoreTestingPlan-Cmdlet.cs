...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "BAKRestoreTestingPlan", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Backup DeleteRestoreTestingPlan API operation.", Operation = new[] {"DeleteRestoreTestingPlan"}, SelectReturnType = typeof(Amazon.Backup.Model.DeleteRestoreTestingPlanResponse))]
    [AWSCmdletOutput("None or Amazon.Backup.Model.DeleteRestoreTestingPlanResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Backup.Model.DeleteRestoreTestingPlanResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBAKRestoreTestingPlanCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BAKRestoreTestingPlan (DeleteRestoreTestingPlan)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.DeleteRestoreTestingPlanResponse, RemoveBAKRestoreTestingPlanCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.DeleteRestoreTestingPlanRequest();
        ...
        private Amazon.Backup.Model.DeleteRestoreTestingPlanResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.DeleteRestoreTestingPlanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "DeleteRestoreTestingPlan");
            try
            {
                #if DESKTOP
                return client.DeleteRestoreTestingPlan(request);
                #elif CORECLR
                return client.DeleteRestoreTestingPlanAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RestoreTestingPlanName { get; set; }
            public System.Func<Amazon.Backup.Model.DeleteRestoreTestingPlanResponse, RemoveBAKRestoreTestingPlanCmdlet, object> Select { get; set; } =
