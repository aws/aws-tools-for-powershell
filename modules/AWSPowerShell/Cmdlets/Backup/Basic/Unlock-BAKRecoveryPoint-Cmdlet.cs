...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Unlock", "BAKRecoveryPoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Backup DisassociateRecoveryPoint API operation.", Operation = new[] {"DisassociateRecoveryPoint"}, SelectReturnType = typeof(Amazon.Backup.Model.DisassociateRecoveryPointResponse))]
    [AWSCmdletOutput("None or Amazon.Backup.Model.DisassociateRecoveryPointResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Backup.Model.DisassociateRecoveryPointResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnlockBAKRecoveryPointCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unlock-BAKRecoveryPoint (DisassociateRecoveryPoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.DisassociateRecoveryPointResponse, UnlockBAKRecoveryPointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.DisassociateRecoveryPointRequest();
        ...
        private Amazon.Backup.Model.DisassociateRecoveryPointResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.DisassociateRecoveryPointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "DisassociateRecoveryPoint");
            try
            {
                #if DESKTOP
                return client.DisassociateRecoveryPoint(request);
                #elif CORECLR
                return client.DisassociateRecoveryPointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BackupVaultName { get; set; }
            public System.String RecoveryPointArn { get; set; }
            public System.Func<Amazon.Backup.Model.DisassociateRecoveryPointResponse, UnlockBAKRecoveryPointCmdlet, object> Select { get; set; } =
