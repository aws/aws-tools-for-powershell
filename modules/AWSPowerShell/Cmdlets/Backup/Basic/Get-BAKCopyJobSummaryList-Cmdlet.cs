...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKCopyJobSummaryList")]
    [OutputType("Amazon.Backup.Model.ListCopyJobSummariesResponse")]
    [AWSCmdlet("Calls the AWS Backup ListCopyJobSummaries API operation.", Operation = new[] {"ListCopyJobSummaries"}, SelectReturnType = typeof(Amazon.Backup.Model.ListCopyJobSummariesResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.ListCopyJobSummariesResponse",
        "This cmdlet returns an Amazon.Backup.Model.ListCopyJobSummariesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKCopyJobSummaryListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String MessageCategory { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Backup.CopyJobStatus")]
        public Amazon.Backup.CopyJobStatus State { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.ListCopyJobSummariesResponse, GetBAKCopyJobSummaryListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.AccountId = this.AccountId;
            context.AggregationPeriod = this.AggregationPeriod;
            context.MaxResult = this.MaxResult;
            context.MessageCategory = this.MessageCategory;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Backup.Model.ListCopyJobSummariesRequest();
            ...
            if (cmdletContext.MessageCategory != null)
            {
                request.MessageCategory = cmdletContext.MessageCategory;
            }
        ...
        private Amazon.Backup.Model.ListCopyJobSummariesResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListCopyJobSummariesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "ListCopyJobSummaries");
            try
            {
                #if DESKTOP
                return client.ListCopyJobSummaries(request);
                #elif CORECLR
                return client.ListCopyJobSummariesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceType { get; set; }
            public Amazon.Backup.CopyJobStatus State { get; set; }
            public System.Func<Amazon.Backup.Model.ListCopyJobSummariesResponse, GetBAKCopyJobSummaryListCmdlet, object> Select { get; set; } =
