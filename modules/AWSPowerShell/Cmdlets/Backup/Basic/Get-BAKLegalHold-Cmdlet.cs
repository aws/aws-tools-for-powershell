...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class GetBAKLegalHoldCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetLegalHoldResponse, GetBAKLegalHoldCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetLegalHoldRequest();
        ...
        private Amazon.Backup.Model.GetLegalHoldResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetLegalHoldRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetLegalHold");
            try
            {
                #if DESKTOP
                return client.GetLegalHold(request);
                #elif CORECLR
                return client.GetLegalHoldAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String LegalHoldId { get; set; }
            public System.Func<Amazon.Backup.Model.GetLegalHoldResponse, GetBAKLegalHoldCmdlet, object> Select { get; set; } =
