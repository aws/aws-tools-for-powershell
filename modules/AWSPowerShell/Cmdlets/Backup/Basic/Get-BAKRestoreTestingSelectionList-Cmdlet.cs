...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the AWS Backup ListRestoreTestingSelections API operation.", Operation = new[] {"ListRestoreTestingSelections"}, SelectReturnType = typeof(Amazon.Backup.Model.ListRestoreTestingSelectionsResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.RestoreTestingSelectionForList or Amazon.Backup.Model.ListRestoreTestingSelectionsResponse",
        "This cmdlet returns a collection of Amazon.Backup.Model.RestoreTestingSelectionForList objects.",
        "The service call response (type Amazon.Backup.Model.ListRestoreTestingSelectionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKRestoreTestingSelectionListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RestoreTestingSelections";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.ListRestoreTestingSelectionsResponse, GetBAKRestoreTestingSelectionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Backup.Model.ListRestoreTestingSelectionsRequest();
        ...
        private Amazon.Backup.Model.ListRestoreTestingSelectionsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListRestoreTestingSelectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "ListRestoreTestingSelections");
            try
            {
                #if DESKTOP
                return client.ListRestoreTestingSelections(request);
                #elif CORECLR
                return client.ListRestoreTestingSelectionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RestoreTestingPlanName { get; set; }
            public System.Func<Amazon.Backup.Model.ListRestoreTestingSelectionsResponse, GetBAKRestoreTestingSelectionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RestoreTestingSelections;
        }
