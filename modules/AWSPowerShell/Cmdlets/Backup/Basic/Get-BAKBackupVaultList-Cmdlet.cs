...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKBackupVaultList")]
    [OutputType("Amazon.Backup.Model.BackupVaultListMember")]
    [AWSCmdlet("Calls the AWS Backup ListBackupVaults API operation.", Operation = new[] {"ListBackupVaults"}, SelectReturnType = typeof(Amazon.Backup.Model.ListBackupVaultsResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.BackupVaultListMember or Amazon.Backup.Model.ListBackupVaultsResponse",
        "This cmdlet returns a collection of Amazon.Backup.Model.BackupVaultListMember objects.",
        "The service call response (type Amazon.Backup.Model.ListBackupVaultsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupVaultListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BackupVaultList";
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BackupVaultList?.Count ?? 0;
        ...
        private Amazon.Backup.Model.ListBackupVaultsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListBackupVaultsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "ListBackupVaults");
            try
            {
                #if DESKTOP
                return client.ListBackupVaults(request);
                #elif CORECLR
                return client.ListBackupVaultsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Backup.Model.ListBackupVaultsResponse, GetBAKBackupVaultListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BackupVaultList;
        }
