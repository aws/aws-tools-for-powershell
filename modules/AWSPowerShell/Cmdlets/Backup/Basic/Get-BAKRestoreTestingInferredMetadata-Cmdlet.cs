...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class GetBAKRestoreTestingInferredMetadataCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InferredMetadata";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetRestoreTestingInferredMetadataResponse, GetBAKRestoreTestingInferredMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetRestoreTestingInferredMetadataRequest();
        ...
        private Amazon.Backup.Model.GetRestoreTestingInferredMetadataResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetRestoreTestingInferredMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetRestoreTestingInferredMetadata");
            try
            {
                #if DESKTOP
                return client.GetRestoreTestingInferredMetadata(request);
                #elif CORECLR
                return client.GetRestoreTestingInferredMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BackupVaultName { get; set; }
            public System.String RecoveryPointArn { get; set; }
            public System.Func<Amazon.Backup.Model.GetRestoreTestingInferredMetadataResponse, GetBAKRestoreTestingInferredMetadataCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InferredMetadata;
        }
