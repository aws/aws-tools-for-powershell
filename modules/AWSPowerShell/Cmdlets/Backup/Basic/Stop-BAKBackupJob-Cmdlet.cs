...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class StopBAKBackupJobCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BackupJobId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.BackupJobId;
            }
        ...
        private Amazon.Backup.Model.StopBackupJobResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.StopBackupJobRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.StopBackupJobAsync(request).GetAwaiter().GetResult();
                #else
