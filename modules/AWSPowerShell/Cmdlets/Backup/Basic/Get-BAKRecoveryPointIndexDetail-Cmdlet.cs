...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKRecoveryPointIndexDetail")]
    [OutputType("Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse")]
    [AWSCmdlet("Calls the AWS Backup GetRecoveryPointIndexDetails API operation.", Operation = new[] {"GetRecoveryPointIndexDetails"}, SelectReturnType = typeof(Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse",
        "This cmdlet returns an Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse object containing multiple properties."
    )]
    public partial class GetBAKRecoveryPointIndexDetailCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse).
        /// Specifying the name of a property of type Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse, GetBAKRecoveryPointIndexDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetRecoveryPointIndexDetailsRequest();
        ...
        private Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetRecoveryPointIndexDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetRecoveryPointIndexDetails");
            try
            {
                #if DESKTOP
                return client.GetRecoveryPointIndexDetails(request);
                #elif CORECLR
                return client.GetRecoveryPointIndexDetailsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BackupVaultName { get; set; }
            public System.String RecoveryPointArn { get; set; }
            public System.Func<Amazon.Backup.Model.GetRecoveryPointIndexDetailsResponse, GetBAKRecoveryPointIndexDetailCmdlet, object> Select { get; set; } =
