...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class GetBAKFrameworkCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.DescribeFrameworkResponse, GetBAKFrameworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.DescribeFrameworkRequest();
        ...
        private Amazon.Backup.Model.DescribeFrameworkResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.DescribeFrameworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "DescribeFramework");
            try
            {
                #if DESKTOP
                return client.DescribeFramework(request);
                #elif CORECLR
                return client.DescribeFrameworkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FrameworkName { get; set; }
            public System.Func<Amazon.Backup.Model.DescribeFrameworkResponse, GetBAKFrameworkCmdlet, object> Select { get; set; } =
