...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("Amazon.Backup.Model.ReportJob or Amazon.Backup.Model.ListReportJobsResponse",
        ...
        "The service call response (type Amazon.Backup.Model.ListReportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKReportJobListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ByReportPlanName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ByReportPlanName;
            }
        ...
        private Amazon.Backup.Model.ListReportJobsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListReportJobsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListReportJobs(request);
                #elif CORECLR
                return client.ListReportJobsAsync(request).GetAwaiter().GetResult();
                #else
