...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("Amazon.Backup.Model.BackupPlan or Amazon.Backup.Model.GetBackupPlanFromTemplateResponse",
        ...
        "The service call response (type Amazon.Backup.Model.GetBackupPlanFromTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupPlanFromTemplateCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BackupPlanTemplateId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.BackupPlanTemplateId;
            }
        ...
        private Amazon.Backup.Model.GetBackupPlanFromTemplateResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetBackupPlanFromTemplateRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetBackupPlanFromTemplate(request);
                #elif CORECLR
                return client.GetBackupPlanFromTemplateAsync(request).GetAwaiter().GetResult();
                #else
