...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class StopBAKLegalHoldCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        public System.String CancelDescription { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("RetainRecordInDays")]
        public System.Int64? RetainRecordInDay { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.LegalHoldId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-BAKLegalHold (CancelLegalHold)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.CancelLegalHoldResponse, StopBAKLegalHoldCmdlet>(Select) ??
            ...
            context.CancelDescription = this.CancelDescription;
            #if MODULAR
            if (this.CancelDescription == null && ParameterWasBound(nameof(this.CancelDescription)))
            {
                WriteWarning("You are passing $null as a value for parameter CancelDescription which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            ...
            #endif
            context.RetainRecordInDay = this.RetainRecordInDay;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.CancelLegalHoldRequest();
            
            if (cmdletContext.CancelDescription != null)
            {
                request.CancelDescription = cmdletContext.CancelDescription;
            }
            if (cmdletContext.LegalHoldId != null)
            {
                request.LegalHoldId = cmdletContext.LegalHoldId;
            }
            if (cmdletContext.RetainRecordInDay != null)
            {
                request.RetainRecordInDays = cmdletContext.RetainRecordInDay.Value;
            }
        ...
        private Amazon.Backup.Model.CancelLegalHoldResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.CancelLegalHoldRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LegalHoldId { get; set; }
            public System.Int64? RetainRecordInDay { get; set; }
            public System.Func<Amazon.Backup.Model.CancelLegalHoldResponse, StopBAKLegalHoldCmdlet, object> Select { get; set; } =
