...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    public partial class GetBAKSupportedResourceTypeCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetSupportedResourceTypesResponse, GetBAKSupportedResourceTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetSupportedResourceTypesRequest();
        ...
        private Amazon.Backup.Model.GetSupportedResourceTypesResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetSupportedResourceTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetSupportedResourceTypes");
            try
            {
                #if DESKTOP
                return client.GetSupportedResourceTypes(request);
                #elif CORECLR
                return client.GetSupportedResourceTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.Backup.Model.GetSupportedResourceTypesResponse, GetBAKSupportedResourceTypeCmdlet, object> Select { get; set; } =
