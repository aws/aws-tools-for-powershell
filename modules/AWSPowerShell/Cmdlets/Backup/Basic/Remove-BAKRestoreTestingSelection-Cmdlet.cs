...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("None or Amazon.Backup.Model.DeleteRestoreTestingSelectionResponse",
        ...
        "The service response (type Amazon.Backup.Model.DeleteRestoreTestingSelectionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBAKRestoreTestingSelectionCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RestoreTestingSelectionName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RestoreTestingSelectionName;
            }
