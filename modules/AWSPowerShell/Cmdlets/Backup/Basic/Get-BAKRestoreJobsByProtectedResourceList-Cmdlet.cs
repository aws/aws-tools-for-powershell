...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("Amazon.Backup.Model.RestoreJobsListMember or Amazon.Backup.Model.ListRestoreJobsByProtectedResourceResponse",
        ...
        "The service call response (type Amazon.Backup.Model.ListRestoreJobsByProtectedResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
