...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKRecoveryPointRestoreMetadata")]
    [OutputType("Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse")]
    [AWSCmdlet("Calls the AWS Backup GetRecoveryPointRestoreMetadata API operation.", Operation = new[] {"GetRecoveryPointRestoreMetadata"}, SelectReturnType = typeof(Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse",
        "This cmdlet returns an Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse object containing multiple properties."
    )]
    public partial class GetBAKRecoveryPointRestoreMetadataCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse, GetBAKRecoveryPointRestoreMetadataCmdlet>(Select) ??
        ...
        private Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetRecoveryPointRestoreMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetRecoveryPointRestoreMetadata");
            try
            {
                return client.GetRecoveryPointRestoreMetadataAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
