...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKBackupPlanVersionList")]
    [OutputType("Amazon.Backup.Model.BackupPlansListMember")]
    [AWSCmdlet("Calls the AWS Backup ListBackupPlanVersions API operation.", Operation = new[] {"ListBackupPlanVersions"}, SelectReturnType = typeof(Amazon.Backup.Model.ListBackupPlanVersionsResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.BackupPlansListMember or Amazon.Backup.Model.ListBackupPlanVersionsResponse",
        "This cmdlet returns a collection of Amazon.Backup.Model.BackupPlansListMember objects.",
        "The service call response (type Amazon.Backup.Model.ListBackupPlanVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupPlanVersionListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BackupPlanVersionsList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.ListBackupPlanVersionsResponse, GetBAKBackupPlanVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Backup.Model.ListBackupPlanVersionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BackupPlanVersionsList?.Count ?? 0;
        ...
        private Amazon.Backup.Model.ListBackupPlanVersionsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListBackupPlanVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "ListBackupPlanVersions");
            try
            {
                #if DESKTOP
                return client.ListBackupPlanVersions(request);
                #elif CORECLR
                return client.ListBackupPlanVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Backup.Model.ListBackupPlanVersionsResponse, GetBAKBackupPlanVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BackupPlanVersionsList;
        }
