...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// testing plan.
    /// </summary>
    [Cmdlet("Get", "BAKRestoreTestingSelection")]
    [OutputType("Amazon.Backup.Model.RestoreTestingSelectionForGet")]
    [AWSCmdlet("Calls the AWS Backup GetRestoreTestingSelection API operation.", Operation = new[] {"GetRestoreTestingSelection"}, SelectReturnType = typeof(Amazon.Backup.Model.GetRestoreTestingSelectionResponse))]
    [AWSCmdletOutput("Amazon.Backup.Model.RestoreTestingSelectionForGet or Amazon.Backup.Model.GetRestoreTestingSelectionResponse",
        "This cmdlet returns an Amazon.Backup.Model.RestoreTestingSelectionForGet object.",
        "The service call response (type Amazon.Backup.Model.GetRestoreTestingSelectionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKRestoreTestingSelectionCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RestoreTestingSelection";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetRestoreTestingSelectionResponse, GetBAKRestoreTestingSelectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetRestoreTestingSelectionRequest();
        ...
        private Amazon.Backup.Model.GetRestoreTestingSelectionResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetRestoreTestingSelectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetRestoreTestingSelection");
            try
            {
                #if DESKTOP
                return client.GetRestoreTestingSelection(request);
                #elif CORECLR
                return client.GetRestoreTestingSelectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RestoreTestingPlanName { get; set; }
            public System.String RestoreTestingSelectionName { get; set; }
            public System.Func<Amazon.Backup.Model.GetRestoreTestingSelectionResponse, GetBAKRestoreTestingSelectionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RestoreTestingSelection;
        }
