...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKBackupVaultNotification")]
    ...
    public partial class GetBAKBackupVaultNotificationCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.GetBackupVaultNotificationsResponse, GetBAKBackupVaultNotificationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.GetBackupVaultNotificationsRequest();
        ...
        private Amazon.Backup.Model.GetBackupVaultNotificationsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.GetBackupVaultNotificationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "GetBackupVaultNotifications");
            try
            {
                return client.GetBackupVaultNotificationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String BackupVaultName { get; set; }
            public System.Func<Amazon.Backup.Model.GetBackupVaultNotificationsResponse, GetBAKBackupVaultNotificationCmdlet, object> Select { get; set; } =
