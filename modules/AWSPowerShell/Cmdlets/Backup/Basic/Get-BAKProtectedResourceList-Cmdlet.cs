...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("Amazon.Backup.Model.ProtectedResource or Amazon.Backup.Model.ListProtectedResourcesResponse",
        ...
        "The service call response (type Amazon.Backup.Model.ListProtectedResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKProtectedResourceListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        private Amazon.Backup.Model.ListProtectedResourcesResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListProtectedResourcesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListProtectedResources(request);
                #elif CORECLR
                return client.ListProtectedResourcesAsync(request).GetAwaiter().GetResult();
                #else
