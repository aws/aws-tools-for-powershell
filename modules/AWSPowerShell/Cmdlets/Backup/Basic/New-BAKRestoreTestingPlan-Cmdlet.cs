...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdletOutput("Amazon.Backup.Model.CreateRestoreTestingPlanResponse",
        "This cmdlet returns an Amazon.Backup.Model.CreateRestoreTestingPlanResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewBAKRestoreTestingPlanCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RestoreTestingPlan_RestoreTestingPlanName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RestoreTestingPlan_RestoreTestingPlanName;
            }
        ...
        private Amazon.Backup.Model.CreateRestoreTestingPlanResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.CreateRestoreTestingPlanRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateRestoreTestingPlan(request);
                #elif CORECLR
                return client.CreateRestoreTestingPlanAsync(request).GetAwaiter().GetResult();
                #else
