...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Backup UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.Backup.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Backup.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Backup.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBAKResourceTagCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The keys to identify which key-value tags to remove from a resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BAKResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Backup.Model.UntagResourceResponse, RemoveBAKResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Backup.Model.UntagResourceRequest();
        ...
        private Amazon.Backup.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Backup.Model.UntagResourceResponse, RemoveBAKResourceTagCmdlet, object> Select { get; set; } =
