...
$BAK_SelectMap = @{
    "Select"=@("Add-BAKBackupVaultMpaApprovalTeam",
               ...
               "Get-BAKBackupAccessPointDetail",
               "Get-BAKBackupJob",
               "Get-BAKBackupVault",
               "Get-BAKCopyJob",
               "Get-BAKFramework",
               ...
               "Get-BAKBackupAccessPointList",
               "Get-BAKBackupAccessPointsByRecoveryPointList",
               "Get-BAKBackupAccessPointsByResourceList",
