...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    public partial class RemoveHSM2ClusterCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSMV2.Model.DeleteClusterResponse, RemoveHSM2ClusterCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM V2", "DeleteCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ClusterId { get; set; }
            public System.Func<Amazon.CloudHSMV2.Model.DeleteClusterResponse, RemoveHSM2ClusterCmdlet, object> Select { get; set; } =
