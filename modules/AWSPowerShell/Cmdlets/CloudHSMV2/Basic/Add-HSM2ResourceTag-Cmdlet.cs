...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    /// </summary>
    [Cmdlet("Add", "HSM2ResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CloudHSM V2 TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.CloudHSMV2.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.CloudHSMV2.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudHSMV2.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddHSM2ResourceTagCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-HSM2ResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudHSMV2.Model.TagResourceResponse, AddHSM2ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudHSMV2.Model.TagResourceRequest();
        ...
        private Amazon.CloudHSMV2.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCloudHSMV2 client, Amazon.CloudHSMV2.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudHSM V2", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudHSMV2.Model.TagResourceResponse, AddHSM2ResourceTagCmdlet, object> Select { get; set; } =
