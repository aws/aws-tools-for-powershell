...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Calls the AWS CodeBuild ListSourceCredentials API operation.", Operation = new[] {"ListSourceCredentials"})]
    [AWSCmdletOutput("Amazon.CodeBuild.Model.SourceCredentialsInfo",
        "This cmdlet returns a collection of SourceCredentialsInfo objects.",
    ...
    public partial class GetCBSourceCredentialListCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SourceCredentialsInfos;
        ...
        private Amazon.CodeBuild.Model.ListSourceCredentialsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.ListSourceCredentialsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListSourceCredentialsAsync(request);
                return task.Result;
                #else
