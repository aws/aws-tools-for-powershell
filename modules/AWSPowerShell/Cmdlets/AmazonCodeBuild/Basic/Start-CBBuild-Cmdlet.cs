...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Invokes the StartBuild operation against AWS CodeBuild.", Operation = new[] {"StartBuild"})]
    ...
    public partial class StartCBBuildCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        /// latest version will be used. If specified, must be one of:</para><ul><li><para>For AWS CodeCommit or GitHub: the commit ID to use.</para></li><li><para>For Amazon Simple Storage Service (Amazon S3): the version ID of the object representing
        ...
        private static Amazon.CodeBuild.Model.StartBuildResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.StartBuildRequest request)
        {
            #if DESKTOP
