...
namespace Amazon.PowerShell.Cmdlets.CB
{
    ...
    [AWSCmdlet("Invokes the ListBuilds operation against AWS CodeBuild.", Operation = new[] {"ListBuilds"})]
    ...
    public partial class GetCBBuildIdListCmdlet : AmazonCodeBuildClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CodeBuild.Model.ListBuildsResponse CallAWSServiceOperation(IAmazonCodeBuild client, Amazon.CodeBuild.Model.ListBuildsRequest request)
        {
            #if DESKTOP
