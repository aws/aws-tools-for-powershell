...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class NewS3SessionCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// server-side encryption using KMS keys (SSE-KMS).</para><para>S3 Bucket Keys are always enabled for <c>GET</c> and <c>PUT</c> operations in a directory
        ...
        /// is made for a KMS-encrypted object.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket that you create a session for.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The server-side encryption algorithm to use when you store objects in the directory
        /// bucket.</para><para>For directory buckets, there are only two supported options for server-side encryption:
        /// server-side encryption with Amazon S3 managed keys (SSE-S3) (<c>AES256</c>) and server-side
        ...
        /// data with server-side encryption</a> in the <i>Amazon S3 User Guide</i>.</para><para><b>S3 access points for Amazon FSx </b> - When accessing data stored in Amazon FSx
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the mode of the session that will be created, either <c>ReadWrite</c> or
        ...
        /// <c>ListParts</c>, and <c>ListMultipartUploads</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the Amazon Web Services KMS Encryption Context as an additional encryption
        ...
        /// Amazon Web Services KMS for future <c>GetObject</c> operations on this object.</para><para><b>General purpose buckets</b> - This value must be explicitly added during <c>CopyObject</c>
        ...
        /// context</a> in the <i>Amazon S3 User Guide</i>.</para><para><b>Directory buckets</b> - You can optionally provide an explicit encryption context
        /// value. The value must match the default encryption context - the bucket Amazon Resource
        /// Name (ARN). An additional encryption context value is not supported. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>If you specify <c>x-amz-server-side-encryption</c> with <c>aws:kms</c>, you must specify
        ...
        /// the Key ID. </para><para>Your SSE-KMS configuration can only support 1 <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk">customer
        ...
        /// Web Services managed key</a> (<c>aws/s3</c>) isn't supported. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
