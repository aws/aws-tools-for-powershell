...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdletOutput("None or Amazon.S3.Model.DeleteBucketOwnershipControlsResponse",
        ...
        "The service response (type Amazon.S3.Model.DeleteBucketOwnershipControlsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
