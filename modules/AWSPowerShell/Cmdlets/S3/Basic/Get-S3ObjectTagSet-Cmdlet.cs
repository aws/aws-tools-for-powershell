...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class GetS3ObjectTagSetCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket name containing the object for which to get the tagging information. </para><para><b>Access points</b> - When you use this action with an access point for general
        ...
        private Amazon.S3.Model.GetObjectTaggingResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetObjectTaggingRequest request)
        {
            ...
            try
            {
                return client.GetObjectTaggingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
