...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class GetS3ObjectACLCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket name that contains the object for which to get the ACL information. </para><para><b>Access points</b> - When you use this action with an access point, you must provide
