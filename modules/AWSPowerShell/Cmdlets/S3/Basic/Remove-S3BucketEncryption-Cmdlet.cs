...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketEncryption.html">PutBucketEncryption</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketEncryption.html">GetBucketEncryption</a></para></li></ul><important><para>
    ...
    public partial class RemoveS3BucketEncryptionCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket containing the server-side encryption configuration to delete.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket, you must use path-style requests 
        ...
        private Amazon.S3.Model.DeleteBucketEncryptionResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketEncryptionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteBucketEncryptionAsync(request).GetAwaiter().GetResult();
                #else
