...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class RemoveS3BucketMetricsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket containing the metrics configuration to delete.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
