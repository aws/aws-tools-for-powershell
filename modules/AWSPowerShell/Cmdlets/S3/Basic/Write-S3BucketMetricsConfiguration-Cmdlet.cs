...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><b>General purpose bucket permissions</b> - The <c>s3:PutMetricsConfiguration</c>
    ...
    /// must have the <c>s3express:PutMetricsConfiguration</c> permission in an IAM identity-based
    ...
    /// </para></li></ul></li></ul><important><para>
    ...
    public partial class WriteS3BucketMetricsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket for which the metrics configuration is set.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
