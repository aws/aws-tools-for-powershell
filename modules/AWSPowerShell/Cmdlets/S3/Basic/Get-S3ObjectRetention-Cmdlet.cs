...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class GetS3ObjectRetentionCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket name containing the object whose retention settings you want to retrieve.</para><para>When using this API with an access point, you must direct requests to the access point hostname. 
