...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class RemoveS3ObjectTagSetCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket name containing the objects from which to remove the tags. </para><para><b>Access points</b> - When you use this action with an access point, you must provide
        ...
        private Amazon.S3.Model.DeleteObjectTaggingResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteObjectTaggingRequest request)
        {
            ...
            try
            {
                return client.DeleteObjectTaggingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
