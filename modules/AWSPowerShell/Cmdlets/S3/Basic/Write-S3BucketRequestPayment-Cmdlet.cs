...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucket.html">CreateBucket</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketRequestPayment.html">GetBucketRequestPayment</a></para></li></ul><important><para>
    ...
    public partial class WriteS3BucketRequestPaymentCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            #if MODULAR
            if (this.RequestPaymentConfiguration_Payer == null && ParameterWasBound(nameof(this.RequestPaymentConfiguration_Payer)))
            {
                WriteWarning("You are passing $null as a value for parameter RequestPaymentConfiguration_Payer which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.S3.Model.PutBucketRequestPaymentResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.PutBucketRequestPaymentRequest request)
        {
            ...
            try
            {
                return client.PutBucketRequestPaymentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
