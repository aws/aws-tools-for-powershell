...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class WriteS3BucketVersioningCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies whether MFA delete is enabled in the bucket versioning configuration. This
        /// element is only returned if the bucket has been configured with MFA delete. If the
        /// bucket has never been so configured, this element is not returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The versioning state of the bucket.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.S3.Model.PutBucketVersioningResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.PutBucketVersioningRequest request)
        {
            ...
            try
            {
                return client.PutBucketVersioningAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
