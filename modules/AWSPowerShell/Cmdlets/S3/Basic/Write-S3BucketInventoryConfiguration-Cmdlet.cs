...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para></important><note><para><b>Directory buckets </b> - For directory buckets, you must make requests for this
    ...
    /// </para><ul><li><para><b>General purpose bucket permissions</b> - The <c>s3:PutInventoryConfiguration</c>
    ...
    public partial class WriteS3BucketInventoryConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket where the inventory configuration will be stored.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
        ...
        /// <summary>
        /// <para>
        /// <para>Contains the optional fields that are included in the inventory results.</para><note><para>The following optional fields are supported for directory buckets <c>Size | LastModifiedDate
        ...
        /// optional field is provided. </para></note><para />
