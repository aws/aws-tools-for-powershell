...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><b>General purpose bucket permissions</b> - The <c>s3:GetMetricsConfiguration</c>
    ...
    /// must have the <c>s3express:GetMetricsConfiguration</c> permission in an IAM identity-based
    ...
    public partial class GetS3BucketMetricsConfigurationListCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket containing the metrics configurations to retrieve.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
        ...
        /// <summary>
        /// <para>
        /// <para>The marker that is used to continue a metrics configuration listing that has been
        ...
        private Amazon.S3.Model.ListBucketMetricsConfigurationsResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.ListBucketMetricsConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListBucketMetricsConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
