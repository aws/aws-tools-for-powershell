...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketEncryption.html">PutBucketEncryption</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketEncryption.html">DeleteBucketEncryption</a></para></li></ul><important><para>
    ...
    public partial class GetS3BucketEncryptionCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket from which the server-side encryption configuration is retrieved.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
        ...
        private Amazon.S3.Model.GetBucketEncryptionResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketEncryptionRequest request)
        {
            ...
            try
            {
                return client.GetBucketEncryptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
