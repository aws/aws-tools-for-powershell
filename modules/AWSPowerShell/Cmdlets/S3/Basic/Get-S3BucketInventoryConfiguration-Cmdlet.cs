...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    /// </para><ul><li><para><b>General purpose bucket permissions</b> - The <c>s3:GetInventoryConfiguration</c>
    ...
    public partial class GetS3BucketInventoryConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket containing the inventory configuration to retrieve.</para><para><b>Directory buckets </b> - When you use this operation with a directory bucket,
        ...
        private Amazon.S3.Model.GetBucketInventoryConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketInventoryConfigurationRequest request)
        {
            ...
            try
            {
                return client.GetBucketInventoryConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
