...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Glacier RemoveTagsFromVault API operation.", Operation = new[] {"RemoveTagsFromVault"}, SelectReturnType = typeof(Amazon.Glacier.Model.RemoveTagsFromVaultResponse))]
    [AWSCmdletOutput("None or Amazon.Glacier.Model.RemoveTagsFromVaultResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Glacier.Model.RemoveTagsFromVaultResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGLCTagsFromVaultCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tag keys. Each corresponding tag is removed from the vault.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glacier.Model.RemoveTagsFromVaultResponse, RemoveGLCTagsFromVaultCmdlet>(Select) ??
        ...
        private Amazon.Glacier.Model.RemoveTagsFromVaultResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.RemoveTagsFromVaultRequest request)
        {
            ...
            try
            {
                return client.RemoveTagsFromVaultAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VaultName { get; set; }
            public System.Func<Amazon.Glacier.Model.RemoveTagsFromVaultResponse, RemoveGLCTagsFromVaultCmdlet, object> Select { get; set; } =
