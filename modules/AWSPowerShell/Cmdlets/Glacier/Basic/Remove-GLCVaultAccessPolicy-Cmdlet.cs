...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    public partial class RemoveGLCVaultAccessPolicyCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glacier.Model.DeleteVaultAccessPolicyResponse, RemoveGLCVaultAccessPolicyCmdlet>(Select) ??
        ...
        private Amazon.Glacier.Model.DeleteVaultAccessPolicyResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.DeleteVaultAccessPolicyRequest request)
        {
            ...
            try
            {
                return client.DeleteVaultAccessPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String VaultName { get; set; }
            public System.Func<Amazon.Glacier.Model.DeleteVaultAccessPolicyResponse, RemoveGLCVaultAccessPolicyCmdlet, object> Select { get; set; } =
