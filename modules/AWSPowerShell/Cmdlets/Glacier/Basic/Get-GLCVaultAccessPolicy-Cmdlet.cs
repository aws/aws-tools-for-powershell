...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLCVaultAccessPolicy")]
    [OutputType("Amazon.Glacier.Model.VaultAccessPolicy")]
    ...
    public partial class GetGLCVaultAccessPolicyCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glacier.Model.GetVaultAccessPolicyResponse, GetGLCVaultAccessPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glacier.Model.GetVaultAccessPolicyRequest();
        ...
        private Amazon.Glacier.Model.GetVaultAccessPolicyResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.GetVaultAccessPolicyRequest request)
        {
            ...
            try
            {
                return client.GetVaultAccessPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String VaultName { get; set; }
            public System.Func<Amazon.Glacier.Model.GetVaultAccessPolicyResponse, GetGLCVaultAccessPolicyCmdlet, object> Select { get; set; } =
