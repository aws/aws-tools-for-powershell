...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    public partial class NewGLCProvisionedCapacityPurchaseCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "CapacityId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Glacier.Model.PurchaseProvisionedCapacityResponse, NewGLCProvisionedCapacityPurchaseCmdlet>(Select) ??
        ...
        private Amazon.Glacier.Model.PurchaseProvisionedCapacityResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.PurchaseProvisionedCapacityRequest request)
        {
            ...
            try
            {
                return client.PurchaseProvisionedCapacityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.Glacier.Model.PurchaseProvisionedCapacityResponse, NewGLCProvisionedCapacityPurchaseCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CapacityId;
        }
