#
# Module manifest for module 'AWS.Tools.EventBridgeV2'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.EventBridgeV2.dll'
    ...
    GUID = 'e4a48796-36ed-4ea4-a8f5-f86ceb3e633f'
    ...
    Description = 'The EventBridgeV2 module of AWS Tools for PowerShell lets developers and administrators manage Amazon EventBridgeV2 from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.EventBridgeV2.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.EventBridgeV2.Completers.psm1',
        'AWS.Tools.EventBridgeV2.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.EventBridgeV2.dll-Help.xml'
    )
