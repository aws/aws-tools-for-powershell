...
namespace Amazon.PowerShell.Cmdlets.EVBV2
{
    ...
    /// </summary>
    [Cmdlet("Update", "EVBV2Subscriber", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EventBridgeV2.Model.UpdateSubscriberResponse")]
    [AWSCmdlet("Calls the Amazon EventBridgeV2 UpdateSubscriber API operation.", Operation = new[] {"UpdateSubscriber"}, SelectReturnType = typeof(Amazon.EventBridgeV2.Model.UpdateSubscriberResponse))]
    [AWSCmdletOutput("Amazon.EventBridgeV2.Model.UpdateSubscriberResponse",
        "This cmdlet returns an Amazon.EventBridgeV2.Model.UpdateSubscriberResponse object containing multiple properties."
    )]
    public partial class UpdateEVBV2SubscriberCmdlet : AmazonEventBridgeV2ClientCmdlet, IExecutor
    {
        ...
        #region Parameter ResumePosition
        /// <summary>
        /// <para>
        /// The service has not provided documentation for this parameter; please refer to the service's API reference documentation for the latest available information.
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.EventBridgeV2.ResumePosition")]
        public Amazon.EventBridgeV2.ResumePosition ResumePosition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EventBridgeV2.Model.UpdateSubscriberResponse).
        /// Specifying the name of a property of type Amazon.EventBridgeV2.Model.UpdateSubscriberResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EVBV2Subscriber (UpdateSubscriber)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridgeV2.Model.UpdateSubscriberResponse, UpdateEVBV2SubscriberCmdlet>(Select) ??
            ...
            context.ResumePosition = this.ResumePosition;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridgeV2.Model.UpdateSubscriberRequest();
            ...
            request.InvokeConfiguration = new Amazon.EventBridgeV2.Model.UpdateInvokeConfiguration();
            ...
            if (cmdletContext.ResumePosition != null)
            {
                request.ResumePosition = cmdletContext.ResumePosition;
            }
        ...
        private Amazon.EventBridgeV2.Model.UpdateSubscriberResponse CallAWSServiceOperation(IAmazonEventBridgeV2 client, Amazon.EventBridgeV2.Model.UpdateSubscriberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridgeV2", "UpdateSubscriber");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Transformer_JsonataConfiguration_Expression { get; set; }
            public Amazon.EventBridgeV2.TransformerType Transformer_Type { get; set; }
            public System.Func<Amazon.EventBridgeV2.Model.UpdateSubscriberResponse, UpdateEVBV2SubscriberCmdlet, object> Select { get; set; } =
