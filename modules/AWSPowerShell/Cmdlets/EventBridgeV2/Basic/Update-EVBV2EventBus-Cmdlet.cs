...
namespace Amazon.PowerShell.Cmdlets.EVBV2
{
    ...
    /// </summary>
    [Cmdlet("Update", "EVBV2EventBus", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EventBridgeV2.Model.UpdateEventBusResponse")]
    [AWSCmdlet("Calls the Amazon EventBridgeV2 UpdateEventBus API operation.", Operation = new[] {"UpdateEventBus"}, SelectReturnType = typeof(Amazon.EventBridgeV2.Model.UpdateEventBusResponse))]
    [AWSCmdletOutput("Amazon.EventBridgeV2.Model.UpdateEventBusResponse",
        "This cmdlet returns an Amazon.EventBridgeV2.Model.UpdateEventBusResponse object containing multiple properties."
    )]
    public partial class UpdateEVBV2EventBusCmdlet : AmazonEventBridgeV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EventBridgeV2.Model.UpdateEventBusResponse).
        /// Specifying the name of a property of type Amazon.EventBridgeV2.Model.UpdateEventBusResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EVBV2EventBus (UpdateEventBus)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridgeV2.Model.UpdateEventBusResponse, UpdateEVBV2EventBusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridgeV2.Model.UpdateEventBusRequest();
        ...
        private Amazon.EventBridgeV2.Model.UpdateEventBusResponse CallAWSServiceOperation(IAmazonEventBridgeV2 client, Amazon.EventBridgeV2.Model.UpdateEventBusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridgeV2", "UpdateEventBus");
            try
            {
                return client.UpdateEventBusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EventBusArn { get; set; }
            public System.Int32? StorageConfiguration_RetentionPeriodInDay { get; set; }
            public System.Func<Amazon.EventBridgeV2.Model.UpdateEventBusResponse, UpdateEVBV2EventBusCmdlet, object> Select { get; set; } =
