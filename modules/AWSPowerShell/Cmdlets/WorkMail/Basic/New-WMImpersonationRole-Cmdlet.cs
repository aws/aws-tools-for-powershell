...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WMImpersonationRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon WorkMail CreateImpersonationRole API operation.", Operation = new[] {"CreateImpersonationRole"}, SelectReturnType = typeof(Amazon.WorkMail.Model.CreateImpersonationRoleResponse))]
    [AWSCmdletOutput("System.String or Amazon.WorkMail.Model.CreateImpersonationRoleResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WorkMail.Model.CreateImpersonationRoleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewWMImpersonationRoleCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of rules for the impersonation role.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ImpersonationRoleId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WMImpersonationRole (CreateImpersonationRole)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.CreateImpersonationRoleResponse, NewWMImpersonationRoleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.CreateImpersonationRoleRequest();
        ...
        private Amazon.WorkMail.Model.CreateImpersonationRoleResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.CreateImpersonationRoleRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.WorkMail.ImpersonationRoleType Type { get; set; }
            public System.Func<Amazon.WorkMail.Model.CreateImpersonationRoleResponse, NewWMImpersonationRoleCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ImpersonationRoleId;
        }
