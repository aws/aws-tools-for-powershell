...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// users' emails.
    /// </summary>
    [Cmdlet("Add", "WMMailDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddWMMailDomainCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WMMailDomain (RegisterMailDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.RegisterMailDomainResponse, AddWMMailDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.RegisterMailDomainRequest();
        ...
        private Amazon.WorkMail.Model.RegisterMailDomainResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.RegisterMailDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "RegisterMailDomain");
            try
            {
                #if DESKTOP
                return client.RegisterMailDomain(request);
                #elif CORECLR
                return client.RegisterMailDomainAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DomainName { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.RegisterMailDomainResponse, AddWMMailDomainCmdlet, object> Select { get; set; } =
