...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail ListMailboxPermissions API operation.", Operation = new[] {"ListMailboxPermissions"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListMailboxPermissionsResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.Permission or Amazon.WorkMail.Model.ListMailboxPermissionsResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.Permission objects.",
        "The service call response (type Amazon.WorkMail.Model.ListMailboxPermissionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWMMailboxPermissionListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the user, or resource for which to list mailbox permissions.</para><para>The entity ID can accept <i>UserId or ResourceId</i>, <i>Username or Resourcename</i>,
        /// or <i>email</i>.</para><ul><li><para>Entity ID: 12345678-1234-1234-1234-123456789012, or r-0123456789a0123456789b0123456789</para></li><li><para>Email address: entity@domain.tld</para></li><li><para>Entity name: entity</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListMailboxPermissionsResponse, GetWMMailboxPermissionListCmdlet>(Select) ??
        ...
        private Amazon.WorkMail.Model.ListMailboxPermissionsResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListMailboxPermissionsRequest request)
        {
            ...
            try
            {
                return client.ListMailboxPermissionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListMailboxPermissionsResponse, GetWMMailboxPermissionListCmdlet, object> Select { get; set; } =
