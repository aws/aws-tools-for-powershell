...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMAliasList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon WorkMail ListAliases API operation.", Operation = new[] {"ListAliases"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListAliasesResponse))]
    [AWSCmdletOutput("System.String or Amazon.WorkMail.Model.ListAliasesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.WorkMail.Model.ListAliasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWMAliasListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListAliasesResponse, GetWMAliasListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListAliasesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Aliases?.Count ?? 0;
        ...
        private Amazon.WorkMail.Model.ListAliasesResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListAliasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListAliases");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListAliasesResponse, GetWMAliasListCmdlet, object> Select { get; set; } =
