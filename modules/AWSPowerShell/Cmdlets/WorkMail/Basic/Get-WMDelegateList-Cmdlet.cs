...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdletOutput("Amazon.WorkMail.Model.Delegate or Amazon.WorkMail.Model.ListResourceDelegatesResponse",
        ...
        "The service call response (type Amazon.WorkMail.Model.ListResourceDelegatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
