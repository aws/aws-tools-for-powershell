...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMDelegateList")]
    [OutputType("Amazon.WorkMail.Model.Delegate")]
    [AWSCmdlet("Calls the Amazon WorkMail ListResourceDelegates API operation.", Operation = new[] {"ListResourceDelegates"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListResourceDelegatesResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.Delegate or Amazon.WorkMail.Model.ListResourceDelegatesResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.Delegate objects.",
        "The service call response (type Amazon.WorkMail.Model.ListResourceDelegatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWMDelegateListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the resource whose delegates are listed.</para><para>The identifier can accept <i>ResourceId</i>, <i>Resourcename</i>, or <i>email</i>.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Delegates";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListResourceDelegatesResponse, GetWMDelegateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListResourceDelegatesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Delegates?.Count ?? 0;
        ...
        private Amazon.WorkMail.Model.ListResourceDelegatesResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListResourceDelegatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListResourceDelegates");
            try
            {
                return client.ListResourceDelegatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OrganizationId { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListResourceDelegatesResponse, GetWMDelegateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Delegates;
        }
