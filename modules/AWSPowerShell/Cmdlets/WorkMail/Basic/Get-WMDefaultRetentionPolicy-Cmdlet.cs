...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMDefaultRetentionPolicy")]
    ...
    public partial class GetWMDefaultRetentionPolicyCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.GetDefaultRetentionPolicyResponse, GetWMDefaultRetentionPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.GetDefaultRetentionPolicyRequest();
        ...
        private Amazon.WorkMail.Model.GetDefaultRetentionPolicyResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.GetDefaultRetentionPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "GetDefaultRetentionPolicy");
            try
            {
                #if DESKTOP
                return client.GetDefaultRetentionPolicy(request);
                #elif CORECLR
                return client.GetDefaultRetentionPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.GetDefaultRetentionPolicyResponse, GetWMDefaultRetentionPolicyCmdlet, object> Select { get; set; } =
