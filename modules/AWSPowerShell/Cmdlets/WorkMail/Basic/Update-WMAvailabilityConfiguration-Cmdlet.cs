...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkMail UpdateAvailabilityConfiguration API operation.", Operation = new[] {"UpdateAvailabilityConfiguration"}, SelectReturnType = typeof(Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse))]
    [AWSCmdletOutput("None or Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateWMAvailabilityConfigurationCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WMAvailabilityConfiguration (UpdateAvailabilityConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse, UpdateWMAvailabilityConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.UpdateAvailabilityConfigurationRequest();
        ...
        private Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.UpdateAvailabilityConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "UpdateAvailabilityConfiguration");
            try
            {
                #if DESKTOP
                return client.UpdateAvailabilityConfiguration(request);
                #elif CORECLR
                return client.UpdateAvailabilityConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LambdaProvider_LambdaArn { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.UpdateAvailabilityConfigurationResponse, UpdateWMAvailabilityConfigurationCmdlet, object> Select { get; set; } =
