...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class RemoveWMMailDomainCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMMailDomain (DeregisterMailDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DeregisterMailDomainResponse, RemoveWMMailDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DeregisterMailDomainRequest();
        ...
        private Amazon.WorkMail.Model.DeregisterMailDomainResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DeregisterMailDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DeregisterMailDomain");
            try
            {
                #if DESKTOP
                return client.DeregisterMailDomain(request);
                #elif CORECLR
                return client.DeregisterMailDomainAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DeregisterMailDomainResponse, RemoveWMMailDomainCmdlet, object> Select { get; set; } =
