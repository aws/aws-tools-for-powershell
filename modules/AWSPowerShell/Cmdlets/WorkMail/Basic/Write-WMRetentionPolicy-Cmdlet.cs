...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdletOutput("None or Amazon.WorkMail.Model.PutRetentionPolicyResponse",
        ...
        "The service response (type Amazon.WorkMail.Model.PutRetentionPolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteWMRetentionPolicyCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The retention policy folder configurations.</para><para />
