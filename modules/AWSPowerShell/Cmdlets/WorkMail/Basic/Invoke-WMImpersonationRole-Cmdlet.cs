...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Invoke", "WMImpersonationRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WorkMail.Model.AssumeImpersonationRoleResponse")]
    [AWSCmdlet("Calls the Amazon WorkMail AssumeImpersonationRole API operation.", Operation = new[] {"AssumeImpersonationRole"}, SelectReturnType = typeof(Amazon.WorkMail.Model.AssumeImpersonationRoleResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.AssumeImpersonationRoleResponse",
        "This cmdlet returns an Amazon.WorkMail.Model.AssumeImpersonationRoleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class InvokeWMImpersonationRoleCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-WMImpersonationRole (AssumeImpersonationRole)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.AssumeImpersonationRoleResponse, InvokeWMImpersonationRoleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.AssumeImpersonationRoleRequest();
        ...
        private Amazon.WorkMail.Model.AssumeImpersonationRoleResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.AssumeImpersonationRoleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "AssumeImpersonationRole");
            try
            {
                #if DESKTOP
                return client.AssumeImpersonationRole(request);
                #elif CORECLR
                return client.AssumeImpersonationRoleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ImpersonationRoleId { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.AssumeImpersonationRoleResponse, InvokeWMImpersonationRoleCmdlet, object> Select { get; set; } =
