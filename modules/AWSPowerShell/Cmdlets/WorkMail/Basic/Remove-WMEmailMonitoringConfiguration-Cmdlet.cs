...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WMEmailMonitoringConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWMEmailMonitoringConfigurationCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMEmailMonitoringConfiguration (DeleteEmailMonitoringConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DeleteEmailMonitoringConfigurationResponse, RemoveWMEmailMonitoringConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DeleteEmailMonitoringConfigurationRequest();
        ...
        private Amazon.WorkMail.Model.DeleteEmailMonitoringConfigurationResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DeleteEmailMonitoringConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DeleteEmailMonitoringConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteEmailMonitoringConfiguration(request);
                #elif CORECLR
                return client.DeleteEmailMonitoringConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DeleteEmailMonitoringConfigurationResponse, RemoveWMEmailMonitoringConfigurationCmdlet, object> Select { get; set; } =
