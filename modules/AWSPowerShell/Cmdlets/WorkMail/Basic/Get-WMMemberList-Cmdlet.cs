...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail ListGroupMembers API operation.", Operation = new[] {"ListGroupMembers"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListGroupMembersResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.Member or Amazon.WorkMail.Model.ListGroupMembersResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.Member objects.",
        "The service call response (type Amazon.WorkMail.Model.ListGroupMembersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWMMemberListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the group to which the members (users or groups) are associated.</para><para>The identifier can accept <i>GroupId</i>, <i>Groupname</i>, or <i>email</i>. The following
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListGroupMembersResponse, GetWMMemberListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListGroupMembersResponse, GetWMMemberListCmdlet, object> Select { get; set; } =
