...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkMail RegisterToWorkMail API operation.", Operation = new[] {"RegisterToWorkMail"}, SelectReturnType = typeof(Amazon.WorkMail.Model.RegisterToWorkMailResponse))]
    [AWSCmdletOutput("None or Amazon.WorkMail.Model.RegisterToWorkMailResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WorkMail.Model.RegisterToWorkMailResponse) be returned by specifying '-Select *'."
    )]
    public partial class RegisterWMToWorkMailCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the user, group, or resource to be updated.</para><para>The identifier can accept <i>UserId, ResourceId, or GroupId</i>, or <i>Username, Resourcename,
        /// or Groupname</i>. The following identity formats are available:</para><ul><li><para>Entity ID: 12345678-1234-1234-1234-123456789012, r-0123456789a0123456789b0123456789,
        /// or S-1-1-12-1234567890-123456789-123456789-1234</para></li><li><para>Entity name: entity</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-WMToWorkMail (RegisterToWorkMail)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.RegisterToWorkMailResponse, RegisterWMToWorkMailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.RegisterToWorkMailRequest();
        ...
        private Amazon.WorkMail.Model.RegisterToWorkMailResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.RegisterToWorkMailRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "RegisterToWorkMail");
            try
            {
                return client.RegisterToWorkMailAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EntityId { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.RegisterToWorkMailResponse, RegisterWMToWorkMailCmdlet, object> Select { get; set; } =
