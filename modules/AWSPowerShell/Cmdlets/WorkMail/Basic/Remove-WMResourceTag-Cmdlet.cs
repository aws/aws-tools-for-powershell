...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class RemoveWMResourceTagCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.UntagResourceResponse, RemoveWMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.UntagResourceRequest();
        ...
        private Amazon.WorkMail.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkMail.Model.UntagResourceResponse, RemoveWMResourceTagCmdlet, object> Select { get; set; } =
