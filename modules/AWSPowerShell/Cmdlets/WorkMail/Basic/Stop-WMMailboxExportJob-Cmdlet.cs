...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Stop", "WMMailboxExportJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopWMMailboxExportJobCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-WMMailboxExportJob (CancelMailboxExportJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.CancelMailboxExportJobResponse, StopWMMailboxExportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.CancelMailboxExportJobRequest();
        ...
        private Amazon.WorkMail.Model.CancelMailboxExportJobResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.CancelMailboxExportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "CancelMailboxExportJob");
            try
            {
                #if DESKTOP
                return client.CancelMailboxExportJob(request);
                #elif CORECLR
                return client.CancelMailboxExportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String JobId { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.CancelMailboxExportJobResponse, StopWMMailboxExportJobCmdlet, object> Select { get; set; } =
