...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WMDelegateFromResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWMDelegateFromResourceCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMDelegateFromResource (DisassociateDelegateFromResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DisassociateDelegateFromResourceResponse, RemoveWMDelegateFromResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DisassociateDelegateFromResourceRequest();
        ...
        private Amazon.WorkMail.Model.DisassociateDelegateFromResourceResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DisassociateDelegateFromResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DisassociateDelegateFromResource");
            try
            {
                #if DESKTOP
                return client.DisassociateDelegateFromResource(request);
                #elif CORECLR
                return client.DisassociateDelegateFromResourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OrganizationId { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DisassociateDelegateFromResourceResponse, RemoveWMDelegateFromResourceCmdlet, object> Select { get; set; } =
