...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMImpersonationRoleList")]
    [OutputType("Amazon.WorkMail.Model.ImpersonationRole")]
    [AWSCmdlet("Calls the Amazon WorkMail ListImpersonationRoles API operation.", Operation = new[] {"ListImpersonationRoles"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListImpersonationRolesResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.ImpersonationRole or Amazon.WorkMail.Model.ListImpersonationRolesResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.ImpersonationRole objects.",
        "The service call response (type Amazon.WorkMail.Model.ListImpersonationRolesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWMImpersonationRoleListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Roles";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListImpersonationRolesResponse, GetWMImpersonationRoleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListImpersonationRolesRequest();
        ...
        private Amazon.WorkMail.Model.ListImpersonationRolesResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListImpersonationRolesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListImpersonationRoles");
            try
            {
                #if DESKTOP
                return client.ListImpersonationRoles(request);
                #elif CORECLR
                return client.ListImpersonationRolesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListImpersonationRolesResponse, GetWMImpersonationRoleListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Roles;
        }
