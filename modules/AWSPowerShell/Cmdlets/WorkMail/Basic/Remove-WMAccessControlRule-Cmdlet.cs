...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class RemoveWMAccessControlRuleCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMAccessControlRule (DeleteAccessControlRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DeleteAccessControlRuleResponse, RemoveWMAccessControlRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DeleteAccessControlRuleRequest();
        ...
        private Amazon.WorkMail.Model.DeleteAccessControlRuleResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DeleteAccessControlRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DeleteAccessControlRule");
            try
            {
                #if DESKTOP
                return client.DeleteAccessControlRule(request);
                #elif CORECLR
                return client.DeleteAccessControlRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DeleteAccessControlRuleResponse, RemoveWMAccessControlRuleCmdlet, object> Select { get; set; } =
