...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WMImpersonationRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWMImpersonationRoleCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WMImpersonationRole (DeleteImpersonationRole)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DeleteImpersonationRoleResponse, RemoveWMImpersonationRoleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DeleteImpersonationRoleRequest();
        ...
        private Amazon.WorkMail.Model.DeleteImpersonationRoleResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DeleteImpersonationRoleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DeleteImpersonationRole");
            try
            {
                #if DESKTOP
                return client.DeleteImpersonationRole(request);
                #elif CORECLR
                return client.DeleteImpersonationRoleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ImpersonationRoleId { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DeleteImpersonationRoleResponse, RemoveWMImpersonationRoleCmdlet, object> Select { get; set; } =
