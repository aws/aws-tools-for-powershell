...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMMailboxExportJobList")]
    [OutputType("Amazon.WorkMail.Model.MailboxExportJob")]
    [AWSCmdlet("Calls the Amazon WorkMail ListMailboxExportJobs API operation.", Operation = new[] {"ListMailboxExportJobs"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListMailboxExportJobsResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.MailboxExportJob or Amazon.WorkMail.Model.ListMailboxExportJobsResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.MailboxExportJob objects.",
        "The service call response (type Amazon.WorkMail.Model.ListMailboxExportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWMMailboxExportJobListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListMailboxExportJobsResponse, GetWMMailboxExportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListMailboxExportJobsRequest();
        ...
        private Amazon.WorkMail.Model.ListMailboxExportJobsResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListMailboxExportJobsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListMailboxExportJobsResponse, GetWMMailboxExportJobListCmdlet, object> Select { get; set; } =
