...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Write", "WMInboundDmarcSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteWMInboundDmarcSettingCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-WMInboundDmarcSetting (PutInboundDmarcSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.PutInboundDmarcSettingsResponse, WriteWMInboundDmarcSettingCmdlet>(Select) ??
            ...
            context.Enforced = this.Enforced;
            #if MODULAR
            if (this.Enforced == null && ParameterWasBound(nameof(this.Enforced)))
            {
                WriteWarning("You are passing $null as a value for parameter Enforced which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.PutInboundDmarcSettingsRequest();
            
            if (cmdletContext.Enforced != null)
            {
                request.Enforced = cmdletContext.Enforced.Value;
            }
        ...
        private Amazon.WorkMail.Model.PutInboundDmarcSettingsResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.PutInboundDmarcSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "PutInboundDmarcSettings");
            try
            {
                #if DESKTOP
                return client.PutInboundDmarcSettings(request);
                #elif CORECLR
                return client.PutInboundDmarcSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? Enforced { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.PutInboundDmarcSettingsResponse, WriteWMInboundDmarcSettingCmdlet, object> Select { get; set; } =
