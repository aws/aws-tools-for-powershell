...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class GetWMAvailabilityConfigurationListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AvailabilityConfigurations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListAvailabilityConfigurationsResponse, GetWMAvailabilityConfigurationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListAvailabilityConfigurationsRequest();
        ...
        private Amazon.WorkMail.Model.ListAvailabilityConfigurationsResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListAvailabilityConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListAvailabilityConfigurations");
            try
            {
                #if DESKTOP
                return client.ListAvailabilityConfigurations(request);
                #elif CORECLR
                return client.ListAvailabilityConfigurationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListAvailabilityConfigurationsResponse, GetWMAvailabilityConfigurationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AvailabilityConfigurations;
        }
