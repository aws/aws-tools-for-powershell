...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class GetWMMailDomainCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.GetMailDomainResponse, GetWMMailDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.GetMailDomainRequest();
        ...
        private Amazon.WorkMail.Model.GetMailDomainResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.GetMailDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "GetMailDomain");
            try
            {
                #if DESKTOP
                return client.GetMailDomain(request);
                #elif CORECLR
                return client.GetMailDomainAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.GetMailDomainResponse, GetWMMailDomainCmdlet, object> Select { get; set; } =
