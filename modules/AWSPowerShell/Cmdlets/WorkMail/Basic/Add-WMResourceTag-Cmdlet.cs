...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class AddWMResourceTagCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Tags")]
        public Amazon.WorkMail.Model.Tag[] Tag { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WMResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.TagResourceResponse, AddWMResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.WorkMail.Model.Tag>(this.Tag);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.TagResourceRequest();
        ...
        private Amazon.WorkMail.Model.TagResourceResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "TagResource");
            try
            {
        ...
        {
            public System.String ResourceARN { get; set; }
            public List<Amazon.WorkMail.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.WorkMail.Model.TagResourceResponse, AddWMResourceTagCmdlet, object> Select { get; set; } =
