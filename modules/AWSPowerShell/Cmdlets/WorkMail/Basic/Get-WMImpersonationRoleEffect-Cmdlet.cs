...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class GetWMImpersonationRoleEffectCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// identity formats are available:</para><ul><li><para>User ID: <c>12345678-1234-1234-1234-123456789012</c> or <c>S-1-1-12-1234567890-123456789-123456789-1234</c></para></li><li><para>Email address: <c>user@domain.tld</c></para></li><li><para>User name: <c>user</c></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.WorkMail.Model.GetImpersonationRoleEffectResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.GetImpersonationRoleEffectRequest request)
        {
            ...
            try
            {
                return client.GetImpersonationRoleEffectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
