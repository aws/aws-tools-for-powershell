...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdletOutput("Amazon.WorkMail.Model.Group or Amazon.WorkMail.Model.ListGroupsResponse",
        ...
        "The service call response (type Amazon.WorkMail.Model.ListGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
