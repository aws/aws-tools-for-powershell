...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WMMobileDeviceAccessOverrideList")]
    [OutputType("Amazon.WorkMail.Model.MobileDeviceAccessOverride")]
    [AWSCmdlet("Calls the Amazon WorkMail ListMobileDeviceAccessOverrides API operation.", Operation = new[] {"ListMobileDeviceAccessOverrides"}, SelectReturnType = typeof(Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse))]
    [AWSCmdletOutput("Amazon.WorkMail.Model.MobileDeviceAccessOverride or Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse",
        "This cmdlet returns a collection of Amazon.WorkMail.Model.MobileDeviceAccessOverride objects.",
        "The service call response (type Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWMMobileDeviceAccessOverrideListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        /// the following types of user identities:</para><ul><li><para>User ID: <c>12345678-1234-1234-1234-123456789012</c> or <c>S-1-1-12-1234567890-123456789-123456789-1234</c></para></li><li><para>Email address: <c>user@domain.tld</c></para></li><li><para>User name: <c>user</c></para></li></ul>
        /// </para>
        /// </summary>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Overrides";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse, GetWMMobileDeviceAccessOverrideListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesRequest();
        ...
        private Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListMobileDeviceAccessOverrides");
            try
            {
                #if DESKTOP
                return client.ListMobileDeviceAccessOverrides(request);
                #elif CORECLR
                return client.ListMobileDeviceAccessOverridesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OrganizationId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.WorkMail.Model.ListMobileDeviceAccessOverridesResponse, GetWMMobileDeviceAccessOverrideListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Overrides;
        }
