...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    public partial class GetWMMailboxExportJobCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkMail.Model.DescribeMailboxExportJobResponse, GetWMMailboxExportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkMail.Model.DescribeMailboxExportJobRequest();
        ...
        private Amazon.WorkMail.Model.DescribeMailboxExportJobResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DescribeMailboxExportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "DescribeMailboxExportJob");
            try
            {
                #if DESKTOP
                return client.DescribeMailboxExportJob(request);
                #elif CORECLR
                return client.DescribeMailboxExportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String JobId { get; set; }
            public System.String OrganizationId { get; set; }
            public System.Func<Amazon.WorkMail.Model.DescribeMailboxExportJobResponse, GetWMMailboxExportJobCmdlet, object> Select { get; set; } =
