#
# Module manifest for module 'AWS.Tools.PartnerCentralAccount'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.PartnerCentralAccount.dll'
    ...
    GUID = '72e5eeb9-ebdd-407c-9605-021e7360dcb8'
    ...
    Description = 'The PartnerCentralAccount module of AWS Tools for PowerShell lets developers and administrators manage Partner Central Account API from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
This version of AWS Tools for PowerShell is compatible with Windows PowerShell 5.1+ and PowerShell Core 6+ on Windows, Linux and macOS. When running on Windows PowerShell, .NET Framework 4.7.2 or newer is required. Alternative modules AWSPowerShell.NetCore and AWSPowerShell, provide support for all AWS services from a single module and also support older versions of Windows PowerShell and .NET Framework.'
    ...
    FormatsToProcess = @(
        'AWS.Tools.PartnerCentralAccount.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.PartnerCentralAccount.Completers.psm1',
        'AWS.Tools.PartnerCentralAccount.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'Add-PCAAResourceTag', 
        'Approve-PCAAConnectionInvitation', 
    ...
    FileList = @(
        'AWS.Tools.PartnerCentralAccount.dll-Help.xml'
    )
