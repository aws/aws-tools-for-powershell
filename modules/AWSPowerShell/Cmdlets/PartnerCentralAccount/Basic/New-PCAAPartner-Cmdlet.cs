...
namespace Amazon.PowerShell.Cmdlets.PCAA
{
    ...
    /// and configuration.
    /// </summary>
    [Cmdlet("New", "PCAAPartner", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PartnerCentralAccount.Model.CreatePartnerResponse")]
    [AWSCmdlet("Calls the Partner Central Account API CreatePartner API operation.", Operation = new[] {"CreatePartner"}, SelectReturnType = typeof(Amazon.PartnerCentralAccount.Model.CreatePartnerResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralAccount.Model.CreatePartnerResponse",
        "This cmdlet returns an Amazon.PartnerCentralAccount.Model.CreatePartnerResponse object containing multiple properties."
    )]
    public partial class NewPCAAPartnerCmdlet : AmazonPartnerCentralAccountClientCmdlet, IExecutor
    {
        ...
        #region Parameter PrimarySolutionType
        /// <summary>
        /// <para>
        ...
        public Amazon.PartnerCentralAccount.PrimarySolutionType PrimarySolutionType { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        public Amazon.PartnerCentralAccount.Model.Tag[] Tag { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralAccount.Model.CreatePartnerResponse, NewPCAAPartnerCmdlet>(Select) ??
            ...
            #endif
            context.LegalName = this.LegalName;
            #if MODULAR
            if (this.LegalName == null && ParameterWasBound(nameof(this.LegalName)))
            {
                WriteWarning("You are passing $null as a value for parameter LegalName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.PrimarySolutionType = this.PrimarySolutionType;
            #if MODULAR
            if (this.PrimarySolutionType == null && ParameterWasBound(nameof(this.PrimarySolutionType)))
            {
                WriteWarning("You are passing $null as a value for parameter PrimarySolutionType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.PartnerCentralAccount.Model.Tag>(this.Tag);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralAccount.Model.CreatePartnerRequest();
            ...
            if (cmdletContext.LegalName != null)
            {
                request.LegalName = cmdletContext.LegalName;
            }
            if (cmdletContext.PrimarySolutionType != null)
            {
                request.PrimarySolutionType = cmdletContext.PrimarySolutionType;
            }
        ...
        private Amazon.PartnerCentralAccount.Model.CreatePartnerResponse CallAWSServiceOperation(IAmazonPartnerCentralAccount client, Amazon.PartnerCentralAccount.Model.CreatePartnerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Account API", "CreatePartner");
            try
            {
                #if DESKTOP
                return client.CreatePartner(request);
                #elif CORECLR
                return client.CreatePartnerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LegalName { get; set; }
            public Amazon.PartnerCentralAccount.PrimarySolutionType PrimarySolutionType { get; set; }
            public List<Amazon.PartnerCentralAccount.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.PartnerCentralAccount.Model.CreatePartnerResponse, NewPCAAPartnerCmdlet, object> Select { get; set; } =
