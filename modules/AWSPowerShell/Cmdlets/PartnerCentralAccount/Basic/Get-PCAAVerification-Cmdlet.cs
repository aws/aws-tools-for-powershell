...
namespace Amazon.PowerShell.Cmdlets.PCAA
{
    ...
    public partial class GetPCAAVerificationCmdlet : AmazonPartnerCentralAccountClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the VerificationType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^VerificationType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^VerificationType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.VerificationType;
            }
        ...
        private Amazon.PartnerCentralAccount.Model.GetVerificationResponse CallAWSServiceOperation(IAmazonPartnerCentralAccount client, Amazon.PartnerCentralAccount.Model.GetVerificationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetVerification(request);
                #elif CORECLR
                return client.GetVerificationAsync(request).GetAwaiter().GetResult();
                #else
