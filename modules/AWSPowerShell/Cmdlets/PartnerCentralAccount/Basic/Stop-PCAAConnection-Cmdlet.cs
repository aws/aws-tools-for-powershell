...
namespace Amazon.PowerShell.Cmdlets.PCAA
{
    ...
    /// </summary>
    [Cmdlet("Stop", "PCAAConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PartnerCentralAccount.Model.CancelConnectionResponse")]
    [AWSCmdlet("Calls the Partner Central Account API CancelConnection API operation.", Operation = new[] {"CancelConnection"}, SelectReturnType = typeof(Amazon.PartnerCentralAccount.Model.CancelConnectionResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralAccount.Model.CancelConnectionResponse",
        "This cmdlet returns an Amazon.PartnerCentralAccount.Model.CancelConnectionResponse object containing multiple properties."
    )]
    public partial class StopPCAAConnectionCmdlet : AmazonPartnerCentralAccountClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-PCAAConnection (CancelConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralAccount.Model.CancelConnectionResponse, StopPCAAConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralAccount.Model.CancelConnectionRequest();
        ...
        private Amazon.PartnerCentralAccount.Model.CancelConnectionResponse CallAWSServiceOperation(IAmazonPartnerCentralAccount client, Amazon.PartnerCentralAccount.Model.CancelConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Account API", "CancelConnection");
            try
            {
                #if DESKTOP
                return client.CancelConnection(request);
                #elif CORECLR
                return client.CancelConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Identifier { get; set; }
            public System.String Reason { get; set; }
            public System.Func<Amazon.PartnerCentralAccount.Model.CancelConnectionResponse, StopPCAAConnectionCmdlet, object> Select { get; set; } =
