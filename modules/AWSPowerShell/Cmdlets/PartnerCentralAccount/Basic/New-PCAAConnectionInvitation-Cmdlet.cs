...
namespace Amazon.PowerShell.Cmdlets.PCAA
{
    ...
    /// </summary>
    [Cmdlet("New", "PCAAConnectionInvitation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse")]
    [AWSCmdlet("Calls the Partner Central Account API CreateConnectionInvitation API operation.", Operation = new[] {"CreateConnectionInvitation"}, SelectReturnType = typeof(Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse",
        "This cmdlet returns an Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse object containing multiple properties."
    )]
    public partial class NewPCAAConnectionInvitationCmdlet : AmazonPartnerCentralAccountClientCmdlet, IExecutor
    {
        ...
        #region Parameter ReceiverIdentifier
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String ReceiverIdentifier { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse, NewPCAAConnectionInvitationCmdlet>(Select) ??
            ...
            #endif
            context.ReceiverIdentifier = this.ReceiverIdentifier;
            #if MODULAR
            if (this.ReceiverIdentifier == null && ParameterWasBound(nameof(this.ReceiverIdentifier)))
            {
                WriteWarning("You are passing $null as a value for parameter ReceiverIdentifier which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationRequest();
            ...
            if (cmdletContext.ReceiverIdentifier != null)
            {
                request.ReceiverIdentifier = cmdletContext.ReceiverIdentifier;
            }
        ...
        private Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse CallAWSServiceOperation(IAmazonPartnerCentralAccount client, Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Account API", "CreateConnectionInvitation");
            try
            {
                #if DESKTOP
                return client.CreateConnectionInvitation(request);
                #elif CORECLR
                return client.CreateConnectionInvitationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String ReceiverIdentifier { get; set; }
            public System.Func<Amazon.PartnerCentralAccount.Model.CreateConnectionInvitationResponse, NewPCAAConnectionInvitationCmdlet, object> Select { get; set; } =
