...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "SESConfigurationSetSendingEnabled", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) UpdateConfigurationSetSendingEnabled API operation.", Operation = new[] {"UpdateConfigurationSetSendingEnabled"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSESConfigurationSetSendingEnabledCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SESConfigurationSetSendingEnabled (UpdateConfigurationSetSendingEnabled)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse, UpdateSESConfigurationSetSendingEnabledCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledRequest();
        ...
        private Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "UpdateConfigurationSetSendingEnabled");
            try
            {
                #if DESKTOP
                return client.UpdateConfigurationSetSendingEnabled(request);
                #elif CORECLR
                return client.UpdateConfigurationSetSendingEnabledAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfigurationSetName { get; set; }
            public System.Boolean? Enabled { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.UpdateConfigurationSetSendingEnabledResponse, UpdateSESConfigurationSetSendingEnabledCmdlet, object> Select { get; set; } =
