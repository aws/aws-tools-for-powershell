...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "SESReceiptRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) CreateReceiptRule API operation.", Operation = new[] {"CreateReceiptRule"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.CreateReceiptRuleResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.CreateReceiptRuleResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.CreateReceiptRuleResponse) be returned by specifying '-Select *'."
    )]
    public partial class NewSESReceiptRuleCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// email addresses or domains specified in the receipt rule.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The name of an existing rule after which the new rule is placed. If this parameter
        /// is null, the new rule is inserted at the beginning of the rule list.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// field is not specified, this rule matches all recipients on all verified domains.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the rule set where the receipt rule is added.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SESReceiptRule (CreateReceiptRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.CreateReceiptRuleResponse, NewSESReceiptRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmail.Model.CreateReceiptRuleRequest();
        ...
        private Amazon.SimpleEmail.Model.CreateReceiptRuleResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.CreateReceiptRuleRequest request)
        {
            ...
            try
            {
                return client.CreateReceiptRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SimpleEmail.TlsPolicy Rule_TlsPolicy { get; set; }
            public System.String RuleSetName { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.CreateReceiptRuleResponse, NewSESReceiptRuleCmdlet, object> Select { get; set; } =
