...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) DeleteConfigurationSetEventDestination API operation.", Operation = new[] {"DeleteConfigurationSetEventDestination"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.DeleteConfigurationSetEventDestinationResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.DeleteConfigurationSetEventDestinationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.DeleteConfigurationSetEventDestinationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSESConfigurationSetEventDestinationCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.DeleteConfigurationSetEventDestinationResponse, RemoveSESConfigurationSetEventDestinationCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "DeleteConfigurationSetEventDestination");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfigurationSetName { get; set; }
            public System.String EventDestinationName { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.DeleteConfigurationSetEventDestinationResponse, RemoveSESConfigurationSetEventDestinationCmdlet, object> Select { get; set; } =
