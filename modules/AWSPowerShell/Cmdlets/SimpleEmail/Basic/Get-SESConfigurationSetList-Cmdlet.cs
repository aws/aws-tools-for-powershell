...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("Amazon.SimpleEmail.Model.ConfigurationSet")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) ListConfigurationSets API operation.", Operation = new[] {"ListConfigurationSets"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.ListConfigurationSetsResponse))]
    [AWSCmdletOutput("Amazon.SimpleEmail.Model.ConfigurationSet or Amazon.SimpleEmail.Model.ListConfigurationSetsResponse",
        "This cmdlet returns a collection of Amazon.SimpleEmail.Model.ConfigurationSet objects.",
        "The service call response (type Amazon.SimpleEmail.Model.ListConfigurationSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSESConfigurationSetListCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConfigurationSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.ListConfigurationSetsResponse, GetSESConfigurationSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleEmail.Model.ListConfigurationSetsRequest();
        ...
        private Amazon.SimpleEmail.Model.ListConfigurationSetsResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.ListConfigurationSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "ListConfigurationSets");
            try
            {
                #if DESKTOP
                return client.ListConfigurationSets(request);
                #elif CORECLR
                return client.ListConfigurationSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxItem { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.ListConfigurationSetsResponse, GetSESConfigurationSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConfigurationSets;
        }
