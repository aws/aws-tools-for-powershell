...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) ListIdentities API operation.", Operation = new[] {"ListIdentities"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.ListIdentitiesResponse))]
    [AWSCmdletOutput("System.String or Amazon.SimpleEmail.Model.ListIdentitiesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.SimpleEmail.Model.ListIdentitiesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSESIdentityCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Identities";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^IdentityType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.ListIdentitiesResponse, GetSESIdentityCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.IdentityType;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.ListIdentitiesResponse, GetSESIdentityCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Identities;
        }
