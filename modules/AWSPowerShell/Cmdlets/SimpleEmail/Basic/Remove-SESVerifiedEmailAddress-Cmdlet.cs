...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) DeleteVerifiedEmailAddress API operation.", Operation = new[] {"DeleteVerifiedEmailAddress"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.DeleteVerifiedEmailAddressResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.DeleteVerifiedEmailAddressResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.DeleteVerifiedEmailAddressResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSESVerifiedEmailAddressCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^EmailAddress' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.DeleteVerifiedEmailAddressResponse, RemoveSESVerifiedEmailAddressCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.EmailAddress;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "DeleteVerifiedEmailAddress");
            try
            {
                #if DESKTOP
                return client.DeleteVerifiedEmailAddress(request);
                #elif CORECLR
                return client.DeleteVerifiedEmailAddressAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EmailAddress { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.DeleteVerifiedEmailAddressResponse, RemoveSESVerifiedEmailAddressCmdlet, object> Select { get; set; } =
