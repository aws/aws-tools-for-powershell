...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    public partial class ConfirmSESEmailAddressCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.VerifyEmailAddressResponse, ConfirmSESEmailAddressCmdlet>(Select) ??
        ...
        private Amazon.SimpleEmail.Model.VerifyEmailAddressResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.VerifyEmailAddressRequest request)
        {
            ...
            try
            {
                return client.VerifyEmailAddressAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String EmailAddress { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.VerifyEmailAddressResponse, ConfirmSESEmailAddressCmdlet, object> Select { get; set; } =
