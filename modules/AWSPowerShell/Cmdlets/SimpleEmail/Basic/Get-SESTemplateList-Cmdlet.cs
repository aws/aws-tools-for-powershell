...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    /// </summary>
    [Cmdlet("Get", "SESTemplateList")]
    [OutputType("Amazon.SimpleEmail.Model.TemplateMetadata")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) ListTemplates API operation.", Operation = new[] {"ListTemplates"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.ListTemplatesResponse))]
    [AWSCmdletOutput("Amazon.SimpleEmail.Model.TemplateMetadata or Amazon.SimpleEmail.Model.ListTemplatesResponse",
        "This cmdlet returns a collection of Amazon.SimpleEmail.Model.TemplateMetadata objects.",
        "The service call response (type Amazon.SimpleEmail.Model.ListTemplatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSESTemplateListCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.ListTemplatesResponse, GetSESTemplateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleEmail.Model.ListTemplatesRequest();
        ...
        private Amazon.SimpleEmail.Model.ListTemplatesResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.ListTemplatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "ListTemplates");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxItem { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.ListTemplatesResponse, GetSESTemplateListCmdlet, object> Select { get; set; } =
