...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    public partial class GetSESReceiptRuleSetCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.DescribeReceiptRuleSetResponse, GetSESReceiptRuleSetCmdlet>(Select) ??
        ...
        private Amazon.SimpleEmail.Model.DescribeReceiptRuleSetResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.DescribeReceiptRuleSetRequest request)
        {
            ...
            try
            {
                return client.DescribeReceiptRuleSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String RuleSetName { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.DescribeReceiptRuleSetResponse, GetSESReceiptRuleSetCmdlet, object> Select { get; set; } =
