...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) GetTemplate API operation.", Operation = new[] {"GetTemplate"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.GetTemplateResponse))]
    [AWSCmdletOutput("Amazon.SimpleEmail.Model.Template or Amazon.SimpleEmail.Model.GetTemplateResponse",
        "This cmdlet returns an Amazon.SimpleEmail.Model.Template object.",
        "The service call response (type Amazon.SimpleEmail.Model.GetTemplateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSESTemplateCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the template to retrieve.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.GetTemplateResponse, GetSESTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmail.Model.GetTemplateRequest();
        ...
        private Amazon.SimpleEmail.Model.GetTemplateResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.GetTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "GetTemplate");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String TemplateName { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.GetTemplateResponse, GetSESTemplateCmdlet, object> Select { get; set; } =
