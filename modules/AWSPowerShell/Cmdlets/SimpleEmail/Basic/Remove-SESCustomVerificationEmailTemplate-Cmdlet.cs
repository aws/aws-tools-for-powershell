...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) DeleteCustomVerificationEmailTemplate API operation.", Operation = new[] {"DeleteCustomVerificationEmailTemplate"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.DeleteCustomVerificationEmailTemplateResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.DeleteCustomVerificationEmailTemplateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.DeleteCustomVerificationEmailTemplateResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSESCustomVerificationEmailTemplateCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the custom verification email template to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.DeleteCustomVerificationEmailTemplateResponse, RemoveSESCustomVerificationEmailTemplateCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "DeleteCustomVerificationEmailTemplate");
            try
            {
                return client.DeleteCustomVerificationEmailTemplateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String TemplateName { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.DeleteCustomVerificationEmailTemplateResponse, RemoveSESCustomVerificationEmailTemplateCmdlet, object> Select { get; set; } =
