...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) UpdateConfigurationSetTrackingOptions API operation.", Operation = new[] {"UpdateConfigurationSetTrackingOptions"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.UpdateConfigurationSetTrackingOptionsResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.UpdateConfigurationSetTrackingOptionsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.UpdateConfigurationSetTrackingOptionsResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateSESConfigurationSetTrackingOptionCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.UpdateConfigurationSetTrackingOptionsResponse, UpdateSESConfigurationSetTrackingOptionCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service (SES)", "UpdateConfigurationSetTrackingOptions");
            try
            {
                return client.UpdateConfigurationSetTrackingOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfigurationSetName { get; set; }
            public Amazon.SimpleEmail.Model.TrackingOptions TrackingOption { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.UpdateConfigurationSetTrackingOptionsResponse, UpdateSESConfigurationSetTrackingOptionCmdlet, object> Select { get; set; } =
