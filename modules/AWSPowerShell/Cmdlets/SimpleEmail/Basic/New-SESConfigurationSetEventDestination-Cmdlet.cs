...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service (SES) CreateConfigurationSetEventDestination API operation.", Operation = new[] {"CreateConfigurationSetEventDestination"}, SelectReturnType = typeof(Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse) be returned by specifying '-Select *'."
    )]
    public partial class NewSESConfigurationSetEventDestinationCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SESConfigurationSetEventDestination (CreateConfigurationSetEventDestination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse, NewSESConfigurationSetEventDestinationCmdlet>(Select) ??
        ...
        private Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationRequest request)
        {
            ...
            try
            {
                return client.CreateConfigurationSetEventDestinationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EventDestination_Name { get; set; }
            public System.String SNSDestination_TopicARN { get; set; }
            public System.Func<Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse, NewSESConfigurationSetEventDestinationCmdlet, object> Select { get; set; } =
