...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    /// </para><para><b>Required permissions: </b><code>secretsmanager:BatchGetSecretValue</code>, and
    ...
    [AWSCmdletOutput("Amazon.SecretsManager.Model.BatchGetSecretValueResponse",
        "This cmdlet returns an Amazon.SecretsManager.Model.BatchGetSecretValueResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSECBatchSecretValueCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters to choose which secrets to retrieve. You must include <code>Filters</code>
        /// or <code>SecretIdList</code>, but not both.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN or names of the secrets to retrieve. You must include <code>Filters</code>
        /// or <code>SecretIdList</code>, but not both.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the SecretIdList parameter.
        /// The -PassThru parameter is deprecated, use -Select '^SecretIdList' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SecretIdList' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.SecretIdList;
            }
        ...
        private Amazon.SecretsManager.Model.BatchGetSecretValueResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.BatchGetSecretValueRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchGetSecretValue(request);
                #elif CORECLR
                return client.BatchGetSecretValueAsync(request).GetAwaiter().GetResult();
                #else
