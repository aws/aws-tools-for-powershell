...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    /// </para><para><b>Required permissions: </b><c>secretsmanager:RemoveRegionsFromReplication</c>.
    ...
    public partial class RemoveSECRegionsFromReplicationCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Regions of the replicas to remove.</para><para />
        ...
        [Alias("RemoveReplicaRegions")]
        public System.String[] RemoveReplicaRegion { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SECRegionsFromReplication (RemoveRegionsFromReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecretsManager.Model.RemoveRegionsFromReplicationResponse, RemoveSECRegionsFromReplicationCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.RemoveReplicaRegion != null)
            {
                context.RemoveReplicaRegion = new List<System.String>(this.RemoveReplicaRegion);
            }
            #if MODULAR
            if (this.RemoveReplicaRegion == null && ParameterWasBound(nameof(this.RemoveReplicaRegion)))
            {
                WriteWarning("You are passing $null as a value for parameter RemoveReplicaRegion which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecretsManager.Model.RemoveRegionsFromReplicationRequest();
            
            if (cmdletContext.RemoveReplicaRegion != null)
            {
                request.RemoveReplicaRegions = cmdletContext.RemoveReplicaRegion;
            }
        ...
        private Amazon.SecretsManager.Model.RemoveRegionsFromReplicationResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.RemoveRegionsFromReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Secrets Manager", "RemoveRegionsFromReplication");
            try
            {
                return client.RemoveRegionsFromReplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> RemoveReplicaRegion { get; set; }
            public System.String SecretId { get; set; }
            public System.Func<Amazon.SecretsManager.Model.RemoveRegionsFromReplicationResponse, RemoveSECRegionsFromReplicationCmdlet, object> Select { get; set; } =
