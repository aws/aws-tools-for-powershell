...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    /// </para><para><b>Required permissions: </b><c>secretsmanager:StopReplicationToReplica</c>. For
    ...
    public partial class StopSECReplicationToReplicaCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SECReplicationToReplica (StopReplicationToReplica)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecretsManager.Model.StopReplicationToReplicaResponse, StopSECReplicationToReplicaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecretsManager.Model.StopReplicationToReplicaRequest();
        ...
        private Amazon.SecretsManager.Model.StopReplicationToReplicaResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.StopReplicationToReplicaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Secrets Manager", "StopReplicationToReplica");
            try
            {
                #if DESKTOP
                return client.StopReplicationToReplica(request);
                #elif CORECLR
                return client.StopReplicationToReplicaAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SecretId { get; set; }
            public System.Func<Amazon.SecretsManager.Model.StopReplicationToReplicaResponse, StopSECReplicationToReplicaCmdlet, object> Select { get; set; } =
