...
namespace Amazon.PowerShell.Cmdlets.SEC
{
    ...
    [AWSCmdletOutput("Amazon.SecretsManager.Model.RotateSecretResponse",
        "This cmdlet returns an Amazon.SecretsManager.Model.RotateSecretResponse object containing multiple properties."
    )]
    public partial class InvokeSECSecretRotationCmdlet : AmazonSecretsManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique identifier for the new version of the secret. You only need to specify this
        /// value if you implement your own retry logic and you want to ensure that Secrets Manager
        /// doesn't attempt to create a secret version twice.</para><note><para>If you use the Amazon Web Services CLI or one of the Amazon Web Services SDKs to call
        ...
        /// Secrets Manager managed external secrets</a></para><para />
        ...
        private Amazon.SecretsManager.Model.RotateSecretResponse CallAWSServiceOperation(IAmazonSecretsManager client, Amazon.SecretsManager.Model.RotateSecretRequest request)
        {
            ...
            try
            {
                return client.RotateSecretAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
