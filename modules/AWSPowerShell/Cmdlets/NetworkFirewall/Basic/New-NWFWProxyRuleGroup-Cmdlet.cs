...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    public partial class NewNWFWProxyRuleGroupCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ProxyRuleGroupName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ProxyRuleGroupName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ProxyRuleGroupName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ProxyRuleGroupName;
            }
        ...
        private Amazon.NetworkFirewall.Model.CreateProxyRuleGroupResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.CreateProxyRuleGroupRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateProxyRuleGroup(request);
                #elif CORECLR
                return client.CreateProxyRuleGroupAsync(request).GetAwaiter().GetResult();
                #else
