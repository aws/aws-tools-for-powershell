...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// that's in use.
    /// </summary>
    [Cmdlet("Update", "NWFWFirewallDeleteProtection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse")]
    [AWSCmdlet("Calls the AWS Network Firewall UpdateFirewallDeleteProtection API operation.", Operation = new[] {"UpdateFirewallDeleteProtection"}, SelectReturnType = typeof(Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse))]
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse object containing multiple properties."
    )]
    public partial class UpdateNWFWFirewallDeleteProtectionCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DeleteProtection' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.DeleteProtection), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-NWFWFirewallDeleteProtection (UpdateFirewallDeleteProtection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse, UpdateNWFWFirewallDeleteProtectionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DeleteProtection;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.DeleteProtection = this.DeleteProtection;
            #if MODULAR
            if (this.DeleteProtection == null && ParameterWasBound(nameof(this.DeleteProtection)))
            {
                WriteWarning("You are passing $null as a value for parameter DeleteProtection which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionRequest();
        ...
        private Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "UpdateFirewallDeleteProtection");
            try
            {
                #if DESKTOP
                return client.UpdateFirewallDeleteProtection(request);
                #elif CORECLR
                return client.UpdateFirewallDeleteProtectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FirewallName { get; set; }
            public System.String UpdateToken { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.UpdateFirewallDeleteProtectionResponse, UpdateNWFWFirewallDeleteProtectionCmdlet, object> Select { get; set; } =
