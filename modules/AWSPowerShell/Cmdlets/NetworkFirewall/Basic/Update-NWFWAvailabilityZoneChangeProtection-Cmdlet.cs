...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "NWFWAvailabilityZoneChangeProtection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse")]
    [AWSCmdlet("Calls the AWS Network Firewall UpdateAvailabilityZoneChangeProtection API operation.", Operation = new[] {"UpdateAvailabilityZoneChangeProtection"}, SelectReturnType = typeof(Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse))]
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse object containing multiple properties."
    )]
    public partial class UpdateNWFWAvailabilityZoneChangeProtectionCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse).
        /// Specifying the name of a property of type Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse will result in that property being returned.
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AvailabilityZoneChangeProtection parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AvailabilityZoneChangeProtection' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AvailabilityZoneChangeProtection' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse, UpdateNWFWAvailabilityZoneChangeProtectionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.AvailabilityZoneChangeProtection;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.AvailabilityZoneChangeProtection = this.AvailabilityZoneChangeProtection;
            #if MODULAR
            if (this.AvailabilityZoneChangeProtection == null && ParameterWasBound(nameof(this.AvailabilityZoneChangeProtection)))
            {
                WriteWarning("You are passing $null as a value for parameter AvailabilityZoneChangeProtection which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionRequest();
        ...
        private Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "UpdateAvailabilityZoneChangeProtection");
            try
            {
                #if DESKTOP
                return client.UpdateAvailabilityZoneChangeProtection(request);
                #elif CORECLR
                return client.UpdateAvailabilityZoneChangeProtectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FirewallName { get; set; }
            public System.String UpdateToken { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.UpdateAvailabilityZoneChangeProtectionResponse, UpdateNWFWAvailabilityZoneChangeProtectionCmdlet, object> Select { get; set; } =
