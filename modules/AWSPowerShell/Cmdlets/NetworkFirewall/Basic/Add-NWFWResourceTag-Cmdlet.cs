...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "NWFWResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddNWFWResourceTagCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-NWFWResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.TagResourceResponse, AddNWFWResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.TagResourceRequest();
        ...
        private Amazon.NetworkFirewall.Model.TagResourceResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.NetworkFirewall.Model.TagResourceResponse, AddNWFWResourceTagCmdlet, object> Select { get; set; } =
