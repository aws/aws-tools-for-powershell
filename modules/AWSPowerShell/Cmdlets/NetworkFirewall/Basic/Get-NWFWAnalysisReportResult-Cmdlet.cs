...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "NWFWAnalysisReportResult")]
    [OutputType("Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse")]
    [AWSCmdlet("Calls the AWS Network Firewall GetAnalysisReportResults API operation.", Operation = new[] {"GetAnalysisReportResults"}, SelectReturnType = typeof(Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse))]
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse object containing multiple properties."
    )]
    public partial class GetNWFWAnalysisReportResultCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID of the query that ran when you requested an analysis report. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse).
        /// Specifying the name of a property of type Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse, GetNWFWAnalysisReportResultCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.GetAnalysisReportResultsRequest();
        ...
        private Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.GetAnalysisReportResultsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "GetAnalysisReportResults");
            try
            {
                #if DESKTOP
                return client.GetAnalysisReportResults(request);
                #elif CORECLR
                return client.GetAnalysisReportResultsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.GetAnalysisReportResultsResponse, GetNWFWAnalysisReportResultCmdlet, object> Select { get; set; } =
