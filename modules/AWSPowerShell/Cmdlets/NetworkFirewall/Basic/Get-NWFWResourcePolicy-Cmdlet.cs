...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    public partial class GetNWFWResourcePolicyCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.DescribeResourcePolicyResponse, GetNWFWResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.DescribeResourcePolicyRequest();
        ...
        private Amazon.NetworkFirewall.Model.DescribeResourcePolicyResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.DescribeResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "DescribeResourcePolicy");
            try
            {
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.DescribeResourcePolicyResponse, GetNWFWResourcePolicyCmdlet, object> Select { get; set; } =
