...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NWFWResourcePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveNWFWResourcePolicyCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NWFWResourcePolicy (DeleteResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.DeleteResourcePolicyResponse, RemoveNWFWResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.DeleteResourcePolicyRequest();
        ...
        private Amazon.NetworkFirewall.Model.DeleteResourcePolicyResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.DeleteResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "DeleteResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.DeleteResourcePolicyResponse, RemoveNWFWResourcePolicyCmdlet, object> Select { get; set; } =
