...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// a single call might not return the full list.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.TLSInspectionConfigurationMetadata or Amazon.NetworkFirewall.Model.ListTLSInspectionConfigurationsResponse",
        ...
        "The service call response (type Amazon.NetworkFirewall.Model.ListTLSInspectionConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNWFWTLSInspectionConfigurationListCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        private Amazon.NetworkFirewall.Model.ListTLSInspectionConfigurationsResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.ListTLSInspectionConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListTLSInspectionConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
