...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Register", "NWFWFirewallPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse")]
    [AWSCmdlet("Calls the AWS Network Firewall AssociateFirewallPolicy API operation.", Operation = new[] {"AssociateFirewallPolicy"}, SelectReturnType = typeof(Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse))]
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterNWFWFirewallPolicyCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.FirewallPolicyArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-NWFWFirewallPolicy (AssociateFirewallPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse, RegisterNWFWFirewallPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.AssociateFirewallPolicyRequest();
        ...
        private Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.AssociateFirewallPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "AssociateFirewallPolicy");
            try
            {
                #if DESKTOP
                return client.AssociateFirewallPolicy(request);
                #elif CORECLR
                return client.AssociateFirewallPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FirewallPolicyArn { get; set; }
            public System.String UpdateToken { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.AssociateFirewallPolicyResponse, RegisterNWFWFirewallPolicyCmdlet, object> Select { get; set; } =
