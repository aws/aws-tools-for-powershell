...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    public partial class UpdateNWFWProxyCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Listener properties for HTTP and HTTPS traffic to add. </para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Listener properties for HTTP and HTTPS traffic to remove. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.NetworkFirewall.Model.UpdateProxyResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.UpdateProxyRequest request)
        {
            ...
            try
            {
                return client.UpdateProxyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
