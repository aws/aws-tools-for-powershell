...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.DescribeTLSInspectionConfigurationResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.DescribeTLSInspectionConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNWFWTLSInspectionConfigurationCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TLSInspectionConfigurationArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TLSInspectionConfigurationArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TLSInspectionConfigurationArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TLSInspectionConfigurationArn;
            }
        ...
        private Amazon.NetworkFirewall.Model.DescribeTLSInspectionConfigurationResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.DescribeTLSInspectionConfigurationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeTLSInspectionConfiguration(request);
                #elif CORECLR
                return client.DescribeTLSInspectionConfigurationAsync(request).GetAwaiter().GetResult();
                #else
