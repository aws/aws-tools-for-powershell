...
namespace Amazon.PowerShell.Cmdlets.NWFW
{
    ...
    /// </summary>
    [Cmdlet("Get", "NWFWFlowOperation")]
    [OutputType("Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse")]
    [AWSCmdlet("Calls the AWS Network Firewall DescribeFlowOperation API operation.", Operation = new[] {"DescribeFlowOperation"}, SelectReturnType = typeof(Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse))]
    [AWSCmdletOutput("Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse",
        "This cmdlet returns an Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse object containing multiple properties."
    )]
    public partial class GetNWFWFlowOperationCmdlet : AmazonNetworkFirewallClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse).
        /// Specifying the name of a property of type Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse, GetNWFWFlowOperationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFirewall.Model.DescribeFlowOperationRequest();
        ...
        private Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse CallAWSServiceOperation(IAmazonNetworkFirewall client, Amazon.NetworkFirewall.Model.DescribeFlowOperationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Firewall", "DescribeFlowOperation");
            try
            {
                #if DESKTOP
                return client.DescribeFlowOperation(request);
                #elif CORECLR
                return client.DescribeFlowOperationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcEndpointAssociationArn { get; set; }
            public System.String VpcEndpointId { get; set; }
            public System.Func<Amazon.NetworkFirewall.Model.DescribeFlowOperationResponse, GetNWFWFlowOperationCmdlet, object> Select { get; set; } =
