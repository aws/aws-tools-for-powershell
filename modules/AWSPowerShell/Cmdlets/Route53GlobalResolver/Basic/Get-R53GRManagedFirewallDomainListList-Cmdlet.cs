...
namespace Amazon.PowerShell.Cmdlets.R53GR
{
    ...
    public partial class GetR53GRManagedFirewallDomainListListCmdlet : AmazonRoute53GlobalResolverClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ManagedFirewallDomainListType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ManagedFirewallDomainListType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ManagedFirewallDomainListType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ManagedFirewallDomainListType;
            }
        ...
        private Amazon.Route53GlobalResolver.Model.ListManagedFirewallDomainListsResponse CallAWSServiceOperation(IAmazonRoute53GlobalResolver client, Amazon.Route53GlobalResolver.Model.ListManagedFirewallDomainListsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListManagedFirewallDomainLists(request);
                #elif CORECLR
                return client.ListManagedFirewallDomainListsAsync(request).GetAwaiter().GetResult();
                #else
