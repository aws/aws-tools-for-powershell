...
namespace Amazon.PowerShell.Cmdlets.R53GR
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Global Resolver ListFirewallDomains API operation.", Operation = new[] {"ListFirewallDomains"}, SelectReturnType = typeof(Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53GRFirewallDomainCmdlet : AmazonRoute53GlobalResolverClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ID of the DNS Firewall domain list.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse).
        /// Specifying the name of a property of type Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse, GetR53GRFirewallDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53GlobalResolver.Model.ListFirewallDomainsRequest();
        ...
        private Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse CallAWSServiceOperation(IAmazonRoute53GlobalResolver client, Amazon.Route53GlobalResolver.Model.ListFirewallDomainsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Global Resolver", "ListFirewallDomains");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Route53GlobalResolver.Model.ListFirewallDomainsResponse, GetR53GRFirewallDomainCmdlet, object> Select { get; set; } =
