...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 ListUtteranceMetrics API operation.", Operation = new[] {"ListUtteranceMetrics"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse object containing multiple properties."
    )]
    public partial class GetLMBV2UtteranceMetricListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// return. The following attributes are possible:</para><ul><li><para><c>LastUsedIntent</c> – The last used intent at the time of the utterance.</para></li></ul><para />
        ...
        [Alias("Attributes")]
        public Amazon.LexModelsV2.Model.AnalyticsUtteranceAttribute[] Attribute { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the bot for which you want to retrieve utterance metrics.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public Amazon.LexModelsV2.Model.AnalyticsUtteranceGroupBySpecification[] GroupBy { get; set; }
        #endregion
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Metrics")]
        public Amazon.LexModelsV2.Model.AnalyticsUtteranceMetric[] Metric { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the response from the ListUtteranceMetrics operation contains more results than
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse).
        /// Specifying the name of a property of type Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse, GetLMBV2UtteranceMetricListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Attribute != null)
            {
                context.Attribute = new List<Amazon.LexModelsV2.Model.AnalyticsUtteranceAttribute>(this.Attribute);
            }
            if (this.BinBy != null)
            {
        ...
        private Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListUtteranceMetricsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "ListUtteranceMetrics");
            try
            {
                return client.ListUtteranceMetricsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.LexModelsV2.Model.AnalyticsUtteranceAttribute> Attribute { get; set; }
            ...
            public System.String NextToken { get; set; }
            public System.DateTime? StartDateTime { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.ListUtteranceMetricsResponse, GetLMBV2UtteranceMetricListCmdlet, object> Select { get; set; } =
