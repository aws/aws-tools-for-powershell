...
{
    /// <summary>
    /// Get a list of bot recommendations that meet the specified criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "LMBV2BotRecommendationList")]
    [OutputType("Amazon.LexModelsV2.Model.ListBotRecommendationsResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 ListBotRecommendations API operation.", Operation = new[] {"ListBotRecommendations"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.ListBotRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListBotRecommendationsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListBotRecommendationsResponse object containing multiple properties."
    )]
    public partial class GetLMBV2BotRecommendationListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.ListBotRecommendationsResponse, GetLMBV2BotRecommendationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelsV2.Model.ListBotRecommendationsRequest();
        ...
        private Amazon.LexModelsV2.Model.ListBotRecommendationsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBotRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "ListBotRecommendations");
            try
            {
                return client.ListBotRecommendationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.ListBotRecommendationsResponse, GetLMBV2BotRecommendationListCmdlet, object> Select { get; set; } =
