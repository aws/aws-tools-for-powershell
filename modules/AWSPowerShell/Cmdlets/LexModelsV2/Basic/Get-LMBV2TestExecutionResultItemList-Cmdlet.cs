...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.TestExecutionResultItems or Amazon.LexModelsV2.Model.ListTestExecutionResultItemsResponse",
        ...
        "The service call response (type Amazon.LexModelsV2.Model.ListTestExecutionResultItemsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2TestExecutionResultItemListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the response from the <code>ListTestExecutionResultItems</code> operation contains
        ...
        private Amazon.LexModelsV2.Model.ListTestExecutionResultItemsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListTestExecutionResultItemsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListTestExecutionResultItems(request);
                #elif CORECLR
                return client.ListTestExecutionResultItemsAsync(request).GetAwaiter().GetResult();
                #else
