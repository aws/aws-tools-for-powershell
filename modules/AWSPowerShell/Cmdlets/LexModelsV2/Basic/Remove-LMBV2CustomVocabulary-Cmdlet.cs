...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LMBV2CustomVocabulary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveLMBV2CustomVocabularyCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBV2CustomVocabulary (DeleteCustomVocabulary)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DeleteCustomVocabularyResponse, RemoveLMBV2CustomVocabularyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DeleteCustomVocabularyRequest();
        ...
        private Amazon.LexModelsV2.Model.DeleteCustomVocabularyResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DeleteCustomVocabularyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DeleteCustomVocabulary");
            try
            {
                #if DESKTOP
                return client.DeleteCustomVocabulary(request);
                #elif CORECLR
                return client.DeleteCustomVocabularyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotVersion { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DeleteCustomVocabularyResponse, RemoveLMBV2CustomVocabularyCmdlet, object> Select { get; set; } =
