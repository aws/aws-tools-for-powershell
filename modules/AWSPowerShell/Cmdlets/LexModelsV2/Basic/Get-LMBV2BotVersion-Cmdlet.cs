...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2BotVersion")]
    [OutputType("Amazon.LexModelsV2.Model.DescribeBotVersionResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DescribeBotVersion API operation.", Operation = new[] {"DescribeBotVersion"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DescribeBotVersionResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DescribeBotVersionResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DescribeBotVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2BotVersionCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeBotVersionResponse, GetLMBV2BotVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeBotVersionRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeBotVersionResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeBotVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeBotVersion");
            try
            {
                #if DESKTOP
                return client.DescribeBotVersion(request);
                #elif CORECLR
                return client.DescribeBotVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BotId { get; set; }
            public System.String BotVersion { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeBotVersionResponse, GetLMBV2BotVersionCmdlet, object> Select { get; set; } =
