...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Stop", "LMBV2BotRecommendation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.LexModelsV2.Model.StopBotRecommendationResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 StopBotRecommendation API operation.", Operation = new[] {"StopBotRecommendation"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.StopBotRecommendationResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.StopBotRecommendationResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.StopBotRecommendationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopLMBV2BotRecommendationCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-LMBV2BotRecommendation (StopBotRecommendation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.StopBotRecommendationResponse, StopLMBV2BotRecommendationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.StopBotRecommendationRequest();
        ...
        private Amazon.LexModelsV2.Model.StopBotRecommendationResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.StopBotRecommendationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "StopBotRecommendation");
            try
            {
                #if DESKTOP
                return client.StopBotRecommendation(request);
                #elif CORECLR
                return client.StopBotRecommendationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotVersion { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.StopBotRecommendationResponse, StopLMBV2BotRecommendationCmdlet, object> Select { get; set; } =
