...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2Slot")]
    [OutputType("Amazon.LexModelsV2.Model.DescribeSlotResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DescribeSlot API operation.", Operation = new[] {"DescribeSlot"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DescribeSlotResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DescribeSlotResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DescribeSlotResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2SlotCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeSlotResponse, GetLMBV2SlotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeSlotRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeSlotResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeSlotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeSlot");
            try
            {
                #if DESKTOP
                return client.DescribeSlot(request);
                #elif CORECLR
                return client.DescribeSlotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LocaleId { get; set; }
            public System.String SlotId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeSlotResponse, GetLMBV2SlotCmdlet, object> Select { get; set; } =
