...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.BuildBotLocaleResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.BuildBotLocaleResponse object containing multiple properties."
    )]
    public partial class InvokeLMBV2BuildBotLocaleCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.BuildBotLocaleRequest();
        ...
        private Amazon.LexModelsV2.Model.BuildBotLocaleResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.BuildBotLocaleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "BuildBotLocale");
            try
            {
                #if DESKTOP
                return client.BuildBotLocale(request);
                #elif CORECLR
                return client.BuildBotLocaleAsync(request).GetAwaiter().GetResult();
                #else
