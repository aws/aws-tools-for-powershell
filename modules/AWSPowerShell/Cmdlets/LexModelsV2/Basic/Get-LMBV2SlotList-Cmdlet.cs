...
{
    /// <summary>
    /// Gets a list of slots that match the specified criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "LMBV2SlotList")]
    [OutputType("Amazon.LexModelsV2.Model.ListSlotsResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 ListSlots API operation.", Operation = new[] {"ListSlots"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.ListSlotsResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListSlotsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListSlotsResponse object containing multiple properties."
    )]
    public partial class GetLMBV2SlotListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.LexModelsV2.SlotSortAttribute")]
        public Amazon.LexModelsV2.SlotSortAttribute SortBy_Attribute { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Filters")]
        public Amazon.LexModelsV2.Model.SlotFilter[] Filter { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the response from the <c>ListSlots</c> operation contains more results than specified
        /// in the <c>maxResults</c> parameter, a token is returned in the response. Use that
        /// token in the <c>nextToken</c> parameter to return the next page of results.</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.ListSlotsResponse, GetLMBV2SlotListCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.LexModelsV2.Model.SlotFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelsV2.Model.ListSlotsRequest();
            ...
            request.SortBy = new Amazon.LexModelsV2.Model.SlotSortBy();
            Amazon.LexModelsV2.SlotSortAttribute requestSortBy_sortBy_Attribute = null;
        ...
        private Amazon.LexModelsV2.Model.ListSlotsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListSlotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "ListSlots");
            try
            {
                return client.ListSlotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BotId { get; set; }
            public System.String BotVersion { get; set; }
            public List<Amazon.LexModelsV2.Model.SlotFilter> Filter { get; set; }
            public System.String IntentId { get; set; }
            public System.String LocaleId { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public Amazon.LexModelsV2.SlotSortAttribute SortBy_Attribute { get; set; }
            public Amazon.LexModelsV2.SortOrder SortBy_Order { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.ListSlotsResponse, GetLMBV2SlotListCmdlet, object> Select { get; set; } =
