...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListSlotsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListSlotsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2SlotListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListSlotsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListSlotsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListSlots(request);
                #elif CORECLR
                return client.ListSlotsAsync(request).GetAwaiter().GetResult();
                #else
