...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// use in your bot. Intents in the response are ordered by relevance.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetLMBV2RecommendedIntentListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListRecommendedIntentsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListRecommendedIntentsRequest request)
        {
            ...
            try
            {
                return client.ListRecommendedIntentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
