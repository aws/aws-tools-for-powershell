...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListBotResourceGenerationsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListBotResourceGenerationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2BotResourceGenerationListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListBotResourceGenerationsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBotResourceGenerationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListBotResourceGenerations(request);
                #elif CORECLR
                return client.ListBotResourceGenerationsAsync(request).GetAwaiter().GetResult();
                #else
