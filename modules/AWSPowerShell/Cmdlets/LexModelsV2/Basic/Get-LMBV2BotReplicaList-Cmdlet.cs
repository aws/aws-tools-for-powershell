...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2BotReplicaList")]
    ...
    public partial class GetLMBV2BotReplicaListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The request for the unique bot IDs in the list of replicated bots.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LexModelsV2.Model.ListBotReplicasResponse).
        /// Specifying the name of a property of type Amazon.LexModelsV2.Model.ListBotReplicasResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.ListBotReplicasResponse, GetLMBV2BotReplicaListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.ListBotReplicasRequest();
        ...
        private Amazon.LexModelsV2.Model.ListBotReplicasResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBotReplicasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "ListBotReplicas");
            try
            {
                #if DESKTOP
                return client.ListBotReplicas(request);
                #elif CORECLR
                return client.ListBotReplicasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String BotId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.ListBotReplicasResponse, GetLMBV2BotReplicaListCmdlet, object> Select { get; set; } =
