...
{
    /// <summary>
    /// Gets a list of locales for the specified bot.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListBotLocalesResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListBotLocalesResponse object containing multiple properties."
    )]
    public partial class GetLMBV2BotLocaleListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListBotLocalesResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBotLocalesRequest request)
        {
            ...
            try
            {
                return client.ListBotLocalesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
