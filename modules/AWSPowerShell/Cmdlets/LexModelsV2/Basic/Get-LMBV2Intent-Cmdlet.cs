...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    public partial class GetLMBV2IntentCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeIntentResponse, GetLMBV2IntentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeIntentRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeIntentResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeIntentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeIntent");
            try
            {
                #if DESKTOP
                return client.DescribeIntent(request);
                #elif CORECLR
                return client.DescribeIntentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IntentId { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeIntentResponse, GetLMBV2IntentCmdlet, object> Select { get; set; } =
