...
{
    /// <summary>
    /// Gets a list of slot types that match the specified criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetLMBV2SlotTypeListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// and only one string to filter on.</para><para />
        ...
        private Amazon.LexModelsV2.Model.ListSlotTypesResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListSlotTypesRequest request)
        {
            ...
            try
            {
                return client.ListSlotTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
