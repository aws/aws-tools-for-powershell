...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2BotLocale")]
    [OutputType("Amazon.LexModelsV2.Model.DescribeBotLocaleResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DescribeBotLocale API operation.", Operation = new[] {"DescribeBotLocale"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DescribeBotLocaleResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DescribeBotLocaleResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DescribeBotLocaleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2BotLocaleCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeBotLocaleResponse, GetLMBV2BotLocaleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeBotLocaleRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeBotLocaleResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeBotLocaleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeBotLocale");
            try
            {
                #if DESKTOP
                return client.DescribeBotLocale(request);
                #elif CORECLR
                return client.DescribeBotLocaleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotVersion { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeBotLocaleResponse, GetLMBV2BotLocaleCmdlet, object> Select { get; set; } =
