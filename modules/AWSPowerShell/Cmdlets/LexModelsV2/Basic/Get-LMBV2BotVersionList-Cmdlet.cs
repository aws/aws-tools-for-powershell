...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListBotVersionsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListBotVersionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2BotVersionListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListBotVersionsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBotVersionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListBotVersions(request);
                #elif CORECLR
                return client.ListBotVersionsAsync(request).GetAwaiter().GetResult();
                #else
