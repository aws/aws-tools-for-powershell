...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2BotRecommendation")]
    [OutputType("Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DescribeBotRecommendation API operation.", Operation = new[] {"DescribeBotRecommendation"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2BotRecommendationCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse, GetLMBV2BotRecommendationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeBotRecommendationRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeBotRecommendationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeBotRecommendation");
            try
            {
                #if DESKTOP
                return client.DescribeBotRecommendation(request);
                #elif CORECLR
                return client.DescribeBotRecommendationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotVersion { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeBotRecommendationResponse, GetLMBV2BotRecommendationCmdlet, object> Select { get; set; } =
