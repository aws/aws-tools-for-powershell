...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "LMBV2Intent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DeleteIntent API operation.", Operation = new[] {"DeleteIntent"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DeleteIntentResponse))]
    [AWSCmdletOutput("None or Amazon.LexModelsV2.Model.DeleteIntentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LexModelsV2.Model.DeleteIntentResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveLMBV2IntentCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBV2Intent (DeleteIntent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DeleteIntentResponse, RemoveLMBV2IntentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DeleteIntentRequest();
        ...
        private Amazon.LexModelsV2.Model.DeleteIntentResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DeleteIntentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DeleteIntent");
            try
            {
                return client.DeleteIntentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IntentId { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DeleteIntentResponse, RemoveLMBV2IntentCmdlet, object> Select { get; set; } =
