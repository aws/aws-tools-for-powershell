...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "LMBV2BotLocale", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.LexModelsV2.Model.DeleteBotLocaleResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DeleteBotLocale API operation.", Operation = new[] {"DeleteBotLocale"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DeleteBotLocaleResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DeleteBotLocaleResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DeleteBotLocaleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveLMBV2BotLocaleCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBV2BotLocale (DeleteBotLocale)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DeleteBotLocaleResponse, RemoveLMBV2BotLocaleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DeleteBotLocaleRequest();
        ...
        private Amazon.LexModelsV2.Model.DeleteBotLocaleResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DeleteBotLocaleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DeleteBotLocale");
            try
            {
                #if DESKTOP
                return client.DeleteBotLocale(request);
                #elif CORECLR
                return client.DeleteBotLocaleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotVersion { get; set; }
            public System.String LocaleId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DeleteBotLocaleResponse, RemoveLMBV2BotLocaleCmdlet, object> Select { get; set; } =
