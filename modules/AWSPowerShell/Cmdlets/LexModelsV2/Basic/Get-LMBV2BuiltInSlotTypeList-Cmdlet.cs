...
{
    /// <summary>
    /// Gets a list of built-in slot types that meet the specified criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "LMBV2BuiltInSlotTypeList")]
    [OutputType("Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 ListBuiltInSlotTypes API operation.", Operation = new[] {"ListBuiltInSlotTypes"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse object containing multiple properties."
    )]
    public partial class GetLMBV2BuiltInSlotTypeListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.LexModelsV2.BuiltInSlotTypeSortAttribute")]
        public Amazon.LexModelsV2.BuiltInSlotTypeSortAttribute SortBy_Attribute { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the response from the <c>ListBuiltInSlotTypes</c> operation contains more results
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse, GetLMBV2BuiltInSlotTypeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelsV2.Model.ListBuiltInSlotTypesRequest();
            ...
            request.SortBy = new Amazon.LexModelsV2.Model.BuiltInSlotTypeSortBy();
            Amazon.LexModelsV2.BuiltInSlotTypeSortAttribute requestSortBy_sortBy_Attribute = null;
        ...
        private Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListBuiltInSlotTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "ListBuiltInSlotTypes");
            try
            {
                return client.ListBuiltInSlotTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.LexModelsV2.BuiltInSlotTypeSortAttribute SortBy_Attribute { get; set; }
            public Amazon.LexModelsV2.SortOrder SortBy_Order { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.ListBuiltInSlotTypesResponse, GetLMBV2BuiltInSlotTypeListCmdlet, object> Select { get; set; } =
