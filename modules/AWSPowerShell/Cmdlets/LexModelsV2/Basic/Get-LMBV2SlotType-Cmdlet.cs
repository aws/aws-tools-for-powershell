...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBV2SlotType")]
    [OutputType("Amazon.LexModelsV2.Model.DescribeSlotTypeResponse")]
    [AWSCmdlet("Calls the Amazon Lex Model Building V2 DescribeSlotType API operation.", Operation = new[] {"DescribeSlotType"}, SelectReturnType = typeof(Amazon.LexModelsV2.Model.DescribeSlotTypeResponse))]
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.DescribeSlotTypeResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.DescribeSlotTypeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBV2SlotTypeCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DescribeSlotTypeResponse, GetLMBV2SlotTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DescribeSlotTypeRequest();
        ...
        private Amazon.LexModelsV2.Model.DescribeSlotTypeResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DescribeSlotTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DescribeSlotType");
            try
            {
                #if DESKTOP
                return client.DescribeSlotType(request);
                #elif CORECLR
                return client.DescribeSlotTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LocaleId { get; set; }
            public System.String SlotTypeId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DescribeSlotTypeResponse, GetLMBV2SlotTypeCmdlet, object> Select { get; set; } =
