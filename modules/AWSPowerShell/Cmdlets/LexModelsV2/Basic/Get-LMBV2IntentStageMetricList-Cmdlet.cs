...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.ListIntentStageMetricsResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.ListIntentStageMetricsResponse object containing multiple properties."
    )]
    public partial class GetLMBV2IntentStageMetricListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// by the following criteria:</para><ul><li><para><c>IntentStageName</c> – The name of the intent stage.</para></li><li><para><c>SwitchedToIntent</c> – The intent to which the conversation was switched (if any).</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// for the metric you want to return, and the method by which to organize the results.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.LexModelsV2.Model.ListIntentStageMetricsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListIntentStageMetricsRequest request)
        {
            ...
            try
            {
                return client.ListIntentStageMetricsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
