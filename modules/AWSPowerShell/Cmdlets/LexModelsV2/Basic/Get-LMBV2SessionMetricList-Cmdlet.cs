...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// are required:
    /// 
    ///  <ul><li><para><code>metrics</code> – A list of <a href="https://docs.aws.amazon.com/lexv2/latest/APIReference/API_AnalyticsSessionMetric.html">AnalyticsSessionMetric</a>
    ...
    public partial class GetLMBV2SessionMetricListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// by the following criteria:</para><ul><li><para><code>ConversationEndState</code> – The final state of the conversation. The possible
        /// end states are detailed in <a href="https://docs.aws.amazon.com/analytics-key-definitions-conversations">Key
        /// definitions</a> in the user guide.</para></li><li><para><code>LocaleId</code> – The unique identifier of the bot locale.</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
