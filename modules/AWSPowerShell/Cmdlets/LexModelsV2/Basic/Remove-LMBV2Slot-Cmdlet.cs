...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LMBV2Slot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLMBV2SlotCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBV2Slot (DeleteSlot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelsV2.Model.DeleteSlotResponse, RemoveLMBV2SlotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelsV2.Model.DeleteSlotRequest();
        ...
        private Amazon.LexModelsV2.Model.DeleteSlotResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.DeleteSlotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building V2", "DeleteSlot");
            try
            {
                #if DESKTOP
                return client.DeleteSlot(request);
                #elif CORECLR
                return client.DeleteSlotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LocaleId { get; set; }
            public System.String SlotId { get; set; }
            public System.Func<Amazon.LexModelsV2.Model.DeleteSlotResponse, RemoveLMBV2SlotCmdlet, object> Select { get; set; } =
