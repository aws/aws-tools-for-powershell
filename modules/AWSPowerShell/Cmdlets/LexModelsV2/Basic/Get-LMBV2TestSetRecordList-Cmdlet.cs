...
{
    /// <summary>
    /// The list of test set records.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetLMBV2TestSetRecordListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListTestSetRecordsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListTestSetRecordsRequest request)
        {
            ...
            try
            {
                return client.ListTestSetRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
