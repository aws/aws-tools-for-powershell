...
{
    /// <summary>
    /// The list of the test sets<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetLMBV2TestSetListCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelsV2.Model.ListTestSetsResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.ListTestSetsRequest request)
        {
            ...
            try
            {
                return client.ListTestSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
