...
namespace Amazon.PowerShell.Cmdlets.LMBV2
{
    ...
    [AWSCmdletOutput("Amazon.LexModelsV2.Model.CreateResourcePolicyStatementResponse",
        "This cmdlet returns an Amazon.LexModelsV2.Model.CreateResourcePolicyStatementResponse object containing multiple properties."
    )]
    public partial class NewLMBV2ResourcePolicyStatementCmdlet : AmazonLexModelsV2ClientCmdlet, IExecutor
    {
        ...
        /// Actions, resources, and condition keys for Amazon Lex V2</a>.</para><para />
        ...
        /// JSON policy elements: Condition </a>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Web Services JSON policy elements: Principal</a>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.LexModelsV2.Model.CreateResourcePolicyStatementResponse CallAWSServiceOperation(IAmazonLexModelsV2 client, Amazon.LexModelsV2.Model.CreateResourcePolicyStatementRequest request)
        {
            ...
            try
            {
                return client.CreateResourcePolicyStatementAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
