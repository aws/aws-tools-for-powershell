...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB ResetDBClusterParameterGroup API operation.", Operation = new[] {"ResetDBClusterParameterGroup"})]
    ...
    public partial class ResetDOCDBClusterParameterGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "ResetDBClusterParameterGroup");
            try
            {
                #if DESKTOP
