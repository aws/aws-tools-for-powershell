...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeOrderableDBInstanceOptions API operation.", Operation = new[] {"DescribeOrderableDBInstanceOptions"})]
    [AWSCmdletOutput("Amazon.DocDB.Model.OrderableDBInstanceOption",
    ...
    public partial class GetDOCOrderableDBInstanceOptionCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeOrderableDBInstanceOptions");
            try
            {
                #if DESKTOP
