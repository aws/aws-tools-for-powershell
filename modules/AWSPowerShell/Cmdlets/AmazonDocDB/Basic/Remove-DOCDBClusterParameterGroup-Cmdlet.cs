...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DeleteDBClusterParameterGroup API operation.", Operation = new[] {"DeleteDBClusterParameterGroup"})]
    ...
    public partial class RemoveDOCDBClusterParameterGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DeleteDBClusterParameterGroup");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteDBClusterParameterGroupAsync(request);
                return task.Result;
                #else
