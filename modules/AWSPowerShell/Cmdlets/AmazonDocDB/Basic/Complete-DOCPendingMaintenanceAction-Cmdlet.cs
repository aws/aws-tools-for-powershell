...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB ApplyPendingMaintenanceAction API operation.", Operation = new[] {"ApplyPendingMaintenanceAction"})]
    ...
    public partial class CompleteDOCPendingMaintenanceActionCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "ApplyPendingMaintenanceAction");
            try
            {
                #if DESKTOP
