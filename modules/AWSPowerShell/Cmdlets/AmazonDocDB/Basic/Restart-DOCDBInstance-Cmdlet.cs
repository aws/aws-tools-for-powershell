...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB RebootDBInstance API operation.", Operation = new[] {"RebootDBInstance"})]
    ...
    public partial class RestartDOCDBInstanceCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "RebootDBInstance");
            try
            {
                #if DESKTOP
