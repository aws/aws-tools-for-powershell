...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeDBSubnetGroups API operation.", Operation = new[] {"DescribeDBSubnetGroups"})]
    ...
    public partial class GetDOCDBSubnetGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeDBSubnetGroups");
            try
            {
                #if DESKTOP
