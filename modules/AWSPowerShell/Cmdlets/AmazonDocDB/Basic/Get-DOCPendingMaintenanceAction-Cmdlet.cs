...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribePendingMaintenanceActions API operation.", Operation = new[] {"DescribePendingMaintenanceActions"})]
    [AWSCmdletOutput("Amazon.DocDB.Model.ResourcePendingMaintenanceActions",
    ...
    public partial class GetDOCPendingMaintenanceActionCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribePendingMaintenanceActions");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribePendingMaintenanceActionsAsync(request);
                return task.Result;
                #else
