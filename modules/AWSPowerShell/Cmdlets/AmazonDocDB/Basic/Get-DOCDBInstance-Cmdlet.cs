...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    /// </summary>
    [Cmdlet("Get", "DOCDBInstance")]
    [OutputType("Amazon.DocDB.Model.DBInstance")]
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeDBInstances API operation.", Operation = new[] {"DescribeDBInstances"})]
    [AWSCmdletOutput("Amazon.DocDB.Model.DBInstance",
        "This cmdlet returns a collection of DBInstance objects.",
        "The service call response (type Amazon.DocDB.Model.DescribeDBInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetDOCDBInstanceCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DocDB.Model.DescribeDBInstancesRequest();
        ...
        private Amazon.DocDB.Model.DescribeDBInstancesResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.DescribeDBInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeDBInstances");
            try
            {
                #if DESKTOP
