...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeDBClusterParameters API operation.", Operation = new[] {"DescribeDBClusterParameters"})]
    [AWSCmdletOutput("Amazon.DocDB.Model.Parameter",
        "This cmdlet returns a collection of Parameter objects.",
        "The service call response (type Amazon.DocDB.Model.DescribeDBClusterParametersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetDOCDBClusterParameterCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DocDB.Model.DescribeDBClusterParametersRequest();
        ...
        private Amazon.DocDB.Model.DescribeDBClusterParametersResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.DescribeDBClusterParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeDBClusterParameters");
            try
            {
                #if DESKTOP
                return client.DescribeDBClusterParameters(request);
                #elif CORECLR
                return client.DescribeDBClusterParametersAsync(request).GetAwaiter().GetResult();
                #else
