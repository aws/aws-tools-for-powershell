...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB CreateDBSubnetGroup API operation.", Operation = new[] {"CreateDBSubnetGroup"})]
    ...
    public partial class NewDOCDBSubnetGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "CreateDBSubnetGroup");
            try
            {
                #if DESKTOP
