...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB ModifyDBClusterParameterGroup API operation.", Operation = new[] {"ModifyDBClusterParameterGroup"})]
    ...
    public partial class EditDOCDBClusterParameterGroupCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Parameters = new List<Amazon.DocDB.Model.Parameter>(this.Parameter);
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "ModifyDBClusterParameterGroup");
            try
            {
                #if DESKTOP
                ...
                var task = client.ModifyDBClusterParameterGroupAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.String DBClusterParameterGroupName { get; set; }
            public List<Amazon.DocDB.Model.Parameter> Parameters { get; set; }
        }
