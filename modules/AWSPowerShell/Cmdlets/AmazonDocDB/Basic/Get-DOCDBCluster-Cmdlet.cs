...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeDBClusters API operation.", Operation = new[] {"DescribeDBClusters"})]
    ...
    public partial class GetDOCDBClusterCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeDBClusters");
            try
            {
                #if DESKTOP
