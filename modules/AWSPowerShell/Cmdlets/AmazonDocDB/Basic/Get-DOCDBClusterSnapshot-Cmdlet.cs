...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeDBClusterSnapshots API operation.", Operation = new[] {"DescribeDBClusterSnapshots"})]
    ...
    public partial class GetDOCDBClusterSnapshotCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeDBClusterSnapshots");
            try
            {
                #if DESKTOP
