...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DescribeEvents API operation.", Operation = new[] {"DescribeEvents"})]
    [AWSCmdletOutput("Amazon.DocDB.Model.Event",
    ...
    public partial class GetDOCEventCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DescribeEvents");
            try
            {
                #if DESKTOP
