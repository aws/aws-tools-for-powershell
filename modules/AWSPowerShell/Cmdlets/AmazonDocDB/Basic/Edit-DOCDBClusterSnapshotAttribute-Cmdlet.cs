...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB ModifyDBClusterSnapshotAttribute API operation.", Operation = new[] {"ModifyDBClusterSnapshotAttribute"})]
    ...
    public partial class EditDOCDBClusterSnapshotAttributeCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "ModifyDBClusterSnapshotAttribute");
            try
            {
                #if DESKTOP
