...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB DeleteDBClusterSnapshot API operation.", Operation = new[] {"DeleteDBClusterSnapshot"})]
    ...
    public partial class RemoveDOCDBClusterSnapshotCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "DeleteDBClusterSnapshot");
            try
            {
                #if DESKTOP
