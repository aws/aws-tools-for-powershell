...
namespace Amazon.PowerShell.Cmdlets.DOC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DOCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon DocumentDB RemoveTagsFromResource API operation.", Operation = new[] {"RemoveTagsFromResource"})]
    ...
    public partial class RemoveDOCResourceTagCmdlet : AmazonDocDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DOCResourceTag (RemoveTagsFromResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DocDB.Model.RemoveTagsFromResourceRequest();
        ...
        private Amazon.DocDB.Model.RemoveTagsFromResourceResponse CallAWSServiceOperation(IAmazonDocDB client, Amazon.DocDB.Model.RemoveTagsFromResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB", "RemoveTagsFromResource");
            try
            {
                #if DESKTOP
