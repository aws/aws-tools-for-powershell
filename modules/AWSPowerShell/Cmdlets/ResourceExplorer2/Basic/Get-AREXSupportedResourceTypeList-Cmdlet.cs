...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    /// Resource Explorer.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAREXSupportedResourceTypeListCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ResourceExplorer2.Model.ListSupportedResourceTypesResponse CallAWSServiceOperation(IAmazonResourceExplorer2 client, Amazon.ResourceExplorer2.Model.ListSupportedResourceTypesRequest request)
        {
            ...
            try
            {
                return client.ListSupportedResourceTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
