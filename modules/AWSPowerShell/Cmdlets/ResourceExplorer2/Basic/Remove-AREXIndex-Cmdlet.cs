...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    public partial class RemoveAREXIndexCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AREXIndex (DeleteIndex)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceExplorer2.Model.DeleteIndexResponse, RemoveAREXIndexCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceExplorer2.Model.DeleteIndexRequest();
        ...
        private Amazon.ResourceExplorer2.Model.DeleteIndexResponse CallAWSServiceOperation(IAmazonResourceExplorer2 client, Amazon.ResourceExplorer2.Model.DeleteIndexRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Explorer", "DeleteIndex");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.ResourceExplorer2.Model.DeleteIndexResponse, RemoveAREXIndexCmdlet, object> Select { get; set; } =
