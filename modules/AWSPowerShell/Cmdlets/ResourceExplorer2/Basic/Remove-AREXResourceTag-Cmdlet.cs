...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    /// view or index.
    /// </summary>
    [Cmdlet("Remove", "AREXResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAREXResourceTagCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AREXResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceExplorer2.Model.UntagResourceResponse, RemoveAREXResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceExplorer2.Model.UntagResourceRequest();
        ...
        private Amazon.ResourceExplorer2.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonResourceExplorer2 client, Amazon.ResourceExplorer2.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Explorer", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ResourceExplorer2.Model.UntagResourceResponse, RemoveAREXResourceTagCmdlet, object> Select { get; set; } =
