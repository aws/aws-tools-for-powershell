...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    /// view or index.
    /// </summary>
    [Cmdlet("Add", "AREXResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddAREXResourceTagCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-AREXResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceExplorer2.Model.TagResourceResponse, AddAREXResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceExplorer2.Model.TagResourceRequest();
        ...
        private Amazon.ResourceExplorer2.Model.TagResourceResponse CallAWSServiceOperation(IAmazonResourceExplorer2 client, Amazon.ResourceExplorer2.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Explorer", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ResourceExplorer2.Model.TagResourceResponse, AddAREXResourceTagCmdlet, object> Select { get; set; } =
