...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "AREXView", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Resource Explorer DeleteView API operation.", Operation = new[] {"DeleteView"}, SelectReturnType = typeof(Amazon.ResourceExplorer2.Model.DeleteViewResponse))]
    [AWSCmdletOutput("System.String or Amazon.ResourceExplorer2.Model.DeleteViewResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ResourceExplorer2.Model.DeleteViewResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAREXViewCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AREXView (DeleteView)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResourceExplorer2.Model.DeleteViewResponse, RemoveAREXViewCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResourceExplorer2.Model.DeleteViewRequest();
        ...
        private Amazon.ResourceExplorer2.Model.DeleteViewResponse CallAWSServiceOperation(IAmazonResourceExplorer2 client, Amazon.ResourceExplorer2.Model.DeleteViewRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Explorer", "DeleteView");
            try
            {
                #if DESKTOP
                return client.DeleteView(request);
                #elif CORECLR
                return client.DeleteViewAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ViewArn { get; set; }
            public System.Func<Amazon.ResourceExplorer2.Model.DeleteViewResponse, RemoveAREXViewCmdlet, object> Select { get; set; } =
