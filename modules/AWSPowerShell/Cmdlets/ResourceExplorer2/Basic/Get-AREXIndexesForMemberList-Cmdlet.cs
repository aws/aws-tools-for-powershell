...
namespace Amazon.PowerShell.Cmdlets.AREX
{
    ...
    /// can invoke this API call.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAREXIndexesForMemberListCmdlet : AmazonResourceExplorer2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The account IDs will limit the output to only indexes from these accounts.</para><para />
