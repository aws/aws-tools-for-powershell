...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.UpdateFlowResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.UpdateFlowResponse object containing multiple properties."
    )]
    public partial class UpdateAABFlowCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of connection definitions in the flow.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>An array of node definitions in the flow.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.BedrockAgent.Model.UpdateFlowResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.UpdateFlowRequest request)
        {
            ...
            try
            {
                return client.UpdateFlowAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
