...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// Guide.
    /// </summary>
    [Cmdlet("Remove", "AABPrompt", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.BedrockAgent.Model.DeletePromptResponse")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock DeletePrompt API operation.", Operation = new[] {"DeletePrompt"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.DeletePromptResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.DeletePromptResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.DeletePromptResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAABPromptCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The version of the prompt to delete.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABPrompt (DeletePrompt)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeletePromptResponse, RemoveAABPromptCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeletePromptRequest();
        ...
        private Amazon.BedrockAgent.Model.DeletePromptResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeletePromptRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PromptIdentifier { get; set; }
            public System.String PromptVersion { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeletePromptResponse, RemoveAABPromptCmdlet, object> Select { get; set; } =
