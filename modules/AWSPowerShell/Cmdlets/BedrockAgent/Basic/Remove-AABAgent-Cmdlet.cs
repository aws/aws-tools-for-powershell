...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AABAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.BedrockAgent.Model.DeleteAgentResponse")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock DeleteAgent API operation.", Operation = new[] {"DeleteAgent"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.DeleteAgentResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.DeleteAgentResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.DeleteAgentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAABAgentCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABAgent (DeleteAgent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeleteAgentResponse, RemoveAABAgentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeleteAgentRequest();
        ...
        private Amazon.BedrockAgent.Model.DeleteAgentResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeleteAgentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "DeleteAgent");
            try
            {
                #if DESKTOP
                return client.DeleteAgent(request);
                #elif CORECLR
                return client.DeleteAgentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AgentId { get; set; }
            public System.Boolean? SkipResourceInUseCheck { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeleteAgentResponse, RemoveAABAgentCmdlet, object> Select { get; set; } =
