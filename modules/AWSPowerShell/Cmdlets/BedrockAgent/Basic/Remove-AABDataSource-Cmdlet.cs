...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AABDataSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.BedrockAgent.Model.DeleteDataSourceResponse")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock DeleteDataSource API operation.", Operation = new[] {"DeleteDataSource"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.DeleteDataSourceResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.DeleteDataSourceResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.DeleteDataSourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAABDataSourceCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABDataSource (DeleteDataSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeleteDataSourceResponse, RemoveAABDataSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeleteDataSourceRequest();
        ...
        private Amazon.BedrockAgent.Model.DeleteDataSourceResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeleteDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "DeleteDataSource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DataSourceId { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeleteDataSourceResponse, RemoveAABDataSourceCmdlet, object> Select { get; set; } =
