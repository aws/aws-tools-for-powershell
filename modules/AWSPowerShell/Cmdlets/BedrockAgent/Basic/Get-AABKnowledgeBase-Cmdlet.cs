...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    public partial class GetAABKnowledgeBaseCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.GetKnowledgeBaseResponse, GetAABKnowledgeBaseCmdlet>(Select) ??
        ...
        private Amazon.BedrockAgent.Model.GetKnowledgeBaseResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.GetKnowledgeBaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "GetKnowledgeBase");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.GetKnowledgeBaseResponse, GetAABKnowledgeBaseCmdlet, object> Select { get; set; } =
