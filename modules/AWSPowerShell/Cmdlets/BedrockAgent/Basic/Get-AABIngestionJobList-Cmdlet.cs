...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// about each job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAABIngestionJobListCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.BedrockAgent.IngestionJobSortByAttribute")]
        public Amazon.BedrockAgent.IngestionJobSortByAttribute SortBy_Attribute { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>Contains information about the filters for filtering the data.</para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Filters")]
        public Amazon.BedrockAgent.Model.IngestionJobFilter[] Filter { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.BedrockAgent.SortOrder")]
        public Amazon.BedrockAgent.SortOrder SortBy_Order { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IngestionJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.ListIngestionJobsResponse, GetAABIngestionJobListCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.BedrockAgent.Model.IngestionJobFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BedrockAgent.Model.ListIngestionJobsRequest();
            ...
            request.SortBy = new Amazon.BedrockAgent.Model.IngestionJobSortBy();
            Amazon.BedrockAgent.IngestionJobSortByAttribute requestSortBy_sortBy_Attribute = null;
            ...
            Amazon.BedrockAgent.SortOrder requestSortBy_sortBy_Order = null;
        ...
        private Amazon.BedrockAgent.Model.ListIngestionJobsResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.ListIngestionJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "ListIngestionJobs");
            try
            {
                return client.ListIngestionJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DataSourceId { get; set; }
            public List<Amazon.BedrockAgent.Model.IngestionJobFilter> Filter { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public Amazon.BedrockAgent.IngestionJobSortByAttribute SortBy_Attribute { get; set; }
            public Amazon.BedrockAgent.SortOrder SortBy_Order { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.ListIngestionJobsResponse, GetAABIngestionJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IngestionJobSummaries;
        }
