...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// </summary>
    [Cmdlet("Update", "AABAgentCollaborator", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgent.Model.AgentCollaborator")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock UpdateAgentCollaborator API operation.", Operation = new[] {"UpdateAgentCollaborator"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.AgentCollaborator or Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.AgentCollaborator object.",
        "The service call response (type Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateAABAgentCollaboratorCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The collaborator's name.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AABAgentCollaborator (UpdateAgentCollaborator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse, UpdateAABAgentCollaboratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.UpdateAgentCollaboratorRequest();
        ...
        private Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.UpdateAgentCollaboratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "UpdateAgentCollaborator");
            try
            {
                #if DESKTOP
                return client.UpdateAgentCollaborator(request);
                #elif CORECLR
                return client.UpdateAgentCollaboratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String CollaboratorName { get; set; }
            public Amazon.BedrockAgent.RelayConversationHistory RelayConversationHistory { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.UpdateAgentCollaboratorResponse, UpdateAABAgentCollaboratorCmdlet, object> Select { get; set; } =
