...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    public partial class RemoveAABKnowledgeBaseCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABKnowledgeBase (DeleteKnowledgeBase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeleteKnowledgeBaseResponse, RemoveAABKnowledgeBaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeleteKnowledgeBaseRequest();
        ...
        private Amazon.BedrockAgent.Model.DeleteKnowledgeBaseResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeleteKnowledgeBaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "DeleteKnowledgeBase");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeleteKnowledgeBaseResponse, RemoveAABKnowledgeBaseCmdlet, object> Select { get; set; } =
