...
{
    /// <summary>
    /// Lists the aliases of an agent and information about each one.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.AgentAliasSummary or Amazon.BedrockAgent.Model.ListAgentAliasesResponse",
        ...
        "The service call response (type Amazon.BedrockAgent.Model.ListAgentAliasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAABAgentAliasListCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        private Amazon.BedrockAgent.Model.ListAgentAliasesResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.ListAgentAliasesRequest request)
        {
            ...
            try
            {
                return client.ListAgentAliasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
