...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    [AWSCmdlet("Calls the Agents for Amazon Bedrock GetAgentVersion API operation.", Operation = new[] {"GetAgentVersion"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.GetAgentVersionResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.AgentVersion or Amazon.BedrockAgent.Model.GetAgentVersionResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.AgentVersion object.",
        "The service call response (type Amazon.BedrockAgent.Model.GetAgentVersionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAABAgentVersionCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AgentVersion";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.GetAgentVersionResponse, GetAABAgentVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.GetAgentVersionRequest();
        ...
        private Amazon.BedrockAgent.Model.GetAgentVersionResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.GetAgentVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "GetAgentVersion");
            try
            {
                #if DESKTOP
                return client.GetAgentVersion(request);
                #elif CORECLR
                return client.GetAgentVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AgentId { get; set; }
            public System.String AgentVersion { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.GetAgentVersionResponse, GetAABAgentVersionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AgentVersion;
        }
