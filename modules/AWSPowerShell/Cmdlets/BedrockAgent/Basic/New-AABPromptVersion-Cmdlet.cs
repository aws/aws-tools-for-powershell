...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// Guide.
    /// </summary>
    [Cmdlet("New", "AABPromptVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.BedrockAgent.Model.CreatePromptVersionResponse")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock CreatePromptVersion API operation.", Operation = new[] {"CreatePromptVersion"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.CreatePromptVersionResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.CreatePromptVersionResponse",
        "This cmdlet returns an Amazon.BedrockAgent.Model.CreatePromptVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewAABPromptVersionCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-AABPromptVersion (CreatePromptVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.CreatePromptVersionResponse, NewAABPromptVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.CreatePromptVersionRequest();
        ...
        private Amazon.BedrockAgent.Model.CreatePromptVersionResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.CreatePromptVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "CreatePromptVersion");
            try
            {
                #if DESKTOP
                return client.CreatePromptVersion(request);
                #elif CORECLR
                return client.CreatePromptVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BedrockAgent.Model.CreatePromptVersionResponse, NewAABPromptVersionCmdlet, object> Select { get; set; } =
