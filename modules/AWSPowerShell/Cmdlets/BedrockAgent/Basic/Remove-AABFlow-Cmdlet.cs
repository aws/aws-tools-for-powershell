...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    /// Deletes a flow.
    /// </summary>
    [Cmdlet("Remove", "AABFlow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock DeleteFlow API operation.", Operation = new[] {"DeleteFlow"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.DeleteFlowResponse))]
    [AWSCmdletOutput("System.String or Amazon.BedrockAgent.Model.DeleteFlowResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BedrockAgent.Model.DeleteFlowResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAABFlowCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABFlow (DeleteFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeleteFlowResponse, RemoveAABFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeleteFlowRequest();
        ...
        private Amazon.BedrockAgent.Model.DeleteFlowResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeleteFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "DeleteFlow");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FlowIdentifier { get; set; }
            public System.Boolean? SkipResourceInUseCheck { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeleteFlowResponse, RemoveAABFlowCmdlet, object> Select { get; set; } =
