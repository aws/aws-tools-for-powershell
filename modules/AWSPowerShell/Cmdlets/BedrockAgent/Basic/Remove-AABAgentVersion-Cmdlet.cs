...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    public partial class RemoveAABAgentVersionCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AABAgentVersion (DeleteAgentVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.DeleteAgentVersionResponse, RemoveAABAgentVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.DeleteAgentVersionRequest();
        ...
        private Amazon.BedrockAgent.Model.DeleteAgentVersionResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.DeleteAgentVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "DeleteAgentVersion");
            try
            {
                #if DESKTOP
                return client.DeleteAgentVersion(request);
                #elif CORECLR
                return client.DeleteAgentVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AgentVersion { get; set; }
            public System.Boolean? SkipResourceInUseCheck { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.DeleteAgentVersionResponse, RemoveAABAgentVersionCmdlet, object> Select { get; set; } =
