...
{
    /// <summary>
    /// Lists knowledge bases associated with an agent and information about each one.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AABAgentKnowledgeBasisList")]
    [OutputType("Amazon.BedrockAgent.Model.AgentKnowledgeBaseSummary")]
    [AWSCmdlet("Calls the Agents for Amazon Bedrock ListAgentKnowledgeBases API operation.", Operation = new[] {"ListAgentKnowledgeBases"}, SelectReturnType = typeof(Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse))]
    [AWSCmdletOutput("Amazon.BedrockAgent.Model.AgentKnowledgeBaseSummary or Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse",
        "This cmdlet returns a collection of Amazon.BedrockAgent.Model.AgentKnowledgeBaseSummary objects.",
        "The service call response (type Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAABAgentKnowledgeBasisListCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AgentKnowledgeBaseSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse, GetAABAgentKnowledgeBasisListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesRequest();
        ...
        private Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "ListAgentKnowledgeBases");
            try
            {
                return client.ListAgentKnowledgeBasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.ListAgentKnowledgeBasesResponse, GetAABAgentKnowledgeBasisListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AgentKnowledgeBaseSummaries;
        }
