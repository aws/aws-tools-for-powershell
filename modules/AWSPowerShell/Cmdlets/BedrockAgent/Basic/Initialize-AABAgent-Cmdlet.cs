...
namespace Amazon.PowerShell.Cmdlets.AAB
{
    ...
    public partial class InitializeAABAgentCmdlet : AmazonBedrockAgentClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Initialize-AABAgent (PrepareAgent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgent.Model.PrepareAgentResponse, InitializeAABAgentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgent.Model.PrepareAgentRequest();
        ...
        private Amazon.BedrockAgent.Model.PrepareAgentResponse CallAWSServiceOperation(IAmazonBedrockAgent client, Amazon.BedrockAgent.Model.PrepareAgentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Agents for Amazon Bedrock", "PrepareAgent");
            try
            {
                #if DESKTOP
                return client.PrepareAgent(request);
                #elif CORECLR
                return client.PrepareAgentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AgentId { get; set; }
            public System.Func<Amazon.BedrockAgent.Model.PrepareAgentResponse, InitializeAABAgentCmdlet, object> Select { get; set; } =
