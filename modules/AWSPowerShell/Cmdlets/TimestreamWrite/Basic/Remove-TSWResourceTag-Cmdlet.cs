...
namespace Amazon.PowerShell.Cmdlets.TSW
{
    ...
    [AWSCmdletOutput("None or Amazon.TimestreamWrite.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.TimestreamWrite.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
