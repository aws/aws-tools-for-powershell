...
namespace Amazon.PowerShell.Cmdlets.TSW
{
    ...
    [AWSCmdlet("Calls the Amazon Timestream Write CreateDatabase API operation.", Operation = new[] {"CreateDatabase"}, SelectReturnType = typeof(Amazon.TimestreamWrite.Model.CreateDatabaseResponse))]
    [AWSCmdletOutput("Amazon.TimestreamWrite.Model.Database or Amazon.TimestreamWrite.Model.CreateDatabaseResponse",
        "This cmdlet returns an Amazon.TimestreamWrite.Model.Database object.",
        "The service call response (type Amazon.TimestreamWrite.Model.CreateDatabaseResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewTSWDatabaseCmdlet : AmazonTimestreamWriteClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-TSWDatabase (CreateDatabase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TimestreamWrite.Model.CreateDatabaseResponse, NewTSWDatabaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TimestreamWrite.Model.CreateDatabaseRequest();
        ...
        private Amazon.TimestreamWrite.Model.CreateDatabaseResponse CallAWSServiceOperation(IAmazonTimestreamWrite client, Amazon.TimestreamWrite.Model.CreateDatabaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Timestream Write", "CreateDatabase");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.TimestreamWrite.Model.CreateDatabaseResponse, NewTSWDatabaseCmdlet, object> Select { get; set; } =
