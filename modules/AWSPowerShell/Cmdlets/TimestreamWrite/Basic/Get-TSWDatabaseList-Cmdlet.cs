...
namespace Amazon.PowerShell.Cmdlets.TSW
{
    ...
    /// </summary>
    [Cmdlet("Get", "TSWDatabaseList")]
    [OutputType("Amazon.TimestreamWrite.Model.Database")]
    [AWSCmdlet("Calls the Amazon Timestream Write ListDatabases API operation.", Operation = new[] {"ListDatabases"}, SelectReturnType = typeof(Amazon.TimestreamWrite.Model.ListDatabasesResponse))]
    [AWSCmdletOutput("Amazon.TimestreamWrite.Model.Database or Amazon.TimestreamWrite.Model.ListDatabasesResponse",
        "This cmdlet returns a collection of Amazon.TimestreamWrite.Model.Database objects.",
        "The service call response (type Amazon.TimestreamWrite.Model.ListDatabasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetTSWDatabaseListCmdlet : AmazonTimestreamWriteClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TimestreamWrite.Model.ListDatabasesResponse, GetTSWDatabaseListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.TimestreamWrite.Model.ListDatabasesRequest();
        ...
        private Amazon.TimestreamWrite.Model.ListDatabasesResponse CallAWSServiceOperation(IAmazonTimestreamWrite client, Amazon.TimestreamWrite.Model.ListDatabasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Timestream Write", "ListDatabases");
            try
            {
                return client.ListDatabasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.TimestreamWrite.Model.ListDatabasesResponse, GetTSWDatabaseListCmdlet, object> Select { get; set; } =
