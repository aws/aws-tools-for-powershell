...
namespace Amazon.PowerShell.Cmdlets.TSW
{
    ...
    [AWSCmdletOutput("Amazon.TimestreamWrite.Model.Database or Amazon.TimestreamWrite.Model.ListDatabasesResponse",
        ...
        "The service call response (type Amazon.TimestreamWrite.Model.ListDatabasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
