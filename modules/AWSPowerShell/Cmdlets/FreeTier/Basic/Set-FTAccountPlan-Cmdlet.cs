...
namespace Amazon.PowerShell.Cmdlets.FT
{
    ...
    public partial class SetFTAccountPlanCmdlet : AmazonFreeTierClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AccountPlanType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AccountPlanType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AccountPlanType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AccountPlanType;
            }
        ...
        private Amazon.FreeTier.Model.UpgradeAccountPlanResponse CallAWSServiceOperation(IAmazonFreeTier client, Amazon.FreeTier.Model.UpgradeAccountPlanRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpgradeAccountPlan(request);
                #elif CORECLR
                return client.UpgradeAccountPlanAsync(request).GetAwaiter().GetResult();
                #else
