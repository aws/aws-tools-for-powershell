...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Invokes the CreateTags operation against Amazon WorkSpaces.", Operation = new[] {"CreateTags"})]
    ...
    public class NewWKSTagCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
