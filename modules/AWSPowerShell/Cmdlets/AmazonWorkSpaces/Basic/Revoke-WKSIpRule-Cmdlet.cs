...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdlet("Calls the Amazon WorkSpaces RevokeIpRules API operation.", Operation = new[] {"RevokeIpRules"})]
    ...
    public partial class RevokeWKSIpRuleCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.UserRules = new List<System.String>(this.UserRule);
            }
        ...
        private Amazon.WorkSpaces.Model.RevokeIpRulesResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.RevokeIpRulesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.RevokeIpRulesAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.String GroupId { get; set; }
            public List<System.String> UserRules { get; set; }
        }
