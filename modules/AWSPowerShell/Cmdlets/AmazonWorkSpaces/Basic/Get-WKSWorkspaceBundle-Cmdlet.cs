...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdlet("Calls the Amazon WorkSpaces DescribeWorkspaceBundles API operation.", Operation = new[] {"DescribeWorkspaceBundles"}, LegacyAlias="Get-WKSWorkspaceBundles")]
