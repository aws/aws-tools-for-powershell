...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </summary>
    [Cmdlet("Register", "WKSIpGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon WorkSpaces AssociateIpGroups API operation.", Operation = new[] {"AssociateIpGroups"})]
    ...
    public partial class RegisterWKSIpGroupCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-WKSIpGroup (AssociateIpGroups)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.AssociateIpGroupsRequest();
        ...
        private Amazon.WorkSpaces.Model.AssociateIpGroupsResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.AssociateIpGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "AssociateIpGroups");
            try
            {
                #if DESKTOP
                return client.AssociateIpGroups(request);
                #elif CORECLR
                return client.AssociateIpGroupsAsync(request).GetAwaiter().GetResult();
                #else
