...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Athena.Model.ListNamedQueriesResponse",
        ...
        "The service call response (type Amazon.Athena.Model.ListNamedQueriesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetATHNamedQueryListCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.NamedQueryIds?.Count ?? 0;
        ...
        private Amazon.Athena.Model.ListNamedQueriesResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.ListNamedQueriesRequest request)
        {
            ...
            try
            {
                return client.ListNamedQueriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
