...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ATHPreparedStatement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveATHPreparedStatementCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StatementName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ATHPreparedStatement (DeletePreparedStatement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.DeletePreparedStatementResponse, RemoveATHPreparedStatementCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.StatementName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.DeletePreparedStatementRequest();
        ...
        private Amazon.Athena.Model.DeletePreparedStatementResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.DeletePreparedStatementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "DeletePreparedStatement");
            try
            {
                #if DESKTOP
                return client.DeletePreparedStatement(request);
                #elif CORECLR
                return client.DeletePreparedStatementAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String StatementName { get; set; }
            public System.String WorkGroup { get; set; }
            public System.Func<Amazon.Athena.Model.DeletePreparedStatementResponse, RemoveATHPreparedStatementCmdlet, object> Select { get; set; } =
