...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Get", "ATHPreparedStatement")]
    [OutputType("Amazon.Athena.Model.PreparedStatement")]
    ...
    public partial class GetATHPreparedStatementCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PreparedStatement";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.GetPreparedStatementResponse, GetATHPreparedStatementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.GetPreparedStatementRequest();
        ...
        private Amazon.Athena.Model.GetPreparedStatementResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetPreparedStatementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "GetPreparedStatement");
            try
            {
                #if DESKTOP
                return client.GetPreparedStatement(request);
                #elif CORECLR
                return client.GetPreparedStatementAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String StatementName { get; set; }
            public System.String WorkGroup { get; set; }
            public System.Func<Amazon.Athena.Model.GetPreparedStatementResponse, GetATHPreparedStatementCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PreparedStatement;
        }
