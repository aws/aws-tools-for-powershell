...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    public partial class GetATHSessionStatusCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.GetSessionStatusResponse, GetATHSessionStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.GetSessionStatusRequest();
        ...
        private Amazon.Athena.Model.GetSessionStatusResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetSessionStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "GetSessionStatus");
            try
            {
                #if DESKTOP
                return client.GetSessionStatus(request);
                #elif CORECLR
                return client.GetSessionStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SessionId { get; set; }
            public System.Func<Amazon.Athena.Model.GetSessionStatusResponse, GetATHSessionStatusCmdlet, object> Select { get; set; } =
