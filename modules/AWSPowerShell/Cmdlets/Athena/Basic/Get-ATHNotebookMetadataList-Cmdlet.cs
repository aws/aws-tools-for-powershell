...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdletOutput("Amazon.Athena.Model.NotebookMetadata or Amazon.Athena.Model.ListNotebookMetadataResponse",
        ...
        "The service call response (type Amazon.Athena.Model.ListNotebookMetadataResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
