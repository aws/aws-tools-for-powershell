...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena CreateNamedQuery API operation.", Operation = new[] {"CreateNamedQuery"}, SelectReturnType = typeof(Amazon.Athena.Model.CreateNamedQueryResponse))]
    [AWSCmdletOutput("System.String or Amazon.Athena.Model.CreateNamedQueryResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Athena.Model.CreateNamedQueryResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewATHNamedQueryCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NamedQueryId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.CreateNamedQueryResponse, NewATHNamedQueryCmdlet>(Select) ??
        ...
        private Amazon.Athena.Model.CreateNamedQueryResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.CreateNamedQueryRequest request)
        {
            ...
            try
            {
                return client.CreateNamedQueryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueryString { get; set; }
            public System.String WorkGroup { get; set; }
            public System.Func<Amazon.Athena.Model.CreateNamedQueryResponse, NewATHNamedQueryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NamedQueryId;
        }
