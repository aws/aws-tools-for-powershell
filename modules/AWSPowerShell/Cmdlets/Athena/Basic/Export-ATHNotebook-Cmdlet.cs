...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Export", "ATHNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Athena.Model.ExportNotebookResponse")]
    [AWSCmdlet("Calls the Amazon Athena ExportNotebook API operation.", Operation = new[] {"ExportNotebook"}, SelectReturnType = typeof(Amazon.Athena.Model.ExportNotebookResponse))]
    [AWSCmdletOutput("Amazon.Athena.Model.ExportNotebookResponse",
        "This cmdlet returns an Amazon.Athena.Model.ExportNotebookResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ExportATHNotebookCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Export-ATHNotebook (ExportNotebook)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.ExportNotebookResponse, ExportATHNotebookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.ExportNotebookRequest();
        ...
        private Amazon.Athena.Model.ExportNotebookResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.ExportNotebookRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "ExportNotebook");
            try
            {
                #if DESKTOP
                return client.ExportNotebook(request);
                #elif CORECLR
                return client.ExportNotebookAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NotebookId { get; set; }
            public System.Func<Amazon.Athena.Model.ExportNotebookResponse, ExportATHNotebookCmdlet, object> Select { get; set; } =
