...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena ListQueryExecutions API operation.", Operation = new[] {"ListQueryExecutions"}, SelectReturnType = typeof(Amazon.Athena.Model.ListQueryExecutionsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Athena.Model.ListQueryExecutionsResponse",
    ...
    public partial class GetATHQueryExecutionListCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "QueryExecutionIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.ListQueryExecutionsResponse, GetATHQueryExecutionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.QueryExecutionIds.Count;
        ...
        private Amazon.Athena.Model.ListQueryExecutionsResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.ListQueryExecutionsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListQueryExecutionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkGroup { get; set; }
            public System.Func<Amazon.Athena.Model.ListQueryExecutionsResponse, GetATHQueryExecutionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.QueryExecutionIds;
        }
