...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Get", "ATHCalculationExecution")]
    [OutputType("Amazon.Athena.Model.GetCalculationExecutionResponse")]
    [AWSCmdlet("Calls the Amazon Athena GetCalculationExecution API operation.", Operation = new[] {"GetCalculationExecution"}, SelectReturnType = typeof(Amazon.Athena.Model.GetCalculationExecutionResponse))]
    [AWSCmdletOutput("Amazon.Athena.Model.GetCalculationExecutionResponse",
        "This cmdlet returns an Amazon.Athena.Model.GetCalculationExecutionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetATHCalculationExecutionCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.GetCalculationExecutionResponse, GetATHCalculationExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.GetCalculationExecutionRequest();
        ...
        private Amazon.Athena.Model.GetCalculationExecutionResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetCalculationExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "GetCalculationExecution");
            try
            {
                #if DESKTOP
                return client.GetCalculationExecution(request);
                #elif CORECLR
                return client.GetCalculationExecutionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CalculationExecutionId { get; set; }
            public System.Func<Amazon.Athena.Model.GetCalculationExecutionResponse, GetATHCalculationExecutionCmdlet, object> Select { get; set; } =
