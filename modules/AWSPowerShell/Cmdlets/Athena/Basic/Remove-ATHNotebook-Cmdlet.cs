...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ATHNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveATHNotebookCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ATHNotebook (DeleteNotebook)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.DeleteNotebookResponse, RemoveATHNotebookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.DeleteNotebookRequest();
        ...
        private Amazon.Athena.Model.DeleteNotebookResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.DeleteNotebookRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "DeleteNotebook");
            try
            {
                #if DESKTOP
                return client.DeleteNotebook(request);
                #elif CORECLR
                return client.DeleteNotebookAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NotebookId { get; set; }
            public System.Func<Amazon.Athena.Model.DeleteNotebookResponse, RemoveATHNotebookCmdlet, object> Select { get; set; } =
