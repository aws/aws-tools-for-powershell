...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    [AWSCmdlet("Calls the Amazon Athena GetCalculationExecutionCode API operation.", Operation = new[] {"GetCalculationExecutionCode"}, SelectReturnType = typeof(Amazon.Athena.Model.GetCalculationExecutionCodeResponse))]
    [AWSCmdletOutput("System.String or Amazon.Athena.Model.GetCalculationExecutionCodeResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Athena.Model.GetCalculationExecutionCodeResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetATHCalculationExecutionCodeCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "CodeBlock";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.GetCalculationExecutionCodeResponse, GetATHCalculationExecutionCodeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.GetCalculationExecutionCodeRequest();
        ...
        private Amazon.Athena.Model.GetCalculationExecutionCodeResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetCalculationExecutionCodeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "GetCalculationExecutionCode");
            try
            {
                #if DESKTOP
                return client.GetCalculationExecutionCode(request);
                #elif CORECLR
                return client.GetCalculationExecutionCodeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CalculationExecutionId { get; set; }
            public System.Func<Amazon.Athena.Model.GetCalculationExecutionCodeResponse, GetATHCalculationExecutionCodeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CodeBlock;
        }
