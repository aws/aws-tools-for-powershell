...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Update", "ATHNotebookMetadata", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Athena UpdateNotebookMetadata API operation.", Operation = new[] {"UpdateNotebookMetadata"}, SelectReturnType = typeof(Amazon.Athena.Model.UpdateNotebookMetadataResponse))]
    [AWSCmdletOutput("None or Amazon.Athena.Model.UpdateNotebookMetadataResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Athena.Model.UpdateNotebookMetadataResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateATHNotebookMetadataCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-ATHNotebookMetadata (UpdateNotebookMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.UpdateNotebookMetadataResponse, UpdateATHNotebookMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.UpdateNotebookMetadataRequest();
        ...
        private Amazon.Athena.Model.UpdateNotebookMetadataResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.UpdateNotebookMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "UpdateNotebookMetadata");
            try
            {
                #if DESKTOP
                return client.UpdateNotebookMetadata(request);
                #elif CORECLR
                return client.UpdateNotebookMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NotebookId { get; set; }
            public System.Func<Amazon.Athena.Model.UpdateNotebookMetadataResponse, UpdateATHNotebookMetadataCmdlet, object> Select { get; set; } =
