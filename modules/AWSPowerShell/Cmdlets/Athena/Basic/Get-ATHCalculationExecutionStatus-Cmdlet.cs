...
namespace Amazon.PowerShell.Cmdlets.ATH
{
    ...
    /// </summary>
    [Cmdlet("Get", "ATHCalculationExecutionStatus")]
    [OutputType("Amazon.Athena.Model.GetCalculationExecutionStatusResponse")]
    [AWSCmdlet("Calls the Amazon Athena GetCalculationExecutionStatus API operation.", Operation = new[] {"GetCalculationExecutionStatus"}, SelectReturnType = typeof(Amazon.Athena.Model.GetCalculationExecutionStatusResponse))]
    [AWSCmdletOutput("Amazon.Athena.Model.GetCalculationExecutionStatusResponse",
        "This cmdlet returns an Amazon.Athena.Model.GetCalculationExecutionStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetATHCalculationExecutionStatusCmdlet : AmazonAthenaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Athena.Model.GetCalculationExecutionStatusResponse, GetATHCalculationExecutionStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Athena.Model.GetCalculationExecutionStatusRequest();
        ...
        private Amazon.Athena.Model.GetCalculationExecutionStatusResponse CallAWSServiceOperation(IAmazonAthena client, Amazon.Athena.Model.GetCalculationExecutionStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Athena", "GetCalculationExecutionStatus");
            try
            {
                #if DESKTOP
                return client.GetCalculationExecutionStatus(request);
                #elif CORECLR
                return client.GetCalculationExecutionStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CalculationExecutionId { get; set; }
            public System.Func<Amazon.Athena.Model.GetCalculationExecutionStatusResponse, GetATHCalculationExecutionStatusCmdlet, object> Select { get; set; } =
