...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MMGRRelay", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMMGRRelayCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RelayId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MMGRRelay (DeleteRelay)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.DeleteRelayResponse, RemoveMMGRRelayCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RelayId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.DeleteRelayRequest();
        ...
        private Amazon.MailManager.Model.DeleteRelayResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.DeleteRelayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "DeleteRelay");
            try
            {
                #if DESKTOP
                return client.DeleteRelay(request);
                #elif CORECLR
                return client.DeleteRelayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RelayId { get; set; }
            public System.Func<Amazon.MailManager.Model.DeleteRelayResponse, RemoveMMGRRelayCmdlet, object> Select { get; set; } =
