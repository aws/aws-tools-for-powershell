...
{
    /// <summary>
    /// List rule sets for this account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMMGRRuleSetListCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.MailManager.Model.ListRuleSetsResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.ListRuleSetsRequest request)
        {
            ...
            try
            {
                return client.ListRuleSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
