...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    public partial class GetMMGRRelayCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.GetRelayResponse, GetMMGRRelayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.GetRelayRequest();
        ...
        private Amazon.MailManager.Model.GetRelayResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.GetRelayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "GetRelay");
            try
            {
                return client.GetRelayAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String RelayId { get; set; }
            public System.Func<Amazon.MailManager.Model.GetRelayResponse, GetMMGRRelayCmdlet, object> Select { get; set; } =
