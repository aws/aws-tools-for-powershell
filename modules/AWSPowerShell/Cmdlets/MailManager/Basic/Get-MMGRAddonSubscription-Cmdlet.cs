...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "MMGRAddonSubscription")]
    ...
    public partial class GetMMGRAddonSubscriptionCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.GetAddonSubscriptionResponse, GetMMGRAddonSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.GetAddonSubscriptionRequest();
        ...
        private Amazon.MailManager.Model.GetAddonSubscriptionResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.GetAddonSubscriptionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "GetAddonSubscription");
            try
            {
                #if DESKTOP
                return client.GetAddonSubscription(request);
                #elif CORECLR
                return client.GetAddonSubscriptionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AddonSubscriptionId { get; set; }
            public System.Func<Amazon.MailManager.Model.GetAddonSubscriptionResponse, GetMMGRAddonSubscriptionCmdlet, object> Select { get; set; } =
