...
{
    /// <summary>
    /// Returns a list of all email archives in your account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMMGRArchiveListCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.MailManager.Model.ListArchivesResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.ListArchivesRequest request)
        {
            ...
            try
            {
                return client.ListArchivesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
