...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MMGRResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMMGRResourceTagCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MMGRResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.UntagResourceResponse, RemoveMMGRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.UntagResourceRequest();
        ...
        private Amazon.MailManager.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MailManager.Model.UntagResourceResponse, RemoveMMGRResourceTagCmdlet, object> Select { get; set; } =
