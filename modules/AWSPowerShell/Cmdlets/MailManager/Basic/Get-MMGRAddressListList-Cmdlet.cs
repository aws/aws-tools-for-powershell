...
{
    /// <summary>
    /// Lists address lists for this account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMMGRAddressListListCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.MailManager.Model.ListAddressListsResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.ListAddressListsRequest request)
        {
            ...
            try
            {
                return client.ListAddressListsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
