...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MMGRArchive", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMMGRArchiveCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MMGRArchive (DeleteArchive)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.DeleteArchiveResponse, RemoveMMGRArchiveCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.DeleteArchiveRequest();
        ...
        private Amazon.MailManager.Model.DeleteArchiveResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.DeleteArchiveRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "DeleteArchive");
            try
            {
        ...
        {
            public System.String ArchiveId { get; set; }
            public System.Func<Amazon.MailManager.Model.DeleteArchiveResponse, RemoveMMGRArchiveCmdlet, object> Select { get; set; } =
