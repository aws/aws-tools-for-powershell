...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Stop", "MMGRArchiveSearch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopMMGRArchiveSearchCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SearchId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SearchId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-MMGRArchiveSearch (StopArchiveSearch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.StopArchiveSearchResponse, StopMMGRArchiveSearchCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SearchId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.StopArchiveSearchRequest();
        ...
        private Amazon.MailManager.Model.StopArchiveSearchResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.StopArchiveSearchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "StopArchiveSearch");
            try
            {
                #if DESKTOP
                return client.StopArchiveSearch(request);
                #elif CORECLR
                return client.StopArchiveSearchAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SearchId { get; set; }
            public System.Func<Amazon.MailManager.Model.StopArchiveSearchResponse, StopMMGRArchiveSearchCmdlet, object> Select { get; set; } =
