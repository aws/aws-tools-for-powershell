...
{
    /// <summary>
    /// Lists all Add On subscriptions in your account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "MMGRAddonSubscriptionList")]
    [OutputType("Amazon.MailManager.Model.AddonSubscription")]
    ...
    public partial class GetMMGRAddonSubscriptionListCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AddonSubscriptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.ListAddonSubscriptionsResponse, GetMMGRAddonSubscriptionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MailManager.Model.ListAddonSubscriptionsRequest();
        ...
        private Amazon.MailManager.Model.ListAddonSubscriptionsResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.ListAddonSubscriptionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "ListAddonSubscriptions");
            try
            {
                return client.ListAddonSubscriptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.MailManager.Model.ListAddonSubscriptionsResponse, GetMMGRAddonSubscriptionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AddonSubscriptions;
        }
