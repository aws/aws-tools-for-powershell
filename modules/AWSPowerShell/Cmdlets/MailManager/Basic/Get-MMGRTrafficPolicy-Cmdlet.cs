...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    /// </summary>
    [Cmdlet("Get", "MMGRTrafficPolicy")]
    [OutputType("Amazon.MailManager.Model.GetTrafficPolicyResponse")]
    [AWSCmdlet("Calls the Amazon SES Mail Manager GetTrafficPolicy API operation.", Operation = new[] {"GetTrafficPolicy"}, SelectReturnType = typeof(Amazon.MailManager.Model.GetTrafficPolicyResponse))]
    [AWSCmdletOutput("Amazon.MailManager.Model.GetTrafficPolicyResponse",
        "This cmdlet returns an Amazon.MailManager.Model.GetTrafficPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMMGRTrafficPolicyCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.GetTrafficPolicyResponse, GetMMGRTrafficPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.GetTrafficPolicyRequest();
        ...
        private Amazon.MailManager.Model.GetTrafficPolicyResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.GetTrafficPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "GetTrafficPolicy");
            try
            {
                #if DESKTOP
                return client.GetTrafficPolicy(request);
                #elif CORECLR
                return client.GetTrafficPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TrafficPolicyId { get; set; }
            public System.Func<Amazon.MailManager.Model.GetTrafficPolicyResponse, GetMMGRTrafficPolicyCmdlet, object> Select { get; set; } =
