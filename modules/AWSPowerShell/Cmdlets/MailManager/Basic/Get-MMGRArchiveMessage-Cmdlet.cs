...
namespace Amazon.PowerShell.Cmdlets.MMGR
{
    ...
    public partial class GetMMGRArchiveMessageCmdlet : AmazonMailManagerClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "MessageDownloadLink";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ArchivedMessageId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MailManager.Model.GetArchiveMessageResponse, GetMMGRArchiveMessageCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ArchivedMessageId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MailManager.Model.GetArchiveMessageRequest();
        ...
        private Amazon.MailManager.Model.GetArchiveMessageResponse CallAWSServiceOperation(IAmazonMailManager client, Amazon.MailManager.Model.GetArchiveMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SES Mail Manager", "GetArchiveMessage");
            try
            {
                #if DESKTOP
                return client.GetArchiveMessage(request);
                #elif CORECLR
                return client.GetArchiveMessageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ArchivedMessageId { get; set; }
            public System.Func<Amazon.MailManager.Model.GetArchiveMessageResponse, GetMMGRArchiveMessageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MessageDownloadLink;
        }
