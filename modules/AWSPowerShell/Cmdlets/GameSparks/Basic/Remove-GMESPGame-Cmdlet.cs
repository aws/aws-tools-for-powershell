...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// Deletes a game.
    /// </summary>
    [Cmdlet("Remove", "GMESPGame", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon GameSparks DeleteGame API operation.", Operation = new[] {"DeleteGame"}, SelectReturnType = typeof(Amazon.GameSparks.Model.DeleteGameResponse))]
    [AWSCmdletOutput("None or Amazon.GameSparks.Model.DeleteGameResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GameSparks.Model.DeleteGameResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGMESPGameCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GMESPGame (DeleteGame)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.DeleteGameResponse, RemoveGMESPGameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.DeleteGameRequest();
        ...
        private Amazon.GameSparks.Model.DeleteGameResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.DeleteGameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "DeleteGame");
            try
            {
                #if DESKTOP
                return client.DeleteGame(request);
                #elif CORECLR
                return client.DeleteGameAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GameName { get; set; }
            public System.Func<Amazon.GameSparks.Model.DeleteGameResponse, RemoveGMESPGameCmdlet, object> Select { get; set; } =
