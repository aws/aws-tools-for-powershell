...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPSnapshotList")]
    [OutputType("Amazon.GameSparks.Model.SnapshotSummary")]
    [AWSCmdlet("Calls the Amazon GameSparks ListSnapshots API operation.", Operation = new[] {"ListSnapshots"}, SelectReturnType = typeof(Amazon.GameSparks.Model.ListSnapshotsResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.SnapshotSummary or Amazon.GameSparks.Model.ListSnapshotsResponse",
        "This cmdlet returns a collection of Amazon.GameSparks.Model.SnapshotSummary objects.",
        "The service call response (type Amazon.GameSparks.Model.ListSnapshotsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPSnapshotListCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.ListSnapshotsResponse, GetGMESPSnapshotListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.ListSnapshotsRequest();
        ...
        private Amazon.GameSparks.Model.ListSnapshotsResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.ListSnapshotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "ListSnapshots");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GameSparks.Model.ListSnapshotsResponse, GetGMESPSnapshotListCmdlet, object> Select { get; set; } =
