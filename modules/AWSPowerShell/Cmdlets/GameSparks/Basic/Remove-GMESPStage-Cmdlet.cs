...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GMESPStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon GameSparks DeleteStage API operation.", Operation = new[] {"DeleteStage"}, SelectReturnType = typeof(Amazon.GameSparks.Model.DeleteStageResponse))]
    [AWSCmdletOutput("None or Amazon.GameSparks.Model.DeleteStageResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GameSparks.Model.DeleteStageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGMESPStageCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GMESPStage (DeleteStage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.DeleteStageResponse, RemoveGMESPStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.DeleteStageRequest();
        ...
        private Amazon.GameSparks.Model.DeleteStageResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.DeleteStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "DeleteStage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GameName { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.GameSparks.Model.DeleteStageResponse, RemoveGMESPStageCmdlet, object> Select { get; set; } =
