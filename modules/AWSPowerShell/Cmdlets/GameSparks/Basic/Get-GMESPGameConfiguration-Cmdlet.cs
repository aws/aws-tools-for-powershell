...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPGameConfiguration")]
    [OutputType("Amazon.GameSparks.Model.GameConfigurationDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks GetGameConfiguration API operation.", Operation = new[] {"GetGameConfiguration"}, SelectReturnType = typeof(Amazon.GameSparks.Model.GetGameConfigurationResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.GameConfigurationDetails or Amazon.GameSparks.Model.GetGameConfigurationResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.GameConfigurationDetails object.",
        "The service call response (type Amazon.GameSparks.Model.GetGameConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPGameConfigurationCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.GetGameConfigurationResponse, GetGMESPGameConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.GetGameConfigurationRequest();
        ...
        private Amazon.GameSparks.Model.GetGameConfigurationResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.GetGameConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "GetGameConfiguration");
            try
            {
                #if DESKTOP
                return client.GetGameConfiguration(request);
                #elif CORECLR
                return client.GetGameConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GameSparks.Model.GetGameConfigurationResponse, GetGMESPGameConfigurationCmdlet, object> Select { get; set; } =
