...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Export", "GMESPSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon GameSparks ExportSnapshot API operation.", Operation = new[] {"ExportSnapshot"}, SelectReturnType = typeof(Amazon.GameSparks.Model.ExportSnapshotResponse))]
    [AWSCmdletOutput("System.String or Amazon.GameSparks.Model.ExportSnapshotResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.GameSparks.Model.ExportSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ExportGMESPSnapshotCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "S3Url";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Export-GMESPSnapshot (ExportSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.ExportSnapshotResponse, ExportGMESPSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.ExportSnapshotRequest();
        ...
        private Amazon.GameSparks.Model.ExportSnapshotResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.ExportSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "ExportSnapshot");
            try
            {
                #if DESKTOP
                return client.ExportSnapshot(request);
                #elif CORECLR
                return client.ExportSnapshotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GameName { get; set; }
            public System.String SnapshotId { get; set; }
            public System.Func<Amazon.GameSparks.Model.ExportSnapshotResponse, ExportGMESPSnapshotCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.S3Url;
        }
