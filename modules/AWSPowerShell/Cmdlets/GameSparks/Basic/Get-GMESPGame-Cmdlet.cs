...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPGame")]
    [OutputType("Amazon.GameSparks.Model.GameDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks GetGame API operation.", Operation = new[] {"GetGame"}, SelectReturnType = typeof(Amazon.GameSparks.Model.GetGameResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.GameDetails or Amazon.GameSparks.Model.GetGameResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.GameDetails object.",
        "The service call response (type Amazon.GameSparks.Model.GetGameResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPGameCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.GetGameResponse, GetGMESPGameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.GetGameRequest();
        ...
        private Amazon.GameSparks.Model.GetGameResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.GetGameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "GetGame");
            try
            {
                #if DESKTOP
                return client.GetGame(request);
                #elif CORECLR
                return client.GetGameAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GameName { get; set; }
            public System.Func<Amazon.GameSparks.Model.GetGameResponse, GetGMESPGameCmdlet, object> Select { get; set; } =
