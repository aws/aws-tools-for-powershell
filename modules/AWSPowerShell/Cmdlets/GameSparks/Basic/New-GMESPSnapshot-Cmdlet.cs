...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("New", "GMESPSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.GameSparks.Model.SnapshotDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks CreateSnapshot API operation.", Operation = new[] {"CreateSnapshot"}, SelectReturnType = typeof(Amazon.GameSparks.Model.CreateSnapshotResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.SnapshotDetails or Amazon.GameSparks.Model.CreateSnapshotResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.SnapshotDetails object.",
        "The service call response (type Amazon.GameSparks.Model.CreateSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGMESPSnapshotCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-GMESPSnapshot (CreateSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.CreateSnapshotResponse, NewGMESPSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.CreateSnapshotRequest();
        ...
        private Amazon.GameSparks.Model.CreateSnapshotResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.CreateSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "CreateSnapshot");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String GameName { get; set; }
            public System.Func<Amazon.GameSparks.Model.CreateSnapshotResponse, NewGMESPSnapshotCmdlet, object> Select { get; set; } =
