...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disconnect", "GMESPPlayer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.GameSparks.Model.DisconnectPlayerResponse")]
    [AWSCmdlet("Calls the Amazon GameSparks DisconnectPlayer API operation.", Operation = new[] {"DisconnectPlayer"}, SelectReturnType = typeof(Amazon.GameSparks.Model.DisconnectPlayerResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.DisconnectPlayerResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.DisconnectPlayerResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisconnectGMESPPlayerCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.PlayerId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disconnect-GMESPPlayer (DisconnectPlayer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.DisconnectPlayerResponse, DisconnectGMESPPlayerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.DisconnectPlayerRequest();
        ...
        private Amazon.GameSparks.Model.DisconnectPlayerResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.DisconnectPlayerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "DisconnectPlayer");
            try
            {
                #if DESKTOP
                return client.DisconnectPlayer(request);
                #elif CORECLR
                return client.DisconnectPlayerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PlayerId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.GameSparks.Model.DisconnectPlayerResponse, DisconnectGMESPPlayerCmdlet, object> Select { get; set; } =
