...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPGeneratedCodeJob")]
    [OutputType("Amazon.GameSparks.Model.GeneratedCodeJobDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks GetGeneratedCodeJob API operation.", Operation = new[] {"GetGeneratedCodeJob"}, SelectReturnType = typeof(Amazon.GameSparks.Model.GetGeneratedCodeJobResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.GeneratedCodeJobDetails or Amazon.GameSparks.Model.GetGeneratedCodeJobResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.GeneratedCodeJobDetails object.",
        "The service call response (type Amazon.GameSparks.Model.GetGeneratedCodeJobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPGeneratedCodeJobCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GeneratedCodeJob";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.GetGeneratedCodeJobResponse, GetGMESPGeneratedCodeJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.GetGeneratedCodeJobRequest();
        ...
        private Amazon.GameSparks.Model.GetGeneratedCodeJobResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.GetGeneratedCodeJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "GetGeneratedCodeJob");
            try
            {
                #if DESKTOP
                return client.GetGeneratedCodeJob(request);
                #elif CORECLR
                return client.GetGeneratedCodeJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String JobId { get; set; }
            public System.String SnapshotId { get; set; }
            public System.Func<Amazon.GameSparks.Model.GetGeneratedCodeJobResponse, GetGMESPGeneratedCodeJobCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GeneratedCodeJob;
        }
