...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPStage")]
    [OutputType("Amazon.GameSparks.Model.StageDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks GetStage API operation.", Operation = new[] {"GetStage"}, SelectReturnType = typeof(Amazon.GameSparks.Model.GetStageResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.StageDetails or Amazon.GameSparks.Model.GetStageResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.StageDetails object.",
        "The service call response (type Amazon.GameSparks.Model.GetStageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPStageCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.GetStageResponse, GetGMESPStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.GetStageRequest();
        ...
        private Amazon.GameSparks.Model.GetStageResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.GetStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "GetStage");
            try
            {
                #if DESKTOP
                return client.GetStage(request);
                #elif CORECLR
                return client.GetStageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GameName { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.GameSparks.Model.GetStageResponse, GetGMESPStageCmdlet, object> Select { get; set; } =
