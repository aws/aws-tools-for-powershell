...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Update", "GMESPGame", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.GameSparks.Model.GameDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks UpdateGame API operation.", Operation = new[] {"UpdateGame"}, SelectReturnType = typeof(Amazon.GameSparks.Model.UpdateGameResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.GameDetails or Amazon.GameSparks.Model.UpdateGameResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.GameDetails object.",
        "The service call response (type Amazon.GameSparks.Model.UpdateGameResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateGMESPGameCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Game";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GMESPGame (UpdateGame)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.UpdateGameResponse, UpdateGMESPGameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.UpdateGameRequest();
        ...
        private Amazon.GameSparks.Model.UpdateGameResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.UpdateGameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "UpdateGame");
            try
            {
                #if DESKTOP
                return client.UpdateGame(request);
                #elif CORECLR
                return client.UpdateGameAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String GameName { get; set; }
            public System.Func<Amazon.GameSparks.Model.UpdateGameResponse, UpdateGMESPGameCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Game;
        }
