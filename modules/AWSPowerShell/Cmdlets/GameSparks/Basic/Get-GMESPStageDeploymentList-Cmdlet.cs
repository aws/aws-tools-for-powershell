...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMESPStageDeploymentList")]
    [OutputType("Amazon.GameSparks.Model.StageDeploymentSummary")]
    [AWSCmdlet("Calls the Amazon GameSparks ListStageDeployments API operation.", Operation = new[] {"ListStageDeployments"}, SelectReturnType = typeof(Amazon.GameSparks.Model.ListStageDeploymentsResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.StageDeploymentSummary or Amazon.GameSparks.Model.ListStageDeploymentsResponse",
        "This cmdlet returns a collection of Amazon.GameSparks.Model.StageDeploymentSummary objects.",
        "The service call response (type Amazon.GameSparks.Model.ListStageDeploymentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGMESPStageDeploymentListCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StageDeployments";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.ListStageDeploymentsResponse, GetGMESPStageDeploymentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.ListStageDeploymentsRequest();
        ...
        private Amazon.GameSparks.Model.ListStageDeploymentsResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.ListStageDeploymentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "ListStageDeployments");
            try
            {
                #if DESKTOP
                return client.ListStageDeployments(request);
                #elif CORECLR
                return client.ListStageDeploymentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.GameSparks.Model.ListStageDeploymentsResponse, GetGMESPStageDeploymentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StageDeployments;
        }
