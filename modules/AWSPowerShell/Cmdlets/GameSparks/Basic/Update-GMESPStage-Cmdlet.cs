...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("Update", "GMESPStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.GameSparks.Model.StageDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks UpdateStage API operation.", Operation = new[] {"UpdateStage"}, SelectReturnType = typeof(Amazon.GameSparks.Model.UpdateStageResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.StageDetails or Amazon.GameSparks.Model.UpdateStageResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.StageDetails object.",
        "The service call response (type Amazon.GameSparks.Model.UpdateStageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateGMESPStageCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GMESPStage (UpdateStage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.UpdateStageResponse, UpdateGMESPStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.UpdateStageRequest();
        ...
        private Amazon.GameSparks.Model.UpdateStageResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.UpdateStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "UpdateStage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Role { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.GameSparks.Model.UpdateStageResponse, UpdateGMESPStageCmdlet, object> Select { get; set; } =
