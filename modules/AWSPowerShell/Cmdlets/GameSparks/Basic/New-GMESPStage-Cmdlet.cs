...
namespace Amazon.PowerShell.Cmdlets.GMESP
{
    ...
    /// </summary>
    [Cmdlet("New", "GMESPStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.GameSparks.Model.StageDetails")]
    [AWSCmdlet("Calls the Amazon GameSparks CreateStage API operation.", Operation = new[] {"CreateStage"}, SelectReturnType = typeof(Amazon.GameSparks.Model.CreateStageResponse))]
    [AWSCmdletOutput("Amazon.GameSparks.Model.StageDetails or Amazon.GameSparks.Model.CreateStageResponse",
        "This cmdlet returns an Amazon.GameSparks.Model.StageDetails object.",
        "The service call response (type Amazon.GameSparks.Model.CreateStageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGMESPStageCmdlet : AmazonGameSparksClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-GMESPStage (CreateStage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameSparks.Model.CreateStageResponse, NewGMESPStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameSparks.Model.CreateStageRequest();
        ...
        private Amazon.GameSparks.Model.CreateStageResponse CallAWSServiceOperation(IAmazonGameSparks client, Amazon.GameSparks.Model.CreateStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameSparks", "CreateStage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GameSparks.Model.CreateStageResponse, NewGMESPStageCmdlet, object> Select { get; set; } =
