...
namespace Amazon.PowerShell.Cmdlets.CW
{
    ...
    public class WriteCWMetricDataCmdlet : AmazonCloudWatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The namespace for the metric data. </para><note> You cannot specify a namespace that begins with "AWS/". Namespaces that begin
        ...
        private static Amazon.CloudWatch.Model.PutMetricDataResponse CallAWSServiceOperation(IAmazonCloudWatch client, Amazon.CloudWatch.Model.PutMetricDataRequest request)
        {
