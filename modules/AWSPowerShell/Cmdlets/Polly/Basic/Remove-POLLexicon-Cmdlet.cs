...
namespace Amazon.PowerShell.Cmdlets.POL
{
    ...
    public partial class RemovePOLLexiconCmdlet : AmazonPollyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Polly.Model.DeleteLexiconResponse, RemovePOLLexiconCmdlet>(Select) ??
        ...
        private Amazon.Polly.Model.DeleteLexiconResponse CallAWSServiceOperation(IAmazonPolly client, Amazon.Polly.Model.DeleteLexiconRequest request)
        {
            ...
            try
            {
                return client.DeleteLexiconAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Polly.Model.DeleteLexiconResponse, RemovePOLLexiconCmdlet, object> Select { get; set; } =
