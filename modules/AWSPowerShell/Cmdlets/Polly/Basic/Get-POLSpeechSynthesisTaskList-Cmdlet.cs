...
namespace Amazon.PowerShell.Cmdlets.POL
{
    ...
    /// </summary>
    [Cmdlet("Get", "POLSpeechSynthesisTaskList")]
    [OutputType("Amazon.Polly.Model.SynthesisTask")]
    [AWSCmdlet("Calls the Amazon Polly ListSpeechSynthesisTasks API operation.", Operation = new[] {"ListSpeechSynthesisTasks"}, SelectReturnType = typeof(Amazon.Polly.Model.ListSpeechSynthesisTasksResponse))]
    [AWSCmdletOutput("Amazon.Polly.Model.SynthesisTask or Amazon.Polly.Model.ListSpeechSynthesisTasksResponse",
        "This cmdlet returns a collection of Amazon.Polly.Model.SynthesisTask objects.",
        "The service call response (type Amazon.Polly.Model.ListSpeechSynthesisTasksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPOLSpeechSynthesisTaskListCmdlet : AmazonPollyClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.Polly.TaskStatus")]
        public Amazon.Polly.TaskStatus Status { get; set; }
        #endregion
        ...
        private Amazon.Polly.Model.ListSpeechSynthesisTasksResponse CallAWSServiceOperation(IAmazonPolly client, Amazon.Polly.Model.ListSpeechSynthesisTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Polly", "ListSpeechSynthesisTasks");
            try
            {
                #if DESKTOP
                return client.ListSpeechSynthesisTasks(request);
                #elif CORECLR
                return client.ListSpeechSynthesisTasksAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.Polly.TaskStatus Status { get; set; }
            public System.Func<Amazon.Polly.Model.ListSpeechSynthesisTasksResponse, GetPOLSpeechSynthesisTaskListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SynthesisTasks;
        }
