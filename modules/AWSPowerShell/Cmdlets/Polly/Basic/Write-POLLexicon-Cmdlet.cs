...
namespace Amazon.PowerShell.Cmdlets.POL
{
    ...
    public partial class WritePOLLexiconCmdlet : AmazonPollyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Polly.Model.PutLexiconResponse, WritePOLLexiconCmdlet>(Select) ??
        ...
        private Amazon.Polly.Model.PutLexiconResponse CallAWSServiceOperation(IAmazonPolly client, Amazon.Polly.Model.PutLexiconRequest request)
        {
            ...
            try
            {
                return client.PutLexiconAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Content { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.Polly.Model.PutLexiconResponse, WritePOLLexiconCmdlet, object> Select { get; set; } =
