...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Clear", "KNDRQuerySuggestion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class ClearKNDRQuerySuggestionCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Clear-KNDRQuerySuggestion (ClearQuerySuggestions)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.ClearQuerySuggestionsResponse, ClearKNDRQuerySuggestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.ClearQuerySuggestionsRequest();
        ...
        private Amazon.Kendra.Model.ClearQuerySuggestionsResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.ClearQuerySuggestionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "ClearQuerySuggestions");
            try
            {
                #if DESKTOP
                return client.ClearQuerySuggestions(request);
                #elif CORECLR
                return client.ClearQuerySuggestionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.ClearQuerySuggestionsResponse, ClearKNDRQuerySuggestionCmdlet, object> Select { get; set; } =
