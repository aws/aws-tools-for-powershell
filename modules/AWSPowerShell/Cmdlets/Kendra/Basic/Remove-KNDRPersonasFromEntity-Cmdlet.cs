...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class RemoveKNDRPersonasFromEntityCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifiers of users or groups in your Amazon Web Services SSO identity source.
        /// For example, user IDs could be user emails.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Kendra.Model.DisassociatePersonasFromEntitiesResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DisassociatePersonasFromEntitiesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DisassociatePersonasFromEntities(request);
                #elif CORECLR
                return client.DisassociatePersonasFromEntitiesAsync(request).GetAwaiter().GetResult();
                #else
