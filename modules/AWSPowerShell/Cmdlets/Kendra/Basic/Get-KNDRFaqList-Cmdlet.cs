...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [AWSCmdletOutput("Amazon.Kendra.Model.FaqSummary or Amazon.Kendra.Model.ListFaqsResponse",
        ...
        "The service call response (type Amazon.Kendra.Model.ListFaqsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
