...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    /// </para><para><c>DeletePrincipalMapping</c> is currently not supported in the Amazon Web Services
    ...
    public partial class RemoveKNDRPrincipalMappingCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// are yet to be processed.</para><para>The default ordering ID is the current Unix time in milliseconds that the action was
        ...
        private Amazon.Kendra.Model.DeletePrincipalMappingResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DeletePrincipalMappingRequest request)
        {
            ...
            try
            {
                return client.DeletePrincipalMappingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
