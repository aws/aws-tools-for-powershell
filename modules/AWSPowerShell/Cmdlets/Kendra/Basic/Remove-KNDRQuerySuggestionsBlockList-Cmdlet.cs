...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    /// </para><para><c>DeleteQuerySuggestionsBlockList</c> is currently not supported in the Amazon Web
    ...
    public partial class RemoveKNDRQuerySuggestionsBlockListCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KNDRQuerySuggestionsBlockList (DeleteQuerySuggestionsBlockList)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.DeleteQuerySuggestionsBlockListResponse, RemoveKNDRQuerySuggestionsBlockListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.DeleteQuerySuggestionsBlockListRequest();
        ...
        private Amazon.Kendra.Model.DeleteQuerySuggestionsBlockListResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DeleteQuerySuggestionsBlockListRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "DeleteQuerySuggestionsBlockList");
            try
            {
                #if DESKTOP
                return client.DeleteQuerySuggestionsBlockList(request);
                #elif CORECLR
                return client.DeleteQuerySuggestionsBlockListAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.DeleteQuerySuggestionsBlockListResponse, RemoveKNDRQuerySuggestionsBlockListCmdlet, object> Select { get; set; } =
