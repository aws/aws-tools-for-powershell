...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class StopKNDRDataSourceSyncJobCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-KNDRDataSourceSyncJob (StopDataSourceSyncJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.StopDataSourceSyncJobResponse, StopKNDRDataSourceSyncJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.StopDataSourceSyncJobRequest();
        ...
        private Amazon.Kendra.Model.StopDataSourceSyncJobResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.StopDataSourceSyncJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "StopDataSourceSyncJob");
            try
            {
                #if DESKTOP
                return client.StopDataSourceSyncJob(request);
                #elif CORECLR
                return client.StopDataSourceSyncJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.StopDataSourceSyncJobResponse, StopKNDRDataSourceSyncJobCmdlet, object> Select { get; set; } =
