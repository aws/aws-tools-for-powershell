...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "KNDRFeaturedResultsSetBatch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetError")]
    ...
    public partial class RemoveKNDRFeaturedResultsSetBatchCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifiers of the featured results sets that you want to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetResponse).
        /// Specifying the name of a property of type Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KNDRFeaturedResultsSetBatch (BatchDeleteFeaturedResultsSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetResponse, RemoveKNDRFeaturedResultsSetBatchCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.FeaturedResultsSetId != null)
            {
                context.FeaturedResultsSetId = new List<System.String>(this.FeaturedResultsSetId);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetRequest();
            
            if (cmdletContext.FeaturedResultsSetId != null)
            {
                request.FeaturedResultsSetIds = cmdletContext.FeaturedResultsSetId;
            }
        ...
        private Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "BatchDeleteFeaturedResultsSet");
            try
            {
                #if DESKTOP
                return client.BatchDeleteFeaturedResultsSet(request);
                #elif CORECLR
                return client.BatchDeleteFeaturedResultsSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<System.String> FeaturedResultsSetId { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.BatchDeleteFeaturedResultsSetResponse, RemoveKNDRFeaturedResultsSetBatchCmdlet, object> Select { get; set; } =
