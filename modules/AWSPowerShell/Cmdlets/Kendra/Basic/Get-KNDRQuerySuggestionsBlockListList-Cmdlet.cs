...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [OutputType("Amazon.Kendra.Model.QuerySuggestionsBlockListSummary")]
    [AWSCmdlet("Calls the Amazon Kendra ListQuerySuggestionsBlockLists API operation.", Operation = new[] {"ListQuerySuggestionsBlockLists"}, SelectReturnType = typeof(Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse))]
    [AWSCmdletOutput("Amazon.Kendra.Model.QuerySuggestionsBlockListSummary or Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse",
        "This cmdlet returns a collection of Amazon.Kendra.Model.QuerySuggestionsBlockListSummary objects.",
        "The service call response (type Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetKNDRQuerySuggestionsBlockListListCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BlockListSummaryItems";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse, GetKNDRQuerySuggestionsBlockListListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kendra.Model.ListQuerySuggestionsBlockListsRequest();
        ...
        private Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.ListQuerySuggestionsBlockListsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "ListQuerySuggestionsBlockLists");
            try
            {
                #if DESKTOP
                return client.ListQuerySuggestionsBlockLists(request);
                #elif CORECLR
                return client.ListQuerySuggestionsBlockListsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Kendra.Model.ListQuerySuggestionsBlockListsResponse, GetKNDRQuerySuggestionsBlockListListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BlockListSummaryItems;
        }
