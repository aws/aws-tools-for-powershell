...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class UpdateKNDRExperienceCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the data sources you want to use for your Amazon Kendra experience.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the FAQs that you want to use for your Amazon Kendra experience.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Kendra.Model.UpdateExperienceResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.UpdateExperienceRequest request)
        {
            ...
            try
            {
                return client.UpdateExperienceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
