...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [AWSCmdlet("Calls the Amazon Kendra ListDataSources API operation.", Operation = new[] {"ListDataSources"}, SelectReturnType = typeof(Amazon.Kendra.Model.ListDataSourcesResponse))]
    [AWSCmdletOutput("Amazon.Kendra.Model.DataSourceSummary or Amazon.Kendra.Model.ListDataSourcesResponse",
        "This cmdlet returns a collection of Amazon.Kendra.Model.DataSourceSummary objects.",
        "The service call response (type Amazon.Kendra.Model.ListDataSourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetKNDRDataSourceListCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// token to retrieve the next set of data source connectors. </para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.ListDataSourcesResponse, GetKNDRDataSourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kendra.Model.ListDataSourcesRequest();
        ...
        private Amazon.Kendra.Model.ListDataSourcesResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.ListDataSourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "ListDataSources");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Kendra.Model.ListDataSourcesResponse, GetKNDRDataSourceListCmdlet, object> Select { get; set; } =
