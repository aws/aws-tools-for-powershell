...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class StartKNDRDataSourceSyncJobCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-KNDRDataSourceSyncJob (StartDataSourceSyncJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.StartDataSourceSyncJobResponse, StartKNDRDataSourceSyncJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.StartDataSourceSyncJobRequest();
        ...
        private Amazon.Kendra.Model.StartDataSourceSyncJobResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.StartDataSourceSyncJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "StartDataSourceSyncJob");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.StartDataSourceSyncJobResponse, StartKNDRDataSourceSyncJobCmdlet, object> Select { get; set; } =
