...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class UpdateKNDRAccessControlConfigurationCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// results are filtered based on the user or their group access to documents.</para><para />
        ...
        /// lists that define the hierarchy for which documents users should have access to.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Kendra.Model.UpdateAccessControlConfigurationResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.UpdateAccessControlConfigurationRequest request)
        {
            ...
            try
            {
                return client.UpdateAccessControlConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
