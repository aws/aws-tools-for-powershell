...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [AWSCmdletOutput("Amazon.Kendra.Model.GetSnapshotsResponse",
        "This cmdlet returns an Amazon.Kendra.Model.GetSnapshotsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
