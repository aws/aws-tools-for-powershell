...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class GetKNDRThesaurusCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.DescribeThesaurusResponse, GetKNDRThesaurusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.DescribeThesaurusRequest();
        ...
        private Amazon.Kendra.Model.DescribeThesaurusResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DescribeThesaurusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "DescribeThesaurus");
            try
            {
                #if DESKTOP
                return client.DescribeThesaurus(request);
                #elif CORECLR
                return client.DescribeThesaurusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.DescribeThesaurusResponse, GetKNDRThesaurusCmdlet, object> Select { get; set; } =
