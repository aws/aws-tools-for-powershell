...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [AWSCmdletOutput("Amazon.Kendra.Model.DescribeIndexResponse",
        "This cmdlet returns an Amazon.Kendra.Model.DescribeIndexResponse object containing multiple properties."
    )]
    public partial class GetKNDRIndexCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the index you want to get information on.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Kendra.Model.DescribeIndexResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DescribeIndexRequest request)
        {
            ...
            try
            {
                return client.DescribeIndexAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
