...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Kendra TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.Kendra.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Kendra.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Kendra.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddKNDRResourceTagCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// tag already exists, the existing value is replaced with the new value.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-KNDRResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.TagResourceResponse, AddKNDRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.TagResourceRequest();
        ...
        private Amazon.Kendra.Model.TagResourceResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Kendra.Model.TagResourceResponse, AddKNDRResourceTagCmdlet, object> Select { get; set; } =
