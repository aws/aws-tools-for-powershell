...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class RemoveKNDRFaqCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KNDRFaq (DeleteFaq)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.DeleteFaqResponse, RemoveKNDRFaqCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.DeleteFaqRequest();
        ...
        private Amazon.Kendra.Model.DeleteFaqResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.DeleteFaqRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "DeleteFaq");
            try
            {
                #if DESKTOP
                return client.DeleteFaq(request);
                #elif CORECLR
                return client.DeleteFaqAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.Kendra.Model.DeleteFaqResponse, RemoveKNDRFaqCmdlet, object> Select { get; set; } =
