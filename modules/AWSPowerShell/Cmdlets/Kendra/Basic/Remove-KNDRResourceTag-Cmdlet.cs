...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    public partial class RemoveKNDRResourceTagCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// If a tag key doesn't exist for the resource, it is ignored.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-KNDRResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Kendra.Model.UntagResourceResponse, RemoveKNDRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Kendra.Model.UntagResourceRequest();
        ...
        private Amazon.Kendra.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kendra", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Kendra.Model.UntagResourceResponse, RemoveKNDRResourceTagCmdlet, object> Select { get; set; } =
