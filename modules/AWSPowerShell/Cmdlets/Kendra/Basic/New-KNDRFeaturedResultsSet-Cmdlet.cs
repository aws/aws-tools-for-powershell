...
namespace Amazon.PowerShell.Cmdlets.KNDR
{
    ...
    [AWSCmdletOutput("Amazon.Kendra.Model.FeaturedResultsSet or Amazon.Kendra.Model.CreateFeaturedResultsSetResponse",
        ...
        "The service call response (type Amazon.Kendra.Model.CreateFeaturedResultsSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewKNDRFeaturedResultsSetCmdlet : AmazonKendraClientCmdlet, IExecutor
    {
        ...
        /// results page. For more information on the list of documents, see <a href="https://docs.aws.amazon.com/kendra/latest/dg/API_FeaturedResultsSet.html">FeaturedResultsSet</a>.</para><para />
        ...
        private Amazon.Kendra.Model.CreateFeaturedResultsSetResponse CallAWSServiceOperation(IAmazonKendra client, Amazon.Kendra.Model.CreateFeaturedResultsSetRequest request)
        {
            ...
            try
            {
                return client.CreateFeaturedResultsSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
