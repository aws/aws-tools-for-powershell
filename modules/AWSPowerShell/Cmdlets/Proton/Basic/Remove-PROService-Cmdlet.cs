...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    [AWSCmdlet("Calls the AWS Proton DeleteService API operation.", Operation = new[] {"DeleteService"}, SelectReturnType = typeof(Amazon.Proton.Model.DeleteServiceResponse))]
    [AWSCmdletOutput("Amazon.Proton.Model.Service or Amazon.Proton.Model.DeleteServiceResponse",
        "This cmdlet returns an Amazon.Proton.Model.Service object.",
        "The service call response (type Amazon.Proton.Model.DeleteServiceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePROServiceCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROService (DeleteService)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.DeleteServiceResponse, RemovePROServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.DeleteServiceRequest();
        ...
        private Amazon.Proton.Model.DeleteServiceResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.DeleteServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "DeleteService");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Proton.Model.DeleteServiceResponse, RemovePROServiceCmdlet, object> Select { get; set; } =
