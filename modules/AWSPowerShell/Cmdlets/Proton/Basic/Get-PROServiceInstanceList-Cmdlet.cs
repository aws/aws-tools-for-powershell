...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    /// services in the Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPROServiceInstanceListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        /// instances in the Amazon Web Services account are returned.</para><para />
        ...
        private Amazon.Proton.Model.ListServiceInstancesResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListServiceInstancesRequest request)
        {
            ...
            try
            {
                return client.ListServiceInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
