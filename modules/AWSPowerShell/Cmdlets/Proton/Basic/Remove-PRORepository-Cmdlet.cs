...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    [AWSCmdlet("Calls the AWS Proton DeleteRepository API operation.", Operation = new[] {"DeleteRepository"}, SelectReturnType = typeof(Amazon.Proton.Model.DeleteRepositoryResponse))]
    [AWSCmdletOutput("Amazon.Proton.Model.Repository or Amazon.Proton.Model.DeleteRepositoryResponse",
        "This cmdlet returns an Amazon.Proton.Model.Repository object.",
        "The service call response (type Amazon.Proton.Model.DeleteRepositoryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePRORepositoryCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PRORepository (DeleteRepository)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.DeleteRepositoryResponse, RemovePRORepositoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.DeleteRepositoryRequest();
        ...
        private Amazon.Proton.Model.DeleteRepositoryResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.DeleteRepositoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "DeleteRepository");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public Amazon.Proton.RepositoryProvider Provider { get; set; }
            public System.Func<Amazon.Proton.Model.DeleteRepositoryResponse, RemovePRORepositoryCmdlet, object> Select { get; set; } =
