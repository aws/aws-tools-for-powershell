...
{
    /// <summary>
    /// List environments with detail data summaries.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Proton.Model.EnvironmentSummary or Amazon.Proton.Model.ListEnvironmentsResponse",
        ...
        "The service call response (type Amazon.Proton.Model.ListEnvironmentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPROEnvironmentListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of the versions of the environment template.</para><para />
