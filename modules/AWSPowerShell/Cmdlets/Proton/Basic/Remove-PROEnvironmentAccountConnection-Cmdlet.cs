...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    public partial class RemovePROEnvironmentAccountConnectionCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROEnvironmentAccountConnection (DeleteEnvironmentAccountConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.DeleteEnvironmentAccountConnectionResponse, RemovePROEnvironmentAccountConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.DeleteEnvironmentAccountConnectionRequest();
        ...
        private Amazon.Proton.Model.DeleteEnvironmentAccountConnectionResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.DeleteEnvironmentAccountConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "DeleteEnvironmentAccountConnection");
            try
            {
                #if DESKTOP
                return client.DeleteEnvironmentAccountConnection(request);
                #elif CORECLR
                return client.DeleteEnvironmentAccountConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Proton.Model.DeleteEnvironmentAccountConnectionResponse, RemovePROEnvironmentAccountConnectionCmdlet, object> Select { get; set; } =
