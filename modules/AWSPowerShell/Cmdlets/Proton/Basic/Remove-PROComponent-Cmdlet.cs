...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "PROComponent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemovePROComponentCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROComponent (DeleteComponent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.DeleteComponentResponse, RemovePROComponentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.DeleteComponentRequest();
        ...
        private Amazon.Proton.Model.DeleteComponentResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.DeleteComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "DeleteComponent");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Proton.Model.DeleteComponentResponse, RemovePROComponentCmdlet, object> Select { get; set; } =
