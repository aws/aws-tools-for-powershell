...
{
    /// <summary>
    /// Get detailed data for an environment.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "PROEnvironment")]
    ...
    public partial class GetPROEnvironmentCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.GetEnvironmentResponse, GetPROEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.GetEnvironmentRequest();
        ...
        private Amazon.Proton.Model.GetEnvironmentResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.GetEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "GetEnvironment");
            try
            {
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Proton.Model.GetEnvironmentResponse, GetPROEnvironmentCmdlet, object> Select { get; set; } =
