...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    public partial class RemovePROTemplateSyncConfigCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PROTemplateSyncConfig (DeleteTemplateSyncConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.DeleteTemplateSyncConfigResponse, RemovePROTemplateSyncConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.DeleteTemplateSyncConfigRequest();
        ...
        private Amazon.Proton.Model.DeleteTemplateSyncConfigResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.DeleteTemplateSyncConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "DeleteTemplateSyncConfig");
            try
            {
                #if DESKTOP
                return client.DeleteTemplateSyncConfig(request);
                #elif CORECLR
                return client.DeleteTemplateSyncConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TemplateName { get; set; }
            public Amazon.Proton.TemplateType TemplateType { get; set; }
            public System.Func<Amazon.Proton.Model.DeleteTemplateSyncConfigResponse, RemovePROTemplateSyncConfigCmdlet, object> Select { get; set; } =
