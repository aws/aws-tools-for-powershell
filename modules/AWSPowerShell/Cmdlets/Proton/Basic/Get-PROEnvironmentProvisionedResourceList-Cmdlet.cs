...
{
    /// <summary>
    /// List the provisioned resources for your environment.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.<br/><br/>This operation is deprecated.
    /// </summary>
    ...
    public partial class GetPROEnvironmentProvisionedResourceListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.ListEnvironmentProvisionedResourcesResponse, GetPROEnvironmentProvisionedResourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Proton.Model.ListEnvironmentProvisionedResourcesRequest();
        ...
        private Amazon.Proton.Model.ListEnvironmentProvisionedResourcesResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListEnvironmentProvisionedResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "ListEnvironmentProvisionedResources");
            try
            {
                return client.ListEnvironmentProvisionedResourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String EnvironmentName { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Proton.Model.ListEnvironmentProvisionedResourcesResponse, GetPROEnvironmentProvisionedResourceListCmdlet, object> Select { get; set; } =
