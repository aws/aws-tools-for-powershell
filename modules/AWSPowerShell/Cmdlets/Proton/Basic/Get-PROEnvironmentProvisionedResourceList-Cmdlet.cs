...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    public partial class GetPROEnvironmentProvisionedResourceListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A token to indicate the location of the next environment provisioned resource in the
        ...
        private Amazon.Proton.Model.ListEnvironmentProvisionedResourcesResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListEnvironmentProvisionedResourcesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListEnvironmentProvisionedResources(request);
                #elif CORECLR
                return client.ListEnvironmentProvisionedResourcesAsync(request).GetAwaiter().GetResult();
                #else
