...
{
    /// <summary>
    /// List major or minor versions of an environment template with detail data.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPROEnvironmentTemplateVersionListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        private Amazon.Proton.Model.ListEnvironmentTemplateVersionsResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListEnvironmentTemplateVersionsRequest request)
        {
            ...
            try
            {
                return client.ListEnvironmentTemplateVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
