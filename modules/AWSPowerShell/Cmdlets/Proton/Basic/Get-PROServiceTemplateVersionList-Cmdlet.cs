...
{
    /// <summary>
    /// List major or minor versions of a service template with detail data.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.<br/><br/>This operation is deprecated.
    /// </summary>
    ...
    public partial class GetPROServiceTemplateVersionListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        private Amazon.Proton.Model.ListServiceTemplateVersionsResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListServiceTemplateVersionsRequest request)
        {
            ...
            try
            {
                return client.ListServiceTemplateVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
