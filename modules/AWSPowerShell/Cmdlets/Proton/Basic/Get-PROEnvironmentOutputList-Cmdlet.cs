...
{
    /// <summary>
    /// List the infrastructure as code outputs for your environment.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Proton.Model.Output or Amazon.Proton.Model.ListEnvironmentOutputsResponse",
        ...
        "The service call response (type Amazon.Proton.Model.ListEnvironmentOutputsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPROEnvironmentOutputListCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        private Amazon.Proton.Model.ListEnvironmentOutputsResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.ListEnvironmentOutputsRequest request)
        {
            ...
            try
            {
                return client.ListEnvironmentOutputsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
