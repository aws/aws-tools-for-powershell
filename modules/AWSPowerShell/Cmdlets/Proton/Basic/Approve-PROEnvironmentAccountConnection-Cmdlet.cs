...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    public partial class ApprovePROEnvironmentAccountConnectionCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-PROEnvironmentAccountConnection (AcceptEnvironmentAccountConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.AcceptEnvironmentAccountConnectionResponse, ApprovePROEnvironmentAccountConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.AcceptEnvironmentAccountConnectionRequest();
        ...
        private Amazon.Proton.Model.AcceptEnvironmentAccountConnectionResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.AcceptEnvironmentAccountConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "AcceptEnvironmentAccountConnection");
            try
            {
                #if DESKTOP
                return client.AcceptEnvironmentAccountConnection(request);
                #elif CORECLR
                return client.AcceptEnvironmentAccountConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Proton.Model.AcceptEnvironmentAccountConnectionResponse, ApprovePROEnvironmentAccountConnectionCmdlet, object> Select { get; set; } =
