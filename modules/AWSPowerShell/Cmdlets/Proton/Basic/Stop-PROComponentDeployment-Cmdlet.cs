...
namespace Amazon.PowerShell.Cmdlets.PRO
{
    ...
    [AWSCmdlet("Calls the AWS Proton CancelComponentDeployment API operation.", Operation = new[] {"CancelComponentDeployment"}, SelectReturnType = typeof(Amazon.Proton.Model.CancelComponentDeploymentResponse))]
    [AWSCmdletOutput("Amazon.Proton.Model.Component or Amazon.Proton.Model.CancelComponentDeploymentResponse",
        "This cmdlet returns an Amazon.Proton.Model.Component object.",
        "The service call response (type Amazon.Proton.Model.CancelComponentDeploymentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopPROComponentDeploymentCmdlet : AmazonProtonClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-PROComponentDeployment (CancelComponentDeployment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Proton.Model.CancelComponentDeploymentResponse, StopPROComponentDeploymentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Proton.Model.CancelComponentDeploymentRequest();
        ...
        private Amazon.Proton.Model.CancelComponentDeploymentResponse CallAWSServiceOperation(IAmazonProton client, Amazon.Proton.Model.CancelComponentDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Proton", "CancelComponentDeployment");
            try
            {
                #if DESKTOP
                return client.CancelComponentDeployment(request);
                #elif CORECLR
                return client.CancelComponentDeploymentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ComponentName { get; set; }
            public System.Func<Amazon.Proton.Model.CancelComponentDeploymentResponse, StopPROComponentDeploymentCmdlet, object> Select { get; set; } =
