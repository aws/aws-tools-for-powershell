#
# Module manifest for module 'AWS.Tools.Proton'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.Proton.dll'
    ...
    GUID = 'EAFCFB59-D26E-4DC7-827B-51298937CE90'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.Proton.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.Proton.Completers.psm1',
        'AWS.Tools.Proton.Aliases.psm1'
    )
