...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    /// </summary>
    [Cmdlet("Disable", "PV5GDeviceIdentifier", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Private5G.Model.DeviceIdentifier")]
    [AWSCmdlet("Calls the AWS Private 5G DeactivateDeviceIdentifier API operation.", Operation = new[] {"DeactivateDeviceIdentifier"}, SelectReturnType = typeof(Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse))]
    [AWSCmdletOutput("Amazon.Private5G.Model.DeviceIdentifier or Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse",
        "This cmdlet returns an Amazon.Private5G.Model.DeviceIdentifier object.",
        "The service call response (type Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisablePV5GDeviceIdentifierCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-PV5GDeviceIdentifier (DeactivateDeviceIdentifier)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse, DisablePV5GDeviceIdentifierCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.DeactivateDeviceIdentifierRequest();
        ...
        private Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.DeactivateDeviceIdentifierRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "DeactivateDeviceIdentifier");
            try
            {
                #if DESKTOP
                return client.DeactivateDeviceIdentifier(request);
                #elif CORECLR
                return client.DeactivateDeviceIdentifierAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String DeviceIdentifierArn { get; set; }
            public System.Func<Amazon.Private5G.Model.DeactivateDeviceIdentifierResponse, DisablePV5GDeviceIdentifierCmdlet, object> Select { get; set; } =
