...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    /// </summary>
    [Cmdlet("Ping", "PV5GPing", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class PingPV5GPingCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Ping-PV5GPing (Ping)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.PingResponse, PingPV5GPingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.PingRequest();
        ...
        private Amazon.Private5G.Model.PingResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.PingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "Ping");
            try
            {
                return client.PingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.Private5G.Model.PingResponse, PingPV5GPingCmdlet, object> Select { get; set; } =
