...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    /// Creates a network.
    /// </summary>
    [Cmdlet("New", "PV5GNetwork", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Private5G.Model.Network")]
    [AWSCmdlet("Calls the AWS Private 5G CreateNetwork API operation.", Operation = new[] {"CreateNetwork"}, SelectReturnType = typeof(Amazon.Private5G.Model.CreateNetworkResponse))]
    [AWSCmdletOutput("Amazon.Private5G.Model.Network or Amazon.Private5G.Model.CreateNetworkResponse",
        "This cmdlet returns an Amazon.Private5G.Model.Network object.",
        "The service call response (type Amazon.Private5G.Model.CreateNetworkResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewPV5GNetworkCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^NetworkName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-PV5GNetwork (CreateNetwork)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.CreateNetworkResponse, NewPV5GNetworkCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.NetworkName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.CreateNetworkRequest();
        ...
        private Amazon.Private5G.Model.CreateNetworkResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.CreateNetworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "CreateNetwork");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Private5G.Model.CreateNetworkResponse, NewPV5GNetworkCmdlet, object> Select { get; set; } =
