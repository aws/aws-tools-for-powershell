...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    [AWSCmdlet("Calls the AWS Private 5G ListDeviceIdentifiers API operation.", Operation = new[] {"ListDeviceIdentifiers"}, SelectReturnType = typeof(Amazon.Private5G.Model.ListDeviceIdentifiersResponse))]
    [AWSCmdletOutput("Amazon.Private5G.Model.DeviceIdentifier or Amazon.Private5G.Model.ListDeviceIdentifiersResponse",
        "This cmdlet returns a collection of Amazon.Private5G.Model.DeviceIdentifier objects.",
        "The service call response (type Amazon.Private5G.Model.ListDeviceIdentifiersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPV5GDeviceIdentifierListCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeviceIdentifiers";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^NetworkArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.ListDeviceIdentifiersResponse, GetPV5GDeviceIdentifierListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.NetworkArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.ListDeviceIdentifiersRequest();
        ...
        private Amazon.Private5G.Model.ListDeviceIdentifiersResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.ListDeviceIdentifiersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "ListDeviceIdentifiers");
            try
            {
                #if DESKTOP
                return client.ListDeviceIdentifiers(request);
                #elif CORECLR
                return client.ListDeviceIdentifiersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NetworkArn { get; set; }
            public System.String StartToken { get; set; }
            public System.Func<Amazon.Private5G.Model.ListDeviceIdentifiersResponse, GetPV5GDeviceIdentifierListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeviceIdentifiers;
        }
