...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    public partial class GetPV5GOrderListCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><code>NETWORK_SITE</code> - The Amazon Resource Name (ARN) of the network site.</para></li><li><para><code>STATUS</code> - The status (<code>ACKNOWLEDGING</code> | <code>ACKNOWLEDGED</code>
        /// | <code>UNACKNOWLEDGED</code>).</para></li></ul><para>Filter values are case sensitive. If you specify multiple values for a filter, the
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.ListOrdersResponse, GetPV5GOrderListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.ListOrdersRequest();
        ...
        private Amazon.Private5G.Model.ListOrdersResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.ListOrdersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "ListOrders");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NetworkArn { get; set; }
            public System.String StartToken { get; set; }
            public System.Func<Amazon.Private5G.Model.ListOrdersResponse, GetPV5GOrderListCmdlet, object> Select { get; set; } =
