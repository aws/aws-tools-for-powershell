...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    [AWSCmdletOutput("Amazon.Private5G.Model.NetworkResource or Amazon.Private5G.Model.ListNetworkResourcesResponse",
        ...
        "The service call response (type Amazon.Private5G.Model.ListNetworkResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPV5GNetworkResourceListCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><code>ORDER</code> - The Amazon Resource Name (ARN) of the order.</para></li><li><para><code>STATUS</code> - The status (<code>AVAILABLE</code> | <code>DELETED</code> |
        /// <code>DELETING</code> | <code>PENDING</code> | <code>PENDING_RETURN</code> | <code>PROVISIONING</code>
        /// | <code>SHIPPED</code>).</para></li></ul><para>Filter values are case sensitive. If you specify multiple values for a filter, the
        ...
        private Amazon.Private5G.Model.ListNetworkResourcesResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.ListNetworkResourcesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListNetworkResources(request);
                #elif CORECLR
                return client.ListNetworkResourcesAsync(request).GetAwaiter().GetResult();
                #else
