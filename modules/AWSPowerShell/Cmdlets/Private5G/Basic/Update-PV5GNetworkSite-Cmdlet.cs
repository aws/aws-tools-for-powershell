...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    /// </summary>
    [Cmdlet("Update", "PV5GNetworkSite", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Private5G.Model.NetworkSite")]
    [AWSCmdlet("Calls the AWS Private 5G UpdateNetworkSite API operation.", Operation = new[] {"UpdateNetworkSite"}, SelectReturnType = typeof(Amazon.Private5G.Model.UpdateNetworkSiteResponse))]
    [AWSCmdletOutput("Amazon.Private5G.Model.NetworkSite or Amazon.Private5G.Model.UpdateNetworkSiteResponse",
        "This cmdlet returns an Amazon.Private5G.Model.NetworkSite object.",
        "The service call response (type Amazon.Private5G.Model.UpdateNetworkSiteResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdatePV5GNetworkSiteCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-PV5GNetworkSite (UpdateNetworkSite)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.UpdateNetworkSiteResponse, UpdatePV5GNetworkSiteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.UpdateNetworkSiteRequest();
        ...
        private Amazon.Private5G.Model.UpdateNetworkSiteResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.UpdateNetworkSiteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "UpdateNetworkSite");
            try
            {
                #if DESKTOP
                return client.UpdateNetworkSite(request);
                #elif CORECLR
                return client.UpdateNetworkSiteAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String NetworkSiteArn { get; set; }
            public System.Func<Amazon.Private5G.Model.UpdateNetworkSiteResponse, UpdatePV5GNetworkSiteCmdlet, object> Select { get; set; } =
