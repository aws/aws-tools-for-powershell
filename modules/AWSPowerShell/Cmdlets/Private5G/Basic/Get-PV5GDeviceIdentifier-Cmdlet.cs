...
namespace Amazon.PowerShell.Cmdlets.PV5G
{
    ...
    /// </summary>
    [Cmdlet("Get", "PV5GDeviceIdentifier")]
    ...
    public partial class GetPV5GDeviceIdentifierCmdlet : AmazonPrivate5GClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Private5G.Model.GetDeviceIdentifierResponse, GetPV5GDeviceIdentifierCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Private5G.Model.GetDeviceIdentifierRequest();
        ...
        private Amazon.Private5G.Model.GetDeviceIdentifierResponse CallAWSServiceOperation(IAmazonPrivate5G client, Amazon.Private5G.Model.GetDeviceIdentifierRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Private 5G", "GetDeviceIdentifier");
            try
            {
                #if DESKTOP
                return client.GetDeviceIdentifier(request);
                #elif CORECLR
                return client.GetDeviceIdentifierAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DeviceIdentifierArn { get; set; }
            public System.Func<Amazon.Private5G.Model.GetDeviceIdentifierResponse, GetPV5GDeviceIdentifierCmdlet, object> Select { get; set; } =
