...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    /// the flow.
    /// </summary>
    [Cmdlet("Stop", "AFFlow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopAFFlowCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-AFFlow (StopFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Appflow.Model.StopFlowResponse, StopAFFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Appflow.Model.StopFlowRequest();
        ...
        private Amazon.Appflow.Model.StopFlowResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.StopFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Appflow", "StopFlow");
            try
            {
        ...
        {
            public System.String FlowName { get; set; }
            public System.Func<Amazon.Appflow.Model.StopFlowResponse, StopAFFlowCmdlet, object> Select { get; set; } =
