...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    public partial class UpdateAFConnectorProfileCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        /// <code>UpdateConnectorProfile</code> request completes only once. You choose the value
        ...
        /// it a new call to <code>UpdateConnectorProfile</code>. The token is active for 8 hours.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
