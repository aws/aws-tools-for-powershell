...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    /// </summary>
    [Cmdlet("Add", "AFResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddAFResourceTagCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-AFResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Appflow.Model.TagResourceResponse, AddAFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Appflow.Model.TagResourceRequest();
        ...
        private Amazon.Appflow.Model.TagResourceResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Appflow", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Appflow.Model.TagResourceResponse, AddAFResourceTagCmdlet, object> Select { get; set; } =
