...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AFResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAFResourceTagCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The tag keys associated with the tag that you want to remove from your flow. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AFResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Appflow.Model.UntagResourceResponse, RemoveAFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Appflow.Model.UntagResourceRequest();
        ...
        private Amazon.Appflow.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Appflow", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Appflow.Model.UntagResourceResponse, RemoveAFResourceTagCmdlet, object> Select { get; set; } =
