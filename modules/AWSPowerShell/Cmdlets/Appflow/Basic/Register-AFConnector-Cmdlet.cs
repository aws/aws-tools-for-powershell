...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    public partial class RegisterAFConnectorCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        /// retry the request with the same <code>clientToken</code> parameter value.</para><para>If you omit a <code>clientToken</code> value, the Amazon Web Services SDK that you
        ...
        /// it a new call to <code>RegisterConnector</code>. The token is active for 8 hours.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
