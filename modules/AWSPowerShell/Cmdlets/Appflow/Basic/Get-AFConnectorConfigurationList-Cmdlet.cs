...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    /// next call to the <c>DescribeConnectors</c> API operation to retrieve the next page.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("System.String or Amazon.Appflow.Model.DescribeConnectorsResponse",
        ...
        "The service call response (type Amazon.Appflow.Model.DescribeConnectorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAFConnectorConfigurationListCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The type of connector, such as Salesforce, Amplitude, and so on. </para><para />
        ...
        private Amazon.Appflow.Model.DescribeConnectorsResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.DescribeConnectorsRequest request)
        {
            ...
            try
            {
                return client.DescribeConnectorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
