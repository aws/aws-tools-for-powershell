...
{
    /// <summary>
    /// Fetches the execution history of the flow.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Appflow.Model.ExecutionRecord or Amazon.Appflow.Model.DescribeFlowExecutionRecordsResponse",
        ...
        "The service call response (type Amazon.Appflow.Model.DescribeFlowExecutionRecordsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAFFlowExecutionRecordCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        private Amazon.Appflow.Model.DescribeFlowExecutionRecordsResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.DescribeFlowExecutionRecordsRequest request)
        {
            ...
            try
            {
                return client.DescribeFlowExecutionRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
