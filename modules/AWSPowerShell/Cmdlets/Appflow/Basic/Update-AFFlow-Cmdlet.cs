...
namespace Amazon.PowerShell.Cmdlets.AF
{
    ...
    public partial class UpdateAFFlowCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        /// <code>UpdateFlow</code> request completes only once. You choose the value to pass.
        ...
        /// it a new call to <code>UpdateFlow</code>. The token is active for 8 hours.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
