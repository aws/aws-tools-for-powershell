...
{
    /// <summary>
    /// Lists all of the flows associated with your account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AFFlowList")]
    [OutputType("Amazon.Appflow.Model.FlowDefinition")]
    ...
    public partial class GetAFFlowListCmdlet : AmazonAppflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Appflow.Model.ListFlowsResponse, GetAFFlowListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Appflow.Model.ListFlowsRequest();
        ...
        private Amazon.Appflow.Model.ListFlowsResponse CallAWSServiceOperation(IAmazonAppflow client, Amazon.Appflow.Model.ListFlowsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Appflow", "ListFlows");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Appflow.Model.ListFlowsResponse, GetAFFlowListCmdlet, object> Select { get; set; } =
