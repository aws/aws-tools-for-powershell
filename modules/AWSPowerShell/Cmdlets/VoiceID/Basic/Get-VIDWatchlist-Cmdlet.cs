...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    /// </summary>
    [Cmdlet("Get", "VIDWatchlist")]
    [OutputType("Amazon.VoiceID.Model.Watchlist")]
    [AWSCmdlet("Calls the Amazon Voice ID DescribeWatchlist API operation.", Operation = new[] {"DescribeWatchlist"}, SelectReturnType = typeof(Amazon.VoiceID.Model.DescribeWatchlistResponse))]
    [AWSCmdletOutput("Amazon.VoiceID.Model.Watchlist or Amazon.VoiceID.Model.DescribeWatchlistResponse",
        "This cmdlet returns an Amazon.VoiceID.Model.Watchlist object.",
        "The service call response (type Amazon.VoiceID.Model.DescribeWatchlistResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetVIDWatchlistCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VoiceID.Model.DescribeWatchlistResponse, GetVIDWatchlistCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VoiceID.Model.DescribeWatchlistRequest();
        ...
        private Amazon.VoiceID.Model.DescribeWatchlistResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.DescribeWatchlistRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Voice ID", "DescribeWatchlist");
            try
            {
                #if DESKTOP
                return client.DescribeWatchlist(request);
                #elif CORECLR
                return client.DescribeWatchlistAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String WatchlistId { get; set; }
            public System.Func<Amazon.VoiceID.Model.DescribeWatchlistResponse, GetVIDWatchlistCmdlet, object> Select { get; set; } =
