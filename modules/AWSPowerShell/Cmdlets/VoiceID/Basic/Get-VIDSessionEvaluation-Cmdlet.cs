...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    /// </summary>
    [Cmdlet("Get", "VIDSessionEvaluation")]
    ...
    public partial class GetVIDSessionEvaluationCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        #region Parameter SessionNameOrId
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String SessionNameOrId { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SessionNameOrId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VoiceID.Model.EvaluateSessionResponse, GetVIDSessionEvaluationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SessionNameOrId;
            }
            ...
            #endif
            context.SessionNameOrId = this.SessionNameOrId;
            #if MODULAR
            if (this.SessionNameOrId == null && ParameterWasBound(nameof(this.SessionNameOrId)))
            {
                WriteWarning("You are passing $null as a value for parameter SessionNameOrId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VoiceID.Model.EvaluateSessionRequest();
            
            if (cmdletContext.DomainId != null)
            {
                request.DomainId = cmdletContext.DomainId;
            }
            if (cmdletContext.SessionNameOrId != null)
            {
                request.SessionNameOrId = cmdletContext.SessionNameOrId;
            }
        ...
        private Amazon.VoiceID.Model.EvaluateSessionResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.EvaluateSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Voice ID", "EvaluateSession");
            try
            {
                #if DESKTOP
                return client.EvaluateSession(request);
                #elif CORECLR
                return client.EvaluateSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String SessionNameOrId { get; set; }
            public System.Func<Amazon.VoiceID.Model.EvaluateSessionResponse, GetVIDSessionEvaluationCmdlet, object> Select { get; set; } =
