...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    [AWSCmdletOutput("None or Amazon.VoiceID.Model.DeleteWatchlistResponse",
        ...
        "The service response (type Amazon.VoiceID.Model.DeleteWatchlistResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
