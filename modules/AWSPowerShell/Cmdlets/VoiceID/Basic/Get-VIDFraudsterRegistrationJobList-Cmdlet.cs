...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    /// the given domain.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetVIDFraudsterRegistrationJobListCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        private Amazon.VoiceID.Model.ListFraudsterRegistrationJobsResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.ListFraudsterRegistrationJobsRequest request)
        {
            ...
            try
            {
                return client.ListFraudsterRegistrationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
