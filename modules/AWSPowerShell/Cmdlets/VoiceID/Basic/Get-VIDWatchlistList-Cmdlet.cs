...
{
    /// <summary>
    /// Lists all watchlists in a specified domain.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "VIDWatchlistList")]
    [OutputType("Amazon.VoiceID.Model.WatchlistSummary")]
    ...
    public partial class GetVIDWatchlistListCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WatchlistSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VoiceID.Model.ListWatchlistsResponse, GetVIDWatchlistListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.VoiceID.Model.ListWatchlistsRequest();
        ...
        private Amazon.VoiceID.Model.ListWatchlistsResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.ListWatchlistsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Voice ID", "ListWatchlists");
            try
            {
                return client.ListWatchlistsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.VoiceID.Model.ListWatchlistsResponse, GetVIDWatchlistListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WatchlistSummaries;
        }
