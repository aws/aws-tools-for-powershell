...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    /// Voice ID.
    /// </summary>
    [Cmdlet("Set", "VIDOptOutSpeaker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.VoiceID.Model.Speaker")]
    ...
    public partial class SetVIDOptOutSpeakerCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String SpeakerId { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Speaker";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SpeakerId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-VIDOptOutSpeaker (OptOutSpeaker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VoiceID.Model.OptOutSpeakerResponse, SetVIDOptOutSpeakerCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SpeakerId;
            }
            ...
            #endif
            context.SpeakerId = this.SpeakerId;
            #if MODULAR
            if (this.SpeakerId == null && ParameterWasBound(nameof(this.SpeakerId)))
            {
                WriteWarning("You are passing $null as a value for parameter SpeakerId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VoiceID.Model.OptOutSpeakerRequest();
            
            if (cmdletContext.DomainId != null)
            {
                request.DomainId = cmdletContext.DomainId;
            }
            if (cmdletContext.SpeakerId != null)
            {
                request.SpeakerId = cmdletContext.SpeakerId;
            }
        ...
        private Amazon.VoiceID.Model.OptOutSpeakerResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.OptOutSpeakerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Voice ID", "OptOutSpeaker");
            try
            {
                #if DESKTOP
                return client.OptOutSpeaker(request);
                #elif CORECLR
                return client.OptOutSpeakerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String SpeakerId { get; set; }
            public System.Func<Amazon.VoiceID.Model.OptOutSpeakerResponse, SetVIDOptOutSpeakerCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Speaker;
        }
