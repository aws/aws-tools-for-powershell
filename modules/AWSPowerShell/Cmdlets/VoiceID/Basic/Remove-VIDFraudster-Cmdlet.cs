...
namespace Amazon.PowerShell.Cmdlets.VID
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Voice ID DeleteFraudster API operation.", Operation = new[] {"DeleteFraudster"}, SelectReturnType = typeof(Amazon.VoiceID.Model.DeleteFraudsterResponse))]
    [AWSCmdletOutput("None or Amazon.VoiceID.Model.DeleteFraudsterResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.VoiceID.Model.DeleteFraudsterResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveVIDFraudsterCmdlet : AmazonVoiceIDClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VoiceID.Model.DeleteFraudsterResponse, RemoveVIDFraudsterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VoiceID.Model.DeleteFraudsterRequest();
        ...
        private Amazon.VoiceID.Model.DeleteFraudsterResponse CallAWSServiceOperation(IAmazonVoiceID client, Amazon.VoiceID.Model.DeleteFraudsterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Voice ID", "DeleteFraudster");
            try
            {
                #if DESKTOP
                return client.DeleteFraudster(request);
                #elif CORECLR
                return client.DeleteFraudsterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String FraudsterId { get; set; }
            public System.Func<Amazon.VoiceID.Model.DeleteFraudsterResponse, RemoveVIDFraudsterCmdlet, object> Select { get; set; } =
