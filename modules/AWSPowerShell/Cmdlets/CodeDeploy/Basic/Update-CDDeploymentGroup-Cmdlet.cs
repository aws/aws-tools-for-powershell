...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class UpdateCDDeploymentGroupCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            #if MODULAR
            if (this.CurrentDeploymentGroupName == null && ParameterWasBound(nameof(this.CurrentDeploymentGroupName)))
            {
                WriteWarning("You are passing $null as a value for parameter CurrentDeploymentGroupName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
