...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    /// </summary>
    [Cmdlet("Get", "CDOnPremiseInstanceBatch")]
    ...
    public partial class GetCDOnPremiseInstanceBatchCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// number of instance names you can specify is 25.</para><para />
        ...
        public string Select { get; set; } = "InstanceInfos";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.BatchGetOnPremisesInstancesResponse, GetCDOnPremiseInstanceBatchCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.BatchGetOnPremisesInstancesResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.BatchGetOnPremisesInstancesRequest request)
        {
            ...
            try
            {
                return client.BatchGetOnPremisesInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeDeploy.Model.BatchGetOnPremisesInstancesResponse, GetCDOnPremiseInstanceBatchCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceInfos;
        }
