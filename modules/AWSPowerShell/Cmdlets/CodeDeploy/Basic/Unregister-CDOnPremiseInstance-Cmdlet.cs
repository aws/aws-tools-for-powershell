...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class UnregisterCDOnPremiseInstanceCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.DeregisterOnPremisesInstanceResponse, UnregisterCDOnPremiseInstanceCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.DeregisterOnPremisesInstanceResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.DeregisterOnPremisesInstanceRequest request)
        {
            ...
            try
            {
                return client.DeregisterOnPremisesInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InstanceName { get; set; }
            public System.Func<Amazon.CodeDeploy.Model.DeregisterOnPremisesInstanceResponse, UnregisterCDOnPremiseInstanceCmdlet, object> Select { get; set; } =
