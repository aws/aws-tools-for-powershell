...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CodeDeploy RemoveTagsFromOnPremisesInstances API operation.", Operation = new[] {"RemoveTagsFromOnPremisesInstances"}, SelectReturnType = typeof(Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse))]
    [AWSCmdletOutput("None or Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCDOnPremiseInstanceTagCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse, RemoveCDOnPremiseInstanceTagCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesRequest request)
        {
            ...
            try
            {
                return client.RemoveTagsFromOnPremisesInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeDeploy.Model.RemoveTagsFromOnPremisesInstancesResponse, RemoveCDOnPremiseInstanceTagCmdlet, object> Select { get; set; } =
