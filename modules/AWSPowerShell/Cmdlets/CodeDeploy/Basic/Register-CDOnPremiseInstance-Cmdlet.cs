...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class RegisterCDOnPremiseInstanceCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.RegisterOnPremisesInstanceResponse, RegisterCDOnPremiseInstanceCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.RegisterOnPremisesInstanceResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.RegisterOnPremisesInstanceRequest request)
        {
            ...
            try
            {
                return client.RegisterOnPremisesInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IamUserArn { get; set; }
            public System.String InstanceName { get; set; }
            public System.Func<Amazon.CodeDeploy.Model.RegisterOnPremisesInstanceResponse, RegisterCDOnPremiseInstanceCmdlet, object> Select { get; set; } =
