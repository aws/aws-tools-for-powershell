...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class AddCDResourceTagCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// identified by the <c>ResourceArn</c> input parameter. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CDResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.TagResourceResponse, AddCDResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeDeploy.Model.TagResourceRequest();
        ...
        private Amazon.CodeDeploy.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeDeploy", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeDeploy.Model.TagResourceResponse, AddCDResourceTagCmdlet, object> Select { get; set; } =
