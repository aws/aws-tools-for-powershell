...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class GetCDDeploymentInstanceCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceSummary";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.GetDeploymentInstanceResponse, GetCDDeploymentInstanceCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.GetDeploymentInstanceResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.GetDeploymentInstanceRequest request)
        {
            ...
            try
            {
                return client.GetDeploymentInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DeploymentId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.CodeDeploy.Model.GetDeploymentInstanceResponse, GetCDDeploymentInstanceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceSummary;
        }
