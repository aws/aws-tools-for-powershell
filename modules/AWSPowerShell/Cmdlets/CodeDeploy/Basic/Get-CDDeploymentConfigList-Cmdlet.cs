...
{
    /// <summary>
    /// Lists the deployment configurations with the user or Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCDDeploymentConfigListCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An identifier returned from the previous <c>ListDeploymentConfigs</c> call. It can
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeploymentConfigsList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.ListDeploymentConfigsResponse, GetCDDeploymentConfigListCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.ListDeploymentConfigsResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.ListDeploymentConfigsRequest request)
        {
            ...
            try
            {
                return client.ListDeploymentConfigsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodeDeploy.Model.ListDeploymentConfigsResponse, GetCDDeploymentConfigListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeploymentConfigsList;
        }
