...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    public partial class GetCDDeploymentInstanceBatchCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// IDs you can specify is 25.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeDeploy.Model.BatchGetDeploymentInstancesResponse, GetCDDeploymentInstanceBatchCmdlet>(Select) ??
        ...
        private Amazon.CodeDeploy.Model.BatchGetDeploymentInstancesResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.BatchGetDeploymentInstancesRequest request)
        {
            ...
            try
            {
                return client.BatchGetDeploymentInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeDeploy.Model.BatchGetDeploymentInstancesResponse, GetCDDeploymentInstanceBatchCmdlet, object> Select { get; set; } =
