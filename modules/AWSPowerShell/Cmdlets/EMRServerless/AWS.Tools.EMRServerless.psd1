#
# Module manifest for module 'AWS.Tools.EMRServerless'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.EMRServerless.dll'
    ...
    Description = 'The EMRServerless module of AWS Tools for PowerShell lets developers and administrators manage EMR Serverless from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.EMRServerless.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.EMRServerless.Completers.psm1',
        'AWS.Tools.EMRServerless.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.EMRServerless.dll-Help.xml'
    )
