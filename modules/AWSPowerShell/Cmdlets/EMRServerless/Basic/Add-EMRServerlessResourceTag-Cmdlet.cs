...
namespace Amazon.PowerShell.Cmdlets.EMRServerless
{
    ...
    public partial class AddEMRServerlessResourceTagCmdlet : AmazonEMRServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to add to the resource. A tag is an array of key-value pairs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EMRServerlessResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EMRServerless.Model.TagResourceResponse, AddEMRServerlessResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EMRServerless.Model.TagResourceRequest();
        ...
        private Amazon.EMRServerless.Model.TagResourceResponse CallAWSServiceOperation(IAmazonEMRServerless client, Amazon.EMRServerless.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EMR Serverless", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EMRServerless.Model.TagResourceResponse, AddEMRServerlessResourceTagCmdlet, object> Select { get; set; } =
