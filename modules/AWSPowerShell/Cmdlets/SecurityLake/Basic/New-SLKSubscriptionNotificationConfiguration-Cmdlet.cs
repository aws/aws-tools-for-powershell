...
namespace Amazon.PowerShell.Cmdlets.SLK
{
    ...
    [AWSCmdlet("Calls the Amazon Security Lake CreateSubscriptionNotificationConfiguration API operation.", Operation = new[] {"CreateSubscriptionNotificationConfiguration"}, SelectReturnType = typeof(Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse))]
    [AWSCmdletOutput("System.String or Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSLKSubscriptionNotificationConfigurationCmdlet : AmazonSecurityLakeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SLKSubscriptionNotificationConfiguration (CreateSubscriptionNotificationConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse, NewSLKSubscriptionNotificationConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationRequest();
        ...
        private Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse CallAWSServiceOperation(IAmazonSecurityLake client, Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Security Lake", "CreateSubscriptionNotificationConfiguration");
            try
            {
                #if DESKTOP
                return client.CreateSubscriptionNotificationConfiguration(request);
                #elif CORECLR
                return client.CreateSubscriptionNotificationConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SubscriptionEndpoint { get; set; }
            public System.String SubscriptionId { get; set; }
            public System.Func<Amazon.SecurityLake.Model.CreateSubscriptionNotificationConfigurationResponse, NewSLKSubscriptionNotificationConfigurationCmdlet, object> Select { get; set; } =
