...
namespace Amazon.PowerShell.Cmdlets.SLK
{
    ...
    /// and fix them.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetSLKDataLakeExceptionListCmdlet : AmazonSecurityLakeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Web Services Regions from which exceptions are retrieved.</para><para />
        ...
        private Amazon.SecurityLake.Model.ListDataLakeExceptionsResponse CallAWSServiceOperation(IAmazonSecurityLake client, Amazon.SecurityLake.Model.ListDataLakeExceptionsRequest request)
        {
            ...
            try
            {
                return client.ListDataLakeExceptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
