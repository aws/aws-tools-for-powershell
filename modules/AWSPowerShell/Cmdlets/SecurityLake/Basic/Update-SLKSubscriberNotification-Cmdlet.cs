...
namespace Amazon.PowerShell.Cmdlets.SLK
{
    ...
    /// </summary>
    [Cmdlet("Update", "SLKSubscriberNotification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateSLKSubscriberNotificationCmdlet : AmazonSecurityLakeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SLKSubscriberNotification (UpdateSubscriberNotification)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityLake.Model.UpdateSubscriberNotificationResponse, UpdateSLKSubscriberNotificationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityLake.Model.UpdateSubscriberNotificationRequest();
        ...
        private Amazon.SecurityLake.Model.UpdateSubscriberNotificationResponse CallAWSServiceOperation(IAmazonSecurityLake client, Amazon.SecurityLake.Model.UpdateSubscriberNotificationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Security Lake", "UpdateSubscriberNotification");
            try
            {
                #if DESKTOP
                return client.UpdateSubscriberNotification(request);
                #elif CORECLR
                return client.UpdateSubscriberNotificationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SecurityLake.Model.SqsNotificationConfiguration Configuration_SqsNotificationConfiguration { get; set; }
            public System.String SubscriberId { get; set; }
            public System.Func<Amazon.SecurityLake.Model.UpdateSubscriberNotificationResponse, UpdateSLKSubscriberNotificationCmdlet, object> Select { get; set; } =
