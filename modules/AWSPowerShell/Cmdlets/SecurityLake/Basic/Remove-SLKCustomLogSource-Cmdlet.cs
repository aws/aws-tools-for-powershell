...
namespace Amazon.PowerShell.Cmdlets.SLK
{
    ...
    [AWSCmdletOutput("None or Amazon.SecurityLake.Model.DeleteCustomLogSourceResponse",
        ...
        "The service response (type Amazon.SecurityLake.Model.DeleteCustomLogSourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSLKCustomLogSourceCmdlet : AmazonSecurityLakeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityLake.Model.DeleteCustomLogSourceResponse, RemoveSLKCustomLogSourceCmdlet>(Select) ??
        ...
        private Amazon.SecurityLake.Model.DeleteCustomLogSourceResponse CallAWSServiceOperation(IAmazonSecurityLake client, Amazon.SecurityLake.Model.DeleteCustomLogSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Security Lake", "DeleteCustomLogSource");
            try
            {
                #if DESKTOP
                return client.DeleteCustomLogSource(request);
                #elif CORECLR
                return client.DeleteCustomLogSourceAsync(request).GetAwaiter().GetResult();
                #else
