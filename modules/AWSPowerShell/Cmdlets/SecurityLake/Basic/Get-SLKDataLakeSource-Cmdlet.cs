...
namespace Amazon.PowerShell.Cmdlets.SLK
{
    ...
    /// is enabled for those accounts and which sources Security Lake is collecting data from.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetSLKDataLakeSourceCmdlet : AmazonSecurityLakeClientCmdlet, IExecutor
    {
        ...
        /// Web Services Region, including enabled accounts and log sources, is retrieved.</para><para />
        ...
        private Amazon.SecurityLake.Model.GetDataLakeSourcesResponse CallAWSServiceOperation(IAmazonSecurityLake client, Amazon.SecurityLake.Model.GetDataLakeSourcesRequest request)
        {
            ...
            try
            {
                return client.GetDataLakeSourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
