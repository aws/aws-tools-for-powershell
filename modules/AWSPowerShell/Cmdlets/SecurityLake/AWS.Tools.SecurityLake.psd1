#
# Module manifest for module 'AWS.Tools.SecurityLake'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SecurityLake.dll'
    ...
    GUID = '4b173dff-7542-48e7-8c25-55e8080af6fa'
    ...
    Description = 'The SecurityLake module of AWS Tools for PowerShell lets developers and administrators manage Amazon Security Lake from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SecurityLake.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SecurityLake.Completers.psm1',
        'AWS.Tools.SecurityLake.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.SecurityLake.dll-Help.xml'
    )
