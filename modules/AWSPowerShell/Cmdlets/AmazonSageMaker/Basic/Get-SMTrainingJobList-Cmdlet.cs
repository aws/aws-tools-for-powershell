...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListTrainingJobs API operation.", Operation = new[] {"ListTrainingJobs"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.TrainingJobSummary",
        "This cmdlet returns a collection of TrainingJobSummary objects.",
    ...
    public partial class GetSMTrainingJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListTrainingJobsRequest();
        ...
        private Amazon.SageMaker.Model.ListTrainingJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListTrainingJobsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListTrainingJobsAsync(request);
                return task.Result;
                #else
