...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListHyperParameterTuningJobs API operation.", Operation = new[] {"ListHyperParameterTuningJobs"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.HyperParameterTuningJobSummary",
        "This cmdlet returns a collection of HyperParameterTuningJobSummary objects.",
    ...
    public partial class GetSMHyperParameterTuningJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.HyperParameterTuningJobSummaries;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.HyperParameterTuningJobSortByOptions SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.HyperParameterTuningJobStatus StatusEquals { get; set; }
        }
