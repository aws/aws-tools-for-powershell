...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListSubscribedWorkteams API operation.", Operation = new[] {"ListSubscribedWorkteams"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.SubscribedWorkteam",
        "This cmdlet returns a collection of SubscribedWorkteam objects.",
        "The service call response (type Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSMSubscribedWorkteamListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListSubscribedWorkteamsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SubscribedWorkteams;
                        ...
                        int _receivedThisCall = response.SubscribedWorkteams.Count;
        ...
        private Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListSubscribedWorkteamsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListSubscribedWorkteamsAsync(request);
                return task.Result;
                #else
