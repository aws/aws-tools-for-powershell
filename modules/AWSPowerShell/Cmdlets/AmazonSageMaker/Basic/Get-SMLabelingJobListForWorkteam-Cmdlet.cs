...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListLabelingJobsForWorkteam API operation.", Operation = new[] {"ListLabelingJobsForWorkteam"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.LabelingJobForWorkteamSummary",
        "This cmdlet returns a collection of LabelingJobForWorkteamSummary objects.",
    ...
    public partial class GetSMLabelingJobListForWorkteamCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.JobReferenceCodeContains = this.JobReferenceCodeContain;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.JobReferenceCodeContains != null)
            {
                request.JobReferenceCodeContains = cmdletContext.JobReferenceCodeContains;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.DateTime? CreationTimeAfter { get; set; }
            public System.DateTime? CreationTimeBefore { get; set; }
            public System.String JobReferenceCodeContains { get; set; }
