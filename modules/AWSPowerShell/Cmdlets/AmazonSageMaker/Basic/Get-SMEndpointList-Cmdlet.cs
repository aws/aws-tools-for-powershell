...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMEndpointList")]
    [OutputType("Amazon.SageMaker.Model.EndpointSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListEndpoints API operation.", Operation = new[] {"ListEndpoints"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.EndpointSummary",
        "This cmdlet returns a collection of EndpointSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListEndpointsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSMEndpointListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        
        #region Parameter CreationTimeAfter
        /// <summary>
        /// <para>
        /// <para>A filter that returns only endpoints that were created after the specified time (timestamp).</para>
        /// </para>
        /// </summary>
        ...
        /// </summary>
        [System.Management.Automation.Parameter]
        [AWSConstantClassSource("Amazon.SageMaker.EndpointSortKey")]
        public Amazon.SageMaker.EndpointSortKey SortBy { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.EndpointStatus")]
        public Amazon.SageMaker.EndpointStatus StatusEqual { get; set; }
        #endregion
        ...
        private Amazon.SageMaker.Model.ListEndpointsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListEndpoints");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.EndpointSortKey SortBy { get; set; }
            public Amazon.SageMaker.OrderKey SortOrder { get; set; }
            public Amazon.SageMaker.EndpointStatus StatusEquals { get; set; }
        }
