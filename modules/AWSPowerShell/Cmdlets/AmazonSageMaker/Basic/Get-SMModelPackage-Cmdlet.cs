...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeModelPackage API operation.", Operation = new[] {"DescribeModelPackage"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeModelPackageResponse",
        "This cmdlet returns a Amazon.SageMaker.Model.DescribeModelPackageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMModelPackageCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.SageMaker.Model.DescribeModelPackageResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeModelPackageRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeModelPackageAsync(request);
                return task.Result;
                #else
