...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListCodeRepositories API operation.", Operation = new[] {"ListCodeRepositories"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.CodeRepositorySummary",
        "This cmdlet returns a collection of CodeRepositorySummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListCodeRepositoriesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetSMCodeRepositoryListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CodeRepositorySummaryList;
        ...
        private Amazon.SageMaker.Model.ListCodeRepositoriesResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListCodeRepositoriesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListCodeRepositoriesAsync(request);
                return task.Result;
                #else
