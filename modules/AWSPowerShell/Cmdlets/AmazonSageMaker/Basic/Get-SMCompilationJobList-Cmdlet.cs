...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [OutputType("Amazon.SageMaker.Model.CompilationJobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListCompilationJobs API operation.", Operation = new[] {"ListCompilationJobs"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.CompilationJobSummary",
        "This cmdlet returns a collection of CompilationJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListCompilationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSMCompilationJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        [System.Management.Automation.Parameter]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.CompilationJobStatus")]
        public Amazon.SageMaker.CompilationJobStatus StatusEqual { get; set; }
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListCompilationJobsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CompilationJobSummaries;
                        ...
                        int _receivedThisCall = response.CompilationJobSummaries.Count;
        ...
        private Amazon.SageMaker.Model.ListCompilationJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListCompilationJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListCompilationJobs");
            try
            {
                #if DESKTOP
                return client.ListCompilationJobs(request);
                #elif CORECLR
                return client.ListCompilationJobsAsync(request).GetAwaiter().GetResult();
                #else
