...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListAlgorithms API operation.", Operation = new[] {"ListAlgorithms"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.AlgorithmSummary",
        "This cmdlet returns a collection of AlgorithmSummary objects.",
    ...
    public partial class GetSMAlgorithmListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.AlgorithmSummaryList;
        ...
        private Amazon.SageMaker.Model.ListAlgorithmsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListAlgorithmsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListAlgorithmsAsync(request);
                return task.Result;
                #else
