...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service StopCompilationJob API operation.", Operation = new[] {"StopCompilationJob"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the CompilationJobName parameter. Otherwise, this cmdlet does not return any output. " +
        "The service response (type Amazon.SageMaker.Model.StopCompilationJobResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopSMCompilationJobCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.CompilationJobName;
        ...
        private Amazon.SageMaker.Model.StopCompilationJobResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.StopCompilationJobRequest request)
        {
            ...
            try
            {
                ...
                var task = client.StopCompilationJobAsync(request);
                return task.Result;
                #else
