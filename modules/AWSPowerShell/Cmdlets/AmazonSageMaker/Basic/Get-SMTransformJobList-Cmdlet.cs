...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListTransformJobs API operation.", Operation = new[] {"ListTransformJobs"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.TransformJobSummary",
        "This cmdlet returns a collection of TransformJobSummary objects.",
    ...
    public partial class GetSMTransformJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TransformJobSummaries;
        ...
        private Amazon.SageMaker.Model.ListTransformJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListTransformJobsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListTransformJobsAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.TransformJobStatus StatusEquals { get; set; }
        }
