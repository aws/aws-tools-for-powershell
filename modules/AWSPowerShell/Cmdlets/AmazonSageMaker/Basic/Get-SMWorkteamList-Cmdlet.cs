...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListWorkteams API operation.", Operation = new[] {"ListWorkteams"})]
    [AWSCmdletOutput("Amazon.SageMaker.Model.Workteam",
        "This cmdlet returns a collection of Workteam objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Workteams;
