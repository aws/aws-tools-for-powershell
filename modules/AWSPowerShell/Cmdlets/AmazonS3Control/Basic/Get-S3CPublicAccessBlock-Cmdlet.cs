...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    [AWSCmdlet("Calls the Amazon S3 Control GetPublicAccessBlock API operation.", Operation = new[] {"GetPublicAccessBlock"})]
    [AWSCmdletOutput("Amazon.S3Control.Model.PublicAccessBlockConfiguration",
