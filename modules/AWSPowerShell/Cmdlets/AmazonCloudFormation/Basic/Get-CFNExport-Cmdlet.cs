...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [OutputType("Amazon.CloudFormation.Model.Export")]
    [AWSCmdlet("Invokes the ListExports operation against AWS CloudFormation.", Operation = new[] {"ListExports"})]
    [AWSCmdletOutput("Amazon.CloudFormation.Model.Export",
        "This cmdlet returns a collection of Export objects.",
    ...
    public partial class GetCFNExportCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudFormation.Model.ListExportsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Exports;
                        ...
                        {
                            int _receivedThisCall = response.Exports.Count;
        ...
        private Amazon.CloudFormation.Model.ListExportsResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.ListExportsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudFormation", "ListExports");
            #if DESKTOP
            return client.ListExports(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListExportsAsync(request);
            return task.Result;
            #else
