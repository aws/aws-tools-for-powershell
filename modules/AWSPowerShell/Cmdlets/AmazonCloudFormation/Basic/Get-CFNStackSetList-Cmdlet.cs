...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdlet("Invokes the ListStackSets operation against AWS CloudFormation.", Operation = new[] {"ListStackSets"})]
    [AWSCmdletOutput("Amazon.CloudFormation.Model.StackSetSummary",
        "This cmdlet returns a collection of StackSetSummary objects.",
    ...
    public partial class GetCFNStackSetListCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        private Amazon.CloudFormation.Model.ListStackSetsResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.ListStackSetsRequest request)
        {
            ...
            var task = client.ListStackSetsAsync(request);
            return task.Result;
            #else
