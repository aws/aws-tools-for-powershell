...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    public class UpdateCFNStackCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of capabilities that you must specify before AWS CloudFormation can update
        ...
        /// by specifying this parameter.</para><para>Currently, the only valid value is <code>CAPABILITY_IAM</code>, which is required
