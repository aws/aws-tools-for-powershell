...
namespace Amazon.PowerShell.Cmdlets.CFN
{
    ...
    [AWSCmdlet("Invokes the DescribeStackInstance operation against AWS CloudFormation.", Operation = new[] {"DescribeStackInstance"})]
    [AWSCmdletOutput("Amazon.CloudFormation.Model.StackInstance",
        "This cmdlet returns a StackInstance object.",
    ...
    public partial class GetCFNStackInstanceCmdlet : AmazonCloudFormationClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.StackInstance;
        ...
        private Amazon.CloudFormation.Model.DescribeStackInstanceResponse CallAWSServiceOperation(IAmazonCloudFormation client, Amazon.CloudFormation.Model.DescribeStackInstanceRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeStackInstanceAsync(request);
                return task.Result;
                #else
