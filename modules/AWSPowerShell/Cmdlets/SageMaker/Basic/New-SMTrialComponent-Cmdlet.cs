...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMTrialComponentCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// hyperparameters, source code, and instance types.</para><para />
        ...
        /// snapshots, logs, and images.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The hyperparameters for the component.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateTrialComponentResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateTrialComponentRequest request)
        {
            ...
            try
            {
                return client.CreateTrialComponentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
