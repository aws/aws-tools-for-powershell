...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Update", "SMDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service UpdateDevices API operation.", Operation = new[] {"UpdateDevices"}, SelectReturnType = typeof(Amazon.SageMaker.Model.UpdateDevicesResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.UpdateDevicesResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.UpdateDevicesResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateSMDeviceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of devices to register with Edge Manager agent.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SMDevice (UpdateDevices)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.UpdateDevicesResponse, UpdateSMDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.UpdateDevicesRequest();
        ...
        private Amazon.SageMaker.Model.UpdateDevicesResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.UpdateDevicesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "UpdateDevices");
            try
            {
                return client.UpdateDevicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SageMaker.Model.UpdateDevicesResponse, UpdateSMDeviceCmdlet, object> Select { get; set; } =
