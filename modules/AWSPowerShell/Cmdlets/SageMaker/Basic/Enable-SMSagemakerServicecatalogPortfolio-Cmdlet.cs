...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.EnableSagemakerServicecatalogPortfolioResponse",
        ...
        "The service response (type Amazon.SageMaker.Model.EnableSagemakerServicecatalogPortfolioResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
