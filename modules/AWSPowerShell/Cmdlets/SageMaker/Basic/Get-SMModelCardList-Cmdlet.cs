...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMModelCardList")]
    [OutputType("Amazon.SageMaker.Model.ModelCardSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListModelCards API operation.", Operation = new[] {"ListModelCards"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListModelCardsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.ModelCardSummary or Amazon.SageMaker.Model.ListModelCardsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.ModelCardSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListModelCardsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMModelCardListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.ModelCardSortBy")]
        public Amazon.SageMaker.ModelCardSortBy SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the response to a previous <code>ListModelCards</code> request was truncated, the
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ModelCardSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListModelCardsResponse, GetSMModelCardListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListModelCardsRequest();
        ...
        private Amazon.SageMaker.Model.ListModelCardsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListModelCardsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListModelCards");
            try
            {
                #if DESKTOP
                return client.ListModelCards(request);
                #elif CORECLR
                return client.ListModelCardsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.ModelCardSortBy SortBy { get; set; }
            public Amazon.SageMaker.ModelCardSortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListModelCardsResponse, GetSMModelCardListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ModelCardSummaries;
        }
