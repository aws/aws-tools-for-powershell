...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SMFlowDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSMFlowDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMFlowDefinition (DeleteFlowDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteFlowDefinitionResponse, RemoveSMFlowDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteFlowDefinitionRequest();
        ...
        private Amazon.SageMaker.Model.DeleteFlowDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteFlowDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteFlowDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteFlowDefinition(request);
                #elif CORECLR
                return client.DeleteFlowDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FlowDefinitionName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteFlowDefinitionResponse, RemoveSMFlowDefinitionCmdlet, object> Select { get; set; } =
