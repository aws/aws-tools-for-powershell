...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.ContextSummary or Amazon.SageMaker.Model.ListContextsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListContextsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
