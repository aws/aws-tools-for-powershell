...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMFlowDefinition")]
    [OutputType("Amazon.SageMaker.Model.DescribeFlowDefinitionResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeFlowDefinition API operation.", Operation = new[] {"DescribeFlowDefinition"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeFlowDefinitionResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeFlowDefinitionResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeFlowDefinitionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMFlowDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeFlowDefinitionResponse, GetSMFlowDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeFlowDefinitionRequest();
        ...
        private Amazon.SageMaker.Model.DescribeFlowDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeFlowDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeFlowDefinition");
            try
            {
                #if DESKTOP
                return client.DescribeFlowDefinition(request);
                #elif CORECLR
                return client.DescribeFlowDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FlowDefinitionName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeFlowDefinitionResponse, GetSMFlowDefinitionCmdlet, object> Select { get; set; } =
