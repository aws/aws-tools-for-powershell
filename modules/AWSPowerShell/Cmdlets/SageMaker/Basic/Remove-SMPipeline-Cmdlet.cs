...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DeletePipeline API operation.", Operation = new[] {"DeletePipeline"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeletePipelineResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.DeletePipelineResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.DeletePipelineResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMPipelineCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMPipeline (DeletePipeline)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeletePipelineResponse, RemoveSMPipelineCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeletePipelineRequest();
        ...
        private Amazon.SageMaker.Model.DeletePipelineResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeletePipelineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeletePipeline");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientRequestToken { get; set; }
            public System.String PipelineName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeletePipelineResponse, RemoveSMPipelineCmdlet, object> Select { get; set; } =
