...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Stop", "SMLabelingJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service StopLabelingJob API operation.", Operation = new[] {"StopLabelingJob"}, SelectReturnType = typeof(Amazon.SageMaker.Model.StopLabelingJobResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.StopLabelingJobResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.StopLabelingJobResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopSMLabelingJobCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SMLabelingJob (StopLabelingJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.StopLabelingJobResponse, StopSMLabelingJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.StopLabelingJobRequest();
        ...
        private Amazon.SageMaker.Model.StopLabelingJobResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.StopLabelingJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "StopLabelingJob");
            try
            {
                #if DESKTOP
                return client.StopLabelingJob(request);
                #elif CORECLR
                return client.StopLabelingJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String LabelingJobName { get; set; }
            public System.Func<Amazon.SageMaker.Model.StopLabelingJobResponse, StopSMLabelingJobCmdlet, object> Select { get; set; } =
