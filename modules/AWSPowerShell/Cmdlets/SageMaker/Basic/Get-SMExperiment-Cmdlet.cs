...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMExperiment")]
    [OutputType("Amazon.SageMaker.Model.DescribeExperimentResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeExperiment API operation.", Operation = new[] {"DescribeExperiment"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeExperimentResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeExperimentResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeExperimentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMExperimentCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeExperimentResponse, GetSMExperimentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeExperimentRequest();
        ...
        private Amazon.SageMaker.Model.DescribeExperimentResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeExperimentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeExperiment");
            try
            {
                #if DESKTOP
                return client.DescribeExperiment(request);
                #elif CORECLR
                return client.DescribeExperimentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ExperimentName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeExperimentResponse, GetSMExperimentCmdlet, object> Select { get; set; } =
