...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringAlertHistorySummary or Amazon.SageMaker.Model.ListMonitoringAlertHistoryResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListMonitoringAlertHistoryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMMonitoringAlertHistoryListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The field used to sort results. The default is <code>CreationTime</code>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The sort order, whether <code>Ascending</code> or <code>Descending</code>, of the
        /// alert history. The default is <code>Descending</code>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>If the result of the previous <code>ListMonitoringAlertHistory</code> request was
        /// truncated, the response includes a <code>NextToken</code>. To retrieve the next set
        /// of alerts in the history, use the token in the next request.</para>
        /// </para>
        /// <para>
