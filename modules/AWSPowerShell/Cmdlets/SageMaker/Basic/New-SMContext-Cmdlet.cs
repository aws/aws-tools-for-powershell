...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// 
    ///  <note><para><code>CreateContext</code> can only be invoked from within an SageMaker managed environment.
    ...
    public partial class NewSMContextCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the context. Must be unique to your account in an AWS Region.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
