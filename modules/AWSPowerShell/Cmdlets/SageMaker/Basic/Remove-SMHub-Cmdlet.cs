...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "SMHub", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSMHubCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMHub (DeleteHub)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteHubResponse, RemoveSMHubCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteHubRequest();
        ...
        private Amazon.SageMaker.Model.DeleteHubResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteHubRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteHub");
            try
            {
                #if DESKTOP
                return client.DeleteHub(request);
                #elif CORECLR
                return client.DeleteHubAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HubName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteHubResponse, RemoveSMHubCmdlet, object> Select { get; set; } =
