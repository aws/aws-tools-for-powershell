...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListWorkteams API operation.", Operation = new[] {"ListWorkteams"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListWorkteamsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.Workteam or Amazon.SageMaker.Model.ListWorkteamsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.Workteam objects.",
        "The service call response (type Amazon.SageMaker.Model.ListWorkteamsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMWorkteamListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.ListWorkteamsSortByOptions")]
        public Amazon.SageMaker.ListWorkteamsSortByOptions SortBy { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Workteams";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListWorkteamsResponse, GetSMWorkteamListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListWorkteamsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Workteams?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListWorkteamsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListWorkteamsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListWorkteams");
            try
            {
                #if DESKTOP
                return client.ListWorkteams(request);
                #elif CORECLR
                return client.ListWorkteamsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.ListWorkteamsSortByOptions SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListWorkteamsResponse, GetSMWorkteamListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Workteams;
        }
