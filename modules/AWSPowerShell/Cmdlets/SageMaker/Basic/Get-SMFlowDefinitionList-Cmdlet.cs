...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMFlowDefinitionList")]
    [OutputType("Amazon.SageMaker.Model.FlowDefinitionSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListFlowDefinitions API operation.", Operation = new[] {"ListFlowDefinitions"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListFlowDefinitionsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.FlowDefinitionSummary or Amazon.SageMaker.Model.ListFlowDefinitionsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.FlowDefinitionSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListFlowDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMFlowDefinitionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FlowDefinitionSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListFlowDefinitionsResponse, GetSMFlowDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListFlowDefinitionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FlowDefinitionSummaries?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListFlowDefinitionsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListFlowDefinitionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListFlowDefinitions");
            try
            {
                #if DESKTOP
                return client.ListFlowDefinitions(request);
                #elif CORECLR
                return client.ListFlowDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListFlowDefinitionsResponse, GetSMFlowDefinitionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FlowDefinitionSummaries;
        }
