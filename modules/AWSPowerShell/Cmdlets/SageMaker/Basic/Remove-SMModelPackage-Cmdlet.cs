...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteModelPackage API operation.", Operation = new[] {"DeleteModelPackage"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteModelPackageResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.DeleteModelPackageResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.DeleteModelPackageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMModelPackageCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMModelPackage (DeleteModelPackage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteModelPackageResponse, RemoveSMModelPackageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteModelPackageRequest();
        ...
        private Amazon.SageMaker.Model.DeleteModelPackageResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteModelPackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteModelPackage");
            try
            {
                #if DESKTOP
                return client.DeleteModelPackage(request);
                #elif CORECLR
                return client.DeleteModelPackageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ModelPackageName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteModelPackageResponse, RemoveSMModelPackageCmdlet, object> Select { get; set; } =
