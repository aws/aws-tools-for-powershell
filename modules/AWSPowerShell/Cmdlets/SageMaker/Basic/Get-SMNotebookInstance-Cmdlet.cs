...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMNotebookInstanceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeNotebookInstanceResponse, GetSMNotebookInstanceCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.DescribeNotebookInstanceResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeNotebookInstanceRequest request)
        {
            ...
            try
            {
                return client.DescribeNotebookInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NotebookInstanceName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeNotebookInstanceResponse, GetSMNotebookInstanceCmdlet, object> Select { get; set; } =
