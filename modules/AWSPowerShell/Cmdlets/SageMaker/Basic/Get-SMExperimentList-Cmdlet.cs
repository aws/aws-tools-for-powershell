...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMExperimentList")]
    [OutputType("Amazon.SageMaker.Model.ExperimentSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListExperiments API operation.", Operation = new[] {"ListExperiments"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListExperimentsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.ExperimentSummary or Amazon.SageMaker.Model.ListExperimentsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.ExperimentSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListExperimentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMExperimentListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.SortExperimentsBy")]
        public Amazon.SageMaker.SortExperimentsBy SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of experiments to return in the response.</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ExperimentSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListExperimentsResponse, GetSMExperimentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListExperimentsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ExperimentSummaries.Count;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortExperimentsBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListExperimentsResponse, GetSMExperimentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ExperimentSummaries;
        }
