...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMHyperParameterTuningJobCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeHyperParameterTuningJobResponse, GetSMHyperParameterTuningJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeHyperParameterTuningJobRequest();
        ...
        private Amazon.SageMaker.Model.DescribeHyperParameterTuningJobResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeHyperParameterTuningJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeHyperParameterTuningJob");
            try
            {
                #if DESKTOP
                return client.DescribeHyperParameterTuningJob(request);
                #elif CORECLR
                return client.DescribeHyperParameterTuningJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HyperParameterTuningJobName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeHyperParameterTuningJobResponse, GetSMHyperParameterTuningJobCmdlet, object> Select { get; set; } =
