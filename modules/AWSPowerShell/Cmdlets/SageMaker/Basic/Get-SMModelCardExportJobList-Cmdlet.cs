...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.ModelCardExportJobSummary or Amazon.SageMaker.Model.ListModelCardExportJobsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListModelCardExportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMModelCardExportJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the response to a previous <code>ListModelCardExportJobs</code> request was truncated,
        /// the response includes a <code>NextToken</code>. To retrieve the next set of model
        /// card export jobs, use the token in the next request.</para>
        /// </para>
        /// <para>
        ...
        private Amazon.SageMaker.Model.ListModelCardExportJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListModelCardExportJobsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListModelCardExportJobs(request);
                #elif CORECLR
                return client.ListModelCardExportJobsAsync(request).GetAwaiter().GetResult();
                #else
