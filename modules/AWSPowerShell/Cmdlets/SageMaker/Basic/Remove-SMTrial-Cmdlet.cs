...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteTrial API operation.", Operation = new[] {"DeleteTrial"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteTrialResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.DeleteTrialResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.DeleteTrialResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMTrialCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMTrial (DeleteTrial)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteTrialResponse, RemoveSMTrialCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteTrialRequest();
        ...
        private Amazon.SageMaker.Model.DeleteTrialResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteTrialRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteTrial");
            try
            {
                #if DESKTOP
                return client.DeleteTrial(request);
                #elif CORECLR
                return client.DeleteTrialAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TrialName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteTrialResponse, RemoveSMTrialCmdlet, object> Select { get; set; } =
