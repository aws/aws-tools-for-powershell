...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMStudioLifecycleConfigCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Studio Lifecycle Configuration to describe.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeStudioLifecycleConfigResponse, GetSMStudioLifecycleConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeStudioLifecycleConfigRequest();
        ...
        private Amazon.SageMaker.Model.DescribeStudioLifecycleConfigResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeStudioLifecycleConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeStudioLifecycleConfig");
            try
            {
                #if DESKTOP
                return client.DescribeStudioLifecycleConfig(request);
                #elif CORECLR
                return client.DescribeStudioLifecycleConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StudioLifecycleConfigName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeStudioLifecycleConfigResponse, GetSMStudioLifecycleConfigCmdlet, object> Select { get; set; } =
