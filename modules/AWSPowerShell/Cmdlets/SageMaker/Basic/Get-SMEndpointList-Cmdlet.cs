...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListEndpoints API operation.", Operation = new[] {"ListEndpoints"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListEndpointsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.EndpointSummary or Amazon.SageMaker.Model.ListEndpointsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.EndpointSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListEndpointsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMEndpointListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListEndpointsResponse, GetSMEndpointListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.OrderKey SortOrder { get; set; }
            public Amazon.SageMaker.EndpointStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListEndpointsResponse, GetSMEndpointListCmdlet, object> Select { get; set; } =
