...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class UpdateSMHubContentReferenceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the HubContentName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^HubContentName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^HubContentName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.HubContentName;
            }
        ...
        private Amazon.SageMaker.Model.UpdateHubContentReferenceResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.UpdateHubContentReferenceRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateHubContentReference(request);
                #elif CORECLR
                return client.UpdateHubContentReferenceAsync(request).GetAwaiter().GetResult();
                #else
