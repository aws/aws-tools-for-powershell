...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMTrainingPlanCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TrainingPlanName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TrainingPlanName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TrainingPlanName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TrainingPlanName;
            }
        ...
        private Amazon.SageMaker.Model.DescribeTrainingPlanResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeTrainingPlanRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeTrainingPlan(request);
                #elif CORECLR
                return client.DescribeTrainingPlanAsync(request).GetAwaiter().GetResult();
                #else
