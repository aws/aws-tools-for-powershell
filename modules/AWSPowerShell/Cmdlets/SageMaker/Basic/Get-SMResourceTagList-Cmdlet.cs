...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListTags API operation.", Operation = new[] {"ListTags"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListTagsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.Tag or Amazon.SageMaker.Model.ListTagsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.Tag objects.",
        "The service call response (type Amazon.SageMaker.Model.ListTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMResourceTagListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListTagsResponse, GetSMResourceTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListTagsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                ProcessOutput(output);
            } while (!_userControllingPaging && AutoIterationHelpers.HasValue(_nextToken) && (!_emitLimit.HasValue || _emitLimit.Value >= 50));
        ...
        private Amazon.SageMaker.Model.ListTagsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListTags");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListTagsResponse, GetSMResourceTagListCmdlet, object> Select { get; set; } =
