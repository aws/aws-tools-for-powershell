...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMModelQualityJobDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of arguments for the container used to run the monitoring job.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the entrypoint for a container that the monitoring job runs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateModelQualityJobDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateModelQualityJobDefinitionRequest request)
        {
            ...
            try
            {
                return client.CreateModelQualityJobDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
