...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMAutoMLJobList")]
    [OutputType("Amazon.SageMaker.Model.AutoMLJobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListAutoMLJobs API operation.", Operation = new[] {"ListAutoMLJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListAutoMLJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.AutoMLJobSummary or Amazon.SageMaker.Model.ListAutoMLJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.AutoMLJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListAutoMLJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMAutoMLJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The parameter by which to sort the results. The default is <code>Name</code>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.AutoMLSortBy")]
        public Amazon.SageMaker.AutoMLSortBy SortBy { get; set; }
        #endregion
        
        #region Parameter SortOrder
        /// <summary>
        /// <para>
        /// <para>The sort order for the results. The default is <code>Descending</code>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.AutoMLJobStatus")]
        public Amazon.SageMaker.AutoMLJobStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AutoMLJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListAutoMLJobsResponse, GetSMAutoMLJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListAutoMLJobsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AutoMLJobSummaries.Count;
        ...
        private Amazon.SageMaker.Model.ListAutoMLJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListAutoMLJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListAutoMLJobs");
            try
            {
                #if DESKTOP
                return client.ListAutoMLJobs(request);
                #elif CORECLR
                return client.ListAutoMLJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.AutoMLSortOrder SortOrder { get; set; }
            public Amazon.SageMaker.AutoMLJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListAutoMLJobsResponse, GetSMAutoMLJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AutoMLJobSummaries;
        }
