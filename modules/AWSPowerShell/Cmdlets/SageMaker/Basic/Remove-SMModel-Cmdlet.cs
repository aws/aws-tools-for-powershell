...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteModel API operation.", Operation = new[] {"DeleteModel"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteModelResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.DeleteModelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.DeleteModelResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSMModelCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteModelResponse, RemoveSMModelCmdlet>(Select) ??
        ...
        {
            public System.String ModelName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteModelResponse, RemoveSMModelCmdlet, object> Select { get; set; } =
