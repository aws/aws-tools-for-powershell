...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMEdgePackagingJobList")]
    [OutputType("Amazon.SageMaker.Model.EdgePackagingJobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListEdgePackagingJobs API operation.", Operation = new[] {"ListEdgePackagingJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListEdgePackagingJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.EdgePackagingJobSummary or Amazon.SageMaker.Model.ListEdgePackagingJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.EdgePackagingJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListEdgePackagingJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMEdgePackagingJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        #region Parameter ModelNameContain
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ModelNameContains")]
        public System.String ModelNameContain { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.ListEdgePackagingJobsSortBy")]
        public Amazon.SageMaker.ListEdgePackagingJobsSortBy SortBy { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.EdgePackagingJobStatus")]
        public Amazon.SageMaker.EdgePackagingJobStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EdgePackagingJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListEdgePackagingJobsResponse, GetSMEdgePackagingJobListCmdlet>(Select) ??
            ...
            context.ModelNameContain = this.ModelNameContain;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListEdgePackagingJobsRequest();
            ...
            if (cmdletContext.ModelNameContain != null)
            {
                request.ModelNameContains = cmdletContext.ModelNameContain;
            }
        ...
        private Amazon.SageMaker.Model.ListEdgePackagingJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListEdgePackagingJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListEdgePackagingJobs");
            try
            {
                #if DESKTOP
                return client.ListEdgePackagingJobs(request);
                #elif CORECLR
                return client.ListEdgePackagingJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.EdgePackagingJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListEdgePackagingJobsResponse, GetSMEdgePackagingJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EdgePackagingJobSummaries;
        }
