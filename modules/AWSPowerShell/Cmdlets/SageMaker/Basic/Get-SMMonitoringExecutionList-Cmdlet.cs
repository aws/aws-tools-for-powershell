...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringExecutionSummary or Amazon.SageMaker.Model.ListMonitoringExecutionsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListMonitoringExecutionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.MonitoringExecutionSummaries?.Count ?? 0;
