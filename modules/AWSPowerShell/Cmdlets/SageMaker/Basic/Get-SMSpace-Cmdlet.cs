...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMSpace")]
    [OutputType("Amazon.SageMaker.Model.DescribeSpaceResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeSpace API operation.", Operation = new[] {"DescribeSpace"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeSpaceResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeSpaceResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeSpaceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMSpaceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeSpaceResponse, GetSMSpaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeSpaceRequest();
        ...
        private Amazon.SageMaker.Model.DescribeSpaceResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeSpaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeSpace");
            try
            {
                #if DESKTOP
                return client.DescribeSpace(request);
                #elif CORECLR
                return client.DescribeSpaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String SpaceName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeSpaceResponse, GetSMSpaceCmdlet, object> Select { get; set; } =
