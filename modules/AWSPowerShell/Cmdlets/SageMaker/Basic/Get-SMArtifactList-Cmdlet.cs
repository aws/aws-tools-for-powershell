...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.ArtifactSummary or Amazon.SageMaker.Model.ListArtifactsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListArtifactsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMArtifactListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the previous call to <code>ListArtifacts</code> didn't return the full set of artifacts,
