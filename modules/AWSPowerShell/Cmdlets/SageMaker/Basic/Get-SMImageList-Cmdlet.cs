...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.Image or Amazon.SageMaker.Model.ListImagesResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListImagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMImageListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the previous call to <code>ListImages</code> didn't return the full set of images,
        /// the call returns a token for getting the next set of images.</para>
        /// </para>
        /// <para>
