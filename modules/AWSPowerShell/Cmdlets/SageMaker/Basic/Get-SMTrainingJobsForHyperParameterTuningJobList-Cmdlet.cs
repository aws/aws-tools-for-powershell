...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListTrainingJobsForHyperParameterTuningJob API operation.", Operation = new[] {"ListTrainingJobsForHyperParameterTuningJob"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.HyperParameterTrainingJobSummary or Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.HyperParameterTrainingJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMTrainingJobsForHyperParameterTuningJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TrainingJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse, GetSMTrainingJobsForHyperParameterTuningJobListCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobRequest request)
        {
            ...
            try
            {
                return client.ListTrainingJobsForHyperParameterTuningJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.TrainingJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListTrainingJobsForHyperParameterTuningJobResponse, GetSMTrainingJobsForHyperParameterTuningJobListCmdlet, object> Select { get; set; } =
