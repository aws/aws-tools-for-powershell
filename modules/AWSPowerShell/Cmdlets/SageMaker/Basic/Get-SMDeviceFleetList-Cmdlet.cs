...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.DeviceFleetSummary or Amazon.SageMaker.Model.ListDeviceFleetsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListDeviceFleetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
