...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMEndpoint")]
    [OutputType("Amazon.SageMaker.Model.DescribeEndpointResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeEndpoint API operation.", Operation = new[] {"DescribeEndpoint"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeEndpointResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeEndpointResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMEndpointCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeEndpointResponse, GetSMEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeEndpointRequest();
        ...
        private Amazon.SageMaker.Model.DescribeEndpointResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeEndpoint");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String EndpointName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeEndpointResponse, GetSMEndpointCmdlet, object> Select { get; set; } =
