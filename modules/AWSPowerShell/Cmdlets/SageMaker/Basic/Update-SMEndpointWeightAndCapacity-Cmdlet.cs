...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service UpdateEndpointWeightsAndCapacities API operation.", Operation = new[] {"UpdateEndpointWeightsAndCapacities"}, SelectReturnType = typeof(Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateSMEndpointWeightAndCapacityCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An object that provides new capacity and weight values for a variant.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse, UpdateSMEndpointWeightAndCapacityCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.DesiredWeightsAndCapacity != null)
            {
                context.DesiredWeightsAndCapacity = new List<Amazon.SageMaker.Model.DesiredWeightAndCapacity>(this.DesiredWeightsAndCapacity);
            }
            #if MODULAR
            if (this.DesiredWeightsAndCapacity == null && ParameterWasBound(nameof(this.DesiredWeightsAndCapacity)))
            {
                WriteWarning("You are passing $null as a value for parameter DesiredWeightsAndCapacity which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.DesiredWeightsAndCapacity != null)
            {
                request.DesiredWeightsAndCapacities = cmdletContext.DesiredWeightsAndCapacity;
            }
        ...
        private Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesRequest request)
        {
            ...
            try
            {
                return client.UpdateEndpointWeightsAndCapacitiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.SageMaker.Model.DesiredWeightAndCapacity> DesiredWeightsAndCapacity { get; set; }
            public System.String EndpointName { get; set; }
            public System.Func<Amazon.SageMaker.Model.UpdateEndpointWeightsAndCapacitiesResponse, UpdateSMEndpointWeightAndCapacityCmdlet, object> Select { get; set; } =
