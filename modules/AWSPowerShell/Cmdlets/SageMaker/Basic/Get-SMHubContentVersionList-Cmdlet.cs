...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.HubContentInfo or Amazon.SageMaker.Model.ListHubContentVersionsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListHubContentVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
