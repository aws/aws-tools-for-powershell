...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// Deletes an context.
    /// </summary>
    [Cmdlet("Remove", "SMContext", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteContext API operation.", Operation = new[] {"DeleteContext"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteContextResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.DeleteContextResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.DeleteContextResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMContextCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMContext (DeleteContext)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteContextResponse, RemoveSMContextCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteContextRequest();
        ...
        private Amazon.SageMaker.Model.DeleteContextResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteContextRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteContext");
            try
            {
                #if DESKTOP
                return client.DeleteContext(request);
                #elif CORECLR
                return client.DeleteContextAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContextName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteContextResponse, RemoveSMContextCmdlet, object> Select { get; set; } =
