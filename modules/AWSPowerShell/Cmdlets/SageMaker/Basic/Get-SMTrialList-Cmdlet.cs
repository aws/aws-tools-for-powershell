...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.TrialSummary or Amazon.SageMaker.Model.ListTrialsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListTrialsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMTrialListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of trials to return in the response.</para>
        /// </para>
        /// <para>
