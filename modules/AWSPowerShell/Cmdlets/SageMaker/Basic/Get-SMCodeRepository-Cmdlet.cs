...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeCodeRepository API operation.", Operation = new[] {"DescribeCodeRepository"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeCodeRepositoryResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeCodeRepositoryResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeCodeRepositoryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMCodeRepositoryCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeCodeRepositoryResponse, GetSMCodeRepositoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeCodeRepositoryRequest();
        ...
        private Amazon.SageMaker.Model.DescribeCodeRepositoryResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeCodeRepositoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeCodeRepository");
            try
            {
                #if DESKTOP
                return client.DescribeCodeRepository(request);
                #elif CORECLR
                return client.DescribeCodeRepositoryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CodeRepositoryName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeCodeRepositoryResponse, GetSMCodeRepositoryCmdlet, object> Select { get; set; } =
