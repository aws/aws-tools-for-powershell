...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.ActionSummary or Amazon.SageMaker.Model.ListActionsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMActionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the previous call to <code>ListActions</code> didn't return the full set of actions,
