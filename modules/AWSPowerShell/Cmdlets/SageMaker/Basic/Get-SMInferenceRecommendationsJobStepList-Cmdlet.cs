...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.InferenceRecommendationsJobStep or Amazon.SageMaker.Model.ListInferenceRecommendationsJobStepsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListInferenceRecommendationsJobStepsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
