...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SMAppImageConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSMAppImageConfigCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMAppImageConfig (DeleteAppImageConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteAppImageConfigResponse, RemoveSMAppImageConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteAppImageConfigRequest();
        ...
        private Amazon.SageMaker.Model.DeleteAppImageConfigResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteAppImageConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteAppImageConfig");
            try
            {
                #if DESKTOP
                return client.DeleteAppImageConfig(request);
                #elif CORECLR
                return client.DeleteAppImageConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppImageConfigName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteAppImageConfigResponse, RemoveSMAppImageConfigCmdlet, object> Select { get; set; } =
