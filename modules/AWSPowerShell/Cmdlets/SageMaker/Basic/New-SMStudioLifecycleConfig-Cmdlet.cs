...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.CreateStudioLifecycleConfigResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.CreateStudioLifecycleConfigResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSMStudioLifecycleConfigCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The content of your Studio Lifecycle Configuration script. This content must be base64
        /// encoded.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Studio Lifecycle Configuration to create.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StudioLifecycleConfigName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.StudioLifecycleConfigName;
            }
