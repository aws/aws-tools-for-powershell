...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SMDataQualityJobDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSMDataQualityJobDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMDataQualityJobDefinition (DeleteDataQualityJobDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteDataQualityJobDefinitionResponse, RemoveSMDataQualityJobDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteDataQualityJobDefinitionRequest();
        ...
        private Amazon.SageMaker.Model.DeleteDataQualityJobDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteDataQualityJobDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteDataQualityJobDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteDataQualityJobDefinition(request);
                #elif CORECLR
                return client.DeleteDataQualityJobDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobDefinitionName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteDataQualityJobDefinitionResponse, RemoveSMDataQualityJobDefinitionCmdlet, object> Select { get; set; } =
