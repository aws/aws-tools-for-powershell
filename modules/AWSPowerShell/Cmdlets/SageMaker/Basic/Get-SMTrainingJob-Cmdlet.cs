...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "SMTrainingJob")]
    [OutputType("Amazon.SageMaker.Model.DescribeTrainingJobResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeTrainingJob API operation.", Operation = new[] {"DescribeTrainingJob"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeTrainingJobResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeTrainingJobResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeTrainingJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMTrainingJobCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeTrainingJobResponse, GetSMTrainingJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeTrainingJobRequest();
        ...
        private Amazon.SageMaker.Model.DescribeTrainingJobResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeTrainingJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeTrainingJob");
            try
            {
                #if DESKTOP
                return client.DescribeTrainingJob(request);
                #elif CORECLR
                return client.DescribeTrainingJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TrainingJobName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeTrainingJobResponse, GetSMTrainingJobCmdlet, object> Select { get; set; } =
