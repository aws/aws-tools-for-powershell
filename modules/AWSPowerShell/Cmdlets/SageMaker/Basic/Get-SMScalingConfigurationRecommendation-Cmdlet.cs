...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMScalingConfigurationRecommendationCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^InferenceRecommendationsJobName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.InferenceRecommendationsJobName;
            }
        ...
        private Amazon.SageMaker.Model.GetScalingConfigurationRecommendationResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.GetScalingConfigurationRecommendationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetScalingConfigurationRecommendation(request);
                #elif CORECLR
                return client.GetScalingConfigurationRecommendationAsync(request).GetAwaiter().GetResult();
                #else
