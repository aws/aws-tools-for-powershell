...
{
    /// <summary>
    /// List all existing hubs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SMHubList")]
    [OutputType("Amazon.SageMaker.Model.HubInfo")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListHubs API operation.", Operation = new[] {"ListHubs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListHubsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.HubInfo or Amazon.SageMaker.Model.ListHubsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.HubInfo objects.",
        "The service call response (type Amazon.SageMaker.Model.ListHubsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMHubListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.HubSortBy")]
        public Amazon.SageMaker.HubSortBy SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the response to a previous <code>ListHubs</code> request was truncated, the response
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HubSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListHubsResponse, GetSMHubListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListHubsRequest();
        ...
        private Amazon.SageMaker.Model.ListHubsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListHubsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListHubs");
            try
            {
                #if DESKTOP
                return client.ListHubs(request);
                #elif CORECLR
                return client.ListHubsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.HubSortBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListHubsResponse, GetSMHubListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HubSummaries;
        }
