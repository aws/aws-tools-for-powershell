...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListSubscribedWorkteams API operation.", Operation = new[] {"ListSubscribedWorkteams"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.SubscribedWorkteam or Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.SubscribedWorkteam objects.",
        "The service call response (type Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMSubscribedWorkteamListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SubscribedWorkteams";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse, GetSMSubscribedWorkteamListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SubscribedWorkteams?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NameContain { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListSubscribedWorkteamsResponse, GetSMSubscribedWorkteamListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SubscribedWorkteams;
        }
