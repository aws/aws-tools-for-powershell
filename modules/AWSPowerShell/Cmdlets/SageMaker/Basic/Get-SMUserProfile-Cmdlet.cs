...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeUserProfile API operation.", Operation = new[] {"DescribeUserProfile"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeUserProfileResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeUserProfileResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeUserProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMUserProfileCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^UserProfileName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeUserProfileResponse, GetSMUserProfileCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.UserProfileName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeUserProfileRequest();
        ...
        private Amazon.SageMaker.Model.DescribeUserProfileResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeUserProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeUserProfile");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainId { get; set; }
            public System.String UserProfileName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeUserProfileResponse, GetSMUserProfileCmdlet, object> Select { get; set; } =
