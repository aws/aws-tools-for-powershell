...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.OptimizationJobSummary or Amazon.SageMaker.Model.ListOptimizationJobsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListOptimizationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
