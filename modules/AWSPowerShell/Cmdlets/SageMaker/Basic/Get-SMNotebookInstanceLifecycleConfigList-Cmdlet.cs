...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListNotebookInstanceLifecycleConfigs API operation.", Operation = new[] {"ListNotebookInstanceLifecycleConfigs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.NotebookInstanceLifecycleConfigSummary or Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.NotebookInstanceLifecycleConfigSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMNotebookInstanceLifecycleConfigListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NotebookInstanceLifecycleConfigs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse, GetSMNotebookInstanceLifecycleConfigListCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsRequest request)
        {
            ...
            try
            {
                return client.ListNotebookInstanceLifecycleConfigsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.NotebookInstanceLifecycleConfigSortKey SortBy { get; set; }
            public Amazon.SageMaker.NotebookInstanceLifecycleConfigSortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListNotebookInstanceLifecycleConfigsResponse, GetSMNotebookInstanceLifecycleConfigListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NotebookInstanceLifecycleConfigs;
        }
