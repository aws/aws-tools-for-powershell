...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMHyperParameterTuningJobList")]
    [OutputType("Amazon.SageMaker.Model.HyperParameterTuningJobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListHyperParameterTuningJobs API operation.", Operation = new[] {"ListHyperParameterTuningJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.HyperParameterTuningJobSummary or Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.HyperParameterTuningJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMHyperParameterTuningJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.HyperParameterTuningJobSortByOptions")]
        public Amazon.SageMaker.HyperParameterTuningJobSortByOptions SortBy { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.HyperParameterTuningJobStatus")]
        public Amazon.SageMaker.HyperParameterTuningJobStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HyperParameterTuningJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse, GetSMHyperParameterTuningJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListHyperParameterTuningJobsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.HyperParameterTuningJobSummaries?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListHyperParameterTuningJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListHyperParameterTuningJobs");
            try
            {
                return client.ListHyperParameterTuningJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.HyperParameterTuningJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse, GetSMHyperParameterTuningJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HyperParameterTuningJobSummaries;
        }
