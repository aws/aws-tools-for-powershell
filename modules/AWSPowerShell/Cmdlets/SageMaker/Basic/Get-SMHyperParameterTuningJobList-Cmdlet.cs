...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.HyperParameterTuningJobSummary or Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListHyperParameterTuningJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
