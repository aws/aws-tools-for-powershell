...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMModelExplainabilityJobDefinitionList")]
    [OutputType("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListModelExplainabilityJobDefinitions API operation.", Operation = new[] {"ListModelExplainabilityJobDefinitions"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary or Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.MonitoringJobDefinitionSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMModelExplainabilityJobDefinitionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse, GetSMModelExplainabilityJobDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsRequest();
        ...
        private Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListModelExplainabilityJobDefinitions");
            try
            {
                #if DESKTOP
                return client.ListModelExplainabilityJobDefinitions(request);
                #elif CORECLR
                return client.ListModelExplainabilityJobDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.MonitoringJobDefinitionSortKey SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListModelExplainabilityJobDefinitionsResponse, GetSMModelExplainabilityJobDefinitionListCmdlet, object> Select { get; set; } =
