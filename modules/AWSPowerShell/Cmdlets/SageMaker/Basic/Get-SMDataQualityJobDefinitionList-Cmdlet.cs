...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMDataQualityJobDefinitionList")]
    [OutputType("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListDataQualityJobDefinitions API operation.", Operation = new[] {"ListDataQualityJobDefinitions"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary or Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.MonitoringJobDefinitionSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMDataQualityJobDefinitionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the result of the previous <code>ListDataQualityJobDefinitions</code> request was
        /// truncated, the response includes a <code>NextToken</code>. To retrieve the next set
        /// of transform jobs, use the token in the next request.&gt;</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse, GetSMDataQualityJobDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListDataQualityJobDefinitionsRequest();
        ...
        private Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListDataQualityJobDefinitionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListDataQualityJobDefinitions");
            try
            {
                #if DESKTOP
                return client.ListDataQualityJobDefinitions(request);
                #elif CORECLR
                return client.ListDataQualityJobDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.MonitoringJobDefinitionSortKey SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListDataQualityJobDefinitionsResponse, GetSMDataQualityJobDefinitionListCmdlet, object> Select { get; set; } =
