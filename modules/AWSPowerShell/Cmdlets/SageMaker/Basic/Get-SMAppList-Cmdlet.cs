...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMAppList")]
    [OutputType("Amazon.SageMaker.Model.AppDetails")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListApps API operation.", Operation = new[] {"ListApps"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListAppsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.AppDetails or Amazon.SageMaker.Model.ListAppsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.AppDetails objects.",
        "The service call response (type Amazon.SageMaker.Model.ListAppsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMAppListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.AppSortKey")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListAppsResponse, GetSMAppListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListAppsRequest();
            ...
            {
                request.UserProfileNameEquals = cmdletContext.UserProfileNameEqual;
            }
        ...
        private Amazon.SageMaker.Model.ListAppsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListAppsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListApps");
            try
            {
                #if DESKTOP
