...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMEdgeDeploymentPlanList")]
    [OutputType("Amazon.SageMaker.Model.EdgeDeploymentPlanSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListEdgeDeploymentPlans API operation.", Operation = new[] {"ListEdgeDeploymentPlans"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.EdgeDeploymentPlanSummary or Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.EdgeDeploymentPlanSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMEdgeDeploymentPlanListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        #region Parameter DeviceFleetNameContain
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("DeviceFleetNameContains")]
        public System.String DeviceFleetNameContain { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.ListEdgeDeploymentPlansSortBy")]
        public Amazon.SageMaker.ListEdgeDeploymentPlansSortBy SortBy { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EdgeDeploymentPlanSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse, GetSMEdgeDeploymentPlanListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.CreationTimeAfter = this.CreationTimeAfter;
            context.CreationTimeBefore = this.CreationTimeBefore;
            context.DeviceFleetNameContain = this.DeviceFleetNameContain;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListEdgeDeploymentPlansRequest();
            ...
            if (cmdletContext.DeviceFleetNameContain != null)
            {
                request.DeviceFleetNameContains = cmdletContext.DeviceFleetNameContain;
            }
        ...
        private Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListEdgeDeploymentPlansRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListEdgeDeploymentPlans");
            try
            {
                #if DESKTOP
                return client.ListEdgeDeploymentPlans(request);
                #elif CORECLR
                return client.ListEdgeDeploymentPlansAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.ListEdgeDeploymentPlansSortBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListEdgeDeploymentPlansResponse, GetSMEdgeDeploymentPlanListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EdgeDeploymentPlanSummaries;
        }
