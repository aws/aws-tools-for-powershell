...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMFlowDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// a flow definition. Each tag consists of a key and a value, both of which you define.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Keywords used to describe the task so that workers can discover the task.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateFlowDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateFlowDefinitionRequest request)
        {
            ...
            try
            {
                return client.CreateFlowDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
