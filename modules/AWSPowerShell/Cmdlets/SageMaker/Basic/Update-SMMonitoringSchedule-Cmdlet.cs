...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Update", "SMMonitoringSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon SageMaker Service UpdateMonitoringSchedule API operation.", Operation = new[] {"UpdateMonitoringSchedule"}, SelectReturnType = typeof(Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSMMonitoringScheduleCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SMMonitoringSchedule (UpdateMonitoringSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse, UpdateSMMonitoringScheduleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.UpdateMonitoringScheduleRequest();
        ...
        private Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.UpdateMonitoringScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "UpdateMonitoringSchedule");
            try
            {
                #if DESKTOP
                return client.UpdateMonitoringSchedule(request);
                #elif CORECLR
                return client.UpdateMonitoringScheduleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.SageMaker.Model.MonitoringScheduleConfig MonitoringScheduleConfig { get; set; }
            public System.String MonitoringScheduleName { get; set; }
            public System.Func<Amazon.SageMaker.Model.UpdateMonitoringScheduleResponse, UpdateSMMonitoringScheduleCmdlet, object> Select { get; set; } =
