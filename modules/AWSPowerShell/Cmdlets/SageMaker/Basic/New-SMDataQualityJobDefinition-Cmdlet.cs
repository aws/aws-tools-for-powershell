...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMDataQualityJobDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The arguments to send to the container that the monitoring job runs.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The entrypoint for a container used to run a monitoring job.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Sets the environment variables in the container that the monitoring job runs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateDataQualityJobDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateDataQualityJobDefinitionRequest request)
        {
            ...
            try
            {
                return client.CreateDataQualityJobDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
