...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.CreateDataQualityJobDefinitionResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.CreateDataQualityJobDefinitionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSMDataQualityJobDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// the model artifacts at rest using Amazon S3 server-side encryption.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <para>
        /// <para>The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt
        /// data on the storage volume attached to the ML compute instance(s) that run the model
        /// monitoring job.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.DataQualityAppSpecification_Environment != null)
            {
                ...
                {
                    context.DataQualityAppSpecification_Environment.Add((String)hashKey, (String)(this.DataQualityAppSpecification_Environment[hashKey]));
                }
            }
