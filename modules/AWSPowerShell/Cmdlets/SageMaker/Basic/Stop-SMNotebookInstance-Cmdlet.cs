...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Stop", "SMNotebookInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service StopNotebookInstance API operation.", Operation = new[] {"StopNotebookInstance"}, SelectReturnType = typeof(Amazon.SageMaker.Model.StopNotebookInstanceResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.StopNotebookInstanceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.StopNotebookInstanceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopSMNotebookInstanceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SMNotebookInstance (StopNotebookInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.StopNotebookInstanceResponse, StopSMNotebookInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.StopNotebookInstanceRequest();
        ...
        private Amazon.SageMaker.Model.StopNotebookInstanceResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.StopNotebookInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "StopNotebookInstance");
            try
            {
                #if DESKTOP
                return client.StopNotebookInstance(request);
                #elif CORECLR
                return client.StopNotebookInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NotebookInstanceName { get; set; }
            public System.Func<Amazon.SageMaker.Model.StopNotebookInstanceResponse, StopSMNotebookInstanceCmdlet, object> Select { get; set; } =
