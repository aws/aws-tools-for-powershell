...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </para><ul><li><para><c>CreateJob</c></para></li><li><para><c>DescribeJob</c></para></li></ul><br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SMJobList")]
    [OutputType("Amazon.SageMaker.Model.JobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.JobSummary or Amazon.SageMaker.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.JobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The category of jobs to list.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>A filter that returns only jobs modified after the specified time.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A filter that returns only jobs modified before the specified time.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A string in the job name to filter results. Only jobs whose name contains the specified
        /// string are returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("NameContains")]
        ...
        /// <summary>
        /// <para>
        /// <para>The sort order for results. Valid values are <c>Ascending</c> and <c>Descending</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A filter that returns only jobs with the specified status.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.JobStatus")]
        public Amazon.SageMaker.JobStatus StatusEqual { get; set; }
        #endregion
        
        #region Parameter MaxResult
        /// <summary>
        /// <para>
        /// <para>The maximum number of jobs to return in the response. The default value is 50.</para>
        /// </para>
        /// <para>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SageMaker.Model.ListJobsResponse).
        /// Specifying the name of a property of type Amazon.SageMaker.Model.ListJobsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListJobsResponse, GetSMJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListJobsRequest();
        ...
        private Amazon.SageMaker.Model.ListJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListJobs");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.JobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListJobsResponse, GetSMJobListCmdlet, object> Select { get; set; } =
