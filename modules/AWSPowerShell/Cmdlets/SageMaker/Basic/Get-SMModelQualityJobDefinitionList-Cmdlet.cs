...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMModelQualityJobDefinitionList")]
    [OutputType("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListModelQualityJobDefinitions API operation.", Operation = new[] {"ListModelQualityJobDefinitions"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringJobDefinitionSummary or Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.MonitoringJobDefinitionSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMModelQualityJobDefinitionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse, GetSMModelQualityJobDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListModelQualityJobDefinitionsRequest();
        ...
        private Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListModelQualityJobDefinitionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListModelQualityJobDefinitions");
            try
            {
                #if DESKTOP
                return client.ListModelQualityJobDefinitions(request);
                #elif CORECLR
                return client.ListModelQualityJobDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.MonitoringJobDefinitionSortKey SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListModelQualityJobDefinitionsResponse, GetSMModelQualityJobDefinitionListCmdlet, object> Select { get; set; } =
