...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMDomainList")]
    [OutputType("Amazon.SageMaker.Model.DomainDetails")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListDomains API operation.", Operation = new[] {"ListDomains"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListDomainsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DomainDetails or Amazon.SageMaker.Model.ListDomainsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.DomainDetails objects.",
        "The service call response (type Amazon.SageMaker.Model.ListDomainsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMDomainListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListDomainsResponse, GetSMDomainListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListDomainsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Domains?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListDomainsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListDomainsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListDomains");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListDomainsResponse, GetSMDomainListCmdlet, object> Select { get; set; } =
