...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.DeleteArtifactResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.DeleteArtifactResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMArtifactCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ArtifactArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ArtifactArn;
            }
        ...
        private Amazon.SageMaker.Model.DeleteArtifactResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteArtifactRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteArtifact(request);
                #elif CORECLR
                return client.DeleteArtifactAsync(request).GetAwaiter().GetResult();
                #else
