...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Stop", "SMMonitoringSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopSMMonitoringScheduleCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SMMonitoringSchedule (StopMonitoringSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.StopMonitoringScheduleResponse, StopSMMonitoringScheduleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.StopMonitoringScheduleRequest();
        ...
        private Amazon.SageMaker.Model.StopMonitoringScheduleResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.StopMonitoringScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "StopMonitoringSchedule");
            try
            {
                #if DESKTOP
                return client.StopMonitoringSchedule(request);
                #elif CORECLR
                return client.StopMonitoringScheduleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MonitoringScheduleName { get; set; }
            public System.Func<Amazon.SageMaker.Model.StopMonitoringScheduleResponse, StopSMMonitoringScheduleCmdlet, object> Select { get; set; } =
