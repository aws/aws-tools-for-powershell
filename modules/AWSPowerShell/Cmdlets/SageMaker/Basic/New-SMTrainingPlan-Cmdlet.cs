...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMTrainingPlanCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TrainingPlanOfferingId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TrainingPlanOfferingId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TrainingPlanOfferingId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.SageMaker.Model.CreateTrainingPlanResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateTrainingPlanRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateTrainingPlan(request);
                #elif CORECLR
                return client.CreateTrainingPlanAsync(request).GetAwaiter().GetResult();
                #else
