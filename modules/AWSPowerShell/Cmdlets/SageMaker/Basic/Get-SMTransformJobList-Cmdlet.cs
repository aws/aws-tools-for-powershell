...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMTransformJobList")]
    [OutputType("Amazon.SageMaker.Model.TransformJobSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListTransformJobs API operation.", Operation = new[] {"ListTransformJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListTransformJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.TransformJobSummary or Amazon.SageMaker.Model.ListTransformJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.TransformJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListTransformJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMTransformJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.TransformJobStatus")]
        public Amazon.SageMaker.TransformJobStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TransformJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListTransformJobsResponse, GetSMTransformJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListTransformJobsRequest();
        ...
        private Amazon.SageMaker.Model.ListTransformJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListTransformJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListTransformJobs");
            try
            {
                #if DESKTOP
                return client.ListTransformJobs(request);
                #elif CORECLR
                return client.ListTransformJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.TransformJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListTransformJobsResponse, GetSMTransformJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TransformJobSummaries;
        }
