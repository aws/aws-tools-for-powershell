...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class NewSMMlflowAppCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of SageMaker domain IDs for which this MLflow App is used as the default.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Tags consisting of key-value pairs used to manage metadata for the MLflow App.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateMlflowAppResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateMlflowAppRequest request)
        {
            ...
            try
            {
                return client.CreateMlflowAppAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
