...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeSubscribedWorkteam API operation.", Operation = new[] {"DescribeSubscribedWorkteam"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.SubscribedWorkteam or Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.SubscribedWorkteam object.",
        "The service call response (type Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMSubscribedWorkteamCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "SubscribedWorkteam";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse, GetSMSubscribedWorkteamCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeSubscribedWorkteamRequest request)
        {
            ...
            try
            {
                return client.DescribeSubscribedWorkteamAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String WorkteamArn { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeSubscribedWorkteamResponse, GetSMSubscribedWorkteamCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SubscribedWorkteam;
        }
