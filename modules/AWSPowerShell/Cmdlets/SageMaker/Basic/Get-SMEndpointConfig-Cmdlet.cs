...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class GetSMEndpointConfigCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeEndpointConfigResponse, GetSMEndpointConfigCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.DescribeEndpointConfigResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeEndpointConfigRequest request)
        {
            ...
            try
            {
                return client.DescribeEndpointConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String EndpointConfigName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeEndpointConfigResponse, GetSMEndpointConfigCmdlet, object> Select { get; set; } =
