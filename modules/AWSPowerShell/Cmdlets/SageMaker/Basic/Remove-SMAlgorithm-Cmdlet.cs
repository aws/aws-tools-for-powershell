...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class RemoveSMAlgorithmCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteAlgorithmResponse, RemoveSMAlgorithmCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.DeleteAlgorithmResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteAlgorithmRequest request)
        {
            ...
            try
            {
                return client.DeleteAlgorithmAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AlgorithmName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteAlgorithmResponse, RemoveSMAlgorithmCmdlet, object> Select { get; set; } =
