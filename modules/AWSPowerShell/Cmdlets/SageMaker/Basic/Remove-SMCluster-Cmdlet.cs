...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SMCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveSMClusterCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMCluster (DeleteCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteClusterResponse, RemoveSMClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteClusterRequest();
        ...
        private Amazon.SageMaker.Model.DeleteClusterResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ClusterName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteClusterResponse, RemoveSMClusterCmdlet, object> Select { get; set; } =
