...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// Updates an action.
    /// </summary>
    [Cmdlet("Update", "SMAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon SageMaker Service UpdateAction API operation.", Operation = new[] {"UpdateAction"}, SelectReturnType = typeof(Amazon.SageMaker.Model.UpdateActionResponse))]
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.UpdateActionResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.SageMaker.Model.UpdateActionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateSMActionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The new list of properties. Overwrites the current property list.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of properties to remove.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SMAction (UpdateAction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.UpdateActionResponse, UpdateSMActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.UpdateActionRequest();
        ...
        private Amazon.SageMaker.Model.UpdateActionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.UpdateActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "UpdateAction");
            try
            {
                return client.UpdateActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.ActionStatus Status { get; set; }
            public System.Func<Amazon.SageMaker.Model.UpdateActionResponse, UpdateSMActionCmdlet, object> Select { get; set; } =
