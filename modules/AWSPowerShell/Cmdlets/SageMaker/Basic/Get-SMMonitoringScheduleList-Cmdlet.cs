...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMMonitoringScheduleList")]
    [OutputType("Amazon.SageMaker.Model.MonitoringScheduleSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListMonitoringSchedules API operation.", Operation = new[] {"ListMonitoringSchedules"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListMonitoringSchedulesResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.MonitoringScheduleSummary or Amazon.SageMaker.Model.ListMonitoringSchedulesResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.MonitoringScheduleSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListMonitoringSchedulesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMMonitoringScheduleListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.MonitoringScheduleSortKey")]
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.SageMaker.ScheduleStatus")]
        public Amazon.SageMaker.ScheduleStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MonitoringScheduleSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListMonitoringSchedulesResponse, GetSMMonitoringScheduleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListMonitoringSchedulesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.MonitoringScheduleSummaries?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListMonitoringSchedulesResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListMonitoringSchedulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListMonitoringSchedules");
            try
            {
                #if DESKTOP
                return client.ListMonitoringSchedules(request);
                #elif CORECLR
                return client.ListMonitoringSchedulesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.ScheduleStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListMonitoringSchedulesResponse, GetSMMonitoringScheduleListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MonitoringScheduleSummaries;
        }
