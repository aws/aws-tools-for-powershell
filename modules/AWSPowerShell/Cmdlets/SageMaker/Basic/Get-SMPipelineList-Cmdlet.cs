...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.PipelineSummary or Amazon.SageMaker.Model.ListPipelinesResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListPipelinesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMPipelineListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the result of the previous <code>ListPipelines</code> request was truncated, the
