...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    public partial class StartSMNotebookInstanceCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.StartNotebookInstanceResponse, StartSMNotebookInstanceCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.StartNotebookInstanceResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.StartNotebookInstanceRequest request)
        {
            ...
            try
            {
                return client.StartNotebookInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NotebookInstanceName { get; set; }
            public System.Func<Amazon.SageMaker.Model.StartNotebookInstanceResponse, StartSMNotebookInstanceCmdlet, object> Select { get; set; } =
