...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SMInferenceComponent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSMInferenceComponentCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMInferenceComponent (DeleteInferenceComponent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteInferenceComponentResponse, RemoveSMInferenceComponentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteInferenceComponentRequest();
        ...
        private Amazon.SageMaker.Model.DeleteInferenceComponentResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteInferenceComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteInferenceComponent");
            try
            {
                #if DESKTOP
                return client.DeleteInferenceComponent(request);
                #elif CORECLR
                return client.DeleteInferenceComponentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String InferenceComponentName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteInferenceComponentResponse, RemoveSMInferenceComponentCmdlet, object> Select { get; set; } =
