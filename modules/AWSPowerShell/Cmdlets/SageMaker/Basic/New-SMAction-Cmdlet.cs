...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.CreateActionResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.CreateActionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSMActionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of properties to add to the action.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags to apply to the action.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.SageMaker.Model.CreateActionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateActionRequest request)
        {
            ...
            try
            {
                return client.CreateActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
