...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SageMaker.Model.CreateModelExplainabilityJobDefinitionResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.CreateModelExplainabilityJobDefinitionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSMModelExplainabilityJobDefinitionCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Sets the environment variables in the Docker container.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ModelExplainabilityJobInput_BatchTransformInput_ExcludeFeaturesAttribute")]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ModelExplainabilityJobInput_EndpointInput_ExcludeFeaturesAttribute")]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            System.String requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInput_endpointInput_ExcludeFeaturesAttribute = null;
            if (cmdletContext.EndpointInput_ExcludeFeaturesAttribute != null)
            {
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInput_endpointInput_ExcludeFeaturesAttribute = cmdletContext.EndpointInput_ExcludeFeaturesAttribute;
            }
            if (requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInput_endpointInput_ExcludeFeaturesAttribute != null)
            {
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInput.ExcludeFeaturesAttribute = requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInput_endpointInput_ExcludeFeaturesAttribute;
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_EndpointInputIsNull = false;
            }
            ...
            System.String requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInput_batchTransformInput_ExcludeFeaturesAttribute = null;
            if (cmdletContext.BatchTransformInput_ExcludeFeaturesAttribute != null)
            {
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInput_batchTransformInput_ExcludeFeaturesAttribute = cmdletContext.BatchTransformInput_ExcludeFeaturesAttribute;
            }
            if (requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInput_batchTransformInput_ExcludeFeaturesAttribute != null)
            {
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInput.ExcludeFeaturesAttribute = requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInput_batchTransformInput_ExcludeFeaturesAttribute;
                requestModelExplainabilityJobInput_modelExplainabilityJobInput_BatchTransformInputIsNull = false;
            }
        ...
        private Amazon.SageMaker.Model.CreateModelExplainabilityJobDefinitionResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.CreateModelExplainabilityJobDefinitionRequest request)
        {
            ...
            try
            {
                return client.CreateModelExplainabilityJobDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
