...
{
    /// <summary>
    /// List the contents of a hub.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SMHubContentList")]
    [OutputType("Amazon.SageMaker.Model.HubContentInfo")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListHubContents API operation.", Operation = new[] {"ListHubContents"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListHubContentsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.HubContentInfo or Amazon.SageMaker.Model.ListHubContentsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.HubContentInfo objects.",
        "The service call response (type Amazon.SageMaker.Model.ListHubContentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMHubContentListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If the response to a previous <code>ListHubContents</code> request was truncated,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListHubContentsResponse, GetSMHubContentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListHubContentsRequest();
        ...
        private Amazon.SageMaker.Model.ListHubContentsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListHubContentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListHubContents");
            try
            {
                #if DESKTOP
                return client.ListHubContents(request);
                #elif CORECLR
                return client.ListHubContentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.HubContentSortBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListHubContentsResponse, GetSMHubContentListCmdlet, object> Select { get; set; } =
