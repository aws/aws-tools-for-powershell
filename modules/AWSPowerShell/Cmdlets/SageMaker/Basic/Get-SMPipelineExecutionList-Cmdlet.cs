...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMPipelineExecutionList")]
    [OutputType("Amazon.SageMaker.Model.PipelineExecutionSummary")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListPipelineExecutions API operation.", Operation = new[] {"ListPipelineExecutions"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListPipelineExecutionsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.PipelineExecutionSummary or Amazon.SageMaker.Model.ListPipelineExecutionsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.PipelineExecutionSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListPipelineExecutionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMPipelineExecutionListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.SortPipelineExecutionsBy")]
        public Amazon.SageMaker.SortPipelineExecutionsBy SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>If the result of the previous <code>ListPipelineExecutions</code> request was truncated,
        /// the response includes a <code>NextToken</code>. To retrieve the next set of pipeline
        /// executions, use the token in the next request.</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListPipelineExecutionsResponse, GetSMPipelineExecutionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListPipelineExecutionsRequest();
        ...
        private Amazon.SageMaker.Model.ListPipelineExecutionsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListPipelineExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListPipelineExecutions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortPipelineExecutionsBy SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListPipelineExecutionsResponse, GetSMPipelineExecutionListCmdlet, object> Select { get; set; } =
