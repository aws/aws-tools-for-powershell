...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListLabelingJobs API operation.", Operation = new[] {"ListLabelingJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListLabelingJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.LabelingJobSummary or Amazon.SageMaker.Model.ListLabelingJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.LabelingJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListLabelingJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMLabelingJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListLabelingJobsResponse, GetSMLabelingJobListCmdlet>(Select) ??
        ...
        private Amazon.SageMaker.Model.ListLabelingJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListLabelingJobsRequest request)
        {
            ...
            try
            {
                return client.ListLabelingJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.LabelingJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListLabelingJobsResponse, GetSMLabelingJobListCmdlet, object> Select { get; set; } =
