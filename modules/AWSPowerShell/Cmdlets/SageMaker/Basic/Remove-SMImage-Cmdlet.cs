...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteImage API operation.", Operation = new[] {"DeleteImage"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteImageResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.DeleteImageResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.DeleteImageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMImageCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMImage (DeleteImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteImageResponse, RemoveSMImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteImageRequest();
        ...
        private Amazon.SageMaker.Model.DeleteImageResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteImage");
            try
            {
                #if DESKTOP
                return client.DeleteImage(request);
                #elif CORECLR
                return client.DeleteImageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ImageName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteImageResponse, RemoveSMImageCmdlet, object> Select { get; set; } =
