...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdlet("Calls the Amazon SageMaker Service ListCompilationJobs API operation.", Operation = new[] {"ListCompilationJobs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListCompilationJobsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.CompilationJobSummary or Amazon.SageMaker.Model.ListCompilationJobsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.CompilationJobSummary objects.",
        "The service call response (type Amazon.SageMaker.Model.ListCompilationJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMCompilationJobListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CompilationJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListCompilationJobsResponse, GetSMCompilationJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.CompilationJobSummaries?.Count ?? 0;
        ...
        private Amazon.SageMaker.Model.ListCompilationJobsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListCompilationJobsRequest request)
        {
            ...
            try
            {
                return client.ListCompilationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public Amazon.SageMaker.CompilationJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListCompilationJobsResponse, GetSMCompilationJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CompilationJobSummaries;
        }
