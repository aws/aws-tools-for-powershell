...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMHubContent")]
    [OutputType("Amazon.SageMaker.Model.DescribeHubContentResponse")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DescribeHubContent API operation.", Operation = new[] {"DescribeHubContent"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DescribeHubContentResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.DescribeHubContentResponse",
        "This cmdlet returns an Amazon.SageMaker.Model.DescribeHubContentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMHubContentCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DescribeHubContentResponse, GetSMHubContentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DescribeHubContentRequest();
        ...
        private Amazon.SageMaker.Model.DescribeHubContentResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DescribeHubContentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DescribeHubContent");
            try
            {
                #if DESKTOP
                return client.DescribeHubContent(request);
                #elif CORECLR
                return client.DescribeHubContentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String HubContentVersion { get; set; }
            public System.String HubName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DescribeHubContentResponse, GetSMHubContentCmdlet, object> Select { get; set; } =
