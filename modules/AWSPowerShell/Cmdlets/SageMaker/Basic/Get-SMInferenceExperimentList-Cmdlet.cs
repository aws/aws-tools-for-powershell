...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [AWSCmdletOutput("Amazon.SageMaker.Model.InferenceExperimentSummary or Amazon.SageMaker.Model.ListInferenceExperimentsResponse",
        ...
        "The service call response (type Amazon.SageMaker.Model.ListInferenceExperimentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMInferenceExperimentListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// see <a>DescribeInferenceExperimentResponse$Status</a>. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        ...
        /// see <a>CreateInferenceExperimentRequest$Type</a>. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.SageMaker.Model.ListInferenceExperimentsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListInferenceExperimentsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListInferenceExperiments(request);
                #elif CORECLR
                return client.ListInferenceExperimentsAsync(request).GetAwaiter().GetResult();
                #else
