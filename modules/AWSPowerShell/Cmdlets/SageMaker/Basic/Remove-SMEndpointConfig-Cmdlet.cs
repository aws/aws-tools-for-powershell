...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon SageMaker Service DeleteEndpointConfig API operation.", Operation = new[] {"DeleteEndpointConfig"}, SelectReturnType = typeof(Amazon.SageMaker.Model.DeleteEndpointConfigResponse))]
    [AWSCmdletOutput("None or Amazon.SageMaker.Model.DeleteEndpointConfigResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SageMaker.Model.DeleteEndpointConfigResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMEndpointConfigCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMEndpointConfig (DeleteEndpointConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.DeleteEndpointConfigResponse, RemoveSMEndpointConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SageMaker.Model.DeleteEndpointConfigRequest();
        ...
        private Amazon.SageMaker.Model.DeleteEndpointConfigResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.DeleteEndpointConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "DeleteEndpointConfig");
            try
            {
                #if DESKTOP
                return client.DeleteEndpointConfig(request);
                #elif CORECLR
                return client.DeleteEndpointConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EndpointConfigName { get; set; }
            public System.Func<Amazon.SageMaker.Model.DeleteEndpointConfigResponse, RemoveSMEndpointConfigCmdlet, object> Select { get; set; } =
