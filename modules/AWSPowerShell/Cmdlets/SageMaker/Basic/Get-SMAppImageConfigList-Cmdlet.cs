...
namespace Amazon.PowerShell.Cmdlets.SM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMAppImageConfigList")]
    [OutputType("Amazon.SageMaker.Model.AppImageConfigDetails")]
    [AWSCmdlet("Calls the Amazon SageMaker Service ListAppImageConfigs API operation.", Operation = new[] {"ListAppImageConfigs"}, SelectReturnType = typeof(Amazon.SageMaker.Model.ListAppImageConfigsResponse))]
    [AWSCmdletOutput("Amazon.SageMaker.Model.AppImageConfigDetails or Amazon.SageMaker.Model.ListAppImageConfigsResponse",
        "This cmdlet returns a collection of Amazon.SageMaker.Model.AppImageConfigDetails objects.",
        "The service call response (type Amazon.SageMaker.Model.ListAppImageConfigsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMAppImageConfigListCmdlet : AmazonSageMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.SageMaker.AppImageConfigSortKey")]
        public Amazon.SageMaker.AppImageConfigSortKey SortBy { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of AppImageConfigs to return in the response. The default value
        /// is 10. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AppImageConfigs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SageMaker.Model.ListAppImageConfigsResponse, GetSMAppImageConfigListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SageMaker.Model.ListAppImageConfigsRequest();
        ...
        private Amazon.SageMaker.Model.ListAppImageConfigsResponse CallAWSServiceOperation(IAmazonSageMaker client, Amazon.SageMaker.Model.ListAppImageConfigsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SageMaker Service", "ListAppImageConfigs");
            try
            {
                #if DESKTOP
                return client.ListAppImageConfigs(request);
                #elif CORECLR
                return client.ListAppImageConfigsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SageMaker.AppImageConfigSortKey SortBy { get; set; }
            public Amazon.SageMaker.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.SageMaker.Model.ListAppImageConfigsResponse, GetSMAppImageConfigListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AppImageConfigs;
        }
