...
namespace Amazon.PowerShell.Cmdlets.SSW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSWApp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS SimSpace Weaver DeleteApp API operation.", Operation = new[] {"DeleteApp"}, SelectReturnType = typeof(Amazon.SimSpaceWeaver.Model.DeleteAppResponse))]
    [AWSCmdletOutput("None or Amazon.SimSpaceWeaver.Model.DeleteAppResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimSpaceWeaver.Model.DeleteAppResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSSWAppCmdlet : AmazonSimSpaceWeaverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSWApp (DeleteApp)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimSpaceWeaver.Model.DeleteAppResponse, RemoveSSWAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimSpaceWeaver.Model.DeleteAppRequest();
        ...
        private Amazon.SimSpaceWeaver.Model.DeleteAppResponse CallAWSServiceOperation(IAmazonSimSpaceWeaver client, Amazon.SimSpaceWeaver.Model.DeleteAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS SimSpace Weaver", "DeleteApp");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Domain { get; set; }
            public System.String Simulation { get; set; }
            public System.Func<Amazon.SimSpaceWeaver.Model.DeleteAppResponse, RemoveSSWAppCmdlet, object> Select { get; set; } =
