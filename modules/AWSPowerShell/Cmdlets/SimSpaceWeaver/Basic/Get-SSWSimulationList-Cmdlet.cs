...
namespace Amazon.PowerShell.Cmdlets.SSW
{
    ...
    [AWSCmdletOutput("Amazon.SimSpaceWeaver.Model.SimulationMetadata or Amazon.SimSpaceWeaver.Model.ListSimulationsResponse",
        ...
        "The service call response (type Amazon.SimSpaceWeaver.Model.ListSimulationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSWSimulationListCmdlet : AmazonSimSpaceWeaverClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If SimSpace Weaver returns <code>nextToken</code>, there are more results available.
        ...
        /// token that isn't valid, you receive an <i>HTTP 400 ValidationException</i> error.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.SimSpaceWeaver.Model.ListSimulationsResponse CallAWSServiceOperation(IAmazonSimSpaceWeaver client, Amazon.SimSpaceWeaver.Model.ListSimulationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListSimulations(request);
                #elif CORECLR
                return client.ListSimulationsAsync(request).GetAwaiter().GetResult();
                #else
