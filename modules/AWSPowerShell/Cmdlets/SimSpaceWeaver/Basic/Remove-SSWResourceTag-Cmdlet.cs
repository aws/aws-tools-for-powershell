...
namespace Amazon.PowerShell.Cmdlets.SSW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSWResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSWResourceTagCmdlet : AmazonSimSpaceWeaverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSWResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimSpaceWeaver.Model.UntagResourceResponse, RemoveSSWResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimSpaceWeaver.Model.UntagResourceRequest();
        ...
        private Amazon.SimSpaceWeaver.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonSimSpaceWeaver client, Amazon.SimSpaceWeaver.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS SimSpace Weaver", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SimSpaceWeaver.Model.UntagResourceResponse, RemoveSSWResourceTagCmdlet, object> Select { get; set; } =
