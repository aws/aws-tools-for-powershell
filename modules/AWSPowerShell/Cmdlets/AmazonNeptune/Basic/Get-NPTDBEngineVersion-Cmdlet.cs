...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBEngineVersions API operation.", Operation = new[] {"DescribeDBEngineVersions"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBEngineVersion",
