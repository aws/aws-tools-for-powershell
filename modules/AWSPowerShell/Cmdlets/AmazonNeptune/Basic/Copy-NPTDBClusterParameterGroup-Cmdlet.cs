...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune CopyDBClusterParameterGroup API operation.", Operation = new[] {"CopyDBClusterParameterGroup"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBClusterParameterGroup",
        "This cmdlet returns a DBClusterParameterGroup object.",
        "The service call response (type Amazon.Neptune.Model.CopyDBClusterParameterGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
