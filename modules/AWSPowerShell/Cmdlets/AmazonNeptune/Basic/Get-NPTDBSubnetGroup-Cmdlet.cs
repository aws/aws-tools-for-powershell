...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NPTDBSubnetGroup")]
    [OutputType("Amazon.Neptune.Model.DBSubnetGroup")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBSubnetGroups API operation.", Operation = new[] {"DescribeDBSubnetGroups"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBSubnetGroup",
        "This cmdlet returns a collection of DBSubnetGroup objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBSubnetGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetNPTDBSubnetGroupCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeDBSubnetGroupsRequest();
        ...
        private Amazon.Neptune.Model.DescribeDBSubnetGroupsResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeDBSubnetGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeDBSubnetGroups");
            try
            {
                #if DESKTOP
