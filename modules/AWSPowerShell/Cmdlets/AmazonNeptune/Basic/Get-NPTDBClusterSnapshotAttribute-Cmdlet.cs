...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBClusterSnapshotAttributes API operation.", Operation = new[] {"DescribeDBClusterSnapshotAttributes"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBClusterSnapshotAttributesResult",
