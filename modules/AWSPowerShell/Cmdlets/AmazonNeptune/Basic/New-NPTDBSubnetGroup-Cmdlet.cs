...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune CreateDBSubnetGroup API operation.", Operation = new[] {"CreateDBSubnetGroup"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBSubnetGroup",
        "This cmdlet returns a DBSubnetGroup object.",
        "The service call response (type Amazon.Neptune.Model.CreateDBSubnetGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
