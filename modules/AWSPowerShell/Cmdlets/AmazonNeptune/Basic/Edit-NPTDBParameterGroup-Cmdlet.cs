...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune ModifyDBParameterGroup API operation.", Operation = new[] {"ModifyDBParameterGroup"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a String object.",
        "The service call response (type Amazon.Neptune.Model.ModifyDBParameterGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EditNPTDBParameterGroupCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        private Amazon.Neptune.Model.ModifyDBParameterGroupResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.ModifyDBParameterGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ModifyDBParameterGroupAsync(request);
                return task.Result;
                #else
