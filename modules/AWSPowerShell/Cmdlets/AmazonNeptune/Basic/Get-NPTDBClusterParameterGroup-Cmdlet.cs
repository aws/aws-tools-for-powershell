...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NPTDBClusterParameterGroup")]
    [OutputType("Amazon.Neptune.Model.DBClusterParameterGroup")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBClusterParameterGroups API operation.", Operation = new[] {"DescribeDBClusterParameterGroups"})]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBClusterParameterGroup",
        "This cmdlet returns a collection of DBClusterParameterGroup objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetNPTDBClusterParameterGroupCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeDBClusterParameterGroupsRequest();
        ...
        private Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeDBClusterParameterGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeDBClusterParameterGroups");
            try
            {
                #if DESKTOP
