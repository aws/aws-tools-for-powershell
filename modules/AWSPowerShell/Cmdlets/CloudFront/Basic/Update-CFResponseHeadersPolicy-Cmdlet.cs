...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [OutputType("Amazon.CloudFront.Model.ResponseHeadersPolicy")]
    ...
    public partial class UpdateCFResponseHeadersPolicyCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the response headers policy that you are updating.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The version of the response headers policy that you are updating.</para><para>The version is returned in the cache policy's <c>ETag</c> field in the response to
        /// <c>GetResponseHeadersPolicyConfig</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ResponseHeadersPolicy'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.UpdateResponseHeadersPolicyResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.UpdateResponseHeadersPolicyResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CFResponseHeadersPolicy (UpdateResponseHeadersPolicy)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.UpdateResponseHeadersPolicyRequest();
        ...
        private Amazon.CloudFront.Model.UpdateResponseHeadersPolicyResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.UpdateResponseHeadersPolicyRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? ServerTimingHeadersConfig_Enabled { get; set; }
            public System.Double? ServerTimingHeadersConfig_SamplingRate { get; set; }
            public System.Func<Amazon.CloudFront.Model.UpdateResponseHeadersPolicyResponse, UpdateCFResponseHeadersPolicyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResponseHeadersPolicy;
        }
