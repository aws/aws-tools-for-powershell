...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    /// </summary>
    [Cmdlet("New", "CFInvalidationForDistributionTenant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse")]
    [AWSCmdlet("Calls the Amazon CloudFront CreateInvalidationForDistributionTenant API operation.", Operation = new[] {"CreateInvalidationForDistributionTenant"}, SelectReturnType = typeof(Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse object containing multiple properties."
    )]
    public partial class NewCFInvalidationForDistributionTenantCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A complex type that contains a list of the paths that you want to invalidate.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CFInvalidationForDistributionTenant (CreateInvalidationForDistributionTenant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse, NewCFInvalidationForDistributionTenantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantRequest();
        ...
        private Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "CreateInvalidationForDistributionTenant");
            try
            {
                return client.CreateInvalidationForDistributionTenantAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? Paths_Quantity { get; set; }
            public System.Func<Amazon.CloudFront.Model.CreateInvalidationForDistributionTenantResponse, NewCFInvalidationForDistributionTenantCmdlet, object> Select { get; set; } =
