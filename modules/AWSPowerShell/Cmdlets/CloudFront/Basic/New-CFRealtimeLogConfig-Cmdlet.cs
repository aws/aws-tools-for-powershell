...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.RealtimeLogConfig or Amazon.CloudFront.Model.CreateRealtimeLogConfigResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.CreateRealtimeLogConfigResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCFRealtimeLogConfigCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// log configuration fields</a> in the <i>Amazon CloudFront Developer Guide</i>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The sampling rate for this real-time log configuration. You can specify a whole number
        /// between 1 and 100 (inclusive) to determine the percentage of viewer requests that
        /// are represented in the real-time log data.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CloudFront.Model.CreateRealtimeLogConfigResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.CreateRealtimeLogConfigRequest request)
        {
            ...
            try
            {
                return client.CreateRealtimeLogConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
