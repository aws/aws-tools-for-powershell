...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class RemoveCFKeyGroupCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.DeleteKeyGroupResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CFKeyGroup (DeleteKeyGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.DeleteKeyGroupResponse, RemoveCFKeyGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.DeleteKeyGroupRequest();
        ...
        private Amazon.CloudFront.Model.DeleteKeyGroupResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.DeleteKeyGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "DeleteKeyGroup");
            try
            {
                #if DESKTOP
                return client.DeleteKeyGroup(request);
                #elif CORECLR
                return client.DeleteKeyGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IfMatch { get; set; }
            public System.Func<Amazon.CloudFront.Model.DeleteKeyGroupResponse, RemoveCFKeyGroupCmdlet, object> Select { get; set; } =
