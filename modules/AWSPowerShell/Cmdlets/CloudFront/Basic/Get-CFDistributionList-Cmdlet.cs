...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    /// </summary>
    [Cmdlet("Get", "CFDistributionList")]
    [OutputType("Amazon.CloudFront.Model.DistributionSummary")]
    [AWSCmdlet("Calls the Amazon CloudFront ListDistributions API operation.", Operation = new[] {"ListDistributions"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListDistributionsResponse), LegacyAlias="Get-CFDistributions")]
    [AWSCmdletOutput("Amazon.CloudFront.Model.DistributionSummary or Amazon.CloudFront.Model.ListDistributionsResponse",
        "This cmdlet returns a collection of Amazon.CloudFront.Model.DistributionSummary objects.",
        "The service call response (type Amazon.CloudFront.Model.ListDistributionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFDistributionListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListDistributionsResponse, GetCFDistributionListCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.ListDistributionsResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListDistributionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "ListDistributions");
            try
            {
                return client.ListDistributionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListDistributionsResponse, GetCFDistributionListCmdlet, object> Select { get; set; } =
