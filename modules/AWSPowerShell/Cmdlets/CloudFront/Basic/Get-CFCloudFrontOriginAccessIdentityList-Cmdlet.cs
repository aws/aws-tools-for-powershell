...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront ListCloudFrontOriginAccessIdentities API operation.", Operation = new[] {"ListCloudFrontOriginAccessIdentities"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse), LegacyAlias="Get-CFCloudFrontOriginAccessIdentities")]
    [AWSCmdletOutput("Amazon.CloudFront.Model.CloudFrontOriginAccessIdentitySummary or Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse",
        "This cmdlet returns a collection of Amazon.CloudFront.Model.CloudFrontOriginAccessIdentitySummary objects.",
        "The service call response (type Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFCloudFrontOriginAccessIdentityListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CloudFrontOriginAccessIdentityList.Items";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse, GetCFCloudFrontOriginAccessIdentityListCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesRequest request)
        {
            ...
            try
            {
                return client.ListCloudFrontOriginAccessIdentitiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListCloudFrontOriginAccessIdentitiesResponse, GetCFCloudFrontOriginAccessIdentityListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CloudFrontOriginAccessIdentityList.Items;
        }
