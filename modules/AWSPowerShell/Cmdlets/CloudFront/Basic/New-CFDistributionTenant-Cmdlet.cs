...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    /// </summary>
    [Cmdlet("New", "CFDistributionTenant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudFront.Model.DistributionTenant")]
    [AWSCmdlet("Calls the Amazon CloudFront CreateDistributionTenant API operation.", Operation = new[] {"CreateDistributionTenant"}, SelectReturnType = typeof(Amazon.CloudFront.Model.CreateDistributionTenantResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.DistributionTenant or Amazon.CloudFront.Model.CreateDistributionTenantResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.DistributionTenant object.",
        "The service call response (type Amazon.CloudFront.Model.CreateDistributionTenantResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCFDistributionTenantCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the connection group to associate with the distribution tenant.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the multi-tenant distribution to use for creating the distribution tenant.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Indicates whether the distribution tenant should be enabled when created. If the distribution
        /// tenant is disabled, the distribution tenant won't serve traffic.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the distribution tenant. Enter a friendly identifier that is unique within
        /// your Amazon Web Services account. This name can't be updated after you create the
        /// distribution tenant.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.CreateDistributionTenantResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.CreateDistributionTenantResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CFDistributionTenant (CreateDistributionTenant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.CreateDistributionTenantResponse, NewCFDistributionTenantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.CreateDistributionTenantRequest();
        ...
        private Amazon.CloudFront.Model.CreateDistributionTenantResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.CreateDistributionTenantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "CreateDistributionTenant");
            try
            {
                #if DESKTOP
                return client.CreateDistributionTenant(request);
                #elif CORECLR
                return client.CreateDistributionTenantAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudFront.Model.CreateDistributionTenantResponse, NewCFDistributionTenantCmdlet, object> Select { get; set; } =
