...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront ListFieldLevelEncryptionProfiles API operation.", Operation = new[] {"ListFieldLevelEncryptionProfiles"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.FieldLevelEncryptionProfileSummary or Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse",
        "This cmdlet returns a collection of Amazon.CloudFront.Model.FieldLevelEncryptionProfileSummary objects.",
        "The service call response (type Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFFieldLevelEncryptionProfileListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// the current page's response (which is also the ID of the last profile on that page).</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FieldLevelEncryptionProfileList.Items";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse, GetCFFieldLevelEncryptionProfileListCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesRequest request)
        {
            ...
            try
            {
                return client.ListFieldLevelEncryptionProfilesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListFieldLevelEncryptionProfilesResponse, GetCFFieldLevelEncryptionProfileListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FieldLevelEncryptionProfileList.Items;
        }
