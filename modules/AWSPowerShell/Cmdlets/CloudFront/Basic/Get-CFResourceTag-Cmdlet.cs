...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.Tags or Amazon.CloudFront.Model.ListTagsForResourceResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.Tags object.",
        "The service call response (type Amazon.CloudFront.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFResourceTagCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListTagsForResourceResponse, GetCFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.ListTagsForResourceRequest();
        ...
        private Amazon.CloudFront.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Resource { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListTagsForResourceResponse, GetCFResourceTagCmdlet, object> Select { get; set; } =
