...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFKeyGroupCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the key group that you are getting. To get the identifier, use <code>ListKeyGroups</code>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.GetKeyGroupResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.GetKeyGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetKeyGroupResponse, GetCFKeyGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetKeyGroupRequest();
        ...
        private Amazon.CloudFront.Model.GetKeyGroupResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetKeyGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "GetKeyGroup");
            try
            {
                #if DESKTOP
                return client.GetKeyGroup(request);
                #elif CORECLR
                return client.GetKeyGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetKeyGroupResponse, GetCFKeyGroupCmdlet, object> Select { get; set; } =
