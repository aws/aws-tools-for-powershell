...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.DistributionIdList or Amazon.CloudFront.Model.ListDistributionsByResponseHeadersPolicyIdResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.ListDistributionsByResponseHeadersPolicyIdResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFDistributionsByResponseHeadersPolicyIdCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ResponseHeadersPolicyId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ResponseHeadersPolicyId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResponseHeadersPolicyId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ResponseHeadersPolicyId;
            }
