...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    /// </summary>
    [Cmdlet("New", "CFConnectionFunction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudFront.Model.CreateConnectionFunctionResponse")]
    [AWSCmdlet("Calls the Amazon CloudFront CreateConnectionFunction API operation.", Operation = new[] {"CreateConnectionFunction"}, SelectReturnType = typeof(Amazon.CloudFront.Model.CreateConnectionFunctionResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.CreateConnectionFunctionResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.CreateConnectionFunctionResponse object containing multiple properties."
    )]
    public partial class NewCFConnectionFunctionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The code for the connection function.</para>
        /// </para>
        ...
        /// <summary>
        /// <para>
        /// <para>A name for the connection function.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.CreateConnectionFunctionResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.CreateConnectionFunctionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CFConnectionFunction (CreateConnectionFunction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.CreateConnectionFunctionResponse, NewCFConnectionFunctionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.CloudFront.Model.CreateConnectionFunctionRequest();
        ...
        private Amazon.CloudFront.Model.CreateConnectionFunctionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.CreateConnectionFunctionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "CreateConnectionFunction");
            try
            {
                #if DESKTOP
                return client.CreateConnectionFunction(request);
                #elif CORECLR
                return client.CreateConnectionFunctionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudFront.Model.CreateConnectionFunctionResponse, NewCFConnectionFunctionCmdlet, object> Select { get; set; } =
