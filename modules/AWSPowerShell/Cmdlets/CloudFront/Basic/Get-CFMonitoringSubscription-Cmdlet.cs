...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    /// </summary>
    [Cmdlet("Get", "CFMonitoringSubscription")]
    [OutputType("Amazon.CloudFront.Model.MonitoringSubscription")]
    [AWSCmdlet("Calls the Amazon CloudFront GetMonitoringSubscription API operation.", Operation = new[] {"GetMonitoringSubscription"}, SelectReturnType = typeof(Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.MonitoringSubscription or Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.MonitoringSubscription object.",
        "The service call response (type Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFMonitoringSubscriptionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse, GetCFMonitoringSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetMonitoringSubscriptionRequest();
        ...
        private Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetMonitoringSubscriptionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "GetMonitoringSubscription");
            try
            {
                #if DESKTOP
                return client.GetMonitoringSubscription(request);
                #elif CORECLR
                return client.GetMonitoringSubscriptionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DistributionId { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetMonitoringSubscriptionResponse, GetCFMonitoringSubscriptionCmdlet, object> Select { get; set; } =
