...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class CopyCFDistributionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// you set this value to <c>False</c>, the staging distribution is disabled.</para><para>If you omit this field, the default value is <c>True</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <c>GetDistributionConfig</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// get a distribution ID, use <c>ListDistributions</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// valid value is <c>True</c>, indicating that you are copying to a staging distribution.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CloudFront.Model.CopyDistributionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.CopyDistributionRequest request)
        {
            ...
            try
            {
                return client.CopyDistributionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
