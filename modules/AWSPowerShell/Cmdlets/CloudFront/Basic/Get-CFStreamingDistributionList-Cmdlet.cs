...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront ListStreamingDistributions API operation.", Operation = new[] {"ListStreamingDistributions"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListStreamingDistributionsResponse), LegacyAlias="Get-CFStreamingDistributions")]
    [AWSCmdletOutput("Amazon.CloudFront.Model.StreamingDistributionSummary or Amazon.CloudFront.Model.ListStreamingDistributionsResponse",
        "This cmdlet returns a collection of Amazon.CloudFront.Model.StreamingDistributionSummary objects.",
        "The service call response (type Amazon.CloudFront.Model.ListStreamingDistributionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFStreamingDistributionListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StreamingDistributionList.Items";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListStreamingDistributionsResponse, GetCFStreamingDistributionListCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.ListStreamingDistributionsResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListStreamingDistributionsRequest request)
        {
            ...
            try
            {
                return client.ListStreamingDistributionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListStreamingDistributionsResponse, GetCFStreamingDistributionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StreamingDistributionList.Items;
        }
