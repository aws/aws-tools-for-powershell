...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFPublicKeyCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetPublicKeyResponse, GetCFPublicKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetPublicKeyRequest();
        ...
        private Amazon.CloudFront.Model.GetPublicKeyResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetPublicKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "GetPublicKey");
            try
            {
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetPublicKeyResponse, GetCFPublicKeyCmdlet, object> Select { get; set; } =
