...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.OriginAccessControl or Amazon.CloudFront.Model.UpdateOriginAccessControlResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.UpdateOriginAccessControlResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCFOriginAccessControlCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The current version (<code>ETag</code> value) of the origin access control that you
        /// are updating.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            #if MODULAR
            if (this.OriginAccessControlConfig_Description == null && ParameterWasBound(nameof(this.OriginAccessControlConfig_Description)))
            {
                WriteWarning("You are passing $null as a value for parameter OriginAccessControlConfig_Description which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
