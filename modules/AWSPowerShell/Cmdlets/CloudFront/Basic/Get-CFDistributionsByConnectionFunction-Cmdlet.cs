...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFDistributionsByConnectionFunctionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ConnectionFunctionIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ConnectionFunctionIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ConnectionFunctionIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ConnectionFunctionIdentifier;
            }
        ...
        private Amazon.CloudFront.Model.ListDistributionsByConnectionFunctionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListDistributionsByConnectionFunctionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListDistributionsByConnectionFunction(request);
                #elif CORECLR
                return client.ListDistributionsByConnectionFunctionAsync(request).GetAwaiter().GetResult();
                #else
