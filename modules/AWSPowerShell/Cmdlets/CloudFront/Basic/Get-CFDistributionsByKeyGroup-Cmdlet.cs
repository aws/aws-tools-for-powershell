...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.DistributionIdList or Amazon.CloudFront.Model.ListDistributionsByKeyGroupResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.ListDistributionsByKeyGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFDistributionsByKeyGroupCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the KeyGroupId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^KeyGroupId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^KeyGroupId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.KeyGroupId;
            }
        ...
        private Amazon.CloudFront.Model.ListDistributionsByKeyGroupResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListDistributionsByKeyGroupRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListDistributionsByKeyGroup(request);
                #elif CORECLR
                return client.ListDistributionsByKeyGroupAsync(request).GetAwaiter().GetResult();
                #else
