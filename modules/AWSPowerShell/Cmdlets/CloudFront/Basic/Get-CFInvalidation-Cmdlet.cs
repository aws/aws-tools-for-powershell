...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront GetInvalidation API operation.", Operation = new[] {"GetInvalidation"}, SelectReturnType = typeof(Amazon.CloudFront.Model.GetInvalidationResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.Invalidation or Amazon.CloudFront.Model.GetInvalidationResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.Invalidation object.",
        "The service call response (type Amazon.CloudFront.Model.GetInvalidationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFInvalidationCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Invalidation";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetInvalidationResponse, GetCFInvalidationCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.GetInvalidationResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetInvalidationRequest request)
        {
            ...
            try
            {
                return client.GetInvalidationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DistributionId { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetInvalidationResponse, GetCFInvalidationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Invalidation;
        }
