...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class AddCFResourceTagCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        public Amazon.CloudFront.Model.Tag[] Tag { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CFResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.TagResourceResponse, AddCFResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.CloudFront.Model.Tag>(this.Tag);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.TagResourceRequest();
            ...
            {
                requestTags_tag = cmdletContext.Tag;
            }
        ...
        {
            public System.String Resource { get; set; }
            public List<Amazon.CloudFront.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.CloudFront.Model.TagResourceResponse, AddCFResourceTagCmdlet, object> Select { get; set; } =
