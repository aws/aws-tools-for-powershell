...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFConnectionGroupByRoutingEndpointCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RoutingEndpoint parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RoutingEndpoint' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RoutingEndpoint' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RoutingEndpoint;
            }
        ...
        private Amazon.CloudFront.Model.GetConnectionGroupByRoutingEndpointResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetConnectionGroupByRoutingEndpointRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetConnectionGroupByRoutingEndpoint(request);
                #elif CORECLR
                return client.GetConnectionGroupByRoutingEndpointAsync(request).GetAwaiter().GetResult();
                #else
