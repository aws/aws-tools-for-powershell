...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFFunctionCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the function whose code you are getting.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.GetFunctionResponse).
        /// Specifying the name of a property of type Amazon.CloudFront.Model.GetFunctionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetFunctionResponse, GetCFFunctionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetFunctionRequest();
        ...
        private Amazon.CloudFront.Model.GetFunctionResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetFunctionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "GetFunction");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public Amazon.CloudFront.FunctionStage Stage { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetFunctionResponse, GetCFFunctionCmdlet, object> Select { get; set; } =
