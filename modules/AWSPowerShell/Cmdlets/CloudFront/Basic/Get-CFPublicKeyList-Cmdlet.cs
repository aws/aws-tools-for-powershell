...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront ListPublicKeys API operation.", Operation = new[] {"ListPublicKeys"}, SelectReturnType = typeof(Amazon.CloudFront.Model.ListPublicKeysResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.PublicKeySummary or Amazon.CloudFront.Model.ListPublicKeysResponse",
        "This cmdlet returns a collection of Amazon.CloudFront.Model.PublicKeySummary objects.",
        "The service call response (type Amazon.CloudFront.Model.ListPublicKeysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFPublicKeyListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PublicKeyList.Items";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.ListPublicKeysResponse, GetCFPublicKeyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    _nextToken = response.PublicKeyList.NextMarker;
                }
                catch (Exception e)
                {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.PublicKeyList.Items?.Count ?? 0;
        ...
        private Amazon.CloudFront.Model.ListPublicKeysResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListPublicKeysRequest request)
        {
            ...
            try
            {
                return client.ListPublicKeysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.CloudFront.Model.ListPublicKeysResponse, GetCFPublicKeyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PublicKeyList.Items;
        }
