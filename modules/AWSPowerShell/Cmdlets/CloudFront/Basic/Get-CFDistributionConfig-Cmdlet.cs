...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFDistributionConfigCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "DistributionConfig";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetDistributionConfigResponse, GetCFDistributionConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetDistributionConfigRequest();
        ...
        private Amazon.CloudFront.Model.GetDistributionConfigResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetDistributionConfigRequest request)
        {
            ...
            try
            {
                return client.GetDistributionConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetDistributionConfigResponse, GetCFDistributionConfigCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DistributionConfig;
        }
