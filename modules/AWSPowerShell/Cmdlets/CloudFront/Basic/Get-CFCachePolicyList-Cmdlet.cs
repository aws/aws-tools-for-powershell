...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.CachePolicyList or Amazon.CloudFront.Model.ListCachePoliciesResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.ListCachePoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFCachePolicyListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A filter to return only the specified kinds of cache policies. Valid values are:</para><ul><li><para><c>managed</c> – Returns only the managed policies created by Amazon Web Services.</para></li><li><para><c>custom</c> – Returns only the custom policies created in your Amazon Web Services
        /// account.</para></li></ul>
        /// </para>
        /// </summary>
        ...
        private Amazon.CloudFront.Model.ListCachePoliciesResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListCachePoliciesRequest request)
        {
            ...
            try
            {
                return client.ListCachePoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
