...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.ResponseHeadersPolicyList or Amazon.CloudFront.Model.ListResponseHeadersPoliciesResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.ListResponseHeadersPoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFResponseHeadersPolicyListCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// are:</para><ul><li><para><code>managed</code> – Gets only the managed policies created by Amazon Web Services.</para></li><li><para><code>custom</code> – Gets only the custom policies created in your Amazon Web Services
        /// account.</para></li></ul>
        /// </para>
        /// </summary>
        ...
        private Amazon.CloudFront.Model.ListResponseHeadersPoliciesResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListResponseHeadersPoliciesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListResponseHeadersPolicies(request);
                #elif CORECLR
                return client.ListResponseHeadersPoliciesAsync(request).GetAwaiter().GetResult();
                #else
