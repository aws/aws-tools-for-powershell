...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront GetCachePolicy API operation.", Operation = new[] {"GetCachePolicy"}, SelectReturnType = typeof(Amazon.CloudFront.Model.GetCachePolicyResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.CachePolicy or Amazon.CloudFront.Model.GetCachePolicyResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.CachePolicy object.",
        "The service call response (type Amazon.CloudFront.Model.GetCachePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFCachePolicyCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetCachePolicyResponse, GetCFCachePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.GetCachePolicyRequest();
        ...
        private Amazon.CloudFront.Model.GetCachePolicyResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetCachePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "GetCachePolicy");
            try
            {
                #if DESKTOP
                return client.GetCachePolicy(request);
                #elif CORECLR
                return client.GetCachePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetCachePolicyResponse, GetCFCachePolicyCmdlet, object> Select { get; set; } =
