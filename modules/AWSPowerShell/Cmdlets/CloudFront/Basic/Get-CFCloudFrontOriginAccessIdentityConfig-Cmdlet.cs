...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class GetCFCloudFrontOriginAccessIdentityConfigCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "CloudFrontOriginAccessIdentityConfig";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.GetCloudFrontOriginAccessIdentityConfigResponse, GetCFCloudFrontOriginAccessIdentityConfigCmdlet>(Select) ??
        ...
        private Amazon.CloudFront.Model.GetCloudFrontOriginAccessIdentityConfigResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.GetCloudFrontOriginAccessIdentityConfigRequest request)
        {
            ...
            try
            {
                return client.GetCloudFrontOriginAccessIdentityConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CloudFront.Model.GetCloudFrontOriginAccessIdentityConfigResponse, GetCFCloudFrontOriginAccessIdentityConfigCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CloudFrontOriginAccessIdentityConfig;
        }
