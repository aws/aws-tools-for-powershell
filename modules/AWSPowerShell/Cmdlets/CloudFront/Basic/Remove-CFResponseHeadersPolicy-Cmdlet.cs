...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    public partial class RemoveCFResponseHeadersPolicyCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudFront.Model.DeleteResponseHeadersPolicyResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CFResponseHeadersPolicy (DeleteResponseHeadersPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.DeleteResponseHeadersPolicyResponse, RemoveCFResponseHeadersPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFront.Model.DeleteResponseHeadersPolicyRequest();
        ...
        private Amazon.CloudFront.Model.DeleteResponseHeadersPolicyResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.DeleteResponseHeadersPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront", "DeleteResponseHeadersPolicy");
            try
            {
                #if DESKTOP
                return client.DeleteResponseHeadersPolicy(request);
                #elif CORECLR
                return client.DeleteResponseHeadersPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IfMatch { get; set; }
            public System.Func<Amazon.CloudFront.Model.DeleteResponseHeadersPolicyResponse, RemoveCFResponseHeadersPolicyCmdlet, object> Select { get; set; } =
