...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdlet("Calls the Amazon CloudFront UpdateFieldLevelEncryptionConfig API operation.", Operation = new[] {"UpdateFieldLevelEncryptionConfig"}, SelectReturnType = typeof(Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse))]
    [AWSCmdletOutput("Amazon.CloudFront.Model.FieldLevelEncryption or Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse",
        "This cmdlet returns an Amazon.CloudFront.Model.FieldLevelEncryption object.",
        "The service call response (type Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCFFieldLevelEncryptionConfigCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FieldLevelEncryption";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse, UpdateCFFieldLevelEncryptionConfigCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.FieldLevelEncryptionConfig = this.FieldLevelEncryptionConfig;
            #if MODULAR
            if (this.FieldLevelEncryptionConfig == null && ParameterWasBound(nameof(this.FieldLevelEncryptionConfig)))
            {
                WriteWarning("You are passing $null as a value for parameter FieldLevelEncryptionConfig which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.Id = this.Id;
            #if MODULAR
        ...
        private Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigRequest request)
        {
            ...
            try
            {
                return client.UpdateFieldLevelEncryptionConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Id { get; set; }
            public System.String IfMatch { get; set; }
            public System.Func<Amazon.CloudFront.Model.UpdateFieldLevelEncryptionConfigResponse, UpdateCFFieldLevelEncryptionConfigCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FieldLevelEncryption;
        }
