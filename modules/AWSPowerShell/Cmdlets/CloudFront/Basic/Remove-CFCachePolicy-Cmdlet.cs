...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("None or Amazon.CloudFront.Model.DeleteCachePolicyResponse",
        ...
        "The service response (type Amazon.CloudFront.Model.DeleteCachePolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
