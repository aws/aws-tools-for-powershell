...
namespace Amazon.PowerShell.Cmdlets.CF
{
    ...
    [AWSCmdletOutput("Amazon.CloudFront.Model.DistributionSummary or Amazon.CloudFront.Model.ListDistributionsByWebACLIdResponse",
        ...
        "The service call response (type Amazon.CloudFront.Model.ListDistributionsByWebACLIdResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFDistributionListByWebACLIdCmdlet : AmazonCloudFrontClientCmdlet, IExecutor
    {
        ...
        /// associated with a web ACL. </para><para>For WAFV2, this is the ARN of the web ACL, such as <c>arn:aws:wafv2:us-east-1:123456789012:global/webacl/ExampleWebACL/a1b2c3d4-5678-90ab-cdef-EXAMPLE11111</c>.</para><para>For WAF Classic, this is the ID of the web ACL, such as <c>a1b2c3d4-5678-90ab-cdef-EXAMPLE11111</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.CloudFront.Model.ListDistributionsByWebACLIdResponse CallAWSServiceOperation(IAmazonCloudFront client, Amazon.CloudFront.Model.ListDistributionsByWebACLIdRequest request)
        {
            ...
            try
            {
                return client.ListDistributionsByWebACLIdAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
