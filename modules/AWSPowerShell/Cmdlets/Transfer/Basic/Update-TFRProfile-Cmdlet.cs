...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    /// to update.
    /// </summary>
    [Cmdlet("Update", "TFRProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateTFRProfileCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// working with profiles and partner profiles.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-TFRProfile (UpdateProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.UpdateProfileResponse, UpdateTFRProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.UpdateProfileRequest();
        ...
        private Amazon.Transfer.Model.UpdateProfileResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.UpdateProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "UpdateProfile");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.Transfer.Model.UpdateProfileResponse, UpdateTFRProfileCmdlet, object> Select { get; set; } =
