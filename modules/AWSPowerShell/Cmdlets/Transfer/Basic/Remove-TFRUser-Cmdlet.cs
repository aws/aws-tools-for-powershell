...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "TFRUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveTFRUserCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TFRUser (DeleteUser)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.DeleteUserResponse, RemoveTFRUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.DeleteUserRequest();
        ...
        private Amazon.Transfer.Model.DeleteUserResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.DeleteUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "DeleteUser");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ServerId { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.Transfer.Model.DeleteUserResponse, RemoveTFRUserCmdlet, object> Select { get; set; } =
