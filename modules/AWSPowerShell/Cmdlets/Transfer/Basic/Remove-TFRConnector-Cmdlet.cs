...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class RemoveTFRConnectorCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TFRConnector (DeleteConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.DeleteConnectorResponse, RemoveTFRConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.DeleteConnectorRequest();
        ...
        private Amazon.Transfer.Model.DeleteConnectorResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.DeleteConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "DeleteConnector");
            try
            {
        ...
        {
            public System.String ConnectorId { get; set; }
            public System.Func<Amazon.Transfer.Model.DeleteConnectorResponse, RemoveTFRConnectorCmdlet, object> Select { get; set; } =
