...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class GetTFRAccessCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// you can view the SID values by running the following command using Windows PowerShell.</para><para><code>Get-ADGroup -Filter {samAccountName -like "<i>YourGroupName</i>*"} -Properties
