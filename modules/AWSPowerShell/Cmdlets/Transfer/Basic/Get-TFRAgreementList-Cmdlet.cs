...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdletOutput("Amazon.Transfer.Model.ListedAgreement or Amazon.Transfer.Model.ListAgreementsResponse",
        ...
        "The service call response (type Amazon.Transfer.Model.ListAgreementsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
