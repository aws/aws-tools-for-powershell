...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class UpdateTFRServerCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// client attempts to use SETSTAT on a file you are uploading to an S3 bucket.</para><para>Some SFTP file transfer clients can attempt to change the attributes of remote files,
        ...
        /// result in errors even when the file is otherwise successfully uploaded.</para><para>Set the value to <code>ENABLE_NO_OP</code> to have the Transfer Family server ignore
        ...
        /// when the client is making a SETSTAT call.</para><note><para>If you want to preserve the original timestamp for your file, and modify other file
