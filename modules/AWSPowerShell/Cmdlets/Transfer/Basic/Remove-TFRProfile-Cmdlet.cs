...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdletOutput("None or Amazon.Transfer.Model.DeleteProfileResponse",
        ...
        "The service response (type Amazon.Transfer.Model.DeleteProfileResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
