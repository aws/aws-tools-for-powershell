...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class StartTFRFileTransferCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// file path for one outbound file transfer. For example, <code><i>DOC-EXAMPLE-BUCKET</i>/<i>myfile.txt</i></code>.</para><note><para>Replace <code><i>DOC-EXAMPLE-BUCKET</i></code> with one of your actual buckets.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SendFilePaths")]
