...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class RemoveTFRCertificateCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TFRCertificate (DeleteCertificate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.DeleteCertificateResponse, RemoveTFRCertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.DeleteCertificateRequest();
        ...
        private Amazon.Transfer.Model.DeleteCertificateResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.DeleteCertificateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "DeleteCertificate");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String CertificateId { get; set; }
            public System.Func<Amazon.Transfer.Model.DeleteCertificateResponse, RemoveTFRCertificateCmdlet, object> Select { get; set; } =
