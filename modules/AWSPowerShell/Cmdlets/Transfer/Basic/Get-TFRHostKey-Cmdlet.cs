...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class GetTFRHostKeyCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Provide the ID of the host key that you want described.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>Provide the ID of the server that contains the host key that you want described.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
