...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdletOutput("Amazon.Transfer.Model.CreateAccessResponse",
        "This cmdlet returns an Amazon.Transfer.Model.CreateAccessResponse object containing multiple properties."
    )]
    public partial class NewTFRAccessCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// to <c>/</c> and set <c>Target</c> to the <c>HomeDirectory</c> parameter value.</para><para>The following is an <c>Entry</c> and <c>Target</c> pair example for <c>chroot</c>.</para><para><c>[ { "Entry": "/", "Target": "/bucket_name/home/mydirectory" } ]</c></para><para />
        ...
        private Amazon.Transfer.Model.CreateAccessResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.CreateAccessRequest request)
        {
            ...
            try
            {
                return client.CreateAccessAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
