...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "TFRCertificateList")]
    [OutputType("Amazon.Transfer.Model.ListedCertificate")]
    ...
    public partial class GetTFRCertificateListCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.ListCertificatesResponse, GetTFRCertificateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Transfer.Model.ListCertificatesRequest();
        ...
        private Amazon.Transfer.Model.ListCertificatesResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.ListCertificatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "ListCertificates");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Transfer.Model.ListCertificatesResponse, GetTFRCertificateListCmdlet, object> Select { get; set; } =
