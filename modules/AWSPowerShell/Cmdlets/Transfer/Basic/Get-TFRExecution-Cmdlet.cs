...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class GetTFRExecutionCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.DescribeExecutionResponse, GetTFRExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.DescribeExecutionRequest();
        ...
        private Amazon.Transfer.Model.DescribeExecutionResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.DescribeExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "DescribeExecution");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ExecutionId { get; set; }
            public System.String WorkflowId { get; set; }
            public System.Func<Amazon.Transfer.Model.DescribeExecutionResponse, GetTFRExecutionCmdlet, object> Select { get; set; } =
