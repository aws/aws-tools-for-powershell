...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdlet("Calls the AWS Transfer for SFTP ListUsers API operation.", Operation = new[] {"ListUsers"}, SelectReturnType = typeof(Amazon.Transfer.Model.ListUsersResponse))]
    [AWSCmdletOutput("Amazon.Transfer.Model.ListedUser or Amazon.Transfer.Model.ListUsersResponse",
        "This cmdlet returns a collection of Amazon.Transfer.Model.ListedUser objects.",
        "The service call response (type Amazon.Transfer.Model.ListUsersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTFRUserListCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.ListUsersResponse, GetTFRUserListCmdlet>(Select) ??
            ...
            {
                WriteVerbose("MaxResult parameter unset, using default value of '1000'");
                context.MaxResult = 1000;
            }
            #endif
            #if !MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Transfer.Model.ListUsersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                {
                    request.MaxResults = AutoIterationHelpers.ConvertEmitLimitToInt32(1000);
                }
        ...
        private Amazon.Transfer.Model.ListUsersResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.ListUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "ListUsers");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServerId { get; set; }
            public System.Func<Amazon.Transfer.Model.ListUsersResponse, GetTFRUserListCmdlet, object> Select { get; set; } =
