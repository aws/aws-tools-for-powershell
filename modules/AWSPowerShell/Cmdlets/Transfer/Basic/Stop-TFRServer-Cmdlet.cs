...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class StopTFRServerCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.StopServerResponse, StopTFRServerCmdlet>(Select) ??
        ...
        private Amazon.Transfer.Model.StopServerResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.StopServerRequest request)
        {
            ...
            try
            {
                return client.StopServerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ServerId { get; set; }
            public System.Func<Amazon.Transfer.Model.StopServerResponse, StopTFRServerCmdlet, object> Select { get; set; } =
