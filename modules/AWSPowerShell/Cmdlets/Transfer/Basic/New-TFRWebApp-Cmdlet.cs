...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    public partial class NewTFRWebAppCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// These subnets must be in the same VPC specified in the VpcId parameter.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AccessEndpoint parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AccessEndpoint' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AccessEndpoint' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AccessEndpoint;
            }
        ...
        private Amazon.Transfer.Model.CreateWebAppResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.CreateWebAppRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateWebApp(request);
                #elif CORECLR
                return client.CreateWebAppAsync(request).GetAwaiter().GetResult();
                #else
