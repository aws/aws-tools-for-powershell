...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [OutputType("Amazon.Transfer.Model.UpdateHostKeyResponse")]
    [AWSCmdlet("Calls the AWS Transfer for SFTP UpdateHostKey API operation.", Operation = new[] {"UpdateHostKey"}, SelectReturnType = typeof(Amazon.Transfer.Model.UpdateHostKeyResponse))]
    [AWSCmdletOutput("Amazon.Transfer.Model.UpdateHostKeyResponse",
        "This cmdlet returns an Amazon.Transfer.Model.UpdateHostKeyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateTFRHostKeyCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-TFRHostKey (UpdateHostKey)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.UpdateHostKeyResponse, UpdateTFRHostKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Transfer.Model.UpdateHostKeyRequest();
        ...
        private Amazon.Transfer.Model.UpdateHostKeyResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.UpdateHostKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "UpdateHostKey");
            try
            {
                #if DESKTOP
                return client.UpdateHostKey(request);
                #elif CORECLR
                return client.UpdateHostKeyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String HostKeyId { get; set; }
            public System.String ServerId { get; set; }
            public System.Func<Amazon.Transfer.Model.UpdateHostKeyResponse, UpdateTFRHostKeyCmdlet, object> Select { get; set; } =
