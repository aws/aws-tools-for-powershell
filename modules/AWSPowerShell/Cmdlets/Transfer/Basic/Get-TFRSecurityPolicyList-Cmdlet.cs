...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "TFRSecurityPolicyList")]
    ...
    public partial class GetTFRSecurityPolicyListCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SecurityPolicyNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.ListSecurityPoliciesResponse, GetTFRSecurityPolicyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Transfer.Model.ListSecurityPoliciesRequest();
        ...
        private Amazon.Transfer.Model.ListSecurityPoliciesResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.ListSecurityPoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "ListSecurityPolicies");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Transfer.Model.ListSecurityPoliciesResponse, GetTFRSecurityPolicyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SecurityPolicyNames;
        }
