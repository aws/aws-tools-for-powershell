...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "TFRAccessList")]
    [OutputType("Amazon.Transfer.Model.ListAccessesResponse")]
    [AWSCmdlet("Calls the AWS Transfer for SFTP ListAccesses API operation.", Operation = new[] {"ListAccesses"}, SelectReturnType = typeof(Amazon.Transfer.Model.ListAccessesResponse))]
    [AWSCmdletOutput("Amazon.Transfer.Model.ListAccessesResponse",
        "This cmdlet returns an Amazon.Transfer.Model.ListAccessesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTFRAccessListCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Transfer.Model.ListAccessesResponse, GetTFRAccessListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Transfer.Model.ListAccessesRequest();
        ...
        private Amazon.Transfer.Model.ListAccessesResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.ListAccessesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "ListAccesses");
            try
            {
                #if DESKTOP
                return client.ListAccesses(request);
                #elif CORECLR
                return client.ListAccessesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServerId { get; set; }
            public System.Func<Amazon.Transfer.Model.ListAccessesResponse, GetTFRAccessListCmdlet, object> Select { get; set; } =
