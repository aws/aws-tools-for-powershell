...
namespace Amazon.PowerShell.Cmdlets.CGS
{
    ...
    public partial class GetCGSAccountConfigurationCmdlet : AmazonCodeGuruSecurityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeGuruSecurity.Model.GetAccountConfigurationResponse, GetCGSAccountConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeGuruSecurity.Model.GetAccountConfigurationRequest();
        ...
        private Amazon.CodeGuruSecurity.Model.GetAccountConfigurationResponse CallAWSServiceOperation(IAmazonCodeGuruSecurity client, Amazon.CodeGuruSecurity.Model.GetAccountConfigurationRequest request)
        {
        ...
        {
            public System.Func<Amazon.CodeGuruSecurity.Model.GetAccountConfigurationResponse, GetCGSAccountConfigurationCmdlet, object> Select { get; set; } =
