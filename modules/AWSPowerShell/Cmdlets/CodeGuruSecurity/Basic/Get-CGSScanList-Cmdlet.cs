...
{
    /// <summary>
    /// Returns a list of all scans in an account. Does not return <c>EXPRESS</c> scans.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCGSScanListCmdlet : AmazonCodeGuruSecurityClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeGuruSecurity.Model.ListScansResponse CallAWSServiceOperation(IAmazonCodeGuruSecurity client, Amazon.CodeGuruSecurity.Model.ListScansRequest request)
        {
            ...
            try
            {
                return client.ListScansAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
