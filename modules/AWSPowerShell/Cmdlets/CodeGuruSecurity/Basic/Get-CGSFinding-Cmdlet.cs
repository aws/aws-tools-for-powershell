...
{
    /// <summary>
    /// Returns a list of all findings generated by a particular scan.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CodeGuruSecurity.Model.Finding or Amazon.CodeGuruSecurity.Model.GetFindingsResponse",
        ...
        "The service call response (type Amazon.CodeGuruSecurity.Model.GetFindingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGSFindingCmdlet : AmazonCodeGuruSecurityClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeGuruSecurity.Model.GetFindingsResponse CallAWSServiceOperation(IAmazonCodeGuruSecurity client, Amazon.CodeGuruSecurity.Model.GetFindingsRequest request)
        {
            ...
            try
            {
                return client.GetFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
