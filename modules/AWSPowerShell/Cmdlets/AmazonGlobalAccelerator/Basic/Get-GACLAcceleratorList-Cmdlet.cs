...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdlet("Calls the AWS Global Accelerator ListAccelerators API operation.", Operation = new[] {"ListAccelerators"})]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.Accelerator",
        "This cmdlet returns a collection of Accelerator objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Accelerators;
