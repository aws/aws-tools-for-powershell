...
namespace Amazon.PowerShell.Cmdlets.GACL
{
    ...
    [AWSCmdlet("Calls the AWS Global Accelerator ListEndpointGroups API operation.", Operation = new[] {"ListEndpointGroups"})]
    [AWSCmdletOutput("Amazon.GlobalAccelerator.Model.EndpointGroup",
        "This cmdlet returns a collection of EndpointGroup objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.EndpointGroups;
