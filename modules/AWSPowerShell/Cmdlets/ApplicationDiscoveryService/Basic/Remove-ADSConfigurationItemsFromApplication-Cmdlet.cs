...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    public partial class RemoveADSConfigurationItemsFromApplicationCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Configuration ID of each item to be disassociated from an application.</para><para />
        ...
        private Amazon.ApplicationDiscoveryService.Model.DisassociateConfigurationItemsFromApplicationResponse CallAWSServiceOperation(IAmazonApplicationDiscoveryService client, Amazon.ApplicationDiscoveryService.Model.DisassociateConfigurationItemsFromApplicationRequest request)
        {
            ...
            try
            {
                return client.DisassociateConfigurationItemsFromApplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
