...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADSImportTask")]
    [OutputType("Amazon.ApplicationDiscoveryService.Model.ImportTask")]
    [AWSCmdlet("Calls the AWS Application Discovery Service DescribeImportTasks API operation.", Operation = new[] {"DescribeImportTasks"}, SelectReturnType = typeof(Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse))]
    [AWSCmdletOutput("Amazon.ApplicationDiscoveryService.Model.ImportTask or Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse",
        "This cmdlet returns a collection of Amazon.ApplicationDiscoveryService.Model.ImportTask objects.",
        "The service call response (type Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADSImportTaskCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        [Alias("Filters")]
        public Amazon.ApplicationDiscoveryService.Model.ImportTaskFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse, GetADSImportTaskCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.ApplicationDiscoveryService.Model.ImportTaskFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksRequest();
        ...
        private Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse CallAWSServiceOperation(IAmazonApplicationDiscoveryService client, Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Application Discovery Service", "DescribeImportTasks");
            try
            {
                #if DESKTOP
        ...
        {
            public List<Amazon.ApplicationDiscoveryService.Model.ImportTaskFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApplicationDiscoveryService.Model.DescribeImportTasksResponse, GetADSImportTaskCmdlet, object> Select { get; set; } =
