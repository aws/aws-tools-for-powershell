...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    [AWSCmdlet("Calls the AWS Application Discovery Service DescribeTags API operation.", Operation = new[] {"DescribeTags"}, SelectReturnType = typeof(Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse))]
    [AWSCmdletOutput("Amazon.ApplicationDiscoveryService.Model.ConfigurationTag or Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse",
        "This cmdlet returns a collection of Amazon.ApplicationDiscoveryService.Model.ConfigurationTag objects.",
        "The service call response (type Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADSTagCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse, GetADSTagCmdlet>(Select) ??
        ...
        private Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse CallAWSServiceOperation(IAmazonApplicationDiscoveryService client, Amazon.ApplicationDiscoveryService.Model.DescribeTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Application Discovery Service", "DescribeTags");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApplicationDiscoveryService.Model.DescribeTagsResponse, GetADSTagCmdlet, object> Select { get; set; } =
