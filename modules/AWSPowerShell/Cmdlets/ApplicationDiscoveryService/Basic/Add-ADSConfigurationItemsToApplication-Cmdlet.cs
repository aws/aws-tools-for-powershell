...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    public partial class AddADSConfigurationItemsToApplicationCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ApplicationConfigurationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ApplicationConfigurationId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ADSConfigurationItemsToApplication (AssociateConfigurationItemsToApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationDiscoveryService.Model.AssociateConfigurationItemsToApplicationResponse, AddADSConfigurationItemsToApplicationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ApplicationConfigurationId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationDiscoveryService.Model.AssociateConfigurationItemsToApplicationRequest();
        ...
        private Amazon.ApplicationDiscoveryService.Model.AssociateConfigurationItemsToApplicationResponse CallAWSServiceOperation(IAmazonApplicationDiscoveryService client, Amazon.ApplicationDiscoveryService.Model.AssociateConfigurationItemsToApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Application Discovery Service", "AssociateConfigurationItemsToApplication");
            try
            {
                #if DESKTOP
                return client.AssociateConfigurationItemsToApplication(request);
                #elif CORECLR
                return client.AssociateConfigurationItemsToApplicationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ApplicationDiscoveryService.Model.AssociateConfigurationItemsToApplicationResponse, AddADSConfigurationItemsToApplicationCmdlet, object> Select { get; set; } =
