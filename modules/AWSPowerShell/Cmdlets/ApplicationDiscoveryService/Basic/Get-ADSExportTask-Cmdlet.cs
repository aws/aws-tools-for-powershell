...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    [AWSCmdletOutput("Amazon.ApplicationDiscoveryService.Model.ExportInfo or Amazon.ApplicationDiscoveryService.Model.DescribeExportTasksResponse",
        ...
        "The service call response (type Amazon.ApplicationDiscoveryService.Model.DescribeExportTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADSExportTaskCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more unique identifiers used to query the status of an export request.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters.</para><ul><li><para><c>AgentId</c> - ID of the agent whose collected data will be exported</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
