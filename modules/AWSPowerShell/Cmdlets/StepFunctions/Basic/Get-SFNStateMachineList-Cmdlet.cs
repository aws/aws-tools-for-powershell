...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    [AWSCmdlet("Calls the AWS Step Functions ListStateMachines API operation.", Operation = new[] {"ListStateMachines"}, SelectReturnType = typeof(Amazon.StepFunctions.Model.ListStateMachinesResponse))]
    [AWSCmdletOutput("Amazon.StepFunctions.Model.StateMachineListItem or Amazon.StepFunctions.Model.ListStateMachinesResponse",
        "This cmdlet returns a collection of Amazon.StepFunctions.Model.StateMachineListItem objects.",
        "The service call response (type Amazon.StepFunctions.Model.ListStateMachinesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSFNStateMachineListCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StateMachines";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StepFunctions.Model.ListStateMachinesResponse, GetSFNStateMachineListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.StateMachines?.Count ?? 0;
        ...
        private Amazon.StepFunctions.Model.ListStateMachinesResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.ListStateMachinesRequest request)
        {
            ...
            try
            {
                return client.ListStateMachinesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.StepFunctions.Model.ListStateMachinesResponse, GetSFNStateMachineListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StateMachines;
        }
