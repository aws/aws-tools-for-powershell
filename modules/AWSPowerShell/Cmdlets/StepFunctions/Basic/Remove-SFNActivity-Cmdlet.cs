...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    public partial class RemoveSFNActivityCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ActivityArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ActivityArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SFNActivity (DeleteActivity)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StepFunctions.Model.DeleteActivityResponse, RemoveSFNActivityCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ActivityArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StepFunctions.Model.DeleteActivityRequest();
        ...
        private Amazon.StepFunctions.Model.DeleteActivityResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.DeleteActivityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Step Functions", "DeleteActivity");
            try
            {
                #if DESKTOP
                return client.DeleteActivity(request);
                #elif CORECLR
                return client.DeleteActivityAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ActivityArn { get; set; }
            public System.Func<Amazon.StepFunctions.Model.DeleteActivityResponse, RemoveSFNActivityCmdlet, object> Select { get; set; } =
