...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    /// </summary>
    [Cmdlet("Get", "SFNStateMachineVersionList")]
    [OutputType("Amazon.StepFunctions.Model.StateMachineVersionListItem")]
    [AWSCmdlet("Calls the AWS Step Functions ListStateMachineVersions API operation.", Operation = new[] {"ListStateMachineVersions"}, SelectReturnType = typeof(Amazon.StepFunctions.Model.ListStateMachineVersionsResponse))]
    [AWSCmdletOutput("Amazon.StepFunctions.Model.StateMachineVersionListItem or Amazon.StepFunctions.Model.ListStateMachineVersionsResponse",
        "This cmdlet returns a collection of Amazon.StepFunctions.Model.StateMachineVersionListItem objects.",
        "The service call response (type Amazon.StepFunctions.Model.ListStateMachineVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSFNStateMachineVersionListCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StateMachineVersions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StepFunctions.Model.ListStateMachineVersionsResponse, GetSFNStateMachineVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.StepFunctions.Model.ListStateMachineVersionsRequest();
        ...
        private Amazon.StepFunctions.Model.ListStateMachineVersionsResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.ListStateMachineVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Step Functions", "ListStateMachineVersions");
            try
            {
                #if DESKTOP
                return client.ListStateMachineVersions(request);
                #elif CORECLR
                return client.ListStateMachineVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StateMachineArn { get; set; }
            public System.Func<Amazon.StepFunctions.Model.ListStateMachineVersionsResponse, GetSFNStateMachineVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StateMachineVersions;
        }
