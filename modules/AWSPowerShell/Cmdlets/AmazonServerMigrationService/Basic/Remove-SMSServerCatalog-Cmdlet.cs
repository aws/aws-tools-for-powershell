...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    public partial class RemoveSMSServerCatalogCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMSServerCatalog (DeleteServerCatalog)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServerMigrationService.Model.DeleteServerCatalogRequest();
        ...
        private Amazon.ServerMigrationService.Model.DeleteServerCatalogResponse CallAWSServiceOperation(IAmazonServerMigrationService client, Amazon.ServerMigrationService.Model.DeleteServerCatalogRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteServerCatalogAsync(request).GetAwaiter().GetResult();
                #else
