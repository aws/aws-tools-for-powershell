...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the Amazon Server Migration Service GenerateTemplate API operation.", Operation = new[] {"GenerateTemplate"})]
    ...
    public partial class NewSMSTemplateCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Server Migration Service", "GenerateTemplate");
            try
            {
                #if DESKTOP
                ...
                var task = client.GenerateTemplateAsync(request);
                return task.Result;
                #else
