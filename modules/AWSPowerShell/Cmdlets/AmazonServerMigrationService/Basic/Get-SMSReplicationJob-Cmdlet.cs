...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Invokes the GetReplicationJobs operation against Amazon Server Migration Service.", Operation = new[] {"GetReplicationJobs"})]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.ReplicationJob",
        "This cmdlet returns a collection of ReplicationJob objects.",
    ...
    public partial class GetSMSReplicationJobCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ReplicationJobList;
        ...
        private Amazon.ServerMigrationService.Model.GetReplicationJobsResponse CallAWSServiceOperation(IAmazonServerMigrationService client, Amazon.ServerMigrationService.Model.GetReplicationJobsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetReplicationJobsAsync(request);
                return task.Result;
                #else
