...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the Amazon Server Migration Service CreateApp API operation.", Operation = new[] {"CreateApp"})]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.CreateAppResponse",
        "This cmdlet returns a Amazon.ServerMigrationService.Model.CreateAppResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSMSAppCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Server Migration Service", "CreateApp");
            try
            {
                #if DESKTOP
