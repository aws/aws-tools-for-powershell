...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the Amazon Server Migration Service GetAppLaunchConfiguration API operation.", Operation = new[] {"GetAppLaunchConfiguration"})]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.GetAppLaunchConfigurationResponse",
        "This cmdlet returns a Amazon.ServerMigrationService.Model.GetAppLaunchConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMSAppLaunchConfigurationCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Server Migration Service", "GetAppLaunchConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetAppLaunchConfigurationAsync(request);
                return task.Result;
                #else
