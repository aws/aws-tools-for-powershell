...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the Amazon Server Migration Service PutAppLaunchConfiguration API operation.", Operation = new[] {"PutAppLaunchConfiguration"})]
    ...
    public partial class WriteSMSAppLaunchConfigurationCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ServerGroupLaunchConfigurations = new List<Amazon.ServerMigrationService.Model.ServerGroupLaunchConfiguration>(this.ServerGroupLaunchConfiguration);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ServerGroupLaunchConfigurations != null)
            {
                request.ServerGroupLaunchConfigurations = cmdletContext.ServerGroupLaunchConfigurations;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Server Migration Service", "PutAppLaunchConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.PutAppLaunchConfigurationAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppId { get; set; }
            public System.String RoleName { get; set; }
            public List<Amazon.ServerMigrationService.Model.ServerGroupLaunchConfiguration> ServerGroupLaunchConfigurations { get; set; }
        }
