...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the Amazon Server Migration Service PutAppReplicationConfiguration API operation.", Operation = new[] {"PutAppReplicationConfiguration"})]
    ...
    public partial class WriteSMSAppReplicationConfigurationCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ServerGroupReplicationConfigurations = new List<Amazon.ServerMigrationService.Model.ServerGroupReplicationConfiguration>(this.ServerGroupReplicationConfiguration);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ServerGroupReplicationConfigurations != null)
            {
                request.ServerGroupReplicationConfigurations = cmdletContext.ServerGroupReplicationConfigurations;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Server Migration Service", "PutAppReplicationConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.PutAppReplicationConfigurationAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.String AppId { get; set; }
            public List<Amazon.ServerMigrationService.Model.ServerGroupReplicationConfiguration> ServerGroupReplicationConfigurations { get; set; }
        }
