...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    [AWSCmdletOutput("Amazon.Textract.Model.AdapterOverview or Amazon.Textract.Model.ListAdaptersResponse",
        ...
        "The service call response (type Amazon.Textract.Model.ListAdaptersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
