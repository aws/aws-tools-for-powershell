...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    public partial class GetTXTAdapterCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Textract.Model.GetAdapterResponse, GetTXTAdapterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Textract.Model.GetAdapterRequest();
        ...
        private Amazon.Textract.Model.GetAdapterResponse CallAWSServiceOperation(IAmazonTextract client, Amazon.Textract.Model.GetAdapterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Textract", "GetAdapter");
            try
            {
                #if DESKTOP
                return client.GetAdapter(request);
                #elif CORECLR
                return client.GetAdapterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AdapterId { get; set; }
            public System.Func<Amazon.Textract.Model.GetAdapterResponse, GetTXTAdapterCmdlet, object> Select { get; set; } =
