...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    [OutputType("Amazon.Textract.Model.GetLendingAnalysisResponse")]
    [AWSCmdlet("Calls the Amazon Textract GetLendingAnalysis API operation.", Operation = new[] {"GetLendingAnalysis"}, SelectReturnType = typeof(Amazon.Textract.Model.GetLendingAnalysisResponse))]
    [AWSCmdletOutput("Amazon.Textract.Model.GetLendingAnalysisResponse",
        "This cmdlet returns an Amazon.Textract.Model.GetLendingAnalysisResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTXTLendingAnalysisCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Textract.Model.GetLendingAnalysisResponse, GetTXTLendingAnalysisCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Textract.Model.GetLendingAnalysisRequest();
        ...
        private Amazon.Textract.Model.GetLendingAnalysisResponse CallAWSServiceOperation(IAmazonTextract client, Amazon.Textract.Model.GetLendingAnalysisRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Textract", "GetLendingAnalysis");
            try
            {
                #if DESKTOP
                return client.GetLendingAnalysis(request);
                #elif CORECLR
                return client.GetLendingAnalysisAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Textract.Model.GetLendingAnalysisResponse, GetTXTLendingAnalysisCmdlet, object> Select { get; set; } =
