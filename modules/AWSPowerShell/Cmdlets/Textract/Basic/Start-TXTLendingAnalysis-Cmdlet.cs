...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    /// 
    ///  
    /// <para><code>StartLendingAnalysis</code> can analyze text in documents that are in one of
    ...
    /// </para><para><code>StartLendingAnalysis</code> returns a job identifier (<code>JobId</code>) that
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Start", "TXTLendingAnalysis", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartTXTLendingAnalysisCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-TXTLendingAnalysis (StartLendingAnalysis)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Textract.Model.StartLendingAnalysisResponse, StartTXTLendingAnalysisCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Textract.Model.StartLendingAnalysisRequest();
        ...
        private Amazon.Textract.Model.StartLendingAnalysisResponse CallAWSServiceOperation(IAmazonTextract client, Amazon.Textract.Model.StartLendingAnalysisRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Textract", "StartLendingAnalysis");
            try
            {
                #if DESKTOP
                return client.StartLendingAnalysis(request);
                #elif CORECLR
                return client.StartLendingAnalysisAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OutputConfig_S3Bucket { get; set; }
            public System.String OutputConfig_S3Prefix { get; set; }
            public System.Func<Amazon.Textract.Model.StartLendingAnalysisResponse, StartTXTLendingAnalysisCmdlet, object> Select { get; set; } =
