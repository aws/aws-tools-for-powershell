...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    /// 
    ///  
    /// <para><code>StartExpenseAnalysis</code> can analyze text in documents that are in JPEG,
    ...
    /// </para><para><code>StartExpenseAnalysis</code> returns a job identifier (<code>JobId</code>) that
    ...
    public partial class StartTXTExpenseAnalysisCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Textract.Model.StartExpenseAnalysisResponse, StartTXTExpenseAnalysisCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OutputConfig_S3Bucket { get; set; }
            public System.String OutputConfig_S3Prefix { get; set; }
            public System.Func<Amazon.Textract.Model.StartExpenseAnalysisResponse, StartTXTExpenseAnalysisCmdlet, object> Select { get; set; } =
