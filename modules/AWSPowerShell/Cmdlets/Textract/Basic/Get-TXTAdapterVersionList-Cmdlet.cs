...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    /// </summary>
    [Cmdlet("Get", "TXTAdapterVersionList")]
    [OutputType("Amazon.Textract.Model.AdapterVersionOverview")]
    ...
    public partial class GetTXTAdapterVersionListCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AdapterVersions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Textract.Model.ListAdapterVersionsResponse, GetTXTAdapterVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Textract.Model.ListAdapterVersionsRequest();
        ...
        private Amazon.Textract.Model.ListAdapterVersionsResponse CallAWSServiceOperation(IAmazonTextract client, Amazon.Textract.Model.ListAdapterVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Textract", "ListAdapterVersions");
            try
            {
                #if DESKTOP
                return client.ListAdapterVersions(request);
                #elif CORECLR
                return client.ListAdapterVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Textract.Model.ListAdapterVersionsResponse, GetTXTAdapterVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AdapterVersions;
        }
