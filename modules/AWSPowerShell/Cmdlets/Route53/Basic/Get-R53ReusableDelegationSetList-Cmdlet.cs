...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [AWSCmdletOutput("Amazon.Route53.Model.DelegationSet or Amazon.Route53.Model.ListReusableDelegationSetsResponse",
        ...
        "The service call response (type Amazon.Route53.Model.ListReusableDelegationSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53ReusableDelegationSetListCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        /// will return if you submit another request.</para><para>If the value of <c>IsTruncated</c> in the previous response was <c>false</c>, there
        /// are no more reusable delegation sets to get.</para>
        /// </para>
        /// <para>
        ...
        private Amazon.Route53.Model.ListReusableDelegationSetsResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.ListReusableDelegationSetsRequest request)
        {
            ...
            try
            {
                return client.ListReusableDelegationSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
