...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 UpdateHostedZoneComment API operation.", Operation = new[] {"UpdateHostedZoneComment"}, SelectReturnType = typeof(Amazon.Route53.Model.UpdateHostedZoneCommentResponse))]
    [AWSCmdletOutput("Amazon.Route53.Model.HostedZone or Amazon.Route53.Model.UpdateHostedZoneCommentResponse",
        "This cmdlet returns an Amazon.Route53.Model.HostedZone object.",
        "The service call response (type Amazon.Route53.Model.UpdateHostedZoneCommentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateR53HostedZoneCommentCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HostedZone";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.UpdateHostedZoneCommentResponse, UpdateR53HostedZoneCommentCmdlet>(Select) ??
        ...
        private Amazon.Route53.Model.UpdateHostedZoneCommentResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.UpdateHostedZoneCommentRequest request)
        {
            ...
            try
            {
                return client.UpdateHostedZoneCommentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String Comment { get; set; }
            public System.Func<Amazon.Route53.Model.UpdateHostedZoneCommentResponse, UpdateR53HostedZoneCommentCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HostedZone;
        }
