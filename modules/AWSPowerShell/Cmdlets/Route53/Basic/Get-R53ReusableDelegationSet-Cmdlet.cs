...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53ReusableDelegationSetCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "DelegationSet";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.GetReusableDelegationSetResponse, GetR53ReusableDelegationSetCmdlet>(Select) ??
        ...
        private Amazon.Route53.Model.GetReusableDelegationSetResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetReusableDelegationSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53", "GetReusableDelegationSet");
            try
            {
                return client.GetReusableDelegationSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Route53.Model.GetReusableDelegationSetResponse, GetR53ReusableDelegationSetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DelegationSet;
        }
