...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    /// does not include CIDR blocks).<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetR53CidrLocationListCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        private Amazon.Route53.Model.ListCidrLocationsResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.ListCidrLocationsRequest request)
        {
            ...
            try
            {
                return client.ListCidrLocationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
