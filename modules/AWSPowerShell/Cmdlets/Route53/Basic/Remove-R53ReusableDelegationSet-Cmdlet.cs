...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class RemoveR53ReusableDelegationSetCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.DeleteReusableDelegationSetResponse, RemoveR53ReusableDelegationSetCmdlet>(Select) ??
        ...
        private Amazon.Route53.Model.DeleteReusableDelegationSetResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.DeleteReusableDelegationSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53", "DeleteReusableDelegationSet");
            try
            {
                return client.DeleteReusableDelegationSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Route53.Model.DeleteReusableDelegationSetResponse, RemoveR53ReusableDelegationSetCmdlet, object> Select { get; set; } =
