...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53HealthCheckCountCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.GetHealthCheckCountResponse, GetR53HealthCheckCountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53.Model.GetHealthCheckCountRequest();
        ...
        private Amazon.Route53.Model.GetHealthCheckCountResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetHealthCheckCountRequest request)
        {
        ...
        {
            public System.Func<Amazon.Route53.Model.GetHealthCheckCountResponse, GetR53HealthCheckCountCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HealthCheckCount;
        }
