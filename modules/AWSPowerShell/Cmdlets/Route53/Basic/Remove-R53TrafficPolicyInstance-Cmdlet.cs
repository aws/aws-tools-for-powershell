...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class RemoveR53TrafficPolicyInstanceCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.DeleteTrafficPolicyInstanceResponse, RemoveR53TrafficPolicyInstanceCmdlet>(Select) ??
        ...
        private Amazon.Route53.Model.DeleteTrafficPolicyInstanceResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.DeleteTrafficPolicyInstanceRequest request)
        {
            ...
            try
            {
                return client.DeleteTrafficPolicyInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.Route53.Model.DeleteTrafficPolicyInstanceResponse, RemoveR53TrafficPolicyInstanceCmdlet, object> Select { get; set; } =
