...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class EditR53TagsForResourceCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        /// health check or hosted zone and/or the tags that you want to edit <c>Value</c> for.</para><para>You can add a maximum of 10 tags to a health check or a hosted zone.</para><para />
        ...
        /// health check or hosted zone. You can specify up to 10 keys.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.ChangeTagsForResourceResponse, EditR53TagsForResourceCmdlet>(Select) ??
            ...
            if (this.AddTag != null)
            {
                context.AddTag = new List<Amazon.Route53.Model.Tag>(this.AddTag);
            }
            if (this.RemoveTagKey != null)
            {
                context.RemoveTagKey = new List<System.String>(this.RemoveTagKey);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.RemoveTagKey != null)
            {
                request.RemoveTagKeys = cmdletContext.RemoveTagKey;
            }
        ...
        private Amazon.Route53.Model.ChangeTagsForResourceResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.ChangeTagsForResourceRequest request)
        {
            ...
            try
            {
                return client.ChangeTagsForResourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.Route53.TagResourceType ResourceType { get; set; }
            public System.String ResourceId { get; set; }
            public List<Amazon.Route53.Model.Tag> AddTag { get; set; }
            public List<System.String> RemoveTagKey { get; set; }
            public System.Func<Amazon.Route53.Model.ChangeTagsForResourceResponse, EditR53TagsForResourceCmdlet, object> Select { get; set; } =
