...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53HealthCheckStatusCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        /// <c>HealthCheckId</c> element.</para><note><para>If you want to check the status of a calculated health check, you must use the Amazon
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53.Model.GetHealthCheckStatusResponse, GetR53HealthCheckStatusCmdlet>(Select) ??
        ...
        private Amazon.Route53.Model.GetHealthCheckStatusResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetHealthCheckStatusRequest request)
        {
            ...
            try
            {
                return client.GetHealthCheckStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String HealthCheckId { get; set; }
            public System.Func<Amazon.Route53.Model.GetHealthCheckStatusResponse, GetR53HealthCheckStatusCmdlet, object> Select { get; set; } =
