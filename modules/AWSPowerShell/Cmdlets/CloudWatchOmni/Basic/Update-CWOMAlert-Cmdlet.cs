...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the CloudWatch Omni UpdateAlert API operation.", Operation = new[] {"UpdateAlert"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.UpdateAlertResponse))]
    [AWSCmdletOutput("None or Amazon.CloudWatchOmni.Model.UpdateAlertResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudWatchOmni.Model.UpdateAlertResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCWOMAlertCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.UpdateAlertResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.AlertId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWOMAlert (UpdateAlert)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.UpdateAlertResponse, UpdateCWOMAlertCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.UpdateAlertRequest();
        ...
        private Amazon.CloudWatchOmni.Model.UpdateAlertResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.UpdateAlertRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "UpdateAlert");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CloudWatchOmni.QueryLanguage Rule_TelemetryRule_Query_Language { get; set; }
            public System.String SpaceId { get; set; }
            public System.Func<Amazon.CloudWatchOmni.Model.UpdateAlertResponse, UpdateCWOMAlertCmdlet, object> Select { get; set; } =
