...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    [AWSCmdlet("Calls the CloudWatch Omni SearchPrincipals API operation.", Operation = new[] {"SearchPrincipals"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.PrincipalSearchResult or Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse",
        "This cmdlet returns a collection of Amazon.CloudWatchOmni.Model.PrincipalSearchResult objects.",
        "The service call response (type Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SearchCWOMPrincipalCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CWOMPrincipal (SearchPrincipals)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse, SearchCWOMPrincipalCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudWatchOmni.Model.SearchPrincipalsRequest();
        ...
        private Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.SearchPrincipalsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "SearchPrincipals");
            try
            {
                return client.SearchPrincipalsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SearchQuery { get; set; }
            public System.Func<Amazon.CloudWatchOmni.Model.SearchPrincipalsResponse, SearchCWOMPrincipalCmdlet, object> Select { get; set; } =
