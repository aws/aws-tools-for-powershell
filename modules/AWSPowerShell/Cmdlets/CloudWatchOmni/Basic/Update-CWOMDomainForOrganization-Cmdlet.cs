...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    [AWSCmdlet("Calls the CloudWatch Omni UpdateDomainForOrganization API operation.", Operation = new[] {"UpdateDomainForOrganization"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.OrganizationDomain or Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse",
        "This cmdlet returns an Amazon.CloudWatchOmni.Model.OrganizationDomain object.",
        "The service call response (type Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCWOMDomainForOrganizationCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWOMDomainForOrganization (UpdateDomainForOrganization)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse, UpdateCWOMDomainForOrganizationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationRequest();
        ...
        private Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "UpdateDomainForOrganization");
            try
            {
                return client.UpdateDomainForOrganizationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudWatchOmni.Model.UpdateDomainForOrganizationResponse, UpdateCWOMDomainForOrganizationCmdlet, object> Select { get; set; } =
