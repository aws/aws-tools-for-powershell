...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    /// </summary>
    [Cmdlet("New", "CWOMDomainForOrganization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudWatchOmni.Model.OrganizationDomain")]
    [AWSCmdlet("Calls the CloudWatch Omni CreateDomainForOrganization API operation.", Operation = new[] {"CreateDomainForOrganization"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.OrganizationDomain or Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse",
        "This cmdlet returns an Amazon.CloudWatchOmni.Model.OrganizationDomain object.",
        "The service call response (type Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCWOMDomainForOrganizationCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        private readonly CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();
        
        #region Parameter DomainAccessRoleArn
        /// <summary>
        /// <para>
        /// <para>The ARN of an IAM role in the management account used for domain access. You must
        ...
        public System.String DomainAccessRoleArn { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>A name that identifies the organization domain. Must be 3-63 characters: lowercase
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'OrganizationDomain'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OrganizationDomain";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                nameof(this.Name),
                nameof(this.DomainAccessRoleArn)
            };
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(targetParameterNames, MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CWOMDomainForOrganization (CreateDomainForOrganization)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse, NewCWOMDomainForOrganizationCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.ClientToken = this.ClientToken;
            context.DomainAccessRoleArn = this.DomainAccessRoleArn;
            #if MODULAR
            if (this.DomainAccessRoleArn == null && ParameterWasBound(nameof(this.DomainAccessRoleArn)))
            {
                WriteWarning("You are passing $null as a value for parameter DomainAccessRoleArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationRequest();
            
            if (cmdletContext.ClientToken != null)
            {
                request.ClientToken = cmdletContext.ClientToken;
            }
            if (cmdletContext.DomainAccessRoleArn != null)
            {
                request.DomainAccessRoleArn = cmdletContext.DomainAccessRoleArn;
            }
        ...
        private Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "CreateDomainForOrganization");
            try
            {
                return client.CreateDomainForOrganizationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudWatchOmni.Model.CreateDomainForOrganizationResponse, NewCWOMDomainForOrganizationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OrganizationDomain;
        }
