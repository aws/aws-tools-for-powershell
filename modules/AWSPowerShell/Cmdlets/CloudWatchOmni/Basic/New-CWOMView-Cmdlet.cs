...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    [AWSCmdlet("Calls the CloudWatch Omni CreateView API operation.", Operation = new[] {"CreateView"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.CreateViewResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.CreateViewResponse",
        "This cmdlet returns an Amazon.CloudWatchOmni.Model.CreateViewResponse object containing multiple properties."
    )]
    public partial class NewCWOMViewCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.CreateViewResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.CreateViewResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CWOMView (CreateView)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.CreateViewResponse, NewCWOMViewCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.CreateViewRequest();
        ...
        private Amazon.CloudWatchOmni.Model.CreateViewResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.CreateViewRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "CreateView");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudWatchOmni.Model.CreateViewResponse, NewCWOMViewCmdlet, object> Select { get; set; } =
