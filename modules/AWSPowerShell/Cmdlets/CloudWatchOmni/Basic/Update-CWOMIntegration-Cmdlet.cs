...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    /// </summary>
    [Cmdlet("Update", "CWOMIntegration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudWatchOmni.Model.Integration")]
    [AWSCmdlet("Calls the CloudWatch Omni UpdateIntegration API operation.", Operation = new[] {"UpdateIntegration"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.Integration or Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse",
        "This cmdlet returns an Amazon.CloudWatchOmni.Model.Integration object.",
        "The service call response (type Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCWOMIntegrationCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWOMIntegration (UpdateIntegration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse, UpdateCWOMIntegrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.UpdateIntegrationRequest();
        ...
        private Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.UpdateIntegrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "UpdateIntegration");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.CloudWatchOmni.Model.UpdateIntegrationResponse, UpdateCWOMIntegrationCmdlet, object> Select { get; set; } =
