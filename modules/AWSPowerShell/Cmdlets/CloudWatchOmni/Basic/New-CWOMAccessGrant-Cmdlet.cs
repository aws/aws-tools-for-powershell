...
namespace Amazon.PowerShell.Cmdlets.CWOM
{
    ...
    [AWSCmdlet("Calls the CloudWatch Omni CreateAccessGrant API operation.", Operation = new[] {"CreateAccessGrant"}, SelectReturnType = typeof(Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchOmni.Model.AccessGrant or Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse",
        "This cmdlet returns an Amazon.CloudWatchOmni.Model.AccessGrant object.",
        "The service call response (type Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewCWOMAccessGrantCmdlet : AmazonCloudWatchOmniClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.CloudWatchOmni.AccessGrantPermission")]
        public Amazon.CloudWatchOmni.AccessGrantPermission Permission { get; set; }
        #endregion
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.CloudWatchOmni.AccessGrantPrincipalType")]
        public Amazon.CloudWatchOmni.AccessGrantPrincipalType Principal_PrincipalType { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ScopedActions")]
        public Amazon.CloudWatchOmni.Model.ScopedActions[] ScopedAction { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CWOMAccessGrant (CreateAccessGrant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse, NewCWOMAccessGrantCmdlet>(Select) ??
            ...
            #endif
            if (this.ScopedAction != null)
            {
                context.ScopedAction = new List<Amazon.CloudWatchOmni.Model.ScopedActions>(this.ScopedAction);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchOmni.Model.CreateAccessGrantRequest();
            ...
            request.Principal = new Amazon.CloudWatchOmni.Model.AccessGrantPrincipal();
            ...
            Amazon.CloudWatchOmni.AccessGrantPrincipalType requestPrincipal_principal_PrincipalType = null;
            ...
            if (cmdletContext.ScopedAction != null)
            {
                request.ScopedActions = cmdletContext.ScopedAction;
            }
        ...
        private Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse CallAWSServiceOperation(IAmazonCloudWatchOmni client, Amazon.CloudWatchOmni.Model.CreateAccessGrantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Omni", "CreateAccessGrant");
            try
            {
                return client.CreateAccessGrantAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Principal_PrincipalId { get; set; }
            public Amazon.CloudWatchOmni.AccessGrantPrincipalType Principal_PrincipalType { get; set; }
            public List<Amazon.CloudWatchOmni.Model.ScopedActions> ScopedAction { get; set; }
            public System.String SpaceId { get; set; }
            public Dictionary<System.String, System.String> Tag { get; set; }
            public System.Func<Amazon.CloudWatchOmni.Model.CreateAccessGrantResponse, NewCWOMAccessGrantCmdlet, object> Select { get; set; } =
