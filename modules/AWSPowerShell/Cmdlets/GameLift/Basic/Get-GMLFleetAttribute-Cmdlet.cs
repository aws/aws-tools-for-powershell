...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class GetGMLFleetAttributeCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLift.Model.DescribeFleetAttributesResponse, GetGMLFleetAttributeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FleetAttributes?.Count ?? 0;
        ...
        private Amazon.GameLift.Model.DescribeFleetAttributesResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.DescribeFleetAttributesRequest request)
        {
            ...
            try
            {
                return client.DescribeFleetAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GameLift.Model.DescribeFleetAttributesResponse, GetGMLFleetAttributeCmdlet, object> Select { get; set; } =
