...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class NewGMLContainerFleetCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// can have only one metric group, but you can change this value at any time. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MetricGroups")]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the FleetRoleArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^FleetRoleArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^FleetRoleArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.FleetRoleArn;
            }
        ...
        private Amazon.GameLift.Model.CreateContainerFleetResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.CreateContainerFleetRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateContainerFleet(request);
                #elif CORECLR
                return client.CreateContainerFleetAsync(request).GetAwaiter().GetResult();
                #else
