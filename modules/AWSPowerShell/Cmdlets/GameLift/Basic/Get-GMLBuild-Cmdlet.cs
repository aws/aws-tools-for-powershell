...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    [AWSCmdlet("Calls the Amazon GameLift Service ListBuilds API operation.", Operation = new[] {"ListBuilds"}, SelectReturnType = typeof(Amazon.GameLift.Model.ListBuildsResponse))]
    [AWSCmdletOutput("Amazon.GameLift.Model.Build or Amazon.GameLift.Model.ListBuildsResponse",
        "This cmdlet returns a collection of Amazon.GameLift.Model.Build objects.",
        "The service call response (type Amazon.GameLift.Model.ListBuildsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGMLBuildCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Builds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLift.Model.ListBuildsResponse, GetGMLBuildCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Builds?.Count ?? 0;
        ...
        private Amazon.GameLift.Model.ListBuildsResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.ListBuildsRequest request)
        {
            ...
            try
            {
                return client.ListBuildsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.GameLift.BuildStatus Status { get; set; }
            public System.Func<Amazon.GameLift.Model.ListBuildsResponse, GetGMLBuildCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Builds;
        }
