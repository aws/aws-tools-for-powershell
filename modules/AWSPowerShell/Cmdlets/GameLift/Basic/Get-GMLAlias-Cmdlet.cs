...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    [AWSCmdlet("Calls the Amazon GameLift Service ListAliases API operation.", Operation = new[] {"ListAliases"}, SelectReturnType = typeof(Amazon.GameLift.Model.ListAliasesResponse))]
    [AWSCmdletOutput("Amazon.GameLift.Model.Alias or Amazon.GameLift.Model.ListAliasesResponse",
        "This cmdlet returns a collection of Amazon.GameLift.Model.Alias objects.",
        "The service call response (type Amazon.GameLift.Model.ListAliasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGMLAliasCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLift.Model.ListAliasesResponse, GetGMLAliasCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.GameLift.RoutingStrategyType RoutingStrategyType { get; set; }
            public System.Func<Amazon.GameLift.Model.ListAliasesResponse, GetGMLAliasCmdlet, object> Select { get; set; } =
