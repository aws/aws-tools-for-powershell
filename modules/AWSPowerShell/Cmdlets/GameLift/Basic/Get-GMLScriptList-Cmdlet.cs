...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class GetGMLScriptListCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Scripts";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLift.Model.ListScriptsResponse, GetGMLScriptListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GameLift.Model.ListScriptsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Scripts?.Count ?? 0;
        ...
        private Amazon.GameLift.Model.ListScriptsResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.ListScriptsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameLift Service", "ListScripts");
            try
            {
                return client.ListScriptsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GameLift.Model.ListScriptsResponse, GetGMLScriptListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Scripts;
        }
