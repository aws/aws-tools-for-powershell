...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class UpdateGMLGameSessionCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// the value of a game property</a>. </para><note><ul><li><para>Avoid using periods (".") in property keys if you plan to search for game sessions
        ...
        /// <summary>
        /// <para>
        /// <para>An identifier for the game session that is unique across all regions to update. The
        ...
        private Amazon.GameLift.Model.UpdateGameSessionResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.UpdateGameSessionRequest request)
        {
            ...
            try
            {
                return client.UpdateGameSessionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
