...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    /// exist in the Region.
    /// </para><para><b>Learn more</b></para><para><a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/queues-console.html">
    ...
    [AWSCmdletOutput("Amazon.GameLift.Model.GameSessionQueue or Amazon.GameLift.Model.DescribeGameSessionQueuesResponse",
        ...
        "The service call response (type Amazon.GameLift.Model.DescribeGameSessionQueuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGMLGameSessionQueueCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// or ARN value. To request settings for all queues, leave this parameter empty. </para><para />
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GameSessionQueues?.Count ?? 0;
        ...
        private Amazon.GameLift.Model.DescribeGameSessionQueuesResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.DescribeGameSessionQueuesRequest request)
        {
            ...
            try
            {
                return client.DescribeGameSessionQueuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
