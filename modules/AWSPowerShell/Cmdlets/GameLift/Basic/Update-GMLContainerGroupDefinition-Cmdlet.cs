...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class UpdateGMLContainerGroupDefinitionCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// parameter in the <i>Amazon Elastic Container Service API Reference</i>. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// host system and lets it access the file or directory.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// on the same operating system.</para><note><para>Amazon Linux 2 (AL2) will reach end of support on 6/30/2026. See more details in the
        ...
        private Amazon.GameLift.Model.UpdateContainerGroupDefinitionResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.UpdateContainerGroupDefinitionRequest request)
        {
            ...
            try
            {
                return client.UpdateContainerGroupDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
