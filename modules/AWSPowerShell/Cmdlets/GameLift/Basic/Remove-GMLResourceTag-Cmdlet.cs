...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class RemoveGMLResourceTagCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GMLResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLift.Model.UntagResourceResponse, RemoveGMLResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameLift.Model.UntagResourceRequest();
        ...
        private Amazon.GameLift.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameLift Service", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GameLift.Model.UntagResourceResponse, RemoveGMLResourceTagCmdlet, object> Select { get; set; } =
