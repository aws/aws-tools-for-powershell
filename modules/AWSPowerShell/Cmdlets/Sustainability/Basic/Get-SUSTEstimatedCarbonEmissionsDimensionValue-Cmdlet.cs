...
namespace Amazon.PowerShell.Cmdlets.SUST
{
    ...
    /// </summary>
    [Cmdlet("Get", "SUSTEstimatedCarbonEmissionsDimensionValue")]
    [OutputType("Amazon.Sustainability.Model.DimensionEntry")]
    [AWSCmdlet("Calls the AWS Sustainability GetEstimatedCarbonEmissionsDimensionValues API operation.", Operation = new[] {"GetEstimatedCarbonEmissionsDimensionValues"}, SelectReturnType = typeof(Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse))]
    [AWSCmdletOutput("Amazon.Sustainability.Model.DimensionEntry or Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse",
        "This cmdlet returns a collection of Amazon.Sustainability.Model.DimensionEntry objects.",
        "The service call response (type Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSUSTEstimatedCarbonEmissionsDimensionValueCmdlet : AmazonSustainabilityClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse).
        /// Specifying the name of a property of type Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse, GetSUSTEstimatedCarbonEmissionsDimensionValueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesRequest();
        ...
        private Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse CallAWSServiceOperation(IAmazonSustainability client, Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Sustainability", "GetEstimatedCarbonEmissionsDimensionValues");
            try
            {
                return client.GetEstimatedCarbonEmissionsDimensionValuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? TimePeriod_End { get; set; }
            public System.DateTime? TimePeriod_Start { get; set; }
            public System.Func<Amazon.Sustainability.Model.GetEstimatedCarbonEmissionsDimensionValuesResponse, GetSUSTEstimatedCarbonEmissionsDimensionValueCmdlet, object> Select { get; set; } =
