...
namespace Amazon.PowerShell.Cmdlets.SUST
{
    ...
    /// </summary>
    [Cmdlet("Get", "SUSTEstimatedWaterAllocationDimensionValue")]
    [OutputType("Amazon.Sustainability.Model.DimensionEntry")]
    [AWSCmdlet("Calls the AWS Sustainability GetEstimatedWaterAllocationDimensionValues API operation.", Operation = new[] {"GetEstimatedWaterAllocationDimensionValues"}, SelectReturnType = typeof(Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse))]
    [AWSCmdletOutput("Amazon.Sustainability.Model.DimensionEntry or Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse",
        "This cmdlet returns a collection of Amazon.Sustainability.Model.DimensionEntry objects.",
        "The service call response (type Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSUSTEstimatedWaterAllocationDimensionValueCmdlet : AmazonSustainabilityClientCmdlet, IExecutor
    {
        ...
        [Alias("Dimensions")]
        public System.String[] Dimension { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse).
        /// Specifying the name of a property of type Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse, GetSUSTEstimatedWaterAllocationDimensionValueCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Dimension != null)
            {
                context.Dimension = new List<System.String>(this.Dimension);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesRequest();
        ...
        private Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse CallAWSServiceOperation(IAmazonSustainability client, Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Sustainability", "GetEstimatedWaterAllocationDimensionValues");
            try
            {
                return client.GetEstimatedWaterAllocationDimensionValuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> Dimension { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.DateTime? TimePeriod_End { get; set; }
            public System.DateTime? TimePeriod_Start { get; set; }
            public System.Func<Amazon.Sustainability.Model.GetEstimatedWaterAllocationDimensionValuesResponse, GetSUSTEstimatedWaterAllocationDimensionValueCmdlet, object> Select { get; set; } =
