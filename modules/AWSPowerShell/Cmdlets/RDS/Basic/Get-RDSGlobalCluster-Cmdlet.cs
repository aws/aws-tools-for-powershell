...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeGlobalClusters API operation.", Operation = new[] {"DescribeGlobalClusters"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeGlobalClustersResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.GlobalCluster or Amazon.RDS.Model.DescribeGlobalClustersResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.GlobalCluster objects.",
        "The service call response (type Amazon.RDS.Model.DescribeGlobalClustersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSGlobalClusterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeGlobalClustersResponse, GetRDSGlobalClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GlobalClusters?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeGlobalClustersResponse, GetRDSGlobalClusterCmdlet, object> Select { get; set; } =
