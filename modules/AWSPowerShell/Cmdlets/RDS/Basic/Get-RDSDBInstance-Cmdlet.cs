...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBInstances API operation.", Operation = new[] {"DescribeDBInstances"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBInstancesResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBInstance or Amazon.RDS.Model.DescribeDBInstancesResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBInstance objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBInstancesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// about the DB instances for these engines.</para></li></ul><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBInstancesResponse, GetRDSDBInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBInstancesRequest();
        ...
        private Amazon.RDS.Model.DescribeDBInstancesResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBInstances");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBInstancesResponse, GetRDSDBInstanceCmdlet, object> Select { get; set; } =
