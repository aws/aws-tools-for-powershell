...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Stop", "RDSDBCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.RDS.Model.DBCluster")]
    [AWSCmdlet("Calls the Amazon Relational Database Service StopDBCluster API operation.", Operation = new[] {"StopDBCluster"}, SelectReturnType = typeof(Amazon.RDS.Model.StopDBClusterResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBCluster or Amazon.RDS.Model.StopDBClusterResponse",
        "This cmdlet returns an Amazon.RDS.Model.DBCluster object.",
        "The service call response (type Amazon.RDS.Model.StopDBClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopRDSDBClusterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-RDSDBCluster (StopDBCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.StopDBClusterResponse, StopRDSDBClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDS.Model.StopDBClusterRequest();
        ...
        private Amazon.RDS.Model.StopDBClusterResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.StopDBClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "StopDBCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DBClusterIdentifier { get; set; }
            public System.Func<Amazon.RDS.Model.StopDBClusterResponse, StopRDSDBClusterCmdlet, object> Select { get; set; } =
