...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EditRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// configuration is used to update the existing configuration.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Options in this list are removed from the option group.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.RDS.Model.ModifyOptionGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.ModifyOptionGroupRequest request)
        {
            ...
            try
            {
                return client.ModifyOptionGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
