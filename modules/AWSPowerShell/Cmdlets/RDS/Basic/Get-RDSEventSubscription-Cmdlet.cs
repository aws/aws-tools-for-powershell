...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RDSEventSubscription")]
    [OutputType("Amazon.RDS.Model.EventSubscription")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeEventSubscriptions API operation.", Operation = new[] {"DescribeEventSubscriptions"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeEventSubscriptionsResponse), LegacyAlias="Get-RDSEventSubscriptions")]
    [AWSCmdletOutput("Amazon.RDS.Model.EventSubscription or Amazon.RDS.Model.DescribeEventSubscriptionsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.EventSubscription objects.",
        "The service call response (type Amazon.RDS.Model.DescribeEventSubscriptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSEventSubscriptionCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeEventSubscriptionsResponse, GetRDSEventSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeEventSubscriptionsRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String SubscriptionName { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeEventSubscriptionsResponse, GetRDSEventSubscriptionCmdlet, object> Select { get; set; } =
