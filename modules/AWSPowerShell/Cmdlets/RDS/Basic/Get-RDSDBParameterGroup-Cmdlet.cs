...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBParameterGroups API operation.", Operation = new[] {"DescribeDBParameterGroups"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBParameterGroupsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBParameterGroup or Amazon.RDS.Model.DescribeDBParameterGroupsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBParameterGroup objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBParameterGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBParameterGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBParameterGroupsResponse, GetRDSDBParameterGroupCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBParameterGroupsResponse, GetRDSDBParameterGroupCmdlet, object> Select { get; set; } =
