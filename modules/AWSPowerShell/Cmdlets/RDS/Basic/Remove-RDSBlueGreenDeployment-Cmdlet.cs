...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteBlueGreenDeployment API operation.", Operation = new[] {"DeleteBlueGreenDeployment"}, SelectReturnType = typeof(Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.BlueGreenDeployment or Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse",
        "This cmdlet returns an Amazon.RDS.Model.BlueGreenDeployment object.",
        "The service call response (type Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRDSBlueGreenDeploymentCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A value that indicates whether to delete the resources in the green environment.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Boolean? DeleteTarget { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RDSBlueGreenDeployment (DeleteBlueGreenDeployment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse, RemoveRDSBlueGreenDeploymentCmdlet>(Select) ??
            ...
            #endif
            context.DeleteTarget = this.DeleteTarget;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDS.Model.DeleteBlueGreenDeploymentRequest();
            ...
            if (cmdletContext.DeleteTarget != null)
            {
                request.DeleteTarget = cmdletContext.DeleteTarget.Value;
            }
        ...
        private Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteBlueGreenDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DeleteBlueGreenDeployment");
            try
            {
                #if DESKTOP
                return client.DeleteBlueGreenDeployment(request);
                #elif CORECLR
                return client.DeleteBlueGreenDeploymentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BlueGreenDeploymentIdentifier { get; set; }
            public System.Boolean? DeleteTarget { get; set; }
            public System.Func<Amazon.RDS.Model.DeleteBlueGreenDeploymentResponse, RemoveRDSBlueGreenDeploymentCmdlet, object> Select { get; set; } =
