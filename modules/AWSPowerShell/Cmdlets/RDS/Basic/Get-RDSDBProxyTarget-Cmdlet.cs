...
{
    /// <summary>
    /// Returns information about <code>DBProxyTarget</code> objects. This API supports pagination.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "RDSDBProxyTarget")]
    [OutputType("Amazon.RDS.Model.DBProxyTarget")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBProxyTargets API operation.", Operation = new[] {"DescribeDBProxyTargets"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBProxyTargetsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBProxyTarget or Amazon.RDS.Model.DescribeDBProxyTargetsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBProxyTarget objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBProxyTargetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRDSDBProxyTargetCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBProxyTargetsResponse, GetRDSDBProxyTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBProxyTargetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                ProcessOutput(output);
            } while (!_userControllingPaging && AutoIterationHelpers.HasValue(_nextToken) && (!_emitLimit.HasValue || _emitLimit.Value >= 20));
        ...
        private Amazon.RDS.Model.DescribeDBProxyTargetsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBProxyTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBProxyTargets");
            try
            {
                #if DESKTOP
                return client.DescribeDBProxyTargets(request);
                #elif CORECLR
                return client.DescribeDBProxyTargetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String TargetGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBProxyTargetsResponse, GetRDSDBProxyTargetCmdlet, object> Select { get; set; } =
