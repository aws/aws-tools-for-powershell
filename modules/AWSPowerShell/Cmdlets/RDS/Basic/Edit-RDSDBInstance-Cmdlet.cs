...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EditRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// for RDS for Oracle and RDS for SQL Server DB instances only.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The Active Directory organizational unit for your DB instance to join.</para><para>Constraints:</para><ul><li><para>Must be in the distinguished name format.</para></li></ul><para>Example: <c>OU=mymanagedADtestOU,DC=mymanagedADtest,DC=mymanagedAD,DC=mydomain</c></para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The open mode of a replica database.</para><para>This parameter is only supported for Db2 DB instances and Oracle DB instances.</para><dl><dt>Db2</dt><dd><para>Standby DB replicas are included in Db2 Advanced Edition (AE), Db2 Community Edition
        ...
        /// serve a read-only workload.</para><para>You can create a combination of standby and read-only DB replicas for the same primary
