...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EditRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// existing value are rounded up so that they are 10% greater than the current value.</para><para>For the valid values for allocated storage for each engine, see <code>CreateDBInstance</code>.</para>
        /// </para>
        /// </summary>
        ...
        /// Instance Class</a> in the <i>Amazon RDS User Guide</i>. For RDS Custom, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-reqs-limits.html#custom-reqs-limits.instances">DB
        /// instance class support for RDS Custom for Oracle</a> and <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-reqs-limits-MS.html#custom-reqs-limits.instancesMS">DB
        /// instance class support for RDS Custom for SQL Server</a>.</para><para>If you modify the DB instance class, an outage occurs during the change. The change
