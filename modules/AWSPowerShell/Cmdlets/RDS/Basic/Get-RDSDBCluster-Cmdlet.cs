...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBClusters API operation.", Operation = new[] {"DescribeDBClusters"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBClustersResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBCluster or Amazon.RDS.Model.DescribeDBClustersResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBCluster objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBClustersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBClusterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBClustersResponse, GetRDSDBClusterCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBClustersResponse, GetRDSDBClusterCmdlet, object> Select { get; set; } =
