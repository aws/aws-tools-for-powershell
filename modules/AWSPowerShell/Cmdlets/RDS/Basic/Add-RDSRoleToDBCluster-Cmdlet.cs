...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class AddRDSRoleToDBClusterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.AddRoleToDBClusterResponse, AddRDSRoleToDBClusterCmdlet>(Select) ??
        ...
        private Amazon.RDS.Model.AddRoleToDBClusterResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.AddRoleToDBClusterRequest request)
        {
            ...
            try
            {
                return client.AddRoleToDBClusterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FeatureName { get; set; }
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.RDS.Model.AddRoleToDBClusterResponse, AddRDSRoleToDBClusterCmdlet, object> Select { get; set; } =
