...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdletOutput("Amazon.RDS.Model.DBProxyTarget or Amazon.RDS.Model.RegisterDBProxyTargetsResponse",
        ...
        "The service call response (type Amazon.RDS.Model.RegisterDBProxyTargetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RegisterRDSDBProxyTargetCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more DB cluster identifiers.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more DB instance identifiers.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.RDS.Model.RegisterDBProxyTargetsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.RegisterDBProxyTargetsRequest request)
        {
            ...
            try
            {
                return client.RegisterDBProxyTargetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
