...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteOptionGroup API operation.", Operation = new[] {"DeleteOptionGroup"}, SelectReturnType = typeof(Amazon.RDS.Model.DeleteOptionGroupResponse))]
    [AWSCmdletOutput("None or Amazon.RDS.Model.DeleteOptionGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.RDS.Model.DeleteOptionGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DeleteOptionGroupResponse, RemoveRDSOptionGroupCmdlet>(Select) ??
        ...
        private Amazon.RDS.Model.DeleteOptionGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteOptionGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteOptionGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String OptionGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DeleteOptionGroupResponse, RemoveRDSOptionGroupCmdlet, object> Select { get; set; } =
