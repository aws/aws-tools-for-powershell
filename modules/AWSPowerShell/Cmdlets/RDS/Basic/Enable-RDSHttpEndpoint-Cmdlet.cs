...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EnableRDSHttpEndpointCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-RDSHttpEndpoint (EnableHttpEndpoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.EnableHttpEndpointResponse, EnableRDSHttpEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDS.Model.EnableHttpEndpointRequest();
        ...
        private Amazon.RDS.Model.EnableHttpEndpointResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.EnableHttpEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "EnableHttpEndpoint");
            try
            {
                #if DESKTOP
                return client.EnableHttpEndpoint(request);
                #elif CORECLR
                return client.EnableHttpEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.RDS.Model.EnableHttpEndpointResponse, EnableRDSHttpEndpointCmdlet, object> Select { get; set; } =
