...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class NewRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// for the space that you use in an Aurora cluster volume.</para><dl><dt>Amazon RDS Custom</dt><dt>RDS for MariaDB</dt><dt>RDS for MySQL</dt><dt>RDS
        /// for Oracle</dt><dt>RDS for PostgreSQL</dt><dt>RDS for SQL Server</dt><dd><para>Constraints to the amount of storage for each storage type are the following:</para><ul><li><para>General Purpose (SSD) storage (gp2, gp3): Must be an integer from 40 to 65536 for
        ...
        /// <summary>
        /// <para>
        /// <para>Spcifies whether to copy tags from the DB instance to snapshots of the DB instance.
        ...
        /// <summary>
        /// <para>
        /// <para>The meaning of this parameter differs depending on the database engine.</para><dl><dt>Amazon Aurora MySQL</dt><dt>Amazon Aurora PostgreSQL</dt><dt>Amazon RDS
        /// Custom for Oracle</dt><dt>Amazon RDS Custom for SQL Server</dt><dt>RDS for MariaDB</dt><dt>RDS for MySQL</dt><dt>RDS for Oracle</dt><dt>RDS for PostgreSQL</dt><dt>RDS
        /// for SQL Server</dt><dd><para>The name of the database to create when the primary DB instance of the Aurora MySQL
        /// DB cluster is created. If you don't specify a value, Amazon RDS doesn't create a database
        /// in the DB cluster.</para><para>Constraints:</para><ul><li><para>Must contain 1 to 64 alphanumeric characters.</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>The name of the database to create when the primary DB instance of the Aurora PostgreSQL
        ...
        /// (0 to 9).</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>The Oracle System ID (SID) of the created RDS Custom DB instance.</para><para>Default: <code>ORCL</code></para><para>Constraints:</para><ul><li><para>Must contain 1 to 8 alphanumeric characters.</para></li><li><para>Must contain a letter.</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>Not applicable. Must be null.</para></dd><dd><para>The name of the database to create when the DB instance is created. If you don't specify
        ...
        /// (0-9).</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>The name of the database to create when the DB instance is created. If you don't specify
        /// a value, Amazon RDS doesn't create a database in the DB instance.</para><para>Constraints:</para><ul><li><para>Must contain 1 to 64 letters or numbers.</para></li><li><para>Must begin with a letter. Subsequent characters can be letters, underscores, or digits
        /// (0-9).</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>The Oracle System ID (SID) of the created DB instance.</para><para>Default: <code>ORCL</code></para><para>Constraints:</para><ul><li><para>Can't be longer than 8 characters.</para></li><li><para>Can't be a word reserved by the database engine, such as the string <code>NULL</code>.</para></li></ul></dd><dd><para>The name of the database to create when the DB instance is created.</para><para>Default: <code>postgres</code></para><para>Constraints:</para><ul><li><para>Must contain 1 to 63 letters, numbers, or underscores.</para></li><li><para>Must begin with a letter. Subsequent characters can be letters, underscores, or digits
        /// (0-9).</para></li><li><para>Can't be a word reserved by the database engine.</para></li></ul></dd><dd><para>Not applicable. Must be null.</para></dd></dl>
        /// </para>
        /// </summary>
        ...
        /// for every Amazon Web Services Region.</para><dl><dt>Amazon RDS Custom for Oracle</dt><dt>Amazon RDS Custom for SQL Server</dt><dt>RDS for MariaDB</dt><dt>RDS for Microsoft SQL Server</dt><dt>RDS for MySQL</dt><dt>RDS for Oracle</dt><dt>RDS for PostgreSQL</dt><dd><para>A custom engine version (CEV) that you have previously created. This setting is required
        ...
        /// Creating an RDS Custom for Oracle DB instance</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>See <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/custom-reqs-limits-MS.html">RDS
        /// Custom for SQL Server general requirements</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>For information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_MariaDB.html#MariaDB.Concepts.VersionMgmt">MariaDB
        /// on Amazon RDS versions</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>For information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_SQLServer.html#SQLServer.Concepts.General.VersionSupport">Microsoft
        /// SQL Server versions on Amazon RDS</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>For information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_MySQL.html#MySQL.Concepts.VersionMgmt">MySQL
        /// on Amazon RDS versions</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>For information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.Oracle.PatchComposition.html">Oracle
        /// Database Engine release notes</a> in the <i>Amazon RDS User Guide</i>.</para></dd><dd><para>For information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_PostgreSQL.html#PostgreSQL.Concepts">Amazon
