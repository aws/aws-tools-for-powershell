...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class NewRDSDBInstanceCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the database engine to be used for this instance.</para><para>Not every database engine is available for every Amazon Web Services Region.</para><para>Valid Values:</para><ul><li><para><code>aurora-mysql</code> (for Aurora MySQL DB instances)</para></li><li><para><code>aurora-postgresql</code> (for Aurora PostgreSQL DB instances)</para></li><li><para><code>custom-oracle-ee (for RDS Custom for Oracle DB instances)</code></para></li><li><para><code>custom-oracle-ee-cdb (for RDS Custom for Oracle DB instances)</code></para></li><li><para><code>custom-sqlserver-ee (for RDS Custom for SQL Server DB instances)</code></para></li><li><para><code>custom-sqlserver-se (for RDS Custom for SQL Server DB instances)</code></para></li><li><para><code>custom-sqlserver-web (for RDS Custom for SQL Server DB instances)</code></para></li><li><para><code>mariadb</code></para></li><li><para><code>mysql</code></para></li><li><para><code>oracle-ee</code></para></li><li><para><code>oracle-ee-cdb</code></para></li><li><para><code>oracle-se2</code></para></li><li><para><code>oracle-se2-cdb</code></para></li><li><para><code>postgres</code></para></li><li><para><code>sqlserver-ee</code></para></li><li><para><code>sqlserver-se</code></para></li><li><para><code>sqlserver-ex</code></para></li><li><para><code>sqlserver-web</code></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
