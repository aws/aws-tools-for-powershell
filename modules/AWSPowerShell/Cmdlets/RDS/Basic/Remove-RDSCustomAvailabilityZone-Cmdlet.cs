...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RDSCustomAvailabilityZone", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.RDS.Model.CustomAvailabilityZone")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DeleteCustomAvailabilityZone API operation.", Operation = new[] {"DeleteCustomAvailabilityZone"}, SelectReturnType = typeof(Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.CustomAvailabilityZone or Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse",
        "This cmdlet returns an Amazon.RDS.Model.CustomAvailabilityZone object.",
        "The service call response (type Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRDSCustomAvailabilityZoneCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RDSCustomAvailabilityZone (DeleteCustomAvailabilityZone)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse, RemoveRDSCustomAvailabilityZoneCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDS.Model.DeleteCustomAvailabilityZoneRequest();
        ...
        private Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteCustomAvailabilityZoneRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DeleteCustomAvailabilityZone");
            try
            {
                #if DESKTOP
                return client.DeleteCustomAvailabilityZone(request);
                #elif CORECLR
                return client.DeleteCustomAvailabilityZoneAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CustomAvailabilityZoneId { get; set; }
            public System.Func<Amazon.RDS.Model.DeleteCustomAvailabilityZoneResponse, RemoveRDSCustomAvailabilityZoneCmdlet, object> Select { get; set; } =
