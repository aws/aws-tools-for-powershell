...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class GetRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OptionGroupsList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeOptionGroupsResponse, GetRDSOptionGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OptionGroupsList?.Count ?? 0;
        ...
        private Amazon.RDS.Model.DescribeOptionGroupsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeOptionGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeOptionGroups");
            try
            {
                return client.DescribeOptionGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String OptionGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeOptionGroupsResponse, GetRDSOptionGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OptionGroupsList;
        }
