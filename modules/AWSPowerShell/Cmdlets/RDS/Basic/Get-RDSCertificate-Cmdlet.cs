...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeCertificates API operation.", Operation = new[] {"DescribeCertificates"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeCertificatesResponse), LegacyAlias="Get-RDSCertificates")]
    [AWSCmdletOutput("Amazon.RDS.Model.Certificate or Amazon.RDS.Model.DescribeCertificatesResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.Certificate objects.",
        "The service call response (type Amazon.RDS.Model.DescribeCertificatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSCertificateCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeCertificatesResponse, GetRDSCertificateCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeCertificatesResponse, GetRDSCertificateCmdlet, object> Select { get; set; } =
