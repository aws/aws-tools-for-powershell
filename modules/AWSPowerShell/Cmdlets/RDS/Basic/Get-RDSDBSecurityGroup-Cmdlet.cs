...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBSecurityGroups API operation.", Operation = new[] {"DescribeDBSecurityGroups"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBSecurityGroupsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBSecurityGroup or Amazon.RDS.Model.DescribeDBSecurityGroupsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBSecurityGroup objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBSecurityGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBSecurityGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DBSecurityGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBSecurityGroupsResponse, GetRDSDBSecurityGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBSecurityGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DBSecurityGroups?.Count ?? 0;
        ...
        private Amazon.RDS.Model.DescribeDBSecurityGroupsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBSecurityGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBSecurityGroups");
            try
            {
                #if DESKTOP
                return client.DescribeDBSecurityGroups(request);
                #elif CORECLR
                return client.DescribeDBSecurityGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBSecurityGroupsResponse, GetRDSDBSecurityGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DBSecurityGroups;
        }
