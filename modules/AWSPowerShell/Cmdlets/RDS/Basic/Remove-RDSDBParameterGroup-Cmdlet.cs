...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class RemoveRDSDBParameterGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DeleteDBParameterGroupResponse, RemoveRDSDBParameterGroupCmdlet>(Select) ??
        ...
        private Amazon.RDS.Model.DeleteDBParameterGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteDBParameterGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteDBParameterGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DBParameterGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DeleteDBParameterGroupResponse, RemoveRDSDBParameterGroupCmdlet, object> Select { get; set; } =
