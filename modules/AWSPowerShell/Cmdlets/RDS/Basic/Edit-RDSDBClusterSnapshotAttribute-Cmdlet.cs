...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class EditRDSDBClusterSnapshotAttributeCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// snapshot, set this value to <code>restore</code>.</para><note><para>To view the list of attributes available to modify, use the <a>DescribeDBClusterSnapshotAttributes</a>
