...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeSourceRegions API operation.", Operation = new[] {"DescribeSourceRegions"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeSourceRegionsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.SourceRegion or Amazon.RDS.Model.DescribeSourceRegionsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.SourceRegion objects.",
        "The service call response (type Amazon.RDS.Model.DescribeSourceRegionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSSourceRegionCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SourceRegions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeSourceRegionsResponse, GetRDSSourceRegionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SourceRegions?.Count ?? 0;
        ...
        private Amazon.RDS.Model.DescribeSourceRegionsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeSourceRegionsRequest request)
        {
            ...
            try
            {
                return client.DescribeSourceRegionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String RegionName { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeSourceRegionsResponse, GetRDSSourceRegionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SourceRegions;
        }
