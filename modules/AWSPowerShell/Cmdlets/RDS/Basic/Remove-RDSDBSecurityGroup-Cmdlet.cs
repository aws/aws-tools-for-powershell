...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class RemoveRDSDBSecurityGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DeleteDBSecurityGroupResponse, RemoveRDSDBSecurityGroupCmdlet>(Select) ??
        ...
        private Amazon.RDS.Model.DeleteDBSecurityGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DeleteDBSecurityGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteDBSecurityGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DBSecurityGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DeleteDBSecurityGroupResponse, RemoveRDSDBSecurityGroupCmdlet, object> Select { get; set; } =
