...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RDSDBProxyEndpoint")]
    [OutputType("Amazon.RDS.Model.DBProxyEndpoint")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBProxyEndpoints API operation.", Operation = new[] {"DescribeDBProxyEndpoints"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBProxyEndpointsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBProxyEndpoint or Amazon.RDS.Model.DescribeDBProxyEndpointsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBProxyEndpoint objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBProxyEndpointsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRDSDBProxyEndpointCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DBProxyEndpoints";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBProxyEndpointsResponse, GetRDSDBProxyEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBProxyEndpointsRequest();
        ...
        private Amazon.RDS.Model.DescribeDBProxyEndpointsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBProxyEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBProxyEndpoints");
            try
            {
                #if DESKTOP
                return client.DescribeDBProxyEndpoints(request);
                #elif CORECLR
                return client.DescribeDBProxyEndpointsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBProxyEndpointsResponse, GetRDSDBProxyEndpointCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DBProxyEndpoints;
        }
