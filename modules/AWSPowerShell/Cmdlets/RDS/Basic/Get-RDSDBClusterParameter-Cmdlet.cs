...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBClusterParameters API operation.", Operation = new[] {"DescribeDBClusterParameters"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBClusterParametersResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.Parameter or Amazon.RDS.Model.DescribeDBClusterParametersResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.Parameter objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBClusterParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBClusterParameterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// information about the DB cluster parameters with these names.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBClusterParametersResponse, GetRDSDBClusterParameterCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String Source { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBClusterParametersResponse, GetRDSDBClusterParameterCmdlet, object> Select { get; set; } =
