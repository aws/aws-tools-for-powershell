...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeInstallationMedia API operation.", Operation = new[] {"DescribeInstallationMedia"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeInstallationMediaResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.InstallationMedia or Amazon.RDS.Model.DescribeInstallationMediaResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.InstallationMedia objects.",
        "The service call response (type Amazon.RDS.Model.DescribeInstallationMediaResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRDSInstallationMediaCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        public System.String InstallationMediaId { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstallationMedia";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^InstallationMediaId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeInstallationMediaResponse, GetRDSInstallationMediaCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.InstallationMediaId;
            }
            ...
            context.InstallationMediaId = this.InstallationMediaId;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeInstallationMediaRequest();
            
            if (cmdletContext.Filter != null)
            {
                request.Filters = cmdletContext.Filter;
            }
            if (cmdletContext.InstallationMediaId != null)
            {
                request.InstallationMediaId = cmdletContext.InstallationMediaId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.InstallationMedia.Count;
        ...
        private Amazon.RDS.Model.DescribeInstallationMediaResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeInstallationMediaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeInstallationMedia");
            try
            {
                #if DESKTOP
                return client.DescribeInstallationMedia(request);
                #elif CORECLR
                return client.DescribeInstallationMediaAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeInstallationMediaResponse, GetRDSInstallationMediaCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstallationMedia;
        }
