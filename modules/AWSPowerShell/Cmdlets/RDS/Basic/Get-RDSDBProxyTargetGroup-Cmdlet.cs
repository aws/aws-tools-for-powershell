...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RDSDBProxyTargetGroup")]
    [OutputType("Amazon.RDS.Model.DBProxyTargetGroup")]
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBProxyTargetGroups API operation.", Operation = new[] {"DescribeDBProxyTargetGroups"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.DBProxyTargetGroup or Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.DBProxyTargetGroup objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRDSDBProxyTargetGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse, GetRDSDBProxyTargetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeDBProxyTargetGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TargetGroups?.Count ?? 0;
        ...
        private Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeDBProxyTargetGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeDBProxyTargetGroups");
            try
            {
                #if DESKTOP
                return client.DescribeDBProxyTargetGroups(request);
                #elif CORECLR
                return client.DescribeDBProxyTargetGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String TargetGroupName { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBProxyTargetGroupsResponse, GetRDSDBProxyTargetGroupCmdlet, object> Select { get; set; } =
