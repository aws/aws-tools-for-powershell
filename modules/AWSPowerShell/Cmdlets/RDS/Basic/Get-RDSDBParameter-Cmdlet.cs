...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeDBParameters API operation.", Operation = new[] {"DescribeDBParameters"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeDBParametersResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.Parameter or Amazon.RDS.Model.DescribeDBParametersResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.Parameter objects.",
        "The service call response (type Amazon.RDS.Model.DescribeDBParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBParameterCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// information about the DB parameters with these names.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeDBParametersResponse, GetRDSDBParameterCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String Source { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeDBParametersResponse, GetRDSDBParameterCmdlet, object> Select { get; set; } =
