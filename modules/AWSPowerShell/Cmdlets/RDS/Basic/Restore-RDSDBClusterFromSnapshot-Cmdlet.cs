...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class RestoreRDSDBClusterFromSnapshotCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// with the DB cluster when it's restored from a snapshot. Each role grants the DB cluster
        ...
        /// or <c>Lambda</c>).</para><para>Valid for Cluster Type: Aurora DB clusters only</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The lifecycle type for this DB cluster.</para><note><para>By default, this value is set to <c>open-source-rds-extended-support</c>, which enrolls
        ...
        /// or platform version to determine the specific maximum capacity supported.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to assign to resources associated with the DB cluster.</para><para>Valid Values: </para><ul><li><para><c>cluster-auto-backup</c> - The DB cluster's automated backup.</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
