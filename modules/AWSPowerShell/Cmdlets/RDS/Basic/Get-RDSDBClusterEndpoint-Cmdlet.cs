...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdletOutput("Amazon.RDS.Model.DBClusterEndpoint or Amazon.RDS.Model.DescribeDBClusterEndpointsResponse",
        ...
        "The service call response (type Amazon.RDS.Model.DescribeDBClusterEndpointsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSDBClusterEndpointCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <c>inactive</c>, <c>modifying</c>.</para><para />
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DBClusterEndpoints?.Count ?? 0;
