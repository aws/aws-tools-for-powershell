...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdlet("Calls the Amazon Relational Database Service DescribeIntegrations API operation.", Operation = new[] {"DescribeIntegrations"}, SelectReturnType = typeof(Amazon.RDS.Model.DescribeIntegrationsResponse))]
    [AWSCmdletOutput("Amazon.RDS.Model.Integration or Amazon.RDS.Model.DescribeIntegrationsResponse",
        "This cmdlet returns a collection of Amazon.RDS.Model.Integration objects.",
        "The service call response (type Amazon.RDS.Model.DescribeIntegrationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRDSIntegrationCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An optional pagination token provided by a previous <code>DescribeIntegrations</code>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.DescribeIntegrationsResponse, GetRDSIntegrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RDS.Model.DescribeIntegrationsRequest();
        ...
        private Amazon.RDS.Model.DescribeIntegrationsResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.DescribeIntegrationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Relational Database Service", "DescribeIntegrations");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.RDS.Model.DescribeIntegrationsResponse, GetRDSIntegrationCmdlet, object> Select { get; set; } =
