...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    [AWSCmdletOutput("Amazon.RDS.Model.Integration or Amazon.RDS.Model.DescribeIntegrationsResponse",
        ...
        "The service call response (type Amazon.RDS.Model.DescribeIntegrationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRDSIntegrationCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A filter that specifies one or more resources to return.</para><para />
