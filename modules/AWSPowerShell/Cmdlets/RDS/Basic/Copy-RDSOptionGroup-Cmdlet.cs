...
namespace Amazon.PowerShell.Cmdlets.RDS
{
    ...
    public partial class CopyRDSOptionGroupCmdlet : AmazonRDSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SourceOptionGroupIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SourceOptionGroupIdentifier), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDS.Model.CopyOptionGroupResponse, CopyRDSOptionGroupCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SourceOptionGroupIdentifier;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.SourceOptionGroupIdentifier = this.SourceOptionGroupIdentifier;
            #if MODULAR
            if (this.SourceOptionGroupIdentifier == null && ParameterWasBound(nameof(this.SourceOptionGroupIdentifier)))
            {
                WriteWarning("You are passing $null as a value for parameter SourceOptionGroupIdentifier which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            if (this.Tag != null)
            {
            ...
            #if MODULAR
            if (this.TargetOptionGroupDescription == null && ParameterWasBound(nameof(this.TargetOptionGroupDescription)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetOptionGroupDescription which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.TargetOptionGroupIdentifier = this.TargetOptionGroupIdentifier;
            #if MODULAR
            if (this.TargetOptionGroupIdentifier == null && ParameterWasBound(nameof(this.TargetOptionGroupIdentifier)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetOptionGroupIdentifier which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.RDS.Model.CopyOptionGroupResponse CallAWSServiceOperation(IAmazonRDS client, Amazon.RDS.Model.CopyOptionGroupRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.CopyOptionGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TargetOptionGroupDescription { get; set; }
            public System.String TargetOptionGroupIdentifier { get; set; }
            public System.Func<Amazon.RDS.Model.CopyOptionGroupResponse, CopyRDSOptionGroupCmdlet, object> Select { get; set; } =
