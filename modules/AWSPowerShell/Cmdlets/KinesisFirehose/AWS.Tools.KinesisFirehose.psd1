#
# Module manifest for module 'AWS.Tools.KinesisFirehose'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.KinesisFirehose.dll'
    ...
    GUID = 'c3053630-8285-4f10-8f90-036467ccae30'
    ...
    Description = 'The KinesisFirehose module of AWS Tools for PowerShell lets developers and administrators manage Amazon Kinesis Firehose from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.KinesisFirehose.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.KinesisFirehose.Completers.psm1',
        'AWS.Tools.KinesisFirehose.Aliases.psm1'
    )
