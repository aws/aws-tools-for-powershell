...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ContainerRecipeSummary or Amazon.Imagebuilder.Model.ListContainerRecipesResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListContainerRecipesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBContainerRecipeListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Request filters that are used to narrow the list of container images that are returned.</para>
        /// </para>
        /// </summary>
