...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class GetEC2IBContainerRecipeListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Use the following filters to streamline results:</para><ul><li><para><c>containerType</c></para></li><li><para><c>name</c></para></li><li><para><c>parentImage</c></para></li><li><para><c>platform</c></para></li></ul><para />
        ...
        private Amazon.Imagebuilder.Model.ListContainerRecipesResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListContainerRecipesRequest request)
        {
            ...
            try
            {
                return client.ListContainerRecipesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
