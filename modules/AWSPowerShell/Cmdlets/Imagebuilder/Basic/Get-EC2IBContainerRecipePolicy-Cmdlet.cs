...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2IBContainerRecipePolicy")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the EC2 Image Builder GetContainerRecipePolicy API operation.", Operation = new[] {"GetContainerRecipePolicy"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBContainerRecipePolicyCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse, GetEC2IBContainerRecipePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.GetContainerRecipePolicyRequest();
        ...
        private Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetContainerRecipePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "GetContainerRecipePolicy");
            try
            {
                #if DESKTOP
                return client.GetContainerRecipePolicy(request);
                #elif CORECLR
                return client.GetContainerRecipePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContainerRecipeArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.GetContainerRecipePolicyResponse, GetEC2IBContainerRecipePolicyCmdlet, object> Select { get; set; } =
