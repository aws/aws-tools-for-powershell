...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder DeleteImagePipeline API operation.", Operation = new[] {"DeleteImagePipeline"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.DeleteImagePipelineResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.DeleteImagePipelineResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.DeleteImagePipelineResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2IBImagePipelineCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2IBImagePipeline (DeleteImagePipeline)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.DeleteImagePipelineResponse, RemoveEC2IBImagePipelineCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.DeleteImagePipelineRequest();
        ...
        private Amazon.Imagebuilder.Model.DeleteImagePipelineResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.DeleteImagePipelineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "DeleteImagePipeline");
            try
            {
                #if DESKTOP
                return client.DeleteImagePipeline(request);
                #elif CORECLR
                return client.DeleteImagePipelineAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ImagePipelineArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.DeleteImagePipelineResponse, RemoveEC2IBImagePipelineCmdlet, object> Select { get; set; } =
