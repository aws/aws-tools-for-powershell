...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ImageSummary or Amazon.Imagebuilder.Model.ListImagePipelineImagesResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListImagePipelineImagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
