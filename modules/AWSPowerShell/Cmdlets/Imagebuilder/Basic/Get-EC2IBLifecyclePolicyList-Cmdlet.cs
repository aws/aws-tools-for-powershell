...
{
    /// <summary>
    /// Retrieves a list of lifecycle policies in your Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.LifecyclePolicySummary or Amazon.Imagebuilder.Model.ListLifecyclePoliciesResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListLifecyclePoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2IBLifecyclePolicyListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Use the following filters to streamline results: <c>name</c>, <c>resourceType</c>,
        /// and <c>status</c>. Filter names are matched exactly as shown.</para><para />
