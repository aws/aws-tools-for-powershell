...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class ImportEC2IBComponentCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The data of the component. For the <c>SHELL</c> format, this is the plain script content.
        /// You must specify exactly one of the <c>data</c> or <c>uri</c> properties. For scripts
        /// that exceed the inline length constraint, use the <c>uri</c> property.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the KMS key that is used to encrypt this component.
        ...
        /// <summary>
        /// <para>
        /// <para>The tags of the component.</para><para />
        ...
        private Amazon.Imagebuilder.Model.ImportComponentResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ImportComponentRequest request)
        {
            ...
            try
            {
                return client.ImportComponentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
