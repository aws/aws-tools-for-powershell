...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// </summary>
    [Cmdlet("Start", "EC2IBImageRetry", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the EC2 Image Builder RetryImage API operation.", Operation = new[] {"RetryImage"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.RetryImageResponse))]
    [AWSCmdletOutput("System.String or Amazon.Imagebuilder.Model.RetryImageResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Imagebuilder.Model.RetryImageResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartEC2IBImageRetryCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the image build version that you want to retry.
        /// The image must be in the <c>FAILED</c> or <c>CANCELLED</c> state.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Imagebuilder.Model.RetryImageResponse).
        /// Specifying the name of a property of type Amazon.Imagebuilder.Model.RetryImageResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-EC2IBImageRetry (RetryImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.RetryImageResponse, StartEC2IBImageRetryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.RetryImageRequest();
        ...
        private Amazon.Imagebuilder.Model.RetryImageResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.RetryImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "RetryImage");
            try
            {
                return client.RetryImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String ImageBuildVersionArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.RetryImageResponse, StartEC2IBImageRetryCmdlet, object> Select { get; set; } =
