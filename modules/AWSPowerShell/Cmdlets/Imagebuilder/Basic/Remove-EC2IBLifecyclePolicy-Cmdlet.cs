...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder DeleteLifecyclePolicy API operation.", Operation = new[] {"DeleteLifecyclePolicy"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2IBLifecyclePolicyCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^LifecyclePolicyArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2IBLifecyclePolicy (DeleteLifecyclePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse, RemoveEC2IBLifecyclePolicyCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.LifecyclePolicyArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.DeleteLifecyclePolicyRequest();
        ...
        private Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.DeleteLifecyclePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "DeleteLifecyclePolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String LifecyclePolicyArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.DeleteLifecyclePolicyResponse, RemoveEC2IBLifecyclePolicyCmdlet, object> Select { get; set; } =
