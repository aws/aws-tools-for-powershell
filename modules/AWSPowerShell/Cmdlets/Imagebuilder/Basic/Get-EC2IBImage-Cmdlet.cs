...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.Image or Amazon.Imagebuilder.Model.GetImageResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.GetImageResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2IBImageCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the image that you want to get. You can specify
        ...
        /// failed or in-progress build, specify the full build version ARN.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Imagebuilder.Model.GetImageResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetImageRequest request)
        {
            ...
            try
            {
                return client.GetImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
