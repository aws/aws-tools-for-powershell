...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2IBComponent")]
    [OutputType("Amazon.Imagebuilder.Model.Component")]
    [AWSCmdlet("Calls the EC2 Image Builder GetComponent API operation.", Operation = new[] {"GetComponent"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.GetComponentResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.Component or Amazon.Imagebuilder.Model.GetComponentResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.Component object.",
        "The service call response (type Amazon.Imagebuilder.Model.GetComponentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBComponentCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ComponentBuildVersionArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.GetComponentResponse, GetEC2IBComponentCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ComponentBuildVersionArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.GetComponentRequest();
        ...
        private Amazon.Imagebuilder.Model.GetComponentResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "GetComponent");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ComponentBuildVersionArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.GetComponentResponse, GetEC2IBComponentCmdlet, object> Select { get; set; } =
