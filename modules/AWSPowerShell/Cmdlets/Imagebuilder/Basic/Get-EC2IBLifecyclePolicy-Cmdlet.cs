...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder GetLifecyclePolicy API operation.", Operation = new[] {"GetLifecyclePolicy"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.LifecyclePolicy or Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.LifecyclePolicy object.",
        "The service call response (type Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBLifecyclePolicyCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse, GetEC2IBLifecyclePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.GetLifecyclePolicyRequest();
        ...
        private Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetLifecyclePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "GetLifecyclePolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String LifecyclePolicyArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.GetLifecyclePolicyResponse, GetEC2IBLifecyclePolicyCmdlet, object> Select { get; set; } =
