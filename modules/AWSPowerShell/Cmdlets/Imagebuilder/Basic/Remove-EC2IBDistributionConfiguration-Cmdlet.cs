...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class RemoveEC2IBDistributionConfigurationCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2IBDistributionConfiguration (DeleteDistributionConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.DeleteDistributionConfigurationResponse, RemoveEC2IBDistributionConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.DeleteDistributionConfigurationRequest();
        ...
        private Amazon.Imagebuilder.Model.DeleteDistributionConfigurationResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.DeleteDistributionConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "DeleteDistributionConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteDistributionConfiguration(request);
                #elif CORECLR
                return client.DeleteDistributionConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DistributionConfigurationArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.DeleteDistributionConfigurationResponse, RemoveEC2IBDistributionConfigurationCmdlet, object> Select { get; set; } =
