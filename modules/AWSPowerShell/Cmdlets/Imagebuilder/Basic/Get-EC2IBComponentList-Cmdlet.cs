...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder ListComponents API operation.", Operation = new[] {"ListComponents"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.ListComponentsResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ComponentVersion or Amazon.Imagebuilder.Model.ListComponentsResponse",
        "This cmdlet returns a collection of Amazon.Imagebuilder.Model.ComponentVersion objects.",
        "The service call response (type Amazon.Imagebuilder.Model.ListComponentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBComponentListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The owner defines whose components you wish to list. By default this request will
        ...
        /// shared with you by other customers. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ComponentVersionList";
        #endregion
        ...
        private Amazon.Imagebuilder.Model.ListComponentsResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListComponentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "ListComponents");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.Imagebuilder.Ownership Owner { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.ListComponentsResponse, GetEC2IBComponentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ComponentVersionList;
        }
