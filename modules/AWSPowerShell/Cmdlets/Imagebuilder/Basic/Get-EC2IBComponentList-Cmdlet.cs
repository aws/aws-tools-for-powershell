...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// </para><para><b>Filtering:</b> You can use wildcards (x) to specify the most recent versions or
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ComponentVersion or Amazon.Imagebuilder.Model.ListComponentsResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListComponentsResponse) can be returned by specifying '-Select *'."
    )]
