...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// by Amazon Web Services Systems Manager Inventory at build time.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ImagePackage or Amazon.Imagebuilder.Model.ListImagePackagesResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListImagePackagesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2IBImagePackageListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        private Amazon.Imagebuilder.Model.ListImagePackagesResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListImagePackagesRequest request)
        {
            ...
            try
            {
                return client.ListImagePackagesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
