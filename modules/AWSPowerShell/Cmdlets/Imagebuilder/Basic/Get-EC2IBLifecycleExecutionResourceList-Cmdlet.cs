...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ListLifecycleExecutionResourcesResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.ListLifecycleExecutionResourcesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBLifecycleExecutionResourceListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        private Amazon.Imagebuilder.Model.ListLifecycleExecutionResourcesResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListLifecycleExecutionResourcesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListLifecycleExecutionResources(request);
                #elif CORECLR
                return client.ListLifecycleExecutionResourcesAsync(request).GetAwaiter().GetResult();
                #else
