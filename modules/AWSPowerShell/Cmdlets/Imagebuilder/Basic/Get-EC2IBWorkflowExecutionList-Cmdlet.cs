...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2IBWorkflowExecutionList")]
    [OutputType("Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse")]
    [AWSCmdlet("Calls the EC2 Image Builder ListWorkflowExecutions API operation.", Operation = new[] {"ListWorkflowExecutions"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBWorkflowExecutionListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse, GetEC2IBWorkflowExecutionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Imagebuilder.Model.ListWorkflowExecutionsRequest();
        ...
        private Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListWorkflowExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "ListWorkflowExecutions");
            try
            {
                #if DESKTOP
                return client.ListWorkflowExecutions(request);
                #elif CORECLR
                return client.ListWorkflowExecutionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.ListWorkflowExecutionsResponse, GetEC2IBWorkflowExecutionListCmdlet, object> Select { get; set; } =
