...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class SendEC2IBWorkflowStepActionCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the image build version associated with the workflow
        ...
        /// <summary>
        /// <para>
        /// <para>The reason for the action. This value is stored with the step execution record and
        /// is accessible in subsequent workflow steps via step output references.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Imagebuilder.Model.SendWorkflowStepActionResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.SendWorkflowStepActionRequest request)
        {
            ...
            try
            {
                return client.SendWorkflowStepActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
