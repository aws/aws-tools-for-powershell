...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class NewEC2IBInfrastructureConfigurationCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the infrastructure configuration. Infrastructure configuration names must
        /// be unique to your account in each Amazon Web Services Region. Image Builder generates
        /// the infrastructure configuration ARN from a normalized form of the name, so names
        /// that differ only in case, spaces, or underscores count as the same name.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Builder creates as output. Tags are formatted as key value pairs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
