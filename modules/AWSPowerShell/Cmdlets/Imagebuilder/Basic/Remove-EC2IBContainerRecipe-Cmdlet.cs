...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class RemoveEC2IBContainerRecipeCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2IBContainerRecipe (DeleteContainerRecipe)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.DeleteContainerRecipeResponse, RemoveEC2IBContainerRecipeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.DeleteContainerRecipeRequest();
        ...
        private Amazon.Imagebuilder.Model.DeleteContainerRecipeResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.DeleteContainerRecipeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "DeleteContainerRecipe");
            try
            {
                #if DESKTOP
                return client.DeleteContainerRecipe(request);
                #elif CORECLR
                return client.DeleteContainerRecipeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContainerRecipeArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.DeleteContainerRecipeResponse, RemoveEC2IBContainerRecipeCmdlet, object> Select { get; set; } =
