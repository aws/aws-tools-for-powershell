...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    public partial class GetEC2IBImageRecipeCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The Amazon Resource Name (ARN) of the image recipe that you wish to retrieve. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        public string Select { get; set; } = "ImageRecipe";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.GetImageRecipeResponse, GetEC2IBImageRecipeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.GetImageRecipeRequest();
        ...
        private Amazon.Imagebuilder.Model.GetImageRecipeResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetImageRecipeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "GetImageRecipe");
            try
            {
                #if DESKTOP
                return client.GetImageRecipe(request);
                #elif CORECLR
                return client.GetImageRecipeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ImageRecipeArn { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.GetImageRecipeResponse, GetEC2IBImageRecipeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ImageRecipe;
        }
