...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ImageVersion or Amazon.Imagebuilder.Model.ListImagesResponse",
        ...
        "The service call response (type Amazon.Imagebuilder.Model.ListImagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
