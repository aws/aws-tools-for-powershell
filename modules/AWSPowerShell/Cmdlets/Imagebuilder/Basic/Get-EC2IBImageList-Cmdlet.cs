...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder ListImages API operation.", Operation = new[] {"ListImages"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.ListImagesResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.ImageVersion or Amazon.Imagebuilder.Model.ListImagesResponse",
        "This cmdlet returns a collection of Amazon.Imagebuilder.Model.ImageVersion objects.",
        "The service call response (type Amazon.Imagebuilder.Model.ListImagesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2IBImageListCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Use the following filters to streamline results:</para><ul><li><para><c>name</c></para></li><li><para><c>osVersion</c></para></li><li><para><c>platform</c></para></li><li><para><c>type</c></para></li><li><para><c>version</c></para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Filters the list to images owned by you, by Amazon, or shared with you by other accounts.
        /// By default, only your account's images are returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ImageVersionList";
        #endregion
        ...
        private Amazon.Imagebuilder.Model.ListImagesResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.ListImagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "ListImages");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.Imagebuilder.Ownership Owner { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.ListImagesResponse, GetEC2IBImageListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ImageVersionList;
        }
