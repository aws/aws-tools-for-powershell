...
namespace Amazon.PowerShell.Cmdlets.EC2IB
{
    ...
    [AWSCmdlet("Calls the EC2 Image Builder GetWorkflowExecution API operation.", Operation = new[] {"GetWorkflowExecution"}, SelectReturnType = typeof(Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse))]
    [AWSCmdletOutput("Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse",
        "This cmdlet returns an Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IBWorkflowExecutionCmdlet : AmazonImagebuilderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse, GetEC2IBWorkflowExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Imagebuilder.Model.GetWorkflowExecutionRequest();
        ...
        private Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse CallAWSServiceOperation(IAmazonImagebuilder client, Amazon.Imagebuilder.Model.GetWorkflowExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EC2 Image Builder", "GetWorkflowExecution");
            try
            {
                #if DESKTOP
                return client.GetWorkflowExecution(request);
                #elif CORECLR
                return client.GetWorkflowExecutionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WorkflowExecutionId { get; set; }
            public System.Func<Amazon.Imagebuilder.Model.GetWorkflowExecutionResponse, GetEC2IBWorkflowExecutionCmdlet, object> Select { get; set; } =
