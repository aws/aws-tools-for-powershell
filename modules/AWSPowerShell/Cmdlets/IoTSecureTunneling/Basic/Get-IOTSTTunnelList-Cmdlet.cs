...
namespace Amazon.PowerShell.Cmdlets.IOTST
{
    ...
    public partial class GetIOTSTTunnelListCmdlet : AmazonIoTSecureTunnelingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TunnelSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSecureTunneling.Model.ListTunnelsResponse, GetIOTSTTunnelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTSecureTunneling.Model.ListTunnelsRequest();
        ...
        private Amazon.IoTSecureTunneling.Model.ListTunnelsResponse CallAWSServiceOperation(IAmazonIoTSecureTunneling client, Amazon.IoTSecureTunneling.Model.ListTunnelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Secure Tunneling", "ListTunnels");
            try
            {
                #if DESKTOP
                return client.ListTunnels(request);
                #elif CORECLR
                return client.ListTunnelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ThingName { get; set; }
            public System.Func<Amazon.IoTSecureTunneling.Model.ListTunnelsResponse, GetIOTSTTunnelListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TunnelSummaries;
        }
