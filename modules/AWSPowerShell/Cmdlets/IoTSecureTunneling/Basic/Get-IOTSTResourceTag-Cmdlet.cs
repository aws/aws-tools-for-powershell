...
namespace Amazon.PowerShell.Cmdlets.IOTST
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTSTResourceTag")]
    [OutputType("Amazon.IoTSecureTunneling.Model.Tag")]
    ...
    public partial class GetIOTSTResourceTagCmdlet : AmazonIoTSecureTunnelingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSecureTunneling.Model.ListTagsForResourceResponse, GetIOTSTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSecureTunneling.Model.ListTagsForResourceRequest();
        ...
        private Amazon.IoTSecureTunneling.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonIoTSecureTunneling client, Amazon.IoTSecureTunneling.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Secure Tunneling", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.IoTSecureTunneling.Model.ListTagsForResourceResponse, GetIOTSTResourceTagCmdlet, object> Select { get; set; } =
