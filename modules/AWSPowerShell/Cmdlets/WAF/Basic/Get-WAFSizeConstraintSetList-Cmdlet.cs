...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF ListSizeConstraintSets API operation.", Operation = new[] {"ListSizeConstraintSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListSizeConstraintSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.SizeConstraintSetSummary or Amazon.WAF.Model.ListSizeConstraintSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.SizeConstraintSetSummary objects.",
    ...
    public partial class GetWAFSizeConstraintSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListSizeConstraintSetsResponse, GetWAFSizeConstraintSetListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListSizeConstraintSetsResponse, GetWAFSizeConstraintSetListCmdlet, object> Select { get; set; } =
