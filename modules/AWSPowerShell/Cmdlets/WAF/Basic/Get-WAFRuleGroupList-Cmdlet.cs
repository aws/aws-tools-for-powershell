...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRuleGroupList")]
    [OutputType("Amazon.WAF.Model.RuleGroupSummary")]
    [AWSCmdlet("Calls the AWS WAF ListRuleGroups API operation.", Operation = new[] {"ListRuleGroups"}, SelectReturnType = typeof(Amazon.WAF.Model.ListRuleGroupsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.RuleGroupSummary or Amazon.WAF.Model.ListRuleGroupsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.RuleGroupSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListRuleGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRuleGroupListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListRuleGroupsResponse, GetWAFRuleGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListRuleGroupsRequest();
        ...
        private Amazon.WAF.Model.ListRuleGroupsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListRuleGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListRuleGroups");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListRuleGroupsResponse, GetWAFRuleGroupListCmdlet, object> Select { get; set; } =
