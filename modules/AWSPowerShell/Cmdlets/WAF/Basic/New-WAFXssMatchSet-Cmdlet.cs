...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF CreateXssMatchSet API operation.", Operation = new[] {"CreateXssMatchSet"}, SelectReturnType = typeof(Amazon.WAF.Model.CreateXssMatchSetResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.CreateXssMatchSetResponse",
        "This cmdlet returns an Amazon.WAF.Model.CreateXssMatchSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWAFXssMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFXssMatchSet (CreateXssMatchSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.CreateXssMatchSetResponse, NewWAFXssMatchSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.CreateXssMatchSetRequest();
        ...
        private Amazon.WAF.Model.CreateXssMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.CreateXssMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "CreateXssMatchSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.WAF.Model.CreateXssMatchSetResponse, NewWAFXssMatchSetCmdlet, object> Select { get; set; } =
