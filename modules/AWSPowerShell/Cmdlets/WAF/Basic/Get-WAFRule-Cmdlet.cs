...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF GetRule API operation.", Operation = new[] {"GetRule"}, SelectReturnType = typeof(Amazon.WAF.Model.GetRuleResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.Rule or Amazon.WAF.Model.GetRuleResponse",
        "This cmdlet returns an Amazon.WAF.Model.Rule object.",
        "The service call response (type Amazon.WAF.Model.GetRuleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRuleCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.GetRuleResponse, GetWAFRuleCmdlet>(Select) ??
        ...
        private Amazon.WAF.Model.GetRuleResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.GetRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "GetRule");
            try
            {
                #if DESKTOP
                return client.GetRule(request);
                #elif CORECLR
                return client.GetRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RuleId { get; set; }
            public System.Func<Amazon.WAF.Model.GetRuleResponse, GetWAFRuleCmdlet, object> Select { get; set; } =
