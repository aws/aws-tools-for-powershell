...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFGeoMatchSetList")]
    [OutputType("Amazon.WAF.Model.GeoMatchSetSummary")]
    [AWSCmdlet("Calls the AWS WAF ListGeoMatchSets API operation.", Operation = new[] {"ListGeoMatchSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListGeoMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.GeoMatchSetSummary or Amazon.WAF.Model.ListGeoMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.GeoMatchSetSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListGeoMatchSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFGeoMatchSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListGeoMatchSetsResponse, GetWAFGeoMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListGeoMatchSetsRequest();
        ...
        private Amazon.WAF.Model.ListGeoMatchSetsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListGeoMatchSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListGeoMatchSets");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListGeoMatchSetsResponse, GetWAFGeoMatchSetListCmdlet, object> Select { get; set; } =
