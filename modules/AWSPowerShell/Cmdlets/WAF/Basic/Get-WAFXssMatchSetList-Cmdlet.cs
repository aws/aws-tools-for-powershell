...
{
    /// <summary>
    /// Returns an array of <a>XssMatchSet</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFXssMatchSetList")]
    [OutputType("Amazon.WAF.Model.XssMatchSetSummary")]
    [AWSCmdlet("Calls the AWS WAF ListXssMatchSets API operation.", Operation = new[] {"ListXssMatchSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListXssMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.XssMatchSetSummary or Amazon.WAF.Model.ListXssMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.XssMatchSetSummary objects.",
    ...
    public partial class GetWAFXssMatchSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "XssMatchSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListXssMatchSetsResponse, GetWAFXssMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListXssMatchSetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.XssMatchSets.Count;
        ...
        private Amazon.WAF.Model.ListXssMatchSetsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListXssMatchSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListXssMatchSets");
            try
            {
                #if DESKTOP
                return client.ListXssMatchSets(request);
                #elif CORECLR
                return client.ListXssMatchSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListXssMatchSetsResponse, GetWAFXssMatchSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.XssMatchSets;
        }
