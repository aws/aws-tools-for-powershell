...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    public partial class RemoveWAFRuleGroupCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFRuleGroup (DeleteRuleGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.DeleteRuleGroupResponse, RemoveWAFRuleGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.DeleteRuleGroupRequest();
        ...
        private Amazon.WAF.Model.DeleteRuleGroupResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteRuleGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "DeleteRuleGroup");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RuleGroupId { get; set; }
            public System.Func<Amazon.WAF.Model.DeleteRuleGroupResponse, RemoveWAFRuleGroupCmdlet, object> Select { get; set; } =
