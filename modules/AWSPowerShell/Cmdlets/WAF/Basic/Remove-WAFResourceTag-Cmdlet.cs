...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "WAFResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWAFResourceTagCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.UntagResourceResponse, RemoveWAFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.UntagResourceRequest();
        ...
        private Amazon.WAF.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WAF.Model.UntagResourceResponse, RemoveWAFResourceTagCmdlet, object> Select { get; set; } =
