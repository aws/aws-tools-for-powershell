...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF DeleteRegexMatchSet API operation.", Operation = new[] {"DeleteRegexMatchSet"}, SelectReturnType = typeof(Amazon.WAF.Model.DeleteRegexMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.DeleteRegexMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAF.Model.DeleteRegexMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRegexMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.DeleteRegexMatchSetResponse, RemoveWAFRegexMatchSetCmdlet>(Select) ??
        ...
        private Amazon.WAF.Model.DeleteRegexMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteRegexMatchSetRequest request)
        {
            ...
            try
            {
                return client.DeleteRegexMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexMatchSetId { get; set; }
            public System.Func<Amazon.WAF.Model.DeleteRegexMatchSetResponse, RemoveWAFRegexMatchSetCmdlet, object> Select { get; set; } =
