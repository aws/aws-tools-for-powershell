...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "WAFResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddWAFResourceTagCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WAFResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.TagResourceResponse, AddWAFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.TagResourceRequest();
        ...
        private Amazon.WAF.Model.TagResourceResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WAF.Model.TagResourceResponse, AddWAFResourceTagCmdlet, object> Select { get; set; } =
