...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF GetIPSet API operation.", Operation = new[] {"GetIPSet"}, SelectReturnType = typeof(Amazon.WAF.Model.GetIPSetResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.IPSet or Amazon.WAF.Model.GetIPSetResponse",
        "This cmdlet returns an Amazon.WAF.Model.IPSet object.",
        "The service call response (type Amazon.WAF.Model.GetIPSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFIPSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.GetIPSetResponse, GetWAFIPSetCmdlet>(Select) ??
        ...
        private Amazon.WAF.Model.GetIPSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.GetIPSetRequest request)
        {
            ...
            try
            {
                return client.GetIPSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String IPSetId { get; set; }
            public System.Func<Amazon.WAF.Model.GetIPSetResponse, GetWAFIPSetCmdlet, object> Select { get; set; } =
