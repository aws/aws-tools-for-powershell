...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF ListSubscribedRuleGroups API operation.", Operation = new[] {"ListSubscribedRuleGroups"}, SelectReturnType = typeof(Amazon.WAF.Model.ListSubscribedRuleGroupsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.SubscribedRuleGroupSummary or Amazon.WAF.Model.ListSubscribedRuleGroupsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.SubscribedRuleGroupSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListSubscribedRuleGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFSubscribedRuleGroupListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListSubscribedRuleGroupsResponse, GetWAFSubscribedRuleGroupListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListSubscribedRuleGroupsResponse, GetWAFSubscribedRuleGroupListCmdlet, object> Select { get; set; } =
