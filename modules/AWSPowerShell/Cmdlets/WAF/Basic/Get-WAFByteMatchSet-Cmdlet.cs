...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [OutputType("Amazon.WAF.Model.ByteMatchSet")]
    ...
    public partial class GetWAFByteMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.GetByteMatchSetResponse, GetWAFByteMatchSetCmdlet>(Select) ??
        ...
        private Amazon.WAF.Model.GetByteMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.GetByteMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "GetByteMatchSet");
            try
            {
                return client.GetByteMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ByteMatchSetId { get; set; }
            public System.Func<Amazon.WAF.Model.GetByteMatchSetResponse, GetWAFByteMatchSetCmdlet, object> Select { get; set; } =
