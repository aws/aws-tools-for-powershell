...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// 10,000 addresses with the highest rates will be blocked.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRateBasedRuleManagedKey")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS WAF GetRateBasedRuleManagedKeys API operation.", Operation = new[] {"GetRateBasedRuleManagedKeys"}, SelectReturnType = typeof(Amazon.WAF.Model.GetRateBasedRuleManagedKeysResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.GetRateBasedRuleManagedKeysResponse",
    ...
    public partial class GetWAFRateBasedRuleManagedKeyCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.GetRateBasedRuleManagedKeysResponse, GetWAFRateBasedRuleManagedKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.GetRateBasedRuleManagedKeysRequest();
        ...
        private Amazon.WAF.Model.GetRateBasedRuleManagedKeysResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.GetRateBasedRuleManagedKeysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "GetRateBasedRuleManagedKeys");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextMarker { get; set; }
            public System.String RuleId { get; set; }
            public System.Func<Amazon.WAF.Model.GetRateBasedRuleManagedKeysResponse, GetWAFRateBasedRuleManagedKeyCmdlet, object> Select { get; set; } =
