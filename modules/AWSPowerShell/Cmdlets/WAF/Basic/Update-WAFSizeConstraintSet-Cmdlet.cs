...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF UpdateSizeConstraintSet API operation.", Operation = new[] {"UpdateSizeConstraintSet"}, SelectReturnType = typeof(Amazon.WAF.Model.UpdateSizeConstraintSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.UpdateSizeConstraintSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAF.Model.UpdateSizeConstraintSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFSizeConstraintSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.UpdateSizeConstraintSetResponse, UpdateWAFSizeConstraintSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAF.Model.SizeConstraintSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String SizeConstraintSetId { get; set; }
            public List<Amazon.WAF.Model.SizeConstraintSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAF.Model.UpdateSizeConstraintSetResponse, UpdateWAFSizeConstraintSetCmdlet, object> Select { get; set; } =
