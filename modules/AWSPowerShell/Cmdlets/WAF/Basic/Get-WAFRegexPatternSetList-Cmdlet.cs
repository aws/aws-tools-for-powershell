...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF ListRegexPatternSets API operation.", Operation = new[] {"ListRegexPatternSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListRegexPatternSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.RegexPatternSetSummary or Amazon.WAF.Model.ListRegexPatternSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.RegexPatternSetSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListRegexPatternSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRegexPatternSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListRegexPatternSetsResponse, GetWAFRegexPatternSetListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListRegexPatternSetsResponse, GetWAFRegexPatternSetListCmdlet, object> Select { get; set; } =
