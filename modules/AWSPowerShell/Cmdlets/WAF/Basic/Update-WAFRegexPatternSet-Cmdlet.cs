...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF UpdateRegexPatternSet API operation.", Operation = new[] {"UpdateRegexPatternSet"}, SelectReturnType = typeof(Amazon.WAF.Model.UpdateRegexPatternSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.UpdateRegexPatternSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAF.Model.UpdateRegexPatternSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFRegexPatternSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.UpdateRegexPatternSetResponse, UpdateWAFRegexPatternSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAF.Model.RegexPatternSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexPatternSetId { get; set; }
            public List<Amazon.WAF.Model.RegexPatternSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAF.Model.UpdateRegexPatternSetResponse, UpdateWAFRegexPatternSetCmdlet, object> Select { get; set; } =
