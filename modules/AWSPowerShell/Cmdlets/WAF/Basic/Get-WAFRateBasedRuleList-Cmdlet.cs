...
{
    /// <summary>
    /// Returns an array of <a>RuleSummary</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRateBasedRuleList")]
    [OutputType("Amazon.WAF.Model.RuleSummary")]
    [AWSCmdlet("Calls the AWS WAF ListRateBasedRules API operation.", Operation = new[] {"ListRateBasedRules"}, SelectReturnType = typeof(Amazon.WAF.Model.ListRateBasedRulesResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.RuleSummary or Amazon.WAF.Model.ListRateBasedRulesResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.RuleSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListRateBasedRulesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRateBasedRuleListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListRateBasedRulesResponse, GetWAFRateBasedRuleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListRateBasedRulesRequest();
        ...
        private Amazon.WAF.Model.ListRateBasedRulesResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListRateBasedRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListRateBasedRules");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListRateBasedRulesResponse, GetWAFRateBasedRuleListCmdlet, object> Select { get; set; } =
