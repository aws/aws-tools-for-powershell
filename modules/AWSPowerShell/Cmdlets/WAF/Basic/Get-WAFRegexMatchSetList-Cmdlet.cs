...
{
    /// <summary>
    /// Returns an array of <a>RegexMatchSetSummary</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRegexMatchSetList")]
    [OutputType("Amazon.WAF.Model.RegexMatchSetSummary")]
    [AWSCmdlet("Calls the AWS WAF ListRegexMatchSets API operation.", Operation = new[] {"ListRegexMatchSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListRegexMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.RegexMatchSetSummary or Amazon.WAF.Model.ListRegexMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.RegexMatchSetSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListRegexMatchSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRegexMatchSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RegexMatchSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListRegexMatchSetsResponse, GetWAFRegexMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListRegexMatchSetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RegexMatchSets.Count;
        ...
        private Amazon.WAF.Model.ListRegexMatchSetsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListRegexMatchSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListRegexMatchSets");
            try
            {
                #if DESKTOP
                return client.ListRegexMatchSets(request);
                #elif CORECLR
                return client.ListRegexMatchSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListRegexMatchSetsResponse, GetWAFRegexMatchSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RegexMatchSets;
        }
