...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF UpdateSqlInjectionMatchSet API operation.", Operation = new[] {"UpdateSqlInjectionMatchSet"}, SelectReturnType = typeof(Amazon.WAF.Model.UpdateSqlInjectionMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.UpdateSqlInjectionMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAF.Model.UpdateSqlInjectionMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFSqlInjectionMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// data types:</para><ul><li><para><a>SqlInjectionMatchSetUpdate</a>: Contains <c>Action</c> and <c>SqlInjectionMatchTuple</c></para></li><li><para><a>SqlInjectionMatchTuple</a>: Contains <c>FieldToMatch</c> and <c>TextTransformation</c></para></li><li><para><a>FieldToMatch</a>: Contains <c>Data</c> and <c>Type</c></para></li></ul><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.UpdateSqlInjectionMatchSetResponse, UpdateWAFSqlInjectionMatchSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAF.Model.SqlInjectionMatchSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String SqlInjectionMatchSetId { get; set; }
            public List<Amazon.WAF.Model.SqlInjectionMatchSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAF.Model.UpdateSqlInjectionMatchSetResponse, UpdateWAFSqlInjectionMatchSetCmdlet, object> Select { get; set; } =
