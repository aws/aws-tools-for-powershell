...
{
    /// <summary>
    /// Returns an array of <a>SqlInjectionMatchSet</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFSqlInjectionMatchSetList")]
    [OutputType("Amazon.WAF.Model.SqlInjectionMatchSetSummary")]
    [AWSCmdlet("Calls the AWS WAF ListSqlInjectionMatchSets API operation.", Operation = new[] {"ListSqlInjectionMatchSets"}, SelectReturnType = typeof(Amazon.WAF.Model.ListSqlInjectionMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.SqlInjectionMatchSetSummary or Amazon.WAF.Model.ListSqlInjectionMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.SqlInjectionMatchSetSummary objects.",
    ...
    public partial class GetWAFSqlInjectionMatchSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SqlInjectionMatchSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListSqlInjectionMatchSetsResponse, GetWAFSqlInjectionMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListSqlInjectionMatchSetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SqlInjectionMatchSets.Count;
        ...
        private Amazon.WAF.Model.ListSqlInjectionMatchSetsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListSqlInjectionMatchSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListSqlInjectionMatchSets");
            try
            {
                #if DESKTOP
                return client.ListSqlInjectionMatchSets(request);
                #elif CORECLR
                return client.ListSqlInjectionMatchSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListSqlInjectionMatchSetsResponse, GetWAFSqlInjectionMatchSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SqlInjectionMatchSets;
        }
