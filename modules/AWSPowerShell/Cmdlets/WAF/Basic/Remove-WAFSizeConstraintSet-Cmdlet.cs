...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    public partial class RemoveWAFSizeConstraintSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFSizeConstraintSet (DeleteSizeConstraintSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.DeleteSizeConstraintSetResponse, RemoveWAFSizeConstraintSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.DeleteSizeConstraintSetRequest();
        ...
        private Amazon.WAF.Model.DeleteSizeConstraintSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteSizeConstraintSetRequest request)
        {
            ...
            try
            {
                return client.DeleteSizeConstraintSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String SizeConstraintSetId { get; set; }
            public System.Func<Amazon.WAF.Model.DeleteSizeConstraintSetResponse, RemoveWAFSizeConstraintSetCmdlet, object> Select { get; set; } =
