...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    public partial class UpdateWAFIPSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// an <a>IPSet</a>. For more information, see the applicable data types:</para><ul><li><para><a>IPSetUpdate</a>: Contains <c>Action</c> and <c>IPSetDescriptor</c></para></li><li><para><a>IPSetDescriptor</a>: Contains <c>Type</c> and <c>Value</c></para></li></ul><para>You can insert a maximum of 1000 addresses in a single request.</para><para />
