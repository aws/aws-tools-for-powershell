...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdletOutput("Amazon.WAF.Model.WebACLSummary or Amazon.WAF.Model.ListWebACLsResponse",
        ...
        "The service call response (type Amazon.WAF.Model.ListWebACLsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFWebACLListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WebACLs?.Count ?? 0;
        ...
        private Amazon.WAF.Model.ListWebACLsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListWebACLsRequest request)
        {
            ...
            try
            {
                return client.ListWebACLsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
