...
{
    /// <summary>
    /// Returns an array of <a>WebACLSummary</a> objects in the response.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFWebACLList")]
    [OutputType("Amazon.WAF.Model.WebACLSummary")]
    [AWSCmdlet("Calls the AWS WAF ListWebACLs API operation.", Operation = new[] {"ListWebACLs"}, SelectReturnType = typeof(Amazon.WAF.Model.ListWebACLsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.WebACLSummary or Amazon.WAF.Model.ListWebACLsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.WebACLSummary objects.",
    ...
    public partial class GetWAFWebACLListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListWebACLsResponse, GetWAFWebACLListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListWebACLsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WebACLs.Count;
        ...
        private Amazon.WAF.Model.ListWebACLsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListWebACLsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListWebACLs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListWebACLsResponse, GetWAFWebACLListCmdlet, object> Select { get; set; } =
