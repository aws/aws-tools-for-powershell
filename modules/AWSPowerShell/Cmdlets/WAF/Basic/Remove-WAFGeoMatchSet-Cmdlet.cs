...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF DeleteGeoMatchSet API operation.", Operation = new[] {"DeleteGeoMatchSet"}, SelectReturnType = typeof(Amazon.WAF.Model.DeleteGeoMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAF.Model.DeleteGeoMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAF.Model.DeleteGeoMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFGeoMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.DeleteGeoMatchSetResponse, RemoveWAFGeoMatchSetCmdlet>(Select) ??
        ...
        private Amazon.WAF.Model.DeleteGeoMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteGeoMatchSetRequest request)
        {
            ...
            try
            {
                return client.DeleteGeoMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String GeoMatchSetId { get; set; }
            public System.Func<Amazon.WAF.Model.DeleteGeoMatchSetResponse, RemoveWAFGeoMatchSetCmdlet, object> Select { get; set; } =
