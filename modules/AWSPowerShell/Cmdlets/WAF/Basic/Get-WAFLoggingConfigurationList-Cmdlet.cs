...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdletOutput("Amazon.WAF.Model.LoggingConfiguration or Amazon.WAF.Model.ListLoggingConfigurationsResponse",
        ...
        "The service call response (type Amazon.WAF.Model.ListLoggingConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.LoggingConfigurations?.Count ?? 0;
