...
{
    /// <summary>
    /// Returns an array of <a>LoggingConfiguration</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFLoggingConfigurationList")]
    [OutputType("Amazon.WAF.Model.LoggingConfiguration")]
    [AWSCmdlet("Calls the AWS WAF ListLoggingConfigurations API operation.", Operation = new[] {"ListLoggingConfigurations"}, SelectReturnType = typeof(Amazon.WAF.Model.ListLoggingConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.WAF.Model.LoggingConfiguration or Amazon.WAF.Model.ListLoggingConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.WAF.Model.LoggingConfiguration objects.",
    ...
    public partial class GetWAFLoggingConfigurationListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAF.Model.ListLoggingConfigurationsResponse, GetWAFLoggingConfigurationListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAF.Model.ListLoggingConfigurationsResponse, GetWAFLoggingConfigurationListCmdlet, object> Select { get; set; } =
