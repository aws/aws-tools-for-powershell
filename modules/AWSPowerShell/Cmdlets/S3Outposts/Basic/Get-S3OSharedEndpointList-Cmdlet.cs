...
namespace Amazon.PowerShell.Cmdlets.S3O
{
    ...
    /// </summary>
    [Cmdlet("Get", "S3OSharedEndpointList")]
    ...
    public partial class GetS3OSharedEndpointListCmdlet : AmazonS3OutpostsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Outposts.Model.ListSharedEndpointsResponse, GetS3OSharedEndpointListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Outposts.Model.ListSharedEndpointsRequest();
        ...
        private Amazon.S3Outposts.Model.ListSharedEndpointsResponse CallAWSServiceOperation(IAmazonS3Outposts client, Amazon.S3Outposts.Model.ListSharedEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Outposts", "ListSharedEndpoints");
            try
            {
                #if DESKTOP
                return client.ListSharedEndpoints(request);
                #elif CORECLR
                return client.ListSharedEndpointsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OutpostId { get; set; }
            public System.Func<Amazon.S3Outposts.Model.ListSharedEndpointsResponse, GetS3OSharedEndpointListCmdlet, object> Select { get; set; } =
