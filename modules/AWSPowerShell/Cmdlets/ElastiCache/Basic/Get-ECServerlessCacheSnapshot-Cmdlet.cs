...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    public partial class GetECServerlessCacheSnapshotCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// only this snapshot is described. Available for Redis only.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The type of snapshot that is being described. Available for Redis only.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// results can be retrieved. Available for Redis only.The default is 50. The Validation
        /// Constraints are a maximum of 50.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// beyond the marker, up to the value specified by max-results. Available for Redis only.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
