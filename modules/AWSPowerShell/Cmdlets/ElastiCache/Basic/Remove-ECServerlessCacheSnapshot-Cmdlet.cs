...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    public partial class RemoveECServerlessCacheSnapshotCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Idenfitier of the snapshot to be deleted. Available for Redis only.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotResponse).
        /// Specifying the name of a property of type Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ECServerlessCacheSnapshot (DeleteServerlessCacheSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotResponse, RemoveECServerlessCacheSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotRequest();
        ...
        private Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ElastiCache", "DeleteServerlessCacheSnapshot");
            try
            {
                #if DESKTOP
                return client.DeleteServerlessCacheSnapshot(request);
                #elif CORECLR
                return client.DeleteServerlessCacheSnapshotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ServerlessCacheSnapshotName { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DeleteServerlessCacheSnapshotResponse, RemoveECServerlessCacheSnapshotCmdlet, object> Select { get; set; } =
