...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdlet("Calls the Amazon ElastiCache DescribeCacheParameterGroups API operation.", Operation = new[] {"DescribeCacheParameterGroups"}, SelectReturnType = typeof(Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse))]
    [AWSCmdletOutput("Amazon.ElastiCache.Model.CacheParameterGroup or Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse",
        "This cmdlet returns a collection of Amazon.ElastiCache.Model.CacheParameterGroup objects.",
        "The service call response (type Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetECCacheParameterGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CacheParameterGroups";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CacheParameterGroupName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse, GetECCacheParameterGroupCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.CacheParameterGroupName;
            }
        ...
        private Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DescribeCacheParameterGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ElastiCache", "DescribeCacheParameterGroups");
            try
            {
                #if DESKTOP
                return client.DescribeCacheParameterGroups(request);
                #elif CORECLR
                return client.DescribeCacheParameterGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DescribeCacheParameterGroupsResponse, GetECCacheParameterGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CacheParameterGroups;
        }
