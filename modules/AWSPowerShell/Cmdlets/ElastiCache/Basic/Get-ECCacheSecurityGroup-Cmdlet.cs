...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdlet("Calls the Amazon ElastiCache DescribeCacheSecurityGroups API operation.", Operation = new[] {"DescribeCacheSecurityGroups"}, SelectReturnType = typeof(Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse))]
    [AWSCmdletOutput("Amazon.ElastiCache.Model.CacheSecurityGroup or Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse",
        "This cmdlet returns a collection of Amazon.ElastiCache.Model.CacheSecurityGroup objects.",
        "The service call response (type Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetECCacheSecurityGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CacheSecurityGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse, GetECCacheSecurityGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.CacheSecurityGroups?.Count ?? 0;
        ...
        private Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsRequest request)
        {
            ...
            try
            {
                return client.DescribeCacheSecurityGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DescribeCacheSecurityGroupsResponse, GetECCacheSecurityGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CacheSecurityGroups;
        }
