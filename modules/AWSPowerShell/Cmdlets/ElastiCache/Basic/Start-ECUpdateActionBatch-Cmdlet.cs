...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdletOutput("Amazon.ElastiCache.Model.BatchApplyUpdateActionResponse",
        "This cmdlet returns an Amazon.ElastiCache.Model.BatchApplyUpdateActionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
