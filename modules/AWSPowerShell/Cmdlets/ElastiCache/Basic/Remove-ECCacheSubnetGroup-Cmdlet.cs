...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon ElastiCache DeleteCacheSubnetGroup API operation.", Operation = new[] {"DeleteCacheSubnetGroup"}, SelectReturnType = typeof(Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse))]
    [AWSCmdletOutput("None or Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveECCacheSubnetGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse, RemoveECCacheSubnetGroupCmdlet>(Select) ??
        ...
        private Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DeleteCacheSubnetGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteCacheSubnetGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String CacheSubnetGroupName { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DeleteCacheSubnetGroupResponse, RemoveECCacheSubnetGroupCmdlet, object> Select { get; set; } =
