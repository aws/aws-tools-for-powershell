...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdletOutput("Amazon.ElastiCache.Model.GlobalReplicationGroup or Amazon.ElastiCache.Model.DescribeGlobalReplicationGroupsResponse",
        ...
        "The service call response (type Amazon.ElastiCache.Model.DescribeGlobalReplicationGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
