...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    public partial class GetECCacheEngineVersionCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// | <code>redis5.0</code> | <code>redis6.x</code> | </para><para>Constraints:</para><ul><li><para>Must be 1 to 255 alphanumeric characters</para></li><li><para>First character must be a letter</para></li><li><para>Cannot end with a hyphen or contain two consecutive hyphens</para></li></ul>
        /// </para>
        /// </summary>
