...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdlet("Calls the Amazon ElastiCache DescribeCacheSubnetGroups API operation.", Operation = new[] {"DescribeCacheSubnetGroups"}, SelectReturnType = typeof(Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse), LegacyAlias="Get-ECCacheSubnetGroups")]
    [AWSCmdletOutput("Amazon.ElastiCache.Model.CacheSubnetGroup or Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse",
        "This cmdlet returns a collection of Amazon.ElastiCache.Model.CacheSubnetGroup objects.",
        "The service call response (type Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetECCacheSubnetGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CacheSubnetGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse, GetECCacheSubnetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.CacheSubnetGroups?.Count ?? 0;
        ...
        private Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsRequest request)
        {
            ...
            try
            {
                return client.DescribeCacheSubnetGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse, GetECCacheSubnetGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CacheSubnetGroups;
        }
