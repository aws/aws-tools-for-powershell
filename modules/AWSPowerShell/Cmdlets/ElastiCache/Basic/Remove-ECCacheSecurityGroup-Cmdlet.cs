...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    public partial class RemoveECCacheSecurityGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DeleteCacheSecurityGroupResponse, RemoveECCacheSecurityGroupCmdlet>(Select) ??
        ...
        private Amazon.ElastiCache.Model.DeleteCacheSecurityGroupResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DeleteCacheSecurityGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteCacheSecurityGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String CacheSecurityGroupName { get; set; }
            public System.Func<Amazon.ElastiCache.Model.DeleteCacheSecurityGroupResponse, RemoveECCacheSecurityGroupCmdlet, object> Select { get; set; } =
