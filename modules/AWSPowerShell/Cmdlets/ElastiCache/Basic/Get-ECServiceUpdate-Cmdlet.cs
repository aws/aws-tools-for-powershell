...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ECServiceUpdate")]
    [OutputType("Amazon.ElastiCache.Model.ServiceUpdate")]
    [AWSCmdlet("Calls the Amazon ElastiCache DescribeServiceUpdates API operation.", Operation = new[] {"DescribeServiceUpdates"}, SelectReturnType = typeof(Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse))]
    [AWSCmdletOutput("Amazon.ElastiCache.Model.ServiceUpdate or Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse",
        "This cmdlet returns a collection of Amazon.ElastiCache.Model.ServiceUpdate objects.",
        "The service call response (type Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetECServiceUpdateCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse, GetECServiceUpdateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ElastiCache.Model.DescribeServiceUpdatesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ServiceUpdates?.Count ?? 0;
        ...
        private Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DescribeServiceUpdatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ElastiCache", "DescribeServiceUpdates");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ElastiCache.Model.DescribeServiceUpdatesResponse, GetECServiceUpdateCmdlet, object> Select { get; set; } =
