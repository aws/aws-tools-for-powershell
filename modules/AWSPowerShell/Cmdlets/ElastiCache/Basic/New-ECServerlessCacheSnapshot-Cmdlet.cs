...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdletOutput("Amazon.ElastiCache.Model.ServerlessCacheSnapshot or Amazon.ElastiCache.Model.CreateServerlessCacheSnapshotResponse",
        ...
        "The service call response (type Amazon.ElastiCache.Model.CreateServerlessCacheSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewECServerlessCacheSnapshotCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the KMS key used to encrypt the snapshot. Available for Redis only. Default:
        /// NULL</para>
        /// </para>
        /// </summary>
        ...
        /// Available for Redis only. Must be between 1 and 255 characters.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.ElastiCache.Model.CreateServerlessCacheSnapshotResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.CreateServerlessCacheSnapshotRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateServerlessCacheSnapshot(request);
                #elif CORECLR
                return client.CreateServerlessCacheSnapshotAsync(request).GetAwaiter().GetResult();
                #else
