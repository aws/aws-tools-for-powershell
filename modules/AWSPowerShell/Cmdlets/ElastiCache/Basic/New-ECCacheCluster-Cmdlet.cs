...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    public partial class NewECCacheClusterCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        /// cache engine versions, use the DescribeCacheEngineVersions operation.</para><para><b>Important:</b> You can upgrade to a newer engine version (see <a href="https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/SelectEngine.html#VersionManagement">Selecting
        ...
        private Amazon.ElastiCache.Model.CreateCacheClusterResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.CreateCacheClusterRequest request)
        {
            ...
            try
            {
                return client.CreateCacheClusterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
