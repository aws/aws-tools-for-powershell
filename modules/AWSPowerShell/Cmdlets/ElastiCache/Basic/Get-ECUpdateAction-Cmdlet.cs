...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    [AWSCmdletOutput("Amazon.ElastiCache.Model.UpdateAction or Amazon.ElastiCache.Model.DescribeUpdateActionsResponse",
        ...
        "The service call response (type Amazon.ElastiCache.Model.DescribeUpdateActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
