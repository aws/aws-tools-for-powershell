...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Update", "IAMAAFinding", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer UpdateFindings API operation.", Operation = new[] {"UpdateFindings"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.UpdateFindingsResponse))]
    [AWSCmdletOutput("None or Amazon.AccessAnalyzer.Model.UpdateFindingsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AccessAnalyzer.Model.UpdateFindingsResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateIAMAAFindingCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the findings to update.</para><para />
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.AccessAnalyzer.FindingStatusUpdate")]
        public Amazon.AccessAnalyzer.FindingStatusUpdate Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IAMAAFinding (UpdateFindings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.UpdateFindingsResponse, UpdateIAMAAFindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AccessAnalyzer.Model.UpdateFindingsRequest();
        ...
        private Amazon.AccessAnalyzer.Model.UpdateFindingsResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.UpdateFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "UpdateFindings");
            try
            {
                return client.UpdateFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceArn { get; set; }
            public Amazon.AccessAnalyzer.FindingStatusUpdate Status { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.UpdateFindingsResponse, UpdateIAMAAFindingCmdlet, object> Select { get; set; } =
