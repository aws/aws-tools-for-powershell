...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAAAccessPreviewFindingList")]
    [OutputType("Amazon.AccessAnalyzer.Model.AccessPreviewFinding")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer ListAccessPreviewFindings API operation.", Operation = new[] {"ListAccessPreviewFindings"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse))]
    [AWSCmdletOutput("Amazon.AccessAnalyzer.Model.AccessPreviewFinding or Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse",
        "This cmdlet returns a collection of Amazon.AccessAnalyzer.Model.AccessPreviewFinding objects.",
        "The service call response (type Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMAAAccessPreviewFindingListCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse, GetIAMAAAccessPreviewFindingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsRequest();
        ...
        private Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.ListAccessPreviewFindingsResponse, GetIAMAAAccessPreviewFindingListCmdlet, object> Select { get; set; } =
