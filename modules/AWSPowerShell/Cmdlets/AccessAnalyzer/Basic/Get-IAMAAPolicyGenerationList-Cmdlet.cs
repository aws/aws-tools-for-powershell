...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAAPolicyGenerationList")]
    [OutputType("Amazon.AccessAnalyzer.Model.PolicyGeneration")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer ListPolicyGenerations API operation.", Operation = new[] {"ListPolicyGenerations"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse))]
    [AWSCmdletOutput("Amazon.AccessAnalyzer.Model.PolicyGeneration or Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse",
        "This cmdlet returns a collection of Amazon.AccessAnalyzer.Model.PolicyGeneration objects.",
        "The service call response (type Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMAAPolicyGenerationListCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse, GetIAMAAPolicyGenerationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AccessAnalyzer.Model.ListPolicyGenerationsRequest();
        ...
        private Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.ListPolicyGenerationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "ListPolicyGenerations");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PrincipalArn { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.ListPolicyGenerationsResponse, GetIAMAAPolicyGenerationListCmdlet, object> Select { get; set; } =
