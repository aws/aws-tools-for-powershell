...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAAFindingsV2List")]
    [OutputType("Amazon.AccessAnalyzer.Model.FindingSummaryV2")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer ListFindingsV2 API operation.", Operation = new[] {"ListFindingsV2"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.ListFindingsV2Response))]
    [AWSCmdletOutput("Amazon.AccessAnalyzer.Model.FindingSummaryV2 or Amazon.AccessAnalyzer.Model.ListFindingsV2Response",
        "This cmdlet returns a collection of Amazon.AccessAnalyzer.Model.FindingSummaryV2 objects.",
        "The service call response (type Amazon.AccessAnalyzer.Model.ListFindingsV2Response) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMAAFindingsV2ListCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AccessAnalyzer.Model.ListFindingsV2Response).
        /// Specifying the name of a property of type Amazon.AccessAnalyzer.Model.ListFindingsV2Response will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.ListFindingsV2Response, GetIAMAAFindingsV2ListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AccessAnalyzer.Model.ListFindingsV2Request();
        ...
        private Amazon.AccessAnalyzer.Model.ListFindingsV2Response CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.ListFindingsV2Request request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "ListFindingsV2");
            try
            {
                #if DESKTOP
                return client.ListFindingsV2(request);
                #elif CORECLR
                return client.ListFindingsV2Async(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Sort_AttributeName { get; set; }
            public Amazon.AccessAnalyzer.OrderBy Sort_OrderBy { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.ListFindingsV2Response, GetIAMAAFindingsV2ListCmdlet, object> Select { get; set; } =
