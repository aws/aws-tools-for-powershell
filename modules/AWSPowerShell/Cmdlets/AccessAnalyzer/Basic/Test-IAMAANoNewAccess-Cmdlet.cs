...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    public partial class TestIAMAANoNewAccessCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the NewPolicyDocument parameter.
        /// The -PassThru parameter is deprecated, use -Select '^NewPolicyDocument' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^NewPolicyDocument' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.NewPolicyDocument;
            }
