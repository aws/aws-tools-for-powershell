...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAAAccessPreviewList")]
    [OutputType("Amazon.AccessAnalyzer.Model.AccessPreviewSummary")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer ListAccessPreviews API operation.", Operation = new[] {"ListAccessPreviews"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse))]
    [AWSCmdletOutput("Amazon.AccessAnalyzer.Model.AccessPreviewSummary or Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse",
        "This cmdlet returns a collection of Amazon.AccessAnalyzer.Model.AccessPreviewSummary objects.",
        "The service call response (type Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMAAAccessPreviewListCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccessPreviews";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse, GetIAMAAAccessPreviewListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AccessAnalyzer.Model.ListAccessPreviewsRequest();
        ...
        private Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.ListAccessPreviewsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "ListAccessPreviews");
            try
            {
                #if DESKTOP
                return client.ListAccessPreviews(request);
                #elif CORECLR
                return client.ListAccessPreviewsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.ListAccessPreviewsResponse, GetIAMAAAccessPreviewListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccessPreviews;
        }
