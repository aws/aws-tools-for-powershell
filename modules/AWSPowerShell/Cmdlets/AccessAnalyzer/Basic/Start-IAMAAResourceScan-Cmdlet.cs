...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IAM Access Analyzer StartResourceScan API operation.", Operation = new[] {"StartResourceScan"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.StartResourceScanResponse))]
    [AWSCmdletOutput("None or Amazon.AccessAnalyzer.Model.StartResourceScanResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AccessAnalyzer.Model.StartResourceScanResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartIAMAAResourceScanCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-IAMAAResourceScan (StartResourceScan)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.StartResourceScanResponse, StartIAMAAResourceScanCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AccessAnalyzer.Model.StartResourceScanRequest();
        ...
        private Amazon.AccessAnalyzer.Model.StartResourceScanResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.StartResourceScanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "StartResourceScan");
            try
            {
                #if DESKTOP
