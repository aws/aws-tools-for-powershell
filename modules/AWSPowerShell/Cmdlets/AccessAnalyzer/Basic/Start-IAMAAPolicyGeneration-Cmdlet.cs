...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    public partial class StartIAMAAPolicyGenerationCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the service role that Access Analyzer uses to access your CloudTrail trail
        /// and service last accessed information.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The end of the time range for which Access Analyzer reviews your CloudTrail events.
        ...
        /// <summary>
        /// <para>
        /// <para>The start of the time range for which Access Analyzer reviews your CloudTrail events.
        /// Events with a timestamp before this time are not considered to generate a policy.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// request and they have no additional effect.</para><para>If you do not specify a client token, one is automatically generated by the AWS SDK.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
