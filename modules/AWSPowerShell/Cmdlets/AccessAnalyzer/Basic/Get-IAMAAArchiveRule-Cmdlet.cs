...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    [AWSCmdlet("Calls the AWS IAM Access Analyzer GetArchiveRule API operation.", Operation = new[] {"GetArchiveRule"}, SelectReturnType = typeof(Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse))]
    [AWSCmdletOutput("Amazon.AccessAnalyzer.Model.ArchiveRuleSummary or Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse",
        "This cmdlet returns an Amazon.AccessAnalyzer.Model.ArchiveRuleSummary object.",
        "The service call response (type Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMAAArchiveRuleCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ArchiveRule";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse, GetIAMAAArchiveRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AccessAnalyzer.Model.GetArchiveRuleRequest();
        ...
        private Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.GetArchiveRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "GetArchiveRule");
            try
            {
                #if DESKTOP
                return client.GetArchiveRule(request);
                #elif CORECLR
                return client.GetArchiveRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AnalyzerName { get; set; }
            public System.String RuleName { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.GetArchiveRuleResponse, GetIAMAAArchiveRuleCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ArchiveRule;
        }
