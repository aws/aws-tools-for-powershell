...
namespace Amazon.PowerShell.Cmdlets.IAMAA
{
    ...
    /// </summary>
    [Cmdlet("Stop", "IAMAAPolicyGeneration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopIAMAAPolicyGenerationCmdlet : AmazonAccessAnalyzerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-IAMAAPolicyGeneration (CancelPolicyGeneration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AccessAnalyzer.Model.CancelPolicyGenerationResponse, StopIAMAAPolicyGenerationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AccessAnalyzer.Model.CancelPolicyGenerationRequest();
        ...
        private Amazon.AccessAnalyzer.Model.CancelPolicyGenerationResponse CallAWSServiceOperation(IAmazonAccessAnalyzer client, Amazon.AccessAnalyzer.Model.CancelPolicyGenerationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IAM Access Analyzer", "CancelPolicyGeneration");
            try
            {
                #if DESKTOP
                return client.CancelPolicyGeneration(request);
                #elif CORECLR
                return client.CancelPolicyGenerationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.AccessAnalyzer.Model.CancelPolicyGenerationResponse, StopIAMAAPolicyGenerationCmdlet, object> Select { get; set; } =
