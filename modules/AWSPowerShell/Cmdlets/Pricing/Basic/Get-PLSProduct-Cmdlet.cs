...
namespace Amazon.PowerShell.Cmdlets.PLS
{
    ...
    [AWSCmdlet("Calls the AWS Price List Service GetProducts API operation.", Operation = new[] {"GetProducts"}, SelectReturnType = typeof(Amazon.Pricing.Model.GetProductsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Pricing.Model.GetProductsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Pricing.Model.GetProductsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPLSProductCmdlet : AmazonPricingClientCmdlet, IExecutor
    {
        ...
        /// filters are returned.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PriceList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pricing.Model.GetProductsResponse, GetPLSProductCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.Pricing.Model.Filter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.PriceList?.Count ?? 0;
        ...
        private Amazon.Pricing.Model.GetProductsResponse CallAWSServiceOperation(IAmazonPricing client, Amazon.Pricing.Model.GetProductsRequest request)
        {
            ...
            try
            {
                return client.GetProductsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.Pricing.Model.Filter> Filter { get; set; }
            public System.String FormatVersion { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.String ServiceCode { get; set; }
            public System.Func<Amazon.Pricing.Model.GetProductsResponse, GetPLSProductCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PriceList;
        }
