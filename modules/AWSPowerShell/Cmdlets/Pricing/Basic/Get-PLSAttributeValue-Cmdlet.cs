...
namespace Amazon.PowerShell.Cmdlets.PLS
{
    ...
    /// Billing and Cost Management User Guide</a>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetPLSAttributeValueCmdlet : AmazonPricingClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AttributeValues.Count;
        ...
        private Amazon.Pricing.Model.GetAttributeValuesResponse CallAWSServiceOperation(IAmazonPricing client, Amazon.Pricing.Model.GetAttributeValuesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetAttributeValues(request);
                #elif CORECLR
                return client.GetAttributeValuesAsync(request).GetAwaiter().GetResult();
                #else
