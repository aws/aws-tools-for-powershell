...
namespace Amazon.PowerShell.Cmdlets.PLS
{
    ...
    [AWSCmdlet("Calls the AWS Price List Service DescribeServices API operation.", Operation = new[] {"DescribeServices"}, SelectReturnType = typeof(Amazon.Pricing.Model.DescribeServicesResponse))]
    [AWSCmdletOutput("Amazon.Pricing.Model.Service or Amazon.Pricing.Model.DescribeServicesResponse",
        "This cmdlet returns a collection of Amazon.Pricing.Model.Service objects.",
        "The service call response (type Amazon.Pricing.Model.DescribeServicesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPLSServiceCmdlet : AmazonPricingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Pricing.Model.DescribeServicesResponse, GetPLSServiceCmdlet>(Select) ??
        ...
        private Amazon.Pricing.Model.DescribeServicesResponse CallAWSServiceOperation(IAmazonPricing client, Amazon.Pricing.Model.DescribeServicesRequest request)
        {
            ...
            try
            {
                return client.DescribeServicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServiceCode { get; set; }
            public System.Func<Amazon.Pricing.Model.DescribeServicesResponse, GetPLSServiceCmdlet, object> Select { get; set; } =
