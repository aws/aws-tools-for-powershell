...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EKSPodIdentityAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveEKSPodIdentityAssociationCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the association to be deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The cluster name that</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EKS.Model.DeletePodIdentityAssociationResponse).
        /// Specifying the name of a property of type Amazon.EKS.Model.DeletePodIdentityAssociationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EKSPodIdentityAssociation (DeletePodIdentityAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.DeletePodIdentityAssociationResponse, RemoveEKSPodIdentityAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.DeletePodIdentityAssociationRequest();
        ...
        private Amazon.EKS.Model.DeletePodIdentityAssociationResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.DeletePodIdentityAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "DeletePodIdentityAssociation");
            try
            {
                #if DESKTOP
                return client.DeletePodIdentityAssociation(request);
                #elif CORECLR
                return client.DeletePodIdentityAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssociationId { get; set; }
            public System.String ClusterName { get; set; }
            public System.Func<Amazon.EKS.Model.DeletePodIdentityAssociationResponse, RemoveEKSPodIdentityAssociationCmdlet, object> Select { get; set; } =
