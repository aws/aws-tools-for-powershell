...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    public partial class UnregisterEKSClusterCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-EKSCluster (DeregisterCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.DeregisterClusterResponse, UnregisterEKSClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.DeregisterClusterRequest();
        ...
        private Amazon.EKS.Model.DeregisterClusterResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.DeregisterClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "DeregisterCluster");
            try
            {
                #if DESKTOP
                return client.DeregisterCluster(request);
                #elif CORECLR
                return client.DeregisterClusterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.EKS.Model.DeregisterClusterResponse, UnregisterEKSClusterCmdlet, object> Select { get; set; } =
