...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    public partial class RemoveEKSAccessEntryCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EKS.Model.DeleteAccessEntryResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EKSAccessEntry (DeleteAccessEntry)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.DeleteAccessEntryResponse, RemoveEKSAccessEntryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.DeleteAccessEntryRequest();
        ...
        private Amazon.EKS.Model.DeleteAccessEntryResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.DeleteAccessEntryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "DeleteAccessEntry");
            try
            {
                #if DESKTOP
                return client.DeleteAccessEntry(request);
                #elif CORECLR
                return client.DeleteAccessEntryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClusterName { get; set; }
            public System.String PrincipalArn { get; set; }
            public System.Func<Amazon.EKS.Model.DeleteAccessEntryResponse, RemoveEKSAccessEntryCmdlet, object> Select { get; set; } =
