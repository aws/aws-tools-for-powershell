...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes ListUpdates API operation.", Operation = new[] {"ListUpdates"}, SelectReturnType = typeof(Amazon.EKS.Model.ListUpdatesResponse))]
    [AWSCmdletOutput("System.String or Amazon.EKS.Model.ListUpdatesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.EKS.Model.ListUpdatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEKSUpdateListCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "UpdateIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.ListUpdatesResponse, GetEKSUpdateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.UpdateIds?.Count ?? 0;
        ...
        private Amazon.EKS.Model.ListUpdatesResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.ListUpdatesRequest request)
        {
            ...
            try
            {
                return client.ListUpdatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
