...
{
    /// <summary>
    /// Lists the installed add-ons.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EKSAddonList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes ListAddons API operation.", Operation = new[] {"ListAddons"}, SelectReturnType = typeof(Amazon.EKS.Model.ListAddonsResponse))]
    [AWSCmdletOutput("System.String or Amazon.EKS.Model.ListAddonsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.EKS.Model.ListAddonsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEKSAddonListCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.ListAddonsResponse, GetEKSAddonListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EKS.Model.ListAddonsRequest();
        ...
        private Amazon.EKS.Model.ListAddonsResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.ListAddonsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "ListAddons");
            try
            {
                #if DESKTOP
                return client.ListAddons(request);
                #elif CORECLR
                return client.ListAddonsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EKS.Model.ListAddonsResponse, GetEKSAddonListCmdlet, object> Select { get; set; } =
