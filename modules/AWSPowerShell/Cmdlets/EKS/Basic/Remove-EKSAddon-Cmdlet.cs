...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    public partial class RemoveEKSAddonCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EKSAddon (DeleteAddon)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.DeleteAddonResponse, RemoveEKSAddonCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.DeleteAddonRequest();
        ...
        private Amazon.EKS.Model.DeleteAddonResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.DeleteAddonRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "DeleteAddon");
            try
            {
                #if DESKTOP
                return client.DeleteAddon(request);
                #elif CORECLR
                return client.DeleteAddonAsync(request).GetAwaiter().GetResult();
                #else
