...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    public partial class NewEKSClusterCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// add-ons will not be installed.</para><para>The default networking add-ons include <c>vpc-cni</c>, <c>coredns</c>, and <c>kube-proxy</c>.</para><para>Use this option when you plan to install third-party alternative add-ons or self-manage
