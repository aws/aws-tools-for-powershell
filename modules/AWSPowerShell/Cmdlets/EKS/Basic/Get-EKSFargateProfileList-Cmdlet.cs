...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes ListFargateProfiles API operation.", Operation = new[] {"ListFargateProfiles"}, SelectReturnType = typeof(Amazon.EKS.Model.ListFargateProfilesResponse))]
    [AWSCmdletOutput("System.String or Amazon.EKS.Model.ListFargateProfilesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.EKS.Model.ListFargateProfilesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEKSFargateProfileListCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FargateProfileNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.ListFargateProfilesResponse, GetEKSFargateProfileListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EKS.Model.ListFargateProfilesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FargateProfileNames?.Count ?? 0;
        ...
        private Amazon.EKS.Model.ListFargateProfilesResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.ListFargateProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "ListFargateProfiles");
            try
            {
                #if DESKTOP
                return client.ListFargateProfiles(request);
                #elif CORECLR
                return client.ListFargateProfilesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EKS.Model.ListFargateProfilesResponse, GetEKSFargateProfileListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FargateProfileNames;
        }
