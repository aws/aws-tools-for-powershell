...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    /// account in the specified Region.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EKSNodegroupList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes ListNodegroups API operation.", Operation = new[] {"ListNodegroups"}, SelectReturnType = typeof(Amazon.EKS.Model.ListNodegroupsResponse))]
    [AWSCmdletOutput("System.String or Amazon.EKS.Model.ListNodegroupsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.EKS.Model.ListNodegroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEKSNodegroupListCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Nodegroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.ListNodegroupsResponse, GetEKSNodegroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EKS.Model.ListNodegroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Nodegroups.Count;
        ...
        private Amazon.EKS.Model.ListNodegroupsResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.ListNodegroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "ListNodegroups");
            try
            {
                #if DESKTOP
                return client.ListNodegroups(request);
                #elif CORECLR
                return client.ListNodegroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EKS.Model.ListNodegroupsResponse, GetEKSNodegroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Nodegroups;
        }
