...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes DescribeFargateProfile API operation.", Operation = new[] {"DescribeFargateProfile"}, SelectReturnType = typeof(Amazon.EKS.Model.DescribeFargateProfileResponse))]
    [AWSCmdletOutput("Amazon.EKS.Model.FargateProfile or Amazon.EKS.Model.DescribeFargateProfileResponse",
        "This cmdlet returns an Amazon.EKS.Model.FargateProfile object.",
        "The service call response (type Amazon.EKS.Model.DescribeFargateProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEKSFargateProfileCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.DescribeFargateProfileResponse, GetEKSFargateProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.DescribeFargateProfileRequest();
        ...
        private Amazon.EKS.Model.DescribeFargateProfileResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.DescribeFargateProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "DescribeFargateProfile");
            try
            {
                #if DESKTOP
                return client.DescribeFargateProfile(request);
                #elif CORECLR
                return client.DescribeFargateProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClusterName { get; set; }
            public System.String FargateProfileName { get; set; }
            public System.Func<Amazon.EKS.Model.DescribeFargateProfileResponse, GetEKSFargateProfileCmdlet, object> Select { get; set; } =
