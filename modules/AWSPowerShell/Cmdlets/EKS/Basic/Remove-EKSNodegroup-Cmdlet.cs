...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    [AWSCmdletOutput("Amazon.EKS.Model.Nodegroup or Amazon.EKS.Model.DeleteNodegroupResponse",
        ...
        "The service call response (type Amazon.EKS.Model.DeleteNodegroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
