...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    public partial class AddEKSResourceTagCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EKSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EKS.Model.TagResourceResponse, AddEKSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EKS.Model.TagResourceRequest();
        ...
        private Amazon.EKS.Model.TagResourceResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EKS.Model.TagResourceResponse, AddEKSResourceTagCmdlet, object> Select { get; set; } =
