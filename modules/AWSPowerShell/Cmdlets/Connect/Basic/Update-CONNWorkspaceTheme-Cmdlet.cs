...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CONNWorkspaceTheme", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service UpdateWorkspaceTheme API operation.", Operation = new[] {"UpdateWorkspaceTheme"}, SelectReturnType = typeof(Amazon.Connect.Model.UpdateWorkspaceThemeResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateWorkspaceThemeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.UpdateWorkspaceThemeResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCONNWorkspaceThemeCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.UpdateWorkspaceThemeResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNWorkspaceTheme (UpdateWorkspaceTheme)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateWorkspaceThemeResponse, UpdateCONNWorkspaceThemeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateWorkspaceThemeRequest();
        ...
        private Amazon.Connect.Model.UpdateWorkspaceThemeResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateWorkspaceThemeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateWorkspaceTheme");
            try
            {
                #if DESKTOP
                return client.UpdateWorkspaceTheme(request);
                #elif CORECLR
                return client.UpdateWorkspaceThemeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Connect.WorkspaceFontFamily Theme_Light_Typography_FontFamily_Default { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateWorkspaceThemeResponse, UpdateCONNWorkspaceThemeCmdlet, object> Select { get; set; } =
