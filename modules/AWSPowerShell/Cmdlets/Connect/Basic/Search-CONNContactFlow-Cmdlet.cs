...
{
    /// <summary>
    /// Searches the flows in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class SearchCONNContactFlowCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.SearchContactFlowsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchContactFlowsRequest request)
        {
            ...
            try
            {
                return client.SearchContactFlowsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
