...
{
    /// <summary>
    /// Searches the flows in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Connect.Model.SearchContactFlowsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchContactFlowsResponse object containing multiple properties."
    )]
