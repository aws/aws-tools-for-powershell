...
{
    /// <summary>
    /// Searches the contact flows in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNContactFlow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchContactFlowsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchContactFlows API operation.", Operation = new[] {"SearchContactFlows"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchContactFlowsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchContactFlowsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchContactFlowsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNContactFlowCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.ContactFlowSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.ContactFlowState SearchCriteria_StateCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchContactFlowsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchContactFlowsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNContactFlow (SearchContactFlows)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchContactFlowsResponse, SearchCONNContactFlowCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.ContactFlowSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.ContactFlowSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchContactFlowsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.ContactFlowSearchCriteria();
            List<Amazon.Connect.Model.ContactFlowSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.ContactFlowSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            Amazon.Connect.ContactFlowState requestSearchCriteria_searchCriteria_StateCondition = null;
            ...
            Amazon.Connect.ContactFlowStatus requestSearchCriteria_searchCriteria_StatusCondition = null;
            ...
            Amazon.Connect.ContactFlowType requestSearchCriteria_searchCriteria_TypeCondition = null;
            if (cmdletContext.SearchCriteria_TypeCondition != null)
            {
                requestSearchCriteria_searchCriteria_TypeCondition = cmdletContext.SearchCriteria_TypeCondition;
            }
            if (requestSearchCriteria_searchCriteria_TypeCondition != null)
            {
                request.SearchCriteria.TypeCondition = requestSearchCriteria_searchCriteria_TypeCondition;
                requestSearchCriteriaIsNull = false;
            }
            ...
            request.SearchFilter = new Amazon.Connect.Model.ContactFlowSearchFilter();
        ...
        private Amazon.Connect.Model.SearchContactFlowsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchContactFlowsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchContactFlows");
            try
            {
                #if DESKTOP
                return client.SearchContactFlows(request);
                #elif CORECLR
                return client.SearchContactFlowsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.ContactFlowSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.ContactFlowSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.ContactFlowState SearchCriteria_StateCondition { get; set; }
            public Amazon.Connect.ContactFlowStatus SearchCriteria_StatusCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
