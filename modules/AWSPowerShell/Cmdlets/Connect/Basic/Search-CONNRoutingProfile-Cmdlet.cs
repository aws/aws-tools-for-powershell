...
{
    /// <summary>
    /// Searches routing profiles in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNRoutingProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchRoutingProfilesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchRoutingProfiles API operation.", Operation = new[] {"SearchRoutingProfiles"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchRoutingProfilesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchRoutingProfilesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchRoutingProfilesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNRoutingProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.RoutingProfileSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.RoutingProfileSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchRoutingProfilesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchRoutingProfilesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNRoutingProfile (SearchRoutingProfiles)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchRoutingProfilesResponse, SearchCONNRoutingProfileCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.RoutingProfileSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.RoutingProfileSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchRoutingProfilesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.RoutingProfileSearchCriteria();
            List<Amazon.Connect.Model.RoutingProfileSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.RoutingProfileSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.RoutingProfileSearchFilter();
        ...
        private Amazon.Connect.Model.SearchRoutingProfilesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchRoutingProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchRoutingProfiles");
            try
            {
                #if DESKTOP
                return client.SearchRoutingProfiles(request);
                #elif CORECLR
                return client.SearchRoutingProfilesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.RoutingProfileSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.RoutingProfileSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchRoutingProfilesResponse, SearchCONNRoutingProfileCmdlet, object> Select { get; set; } =
