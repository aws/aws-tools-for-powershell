...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("New", "CONNUserHierarchyGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewCONNUserHierarchyGroupCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNUserHierarchyGroup (CreateUserHierarchyGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateUserHierarchyGroupResponse, NewCONNUserHierarchyGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateUserHierarchyGroupRequest();
        ...
        private Amazon.Connect.Model.CreateUserHierarchyGroupResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateUserHierarchyGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateUserHierarchyGroup");
            try
            {
                #if DESKTOP
                return client.CreateUserHierarchyGroup(request);
                #elif CORECLR
                return client.CreateUserHierarchyGroupAsync(request).GetAwaiter().GetResult();
                #else
