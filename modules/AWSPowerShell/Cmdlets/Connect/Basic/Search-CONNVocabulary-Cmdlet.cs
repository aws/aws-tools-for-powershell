...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("Amazon.Connect.Model.VocabularySummary or Amazon.Connect.Model.SearchVocabulariesResponse",
        ...
        "The service call response (type Amazon.Connect.Model.SearchVocabulariesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
