...
{
    /// <summary>
    /// Searches the hours of operation in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNHoursOfOperation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchHoursOfOperationsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchHoursOfOperations API operation.", Operation = new[] {"SearchHoursOfOperations"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchHoursOfOperationsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchHoursOfOperationsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchHoursOfOperationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNHoursOfOperationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.HoursOfOperationSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.HoursOfOperationSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchHoursOfOperationsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchHoursOfOperationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNHoursOfOperation (SearchHoursOfOperations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchHoursOfOperationsResponse, SearchCONNHoursOfOperationCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.HoursOfOperationSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.HoursOfOperationSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchHoursOfOperationsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.HoursOfOperationSearchCriteria();
            List<Amazon.Connect.Model.HoursOfOperationSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.HoursOfOperationSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
        ...
        private Amazon.Connect.Model.SearchHoursOfOperationsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchHoursOfOperationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchHoursOfOperations");
            try
            {
                #if DESKTOP
                return client.SearchHoursOfOperations(request);
                #elif CORECLR
                return client.SearchHoursOfOperationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.HoursOfOperationSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.HoursOfOperationSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchHoursOfOperationsResponse, SearchCONNHoursOfOperationCmdlet, object> Select { get; set; } =
