...
{
    /// <summary>
    /// Searches the hours of operation in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class SearchCONNHoursOfOperationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.SearchHoursOfOperationsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchHoursOfOperationsRequest request)
        {
            ...
            try
            {
                return client.SearchHoursOfOperationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
