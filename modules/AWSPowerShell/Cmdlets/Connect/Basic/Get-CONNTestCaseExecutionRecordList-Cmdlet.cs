...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// actions taken and data associated in the specified Amazon Connect instance.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCONNTestCaseExecutionRecordListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.ListTestCaseExecutionRecordsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListTestCaseExecutionRecordsRequest request)
        {
            ...
            try
            {
                return client.ListTestCaseExecutionRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
