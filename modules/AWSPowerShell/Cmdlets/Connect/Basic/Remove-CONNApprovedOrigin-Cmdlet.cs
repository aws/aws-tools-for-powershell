...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "CONNApprovedOrigin", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCONNApprovedOriginCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNApprovedOrigin (DisassociateApprovedOrigin)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DisassociateApprovedOriginResponse, RemoveCONNApprovedOriginCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DisassociateApprovedOriginRequest();
        ...
        private Amazon.Connect.Model.DisassociateApprovedOriginResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DisassociateApprovedOriginRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DisassociateApprovedOrigin");
            try
            {
                #if DESKTOP
                return client.DisassociateApprovedOrigin(request);
                #elif CORECLR
                return client.DisassociateApprovedOriginAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String Origin { get; set; }
            public System.Func<Amazon.Connect.Model.DisassociateApprovedOriginResponse, RemoveCONNApprovedOriginCmdlet, object> Select { get; set; } =
