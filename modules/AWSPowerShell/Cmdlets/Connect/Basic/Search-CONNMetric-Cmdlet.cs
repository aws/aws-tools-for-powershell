...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Search", "CONNMetric", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchMetricsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchMetrics API operation.", Operation = new[] {"SearchMetrics"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchMetricsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchMetricsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchMetricsResponse object containing multiple properties."
    )]
    public partial class SearchCONNMetricCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.MetricSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        
        #region Parameter SearchFilter_TagFilter_AndCondition
        /// <summary>
        /// <para>
        ...
        public Amazon.Connect.Model.TagCondition[] SearchFilter_TagFilter_AndCondition { get; set; }
        #endregion
        
        #region Parameter SearchCriteria_BooleanCondition_ComparisonType
        /// <summary>
        /// <para>
        ...
        public Amazon.Connect.BooleanComparisonType SearchCriteria_BooleanCondition_ComparisonType { get; set; }
        #endregion
        ...
        #region Parameter SearchCriteria_BooleanCondition_FieldName
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String SearchCriteria_BooleanCondition_FieldName { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.MetricSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        
        #region Parameter SearchFilter_TagFilter_OrCondition
        /// <summary>
        /// <para>
        ...
        public Amazon.Connect.Model.TagCondition[][] SearchFilter_TagFilter_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchMetricsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchMetricsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNMetric (SearchMetrics)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchMetricsResponse, SearchCONNMetricCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.MetricSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            context.SearchCriteria_BooleanCondition_ComparisonType = this.SearchCriteria_BooleanCondition_ComparisonType;
            context.SearchCriteria_BooleanCondition_FieldName = this.SearchCriteria_BooleanCondition_FieldName;
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.MetricSearchCriteria>(this.SearchCriteria_OrCondition);
            }
            ...
            if (this.SearchFilter_TagFilter_AndCondition != null)
            {
                context.SearchFilter_TagFilter_AndCondition = new List<Amazon.Connect.Model.TagCondition>(this.SearchFilter_TagFilter_AndCondition);
            }
            if (this.SearchFilter_TagFilter_OrCondition != null)
            {
                context.SearchFilter_TagFilter_OrCondition = new List<List<Amazon.Connect.Model.TagCondition>>();
                foreach (var innerList in this.SearchFilter_TagFilter_OrCondition)
                {
                    context.SearchFilter_TagFilter_OrCondition.Add(new List<Amazon.Connect.Model.TagCondition>(innerList));
                }
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchMetricsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.MetricSearchCriteria();
            List<Amazon.Connect.Model.MetricSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.MetricSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            Amazon.Connect.BooleanComparisonType requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_ComparisonType = null;
            if (cmdletContext.SearchCriteria_BooleanCondition_ComparisonType != null)
            {
                requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_ComparisonType = cmdletContext.SearchCriteria_BooleanCondition_ComparisonType;
            }
            if (requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_ComparisonType != null)
            {
                requestSearchCriteria_searchCriteria_BooleanCondition.ComparisonType = requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_ComparisonType;
                requestSearchCriteria_searchCriteria_BooleanConditionIsNull = false;
            }
            System.String requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_FieldName = null;
            if (cmdletContext.SearchCriteria_BooleanCondition_FieldName != null)
            {
                requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_FieldName = cmdletContext.SearchCriteria_BooleanCondition_FieldName;
            }
            if (requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_FieldName != null)
            {
                requestSearchCriteria_searchCriteria_BooleanCondition.FieldName = requestSearchCriteria_searchCriteria_BooleanCondition_searchCriteria_BooleanCondition_FieldName;
                requestSearchCriteria_searchCriteria_BooleanConditionIsNull = false;
            }
            ...
            request.SearchFilter = new Amazon.Connect.Model.MetricSearchFilter();
            ...
            List<Amazon.Connect.Model.TagCondition> requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_AndCondition = null;
            if (cmdletContext.SearchFilter_TagFilter_AndCondition != null)
            {
                requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_AndCondition = cmdletContext.SearchFilter_TagFilter_AndCondition;
            }
            if (requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_AndCondition != null)
            {
                requestSearchFilter_searchFilter_TagFilter.AndConditions = requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_AndCondition;
                requestSearchFilter_searchFilter_TagFilterIsNull = false;
            }
            List<List<Amazon.Connect.Model.TagCondition>> requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_OrCondition = null;
            if (cmdletContext.SearchFilter_TagFilter_OrCondition != null)
            {
                requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_OrCondition = cmdletContext.SearchFilter_TagFilter_OrCondition;
            }
            if (requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_OrCondition != null)
            {
                requestSearchFilter_searchFilter_TagFilter.OrConditions = requestSearchFilter_searchFilter_TagFilter_searchFilter_TagFilter_OrCondition;
                requestSearchFilter_searchFilter_TagFilterIsNull = false;
            }
        ...
        private Amazon.Connect.Model.SearchMetricsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchMetricsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchMetrics");
            try
            {
                return client.SearchMetricsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.MetricSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public Amazon.Connect.BooleanComparisonType SearchCriteria_BooleanCondition_ComparisonType { get; set; }
            public System.String SearchCriteria_BooleanCondition_FieldName { get; set; }
            public List<Amazon.Connect.Model.MetricSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType SearchCriteria_StringCondition_ComparisonType { get; set; }
            public System.String SearchCriteria_StringCondition_FieldName { get; set; }
            public System.String SearchCriteria_StringCondition_Value { get; set; }
            public List<Amazon.Connect.Model.TagCondition> SearchFilter_TagFilter_AndCondition { get; set; }
            public List<List<Amazon.Connect.Model.TagCondition>> SearchFilter_TagFilter_OrCondition { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchMetricsResponse, SearchCONNMetricCmdlet, object> Select { get; set; } =
