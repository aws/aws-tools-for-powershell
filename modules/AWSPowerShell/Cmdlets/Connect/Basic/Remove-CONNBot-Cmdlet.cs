...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.DisassociateBotResponse",
        ...
        "The service response (type Amazon.Connect.Model.DisassociateBotResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
