...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class UpdateCONNRuleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of actions to be run when the rule is triggered.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.UpdateRuleResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNRule (UpdateRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateRuleResponse, UpdateCONNRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateRuleRequest();
        ...
        private Amazon.Connect.Model.UpdateRuleResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateRule");
            try
            {
