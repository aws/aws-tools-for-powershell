...
{
    /// <summary>
    /// Searches quick connects in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNQuickConnect", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchQuickConnectsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchQuickConnects API operation.", Operation = new[] {"SearchQuickConnects"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchQuickConnectsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchQuickConnectsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchQuickConnectsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNQuickConnectCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.QuickConnectSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.QuickConnectSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchQuickConnectsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchQuickConnectsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNQuickConnect (SearchQuickConnects)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchQuickConnectsResponse, SearchCONNQuickConnectCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.QuickConnectSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.QuickConnectSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchQuickConnectsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.QuickConnectSearchCriteria();
            List<Amazon.Connect.Model.QuickConnectSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.QuickConnectSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.QuickConnectSearchFilter();
        ...
        private Amazon.Connect.Model.SearchQuickConnectsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchQuickConnectsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchQuickConnects");
            try
            {
                #if DESKTOP
                return client.SearchQuickConnects(request);
                #elif CORECLR
                return client.SearchQuickConnectsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.QuickConnectSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.QuickConnectSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchQuickConnectsResponse, SearchCONNQuickConnectCmdlet, object> Select { get; set; } =
