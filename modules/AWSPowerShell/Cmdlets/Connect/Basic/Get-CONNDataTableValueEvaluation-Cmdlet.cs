...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// a batch operation as specified in Batch Operations: Amazon Web Services API Standards.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCONNDataTableValueEvaluationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.EvaluateDataTableValuesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.EvaluateDataTableValuesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.EvaluateDataTableValues(request);
                #elif CORECLR
                return client.EvaluateDataTableValuesAsync(request).GetAwaiter().GetResult();
                #else
