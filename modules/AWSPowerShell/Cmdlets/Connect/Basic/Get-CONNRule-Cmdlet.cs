...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Get", "CONNRule")]
    [OutputType("Amazon.Connect.Model.Rule")]
    ...
    public partial class GetCONNRuleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.DescribeRuleResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.DescribeRuleResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DescribeRuleResponse, GetCONNRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DescribeRuleRequest();
        ...
        private Amazon.Connect.Model.DescribeRuleResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DescribeRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DescribeRule");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String RuleId { get; set; }
            public System.Func<Amazon.Connect.Model.DescribeRuleResponse, GetCONNRuleCmdlet, object> Select { get; set; } =
