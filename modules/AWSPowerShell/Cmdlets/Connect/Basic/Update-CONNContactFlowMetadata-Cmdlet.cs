...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CONNContactFlowMetadata", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCONNContactFlowMetadataCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        #region Parameter ContactFlowState
        /// <summary>
        /// <para>
        /// <para>The state of flow.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Connect.ContactFlowState")]
        public Amazon.Connect.ContactFlowState ContactFlowState { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNContactFlowMetadata (UpdateContactFlowMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateContactFlowMetadataResponse, UpdateCONNContactFlowMetadataCmdlet>(Select) ??
            ...
            #endif
            context.ContactFlowState = this.ContactFlowState;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateContactFlowMetadataRequest();
            
            if (cmdletContext.ContactFlowId != null)
            {
                request.ContactFlowId = cmdletContext.ContactFlowId;
            }
            if (cmdletContext.ContactFlowState != null)
            {
                request.ContactFlowState = cmdletContext.ContactFlowState;
            }
        ...
        private Amazon.Connect.Model.UpdateContactFlowMetadataResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateContactFlowMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateContactFlowMetadata");
            try
            {
                #if DESKTOP
                return client.UpdateContactFlowMetadata(request);
                #elif CORECLR
                return client.UpdateContactFlowMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateContactFlowMetadataResponse, UpdateCONNContactFlowMetadataCmdlet, object> Select { get; set; } =
