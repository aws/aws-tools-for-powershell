...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class NewCONNUserCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of after contact work (ACW) timeout configuration settings for each channel.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The list of auto-accept configuration settings for each channel.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
