...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// integration.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCONNDataTableAttributeListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// describe attributes by ID. If NextToken is provided, this parameter is ignored.</para><para />
        ...
        private Amazon.Connect.Model.ListDataTableAttributesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListDataTableAttributesRequest request)
        {
            ...
            try
            {
                return client.ListDataTableAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
