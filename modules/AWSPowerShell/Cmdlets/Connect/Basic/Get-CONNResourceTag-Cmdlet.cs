...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class GetCONNResourceTagCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.ListTagsForResourceResponse, GetCONNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Connect.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ListTagsForResource");
            try
            {
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Connect.Model.ListTagsForResourceResponse, GetCONNResourceTagCmdlet, object> Select { get; set; } =
