...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("Amazon.Connect.Model.AvailableNumberSummary or Amazon.Connect.Model.SearchAvailablePhoneNumbersResponse",
        ...
        "The service call response (type Amazon.Connect.Model.SearchAvailablePhoneNumbersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
