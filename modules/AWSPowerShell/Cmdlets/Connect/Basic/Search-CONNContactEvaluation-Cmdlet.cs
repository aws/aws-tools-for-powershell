...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Search", "CONNContactEvaluation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchContactEvaluationsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchContactEvaluations API operation.", Operation = new[] {"SearchContactEvaluations"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchContactEvaluationsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchContactEvaluationsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchContactEvaluationsResponse object containing multiple properties."
    )]
    public partial class SearchCONNContactEvaluationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_DecimalCondition_ComparisonType")]
        [AWSConstantClassSource("Amazon.Connect.DecimalComparisonType")]
        public Amazon.Connect.DecimalComparisonType DecimalCondition_ComparisonType { get; set; }
        #endregion
        ...
        #region Parameter DecimalCondition_FieldName
        /// <summary>
        /// <para>
        /// <para>A name of the decimal property to be searched.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_DecimalCondition_FieldName")]
        public System.String DecimalCondition_FieldName { get; set; }
        #endregion
        ...
        #region Parameter DecimalCondition_MaxValue
        /// <summary>
        /// <para>
        /// <para>A maximum value of the decimal property.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_DecimalCondition_MaxValue")]
        public System.Double? DecimalCondition_MaxValue { get; set; }
        #endregion
        ...
        #region Parameter DecimalCondition_MinValue
        /// <summary>
        /// <para>
        /// <para>A minimum value of the decimal property.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_DecimalCondition_MinValue")]
        public System.Double? DecimalCondition_MinValue { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.EvaluationSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchContactEvaluationsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchContactEvaluationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNContactEvaluation (SearchContactEvaluations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchContactEvaluationsResponse, SearchCONNContactEvaluationCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.EvaluationSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            ...
            context.DecimalCondition_ComparisonType = this.DecimalCondition_ComparisonType;
            context.DecimalCondition_FieldName = this.DecimalCondition_FieldName;
            context.DecimalCondition_MaxValue = this.DecimalCondition_MaxValue;
            context.DecimalCondition_MinValue = this.DecimalCondition_MinValue;
            ...
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.EvaluationSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.SearchContactEvaluationsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.EvaluationSearchCriteria();
            List<Amazon.Connect.Model.EvaluationSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.EvaluationSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            Amazon.Connect.Model.DecimalCondition requestSearchCriteria_searchCriteria_DecimalCondition = null;
            
             // populate DecimalCondition
            var requestSearchCriteria_searchCriteria_DecimalConditionIsNull = true;
            requestSearchCriteria_searchCriteria_DecimalCondition = new Amazon.Connect.Model.DecimalCondition();
            Amazon.Connect.DecimalComparisonType requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_ComparisonType = null;
            if (cmdletContext.DecimalCondition_ComparisonType != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_ComparisonType = cmdletContext.DecimalCondition_ComparisonType;
            }
            if (requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_ComparisonType != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition.ComparisonType = requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_ComparisonType;
                requestSearchCriteria_searchCriteria_DecimalConditionIsNull = false;
            }
            System.String requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_FieldName = null;
            if (cmdletContext.DecimalCondition_FieldName != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_FieldName = cmdletContext.DecimalCondition_FieldName;
            }
            if (requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_FieldName != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition.FieldName = requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_FieldName;
                requestSearchCriteria_searchCriteria_DecimalConditionIsNull = false;
            }
            System.Double? requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MaxValue = null;
            if (cmdletContext.DecimalCondition_MaxValue != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MaxValue = cmdletContext.DecimalCondition_MaxValue.Value;
            }
            if (requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MaxValue != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition.MaxValue = requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MaxValue.Value;
                requestSearchCriteria_searchCriteria_DecimalConditionIsNull = false;
            }
            System.Double? requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MinValue = null;
            if (cmdletContext.DecimalCondition_MinValue != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MinValue = cmdletContext.DecimalCondition_MinValue.Value;
            }
            if (requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MinValue != null)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition.MinValue = requestSearchCriteria_searchCriteria_DecimalCondition_decimalCondition_MinValue.Value;
                requestSearchCriteria_searchCriteria_DecimalConditionIsNull = false;
            }
             // determine if requestSearchCriteria_searchCriteria_DecimalCondition should be set to null
            if (requestSearchCriteria_searchCriteria_DecimalConditionIsNull)
            {
                requestSearchCriteria_searchCriteria_DecimalCondition = null;
            }
            if (requestSearchCriteria_searchCriteria_DecimalCondition != null)
            {
                request.SearchCriteria.DecimalCondition = requestSearchCriteria_searchCriteria_DecimalCondition;
                requestSearchCriteriaIsNull = false;
            }
            ...
            request.SearchFilter = new Amazon.Connect.Model.EvaluationSearchFilter();
        ...
        private Amazon.Connect.Model.SearchContactEvaluationsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchContactEvaluationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchContactEvaluations");
            try
            {
                #if DESKTOP
                return client.SearchContactEvaluations(request);
                #elif CORECLR
                return client.SearchContactEvaluationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.EvaluationSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public Amazon.Connect.BooleanComparisonType BooleanCondition_ComparisonType { get; set; }
            public System.String BooleanCondition_FieldName { get; set; }
            public Amazon.Connect.DateTimeComparisonType DateTimeCondition_ComparisonType { get; set; }
            public System.String DateTimeCondition_FieldName { get; set; }
            ...
            public System.Int32? NumberCondition_MaxValue { get; set; }
            public System.Int32? NumberCondition_MinValue { get; set; }
            public List<Amazon.Connect.Model.EvaluationSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
