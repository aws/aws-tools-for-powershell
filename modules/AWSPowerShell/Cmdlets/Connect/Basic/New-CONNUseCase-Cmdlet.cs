...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class NewCONNUseCaseCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.Connect.UseCaseType")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.UseCaseType), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNUseCase (CreateUseCase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateUseCaseResponse, NewCONNUseCaseCmdlet>(Select) ??
            ...
            {
                WriteWarning("You are passing $null as a value for parameter UseCaseType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateUseCaseRequest();
            ...
            {
                request.UseCaseType = cmdletContext.UseCaseType;
            }
        ...
        private Amazon.Connect.Model.CreateUseCaseResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateUseCaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateUseCase");
            try
            {
                #if DESKTOP
                return client.CreateUseCase(request);
                #elif CORECLR
                return client.CreateUseCaseAsync(request).GetAwaiter().GetResult();
                #else
