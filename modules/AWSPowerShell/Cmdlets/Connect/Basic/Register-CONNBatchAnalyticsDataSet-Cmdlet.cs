...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class RegisterCONNBatchAnalyticsDataSetCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of dataset identifiers to associate.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.BatchAssociateAnalyticsDataSetResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.BatchAssociateAnalyticsDataSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-CONNBatchAnalyticsDataSet (BatchAssociateAnalyticsDataSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.BatchAssociateAnalyticsDataSetResponse, RegisterCONNBatchAnalyticsDataSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.BatchAssociateAnalyticsDataSetRequest();
        ...
        private Amazon.Connect.Model.BatchAssociateAnalyticsDataSetResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.BatchAssociateAnalyticsDataSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "BatchAssociateAnalyticsDataSet");
            try
            {
                #if DESKTOP
                return client.BatchAssociateAnalyticsDataSet(request);
                #elif CORECLR
                return client.BatchAssociateAnalyticsDataSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String TargetAccountId { get; set; }
            public System.Func<Amazon.Connect.Model.BatchAssociateAnalyticsDataSetResponse, RegisterCONNBatchAnalyticsDataSetCmdlet, object> Select { get; set; } =
