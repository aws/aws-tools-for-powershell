...
{
    /// <summary>
    /// Searches rules in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchRulesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchRules API operation.", Operation = new[] {"SearchRules"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchRulesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchRulesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchRulesResponse object containing multiple properties."
    )]
    public partial class SearchCONNRuleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.RulesSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.RulesSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.RuleAttributeAndCondition[] SearchFilter_AttributeFilter_OrCondition { get; set; }
        #endregion
        
        #region Parameter SearchFilter_AttributeFilter_AndCondition_TagCondition
        /// <summary>
        /// <para>
        /// <para>A list of tag conditions that need to be applied with <c>AND</c> condition.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchRulesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchRulesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNRule (SearchRules)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchRulesResponse, SearchCONNRuleCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.RulesSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.RulesSearchCriteria>(this.SearchCriteria_OrCondition);
            }
            ...
            {
                context.SearchFilter_AttributeFilter_OrCondition = new List<Amazon.Connect.Model.RuleAttributeAndCondition>(this.SearchFilter_AttributeFilter_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchRulesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.RulesSearchCriteria();
            List<Amazon.Connect.Model.RulesSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.RulesSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.RulesSearchFilter();
            Amazon.Connect.Model.RuleAttributeFilter requestSearchFilter_searchFilter_AttributeFilter = null;
            
             // populate AttributeFilter
            var requestSearchFilter_searchFilter_AttributeFilterIsNull = true;
            requestSearchFilter_searchFilter_AttributeFilter = new Amazon.Connect.Model.RuleAttributeFilter();
            List<Amazon.Connect.Model.RuleAttributeAndCondition> requestSearchFilter_searchFilter_AttributeFilter_searchFilter_AttributeFilter_OrCondition = null;
            ...
            Amazon.Connect.Model.RuleAttributeAndCondition requestSearchFilter_searchFilter_AttributeFilter_searchFilter_AttributeFilter_AndCondition = null;
            ...
            requestSearchFilter_searchFilter_AttributeFilter_searchFilter_AttributeFilter_AndCondition = new Amazon.Connect.Model.RuleAttributeAndCondition();
        ...
        private Amazon.Connect.Model.SearchRulesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchRules");
            try
            {
                return client.SearchRulesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.RulesSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.RulesSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType SearchCriteria_StringCondition_ComparisonType { get; set; }
            public System.String SearchCriteria_StringCondition_FieldName { get; set; }
            public System.String SearchCriteria_StringCondition_Value { get; set; }
            public List<Amazon.Connect.Model.TagCondition> SearchFilter_AttributeFilter_AndCondition_TagCondition { get; set; }
            public List<Amazon.Connect.Model.RuleAttributeAndCondition> SearchFilter_AttributeFilter_OrCondition { get; set; }
            public System.String SearchFilter_AttributeFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_AttributeFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchRulesResponse, SearchCONNRuleCmdlet, object> Select { get; set; } =
