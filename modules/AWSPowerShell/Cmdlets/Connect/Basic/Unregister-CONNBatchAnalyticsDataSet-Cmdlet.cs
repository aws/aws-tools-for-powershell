...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class UnregisterCONNBatchAnalyticsDataSetCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of associated dataset identifiers to remove.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Connect.Model.BatchDisassociateAnalyticsDataSetResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.BatchDisassociateAnalyticsDataSetRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchDisassociateAnalyticsDataSet(request);
                #elif CORECLR
                return client.BatchDisassociateAnalyticsDataSetAsync(request).GetAwaiter().GetResult();
                #else
