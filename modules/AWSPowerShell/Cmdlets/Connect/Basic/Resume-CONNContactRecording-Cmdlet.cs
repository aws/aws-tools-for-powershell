...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service ResumeContactRecording API operation.", Operation = new[] {"ResumeContactRecording"}, SelectReturnType = typeof(Amazon.Connect.Model.ResumeContactRecordingResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.ResumeContactRecordingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.ResumeContactRecordingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ResumeCONNContactRecordingCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Resume-CONNContactRecording (ResumeContactRecording)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.ResumeContactRecordingResponse, ResumeCONNContactRecordingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.ResumeContactRecordingRequest();
        ...
        private Amazon.Connect.Model.ResumeContactRecordingResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ResumeContactRecordingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ResumeContactRecording");
            try
            {
                #if DESKTOP
                return client.ResumeContactRecording(request);
                #elif CORECLR
                return client.ResumeContactRecordingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InitialContactId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.ResumeContactRecordingResponse, ResumeCONNContactRecordingCmdlet, object> Select { get; set; } =
