...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class GetCONNMetricDataV2Cmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filtering is an operation that selects records that match a set of specified criteria.
        /// By narrowing the dataset before aggregation, filters ensure that only relevant records
        /// are included in the computation.</para><para><b>Filter keys</b></para><para>The following are valid filter keys for a <c>GetMetricDataV2</c> request:</para><para><c>AGENT</c> | <c>AI_AGENT</c> | <c>AI_AGENT_ID</c> | <c>AI_AGENT_NAME</c> | <c>AI_AGENT_TYPE</c>
        ...
        /// <c>AGENT_HIERARCHY_LEVEL_FIVE</c>, <c>CAMPAIGN</c>, <c>EVALUATION_FORM</c>, <c>EVALUATOR_ID</c></para><para>You can use up to 5 filter keys in a single request, and up to 100 filter values across
        /// all filter keys.</para></note><para><b>Filter values</b></para><ul><li><para>VOICE, CHAT, TASK, and EMAIL are valid filter values for the <c>CHANNEL</c> filter
        ...
        /// 100 filter values, along with 4 channel filters.</para></li><li><para><c>contact_lens_conversational_analytics</c> is a valid filter value for the <c>FEATURE</c>
        ...
        /// apply to the metrics for each queue. They are not aggregated for all queues.</para><para>If no grouping is specified, a summary of all metrics is returned.</para><para>Valid grouping keys: <c>AGENT</c> | <c>AI_AGENT</c> | <c>AI_AGENT_ID</c> | <c>AI_AGENT_NAME</c>
        ...
        /// after contact work time</a></para><note><para>Feature is a valid filter but not a valid grouping.</para></note></dd><dt>AVG_AGENT_CONCURRENCY</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: Queue, Channel, Routing Profile, Agent, Agent Hierarchy,
        /// Q in Connect</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-agent-concurrency">Average
        /// agent concurrency</a></para></dd><dt>AVG_AGENT_CONNECTING_TIME</dt><dd><para>Unit: Seconds</para><para>Valid metric filter key: <c>INITIATION_METHOD</c>. For now, this metric only supports
        ...
        /// AI Use Case, Feature, contact/segmentAttributes/connect:Subtype, RoutingStepExpression</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-handle-time">Average
        ...
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#active-ai-agents">Active
        /// AI Agents</a></para></dd><dt>AI_HANDOFF_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-handoff-rate">AI
        /// Handoff Rate</a></para></dd><dt>AI_HANDOFFS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-handoffs">AI
        /// Handoff Count</a></para></dd><dt>AI_AGENT_INVOCATION_SUCCESS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Use Case, Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-agent-invocation-success">AI
        /// Agent Invocation Success</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_AGENT_INVOCATION_SUCCESS_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Use Case, Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-agent-invocation-success-rate">AI
        /// Agent Invocation Success Rate</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_AGENT_INVOCATIONS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Type, AI Agent Name
        /// Version, AI Use Case, Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-agent-invocations">AI
        /// Agent Invocation Count</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_AGENT_RESPONSE_HELPFUL</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent ID, AI Agent Name, AI Agent Name Version,
        /// AI Agent Type, AI Use Case, Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-agent-response-helpful">AI
        /// Agent Response Helpful</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_AGENT_RESPONSE_NOT_HELPFUL</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent ID, AI Agent Name, AI Agent Name Version,
        /// AI Agent Type, AI Use Case, Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-agent-response-not-helpful">AI
        /// Agent Response Not Helpful</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_RESPONSE_COMPLETION_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-response-completion-rate">AI
        /// Response Completion Rate</a></para></dd><dt>AI_INVOLVED_CONTACTS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-involved-contacts">AI
        /// Involved Contacts</a></para></dd><dt>AI_PROMPT_INVOCATION_SUCCESS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Prompt, AI Prompt ID, AI Prompt Name, AI Prompt Type, AI Use Case, Channel,
        /// Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-prompt-invocation-success">AI
        /// Prompt Invocation Success</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_PROMPT_INVOCATION_SUCCESS_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Prompt, AI Prompt ID, AI Prompt Name, AI Prompt Type, AI Use Case, Channel,
        /// Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-prompt-invocation-success-rate">AI
        /// Prompt Invocation Success Rate</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_PROMPT_INVOCATIONS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Prompt, AI Prompt ID, AI Prompt Name, AI Prompt Type, AI Use Case, Channel,
        /// Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-prompt-invocations">AI
        /// Prompt Invocations</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_INVOCATION_SUCCESS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue, Routing
        /// Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-invocation-success">AI
        /// Tool Invocation Success</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_INVOCATION_SUCCESS_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue, Routing
        /// Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-invocation-success-rate">AI
        /// Tool Invocation Success Rate</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_INVOCATIONS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue, Routing
        /// Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-invocations">AI
        /// Tool Invocations</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AVG_AI_AGENT_CONVERSATION_TURNS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Use Case, Channel, Queue, Routing Profile </para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-ai-agent-conversation-turns">Average
        /// AI Agent Conversation Turns</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AVG_AI_CONVERSATION_TURNS</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-ai-conversation-turns">Average
        /// AI Conversation Turns</a></para></dd><dt>AVG_AI_PROMPT_INVOCATION_LATENCY</dt><dd><para>Unit: Milliseconds</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Prompt, AI Prompt ID, AI Prompt Name, AI Prompt Type, AI Use Case, Channel,
        /// Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-ai-prompt-invocation-latency">Average
        /// AI Prompt Invocation Latency</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AVG_AI_TOOL_INVOCATION_LATENCY</dt><dd><para>Unit: Milliseconds</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Name Version, AI Agent
        /// Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue, Routing
        /// Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#average-ai-tool-invocation-latency">Average
        /// AI Tool Invocation Latency</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_PARAMETER_ACCURACY</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent, AI Agent ID, AI Agent Name, AI Agent Name Version,
        /// AI Agent Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue,
        /// Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-parameter-accuracy">AI
        /// Tool Parameter Accuracy</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_SELECTION_ACCURACY</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent, AI Agent ID, AI Agent Name, AI Agent Name Version,
        /// AI Agent Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue,
        /// Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-selection-accuracy">AI
        /// Tool Selection Accuracy</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>AI_TOOL_UTILIZATION_ACCURACY</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent, AI Agent ID, AI Agent Name, AI Agent Name Version,
        /// AI Agent Type, AI Tool ID, AI Tool Name, AI Tool Type, AI Use Case, Channel, Queue,
        /// Routing Profile, Session ID</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#ai-tool-utilization-accuracy">AI
        /// Tool Utilization Accuracy</a></para><note><para>AI Agent Name Version is not a valid filter but a valid grouping.</para></note></dd><dt>COMPLETENESS_SCORE</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile, Session ID</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#completeness-score">Completeness
        /// Score</a></para></dd><dt>FAITHFULNESS_SCORE</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile, Session ID</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#faithfulness-score">Faithfulness
        /// Score</a></para></dd><dt>GOAL_SUCCESS_RATE</dt><dd><para>Unit: Double</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile, Session ID</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#goal-success-rate">Goal
        /// Success Rate</a></para></dd><dt>KNOWLEDGE_CONTENT_REFERENCES</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Knowledge Base Name, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#knowledge-content-references">Knowledge
        /// Content References</a></para></dd><dt>PROACTIVE_INTENT_ENGAGEMENT_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#proactive-intents-engagement-rate">Proactive
        /// Intent Engagement Rate</a></para></dd><dt>PROACTIVE_INTENT_RESPONSE_RATE</dt><dd><para>Unit: Percent</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#proactive-intents-response-rate">Proactive
        /// Intent Response Rate</a></para></dd><dt>PROACTIVE_INTENTS_ANSWERED</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#proactive-intents-answered">Proactive
        /// Intents Answered</a></para></dd><dt>PROACTIVE_INTENTS_DETECTED</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#proactive-intents-detected">Proactive
        /// Intents Detected</a></para></dd><dt>PROACTIVE_INTENTS_ENGAGED</dt><dd><para>Unit: Count</para><para>Valid groupings and filters: AI Agent ID, AI Agent Name, AI Agent Type, AI Use Case,
        /// Channel, Queue, Routing Profile</para><para>UI name: <a href="https://docs.aws.amazon.com/connect/latest/adminguide/metrics-definitions.html#proactive-intents-engaged">Proactive
        /// Intents Engaged</a></para></dd><dt>AVG_HOLD_TIME</dt><dd><para>Unit: Seconds</para><para>Valid groupings and filters: Queue, Channel, Routing Profile, Agent, Agent Hierarchy,
        ...
        private Amazon.Connect.Model.GetMetricDataV2Response CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.GetMetricDataV2Request request)
        {
            ...
            try
            {
                return client.GetMetricDataV2Async(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
