...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class NewCONNHoursOfOperationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// overrides from different hours of operation</a> in the <i> Administrator Guide</i>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNHoursOfOperation (CreateHoursOfOperation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateHoursOfOperationResponse, NewCONNHoursOfOperationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateHoursOfOperationRequest();
        ...
        private Amazon.Connect.Model.CreateHoursOfOperationResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateHoursOfOperationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateHoursOfOperation");
            try
            {
                #if DESKTOP
                return client.CreateHoursOfOperation(request);
                #elif CORECLR
                return client.CreateHoursOfOperationAsync(request).GetAwaiter().GetResult();
                #else
