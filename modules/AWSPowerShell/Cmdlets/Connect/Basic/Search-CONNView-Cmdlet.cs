...
{
    /// <summary>
    /// Searches views based on name, description, or tags.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNView", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchViewsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchViews API operation.", Operation = new[] {"SearchViews"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchViewsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchViewsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchViewsResponse object containing multiple properties."
    )]
    public partial class SearchCONNViewCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of conditions that must all be satisfied.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_AndConditions")]
        public Amazon.Connect.Model.ViewSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>A list of conditions to be met, where at least one condition must be satisfied.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SearchCriteria_OrConditions")]
        public Amazon.Connect.Model.ViewSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        #region Parameter SearchCriteria_ViewStatusCondition
        /// <summary>
        /// <para>
        /// <para>A condition that filters views by their status.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Connect.ViewStatus")]
        public Amazon.Connect.ViewStatus SearchCriteria_ViewStatusCondition { get; set; }
        #endregion
        
        #region Parameter SearchCriteria_ViewTypeCondition
        /// <summary>
        /// <para>
        /// <para>A condition that filters views by their type.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Connect.ViewType")]
        public Amazon.Connect.ViewType SearchCriteria_ViewTypeCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchViewsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchViewsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNView (SearchViews)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchViewsResponse, SearchCONNViewCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.ViewSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.ViewSearchCriteria>(this.SearchCriteria_OrCondition);
            }
            ...
            context.SearchCriteria_ViewStatusCondition = this.SearchCriteria_ViewStatusCondition;
            context.SearchCriteria_ViewTypeCondition = this.SearchCriteria_ViewTypeCondition;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchViewsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.ViewSearchCriteria();
            List<Amazon.Connect.Model.ViewSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.ViewSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            Amazon.Connect.ViewStatus requestSearchCriteria_searchCriteria_ViewStatusCondition = null;
            if (cmdletContext.SearchCriteria_ViewStatusCondition != null)
            {
                requestSearchCriteria_searchCriteria_ViewStatusCondition = cmdletContext.SearchCriteria_ViewStatusCondition;
            }
            if (requestSearchCriteria_searchCriteria_ViewStatusCondition != null)
            {
                request.SearchCriteria.ViewStatusCondition = requestSearchCriteria_searchCriteria_ViewStatusCondition;
                requestSearchCriteriaIsNull = false;
            }
            Amazon.Connect.ViewType requestSearchCriteria_searchCriteria_ViewTypeCondition = null;
            if (cmdletContext.SearchCriteria_ViewTypeCondition != null)
            {
                requestSearchCriteria_searchCriteria_ViewTypeCondition = cmdletContext.SearchCriteria_ViewTypeCondition;
            }
            if (requestSearchCriteria_searchCriteria_ViewTypeCondition != null)
            {
                request.SearchCriteria.ViewTypeCondition = requestSearchCriteria_searchCriteria_ViewTypeCondition;
                requestSearchCriteriaIsNull = false;
            }
            ...
            request.SearchFilter = new Amazon.Connect.Model.ViewSearchFilter();
        ...
        private Amazon.Connect.Model.SearchViewsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchViewsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchViews");
            try
            {
                #if DESKTOP
                return client.SearchViews(request);
                #elif CORECLR
                return client.SearchViewsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.ViewSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.ViewSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            public Amazon.Connect.ViewStatus SearchCriteria_ViewStatusCondition { get; set; }
            ...
            public System.String TagCondition_TagKey { get; set; }
            public System.String TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchViewsResponse, SearchCONNViewCmdlet, object> Select { get; set; } =
