...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service UpdateUserRoutingProfile API operation.", Operation = new[] {"UpdateUserRoutingProfile"}, SelectReturnType = typeof(Amazon.Connect.Model.UpdateUserRoutingProfileResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateUserRoutingProfileResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.UpdateUserRoutingProfileResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCONNUserRoutingProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RoutingProfileId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RoutingProfileId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateUserRoutingProfileResponse, UpdateCONNUserRoutingProfileCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RoutingProfileId;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RoutingProfileId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateUserRoutingProfileResponse, UpdateCONNUserRoutingProfileCmdlet, object> Select { get; set; } =
