...
{
    /// <summary>
    /// Searches email address in an instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNEmailAddress", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchEmailAddressesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchEmailAddresses API operation.", Operation = new[] {"SearchEmailAddresses"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchEmailAddressesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchEmailAddressesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchEmailAddressesResponse object containing multiple properties."
    )]
    public partial class SearchCONNEmailAddressCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.EmailAddressSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.EmailAddressSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchEmailAddressesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchEmailAddressesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNEmailAddress (SearchEmailAddresses)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchEmailAddressesResponse, SearchCONNEmailAddressCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.EmailAddressSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.EmailAddressSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchEmailAddressesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.EmailAddressSearchCriteria();
            List<Amazon.Connect.Model.EmailAddressSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.EmailAddressSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.EmailAddressSearchFilter();
        ...
        private Amazon.Connect.Model.SearchEmailAddressesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchEmailAddressesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchEmailAddresses");
            try
            {
                #if DESKTOP
                return client.SearchEmailAddresses(request);
                #elif CORECLR
                return client.SearchEmailAddressesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.EmailAddressSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.EmailAddressSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String TagCondition_TagKey { get; set; }
            public System.String TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchEmailAddressesResponse, SearchCONNEmailAddressCmdlet, object> Select { get; set; } =
