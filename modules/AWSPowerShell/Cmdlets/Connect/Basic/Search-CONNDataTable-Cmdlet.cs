...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// Follows other search operations closely and supports both search criteria and filters.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNDataTable", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchDataTablesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchDataTables API operation.", Operation = new[] {"SearchDataTables"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchDataTablesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchDataTablesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchDataTablesResponse object containing multiple properties."
    )]
    public partial class SearchCONNDataTableCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The criteria's and conditions.</para><para />
        ...
        public Amazon.Connect.Model.DataTableSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier for the Amazon Connect instance to search within.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The criteria's or conditions.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        public Amazon.Connect.Model.DataTableSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of data tables to return in one page of results.</para>
        /// </para>
        /// <para>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchDataTablesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchDataTablesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNDataTable (SearchDataTables)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchDataTablesResponse, SearchCONNDataTableCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.DataTableSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.DataTableSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchDataTablesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.DataTableSearchCriteria();
            List<Amazon.Connect.Model.DataTableSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.DataTableSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.DataTableSearchFilter();
        ...
        private Amazon.Connect.Model.SearchDataTablesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchDataTablesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchDataTables");
            try
            {
                return client.SearchDataTablesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.DataTableSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.DataTableSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String TagCondition_TagKey { get; set; }
            public System.String TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchDataTablesResponse, SearchCONNDataTableCmdlet, object> Select { get; set; } =
