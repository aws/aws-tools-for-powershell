...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class SearchCONNDataTableCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The criteria's and conditions.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The criteria's or conditions.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Connect.Model.SearchDataTablesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchDataTablesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.SearchDataTables(request);
                #elif CORECLR
                return client.SearchDataTablesAsync(request).GetAwaiter().GetResult();
                #else
