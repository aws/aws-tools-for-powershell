...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CONNContactFlow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service DeleteContactFlow API operation.", Operation = new[] {"DeleteContactFlow"}, SelectReturnType = typeof(Amazon.Connect.Model.DeleteContactFlowResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.DeleteContactFlowResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.DeleteContactFlowResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCONNContactFlowCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNContactFlow (DeleteContactFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteContactFlowResponse, RemoveCONNContactFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteContactFlowRequest();
        ...
        private Amazon.Connect.Model.DeleteContactFlowResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteContactFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteContactFlow");
            try
            {
                #if DESKTOP
                return client.DeleteContactFlow(request);
                #elif CORECLR
                return client.DeleteContactFlowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ContactFlowId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteContactFlowResponse, RemoveCONNContactFlowCmdlet, object> Select { get; set; } =
