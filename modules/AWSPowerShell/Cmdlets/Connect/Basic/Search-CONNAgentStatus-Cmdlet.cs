...
{
    /// <summary>
    /// Searches AgentStatuses in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class SearchCONNAgentStatusCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <c>state</c>, <c>type</c>, <c>displayOrder</c>, and <c>resourceID</c>.</para></note><para />
