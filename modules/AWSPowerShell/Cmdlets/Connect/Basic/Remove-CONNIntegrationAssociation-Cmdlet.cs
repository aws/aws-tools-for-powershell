...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class RemoveCONNIntegrationAssociationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.IntegrationAssociationId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNIntegrationAssociation (DeleteIntegrationAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteIntegrationAssociationResponse, RemoveCONNIntegrationAssociationCmdlet>(Select) ??
            ...
            #endif
            context.IntegrationAssociationId = this.IntegrationAssociationId;
            #if MODULAR
            if (this.IntegrationAssociationId == null && ParameterWasBound(nameof(this.IntegrationAssociationId)))
            {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteIntegrationAssociationRequest();
        ...
        private Amazon.Connect.Model.DeleteIntegrationAssociationResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteIntegrationAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteIntegrationAssociation");
            try
            {
                #if DESKTOP
                return client.DeleteIntegrationAssociation(request);
                #elif CORECLR
                return client.DeleteIntegrationAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String IntegrationAssociationId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteIntegrationAssociationResponse, RemoveCONNIntegrationAssociationCmdlet, object> Select { get; set; } =
