...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class GetCONNContactFlowModuleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DescribeContactFlowModuleRequest();
        ...
        private Amazon.Connect.Model.DescribeContactFlowModuleResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DescribeContactFlowModuleRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ContactFlowModuleId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.DescribeContactFlowModuleResponse, GetCONNContactFlowModuleCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ContactFlowModule;
        }
