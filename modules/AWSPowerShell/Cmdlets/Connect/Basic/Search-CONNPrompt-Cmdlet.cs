...
{
    /// <summary>
    /// Searches prompts in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNPrompt", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchPromptsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchPrompts API operation.", Operation = new[] {"SearchPrompts"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchPromptsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchPromptsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchPromptsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNPromptCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.PromptSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.PromptSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchPromptsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchPromptsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNPrompt (SearchPrompts)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchPromptsResponse, SearchCONNPromptCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.PromptSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.PromptSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchPromptsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.PromptSearchCriteria();
            List<Amazon.Connect.Model.PromptSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.PromptSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.PromptSearchFilter();
        ...
        private Amazon.Connect.Model.SearchPromptsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchPromptsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchPrompts");
            try
            {
                #if DESKTOP
                return client.SearchPrompts(request);
                #elif CORECLR
                return client.SearchPromptsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.PromptSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.PromptSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchPromptsResponse, SearchCONNPromptCmdlet, object> Select { get; set; } =
