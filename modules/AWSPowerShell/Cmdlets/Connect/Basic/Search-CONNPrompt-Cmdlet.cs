...
{
    /// <summary>
    /// Searches prompts in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class SearchCONNPromptCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.SearchPromptsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchPromptsRequest request)
        {
            ...
            try
            {
                return client.SearchPromptsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
