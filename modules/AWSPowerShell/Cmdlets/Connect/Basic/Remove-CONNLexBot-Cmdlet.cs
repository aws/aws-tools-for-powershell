...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.DisassociateLexBotResponse",
        ...
        "The service response (type Amazon.Connect.Model.DisassociateLexBotResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
