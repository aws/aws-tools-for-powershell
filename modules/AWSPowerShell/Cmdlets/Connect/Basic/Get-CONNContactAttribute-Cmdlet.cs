...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service GetContactAttributes API operation.", Operation = new[] {"GetContactAttributes"}, SelectReturnType = typeof(Amazon.Connect.Model.GetContactAttributesResponse))]
    [AWSCmdletOutput("System.String or Amazon.Connect.Model.GetContactAttributesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Connect.Model.GetContactAttributesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCONNContactAttributeCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.GetContactAttributesResponse, GetCONNContactAttributeCmdlet>(Select) ??
        ...
        private Amazon.Connect.Model.GetContactAttributesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.GetContactAttributesRequest request)
        {
            ...
            try
            {
                return client.GetContactAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InitialContactId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.GetContactAttributesResponse, GetCONNContactAttributeCmdlet, object> Select { get; set; } =
