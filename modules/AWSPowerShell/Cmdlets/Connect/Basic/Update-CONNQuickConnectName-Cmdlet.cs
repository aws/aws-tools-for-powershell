...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class UpdateCONNQuickConnectNameCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNQuickConnectName (UpdateQuickConnectName)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateQuickConnectNameResponse, UpdateCONNQuickConnectNameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateQuickConnectNameRequest();
        ...
        private Amazon.Connect.Model.UpdateQuickConnectNameResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateQuickConnectNameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateQuickConnectName");
            try
            {
                #if DESKTOP
                return client.UpdateQuickConnectName(request);
                #elif CORECLR
                return client.UpdateQuickConnectNameAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String QuickConnectId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateQuickConnectNameResponse, UpdateCONNQuickConnectNameCmdlet, object> Select { get; set; } =
