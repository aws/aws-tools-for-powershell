...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service CreateContactFlowModule API operation.", Operation = new[] {"CreateContactFlowModule"}, SelectReturnType = typeof(Amazon.Connect.Model.CreateContactFlowModuleResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.CreateContactFlowModuleResponse",
        "This cmdlet returns an Amazon.Connect.Model.CreateContactFlowModuleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCONNContactFlowModuleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNContactFlowModule (CreateContactFlowModule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateContactFlowModuleResponse, NewCONNContactFlowModuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateContactFlowModuleRequest();
        ...
        private Amazon.Connect.Model.CreateContactFlowModuleResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateContactFlowModuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateContactFlowModule");
            try
            {
                #if DESKTOP
                return client.CreateContactFlowModule(request);
                #elif CORECLR
                return client.CreateContactFlowModuleAsync(request).GetAwaiter().GetResult();
                #else
