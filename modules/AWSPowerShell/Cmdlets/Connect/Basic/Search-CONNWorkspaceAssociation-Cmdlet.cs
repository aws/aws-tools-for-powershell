...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Search", "CONNWorkspaceAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchWorkspaceAssociationsResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchWorkspaceAssociations API operation.", Operation = new[] {"SearchWorkspaceAssociations"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchWorkspaceAssociationsResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchWorkspaceAssociationsResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchWorkspaceAssociationsResponse object containing multiple properties."
    )]
    public partial class SearchCONNWorkspaceAssociationCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.WorkspaceAssociationSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.WorkspaceAssociationSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchWorkspaceAssociationsResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchWorkspaceAssociationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNWorkspaceAssociation (SearchWorkspaceAssociations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchWorkspaceAssociationsResponse, SearchCONNWorkspaceAssociationCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchWorkspaceAssociationsRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.WorkspaceAssociationSearchCriteria();
            List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.WorkspaceAssociationSearchFilter();
        ...
        private Amazon.Connect.Model.SearchWorkspaceAssociationsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchWorkspaceAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchWorkspaceAssociations");
            try
            {
                #if DESKTOP
                return client.SearchWorkspaceAssociations(request);
                #elif CORECLR
                return client.SearchWorkspaceAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.WorkspaceAssociationSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String TagCondition_TagKey { get; set; }
            public System.String TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchWorkspaceAssociationsResponse, SearchCONNWorkspaceAssociationCmdlet, object> Select { get; set; } =
