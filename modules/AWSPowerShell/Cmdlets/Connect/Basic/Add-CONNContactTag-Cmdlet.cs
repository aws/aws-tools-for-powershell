...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service TagContact API operation.", Operation = new[] {"TagContact"}, SelectReturnType = typeof(Amazon.Connect.Model.TagContactResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.TagContactResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.TagContactResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddCONNContactTagCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.TagContactResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.TagContactResponse, AddCONNContactTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.TagContactRequest();
        ...
        private Amazon.Connect.Model.TagContactResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.TagContactRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "TagContact");
            try
            {
                #if DESKTOP
                return client.TagContact(request);
                #elif CORECLR
                return client.TagContactAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Connect.Model.TagContactResponse, AddCONNContactTagCmdlet, object> Select { get; set; } =
