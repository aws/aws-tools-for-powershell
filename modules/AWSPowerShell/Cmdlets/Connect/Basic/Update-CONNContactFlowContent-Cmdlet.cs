...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateContactFlowContentResponse",
        ...
        "The service response (type Amazon.Connect.Model.UpdateContactFlowContentResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCONNContactFlowContentCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// flow in Connect Customer Flow language</a>. </para><para>Length Constraints: Minimum length of 1. Maximum length of 256000.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Connect.Model.UpdateContactFlowContentResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateContactFlowContentRequest request)
        {
            ...
            try
            {
                return client.UpdateContactFlowContentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
