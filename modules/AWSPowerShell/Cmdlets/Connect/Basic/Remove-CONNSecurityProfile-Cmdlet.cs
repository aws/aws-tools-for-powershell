...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CONNSecurityProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCONNSecurityProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNSecurityProfile (DeleteSecurityProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteSecurityProfileResponse, RemoveCONNSecurityProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteSecurityProfileRequest();
        ...
        private Amazon.Connect.Model.DeleteSecurityProfileResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteSecurityProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteSecurityProfile");
            try
            {
                #if DESKTOP
                return client.DeleteSecurityProfile(request);
                #elif CORECLR
                return client.DeleteSecurityProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String SecurityProfileId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteSecurityProfileResponse, RemoveCONNSecurityProfileCmdlet, object> Select { get; set; } =
