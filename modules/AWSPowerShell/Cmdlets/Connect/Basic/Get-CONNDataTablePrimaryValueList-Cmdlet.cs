...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class GetCONNDataTablePrimaryValueListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Optional filter to retrieve primary values matching specific criteria.</para><para />
        ...
        /// describe records by ID. If NextToken is provided, this parameter is ignored.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Connect.Model.ListDataTablePrimaryValuesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListDataTablePrimaryValuesRequest request)
        {
            ...
            try
            {
                return client.ListDataTablePrimaryValuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
