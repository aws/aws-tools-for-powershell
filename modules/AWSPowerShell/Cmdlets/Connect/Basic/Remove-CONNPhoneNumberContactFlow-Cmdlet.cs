...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service DisassociatePhoneNumberContactFlow API operation.", Operation = new[] {"DisassociatePhoneNumberContactFlow"}, SelectReturnType = typeof(Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCONNPhoneNumberContactFlowCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNPhoneNumberContactFlow (DisassociatePhoneNumberContactFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse, RemoveCONNPhoneNumberContactFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DisassociatePhoneNumberContactFlowRequest();
        ...
        private Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DisassociatePhoneNumberContactFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DisassociatePhoneNumberContactFlow");
            try
            {
                #if DESKTOP
                return client.DisassociatePhoneNumberContactFlow(request);
                #elif CORECLR
                return client.DisassociatePhoneNumberContactFlowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String PhoneNumberId { get; set; }
            public System.Func<Amazon.Connect.Model.DisassociatePhoneNumberContactFlowResponse, RemoveCONNPhoneNumberContactFlowCmdlet, object> Select { get; set; } =
