...
{
    /// <summary>
    /// Searches queues in an Connect Customer instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class SearchCONNQueueCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.SearchQueuesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchQueuesRequest request)
        {
            ...
            try
            {
                return client.SearchQueuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
