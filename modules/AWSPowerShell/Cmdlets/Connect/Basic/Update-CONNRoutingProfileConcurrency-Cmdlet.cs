...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateRoutingProfileConcurrencyResponse",
        ...
        "The service response (type Amazon.Connect.Model.UpdateRoutingProfileConcurrencyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCONNRoutingProfileConcurrencyCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.UpdateRoutingProfileConcurrencyResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateRoutingProfileConcurrencyRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateRoutingProfileConcurrency(request);
                #elif CORECLR
                return client.UpdateRoutingProfileConcurrencyAsync(request).GetAwaiter().GetResult();
                #else
