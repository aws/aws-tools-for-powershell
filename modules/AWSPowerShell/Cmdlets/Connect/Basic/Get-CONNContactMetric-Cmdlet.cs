...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class GetCONNContactMetricCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of contact level metrics to retrieve.Supported metrics include POSITION_IN_QUEUE
        /// (the contact's current position in the queue) and ESTIMATED_WAIT_TIME (the predicted
        /// time in seconds until the contact is connected to an agent)</para><para />
