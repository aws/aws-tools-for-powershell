...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("Amazon.Connect.Model.TaskTemplateMetadata or Amazon.Connect.Model.ListTaskTemplatesResponse",
        ...
        "The service call response (type Amazon.Connect.Model.ListTaskTemplatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCONNTaskTemplateListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.ListTaskTemplatesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListTaskTemplatesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListTaskTemplates(request);
                #elif CORECLR
                return client.ListTaskTemplatesAsync(request).GetAwaiter().GetResult();
                #else
