...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CONNRoutingProfileDefaultOutboundQueue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCONNRoutingProfileDefaultOutboundQueueCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNRoutingProfileDefaultOutboundQueue (UpdateRoutingProfileDefaultOutboundQueue)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateRoutingProfileDefaultOutboundQueueResponse, UpdateCONNRoutingProfileDefaultOutboundQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateRoutingProfileDefaultOutboundQueueRequest();
        ...
        private Amazon.Connect.Model.UpdateRoutingProfileDefaultOutboundQueueResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateRoutingProfileDefaultOutboundQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateRoutingProfileDefaultOutboundQueue");
            try
            {
                #if DESKTOP
                return client.UpdateRoutingProfileDefaultOutboundQueue(request);
                #elif CORECLR
                return client.UpdateRoutingProfileDefaultOutboundQueueAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String RoutingProfileId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateRoutingProfileDefaultOutboundQueueResponse, UpdateCONNRoutingProfileDefaultOutboundQueueCmdlet, object> Select { get; set; } =
