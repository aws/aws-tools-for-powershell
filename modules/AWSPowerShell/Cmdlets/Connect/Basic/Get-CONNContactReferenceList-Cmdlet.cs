...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("Amazon.Connect.Model.ReferenceSummary")]
    ...
    public partial class GetCONNContactReferenceListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        #region Parameter ReferenceType
        /// <summary>
        /// <para>
        /// <para>The type of reference.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReferenceSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.ListContactReferencesResponse, GetCONNContactReferenceListCmdlet>(Select) ??
            ...
            {
                context.ReferenceType = new List<System.String>(this.ReferenceType);
            }
            #if MODULAR
            if (this.ReferenceType == null && ParameterWasBound(nameof(this.ReferenceType)))
            {
                WriteWarning("You are passing $null as a value for parameter ReferenceType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.ListContactReferencesRequest();
            ...
            if (cmdletContext.ReferenceType != null)
            {
                request.ReferenceTypes = cmdletContext.ReferenceType;
            }
        ...
        private Amazon.Connect.Model.ListContactReferencesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListContactReferencesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ListContactReferences");
            try
            {
                return client.ListContactReferencesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> ReferenceType { get; set; }
            public System.Func<Amazon.Connect.Model.ListContactReferencesResponse, GetCONNContactReferenceListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReferenceSummaryList;
        }
