...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Get", "CONNTaskTemplate")]
    [OutputType("Amazon.Connect.Model.GetTaskTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service GetTaskTemplate API operation.", Operation = new[] {"GetTaskTemplate"}, SelectReturnType = typeof(Amazon.Connect.Model.GetTaskTemplateResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.GetTaskTemplateResponse",
        "This cmdlet returns an Amazon.Connect.Model.GetTaskTemplateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCONNTaskTemplateCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        #region Parameter SnapshotVersion
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String SnapshotVersion { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.GetTaskTemplateResponse, GetCONNTaskTemplateCmdlet>(Select) ??
            ...
            #endif
            context.SnapshotVersion = this.SnapshotVersion;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.GetTaskTemplateRequest();
            
            if (cmdletContext.InstanceId != null)
            {
                request.InstanceId = cmdletContext.InstanceId;
            }
            if (cmdletContext.SnapshotVersion != null)
            {
                request.SnapshotVersion = cmdletContext.SnapshotVersion;
            }
        ...
        private Amazon.Connect.Model.GetTaskTemplateResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.GetTaskTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "GetTaskTemplate");
            try
            {
                #if DESKTOP
                return client.GetTaskTemplate(request);
                #elif CORECLR
                return client.GetTaskTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SnapshotVersion { get; set; }
            public System.String TaskTemplateId { get; set; }
            public System.Func<Amazon.Connect.Model.GetTaskTemplateResponse, GetCONNTaskTemplateCmdlet, object> Select { get; set; } =
