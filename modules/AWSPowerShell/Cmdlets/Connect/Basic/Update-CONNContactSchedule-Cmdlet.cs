...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CONNContactSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCONNContactScheduleCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNContactSchedule (UpdateContactSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateContactScheduleResponse, UpdateCONNContactScheduleCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.ScheduledTime == null && ParameterWasBound(nameof(this.ScheduledTime)))
            {
                WriteWarning("You are passing $null as a value for parameter ScheduledTime which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateContactScheduleRequest();
        ...
        private Amazon.Connect.Model.UpdateContactScheduleResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateContactScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateContactSchedule");
            try
            {
                #if DESKTOP
                return client.UpdateContactSchedule(request);
                #elif CORECLR
                return client.UpdateContactScheduleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.DateTime? ScheduledTime { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateContactScheduleResponse, UpdateCONNContactScheduleCmdlet, object> Select { get; set; } =
