...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "CONNQueueQuickConnect", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCONNQueueQuickConnectCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The quick connects to disassociate from the queue.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNQueueQuickConnect (DisassociateQueueQuickConnects)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DisassociateQueueQuickConnectsResponse, RemoveCONNQueueQuickConnectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DisassociateQueueQuickConnectsRequest();
        ...
        private Amazon.Connect.Model.DisassociateQueueQuickConnectsResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DisassociateQueueQuickConnectsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DisassociateQueueQuickConnects");
            try
            {
                return client.DisassociateQueueQuickConnectsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Connect.Model.DisassociateQueueQuickConnectsResponse, RemoveCONNQueueQuickConnectCmdlet, object> Select { get; set; } =
