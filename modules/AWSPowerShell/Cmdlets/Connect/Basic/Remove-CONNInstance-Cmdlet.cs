...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "CONNInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCONNInstanceCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNInstance (DeleteInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteInstanceResponse, RemoveCONNInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteInstanceRequest();
        ...
        private Amazon.Connect.Model.DeleteInstanceResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteInstance");
            try
            {
                return client.DeleteInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteInstanceResponse, RemoveCONNInstanceCmdlet, object> Select { get; set; } =
