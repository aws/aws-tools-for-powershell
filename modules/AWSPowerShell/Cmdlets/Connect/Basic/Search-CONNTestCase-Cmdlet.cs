...
{
    /// <summary>
    /// Searches for test cases in the specified Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNTestCase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchTestCasesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchTestCases API operation.", Operation = new[] {"SearchTestCases"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchTestCasesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchTestCasesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchTestCasesResponse object containing multiple properties."
    )]
    public partial class SearchCONNTestCaseCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.TestCaseSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.TestCaseSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The status of the test case.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.Connect.TestCaseStatus")]
        public Amazon.Connect.TestCaseStatus SearchCriteria_StatusCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchTestCasesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchTestCasesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNTestCase (SearchTestCases)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchTestCasesResponse, SearchCONNTestCaseCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.TestCaseSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.TestCaseSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchTestCasesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.TestCaseSearchCriteria();
            List<Amazon.Connect.Model.TestCaseSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.TestCaseSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            Amazon.Connect.TestCaseStatus requestSearchCriteria_searchCriteria_StatusCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.TestCaseSearchFilter();
        ...
        private Amazon.Connect.Model.SearchTestCasesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchTestCasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchTestCases");
            try
            {
                #if DESKTOP
                return client.SearchTestCases(request);
                #elif CORECLR
                return client.SearchTestCasesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.TestCaseSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.TestCaseSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.TestCaseStatus SearchCriteria_StatusCondition { get; set; }
            public Amazon.Connect.StringComparisonType SearchCriteria_StringCondition_ComparisonType { get; set; }
            public System.String SearchCriteria_StringCondition_FieldName { get; set; }
            public System.String SearchCriteria_StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchTestCasesResponse, SearchCONNTestCaseCmdlet, object> Select { get; set; } =
