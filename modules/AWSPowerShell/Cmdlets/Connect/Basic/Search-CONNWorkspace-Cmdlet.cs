...
{
    /// <summary>
    /// Searches workspaces based on name, description, visibility, or tags.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNWorkspace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchWorkspacesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchWorkspaces API operation.", Operation = new[] {"SearchWorkspaces"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchWorkspacesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchWorkspacesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchWorkspacesResponse object containing multiple properties."
    )]
    public partial class SearchCONNWorkspaceCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.WorkspaceSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.WorkspaceSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchWorkspacesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchWorkspacesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNWorkspace (SearchWorkspaces)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchWorkspacesResponse, SearchCONNWorkspaceCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.WorkspaceSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.WorkspaceSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchWorkspacesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.WorkspaceSearchCriteria();
            List<Amazon.Connect.Model.WorkspaceSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.WorkspaceSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.WorkspaceSearchFilter();
        ...
        private Amazon.Connect.Model.SearchWorkspacesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchWorkspacesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchWorkspaces");
            try
            {
                #if DESKTOP
                return client.SearchWorkspaces(request);
                #elif CORECLR
                return client.SearchWorkspacesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.WorkspaceSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.WorkspaceSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String TagCondition_TagKey { get; set; }
            public System.String TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchWorkspacesResponse, SearchCONNWorkspaceCmdlet, object> Select { get; set; } =
