...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("New", "CONNDataTableAttribute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.CreateDataTableAttributeResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service CreateDataTableAttribute API operation.", Operation = new[] {"CreateDataTableAttribute"}, SelectReturnType = typeof(Amazon.Connect.Model.CreateDataTableAttributeResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.CreateDataTableAttributeResponse",
        "This cmdlet returns an Amazon.Connect.Model.CreateDataTableAttributeResponse object containing multiple properties."
    )]
    public partial class NewCONNDataTableAttributeCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An optional description for the attribute. Must conform to Connect human readable
        /// string specification and have 0-250 characters. Whitespace trimmed before persisting.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name for the attribute. Must conform to Connect human readable string specification
        ...
        /// data table using case-insensitive comparison.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Optional boolean that defaults to false. Determines if the value is used to identify
        /// a record in the table. Values for primary attributes must not be expressions.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The type of value allowed or the resultant type after the value's expression is evaluated.
        /// Must be one of TEXT, TEXT_LIST, NUMBER, NUMBER_LIST, and BOOLEAN.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.CreateDataTableAttributeResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.CreateDataTableAttributeResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNDataTableAttribute (CreateDataTableAttribute)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateDataTableAttributeResponse, NewCONNDataTableAttributeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateDataTableAttributeRequest();
        ...
        private Amazon.Connect.Model.CreateDataTableAttributeResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateDataTableAttributeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateDataTableAttribute");
            try
            {
                #if DESKTOP
                return client.CreateDataTableAttribute(request);
                #elif CORECLR
                return client.CreateDataTableAttributeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Double? Validation_MultipleOf { get; set; }
            public Amazon.Connect.DataTableAttributeValueType ValueType { get; set; }
            public System.Func<Amazon.Connect.Model.CreateDataTableAttributeResponse, NewCONNDataTableAttributeCmdlet, object> Select { get; set; } =
