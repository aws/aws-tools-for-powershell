...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service UpdateUserHierarchy API operation.", Operation = new[] {"UpdateUserHierarchy"}, SelectReturnType = typeof(Amazon.Connect.Model.UpdateUserHierarchyResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateUserHierarchyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.UpdateUserHierarchyResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCONNUserHierarchyCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateUserHierarchyResponse, UpdateCONNUserHierarchyCmdlet>(Select) ??
        ...
        private Amazon.Connect.Model.UpdateUserHierarchyResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateUserHierarchyRequest request)
        {
            ...
            try
            {
                return client.UpdateUserHierarchyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateUserHierarchyResponse, UpdateCONNUserHierarchyCmdlet, object> Select { get; set; } =
