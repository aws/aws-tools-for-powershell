...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CONNUserHierarchyGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCONNUserHierarchyGroupCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNUserHierarchyGroup (DeleteUserHierarchyGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteUserHierarchyGroupResponse, RemoveCONNUserHierarchyGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteUserHierarchyGroupRequest();
        ...
        private Amazon.Connect.Model.DeleteUserHierarchyGroupResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteUserHierarchyGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteUserHierarchyGroup");
            try
            {
                #if DESKTOP
                return client.DeleteUserHierarchyGroup(request);
                #elif CORECLR
                return client.DeleteUserHierarchyGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String HierarchyGroupId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteUserHierarchyGroupResponse, RemoveCONNUserHierarchyGroupCmdlet, object> Select { get; set; } =
