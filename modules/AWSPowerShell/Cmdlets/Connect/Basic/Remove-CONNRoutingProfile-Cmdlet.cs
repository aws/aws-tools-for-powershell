...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.DeleteRoutingProfileResponse",
        ...
        "The service response (type Amazon.Connect.Model.DeleteRoutingProfileResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCONNRoutingProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteRoutingProfileResponse, RemoveCONNRoutingProfileCmdlet>(Select) ??
        ...
        private Amazon.Connect.Model.DeleteRoutingProfileResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteRoutingProfileRequest request)
        {
            ...
            try
            {
                return client.DeleteRoutingProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String RoutingProfileId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteRoutingProfileResponse, RemoveCONNRoutingProfileCmdlet, object> Select { get; set; } =
