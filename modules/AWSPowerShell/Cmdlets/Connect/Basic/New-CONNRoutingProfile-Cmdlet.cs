...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("Amazon.Connect.Model.CreateRoutingProfileResponse",
        "This cmdlet returns an Amazon.Connect.Model.CreateRoutingProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCONNRoutingProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.Connect.Model.CreateRoutingProfileResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateRoutingProfileRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateRoutingProfile(request);
                #elif CORECLR
                return client.CreateRoutingProfileAsync(request).GetAwaiter().GetResult();
                #else
