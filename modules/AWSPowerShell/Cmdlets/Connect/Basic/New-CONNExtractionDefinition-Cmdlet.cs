...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("New", "CONNExtractionDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.CreateExtractionDefinitionResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service CreateExtractionDefinition API operation.", Operation = new[] {"CreateExtractionDefinition"}, SelectReturnType = typeof(Amazon.Connect.Model.CreateExtractionDefinitionResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.CreateExtractionDefinitionResponse",
        "This cmdlet returns an Amazon.Connect.Model.CreateExtractionDefinitionResponse object containing multiple properties."
    )]
    public partial class NewCONNExtractionDefinitionCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique name of the extraction definition.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.CreateExtractionDefinitionResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.CreateExtractionDefinitionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CONNExtractionDefinition (CreateExtractionDefinition)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.CreateExtractionDefinitionResponse, NewCONNExtractionDefinitionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.CreateExtractionDefinitionRequest();
        ...
        private Amazon.Connect.Model.CreateExtractionDefinitionResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.CreateExtractionDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "CreateExtractionDefinition");
            try
            {
                return client.CreateExtractionDefinitionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Connect.Model.CreateExtractionDefinitionResponse, NewCONNExtractionDefinitionCmdlet, object> Select { get; set; } =
