...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Update", "CONNRoutingProfileAgentAvailabilityTimer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCONNRoutingProfileAgentAvailabilityTimerCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNRoutingProfileAgentAvailabilityTimer (UpdateRoutingProfileAgentAvailabilityTimer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerResponse, UpdateCONNRoutingProfileAgentAvailabilityTimerCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.AgentAvailabilityTimer = this.AgentAvailabilityTimer;
            #if MODULAR
            if (this.AgentAvailabilityTimer == null && ParameterWasBound(nameof(this.AgentAvailabilityTimer)))
            {
                WriteWarning("You are passing $null as a value for parameter AgentAvailabilityTimer which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerRequest();
        ...
        private Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateRoutingProfileAgentAvailabilityTimer");
            try
            {
                #if DESKTOP
                return client.UpdateRoutingProfileAgentAvailabilityTimer(request);
                #elif CORECLR
                return client.UpdateRoutingProfileAgentAvailabilityTimerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InstanceId { get; set; }
            public System.String RoutingProfileId { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateRoutingProfileAgentAvailabilityTimerResponse, UpdateCONNRoutingProfileAgentAvailabilityTimerCmdlet, object> Select { get; set; } =
