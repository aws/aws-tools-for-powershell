...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </summary>
    [Cmdlet("Invoke", "CONNResumeContact", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class InvokeCONNResumeContactCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.ResumeContactResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-CONNResumeContact (ResumeContact)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.ResumeContactResponse, InvokeCONNResumeContactCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.ResumeContactRequest();
        ...
        private Amazon.Connect.Model.ResumeContactResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ResumeContactRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ResumeContact");
            try
            {
                #if DESKTOP
                return client.ResumeContact(request);
                #elif CORECLR
                return client.ResumeContactAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ContactId { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.Connect.Model.ResumeContactResponse, InvokeCONNResumeContactCmdlet, object> Select { get; set; } =
