...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class RemoveCONNQuickConnectCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CONNQuickConnect (DeleteQuickConnect)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DeleteQuickConnectResponse, RemoveCONNQuickConnectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DeleteQuickConnectRequest();
        ...
        private Amazon.Connect.Model.DeleteQuickConnectResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DeleteQuickConnectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DeleteQuickConnect");
            try
            {
                #if DESKTOP
                return client.DeleteQuickConnect(request);
                #elif CORECLR
                return client.DeleteQuickConnectAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String QuickConnectId { get; set; }
            public System.Func<Amazon.Connect.Model.DeleteQuickConnectResponse, RemoveCONNQuickConnectCmdlet, object> Select { get; set; } =
