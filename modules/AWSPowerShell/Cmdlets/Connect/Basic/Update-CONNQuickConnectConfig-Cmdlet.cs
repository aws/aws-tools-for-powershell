...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateQuickConnectConfigResponse",
        ...
        "The service response (type Amazon.Connect.Model.UpdateQuickConnectConfigResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
