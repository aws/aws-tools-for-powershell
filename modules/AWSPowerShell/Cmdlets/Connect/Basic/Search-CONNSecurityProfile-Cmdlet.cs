...
{
    /// <summary>
    /// Searches security profiles in an Amazon Connect instance, with optional filtering.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Search", "CONNSecurityProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Connect.Model.SearchSecurityProfilesResponse")]
    [AWSCmdlet("Calls the Amazon Connect Service SearchSecurityProfiles API operation.", Operation = new[] {"SearchSecurityProfiles"}, SelectReturnType = typeof(Amazon.Connect.Model.SearchSecurityProfilesResponse))]
    [AWSCmdletOutput("Amazon.Connect.Model.SearchSecurityProfilesResponse",
        "This cmdlet returns an Amazon.Connect.Model.SearchSecurityProfilesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchCONNSecurityProfileCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.Model.SecurityProfileSearchCriteria[] SearchCriteria_AndCondition { get; set; }
        #endregion
        ...
        public Amazon.Connect.Model.SecurityProfileSearchCriteria[] SearchCriteria_OrCondition { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Connect.Model.SearchSecurityProfilesResponse).
        /// Specifying the name of a property of type Amazon.Connect.Model.SearchSecurityProfilesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-CONNSecurityProfile (SearchSecurityProfiles)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.SearchSecurityProfilesResponse, SearchCONNSecurityProfileCmdlet>(Select) ??
            ...
            {
                context.SearchCriteria_AndCondition = new List<Amazon.Connect.Model.SecurityProfileSearchCriteria>(this.SearchCriteria_AndCondition);
            }
            if (this.SearchCriteria_OrCondition != null)
            {
                context.SearchCriteria_OrCondition = new List<Amazon.Connect.Model.SecurityProfileSearchCriteria>(this.SearchCriteria_OrCondition);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.SearchSecurityProfilesRequest();
            ...
            request.SearchCriteria = new Amazon.Connect.Model.SecurityProfileSearchCriteria();
            List<Amazon.Connect.Model.SecurityProfileSearchCriteria> requestSearchCriteria_searchCriteria_AndCondition = null;
            ...
            List<Amazon.Connect.Model.SecurityProfileSearchCriteria> requestSearchCriteria_searchCriteria_OrCondition = null;
            ...
            request.SearchFilter = new Amazon.Connect.Model.SecurityProfilesSearchFilter();
        ...
        private Amazon.Connect.Model.SearchSecurityProfilesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.SearchSecurityProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "SearchSecurityProfiles");
            try
            {
                #if DESKTOP
                return client.SearchSecurityProfiles(request);
                #elif CORECLR
                return client.SearchSecurityProfilesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.Connect.Model.SecurityProfileSearchCriteria> SearchCriteria_AndCondition { get; set; }
            public List<Amazon.Connect.Model.SecurityProfileSearchCriteria> SearchCriteria_OrCondition { get; set; }
            public Amazon.Connect.StringComparisonType StringCondition_ComparisonType { get; set; }
            public System.String StringCondition_FieldName { get; set; }
            public System.String StringCondition_Value { get; set; }
            ...
            public System.String SearchFilter_TagFilter_TagCondition_TagKey { get; set; }
            public System.String SearchFilter_TagFilter_TagCondition_TagValue { get; set; }
            public System.Func<Amazon.Connect.Model.SearchSecurityProfilesResponse, SearchCONNSecurityProfileCmdlet, object> Select { get; set; } =
