...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    public partial class AddCONNInstanceStorageConfigCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The full ARN of the encryption key. </para><note><para>Be sure to provide the full ARN of the encryption key, not just the ID.</para><para>Connect Customer supports only KMS keys with the default key spec of <a href="https://docs.aws.amazon.com/kms/latest/developerguide/asymmetric-key-specs.html#key-spec-symmetric-default"><c>SYMMETRIC_DEFAULT</c></a>. </para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A valid resource type. To <a href="https://docs.aws.amazon.com/connect/latest/adminguide/enable-contact-analysis-segment-streams.html">enable
        /// streaming for real-time analysis of contacts</a>, use the following types:</para><ul><li><para>For chat contacts, use <c>REAL_TIME_CONTACT_ANALYSIS_CHAT_SEGMENTS</c>.</para></li><li><para>For voice contacts, use <c>REAL_TIME_CONTACT_ANALYSIS_VOICE_SEGMENTS</c>.</para></li></ul><note><para><c>REAL_TIME_CONTACT_ANALYSIS_SEGMENTS</c> is deprecated, but it is still supported
        /// and will apply only to VOICE channel contacts. Use <c>REAL_TIME_CONTACT_ANALYSIS_VOICE_SEGMENTS</c>
        /// for voice contacts moving forward.</para><para>If you have previously associated a stream with <c>REAL_TIME_CONTACT_ANALYSIS_SEGMENTS</c>,
        /// no action is needed to update the stream to <c>REAL_TIME_CONTACT_ANALYSIS_VOICE_SEGMENTS</c>.</para></note>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CONNInstanceStorageConfig (AssociateInstanceStorageConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.AssociateInstanceStorageConfigResponse, AddCONNInstanceStorageConfigCmdlet>(Select) ??
        ...
        private Amazon.Connect.Model.AssociateInstanceStorageConfigResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.AssociateInstanceStorageConfigRequest request)
        {
            ...
            try
            {
                return client.AssociateInstanceStorageConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StorageConfigS3ConfigEncryptionConfigKeyId { get; set; }
            public Amazon.Connect.StorageType StorageConfig_StorageType { get; set; }
            public System.Func<Amazon.Connect.Model.AssociateInstanceStorageConfigResponse, AddCONNInstanceStorageConfigCmdlet, object> Select { get; set; } =
