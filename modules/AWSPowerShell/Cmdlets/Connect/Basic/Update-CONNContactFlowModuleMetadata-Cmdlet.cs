...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Service UpdateContactFlowModuleMetadata API operation.", Operation = new[] {"UpdateContactFlowModuleMetadata"}, SelectReturnType = typeof(Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse))]
    [AWSCmdletOutput("None or Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCONNContactFlowModuleMetadataCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public Amazon.Connect.ContactFlowModuleState State { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNContactFlowModuleMetadata (UpdateContactFlowModuleMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse, UpdateCONNContactFlowModuleMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateContactFlowModuleMetadataRequest();
        ...
        private Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateContactFlowModuleMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateContactFlowModuleMetadata");
            try
            {
                #if DESKTOP
                return client.UpdateContactFlowModuleMetadata(request);
                #elif CORECLR
                return client.UpdateContactFlowModuleMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.Connect.ContactFlowModuleState State { get; set; }
            public System.Func<Amazon.Connect.Model.UpdateContactFlowModuleMetadataResponse, UpdateCONNContactFlowModuleMetadataCmdlet, object> Select { get; set; } =
