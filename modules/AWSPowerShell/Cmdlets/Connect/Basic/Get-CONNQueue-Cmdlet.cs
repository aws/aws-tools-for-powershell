...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "CONNQueue")]
    [OutputType("Amazon.Connect.Model.Queue")]
    ...
    public partial class GetCONNQueueCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Connect.Model.DescribeQueueResponse, GetCONNQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.DescribeQueueRequest();
        ...
        private Amazon.Connect.Model.DescribeQueueResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.DescribeQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "DescribeQueue");
            try
            {
                #if DESKTOP
                return client.DescribeQueue(request);
                #elif CORECLR
                return client.DescribeQueueAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Connect.Model.DescribeQueueResponse, GetCONNQueueCmdlet, object> Select { get; set; } =
