...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdletOutput("None or Amazon.Connect.Model.DisassociateUserProficienciesResponse",
        ...
        "The service response (type Amazon.Connect.Model.DisassociateUserProficienciesResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
