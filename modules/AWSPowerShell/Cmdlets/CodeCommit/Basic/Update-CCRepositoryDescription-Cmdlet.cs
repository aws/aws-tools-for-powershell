...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CodeCommit UpdateRepositoryDescription API operation.", Operation = new[] {"UpdateRepositoryDescription"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse))]
    [AWSCmdletOutput("None or Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCCRepositoryDescriptionCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse, UpdateCCRepositoryDescriptionCmdlet>(Select) ??
        ...
        private Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.UpdateRepositoryDescriptionRequest request)
        {
            ...
            try
            {
                return client.UpdateRepositoryDescriptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RepositoryDescription { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.CodeCommit.Model.UpdateRepositoryDescriptionResponse, UpdateCCRepositoryDescriptionCmdlet, object> Select { get; set; } =
