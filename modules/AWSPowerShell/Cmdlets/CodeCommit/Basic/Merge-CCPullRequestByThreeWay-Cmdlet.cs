...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Merge", "CCPullRequestByThreeWay", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class MergeCCPullRequestByThreeWayCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Merge-CCPullRequestByThreeWay (MergePullRequestByThreeWay)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.MergePullRequestByThreeWayResponse, MergeCCPullRequestByThreeWayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.MergePullRequestByThreeWayRequest();
        ...
        private Amazon.CodeCommit.Model.MergePullRequestByThreeWayResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.MergePullRequestByThreeWayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "MergePullRequestByThreeWay");
            try
            {
                #if DESKTOP
                return client.MergePullRequestByThreeWay(request);
                #elif CORECLR
                return client.MergePullRequestByThreeWayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RepositoryName { get; set; }
            public System.String SourceCommitId { get; set; }
            public System.Func<Amazon.CodeCommit.Model.MergePullRequestByThreeWayResponse, MergeCCPullRequestByThreeWayCmdlet, object> Select { get; set; } =
