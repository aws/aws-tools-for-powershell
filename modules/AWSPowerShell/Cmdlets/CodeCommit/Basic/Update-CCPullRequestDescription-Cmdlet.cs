...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit UpdatePullRequestDescription API operation.", Operation = new[] {"UpdatePullRequestDescription"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse))]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.PullRequest or Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse",
        "This cmdlet returns an Amazon.CodeCommit.Model.PullRequest object.",
        "The service call response (type Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCCPullRequestDescriptionCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse, UpdateCCPullRequestDescriptionCmdlet>(Select) ??
        ...
        private Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.UpdatePullRequestDescriptionRequest request)
        {
            ...
            try
            {
                return client.UpdatePullRequestDescriptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String PullRequestId { get; set; }
            public System.Func<Amazon.CodeCommit.Model.UpdatePullRequestDescriptionResponse, UpdateCCPullRequestDescriptionCmdlet, object> Select { get; set; } =
