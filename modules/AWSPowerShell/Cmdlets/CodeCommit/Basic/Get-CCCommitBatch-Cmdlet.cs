...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    public partial class GetCCCommitBatchCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The full commit IDs of the commits to get information about.</para><note><para>You must supply the full SHA IDs of each commit. You cannot use shortened SHA IDs.</para></note><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.BatchGetCommitsResponse, GetCCCommitBatchCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.CommitId != null)
            {
                context.CommitId = new List<System.String>(this.CommitId);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.BatchGetCommitsRequest();
            
            if (cmdletContext.CommitId != null)
            {
                request.CommitIds = cmdletContext.CommitId;
            }
        ...
        private Amazon.CodeCommit.Model.BatchGetCommitsResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.BatchGetCommitsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "BatchGetCommits");
            try
            {
                return client.BatchGetCommitsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> CommitId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.CodeCommit.Model.BatchGetCommitsResponse, GetCCCommitBatchCmdlet, object> Select { get; set; } =
