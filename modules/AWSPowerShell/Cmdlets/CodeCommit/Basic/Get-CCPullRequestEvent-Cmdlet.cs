...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit DescribePullRequestEvents API operation.", Operation = new[] {"DescribePullRequestEvents"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.DescribePullRequestEventsResponse))]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.PullRequestEvent or Amazon.CodeCommit.Model.DescribePullRequestEventsResponse",
        "This cmdlet returns a collection of Amazon.CodeCommit.Model.PullRequestEvent objects.",
        "The service call response (type Amazon.CodeCommit.Model.DescribePullRequestEventsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCCPullRequestEventCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PullRequestEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.DescribePullRequestEventsResponse, GetCCPullRequestEventCmdlet>(Select) ??
        ...
        private Amazon.CodeCommit.Model.DescribePullRequestEventsResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.DescribePullRequestEventsRequest request)
        {
            ...
            try
            {
                return client.DescribePullRequestEventsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CodeCommit.PullRequestEventType PullRequestEventType { get; set; }
            public System.String PullRequestId { get; set; }
            public System.Func<Amazon.CodeCommit.Model.DescribePullRequestEventsResponse, GetCCPullRequestEventCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PullRequestEvents;
        }
