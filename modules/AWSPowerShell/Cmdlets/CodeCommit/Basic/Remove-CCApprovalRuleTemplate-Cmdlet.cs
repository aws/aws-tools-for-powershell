...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CCApprovalRuleTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS CodeCommit DeleteApprovalRuleTemplate API operation.", Operation = new[] {"DeleteApprovalRuleTemplate"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCCApprovalRuleTemplateCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "ApprovalRuleTemplateId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CCApprovalRuleTemplate (DeleteApprovalRuleTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse, RemoveCCApprovalRuleTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateRequest();
        ...
        private Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "DeleteApprovalRuleTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteApprovalRuleTemplate(request);
                #elif CORECLR
                return client.DeleteApprovalRuleTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApprovalRuleTemplateName { get; set; }
            public System.Func<Amazon.CodeCommit.Model.DeleteApprovalRuleTemplateResponse, RemoveCCApprovalRuleTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ApprovalRuleTemplateId;
        }
