...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Merge", "CCBranchesByThreeWay", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class MergeCCBranchesByThreeWayCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Merge-CCBranchesByThreeWay (MergeBranchesByThreeWay)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.MergeBranchesByThreeWayResponse, MergeCCBranchesByThreeWayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.MergeBranchesByThreeWayRequest();
        ...
        private Amazon.CodeCommit.Model.MergeBranchesByThreeWayResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.MergeBranchesByThreeWayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "MergeBranchesByThreeWay");
            try
            {
                #if DESKTOP
                return client.MergeBranchesByThreeWay(request);
                #elif CORECLR
                return client.MergeBranchesByThreeWayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SourceCommitSpecifier { get; set; }
            public System.String TargetBranch { get; set; }
            public System.Func<Amazon.CodeCommit.Model.MergeBranchesByThreeWayResponse, MergeCCBranchesByThreeWayCmdlet, object> Select { get; set; } =
