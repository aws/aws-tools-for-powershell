...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit UpdatePullRequestStatus API operation.", Operation = new[] {"UpdatePullRequestStatus"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.UpdatePullRequestStatusResponse))]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.PullRequest or Amazon.CodeCommit.Model.UpdatePullRequestStatusResponse",
        "This cmdlet returns an Amazon.CodeCommit.Model.PullRequest object.",
        "The service call response (type Amazon.CodeCommit.Model.UpdatePullRequestStatusResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateCCPullRequestStatusCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PullRequestStatus' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.UpdatePullRequestStatusResponse, UpdateCCPullRequestStatusCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.PullRequestStatus;
            }
            ...
            #if MODULAR
            if (this.PullRequestStatus == null && ParameterWasBound(nameof(this.PullRequestStatus)))
            {
                WriteWarning("You are passing $null as a value for parameter PullRequestStatus which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PullRequestId { get; set; }
            public Amazon.CodeCommit.PullRequestStatusEnum PullRequestStatus { get; set; }
            public System.Func<Amazon.CodeCommit.Model.UpdatePullRequestStatusResponse, UpdateCCPullRequestStatusCmdlet, object> Select { get; set; } =
