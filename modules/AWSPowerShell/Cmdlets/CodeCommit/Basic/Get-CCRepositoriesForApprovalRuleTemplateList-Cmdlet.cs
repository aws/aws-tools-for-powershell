...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCRepositoriesForApprovalRuleTemplateList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS CodeCommit ListRepositoriesForApprovalRuleTemplate API operation.", Operation = new[] {"ListRepositoriesForApprovalRuleTemplate"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCCRepositoriesForApprovalRuleTemplateListCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RepositoryNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse, GetCCRepositoriesForApprovalRuleTemplateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateRequest();
        ...
        private Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "ListRepositoriesForApprovalRuleTemplate");
            try
            {
                #if DESKTOP
                return client.ListRepositoriesForApprovalRuleTemplate(request);
                #elif CORECLR
                return client.ListRepositoriesForApprovalRuleTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodeCommit.Model.ListRepositoriesForApprovalRuleTemplateResponse, GetCCRepositoriesForApprovalRuleTemplateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RepositoryNames;
        }
