...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCPullRequestList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS CodeCommit ListPullRequests API operation.", Operation = new[] {"ListPullRequests"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.ListPullRequestsResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeCommit.Model.ListPullRequestsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CodeCommit.Model.ListPullRequestsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCCPullRequestListCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        public System.String AuthorArn { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PullRequestIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.ListPullRequestsResponse, GetCCPullRequestListCmdlet>(Select) ??
            ...
            context.AuthorArn = this.AuthorArn;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeCommit.Model.ListPullRequestsRequest();
            
            if (cmdletContext.AuthorArn != null)
            {
                request.AuthorArn = cmdletContext.AuthorArn;
            }
        ...
        private Amazon.CodeCommit.Model.ListPullRequestsResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.ListPullRequestsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CodeCommit.PullRequestStatusEnum PullRequestStatus { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.CodeCommit.Model.ListPullRequestsResponse, GetCCPullRequestListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PullRequestIds;
        }
