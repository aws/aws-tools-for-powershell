...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    public partial class AddCCResourceTagCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key-value pair to use when tagging this repository.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.TagResourceResponse, AddCCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.TagResourceRequest();
        ...
        private Amazon.CodeCommit.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeCommit.Model.TagResourceResponse, AddCCResourceTagCmdlet, object> Select { get; set; } =
