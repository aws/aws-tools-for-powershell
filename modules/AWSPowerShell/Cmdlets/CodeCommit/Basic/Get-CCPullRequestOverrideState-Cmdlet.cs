...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCPullRequestOverrideState")]
    ...
    public partial class GetCCPullRequestOverrideStateCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.GetPullRequestOverrideStateResponse, GetCCPullRequestOverrideStateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCommit.Model.GetPullRequestOverrideStateRequest();
        ...
        private Amazon.CodeCommit.Model.GetPullRequestOverrideStateResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.GetPullRequestOverrideStateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCommit", "GetPullRequestOverrideState");
            try
            {
                #if DESKTOP
                return client.GetPullRequestOverrideState(request);
                #elif CORECLR
                return client.GetPullRequestOverrideStateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PullRequestId { get; set; }
            public System.String RevisionId { get; set; }
            public System.Func<Amazon.CodeCommit.Model.GetPullRequestOverrideStateResponse, GetCCPullRequestOverrideStateCmdlet, object> Select { get; set; } =
