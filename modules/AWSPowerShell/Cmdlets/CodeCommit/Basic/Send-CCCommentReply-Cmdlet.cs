...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit PostCommentReply API operation.", Operation = new[] {"PostCommentReply"}, SelectReturnType = typeof(Amazon.CodeCommit.Model.PostCommentReplyResponse))]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.Comment or Amazon.CodeCommit.Model.PostCommentReplyResponse",
        "This cmdlet returns an Amazon.CodeCommit.Model.Comment object.",
        "The service call response (type Amazon.CodeCommit.Model.PostCommentReplyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SendCCCommentReplyCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCommit.Model.PostCommentReplyResponse, SendCCCommentReplyCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.InReplyTo == null && ParameterWasBound(nameof(this.InReplyTo)))
            {
                WriteWarning("You are passing $null as a value for parameter InReplyTo which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.CodeCommit.Model.PostCommentReplyResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.PostCommentReplyRequest request)
        {
            ...
            try
            {
                return client.PostCommentReplyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Content { get; set; }
            public System.String InReplyTo { get; set; }
            public System.Func<Amazon.CodeCommit.Model.PostCommentReplyResponse, SendCCCommentReplyCmdlet, object> Select { get; set; } =
