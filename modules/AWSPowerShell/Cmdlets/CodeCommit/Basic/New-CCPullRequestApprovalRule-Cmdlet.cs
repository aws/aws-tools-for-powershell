...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdletOutput("Amazon.CodeCommit.Model.ApprovalRule or Amazon.CodeCommit.Model.CreatePullRequestApprovalRuleResponse",
        ...
        "The service call response (type Amazon.CodeCommit.Model.CreatePullRequestApprovalRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCCPullRequestApprovalRuleCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ApprovalRuleContent' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ApprovalRuleContent;
            }
        ...
        private Amazon.CodeCommit.Model.CreatePullRequestApprovalRuleResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.CreatePullRequestApprovalRuleRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreatePullRequestApprovalRule(request);
                #elif CORECLR
                return client.CreatePullRequestApprovalRuleAsync(request).GetAwaiter().GetResult();
                #else
