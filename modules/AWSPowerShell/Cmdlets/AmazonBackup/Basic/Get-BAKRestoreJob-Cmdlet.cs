...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup DescribeRestoreJob API operation.", Operation = new[] {"DescribeRestoreJob"})]
    [AWSCmdletOutput("Amazon.Backup.Model.DescribeRestoreJobResponse",
        "This cmdlet returns a Amazon.Backup.Model.DescribeRestoreJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKRestoreJobCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "DescribeRestoreJob");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeRestoreJobAsync(request);
                return task.Result;
                #else
