...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListBackupPlanTemplates API operation.", Operation = new[] {"ListBackupPlanTemplates"})]
    [AWSCmdletOutput("Amazon.Backup.Model.BackupPlanTemplatesListMember",
        "This cmdlet returns a collection of BackupPlanTemplatesListMember objects.",
    ...
    public partial class GetBAKBackupPlanTemplateListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Backup.Model.ListBackupPlanTemplatesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BackupPlanTemplatesList;
        ...
        private Amazon.Backup.Model.ListBackupPlanTemplatesResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListBackupPlanTemplatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListBackupPlanTemplates");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListBackupPlanTemplatesAsync(request);
                return task.Result;
                #else
