...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup DescribeBackupVault API operation.", Operation = new[] {"DescribeBackupVault"})]
    [AWSCmdletOutput("Amazon.Backup.Model.DescribeBackupVaultResponse",
        "This cmdlet returns a Amazon.Backup.Model.DescribeBackupVaultResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupVaultCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "DescribeBackupVault");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeBackupVaultAsync(request);
                return task.Result;
                #else
