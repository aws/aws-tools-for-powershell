...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListBackupPlans API operation.", Operation = new[] {"ListBackupPlans"})]
    ...
    public partial class GetBAKBackupPlanListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BackupPlansList;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListBackupPlans");
            try
            {
                #if DESKTOP
