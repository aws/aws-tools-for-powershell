...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup UntagResource API operation.", Operation = new[] {"UntagResource"})]
    ...
    public partial class RemoveBAKResourceTagCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "UntagResource");
            try
            {
                #if DESKTOP
