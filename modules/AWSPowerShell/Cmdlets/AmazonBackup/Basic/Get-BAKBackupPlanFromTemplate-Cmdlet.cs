...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup GetBackupPlanFromTemplate API operation.", Operation = new[] {"GetBackupPlanFromTemplate"})]
    ...
    public partial class GetBAKBackupPlanFromTemplateCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.BackupPlanDocument;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "GetBackupPlanFromTemplate");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetBackupPlanFromTemplateAsync(request);
                return task.Result;
                #else
