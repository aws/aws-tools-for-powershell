...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListRecoveryPointsByResource API operation.", Operation = new[] {"ListRecoveryPointsByResource"})]
    [AWSCmdletOutput("Amazon.Backup.Model.RecoveryPointByResource",
        "This cmdlet returns a collection of RecoveryPointByResource objects.",
    ...
    public partial class GetBAKRecoveryPointsByResourceListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        private Amazon.Backup.Model.ListRecoveryPointsByResourceResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListRecoveryPointsByResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListRecoveryPointsByResource");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListRecoveryPointsByResourceAsync(request);
                return task.Result;
                #else
