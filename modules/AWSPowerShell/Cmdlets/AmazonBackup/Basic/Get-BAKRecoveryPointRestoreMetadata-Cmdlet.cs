...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup GetRecoveryPointRestoreMetadata API operation.", Operation = new[] {"GetRecoveryPointRestoreMetadata"})]
    [AWSCmdletOutput("Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse",
        "This cmdlet returns a Amazon.Backup.Model.GetRecoveryPointRestoreMetadataResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKRecoveryPointRestoreMetadataCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "GetRecoveryPointRestoreMetadata");
            try
            {
                #if DESKTOP
