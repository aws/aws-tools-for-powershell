...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup GetBackupVaultNotifications API operation.", Operation = new[] {"GetBackupVaultNotifications"})]
    [AWSCmdletOutput("Amazon.Backup.Model.GetBackupVaultNotificationsResponse",
        "This cmdlet returns a Amazon.Backup.Model.GetBackupVaultNotificationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupVaultNotificationCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "GetBackupVaultNotifications");
            try
            {
                #if DESKTOP
