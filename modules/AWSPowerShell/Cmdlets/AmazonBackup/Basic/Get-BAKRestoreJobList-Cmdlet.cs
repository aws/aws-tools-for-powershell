...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListRestoreJobs API operation.", Operation = new[] {"ListRestoreJobs"})]
    [AWSCmdletOutput("Amazon.Backup.Model.RestoreJobsListMember",
        "This cmdlet returns a collection of RestoreJobsListMember objects.",
    ...
    public partial class GetBAKRestoreJobListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.RestoreJobs;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListRestoreJobs");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListRestoreJobsAsync(request);
                return task.Result;
                #else
