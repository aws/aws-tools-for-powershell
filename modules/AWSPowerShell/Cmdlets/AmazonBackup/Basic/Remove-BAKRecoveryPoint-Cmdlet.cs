...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup DeleteRecoveryPoint API operation.", Operation = new[] {"DeleteRecoveryPoint"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the RecoveryPointArn parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveBAKRecoveryPointCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.RecoveryPointArn;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "DeleteRecoveryPoint");
            try
            {
                #if DESKTOP
                return client.DeleteRecoveryPoint(request);
                #elif CORECLR
                return client.DeleteRecoveryPointAsync(request).GetAwaiter().GetResult();
                #else
