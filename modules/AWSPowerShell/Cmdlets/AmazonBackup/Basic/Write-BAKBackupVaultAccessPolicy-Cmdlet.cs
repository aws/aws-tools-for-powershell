...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup PutBackupVaultAccessPolicy API operation.", Operation = new[] {"PutBackupVaultAccessPolicy"})]
    ...
    public partial class WriteBAKBackupVaultAccessPolicyCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "PutBackupVaultAccessPolicy");
            try
            {
                #if DESKTOP
                ...
                var task = client.PutBackupVaultAccessPolicyAsync(request);
                return task.Result;
                #else
