...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListTags API operation.", Operation = new[] {"ListTags"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Backup.Model.ListTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetBAKResourceTagCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Backup.Model.ListTagsRequest();
        ...
        private Amazon.Backup.Model.ListTagsResponse CallAWSServiceOperation(IAmazonBackup client, Amazon.Backup.Model.ListTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListTags");
            try
            {
                #if DESKTOP
