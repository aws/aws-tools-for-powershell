...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup ListBackupVaults API operation.", Operation = new[] {"ListBackupVaults"})]
    [AWSCmdletOutput("Amazon.Backup.Model.BackupVaultListMember",
        "This cmdlet returns a collection of BackupVaultListMember objects.",
    ...
    public partial class GetBAKBackupVaultListCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BackupVaultList;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "ListBackupVaults");
            try
            {
                #if DESKTOP
