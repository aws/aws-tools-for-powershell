...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup DeleteBackupSelection API operation.", Operation = new[] {"DeleteBackupSelection"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the SelectionId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveBAKBackupSelectionCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("SelectionId", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.SelectionId;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "DeleteBackupSelection");
            try
            {
                #if DESKTOP
                return client.DeleteBackupSelection(request);
                #elif CORECLR
                return client.DeleteBackupSelectionAsync(request).GetAwaiter().GetResult();
                #else
