...
namespace Amazon.PowerShell.Cmdlets.BAK
{
    ...
    [AWSCmdlet("Calls the Amazon Backup GetBackupSelection API operation.", Operation = new[] {"GetBackupSelection"})]
    [AWSCmdletOutput("Amazon.Backup.Model.GetBackupSelectionResponse",
        "This cmdlet returns a Amazon.Backup.Model.GetBackupSelectionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBAKBackupSelectionCmdlet : AmazonBackupClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Backup", "GetBackupSelection");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetBackupSelectionAsync(request);
                return task.Result;
                #else
