...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    public partial class GetIVSStreamKeyBatchCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Array of ARNs, one per stream key.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.BatchGetStreamKeyResponse, GetIVSStreamKeyBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.BatchGetStreamKeyRequest();
        ...
        private Amazon.IVS.Model.BatchGetStreamKeyResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.BatchGetStreamKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "BatchGetStreamKey");
            try
            {
                return client.BatchGetStreamKeyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IVS.Model.BatchGetStreamKeyResponse, GetIVSStreamKeyBatchCmdlet, object> Select { get; set; } =
