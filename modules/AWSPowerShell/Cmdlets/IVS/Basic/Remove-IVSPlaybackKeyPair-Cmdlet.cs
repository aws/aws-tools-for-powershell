...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IVSPlaybackKeyPair", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIVSPlaybackKeyPairCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IVSPlaybackKeyPair (DeletePlaybackKeyPair)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.DeletePlaybackKeyPairResponse, RemoveIVSPlaybackKeyPairCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.DeletePlaybackKeyPairRequest();
        ...
        private Amazon.IVS.Model.DeletePlaybackKeyPairResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.DeletePlaybackKeyPairRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "DeletePlaybackKeyPair");
            try
            {
                #if DESKTOP
                return client.DeletePlaybackKeyPair(request);
                #elif CORECLR
                return client.DeletePlaybackKeyPairAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVS.Model.DeletePlaybackKeyPairResponse, RemoveIVSPlaybackKeyPairCmdlet, object> Select { get; set; } =
