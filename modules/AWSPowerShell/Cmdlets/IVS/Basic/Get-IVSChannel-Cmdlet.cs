...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    /// </summary>
    [Cmdlet("Get", "IVSChannel")]
    [OutputType("Amazon.IVS.Model.Channel")]
    [AWSCmdlet("Calls the Amazon Interactive Video Service GetChannel API operation.", Operation = new[] {"GetChannel"}, SelectReturnType = typeof(Amazon.IVS.Model.GetChannelResponse))]
    [AWSCmdletOutput("Amazon.IVS.Model.Channel or Amazon.IVS.Model.GetChannelResponse",
        "This cmdlet returns an Amazon.IVS.Model.Channel object.",
        "The service call response (type Amazon.IVS.Model.GetChannelResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIVSChannelCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.GetChannelResponse, GetIVSChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.GetChannelRequest();
        ...
        private Amazon.IVS.Model.GetChannelResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.GetChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "GetChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVS.Model.GetChannelResponse, GetIVSChannelCmdlet, object> Select { get; set; } =
