...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "IVSStreamKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewIVSStreamKeyCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IVSStreamKey (CreateStreamKey)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.CreateStreamKeyResponse, NewIVSStreamKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.CreateStreamKeyRequest();
        ...
        private Amazon.IVS.Model.CreateStreamKeyResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.CreateStreamKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "CreateStreamKey");
            try
            {
                #if DESKTOP
                return client.CreateStreamKey(request);
                #elif CORECLR
                return client.CreateStreamKeyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IVS.Model.CreateStreamKeyResponse, NewIVSStreamKeyCmdlet, object> Select { get; set; } =
