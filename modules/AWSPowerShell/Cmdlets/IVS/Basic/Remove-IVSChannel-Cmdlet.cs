...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    public partial class RemoveIVSChannelCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IVSChannel (DeleteChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.DeleteChannelResponse, RemoveIVSChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.DeleteChannelRequest();
        ...
        private Amazon.IVS.Model.DeleteChannelResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.DeleteChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "DeleteChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVS.Model.DeleteChannelResponse, RemoveIVSChannelCmdlet, object> Select { get; set; } =
