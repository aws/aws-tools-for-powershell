...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    /// Up Private Channels</a> in the <i>Amazon IVS User Guide</i>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetIVSPlaybackKeyPairListCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The first key pair to retrieve. This is used for pagination; see the <c>nextToken</c>
        /// response field.</para>
        /// </para>
        /// <para>
        ...
        private Amazon.IVS.Model.ListPlaybackKeyPairsResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.ListPlaybackKeyPairsRequest request)
        {
            ...
            try
            {
                return client.ListPlaybackKeyPairsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
