...
namespace Amazon.PowerShell.Cmdlets.IVS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IVSRecordingConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIVSRecordingConfigurationCmdlet : AmazonIVSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IVSRecordingConfiguration (DeleteRecordingConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVS.Model.DeleteRecordingConfigurationResponse, RemoveIVSRecordingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVS.Model.DeleteRecordingConfigurationRequest();
        ...
        private Amazon.IVS.Model.DeleteRecordingConfigurationResponse CallAWSServiceOperation(IAmazonIVS client, Amazon.IVS.Model.DeleteRecordingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service", "DeleteRecordingConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteRecordingConfiguration(request);
                #elif CORECLR
                return client.DeleteRecordingConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVS.Model.DeleteRecordingConfigurationResponse, RemoveIVSRecordingConfigurationCmdlet, object> Select { get; set; } =
