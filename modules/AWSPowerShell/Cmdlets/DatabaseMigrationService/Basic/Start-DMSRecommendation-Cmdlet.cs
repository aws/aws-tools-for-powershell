...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class StartDMSRecommendationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the DatabaseId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^DatabaseId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DatabaseId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.DatabaseId;
            }
        ...
        private Amazon.DatabaseMigrationService.Model.StartRecommendationsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.StartRecommendationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartRecommendations(request);
                #elif CORECLR
                return client.StartRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
