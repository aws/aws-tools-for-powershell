...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.SchemaConversionRequest or Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSMetadataModelExportsToTargetCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetResponse, GetDMSMetadataModelExportsToTargetCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetRequest request)
        {
            ...
            try
            {
                return client.DescribeMetadataModelExportsToTargetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxRecord { get; set; }
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsToTargetResponse, GetDMSMetadataModelExportsToTargetCmdlet, object> Select { get; set; } =
