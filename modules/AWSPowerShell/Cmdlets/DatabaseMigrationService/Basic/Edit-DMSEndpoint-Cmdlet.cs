...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.Endpoint or Amazon.DatabaseMigrationService.Model.ModifyEndpointResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.ModifyEndpointResponse) can be returned by specifying '-Select *'."
    )]
    public partial class EditDMSEndpointCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// the following example:</para><para><c>s3-settings='{"DatePartitionEnabled": true, "DatePartitionSequence": "YYYYMMDDHH",
        ...
        /// <summary>
        /// <para>
        /// <para>The database engine name. Valid values, depending on the EndpointType, include <c>"mysql"</c>,
        ...
        /// <summary>
        /// <para>
        /// <para>If this attribute is Y, the current call to <c>ModifyEndpoint</c> replaces all existing
        /// endpoint settings with the exact settings that you specify in this call. If this attribute
        /// is N, the current call to <c>ModifyEndpoint</c> does two things: </para><ul><li><para>It replaces any endpoint settings that already exist with new values, for settings
        ...
        /// names. </para></li></ul><para>For example, if you call <c>create-endpoint ... --endpoint-settings '{"a":1}' ...</c>,
        ...
        /// the endpoint has the following settings: <c>'{"a":1,"b":2}'</c>. </para><para>However, suppose that you follow this with a call to <c>modify-endpoint ... --endpoint-settings
        ...
        /// the exact settings that you specify. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ExactSettings")]
        ...
        /// The role must allow the <c>iam:PassRole</c> action.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The SSL mode used to connect to the endpoint. The default value is <c>none</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.DatabaseMigrationService.Model.ModifyEndpointResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.ModifyEndpointRequest request)
        {
            ...
            try
            {
                return client.ModifyEndpointAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
