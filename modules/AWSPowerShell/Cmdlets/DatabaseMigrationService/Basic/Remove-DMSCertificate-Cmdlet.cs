...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DeleteCertificate API operation.", Operation = new[] {"DeleteCertificate"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.Certificate or Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse",
        "This cmdlet returns an Amazon.DatabaseMigrationService.Model.Certificate object.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveDMSCertificateCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse, RemoveDMSCertificateCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DeleteCertificateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DeleteCertificate");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String CertificateArn { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DeleteCertificateResponse, RemoveDMSCertificateCmdlet, object> Select { get; set; } =
