...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// 
    ///  
    /// <para><b>Required permissions:</b><c>dms:UpdateDataProvider</c>. For more information,
    ...
    public partial class EditDMSDataProviderCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If this attribute is Y, the current call to <c>ModifyDataProvider</c> replaces all
        ...
        /// </para><ul><li><para>It replaces any data provider settings that already exist with new values, for settings
        ...
        private Amazon.DatabaseMigrationService.Model.ModifyDataProviderResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.ModifyDataProviderRequest request)
        {
            ...
            try
            {
                return client.ModifyDataProviderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
