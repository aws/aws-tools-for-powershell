...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("System.String or Amazon.DatabaseMigrationService.Model.UpdateSubscriptionsToEventBridgeResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.UpdateSubscriptionsToEventBridgeResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateDMSSubscriptionsToEventBridgeCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ForceMove' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ForceMove;
            }
        ...
        private Amazon.DatabaseMigrationService.Model.UpdateSubscriptionsToEventBridgeResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.UpdateSubscriptionsToEventBridgeRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateSubscriptionsToEventBridge(request);
                #elif CORECLR
                return client.UpdateSubscriptionsToEventBridgeAsync(request).GetAwaiter().GetResult();
                #else
