...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// 
    ///  
    /// <para><b>Required permissions:</b><c>dms:ListMetadataModelAssessments</c>. For more information,
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.SchemaConversionRequest or Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSMetadataModelAssessmentCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters to apply to the metadata model assessment requests.</para><para>The following filter names are supported:</para><ul><li><para><c>request-id</c> – The request identifier.</para></li><li><para><c>status</c> – The request status. Valid values: <c>RECEIVED</c>, <c>IN_PROGRESS</c>,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsResponse, GetDMSMetadataModelAssessmentCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsRequest request)
        {
            ...
            try
            {
                return client.DescribeMetadataModelAssessmentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxRecord { get; set; }
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelAssessmentsResponse, GetDMSMetadataModelAssessmentCmdlet, object> Select { get; set; } =
