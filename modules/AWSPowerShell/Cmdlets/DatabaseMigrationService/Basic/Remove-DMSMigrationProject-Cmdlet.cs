...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.MigrationProject or Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveDMSMigrationProjectCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name or Amazon Resource Name (ARN) of the migration project to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectResponse, RemoveDMSMigrationProjectCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectRequest request)
        {
            ...
            try
            {
                return client.DeleteMigrationProjectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DeleteMigrationProjectResponse, RemoveDMSMigrationProjectCmdlet, object> Select { get; set; } =
