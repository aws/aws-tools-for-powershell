...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// </para></li></ul><para><b>Required permissions:</b><c>dms:StartMetadataModelCreation</c>. For more information,
    ...
    public partial class StartDMSMetadataModelCreationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name for the metadata model to use in subsequent operations.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A JSON string that identifies the source schema for the metadata model. For the selection
        ...
        /// matches the source data provider.</para></li><li><para>Supports only <c>explicit</c> rule actions.</para></li><li><para>Exactly one rule is allowed.</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
