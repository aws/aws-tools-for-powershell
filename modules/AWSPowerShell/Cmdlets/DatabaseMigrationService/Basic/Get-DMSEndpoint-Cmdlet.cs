...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeEndpoints API operation.", Operation = new[] {"DescribeEndpoints"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.Endpoint or Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.Endpoint objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSEndpointCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters applied to the endpoints.</para><para>Valid filter names: endpoint-arn | endpoint-type | endpoint-id | engine-name</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse, GetDMSEndpointCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse, GetDMSEndpointCmdlet, object> Select { get; set; } =
