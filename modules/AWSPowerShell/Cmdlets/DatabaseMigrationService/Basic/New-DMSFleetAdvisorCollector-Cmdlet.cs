...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("System.String or Amazon.DatabaseMigrationService.Model.CreateFleetAdvisorCollectorResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.CreateFleetAdvisorCollectorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewDMSFleetAdvisorCollectorCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CollectorName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CollectorName;
            }
        ...
        private Amazon.DatabaseMigrationService.Model.CreateFleetAdvisorCollectorResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.CreateFleetAdvisorCollectorRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateFleetAdvisorCollector(request);
                #elif CORECLR
                return client.CreateFleetAdvisorCollectorAsync(request).GetAwaiter().GetResult();
                #else
