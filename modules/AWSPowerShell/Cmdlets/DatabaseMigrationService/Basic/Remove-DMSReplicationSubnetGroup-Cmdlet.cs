...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Database Migration Service DeleteReplicationSubnetGroup API operation.", Operation = new[] {"DeleteReplicationSubnetGroup"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse))]
    [AWSCmdletOutput("None or Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveDMSReplicationSubnetGroupCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DMSReplicationSubnetGroup (DeleteReplicationSubnetGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse, RemoveDMSReplicationSubnetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteReplicationSubnetGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ReplicationSubnetGroupIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DeleteReplicationSubnetGroupResponse, RemoveDMSReplicationSubnetGroupCmdlet, object> Select { get; set; } =
