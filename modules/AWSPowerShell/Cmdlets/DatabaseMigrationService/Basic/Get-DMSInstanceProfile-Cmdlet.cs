...
{
    /// <summary>
    /// Returns a paginated list of instance profiles for your account in the current region.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.InstanceProfile or Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSInstanceProfileCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesResponse, GetDMSInstanceProfileCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesRequest request)
        {
            ...
            try
            {
                return client.DescribeInstanceProfilesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeInstanceProfilesResponse, GetDMSInstanceProfileCmdlet, object> Select { get; set; } =
