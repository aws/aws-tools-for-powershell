...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class RemoveDMSFleetAdvisorCollectorCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        public System.String CollectorReferencedId { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DMSFleetAdvisorCollector (DeleteFleetAdvisorCollector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DeleteFleetAdvisorCollectorResponse, RemoveDMSFleetAdvisorCollectorCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.CollectorReferencedId = this.CollectorReferencedId;
            #if MODULAR
            if (this.CollectorReferencedId == null && ParameterWasBound(nameof(this.CollectorReferencedId)))
            {
                WriteWarning("You are passing $null as a value for parameter CollectorReferencedId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DatabaseMigrationService.Model.DeleteFleetAdvisorCollectorRequest();
            
            if (cmdletContext.CollectorReferencedId != null)
            {
                request.CollectorReferencedId = cmdletContext.CollectorReferencedId;
            }
        ...
        private Amazon.DatabaseMigrationService.Model.DeleteFleetAdvisorCollectorResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DeleteFleetAdvisorCollectorRequest request)
        {
        ...
        {
            public System.String CollectorReferencedId { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DeleteFleetAdvisorCollectorResponse, RemoveDMSFleetAdvisorCollectorCmdlet, object> Select { get; set; } =
