...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeEventSubscriptions API operation.", Operation = new[] {"DescribeEventSubscriptions"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeEventSubscriptionsResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.EventSubscription or Amazon.DatabaseMigrationService.Model.DescribeEventSubscriptionsResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.EventSubscription objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeEventSubscriptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSEventSubscriptionCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters applied to event subscriptions.</para><para>Valid filter names: <c>event-subscription-arn</c> | <c>event-subscription-id</c></para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeEventSubscriptionsResponse, GetDMSEventSubscriptionCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String SubscriptionName { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeEventSubscriptionsResponse, GetDMSEventSubscriptionCmdlet, object> Select { get; set; } =
