...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeCertificates API operation.", Operation = new[] {"DescribeCertificates"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.Certificate or Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.Certificate objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSCertificateCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// values are <c>certificate-arn</c> and <c>certificate-id</c>.</para><para />
        ...
        /// in the response so that the remaining results can be retrieved. </para><para>Default: 10</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse, GetDMSCertificateCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeCertificatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeCertificates");
            try
            {
                return client.DescribeCertificatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeCertificatesResponse, GetDMSCertificateCmdlet, object> Select { get; set; } =
