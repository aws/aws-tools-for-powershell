...
{
    /// <summary>
    /// Returns a list of the Fleet Advisor collectors in your account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.CollectorResponse or Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorCollectorsResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorCollectorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSFleetAdvisorCollectorCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorCollectorsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorCollectorsRequest request)
        {
            ...
            try
            {
                return client.DescribeFleetAdvisorCollectorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
