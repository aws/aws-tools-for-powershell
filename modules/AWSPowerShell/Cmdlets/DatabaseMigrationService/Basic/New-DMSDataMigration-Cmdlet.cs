...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.DataMigration or Amazon.DatabaseMigrationService.Model.CreateDataMigrationResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.CreateDataMigrationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewDMSDataMigrationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies information about the source data provider.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more tags to be assigned to the data migration.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies information about the target data provider.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.DatabaseMigrationService.Model.CreateDataMigrationResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.CreateDataMigrationRequest request)
        {
            ...
            try
            {
                return client.CreateDataMigrationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
