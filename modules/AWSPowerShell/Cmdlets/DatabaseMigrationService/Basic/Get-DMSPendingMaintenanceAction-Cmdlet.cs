...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribePendingMaintenanceActions API operation.", Operation = new[] {"DescribePendingMaintenanceActions"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.ResourcePendingMaintenanceActions or Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.ResourcePendingMaintenanceActions objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSPendingMaintenanceActionCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse, GetDMSPendingMaintenanceActionCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String ReplicationInstanceArn { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse, GetDMSPendingMaintenanceActionCmdlet, object> Select { get; set; } =
