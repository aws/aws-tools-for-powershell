...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// </para><para><b>Required permissions:</b><c>dms:CreateMigrationProject</c>. For more information,
    ...
    public partial class NewDMSMigrationProjectCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more tags to be assigned to the migration project.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Services Secrets Manager parameters.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>A JSON string that specifies the transformation rules for the migration project. Transformation
        ...
        /// rules in DMS Schema Conversion</a>.</para><note><para>Homogeneous data migrations do not support transformation rules.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.DatabaseMigrationService.Model.CreateMigrationProjectResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.CreateMigrationProjectRequest request)
        {
            ...
            try
            {
                return client.CreateMigrationProjectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
