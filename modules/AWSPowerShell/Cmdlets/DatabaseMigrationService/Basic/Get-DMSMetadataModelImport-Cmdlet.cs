...
{
    /// <summary>
    /// Returns a paginated list of metadata model imports.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.SchemaConversionRequest or Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSMetadataModelImportCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters applied to the metadata model imports described in the form of key-value pairs.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A paginated list of metadata model imports.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxRecords")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsResponse, GetDMSMetadataModelImportCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsRequest request)
        {
            ...
            try
            {
                return client.DescribeMetadataModelImportsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxRecord { get; set; }
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelImportsResponse, GetDMSMetadataModelImportCmdlet, object> Select { get; set; } =
