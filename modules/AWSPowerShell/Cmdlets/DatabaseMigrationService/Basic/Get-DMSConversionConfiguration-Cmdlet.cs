...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class GetDMSConversionConfigurationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name or Amazon Resource Name (ARN) for the schema conversion project to describe.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeConversionConfigurationResponse, GetDMSConversionConfigurationCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeConversionConfigurationResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeConversionConfigurationRequest request)
        {
            ...
            try
            {
                return client.DescribeConversionConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeConversionConfigurationResponse, GetDMSConversionConfigurationCmdlet, object> Select { get; set; } =
