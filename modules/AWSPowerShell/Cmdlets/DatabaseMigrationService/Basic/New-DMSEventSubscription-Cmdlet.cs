...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class NewDMSEventSubscriptionCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of identifiers for which AWS DMS provides notification events.</para><para>If you don't specify a value, notifications are provided for all sources.</para><para>If you specify multiple values, they must be of the same type. For example, if you
        ...
        /// returned. </para><para>Valid values: <code>replication-instance</code> | <code>replication-task</code></para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the AWS DMS event notification subscription. This name must be less than
        /// 255 characters.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
