...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// 
    ///  
    /// <para><b>Required permissions:</b><c>dms:ListMigrationProjects</c>. For more information,
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.MigrationProject or Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSMigrationProjectCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters to apply to the migration projects.</para><para>The following filter names are supported:</para><ul><li><para><c>migration-project-identifier</c> – The migration project name or ARN.</para></li><li><para><c>instance-profile-identifier</c> – The instance profile name or ARN.</para></li><li><para><c>data-provider-identifier</c> – The source or target data provider name or ARN.</para></li><li><para><c>source-data-provider-identifier</c> – The source data provider name or ARN.</para></li><li><para><c>target-data-provider-identifier</c> – The target data provider name or ARN.</para></li></ul><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsResponse, GetDMSMigrationProjectCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsRequest request)
        {
            ...
            try
            {
                return client.DescribeMigrationProjectsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeMigrationProjectsResponse, GetDMSMigrationProjectCmdlet, object> Select { get; set; } =
