...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeReplicationTasks API operation.", Operation = new[] {"DescribeReplicationTasks"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.ReplicationTask or Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.ReplicationTask objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSReplicationTaskCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// endpoint-arn | replication-instance-arn</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReplicationTasks";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse, GetDMSReplicationTaskCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksRequest request)
        {
            ...
            try
            {
                return client.DescribeReplicationTasksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.Boolean? WithoutSetting { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse, GetDMSReplicationTaskCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReplicationTasks;
        }
