...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeConnections API operation.", Operation = new[] {"DescribeConnections"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse))]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.Connection or Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse",
        "This cmdlet returns a collection of Amazon.DatabaseMigrationService.Model.Connection objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSConnectionCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters applied to the connection.</para><para>Valid filter names: endpoint-arn | replication-instance-arn</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse, GetDMSConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribeConnectionsRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeConnectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeConnections");
            try
            {
                return client.DescribeConnectionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeConnectionsResponse, GetDMSConnectionCmdlet, object> Select { get; set; } =
