...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.DatabaseResponse or Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorDatabasesResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeFleetAdvisorDatabasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDMSFleetAdvisorDatabaseCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// only those databases that meet the filter criteria: </para><ul><li><para><code>database-id</code> – The ID of the database, for example <code>d4610ac5-e323-4ad9-bc50-eaf7249dfe9d</code>.</para></li><li><para><code>database-name</code> – The name of the database.</para></li><li><para><code>database-engine</code> – The name of the database engine.</para></li><li><para><code>server-ip-address</code> – The IP address of the database server.</para></li><li><para><code>database-ip-address</code> – The IP address of the database.</para></li><li><para><code>collector-name</code> – The name of the associated Fleet Advisor collector.</para></li></ul><para>An example is: <code>describe-fleet-advisor-databases --filter Name="database-id",Values="d4610ac5-e323-4ad9-bc50-eaf7249dfe9d"</code></para>
        /// </para>
        /// </summary>
