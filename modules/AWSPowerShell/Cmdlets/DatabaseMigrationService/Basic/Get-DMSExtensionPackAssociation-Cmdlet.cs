...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// 
    ///  
    /// <para><b>Required permissions:</b><c>dms:ListExtensionPacks</c>. For more information,
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.SchemaConversionRequest or Amazon.DatabaseMigrationService.Model.DescribeExtensionPackAssociationsResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeExtensionPackAssociationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSExtensionPackAssociationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters to apply to the extension pack installation requests.</para><para>The following filter names are supported:</para><ul><li><para><c>request-id</c> – The request identifier.</para></li><li><para><c>status</c> – The request status. Valid values: <c>RECEIVED</c>, <c>IN_PROGRESS</c>,
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeExtensionPackAssociationsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeExtensionPackAssociationsRequest request)
        {
            ...
            try
            {
                return client.DescribeExtensionPackAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
