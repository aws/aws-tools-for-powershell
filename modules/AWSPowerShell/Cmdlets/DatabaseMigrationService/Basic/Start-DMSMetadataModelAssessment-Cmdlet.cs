...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("System.String or Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartDMSMetadataModelAssessmentCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentResponse, StartDMSMetadataModelAssessmentCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentRequest request)
        {
            ...
            try
            {
                return client.StartMetadataModelAssessmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String MigrationProjectIdentifier { get; set; }
            public System.String SelectionRule { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.StartMetadataModelAssessmentResponse, StartDMSMetadataModelAssessmentCmdlet, object> Select { get; set; } =
