...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// 
    ///  
    /// <para><b>Required permissions:</b><c>dms:ListMetadataModelExports</c>. For more information,
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.SchemaConversionRequest or Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSMetadataModelExportsAsScriptCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters to apply to the metadata model export requests.</para><para>The following filter names are supported:</para><ul><li><para><c>request-id</c> – The request identifier.</para></li><li><para><c>status</c> – The request status. Valid values: <c>RECEIVED</c>, <c>IN_PROGRESS</c>,
        /// <c>SUCCESS</c>, <c>FAILED</c>.</para></li></ul><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptResponse, GetDMSMetadataModelExportsAsScriptCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptRequest request)
        {
            ...
            try
            {
                return client.DescribeMetadataModelExportsAsScriptAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxRecord { get; set; }
            public System.String MigrationProjectIdentifier { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeMetadataModelExportsAsScriptResponse, GetDMSMetadataModelExportsAsScriptCmdlet, object> Select { get; set; } =
