...
{
    /// <summary>
    /// Returns a paginated list of metadata model exports.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetDMSMetadataModelExportsAsScriptCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters applied to the metadata model exports described in the form of key-value pairs.</para><para />
