...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.DataProvider or Amazon.DatabaseMigrationService.Model.DescribeDataProvidersResponse",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeDataProvidersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSDataProviderCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters applied to the data providers described in the form of key-value pairs.</para><para>Valid filter names and values: data-provider-identifier, data provider arn or name</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeDataProvidersResponse, GetDMSDataProviderCmdlet>(Select) ??
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeDataProvidersResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeDataProvidersRequest request)
        {
            ...
            try
            {
                return client.DescribeDataProvidersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeDataProvidersResponse, GetDMSDataProviderCmdlet, object> Select { get; set; } =
