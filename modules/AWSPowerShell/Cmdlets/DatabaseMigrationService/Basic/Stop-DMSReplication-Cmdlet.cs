...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// </summary>
    [Cmdlet("Stop", "DMSReplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopDMSReplicationCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name of the replication to stop.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DatabaseMigrationService.Model.StopReplicationResponse).
        /// Specifying the name of a property of type Amazon.DatabaseMigrationService.Model.StopReplicationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-DMSReplication (StopReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.StopReplicationResponse, StopDMSReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DatabaseMigrationService.Model.StopReplicationRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.StopReplicationResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.StopReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "StopReplication");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ReplicationConfigArn { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.StopReplicationResponse, StopDMSReplicationCmdlet, object> Select { get; set; } =
