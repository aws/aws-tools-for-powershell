...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeSchemas API operation.", Operation = new[] {"DescribeSchemas"}, SelectReturnType = typeof(Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse))]
    [AWSCmdletOutput("System.String or Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDMSSchemaCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse, GetDMSSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribeSchemasRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeSchemasRequest request)
        {
            ...
            try
            {
                return client.DescribeSchemasAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.DatabaseMigrationService.Model.DescribeSchemasResponse, GetDMSSchemaCmdlet, object> Select { get; set; } =
