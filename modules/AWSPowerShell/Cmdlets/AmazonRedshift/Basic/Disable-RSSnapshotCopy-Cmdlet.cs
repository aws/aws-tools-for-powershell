...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the DisableSnapshotCopy operation against Amazon Redshift.", Operation = new[] {"DisableSnapshotCopy"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.Cluster",
        "This cmdlet returns a Cluster object.",
        "The service call response (type DisableSnapshotCopyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class DisableRSSnapshotCopyCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new DisableSnapshotCopyRequest();
            ...
            try
            {
                var response = client.DisableSnapshotCopy(request);
