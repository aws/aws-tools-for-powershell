...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the DescribeClusterSnapshots operation against Amazon Redshift.", Operation = new[] {"DescribeClusterSnapshots"}, LegacyAlias="Get-RSClusterSnapshots")]
