...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeEventSubscriptions API operation.", Operation = new[] {"DescribeEventSubscriptions"}, LegacyAlias="Get-RSEventSubscriptions")]
