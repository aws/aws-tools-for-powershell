...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the DescribeEventCategories operation against Amazon Redshift.", Operation = new[] {"DescribeEventCategories"}, LegacyAlias="Get-RSEventCategories")]
