...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterParameters API operation.", Operation = new[] {"DescribeClusterParameters"}, LegacyAlias="Get-RSClusterParameters")]
