...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift GetReservedNodeExchangeOfferings API operation.", Operation = new[] {"GetReservedNodeExchangeOfferings"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.ReservedNodeOffering",
        ...
        "The service call response (type Amazon.Redshift.Model.GetReservedNodeExchangeOfferingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetRSReservedNodeExchangeOfferingCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Redshift.Model.GetReservedNodeExchangeOfferingsRequest();
        ...
        private Amazon.Redshift.Model.GetReservedNodeExchangeOfferingsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.GetReservedNodeExchangeOfferingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "GetReservedNodeExchangeOfferings");
            try
            {
                #if DESKTOP
                return client.GetReservedNodeExchangeOfferings(request);
                #elif CORECLR
                return client.GetReservedNodeExchangeOfferingsAsync(request).GetAwaiter().GetResult();
                #else
