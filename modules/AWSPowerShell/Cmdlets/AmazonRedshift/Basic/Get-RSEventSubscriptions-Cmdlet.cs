...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the DescribeEventSubscriptions operation against Amazon Redshift.", Operation = new[] {"DescribeEventSubscriptions"})]
    ...
    public partial class GetRSEventSubscriptionsCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Redshift.Model.DescribeEventSubscriptionsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeEventSubscriptionsRequest request)
        {
            #if DESKTOP
