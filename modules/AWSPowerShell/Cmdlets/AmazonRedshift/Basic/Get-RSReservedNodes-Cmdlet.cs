...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSReservedNodes")]
    [OutputType("Amazon.Redshift.Model.ReservedNode")]
    [AWSCmdlet("Invokes the DescribeReservedNodes operation against Amazon Redshift.", Operation = new[] {"DescribeReservedNodes"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.ReservedNode",
        "This cmdlet returns a collection of ReservedNode objects.",
        "The service call response (type DescribeReservedNodesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.ReservedNodes.Count;
