...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterTracks API operation.", Operation = new[] {"DescribeClusterTracks"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.MaintenanceTrack",
        "This cmdlet returns a collection of MaintenanceTrack objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.MaintenanceTracks;
