...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the DescribeHsmConfigurations operation against Amazon Redshift.", Operation = new[] {"DescribeHsmConfigurations"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.HsmConfiguration",
        "This cmdlet returns a collection of HsmConfiguration objects.",
        "The service call response (type DescribeHsmConfigurationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetRSHsmConfigurationsCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new DescribeHsmConfigurationsRequest();
