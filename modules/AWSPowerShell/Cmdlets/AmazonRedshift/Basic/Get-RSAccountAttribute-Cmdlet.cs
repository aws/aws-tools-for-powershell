...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeAccountAttributes API operation.", Operation = new[] {"DescribeAccountAttributes"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.AccountAttribute",
