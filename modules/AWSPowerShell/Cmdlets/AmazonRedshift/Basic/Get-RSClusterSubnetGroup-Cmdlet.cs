...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class GetRSClusterSubnetGroupCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        private Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterSubnetGroupsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeClusterSubnetGroupsAsync(request).GetAwaiter().GetResult();
                #else
