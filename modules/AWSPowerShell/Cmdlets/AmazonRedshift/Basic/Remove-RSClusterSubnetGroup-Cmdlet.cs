...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class RemoveRSClusterSubnetGroupCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSClusterSubnetGroup (DeleteClusterSubnetGroup)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeleteClusterSubnetGroupRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ClusterSubnetGroupName;
        ...
        private Amazon.Redshift.Model.DeleteClusterSubnetGroupResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteClusterSubnetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeleteClusterSubnetGroup");
            try
            {
                #if DESKTOP
                return client.DeleteClusterSubnetGroup(request);
                #elif CORECLR
                return client.DeleteClusterSubnetGroupAsync(request).GetAwaiter().GetResult();
                #else
