...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Invokes the ModifyClusterIamRoles operation against Amazon Redshift.", Operation = new[] {"ModifyClusterIamRoles"})]
    ...
    public class EditRSClusterIamRolesCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-RSClusterIamRoles (ModifyClusterIamRoles)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.ModifyClusterIamRoles(request);
