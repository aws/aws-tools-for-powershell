...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSClusterSubnetGroups")]
    ...
    public partial class GetRSClusterSubnetGroupsCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ClusterSubnetGroups;
                        ...
                        int _receivedThisCall = response.ClusterSubnetGroups.Count;
        ...
        private Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterSubnetGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DescribeClusterSubnetGroups");
            #if DESKTOP
            return client.DescribeClusterSubnetGroups(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeClusterSubnetGroupsAsync(request);
            return task.Result;
            #else
