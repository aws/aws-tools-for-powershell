...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DeleteHsmConfiguration API operation.", Operation = new[] {"DeleteHsmConfiguration"})]
    ...
    public partial class RemoveRSHsmConfigurationCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("HsmConfigurationIdentifier", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.HsmConfigurationIdentifier;
        ...
        private Amazon.Redshift.Model.DeleteHsmConfigurationResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteHsmConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteHsmConfigurationAsync(request);
                return task.Result;
                #else
