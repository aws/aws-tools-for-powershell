...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdletOutput("Amazon.Redshift.Model.Parameter",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String), ParameterGroupFamily (type System.String)"
    )]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DefaultClusterParameters.Parameters;
                        notes = new Dictionary<string, object>();
                        notes["Marker"] = response.DefaultClusterParameters.Marker;
                        notes["ParameterGroupFamily"] = response.DefaultClusterParameters.ParameterGroupFamily;
                        ...
                        int _receivedThisCall = response.DefaultClusterParameters.Parameters.Count;
                        if (_userControllingPaging)
                        {
                            WriteProgressRecord("Retrieving", string.Format("Retrieved {0} records starting from marker '{1}'", _receivedThisCall, request.Marker));
                        }
                        
                        _nextMarker = response.DefaultClusterParameters.Marker;
