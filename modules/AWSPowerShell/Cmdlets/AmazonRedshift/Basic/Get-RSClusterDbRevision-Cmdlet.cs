...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterDbRevisions API operation.", Operation = new[] {"DescribeClusterDbRevisions"})]
    [AWSCmdletOutput("Amazon.Redshift.Model.ClusterDbRevision",
        "This cmdlet returns a collection of ClusterDbRevision objects.",
    ...
    public partial class GetRSClusterDbRevisionCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ClusterDbRevisions;
        ...
        private Amazon.Redshift.Model.DescribeClusterDbRevisionsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterDbRevisionsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeClusterDbRevisionsAsync(request);
                return task.Result;
                #else
