...
namespace Amazon.PowerShell.Cmdlets.GDB
{
    ...
    [AWSCmdletOutput("Amazon.GlueDataBrew.Model.Recipe or Amazon.GlueDataBrew.Model.ListRecipesResponse",
        ...
        "The service call response (type Amazon.GlueDataBrew.Model.ListRecipesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGDBRecipeListCmdlet : AmazonGlueDataBrewClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RecipeVersion parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RecipeVersion' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RecipeVersion' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RecipeVersion;
            }
