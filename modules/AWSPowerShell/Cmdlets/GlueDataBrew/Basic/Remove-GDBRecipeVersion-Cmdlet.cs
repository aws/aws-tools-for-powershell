...
namespace Amazon.PowerShell.Cmdlets.GDB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GDBRecipeVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveGDBRecipeVersionCmdlet : AmazonGlueDataBrewClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.GlueDataBrew.Model.DeleteRecipeVersionResponse).
        /// Specifying the name of a property of type Amazon.GlueDataBrew.Model.DeleteRecipeVersionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GDBRecipeVersion (DeleteRecipeVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GlueDataBrew.Model.DeleteRecipeVersionResponse, RemoveGDBRecipeVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GlueDataBrew.Model.DeleteRecipeVersionRequest();
        ...
        private Amazon.GlueDataBrew.Model.DeleteRecipeVersionResponse CallAWSServiceOperation(IAmazonGlueDataBrew client, Amazon.GlueDataBrew.Model.DeleteRecipeVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue DataBrew", "DeleteRecipeVersion");
            try
            {
                #if DESKTOP
                return client.DeleteRecipeVersion(request);
                #elif CORECLR
                return client.DeleteRecipeVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String RecipeVersion { get; set; }
            public System.Func<Amazon.GlueDataBrew.Model.DeleteRecipeVersionResponse, RemoveGDBRecipeVersionCmdlet, object> Select { get; set; } =
