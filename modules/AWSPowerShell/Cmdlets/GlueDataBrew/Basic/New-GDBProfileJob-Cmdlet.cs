...
namespace Amazon.PowerShell.Cmdlets.GDB
{
    ...
    [AWSCmdletOutput("System.String or Amazon.GlueDataBrew.Model.CreateProfileJobResponse",
        ...
        "The service call response (type Amazon.GlueDataBrew.Model.CreateProfileJobResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewGDBProfileJobCmdlet : AmazonGlueDataBrewClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The encryption mode for the job, which can be one of the following:</para><ul><li><para><c>SSE-KMS</c> - <c>SSE-KMS</c> - Server-side encryption with KMS-managed keys.</para></li><li><para><c>SSE-S3</c> - Server-side encryption with keys managed by Amazon S3.</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.GlueDataBrew.Model.CreateProfileJobResponse CallAWSServiceOperation(IAmazonGlueDataBrew client, Amazon.GlueDataBrew.Model.CreateProfileJobRequest request)
        {
            ...
            try
            {
                return client.CreateProfileJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
