...
namespace Amazon.PowerShell.Cmdlets.GDB
{
    ...
    public abstract partial class AmazonGlueDataBrewClientCmdlet : ServiceCmdlet
    {
        ...
        public AmazonGlueDataBrewConfig ClientConfig
        {
            get
            {
                return base._ClientConfig as AmazonGlueDataBrewConfig;
            }
            set
            {
        ...
        {
            var config = this.ClientConfig ?? new AmazonGlueDataBrewConfig();
        ...
        {
            base.AWSServiceId = AmazonGlueDataBrewConfig.ServiceId.ToString();
