...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    /// Tag the resource.
    /// </summary>
    [Cmdlet("Add", "BUGWResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddBUGWResourceTagCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags to assign to the resource.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-BUGWResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.TagResourceResponse, AddBUGWResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.TagResourceRequest();
        ...
        private Amazon.BackupGateway.Model.TagResourceResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BackupGateway.Model.TagResourceResponse, AddBUGWResourceTagCmdlet, object> Select { get; set; } =
