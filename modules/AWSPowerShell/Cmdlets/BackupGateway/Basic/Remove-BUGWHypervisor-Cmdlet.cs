...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "BUGWHypervisor", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Backup Gateway DeleteHypervisor API operation.", Operation = new[] {"DeleteHypervisor"}, SelectReturnType = typeof(Amazon.BackupGateway.Model.DeleteHypervisorResponse))]
    [AWSCmdletOutput("System.String or Amazon.BackupGateway.Model.DeleteHypervisorResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BackupGateway.Model.DeleteHypervisorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBUGWHypervisorCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BUGWHypervisor (DeleteHypervisor)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.DeleteHypervisorResponse, RemoveBUGWHypervisorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.DeleteHypervisorRequest();
        ...
        private Amazon.BackupGateway.Model.DeleteHypervisorResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.DeleteHypervisorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "DeleteHypervisor");
            try
            {
                #if DESKTOP
                return client.DeleteHypervisor(request);
                #elif CORECLR
                return client.DeleteHypervisorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HypervisorArn { get; set; }
            public System.Func<Amazon.BackupGateway.Model.DeleteHypervisorResponse, RemoveBUGWHypervisorCmdlet, object> Select { get; set; } =
