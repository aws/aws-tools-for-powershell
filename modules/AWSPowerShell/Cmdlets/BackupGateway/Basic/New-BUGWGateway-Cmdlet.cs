...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    [AWSCmdletOutput("System.String or Amazon.BackupGateway.Model.CreateGatewayResponse",
        ...
        "The service call response (type Amazon.BackupGateway.Model.CreateGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
