...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    public partial class GetBUGWHypervisorPropertyMappingCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.GetHypervisorPropertyMappingsResponse, GetBUGWHypervisorPropertyMappingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.GetHypervisorPropertyMappingsRequest();
        ...
        private Amazon.BackupGateway.Model.GetHypervisorPropertyMappingsResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.GetHypervisorPropertyMappingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "GetHypervisorPropertyMappings");
            try
            {
                #if DESKTOP
                return client.GetHypervisorPropertyMappings(request);
                #elif CORECLR
                return client.GetHypervisorPropertyMappingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HypervisorArn { get; set; }
            public System.Func<Amazon.BackupGateway.Model.GetHypervisorPropertyMappingsResponse, GetBUGWHypervisorPropertyMappingCmdlet, object> Select { get; set; } =
