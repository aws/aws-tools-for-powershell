...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "BUGWGateway", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Backup Gateway DeleteGateway API operation.", Operation = new[] {"DeleteGateway"}, SelectReturnType = typeof(Amazon.BackupGateway.Model.DeleteGatewayResponse))]
    [AWSCmdletOutput("System.String or Amazon.BackupGateway.Model.DeleteGatewayResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BackupGateway.Model.DeleteGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBUGWGatewayCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BUGWGateway (DeleteGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.DeleteGatewayResponse, RemoveBUGWGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.DeleteGatewayRequest();
        ...
        private Amazon.BackupGateway.Model.DeleteGatewayResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.DeleteGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "DeleteGateway");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GatewayArn { get; set; }
            public System.Func<Amazon.BackupGateway.Model.DeleteGatewayResponse, RemoveBUGWGatewayCmdlet, object> Select { get; set; } =
