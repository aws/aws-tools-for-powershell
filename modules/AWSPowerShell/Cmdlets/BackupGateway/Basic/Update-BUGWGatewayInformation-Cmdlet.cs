...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    /// </summary>
    [Cmdlet("Update", "BUGWGatewayInformation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Backup Gateway UpdateGatewayInformation API operation.", Operation = new[] {"UpdateGatewayInformation"}, SelectReturnType = typeof(Amazon.BackupGateway.Model.UpdateGatewayInformationResponse))]
    [AWSCmdletOutput("System.String or Amazon.BackupGateway.Model.UpdateGatewayInformationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BackupGateway.Model.UpdateGatewayInformationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateBUGWGatewayInformationCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-BUGWGatewayInformation (UpdateGatewayInformation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.UpdateGatewayInformationResponse, UpdateBUGWGatewayInformationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.UpdateGatewayInformationRequest();
        ...
        private Amazon.BackupGateway.Model.UpdateGatewayInformationResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.UpdateGatewayInformationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "UpdateGatewayInformation");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayArn { get; set; }
            public System.String GatewayDisplayName { get; set; }
            public System.Func<Amazon.BackupGateway.Model.UpdateGatewayInformationResponse, UpdateBUGWGatewayInformationCmdlet, object> Select { get; set; } =
