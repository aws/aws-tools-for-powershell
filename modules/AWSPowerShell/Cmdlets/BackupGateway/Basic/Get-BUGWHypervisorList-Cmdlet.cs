...
namespace Amazon.PowerShell.Cmdlets.BUGW
{
    ...
    /// </summary>
    [Cmdlet("Get", "BUGWHypervisorList")]
    [OutputType("Amazon.BackupGateway.Model.Hypervisor")]
    ...
    public partial class GetBUGWHypervisorListCmdlet : AmazonBackupGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Hypervisors";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupGateway.Model.ListHypervisorsResponse, GetBUGWHypervisorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BackupGateway.Model.ListHypervisorsRequest();
        ...
        private Amazon.BackupGateway.Model.ListHypervisorsResponse CallAWSServiceOperation(IAmazonBackupGateway client, Amazon.BackupGateway.Model.ListHypervisorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Gateway", "ListHypervisors");
            try
            {
                #if DESKTOP
                return client.ListHypervisors(request);
                #elif CORECLR
                return client.ListHypervisorsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BackupGateway.Model.ListHypervisorsResponse, GetBUGWHypervisorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Hypervisors;
        }
