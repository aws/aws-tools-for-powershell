...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager UpdateResourceShare API operation.", Operation = new[] {"UpdateResourceShare"})]
    ...
    public partial class UpdateRAMResourceShareCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "UpdateResourceShare");
            try
            {
                #if DESKTOP
                ...
                var task = client.UpdateResourceShareAsync(request);
                return task.Result;
                #else
