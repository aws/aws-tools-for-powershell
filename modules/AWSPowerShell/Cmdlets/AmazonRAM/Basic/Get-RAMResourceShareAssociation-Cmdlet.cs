...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager GetResourceShareAssociations API operation.", Operation = new[] {"GetResourceShareAssociations"})]
    [AWSCmdletOutput("Amazon.RAM.Model.ResourceShareAssociation",
        ...
        "The service call response (type Amazon.RAM.Model.GetResourceShareAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetRAMResourceShareAssociationCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                do
                {
                    ...
                    int correctPageSize = 500;
                    if (_emitLimit.HasValue)
                    {
                        correctPageSize = AutoIterationHelpers.Min(500, _emitLimit.Value);
                    }
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.ResourceShareAssociations.Count;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "GetResourceShareAssociations");
            try
            {
                #if DESKTOP
                return client.GetResourceShareAssociations(request);
                #elif CORECLR
                return client.GetResourceShareAssociationsAsync(request).GetAwaiter().GetResult();
                #else
