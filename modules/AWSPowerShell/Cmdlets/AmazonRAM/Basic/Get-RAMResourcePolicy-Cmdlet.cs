...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager GetResourcePolicies API operation.", Operation = new[] {"GetResourcePolicies"})]
    ...
    public partial class GetRAMResourcePolicyCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "GetResourcePolicies");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetResourcePoliciesAsync(request);
                return task.Result;
                #else
