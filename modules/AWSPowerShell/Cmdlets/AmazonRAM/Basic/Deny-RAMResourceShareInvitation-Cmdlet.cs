...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager RejectResourceShareInvitation API operation.", Operation = new[] {"RejectResourceShareInvitation"})]
    ...
    public partial class DenyRAMResourceShareInvitationCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "RejectResourceShareInvitation");
            try
            {
                #if DESKTOP
