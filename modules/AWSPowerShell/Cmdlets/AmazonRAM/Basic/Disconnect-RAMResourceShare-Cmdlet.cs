...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager DisassociateResourceShare API operation.", Operation = new[] {"DisassociateResourceShare"})]
    ...
    public partial class DisconnectRAMResourceShareCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "DisassociateResourceShare");
            try
            {
                #if DESKTOP
