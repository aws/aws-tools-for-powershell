...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager ListResources API operation.", Operation = new[] {"ListResources"})]
    [AWSCmdletOutput("Amazon.RAM.Model.Resource",
    ...
    public partial class GetRAMResourceListCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "ListResources");
            try
            {
                #if DESKTOP
