...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager ListPrincipals API operation.", Operation = new[] {"ListPrincipals"})]
    [AWSCmdletOutput("Amazon.RAM.Model.Principal",
    ...
    public partial class GetRAMPrincipalListCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "ListPrincipals");
            try
            {
                #if DESKTOP
