...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager EnableSharingWithAwsOrganization API operation.", Operation = new[] {"EnableSharingWithAwsOrganization"})]
    ...
    public partial class EnableRAMSharingWithAwsOrganizationCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager", "EnableSharingWithAwsOrganization");
            try
            {
                #if DESKTOP
