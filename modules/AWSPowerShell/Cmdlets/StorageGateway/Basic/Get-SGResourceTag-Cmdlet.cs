...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListTagsForResourceResponse), LegacyAlias="Get-SGResourceTags")]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.Tag or Amazon.StorageGateway.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.Tag objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGResourceTagCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListTagsForResourceResponse, GetSGResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ListTagsForResourceResponse, GetSGResourceTagCmdlet, object> Select { get; set; } =
