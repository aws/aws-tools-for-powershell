...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class GetSGGatewayInformationCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeGatewayInformationResponse, GetSGGatewayInformationCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.DescribeGatewayInformationResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeGatewayInformationRequest request)
        {
            ...
            try
            {
                return client.DescribeGatewayInformationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeGatewayInformationResponse, GetSGGatewayInformationCmdlet, object> Select { get; set; } =
