...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway SetLocalConsolePassword API operation.", Operation = new[] {"SetLocalConsolePassword"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse))]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SetSGLocalConsolePasswordCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse, SetSGLocalConsolePasswordCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.LocalConsolePassword == null && ParameterWasBound(nameof(this.LocalConsolePassword)))
            {
                WriteWarning("You are passing $null as a value for parameter LocalConsolePassword which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.SetLocalConsolePasswordRequest request)
        {
            ...
            try
            {
                return client.SetLocalConsolePasswordAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayARN { get; set; }
            public System.String LocalConsolePassword { get; set; }
            public System.Func<Amazon.StorageGateway.Model.SetLocalConsolePasswordResponse, SetSGLocalConsolePasswordCmdlet, object> Select { get; set; } =
