...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    /// </summary>
    [Cmdlet("Get", "SGTapeArchiveList")]
    [OutputType("Amazon.StorageGateway.Model.TapeArchive")]
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeTapeArchives API operation.", Operation = new[] {"DescribeTapeArchives"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.DescribeTapeArchivesResponse), LegacyAlias="Get-SGTapeArchives")]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.TapeArchive or Amazon.StorageGateway.Model.DescribeTapeArchivesResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.TapeArchive objects.",
        "The service call response (type Amazon.StorageGateway.Model.DescribeTapeArchivesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGTapeArchiveListCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TapeArchives";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TapeARNs' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeTapeArchivesResponse, GetSGTapeArchiveListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TapeARNs;
            }
        ...
        private Amazon.StorageGateway.Model.DescribeTapeArchivesResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeTapeArchivesRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeTapeArchivesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.StorageGateway.Model.DescribeTapeArchivesResponse, GetSGTapeArchiveListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TapeArchives;
        }
