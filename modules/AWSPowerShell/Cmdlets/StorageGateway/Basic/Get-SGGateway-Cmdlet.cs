...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListGateways API operation.", Operation = new[] {"ListGateways"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListGatewaysResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.GatewayInfo or Amazon.StorageGateway.Model.ListGatewaysResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.GatewayInfo objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListGatewaysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGGatewayCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListGatewaysResponse, GetSGGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Gateways?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ListGatewaysResponse, GetSGGatewayCmdlet, object> Select { get; set; } =
