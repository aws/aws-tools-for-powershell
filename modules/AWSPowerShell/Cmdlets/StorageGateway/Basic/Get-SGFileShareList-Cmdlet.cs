...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    /// supported for S3 File Gateways.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SGFileShareList")]
    [OutputType("Amazon.StorageGateway.Model.FileShareInfo")]
    [AWSCmdlet("Calls the AWS Storage Gateway ListFileShares API operation.", Operation = new[] {"ListFileShares"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListFileSharesResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.FileShareInfo or Amazon.StorageGateway.Model.ListFileSharesResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.FileShareInfo objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListFileSharesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGFileShareListCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FileShareInfoList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListFileSharesResponse, GetSGFileShareListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FileShareInfoList?.Count ?? 0;
        ...
        private Amazon.StorageGateway.Model.ListFileSharesResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ListFileSharesRequest request)
        {
            ...
            try
            {
                return client.ListFileSharesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ListFileSharesResponse, GetSGFileShareListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FileShareInfoList;
        }
