...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway RetrieveTapeRecoveryPoint API operation.", Operation = new[] {"RetrieveTapeRecoveryPoint"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse))]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGTapeRecoveryPointCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse, GetSGTapeRecoveryPointCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointRequest request)
        {
            ...
            try
            {
                return client.RetrieveTapeRecoveryPointAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayARN { get; set; }
            public System.String TapeARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.RetrieveTapeRecoveryPointResponse, GetSGTapeRecoveryPointCmdlet, object> Select { get; set; } =
