...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway CancelRetrieval API operation.", Operation = new[] {"CancelRetrieval"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.CancelRetrievalResponse))]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.CancelRetrievalResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.StorageGateway.Model.CancelRetrievalResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StopSGRetrievalCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.CancelRetrievalResponse, StopSGRetrievalCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.CancelRetrievalResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.CancelRetrievalRequest request)
        {
            ...
            try
            {
                return client.CancelRetrievalAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayARN { get; set; }
            public System.String TapeARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.CancelRetrievalResponse, StopSGRetrievalCmdlet, object> Select { get; set; } =
