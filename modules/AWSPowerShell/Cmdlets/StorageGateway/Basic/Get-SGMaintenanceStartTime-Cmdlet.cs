...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class GetSGMaintenanceStartTimeCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeMaintenanceStartTimeResponse, GetSGMaintenanceStartTimeCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.DescribeMaintenanceStartTimeResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeMaintenanceStartTimeRequest request)
        {
            ...
            try
            {
                return client.DescribeMaintenanceStartTimeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeMaintenanceStartTimeResponse, GetSGMaintenanceStartTimeCmdlet, object> Select { get; set; } =
