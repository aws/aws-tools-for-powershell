...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListVolumes API operation.", Operation = new[] {"ListVolumes"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListVolumesResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.VolumeInfo or Amazon.StorageGateway.Model.ListVolumesResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.VolumeInfo objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListVolumesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGVolumeCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VolumeInfos";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListVolumesResponse, GetSGVolumeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.VolumeInfos?.Count ?? 0;
        ...
        private Amazon.StorageGateway.Model.ListVolumesResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ListVolumesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Storage Gateway", "ListVolumes");
            try
            {
                #if DESKTOP
                return client.ListVolumes(request);
                #elif CORECLR
                return client.ListVolumesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ListVolumesResponse, GetSGVolumeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VolumeInfos;
        }
