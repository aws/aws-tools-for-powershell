...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeUploadBuffer API operation.", Operation = new[] {"DescribeUploadBuffer"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.DescribeUploadBufferResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.DescribeUploadBufferResponse",
        "This cmdlet returns an Amazon.StorageGateway.Model.DescribeUploadBufferResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSGUploadBufferCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeUploadBufferResponse, GetSGUploadBufferCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.DescribeUploadBufferResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeUploadBufferRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Storage Gateway", "DescribeUploadBuffer");
            try
            {
                #if DESKTOP
                return client.DescribeUploadBuffer(request);
                #elif CORECLR
                return client.DescribeUploadBufferAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeUploadBufferResponse, GetSGUploadBufferCmdlet, object> Select { get; set; } =
