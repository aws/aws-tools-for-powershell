...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class JoinSGDomainCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of IP addresses, NetBIOS names, or host names of your domain server. If you need
        /// to specify the port number include it after the colon (“:”). For example, <c>mydc.mydomain.com:389</c>.</para><note><para>S3 File Gateway supports IPv6 addresses in addition to IPv4 and other existing formats.</para><para>FSx File Gateway does not support IPv6.</para></note><para />
        ...
        private Amazon.StorageGateway.Model.JoinDomainResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.JoinDomainRequest request)
        {
            ...
            try
            {
                return client.JoinDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
