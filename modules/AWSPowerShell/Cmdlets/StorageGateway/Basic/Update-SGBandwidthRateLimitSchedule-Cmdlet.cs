...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    /// </summary>
    [Cmdlet("Update", "SGBandwidthRateLimitSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Storage Gateway UpdateBandwidthRateLimitSchedule API operation.", Operation = new[] {"UpdateBandwidthRateLimitSchedule"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse))]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSGBandwidthRateLimitScheduleCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        public Amazon.StorageGateway.Model.BandwidthRateLimitInterval[] BandwidthRateLimitInterval { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SGBandwidthRateLimitSchedule (UpdateBandwidthRateLimitSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse, UpdateSGBandwidthRateLimitScheduleCmdlet>(Select) ??
            ...
            {
                context.BandwidthRateLimitInterval = new List<Amazon.StorageGateway.Model.BandwidthRateLimitInterval>(this.BandwidthRateLimitInterval);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleRequest();
        ...
        private Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Storage Gateway", "UpdateBandwidthRateLimitSchedule");
            try
            {
                #if DESKTOP
                return client.UpdateBandwidthRateLimitSchedule(request);
                #elif CORECLR
                return client.UpdateBandwidthRateLimitScheduleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<Amazon.StorageGateway.Model.BandwidthRateLimitInterval> BandwidthRateLimitInterval { get; set; }
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.UpdateBandwidthRateLimitScheduleResponse, UpdateSGBandwidthRateLimitScheduleCmdlet, object> Select { get; set; } =
