...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway AssociateFileSystem API operation.", Operation = new[] {"AssociateFileSystem"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.AssociateFileSystemResponse))]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.AssociateFileSystemResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.StorageGateway.Model.AssociateFileSystemResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewSGSGFileSystemAssociationCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SGSGFileSystemAssociation (AssociateFileSystem)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.AssociateFileSystemResponse, NewSGSGFileSystemAssociationCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.AssociateFileSystemResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.AssociateFileSystemRequest request)
        {
            ...
            try
            {
                return client.AssociateFileSystemAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String UserName { get; set; }
            public System.Func<Amazon.StorageGateway.Model.AssociateFileSystemResponse, NewSGSGFileSystemAssociationCmdlet, object> Select { get; set; } =
