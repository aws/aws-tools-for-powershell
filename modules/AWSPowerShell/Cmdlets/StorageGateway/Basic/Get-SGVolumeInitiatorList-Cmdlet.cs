...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListVolumeInitiators API operation.", Operation = new[] {"ListVolumeInitiators"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse), LegacyAlias="Get-SGVolumeInitiators")]
    [AWSCmdletOutput("System.String or Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGVolumeInitiatorListCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Initiators";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse, GetSGVolumeInitiatorListCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ListVolumeInitiatorsRequest request)
        {
            ...
            try
            {
                return client.ListVolumeInitiatorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VolumeARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ListVolumeInitiatorsResponse, GetSGVolumeInitiatorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Initiators;
        }
