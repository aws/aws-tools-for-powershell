...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class GetSGSMBSettingCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeSMBSettingsResponse, GetSGSMBSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StorageGateway.Model.DescribeSMBSettingsRequest();
        ...
        private Amazon.StorageGateway.Model.DescribeSMBSettingsResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeSMBSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Storage Gateway", "DescribeSMBSettings");
            try
            {
                #if DESKTOP
                return client.DescribeSMBSettings(request);
                #elif CORECLR
                return client.DescribeSMBSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeSMBSettingsResponse, GetSGSMBSettingCmdlet, object> Select { get; set; } =
