...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class ResetSGCacheCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ResetCacheResponse, ResetSGCacheCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.ResetCacheResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ResetCacheRequest request)
        {
            ...
            try
            {
                return client.ResetCacheAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.ResetCacheResponse, ResetSGCacheCmdlet, object> Select { get; set; } =
