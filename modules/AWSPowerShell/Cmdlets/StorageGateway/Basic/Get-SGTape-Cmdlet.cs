...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListTapes API operation.", Operation = new[] {"ListTapes"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.ListTapesResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.TapeInfo or Amazon.StorageGateway.Model.ListTapesResponse",
        "This cmdlet returns a collection of Amazon.StorageGateway.Model.TapeInfo objects.",
        "The service call response (type Amazon.StorageGateway.Model.ListTapesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSGTapeCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TapeInfos";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.ListTapesResponse, GetSGTapeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TapeInfos?.Count ?? 0;
        ...
        private Amazon.StorageGateway.Model.ListTapesResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ListTapesRequest request)
        {
            ...
            try
            {
                return client.ListTapesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.StorageGateway.Model.ListTapesResponse, GetSGTapeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TapeInfos;
        }
