...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class GetSGTapeRecoveryPointListCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TapeRecoveryPointInfos";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeTapeRecoveryPointsResponse, GetSGTapeRecoveryPointListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TapeRecoveryPointInfos?.Count ?? 0;
        ...
        private Amazon.StorageGateway.Model.DescribeTapeRecoveryPointsResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeTapeRecoveryPointsRequest request)
        {
            ...
            try
            {
                return client.DescribeTapeRecoveryPointsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeTapeRecoveryPointsResponse, GetSGTapeRecoveryPointListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TapeRecoveryPointInfos;
        }
