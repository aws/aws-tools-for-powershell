...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeCache API operation.", Operation = new[] {"DescribeCache"}, SelectReturnType = typeof(Amazon.StorageGateway.Model.DescribeCacheResponse))]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.DescribeCacheResponse",
        "This cmdlet returns an Amazon.StorageGateway.Model.DescribeCacheResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSGCacheCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.DescribeCacheResponse, GetSGCacheCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StorageGateway.Model.DescribeCacheRequest();
        ...
        private Amazon.StorageGateway.Model.DescribeCacheResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeCacheRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Storage Gateway", "DescribeCache");
            try
            {
                #if DESKTOP
                return client.DescribeCache(request);
                #elif CORECLR
                return client.DescribeCacheAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GatewayARN { get; set; }
            public System.Func<Amazon.StorageGateway.Model.DescribeCacheResponse, GetSGCacheCmdlet, object> Select { get; set; } =
