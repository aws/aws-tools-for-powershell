...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    public partial class SetSGSMBGuestPasswordCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.StorageGateway.Model.SetSMBGuestPasswordResponse, SetSGSMBGuestPasswordCmdlet>(Select) ??
        ...
        private Amazon.StorageGateway.Model.SetSMBGuestPasswordResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.SetSMBGuestPasswordRequest request)
        {
            ...
            try
            {
                return client.SetSMBGuestPasswordAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayARN { get; set; }
            public System.String Password { get; set; }
            public System.Func<Amazon.StorageGateway.Model.SetSMBGuestPasswordResponse, SetSGSMBGuestPasswordCmdlet, object> Select { get; set; } =
