...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkDocs DeleteFolder API operation.", Operation = new[] {"DeleteFolder"}, SelectReturnType = typeof(Amazon.WorkDocs.Model.DeleteFolderResponse))]
    [AWSCmdletOutput("None or Amazon.WorkDocs.Model.DeleteFolderResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WorkDocs.Model.DeleteFolderResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveWDFolderCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DeleteFolderResponse, RemoveWDFolderCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.DeleteFolderResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DeleteFolderRequest request)
        {
            ...
            try
            {
                return client.DeleteFolderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AuthenticationToken { get; set; }
            public System.String FolderId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DeleteFolderResponse, RemoveWDFolderCmdlet, object> Select { get; set; } =
