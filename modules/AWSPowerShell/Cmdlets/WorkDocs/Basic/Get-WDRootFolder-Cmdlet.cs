...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdlet("Calls the Amazon WorkDocs DescribeRootFolders API operation.", Operation = new[] {"DescribeRootFolders"}, SelectReturnType = typeof(Amazon.WorkDocs.Model.DescribeRootFoldersResponse))]
    [AWSCmdletOutput("Amazon.WorkDocs.Model.FolderMetadata or Amazon.WorkDocs.Model.DescribeRootFoldersResponse",
        "This cmdlet returns a collection of Amazon.WorkDocs.Model.FolderMetadata objects.",
        "The service call response (type Amazon.WorkDocs.Model.DescribeRootFoldersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWDRootFolderCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AuthenticationToken' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DescribeRootFoldersResponse, GetWDRootFolderCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.AuthenticationToken;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkDocs.Model.DescribeRootFoldersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Folders.Count;
        ...
        private Amazon.WorkDocs.Model.DescribeRootFoldersResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DescribeRootFoldersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkDocs", "DescribeRootFolders");
            try
            {
                #if DESKTOP
                return client.DescribeRootFolders(request);
                #elif CORECLR
                return client.DescribeRootFoldersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DescribeRootFoldersResponse, GetWDRootFolderCmdlet, object> Select { get; set; } =
