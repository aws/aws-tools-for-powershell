...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    public partial class RemoveWDNotificationSubscriptionCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DeleteNotificationSubscriptionResponse, RemoveWDNotificationSubscriptionCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.DeleteNotificationSubscriptionResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DeleteNotificationSubscriptionRequest request)
        {
            ...
            try
            {
                return client.DeleteNotificationSubscriptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String OrganizationId { get; set; }
            public System.String SubscriptionId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DeleteNotificationSubscriptionResponse, RemoveWDNotificationSubscriptionCmdlet, object> Select { get; set; } =
