...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdlet("Calls the Amazon WorkDocs DescribeComments API operation.", Operation = new[] {"DescribeComments"}, SelectReturnType = typeof(Amazon.WorkDocs.Model.DescribeCommentsResponse))]
    [AWSCmdletOutput("Amazon.WorkDocs.Model.Comment or Amazon.WorkDocs.Model.DescribeCommentsResponse",
        "This cmdlet returns a collection of Amazon.WorkDocs.Model.Comment objects.",
        "The service call response (type Amazon.WorkDocs.Model.DescribeCommentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWDCommentCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Comments";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DescribeCommentsResponse, GetWDCommentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Comments?.Count ?? 0;
        ...
        private Amazon.WorkDocs.Model.DescribeCommentsResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DescribeCommentsRequest request)
        {
            ...
            try
            {
                return client.DescribeCommentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.String VersionId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DescribeCommentsResponse, GetWDCommentCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Comments;
        }
