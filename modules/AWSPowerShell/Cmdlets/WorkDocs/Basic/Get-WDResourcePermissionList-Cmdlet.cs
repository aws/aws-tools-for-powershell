...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdlet("Calls the Amazon WorkDocs DescribeResourcePermissions API operation.", Operation = new[] {"DescribeResourcePermissions"}, SelectReturnType = typeof(Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse))]
    [AWSCmdletOutput("Amazon.WorkDocs.Model.Principal or Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse",
        "This cmdlet returns a collection of Amazon.WorkDocs.Model.Principal objects.",
        "The service call response (type Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWDResourcePermissionListCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse, GetWDResourcePermissionListCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DescribeResourcePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkDocs", "DescribeResourcePermissions");
            try
            {
                #if DESKTOP
                return client.DescribeResourcePermissions(request);
                #elif CORECLR
                return client.DescribeResourcePermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DescribeResourcePermissionsResponse, GetWDResourcePermissionListCmdlet, object> Select { get; set; } =
