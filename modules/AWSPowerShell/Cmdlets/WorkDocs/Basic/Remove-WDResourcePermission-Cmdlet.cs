...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    public partial class RemoveWDResourcePermissionCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.RemoveResourcePermissionResponse, RemoveWDResourcePermissionCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.RemoveResourcePermissionResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.RemoveResourcePermissionRequest request)
        {
            ...
            try
            {
                return client.RemoveResourcePermissionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.WorkDocs.PrincipalType PrincipalType { get; set; }
            public System.String ResourceId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.RemoveResourcePermissionResponse, RemoveWDResourcePermissionCmdlet, object> Select { get; set; } =
