...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdletOutput("Amazon.WorkDocs.Model.GetDocumentResponse",
        "This cmdlet returns an Amazon.WorkDocs.Model.GetDocumentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
