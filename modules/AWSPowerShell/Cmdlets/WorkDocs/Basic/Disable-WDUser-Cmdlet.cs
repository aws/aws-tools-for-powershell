...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    public partial class DisableWDUserCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DeactivateUserResponse, DisableWDUserCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.DeactivateUserResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DeactivateUserRequest request)
        {
            ...
            try
            {
                return client.DeactivateUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AuthenticationToken { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DeactivateUserResponse, DisableWDUserCmdlet, object> Select { get; set; } =
