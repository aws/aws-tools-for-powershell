...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    public partial class RemoveWDCommentCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.DeleteCommentResponse, RemoveWDCommentCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.DeleteCommentResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DeleteCommentRequest request)
        {
            ...
            try
            {
                return client.DeleteCommentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DocumentId { get; set; }
            public System.String VersionId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.DeleteCommentResponse, RemoveWDCommentCmdlet, object> Select { get; set; } =
