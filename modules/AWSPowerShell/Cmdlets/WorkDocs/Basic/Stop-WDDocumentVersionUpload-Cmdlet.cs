...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon WorkDocs AbortDocumentVersionUpload API operation.", Operation = new[] {"AbortDocumentVersionUpload"}, SelectReturnType = typeof(Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse))]
    [AWSCmdletOutput("None or Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse) be returned by specifying '-Select *'."
    )]
    public partial class StopWDDocumentVersionUploadCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse, StopWDDocumentVersionUploadCmdlet>(Select) ??
        ...
        private Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.AbortDocumentVersionUploadRequest request)
        {
            ...
            try
            {
                return client.AbortDocumentVersionUploadAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DocumentId { get; set; }
            public System.String VersionId { get; set; }
            public System.Func<Amazon.WorkDocs.Model.AbortDocumentVersionUploadResponse, StopWDDocumentVersionUploadCmdlet, object> Select { get; set; } =
