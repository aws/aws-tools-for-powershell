...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "ECRImageSigningStatusDetail")]
    [OutputType("Amazon.ECR.Model.DescribeImageSigningStatusResponse")]
    [AWSCmdlet("Calls the Amazon EC2 Container Registry DescribeImageSigningStatus API operation.", Operation = new[] {"DescribeImageSigningStatus"}, SelectReturnType = typeof(Amazon.ECR.Model.DescribeImageSigningStatusResponse))]
    [AWSCmdletOutput("Amazon.ECR.Model.DescribeImageSigningStatusResponse",
        "This cmdlet returns an Amazon.ECR.Model.DescribeImageSigningStatusResponse object containing multiple properties."
    )]
    public partial class GetECRImageSigningStatusDetailCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the repository that contains the image.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ECR.Model.DescribeImageSigningStatusResponse).
        /// Specifying the name of a property of type Amazon.ECR.Model.DescribeImageSigningStatusResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.DescribeImageSigningStatusResponse, GetECRImageSigningStatusDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECR.Model.DescribeImageSigningStatusRequest();
        ...
        private Amazon.ECR.Model.DescribeImageSigningStatusResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.DescribeImageSigningStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Registry", "DescribeImageSigningStatus");
            try
            {
                #if DESKTOP
                return client.DescribeImageSigningStatus(request);
                #elif CORECLR
                return client.DescribeImageSigningStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.DescribeImageSigningStatusResponse, GetECRImageSigningStatusDetailCmdlet, object> Select { get; set; } =
