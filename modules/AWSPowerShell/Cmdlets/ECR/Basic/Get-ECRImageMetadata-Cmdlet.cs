...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class GetECRImageMetadataCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The image status with which to filter your <a>DescribeImages</a> results. Valid values
        /// are <c>ACTIVE</c>, <c>ARCHIVED</c>, and <c>ACTIVATING</c>. If not specified, only
        /// images with <c>ACTIVE</c> status are returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of repository results returned by <c>DescribeImages</c> in paginated
        ...
        /// you specify images with <c>imageIds</c>.</para>
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>DescribeImages</c>
        /// request where <c>maxResults</c> was used and the results exceeded the value of that
        /// parameter. Pagination continues from the end of the previous results that returned
        /// the <c>nextToken</c> value. This value is <c>null</c> when there are no more results
        /// to return. This option cannot be used when you specify images with <c>imageIds</c>.</para>
        /// </para>
        /// <para>
