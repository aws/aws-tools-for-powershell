...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class WriteECRRegistryScanningConfigurationCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// repository filters are used and at what frequency scanning will occur.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The scanning type to set for the registry.</para><para>When a registry scanning configuration is not defined, by default the <c>BASIC</c>
        ...
        /// basic scanning.</para><para>When the <c>ENHANCED</c> scan type is set, Amazon Inspector provides automated vulnerability
        /// scanning. You may choose between continuous scanning or scan on push and you may specify
        /// filters to determine which individual repositories, or all repositories, are scanned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.ECR.Model.PutRegistryScanningConfigurationResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.PutRegistryScanningConfigurationRequest request)
        {
            ...
            try
            {
                return client.PutRegistryScanningConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
