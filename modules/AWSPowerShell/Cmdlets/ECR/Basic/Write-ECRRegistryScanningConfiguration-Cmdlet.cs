...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class WriteECRRegistryScanningConfigurationCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The scanning type to set for the registry.</para><para>By default, the <code>BASIC</code> scan type is used. When basic scanning is set,
        ...
        /// images with basic scanning.</para><para>When the <code>ENHANCED</code> scan type is set, Amazon Inspector provides automated,
        /// continuous scanning of all repositories in your registry.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
