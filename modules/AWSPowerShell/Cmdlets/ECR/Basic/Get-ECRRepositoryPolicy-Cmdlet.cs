...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Registry GetRepositoryPolicy API operation.", Operation = new[] {"GetRepositoryPolicy"}, SelectReturnType = typeof(Amazon.ECR.Model.GetRepositoryPolicyResponse))]
    [AWSCmdletOutput("Amazon.ECR.Model.GetRepositoryPolicyResponse",
        "This cmdlet returns an Amazon.ECR.Model.GetRepositoryPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetECRRepositoryPolicyCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.GetRepositoryPolicyResponse, GetECRRepositoryPolicyCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.GetRepositoryPolicyResponse, GetECRRepositoryPolicyCmdlet, object> Select { get; set; } =
