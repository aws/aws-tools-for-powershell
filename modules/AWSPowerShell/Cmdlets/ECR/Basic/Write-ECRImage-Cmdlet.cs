...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class WriteECRImageCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.PutImageResponse, WriteECRImageCmdlet>(Select) ??
        ...
        private Amazon.ECR.Model.PutImageResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.PutImageRequest request)
        {
            ...
            try
            {
                return client.PutImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.PutImageResponse, WriteECRImageCmdlet, object> Select { get; set; } =
