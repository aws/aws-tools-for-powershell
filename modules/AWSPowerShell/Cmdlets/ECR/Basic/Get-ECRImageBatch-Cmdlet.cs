...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class GetECRImageBatchCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// images to describe. If you do not specify a registry, the default registry is assumed.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.BatchGetImageResponse, GetECRImageBatchCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.AcceptedMediaType != null)
            {
                context.AcceptedMediaType = new List<System.String>(this.AcceptedMediaType);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.AcceptedMediaType != null)
            {
                request.AcceptedMediaTypes = cmdletContext.AcceptedMediaType;
            }
        ...
        private Amazon.ECR.Model.BatchGetImageResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.BatchGetImageRequest request)
        {
            ...
            try
            {
                return client.BatchGetImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> AcceptedMediaType { get; set; }
            public List<Amazon.ECR.Model.ImageIdentifier> ImageId { get; set; }
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.BatchGetImageResponse, GetECRImageBatchCmdlet, object> Select { get; set; } =
