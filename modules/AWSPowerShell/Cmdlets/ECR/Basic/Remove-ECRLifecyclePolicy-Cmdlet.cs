...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Registry DeleteLifecyclePolicy API operation.", Operation = new[] {"DeleteLifecyclePolicy"}, SelectReturnType = typeof(Amazon.ECR.Model.DeleteLifecyclePolicyResponse))]
    [AWSCmdletOutput("Amazon.ECR.Model.DeleteLifecyclePolicyResponse",
        "This cmdlet returns an Amazon.ECR.Model.DeleteLifecyclePolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveECRLifecyclePolicyCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ECRLifecyclePolicy (DeleteLifecyclePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.DeleteLifecyclePolicyResponse, RemoveECRLifecyclePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECR.Model.DeleteLifecyclePolicyRequest();
        ...
        private Amazon.ECR.Model.DeleteLifecyclePolicyResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.DeleteLifecyclePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Registry", "DeleteLifecyclePolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.DeleteLifecyclePolicyResponse, RemoveECRLifecyclePolicyCmdlet, object> Select { get; set; } =
