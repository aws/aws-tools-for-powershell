...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    public partial class WriteECRLifecyclePolicyCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^LifecyclePolicyText' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.PutLifecyclePolicyResponse, WriteECRLifecyclePolicyCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.LifecyclePolicyText;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.LifecyclePolicyText = this.LifecyclePolicyText;
            #if MODULAR
            if (this.LifecyclePolicyText == null && ParameterWasBound(nameof(this.LifecyclePolicyText)))
            {
                WriteWarning("You are passing $null as a value for parameter LifecyclePolicyText which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.PutLifecyclePolicyResponse, WriteECRLifecyclePolicyCmdlet, object> Select { get; set; } =
