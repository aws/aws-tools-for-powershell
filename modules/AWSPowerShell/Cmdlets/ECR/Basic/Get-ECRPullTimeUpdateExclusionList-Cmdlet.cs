...
{
    /// <summary>
    /// Lists the IAM principals that are excluded from having their image pull times recorded.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetECRPullTimeUpdateExclusionListCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        private Amazon.ECR.Model.ListPullTimeUpdateExclusionsResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.ListPullTimeUpdateExclusionsRequest request)
        {
            ...
            try
            {
                return client.ListPullTimeUpdateExclusionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
