...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Registry DeleteRepositoryPolicy API operation.", Operation = new[] {"DeleteRepositoryPolicy"}, SelectReturnType = typeof(Amazon.ECR.Model.DeleteRepositoryPolicyResponse))]
    [AWSCmdletOutput("Amazon.ECR.Model.DeleteRepositoryPolicyResponse",
        "This cmdlet returns an Amazon.ECR.Model.DeleteRepositoryPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveECRRepositoryPolicyCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECR.Model.DeleteRepositoryPolicyResponse, RemoveECRRepositoryPolicyCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RegistryId { get; set; }
            public System.String RepositoryName { get; set; }
            public System.Func<Amazon.ECR.Model.DeleteRepositoryPolicyResponse, RemoveECRRepositoryPolicyCmdlet, object> Select { get; set; } =
