...
{
    /// <summary>
    /// Lists the AWS RAM permissions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "RAMPermissionList")]
    ...
    public partial class GetRAMPermissionListCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the resource type for which to list permissions. For example, to list only
        /// permissions that apply to EC2 subnets, specify <code>ec2:Subnet</code>.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.ListPermissionsResponse, GetRAMPermissionListCmdlet>(Select) ??
        ...
        private Amazon.RAM.Model.ListPermissionsResponse CallAWSServiceOperation(IAmazonRAM client, Amazon.RAM.Model.ListPermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager (RAM)", "ListPermissions");
            try
            {
                #if DESKTOP
