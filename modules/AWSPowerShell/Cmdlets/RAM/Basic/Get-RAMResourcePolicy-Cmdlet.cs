...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager (RAM) GetResourcePolicies API operation.", Operation = new[] {"GetResourcePolicies"}, SelectReturnType = typeof(Amazon.RAM.Model.GetResourcePoliciesResponse))]
    [AWSCmdletOutput("System.String or Amazon.RAM.Model.GetResourcePoliciesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.RAM.Model.GetResourcePoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRAMResourcePolicyCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        /// Resource Names (ARNs)</a> of the resources whose policies you want to retrieve.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.GetResourcePoliciesResponse, GetRAMResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RAM.Model.GetResourcePoliciesRequest();
        ...
        private Amazon.RAM.Model.GetResourcePoliciesResponse CallAWSServiceOperation(IAmazonRAM client, Amazon.RAM.Model.GetResourcePoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager (RAM)", "GetResourcePolicies");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RAM.Model.GetResourcePoliciesResponse, GetRAMResourcePolicyCmdlet, object> Select { get; set; } =
