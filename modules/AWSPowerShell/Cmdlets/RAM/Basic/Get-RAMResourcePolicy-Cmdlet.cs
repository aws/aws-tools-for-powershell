...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.RAM.Model.GetResourcePoliciesResponse",
        ...
        "The service call response (type Amazon.RAM.Model.GetResourcePoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
