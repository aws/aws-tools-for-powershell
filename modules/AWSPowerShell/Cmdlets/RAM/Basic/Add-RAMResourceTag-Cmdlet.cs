...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    public partial class AddRAMResourceTagCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        /// be an empty string. The tag value must be present but can be an empty string.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.TagResourceResponse, AddRAMResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager (RAM)", "TagResource");
            try
            {
