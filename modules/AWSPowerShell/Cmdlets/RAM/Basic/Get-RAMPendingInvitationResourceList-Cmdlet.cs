...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdlet("Calls the AWS Resource Access Manager (RAM) ListPendingInvitationResources API operation.", Operation = new[] {"ListPendingInvitationResources"}, SelectReturnType = typeof(Amazon.RAM.Model.ListPendingInvitationResourcesResponse))]
    [AWSCmdletOutput("Amazon.RAM.Model.Resource or Amazon.RAM.Model.ListPendingInvitationResourcesResponse",
        "This cmdlet returns a collection of Amazon.RAM.Model.Resource objects.",
        "The service call response (type Amazon.RAM.Model.ListPendingInvitationResourcesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRAMPendingInvitationResourceListCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.ListPendingInvitationResourcesResponse, GetRAMPendingInvitationResourceListCmdlet>(Select) ??
        ...
        private Amazon.RAM.Model.ListPendingInvitationResourcesResponse CallAWSServiceOperation(IAmazonRAM client, Amazon.RAM.Model.ListPendingInvitationResourcesRequest request)
        {
            ...
            try
            {
                return client.ListPendingInvitationResourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
