...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [AWSCmdletOutput("Amazon.RAM.Model.Resource or Amazon.RAM.Model.ListPendingInvitationResourcesResponse",
        ...
        "The service call response (type Amazon.RAM.Model.ListPendingInvitationResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
