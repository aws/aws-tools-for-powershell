...
namespace Amazon.PowerShell.Cmdlets.RAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Resource Access Manager (RAM) UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.RAM.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.RAM.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.RAM.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveRAMResourceTagCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies a list of one or more tag keys that you want to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.UntagResourceResponse, RemoveRAMResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager (RAM)", "UntagResource");
            try
            {
