...
{
    /// <summary>
    /// Lists the AWS RAM permissions that are associated with a resource share.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "RAMResourceSharePermissionList")]
    [OutputType("Amazon.RAM.Model.ResourceSharePermissionSummary")]
    [AWSCmdlet("Calls the AWS Resource Access Manager (RAM) ListResourceSharePermissions API operation.", Operation = new[] {"ListResourceSharePermissions"}, SelectReturnType = typeof(Amazon.RAM.Model.ListResourceSharePermissionsResponse))]
    [AWSCmdletOutput("Amazon.RAM.Model.ResourceSharePermissionSummary or Amazon.RAM.Model.ListResourceSharePermissionsResponse",
        "This cmdlet returns a collection of Amazon.RAM.Model.ResourceSharePermissionSummary objects.",
        "The service call response (type Amazon.RAM.Model.ListResourceSharePermissionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRAMResourceSharePermissionListCmdlet : AmazonRAMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RAM.Model.ListResourceSharePermissionsResponse, GetRAMResourceSharePermissionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RAM.Model.ListResourceSharePermissionsRequest();
        ...
        private Amazon.RAM.Model.ListResourceSharePermissionsResponse CallAWSServiceOperation(IAmazonRAM client, Amazon.RAM.Model.ListResourceSharePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resource Access Manager (RAM)", "ListResourceSharePermissions");
            try
            {
                #if DESKTOP
                return client.ListResourceSharePermissions(request);
                #elif CORECLR
                return client.ListResourceSharePermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceShareArn { get; set; }
            public System.Func<Amazon.RAM.Model.ListResourceSharePermissionsResponse, GetRAMResourceSharePermissionListCmdlet, object> Select { get; set; } =
