...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteRouteResponse API operation.", Operation = new[] {"DeleteRouteResponse"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse))]
    [AWSCmdletOutput("None or Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAG2RouteResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse, RemoveAG2RouteResponseCmdlet>(Select) ??
        ...
        private Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteRouteResponseRequest request)
        {
            ...
            try
            {
                return client.DeleteRouteResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RouteId { get; set; }
            public System.String RouteResponseId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.DeleteRouteResponseResponse, RemoveAG2RouteResponseCmdlet, object> Select { get; set; } =
