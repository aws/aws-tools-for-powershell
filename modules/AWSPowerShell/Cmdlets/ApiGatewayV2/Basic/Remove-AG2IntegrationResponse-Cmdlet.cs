...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AG2IntegrationResponse", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteIntegrationResponse API operation.", Operation = new[] {"DeleteIntegrationResponse"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse))]
    [AWSCmdletOutput("None or Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAG2IntegrationResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AG2IntegrationResponse (DeleteIntegrationResponse)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse, RemoveAG2IntegrationResponseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseRequest();
        ...
        private Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "DeleteIntegrationResponse");
            try
            {
                #if DESKTOP
                return client.DeleteIntegrationResponse(request);
                #elif CORECLR
                return client.DeleteIntegrationResponseAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String IntegrationId { get; set; }
            public System.String IntegrationResponseId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.DeleteIntegrationResponseResponse, RemoveAG2IntegrationResponseCmdlet, object> Select { get; set; } =
