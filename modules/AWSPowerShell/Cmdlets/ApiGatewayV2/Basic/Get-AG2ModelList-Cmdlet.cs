...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2ModelList")]
    [OutputType("Amazon.ApiGatewayV2.Model.Model")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetModels API operation.", Operation = new[] {"GetModels"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetModelsResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Model or Amazon.ApiGatewayV2.Model.GetModelsResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.Model objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetModelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2ModelListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetModelsResponse, GetAG2ModelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApiGatewayV2.Model.GetModelsRequest();
        ...
        private Amazon.ApiGatewayV2.Model.GetModelsResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetModelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetModels");
            try
            {
                #if DESKTOP
                return client.GetModels(request);
                #elif CORECLR
                return client.GetModelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetModelsResponse, GetAG2ModelListCmdlet, object> Select { get; set; } =
