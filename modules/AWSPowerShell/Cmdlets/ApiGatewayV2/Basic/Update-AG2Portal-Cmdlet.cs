...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// Updates a portal.
    /// </summary>
    [Cmdlet("Update", "AG2Portal", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ApiGatewayV2.Model.UpdatePortalResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdatePortal API operation.", Operation = new[] {"UpdatePortal"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.UpdatePortalResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdatePortalResponse",
        "This cmdlet returns an Amazon.ApiGatewayV2.Model.UpdatePortalResponse object containing multiple properties."
    )]
    public partial class UpdateAG2PortalCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARNs of the portal products included in the portal.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The CloudWatch RUM app monitor name.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApiGatewayV2.Model.UpdatePortalResponse).
        /// Specifying the name of a property of type Amazon.ApiGatewayV2.Model.UpdatePortalResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AG2Portal (UpdatePortal)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.UpdatePortalResponse, UpdateAG2PortalCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.UpdatePortalRequest();
        ...
        private Amazon.ApiGatewayV2.Model.UpdatePortalResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.UpdatePortalRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "UpdatePortal");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PortalId { get; set; }
            public System.String RumAppMonitorName { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.UpdatePortalResponse, UpdateAG2PortalCmdlet, object> Select { get; set; } =
