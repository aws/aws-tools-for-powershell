...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AG2Deployment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteDeployment API operation.", Operation = new[] {"DeleteDeployment"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse))]
    [AWSCmdletOutput("None or Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAG2DeploymentCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AG2Deployment (DeleteDeployment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse, RemoveAG2DeploymentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.DeleteDeploymentRequest();
        ...
        private Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "DeleteDeployment");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String DeploymentId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.DeleteDeploymentResponse, RemoveAG2DeploymentCmdlet, object> Select { get; set; } =
