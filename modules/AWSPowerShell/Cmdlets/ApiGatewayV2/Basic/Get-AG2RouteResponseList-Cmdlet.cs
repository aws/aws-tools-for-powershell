...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetRouteResponses API operation.", Operation = new[] {"GetRouteResponses"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.RouteResponse or Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.RouteResponse objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAG2RouteResponseListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse, GetAG2RouteResponseListCmdlet>(Select) ??
        ...
        private Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetRouteResponsesRequest request)
        {
            ...
            try
            {
                return client.GetRouteResponsesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RouteId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetRouteResponsesResponse, GetAG2RouteResponseListCmdlet, object> Select { get; set; } =
