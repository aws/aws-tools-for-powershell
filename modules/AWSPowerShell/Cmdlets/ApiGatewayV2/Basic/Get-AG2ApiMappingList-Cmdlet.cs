...
{
    /// <summary>
    /// The API mappings.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.ApiMapping or Amazon.ApiGatewayV2.Model.GetApiMappingsResponse",
        ...
        "The service call response (type Amazon.ApiGatewayV2.Model.GetApiMappingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2ApiMappingListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.GetApiMappingsResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetApiMappingsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetApiMappings(request);
                #elif CORECLR
                return client.GetApiMappingsAsync(request).GetAwaiter().GetResult();
                #else
