...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2Model")]
    [OutputType("Amazon.ApiGatewayV2.Model.GetModelResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetModel API operation.", Operation = new[] {"GetModel"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetModelResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.GetModelResponse",
        "This cmdlet returns an Amazon.ApiGatewayV2.Model.GetModelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2ModelCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetModelResponse, GetAG2ModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.GetModelRequest();
        ...
        private Amazon.ApiGatewayV2.Model.GetModelResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetModel");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String ModelId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetModelResponse, GetAG2ModelCmdlet, object> Select { get; set; } =
