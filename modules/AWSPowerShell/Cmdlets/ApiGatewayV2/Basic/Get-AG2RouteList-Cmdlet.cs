...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetRoutes API operation.", Operation = new[] {"GetRoutes"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetRoutesResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Route or Amazon.ApiGatewayV2.Model.GetRoutesResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.Route objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetRoutesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAG2RouteListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetRoutesResponse, GetAG2RouteListCmdlet>(Select) ??
        ...
        private Amazon.ApiGatewayV2.Model.GetRoutesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetRoutesRequest request)
        {
            ...
            try
            {
                return client.GetRoutesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetRoutesResponse, GetAG2RouteListCmdlet, object> Select { get; set; } =
