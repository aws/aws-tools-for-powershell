...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2AuthorizerList")]
    [OutputType("Amazon.ApiGatewayV2.Model.Authorizer")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetAuthorizers API operation.", Operation = new[] {"GetAuthorizers"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetAuthorizersResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Authorizer or Amazon.ApiGatewayV2.Model.GetAuthorizersResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.Authorizer objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetAuthorizersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2AuthorizerListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetAuthorizersResponse, GetAG2AuthorizerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApiGatewayV2.Model.GetAuthorizersRequest();
        ...
        private Amazon.ApiGatewayV2.Model.GetAuthorizersResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetAuthorizersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetAuthorizers");
            try
            {
                #if DESKTOP
                return client.GetAuthorizers(request);
                #elif CORECLR
                return client.GetAuthorizersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetAuthorizersResponse, GetAG2AuthorizerListCmdlet, object> Select { get; set; } =
