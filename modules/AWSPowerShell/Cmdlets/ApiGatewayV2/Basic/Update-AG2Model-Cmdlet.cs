...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// Updates a Model.
    /// </summary>
    [Cmdlet("Update", "AG2Model", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ApiGatewayV2.Model.UpdateModelResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdateModel API operation.", Operation = new[] {"UpdateModel"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.UpdateModelResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdateModelResponse",
        "This cmdlet returns an Amazon.ApiGatewayV2.Model.UpdateModelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAG2ModelCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AG2Model (UpdateModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.UpdateModelResponse, UpdateAG2ModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.UpdateModelRequest();
        ...
        private Amazon.ApiGatewayV2.Model.UpdateModelResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.UpdateModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "UpdateModel");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String Schema { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.UpdateModelResponse, UpdateAG2ModelCmdlet, object> Select { get; set; } =
