...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2IntegrationResponseList")]
    [OutputType("Amazon.ApiGatewayV2.Model.IntegrationResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetIntegrationResponses API operation.", Operation = new[] {"GetIntegrationResponses"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.IntegrationResponse or Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.IntegrationResponse objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2IntegrationResponseListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse, GetAG2IntegrationResponseListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApiGatewayV2.Model.GetIntegrationResponsesRequest();
        ...
        private Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetIntegrationResponsesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetIntegrationResponses");
            try
            {
                #if DESKTOP
                return client.GetIntegrationResponses(request);
                #elif CORECLR
                return client.GetIntegrationResponsesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetIntegrationResponsesResponse, GetAG2IntegrationResponseListCmdlet, object> Select { get; set; } =
