...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Reset", "AG2AuthorizersCache", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class ResetAG2AuthorizersCacheCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Reset-AG2AuthorizersCache (ResetAuthorizersCache)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheResponse, ResetAG2AuthorizersCacheCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheRequest();
        ...
        private Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "ResetAuthorizersCache");
            try
            {
                #if DESKTOP
                return client.ResetAuthorizersCache(request);
                #elif CORECLR
                return client.ResetAuthorizersCacheAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.ResetAuthorizersCacheResponse, ResetAG2AuthorizersCacheCmdlet, object> Select { get; set; } =
