...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// Deletes a Route.
    /// </summary>
    [Cmdlet("Remove", "AG2Route", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteRoute API operation.", Operation = new[] {"DeleteRoute"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.DeleteRouteResponse))]
    [AWSCmdletOutput("None or Amazon.ApiGatewayV2.Model.DeleteRouteResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteRouteResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAG2RouteCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AG2Route (DeleteRoute)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.DeleteRouteResponse, RemoveAG2RouteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.DeleteRouteRequest();
        ...
        private Amazon.ApiGatewayV2.Model.DeleteRouteResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteRouteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "DeleteRoute");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String RouteId { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.DeleteRouteResponse, RemoveAG2RouteCmdlet, object> Select { get; set; } =
