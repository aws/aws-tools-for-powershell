...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2StageList")]
    [OutputType("Amazon.ApiGatewayV2.Model.Stage")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetStages API operation.", Operation = new[] {"GetStages"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetStagesResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Stage or Amazon.ApiGatewayV2.Model.GetStagesResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.Stage objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetStagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2StageListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetStagesResponse, GetAG2StageListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApiGatewayV2.Model.GetStagesRequest();
        ...
        private Amazon.ApiGatewayV2.Model.GetStagesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetStagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetStages");
            try
            {
                #if DESKTOP
                return client.GetStages(request);
                #elif CORECLR
                return client.GetStagesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetStagesResponse, GetAG2StageListCmdlet, object> Select { get; set; } =
