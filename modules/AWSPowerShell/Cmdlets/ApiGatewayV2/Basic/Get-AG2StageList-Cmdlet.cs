...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Stage or Amazon.ApiGatewayV2.Model.GetStagesResponse",
        ...
        "The service call response (type Amazon.ApiGatewayV2.Model.GetStagesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAG2StageListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.GetStagesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetStagesRequest request)
        {
            ...
            try
            {
                return client.GetStagesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
