...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2DeploymentList")]
    [OutputType("Amazon.ApiGatewayV2.Model.Deployment")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetDeployments API operation.", Operation = new[] {"GetDeployments"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.GetDeploymentsResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Deployment or Amazon.ApiGatewayV2.Model.GetDeploymentsResponse",
        "This cmdlet returns a collection of Amazon.ApiGatewayV2.Model.Deployment objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetDeploymentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2DeploymentListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.GetDeploymentsResponse, GetAG2DeploymentListCmdlet>(Select) ??
        ...
        private Amazon.ApiGatewayV2.Model.GetDeploymentsResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetDeploymentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetDeployments");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.GetDeploymentsResponse, GetAG2DeploymentListCmdlet, object> Select { get; set; } =
