...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 CreateRouteResponse API operation.", Operation = new[] {"CreateRouteResponse"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse",
        "This cmdlet returns an Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse object containing multiple properties."
    )]
    public partial class NewAG2RouteResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The response models for the route response.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The route response parameters.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse, NewAG2RouteResponseCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.RouteResponseKey == null && ParameterWasBound(nameof(this.RouteResponseKey)))
            {
                WriteWarning("You are passing $null as a value for parameter RouteResponseKey which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.CreateRouteResponseRequest request)
        {
            ...
            try
            {
                return client.CreateRouteResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RouteId { get; set; }
            public System.String RouteResponseKey { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.CreateRouteResponseResponse, NewAG2RouteResponseCmdlet, object> Select { get; set; } =
