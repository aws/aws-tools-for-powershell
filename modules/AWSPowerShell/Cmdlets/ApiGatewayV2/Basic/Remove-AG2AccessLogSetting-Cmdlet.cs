...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AG2AccessLogSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteAccessLogSettings API operation.", Operation = new[] {"DeleteAccessLogSettings"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse))]
    [AWSCmdletOutput("None or Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAG2AccessLogSettingCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AG2AccessLogSetting (DeleteAccessLogSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse, RemoveAG2AccessLogSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsRequest();
        ...
        private Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "DeleteAccessLogSettings");
            try
            {
                #if DESKTOP
                return client.DeleteAccessLogSettings(request);
                #elif CORECLR
                return client.DeleteAccessLogSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.DeleteAccessLogSettingsResponse, RemoveAG2AccessLogSettingCmdlet, object> Select { get; set; } =
