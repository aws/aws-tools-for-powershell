...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// Imports an API.
    /// </summary>
    [Cmdlet("Import", "AG2Api", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ApiGatewayV2.Model.ImportApiResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 ImportApi API operation.", Operation = new[] {"ImportApi"}, SelectReturnType = typeof(Amazon.ApiGatewayV2.Model.ImportApiResponse))]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.ImportApiResponse",
        "This cmdlet returns an Amazon.ApiGatewayV2.Model.ImportApiResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ImportAG2ApiCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Body' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.Body), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Import-AG2Api (ImportApi)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApiGatewayV2.Model.ImportApiResponse, ImportAG2ApiCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Body;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.ImportApiRequest();
        ...
        private Amazon.ApiGatewayV2.Model.ImportApiResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.ImportApiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "ImportApi");
            try
            {
                #if DESKTOP
                return client.ImportApi(request);
                #elif CORECLR
                return client.ImportApiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Body { get; set; }
            public System.Boolean? FailOnWarning { get; set; }
            public System.Func<Amazon.ApiGatewayV2.Model.ImportApiResponse, ImportAG2ApiCmdlet, object> Select { get; set; } =
