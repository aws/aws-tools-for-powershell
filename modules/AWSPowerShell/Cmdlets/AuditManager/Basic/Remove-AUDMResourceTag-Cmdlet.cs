...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    public partial class RemoveAUDMResourceTagCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The name or key of the tag. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AUDMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.UntagResourceResponse, RemoveAUDMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.UntagResourceRequest();
        ...
        private Amazon.AuditManager.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AuditManager.Model.UntagResourceResponse, RemoveAUDMResourceTagCmdlet, object> Select { get; set; } =
