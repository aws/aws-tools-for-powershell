...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Audit Manager AssociateAssessmentReportEvidenceFolder API operation.", Operation = new[] {"AssociateAssessmentReportEvidenceFolder"}, SelectReturnType = typeof(Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse))]
    [AWSCmdletOutput("None or Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddAUDMAssessmentReportEvidenceFolderCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-AUDMAssessmentReportEvidenceFolder (AssociateAssessmentReportEvidenceFolder)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse, AddAUDMAssessmentReportEvidenceFolderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderRequest();
        ...
        private Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "AssociateAssessmentReportEvidenceFolder");
            try
            {
                #if DESKTOP
                return client.AssociateAssessmentReportEvidenceFolder(request);
                #elif CORECLR
                return client.AssociateAssessmentReportEvidenceFolderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssessmentId { get; set; }
            public System.String EvidenceFolderId { get; set; }
            public System.Func<Amazon.AuditManager.Model.AssociateAssessmentReportEvidenceFolderResponse, AddAUDMAssessmentReportEvidenceFolderCmdlet, object> Select { get; set; } =
