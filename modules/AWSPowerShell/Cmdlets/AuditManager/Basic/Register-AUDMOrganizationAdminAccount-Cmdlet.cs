...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    [AWSCmdlet("Calls the AWS Audit Manager RegisterOrganizationAdminAccount API operation.", Operation = new[] {"RegisterOrganizationAdminAccount"}, SelectReturnType = typeof(Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse))]
    [AWSCmdletOutput("Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse",
        "This cmdlet returns an Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterAUDMOrganizationAdminAccountCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-AUDMOrganizationAdminAccount (RegisterOrganizationAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse, RegisterAUDMOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.RegisterOrganizationAdminAccountRequest();
        ...
        private Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.RegisterOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "RegisterOrganizationAdminAccount");
            try
            {
                #if DESKTOP
                return client.RegisterOrganizationAdminAccount(request);
                #elif CORECLR
                return client.RegisterOrganizationAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AdminAccountId { get; set; }
            public System.Func<Amazon.AuditManager.Model.RegisterOrganizationAdminAccountResponse, RegisterAUDMOrganizationAdminAccountCmdlet, object> Select { get; set; } =
