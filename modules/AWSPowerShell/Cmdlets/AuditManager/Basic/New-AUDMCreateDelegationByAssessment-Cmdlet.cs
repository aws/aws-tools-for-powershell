...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    public partial class NewAUDMCreateDelegationByAssessmentCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        #region Parameter CreateDelegationRequest
        /// <summary>
        /// <para>
        /// <para> The API request to batch create delegations in AWS Audit Manager. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        public Amazon.AuditManager.Model.CreateDelegationRequest[] CreateDelegationRequest { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-AUDMCreateDelegationByAssessment (BatchCreateDelegationByAssessment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.BatchCreateDelegationByAssessmentResponse, NewAUDMCreateDelegationByAssessmentCmdlet>(Select) ??
            ...
            #endif
            if (this.CreateDelegationRequest != null)
            {
                context.CreateDelegationRequest = new List<Amazon.AuditManager.Model.CreateDelegationRequest>(this.CreateDelegationRequest);
            }
            #if MODULAR
            if (this.CreateDelegationRequest == null && ParameterWasBound(nameof(this.CreateDelegationRequest)))
            {
                WriteWarning("You are passing $null as a value for parameter CreateDelegationRequest which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.BatchCreateDelegationByAssessmentRequest();
            
            if (cmdletContext.AssessmentId != null)
            {
                request.AssessmentId = cmdletContext.AssessmentId;
            }
            if (cmdletContext.CreateDelegationRequest != null)
            {
                request.CreateDelegationRequests = cmdletContext.CreateDelegationRequest;
            }
        ...
        private Amazon.AuditManager.Model.BatchCreateDelegationByAssessmentResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.BatchCreateDelegationByAssessmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "BatchCreateDelegationByAssessment");
            try
            {
                #if DESKTOP
                return client.BatchCreateDelegationByAssessment(request);
                #elif CORECLR
                return client.BatchCreateDelegationByAssessmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AssessmentId { get; set; }
            public List<Amazon.AuditManager.Model.CreateDelegationRequest> CreateDelegationRequest { get; set; }
            public System.Func<Amazon.AuditManager.Model.BatchCreateDelegationByAssessmentResponse, NewAUDMCreateDelegationByAssessmentCmdlet, object> Select { get; set; } =
