...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    /// Audit Manager assessment.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAUDMEvidenceFolderByAssessmentControlCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.AuditManager.Model.GetEvidenceFoldersByAssessmentControlResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetEvidenceFoldersByAssessmentControlRequest request)
        {
            ...
            try
            {
                return client.GetEvidenceFoldersByAssessmentControlAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
