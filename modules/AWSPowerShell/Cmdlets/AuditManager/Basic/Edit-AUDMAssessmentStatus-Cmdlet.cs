...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    /// </summary>
    [Cmdlet("Edit", "AUDMAssessmentStatus", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AuditManager.Model.Assessment")]
    [AWSCmdlet("Calls the AWS Audit Manager UpdateAssessmentStatus API operation.", Operation = new[] {"UpdateAssessmentStatus"}, SelectReturnType = typeof(Amazon.AuditManager.Model.UpdateAssessmentStatusResponse))]
    [AWSCmdletOutput("Amazon.AuditManager.Model.Assessment or Amazon.AuditManager.Model.UpdateAssessmentStatusResponse",
        "This cmdlet returns an Amazon.AuditManager.Model.Assessment object.",
        "The service call response (type Amazon.AuditManager.Model.UpdateAssessmentStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EditAUDMAssessmentStatusCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-AUDMAssessmentStatus (UpdateAssessmentStatus)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.UpdateAssessmentStatusResponse, EditAUDMAssessmentStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.UpdateAssessmentStatusRequest();
        ...
        private Amazon.AuditManager.Model.UpdateAssessmentStatusResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.UpdateAssessmentStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "UpdateAssessmentStatus");
            try
            {
                #if DESKTOP
                return client.UpdateAssessmentStatus(request);
                #elif CORECLR
                return client.UpdateAssessmentStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssessmentId { get; set; }
            public Amazon.AuditManager.AssessmentStatus Status { get; set; }
            public System.Func<Amazon.AuditManager.Model.UpdateAssessmentStatusResponse, EditAUDMAssessmentStatusCmdlet, object> Select { get; set; } =
