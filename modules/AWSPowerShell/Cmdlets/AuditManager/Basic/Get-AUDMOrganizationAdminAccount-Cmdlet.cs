...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    public partial class GetAUDMOrganizationAdminAccountCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.GetOrganizationAdminAccountResponse, GetAUDMOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.GetOrganizationAdminAccountRequest();
        ...
        private Amazon.AuditManager.Model.GetOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "GetOrganizationAdminAccount");
            try
            {
                #if DESKTOP
                return client.GetOrganizationAdminAccount(request);
                #elif CORECLR
                return client.GetOrganizationAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.AuditManager.Model.GetOrganizationAdminAccountResponse, GetAUDMOrganizationAdminAccountCmdlet, object> Select { get; set; } =
