...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    /// see <a href="https://docs.aws.amazon.com/controlcatalog/latest/APIReference/API_ListDomains.html"><c>ListDomains</c></a> in the Amazon Web Services Control Catalog API Reference.
    /// </para><note><para>
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "AUDMControlDomainInsightsByAssessmentList")]
    [OutputType("Amazon.AuditManager.Model.ControlDomainInsights")]
    [AWSCmdlet("Calls the AWS Audit Manager ListControlDomainInsightsByAssessment API operation.", Operation = new[] {"ListControlDomainInsightsByAssessment"}, SelectReturnType = typeof(Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse))]
    [AWSCmdletOutput("Amazon.AuditManager.Model.ControlDomainInsights or Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse",
        "This cmdlet returns a collection of Amazon.AuditManager.Model.ControlDomainInsights objects.",
        "The service call response (type Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAUDMControlDomainInsightsByAssessmentListCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse, GetAUDMControlDomainInsightsByAssessmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentRequest();
        ...
        private Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "ListControlDomainInsightsByAssessment");
            try
            {
                #if DESKTOP
                return client.ListControlDomainInsightsByAssessment(request);
                #elif CORECLR
                return client.ListControlDomainInsightsByAssessmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AuditManager.Model.ListControlDomainInsightsByAssessmentResponse, GetAUDMControlDomainInsightsByAssessmentListCmdlet, object> Select { get; set; } =
