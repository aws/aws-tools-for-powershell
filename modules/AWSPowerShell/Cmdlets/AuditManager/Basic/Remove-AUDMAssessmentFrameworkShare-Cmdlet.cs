...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AUDMAssessmentFrameworkShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAUDMAssessmentFrameworkShareCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AUDMAssessmentFrameworkShare (DeleteAssessmentFrameworkShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.DeleteAssessmentFrameworkShareResponse, RemoveAUDMAssessmentFrameworkShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.DeleteAssessmentFrameworkShareRequest();
        ...
        private Amazon.AuditManager.Model.DeleteAssessmentFrameworkShareResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.DeleteAssessmentFrameworkShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "DeleteAssessmentFrameworkShare");
            try
            {
                #if DESKTOP
                return client.DeleteAssessmentFrameworkShare(request);
                #elif CORECLR
                return client.DeleteAssessmentFrameworkShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RequestId { get; set; }
            public Amazon.AuditManager.ShareRequestType RequestType { get; set; }
            public System.Func<Amazon.AuditManager.Model.DeleteAssessmentFrameworkShareResponse, RemoveAUDMAssessmentFrameworkShareCmdlet, object> Select { get; set; } =
