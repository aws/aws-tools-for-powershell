...
{
    /// <summary>
    /// Gets all evidence from a specified evidence folder in Audit Manager.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AUDMEvidenceByEvidenceFolder")]
    [OutputType("Amazon.AuditManager.Model.Evidence")]
    [AWSCmdlet("Calls the AWS Audit Manager GetEvidenceByEvidenceFolder API operation.", Operation = new[] {"GetEvidenceByEvidenceFolder"}, SelectReturnType = typeof(Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse))]
    [AWSCmdletOutput("Amazon.AuditManager.Model.Evidence or Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse",
        "This cmdlet returns a collection of Amazon.AuditManager.Model.Evidence objects.",
        "The service call response (type Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAUDMEvidenceByEvidenceFolderCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse, GetAUDMEvidenceByEvidenceFolderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderRequest();
        ...
        private Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "GetEvidenceByEvidenceFolder");
            try
            {
                return client.GetEvidenceByEvidenceFolderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AuditManager.Model.GetEvidenceByEvidenceFolderResponse, GetAUDMEvidenceByEvidenceFolderCmdlet, object> Select { get; set; } =
