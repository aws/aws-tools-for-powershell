...
{
    /// <summary>
    /// Gets the evidence folders from a specified assessment in Audit Manager.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAUDMEvidenceFolderByAssessmentCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        private Amazon.AuditManager.Model.GetEvidenceFoldersByAssessmentResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetEvidenceFoldersByAssessmentRequest request)
        {
            ...
            try
            {
                return client.GetEvidenceFoldersByAssessmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
