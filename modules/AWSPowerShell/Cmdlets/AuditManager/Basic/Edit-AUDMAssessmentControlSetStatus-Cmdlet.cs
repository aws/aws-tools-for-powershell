...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    [AWSCmdletOutput("Amazon.AuditManager.Model.AssessmentControlSet or Amazon.AuditManager.Model.UpdateAssessmentControlSetStatusResponse",
        ...
        "The service call response (type Amazon.AuditManager.Model.UpdateAssessmentControlSetStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EditAUDMAssessmentControlSetStatusCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ControlSetId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ControlSetId;
            }
        ...
        private Amazon.AuditManager.Model.UpdateAssessmentControlSetStatusResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.UpdateAssessmentControlSetStatusRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateAssessmentControlSetStatus(request);
                #elif CORECLR
                return client.UpdateAssessmentControlSetStatusAsync(request).GetAwaiter().GetResult();
                #else
