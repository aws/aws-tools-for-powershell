...
{
    /// <summary>
    /// Returns a list of current and past assessments from Audit Manager.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.AuditManager.Model.AssessmentMetadataItem or Amazon.AuditManager.Model.ListAssessmentsResponse",
        ...
        "The service call response (type Amazon.AuditManager.Model.ListAssessmentsResponse) can be returned by specifying '-Select *'."
    )]
