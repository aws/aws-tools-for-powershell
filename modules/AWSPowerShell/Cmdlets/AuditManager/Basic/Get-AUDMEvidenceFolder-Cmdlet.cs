...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    public partial class GetAUDMEvidenceFolderCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EvidenceFolder";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.GetEvidenceFolderResponse, GetAUDMEvidenceFolderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.GetEvidenceFolderRequest();
        ...
        private Amazon.AuditManager.Model.GetEvidenceFolderResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetEvidenceFolderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "GetEvidenceFolder");
            try
            {
                #if DESKTOP
                return client.GetEvidenceFolder(request);
                #elif CORECLR
                return client.GetEvidenceFolderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ControlSetId { get; set; }
            public System.String EvidenceFolderId { get; set; }
            public System.Func<Amazon.AuditManager.Model.GetEvidenceFolderResponse, GetAUDMEvidenceFolderCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EvidenceFolder;
        }
