...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Audit Manager DeleteAssessmentFramework API operation.", Operation = new[] {"DeleteAssessmentFramework"}, SelectReturnType = typeof(Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse))]
    [AWSCmdletOutput("None or Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAUDMAssessmentFrameworkCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AUDMAssessmentFramework (DeleteAssessmentFramework)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse, RemoveAUDMAssessmentFrameworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.DeleteAssessmentFrameworkRequest();
        ...
        private Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.DeleteAssessmentFrameworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "DeleteAssessmentFramework");
            try
            {
                #if DESKTOP
                return client.DeleteAssessmentFramework(request);
                #elif CORECLR
                return client.DeleteAssessmentFrameworkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FrameworkId { get; set; }
            public System.Func<Amazon.AuditManager.Model.DeleteAssessmentFrameworkResponse, RemoveAUDMAssessmentFrameworkCmdlet, object> Select { get; set; } =
