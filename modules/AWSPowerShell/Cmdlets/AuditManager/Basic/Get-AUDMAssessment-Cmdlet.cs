...
namespace Amazon.PowerShell.Cmdlets.AUDM
{
    ...
    /// </summary>
    [Cmdlet("Get", "AUDMAssessment")]
    [OutputType("Amazon.AuditManager.Model.Assessment")]
    [AWSCmdlet("Calls the AWS Audit Manager GetAssessment API operation.", Operation = new[] {"GetAssessment"}, SelectReturnType = typeof(Amazon.AuditManager.Model.GetAssessmentResponse))]
    [AWSCmdletOutput("Amazon.AuditManager.Model.Assessment or Amazon.AuditManager.Model.GetAssessmentResponse",
        "This cmdlet returns an Amazon.AuditManager.Model.Assessment object.",
        "The service call response (type Amazon.AuditManager.Model.GetAssessmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAUDMAssessmentCmdlet : AmazonAuditManagerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AuditManager.Model.GetAssessmentResponse, GetAUDMAssessmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AuditManager.Model.GetAssessmentRequest();
        ...
        private Amazon.AuditManager.Model.GetAssessmentResponse CallAWSServiceOperation(IAmazonAuditManager client, Amazon.AuditManager.Model.GetAssessmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Audit Manager", "GetAssessment");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String AssessmentId { get; set; }
            public System.Func<Amazon.AuditManager.Model.GetAssessmentResponse, GetAUDMAssessmentCmdlet, object> Select { get; set; } =
