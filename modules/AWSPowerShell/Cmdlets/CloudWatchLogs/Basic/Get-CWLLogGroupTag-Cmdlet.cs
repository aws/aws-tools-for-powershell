...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    public partial class GetCWLLogGroupTagCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchLogs.Model.ListTagsLogGroupResponse, GetCWLLogGroupTagCmdlet>(Select) ??
        ...
        private Amazon.CloudWatchLogs.Model.ListTagsLogGroupResponse CallAWSServiceOperation(IAmazonCloudWatchLogs client, Amazon.CloudWatchLogs.Model.ListTagsLogGroupRequest request)
        {
            ...
            try
            {
                return client.ListTagsLogGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String LogGroupName { get; set; }
            public System.Func<Amazon.CloudWatchLogs.Model.ListTagsLogGroupResponse, GetCWLLogGroupTagCmdlet, object> Select { get; set; } =
