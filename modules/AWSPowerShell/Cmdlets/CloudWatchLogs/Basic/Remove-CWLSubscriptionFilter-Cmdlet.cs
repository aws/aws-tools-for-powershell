...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon CloudWatch Logs DeleteSubscriptionFilter API operation.", Operation = new[] {"DeleteSubscriptionFilter"}, SelectReturnType = typeof(Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse))]
    [AWSCmdletOutput("None or Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCWLSubscriptionFilterCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse, RemoveCWLSubscriptionFilterCmdlet>(Select) ??
        ...
        private Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse CallAWSServiceOperation(IAmazonCloudWatchLogs client, Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterRequest request)
        {
            ...
            try
            {
                return client.DeleteSubscriptionFilterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FilterName { get; set; }
            public System.String LogGroupName { get; set; }
            public System.Func<Amazon.CloudWatchLogs.Model.DeleteSubscriptionFilterResponse, RemoveCWLSubscriptionFilterCmdlet, object> Select { get; set; } =
