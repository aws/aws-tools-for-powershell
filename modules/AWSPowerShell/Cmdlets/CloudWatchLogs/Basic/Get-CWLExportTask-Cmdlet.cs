...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Logs DescribeExportTasks API operation.", Operation = new[] {"DescribeExportTasks"}, SelectReturnType = typeof(Amazon.CloudWatchLogs.Model.DescribeExportTasksResponse), LegacyAlias="Get-CWLExportTasks")]
    [AWSCmdletOutput("Amazon.CloudWatchLogs.Model.ExportTask or Amazon.CloudWatchLogs.Model.DescribeExportTasksResponse",
        "This cmdlet returns a collection of Amazon.CloudWatchLogs.Model.ExportTask objects.",
        "The service call response (type Amazon.CloudWatchLogs.Model.DescribeExportTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWLExportTaskCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchLogs.Model.DescribeExportTasksResponse, GetCWLExportTaskCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ExportTasks?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CloudWatchLogs.ExportTaskStatusCode StatusCode { get; set; }
            public System.String TaskId { get; set; }
            public System.Func<Amazon.CloudWatchLogs.Model.DescribeExportTasksResponse, GetCWLExportTaskCmdlet, object> Select { get; set; } =
