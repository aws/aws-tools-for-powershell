...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdletOutput("Amazon.CloudWatchLogs.Model.QueryDefinition or Amazon.CloudWatchLogs.Model.DescribeQueryDefinitionsResponse",
        ...
        "The service call response (type Amazon.CloudWatchLogs.Model.DescribeQueryDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWLQueryDefinitionCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^QueryDefinitionNamePrefix' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.QueryDefinitionNamePrefix;
            }
        ...
        private Amazon.CloudWatchLogs.Model.DescribeQueryDefinitionsResponse CallAWSServiceOperation(IAmazonCloudWatchLogs client, Amazon.CloudWatchLogs.Model.DescribeQueryDefinitionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeQueryDefinitions(request);
                #elif CORECLR
                return client.DescribeQueryDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
