...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdletOutput("Amazon.CloudWatchLogs.Model.DeliveryDestination or Amazon.CloudWatchLogs.Model.DescribeDeliveryDestinationsResponse",
        ...
        "The service call response (type Amazon.CloudWatchLogs.Model.DescribeDeliveryDestinationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
