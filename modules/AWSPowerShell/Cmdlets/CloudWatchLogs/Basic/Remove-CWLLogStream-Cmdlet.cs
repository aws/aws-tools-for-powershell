...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon CloudWatch Logs DeleteLogStream API operation.", Operation = new[] {"DeleteLogStream"}, SelectReturnType = typeof(Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse))]
    [AWSCmdletOutput("None or Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCWLLogStreamCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse, RemoveCWLLogStreamCmdlet>(Select) ??
        ...
        private Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse CallAWSServiceOperation(IAmazonCloudWatchLogs client, Amazon.CloudWatchLogs.Model.DeleteLogStreamRequest request)
        {
            ...
            try
            {
                return client.DeleteLogStreamAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String LogGroupName { get; set; }
            public System.String LogStreamName { get; set; }
            public System.Func<Amazon.CloudWatchLogs.Model.DeleteLogStreamResponse, RemoveCWLLogStreamCmdlet, object> Select { get; set; } =
