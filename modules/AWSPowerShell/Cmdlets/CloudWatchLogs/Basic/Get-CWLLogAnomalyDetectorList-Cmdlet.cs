...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdletOutput("Amazon.CloudWatchLogs.Model.AnomalyDetector or Amazon.CloudWatchLogs.Model.ListLogAnomalyDetectorsResponse",
        ...
        "The service call response (type Amazon.CloudWatchLogs.Model.ListLogAnomalyDetectorsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
