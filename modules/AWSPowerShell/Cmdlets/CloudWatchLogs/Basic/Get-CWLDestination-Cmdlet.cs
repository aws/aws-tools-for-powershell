...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Logs DescribeDestinations API operation.", Operation = new[] {"DescribeDestinations"}, SelectReturnType = typeof(Amazon.CloudWatchLogs.Model.DescribeDestinationsResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchLogs.Model.Destination or Amazon.CloudWatchLogs.Model.DescribeDestinationsResponse",
        "This cmdlet returns a collection of Amazon.CloudWatchLogs.Model.Destination objects.",
        "The service call response (type Amazon.CloudWatchLogs.Model.DescribeDestinationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWLDestinationCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DestinationNamePrefix' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchLogs.Model.DescribeDestinationsResponse, GetCWLDestinationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DestinationNamePrefix;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudWatchLogs.Model.DescribeDestinationsResponse, GetCWLDestinationCmdlet, object> Select { get; set; } =
