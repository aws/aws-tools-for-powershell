#
# Module manifest for module 'AWS.Tools.BedrockDataAutomation'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BedrockDataAutomation.dll'
    ...
    GUID = 'ee533d77-339d-4172-b1d4-e91fa67edd08'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.BedrockDataAutomation.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BedrockDataAutomation.Completers.psm1',
        'AWS.Tools.BedrockDataAutomation.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.BedrockDataAutomation.dll-Help.xml'
    )
