...
namespace Amazon.PowerShell.Cmdlets.BDA
{
    ...
    public partial class NewBDADataAutomationProjectCmdlet : AmazonBedrockDataAutomationClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.BedrockDataAutomation.DataAutomationProjectType")]
        public Amazon.BedrockDataAutomation.DataAutomationProjectType ProjectType { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            context.ProjectType = this.ProjectType;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ProjectType != null)
            {
                request.ProjectType = cmdletContext.ProjectType;
            }
        ...
        private Amazon.BedrockDataAutomation.Model.CreateDataAutomationProjectResponse CallAWSServiceOperation(IAmazonBedrockDataAutomation client, Amazon.BedrockDataAutomation.Model.CreateDataAutomationProjectRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateDataAutomationProject(request);
                #elif CORECLR
                return client.CreateDataAutomationProjectAsync(request).GetAwaiter().GetResult();
                #else
