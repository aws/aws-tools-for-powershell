...
namespace Amazon.PowerShell.Cmdlets.BDA
{
    ...
    /// </summary>
    [Cmdlet("Get", "BDADataAutomationLibraryEntity")]
    [OutputType("Amazon.BedrockDataAutomation.Model.EntityDetails")]
    [AWSCmdlet("Calls the Data Automation for Amazon Bedrock GetDataAutomationLibraryEntity API operation.", Operation = new[] {"GetDataAutomationLibraryEntity"}, SelectReturnType = typeof(Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse))]
    [AWSCmdletOutput("Amazon.BedrockDataAutomation.Model.EntityDetails or Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse",
        "This cmdlet returns an Amazon.BedrockDataAutomation.Model.EntityDetails object.",
        "The service call response (type Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBDADataAutomationLibraryEntityCmdlet : AmazonBedrockDataAutomationClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse).
        /// Specifying the name of a property of type Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse, GetBDADataAutomationLibraryEntityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityRequest();
        ...
        private Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse CallAWSServiceOperation(IAmazonBedrockDataAutomation client, Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Data Automation for Amazon Bedrock", "GetDataAutomationLibraryEntity");
            try
            {
                return client.GetDataAutomationLibraryEntityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.BedrockDataAutomation.EntityType EntityType { get; set; }
            public System.String LibraryArn { get; set; }
            public System.Func<Amazon.BedrockDataAutomation.Model.GetDataAutomationLibraryEntityResponse, GetBDADataAutomationLibraryEntityCmdlet, object> Select { get; set; } =
