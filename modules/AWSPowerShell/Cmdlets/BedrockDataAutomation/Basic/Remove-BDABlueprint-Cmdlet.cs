...
namespace Amazon.PowerShell.Cmdlets.BDA
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Data Automation for Amazon Bedrock DeleteBlueprint API operation.", Operation = new[] {"DeleteBlueprint"}, SelectReturnType = typeof(Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse))]
    [AWSCmdletOutput("None or Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBDABlueprintCmdlet : AmazonBedrockDataAutomationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BDABlueprint (DeleteBlueprint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse, RemoveBDABlueprintCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockDataAutomation.Model.DeleteBlueprintRequest();
        ...
        private Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse CallAWSServiceOperation(IAmazonBedrockDataAutomation client, Amazon.BedrockDataAutomation.Model.DeleteBlueprintRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Data Automation for Amazon Bedrock", "DeleteBlueprint");
            try
            {
                #if DESKTOP
                return client.DeleteBlueprint(request);
                #elif CORECLR
                return client.DeleteBlueprintAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BlueprintArn { get; set; }
            public System.String BlueprintVersion { get; set; }
            public System.Func<Amazon.BedrockDataAutomation.Model.DeleteBlueprintResponse, RemoveBDABlueprintCmdlet, object> Select { get; set; } =
