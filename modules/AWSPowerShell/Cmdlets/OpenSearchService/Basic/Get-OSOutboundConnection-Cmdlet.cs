...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    [AWSCmdlet("Calls the Amazon OpenSearch Service DescribeOutboundConnections API operation.", Operation = new[] {"DescribeOutboundConnections"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.OutboundConnection or Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.OutboundConnection objects.",
        "The service call response (type Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOSOutboundConnectionCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of filter names and values that you can use for requests.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse, GetOSOutboundConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.DescribeOutboundConnectionsRequest();
        ...
        private Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DescribeOutboundConnectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DescribeOutboundConnections");
            try
            {
                return client.DescribeOutboundConnectionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DescribeOutboundConnectionsResponse, GetOSOutboundConnectionCmdlet, object> Select { get; set; } =
