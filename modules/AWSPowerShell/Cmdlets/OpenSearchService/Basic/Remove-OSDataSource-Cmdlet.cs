...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class RemoveOSDataSourceCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OSDataSource (DeleteDataSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DeleteDataSourceResponse, RemoveOSDataSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.DeleteDataSourceRequest();
        ...
        private Amazon.OpenSearchService.Model.DeleteDataSourceResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DeleteDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DeleteDataSource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DeleteDataSourceResponse, RemoveOSDataSourceCmdlet, object> Select { get; set; } =
