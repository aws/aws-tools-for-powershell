...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Get", "OSInstanceTypeDetailList")]
    [OutputType("Amazon.OpenSearchService.Model.InstanceTypeDetails")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service ListInstanceTypeDetails API operation.", Operation = new[] {"ListInstanceTypeDetails"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.ListInstanceTypeDetailsResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.InstanceTypeDetails or Amazon.OpenSearchService.Model.ListInstanceTypeDetailsResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.InstanceTypeDetails objects.",
        "The service call response (type Amazon.OpenSearchService.Model.ListInstanceTypeDetailsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSInstanceTypeDetailListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <code>ListInstanceTypeDetails</code> operation returns a <code>nextToken</code>,
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceTypeDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.ListInstanceTypeDetailsResponse, GetOSInstanceTypeDetailListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.ListInstanceTypeDetailsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.InstanceTypeDetails.Count;
        ...
        private Amazon.OpenSearchService.Model.ListInstanceTypeDetailsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.ListInstanceTypeDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "ListInstanceTypeDetails");
            try
            {
                #if DESKTOP
                return client.ListInstanceTypeDetails(request);
                #elif CORECLR
                return client.ListInstanceTypeDetailsAsync(request).GetAwaiter().GetResult();
                #else
