...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Get", "OSScheduledActionList")]
    [OutputType("Amazon.OpenSearchService.Model.ScheduledAction")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service ListScheduledActions API operation.", Operation = new[] {"ListScheduledActions"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.ListScheduledActionsResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.ScheduledAction or Amazon.OpenSearchService.Model.ListScheduledActionsResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.ScheduledAction objects.",
        "The service call response (type Amazon.OpenSearchService.Model.ListScheduledActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSScheduledActionListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <code>ListScheduledActions</code> operation returns a <code>nextToken</code>,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.ListScheduledActionsResponse, GetOSScheduledActionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.ListScheduledActionsRequest();
        ...
        private Amazon.OpenSearchService.Model.ListScheduledActionsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.ListScheduledActionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "ListScheduledActions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.ListScheduledActionsResponse, GetOSScheduledActionListCmdlet, object> Select { get; set; } =
