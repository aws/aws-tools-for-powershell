...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "OSVpcEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveOSVpcEndpointCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OSVpcEndpoint (DeleteVpcEndpoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DeleteVpcEndpointResponse, RemoveOSVpcEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.DeleteVpcEndpointRequest();
        ...
        private Amazon.OpenSearchService.Model.DeleteVpcEndpointResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DeleteVpcEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DeleteVpcEndpoint");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VpcEndpointId { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DeleteVpcEndpointResponse, RemoveOSVpcEndpointCmdlet, object> Select { get; set; } =
