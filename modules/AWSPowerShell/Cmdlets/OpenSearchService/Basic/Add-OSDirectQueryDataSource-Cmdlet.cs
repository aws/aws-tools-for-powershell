...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Add", "OSDirectQueryDataSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service AddDirectQueryDataSource API operation.", Operation = new[] {"AddDirectQueryDataSource"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse))]
    [AWSCmdletOutput("System.String or Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class AddOSDirectQueryDataSourceCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse).
        /// Specifying the name of a property of type Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-OSDirectQueryDataSource (AddDirectQueryDataSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse, AddOSDirectQueryDataSourceCmdlet>(Select) ??
        ...
        private Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.AddDirectQueryDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "AddDirectQueryDataSource");
            try
            {
                #if DESKTOP
                return client.AddDirectQueryDataSource(request);
                #elif CORECLR
                return client.AddDirectQueryDataSourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OpenSearchService.Model.AddDirectQueryDataSourceResponse, AddOSDirectQueryDataSourceCmdlet, object> Select { get; set; } =
