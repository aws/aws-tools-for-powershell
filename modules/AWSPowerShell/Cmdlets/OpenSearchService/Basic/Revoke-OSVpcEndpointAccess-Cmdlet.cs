...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Revoke", "OSVpcEndpointAccess", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class RevokeOSVpcEndpointAccessCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Revoke-OSVpcEndpointAccess (RevokeVpcEndpointAccess)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.RevokeVpcEndpointAccessRequest();
        ...
        private Amazon.OpenSearchService.Model.RevokeVpcEndpointAccessResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.RevokeVpcEndpointAccessRequest request)
        {
