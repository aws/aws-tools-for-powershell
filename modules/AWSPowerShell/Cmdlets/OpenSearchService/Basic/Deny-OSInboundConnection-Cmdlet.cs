...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class DenyOSInboundConnectionCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-OSInboundConnection (RejectInboundConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.RejectInboundConnectionResponse, DenyOSInboundConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.RejectInboundConnectionRequest();
        ...
        private Amazon.OpenSearchService.Model.RejectInboundConnectionResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.RejectInboundConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "RejectInboundConnection");
            try
            {
                #if DESKTOP
                return client.RejectInboundConnection(request);
                #elif CORECLR
                return client.RejectInboundConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ConnectionId { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.RejectInboundConnectionResponse, DenyOSInboundConnectionCmdlet, object> Select { get; set; } =
