...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class RemoveOSInboundConnectionCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OSInboundConnection (DeleteInboundConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DeleteInboundConnectionResponse, RemoveOSInboundConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.DeleteInboundConnectionRequest();
        ...
        private Amazon.OpenSearchService.Model.DeleteInboundConnectionResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DeleteInboundConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DeleteInboundConnection");
            try
            {
                #if DESKTOP
                return client.DeleteInboundConnection(request);
                #elif CORECLR
                return client.DeleteInboundConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ConnectionId { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DeleteInboundConnectionResponse, RemoveOSInboundConnectionCmdlet, object> Select { get; set; } =
