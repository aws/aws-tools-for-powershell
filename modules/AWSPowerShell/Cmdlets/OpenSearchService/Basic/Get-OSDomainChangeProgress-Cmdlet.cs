...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class GetOSDomainChangeProgressCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DescribeDomainChangeProgressResponse, GetOSDomainChangeProgressCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.DescribeDomainChangeProgressRequest();
        ...
        private Amazon.OpenSearchService.Model.DescribeDomainChangeProgressResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DescribeDomainChangeProgressRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DescribeDomainChangeProgress");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeId { get; set; }
            public System.String DomainName { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DescribeDomainChangeProgressResponse, GetOSDomainChangeProgressCmdlet, object> Select { get; set; } =
