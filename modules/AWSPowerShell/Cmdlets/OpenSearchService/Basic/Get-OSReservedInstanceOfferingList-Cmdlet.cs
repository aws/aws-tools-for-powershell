...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Get", "OSReservedInstanceOfferingList")]
    [OutputType("Amazon.OpenSearchService.Model.ReservedInstanceOffering")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service DescribeReservedInstanceOfferings API operation.", Operation = new[] {"DescribeReservedInstanceOfferings"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.ReservedInstanceOffering or Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.ReservedInstanceOffering objects.",
        "The service call response (type Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSReservedInstanceOfferingListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <code>DescribeReservedInstanceOfferings</code> operation returns a
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReservedInstanceOfferings";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse, GetOSReservedInstanceOfferingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ReservedInstanceOfferings.Count;
        ...
        private Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DescribeReservedInstanceOfferings");
            try
            {
                #if DESKTOP
                return client.DescribeReservedInstanceOfferings(request);
                #elif CORECLR
                return client.DescribeReservedInstanceOfferingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ReservedInstanceOfferingId { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DescribeReservedInstanceOfferingsResponse, GetOSReservedInstanceOfferingListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReservedInstanceOfferings;
        }
