...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.PackageDetails or Amazon.OpenSearchService.Model.DescribePackagesResponse",
        ...
        "The service call response (type Amazon.OpenSearchService.Model.DescribePackagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
