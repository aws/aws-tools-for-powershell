...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class RemoveOSResourceTagCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the domain, data source, or application from which
        /// you want to delete the specified tags.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The list of tag keys to remove from the domain, data source, or application.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OSResourceTag (RemoveTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.RemoveTagsResponse, RemoveOSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.RemoveTagsRequest();
        ...
        private Amazon.OpenSearchService.Model.RemoveTagsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.RemoveTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "RemoveTags");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OpenSearchService.Model.RemoveTagsResponse, RemoveOSResourceTagCmdlet, object> Select { get; set; } =
