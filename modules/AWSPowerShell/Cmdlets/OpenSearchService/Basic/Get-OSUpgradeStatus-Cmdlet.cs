...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class GetOSUpgradeStatusCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.GetUpgradeStatusResponse, GetOSUpgradeStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.GetUpgradeStatusRequest();
        ...
        private Amazon.OpenSearchService.Model.GetUpgradeStatusResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.GetUpgradeStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "GetUpgradeStatus");
            try
            {
                #if DESKTOP
                return client.GetUpgradeStatus(request);
                #elif CORECLR
                return client.GetUpgradeStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.GetUpgradeStatusResponse, GetOSUpgradeStatusCmdlet, object> Select { get; set; } =
