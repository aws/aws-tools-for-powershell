...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class GetOSDomainListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// specify at least one domain name.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DescribeDomainsResponse, GetOSDomainListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.DescribeDomainsRequest();
        ...
        private Amazon.OpenSearchService.Model.DescribeDomainsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DescribeDomainsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DescribeDomains");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OpenSearchService.Model.DescribeDomainsResponse, GetOSDomainListCmdlet, object> Select { get; set; } =
