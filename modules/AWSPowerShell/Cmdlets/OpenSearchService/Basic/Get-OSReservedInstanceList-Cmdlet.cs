...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Get", "OSReservedInstanceList")]
    [OutputType("Amazon.OpenSearchService.Model.ReservedInstance")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service DescribeReservedInstances API operation.", Operation = new[] {"DescribeReservedInstances"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.ReservedInstance or Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.ReservedInstance objects.",
        "The service call response (type Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSReservedInstanceListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ReservedInstanceId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse, GetOSReservedInstanceListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ReservedInstanceId;
            }
            ...
            context.ReservedInstanceId = this.ReservedInstanceId;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.DescribeReservedInstancesRequest();
            ...
            {
                request.ReservedInstanceId = cmdletContext.ReservedInstanceId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ReservedInstances.Count;
        ...
        private Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.DescribeReservedInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "DescribeReservedInstances");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ReservedInstanceId { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.DescribeReservedInstancesResponse, GetOSReservedInstanceListCmdlet, object> Select { get; set; } =
