...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    [OutputType("Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service GetPackageVersionHistory API operation.", Operation = new[] {"GetPackageVersionHistory"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse",
        "This cmdlet returns an Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSPackageVersionHistoryCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <code>GetPackageVersionHistory</code> operation returns a <code>nextToken</code>,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse, GetOSPackageVersionHistoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.GetPackageVersionHistoryRequest();
        ...
        private Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.GetPackageVersionHistoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "GetPackageVersionHistory");
            try
            {
                #if DESKTOP
                return client.GetPackageVersionHistory(request);
                #elif CORECLR
                return client.GetPackageVersionHistoryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PackageID { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.GetPackageVersionHistoryResponse, GetOSPackageVersionHistoryCmdlet, object> Select { get; set; } =
