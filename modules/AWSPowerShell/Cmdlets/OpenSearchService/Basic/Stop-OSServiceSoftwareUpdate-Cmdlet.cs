...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    public partial class StopOSServiceSoftwareUpdateCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-OSServiceSoftwareUpdate (CancelServiceSoftwareUpdate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.CancelServiceSoftwareUpdateResponse, StopOSServiceSoftwareUpdateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpenSearchService.Model.CancelServiceSoftwareUpdateRequest();
        ...
        private Amazon.OpenSearchService.Model.CancelServiceSoftwareUpdateResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.CancelServiceSoftwareUpdateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "CancelServiceSoftwareUpdate");
            try
            {
                #if DESKTOP
                return client.CancelServiceSoftwareUpdate(request);
                #elif CORECLR
                return client.CancelServiceSoftwareUpdateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.CancelServiceSoftwareUpdateResponse, StopOSServiceSoftwareUpdateCmdlet, object> Select { get; set; } =
