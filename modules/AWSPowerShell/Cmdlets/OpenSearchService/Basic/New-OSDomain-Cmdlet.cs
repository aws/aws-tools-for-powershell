...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.DomainStatus or Amazon.OpenSearchService.Model.CreateDomainResponse",
        ...
        "The service call response (type Amazon.OpenSearchService.Model.CreateDomainResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewOSDomainCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The engine mode for the domain. For valid values and requirements, see <c>EngineMode</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// 1.2 to TLS version 1.3 with perfect forward secrecy cipher suites</para></li><li><para><b>Policy-Min-TLS-1-2-RFC9151-FIPS-2024-08:</b> TLS security policy that supports
        /// TLS version 1.3 with FIPS</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
