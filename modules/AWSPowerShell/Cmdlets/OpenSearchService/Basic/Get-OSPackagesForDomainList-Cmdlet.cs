...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    [AWSCmdlet("Calls the Amazon OpenSearch Service ListPackagesForDomain API operation.", Operation = new[] {"ListPackagesForDomain"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.ListPackagesForDomainResponse))]
    [AWSCmdletOutput("Amazon.OpenSearchService.Model.DomainPackageDetails or Amazon.OpenSearchService.Model.ListPackagesForDomainResponse",
        "This cmdlet returns a collection of Amazon.OpenSearchService.Model.DomainPackageDetails objects.",
        "The service call response (type Amazon.OpenSearchService.Model.ListPackagesForDomainResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSPackagesForDomainListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.ListPackagesForDomainResponse, GetOSPackagesForDomainListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.ListPackagesForDomainRequest();
        ...
        private Amazon.OpenSearchService.Model.ListPackagesForDomainResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.ListPackagesForDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "ListPackagesForDomain");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.ListPackagesForDomainResponse, GetOSPackagesForDomainListCmdlet, object> Select { get; set; } =
