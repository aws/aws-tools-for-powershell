...
namespace Amazon.PowerShell.Cmdlets.OS
{
    ...
    /// </summary>
    [Cmdlet("Get", "OSVersionList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon OpenSearch Service ListVersions API operation.", Operation = new[] {"ListVersions"}, SelectReturnType = typeof(Amazon.OpenSearchService.Model.ListVersionsResponse))]
    [AWSCmdletOutput("System.String or Amazon.OpenSearchService.Model.ListVersionsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.OpenSearchService.Model.ListVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSVersionListCmdlet : AmazonOpenSearchServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpenSearchService.Model.ListVersionsResponse, GetOSVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpenSearchService.Model.ListVersionsRequest();
        ...
        private Amazon.OpenSearchService.Model.ListVersionsResponse CallAWSServiceOperation(IAmazonOpenSearchService client, Amazon.OpenSearchService.Model.ListVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Service", "ListVersions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.OpenSearchService.Model.ListVersionsResponse, GetOSVersionListCmdlet, object> Select { get; set; } =
