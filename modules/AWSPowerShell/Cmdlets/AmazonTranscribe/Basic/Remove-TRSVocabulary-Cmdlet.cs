...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdlet("Calls the Amazon Transcribe Service DeleteVocabulary API operation.", Operation = new[] {"DeleteVocabulary"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the VocabularyName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveTRSVocabularyCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.VocabularyName;
        ...
        private Amazon.TranscribeService.Model.DeleteVocabularyResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.DeleteVocabularyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteVocabularyAsync(request);
                return task.Result;
                #else
