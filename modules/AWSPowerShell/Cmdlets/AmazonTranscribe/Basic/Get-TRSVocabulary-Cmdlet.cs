...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdlet("Calls the Amazon Transcribe Service GetVocabulary API operation.", Operation = new[] {"GetVocabulary"})]
    [AWSCmdletOutput("Amazon.TranscribeService.Model.GetVocabularyResponse",
        "This cmdlet returns a Amazon.TranscribeService.Model.GetVocabularyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRSVocabularyCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.TranscribeService.Model.GetVocabularyResponse CallAWSServiceOperation(IAmazonTranscribeService client, Amazon.TranscribeService.Model.GetVocabularyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetVocabularyAsync(request);
                return task.Result;
                #else
