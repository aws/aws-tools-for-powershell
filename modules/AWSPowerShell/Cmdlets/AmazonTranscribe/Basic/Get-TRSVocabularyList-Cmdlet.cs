...
namespace Amazon.PowerShell.Cmdlets.TRS
{
    ...
    [AWSCmdlet("Calls the Amazon Transcribe Service ListVocabularies API operation.", Operation = new[] {"ListVocabularies"})]
    [AWSCmdletOutput("Amazon.TranscribeService.Model.VocabularyInfo",
        "This cmdlet returns a collection of VocabularyInfo objects.",
    ...
    public partial class GetTRSVocabularyListCmdlet : AmazonTranscribeServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.StateEquals = this.StateEqual;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.StateEquals != null)
            {
                request.StateEquals = cmdletContext.StateEquals;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Vocabularies;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.TranscribeService.VocabularyState StateEquals { get; set; }
        }
