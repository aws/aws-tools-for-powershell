...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaLive ListReservations API operation.", Operation = new[] {"ListReservations"})]
    [AWSCmdletOutput("Amazon.MediaLive.Model.Reservation",
        "This cmdlet returns a collection of Reservation objects.",
        "The service call response (type Amazon.MediaLive.Model.ListReservationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetEMLReservationListCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Reservations;
        ...
        private Amazon.MediaLive.Model.ListReservationsResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.ListReservationsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListReservationsAsync(request);
                return task.Result;
                #else
