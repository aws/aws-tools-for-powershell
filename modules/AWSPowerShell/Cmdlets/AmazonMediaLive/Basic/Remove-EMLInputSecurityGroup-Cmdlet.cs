...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaLive DeleteInputSecurityGroup API operation.", Operation = new[] {"DeleteInputSecurityGroup"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the InputSecurityGroupId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveEMLInputSecurityGroupCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.InputSecurityGroupId;
        ...
        private Amazon.MediaLive.Model.DeleteInputSecurityGroupResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DeleteInputSecurityGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteInputSecurityGroupAsync(request);
                return task.Result;
                #else
