...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaLive DescribeReservation API operation.", Operation = new[] {"DescribeReservation"})]
    [AWSCmdletOutput("Amazon.MediaLive.Model.DescribeReservationResponse",
        "This cmdlet returns a Amazon.MediaLive.Model.DescribeReservationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMLReservationCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        private Amazon.MediaLive.Model.DescribeReservationResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DescribeReservationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeReservationAsync(request);
                return task.Result;
                #else
