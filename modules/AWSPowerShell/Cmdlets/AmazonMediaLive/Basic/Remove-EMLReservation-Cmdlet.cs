...
namespace Amazon.PowerShell.Cmdlets.EML
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaLive DeleteReservation API operation.", Operation = new[] {"DeleteReservation"})]
    [AWSCmdletOutput("Amazon.MediaLive.Model.DeleteReservationResponse",
        "This cmdlet returns a Amazon.MediaLive.Model.DeleteReservationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEMLReservationCmdlet : AmazonMediaLiveClientCmdlet, IExecutor
    {
        ...
        private Amazon.MediaLive.Model.DeleteReservationResponse CallAWSServiceOperation(IAmazonMediaLive client, Amazon.MediaLive.Model.DeleteReservationRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteReservationAsync(request).GetAwaiter().GetResult();
                #else
