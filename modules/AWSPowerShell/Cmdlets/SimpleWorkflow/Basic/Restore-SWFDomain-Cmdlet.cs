...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Restore", "SWFDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class RestoreSWFDomainCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-SWFDomain (UndeprecateDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleWorkflow.Model.UndeprecateDomainResponse, RestoreSWFDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleWorkflow.Model.UndeprecateDomainRequest();
        ...
        private Amazon.SimpleWorkflow.Model.UndeprecateDomainResponse CallAWSServiceOperation(IAmazonSimpleWorkflow client, Amazon.SimpleWorkflow.Model.UndeprecateDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service (SWF)", "UndeprecateDomain");
            try
            {
                #if DESKTOP
                return client.UndeprecateDomain(request);
                #elif CORECLR
                return client.UndeprecateDomainAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.SimpleWorkflow.Model.UndeprecateDomainResponse, RestoreSWFDomainCmdlet, object> Select { get; set; } =
