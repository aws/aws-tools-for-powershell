...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    public partial class GetSWFWorkflowTypeListCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        /// are returned in ascending alphabetical order of the <c>name</c> of the workflow types.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WorkflowTypeInfos.TypeInfos";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleWorkflow.Model.ListWorkflowTypesResponse, GetSWFWorkflowTypeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WorkflowTypeInfos.TypeInfos?.Count ?? 0;
        ...
        private Amazon.SimpleWorkflow.Model.ListWorkflowTypesResponse CallAWSServiceOperation(IAmazonSimpleWorkflow client, Amazon.SimpleWorkflow.Model.ListWorkflowTypesRequest request)
        {
            ...
            try
            {
                return client.ListWorkflowTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.SimpleWorkflow.RegistrationStatus RegistrationStatus { get; set; }
            public System.Boolean? ReverseOrder { get; set; }
            public System.Func<Amazon.SimpleWorkflow.Model.ListWorkflowTypesResponse, GetSWFWorkflowTypeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WorkflowTypeInfos.TypeInfos;
        }
