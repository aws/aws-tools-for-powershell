...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Simple Workflow Service (SWF) DeprecateDomain API operation.", Operation = new[] {"DeprecateDomain"}, SelectReturnType = typeof(Amazon.SimpleWorkflow.Model.DeprecateDomainResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleWorkflow.Model.DeprecateDomainResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleWorkflow.Model.DeprecateDomainResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSWFDomainCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleWorkflow.Model.DeprecateDomainResponse, RemoveSWFDomainCmdlet>(Select) ??
        ...
        private Amazon.SimpleWorkflow.Model.DeprecateDomainResponse CallAWSServiceOperation(IAmazonSimpleWorkflow client, Amazon.SimpleWorkflow.Model.DeprecateDomainRequest request)
        {
            ...
            try
            {
                return client.DeprecateDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.SimpleWorkflow.Model.DeprecateDomainResponse, RemoveSWFDomainCmdlet, object> Select { get; set; } =
