...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Restore", "SWFActivityType", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Simple Workflow Service (SWF) UndeprecateActivityType API operation.", Operation = new[] {"UndeprecateActivityType"}, SelectReturnType = typeof(Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RestoreSWFActivityTypeCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-SWFActivityType (UndeprecateActivityType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse, RestoreSWFActivityTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeRequest();
        ...
        private Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse CallAWSServiceOperation(IAmazonSimpleWorkflow client, Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service (SWF)", "UndeprecateActivityType");
            try
            {
                #if DESKTOP
                return client.UndeprecateActivityType(request);
                #elif CORECLR
                return client.UndeprecateActivityTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ActivityType_Version { get; set; }
            public System.String Domain { get; set; }
            public System.Func<Amazon.SimpleWorkflow.Model.UndeprecateActivityTypeResponse, RestoreSWFActivityTypeCmdlet, object> Select { get; set; } =
