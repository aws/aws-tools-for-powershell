...
namespace Amazon.PowerShell.Cmdlets.SWF
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Add", "SWFResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddSWFResourceTagCmdlet : AmazonSimpleWorkflowClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SWFResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleWorkflow.Model.TagResourceResponse, AddSWFResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleWorkflow.Model.TagResourceRequest();
        ...
        private Amazon.SimpleWorkflow.Model.TagResourceResponse CallAWSServiceOperation(IAmazonSimpleWorkflow client, Amazon.SimpleWorkflow.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Simple Workflow Service (SWF)", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SimpleWorkflow.Model.TagResourceResponse, AddSWFResourceTagCmdlet, object> Select { get; set; } =
