...
namespace Amazon.PowerShell.Cmdlets.ASP
{
    ...
    [AWSCmdlet("Calls the AWS Auto Scaling Plans DescribeScalingPlanResources API operation.", Operation = new[] {"DescribeScalingPlanResources"})]
    [AWSCmdletOutput("Amazon.AutoScalingPlans.Model.ScalingPlanResource",
        "This cmdlet returns a collection of ScalingPlanResource objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ScalingPlanResources;
