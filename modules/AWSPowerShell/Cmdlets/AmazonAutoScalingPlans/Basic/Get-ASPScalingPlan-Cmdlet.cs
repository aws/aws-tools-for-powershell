...
namespace Amazon.PowerShell.Cmdlets.ASP
{
    ...
    [AWSCmdlet("Calls the AWS Auto Scaling Plans DescribeScalingPlans API operation.", Operation = new[] {"DescribeScalingPlans"})]
    [AWSCmdletOutput("Amazon.AutoScalingPlans.Model.ScalingPlan",
        "This cmdlet returns a collection of ScalingPlan objects.",
    ...
    public partial class GetASPScalingPlanCmdlet : AmazonAutoScalingPlansClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ApplicationSources = new List<Amazon.AutoScalingPlans.Model.ApplicationSource>(this.ApplicationSource);
            }
            ...
            {
                context.ScalingPlanNames = new List<System.String>(this.ScalingPlanName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ApplicationSources != null)
            {
                request.ApplicationSources = cmdletContext.ApplicationSources;
            }
            if (cmdletContext.ScalingPlanNames != null)
            {
                request.ScalingPlanNames = cmdletContext.ScalingPlanNames;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ScalingPlans;
        ...
        {
            public List<Amazon.AutoScalingPlans.Model.ApplicationSource> ApplicationSources { get; set; }
            public int? MaxResults { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> ScalingPlanNames { get; set; }
            public System.Int64? ScalingPlanVersion { get; set; }
        }
