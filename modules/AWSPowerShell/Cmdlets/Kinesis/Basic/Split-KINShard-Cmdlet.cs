...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    /// </para><para><c>SplitShard</c> is an asynchronous operation. Upon receiving a <c>SplitShard</c>
    ...
    /// 
    /// </para><para><c>SplitShard</c> has a limit of five transactions per second per account.
    /// </para>
    /// </summary>
    ...
    public partial class SplitKINShardCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
        ...
        private Amazon.Kinesis.Model.SplitShardResponse CallAWSServiceOperation(IAmazonKinesis client, Amazon.Kinesis.Model.SplitShardRequest request)
        {
            ...
            try
            {
                return client.SplitShardAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
