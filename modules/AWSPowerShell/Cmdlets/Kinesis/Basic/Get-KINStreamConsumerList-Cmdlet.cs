...
namespace Amazon.PowerShell.Cmdlets.KIN
{
    ...
    [AWSCmdletOutput("Amazon.Kinesis.Model.Consumer or Amazon.Kinesis.Model.ListStreamConsumersResponse",
        ...
        "The service call response (type Amazon.Kinesis.Model.ListStreamConsumersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetKINStreamConsumerListCmdlet : AmazonKinesisClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of consumers that you want a single call of <c>ListStreamConsumers</c>
        ...
        /// to list the next set of registered consumers.</para><para>Don't specify <c>StreamName</c> or <c>StreamCreationTimestamp</c> if you specify <c>NextToken</c>
        ...
        /// next set of consumers.</para><important><para>Tokens expire after 300 seconds. When you obtain a value for <c>NextToken</c> in the
        ...
        /// get <c>ExpiredNextTokenException</c>.</para></important>
        /// </para>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Consumers?.Count ?? 0;
        ...
        private Amazon.Kinesis.Model.ListStreamConsumersResponse CallAWSServiceOperation(IAmazonKinesis client, Amazon.Kinesis.Model.ListStreamConsumersRequest request)
        {
            ...
            try
            {
                return client.ListStreamConsumersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
