#
# Module manifest for module 'AWS.Tools.Odb'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.Odb.dll'
    ...
    GUID = '018DBEC0-F918-46E9-AA33-AAE48D84CBDD'
    ...
    Description = 'The Odb module of AWS Tools for PowerShell lets developers and administrators manage Oracle Database@Amazon Web Services from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.Odb.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.Odb.Completers.psm1',
        'AWS.Tools.Odb.Aliases.psm1'
    )
