...
namespace Amazon.PowerShell.Cmdlets.ODB
{
    ...
    public partial class NewODBCloudExadataInfrastructureCmdlet : AmazonOdbClientCmdlet, IExecutor
    {
        ...
        /// updates for the Exadata infrastructure.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The list of resource tags to apply to the Exadata infrastructure.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.Odb.Model.CreateCloudExadataInfrastructureResponse CallAWSServiceOperation(IAmazonOdb client, Amazon.Odb.Model.CreateCloudExadataInfrastructureRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateCloudExadataInfrastructure(request);
                #elif CORECLR
                return client.CreateCloudExadataInfrastructureAsync(request).GetAwaiter().GetResult();
                #else
