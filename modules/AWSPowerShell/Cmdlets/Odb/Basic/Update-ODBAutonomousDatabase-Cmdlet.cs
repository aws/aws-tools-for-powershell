...
namespace Amazon.PowerShell.Cmdlets.ODB
{
    ...
    public partial class UpdateODBAutonomousDatabaseCmdlet : AmazonOdbClientCmdlet, IExecutor
    {
        ...
        /// IAM role.</para><para>The valid values depend on the operation. For the <c>CreateAutonomousDatabase</c>
        ...
        /// <c>database_ocid</c>, <c>compartment_ocid</c>, and <c>tenant_ocid</c> are all allowed.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
