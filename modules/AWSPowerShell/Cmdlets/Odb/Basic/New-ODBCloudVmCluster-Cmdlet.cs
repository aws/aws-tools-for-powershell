...
namespace Amazon.PowerShell.Cmdlets.ODB
{
    ...
    public partial class NewODBCloudVmClusterCmdlet : AmazonOdbClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of database servers for the VM cluster.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The public key portion of one or more key pairs used for SSH access to the VM cluster.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The list of resource tags to apply to the VM cluster.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Odb.Model.CreateCloudVmClusterResponse CallAWSServiceOperation(IAmazonOdb client, Amazon.Odb.Model.CreateCloudVmClusterRequest request)
        {
            ...
            try
            {
                return client.CreateCloudVmClusterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
