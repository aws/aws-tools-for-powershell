...
namespace Amazon.PowerShell.Cmdlets.ODB
{
    ...
    public partial class StartODBDbNodeCmdlet : AmazonOdbClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the VM cluster that contains the DB node to start. You must
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the Exascale VM cluster that contains the DB node to start.
