...
namespace Amazon.PowerShell.Cmdlets.FINSP
{
    ...
    public partial class RemoveFINSPEnvironmentCmdlet : AmazonFinspaceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier for the FinSpace environment.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Finspace.Model.DeleteEnvironmentResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FINSPEnvironment (DeleteEnvironment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Finspace.Model.DeleteEnvironmentResponse, RemoveFINSPEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Finspace.Model.DeleteEnvironmentRequest();
        ...
        private Amazon.Finspace.Model.DeleteEnvironmentResponse CallAWSServiceOperation(IAmazonFinspace client, Amazon.Finspace.Model.DeleteEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace User Environment Management Service", "DeleteEnvironment");
            try
            {
        ...
        {
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.Finspace.Model.DeleteEnvironmentResponse, RemoveFINSPEnvironmentCmdlet, object> Select { get; set; } =
