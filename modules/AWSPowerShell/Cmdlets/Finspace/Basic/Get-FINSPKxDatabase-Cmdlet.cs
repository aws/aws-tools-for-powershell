...
namespace Amazon.PowerShell.Cmdlets.FINSP
{
    ...
    public partial class GetFINSPKxDatabaseCmdlet : AmazonFinspaceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Finspace.Model.GetKxDatabaseResponse).
        /// Specifying the name of a property of type Amazon.Finspace.Model.GetKxDatabaseResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Finspace.Model.GetKxDatabaseResponse, GetFINSPKxDatabaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Finspace.Model.GetKxDatabaseRequest();
        ...
        private Amazon.Finspace.Model.GetKxDatabaseResponse CallAWSServiceOperation(IAmazonFinspace client, Amazon.Finspace.Model.GetKxDatabaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace User Environment Management Service", "GetKxDatabase");
            try
            {
                #if DESKTOP
                return client.GetKxDatabase(request);
                #elif CORECLR
                return client.GetKxDatabaseAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DatabaseName { get; set; }
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.Finspace.Model.GetKxDatabaseResponse, GetFINSPKxDatabaseCmdlet, object> Select { get; set; } =
