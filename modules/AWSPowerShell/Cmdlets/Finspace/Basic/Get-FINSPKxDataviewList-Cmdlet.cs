...
{
    /// <summary>
    /// Returns a list of all the dataviews in the database.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Finspace.Model.KxDataviewListEntry or Amazon.Finspace.Model.ListKxDataviewsResponse",
        ...
        "The service call response (type Amazon.Finspace.Model.ListKxDataviewsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFINSPKxDataviewListCmdlet : AmazonFinspaceClientCmdlet, IExecutor
    {
        ...
        private Amazon.Finspace.Model.ListKxDataviewsResponse CallAWSServiceOperation(IAmazonFinspace client, Amazon.Finspace.Model.ListKxDataviewsRequest request)
        {
            ...
            try
            {
                return client.ListKxDataviewsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
