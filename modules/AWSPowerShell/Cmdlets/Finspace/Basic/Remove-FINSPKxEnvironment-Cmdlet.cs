...
namespace Amazon.PowerShell.Cmdlets.FINSP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "FINSPKxEnvironment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the FinSpace User Environment Management Service DeleteKxEnvironment API operation.", Operation = new[] {"DeleteKxEnvironment"}, SelectReturnType = typeof(Amazon.Finspace.Model.DeleteKxEnvironmentResponse))]
    [AWSCmdletOutput("None or Amazon.Finspace.Model.DeleteKxEnvironmentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Finspace.Model.DeleteKxEnvironmentResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveFINSPKxEnvironmentCmdlet : AmazonFinspaceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Finspace.Model.DeleteKxEnvironmentResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FINSPKxEnvironment (DeleteKxEnvironment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Finspace.Model.DeleteKxEnvironmentResponse, RemoveFINSPKxEnvironmentCmdlet>(Select) ??
        ...
        private Amazon.Finspace.Model.DeleteKxEnvironmentResponse CallAWSServiceOperation(IAmazonFinspace client, Amazon.Finspace.Model.DeleteKxEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace User Environment Management Service", "DeleteKxEnvironment");
            try
            {
                #if DESKTOP
                return client.DeleteKxEnvironment(request);
                #elif CORECLR
                return client.DeleteKxEnvironmentAsync(request).GetAwaiter().GetResult();
                #else
