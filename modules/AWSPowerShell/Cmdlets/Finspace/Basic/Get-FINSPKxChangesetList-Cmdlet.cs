...
{
    /// <summary>
    /// Returns a list of all the changesets for a database.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Finspace.Model.KxChangesetListEntry or Amazon.Finspace.Model.ListKxChangesetsResponse",
        ...
        "The service call response (type Amazon.Finspace.Model.ListKxChangesetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFINSPKxChangesetListCmdlet : AmazonFinspaceClientCmdlet, IExecutor
    {
        ...
        private Amazon.Finspace.Model.ListKxChangesetsResponse CallAWSServiceOperation(IAmazonFinspace client, Amazon.Finspace.Model.ListKxChangesetsRequest request)
        {
            ...
            try
            {
                return client.ListKxChangesetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
