...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    /// message payloads</a> in the <i>Amazon SNS Developer Guide.</i></para><important><para>
    ...
    /// </para><para><c>&amp;AttributeName.1=first</c></para><para><c>&amp;AttributeName.2=second</c></para><para>
    ...
    public partial class PublishSNSBatchCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of <c>PublishBatch</c> request entries to be sent to the SNS topic.</para><para />
        ...
        private Amazon.SimpleNotificationService.Model.PublishBatchResponse CallAWSServiceOperation(IAmazonSimpleNotificationService client, Amazon.SimpleNotificationService.Model.PublishBatchRequest request)
        {
            ...
            try
            {
                return client.PublishBatchAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
