...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    public partial class SetSNSTopicAttributeCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        /// that the <code>SetTopicAttributes</code> action uses:</para><ul><li><para><code>ApplicationSuccessFeedbackRoleArn</code> – Indicates failed message delivery
        /// status for an Amazon SNS topic that is subscribed to a platform application endpoint.</para></li><li><para><code>DeliveryPolicy</code> – The policy that defines how Amazon SNS retries failed
        ...
        /// only the topic owner can publish or subscribe to the topic.</para></li><li><para><code>TracingConfig</code> – Tracing mode of an Amazon SNS topic. By default <code>TracingConfig</code>
        ...
        /// in the tracing header is true. This is only supported on standard topics.</para></li><li><para>HTTP</para><ul><li><para><code>HTTPSuccessFeedbackRoleArn</code> – Indicates successful message delivery status
        /// for an Amazon SNS topic that is subscribed to an HTTP endpoint. </para></li><li><para><code>HTTPSuccessFeedbackSampleRate</code> – Indicates percentage of successful messages
        /// to sample for an Amazon SNS topic that is subscribed to an HTTP endpoint.</para></li><li><para><code>HTTPFailureFeedbackRoleArn</code> – Indicates failed message delivery status
        /// for an Amazon SNS topic that is subscribed to an HTTP endpoint.</para></li></ul></li><li><para>Amazon Kinesis Data Firehose</para><ul><li><para><code>FirehoseSuccessFeedbackRoleArn</code> – Indicates successful message delivery
        /// status for an Amazon SNS topic that is subscribed to an Amazon Kinesis Data Firehose
        /// endpoint.</para></li><li><para><code>FirehoseSuccessFeedbackSampleRate</code> – Indicates percentage of successful
        /// messages to sample for an Amazon SNS topic that is subscribed to an Amazon Kinesis
        /// Data Firehose endpoint.</para></li><li><para><code>FirehoseFailureFeedbackRoleArn</code> – Indicates failed message delivery status
        /// for an Amazon SNS topic that is subscribed to an Amazon Kinesis Data Firehose endpoint.
        /// </para></li></ul></li><li><para>Lambda</para><ul><li><para><code>LambdaSuccessFeedbackRoleArn</code> – Indicates successful message delivery
        /// status for an Amazon SNS topic that is subscribed to an Lambda endpoint.</para></li><li><para><code>LambdaSuccessFeedbackSampleRate</code> – Indicates percentage of successful
        /// messages to sample for an Amazon SNS topic that is subscribed to an Lambda endpoint.</para></li><li><para><code>LambdaFailureFeedbackRoleArn</code> – Indicates failed message delivery status
        /// for an Amazon SNS topic that is subscribed to an Lambda endpoint. </para></li></ul></li><li><para>Platform application endpoint</para><ul><li><para><code>ApplicationSuccessFeedbackRoleArn</code> – Indicates successful message delivery
        /// status for an Amazon SNS topic that is subscribed to an Amazon Web Services application
        /// endpoint.</para></li><li><para><code>ApplicationSuccessFeedbackSampleRate</code> – Indicates percentage of successful
        /// messages to sample for an Amazon SNS topic that is subscribed to an Amazon Web Services
        /// application endpoint.</para></li><li><para><code>ApplicationFailureFeedbackRoleArn</code> – Indicates failed message delivery
        /// status for an Amazon SNS topic that is subscribed to an Amazon Web Services application
        /// endpoint.</para></li></ul><note><para>In addition to being able to configure topic attributes for message delivery status
        ...
        /// Amazon SNS Application Attributes for Message Delivery Status</a>. </para></note></li><li><para>Amazon SQS</para><ul><li><para><code>SQSSuccessFeedbackRoleArn</code> – Indicates successful message delivery status
        /// for an Amazon SNS topic that is subscribed to an Amazon SQS endpoint. </para></li><li><para><code>SQSSuccessFeedbackSampleRate</code> – Indicates percentage of successful messages
        /// to sample for an Amazon SNS topic that is subscribed to an Amazon SQS endpoint. </para></li><li><para><code>SQSFailureFeedbackRoleArn</code> – Indicates failed message delivery status
        /// for an Amazon SNS topic that is subscribed to an Amazon SQS endpoint. </para></li></ul></li></ul><note><para>The &lt;ENDPOINT&gt;SuccessFeedbackRoleArn and &lt;ENDPOINT&gt;FailureFeedbackRoleArn
        ...
        /// generate CloudWatch Logs. </para></note><para>The following attribute applies only to <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-server-side-encryption.html">server-side-encryption</a>:</para><ul><li><para><code>KmsMasterKeyId</code> – The ID of an Amazon Web Services managed customer master
        ...
        /// in the <i>Key Management Service API Reference</i>. </para></li><li><para><code>SignatureVersion</code> – The signature version corresponds to the hashing
        ...
        /// is set to <code>1</code>.</para></li></ul><para>The following attribute applies only to <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-fifo-topics.html">FIFO
        /// topics</a>:</para><ul><li><para><code>ContentBasedDeduplication</code> – Enables content-based deduplication for
