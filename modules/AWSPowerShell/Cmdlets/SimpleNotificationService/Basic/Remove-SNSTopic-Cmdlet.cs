...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Notification Service (SNS) DeleteTopic API operation.", Operation = new[] {"DeleteTopic"}, SelectReturnType = typeof(Amazon.SimpleNotificationService.Model.DeleteTopicResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleNotificationService.Model.DeleteTopicResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleNotificationService.Model.DeleteTopicResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSNSTopicCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleNotificationService.Model.DeleteTopicResponse, RemoveSNSTopicCmdlet>(Select) ??
        ...
        {
            public System.String TopicArn { get; set; }
            public System.Func<Amazon.SimpleNotificationService.Model.DeleteTopicResponse, RemoveSNSTopicCmdlet, object> Select { get; set; } =
