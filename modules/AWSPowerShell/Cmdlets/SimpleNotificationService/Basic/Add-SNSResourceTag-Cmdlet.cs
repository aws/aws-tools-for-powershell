...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Add", "SNSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddSNSResourceTagCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SNSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleNotificationService.Model.TagResourceResponse, AddSNSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleNotificationService.Model.TagResourceRequest();
        ...
        private Amazon.SimpleNotificationService.Model.TagResourceResponse CallAWSServiceOperation(IAmazonSimpleNotificationService client, Amazon.SimpleNotificationService.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Notification Service (SNS)", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SimpleNotificationService.Model.TagResourceResponse, AddSNSResourceTagCmdlet, object> Select { get; set; } =
