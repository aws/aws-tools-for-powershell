...
{
    [AWSClientCmdlet("Amazon Simple Notification Service (SNS)", "SNS", "2010-03-31", "SimpleNotificationService")]
    public abstract partial class AmazonSimpleNotificationServiceClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonSimpleNotificationServiceConfig.ServiceId.ToString();
