...
namespace Amazon.PowerShell.Cmdlets.DOCE
{
    ...
    [AWSCmdletOutput("Amazon.DocDBElastic.Model.Cluster or Amazon.DocDBElastic.Model.GetClusterResponse",
        ...
        "The service call response (type Amazon.DocDBElastic.Model.GetClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
