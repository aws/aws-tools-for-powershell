...
namespace Amazon.PowerShell.Cmdlets.DOCE
{
    ...
    [AWSCmdlet("Calls the Amazon DocumentDB Elastic Clusters DeleteCluster API operation.", Operation = new[] {"DeleteCluster"}, SelectReturnType = typeof(Amazon.DocDBElastic.Model.DeleteClusterResponse))]
    [AWSCmdletOutput("Amazon.DocDBElastic.Model.Cluster or Amazon.DocDBElastic.Model.DeleteClusterResponse",
        "This cmdlet returns an Amazon.DocDBElastic.Model.Cluster object.",
        "The service call response (type Amazon.DocDBElastic.Model.DeleteClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveDOCEClusterCmdlet : AmazonDocDBElasticClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DOCECluster (DeleteCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DocDBElastic.Model.DeleteClusterResponse, RemoveDOCEClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DocDBElastic.Model.DeleteClusterRequest();
        ...
        private Amazon.DocDBElastic.Model.DeleteClusterResponse CallAWSServiceOperation(IAmazonDocDBElastic client, Amazon.DocDBElastic.Model.DeleteClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DocumentDB Elastic Clusters", "DeleteCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ClusterArn { get; set; }
            public System.Func<Amazon.DocDBElastic.Model.DeleteClusterResponse, RemoveDOCEClusterCmdlet, object> Select { get; set; } =
