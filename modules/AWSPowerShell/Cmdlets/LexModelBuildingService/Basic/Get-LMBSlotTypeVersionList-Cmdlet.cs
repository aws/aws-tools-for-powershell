...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetSlotTypeVersions API operation.", Operation = new[] {"GetSlotTypeVersions"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.SlotTypeMetadata or Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.SlotTypeMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMBSlotTypeVersionListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SlotTypes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse, GetLMBSlotTypeVersionListCmdlet>(Select) ??
        ...
        private Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsRequest request)
        {
            ...
            try
            {
                return client.GetSlotTypeVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetSlotTypeVersionsResponse, GetLMBSlotTypeVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SlotTypes;
        }
