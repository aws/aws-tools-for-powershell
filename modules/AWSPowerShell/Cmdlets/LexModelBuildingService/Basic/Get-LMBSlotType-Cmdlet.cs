...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetSlotType API operation.", Operation = new[] {"GetSlotType"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetSlotTypeResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.GetSlotTypeResponse",
        "This cmdlet returns an Amazon.LexModelBuildingService.Model.GetSlotTypeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBSlotTypeCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetSlotTypeResponse, GetLMBSlotTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelBuildingService.Model.GetSlotTypeRequest();
        ...
        private Amazon.LexModelBuildingService.Model.GetSlotTypeResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetSlotTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetSlotType");
            try
            {
                #if DESKTOP
                return client.GetSlotType(request);
                #elif CORECLR
                return client.GetSlotTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetSlotTypeResponse, GetLMBSlotTypeCmdlet, object> Select { get; set; } =
