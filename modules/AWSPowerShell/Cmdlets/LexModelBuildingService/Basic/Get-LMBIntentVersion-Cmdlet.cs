...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetIntentVersions API operation.", Operation = new[] {"GetIntentVersions"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.IntentMetadata or Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.IntentMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBIntentVersionCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse, GetLMBIntentVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetIntentVersionsRequest();
        ...
        private Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetIntentVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetIntentVersions");
            try
            {
                #if DESKTOP
                return client.GetIntentVersions(request);
                #elif CORECLR
                return client.GetIntentVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetIntentVersionsResponse, GetLMBIntentVersionCmdlet, object> Select { get; set; } =
