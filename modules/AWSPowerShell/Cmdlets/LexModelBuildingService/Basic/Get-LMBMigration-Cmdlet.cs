...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.GetMigrationResponse",
        "This cmdlet returns an Amazon.LexModelBuildingService.Model.GetMigrationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBMigrationCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the MigrationId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^MigrationId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MigrationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.MigrationId;
            }
