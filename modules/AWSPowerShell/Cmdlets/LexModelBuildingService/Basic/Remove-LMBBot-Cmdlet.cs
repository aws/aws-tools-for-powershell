...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Lex Model Building Service DeleteBot API operation.", Operation = new[] {"DeleteBot"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.DeleteBotResponse))]
    [AWSCmdletOutput("None or Amazon.LexModelBuildingService.Model.DeleteBotResponse",
    ...
    public partial class RemoveLMBBotCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBBot (DeleteBot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.DeleteBotResponse, RemoveLMBBotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelBuildingService.Model.DeleteBotRequest();
        ...
        private Amazon.LexModelBuildingService.Model.DeleteBotResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.DeleteBotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "DeleteBot");
            try
            {
                #if DESKTOP
                return client.DeleteBot(request);
                #elif CORECLR
                return client.DeleteBotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.DeleteBotResponse, RemoveLMBBotCmdlet, object> Select { get; set; } =
