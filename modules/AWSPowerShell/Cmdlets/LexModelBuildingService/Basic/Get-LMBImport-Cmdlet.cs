...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    public partial class GetLMBImportCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetImportResponse, GetLMBImportCmdlet>(Select) ??
        ...
        private Amazon.LexModelBuildingService.Model.GetImportResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetImportRequest request)
        {
            ...
            try
            {
                return client.GetImportAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ImportId { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetImportResponse, GetLMBImportCmdlet, object> Select { get; set; } =
