...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetIntents API operation.", Operation = new[] {"GetIntents"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetIntentsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.IntentMetadata or Amazon.LexModelBuildingService.Model.GetIntentsResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.IntentMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetIntentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMBIntentListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetIntentsResponse, GetLMBIntentListCmdlet>(Select) ??
        ...
        private Amazon.LexModelBuildingService.Model.GetIntentsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetIntentsRequest request)
        {
            ...
            try
            {
                return client.GetIntentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NameContain { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetIntentsResponse, GetLMBIntentListCmdlet, object> Select { get; set; } =
