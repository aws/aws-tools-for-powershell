...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetBots API operation.", Operation = new[] {"GetBots"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetBotsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotMetadata or Amazon.LexModelBuildingService.Model.GetBotsResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.BotMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetBotsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMBBotListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetBotsResponse, GetLMBBotListCmdlet>(Select) ??
        ...
        private Amazon.LexModelBuildingService.Model.GetBotsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotsRequest request)
        {
            ...
            try
            {
                return client.GetBotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NameContain { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetBotsResponse, GetLMBBotListCmdlet, object> Select { get; set; } =
