...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetBotAliases API operation.", Operation = new[] {"GetBotAliases"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetBotAliasesResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotAliasMetadata or Amazon.LexModelBuildingService.Model.GetBotAliasesResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.BotAliasMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetBotAliasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMBBotAliasListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BotAliases";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetBotAliasesResponse, GetLMBBotAliasListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetBotAliasesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BotAliases?.Count ?? 0;
        ...
        private Amazon.LexModelBuildingService.Model.GetBotAliasesResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotAliasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetBotAliases");
            try
            {
                #if DESKTOP
                return client.GetBotAliases(request);
                #elif CORECLR
                return client.GetBotAliasesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NameContain { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetBotAliasesResponse, GetLMBBotAliasListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BotAliases;
        }
