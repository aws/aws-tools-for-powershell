...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    public partial class GetLMBBotCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        #region Parameter VersionOrAlias
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String VersionOrAlias { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^VersionOrAlias' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetBotResponse, GetLMBBotCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.VersionOrAlias;
            }
            ...
            #endif
            context.VersionOrAlias = this.VersionOrAlias;
            #if MODULAR
            if (this.VersionOrAlias == null && ParameterWasBound(nameof(this.VersionOrAlias)))
            {
                WriteWarning("You are passing $null as a value for parameter VersionOrAlias which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelBuildingService.Model.GetBotRequest();
            
            if (cmdletContext.Name != null)
            {
                request.Name = cmdletContext.Name;
            }
            if (cmdletContext.VersionOrAlias != null)
            {
                request.VersionOrAlias = cmdletContext.VersionOrAlias;
            }
        ...
        private Amazon.LexModelBuildingService.Model.GetBotResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetBot");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String VersionOrAlias { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetBotResponse, GetLMBBotCmdlet, object> Select { get; set; } =
