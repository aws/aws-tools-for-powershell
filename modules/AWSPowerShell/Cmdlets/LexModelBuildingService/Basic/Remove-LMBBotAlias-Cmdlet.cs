...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Lex Model Building Service DeleteBotAlias API operation.", Operation = new[] {"DeleteBotAlias"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse))]
    [AWSCmdletOutput("None or Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveLMBBotAliasCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBBotAlias (DeleteBotAlias)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse, RemoveLMBBotAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelBuildingService.Model.DeleteBotAliasRequest();
        ...
        private Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.DeleteBotAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "DeleteBotAlias");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BotName { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.DeleteBotAliasResponse, RemoveLMBBotAliasCmdlet, object> Select { get; set; } =
