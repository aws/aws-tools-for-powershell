...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Lex Model Building Service DeleteSlotTypeVersion API operation.", Operation = new[] {"DeleteSlotTypeVersion"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse))]
    [AWSCmdletOutput("None or Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveLMBSlotTypeVersionCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse, RemoveLMBSlotTypeVersionCmdlet>(Select) ??
        ...
        private Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionRequest request)
        {
            ...
            try
            {
                return client.DeleteSlotTypeVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String Version { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.DeleteSlotTypeVersionResponse, RemoveLMBSlotTypeVersionCmdlet, object> Select { get; set; } =
