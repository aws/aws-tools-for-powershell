...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetBotVersions API operation.", Operation = new[] {"GetBotVersions"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetBotVersionsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotMetadata or Amazon.LexModelBuildingService.Model.GetBotVersionsResponse",
        "This cmdlet returns a collection of Amazon.LexModelBuildingService.Model.BotMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetBotVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLMBBotVersionListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexModelBuildingService.Model.GetBotVersionsResponse, GetLMBBotVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetBotVersionsRequest();
        ...
        private Amazon.LexModelBuildingService.Model.GetBotVersionsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetBotVersions");
            try
            {
                #if DESKTOP
                return client.GetBotVersions(request);
                #elif CORECLR
                return client.GetBotVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetBotVersionsResponse, GetLMBBotVersionListCmdlet, object> Select { get; set; } =
