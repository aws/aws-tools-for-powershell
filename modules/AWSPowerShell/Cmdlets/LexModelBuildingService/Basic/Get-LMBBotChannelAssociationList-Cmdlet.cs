...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetBotChannelAssociations API operation.", Operation = new[] {"GetBotChannelAssociations"}, SelectReturnType = typeof(Amazon.LexModelBuildingService.Model.GetBotChannelAssociationsResponse))]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotChannelAssociation or Amazon.LexModelBuildingService.Model.GetBotChannelAssociationsResponse",
    ...
    public partial class GetLMBBotChannelAssociationListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LexModelBuildingService.Model.GetBotChannelAssociationsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotChannelAssociationsRequest request)
        {
            ...
            try
            {
                return client.GetBotChannelAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NameContain { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LexModelBuildingService.Model.GetBotChannelAssociationsResponse, GetLMBBotChannelAssociationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BotChannelAssociations;
        }
