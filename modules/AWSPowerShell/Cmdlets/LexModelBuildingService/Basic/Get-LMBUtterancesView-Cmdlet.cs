...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    public partial class GetLMBUtterancesViewCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        /// is 5 versions per request.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>To return utterances that were recognized and handled, use <c>Detected</c>. To return
        /// utterances that were not recognized, use <c>Missed</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.LexModelBuildingService.Model.GetUtterancesViewResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetUtterancesViewRequest request)
        {
            ...
            try
            {
                return client.GetUtterancesViewAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
