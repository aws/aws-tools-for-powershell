...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync ListApiKeys API operation.", Operation = new[] {"ListApiKeys"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.ApiKey",
        "This cmdlet returns a collection of ApiKey objects.",
        "The service call response (type Amazon.AppSync.Model.ListApiKeysResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetASYNApiKeyListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListApiKeysRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ApiKeys;
                        ...
                        int _receivedThisCall = response.ApiKeys.Count;
        ...
        private Amazon.AppSync.Model.ListApiKeysResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListApiKeysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListApiKeys");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListApiKeysAsync(request);
                return task.Result;
                #else
