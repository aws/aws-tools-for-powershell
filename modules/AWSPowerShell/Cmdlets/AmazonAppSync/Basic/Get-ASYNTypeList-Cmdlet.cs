...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNTypeList")]
    [OutputType("Amazon.AppSync.Model.Type")]
    [AWSCmdlet("Calls the AWS AppSync ListTypes API operation.", Operation = new[] {"ListTypes"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.Type",
        "This cmdlet returns a collection of Type objects.",
        "The service call response (type Amazon.AppSync.Model.ListTypesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetASYNTypeListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListTypesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Types;
                        ...
                        int _receivedThisCall = response.Types.Count;
        ...
        private Amazon.AppSync.Model.ListTypesResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListTypes");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListTypesAsync(request);
                return task.Result;
                #else
