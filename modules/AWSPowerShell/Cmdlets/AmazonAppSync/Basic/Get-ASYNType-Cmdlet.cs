...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync GetType API operation.", Operation = new[] {"GetType"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.Type",
        "This cmdlet returns a Type object.",
        "The service call response (type Amazon.AppSync.Model.GetTypeResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASYNTypeCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppSync.Model.GetTypeResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.GetTypeRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetTypeAsync(request);
                return task.Result;
                #else
