...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNResolverListByFunction")]
    [OutputType("Amazon.AppSync.Model.Resolver")]
    [AWSCmdlet("Calls the AWS AppSync ListResolversByFunction API operation.", Operation = new[] {"ListResolversByFunction"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.Resolver",
        "This cmdlet returns a collection of Resolver objects.",
        "The service call response (type Amazon.AppSync.Model.ListResolversByFunctionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetASYNResolverListByFunctionCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListResolversByFunctionRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Resolvers;
                        ...
                        int _receivedThisCall = response.Resolvers.Count;
        ...
        private Amazon.AppSync.Model.ListResolversByFunctionResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListResolversByFunctionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListResolversByFunction");
            try
            {
                #if DESKTOP
                return client.ListResolversByFunction(request);
                #elif CORECLR
                return client.ListResolversByFunctionAsync(request).GetAwaiter().GetResult();
                #else
