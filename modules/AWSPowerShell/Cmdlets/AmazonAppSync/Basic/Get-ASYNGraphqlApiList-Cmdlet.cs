...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync ListGraphqlApis API operation.", Operation = new[] {"ListGraphqlApis"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.GraphqlApi",
        "This cmdlet returns a collection of GraphqlApi objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.GraphqlApis;
