...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNResolverList")]
    [OutputType("Amazon.AppSync.Model.Resolver")]
    [AWSCmdlet("Calls the AWS AppSync ListResolvers API operation.", Operation = new[] {"ListResolvers"})]
    [AWSCmdletOutput("Amazon.AppSync.Model.Resolver",
        "This cmdlet returns a collection of Resolver objects.",
        "The service call response (type Amazon.AppSync.Model.ListResolversResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetASYNResolverListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListResolversRequest();
        ...
        private Amazon.AppSync.Model.ListResolversResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListResolversRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListResolvers");
            try
            {
                #if DESKTOP
