...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// in Amazon EC2. To call <c>Decrypt</c> for a Nitro enclave or NitroTPM, use the <a href="https://docs.aws.amazon.com/enclaves/latest/user/developing-applications.html#sdk">Amazon
    ...
    /// </para><para><b>Cross-account use</b>: Yes. To specify a KMS key in a different Amazon Web Services
    ...
    public partial class InvokeKMSDecryptCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// your permissions</a> in the <i>Key Management Service Developer Guide</i>.</para><para />
