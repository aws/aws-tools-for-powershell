...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// grants</a>.
    /// </para><para><b>Cross-account use</b>: Yes. You can retire a grant on a CMK in a different AWS
    /// account.
    ...
    public partial class DisableKMSGrantCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// consistency</a> in the <i>AWS Key Management Service Developer Guide</i>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The key ARN CMK associated with the grant. To find the key ARN, use the <a>ListKeys</a>
