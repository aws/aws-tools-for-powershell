...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// </para></note><para><b>Cross-account use</b>: No. You cannot use this operation to create a CMK in a
    /// different AWS account. 
    /// </para><para><b>Required permissions</b>: 
    /// </para><ul><li><para><code>kms:ReplicateKey</code> on the primary CMK (in the primary CMK's Region). Include
    ...
    public partial class NewKMSReplicaKeyCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A description of the CMK. Use a description that helps you decide whether the CMK
        /// is appropriate for a task. The default value is an empty string (no description).</para><para>The description is not a shared property of multi-Region keys. You can specify the
        /// same description or a different description for each key in a set of related multi-Region
        /// keys. AWS KMS does not synchronize this property.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The key policy to attach to the CMK. This parameter is optional. If you do not provide
        ...
        /// key policy</a> to the CMK.</para><para>The key policy is not a shared property of multi-Region keys. You can specify the
        /// same key policy or a different key policy for each key in a set of related multi-Region
        /// keys. AWS KMS does not synchronize this property.</para><para>If you provide a key policy, it must meet the following criteria:</para><ul><li><para>If you don't set <code>BypassPolicyLockoutSafetyCheck</code> to true, the key policy
        ...
        /// Management User Guide</i>.</para></li><li><para>The key policy size quota is 32 kilobytes (32768 bytes).</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The Region ID of the AWS Region for this replica key. </para><para>Enter the Region ID, such as <code>us-east-1</code> or <code>ap-southeast-2</code>.
        ...
        /// KMS service endpoints</a> in the <i>Amazon Web Services General Reference</i>.</para><para>The replica must be in a different AWS Region than its primary key and other replicas
        ...
        /// in the Region. </para><para>For information about AWS partitions, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon
        ...
        /// <summary>
        /// <para>
        /// <para>Assigns one or more tags to the replica key. Use this parameter to tag the CMK when
        /// it is created. To tag an existing CMK, use the <a>TagResource</a> operation.</para><note><para>Tagging or untagging a CMK can allow or deny permission to the CMK. For details, see
        ...
        /// not synchronize this property.</para><para>Each tag consists of a tag key and a tag value. Both the tag key and the tag value
