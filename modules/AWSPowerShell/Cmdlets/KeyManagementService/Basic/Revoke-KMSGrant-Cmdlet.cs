...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// and revoking grants</a> in the <i><i>AWS Key Management Service Developer Guide</i></i>.
    /// 
    ///  
    /// <para>
    ...
    public partial class RevokeKMSGrantCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique identifier for the customer master key (CMK) associated with the grant. To
        /// get the key ID and key ARN for a CMK, use <a>ListKeys</a> or <a>DescribeKey</a>.</para><para>Specify the key ID or key ARN of the CMK. To specify a CMK in a different AWS account,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KeyManagementService.Model.RevokeGrantResponse, RevokeKMSGrantCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GrantId { get; set; }
            public System.String KeyId { get; set; }
            public System.Func<Amazon.KeyManagementService.Model.RevokeGrantResponse, RevokeKMSGrantCmdlet, object> Select { get; set; } =
