...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    /// </para><para><b>Cross-account use</b>: Yes. The source CMK and destination CMK can be in different
    ...
    public partial class InvokeKMSReEncryptCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// To find the <code>KeyUsage</code> value of a CMK, use the <a>DescribeKey</a> operation.</para><para>To specify a CMK, use its key ID, key ARN, alias name, or alias ARN. When using an
        ...
        /// ciphertext.</para><para>This parameter is required only when the ciphertext was encrypted under an asymmetric
