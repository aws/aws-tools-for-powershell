...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public partial class UpdateKMSCustomKeyStoreCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Changes the Amazon Web Services account ID that KMS uses to identify the Amazon VPC
        ...
        /// endpoint service will not be updated.</para><para>To change this value, the external key store must be disconnected.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.KeyManagementService.Model.UpdateCustomKeyStoreResponse CallAWSServiceOperation(IAmazonKeyManagementService client, Amazon.KeyManagementService.Model.UpdateCustomKeyStoreRequest request)
        {
            ...
            try
            {
                return client.UpdateCustomKeyStoreAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
