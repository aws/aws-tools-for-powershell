...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public partial class InvokeKMSEncryptCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// we recommend RSAES_OAEP_SHA_256.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Identifies the KMS key to use in the encryption operation.</para><para>To specify a KMS key, use its key ID, key ARN, alias name, or alias ARN. When using
