...
namespace Amazon.PowerShell.Cmdlets.KMS
{
    ...
    public partial class InvokeKMSEncryptCmdlet : AmazonKeyManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Identifies the customer master key (CMK) to use in the encryption operation.</para><para>To specify a CMK, use its key ID, key ARN, alias name, or alias ARN. When using an
