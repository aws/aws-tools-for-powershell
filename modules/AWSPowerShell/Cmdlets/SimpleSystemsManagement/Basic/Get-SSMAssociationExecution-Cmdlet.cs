...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMAssociationExecution")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.AssociationExecution")]
    [AWSCmdlet("Calls the AWS Systems Manager DescribeAssociationExecutions API operation.", Operation = new[] {"DescribeAssociationExecutions"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.AssociationExecution or Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.AssociationExecution objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSMAssociationExecutionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Filters")]
        public Amazon.SimpleSystemsManagement.Model.AssociationExecutionFilter[] Filter { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AssociationExecutions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse, GetSSMAssociationExecutionCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.AssociationExecutionFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AssociationExecutions?.Count ?? 0;
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DescribeAssociationExecutions");
            try
            {
                #if DESKTOP
                return client.DescribeAssociationExecutions(request);
                #elif CORECLR
                return client.DescribeAssociationExecutionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AssociationId { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.AssociationExecutionFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionsResponse, GetSSMAssociationExecutionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AssociationExecutions;
        }
