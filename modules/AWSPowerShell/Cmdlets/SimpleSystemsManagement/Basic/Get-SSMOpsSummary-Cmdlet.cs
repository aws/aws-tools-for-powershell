...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager GetOpsSummary API operation.", Operation = new[] {"GetOpsSummary"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.GetOpsSummaryResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.OpsEntity or Amazon.SimpleSystemsManagement.Model.GetOpsSummaryResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.OpsEntity objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.GetOpsSummaryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSMOpsSummaryCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Aggregator' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.GetOpsSummaryResponse, GetSSMOpsSummaryCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Aggregator;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.GetOpsSummaryRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.GetOpsSummaryResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetOpsSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "GetOpsSummary");
            try
            {
                #if DESKTOP
                return client.GetOpsSummary(request);
                #elif CORECLR
                return client.GetOpsSummaryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.OpsAggregator> Aggregator { get; set; }
