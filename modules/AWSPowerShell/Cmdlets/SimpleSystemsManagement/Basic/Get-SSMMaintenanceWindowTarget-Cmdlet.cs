...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMMaintenanceWindowTarget")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.MaintenanceWindowTarget")]
    ...
    public partial class GetSSMMaintenanceWindowTargetCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// targets. The supported filter keys are <c>Type</c>, <c>WindowTargetId</c>, and <c>OwnerInformation</c>.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowTargetsResponse, GetSSMMaintenanceWindowTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowTargetsRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowTargetsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DescribeMaintenanceWindowTargets");
            try
            {
                #if DESKTOP
                return client.DescribeMaintenanceWindowTargets(request);
                #elif CORECLR
                return client.DescribeMaintenanceWindowTargetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WindowId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowTargetsResponse, GetSSMMaintenanceWindowTargetCmdlet, object> Select { get; set; } =
