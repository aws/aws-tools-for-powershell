...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMParameterListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeParametersResponse, GetSSMParameterListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.ParametersFilter>(this.Filter);
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.ParametersFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
