...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Systems Manager DisassociateOpsItemRelatedItem API operation.", Operation = new[] {"DisassociateOpsItemRelatedItem"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnregisterSSMOpsItemRelatedItemCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-SSMOpsItemRelatedItem (DisassociateOpsItemRelatedItem)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse, UnregisterSSMOpsItemRelatedItemCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DisassociateOpsItemRelatedItem");
            try
            {
                #if DESKTOP
                return client.DisassociateOpsItemRelatedItem(request);
                #elif CORECLR
                return client.DisassociateOpsItemRelatedItemAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssociationId { get; set; }
            public System.String OpsItemId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DisassociateOpsItemRelatedItemResponse, UnregisterSSMOpsItemRelatedItemCmdlet, object> Select { get; set; } =
