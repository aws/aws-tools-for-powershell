...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMInstanceInformationCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceInformationList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeInstanceInformationResponse, GetSSMInstanceInformationCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.InstanceInformationStringFilter>(this.Filter);
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.InstanceInformationStringFilter> Filter { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.InstanceInformationFilter> InstanceInformationFilterList { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribeInstanceInformationResponse, GetSSMInstanceInformationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceInformationList;
        }
