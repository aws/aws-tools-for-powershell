...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMExecutionPreviewCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ExecutionPreviewId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ExecutionPreviewId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ExecutionPreviewId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ExecutionPreviewId;
            }
        ...
        private Amazon.SimpleSystemsManagement.Model.GetExecutionPreviewResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetExecutionPreviewRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetExecutionPreview(request);
                #elif CORECLR
                return client.GetExecutionPreviewAsync(request).GetAwaiter().GetResult();
                #else
