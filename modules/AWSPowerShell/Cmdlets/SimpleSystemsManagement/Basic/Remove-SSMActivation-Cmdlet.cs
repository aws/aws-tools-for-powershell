...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class RemoveSSMActivationCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ActivationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ActivationId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DeleteActivationResponse, RemoveSSMActivationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ActivationId;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.ActivationId = this.ActivationId;
            #if MODULAR
            if (this.ActivationId == null && ParameterWasBound(nameof(this.ActivationId)))
            {
                WriteWarning("You are passing $null as a value for parameter ActivationId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DeleteActivation");
            try
            {
                #if DESKTOP
                return client.DeleteActivation(request);
                #elif CORECLR
                return client.DeleteActivationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ActivationId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DeleteActivationResponse, RemoveSSMActivationCmdlet, object> Select { get; set; } =
