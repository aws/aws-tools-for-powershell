...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager ListCommandInvocations API operation.", Operation = new[] {"ListCommandInvocations"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.CommandInvocation or Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.CommandInvocation objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMCommandInvocationCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>(Optional) One or more filters. Use a filter to return a more specific list of results.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CommandInvocations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse, GetSSMCommandInvocationCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.CommandFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.CommandInvocations?.Count ?? 0;
        ...
        private Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsRequest request)
        {
            ...
            try
            {
                return client.ListCommandInvocationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CommandId { get; set; }
            public System.Boolean? Detail { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.CommandFilter> Filter { get; set; }
            public System.String InstanceId { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.ListCommandInvocationsResponse, GetSSMCommandInvocationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CommandInvocations;
        }
