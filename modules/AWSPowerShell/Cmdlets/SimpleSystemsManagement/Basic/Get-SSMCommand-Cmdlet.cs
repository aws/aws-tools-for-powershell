...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager ListCommands API operation.", Operation = new[] {"ListCommands"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.ListCommandsResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.Command or Amazon.SimpleSystemsManagement.Model.ListCommandsResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.Command objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.ListCommandsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMCommandCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>(Optional) Lists commands issued against this managed node ID.</para><note><para>You can't specify a managed node ID in the same command that you specify <c>Status</c>
        /// = <c>Pending</c>. This is because the command hasn't reached the managed node yet.</para></note>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.ListCommandsResponse, GetSSMCommandCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Commands?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.ListCommandsResponse, GetSSMCommandCmdlet, object> Select { get; set; } =
