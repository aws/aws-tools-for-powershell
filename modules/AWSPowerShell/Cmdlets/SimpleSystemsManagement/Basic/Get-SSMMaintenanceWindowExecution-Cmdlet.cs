...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMMaintenanceWindowExecutionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.GetMaintenanceWindowExecutionResponse, GetSSMMaintenanceWindowExecutionCmdlet>(Select) ??
        ...
        private Amazon.SimpleSystemsManagement.Model.GetMaintenanceWindowExecutionResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetMaintenanceWindowExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "GetMaintenanceWindowExecution");
            try
            {
                return client.GetMaintenanceWindowExecutionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String WindowExecutionId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.GetMaintenanceWindowExecutionResponse, GetSSMMaintenanceWindowExecutionCmdlet, object> Select { get; set; } =
