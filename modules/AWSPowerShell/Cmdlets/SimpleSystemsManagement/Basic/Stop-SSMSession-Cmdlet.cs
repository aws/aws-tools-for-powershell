...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class StopSSMSessionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SSMSession (TerminateSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.TerminateSessionResponse, StopSSMSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleSystemsManagement.Model.TerminateSessionRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.TerminateSessionResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.TerminateSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "TerminateSession");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SessionId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.TerminateSessionResponse, StopSSMSessionCmdlet, object> Select { get; set; } =
