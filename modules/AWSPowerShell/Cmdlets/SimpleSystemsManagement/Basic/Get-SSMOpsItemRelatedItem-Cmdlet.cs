...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.OpsItemRelatedItemSummary or Amazon.SimpleSystemsManagement.Model.ListOpsItemRelatedItemsResponse",
        ...
        "The service call response (type Amazon.SimpleSystemsManagement.Model.ListOpsItemRelatedItemsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
