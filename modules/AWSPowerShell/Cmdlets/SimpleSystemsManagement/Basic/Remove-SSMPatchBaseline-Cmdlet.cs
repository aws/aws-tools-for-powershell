...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class RemoveSSMPatchBaselineCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineResponse, RemoveSSMPatchBaselineCmdlet>(Select) ??
        ...
        private Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineRequest request)
        {
            ...
            try
            {
                return client.DeletePatchBaselineAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String BaselineId { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineResponse, RemoveSSMPatchBaselineCmdlet, object> Select { get; set; } =
