...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager DescribeActivations API operation.", Operation = new[] {"DescribeActivations"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.Activation or Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.Activation objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMActivationCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A filter to view information about your activations.</para><para />
        ...
        [Alias("Filters")]
        public Amazon.SimpleSystemsManagement.Model.DescribeActivationsFilter[] Filter { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ActivationList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse, GetSSMActivationCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.DescribeActivationsFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeActivationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ActivationList?.Count ?? 0;
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeActivationsRequest request)
        {
            ...
            try
            {
                return client.DescribeActivationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.DescribeActivationsFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse, GetSSMActivationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ActivationList;
        }
