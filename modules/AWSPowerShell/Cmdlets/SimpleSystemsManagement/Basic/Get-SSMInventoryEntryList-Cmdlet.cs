...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager ListInventoryEntries API operation.", Operation = new[] {"ListInventoryEntries"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.ListInventoryEntriesResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.ListInventoryEntriesResponse",
        "This cmdlet returns an Amazon.SimpleSystemsManagement.Model.ListInventoryEntriesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSMInventoryEntryListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.ListInventoryEntriesResponse, GetSSMInventoryEntryListCmdlet>(Select) ??
