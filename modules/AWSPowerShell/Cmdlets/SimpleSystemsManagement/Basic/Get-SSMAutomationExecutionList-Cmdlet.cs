...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMAutomationExecutionList")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.AutomationExecutionMetadata")]
    ...
    public partial class GetSSMAutomationExecutionListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters used to limit the scope of executions that are requested.</para><para />
        ...
        [Alias("Filters")]
        public Amazon.SimpleSystemsManagement.Model.AutomationExecutionFilter[] Filter { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AutomationExecutionMetadataList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribeAutomationExecutionsResponse, GetSSMAutomationExecutionListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.AutomationExecutionFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeAutomationExecutionsRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeAutomationExecutionsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeAutomationExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DescribeAutomationExecutions");
            try
            {
                return client.DescribeAutomationExecutionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.AutomationExecutionFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribeAutomationExecutionsResponse, GetSSMAutomationExecutionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AutomationExecutionMetadataList;
        }
