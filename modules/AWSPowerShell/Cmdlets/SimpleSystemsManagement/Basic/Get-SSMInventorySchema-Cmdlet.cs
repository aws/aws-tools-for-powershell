...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager GetInventorySchema API operation.", Operation = new[] {"GetInventorySchema"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.GetInventorySchemaResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.InventoryItemSchema or Amazon.SimpleSystemsManagement.Model.GetInventorySchemaResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.InventoryItemSchema objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.GetInventorySchemaResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMInventorySchemaCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.GetInventorySchemaResponse, GetSSMInventorySchemaCmdlet>(Select) ??
            ...
            {
                WriteVerbose("MaxResult parameter unset, using default value of '200'");
                context.MaxResult = 200;
            }
            #endif
            #if !MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                {
                    request.MaxResults = AutoIterationHelpers.ConvertEmitLimitToInt32(200);
                }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? SubType { get; set; }
            public System.String TypeName { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.GetInventorySchemaResponse, GetSSMInventorySchemaCmdlet, object> Select { get; set; } =
