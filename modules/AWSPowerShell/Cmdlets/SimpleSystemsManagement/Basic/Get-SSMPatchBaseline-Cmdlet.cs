...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMPatchBaselineCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BaselineIdentities";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.DescribePatchBaselinesResponse, GetSSMPatchBaselineCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.DescribePatchBaselinesResponse, GetSSMPatchBaselineCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BaselineIdentities;
        }
