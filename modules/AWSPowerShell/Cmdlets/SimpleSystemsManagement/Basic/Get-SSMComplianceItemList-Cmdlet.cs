...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMComplianceItemList")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.ComplianceItem")]
    [AWSCmdlet("Calls the AWS Systems Manager ListComplianceItems API operation.", Operation = new[] {"ListComplianceItems"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.ListComplianceItemsResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.ComplianceItem or Amazon.SimpleSystemsManagement.Model.ListComplianceItemsResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.ComplianceItem objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.ListComplianceItemsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMComplianceItemListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more compliance filters. Use a filter to return a more specific list of results.</para><para />
        ...
        /// can only specify one resource ID.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// supported resource type is <c>ManagedInstance</c>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ComplianceItems";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.ListComplianceItemsResponse, GetSSMComplianceItemListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.ComplianceStringFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ComplianceItems?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "ListComplianceItems");
            try
            {
                return client.ListComplianceItemsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.ComplianceStringFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> ResourceId { get; set; }
            public List<System.String> ResourceType { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.ListComplianceItemsResponse, GetSSMComplianceItemListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ComplianceItems;
        }
