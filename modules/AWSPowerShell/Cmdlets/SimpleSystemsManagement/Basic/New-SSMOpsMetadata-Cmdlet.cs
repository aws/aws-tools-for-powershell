...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class NewSSMOpsMetadataCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SSMOpsMetadata (CreateOpsMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.CreateOpsMetadataResponse, NewSSMOpsMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleSystemsManagement.Model.CreateOpsMetadataRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.CreateOpsMetadataResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.CreateOpsMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "CreateOpsMetadata");
            try
            {
                return client.CreateOpsMetadataAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
