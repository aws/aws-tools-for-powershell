...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMResourceComplianceSummaryListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters. Use a filter to return a more specific list of results.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResourceComplianceSummaryItems";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.ListResourceComplianceSummariesResponse, GetSSMResourceComplianceSummaryListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.ListResourceComplianceSummariesRequest();
        ...
        private Amazon.SimpleSystemsManagement.Model.ListResourceComplianceSummariesResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.ListResourceComplianceSummariesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "ListResourceComplianceSummaries");
            try
            {
                return client.ListResourceComplianceSummariesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.ListResourceComplianceSummariesResponse, GetSSMResourceComplianceSummaryListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResourceComplianceSummaryItems;
        }
