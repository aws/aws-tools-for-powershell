...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager GetInventory API operation.", Operation = new[] {"GetInventory"}, SelectReturnType = typeof(Amazon.SimpleSystemsManagement.Model.GetInventoryResponse))]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.InventoryResultEntity or Amazon.SimpleSystemsManagement.Model.GetInventoryResponse",
        "This cmdlet returns a collection of Amazon.SimpleSystemsManagement.Model.InventoryResultEntity objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.GetInventoryResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSSMInventoryCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of inventory item types to return.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleSystemsManagement.Model.GetInventoryResponse, GetSSMInventoryCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Aggregator != null)
            {
                context.Aggregator = new List<Amazon.SimpleSystemsManagement.Model.InventoryAggregator>(this.Aggregator);
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.SimpleSystemsManagement.Model.InventoryFilter>(this.Filter);
            }
            ...
            {
                context.ResultAttribute = new List<Amazon.SimpleSystemsManagement.Model.ResultAttribute>(this.ResultAttribute);
            }
        ...
        private Amazon.SimpleSystemsManagement.Model.GetInventoryResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetInventoryRequest request)
        {
            ...
            try
            {
                return client.GetInventoryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.SimpleSystemsManagement.Model.InventoryAggregator> Aggregator { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.InventoryFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.ResultAttribute> ResultAttribute { get; set; }
            public System.Func<Amazon.SimpleSystemsManagement.Model.GetInventoryResponse, GetSSMInventoryCmdlet, object> Select { get; set; } =
