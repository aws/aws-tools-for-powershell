...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Elastic Beanstalk DeleteConfigurationTemplate API operation.", Operation = new[] {"DeleteConfigurationTemplate"}, SelectReturnType = typeof(Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse))]
    [AWSCmdletOutput("None or Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveEBConfigurationTemplateCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse, RemoveEBConfigurationTemplateCmdlet>(Select) ??
        ...
        private Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateRequest request)
        {
            ...
            try
            {
                return client.DeleteConfigurationTemplateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationName { get; set; }
            public System.String TemplateName { get; set; }
            public System.Func<Amazon.ElasticBeanstalk.Model.DeleteConfigurationTemplateResponse, RemoveEBConfigurationTemplateCmdlet, object> Select { get; set; } =
