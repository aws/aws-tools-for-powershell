...
{
    /// <summary>
    /// Retrieve a list of application versions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EBApplicationVersion")]
    [OutputType("Amazon.ElasticBeanstalk.Model.ApplicationVersionDescription")]
    [AWSCmdlet("Calls the AWS Elastic Beanstalk DescribeApplicationVersions API operation.", Operation = new[] {"DescribeApplicationVersions"}, SelectReturnType = typeof(Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse), LegacyAlias="Get-EBApplicationVersions")]
    [AWSCmdletOutput("Amazon.ElasticBeanstalk.Model.ApplicationVersionDescription or Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse",
        "This cmdlet returns a collection of Amazon.ElasticBeanstalk.Model.ApplicationVersionDescription objects.",
        "The service call response (type Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEBApplicationVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specify a version label to show a specific application version.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse).
        /// Specifying the name of a property of type Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse, GetEBApplicationVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ApplicationVersions?.Count ?? 0;
        ...
        private Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsRequest request)
        {
            ...
            try
            {
                return client.DescribeApplicationVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ElasticBeanstalk.Model.DescribeApplicationVersionsResponse, GetEBApplicationVersionCmdlet, object> Select { get; set; } =
