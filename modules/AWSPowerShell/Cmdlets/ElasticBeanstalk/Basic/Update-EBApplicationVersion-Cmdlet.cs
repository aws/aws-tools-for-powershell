...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    public partial class UpdateEBApplicationVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse).
        /// Specifying the name of a property of type Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse, UpdateEBApplicationVersionCmdlet>(Select) ??
        ...
        private Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionRequest request)
        {
            ...
            try
            {
                return client.UpdateApplicationVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String VersionLabel { get; set; }
            public System.Func<Amazon.ElasticBeanstalk.Model.UpdateApplicationVersionResponse, UpdateEBApplicationVersionCmdlet, object> Select { get; set; } =
