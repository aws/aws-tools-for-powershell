...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    public partial class GetEBPlatformVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        /// as a logical conjunction (AND) of the separate <c>PlatformFilter</c> terms.</para><para />
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'PlatformSummaryList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticBeanstalk.Model.ListPlatformVersionsResponse).
        /// Specifying the name of a property of type Amazon.ElasticBeanstalk.Model.ListPlatformVersionsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PlatformSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticBeanstalk.Model.ListPlatformVersionsResponse, GetEBPlatformVersionCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.ElasticBeanstalk.Model.PlatformFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.PlatformSummaryList?.Count ?? 0;
        ...
        private Amazon.ElasticBeanstalk.Model.ListPlatformVersionsResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.ListPlatformVersionsRequest request)
        {
            ...
            try
            {
                return client.ListPlatformVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.ElasticBeanstalk.Model.PlatformFilter> Filter { get; set; }
            public int? MaxRecord { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ElasticBeanstalk.Model.ListPlatformVersionsResponse, GetEBPlatformVersionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PlatformSummaryList;
        }
