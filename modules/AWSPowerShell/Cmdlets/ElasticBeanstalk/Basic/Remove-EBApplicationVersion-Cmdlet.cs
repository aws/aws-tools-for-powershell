...
namespace Amazon.PowerShell.Cmdlets.EB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Elastic Beanstalk DeleteApplicationVersion API operation.", Operation = new[] {"DeleteApplicationVersion"}, SelectReturnType = typeof(Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse))]
    [AWSCmdletOutput("None or Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveEBApplicationVersionCmdlet : AmazonElasticBeanstalkClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.VersionLabel), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse, RemoveEBApplicationVersionCmdlet>(Select) ??
        ...
        private Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse CallAWSServiceOperation(IAmazonElasticBeanstalk client, Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionRequest request)
        {
            ...
            try
            {
                return client.DeleteApplicationVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? DeleteSourceBundle { get; set; }
            public System.String VersionLabel { get; set; }
            public System.Func<Amazon.ElasticBeanstalk.Model.DeleteApplicationVersionResponse, RemoveEBApplicationVersionCmdlet, object> Select { get; set; } =
