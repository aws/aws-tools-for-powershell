...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    public partial class RemoveERESIdNamespaceCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ERESIdNamespace (DeleteIdNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EntityResolution.Model.DeleteIdNamespaceResponse, RemoveERESIdNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EntityResolution.Model.DeleteIdNamespaceRequest();
        ...
        private Amazon.EntityResolution.Model.DeleteIdNamespaceResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.DeleteIdNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS EntityResolution", "DeleteIdNamespace");
            try
            {
                #if DESKTOP
                return client.DeleteIdNamespace(request);
                #elif CORECLR
                return client.DeleteIdNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String IdNamespaceName { get; set; }
            public System.Func<Amazon.EntityResolution.Model.DeleteIdNamespaceResponse, RemoveERESIdNamespaceCmdlet, object> Select { get; set; } =
