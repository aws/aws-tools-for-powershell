...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    /// </summary>
    [Cmdlet("Start", "ERESIdMappingJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS EntityResolution StartIdMappingJob API operation.", Operation = new[] {"StartIdMappingJob"}, SelectReturnType = typeof(Amazon.EntityResolution.Model.StartIdMappingJobResponse))]
    [AWSCmdletOutput("System.String or Amazon.EntityResolution.Model.StartIdMappingJobResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.EntityResolution.Model.StartIdMappingJobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartERESIdMappingJobCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-ERESIdMappingJob (StartIdMappingJob)"))
            {
                return;
            }
        ...
        private Amazon.EntityResolution.Model.StartIdMappingJobResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.StartIdMappingJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS EntityResolution", "StartIdMappingJob");
            try
            {
                #if DESKTOP
                return client.StartIdMappingJob(request);
                #elif CORECLR
                return client.StartIdMappingJobAsync(request).GetAwaiter().GetResult();
                #else
