...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    [AWSCmdletOutput("System.String or Amazon.EntityResolution.Model.StartIdMappingJobResponse",
        ...
        "The service call response (type Amazon.EntityResolution.Model.StartIdMappingJobResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartERESIdMappingJobCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of <c>OutputSource</c> objects.</para><para />
        ...
        private Amazon.EntityResolution.Model.StartIdMappingJobResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.StartIdMappingJobRequest request)
        {
            ...
            try
            {
                return client.StartIdMappingJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
