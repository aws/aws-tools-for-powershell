...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    public partial class StartERESMatchingJobCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-ERESMatchingJob (StartMatchingJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EntityResolution.Model.StartMatchingJobResponse, StartERESMatchingJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EntityResolution.Model.StartMatchingJobRequest();
        ...
        private Amazon.EntityResolution.Model.StartMatchingJobResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.StartMatchingJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS EntityResolution", "StartMatchingJob");
            try
            {
                #if DESKTOP
                return client.StartMatchingJob(request);
                #elif CORECLR
                return client.StartMatchingJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WorkflowName { get; set; }
            public System.Func<Amazon.EntityResolution.Model.StartMatchingJobResponse, StartERESMatchingJobCmdlet, object> Select { get; set; } =
