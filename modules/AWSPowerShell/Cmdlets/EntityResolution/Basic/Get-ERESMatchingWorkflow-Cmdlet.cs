...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    public partial class GetERESMatchingWorkflowCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EntityResolution.Model.GetMatchingWorkflowResponse, GetERESMatchingWorkflowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EntityResolution.Model.GetMatchingWorkflowRequest();
        ...
        private Amazon.EntityResolution.Model.GetMatchingWorkflowResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.GetMatchingWorkflowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS EntityResolution", "GetMatchingWorkflow");
            try
            {
                #if DESKTOP
                return client.GetMatchingWorkflow(request);
                #elif CORECLR
                return client.GetMatchingWorkflowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WorkflowName { get; set; }
            public System.Func<Amazon.EntityResolution.Model.GetMatchingWorkflowResponse, GetERESMatchingWorkflowCmdlet, object> Select { get; set; } =
