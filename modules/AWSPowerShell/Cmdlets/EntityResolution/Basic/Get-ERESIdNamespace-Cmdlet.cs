...
namespace Amazon.PowerShell.Cmdlets.ERES
{
    ...
    public partial class GetERESIdNamespaceCmdlet : AmazonEntityResolutionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EntityResolution.Model.GetIdNamespaceResponse, GetERESIdNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EntityResolution.Model.GetIdNamespaceRequest();
        ...
        private Amazon.EntityResolution.Model.GetIdNamespaceResponse CallAWSServiceOperation(IAmazonEntityResolution client, Amazon.EntityResolution.Model.GetIdNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS EntityResolution", "GetIdNamespace");
            try
            {
                #if DESKTOP
                return client.GetIdNamespace(request);
                #elif CORECLR
                return client.GetIdNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String IdNamespaceName { get; set; }
            public System.Func<Amazon.EntityResolution.Model.GetIdNamespaceResponse, GetERESIdNamespaceCmdlet, object> Select { get; set; } =
