#
# Module manifest for module 'AWS.Tools.EntityResolution'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.EntityResolution.dll'
    ...
    GUID = '7ad463f2-2814-4c46-8130-a9825d1fd892'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.EntityResolution.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.EntityResolution.Completers.psm1',
        'AWS.Tools.EntityResolution.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.EntityResolution.dll-Help.xml'
    )
