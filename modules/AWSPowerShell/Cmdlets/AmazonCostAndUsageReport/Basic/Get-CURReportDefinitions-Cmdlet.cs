...
namespace Amazon.PowerShell.Cmdlets.CUR
{
    ...
    /// </summary>
    [Cmdlet("Get", "CURReportDefinitions")]
    [OutputType("Amazon.CostAndUsageReport.Model.ReportDefinition")]
    [AWSCmdlet("Invokes the DescribeReportDefinitions operation against AWS Cost and Usage Report.", Operation = new[] {"DescribeReportDefinitions"})]
    ...
    public partial class GetCURReportDefinitionsCmdlet : AmazonCostAndUsageReportClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.ReportDefinitions;
        ...
        private static Amazon.CostAndUsageReport.Model.DescribeReportDefinitionsResponse CallAWSServiceOperation(IAmazonCostAndUsageReport client, Amazon.CostAndUsageReport.Model.DescribeReportDefinitionsRequest request)
        {
            ...
            var task = client.DescribeReportDefinitionsAsync(request);
            return task.Result;
            #else
