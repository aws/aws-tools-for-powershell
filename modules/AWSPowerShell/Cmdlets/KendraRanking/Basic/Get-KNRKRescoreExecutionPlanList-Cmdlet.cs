...
namespace Amazon.PowerShell.Cmdlets.KNRK
{
    ...
    /// Ranking resource used for provisioning the <c>Rescore</c> API.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.KendraRanking.Model.RescoreExecutionPlanSummary or Amazon.KendraRanking.Model.ListRescoreExecutionPlansResponse",
        ...
        "The service call response (type Amazon.KendraRanking.Model.ListRescoreExecutionPlansResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetKNRKRescoreExecutionPlanListCmdlet : AmazonKendraRankingClientCmdlet, IExecutor
    {
        ...
        private Amazon.KendraRanking.Model.ListRescoreExecutionPlansResponse CallAWSServiceOperation(IAmazonKendraRanking client, Amazon.KendraRanking.Model.ListRescoreExecutionPlansRequest request)
        {
            ...
            try
            {
                return client.ListRescoreExecutionPlansAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
