...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("New", "QSVPCConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewQSVPCConnectionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Web Services account ID of the account where you want to create a new VPC
        /// connection.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The IAM role to associate with the VPC connection.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.CreateVPCConnectionResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.CreateVPCConnectionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-QSVPCConnection (CreateVPCConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CreateVPCConnectionResponse, NewQSVPCConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.CreateVPCConnectionRequest();
        ...
        private Amazon.QuickSight.Model.CreateVPCConnectionResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateVPCConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "CreateVPCConnection");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VPCConnectionId { get; set; }
            public System.Func<Amazon.QuickSight.Model.CreateVPCConnectionResponse, NewQSVPCConnectionCmdlet, object> Select { get; set; } =
