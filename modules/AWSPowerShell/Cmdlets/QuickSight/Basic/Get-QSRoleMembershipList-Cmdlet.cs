...
{
    /// <summary>
    /// Lists all groups that are associated with a role.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "QSRoleMembershipList")]
    ...
    public partial class GetQSRoleMembershipListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'MembersList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.ListRoleMembershipsResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.ListRoleMembershipsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MembersList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListRoleMembershipsResponse, GetQSRoleMembershipListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListRoleMembershipsRequest();
        ...
        private Amazon.QuickSight.Model.ListRoleMembershipsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListRoleMembershipsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.QuickSight.Role Role { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListRoleMembershipsResponse, GetQSRoleMembershipListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MembersList;
        }
