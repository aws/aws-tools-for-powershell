...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.CreateRefreshScheduleResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.CreateRefreshScheduleResponse object containing multiple properties."
    )]
    public partial class NewQSRefreshScheduleCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CreateRefreshScheduleResponse, NewQSRefreshScheduleCmdlet>(Select) ??
        ...
        private Amazon.QuickSight.Model.CreateRefreshScheduleResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateRefreshScheduleRequest request)
        {
            ...
            try
            {
                return client.CreateRefreshScheduleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Schedule_ScheduleId { get; set; }
            public System.DateTime? Schedule_StartAfterDateTime { get; set; }
            public System.Func<Amazon.QuickSight.Model.CreateRefreshScheduleResponse, NewQSRefreshScheduleCmdlet, object> Select { get; set; } =
