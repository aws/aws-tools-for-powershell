...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Get", "QSFolderList")]
    [OutputType("Amazon.QuickSight.Model.FolderSummary")]
    [AWSCmdlet("Calls the Amazon QuickSight ListFolders API operation.", Operation = new[] {"ListFolders"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListFoldersResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.FolderSummary or Amazon.QuickSight.Model.ListFoldersResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.FolderSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.ListFoldersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSFolderListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListFoldersResponse, GetQSFolderListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListFoldersRequest();
        ...
        private Amazon.QuickSight.Model.ListFoldersResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListFoldersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListFolders");
            try
            {
                #if DESKTOP
                return client.ListFolders(request);
                #elif CORECLR
                return client.ListFoldersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListFoldersResponse, GetQSFolderListCmdlet, object> Select { get; set; } =
