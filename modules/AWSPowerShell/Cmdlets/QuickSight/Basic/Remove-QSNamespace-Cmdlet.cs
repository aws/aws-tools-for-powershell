...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// the relevant asset.
    /// </summary>
    [Cmdlet("Remove", "QSNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.QuickSight.Model.DeleteNamespaceResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight DeleteNamespace API operation.", Operation = new[] {"DeleteNamespace"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DeleteNamespaceResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteNamespaceResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteNamespaceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQSNamespaceCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSNamespace (DeleteNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteNamespaceResponse, RemoveQSNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteNamespaceRequest();
        ...
        private Amazon.QuickSight.Model.DeleteNamespaceResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteNamespace");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String Namespace { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteNamespaceResponse, RemoveQSNamespaceCmdlet, object> Select { get; set; } =
