...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSTopicV2", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateTopicV2Response")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateTopicV2 API operation.", Operation = new[] {"UpdateTopicV2"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateTopicV2Response))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateTopicV2Response",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateTopicV2Response object containing multiple properties."
    )]
    public partial class UpdateQSTopicV2Cmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        #region Parameter PublishOption
        /// <summary>
        /// <para>
        /// <para>The publish option for the topic that you want to update.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.QuickSight.TopicV2PublishOption")]
        public Amazon.QuickSight.TopicV2PublishOption PublishOption { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.UpdateTopicV2Response).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.UpdateTopicV2Response will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSTopicV2 (UpdateTopicV2)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateTopicV2Response, UpdateQSTopicV2Cmdlet>(Select) ??
            ...
            context.PublishOption = this.PublishOption;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateTopicV2Request();
            ...
            if (cmdletContext.PublishOption != null)
            {
                request.PublishOption = cmdletContext.PublishOption;
            }
        ...
        private Amazon.QuickSight.Model.UpdateTopicV2Response CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateTopicV2Request request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateTopicV2");
            try
            {
                return client.UpdateTopicV2Async(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Topic_Name { get; set; }
            public System.String TopicId { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateTopicV2Response, UpdateQSTopicV2Cmdlet, object> Select { get; set; } =
