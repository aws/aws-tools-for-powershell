...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Get", "QSThemeAliasList")]
    [OutputType("Amazon.QuickSight.Model.ThemeAlias")]
    [AWSCmdlet("Calls the Amazon QuickSight ListThemeAliases API operation.", Operation = new[] {"ListThemeAliases"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListThemeAliasesResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.ThemeAlias or Amazon.QuickSight.Model.ListThemeAliasesResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.ThemeAlias objects.",
        "The service call response (type Amazon.QuickSight.Model.ListThemeAliasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSThemeAliasListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThemeAliasList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListThemeAliasesResponse, GetQSThemeAliasListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListThemeAliasesRequest();
        ...
        private Amazon.QuickSight.Model.ListThemeAliasesResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListThemeAliasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListThemeAliases");
            try
            {
                #if DESKTOP
                return client.ListThemeAliases(request);
                #elif CORECLR
                return client.ListThemeAliasesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ThemeId { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListThemeAliasesResponse, GetQSThemeAliasListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThemeAliasList;
        }
