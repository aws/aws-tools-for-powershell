...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight ListTemplateAliases API operation.", Operation = new[] {"ListTemplateAliases"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListTemplateAliasesResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.TemplateAlias or Amazon.QuickSight.Model.ListTemplateAliasesResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.TemplateAlias objects.",
        "The service call response (type Amazon.QuickSight.Model.ListTemplateAliasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSTemplateAliasListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TemplateAliasList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListTemplateAliasesResponse, GetQSTemplateAliasListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListTemplateAliasesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TemplateAliasList?.Count ?? 0;
        ...
        private Amazon.QuickSight.Model.ListTemplateAliasesResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListTemplateAliasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListTemplateAliases");
            try
            {
                #if DESKTOP
                return client.ListTemplateAliases(request);
                #elif CORECLR
                return client.ListTemplateAliasesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListTemplateAliasesResponse, GetQSTemplateAliasListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TemplateAliasList;
        }
