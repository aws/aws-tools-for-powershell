...
{
    /// <summary>
    /// Lists all the versions of the templates in the current Amazon Quick Sight account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "QSTemplateVersionList")]
    [OutputType("Amazon.QuickSight.Model.TemplateVersionSummary")]
    [AWSCmdlet("Calls the Amazon QuickSight ListTemplateVersions API operation.", Operation = new[] {"ListTemplateVersions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListTemplateVersionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.TemplateVersionSummary or Amazon.QuickSight.Model.ListTemplateVersionsResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.TemplateVersionSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.ListTemplateVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQSTemplateVersionListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TemplateVersionSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListTemplateVersionsResponse, GetQSTemplateVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListTemplateVersionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TemplateVersionSummaryList.Count;
        ...
        private Amazon.QuickSight.Model.ListTemplateVersionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListTemplateVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListTemplateVersions");
            try
            {
                #if DESKTOP
                return client.ListTemplateVersions(request);
                #elif CORECLR
                return client.ListTemplateVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListTemplateVersionsResponse, GetQSTemplateVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TemplateVersionSummaryList;
        }
