...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.TemplateVersionSummary or Amazon.QuickSight.Model.ListTemplateVersionsResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListTemplateVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
