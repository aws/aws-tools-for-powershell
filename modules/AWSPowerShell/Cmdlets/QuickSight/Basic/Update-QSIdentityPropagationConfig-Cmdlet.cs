...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class UpdateQSIdentityPropagationConfigCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies a list of application ARNs that represent the authorized targets for a service.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the Amazon Web Services account that contains the identity propagation configuration
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Amazon Web Services service that contains the authorized targets that
        /// you want to add or update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.QuickSight.ServiceType")]
        public Amazon.QuickSight.ServiceType Service { get; set; }
        #endregion
        
        #region Parameter Select
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is '*'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.UpdateIdentityPropagationConfigResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.UpdateIdentityPropagationConfigResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSIdentityPropagationConfig (UpdateIdentityPropagationConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateIdentityPropagationConfigResponse, UpdateQSIdentityPropagationConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateIdentityPropagationConfigRequest();
        ...
        private Amazon.QuickSight.Model.UpdateIdentityPropagationConfigResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateIdentityPropagationConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateIdentityPropagationConfig");
            try
            {
                #if DESKTOP
                return client.UpdateIdentityPropagationConfig(request);
                #elif CORECLR
                return client.UpdateIdentityPropagationConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AwsAccountId { get; set; }
            public Amazon.QuickSight.ServiceType Service { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateIdentityPropagationConfigResponse, UpdateQSIdentityPropagationConfigCmdlet, object> Select { get; set; } =
