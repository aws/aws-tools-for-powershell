...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DescribeDataSource API operation.", Operation = new[] {"DescribeDataSource"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DescribeDataSourceResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DataSource or Amazon.QuickSight.Model.DescribeDataSourceResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DataSource object.",
        "The service call response (type Amazon.QuickSight.Model.DescribeDataSourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSDataSourceCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeDataSourceResponse, GetQSDataSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeDataSourceRequest();
        ...
        private Amazon.QuickSight.Model.DescribeDataSourceResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeDataSource");
            try
            {
                #if DESKTOP
                return client.DescribeDataSource(request);
                #elif CORECLR
                return client.DescribeDataSourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String DataSourceId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeDataSourceResponse, GetQSDataSourceCmdlet, object> Select { get; set; } =
