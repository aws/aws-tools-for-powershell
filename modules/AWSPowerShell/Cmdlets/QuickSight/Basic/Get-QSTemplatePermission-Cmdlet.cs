...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DescribeTemplatePermissions API operation.", Operation = new[] {"DescribeTemplatePermissions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSTemplatePermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse, GetQSTemplatePermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeTemplatePermissionsRequest();
        ...
        private Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeTemplatePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeTemplatePermissions");
            try
            {
                #if DESKTOP
                return client.DescribeTemplatePermissions(request);
                #elif CORECLR
                return client.DescribeTemplatePermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeTemplatePermissionsResponse, GetQSTemplatePermissionCmdlet, object> Select { get; set; } =
