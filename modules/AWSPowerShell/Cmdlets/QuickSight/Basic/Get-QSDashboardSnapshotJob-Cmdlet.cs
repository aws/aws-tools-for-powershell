...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DescribeDashboardSnapshotJob API operation.", Operation = new[] {"DescribeDashboardSnapshotJob"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSDashboardSnapshotJobCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse, GetQSDashboardSnapshotJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeDashboardSnapshotJobRequest();
        ...
        private Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeDashboardSnapshotJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeDashboardSnapshotJob");
            try
            {
                #if DESKTOP
                return client.DescribeDashboardSnapshotJob(request);
                #elif CORECLR
                return client.DescribeDashboardSnapshotJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DashboardId { get; set; }
            public System.String SnapshotJobId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeDashboardSnapshotJobResponse, GetQSDashboardSnapshotJobCmdlet, object> Select { get; set; } =
