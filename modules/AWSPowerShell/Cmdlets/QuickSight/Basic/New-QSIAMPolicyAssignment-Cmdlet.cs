...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class NewQSIAMPolicyAssignmentCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// Amazon Quick Sight users or groups.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Quick Sight users, groups, or both that you want to assign the policy to.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN for the IAM policy to apply to the Amazon Quick Sight users and groups specified
        ...
        private Amazon.QuickSight.Model.CreateIAMPolicyAssignmentResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateIAMPolicyAssignmentRequest request)
        {
            ...
            try
            {
                return client.CreateIAMPolicyAssignmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
