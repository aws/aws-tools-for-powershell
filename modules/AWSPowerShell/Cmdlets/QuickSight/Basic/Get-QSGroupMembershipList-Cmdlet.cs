...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight ListGroupMemberships API operation.", Operation = new[] {"ListGroupMemberships"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListGroupMembershipsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.GroupMember or Amazon.QuickSight.Model.ListGroupMembershipsResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.GroupMember objects.",
    ...
    public partial class GetQSGroupMembershipListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GroupMemberList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListGroupMembershipsResponse, GetQSGroupMembershipListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GroupMemberList?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListGroupMembershipsResponse, GetQSGroupMembershipListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GroupMemberList;
        }
