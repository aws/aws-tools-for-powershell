...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateAgentResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateAgent API operation.", Operation = new[] {"UpdateAgent"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateAgentResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateAgentResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateAgentResponse object containing multiple properties."
    )]
    public partial class UpdateQSAgentCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        private readonly CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();
        
        #region Parameter ActionConnectorsToAdd
        /// <summary>
        /// <para>
        ...
        public System.String[] ActionConnectorsToAdd { get; set; }
        #endregion
        
        #region Parameter ActionConnectorsToRemove
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Names (ARNs) of the action connectors to detach from the agent.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String[] ActionConnectorsToRemove { get; set; }
        #endregion
        
        #region Parameter AgentId
        /// <summary>
        /// <para>
        /// <para>The unique identifier for the agent to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String[] SpacesToAdd { get; set; }
        #endregion
        
        #region Parameter SpacesToRemove
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Names (ARNs) of the spaces to detach from the agent.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String[] SpacesToRemove { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.UpdateAgentResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.UpdateAgentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSAgent (UpdateAgent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateAgentResponse, UpdateQSAgentCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.ActionConnectorsToAdd != null)
            {
                context.ActionConnectorsToAdd = new List<System.String>(this.ActionConnectorsToAdd);
            }
            if (this.ActionConnectorsToRemove != null)
            {
                context.ActionConnectorsToRemove = new List<System.String>(this.ActionConnectorsToRemove);
            }
            ...
            {
                context.SpacesToAdd = new List<System.String>(this.SpacesToAdd);
            }
            if (this.SpacesToRemove != null)
            {
                context.SpacesToRemove = new List<System.String>(this.SpacesToRemove);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateAgentRequest();
            
            if (cmdletContext.ActionConnectorsToAdd != null)
            {
                request.ActionConnectorsToAdd = cmdletContext.ActionConnectorsToAdd;
            }
            if (cmdletContext.ActionConnectorsToRemove != null)
            {
                request.ActionConnectorsToRemove = cmdletContext.ActionConnectorsToRemove;
            }
            ...
            if (cmdletContext.SpacesToAdd != null)
            {
                request.SpacesToAdd = cmdletContext.SpacesToAdd;
            }
            if (cmdletContext.SpacesToRemove != null)
            {
                request.SpacesToRemove = cmdletContext.SpacesToRemove;
            }
        ...
        private Amazon.QuickSight.Model.UpdateAgentResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateAgentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateAgent");
            try
            {
        ...
        {
            public List<System.String> ActionConnectorsToAdd { get; set; }
            public List<System.String> ActionConnectorsToRemove { get; set; }
            public System.String AgentId { get; set; }
            public System.String AwsAccountId { get; set; }
            public System.String CustomPromptInput_ExistingPrompt_ModelProfileId { get; set; }
            public System.String CustomPromptInput_ExistingPrompt_QbsAwsAccountId { get; set; }
            ...
            public System.String IconId { get; set; }
            public System.String Name { get; set; }
            public List<System.String> SpacesToAdd { get; set; }
            public List<System.String> SpacesToRemove { get; set; }
            public List<System.String> StarterPrompt { get; set; }
            public System.String WelcomeMessage { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateAgentResponse, UpdateQSAgentCmdlet, object> Select { get; set; } =
