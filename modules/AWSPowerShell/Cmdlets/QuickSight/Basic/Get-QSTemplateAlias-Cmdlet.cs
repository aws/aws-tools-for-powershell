...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DescribeTemplateAlias API operation.", Operation = new[] {"DescribeTemplateAlias"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DescribeTemplateAliasResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.TemplateAlias or Amazon.QuickSight.Model.DescribeTemplateAliasResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.TemplateAlias object.",
        "The service call response (type Amazon.QuickSight.Model.DescribeTemplateAliasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSTemplateAliasCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeTemplateAliasResponse, GetQSTemplateAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeTemplateAliasRequest();
        ...
        private Amazon.QuickSight.Model.DescribeTemplateAliasResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeTemplateAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeTemplateAlias");
            try
            {
                #if DESKTOP
                return client.DescribeTemplateAlias(request);
                #elif CORECLR
                return client.DescribeTemplateAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AwsAccountId { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeTemplateAliasResponse, GetQSTemplateAliasCmdlet, object> Select { get; set; } =
