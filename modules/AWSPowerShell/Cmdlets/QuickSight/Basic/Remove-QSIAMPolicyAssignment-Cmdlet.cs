...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// <para>
    /// CLI syntax:
    /// </para><para><code>aws quicksight delete-iam-policy-assignment --aws-account-id=111122223333 --assignment-name=testtest
    /// --region=us-east-1 --namespace=default</code></para>
    /// </summary>
    ...
    public partial class RemoveQSIAMPolicyAssignmentCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS account ID where you want to delete an IAM policy assignment.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AssignmentName";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSIAMPolicyAssignment (DeleteIAMPolicyAssignment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteIAMPolicyAssignmentResponse, RemoveQSIAMPolicyAssignmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteIAMPolicyAssignmentRequest();
        ...
        private Amazon.QuickSight.Model.DeleteIAMPolicyAssignmentResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteIAMPolicyAssignmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteIAMPolicyAssignment");
            try
            {
                #if DESKTOP
                return client.DeleteIAMPolicyAssignment(request);
                #elif CORECLR
                return client.DeleteIAMPolicyAssignmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AwsAccountId { get; set; }
            public System.String Namespace { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteIAMPolicyAssignmentResponse, RemoveQSIAMPolicyAssignmentCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AssignmentName;
        }
