...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSFolder", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateFolderResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateFolder API operation.", Operation = new[] {"UpdateFolder"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateFolderResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateFolderResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateFolderResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSFolderCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSFolder (UpdateFolder)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateFolderResponse, UpdateQSFolderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateFolderRequest();
        ...
        private Amazon.QuickSight.Model.UpdateFolderResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateFolderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateFolder");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FolderId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateFolderResponse, UpdateQSFolderCmdlet, object> Select { get; set; } =
