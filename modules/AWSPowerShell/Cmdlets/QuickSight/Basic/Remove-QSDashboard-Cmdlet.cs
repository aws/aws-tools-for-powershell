...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteDashboard API operation.", Operation = new[] {"DeleteDashboard"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DeleteDashboardResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteDashboardResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteDashboardResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQSDashboardCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSDashboard (DeleteDashboard)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteDashboardResponse, RemoveQSDashboardCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteDashboardRequest();
        ...
        private Amazon.QuickSight.Model.DeleteDashboardResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteDashboardRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteDashboard");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DashboardId { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteDashboardResponse, RemoveQSDashboardCmdlet, object> Select { get; set; } =
