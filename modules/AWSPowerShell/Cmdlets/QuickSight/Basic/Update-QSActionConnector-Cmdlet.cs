...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSActionConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateActionConnectorResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateActionConnector API operation.", Operation = new[] {"UpdateActionConnector"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateActionConnectorResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateActionConnectorResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateActionConnectorResponse object containing multiple properties."
    )]
    public partial class UpdateQSActionConnectorCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the action connector to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Web Services account ID that contains the action connector to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated description of the action connector.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The new name for the action connector.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated ARN of the VPC connection to use for secure connectivity.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.UpdateActionConnectorResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.UpdateActionConnectorResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSActionConnector (UpdateActionConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateActionConnectorResponse, UpdateQSActionConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateActionConnectorRequest();
        ...
        private Amazon.QuickSight.Model.UpdateActionConnectorResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateActionConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateActionConnector");
            try
            {
                #if DESKTOP
                return client.UpdateActionConnector(request);
                #elif CORECLR
                return client.UpdateActionConnectorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String VpcConnectionArn { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateActionConnectorResponse, UpdateQSActionConnectorCmdlet, object> Select { get; set; } =
