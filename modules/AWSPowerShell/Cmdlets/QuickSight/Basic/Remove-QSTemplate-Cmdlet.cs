...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class RemoveQSTemplateCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSTemplate (DeleteTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteTemplateResponse, RemoveQSTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteTemplateRequest();
        ...
        private Amazon.QuickSight.Model.DeleteTemplateResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteTemplate");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TemplateId { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteTemplateResponse, RemoveQSTemplateCmdlet, object> Select { get; set; } =
