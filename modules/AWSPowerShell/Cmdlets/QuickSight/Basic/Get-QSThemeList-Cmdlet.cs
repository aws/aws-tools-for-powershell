...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.ThemeSummary or Amazon.QuickSight.Model.ListThemesResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListThemesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
