...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class GetQSThemeListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of themes that you want to list. Valid options include the following:</para><ul><li><para><c>ALL (default)</c>- Display all existing themes.</para></li><li><para><c>CUSTOM</c> - Display only the themes created by people using Amazon Quick Sight.</para></li><li><para><c>QUICKSIGHT</c> - Display only the starting themes defined by Quick Sight.</para></li></ul>
        /// </para>
        /// </summary>
