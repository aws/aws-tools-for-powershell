...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// Access to the Amazon Quick Console</a></para></li></ul>
    /// </summary>
    ...
    public partial class GetQSSessionEmbedUrlCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID for the Amazon Web Services account associated with your Amazon Quick Sight
        /// subscription.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// to the following paths:</para><ul><li><para><c>/start</c></para></li><li><para><c>/start/analyses</c></para></li><li><para><c>/start/dashboards</c></para></li><li><para><c>/start/favorites</c></para></li><li><para><c>/dashboards/<i>DashboardId</i></c> - where <c>DashboardId</c> is the actual ID
        /// key from the Amazon Quick Sight console URL of the dashboard</para></li><li><para><c>/analyses/<i>AnalysisId</i></c> - where <c>AnalysisId</c> is the actual ID key
        /// from the Amazon Quick Sight console URL of the analysis</para></li></ul>
        /// </para>
        /// </summary>
        ...
        /// identity type. You can use this for any type of Amazon Quick users in your account
        ...
        private Amazon.QuickSight.Model.GetSessionEmbedUrlResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.GetSessionEmbedUrlRequest request)
        {
            ...
            try
            {
                return client.GetSessionEmbedUrlAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
