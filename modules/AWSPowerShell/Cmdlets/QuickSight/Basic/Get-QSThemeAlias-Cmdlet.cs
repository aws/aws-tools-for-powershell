...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class GetQSThemeAliasCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeThemeAliasResponse, GetQSThemeAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeThemeAliasRequest();
        ...
        private Amazon.QuickSight.Model.DescribeThemeAliasResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeThemeAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeThemeAlias");
            try
            {
                #if DESKTOP
                return client.DescribeThemeAlias(request);
                #elif CORECLR
                return client.DescribeThemeAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AwsAccountId { get; set; }
            public System.String ThemeId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeThemeAliasResponse, GetQSThemeAliasCmdlet, object> Select { get; set; } =
