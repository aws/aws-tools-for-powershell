...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateTopicPermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateTopicPermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSTopicPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The resource permissions that you want to grant to the topic.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The resource permissions that you want to revoke from the topic.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.QuickSight.Model.UpdateTopicPermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateTopicPermissionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateTopicPermissions(request);
                #elif CORECLR
                return client.UpdateTopicPermissionsAsync(request).GetAwaiter().GetResult();
                #else
