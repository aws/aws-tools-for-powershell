...
{
    /// <summary>
    /// Lists all the versions of the dashboards in the Amazon Quick Sight subscription.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "QSDashboardVersionList")]
    [OutputType("Amazon.QuickSight.Model.DashboardVersionSummary")]
    [AWSCmdlet("Calls the Amazon QuickSight ListDashboardVersions API operation.", Operation = new[] {"ListDashboardVersions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListDashboardVersionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DashboardVersionSummary or Amazon.QuickSight.Model.ListDashboardVersionsResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.DashboardVersionSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.ListDashboardVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQSDashboardVersionListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DashboardVersionSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListDashboardVersionsResponse, GetQSDashboardVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListDashboardVersionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DashboardVersionSummaryList.Count;
        ...
        private Amazon.QuickSight.Model.ListDashboardVersionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListDashboardVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListDashboardVersions");
            try
            {
                #if DESKTOP
                return client.ListDashboardVersions(request);
                #elif CORECLR
                return client.ListDashboardVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListDashboardVersionsResponse, GetQSDashboardVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DashboardVersionSummaryList;
        }
