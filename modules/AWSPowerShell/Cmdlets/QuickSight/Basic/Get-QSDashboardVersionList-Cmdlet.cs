...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.DashboardVersionSummary or Amazon.QuickSight.Model.ListDashboardVersionsResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListDashboardVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSDashboardVersionListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>AWS account ID that contains the dashboard you are listing.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
