...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight ListFolderMembers API operation.", Operation = new[] {"ListFolderMembers"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListFolderMembersResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.MemberIdArnPair or Amazon.QuickSight.Model.ListFolderMembersResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.MemberIdArnPair objects.",
        "The service call response (type Amazon.QuickSight.Model.ListFolderMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSFolderMemberListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FolderMemberList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListFolderMembersResponse, GetQSFolderMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListFolderMembersRequest();
        ...
        private Amazon.QuickSight.Model.ListFolderMembersResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListFolderMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListFolderMembers");
            try
            {
                #if DESKTOP
                return client.ListFolderMembers(request);
                #elif CORECLR
                return client.ListFolderMembersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListFolderMembersResponse, GetQSFolderMemberListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FolderMemberList;
        }
