...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("New", "QSDlpSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.CreateDlpSettingResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight CreateDlpSetting API operation.", Operation = new[] {"CreateDlpSetting"}, SelectReturnType = typeof(Amazon.QuickSight.Model.CreateDlpSettingResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.CreateDlpSettingResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.CreateDlpSettingResponse object containing multiple properties."
    )]
    public partial class NewQSDlpSettingCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the Amazon Web Services account in which to create the DLP setting.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>A unique identifier for the DLP setting.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// enable enforcement, or <c>false</c> to disable it at time of setting creation.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A human-readable display name for the DLP setting.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The behavior to apply when the DLP provider is unreachable. Valid values are <c>ALLOW</c>,
        /// <c>WARN</c>, and <c>BLOCK</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The type of external DLP provider to use for sensitivity label classification. Currently,
        /// the only supported value is <c>MICROSOFT_PURVIEW</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A list of resource tags to apply to the DLP setting. You can use tags to manage access
        /// to your Amazon Web Services resources.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.CreateDlpSettingResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.CreateDlpSettingResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-QSDlpSetting (CreateDlpSetting)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CreateDlpSettingResponse, NewQSDlpSettingCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.ProviderOutageAction == null && ParameterWasBound(nameof(this.ProviderOutageAction)))
            {
                WriteWarning("You are passing $null as a value for parameter ProviderOutageAction which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.CreateDlpSettingRequest();
        ...
        private Amazon.QuickSight.Model.CreateDlpSettingResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateDlpSettingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "CreateDlpSetting");
            try
            {
                return client.CreateDlpSettingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QuickSight.Model.CreateDlpSettingResponse, NewQSDlpSettingCmdlet, object> Select { get; set; } =
