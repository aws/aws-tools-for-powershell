...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "QSRoleCustomPermission", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveQSRoleCustomPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The namespace that includes the role.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.DeleteRoleCustomPermissionResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.DeleteRoleCustomPermissionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSRoleCustomPermission (DeleteRoleCustomPermission)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteRoleCustomPermissionResponse, RemoveQSRoleCustomPermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteRoleCustomPermissionRequest();
        ...
        private Amazon.QuickSight.Model.DeleteRoleCustomPermissionResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteRoleCustomPermissionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteRoleCustomPermission");
            try
            {
                #if DESKTOP
                return client.DeleteRoleCustomPermission(request);
                #elif CORECLR
                return client.DeleteRoleCustomPermissionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public Amazon.QuickSight.Role Role { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteRoleCustomPermissionResponse, RemoveQSRoleCustomPermissionCmdlet, object> Select { get; set; } =
