...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class NewQSKnowledgeBaseCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// on the connector type of the data source referenced by <c>DataSourceArn</c>.</para><para>The template must be a JSON object. The required fields vary by connector type:</para><ul><li><para><b>Amazon S3</b> (<c>S3V2</c>) – Requires <c>connectionConfiguration</c> with <c>bucketName</c>.
        /// Supports <c>filterConfiguration</c> for inclusion and exclusion prefixes and patterns.
        /// Supports <c>accessControlConfiguration</c> and <c>deletionProtectionConfiguration</c>.</para></li><li><para><b>Google Drive</b> (<c>GOOGLEDRIVEV3</c>) – Requires <c>connectionConfiguration</c>
        /// with <c>authType</c> set to <c>SERVICE_ACCOUNT</c>. Supports <c>dataEntityConfiguration</c>
        /// with <c>crawlMyDrive</c>, <c>crawlSharedWithMe</c>, and <c>crawlSharedDrives</c>.</para></li><li><para><b>OneDrive</b> (<c>ONEDRIVEV3</c>) – Requires <c>authType</c> at the template root
        ...
        /// and <c>crawlSharedWithMe</c>.</para></li><li><para><b>SharePoint</b> (<c>SHAREPOINTV3</c>) – Requires <c>connectionConfiguration</c>
        /// with <c>tenantId</c> in UUID format. Supports <c>dataEntityConfiguration</c> with
        /// <c>siteUrls</c>, <c>crawlFiles</c>, and <c>crawlPages</c>.</para></li><li><para><b>Web Crawler</b> (<c>WEBCRAWLERV3</c>) – Requires <c>connectionConfiguration</c>
        ...
        /// <c>authType</c>: <c>NO_AUTH</c>, <c>BASIC_AUTH</c>, <c>FORM</c>, <c>SAML</c>.</para></li></ul><para>The optional <c>deletionProtectionConfiguration</c> object is supported by all connector
        /// types. It contains <c>enableDeletionProtection</c> and <c>deletionProtectionThreshold</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
