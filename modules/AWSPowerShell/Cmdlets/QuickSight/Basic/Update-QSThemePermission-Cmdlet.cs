...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class UpdateQSThemePermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of resource permissions to be granted for the theme.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of resource permissions to be revoked from the theme.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.QuickSight.Model.UpdateThemePermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateThemePermissionsRequest request)
        {
            ...
            try
            {
                return client.UpdateThemePermissionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
