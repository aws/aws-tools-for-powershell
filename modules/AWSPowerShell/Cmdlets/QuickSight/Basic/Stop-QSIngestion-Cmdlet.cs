...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight CancelIngestion API operation.", Operation = new[] {"CancelIngestion"}, SelectReturnType = typeof(Amazon.QuickSight.Model.CancelIngestionResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.CancelIngestionResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.CancelIngestionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopQSIngestionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-QSIngestion (CancelIngestion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CancelIngestionResponse, StopQSIngestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.CancelIngestionRequest();
        ...
        private Amazon.QuickSight.Model.CancelIngestionResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CancelIngestionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "CancelIngestion");
            try
            {
                #if DESKTOP
                return client.CancelIngestion(request);
                #elif CORECLR
                return client.CancelIngestionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DataSetId { get; set; }
            public System.String IngestionId { get; set; }
            public System.Func<Amazon.QuickSight.Model.CancelIngestionResponse, StopQSIngestionCmdlet, object> Select { get; set; } =
