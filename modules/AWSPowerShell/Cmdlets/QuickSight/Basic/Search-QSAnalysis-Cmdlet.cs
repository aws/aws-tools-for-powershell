...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Search", "QSAnalysis", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.AnalysisSummary")]
    [AWSCmdlet("Calls the Amazon QuickSight SearchAnalyses API operation.", Operation = new[] {"SearchAnalyses"}, SelectReturnType = typeof(Amazon.QuickSight.Model.SearchAnalysesResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.AnalysisSummary or Amazon.QuickSight.Model.SearchAnalysesResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.AnalysisSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.SearchAnalysesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchQSAnalysisCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Filters")]
        public Amazon.QuickSight.Model.AnalysisSearchFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-QSAnalysis (SearchAnalyses)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.SearchAnalysesResponse, SearchQSAnalysisCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.QuickSight.Model.AnalysisSearchFilter>(this.Filter);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.SearchAnalysesRequest();
        ...
        private Amazon.QuickSight.Model.SearchAnalysesResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.SearchAnalysesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "SearchAnalyses");
            try
            {
                #if DESKTOP
                return client.SearchAnalyses(request);
                #elif CORECLR
                return client.SearchAnalysesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AwsAccountId { get; set; }
            public List<Amazon.QuickSight.Model.AnalysisSearchFilter> Filter { get; set; }
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.SearchAnalysesResponse, SearchQSAnalysisCmdlet, object> Select { get; set; } =
