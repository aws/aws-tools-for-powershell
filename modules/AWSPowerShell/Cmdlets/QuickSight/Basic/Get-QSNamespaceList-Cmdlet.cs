...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.NamespaceInfoV2 or Amazon.QuickSight.Model.ListNamespacesResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListNamespacesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
