...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight ListNamespaces API operation.", Operation = new[] {"ListNamespaces"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListNamespacesResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.NamespaceInfoV2 or Amazon.QuickSight.Model.ListNamespacesResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.NamespaceInfoV2 objects.",
        "The service call response (type Amazon.QuickSight.Model.ListNamespacesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQSNamespaceListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID for the Amazon Web Services account that contains the Quick Sight namespaces
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListNamespacesResponse, GetQSNamespaceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListNamespacesRequest();
        ...
        private Amazon.QuickSight.Model.ListNamespacesResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListNamespacesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListNamespaces");
            try
            {
                return client.ListNamespacesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListNamespacesResponse, GetQSNamespaceListCmdlet, object> Select { get; set; } =
