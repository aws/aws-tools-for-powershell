...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// CLI syntax:
    /// </para><para><code>aws quicksight update-data-source \</code></para><para><code>--aws-account-id=111122223333 \</code></para><para><code>--data-source-id=unique-data-source-id \</code></para><para><code>--name='My Data Source' \</code></para><para><code>--data-source-parameters='{"PostgreSqlParameters":{"Host":"my-db-host.example.com","Port":1234,"Database":"my-db"}}'
    /// \</code></para><para><code>--credentials='{"CredentialPair":{"Username":"username","Password":"password"}}</code></para>
    /// </summary>
    [Cmdlet("Update", "QSDataSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateDataSourceResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateDataSource API operation.", Operation = new[] {"UpdateDataSource"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateDataSourceResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateDataSourceResponse",
    ...
    public partial class UpdateQSDataSourceCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSDataSource (UpdateDataSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateDataSourceResponse, UpdateQSDataSourceCmdlet>(Select) ??
        ...
        private Amazon.QuickSight.Model.UpdateDataSourceResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateDataSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateDataSource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? SslProperties_DisableSsl { get; set; }
            public System.String VpcConnectionProperties_VpcConnectionArn { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateDataSourceResponse, UpdateQSDataSourceCmdlet, object> Select { get; set; } =
