...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight UpdateTemplatePermissions API operation.", Operation = new[] {"UpdateTemplatePermissions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse object containing multiple properties."
    )]
    public partial class UpdateQSTemplatePermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of resource permissions to be granted on the template. </para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of resource permissions to be revoked from the template. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSTemplatePermission (UpdateTemplatePermissions)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse, UpdateQSTemplatePermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateTemplatePermissionsRequest();
        ...
        private Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateTemplatePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateTemplatePermissions");
            try
            {
                return client.UpdateTemplatePermissionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateTemplatePermissionsResponse, UpdateQSTemplatePermissionCmdlet, object> Select { get; set; } =
