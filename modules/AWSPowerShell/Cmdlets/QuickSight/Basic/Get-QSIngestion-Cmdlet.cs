...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Get", "QSIngestion")]
    [OutputType("Amazon.QuickSight.Model.Ingestion")]
    ...
    public partial class GetQSIngestionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeIngestionResponse, GetQSIngestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeIngestionRequest();
        ...
        private Amazon.QuickSight.Model.DescribeIngestionResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeIngestionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeIngestion");
            try
            {
                #if DESKTOP
                return client.DescribeIngestion(request);
                #elif CORECLR
                return client.DescribeIngestionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DataSetId { get; set; }
            public System.String IngestionId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeIngestionResponse, GetQSIngestionCmdlet, object> Select { get; set; } =
