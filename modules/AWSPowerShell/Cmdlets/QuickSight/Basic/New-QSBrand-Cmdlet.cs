...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class NewQSBrandCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A map of the key-value pairs that are assigned to the brand.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.QuickSight.Model.CreateBrandResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateBrandRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateBrand(request);
                #elif CORECLR
                return client.CreateBrandAsync(request).GetAwaiter().GetResult();
                #else
