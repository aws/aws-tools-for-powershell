...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight CreateBrand API operation.", Operation = new[] {"CreateBrand"}, SelectReturnType = typeof(Amazon.QuickSight.Model.CreateBrandResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.CreateBrandResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.CreateBrandResponse object containing multiple properties."
    )]
    public partial class NewQSBrandCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A map of the key-value pairs that are assigned to the brand.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.CreateBrandResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.CreateBrandResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-QSBrand (CreateBrand)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CreateBrandResponse, NewQSBrandCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.CreateBrandRequest();
        ...
        private Amazon.QuickSight.Model.CreateBrandResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateBrandRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "CreateBrand");
            try
            {
                return client.CreateBrandAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QuickSight.Model.CreateBrandResponse, NewQSBrandCmdlet, object> Select { get; set; } =
