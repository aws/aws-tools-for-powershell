...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// <para>
    /// CLI syntax:
    /// </para><para><code />aws quicksight update-iam-policy-assignment --aws-account-id=111122223333
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateIAMPolicyAssignmentResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateIAMPolicyAssignmentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSIAMPolicyAssignmentCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS account ID that contains the IAM policy assignment.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>QuickSight users and/or groups that you want to assign to the specified IAM policy.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Identities")]
        ...
        /// <summary>
        /// <para>
        /// <para>An IAM policy ARN that will be applied to specified QuickSight users and groups in
        ...
        private Amazon.QuickSight.Model.UpdateIAMPolicyAssignmentResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateIAMPolicyAssignmentRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateIAMPolicyAssignment(request);
                #elif CORECLR
                return client.UpdateIAMPolicyAssignmentAsync(request).GetAwaiter().GetResult();
                #else
