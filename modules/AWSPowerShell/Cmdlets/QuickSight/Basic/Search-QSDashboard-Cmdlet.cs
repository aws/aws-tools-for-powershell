...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class SearchQSDashboardCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// "Value": "arn:aws:quicksight:us-east-1:1:user/default/UserName1" } ]</c></para><para />
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Filters")]
        public Amazon.QuickSight.Model.DashboardSearchFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-QSDashboard (SearchDashboards)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.SearchDashboardsResponse, SearchQSDashboardCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.QuickSight.Model.DashboardSearchFilter>(this.Filter);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.SearchDashboardsRequest();
        ...
        private Amazon.QuickSight.Model.SearchDashboardsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.SearchDashboardsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "SearchDashboards");
            try
            {
                return client.SearchDashboardsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AwsAccountId { get; set; }
            public List<Amazon.QuickSight.Model.DashboardSearchFilter> Filter { get; set; }
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.SearchDashboardsResponse, SearchQSDashboardCmdlet, object> Select { get; set; } =
