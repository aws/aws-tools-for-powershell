...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class UpdateQSActionConnectorPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The permissions to grant to users and groups for this action connector.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The permissions to revoke from users and groups for this action connector.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.QuickSight.Model.UpdateActionConnectorPermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateActionConnectorPermissionsRequest request)
        {
            ...
            try
            {
                return client.UpdateActionConnectorPermissionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
