...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight CreateGroupMembership API operation.", Operation = new[] {"CreateGroupMembership"}, SelectReturnType = typeof(Amazon.QuickSight.Model.CreateGroupMembershipResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.GroupMember or Amazon.QuickSight.Model.CreateGroupMembershipResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.GroupMember object.",
        "The service call response (type Amazon.QuickSight.Model.CreateGroupMembershipResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewQSGroupMembershipCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-QSGroupMembership (CreateGroupMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.CreateGroupMembershipResponse, NewQSGroupMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.CreateGroupMembershipRequest();
        ...
        private Amazon.QuickSight.Model.CreateGroupMembershipResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateGroupMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "CreateGroupMembership");
            try
            {
                return client.CreateGroupMembershipAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemberName { get; set; }
            public System.String Namespace { get; set; }
            public System.Func<Amazon.QuickSight.Model.CreateGroupMembershipResponse, NewQSGroupMembershipCmdlet, object> Select { get; set; } =
