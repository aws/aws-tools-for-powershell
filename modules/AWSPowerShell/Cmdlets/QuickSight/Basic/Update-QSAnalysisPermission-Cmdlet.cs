...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateAnalysisPermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateAnalysisPermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSAnalysisPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        private Amazon.QuickSight.Model.UpdateAnalysisPermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateAnalysisPermissionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateAnalysisPermissions(request);
                #elif CORECLR
                return client.UpdateAnalysisPermissionsAsync(request).GetAwaiter().GetResult();
                #else
