...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class RemoveQSIdentityPropagationConfigCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the Amazon Web Services account that you want to delete an identity propagation
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Amazon Web Services service that you want to delete the associated
        /// access scopes and authorized targets from.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QuickSight.Model.DeleteIdentityPropagationConfigResponse).
        /// Specifying the name of a property of type Amazon.QuickSight.Model.DeleteIdentityPropagationConfigResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSIdentityPropagationConfig (DeleteIdentityPropagationConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteIdentityPropagationConfigResponse, RemoveQSIdentityPropagationConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteIdentityPropagationConfigRequest();
        ...
        private Amazon.QuickSight.Model.DeleteIdentityPropagationConfigResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteIdentityPropagationConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteIdentityPropagationConfig");
            try
            {
                #if DESKTOP
                return client.DeleteIdentityPropagationConfig(request);
                #elif CORECLR
                return client.DeleteIdentityPropagationConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public Amazon.QuickSight.ServiceType Service { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteIdentityPropagationConfigResponse, RemoveQSIdentityPropagationConfigCmdlet, object> Select { get; set; } =
