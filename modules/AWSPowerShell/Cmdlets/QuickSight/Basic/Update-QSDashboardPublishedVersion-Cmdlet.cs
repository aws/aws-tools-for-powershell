...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class UpdateQSDashboardPublishedVersionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSDashboardPublishedVersion (UpdateDashboardPublishedVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateDashboardPublishedVersionResponse, UpdateQSDashboardPublishedVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateDashboardPublishedVersionRequest();
        ...
        private Amazon.QuickSight.Model.UpdateDashboardPublishedVersionResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateDashboardPublishedVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateDashboardPublishedVersion");
            try
            {
                #if DESKTOP
                return client.UpdateDashboardPublishedVersion(request);
                #elif CORECLR
                return client.UpdateDashboardPublishedVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DashboardId { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateDashboardPublishedVersionResponse, UpdateQSDashboardPublishedVersionCmdlet, object> Select { get; set; } =
