...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.Group or Amazon.QuickSight.Model.SearchGroupsResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.SearchGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class FindQSGroupCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The structure for the search filters that you want to apply to your search.</para><para />
