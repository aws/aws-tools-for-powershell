...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Get", "QSThemeVersionList")]
    [OutputType("Amazon.QuickSight.Model.ThemeVersionSummary")]
    [AWSCmdlet("Calls the Amazon QuickSight ListThemeVersions API operation.", Operation = new[] {"ListThemeVersions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListThemeVersionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.ThemeVersionSummary or Amazon.QuickSight.Model.ListThemeVersionsResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.ThemeVersionSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.ListThemeVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSThemeVersionListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThemeVersionSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListThemeVersionsResponse, GetQSThemeVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListThemeVersionsRequest();
        ...
        private Amazon.QuickSight.Model.ListThemeVersionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListThemeVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListThemeVersions");
            try
            {
                #if DESKTOP
                return client.ListThemeVersions(request);
                #elif CORECLR
                return client.ListThemeVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ThemeId { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListThemeVersionsResponse, GetQSThemeVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThemeVersionSummaryList;
        }
