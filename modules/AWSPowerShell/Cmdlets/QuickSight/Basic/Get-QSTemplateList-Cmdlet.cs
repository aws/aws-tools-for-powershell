...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// <para>
    /// CLI syntax:
    /// </para><para><code>aws quicksight list-templates --aws-account-id 111122223333 --max-results 1
    /// —next-token AYADeJuxwOypAndSoOn</code></para><br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "QSTemplateList")]
    [OutputType("Amazon.QuickSight.Model.TemplateSummary")]
    ...
    public partial class GetQSTemplateListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TemplateSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListTemplatesResponse, GetQSTemplateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListTemplatesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TemplateSummaryList.Count;
        ...
        private Amazon.QuickSight.Model.ListTemplatesResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListTemplatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListTemplates");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListTemplatesResponse, GetQSTemplateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TemplateSummaryList;
        }
