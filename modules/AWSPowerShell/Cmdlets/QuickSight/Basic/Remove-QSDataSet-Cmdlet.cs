...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteDataSet API operation.", Operation = new[] {"DeleteDataSet"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DeleteDataSetResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteDataSetResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteDataSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQSDataSetCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSDataSet (DeleteDataSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteDataSetResponse, RemoveQSDataSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteDataSetRequest();
        ...
        private Amazon.QuickSight.Model.DeleteDataSetResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteDataSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteDataSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String DataSetId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteDataSetResponse, RemoveQSDataSetCmdlet, object> Select { get; set; } =
