...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight ListDataSets API operation.", Operation = new[] {"ListDataSets"}, SelectReturnType = typeof(Amazon.QuickSight.Model.ListDataSetsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DataSetSummary or Amazon.QuickSight.Model.ListDataSetsResponse",
        "This cmdlet returns a collection of Amazon.QuickSight.Model.DataSetSummary objects.",
        "The service call response (type Amazon.QuickSight.Model.ListDataSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSDataSetListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.ListDataSetsResponse, GetQSDataSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QuickSight.Model.ListDataSetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DataSetSummaries?.Count ?? 0;
        ...
        private Amazon.QuickSight.Model.ListDataSetsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.ListDataSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "ListDataSets");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QuickSight.Model.ListDataSetsResponse, GetQSDataSetListCmdlet, object> Select { get; set; } =
