...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class NewQSActionConnectorCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// access this action connector and what operations they can perform.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Permissions")]
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags to apply to the action connector for resource management and organization.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.QuickSight.Model.CreateActionConnectorResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.CreateActionConnectorRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateActionConnector(request);
                #elif CORECLR
                return client.CreateActionConnectorAsync(request).GetAwaiter().GetResult();
                #else
