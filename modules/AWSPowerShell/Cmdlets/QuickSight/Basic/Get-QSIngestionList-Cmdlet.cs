...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.Ingestion or Amazon.QuickSight.Model.ListIngestionsResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListIngestionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
