...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    public partial class RemoveQSResourceTagCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The keys of the key-value pairs for the resource tag or tags assigned to the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UntagResourceResponse, RemoveQSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UntagResourceRequest();
        ...
        private Amazon.QuickSight.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QuickSight.Model.UntagResourceResponse, RemoveQSResourceTagCmdlet, object> Select { get; set; } =
