...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse object containing multiple properties."
    )]
    public partial class RemoveQSUserByPrincipalIdCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        private Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteUserByPrincipalIdRequest request)
        {
            ...
            try
            {
                return client.DeleteUserByPrincipalIdAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
