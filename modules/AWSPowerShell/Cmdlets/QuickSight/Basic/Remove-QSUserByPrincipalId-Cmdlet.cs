...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteUserByPrincipalId API operation.", Operation = new[] {"DeleteUserByPrincipalId"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQSUserByPrincipalIdCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse, RemoveQSUserByPrincipalIdCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Namespace { get; set; }
            public System.String PrincipalId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteUserByPrincipalIdResponse, RemoveQSUserByPrincipalIdCmdlet, object> Select { get; set; } =
