...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSFolderPermission", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.UpdateFolderPermissionsResponse")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateFolderPermissions API operation.", Operation = new[] {"UpdateFolderPermissions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateFolderPermissionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.UpdateFolderPermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.UpdateFolderPermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSFolderPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSFolderPermission (UpdateFolderPermissions)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateFolderPermissionsResponse, UpdateQSFolderPermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateFolderPermissionsRequest();
        ...
        private Amazon.QuickSight.Model.UpdateFolderPermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateFolderPermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateFolderPermissions");
            try
            {
                #if DESKTOP
                return client.UpdateFolderPermissions(request);
                #elif CORECLR
                return client.UpdateFolderPermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QuickSight.Model.UpdateFolderPermissionsResponse, UpdateQSFolderPermissionCmdlet, object> Select { get; set; } =
