...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Get", "QSFolder")]
    [OutputType("Amazon.QuickSight.Model.Folder")]
    ...
    public partial class GetQSFolderCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Folder";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeFolderResponse, GetQSFolderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeFolderRequest();
        ...
        private Amazon.QuickSight.Model.DescribeFolderResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeFolderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeFolder");
            try
            {
                #if DESKTOP
                return client.DescribeFolder(request);
                #elif CORECLR
                return client.DescribeFolderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String FolderId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeFolderResponse, GetQSFolderCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Folder;
        }
