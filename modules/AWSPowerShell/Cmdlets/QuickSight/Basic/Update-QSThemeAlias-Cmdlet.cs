...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    /// </summary>
    [Cmdlet("Update", "QSThemeAlias", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QuickSight.Model.ThemeAlias")]
    [AWSCmdlet("Calls the Amazon QuickSight UpdateThemeAlias API operation.", Operation = new[] {"UpdateThemeAlias"}, SelectReturnType = typeof(Amazon.QuickSight.Model.UpdateThemeAliasResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.ThemeAlias or Amazon.QuickSight.Model.UpdateThemeAliasResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.ThemeAlias object.",
        "The service call response (type Amazon.QuickSight.Model.UpdateThemeAliasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateQSThemeAliasCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-QSThemeAlias (UpdateThemeAlias)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.UpdateThemeAliasResponse, UpdateQSThemeAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.UpdateThemeAliasRequest();
        ...
        private Amazon.QuickSight.Model.UpdateThemeAliasResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.UpdateThemeAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "UpdateThemeAlias");
            try
            {
                #if DESKTOP
                return client.UpdateThemeAlias(request);
                #elif CORECLR
                return client.UpdateThemeAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ThemeId { get; set; }
            public System.Int64? ThemeVersionNumber { get; set; }
            public System.Func<Amazon.QuickSight.Model.UpdateThemeAliasResponse, UpdateQSThemeAliasCmdlet, object> Select { get; set; } =
