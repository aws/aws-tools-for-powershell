...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteTemplateAlias API operation.", Operation = new[] {"DeleteTemplateAlias"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DeleteTemplateAliasResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DeleteTemplateAliasResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DeleteTemplateAliasResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQSTemplateAliasCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QSTemplateAlias (DeleteTemplateAlias)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DeleteTemplateAliasResponse, RemoveQSTemplateAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DeleteTemplateAliasRequest();
        ...
        private Amazon.QuickSight.Model.DeleteTemplateAliasResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DeleteTemplateAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DeleteTemplateAlias");
            try
            {
                #if DESKTOP
                return client.DeleteTemplateAlias(request);
                #elif CORECLR
                return client.DeleteTemplateAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AwsAccountId { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DeleteTemplateAliasResponse, RemoveQSTemplateAliasCmdlet, object> Select { get; set; } =
