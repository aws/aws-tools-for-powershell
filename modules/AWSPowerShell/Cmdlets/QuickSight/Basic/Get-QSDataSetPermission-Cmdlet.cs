...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DescribeDataSetPermissions API operation.", Operation = new[] {"DescribeDataSetPermissions"}, SelectReturnType = typeof(Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse))]
    [AWSCmdletOutput("Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse",
        "This cmdlet returns an Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQSDataSetPermissionCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse, GetQSDataSetPermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QuickSight.Model.DescribeDataSetPermissionsRequest();
        ...
        private Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse CallAWSServiceOperation(IAmazonQuickSight client, Amazon.QuickSight.Model.DescribeDataSetPermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QuickSight", "DescribeDataSetPermissions");
            try
            {
                #if DESKTOP
                return client.DescribeDataSetPermissions(request);
                #elif CORECLR
                return client.DescribeDataSetPermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AwsAccountId { get; set; }
            public System.String DataSetId { get; set; }
            public System.Func<Amazon.QuickSight.Model.DescribeDataSetPermissionsResponse, GetQSDataSetPermissionCmdlet, object> Select { get; set; } =
