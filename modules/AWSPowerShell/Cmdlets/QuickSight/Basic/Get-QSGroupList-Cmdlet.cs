...
{
    /// <summary>
    /// Lists all user groups in Amazon Quick Sight.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.QuickSight.Model.Group or Amazon.QuickSight.Model.ListGroupsResponse",
        ...
        "The service call response (type Amazon.QuickSight.Model.ListGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQSGroupListCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GroupList";
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GroupList?.Count ?? 0;
