...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Domains EnableDomainTransferLock API operation.", Operation = new[] {"EnableDomainTransferLock"}, SelectReturnType = typeof(Amazon.Route53Domains.Model.EnableDomainTransferLockResponse))]
    [AWSCmdletOutput("System.String or Amazon.Route53Domains.Model.EnableDomainTransferLockResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Route53Domains.Model.EnableDomainTransferLockResponse) can be returned by specifying '-Select *'."
    )]
    public partial class EnableR53DDomainTransferLockCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.EnableDomainTransferLockResponse, EnableR53DDomainTransferLockCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.EnableDomainTransferLockResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.EnableDomainTransferLockRequest request)
        {
            ...
            try
            {
                return client.EnableDomainTransferLockAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.EnableDomainTransferLockResponse, EnableR53DDomainTransferLockCmdlet, object> Select { get; set; } =
