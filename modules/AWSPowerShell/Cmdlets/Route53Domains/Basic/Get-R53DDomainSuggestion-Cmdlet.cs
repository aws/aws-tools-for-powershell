...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class GetR53DDomainSuggestionCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If <c>OnlyAvailable</c> is <c>true</c>, Route 53 returns only domain names that are
        ...
        /// the domain is available, you can call <c>checkDomainAvailability</c> for each suggestion.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Route53Domains.Model.GetDomainSuggestionsResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.GetDomainSuggestionsRequest request)
        {
            ...
            try
            {
                return client.GetDomainSuggestionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
