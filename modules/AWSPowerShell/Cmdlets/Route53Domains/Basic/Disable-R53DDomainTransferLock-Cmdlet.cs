...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    /// notified by email.
    /// </summary>
    [Cmdlet("Disable", "R53DDomainTransferLock", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class DisableR53DDomainTransferLockCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-R53DDomainTransferLock (DisableDomainTransferLock)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.DisableDomainTransferLockResponse, DisableR53DDomainTransferLockCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Domains.Model.DisableDomainTransferLockRequest();
        ...
        private Amazon.Route53Domains.Model.DisableDomainTransferLockResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.DisableDomainTransferLockRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Domains", "DisableDomainTransferLock");
            try
            {
                return client.DisableDomainTransferLockAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.DisableDomainTransferLockResponse, DisableR53DDomainTransferLockCmdlet, object> Select { get; set; } =
