...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class GetR53DBillingRecordCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BillingRecords";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.ViewBillingResponse, GetR53DBillingRecordCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.DateTime? Start { get; set; }
            public System.Func<Amazon.Route53Domains.Model.ViewBillingResponse, GetR53DBillingRecordCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BillingRecords;
        }
