...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Route 53 Domains UpdateTagsForDomain API operation.", Operation = new[] {"UpdateTagsForDomain"}, SelectReturnType = typeof(Amazon.Route53Domains.Model.UpdateTagsForDomainResponse))]
    [AWSCmdletOutput("None or Amazon.Route53Domains.Model.UpdateTagsForDomainResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Route53Domains.Model.UpdateTagsForDomainResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateR53DTagsForDomainCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// key that already exists, the corresponding value will be replaced.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.UpdateTagsForDomainResponse, UpdateR53DTagsForDomainCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.UpdateTagsForDomainResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.UpdateTagsForDomainRequest request)
        {
            ...
            try
            {
                return client.UpdateTagsForDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Route53Domains.Model.UpdateTagsForDomainResponse, UpdateR53DTagsForDomainCmdlet, object> Select { get; set; } =
