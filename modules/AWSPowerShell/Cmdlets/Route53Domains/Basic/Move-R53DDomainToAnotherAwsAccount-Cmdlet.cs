...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class MoveR53DDomainToAnotherAwsAccountCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The account ID of the AWS account that you want to transfer the domain to, for example,
        /// <code>111122223333</code>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the domain that you want to transfer from the current AWS account to another
        /// account.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Route53Domains.Model.TransferDomainToAnotherAwsAccountResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.TransferDomainToAnotherAwsAccountRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.TransferDomainToAnotherAwsAccount(request);
                #elif CORECLR
                return client.TransferDomainToAnotherAwsAccountAsync(request).GetAwaiter().GetResult();
                #else
