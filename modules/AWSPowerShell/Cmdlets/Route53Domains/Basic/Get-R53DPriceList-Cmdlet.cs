...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [AWSCmdletOutput("Amazon.Route53Domains.Model.DomainPrice or Amazon.Route53Domains.Model.ListPricesResponse",
        ...
        "The service call response (type Amazon.Route53Domains.Model.ListPricesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53DPriceListCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Tld' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.Tld;
            }
        ...
        private Amazon.Route53Domains.Model.ListPricesResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.ListPricesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListPrices(request);
                #elif CORECLR
                return client.ListPricesAsync(request).GetAwaiter().GetResult();
                #else
