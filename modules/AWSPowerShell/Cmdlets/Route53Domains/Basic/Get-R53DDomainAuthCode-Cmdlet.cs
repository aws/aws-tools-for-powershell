...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class GetR53DDomainAuthCodeCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "AuthCode";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.RetrieveDomainAuthCodeResponse, GetR53DDomainAuthCodeCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.RetrieveDomainAuthCodeResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.RetrieveDomainAuthCodeRequest request)
        {
            ...
            try
            {
                return client.RetrieveDomainAuthCodeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.RetrieveDomainAuthCodeResponse, GetR53DDomainAuthCodeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AuthCode;
        }
