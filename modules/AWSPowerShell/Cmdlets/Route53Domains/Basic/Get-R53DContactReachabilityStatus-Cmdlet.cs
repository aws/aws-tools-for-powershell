...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Domains GetContactReachabilityStatus API operation.", Operation = new[] {"GetContactReachabilityStatus"}, SelectReturnType = typeof(Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse))]
    [AWSCmdletOutput("Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse",
        "This cmdlet returns an Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse object containing multiple properties."
    )]
    public partial class GetR53DContactReachabilityStatusCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse, GetR53DContactReachabilityStatusCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.GetContactReachabilityStatusRequest request)
        {
            ...
            try
            {
                return client.GetContactReachabilityStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.GetContactReachabilityStatusResponse, GetR53DContactReachabilityStatusCmdlet, object> Select { get; set; } =
