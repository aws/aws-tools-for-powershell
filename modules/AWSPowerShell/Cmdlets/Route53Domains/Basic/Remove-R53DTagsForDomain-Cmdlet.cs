...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Route 53 Domains DeleteTagsForDomain API operation.", Operation = new[] {"DeleteTagsForDomain"}, SelectReturnType = typeof(Amazon.Route53Domains.Model.DeleteTagsForDomainResponse))]
    [AWSCmdletOutput("None or Amazon.Route53Domains.Model.DeleteTagsForDomainResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Route53Domains.Model.DeleteTagsForDomainResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveR53DTagsForDomainCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.DeleteTagsForDomainResponse, RemoveR53DTagsForDomainCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.TagsToDelete == null && ParameterWasBound(nameof(this.TagsToDelete)))
            {
                WriteWarning("You are passing $null as a value for parameter TagsToDelete which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.Route53Domains.Model.DeleteTagsForDomainResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.DeleteTagsForDomainRequest request)
        {
            ...
            try
            {
                return client.DeleteTagsForDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Route53Domains.Model.DeleteTagsForDomainResponse, RemoveR53DTagsForDomainCmdlet, object> Select { get; set; } =
