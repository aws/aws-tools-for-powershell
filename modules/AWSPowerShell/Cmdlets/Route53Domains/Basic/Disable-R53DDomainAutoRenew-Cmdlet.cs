...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class DisableR53DDomainAutoRenewCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.DisableDomainAutoRenewResponse, DisableR53DDomainAutoRenewCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.DisableDomainAutoRenewResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.DisableDomainAutoRenewRequest request)
        {
            ...
            try
            {
                return client.DisableDomainAutoRenewAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.DisableDomainAutoRenewResponse, DisableR53DDomainAutoRenewCmdlet, object> Select { get; set; } =
