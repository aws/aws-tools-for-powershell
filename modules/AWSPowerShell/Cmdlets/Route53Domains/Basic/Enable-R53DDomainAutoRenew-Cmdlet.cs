...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Route 53 Domains EnableDomainAutoRenew API operation.", Operation = new[] {"EnableDomainAutoRenew"}, SelectReturnType = typeof(Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse))]
    [AWSCmdletOutput("None or Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse) be returned by specifying '-Select *'."
    )]
    public partial class EnableR53DDomainAutoRenewCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse, EnableR53DDomainAutoRenewCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.EnableDomainAutoRenewRequest request)
        {
            ...
            try
            {
                return client.EnableDomainAutoRenewAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Route53Domains.Model.EnableDomainAutoRenewResponse, EnableR53DDomainAutoRenewCmdlet, object> Select { get; set; } =
