...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    public partial class InvokeR53DDomainTransferCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Contains details for the host and glue IP addresses.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// the phrase "REDACTED FOR PRIVACY", or "On behalf of &lt;domain name&gt; owner.".</para><note><para>While some domains may allow different privacy settings per contact, we recommend
        /// specifying the same privacy setting for all contacts.</para></note><para>Default: <c>true</c></para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Domains.Model.TransferDomainResponse, InvokeR53DDomainTransferCmdlet>(Select) ??
        ...
        private Amazon.Route53Domains.Model.TransferDomainResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.TransferDomainRequest request)
        {
            ...
            try
            {
                return client.TransferDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TechContact_State { get; set; }
            public System.String TechContact_ZipCode { get; set; }
            public System.Func<Amazon.Route53Domains.Model.TransferDomainResponse, InvokeR53DDomainTransferCmdlet, object> Select { get; set; } =
