...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    /// </summary>
    [Cmdlet("Get", "COLicenseRecommendation")]
    [OutputType("Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse")]
    [AWSCmdlet("Calls the AWS Compute Optimizer GetLicenseRecommendations API operation.", Operation = new[] {"GetLicenseRecommendations"}, SelectReturnType = typeof(Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse",
        "This cmdlet returns an Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCOLicenseRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse, GetCOLicenseRecommendationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsRequest();
        ...
        private Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse CallAWSServiceOperation(IAmazonComputeOptimizer client, Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Compute Optimizer", "GetLicenseRecommendations");
            try
            {
                #if DESKTOP
                return client.GetLicenseRecommendations(request);
                #elif CORECLR
                return client.GetLicenseRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ComputeOptimizer.Model.GetLicenseRecommendationsResponse, GetCOLicenseRecommendationCmdlet, object> Select { get; set; } =
