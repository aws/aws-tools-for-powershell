...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    public partial class ExportCOLambdaFunctionRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the AWS accounts for which to export Lambda function recommendations.</para><para>If your account is the management account of an organization, use this parameter to
        ...
        /// <summary>
        /// <para>
        /// <para>An array of objects that describe a filter to export a more specific set of Lambda
