...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    public partial class GetCOAutoScalingGroupRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the AWS account for which to return Auto Scaling group recommendations.</para><para>If your account is the management account of an organization, use this parameter to
