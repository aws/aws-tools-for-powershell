...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    public partial class GetCOEBSVolumeRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the AWS accounts for which to return volume recommendations.</para><para>If your account is the management account of an organization, use this parameter to
        /// specify the member accounts for which you want to return volume recommendations.</para><para>Only one account ID can be specified per request.</para>
        /// </para>
        /// </summary>
