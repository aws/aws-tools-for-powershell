...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Export", "COIdleRecommendation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse")]
    [AWSCmdlet("Calls the AWS Compute Optimizer ExportIdleRecommendations API operation.", Operation = new[] {"ExportIdleRecommendations"}, SelectReturnType = typeof(Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse",
        "This cmdlet returns an Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse object containing multiple properties."
    )]
    public partial class ExportCOIdleRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The Amazon Web Services account IDs for the export idle resource recommendations.
        ...
        /// <summary>
        /// <para>
        /// <para>The format of the export file. The CSV file is the only export file format currently
        /// supported.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>An array of objects to specify a filter that exports a more specific set of idle resource
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse).
        /// Specifying the name of a property of type Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Export-COIdleRecommendation (ExportIdleRecommendations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse, ExportCOIdleRecommendationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsRequest();
        ...
        private Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse CallAWSServiceOperation(IAmazonComputeOptimizer client, Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Compute Optimizer", "ExportIdleRecommendations");
            try
            {
                #if DESKTOP
                return client.ExportIdleRecommendations(request);
                #elif CORECLR
                return client.ExportIdleRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String S3DestinationConfig_Bucket { get; set; }
            public System.String S3DestinationConfig_KeyPrefix { get; set; }
            public System.Func<Amazon.ComputeOptimizer.Model.ExportIdleRecommendationsResponse, ExportCOIdleRecommendationCmdlet, object> Select { get; set; } =
