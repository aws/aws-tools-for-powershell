...
namespace Amazon.PowerShell.Cmdlets.CO
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Export", "COEBSVolumeRecommendation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse")]
    [AWSCmdlet("Calls the AWS Compute Optimizer ExportEBSVolumeRecommendations API operation.", Operation = new[] {"ExportEBSVolumeRecommendations"}, SelectReturnType = typeof(Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse",
        "This cmdlet returns an Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ExportCOEBSVolumeRecommendationCmdlet : AmazonComputeOptimizerClientCmdlet, IExecutor
    {
        
        #region Parameter AccountId
        /// <summary>
        /// <para>
        /// <para>The IDs of the AWS accounts for which to export Amazon EBS volume recommendations.</para><para>If your account is the management account of an organization, use this parameter to
        ...
        /// <summary>
        /// <para>
        /// <para>An array of objects that describe a filter to export a more specific set of Amazon
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Export-COEBSVolumeRecommendation (ExportEBSVolumeRecommendations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse, ExportCOEBSVolumeRecommendationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsRequest();
        ...
        private Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse CallAWSServiceOperation(IAmazonComputeOptimizer client, Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Compute Optimizer", "ExportEBSVolumeRecommendations");
            try
            {
                #if DESKTOP
                return client.ExportEBSVolumeRecommendations(request);
                #elif CORECLR
                return client.ExportEBSVolumeRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String S3DestinationConfig_Bucket { get; set; }
            public System.String S3DestinationConfig_KeyPrefix { get; set; }
            public System.Func<Amazon.ComputeOptimizer.Model.ExportEBSVolumeRecommendationsResponse, ExportCOEBSVolumeRecommendationCmdlet, object> Select { get; set; } =
