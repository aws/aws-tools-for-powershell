...
namespace Amazon.PowerShell.Cmdlets.AMPUI
{
    ...
    [AWSCmdletOutput("Amazon.AmplifyUIBuilder.Model.Theme or Amazon.AmplifyUIBuilder.Model.CreateThemeResponse",
        ...
        "The service call response (type Amazon.AmplifyUIBuilder.Model.CreateThemeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewAMPUIThemeCmdlet : AmazonAmplifyUIBuilderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Describes the properties that can be overriden to customize an instance of the theme.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more key-value pairs to use when tagging the theme data.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>A list of key-value pairs that deﬁnes the properties of the theme.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
