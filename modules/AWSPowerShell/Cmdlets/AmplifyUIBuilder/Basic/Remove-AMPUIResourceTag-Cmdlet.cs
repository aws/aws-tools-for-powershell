...
namespace Amazon.PowerShell.Cmdlets.AMPUI
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMPUIResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAMPUIResourceTagCmdlet : AmazonAmplifyUIBuilderClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AmplifyUIBuilder.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPUIResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyUIBuilder.Model.UntagResourceResponse, RemoveAMPUIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyUIBuilder.Model.UntagResourceRequest();
        ...
        private Amazon.AmplifyUIBuilder.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAmplifyUIBuilder client, Amazon.AmplifyUIBuilder.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify UI Builder", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AmplifyUIBuilder.Model.UntagResourceResponse, RemoveAMPUIResourceTagCmdlet, object> Select { get; set; } =
