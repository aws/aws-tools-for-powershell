...
namespace Amazon.PowerShell.Cmdlets.AMPUI
{
    ...
    public partial class GetAMPUIThemeCmdlet : AmazonAmplifyUIBuilderClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AmplifyUIBuilder.Model.GetThemeResponse).
        /// Specifying the name of a property of type Amazon.AmplifyUIBuilder.Model.GetThemeResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AmplifyUIBuilder.Model.GetThemeResponse, GetAMPUIThemeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AmplifyUIBuilder.Model.GetThemeRequest();
        ...
        private Amazon.AmplifyUIBuilder.Model.GetThemeResponse CallAWSServiceOperation(IAmazonAmplifyUIBuilder client, Amazon.AmplifyUIBuilder.Model.GetThemeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify UI Builder", "GetTheme");
            try
            {
                return client.GetThemeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EnvironmentName { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.AmplifyUIBuilder.Model.GetThemeResponse, GetAMPUIThemeCmdlet, object> Select { get; set; } =
