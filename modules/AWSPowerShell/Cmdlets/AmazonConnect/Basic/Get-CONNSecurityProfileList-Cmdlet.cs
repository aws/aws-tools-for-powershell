...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [OutputType("Amazon.Connect.Model.SecurityProfileSummary")]
    [AWSCmdlet("Calls the Amazon Connect Service ListSecurityProfiles API operation.", Operation = new[] {"ListSecurityProfiles"})]
    [AWSCmdletOutput("Amazon.Connect.Model.SecurityProfileSummary",
        "This cmdlet returns a collection of SecurityProfileSummary objects.",
        "The service call response (type Amazon.Connect.Model.ListSecurityProfilesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetCONNSecurityProfileListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.ListSecurityProfilesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SecurityProfileSummaryList;
                        ...
                        int _receivedThisCall = response.SecurityProfileSummaryList.Count;
        ...
        private Amazon.Connect.Model.ListSecurityProfilesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListSecurityProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ListSecurityProfiles");
            try
            {
                #if DESKTOP
