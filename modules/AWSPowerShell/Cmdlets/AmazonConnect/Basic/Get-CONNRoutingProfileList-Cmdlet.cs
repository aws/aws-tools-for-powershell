...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service ListRoutingProfiles API operation.", Operation = new[] {"ListRoutingProfiles"})]
    [AWSCmdletOutput("Amazon.Connect.Model.RoutingProfileSummary",
        "This cmdlet returns a collection of RoutingProfileSummary objects.",
        "The service call response (type Amazon.Connect.Model.ListRoutingProfilesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetCONNRoutingProfileListCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Connect.Model.ListRoutingProfilesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.RoutingProfileSummaryList;
                        ...
                        int _receivedThisCall = response.RoutingProfileSummaryList.Count;
        ...
        private Amazon.Connect.Model.ListRoutingProfilesResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.ListRoutingProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "ListRoutingProfiles");
            try
            {
                #if DESKTOP
                return client.ListRoutingProfiles(request);
                #elif CORECLR
                return client.ListRoutingProfilesAsync(request).GetAwaiter().GetResult();
                #else
