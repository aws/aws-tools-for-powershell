...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service UpdateUserIdentityInfo API operation.", Operation = new[] {"UpdateUserIdentityInfo"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.Connect.Model.UpdateUserIdentityInfoResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCONNUserIdentityInfoCmdlet : AmazonConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CONNUserIdentityInfo (UpdateUserIdentityInfo)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Connect.Model.UpdateUserIdentityInfoRequest();
        ...
        private Amazon.Connect.Model.UpdateUserIdentityInfoResponse CallAWSServiceOperation(IAmazonConnect client, Amazon.Connect.Model.UpdateUserIdentityInfoRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Service", "UpdateUserIdentityInfo");
            try
            {
                #if DESKTOP
