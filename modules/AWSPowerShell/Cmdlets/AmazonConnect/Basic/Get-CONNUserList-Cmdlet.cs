...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service ListUsers API operation.", Operation = new[] {"ListUsers"})]
    [AWSCmdletOutput("Amazon.Connect.Model.UserSummary",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.UserSummaryList;
