...
namespace Amazon.PowerShell.Cmdlets.CONN
{
    ...
    [AWSCmdlet("Calls the Amazon Connect Service ListUserHierarchyGroups API operation.", Operation = new[] {"ListUserHierarchyGroups"})]
    [AWSCmdletOutput("Amazon.Connect.Model.HierarchyGroupSummary",
        "This cmdlet returns a collection of HierarchyGroupSummary objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.UserHierarchyGroupSummaryList;
