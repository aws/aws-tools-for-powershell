...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    /// </summary>
    [Cmdlet("Get", "FMSAppsListList")]
    [OutputType("Amazon.FMS.Model.AppsListDataSummary")]
    ...
    public partial class GetFMSAppsListListCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies whether the lists to retrieve are default lists owned by AWS Firewall Manager.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of objects that you want AWS Firewall Manager to return for this
        ...
        /// batch of objects.</para><para>If you don't specify this, AWS Firewall Manager returns all available objects.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AppsLists";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DefaultList' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FMS.Model.ListAppsListsResponse, GetFMSAppsListListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DefaultList;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FMS.Model.ListAppsListsRequest();
        ...
        private Amazon.FMS.Model.ListAppsListsResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.ListAppsListsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Firewall Management Service", "ListAppsLists");
            try
            {
                #if DESKTOP
                return client.ListAppsLists(request);
                #elif CORECLR
                return client.ListAppsListsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FMS.Model.ListAppsListsResponse, GetFMSAppsListListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AppsLists;
        }
