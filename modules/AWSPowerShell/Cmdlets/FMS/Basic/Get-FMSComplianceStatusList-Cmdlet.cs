...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service ListComplianceStatus API operation.", Operation = new[] {"ListComplianceStatus"}, SelectReturnType = typeof(Amazon.FMS.Model.ListComplianceStatusResponse))]
    [AWSCmdletOutput("Amazon.FMS.Model.PolicyComplianceStatus or Amazon.FMS.Model.ListComplianceStatusResponse",
        "This cmdlet returns a collection of Amazon.FMS.Model.PolicyComplianceStatus objects.",
        "The service call response (type Amazon.FMS.Model.ListComplianceStatusResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFMSComplianceStatusListCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the number of <c>PolicyComplianceStatus</c> objects that you want Firewall
        ...
        /// <summary>
        /// <para>
        /// <para>If you specify a value for <c>MaxResults</c> and you have more <c>PolicyComplianceStatus</c>
        ...
        /// information about another batch of <c>PolicyComplianceStatus</c> objects.</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PolicyComplianceStatusList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FMS.Model.ListComplianceStatusResponse, GetFMSComplianceStatusListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.PolicyComplianceStatusList?.Count ?? 0;
        ...
        private Amazon.FMS.Model.ListComplianceStatusResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.ListComplianceStatusRequest request)
        {
            ...
            try
            {
                return client.ListComplianceStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PolicyId { get; set; }
            public System.Func<Amazon.FMS.Model.ListComplianceStatusResponse, GetFMSComplianceStatusListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PolicyComplianceStatusList;
        }
