...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service GetPolicy API operation.", Operation = new[] {"GetPolicy"}, SelectReturnType = typeof(Amazon.FMS.Model.GetPolicyResponse))]
    [AWSCmdletOutput("Amazon.FMS.Model.GetPolicyResponse",
        "This cmdlet returns an Amazon.FMS.Model.GetPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFMSPolicyCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FMS.Model.GetPolicyResponse, GetFMSPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FMS.Model.GetPolicyRequest();
        ...
        private Amazon.FMS.Model.GetPolicyResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.GetPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Firewall Management Service", "GetPolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String PolicyId { get; set; }
            public System.Func<Amazon.FMS.Model.GetPolicyResponse, GetFMSPolicyCmdlet, object> Select { get; set; } =
