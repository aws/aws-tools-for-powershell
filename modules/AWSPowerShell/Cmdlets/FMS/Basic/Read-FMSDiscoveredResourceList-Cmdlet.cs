...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdletOutput("Amazon.FMS.Model.DiscoveredResource or Amazon.FMS.Model.ListDiscoveredResourcesResponse",
        ...
        "The service call response (type Amazon.FMS.Model.ListDiscoveredResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
