...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    public partial class WriteFMSProtocolListCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A map of previous version numbers to their corresponding protocol arrays.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>An array of protocols in the Firewall Manager protocols list.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.FMS.Model.PutProtocolsListResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.PutProtocolsListRequest request)
        {
            ...
            try
            {
                return client.PutProtocolsListAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
