...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    public partial class AddFMSAssociatedResourceCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ResourceSetIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ResourceSetIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceSetIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceSetIdentifier;
            }
        ...
        private Amazon.FMS.Model.BatchAssociateResourceResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.BatchAssociateResourceRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchAssociateResource(request);
                #elif CORECLR
                return client.BatchAssociateResourceAsync(request).GetAwaiter().GetResult();
                #else
