...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdletOutput("Amazon.FMS.Model.ThirdPartyFirewallFirewallPolicy or Amazon.FMS.Model.ListThirdPartyFirewallFirewallPoliciesResponse",
        ...
        "The service call response (type Amazon.FMS.Model.ListThirdPartyFirewallFirewallPoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
