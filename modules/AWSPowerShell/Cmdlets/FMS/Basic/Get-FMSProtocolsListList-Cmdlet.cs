...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdletOutput("Amazon.FMS.Model.ProtocolsListDataSummary or Amazon.FMS.Model.ListProtocolsListsResponse",
        ...
        "The service call response (type Amazon.FMS.Model.ListProtocolsListsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
