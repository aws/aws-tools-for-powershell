...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service ListMemberAccounts API operation.", Operation = new[] {"ListMemberAccounts"}, SelectReturnType = typeof(Amazon.FMS.Model.ListMemberAccountsResponse))]
    [AWSCmdletOutput("System.String or Amazon.FMS.Model.ListMemberAccountsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.FMS.Model.ListMemberAccountsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFMSMemberAccountListCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FMS.Model.ListMemberAccountsResponse, GetFMSMemberAccountListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FMS.Model.ListMemberAccountsResponse, GetFMSMemberAccountListCmdlet, object> Select { get; set; } =
