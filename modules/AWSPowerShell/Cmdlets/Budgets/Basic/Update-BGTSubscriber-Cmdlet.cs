...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Budgets UpdateSubscriber API operation.", Operation = new[] {"UpdateSubscriber"}, SelectReturnType = typeof(Amazon.Budgets.Model.UpdateSubscriberResponse))]
    [AWSCmdletOutput("None or Amazon.Budgets.Model.UpdateSubscriberResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Budgets.Model.UpdateSubscriberResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateBGTSubscriberCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>accountId</c> that is associated with the budget whose subscriber you want
        /// to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.UpdateSubscriberResponse, UpdateBGTSubscriberCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.NewSubscriber_Address == null && ParameterWasBound(nameof(this.NewSubscriber_Address)))
            {
                WriteWarning("You are passing $null as a value for parameter NewSubscriber_Address which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.NewSubscriber_SubscriptionType = this.NewSubscriber_SubscriptionType;
            #if MODULAR
            if (this.NewSubscriber_SubscriptionType == null && ParameterWasBound(nameof(this.NewSubscriber_SubscriptionType)))
            {
                WriteWarning("You are passing $null as a value for parameter NewSubscriber_SubscriptionType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            ...
            #if MODULAR
            if (this.OldSubscriber_Address == null && ParameterWasBound(nameof(this.OldSubscriber_Address)))
            {
                WriteWarning("You are passing $null as a value for parameter OldSubscriber_Address which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.OldSubscriber_SubscriptionType = this.OldSubscriber_SubscriptionType;
            #if MODULAR
            if (this.OldSubscriber_SubscriptionType == null && ParameterWasBound(nameof(this.OldSubscriber_SubscriptionType)))
            {
                WriteWarning("You are passing $null as a value for parameter OldSubscriber_SubscriptionType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var requestNewSubscriberIsNull = true;
            ...
            var requestOldSubscriberIsNull = true;
        ...
        private Amazon.Budgets.Model.UpdateSubscriberResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.UpdateSubscriberRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.UpdateSubscriberAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OldSubscriber_Address { get; set; }
            public Amazon.Budgets.SubscriptionType OldSubscriber_SubscriptionType { get; set; }
            public System.Func<Amazon.Budgets.Model.UpdateSubscriberResponse, UpdateBGTSubscriberCmdlet, object> Select { get; set; } =
