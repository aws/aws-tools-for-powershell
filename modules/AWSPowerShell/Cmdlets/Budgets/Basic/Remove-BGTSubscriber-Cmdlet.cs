...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Budgets DeleteSubscriber API operation.", Operation = new[] {"DeleteSubscriber"}, SelectReturnType = typeof(Amazon.Budgets.Model.DeleteSubscriberResponse))]
    [AWSCmdletOutput("None or Amazon.Budgets.Model.DeleteSubscriberResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Budgets.Model.DeleteSubscriberResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBGTSubscriberCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BGTSubscriber (DeleteSubscriber)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.DeleteSubscriberResponse, RemoveBGTSubscriberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Budgets.Model.DeleteSubscriberRequest();
        ...
        private Amazon.Budgets.Model.DeleteSubscriberResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DeleteSubscriberRequest request)
        {
            ...
            try
            {
                return client.DeleteSubscriberAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Subscriber_Address { get; set; }
            public Amazon.Budgets.SubscriptionType Subscriber_SubscriptionType { get; set; }
            public System.Func<Amazon.Budgets.Model.DeleteSubscriberResponse, RemoveBGTSubscriberCmdlet, object> Select { get; set; } =
