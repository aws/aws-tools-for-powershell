...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    /// </summary>
    [Cmdlet("Get", "BGTBudgetAction")]
    [OutputType("Amazon.Budgets.Model.DescribeBudgetActionResponse")]
    [AWSCmdlet("Calls the AWS Budgets DescribeBudgetAction API operation.", Operation = new[] {"DescribeBudgetAction"}, SelectReturnType = typeof(Amazon.Budgets.Model.DescribeBudgetActionResponse))]
    [AWSCmdletOutput("Amazon.Budgets.Model.DescribeBudgetActionResponse",
        "This cmdlet returns an Amazon.Budgets.Model.DescribeBudgetActionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBGTBudgetActionCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.DescribeBudgetActionResponse, GetBGTBudgetActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Budgets.Model.DescribeBudgetActionRequest();
        ...
        private Amazon.Budgets.Model.DescribeBudgetActionResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DescribeBudgetActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Budgets", "DescribeBudgetAction");
            try
            {
                #if DESKTOP
                return client.DescribeBudgetAction(request);
                #elif CORECLR
                return client.DescribeBudgetActionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ActionId { get; set; }
            public System.String BudgetName { get; set; }
            public System.Func<Amazon.Budgets.Model.DescribeBudgetActionResponse, GetBGTBudgetActionCmdlet, object> Select { get; set; } =
