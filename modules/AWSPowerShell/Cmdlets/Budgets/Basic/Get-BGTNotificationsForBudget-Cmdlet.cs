...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [AWSCmdlet("Calls the AWS Budgets DescribeNotificationsForBudget API operation.", Operation = new[] {"DescribeNotificationsForBudget"}, SelectReturnType = typeof(Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse))]
    [AWSCmdletOutput("Amazon.Budgets.Model.Notification or Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse",
        "This cmdlet returns a collection of Amazon.Budgets.Model.Notification objects.",
        "The service call response (type Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBGTNotificationsForBudgetCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse, GetBGTNotificationsForBudgetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Budgets.Model.DescribeNotificationsForBudgetRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Notifications?.Count ?? 0;
        ...
        private Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DescribeNotificationsForBudgetRequest request)
        {
            ...
            try
            {
                return client.DescribeNotificationsForBudgetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse, GetBGTNotificationsForBudgetCmdlet, object> Select { get; set; } =
