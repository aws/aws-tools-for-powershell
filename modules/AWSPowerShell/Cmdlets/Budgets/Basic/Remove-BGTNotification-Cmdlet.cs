...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Budgets DeleteNotification API operation.", Operation = new[] {"DeleteNotification"}, SelectReturnType = typeof(Amazon.Budgets.Model.DeleteNotificationResponse))]
    [AWSCmdletOutput("None or Amazon.Budgets.Model.DeleteNotificationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Budgets.Model.DeleteNotificationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBGTNotificationCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.DeleteNotificationResponse, RemoveBGTNotificationCmdlet>(Select) ??
        ...
        private Amazon.Budgets.Model.DeleteNotificationResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DeleteNotificationRequest request)
        {
            ...
            try
            {
                return client.DeleteNotificationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Double? Notification_Threshold { get; set; }
            public Amazon.Budgets.ThresholdType Notification_ThresholdType { get; set; }
            public System.Func<Amazon.Budgets.Model.DeleteNotificationResponse, RemoveBGTNotificationCmdlet, object> Select { get; set; } =
