...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    /// </summary>
    [Cmdlet("Get", "BGTResourceTag")]
    [OutputType("Amazon.Budgets.Model.ResourceTag")]
    ...
    public partial class GetBGTResourceTagCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Budgets.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.Budgets.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Budgets.Model.ListTagsForResourceResponse, GetBGTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Budgets.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Budgets.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Budgets", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.Budgets.Model.ListTagsForResourceResponse, GetBGTResourceTagCmdlet, object> Select { get; set; } =
