...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdletOutput("Amazon.Comprehend.Model.EndpointProperties or Amazon.Comprehend.Model.ListEndpointsResponse",
        ...
        "The service call response (type Amazon.Comprehend.Model.ListEndpointsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
