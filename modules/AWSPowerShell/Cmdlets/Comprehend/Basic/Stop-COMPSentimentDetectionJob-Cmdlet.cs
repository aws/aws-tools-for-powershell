...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    public partial class StopCOMPSentimentDetectionJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.StopSentimentDetectionJobResponse, StopCOMPSentimentDetectionJobCmdlet>(Select) ??
        ...
        private Amazon.Comprehend.Model.StopSentimentDetectionJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StopSentimentDetectionJobRequest request)
        {
            ...
            try
            {
                return client.StopSentimentDetectionJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.Comprehend.Model.StopSentimentDetectionJobResponse, StopCOMPSentimentDetectionJobCmdlet, object> Select { get; set; } =
