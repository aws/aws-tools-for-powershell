...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    public partial class RemoveCOMPDocumentClassifierCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DocumentClassifierArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.DeleteDocumentClassifierResponse, RemoveCOMPDocumentClassifierCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DocumentClassifierArn;
            }
        ...
        {
            public System.String DocumentClassifierArn { get; set; }
            public System.Func<Amazon.Comprehend.Model.DeleteDocumentClassifierResponse, RemoveCOMPDocumentClassifierCmdlet, object> Select { get; set; } =
