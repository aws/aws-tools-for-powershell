...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdletOutput("Amazon.Comprehend.Model.BatchDetectSyntaxResponse",
        "This cmdlet returns an Amazon.Comprehend.Model.BatchDetectSyntaxResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
