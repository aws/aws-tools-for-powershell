...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    /// </summary>
    [Cmdlet("Get", "COMPTargetedSentimentDetectionJobList")]
    [OutputType("Amazon.Comprehend.Model.TargetedSentimentDetectionJobProperties")]
    [AWSCmdlet("Calls the Amazon Comprehend ListTargetedSentimentDetectionJobs API operation.", Operation = new[] {"ListTargetedSentimentDetectionJobs"}, SelectReturnType = typeof(Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse))]
    [AWSCmdletOutput("Amazon.Comprehend.Model.TargetedSentimentDetectionJobProperties or Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse",
        "This cmdlet returns a collection of Amazon.Comprehend.Model.TargetedSentimentDetectionJobProperties objects.",
        "The service call response (type Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCOMPTargetedSentimentDetectionJobListCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TargetedSentimentDetectionJobPropertiesList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse, GetCOMPTargetedSentimentDetectionJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsRequest();
            
            
             // populate Filter
            var requestFilterIsNull = true;
            request.Filter = new Amazon.Comprehend.Model.TargetedSentimentDetectionJobFilter();
        ...
        private Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Comprehend", "ListTargetedSentimentDetectionJobs");
            try
            {
                #if DESKTOP
                return client.ListTargetedSentimentDetectionJobs(request);
                #elif CORECLR
                return client.ListTargetedSentimentDetectionJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Comprehend.Model.ListTargetedSentimentDetectionJobsResponse, GetCOMPTargetedSentimentDetectionJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TargetedSentimentDetectionJobPropertiesList;
        }
