...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    public partial class FindCOMPEntityBatchCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.BatchDetectEntitiesResponse, FindCOMPEntityBatchCmdlet>(Select) ??
        ...
        private Amazon.Comprehend.Model.BatchDetectEntitiesResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.BatchDetectEntitiesRequest request)
        {
            ...
            try
            {
                return client.BatchDetectEntitiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Comprehend.Model.BatchDetectEntitiesResponse, FindCOMPEntityBatchCmdlet, object> Select { get; set; } =
