...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "COMPFlywheel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCOMPFlywheelCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-COMPFlywheel (DeleteFlywheel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.DeleteFlywheelResponse, RemoveCOMPFlywheelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Comprehend.Model.DeleteFlywheelRequest();
        ...
        private Amazon.Comprehend.Model.DeleteFlywheelResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.DeleteFlywheelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Comprehend", "DeleteFlywheel");
            try
            {
                #if DESKTOP
                return client.DeleteFlywheel(request);
                #elif CORECLR
                return client.DeleteFlywheelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FlywheelArn { get; set; }
            public System.Func<Amazon.Comprehend.Model.DeleteFlywheelResponse, RemoveCOMPFlywheelCmdlet, object> Select { get; set; } =
