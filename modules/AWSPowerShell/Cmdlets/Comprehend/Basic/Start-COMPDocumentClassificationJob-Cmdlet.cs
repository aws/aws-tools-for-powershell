...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdletOutput("Amazon.Comprehend.Model.StartDocumentClassificationJobResponse",
        "This cmdlet returns an Amazon.Comprehend.Model.StartDocumentClassificationJobResponse object containing multiple properties."
    )]
    public partial class StartCOMPDocumentClassificationJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// "Sales" as the key might be added to a resource to indicate its use by the sales department.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Comprehend.Model.StartDocumentClassificationJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StartDocumentClassificationJobRequest request)
        {
            ...
            try
            {
                return client.StartDocumentClassificationJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
