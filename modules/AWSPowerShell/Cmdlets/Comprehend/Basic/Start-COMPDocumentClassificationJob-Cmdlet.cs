...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend StartDocumentClassificationJob API operation.", Operation = new[] {"StartDocumentClassificationJob"}, SelectReturnType = typeof(Amazon.Comprehend.Model.StartDocumentClassificationJobResponse))]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StartDocumentClassificationJobResponse",
        "This cmdlet returns an Amazon.Comprehend.Model.StartDocumentClassificationJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCOMPDocumentClassificationJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-COMPDocumentClassificationJob (StartDocumentClassificationJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.StartDocumentClassificationJobResponse, StartCOMPDocumentClassificationJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Comprehend.Model.StartDocumentClassificationJobRequest();
        ...
        private Amazon.Comprehend.Model.StartDocumentClassificationJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StartDocumentClassificationJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Comprehend", "StartDocumentClassificationJob");
            try
            {
                #if DESKTOP
                return client.StartDocumentClassificationJob(request);
                #elif CORECLR
                return client.StartDocumentClassificationJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Comprehend.Model.StartDocumentClassificationJobResponse, StartCOMPDocumentClassificationJobCmdlet, object> Select { get; set; } =
