...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    public partial class FindCOMPPiiEntityTypeCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Creates a new document classification request to analyze a single document in real-time,
        /// returning personally identifiable information (PII) entity labels.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
