...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend ListSentimentDetectionJobs API operation.", Operation = new[] {"ListSentimentDetectionJobs"}, SelectReturnType = typeof(Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse))]
    [AWSCmdletOutput("Amazon.Comprehend.Model.SentimentDetectionJobProperties or Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse",
        "This cmdlet returns a collection of Amazon.Comprehend.Model.SentimentDetectionJobProperties objects.",
        "The service call response (type Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCOMPSentimentDetectionJobListCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SentimentDetectionJobPropertiesList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse, GetCOMPSentimentDetectionJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SentimentDetectionJobPropertiesList?.Count ?? 0;
        ...
        private Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.ListSentimentDetectionJobsRequest request)
        {
            ...
            try
            {
                return client.ListSentimentDetectionJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Comprehend.Model.ListSentimentDetectionJobsResponse, GetCOMPSentimentDetectionJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SentimentDetectionJobPropertiesList;
        }
