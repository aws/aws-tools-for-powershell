...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend StartTopicsDetectionJob API operation.", Operation = new[] {"StartTopicsDetectionJob"}, SelectReturnType = typeof(Amazon.Comprehend.Model.StartTopicsDetectionJobResponse))]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StartTopicsDetectionJobResponse",
        "This cmdlet returns an Amazon.Comprehend.Model.StartTopicsDetectionJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCOMPTopicsDetectionJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to be associated with the topics detection job. A tag is a key-value pair that
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Comprehend.Model.StartTopicsDetectionJobResponse, StartCOMPTopicsDetectionJobCmdlet>(Select) ??
            ...
            context.NumberOfTopic = this.NumberOfTopic;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.NumberOfTopic != null)
            {
                request.NumberOfTopics = cmdletContext.NumberOfTopic.Value;
            }
        ...
        private Amazon.Comprehend.Model.StartTopicsDetectionJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StartTopicsDetectionJobRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.StartTopicsDetectionJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Comprehend.Model.StartTopicsDetectionJobResponse, StartCOMPTopicsDetectionJobCmdlet, object> Select { get; set; } =
