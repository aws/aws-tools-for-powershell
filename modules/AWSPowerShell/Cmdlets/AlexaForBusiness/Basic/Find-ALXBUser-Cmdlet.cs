...
{
    /// <summary>
    /// Searches users and lists the ones that meet a set of filter and sort criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Find", "ALXBUser")]
    [OutputType("Amazon.AlexaForBusiness.Model.UserData")]
    [AWSCmdlet("Calls the Alexa For Business SearchUsers API operation.", Operation = new[] {"SearchUsers"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.SearchUsersResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.UserData or Amazon.AlexaForBusiness.Model.SearchUsersResponse",
        "This cmdlet returns a collection of Amazon.AlexaForBusiness.Model.UserData objects.",
        "The service call response (type Amazon.AlexaForBusiness.Model.SearchUsersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class FindALXBUserCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.SearchUsersResponse, FindALXBUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.SearchUsersRequest();
        ...
        private Amazon.AlexaForBusiness.Model.SearchUsersResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "SearchUsers");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AlexaForBusiness.Model.SearchUsersResponse, FindALXBUserCmdlet, object> Select { get; set; } =
