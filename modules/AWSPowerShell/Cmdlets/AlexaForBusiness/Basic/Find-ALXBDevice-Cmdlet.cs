...
{
    /// <summary>
    /// Searches devices and lists the ones that meet a set of filter criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Find", "ALXBDevice")]
    [OutputType("Amazon.AlexaForBusiness.Model.DeviceData")]
    [AWSCmdlet("Calls the Alexa For Business SearchDevices API operation.", Operation = new[] {"SearchDevices"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.SearchDevicesResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.DeviceData or Amazon.AlexaForBusiness.Model.SearchDevicesResponse",
        "This cmdlet returns a collection of Amazon.AlexaForBusiness.Model.DeviceData objects.",
        "The service call response (type Amazon.AlexaForBusiness.Model.SearchDevicesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class FindALXBDeviceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.SearchDevicesResponse, FindALXBDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.SearchDevicesRequest();
        ...
        private Amazon.AlexaForBusiness.Model.SearchDevicesResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchDevicesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "SearchDevices");
            try
            {
                #if DESKTOP
                return client.SearchDevices(request);
                #elif CORECLR
                return client.SearchDevicesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AlexaForBusiness.Model.SearchDevicesResponse, FindALXBDeviceCmdlet, object> Select { get; set; } =
