...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListGateways API operation.", Operation = new[] {"ListGateways"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.ListGatewaysResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.GatewaySummary or Amazon.AlexaForBusiness.Model.ListGatewaysResponse",
    ...
    public partial class GetALXBGatewayListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.ListGatewaysResponse, GetALXBGatewayListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.ListGatewaysRequest();
        ...
        private Amazon.AlexaForBusiness.Model.ListGatewaysResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ListGatewaysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ListGateways");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.ListGatewaysResponse, GetALXBGatewayListCmdlet, object> Select { get; set; } =
