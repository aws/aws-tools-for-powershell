...
{
    /// <summary>
    /// Retrieves the details of a gateway group.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBGatewayGroup")]
    [OutputType("Amazon.AlexaForBusiness.Model.GatewayGroup")]
    [AWSCmdlet("Calls the Alexa For Business GetGatewayGroup API operation.", Operation = new[] {"GetGatewayGroup"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetGatewayGroupResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.GatewayGroup or Amazon.AlexaForBusiness.Model.GetGatewayGroupResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.GatewayGroup object.",
    ...
    public partial class GetALXBGatewayGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "GatewayGroup";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetGatewayGroupResponse, GetALXBGatewayGroupCmdlet>(Select) ??
        ...
        {
            public System.String GatewayGroupArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetGatewayGroupResponse, GetALXBGatewayGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GatewayGroup;
        }
