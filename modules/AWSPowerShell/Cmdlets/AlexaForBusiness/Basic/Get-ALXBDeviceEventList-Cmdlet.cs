...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListDeviceEvents API operation.", Operation = new[] {"ListDeviceEvents"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.DeviceEvent or Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse",
    ...
    public partial class GetALXBDeviceEventListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.AlexaForBusiness.DeviceEventType")]
        public Amazon.AlexaForBusiness.DeviceEventType EventType { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeviceEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse, GetALXBDeviceEventListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.ListDeviceEventsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DeviceEvents.Count;
        ...
        private Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ListDeviceEventsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ListDeviceEvents");
            try
            {
                #if DESKTOP
                return client.ListDeviceEvents(request);
                #elif CORECLR
                return client.ListDeviceEventsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse, GetALXBDeviceEventListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeviceEvents;
        }
