...
{
    /// <summary>
    /// Gets the details of a room profile by profile ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBProfile")]
    [OutputType("Amazon.AlexaForBusiness.Model.Profile")]
    [AWSCmdlet("Calls the Alexa For Business GetProfile API operation.", Operation = new[] {"GetProfile"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetProfileResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.Profile or Amazon.AlexaForBusiness.Model.GetProfileResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.Profile object.",
    ...
    public partial class GetALXBProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetProfileResponse, GetALXBProfileCmdlet>(Select) ??
        ...
        {
            public System.String ProfileArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetProfileResponse, GetALXBProfileCmdlet, object> Select { get; set; } =
