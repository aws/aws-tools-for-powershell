...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListSkills API operation.", Operation = new[] {"ListSkills"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.ListSkillsResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.SkillSummary or Amazon.AlexaForBusiness.Model.ListSkillsResponse",
    ...
    public partial class GetALXBSkillListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SkillSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.ListSkillsResponse, GetALXBSkillListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SkillGroupArn { get; set; }
            public Amazon.AlexaForBusiness.SkillTypeFilter SkillType { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.ListSkillsResponse, GetALXBSkillListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SkillSummaries;
        }
