...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateDeviceWithRoom API operation.", Operation = new[] {"AssociateDeviceWithRoom"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomResponse",
    ...
    public partial class AddALXBDeviceToRoomCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomResponse, AddALXBDeviceToRoomCmdlet>(Select) ??
        ...
        private Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.AssociateDeviceWithRoomAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DeviceArn { get; set; }
            public System.String RoomArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateDeviceWithRoomResponse, AddALXBDeviceToRoomCmdlet, object> Select { get; set; } =
