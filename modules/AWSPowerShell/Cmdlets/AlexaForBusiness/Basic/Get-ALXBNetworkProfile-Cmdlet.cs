...
{
    /// <summary>
    /// Gets the network profile details by the network profile ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBNetworkProfile")]
    [OutputType("Amazon.AlexaForBusiness.Model.NetworkProfile")]
    [AWSCmdlet("Calls the Alexa For Business GetNetworkProfile API operation.", Operation = new[] {"GetNetworkProfile"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.NetworkProfile or Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.NetworkProfile object.",
        "The service call response (type Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class GetALXBNetworkProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse, GetALXBNetworkProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.GetNetworkProfileRequest();
        ...
        private Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.GetNetworkProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "GetNetworkProfile");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String NetworkProfileArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetNetworkProfileResponse, GetALXBNetworkProfileCmdlet, object> Select { get; set; } =
