...
{
    /// <summary>
    /// Makes a private skill available for enrolled users to enable on their devices.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Add", "ALXBSkillToUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateSkillWithUsers API operation.", Operation = new[] {"AssociateSkillWithUsers"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateSkillWithUsersResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateSkillWithUsersResponse",
    ...
    public partial class AddALXBSkillToUserCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateSkillWithUsersResponse, AddALXBSkillToUserCmdlet>(Select) ??
        ...
        {
            public System.String SkillId { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateSkillWithUsersResponse, AddALXBSkillToUserCmdlet, object> Select { get; set; } =
