...
{
    /// <summary>
    /// Creates a user.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("New", "ALXBUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Alexa For Business CreateUser API operation.", Operation = new[] {"CreateUser"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.CreateUserResponse))]
    [AWSCmdletOutput("System.String or Amazon.AlexaForBusiness.Model.CreateUserResponse",
    ...
    public partial class NewALXBUserCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "UserArn";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.CreateUserResponse, NewALXBUserCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String UserId { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.CreateUserResponse, NewALXBUserCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.UserArn;
        }
