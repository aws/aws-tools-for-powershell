...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateSkillWithSkillGroup API operation.", Operation = new[] {"AssociateSkillWithSkillGroup"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse",
    ...
    public partial class AddALXBSkillToSkillGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ALXBSkillToSkillGroup (AssociateSkillWithSkillGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse, AddALXBSkillToSkillGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupRequest();
        ...
        private Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "AssociateSkillWithSkillGroup");
            try
            {
                #if DESKTOP
                return client.AssociateSkillWithSkillGroup(request);
                #elif CORECLR
                return client.AssociateSkillWithSkillGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SkillGroupArn { get; set; }
            public System.String SkillId { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse, AddALXBSkillToSkillGroupCmdlet, object> Select { get; set; } =
