...
{
    /// <summary>
    /// Retrieves the details of a gateway.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBGateway")]
    [OutputType("Amazon.AlexaForBusiness.Model.Gateway")]
    [AWSCmdlet("Calls the Alexa For Business GetGateway API operation.", Operation = new[] {"GetGateway"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetGatewayResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.Gateway or Amazon.AlexaForBusiness.Model.GetGatewayResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.Gateway object.",
        "The service call response (type Amazon.AlexaForBusiness.Model.GetGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    ...
    public partial class GetALXBGatewayCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetGatewayResponse, GetALXBGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.GetGatewayRequest();
        ...
        private Amazon.AlexaForBusiness.Model.GetGatewayResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.GetGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "GetGateway");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GatewayArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetGatewayResponse, GetALXBGatewayCmdlet, object> Select { get; set; } =
