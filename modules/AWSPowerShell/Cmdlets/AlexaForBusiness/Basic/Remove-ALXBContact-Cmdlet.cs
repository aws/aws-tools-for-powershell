...
{
    /// <summary>
    /// Deletes a contact by the contact ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Remove", "ALXBContact", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business DeleteContact API operation.", Operation = new[] {"DeleteContact"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.DeleteContactResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.DeleteContactResponse",
    ...
    public partial class RemoveALXBContactCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.DeleteContactResponse, RemoveALXBContactCmdlet>(Select) ??
        ...
        {
            public System.String ContactArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.DeleteContactResponse, RemoveALXBContactCmdlet, object> Select { get; set; } =
