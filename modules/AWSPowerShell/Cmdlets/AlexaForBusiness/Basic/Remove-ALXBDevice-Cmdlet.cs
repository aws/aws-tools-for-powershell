...
{
    /// <summary>
    /// Removes a device from Alexa For Business.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Remove", "ALXBDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business DeleteDevice API operation.", Operation = new[] {"DeleteDevice"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.DeleteDeviceResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.DeleteDeviceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AlexaForBusiness.Model.DeleteDeviceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class RemoveALXBDeviceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ALXBDevice (DeleteDevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.DeleteDeviceResponse, RemoveALXBDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.DeleteDeviceRequest();
        ...
        private Amazon.AlexaForBusiness.Model.DeleteDeviceResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.DeleteDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "DeleteDevice");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DeviceArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.DeleteDeviceResponse, RemoveALXBDeviceCmdlet, object> Select { get; set; } =
