...
{
    /// <summary>
    /// Searches room profiles and lists the ones that meet a set of filter criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Find", "ALXBProfile")]
    [OutputType("Amazon.AlexaForBusiness.Model.ProfileData")]
    [AWSCmdlet("Calls the Alexa For Business SearchProfiles API operation.", Operation = new[] {"SearchProfiles"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.SearchProfilesResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.ProfileData or Amazon.AlexaForBusiness.Model.SearchProfilesResponse",
        "This cmdlet returns a collection of Amazon.AlexaForBusiness.Model.ProfileData objects.",
        "The service call response (type Amazon.AlexaForBusiness.Model.SearchProfilesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class FindALXBProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.SearchProfilesResponse, FindALXBProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.SearchProfilesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Profiles.Count;
        ...
        private Amazon.AlexaForBusiness.Model.SearchProfilesResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "SearchProfiles");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AlexaForBusiness.Model.SearchProfilesResponse, FindALXBProfileCmdlet, object> Select { get; set; } =
