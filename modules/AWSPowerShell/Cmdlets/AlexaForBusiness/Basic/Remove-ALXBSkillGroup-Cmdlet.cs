...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business DeleteSkillGroup API operation.", Operation = new[] {"DeleteSkillGroup"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.DeleteSkillGroupResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.DeleteSkillGroupResponse",
    ...
    public partial class RemoveALXBSkillGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ALXBSkillGroup (DeleteSkillGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.DeleteSkillGroupResponse, RemoveALXBSkillGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.DeleteSkillGroupRequest();
        ...
        private Amazon.AlexaForBusiness.Model.DeleteSkillGroupResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.DeleteSkillGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "DeleteSkillGroup");
            try
            {
                #if DESKTOP
                return client.DeleteSkillGroup(request);
                #elif CORECLR
                return client.DeleteSkillGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SkillGroupArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.DeleteSkillGroupResponse, RemoveALXBSkillGroupCmdlet, object> Select { get; set; } =
