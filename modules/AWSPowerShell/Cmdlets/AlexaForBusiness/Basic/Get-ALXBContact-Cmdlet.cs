...
{
    /// <summary>
    /// Gets the contact details by the contact ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBContact")]
    [OutputType("Amazon.AlexaForBusiness.Model.Contact")]
    [AWSCmdlet("Calls the Alexa For Business GetContact API operation.", Operation = new[] {"GetContact"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetContactResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.Contact or Amazon.AlexaForBusiness.Model.GetContactResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.Contact object.",
        "The service call response (type Amazon.AlexaForBusiness.Model.GetContactResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    ...
    public partial class GetALXBContactCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetContactResponse, GetALXBContactCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.GetContactRequest();
        ...
        private Amazon.AlexaForBusiness.Model.GetContactResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.GetContactRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "GetContact");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ContactArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetContactResponse, GetALXBContactCmdlet, object> Select { get; set; } =
