...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business DeleteNetworkProfile API operation.", Operation = new[] {"DeleteNetworkProfile"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.DeleteNetworkProfileResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.DeleteNetworkProfileResponse",
    ...
    public partial class RemoveALXBNetworkProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ALXBNetworkProfile (DeleteNetworkProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.DeleteNetworkProfileResponse, RemoveALXBNetworkProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.DeleteNetworkProfileRequest();
        ...
        private Amazon.AlexaForBusiness.Model.DeleteNetworkProfileResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.DeleteNetworkProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "DeleteNetworkProfile");
            try
            {
                #if DESKTOP
                return client.DeleteNetworkProfile(request);
                #elif CORECLR
                return client.DeleteNetworkProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NetworkProfileArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.DeleteNetworkProfileResponse, RemoveALXBNetworkProfileCmdlet, object> Select { get; set; } =
