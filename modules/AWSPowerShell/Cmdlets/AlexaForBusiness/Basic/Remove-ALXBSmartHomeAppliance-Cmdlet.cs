...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business ForgetSmartHomeAppliances API operation.", Operation = new[] {"ForgetSmartHomeAppliances"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesResponse",
    ...
    public partial class RemoveALXBSmartHomeApplianceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ALXBSmartHomeAppliance (ForgetSmartHomeAppliances)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesResponse, RemoveALXBSmartHomeApplianceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesRequest();
        ...
        private Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ForgetSmartHomeAppliances");
            try
            {
                #if DESKTOP
                return client.ForgetSmartHomeAppliances(request);
                #elif CORECLR
                return client.ForgetSmartHomeAppliancesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RoomArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.ForgetSmartHomeAppliancesResponse, RemoveALXBSmartHomeApplianceCmdlet, object> Select { get; set; } =
