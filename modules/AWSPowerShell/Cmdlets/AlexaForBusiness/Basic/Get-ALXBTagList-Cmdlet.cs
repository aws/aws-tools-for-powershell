...
{
    /// <summary>
    /// Lists all tags for the specified resource.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBTagList")]
    [OutputType("Amazon.AlexaForBusiness.Model.Tag")]
    [AWSCmdlet("Calls the Alexa For Business ListTags API operation.", Operation = new[] {"ListTags"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.ListTagsResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.Tag or Amazon.AlexaForBusiness.Model.ListTagsResponse",
        "This cmdlet returns a collection of Amazon.AlexaForBusiness.Model.Tag objects.",
        "The service call response (type Amazon.AlexaForBusiness.Model.ListTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class GetALXBTagListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.ListTagsResponse, GetALXBTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AlexaForBusiness.Model.ListTagsRequest();
        ...
        private Amazon.AlexaForBusiness.Model.ListTagsResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ListTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ListTags");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.ListTagsResponse, GetALXBTagListCmdlet, object> Select { get; set; } =
