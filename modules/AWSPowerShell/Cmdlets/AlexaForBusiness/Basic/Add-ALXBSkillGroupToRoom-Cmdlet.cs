...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateSkillGroupWithRoom API operation.", Operation = new[] {"AssociateSkillGroupWithRoom"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomResponse",
    ...
    public partial class AddALXBSkillGroupToRoomCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ALXBSkillGroupToRoom (AssociateSkillGroupWithRoom)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomResponse, AddALXBSkillGroupToRoomCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomRequest();
        ...
        private Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "AssociateSkillGroupWithRoom");
            try
            {
                #if DESKTOP
                return client.AssociateSkillGroupWithRoom(request);
                #elif CORECLR
                return client.AssociateSkillGroupWithRoomAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RoomArn { get; set; }
            public System.String SkillGroupArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateSkillGroupWithRoomResponse, AddALXBSkillGroupToRoomCmdlet, object> Select { get; set; } =
