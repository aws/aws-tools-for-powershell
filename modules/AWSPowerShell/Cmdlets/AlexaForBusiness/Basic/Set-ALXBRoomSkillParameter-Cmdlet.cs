...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business PutRoomSkillParameter API operation.", Operation = new[] {"PutRoomSkillParameter"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.PutRoomSkillParameterResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.PutRoomSkillParameterResponse",
    ...
    public partial class SetALXBRoomSkillParameterCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RoomSkillParameter' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.PutRoomSkillParameterResponse, SetALXBRoomSkillParameterCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RoomSkillParameter;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.RoomArn = this.RoomArn;
            context.RoomSkillParameter = this.RoomSkillParameter;
            #if MODULAR
            if (this.RoomSkillParameter == null && ParameterWasBound(nameof(this.RoomSkillParameter)))
            {
                WriteWarning("You are passing $null as a value for parameter RoomSkillParameter which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.AlexaForBusiness.Model.RoomSkillParameter RoomSkillParameter { get; set; }
            public System.String SkillId { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.PutRoomSkillParameterResponse, SetALXBRoomSkillParameterCmdlet, object> Select { get; set; } =
