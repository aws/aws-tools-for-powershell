...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business GetInvitationConfiguration API operation.", Operation = new[] {"GetInvitationConfiguration"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetInvitationConfigurationResponse))]
    ...
    public partial class GetALXBInvitationConfigurationCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetInvitationConfigurationResponse, GetALXBInvitationConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.GetInvitationConfigurationRequest();
        ...
        private Amazon.AlexaForBusiness.Model.GetInvitationConfigurationResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.GetInvitationConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "GetInvitationConfiguration");
            try
            {
                #if DESKTOP
                return client.GetInvitationConfiguration(request);
                #elif CORECLR
                return client.GetInvitationConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.AlexaForBusiness.Model.GetInvitationConfigurationResponse, GetALXBInvitationConfigurationCmdlet, object> Select { get; set; } =
