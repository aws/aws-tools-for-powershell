...
{
    /// <summary>
    /// Associates a device with the specified network profile.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Add", "ALXBDeviceToNetworkProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateDeviceWithNetworkProfile API operation.", Operation = new[] {"AssociateDeviceWithNetworkProfile"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Alexa For Business is no longer supported")]
    public partial class AddALXBDeviceToNetworkProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ALXBDeviceToNetworkProfile (AssociateDeviceWithNetworkProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse, AddALXBDeviceToNetworkProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileRequest();
        ...
        private Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "AssociateDeviceWithNetworkProfile");
            try
            {
                #if DESKTOP
                return client.AssociateDeviceWithNetworkProfile(request);
                #elif CORECLR
                return client.AssociateDeviceWithNetworkProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DeviceArn { get; set; }
            public System.String NetworkProfileArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateDeviceWithNetworkProfileResponse, AddALXBDeviceToNetworkProfileCmdlet, object> Select { get; set; } =
