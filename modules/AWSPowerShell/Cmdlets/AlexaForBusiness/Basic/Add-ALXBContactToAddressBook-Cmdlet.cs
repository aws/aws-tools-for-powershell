...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business AssociateContactWithAddressBook API operation.", Operation = new[] {"AssociateContactWithAddressBook"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.AssociateContactWithAddressBookResponse), LegacyAlias="Add-ALXBContactWithAddressBook")]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.AssociateContactWithAddressBookResponse",
    ...
    public partial class AddALXBContactToAddressBookCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ALXBContactToAddressBook (AssociateContactWithAddressBook)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.AssociateContactWithAddressBookResponse, AddALXBContactToAddressBookCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.AddressBookArn == null && ParameterWasBound(nameof(this.AddressBookArn)))
            {
                WriteWarning("You are passing $null as a value for parameter AddressBookArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AddressBookArn { get; set; }
            public System.String ContactArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.AssociateContactWithAddressBookResponse, AddALXBContactToAddressBookCmdlet, object> Select { get; set; } =
