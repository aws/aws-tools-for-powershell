...
{
    /// <summary>
    /// Gets the details of a device by device ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Get", "ALXBDevice")]
    [OutputType("Amazon.AlexaForBusiness.Model.Device")]
    [AWSCmdlet("Calls the Alexa For Business GetDevice API operation.", Operation = new[] {"GetDevice"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.GetDeviceResponse))]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.Device or Amazon.AlexaForBusiness.Model.GetDeviceResponse",
        "This cmdlet returns an Amazon.AlexaForBusiness.Model.Device object.",
    ...
    public partial class GetALXBDeviceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.GetDeviceResponse, GetALXBDeviceCmdlet>(Select) ??
        ...
        {
            public System.String DeviceArn { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.GetDeviceResponse, GetALXBDeviceCmdlet, object> Select { get; set; } =
