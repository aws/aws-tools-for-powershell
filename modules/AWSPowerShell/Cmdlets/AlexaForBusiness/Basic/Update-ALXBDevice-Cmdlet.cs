...
{
    /// <summary>
    /// Updates the device name by device ARN.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Update", "ALXBDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Alexa For Business UpdateDevice API operation.", Operation = new[] {"UpdateDevice"}, SelectReturnType = typeof(Amazon.AlexaForBusiness.Model.UpdateDeviceResponse))]
    [AWSCmdletOutput("None or Amazon.AlexaForBusiness.Model.UpdateDeviceResponse",
    ...
    public partial class UpdateALXBDeviceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AlexaForBusiness.Model.UpdateDeviceResponse, UpdateALXBDeviceCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DeviceArn { get; set; }
            public System.String DeviceName { get; set; }
            public System.Func<Amazon.AlexaForBusiness.Model.UpdateDeviceResponse, UpdateALXBDeviceCmdlet, object> Select { get; set; } =
