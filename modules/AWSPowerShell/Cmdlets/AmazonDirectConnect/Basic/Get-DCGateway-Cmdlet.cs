...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Invokes the DescribeDirectConnectGateways operation against AWS Direct Connect.", Operation = new[] {"DescribeDirectConnectGateways"})]
    ...
    public partial class GetDCGatewayCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeDirectConnectGatewaysAsync(request);
                return task.Result;
                #else
