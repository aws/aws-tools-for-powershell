...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Calls the AWS Direct Connect DescribeDirectConnectGateways API operation.", Operation = new[] {"DescribeDirectConnectGateways"})]
    [AWSCmdletOutput("Amazon.DirectConnect.Model.DirectConnectGateway",
        "This cmdlet returns a collection of DirectConnectGateway objects.",
        "The service call response (type Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetDCGatewayCmdlet : AmazonDirectConnectClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DirectConnectGateways;
                        ...
                        int _receivedThisCall = response.DirectConnectGateways.Count;
        ...
        private Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysResponse CallAWSServiceOperation(IAmazonDirectConnect client, Amazon.DirectConnect.Model.DescribeDirectConnectGatewaysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Direct Connect", "DescribeDirectConnectGateways");
            try
            {
                #if DESKTOP
                return client.DescribeDirectConnectGateways(request);
                #elif CORECLR
                return client.DescribeDirectConnectGatewaysAsync(request).GetAwaiter().GetResult();
                #else
