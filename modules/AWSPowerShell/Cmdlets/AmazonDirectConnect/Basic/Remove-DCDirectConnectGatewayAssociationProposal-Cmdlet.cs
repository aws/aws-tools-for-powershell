...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Calls the AWS Direct Connect DeleteDirectConnectGatewayAssociationProposal API operation.", Operation = new[] {"DeleteDirectConnectGatewayAssociationProposal"})]
    [AWSCmdletOutput("Amazon.DirectConnect.Model.DirectConnectGatewayAssociationProposal",
        ...
        "The service call response (type Amazon.DirectConnect.Model.DeleteDirectConnectGatewayAssociationProposalResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
