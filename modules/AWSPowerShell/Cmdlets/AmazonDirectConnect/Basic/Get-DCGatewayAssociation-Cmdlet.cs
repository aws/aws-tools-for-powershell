...
namespace Amazon.PowerShell.Cmdlets.DC
{
    ...
    [AWSCmdlet("Invokes the DescribeDirectConnectGatewayAssociations operation against AWS Direct Connect.", Operation = new[] {"DescribeDirectConnectGatewayAssociations"})]
