...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity ListIdentityPools API operation.", Operation = new[] {"ListIdentityPools"})]
    ...
    public partial class GetCGIIdentityPoolListCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        private Amazon.CognitoIdentity.Model.ListIdentityPoolsResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.ListIdentityPoolsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListIdentityPoolsAsync(request);
                return task.Result;
                #else
