...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity UntagResource API operation.", Operation = new[] {"UntagResource"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.CognitoIdentity.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCGIResourceTagCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CGIResourceTag (UntagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentity.Model.UntagResourceRequest();
        ...
        private Amazon.CognitoIdentity.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity", "UntagResource");
            try
            {
                #if DESKTOP
