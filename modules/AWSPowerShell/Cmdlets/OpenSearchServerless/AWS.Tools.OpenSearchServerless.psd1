#
# Module manifest for module 'AWS.Tools.OpenSearchServerless'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.OpenSearchServerless.dll'
    ...
    GUID = '6c5ea2b3-a50d-44bf-b948-cbfc102bceee'
    ...
    Description = 'The OpenSearchServerless module of AWS Tools for PowerShell lets developers and administrators manage OpenSearch Serverless from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.OpenSearchServerless.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.OpenSearchServerless.Completers.psm1',
        'AWS.Tools.OpenSearchServerless.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.OpenSearchServerless.dll-Help.xml'
    )
