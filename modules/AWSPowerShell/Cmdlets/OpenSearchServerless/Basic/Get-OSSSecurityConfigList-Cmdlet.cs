...
namespace Amazon.PowerShell.Cmdlets.OSS
{
    ...
    [AWSCmdletOutput("Amazon.OpenSearchServerless.Model.SecurityConfigSummary or Amazon.OpenSearchServerless.Model.ListSecurityConfigsResponse",
        ...
        "The service call response (type Amazon.OpenSearchServerless.Model.ListSecurityConfigsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOSSSecurityConfigListCmdlet : AmazonOpenSearchServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <code>ListSecurityConfigs</code> operation returns a <code>nextToken</code>,
        /// you can include the returned <code>nextToken</code> in subsequent <code>ListSecurityConfigs</code>
        ...
        private Amazon.OpenSearchServerless.Model.ListSecurityConfigsResponse CallAWSServiceOperation(IAmazonOpenSearchServerless client, Amazon.OpenSearchServerless.Model.ListSecurityConfigsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListSecurityConfigs(request);
                #elif CORECLR
                return client.ListSecurityConfigsAsync(request).GetAwaiter().GetResult();
                #else
