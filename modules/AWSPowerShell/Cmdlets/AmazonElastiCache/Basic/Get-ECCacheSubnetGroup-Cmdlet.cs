...
namespace Amazon.PowerShell.Cmdlets.EC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ECCacheSubnetGroup")]
    [OutputType("Amazon.ElastiCache.Model.CacheSubnetGroup")]
    [AWSCmdlet("Calls the Amazon ElastiCache DescribeCacheSubnetGroups API operation.", Operation = new[] {"DescribeCacheSubnetGroups"}, LegacyAlias="Get-ECCacheSubnetGroups")]
    [AWSCmdletOutput("Amazon.ElastiCache.Model.CacheSubnetGroup",
        "This cmdlet returns a collection of CacheSubnetGroup objects.",
    ...
    public partial class GetECCacheSubnetGroupCmdlet : AmazonElastiCacheClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CacheSubnetGroups;
                        ...
                        int _receivedThisCall = response.CacheSubnetGroups.Count;
        ...
        private Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsResponse CallAWSServiceOperation(IAmazonElastiCache client, Amazon.ElastiCache.Model.DescribeCacheSubnetGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon ElastiCache", "DescribeCacheSubnetGroups");
            try
            {
                #if DESKTOP
                return client.DescribeCacheSubnetGroups(request);
                #elif CORECLR
                return client.DescribeCacheSubnetGroupsAsync(request).GetAwaiter().GetResult();
                #else
