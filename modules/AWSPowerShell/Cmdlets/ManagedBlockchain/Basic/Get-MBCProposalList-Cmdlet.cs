...
{
    /// <summary>
    /// Returns a listing of proposals for the network.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "MBCProposalList")]
    [OutputType("Amazon.ManagedBlockchain.Model.ProposalSummary")]
    [AWSCmdlet("Calls the Amazon Managed Blockchain ListProposals API operation.", Operation = new[] {"ListProposals"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.ListProposalsResponse))]
    [AWSCmdletOutput("Amazon.ManagedBlockchain.Model.ProposalSummary or Amazon.ManagedBlockchain.Model.ListProposalsResponse",
        "This cmdlet returns a collection of Amazon.ManagedBlockchain.Model.ProposalSummary objects.",
        "The service call response (type Amazon.ManagedBlockchain.Model.ListProposalsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMBCProposalListCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        private Amazon.ManagedBlockchain.Model.ListProposalsResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.ListProposalsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "ListProposals");
            try
            {
                #if DESKTOP
                return client.ListProposals(request);
                #elif CORECLR
                return client.ListProposalsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NetworkId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.ListProposalsResponse, GetMBCProposalListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Proposals;
        }
