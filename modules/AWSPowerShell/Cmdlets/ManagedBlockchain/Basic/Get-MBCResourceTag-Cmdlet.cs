...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    public partial class GetMBCResourceTagCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.ListTagsForResourceResponse, GetMBCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ManagedBlockchain.Model.ListTagsForResourceRequest();
        ...
        private Amazon.ManagedBlockchain.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "ListTagsForResource");
            try
            {
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.ListTagsForResourceResponse, GetMBCResourceTagCmdlet, object> Select { get; set; } =
