...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "MBCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMBCResourceTagCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MBCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.UntagResourceResponse, RemoveMBCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ManagedBlockchain.Model.UntagResourceRequest();
        ...
        private Amazon.ManagedBlockchain.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ManagedBlockchain.Model.UntagResourceResponse, RemoveMBCResourceTagCmdlet, object> Select { get; set; } =
