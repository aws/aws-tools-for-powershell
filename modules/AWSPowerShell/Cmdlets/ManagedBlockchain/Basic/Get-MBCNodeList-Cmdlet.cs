...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    [AWSCmdlet("Calls the Amazon Managed Blockchain ListNodes API operation.", Operation = new[] {"ListNodes"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.ListNodesResponse))]
    [AWSCmdletOutput("Amazon.ManagedBlockchain.Model.NodeSummary or Amazon.ManagedBlockchain.Model.ListNodesResponse",
        "This cmdlet returns a collection of Amazon.ManagedBlockchain.Model.NodeSummary objects.",
        "The service call response (type Amazon.ManagedBlockchain.Model.ListNodesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMBCNodeListCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.ManagedBlockchain.NodeStatus")]
        public Amazon.ManagedBlockchain.NodeStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.ListNodesResponse, GetMBCNodeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Nodes?.Count ?? 0;
        ...
        private Amazon.ManagedBlockchain.Model.ListNodesResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.ListNodesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "ListNodes");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.ManagedBlockchain.NodeStatus Status { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.ListNodesResponse, GetMBCNodeListCmdlet, object> Select { get; set; } =
