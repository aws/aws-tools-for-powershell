...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    [AWSCmdletOutput("Amazon.ManagedBlockchain.Model.NetworkSummary or Amazon.ManagedBlockchain.Model.ListNetworksResponse",
        ...
        "The service call response (type Amazon.ManagedBlockchain.Model.ListNetworksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
