...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    [AWSCmdlet("Calls the Amazon Managed Blockchain ListNetworks API operation.", Operation = new[] {"ListNetworks"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.ListNetworksResponse))]
    [AWSCmdletOutput("Amazon.ManagedBlockchain.Model.NetworkSummary or Amazon.ManagedBlockchain.Model.ListNetworksResponse",
        "This cmdlet returns a collection of Amazon.ManagedBlockchain.Model.NetworkSummary objects.",
        "The service call response (type Amazon.ManagedBlockchain.Model.ListNetworksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMBCNetworkListCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.ManagedBlockchain.NetworkStatus")]
        public Amazon.ManagedBlockchain.NetworkStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.ListNetworksResponse, GetMBCNetworkListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ManagedBlockchain.Model.ListNetworksRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Networks?.Count ?? 0;
        ...
        private Amazon.ManagedBlockchain.Model.ListNetworksResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.ListNetworksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "ListNetworks");
            try
            {
                return client.ListNetworksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.ManagedBlockchain.NetworkStatus Status { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.ListNetworksResponse, GetMBCNetworkListCmdlet, object> Select { get; set; } =
