...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "MBCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Managed Blockchain TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.ManagedBlockchain.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ManagedBlockchain.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddMBCResourceTagCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-MBCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.TagResourceResponse, AddMBCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ManagedBlockchain.Model.TagResourceRequest();
        ...
        private Amazon.ManagedBlockchain.Model.TagResourceResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ManagedBlockchain.Model.TagResourceResponse, AddMBCResourceTagCmdlet, object> Select { get; set; } =
