...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Managed Blockchain RejectInvitation API operation.", Operation = new[] {"RejectInvitation"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.RejectInvitationResponse))]
    [AWSCmdletOutput("None or Amazon.ManagedBlockchain.Model.RejectInvitationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ManagedBlockchain.Model.RejectInvitationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DenyMBCInvitationCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-MBCInvitation (RejectInvitation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.RejectInvitationResponse, DenyMBCInvitationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ManagedBlockchain.Model.RejectInvitationRequest();
        ...
        private Amazon.ManagedBlockchain.Model.RejectInvitationResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.RejectInvitationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "RejectInvitation");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String InvitationId { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.RejectInvitationResponse, DenyMBCInvitationCmdlet, object> Select { get; set; } =
