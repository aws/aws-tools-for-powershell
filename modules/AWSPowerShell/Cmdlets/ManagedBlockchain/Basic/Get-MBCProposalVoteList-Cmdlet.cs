...
namespace Amazon.PowerShell.Cmdlets.MBC
{
    ...
    [AWSCmdlet("Calls the Amazon Managed Blockchain ListProposalVotes API operation.", Operation = new[] {"ListProposalVotes"}, SelectReturnType = typeof(Amazon.ManagedBlockchain.Model.ListProposalVotesResponse))]
    [AWSCmdletOutput("Amazon.ManagedBlockchain.Model.VoteSummary or Amazon.ManagedBlockchain.Model.ListProposalVotesResponse",
        "This cmdlet returns a collection of Amazon.ManagedBlockchain.Model.VoteSummary objects.",
        "The service call response (type Amazon.ManagedBlockchain.Model.ListProposalVotesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMBCProposalVoteListCmdlet : AmazonManagedBlockchainClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ProposalVotes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ManagedBlockchain.Model.ListProposalVotesResponse, GetMBCProposalVoteListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ProposalVotes?.Count ?? 0;
        ...
        private Amazon.ManagedBlockchain.Model.ListProposalVotesResponse CallAWSServiceOperation(IAmazonManagedBlockchain client, Amazon.ManagedBlockchain.Model.ListProposalVotesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Managed Blockchain", "ListProposalVotes");
            try
            {
                #if DESKTOP
                return client.ListProposalVotes(request);
                #elif CORECLR
                return client.ListProposalVotesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProposalId { get; set; }
            public System.Func<Amazon.ManagedBlockchain.Model.ListProposalVotesResponse, GetMBCProposalVoteListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ProposalVotes;
        }
