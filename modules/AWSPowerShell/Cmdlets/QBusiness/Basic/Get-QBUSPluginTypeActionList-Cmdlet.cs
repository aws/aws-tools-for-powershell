...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    public partial class GetQBUSPluginTypeActionListCmdlet : AmazonQBusinessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the PluginType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^PluginType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PluginType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.PluginType;
            }
        ...
        private Amazon.QBusiness.Model.ListPluginTypeActionsResponse CallAWSServiceOperation(IAmazonQBusiness client, Amazon.QBusiness.Model.ListPluginTypeActionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListPluginTypeActions(request);
                #elif CORECLR
                return client.ListPluginTypeActionsAsync(request).GetAwaiter().GetResult();
                #else
