...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    public partial class StartQBUSDataSourceSyncJobCmdlet : AmazonQBusinessClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QBusiness.Model.StartDataSourceSyncJobResponse).
        /// Specifying the name of a property of type Amazon.QBusiness.Model.StartDataSourceSyncJobResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-QBUSDataSourceSyncJob (StartDataSourceSyncJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QBusiness.Model.StartDataSourceSyncJobResponse, StartQBUSDataSourceSyncJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QBusiness.Model.StartDataSourceSyncJobRequest();
        ...
        private Amazon.QBusiness.Model.StartDataSourceSyncJobResponse CallAWSServiceOperation(IAmazonQBusiness client, Amazon.QBusiness.Model.StartDataSourceSyncJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QBusiness", "StartDataSourceSyncJob");
            try
            {
                #if DESKTOP
                return client.StartDataSourceSyncJob(request);
                #elif CORECLR
                return client.StartDataSourceSyncJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DataSourceId { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.QBusiness.Model.StartDataSourceSyncJobResponse, StartQBUSDataSourceSyncJobCmdlet, object> Select { get; set; } =
