...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "QBUSRetriever", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveQBUSRetrieverCmdlet : AmazonQBusinessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the retriever being deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QBusiness.Model.DeleteRetrieverResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QBUSRetriever (DeleteRetriever)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QBusiness.Model.DeleteRetrieverResponse, RemoveQBUSRetrieverCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QBusiness.Model.DeleteRetrieverRequest();
        ...
        private Amazon.QBusiness.Model.DeleteRetrieverResponse CallAWSServiceOperation(IAmazonQBusiness client, Amazon.QBusiness.Model.DeleteRetrieverRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QBusiness", "DeleteRetriever");
            try
            {
                #if DESKTOP
                return client.DeleteRetriever(request);
                #elif CORECLR
                return client.DeleteRetrieverAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String RetrieverId { get; set; }
            public System.Func<Amazon.QBusiness.Model.DeleteRetrieverResponse, RemoveQBUSRetrieverCmdlet, object> Select { get; set; } =
