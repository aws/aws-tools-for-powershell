...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    [AWSCmdletOutput("None or Amazon.QBusiness.Model.UpdateIndexResponse",
        ...
        "The service response (type Amazon.QBusiness.Model.UpdateIndexResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
