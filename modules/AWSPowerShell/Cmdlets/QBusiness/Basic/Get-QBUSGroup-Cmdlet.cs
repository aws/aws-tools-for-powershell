...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    public partial class GetQBUSGroupCmdlet : AmazonQBusinessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the application id the group is attached to.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the data source the group is attached to.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the index the group is attached to.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QBusiness.Model.GetGroupResponse).
        /// Specifying the name of a property of type Amazon.QBusiness.Model.GetGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QBusiness.Model.GetGroupResponse, GetQBUSGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QBusiness.Model.GetGroupRequest();
        ...
        private Amazon.QBusiness.Model.GetGroupResponse CallAWSServiceOperation(IAmazonQBusiness client, Amazon.QBusiness.Model.GetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QBusiness", "GetGroup");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String GroupName { get; set; }
            public System.String IndexId { get; set; }
            public System.Func<Amazon.QBusiness.Model.GetGroupResponse, GetQBUSGroupCmdlet, object> Select { get; set; } =
