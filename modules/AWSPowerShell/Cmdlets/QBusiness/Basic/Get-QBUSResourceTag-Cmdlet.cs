...
namespace Amazon.PowerShell.Cmdlets.QBUS
{
    ...
    public partial class GetQBUSResourceTagCmdlet : AmazonQBusinessClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QBusiness.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.QBusiness.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QBusiness.Model.ListTagsForResourceResponse, GetQBUSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QBusiness.Model.ListTagsForResourceRequest();
        ...
        private Amazon.QBusiness.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonQBusiness client, Amazon.QBusiness.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QBusiness", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.QBusiness.Model.ListTagsForResourceResponse, GetQBUSResourceTagCmdlet, object> Select { get; set; } =
