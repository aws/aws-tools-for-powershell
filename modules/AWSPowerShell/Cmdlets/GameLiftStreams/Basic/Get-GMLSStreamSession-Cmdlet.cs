...
namespace Amazon.PowerShell.Cmdlets.GMLS
{
    ...
    /// requested resource.
    /// </summary>
    [Cmdlet("Get", "GMLSStreamSession")]
    [OutputType("Amazon.GameLiftStreams.Model.GetStreamSessionResponse")]
    [AWSCmdlet("Calls the Amazon GameLiftStreams GetStreamSession API operation.", Operation = new[] {"GetStreamSession"}, SelectReturnType = typeof(Amazon.GameLiftStreams.Model.GetStreamSessionResponse))]
    [AWSCmdletOutput("Amazon.GameLiftStreams.Model.GetStreamSessionResponse",
        "This cmdlet returns an Amazon.GameLiftStreams.Model.GetStreamSessionResponse object containing multiple properties."
    )]
    public partial class GetGMLSStreamSessionCmdlet : AmazonGameLiftStreamsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLiftStreams.Model.GetStreamSessionResponse, GetGMLSStreamSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameLiftStreams.Model.GetStreamSessionRequest();
        ...
        private Amazon.GameLiftStreams.Model.GetStreamSessionResponse CallAWSServiceOperation(IAmazonGameLiftStreams client, Amazon.GameLiftStreams.Model.GetStreamSessionRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Identifier { get; set; }
            public System.String StreamSessionIdentifier { get; set; }
            public System.Func<Amazon.GameLiftStreams.Model.GetStreamSessionResponse, GetGMLSStreamSessionCmdlet, object> Select { get; set; } =
