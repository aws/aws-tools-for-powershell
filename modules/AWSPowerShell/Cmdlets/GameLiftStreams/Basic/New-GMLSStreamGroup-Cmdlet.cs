...
namespace Amazon.PowerShell.Cmdlets.GMLS
{
    ...
    public partial class NewGMLSStreamGroupCmdlet : AmazonGameLiftStreamsClientCmdlet, IExecutor
    {
        ...
        /// and anti-cheat technology. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 8 vCPUs, 32 GB RAM, 24 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen6n_ultra</c> (NVIDIA, ultra)</b> Supports applications with high 3D scene
        /// complexity. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 8 vCPUs, 32 GB RAM, 24 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen6n_high</c> (NVIDIA, high)</b> Supports applications with moderate to high
        /// 3D scene complexity. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 4 vCPUs, 16 GB RAM, 12 GB VRAM</para></li><li><para>Tenancy: Supports up to 2 concurrent stream sessions</para></li></ul></li><li><para><b><c>gen6n_medium</c> (NVIDIA, medium)</b> Supports applications with moderate
        ...
        /// 3D scene complexity and low CPU usage. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 1 vCPUs, 4 GB RAM, 2 GB VRAM</para></li><li><para>Tenancy: Supports up to 12 concurrent stream sessions</para></li></ul></li><li><para><b><c>gen6n_medium_win2022</c> (NVIDIA, medium)</b> Supports applications with low
        /// 3D scene complexity. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 8 vCPUs, 32 GB RAM, 6 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen6n_small_win2022</c> (NVIDIA, small)</b> Supports applications with low
        /// 3D scene complexity. Powered by NVIDIA L4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 2 vCPUs, 8 GB RAM, 3 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen6e_pro_win2022</c> (NVIDIA, pro)</b> Supports applications with extremely
        /// high 3D scene complexity which require maximum resources. Runs applications on Microsoft
        /// Windows Server 2022 Base and supports DirectX 12. Compatible with Unreal Engine versions
        /// up through 5.6, 32 and 64-bit applications, and anti-cheat technology. Powered by
        /// NVIDIA L40S Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 16 vCPUs, 128 GB RAM, 48 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen6e_pro</c> (NVIDIA, pro)</b> Supports applications with extremely high
        /// 3D scene complexity which require maximum resources. Powered by NVIDIA L40S Tensor
        /// Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 16 vCPUs, 128 GB RAM, 48 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li><li><para><b><c>gen5n_win2022</c> (NVIDIA, ultra)</b> Supports applications with extremely
        ...
        /// 3D scene complexity. Powered by NVIDIA A10G Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 4 vCPUs, 16 GB RAM, 12 GB VRAM</para></li><li><para>Tenancy: Supports up to 2 concurrent stream sessions</para></li></ul></li><li><para><b><c>gen5n_ultra</c> (NVIDIA, ultra)</b> Supports applications with extremely high
        ...
        /// 3D scene complexity. Powered by NVIDIA T4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 4 vCPUs, 16 GB RAM, 8 GB VRAM</para></li><li><para>Tenancy: Supports up to 2 concurrent stream sessions</para></li></ul></li><li><para><b><c>gen4n_ultra</c> (NVIDIA, ultra)</b> Supports applications with high 3D scene
        /// complexity. Powered by NVIDIA T4 Tensor Core GPUs.</para><ul><li><para>Reference resolution: 1080p</para></li><li><para>Reference frame rate: 60 fps</para></li><li><para>Workload specifications: 8 vCPUs, 32 GB RAM, 16 GB VRAM</para></li><li><para>Tenancy: Supports 1 concurrent stream session</para></li></ul></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
