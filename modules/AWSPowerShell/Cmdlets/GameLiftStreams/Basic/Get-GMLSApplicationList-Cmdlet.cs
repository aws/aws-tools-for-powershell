...
namespace Amazon.PowerShell.Cmdlets.GMLS
{
    ...
    /// </summary>
    [Cmdlet("Get", "GMLSApplicationList")]
    [OutputType("Amazon.GameLiftStreams.Model.ApplicationSummary")]
    [AWSCmdlet("Calls the Amazon GameLiftStreams ListApplications API operation.", Operation = new[] {"ListApplications"}, SelectReturnType = typeof(Amazon.GameLiftStreams.Model.ListApplicationsResponse))]
    [AWSCmdletOutput("Amazon.GameLiftStreams.Model.ApplicationSummary or Amazon.GameLiftStreams.Model.ListApplicationsResponse",
        "This cmdlet returns a collection of Amazon.GameLiftStreams.Model.ApplicationSummary objects.",
        "The service call response (type Amazon.GameLiftStreams.Model.ListApplicationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGMLSApplicationListCmdlet : AmazonGameLiftStreamsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GameLiftStreams.Model.ListApplicationsResponse, GetGMLSApplicationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GameLiftStreams.Model.ListApplicationsRequest();
        ...
        private Amazon.GameLiftStreams.Model.ListApplicationsResponse CallAWSServiceOperation(IAmazonGameLiftStreams client, Amazon.GameLiftStreams.Model.ListApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameLiftStreams", "ListApplications");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GameLiftStreams.Model.ListApplicationsResponse, GetGMLSApplicationListCmdlet, object> Select { get; set; } =
