#
# Module manifest for module 'AWS.Tools.GameLiftStreams'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.GameLiftStreams.dll'
    ...
    GUID = '73263797-d5dd-49fe-95e4-08a0804ca350'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.GameLiftStreams.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.GameLiftStreams.Completers.psm1',
        'AWS.Tools.GameLiftStreams.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.GameLiftStreams.dll-Help.xml'
    )
