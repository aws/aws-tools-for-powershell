...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "LFVResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddLFVResourceTagCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key-value tags to assign to the model.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-LFVResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.TagResourceResponse, AddLFVResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutforVision.Model.TagResourceRequest();
        ...
        private Amazon.LookoutforVision.Model.TagResourceResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LookoutforVision.Model.TagResourceResponse, AddLFVResourceTagCmdlet, object> Select { get; set; } =
