...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    /// </summary>
    [Cmdlet("Get", "LFVProjectList")]
    [OutputType("Amazon.LookoutforVision.Model.ProjectMetadata")]
    [AWSCmdlet("Calls the Amazon Lookout for Vision ListProjects API operation.", Operation = new[] {"ListProjects"}, SelectReturnType = typeof(Amazon.LookoutforVision.Model.ListProjectsResponse))]
    [AWSCmdletOutput("Amazon.LookoutforVision.Model.ProjectMetadata or Amazon.LookoutforVision.Model.ListProjectsResponse",
        "This cmdlet returns a collection of Amazon.LookoutforVision.Model.ProjectMetadata objects.",
        "The service call response (type Amazon.LookoutforVision.Model.ListProjectsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLFVProjectListCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.ListProjectsResponse, GetLFVProjectListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LookoutforVision.Model.ListProjectsRequest();
        ...
        private Amazon.LookoutforVision.Model.ListProjectsResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.ListProjectsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "ListProjects");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LookoutforVision.Model.ListProjectsResponse, GetLFVProjectListCmdlet, object> Select { get; set; } =
