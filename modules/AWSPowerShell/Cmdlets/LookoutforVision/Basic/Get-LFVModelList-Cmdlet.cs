...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    [AWSCmdlet("Calls the Amazon Lookout for Vision ListModels API operation.", Operation = new[] {"ListModels"}, SelectReturnType = typeof(Amazon.LookoutforVision.Model.ListModelsResponse))]
    [AWSCmdletOutput("Amazon.LookoutforVision.Model.ModelMetadata or Amazon.LookoutforVision.Model.ListModelsResponse",
        "This cmdlet returns a collection of Amazon.LookoutforVision.Model.ModelMetadata objects.",
        "The service call response (type Amazon.LookoutforVision.Model.ListModelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLFVModelListCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.ListModelsResponse, GetLFVModelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LookoutforVision.Model.ListModelsRequest();
        ...
        private Amazon.LookoutforVision.Model.ListModelsResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.ListModelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "ListModels");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProjectName { get; set; }
            public System.Func<Amazon.LookoutforVision.Model.ListModelsResponse, GetLFVModelListCmdlet, object> Select { get; set; } =
