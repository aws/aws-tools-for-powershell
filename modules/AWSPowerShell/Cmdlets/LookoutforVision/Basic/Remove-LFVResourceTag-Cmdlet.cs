...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "LFVResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLFVResourceTagCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LFVResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.UntagResourceResponse, RemoveLFVResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutforVision.Model.UntagResourceRequest();
        ...
        private Amazon.LookoutforVision.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LookoutforVision.Model.UntagResourceResponse, RemoveLFVResourceTagCmdlet, object> Select { get; set; } =
