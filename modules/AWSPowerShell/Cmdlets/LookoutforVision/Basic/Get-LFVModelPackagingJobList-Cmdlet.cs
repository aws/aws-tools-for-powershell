...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    /// </summary>
    [Cmdlet("Get", "LFVModelPackagingJobList")]
    [OutputType("Amazon.LookoutforVision.Model.ModelPackagingJobMetadata")]
    ...
    public partial class GetLFVModelPackagingJobListCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ModelPackagingJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.ListModelPackagingJobsResponse, GetLFVModelPackagingJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LookoutforVision.Model.ListModelPackagingJobsRequest();
        ...
        private Amazon.LookoutforVision.Model.ListModelPackagingJobsResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.ListModelPackagingJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "ListModelPackagingJobs");
            try
            {
                #if DESKTOP
                return client.ListModelPackagingJobs(request);
                #elif CORECLR
                return client.ListModelPackagingJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProjectName { get; set; }
            public System.Func<Amazon.LookoutforVision.Model.ListModelPackagingJobsResponse, GetLFVModelPackagingJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ModelPackagingJobs;
        }
