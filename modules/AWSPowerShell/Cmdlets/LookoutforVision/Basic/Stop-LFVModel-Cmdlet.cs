...
namespace Amazon.PowerShell.Cmdlets.LFV
{
    ...
    public partial class StopLFVModelCmdlet : AmazonLookoutforVisionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ClientToken is an idempotency token that ensures a call to <c>StopModel</c> completes
        ...
        /// <c>StopModel</c> by using the same <c>ClientToken</c> parameter value.</para><para>If you don't supply a value for <c>ClientToken</c>, the AWS SDK you are using inserts
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-LFVModel (StopModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LookoutforVision.Model.StopModelResponse, StopLFVModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LookoutforVision.Model.StopModelRequest();
        ...
        private Amazon.LookoutforVision.Model.StopModelResponse CallAWSServiceOperation(IAmazonLookoutforVision client, Amazon.LookoutforVision.Model.StopModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lookout for Vision", "StopModel");
            try
            {
                return client.StopModelAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ModelVersion { get; set; }
            public System.String ProjectName { get; set; }
            public System.Func<Amazon.LookoutforVision.Model.StopModelResponse, StopLFVModelCmdlet, object> Select { get; set; } =
