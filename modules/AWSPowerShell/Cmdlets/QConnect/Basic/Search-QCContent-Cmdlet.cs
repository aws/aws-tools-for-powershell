...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// content resource by its name.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Search", "QCContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QConnect.Model.ContentSummary")]
    [AWSCmdlet("Calls the Amazon Q Connect SearchContent API operation.", Operation = new[] {"SearchContent"}, SelectReturnType = typeof(Amazon.QConnect.Model.SearchContentResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.ContentSummary or Amazon.QConnect.Model.SearchContentResponse",
        "This cmdlet returns a collection of Amazon.QConnect.Model.ContentSummary objects.",
        "The service call response (type Amazon.QConnect.Model.SearchContentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SearchQCContentCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The search expression filters.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.SearchContentResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.SearchContentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-QCContent (SearchContent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.SearchContentResponse, SearchQCContentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QConnect.Model.SearchContentRequest();
        ...
        private Amazon.QConnect.Model.SearchContentResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.SearchContentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "SearchContent");
            try
            {
                return client.SearchContentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QConnect.Model.SearchContentResponse, SearchQCContentCmdlet, object> Select { get; set; } =
