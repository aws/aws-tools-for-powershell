...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Disable", "QCMessageTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.QConnect.Model.DeactivateMessageTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Q Connect DeactivateMessageTemplate API operation.", Operation = new[] {"DeactivateMessageTemplate"}, SelectReturnType = typeof(Amazon.QConnect.Model.DeactivateMessageTemplateResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.DeactivateMessageTemplateResponse",
        "This cmdlet returns an Amazon.QConnect.Model.DeactivateMessageTemplateResponse object containing multiple properties."
    )]
    public partial class DisableQCMessageTemplateCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The version number of the message template version to deactivate.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.DeactivateMessageTemplateResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.DeactivateMessageTemplateResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-QCMessageTemplate (DeactivateMessageTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.DeactivateMessageTemplateResponse, DisableQCMessageTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.DeactivateMessageTemplateRequest();
        ...
        private Amazon.QConnect.Model.DeactivateMessageTemplateResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.DeactivateMessageTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "DeactivateMessageTemplate");
            try
            {
                #if DESKTOP
                return client.DeactivateMessageTemplate(request);
                #elif CORECLR
                return client.DeactivateMessageTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MessageTemplateId { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.QConnect.Model.DeactivateMessageTemplateResponse, DisableQCMessageTemplateCmdlet, object> Select { get; set; } =
