...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    [AWSCmdlet("Calls the Amazon Q Connect CreateContent API operation.", Operation = new[] {"CreateContent"}, SelectReturnType = typeof(Amazon.QConnect.Model.CreateContentResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.ContentData or Amazon.QConnect.Model.CreateContentResponse",
        "This cmdlet returns an Amazon.QConnect.Model.ContentData object.",
        "The service call response (type Amazon.QConnect.Model.CreateContentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewQCContentCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// with the <a href="https://docs.aws.amazon.com/amazon-q-connect/latest/APIReference/API_SearchContent.html">SearchContent</a>
        /// API.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>A pointer to the uploaded asset. This value is returned by <a href="https://docs.aws.amazon.com/amazon-q-connect/latest/APIReference/API_StartContentUpload.html">StartContentUpload</a>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.CreateContentResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.CreateContentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-QCContent (CreateContent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.CreateContentResponse, NewQCContentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.CreateContentRequest();
        ...
        private Amazon.QConnect.Model.CreateContentResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.CreateContentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "CreateContent");
            try
            {
                #if DESKTOP
                return client.CreateContent(request);
                #elif CORECLR
                return client.CreateContentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Title { get; set; }
            public System.String UploadId { get; set; }
            public System.Func<Amazon.QConnect.Model.CreateContentResponse, NewQCContentCmdlet, object> Select { get; set; } =
