...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Get", "QCAIPrompt")]
    [OutputType("Amazon.QConnect.Model.GetAIPromptResponse")]
    [AWSCmdlet("Calls the Amazon Q Connect GetAIPrompt API operation.", Operation = new[] {"GetAIPrompt"}, SelectReturnType = typeof(Amazon.QConnect.Model.GetAIPromptResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.GetAIPromptResponse",
        "This cmdlet returns an Amazon.QConnect.Model.GetAIPromptResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQCAIPromptCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.GetAIPromptResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.GetAIPromptResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.GetAIPromptResponse, GetQCAIPromptCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.GetAIPromptRequest();
        ...
        private Amazon.QConnect.Model.GetAIPromptResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.GetAIPromptRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "GetAIPrompt");
            try
            {
                #if DESKTOP
                return client.GetAIPrompt(request);
                #elif CORECLR
                return client.GetAIPromptAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AiPromptId { get; set; }
            public System.String AssistantId { get; set; }
            public System.Func<Amazon.QConnect.Model.GetAIPromptResponse, GetQCAIPromptCmdlet, object> Select { get; set; } =
