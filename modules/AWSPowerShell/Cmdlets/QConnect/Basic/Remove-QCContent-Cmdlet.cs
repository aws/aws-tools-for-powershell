...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// Deletes the content.
    /// </summary>
    [Cmdlet("Remove", "QCContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveQCContentCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.DeleteContentResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QCContent (DeleteContent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.DeleteContentResponse, RemoveQCContentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.DeleteContentRequest();
        ...
        private Amazon.QConnect.Model.DeleteContentResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.DeleteContentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "DeleteContent");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ContentId { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.QConnect.Model.DeleteContentResponse, RemoveQCContentCmdlet, object> Select { get; set; } =
