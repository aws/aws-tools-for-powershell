...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// recommendations.
    /// </summary>
    [Cmdlet("Remove", "QCRecommendationsReceived", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveQCRecommendationsReceivedCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifiers of the recommendations.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.NotifyRecommendationsReceivedResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.NotifyRecommendationsReceivedResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QCRecommendationsReceived (NotifyRecommendationsReceived)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.NotifyRecommendationsReceivedResponse, RemoveQCRecommendationsReceivedCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.NotifyRecommendationsReceivedRequest();
        ...
        private Amazon.QConnect.Model.NotifyRecommendationsReceivedResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.NotifyRecommendationsReceivedRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "NotifyRecommendationsReceived");
            try
            {
                return client.NotifyRecommendationsReceivedAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SessionId { get; set; }
            public System.Func<Amazon.QConnect.Model.NotifyRecommendationsReceivedResponse, RemoveQCRecommendationsReceivedCmdlet, object> Select { get; set; } =
