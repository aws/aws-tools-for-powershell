...
{
    /// <summary>
    /// Lists the content.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "QCContentList")]
    ...
    public partial class GetQCContentListCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.ListContentsResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.ListContentsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.ListContentsResponse, GetQCContentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.QConnect.Model.ListContentsRequest();
        ...
        private Amazon.QConnect.Model.ListContentsResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.ListContentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "ListContents");
            try
            {
                return client.ListContentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.QConnect.Model.ListContentsResponse, GetQCContentListCmdlet, object> Select { get; set; } =
