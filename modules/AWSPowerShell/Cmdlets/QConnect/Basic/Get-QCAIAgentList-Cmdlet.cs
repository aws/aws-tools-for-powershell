...
{
    /// <summary>
    /// Lists AI Agents.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.QConnect.Model.AIAgentSummary or Amazon.QConnect.Model.ListAIAgentsResponse",
        ...
        "The service call response (type Amazon.QConnect.Model.ListAIAgentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQCAIAgentListCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.QConnect.Model.ListAIAgentsResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.ListAIAgentsRequest request)
        {
            ...
            try
            {
                return client.ListAIAgentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
