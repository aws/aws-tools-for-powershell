...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "QCAIPrompt", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Q Connect DeleteAIPrompt API operation.", Operation = new[] {"DeleteAIPrompt"}, SelectReturnType = typeof(Amazon.QConnect.Model.DeleteAIPromptResponse))]
    [AWSCmdletOutput("None or Amazon.QConnect.Model.DeleteAIPromptResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.QConnect.Model.DeleteAIPromptResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveQCAIPromptCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the Amazon Q in Connect AI prompt. Can be either the ID or the ARN.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.DeleteAIPromptResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QCAIPrompt (DeleteAIPrompt)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.DeleteAIPromptResponse, RemoveQCAIPromptCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.DeleteAIPromptRequest();
        ...
        private Amazon.QConnect.Model.DeleteAIPromptResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.DeleteAIPromptRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "DeleteAIPrompt");
            try
            {
                #if DESKTOP
                return client.DeleteAIPrompt(request);
                #elif CORECLR
                return client.DeleteAIPromptAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AiPromptId { get; set; }
            public System.String AssistantId { get; set; }
            public System.Func<Amazon.QConnect.Model.DeleteAIPromptResponse, RemoveQCAIPromptCmdlet, object> Select { get; set; } =
