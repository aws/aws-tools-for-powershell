...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// type CUSTOM.
    /// </summary>
    [Cmdlet("Start", "QCContentUpload", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartQCContentUploadCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.StartContentUploadResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.StartContentUploadResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-QCContentUpload (StartContentUpload)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.StartContentUploadResponse, StartQCContentUploadCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.StartContentUploadRequest();
        ...
        private Amazon.QConnect.Model.StartContentUploadResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.StartContentUploadRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "StartContentUpload");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String KnowledgeBaseId { get; set; }
            public System.Int32? PresignedUrlTimeToLive { get; set; }
            public System.Func<Amazon.QConnect.Model.StartContentUploadResponse, StartQCContentUploadCmdlet, object> Select { get; set; } =
