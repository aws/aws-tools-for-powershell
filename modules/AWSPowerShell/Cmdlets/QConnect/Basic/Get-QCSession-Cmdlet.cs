...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Get", "QCSession")]
    [OutputType("Amazon.QConnect.Model.SessionData")]
    [AWSCmdlet("Calls the Amazon Q Connect GetSession API operation.", Operation = new[] {"GetSession"}, SelectReturnType = typeof(Amazon.QConnect.Model.GetSessionResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.SessionData or Amazon.QConnect.Model.GetSessionResponse",
        "This cmdlet returns an Amazon.QConnect.Model.SessionData object.",
        "The service call response (type Amazon.QConnect.Model.GetSessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetQCSessionCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.GetSessionResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.GetSessionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.GetSessionResponse, GetQCSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.GetSessionRequest();
        ...
        private Amazon.QConnect.Model.GetSessionResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.GetSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "GetSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssistantId { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.QConnect.Model.GetSessionResponse, GetQCSessionCmdlet, object> Select { get; set; } =
