...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "QCMessageTemplateAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Q Connect DeleteMessageTemplateAttachment API operation.", Operation = new[] {"DeleteMessageTemplateAttachment"}, SelectReturnType = typeof(Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse))]
    [AWSCmdletOutput("None or Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveQCMessageTemplateAttachmentCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the attachment file.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QCMessageTemplateAttachment (DeleteMessageTemplateAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse, RemoveQCMessageTemplateAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.DeleteMessageTemplateAttachmentRequest();
        ...
        private Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.DeleteMessageTemplateAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "DeleteMessageTemplateAttachment");
            try
            {
                #if DESKTOP
                return client.DeleteMessageTemplateAttachment(request);
                #elif CORECLR
                return client.DeleteMessageTemplateAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String KnowledgeBaseId { get; set; }
            public System.String MessageTemplateId { get; set; }
            public System.Func<Amazon.QConnect.Model.DeleteMessageTemplateAttachmentResponse, RemoveQCMessageTemplateAttachmentCmdlet, object> Select { get; set; } =
