...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "QCAIGuardrailVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Q Connect DeleteAIGuardrailVersion API operation.", Operation = new[] {"DeleteAIGuardrailVersion"}, SelectReturnType = typeof(Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse))]
    [AWSCmdletOutput("None or Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveQCAIGuardrailVersionCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The version number of the AI Guardrail version to be deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-QCAIGuardrailVersion (DeleteAIGuardrailVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse, RemoveQCAIGuardrailVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.DeleteAIGuardrailVersionRequest();
        ...
        private Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.DeleteAIGuardrailVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "DeleteAIGuardrailVersion");
            try
            {
                #if DESKTOP
                return client.DeleteAIGuardrailVersion(request);
                #elif CORECLR
                return client.DeleteAIGuardrailVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AssistantId { get; set; }
            public System.Int64? VersionNumber { get; set; }
            public System.Func<Amazon.QConnect.Model.DeleteAIGuardrailVersionResponse, RemoveQCAIGuardrailVersionCmdlet, object> Select { get; set; } =
