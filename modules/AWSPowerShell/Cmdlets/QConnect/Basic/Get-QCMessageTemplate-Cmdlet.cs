...
namespace Amazon.PowerShell.Cmdlets.QC
{
    ...
    /// </summary>
    [Cmdlet("Get", "QCMessageTemplate")]
    [OutputType("Amazon.QConnect.Model.ExtendedMessageTemplateData")]
    [AWSCmdlet("Calls the Amazon Q Connect GetMessageTemplate API operation.", Operation = new[] {"GetMessageTemplate"}, SelectReturnType = typeof(Amazon.QConnect.Model.GetMessageTemplateResponse))]
    [AWSCmdletOutput("Amazon.QConnect.Model.ExtendedMessageTemplateData or Amazon.QConnect.Model.GetMessageTemplateResponse",
        "This cmdlet returns an Amazon.QConnect.Model.ExtendedMessageTemplateData object.",
        "The service call response (type Amazon.QConnect.Model.GetMessageTemplateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetQCMessageTemplateCmdlet : AmazonQConnectClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.QConnect.Model.GetMessageTemplateResponse).
        /// Specifying the name of a property of type Amazon.QConnect.Model.GetMessageTemplateResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QConnect.Model.GetMessageTemplateResponse, GetQCMessageTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QConnect.Model.GetMessageTemplateRequest();
        ...
        private Amazon.QConnect.Model.GetMessageTemplateResponse CallAWSServiceOperation(IAmazonQConnect client, Amazon.QConnect.Model.GetMessageTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Q Connect", "GetMessageTemplate");
            try
            {
                #if DESKTOP
                return client.GetMessageTemplate(request);
                #elif CORECLR
                return client.GetMessageTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.String MessageTemplateId { get; set; }
            public System.Func<Amazon.QConnect.Model.GetMessageTemplateResponse, GetQCMessageTemplateCmdlet, object> Select { get; set; } =
