#
# Module manifest for module 'AWS.Tools.QConnect'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.QConnect.dll'
    ...
    GUID = '9ef1fd55-f80e-4a6d-a074-e5fda14b517c'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.QConnect.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.QConnect.Completers.psm1',
        'AWS.Tools.QConnect.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.QConnect.dll-Help.xml'
    )
