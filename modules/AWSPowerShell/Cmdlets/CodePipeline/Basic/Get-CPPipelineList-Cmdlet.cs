...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    [AWSCmdlet("Calls the AWS CodePipeline ListPipelines API operation.", Operation = new[] {"ListPipelines"}, SelectReturnType = typeof(Amazon.CodePipeline.Model.ListPipelinesResponse))]
    [AWSCmdletOutput("Amazon.CodePipeline.Model.PipelineSummary or Amazon.CodePipeline.Model.ListPipelinesResponse",
        "This cmdlet returns a collection of Amazon.CodePipeline.Model.PipelineSummary objects.",
        "The service call response (type Amazon.CodePipeline.Model.ListPipelinesResponse) can be returned by specifying '-Select *'."
    )]
