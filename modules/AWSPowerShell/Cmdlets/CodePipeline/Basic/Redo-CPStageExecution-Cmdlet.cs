...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    public partial class RedoCPStageExecutionCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.RetryStageExecutionResponse, RedoCPStageExecutionCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.RetryMode == null && ParameterWasBound(nameof(this.RetryMode)))
            {
                WriteWarning("You are passing $null as a value for parameter RetryMode which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.CodePipeline.Model.RetryStageExecutionResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.RetryStageExecutionRequest request)
        {
            ...
            try
            {
                return client.RetryStageExecutionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CodePipeline.StageRetryMode RetryMode { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.CodePipeline.Model.RetryStageExecutionResponse, RedoCPStageExecutionCmdlet, object> Select { get; set; } =
