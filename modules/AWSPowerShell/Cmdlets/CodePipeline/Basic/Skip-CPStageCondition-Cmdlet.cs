...
{
    /// <summary>
    /// Used to override a stage condition. For more information about conditions, see <a href="https://docs.aws.amazon.com/codepipeline/latest/userguide/stage-conditions.html">Stage
    ...
    public partial class SkipCPStageConditionCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodePipeline.Model.OverrideStageConditionResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.OverrideStageConditionRequest request)
        {
            ...
            try
            {
                return client.OverrideStageConditionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
