...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    [AWSCmdlet("Calls the AWS CodePipeline ListWebhooks API operation.", Operation = new[] {"ListWebhooks"}, SelectReturnType = typeof(Amazon.CodePipeline.Model.ListWebhooksResponse))]
    [AWSCmdletOutput("Amazon.CodePipeline.Model.ListWebhookItem or Amazon.CodePipeline.Model.ListWebhooksResponse",
        "This cmdlet returns a collection of Amazon.CodePipeline.Model.ListWebhookItem objects.",
        "The service call response (type Amazon.CodePipeline.Model.ListWebhooksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCPWebhookListCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.ListWebhooksResponse, GetCPWebhookListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodePipeline.Model.ListWebhooksRequest();
        ...
        private Amazon.CodePipeline.Model.ListWebhooksResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.ListWebhooksRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodePipeline.Model.ListWebhooksResponse, GetCPWebhookListCmdlet, object> Select { get; set; } =
