...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CodePipeline PutJobFailureResult API operation.", Operation = new[] {"PutJobFailureResult"}, SelectReturnType = typeof(Amazon.CodePipeline.Model.PutJobFailureResultResponse))]
    [AWSCmdletOutput("None or Amazon.CodePipeline.Model.PutJobFailureResultResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CodePipeline.Model.PutJobFailureResultResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteCPJobFailureResultCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.PutJobFailureResultResponse, WriteCPJobFailureResultCmdlet>(Select) ??
        ...
        private Amazon.CodePipeline.Model.PutJobFailureResultResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.PutJobFailureResultRequest request)
        {
            ...
            try
            {
                return client.PutJobFailureResultAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CodePipeline.FailureType FailureDetails_Type { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.CodePipeline.Model.PutJobFailureResultResponse, WriteCPJobFailureResultCmdlet, object> Select { get; set; } =
