...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CPWebhook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCPWebhookCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CPWebhook (DeleteWebhook)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.DeleteWebhookResponse, RemoveCPWebhookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodePipeline.Model.DeleteWebhookRequest();
        ...
        private Amazon.CodePipeline.Model.DeleteWebhookResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.DeleteWebhookRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodePipeline", "DeleteWebhook");
            try
            {
                return client.DeleteWebhookAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CodePipeline.Model.DeleteWebhookResponse, RemoveCPWebhookCmdlet, object> Select { get; set; } =
