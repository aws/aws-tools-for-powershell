...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    public partial class GetCPPipelineStateCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.GetPipelineStateResponse, GetCPPipelineStateCmdlet>(Select) ??
        ...
        private Amazon.CodePipeline.Model.GetPipelineStateResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.GetPipelineStateRequest request)
        {
            ...
            try
            {
                return client.GetPipelineStateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CodePipeline.Model.GetPipelineStateResponse, GetCPPipelineStateCmdlet, object> Select { get; set; } =
