...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    public partial class NewCPCustomActionTypeCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        /// a Custom Action for a Pipeline</a>.</para></note><para />
        ...
        /// group. This link is provided as part of the action display in the pipeline.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The URL returned to the CodePipeline console that contains a link to the top-level
        ...
        /// link to the execution entity of the external action.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The tags for the custom action.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.CodePipeline.Model.CreateCustomActionTypeResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.CreateCustomActionTypeRequest request)
        {
            ...
            try
            {
                return client.CreateCustomActionTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
