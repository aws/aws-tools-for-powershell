...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    [AWSCmdlet("Calls the AWS CodePipeline GetThirdPartyJobDetails API operation.", Operation = new[] {"GetThirdPartyJobDetails"}, SelectReturnType = typeof(Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse), LegacyAlias="Get-CPThirdPartyJobDetails")]
    [AWSCmdletOutput("Amazon.CodePipeline.Model.ThirdPartyJobDetails or Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse",
        "This cmdlet returns an Amazon.CodePipeline.Model.ThirdPartyJobDetails object.",
        "The service call response (type Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCPThirdPartyJobDetailCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "JobDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse, GetCPThirdPartyJobDetailCmdlet>(Select) ??
        ...
        private Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.GetThirdPartyJobDetailsRequest request)
        {
            ...
            try
            {
                return client.GetThirdPartyJobDetailsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.CodePipeline.Model.GetThirdPartyJobDetailsResponse, GetCPThirdPartyJobDetailCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.JobDetails;
        }
