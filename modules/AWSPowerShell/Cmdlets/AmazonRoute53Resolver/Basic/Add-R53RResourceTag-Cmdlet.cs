...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    /// </summary>
    [Cmdlet("Add", "R53RResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon Route 53 Resolver TagResource API operation.", Operation = new[] {"TagResource"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.Route53Resolver.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddR53RResourceTagCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-R53RResourceTag (TagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Resolver.Model.TagResourceRequest();
        ...
        private Amazon.Route53Resolver.Model.TagResourceResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Resolver", "TagResource");
            try
            {
                #if DESKTOP
