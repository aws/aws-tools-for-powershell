...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverEndpointIpAddresses API operation.", Operation = new[] {"ListResolverEndpointIpAddresses"})]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.IpAddressResponse",
        "This cmdlet returns a collection of IpAddressResponse objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListResolverEndpointIpAddressesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetR53RResolverEndpointIpAddressListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.IpAddresses;
                        ...
                        int _receivedThisCall = response.IpAddresses.Count;
        ...
        private Amazon.Route53Resolver.Model.ListResolverEndpointIpAddressesResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListResolverEndpointIpAddressesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListResolverEndpointIpAddresses(request);
                #elif CORECLR
                return client.ListResolverEndpointIpAddressesAsync(request).GetAwaiter().GetResult();
                #else
