...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver GetResolverRule API operation.", Operation = new[] {"GetResolverRule"})]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverRule",
        "This cmdlet returns a ResolverRule object.",
        "The service call response (type Amazon.Route53Resolver.Model.GetResolverRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53RResolverRuleCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        private Amazon.Route53Resolver.Model.GetResolverRuleResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.GetResolverRuleRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetResolverRuleAsync(request);
                return task.Result;
                #else
