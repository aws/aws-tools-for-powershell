...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverRuleAssociations API operation.", Operation = new[] {"ListResolverRuleAssociations"})]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverRuleAssociation",
        "This cmdlet returns a collection of ResolverRuleAssociation objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetR53RResolverRuleAssociationListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53Resolver.Model.ListResolverRuleAssociationsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ResolverRuleAssociations;
                        ...
                        int _receivedThisCall = response.ResolverRuleAssociations.Count;
        ...
        private Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListResolverRuleAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Resolver", "ListResolverRuleAssociations");
            try
            {
                #if DESKTOP
                return client.ListResolverRuleAssociations(request);
                #elif CORECLR
                return client.ListResolverRuleAssociationsAsync(request).GetAwaiter().GetResult();
                #else
