...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverEndpoints API operation.", Operation = new[] {"ListResolverEndpoints"})]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverEndpoint",
        "This cmdlet returns a collection of ResolverEndpoint objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ResolverEndpoints;
