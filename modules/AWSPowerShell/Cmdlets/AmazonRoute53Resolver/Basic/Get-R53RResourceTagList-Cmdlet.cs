...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53RResourceTagList")]
    [OutputType("Amazon.Route53Resolver.Model.Tag")]
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.Tag",
        "This cmdlet returns a collection of Tag objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListTagsForResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetR53RResourceTagListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53Resolver.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Route53Resolver.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Resolver", "ListTagsForResource");
            try
            {
                #if DESKTOP
