...
{
    /// <summary>
    /// Returns a list of the audience export jobs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CleanRoomsML.Model.AudienceExportJobSummary or Amazon.CleanRoomsML.Model.ListAudienceExportJobsResponse",
        ...
        "The service call response (type Amazon.CleanRoomsML.Model.ListAudienceExportJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRMLAudienceExportJobListCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRoomsML.Model.ListAudienceExportJobsResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.ListAudienceExportJobsRequest request)
        {
            ...
            try
            {
                return client.ListAudienceExportJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
