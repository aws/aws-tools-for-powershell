...
{
    /// <summary>
    /// Returns a list of audience generation jobs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCRMLAudienceGenerationJobListCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRoomsML.Model.ListAudienceGenerationJobsResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.ListAudienceGenerationJobsRequest request)
        {
            ...
            try
            {
                return client.ListAudienceGenerationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
