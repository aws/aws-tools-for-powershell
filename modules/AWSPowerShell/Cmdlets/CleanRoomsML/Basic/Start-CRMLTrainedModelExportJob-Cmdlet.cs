...
namespace Amazon.PowerShell.Cmdlets.CRML
{
    ...
    public partial class StartCRMLTrainedModelExportJobCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The members that will received the exported trained model output.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The version identifier of the trained model to export. This specifies which version
        /// of the trained model should be exported to the specified destination.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.CleanRoomsML.Model.StartTrainedModelExportJobResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.StartTrainedModelExportJobRequest request)
        {
            ...
            try
            {
                return client.StartTrainedModelExportJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
