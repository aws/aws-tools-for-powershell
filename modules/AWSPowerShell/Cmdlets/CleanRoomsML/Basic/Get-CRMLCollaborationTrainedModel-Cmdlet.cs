...
namespace Amazon.PowerShell.Cmdlets.CRML
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRMLCollaborationTrainedModel")]
    [OutputType("Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse")]
    ...
    [AWSCmdletOutput("Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse",
        "This cmdlet returns an Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse object containing multiple properties."
    )]
    public partial class GetCRMLCollaborationTrainedModelCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse, GetCRMLCollaborationTrainedModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelRequest();
        ...
        private Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CleanRoomsML", "GetCollaborationTrainedModel");
            try
            {
                #if DESKTOP
                return client.GetCollaborationTrainedModel(request);
                #elif CORECLR
                return client.GetCollaborationTrainedModelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CollaborationIdentifier { get; set; }
            public System.String TrainedModelArn { get; set; }
            public System.Func<Amazon.CleanRoomsML.Model.GetCollaborationTrainedModelResponse, GetCRMLCollaborationTrainedModelCmdlet, object> Select { get; set; } =
