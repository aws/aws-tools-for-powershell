...
namespace Amazon.PowerShell.Cmdlets.CRML
{
    ...
    [OutputType("Amazon.CleanRoomsML.Model.CollaborationTrainedModelSummary")]
    [AWSCmdlet("Calls the CleanRoomsML ListCollaborationTrainedModels API operation.", Operation = new[] {"ListCollaborationTrainedModels"}, SelectReturnType = typeof(Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse))]
    [AWSCmdletOutput("Amazon.CleanRoomsML.Model.CollaborationTrainedModelSummary or Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse",
        "This cmdlet returns a collection of Amazon.CleanRoomsML.Model.CollaborationTrainedModelSummary objects.",
        "The service call response (type Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRMLCollaborationTrainedModelListCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CollaborationTrainedModels";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse, GetCRMLCollaborationTrainedModelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsRequest();
        ...
        private Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CleanRoomsML", "ListCollaborationTrainedModels");
            try
            {
                #if DESKTOP
                return client.ListCollaborationTrainedModels(request);
                #elif CORECLR
                return client.ListCollaborationTrainedModelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelsResponse, GetCRMLCollaborationTrainedModelListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CollaborationTrainedModels;
        }
