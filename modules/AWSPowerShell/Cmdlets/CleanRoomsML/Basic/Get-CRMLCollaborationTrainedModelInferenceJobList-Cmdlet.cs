...
{
    /// <summary>
    /// Returns a list of trained model inference jobs in a specified collaboration.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCRMLCollaborationTrainedModelInferenceJobListCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelInferenceJobsResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelInferenceJobsRequest request)
        {
            ...
            try
            {
                return client.ListCollaborationTrainedModelInferenceJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
