...
namespace Amazon.PowerShell.Cmdlets.CRML
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRMLCollaborationConfiguredModelAlgorithmAssociation")]
    [OutputType("Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse")]
    [AWSCmdlet("Calls the CleanRoomsML GetCollaborationConfiguredModelAlgorithmAssociation API operation.", Operation = new[] {"GetCollaborationConfiguredModelAlgorithmAssociation"}, SelectReturnType = typeof(Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse))]
    [AWSCmdletOutput("Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse",
        "This cmdlet returns an Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse object containing multiple properties."
    )]
    public partial class GetCRMLCollaborationConfiguredModelAlgorithmAssociationCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse, GetCRMLCollaborationConfiguredModelAlgorithmAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationRequest();
        ...
        private Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CleanRoomsML", "GetCollaborationConfiguredModelAlgorithmAssociation");
            try
            {
                #if DESKTOP
                return client.GetCollaborationConfiguredModelAlgorithmAssociation(request);
                #elif CORECLR
                return client.GetCollaborationConfiguredModelAlgorithmAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CollaborationIdentifier { get; set; }
            public System.String ConfiguredModelAlgorithmAssociationArn { get; set; }
            public System.Func<Amazon.CleanRoomsML.Model.GetCollaborationConfiguredModelAlgorithmAssociationResponse, GetCRMLCollaborationConfiguredModelAlgorithmAssociationCmdlet, object> Select { get; set; } =
