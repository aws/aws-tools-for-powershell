...
namespace Amazon.PowerShell.Cmdlets.CRML
{
    ...
    [OutputType("Amazon.CleanRoomsML.Model.CollaborationTrainedModelExportJobSummary")]
    [AWSCmdlet("Calls the CleanRoomsML ListCollaborationTrainedModelExportJobs API operation.", Operation = new[] {"ListCollaborationTrainedModelExportJobs"}, SelectReturnType = typeof(Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse))]
    [AWSCmdletOutput("Amazon.CleanRoomsML.Model.CollaborationTrainedModelExportJobSummary or Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse",
        "This cmdlet returns a collection of Amazon.CleanRoomsML.Model.CollaborationTrainedModelExportJobSummary objects.",
        "The service call response (type Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRMLCollaborationTrainedModelExportJobListCmdlet : AmazonCleanRoomsMLClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The version identifier of the trained model to filter export jobs by. When specified,
        /// only export jobs for this specific version of the trained model are returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CollaborationTrainedModelExportJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse, GetCRMLCollaborationTrainedModelExportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsRequest();
        ...
        private Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse CallAWSServiceOperation(IAmazonCleanRoomsML client, Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CleanRoomsML", "ListCollaborationTrainedModelExportJobs");
            try
            {
                #if DESKTOP
                return client.ListCollaborationTrainedModelExportJobs(request);
                #elif CORECLR
                return client.ListCollaborationTrainedModelExportJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TrainedModelArn { get; set; }
            public System.String TrainedModelVersionIdentifier { get; set; }
            public System.Func<Amazon.CleanRoomsML.Model.ListCollaborationTrainedModelExportJobsResponse, GetCRMLCollaborationTrainedModelExportJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CollaborationTrainedModelExportJobs;
        }
