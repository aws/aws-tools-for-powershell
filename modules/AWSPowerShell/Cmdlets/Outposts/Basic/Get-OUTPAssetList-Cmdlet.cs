...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    [AWSCmdletOutput("Amazon.Outposts.Model.AssetInfo or Amazon.Outposts.Model.ListAssetsResponse",
        ...
        "The service call response (type Amazon.Outposts.Model.ListAssetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOUTPAssetListCmdlet : AmazonOutpostsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filters the results by the host ID of a Dedicated Host.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Filters the results by state.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
