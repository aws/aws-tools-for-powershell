...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    public partial class RemoveOUTPSiteCmdlet : AmazonOutpostsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OUTPSite (DeleteSite)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Outposts.Model.DeleteSiteResponse, RemoveOUTPSiteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Outposts.Model.DeleteSiteRequest();
        ...
        private Amazon.Outposts.Model.DeleteSiteResponse CallAWSServiceOperation(IAmazonOutposts client, Amazon.Outposts.Model.DeleteSiteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Outposts", "DeleteSite");
            try
            {
                return client.DeleteSiteAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String SiteId { get; set; }
            public System.Func<Amazon.Outposts.Model.DeleteSiteResponse, RemoveOUTPSiteCmdlet, object> Select { get; set; } =
