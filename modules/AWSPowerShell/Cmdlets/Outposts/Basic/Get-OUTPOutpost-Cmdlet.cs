...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    /// </summary>
    [Cmdlet("Get", "OUTPOutpost")]
    [OutputType("Amazon.Outposts.Model.Outpost")]
    [AWSCmdlet("Calls the AWS Outposts GetOutpost API operation.", Operation = new[] {"GetOutpost"}, SelectReturnType = typeof(Amazon.Outposts.Model.GetOutpostResponse))]
    [AWSCmdletOutput("Amazon.Outposts.Model.Outpost or Amazon.Outposts.Model.GetOutpostResponse",
        "This cmdlet returns an Amazon.Outposts.Model.Outpost object.",
        "The service call response (type Amazon.Outposts.Model.GetOutpostResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOUTPOutpostCmdlet : AmazonOutpostsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Outposts.Model.GetOutpostResponse, GetOUTPOutpostCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Outposts.Model.GetOutpostRequest();
        ...
        private Amazon.Outposts.Model.GetOutpostResponse CallAWSServiceOperation(IAmazonOutposts client, Amazon.Outposts.Model.GetOutpostRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Outposts", "GetOutpost");
            try
            {
                #if DESKTOP
                return client.GetOutpost(request);
                #elif CORECLR
                return client.GetOutpostAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String OutpostId { get; set; }
            public System.Func<Amazon.Outposts.Model.GetOutpostResponse, GetOUTPOutpostCmdlet, object> Select { get; set; } =
