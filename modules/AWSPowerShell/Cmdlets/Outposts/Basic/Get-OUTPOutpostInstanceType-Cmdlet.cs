...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    /// </summary>
    [Cmdlet("Get", "OUTPOutpostInstanceType")]
    [OutputType("Amazon.Outposts.Model.InstanceTypeItem")]
    [AWSCmdlet("Calls the AWS Outposts GetOutpostInstanceTypes API operation.", Operation = new[] {"GetOutpostInstanceTypes"}, SelectReturnType = typeof(Amazon.Outposts.Model.GetOutpostInstanceTypesResponse))]
    [AWSCmdletOutput("Amazon.Outposts.Model.InstanceTypeItem or Amazon.Outposts.Model.GetOutpostInstanceTypesResponse",
        "This cmdlet returns a collection of Amazon.Outposts.Model.InstanceTypeItem objects.",
        "The service call response (type Amazon.Outposts.Model.GetOutpostInstanceTypesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOUTPOutpostInstanceTypeCmdlet : AmazonOutpostsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Outposts.Model.GetOutpostInstanceTypesResponse, GetOUTPOutpostInstanceTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Outposts.Model.GetOutpostInstanceTypesRequest();
        ...
        private Amazon.Outposts.Model.GetOutpostInstanceTypesResponse CallAWSServiceOperation(IAmazonOutposts client, Amazon.Outposts.Model.GetOutpostInstanceTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Outposts", "GetOutpostInstanceTypes");
            try
            {
                #if DESKTOP
                return client.GetOutpostInstanceTypes(request);
                #elif CORECLR
                return client.GetOutpostInstanceTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OutpostId { get; set; }
            public System.Func<Amazon.Outposts.Model.GetOutpostInstanceTypesResponse, GetOUTPOutpostInstanceTypeCmdlet, object> Select { get; set; } =
