...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    [AWSCmdletOutput("Amazon.Outposts.Model.Outpost or Amazon.Outposts.Model.ListOutpostsResponse",
        ...
        "The service call response (type Amazon.Outposts.Model.ListOutpostsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
