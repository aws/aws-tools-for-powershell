...
namespace Amazon.PowerShell.Cmdlets.OUTP
{
    ...
    public partial class StopOUTPOrderCmdlet : AmazonOutpostsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.OrderId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-OUTPOrder (CancelOrder)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Outposts.Model.CancelOrderResponse, StopOUTPOrderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Outposts.Model.CancelOrderRequest();
        ...
        private Amazon.Outposts.Model.CancelOrderResponse CallAWSServiceOperation(IAmazonOutposts client, Amazon.Outposts.Model.CancelOrderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Outposts", "CancelOrder");
            try
            {
                return client.CancelOrderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String OrderId { get; set; }
            public System.Func<Amazon.Outposts.Model.CancelOrderResponse, StopOUTPOrderCmdlet, object> Select { get; set; } =
