...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    public partial class RemoveECSCapacityProviderCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CapacityProvider' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CapacityProvider;
            }
