...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    public partial class WriteECSAccountSettingDefaultCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// information about log delivery modes, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_LogConfiguration.html">LogConfiguration</a>.</para><note><para>On June 25, 2025, Amazon ECS is changing the default log driver mode from <c>blocking</c>
        ...
        private Amazon.ECS.Model.PutAccountSettingDefaultResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.PutAccountSettingDefaultRequest request)
        {
            ...
            try
            {
                return client.PutAccountSettingDefaultAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
