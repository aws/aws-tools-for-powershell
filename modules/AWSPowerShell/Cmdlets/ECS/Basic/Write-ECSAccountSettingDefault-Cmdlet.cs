...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    public partial class WriteECSAccountSettingDefaultCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The resource name for which to modify the account setting. If you specify <c>serviceLongArnFormat</c>,
        ...
        /// task due to required maintenance is affected.</para><para>When you specify <c>fargateFIPSMode</c> for the <c>name</c> and <c>enabled</c> for
        ...
        /// Web Services Fargate task maintenance</a> in the <i>Amazon ECS Developer Guide</i>.</para><para>The <c>guardDutyActivate</c> parameter is read-only in Amazon ECS and indicates whether
