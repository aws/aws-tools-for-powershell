...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    public partial class RemoveECSTaskDefinitionCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// Name (ARN) of the task definition to delete. You must specify a <c>revision</c>.</para><para>You can specify up to 10 task definitions as a comma separated list.</para><para />
