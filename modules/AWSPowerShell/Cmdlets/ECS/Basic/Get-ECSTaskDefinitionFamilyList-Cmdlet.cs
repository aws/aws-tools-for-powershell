...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Service ListTaskDefinitionFamilies API operation.", Operation = new[] {"ListTaskDefinitionFamilies"}, SelectReturnType = typeof(Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse), LegacyAlias="Get-ECSTaskDefinitionFamilies")]
    [AWSCmdletOutput("System.String or Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetECSTaskDefinitionFamilyListCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Families";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse, GetECSTaskDefinitionFamilyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ECS.Model.ListTaskDefinitionFamiliesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Families?.Count ?? 0;
        ...
        private Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.ListTaskDefinitionFamiliesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Service", "ListTaskDefinitionFamilies");
            try
            {
                return client.ListTaskDefinitionFamiliesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.ECS.TaskDefinitionFamilyStatus Status { get; set; }
            public System.Func<Amazon.ECS.Model.ListTaskDefinitionFamiliesResponse, GetECSTaskDefinitionFamilyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Families;
        }
