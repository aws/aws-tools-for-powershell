...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    public partial class RegisterECSDaemonTaskDefinitionCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IPC namespace mode for the daemon. The valid values are <c>none</c> and <c>shared</c>.
        /// The default is <c>none</c>.</para><para>If <c>none</c> is specified or no value is provided, the daemon runs with its own
        ...
        /// "host"</c> or other daemons that use <c>ipcMode: "shared"</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The PID namespace mode for the daemon. The valid values are <c>none</c> and <c>shared</c>.
        /// The default is <c>none</c>.</para><para>If <c>none</c> is specified or no value is provided, the daemon runs with its own
        ...
        /// "host"</c> or other daemons that use <c>pidMode: "shared"</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
