...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdletOutput("Amazon.ECS.Model.Cluster or Amazon.ECS.Model.UpdateClusterSettingsResponse",
        ...
        "The service call response (type Amazon.ECS.Model.UpdateClusterSettingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateECSClusterSettingCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// or <a href="https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutAccountSettingDefault.html">PutAccountSettingDefault</a>.</para><important><para>Currently, if you delete an existing cluster that does not have Container Insights
        ...
        /// 7 days before you can re-create it.</para></important><para />
        ...
        private Amazon.ECS.Model.UpdateClusterSettingsResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.UpdateClusterSettingsRequest request)
        {
            ...
            try
            {
                return client.UpdateClusterSettingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
