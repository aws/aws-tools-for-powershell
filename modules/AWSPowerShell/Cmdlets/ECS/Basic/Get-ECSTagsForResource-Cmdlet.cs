...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    /// </summary>
    [Cmdlet("Get", "ECSTagsForResource")]
    [OutputType("Amazon.ECS.Model.Tag")]
    ...
    public partial class GetECSTagsForResourceCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECS.Model.ListTagsForResourceResponse, GetECSTagsForResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECS.Model.ListTagsForResourceRequest();
        ...
        private Amazon.ECS.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Service", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.ECS.Model.ListTagsForResourceResponse, GetECSTagsForResourceCmdlet, object> Select { get; set; } =
