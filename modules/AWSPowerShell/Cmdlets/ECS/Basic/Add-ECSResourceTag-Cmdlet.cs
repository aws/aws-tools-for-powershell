...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon EC2 Container Service TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.ECS.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.ECS.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ECS.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddECSResourceTagCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// and container instances.</para><para>In order to tag a service that has the following ARN format, you need to migrate the
        ...
        /// Service Developer Guide</i>.</para><para><c>arn:aws:ecs:region:aws_account_id:service/service-name</c></para><para>After the migration is complete, the service has the long ARN format, as shown below.
        /// Use this ARN to tag the service.</para><para><c>arn:aws:ecs:region:aws_account_id:service/cluster-name/service-name</c></para><para>If you try to tag a service with a short ARN, you receive an <c>InvalidParameterException</c>
        /// error.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECS.Model.TagResourceResponse, AddECSResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ECS.Model.TagResourceResponse, AddECSResourceTagCmdlet, object> Select { get; set; } =
