...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    [AWSCmdletOutput("Amazon.ECS.Model.CapacityProvider or Amazon.ECS.Model.UpdateCapacityProviderResponse",
        ...
        "The service call response (type Amazon.ECS.Model.UpdateCapacityProviderResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateECSCapacityProviderCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the cluster that contains the capacity provider to update. Managed instances
        ...
        /// <summary>
        /// <para>
        /// <para>The updated Amazon Resource Name (ARN) of the instance profile. The new instance profile
        /// must have the necessary permissions for your tasks.</para><para>For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/managed-instances-instance-profile.html">Amazon
        ...
        /// <summary>
        /// <para>
        /// <para>The updated Amazon Resource Name (ARN) of the infrastructure role. The new role must
        /// have the necessary permissions to manage instances and access required Amazon Web
        /// Services services.</para><para>For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/infrastructure_IAM_role.html">Amazon
        ...
        /// <summary>
        /// <para>
        /// <para>The updated tag propagation setting. When changed, this affects only new instances
        /// launched after the update.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            request.ManagedInstancesProvider = new Amazon.ECS.Model.UpdateManagedInstancesProviderConfiguration();
            ...
            requestManagedInstancesProvider_managedInstancesProvider_InstanceLaunchTemplate = new Amazon.ECS.Model.InstanceLaunchTemplateUpdate();
