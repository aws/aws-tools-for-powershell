...
namespace Amazon.PowerShell.Cmdlets.ECS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "ECSExpressGatewayService", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ECS.Model.UpdatedExpressGatewayService")]
    [AWSCmdlet("Calls the Amazon EC2 Container Service UpdateExpressGatewayService API operation.", Operation = new[] {"UpdateExpressGatewayService"}, SelectReturnType = typeof(Amazon.ECS.Model.UpdateExpressGatewayServiceResponse))]
    [AWSCmdletOutput("Amazon.ECS.Model.UpdatedExpressGatewayService or Amazon.ECS.Model.UpdateExpressGatewayServiceResponse",
        "This cmdlet returns an Amazon.ECS.Model.UpdatedExpressGatewayService object.",
        "The service call response (type Amazon.ECS.Model.UpdateExpressGatewayServiceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateECSExpressGatewayServiceCmdlet : AmazonECSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The command that is passed to the container.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The number of CPU units used by the task.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The environment variables to pass to the container.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the task execution role for the Express service.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The path on the container for Application Load Balancer health checks.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The amount of memory (in MiB) used by the task.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The secrets to pass to the container.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the security groups associated with the Express service.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the Express service to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the subnets associated with the Express service.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the IAM role for containers in this task.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ECS.Model.UpdateExpressGatewayServiceResponse).
        /// Specifying the name of a property of type Amazon.ECS.Model.UpdateExpressGatewayServiceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-ECSExpressGatewayService (UpdateExpressGatewayService)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ECS.Model.UpdateExpressGatewayServiceResponse, UpdateECSExpressGatewayServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECS.Model.UpdateExpressGatewayServiceRequest();
        ...
        private Amazon.ECS.Model.UpdateExpressGatewayServiceResponse CallAWSServiceOperation(IAmazonECS client, Amazon.ECS.Model.UpdateExpressGatewayServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Service", "UpdateExpressGatewayService");
            try
            {
                return client.UpdateExpressGatewayServiceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
