...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    [AWSCmdletOutput("Amazon.AppRunner.Model.VpcIngressConnectionSummary or Amazon.AppRunner.Model.ListVpcIngressConnectionsResponse",
        ...
        "The service call response (type Amazon.AppRunner.Model.ListVpcIngressConnectionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
