...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    public partial class RemoveAARServiceCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AARService (DeleteService)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.DeleteServiceResponse, RemoveAARServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.DeleteServiceRequest();
        ...
        private Amazon.AppRunner.Model.DeleteServiceResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.DeleteServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "DeleteService");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ServiceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.DeleteServiceResponse, RemoveAARServiceCmdlet, object> Select { get; set; } =
