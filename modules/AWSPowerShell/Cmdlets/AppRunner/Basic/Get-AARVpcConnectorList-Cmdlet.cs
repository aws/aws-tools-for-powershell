...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    /// </summary>
    [Cmdlet("Get", "AARVpcConnectorList")]
    ...
    public partial class GetAARVpcConnectorListCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VpcConnectors";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.ListVpcConnectorsResponse, GetAARVpcConnectorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppRunner.Model.ListVpcConnectorsRequest();
        ...
        private Amazon.AppRunner.Model.ListVpcConnectorsResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.ListVpcConnectorsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppRunner.Model.ListVpcConnectorsResponse, GetAARVpcConnectorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VpcConnectors;
        }
