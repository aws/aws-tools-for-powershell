...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    /// </summary>
    [Cmdlet("Get", "AARCustomDomain")]
    [OutputType("Amazon.AppRunner.Model.DescribeCustomDomainsResponse")]
    [AWSCmdlet("Calls the AWS App Runner DescribeCustomDomains API operation.", Operation = new[] {"DescribeCustomDomains"}, SelectReturnType = typeof(Amazon.AppRunner.Model.DescribeCustomDomainsResponse))]
    [AWSCmdletOutput("Amazon.AppRunner.Model.DescribeCustomDomainsResponse",
        "This cmdlet returns an Amazon.AppRunner.Model.DescribeCustomDomainsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAARCustomDomainCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.DescribeCustomDomainsResponse, GetAARCustomDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppRunner.Model.DescribeCustomDomainsRequest();
        ...
        private Amazon.AppRunner.Model.DescribeCustomDomainsResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.DescribeCustomDomainsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "DescribeCustomDomains");
            try
            {
                #if DESKTOP
                return client.DescribeCustomDomains(request);
                #elif CORECLR
                return client.DescribeCustomDomainsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServiceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.DescribeCustomDomainsResponse, GetAARCustomDomainCmdlet, object> Select { get; set; } =
