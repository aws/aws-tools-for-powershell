...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    [AWSCmdletOutput("Amazon.AppRunner.Model.OperationSummary or Amazon.AppRunner.Model.ListOperationsResponse",
        ...
        "The service call response (type Amazon.AppRunner.Model.ListOperationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
