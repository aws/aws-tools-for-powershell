...
{
    /// <summary>
    /// Returns a list of AWS App Runner connections that are associated with your AWS account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "AARConnectionList")]
    [OutputType("Amazon.AppRunner.Model.ConnectionSummary")]
    ...
    public partial class GetAARConnectionListCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConnectionSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.ListConnectionsResponse, GetAARConnectionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppRunner.Model.ListConnectionsRequest();
        ...
        private Amazon.AppRunner.Model.ListConnectionsResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.ListConnectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "ListConnections");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppRunner.Model.ListConnectionsResponse, GetAARConnectionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConnectionSummaryList;
        }
