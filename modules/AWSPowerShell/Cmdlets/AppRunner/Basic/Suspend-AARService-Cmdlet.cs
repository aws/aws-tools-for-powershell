...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Suspend", "AARService", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class SuspendAARServiceCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Suspend-AARService (PauseService)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.PauseServiceResponse, SuspendAARServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.PauseServiceRequest();
        ...
        private Amazon.AppRunner.Model.PauseServiceResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.PauseServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "PauseService");
            try
            {
                #if DESKTOP
                return client.PauseService(request);
                #elif CORECLR
                return client.PauseServiceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ServiceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.PauseServiceResponse, SuspendAARServiceCmdlet, object> Select { get; set; } =
