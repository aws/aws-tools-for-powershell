...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    public partial class RemoveAARConnectionCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AARConnection (DeleteConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.DeleteConnectionResponse, RemoveAARConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.DeleteConnectionRequest();
        ...
        private Amazon.AppRunner.Model.DeleteConnectionResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.DeleteConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "DeleteConnection");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ConnectionArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.DeleteConnectionResponse, RemoveAARConnectionCmdlet, object> Select { get; set; } =
