...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "AARCustomDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.AppRunner.Model.DisassociateCustomDomainResponse")]
    [AWSCmdlet("Calls the AWS App Runner DisassociateCustomDomain API operation.", Operation = new[] {"DisassociateCustomDomain"}, SelectReturnType = typeof(Amazon.AppRunner.Model.DisassociateCustomDomainResponse))]
    [AWSCmdletOutput("Amazon.AppRunner.Model.DisassociateCustomDomainResponse",
        "This cmdlet returns an Amazon.AppRunner.Model.DisassociateCustomDomainResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAARCustomDomainCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AARCustomDomain (DisassociateCustomDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.DisassociateCustomDomainResponse, RemoveAARCustomDomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.DisassociateCustomDomainRequest();
        ...
        private Amazon.AppRunner.Model.DisassociateCustomDomainResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.DisassociateCustomDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "DisassociateCustomDomain");
            try
            {
                #if DESKTOP
                return client.DisassociateCustomDomain(request);
                #elif CORECLR
                return client.DisassociateCustomDomainAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String ServiceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.DisassociateCustomDomainResponse, RemoveAARCustomDomainCmdlet, object> Select { get; set; } =
