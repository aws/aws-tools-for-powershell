...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Resume", "AARService", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ResumeAARServiceCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Resume-AARService (ResumeService)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.ResumeServiceResponse, ResumeAARServiceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.ResumeServiceRequest();
        ...
        private Amazon.AppRunner.Model.ResumeServiceResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.ResumeServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "ResumeService");
            try
            {
                #if DESKTOP
                return client.ResumeService(request);
                #elif CORECLR
                return client.ResumeServiceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ServiceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.ResumeServiceResponse, ResumeAARServiceCmdlet, object> Select { get; set; } =
