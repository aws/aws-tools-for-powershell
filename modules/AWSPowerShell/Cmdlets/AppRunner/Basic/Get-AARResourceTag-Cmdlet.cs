...
namespace Amazon.PowerShell.Cmdlets.AAR
{
    ...
    [OutputType("Amazon.AppRunner.Model.Tag")]
    ...
    public partial class GetAARResourceTagCmdlet : AmazonAppRunnerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRunner.Model.ListTagsForResourceResponse, GetAARResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRunner.Model.ListTagsForResourceRequest();
        ...
        private Amazon.AppRunner.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonAppRunner client, Amazon.AppRunner.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS App Runner", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.AppRunner.Model.ListTagsForResourceResponse, GetAARResourceTagCmdlet, object> Select { get; set; } =
