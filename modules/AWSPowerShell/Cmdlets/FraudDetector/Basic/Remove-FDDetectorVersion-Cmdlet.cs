...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector DeleteDetectorVersion API operation.", Operation = new[] {"DeleteDetectorVersion"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.DeleteDetectorVersionResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.DeleteDetectorVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.DeleteDetectorVersionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveFDDetectorVersionCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FDDetectorVersion (DeleteDetectorVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.DeleteDetectorVersionResponse, RemoveFDDetectorVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.DeleteDetectorVersionRequest();
        ...
        private Amazon.FraudDetector.Model.DeleteDetectorVersionResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.DeleteDetectorVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "DeleteDetectorVersion");
            try
            {
                #if DESKTOP
                return client.DeleteDetectorVersion(request);
                #elif CORECLR
                return client.DeleteDetectorVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DetectorId { get; set; }
            public System.String DetectorVersionId { get; set; }
            public System.Func<Amazon.FraudDetector.Model.DeleteDetectorVersionResponse, RemoveFDDetectorVersionCmdlet, object> Select { get; set; } =
