...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Get", "FDModelVersionList")]
    [OutputType("Amazon.FraudDetector.Model.ModelVersionDetail")]
    [AWSCmdlet("Calls the Amazon Fraud Detector DescribeModelVersions API operation.", Operation = new[] {"DescribeModelVersions"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.DescribeModelVersionsResponse))]
    [AWSCmdletOutput("Amazon.FraudDetector.Model.ModelVersionDetail or Amazon.FraudDetector.Model.DescribeModelVersionsResponse",
        "This cmdlet returns a collection of Amazon.FraudDetector.Model.ModelVersionDetail objects.",
        "The service call response (type Amazon.FraudDetector.Model.DescribeModelVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFDModelVersionListCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ModelVersionDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.DescribeModelVersionsResponse, GetFDModelVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FraudDetector.Model.DescribeModelVersionsRequest();
        ...
        private Amazon.FraudDetector.Model.DescribeModelVersionsResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.DescribeModelVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "DescribeModelVersions");
            try
            {
                #if DESKTOP
                return client.DescribeModelVersions(request);
                #elif CORECLR
                return client.DescribeModelVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ModelVersionNumber { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FraudDetector.Model.DescribeModelVersionsResponse, GetFDModelVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ModelVersionDetails;
        }
