...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Update", "FDDetectorVersionStatus", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector UpdateDetectorVersionStatus API operation.", Operation = new[] {"UpdateDetectorVersionStatus"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateFDDetectorVersionStatusCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.FraudDetector.DetectorVersionStatus")]
        public Amazon.FraudDetector.DetectorVersionStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-FDDetectorVersionStatus (UpdateDetectorVersionStatus)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse, UpdateFDDetectorVersionStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.UpdateDetectorVersionStatusRequest();
        ...
        private Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.UpdateDetectorVersionStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "UpdateDetectorVersionStatus");
            try
            {
                #if DESKTOP
                return client.UpdateDetectorVersionStatus(request);
                #elif CORECLR
                return client.UpdateDetectorVersionStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DetectorVersionId { get; set; }
            public Amazon.FraudDetector.DetectorVersionStatus Status { get; set; }
            public System.Func<Amazon.FraudDetector.Model.UpdateDetectorVersionStatusResponse, UpdateFDDetectorVersionStatusCmdlet, object> Select { get; set; } =
