...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    public partial class WriteFDEventTypeCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The entity type for the event type. Example entity types: customer, merchant, account.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The event type variables.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The event type labels.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.FraudDetector.Model.PutEventTypeResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.PutEventTypeRequest request)
        {
            ...
            try
            {
                return client.PutEventTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
