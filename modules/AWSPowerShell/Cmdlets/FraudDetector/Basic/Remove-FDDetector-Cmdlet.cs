...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector DeleteDetector API operation.", Operation = new[] {"DeleteDetector"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.DeleteDetectorResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.DeleteDetectorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.DeleteDetectorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveFDDetectorCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FDDetector (DeleteDetector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.DeleteDetectorResponse, RemoveFDDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.DeleteDetectorRequest();
        ...
        private Amazon.FraudDetector.Model.DeleteDetectorResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.DeleteDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "DeleteDetector");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DetectorId { get; set; }
            public System.Func<Amazon.FraudDetector.Model.DeleteDetectorResponse, RemoveFDDetectorCmdlet, object> Select { get; set; } =
