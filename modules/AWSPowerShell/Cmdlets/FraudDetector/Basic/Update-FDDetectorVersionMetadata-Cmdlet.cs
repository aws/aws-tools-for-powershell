...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector UpdateDetectorVersionMetadata API operation.", Operation = new[] {"UpdateDetectorVersionMetadata"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateFDDetectorVersionMetadataCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-FDDetectorVersionMetadata (UpdateDetectorVersionMetadata)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse, UpdateFDDetectorVersionMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataRequest();
        ...
        private Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "UpdateDetectorVersionMetadata");
            try
            {
                #if DESKTOP
                return client.UpdateDetectorVersionMetadata(request);
                #elif CORECLR
                return client.UpdateDetectorVersionMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DetectorId { get; set; }
            public System.String DetectorVersionId { get; set; }
            public System.Func<Amazon.FraudDetector.Model.UpdateDetectorVersionMetadataResponse, UpdateFDDetectorVersionMetadataCmdlet, object> Select { get; set; } =
