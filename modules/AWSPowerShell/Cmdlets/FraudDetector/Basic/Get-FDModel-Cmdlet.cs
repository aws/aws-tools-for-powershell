...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [AWSCmdletOutput("Amazon.FraudDetector.Model.Model or Amazon.FraudDetector.Model.GetModelsResponse",
        ...
        "The service call response (type Amazon.FraudDetector.Model.GetModelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
