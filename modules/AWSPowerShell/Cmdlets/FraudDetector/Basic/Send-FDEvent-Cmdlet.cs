...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.SendEventResponse",
        ...
        "The service response (type Amazon.FraudDetector.Model.SendEventResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
