...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    public partial class GetFDEventTypeCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.GetEventTypesResponse, GetFDEventTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FraudDetector.Model.GetEventTypesRequest();
        ...
        private Amazon.FraudDetector.Model.GetEventTypesResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.GetEventTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "GetEventTypes");
            try
            {
                #if DESKTOP
                return client.GetEventTypes(request);
                #elif CORECLR
                return client.GetEventTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FraudDetector.Model.GetEventTypesResponse, GetFDEventTypeCmdlet, object> Select { get; set; } =
