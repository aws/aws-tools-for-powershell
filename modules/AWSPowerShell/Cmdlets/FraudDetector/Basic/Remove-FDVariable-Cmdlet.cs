...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    public partial class RemoveFDVariableCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-FDVariable (DeleteVariable)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.DeleteVariableResponse, RemoveFDVariableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.DeleteVariableRequest();
        ...
        private Amazon.FraudDetector.Model.DeleteVariableResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.DeleteVariableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "DeleteVariable");
            try
            {
                #if DESKTOP
                return client.DeleteVariable(request);
                #elif CORECLR
                return client.DeleteVariableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.FraudDetector.Model.DeleteVariableResponse, RemoveFDVariableCmdlet, object> Select { get; set; } =
