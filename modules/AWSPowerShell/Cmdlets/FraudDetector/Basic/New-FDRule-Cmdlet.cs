...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("New", "FDRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewFDRuleCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The outcome or outcomes returned when the rule expression matches.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-FDRule (CreateRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.CreateRuleResponse, NewFDRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.CreateRuleRequest();
        ...
        private Amazon.FraudDetector.Model.CreateRuleResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.CreateRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "CreateRule");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.FraudDetector.Model.CreateRuleResponse, NewFDRuleCmdlet, object> Select { get; set; } =
