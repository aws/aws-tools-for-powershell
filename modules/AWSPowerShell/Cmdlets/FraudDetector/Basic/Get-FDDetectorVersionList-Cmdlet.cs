...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Get", "FDDetectorVersionList")]
    [OutputType("Amazon.FraudDetector.Model.DetectorVersionSummary")]
    [AWSCmdlet("Calls the Amazon Fraud Detector DescribeDetector API operation.", Operation = new[] {"DescribeDetector"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.DescribeDetectorResponse))]
    [AWSCmdletOutput("Amazon.FraudDetector.Model.DetectorVersionSummary or Amazon.FraudDetector.Model.DescribeDetectorResponse",
        "This cmdlet returns a collection of Amazon.FraudDetector.Model.DetectorVersionSummary objects.",
        "The service call response (type Amazon.FraudDetector.Model.DescribeDetectorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFDDetectorVersionListCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DetectorVersionSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.DescribeDetectorResponse, GetFDDetectorVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FraudDetector.Model.DescribeDetectorRequest();
        ...
        private Amazon.FraudDetector.Model.DescribeDetectorResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.DescribeDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "DescribeDetector");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FraudDetector.Model.DescribeDetectorResponse, GetFDDetectorVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DetectorVersionSummaries;
        }
