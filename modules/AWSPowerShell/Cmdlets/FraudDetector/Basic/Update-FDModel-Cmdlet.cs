...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector UpdateModel API operation.", Operation = new[] {"UpdateModel"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.UpdateModelResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.UpdateModelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.UpdateModelResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateFDModelCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-FDModel (UpdateModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.UpdateModelResponse, UpdateFDModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.UpdateModelRequest();
        ...
        private Amazon.FraudDetector.Model.UpdateModelResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.UpdateModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "UpdateModel");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ModelId { get; set; }
            public Amazon.FraudDetector.ModelTypeEnum ModelType { get; set; }
            public System.Func<Amazon.FraudDetector.Model.UpdateModelResponse, UpdateFDModelCmdlet, object> Select { get; set; } =
