...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Get", "FDDetector")]
    [OutputType("Amazon.FraudDetector.Model.Detector")]
    [AWSCmdlet("Calls the Amazon Fraud Detector GetDetectors API operation.", Operation = new[] {"GetDetectors"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.GetDetectorsResponse))]
    [AWSCmdletOutput("Amazon.FraudDetector.Model.Detector or Amazon.FraudDetector.Model.GetDetectorsResponse",
        "This cmdlet returns a collection of Amazon.FraudDetector.Model.Detector objects.",
        "The service call response (type Amazon.FraudDetector.Model.GetDetectorsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFDDetectorCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Detectors";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.GetDetectorsResponse, GetFDDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FraudDetector.Model.GetDetectorsRequest();
        ...
        private Amazon.FraudDetector.Model.GetDetectorsResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.GetDetectorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "GetDetectors");
            try
            {
                #if DESKTOP
                return client.GetDetectors(request);
                #elif CORECLR
                return client.GetDetectorsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FraudDetector.Model.GetDetectorsResponse, GetFDDetectorCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Detectors;
        }
