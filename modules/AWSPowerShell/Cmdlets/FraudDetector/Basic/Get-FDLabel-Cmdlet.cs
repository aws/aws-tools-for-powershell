...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Get", "FDLabel")]
    [OutputType("Amazon.FraudDetector.Model.Label")]
    [AWSCmdlet("Calls the Amazon Fraud Detector GetLabels API operation.", Operation = new[] {"GetLabels"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.GetLabelsResponse))]
    [AWSCmdletOutput("Amazon.FraudDetector.Model.Label or Amazon.FraudDetector.Model.GetLabelsResponse",
        "This cmdlet returns a collection of Amazon.FraudDetector.Model.Label objects.",
        "The service call response (type Amazon.FraudDetector.Model.GetLabelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFDLabelCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.GetLabelsResponse, GetFDLabelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FraudDetector.Model.GetLabelsRequest();
        ...
        private Amazon.FraudDetector.Model.GetLabelsResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.GetLabelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "GetLabels");
            try
            {
                #if DESKTOP
                return client.GetLabels(request);
                #elif CORECLR
                return client.GetLabelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.FraudDetector.Model.GetLabelsResponse, GetFDLabelCmdlet, object> Select { get; set; } =
