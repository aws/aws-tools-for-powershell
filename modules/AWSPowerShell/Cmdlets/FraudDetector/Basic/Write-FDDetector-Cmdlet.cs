...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Write", "FDDetector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Fraud Detector PutDetector API operation.", Operation = new[] {"PutDetector"}, SelectReturnType = typeof(Amazon.FraudDetector.Model.PutDetectorResponse))]
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.PutDetectorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.FraudDetector.Model.PutDetectorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteFDDetectorCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-FDDetector (PutDetector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.PutDetectorResponse, WriteFDDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.PutDetectorRequest();
        ...
        private Amazon.FraudDetector.Model.PutDetectorResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.PutDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "PutDetector");
            try
            {
                #if DESKTOP
                return client.PutDetector(request);
                #elif CORECLR
                return client.PutDetectorAsync(request).GetAwaiter().GetResult();
                #else
