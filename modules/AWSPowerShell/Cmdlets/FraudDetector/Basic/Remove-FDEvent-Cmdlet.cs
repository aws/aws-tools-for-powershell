...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    [AWSCmdletOutput("None or Amazon.FraudDetector.Model.DeleteEventResponse",
        ...
        "The service response (type Amazon.FraudDetector.Model.DeleteEventResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
