...
namespace Amazon.PowerShell.Cmdlets.FD
{
    ...
    /// </summary>
    [Cmdlet("Get", "FDEvent")]
    [OutputType("Amazon.FraudDetector.Model.Event")]
    ...
    public partial class GetFDEventCmdlet : AmazonFraudDetectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FraudDetector.Model.GetEventResponse, GetFDEventCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FraudDetector.Model.GetEventRequest();
        ...
        private Amazon.FraudDetector.Model.GetEventResponse CallAWSServiceOperation(IAmazonFraudDetector client, Amazon.FraudDetector.Model.GetEventRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Fraud Detector", "GetEvent");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String EventId { get; set; }
            public System.String EventTypeName { get; set; }
            public System.Func<Amazon.FraudDetector.Model.GetEventResponse, GetFDEventCmdlet, object> Select { get; set; } =
