...
namespace Amazon.PowerShell.Cmdlets.IOTE
{
    ...
    /// </summary>
    [Cmdlet("Update", "IOTEDetectorModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTEvents.Model.DetectorModelConfiguration")]
    [AWSCmdlet("Calls the AWS IoT Events UpdateDetectorModel API operation.", Operation = new[] {"UpdateDetectorModel"}, SelectReturnType = typeof(Amazon.IoTEvents.Model.UpdateDetectorModelResponse))]
    [AWSCmdletOutput("Amazon.IoTEvents.Model.DetectorModelConfiguration or Amazon.IoTEvents.Model.UpdateDetectorModelResponse",
        "This cmdlet returns an Amazon.IoTEvents.Model.DetectorModelConfiguration object.",
        "The service call response (type Amazon.IoTEvents.Model.UpdateDetectorModelResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTEDetectorModelCmdlet : AmazonIoTEventsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>When set to <code>SERIAL</code>, variables are updated and event conditions evaluated
        /// in the order that the events are defined. When set to <code>BATCH</code>, variables
        /// are updated and events performed only after all event conditions are evaluated.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTEDetectorModel (UpdateDetectorModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEvents.Model.UpdateDetectorModelResponse, UpdateIOTEDetectorModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTEvents.Model.UpdateDetectorModelRequest();
        ...
        private Amazon.IoTEvents.Model.UpdateDetectorModelResponse CallAWSServiceOperation(IAmazonIoTEvents client, Amazon.IoTEvents.Model.UpdateDetectorModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events", "UpdateDetectorModel");
            try
            {
                #if DESKTOP
                return client.UpdateDetectorModel(request);
                #elif CORECLR
                return client.UpdateDetectorModelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoTEvents.EvaluationMethod EvaluationMethod { get; set; }
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.IoTEvents.Model.UpdateDetectorModelResponse, UpdateIOTEDetectorModelCmdlet, object> Select { get; set; } =
