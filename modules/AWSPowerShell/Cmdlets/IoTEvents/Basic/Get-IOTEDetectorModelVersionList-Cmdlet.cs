...
namespace Amazon.PowerShell.Cmdlets.IOTE
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTEDetectorModelVersionList")]
    [OutputType("Amazon.IoTEvents.Model.DetectorModelVersionSummary")]
    [AWSCmdlet("Calls the AWS IoT Events ListDetectorModelVersions API operation.", Operation = new[] {"ListDetectorModelVersions"}, SelectReturnType = typeof(Amazon.IoTEvents.Model.ListDetectorModelVersionsResponse))]
    [AWSCmdletOutput("Amazon.IoTEvents.Model.DetectorModelVersionSummary or Amazon.IoTEvents.Model.ListDetectorModelVersionsResponse",
        "This cmdlet returns a collection of Amazon.IoTEvents.Model.DetectorModelVersionSummary objects.",
        "The service call response (type Amazon.IoTEvents.Model.ListDetectorModelVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTEDetectorModelVersionListCmdlet : AmazonIoTEventsClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTEvents.Model.ListDetectorModelVersionsResponse CallAWSServiceOperation(IAmazonIoTEvents client, Amazon.IoTEvents.Model.ListDetectorModelVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events", "ListDetectorModelVersions");
            try
            {
                #if DESKTOP
                return client.ListDetectorModelVersions(request);
                #elif CORECLR
                return client.ListDetectorModelVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.IoTEvents.Model.ListDetectorModelVersionsResponse, GetIOTEDetectorModelVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DetectorModelVersionSummaries;
        }
