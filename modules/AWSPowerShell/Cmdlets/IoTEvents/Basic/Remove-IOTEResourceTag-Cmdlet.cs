...
namespace Amazon.PowerShell.Cmdlets.IOTE
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IOTEResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTEResourceTagCmdlet : AmazonIoTEventsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTEResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEvents.Model.UntagResourceResponse, RemoveIOTEResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTEvents.Model.UntagResourceRequest();
        ...
        private Amazon.IoTEvents.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonIoTEvents client, Amazon.IoTEvents.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTEvents.Model.UntagResourceResponse, RemoveIOTEResourceTagCmdlet, object> Select { get; set; } =
