...
namespace Amazon.PowerShell.Cmdlets.IOTE
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTEResourceTag")]
    [OutputType("Amazon.IoTEvents.Model.Tag")]
    ...
    public partial class GetIOTEResourceTagCmdlet : AmazonIoTEventsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEvents.Model.ListTagsForResourceResponse, GetIOTEResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTEvents.Model.ListTagsForResourceRequest();
        ...
        private Amazon.IoTEvents.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonIoTEvents client, Amazon.IoTEvents.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.IoTEvents.Model.ListTagsForResourceResponse, GetIOTEResourceTagCmdlet, object> Select { get; set; } =
