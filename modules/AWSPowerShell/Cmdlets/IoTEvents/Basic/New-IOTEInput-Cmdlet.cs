...
namespace Amazon.PowerShell.Cmdlets.IOTE
{
    ...
    /// Creates an input.
    /// </summary>
    [Cmdlet("New", "IOTEInput", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTEvents.Model.InputConfiguration")]
    [AWSCmdlet("Calls the AWS IoT Events CreateInput API operation.", Operation = new[] {"CreateInput"}, SelectReturnType = typeof(Amazon.IoTEvents.Model.CreateInputResponse))]
    [AWSCmdletOutput("Amazon.IoTEvents.Model.InputConfiguration or Amazon.IoTEvents.Model.CreateInputResponse",
        "This cmdlet returns an Amazon.IoTEvents.Model.InputConfiguration object.",
        "The service call response (type Amazon.IoTEvents.Model.CreateInputResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIOTEInputCmdlet : AmazonIoTEventsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^InputName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IOTEInput (CreateInput)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEvents.Model.CreateInputResponse, NewIOTEInputCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.InputName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTEvents.Model.CreateInputRequest();
        ...
        private Amazon.IoTEvents.Model.CreateInputResponse CallAWSServiceOperation(IAmazonIoTEvents client, Amazon.IoTEvents.Model.CreateInputRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events", "CreateInput");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTEvents.Model.CreateInputResponse, NewIOTEInputCmdlet, object> Select { get; set; } =
