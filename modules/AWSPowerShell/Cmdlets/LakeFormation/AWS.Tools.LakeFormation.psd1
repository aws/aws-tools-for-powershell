#
# Module manifest for module 'AWS.Tools.LakeFormation'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.LakeFormation.dll'
    ...
    GUID = '86807489-62b6-4973-a06b-ee9c4abacf2a'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.LakeFormation.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.LakeFormation.Completers.psm1',
        'AWS.Tools.LakeFormation.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.LakeFormation.dll-Help.xml'
    )
