...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Invoke", "LKFTransaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class InvokeLKFTransactionCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-LKFTransaction (ExtendTransaction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.ExtendTransactionResponse, InvokeLKFTransactionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.ExtendTransactionRequest();
        ...
        private Amazon.LakeFormation.Model.ExtendTransactionResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.ExtendTransactionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "ExtendTransaction");
            try
            {
                #if DESKTOP
                return client.ExtendTransaction(request);
                #elif CORECLR
                return client.ExtendTransactionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TransactionId { get; set; }
            public System.Func<Amazon.LakeFormation.Model.ExtendTransactionResponse, InvokeLKFTransactionCmdlet, object> Select { get; set; } =
