...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    /// </summary>
    [Cmdlet("New", "LKFLFTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Lake Formation CreateLFTag API operation.", Operation = new[] {"CreateLFTag"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.CreateLFTagResponse))]
    [AWSCmdletOutput("None or Amazon.LakeFormation.Model.CreateLFTagResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LakeFormation.Model.CreateLFTagResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewLKFLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-LKFLFTag (CreateLFTag)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.CreateLFTagResponse, NewLKFLFTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.CreateLFTagRequest();
        ...
        private Amazon.LakeFormation.Model.CreateLFTagResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.CreateLFTagRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "CreateLFTag");
            try
            {
                #if DESKTOP
                return client.CreateLFTag(request);
                #elif CORECLR
                return client.CreateLFTagAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.LakeFormation.Model.CreateLFTagResponse, NewLKFLFTagCmdlet, object> Select { get; set; } =
