...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    [AWSCmdlet("Calls the AWS Lake Formation SearchTablesByLFTags API operation.", Operation = new[] {"SearchTablesByLFTags"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse))]
    [AWSCmdletOutput("Amazon.LakeFormation.Model.TaggedTable or Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse",
        "This cmdlet returns a collection of Amazon.LakeFormation.Model.TaggedTable objects.",
        "The service call response (type Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SearchLKFTablesByLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of conditions (<c>LFTag</c> structures) to search for in table resources.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-LKFTablesByLFTag (SearchTablesByLFTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse, SearchLKFTablesByLFTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LakeFormation.Model.SearchTablesByLFTagsRequest();
        ...
        private Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.SearchTablesByLFTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "SearchTablesByLFTags");
            try
            {
                return client.SearchTablesByLFTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse, SearchLKFTablesByLFTagCmdlet, object> Select { get; set; } =
