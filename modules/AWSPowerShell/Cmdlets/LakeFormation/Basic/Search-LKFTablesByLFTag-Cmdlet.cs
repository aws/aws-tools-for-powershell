...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    [AWSCmdletOutput("Amazon.LakeFormation.Model.TaggedTable or Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse",
        ...
        "The service call response (type Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchLKFTablesByLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        private Amazon.LakeFormation.Model.SearchTablesByLFTagsResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.SearchTablesByLFTagsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.SearchTablesByLFTags(request);
                #elif CORECLR
                return client.SearchTablesByLFTagsAsync(request).GetAwaiter().GetResult();
                #else
