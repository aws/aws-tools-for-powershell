...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LKFLFTagsFromResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.LakeFormation.Model.LFTagError")]
    [AWSCmdlet("Calls the AWS Lake Formation RemoveLFTagsFromResource API operation.", Operation = new[] {"RemoveLFTagsFromResource"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse))]
    [AWSCmdletOutput("Amazon.LakeFormation.Model.LFTagError or Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse",
        "This cmdlet returns a collection of Amazon.LakeFormation.Model.LFTagError objects.",
        "The service call response (type Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveLKFLFTagsFromResourceCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LKFLFTagsFromResource (RemoveLFTagsFromResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse, RemoveLKFLFTagsFromResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.RemoveLFTagsFromResourceRequest();
        ...
        private Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.RemoveLFTagsFromResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "RemoveLFTagsFromResource");
            try
            {
                #if DESKTOP
                return client.RemoveLFTagsFromResource(request);
                #elif CORECLR
                return client.RemoveLFTagsFromResourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableWithColumns_DatabaseName { get; set; }
            public System.String TableWithColumns_Name { get; set; }
            public System.Func<Amazon.LakeFormation.Model.RemoveLFTagsFromResourceResponse, RemoveLKFLFTagsFromResourceCmdlet, object> Select { get; set; } =
