...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    [AWSCmdletOutput("Amazon.LakeFormation.Model.GetLFTagResponse",
        "This cmdlet returns an Amazon.LakeFormation.Model.GetLFTagResponse object containing multiple properties."
    )]
    public partial class GetLKFLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        private Amazon.LakeFormation.Model.GetLFTagResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.GetLFTagRequest request)
        {
            ...
            try
            {
                return client.GetLFTagAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
