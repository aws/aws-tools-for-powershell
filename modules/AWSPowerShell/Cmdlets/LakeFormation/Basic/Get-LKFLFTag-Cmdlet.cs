...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    [AWSCmdlet("Calls the AWS Lake Formation GetLFTag API operation.", Operation = new[] {"GetLFTag"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.GetLFTagResponse))]
    [AWSCmdletOutput("Amazon.LakeFormation.Model.GetLFTagResponse",
        "This cmdlet returns an Amazon.LakeFormation.Model.GetLFTagResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLKFLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.GetLFTagResponse, GetLKFLFTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.GetLFTagRequest();
        ...
        private Amazon.LakeFormation.Model.GetLFTagResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.GetLFTagRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "GetLFTag");
            try
            {
                #if DESKTOP
                return client.GetLFTag(request);
                #elif CORECLR
                return client.GetLFTagAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CatalogId { get; set; }
            public System.String TagKey { get; set; }
            public System.Func<Amazon.LakeFormation.Model.GetLFTagResponse, GetLKFLFTagCmdlet, object> Select { get; set; } =
