...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    public partial class GetLKFTransactionCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "TransactionDescription";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.DescribeTransactionResponse, GetLKFTransactionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.DescribeTransactionRequest();
        ...
        private Amazon.LakeFormation.Model.DescribeTransactionResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.DescribeTransactionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "DescribeTransaction");
            try
            {
                #if DESKTOP
                return client.DescribeTransaction(request);
                #elif CORECLR
                return client.DescribeTransactionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TransactionId { get; set; }
            public System.Func<Amazon.LakeFormation.Model.DescribeTransactionResponse, GetLKFTransactionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TransactionDescription;
        }
