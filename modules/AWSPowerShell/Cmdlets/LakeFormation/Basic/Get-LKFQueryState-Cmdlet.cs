...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    public partial class GetLKFQueryStateCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.GetQueryStateResponse, GetLKFQueryStateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.GetQueryStateRequest();
        ...
        private Amazon.LakeFormation.Model.GetQueryStateResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.GetQueryStateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "GetQueryState");
            try
            {
                #if DESKTOP
                return client.GetQueryState(request);
                #elif CORECLR
                return client.GetQueryStateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String QueryId { get; set; }
            public System.Func<Amazon.LakeFormation.Model.GetQueryStateResponse, GetLKFQueryStateCmdlet, object> Select { get; set; } =
