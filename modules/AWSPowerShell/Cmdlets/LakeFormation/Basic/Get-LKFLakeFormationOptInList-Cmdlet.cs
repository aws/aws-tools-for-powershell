...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    /// Formation permissions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "LKFLakeFormationOptInList")]
    [OutputType("Amazon.LakeFormation.Model.LakeFormationOptInsInfo")]
    [AWSCmdlet("Calls the AWS Lake Formation ListLakeFormationOptIns API operation.", Operation = new[] {"ListLakeFormationOptIns"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse))]
    [AWSCmdletOutput("Amazon.LakeFormation.Model.LakeFormationOptInsInfo or Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse",
        "This cmdlet returns a collection of Amazon.LakeFormation.Model.LakeFormationOptInsInfo objects.",
        "The service call response (type Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLKFLakeFormationOptInListCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'LakeFormationOptInsInfoList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse).
        /// Specifying the name of a property of type Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LakeFormationOptInsInfoList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse, GetLKFLakeFormationOptInListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LakeFormation.Model.ListLakeFormationOptInsRequest();
        ...
        private Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.ListLakeFormationOptInsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "ListLakeFormationOptIns");
            try
            {
                #if DESKTOP
                return client.ListLakeFormationOptIns(request);
                #elif CORECLR
                return client.ListLakeFormationOptInsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableWithColumns_DatabaseName { get; set; }
            public System.String TableWithColumns_Name { get; set; }
            public System.Func<Amazon.LakeFormation.Model.ListLakeFormationOptInsResponse, GetLKFLakeFormationOptInListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LakeFormationOptInsInfoList;
        }
