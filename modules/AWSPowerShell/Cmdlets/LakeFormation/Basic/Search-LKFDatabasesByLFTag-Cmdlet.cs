...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    [AWSCmdlet("Calls the AWS Lake Formation SearchDatabasesByLFTags API operation.", Operation = new[] {"SearchDatabasesByLFTags"}, SelectReturnType = typeof(Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse))]
    [AWSCmdletOutput("Amazon.LakeFormation.Model.TaggedDatabase or Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse",
        "This cmdlet returns a collection of Amazon.LakeFormation.Model.TaggedDatabase objects.",
        "The service call response (type Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SearchLKFDatabasesByLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of conditions (<c>LFTag</c> structures) to search for in database resources.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-LKFDatabasesByLFTag (SearchDatabasesByLFTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse, SearchLKFDatabasesByLFTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LakeFormation.Model.SearchDatabasesByLFTagsRequest();
        ...
        private Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.SearchDatabasesByLFTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "SearchDatabasesByLFTags");
            try
            {
                return client.SearchDatabasesByLFTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.LakeFormation.Model.SearchDatabasesByLFTagsResponse, SearchLKFDatabasesByLFTagCmdlet, object> Select { get; set; } =
