...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    /// and principals.
    /// </summary>
    [Cmdlet("Remove", "LKFLakeFormationOptIn", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLKFLakeFormationOptInCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.LakeFormation.Model.DeleteLakeFormationOptInResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LKFLakeFormationOptIn (DeleteLakeFormationOptIn)"))
            {
                return;
            }
        ...
        private Amazon.LakeFormation.Model.DeleteLakeFormationOptInResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.DeleteLakeFormationOptInRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "DeleteLakeFormationOptIn");
            try
            {
                #if DESKTOP
                return client.DeleteLakeFormationOptIn(request);
                #elif CORECLR
                return client.DeleteLakeFormationOptInAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableWithColumns_DatabaseName { get; set; }
            public System.String TableWithColumns_Name { get; set; }
            public System.Func<Amazon.LakeFormation.Model.DeleteLakeFormationOptInResponse, RemoveLKFLakeFormationOptInCmdlet, object> Select { get; set; } =
