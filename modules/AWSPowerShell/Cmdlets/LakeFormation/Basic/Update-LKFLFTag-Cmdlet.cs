...
namespace Amazon.PowerShell.Cmdlets.LKF
{
    ...
    public partial class UpdateLKFLFTagCmdlet : AmazonLakeFormationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of LF-tag values to add from the LF-tag.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String[] TagValuesToAdd { get; set; }
        #endregion
        
        #region Parameter TagValuesToDelete
        /// <summary>
        /// <para>
        /// <para>A list of LF-tag values to delete from the LF-tag.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String[] TagValuesToDelete { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-LKFLFTag (UpdateLFTag)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LakeFormation.Model.UpdateLFTagResponse, UpdateLKFLFTagCmdlet>(Select) ??
            ...
            {
                context.TagValuesToAdd = new List<System.String>(this.TagValuesToAdd);
            }
            if (this.TagValuesToDelete != null)
            {
                context.TagValuesToDelete = new List<System.String>(this.TagValuesToDelete);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LakeFormation.Model.UpdateLFTagRequest();
            ...
            if (cmdletContext.TagValuesToAdd != null)
            {
                request.TagValuesToAdd = cmdletContext.TagValuesToAdd;
            }
            if (cmdletContext.TagValuesToDelete != null)
            {
                request.TagValuesToDelete = cmdletContext.TagValuesToDelete;
            }
        ...
        private Amazon.LakeFormation.Model.UpdateLFTagResponse CallAWSServiceOperation(IAmazonLakeFormation client, Amazon.LakeFormation.Model.UpdateLFTagRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Lake Formation", "UpdateLFTag");
            try
            {
                return client.UpdateLFTagAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CatalogId { get; set; }
            public System.String TagKey { get; set; }
            public List<System.String> TagValuesToAdd { get; set; }
            public List<System.String> TagValuesToDelete { get; set; }
            public System.Func<Amazon.LakeFormation.Model.UpdateLFTagResponse, UpdateLKFLFTagCmdlet, object> Select { get; set; } =
