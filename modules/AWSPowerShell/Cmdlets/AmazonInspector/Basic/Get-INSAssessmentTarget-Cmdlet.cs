...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdlet("Invokes the DescribeAssessmentTargets operation against Amazon Inspector.", Operation = new[] {"DescribeAssessmentTargets"})]
    ...
    public class GetINSAssessmentTargetCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Inspector.Model.DescribeAssessmentTargetsResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.DescribeAssessmentTargetsRequest request)
        {
