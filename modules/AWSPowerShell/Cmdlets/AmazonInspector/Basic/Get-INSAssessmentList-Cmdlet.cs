...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdletOutput("System.String",
        ...
        "The service call response (type ListAssessmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetINSAssessmentListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ApplicationArns = new List<String>(this.ApplicationArn);
            }
        ...
        {
            public List<String> ApplicationArns { get; set; }
