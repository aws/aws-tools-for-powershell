...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    /// ARNs.
    /// </summary>
    [Cmdlet("Get", "INSAssessmentList")]
    [OutputType("System.String")]
    [AWSCmdlet("Invokes the ListAssessments operation against Amazon Inspector.", Operation = new[] {"ListAssessments"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Inspector.Model.ListAssessmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetINSAssessmentListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ApplicationArns = new List<System.String>(this.ApplicationArn);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Inspector.Model.ListAssessmentsRequest();
            if (cmdletContext.ApplicationArns != null)
            {
                request.ApplicationArns = cmdletContext.ApplicationArns;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListAssessments(request);
        ...
        {
            public List<System.String> ApplicationArns { get; set; }
