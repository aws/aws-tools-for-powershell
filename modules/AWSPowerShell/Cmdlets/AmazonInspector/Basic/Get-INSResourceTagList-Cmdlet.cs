...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    /// </summary>
    [Cmdlet("Get", "INSResourceTagList")]
    [OutputType("Amazon.Inspector.Model.Tag")]
    [AWSCmdlet("Calls the Amazon Inspector ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    ...
    public partial class GetINSResourceTagListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        private Amazon.Inspector.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonInspector client, Amazon.Inspector.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Inspector", "ListTagsForResource");
            try
            {
                #if DESKTOP
