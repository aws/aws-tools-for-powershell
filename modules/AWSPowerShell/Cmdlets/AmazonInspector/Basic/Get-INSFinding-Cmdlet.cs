...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [OutputType("Amazon.Inspector.Model.Finding")]
    ...
    public class GetINSFindingCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.FindingArn = this.FindingArn;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.FindingArn = cmdletContext.FindingArn;
            }
            ...
            try
            {
                var response = client.DescribeFinding(request);
                Dictionary<string, object> notes = null;
                object pipelineOutput = response.Finding;
