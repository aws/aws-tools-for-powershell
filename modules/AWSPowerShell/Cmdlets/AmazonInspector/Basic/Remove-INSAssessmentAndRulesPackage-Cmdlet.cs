...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    [AWSCmdletOutput("System.String",
        ...
        "The service call response (type DetachAssessmentAndRulesPackageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
