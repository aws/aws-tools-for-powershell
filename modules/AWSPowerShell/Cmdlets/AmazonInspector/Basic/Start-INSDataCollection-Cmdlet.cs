...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    /// </summary>
    [Cmdlet("Start", "INSDataCollection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class StartINSDataCollectionCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-INSDataCollection (StartDataCollection)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.StartDataCollection(request);
