...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    /// </summary>
    [Cmdlet("Get", "INSAssessmentAgentList")]
    [OutputType("Amazon.Inspector.Model.Agent")]
    ...
    public class GetINSAssessmentAgentListCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (requestFilter_filter_AgentHealthList != null)
            {
                request.Filter.AgentHealthList = requestFilter_filter_AgentHealthList;
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListAssessmentAgents(request);
                        Dictionary<string, object> notes = null;
                        object pipelineOutput = response.AgentList;
                        ...
                        int _receivedThisCall = response.AgentList.Count;
