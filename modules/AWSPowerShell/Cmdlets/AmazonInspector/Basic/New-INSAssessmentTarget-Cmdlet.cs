...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public class NewINSAssessmentTargetCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The user-defined name identifying the assessment target that you want to create. The
        /// name must be unique within the AWS account.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN specifying the resource group that is used to create the assessment target.</para>
        /// </para>
        /// </summary>
