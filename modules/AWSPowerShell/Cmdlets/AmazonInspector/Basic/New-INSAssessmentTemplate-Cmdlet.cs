...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    public class NewINSAssessmentTemplateCmdlet : AmazonInspectorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN specifying the assessment target for which you want to create the assessment
        /// template.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The user-defined name identifying the assessment template that you want to create.
        /// You can create several assessment templates for an assessment target. The names of
        /// the assessment templates corresponding to a particular assessment target must be unique.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The ARNs specifying the rules packages that you want to attach to the assessment template.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        /// <summary>
        /// <para>
        /// <para>The user-defined attributes that are assigned to every finding generated by the assessment
        /// run that uses this assessment template.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
