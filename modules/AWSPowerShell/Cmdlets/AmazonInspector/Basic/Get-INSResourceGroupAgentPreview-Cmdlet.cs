...
namespace Amazon.PowerShell.Cmdlets.INS
{
    ...
    /// </summary>
    [Cmdlet("Get", "INSResourceGroupAgentPreview")]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.PreviewAgentsForResourceGroup(request);
                        Dictionary<string, object> notes = null;
                        object pipelineOutput = response.AgentPreviewList;
                        ...
                        int _receivedThisCall = response.AgentPreviewList.Count;
