...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public class GetDMSTableStatisticCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.DatabaseMigrationService.Model.DescribeTableStatisticsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeTableStatisticsRequest request)
        {
