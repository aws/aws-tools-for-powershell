...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class GetDMSEndpointCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribeEndpointsRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeEndpointsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeEndpoints");
            try
            {
                #if DESKTOP
