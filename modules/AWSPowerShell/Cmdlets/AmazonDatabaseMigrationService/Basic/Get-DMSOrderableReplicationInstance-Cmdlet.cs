...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    public partial class GetDMSOrderableReplicationInstanceCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribeOrderableReplicationInstancesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.OrderableReplicationInstances;
                        ...
                        int _receivedThisCall = response.OrderableReplicationInstances.Count;
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeOrderableReplicationInstancesResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeOrderableReplicationInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeOrderableReplicationInstances");
            try
            {
                #if DESKTOP
                return client.DescribeOrderableReplicationInstances(request);
                #elif CORECLR
                return client.DescribeOrderableReplicationInstancesAsync(request).GetAwaiter().GetResult();
                #else
