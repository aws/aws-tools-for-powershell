...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    /// </summary>
    [Cmdlet("Get", "DMSPendingMaintenanceAction")]
    [OutputType("Amazon.DatabaseMigrationService.Model.ResourcePendingMaintenanceActions")]
    [AWSCmdlet("Calls the AWS Database Migration Service DescribePendingMaintenanceActions API operation.", Operation = new[] {"DescribePendingMaintenanceActions"})]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.ResourcePendingMaintenanceActions",
        ...
        "The service call response (type Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Marker (type System.String)"
    )]
    public partial class GetDMSPendingMaintenanceActionCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsRequest();
        ...
        private Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribePendingMaintenanceActionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribePendingMaintenanceActions");
            try
            {
                #if DESKTOP
