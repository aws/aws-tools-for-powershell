...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeReplicationTasks API operation.", Operation = new[] {"DescribeReplicationTasks"})]
    ...
    public partial class GetDMSReplicationTaskCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeReplicationTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeReplicationTasks");
            try
            {
                #if DESKTOP
