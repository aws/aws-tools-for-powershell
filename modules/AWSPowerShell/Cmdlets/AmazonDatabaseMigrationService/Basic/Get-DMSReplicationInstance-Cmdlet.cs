...
namespace Amazon.PowerShell.Cmdlets.DMS
{
    ...
    [AWSCmdlet("Calls the AWS Database Migration Service DescribeReplicationInstances API operation.", Operation = new[] {"DescribeReplicationInstances"})]
    [AWSCmdletOutput("Amazon.DatabaseMigrationService.Model.ReplicationInstance",
        "This cmdlet returns a collection of ReplicationInstance objects.",
    ...
    public partial class GetDMSReplicationInstanceCmdlet : AmazonDatabaseMigrationServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DatabaseMigrationService.Model.DescribeReplicationInstancesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ReplicationInstances;
                        ...
                        int _receivedThisCall = response.ReplicationInstances.Count;
        ...
        private Amazon.DatabaseMigrationService.Model.DescribeReplicationInstancesResponse CallAWSServiceOperation(IAmazonDatabaseMigrationService client, Amazon.DatabaseMigrationService.Model.DescribeReplicationInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Database Migration Service", "DescribeReplicationInstances");
            try
            {
                #if DESKTOP
                return client.DescribeReplicationInstances(request);
                #elif CORECLR
                return client.DescribeReplicationInstancesAsync(request).GetAwaiter().GetResult();
                #else
