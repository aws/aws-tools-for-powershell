...
namespace Amazon.PowerShell.Cmdlets.ARC
{
    ...
    /// plan ARN and execution ID.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "ARCPlanExecution")]
    [OutputType("Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse")]
    [AWSCmdlet("Calls the ARC - Region switch GetPlanExecution API operation.", Operation = new[] {"GetPlanExecution"}, SelectReturnType = typeof(Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse))]
    [AWSCmdletOutput("Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse",
        "This cmdlet returns an Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse object containing multiple properties."
    )]
    public partial class GetARCPlanExecutionCmdlet : AmazonARCRegionswitchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the plan with the execution to retrieve.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse).
        /// Specifying the name of a property of type Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse, GetARCPlanExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ARCRegionswitch.Model.GetPlanExecutionRequest();
        ...
        private Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse CallAWSServiceOperation(IAmazonARCRegionswitch client, Amazon.ARCRegionswitch.Model.GetPlanExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "ARC - Region switch", "GetPlanExecution");
            try
            {
                #if DESKTOP
                return client.GetPlanExecution(request);
                #elif CORECLR
                return client.GetPlanExecutionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PlanArn { get; set; }
            public System.Func<Amazon.ARCRegionswitch.Model.GetPlanExecutionResponse, GetARCPlanExecutionCmdlet, object> Select { get; set; } =
