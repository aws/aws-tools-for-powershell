...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    /// </summary>
    [Cmdlet("Disable", "INS2DelegatedAdminAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Inspector2 DisableDelegatedAdminAccount API operation.", Operation = new[] {"DisableDelegatedAdminAccount"}, SelectReturnType = typeof(Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse))]
    [AWSCmdletOutput("System.String or Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisableINS2DelegatedAdminAccountCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-INS2DelegatedAdminAccount (DisableDelegatedAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse, DisableINS2DelegatedAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.DisableDelegatedAdminAccountRequest();
        ...
        private Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.DisableDelegatedAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "DisableDelegatedAdminAccount");
            try
            {
                #if DESKTOP
                return client.DisableDelegatedAdminAccount(request);
                #elif CORECLR
                return client.DisableDelegatedAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DelegatedAdminAccountId { get; set; }
            public System.Func<Amazon.Inspector2.Model.DisableDelegatedAdminAccountResponse, DisableINS2DelegatedAdminAccountCmdlet, object> Select { get; set; } =
