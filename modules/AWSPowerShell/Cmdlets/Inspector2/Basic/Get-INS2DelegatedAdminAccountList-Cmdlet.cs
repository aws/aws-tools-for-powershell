...
{
    /// <summary>
    /// Lists information about the Amazon Inspector delegated administrator of your organization.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetINS2DelegatedAdminAccountListCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.Inspector2.Model.ListDelegatedAdminAccountsResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.ListDelegatedAdminAccountsRequest request)
        {
            ...
            try
            {
                return client.ListDelegatedAdminAccountsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
