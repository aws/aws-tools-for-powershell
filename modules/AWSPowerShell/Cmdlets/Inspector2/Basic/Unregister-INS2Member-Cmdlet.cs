...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "INS2Member", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UnregisterINS2MemberCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-INS2Member (DisassociateMember)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.DisassociateMemberResponse, UnregisterINS2MemberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.DisassociateMemberRequest();
        ...
        private Amazon.Inspector2.Model.DisassociateMemberResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.DisassociateMemberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "DisassociateMember");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.Inspector2.Model.DisassociateMemberResponse, UnregisterINS2MemberCmdlet, object> Select { get; set; } =
