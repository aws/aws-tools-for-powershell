...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    /// </summary>
    [Cmdlet("Stop", "INS2FindingsReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Inspector2 CancelFindingsReport API operation.", Operation = new[] {"CancelFindingsReport"}, SelectReturnType = typeof(Amazon.Inspector2.Model.CancelFindingsReportResponse))]
    [AWSCmdletOutput("System.String or Amazon.Inspector2.Model.CancelFindingsReportResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Inspector2.Model.CancelFindingsReportResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopINS2FindingsReportCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-INS2FindingsReport (CancelFindingsReport)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.CancelFindingsReportResponse, StopINS2FindingsReportCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.CancelFindingsReportRequest();
        ...
        private Amazon.Inspector2.Model.CancelFindingsReportResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.CancelFindingsReportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "CancelFindingsReport");
            try
            {
                #if DESKTOP
                return client.CancelFindingsReport(request);
                #elif CORECLR
                return client.CancelFindingsReportAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ReportId { get; set; }
            public System.Func<Amazon.Inspector2.Model.CancelFindingsReportResponse, StopINS2FindingsReportCmdlet, object> Select { get; set; } =
