...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    public partial class GetINS2MemberCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.GetMemberResponse, GetINS2MemberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.GetMemberRequest();
        ...
        private Amazon.Inspector2.Model.GetMemberResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.GetMemberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "GetMember");
            try
            {
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.Inspector2.Model.GetMemberResponse, GetINS2MemberCmdlet, object> Select { get; set; } =
