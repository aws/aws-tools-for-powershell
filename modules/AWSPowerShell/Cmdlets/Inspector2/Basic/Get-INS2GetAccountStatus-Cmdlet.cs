...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    /// your environment.
    /// </summary>
    [Cmdlet("Get", "INS2GetAccountStatus")]
    ...
    public partial class GetINS2GetAccountStatusCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.BatchGetAccountStatusResponse, GetINS2GetAccountStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.BatchGetAccountStatusRequest();
        ...
        private Amazon.Inspector2.Model.BatchGetAccountStatusResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.BatchGetAccountStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "BatchGetAccountStatus");
            try
            {
                return client.BatchGetAccountStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Inspector2.Model.BatchGetAccountStatusResponse, GetINS2GetAccountStatusCmdlet, object> Select { get; set; } =
