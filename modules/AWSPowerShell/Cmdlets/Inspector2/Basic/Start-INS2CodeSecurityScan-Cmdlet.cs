...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    public partial class StartINS2CodeSecurityScanCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the Resource_ProjectId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^Resource_ProjectId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Resource_ProjectId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.Resource_ProjectId;
            }
        ...
        private Amazon.Inspector2.Model.StartCodeSecurityScanResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.StartCodeSecurityScanRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartCodeSecurityScan(request);
                #elif CORECLR
                return client.StartCodeSecurityScanAsync(request).GetAwaiter().GetResult();
                #else
