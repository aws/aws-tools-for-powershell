...
{
    /// <summary>
    /// Lists the Amazon Inspector usage totals over the last 30 days.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetINS2UsageTotalListCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Web Services account IDs to retrieve usage totals for.</para><para />
        ...
        private Amazon.Inspector2.Model.ListUsageTotalsResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.ListUsageTotalsRequest request)
        {
            ...
            try
            {
                return client.ListUsageTotalsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
