...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    public partial class StopINS2InspectorCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of account IDs you want to enable Amazon Inspector scans for.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The resource scan types you want to enable.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Inspector2.Model.EnableResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.EnableRequest request)
        {
            ...
            try
            {
                return client.EnableAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
