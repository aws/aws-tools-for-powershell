...
namespace Amazon.PowerShell.Cmdlets.INS2
{
    ...
    /// organization.
    /// </summary>
    [Cmdlet("Get", "INS2DelegatedAdminAccount")]
    [OutputType("Amazon.Inspector2.Model.DelegatedAdmin")]
    ...
    public partial class GetINS2DelegatedAdminAccountCmdlet : AmazonInspector2ClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "DelegatedAdmin";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Inspector2.Model.GetDelegatedAdminAccountResponse, GetINS2DelegatedAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Inspector2.Model.GetDelegatedAdminAccountRequest();
        ...
        private Amazon.Inspector2.Model.GetDelegatedAdminAccountResponse CallAWSServiceOperation(IAmazonInspector2 client, Amazon.Inspector2.Model.GetDelegatedAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Inspector2", "GetDelegatedAdminAccount");
            try
            {
                #if DESKTOP
                return client.GetDelegatedAdminAccount(request);
                #elif CORECLR
                return client.GetDelegatedAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.Inspector2.Model.GetDelegatedAdminAccountResponse, GetINS2DelegatedAdminAccountCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DelegatedAdmin;
        }
