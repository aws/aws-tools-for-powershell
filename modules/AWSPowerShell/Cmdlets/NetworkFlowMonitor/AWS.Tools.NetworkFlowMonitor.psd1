#
# Module manifest for module 'AWS.Tools.NetworkFlowMonitor'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.NetworkFlowMonitor.dll'
    ...
    GUID = '870fedf3-8840-4d96-951a-8da5473e1d08'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.NetworkFlowMonitor.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.NetworkFlowMonitor.Completers.psm1',
        'AWS.Tools.NetworkFlowMonitor.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.NetworkFlowMonitor.dll-Help.xml'
    )
