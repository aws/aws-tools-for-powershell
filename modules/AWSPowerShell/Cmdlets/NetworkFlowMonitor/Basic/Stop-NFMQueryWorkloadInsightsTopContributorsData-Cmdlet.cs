...
namespace Amazon.PowerShell.Cmdlets.NFM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Stop", "NFMQueryWorkloadInsightsTopContributorsData", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Network Flow Monitor StopQueryWorkloadInsightsTopContributorsData API operation.", Operation = new[] {"StopQueryWorkloadInsightsTopContributorsData"}, SelectReturnType = typeof(Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse))]
    [AWSCmdletOutput("None or Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse) be returned by specifying '-Select *'."
    )]
    public partial class StopNFMQueryWorkloadInsightsTopContributorsDataCmdlet : AmazonNetworkFlowMonitorClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-NFMQueryWorkloadInsightsTopContributorsData (StopQueryWorkloadInsightsTopContributorsData)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse, StopNFMQueryWorkloadInsightsTopContributorsDataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataRequest();
        ...
        private Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse CallAWSServiceOperation(IAmazonNetworkFlowMonitor client, Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Network Flow Monitor", "StopQueryWorkloadInsightsTopContributorsData");
            try
            {
                #if DESKTOP
                return client.StopQueryWorkloadInsightsTopContributorsData(request);
                #elif CORECLR
                return client.StopQueryWorkloadInsightsTopContributorsDataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String QueryId { get; set; }
            public System.String ScopeId { get; set; }
            public System.Func<Amazon.NetworkFlowMonitor.Model.StopQueryWorkloadInsightsTopContributorsDataResponse, StopNFMQueryWorkloadInsightsTopContributorsDataCmdlet, object> Select { get; set; } =
