...
namespace Amazon.PowerShell.Cmdlets.NFM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Start", "NFMQueryWorkloadInsightsTopContributor", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Network Flow Monitor StartQueryWorkloadInsightsTopContributors API operation.", Operation = new[] {"StartQueryWorkloadInsightsTopContributors"}, SelectReturnType = typeof(Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse))]
    [AWSCmdletOutput("System.String or Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartNFMQueryWorkloadInsightsTopContributorCmdlet : AmazonNetworkFlowMonitorClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse).
        /// Specifying the name of a property of type Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-NFMQueryWorkloadInsightsTopContributor (StartQueryWorkloadInsightsTopContributors)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse, StartNFMQueryWorkloadInsightsTopContributorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsRequest();
        ...
        private Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse CallAWSServiceOperation(IAmazonNetworkFlowMonitor client, Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Network Flow Monitor", "StartQueryWorkloadInsightsTopContributors");
            try
            {
                #if DESKTOP
                return client.StartQueryWorkloadInsightsTopContributors(request);
                #elif CORECLR
                return client.StartQueryWorkloadInsightsTopContributorsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ScopeId { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.NetworkFlowMonitor.Model.StartQueryWorkloadInsightsTopContributorsResponse, StartNFMQueryWorkloadInsightsTopContributorCmdlet, object> Select { get; set; } =
