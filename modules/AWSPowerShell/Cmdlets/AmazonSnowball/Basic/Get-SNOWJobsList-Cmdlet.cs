...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Invokes the ListJobs operation against Amazon Import/Export Snowball.", Operation = new[] {"ListJobs"})]
    ...
    public class GetSNOWJobsListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
