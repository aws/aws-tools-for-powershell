...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Invokes the ListClusters operation against AWS Import/Export Snowball.", Operation = new[] {"ListClusters"})]
    [AWSCmdletOutput("Amazon.Snowball.Model.ClusterListEntry",
        "This cmdlet returns a collection of ClusterListEntry objects.",
    ...
    public partial class GetSNOWClusterListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Snowball.Model.ListClustersRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ClusterListEntries;
                        ...
                        int _receivedThisCall = response.ClusterListEntries.Count;
        ...
        private Amazon.Snowball.Model.ListClustersResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.ListClustersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Import/Export Snowball", "ListClusters");
            #if DESKTOP
