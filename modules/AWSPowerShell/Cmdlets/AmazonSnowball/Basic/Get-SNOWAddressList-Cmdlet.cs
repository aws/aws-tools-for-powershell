...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Invokes the DescribeAddresses operation against Amazon Import/Export Snowball.", Operation = new[] {"DescribeAddresses"})]
    ...
    public class GetSNOWAddressListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Snowball.Model.DescribeAddressesRequest();
        ...
        private static Amazon.Snowball.Model.DescribeAddressesResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.DescribeAddressesRequest request)
        {
