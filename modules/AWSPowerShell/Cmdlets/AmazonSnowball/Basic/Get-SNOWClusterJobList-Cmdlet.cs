...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Invokes the ListClusterJobs operation against AWS Import/Export Snowball.", Operation = new[] {"ListClusterJobs"})]
    ...
    public partial class GetSNOWClusterJobListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Snowball.Model.ListClusterJobsResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.ListClusterJobsRequest request)
        {
            #if DESKTOP
            return client.ListClusterJobs(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListClusterJobsAsync(request);
            return task.Result;
            #else
