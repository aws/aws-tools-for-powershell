...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Calls the AWS Import/Export Snowball ListCompatibleImages API operation.", Operation = new[] {"ListCompatibleImages"})]
    [AWSCmdletOutput("Amazon.Snowball.Model.CompatibleImage",
        "This cmdlet returns a collection of CompatibleImage objects.",
    ...
    public partial class GetSNOWCompatibleImageListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Snowball.Model.ListCompatibleImagesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CompatibleImages;
        ...
        private Amazon.Snowball.Model.ListCompatibleImagesResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.ListCompatibleImagesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListCompatibleImagesAsync(request);
                return task.Result;
                #else
