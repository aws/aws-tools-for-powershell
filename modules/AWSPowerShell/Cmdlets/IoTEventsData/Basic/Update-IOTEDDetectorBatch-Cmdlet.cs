...
namespace Amazon.PowerShell.Cmdlets.IOTED
{
    ...
    /// </summary>
    [Cmdlet("Update", "IOTEDDetectorBatch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTEventsData.Model.BatchUpdateDetectorErrorEntry")]
    ...
    public partial class UpdateIOTEDDetectorBatchCmdlet : AmazonIoTEventsDataClientCmdlet, IExecutor
    {
        ...
        [Alias("Detectors")]
        public Amazon.IoTEventsData.Model.UpdateDetectorRequest[] Detector { get; set; }
        #endregion
        ...
        public string Select { get; set; } = "BatchUpdateDetectorErrorEntries";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Detector' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTEDDetectorBatch (BatchUpdateDetector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEventsData.Model.BatchUpdateDetectorResponse, UpdateIOTEDDetectorBatchCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Detector;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            if (this.Detector != null)
            {
                context.Detector = new List<Amazon.IoTEventsData.Model.UpdateDetectorRequest>(this.Detector);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTEventsData.Model.BatchUpdateDetectorRequest();
        ...
        private Amazon.IoTEventsData.Model.BatchUpdateDetectorResponse CallAWSServiceOperation(IAmazonIoTEventsData client, Amazon.IoTEventsData.Model.BatchUpdateDetectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Events Data", "BatchUpdateDetector");
            try
            {
                #if DESKTOP
                return client.BatchUpdateDetector(request);
                #elif CORECLR
                return client.BatchUpdateDetectorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<Amazon.IoTEventsData.Model.UpdateDetectorRequest> Detector { get; set; }
            public System.Func<Amazon.IoTEventsData.Model.BatchUpdateDetectorResponse, UpdateIOTEDDetectorBatchCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BatchUpdateDetectorErrorEntries;
        }
