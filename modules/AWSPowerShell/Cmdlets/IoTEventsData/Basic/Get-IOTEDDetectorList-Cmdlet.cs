...
namespace Amazon.PowerShell.Cmdlets.IOTED
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTEDDetectorList")]
    [OutputType("Amazon.IoTEventsData.Model.DetectorSummary")]
    [AWSCmdlet("Calls the AWS IoT Events Data ListDetectors API operation.", Operation = new[] {"ListDetectors"}, SelectReturnType = typeof(Amazon.IoTEventsData.Model.ListDetectorsResponse))]
    [AWSCmdletOutput("Amazon.IoTEventsData.Model.DetectorSummary or Amazon.IoTEventsData.Model.ListDetectorsResponse",
        "This cmdlet returns a collection of Amazon.IoTEventsData.Model.DetectorSummary objects.",
        "The service call response (type Amazon.IoTEventsData.Model.ListDetectorsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTEDDetectorListCmdlet : AmazonIoTEventsDataClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DetectorSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTEventsData.Model.ListDetectorsResponse, GetIOTEDDetectorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTEventsData.Model.ListDetectorsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DetectorSummaries?.Count ?? 0;
        ...
        private Amazon.IoTEventsData.Model.ListDetectorsResponse CallAWSServiceOperation(IAmazonIoTEventsData client, Amazon.IoTEventsData.Model.ListDetectorsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StateName { get; set; }
            public System.Func<Amazon.IoTEventsData.Model.ListDetectorsResponse, GetIOTEDDetectorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DetectorSummaries;
        }
