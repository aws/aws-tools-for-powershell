...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    /// </summary>
    [Cmdlet("Add", "IFWResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddIFWResourceTagCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IFWResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.TagResourceResponse, AddIFWResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.TagResourceRequest();
        ...
        private Amazon.IoTFleetWise.Model.TagResourceResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTFleetWise.Model.TagResourceResponse, AddIFWResourceTagCmdlet, object> Select { get; set; } =
