...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    /// models.
    /// </summary>
    [Cmdlet("New", "IFWSignalCatalog", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewIFWSignalCatalogCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        /// more information, see the API data type.</para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Nodes")]
        public Amazon.IoTFleetWise.Model.Node[] Node { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IFWSignalCatalog (CreateSignalCatalog)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.CreateSignalCatalogResponse, NewIFWSignalCatalogCmdlet>(Select) ??
            ...
            if (this.Node != null)
            {
                context.Node = new List<Amazon.IoTFleetWise.Model.Node>(this.Node);
            }
            if (this.Tag != null)
            {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.CreateSignalCatalogRequest();
        ...
        private Amazon.IoTFleetWise.Model.CreateSignalCatalogResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.CreateSignalCatalogRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "CreateSignalCatalog");
            try
            {
                return client.CreateSignalCatalogAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String Name { get; set; }
            public List<Amazon.IoTFleetWise.Model.Node> Node { get; set; }
            public List<Amazon.IoTFleetWise.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.CreateSignalCatalogResponse, NewIFWSignalCatalogCmdlet, object> Select { get; set; } =
