...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    public partial class GetIFWDecoderManifestCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.GetDecoderManifestResponse, GetIFWDecoderManifestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.GetDecoderManifestRequest();
        ...
        private Amazon.IoTFleetWise.Model.GetDecoderManifestResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.GetDecoderManifestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "GetDecoderManifest");
            try
            {
                #if DESKTOP
                return client.GetDecoderManifest(request);
                #elif CORECLR
                return client.GetDecoderManifestAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.GetDecoderManifestResponse, GetIFWDecoderManifestCmdlet, object> Select { get; set; } =
