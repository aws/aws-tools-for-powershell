...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    /// templates associated with a vehicle.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "IFWVehicleStatus")]
    [OutputType("Amazon.IoTFleetWise.Model.VehicleStatus")]
    [AWSCmdlet("Calls the AWS IoT FleetWise GetVehicleStatus API operation.", Operation = new[] {"GetVehicleStatus"}, SelectReturnType = typeof(Amazon.IoTFleetWise.Model.GetVehicleStatusResponse))]
    [AWSCmdletOutput("Amazon.IoTFleetWise.Model.VehicleStatus or Amazon.IoTFleetWise.Model.GetVehicleStatusResponse",
        "This cmdlet returns a collection of Amazon.IoTFleetWise.Model.VehicleStatus objects.",
        "The service call response (type Amazon.IoTFleetWise.Model.GetVehicleStatusResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIFWVehicleStatusCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Campaigns";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.GetVehicleStatusResponse, GetIFWVehicleStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTFleetWise.Model.GetVehicleStatusRequest();
        ...
        private Amazon.IoTFleetWise.Model.GetVehicleStatusResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.GetVehicleStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "GetVehicleStatus");
            try
            {
                return client.GetVehicleStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String VehicleName { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.GetVehicleStatusResponse, GetIFWVehicleStatusCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Campaigns;
        }
