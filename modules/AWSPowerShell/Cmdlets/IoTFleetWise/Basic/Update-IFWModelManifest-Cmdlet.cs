...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    [AWSCmdletOutput("Amazon.IoTFleetWise.Model.UpdateModelManifestResponse",
        "This cmdlet returns an Amazon.IoTFleetWise.Model.UpdateModelManifestResponse object containing multiple properties."
    )]
    public partial class UpdateIFWModelManifestCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        /// signals, to add to the vehicle model. </para><para />
        ...
        /// <para>
        /// <para> A list of <c>fullyQualifiedName</c> of nodes, which are a general abstraction of
        /// signals, to remove from the vehicle model. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.IoTFleetWise.Model.UpdateModelManifestResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.UpdateModelManifestRequest request)
        {
            ...
            try
            {
                return client.UpdateModelManifestAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
