...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    public partial class RemoveIFWVehicleFleetCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IFWVehicleFleet (DisassociateVehicleFleet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.DisassociateVehicleFleetRequest();
        ...
        private Amazon.IoTFleetWise.Model.DisassociateVehicleFleetResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.DisassociateVehicleFleetRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FleetId { get; set; }
            public System.String VehicleName { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.DisassociateVehicleFleetResponse, RemoveIFWVehicleFleetCmdlet, object> Select { get; set; } =
