...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    public partial class RemoveIFWModelManifestCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IFWModelManifest (DeleteModelManifest)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.DeleteModelManifestResponse, RemoveIFWModelManifestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.DeleteModelManifestRequest();
        ...
        private Amazon.IoTFleetWise.Model.DeleteModelManifestResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.DeleteModelManifestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "DeleteModelManifest");
            try
            {
                return client.DeleteModelManifestAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.DeleteModelManifestResponse, RemoveIFWModelManifestCmdlet, object> Select { get; set; } =
