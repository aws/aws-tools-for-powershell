...
namespace Amazon.PowerShell.Cmdlets.IFW
{
    ...
    [AWSCmdlet("Calls the AWS IoT FleetWise UpdateFleet API operation.", Operation = new[] {"UpdateFleet"}, SelectReturnType = typeof(Amazon.IoTFleetWise.Model.UpdateFleetResponse))]
    [AWSCmdletOutput("Amazon.IoTFleetWise.Model.UpdateFleetResponse",
        "This cmdlet returns an Amazon.IoTFleetWise.Model.UpdateFleetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIFWFleetCmdlet : AmazonIoTFleetWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IFWFleet (UpdateFleet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTFleetWise.Model.UpdateFleetResponse, UpdateIFWFleetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTFleetWise.Model.UpdateFleetRequest();
        ...
        private Amazon.IoTFleetWise.Model.UpdateFleetResponse CallAWSServiceOperation(IAmazonIoTFleetWise client, Amazon.IoTFleetWise.Model.UpdateFleetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT FleetWise", "UpdateFleet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String FleetId { get; set; }
            public System.Func<Amazon.IoTFleetWise.Model.UpdateFleetResponse, UpdateIFWFleetCmdlet, object> Select { get; set; } =
