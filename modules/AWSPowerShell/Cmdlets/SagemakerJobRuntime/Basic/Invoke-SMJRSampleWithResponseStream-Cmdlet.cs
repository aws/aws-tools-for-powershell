...
namespace Amazon.PowerShell.Cmdlets.SMJR
{
    ...
    /// </summary>
    [Cmdlet("Invoke", "SMJRSampleWithResponseStream", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse")]
    [AWSCmdlet("Calls the Sagemaker Job Runtime Service SampleWithResponseStream API operation.", Operation = new[] {"SampleWithResponseStream"}, SelectReturnType = typeof(Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse))]
    [AWSCmdletOutput("Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse",
        "This cmdlet returns an Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse object containing multiple properties."
    )]
    public partial class InvokeSMJRSampleWithResponseStreamCmdlet : AmazonSagemakerJobRuntimeClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse).
        /// Specifying the name of a property of type Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-SMJRSampleWithResponseStream (SampleWithResponseStream)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse, InvokeSMJRSampleWithResponseStreamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamRequest();
        ...
        private Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse CallAWSServiceOperation(IAmazonSagemakerJobRuntime client, Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Sagemaker Job Runtime Service", "SampleWithResponseStream");
            try
            {
                return client.SampleWithResponseStreamAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String JobArn { get; set; }
            public System.String TrajectoryId { get; set; }
            public System.Func<Amazon.SagemakerJobRuntime.Model.SampleWithResponseStreamResponse, InvokeSMJRSampleWithResponseStreamCmdlet, object> Select { get; set; } =
