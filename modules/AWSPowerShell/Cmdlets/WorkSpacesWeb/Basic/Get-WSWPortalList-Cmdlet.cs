...
{
    /// <summary>
    /// Retrieves a list or web portals.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "WSWPortalList")]
    [OutputType("Amazon.WorkSpacesWeb.Model.PortalSummary")]
    ...
    public partial class GetWSWPortalListCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Portals";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.ListPortalsResponse, GetWSWPortalListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkSpacesWeb.Model.ListPortalsRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.ListPortalsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.ListPortalsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "ListPortals");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.ListPortalsResponse, GetWSWPortalListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Portals;
        }
