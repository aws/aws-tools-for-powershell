...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSWIdentityProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSWIdentityProviderCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSWIdentityProvider (DeleteIdentityProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DeleteIdentityProviderResponse, RemoveWSWIdentityProviderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DeleteIdentityProviderRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DeleteIdentityProviderResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DeleteIdentityProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DeleteIdentityProvider");
            try
            {
                return client.DeleteIdentityProviderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String IdentityProviderArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DeleteIdentityProviderResponse, RemoveWSWIdentityProviderCmdlet, object> Select { get; set; } =
