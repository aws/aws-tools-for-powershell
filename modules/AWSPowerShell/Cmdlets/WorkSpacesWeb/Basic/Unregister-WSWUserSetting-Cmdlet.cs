...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "WSWUserSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UnregisterWSWUserSettingCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WSWUserSetting (DisassociateUserSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DisassociateUserSettingsResponse, UnregisterWSWUserSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DisassociateUserSettingsRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DisassociateUserSettingsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DisassociateUserSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DisassociateUserSettings");
            try
            {
                #if DESKTOP
                return client.DisassociateUserSettings(request);
                #elif CORECLR
                return client.DisassociateUserSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PortalArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DisassociateUserSettingsResponse, UnregisterWSWUserSettingCmdlet, object> Select { get; set; } =
