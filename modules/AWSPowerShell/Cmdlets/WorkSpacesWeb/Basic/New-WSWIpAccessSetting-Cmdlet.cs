...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    [AWSCmdletOutput("System.String or Amazon.WorkSpacesWeb.Model.CreateIpAccessSettingsResponse",
        ...
        "The service call response (type Amazon.WorkSpacesWeb.Model.CreateIpAccessSettingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
