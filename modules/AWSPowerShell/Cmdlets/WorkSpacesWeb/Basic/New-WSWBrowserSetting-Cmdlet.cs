...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    public partial class NewWSWBrowserSettingCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BrowserPolicy' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.BrowserPolicy;
            }
        ...
        private Amazon.WorkSpacesWeb.Model.CreateBrowserSettingsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.CreateBrowserSettingsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateBrowserSettings(request);
                #elif CORECLR
                return client.CreateBrowserSettingsAsync(request).GetAwaiter().GetResult();
                #else
