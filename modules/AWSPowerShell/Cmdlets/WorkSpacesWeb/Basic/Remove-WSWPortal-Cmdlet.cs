...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSWPortal", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSWPortalCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSWPortal (DeletePortal)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DeletePortalResponse, RemoveWSWPortalCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DeletePortalRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DeletePortalResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DeletePortalRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DeletePortal");
            try
            {
        ...
        {
            public System.String PortalArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DeletePortalResponse, RemoveWSWPortalCmdlet, object> Select { get; set; } =
