...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "WSWUserAccessLoggingSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UnregisterWSWUserAccessLoggingSettingCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WSWUserAccessLoggingSetting (DisassociateUserAccessLoggingSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DisassociateUserAccessLoggingSettingsResponse, UnregisterWSWUserAccessLoggingSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DisassociateUserAccessLoggingSettingsRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DisassociateUserAccessLoggingSettingsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DisassociateUserAccessLoggingSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DisassociateUserAccessLoggingSettings");
            try
            {
                #if DESKTOP
                return client.DisassociateUserAccessLoggingSettings(request);
                #elif CORECLR
                return client.DisassociateUserAccessLoggingSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PortalArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DisassociateUserAccessLoggingSettingsResponse, UnregisterWSWUserAccessLoggingSettingCmdlet, object> Select { get; set; } =
