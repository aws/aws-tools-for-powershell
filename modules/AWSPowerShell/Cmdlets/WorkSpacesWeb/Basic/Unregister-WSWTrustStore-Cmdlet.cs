...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "WSWTrustStore", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UnregisterWSWTrustStoreCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WSWTrustStore (DisassociateTrustStore)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DisassociateTrustStoreResponse, UnregisterWSWTrustStoreCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DisassociateTrustStoreRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DisassociateTrustStoreResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DisassociateTrustStoreRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DisassociateTrustStore");
            try
            {
                #if DESKTOP
                return client.DisassociateTrustStore(request);
                #elif CORECLR
                return client.DisassociateTrustStoreAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PortalArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DisassociateTrustStoreResponse, UnregisterWSWTrustStoreCmdlet, object> Select { get; set; } =
