...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    public partial class NewWSWDataProtectionSettingCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Additional encryption context of the data protection settings.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to add to the data protection settings resource. A tag is a key-value pair.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.WorkSpacesWeb.Model.CreateDataProtectionSettingsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.CreateDataProtectionSettingsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateDataProtectionSettings(request);
                #elif CORECLR
                return client.CreateDataProtectionSettingsAsync(request).GetAwaiter().GetResult();
                #else
