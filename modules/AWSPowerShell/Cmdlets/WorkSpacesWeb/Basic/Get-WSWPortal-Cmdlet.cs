...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// Gets the web portal.
    /// </summary>
    [Cmdlet("Get", "WSWPortal")]
    [OutputType("Amazon.WorkSpacesWeb.Model.Portal")]
    [AWSCmdlet("Calls the Amazon WorkSpaces Web GetPortal API operation.", Operation = new[] {"GetPortal"}, SelectReturnType = typeof(Amazon.WorkSpacesWeb.Model.GetPortalResponse))]
    [AWSCmdletOutput("Amazon.WorkSpacesWeb.Model.Portal or Amazon.WorkSpacesWeb.Model.GetPortalResponse",
        "This cmdlet returns an Amazon.WorkSpacesWeb.Model.Portal object.",
        "The service call response (type Amazon.WorkSpacesWeb.Model.GetPortalResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWSWPortalCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.GetPortalResponse, GetWSWPortalCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.GetPortalRequest();
        ...
        {
            public System.String PortalArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.GetPortalResponse, GetWSWPortalCmdlet, object> Select { get; set; } =
