...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    [AWSCmdletOutput("Amazon.WorkSpacesWeb.Model.Portal or Amazon.WorkSpacesWeb.Model.GetPortalResponse",
        ...
        "The service call response (type Amazon.WorkSpacesWeb.Model.GetPortalResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
