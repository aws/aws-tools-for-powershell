...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    [AWSCmdletOutput("System.String or Amazon.WorkSpacesWeb.Model.CreateTrustStoreResponse",
        ...
        "The service call response (type Amazon.WorkSpacesWeb.Model.CreateTrustStoreResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewWSWTrustStoreCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of CA certificates to be added to the trust store.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to add to the trust store. A tag is a key-value pair.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
