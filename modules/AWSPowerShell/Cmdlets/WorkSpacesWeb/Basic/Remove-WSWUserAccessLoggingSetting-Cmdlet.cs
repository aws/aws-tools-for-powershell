...
namespace Amazon.PowerShell.Cmdlets.WSW
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSWUserAccessLoggingSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSWUserAccessLoggingSettingCmdlet : AmazonWorkSpacesWebClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSWUserAccessLoggingSetting (DeleteUserAccessLoggingSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesWeb.Model.DeleteUserAccessLoggingSettingsResponse, RemoveWSWUserAccessLoggingSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesWeb.Model.DeleteUserAccessLoggingSettingsRequest();
        ...
        private Amazon.WorkSpacesWeb.Model.DeleteUserAccessLoggingSettingsResponse CallAWSServiceOperation(IAmazonWorkSpacesWeb client, Amazon.WorkSpacesWeb.Model.DeleteUserAccessLoggingSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Web", "DeleteUserAccessLoggingSettings");
            try
            {
                #if DESKTOP
                return client.DeleteUserAccessLoggingSettings(request);
                #elif CORECLR
                return client.DeleteUserAccessLoggingSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String UserAccessLoggingSettingsArn { get; set; }
            public System.Func<Amazon.WorkSpacesWeb.Model.DeleteUserAccessLoggingSettingsResponse, RemoveWSWUserAccessLoggingSettingCmdlet, object> Select { get; set; } =
