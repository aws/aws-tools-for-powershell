...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    /// </summary>
    [Cmdlet("New", "EMCNRouterInput", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaConnect.Model.RouterInput")]
    [AWSCmdlet("Calls the AWS Elemental MediaConnect CreateRouterInput API operation.", Operation = new[] {"CreateRouterInput"}, SelectReturnType = typeof(Amazon.MediaConnect.Model.CreateRouterInputResponse))]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.RouterInput or Amazon.MediaConnect.Model.CreateRouterInputResponse",
        "This cmdlet returns an Amazon.MediaConnect.Model.RouterInput object.",
        "The service call response (type Amazon.MediaConnect.Model.CreateRouterInputResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewEMCNRouterInputCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Availability Zone where you want to create the router input. This must be a valid
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum bitrate for the router input.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the router input.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS Region for the router input. Defaults to the current region if not specified.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Key-value pairs that can be used to tag and organize this router input.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        /// <summary>
        /// <para>
        /// <para>The tier level for the router input.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConnect.Model.CreateRouterInputResponse).
        /// Specifying the name of a property of type Amazon.MediaConnect.Model.CreateRouterInputResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EMCNRouterInput (CreateRouterInput)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.CreateRouterInputResponse, NewEMCNRouterInputCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConnect.Model.CreateRouterInputRequest();
        ...
        private Amazon.MediaConnect.Model.CreateRouterInputResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.CreateRouterInputRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "CreateRouterInput");
            try
            {
                #if DESKTOP
                return client.CreateRouterInput(request);
                #elif CORECLR
                return client.CreateRouterInputAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TransitEncryption_EncryptionKeyConfiguration_SecretsManager_SecretArn { get; set; }
            public Amazon.MediaConnect.RouterInputTransitEncryptionKeyType TransitEncryption_EncryptionKeyType { get; set; }
            public System.Func<Amazon.MediaConnect.Model.CreateRouterInputResponse, NewEMCNRouterInputCmdlet, object> Select { get; set; } =
