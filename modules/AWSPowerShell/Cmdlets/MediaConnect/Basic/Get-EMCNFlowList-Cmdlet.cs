...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMCNFlowList")]
    [OutputType("Amazon.MediaConnect.Model.ListedFlow")]
    ...
    public partial class GetEMCNFlowListCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.ListFlowsResponse, GetEMCNFlowListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaConnect.Model.ListFlowsRequest();
        ...
        private Amazon.MediaConnect.Model.ListFlowsResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.ListFlowsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MediaConnect.Model.ListFlowsResponse, GetEMCNFlowListCmdlet, object> Select { get; set; } =
