...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConnect UpdateBridgeState API operation.", Operation = new[] {"UpdateBridgeState"}, SelectReturnType = typeof(Amazon.MediaConnect.Model.UpdateBridgeStateResponse))]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.UpdateBridgeStateResponse",
        "This cmdlet returns an Amazon.MediaConnect.Model.UpdateBridgeStateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateEMCNBridgeStateCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.MediaConnect.DesiredState")]
        public Amazon.MediaConnect.DesiredState DesiredState { get; set; }
        #endregion
        
        #region Parameter Select
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is '*'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConnect.Model.UpdateBridgeStateResponse).
        /// Specifying the name of a property of type Amazon.MediaConnect.Model.UpdateBridgeStateResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EMCNBridgeState (UpdateBridgeState)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.UpdateBridgeStateResponse, UpdateEMCNBridgeStateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConnect.Model.UpdateBridgeStateRequest();
        ...
        private Amazon.MediaConnect.Model.UpdateBridgeStateResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.UpdateBridgeStateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "UpdateBridgeState");
            try
            {
                #if DESKTOP
                return client.UpdateBridgeState(request);
                #elif CORECLR
                return client.UpdateBridgeStateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BridgeArn { get; set; }
            public Amazon.MediaConnect.DesiredState DesiredState { get; set; }
            public System.Func<Amazon.MediaConnect.Model.UpdateBridgeStateResponse, UpdateEMCNBridgeStateCmdlet, object> Select { get; set; } =
