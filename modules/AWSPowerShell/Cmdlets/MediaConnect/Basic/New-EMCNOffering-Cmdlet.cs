...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    public partial class NewEMCNOfferingCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The Amazon Resource Name (ARN) of the offering.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para> The name that you want to use for the reservation.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para> The date and time that you want the reservation to begin, in Coordinated Universal
        /// Time (UTC). </para><para>You can specify any date and time between 12:00am on the first day of the current
        ...
        /// enter <c>2020-03-05T23:30:00Z</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
