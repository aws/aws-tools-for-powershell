...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    /// </summary>
    [Cmdlet("Update", "EMCNRouterOutput", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MediaConnect.Model.RouterOutput")]
    [AWSCmdlet("Calls the AWS Elemental MediaConnect UpdateRouterOutput API operation.", Operation = new[] {"UpdateRouterOutput"}, SelectReturnType = typeof(Amazon.MediaConnect.Model.UpdateRouterOutputResponse))]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.RouterOutput or Amazon.MediaConnect.Model.UpdateRouterOutputResponse",
        "This cmdlet returns an Amazon.MediaConnect.Model.RouterOutput object.",
        "The service call response (type Amazon.MediaConnect.Model.UpdateRouterOutputResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateEMCNRouterOutputCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the router output that you want to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The updated maximum bitrate for the router output.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated name for the router output.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated tier level for the router output.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConnect.Model.UpdateRouterOutputResponse).
        /// Specifying the name of a property of type Amazon.MediaConnect.Model.UpdateRouterOutputResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EMCNRouterOutput (UpdateRouterOutput)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.UpdateRouterOutputResponse, UpdateEMCNRouterOutputCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConnect.Model.UpdateRouterOutputRequest();
        ...
        private Amazon.MediaConnect.Model.UpdateRouterOutputResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.UpdateRouterOutputRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "UpdateRouterOutput");
            try
            {
                #if DESKTOP
                return client.UpdateRouterOutput(request);
                #elif CORECLR
                return client.UpdateRouterOutputAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.MediaConnect.RoutingScope RoutingScope { get; set; }
            public Amazon.MediaConnect.RouterOutputTier Tier { get; set; }
            public System.Func<Amazon.MediaConnect.Model.UpdateRouterOutputResponse, UpdateEMCNRouterOutputCmdlet, object> Select { get; set; } =
