...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    public partial class NewEMCNRouterNetworkInterfaceCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of allowed CIDR blocks for the public router network interface.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Key-value pairs that can be used to tag and organize this router network interface.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.MediaConnect.Model.CreateRouterNetworkInterfaceResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.CreateRouterNetworkInterfaceRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateRouterNetworkInterface(request);
                #elif CORECLR
                return client.CreateRouterNetworkInterfaceAsync(request).GetAwaiter().GetResult();
                #else
