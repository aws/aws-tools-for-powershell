...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMCNGatewayInstance")]
    [OutputType("Amazon.MediaConnect.Model.GatewayInstance")]
    ...
    public partial class GetEMCNGatewayInstanceCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'GatewayInstance'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConnect.Model.DescribeGatewayInstanceResponse).
        /// Specifying the name of a property of type Amazon.MediaConnect.Model.DescribeGatewayInstanceResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GatewayInstance";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.DescribeGatewayInstanceResponse, GetEMCNGatewayInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConnect.Model.DescribeGatewayInstanceRequest();
        ...
        private Amazon.MediaConnect.Model.DescribeGatewayInstanceResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.DescribeGatewayInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "DescribeGatewayInstance");
            try
            {
                #if DESKTOP
                return client.DescribeGatewayInstance(request);
                #elif CORECLR
                return client.DescribeGatewayInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GatewayInstanceArn { get; set; }
            public System.Func<Amazon.MediaConnect.Model.DescribeGatewayInstanceResponse, GetEMCNGatewayInstanceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GatewayInstance;
        }
