...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    public partial class NewEMCNRouterOutputCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Web Services Region for the router output. Defaults to the current region
        ...
        /// <summary>
        /// <para>
        /// <para>Key-value pairs that can be used to tag this router output.</para><para />
        ...
        private Amazon.MediaConnect.Model.CreateRouterOutputResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.CreateRouterOutputRequest request)
        {
            ...
            try
            {
                return client.CreateRouterOutputAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
