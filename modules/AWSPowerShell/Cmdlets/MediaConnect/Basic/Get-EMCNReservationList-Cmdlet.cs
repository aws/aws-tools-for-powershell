...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdletOutput("Amazon.MediaConnect.Model.Reservation or Amazon.MediaConnect.Model.ListReservationsResponse",
        ...
        "The service call response (type Amazon.MediaConnect.Model.ListReservationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
