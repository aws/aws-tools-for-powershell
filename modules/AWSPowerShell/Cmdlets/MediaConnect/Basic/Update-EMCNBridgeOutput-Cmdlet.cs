...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdletOutput("Amazon.MediaConnect.Model.UpdateBridgeOutputResponse",
        "This cmdlet returns an Amazon.MediaConnect.Model.UpdateBridgeOutputResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateEMCNBridgeOutputCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.MediaConnect.Model.UpdateBridgeOutputResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.UpdateBridgeOutputRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateBridgeOutput(request);
                #elif CORECLR
                return client.UpdateBridgeOutputAsync(request).GetAwaiter().GetResult();
                #else
