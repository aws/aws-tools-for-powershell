...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConnect RemoveFlowOutput API operation.", Operation = new[] {"RemoveFlowOutput"}, SelectReturnType = typeof(Amazon.MediaConnect.Model.RemoveFlowOutputResponse))]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.RemoveFlowOutputResponse",
        "This cmdlet returns an Amazon.MediaConnect.Model.RemoveFlowOutputResponse object containing multiple properties."
    )]
    public partial class RemoveEMCNFlowOutputCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The Amazon Resource Name (ARN) of the flow that you want to remove an output from.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para> The ARN of the output that you want to remove. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.RemoveFlowOutputResponse, RemoveEMCNFlowOutputCmdlet>(Select) ??
        ...
        private Amazon.MediaConnect.Model.RemoveFlowOutputResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.RemoveFlowOutputRequest request)
        {
            ...
            try
            {
                return client.RemoveFlowOutputAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FlowArn { get; set; }
            public System.String OutputArn { get; set; }
            public System.Func<Amazon.MediaConnect.Model.RemoveFlowOutputResponse, RemoveEMCNFlowOutputCmdlet, object> Select { get; set; } =
