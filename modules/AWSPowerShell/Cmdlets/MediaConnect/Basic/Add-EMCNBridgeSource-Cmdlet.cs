...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    /// </summary>
    [Cmdlet("Add", "EMCNBridgeSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddEMCNBridgeSourceCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The sources that you want to add to this bridge.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaConnect.Model.AddBridgeSourcesResponse).
        /// Specifying the name of a property of type Amazon.MediaConnect.Model.AddBridgeSourcesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EMCNBridgeSource (AddBridgeSources)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaConnect.Model.AddBridgeSourcesResponse, AddEMCNBridgeSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaConnect.Model.AddBridgeSourcesRequest();
        ...
        private Amazon.MediaConnect.Model.AddBridgeSourcesResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.AddBridgeSourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "AddBridgeSources");
            try
            {
                return client.AddBridgeSourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MediaConnect.Model.AddBridgeSourcesResponse, AddEMCNBridgeSourceCmdlet, object> Select { get; set; } =
