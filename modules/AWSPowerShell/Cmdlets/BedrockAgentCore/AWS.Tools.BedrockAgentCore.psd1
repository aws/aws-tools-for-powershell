#
# Module manifest for module 'AWS.Tools.BedrockAgentCore'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BedrockAgentCore.dll'
    ...
    GUID = '071d6e44-6022-4867-92ca-271f6abca217'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.BedrockAgentCore.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BedrockAgentCore.Completers.psm1',
        'AWS.Tools.BedrockAgentCore.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.BedrockAgentCore.dll-Help.xml'
    )
