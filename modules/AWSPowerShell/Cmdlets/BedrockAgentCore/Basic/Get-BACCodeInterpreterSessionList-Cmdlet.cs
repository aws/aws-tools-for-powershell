...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    public partial class GetBACCodeInterpreterSessionListCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the CodeInterpreterIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^CodeInterpreterIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CodeInterpreterIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.BedrockAgentCore.Model.ListCodeInterpreterSessionsResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.ListCodeInterpreterSessionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListCodeInterpreterSessions(request);
                #elif CORECLR
                return client.ListCodeInterpreterSessionsAsync(request).GetAwaiter().GetResult();
                #else
