...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    public partial class GetBACBrowserSessionListCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the BrowserIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^BrowserIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BrowserIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.BrowserIdentifier;
            }
        ...
        private Amazon.BedrockAgentCore.Model.ListBrowserSessionsResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.ListBrowserSessionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListBrowserSessions(request);
                #elif CORECLR
                return client.ListBrowserSessionsAsync(request).GetAwaiter().GetResult();
                #else
