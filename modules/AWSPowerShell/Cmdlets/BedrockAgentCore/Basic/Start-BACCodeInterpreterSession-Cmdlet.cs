...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    public partial class StartBACCodeInterpreterSessionCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The duration in seconds (time-to-live) after which the session automatically terminates,
        /// regardless of ongoing activity. Defaults to 900 seconds (15 minutes). Recommended
        /// minimum: 60 seconds. Maximum allowed: 28,800 seconds (8 hours).</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.BedrockAgentCore.Model.StartCodeInterpreterSessionResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.StartCodeInterpreterSessionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartCodeInterpreterSession(request);
                #elif CORECLR
                return client.StartCodeInterpreterSessionAsync(request).GetAwaiter().GetResult();
                #else
