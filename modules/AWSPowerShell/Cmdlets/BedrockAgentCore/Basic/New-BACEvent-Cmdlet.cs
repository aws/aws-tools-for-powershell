...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    public partial class NewBACEventCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key-value metadata to attach to the event.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The content payload of the event. This can include conversational data or binary content.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.BedrockAgentCore.Model.CreateEventResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.CreateEventRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.CreateEventAsync(request).GetAwaiter().GetResult();
                #else
