...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    public partial class StartBACBrowserSessionCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of certificates to install in the browser session.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>A list of files containing enterprise policies for the browser.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// 60 seconds. Maximum allowed: 28,800 seconds (8 hours).</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.BedrockAgentCore.Model.StartBrowserSessionResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.StartBrowserSessionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartBrowserSession(request);
                #elif CORECLR
                return client.StartBrowserSessionAsync(request).GetAwaiter().GetResult();
                #else
