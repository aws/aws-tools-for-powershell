...
namespace Amazon.PowerShell.Cmdlets.BAC
{
    ...
    [AWSCmdlet("Calls the Amazon Bedrock AgentCore Data Plane Fronting Layer DeleteEvent API operation.", Operation = new[] {"DeleteEvent"}, SelectReturnType = typeof(Amazon.BedrockAgentCore.Model.DeleteEventResponse))]
    [AWSCmdletOutput("System.String or Amazon.BedrockAgentCore.Model.DeleteEventResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BedrockAgentCore.Model.DeleteEventResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveBACEventCmdlet : AmazonBedrockAgentCoreClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the actor associated with the event to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the event to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the session containing the event to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BedrockAgentCore.Model.DeleteEventResponse).
        /// Specifying the name of a property of type Amazon.BedrockAgentCore.Model.DeleteEventResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BACEvent (DeleteEvent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockAgentCore.Model.DeleteEventResponse, RemoveBACEventCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockAgentCore.Model.DeleteEventRequest();
        ...
        private Amazon.BedrockAgentCore.Model.DeleteEventResponse CallAWSServiceOperation(IAmazonBedrockAgentCore client, Amazon.BedrockAgentCore.Model.DeleteEventRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock AgentCore Data Plane Fronting Layer", "DeleteEvent");
            try
            {
                return client.DeleteEventAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemoryId { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.BedrockAgentCore.Model.DeleteEventResponse, RemoveBACEventCmdlet, object> Select { get; set; } =
