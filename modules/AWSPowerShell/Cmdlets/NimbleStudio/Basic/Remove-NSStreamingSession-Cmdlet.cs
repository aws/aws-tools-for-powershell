...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    [AWSCmdlet("Calls the Amazon Nimble Studio DeleteStreamingSession API operation.", Operation = new[] {"DeleteStreamingSession"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingSession or Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingSession object.",
        "The service call response (type Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveNSStreamingSessionCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NSStreamingSession (DeleteStreamingSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse, RemoveNSStreamingSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.DeleteStreamingSessionRequest();
        ...
        private Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.DeleteStreamingSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "DeleteStreamingSession");
            try
            {
                #if DESKTOP
                return client.DeleteStreamingSession(request);
                #elif CORECLR
                return client.DeleteStreamingSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SessionId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.DeleteStreamingSessionResponse, RemoveNSStreamingSessionCmdlet, object> Select { get; set; } =
