...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NSLaunchProfileMember", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveNSLaunchProfileMemberCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NSLaunchProfileMember (DeleteLaunchProfileMember)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.DeleteLaunchProfileMemberResponse, RemoveNSLaunchProfileMemberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.DeleteLaunchProfileMemberRequest();
        ...
        private Amazon.NimbleStudio.Model.DeleteLaunchProfileMemberResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.DeleteLaunchProfileMemberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "DeleteLaunchProfileMember");
            try
            {
                #if DESKTOP
                return client.DeleteLaunchProfileMember(request);
                #elif CORECLR
                return client.DeleteLaunchProfileMemberAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.DeleteLaunchProfileMemberResponse, RemoveNSLaunchProfileMemberCmdlet, object> Select { get; set; } =
