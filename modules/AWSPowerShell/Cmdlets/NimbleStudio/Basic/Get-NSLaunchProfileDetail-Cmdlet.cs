...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Get", "NSLaunchProfileDetail")]
    ...
    public partial class GetNSLaunchProfileDetailCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.GetLaunchProfileDetailsResponse, GetNSLaunchProfileDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.GetLaunchProfileDetailsRequest();
        ...
        private Amazon.NimbleStudio.Model.GetLaunchProfileDetailsResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.GetLaunchProfileDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "GetLaunchProfileDetails");
            try
            {
                #if DESKTOP
                return client.GetLaunchProfileDetails(request);
                #elif CORECLR
                return client.GetLaunchProfileDetailsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String LaunchProfileId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.GetLaunchProfileDetailsResponse, GetNSLaunchProfileDetailCmdlet, object> Select { get; set; } =
