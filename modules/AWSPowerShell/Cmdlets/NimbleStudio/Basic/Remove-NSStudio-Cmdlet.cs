...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NSStudio", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.NimbleStudio.Model.Studio")]
    [AWSCmdlet("Calls the Amazon Nimble Studio DeleteStudio API operation.", Operation = new[] {"DeleteStudio"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.DeleteStudioResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.Studio or Amazon.NimbleStudio.Model.DeleteStudioResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.Studio object.",
        "The service call response (type Amazon.NimbleStudio.Model.DeleteStudioResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveNSStudioCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NSStudio (DeleteStudio)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.DeleteStudioResponse, RemoveNSStudioCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.DeleteStudioRequest();
        ...
        private Amazon.NimbleStudio.Model.DeleteStudioResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.DeleteStudioRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "DeleteStudio");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.DeleteStudioResponse, RemoveNSStudioCmdlet, object> Select { get; set; } =
