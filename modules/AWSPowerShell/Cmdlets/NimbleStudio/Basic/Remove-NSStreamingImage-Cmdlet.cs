...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NSStreamingImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.NimbleStudio.Model.StreamingImage")]
    [AWSCmdlet("Calls the Amazon Nimble Studio DeleteStreamingImage API operation.", Operation = new[] {"DeleteStreamingImage"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.DeleteStreamingImageResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingImage or Amazon.NimbleStudio.Model.DeleteStreamingImageResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingImage object.",
        "The service call response (type Amazon.NimbleStudio.Model.DeleteStreamingImageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveNSStreamingImageCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NSStreamingImage (DeleteStreamingImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.DeleteStreamingImageResponse, RemoveNSStreamingImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.DeleteStreamingImageRequest();
        ...
        private Amazon.NimbleStudio.Model.DeleteStreamingImageResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.DeleteStreamingImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "DeleteStreamingImage");
            try
            {
                #if DESKTOP
                return client.DeleteStreamingImage(request);
                #elif CORECLR
                return client.DeleteStreamingImageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StreamingImageId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.DeleteStreamingImageResponse, RemoveNSStreamingImageCmdlet, object> Select { get; set; } =
