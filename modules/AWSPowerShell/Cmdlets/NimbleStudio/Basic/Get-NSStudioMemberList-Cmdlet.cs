...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    [AWSCmdlet("Calls the Amazon Nimble Studio ListStudioMembers API operation.", Operation = new[] {"ListStudioMembers"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.ListStudioMembersResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StudioMembership or Amazon.NimbleStudio.Model.ListStudioMembersResponse",
        "This cmdlet returns a collection of Amazon.NimbleStudio.Model.StudioMembership objects.",
        "The service call response (type Amazon.NimbleStudio.Model.ListStudioMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNSStudioMemberListCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.ListStudioMembersResponse, GetNSStudioMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.ListStudioMembersRequest();
        ...
        private Amazon.NimbleStudio.Model.ListStudioMembersResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.ListStudioMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "ListStudioMembers");
            try
            {
                #if DESKTOP
                return client.ListStudioMembers(request);
                #elif CORECLR
                return client.ListStudioMembersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.ListStudioMembersResponse, GetNSStudioMemberListCmdlet, object> Select { get; set; } =
