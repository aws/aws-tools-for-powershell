...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "NSStreamingSessionStream")]
    [OutputType("Amazon.NimbleStudio.Model.StreamingSessionStream")]
    [AWSCmdlet("Calls the Amazon Nimble Studio GetStreamingSessionStream API operation.", Operation = new[] {"GetStreamingSessionStream"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingSessionStream or Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingSessionStream object.",
        "The service call response (type Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNSStreamingSessionStreamCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse, GetNSStreamingSessionStreamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.GetStreamingSessionStreamRequest();
        ...
        private Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.GetStreamingSessionStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "GetStreamingSessionStream");
            try
            {
                #if DESKTOP
                return client.GetStreamingSessionStream(request);
                #elif CORECLR
                return client.GetStreamingSessionStreamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StreamId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.GetStreamingSessionStreamResponse, GetNSStreamingSessionStreamCmdlet, object> Select { get; set; } =
