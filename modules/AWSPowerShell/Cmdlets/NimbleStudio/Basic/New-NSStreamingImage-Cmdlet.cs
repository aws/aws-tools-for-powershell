...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("New", "NSStreamingImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NimbleStudio.Model.StreamingImage")]
    [AWSCmdlet("Calls the Amazon Nimble Studio CreateStreamingImage API operation.", Operation = new[] {"CreateStreamingImage"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.CreateStreamingImageResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingImage or Amazon.NimbleStudio.Model.CreateStreamingImageResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingImage object.",
        "The service call response (type Amazon.NimbleStudio.Model.CreateStreamingImageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewNSStreamingImageCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-NSStreamingImage (CreateStreamingImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.CreateStreamingImageResponse, NewNSStreamingImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.CreateStreamingImageRequest();
        ...
        private Amazon.NimbleStudio.Model.CreateStreamingImageResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.CreateStreamingImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "CreateStreamingImage");
            try
            {
                #if DESKTOP
                return client.CreateStreamingImage(request);
                #elif CORECLR
                return client.CreateStreamingImageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.NimbleStudio.Model.CreateStreamingImageResponse, NewNSStreamingImageCmdlet, object> Select { get; set; } =
