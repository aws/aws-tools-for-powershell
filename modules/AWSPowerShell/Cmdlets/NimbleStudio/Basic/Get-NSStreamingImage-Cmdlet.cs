...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// Get streaming image.
    /// </summary>
    [Cmdlet("Get", "NSStreamingImage")]
    [OutputType("Amazon.NimbleStudio.Model.StreamingImage")]
    [AWSCmdlet("Calls the Amazon Nimble Studio GetStreamingImage API operation.", Operation = new[] {"GetStreamingImage"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.GetStreamingImageResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingImage or Amazon.NimbleStudio.Model.GetStreamingImageResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingImage object.",
        "The service call response (type Amazon.NimbleStudio.Model.GetStreamingImageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNSStreamingImageCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.GetStreamingImageResponse, GetNSStreamingImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.GetStreamingImageRequest();
        ...
        private Amazon.NimbleStudio.Model.GetStreamingImageResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.GetStreamingImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "GetStreamingImage");
            try
            {
                #if DESKTOP
                return client.GetStreamingImage(request);
                #elif CORECLR
                return client.GetStreamingImageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String StreamingImageId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.GetStreamingImageResponse, GetNSStreamingImageCmdlet, object> Select { get; set; } =
