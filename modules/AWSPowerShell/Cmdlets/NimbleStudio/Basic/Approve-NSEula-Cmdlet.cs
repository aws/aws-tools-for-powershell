...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// Accept EULAs.
    /// </summary>
    [Cmdlet("Approve", "NSEula", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NimbleStudio.Model.EulaAcceptance")]
    [AWSCmdlet("Calls the Amazon Nimble Studio AcceptEulas API operation.", Operation = new[] {"AcceptEulas"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.AcceptEulasResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.EulaAcceptance or Amazon.NimbleStudio.Model.AcceptEulasResponse",
        "This cmdlet returns a collection of Amazon.NimbleStudio.Model.EulaAcceptance objects.",
        "The service call response (type Amazon.NimbleStudio.Model.AcceptEulasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ApproveNSEulaCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-NSEula (AcceptEulas)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.AcceptEulasResponse, ApproveNSEulaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.AcceptEulasRequest();
        ...
        private Amazon.NimbleStudio.Model.AcceptEulasResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.AcceptEulasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "AcceptEulas");
            try
            {
                #if DESKTOP
                return client.AcceptEulas(request);
                #elif CORECLR
                return client.AcceptEulasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.AcceptEulasResponse, ApproveNSEulaCmdlet, object> Select { get; set; } =
