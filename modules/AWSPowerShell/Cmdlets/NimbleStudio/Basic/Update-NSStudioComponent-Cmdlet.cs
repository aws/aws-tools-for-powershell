...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Update", "NSStudioComponent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NimbleStudio.Model.StudioComponent")]
    [AWSCmdlet("Calls the Amazon Nimble Studio UpdateStudioComponent API operation.", Operation = new[] {"UpdateStudioComponent"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.UpdateStudioComponentResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StudioComponent or Amazon.NimbleStudio.Model.UpdateStudioComponentResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StudioComponent object.",
        "The service call response (type Amazon.NimbleStudio.Model.UpdateStudioComponentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateNSStudioComponentCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-NSStudioComponent (UpdateStudioComponent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.UpdateStudioComponentResponse, UpdateNSStudioComponentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.UpdateStudioComponentRequest();
        ...
        private Amazon.NimbleStudio.Model.UpdateStudioComponentResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.UpdateStudioComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "UpdateStudioComponent");
            try
            {
                #if DESKTOP
                return client.UpdateStudioComponent(request);
                #elif CORECLR
                return client.UpdateStudioComponentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.NimbleStudio.StudioComponentSubtype Subtype { get; set; }
            public Amazon.NimbleStudio.StudioComponentType Type { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.UpdateStudioComponentResponse, UpdateNSStudioComponentCmdlet, object> Select { get; set; } =
