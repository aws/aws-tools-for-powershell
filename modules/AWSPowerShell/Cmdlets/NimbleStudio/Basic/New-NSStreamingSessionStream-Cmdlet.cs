...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "NSStreamingSessionStream", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NimbleStudio.Model.StreamingSessionStream")]
    [AWSCmdlet("Calls the Amazon Nimble Studio CreateStreamingSessionStream API operation.", Operation = new[] {"CreateStreamingSessionStream"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingSessionStream or Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingSessionStream object.",
        "The service call response (type Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewNSStreamingSessionStreamCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        [Alias("ExpirationInSeconds")]
        public System.Int32? ExpirationInSecond { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-NSStreamingSessionStream (CreateStreamingSessionStream)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse, NewNSStreamingSessionStreamCmdlet>(Select) ??
            ...
            context.ExpirationInSecond = this.ExpirationInSecond;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.CreateStreamingSessionStreamRequest();
            
            if (cmdletContext.ClientToken != null)
            {
                request.ClientToken = cmdletContext.ClientToken;
            }
            if (cmdletContext.ExpirationInSecond != null)
            {
                request.ExpirationInSeconds = cmdletContext.ExpirationInSecond.Value;
            }
        ...
        private Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.CreateStreamingSessionStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "CreateStreamingSessionStream");
            try
            {
                #if DESKTOP
                return client.CreateStreamingSessionStream(request);
                #elif CORECLR
                return client.CreateStreamingSessionStreamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SessionId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.CreateStreamingSessionStreamResponse, NewNSStreamingSessionStreamCmdlet, object> Select { get; set; } =
