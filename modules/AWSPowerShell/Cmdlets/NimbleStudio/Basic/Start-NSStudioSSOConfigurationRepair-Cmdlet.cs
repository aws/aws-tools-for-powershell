...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Start", "NSStudioSSOConfigurationRepair", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartNSStudioSSOConfigurationRepairCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-NSStudioSSOConfigurationRepair (StartStudioSSOConfigurationRepair)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.StartStudioSSOConfigurationRepairResponse, StartNSStudioSSOConfigurationRepairCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.StartStudioSSOConfigurationRepairRequest();
        ...
        private Amazon.NimbleStudio.Model.StartStudioSSOConfigurationRepairResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.StartStudioSSOConfigurationRepairRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "StartStudioSSOConfigurationRepair");
            try
            {
                #if DESKTOP
                return client.StartStudioSSOConfigurationRepair(request);
                #elif CORECLR
                return client.StartStudioSSOConfigurationRepairAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.StartStudioSSOConfigurationRepairResponse, StartNSStudioSSOConfigurationRepairCmdlet, object> Select { get; set; } =
