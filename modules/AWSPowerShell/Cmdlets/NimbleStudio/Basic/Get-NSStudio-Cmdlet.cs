...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    [AWSCmdlet("Calls the Amazon Nimble Studio GetStudio API operation.", Operation = new[] {"GetStudio"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.GetStudioResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.Studio or Amazon.NimbleStudio.Model.GetStudioResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.Studio object.",
        "The service call response (type Amazon.NimbleStudio.Model.GetStudioResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNSStudioCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.GetStudioResponse, GetNSStudioCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.GetStudioRequest();
        ...
        private Amazon.NimbleStudio.Model.GetStudioResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.GetStudioRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "GetStudio");
            try
            {
                #if DESKTOP
                return client.GetStudio(request);
                #elif CORECLR
                return client.GetStudioAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.GetStudioResponse, GetNSStudioCmdlet, object> Select { get; set; } =
