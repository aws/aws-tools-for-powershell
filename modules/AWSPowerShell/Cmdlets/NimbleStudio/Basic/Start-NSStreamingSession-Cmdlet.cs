...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    [AWSCmdlet("Calls the Amazon Nimble Studio StartStreamingSession API operation.", Operation = new[] {"StartStreamingSession"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.StartStreamingSessionResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StreamingSession or Amazon.NimbleStudio.Model.StartStreamingSessionResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StreamingSession object.",
        "The service call response (type Amazon.NimbleStudio.Model.StartStreamingSessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartNSStreamingSessionCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-NSStreamingSession (StartStreamingSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.StartStreamingSessionResponse, StartNSStreamingSessionCmdlet>(Select) ??
        ...
        private Amazon.NimbleStudio.Model.StartStreamingSessionResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.StartStreamingSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "StartStreamingSession");
            try
            {
                #if DESKTOP
                return client.StartStreamingSession(request);
                #elif CORECLR
                return client.StartStreamingSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SessionId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.StartStreamingSessionResponse, StartNSStreamingSessionCmdlet, object> Select { get; set; } =
