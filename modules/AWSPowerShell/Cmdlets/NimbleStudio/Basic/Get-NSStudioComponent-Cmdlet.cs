...
namespace Amazon.PowerShell.Cmdlets.NS
{
    ...
    /// </summary>
    [Cmdlet("Get", "NSStudioComponent")]
    [OutputType("Amazon.NimbleStudio.Model.StudioComponent")]
    [AWSCmdlet("Calls the Amazon Nimble Studio GetStudioComponent API operation.", Operation = new[] {"GetStudioComponent"}, SelectReturnType = typeof(Amazon.NimbleStudio.Model.GetStudioComponentResponse))]
    [AWSCmdletOutput("Amazon.NimbleStudio.Model.StudioComponent or Amazon.NimbleStudio.Model.GetStudioComponentResponse",
        "This cmdlet returns an Amazon.NimbleStudio.Model.StudioComponent object.",
        "The service call response (type Amazon.NimbleStudio.Model.GetStudioComponentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNSStudioComponentCmdlet : AmazonNimbleStudioClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StudioComponentId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NimbleStudio.Model.GetStudioComponentResponse, GetNSStudioComponentCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.StudioComponentId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NimbleStudio.Model.GetStudioComponentRequest();
            
            if (cmdletContext.StudioComponentId != null)
            {
                request.StudioComponentId = cmdletContext.StudioComponentId;
            }
        ...
        private Amazon.NimbleStudio.Model.GetStudioComponentResponse CallAWSServiceOperation(IAmazonNimbleStudio client, Amazon.NimbleStudio.Model.GetStudioComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Nimble Studio", "GetStudioComponent");
            try
            {
                #if DESKTOP
                return client.GetStudioComponent(request);
                #elif CORECLR
                return client.GetStudioComponentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String StudioComponentId { get; set; }
            public System.String StudioId { get; set; }
            public System.Func<Amazon.NimbleStudio.Model.GetStudioComponentResponse, GetNSStudioComponentCmdlet, object> Select { get; set; } =
