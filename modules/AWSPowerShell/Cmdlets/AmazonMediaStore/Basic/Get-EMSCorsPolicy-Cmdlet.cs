...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaStore GetCorsPolicy API operation.", Operation = new[] {"GetCorsPolicy"})]
    [AWSCmdletOutput("Amazon.MediaStore.Model.CorsRule",
        "This cmdlet returns a collection of CorsRule objects.",
    ...
    public partial class GetEMSCorsPolicyCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.CorsPolicy;
