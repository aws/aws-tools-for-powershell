...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaStore PutContainerPolicy API operation.", Operation = new[] {"PutContainerPolicy"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.MediaStore.Model.PutContainerPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteEMSContainerPolicyCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-EMSContainerPolicy (PutContainerPolicy)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaStore.Model.PutContainerPolicyRequest();
        ...
        private Amazon.MediaStore.Model.PutContainerPolicyResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.PutContainerPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaStore", "PutContainerPolicy");
            try
            {
                #if DESKTOP
                return client.PutContainerPolicy(request);
                #elif CORECLR
                return client.PutContainerPolicyAsync(request).GetAwaiter().GetResult();
                #else
