...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaStore ListContainers API operation.", Operation = new[] {"ListContainers"})]
    [AWSCmdletOutput("Amazon.MediaStore.Model.Container",
        "This cmdlet returns a collection of Container objects.",
    ...
    public partial class GetEMSContainerListCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Containers;
        ...
        private Amazon.MediaStore.Model.ListContainersResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.ListContainersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListContainersAsync(request);
                return task.Result;
                #else
