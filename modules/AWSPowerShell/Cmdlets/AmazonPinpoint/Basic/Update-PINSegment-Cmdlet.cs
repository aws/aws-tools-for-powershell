...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    /// </summary>
    [Cmdlet("Update", "PINSegment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Pinpoint.Model.SegmentResponse")]
    [AWSCmdlet("Invokes the UpdateSegment operation against Amazon Pinpoint.", Operation = new[] {"UpdateSegment"})]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.SegmentResponse",
        "This cmdlet returns a SegmentResponse object.",
        "The service call response (type Amazon.Pinpoint.Model.UpdateSegmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdatePINSegmentCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-PINSegment (UpdateSegment)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.UpdateSegmentRequest();
        ...
        private Amazon.Pinpoint.Model.UpdateSegmentResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.UpdateSegmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "UpdateSegment");
            #if DESKTOP
