...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint TagResource API operation.", Operation = new[] {"TagResource"})]
    ...
    public partial class AddPINResourceTagCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.TagsModel_Tags = new Dictionary<System.String, System.String>(StringComparer.Ordinal);
                foreach (var hashKey in this.TagsModel_Tag.Keys)
                {
                    context.TagsModel_Tags.Add((String)hashKey, (String)(this.TagsModel_Tag[hashKey]));
                }
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ResourceArn != null)
            {
             ...
             // populate TagsModel
            bool requestTagsModelIsNull = true;
            ...
            if (cmdletContext.TagsModel_Tags != null)
            {
                requestTagsModel_tagsModel_Tag = cmdletContext.TagsModel_Tags;
            }
        ...
        {
            public System.String ResourceArn { get; set; }
            public Dictionary<System.String, System.String> TagsModel_Tags { get; set; }
        }
