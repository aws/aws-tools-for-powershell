...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Invokes the GetImportJobs operation against Amazon Pinpoint.", Operation = new[] {"GetImportJobs"})]
    ...
    public partial class GetPINImportJobListCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Pinpoint.Model.GetImportJobsResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.GetImportJobsRequest request)
        {
            #if DESKTOP
