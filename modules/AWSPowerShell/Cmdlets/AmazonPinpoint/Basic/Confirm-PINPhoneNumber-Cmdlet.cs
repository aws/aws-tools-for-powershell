...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Calls the Amazon Pinpoint PhoneNumberValidate API operation.", Operation = new[] {"PhoneNumberValidate"})]
    [AWSCmdletOutput("Amazon.Pinpoint.Model.NumberValidateResponse",
        "This cmdlet returns a NumberValidateResponse object.",
    ...
    public partial class ConfirmPINPhoneNumberCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.NumberValidateResponse;
        ...
        private Amazon.Pinpoint.Model.PhoneNumberValidateResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.PhoneNumberValidateRequest request)
        {
            ...
            try
            {
                ...
                var task = client.PhoneNumberValidateAsync(request);
                return task.Result;
                #else
