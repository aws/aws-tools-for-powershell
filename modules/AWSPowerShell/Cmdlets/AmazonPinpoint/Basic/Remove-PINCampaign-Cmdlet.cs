...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Invokes the DeleteCampaign operation against Amazon Pinpoint.", Operation = new[] {"DeleteCampaign"})]
    ...
    public partial class RemovePINCampaignCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Pinpoint.Model.DeleteCampaignResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteCampaignRequest request)
        {
            #if DESKTOP
