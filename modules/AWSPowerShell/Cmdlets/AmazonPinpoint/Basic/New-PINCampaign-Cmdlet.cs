...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Invokes the CreateCampaign operation against Amazon Pinpoint.", Operation = new[] {"CreateCampaign"})]
    ...
    public partial class NewPINCampaignCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Pinpoint.Model.CreateCampaignResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.CreateCampaignRequest request)
        {
            #if DESKTOP
            return client.CreateCampaign(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.CreateCampaignAsync(request);
            return task.Result;
            #else
