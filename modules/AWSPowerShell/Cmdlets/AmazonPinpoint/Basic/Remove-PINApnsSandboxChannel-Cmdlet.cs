...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    public partial class RemovePINApnsSandboxChannelCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINApnsSandboxChannel (DeleteApnsSandboxChannel)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Pinpoint.Model.DeleteApnsSandboxChannelRequest();
        ...
        private Amazon.Pinpoint.Model.DeleteApnsSandboxChannelResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.DeleteApnsSandboxChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint", "DeleteApnsSandboxChannel");
            try
            {
                #if DESKTOP
