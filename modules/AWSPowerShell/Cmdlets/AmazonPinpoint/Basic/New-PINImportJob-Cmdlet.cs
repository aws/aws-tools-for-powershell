...
namespace Amazon.PowerShell.Cmdlets.PIN
{
    ...
    [AWSCmdlet("Invokes the CreateImportJob operation against Amazon Pinpoint.", Operation = new[] {"CreateImportJob"})]
    ...
    public partial class NewPINImportJobCmdlet : AmazonPinpointClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Pinpoint.Model.CreateImportJobResponse CallAWSServiceOperation(IAmazonPinpoint client, Amazon.Pinpoint.Model.CreateImportJobRequest request)
        {
            #if DESKTOP
