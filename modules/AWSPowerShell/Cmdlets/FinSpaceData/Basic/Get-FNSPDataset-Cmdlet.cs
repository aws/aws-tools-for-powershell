...
namespace Amazon.PowerShell.Cmdlets.FNSP
{
    ...
    [AWSCmdlet("Calls the FinSpace Public API GetDataset API operation.", Operation = new[] {"GetDataset"}, SelectReturnType = typeof(Amazon.FinSpaceData.Model.GetDatasetResponse))]
    [AWSCmdletOutput("Amazon.FinSpaceData.Model.GetDatasetResponse",
        "This cmdlet returns an Amazon.FinSpaceData.Model.GetDatasetResponse object containing multiple properties."
    )]
    ...
    public partial class GetFNSPDatasetCmdlet : AmazonFinSpaceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FinSpaceData.Model.GetDatasetResponse, GetFNSPDatasetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FinSpaceData.Model.GetDatasetRequest();
        ...
        private Amazon.FinSpaceData.Model.GetDatasetResponse CallAWSServiceOperation(IAmazonFinSpaceData client, Amazon.FinSpaceData.Model.GetDatasetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace Public API", "GetDataset");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DatasetId { get; set; }
            public System.Func<Amazon.FinSpaceData.Model.GetDatasetResponse, GetFNSPDatasetCmdlet, object> Select { get; set; } =
