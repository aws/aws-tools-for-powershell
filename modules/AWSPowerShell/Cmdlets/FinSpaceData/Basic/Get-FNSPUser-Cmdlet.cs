...
namespace Amazon.PowerShell.Cmdlets.FNSP
{
    ...
    public partial class GetFNSPUserCmdlet : AmazonFinSpaceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FinSpaceData.Model.GetUserResponse, GetFNSPUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FinSpaceData.Model.GetUserRequest();
        ...
        private Amazon.FinSpaceData.Model.GetUserResponse CallAWSServiceOperation(IAmazonFinSpaceData client, Amazon.FinSpaceData.Model.GetUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace Public API", "GetUser");
            try
            {
                return client.GetUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String UserId { get; set; }
            public System.Func<Amazon.FinSpaceData.Model.GetUserResponse, GetFNSPUserCmdlet, object> Select { get; set; } =
