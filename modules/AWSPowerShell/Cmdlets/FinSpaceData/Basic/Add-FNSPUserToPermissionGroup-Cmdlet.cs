...
namespace Amazon.PowerShell.Cmdlets.FNSP
{
    ...
    public partial class AddFNSPUserToPermissionGroupCmdlet : AmazonFinSpaceDataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-FNSPUserToPermissionGroup (AssociateUserToPermissionGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FinSpaceData.Model.AssociateUserToPermissionGroupResponse, AddFNSPUserToPermissionGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FinSpaceData.Model.AssociateUserToPermissionGroupRequest();
        ...
        private Amazon.FinSpaceData.Model.AssociateUserToPermissionGroupResponse CallAWSServiceOperation(IAmazonFinSpaceData client, Amazon.FinSpaceData.Model.AssociateUserToPermissionGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "FinSpace Public API", "AssociateUserToPermissionGroup");
            try
            {
                #if DESKTOP
                return client.AssociateUserToPermissionGroup(request);
                #elif CORECLR
                return client.AssociateUserToPermissionGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PermissionGroupId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.FinSpaceData.Model.AssociateUserToPermissionGroupResponse, AddFNSPUserToPermissionGroupCmdlet, object> Select { get; set; } =
