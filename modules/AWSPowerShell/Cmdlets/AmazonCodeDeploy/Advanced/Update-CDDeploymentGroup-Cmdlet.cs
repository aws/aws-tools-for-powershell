...
{
    public partial class UpdateCDDeploymentGroupCmdlet
    {
        ...
        #region Parameter OnPremisesTagGroup
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter]
        public Amazon.CodeDeploy.Model.TagFilter[][] OnPremisesTagGroup { get; set; }
        #endregion
        ...
        protected override void PostExecutionContextLoad(ExecutorContext context)
        {
            ...
            if (this.OnPremisesTagGroup != null)
            {
                cmdletContext.OnPremisesTagSetList = new List<List<Amazon.CodeDeploy.Model.TagFilter>>();
                foreach (var innerList in this.OnPremisesTagGroup)
                {
                    cmdletContext.OnPremisesTagSetList.Add(new List<TagFilter>(innerList));
                }
            }
        }
