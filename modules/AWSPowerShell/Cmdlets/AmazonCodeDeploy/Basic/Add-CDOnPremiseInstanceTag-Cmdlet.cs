...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Invokes the AddTagsToOnPremisesInstances operation against Amazon CodeDeploy.", Operation = new[] {"AddTagsToOnPremisesInstances"})]
    ...
    public class AddCDOnPremiseInstanceTagCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.AddTagsToOnPremisesInstances(request);
