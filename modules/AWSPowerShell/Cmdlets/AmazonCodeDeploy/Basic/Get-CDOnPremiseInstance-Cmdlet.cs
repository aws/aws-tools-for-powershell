...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Invokes the GetOnPremisesInstance operation against Amazon CodeDeploy.", Operation = new[] {"GetOnPremisesInstance"})]
    ...
    public class GetCDOnPremiseInstanceCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.GetOnPremisesInstance(request);
