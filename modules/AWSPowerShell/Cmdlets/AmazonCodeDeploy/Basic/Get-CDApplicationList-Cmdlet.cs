...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Invokes the ListApplications operation against AWS CodeDeploy.", Operation = new[] {"ListApplications"})]
    ...
    public partial class GetCDApplicationListCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeDeploy.Model.ListApplicationsRequest();
        ...
        private Amazon.CodeDeploy.Model.ListApplicationsResponse CallAWSServiceOperation(IAmazonCodeDeploy client, Amazon.CodeDeploy.Model.ListApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeDeploy", "ListApplications");
            #if DESKTOP
