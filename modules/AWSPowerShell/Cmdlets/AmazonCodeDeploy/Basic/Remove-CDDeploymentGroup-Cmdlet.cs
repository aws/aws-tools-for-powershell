...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Invokes the DeleteDeploymentGroup operation against Amazon CodeDeploy.", Operation = new[] {"DeleteDeploymentGroup"})]
    ...
    public class RemoveCDDeploymentGroupCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteDeploymentGroup(request);
