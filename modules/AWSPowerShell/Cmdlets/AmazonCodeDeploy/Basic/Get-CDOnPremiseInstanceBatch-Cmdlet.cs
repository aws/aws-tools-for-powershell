...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Invokes the BatchGetOnPremisesInstances operation against Amazon CodeDeploy.", Operation = new[] {"BatchGetOnPremisesInstances"})]
    ...
    public class GetCDOnPremiseInstanceBatchCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.BatchGetOnPremisesInstances(request);
                Dictionary<string, object> notes = null;
                object pipelineOutput = response.InstanceInfos;
