...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Calls the AWS CodeDeploy GetDeployment API operation.", Operation = new[] {"GetDeployment"})]
    ...
    public partial class GetCDDeploymentCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The unique ID of a deployment associated with the applicable IAM user or AWS account.
        /// </para>
        /// </para>
        /// </summary>
