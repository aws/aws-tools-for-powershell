...
namespace Amazon.PowerShell.Cmdlets.CD
{
    ...
    [AWSCmdlet("Invokes the DeleteDeploymentConfig operation against Amazon CodeDeploy.", Operation = new[] {"DeleteDeploymentConfig"})]
    ...
    public class RemoveCDDeploymentConfigCmdlet : AmazonCodeDeployClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteDeploymentConfig(request);
