...
namespace Amazon.PowerShell.Cmdlets.IOTMI
{
    ...
    public partial class NewIOTMIAccountAssociationCmdlet : AmazonIoTManagedIntegrationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A set of key/value pairs that are used to manage the account association.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ConnectorDestinationId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ConnectorDestinationId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ConnectorDestinationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ConnectorDestinationId;
            }
        ...
        private Amazon.IoTManagedIntegrations.Model.CreateAccountAssociationResponse CallAWSServiceOperation(IAmazonIoTManagedIntegrations client, Amazon.IoTManagedIntegrations.Model.CreateAccountAssociationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateAccountAssociation(request);
                #elif CORECLR
                return client.CreateAccountAssociationAsync(request).GetAwaiter().GetResult();
                #else
