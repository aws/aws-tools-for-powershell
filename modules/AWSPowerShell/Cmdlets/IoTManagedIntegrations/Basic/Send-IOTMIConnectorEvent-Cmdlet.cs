...
namespace Amazon.PowerShell.Cmdlets.IOTMI
{
    ...
    public partial class SendIOTMIConnectorEventCmdlet : AmazonIoTManagedIntegrationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of Matter clusters for a managed thing.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The list of devices.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The trace request identifier. This is generated by IoT managed integrations and can
        /// be used to trace this command and its related operations in CloudWatch.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.IoTManagedIntegrations.Model.SendConnectorEventResponse CallAWSServiceOperation(IAmazonIoTManagedIntegrations client, Amazon.IoTManagedIntegrations.Model.SendConnectorEventRequest request)
        {
            ...
            try
            {
                return client.SendConnectorEventAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
