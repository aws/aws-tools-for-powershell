...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    [AWSCmdletOutput("Amazon.DataExchange.Model.AssetEntry or Amazon.DataExchange.Model.ListRevisionAssetsResponse",
        ...
        "The service call response (type Amazon.DataExchange.Model.ListRevisionAssetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
