...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// state.
    /// </summary>
    [Cmdlet("Stop", "DTEXJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopDTEXJobCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-DTEXJob (CancelJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.CancelJobResponse, StopDTEXJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataExchange.Model.CancelJobRequest();
        ...
        private Amazon.DataExchange.Model.CancelJobResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.CancelJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "CancelJob");
            try
            {
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.DataExchange.Model.CancelJobResponse, StopDTEXJobCmdlet, object> Select { get; set; } =
