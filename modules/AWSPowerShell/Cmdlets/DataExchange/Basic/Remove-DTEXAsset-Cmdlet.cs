...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DTEXAsset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDTEXAssetCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DTEXAsset (DeleteAsset)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.DeleteAssetResponse, RemoveDTEXAssetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataExchange.Model.DeleteAssetRequest();
        ...
        private Amazon.DataExchange.Model.DeleteAssetResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.DeleteAssetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "DeleteAsset");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DataSetId { get; set; }
            public System.String RevisionId { get; set; }
            public System.Func<Amazon.DataExchange.Model.DeleteAssetResponse, RemoveDTEXAssetCmdlet, object> Select { get; set; } =
