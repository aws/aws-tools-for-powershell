...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// </summary>
    [Cmdlet("Get", "DTEXDataSetRevisionList")]
    [OutputType("Amazon.DataExchange.Model.RevisionEntry")]
    [AWSCmdlet("Calls the AWS Data Exchange ListDataSetRevisions API operation.", Operation = new[] {"ListDataSetRevisions"}, SelectReturnType = typeof(Amazon.DataExchange.Model.ListDataSetRevisionsResponse))]
    [AWSCmdletOutput("Amazon.DataExchange.Model.RevisionEntry or Amazon.DataExchange.Model.ListDataSetRevisionsResponse",
        "This cmdlet returns a collection of Amazon.DataExchange.Model.RevisionEntry objects.",
        "The service call response (type Amazon.DataExchange.Model.ListDataSetRevisionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDTEXDataSetRevisionListCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.ListDataSetRevisionsResponse, GetDTEXDataSetRevisionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataExchange.Model.ListDataSetRevisionsRequest();
        ...
        private Amazon.DataExchange.Model.ListDataSetRevisionsResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.ListDataSetRevisionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "ListDataSetRevisions");
            try
            {
                #if DESKTOP
                return client.ListDataSetRevisions(request);
                #elif CORECLR
                return client.ListDataSetRevisionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DataExchange.Model.ListDataSetRevisionsResponse, GetDTEXDataSetRevisionListCmdlet, object> Select { get; set; } =
