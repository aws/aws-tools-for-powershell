...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// </summary>
    [Cmdlet("Update", "DTEXDataSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataExchange.Model.UpdateDataSetResponse")]
    [AWSCmdlet("Calls the AWS Data Exchange UpdateDataSet API operation.", Operation = new[] {"UpdateDataSet"}, SelectReturnType = typeof(Amazon.DataExchange.Model.UpdateDataSetResponse))]
    [AWSCmdletOutput("Amazon.DataExchange.Model.UpdateDataSetResponse",
        "This cmdlet returns an Amazon.DataExchange.Model.UpdateDataSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateDTEXDataSetCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-DTEXDataSet (UpdateDataSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.UpdateDataSetResponse, UpdateDTEXDataSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataExchange.Model.UpdateDataSetRequest();
        ...
        private Amazon.DataExchange.Model.UpdateDataSetResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.UpdateDataSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "UpdateDataSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.DataExchange.Model.UpdateDataSetResponse, UpdateDTEXDataSetCmdlet, object> Select { get; set; } =
