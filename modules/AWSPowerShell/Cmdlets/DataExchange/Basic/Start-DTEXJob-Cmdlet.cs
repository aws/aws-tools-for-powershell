...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// </summary>
    [Cmdlet("Start", "DTEXJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StartDTEXJobCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-DTEXJob (StartJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.StartJobResponse, StartDTEXJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataExchange.Model.StartJobRequest();
        ...
        private Amazon.DataExchange.Model.StartJobResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.StartJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "StartJob");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.DataExchange.Model.StartJobResponse, StartDTEXJobCmdlet, object> Select { get; set; } =
