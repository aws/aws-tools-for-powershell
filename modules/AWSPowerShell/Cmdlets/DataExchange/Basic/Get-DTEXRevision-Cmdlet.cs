...
namespace Amazon.PowerShell.Cmdlets.DTEX
{
    ...
    /// </summary>
    [Cmdlet("Get", "DTEXRevision")]
    [OutputType("Amazon.DataExchange.Model.GetRevisionResponse")]
    [AWSCmdlet("Calls the AWS Data Exchange GetRevision API operation.", Operation = new[] {"GetRevision"}, SelectReturnType = typeof(Amazon.DataExchange.Model.GetRevisionResponse))]
    [AWSCmdletOutput("Amazon.DataExchange.Model.GetRevisionResponse",
        "This cmdlet returns an Amazon.DataExchange.Model.GetRevisionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDTEXRevisionCmdlet : AmazonDataExchangeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataExchange.Model.GetRevisionResponse, GetDTEXRevisionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataExchange.Model.GetRevisionRequest();
        ...
        private Amazon.DataExchange.Model.GetRevisionResponse CallAWSServiceOperation(IAmazonDataExchange client, Amazon.DataExchange.Model.GetRevisionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Data Exchange", "GetRevision");
            try
            {
                #if DESKTOP
                return client.GetRevision(request);
                #elif CORECLR
                return client.GetRevisionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DataSetId { get; set; }
            public System.String RevisionId { get; set; }
            public System.Func<Amazon.DataExchange.Model.GetRevisionResponse, GetDTEXRevisionCmdlet, object> Select { get; set; } =
