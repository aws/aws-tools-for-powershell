...
namespace Amazon.PowerShell.Cmdlets.POL
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Write", "POLLexicon", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Invokes the PutLexicon operation against Amazon Polly.", Operation = new[] {"PutLexicon"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the Content parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class WritePOLLexiconCmdlet : AmazonPollyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-POLLexicon (PutLexicon)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Polly.Model.PutLexiconRequest();
        ...
        private static Amazon.Polly.Model.PutLexiconResponse CallAWSServiceOperation(IAmazonPolly client, Amazon.Polly.Model.PutLexiconRequest request)
        {
            #if DESKTOP
            return client.PutLexicon(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.PutLexiconAsync(request);
            return task.Result;
            #else
