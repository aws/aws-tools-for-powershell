...
namespace Amazon.PowerShell.Cmdlets.POL
{
    ...
    public partial class RemovePOLLexiconCmdlet : AmazonPollyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-POLLexicon (DeleteLexicon)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Polly.Model.DeleteLexiconRequest();
