...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </summary>
    [Cmdlet("Remove", "S3CBucketLifecycleConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Control DeleteBucketLifecycleConfiguration API operation.", Operation = new[] {"DeleteBucketLifecycleConfiguration"}, SelectReturnType = typeof(Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse))]
    [AWSCmdletOutput("None or Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveS3CBucketLifecycleConfigurationCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket ARN of the bucket.</para><para>For Amazon S3 on Outposts specify the ARN of the bucket accessed in the format <code>arn:aws:s3-outposts:&lt;Region&gt;:&lt;account-id&gt;:outpost/&lt;outpost-id&gt;/bucket/&lt;my-bucket-name&gt;</code>.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CBucketLifecycleConfiguration (DeleteBucketLifecycleConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse, RemoveS3CBucketLifecycleConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationRequest();
        ...
        private Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteBucketLifecycleConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteBucketLifecycleConfiguration(request);
                #elif CORECLR
                return client.DeleteBucketLifecycleConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String Bucket { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteBucketLifecycleConfigurationResponse, RemoveS3CBucketLifecycleConfigurationCmdlet, object> Select { get; set; } =
