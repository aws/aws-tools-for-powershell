...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class RemoveS3CJobTaggingCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CJobTagging (DeleteJobTagging)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteJobTaggingResponse, RemoveS3CJobTaggingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteJobTaggingRequest();
        ...
        private Amazon.S3Control.Model.DeleteJobTaggingResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteJobTaggingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteJobTagging");
            try
            {
                #if DESKTOP
                return client.DeleteJobTagging(request);
                #elif CORECLR
                return client.DeleteJobTaggingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteJobTaggingResponse, RemoveS3CJobTaggingCmdlet, object> Select { get; set; } =
