...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class GetS3CAccessPointCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the access point whose configuration information you want to retrieve.</para><para>For Amazon S3 on Outposts specify the ARN of the access point accessed in the format
