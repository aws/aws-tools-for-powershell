...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class RemoveS3CAccessGrantsInstanceCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CAccessGrantsInstance (DeleteAccessGrantsInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteAccessGrantsInstanceResponse, RemoveS3CAccessGrantsInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteAccessGrantsInstanceRequest();
        ...
        private Amazon.S3Control.Model.DeleteAccessGrantsInstanceResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteAccessGrantsInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteAccessGrantsInstance");
            try
            {
                #if DESKTOP
                return client.DeleteAccessGrantsInstance(request);
                #elif CORECLR
                return client.DeleteAccessGrantsInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteAccessGrantsInstanceResponse, RemoveS3CAccessGrantsInstanceCmdlet, object> Select { get; set; } =
