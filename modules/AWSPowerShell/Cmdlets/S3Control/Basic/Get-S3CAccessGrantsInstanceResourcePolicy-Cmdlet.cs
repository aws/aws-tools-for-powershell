...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3CAccessGrantsInstanceResourcePolicy")]
    ...
    public partial class GetS3CAccessGrantsInstanceResourcePolicyCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.GetAccessGrantsInstanceResourcePolicyResponse, GetS3CAccessGrantsInstanceResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.GetAccessGrantsInstanceResourcePolicyRequest();
        ...
        private Amazon.S3Control.Model.GetAccessGrantsInstanceResourcePolicyResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.GetAccessGrantsInstanceResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "GetAccessGrantsInstanceResourcePolicy");
            try
            {
                #if DESKTOP
                return client.GetAccessGrantsInstanceResourcePolicy(request);
                #elif CORECLR
                return client.GetAccessGrantsInstanceResourcePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.S3Control.Model.GetAccessGrantsInstanceResourcePolicyResponse, GetS3CAccessGrantsInstanceResourcePolicyCmdlet, object> Select { get; set; } =
