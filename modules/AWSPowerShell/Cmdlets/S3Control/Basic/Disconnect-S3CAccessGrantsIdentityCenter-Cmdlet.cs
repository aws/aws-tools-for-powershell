...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Disconnect", "S3CAccessGrantsIdentityCenter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class DisconnectS3CAccessGrantsIdentityCenterCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disconnect-S3CAccessGrantsIdentityCenter (DissociateAccessGrantsIdentityCenter)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DissociateAccessGrantsIdentityCenterResponse, DisconnectS3CAccessGrantsIdentityCenterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DissociateAccessGrantsIdentityCenterRequest();
        ...
        private Amazon.S3Control.Model.DissociateAccessGrantsIdentityCenterResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DissociateAccessGrantsIdentityCenterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DissociateAccessGrantsIdentityCenter");
            try
            {
                #if DESKTOP
                return client.DissociateAccessGrantsIdentityCenter(request);
                #elif CORECLR
                return client.DissociateAccessGrantsIdentityCenterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.S3Control.Model.DissociateAccessGrantsIdentityCenterResponse, DisconnectS3CAccessGrantsIdentityCenterCmdlet, object> Select { get; set; } =
