...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "S3CStorageLensGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Control UpdateStorageLensGroup API operation.", Operation = new[] {"UpdateStorageLensGroup"}, SelectReturnType = typeof(Amazon.S3Control.Model.UpdateStorageLensGroupResponse))]
    [AWSCmdletOutput("None or Amazon.S3Control.Model.UpdateStorageLensGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Control.Model.UpdateStorageLensGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateS3CStorageLensGroupCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Filters objects that match any of the specified prefixes. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para> Filters objects that match any of the specified suffixes. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// 10 object tags are allowed. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// to 10 object tags are allowed. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para> Filters objects that match any of the specified S3 object tags. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-S3CStorageLensGroup (UpdateStorageLensGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.UpdateStorageLensGroupResponse, UpdateS3CStorageLensGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.UpdateStorageLensGroupRequest();
        ...
        private Amazon.S3Control.Model.UpdateStorageLensGroupResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.UpdateStorageLensGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "UpdateStorageLensGroup");
            try
            {
                return client.UpdateStorageLensGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StorageLensGroup_Name { get; set; }
            public System.String StorageLensGroup_StorageLensGroupArn { get; set; }
            public System.Func<Amazon.S3Control.Model.UpdateStorageLensGroupResponse, UpdateS3CStorageLensGroupCmdlet, object> Select { get; set; } =
