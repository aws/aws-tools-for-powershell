...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </para><ul><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetBucketTagging.html">GetBucketTagging</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_PutBucketTagging.html">PutBucketTagging</a></para></li></ul><important><para>
    /// You must URL encode any signed header values that contain spaces. For example, if
    /// your header value is <c>my file.txt</c>, containing two spaces after <c>my</c>, you
    /// must URL encode this value to <c>my%20%20file.txt</c>.
    /// </para></important>
    /// </summary>
    [Cmdlet("Remove", "S3CBucketTagging", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Control DeleteBucketTagging API operation.", Operation = new[] {"DeleteBucketTagging"}, SelectReturnType = typeof(Amazon.S3Control.Model.DeleteBucketTaggingResponse))]
    [AWSCmdletOutput("None or Amazon.S3Control.Model.DeleteBucketTaggingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Control.Model.DeleteBucketTaggingResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveS3CBucketTaggingCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CBucketTagging (DeleteBucketTagging)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteBucketTaggingResponse, RemoveS3CBucketTaggingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteBucketTaggingRequest();
        ...
        private Amazon.S3Control.Model.DeleteBucketTaggingResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteBucketTaggingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteBucketTagging");
            try
            {
                return client.DeleteBucketTaggingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String Bucket { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteBucketTaggingResponse, RemoveS3CBucketTaggingCmdlet, object> Select { get; set; } =
