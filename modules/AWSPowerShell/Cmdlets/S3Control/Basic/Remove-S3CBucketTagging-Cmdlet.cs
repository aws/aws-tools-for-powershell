...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    [AWSCmdletOutput("None or Amazon.S3Control.Model.DeleteBucketTaggingResponse",
        ...
        "The service response (type Amazon.S3Control.Model.DeleteBucketTaggingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveS3CBucketTaggingCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The bucket ARN that has the tag set to be removed.</para><para>For Amazon S3 on Outposts specify the ARN of the bucket accessed in the format <code>arn:aws:s3-outposts:&lt;Region&gt;:&lt;account-id&gt;:outpost/&lt;outpost-id&gt;/bucket/&lt;my-bucket-name&gt;</code>.
        ...
        private Amazon.S3Control.Model.DeleteBucketTaggingResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteBucketTaggingRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteBucketTaggingAsync(request).GetAwaiter().GetResult();
                #else
