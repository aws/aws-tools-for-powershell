...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </summary>
    [Cmdlet("Remove", "S3CMultiRegionAccessPoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveS3CMultiRegionAccessPointCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CMultiRegionAccessPoint (DeleteMultiRegionAccessPoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteMultiRegionAccessPointResponse, RemoveS3CMultiRegionAccessPointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteMultiRegionAccessPointRequest();
            ...
            request.Details = new Amazon.S3Control.Model.DeleteMultiRegionAccessPointInput();
        ...
        private Amazon.S3Control.Model.DeleteMultiRegionAccessPointResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteMultiRegionAccessPointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteMultiRegionAccessPoint");
            try
            {
                #if DESKTOP
                return client.DeleteMultiRegionAccessPoint(request);
                #elif CORECLR
                return client.DeleteMultiRegionAccessPointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientToken { get; set; }
            public System.String Details_Name { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteMultiRegionAccessPointResponse, RemoveS3CMultiRegionAccessPointCmdlet, object> Select { get; set; } =
