...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    [AWSCmdletOutput("System.String or Amazon.S3Control.Model.PutMultiRegionAccessPointPolicyResponse",
        ...
        "The service call response (type Amazon.S3Control.Model.PutMultiRegionAccessPointPolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
