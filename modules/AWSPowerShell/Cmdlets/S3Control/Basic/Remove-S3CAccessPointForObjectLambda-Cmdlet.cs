...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class RemoveS3CAccessPointForObjectLambdaCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3CAccessPointForObjectLambda (DeleteAccessPointForObjectLambda)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.DeleteAccessPointForObjectLambdaResponse, RemoveS3CAccessPointForObjectLambdaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.DeleteAccessPointForObjectLambdaRequest();
        ...
        private Amazon.S3Control.Model.DeleteAccessPointForObjectLambdaResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.DeleteAccessPointForObjectLambdaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "DeleteAccessPointForObjectLambda");
            try
            {
                #if DESKTOP
                return client.DeleteAccessPointForObjectLambda(request);
                #elif CORECLR
                return client.DeleteAccessPointForObjectLambdaAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.S3Control.Model.DeleteAccessPointForObjectLambdaResponse, RemoveS3CAccessPointForObjectLambdaCmdlet, object> Select { get; set; } =
