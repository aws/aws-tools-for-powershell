...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class GetS3CAccessGrantsInstanceForPrefixCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.GetAccessGrantsInstanceForPrefixResponse, GetS3CAccessGrantsInstanceForPrefixCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.GetAccessGrantsInstanceForPrefixRequest();
        ...
        private Amazon.S3Control.Model.GetAccessGrantsInstanceForPrefixResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.GetAccessGrantsInstanceForPrefixRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "GetAccessGrantsInstanceForPrefix");
            try
            {
                #if DESKTOP
                return client.GetAccessGrantsInstanceForPrefix(request);
                #elif CORECLR
                return client.GetAccessGrantsInstanceForPrefixAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String S3Prefix { get; set; }
            public System.Func<Amazon.S3Control.Model.GetAccessGrantsInstanceForPrefixResponse, GetS3CAccessGrantsInstanceForPrefixCmdlet, object> Select { get; set; } =
