...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class GetS3CAccessPointListCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the bucket whose associated access points you want to list.</para><para>For Amazon S3 on Outposts specify the ARN of the bucket accessed in the format <code>arn:aws:s3-outposts:&lt;Region&gt;:&lt;account-id&gt;:outpost/&lt;outpost-id&gt;/bucket/&lt;my-bucket-name&gt;</code>.
