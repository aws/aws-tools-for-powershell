...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    public partial class GetS3CBucketTaggingCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.GetBucketTaggingResponse, GetS3CBucketTaggingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.GetBucketTaggingRequest();
        ...
        private Amazon.S3Control.Model.GetBucketTaggingResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.GetBucketTaggingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "GetBucketTagging");
            try
            {
                return client.GetBucketTaggingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String Bucket { get; set; }
            public System.Func<Amazon.S3Control.Model.GetBucketTaggingResponse, GetS3CBucketTaggingCmdlet, object> Select { get; set; } =
