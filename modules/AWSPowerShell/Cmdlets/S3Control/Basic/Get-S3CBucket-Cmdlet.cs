...
namespace Amazon.PowerShell.Cmdlets.S3C
{
    ...
    /// </para><ul><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html">PutObject</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_CreateBucket.html">CreateBucket</a></para></li><li><para><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_DeleteBucket.html">DeleteBucket</a></para></li></ul>
    /// </summary>
    [Cmdlet("Get", "S3CBucket")]
    ...
    public partial class GetS3CBucketCmdlet : AmazonS3ControlClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Control.Model.GetBucketResponse, GetS3CBucketCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Control.Model.GetBucketRequest();
        ...
        private Amazon.S3Control.Model.GetBucketResponse CallAWSServiceOperation(IAmazonS3Control client, Amazon.S3Control.Model.GetBucketRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Control", "GetBucket");
            try
            {
                #if DESKTOP
                return client.GetBucket(request);
                #elif CORECLR
                return client.GetBucketAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String Bucket { get; set; }
            public System.Func<Amazon.S3Control.Model.GetBucketResponse, GetS3CBucketCmdlet, object> Select { get; set; } =
