...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMMBatchJobExecution")]
    ...
    public partial class GetAMMBatchJobExecutionCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.GetBatchJobExecutionResponse, GetAMMBatchJobExecutionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.GetBatchJobExecutionRequest();
        ...
        private Amazon.MainframeModernization.Model.GetBatchJobExecutionResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.GetBatchJobExecutionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "GetBatchJobExecution");
            try
            {
                #if DESKTOP
                return client.GetBatchJobExecution(request);
                #elif CORECLR
                return client.GetBatchJobExecutionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String ExecutionId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.GetBatchJobExecutionResponse, GetAMMBatchJobExecutionCmdlet, object> Select { get; set; } =
