...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    public partial class GetAMMEnvironmentCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.GetEnvironmentResponse, GetAMMEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.GetEnvironmentRequest();
        ...
        private Amazon.MainframeModernization.Model.GetEnvironmentResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.GetEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "GetEnvironment");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.GetEnvironmentResponse, GetAMMEnvironmentCmdlet, object> Select { get; set; } =
