...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    public partial class GetAMMApplicationCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.GetApplicationResponse, GetAMMApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.GetApplicationRequest();
        ...
        private Amazon.MainframeModernization.Model.GetApplicationResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.GetApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "GetApplication");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ApplicationId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.GetApplicationResponse, GetAMMApplicationCmdlet, object> Select { get; set; } =
