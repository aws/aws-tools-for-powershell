...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    [AWSCmdletOutput("Amazon.MainframeModernization.Model.CreateApplicationResponse",
        "This cmdlet returns an Amazon.MainframeModernization.Model.CreateApplicationResponse object containing multiple properties."
    )]
    public partial class NewAMMApplicationCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags to apply to the application.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A client token is a unique, case-sensitive string of up to 128 ASCII characters with
        /// ASCII values of 33-126 inclusive. It's generated by the client to ensure idempotent
        /// operations, allowing for safe retries without unintended side effects.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
