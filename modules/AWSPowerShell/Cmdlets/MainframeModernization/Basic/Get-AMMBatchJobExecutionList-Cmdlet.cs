...
{
    /// <summary>
    /// Lists historical, current, and scheduled batch job executions for a specific application.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.MainframeModernization.Model.BatchJobExecutionSummary or Amazon.MainframeModernization.Model.ListBatchJobExecutionsResponse",
        ...
        "The service call response (type Amazon.MainframeModernization.Model.ListBatchJobExecutionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMMBatchJobExecutionListCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of each batch job execution.</para><para />
        ...
        private Amazon.MainframeModernization.Model.ListBatchJobExecutionsResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.ListBatchJobExecutionsRequest request)
        {
            ...
            try
            {
                return client.ListBatchJobExecutionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
