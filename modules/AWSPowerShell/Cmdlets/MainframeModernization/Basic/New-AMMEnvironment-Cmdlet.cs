...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    [AWSCmdletOutput("System.String or Amazon.MainframeModernization.Model.CreateEnvironmentResponse",
        ...
        "The service call response (type Amazon.MainframeModernization.Model.CreateEnvironmentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewAMMEnvironmentCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of security groups for the VPC associated with this runtime environment.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Optional. The storage configurations for this runtime environment.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The list of subnets associated with the VPC for this runtime environment.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The tags for the runtime environment.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
