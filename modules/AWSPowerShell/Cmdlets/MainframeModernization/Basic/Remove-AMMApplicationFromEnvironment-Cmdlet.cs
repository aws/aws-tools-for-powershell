...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    public partial class RemoveAMMApplicationFromEnvironmentCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMMApplicationFromEnvironment (DeleteApplicationFromEnvironment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.DeleteApplicationFromEnvironmentResponse, RemoveAMMApplicationFromEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.DeleteApplicationFromEnvironmentRequest();
        ...
        private Amazon.MainframeModernization.Model.DeleteApplicationFromEnvironmentResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.DeleteApplicationFromEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "DeleteApplicationFromEnvironment");
            try
            {
                #if DESKTOP
                return client.DeleteApplicationFromEnvironment(request);
                #elif CORECLR
                return client.DeleteApplicationFromEnvironmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.DeleteApplicationFromEnvironmentResponse, RemoveAMMApplicationFromEnvironmentCmdlet, object> Select { get; set; } =
