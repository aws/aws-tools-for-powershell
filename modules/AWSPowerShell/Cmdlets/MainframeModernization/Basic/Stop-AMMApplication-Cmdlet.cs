...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    /// </summary>
    [Cmdlet("Stop", "AMMApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopAMMApplicationCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-AMMApplication (StopApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.StopApplicationResponse, StopAMMApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.StopApplicationRequest();
            ...
            {
                request.ForceStop = cmdletContext.ForceStop.Value;
            }
        ...
        private Amazon.MainframeModernization.Model.StopApplicationResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.StopApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "StopApplication");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.Boolean? ForceStop { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.StopApplicationResponse, StopAMMApplicationCmdlet, object> Select { get; set; } =
