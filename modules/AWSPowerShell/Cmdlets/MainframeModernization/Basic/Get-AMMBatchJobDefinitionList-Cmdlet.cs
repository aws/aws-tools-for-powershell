...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    /// to start a batch job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAMMBatchJobDefinitionListCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        private Amazon.MainframeModernization.Model.ListBatchJobDefinitionsResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.ListBatchJobDefinitionsRequest request)
        {
            ...
            try
            {
                return client.ListBatchJobDefinitionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
