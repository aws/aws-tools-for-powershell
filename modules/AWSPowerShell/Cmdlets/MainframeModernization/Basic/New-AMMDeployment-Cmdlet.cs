...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    [AWSCmdlet("Calls the M2 CreateDeployment API operation.", Operation = new[] {"CreateDeployment"}, SelectReturnType = typeof(Amazon.MainframeModernization.Model.CreateDeploymentResponse))]
    [AWSCmdletOutput("System.String or Amazon.MainframeModernization.Model.CreateDeploymentResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.MainframeModernization.Model.CreateDeploymentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewAMMDeploymentCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-AMMDeployment (CreateDeployment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.CreateDeploymentResponse, NewAMMDeploymentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.CreateDeploymentRequest();
        ...
        private Amazon.MainframeModernization.Model.CreateDeploymentResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.CreateDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "CreateDeployment");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientToken { get; set; }
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.CreateDeploymentResponse, NewAMMDeploymentCmdlet, object> Select { get; set; } =
