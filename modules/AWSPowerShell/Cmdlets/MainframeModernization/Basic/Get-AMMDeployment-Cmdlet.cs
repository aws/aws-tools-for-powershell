...
namespace Amazon.PowerShell.Cmdlets.AMM
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMMDeployment")]
    [OutputType("Amazon.MainframeModernization.Model.GetDeploymentResponse")]
    [AWSCmdlet("Calls the M2 GetDeployment API operation.", Operation = new[] {"GetDeployment"}, SelectReturnType = typeof(Amazon.MainframeModernization.Model.GetDeploymentResponse))]
    [AWSCmdletOutput("Amazon.MainframeModernization.Model.GetDeploymentResponse",
        "This cmdlet returns an Amazon.MainframeModernization.Model.GetDeploymentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMMDeploymentCmdlet : AmazonMainframeModernizationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MainframeModernization.Model.GetDeploymentResponse, GetAMMDeploymentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MainframeModernization.Model.GetDeploymentRequest();
        ...
        private Amazon.MainframeModernization.Model.GetDeploymentResponse CallAWSServiceOperation(IAmazonMainframeModernization client, Amazon.MainframeModernization.Model.GetDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "M2", "GetDeployment");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String DeploymentId { get; set; }
            public System.Func<Amazon.MainframeModernization.Model.GetDeploymentResponse, GetAMMDeploymentCmdlet, object> Select { get; set; } =
