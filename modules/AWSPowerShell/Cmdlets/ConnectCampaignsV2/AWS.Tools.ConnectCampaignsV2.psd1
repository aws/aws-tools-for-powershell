#
# Module manifest for module 'AWS.Tools.ConnectCampaignsV2'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ConnectCampaignsV2.dll'
    ...
    GUID = '99a6427a-954c-41b7-9b1a-6cc4d7ad9e6f'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.ConnectCampaignsV2.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ConnectCampaignsV2.Completers.psm1',
        'AWS.Tools.ConnectCampaignsV2.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.ConnectCampaignsV2.dll-Help.xml'
    )
