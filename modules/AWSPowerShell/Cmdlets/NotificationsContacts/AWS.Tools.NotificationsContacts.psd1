#
# Module manifest for module 'AWS.Tools.NotificationsContacts'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.NotificationsContacts.dll'
    ...
    GUID = 'c63adc44-47a8-407c-a25d-505c87020e82'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.NotificationsContacts.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.NotificationsContacts.Completers.psm1',
        'AWS.Tools.NotificationsContacts.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.NotificationsContacts.dll-Help.xml'
    )
