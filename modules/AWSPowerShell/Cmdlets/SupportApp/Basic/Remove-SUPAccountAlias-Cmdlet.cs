...
namespace Amazon.PowerShell.Cmdlets.SUP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SUPAccountAlias", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSUPAccountAliasCmdlet : AmazonSupportAppClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SUPAccountAlias (DeleteAccountAlias)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SupportApp.Model.DeleteAccountAliasResponse, RemoveSUPAccountAliasCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SupportApp.Model.DeleteAccountAliasRequest();
        ...
        private Amazon.SupportApp.Model.DeleteAccountAliasResponse CallAWSServiceOperation(IAmazonSupportApp client, Amazon.SupportApp.Model.DeleteAccountAliasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Support App", "DeleteAccountAlias");
            try
            {
                #if DESKTOP
                return client.DeleteAccountAlias(request);
                #elif CORECLR
                return client.DeleteAccountAliasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.SupportApp.Model.DeleteAccountAliasResponse, RemoveSUPAccountAliasCmdlet, object> Select { get; set; } =
