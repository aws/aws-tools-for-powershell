...
namespace Amazon.PowerShell.Cmdlets.SUP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SUPSlackChannelConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSUPSlackChannelConfigurationCmdlet : AmazonSupportAppClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SUPSlackChannelConfiguration (DeleteSlackChannelConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SupportApp.Model.DeleteSlackChannelConfigurationResponse, RemoveSUPSlackChannelConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SupportApp.Model.DeleteSlackChannelConfigurationRequest();
        ...
        private Amazon.SupportApp.Model.DeleteSlackChannelConfigurationResponse CallAWSServiceOperation(IAmazonSupportApp client, Amazon.SupportApp.Model.DeleteSlackChannelConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Support App", "DeleteSlackChannelConfiguration");
            try
            {
                return client.DeleteSlackChannelConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChannelId { get; set; }
            public System.String TeamId { get; set; }
            public System.Func<Amazon.SupportApp.Model.DeleteSlackChannelConfigurationResponse, RemoveSUPSlackChannelConfigurationCmdlet, object> Select { get; set; } =
