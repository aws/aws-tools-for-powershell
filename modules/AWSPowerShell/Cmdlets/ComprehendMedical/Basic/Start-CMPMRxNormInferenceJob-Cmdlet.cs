...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    [AWSCmdlet("Calls the AWS Comprehend Medical StartRxNormInferenceJob API operation.", Operation = new[] {"StartRxNormInferenceJob"}, SelectReturnType = typeof(Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse))]
    [AWSCmdletOutput("System.String or Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartCMPMRxNormInferenceJobCmdlet : AmazonComprehendMedicalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CMPMRxNormInferenceJob (StartRxNormInferenceJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse, StartCMPMRxNormInferenceJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComprehendMedical.Model.StartRxNormInferenceJobRequest();
        ...
        private Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse CallAWSServiceOperation(IAmazonComprehendMedical client, Amazon.ComprehendMedical.Model.StartRxNormInferenceJobRequest request)
        {
            ...
            try
            {
                return client.StartRxNormInferenceJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OutputDataConfig_S3Bucket { get; set; }
            public System.String OutputDataConfig_S3Key { get; set; }
            public System.Func<Amazon.ComprehendMedical.Model.StartRxNormInferenceJobResponse, StartCMPMRxNormInferenceJobCmdlet, object> Select { get; set; } =
