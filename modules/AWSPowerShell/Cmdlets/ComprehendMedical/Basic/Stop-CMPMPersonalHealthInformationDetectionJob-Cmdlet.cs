...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    /// </summary>
    [Cmdlet("Stop", "CMPMPersonalHealthInformationDetectionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopCMPMPersonalHealthInformationDetectionJobCmdlet : AmazonComprehendMedicalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-CMPMPersonalHealthInformationDetectionJob (StopPHIDetectionJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComprehendMedical.Model.StopPHIDetectionJobResponse, StopCMPMPersonalHealthInformationDetectionJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComprehendMedical.Model.StopPHIDetectionJobRequest();
        ...
        private Amazon.ComprehendMedical.Model.StopPHIDetectionJobResponse CallAWSServiceOperation(IAmazonComprehendMedical client, Amazon.ComprehendMedical.Model.StopPHIDetectionJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Comprehend Medical", "StopPHIDetectionJob");
            try
            {
                #if DESKTOP
                return client.StopPHIDetectionJob(request);
                #elif CORECLR
                return client.StopPHIDetectionJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.ComprehendMedical.Model.StopPHIDetectionJobResponse, StopCMPMPersonalHealthInformationDetectionJobCmdlet, object> Select { get; set; } =
