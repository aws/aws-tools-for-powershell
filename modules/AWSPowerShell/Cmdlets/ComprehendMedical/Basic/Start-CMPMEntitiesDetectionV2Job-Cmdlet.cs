...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    /// of a job.
    /// </summary>
    [Cmdlet("Start", "CMPMEntitiesDetectionV2Job", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Comprehend Medical StartEntitiesDetectionV2Job API operation.", Operation = new[] {"StartEntitiesDetectionV2Job"}, SelectReturnType = typeof(Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse))]
    [AWSCmdletOutput("System.String or Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCMPMEntitiesDetectionV2JobCmdlet : AmazonComprehendMedicalClientCmdlet, IExecutor
    {
        ...
        /// Medical; generates one for you.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The language of the input documents. All documents must be in the same language. Comprehend
        /// Medical; processes files in US English (en).</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CMPMEntitiesDetectionV2Job (StartEntitiesDetectionV2Job)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse, StartCMPMEntitiesDetectionV2JobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobRequest();
        ...
        private Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse CallAWSServiceOperation(IAmazonComprehendMedical client, Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Comprehend Medical", "StartEntitiesDetectionV2Job");
            try
            {
                #if DESKTOP
                return client.StartEntitiesDetectionV2Job(request);
                #elif CORECLR
                return client.StartEntitiesDetectionV2JobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OutputDataConfig_S3Bucket { get; set; }
            public System.String OutputDataConfig_S3Key { get; set; }
            public System.Func<Amazon.ComprehendMedical.Model.StartEntitiesDetectionV2JobResponse, StartCMPMEntitiesDetectionV2JobCmdlet, object> Select { get; set; } =
