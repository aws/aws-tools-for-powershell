...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CMPMEntitiesDetectionV2JobList")]
    [OutputType("Amazon.ComprehendMedical.Model.ComprehendMedicalAsyncJobProperties")]
    [AWSCmdlet("Calls the AWS Comprehend Medical ListEntitiesDetectionV2Jobs API operation.", Operation = new[] {"ListEntitiesDetectionV2Jobs"}, SelectReturnType = typeof(Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse))]
    [AWSCmdletOutput("Amazon.ComprehendMedical.Model.ComprehendMedicalAsyncJobProperties or Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse",
        "This cmdlet returns a collection of Amazon.ComprehendMedical.Model.ComprehendMedicalAsyncJobProperties objects.",
        "The service call response (type Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCMPMEntitiesDetectionV2JobListCmdlet : AmazonComprehendMedicalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse, GetCMPMEntitiesDetectionV2JobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsRequest();
        ...
        private Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse CallAWSServiceOperation(IAmazonComprehendMedical client, Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Comprehend Medical", "ListEntitiesDetectionV2Jobs");
            try
            {
                #if DESKTOP
                return client.ListEntitiesDetectionV2Jobs(request);
                #elif CORECLR
                return client.ListEntitiesDetectionV2JobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ComprehendMedical.Model.ListEntitiesDetectionV2JobsResponse, GetCMPMEntitiesDetectionV2JobListCmdlet, object> Select { get; set; } =
