...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    /// </summary>
    [Cmdlet("Start", "CMPMPersonalHealthInformationDetectionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Comprehend Medical StartPHIDetectionJob API operation.", Operation = new[] {"StartPHIDetectionJob"}, SelectReturnType = typeof(Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse))]
    [AWSCmdletOutput("System.String or Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCMPMPersonalHealthInformationDetectionJobCmdlet : AmazonComprehendMedicalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CMPMPersonalHealthInformationDetectionJob (StartPHIDetectionJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse, StartCMPMPersonalHealthInformationDetectionJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ComprehendMedical.Model.StartPHIDetectionJobRequest();
        ...
        private Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse CallAWSServiceOperation(IAmazonComprehendMedical client, Amazon.ComprehendMedical.Model.StartPHIDetectionJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Comprehend Medical", "StartPHIDetectionJob");
            try
            {
                #if DESKTOP
                return client.StartPHIDetectionJob(request);
                #elif CORECLR
                return client.StartPHIDetectionJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String OutputDataConfig_S3Bucket { get; set; }
            public System.String OutputDataConfig_S3Key { get; set; }
            public System.Func<Amazon.ComprehendMedical.Model.StartPHIDetectionJobResponse, StartCMPMPersonalHealthInformationDetectionJobCmdlet, object> Select { get; set; } =
