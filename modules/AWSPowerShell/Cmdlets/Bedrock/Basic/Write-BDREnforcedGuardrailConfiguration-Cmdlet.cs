...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class WriteBDREnforcedGuardrailConfigurationCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Models to exclude from enforcement of the guardrail.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Models to enforce the guardrail on.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Bedrock.Model.PutEnforcedGuardrailConfigurationResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.PutEnforcedGuardrailConfigurationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.PutEnforcedGuardrailConfiguration(request);
                #elif CORECLR
                return client.PutEnforcedGuardrailConfigurationAsync(request).GetAwaiter().GetResult();
                #else
