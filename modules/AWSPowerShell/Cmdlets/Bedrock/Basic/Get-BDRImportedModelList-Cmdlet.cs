...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    /// </summary>
    [Cmdlet("Get", "BDRImportedModelList")]
    [OutputType("Amazon.Bedrock.Model.ImportedModelSummary")]
    [AWSCmdlet("Calls the Amazon Bedrock ListImportedModels API operation.", Operation = new[] {"ListImportedModels"}, SelectReturnType = typeof(Amazon.Bedrock.Model.ListImportedModelsResponse))]
    [AWSCmdletOutput("Amazon.Bedrock.Model.ImportedModelSummary or Amazon.Bedrock.Model.ListImportedModelsResponse",
        "This cmdlet returns a collection of Amazon.Bedrock.Model.ImportedModelSummary objects.",
        "The service call response (type Amazon.Bedrock.Model.ListImportedModelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBDRImportedModelListCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.ListImportedModelsResponse, GetBDRImportedModelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Bedrock.Model.ListImportedModelsRequest();
        ...
        private Amazon.Bedrock.Model.ListImportedModelsResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.ListImportedModelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "ListImportedModels");
            try
            {
                #if DESKTOP
                return client.ListImportedModels(request);
                #elif CORECLR
                return client.ListImportedModelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Bedrock.SortModelsBy SortBy { get; set; }
            public Amazon.Bedrock.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.Bedrock.Model.ListImportedModelsResponse, GetBDRImportedModelListCmdlet, object> Select { get; set; } =
