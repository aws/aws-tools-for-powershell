...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    /// </summary>
    [Cmdlet("Get", "BDRModelImportJobList")]
    [OutputType("Amazon.Bedrock.Model.ModelImportJobSummary")]
    [AWSCmdlet("Calls the Amazon Bedrock ListModelImportJobs API operation.", Operation = new[] {"ListModelImportJobs"}, SelectReturnType = typeof(Amazon.Bedrock.Model.ListModelImportJobsResponse))]
    [AWSCmdletOutput("Amazon.Bedrock.Model.ModelImportJobSummary or Amazon.Bedrock.Model.ListModelImportJobsResponse",
        "This cmdlet returns a collection of Amazon.Bedrock.Model.ModelImportJobSummary objects.",
        "The service call response (type Amazon.Bedrock.Model.ListModelImportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBDRModelImportJobListCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("StatusEquals")]
        [AWSConstantClassSource("Amazon.Bedrock.ModelImportJobStatus")]
        public Amazon.Bedrock.ModelImportJobStatus StatusEqual { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ModelImportJobSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.ListModelImportJobsResponse, GetBDRModelImportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Bedrock.Model.ListModelImportJobsRequest();
        ...
        private Amazon.Bedrock.Model.ListModelImportJobsResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.ListModelImportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "ListModelImportJobs");
            try
            {
                #if DESKTOP
                return client.ListModelImportJobs(request);
                #elif CORECLR
                return client.ListModelImportJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Bedrock.SortOrder SortOrder { get; set; }
            public Amazon.Bedrock.ModelImportJobStatus StatusEqual { get; set; }
            public System.Func<Amazon.Bedrock.Model.ListModelImportJobsResponse, GetBDRModelImportJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ModelImportJobSummaries;
        }
