...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    [AWSCmdletOutput("Amazon.Bedrock.Model.ModelInvocationJobSummary or Amazon.Bedrock.Model.ListModelInvocationJobsResponse",
        ...
        "The service call response (type Amazon.Bedrock.Model.ListModelInvocationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
