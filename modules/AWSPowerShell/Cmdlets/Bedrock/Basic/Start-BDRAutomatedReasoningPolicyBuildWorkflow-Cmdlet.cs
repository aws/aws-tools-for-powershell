...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class StartBDRAutomatedReasoningPolicyBuildWorkflowCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// as rule corrections or variable updates.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The list of documents to be processed in a document ingestion workflow.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// be processed to create atomic statements and grounding information.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Bedrock.Model.StartAutomatedReasoningPolicyBuildWorkflowResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.StartAutomatedReasoningPolicyBuildWorkflowRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartAutomatedReasoningPolicyBuildWorkflow(request);
                #elif CORECLR
                return client.StartAutomatedReasoningPolicyBuildWorkflowAsync(request).GetAwaiter().GetResult();
                #else
