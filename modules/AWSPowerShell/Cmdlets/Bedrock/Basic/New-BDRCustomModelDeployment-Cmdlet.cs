...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class NewBDRCustomModelDeploymentCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// your Amazon Web Services resources for cost allocation and management purposes.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ModelDeploymentName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ModelDeploymentName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ModelDeploymentName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ModelDeploymentName;
            }
        ...
        private Amazon.Bedrock.Model.CreateCustomModelDeploymentResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.CreateCustomModelDeploymentRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateCustomModelDeployment(request);
                #elif CORECLR
                return client.CreateCustomModelDeploymentAsync(request).GetAwaiter().GetResult();
                #else
