...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    [AWSCmdletOutput("Amazon.Bedrock.Model.ModelCopyJobSummary or Amazon.Bedrock.Model.ListModelCopyJobsResponse",
        ...
        "The service call response (type Amazon.Bedrock.Model.ListModelCopyJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
