...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Bedrock DeleteCustomModel API operation.", Operation = new[] {"DeleteCustomModel"}, SelectReturnType = typeof(Amazon.Bedrock.Model.DeleteCustomModelResponse))]
    [AWSCmdletOutput("None or Amazon.Bedrock.Model.DeleteCustomModelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Bedrock.Model.DeleteCustomModelResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBDRCustomModelCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ModelIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BDRCustomModel (DeleteCustomModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.DeleteCustomModelResponse, RemoveBDRCustomModelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Bedrock.Model.DeleteCustomModelRequest();
        ...
        private Amazon.Bedrock.Model.DeleteCustomModelResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.DeleteCustomModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "DeleteCustomModel");
            try
            {
                #if DESKTOP
                return client.DeleteCustomModel(request);
                #elif CORECLR
                return client.DeleteCustomModelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ModelIdentifier { get; set; }
            public System.Func<Amazon.Bedrock.Model.DeleteCustomModelResponse, RemoveBDRCustomModelCmdlet, object> Select { get; set; } =
