...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class StopBDRModelCustomizationJobCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-BDRModelCustomizationJob (StopModelCustomizationJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.StopModelCustomizationJobResponse, StopBDRModelCustomizationJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Bedrock.Model.StopModelCustomizationJobRequest();
        ...
        private Amazon.Bedrock.Model.StopModelCustomizationJobResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.StopModelCustomizationJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "StopModelCustomizationJob");
            try
            {
                #if DESKTOP
                return client.StopModelCustomizationJob(request);
                #elif CORECLR
                return client.StopModelCustomizationJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobIdentifier { get; set; }
            public System.Func<Amazon.Bedrock.Model.StopModelCustomizationJobResponse, StopBDRModelCustomizationJobCmdlet, object> Select { get; set; } =
