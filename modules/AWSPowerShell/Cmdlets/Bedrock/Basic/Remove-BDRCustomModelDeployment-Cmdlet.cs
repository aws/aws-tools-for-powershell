...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class RemoveBDRCustomModelDeploymentCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the CustomModelDeploymentIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^CustomModelDeploymentIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CustomModelDeploymentIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CustomModelDeploymentIdentifier;
            }
        ...
        private Amazon.Bedrock.Model.DeleteCustomModelDeploymentResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.DeleteCustomModelDeploymentRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteCustomModelDeployment(request);
                #elif CORECLR
                return client.DeleteCustomModelDeploymentAsync(request).GetAwaiter().GetResult();
                #else
