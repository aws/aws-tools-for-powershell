...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "BDRAutomatedReasoningPolicyBuildWorkflow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Bedrock DeleteAutomatedReasoningPolicyBuildWorkflow API operation.", Operation = new[] {"DeleteAutomatedReasoningPolicyBuildWorkflow"}, SelectReturnType = typeof(Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse))]
    [AWSCmdletOutput("None or Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveBDRAutomatedReasoningPolicyBuildWorkflowCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the build workflow to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The timestamp when the build workflow was last updated. This is used for optimistic
        /// concurrency control to prevent accidental deletion of workflows that have been modified.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BDRAutomatedReasoningPolicyBuildWorkflow (DeleteAutomatedReasoningPolicyBuildWorkflow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse, RemoveBDRAutomatedReasoningPolicyBuildWorkflowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowRequest();
        ...
        private Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "DeleteAutomatedReasoningPolicyBuildWorkflow");
            try
            {
                #if DESKTOP
                return client.DeleteAutomatedReasoningPolicyBuildWorkflow(request);
                #elif CORECLR
                return client.DeleteAutomatedReasoningPolicyBuildWorkflowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? LastUpdatedAt { get; set; }
            public System.String PolicyArn { get; set; }
            public System.Func<Amazon.Bedrock.Model.DeleteAutomatedReasoningPolicyBuildWorkflowResponse, RemoveBDRAutomatedReasoningPolicyBuildWorkflowCmdlet, object> Select { get; set; } =
