...
namespace Amazon.PowerShell.Cmdlets.BDR
{
    ...
    public partial class RemoveBDRResourceTagCmdlet : AmazonBedrockClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tag keys of the tags to remove from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BDRResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Bedrock.Model.UntagResourceResponse, RemoveBDRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Bedrock.Model.UntagResourceRequest();
        ...
        private Amazon.Bedrock.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonBedrock client, Amazon.Bedrock.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Bedrock.Model.UntagResourceResponse, RemoveBDRResourceTagCmdlet, object> Select { get; set; } =
