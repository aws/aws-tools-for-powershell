...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    public partial class GetSFNStateMachineCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.StepFunctions.Model.DescribeStateMachineResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.DescribeStateMachineRequest request)
        {
            #if DESKTOP
