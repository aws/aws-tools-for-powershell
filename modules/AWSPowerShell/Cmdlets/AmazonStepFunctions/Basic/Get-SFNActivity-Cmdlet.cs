...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    [AWSCmdlet("Calls the AWS Step Functions DescribeActivity API operation.", Operation = new[] {"DescribeActivity"})]
    ...
    public partial class GetSFNActivityCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Step Functions", "DescribeActivity");
            try
            {
                #if DESKTOP
                return client.DescribeActivity(request);
                #elif CORECLR
                return client.DescribeActivityAsync(request).GetAwaiter().GetResult();
                #else
