...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    public partial class RemoveSFNActivityCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ActivityArn", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ActivityArn;
        ...
        private static Amazon.StepFunctions.Model.DeleteActivityResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.DeleteActivityRequest request)
        {
            #if DESKTOP
            return client.DeleteActivity(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeleteActivityAsync(request);
            return task.Result;
            #else
