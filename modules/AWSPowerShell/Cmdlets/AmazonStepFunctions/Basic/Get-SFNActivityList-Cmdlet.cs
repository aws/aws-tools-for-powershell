...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    /// the previous call.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    [Cmdlet("Get", "SFNActivityList")]
    [OutputType("Amazon.StepFunctions.Model.ActivityListItem")]
    [AWSCmdlet("Invokes the ListActivities operation against Amazon Step Functions.", Operation = new[] {"ListActivities"})]
    [AWSCmdletOutput("Amazon.StepFunctions.Model.ActivityListItem",
        "This cmdlet returns a collection of ActivityListItem objects.",
    ...
    public partial class GetSFNActivityListCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        private Amazon.StepFunctions.Model.ListActivitiesResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.ListActivitiesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListActivitiesAsync(request);
                return task.Result;
                #else
