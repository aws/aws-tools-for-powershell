...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    /// by the previous call.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    ...
    public partial class GetSFNStateMachineListCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.StepFunctions.Model.ListStateMachinesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.StateMachines;
                        ...
                        int _receivedThisCall = response.StateMachines.Count;
        ...
        private static Amazon.StepFunctions.Model.ListStateMachinesResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.ListStateMachinesRequest request)
        {
            #if DESKTOP
