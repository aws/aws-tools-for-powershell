...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SFNResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the AWS Step Functions UntagResource API operation.", Operation = new[] {"UntagResource"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.StepFunctions.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSFNResourceTagCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SFNResourceTag (UntagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StepFunctions.Model.UntagResourceRequest();
        ...
        private Amazon.StepFunctions.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Step Functions", "UntagResource");
            try
            {
                #if DESKTOP
