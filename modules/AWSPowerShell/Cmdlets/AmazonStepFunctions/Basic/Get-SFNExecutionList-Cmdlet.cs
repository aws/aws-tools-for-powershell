...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    /// using the <code>nextToken</code> returned by the previous call.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    ...
    public partial class GetSFNExecutionListCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Executions;
        ...
        private static Amazon.StepFunctions.Model.ListExecutionsResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.ListExecutionsRequest request)
        {
            #if DESKTOP
            return client.ListExecutions(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListExecutionsAsync(request);
            return task.Result;
            #else
