...
namespace Amazon.PowerShell.Cmdlets.SFN
{
    ...
    [AWSCmdlet("Invokes the SendTaskSuccess operation against Amazon Step Functions.", Operation = new[] {"SendTaskSuccess"})]
    ...
    public partial class SendSFNTaskSuccessCmdlet : AmazonStepFunctionsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.StepFunctions.Model.SendTaskSuccessResponse CallAWSServiceOperation(IAmazonStepFunctions client, Amazon.StepFunctions.Model.SendTaskSuccessRequest request)
        {
            #if DESKTOP
            return client.SendTaskSuccess(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.SendTaskSuccessAsync(request);
            return task.Result;
            #else
