...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    [AWSCmdlet("Invokes the DescribeParameterGroups operation against Amazon DynamoDB Accelerator (DAX).", Operation = new[] {"DescribeParameterGroups"})]
    [AWSCmdletOutput("Amazon.DAX.Model.ParameterGroup",
        "This cmdlet returns a collection of ParameterGroup objects.",
    ...
    public partial class GetDAXParameterGroupCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ParameterGroupNames = new List<System.String>(this.ParameterGroupName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ParameterGroupNames != null)
            {
                request.ParameterGroupNames = cmdletContext.ParameterGroupNames;
            }
        ...
        internal class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> ParameterGroupNames { get; set; }
        }
