...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    public partial class GetDAXSubnetGroupCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.SubnetGroupNames = new List<System.String>(this.SubnetGroupName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.SubnetGroupNames != null)
            {
                request.SubnetGroupNames = cmdletContext.SubnetGroupNames;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SubnetGroups;
        ...
        private Amazon.DAX.Model.DescribeSubnetGroupsResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.DescribeSubnetGroupsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeSubnetGroupsAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> SubnetGroupNames { get; set; }
        }
