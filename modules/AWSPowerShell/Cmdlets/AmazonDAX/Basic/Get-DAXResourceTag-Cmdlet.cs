...
namespace Amazon.PowerShell.Cmdlets.DAX
{
    ...
    public partial class GetDAXResourceTagCmdlet : AmazonDAXClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DAX.Model.ListTagsRequest();
        ...
        private Amazon.DAX.Model.ListTagsResponse CallAWSServiceOperation(IAmazonDAX client, Amazon.DAX.Model.ListTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB Accelerator (DAX)", "ListTags");
            try
            {
                #if DESKTOP
