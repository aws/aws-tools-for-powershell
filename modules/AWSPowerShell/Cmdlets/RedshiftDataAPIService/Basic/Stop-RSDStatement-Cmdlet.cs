...
namespace Amazon.PowerShell.Cmdlets.RSD
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Stop", "RSDStatement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopRSDStatementCmdlet : AmazonRedshiftDataAPIServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-RSDStatement (CancelStatement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftDataAPIService.Model.CancelStatementResponse, StopRSDStatementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftDataAPIService.Model.CancelStatementRequest();
        ...
        private Amazon.RedshiftDataAPIService.Model.CancelStatementResponse CallAWSServiceOperation(IAmazonRedshiftDataAPIService client, Amazon.RedshiftDataAPIService.Model.CancelStatementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Redshift Data API Service", "CancelStatement");
            try
            {
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.RedshiftDataAPIService.Model.CancelStatementResponse, StopRSDStatementCmdlet, object> Select { get; set; } =
