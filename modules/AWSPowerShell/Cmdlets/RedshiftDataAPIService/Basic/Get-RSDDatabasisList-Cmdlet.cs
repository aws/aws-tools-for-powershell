...
namespace Amazon.PowerShell.Cmdlets.RSD
{
    ...
    [AWSCmdlet("Calls the Redshift Data API Service ListDatabases API operation.", Operation = new[] {"ListDatabases"}, SelectReturnType = typeof(Amazon.RedshiftDataAPIService.Model.ListDatabasesResponse))]
    [AWSCmdletOutput("System.String or Amazon.RedshiftDataAPIService.Model.ListDatabasesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.RedshiftDataAPIService.Model.ListDatabasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSDDatabasisListCmdlet : AmazonRedshiftDataAPIServiceClientCmdlet, IExecutor
    {
        ...
        /// than fit in one response, then <c>NextToken</c> is returned to page through the results.
        /// </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftDataAPIService.Model.ListDatabasesResponse, GetRSDDatabasisListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftDataAPIService.Model.ListDatabasesRequest();
        ...
        private Amazon.RedshiftDataAPIService.Model.ListDatabasesResponse CallAWSServiceOperation(IAmazonRedshiftDataAPIService client, Amazon.RedshiftDataAPIService.Model.ListDatabasesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Redshift Data API Service", "ListDatabases");
            try
            {
