...
namespace Amazon.PowerShell.Cmdlets.RSD
{
    ...
    public partial class GetRSDStatementCmdlet : AmazonRedshiftDataAPIServiceClientCmdlet, IExecutor
    {
        ...
        /// by <code>ExecuteStatment</code> and <code>ListStatements</code>. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftDataAPIService.Model.DescribeStatementResponse, GetRSDStatementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftDataAPIService.Model.DescribeStatementRequest();
        ...
        private Amazon.RedshiftDataAPIService.Model.DescribeStatementResponse CallAWSServiceOperation(IAmazonRedshiftDataAPIService client, Amazon.RedshiftDataAPIService.Model.DescribeStatementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Redshift Data API Service", "DescribeStatement");
            try
            {
                #if DESKTOP
                return client.DescribeStatement(request);
                #elif CORECLR
                return client.DescribeStatementAsync(request).GetAwaiter().GetResult();
                #else
