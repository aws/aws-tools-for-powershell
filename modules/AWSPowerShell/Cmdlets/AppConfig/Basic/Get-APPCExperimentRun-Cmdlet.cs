...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// exposure settings.
    /// </summary>
    [Cmdlet("Get", "APPCExperimentRun")]
    [OutputType("Amazon.AppConfig.Model.GetExperimentRunResponse")]
    [AWSCmdlet("Calls the AWS AppConfig GetExperimentRun API operation.", Operation = new[] {"GetExperimentRun"}, SelectReturnType = typeof(Amazon.AppConfig.Model.GetExperimentRunResponse))]
    [AWSCmdletOutput("Amazon.AppConfig.Model.GetExperimentRunResponse",
        "This cmdlet returns an Amazon.AppConfig.Model.GetExperimentRunResponse object containing multiple properties."
    )]
    public partial class GetAPPCExperimentRunCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The run number to retrieve.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AppConfig.Model.GetExperimentRunResponse).
        /// Specifying the name of a property of type Amazon.AppConfig.Model.GetExperimentRunResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.GetExperimentRunResponse, GetAPPCExperimentRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.GetExperimentRunRequest();
        ...
        private Amazon.AppConfig.Model.GetExperimentRunResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.GetExperimentRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "GetExperimentRun");
            try
            {
                return client.GetExperimentRunAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ExperimentDefinitionIdentifier { get; set; }
            public System.Int32? Run { get; set; }
            public System.Func<Amazon.AppConfig.Model.GetExperimentRunResponse, GetAPPCExperimentRunCmdlet, object> Select { get; set; } =
