...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// and bake time.
    /// </summary>
    [Cmdlet("Get", "APPCDeploymentStrategy")]
    ...
    public partial class GetAPPCDeploymentStrategyCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.GetDeploymentStrategyResponse, GetAPPCDeploymentStrategyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.GetDeploymentStrategyRequest();
        ...
        private Amazon.AppConfig.Model.GetDeploymentStrategyResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.GetDeploymentStrategyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "GetDeploymentStrategy");
            try
            {
                #if DESKTOP
                return client.GetDeploymentStrategy(request);
                #elif CORECLR
                return client.GetDeploymentStrategyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DeploymentStrategyId { get; set; }
            public System.Func<Amazon.AppConfig.Model.GetDeploymentStrategyResponse, GetAPPCDeploymentStrategyCmdlet, object> Select { get; set; } =
