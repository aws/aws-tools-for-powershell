...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    [AWSCmdlet("Calls the AWS AppConfig GetEnvironment API operation.", Operation = new[] {"GetEnvironment"}, SelectReturnType = typeof(Amazon.AppConfig.Model.GetEnvironmentResponse))]
    [AWSCmdletOutput("Amazon.AppConfig.Model.GetEnvironmentResponse",
        "This cmdlet returns an Amazon.AppConfig.Model.GetEnvironmentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPPCEnvironmentCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.GetEnvironmentResponse, GetAPPCEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.GetEnvironmentRequest();
        ...
        private Amazon.AppConfig.Model.GetEnvironmentResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.GetEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "GetEnvironment");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.AppConfig.Model.GetEnvironmentResponse, GetAPPCEnvironmentCmdlet, object> Select { get; set; } =
