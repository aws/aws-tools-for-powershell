...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "APPCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAPPCResourceTagCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag keys to delete.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APPCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.UntagResourceResponse, RemoveAPPCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.UntagResourceRequest();
        ...
        private Amazon.AppConfig.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppConfig.Model.UntagResourceResponse, RemoveAPPCResourceTagCmdlet, object> Select { get; set; } =
