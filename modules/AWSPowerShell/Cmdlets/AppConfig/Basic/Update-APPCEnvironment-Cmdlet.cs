...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// </summary>
    [Cmdlet("Update", "APPCEnvironment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateAPPCEnvironmentCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Amazon CloudWatch alarms to monitor during the deployment process.</para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Monitors")]
        public Amazon.AppConfig.Model.Monitor[] Monitor { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-APPCEnvironment (UpdateEnvironment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.UpdateEnvironmentResponse, UpdateAPPCEnvironmentCmdlet>(Select) ??
            ...
            {
                context.Monitor = new List<Amazon.AppConfig.Model.Monitor>(this.Monitor);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.UpdateEnvironmentRequest();
            ...
            {
                request.Monitors = cmdletContext.Monitor;
            }
        ...
        private Amazon.AppConfig.Model.UpdateEnvironmentResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.UpdateEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "UpdateEnvironment");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String EnvironmentId { get; set; }
            public List<Amazon.AppConfig.Model.Monitor> Monitor { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.AppConfig.Model.UpdateEnvironmentResponse, UpdateAPPCEnvironmentCmdlet, object> Select { get; set; } =
