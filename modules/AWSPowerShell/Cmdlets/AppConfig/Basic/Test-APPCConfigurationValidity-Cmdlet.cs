...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// </summary>
    [Cmdlet("Test", "APPCConfigurationValidity")]
    [OutputType("None")]
    ...
    public partial class TestAPPCConfigurationValidityCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.ValidateConfigurationResponse, TestAPPCConfigurationValidityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.ValidateConfigurationRequest();
        ...
        private Amazon.AppConfig.Model.ValidateConfigurationResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.ValidateConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "ValidateConfiguration");
            try
            {
                #if DESKTOP
                return client.ValidateConfiguration(request);
                #elif CORECLR
                return client.ValidateConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ConfigurationProfileId { get; set; }
            public System.String ConfigurationVersion { get; set; }
            public System.Func<Amazon.AppConfig.Model.ValidateConfigurationResponse, TestAPPCConfigurationValidityCmdlet, object> Select { get; set; } =
