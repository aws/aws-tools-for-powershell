...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// </summary>
    [Cmdlet("Add", "APPCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddAPPCResourceTagCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        /// be up to 256 characters.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-APPCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.TagResourceResponse, AddAPPCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.TagResourceRequest();
        ...
        private Amazon.AppConfig.Model.TagResourceResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppConfig.Model.TagResourceResponse, AddAPPCResourceTagCmdlet, object> Select { get; set; } =
