...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    [AWSCmdlet("Calls the AWS AppConfig GetConfigurationProfile API operation.", Operation = new[] {"GetConfigurationProfile"}, SelectReturnType = typeof(Amazon.AppConfig.Model.GetConfigurationProfileResponse))]
    [AWSCmdletOutput("Amazon.AppConfig.Model.GetConfigurationProfileResponse",
        "This cmdlet returns an Amazon.AppConfig.Model.GetConfigurationProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPPCConfigurationProfileCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.GetConfigurationProfileResponse, GetAPPCConfigurationProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.GetConfigurationProfileRequest();
        ...
        private Amazon.AppConfig.Model.GetConfigurationProfileResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.GetConfigurationProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "GetConfigurationProfile");
            try
            {
                #if DESKTOP
                return client.GetConfigurationProfile(request);
                #elif CORECLR
                return client.GetConfigurationProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationId { get; set; }
            public System.String ConfigurationProfileId { get; set; }
            public System.Func<Amazon.AppConfig.Model.GetConfigurationProfileResponse, GetAPPCConfigurationProfileCmdlet, object> Select { get; set; } =
