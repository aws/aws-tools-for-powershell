...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    /// </summary>
    [Cmdlet("Update", "APPCExperimentRun", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AppConfig.Model.UpdateExperimentRunResponse")]
    [AWSCmdlet("Calls the AWS AppConfig UpdateExperimentRun API operation.", Operation = new[] {"UpdateExperimentRun"}, SelectReturnType = typeof(Amazon.AppConfig.Model.UpdateExperimentRunResponse))]
    [AWSCmdletOutput("Amazon.AppConfig.Model.UpdateExperimentRunResponse",
        "This cmdlet returns an Amazon.AppConfig.Model.UpdateExperimentRunResponse object containing multiple properties."
    )]
    public partial class UpdateAPPCExperimentRunCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An updated description for the experiment run.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The new exposure percentage. This value can only be increased from the current setting.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The run number to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AppConfig.Model.UpdateExperimentRunResponse).
        /// Specifying the name of a property of type Amazon.AppConfig.Model.UpdateExperimentRunResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-APPCExperimentRun (UpdateExperimentRun)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.UpdateExperimentRunResponse, UpdateAPPCExperimentRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.UpdateExperimentRunRequest();
        ...
        private Amazon.AppConfig.Model.UpdateExperimentRunResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.UpdateExperimentRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "UpdateExperimentRun");
            try
            {
                return client.UpdateExperimentRunAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppConfig.Model.UpdateExperimentRunResponse, UpdateAPPCExperimentRunCmdlet, object> Select { get; set; } =
