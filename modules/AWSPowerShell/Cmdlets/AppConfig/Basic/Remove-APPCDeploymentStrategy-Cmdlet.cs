...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS AppConfig DeleteDeploymentStrategy API operation.", Operation = new[] {"DeleteDeploymentStrategy"}, SelectReturnType = typeof(Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse))]
    [AWSCmdletOutput("None or Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAPPCDeploymentStrategyCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APPCDeploymentStrategy (DeleteDeploymentStrategy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse, RemoveAPPCDeploymentStrategyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.DeleteDeploymentStrategyRequest();
        ...
        private Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.DeleteDeploymentStrategyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "DeleteDeploymentStrategy");
            try
            {
                #if DESKTOP
                return client.DeleteDeploymentStrategy(request);
                #elif CORECLR
                return client.DeleteDeploymentStrategyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DeploymentStrategyId { get; set; }
            public System.Func<Amazon.AppConfig.Model.DeleteDeploymentStrategyResponse, RemoveAPPCDeploymentStrategyCmdlet, object> Select { get; set; } =
