...
namespace Amazon.PowerShell.Cmdlets.APPC
{
    ...
    public partial class RemoveAPPCHostedConfigurationVersionCmdlet : AmazonAppConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APPCHostedConfigurationVersion (DeleteHostedConfigurationVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppConfig.Model.DeleteHostedConfigurationVersionResponse, RemoveAPPCHostedConfigurationVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppConfig.Model.DeleteHostedConfigurationVersionRequest();
        ...
        private Amazon.AppConfig.Model.DeleteHostedConfigurationVersionResponse CallAWSServiceOperation(IAmazonAppConfig client, Amazon.AppConfig.Model.DeleteHostedConfigurationVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppConfig", "DeleteHostedConfigurationVersion");
            try
            {
                #if DESKTOP
                return client.DeleteHostedConfigurationVersion(request);
                #elif CORECLR
                return client.DeleteHostedConfigurationVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ConfigurationProfileId { get; set; }
            public System.Int32? VersionNumber { get; set; }
            public System.Func<Amazon.AppConfig.Model.DeleteHostedConfigurationVersionResponse, RemoveAPPCHostedConfigurationVersionCmdlet, object> Select { get; set; } =
