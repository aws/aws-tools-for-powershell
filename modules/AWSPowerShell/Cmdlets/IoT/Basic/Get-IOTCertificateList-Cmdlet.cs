...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListCertificates API operation.", Operation = new[] {"ListCertificates"}, SelectReturnType = typeof(Amazon.IoT.Model.ListCertificatesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.Certificate or Amazon.IoT.Model.ListCertificatesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.Certificate objects.",
        "The service call response (type Amazon.IoT.Model.ListCertificatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTCertificateListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListCertificatesResponse, GetIOTCertificateListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.IoT.Model.ListCertificatesResponse, GetIOTCertificateListCmdlet, object> Select { get; set; } =
