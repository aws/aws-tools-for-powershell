...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.GetPackageVersionResponse",
        "This cmdlet returns an Amazon.IoT.Model.GetPackageVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTPackageVersionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.GetPackageVersionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetPackageVersionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetPackageVersion(request);
                #elif CORECLR
                return client.GetPackageVersionAsync(request).GetAwaiter().GetResult();
                #else
