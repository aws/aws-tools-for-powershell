...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT AcceptCertificateTransfer API operation.", Operation = new[] {"AcceptCertificateTransfer"}, SelectReturnType = typeof(Amazon.IoT.Model.AcceptCertificateTransferResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.AcceptCertificateTransferResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.AcceptCertificateTransferResponse) be returned by specifying '-Select *'."
    )]
    public partial class ConfirmIOTCertificateTransferCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.AcceptCertificateTransferResponse, ConfirmIOTCertificateTransferCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.AcceptCertificateTransferResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AcceptCertificateTransferRequest request)
        {
            ...
            try
            {
                return client.AcceptCertificateTransferAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CertificateId { get; set; }
            public System.Boolean? SetAsActive { get; set; }
            public System.Func<Amazon.IoT.Model.AcceptCertificateTransferResponse, ConfirmIOTCertificateTransferCmdlet, object> Select { get; set; } =
