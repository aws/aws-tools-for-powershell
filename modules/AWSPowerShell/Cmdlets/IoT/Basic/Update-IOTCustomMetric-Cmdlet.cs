...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.UpdateCustomMetricResponse",
        "This cmdlet returns an Amazon.IoT.Model.UpdateCustomMetricResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTCustomMetricCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.UpdateCustomMetricResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.UpdateCustomMetricRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateCustomMetric(request);
                #elif CORECLR
                return client.UpdateCustomMetricAsync(request).GetAwaiter().GetResult();
                #else
