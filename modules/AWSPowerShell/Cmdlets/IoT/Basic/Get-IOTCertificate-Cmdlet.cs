...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class GetIOTCertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "CertificateDescription";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeCertificateResponse, GetIOTCertificateCmdlet>(Select) ??
        ...
        {
            public System.String CertificateId { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeCertificateResponse, GetIOTCertificateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CertificateDescription;
        }
