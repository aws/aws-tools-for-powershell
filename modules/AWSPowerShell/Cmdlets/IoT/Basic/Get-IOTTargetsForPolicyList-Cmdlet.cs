...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListTargetsForPolicy API operation.", Operation = new[] {"ListTargetsForPolicy"}, SelectReturnType = typeof(Amazon.IoT.Model.ListTargetsForPolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListTargetsForPolicyResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListTargetsForPolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTTargetsForPolicyListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListTargetsForPolicyResponse, GetIOTTargetsForPolicyListCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.ListTargetsForPolicyResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListTargetsForPolicyRequest request)
        {
            ...
            try
            {
                return client.ListTargetsForPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? PageSize { get; set; }
            public System.String PolicyName { get; set; }
            public System.Func<Amazon.IoT.Model.ListTargetsForPolicyResponse, GetIOTTargetsForPolicyListCmdlet, object> Select { get; set; } =
