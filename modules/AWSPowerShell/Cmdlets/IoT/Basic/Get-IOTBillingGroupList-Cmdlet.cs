...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTBillingGroupList")]
    [OutputType("Amazon.IoT.Model.GroupNameAndArn")]
    [AWSCmdlet("Calls the AWS IoT ListBillingGroups API operation.", Operation = new[] {"ListBillingGroups"}, SelectReturnType = typeof(Amazon.IoT.Model.ListBillingGroupsResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.GroupNameAndArn or Amazon.IoT.Model.ListBillingGroupsResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.GroupNameAndArn objects.",
        "The service call response (type Amazon.IoT.Model.ListBillingGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTBillingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^NamePrefixFilter' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListBillingGroupsResponse, GetIOTBillingGroupListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.NamePrefixFilter;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListBillingGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BillingGroups.Count;
        ...
        private Amazon.IoT.Model.ListBillingGroupsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListBillingGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListBillingGroups");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NamePrefixFilter { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.IoT.Model.ListBillingGroupsResponse, GetIOTBillingGroupListCmdlet, object> Select { get; set; } =
