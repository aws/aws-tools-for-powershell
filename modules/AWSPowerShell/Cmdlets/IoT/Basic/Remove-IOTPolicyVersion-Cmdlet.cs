...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeletePolicyVersion API operation.", Operation = new[] {"DeletePolicyVersion"}, SelectReturnType = typeof(Amazon.IoT.Model.DeletePolicyVersionResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeletePolicyVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeletePolicyVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIOTPolicyVersionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.PolicyVersionId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeletePolicyVersionResponse, RemoveIOTPolicyVersionCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.DeletePolicyVersionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeletePolicyVersionRequest request)
        {
            ...
            try
            {
                return client.DeletePolicyVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyName { get; set; }
            public System.String PolicyVersionId { get; set; }
            public System.Func<Amazon.IoT.Model.DeletePolicyVersionResponse, RemoveIOTPolicyVersionCmdlet, object> Select { get; set; } =
