...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Enable", "IOTTopicRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT EnableTopicRule API operation.", Operation = new[] {"EnableTopicRule"}, SelectReturnType = typeof(Amazon.IoT.Model.EnableTopicRuleResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.EnableTopicRuleResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.EnableTopicRuleResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EnableIOTTopicRuleCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-IOTTopicRule (EnableTopicRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.EnableTopicRuleResponse, EnableIOTTopicRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.EnableTopicRuleRequest();
        ...
        private Amazon.IoT.Model.EnableTopicRuleResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.EnableTopicRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "EnableTopicRule");
            try
            {
                #if DESKTOP
                return client.EnableTopicRule(request);
                #elif CORECLR
                return client.EnableTopicRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RuleName { get; set; }
            public System.Func<Amazon.IoT.Model.EnableTopicRuleResponse, EnableIOTTopicRuleCmdlet, object> Select { get; set; } =
