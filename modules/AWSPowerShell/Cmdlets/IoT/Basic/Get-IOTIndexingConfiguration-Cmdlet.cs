...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class GetIOTIndexingConfigurationCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.GetIndexingConfigurationResponse, GetIOTIndexingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.GetIndexingConfigurationRequest();
        ...
        private Amazon.IoT.Model.GetIndexingConfigurationResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetIndexingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "GetIndexingConfiguration");
            try
            {
                #if DESKTOP
                return client.GetIndexingConfiguration(request);
                #elif CORECLR
                return client.GetIndexingConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.IoT.Model.GetIndexingConfigurationResponse, GetIOTIndexingConfigurationCmdlet, object> Select { get; set; } =
