...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTThingGroupList")]
    [OutputType("Amazon.IoT.Model.GroupNameAndArn")]
    [AWSCmdlet("Calls the AWS IoT ListThingGroups API operation.", Operation = new[] {"ListThingGroups"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingGroupsResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.GroupNameAndArn or Amazon.IoT.Model.ListThingGroupsResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.GroupNameAndArn objects.",
        "The service call response (type Amazon.IoT.Model.ListThingGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTThingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThingGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingGroupsResponse, GetIOTThingGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ThingGroups?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListThingGroupsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingGroupsRequest request)
        {
            ...
            try
            {
                return client.ListThingGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ParentGroup { get; set; }
            public System.Boolean? Recursive { get; set; }
            public System.Func<Amazon.IoT.Model.ListThingGroupsResponse, GetIOTThingGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThingGroups;
        }
