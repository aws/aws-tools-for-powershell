...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class GetIOTEffectivePolicyCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EffectivePolicies";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.GetEffectivePoliciesResponse, GetIOTEffectivePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.GetEffectivePoliciesRequest();
        ...
        private Amazon.IoT.Model.GetEffectivePoliciesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetEffectivePoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "GetEffectivePolicies");
            try
            {
                #if DESKTOP
                return client.GetEffectivePolicies(request);
                #elif CORECLR
                return client.GetEffectivePoliciesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Principal { get; set; }
            public System.String ThingName { get; set; }
            public System.Func<Amazon.IoT.Model.GetEffectivePoliciesResponse, GetIOTEffectivePolicyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EffectivePolicies;
        }
