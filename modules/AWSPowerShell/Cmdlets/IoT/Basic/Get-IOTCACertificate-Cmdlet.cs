...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DescribeCACertificate API operation.", Operation = new[] {"DescribeCACertificate"}, SelectReturnType = typeof(Amazon.IoT.Model.DescribeCACertificateResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeCACertificateResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeCACertificateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTCACertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeCACertificateResponse, GetIOTCACertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DescribeCACertificateRequest();
        ...
        private Amazon.IoT.Model.DescribeCACertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeCACertificateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DescribeCACertificate");
            try
            {
                #if DESKTOP
                return client.DescribeCACertificate(request);
                #elif CORECLR
                return client.DescribeCACertificateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CertificateId { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeCACertificateResponse, GetIOTCACertificateCmdlet, object> Select { get; set; } =
