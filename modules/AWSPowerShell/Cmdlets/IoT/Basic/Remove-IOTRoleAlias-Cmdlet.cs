...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeleteRoleAliasResponse",
        ...
        "The service response (type Amazon.IoT.Model.DeleteRoleAliasResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIOTRoleAliasCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RoleAlias' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RoleAlias;
            }
        ...
        private Amazon.IoT.Model.DeleteRoleAliasResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteRoleAliasRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteRoleAlias(request);
                #elif CORECLR
                return client.DeleteRoleAliasAsync(request).GetAwaiter().GetResult();
                #else
