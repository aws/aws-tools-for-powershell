...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeThingResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeThingResponse object containing multiple properties."
    )]
    public partial class GetIOTThingCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.DescribeThingResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeThingRequest request)
        {
            ...
            try
            {
                return client.DescribeThingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
