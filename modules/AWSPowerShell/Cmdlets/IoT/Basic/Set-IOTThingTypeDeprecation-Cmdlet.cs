...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeprecateThingType API operation.", Operation = new[] {"DeprecateThingType"}, SelectReturnType = typeof(Amazon.IoT.Model.DeprecateThingTypeResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeprecateThingTypeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeprecateThingTypeResponse) be returned by specifying '-Select *'."
    )]
    public partial class SetIOTThingTypeDeprecationCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeprecateThingTypeResponse, SetIOTThingTypeDeprecationCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.DeprecateThingTypeResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeprecateThingTypeRequest request)
        {
            ...
            try
            {
                return client.DeprecateThingTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ThingTypeName { get; set; }
            public System.Boolean? UndoDeprecate { get; set; }
            public System.Func<Amazon.IoT.Model.DeprecateThingTypeResponse, SetIOTThingTypeDeprecationCmdlet, object> Select { get; set; } =
