...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTAuditSuppression")]
    [OutputType("Amazon.IoT.Model.DescribeAuditSuppressionResponse")]
    [AWSCmdlet("Calls the AWS IoT DescribeAuditSuppression API operation.", Operation = new[] {"DescribeAuditSuppression"}, SelectReturnType = typeof(Amazon.IoT.Model.DescribeAuditSuppressionResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeAuditSuppressionResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeAuditSuppressionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTAuditSuppressionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoT.Model.DescribeAuditSuppressionResponse).
        /// Specifying the name of a property of type Amazon.IoT.Model.DescribeAuditSuppressionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeAuditSuppressionResponse, GetIOTAuditSuppressionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DescribeAuditSuppressionRequest();
        ...
        private Amazon.IoT.Model.DescribeAuditSuppressionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeAuditSuppressionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DescribeAuditSuppression");
            try
            {
                #if DESKTOP
                return client.DescribeAuditSuppression(request);
                #elif CORECLR
                return client.DescribeAuditSuppressionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PolicyVersionIdentifier_PolicyVersionId { get; set; }
            public System.String ResourceIdentifier_RoleAliasArn { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeAuditSuppressionResponse, GetIOTAuditSuppressionCmdlet, object> Select { get; set; } =
