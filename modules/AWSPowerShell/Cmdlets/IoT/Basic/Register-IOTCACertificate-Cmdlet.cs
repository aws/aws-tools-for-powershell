...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class RegisterIOTCACertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A boolean value that specifies if the CA certificate is set to active.</para><para>Valid values: <c>ACTIVE | INACTIVE</c></para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The private key verification certificate. If <c>certificateMode</c> is <c>SNI_ONLY</c>,
        ...
        private Amazon.IoT.Model.RegisterCACertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.RegisterCACertificateRequest request)
        {
            ...
            try
            {
                return client.RegisterCACertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
