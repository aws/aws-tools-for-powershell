...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTThingsInThingGroupList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS IoT ListThingsInThingGroup API operation.", Operation = new[] {"ListThingsInThingGroup"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingsInThingGroupResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListThingsInThingGroupResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListThingsInThingGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTThingsInThingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingsInThingGroupResponse, GetIOTThingsInThingGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListThingsInThingGroupRequest();
        ...
        private Amazon.IoT.Model.ListThingsInThingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingsInThingGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListThingsInThingGroup");
            try
            {
                #if DESKTOP
                return client.ListThingsInThingGroup(request);
                #elif CORECLR
                return client.ListThingsInThingGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? Recursive { get; set; }
            public System.String ThingGroupName { get; set; }
            public System.Func<Amazon.IoT.Model.ListThingsInThingGroupResponse, GetIOTThingsInThingGroupListCmdlet, object> Select { get; set; } =
