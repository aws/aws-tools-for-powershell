...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListPrincipalThings API operation.", Operation = new[] {"ListPrincipalThings"}, SelectReturnType = typeof(Amazon.IoT.Model.ListPrincipalThingsResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListPrincipalThingsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListPrincipalThingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTPrincipalThingListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListPrincipalThingsResponse, GetIOTPrincipalThingListCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.ListPrincipalThingsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListPrincipalThingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListPrincipalThings");
            try
            {
                return client.ListPrincipalThingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String Principal { get; set; }
            public System.Func<Amazon.IoT.Model.ListPrincipalThingsResponse, GetIOTPrincipalThingListCmdlet, object> Select { get; set; } =
