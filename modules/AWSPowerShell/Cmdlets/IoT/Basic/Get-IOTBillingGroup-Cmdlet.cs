...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTBillingGroup")]
    [OutputType("Amazon.IoT.Model.DescribeBillingGroupResponse")]
    [AWSCmdlet("Calls the AWS IoT DescribeBillingGroup API operation.", Operation = new[] {"DescribeBillingGroup"}, SelectReturnType = typeof(Amazon.IoT.Model.DescribeBillingGroupResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeBillingGroupResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeBillingGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTBillingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeBillingGroupResponse, GetIOTBillingGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DescribeBillingGroupRequest();
        ...
        private Amazon.IoT.Model.DescribeBillingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeBillingGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DescribeBillingGroup");
            try
            {
                #if DESKTOP
                return client.DescribeBillingGroup(request);
                #elif CORECLR
                return client.DescribeBillingGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String BillingGroupName { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeBillingGroupResponse, GetIOTBillingGroupCmdlet, object> Select { get; set; } =
