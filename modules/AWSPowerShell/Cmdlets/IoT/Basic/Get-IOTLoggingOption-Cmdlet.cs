...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.GetLoggingOptionsResponse",
        "This cmdlet returns an Amazon.IoT.Model.GetLoggingOptionsResponse object containing multiple properties."
    )]
    public partial class GetIOTLoggingOptionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.GetLoggingOptionsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetLoggingOptionsRequest request)
        {
            ...
            try
            {
                return client.GetLoggingOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
