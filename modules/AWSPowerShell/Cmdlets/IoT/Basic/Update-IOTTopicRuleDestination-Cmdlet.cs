...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("None or Amazon.IoT.Model.UpdateTopicRuleDestinationResponse",
        ...
        "The service response (type Amazon.IoT.Model.UpdateTopicRuleDestinationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
