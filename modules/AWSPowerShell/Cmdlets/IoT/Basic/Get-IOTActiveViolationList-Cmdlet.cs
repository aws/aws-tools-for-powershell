...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListActiveViolations API operation.", Operation = new[] {"ListActiveViolations"}, SelectReturnType = typeof(Amazon.IoT.Model.ListActiveViolationsResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.ActiveViolation or Amazon.IoT.Model.ListActiveViolationsResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.ActiveViolation objects.",
        "The service call response (type Amazon.IoT.Model.ListActiveViolationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTActiveViolationListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ActiveViolations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListActiveViolationsResponse, GetIOTActiveViolationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ActiveViolations?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListActiveViolationsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListActiveViolationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListActiveViolations");
            try
            {
                return client.ListActiveViolationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
