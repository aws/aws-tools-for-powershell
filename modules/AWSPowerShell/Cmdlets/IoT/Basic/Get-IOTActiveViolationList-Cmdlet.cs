...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.ActiveViolation or Amazon.IoT.Model.ListActiveViolationsResponse",
        ...
        "The service call response (type Amazon.IoT.Model.ListActiveViolationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
