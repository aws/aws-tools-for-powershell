...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "IOTSbomValidationResultList")]
    [OutputType("Amazon.IoT.Model.SbomValidationResultSummary")]
    ...
    public partial class GetIOTSbomValidationResultListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        #region Parameter ValidationResult
        /// <summary>
        /// <para>
        /// <para>The end result of the </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.IoT.SbomValidationResult")]
        public Amazon.IoT.SbomValidationResult ValidationResult { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>A token that can be used to retrieve the next set of results, or null if there are
        /// no additional results.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ValidationResultSummaries'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoT.Model.ListSbomValidationResultsResponse).
        /// Specifying the name of a property of type Amazon.IoT.Model.ListSbomValidationResultsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ValidationResultSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListSbomValidationResultsResponse, GetIOTSbomValidationResultListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.ListSbomValidationResultsRequest();
            ...
            if (cmdletContext.ValidationResult != null)
            {
                request.ValidationResult = cmdletContext.ValidationResult;
            }
        ...
        private Amazon.IoT.Model.ListSbomValidationResultsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListSbomValidationResultsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListSbomValidationResults");
            try
            {
                #if DESKTOP
                return client.ListSbomValidationResults(request);
                #elif CORECLR
                return client.ListSbomValidationResultsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoT.SbomValidationResult ValidationResult { get; set; }
            public System.String VersionName { get; set; }
            public System.Func<Amazon.IoT.Model.ListSbomValidationResultsResponse, GetIOTSbomValidationResultListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ValidationResultSummaries;
        }
