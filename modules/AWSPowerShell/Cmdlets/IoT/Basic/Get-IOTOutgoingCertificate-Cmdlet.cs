...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTOutgoingCertificate")]
    [OutputType("Amazon.IoT.Model.OutgoingCertificate")]
    ...
    public partial class GetIOTOutgoingCertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OutgoingCertificates";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListOutgoingCertificatesResponse, GetIOTOutgoingCertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListOutgoingCertificatesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OutgoingCertificates?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListOutgoingCertificatesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListOutgoingCertificatesRequest request)
        {
            ...
            try
            {
                return client.ListOutgoingCertificatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.IoT.Model.ListOutgoingCertificatesResponse, GetIOTOutgoingCertificateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OutgoingCertificates;
        }
