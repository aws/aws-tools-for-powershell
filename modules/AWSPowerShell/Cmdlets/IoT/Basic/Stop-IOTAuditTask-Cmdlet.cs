...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT CancelAuditTask API operation.", Operation = new[] {"CancelAuditTask"}, SelectReturnType = typeof(Amazon.IoT.Model.CancelAuditTaskResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.CancelAuditTaskResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.CancelAuditTaskResponse) be returned by specifying '-Select *'."
    )]
    public partial class StopIOTAuditTaskCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.CancelAuditTaskResponse, StopIOTAuditTaskCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.CancelAuditTaskResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.CancelAuditTaskRequest request)
        {
            ...
            try
            {
                return client.CancelAuditTaskAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String TaskId { get; set; }
            public System.Func<Amazon.IoT.Model.CancelAuditTaskResponse, StopIOTAuditTaskCmdlet, object> Select { get; set; } =
