...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class AddIOTPrincipalPolicyCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.AttachPrincipalPolicyResponse, AddIOTPrincipalPolicyCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.AttachPrincipalPolicyResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AttachPrincipalPolicyRequest request)
        {
            ...
            try
            {
                return client.AttachPrincipalPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyName { get; set; }
            public System.String Principal { get; set; }
            public System.Func<Amazon.IoT.Model.AttachPrincipalPolicyResponse, AddIOTPrincipalPolicyCmdlet, object> Select { get; set; } =
