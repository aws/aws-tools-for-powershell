...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTAuthorizerList")]
    [OutputType("Amazon.IoT.Model.AuthorizerSummary")]
    [AWSCmdlet("Calls the AWS IoT ListAuthorizers API operation.", Operation = new[] {"ListAuthorizers"}, SelectReturnType = typeof(Amazon.IoT.Model.ListAuthorizersResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.AuthorizerSummary or Amazon.IoT.Model.ListAuthorizersResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.AuthorizerSummary objects.",
        "The service call response (type Amazon.IoT.Model.ListAuthorizersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTAuthorizerListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Authorizers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListAuthorizersResponse, GetIOTAuthorizerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Authorizers?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListAuthorizersResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListAuthorizersRequest request)
        {
            ...
            try
            {
                return client.ListAuthorizersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? PageSize { get; set; }
            public Amazon.IoT.AuthorizerStatus Status { get; set; }
            public System.Func<Amazon.IoT.Model.ListAuthorizersResponse, GetIOTAuthorizerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Authorizers;
        }
