...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class GetIOTAuthorizerCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeAuthorizerResponse, GetIOTAuthorizerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DescribeAuthorizerRequest();
        ...
        private Amazon.IoT.Model.DescribeAuthorizerResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeAuthorizerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DescribeAuthorizer");
            try
            {
                #if DESKTOP
                return client.DescribeAuthorizer(request);
                #elif CORECLR
                return client.DescribeAuthorizerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AuthorizerName { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeAuthorizerResponse, GetIOTAuthorizerCmdlet, object> Select { get; set; } =
