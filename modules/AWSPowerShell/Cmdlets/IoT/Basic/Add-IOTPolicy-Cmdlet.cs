...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "IOTPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT AttachPolicy API operation.", Operation = new[] {"AttachPolicy"}, SelectReturnType = typeof(Amazon.IoT.Model.AttachPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.AttachPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.AttachPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIOTPolicyCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IOTPolicy (AttachPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.AttachPolicyResponse, AddIOTPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.AttachPolicyRequest();
        ...
        private Amazon.IoT.Model.AttachPolicyResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AttachPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "AttachPolicy");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyName { get; set; }
            public System.String Target { get; set; }
            public System.Func<Amazon.IoT.Model.AttachPolicyResponse, AddIOTPolicyCmdlet, object> Select { get; set; } =
