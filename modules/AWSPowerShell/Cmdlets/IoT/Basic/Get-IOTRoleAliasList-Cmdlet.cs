...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListRoleAliases API operation.", Operation = new[] {"ListRoleAliases"}, SelectReturnType = typeof(Amazon.IoT.Model.ListRoleAliasesResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListRoleAliasesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListRoleAliasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTRoleAliasListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RoleAliases";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListRoleAliasesResponse, GetIOTRoleAliasListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RoleAliases?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListRoleAliasesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListRoleAliasesRequest request)
        {
            ...
            try
            {
                return client.ListRoleAliasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.IoT.Model.ListRoleAliasesResponse, GetIOTRoleAliasListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RoleAliases;
        }
