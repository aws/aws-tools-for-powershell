...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListThingTypes API operation.", Operation = new[] {"ListThingTypes"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingTypesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.ThingTypeDefinition or Amazon.IoT.Model.ListThingTypesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.ThingTypeDefinition objects.",
        "The service call response (type Amazon.IoT.Model.ListThingTypesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTThingTypeListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThingTypes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingTypesResponse, GetIOTThingTypeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ThingTypes?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListThingTypesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingTypesRequest request)
        {
            ...
            try
            {
                return client.ListThingTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ThingTypeName { get; set; }
            public System.Func<Amazon.IoT.Model.ListThingTypesResponse, GetIOTThingTypeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThingTypes;
        }
