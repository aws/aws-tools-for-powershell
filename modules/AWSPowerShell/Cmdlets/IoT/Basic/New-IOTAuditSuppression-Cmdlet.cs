...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT CreateAuditSuppression API operation.", Operation = new[] {"CreateAuditSuppression"}, SelectReturnType = typeof(Amazon.IoT.Model.CreateAuditSuppressionResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.CreateAuditSuppressionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.CreateAuditSuppressionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIOTAuditSuppressionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoT.Model.CreateAuditSuppressionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IOTAuditSuppression (CreateAuditSuppression)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.CreateAuditSuppressionResponse, NewIOTAuditSuppressionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.CreateAuditSuppressionRequest();
        ...
        private Amazon.IoT.Model.CreateAuditSuppressionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.CreateAuditSuppressionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "CreateAuditSuppression");
            try
            {
                #if DESKTOP
                return client.CreateAuditSuppression(request);
                #elif CORECLR
                return client.CreateAuditSuppressionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceIdentifier_RoleAliasArn { get; set; }
            public System.Boolean? SuppressIndefinitely { get; set; }
            public System.Func<Amazon.IoT.Model.CreateAuditSuppressionResponse, NewIOTAuditSuppressionCmdlet, object> Select { get; set; } =
