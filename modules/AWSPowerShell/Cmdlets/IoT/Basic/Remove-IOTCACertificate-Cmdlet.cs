...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeleteCACertificate API operation.", Operation = new[] {"DeleteCACertificate"}, SelectReturnType = typeof(Amazon.IoT.Model.DeleteCACertificateResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeleteCACertificateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeleteCACertificateResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIOTCACertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteCACertificateResponse, RemoveIOTCACertificateCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.DeleteCACertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteCACertificateRequest request)
        {
            ...
            try
            {
                return client.DeleteCACertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String CertificateId { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteCACertificateResponse, RemoveIOTCACertificateCmdlet, object> Select { get; set; } =
