...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IOTTopicRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeleteTopicRule API operation.", Operation = new[] {"DeleteTopicRule"}, SelectReturnType = typeof(Amazon.IoT.Model.DeleteTopicRuleResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeleteTopicRuleResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeleteTopicRuleResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIOTTopicRuleCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTopicRule (DeleteTopicRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteTopicRuleResponse, RemoveIOTTopicRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeleteTopicRuleRequest();
        ...
        private Amazon.IoT.Model.DeleteTopicRuleResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteTopicRuleRequest request)
        {
            ...
            try
            {
                return client.DeleteTopicRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String RuleName { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteTopicRuleResponse, RemoveIOTTopicRuleCmdlet, object> Select { get; set; } =
