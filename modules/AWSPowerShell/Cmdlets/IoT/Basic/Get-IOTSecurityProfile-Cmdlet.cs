...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DescribeSecurityProfile API operation.", Operation = new[] {"DescribeSecurityProfile"}, SelectReturnType = typeof(Amazon.IoT.Model.DescribeSecurityProfileResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeSecurityProfileResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeSecurityProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSecurityProfileCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeSecurityProfileResponse, GetIOTSecurityProfileCmdlet>(Select) ??
        ...
        {
            public System.String SecurityProfileName { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeSecurityProfileResponse, GetIOTSecurityProfileCmdlet, object> Select { get; set; } =
