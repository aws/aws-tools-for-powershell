...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListOTAUpdates API operation.", Operation = new[] {"ListOTAUpdates"}, SelectReturnType = typeof(Amazon.IoT.Model.ListOTAUpdatesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.OTAUpdateSummary or Amazon.IoT.Model.ListOTAUpdatesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.OTAUpdateSummary objects.",
        "The service call response (type Amazon.IoT.Model.ListOTAUpdatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTOTAUpdateListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OtaUpdates";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListOTAUpdatesResponse, GetIOTOTAUpdateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OtaUpdates?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListOTAUpdatesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListOTAUpdatesRequest request)
        {
            ...
            try
            {
                return client.ListOTAUpdatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.IoT.OTAUpdateStatus OtaUpdateStatus { get; set; }
            public System.Func<Amazon.IoT.Model.ListOTAUpdatesResponse, GetIOTOTAUpdateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OtaUpdates;
        }
