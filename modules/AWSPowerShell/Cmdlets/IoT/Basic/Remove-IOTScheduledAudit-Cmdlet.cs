...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IOTScheduledAudit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTScheduledAuditCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ScheduledAuditName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTScheduledAudit (DeleteScheduledAudit)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteScheduledAuditResponse, RemoveIOTScheduledAuditCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ScheduledAuditName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeleteScheduledAuditRequest();
        ...
        private Amazon.IoT.Model.DeleteScheduledAuditResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteScheduledAuditRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DeleteScheduledAudit");
            try
            {
                #if DESKTOP
                return client.DeleteScheduledAudit(request);
                #elif CORECLR
                return client.DeleteScheduledAuditAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ScheduledAuditName { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteScheduledAuditResponse, RemoveIOTScheduledAuditCmdlet, object> Select { get; set; } =
