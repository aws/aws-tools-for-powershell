...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class AddIOTResourceTagCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IOTResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.TagResourceResponse, AddIOTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.TagResourceRequest();
        ...
        private Amazon.IoT.Model.TagResourceResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoT.Model.TagResourceResponse, AddIOTResourceTagCmdlet, object> Select { get; set; } =
