...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT GetTopicRule API operation.", Operation = new[] {"GetTopicRule"}, SelectReturnType = typeof(Amazon.IoT.Model.GetTopicRuleResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.GetTopicRuleResponse",
        "This cmdlet returns an Amazon.IoT.Model.GetTopicRuleResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTTopicRuleCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.GetTopicRuleResponse, GetIOTTopicRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.GetTopicRuleRequest();
        ...
        private Amazon.IoT.Model.GetTopicRuleResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetTopicRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "GetTopicRule");
            try
            {
                #if DESKTOP
                return client.GetTopicRule(request);
                #elif CORECLR
                return client.GetTopicRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RuleName { get; set; }
            public System.Func<Amazon.IoT.Model.GetTopicRuleResponse, GetIOTTopicRuleCmdlet, object> Select { get; set; } =
