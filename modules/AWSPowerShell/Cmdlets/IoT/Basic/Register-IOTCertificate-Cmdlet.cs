...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.RegisterCertificateResponse",
        "This cmdlet returns an Amazon.IoT.Model.RegisterCertificateResponse object containing multiple properties."
    )]
    public partial class RegisterIOTCertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// <c>ACTIVE</c>, <c>INACTIVE</c>, and <c>REVOKED</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A boolean value that specifies if the certificate is set to active.</para><para>Valid values: <c>ACTIVE | INACTIVE</c></para>
        /// </para>
        ...
        private Amazon.IoT.Model.RegisterCertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.RegisterCertificateRequest request)
        {
            ...
            try
            {
                return client.RegisterCertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
