...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IOTThingGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeleteThingGroup API operation.", Operation = new[] {"DeleteThingGroup"}, SelectReturnType = typeof(Amazon.IoT.Model.DeleteThingGroupResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeleteThingGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeleteThingGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIOTThingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTThingGroup (DeleteThingGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteThingGroupResponse, RemoveIOTThingGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeleteThingGroupRequest();
        ...
        private Amazon.IoT.Model.DeleteThingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteThingGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DeleteThingGroup");
            try
            {
                #if DESKTOP
                return client.DeleteThingGroup(request);
                #elif CORECLR
                return client.DeleteThingGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int64? ExpectedVersion { get; set; }
            public System.String ThingGroupName { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteThingGroupResponse, RemoveIOTThingGroupCmdlet, object> Select { get; set; } =
