...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "IOTThingType")]
    [OutputType("Amazon.IoT.Model.DescribeThingTypeResponse")]
    [AWSCmdlet("Calls the AWS IoT DescribeThingType API operation.", Operation = new[] {"DescribeThingType"}, SelectReturnType = typeof(Amazon.IoT.Model.DescribeThingTypeResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.DescribeThingTypeResponse",
        "This cmdlet returns an Amazon.IoT.Model.DescribeThingTypeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTThingTypeCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DescribeThingTypeResponse, GetIOTThingTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DescribeThingTypeRequest();
        ...
        private Amazon.IoT.Model.DescribeThingTypeResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeThingTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DescribeThingType");
            try
            {
                #if DESKTOP
                return client.DescribeThingType(request);
                #elif CORECLR
                return client.DescribeThingTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ThingTypeName { get; set; }
            public System.Func<Amazon.IoT.Model.DescribeThingTypeResponse, GetIOTThingTypeCmdlet, object> Select { get; set; } =
