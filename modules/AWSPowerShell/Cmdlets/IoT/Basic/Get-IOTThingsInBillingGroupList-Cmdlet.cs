...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTThingsInBillingGroupList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS IoT ListThingsInBillingGroup API operation.", Operation = new[] {"ListThingsInBillingGroup"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingsInBillingGroupResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListThingsInBillingGroupResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListThingsInBillingGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTThingsInBillingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingsInBillingGroupResponse, GetIOTThingsInBillingGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListThingsInBillingGroupRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Things?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListThingsInBillingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingsInBillingGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListThingsInBillingGroup");
            try
            {
                #if DESKTOP
                return client.ListThingsInBillingGroup(request);
                #elif CORECLR
                return client.ListThingsInBillingGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.IoT.Model.ListThingsInBillingGroupResponse, GetIOTThingsInBillingGroupListCmdlet, object> Select { get; set; } =
