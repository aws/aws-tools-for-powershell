...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListThings API operation.", Operation = new[] {"ListThings"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingsResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.ThingAttribute or Amazon.IoT.Model.ListThingsResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.ThingAttribute objects.",
        "The service call response (type Amazon.IoT.Model.ListThingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTThingListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingsResponse, GetIOTThingListCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.ListThingsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingsRequest request)
        {
            ...
            try
            {
                return client.ListThingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
