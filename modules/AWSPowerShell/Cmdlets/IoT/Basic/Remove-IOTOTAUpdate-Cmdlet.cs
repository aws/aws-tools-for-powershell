...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeleteOTAUpdateResponse",
        ...
        "The service response (type Amazon.IoT.Model.DeleteOTAUpdateResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIOTOTAUpdateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>When true, the stream created by the OTAUpdate process is deleted when the OTA update
        /// is deleted. Ignored if the stream specified in the OTAUpdate is supplied by the user.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.IoT.Model.DeleteOTAUpdateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteOTAUpdateRequest request)
        {
            ...
            try
            {
                return client.DeleteOTAUpdateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
