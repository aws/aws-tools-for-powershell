...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT DeletePackageVersion API operation.", Operation = new[] {"DeletePackageVersion"}, SelectReturnType = typeof(Amazon.IoT.Model.DeletePackageVersionResponse))]
    [AWSCmdletOutput("None or Amazon.IoT.Model.DeletePackageVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoT.Model.DeletePackageVersionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIOTPackageVersionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoT.Model.DeletePackageVersionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTPackageVersion (DeletePackageVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeletePackageVersionResponse, RemoveIOTPackageVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeletePackageVersionRequest();
        ...
        private Amazon.IoT.Model.DeletePackageVersionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeletePackageVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DeletePackageVersion");
            try
            {
                #if DESKTOP
                return client.DeletePackageVersion(request);
                #elif CORECLR
                return client.DeletePackageVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PackageName { get; set; }
            public System.String VersionName { get; set; }
            public System.Func<Amazon.IoT.Model.DeletePackageVersionResponse, RemoveIOTPackageVersionCmdlet, object> Select { get; set; } =
