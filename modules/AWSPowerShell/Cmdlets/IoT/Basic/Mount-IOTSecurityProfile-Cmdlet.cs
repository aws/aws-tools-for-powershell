...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Mount", "IOTSecurityProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class MountIOTSecurityProfileCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Mount-IOTSecurityProfile (AttachSecurityProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.AttachSecurityProfileResponse, MountIOTSecurityProfileCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.SecurityProfileTargetArn == null && ParameterWasBound(nameof(this.SecurityProfileTargetArn)))
            {
                WriteWarning("You are passing $null as a value for parameter SecurityProfileTargetArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.AttachSecurityProfileRequest();
        ...
        private Amazon.IoT.Model.AttachSecurityProfileResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AttachSecurityProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "AttachSecurityProfile");
            try
            {
                #if DESKTOP
                return client.AttachSecurityProfile(request);
                #elif CORECLR
                return client.AttachSecurityProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SecurityProfileName { get; set; }
            public System.String SecurityProfileTargetArn { get; set; }
            public System.Func<Amazon.IoT.Model.AttachSecurityProfileResponse, MountIOTSecurityProfileCmdlet, object> Select { get; set; } =
