...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTThingRegistrationTaskReportList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS IoT ListThingRegistrationTaskReports API operation.", Operation = new[] {"ListThingRegistrationTaskReports"}, SelectReturnType = typeof(Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse))]
    [AWSCmdletOutput("System.String or Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTThingRegistrationTaskReportListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResourceLinks";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse, GetIOTThingRegistrationTaskReportListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ResourceLinks?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingRegistrationTaskReportsRequest request)
        {
            ...
            try
            {
                return client.ListThingRegistrationTaskReportsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoT.ReportType ReportType { get; set; }
            public System.String TaskId { get; set; }
            public System.Func<Amazon.IoT.Model.ListThingRegistrationTaskReportsResponse, GetIOTThingRegistrationTaskReportListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResourceLinks;
        }
