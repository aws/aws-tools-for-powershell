...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListSecurityProfiles API operation.", Operation = new[] {"ListSecurityProfiles"}, SelectReturnType = typeof(Amazon.IoT.Model.ListSecurityProfilesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.SecurityProfileIdentifier or Amazon.IoT.Model.ListSecurityProfilesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.SecurityProfileIdentifier objects.",
        "The service call response (type Amazon.IoT.Model.ListSecurityProfilesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTSecurityProfileListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SecurityProfileIdentifiers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListSecurityProfilesResponse, GetIOTSecurityProfileListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListSecurityProfilesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.SecurityProfileIdentifiers?.Count ?? 0;
        ...
        private Amazon.IoT.Model.ListSecurityProfilesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListSecurityProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListSecurityProfiles");
            try
            {
                return client.ListSecurityProfilesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
