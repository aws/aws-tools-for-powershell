...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IOTMitigationAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTMitigationActionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTMitigationAction (DeleteMitigationAction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteMitigationActionResponse, RemoveIOTMitigationActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeleteMitigationActionRequest();
        ...
        private Amazon.IoT.Model.DeleteMitigationActionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteMitigationActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DeleteMitigationAction");
            try
            {
                #if DESKTOP
                return client.DeleteMitigationAction(request);
                #elif CORECLR
                return client.DeleteMitigationActionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ActionName { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteMitigationActionResponse, RemoveIOTMitigationActionCmdlet, object> Select { get; set; } =
