...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListJobExecutionsForThing API operation.", Operation = new[] {"ListJobExecutionsForThing"}, SelectReturnType = typeof(Amazon.IoT.Model.ListJobExecutionsForThingResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.JobExecutionSummaryForThing or Amazon.IoT.Model.ListJobExecutionsForThingResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.JobExecutionSummaryForThing objects.",
        "The service call response (type Amazon.IoT.Model.ListJobExecutionsForThingResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTJobExecutionsForThingListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListJobExecutionsForThingResponse, GetIOTJobExecutionsForThingListCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.ListJobExecutionsForThingResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListJobExecutionsForThingRequest request)
        {
            ...
            try
            {
                return client.ListJobExecutionsForThingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoT.JobExecutionStatus Status { get; set; }
            public System.String ThingName { get; set; }
            public System.Func<Amazon.IoT.Model.ListJobExecutionsForThingResponse, GetIOTJobExecutionsForThingListCmdlet, object> Select { get; set; } =
