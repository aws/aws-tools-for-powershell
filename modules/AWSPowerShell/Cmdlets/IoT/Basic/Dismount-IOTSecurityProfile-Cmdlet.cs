...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class DismountIOTSecurityProfileCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DetachSecurityProfileResponse, DismountIOTSecurityProfileCmdlet>(Select) ??
        ...
        private Amazon.IoT.Model.DetachSecurityProfileResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DetachSecurityProfileRequest request)
        {
            ...
            try
            {
                return client.DetachSecurityProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SecurityProfileName { get; set; }
            public System.String SecurityProfileTargetArn { get; set; }
            public System.Func<Amazon.IoT.Model.DetachSecurityProfileResponse, DismountIOTSecurityProfileCmdlet, object> Select { get; set; } =
