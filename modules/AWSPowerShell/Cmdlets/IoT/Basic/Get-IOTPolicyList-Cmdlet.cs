...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListPolicies API operation.", Operation = new[] {"ListPolicies"}, SelectReturnType = typeof(Amazon.IoT.Model.ListPoliciesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.Policy or Amazon.IoT.Model.ListPoliciesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.Policy objects.",
        "The service call response (type Amazon.IoT.Model.ListPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTPolicyListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListPoliciesResponse, GetIOTPolicyListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.IoT.Model.ListPoliciesResponse, GetIOTPolicyListCmdlet, object> Select { get; set; } =
