...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IOTSecurityProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTSecurityProfileCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTSecurityProfile (DeleteSecurityProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.DeleteSecurityProfileResponse, RemoveIOTSecurityProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.DeleteSecurityProfileRequest();
        ...
        private Amazon.IoT.Model.DeleteSecurityProfileResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteSecurityProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "DeleteSecurityProfile");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int64? ExpectedVersion { get; set; }
            public System.String SecurityProfileName { get; set; }
            public System.Func<Amazon.IoT.Model.DeleteSecurityProfileResponse, RemoveIOTSecurityProfileCmdlet, object> Select { get; set; } =
