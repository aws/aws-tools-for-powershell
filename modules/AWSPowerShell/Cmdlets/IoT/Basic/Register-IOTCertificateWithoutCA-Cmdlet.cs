...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.RegisterCertificateWithoutCAResponse",
        "This cmdlet returns an Amazon.IoT.Model.RegisterCertificateWithoutCAResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterIOTCertificateWithoutCACmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CertificatePem' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CertificatePem;
            }
        ...
        private Amazon.IoT.Model.RegisterCertificateWithoutCAResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.RegisterCertificateWithoutCARequest request)
        {
            ...
            {
                #if DESKTOP
                return client.RegisterCertificateWithoutCA(request);
                #elif CORECLR
                return client.RegisterCertificateWithoutCAAsync(request).GetAwaiter().GetResult();
                #else
