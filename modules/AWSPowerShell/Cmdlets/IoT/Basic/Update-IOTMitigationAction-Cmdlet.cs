...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "IOTMitigationAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoT.Model.UpdateMitigationActionResponse")]
    [AWSCmdlet("Calls the AWS IoT UpdateMitigationAction API operation.", Operation = new[] {"UpdateMitigationAction"}, SelectReturnType = typeof(Amazon.IoT.Model.UpdateMitigationActionResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.UpdateMitigationActionResponse",
        "This cmdlet returns an Amazon.IoT.Model.UpdateMitigationActionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTMitigationActionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The friendly name for the mitigation action. You cannot change the name by using <c>UpdateMitigationAction</c>.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTMitigationAction (UpdateMitigationAction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.UpdateMitigationActionResponse, UpdateIOTMitigationActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.UpdateMitigationActionRequest();
        ...
        private Amazon.IoT.Model.UpdateMitigationActionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.UpdateMitigationActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "UpdateMitigationAction");
            try
            {
                #if DESKTOP
                return client.UpdateMitigationAction(request);
                #elif CORECLR
                return client.UpdateMitigationActionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoT.DeviceCertificateUpdateAction UpdateDeviceCertificateParams_Action { get; set; }
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.IoT.Model.UpdateMitigationActionResponse, UpdateIOTMitigationActionCmdlet, object> Select { get; set; } =
