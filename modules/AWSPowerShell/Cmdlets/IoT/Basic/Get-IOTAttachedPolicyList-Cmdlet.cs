...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTAttachedPolicyList")]
    [OutputType("Amazon.IoT.Model.Policy")]
    [AWSCmdlet("Calls the AWS IoT ListAttachedPolicies API operation.", Operation = new[] {"ListAttachedPolicies"}, SelectReturnType = typeof(Amazon.IoT.Model.ListAttachedPoliciesResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.Policy or Amazon.IoT.Model.ListAttachedPoliciesResponse",
        "This cmdlet returns a collection of Amazon.IoT.Model.Policy objects.",
        "The service call response (type Amazon.IoT.Model.ListAttachedPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTAttachedPolicyListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.ListAttachedPoliciesResponse, GetIOTAttachedPolicyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoT.Model.ListAttachedPoliciesRequest();
        ...
        private Amazon.IoT.Model.ListAttachedPoliciesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListAttachedPoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListAttachedPolicies");
            try
            {
                return client.ListAttachedPoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? Recursive { get; set; }
            public System.String Target { get; set; }
            public System.Func<Amazon.IoT.Model.ListAttachedPoliciesResponse, GetIOTAttachedPolicyListCmdlet, object> Select { get; set; } =
