...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("Amazon.IoT.Model.Policy or Amazon.IoT.Model.ListAttachedPoliciesResponse",
        ...
        "The service call response (type Amazon.IoT.Model.ListAttachedPoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
