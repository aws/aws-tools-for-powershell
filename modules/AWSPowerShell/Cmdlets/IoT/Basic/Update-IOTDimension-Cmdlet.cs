...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT UpdateDimension API operation.", Operation = new[] {"UpdateDimension"}, SelectReturnType = typeof(Amazon.IoT.Model.UpdateDimensionResponse))]
    [AWSCmdletOutput("Amazon.IoT.Model.UpdateDimensionResponse",
        "This cmdlet returns an Amazon.IoT.Model.UpdateDimensionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTDimensionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTDimension (UpdateDimension)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoT.Model.UpdateDimensionResponse, UpdateIOTDimensionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoT.Model.UpdateDimensionRequest();
        ...
        private Amazon.IoT.Model.UpdateDimensionResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.UpdateDimensionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "UpdateDimension");
            try
            {
                #if DESKTOP
                return client.UpdateDimension(request);
                #elif CORECLR
                return client.UpdateDimensionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoT.Model.UpdateDimensionResponse, UpdateIOTDimensionCmdlet, object> Select { get; set; } =
