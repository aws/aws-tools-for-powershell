...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Calls the AWS Directory Service ListIpRoutes API operation.", Operation = new[] {"ListIpRoutes"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.ListIpRoutesResponse), LegacyAlias="Get-DSIpRoutes")]
    [AWSCmdletOutput("Amazon.DirectoryService.Model.IpRouteInfo or Amazon.DirectoryService.Model.ListIpRoutesResponse",
        "This cmdlet returns a collection of Amazon.DirectoryService.Model.IpRouteInfo objects.",
        "The service call response (type Amazon.DirectoryService.Model.ListIpRoutesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSIpRouteListCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IpRoutesInfo";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.ListIpRoutesResponse, GetDSIpRouteListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.IpRoutesInfo?.Count ?? 0;
        ...
        private Amazon.DirectoryService.Model.ListIpRoutesResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.ListIpRoutesRequest request)
        {
            ...
            try
            {
                return client.ListIpRoutesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DirectoryService.Model.ListIpRoutesResponse, GetDSIpRouteListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IpRoutesInfo;
        }
