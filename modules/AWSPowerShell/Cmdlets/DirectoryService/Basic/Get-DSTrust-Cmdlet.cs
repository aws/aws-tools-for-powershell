...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Calls the AWS Directory Service DescribeTrusts API operation.", Operation = new[] {"DescribeTrusts"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DescribeTrustsResponse))]
    [AWSCmdletOutput("Amazon.DirectoryService.Model.Trust or Amazon.DirectoryService.Model.DescribeTrustsResponse",
        "This cmdlet returns a collection of Amazon.DirectoryService.Model.Trust objects.",
        "The service call response (type Amazon.DirectoryService.Model.DescribeTrustsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSTrustCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// are returned.</para><para>An empty list results in an <c>InvalidParameterException</c> being thrown.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Trusts";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DescribeTrustsResponse, GetDSTrustCmdlet>(Select) ??
            ...
            {
                context.TrustId = new List<System.String>(this.TrustId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.TrustIds = cmdletContext.TrustId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Trusts?.Count ?? 0;
        ...
        private Amazon.DirectoryService.Model.DescribeTrustsResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DescribeTrustsRequest request)
        {
            ...
            try
            {
                return client.DescribeTrustsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> TrustId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DescribeTrustsResponse, GetDSTrustCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Trusts;
        }
