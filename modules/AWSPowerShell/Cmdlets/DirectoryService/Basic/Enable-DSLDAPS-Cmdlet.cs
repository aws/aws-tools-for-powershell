...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdletOutput("None or Amazon.DirectoryService.Model.EnableLDAPSResponse",
        ...
        "The service response (type Amazon.DirectoryService.Model.EnableLDAPSResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EnableDSLDAPSCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of LDAP security the customer wants to enable. The security can be either
