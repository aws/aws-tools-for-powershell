...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    /// API.
    /// </summary>
    [Cmdlet("Remove", "DSRegion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDSRegionCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the directory for which you want to remove Region replication.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DirectoryService.Model.RemoveRegionResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DSRegion (RemoveRegion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.RemoveRegionResponse, RemoveDSRegionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryService.Model.RemoveRegionRequest();
        ...
        private Amazon.DirectoryService.Model.RemoveRegionResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.RemoveRegionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service", "RemoveRegion");
            try
            {
        ...
        {
            public System.String DirectoryId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.RemoveRegionResponse, RemoveDSRegionCmdlet, object> Select { get; set; } =
