...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    /// </summary>
    [Cmdlet("Deny", "DSSharedDirectory", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class DenyDSSharedDirectoryCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-DSSharedDirectory (RejectSharedDirectory)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.RejectSharedDirectoryResponse, DenyDSSharedDirectoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryService.Model.RejectSharedDirectoryRequest();
        ...
        private Amazon.DirectoryService.Model.RejectSharedDirectoryResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.RejectSharedDirectoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service", "RejectSharedDirectory");
            try
            {
                #if DESKTOP
                return client.RejectSharedDirectory(request);
                #elif CORECLR
                return client.RejectSharedDirectoryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SharedDirectoryId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.RejectSharedDirectoryResponse, DenyDSSharedDirectoryCmdlet, object> Select { get; set; } =
