...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    public partial class DisableDSDirectoryDataAccessCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DirectoryService.Model.DisableDirectoryDataAccessResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-DSDirectoryDataAccess (DisableDirectoryDataAccess)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DisableDirectoryDataAccessResponse, DisableDSDirectoryDataAccessCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryService.Model.DisableDirectoryDataAccessRequest();
        ...
        private Amazon.DirectoryService.Model.DisableDirectoryDataAccessResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DisableDirectoryDataAccessRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service", "DisableDirectoryDataAccess");
            try
            {
                #if DESKTOP
                return client.DisableDirectoryDataAccess(request);
                #elif CORECLR
                return client.DisableDirectoryDataAccessAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DirectoryId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DisableDirectoryDataAccessResponse, DisableDSDirectoryDataAccessCmdlet, object> Select { get; set; } =
