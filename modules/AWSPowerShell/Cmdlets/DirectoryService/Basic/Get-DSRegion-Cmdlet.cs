...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdletOutput("Amazon.DirectoryService.Model.RegionDescription or Amazon.DirectoryService.Model.DescribeRegionsResponse",
        ...
        "The service call response (type Amazon.DirectoryService.Model.DescribeRegionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
