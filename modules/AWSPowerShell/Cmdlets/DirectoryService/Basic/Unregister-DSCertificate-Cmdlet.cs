...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Directory Service DeregisterCertificate API operation.", Operation = new[] {"DeregisterCertificate"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DeregisterCertificateResponse))]
    [AWSCmdletOutput("None or Amazon.DirectoryService.Model.DeregisterCertificateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectoryService.Model.DeregisterCertificateResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnregisterDSCertificateCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-DSCertificate (DeregisterCertificate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DeregisterCertificateResponse, UnregisterDSCertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryService.Model.DeregisterCertificateRequest();
        ...
        private Amazon.DirectoryService.Model.DeregisterCertificateResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DeregisterCertificateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service", "DeregisterCertificate");
            try
            {
                #if DESKTOP
                return client.DeregisterCertificate(request);
                #elif CORECLR
                return client.DeregisterCertificateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CertificateId { get; set; }
            public System.String DirectoryId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DeregisterCertificateResponse, UnregisterDSCertificateCmdlet, object> Select { get; set; } =
