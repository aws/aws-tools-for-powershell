...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Calls the AWS Directory Service DescribeSnapshots API operation.", Operation = new[] {"DescribeSnapshots"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DescribeSnapshotsResponse))]
    [AWSCmdletOutput("Amazon.DirectoryService.Model.Snapshot or Amazon.DirectoryService.Model.DescribeSnapshotsResponse",
        "This cmdlet returns a collection of Amazon.DirectoryService.Model.Snapshot objects.",
        "The service call response (type Amazon.DirectoryService.Model.DescribeSnapshotsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSSnapshotCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DescribeSnapshotsResponse, GetDSSnapshotCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DirectoryService.Model.DescribeSnapshotsResponse, GetDSSnapshotCmdlet, object> Select { get; set; } =
