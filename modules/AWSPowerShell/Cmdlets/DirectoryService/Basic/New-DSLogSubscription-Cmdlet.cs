...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Directory Service CreateLogSubscription API operation.", Operation = new[] {"CreateLogSubscription"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.CreateLogSubscriptionResponse))]
    [AWSCmdletOutput("None or Amazon.DirectoryService.Model.CreateLogSubscriptionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectoryService.Model.CreateLogSubscriptionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewDSLogSubscriptionCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DSLogSubscription (CreateLogSubscription)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.CreateLogSubscriptionResponse, NewDSLogSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DirectoryService.Model.CreateLogSubscriptionRequest();
        ...
        private Amazon.DirectoryService.Model.CreateLogSubscriptionResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.CreateLogSubscriptionRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DirectoryId { get; set; }
            public System.String LogGroupName { get; set; }
            public System.Func<Amazon.DirectoryService.Model.CreateLogSubscriptionResponse, NewDSLogSubscriptionCmdlet, object> Select { get; set; } =
