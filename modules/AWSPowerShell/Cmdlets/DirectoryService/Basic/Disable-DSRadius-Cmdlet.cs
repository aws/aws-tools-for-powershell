...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Directory Service DisableRadius API operation.", Operation = new[] {"DisableRadius"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DisableRadiusResponse))]
    [AWSCmdletOutput("None or Amazon.DirectoryService.Model.DisableRadiusResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DirectoryService.Model.DisableRadiusResponse) be returned by specifying '-Select *'."
    )]
    public partial class DisableDSRadiusCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DisableRadiusResponse, DisableDSRadiusCmdlet>(Select) ??
        ...
        private Amazon.DirectoryService.Model.DisableRadiusResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DisableRadiusRequest request)
        {
            ...
            try
            {
                return client.DisableRadiusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DirectoryId { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DisableRadiusResponse, DisableDSRadiusCmdlet, object> Select { get; set; } =
