...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    public partial class GetDSEventTopicCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// is null, all associations for the specified Directory ID are returned.</para><para>An empty list results in an <c>InvalidParameterException</c> being thrown.</para><para />
