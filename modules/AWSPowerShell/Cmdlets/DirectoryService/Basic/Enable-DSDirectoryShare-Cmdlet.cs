...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    public partial class EnableDSDirectoryShareCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// any Amazon Web Services account by sending a directory sharing request (<c>HANDSHAKE</c>).</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Type of identifier to be used in the <c>Id</c> field.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.DirectoryService.Model.ShareDirectoryResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.ShareDirectoryRequest request)
        {
            ...
            try
            {
                return client.ShareDirectoryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
