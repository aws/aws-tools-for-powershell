...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    public partial class NewDSSnapshotCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.CreateSnapshotResponse, NewDSSnapshotCmdlet>(Select) ??
        ...
        private Amazon.DirectoryService.Model.CreateSnapshotResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.CreateSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Directory Service", "CreateSnapshot");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DirectoryId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.DirectoryService.Model.CreateSnapshotResponse, NewDSSnapshotCmdlet, object> Select { get; set; } =
