...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Calls the AWS Directory Service DescribeDirectories API operation.", Operation = new[] {"DescribeDirectories"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DescribeDirectoriesResponse))]
    [AWSCmdletOutput("Amazon.DirectoryService.Model.DirectoryDescription or Amazon.DirectoryService.Model.DescribeDirectoriesResponse",
        "This cmdlet returns a collection of Amazon.DirectoryService.Model.DirectoryDescription objects.",
        "The service call response (type Amazon.DirectoryService.Model.DescribeDirectoriesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSDirectoryCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>DescribeDirectoriesResult.NextToken</c> value from a previous call to <a>DescribeDirectories</a>.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DirectoryDescriptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DescribeDirectoriesResponse, GetDSDirectoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DirectoryDescriptions?.Count ?? 0;
        ...
        private Amazon.DirectoryService.Model.DescribeDirectoriesResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DescribeDirectoriesRequest request)
        {
            ...
            try
            {
                return client.DescribeDirectoriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DescribeDirectoriesResponse, GetDSDirectoryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DirectoryDescriptions;
        }
