...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Calls the AWS Directory Service DescribeDomainControllers API operation.", Operation = new[] {"DescribeDomainControllers"}, SelectReturnType = typeof(Amazon.DirectoryService.Model.DescribeDomainControllersResponse))]
    [AWSCmdletOutput("Amazon.DirectoryService.Model.DomainController or Amazon.DirectoryService.Model.DescribeDomainControllersResponse",
        "This cmdlet returns a collection of Amazon.DirectoryService.Model.DomainController objects.",
        "The service call response (type Amazon.DirectoryService.Model.DescribeDomainControllersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSDomainControllerListCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of identifiers for the domain controllers whose information will be provided.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DomainControllers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DirectoryService.Model.DescribeDomainControllersResponse, GetDSDomainControllerListCmdlet>(Select) ??
            ...
            {
                context.DomainControllerId = new List<System.String>(this.DomainControllerId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.DomainControllerId != null)
            {
                request.DomainControllerIds = cmdletContext.DomainControllerId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DomainControllers?.Count ?? 0;
        ...
        private Amazon.DirectoryService.Model.DescribeDomainControllersResponse CallAWSServiceOperation(IAmazonDirectoryService client, Amazon.DirectoryService.Model.DescribeDomainControllersRequest request)
        {
            ...
            try
            {
                return client.DescribeDomainControllersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DirectoryId { get; set; }
            public List<System.String> DomainControllerId { get; set; }
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DirectoryService.Model.DescribeDomainControllersResponse, GetDSDomainControllerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DomainControllers;
        }
