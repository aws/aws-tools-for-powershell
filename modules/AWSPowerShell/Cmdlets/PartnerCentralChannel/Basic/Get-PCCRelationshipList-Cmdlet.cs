...
namespace Amazon.PowerShell.Cmdlets.PCC
{
    ...
    public partial class GetPCCRelationshipListCmdlet : AmazonPartnerCentralChannelClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filter by associated AWS account IDs.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Filter by association types.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Filter by program management account identifiers.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.PartnerCentralChannel.Model.ListRelationshipsResponse CallAWSServiceOperation(IAmazonPartnerCentralChannel client, Amazon.PartnerCentralChannel.Model.ListRelationshipsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListRelationships(request);
                #elif CORECLR
                return client.ListRelationshipsAsync(request).GetAwaiter().GetResult();
                #else
