...
namespace Amazon.PowerShell.Cmdlets.ACD
{
    ...
    public partial class GetACDLatestConfigurationCmdlet : AmazonAppConfigDataClientCmdlet, IExecutor
    {
        ...
        /// and MUST be provided to subsequent GetLatestConfiguration API calls.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ConfigurationToken' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ConfigurationToken;
            }
