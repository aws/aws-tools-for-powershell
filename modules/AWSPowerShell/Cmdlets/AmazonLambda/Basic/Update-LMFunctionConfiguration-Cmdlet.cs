...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    public partial class UpdateLMFunctionConfigurationCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// v2.7, set the value to "python2.7".</para><note><para>Node v0.10.42 is currently marked as deprecated. You must migrate existing functions
