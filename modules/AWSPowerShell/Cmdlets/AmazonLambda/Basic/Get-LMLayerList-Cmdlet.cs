...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda ListLayers API operation.", Operation = new[] {"ListLayers"})]
    [AWSCmdletOutput("Amazon.Lambda.Model.LayersListItem",
        "This cmdlet returns a collection of LayersListItem objects.",
    ...
    public partial class GetLMLayerListCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Layers;
                        ...
                        int _receivedThisCall = response.Layers.Count;
        ...
        private Amazon.Lambda.Model.ListLayersResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.ListLayersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListLayersAsync(request);
                return task.Result;
                #else
