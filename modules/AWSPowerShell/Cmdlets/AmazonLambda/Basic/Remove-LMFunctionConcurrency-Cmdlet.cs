...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda DeleteFunctionConcurrency API operation.", Operation = new[] {"DeleteFunctionConcurrency"})]
    ...
    public partial class RemoveLMFunctionConcurrencyCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the function you are removing concurrent execution limits from.</para>
        /// </para>
        /// </summary>
