...
namespace Amazon.PowerShell.Cmdlets.LM
{
    ...
    [AWSCmdlet("Calls the AWS Lambda GetLayerVersionPolicy API operation.", Operation = new[] {"GetLayerVersionPolicy"})]
    [AWSCmdletOutput("Amazon.Lambda.Model.GetLayerVersionPolicyResponse",
        "This cmdlet returns a Amazon.Lambda.Model.GetLayerVersionPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLMLayerVersionPolicyCmdlet : AmazonLambdaClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lambda.Model.GetLayerVersionPolicyResponse CallAWSServiceOperation(IAmazonLambda client, Amazon.Lambda.Model.GetLayerVersionPolicyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetLayerVersionPolicyAsync(request);
                return task.Result;
                #else
