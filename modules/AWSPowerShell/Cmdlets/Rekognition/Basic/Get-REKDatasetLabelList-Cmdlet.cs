...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    /// </summary>
    [Cmdlet("Get", "REKDatasetLabelList")]
    [OutputType("Amazon.Rekognition.Model.DatasetLabelDescription")]
    [AWSCmdlet("Calls the Amazon Rekognition ListDatasetLabels API operation.", Operation = new[] {"ListDatasetLabels"}, SelectReturnType = typeof(Amazon.Rekognition.Model.ListDatasetLabelsResponse))]
    [AWSCmdletOutput("Amazon.Rekognition.Model.DatasetLabelDescription or Amazon.Rekognition.Model.ListDatasetLabelsResponse",
        "This cmdlet returns a collection of Amazon.Rekognition.Model.DatasetLabelDescription objects.",
        "The service call response (type Amazon.Rekognition.Model.ListDatasetLabelsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetREKDatasetLabelListCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DatasetLabelDescriptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.ListDatasetLabelsResponse, GetREKDatasetLabelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Rekognition.Model.ListDatasetLabelsRequest();
        ...
        private Amazon.Rekognition.Model.ListDatasetLabelsResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.ListDatasetLabelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "ListDatasetLabels");
            try
            {
                #if DESKTOP
                return client.ListDatasetLabels(request);
                #elif CORECLR
                return client.ListDatasetLabelsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Rekognition.Model.ListDatasetLabelsResponse, GetREKDatasetLabelListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DatasetLabelDescriptions;
        }
