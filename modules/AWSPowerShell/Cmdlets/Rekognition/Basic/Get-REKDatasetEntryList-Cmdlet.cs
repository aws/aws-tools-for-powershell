...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Rekognition.Model.ListDatasetEntriesResponse",
        ...
        "The service call response (type Amazon.Rekognition.Model.ListDatasetEntriesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetREKDatasetEntryListCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// one or more of the labels in <c>ContainsLabels</c> exist in the entry. </para><para />
