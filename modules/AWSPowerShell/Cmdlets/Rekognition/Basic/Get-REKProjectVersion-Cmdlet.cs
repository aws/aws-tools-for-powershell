...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    /// </summary>
    [Cmdlet("Get", "REKProjectVersion")]
    [OutputType("Amazon.Rekognition.Model.ProjectVersionDescription")]
    [AWSCmdlet("Calls the Amazon Rekognition DescribeProjectVersions API operation.", Operation = new[] {"DescribeProjectVersions"}, SelectReturnType = typeof(Amazon.Rekognition.Model.DescribeProjectVersionsResponse))]
    [AWSCmdletOutput("Amazon.Rekognition.Model.ProjectVersionDescription or Amazon.Rekognition.Model.DescribeProjectVersionsResponse",
        "This cmdlet returns a collection of Amazon.Rekognition.Model.ProjectVersionDescription objects.",
        "The service call response (type Amazon.Rekognition.Model.DescribeProjectVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetREKProjectVersionCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ProjectVersionDescriptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.DescribeProjectVersionsResponse, GetREKProjectVersionCmdlet>(Select) ??
            ...
            {
                context.VersionName = new List<System.String>(this.VersionName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Rekognition.Model.DescribeProjectVersionsRequest();
            ...
            {
                request.VersionNames = cmdletContext.VersionName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ProjectVersionDescriptions?.Count ?? 0;
        ...
        private Amazon.Rekognition.Model.DescribeProjectVersionsResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DescribeProjectVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "DescribeProjectVersions");
            try
            {
                #if DESKTOP
                return client.DescribeProjectVersions(request);
                #elif CORECLR
                return client.DescribeProjectVersionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProjectArn { get; set; }
            public List<System.String> VersionName { get; set; }
            public System.Func<Amazon.Rekognition.Model.DescribeProjectVersionsResponse, GetREKProjectVersionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ProjectVersionDescriptions;
        }
