...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    /// video.
    /// </para><note><para><c>GetFaceSearch</c> only returns the default facial attributes (<c>BoundingBox</c>,
    ...
    [AWSCmdletOutput("Amazon.Rekognition.Model.GetFaceSearchResponse",
        "This cmdlet returns an Amazon.Rekognition.Model.GetFaceSearchResponse object containing multiple properties."
    )]
    public partial class GetREKFaceSearchCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// call to <c>StartFaceSearch</c>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>Sort to use for grouping faces in the response. Use <c>TIMESTAMP</c> to group faces
        ...
        private Amazon.Rekognition.Model.GetFaceSearchResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.GetFaceSearchRequest request)
        {
            ...
            try
            {
                return client.GetFaceSearchAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
