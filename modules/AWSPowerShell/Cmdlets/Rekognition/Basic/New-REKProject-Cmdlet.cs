...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    public partial class NewREKProjectCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A set of tags (key-value pairs) that you want to attach to the project.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-REKProject (CreateProject)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.CreateProjectResponse, NewREKProjectCmdlet>(Select) ??
        ...
        private Amazon.Rekognition.Model.CreateProjectResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.CreateProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "CreateProject");
            try
            {
