...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "REKDataset")]
    [OutputType("Amazon.Rekognition.Model.DatasetDescription")]
    ...
    public partial class GetREKDatasetCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.DescribeDatasetResponse, GetREKDatasetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Rekognition.Model.DescribeDatasetRequest();
        ...
        private Amazon.Rekognition.Model.DescribeDatasetResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DescribeDatasetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "DescribeDataset");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DatasetArn { get; set; }
            public System.Func<Amazon.Rekognition.Model.DescribeDatasetResponse, GetREKDatasetCmdlet, object> Select { get; set; } =
