...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdletOutput("Amazon.Rekognition.Model.ProjectPolicy or Amazon.Rekognition.Model.ListProjectPoliciesResponse",
        ...
        "The service call response (type Amazon.Rekognition.Model.ListProjectPoliciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
