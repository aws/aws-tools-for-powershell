...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    public partial class StopREKStreamProcessorCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.StopStreamProcessorResponse, StopREKStreamProcessorCmdlet>(Select) ??
        ...
        private Amazon.Rekognition.Model.StopStreamProcessorResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.StopStreamProcessorRequest request)
        {
            ...
            try
            {
                return client.StopStreamProcessorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Rekognition.Model.StopStreamProcessorResponse, StopREKStreamProcessorCmdlet, object> Select { get; set; } =
