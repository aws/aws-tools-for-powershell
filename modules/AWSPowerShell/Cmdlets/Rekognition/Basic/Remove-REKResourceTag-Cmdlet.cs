...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    public partial class RemoveREKResourceTagCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> A list of the tags that you want to remove. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-REKResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.UntagResourceResponse, RemoveREKResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Rekognition.Model.UntagResourceRequest();
        ...
        private Amazon.Rekognition.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Rekognition.Model.UntagResourceResponse, RemoveREKResourceTagCmdlet, object> Select { get; set; } =
