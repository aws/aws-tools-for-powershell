...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    public partial class GetREKStreamProcessorCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.DescribeStreamProcessorResponse, GetREKStreamProcessorCmdlet>(Select) ??
        ...
        private Amazon.Rekognition.Model.DescribeStreamProcessorResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DescribeStreamProcessorRequest request)
        {
            ...
            try
            {
                return client.DescribeStreamProcessorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.Rekognition.Model.DescribeStreamProcessorResponse, GetREKStreamProcessorCmdlet, object> Select { get; set; } =
