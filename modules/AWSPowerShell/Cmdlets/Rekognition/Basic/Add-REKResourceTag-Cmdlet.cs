...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    public partial class AddREKResourceTagCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The key-value tags to assign to the resource. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-REKResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.TagResourceResponse, AddREKResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Rekognition.Model.TagResourceRequest();
        ...
        private Amazon.Rekognition.Model.TagResourceResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Rekognition.Model.TagResourceResponse, AddREKResourceTagCmdlet, object> Select { get; set; } =
