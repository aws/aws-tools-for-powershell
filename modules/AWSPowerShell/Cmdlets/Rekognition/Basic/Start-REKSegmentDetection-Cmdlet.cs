...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Rekognition.Model.StartSegmentDetectionResponse",
        ...
        "The service call response (type Amazon.Rekognition.Model.StartSegmentDetectionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
