...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdletOutput("Amazon.Rekognition.Model.ProjectDescription or Amazon.Rekognition.Model.DescribeProjectsResponse",
        ...
        "The service call response (type Amazon.Rekognition.Model.DescribeProjectsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
