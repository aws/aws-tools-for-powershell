...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "REKProjectVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Rekognition.ProjectVersionStatus")]
    [AWSCmdlet("Calls the Amazon Rekognition DeleteProjectVersion API operation.", Operation = new[] {"DeleteProjectVersion"}, SelectReturnType = typeof(Amazon.Rekognition.Model.DeleteProjectVersionResponse))]
    [AWSCmdletOutput("Amazon.Rekognition.ProjectVersionStatus or Amazon.Rekognition.Model.DeleteProjectVersionResponse",
        "This cmdlet returns an Amazon.Rekognition.ProjectVersionStatus object.",
        "The service call response (type Amazon.Rekognition.Model.DeleteProjectVersionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveREKProjectVersionCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the project version that you want to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-REKProjectVersion (DeleteProjectVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.DeleteProjectVersionResponse, RemoveREKProjectVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Rekognition.Model.DeleteProjectVersionRequest();
        ...
        private Amazon.Rekognition.Model.DeleteProjectVersionResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DeleteProjectVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "DeleteProjectVersion");
            try
            {
                #if DESKTOP
                return client.DeleteProjectVersion(request);
                #elif CORECLR
                return client.DeleteProjectVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ProjectVersionArn { get; set; }
            public System.Func<Amazon.Rekognition.Model.DeleteProjectVersionResponse, RemoveREKProjectVersionCmdlet, object> Select { get; set; } =
