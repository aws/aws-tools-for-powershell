...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Calls the Amazon Rekognition ListCollections API operation.", Operation = new[] {"ListCollections"}, SelectReturnType = typeof(Amazon.Rekognition.Model.ListCollectionsResponse))]
    [AWSCmdletOutput("Amazon.Rekognition.Model.ListCollectionsResponse",
        "This cmdlet returns an Amazon.Rekognition.Model.ListCollectionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetREKCollectionIdListCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Rekognition.Model.ListCollectionsResponse, GetREKCollectionIdListCmdlet>(Select) ??
