...
namespace Amazon.PowerShell.Cmdlets.QLDB
{
    ...
    [AWSCmdletOutput("System.String or Amazon.QLDB.Model.CancelJournalKinesisStreamResponse",
        ...
        "The service call response (type Amazon.QLDB.Model.CancelJournalKinesisStreamResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
