...
namespace Amazon.PowerShell.Cmdlets.QLDB
{
    ...
    [AWSCmdletOutput("Amazon.QLDB.Model.CreateLedgerResponse",
        "This cmdlet returns an Amazon.QLDB.Model.CreateLedgerResponse object containing multiple properties."
    )]
    public partial class NewQLDBLedgerCmdlet : AmazonQLDBClientCmdlet, IExecutor
    {
        ...
        /// Services on your behalf.</para></li><li><para><b>Undefined</b>: By default, use an Amazon Web Services owned KMS key.</para></li><li><para><b>A valid symmetric customer managed KMS key</b>: Use the specified symmetric encryption
        ...
        /// can have one of the following values:</para><ul><li><para><c>ALLOW_ALL</c>: A legacy permissions mode that enables access control with API-level
        ...
        /// are case sensitive. Tag values are case sensitive and can be null.</para><para />
        ...
        private Amazon.QLDB.Model.CreateLedgerResponse CallAWSServiceOperation(IAmazonQLDB client, Amazon.QLDB.Model.CreateLedgerRequest request)
        {
            ...
            try
            {
                return client.CreateLedgerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
