...
namespace Amazon.PowerShell.Cmdlets.QLDB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "QLDBResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddQLDBResourceTagCmdlet : AmazonQLDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) to which you want to add the tags. For example:</para><para><c>arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger</c></para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// fails and returns an error. Tag values are case sensitive and can be null.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-QLDBResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QLDB.Model.TagResourceResponse, AddQLDBResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QLDB.Model.TagResourceRequest();
        ...
        private Amazon.QLDB.Model.TagResourceResponse CallAWSServiceOperation(IAmazonQLDB client, Amazon.QLDB.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QLDB", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.QLDB.Model.TagResourceResponse, AddQLDBResourceTagCmdlet, object> Select { get; set; } =
