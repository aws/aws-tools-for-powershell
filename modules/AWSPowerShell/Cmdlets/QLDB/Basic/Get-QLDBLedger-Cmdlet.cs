...
namespace Amazon.PowerShell.Cmdlets.QLDB
{
    ...
    public partial class GetQLDBLedgerCmdlet : AmazonQLDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QLDB.Model.DescribeLedgerResponse, GetQLDBLedgerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QLDB.Model.DescribeLedgerRequest();
        ...
        private Amazon.QLDB.Model.DescribeLedgerResponse CallAWSServiceOperation(IAmazonQLDB client, Amazon.QLDB.Model.DescribeLedgerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QLDB", "DescribeLedger");
            try
            {
                #if DESKTOP
                return client.DescribeLedger(request);
                #elif CORECLR
                return client.DescribeLedgerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.QLDB.Model.DescribeLedgerResponse, GetQLDBLedgerCmdlet, object> Select { get; set; } =
