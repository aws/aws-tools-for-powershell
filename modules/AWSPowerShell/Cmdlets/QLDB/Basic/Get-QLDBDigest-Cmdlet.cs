...
namespace Amazon.PowerShell.Cmdlets.QLDB
{
    ...
    public partial class GetQLDBDigestCmdlet : AmazonQLDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.QLDB.Model.GetDigestResponse, GetQLDBDigestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.QLDB.Model.GetDigestRequest();
        ...
        private Amazon.QLDB.Model.GetDigestResponse CallAWSServiceOperation(IAmazonQLDB client, Amazon.QLDB.Model.GetDigestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon QLDB", "GetDigest");
            try
            {
                return client.GetDigestAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.QLDB.Model.GetDigestResponse, GetQLDBDigestCmdlet, object> Select { get; set; } =
