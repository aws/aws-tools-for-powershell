...
namespace Amazon.PowerShell.Cmdlets.CCAS
{
    ...
    public partial class GetCCASTemplateListCmdlet : AmazonConnectCasesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of status values to filter on.</para><para />
