...
namespace Amazon.PowerShell.Cmdlets.CCAS
{
    ...
    /// case field conditions to a case template</a>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCCASCaseRuleListCmdlet : AmazonConnectCasesClientCmdlet, IExecutor
    {
        ...
        private Amazon.ConnectCases.Model.ListCaseRulesResponse CallAWSServiceOperation(IAmazonConnectCases client, Amazon.ConnectCases.Model.ListCaseRulesRequest request)
        {
            ...
            try
            {
                return client.ListCaseRulesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
