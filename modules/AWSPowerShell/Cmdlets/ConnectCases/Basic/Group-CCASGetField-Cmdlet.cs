...
namespace Amazon.PowerShell.Cmdlets.CCAS
{
    ...
    /// </summary>
    [Cmdlet("Group", "CCASGetField", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class GroupCCASGetFieldCmdlet : AmazonConnectCasesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Group-CCASGetField (BatchGetField)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectCases.Model.BatchGetFieldResponse, GroupCCASGetFieldCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectCases.Model.BatchGetFieldRequest();
        ...
        private Amazon.ConnectCases.Model.BatchGetFieldResponse CallAWSServiceOperation(IAmazonConnectCases client, Amazon.ConnectCases.Model.BatchGetFieldRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Cases", "BatchGetField");
            try
            {
                #if DESKTOP
                return client.BatchGetField(request);
                #elif CORECLR
                return client.BatchGetFieldAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConnectCases.Model.BatchGetFieldResponse, GroupCCASGetFieldCmdlet, object> Select { get; set; } =
