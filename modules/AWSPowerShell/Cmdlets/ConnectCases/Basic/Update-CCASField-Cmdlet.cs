...
namespace Amazon.PowerShell.Cmdlets.CCAS
{
    ...
    /// </summary>
    [Cmdlet("Update", "CCASField", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCCASFieldCmdlet : AmazonConnectCasesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CCASField (UpdateField)"))
            {
                return;
            }
        ...
        private Amazon.ConnectCases.Model.UpdateFieldResponse CallAWSServiceOperation(IAmazonConnectCases client, Amazon.ConnectCases.Model.UpdateFieldRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Cases", "UpdateField");
            try
            {
                #if DESKTOP
                return client.UpdateField(request);
                #elif CORECLR
                return client.UpdateFieldAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FieldId { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.ConnectCases.Model.UpdateFieldResponse, UpdateCCASFieldCmdlet, object> Select { get; set; } =
