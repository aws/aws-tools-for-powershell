...
namespace Amazon.PowerShell.Cmdlets.CCAS
{
    ...
    /// </summary>
    [Cmdlet("New", "CCASField", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewCCASFieldCmdlet : AmazonConnectCasesClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.ConnectCases.FieldType")]
        public Amazon.ConnectCases.FieldType Type { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CCASField (CreateField)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectCases.Model.CreateFieldResponse, NewCCASFieldCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectCases.Model.CreateFieldRequest();
        ...
        private Amazon.ConnectCases.Model.CreateFieldResponse CallAWSServiceOperation(IAmazonConnectCases client, Amazon.ConnectCases.Model.CreateFieldRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Cases", "CreateField");
            try
            {
                #if DESKTOP
                return client.CreateField(request);
                #elif CORECLR
                return client.CreateFieldAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public Amazon.ConnectCases.FieldType Type { get; set; }
            public System.Func<Amazon.ConnectCases.Model.CreateFieldResponse, NewCCASFieldCmdlet, object> Select { get; set; } =
