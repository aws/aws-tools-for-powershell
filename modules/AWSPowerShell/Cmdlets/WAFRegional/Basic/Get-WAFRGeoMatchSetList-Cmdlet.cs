...
{
    /// <summary>
    /// Returns an array of <a>GeoMatchSetSummary</a> objects in the response.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRGeoMatchSetList")]
    [OutputType("Amazon.WAFRegional.Model.GeoMatchSetSummary")]
    ...
    public partial class GetWAFRGeoMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListGeoMatchSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListGeoMatchSetsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GeoMatchSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListGeoMatchSetsResponse, GetWAFRGeoMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListGeoMatchSetsRequest();
        ...
        private Amazon.WAFRegional.Model.ListGeoMatchSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListGeoMatchSetsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListGeoMatchSetsResponse, GetWAFRGeoMatchSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GeoMatchSets;
        }
