...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "WAFRRuleGroup")]
    [OutputType("Amazon.WAFRegional.Model.RuleGroup")]
    [AWSCmdlet("Calls the AWS WAF Regional GetRuleGroup API operation.", Operation = new[] {"GetRuleGroup"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.GetRuleGroupResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RuleGroup or Amazon.WAFRegional.Model.GetRuleGroupResponse",
        "This cmdlet returns an Amazon.WAFRegional.Model.RuleGroup object.",
        "The service call response (type Amazon.WAFRegional.Model.GetRuleGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRRuleGroupCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.GetRuleGroupResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.GetRuleGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.GetRuleGroupResponse, GetWAFRRuleGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.GetRuleGroupRequest();
        ...
        private Amazon.WAFRegional.Model.GetRuleGroupResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetRuleGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "GetRuleGroup");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String RuleGroupId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.GetRuleGroupResponse, GetWAFRRuleGroupCmdlet, object> Select { get; set; } =
