...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class WriteWAFRLoggingConfigurationCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.PutLoggingConfigurationResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.PutLoggingConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.PutLoggingConfigurationResponse, WriteWAFRLoggingConfigurationCmdlet>(Select) ??
            ...
            {
                context.LoggingConfiguration_RedactedField = new List<Amazon.WAFRegional.Model.FieldToMatch>(this.LoggingConfiguration_RedactedField);
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public List<Amazon.WAFRegional.Model.FieldToMatch> LoggingConfiguration_RedactedField { get; set; }
            public System.String LoggingConfiguration_ResourceArn { get; set; }
            public System.Func<Amazon.WAFRegional.Model.PutLoggingConfigurationResponse, WriteWAFRLoggingConfigurationCmdlet, object> Select { get; set; } =
