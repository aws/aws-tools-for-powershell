...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListRateBasedRules API operation.", Operation = new[] {"ListRateBasedRules"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListRateBasedRulesResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RuleSummary or Amazon.WAFRegional.Model.ListRateBasedRulesResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.RuleSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListRateBasedRulesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRRateBasedRuleListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListRateBasedRulesResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListRateBasedRulesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListRateBasedRulesResponse, GetWAFRRateBasedRuleListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListRateBasedRulesResponse, GetWAFRRateBasedRuleListCmdlet, object> Select { get; set; } =
