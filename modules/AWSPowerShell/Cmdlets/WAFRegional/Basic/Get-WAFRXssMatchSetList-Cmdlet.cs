...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListXssMatchSets API operation.", Operation = new[] {"ListXssMatchSets"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListXssMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.XssMatchSetSummary or Amazon.WAFRegional.Model.ListXssMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.XssMatchSetSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListXssMatchSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRXssMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListXssMatchSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListXssMatchSetsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListXssMatchSetsResponse, GetWAFRXssMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListXssMatchSetsRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListXssMatchSetsResponse, GetWAFRXssMatchSetListCmdlet, object> Select { get; set; } =
