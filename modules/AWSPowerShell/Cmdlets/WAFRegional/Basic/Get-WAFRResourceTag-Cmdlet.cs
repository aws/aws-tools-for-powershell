...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para><br/><br/>In the AWS.Tools.WAFRegional module, this cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRResourceTag")]
    ...
    public partial class GetWAFRResourceTagCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListTagsForResourceResponse, GetWAFRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListTagsForResourceRequest();
        ...
        private Amazon.WAFRegional.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextMarker { get; set; }
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListTagsForResourceResponse, GetWAFRResourceTagCmdlet, object> Select { get; set; } =
