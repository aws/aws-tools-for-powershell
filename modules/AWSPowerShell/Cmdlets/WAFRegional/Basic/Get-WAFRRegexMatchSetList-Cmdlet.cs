...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRRegexMatchSetList")]
    [OutputType("Amazon.WAFRegional.Model.RegexMatchSetSummary")]
    [AWSCmdlet("Calls the AWS WAF Regional ListRegexMatchSets API operation.", Operation = new[] {"ListRegexMatchSets"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListRegexMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RegexMatchSetSummary or Amazon.WAFRegional.Model.ListRegexMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.RegexMatchSetSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListRegexMatchSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRRegexMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListRegexMatchSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListRegexMatchSetsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListRegexMatchSetsResponse, GetWAFRRegexMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListRegexMatchSetsRequest();
        ...
        private Amazon.WAFRegional.Model.ListRegexMatchSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListRegexMatchSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListRegexMatchSets");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListRegexMatchSetsResponse, GetWAFRRegexMatchSetListCmdlet, object> Select { get; set; } =
