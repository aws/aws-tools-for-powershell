...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.UpdateWebACLResponse",
        ...
        "The service call response (type Amazon.WAFRegional.Model.UpdateWebACLResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFRWebACLCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.UpdateWebACLResponse, UpdateWAFRWebACLCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAFRegional.Model.WebACLUpdate>(this.Update);
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public Amazon.WAFRegional.WafActionType DefaultAction_Type { get; set; }
            public List<Amazon.WAFRegional.Model.WebACLUpdate> Update { get; set; }
            public System.String WebACLId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.UpdateWebACLResponse, UpdateWAFRWebACLCmdlet, object> Select { get; set; } =
