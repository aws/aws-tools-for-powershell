...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "WAFRRegexMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS WAF Regional UpdateRegexMatchSet API operation.", Operation = new[] {"UpdateRegexMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateWAFRRegexMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Updates")]
        public Amazon.WAFRegional.Model.RegexMatchSetUpdate[] Update { get; set; }
        #endregion
        
        #region Parameter Select
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ChangeToken'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WAFRRegexMatchSet (UpdateRegexMatchSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse, UpdateWAFRRegexMatchSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAFRegional.Model.RegexMatchSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.UpdateRegexMatchSetRequest();
        ...
        private Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateRegexMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "UpdateRegexMatchSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexMatchSetId { get; set; }
            public List<Amazon.WAFRegional.Model.RegexMatchSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse, UpdateWAFRRegexMatchSetCmdlet, object> Select { get; set; } =
