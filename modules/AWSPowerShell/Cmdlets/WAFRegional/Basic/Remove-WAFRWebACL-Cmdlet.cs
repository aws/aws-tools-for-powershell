...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional DeleteWebACL API operation.", Operation = new[] {"DeleteWebACL"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.DeleteWebACLResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.DeleteWebACLResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteWebACLResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRWebACLCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DeleteWebACLResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.DeleteWebACLResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFRWebACL (DeleteWebACL)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DeleteWebACLResponse, RemoveWAFRWebACLCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String WebACLId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DeleteWebACLResponse, RemoveWAFRWebACLCmdlet, object> Select { get; set; } =
