...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional UpdateByteMatchSet API operation.", Operation = new[] {"UpdateByteMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.UpdateByteMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.UpdateByteMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.UpdateByteMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFRByteMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// <c>TargetString</c>, and <c>TextTransformation</c></para></li><li><para><a>FieldToMatch</a>: Contains <c>Data</c> and <c>Type</c></para></li></ul><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.UpdateByteMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.UpdateByteMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.UpdateByteMatchSetResponse, UpdateWAFRByteMatchSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAFRegional.Model.ByteMatchSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        private Amazon.WAFRegional.Model.UpdateByteMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateByteMatchSetRequest request)
        {
            ...
            try
            {
                return client.UpdateByteMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ByteMatchSetId { get; set; }
            public System.String ChangeToken { get; set; }
            public List<Amazon.WAFRegional.Model.ByteMatchSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAFRegional.Model.UpdateByteMatchSetResponse, UpdateWAFRByteMatchSetCmdlet, object> Select { get; set; } =
