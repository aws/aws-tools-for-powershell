...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRWebACLList")]
    [OutputType("Amazon.WAFRegional.Model.WebACLSummary")]
    [AWSCmdlet("Calls the AWS WAF Regional ListWebACLs API operation.", Operation = new[] {"ListWebACLs"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListWebACLsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.WebACLSummary or Amazon.WAFRegional.Model.ListWebACLsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.WebACLSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListWebACLsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRWebACLListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListWebACLsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListWebACLsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListWebACLsResponse, GetWAFRWebACLListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListWebACLsRequest();
        ...
        private Amazon.WAFRegional.Model.ListWebACLsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListWebACLsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListWebACLs");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListWebACLsResponse, GetWAFRWebACLListCmdlet, object> Select { get; set; } =
