...
{
    /// <summary>
    /// Returns an array of <a>RuleGroup</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRRuleGroupList")]
    [OutputType("Amazon.WAFRegional.Model.RuleGroupSummary")]
    [AWSCmdlet("Calls the AWS WAF Regional ListRuleGroups API operation.", Operation = new[] {"ListRuleGroups"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListRuleGroupsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RuleGroupSummary or Amazon.WAFRegional.Model.ListRuleGroupsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.RuleGroupSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListRuleGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRRuleGroupListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListRuleGroupsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListRuleGroupsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListRuleGroupsResponse, GetWAFRRuleGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListRuleGroupsRequest();
        ...
        private Amazon.WAFRegional.Model.ListRuleGroupsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListRuleGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListRuleGroups");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListRuleGroupsResponse, GetWAFRRuleGroupListCmdlet, object> Select { get; set; } =
