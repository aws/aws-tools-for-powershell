...
{
    /// <summary>
    /// Returns an array of <a>RegexPatternSetSummary</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRRegexPatternSetList")]
    [OutputType("Amazon.WAFRegional.Model.RegexPatternSetSummary")]
    ...
    public partial class GetWAFRRegexPatternSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListRegexPatternSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListRegexPatternSetsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RegexPatternSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListRegexPatternSetsResponse, GetWAFRRegexPatternSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListRegexPatternSetsRequest();
        ...
        private Amazon.WAFRegional.Model.ListRegexPatternSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListRegexPatternSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListRegexPatternSets");
            try
            {
                #if DESKTOP
                return client.ListRegexPatternSets(request);
                #elif CORECLR
                return client.ListRegexPatternSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListRegexPatternSetsResponse, GetWAFRRegexPatternSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RegexPatternSets;
        }
