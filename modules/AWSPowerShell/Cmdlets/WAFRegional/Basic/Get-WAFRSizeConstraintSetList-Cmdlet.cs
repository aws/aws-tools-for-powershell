...
{
    /// <summary>
    /// Returns an array of <a>SizeConstraintSetSummary</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRSizeConstraintSetList")]
    [OutputType("Amazon.WAFRegional.Model.SizeConstraintSetSummary")]
    [AWSCmdlet("Calls the AWS WAF Regional ListSizeConstraintSets API operation.", Operation = new[] {"ListSizeConstraintSets"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.SizeConstraintSetSummary or Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.SizeConstraintSetSummary objects.",
    ...
    public partial class GetWAFRSizeConstraintSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SizeConstraintSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse, GetWAFRSizeConstraintSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListSizeConstraintSetsRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListSizeConstraintSetsResponse, GetWAFRSizeConstraintSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SizeConstraintSets;
        }
