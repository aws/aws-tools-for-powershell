...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WAFRByteMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWAFRByteMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.CreateByteMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.CreateByteMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFRByteMatchSet (CreateByteMatchSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.CreateByteMatchSetResponse, NewWAFRByteMatchSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.CreateByteMatchSetRequest();
        ...
        private Amazon.WAFRegional.Model.CreateByteMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.CreateByteMatchSetRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.WAFRegional.Model.CreateByteMatchSetResponse, NewWAFRByteMatchSetCmdlet, object> Select { get; set; } =
