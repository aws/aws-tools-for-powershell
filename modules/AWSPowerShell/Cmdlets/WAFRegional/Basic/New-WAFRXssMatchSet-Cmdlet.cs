...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WAFRXssMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WAFRegional.Model.CreateXssMatchSetResponse")]
    [AWSCmdlet("Calls the AWS WAF Regional CreateXssMatchSet API operation.", Operation = new[] {"CreateXssMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.CreateXssMatchSetResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.CreateXssMatchSetResponse",
        "This cmdlet returns an Amazon.WAFRegional.Model.CreateXssMatchSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWAFRXssMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.CreateXssMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.CreateXssMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFRXssMatchSet (CreateXssMatchSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.CreateXssMatchSetResponse, NewWAFRXssMatchSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.CreateXssMatchSetRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.WAFRegional.Model.CreateXssMatchSetResponse, NewWAFRXssMatchSetCmdlet, object> Select { get; set; } =
