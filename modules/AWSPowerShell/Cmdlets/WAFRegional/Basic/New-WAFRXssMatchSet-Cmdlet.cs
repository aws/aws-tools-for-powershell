...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdletOutput("Amazon.WAFRegional.Model.CreateXssMatchSetResponse",
        "This cmdlet returns an Amazon.WAFRegional.Model.CreateXssMatchSetResponse object containing multiple properties."
    )]
    public partial class NewWAFRXssMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private Amazon.WAFRegional.Model.CreateXssMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.CreateXssMatchSetRequest request)
        {
            ...
            try
            {
                return client.CreateXssMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
