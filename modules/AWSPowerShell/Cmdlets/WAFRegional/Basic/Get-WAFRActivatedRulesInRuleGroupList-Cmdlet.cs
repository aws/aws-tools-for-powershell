...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRActivatedRulesInRuleGroupList")]
    [OutputType("Amazon.WAFRegional.Model.ActivatedRule")]
    [AWSCmdlet("Calls the AWS WAF Regional ListActivatedRulesInRuleGroup API operation.", Operation = new[] {"ListActivatedRulesInRuleGroup"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.ActivatedRule or Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.ActivatedRule objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWAFRActivatedRulesInRuleGroupListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse, GetWAFRActivatedRulesInRuleGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupRequest();
        ...
        private Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListActivatedRulesInRuleGroup");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextMarker { get; set; }
            public System.String RuleGroupId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListActivatedRulesInRuleGroupResponse, GetWAFRActivatedRulesInRuleGroupListCmdlet, object> Select { get; set; } =
