...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRRegexPatternSet")]
    [OutputType("Amazon.WAFRegional.Model.RegexPatternSet")]
    ...
    public partial class GetWAFRRegexPatternSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.GetRegexPatternSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.GetRegexPatternSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.GetRegexPatternSetResponse, GetWAFRRegexPatternSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.GetRegexPatternSetRequest();
        ...
        private Amazon.WAFRegional.Model.GetRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetRegexPatternSetRequest request)
        {
        ...
        {
            public System.String RegexPatternSetId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.GetRegexPatternSetResponse, GetWAFRRegexPatternSetCmdlet, object> Select { get; set; } =
