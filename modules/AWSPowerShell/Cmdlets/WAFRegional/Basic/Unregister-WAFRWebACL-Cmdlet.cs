...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class UnregisterWAFRWebACLCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DisassociateWebACLResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DisassociateWebACLResponse, UnregisterWAFRWebACLCmdlet>(Select) ??
        ...
        private Amazon.WAFRegional.Model.DisassociateWebACLResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DisassociateWebACLRequest request)
        {
            ...
            try
            {
                return client.DisassociateWebACLAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DisassociateWebACLResponse, UnregisterWAFRWebACLCmdlet, object> Select { get; set; } =
