...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListLoggingConfigurations API operation.", Operation = new[] {"ListLoggingConfigurations"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.LoggingConfiguration or Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.LoggingConfiguration objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRLoggingConfigurationListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse, GetWAFRLoggingConfigurationListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse, GetWAFRLoggingConfigurationListCmdlet, object> Select { get; set; } =
