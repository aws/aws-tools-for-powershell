...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional UpdateGeoMatchSet API operation.", Operation = new[] {"UpdateGeoMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWAFRGeoMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse, UpdateWAFRGeoMatchSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAFRegional.Model.GeoMatchSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String GeoMatchSetId { get; set; }
            public List<Amazon.WAFRegional.Model.GeoMatchSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAFRegional.Model.UpdateGeoMatchSetResponse, UpdateWAFRGeoMatchSetCmdlet, object> Select { get; set; } =
