...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional DeleteRuleGroup API operation.", Operation = new[] {"DeleteRuleGroup"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.DeleteRuleGroupResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.DeleteRuleGroupResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteRuleGroupResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRRuleGroupCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DeleteRuleGroupResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.DeleteRuleGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DeleteRuleGroupResponse, RemoveWAFRRuleGroupCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RuleGroupId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DeleteRuleGroupResponse, RemoveWAFRRuleGroupCmdlet, object> Select { get; set; } =
