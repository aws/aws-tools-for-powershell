...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional DeleteXssMatchSet API operation.", Operation = new[] {"DeleteXssMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.DeleteXssMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.DeleteXssMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteXssMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRXssMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DeleteXssMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.DeleteXssMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DeleteXssMatchSetResponse, RemoveWAFRXssMatchSetCmdlet>(Select) ??
        ...
        private Amazon.WAFRegional.Model.DeleteXssMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteXssMatchSetRequest request)
        {
            ...
            try
            {
                return client.DeleteXssMatchSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String XssMatchSetId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DeleteXssMatchSetResponse, RemoveWAFRXssMatchSetCmdlet, object> Select { get; set; } =
