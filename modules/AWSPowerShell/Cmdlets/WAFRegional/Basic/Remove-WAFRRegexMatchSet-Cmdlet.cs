...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional DeleteRegexMatchSet API operation.", Operation = new[] {"DeleteRegexMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRRegexMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse, RemoveWAFRRegexMatchSetCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexMatchSetId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse, RemoveWAFRRegexMatchSetCmdlet, object> Select { get; set; } =
