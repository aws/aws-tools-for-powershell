...
{
    /// <summary>
    /// Returns an array of <a>ByteMatchSetSummary</a> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "WAFRByteMatchSetList")]
    [OutputType("Amazon.WAFRegional.Model.ByteMatchSetSummary")]
    ...
    public partial class GetWAFRByteMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListByteMatchSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListByteMatchSetsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ByteMatchSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListByteMatchSetsResponse, GetWAFRByteMatchSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListByteMatchSetsRequest();
        ...
        private Amazon.WAFRegional.Model.ListByteMatchSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListByteMatchSetsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListByteMatchSetsResponse, GetWAFRByteMatchSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ByteMatchSets;
        }
