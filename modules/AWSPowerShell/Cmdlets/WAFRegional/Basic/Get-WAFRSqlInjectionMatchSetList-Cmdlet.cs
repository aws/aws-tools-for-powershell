...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListSqlInjectionMatchSets API operation.", Operation = new[] {"ListSqlInjectionMatchSets"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.SqlInjectionMatchSetSummary or Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.SqlInjectionMatchSetSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRSqlInjectionMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse, GetWAFRSqlInjectionMatchSetListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListSqlInjectionMatchSetsResponse, GetWAFRSqlInjectionMatchSetListCmdlet, object> Select { get; set; } =
