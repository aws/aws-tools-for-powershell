...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional DeleteGeoMatchSet API operation.", Operation = new[] {"DeleteGeoMatchSet"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse))]
    [AWSCmdletOutput("System.String or Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWAFRGeoMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse, RemoveWAFRGeoMatchSetCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String GeoMatchSetId { get; set; }
            public System.Func<Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse, RemoveWAFRGeoMatchSetCmdlet, object> Select { get; set; } =
