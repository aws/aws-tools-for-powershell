...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListRules API operation.", Operation = new[] {"ListRules"}, SelectReturnType = typeof(Amazon.WAFRegional.Model.ListRulesResponse))]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RuleSummary or Amazon.WAFRegional.Model.ListRulesResponse",
        "This cmdlet returns a collection of Amazon.WAFRegional.Model.RuleSummary objects.",
        "The service call response (type Amazon.WAFRegional.Model.ListRulesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWAFRRuleListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.ListRulesResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.ListRulesResponse will result in that property being returned.
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextMarker { get; set; }
            public System.Func<Amazon.WAFRegional.Model.ListRulesResponse, GetWAFRRuleListCmdlet, object> Select { get; set; } =
