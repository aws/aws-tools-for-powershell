...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class UpdateWAFRIPSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WAFRegional.Model.UpdateIPSetResponse).
        /// Specifying the name of a property of type Amazon.WAFRegional.Model.UpdateIPSetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WAFRegional.Model.UpdateIPSetResponse, UpdateWAFRIPSetCmdlet>(Select) ??
            ...
            if (this.Update != null)
            {
                context.Update = new List<Amazon.WAFRegional.Model.IPSetUpdate>(this.Update);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String IPSetId { get; set; }
            public List<Amazon.WAFRegional.Model.IPSetUpdate> Update { get; set; }
            public System.Func<Amazon.WAFRegional.Model.UpdateIPSetResponse, UpdateWAFRIPSetCmdlet, object> Select { get; set; } =
