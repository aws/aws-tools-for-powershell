...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Set", "SNSSMSAttributes", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    [AWSCmdlet("Invokes the SetSMSAttributes operation against Amazon Simple Notification Service.", Operation = new[] {"SetSMSAttributes"})]
    ...
    public partial class SetSNSSMSAttributesCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        /// actions.</para><para>For an example bucket policy and usage report, see <a href="http://docs.aws.amazon.com/sns/latest/dg/sms_stats.html">Viewing
        /// Statistics About SMS Message Delivery</a> in the <i>Amazon SNS Developer Guide</i>.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-SNSSMSAttributes (SetSMSAttributes)"))
            {
                return;
            }
