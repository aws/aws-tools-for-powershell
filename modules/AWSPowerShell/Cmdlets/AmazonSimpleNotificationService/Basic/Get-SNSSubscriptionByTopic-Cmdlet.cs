...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Notification Service ListSubscriptionsByTopic API operation.", Operation = new[] {"ListSubscriptionsByTopic"})]
    ...
    public partial class GetSNSSubscriptionByTopicCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Notification Service", "ListSubscriptionsByTopic");
            try
            {
                #if DESKTOP
                return client.ListSubscriptionsByTopic(request);
                #elif CORECLR
                return client.ListSubscriptionsByTopicAsync(request).GetAwaiter().GetResult();
                #else
