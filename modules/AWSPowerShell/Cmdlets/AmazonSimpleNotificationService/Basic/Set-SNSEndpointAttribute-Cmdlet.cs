...
namespace Amazon.PowerShell.Cmdlets.SNS
{
    ...
    [AWSCmdlet("Invokes the SetEndpointAttributes operation against Amazon Simple Notification Service.", Operation = new[] {"SetEndpointAttributes"}, LegacyAlias="Set-SNSEndpointAttributes")]
    ...
    public partial class SetSNSEndpointAttributeCmdlet : AmazonSimpleNotificationServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Notification Service", "SetEndpointAttributes");
            try
            {
                #if DESKTOP
