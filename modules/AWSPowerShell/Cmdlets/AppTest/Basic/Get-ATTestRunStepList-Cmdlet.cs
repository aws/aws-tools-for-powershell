...
{
    /// <summary>
    /// Lists test run steps.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetATTestRunStepListCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppTest.Model.ListTestRunStepsResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.ListTestRunStepsRequest request)
        {
            ...
            try
            {
                return client.ListTestRunStepsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
