...
namespace Amazon.PowerShell.Cmdlets.AT
{
    ...
    /// Deletes a test case.
    /// </summary>
    [Cmdlet("Remove", "ATTestCase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveATTestCaseCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TestCaseId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ATTestCase (DeleteTestCase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppTest.Model.DeleteTestCaseResponse, RemoveATTestCaseCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TestCaseId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppTest.Model.DeleteTestCaseRequest();
        ...
        private Amazon.AppTest.Model.DeleteTestCaseResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.DeleteTestCaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Mainframe Modernization Application Testing", "DeleteTestCase");
            try
            {
                #if DESKTOP
                return client.DeleteTestCase(request);
                #elif CORECLR
                return client.DeleteTestCaseAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TestCaseId { get; set; }
            public System.Func<Amazon.AppTest.Model.DeleteTestCaseResponse, RemoveATTestCaseCmdlet, object> Select { get; set; } =
