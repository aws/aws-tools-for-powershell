...
namespace Amazon.PowerShell.Cmdlets.AT
{
    ...
    /// Creates a test case.
    /// </summary>
    [Cmdlet("New", "ATTestCase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewATTestCaseCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The steps in the test case.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The specified tags of the test case.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-ATTestCase (CreateTestCase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppTest.Model.CreateTestCaseResponse, NewATTestCaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppTest.Model.CreateTestCaseRequest();
        ...
        private Amazon.AppTest.Model.CreateTestCaseResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.CreateTestCaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Mainframe Modernization Application Testing", "CreateTestCase");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppTest.Model.CreateTestCaseResponse, NewATTestCaseCmdlet, object> Select { get; set; } =
