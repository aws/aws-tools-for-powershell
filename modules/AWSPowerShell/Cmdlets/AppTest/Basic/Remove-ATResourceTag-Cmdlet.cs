...
namespace Amazon.PowerShell.Cmdlets.AT
{
    ...
    /// Untags a resource.
    /// </summary>
    [Cmdlet("Remove", "ATResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveATResourceTagCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag keys of the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ATResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppTest.Model.UntagResourceResponse, RemoveATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppTest.Model.UntagResourceRequest();
        ...
        private Amazon.AppTest.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Mainframe Modernization Application Testing", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppTest.Model.UntagResourceResponse, RemoveATResourceTagCmdlet, object> Select { get; set; } =
