...
namespace Amazon.PowerShell.Cmdlets.AT
{
    ...
    /// </summary>
    [Cmdlet("Add", "ATResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddATResourceTagCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ATResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppTest.Model.TagResourceResponse, AddATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppTest.Model.TagResourceRequest();
        ...
        private Amazon.AppTest.Model.TagResourceResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Mainframe Modernization Application Testing", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppTest.Model.TagResourceResponse, AddATResourceTagCmdlet, object> Select { get; set; } =
