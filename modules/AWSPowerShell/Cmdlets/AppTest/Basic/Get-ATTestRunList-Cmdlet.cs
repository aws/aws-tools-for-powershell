...
{
    /// <summary>
    /// Lists test runs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.AppTest.Model.TestRunSummary or Amazon.AppTest.Model.ListTestRunsResponse",
        ...
        "The service call response (type Amazon.AppTest.Model.ListTestRunsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetATTestRunListCmdlet : AmazonAppTestClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The test run IDs of the test runs.</para><para />
        ...
        private Amazon.AppTest.Model.ListTestRunsResponse CallAWSServiceOperation(IAmazonAppTest client, Amazon.AppTest.Model.ListTestRunsRequest request)
        {
            ...
            try
            {
                return client.ListTestRunsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
