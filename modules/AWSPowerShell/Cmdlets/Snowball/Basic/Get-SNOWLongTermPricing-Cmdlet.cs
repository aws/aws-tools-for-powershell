...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    /// </summary>
    [Cmdlet("Get", "SNOWLongTermPricing")]
    [OutputType("Amazon.Snowball.Model.LongTermPricingListEntry")]
    ...
    public partial class GetSNOWLongTermPricingCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LongTermPricingEntries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Snowball.Model.ListLongTermPricingResponse, GetSNOWLongTermPricingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Snowball.Model.ListLongTermPricingRequest();
        ...
        private Amazon.Snowball.Model.ListLongTermPricingResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.ListLongTermPricingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Import/Export Snowball", "ListLongTermPricing");
            try
            {
                #if DESKTOP
                return client.ListLongTermPricing(request);
                #elif CORECLR
                return client.ListLongTermPricingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Snowball.Model.ListLongTermPricingResponse, GetSNOWLongTermPricingCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LongTermPricingEntries;
        }
