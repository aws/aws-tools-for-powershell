...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Calls the AWS Import/Export Snowball ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.Snowball.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.Snowball.Model.JobListEntry or Amazon.Snowball.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.Snowball.Model.JobListEntry objects.",
        "The service call response (type Amazon.Snowball.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSNOWJobListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Snowball.Model.ListJobsResponse, GetSNOWJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Snowball.Model.ListJobsRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Snowball.Model.ListJobsResponse, GetSNOWJobListCmdlet, object> Select { get; set; } =
