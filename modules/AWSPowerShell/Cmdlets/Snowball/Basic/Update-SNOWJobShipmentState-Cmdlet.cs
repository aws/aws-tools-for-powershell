...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdletOutput("None or Amazon.Snowball.Model.UpdateJobShipmentStateResponse",
        ...
        "The service response (type Amazon.Snowball.Model.UpdateJobShipmentStateResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSNOWJobShipmentStateCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The job ID of the job whose shipment date you want to update, for example <code>JID123e4567-e89b-12d3-a456-426655440000</code>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.Snowball.Model.UpdateJobShipmentStateResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.UpdateJobShipmentStateRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateJobShipmentState(request);
                #elif CORECLR
                return client.UpdateJobShipmentStateAsync(request).GetAwaiter().GetResult();
                #else
