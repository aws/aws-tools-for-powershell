...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    /// on the AWS Marketplace.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetSNOWCompatibleImageListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CompatibleImages";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Snowball.Model.ListCompatibleImagesResponse, GetSNOWCompatibleImageListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Snowball.Model.ListCompatibleImagesResponse, GetSNOWCompatibleImageListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CompatibleImages;
        }
