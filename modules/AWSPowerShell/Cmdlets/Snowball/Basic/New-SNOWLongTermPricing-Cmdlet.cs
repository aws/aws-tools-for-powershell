...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdletOutput("System.String or Amazon.Snowball.Model.CreateLongTermPricingResponse",
        ...
        "The service call response (type Amazon.Snowball.Model.CreateLongTermPricingResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSNOWLongTermPricingCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^LongTermPricingType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.LongTermPricingType;
            }
        ...
        private Amazon.Snowball.Model.CreateLongTermPricingResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.CreateLongTermPricingRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateLongTermPricing(request);
                #elif CORECLR
                return client.CreateLongTermPricingAsync(request).GetAwaiter().GetResult();
                #else
