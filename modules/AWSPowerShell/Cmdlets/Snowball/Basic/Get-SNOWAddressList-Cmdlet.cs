...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [AWSCmdlet("Calls the AWS Import/Export Snowball DescribeAddresses API operation.", Operation = new[] {"DescribeAddresses"}, SelectReturnType = typeof(Amazon.Snowball.Model.DescribeAddressesResponse))]
    [AWSCmdletOutput("Amazon.Snowball.Model.Address or Amazon.Snowball.Model.DescribeAddressesResponse",
        "This cmdlet returns a collection of Amazon.Snowball.Model.Address objects.",
        "The service call response (type Amazon.Snowball.Model.DescribeAddressesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSNOWAddressListCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Snowball.Model.DescribeAddressesResponse, GetSNOWAddressListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Snowball.Model.DescribeAddressesResponse, GetSNOWAddressListCmdlet, object> Select { get; set; } =
