...
namespace Amazon.PowerShell.Cmdlets.SNOW
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Import/Export Snowball CancelCluster API operation.", Operation = new[] {"CancelCluster"}, SelectReturnType = typeof(Amazon.Snowball.Model.CancelClusterResponse))]
    [AWSCmdletOutput("None or Amazon.Snowball.Model.CancelClusterResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Snowball.Model.CancelClusterResponse) be returned by specifying '-Select *'."
    )]
    public partial class StopSNOWClusterCmdlet : AmazonSnowballClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Snowball.Model.CancelClusterResponse, StopSNOWClusterCmdlet>(Select) ??
        ...
        private Amazon.Snowball.Model.CancelClusterResponse CallAWSServiceOperation(IAmazonSnowball client, Amazon.Snowball.Model.CancelClusterRequest request)
        {
            ...
            try
            {
                return client.CancelClusterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ClusterId { get; set; }
            public System.Func<Amazon.Snowball.Model.CancelClusterResponse, StopSNOWClusterCmdlet, object> Select { get; set; } =
