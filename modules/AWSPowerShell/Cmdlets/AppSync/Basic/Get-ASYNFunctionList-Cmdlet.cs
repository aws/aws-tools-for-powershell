...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNFunctionList")]
    [OutputType("Amazon.AppSync.Model.FunctionConfiguration")]
    [AWSCmdlet("Calls the AWS AppSync ListFunctions API operation.", Operation = new[] {"ListFunctions"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListFunctionsResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.FunctionConfiguration or Amazon.AppSync.Model.ListFunctionsResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.FunctionConfiguration objects.",
        "The service call response (type Amazon.AppSync.Model.ListFunctionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASYNFunctionListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.ListFunctionsResponse, GetASYNFunctionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListFunctionsRequest();
        ...
        private Amazon.AppSync.Model.ListFunctionsResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListFunctionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListFunctions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppSync.Model.ListFunctionsResponse, GetASYNFunctionListCmdlet, object> Select { get; set; } =
