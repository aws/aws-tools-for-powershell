...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    public partial class StartASYNSchemaCreationCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.StartSchemaCreationResponse, StartASYNSchemaCreationCmdlet>(Select) ??
        ...
        private Amazon.AppSync.Model.StartSchemaCreationResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.StartSchemaCreationRequest request)
        {
            ...
            try
            {
                return client.StartSchemaCreationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public byte[] Definition { get; set; }
            public System.Func<Amazon.AppSync.Model.StartSchemaCreationResponse, StartASYNSchemaCreationCmdlet, object> Select { get; set; } =
