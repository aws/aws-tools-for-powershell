...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNDataSourceList")]
    [OutputType("Amazon.AppSync.Model.DataSource")]
    [AWSCmdlet("Calls the AWS AppSync ListDataSources API operation.", Operation = new[] {"ListDataSources"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListDataSourcesResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.DataSource or Amazon.AppSync.Model.ListDataSourcesResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.DataSource objects.",
        "The service call response (type Amazon.AppSync.Model.ListDataSourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASYNDataSourceListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.ListDataSourcesResponse, GetASYNDataSourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppSync.Model.ListDataSourcesRequest();
        ...
        private Amazon.AppSync.Model.ListDataSourcesResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListDataSourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListDataSources");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppSync.Model.ListDataSourcesResponse, GetASYNDataSourceListCmdlet, object> Select { get; set; } =
