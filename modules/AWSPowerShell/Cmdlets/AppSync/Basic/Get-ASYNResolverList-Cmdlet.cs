...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync ListResolvers API operation.", Operation = new[] {"ListResolvers"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListResolversResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.Resolver or Amazon.AppSync.Model.ListResolversResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.Resolver objects.",
        "The service call response (type Amazon.AppSync.Model.ListResolversResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASYNResolverListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.ListResolversResponse, GetASYNResolverListCmdlet>(Select) ??
        ...
        private Amazon.AppSync.Model.ListResolversResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListResolversRequest request)
        {
            ...
            try
            {
                return client.ListResolversAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TypeName { get; set; }
            public System.Func<Amazon.AppSync.Model.ListResolversResponse, GetASYNResolverListCmdlet, object> Select { get; set; } =
