...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ASYNApiCache", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveASYNApiCacheCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASYNApiCache (DeleteApiCache)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DeleteApiCacheResponse, RemoveASYNApiCacheCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.DeleteApiCacheRequest();
        ...
        private Amazon.AppSync.Model.DeleteApiCacheResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DeleteApiCacheRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "DeleteApiCache");
            try
            {
                #if DESKTOP
                return client.DeleteApiCache(request);
                #elif CORECLR
                return client.DeleteApiCacheAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApiId { get; set; }
            public System.Func<Amazon.AppSync.Model.DeleteApiCacheResponse, RemoveASYNApiCacheCmdlet, object> Select { get; set; } =
