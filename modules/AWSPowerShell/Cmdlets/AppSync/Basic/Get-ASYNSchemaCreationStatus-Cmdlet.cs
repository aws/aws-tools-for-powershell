...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNSchemaCreationStatus")]
    ...
    public partial class GetASYNSchemaCreationStatusCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.GetSchemaCreationStatusResponse, GetASYNSchemaCreationStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.GetSchemaCreationStatusRequest();
        ...
        private Amazon.AppSync.Model.GetSchemaCreationStatusResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.GetSchemaCreationStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "GetSchemaCreationStatus");
            try
            {
                #if DESKTOP
                return client.GetSchemaCreationStatus(request);
                #elif CORECLR
                return client.GetSchemaCreationStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApiId { get; set; }
            public System.Func<Amazon.AppSync.Model.GetSchemaCreationStatusResponse, GetASYNSchemaCreationStatusCmdlet, object> Select { get; set; } =
