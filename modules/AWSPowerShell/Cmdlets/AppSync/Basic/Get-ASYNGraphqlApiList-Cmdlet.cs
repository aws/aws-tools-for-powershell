...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASYNGraphqlApiList")]
    [OutputType("Amazon.AppSync.Model.GraphqlApi")]
    [AWSCmdlet("Calls the AWS AppSync ListGraphqlApis API operation.", Operation = new[] {"ListGraphqlApis"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListGraphqlApisResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.GraphqlApi or Amazon.AppSync.Model.ListGraphqlApisResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.GraphqlApi objects.",
        "The service call response (type Amazon.AppSync.Model.ListGraphqlApisResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASYNGraphqlApiListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GraphqlApis?.Count ?? 0;
        ...
        private Amazon.AppSync.Model.ListGraphqlApisResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListGraphqlApisRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "ListGraphqlApis");
            try
            {
                return client.ListGraphqlApisAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
