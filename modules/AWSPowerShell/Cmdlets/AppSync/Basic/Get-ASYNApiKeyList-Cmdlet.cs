...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync ListApiKeys API operation.", Operation = new[] {"ListApiKeys"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListApiKeysResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.ApiKey or Amazon.AppSync.Model.ListApiKeysResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.ApiKey objects.",
        "The service call response (type Amazon.AppSync.Model.ListApiKeysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASYNApiKeyListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ApiKeys";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.ListApiKeysResponse, GetASYNApiKeyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ApiKeys?.Count ?? 0;
        ...
        private Amazon.AppSync.Model.ListApiKeysResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListApiKeysRequest request)
        {
            ...
            try
            {
                return client.ListApiKeysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppSync.Model.ListApiKeysResponse, GetASYNApiKeyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ApiKeys;
        }
