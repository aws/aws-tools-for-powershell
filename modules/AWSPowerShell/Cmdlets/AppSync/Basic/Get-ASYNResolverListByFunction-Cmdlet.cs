...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync ListResolversByFunction API operation.", Operation = new[] {"ListResolversByFunction"}, SelectReturnType = typeof(Amazon.AppSync.Model.ListResolversByFunctionResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.Resolver or Amazon.AppSync.Model.ListResolversByFunctionResponse",
        "This cmdlet returns a collection of Amazon.AppSync.Model.Resolver objects.",
        "The service call response (type Amazon.AppSync.Model.ListResolversByFunctionResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASYNResolverListByFunctionCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Resolvers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.ListResolversByFunctionResponse, GetASYNResolverListByFunctionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Resolvers?.Count ?? 0;
        ...
        private Amazon.AppSync.Model.ListResolversByFunctionResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListResolversByFunctionRequest request)
        {
            ...
            try
            {
                return client.ListResolversByFunctionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppSync.Model.ListResolversByFunctionResponse, GetASYNResolverListByFunctionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Resolvers;
        }
