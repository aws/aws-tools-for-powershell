...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    public partial class StopASYNApiAssociationCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-ASYNApiAssociation (DisassociateApi)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DisassociateApiResponse, StopASYNApiAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.DisassociateApiRequest();
        ...
        private Amazon.AppSync.Model.DisassociateApiResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DisassociateApiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "DisassociateApi");
            try
            {
                #if DESKTOP
                return client.DisassociateApi(request);
                #elif CORECLR
                return client.DisassociateApiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.AppSync.Model.DisassociateApiResponse, StopASYNApiAssociationCmdlet, object> Select { get; set; } =
