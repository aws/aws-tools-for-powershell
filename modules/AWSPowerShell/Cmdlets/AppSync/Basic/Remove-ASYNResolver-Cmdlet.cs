...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS AppSync DeleteResolver API operation.", Operation = new[] {"DeleteResolver"}, SelectReturnType = typeof(Amazon.AppSync.Model.DeleteResolverResponse))]
    [AWSCmdletOutput("None or Amazon.AppSync.Model.DeleteResolverResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AppSync.Model.DeleteResolverResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveASYNResolverCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DeleteResolverResponse, RemoveASYNResolverCmdlet>(Select) ??
        ...
        private Amazon.AppSync.Model.DeleteResolverResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DeleteResolverRequest request)
        {
            ...
            try
            {
                return client.DeleteResolverAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FieldName { get; set; }
            public System.String TypeName { get; set; }
            public System.Func<Amazon.AppSync.Model.DeleteResolverResponse, RemoveASYNResolverCmdlet, object> Select { get; set; } =
