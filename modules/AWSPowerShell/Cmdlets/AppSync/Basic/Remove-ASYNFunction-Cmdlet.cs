...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    public partial class RemoveASYNFunctionCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASYNFunction (DeleteFunction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DeleteFunctionResponse, RemoveASYNFunctionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.DeleteFunctionRequest();
        ...
        private Amazon.AppSync.Model.DeleteFunctionResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DeleteFunctionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "DeleteFunction");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String FunctionId { get; set; }
            public System.Func<Amazon.AppSync.Model.DeleteFunctionResponse, RemoveASYNFunctionCmdlet, object> Select { get; set; } =
