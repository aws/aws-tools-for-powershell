...
{
    /// <summary>
    /// Lists the <c>SourceApiAssociationSummary</c> data.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.AppSync.Model.SourceApiAssociationSummary or Amazon.AppSync.Model.ListSourceApiAssociationsResponse",
        ...
        "The service call response (type Amazon.AppSync.Model.ListSourceApiAssociationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASYNSourceApiAssociationListCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppSync.Model.ListSourceApiAssociationsResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.ListSourceApiAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListSourceApiAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
