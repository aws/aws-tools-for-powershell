...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync UpdateType API operation.", Operation = new[] {"UpdateType"}, SelectReturnType = typeof(Amazon.AppSync.Model.UpdateTypeResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.Type or Amazon.AppSync.Model.UpdateTypeResponse",
        "This cmdlet returns an Amazon.AppSync.Model.Type object.",
        "The service call response (type Amazon.AppSync.Model.UpdateTypeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateASYNTypeCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.UpdateTypeResponse, UpdateASYNTypeCmdlet>(Select) ??
        ...
        private Amazon.AppSync.Model.UpdateTypeResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.UpdateTypeRequest request)
        {
            ...
            try
            {
                return client.UpdateTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.AppSync.TypeDefinitionFormat Format { get; set; }
            public System.String TypeName { get; set; }
            public System.Func<Amazon.AppSync.Model.UpdateTypeResponse, UpdateASYNTypeCmdlet, object> Select { get; set; } =
