...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS AppSync DeleteType API operation.", Operation = new[] {"DeleteType"}, SelectReturnType = typeof(Amazon.AppSync.Model.DeleteTypeResponse))]
    [AWSCmdletOutput("None or Amazon.AppSync.Model.DeleteTypeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AppSync.Model.DeleteTypeResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveASYNTypeCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASYNType (DeleteType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DeleteTypeResponse, RemoveASYNTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.DeleteTypeRequest();
        ...
        private Amazon.AppSync.Model.DeleteTypeResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DeleteTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "DeleteType");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApiId { get; set; }
            public System.String TypeName { get; set; }
            public System.Func<Amazon.AppSync.Model.DeleteTypeResponse, RemoveASYNTypeCmdlet, object> Select { get; set; } =
