...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdletOutput("Amazon.AppSync.Model.GetDataSourceIntrospectionResponse",
        "This cmdlet returns an Amazon.AppSync.Model.GetDataSourceIntrospectionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASYNDataSourceIntrospectionCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the IntrospectionId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^IntrospectionId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^IntrospectionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.IntrospectionId;
            }
        ...
        private Amazon.AppSync.Model.GetDataSourceIntrospectionResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.GetDataSourceIntrospectionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetDataSourceIntrospection(request);
                #elif CORECLR
                return client.GetDataSourceIntrospectionAsync(request).GetAwaiter().GetResult();
                #else
