...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    public partial class GetASYNDomainNameCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.GetDomainNameResponse, GetASYNDomainNameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.GetDomainNameRequest();
        ...
        private Amazon.AppSync.Model.GetDomainNameResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.GetDomainNameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "GetDomainName");
            try
            {
                return client.GetDomainNameAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.AppSync.Model.GetDomainNameResponse, GetASYNDomainNameCmdlet, object> Select { get; set; } =
