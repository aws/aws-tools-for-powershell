...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    [AWSCmdlet("Calls the AWS AppSync GetApiCache API operation.", Operation = new[] {"GetApiCache"}, SelectReturnType = typeof(Amazon.AppSync.Model.GetApiCacheResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.ApiCache or Amazon.AppSync.Model.GetApiCacheResponse",
        "This cmdlet returns an Amazon.AppSync.Model.ApiCache object.",
        "The service call response (type Amazon.AppSync.Model.GetApiCacheResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASYNApiCacheCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.GetApiCacheResponse, GetASYNApiCacheCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.GetApiCacheRequest();
        ...
        private Amazon.AppSync.Model.GetApiCacheResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.GetApiCacheRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "GetApiCache");
            try
            {
                #if DESKTOP
                return client.GetApiCache(request);
                #elif CORECLR
                return client.GetApiCacheAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApiId { get; set; }
            public System.Func<Amazon.AppSync.Model.GetApiCacheResponse, GetASYNApiCacheCmdlet, object> Select { get; set; } =
