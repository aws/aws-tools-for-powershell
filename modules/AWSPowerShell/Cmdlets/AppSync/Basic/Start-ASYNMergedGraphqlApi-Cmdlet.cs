...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    /// identifier.
    /// </summary>
    [Cmdlet("Start", "ASYNMergedGraphqlApi", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.AppSync.Model.SourceApiAssociation")]
    [AWSCmdlet("Calls the AWS AppSync AssociateMergedGraphqlApi API operation.", Operation = new[] {"AssociateMergedGraphqlApi"}, SelectReturnType = typeof(Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse))]
    [AWSCmdletOutput("Amazon.AppSync.Model.SourceApiAssociation or Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse",
        "This cmdlet returns an Amazon.AppSync.Model.SourceApiAssociation object.",
        "The service call response (type Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartASYNMergedGraphqlApiCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse).
        /// Specifying the name of a property of type Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-ASYNMergedGraphqlApi (AssociateMergedGraphqlApi)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse, StartASYNMergedGraphqlApiCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.AssociateMergedGraphqlApiRequest();
        ...
        private Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.AssociateMergedGraphqlApiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "AssociateMergedGraphqlApi");
            try
            {
                #if DESKTOP
                return client.AssociateMergedGraphqlApi(request);
                #elif CORECLR
                return client.AssociateMergedGraphqlApiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.AppSync.MergeType SourceApiAssociationConfig_MergeType { get; set; }
            public System.String SourceApiIdentifier { get; set; }
            public System.Func<Amazon.AppSync.Model.AssociateMergedGraphqlApiResponse, StartASYNMergedGraphqlApiCmdlet, object> Select { get; set; } =
