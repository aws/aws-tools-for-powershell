...
namespace Amazon.PowerShell.Cmdlets.ASYN
{
    ...
    public partial class RemoveASYNGraphqlApiCmdlet : AmazonAppSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASYNGraphqlApi (DeleteGraphqlApi)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppSync.Model.DeleteGraphqlApiResponse, RemoveASYNGraphqlApiCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppSync.Model.DeleteGraphqlApiRequest();
        ...
        private Amazon.AppSync.Model.DeleteGraphqlApiResponse CallAWSServiceOperation(IAmazonAppSync client, Amazon.AppSync.Model.DeleteGraphqlApiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppSync", "DeleteGraphqlApi");
            try
            {
                #if DESKTOP
                return client.DeleteGraphqlApi(request);
                #elif CORECLR
                return client.DeleteGraphqlApiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApiId { get; set; }
            public System.Func<Amazon.AppSync.Model.DeleteGraphqlApiResponse, RemoveASYNGraphqlApiCmdlet, object> Select { get; set; } =
