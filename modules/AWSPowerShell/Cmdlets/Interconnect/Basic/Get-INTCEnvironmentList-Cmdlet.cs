...
namespace Amazon.PowerShell.Cmdlets.INTC
{
    ...
    /// AWS region.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "INTCEnvironmentList")]
    [OutputType("Amazon.Interconnect.Model.Environment")]
    [AWSCmdlet("Calls the Interconnect ListEnvironments API operation.", Operation = new[] {"ListEnvironments"}, SelectReturnType = typeof(Amazon.Interconnect.Model.ListEnvironmentsResponse))]
    [AWSCmdletOutput("Amazon.Interconnect.Model.Environment or Amazon.Interconnect.Model.ListEnvironmentsResponse",
        "This cmdlet returns a collection of Amazon.Interconnect.Model.Environment objects.",
        "The service call response (type Amazon.Interconnect.Model.ListEnvironmentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetINTCEnvironmentListCmdlet : AmazonInterconnectClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filter results to only include <a>Environment</a> objects that connect to a given
        /// location distiguisher.</para>
        /// </para>
        /// </summary>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Interconnect.Model.ListEnvironmentsResponse).
        /// Specifying the name of a property of type Amazon.Interconnect.Model.ListEnvironmentsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Interconnect.Model.ListEnvironmentsResponse, GetINTCEnvironmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Interconnect.Model.ListEnvironmentsRequest();
        ...
        private Amazon.Interconnect.Model.ListEnvironmentsResponse CallAWSServiceOperation(IAmazonInterconnect client, Amazon.Interconnect.Model.ListEnvironmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Interconnect", "ListEnvironments");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Provider_CloudServiceProvider { get; set; }
            public System.String Provider_LastMileProvider { get; set; }
            public System.Func<Amazon.Interconnect.Model.ListEnvironmentsResponse, GetINTCEnvironmentListCmdlet, object> Select { get; set; } =
