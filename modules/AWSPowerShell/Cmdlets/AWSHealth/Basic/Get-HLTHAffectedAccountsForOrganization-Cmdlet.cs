...
namespace Amazon.PowerShell.Cmdlets.HLTH
{
    ...
    [AWSCmdlet("Calls the AWS Health DescribeAffectedAccountsForOrganization API operation.", Operation = new[] {"DescribeAffectedAccountsForOrganization"}, SelectReturnType = typeof(Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse))]
    [AWSCmdletOutput("System.String or Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetHLTHAffectedAccountsForOrganizationCmdlet : AmazonAWSHealthClientCmdlet, IExecutor
    {
        
        #region Parameter EventArn
        /// <summary>
        /// <para>
        /// <para>The unique identifier for the event. Format: <code>arn:aws:health:<i>event-region</i>::event/<i>SERVICE</i>/<i>EVENT_TYPE_CODE</i>/<i>EVENT_TYPE_PLUS_ID</i></code>. Example: <code>Example: arn:aws:health:us-east-1::event/EC2/EC2_INSTANCE_RETIREMENT_SCHEDULED/EC2_INSTANCE_RETIREMENT_SCHEDULED_ABC123-DEF456</code></para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AffectedAccounts";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse, GetHLTHAffectedAccountsForOrganizationCmdlet>(Select) ??
            ...
            context.EventArn = this.EventArn;
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationRequest();
            
            if (cmdletContext.EventArn != null)
            {
                request.EventArn = cmdletContext.EventArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AffectedAccounts.Count;
        ...
        private Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse CallAWSServiceOperation(IAmazonAWSHealth client, Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Health", "DescribeAffectedAccountsForOrganization");
            try
            {
                #if DESKTOP
                return client.DescribeAffectedAccountsForOrganization(request);
                #elif CORECLR
                return client.DescribeAffectedAccountsForOrganizationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AWSHealth.Model.DescribeAffectedAccountsForOrganizationResponse, GetHLTHAffectedAccountsForOrganizationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AffectedAccounts;
        }
