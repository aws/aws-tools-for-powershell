#
# Module manifest for module 'AWS.Tools.PartnerCentralSelling'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.PartnerCentralSelling.dll'
    ...
    GUID = '03d14f9c-b353-42cf-9722-4b13a3128df0'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.PartnerCentralSelling.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.PartnerCentralSelling.Completers.psm1',
        'AWS.Tools.PartnerCentralSelling.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.PartnerCentralSelling.dll-Help.xml'
    )
