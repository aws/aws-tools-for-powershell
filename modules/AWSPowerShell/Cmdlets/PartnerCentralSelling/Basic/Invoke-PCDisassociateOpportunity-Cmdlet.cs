...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    public partial class InvokePCDisassociateOpportunityCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        /// entities. This identifier helps to ensure that the correct opportunity is updated.</para><para>Validation: Ensure that the provided identifier corresponds to an existing opportunity
        ...
        /// Amazon Web Services MarketplaceUsing the Amazon Web Services Marketplace Catalog API</a>.</para><para>Validation: Ensure the identifier or ARN is valid and corresponds to an existing entity.
        ...
        private Amazon.PartnerCentralSelling.Model.DisassociateOpportunityResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.DisassociateOpportunityRequest request)
        {
            ...
            try
            {
                return client.DisassociateOpportunityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
