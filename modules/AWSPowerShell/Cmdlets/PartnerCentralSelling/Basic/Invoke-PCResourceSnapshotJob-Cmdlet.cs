...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    /// </summary>
    [Cmdlet("Invoke", "PCResourceSnapshotJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse")]
    [AWSCmdlet("Calls the Partner Central Selling API CreateResourceSnapshotJob API operation.", Operation = new[] {"CreateResourceSnapshotJob"}, SelectReturnType = typeof(Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse",
        "This cmdlet returns an Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse object containing multiple properties."
    )]
    public partial class InvokePCResourceSnapshotJobCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse).
        /// Specifying the name of a property of type Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-PCResourceSnapshotJob (CreateResourceSnapshotJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse, InvokePCResourceSnapshotJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobRequest();
        ...
        private Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.CreateResourceSnapshotJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Selling API", "CreateResourceSnapshotJob");
            try
            {
                #if DESKTOP
                return client.CreateResourceSnapshotJob(request);
                #elif CORECLR
                return client.CreateResourceSnapshotJobAsync(request).GetAwaiter().GetResult();
                #else
