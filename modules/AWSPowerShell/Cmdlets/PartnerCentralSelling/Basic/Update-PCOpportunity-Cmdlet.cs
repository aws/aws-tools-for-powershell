...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    public partial class UpdatePCOpportunityCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        /// a partner may be receiving an upfront discount on a service (for example: EDP deals).</para></li><li><para>Cosell—Technical Consultation: Connection with an Amazon Web Services Solutions Architect
        ...
        /// at any stage during their lifecycle. Also known as, for-visibility-only (FVO) opportunity.</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
