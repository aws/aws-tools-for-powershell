...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "PCOpportunity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse")]
    [AWSCmdlet("Calls the Partner Central Selling API UpdateOpportunity API operation.", Operation = new[] {"UpdateOpportunity"}, SelectReturnType = typeof(Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse",
    ...
    public partial class UpdatePCOpportunityCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        #region Parameter LastModifiedDate
        /// <summary>
        /// <para>
        ...
        /// and support for the partner's proposed solution. </para></li><li><para> Co-Sell - Pricing Assistance: Connect with an AWS seller for support situations where
        /// a partner may be receiving an upfront discount on a service (for example: EDP deals).
        /// </para></li><li><para> Co-Sell - Technical Consultation: Connection with an Amazon Web Services Solutions
        /// Architect to address the partner's questions about the proposed solution. </para></li><li><para> Co-Sell - Total Cost of Ownership Evaluation: Assistance with quoting different cost
        ...
        /// where the partner needs RFx support from Amazon Web Services. </para></li><li><para> Do Not Need Support from AWS Sales Rep: Indicates that a partner doesn't need support
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-PCOpportunity (UpdateOpportunity)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse, UpdatePCOpportunityCmdlet>(Select) ??
            ...
            #endif
            context.LastModifiedDate = this.LastModifiedDate;
            #if MODULAR
            if (this.LastModifiedDate == null && ParameterWasBound(nameof(this.LastModifiedDate)))
            {
                WriteWarning("You are passing $null as a value for parameter LastModifiedDate which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralSelling.Model.UpdateOpportunityRequest();
            ...
            if (cmdletContext.LastModifiedDate != null)
            {
                request.LastModifiedDate = cmdletContext.LastModifiedDate.Value;
            }
        ...
        private Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.UpdateOpportunityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Selling API", "UpdateOpportunity");
            try
            {
                #if DESKTOP
                return client.UpdateOpportunity(request);
                #elif CORECLR
                return client.UpdateOpportunityAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Value_Amount { get; set; }
            public Amazon.PartnerCentralSelling.CurrencyCode Value_CurrencyCode { get; set; }
            public System.Func<Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse, UpdatePCOpportunityCmdlet, object> Select { get; set; } =
