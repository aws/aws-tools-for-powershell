...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    public partial class UpdatePCOpportunityCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        /// the partner needs RFx support from Amazon Web Services.</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.PartnerCentralSelling.Model.UpdateOpportunityResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.UpdateOpportunityRequest request)
        {
            ...
            try
            {
                return client.UpdateOpportunityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
