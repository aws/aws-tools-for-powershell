...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    /// and has at least one snapshot in the engagement.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetPCEngagementResourceAssociationListCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        private Amazon.PartnerCentralSelling.Model.ListEngagementResourceAssociationsResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.ListEngagementResourceAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListEngagementResourceAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
