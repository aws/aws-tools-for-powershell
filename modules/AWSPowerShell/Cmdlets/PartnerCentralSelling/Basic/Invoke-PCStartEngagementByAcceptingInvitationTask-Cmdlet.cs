...
namespace Amazon.PowerShell.Cmdlets.PC
{
    ...
    [AWSCmdlet("Calls the Partner Central Selling API StartEngagementByAcceptingInvitationTask API operation.", Operation = new[] {"StartEngagementByAcceptingInvitationTask"}, SelectReturnType = typeof(Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskResponse))]
    [AWSCmdletOutput("Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskResponse",
        "This cmdlet returns an Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskResponse object containing multiple properties."
    )]
    public partial class InvokePCStartEngagementByAcceptingInvitationTaskCmdlet : AmazonPartnerCentralSellingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-PCStartEngagementByAcceptingInvitationTask (StartEngagementByAcceptingInvitationTask)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskResponse, InvokePCStartEngagementByAcceptingInvitationTaskCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskRequest();
        ...
        private Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskResponse CallAWSServiceOperation(IAmazonPartnerCentralSelling client, Amazon.PartnerCentralSelling.Model.StartEngagementByAcceptingInvitationTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Partner Central Selling API", "StartEngagementByAcceptingInvitationTask");
            try
            {
                #if DESKTOP
                return client.StartEngagementByAcceptingInvitationTask(request);
                #elif CORECLR
                return client.StartEngagementByAcceptingInvitationTaskAsync(request).GetAwaiter().GetResult();
                #else
