...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    public partial class GrantMTRQualificationRequestCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^QualificationRequestId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.QualificationRequestId;
            }
        ...
        private Amazon.MTurk.Model.AcceptQualificationRequestResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.AcceptQualificationRequestRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.AcceptQualificationRequest(request);
                #elif CORECLR
                return client.AcceptQualificationRequestAsync(request).GetAwaiter().GetResult();
                #else
