...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    public partial class AddMTRQualificationToWorkerCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.AssociateQualificationWithWorkerResponse, AddMTRQualificationToWorkerCmdlet>(Select) ??
        ...
        private Amazon.MTurk.Model.AssociateQualificationWithWorkerResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.AssociateQualificationWithWorkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MTurk Service", "AssociateQualificationWithWorker");
            try
            {
                return client.AssociateQualificationWithWorkerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? SendNotification { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.MTurk.Model.AssociateQualificationWithWorkerResponse, AddMTRQualificationToWorkerCmdlet, object> Select { get; set; } =
