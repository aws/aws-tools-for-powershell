...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    public partial class RemoveMTRQualificationTypeCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.DeleteQualificationTypeResponse, RemoveMTRQualificationTypeCmdlet>(Select) ??
        ...
        private Amazon.MTurk.Model.DeleteQualificationTypeResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.DeleteQualificationTypeRequest request)
        {
            ...
            try
            {
                return client.DeleteQualificationTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String QualificationTypeId { get; set; }
            public System.Func<Amazon.MTurk.Model.DeleteQualificationTypeResponse, RemoveMTRQualificationTypeCmdlet, object> Select { get; set; } =
