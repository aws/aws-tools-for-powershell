...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "MTRQualificationFromWorker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMTRQualificationFromWorkerCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MTRQualificationFromWorker (DisassociateQualificationFromWorker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.DisassociateQualificationFromWorkerResponse, RemoveMTRQualificationFromWorkerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MTurk.Model.DisassociateQualificationFromWorkerRequest();
        ...
        private Amazon.MTurk.Model.DisassociateQualificationFromWorkerResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.DisassociateQualificationFromWorkerRequest request)
        {
            ...
            try
            {
                return client.DisassociateQualificationFromWorkerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Reason { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.MTurk.Model.DisassociateQualificationFromWorkerResponse, RemoveMTRQualificationFromWorkerCmdlet, object> Select { get; set; } =
