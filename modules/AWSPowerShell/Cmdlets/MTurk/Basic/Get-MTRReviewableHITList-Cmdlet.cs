...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Calls the Amazon MTurk Service ListReviewableHITs API operation.", Operation = new[] {"ListReviewableHITs"}, SelectReturnType = typeof(Amazon.MTurk.Model.ListReviewableHITsResponse))]
    [AWSCmdletOutput("Amazon.MTurk.Model.HIT or Amazon.MTurk.Model.ListReviewableHITsResponse",
        "This cmdlet returns a collection of Amazon.MTurk.Model.HIT objects.",
        "The service call response (type Amazon.MTurk.Model.ListReviewableHITsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMTRReviewableHITListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListReviewableHITsResponse, GetMTRReviewableHITListCmdlet>(Select) ??
        ...
        private Amazon.MTurk.Model.ListReviewableHITsResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListReviewableHITsRequest request)
        {
            ...
            try
            {
                return client.ListReviewableHITsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.MTurk.ReviewableHITStatus Status { get; set; }
            public System.Func<Amazon.MTurk.Model.ListReviewableHITsResponse, GetMTRReviewableHITListCmdlet, object> Select { get; set; } =
