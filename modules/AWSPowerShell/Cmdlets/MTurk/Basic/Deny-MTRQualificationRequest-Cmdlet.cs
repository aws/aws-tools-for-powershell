...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon MTurk Service RejectQualificationRequest API operation.", Operation = new[] {"RejectQualificationRequest"}, SelectReturnType = typeof(Amazon.MTurk.Model.RejectQualificationRequestResponse))]
    [AWSCmdletOutput("None or Amazon.MTurk.Model.RejectQualificationRequestResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.MTurk.Model.RejectQualificationRequestResponse) be returned by specifying '-Select *'."
    )]
    public partial class DenyMTRQualificationRequestCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.RejectQualificationRequestResponse, DenyMTRQualificationRequestCmdlet>(Select) ??
        ...
        private Amazon.MTurk.Model.RejectQualificationRequestResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.RejectQualificationRequestRequest request)
        {
            ...
            try
            {
                return client.RejectQualificationRequestAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String QualificationRequestId { get; set; }
            public System.String Reason { get; set; }
            public System.Func<Amazon.MTurk.Model.RejectQualificationRequestResponse, DenyMTRQualificationRequestCmdlet, object> Select { get; set; } =
