...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Calls the Amazon MTurk Service ListBonusPayments API operation.", Operation = new[] {"ListBonusPayments"}, SelectReturnType = typeof(Amazon.MTurk.Model.ListBonusPaymentsResponse))]
    [AWSCmdletOutput("Amazon.MTurk.Model.BonusPayment or Amazon.MTurk.Model.ListBonusPaymentsResponse",
        "This cmdlet returns a collection of Amazon.MTurk.Model.BonusPayment objects.",
        "The service call response (type Amazon.MTurk.Model.ListBonusPaymentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMTRBonusPaymentListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BonusPayments";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListBonusPaymentsResponse, GetMTRBonusPaymentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MTurk.Model.ListBonusPaymentsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BonusPayments?.Count ?? 0;
        ...
        private Amazon.MTurk.Model.ListBonusPaymentsResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListBonusPaymentsRequest request)
        {
            ...
            try
            {
                return client.ListBonusPaymentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MTurk.Model.ListBonusPaymentsResponse, GetMTRBonusPaymentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BonusPayments;
        }
