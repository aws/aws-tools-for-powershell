...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    /// </summary>
    [Cmdlet("Get", "MTRHITList")]
    [OutputType("Amazon.MTurk.Model.HIT")]
    [AWSCmdlet("Calls the Amazon MTurk Service ListHITs API operation.", Operation = new[] {"ListHITs"}, SelectReturnType = typeof(Amazon.MTurk.Model.ListHITsResponse))]
    [AWSCmdletOutput("Amazon.MTurk.Model.HIT or Amazon.MTurk.Model.ListHITsResponse",
        "This cmdlet returns a collection of Amazon.MTurk.Model.HIT objects.",
        "The service call response (type Amazon.MTurk.Model.ListHITsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMTRHITListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HITs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListHITsResponse, GetMTRHITListCmdlet>(Select) ??
        ...
        private Amazon.MTurk.Model.ListHITsResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListHITsRequest request)
        {
            ...
            try
            {
                return client.ListHITsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MTurk.Model.ListHITsResponse, GetMTRHITListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HITs;
        }
