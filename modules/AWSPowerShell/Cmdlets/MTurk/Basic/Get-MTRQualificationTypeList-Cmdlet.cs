...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Calls the Amazon MTurk Service ListQualificationTypes API operation.", Operation = new[] {"ListQualificationTypes"}, SelectReturnType = typeof(Amazon.MTurk.Model.ListQualificationTypesResponse))]
    [AWSCmdletOutput("Amazon.MTurk.Model.QualificationType or Amazon.MTurk.Model.ListQualificationTypesResponse",
        "This cmdlet returns a collection of Amazon.MTurk.Model.QualificationType objects.",
        "The service call response (type Amazon.MTurk.Model.ListQualificationTypesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMTRQualificationTypeListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "QualificationTypes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListQualificationTypesResponse, GetMTRQualificationTypeListCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.MustBeRequestable == null && ParameterWasBound(nameof(this.MustBeRequestable)))
            {
                WriteWarning("You are passing $null as a value for parameter MustBeRequestable which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.QualificationTypes?.Count ?? 0;
        ...
        private Amazon.MTurk.Model.ListQualificationTypesResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListQualificationTypesRequest request)
        {
            ...
            try
            {
                return client.ListQualificationTypesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String Query { get; set; }
            public System.Func<Amazon.MTurk.Model.ListQualificationTypesResponse, GetMTRQualificationTypeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.QualificationTypes;
        }
