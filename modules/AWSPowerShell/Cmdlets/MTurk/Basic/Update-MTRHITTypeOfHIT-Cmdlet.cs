...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    /// </summary>
    [Cmdlet("Update", "MTRHITTypeOfHIT", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon MTurk Service UpdateHITTypeOfHIT API operation.", Operation = new[] {"UpdateHITTypeOfHIT"}, SelectReturnType = typeof(Amazon.MTurk.Model.UpdateHITTypeOfHITResponse))]
    [AWSCmdletOutput("None or Amazon.MTurk.Model.UpdateHITTypeOfHITResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.MTurk.Model.UpdateHITTypeOfHITResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateMTRHITTypeOfHITCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-MTRHITTypeOfHIT (UpdateHITTypeOfHIT)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.UpdateHITTypeOfHITResponse, UpdateMTRHITTypeOfHITCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MTurk.Model.UpdateHITTypeOfHITRequest();
        ...
        private Amazon.MTurk.Model.UpdateHITTypeOfHITResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.UpdateHITTypeOfHITRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MTurk Service", "UpdateHITTypeOfHIT");
            try
            {
                #if DESKTOP
                return client.UpdateHITTypeOfHIT(request);
                #elif CORECLR
                return client.UpdateHITTypeOfHITAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String HITId { get; set; }
            public System.String HITTypeId { get; set; }
            public System.Func<Amazon.MTurk.Model.UpdateHITTypeOfHITResponse, UpdateMTRHITTypeOfHITCmdlet, object> Select { get; set; } =
