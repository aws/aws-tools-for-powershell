...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Calls the Amazon MTurk Service ListWorkersWithQualificationType API operation.", Operation = new[] {"ListWorkersWithQualificationType"}, SelectReturnType = typeof(Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse))]
    [AWSCmdletOutput("Amazon.MTurk.Model.Qualification or Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse",
        "This cmdlet returns a collection of Amazon.MTurk.Model.Qualification objects.",
        "The service call response (type Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMTRWorkersWithQualificationTypeCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Qualifications";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse, GetMTRWorkersWithQualificationTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Qualifications?.Count ?? 0;
        ...
        private Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListWorkersWithQualificationTypeRequest request)
        {
            ...
            try
            {
                return client.ListWorkersWithQualificationTypeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QualificationTypeId { get; set; }
            public Amazon.MTurk.QualificationStatus Status { get; set; }
            public System.Func<Amazon.MTurk.Model.ListWorkersWithQualificationTypeResponse, GetMTRWorkersWithQualificationTypeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Qualifications;
        }
