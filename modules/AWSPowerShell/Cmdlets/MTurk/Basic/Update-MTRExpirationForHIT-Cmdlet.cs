...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    public partial class UpdateMTRExpirationForHITCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.UpdateExpirationForHITResponse, UpdateMTRExpirationForHITCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.ExpireAt = this.ExpireAt;
            #if MODULAR
            if (this.ExpireAt == null && ParameterWasBound(nameof(this.ExpireAt)))
            {
                WriteWarning("You are passing $null as a value for parameter ExpireAt which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.MTurk.Model.UpdateExpirationForHITResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.UpdateExpirationForHITRequest request)
        {
            ...
            try
            {
                return client.UpdateExpirationForHITAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.DateTime? ExpireAt { get; set; }
            public System.String HITId { get; set; }
            public System.Func<Amazon.MTurk.Model.UpdateExpirationForHITResponse, UpdateMTRExpirationForHITCmdlet, object> Select { get; set; } =
