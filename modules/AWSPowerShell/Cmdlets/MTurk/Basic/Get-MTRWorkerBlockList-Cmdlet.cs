...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    /// </summary>
    [Cmdlet("Get", "MTRWorkerBlockList")]
    [OutputType("Amazon.MTurk.Model.WorkerBlock")]
    ...
    public partial class GetMTRWorkerBlockListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "WorkerBlocks";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MTurk.Model.ListWorkerBlocksResponse, GetMTRWorkerBlockListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MTurk.Model.ListWorkerBlocksRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.WorkerBlocks?.Count ?? 0;
        ...
        private Amazon.MTurk.Model.ListWorkerBlocksResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListWorkerBlocksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MTurk Service", "ListWorkerBlocks");
            try
            {
                #if DESKTOP
                return client.ListWorkerBlocks(request);
                #elif CORECLR
                return client.ListWorkerBlocksAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MTurk.Model.ListWorkerBlocksResponse, GetMTRWorkerBlockListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.WorkerBlocks;
        }
