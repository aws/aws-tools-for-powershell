...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    public partial class GetEVBConnectionCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DescribeConnectionResponse, GetEVBConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DescribeConnectionRequest();
        ...
        private Amazon.EventBridge.Model.DescribeConnectionResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DescribeConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DescribeConnection");
            try
            {
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DescribeConnectionResponse, GetEVBConnectionCmdlet, object> Select { get; set; } =
