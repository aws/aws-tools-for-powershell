...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdlet("Calls the Amazon EventBridge ListTargetsByRule API operation.", Operation = new[] {"ListTargetsByRule"}, SelectReturnType = typeof(Amazon.EventBridge.Model.ListTargetsByRuleResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.Target or Amazon.EventBridge.Model.ListTargetsByRuleResponse",
        "This cmdlet returns a collection of Amazon.EventBridge.Model.Target objects.",
        "The service call response (type Amazon.EventBridge.Model.ListTargetsByRuleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEVBTargetsByRuleCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.ListTargetsByRuleResponse, GetEVBTargetsByRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EventBridge.Model.ListTargetsByRuleRequest();
        ...
        private Amazon.EventBridge.Model.ListTargetsByRuleResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.ListTargetsByRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "ListTargetsByRule");
            try
            {
                return client.ListTargetsByRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String Rule { get; set; }
            public System.Func<Amazon.EventBridge.Model.ListTargetsByRuleResponse, GetEVBTargetsByRuleCmdlet, object> Select { get; set; } =
