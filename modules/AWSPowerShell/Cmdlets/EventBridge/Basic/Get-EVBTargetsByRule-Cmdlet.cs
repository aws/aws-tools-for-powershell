...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdletOutput("Amazon.EventBridge.Model.Target or Amazon.EventBridge.Model.ListTargetsByRuleResponse",
        ...
        "The service call response (type Amazon.EventBridge.Model.ListTargetsByRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
