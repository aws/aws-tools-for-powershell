...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EVBPartnerEventSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEVBPartnerEventSourceCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EVBPartnerEventSource (DeletePartnerEventSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DeletePartnerEventSourceResponse, RemoveEVBPartnerEventSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DeletePartnerEventSourceRequest();
        ...
        private Amazon.EventBridge.Model.DeletePartnerEventSourceResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DeletePartnerEventSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DeletePartnerEventSource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Account { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DeletePartnerEventSourceResponse, RemoveEVBPartnerEventSourceCmdlet, object> Select { get; set; } =
