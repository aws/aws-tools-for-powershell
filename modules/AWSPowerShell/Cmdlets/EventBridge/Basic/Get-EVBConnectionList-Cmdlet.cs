...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdletOutput("Amazon.EventBridge.Model.Connection or Amazon.EventBridge.Model.ListConnectionsResponse",
        ...
        "The service call response (type Amazon.EventBridge.Model.ListConnectionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
