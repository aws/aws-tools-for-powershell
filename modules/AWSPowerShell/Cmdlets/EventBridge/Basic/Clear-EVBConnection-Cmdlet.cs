...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </summary>
    [Cmdlet("Clear", "EVBConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ClearEVBConnectionCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Clear-EVBConnection (DeauthorizeConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DeauthorizeConnectionResponse, ClearEVBConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DeauthorizeConnectionRequest();
        ...
        private Amazon.EventBridge.Model.DeauthorizeConnectionResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DeauthorizeConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DeauthorizeConnection");
            try
            {
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DeauthorizeConnectionResponse, ClearEVBConnectionCmdlet, object> Select { get; set; } =
