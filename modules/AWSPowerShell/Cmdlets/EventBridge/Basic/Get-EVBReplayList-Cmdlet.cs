...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </summary>
    [Cmdlet("Get", "EVBReplayList")]
    [OutputType("Amazon.EventBridge.Model.Replay")]
    [AWSCmdlet("Calls the Amazon EventBridge ListReplays API operation.", Operation = new[] {"ListReplays"}, SelectReturnType = typeof(Amazon.EventBridge.Model.ListReplaysResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.Replay or Amazon.EventBridge.Model.ListReplaysResponse",
        "This cmdlet returns a collection of Amazon.EventBridge.Model.Replay objects.",
        "The service call response (type Amazon.EventBridge.Model.ListReplaysResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEVBReplayListCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.EventBridge.ReplayState")]
        public Amazon.EventBridge.ReplayState State { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Replays";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.ListReplaysResponse, GetEVBReplayListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EventBridge.Model.ListReplaysRequest();
        ...
        private Amazon.EventBridge.Model.ListReplaysResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.ListReplaysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "ListReplays");
            try
            {
                #if DESKTOP
                return client.ListReplays(request);
                #elif CORECLR
                return client.ListReplaysAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.EventBridge.ReplayState State { get; set; }
            public System.Func<Amazon.EventBridge.Model.ListReplaysResponse, GetEVBReplayListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Replays;
        }
