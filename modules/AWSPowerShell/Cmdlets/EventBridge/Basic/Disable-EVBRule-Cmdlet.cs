...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disable", "EVBRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class DisableEVBRuleCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-EVBRule (DisableRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DisableRuleResponse, DisableEVBRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DisableRuleRequest();
        ...
        private Amazon.EventBridge.Model.DisableRuleResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DisableRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DisableRule");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String EventBusName { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DisableRuleResponse, DisableEVBRuleCmdlet, object> Select { get; set; } =
