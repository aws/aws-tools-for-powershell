...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// replayed.
    /// </summary>
    [Cmdlet("Start", "EVBReplay", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EventBridge.Model.StartReplayResponse")]
    [AWSCmdlet("Calls the Amazon EventBridge StartReplay API operation.", Operation = new[] {"StartReplay"}, SelectReturnType = typeof(Amazon.EventBridge.Model.StartReplayResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.StartReplayResponse",
        "This cmdlet returns an Amazon.EventBridge.Model.StartReplayResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartEVBReplayCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-EVBReplay (StartReplay)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.StartReplayResponse, StartEVBReplayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.StartReplayRequest();
            ...
            request.Destination = new Amazon.EventBridge.Model.ReplayDestination();
        ...
        private Amazon.EventBridge.Model.StartReplayResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.StartReplayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "StartReplay");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? EventStartTime { get; set; }
            public System.String ReplayName { get; set; }
            public System.Func<Amazon.EventBridge.Model.StartReplayResponse, StartEVBReplayCmdlet, object> Select { get; set; } =
