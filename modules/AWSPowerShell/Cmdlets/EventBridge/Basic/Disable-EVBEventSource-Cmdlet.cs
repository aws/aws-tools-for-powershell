...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disable", "EVBEventSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class DisableEVBEventSourceCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-EVBEventSource (DeactivateEventSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DeactivateEventSourceResponse, DisableEVBEventSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DeactivateEventSourceRequest();
        ...
        private Amazon.EventBridge.Model.DeactivateEventSourceResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DeactivateEventSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DeactivateEventSource");
            try
            {
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DeactivateEventSourceResponse, DisableEVBEventSourceCmdlet, object> Select { get; set; } =
