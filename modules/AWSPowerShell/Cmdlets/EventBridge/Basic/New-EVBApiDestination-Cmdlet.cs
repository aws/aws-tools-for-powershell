...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdlet("Calls the Amazon EventBridge CreateApiDestination API operation.", Operation = new[] {"CreateApiDestination"}, SelectReturnType = typeof(Amazon.EventBridge.Model.CreateApiDestinationResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.CreateApiDestinationResponse",
        "This cmdlet returns an Amazon.EventBridge.Model.CreateApiDestinationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEVBApiDestinationCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EVBApiDestination (CreateApiDestination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.CreateApiDestinationResponse, NewEVBApiDestinationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.CreateApiDestinationRequest();
        ...
        private Amazon.EventBridge.Model.CreateApiDestinationResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.CreateApiDestinationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "CreateApiDestination");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? InvocationRateLimitPerSecond { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.CreateApiDestinationResponse, NewEVBApiDestinationCmdlet, object> Select { get; set; } =
