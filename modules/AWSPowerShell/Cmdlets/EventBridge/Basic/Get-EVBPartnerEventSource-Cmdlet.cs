...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    public partial class GetEVBPartnerEventSourceCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.DescribePartnerEventSourceResponse, GetEVBPartnerEventSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.DescribePartnerEventSourceRequest();
        ...
        private Amazon.EventBridge.Model.DescribePartnerEventSourceResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.DescribePartnerEventSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "DescribePartnerEventSource");
            try
            {
                return client.DescribePartnerEventSourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.EventBridge.Model.DescribePartnerEventSourceResponse, GetEVBPartnerEventSourceCmdlet, object> Select { get; set; } =
