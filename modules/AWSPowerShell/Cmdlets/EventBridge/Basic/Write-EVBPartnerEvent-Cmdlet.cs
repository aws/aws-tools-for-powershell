...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdlet("Calls the Amazon EventBridge PutPartnerEvents API operation.", Operation = new[] {"PutPartnerEvents"}, SelectReturnType = typeof(Amazon.EventBridge.Model.PutPartnerEventsResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.PutPartnerEventsResultEntry or Amazon.EventBridge.Model.PutPartnerEventsResponse",
        "This cmdlet returns a collection of Amazon.EventBridge.Model.PutPartnerEventsResultEntry objects.",
        "The service call response (type Amazon.EventBridge.Model.PutPartnerEventsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteEVBPartnerEventCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        [Alias("Entries")]
        public Amazon.EventBridge.Model.PutPartnerEventsRequestEntry[] Entry { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-EVBPartnerEvent (PutPartnerEvents)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.PutPartnerEventsResponse, WriteEVBPartnerEventCmdlet>(Select) ??
            ...
            if (this.Entry != null)
            {
                context.Entry = new List<Amazon.EventBridge.Model.PutPartnerEventsRequestEntry>(this.Entry);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.PutPartnerEventsRequest();
        ...
        private Amazon.EventBridge.Model.PutPartnerEventsResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.PutPartnerEventsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "PutPartnerEvents");
            try
            {
                #if DESKTOP
        ...
        {
            public List<Amazon.EventBridge.Model.PutPartnerEventsRequestEntry> Entry { get; set; }
            public System.Func<Amazon.EventBridge.Model.PutPartnerEventsResponse, WriteEVBPartnerEventCmdlet, object> Select { get; set; } =
