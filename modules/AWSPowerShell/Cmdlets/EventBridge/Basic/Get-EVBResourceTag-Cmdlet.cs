...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    public partial class GetEVBResourceTagCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.ListTagsForResourceResponse, GetEVBResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EventBridge.Model.ListTagsForResourceRequest();
        ...
        private Amazon.EventBridge.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "ListTagsForResource");
            try
            {
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.EventBridge.Model.ListTagsForResourceResponse, GetEVBResourceTagCmdlet, object> Select { get; set; } =
