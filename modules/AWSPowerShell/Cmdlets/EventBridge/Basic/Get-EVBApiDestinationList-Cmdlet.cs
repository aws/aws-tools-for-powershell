...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    [AWSCmdletOutput("Amazon.EventBridge.Model.ApiDestination or Amazon.EventBridge.Model.ListApiDestinationsResponse",
        ...
        "The service call response (type Amazon.EventBridge.Model.ListApiDestinationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
