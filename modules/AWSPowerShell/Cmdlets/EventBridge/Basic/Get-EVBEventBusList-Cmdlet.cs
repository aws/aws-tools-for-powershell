...
namespace Amazon.PowerShell.Cmdlets.EVB
{
    ...
    /// </summary>
    [Cmdlet("Get", "EVBEventBusList")]
    [OutputType("Amazon.EventBridge.Model.EventBus")]
    [AWSCmdlet("Calls the Amazon EventBridge ListEventBuses API operation.", Operation = new[] {"ListEventBuses"}, SelectReturnType = typeof(Amazon.EventBridge.Model.ListEventBusesResponse))]
    [AWSCmdletOutput("Amazon.EventBridge.Model.EventBus or Amazon.EventBridge.Model.ListEventBusesResponse",
        "This cmdlet returns a collection of Amazon.EventBridge.Model.EventBus objects.",
        "The service call response (type Amazon.EventBridge.Model.ListEventBusesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEVBEventBusListCmdlet : AmazonEventBridgeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EventBridge.Model.ListEventBusesResponse, GetEVBEventBusListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EventBridge.Model.ListEventBusesRequest();
        ...
        private Amazon.EventBridge.Model.ListEventBusesResponse CallAWSServiceOperation(IAmazonEventBridge client, Amazon.EventBridge.Model.ListEventBusesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge", "ListEventBuses");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NamePrefix { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EventBridge.Model.ListEventBusesResponse, GetEVBEventBusListCmdlet, object> Select { get; set; } =
