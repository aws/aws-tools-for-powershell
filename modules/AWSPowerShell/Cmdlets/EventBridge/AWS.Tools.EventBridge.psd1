#
# Module manifest for module 'AWS.Tools.EventBridge'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.EventBridge.dll'
    ...
    GUID = '18166f9a-d8ce-490f-b665-f7da0e748dc6'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.EventBridge.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.EventBridge.Completers.psm1',
        'AWS.Tools.EventBridge.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.EventBridge.dll-Help.xml'
    )
