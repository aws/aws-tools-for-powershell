...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdletOutput("None or Amazon.AppStream.Model.DisassociateApplicationFromEntitlementResponse",
        ...
        "The service response (type Amazon.AppStream.Model.DisassociateApplicationFromEntitlementResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
