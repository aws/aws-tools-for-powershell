...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Update", "APSEntitlement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateAPSEntitlementCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The attributes of the entitlement.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-APSEntitlement (UpdateEntitlement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.UpdateEntitlementResponse, UpdateAPSEntitlementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.UpdateEntitlementRequest();
        ...
        private Amazon.AppStream.Model.UpdateEntitlementResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.UpdateEntitlementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "UpdateEntitlement");
            try
            {
                return client.UpdateEntitlementAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.UpdateEntitlementResponse, UpdateAPSEntitlementCmdlet, object> Select { get; set; } =
