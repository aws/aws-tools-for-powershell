...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RemoveAPSImageBuilderCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DeleteImageBuilderResponse, RemoveAPSImageBuilderCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DeleteImageBuilder");
            try
            {
                return client.DeleteImageBuilderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.AppStream.Model.DeleteImageBuilderResponse, RemoveAPSImageBuilderCmdlet, object> Select { get; set; } =
