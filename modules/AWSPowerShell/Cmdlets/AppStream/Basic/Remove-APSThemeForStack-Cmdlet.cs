...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// catalog page.
    /// </summary>
    [Cmdlet("Remove", "APSThemeForStack", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAPSThemeForStackCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.AppStream.Model.DeleteThemeForStackResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APSThemeForStack (DeleteThemeForStack)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DeleteThemeForStackResponse, RemoveAPSThemeForStackCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.DeleteThemeForStackRequest();
        ...
        private Amazon.AppStream.Model.DeleteThemeForStackResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DeleteThemeForStackRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DeleteThemeForStack");
            try
            {
                #if DESKTOP
                return client.DeleteThemeForStack(request);
                #elif CORECLR
                return client.DeleteThemeForStackAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.DeleteThemeForStackResponse, RemoveAPSThemeForStackCmdlet, object> Select { get; set; } =
