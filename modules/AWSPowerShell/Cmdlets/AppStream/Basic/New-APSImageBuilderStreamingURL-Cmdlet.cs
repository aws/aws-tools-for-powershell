...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the Amazon AppStream CreateImageBuilderStreamingURL API operation.", Operation = new[] {"CreateImageBuilderStreamingURL"}, SelectReturnType = typeof(Amazon.AppStream.Model.CreateImageBuilderStreamingURLResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.CreateImageBuilderStreamingURLResponse",
        "This cmdlet returns an Amazon.AppStream.Model.CreateImageBuilderStreamingURLResponse object containing multiple properties."
    )]
    public partial class NewAPSImageBuilderStreamingURLCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.CreateImageBuilderStreamingURLResponse, NewAPSImageBuilderStreamingURLCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "CreateImageBuilderStreamingURL");
            try
            {
                return client.CreateImageBuilderStreamingURLAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.Int64? Validity { get; set; }
            public System.Func<Amazon.AppStream.Model.CreateImageBuilderStreamingURLResponse, NewAPSImageBuilderStreamingURLCmdlet, object> Select { get; set; } =
