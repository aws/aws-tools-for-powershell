...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Add", "APSApplicationToEntitlement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddAPSApplicationToEntitlementCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-APSApplicationToEntitlement (AssociateApplicationToEntitlement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.AssociateApplicationToEntitlementResponse, AddAPSApplicationToEntitlementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.AssociateApplicationToEntitlementRequest();
        ...
        private Amazon.AppStream.Model.AssociateApplicationToEntitlementResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.AssociateApplicationToEntitlementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "AssociateApplicationToEntitlement");
            try
            {
                #if DESKTOP
                return client.AssociateApplicationToEntitlement(request);
                #elif CORECLR
                return client.AssociateApplicationToEntitlementAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EntitlementName { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.AssociateApplicationToEntitlementResponse, AddAPSApplicationToEntitlementCmdlet, object> Select { get; set; } =
