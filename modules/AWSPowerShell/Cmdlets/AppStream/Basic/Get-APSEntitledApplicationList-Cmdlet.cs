...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Get", "APSEntitledApplicationList")]
    [OutputType("Amazon.AppStream.Model.EntitledApplication")]
    [AWSCmdlet("Calls the Amazon AppStream ListEntitledApplications API operation.", Operation = new[] {"ListEntitledApplications"}, SelectReturnType = typeof(Amazon.AppStream.Model.ListEntitledApplicationsResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.EntitledApplication or Amazon.AppStream.Model.ListEntitledApplicationsResponse",
        "This cmdlet returns a collection of Amazon.AppStream.Model.EntitledApplication objects.",
        "The service call response (type Amazon.AppStream.Model.ListEntitledApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPSEntitledApplicationListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EntitledApplications";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.ListEntitledApplicationsResponse, GetAPSEntitledApplicationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppStream.Model.ListEntitledApplicationsRequest();
        ...
        private Amazon.AppStream.Model.ListEntitledApplicationsResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.ListEntitledApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "ListEntitledApplications");
            try
            {
                #if DESKTOP
                return client.ListEntitledApplications(request);
                #elif CORECLR
                return client.ListEntitledApplicationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.ListEntitledApplicationsResponse, GetAPSEntitledApplicationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EntitledApplications;
        }
