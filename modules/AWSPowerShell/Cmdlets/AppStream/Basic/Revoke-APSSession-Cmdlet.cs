...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RevokeAPSSessionCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.ExpireSessionResponse, RevokeAPSSessionCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "ExpireSession");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SessionId { get; set; }
            public System.Func<Amazon.AppStream.Model.ExpireSessionResponse, RevokeAPSSessionCmdlet, object> Select { get; set; } =
