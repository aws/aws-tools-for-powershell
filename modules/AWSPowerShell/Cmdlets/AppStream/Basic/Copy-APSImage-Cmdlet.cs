...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class CopyAPSImageCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DestinationImageName";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SourceImageName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SourceImageName), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.CopyImageResponse, CopyAPSImageCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SourceImageName;
            }
            ...
            #if MODULAR
            if (this.DestinationImageName == null && ParameterWasBound(nameof(this.DestinationImageName)))
            {
                WriteWarning("You are passing $null as a value for parameter DestinationImageName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            ...
            #if MODULAR
            if (this.SourceImageName == null && ParameterWasBound(nameof(this.SourceImageName)))
            {
                WriteWarning("You are passing $null as a value for parameter SourceImageName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "CopyImage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DestinationRegion { get; set; }
            public System.String SourceImageName { get; set; }
            public System.Func<Amazon.AppStream.Model.CopyImageResponse, CopyAPSImageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DestinationImageName;
        }
