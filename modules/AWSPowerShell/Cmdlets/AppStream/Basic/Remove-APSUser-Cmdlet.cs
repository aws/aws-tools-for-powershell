...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon AppStream DeleteUser API operation.", Operation = new[] {"DeleteUser"}, SelectReturnType = typeof(Amazon.AppStream.Model.DeleteUserResponse))]
    [AWSCmdletOutput("None or Amazon.AppStream.Model.DeleteUserResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AppStream.Model.DeleteUserResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAPSUserCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DeleteUserResponse, RemoveAPSUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.DeleteUserRequest();
        ...
        private Amazon.AppStream.Model.DeleteUserResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DeleteUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DeleteUser");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.AppStream.AuthenticationType AuthenticationType { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.AppStream.Model.DeleteUserResponse, RemoveAPSUserCmdlet, object> Select { get; set; } =
