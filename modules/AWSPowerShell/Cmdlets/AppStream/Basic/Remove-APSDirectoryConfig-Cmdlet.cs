...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RemoveAPSDirectoryConfigCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DeleteDirectoryConfigResponse, RemoveAPSDirectoryConfigCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DeleteDirectoryConfig");
            try
            {
                return client.DeleteDirectoryConfigAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DirectoryName { get; set; }
            public System.Func<Amazon.AppStream.Model.DeleteDirectoryConfigResponse, RemoveAPSDirectoryConfigCmdlet, object> Select { get; set; } =
