...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class GetAPSFleetListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the fleets to describe.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DescribeFleetsResponse, GetAPSFleetListCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DescribeFleets");
            try
            {
                return client.DescribeFleetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppStream.Model.DescribeFleetsResponse, GetAPSFleetListCmdlet, object> Select { get; set; } =
