...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class StopAPSFleetCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.StopFleetResponse, StopAPSFleetCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "StopFleet");
            try
            {
                return client.StopFleetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.AppStream.Model.StopFleetResponse, StopAPSFleetCmdlet, object> Select { get; set; } =
