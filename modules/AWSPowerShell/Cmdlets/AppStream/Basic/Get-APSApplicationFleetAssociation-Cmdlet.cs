...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Get", "APSApplicationFleetAssociation")]
    [OutputType("Amazon.AppStream.Model.ApplicationFleetAssociation")]
    [AWSCmdlet("Calls the Amazon AppStream DescribeApplicationFleetAssociations API operation.", Operation = new[] {"DescribeApplicationFleetAssociations"}, SelectReturnType = typeof(Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.ApplicationFleetAssociation or Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse",
        "This cmdlet returns a collection of Amazon.AppStream.Model.ApplicationFleetAssociation objects.",
        "The service call response (type Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPSApplicationFleetAssociationCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ApplicationFleetAssociations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse, GetAPSApplicationFleetAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppStream.Model.DescribeApplicationFleetAssociationsRequest();
        ...
        private Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DescribeApplicationFleetAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DescribeApplicationFleetAssociations");
            try
            {
                #if DESKTOP
                return client.DescribeApplicationFleetAssociations(request);
                #elif CORECLR
                return client.DescribeApplicationFleetAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppStream.Model.DescribeApplicationFleetAssociationsResponse, GetAPSApplicationFleetAssociationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ApplicationFleetAssociations;
        }
