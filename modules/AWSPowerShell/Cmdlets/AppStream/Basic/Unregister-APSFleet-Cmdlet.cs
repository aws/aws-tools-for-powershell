...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon AppStream DisassociateFleet API operation.", Operation = new[] {"DisassociateFleet"}, SelectReturnType = typeof(Amazon.AppStream.Model.DisassociateFleetResponse))]
    [AWSCmdletOutput("None or Amazon.AppStream.Model.DisassociateFleetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.AppStream.Model.DisassociateFleetResponse) be returned by specifying '-Select *'."
    )]
    public partial class UnregisterAPSFleetCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DisassociateFleetResponse, UnregisterAPSFleetCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DisassociateFleet");
            try
            {
                return client.DisassociateFleetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FleetName { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.DisassociateFleetResponse, UnregisterAPSFleetCmdlet, object> Select { get; set; } =
