...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "APSImagePermission", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAPSImagePermissionCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APSImagePermission (DeleteImagePermissions)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DeleteImagePermissionsResponse, RemoveAPSImagePermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.DeleteImagePermissionsRequest();
        ...
        private Amazon.AppStream.Model.DeleteImagePermissionsResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DeleteImagePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DeleteImagePermissions");
            try
            {
                #if DESKTOP
                return client.DeleteImagePermissions(request);
                #elif CORECLR
                return client.DeleteImagePermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String SharedAccountId { get; set; }
            public System.Func<Amazon.AppStream.Model.DeleteImagePermissionsResponse, RemoveAPSImagePermissionCmdlet, object> Select { get; set; } =
