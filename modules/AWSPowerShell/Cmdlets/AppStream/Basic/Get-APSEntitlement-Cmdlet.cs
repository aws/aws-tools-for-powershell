...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    /// </summary>
    [Cmdlet("Get", "APSEntitlement")]
    [OutputType("Amazon.AppStream.Model.Entitlement")]
    [AWSCmdlet("Calls the Amazon AppStream DescribeEntitlements API operation.", Operation = new[] {"DescribeEntitlements"}, SelectReturnType = typeof(Amazon.AppStream.Model.DescribeEntitlementsResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.Entitlement or Amazon.AppStream.Model.DescribeEntitlementsResponse",
        "This cmdlet returns a collection of Amazon.AppStream.Model.Entitlement objects.",
        "The service call response (type Amazon.AppStream.Model.DescribeEntitlementsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPSEntitlementCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DescribeEntitlementsResponse, GetAPSEntitlementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppStream.Model.DescribeEntitlementsRequest();
        ...
        private Amazon.AppStream.Model.DescribeEntitlementsResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DescribeEntitlementsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DescribeEntitlements");
            try
            {
                #if DESKTOP
                return client.DescribeEntitlements(request);
                #elif CORECLR
                return client.DescribeEntitlementsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String StackName { get; set; }
            public System.Func<Amazon.AppStream.Model.DescribeEntitlementsResponse, GetAPSEntitlementCmdlet, object> Select { get; set; } =
