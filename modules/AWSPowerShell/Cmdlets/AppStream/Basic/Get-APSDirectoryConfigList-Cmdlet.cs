...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the Amazon AppStream DescribeDirectoryConfigs API operation.", Operation = new[] {"DescribeDirectoryConfigs"}, SelectReturnType = typeof(Amazon.AppStream.Model.DescribeDirectoryConfigsResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.DirectoryConfig or Amazon.AppStream.Model.DescribeDirectoryConfigsResponse",
        "This cmdlet returns a collection of Amazon.AppStream.Model.DirectoryConfig objects.",
        "The service call response (type Amazon.AppStream.Model.DescribeDirectoryConfigsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAPSDirectoryConfigListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The directory names.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DirectoryConfigs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DescribeDirectoryConfigsResponse, GetAPSDirectoryConfigListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.DirectoryName != null)
            {
                context.DirectoryName = new List<System.String>(this.DirectoryName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.DirectoryNames = cmdletContext.DirectoryName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DirectoryConfigs?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DescribeDirectoryConfigs");
            try
            {
                return client.DescribeDirectoryConfigsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> DirectoryName { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppStream.Model.DescribeDirectoryConfigsResponse, GetAPSDirectoryConfigListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DirectoryConfigs;
        }
