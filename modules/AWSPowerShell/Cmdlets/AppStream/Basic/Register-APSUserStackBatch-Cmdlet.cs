...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RegisterAPSUserStackBatchCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^UserStackAssociation' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.UserStackAssociation;
            }
