...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the Amazon AppStream DescribeUsers API operation.", Operation = new[] {"DescribeUsers"}, SelectReturnType = typeof(Amazon.AppStream.Model.DescribeUsersResponse))]
    [AWSCmdletOutput("Amazon.AppStream.Model.User or Amazon.AppStream.Model.DescribeUsersResponse",
        "This cmdlet returns a collection of Amazon.AppStream.Model.User objects.",
        "The service call response (type Amazon.AppStream.Model.DescribeUsersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAPSUserCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.DescribeUsersResponse, GetAPSUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppStream.Model.DescribeUsersRequest();
        ...
        private Amazon.AppStream.Model.DescribeUsersResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DescribeUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "DescribeUsers");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppStream.Model.DescribeUsersResponse, GetAPSUserCmdlet, object> Select { get; set; } =
