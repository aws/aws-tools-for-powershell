...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the Amazon AppStream ListAssociatedStacks API operation.", Operation = new[] {"ListAssociatedStacks"}, SelectReturnType = typeof(Amazon.AppStream.Model.ListAssociatedStacksResponse))]
    [AWSCmdletOutput("System.String or Amazon.AppStream.Model.ListAssociatedStacksResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.AppStream.Model.ListAssociatedStacksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAPSAssociatedStackListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppStream.Model.ListAssociatedStacksResponse, GetAPSAssociatedStackListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppStream.Model.ListAssociatedStacksRequest();
        ...
        private Amazon.AppStream.Model.ListAssociatedStacksResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.ListAssociatedStacksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppStream", "ListAssociatedStacks");
            try
            {
                #if DESKTOP
                return client.ListAssociatedStacks(request);
                #elif CORECLR
                return client.ListAssociatedStacksAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FleetName { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppStream.Model.ListAssociatedStacksResponse, GetAPSAssociatedStackListCmdlet, object> Select { get; set; } =
