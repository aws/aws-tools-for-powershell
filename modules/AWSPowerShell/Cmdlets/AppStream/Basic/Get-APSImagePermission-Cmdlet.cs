...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdletOutput("Amazon.AppStream.Model.SharedImagePermissions or Amazon.AppStream.Model.DescribeImagePermissionsResponse",
        ...
        "The service call response (type Amazon.AppStream.Model.DescribeImagePermissionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
