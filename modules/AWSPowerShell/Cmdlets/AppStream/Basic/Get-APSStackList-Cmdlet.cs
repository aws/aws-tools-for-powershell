...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdletOutput("Amazon.AppStream.Model.Stack or Amazon.AppStream.Model.DescribeStacksResponse",
        ...
        "The service call response (type Amazon.AppStream.Model.DescribeStacksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAPSStackListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the stacks to describe.</para><para />
