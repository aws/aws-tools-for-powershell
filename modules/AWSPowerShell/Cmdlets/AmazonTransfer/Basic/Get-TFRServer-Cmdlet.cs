...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdlet("Calls the AWS Transfer for SFTP DescribeServer API operation.", Operation = new[] {"DescribeServer"})]
    [AWSCmdletOutput("Amazon.Transfer.Model.DescribedServer",
        "This cmdlet returns a DescribedServer object.",
    ...
    public partial class GetTFRServerCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        private Amazon.Transfer.Model.DescribeServerResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.DescribeServerRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeServerAsync(request);
                return task.Result;
                #else
