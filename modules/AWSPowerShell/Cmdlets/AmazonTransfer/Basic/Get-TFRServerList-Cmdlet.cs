...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdlet("Calls the AWS Transfer for SFTP ListServers API operation.", Operation = new[] {"ListServers"})]
    [AWSCmdletOutput("Amazon.Transfer.Model.ListedServer",
        "This cmdlet returns a collection of ListedServer objects.",
        "The service call response (type Amazon.Transfer.Model.ListServersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetTFRServerListCmdlet : AmazonTransferClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Transfer.Model.ListServersRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Servers;
        ...
        private Amazon.Transfer.Model.ListServersResponse CallAWSServiceOperation(IAmazonTransfer client, Amazon.Transfer.Model.ListServersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Transfer for SFTP", "ListServers");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListServersAsync(request);
                return task.Result;
                #else
