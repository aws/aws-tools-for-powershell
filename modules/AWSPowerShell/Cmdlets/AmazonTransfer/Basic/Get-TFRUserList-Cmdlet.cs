...
namespace Amazon.PowerShell.Cmdlets.TFR
{
    ...
    [AWSCmdlet("Calls the AWS Transfer for SFTP ListUsers API operation.", Operation = new[] {"ListUsers"})]
    [AWSCmdletOutput("Amazon.Transfer.Model.ListedUser",
        "This cmdlet returns a collection of ListedUser objects.",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String), ServerId (type System.String)"
    )]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        notes["ServerId"] = response.ServerId;
