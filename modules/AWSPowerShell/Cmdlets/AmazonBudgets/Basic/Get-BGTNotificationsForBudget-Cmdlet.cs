...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    public partial class GetBGTNotificationsForBudgetCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Notifications;
        ...
        private static Amazon.Budgets.Model.DescribeNotificationsForBudgetResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DescribeNotificationsForBudgetRequest request)
        {
            #if DESKTOP
