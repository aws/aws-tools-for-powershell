...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [AWSCmdlet("Invokes the DescribeSubscribersForNotification operation against AWS Budgets.", Operation = new[] {"DescribeSubscribersForNotification"})]
    ...
    public partial class GetBGTSubscribersForNotificationCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Budgets.Model.DescribeSubscribersForNotificationResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.DescribeSubscribersForNotificationRequest request)
        {
            #if DESKTOP
