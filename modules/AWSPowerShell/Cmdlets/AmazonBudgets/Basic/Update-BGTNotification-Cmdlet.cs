...
namespace Amazon.PowerShell.Cmdlets.BGT
{
    ...
    [AWSCmdlet("Invokes the UpdateNotification operation against AWS Budgets.", Operation = new[] {"UpdateNotification"})]
    ...
    public partial class UpdateBGTNotificationCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Budgets.Model.UpdateNotificationResponse CallAWSServiceOperation(IAmazonBudgets client, Amazon.Budgets.Model.UpdateNotificationRequest request)
        {
            #if DESKTOP
