    ...
    public partial class UpdateBGTBudgetCmdlet : AmazonBudgetsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("CostTypes_IncludeCredit"))
                context.NewBudget_CostTypes_IncludeCredit = this.CostTypes_IncludeCredit;
            if (ParameterWasBound("CostTypes_IncludeDiscount"))
                context.NewBudget_CostTypes_IncludeDiscount = this.CostTypes_IncludeDiscount;
            if (ParameterWasBound("CostTypes_IncludeOtherSubscription"))
                context.NewBudget_CostTypes_IncludeOtherSubscription = this.CostTypes_IncludeOtherSubscription;
            if (ParameterWasBound("CostTypes_IncludeRecurring"))
                context.NewBudget_CostTypes_IncludeRecurring = this.CostTypes_IncludeRecurring;
            if (ParameterWasBound("CostTypes_IncludeRefund"))
                context.NewBudget_CostTypes_IncludeRefund = this.CostTypes_IncludeRefund;
            ...
            if (ParameterWasBound("CostTypes_IncludeSupport"))
                context.NewBudget_CostTypes_IncludeSupport = this.CostTypes_IncludeSupport;
            ...
            if (ParameterWasBound("CostTypes_IncludeUpfront"))
                context.NewBudget_CostTypes_IncludeUpfront = this.CostTypes_IncludeUpfront;
            if (ParameterWasBound("CostTypes_UseAmortized"))
                context.NewBudget_CostTypes_UseAmortized = this.CostTypes_UseAmortized;
            if (ParameterWasBound("CostTypes_UseBlended"))
                context.NewBudget_CostTypes_UseBlended = this.CostTypes_UseBlended;
            if (ParameterWasBound("NewBudget_LastUpdatedTime"))
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeCredit != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeCredit = cmdletContext.NewBudget_CostTypes_IncludeCredit.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeDiscount != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeDiscount = cmdletContext.NewBudget_CostTypes_IncludeDiscount.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeOtherSubscription != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeOtherSubscription = cmdletContext.NewBudget_CostTypes_IncludeOtherSubscription.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeRecurring != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeRecurring = cmdletContext.NewBudget_CostTypes_IncludeRecurring.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeRefund != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeRefund = cmdletContext.NewBudget_CostTypes_IncludeRefund.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeSupport != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeSupport = cmdletContext.NewBudget_CostTypes_IncludeSupport.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_IncludeUpfront != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_IncludeUpfront = cmdletContext.NewBudget_CostTypes_IncludeUpfront.Value;
            }
            ...
            if (cmdletContext.NewBudget_CostTypes_UseAmortized != null)
            {
                requestNewBudget_newBudget_CostTypes_costTypes_UseAmortized = cmdletContext.NewBudget_CostTypes_UseAmortized.Value;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? NewBudget_CostTypes_IncludeCredit { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeDiscount { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeOtherSubscription { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeRecurring { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeRefund { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeSubscription { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeSupport { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeTax { get; set; }
            public System.Boolean? NewBudget_CostTypes_IncludeUpfront { get; set; }
            public System.Boolean? NewBudget_CostTypes_UseAmortized { get; set; }
