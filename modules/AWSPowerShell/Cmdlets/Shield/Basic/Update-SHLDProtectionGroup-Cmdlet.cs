...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    /// </summary>
    [Cmdlet("Update", "SHLDProtectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateSHLDProtectionGroupCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SHLDProtectionGroup (UpdateProtectionGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Shield.Model.UpdateProtectionGroupResponse, UpdateSHLDProtectionGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Shield.Model.UpdateProtectionGroupRequest();
        ...
        private Amazon.Shield.Model.UpdateProtectionGroupResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.UpdateProtectionGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Shield", "UpdateProtectionGroup");
            try
            {
                #if DESKTOP
                return client.UpdateProtectionGroup(request);
                #elif CORECLR
                return client.UpdateProtectionGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProtectionGroupId { get; set; }
            public Amazon.Shield.ProtectedResourceType ResourceType { get; set; }
            public System.Func<Amazon.Shield.Model.UpdateProtectionGroupResponse, UpdateSHLDProtectionGroupCmdlet, object> Select { get; set; } =
