...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    public partial class GetSHLDProtectionGroupListCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of <a>ProtectionGroup</a> objects to return. If you leave this
        /// blank, Shield Advanced returns the first 20 results.</para><para>This is a maximum value. Shield Advanced might return the results in smaller batches.
        ...
        /// <summary>
        /// <para>
        /// <para>The next token value from a previous call to <code>ListProtectionGroups</code>. Pass
