...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    public partial class RemoveSHLDResourceTagCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag key for each tag that you want to remove from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SHLDResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Shield.Model.UntagResourceResponse, RemoveSHLDResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Shield.Model.UntagResourceRequest();
        ...
        private Amazon.Shield.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Shield", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Shield.Model.UntagResourceResponse, RemoveSHLDResourceTagCmdlet, object> Select { get; set; } =
