...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    public partial class GetSHLDDRTAccessCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Shield.Model.DescribeDRTAccessResponse, GetSHLDDRTAccessCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Shield.Model.DescribeDRTAccessRequest();
        ...
        private Amazon.Shield.Model.DescribeDRTAccessResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.DescribeDRTAccessRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Shield", "DescribeDRTAccess");
            try
            {
                return client.DescribeDRTAccessAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.Shield.Model.DescribeDRTAccessResponse, GetSHLDDRTAccessCmdlet, object> Select { get; set; } =
