...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    public partial class AddSHLDHealthCheckCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^HealthCheckArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.HealthCheckArn;
            }
        ...
        private Amazon.Shield.Model.AssociateHealthCheckResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.AssociateHealthCheckRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.AssociateHealthCheck(request);
                #elif CORECLR
                return client.AssociateHealthCheckAsync(request).GetAwaiter().GetResult();
                #else
