...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMRBootstrapActionList")]
    [OutputType("Amazon.ElasticMapReduce.Model.Command")]
    [AWSCmdlet("Calls the Amazon Elastic MapReduce ListBootstrapActions API operation.", Operation = new[] {"ListBootstrapActions"}, SelectReturnType = typeof(Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse), LegacyAlias="Get-EMRBootstrapActions")]
    [AWSCmdletOutput("Amazon.ElasticMapReduce.Model.Command or Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse",
        "This cmdlet returns a collection of Amazon.ElasticMapReduce.Model.Command objects.",
        "The service call response (type Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMRBootstrapActionListCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BootstrapActions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse, GetEMRBootstrapActionListCmdlet>(Select) ??
        ...
        private Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.ListBootstrapActionsRequest request)
        {
            ...
            try
            {
                return client.ListBootstrapActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClusterId { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.ListBootstrapActionsResponse, GetEMRBootstrapActionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BootstrapActions;
        }
