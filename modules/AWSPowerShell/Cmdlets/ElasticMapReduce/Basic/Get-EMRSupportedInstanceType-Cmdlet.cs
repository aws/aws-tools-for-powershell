...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    [AWSCmdletOutput("Amazon.ElasticMapReduce.Model.SupportedInstanceType or Amazon.ElasticMapReduce.Model.ListSupportedInstanceTypesResponse",
        ...
        "The service call response (type Amazon.ElasticMapReduce.Model.ListSupportedInstanceTypesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMRSupportedInstanceTypeCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        /// Release labels are in the format <code>emr-x.x.x</code>, where x.x.x is an Amazon
        /// EMR release number such as <code>emr-6.10.0</code>. For more information about Amazon
        /// EMR releases and their included application versions and features, see the <i><a href="https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-release-components.html">Amazon
