...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic MapReduce ListInstanceGroups API operation.", Operation = new[] {"ListInstanceGroups"}, SelectReturnType = typeof(Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse), LegacyAlias="Get-EMRInstanceGroups")]
    [AWSCmdletOutput("Amazon.ElasticMapReduce.Model.InstanceGroup or Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse",
        "This cmdlet returns a collection of Amazon.ElasticMapReduce.Model.InstanceGroup objects.",
        "The service call response (type Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMRInstanceGroupListCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse, GetEMRInstanceGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ElasticMapReduce.Model.ListInstanceGroupsRequest();
        ...
        private Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.ListInstanceGroupsRequest request)
        {
            ...
            try
            {
                return client.ListInstanceGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClusterId { get; set; }
            public System.String Marker { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.ListInstanceGroupsResponse, GetEMRInstanceGroupListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceGroups;
        }
