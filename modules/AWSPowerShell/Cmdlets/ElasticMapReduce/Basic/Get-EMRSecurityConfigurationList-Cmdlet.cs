...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic MapReduce ListSecurityConfigurations API operation.", Operation = new[] {"ListSecurityConfigurations"}, SelectReturnType = typeof(Amazon.ElasticMapReduce.Model.ListSecurityConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.ElasticMapReduce.Model.SecurityConfigurationSummary or Amazon.ElasticMapReduce.Model.ListSecurityConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.ElasticMapReduce.Model.SecurityConfigurationSummary objects.",
        "The service call response (type Amazon.ElasticMapReduce.Model.ListSecurityConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMRSecurityConfigurationListCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.ListSecurityConfigurationsResponse, GetEMRSecurityConfigurationListCmdlet>(Select) ??
        ...
        {
            public System.String Marker { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.ListSecurityConfigurationsResponse, GetEMRSecurityConfigurationListCmdlet, object> Select { get; set; } =
