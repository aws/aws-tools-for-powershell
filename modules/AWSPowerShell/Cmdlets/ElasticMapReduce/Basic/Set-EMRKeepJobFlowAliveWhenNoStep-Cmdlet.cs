...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Set", "EMRKeepJobFlowAliveWhenNoStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class SetEMRKeepJobFlowAliveWhenNoStepCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        #region Parameter KeepJobFlowAliveWhenNoStep
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("KeepJobFlowAliveWhenNoSteps")]
        public System.Boolean? KeepJobFlowAliveWhenNoStep { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^KeepJobFlowAliveWhenNoStep' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.KeepJobFlowAliveWhenNoStep), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-EMRKeepJobFlowAliveWhenNoStep (SetKeepJobFlowAliveWhenNoSteps)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.SetKeepJobFlowAliveWhenNoStepsResponse, SetEMRKeepJobFlowAliveWhenNoStepCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.KeepJobFlowAliveWhenNoStep;
            }
            ...
            #endif
            context.KeepJobFlowAliveWhenNoStep = this.KeepJobFlowAliveWhenNoStep;
            #if MODULAR
            if (this.KeepJobFlowAliveWhenNoStep == null && ParameterWasBound(nameof(this.KeepJobFlowAliveWhenNoStep)))
            {
                WriteWarning("You are passing $null as a value for parameter KeepJobFlowAliveWhenNoStep which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticMapReduce.Model.SetKeepJobFlowAliveWhenNoStepsRequest();
            
            if (cmdletContext.JobFlowId != null)
            {
                request.JobFlowIds = cmdletContext.JobFlowId;
            }
            if (cmdletContext.KeepJobFlowAliveWhenNoStep != null)
            {
                request.KeepJobFlowAliveWhenNoSteps = cmdletContext.KeepJobFlowAliveWhenNoStep.Value;
            }
        ...
        private Amazon.ElasticMapReduce.Model.SetKeepJobFlowAliveWhenNoStepsResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.SetKeepJobFlowAliveWhenNoStepsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic MapReduce", "SetKeepJobFlowAliveWhenNoSteps");
            try
            {
                #if DESKTOP
                return client.SetKeepJobFlowAliveWhenNoSteps(request);
                #elif CORECLR
                return client.SetKeepJobFlowAliveWhenNoStepsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? KeepJobFlowAliveWhenNoStep { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.SetKeepJobFlowAliveWhenNoStepsResponse, SetEMRKeepJobFlowAliveWhenNoStepCmdlet, object> Select { get; set; } =
