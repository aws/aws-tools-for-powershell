...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMRAutoTerminationPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMRAutoTerminationPolicyCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMRAutoTerminationPolicy (RemoveAutoTerminationPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.RemoveAutoTerminationPolicyResponse, RemoveEMRAutoTerminationPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticMapReduce.Model.RemoveAutoTerminationPolicyRequest();
        ...
        private Amazon.ElasticMapReduce.Model.RemoveAutoTerminationPolicyResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.RemoveAutoTerminationPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic MapReduce", "RemoveAutoTerminationPolicy");
            try
            {
                #if DESKTOP
                return client.RemoveAutoTerminationPolicy(request);
                #elif CORECLR
                return client.RemoveAutoTerminationPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClusterId { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.RemoveAutoTerminationPolicyResponse, RemoveEMRAutoTerminationPolicyCmdlet, object> Select { get; set; } =
