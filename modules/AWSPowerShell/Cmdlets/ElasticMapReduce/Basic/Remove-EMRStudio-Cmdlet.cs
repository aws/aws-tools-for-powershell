...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EMRStudio", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMRStudioCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMRStudio (DeleteStudio)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticMapReduce.Model.DeleteStudioResponse, RemoveEMRStudioCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticMapReduce.Model.DeleteStudioRequest();
        ...
        private Amazon.ElasticMapReduce.Model.DeleteStudioResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.DeleteStudioRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic MapReduce", "DeleteStudio");
            try
            {
                #if DESKTOP
                return client.DeleteStudio(request);
                #elif CORECLR
                return client.DeleteStudioAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StudioId { get; set; }
            public System.Func<Amazon.ElasticMapReduce.Model.DeleteStudioResponse, RemoveEMRStudioCmdlet, object> Select { get; set; } =
