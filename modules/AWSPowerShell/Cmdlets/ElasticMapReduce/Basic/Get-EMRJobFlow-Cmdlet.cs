...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    public partial class GetEMRJobFlowCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Return only job flows whose job flow ID is contained in this list.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Return only job flows whose state is contained in this list.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.ElasticMapReduce.Model.DescribeJobFlowsResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.DescribeJobFlowsRequest request)
        {
            ...
            try
            {
                return client.DescribeJobFlowsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
