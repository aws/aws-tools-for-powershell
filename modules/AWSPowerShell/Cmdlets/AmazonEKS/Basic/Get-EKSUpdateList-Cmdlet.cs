...
namespace Amazon.PowerShell.Cmdlets.EKS
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Container Service for Kubernetes ListUpdates API operation.", Operation = new[] {"ListUpdates"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.EKS.Model.ListUpdatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetEKSUpdateListCmdlet : AmazonEKSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Amazon EKS cluster for which to list updates.</para>
        /// </para>
        /// </summary>
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.UpdateIds;
                        ...
                        int _receivedThisCall = response.UpdateIds.Count;
        ...
        private Amazon.EKS.Model.ListUpdatesResponse CallAWSServiceOperation(IAmazonEKS client, Amazon.EKS.Model.ListUpdatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Container Service for Kubernetes", "ListUpdates");
            try
            {
                #if DESKTOP
                return client.ListUpdates(request);
                #elif CORECLR
                return client.ListUpdatesAsync(request).GetAwaiter().GetResult();
                #else
