...
namespace Amazon.PowerShell.Cmdlets.CHMMP
{
    ...
    [AWSCmdletOutput("None or Amazon.ChimeSDKMediaPipelines.Model.UpdateMediaInsightsPipelineStatusResponse",
        ...
        "The service response (type Amazon.ChimeSDKMediaPipelines.Model.UpdateMediaInsightsPipelineStatusResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
