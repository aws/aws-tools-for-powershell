...
namespace Amazon.PowerShell.Cmdlets.CHMMP
{
    ...
    [AWSCmdletOutput("Amazon.ChimeSDKMediaPipelines.Model.MediaInsightsPipelineConfiguration or Amazon.ChimeSDKMediaPipelines.Model.CreateMediaInsightsPipelineConfigurationResponse",
        ...
        "The service call response (type Amazon.ChimeSDKMediaPipelines.Model.CreateMediaInsightsPipelineConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCHMMPMediaInsightsPipelineConfigurationCmdlet : AmazonChimeSDKMediaPipelinesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the MediaInsightsPipelineConfigurationName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^MediaInsightsPipelineConfigurationName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MediaInsightsPipelineConfigurationName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.MediaInsightsPipelineConfigurationName;
            }
        ...
        private Amazon.ChimeSDKMediaPipelines.Model.CreateMediaInsightsPipelineConfigurationResponse CallAWSServiceOperation(IAmazonChimeSDKMediaPipelines client, Amazon.ChimeSDKMediaPipelines.Model.CreateMediaInsightsPipelineConfigurationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateMediaInsightsPipelineConfiguration(request);
                #elif CORECLR
                return client.CreateMediaInsightsPipelineConfigurationAsync(request).GetAwaiter().GetResult();
                #else
