...
{
    /// <summary>
    /// Lists the video stream pools in the media pipeline.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ChimeSDKMediaPipelines.Model.KinesisVideoStreamPoolSummary or Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelineKinesisVideoStreamPoolsResponse",
        ...
        "The service call response (type Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelineKinesisVideoStreamPoolsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCHMMPMediaPipelineKinesisVideoStreamPoolListCmdlet : AmazonChimeSDKMediaPipelinesClientCmdlet, IExecutor
    {
        ...
        private Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelineKinesisVideoStreamPoolsResponse CallAWSServiceOperation(IAmazonChimeSDKMediaPipelines client, Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelineKinesisVideoStreamPoolsRequest request)
        {
            ...
            try
            {
                return client.ListMediaPipelineKinesisVideoStreamPoolsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
