...
namespace Amazon.PowerShell.Cmdlets.CHMMP
{
    ...
    /// </summary>
    [Cmdlet("New", "CHMMPMediaConcatenationPipeline", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ChimeSDKMediaPipelines.Model.MediaConcatenationPipeline")]
    [AWSCmdlet("Calls the Amazon Chime SDK Media Pipelines CreateMediaConcatenationPipeline API operation.", Operation = new[] {"CreateMediaConcatenationPipeline"}, SelectReturnType = typeof(Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMediaPipelines.Model.MediaConcatenationPipeline or Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse",
        "This cmdlet returns an Amazon.ChimeSDKMediaPipelines.Model.MediaConcatenationPipeline object.",
        "The service call response (type Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCHMMPMediaConcatenationPipelineCmdlet : AmazonChimeSDKMediaPipelinesClientCmdlet, IExecutor
    {
        ...
        [Alias("Sinks")]
        public Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSink[] Sink { get; set; }
        #endregion
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Sources")]
        public Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSource[] Source { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MediaConcatenationPipeline";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse, NewCHMMPMediaConcatenationPipelineCmdlet>(Select) ??
            ...
            if (this.Sink != null)
            {
                context.Sink = new List<Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSink>(this.Sink);
            }
            #if MODULAR
            ...
            if (this.Source != null)
            {
                context.Source = new List<Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSource>(this.Source);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineRequest();
        ...
        private Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse CallAWSServiceOperation(IAmazonChimeSDKMediaPipelines client, Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Media Pipelines", "CreateMediaConcatenationPipeline");
            try
            {
                #if DESKTOP
                return client.CreateMediaConcatenationPipeline(request);
                #elif CORECLR
                return client.CreateMediaConcatenationPipelineAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClientRequestToken { get; set; }
            public List<Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSink> Sink { get; set; }
            public List<Amazon.ChimeSDKMediaPipelines.Model.ConcatenationSource> Source { get; set; }
            public List<Amazon.ChimeSDKMediaPipelines.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.ChimeSDKMediaPipelines.Model.CreateMediaConcatenationPipelineResponse, NewCHMMPMediaConcatenationPipelineCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MediaConcatenationPipeline;
        }
