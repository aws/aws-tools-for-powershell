...
{
    /// <summary>
    /// Returns a list of media pipelines.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ChimeSDKMediaPipelines.Model.MediaPipelineSummary or Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelinesResponse",
        ...
        "The service call response (type Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelinesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCHMMPMediaPipelineListCmdlet : AmazonChimeSDKMediaPipelinesClientCmdlet, IExecutor
    {
        ...
        private Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelinesResponse CallAWSServiceOperation(IAmazonChimeSDKMediaPipelines client, Amazon.ChimeSDKMediaPipelines.Model.ListMediaPipelinesRequest request)
        {
            ...
            try
            {
                return client.ListMediaPipelinesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
