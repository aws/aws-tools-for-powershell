...
namespace Amazon.PowerShell.Cmdlets.IOTDA
{
    ...
    [AWSCmdlet("Calls the AWS IoT Core Device Advisor GetSuiteRun API operation.", Operation = new[] {"GetSuiteRun"}, SelectReturnType = typeof(Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse))]
    [AWSCmdletOutput("Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse",
        "This cmdlet returns an Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTDASuiteRunCmdlet : AmazonIoTDeviceAdvisorClientCmdlet, IExecutor
    {
        
        #region Parameter SuiteDefinitionId
        /// <summary>
        /// <para>
        /// <para>Requests the information about Device Advisor test suite run based on suite definition
        /// Id.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>Requests the information about Device Advisor test suite run based on suite run Id.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse).
        /// Specifying the name of a property of type Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse, GetIOTDASuiteRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTDeviceAdvisor.Model.GetSuiteRunRequest();
        ...
        private Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse CallAWSServiceOperation(IAmazonIoTDeviceAdvisor client, Amazon.IoTDeviceAdvisor.Model.GetSuiteRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Core Device Advisor", "GetSuiteRun");
            try
            {
                #if DESKTOP
                return client.GetSuiteRun(request);
                #elif CORECLR
                return client.GetSuiteRunAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SuiteDefinitionId { get; set; }
            public System.String SuiteRunId { get; set; }
            public System.Func<Amazon.IoTDeviceAdvisor.Model.GetSuiteRunResponse, GetIOTDASuiteRunCmdlet, object> Select { get; set; } =
