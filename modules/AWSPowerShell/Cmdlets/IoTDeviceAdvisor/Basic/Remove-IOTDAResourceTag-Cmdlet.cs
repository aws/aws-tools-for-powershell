...
namespace Amazon.PowerShell.Cmdlets.IOTDA
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IOTDAResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIOTDAResourceTagCmdlet : AmazonIoTDeviceAdvisorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of tag keys to remove from the IoT Device Advisor resource.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTDeviceAdvisor.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTDAResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTDeviceAdvisor.Model.UntagResourceResponse, RemoveIOTDAResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTDeviceAdvisor.Model.UntagResourceRequest();
        ...
        private Amazon.IoTDeviceAdvisor.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonIoTDeviceAdvisor client, Amazon.IoTDeviceAdvisor.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Core Device Advisor", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTDeviceAdvisor.Model.UntagResourceResponse, RemoveIOTDAResourceTagCmdlet, object> Select { get; set; } =
