...
namespace Amazon.PowerShell.Cmdlets.ASA
{
    ...
    [AWSCmdlet("Invokes the DescribeCommunications operation against AWS Support API.", Operation = new[] {"DescribeCommunications"}, LegacyAlias="Get-ASACommunications")]
    ...
    public partial class GetASACommunicationCmdlet : AmazonAWSSupportClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Support API", "DescribeCommunications");
            #if DESKTOP
