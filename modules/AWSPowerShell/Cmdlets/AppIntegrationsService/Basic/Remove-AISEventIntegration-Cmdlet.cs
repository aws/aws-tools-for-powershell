...
namespace Amazon.PowerShell.Cmdlets.AIS
{
    ...
    public partial class RemoveAISEventIntegrationCmdlet : AmazonAppIntegrationsServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AISEventIntegration (DeleteEventIntegration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppIntegrationsService.Model.DeleteEventIntegrationResponse, RemoveAISEventIntegrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppIntegrationsService.Model.DeleteEventIntegrationRequest();
        ...
        private Amazon.AppIntegrationsService.Model.DeleteEventIntegrationResponse CallAWSServiceOperation(IAmazonAppIntegrationsService client, Amazon.AppIntegrationsService.Model.DeleteEventIntegrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppIntegrations Service", "DeleteEventIntegration");
            try
            {
                #if DESKTOP
                return client.DeleteEventIntegration(request);
                #elif CORECLR
                return client.DeleteEventIntegrationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.AppIntegrationsService.Model.DeleteEventIntegrationResponse, RemoveAISEventIntegrationCmdlet, object> Select { get; set; } =
