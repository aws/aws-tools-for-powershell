...
namespace Amazon.PowerShell.Cmdlets.AIS
{
    ...
    [AWSCmdletOutput("None or Amazon.AppIntegrationsService.Model.DeleteDataIntegrationResponse",
        ...
        "The service response (type Amazon.AppIntegrationsService.Model.DeleteDataIntegrationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAISDataIntegrationCmdlet : AmazonAppIntegrationsServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DataIntegrationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.DataIntegrationIdentifier;
            }
        ...
        private Amazon.AppIntegrationsService.Model.DeleteDataIntegrationResponse CallAWSServiceOperation(IAmazonAppIntegrationsService client, Amazon.AppIntegrationsService.Model.DeleteDataIntegrationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteDataIntegration(request);
                #elif CORECLR
                return client.DeleteDataIntegrationAsync(request).GetAwaiter().GetResult();
                #else
