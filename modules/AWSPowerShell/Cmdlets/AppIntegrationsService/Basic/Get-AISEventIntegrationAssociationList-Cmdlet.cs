...
{
    /// <summary>
    /// Returns a paginated list of event integration associations in the account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.AppIntegrationsService.Model.EventIntegrationAssociation or Amazon.AppIntegrationsService.Model.ListEventIntegrationAssociationsResponse",
        ...
        "The service call response (type Amazon.AppIntegrationsService.Model.ListEventIntegrationAssociationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAISEventIntegrationAssociationListCmdlet : AmazonAppIntegrationsServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppIntegrationsService.Model.ListEventIntegrationAssociationsResponse CallAWSServiceOperation(IAmazonAppIntegrationsService client, Amazon.AppIntegrationsService.Model.ListEventIntegrationAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListEventIntegrationAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
