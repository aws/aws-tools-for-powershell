...
{
    /// <summary>
    /// Returns a paginated list of application associations for an application.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetAISApplicationAssociationListCmdlet : AmazonAppIntegrationsServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppIntegrationsService.Model.ListApplicationAssociationsResponse CallAWSServiceOperation(IAmazonAppIntegrationsService client, Amazon.AppIntegrationsService.Model.ListApplicationAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListApplicationAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
