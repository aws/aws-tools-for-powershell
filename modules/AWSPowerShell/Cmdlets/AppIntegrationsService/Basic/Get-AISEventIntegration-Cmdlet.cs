...
namespace Amazon.PowerShell.Cmdlets.AIS
{
    ...
    public partial class GetAISEventIntegrationCmdlet : AmazonAppIntegrationsServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppIntegrationsService.Model.GetEventIntegrationResponse, GetAISEventIntegrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppIntegrationsService.Model.GetEventIntegrationRequest();
        ...
        private Amazon.AppIntegrationsService.Model.GetEventIntegrationResponse CallAWSServiceOperation(IAmazonAppIntegrationsService client, Amazon.AppIntegrationsService.Model.GetEventIntegrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon AppIntegrations Service", "GetEventIntegration");
            try
            {
                #if DESKTOP
                return client.GetEventIntegration(request);
                #elif CORECLR
                return client.GetEventIntegrationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.AppIntegrationsService.Model.GetEventIntegrationResponse, GetAISEventIntegrationCmdlet, object> Select { get; set; } =
