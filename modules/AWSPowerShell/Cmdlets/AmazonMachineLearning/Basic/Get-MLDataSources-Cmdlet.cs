...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    /// </summary>
    [Cmdlet("Get", "MLDataSources")]
    [OutputType("Amazon.MachineLearning.Model.DataSource")]
    [AWSCmdlet("Invokes the DescribeDataSources operation against Amazon Machine Learning.", Operation = new[] {"DescribeDataSources"})]
    ...
    public partial class GetMLDataSourcesCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MachineLearning.Model.DescribeDataSourcesResponse CallAWSServiceOperation(IAmazonMachineLearning client, Amazon.MachineLearning.Model.DescribeDataSourcesRequest request)
        {
            #if DESKTOP
