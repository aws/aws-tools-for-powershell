...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </para></important>
    /// </summary>
    [Cmdlet("Remove", "CCATSpace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveCCATSpaceCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CCATSpace (DeleteSpace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.DeleteSpaceResponse, RemoveCCATSpaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.DeleteSpaceRequest();
        ...
        private Amazon.CodeCatalyst.Model.DeleteSpaceResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.DeleteSpaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCatalyst", "DeleteSpace");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.DeleteSpaceResponse, RemoveCCATSpaceCmdlet, object> Select { get; set; } =
