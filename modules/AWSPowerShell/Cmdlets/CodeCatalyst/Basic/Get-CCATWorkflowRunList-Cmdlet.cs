...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    public partial class GetCCATWorkflowRunListCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Information used to sort the items in the returned list.</para><para />
        ...
        public Amazon.CodeCatalyst.Model.WorkflowRunSortCriteria[] SortBy { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.ListWorkflowRunsResponse, GetCCATWorkflowRunListCmdlet>(Select) ??
            ...
            if (this.SortBy != null)
            {
                context.SortBy = new List<Amazon.CodeCatalyst.Model.WorkflowRunSortCriteria>(this.SortBy);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeCatalyst.Model.ListWorkflowRunsRequest();
        ...
        private Amazon.CodeCatalyst.Model.ListWorkflowRunsResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.ListWorkflowRunsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCatalyst", "ListWorkflowRuns");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProjectName { get; set; }
            public List<Amazon.CodeCatalyst.Model.WorkflowRunSortCriteria> SortBy { get; set; }
            public System.String SpaceName { get; set; }
            public System.String WorkflowId { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.ListWorkflowRunsResponse, GetCCATWorkflowRunListCmdlet, object> Select { get; set; } =
