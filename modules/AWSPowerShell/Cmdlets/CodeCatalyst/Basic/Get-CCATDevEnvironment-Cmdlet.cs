...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCATDevEnvironment")]
    [OutputType("Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse")]
    [AWSCmdlet("Calls the AWS CodeCatalyst GetDevEnvironment API operation.", Operation = new[] {"GetDevEnvironment"}, SelectReturnType = typeof(Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse))]
    [AWSCmdletOutput("Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse",
        "This cmdlet returns an Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCCATDevEnvironmentCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse, GetCCATDevEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.GetDevEnvironmentRequest();
        ...
        private Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.GetDevEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCatalyst", "GetDevEnvironment");
            try
            {
                #if DESKTOP
                return client.GetDevEnvironment(request);
                #elif CORECLR
                return client.GetDevEnvironmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProjectName { get; set; }
            public System.String SpaceName { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.GetDevEnvironmentResponse, GetCCATDevEnvironmentCmdlet, object> Select { get; set; } =
