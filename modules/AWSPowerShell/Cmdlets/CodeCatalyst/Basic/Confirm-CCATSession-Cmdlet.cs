...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </summary>
    [Cmdlet("Confirm", "CCATSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ConfirmCCATSessionCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-CCATSession (VerifySession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.VerifySessionResponse, ConfirmCCATSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.VerifySessionRequest();
        ...
        private Amazon.CodeCatalyst.Model.VerifySessionResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.VerifySessionRequest request)
        {
        ...
        {
            public System.Func<Amazon.CodeCatalyst.Model.VerifySessionResponse, ConfirmCCATSessionCmdlet, object> Select { get; set; } =
