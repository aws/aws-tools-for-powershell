...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </summary>
    [Cmdlet("Start", "CCATWorkflowRun", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CodeCatalyst.Model.StartWorkflowRunResponse")]
    [AWSCmdlet("Calls the AWS CodeCatalyst StartWorkflowRun API operation.", Operation = new[] {"StartWorkflowRun"}, SelectReturnType = typeof(Amazon.CodeCatalyst.Model.StartWorkflowRunResponse))]
    [AWSCmdletOutput("Amazon.CodeCatalyst.Model.StartWorkflowRunResponse",
        "This cmdlet returns an Amazon.CodeCatalyst.Model.StartWorkflowRunResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCCATWorkflowRunCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CCATWorkflowRun (StartWorkflowRun)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.StartWorkflowRunResponse, StartCCATWorkflowRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.StartWorkflowRunRequest();
        ...
        private Amazon.CodeCatalyst.Model.StartWorkflowRunResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.StartWorkflowRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCatalyst", "StartWorkflowRun");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SpaceName { get; set; }
            public System.String WorkflowId { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.StartWorkflowRunResponse, StartCCATWorkflowRunCmdlet, object> Select { get; set; } =
