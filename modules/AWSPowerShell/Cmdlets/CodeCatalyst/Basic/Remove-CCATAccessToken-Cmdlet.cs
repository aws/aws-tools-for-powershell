...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CCATAccessToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCCATAccessTokenCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CCATAccessToken (DeleteAccessToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.DeleteAccessTokenResponse, RemoveCCATAccessTokenCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.DeleteAccessTokenRequest();
        ...
        private Amazon.CodeCatalyst.Model.DeleteAccessTokenResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.DeleteAccessTokenRequest request)
        {
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.DeleteAccessTokenResponse, RemoveCCATAccessTokenCmdlet, object> Select { get; set; } =
