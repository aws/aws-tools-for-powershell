...
{
    /// <summary>
    /// Retrieves a list of Dev Environments in a project.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCCATDevEnvironmentListCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeCatalyst.Model.ListDevEnvironmentsResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.ListDevEnvironmentsRequest request)
        {
            ...
            try
            {
                return client.ListDevEnvironmentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
