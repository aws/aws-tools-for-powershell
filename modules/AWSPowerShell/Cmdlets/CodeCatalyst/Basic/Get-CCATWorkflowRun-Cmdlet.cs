...
namespace Amazon.PowerShell.Cmdlets.CCAT
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCATWorkflowRun")]
    [OutputType("Amazon.CodeCatalyst.Model.GetWorkflowRunResponse")]
    [AWSCmdlet("Calls the AWS CodeCatalyst GetWorkflowRun API operation.", Operation = new[] {"GetWorkflowRun"}, SelectReturnType = typeof(Amazon.CodeCatalyst.Model.GetWorkflowRunResponse))]
    [AWSCmdletOutput("Amazon.CodeCatalyst.Model.GetWorkflowRunResponse",
        "This cmdlet returns an Amazon.CodeCatalyst.Model.GetWorkflowRunResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCCATWorkflowRunCmdlet : AmazonCodeCatalystClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeCatalyst.Model.GetWorkflowRunResponse, GetCCATWorkflowRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeCatalyst.Model.GetWorkflowRunRequest();
        ...
        private Amazon.CodeCatalyst.Model.GetWorkflowRunResponse CallAWSServiceOperation(IAmazonCodeCatalyst client, Amazon.CodeCatalyst.Model.GetWorkflowRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeCatalyst", "GetWorkflowRun");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProjectName { get; set; }
            public System.String SpaceName { get; set; }
            public System.Func<Amazon.CodeCatalyst.Model.GetWorkflowRunResponse, GetCCATWorkflowRunCmdlet, object> Select { get; set; } =
