...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DTCTResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDTCTResourceTagCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DTCTResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.UntagResourceResponse, RemoveDTCTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Detective.Model.UntagResourceRequest();
        ...
        private Amazon.Detective.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Detective.Model.UntagResourceResponse, RemoveDTCTResourceTagCmdlet, object> Select { get; set; } =
