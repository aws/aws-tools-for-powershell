...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    /// </summary>
    [Cmdlet("Add", "DTCTResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddDTCTResourceTagCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        /// Each tag value can contain up to 256 characters.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-DTCTResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.TagResourceResponse, AddDTCTResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Detective.Model.TagResourceRequest();
        ...
        private Amazon.Detective.Model.TagResourceResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Detective.Model.TagResourceResponse, AddDTCTResourceTagCmdlet, object> Select { get; set; } =
