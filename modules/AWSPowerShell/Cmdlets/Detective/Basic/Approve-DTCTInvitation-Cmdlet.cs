...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    public partial class ApproveDTCTInvitationCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-DTCTInvitation (AcceptInvitation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.AcceptInvitationResponse, ApproveDTCTInvitationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Detective.Model.AcceptInvitationRequest();
        ...
        private Amazon.Detective.Model.AcceptInvitationResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.AcceptInvitationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "AcceptInvitation");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GraphArn { get; set; }
            public System.Func<Amazon.Detective.Model.AcceptInvitationResponse, ApproveDTCTInvitationCmdlet, object> Select { get; set; } =
