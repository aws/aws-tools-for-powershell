...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    /// </summary>
    [Cmdlet("Get", "DTCTDatasourcePackageList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Detective ListDatasourcePackages API operation.", Operation = new[] {"ListDatasourcePackages"}, SelectReturnType = typeof(Amazon.Detective.Model.ListDatasourcePackagesResponse))]
    [AWSCmdletOutput("System.String or Amazon.Detective.Model.ListDatasourcePackagesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Detective.Model.ListDatasourcePackagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDTCTDatasourcePackageListCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DatasourcePackages";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.ListDatasourcePackagesResponse, GetDTCTDatasourcePackageListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Detective.Model.ListDatasourcePackagesRequest();
        ...
        private Amazon.Detective.Model.ListDatasourcePackagesResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.ListDatasourcePackagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "ListDatasourcePackages");
            try
            {
                #if DESKTOP
                return client.ListDatasourcePackages(request);
                #elif CORECLR
                return client.ListDatasourcePackagesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Detective.Model.ListDatasourcePackagesResponse, GetDTCTDatasourcePackageListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DatasourcePackages;
        }
