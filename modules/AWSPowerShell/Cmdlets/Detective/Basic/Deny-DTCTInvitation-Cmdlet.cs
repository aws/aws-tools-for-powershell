...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Detective RejectInvitation API operation.", Operation = new[] {"RejectInvitation"}, SelectReturnType = typeof(Amazon.Detective.Model.RejectInvitationResponse))]
    [AWSCmdletOutput("None or Amazon.Detective.Model.RejectInvitationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Detective.Model.RejectInvitationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DenyDTCTInvitationCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-DTCTInvitation (RejectInvitation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.RejectInvitationResponse, DenyDTCTInvitationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Detective.Model.RejectInvitationRequest();
        ...
        private Amazon.Detective.Model.RejectInvitationResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.RejectInvitationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "RejectInvitation");
            try
            {
                #if DESKTOP
                return client.RejectInvitation(request);
                #elif CORECLR
                return client.RejectInvitationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GraphArn { get; set; }
            public System.Func<Amazon.Detective.Model.RejectInvitationResponse, DenyDTCTInvitationCmdlet, object> Select { get; set; } =
