...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    /// </para><para><c>CreateMembers</c> verifies the accounts and then invites the verified accounts.
    ...
    [AWSCmdletOutput("Amazon.Detective.Model.CreateMembersResponse",
        "This cmdlet returns an Amazon.Detective.Model.CreateMembersResponse object containing multiple properties."
    )]
    public partial class NewDTCTMemberCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>if set to <c>true</c>, then the invited accounts do not receive email notifications.
        /// By default, this is set to <c>false</c>, and the invited accounts receive email notifications.</para><para>Organization accounts in the organization behavior graph do not receive email notifications.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Detective.Model.CreateMembersResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.CreateMembersRequest request)
        {
            ...
            try
            {
                return client.CreateMembersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
