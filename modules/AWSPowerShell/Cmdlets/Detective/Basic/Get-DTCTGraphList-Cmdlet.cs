...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    [OutputType("Amazon.Detective.Model.Graph")]
    ...
    public partial class GetDTCTGraphListCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "GraphList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.ListGraphsResponse, GetDTCTGraphListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Detective.Model.ListGraphsRequest();
        ...
        private Amazon.Detective.Model.ListGraphsResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.ListGraphsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "ListGraphs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Detective.Model.ListGraphsResponse, GetDTCTGraphListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.GraphList;
        }
