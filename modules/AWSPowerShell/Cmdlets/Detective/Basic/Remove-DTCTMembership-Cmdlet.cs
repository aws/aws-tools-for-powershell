...
namespace Amazon.PowerShell.Cmdlets.DTCT
{
    ...
    public partial class RemoveDTCTMembershipCmdlet : AmazonDetectiveClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DTCTMembership (DisassociateMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Detective.Model.DisassociateMembershipResponse, RemoveDTCTMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Detective.Model.DisassociateMembershipRequest();
        ...
        private Amazon.Detective.Model.DisassociateMembershipResponse CallAWSServiceOperation(IAmazonDetective client, Amazon.Detective.Model.DisassociateMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Detective", "DisassociateMembership");
            try
            {
                #if DESKTOP
                return client.DisassociateMembership(request);
                #elif CORECLR
                return client.DisassociateMembershipAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GraphArn { get; set; }
            public System.Func<Amazon.Detective.Model.DisassociateMembershipResponse, RemoveDTCTMembershipCmdlet, object> Select { get; set; } =
