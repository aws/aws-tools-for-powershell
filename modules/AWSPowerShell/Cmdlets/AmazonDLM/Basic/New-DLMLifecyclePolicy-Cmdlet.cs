...
namespace Amazon.PowerShell.Cmdlets.DLM
{
    ...
    [AWSCmdlet("Calls the Amazon Data Lifecycle Manager CreateLifecyclePolicy API operation.", Operation = new[] {"CreateLifecyclePolicy"})]
    ...
    public partial class NewDLMLifecyclePolicyCmdlet : AmazonDLMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ExecutionRoleArn", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.PolicyId;
        ...
        private Amazon.DLM.Model.CreateLifecyclePolicyResponse CallAWSServiceOperation(IAmazonDLM client, Amazon.DLM.Model.CreateLifecyclePolicyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateLifecyclePolicyAsync(request);
                return task.Result;
                #else
