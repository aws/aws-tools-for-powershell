...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CDIRSchema", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Cloud Directory DeleteSchema API operation.", Operation = new[] {"DeleteSchema"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.DeleteSchemaResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.DeleteSchemaResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CloudDirectory.Model.DeleteSchemaResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCDIRSchemaCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CDIRSchema (DeleteSchema)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.DeleteSchemaResponse, RemoveCDIRSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudDirectory.Model.DeleteSchemaRequest();
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "DeleteSchema");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.DeleteSchemaResponse, RemoveCDIRSchemaCmdlet, object> Select { get; set; } =
