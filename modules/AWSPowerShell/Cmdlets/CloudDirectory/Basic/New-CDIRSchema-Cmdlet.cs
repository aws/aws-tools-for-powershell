...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("New", "CDIRSchema", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Cloud Directory CreateSchema API operation.", Operation = new[] {"CreateSchema"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.CreateSchemaResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.CreateSchemaResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.CloudDirectory.Model.CreateSchemaResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCDIRSchemaCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CDIRSchema (CreateSchema)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.CreateSchemaResponse, NewCDIRSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudDirectory.Model.CreateSchemaRequest();
        ...
        private Amazon.CloudDirectory.Model.CreateSchemaResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.CreateSchemaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "CreateSchema");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.CreateSchemaResponse, NewCDIRSchemaCmdlet, object> Select { get; set; } =
