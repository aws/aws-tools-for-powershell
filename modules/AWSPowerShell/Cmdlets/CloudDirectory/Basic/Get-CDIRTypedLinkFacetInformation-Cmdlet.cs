...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory GetTypedLinkFacetInformation API operation.", Operation = new[] {"GetTypedLinkFacetInformation"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.GetTypedLinkFacetInformationResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.GetTypedLinkFacetInformationResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.GetTypedLinkFacetInformationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRTypedLinkFacetInformationCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IdentityAttributeOrder";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.GetTypedLinkFacetInformationResponse, GetCDIRTypedLinkFacetInformationCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "GetTypedLinkFacetInformation");
            try
            {
                return client.GetTypedLinkFacetInformationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.GetTypedLinkFacetInformationResponse, GetCDIRTypedLinkFacetInformationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IdentityAttributeOrder;
        }
