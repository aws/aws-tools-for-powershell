...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class AddCDIRSchemaCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ApplySchemaResponse, AddCDIRSchemaCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ApplySchema");
            try
            {
                return client.ApplySchemaAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DirectoryArn { get; set; }
            public System.String PublishedSchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ApplySchemaResponse, AddCDIRSchemaCmdlet, object> Select { get; set; } =
