...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListFacetAttributes API operation.", Operation = new[] {"ListFacetAttributes"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListFacetAttributesResponse))]
    [AWSCmdletOutput("Amazon.CloudDirectory.Model.FacetAttribute or Amazon.CloudDirectory.Model.ListFacetAttributesResponse",
        "This cmdlet returns a collection of Amazon.CloudDirectory.Model.FacetAttribute objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListFacetAttributesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRFacetAttributeCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListFacetAttributesResponse, GetCDIRFacetAttributeCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListFacetAttributes");
            try
            {
                return client.ListFacetAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListFacetAttributesResponse, GetCDIRFacetAttributeCmdlet, object> Select { get; set; } =
