...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cloud Directory DeleteFacet API operation.", Operation = new[] {"DeleteFacet"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.DeleteFacetResponse))]
    [AWSCmdletOutput("None or Amazon.CloudDirectory.Model.DeleteFacetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudDirectory.Model.DeleteFacetResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCDIRFacetCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.DeleteFacetResponse, RemoveCDIRFacetCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "DeleteFacet");
            try
            {
                return client.DeleteFacetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.DeleteFacetResponse, RemoveCDIRFacetCmdlet, object> Select { get; set; } =
