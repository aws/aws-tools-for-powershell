...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListAttachedIndices API operation.", Operation = new[] {"ListAttachedIndices"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListAttachedIndicesResponse))]
    [AWSCmdletOutput("Amazon.CloudDirectory.Model.IndexAttachment or Amazon.CloudDirectory.Model.ListAttachedIndicesResponse",
        "This cmdlet returns a collection of Amazon.CloudDirectory.Model.IndexAttachment objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListAttachedIndicesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRObjectIndexCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListAttachedIndicesResponse, GetCDIRObjectIndexCmdlet>(Select) ??
        ...
        private Amazon.CloudDirectory.Model.ListAttachedIndicesResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListAttachedIndicesRequest request)
        {
            ...
            try
            {
                return client.ListAttachedIndicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TargetReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListAttachedIndicesResponse, GetCDIRObjectIndexCmdlet, object> Select { get; set; } =
