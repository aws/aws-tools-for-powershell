...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListObjectPolicies API operation.", Operation = new[] {"ListObjectPolicies"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListObjectPoliciesResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.ListObjectPoliciesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListObjectPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRObjectPolicyCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AttachedPolicyIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListObjectPoliciesResponse, GetCDIRObjectPolicyCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListObjectPolicies");
            try
            {
                return client.ListObjectPoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ObjectReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListObjectPoliciesResponse, GetCDIRObjectPolicyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AttachedPolicyIds;
        }
