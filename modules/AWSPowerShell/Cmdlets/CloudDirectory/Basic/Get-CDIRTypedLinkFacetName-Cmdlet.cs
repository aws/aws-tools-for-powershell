...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </summary>
    [Cmdlet("Get", "CDIRTypedLinkFacetName")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Cloud Directory ListTypedLinkFacetNames API operation.", Operation = new[] {"ListTypedLinkFacetNames"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCDIRTypedLinkFacetNameCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FacetNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse, GetCDIRTypedLinkFacetNameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesRequest();
        ...
        private Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListTypedLinkFacetNames");
            try
            {
                #if DESKTOP
                return client.ListTypedLinkFacetNames(request);
                #elif CORECLR
                return client.ListTypedLinkFacetNamesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListTypedLinkFacetNamesResponse, GetCDIRTypedLinkFacetNameCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FacetNames;
        }
