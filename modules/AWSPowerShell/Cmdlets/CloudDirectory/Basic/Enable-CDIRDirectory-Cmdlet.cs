...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class EnableCDIRDirectoryCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.EnableDirectoryResponse, EnableCDIRDirectoryCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "EnableDirectory");
            try
            {
                return client.EnableDirectoryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DirectoryArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.EnableDirectoryResponse, EnableCDIRDirectoryCmdlet, object> Select { get; set; } =
