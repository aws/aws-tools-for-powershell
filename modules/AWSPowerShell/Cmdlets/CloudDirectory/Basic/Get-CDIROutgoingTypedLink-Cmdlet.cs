...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListOutgoingTypedLinks API operation.", Operation = new[] {"ListOutgoingTypedLinks"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListOutgoingTypedLinksResponse))]
    [AWSCmdletOutput("Amazon.CloudDirectory.Model.TypedLinkSpecifier or Amazon.CloudDirectory.Model.ListOutgoingTypedLinksResponse",
        "This cmdlet returns a collection of Amazon.CloudDirectory.Model.TypedLinkSpecifier objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListOutgoingTypedLinksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIROutgoingTypedLinkCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// not have a range specified are presumed to match the entire range.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TypedLinkSpecifiers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListOutgoingTypedLinksResponse, GetCDIROutgoingTypedLinkCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListOutgoingTypedLinks");
            try
            {
                return client.ListOutgoingTypedLinksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ObjectReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListOutgoingTypedLinksResponse, GetCDIROutgoingTypedLinkCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TypedLinkSpecifiers;
        }
