...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListObjectChildren API operation.", Operation = new[] {"ListObjectChildren"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListObjectChildrenResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.ListObjectChildrenResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListObjectChildrenResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRObjectChildCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListObjectChildrenResponse, GetCDIRObjectChildCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ObjectReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListObjectChildrenResponse, GetCDIRObjectChildCmdlet, object> Select { get; set; } =
