...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.CloudDirectory.Model.Tag or Amazon.CloudDirectory.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.CloudDirectory.Model.Tag objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCDIRResourceTagCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListTagsForResourceResponse, GetCDIRResourceTagCmdlet>(Select) ??
        ...
        private Amazon.CloudDirectory.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListTagsForResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListTagsForResourceResponse, GetCDIRResourceTagCmdlet, object> Select { get; set; } =
