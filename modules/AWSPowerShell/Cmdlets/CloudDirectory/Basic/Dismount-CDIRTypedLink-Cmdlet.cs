...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class DismountCDIRTypedLinkCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Identifies the attribute value to update.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.DetachTypedLinkResponse, DismountCDIRTypedLinkCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "DetachTypedLink");
            try
            {
                return client.DetachTypedLinkAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TypedLinkFacet_SchemaArn { get; set; }
            public System.String TypedLinkFacet_TypedLinkName { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.DetachTypedLinkResponse, DismountCDIRTypedLinkCmdlet, object> Select { get; set; } =
