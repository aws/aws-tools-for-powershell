...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class GetCDIRDirectoryPolicyCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PolicyToPathList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.LookupPolicyResponse, GetCDIRDirectoryPolicyCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "LookupPolicy");
            try
            {
                return client.LookupPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ObjectReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.LookupPolicyResponse, GetCDIRDirectoryPolicyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PolicyToPathList;
        }
