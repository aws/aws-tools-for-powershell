...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "CDIRDirectory", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewCDIRDirectoryCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CDIRDirectory (CreateDirectory)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.CreateDirectoryResponse, NewCDIRDirectoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudDirectory.Model.CreateDirectoryRequest();
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "CreateDirectory");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.CreateDirectoryResponse, NewCDIRDirectoryCmdlet, object> Select { get; set; } =
