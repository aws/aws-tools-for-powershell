...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class DismountCDIRPolicyFromObjectCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.DetachPolicyResponse, DismountCDIRPolicyFromObjectCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "DetachPolicy");
            try
            {
                return client.DetachPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ObjectReference_Selector { get; set; }
            public System.String PolicyReference_Selector { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.DetachPolicyResponse, DismountCDIRPolicyFromObjectCmdlet, object> Select { get; set; } =
