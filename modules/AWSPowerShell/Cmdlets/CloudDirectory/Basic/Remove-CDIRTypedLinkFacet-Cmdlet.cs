...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cloud Directory DeleteTypedLinkFacet API operation.", Operation = new[] {"DeleteTypedLinkFacet"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.DeleteTypedLinkFacetResponse))]
    [AWSCmdletOutput("None or Amazon.CloudDirectory.Model.DeleteTypedLinkFacetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudDirectory.Model.DeleteTypedLinkFacetResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCDIRTypedLinkFacetCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.DeleteTypedLinkFacetResponse, RemoveCDIRTypedLinkFacetCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "DeleteTypedLinkFacet");
            try
            {
                return client.DeleteTypedLinkFacetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.DeleteTypedLinkFacetResponse, RemoveCDIRTypedLinkFacetCmdlet, object> Select { get; set; } =
