...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the Amazon Cloud Directory ListFacetNames API operation.", Operation = new[] {"ListFacetNames"}, SelectReturnType = typeof(Amazon.CloudDirectory.Model.ListFacetNamesResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudDirectory.Model.ListFacetNamesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListFacetNamesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCDIRFacetNameCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudDirectory.Model.ListFacetNamesResponse, GetCDIRFacetNameCmdlet>(Select) ??
        ...
        private Amazon.CloudDirectory.Model.ListFacetNamesResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListFacetNamesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cloud Directory", "ListFacetNames");
            try
            {
                #if DESKTOP
                return client.ListFacetNames(request);
                #elif CORECLR
                return client.ListFacetNamesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.CloudDirectory.Model.ListFacetNamesResponse, GetCDIRFacetNameCmdlet, object> Select { get; set; } =
