...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    [AWSCmdlet("Calls the AWS Amplify ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.Amplify.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.Amplify.Model.JobSummary or Amazon.Amplify.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.Amplify.Model.JobSummary objects.",
        "The service call response (type Amazon.Amplify.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMPJobListCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.ListJobsResponse, GetAMPJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.JobSummaries?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Amplify.Model.ListJobsResponse, GetAMPJobListCmdlet, object> Select { get; set; } =
