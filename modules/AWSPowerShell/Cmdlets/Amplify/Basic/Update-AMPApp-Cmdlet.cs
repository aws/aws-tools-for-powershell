...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    [AWSCmdletOutput("Amazon.Amplify.Model.App or Amazon.Amplify.Model.UpdateAppResponse",
        ...
        "The service call response (type Amazon.Amplify.Model.UpdateAppResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateAMPAppCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Describes the automated branch creation glob patterns for an Amplify app. </para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The custom redirect and rewrite rules for an Amplify app. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The environment variables for an Amplify app. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Git repository for an Amplify app.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
