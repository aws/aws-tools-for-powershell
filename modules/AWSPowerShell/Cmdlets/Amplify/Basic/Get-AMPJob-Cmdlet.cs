...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    public partial class GetAMPJobCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.GetJobResponse, GetAMPJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Amplify.Model.GetJobRequest();
        ...
        private Amazon.Amplify.Model.GetJobResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.GetJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "GetJob");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BranchName { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.Amplify.Model.GetJobResponse, GetAMPJobCmdlet, object> Select { get; set; } =
