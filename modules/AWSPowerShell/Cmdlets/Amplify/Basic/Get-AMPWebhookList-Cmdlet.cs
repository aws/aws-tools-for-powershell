...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    [AWSCmdlet("Calls the AWS Amplify ListWebhooks API operation.", Operation = new[] {"ListWebhooks"}, SelectReturnType = typeof(Amazon.Amplify.Model.ListWebhooksResponse))]
    [AWSCmdletOutput("Amazon.Amplify.Model.Webhook or Amazon.Amplify.Model.ListWebhooksResponse",
        "This cmdlet returns a collection of Amazon.Amplify.Model.Webhook objects.",
        "The service call response (type Amazon.Amplify.Model.ListWebhooksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPWebhookListCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Webhooks";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.ListWebhooksResponse, GetAMPWebhookListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Amplify.Model.ListWebhooksRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Webhooks?.Count ?? 0;
        ...
        private Amazon.Amplify.Model.ListWebhooksResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.ListWebhooksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "ListWebhooks");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Amplify.Model.ListWebhooksResponse, GetAMPWebhookListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Webhooks;
        }
