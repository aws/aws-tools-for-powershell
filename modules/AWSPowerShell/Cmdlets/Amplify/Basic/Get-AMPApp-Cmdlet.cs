...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    public partial class GetAMPAppCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.GetAppResponse, GetAMPAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Amplify.Model.GetAppRequest();
        ...
        private Amazon.Amplify.Model.GetAppResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.GetAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "GetApp");
            try
            {
        ...
        {
            public System.String AppId { get; set; }
            public System.Func<Amazon.Amplify.Model.GetAppResponse, GetAMPAppCmdlet, object> Select { get; set; } =
