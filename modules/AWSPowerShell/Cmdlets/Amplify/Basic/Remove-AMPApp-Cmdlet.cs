...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    public partial class RemoveAMPAppCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPApp (DeleteApp)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.DeleteAppResponse, RemoveAMPAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Amplify.Model.DeleteAppRequest();
        ...
        private Amazon.Amplify.Model.DeleteAppResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.DeleteAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "DeleteApp");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String AppId { get; set; }
            public System.Func<Amazon.Amplify.Model.DeleteAppResponse, RemoveAMPAppCmdlet, object> Select { get; set; } =
