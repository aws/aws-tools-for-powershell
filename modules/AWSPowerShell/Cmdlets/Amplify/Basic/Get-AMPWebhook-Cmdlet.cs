...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    public partial class GetAMPWebhookCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.GetWebhookResponse, GetAMPWebhookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Amplify.Model.GetWebhookRequest();
        ...
        private Amazon.Amplify.Model.GetWebhookResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.GetWebhookRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "GetWebhook");
            try
            {
                #if DESKTOP
                return client.GetWebhook(request);
                #elif CORECLR
                return client.GetWebhookAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WebhookId { get; set; }
            public System.Func<Amazon.Amplify.Model.GetWebhookResponse, GetAMPWebhookCmdlet, object> Select { get; set; } =
