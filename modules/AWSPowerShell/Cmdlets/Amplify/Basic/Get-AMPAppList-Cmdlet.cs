...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPAppList")]
    [OutputType("Amazon.Amplify.Model.App")]
    [AWSCmdlet("Calls the AWS Amplify ListApps API operation.", Operation = new[] {"ListApps"}, SelectReturnType = typeof(Amazon.Amplify.Model.ListAppsResponse))]
    [AWSCmdletOutput("Amazon.Amplify.Model.App or Amazon.Amplify.Model.ListAppsResponse",
        "This cmdlet returns a collection of Amazon.Amplify.Model.App objects.",
        "The service call response (type Amazon.Amplify.Model.ListAppsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAMPAppListCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.ListAppsResponse, GetAMPAppListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Amplify.Model.ListAppsRequest();
        ...
        private Amazon.Amplify.Model.ListAppsResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.ListAppsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "ListApps");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Amplify.Model.ListAppsResponse, GetAMPAppListCmdlet, object> Select { get; set; } =
