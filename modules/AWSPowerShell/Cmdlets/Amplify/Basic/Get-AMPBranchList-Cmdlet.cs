...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    /// </summary>
    [Cmdlet("Get", "AMPBranchList")]
    [OutputType("Amazon.Amplify.Model.Branch")]
    [AWSCmdlet("Calls the AWS Amplify ListBranches API operation.", Operation = new[] {"ListBranches"}, SelectReturnType = typeof(Amazon.Amplify.Model.ListBranchesResponse))]
    [AWSCmdletOutput("Amazon.Amplify.Model.Branch or Amazon.Amplify.Model.ListBranchesResponse",
        "This cmdlet returns a collection of Amazon.Amplify.Model.Branch objects.",
        "The service call response (type Amazon.Amplify.Model.ListBranchesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAMPBranchListCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.ListBranchesResponse, GetAMPBranchListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Amplify.Model.ListBranchesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Branches?.Count ?? 0;
        ...
        private Amazon.Amplify.Model.ListBranchesResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.ListBranchesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "ListBranches");
            try
            {
                return client.ListBranchesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Amplify.Model.ListBranchesResponse, GetAMPBranchListCmdlet, object> Select { get; set; } =
