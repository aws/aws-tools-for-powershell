...
namespace Amazon.PowerShell.Cmdlets.AMP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AMPBranch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveAMPBranchCmdlet : AmazonAmplifyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AMPBranch (DeleteBranch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Amplify.Model.DeleteBranchResponse, RemoveAMPBranchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Amplify.Model.DeleteBranchRequest();
        ...
        private Amazon.Amplify.Model.DeleteBranchResponse CallAWSServiceOperation(IAmazonAmplify client, Amazon.Amplify.Model.DeleteBranchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Amplify", "DeleteBranch");
            try
            {
                return client.DeleteBranchAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppId { get; set; }
            public System.String BranchName { get; set; }
            public System.Func<Amazon.Amplify.Model.DeleteBranchResponse, RemoveAMPBranchCmdlet, object> Select { get; set; } =
