...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    public partial class GetMHMigrationTaskListCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MigrationHub.Model.ListMigrationTasksRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.MigrationTaskSummaryList;
                        ...
                        int _receivedThisCall = response.MigrationTaskSummaryList.Count;
        ...
        private Amazon.MigrationHub.Model.ListMigrationTasksResponse CallAWSServiceOperation(IAmazonMigrationHub client, Amazon.MigrationHub.Model.ListMigrationTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub", "ListMigrationTasks");
            try
            {
                #if DESKTOP
                return client.ListMigrationTasks(request);
                #elif CORECLR
                return client.ListMigrationTasksAsync(request).GetAwaiter().GetResult();
                #else
