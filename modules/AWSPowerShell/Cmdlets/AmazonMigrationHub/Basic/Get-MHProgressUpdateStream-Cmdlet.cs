...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    public partial class GetMHProgressUpdateStreamCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MigrationHub.Model.ListProgressUpdateStreamsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ProgressUpdateStreamSummaryList;
                        ...
                        int _receivedThisCall = response.ProgressUpdateStreamSummaryList.Count;
        ...
        private Amazon.MigrationHub.Model.ListProgressUpdateStreamsResponse CallAWSServiceOperation(IAmazonMigrationHub client, Amazon.MigrationHub.Model.ListProgressUpdateStreamsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub", "ListProgressUpdateStreams");
            try
            {
                #if DESKTOP
                return client.ListProgressUpdateStreams(request);
                #elif CORECLR
                return client.ListProgressUpdateStreamsAsync(request).GetAwaiter().GetResult();
                #else
