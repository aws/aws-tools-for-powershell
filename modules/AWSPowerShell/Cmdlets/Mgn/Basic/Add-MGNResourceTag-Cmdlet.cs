...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// </summary>
    [Cmdlet("Add", "MGNResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddMGNResourceTagCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tag resource by Tags.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-MGNResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.TagResourceResponse, AddMGNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.TagResourceRequest();
        ...
        private Amazon.Mgn.Model.TagResourceResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Mgn.Model.TagResourceResponse, AddMGNResourceTagCmdlet, object> Select { get; set; } =
