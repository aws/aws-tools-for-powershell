...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// </summary>
    [Cmdlet("Update", "MGNNetworkMigrationMapperSegment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse")]
    [AWSCmdlet("Calls the Application Migration Service UpdateNetworkMigrationMapperSegment API operation.", Operation = new[] {"UpdateNetworkMigrationMapperSegment"}, SelectReturnType = typeof(Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse))]
    [AWSCmdletOutput("Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse",
        "This cmdlet returns an Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse object containing multiple properties."
    )]
    public partial class UpdateMGNNetworkMigrationMapperSegmentCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The updated scope tags for the segment.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ScopeTags")]
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the segment to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse).
        /// Specifying the name of a property of type Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            var targetParameterNames = new string[]
            {
                ...
                nameof(this.SegmentID)
            };
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(targetParameterNames, MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-MGNNetworkMigrationMapperSegment (UpdateNetworkMigrationMapperSegment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse, UpdateMGNNetworkMigrationMapperSegmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentRequest();
        ...
        private Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "UpdateNetworkMigrationMapperSegment");
            try
            {
                #if DESKTOP
                return client.UpdateNetworkMigrationMapperSegment(request);
                #elif CORECLR
                return client.UpdateNetworkMigrationMapperSegmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SegmentID { get; set; }
            public System.Func<Amazon.Mgn.Model.UpdateNetworkMigrationMapperSegmentResponse, UpdateMGNNetworkMigrationMapperSegmentCmdlet, object> Select { get; set; } =
