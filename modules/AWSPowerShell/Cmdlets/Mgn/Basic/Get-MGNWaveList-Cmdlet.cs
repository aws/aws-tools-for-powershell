...
{
    /// <summary>
    /// Retrieves all waves or multiple waves by ID.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Mgn.Model.Wave or Amazon.Mgn.Model.ListWavesResponse",
        ...
        "The service call response (type Amazon.Mgn.Model.ListWavesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMGNWaveListCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filter waves list by wave ID.</para><para />
        ...
        private Amazon.Mgn.Model.ListWavesResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ListWavesRequest request)
        {
            ...
            try
            {
                return client.ListWavesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
