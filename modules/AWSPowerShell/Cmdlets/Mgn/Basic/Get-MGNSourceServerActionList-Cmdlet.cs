...
{
    /// <summary>
    /// List source server post migration custom actions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Mgn.Model.SourceServerActionDocument or Amazon.Mgn.Model.ListSourceServerActionsResponse",
        ...
        "The service call response (type Amazon.Mgn.Model.ListSourceServerActionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMGNSourceServerActionListCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Action IDs to filter source server post migration custom actions by.</para><para />
        ...
        private Amazon.Mgn.Model.ListSourceServerActionsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ListSourceServerActionsRequest request)
        {
            ...
            try
            {
                return client.ListSourceServerActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
