...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    public partial class StartMGNNetworkMigrationCodeGenerationCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The output format types for code generation, such as CloudFormation or Terraform.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.Mgn.Model.StartNetworkMigrationCodeGenerationResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.StartNetworkMigrationCodeGenerationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartNetworkMigrationCodeGeneration(request);
                #elif CORECLR
                return client.StartNetworkMigrationCodeGenerationAsync(request).GetAwaiter().GetResult();
                #else
