...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    [AWSCmdlet("Calls the Application Migration Service MarkAsArchived API operation.", Operation = new[] {"MarkAsArchived"}, SelectReturnType = typeof(Amazon.Mgn.Model.MarkAsArchivedResponse))]
    [AWSCmdletOutput("Amazon.Mgn.Model.MarkAsArchivedResponse",
        "This cmdlet returns an Amazon.Mgn.Model.MarkAsArchivedResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetMGNAsArchivedCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-MGNAsArchived (MarkAsArchived)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.MarkAsArchivedResponse, SetMGNAsArchivedCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.MarkAsArchivedRequest();
        ...
        private Amazon.Mgn.Model.MarkAsArchivedResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.MarkAsArchivedRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "MarkAsArchived");
            try
            {
                #if DESKTOP
                return client.MarkAsArchived(request);
                #elif CORECLR
                return client.MarkAsArchivedAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountID { get; set; }
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Mgn.Model.MarkAsArchivedResponse, SetMGNAsArchivedCmdlet, object> Select { get; set; } =
