...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// </summary>
    [Cmdlet("Get", "MGNLaunchConfiguration")]
    [OutputType("Amazon.Mgn.Model.GetLaunchConfigurationResponse")]
    [AWSCmdlet("Calls the Application Migration Service GetLaunchConfiguration API operation.", Operation = new[] {"GetLaunchConfiguration"}, SelectReturnType = typeof(Amazon.Mgn.Model.GetLaunchConfigurationResponse))]
    [AWSCmdletOutput("Amazon.Mgn.Model.GetLaunchConfigurationResponse",
        "This cmdlet returns an Amazon.Mgn.Model.GetLaunchConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMGNLaunchConfigurationCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.GetLaunchConfigurationResponse, GetMGNLaunchConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.GetLaunchConfigurationRequest();
        ...
        private Amazon.Mgn.Model.GetLaunchConfigurationResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.GetLaunchConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "GetLaunchConfiguration");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Mgn.Model.GetLaunchConfigurationResponse, GetMGNLaunchConfigurationCmdlet, object> Select { get; set; } =
