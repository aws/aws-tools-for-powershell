...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// Delete wave.
    /// </summary>
    [Cmdlet("Remove", "MGNWave", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMGNWaveCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MGNWave (DeleteWave)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.DeleteWaveResponse, RemoveMGNWaveCmdlet>(Select) ??
        ...
        private Amazon.Mgn.Model.DeleteWaveResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.DeleteWaveRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "DeleteWave");
            try
            {
                #if DESKTOP
                return client.DeleteWave(request);
                #elif CORECLR
                return client.DeleteWaveAsync(request).GetAwaiter().GetResult();
                #else
