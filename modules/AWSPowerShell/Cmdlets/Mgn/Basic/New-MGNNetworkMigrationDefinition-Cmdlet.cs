...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    public partial class NewMGNNetworkMigrationDefinitionCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Scope tags for the network migration definition to control access and organization.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ScopeTags")]
        ...
        /// <summary>
        /// <para>
        /// <para>A list of source configurations for the network migration.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Tags to assign to the network migration definition.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.Mgn.Model.CreateNetworkMigrationDefinitionResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.CreateNetworkMigrationDefinitionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateNetworkMigrationDefinition(request);
                #elif CORECLR
                return client.CreateNetworkMigrationDefinitionAsync(request).GetAwaiter().GetResult();
                #else
