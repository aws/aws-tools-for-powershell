...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    public partial class WriteMGNTemplateActionCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Template post migration custom action external parameters.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Template post migration custom action parameters.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Mgn.Model.PutTemplateActionResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.PutTemplateActionRequest request)
        {
            ...
            try
            {
                return client.PutTemplateActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
