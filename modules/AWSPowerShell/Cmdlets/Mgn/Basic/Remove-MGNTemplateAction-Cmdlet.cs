...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MGNTemplateAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Application Migration Service RemoveTemplateAction API operation.", Operation = new[] {"RemoveTemplateAction"}, SelectReturnType = typeof(Amazon.Mgn.Model.RemoveTemplateActionResponse))]
    [AWSCmdletOutput("None or Amazon.Mgn.Model.RemoveTemplateActionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Mgn.Model.RemoveTemplateActionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveMGNTemplateActionCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MGNTemplateAction (RemoveTemplateAction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.RemoveTemplateActionResponse, RemoveMGNTemplateActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.RemoveTemplateActionRequest();
        ...
        private Amazon.Mgn.Model.RemoveTemplateActionResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.RemoveTemplateActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "RemoveTemplateAction");
            try
            {
                #if DESKTOP
                return client.RemoveTemplateAction(request);
                #elif CORECLR
                return client.RemoveTemplateActionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ActionID { get; set; }
            public System.String LaunchConfigurationTemplateID { get; set; }
            public System.Func<Amazon.Mgn.Model.RemoveTemplateActionResponse, RemoveMGNTemplateActionCmdlet, object> Select { get; set; } =
