...
{
    /// <summary>
    /// Returns a list of the installed vCenter clients.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMGNVcenterClientCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.DescribeVcenterClientsResponse, GetMGNVcenterClientCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Mgn.Model.DescribeVcenterClientsRequest();
        ...
        private Amazon.Mgn.Model.DescribeVcenterClientsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.DescribeVcenterClientsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "DescribeVcenterClients");
            try
            {
                return client.DescribeVcenterClientsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Mgn.Model.DescribeVcenterClientsResponse, GetMGNVcenterClientCmdlet, object> Select { get; set; } =
