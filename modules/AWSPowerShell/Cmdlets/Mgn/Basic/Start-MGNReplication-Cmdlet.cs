...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    [AWSCmdlet("Calls the Application Migration Service StartReplication API operation.", Operation = new[] {"StartReplication"}, SelectReturnType = typeof(Amazon.Mgn.Model.StartReplicationResponse))]
    [AWSCmdletOutput("Amazon.Mgn.Model.StartReplicationResponse",
        "This cmdlet returns an Amazon.Mgn.Model.StartReplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartMGNReplicationCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-MGNReplication (StartReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.StartReplicationResponse, StartMGNReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.StartReplicationRequest();
        ...
        private Amazon.Mgn.Model.StartReplicationResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.StartReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "StartReplication");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Mgn.Model.StartReplicationResponse, StartMGNReplicationCmdlet, object> Select { get; set; } =
