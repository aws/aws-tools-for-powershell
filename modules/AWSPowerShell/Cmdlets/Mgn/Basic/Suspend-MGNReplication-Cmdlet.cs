...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// Pause Replication.
    /// </summary>
    [Cmdlet("Suspend", "MGNReplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class SuspendMGNReplicationCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Suspend-MGNReplication (PauseReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.PauseReplicationResponse, SuspendMGNReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.PauseReplicationRequest();
        ...
        private Amazon.Mgn.Model.PauseReplicationResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.PauseReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "PauseReplication");
            try
            {
                #if DESKTOP
                return client.PauseReplication(request);
                #elif CORECLR
                return client.PauseReplicationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountID { get; set; }
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Mgn.Model.PauseReplicationResponse, SuspendMGNReplicationCmdlet, object> Select { get; set; } =
