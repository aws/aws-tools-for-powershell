...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MGNApplicationsFromWave", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMGNApplicationsFromWaveCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MGNApplicationsFromWave (DisassociateApplications)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.DisassociateApplicationsResponse, RemoveMGNApplicationsFromWaveCmdlet>(Select) ??
        ...
        private Amazon.Mgn.Model.DisassociateApplicationsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.DisassociateApplicationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "DisassociateApplications");
            try
            {
                return client.DisassociateApplicationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
