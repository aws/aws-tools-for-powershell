...
{
    /// <summary>
    /// List template post migration custom actions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMGNTemplateActionListCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Action IDs to filter template post migration custom actions by.</para><para />
        ...
        private Amazon.Mgn.Model.ListTemplateActionsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ListTemplateActionsRequest request)
        {
            ...
            try
            {
                return client.ListTemplateActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
