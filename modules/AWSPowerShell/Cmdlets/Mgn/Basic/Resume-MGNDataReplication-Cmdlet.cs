...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    /// or STOPPED state.
    /// </summary>
    [Cmdlet("Resume", "MGNDataReplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Mgn.Model.RetryDataReplicationResponse")]
    [AWSCmdlet("Calls the Application Migration Service RetryDataReplication API operation.", Operation = new[] {"RetryDataReplication"}, SelectReturnType = typeof(Amazon.Mgn.Model.RetryDataReplicationResponse))]
    [AWSCmdletOutput("Amazon.Mgn.Model.RetryDataReplicationResponse",
        "This cmdlet returns an Amazon.Mgn.Model.RetryDataReplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ResumeMGNDataReplicationCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Resume-MGNDataReplication (RetryDataReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mgn.Model.RetryDataReplicationResponse, ResumeMGNDataReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mgn.Model.RetryDataReplicationRequest();
        ...
        private Amazon.Mgn.Model.RetryDataReplicationResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.RetryDataReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Migration Service", "RetryDataReplication");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountID { get; set; }
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Mgn.Model.RetryDataReplicationResponse, ResumeMGNDataReplicationCmdlet, object> Select { get; set; } =
