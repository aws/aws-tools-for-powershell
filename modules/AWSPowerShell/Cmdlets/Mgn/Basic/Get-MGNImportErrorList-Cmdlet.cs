...
{
    /// <summary>
    /// List import errors.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Mgn.Model.ImportTaskError or Amazon.Mgn.Model.ListImportErrorsResponse",
        ...
        "The service call response (type Amazon.Mgn.Model.ListImportErrorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMGNImportErrorListCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        private Amazon.Mgn.Model.ListImportErrorsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ListImportErrorsRequest request)
        {
            ...
            try
            {
                return client.ListImportErrorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
