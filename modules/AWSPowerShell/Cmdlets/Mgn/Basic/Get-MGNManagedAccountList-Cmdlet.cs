...
{
    /// <summary>
    /// List Managed Accounts.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Mgn.Model.ManagedAccount or Amazon.Mgn.Model.ListManagedAccountsResponse",
        ...
        "The service call response (type Amazon.Mgn.Model.ListManagedAccountsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMGNManagedAccountListCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        private Amazon.Mgn.Model.ListManagedAccountsResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ListManagedAccountsRequest request)
        {
            ...
            try
            {
                return client.ListManagedAccountsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
