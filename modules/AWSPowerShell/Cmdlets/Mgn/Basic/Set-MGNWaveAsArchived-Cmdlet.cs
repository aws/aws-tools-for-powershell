...
namespace Amazon.PowerShell.Cmdlets.MGN
{
    ...
    [AWSCmdletOutput("Amazon.Mgn.Model.ArchiveWaveResponse",
        "This cmdlet returns an Amazon.Mgn.Model.ArchiveWaveResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetMGNWaveAsArchivedCmdlet : AmazonMgnClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^WaveID' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Mgn.Model.ArchiveWaveResponse CallAWSServiceOperation(IAmazonMgn client, Amazon.Mgn.Model.ArchiveWaveRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ArchiveWave(request);
                #elif CORECLR
                return client.ArchiveWaveAsync(request).GetAwaiter().GetResult();
                #else
