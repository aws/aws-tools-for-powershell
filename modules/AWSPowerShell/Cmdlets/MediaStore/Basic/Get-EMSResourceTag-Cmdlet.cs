...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMSResourceTag")]
    [OutputType("Amazon.MediaStore.Model.Tag")]
    [AWSCmdlet("Calls the AWS Elemental MediaStore ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.MediaStore.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.MediaStore.Model.Tag or Amazon.MediaStore.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.MediaStore.Model.Tag objects.",
        "The service call response (type Amazon.MediaStore.Model.ListTagsForResourceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMSResourceTagCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStore.Model.ListTagsForResourceResponse, GetEMSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaStore.Model.ListTagsForResourceRequest();
        ...
        private Amazon.MediaStore.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaStore", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Resource { get; set; }
            public System.Func<Amazon.MediaStore.Model.ListTagsForResourceResponse, GetEMSResourceTagCmdlet, object> Select { get; set; } =
