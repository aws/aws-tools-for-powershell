...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    public partial class GetEMSContainerPolicyCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStore.Model.GetContainerPolicyResponse, GetEMSContainerPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaStore.Model.GetContainerPolicyRequest();
        ...
        private Amazon.MediaStore.Model.GetContainerPolicyResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.GetContainerPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaStore", "GetContainerPolicy");
            try
            {
                #if DESKTOP
                return client.GetContainerPolicy(request);
                #elif CORECLR
                return client.GetContainerPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.MediaStore.Model.GetContainerPolicyResponse, GetEMSContainerPolicyCmdlet, object> Select { get; set; } =
