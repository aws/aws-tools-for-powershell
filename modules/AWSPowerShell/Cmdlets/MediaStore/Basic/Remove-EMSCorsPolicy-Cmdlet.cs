...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EMSCorsPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMSCorsPolicyCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMSCorsPolicy (DeleteCorsPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStore.Model.DeleteCorsPolicyResponse, RemoveEMSCorsPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaStore.Model.DeleteCorsPolicyRequest();
        ...
        private Amazon.MediaStore.Model.DeleteCorsPolicyResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.DeleteCorsPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaStore", "DeleteCorsPolicy");
            try
            {
                #if DESKTOP
                return client.DeleteCorsPolicy(request);
                #elif CORECLR
                return client.DeleteCorsPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContainerName { get; set; }
            public System.Func<Amazon.MediaStore.Model.DeleteCorsPolicyResponse, RemoveEMSCorsPolicyCmdlet, object> Select { get; set; } =
