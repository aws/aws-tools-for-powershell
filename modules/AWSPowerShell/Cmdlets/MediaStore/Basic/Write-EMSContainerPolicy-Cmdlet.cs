...
namespace Amazon.PowerShell.Cmdlets.EMS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Elemental MediaStore PutContainerPolicy API operation.", Operation = new[] {"PutContainerPolicy"}, SelectReturnType = typeof(Amazon.MediaStore.Model.PutContainerPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.MediaStore.Model.PutContainerPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.MediaStore.Model.PutContainerPolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteEMSContainerPolicyCmdlet : AmazonMediaStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaStore.Model.PutContainerPolicyResponse, WriteEMSContainerPolicyCmdlet>(Select) ??
        ...
        private Amazon.MediaStore.Model.PutContainerPolicyResponse CallAWSServiceOperation(IAmazonMediaStore client, Amazon.MediaStore.Model.PutContainerPolicyRequest request)
        {
            ...
            try
            {
                return client.PutContainerPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Name { get; set; }
            public System.String Policy { get; set; }
            public System.Func<Amazon.MediaStore.Model.PutContainerPolicyResponse, WriteEMSContainerPolicyCmdlet, object> Select { get; set; } =
