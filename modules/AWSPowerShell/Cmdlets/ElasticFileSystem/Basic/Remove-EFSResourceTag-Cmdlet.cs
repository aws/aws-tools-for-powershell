...
namespace Amazon.PowerShell.Cmdlets.EFS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EFSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Elastic File System UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.ElasticFileSystem.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.ElasticFileSystem.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ElasticFileSystem.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEFSResourceTagCmdlet : AmazonElasticFileSystemClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EFSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticFileSystem.Model.UntagResourceResponse, RemoveEFSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticFileSystem.Model.UntagResourceRequest();
        ...
        private Amazon.ElasticFileSystem.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonElasticFileSystem client, Amazon.ElasticFileSystem.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic File System", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ElasticFileSystem.Model.UntagResourceResponse, RemoveEFSResourceTagCmdlet, object> Select { get; set; } =
