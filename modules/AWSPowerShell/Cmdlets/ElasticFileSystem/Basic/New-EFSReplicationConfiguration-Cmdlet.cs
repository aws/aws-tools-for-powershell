...
namespace Amazon.PowerShell.Cmdlets.EFS
{
    ...
    /// </para><ul><li><para><b>Performance mode</b> - The destination file system's performance mode will match
    ...
    /// </para></li><li><para><b>Throughput mode</b> - The destination file system use the Bursting throughput
    /// mode by default. You can modify the throughput mode once the file system is created.
    /// </para></li></ul><para>
    /// The following properties are turned off by default:
    /// </para><ul><li><para><b>Lifecycle management</b> - EFS lifecycle management and intelligent tiering are
