...
namespace Amazon.PowerShell.Cmdlets.EFS
{
    ...
    public partial class AddEFSResourceTagCmdlet : AmazonElasticFileSystemClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of <c>Tag</c> objects to add. Each <c>Tag</c> object is a key-value pair.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EFSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticFileSystem.Model.TagResourceResponse, AddEFSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ElasticFileSystem.Model.TagResourceRequest();
        ...
        private Amazon.ElasticFileSystem.Model.TagResourceResponse CallAWSServiceOperation(IAmazonElasticFileSystem client, Amazon.ElasticFileSystem.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic File System", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ElasticFileSystem.Model.TagResourceResponse, AddEFSResourceTagCmdlet, object> Select { get; set; } =
