...
namespace Amazon.PowerShell.Cmdlets.EFS
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic File System DescribeTags API operation.", Operation = new[] {"DescribeTags"}, SelectReturnType = typeof(Amazon.ElasticFileSystem.Model.DescribeTagsResponse))]
    [AWSCmdletOutput("Amazon.ElasticFileSystem.Model.Tag or Amazon.ElasticFileSystem.Model.DescribeTagsResponse",
        "This cmdlet returns a collection of Amazon.ElasticFileSystem.Model.Tag objects.",
        "The service call response (type Amazon.ElasticFileSystem.Model.DescribeTagsResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetEFSTagCmdlet : AmazonElasticFileSystemClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticFileSystem.Model.DescribeTagsResponse, GetEFSTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.ElasticFileSystem.Model.DescribeTagsResponse, GetEFSTagCmdlet, object> Select { get; set; } =
