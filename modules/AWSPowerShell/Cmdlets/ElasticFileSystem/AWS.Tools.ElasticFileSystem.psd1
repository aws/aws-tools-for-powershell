#
# Module manifest for module 'AWS.Tools.ElasticFileSystem'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ElasticFileSystem.dll'
    ...
    GUID = '3fc11f1b-ce88-411b-81b7-bea376b050c7'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.ElasticFileSystem.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ElasticFileSystem.Completers.psm1',
        'AWS.Tools.ElasticFileSystem.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.ElasticFileSystem.dll-Help.xml'
    )
