...
namespace Amazon.PowerShell.Cmdlets.IE
{
    ...
    [AWSCmdlet("Calls the AWS Import/Export GetStatus API operation.", Operation = new[] {"GetStatus"}, SelectReturnType = typeof(Amazon.ImportExport.Model.GetStatusResponse))]
    [AWSCmdletOutput("Amazon.ImportExport.Model.GetStatusResponse",
        "This cmdlet returns an Amazon.ImportExport.Model.GetStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIEStatusCmdlet : AmazonImportExportClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ImportExport.Model.GetStatusResponse).
        /// Specifying the name of a property of type Amazon.ImportExport.Model.GetStatusResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ImportExport.Model.GetStatusResponse, GetIEStatusCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String APIVersion { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.ImportExport.Model.GetStatusResponse, GetIEStatusCmdlet, object> Select { get; set; } =
