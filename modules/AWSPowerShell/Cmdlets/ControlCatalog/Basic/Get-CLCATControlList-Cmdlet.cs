...
namespace Amazon.PowerShell.Cmdlets.CLCAT
{
    ...
    [AWSCmdletOutput("Amazon.ControlCatalog.Model.ControlSummary or Amazon.ControlCatalog.Model.ListControlsResponse",
        ...
        "The service call response (type Amazon.ControlCatalog.Model.ListControlsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
