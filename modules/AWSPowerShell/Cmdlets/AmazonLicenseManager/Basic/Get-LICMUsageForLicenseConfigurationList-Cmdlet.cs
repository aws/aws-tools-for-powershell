...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    /// </summary>
    [Cmdlet("Get", "LICMUsageForLicenseConfigurationList")]
    [OutputType("Amazon.LicenseManager.Model.LicenseConfigurationUsage")]
    [AWSCmdlet("Calls the AWS License Manager ListUsageForLicenseConfiguration API operation.", Operation = new[] {"ListUsageForLicenseConfiguration"})]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.LicenseConfigurationUsage",
        "This cmdlet returns a collection of LicenseConfigurationUsage objects.",
        "The service call response (type Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetLICMUsageForLicenseConfigurationListCmdlet : AmazonLicenseManagerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.LicenseConfigurationUsageList;
                        ...
                        int _receivedThisCall = response.LicenseConfigurationUsageList.Count;
        ...
        private Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationResponse CallAWSServiceOperation(IAmazonLicenseManager client, Amazon.LicenseManager.Model.ListUsageForLicenseConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager", "ListUsageForLicenseConfiguration");
            try
            {
                #if DESKTOP
                return client.ListUsageForLicenseConfiguration(request);
                #elif CORECLR
                return client.ListUsageForLicenseConfigurationAsync(request).GetAwaiter().GetResult();
                #else
