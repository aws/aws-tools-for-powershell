...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdlet("Calls the AWS License Manager GetServiceSettings API operation.", Operation = new[] {"GetServiceSettings"})]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.GetServiceSettingsResponse",
        "This cmdlet returns a Amazon.LicenseManager.Model.GetServiceSettingsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
