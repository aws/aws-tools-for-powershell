...
namespace Amazon.PowerShell.Cmdlets.LICM
{
    ...
    [AWSCmdlet("Calls the AWS License Manager ListAssociationsForLicenseConfiguration API operation.", Operation = new[] {"ListAssociationsForLicenseConfiguration"})]
    [AWSCmdletOutput("Amazon.LicenseManager.Model.LicenseConfigurationAssociation",
        "This cmdlet returns a collection of LicenseConfigurationAssociation objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.LicenseConfigurationAssociations;
