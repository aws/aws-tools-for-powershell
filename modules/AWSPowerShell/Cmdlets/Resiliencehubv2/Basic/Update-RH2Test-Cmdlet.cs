...
namespace Amazon.PowerShell.Cmdlets.RH2
{
    ...
    /// </summary>
    [Cmdlet("Update", "RH2Test", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Resiliencehubv2.Model.Test")]
    [AWSCmdlet("Calls the AWS Resilience Hub V2 UpdateTest API operation.", Operation = new[] {"UpdateTest"}, SelectReturnType = typeof(Amazon.Resiliencehubv2.Model.UpdateTestResponse))]
    [AWSCmdletOutput("Amazon.Resiliencehubv2.Model.Test or Amazon.Resiliencehubv2.Model.UpdateTestResponse",
        "This cmdlet returns an Amazon.Resiliencehubv2.Model.Test object.",
        "The service call response (type Amazon.Resiliencehubv2.Model.UpdateTestResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateRH2TestCmdlet : AmazonResiliencehubv2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The updated parameter values for the test.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The updated IAM execution role name.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated stop conditions for the test.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the test to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Resiliencehubv2.Model.UpdateTestResponse).
        /// Specifying the name of a property of type Amazon.Resiliencehubv2.Model.UpdateTestResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-RH2Test (UpdateTest)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Resiliencehubv2.Model.UpdateTestResponse, UpdateRH2TestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Resiliencehubv2.Model.UpdateTestRequest();
        ...
        private Amazon.Resiliencehubv2.Model.UpdateTestResponse CallAWSServiceOperation(IAmazonResiliencehubv2 client, Amazon.Resiliencehubv2.Model.UpdateTestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub V2", "UpdateTest");
            try
            {
                return client.UpdateTestAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TestId { get; set; }
            public System.Func<Amazon.Resiliencehubv2.Model.UpdateTestResponse, UpdateRH2TestCmdlet, object> Select { get; set; } =
