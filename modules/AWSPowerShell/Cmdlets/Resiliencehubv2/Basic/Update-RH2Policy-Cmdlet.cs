...
namespace Amazon.PowerShell.Cmdlets.RH2
{
    ...
    /// </summary>
    [Cmdlet("Update", "RH2Policy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Resiliencehubv2.Model.Policy")]
    [AWSCmdlet("Calls the AWS Resilience Hub V2 UpdatePolicy API operation.", Operation = new[] {"UpdatePolicy"}, SelectReturnType = typeof(Amazon.Resiliencehubv2.Model.UpdatePolicyResponse))]
    [AWSCmdletOutput("Amazon.Resiliencehubv2.Model.Policy or Amazon.Resiliencehubv2.Model.UpdatePolicyResponse",
        "This cmdlet returns an Amazon.Resiliencehubv2.Model.Policy object.",
        "The service call response (type Amazon.Resiliencehubv2.Model.UpdatePolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateRH2PolicyCmdlet : AmazonResiliencehubv2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Resiliencehubv2.Model.UpdatePolicyResponse).
        /// Specifying the name of a property of type Amazon.Resiliencehubv2.Model.UpdatePolicyResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-RH2Policy (UpdatePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Resiliencehubv2.Model.UpdatePolicyResponse, UpdateRH2PolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Resiliencehubv2.Model.UpdatePolicyRequest();
        ...
        private Amazon.Resiliencehubv2.Model.UpdatePolicyResponse CallAWSServiceOperation(IAmazonResiliencehubv2 client, Amazon.Resiliencehubv2.Model.UpdatePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub V2", "UpdatePolicy");
            try
            {
