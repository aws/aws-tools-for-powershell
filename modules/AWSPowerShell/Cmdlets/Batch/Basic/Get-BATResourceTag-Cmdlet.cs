...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    public partial class GetBATResourceTagCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// AWS Batch resources that support tags are compute environments, jobs, job definitions,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.ListTagsForResourceResponse, GetBATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Batch.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Batch.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Batch", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Batch.Model.ListTagsForResourceResponse, GetBATResourceTagCmdlet, object> Select { get; set; } =
