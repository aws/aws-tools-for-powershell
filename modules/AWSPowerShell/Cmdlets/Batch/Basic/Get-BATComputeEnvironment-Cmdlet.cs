...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [AWSCmdlet("Calls the AWS Batch DescribeComputeEnvironments API operation.", Operation = new[] {"DescribeComputeEnvironments"}, SelectReturnType = typeof(Amazon.Batch.Model.DescribeComputeEnvironmentsResponse))]
    [AWSCmdletOutput("Amazon.Batch.Model.ComputeEnvironmentDetail or Amazon.Batch.Model.DescribeComputeEnvironmentsResponse",
        "This cmdlet returns a collection of Amazon.Batch.Model.ComputeEnvironmentDetail objects.",
        "The service call response (type Amazon.Batch.Model.DescribeComputeEnvironmentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBATComputeEnvironmentCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of up to 100 compute environment names or full Amazon Resource Name (ARN) entries.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of cluster results returned by <c>DescribeComputeEnvironments</c>
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>DescribeComputeEnvironments</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ComputeEnvironments";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.DescribeComputeEnvironmentsResponse, GetBATComputeEnvironmentCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.ComputeEnvironment != null)
            {
                context.ComputeEnvironment = new List<System.String>(this.ComputeEnvironment);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Batch.Model.DescribeComputeEnvironmentsRequest();
            
            if (cmdletContext.ComputeEnvironment != null)
            {
                request.ComputeEnvironments = cmdletContext.ComputeEnvironment;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ComputeEnvironments?.Count ?? 0;
        ...
        private Amazon.Batch.Model.DescribeComputeEnvironmentsResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.DescribeComputeEnvironmentsRequest request)
        {
            ...
            try
            {
                return client.DescribeComputeEnvironmentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> ComputeEnvironment { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Batch.Model.DescribeComputeEnvironmentsResponse, GetBATComputeEnvironmentCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ComputeEnvironments;
        }
