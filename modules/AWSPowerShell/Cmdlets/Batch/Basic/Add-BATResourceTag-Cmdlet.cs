...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Batch TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.Batch.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Batch.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Batch.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddBATResourceTagCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the resource that tags are added to. AWS Batch resources
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-BATResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.TagResourceResponse, AddBATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Batch.Model.TagResourceRequest();
        ...
        private Amazon.Batch.Model.TagResourceResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Batch", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Batch.Model.TagResourceResponse, AddBATResourceTagCmdlet, object> Select { get; set; } =
