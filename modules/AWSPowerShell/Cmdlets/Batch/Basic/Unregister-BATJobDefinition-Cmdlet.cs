...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    public partial class UnregisterBATJobDefinitionCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^JobDefinition' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.JobDefinition), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.DeregisterJobDefinitionResponse, UnregisterBATJobDefinitionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.JobDefinition;
            }
        ...
        private Amazon.Batch.Model.DeregisterJobDefinitionResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.DeregisterJobDefinitionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeregisterJobDefinitionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobDefinition { get; set; }
            public System.Func<Amazon.Batch.Model.DeregisterJobDefinitionResponse, UnregisterBATJobDefinitionCmdlet, object> Select { get; set; } =
