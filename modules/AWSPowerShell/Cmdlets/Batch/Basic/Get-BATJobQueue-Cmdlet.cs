...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    /// </summary>
    [Cmdlet("Get", "BATJobQueue")]
    [OutputType("Amazon.Batch.Model.JobQueueDetail")]
    [AWSCmdlet("Calls the AWS Batch DescribeJobQueues API operation.", Operation = new[] {"DescribeJobQueues"}, SelectReturnType = typeof(Amazon.Batch.Model.DescribeJobQueuesResponse))]
    [AWSCmdletOutput("Amazon.Batch.Model.JobQueueDetail or Amazon.Batch.Model.DescribeJobQueuesResponse",
        "This cmdlet returns a collection of Amazon.Batch.Model.JobQueueDetail objects.",
        "The service call response (type Amazon.Batch.Model.DescribeJobQueuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBATJobQueueCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of up to 100 queue names or full queue Amazon Resource Name (ARN) entries.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results returned by <c>DescribeJobQueues</c> in paginated output.
        ...
        /// <summary>
        /// <para>
        /// <para>The <c>nextToken</c> value returned from a previous paginated <c>DescribeJobQueues</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "JobQueues";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.DescribeJobQueuesResponse, GetBATJobQueueCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.JobQueue != null)
            {
                context.JobQueue = new List<System.String>(this.JobQueue);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Batch.Model.DescribeJobQueuesRequest();
            
            if (cmdletContext.JobQueue != null)
            {
                request.JobQueues = cmdletContext.JobQueue;
            }
        ...
        private Amazon.Batch.Model.DescribeJobQueuesResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.DescribeJobQueuesRequest request)
        {
            ...
            try
            {
                return client.DescribeJobQueuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> JobQueue { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Batch.Model.DescribeJobQueuesResponse, GetBATJobQueueCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.JobQueues;
        }
