...
namespace Amazon.PowerShell.Cmdlets.BAT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Batch UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.Batch.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.Batch.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Batch.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveBATResourceTagCmdlet : AmazonBatchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-BATResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Batch.Model.UntagResourceResponse, RemoveBATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Batch.Model.UntagResourceRequest();
        ...
        private Amazon.Batch.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonBatch client, Amazon.Batch.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Batch", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Batch.Model.UntagResourceResponse, RemoveBATResourceTagCmdlet, object> Select { get; set; } =
