...
namespace Amazon.PowerShell.Cmdlets.SAR
{
    ...
    [AWSCmdlet("Calls the AWS Serverless Application Repository ListApplicationDependencies API operation.", Operation = new[] {"ListApplicationDependencies"})]
    [AWSCmdletOutput("Amazon.ServerlessApplicationRepository.Model.ApplicationDependencySummary",
        "This cmdlet returns a collection of ApplicationDependencySummary objects.",
    ...
    public partial class GetSARApplicationDependencyListCmdlet : AmazonServerlessApplicationRepositoryClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Dependencies;
                        ...
                        {
                            int _receivedThisCall = response.Dependencies.Count;
        ...
        private Amazon.ServerlessApplicationRepository.Model.ListApplicationDependenciesResponse CallAWSServiceOperation(IAmazonServerlessApplicationRepository client, Amazon.ServerlessApplicationRepository.Model.ListApplicationDependenciesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListApplicationDependenciesAsync(request);
                return task.Result;
                #else
