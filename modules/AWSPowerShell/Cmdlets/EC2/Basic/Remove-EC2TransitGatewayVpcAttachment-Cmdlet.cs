...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2TransitGatewayVpcAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveEC2TransitGatewayVpcAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2TransitGatewayVpcAttachment (DeleteTransitGatewayVpcAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteTransitGatewayVpcAttachmentResponse, RemoveEC2TransitGatewayVpcAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteTransitGatewayVpcAttachmentRequest();
        ...
        private Amazon.EC2.Model.DeleteTransitGatewayVpcAttachmentResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteTransitGatewayVpcAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteTransitGatewayVpcAttachment");
            try
            {
                #if DESKTOP
                return client.DeleteTransitGatewayVpcAttachment(request);
                #elif CORECLR
                return client.DeleteTransitGatewayVpcAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteTransitGatewayVpcAttachmentResponse, RemoveEC2TransitGatewayVpcAttachmentCmdlet, object> Select { get; set; } =
