...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DeleteVpnGateway API operation.", Operation = new[] {"DeleteVpnGateway"}, SelectReturnType = typeof(Amazon.EC2.Model.DeleteVpnGatewayResponse))]
    [AWSCmdletOutput("None or Amazon.EC2.Model.DeleteVpnGatewayResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.EC2.Model.DeleteVpnGatewayResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveEC2VpnGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^VpnGatewayId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteVpnGatewayResponse, RemoveEC2VpnGatewayCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.VpnGatewayId;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteVpnGateway");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VpnGatewayId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteVpnGatewayResponse, RemoveEC2VpnGatewayCmdlet, object> Select { get; set; } =
