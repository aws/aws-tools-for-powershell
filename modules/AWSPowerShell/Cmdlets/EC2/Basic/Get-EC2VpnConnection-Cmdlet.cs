...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2VpnConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// connection.</para></li><li><para><c>transit-gateway-id</c> - The ID of a transit gateway associated with the VPN connection.</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more VPN connection IDs.</para><para>Default: Describes your VPN connections.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.DescribeVpnConnectionsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVpnConnectionsRequest request)
        {
            ...
            try
            {
                return client.DescribeVpnConnectionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
