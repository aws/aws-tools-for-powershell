...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2InstanceAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The instance attribute.</para><para>Note that the <c>enaSupport</c> attribute is not supported.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        public string Select { get; set; } = "InstanceAttribute";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeInstanceAttributeResponse, GetEC2InstanceAttributeCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.DescribeInstanceAttributeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeInstanceAttributeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeInstanceAttribute");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.EC2.InstanceAttributeName Attribute { get; set; }
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeInstanceAttributeResponse, GetEC2InstanceAttributeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceAttribute;
        }
