...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DetachVerifiedAccessTrustProvider API operation.", Operation = new[] {"DetachVerifiedAccessTrustProvider"}, SelectReturnType = typeof(Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse",
        "This cmdlet returns an Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DismountEC2VerifiedAccessTrustProviderCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Dismount-EC2VerifiedAccessTrustProvider (DetachVerifiedAccessTrustProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse, DismountEC2VerifiedAccessTrustProviderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DetachVerifiedAccessTrustProviderRequest();
        ...
        private Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DetachVerifiedAccessTrustProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DetachVerifiedAccessTrustProvider");
            try
            {
                #if DESKTOP
                return client.DetachVerifiedAccessTrustProvider(request);
                #elif CORECLR
                return client.DetachVerifiedAccessTrustProviderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VerifiedAccessInstanceId { get; set; }
            public System.String VerifiedAccessTrustProviderId { get; set; }
            public System.Func<Amazon.EC2.Model.DetachVerifiedAccessTrustProviderResponse, DismountEC2VerifiedAccessTrustProviderCmdlet, object> Select { get; set; } =
