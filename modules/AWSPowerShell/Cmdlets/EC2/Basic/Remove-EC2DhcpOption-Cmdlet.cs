...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RemoveEC2DhcpOptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.DhcpOptionsId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteDhcpOptionsResponse, RemoveEC2DhcpOptionCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteDhcpOptions");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DhcpOptionsId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteDhcpOptionsResponse, RemoveEC2DhcpOptionCmdlet, object> Select { get; set; } =
