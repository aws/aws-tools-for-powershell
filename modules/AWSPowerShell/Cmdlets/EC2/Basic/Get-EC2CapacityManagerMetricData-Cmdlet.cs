...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2CapacityManagerMetricDataCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// operator ('equals', 'in'), and values to match against. </para><para />
        ...
        /// aggregated and returned. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para> The names of the metrics to retrieve. Maximum of 10 metrics per request. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.GetCapacityManagerMetricDataResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetCapacityManagerMetricDataRequest request)
        {
            ...
            try
            {
                return client.GetCapacityManagerMetricDataAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
