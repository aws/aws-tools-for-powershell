...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class ResetEC2ImageAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ResetImageAttributeResponse, ResetEC2ImageAttributeCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ResetImageAttribute");
            try
            {
                return client.ResetImageAttributeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.EC2.ResetImageAttributeName Attribute { get; set; }
            public System.String ImageId { get; set; }
            public System.Func<Amazon.EC2.Model.ResetImageAttributeResponse, ResetEC2ImageAttributeCmdlet, object> Select { get; set; } =
