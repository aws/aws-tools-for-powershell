...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class AddEC2CapacityReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// instances, you must request at least 8 instances (<i>8 * m5.xlarge = 32 vCPUs</i>).</para></note><para>Valid range: 1 - 1000</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to apply to the Capacity Reservation during launch.</para><para />
        ...
        private Amazon.EC2.Model.CreateCapacityReservationResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateCapacityReservationRequest request)
        {
            ...
            try
            {
                return client.CreateCapacityReservationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
