...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RemoveEC2VpcCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteVpcResponse, RemoveEC2VpcCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.DeleteVpcResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteVpcRequest request)
        {
            ...
            try
            {
                return client.DeleteVpcAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteVpcResponse, RemoveEC2VpcCmdlet, object> Select { get; set; } =
