...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) CopyFpgaImage API operation.", Operation = new[] {"CopyFpgaImage"}, SelectReturnType = typeof(Amazon.EC2.Model.CopyFpgaImageResponse))]
    [AWSCmdletOutput("System.String or Amazon.EC2.Model.CopyFpgaImageResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.EC2.Model.CopyFpgaImageResponse) can be returned by specifying '-Select *'."
    )]
    public partial class CopyEC2FpgaImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FpgaImageId";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SourceFpgaImageId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SourceFpgaImageId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CopyFpgaImageResponse, CopyEC2FpgaImageCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SourceFpgaImageId;
            }
            ...
            #if MODULAR
            if (this.SourceFpgaImageId == null && ParameterWasBound(nameof(this.SourceFpgaImageId)))
            {
                WriteWarning("You are passing $null as a value for parameter SourceFpgaImageId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CopyFpgaImage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SourceFpgaImageId { get; set; }
            public System.String SourceRegion { get; set; }
            public System.Func<Amazon.EC2.Model.CopyFpgaImageResponse, CopyEC2FpgaImageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FpgaImageId;
        }
