...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2InstanceEventNotificationAttribute")]
    ...
    public partial class GetEC2InstanceEventNotificationAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeInstanceEventNotificationAttributesResponse, GetEC2InstanceEventNotificationAttributeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DescribeInstanceEventNotificationAttributesRequest();
        ...
        private Amazon.EC2.Model.DescribeInstanceEventNotificationAttributesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeInstanceEventNotificationAttributesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeInstanceEventNotificationAttributes");
            try
            {
                #if DESKTOP
                return client.DescribeInstanceEventNotificationAttributes(request);
                #elif CORECLR
                return client.DescribeInstanceEventNotificationAttributesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.EC2.Model.DescribeInstanceEventNotificationAttributesResponse, GetEC2InstanceEventNotificationAttributeCmdlet, object> Select { get; set; } =
