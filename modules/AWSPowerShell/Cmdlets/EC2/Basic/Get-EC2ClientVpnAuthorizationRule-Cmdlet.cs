...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.AuthorizationRule or Amazon.EC2.Model.DescribeClientVpnAuthorizationRulesResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeClientVpnAuthorizationRulesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AuthorizationRules?.Count ?? 0;
