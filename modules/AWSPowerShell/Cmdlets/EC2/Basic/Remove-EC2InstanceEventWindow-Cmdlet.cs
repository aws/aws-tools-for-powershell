...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EC2InstanceEventWindow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.EC2.Model.InstanceEventWindowStateChange")]
    ...
    public partial class RemoveEC2InstanceEventWindowCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceEventWindowState";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2InstanceEventWindow (DeleteInstanceEventWindow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteInstanceEventWindowResponse, RemoveEC2InstanceEventWindowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteInstanceEventWindowRequest();
        ...
        private Amazon.EC2.Model.DeleteInstanceEventWindowResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteInstanceEventWindowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteInstanceEventWindow");
            try
            {
                #if DESKTOP
                return client.DeleteInstanceEventWindow(request);
                #elif CORECLR
                return client.DeleteInstanceEventWindowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? ForceDelete { get; set; }
            public System.String InstanceEventWindowId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteInstanceEventWindowResponse, RemoveEC2InstanceEventWindowCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceEventWindowState;
        }
