...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2IpamByoasn", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveEC2IpamByoasnCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.DeprovisionIpamByoasnResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.DeprovisionIpamByoasnResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2IpamByoasn (DeprovisionIpamByoasn)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeprovisionIpamByoasnResponse, RemoveEC2IpamByoasnCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeprovisionIpamByoasnRequest();
        ...
        private Amazon.EC2.Model.DeprovisionIpamByoasnResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeprovisionIpamByoasnRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeprovisionIpamByoasn");
            try
            {
                #if DESKTOP
                return client.DeprovisionIpamByoasn(request);
                #elif CORECLR
                return client.DeprovisionIpamByoasnAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Asn { get; set; }
            public System.String IpamId { get; set; }
            public System.Func<Amazon.EC2.Model.DeprovisionIpamByoasnResponse, RemoveEC2IpamByoasnCmdlet, object> Select { get; set; } =
