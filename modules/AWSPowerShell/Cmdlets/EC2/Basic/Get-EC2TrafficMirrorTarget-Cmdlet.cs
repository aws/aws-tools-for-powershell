...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2TrafficMirrorTarget")]
    ...
    public partial class GetEC2TrafficMirrorTargetCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TrafficMirrorTargets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeTrafficMirrorTargetsResponse, GetEC2TrafficMirrorTargetCmdlet>(Select) ??
            ...
            {
                context.TrafficMirrorTargetId = new List<System.String>(this.TrafficMirrorTargetId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeTrafficMirrorTargetsRequest();
            ...
            {
                request.TrafficMirrorTargetIds = cmdletContext.TrafficMirrorTargetId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TrafficMirrorTargets.Count;
        ...
        private Amazon.EC2.Model.DescribeTrafficMirrorTargetsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeTrafficMirrorTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeTrafficMirrorTargets");
            try
            {
                #if DESKTOP
                return client.DescribeTrafficMirrorTargets(request);
                #elif CORECLR
                return client.DescribeTrafficMirrorTargetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> TrafficMirrorTargetId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeTrafficMirrorTargetsResponse, GetEC2TrafficMirrorTargetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TrafficMirrorTargets;
        }
