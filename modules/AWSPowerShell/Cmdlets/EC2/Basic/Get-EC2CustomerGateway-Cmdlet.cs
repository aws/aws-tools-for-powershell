...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.CustomerGateway or Amazon.EC2.Model.DescribeCustomerGatewaysResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeCustomerGatewaysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2CustomerGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more customer gateway IDs.</para><para>Default: Describes all your customer gateways.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters.</para><ul><li><para><c>bgp-asn</c> - The customer gateway's Border Gateway Protocol (BGP) Autonomous
        /// System Number (ASN).</para></li><li><para><c>customer-gateway-id</c> - The ID of the customer gateway.</para></li><li><para><c>ip-address</c> - The IP address of the customer gateway device's external interface.</para></li><li><para><c>state</c> - The state of the customer gateway (<c>pending</c> | <c>available</c>
        /// | <c>deleting</c> | <c>deleted</c>).</para></li><li><para><c>type</c> - The type of customer gateway. Currently, the only supported type is
        /// <c>ipsec.1</c>.</para></li><li><para><c>tag</c>:&lt;key&gt; - The key/value combination of a tag assigned to the resource.
        ...
        private Amazon.EC2.Model.DescribeCustomerGatewaysResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeCustomerGatewaysRequest request)
        {
            ...
            try
            {
                return client.DescribeCustomerGatewaysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
