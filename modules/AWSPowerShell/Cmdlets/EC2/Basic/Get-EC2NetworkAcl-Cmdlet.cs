...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeNetworkAcls API operation.", Operation = new[] {"DescribeNetworkAcls"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeNetworkAclsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.NetworkAcl or Amazon.EC2.Model.DescribeNetworkAclsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.NetworkAcl objects.",
        "The service call response (type Amazon.EC2.Model.DescribeNetworkAclsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2NetworkAclCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>association.association-id</c> - The ID of an association ID for the ACL.</para></li><li><para><c>association.network-acl-id</c> - The ID of the network ACL involved in the association.</para></li><li><para><c>association.subnet-id</c> - The ID of the subnet involved in the association.</para></li><li><para><c>default</c> - Indicates whether the ACL is the default network ACL for the VPC.</para></li><li><para><c>entry.cidr</c> - The IPv4 CIDR range specified in the entry.</para></li><li><para><c>entry.icmp.code</c> - The ICMP code specified in the entry, if any.</para></li><li><para><c>entry.icmp.type</c> - The ICMP type specified in the entry, if any.</para></li><li><para><c>entry.ipv6-cidr</c> - The IPv6 CIDR range specified in the entry.</para></li><li><para><c>entry.port-range.from</c> - The start of the port range specified in the entry.
        /// </para></li><li><para><c>entry.port-range.to</c> - The end of the port range specified in the entry. </para></li><li><para><c>entry.protocol</c> - The protocol specified in the entry (<c>tcp</c> | <c>udp</c>
        /// | <c>icmp</c> or a protocol number).</para></li><li><para><c>entry.rule-action</c> - Allows or denies the matching traffic (<c>allow</c> |
        ...
        /// all resources assigned a tag with a specific key, regardless of the tag value.</para></li><li><para><c>vpc-id</c> - The ID of the VPC for the network ACL.</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the network ACLs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NetworkAcls";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeNetworkAclsResponse, GetEC2NetworkAclCmdlet>(Select) ??
            ...
            {
                context.NetworkAclId = new List<System.String>(this.NetworkAclId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.NetworkAcls?.Count ?? 0;
        ...
        private Amazon.EC2.Model.DescribeNetworkAclsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeNetworkAclsRequest request)
        {
            ...
            try
            {
                return client.DescribeNetworkAclsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public List<System.String> NetworkAclId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeNetworkAclsResponse, GetEC2NetworkAclCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NetworkAcls;
        }
