...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.CreateNetworkInsightsAccessScopeResponse",
        "This cmdlet returns an Amazon.EC2.Model.CreateNetworkInsightsAccessScopeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEC2NetworkInsightsAccessScopeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.CreateNetworkInsightsAccessScopeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateNetworkInsightsAccessScopeRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateNetworkInsightsAccessScope(request);
                #elif CORECLR
                return client.CreateNetworkInsightsAccessScopeAsync(request).GetAwaiter().GetResult();
                #else
