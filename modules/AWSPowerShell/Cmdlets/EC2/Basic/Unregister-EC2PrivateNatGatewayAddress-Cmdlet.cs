...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class UnregisterEC2PrivateNatGatewayAddressCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The private IPv4 addresses you want to unassign.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-EC2PrivateNatGatewayAddress (UnassignPrivateNatGatewayAddress)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.UnassignPrivateNatGatewayAddressResponse, UnregisterEC2PrivateNatGatewayAddressCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.UnassignPrivateNatGatewayAddressRequest();
        ...
        private Amazon.EC2.Model.UnassignPrivateNatGatewayAddressResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.UnassignPrivateNatGatewayAddressRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "UnassignPrivateNatGatewayAddress");
            try
            {
                return client.UnassignPrivateNatGatewayAddressAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.UnassignPrivateNatGatewayAddressResponse, UnregisterEC2PrivateNatGatewayAddressCmdlet, object> Select { get; set; } =
