...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.NetworkInsightsAccessScopeAnalysis or Amazon.EC2.Model.StartNetworkInsightsAccessScopeAnalysisResponse",
        ...
        "The service call response (type Amazon.EC2.Model.StartNetworkInsightsAccessScopeAnalysisResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
