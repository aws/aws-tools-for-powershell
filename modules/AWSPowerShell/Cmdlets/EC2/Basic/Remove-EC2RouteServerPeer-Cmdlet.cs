...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RemoveEC2RouteServerPeerCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RouteServerPeerId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RouteServerPeerId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RouteServerPeerId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RouteServerPeerId;
            }
        ...
        private Amazon.EC2.Model.DeleteRouteServerPeerResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteRouteServerPeerRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteRouteServerPeer(request);
                #elif CORECLR
                return client.DeleteRouteServerPeerAsync(request).GetAwaiter().GetResult();
                #else
