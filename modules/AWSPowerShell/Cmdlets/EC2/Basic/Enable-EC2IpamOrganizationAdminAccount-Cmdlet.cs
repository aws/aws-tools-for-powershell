...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Enable", "EC2IpamOrganizationAdminAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.Boolean")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) EnableIpamOrganizationAdminAccount API operation.", Operation = new[] {"EnableIpamOrganizationAdminAccount"}, SelectReturnType = typeof(Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse",
        "This cmdlet returns a System.Boolean object.",
        "The service call response (type Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EnableEC2IpamOrganizationAdminAccountCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-EC2IpamOrganizationAdminAccount (EnableIpamOrganizationAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse, EnableEC2IpamOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.EnableIpamOrganizationAdminAccountRequest();
        ...
        private Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.EnableIpamOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "EnableIpamOrganizationAdminAccount");
            try
            {
                #if DESKTOP
                return client.EnableIpamOrganizationAdminAccount(request);
                #elif CORECLR
                return client.EnableIpamOrganizationAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DelegatedAdminAccountId { get; set; }
            public System.Func<Amazon.EC2.Model.EnableIpamOrganizationAdminAccountResponse, EnableEC2IpamOrganizationAdminAccountCmdlet, object> Select { get; set; } =
