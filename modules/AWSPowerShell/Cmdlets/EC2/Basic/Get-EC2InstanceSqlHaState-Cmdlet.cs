...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// enabled for Amazon EC2 High Availability for SQL Server monitoring.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetEC2InstanceSqlHaStateCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeInstanceSqlHaStatesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeInstanceSqlHaStatesRequest request)
        {
            ...
            try
            {
                return client.DescribeInstanceSqlHaStatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
