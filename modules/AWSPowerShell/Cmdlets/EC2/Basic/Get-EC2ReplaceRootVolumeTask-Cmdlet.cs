...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// a root volume</a> in the <i>Amazon EC2 User Guide</i>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ReplaceRootVolumeTask or Amazon.EC2.Model.DescribeReplaceRootVolumeTasksResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeReplaceRootVolumeTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2ReplaceRootVolumeTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// task was created.</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the root volume replacement task to view.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.DescribeReplaceRootVolumeTasksResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeReplaceRootVolumeTasksRequest request)
        {
            ...
            try
            {
                return client.DescribeReplaceRootVolumeTasksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
