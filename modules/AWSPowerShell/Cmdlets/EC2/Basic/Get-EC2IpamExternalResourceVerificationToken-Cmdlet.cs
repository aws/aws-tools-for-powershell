...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.IpamExternalResourceVerificationToken or Amazon.EC2.Model.DescribeIpamExternalResourceVerificationTokensResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeIpamExternalResourceVerificationTokensResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
