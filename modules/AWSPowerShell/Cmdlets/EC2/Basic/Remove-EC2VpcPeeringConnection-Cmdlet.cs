...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RemoveEC2VpcPeeringConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteVpcPeeringConnectionResponse, RemoveEC2VpcPeeringConnectionCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.DeleteVpcPeeringConnectionResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteVpcPeeringConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteVpcPeeringConnection");
            try
            {
                return client.DeleteVpcPeeringConnectionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VpcPeeringConnectionId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteVpcPeeringConnectionResponse, RemoveEC2VpcPeeringConnectionCmdlet, object> Select { get; set; } =
