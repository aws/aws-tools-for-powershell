...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Set", "EC2TransitGatewayRoute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.TransitGatewayRoute")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) ReplaceTransitGatewayRoute API operation.", Operation = new[] {"ReplaceTransitGatewayRoute"}, SelectReturnType = typeof(Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayRoute or Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse",
        "This cmdlet returns an Amazon.EC2.Model.TransitGatewayRoute object.",
        "The service call response (type Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetEC2TransitGatewayRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-EC2TransitGatewayRoute (ReplaceTransitGatewayRoute)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse, SetEC2TransitGatewayRouteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.ReplaceTransitGatewayRouteRequest();
        ...
        private Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ReplaceTransitGatewayRouteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ReplaceTransitGatewayRoute");
            try
            {
                #if DESKTOP
                return client.ReplaceTransitGatewayRoute(request);
                #elif CORECLR
                return client.ReplaceTransitGatewayRouteAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.String TransitGatewayRouteTableId { get; set; }
            public System.Func<Amazon.EC2.Model.ReplaceTransitGatewayRouteResponse, SetEC2TransitGatewayRouteCmdlet, object> Select { get; set; } =
