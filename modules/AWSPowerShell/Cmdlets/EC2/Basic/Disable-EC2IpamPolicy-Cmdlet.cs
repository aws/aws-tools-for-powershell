...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disable", "EC2IpamPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.Boolean")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DisableIpamPolicy API operation.", Operation = new[] {"DisableIpamPolicy"}, SelectReturnType = typeof(Amazon.EC2.Model.DisableIpamPolicyResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.DisableIpamPolicyResponse",
        "This cmdlet returns a System.Boolean object.",
        "The service call response (type Amazon.EC2.Model.DisableIpamPolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class DisableEC2IpamPolicyCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the IPAM policy to disable.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the Amazon Web Services Organizations target for which to disable the IPAM
        ...
        /// omit this parameter and the policy will be disabled for the current account.</para><para>A target can be an individual Amazon Web Services account or an entity within an Amazon
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.DisableIpamPolicyResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.DisableIpamPolicyResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-EC2IpamPolicy (DisableIpamPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisableIpamPolicyResponse, DisableEC2IpamPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DisableIpamPolicyRequest();
        ...
        private Amazon.EC2.Model.DisableIpamPolicyResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisableIpamPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisableIpamPolicy");
            try
            {
                #if DESKTOP
                return client.DisableIpamPolicy(request);
                #elif CORECLR
                return client.DisableIpamPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String IpamPolicyId { get; set; }
            public System.String OrganizationTargetId { get; set; }
            public System.Func<Amazon.EC2.Model.DisableIpamPolicyResponse, DisableEC2IpamPolicyCmdlet, object> Select { get; set; } =
