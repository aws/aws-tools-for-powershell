...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2InstanceTpmEkPubCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specify this parameter to verify whether the request will succeed, without actually
        /// making the request. If the request will succeed, the response is <c>DryRunOperation</c>.
        /// Otherwise, the response is <c>UnauthorizedOperation</c>.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.EC2.Model.GetInstanceTpmEkPubResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetInstanceTpmEkPubRequest request)
        {
            ...
            try
            {
                return client.GetInstanceTpmEkPubAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
