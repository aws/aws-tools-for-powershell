...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2IamInstanceProfileAssociation")]
    [OutputType("Amazon.EC2.Model.IamInstanceProfileAssociation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeIamInstanceProfileAssociations API operation.", Operation = new[] {"DescribeIamInstanceProfileAssociations"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.IamInstanceProfileAssociation or Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.IamInstanceProfileAssociation objects.",
        "The service call response (type Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IamInstanceProfileAssociationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IamInstanceProfileAssociations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsResponse, GetEC2IamInstanceProfileAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.IamInstanceProfileAssociations?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeIamInstanceProfileAssociations");
            try
            {
                #if DESKTOP
                return client.DescribeIamInstanceProfileAssociations(request);
                #elif CORECLR
                return client.DescribeIamInstanceProfileAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeIamInstanceProfileAssociationsResponse, GetEC2IamInstanceProfileAssociationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IamInstanceProfileAssociations;
        }
