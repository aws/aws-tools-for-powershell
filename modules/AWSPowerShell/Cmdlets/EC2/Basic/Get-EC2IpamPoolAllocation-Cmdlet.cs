...
{
    /// <summary>
    /// Get a list of all the CIDR allocations in an IPAM pool.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EC2IpamPoolAllocation")]
    [OutputType("Amazon.EC2.Model.IpamPoolAllocation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) GetIpamPoolAllocations API operation.", Operation = new[] {"GetIpamPoolAllocations"}, SelectReturnType = typeof(Amazon.EC2.Model.GetIpamPoolAllocationsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.IpamPoolAllocation or Amazon.EC2.Model.GetIpamPoolAllocationsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.IpamPoolAllocation objects.",
        "The service call response (type Amazon.EC2.Model.GetIpamPoolAllocationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IpamPoolAllocationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetIpamPoolAllocationsResponse, GetEC2IpamPoolAllocationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.GetIpamPoolAllocationsRequest();
        ...
        private Amazon.EC2.Model.GetIpamPoolAllocationsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetIpamPoolAllocationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetIpamPoolAllocations");
            try
            {
                #if DESKTOP
                return client.GetIpamPoolAllocations(request);
                #elif CORECLR
                return client.GetIpamPoolAllocationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.GetIpamPoolAllocationsResponse, GetEC2IpamPoolAllocationCmdlet, object> Select { get; set; } =
