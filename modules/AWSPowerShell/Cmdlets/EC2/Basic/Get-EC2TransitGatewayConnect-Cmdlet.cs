...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayConnect or Amazon.EC2.Model.DescribeTransitGatewayConnectsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeTransitGatewayConnectsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
