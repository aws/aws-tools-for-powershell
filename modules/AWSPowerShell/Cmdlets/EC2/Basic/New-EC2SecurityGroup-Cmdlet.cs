...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class NewEC2SecurityGroupCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the security group. Names are case-insensitive and must be unique within
        /// the VPC.</para><para>Constraints: Up to 255 characters in length. Can't start with <c>sg-</c>.</para><para>Valid characters: a-z, A-Z, 0-9, spaces, and ._-:/()#,@[]+=&amp;;{}!$*</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to assign to the security group.</para><para />
        ...
        private Amazon.EC2.Model.CreateSecurityGroupResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateSecurityGroupRequest request)
        {
            ...
            try
            {
                return client.CreateSecurityGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
