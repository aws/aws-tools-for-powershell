...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ManagedPrefixList or Amazon.EC2.Model.DescribeManagedPrefixListsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeManagedPrefixListsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
