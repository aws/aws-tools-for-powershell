...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Search", "EC2LocalGatewayRoute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.LocalGatewayRoute")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) SearchLocalGatewayRoutes API operation.", Operation = new[] {"SearchLocalGatewayRoutes"}, SelectReturnType = typeof(Amazon.EC2.Model.SearchLocalGatewayRoutesResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.LocalGatewayRoute or Amazon.EC2.Model.SearchLocalGatewayRoutesResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.LocalGatewayRoute objects.",
        "The service call response (type Amazon.EC2.Model.SearchLocalGatewayRoutesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchEC2LocalGatewayRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Routes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-EC2LocalGatewayRoute (SearchLocalGatewayRoutes)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.SearchLocalGatewayRoutesResponse, SearchEC2LocalGatewayRouteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.SearchLocalGatewayRoutesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Routes?.Count ?? 0;
        ...
        private Amazon.EC2.Model.SearchLocalGatewayRoutesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.SearchLocalGatewayRoutesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "SearchLocalGatewayRoutes");
            try
            {
                #if DESKTOP
                return client.SearchLocalGatewayRoutes(request);
                #elif CORECLR
                return client.SearchLocalGatewayRoutesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.SearchLocalGatewayRoutesResponse, SearchEC2LocalGatewayRouteCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Routes;
        }
