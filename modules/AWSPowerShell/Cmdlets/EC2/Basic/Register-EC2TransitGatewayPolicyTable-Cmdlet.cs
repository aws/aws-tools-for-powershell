...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// table.
    /// </summary>
    [Cmdlet("Register", "EC2TransitGatewayPolicyTable")]
    [OutputType("Amazon.EC2.Model.TransitGatewayPolicyTableAssociation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) AssociateTransitGatewayPolicyTable API operation.", Operation = new[] {"AssociateTransitGatewayPolicyTable"}, SelectReturnType = typeof(Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayPolicyTableAssociation or Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse",
        "This cmdlet returns an Amazon.EC2.Model.TransitGatewayPolicyTableAssociation object.",
        "The service call response (type Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterEC2TransitGatewayPolicyTableCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse, RegisterEC2TransitGatewayPolicyTableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.AssociateTransitGatewayPolicyTableRequest();
        ...
        private Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AssociateTransitGatewayPolicyTableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "AssociateTransitGatewayPolicyTable");
            try
            {
                #if DESKTOP
                return client.AssociateTransitGatewayPolicyTable(request);
                #elif CORECLR
                return client.AssociateTransitGatewayPolicyTableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.String TransitGatewayPolicyTableId { get; set; }
            public System.Func<Amazon.EC2.Model.AssociateTransitGatewayPolicyTableResponse, RegisterEC2TransitGatewayPolicyTableCmdlet, object> Select { get; set; } =
