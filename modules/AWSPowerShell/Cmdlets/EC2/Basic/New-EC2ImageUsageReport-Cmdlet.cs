...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class NewEC2ImageUsageReportCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The resource types to include in the report.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <c>image-usage-report</c>; any other value will cause the report creation to fail.</para><para>To tag a report after it has been created, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateTags.html">CreateTags</a>.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.CreateImageUsageReportResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateImageUsageReportRequest request)
        {
            ...
            try
            {
                return client.CreateImageUsageReportAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
