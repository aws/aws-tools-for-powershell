...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeSnapshotAttribute API operation.", Operation = new[] {"DescribeSnapshotAttribute"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeSnapshotAttributeResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.DescribeSnapshotAttributeResponse",
        "This cmdlet returns an Amazon.EC2.Model.DescribeSnapshotAttributeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2SnapshotAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeSnapshotAttributeResponse, GetEC2SnapshotAttributeCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeSnapshotAttribute");
            try
            {
                #if DESKTOP
                return client.DescribeSnapshotAttribute(request);
                #elif CORECLR
                return client.DescribeSnapshotAttributeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.EC2.SnapshotAttributeName Attribute { get; set; }
            public System.String SnapshotId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeSnapshotAttributeResponse, GetEC2SnapshotAttributeCmdlet, object> Select { get; set; } =
