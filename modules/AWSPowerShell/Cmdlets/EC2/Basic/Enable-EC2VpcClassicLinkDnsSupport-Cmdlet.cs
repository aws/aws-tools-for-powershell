...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EnableEC2VpcClassicLinkDnsSupportCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.EnableVpcClassicLinkDnsSupportResponse, EnableEC2VpcClassicLinkDnsSupportCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.EnableVpcClassicLinkDnsSupportResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.EnableVpcClassicLinkDnsSupportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "EnableVpcClassicLinkDnsSupport");
            try
            {
                return client.EnableVpcClassicLinkDnsSupportAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.EnableVpcClassicLinkDnsSupportResponse, EnableEC2VpcClassicLinkDnsSupportCmdlet, object> Select { get; set; } =
