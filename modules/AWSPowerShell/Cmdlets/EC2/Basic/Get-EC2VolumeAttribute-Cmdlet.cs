...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.DescribeVolumeAttributeResponse",
        "This cmdlet returns an Amazon.EC2.Model.DescribeVolumeAttributeResponse object containing multiple properties."
    )]
    public partial class GetEC2VolumeAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeVolumeAttributeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVolumeAttributeRequest request)
        {
            ...
            try
            {
                return client.DescribeVolumeAttributeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
