...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeVolumeAttribute API operation.", Operation = new[] {"DescribeVolumeAttribute"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeVolumeAttributeResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.DescribeVolumeAttributeResponse",
        "This cmdlet returns an Amazon.EC2.Model.DescribeVolumeAttributeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2VolumeAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeVolumeAttributeResponse, GetEC2VolumeAttributeCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.DescribeVolumeAttributeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVolumeAttributeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeVolumeAttribute");
            try
            {
                #if DESKTOP
                return client.DescribeVolumeAttribute(request);
                #elif CORECLR
                return client.DescribeVolumeAttributeAsync(request).GetAwaiter().GetResult();
                #else
