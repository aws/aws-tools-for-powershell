...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EditEC2TransitGatewayMeteringPolicyCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of middlebox attachments to add to the metering policy.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of middlebox attachments to remove from the metering policy.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.EC2.Model.ModifyTransitGatewayMeteringPolicyResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyTransitGatewayMeteringPolicyRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ModifyTransitGatewayMeteringPolicy(request);
                #elif CORECLR
                return client.ModifyTransitGatewayMeteringPolicyAsync(request).GetAwaiter().GetResult();
                #else
