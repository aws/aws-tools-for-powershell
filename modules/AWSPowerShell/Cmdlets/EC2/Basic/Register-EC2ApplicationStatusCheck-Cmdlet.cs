...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Register", "EC2ApplicationStatusCheck", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.AssociateApplicationStatusCheckResponse")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) AssociateApplicationStatusCheck API operation.", Operation = new[] {"AssociateApplicationStatusCheck"}, SelectReturnType = typeof(Amazon.EC2.Model.AssociateApplicationStatusCheckResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.AssociateApplicationStatusCheckResponse",
        "This cmdlet returns an Amazon.EC2.Model.AssociateApplicationStatusCheckResponse object containing multiple properties."
    )]
    public partial class RegisterEC2ApplicationStatusCheckCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the application status check to associate.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the instances to associate with the application status check.</para><para />
        ...
        /// that have the specified tags.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.AssociateApplicationStatusCheckResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.AssociateApplicationStatusCheckResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-EC2ApplicationStatusCheck (AssociateApplicationStatusCheck)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.AssociateApplicationStatusCheckResponse, RegisterEC2ApplicationStatusCheckCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.AssociateApplicationStatusCheckRequest();
        ...
        private Amazon.EC2.Model.AssociateApplicationStatusCheckResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AssociateApplicationStatusCheckRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "AssociateApplicationStatusCheck");
            try
            {
                return client.AssociateApplicationStatusCheckAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.AssociateApplicationStatusCheckResponse, RegisterEC2ApplicationStatusCheckCmdlet, object> Select { get; set; } =
