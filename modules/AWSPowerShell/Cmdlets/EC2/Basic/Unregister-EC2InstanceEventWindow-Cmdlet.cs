...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Unregister", "EC2InstanceEventWindow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.InstanceEventWindow")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DisassociateInstanceEventWindow API operation.", Operation = new[] {"DisassociateInstanceEventWindow"}, SelectReturnType = typeof(Amazon.EC2.Model.DisassociateInstanceEventWindowResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.InstanceEventWindow or Amazon.EC2.Model.DisassociateInstanceEventWindowResponse",
        "This cmdlet returns an Amazon.EC2.Model.InstanceEventWindow object.",
        "The service call response (type Amazon.EC2.Model.DisassociateInstanceEventWindowResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnregisterEC2InstanceEventWindowCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-EC2InstanceEventWindow (DisassociateInstanceEventWindow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisassociateInstanceEventWindowResponse, UnregisterEC2InstanceEventWindowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DisassociateInstanceEventWindowRequest();
        ...
        private Amazon.EC2.Model.DisassociateInstanceEventWindowResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisassociateInstanceEventWindowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisassociateInstanceEventWindow");
            try
            {
                #if DESKTOP
                return client.DisassociateInstanceEventWindow(request);
                #elif CORECLR
                return client.DisassociateInstanceEventWindowAsync(request).GetAwaiter().GetResult();
                #else
