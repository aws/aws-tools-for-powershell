...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2NetworkInterfaceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// interface.</para></li><li><para><code>mac-address</code> - The MAC address of the network interface.</para></li><li><para><code>network-interface-id</code> - The ID of the network interface.</para></li><li><para><code>owner-id</code> - The account ID of the network interface owner.</para></li><li><para><code>private-ip-address</code> - The private IPv4 address or addresses of the network
        /// interface.</para></li><li><para><code>private-dns-name</code> - The private DNS name of the network interface (IPv4).</para></li><li><para><code>requester-id</code> - The alias or account ID of the principal or service that
        /// created the network interface.</para></li><li><para><code>requester-managed</code> - Indicates whether the network interface is being
