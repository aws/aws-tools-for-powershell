...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.NetworkInsightsAccessScopeAnalysis or Amazon.EC2.Model.DescribeNetworkInsightsAccessScopeAnalysesResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeNetworkInsightsAccessScopeAnalysesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
