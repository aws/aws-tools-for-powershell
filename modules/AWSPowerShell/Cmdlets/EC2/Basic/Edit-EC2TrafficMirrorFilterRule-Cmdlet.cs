...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.TrafficMirrorFilterRule or Amazon.EC2.Model.ModifyTrafficMirrorFilterRuleResponse",
        ...
        "The service call response (type Amazon.EC2.Model.ModifyTrafficMirrorFilterRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EditEC2TrafficMirrorFilterRuleCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TrafficMirrorFilterRuleId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TrafficMirrorFilterRuleId;
            }
        ...
        private Amazon.EC2.Model.ModifyTrafficMirrorFilterRuleResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyTrafficMirrorFilterRuleRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ModifyTrafficMirrorFilterRule(request);
                #elif CORECLR
                return client.ModifyTrafficMirrorFilterRuleAsync(request).GetAwaiter().GetResult();
                #else
