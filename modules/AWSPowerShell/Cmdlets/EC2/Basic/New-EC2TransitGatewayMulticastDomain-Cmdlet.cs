...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "EC2TransitGatewayMulticastDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewEC2TransitGatewayMulticastDomainCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags for the transit gateway multicast domain.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TransitGatewayMulticastDomain";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EC2TransitGatewayMulticastDomain (CreateTransitGatewayMulticastDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CreateTransitGatewayMulticastDomainResponse, NewEC2TransitGatewayMulticastDomainCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.CreateTransitGatewayMulticastDomainResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateTransitGatewayMulticastDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CreateTransitGatewayMulticastDomain");
            try
            {
                return client.CreateTransitGatewayMulticastDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.CreateTransitGatewayMulticastDomainResponse, NewEC2TransitGatewayMulticastDomainCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TransitGatewayMulticastDomain;
        }
