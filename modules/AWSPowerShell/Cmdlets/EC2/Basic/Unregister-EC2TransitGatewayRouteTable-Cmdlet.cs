...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "EC2TransitGatewayRouteTable", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.TransitGatewayAssociation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DisassociateTransitGatewayRouteTable API operation.", Operation = new[] {"DisassociateTransitGatewayRouteTable"}, SelectReturnType = typeof(Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayAssociation or Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse",
        "This cmdlet returns an Amazon.EC2.Model.TransitGatewayAssociation object.",
        "The service call response (type Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UnregisterEC2TransitGatewayRouteTableCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-EC2TransitGatewayRouteTable (DisassociateTransitGatewayRouteTable)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse, UnregisterEC2TransitGatewayRouteTableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DisassociateTransitGatewayRouteTableRequest();
        ...
        private Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisassociateTransitGatewayRouteTableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisassociateTransitGatewayRouteTable");
            try
            {
                #if DESKTOP
                return client.DisassociateTransitGatewayRouteTable(request);
                #elif CORECLR
                return client.DisassociateTransitGatewayRouteTableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.String TransitGatewayRouteTableId { get; set; }
            public System.Func<Amazon.EC2.Model.DisassociateTransitGatewayRouteTableResponse, UnregisterEC2TransitGatewayRouteTableCmdlet, object> Select { get; set; } =
