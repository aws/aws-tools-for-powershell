...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeVpcPeeringConnections API operation.", Operation = new[] {"DescribeVpcPeeringConnections"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeVpcPeeringConnectionsResponse), LegacyAlias="Get-EC2VpcPeeringConnections")]
    [AWSCmdletOutput("Amazon.EC2.Model.VpcPeeringConnection or Amazon.EC2.Model.DescribeVpcPeeringConnectionsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.VpcPeeringConnection objects.",
        "The service call response (type Amazon.EC2.Model.DescribeVpcPeeringConnectionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2VpcPeeringConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>accepter-vpc-info.cidr-block</c> - The IPv4 CIDR block of the accepter VPC.</para></li><li><para><c>accepter-vpc-info.owner-id</c> - The ID of the Amazon Web Services account that
        /// owns the accepter VPC.</para></li><li><para><c>accepter-vpc-info.vpc-id</c> - The ID of the accepter VPC.</para></li><li><para><c>expiration-time</c> - The expiration date and time for the VPC peering connection.</para></li><li><para><c>requester-vpc-info.cidr-block</c> - The IPv4 CIDR block of the requester's VPC.</para></li><li><para><c>requester-vpc-info.owner-id</c> - The ID of the Amazon Web Services account that
        ...
        /// all resources assigned a tag with a specific key, regardless of the tag value.</para></li><li><para><c>vpc-peering-connection-id</c> - The ID of the VPC peering connection.</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the VPC peering connections.</para><para>Default: Describes all your VPC peering connections.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeVpcPeeringConnectionsResponse, GetEC2VpcPeeringConnectionCmdlet>(Select) ??
            ...
            {
                context.VpcPeeringConnectionId = new List<System.String>(this.VpcPeeringConnectionId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.VpcPeeringConnectionIds = cmdletContext.VpcPeeringConnectionId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.VpcPeeringConnections?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeVpcPeeringConnections");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> VpcPeeringConnectionId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeVpcPeeringConnectionsResponse, GetEC2VpcPeeringConnectionCmdlet, object> Select { get; set; } =
