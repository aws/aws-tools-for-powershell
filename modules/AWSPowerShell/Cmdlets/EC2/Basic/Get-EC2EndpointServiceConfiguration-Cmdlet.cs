...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ServiceConfiguration or Amazon.EC2.Model.DescribeVpcEndpointServiceConfigurationsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeVpcEndpointServiceConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2EndpointServiceConfigurationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>service-name</c> - The name of the service.</para></li><li><para><c>service-id</c> - The ID of the service.</para></li><li><para><c>service-state</c> - The state of the service (<c>Pending</c> | <c>Available</c>
        /// | <c>Deleting</c> | <c>Deleted</c> | <c>Failed</c>). </para></li><li><para><c>supported-ip-address-types</c> - The IP address type (<c>ipv4</c> | <c>ipv6</c>).</para></li><li><para><c>tag</c>:&lt;key&gt; - The key/value combination of a tag assigned to the resource.
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the endpoint services.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ServiceConfigurations?.Count ?? 0;
        ...
        private Amazon.EC2.Model.DescribeVpcEndpointServiceConfigurationsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVpcEndpointServiceConfigurationsRequest request)
        {
            ...
            try
            {
                return client.DescribeVpcEndpointServiceConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
