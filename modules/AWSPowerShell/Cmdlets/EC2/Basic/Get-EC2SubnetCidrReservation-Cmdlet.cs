...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2SubnetCidrReservation")]
    [OutputType("Amazon.EC2.Model.GetSubnetCidrReservationsResponse")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) GetSubnetCidrReservations API operation.", Operation = new[] {"GetSubnetCidrReservations"}, SelectReturnType = typeof(Amazon.EC2.Model.GetSubnetCidrReservationsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.GetSubnetCidrReservationsResponse",
        "This cmdlet returns an Amazon.EC2.Model.GetSubnetCidrReservationsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2SubnetCidrReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetSubnetCidrReservationsResponse, GetEC2SubnetCidrReservationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.GetSubnetCidrReservationsRequest();
        ...
        private Amazon.EC2.Model.GetSubnetCidrReservationsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetSubnetCidrReservationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetSubnetCidrReservations");
            try
            {
                #if DESKTOP
                return client.GetSubnetCidrReservations(request);
                #elif CORECLR
                return client.GetSubnetCidrReservationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SubnetId { get; set; }
            public System.Func<Amazon.EC2.Model.GetSubnetCidrReservationsResponse, GetEC2SubnetCidrReservationCmdlet, object> Select { get; set; } =
