...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeVerifiedAccessGroups API operation.", Operation = new[] {"DescribeVerifiedAccessGroups"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.VerifiedAccessGroup or Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.VerifiedAccessGroup objects.",
        "The service call response (type Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2VerifiedAccessGroupCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VerifiedAccessGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse, GetEC2VerifiedAccessGroupCmdlet>(Select) ??
            ...
            if (this.VerifiedAccessGroupId != null)
            {
                context.VerifiedAccessGroupId = new List<System.String>(this.VerifiedAccessGroupId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeVerifiedAccessGroupsRequest();
            ...
            {
                request.VerifiedAccessGroupIds = cmdletContext.VerifiedAccessGroupId;
            }
        ...
        private Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVerifiedAccessGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeVerifiedAccessGroups");
            try
            {
                #if DESKTOP
                return client.DescribeVerifiedAccessGroups(request);
                #elif CORECLR
                return client.DescribeVerifiedAccessGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> VerifiedAccessGroupId { get; set; }
            public System.String VerifiedAccessInstanceId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeVerifiedAccessGroupsResponse, GetEC2VerifiedAccessGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VerifiedAccessGroups;
        }
