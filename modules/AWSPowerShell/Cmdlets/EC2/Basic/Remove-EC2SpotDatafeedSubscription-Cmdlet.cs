...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RemoveEC2SpotDatafeedSubscriptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteSpotDatafeedSubscriptionResponse, RemoveEC2SpotDatafeedSubscriptionCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteSpotDatafeedSubscription");
            try
            {
                return client.DeleteSpotDatafeedSubscriptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Boolean? DryRun { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteSpotDatafeedSubscriptionResponse, RemoveEC2SpotDatafeedSubscriptionCmdlet, object> Select { get; set; } =
