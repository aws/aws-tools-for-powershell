...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.SearchTransitGatewayRoutesResponse",
        "This cmdlet returns an Amazon.EC2.Model.SearchTransitGatewayRoutesResponse object containing multiple properties."
    )]
    public partial class SearchEC2TransitGatewayRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters. The possible values are:</para><ul><li><para><c>attachment.transit-gateway-attachment-id</c>- The id of the transit gateway attachment.</para></li><li><para><c>attachment.resource-id</c> - The resource id of the transit gateway attachment.</para></li><li><para><c>attachment.resource-type</c> - The attachment resource type. Valid values are
        /// <c>vpc</c> | <c>vpn</c> | <c>direct-connect-gateway</c> | <c>peering</c> | <c>connect</c>.</para></li><li><para><c>prefix-list-id</c> - The ID of the prefix list.</para></li><li><para><c>route-search.exact-match</c> - The exact match of the specified filter.</para></li><li><para><c>route-search.longest-prefix-match</c> - The longest prefix that matches the route.</para></li><li><para><c>route-search.subnet-of-match</c> - The routes with a subnet that match the specified
        ...
        /// table and you specify supernet-of-match as 10.0.1.0/30, then the result returns 10.0.1.0/29.</para></li><li><para><c>state</c> - The state of the route (<c>active</c> | <c>blackhole</c>).</para></li><li><para><c>type</c> - The type of route (<c>propagated</c> | <c>static</c>).</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of routes to return. If a value is not provided, the default is
        /// 1000.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.EC2.Model.SearchTransitGatewayRoutesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.SearchTransitGatewayRoutesRequest request)
        {
            ...
            try
            {
                return client.SearchTransitGatewayRoutesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
