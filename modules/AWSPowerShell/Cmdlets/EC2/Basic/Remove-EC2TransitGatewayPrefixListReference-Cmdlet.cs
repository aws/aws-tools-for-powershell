...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// table.
    /// </summary>
    [Cmdlet("Remove", "EC2TransitGatewayPrefixListReference", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.EC2.Model.TransitGatewayPrefixListReference")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DeleteTransitGatewayPrefixListReference API operation.", Operation = new[] {"DeleteTransitGatewayPrefixListReference"}, SelectReturnType = typeof(Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayPrefixListReference or Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse",
        "This cmdlet returns an Amazon.EC2.Model.TransitGatewayPrefixListReference object.",
        "The service call response (type Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2TransitGatewayPrefixListReferenceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2TransitGatewayPrefixListReference (DeleteTransitGatewayPrefixListReference)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse, RemoveEC2TransitGatewayPrefixListReferenceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceRequest();
        ...
        private Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteTransitGatewayPrefixListReference");
            try
            {
                #if DESKTOP
                return client.DeleteTransitGatewayPrefixListReference(request);
                #elif CORECLR
                return client.DeleteTransitGatewayPrefixListReferenceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PrefixListId { get; set; }
            public System.String TransitGatewayRouteTableId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteTransitGatewayPrefixListReferenceResponse, RemoveEC2TransitGatewayPrefixListReferenceCmdlet, object> Select { get; set; } =
