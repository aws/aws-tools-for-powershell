...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class NewEC2RouteServerCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AmazonSideAsn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AmazonSideAsn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AmazonSideAsn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AmazonSideAsn;
            }
        ...
        private Amazon.EC2.Model.CreateRouteServerResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateRouteServerRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateRouteServer(request);
                #elif CORECLR
                return client.CreateRouteServerAsync(request).GetAwaiter().GetResult();
                #else
