...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeVpcs API operation.", Operation = new[] {"DescribeVpcs"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeVpcsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.Vpc or Amazon.EC2.Model.DescribeVpcsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.Vpc objects.",
        "The service call response (type Amazon.EC2.Model.DescribeVpcsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2VpcCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>cidr</c> - The primary IPv4 CIDR block of the VPC. The CIDR block you specify
        /// must exactly match the VPC's CIDR block for information to be returned for the VPC.
        /// Must contain the slash followed by one or two digits (for example, <c>/28</c>).</para></li><li><para><c>cidr-block-association.cidr-block</c> - An IPv4 CIDR block associated with the
        /// VPC.</para></li><li><para><c>cidr-block-association.association-id</c> - The association ID for an IPv4 CIDR
        /// block associated with the VPC.</para></li><li><para><c>cidr-block-association.state</c> - The state of an IPv4 CIDR block associated
        /// with the VPC.</para></li><li><para><c>dhcp-options-id</c> - The ID of a set of DHCP options.</para></li><li><para><c>ipv6-cidr-block-association.ipv6-cidr-block</c> - An IPv6 CIDR block associated
        ...
        /// all resources assigned a tag with a specific key, regardless of the tag value.</para></li><li><para><c>vpc-id</c> - The ID of the VPC.</para></li></ul><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the VPCs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeVpcsResponse, GetEC2VpcCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Vpcs?.Count ?? 0;
        ...
        private Amazon.EC2.Model.DescribeVpcsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVpcsRequest request)
        {
            ...
            try
            {
                return client.DescribeVpcsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.DescribeVpcsResponse, GetEC2VpcCmdlet, object> Select { get; set; } =
