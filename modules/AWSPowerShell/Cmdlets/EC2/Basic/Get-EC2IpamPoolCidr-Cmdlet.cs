...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2IpamPoolCidrCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IpamPoolCidrs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetIpamPoolCidrsResponse, GetEC2IpamPoolCidrCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.GetIpamPoolCidrsRequest();
        ...
        private Amazon.EC2.Model.GetIpamPoolCidrsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetIpamPoolCidrsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetIpamPoolCidrs");
            try
            {
                #if DESKTOP
                return client.GetIpamPoolCidrs(request);
                #elif CORECLR
                return client.GetIpamPoolCidrsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.GetIpamPoolCidrsResponse, GetEC2IpamPoolCidrCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IpamPoolCidrs;
        }
