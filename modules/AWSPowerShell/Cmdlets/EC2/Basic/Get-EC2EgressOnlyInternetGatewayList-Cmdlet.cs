...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// gateways that match specific criteria.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EC2EgressOnlyInternetGatewayList")]
    [OutputType("Amazon.EC2.Model.EgressOnlyInternetGateway")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeEgressOnlyInternetGateways API operation.", Operation = new[] {"DescribeEgressOnlyInternetGateways"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.EgressOnlyInternetGateway or Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.EgressOnlyInternetGateway objects.",
        "The service call response (type Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2EgressOnlyInternetGatewayListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the egress-only internet gateways.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("EgressOnlyInternetGatewayIds")]
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>tag</c> - The key/value combination of a tag assigned to the resource. Use the
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EgressOnlyInternetGateways";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysResponse, GetEC2EgressOnlyInternetGatewayListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.EgressOnlyInternetGateways?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeEgressOnlyInternetGateways");
            try
            {
                return client.DescribeEgressOnlyInternetGatewaysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.DescribeEgressOnlyInternetGatewaysResponse, GetEC2EgressOnlyInternetGatewayListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EgressOnlyInternetGateways;
        }
