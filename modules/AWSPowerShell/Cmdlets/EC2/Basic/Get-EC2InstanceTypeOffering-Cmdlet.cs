...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.InstanceTypeOffering or Amazon.EC2.Model.DescribeInstanceTypeOfferingsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeInstanceTypeOfferingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2InstanceTypeOfferingCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeInstanceTypeOfferingsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeInstanceTypeOfferingsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeInstanceTypeOfferingsAsync(request).GetAwaiter().GetResult();
                #else
