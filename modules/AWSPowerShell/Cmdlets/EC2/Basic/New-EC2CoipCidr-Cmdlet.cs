...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("New", "EC2CoipCidr", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.CoipCidr")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) CreateCoipCidr API operation.", Operation = new[] {"CreateCoipCidr"}, SelectReturnType = typeof(Amazon.EC2.Model.CreateCoipCidrResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.CoipCidr or Amazon.EC2.Model.CreateCoipCidrResponse",
        "This cmdlet returns an Amazon.EC2.Model.CoipCidr object.",
        "The service call response (type Amazon.EC2.Model.CreateCoipCidrResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEC2CoipCidrCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EC2CoipCidr (CreateCoipCidr)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CreateCoipCidrResponse, NewEC2CoipCidrCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.CreateCoipCidrRequest();
        ...
        private Amazon.EC2.Model.CreateCoipCidrResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateCoipCidrRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CreateCoipCidr");
            try
            {
                #if DESKTOP
                return client.CreateCoipCidr(request);
                #elif CORECLR
                return client.CreateCoipCidrAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Cidr { get; set; }
            public System.String CoipPoolId { get; set; }
            public System.Func<Amazon.EC2.Model.CreateCoipCidrResponse, NewEC2CoipCidrCmdlet, object> Select { get; set; } =
