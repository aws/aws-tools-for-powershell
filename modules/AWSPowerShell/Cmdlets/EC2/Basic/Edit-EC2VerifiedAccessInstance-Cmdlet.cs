...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Edit", "EC2VerifiedAccessInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.VerifiedAccessInstance")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) ModifyVerifiedAccessInstance API operation.", Operation = new[] {"ModifyVerifiedAccessInstance"}, SelectReturnType = typeof(Amazon.EC2.Model.ModifyVerifiedAccessInstanceResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.VerifiedAccessInstance or Amazon.EC2.Model.ModifyVerifiedAccessInstanceResponse",
        "This cmdlet returns an Amazon.EC2.Model.VerifiedAccessInstance object.",
        "The service call response (type Amazon.EC2.Model.ModifyVerifiedAccessInstanceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EditEC2VerifiedAccessInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        
        #region Parameter Description
        /// <summary>
        /// <para>
        /// <para>A description for the Amazon Web Services Verified Access instance.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-EC2VerifiedAccessInstance (ModifyVerifiedAccessInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ModifyVerifiedAccessInstanceResponse, EditEC2VerifiedAccessInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.ModifyVerifiedAccessInstanceRequest();
        ...
        private Amazon.EC2.Model.ModifyVerifiedAccessInstanceResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyVerifiedAccessInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ModifyVerifiedAccessInstance");
            try
            {
                #if DESKTOP
                return client.ModifyVerifiedAccessInstance(request);
                #elif CORECLR
                return client.ModifyVerifiedAccessInstanceAsync(request).GetAwaiter().GetResult();
                #else
