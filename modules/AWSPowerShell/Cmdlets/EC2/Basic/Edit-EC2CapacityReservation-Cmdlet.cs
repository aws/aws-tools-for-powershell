...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EditEC2CapacityReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        #region Parameter AcceptModificationTerm
        /// <summary>
        /// <para>
        /// <para>Indicates that you accept the modification terms of the quote identified by <c>QuoteId</c>.
        /// To apply a quoted modification, set this parameter to <c>true</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("AcceptModificationTerms")]
        public System.Boolean? AcceptModificationTerm { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the quote that describes the modification you want to apply. Generate a
        /// quote by using <c>CreateCapacityReservationDateChangeQuote</c>. The quote must be
        /// in the <c>active</c> state, and each quote can be used only once.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The new start date for the Capacity Reservation, in the ISO8601 format in the UTC
        /// time zone (<c>YYYY-MM-DDThh:mm:ss.sssZ</c>). Applies to future-dated Capacity Reservations
        /// only. Requires a quote from <c>CreateCapacityReservationDateChangeQuote</c>; pass
        /// the quote ID in <c>QuoteId</c> with <c>AcceptModificationTerms</c> set to <c>true</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            context.AcceptModificationTerm = this.AcceptModificationTerm;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.AcceptModificationTerm != null)
            {
                request.AcceptModificationTerms = cmdletContext.AcceptModificationTerm.Value;
            }
