...
{
    /// <summary>
    /// Describes the Outpost service link virtual interfaces.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetEC2ServiceLinkVirtualInterfaceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the service link virtual interfaces.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.DescribeServiceLinkVirtualInterfacesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeServiceLinkVirtualInterfacesRequest request)
        {
            ...
            try
            {
                return client.DescribeServiceLinkVirtualInterfacesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
