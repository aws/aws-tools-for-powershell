...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class RegisterEC2NatGatewayAddressCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The allocation IDs of EIPs that you want to associate with your NAT gateway.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The private IPv4 addresses that you want to assign to the NAT gateway.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.AssociateNatGatewayAddressResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AssociateNatGatewayAddressRequest request)
        {
            ...
            try
            {
                return client.AssociateNatGatewayAddressAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
