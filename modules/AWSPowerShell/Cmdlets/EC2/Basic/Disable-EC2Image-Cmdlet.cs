...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disable", "EC2Image", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class DisableEC2ImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.DisableImageResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.DisableImageResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-EC2Image (DisableImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisableImageResponse, DisableEC2ImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DisableImageRequest();
        ...
        private Amazon.EC2.Model.DisableImageResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisableImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisableImage");
            try
            {
                #if DESKTOP
                return client.DisableImage(request);
                #elif CORECLR
                return client.DisableImageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ImageId { get; set; }
            public System.Func<Amazon.EC2.Model.DisableImageResponse, DisableEC2ImageCmdlet, object> Select { get; set; } =
