...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("New", "EC2CarrierGateway", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.CarrierGateway")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) CreateCarrierGateway API operation.", Operation = new[] {"CreateCarrierGateway"}, SelectReturnType = typeof(Amazon.EC2.Model.CreateCarrierGatewayResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.CarrierGateway or Amazon.EC2.Model.CreateCarrierGatewayResponse",
        "This cmdlet returns an Amazon.EC2.Model.CarrierGateway object.",
        "The service call response (type Amazon.EC2.Model.CreateCarrierGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEC2CarrierGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EC2CarrierGateway (CreateCarrierGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CreateCarrierGatewayResponse, NewEC2CarrierGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.CreateCarrierGatewayRequest();
        ...
        private Amazon.EC2.Model.CreateCarrierGatewayResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateCarrierGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CreateCarrierGateway");
            try
            {
                #if DESKTOP
                return client.CreateCarrierGateway(request);
                #elif CORECLR
                return client.CreateCarrierGatewayAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.CreateCarrierGatewayResponse, NewEC2CarrierGatewayCmdlet, object> Select { get; set; } =
