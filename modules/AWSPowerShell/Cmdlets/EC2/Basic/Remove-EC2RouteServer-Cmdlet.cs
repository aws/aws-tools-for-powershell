...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "EC2RouteServer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.EC2.Model.RouteServer")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DeleteRouteServer API operation.", Operation = new[] {"DeleteRouteServer"}, SelectReturnType = typeof(Amazon.EC2.Model.DeleteRouteServerResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.RouteServer or Amazon.EC2.Model.DeleteRouteServerResponse",
        "This cmdlet returns an Amazon.EC2.Model.RouteServer object.",
        "The service call response (type Amazon.EC2.Model.DeleteRouteServerResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveEC2RouteServerCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the route server to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.DeleteRouteServerResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.DeleteRouteServerResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2RouteServer (DeleteRouteServer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteRouteServerResponse, RemoveEC2RouteServerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteRouteServerRequest();
        ...
        private Amazon.EC2.Model.DeleteRouteServerResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteRouteServerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteRouteServer");
            try
            {
                #if DESKTOP
                return client.DeleteRouteServer(request);
                #elif CORECLR
                return client.DeleteRouteServerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RouteServerId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteRouteServerResponse, RemoveEC2RouteServerCmdlet, object> Select { get; set; } =
