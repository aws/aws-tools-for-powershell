...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Set", "EC2VpnTunnel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.Boolean")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) ReplaceVpnTunnel API operation.", Operation = new[] {"ReplaceVpnTunnel"}, SelectReturnType = typeof(Amazon.EC2.Model.ReplaceVpnTunnelResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.ReplaceVpnTunnelResponse",
        "This cmdlet returns a collection of System.Boolean objects.",
        "The service call response (type Amazon.EC2.Model.ReplaceVpnTunnelResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetEC2VpnTunnelCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        
        #region Parameter ApplyPendingMaintenance
        /// <summary>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-EC2VpnTunnel (ReplaceVpnTunnel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ReplaceVpnTunnelResponse, SetEC2VpnTunnelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.ReplaceVpnTunnelRequest();
        ...
        private Amazon.EC2.Model.ReplaceVpnTunnelResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ReplaceVpnTunnelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ReplaceVpnTunnel");
            try
            {
                #if DESKTOP
                return client.ReplaceVpnTunnel(request);
                #elif CORECLR
                return client.ReplaceVpnTunnelAsync(request).GetAwaiter().GetResult();
                #else
