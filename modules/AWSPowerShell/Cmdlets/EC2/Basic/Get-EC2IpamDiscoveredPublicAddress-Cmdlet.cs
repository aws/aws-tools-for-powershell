...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.GetIpamDiscoveredPublicAddressesResponse",
        "This cmdlet returns an Amazon.EC2.Model.GetIpamDiscoveredPublicAddressesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2IpamDiscoveredPublicAddressCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.GetIpamDiscoveredPublicAddressesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetIpamDiscoveredPublicAddressesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetIpamDiscoveredPublicAddresses(request);
                #elif CORECLR
                return client.GetIpamDiscoveredPublicAddressesAsync(request).GetAwaiter().GetResult();
                #else
