...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class SetEC2NetworkAclAssociationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ReplaceNetworkAclAssociationResponse, SetEC2NetworkAclAssociationCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ReplaceNetworkAclAssociation");
            try
            {
                return client.ReplaceNetworkAclAssociationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssociationId { get; set; }
            public System.String NetworkAclId { get; set; }
            public System.Func<Amazon.EC2.Model.ReplaceNetworkAclAssociationResponse, SetEC2NetworkAclAssociationCmdlet, object> Select { get; set; } =
