...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2InstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// the network interface.</para></li><li><para><c>network-interface.mac-address</c> - The MAC address of the network interface.</para></li><li><para><c>network-interface.network-interface-id</c> - The ID of the network interface.</para></li><li><para><c>network-interface.outpost-arn</c> - The ARN of the Outpost.</para></li><li><para><c>network-interface.owner-id</c> - The ID of the owner of the network interface.</para></li><li><para><c>network-interface.private-dns-name</c> - The private DNS name of the network interface.</para></li><li><para><c>network-interface.private-ip-address</c> - The private IPv4 address.</para></li><li><para><c>network-interface.public-dns-name</c> - The public DNS name.</para></li><li><para><c>network-interface.requester-id</c> - The requester ID for the network interface.</para></li><li><para><c>network-interface.requester-managed</c> - Indicates whether the network interface
