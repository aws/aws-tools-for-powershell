...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.CapacityReservationBillingRequest or Amazon.EC2.Model.DescribeCapacityReservationBillingRequestsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeCapacityReservationBillingRequestsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
