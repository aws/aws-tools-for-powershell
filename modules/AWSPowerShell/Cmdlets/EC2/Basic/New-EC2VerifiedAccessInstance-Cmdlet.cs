...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.VerifiedAccessInstance or Amazon.EC2.Model.CreateVerifiedAccessInstanceResponse",
        ...
        "The service call response (type Amazon.EC2.Model.CreateVerifiedAccessInstanceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEC2VerifiedAccessInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to assign to the Amazon Web Services Verified Access instance.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.EC2.Model.CreateVerifiedAccessInstanceResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateVerifiedAccessInstanceRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateVerifiedAccessInstance(request);
                #elif CORECLR
                return client.CreateVerifiedAccessInstanceAsync(request).GetAwaiter().GetResult();
                #else
