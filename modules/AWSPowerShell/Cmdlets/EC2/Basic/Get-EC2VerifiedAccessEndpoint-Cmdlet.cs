...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.VerifiedAccessEndpoint or Amazon.EC2.Model.DescribeVerifiedAccessEndpointsResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DescribeVerifiedAccessEndpointsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
