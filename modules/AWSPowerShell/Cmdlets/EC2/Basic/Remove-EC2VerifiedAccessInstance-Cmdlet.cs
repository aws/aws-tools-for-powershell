...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2VerifiedAccessInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.EC2.Model.VerifiedAccessInstance")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DeleteVerifiedAccessInstance API operation.", Operation = new[] {"DeleteVerifiedAccessInstance"}, SelectReturnType = typeof(Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.VerifiedAccessInstance or Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse",
        "This cmdlet returns an Amazon.EC2.Model.VerifiedAccessInstance object.",
        "The service call response (type Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2VerifiedAccessInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2VerifiedAccessInstance (DeleteVerifiedAccessInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse, RemoveEC2VerifiedAccessInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteVerifiedAccessInstanceRequest();
        ...
        private Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteVerifiedAccessInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DeleteVerifiedAccessInstance");
            try
            {
                #if DESKTOP
                return client.DeleteVerifiedAccessInstance(request);
                #elif CORECLR
                return client.DeleteVerifiedAccessInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String VerifiedAccessInstanceId { get; set; }
            public System.Func<Amazon.EC2.Model.DeleteVerifiedAccessInstanceResponse, RemoveEC2VerifiedAccessInstanceCmdlet, object> Select { get; set; } =
