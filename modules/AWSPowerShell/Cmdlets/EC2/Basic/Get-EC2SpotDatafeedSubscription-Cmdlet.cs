...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2SpotDatafeedSubscriptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeSpotDatafeedSubscriptionResponse, GetEC2SpotDatafeedSubscriptionCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeSpotDatafeedSubscription");
            try
            {
                return client.DescribeSpotDatafeedSubscriptionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Boolean? DryRun { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeSpotDatafeedSubscriptionResponse, GetEC2SpotDatafeedSubscriptionCmdlet, object> Select { get; set; } =
