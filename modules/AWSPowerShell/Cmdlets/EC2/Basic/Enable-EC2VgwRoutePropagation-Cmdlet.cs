...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) EnableVgwRoutePropagation API operation.", Operation = new[] {"EnableVgwRoutePropagation"}, SelectReturnType = typeof(Amazon.EC2.Model.EnableVgwRoutePropagationResponse))]
    [AWSCmdletOutput("None or Amazon.EC2.Model.EnableVgwRoutePropagationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.EC2.Model.EnableVgwRoutePropagationResponse) be returned by specifying '-Select *'."
    )]
    public partial class EnableEC2VgwRoutePropagationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-EC2VgwRoutePropagation (EnableVgwRoutePropagation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.EnableVgwRoutePropagationResponse, EnableEC2VgwRoutePropagationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.EnableVgwRoutePropagationRequest();
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "EnableVgwRoutePropagation");
            try
            {
                return client.EnableVgwRoutePropagationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String GatewayId { get; set; }
            public System.String RouteTableId { get; set; }
            public System.Func<Amazon.EC2.Model.EnableVgwRoutePropagationResponse, EnableEC2VgwRoutePropagationCmdlet, object> Select { get; set; } =
