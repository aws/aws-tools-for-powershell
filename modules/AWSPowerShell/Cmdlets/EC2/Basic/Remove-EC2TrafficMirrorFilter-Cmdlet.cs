...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("System.String or Amazon.EC2.Model.DeleteTrafficMirrorFilterResponse",
        ...
        "The service call response (type Amazon.EC2.Model.DeleteTrafficMirrorFilterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
