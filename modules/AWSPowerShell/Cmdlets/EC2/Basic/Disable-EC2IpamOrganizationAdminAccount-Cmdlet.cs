...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Disable", "EC2IpamOrganizationAdminAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.Boolean")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DisableIpamOrganizationAdminAccount API operation.", Operation = new[] {"DisableIpamOrganizationAdminAccount"}, SelectReturnType = typeof(Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse",
        "This cmdlet returns a System.Boolean object.",
        "The service call response (type Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisableEC2IpamOrganizationAdminAccountCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-EC2IpamOrganizationAdminAccount (DisableIpamOrganizationAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse, DisableEC2IpamOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DisableIpamOrganizationAdminAccountRequest();
        ...
        private Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisableIpamOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisableIpamOrganizationAdminAccount");
            try
            {
                #if DESKTOP
                return client.DisableIpamOrganizationAdminAccount(request);
                #elif CORECLR
                return client.DisableIpamOrganizationAdminAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DelegatedAdminAccountId { get; set; }
            public System.Func<Amazon.EC2.Model.DisableIpamOrganizationAdminAccountResponse, DisableEC2IpamOrganizationAdminAccountCmdlet, object> Select { get; set; } =
