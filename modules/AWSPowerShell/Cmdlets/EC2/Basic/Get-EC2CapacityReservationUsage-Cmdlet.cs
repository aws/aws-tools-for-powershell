...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) GetCapacityReservationUsage API operation.", Operation = new[] {"GetCapacityReservationUsage"}, SelectReturnType = typeof(Amazon.EC2.Model.GetCapacityReservationUsageResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.GetCapacityReservationUsageResponse",
        "This cmdlet returns an Amazon.EC2.Model.GetCapacityReservationUsageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2CapacityReservationUsageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetCapacityReservationUsageResponse, GetEC2CapacityReservationUsageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.GetCapacityReservationUsageRequest();
        ...
        private Amazon.EC2.Model.GetCapacityReservationUsageResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetCapacityReservationUsageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetCapacityReservationUsage");
            try
            {
                #if DESKTOP
                return client.GetCapacityReservationUsage(request);
                #elif CORECLR
                return client.GetCapacityReservationUsageAsync(request).GetAwaiter().GetResult();
                #else
