...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Confirm", "EC2TransitGatewayVpcAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.TransitGatewayVpcAttachment")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) AcceptTransitGatewayVpcAttachment API operation.", Operation = new[] {"AcceptTransitGatewayVpcAttachment"}, SelectReturnType = typeof(Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayVpcAttachment or Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse",
        "This cmdlet returns an Amazon.EC2.Model.TransitGatewayVpcAttachment object.",
        "The service call response (type Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ConfirmEC2TransitGatewayVpcAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-EC2TransitGatewayVpcAttachment (AcceptTransitGatewayVpcAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse, ConfirmEC2TransitGatewayVpcAttachmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentRequest();
        ...
        private Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "AcceptTransitGatewayVpcAttachment");
            try
            {
                #if DESKTOP
                return client.AcceptTransitGatewayVpcAttachment(request);
                #elif CORECLR
                return client.AcceptTransitGatewayVpcAttachmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.Func<Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse, ConfirmEC2TransitGatewayVpcAttachmentCmdlet, object> Select { get; set; } =
