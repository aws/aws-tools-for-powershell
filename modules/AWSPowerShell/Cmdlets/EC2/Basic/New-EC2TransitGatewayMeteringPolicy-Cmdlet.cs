...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class NewEC2TransitGatewayMeteringPolicyCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the middlebox attachments to include in the metering policy.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to assign to the metering policy.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.EC2.Model.CreateTransitGatewayMeteringPolicyResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateTransitGatewayMeteringPolicyRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateTransitGatewayMeteringPolicy(request);
                #elif CORECLR
                return client.CreateTransitGatewayMeteringPolicyAsync(request).GetAwaiter().GetResult();
                #else
