...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) CreateEgressOnlyInternetGateway API operation.", Operation = new[] {"CreateEgressOnlyInternetGateway"}, SelectReturnType = typeof(Amazon.EC2.Model.CreateEgressOnlyInternetGatewayResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.CreateEgressOnlyInternetGatewayResponse",
        "This cmdlet returns an Amazon.EC2.Model.CreateEgressOnlyInternetGatewayResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEC2EgressOnlyInternetGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CreateEgressOnlyInternetGatewayResponse, NewEC2EgressOnlyInternetGatewayCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CreateEgressOnlyInternetGateway");
            try
            {
                #if DESKTOP
                return client.CreateEgressOnlyInternetGateway(request);
                #elif CORECLR
                return client.CreateEgressOnlyInternetGatewayAsync(request).GetAwaiter().GetResult();
                #else
