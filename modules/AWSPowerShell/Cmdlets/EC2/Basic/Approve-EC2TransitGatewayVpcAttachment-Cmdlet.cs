...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Approve", "EC2TransitGatewayVpcAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.TransitGatewayVpcAttachment")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) AcceptTransitGatewayVpcAttachment API operation.", Operation = new[] {"AcceptTransitGatewayVpcAttachment"}, SelectReturnType = typeof(Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse), LegacyAlias="Confirm-EC2TransitGatewayVpcAttachment")]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayVpcAttachment or Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse",
        ...
        "The service call response (type Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class ApproveEC2TransitGatewayVpcAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-EC2TransitGatewayVpcAttachment (AcceptTransitGatewayVpcAttachment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse, ApproveEC2TransitGatewayVpcAttachmentCmdlet>(Select) ??
        ...
        private Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentRequest request)
        {
            ...
            try
            {
                return client.AcceptTransitGatewayVpcAttachmentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? DryRun { get; set; }
            public System.String TransitGatewayAttachmentId { get; set; }
            public System.Func<Amazon.EC2.Model.AcceptTransitGatewayVpcAttachmentResponse, ApproveEC2TransitGatewayVpcAttachmentCmdlet, object> Select { get; set; } =
