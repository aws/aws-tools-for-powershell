...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2NetworkInterfacePermissionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NetworkInterfacePermissions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeNetworkInterfacePermissionsResponse, GetEC2NetworkInterfacePermissionCmdlet>(Select) ??
            ...
            {
                context.NetworkInterfacePermissionId = new List<System.String>(this.NetworkInterfacePermissionId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.NetworkInterfacePermissionIds = cmdletContext.NetworkInterfacePermissionId;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public List<System.String> NetworkInterfacePermissionId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeNetworkInterfacePermissionsResponse, GetEC2NetworkInterfacePermissionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NetworkInterfacePermissions;
        }
