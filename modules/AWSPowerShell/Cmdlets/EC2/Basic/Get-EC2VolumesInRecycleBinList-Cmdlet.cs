...
{
    /// <summary>
    /// Lists one or more volumes that are currently in the Recycle Bin.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetEC2VolumesInRecycleBinListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// are in the Recycle Bin.</para><para />
        ...
        private Amazon.EC2.Model.ListVolumesInRecycleBinResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ListVolumesInRecycleBinRequest request)
        {
            ...
            try
            {
                return client.ListVolumesInRecycleBinAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
