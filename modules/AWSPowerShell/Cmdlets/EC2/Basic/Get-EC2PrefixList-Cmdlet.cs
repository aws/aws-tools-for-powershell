...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// the service.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EC2PrefixList")]
    [OutputType("Amazon.EC2.Model.PrefixList")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribePrefixLists API operation.", Operation = new[] {"DescribePrefixLists"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribePrefixListsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.PrefixList or Amazon.EC2.Model.DescribePrefixListsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.PrefixList objects.",
        "The service call response (type Amazon.EC2.Model.DescribePrefixListsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2PrefixListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters.</para><ul><li><para><c>prefix-list-id</c>: The ID of a prefix list.</para></li><li><para><c>prefix-list-name</c>: The name of a prefix list.</para></li></ul>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribePrefixListsResponse, GetEC2PrefixListCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribePrefixLists");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.EC2.Model.DescribePrefixListsResponse, GetEC2PrefixListCmdlet, object> Select { get; set; } =
