...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("System.String or Amazon.EC2.Model.GetFlowLogsIntegrationTemplateResponse",
        ...
        "The service call response (type Amazon.EC2.Model.GetFlowLogsIntegrationTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2FlowLogsIntegrationTemplateCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^FlowLogId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.FlowLogId;
            }
        ...
        private Amazon.EC2.Model.GetFlowLogsIntegrationTemplateResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetFlowLogsIntegrationTemplateRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetFlowLogsIntegrationTemplate(request);
                #elif CORECLR
                return client.GetFlowLogsIntegrationTemplateAsync(request).GetAwaiter().GetResult();
                #else
