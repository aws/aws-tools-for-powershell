...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Export", "EC2ClientVpnClientConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) ExportClientVpnClientConfiguration API operation.", Operation = new[] {"ExportClientVpnClientConfiguration"}, SelectReturnType = typeof(Amazon.EC2.Model.ExportClientVpnClientConfigurationResponse))]
    [AWSCmdletOutput("System.String or Amazon.EC2.Model.ExportClientVpnClientConfigurationResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.EC2.Model.ExportClientVpnClientConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ExportEC2ClientVpnClientConfigurationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "ClientConfiguration";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Export-EC2ClientVpnClientConfiguration (ExportClientVpnClientConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ExportClientVpnClientConfigurationResponse, ExportEC2ClientVpnClientConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.ExportClientVpnClientConfigurationRequest();
        ...
        private Amazon.EC2.Model.ExportClientVpnClientConfigurationResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ExportClientVpnClientConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ExportClientVpnClientConfiguration");
            try
            {
                #if DESKTOP
                return client.ExportClientVpnClientConfiguration(request);
                #elif CORECLR
                return client.ExportClientVpnClientConfigurationAsync(request).GetAwaiter().GetResult();
                #else
