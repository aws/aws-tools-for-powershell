...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeInternetGateways API operation.", Operation = new[] {"DescribeInternetGateways"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeInternetGatewaysResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.InternetGateway or Amazon.EC2.Model.DescribeInternetGatewaysResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.InternetGateway objects.",
        "The service call response (type Amazon.EC2.Model.DescribeInternetGatewaysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2InternetGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the internet gateways.</para><para>Default: Describes all your internet gateways.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InternetGateways";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeInternetGatewaysResponse, GetEC2InternetGatewayCmdlet>(Select) ??
            ...
            {
                context.InternetGatewayId = new List<System.String>(this.InternetGatewayId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.InternetGatewayIds = cmdletContext.InternetGatewayId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.InternetGateways?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeInternetGateways");
            try
            {
                return client.DescribeInternetGatewaysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public List<System.String> InternetGatewayId { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeInternetGatewaysResponse, GetEC2InternetGatewayCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InternetGateways;
        }
