...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Edit", "EC2IpamRoutingPolicyRegistration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.IpamRoutingPolicyRegistrationDelta")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) ModifyIpamRoutingPolicyRegistration API operation.", Operation = new[] {"ModifyIpamRoutingPolicyRegistration"}, SelectReturnType = typeof(Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.IpamRoutingPolicyRegistrationDelta or Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse",
        "This cmdlet returns an Amazon.EC2.Model.IpamRoutingPolicyRegistrationDelta object.",
        "The service call response (type Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class EditEC2IpamRoutingPolicyRegistrationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The updated list of Autonomous System Numbers (ASNs) authorized to originate the prefix.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The IP address prefix in CIDR notation identifying the routing policy registration
        /// to modify.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>A new description for the routing policy registration.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #region Parameter ForceEdit
        /// <summary>
        /// <para>
        /// <para>Forces the modification even if it conflicts with an announced route. Default: <c>false</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Boolean? ForceEdit { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The new maximum prefix length that the ASNs are authorized to announce. Must be greater
        /// than or equal to the prefix length of the CIDR.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse).
        /// Specifying the name of a property of type Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-EC2IpamRoutingPolicyRegistration (ModifyIpamRoutingPolicyRegistration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse, EditEC2IpamRoutingPolicyRegistrationCmdlet>(Select) ??
            ...
            context.ForceEdit = this.ForceEdit;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationRequest();
            ...
            if (cmdletContext.ForceEdit != null)
            {
                request.Force = cmdletContext.ForceEdit.Value;
            }
        ...
        private Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "ModifyIpamRoutingPolicyRegistration");
            try
            {
                return client.ModifyIpamRoutingPolicyRegistrationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxLength { get; set; }
            public System.Boolean? PermitMoreSpecificAnnouncement { get; set; }
            public System.Func<Amazon.EC2.Model.ModifyIpamRoutingPolicyRegistrationResponse, EditEC2IpamRoutingPolicyRegistrationCmdlet, object> Select { get; set; } =
