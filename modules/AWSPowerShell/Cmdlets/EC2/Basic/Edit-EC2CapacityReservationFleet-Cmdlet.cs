...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EditEC2CapacityReservationFleetCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CapacityReservationFleetId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CapacityReservationFleetId;
            }
        ...
        private Amazon.EC2.Model.ModifyCapacityReservationFleetResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyCapacityReservationFleetRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ModifyCapacityReservationFleet(request);
                #elif CORECLR
                return client.ModifyCapacityReservationFleetAsync(request).GetAwaiter().GetResult();
                #else
