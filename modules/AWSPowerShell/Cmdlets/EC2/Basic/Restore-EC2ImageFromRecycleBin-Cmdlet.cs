...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) RestoreImageFromRecycleBin API operation.", Operation = new[] {"RestoreImageFromRecycleBin"}, SelectReturnType = typeof(Amazon.EC2.Model.RestoreImageFromRecycleBinResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.RestoreImageFromRecycleBinResponse",
        "This cmdlet returns a System.Boolean object.",
        "The service call response (type Amazon.EC2.Model.RestoreImageFromRecycleBinResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RestoreEC2ImageFromRecycleBinCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-EC2ImageFromRecycleBin (RestoreImageFromRecycleBin)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.RestoreImageFromRecycleBinResponse, RestoreEC2ImageFromRecycleBinCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.RestoreImageFromRecycleBinRequest();
        ...
        private Amazon.EC2.Model.RestoreImageFromRecycleBinResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.RestoreImageFromRecycleBinRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "RestoreImageFromRecycleBin");
            try
            {
                #if DESKTOP
                return client.RestoreImageFromRecycleBin(request);
                #elif CORECLR
                return client.RestoreImageFromRecycleBinAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ImageId { get; set; }
            public System.Func<Amazon.EC2.Model.RestoreImageFromRecycleBinResponse, RestoreEC2ImageFromRecycleBinCmdlet, object> Select { get; set; } =
