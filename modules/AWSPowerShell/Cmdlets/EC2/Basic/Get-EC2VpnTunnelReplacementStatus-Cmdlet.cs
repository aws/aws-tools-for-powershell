...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2VpnTunnelReplacementStatus")]
    ...
    public partial class GetEC2VpnTunnelReplacementStatusCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetVpnTunnelReplacementStatusResponse, GetEC2VpnTunnelReplacementStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.GetVpnTunnelReplacementStatusRequest();
        ...
        private Amazon.EC2.Model.GetVpnTunnelReplacementStatusResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetVpnTunnelReplacementStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetVpnTunnelReplacementStatus");
            try
            {
                #if DESKTOP
                return client.GetVpnTunnelReplacementStatus(request);
                #elif CORECLR
                return client.GetVpnTunnelReplacementStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String VpnConnectionId { get; set; }
            public System.String VpnTunnelOutsideIpAddress { get; set; }
            public System.Func<Amazon.EC2.Model.GetVpnTunnelReplacementStatusResponse, GetEC2VpnTunnelReplacementStatusCmdlet, object> Select { get; set; } =
