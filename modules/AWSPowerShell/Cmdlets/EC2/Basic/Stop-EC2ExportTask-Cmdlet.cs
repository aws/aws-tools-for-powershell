...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class StopEC2ExportTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the export task. This is the ID returned by the <c>CreateInstanceExportTask</c>
        /// and <c>ExportImage</c> operations.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ExportTaskId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CancelExportTaskResponse, StopEC2ExportTaskCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.ExportTaskId = this.ExportTaskId;
            #if MODULAR
            if (this.ExportTaskId == null && ParameterWasBound(nameof(this.ExportTaskId)))
            {
                WriteWarning("You are passing $null as a value for parameter ExportTaskId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CancelExportTask");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ExportTaskId { get; set; }
            public System.Func<Amazon.EC2.Model.CancelExportTaskResponse, StopEC2ExportTaskCmdlet, object> Select { get; set; } =
