...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) EnableVpcClassicLink API operation.", Operation = new[] {"EnableVpcClassicLink"}, SelectReturnType = typeof(Amazon.EC2.Model.EnableVpcClassicLinkResponse))]
    [AWSCmdletOutput("System.Boolean or Amazon.EC2.Model.EnableVpcClassicLinkResponse",
        "This cmdlet returns a System.Boolean object.",
        "The service call response (type Amazon.EC2.Model.EnableVpcClassicLinkResponse) can be returned by specifying '-Select *'."
    )]
    public partial class EnableEC2VpcClassicLinkCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.EnableVpcClassicLinkResponse, EnableEC2VpcClassicLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.EnableVpcClassicLinkRequest();
        ...
        private Amazon.EC2.Model.EnableVpcClassicLinkResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.EnableVpcClassicLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "EnableVpcClassicLink");
            try
            {
                #if DESKTOP
                return client.EnableVpcClassicLink(request);
                #elif CORECLR
                return client.EnableVpcClassicLinkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.EnableVpcClassicLinkResponse, EnableEC2VpcClassicLinkCmdlet, object> Select { get; set; } =
