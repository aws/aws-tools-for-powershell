...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2FpgaImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// all resources assigned a tag with a specific key, regardless of the tag value.</para></li><li><para><c>update-time</c> - The time of the most recent update.</para></li></ul><para />
        ...
        /// are <c>amazon</c> | <c>aws-marketplace</c>).</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.DescribeFpgaImagesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeFpgaImagesRequest request)
        {
            ...
            try
            {
                return client.DescribeFpgaImagesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
