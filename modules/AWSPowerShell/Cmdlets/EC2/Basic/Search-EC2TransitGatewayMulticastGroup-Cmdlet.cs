...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Search", "EC2TransitGatewayMulticastGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.TransitGatewayMulticastGroup")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) SearchTransitGatewayMulticastGroups API operation.", Operation = new[] {"SearchTransitGatewayMulticastGroups"}, SelectReturnType = typeof(Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayMulticastGroup or Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.TransitGatewayMulticastGroup objects.",
        "The service call response (type Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchEC2TransitGatewayMulticastGroupCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MulticastGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-EC2TransitGatewayMulticastGroup (SearchTransitGatewayMulticastGroups)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse, SearchEC2TransitGatewayMulticastGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.MulticastGroups?.Count ?? 0;
        ...
        private Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "SearchTransitGatewayMulticastGroups");
            try
            {
                #if DESKTOP
                return client.SearchTransitGatewayMulticastGroups(request);
                #elif CORECLR
                return client.SearchTransitGatewayMulticastGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TransitGatewayMulticastDomainId { get; set; }
            public System.Func<Amazon.EC2.Model.SearchTransitGatewayMulticastGroupsResponse, SearchEC2TransitGatewayMulticastGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MulticastGroups;
        }
