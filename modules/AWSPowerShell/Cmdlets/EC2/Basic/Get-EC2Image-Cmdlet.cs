...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2ImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// specified for Allowed AMIs.</para></li><li><para><c>image-id</c> - The ID of the image.</para></li><li><para><c>image-watermark.source-image-creation-time</c> - The creation date of the source
        /// AMI, in the ISO 8601 format in the UTC time zone (<c><i>YYYY</i>-<i>MM</i>-<i>DD</i>T<i>HH</i>:<i>MM</i>:<i>SS</i>.<i>ssssss</i>+<i>HH</i>:<i>MM</i></c>). You can use a wildcard (<c>*</c>), for example, <c>2021-09-29T*</c>, which
        /// matches an entire day.</para></li><li><para><c>image-watermark.source-image-id</c> - The ID of the AMI to which the watermark
        /// was originally attached.</para></li><li><para><c>image-watermark.source-image-region</c> - The Region where the watermark was originally
        ...
        /// parameter, including previous versions.</para></li><li><para><c>ramdisk-id</c> - The RAM disk ID.</para></li><li><para><c>root-device-name</c> - The device name of the root device volume (for example,
