...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2TrafficMirrorSession")]
    [OutputType("Amazon.EC2.Model.TrafficMirrorSession")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeTrafficMirrorSessions API operation.", Operation = new[] {"DescribeTrafficMirrorSessions"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TrafficMirrorSession or Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.TrafficMirrorSession objects.",
        "The service call response (type Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2TrafficMirrorSessionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TrafficMirrorSessions";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TrafficMirrorSessionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse, GetEC2TrafficMirrorSessionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.TrafficMirrorSessionId;
            }
            ...
            {
                context.TrafficMirrorSessionId = new List<System.String>(this.TrafficMirrorSessionId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeTrafficMirrorSessionsRequest();
            ...
            {
                request.TrafficMirrorSessionIds = cmdletContext.TrafficMirrorSessionId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TrafficMirrorSessions.Count;
        ...
        private Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeTrafficMirrorSessionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeTrafficMirrorSessions");
            try
            {
                #if DESKTOP
                return client.DescribeTrafficMirrorSessions(request);
                #elif CORECLR
                return client.DescribeTrafficMirrorSessionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> TrafficMirrorSessionId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeTrafficMirrorSessionsResponse, GetEC2TrafficMirrorSessionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TrafficMirrorSessions;
        }
