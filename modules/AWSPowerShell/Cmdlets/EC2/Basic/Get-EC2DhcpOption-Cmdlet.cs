...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeDhcpOptions API operation.", Operation = new[] {"DescribeDhcpOptions"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeDhcpOptionsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.DhcpOptions or Amazon.EC2.Model.DescribeDhcpOptionsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.DhcpOptions objects.",
        "The service call response (type Amazon.EC2.Model.DescribeDhcpOptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2DhcpOptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The filters.</para><ul><li><para><c>dhcp-options-id</c> - The ID of a DHCP options set.</para></li><li><para><c>key</c> - The key for one of the options (for example, <c>domain-name</c>).</para></li><li><para><c>value</c> - The value for one of the options.</para></li><li><para><c>owner-id</c> - The ID of the Amazon Web Services account that owns the DHCP options
        /// set.</para></li><li><para><c>tag</c> - The key/value combination of a tag assigned to the resource. Use the
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DhcpOptionsId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeDhcpOptionsResponse, GetEC2DhcpOptionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DhcpOptionsId;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            if (this.DhcpOptionsId != null)
            {
                context.DhcpOptionsId = new List<System.String>(this.DhcpOptionsId);
            }
            if (this.Filter != null)
            {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.DhcpOptionsIds = cmdletContext.DhcpOptionsId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DhcpOptions.Count;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeDhcpOptions");
            try
            {
                #if DESKTOP
        ...
        {
            public List<System.String> DhcpOptionsId { get; set; }
            public List<Amazon.EC2.Model.Filter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeDhcpOptionsResponse, GetEC2DhcpOptionCmdlet, object> Select { get; set; } =
