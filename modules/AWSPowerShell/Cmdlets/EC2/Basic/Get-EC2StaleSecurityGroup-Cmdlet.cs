...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2StaleSecurityGroupCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "StaleSecurityGroupSet";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeStaleSecurityGroupsResponse, GetEC2StaleSecurityGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeStaleSecurityGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                {
                    int correctPageSize = AutoIterationHelpers.Min(255, _emitLimit.Value);
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.StaleSecurityGroupSet.Count;
        ...
        private Amazon.EC2.Model.DescribeStaleSecurityGroupsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeStaleSecurityGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeStaleSecurityGroups");
            try
            {
                #if DESKTOP
                return client.DescribeStaleSecurityGroups(request);
                #elif CORECLR
                return client.DescribeStaleSecurityGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeStaleSecurityGroupsResponse, GetEC2StaleSecurityGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StaleSecurityGroupSet;
        }
