...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2ImageUsageReportEntryCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// an entire day.</para></li><li><para><c>resource-type</c> - The resource type (<c>ec2:Instance</c> | <c>ec2:LaunchTemplate</c>).</para></li></ul><para />
        ...
        /// entries containing these images are returned.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the usage reports.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.EC2.Model.DescribeImageUsageReportEntriesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeImageUsageReportEntriesRequest request)
        {
            ...
            try
            {
                return client.DescribeImageUsageReportEntriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
