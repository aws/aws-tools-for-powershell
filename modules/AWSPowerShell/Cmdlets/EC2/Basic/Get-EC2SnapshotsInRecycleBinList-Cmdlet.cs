...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.SnapshotRecycleBinInfo or Amazon.EC2.Model.ListSnapshotsInRecycleBinResponse",
        ...
        "The service call response (type Amazon.EC2.Model.ListSnapshotsInRecycleBinResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
