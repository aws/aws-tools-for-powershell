...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2TransitGatewayPolicyTableAssociation")]
    [OutputType("Amazon.EC2.Model.TransitGatewayPolicyTableAssociation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) GetTransitGatewayPolicyTableAssociations API operation.", Operation = new[] {"GetTransitGatewayPolicyTableAssociations"}, SelectReturnType = typeof(Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayPolicyTableAssociation or Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.TransitGatewayPolicyTableAssociation objects.",
        "The service call response (type Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2TransitGatewayPolicyTableAssociationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse, GetEC2TransitGatewayPolicyTableAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsRequest();
        ...
        private Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "GetTransitGatewayPolicyTableAssociations");
            try
            {
                #if DESKTOP
                return client.GetTransitGatewayPolicyTableAssociations(request);
                #elif CORECLR
                return client.GetTransitGatewayPolicyTableAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TransitGatewayPolicyTableId { get; set; }
            public System.Func<Amazon.EC2.Model.GetTransitGatewayPolicyTableAssociationsResponse, GetEC2TransitGatewayPolicyTableAssociationCmdlet, object> Select { get; set; } =
