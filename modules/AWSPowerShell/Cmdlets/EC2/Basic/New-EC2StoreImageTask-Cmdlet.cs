...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) CreateStoreImageTask API operation.", Operation = new[] {"CreateStoreImageTask"}, SelectReturnType = typeof(Amazon.EC2.Model.CreateStoreImageTaskResponse))]
    [AWSCmdletOutput("System.String or Amazon.EC2.Model.CreateStoreImageTaskResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.EC2.Model.CreateStoreImageTaskResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewEC2StoreImageTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to apply to the AMI object that will be stored in the Amazon S3 bucket. </para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("S3ObjectTags")]
        public Amazon.EC2.Model.S3ObjectTag[] S3ObjectTag { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ObjectKey";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EC2StoreImageTask (CreateStoreImageTask)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.CreateStoreImageTaskResponse, NewEC2StoreImageTaskCmdlet>(Select) ??
            ...
            #endif
            if (this.S3ObjectTag != null)
            {
                context.S3ObjectTag = new List<Amazon.EC2.Model.S3ObjectTag>(this.S3ObjectTag);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.CreateStoreImageTaskRequest();
            ...
            if (cmdletContext.S3ObjectTag != null)
            {
                request.S3ObjectTags = cmdletContext.S3ObjectTag;
            }
        ...
        private Amazon.EC2.Model.CreateStoreImageTaskResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.CreateStoreImageTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "CreateStoreImageTask");
            try
            {
                return client.CreateStoreImageTaskAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? DryRun { get; set; }
            public System.String ImageId { get; set; }
            public List<Amazon.EC2.Model.S3ObjectTag> S3ObjectTag { get; set; }
            public System.Func<Amazon.EC2.Model.CreateStoreImageTaskResponse, NewEC2StoreImageTaskCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ObjectKey;
        }
