...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeVpcAttribute API operation.", Operation = new[] {"DescribeVpcAttribute"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeVpcAttributeResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.DescribeVpcAttributeResponse",
        "This cmdlet returns an Amazon.EC2.Model.DescribeVpcAttributeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEC2VpcAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeVpcAttributeResponse, GetEC2VpcAttributeCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeVpcAttribute");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.EC2.VpcAttributeName Attribute { get; set; }
            public System.String VpcId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeVpcAttributeResponse, GetEC2VpcAttributeCmdlet, object> Select { get; set; } =
