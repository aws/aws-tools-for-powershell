...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class UnregisterEC2RouteTableCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DisassociateRouteTableResponse, UnregisterEC2RouteTableCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DisassociateRouteTable");
            try
            {
                return client.DisassociateRouteTableAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssociationId { get; set; }
            public System.Boolean? DryRun { get; set; }
            public System.Func<Amazon.EC2.Model.DisassociateRouteTableResponse, UnregisterEC2RouteTableCmdlet, object> Select { get; set; } =
