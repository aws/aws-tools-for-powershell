...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud (EC2) DescribeTransitGateways API operation.", Operation = new[] {"DescribeTransitGateways"}, SelectReturnType = typeof(Amazon.EC2.Model.DescribeTransitGatewaysResponse))]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGateway or Amazon.EC2.Model.DescribeTransitGatewaysResponse",
        "This cmdlet returns a collection of Amazon.EC2.Model.TransitGateway objects.",
        "The service call response (type Amazon.EC2.Model.DescribeTransitGatewaysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEC2TransitGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters. The possible values are:</para><ul><li><para><c>options.propagation-default-route-table-id</c> - The ID of the default propagation
        /// route table.</para></li><li><para><c>options.amazon-side-asn</c> - The private ASN for the Amazon side of a BGP session.</para></li><li><para><c>options.association-default-route-table-id</c> - The ID of the default association
        /// route table.</para></li><li><para><c>options.auto-accept-shared-attachments</c> - Indicates whether there is automatic
        /// acceptance of attachment requests (<c>enable</c> | <c>disable</c>).</para></li><li><para><c>options.default-route-table-association</c> - Indicates whether resource attachments
        /// are automatically associated with the default association route table (<c>enable</c>
        /// | <c>disable</c>).</para></li><li><para><c>options.default-route-table-propagation</c> - Indicates whether resource attachments
        /// automatically propagate routes to the default propagation route table (<c>enable</c>
        /// | <c>disable</c>).</para></li><li><para><c>options.dns-support</c> - Indicates whether DNS support is enabled (<c>enable</c>
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the transit gateways.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TransitGateways";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EC2.Model.DescribeTransitGatewaysResponse, GetEC2TransitGatewayCmdlet>(Select) ??
            ...
            {
                context.TransitGatewayId = new List<System.String>(this.TransitGatewayId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.TransitGatewayIds = cmdletContext.TransitGatewayId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TransitGateways?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud (EC2)", "DescribeTransitGateways");
            try
            {
                return client.DescribeTransitGatewaysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<System.String> TransitGatewayId { get; set; }
            public System.Func<Amazon.EC2.Model.DescribeTransitGatewaysResponse, GetEC2TransitGatewayCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TransitGateways;
        }
