...
namespace Amazon.PowerShell.Cmdlets.CCA
{
    ...
    public partial class StopCCAResourceRequestCmdlet : AmazonCloudControlApiClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RequestToken), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-CCAResourceRequest (CancelResourceRequest)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudControlApi.Model.CancelResourceRequestResponse, StopCCAResourceRequestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudControlApi.Model.CancelResourceRequestRequest();
        ...
        private Amazon.CloudControlApi.Model.CancelResourceRequestResponse CallAWSServiceOperation(IAmazonCloudControlApi client, Amazon.CloudControlApi.Model.CancelResourceRequestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Control API", "CancelResourceRequest");
            try
            {
                #if DESKTOP
                return client.CancelResourceRequest(request);
                #elif CORECLR
                return client.CancelResourceRequestAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RequestToken { get; set; }
            public System.Func<Amazon.CloudControlApi.Model.CancelResourceRequestResponse, StopCCAResourceRequestCmdlet, object> Select { get; set; } =
