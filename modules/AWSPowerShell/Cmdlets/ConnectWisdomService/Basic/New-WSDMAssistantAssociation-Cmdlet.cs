...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("New", "WSDMAssistantAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWSDMAssistantAssociationCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.ConnectWisdomService.AssociationType")]
        public Amazon.ConnectWisdomService.AssociationType AssociationType { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WSDMAssistantAssociation (CreateAssistantAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.CreateAssistantAssociationResponse, NewWSDMAssistantAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.CreateAssistantAssociationRequest();
        ...
        private Amazon.ConnectWisdomService.Model.CreateAssistantAssociationResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.CreateAssistantAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "CreateAssistantAssociation");
            try
            {
                #if DESKTOP
                return client.CreateAssistantAssociation(request);
                #elif CORECLR
                return client.CreateAssistantAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConnectWisdomService.Model.CreateAssistantAssociationResponse, NewWSDMAssistantAssociationCmdlet, object> Select { get; set; } =
