...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSDMKnowledgeBaseTemplateUri", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSDMKnowledgeBaseTemplateUriCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSDMKnowledgeBaseTemplateUri (RemoveKnowledgeBaseTemplateUri)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.RemoveKnowledgeBaseTemplateUriResponse, RemoveWSDMKnowledgeBaseTemplateUriCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.RemoveKnowledgeBaseTemplateUriRequest();
        ...
        private Amazon.ConnectWisdomService.Model.RemoveKnowledgeBaseTemplateUriResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.RemoveKnowledgeBaseTemplateUriRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "RemoveKnowledgeBaseTemplateUri");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.RemoveKnowledgeBaseTemplateUriResponse, RemoveWSDMKnowledgeBaseTemplateUriCmdlet, object> Select { get; set; } =
