...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WSDMKnowledgeBase")]
    [OutputType("Amazon.ConnectWisdomService.Model.KnowledgeBaseData")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service GetKnowledgeBase API operation.", Operation = new[] {"GetKnowledgeBase"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.KnowledgeBaseData or Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.KnowledgeBaseData object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWSDMKnowledgeBaseCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse, GetWSDMKnowledgeBaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.GetKnowledgeBaseRequest();
        ...
        private Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.GetKnowledgeBaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "GetKnowledgeBase");
            try
            {
                return client.GetKnowledgeBaseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.GetKnowledgeBaseResponse, GetWSDMKnowledgeBaseCmdlet, object> Select { get; set; } =
