...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WSDMSession")]
    [OutputType("Amazon.ConnectWisdomService.Model.SessionData")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service GetSession API operation.", Operation = new[] {"GetSession"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.GetSessionResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.SessionData or Amazon.ConnectWisdomService.Model.GetSessionResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.SessionData object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.GetSessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWSDMSessionCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.GetSessionResponse, GetWSDMSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.GetSessionRequest();
        ...
        private Amazon.ConnectWisdomService.Model.GetSessionResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.GetSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "GetSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssistantId { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.GetSessionResponse, GetWSDMSessionCmdlet, object> Select { get; set; } =
