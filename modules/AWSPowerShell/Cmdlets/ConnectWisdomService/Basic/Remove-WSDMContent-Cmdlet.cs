...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    [AWSCmdletOutput("None or Amazon.ConnectWisdomService.Model.DeleteContentResponse",
        ...
        "The service response (type Amazon.ConnectWisdomService.Model.DeleteContentResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveWSDMContentCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.ConnectWisdomService.Model.DeleteContentResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.DeleteContentRequest request)
        {
            ...
            try
            {
                return client.DeleteContentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
