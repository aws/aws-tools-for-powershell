...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// Deletes the content.
    /// </summary>
    [Cmdlet("Remove", "WSDMContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service DeleteContent API operation.", Operation = new[] {"DeleteContent"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.DeleteContentResponse))]
    [AWSCmdletOutput("None or Amazon.ConnectWisdomService.Model.DeleteContentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ConnectWisdomService.Model.DeleteContentResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveWSDMContentCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSDMContent (DeleteContent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.DeleteContentResponse, RemoveWSDMContentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.DeleteContentRequest();
        ...
        private Amazon.ConnectWisdomService.Model.DeleteContentResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.DeleteContentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "DeleteContent");
            try
            {
                #if DESKTOP
                return client.DeleteContent(request);
                #elif CORECLR
                return client.DeleteContentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ContentId { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.DeleteContentResponse, RemoveWSDMContentCmdlet, object> Select { get; set; } =
