...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Start", "WSDMImportJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ConnectWisdomService.Model.ImportJobData")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service StartImportJob API operation.", Operation = new[] {"StartImportJob"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.StartImportJobResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.ImportJobData or Amazon.ConnectWisdomService.Model.StartImportJobResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.ImportJobData object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.StartImportJobResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartWSDMImportJobCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.ConnectWisdomService.ImportJobType")]
        public Amazon.ConnectWisdomService.ImportJobType ImportJobType { get; set; }
        #endregion
        ...
        /// ARN. URLs cannot contain the ARN.</para><ul><li><para>For importing Wisdom quick responses, this should be a <code>QUICK_RESPONSES</code>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.ConnectWisdomService.ExternalSource")]
        public Amazon.ConnectWisdomService.ExternalSource ExternalSourceConfiguration_Source { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-WSDMImportJob (StartImportJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.StartImportJobResponse, StartWSDMImportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.StartImportJobRequest();
            ...
            request.ExternalSourceConfiguration = new Amazon.ConnectWisdomService.Model.ExternalSourceConfiguration();
            Amazon.ConnectWisdomService.ExternalSource requestExternalSourceConfiguration_externalSourceConfiguration_Source = null;
            ...
            requestExternalSourceConfiguration_externalSourceConfiguration_Configuration_externalSourceConfiguration_Configuration_ConnectConfiguration = new Amazon.ConnectWisdomService.Model.ConnectConfiguration();
        ...
        private Amazon.ConnectWisdomService.Model.StartImportJobResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.StartImportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "StartImportJob");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String UploadId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.StartImportJobResponse, StartWSDMImportJobCmdlet, object> Select { get; set; } =
