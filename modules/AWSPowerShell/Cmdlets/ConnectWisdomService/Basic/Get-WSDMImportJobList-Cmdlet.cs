...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WSDMImportJobList")]
    [OutputType("Amazon.ConnectWisdomService.Model.ImportJobSummary")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service ListImportJobs API operation.", Operation = new[] {"ListImportJobs"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.ListImportJobsResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.ImportJobSummary or Amazon.ConnectWisdomService.Model.ListImportJobsResponse",
        "This cmdlet returns a collection of Amazon.ConnectWisdomService.Model.ImportJobSummary objects.",
        "The service call response (type Amazon.ConnectWisdomService.Model.ListImportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWSDMImportJobListCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.ListImportJobsResponse, GetWSDMImportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.ListImportJobsRequest();
        ...
        private Amazon.ConnectWisdomService.Model.ListImportJobsResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.ListImportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "ListImportJobs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.ListImportJobsResponse, GetWSDMImportJobListCmdlet, object> Select { get; set; } =
