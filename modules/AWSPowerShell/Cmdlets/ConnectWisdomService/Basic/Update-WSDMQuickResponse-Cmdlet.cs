...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Update", "WSDMQuickResponse", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ConnectWisdomService.Model.QuickResponseData")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service UpdateQuickResponse API operation.", Operation = new[] {"UpdateQuickResponse"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.QuickResponseData or Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.QuickResponseData object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateWSDMQuickResponseCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WSDMQuickResponse (UpdateQuickResponse)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse, UpdateWSDMQuickResponseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.UpdateQuickResponseRequest();
        ...
        private Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.UpdateQuickResponseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "UpdateQuickResponse");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? RemoveShortcutKey { get; set; }
            public System.String ShortcutKey { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.UpdateQuickResponseResponse, UpdateWSDMQuickResponseCmdlet, object> Select { get; set; } =
