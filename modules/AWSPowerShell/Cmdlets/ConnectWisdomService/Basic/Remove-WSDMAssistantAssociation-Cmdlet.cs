...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSDMAssistantAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSDMAssistantAssociationCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSDMAssistantAssociation (DeleteAssistantAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.DeleteAssistantAssociationResponse, RemoveWSDMAssistantAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.DeleteAssistantAssociationRequest();
        ...
        private Amazon.ConnectWisdomService.Model.DeleteAssistantAssociationResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.DeleteAssistantAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "DeleteAssistantAssociation");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssistantAssociationId { get; set; }
            public System.String AssistantId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.DeleteAssistantAssociationResponse, RemoveWSDMAssistantAssociationCmdlet, object> Select { get; set; } =
