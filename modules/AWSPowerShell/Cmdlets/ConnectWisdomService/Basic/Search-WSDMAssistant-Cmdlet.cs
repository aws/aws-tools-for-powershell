...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    public partial class SearchWSDMAssistantCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-WSDMAssistant (QueryAssistant)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.QueryAssistantResponse, SearchWSDMAssistantCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.QueryAssistantRequest();
        ...
        private Amazon.ConnectWisdomService.Model.QueryAssistantResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.QueryAssistantRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "QueryAssistant");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueryText { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.QueryAssistantResponse, SearchWSDMAssistantCmdlet, object> Select { get; set; } =
