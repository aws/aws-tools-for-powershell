...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSDMImportJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSDMImportJobCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ImportJobId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ImportJobId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSDMImportJob (DeleteImportJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.DeleteImportJobResponse, RemoveWSDMImportJobCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ImportJobId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.DeleteImportJobRequest();
        ...
        private Amazon.ConnectWisdomService.Model.DeleteImportJobResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.DeleteImportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "DeleteImportJob");
            try
            {
                #if DESKTOP
                return client.DeleteImportJob(request);
                #elif CORECLR
                return client.DeleteImportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ImportJobId { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.DeleteImportJobResponse, RemoveWSDMImportJobCmdlet, object> Select { get; set; } =
