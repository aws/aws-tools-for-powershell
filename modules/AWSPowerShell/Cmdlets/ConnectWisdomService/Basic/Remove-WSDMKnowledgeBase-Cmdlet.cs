...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "WSDMKnowledgeBase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSDMKnowledgeBaseCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSDMKnowledgeBase (DeleteKnowledgeBase)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.DeleteKnowledgeBaseResponse, RemoveWSDMKnowledgeBaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.DeleteKnowledgeBaseRequest();
        ...
        private Amazon.ConnectWisdomService.Model.DeleteKnowledgeBaseResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.DeleteKnowledgeBaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "DeleteKnowledgeBase");
            try
            {
                return client.DeleteKnowledgeBaseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.DeleteKnowledgeBaseResponse, RemoveWSDMKnowledgeBaseCmdlet, object> Select { get; set; } =
