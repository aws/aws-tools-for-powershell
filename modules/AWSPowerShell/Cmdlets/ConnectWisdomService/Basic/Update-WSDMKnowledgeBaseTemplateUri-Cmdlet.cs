...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Update", "WSDMKnowledgeBaseTemplateUri", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ConnectWisdomService.Model.KnowledgeBaseData")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service UpdateKnowledgeBaseTemplateUri API operation.", Operation = new[] {"UpdateKnowledgeBaseTemplateUri"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.KnowledgeBaseData or Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.KnowledgeBaseData object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWSDMKnowledgeBaseTemplateUriCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WSDMKnowledgeBaseTemplateUri (UpdateKnowledgeBaseTemplateUri)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse, UpdateWSDMKnowledgeBaseTemplateUriCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriRequest();
        ...
        private Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "UpdateKnowledgeBaseTemplateUri");
            try
            {
                return client.UpdateKnowledgeBaseTemplateUriAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String KnowledgeBaseId { get; set; }
            public System.String TemplateUri { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.UpdateKnowledgeBaseTemplateUriResponse, UpdateWSDMKnowledgeBaseTemplateUriCmdlet, object> Select { get; set; } =
