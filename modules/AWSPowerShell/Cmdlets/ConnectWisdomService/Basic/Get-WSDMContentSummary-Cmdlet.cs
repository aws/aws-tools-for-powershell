...
namespace Amazon.PowerShell.Cmdlets.WSDM
{
    ...
    /// </summary>
    [Cmdlet("Get", "WSDMContentSummary")]
    [OutputType("Amazon.ConnectWisdomService.Model.ContentSummary")]
    [AWSCmdlet("Calls the Amazon Connect Wisdom Service GetContentSummary API operation.", Operation = new[] {"GetContentSummary"}, SelectReturnType = typeof(Amazon.ConnectWisdomService.Model.GetContentSummaryResponse))]
    [AWSCmdletOutput("Amazon.ConnectWisdomService.Model.ContentSummary or Amazon.ConnectWisdomService.Model.GetContentSummaryResponse",
        "This cmdlet returns an Amazon.ConnectWisdomService.Model.ContentSummary object.",
        "The service call response (type Amazon.ConnectWisdomService.Model.GetContentSummaryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWSDMContentSummaryCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.GetContentSummaryResponse, GetWSDMContentSummaryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectWisdomService.Model.GetContentSummaryRequest();
        ...
        private Amazon.ConnectWisdomService.Model.GetContentSummaryResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.GetContentSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "GetContentSummary");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ContentId { get; set; }
            public System.String KnowledgeBaseId { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.GetContentSummaryResponse, GetWSDMContentSummaryCmdlet, object> Select { get; set; } =
