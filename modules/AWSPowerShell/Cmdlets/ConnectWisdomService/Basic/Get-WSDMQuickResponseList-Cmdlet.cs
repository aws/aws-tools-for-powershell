...
{
    /// <summary>
    /// Lists information about quick response.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "WSDMQuickResponseList")]
    [OutputType("Amazon.ConnectWisdomService.Model.QuickResponseSummary")]
    ...
    public partial class GetWSDMQuickResponseListCmdlet : AmazonConnectWisdomServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "QuickResponseSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectWisdomService.Model.ListQuickResponsesResponse, GetWSDMQuickResponseListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ConnectWisdomService.Model.ListQuickResponsesRequest();
        ...
        private Amazon.ConnectWisdomService.Model.ListQuickResponsesResponse CallAWSServiceOperation(IAmazonConnectWisdomService client, Amazon.ConnectWisdomService.Model.ListQuickResponsesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Wisdom Service", "ListQuickResponses");
            try
            {
                return client.ListQuickResponsesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConnectWisdomService.Model.ListQuickResponsesResponse, GetWSDMQuickResponseListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.QuickResponseSummaries;
        }
