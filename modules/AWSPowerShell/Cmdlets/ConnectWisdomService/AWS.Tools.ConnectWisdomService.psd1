#
# Module manifest for module 'AWS.Tools.ConnectWisdomService'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ConnectWisdomService.dll'
    ...
    GUID = '5b894162-20f3-48fb-ac63-5738280c70f7'
    ...
    Description = 'The ConnectWisdomService module of AWS Tools for PowerShell lets developers and administrators manage Amazon Connect Wisdom Service from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.ConnectWisdomService.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ConnectWisdomService.Completers.psm1',
        'AWS.Tools.ConnectWisdomService.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.ConnectWisdomService.dll-Help.xml'
    )
