...
{
    /// <summary>
    /// Lists the engagements to contact channels that occurred by engaging a contact.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.SSMContacts.Model.Page or Amazon.SSMContacts.Model.ListPagesByEngagementResponse",
        ...
        "The service call response (type Amazon.SSMContacts.Model.ListPagesByEngagementResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMCPagesByEngagementListCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.ListPagesByEngagementResponse, GetSMCPagesByEngagementListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSMContacts.Model.ListPagesByEngagementRequest();
        ...
        private Amazon.SSMContacts.Model.ListPagesByEngagementResponse CallAWSServiceOperation(IAmazonSSMContacts client, Amazon.SSMContacts.Model.ListPagesByEngagementRequest request)
        {
            ...
            try
            {
                return client.ListPagesByEngagementAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSMContacts.Model.ListPagesByEngagementResponse, GetSMCPagesByEngagementListCmdlet, object> Select { get; set; } =
