...
namespace Amazon.PowerShell.Cmdlets.SMC
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS System Manager Contacts SendActivationCode API operation.", Operation = new[] {"SendActivationCode"}, SelectReturnType = typeof(Amazon.SSMContacts.Model.SendActivationCodeResponse))]
    ...
    public partial class SendSMCActivationCodeCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Send-SMCActivationCode (SendActivationCode)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.SendActivationCodeResponse, SendSMCActivationCodeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMContacts.Model.SendActivationCodeRequest();
        ...
        private Amazon.SSMContacts.Model.SendActivationCodeResponse CallAWSServiceOperation(IAmazonSSMContacts client, Amazon.SSMContacts.Model.SendActivationCodeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS System Manager Contacts", "SendActivationCode");
            try
            {
                #if DESKTOP
                return client.SendActivationCode(request);
                #elif CORECLR
                return client.SendActivationCodeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContactChannelId { get; set; }
            public System.Func<Amazon.SSMContacts.Model.SendActivationCodeResponse, SendSMCActivationCodeCmdlet, object> Select { get; set; } =
