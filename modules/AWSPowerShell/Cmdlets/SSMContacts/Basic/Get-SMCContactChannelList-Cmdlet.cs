...
{
    /// <summary>
    /// Lists all contact channels for the specified contact.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "SMCContactChannelList")]
    [OutputType("Amazon.SSMContacts.Model.ContactChannel")]
    [AWSCmdlet("Calls the AWS Systems Manager Incident Manager Contacts ListContactChannels API operation.", Operation = new[] {"ListContactChannels"}, SelectReturnType = typeof(Amazon.SSMContacts.Model.ListContactChannelsResponse))]
    [AWSCmdletOutput("Amazon.SSMContacts.Model.ContactChannel or Amazon.SSMContacts.Model.ListContactChannelsResponse",
        ...
        "The service call response (type Amazon.SSMContacts.Model.ListContactChannelsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMCContactChannelListCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager Contacts", "ListContactChannels");
            try
            {
                return client.ListContactChannelsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
