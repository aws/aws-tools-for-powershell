...
namespace Amazon.PowerShell.Cmdlets.SMC
{
    ...
    [AWSCmdletOutput("None or Amazon.SSMContacts.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.SSMContacts.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveSMCResourceTagCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key of the tag that you want to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.UntagResourceResponse, RemoveSMCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMContacts.Model.UntagResourceRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SSMContacts.Model.UntagResourceResponse, RemoveSMCResourceTagCmdlet, object> Select { get; set; } =
