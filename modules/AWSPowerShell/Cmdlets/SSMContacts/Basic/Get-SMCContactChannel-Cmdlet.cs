...
namespace Amazon.PowerShell.Cmdlets.SMC
{
    ...
    [AWSCmdletOutput("Amazon.SSMContacts.Model.GetContactChannelResponse",
        "This cmdlet returns an Amazon.SSMContacts.Model.GetContactChannelResponse object containing multiple properties."
    )]
    public partial class GetSMCContactChannelCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.GetContactChannelResponse, GetSMCContactChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMContacts.Model.GetContactChannelRequest();
        ...
        private Amazon.SSMContacts.Model.GetContactChannelResponse CallAWSServiceOperation(IAmazonSSMContacts client, Amazon.SSMContacts.Model.GetContactChannelRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetContactChannel(request);
                #elif CORECLR
                return client.GetContactChannelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContactChannelId { get; set; }
            public System.Func<Amazon.SSMContacts.Model.GetContactChannelResponse, GetSMCContactChannelCmdlet, object> Select { get; set; } =
