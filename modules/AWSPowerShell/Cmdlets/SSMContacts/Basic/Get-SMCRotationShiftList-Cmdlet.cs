...
{
    /// <summary>
    /// Returns a list of shifts generated by an existing rotation in the system.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "SMCRotationShiftList")]
    ...
    public partial class GetSMCRotationShiftListCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.ListRotationShiftsResponse, GetSMCRotationShiftListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSMContacts.Model.ListRotationShiftsRequest();
        ...
        private Amazon.SSMContacts.Model.ListRotationShiftsResponse CallAWSServiceOperation(IAmazonSSMContacts client, Amazon.SSMContacts.Model.ListRotationShiftsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager Incident Manager Contacts", "ListRotationShifts");
            try
            {
                return client.ListRotationShiftsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RotationId { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.SSMContacts.Model.ListRotationShiftsResponse, GetSMCRotationShiftListCmdlet, object> Select { get; set; } =
