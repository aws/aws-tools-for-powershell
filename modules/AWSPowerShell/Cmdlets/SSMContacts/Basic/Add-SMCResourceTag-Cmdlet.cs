...
namespace Amazon.PowerShell.Cmdlets.SMC
{
    ...
    [AWSCmdletOutput("None or Amazon.SSMContacts.Model.TagResourceResponse",
        ...
        "The service response (type Amazon.SSMContacts.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddSMCResourceTagCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of tags that you are adding to the contact or escalation plan.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SMCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMContacts.Model.TagResourceResponse, AddSMCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMContacts.Model.TagResourceRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SSMContacts.Model.TagResourceResponse, AddSMCResourceTagCmdlet, object> Select { get; set; } =
