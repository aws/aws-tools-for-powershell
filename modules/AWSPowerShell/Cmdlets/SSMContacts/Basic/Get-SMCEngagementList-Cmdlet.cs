...
namespace Amazon.PowerShell.Cmdlets.SMC
{
    ...
    [AWSCmdlet("Calls the AWS System Manager Contacts ListEngagements API operation.", Operation = new[] {"ListEngagements"}, SelectReturnType = typeof(Amazon.SSMContacts.Model.ListEngagementsResponse))]
    ...
    public partial class GetSMCEngagementListCmdlet : AmazonSSMContactsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^IncidentId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.IncidentId;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS System Manager Contacts", "ListEngagements");
            try
            {
                #if DESKTOP
                return client.ListEngagements(request);
                #elif CORECLR
                return client.ListEngagementsAsync(request).GetAwaiter().GetResult();
                #else
