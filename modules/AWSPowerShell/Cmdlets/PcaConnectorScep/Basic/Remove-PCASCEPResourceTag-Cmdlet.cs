...
namespace Amazon.PowerShell.Cmdlets.PCASCEP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PCASCEPResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePCASCEPResourceTagCmdlet : AmazonPcaConnectorScepClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PcaConnectorScep.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PCASCEPResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PcaConnectorScep.Model.UntagResourceResponse, RemovePCASCEPResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PcaConnectorScep.Model.UntagResourceRequest();
        ...
        private Amazon.PcaConnectorScep.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPcaConnectorScep client, Amazon.PcaConnectorScep.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Private CA Connector for SCEP", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PcaConnectorScep.Model.UntagResourceResponse, RemovePCASCEPResourceTagCmdlet, object> Select { get; set; } =
