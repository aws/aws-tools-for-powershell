...
namespace Amazon.PowerShell.Cmdlets.PCASCEP
{
    ...
    public partial class RemovePCASCEPConnectorCmdlet : AmazonPcaConnectorScepClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PcaConnectorScep.Model.DeleteConnectorResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PCASCEPConnector (DeleteConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PcaConnectorScep.Model.DeleteConnectorResponse, RemovePCASCEPConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PcaConnectorScep.Model.DeleteConnectorRequest();
        ...
        private Amazon.PcaConnectorScep.Model.DeleteConnectorResponse CallAWSServiceOperation(IAmazonPcaConnectorScep client, Amazon.PcaConnectorScep.Model.DeleteConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Private CA Connector for SCEP", "DeleteConnector");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ConnectorArn { get; set; }
            public System.Func<Amazon.PcaConnectorScep.Model.DeleteConnectorResponse, RemovePCASCEPConnectorCmdlet, object> Select { get; set; } =
