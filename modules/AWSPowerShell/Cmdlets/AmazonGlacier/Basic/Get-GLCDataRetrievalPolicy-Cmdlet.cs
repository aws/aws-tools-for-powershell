...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLCDataRetrievalPolicy")]
    [OutputType("Amazon.Glacier.Model.DataRetrievalPolicy")]
    [AWSCmdlet("Calls the Amazon Glacier GetDataRetrievalPolicy API operation.", Operation = new[] {"GetDataRetrievalPolicy"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.DataRetrievalPolicy",
        "This cmdlet returns a DataRetrievalPolicy object.",
        "The service call response (type Amazon.Glacier.Model.GetDataRetrievalPolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLCDataRetrievalPolicyCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glacier.Model.GetDataRetrievalPolicyRequest();
        ...
        private Amazon.Glacier.Model.GetDataRetrievalPolicyResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.GetDataRetrievalPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Glacier", "GetDataRetrievalPolicy");
            try
            {
                #if DESKTOP
