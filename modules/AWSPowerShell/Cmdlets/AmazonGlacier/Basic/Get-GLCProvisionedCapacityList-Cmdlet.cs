...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier ListProvisionedCapacity API operation.", Operation = new[] {"ListProvisionedCapacity"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.ProvisionedCapacityDescription",
        "This cmdlet returns a collection of ProvisionedCapacityDescription objects.",
        "The service call response (type Amazon.Glacier.Model.ListProvisionedCapacityResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLCProvisionedCapacityListCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.ProvisionedCapacityList;
