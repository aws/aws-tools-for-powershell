...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier CreateVault API operation.", Operation = new[] {"CreateVault"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a String object.",
        "The service call response (type Amazon.Glacier.Model.CreateVaultResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGLCVaultCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        private Amazon.Glacier.Model.CreateVaultResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.CreateVaultRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateVaultAsync(request);
                return task.Result;
                #else
