...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier ListVaults API operation.", Operation = new[] {"ListVaults"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.DescribeVaultOutput",
        "This cmdlet returns a collection of DescribeVaultOutput objects.",
    ...
    public partial class GetGLCVaultListCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.VaultList;
        ...
        private Amazon.Glacier.Model.ListVaultsResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.ListVaultsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListVaultsAsync(request);
                return task.Result;
                #else
