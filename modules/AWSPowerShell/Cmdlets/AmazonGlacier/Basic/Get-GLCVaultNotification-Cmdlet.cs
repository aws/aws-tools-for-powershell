...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier GetVaultNotifications API operation.", Operation = new[] {"GetVaultNotifications"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.VaultNotificationConfig",
        "This cmdlet returns a VaultNotificationConfig object.",
    ...
    public partial class GetGLCVaultNotificationCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.VaultNotificationConfig;
