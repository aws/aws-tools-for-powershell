...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier GetVaultLock API operation.", Operation = new[] {"GetVaultLock"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.GetVaultLockResponse",
        "This cmdlet returns a Amazon.Glacier.Model.GetVaultLockResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLCVaultLockCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
        ...
        private Amazon.Glacier.Model.GetVaultLockResponse CallAWSServiceOperation(IAmazonGlacier client, Amazon.Glacier.Model.GetVaultLockRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetVaultLockAsync(request);
                return task.Result;
                #else
