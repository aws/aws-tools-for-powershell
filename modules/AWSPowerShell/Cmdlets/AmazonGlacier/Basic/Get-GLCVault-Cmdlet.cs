...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    [AWSCmdlet("Calls the Amazon Glacier DescribeVault API operation.", Operation = new[] {"DescribeVault"})]
    [AWSCmdletOutput("Amazon.Glacier.Model.DescribeVaultResponse",
        "This cmdlet returns a Amazon.Glacier.Model.DescribeVaultResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
