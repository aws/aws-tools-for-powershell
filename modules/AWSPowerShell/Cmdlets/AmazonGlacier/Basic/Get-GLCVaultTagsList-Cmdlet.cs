...
namespace Amazon.PowerShell.Cmdlets.GLC
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLCVaultTagsList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Glacier ListTagsForVault API operation.", Operation = new[] {"ListTagsForVault"})]
    ...
    public partial class GetGLCVaultTagsListCmdlet : AmazonGlacierClientCmdlet, IExecutor
    {
