...
namespace Amazon.PowerShell.Cmdlets.SSO
{
    ...
    [AWSCmdlet("Calls the AWS Single Sign-On ListAccountRoles API operation.", Operation = new[] {"ListAccountRoles"}, SelectReturnType = typeof(Amazon.SSO.Model.ListAccountRolesResponse))]
    [AWSCmdletOutput("Amazon.SSO.Model.RoleInfo or Amazon.SSO.Model.ListAccountRolesResponse",
        "This cmdlet returns a collection of Amazon.SSO.Model.RoleInfo objects.",
        "The service call response (type Amazon.SSO.Model.ListAccountRolesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSOAccountRoleListCmdlet : AmazonSSOClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RoleList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSO.Model.ListAccountRolesResponse, GetSSOAccountRoleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SSO.Model.ListAccountRolesRequest();
        ...
        private Amazon.SSO.Model.ListAccountRolesResponse CallAWSServiceOperation(IAmazonSSO client, Amazon.SSO.Model.ListAccountRolesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On", "ListAccountRoles");
            try
            {
                #if DESKTOP
                return client.ListAccountRoles(request);
                #elif CORECLR
                return client.ListAccountRolesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.SSO.Model.ListAccountRolesResponse, GetSSOAccountRoleListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RoleList;
        }
