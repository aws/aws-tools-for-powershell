...
namespace Amazon.PowerShell.Cmdlets.SSO
{
    ...
    [AWSCmdletOutput("Amazon.SSO.Model.AccountInfo or Amazon.SSO.Model.ListAccountsResponse",
        ...
        "The service call response (type Amazon.SSO.Model.ListAccountsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
