...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    /// Gets the SyncJob.
    /// </summary>
    [Cmdlet("Get", "IOTTMSyncJob")]
    [OutputType("Amazon.IoTTwinMaker.Model.GetSyncJobResponse")]
    [AWSCmdlet("Calls the AWS IoT TwinMaker GetSyncJob API operation.", Operation = new[] {"GetSyncJob"}, SelectReturnType = typeof(Amazon.IoTTwinMaker.Model.GetSyncJobResponse))]
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.GetSyncJobResponse",
        "This cmdlet returns an Amazon.IoTTwinMaker.Model.GetSyncJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTTMSyncJobCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTTwinMaker.Model.GetSyncJobResponse, GetIOTTMSyncJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTTwinMaker.Model.GetSyncJobRequest();
        ...
        private Amazon.IoTTwinMaker.Model.GetSyncJobResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.GetSyncJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT TwinMaker", "GetSyncJob");
            try
            {
                #if DESKTOP
                return client.GetSyncJob(request);
                #elif CORECLR
                return client.GetSyncJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SyncSource { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.IoTTwinMaker.Model.GetSyncJobResponse, GetIOTTMSyncJobCmdlet, object> Select { get; set; } =
