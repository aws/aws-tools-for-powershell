...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.CancelMetadataTransferJobResponse",
        "This cmdlet returns an Amazon.IoTTwinMaker.Model.CancelMetadataTransferJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopIOTTMMetadataTransferJobCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MetadataTransferJobId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.MetadataTransferJobId;
            }
        ...
        private Amazon.IoTTwinMaker.Model.CancelMetadataTransferJobResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.CancelMetadataTransferJobRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CancelMetadataTransferJob(request);
                #elif CORECLR
                return client.CancelMetadataTransferJobAsync(request).GetAwaiter().GetResult();
                #else
