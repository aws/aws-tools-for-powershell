...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.SyncResourceSummary or Amazon.IoTTwinMaker.Model.ListSyncResourcesResponse",
        ...
        "The service call response (type Amazon.IoTTwinMaker.Model.ListSyncResourcesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTTMSyncResourceListCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of objects that filter the request.</para><para>The following filter combinations are supported:</para><ul><li><para>Filter with state</para></li><li><para>Filter with ResourceType and ResourceId</para></li><li><para>Filter with ResourceType and ExternalId</para></li></ul><para />
        ...
        private Amazon.IoTTwinMaker.Model.ListSyncResourcesResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.ListSyncResourcesRequest request)
        {
            ...
            try
            {
                return client.ListSyncResourcesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
