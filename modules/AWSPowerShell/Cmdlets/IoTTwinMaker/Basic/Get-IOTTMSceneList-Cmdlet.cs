...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTTMSceneList")]
    [OutputType("Amazon.IoTTwinMaker.Model.SceneSummary")]
    [AWSCmdlet("Calls the AWS IoT TwinMaker ListScenes API operation.", Operation = new[] {"ListScenes"}, SelectReturnType = typeof(Amazon.IoTTwinMaker.Model.ListScenesResponse))]
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.SceneSummary or Amazon.IoTTwinMaker.Model.ListScenesResponse",
        "This cmdlet returns a collection of Amazon.IoTTwinMaker.Model.SceneSummary objects.",
        "The service call response (type Amazon.IoTTwinMaker.Model.ListScenesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTTMSceneListCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SceneSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTTwinMaker.Model.ListScenesResponse, GetIOTTMSceneListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTTwinMaker.Model.ListScenesRequest();
        ...
        private Amazon.IoTTwinMaker.Model.ListScenesResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.ListScenesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT TwinMaker", "ListScenes");
            try
            {
                #if DESKTOP
                return client.ListScenes(request);
                #elif CORECLR
                return client.ListScenesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.IoTTwinMaker.Model.ListScenesResponse, GetIOTTMSceneListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SceneSummaries;
        }
