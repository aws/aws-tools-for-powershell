...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.DeleteWorkspaceResponse",
        "This cmdlet returns an Amazon.IoTTwinMaker.Model.DeleteWorkspaceResponse object containing multiple properties."
    )]
    public partial class RemoveIOTTMWorkspaceCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTMWorkspace (DeleteWorkspace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTTwinMaker.Model.DeleteWorkspaceResponse, RemoveIOTTMWorkspaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTTwinMaker.Model.DeleteWorkspaceRequest();
        ...
        private Amazon.IoTTwinMaker.Model.DeleteWorkspaceResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.DeleteWorkspaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT TwinMaker", "DeleteWorkspace");
            try
            {
                #if DESKTOP
