...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.PropertyValueHistory or Amazon.IoTTwinMaker.Model.GetPropertyValueHistoryResponse",
        ...
        "The service call response (type Amazon.IoTTwinMaker.Model.GetPropertyValueHistoryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
