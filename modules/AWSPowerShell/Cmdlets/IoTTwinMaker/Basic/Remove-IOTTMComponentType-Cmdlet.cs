...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IOTTMComponentType", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveIOTTMComponentTypeCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTMComponentType (DeleteComponentType)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTTwinMaker.Model.DeleteComponentTypeRequest();
        ...
        private Amazon.IoTTwinMaker.Model.DeleteComponentTypeResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.DeleteComponentTypeRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ComponentTypeId { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.IoTTwinMaker.Model.DeleteComponentTypeResponse, RemoveIOTTMComponentTypeCmdlet, object> Select { get; set; } =
