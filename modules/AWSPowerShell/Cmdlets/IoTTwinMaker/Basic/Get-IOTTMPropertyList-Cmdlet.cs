...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTTMPropertyList")]
    [OutputType("Amazon.IoTTwinMaker.Model.PropertySummary")]
    [AWSCmdlet("Calls the AWS IoT TwinMaker ListProperties API operation.", Operation = new[] {"ListProperties"}, SelectReturnType = typeof(Amazon.IoTTwinMaker.Model.ListPropertiesResponse))]
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.PropertySummary or Amazon.IoTTwinMaker.Model.ListPropertiesResponse",
        "This cmdlet returns a collection of Amazon.IoTTwinMaker.Model.PropertySummary objects.",
        "The service call response (type Amazon.IoTTwinMaker.Model.ListPropertiesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTTMPropertyListCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PropertySummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTTwinMaker.Model.ListPropertiesResponse, GetIOTTMPropertyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTTwinMaker.Model.ListPropertiesRequest();
        ...
        private Amazon.IoTTwinMaker.Model.ListPropertiesResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.ListPropertiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT TwinMaker", "ListProperties");
            try
            {
                #if DESKTOP
                return client.ListProperties(request);
                #elif CORECLR
                return client.ListPropertiesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.IoTTwinMaker.Model.ListPropertiesResponse, GetIOTTMPropertyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PropertySummaries;
        }
