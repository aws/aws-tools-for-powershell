...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    [AWSCmdletOutput("Amazon.IoTTwinMaker.Model.PropertySummary or Amazon.IoTTwinMaker.Model.ListPropertiesResponse",
        ...
        "The service call response (type Amazon.IoTTwinMaker.Model.ListPropertiesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTTMPropertyListCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTTwinMaker.Model.ListPropertiesResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.ListPropertiesRequest request)
        {
            ...
            try
            {
                return client.ListPropertiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
