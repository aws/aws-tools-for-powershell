...
namespace Amazon.PowerShell.Cmdlets.IOTTM
{
    ...
    /// Deletes an entity.
    /// </summary>
    [Cmdlet("Remove", "IOTTMEntity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.IoTTwinMaker.State")]
    ...
    public partial class RemoveIOTTMEntityCmdlet : AmazonIoTTwinMakerClientCmdlet, IExecutor
    {
        ...
        public System.Boolean? IsRecursive { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTTMEntity (DeleteEntity)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTTwinMaker.Model.DeleteEntityResponse, RemoveIOTTMEntityCmdlet>(Select) ??
            ...
            #endif
            context.IsRecursive = this.IsRecursive;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTTwinMaker.Model.DeleteEntityRequest();
            
            if (cmdletContext.EntityId != null)
            {
                request.EntityId = cmdletContext.EntityId;
            }
            if (cmdletContext.IsRecursive != null)
            {
                request.IsRecursive = cmdletContext.IsRecursive.Value;
            }
        ...
        private Amazon.IoTTwinMaker.Model.DeleteEntityResponse CallAWSServiceOperation(IAmazonIoTTwinMaker client, Amazon.IoTTwinMaker.Model.DeleteEntityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT TwinMaker", "DeleteEntity");
            try
            {
                return client.DeleteEntityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? IsRecursive { get; set; }
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.IoTTwinMaker.Model.DeleteEntityResponse, RemoveIOTTMEntityCmdlet, object> Select { get; set; } =
