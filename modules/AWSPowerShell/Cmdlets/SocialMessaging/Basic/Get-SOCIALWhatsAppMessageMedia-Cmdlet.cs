...
namespace Amazon.PowerShell.Cmdlets.SOCIAL
{
    ...
    [AWSCmdletOutput("Amazon.SocialMessaging.Model.GetWhatsAppMessageMediaResponse",
        "This cmdlet returns an Amazon.SocialMessaging.Model.GetWhatsAppMessageMediaResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSOCIALWhatsAppMessageMediaCmdlet : AmazonSocialMessagingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the OriginationPhoneNumberId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^OriginationPhoneNumberId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^OriginationPhoneNumberId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.OriginationPhoneNumberId;
            }
        ...
        private Amazon.SocialMessaging.Model.GetWhatsAppMessageMediaResponse CallAWSServiceOperation(IAmazonSocialMessaging client, Amazon.SocialMessaging.Model.GetWhatsAppMessageMediaRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetWhatsAppMessageMedia(request);
                #elif CORECLR
                return client.GetWhatsAppMessageMediaAsync(request).GetAwaiter().GetResult();
                #else
