#
# Module manifest for module 'AWS.Tools.SocialMessaging'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SocialMessaging.dll'
    ...
    GUID = 'da5f15ee-8fac-4456-8d92-289320c240fb'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SocialMessaging.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SocialMessaging.Completers.psm1',
        'AWS.Tools.SocialMessaging.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'Connect-SOCIALWhatsAppBusinessAccount', 
    ...
    FileList = @(
        'AWS.Tools.SocialMessaging.dll-Help.xml'
    )
