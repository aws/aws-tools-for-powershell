...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    [AWSCmdlet("Calls the AWS Cloud HSM V2 DeleteBackup API operation.", Operation = new[] {"DeleteBackup"})]
    ...
    public partial class RemoveHSM2BackupCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM V2", "DeleteBackup");
            try
            {
                #if DESKTOP
