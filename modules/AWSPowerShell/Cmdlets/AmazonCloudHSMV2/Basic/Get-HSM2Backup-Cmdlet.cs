...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    [AWSCmdlet("Invokes the DescribeBackups operation against AWS Cloud HSM V2.", Operation = new[] {"DescribeBackups"})]
    ...
    public partial class GetHSM2BackupCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM V2", "DescribeBackups");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeBackupsAsync(request);
                return task.Result;
                #else
