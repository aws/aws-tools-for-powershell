...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "HSM2Item", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveHSM2ItemCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("HsmId", MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-HSM2Item (DeleteHsm)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.HsmId;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM V2", "DeleteHsm");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteHsmAsync(request);
                return task.Result;
                #else
