...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    [AWSCmdlet("Invokes the InitializeCluster operation against AWS Cloud HSM V2.", Operation = new[] {"InitializeCluster"})]
    ...
    public partial class InitializeHSM2ClusterCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        /// The certificate must be in PEM format.</para>
        /// </para>
        /// </summary>
        ...
        /// with a root certificate. The certificate or certificate chain must be in PEM format.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
