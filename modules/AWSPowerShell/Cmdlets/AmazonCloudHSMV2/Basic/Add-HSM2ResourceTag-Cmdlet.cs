...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    [AWSCmdlet("Invokes the TagResource operation against AWS Cloud HSM V2.", Operation = new[] {"TagResource"})]
    ...
    public partial class AddHSM2ResourceTagCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM V2", "TagResource");
            try
            {
                #if DESKTOP
