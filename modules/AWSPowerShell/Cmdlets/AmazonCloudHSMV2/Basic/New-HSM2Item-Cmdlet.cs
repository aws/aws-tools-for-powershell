...
namespace Amazon.PowerShell.Cmdlets.HSM2
{
    ...
    /// </summary>
    [Cmdlet("New", "HSM2Item", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudHSMV2.Model.Hsm")]
    [AWSCmdlet("Invokes the CreateHsm operation against AWS Cloud HSM V2.", Operation = new[] {"CreateHsm"})]
    ...
    public partial class NewHSM2ItemCmdlet : AmazonCloudHSMV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-HSM2Item (CreateHsm)"))
            {
                return;
            }
