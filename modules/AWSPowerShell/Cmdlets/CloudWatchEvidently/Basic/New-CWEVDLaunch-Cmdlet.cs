...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    [AWSCmdletOutput("Amazon.CloudWatchEvidently.Model.Launch or Amazon.CloudWatchEvidently.Model.CreateLaunchResponse",
        ...
        "The service call response (type Amazon.CloudWatchEvidently.Model.CreateLaunchResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
