...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    public partial class GetCWEVDFeatureCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.GetFeatureResponse, GetCWEVDFeatureCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.GetFeatureRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.GetFeatureResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.GetFeatureRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "GetFeature");
            try
            {
                #if DESKTOP
                return client.GetFeature(request);
                #elif CORECLR
                return client.GetFeatureAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Feature { get; set; }
            public System.String Project { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.GetFeatureResponse, GetCWEVDFeatureCmdlet, object> Select { get; set; } =
