...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon CloudWatch Evidently DeleteLaunch API operation.", Operation = new[] {"DeleteLaunch"}, SelectReturnType = typeof(Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse))]
    [AWSCmdletOutput("None or Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCWEVDLaunchCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWEVDLaunch (DeleteLaunch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse, RemoveCWEVDLaunchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.DeleteLaunchRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.DeleteLaunchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "DeleteLaunch");
            try
            {
                #if DESKTOP
                return client.DeleteLaunch(request);
                #elif CORECLR
                return client.DeleteLaunchAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Launch { get; set; }
            public System.String Project { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.DeleteLaunchResponse, RemoveCWEVDLaunchCmdlet, object> Select { get; set; } =
