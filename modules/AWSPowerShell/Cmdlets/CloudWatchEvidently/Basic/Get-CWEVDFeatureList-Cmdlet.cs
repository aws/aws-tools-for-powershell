...
{
    /// <summary>
    /// Returns configuration details about all the features in the specified project.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "CWEVDFeatureList")]
    [OutputType("Amazon.CloudWatchEvidently.Model.FeatureSummary")]
    [AWSCmdlet("Calls the Amazon CloudWatch Evidently ListFeatures API operation.", Operation = new[] {"ListFeatures"}, SelectReturnType = typeof(Amazon.CloudWatchEvidently.Model.ListFeaturesResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchEvidently.Model.FeatureSummary or Amazon.CloudWatchEvidently.Model.ListFeaturesResponse",
    ...
    public partial class GetCWEVDFeatureListCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        /// from a previous <c>ListFeatures</c> operation.</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Features";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.ListFeaturesResponse, GetCWEVDFeatureListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudWatchEvidently.Model.ListFeaturesRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.ListFeaturesResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.ListFeaturesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "ListFeatures");
            try
            {
                return client.ListFeaturesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String Project { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.ListFeaturesResponse, GetCWEVDFeatureListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Features;
        }
