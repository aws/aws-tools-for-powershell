...
{
    /// <summary>
    /// Deletes an Evidently feature.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Remove", "CWEVDFeature", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCWEVDFeatureCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWEVDFeature (DeleteFeature)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.DeleteFeatureResponse, RemoveCWEVDFeatureCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.DeleteFeatureRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.DeleteFeatureResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.DeleteFeatureRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "DeleteFeature");
            try
            {
                #if DESKTOP
                return client.DeleteFeature(request);
                #elif CORECLR
                return client.DeleteFeatureAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Feature { get; set; }
            public System.String Project { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.DeleteFeatureResponse, RemoveCWEVDFeatureCmdlet, object> Select { get; set; } =
