...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    public partial class GetCWEVDFeatureEvaluationCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A JSON block of attributes that you can optionally pass in. This JSON block is included
        /// in the evaluation events sent to Evidently from the user session. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
