...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Evidently ListExperiments API operation.", Operation = new[] {"ListExperiments"}, SelectReturnType = typeof(Amazon.CloudWatchEvidently.Model.ListExperimentsResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchEvidently.Model.Experiment or Amazon.CloudWatchEvidently.Model.ListExperimentsResponse",
        "This cmdlet returns a collection of Amazon.CloudWatchEvidently.Model.Experiment objects.",
        "The service call response (type Amazon.CloudWatchEvidently.Model.ListExperimentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWEVDExperimentListCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.CloudWatchEvidently.ExperimentStatus")]
        public Amazon.CloudWatchEvidently.ExperimentStatus Status { get; set; }
        #endregion
        ...
        /// from a previous <c>ListExperiments</c> operation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.ListExperimentsResponse, GetCWEVDExperimentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.ListExperimentsRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.ListExperimentsResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.ListExperimentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "ListExperiments");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Project { get; set; }
            public Amazon.CloudWatchEvidently.ExperimentStatus Status { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.ListExperimentsResponse, GetCWEVDExperimentListCmdlet, object> Select { get; set; } =
