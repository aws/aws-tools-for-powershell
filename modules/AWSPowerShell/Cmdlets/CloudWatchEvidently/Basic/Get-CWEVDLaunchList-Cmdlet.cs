...
{
    /// <summary>
    /// Returns configuration details about all the launches in the specified project.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.<br/><br/>This operation is deprecated.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CloudWatchEvidently.Model.Launch or Amazon.CloudWatchEvidently.Model.ListLaunchesResponse",
        ...
        "The service call response (type Amazon.CloudWatchEvidently.Model.ListLaunchesResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetCWEVDLaunchListCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        private Amazon.CloudWatchEvidently.Model.ListLaunchesResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.ListLaunchesRequest request)
        {
            ...
            try
            {
                return client.ListLaunchesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
