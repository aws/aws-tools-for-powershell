...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    public partial class AddCWEVDResourceTagCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CWEVDResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.TagResourceResponse, AddCWEVDResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.TagResourceRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudWatchEvidently.Model.TagResourceResponse, AddCWEVDResourceTagCmdlet, object> Select { get; set; } =
