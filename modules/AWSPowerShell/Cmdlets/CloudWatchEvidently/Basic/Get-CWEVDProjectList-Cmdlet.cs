...
namespace Amazon.PowerShell.Cmdlets.CWEVD
{
    ...
    /// account.
    /// </summary>
    [Cmdlet("Get", "CWEVDProjectList")]
    [OutputType("Amazon.CloudWatchEvidently.Model.ProjectSummary")]
    ...
    public partial class GetCWEVDProjectListCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        /// from a previous <c>ListProjects</c> operation.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.ListProjectsResponse, GetCWEVDProjectListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.ListProjectsRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.ListProjectsResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.ListProjectsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "ListProjects");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.ListProjectsResponse, GetCWEVDProjectListCmdlet, object> Select { get; set; } =
