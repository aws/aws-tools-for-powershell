...
{
    /// <summary>
    /// Starts an existing launch. To create a launch, use <a href="https://docs.aws.amazon.com/cloudwatchevidently/latest/APIReference/API_CreateLaunch.html">CreateLaunch</a>.<br/><br/>This operation is deprecated.
    /// </summary>
    [Cmdlet("Start", "CWEVDLaunch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CloudWatchEvidently.Model.StartLaunchResponse")]
    [AWSCmdlet("Calls the Amazon CloudWatch Evidently StartLaunch API operation.", Operation = new[] {"StartLaunch"}, SelectReturnType = typeof(Amazon.CloudWatchEvidently.Model.StartLaunchResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchEvidently.Model.StartLaunchResponse",
        "This cmdlet returns an Amazon.CloudWatchEvidently.Model.StartLaunchResponse object containing multiple properties."
    )]
    [System.ObsoleteAttribute("AWS CloudWatch Evidently has been deprecated since 11/17/2025.")]
    public partial class StartCWEVDLaunchCmdlet : AmazonCloudWatchEvidentlyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CWEVDLaunch (StartLaunch)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvidently.Model.StartLaunchResponse, StartCWEVDLaunchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvidently.Model.StartLaunchRequest();
        ...
        private Amazon.CloudWatchEvidently.Model.StartLaunchResponse CallAWSServiceOperation(IAmazonCloudWatchEvidently client, Amazon.CloudWatchEvidently.Model.StartLaunchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Evidently", "StartLaunch");
            try
            {
                #if DESKTOP
                return client.StartLaunch(request);
                #elif CORECLR
                return client.StartLaunchAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Launch { get; set; }
            public System.String Project { get; set; }
            public System.Func<Amazon.CloudWatchEvidently.Model.StartLaunchResponse, StartCWEVDLaunchCmdlet, object> Select { get; set; } =
