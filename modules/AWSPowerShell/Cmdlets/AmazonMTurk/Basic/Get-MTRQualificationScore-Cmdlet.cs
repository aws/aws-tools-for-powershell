...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the GetQualificationScore operation against Amazon MTurk Service.", Operation = new[] {"GetQualificationScore"})]
    [AWSCmdletOutput("Amazon.MTurk.Model.Qualification",
        "This cmdlet returns a Qualification object.",
    ...
    public partial class GetMTRQualificationScoreCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Qualification;
        ...
        private static Amazon.MTurk.Model.GetQualificationScoreResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.GetQualificationScoreRequest request)
        {
            #if DESKTOP
            return client.GetQualificationScore(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetQualificationScoreAsync(request);
            return task.Result;
            #else
