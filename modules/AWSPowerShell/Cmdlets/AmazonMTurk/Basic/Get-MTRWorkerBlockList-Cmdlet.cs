...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the ListWorkerBlocks operation against Amazon MTurk Service.", Operation = new[] {"ListWorkerBlocks"})]
    [AWSCmdletOutput("Amazon.MTurk.Model.WorkerBlock",
        "This cmdlet returns a collection of WorkerBlock objects.",
    ...
    public partial class GetMTRWorkerBlockListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.WorkerBlocks;
        ...
        private static Amazon.MTurk.Model.ListWorkerBlocksResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListWorkerBlocksRequest request)
        {
            #if DESKTOP
            return client.ListWorkerBlocks(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListWorkerBlocksAsync(request);
            return task.Result;
            #else
