...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the CreateHITWithHITType operation against Amazon MTurk Service.", Operation = new[] {"CreateHITWithHITType"})]
    ...
    public partial class NewMTRHITWithHITTypeCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MTurk.Model.CreateHITWithHITTypeResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.CreateHITWithHITTypeRequest request)
        {
            #if DESKTOP
