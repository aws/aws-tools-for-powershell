...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the UpdateQualificationType operation against Amazon MTurk Service.", Operation = new[] {"UpdateQualificationType"})]
    ...
    public partial class UpdateMTRQualificationTypeCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MTurk.Model.UpdateQualificationTypeResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.UpdateQualificationTypeRequest request)
        {
            #if DESKTOP
