...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the DisassociateQualificationFromWorker operation against Amazon MTurk Service.", Operation = new[] {"DisassociateQualificationFromWorker"})]
    ...
    public partial class RemoveMTRQualificationFromWorkerCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private Amazon.MTurk.Model.DisassociateQualificationFromWorkerResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.DisassociateQualificationFromWorkerRequest request)
        {
            ...
            var task = client.DisassociateQualificationFromWorkerAsync(request);
            return task.Result;
            #else
