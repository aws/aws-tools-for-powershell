...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the GetQualificationType operation against Amazon MTurk Service.", Operation = new[] {"GetQualificationType"})]
    ...
    public partial class GetMTRQualificationTypeCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private Amazon.MTurk.Model.GetQualificationTypeResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.GetQualificationTypeRequest request)
        {
            ...
            var task = client.GetQualificationTypeAsync(request);
            return task.Result;
            #else
