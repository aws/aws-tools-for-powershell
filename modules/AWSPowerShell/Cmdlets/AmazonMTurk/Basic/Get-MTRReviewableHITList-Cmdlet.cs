...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Calls the Amazon MTurk Service ListReviewableHITs API operation.", Operation = new[] {"ListReviewableHITs"})]
    [AWSCmdletOutput("Amazon.MTurk.Model.HIT",
        "This cmdlet returns a collection of HIT objects.",
        "The service call response (type Amazon.MTurk.Model.ListReviewableHITsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetMTRReviewableHITListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter]
        [AWSConstantClassSource("Amazon.MTurk.ReviewableHITStatus")]
        public Amazon.MTurk.ReviewableHITStatus Status { get; set; }
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MTurk.Model.ListReviewableHITsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.HITs;
        ...
        private Amazon.MTurk.Model.ListReviewableHITsResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListReviewableHITsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListReviewableHITsAsync(request).GetAwaiter().GetResult();
                #else
