...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    public partial class UpdateMTRHITTypeOfHITCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MTurk.Model.UpdateHITTypeOfHITResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.UpdateHITTypeOfHITRequest request)
        {
            #if DESKTOP
