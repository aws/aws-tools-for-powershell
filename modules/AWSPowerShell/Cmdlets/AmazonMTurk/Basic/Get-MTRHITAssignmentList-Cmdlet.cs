...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the ListAssignmentsForHIT operation against Amazon MTurk Service.", Operation = new[] {"ListAssignmentsForHIT"})]
    ...
    public partial class GetMTRHITAssignmentListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MTurk.Model.ListAssignmentsForHITResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListAssignmentsForHITRequest request)
        {
            #if DESKTOP
