...
namespace Amazon.PowerShell.Cmdlets.MTR
{
    ...
    [AWSCmdlet("Invokes the ListHITs operation against Amazon MTurk Service.", Operation = new[] {"ListHITs"})]
    ...
    public partial class GetMTRHITListCmdlet : AmazonMTurkClientCmdlet, IExecutor
    {
        ...
        private static Amazon.MTurk.Model.ListHITsResponse CallAWSServiceOperation(IAmazonMTurk client, Amazon.MTurk.Model.ListHITsRequest request)
        {
            #if DESKTOP
            return client.ListHITs(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListHITsAsync(request);
            return task.Result;
            #else
