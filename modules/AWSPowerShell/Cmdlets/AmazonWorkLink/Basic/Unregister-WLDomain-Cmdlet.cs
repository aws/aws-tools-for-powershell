...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DisassociateDomain API operation.", Operation = new[] {"DisassociateDomain"})]
    ...
    public partial class UnregisterWLDomainCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WLDomain (DisassociateDomain)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DisassociateDomainRequest();
        ...
        private Amazon.WorkLink.Model.DisassociateDomainResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DisassociateDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DisassociateDomain");
            try
            {
                #if DESKTOP
                return client.DisassociateDomain(request);
                #elif CORECLR
                return client.DisassociateDomainAsync(request).GetAwaiter().GetResult();
                #else
