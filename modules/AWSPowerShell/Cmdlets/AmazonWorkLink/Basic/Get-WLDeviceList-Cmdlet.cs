...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    /// </summary>
    [Cmdlet("Get", "WLDeviceList")]
    [OutputType("Amazon.WorkLink.Model.DeviceSummary")]
    [AWSCmdlet("Calls the Amazon WorkLink ListDevices API operation.", Operation = new[] {"ListDevices"})]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DeviceSummary",
        "This cmdlet returns a collection of DeviceSummary objects.",
        "The service call response (type Amazon.WorkLink.Model.ListDevicesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetWLDeviceListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkLink.Model.ListDevicesRequest();
        ...
        private Amazon.WorkLink.Model.ListDevicesResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.ListDevicesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "ListDevices");
            try
            {
                #if DESKTOP
