...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DescribeDomain API operation.", Operation = new[] {"DescribeDomain"})]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DescribeDomainResponse",
        "This cmdlet returns a Amazon.WorkLink.Model.DescribeDomainResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
