...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DescribeDevice API operation.", Operation = new[] {"DescribeDevice"})]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DescribeDeviceResponse",
        "This cmdlet returns a Amazon.WorkLink.Model.DescribeDeviceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWLDeviceCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DescribeDeviceRequest();
        ...
        private Amazon.WorkLink.Model.DescribeDeviceResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DescribeDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DescribeDevice");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeDeviceAsync(request);
                return task.Result;
                #else
