...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    /// </summary>
    [Cmdlet("Get", "WLDomainList")]
    [OutputType("Amazon.WorkLink.Model.DomainSummary")]
    [AWSCmdlet("Calls the Amazon WorkLink ListDomains API operation.", Operation = new[] {"ListDomains"})]
    [AWSCmdletOutput("Amazon.WorkLink.Model.DomainSummary",
        "This cmdlet returns a collection of DomainSummary objects.",
        "The service call response (type Amazon.WorkLink.Model.ListDomainsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetWLDomainListCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkLink.Model.ListDomainsRequest();
        ...
        private Amazon.WorkLink.Model.ListDomainsResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.ListDomainsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "ListDomains");
            try
            {
                #if DESKTOP
