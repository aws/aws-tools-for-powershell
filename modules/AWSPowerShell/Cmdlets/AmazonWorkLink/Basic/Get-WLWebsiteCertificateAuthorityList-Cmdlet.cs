...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink ListWebsiteCertificateAuthorities API operation.", Operation = new[] {"ListWebsiteCertificateAuthorities"})]
    [AWSCmdletOutput("Amazon.WorkLink.Model.WebsiteCaSummary",
        "This cmdlet returns a collection of WebsiteCaSummary objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.WebsiteCertificateAuthorities;
