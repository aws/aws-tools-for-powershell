...
namespace Amazon.PowerShell.Cmdlets.WL
{
    ...
    [AWSCmdlet("Calls the Amazon WorkLink DisassociateWebsiteCertificateAuthority API operation.", Operation = new[] {"DisassociateWebsiteCertificateAuthority"})]
    ...
    public partial class UnregisterWLWebsiteCertificateAuthorityCmdlet : AmazonWorkLinkClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WLWebsiteCertificateAuthority (DisassociateWebsiteCertificateAuthority)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkLink.Model.DisassociateWebsiteCertificateAuthorityRequest();
        ...
        private Amazon.WorkLink.Model.DisassociateWebsiteCertificateAuthorityResponse CallAWSServiceOperation(IAmazonWorkLink client, Amazon.WorkLink.Model.DisassociateWebsiteCertificateAuthorityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkLink", "DisassociateWebsiteCertificateAuthority");
            try
            {
                #if DESKTOP
                return client.DisassociateWebsiteCertificateAuthority(request);
                #elif CORECLR
                return client.DisassociateWebsiteCertificateAuthorityAsync(request).GetAwaiter().GetResult();
                #else
