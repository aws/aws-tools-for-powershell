...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    [AWSCmdletOutput("Amazon.Schemas.Model.StartDiscovererResponse",
        "This cmdlet returns an Amazon.Schemas.Model.StartDiscovererResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
