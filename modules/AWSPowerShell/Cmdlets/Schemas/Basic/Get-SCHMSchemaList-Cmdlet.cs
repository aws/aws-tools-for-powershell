...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    [AWSCmdletOutput("Amazon.Schemas.Model.SchemaSummary or Amazon.Schemas.Model.ListSchemasResponse",
        ...
        "The service call response (type Amazon.Schemas.Model.ListSchemasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
