...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// Deletes a Registry.
    /// </summary>
    [Cmdlet("Remove", "SCHMRegistry", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon EventBridge Schema Registry DeleteRegistry API operation.", Operation = new[] {"DeleteRegistry"}, SelectReturnType = typeof(Amazon.Schemas.Model.DeleteRegistryResponse))]
    [AWSCmdletOutput("None or Amazon.Schemas.Model.DeleteRegistryResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Schemas.Model.DeleteRegistryResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSCHMRegistryCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCHMRegistry (DeleteRegistry)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.DeleteRegistryResponse, RemoveSCHMRegistryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.DeleteRegistryRequest();
        ...
        private Amazon.Schemas.Model.DeleteRegistryResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.DeleteRegistryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "DeleteRegistry");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String RegistryName { get; set; }
            public System.Func<Amazon.Schemas.Model.DeleteRegistryResponse, RemoveSCHMRegistryCmdlet, object> Select { get; set; } =
