...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SCHMSchema")]
    [OutputType("Amazon.Schemas.Model.DescribeSchemaResponse")]
    [AWSCmdlet("Calls the Amazon EventBridge Schema Registry DescribeSchema API operation.", Operation = new[] {"DescribeSchema"}, SelectReturnType = typeof(Amazon.Schemas.Model.DescribeSchemaResponse))]
    [AWSCmdletOutput("Amazon.Schemas.Model.DescribeSchemaResponse",
        "This cmdlet returns an Amazon.Schemas.Model.DescribeSchemaResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSCHMSchemaCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.DescribeSchemaResponse, GetSCHMSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.DescribeSchemaRequest();
        ...
        private Amazon.Schemas.Model.DescribeSchemaResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.DescribeSchemaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "DescribeSchema");
            try
            {
                #if DESKTOP
                return client.DescribeSchema(request);
                #elif CORECLR
                return client.DescribeSchemaAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SchemaName { get; set; }
            public System.String SchemaVersion { get; set; }
            public System.Func<Amazon.Schemas.Model.DescribeSchemaResponse, GetSCHMSchemaCmdlet, object> Select { get; set; } =
