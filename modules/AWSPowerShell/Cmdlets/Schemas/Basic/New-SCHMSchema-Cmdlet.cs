...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("New", "SCHMSchema", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Schemas.Model.CreateSchemaResponse")]
    [AWSCmdlet("Calls the Amazon EventBridge Schema Registry CreateSchema API operation.", Operation = new[] {"CreateSchema"}, SelectReturnType = typeof(Amazon.Schemas.Model.CreateSchemaResponse))]
    [AWSCmdletOutput("Amazon.Schemas.Model.CreateSchemaResponse",
        "This cmdlet returns an Amazon.Schemas.Model.CreateSchemaResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSCHMSchemaCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SCHMSchema (CreateSchema)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.CreateSchemaResponse, NewSCHMSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.CreateSchemaRequest();
        ...
        private Amazon.Schemas.Model.CreateSchemaResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.CreateSchemaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "CreateSchema");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Schemas.Type Type { get; set; }
            public System.Func<Amazon.Schemas.Model.CreateSchemaResponse, NewSCHMSchemaCmdlet, object> Select { get; set; } =
