...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SCHMResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSCHMResourceTagCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Keys of key-value pairs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCHMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.UntagResourceResponse, RemoveSCHMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.UntagResourceRequest();
        ...
        private Amazon.Schemas.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Schemas.Model.UntagResourceResponse, RemoveSCHMResourceTagCmdlet, object> Select { get; set; } =
