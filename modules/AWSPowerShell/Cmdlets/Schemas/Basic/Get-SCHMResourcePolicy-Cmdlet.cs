...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    public partial class GetSCHMResourcePolicyCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.GetResourcePolicyResponse, GetSCHMResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.GetResourcePolicyRequest();
        ...
        private Amazon.Schemas.Model.GetResourcePolicyResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.GetResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "GetResourcePolicy");
            try
            {
        ...
        {
            public System.String RegistryName { get; set; }
            public System.Func<Amazon.Schemas.Model.GetResourcePolicyResponse, GetSCHMResourcePolicyCmdlet, object> Select { get; set; } =
