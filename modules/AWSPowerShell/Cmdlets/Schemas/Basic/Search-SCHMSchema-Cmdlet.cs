...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("Search", "SCHMSchema")]
    [OutputType("Amazon.Schemas.Model.SearchSchemaSummary")]
    [AWSCmdlet("Calls the Amazon EventBridge Schema Registry SearchSchemas API operation.", Operation = new[] {"SearchSchemas"}, SelectReturnType = typeof(Amazon.Schemas.Model.SearchSchemasResponse))]
    [AWSCmdletOutput("Amazon.Schemas.Model.SearchSchemaSummary or Amazon.Schemas.Model.SearchSchemasResponse",
        "This cmdlet returns a collection of Amazon.Schemas.Model.SearchSchemaSummary objects.",
        "The service call response (type Amazon.Schemas.Model.SearchSchemasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchSCHMSchemaCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.SearchSchemasResponse, SearchSCHMSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Schemas.Model.SearchSchemasRequest();
        ...
        private Amazon.Schemas.Model.SearchSchemasResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.SearchSchemasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "SearchSchemas");
            try
            {
                #if DESKTOP
                return client.SearchSchemas(request);
                #elif CORECLR
                return client.SearchSchemasAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RegistryName { get; set; }
            public System.Func<Amazon.Schemas.Model.SearchSchemasResponse, SearchSCHMSchemaCmdlet, object> Select { get; set; } =
