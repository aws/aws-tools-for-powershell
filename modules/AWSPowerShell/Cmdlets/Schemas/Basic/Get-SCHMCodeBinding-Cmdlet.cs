...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    public partial class GetSCHMCodeBindingCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.DescribeCodeBindingResponse, GetSCHMCodeBindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.DescribeCodeBindingRequest();
        ...
        private Amazon.Schemas.Model.DescribeCodeBindingResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.DescribeCodeBindingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "DescribeCodeBinding");
            try
            {
                #if DESKTOP
                return client.DescribeCodeBinding(request);
                #elif CORECLR
                return client.DescribeCodeBindingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SchemaName { get; set; }
            public System.String SchemaVersion { get; set; }
            public System.Func<Amazon.Schemas.Model.DescribeCodeBindingResponse, GetSCHMCodeBindingCmdlet, object> Select { get; set; } =
