...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("Stop", "SCHMDiscoverer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopSCHMDiscovererCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-SCHMDiscoverer (StopDiscoverer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.StopDiscovererResponse, StopSCHMDiscovererCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.StopDiscovererRequest();
        ...
        private Amazon.Schemas.Model.StopDiscovererResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.StopDiscovererRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "StopDiscoverer");
            try
            {
                #if DESKTOP
                return client.StopDiscoverer(request);
                #elif CORECLR
                return client.StopDiscovererAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DiscovererId { get; set; }
            public System.Func<Amazon.Schemas.Model.StopDiscovererResponse, StopSCHMDiscovererCmdlet, object> Select { get; set; } =
