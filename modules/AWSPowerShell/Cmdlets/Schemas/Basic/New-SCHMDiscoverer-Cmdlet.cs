...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("New", "SCHMDiscoverer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewSCHMDiscovererCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SCHMDiscoverer (CreateDiscoverer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.CreateDiscovererResponse, NewSCHMDiscovererCmdlet>(Select) ??
        ...
        private Amazon.Schemas.Model.CreateDiscovererResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.CreateDiscovererRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "CreateDiscoverer");
            try
            {
                return client.CreateDiscovererAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Schemas.Model.CreateDiscovererResponse, NewSCHMDiscovererCmdlet, object> Select { get; set; } =
