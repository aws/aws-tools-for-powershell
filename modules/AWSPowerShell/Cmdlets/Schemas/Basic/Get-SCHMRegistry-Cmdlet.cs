...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    public partial class GetSCHMRegistryCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.DescribeRegistryResponse, GetSCHMRegistryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.DescribeRegistryRequest();
        ...
        private Amazon.Schemas.Model.DescribeRegistryResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.DescribeRegistryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "DescribeRegistry");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String RegistryName { get; set; }
            public System.Func<Amazon.Schemas.Model.DescribeRegistryResponse, GetSCHMRegistryCmdlet, object> Select { get; set; } =
