...
namespace Amazon.PowerShell.Cmdlets.SCHM
{
    ...
    /// </summary>
    [Cmdlet("Write", "SCHMCodeBinding", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Schemas.Model.PutCodeBindingResponse")]
    [AWSCmdlet("Calls the Amazon EventBridge Schema Registry PutCodeBinding API operation.", Operation = new[] {"PutCodeBinding"}, SelectReturnType = typeof(Amazon.Schemas.Model.PutCodeBindingResponse))]
    [AWSCmdletOutput("Amazon.Schemas.Model.PutCodeBindingResponse",
        "This cmdlet returns an Amazon.Schemas.Model.PutCodeBindingResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteSCHMCodeBindingCmdlet : AmazonSchemasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-SCHMCodeBinding (PutCodeBinding)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Schemas.Model.PutCodeBindingResponse, WriteSCHMCodeBindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Schemas.Model.PutCodeBindingRequest();
        ...
        private Amazon.Schemas.Model.PutCodeBindingResponse CallAWSServiceOperation(IAmazonSchemas client, Amazon.Schemas.Model.PutCodeBindingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EventBridge Schema Registry", "PutCodeBinding");
            try
            {
                #if DESKTOP
                return client.PutCodeBinding(request);
                #elif CORECLR
                return client.PutCodeBindingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SchemaName { get; set; }
            public System.String SchemaVersion { get; set; }
            public System.Func<Amazon.Schemas.Model.PutCodeBindingResponse, WriteSCHMCodeBindingCmdlet, object> Select { get; set; } =
