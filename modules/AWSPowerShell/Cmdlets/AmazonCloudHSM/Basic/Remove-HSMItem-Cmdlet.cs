...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS Cloud HSM DeleteHsm API operation.", Operation = new[] {"DeleteHsm"})]
    ...
    public partial class RemoveHSMItemCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM", "DeleteHsm");
            try
            {
                #if DESKTOP
