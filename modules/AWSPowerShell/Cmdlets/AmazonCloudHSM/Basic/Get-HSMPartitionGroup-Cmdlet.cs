...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS Cloud HSM DescribeHapg API operation.", Operation = new[] {"DescribeHapg"})]
    ...
    public partial class GetHSMPartitionGroupCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM", "DescribeHapg");
            try
            {
                #if DESKTOP
