...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS Cloud HSM CreateHapg API operation.", Operation = new[] {"CreateHapg"})]
    ...
    public partial class NewHSMPartitionGroupCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM", "CreateHapg");
            try
            {
                #if DESKTOP
