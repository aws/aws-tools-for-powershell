...
namespace Amazon.PowerShell.Cmdlets.HSM
{
    ...
    [AWSCmdlet("Calls the AWS Cloud HSM ModifyLunaClient API operation.", Operation = new[] {"ModifyLunaClient"})]
    ...
    public partial class EditHSMLunaClientCmdlet : AmazonCloudHSMClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud HSM", "ModifyLunaClient");
            try
            {
                #if DESKTOP
                ...
                var task = client.ModifyLunaClientAsync(request);
                return task.Result;
                #else
