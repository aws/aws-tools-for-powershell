...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    public partial class AddMHCreatedArtifactCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^CreatedArtifact' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.CreatedArtifact;
            }
