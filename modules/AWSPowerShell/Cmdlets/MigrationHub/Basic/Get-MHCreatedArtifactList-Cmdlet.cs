...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    [AWSCmdlet("Calls the AWS Migration Hub ListCreatedArtifacts API operation.", Operation = new[] {"ListCreatedArtifacts"}, SelectReturnType = typeof(Amazon.MigrationHub.Model.ListCreatedArtifactsResponse))]
    [AWSCmdletOutput("Amazon.MigrationHub.Model.CreatedArtifact or Amazon.MigrationHub.Model.ListCreatedArtifactsResponse",
        "This cmdlet returns a collection of Amazon.MigrationHub.Model.CreatedArtifact objects.",
        "The service call response (type Amazon.MigrationHub.Model.ListCreatedArtifactsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMHCreatedArtifactListCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CreatedArtifactList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHub.Model.ListCreatedArtifactsResponse, GetMHCreatedArtifactListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MigrationHub.Model.ListCreatedArtifactsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.CreatedArtifactList?.Count ?? 0;
        ...
        private Amazon.MigrationHub.Model.ListCreatedArtifactsResponse CallAWSServiceOperation(IAmazonMigrationHub client, Amazon.MigrationHub.Model.ListCreatedArtifactsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub", "ListCreatedArtifacts");
            try
            {
                #if DESKTOP
                return client.ListCreatedArtifacts(request);
                #elif CORECLR
                return client.ListCreatedArtifactsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProgressUpdateStream { get; set; }
            public System.Func<Amazon.MigrationHub.Model.ListCreatedArtifactsResponse, GetMHCreatedArtifactListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CreatedArtifactList;
        }
