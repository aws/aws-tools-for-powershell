...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    /// <c>MigrationTaskName</c> and <c>ProgressUpdateStream</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "MHMigrationTaskUpdateList")]
    [OutputType("Amazon.MigrationHub.Model.MigrationTaskUpdate")]
    [AWSCmdlet("Calls the AWS Migration Hub ListMigrationTaskUpdates API operation.", Operation = new[] {"ListMigrationTaskUpdates"}, SelectReturnType = typeof(Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse))]
    [AWSCmdletOutput("Amazon.MigrationHub.Model.MigrationTaskUpdate or Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse",
        "This cmdlet returns a collection of Amazon.MigrationHub.Model.MigrationTaskUpdate objects.",
        "The service call response (type Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMHMigrationTaskUpdateListCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'MigrationTaskUpdateList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse).
        /// Specifying the name of a property of type Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MigrationTaskUpdateList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse, GetMHMigrationTaskUpdateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MigrationHub.Model.ListMigrationTaskUpdatesRequest();
        ...
        private Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse CallAWSServiceOperation(IAmazonMigrationHub client, Amazon.MigrationHub.Model.ListMigrationTaskUpdatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub", "ListMigrationTaskUpdates");
            try
            {
                #if DESKTOP
                return client.ListMigrationTaskUpdates(request);
                #elif CORECLR
                return client.ListMigrationTaskUpdatesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ProgressUpdateStream { get; set; }
            public System.Func<Amazon.MigrationHub.Model.ListMigrationTaskUpdatesResponse, GetMHMigrationTaskUpdateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MigrationTaskUpdateList;
        }
