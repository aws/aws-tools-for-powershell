...
namespace Amazon.PowerShell.Cmdlets.MH
{
    ...
    public partial class AddMHDiscoveredResourceCmdlet : AmazonMigrationHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DiscoveredResource' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHub.Model.AssociateDiscoveredResourceResponse, AddMHDiscoveredResourceCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DiscoveredResource;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.DiscoveredResource = this.DiscoveredResource;
            #if MODULAR
            if (this.DiscoveredResource == null && ParameterWasBound(nameof(this.DiscoveredResource)))
            {
                WriteWarning("You are passing $null as a value for parameter DiscoveredResource which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.MigrationHub.Model.AssociateDiscoveredResourceResponse CallAWSServiceOperation(IAmazonMigrationHub client, Amazon.MigrationHub.Model.AssociateDiscoveredResourceRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.AssociateDiscoveredResourceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MigrationTaskName { get; set; }
            public System.String ProgressUpdateStream { get; set; }
            public System.Func<Amazon.MigrationHub.Model.AssociateDiscoveredResourceResponse, AddMHDiscoveredResourceCmdlet, object> Select { get; set; } =
