...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Invokes the EnableRadius operation against AWS Directory Service.", Operation = new[] {"EnableRadius"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type EnableRadiusResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class EnableDSRadiusCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the directory to enable MFA for.</para>
        /// </para>
        /// </summary>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new EnableRadiusRequest();
            ...
            try
            {
                var response = client.EnableRadius(request);
