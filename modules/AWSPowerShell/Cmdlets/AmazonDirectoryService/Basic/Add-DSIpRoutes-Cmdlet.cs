...
namespace Amazon.PowerShell.Cmdlets.DS
{
    ...
    [AWSCmdlet("Invokes the AddIpRoutes operation against AWS Directory Service.", Operation = new[] {"AddIpRoutes"})]
    ...
    public partial class AddDSIpRoutesCmdlet : AmazonDirectoryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-DSIpRoutes (AddIpRoutes)"))
            {
                return;
            }
