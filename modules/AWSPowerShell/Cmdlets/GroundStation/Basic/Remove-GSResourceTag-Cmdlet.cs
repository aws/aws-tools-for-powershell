...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveGSResourceTagCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Keys of a resource tag.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.UntagResourceResponse, RemoveGSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.UntagResourceRequest();
        ...
        private Amazon.GroundStation.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GroundStation.Model.UntagResourceResponse, RemoveGSResourceTagCmdlet, object> Select { get; set; } =
