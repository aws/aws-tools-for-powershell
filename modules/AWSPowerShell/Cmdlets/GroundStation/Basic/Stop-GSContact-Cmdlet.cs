...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    [AWSCmdlet("Calls the AWS Ground Station CancelContact API operation.", Operation = new[] {"CancelContact"}, SelectReturnType = typeof(Amazon.GroundStation.Model.CancelContactResponse))]
    [AWSCmdletOutput("System.String or Amazon.GroundStation.Model.CancelContactResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.GroundStation.Model.CancelContactResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopGSContactCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-GSContact (CancelContact)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.CancelContactResponse, StopGSContactCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.CancelContactRequest();
        ...
        private Amazon.GroundStation.Model.CancelContactResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.CancelContactRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "CancelContact");
            try
            {
                #if DESKTOP
                return client.CancelContact(request);
                #elif CORECLR
                return client.CancelContactAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContactId { get; set; }
            public System.Func<Amazon.GroundStation.Model.CancelContactResponse, StopGSContactCmdlet, object> Select { get; set; } =
