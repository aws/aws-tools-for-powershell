...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    /// </summary>
    [Cmdlet("Get", "GSDataflowEndpointGroup")]
    [OutputType("Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse")]
    [AWSCmdlet("Calls the AWS Ground Station GetDataflowEndpointGroup API operation.", Operation = new[] {"GetDataflowEndpointGroup"}, SelectReturnType = typeof(Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse))]
    [AWSCmdletOutput("Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse",
        "This cmdlet returns an Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGSDataflowEndpointGroupCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse, GetGSDataflowEndpointGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.GetDataflowEndpointGroupRequest();
        ...
        private Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.GetDataflowEndpointGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "GetDataflowEndpointGroup");
            try
            {
                #if DESKTOP
                return client.GetDataflowEndpointGroup(request);
                #elif CORECLR
                return client.GetDataflowEndpointGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DataflowEndpointGroupId { get; set; }
            public System.Func<Amazon.GroundStation.Model.GetDataflowEndpointGroupResponse, GetGSDataflowEndpointGroupCmdlet, object> Select { get; set; } =
