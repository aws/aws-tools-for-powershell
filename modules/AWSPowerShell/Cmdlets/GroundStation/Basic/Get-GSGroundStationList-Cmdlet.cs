...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    /// </summary>
    [Cmdlet("Get", "GSGroundStationList")]
    [OutputType("Amazon.GroundStation.Model.GroundStationData")]
    [AWSCmdlet("Calls the AWS Ground Station ListGroundStations API operation.", Operation = new[] {"ListGroundStations"}, SelectReturnType = typeof(Amazon.GroundStation.Model.ListGroundStationsResponse))]
    [AWSCmdletOutput("Amazon.GroundStation.Model.GroundStationData or Amazon.GroundStation.Model.ListGroundStationsResponse",
        "This cmdlet returns a collection of Amazon.GroundStation.Model.GroundStationData objects.",
        "The service call response (type Amazon.GroundStation.Model.ListGroundStationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGSGroundStationListCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.GroundStationList?.Count ?? 0;
        ...
        private Amazon.GroundStation.Model.ListGroundStationsResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.ListGroundStationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "ListGroundStations");
            try
            {
                #if DESKTOP
                return client.ListGroundStations(request);
                #elif CORECLR
                return client.ListGroundStationsAsync(request).GetAwaiter().GetResult();
                #else
