...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    /// Returns a satellite.
    /// </summary>
    [Cmdlet("Get", "GSSatellite")]
    [OutputType("Amazon.GroundStation.Model.GetSatelliteResponse")]
    [AWSCmdlet("Calls the AWS Ground Station GetSatellite API operation.", Operation = new[] {"GetSatellite"}, SelectReturnType = typeof(Amazon.GroundStation.Model.GetSatelliteResponse))]
    [AWSCmdletOutput("Amazon.GroundStation.Model.GetSatelliteResponse",
        "This cmdlet returns an Amazon.GroundStation.Model.GetSatelliteResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGSSatelliteCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.GetSatelliteResponse, GetGSSatelliteCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.GetSatelliteRequest();
        ...
        private Amazon.GroundStation.Model.GetSatelliteResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.GetSatelliteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "GetSatellite");
            try
            {
                #if DESKTOP
                return client.GetSatellite(request);
                #elif CORECLR
                return client.GetSatelliteAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SatelliteId { get; set; }
            public System.Func<Amazon.GroundStation.Model.GetSatelliteResponse, GetGSSatelliteCmdlet, object> Select { get; set; } =
