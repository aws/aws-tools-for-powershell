...
namespace Amazon.PowerShell.Cmdlets.GS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GSMissionProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Ground Station DeleteMissionProfile API operation.", Operation = new[] {"DeleteMissionProfile"}, SelectReturnType = typeof(Amazon.GroundStation.Model.DeleteMissionProfileResponse))]
    [AWSCmdletOutput("System.String or Amazon.GroundStation.Model.DeleteMissionProfileResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.GroundStation.Model.DeleteMissionProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGSMissionProfileCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GSMissionProfile (DeleteMissionProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.DeleteMissionProfileResponse, RemoveGSMissionProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.DeleteMissionProfileRequest();
        ...
        private Amazon.GroundStation.Model.DeleteMissionProfileResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.DeleteMissionProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "DeleteMissionProfile");
            try
            {
                #if DESKTOP
                return client.DeleteMissionProfile(request);
                #elif CORECLR
                return client.DeleteMissionProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MissionProfileId { get; set; }
            public System.Func<Amazon.GroundStation.Model.DeleteMissionProfileResponse, RemoveGSMissionProfileCmdlet, object> Select { get; set; } =
