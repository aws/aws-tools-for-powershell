...
{
    /// <summary>
    /// Amazon.GroundStation.IAmazonGroundStation.GetAgentConfiguration
    /// </summary>
    ...
    public partial class GetGSAgentConfigurationCmdlet : AmazonGroundStationClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>UUID of agent to get configuration information for.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.GroundStation.Model.GetAgentConfigurationResponse).
        /// Specifying the name of a property of type Amazon.GroundStation.Model.GetAgentConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GroundStation.Model.GetAgentConfigurationResponse, GetGSAgentConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GroundStation.Model.GetAgentConfigurationRequest();
        ...
        private Amazon.GroundStation.Model.GetAgentConfigurationResponse CallAWSServiceOperation(IAmazonGroundStation client, Amazon.GroundStation.Model.GetAgentConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Ground Station", "GetAgentConfiguration");
            try
            {
                #if DESKTOP
                return client.GetAgentConfiguration(request);
                #elif CORECLR
                return client.GetAgentConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AgentId { get; set; }
            public System.Func<Amazon.GroundStation.Model.GetAgentConfigurationResponse, GetGSAgentConfigurationCmdlet, object> Select { get; set; } =
