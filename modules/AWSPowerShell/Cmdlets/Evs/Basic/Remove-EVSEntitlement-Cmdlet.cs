...
namespace Amazon.PowerShell.Cmdlets.EVS
{
    ...
    /// machines.
    /// </summary>
    [Cmdlet("Remove", "EVSEntitlement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Evs.Model.VmEntitlement")]
    [AWSCmdlet("Calls the Amazon Elastic VMware Service DeleteEntitlement API operation.", Operation = new[] {"DeleteEntitlement"}, SelectReturnType = typeof(Amazon.Evs.Model.DeleteEntitlementResponse))]
    [AWSCmdletOutput("Amazon.Evs.Model.VmEntitlement or Amazon.Evs.Model.DeleteEntitlementResponse",
        "This cmdlet returns a collection of Amazon.Evs.Model.VmEntitlement objects.",
        "The service call response (type Amazon.Evs.Model.DeleteEntitlementResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveEVSEntitlementCmdlet : AmazonEvsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of entitlement to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A unique ID for the environment that the entitlement belongs to.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The list of VMware vSphere virtual machine managed object IDs to delete entitlements
        /// for.</para><para />
        ...
        /// the entitlement deletion request. If you do not specify a client token, a randomly
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Evs.Model.DeleteEntitlementResponse).
        /// Specifying the name of a property of type Amazon.Evs.Model.DeleteEntitlementResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EVSEntitlement (DeleteEntitlement)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Evs.Model.DeleteEntitlementResponse, RemoveEVSEntitlementCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Evs.Model.DeleteEntitlementRequest();
        ...
        private Amazon.Evs.Model.DeleteEntitlementResponse CallAWSServiceOperation(IAmazonEvs client, Amazon.Evs.Model.DeleteEntitlementRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic VMware Service", "DeleteEntitlement");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Evs.Model.DeleteEntitlementResponse, RemoveEVSEntitlementCmdlet, object> Select { get; set; } =
