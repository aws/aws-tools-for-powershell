...
namespace Amazon.PowerShell.Cmdlets.EVS
{
    ...
    /// specified environment and connector.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "EVSVmEntitlementList")]
    [OutputType("Amazon.Evs.Model.VmEntitlement")]
    [AWSCmdlet("Calls the Amazon Elastic VMware Service ListVmEntitlements API operation.", Operation = new[] {"ListVmEntitlements"}, SelectReturnType = typeof(Amazon.Evs.Model.ListVmEntitlementsResponse))]
    [AWSCmdletOutput("Amazon.Evs.Model.VmEntitlement or Amazon.Evs.Model.ListVmEntitlementsResponse",
        "This cmdlet returns a collection of Amazon.Evs.Model.VmEntitlement objects.",
        "The service call response (type Amazon.Evs.Model.ListVmEntitlementsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEVSVmEntitlementListCmdlet : AmazonEvsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A unique ID for the connector.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The type of entitlement to list.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Evs.Model.ListVmEntitlementsResponse).
        /// Specifying the name of a property of type Amazon.Evs.Model.ListVmEntitlementsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Evs.Model.ListVmEntitlementsResponse, GetEVSVmEntitlementListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Evs.Model.ListVmEntitlementsRequest();
        ...
        private Amazon.Evs.Model.ListVmEntitlementsResponse CallAWSServiceOperation(IAmazonEvs client, Amazon.Evs.Model.ListVmEntitlementsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic VMware Service", "ListVmEntitlements");
            try
            {
                return client.ListVmEntitlementsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Evs.Model.ListVmEntitlementsResponse, GetEVSVmEntitlementListCmdlet, object> Select { get; set; } =
