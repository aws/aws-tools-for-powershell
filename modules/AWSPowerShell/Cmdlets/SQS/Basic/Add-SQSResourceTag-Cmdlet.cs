...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Queue Service (SQS) TagQueue API operation.", Operation = new[] {"TagQueue"}, SelectReturnType = typeof(Amazon.SQS.Model.TagQueueResponse))]
    [AWSCmdletOutput("None or Amazon.SQS.Model.TagQueueResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SQS.Model.TagQueueResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddSQSResourceTagCmdlet : AmazonSQSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of tags to be added to the specified queue.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SQS.Model.TagQueueResponse, AddSQSResourceTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Queue Service (SQS)", "TagQueue");
            try
            {
                return client.TagQueueAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SQS.Model.TagQueueResponse, AddSQSResourceTagCmdlet, object> Select { get; set; } =
