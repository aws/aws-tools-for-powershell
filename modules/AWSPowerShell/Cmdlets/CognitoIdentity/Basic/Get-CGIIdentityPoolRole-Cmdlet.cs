...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity GetIdentityPoolRoles API operation.", Operation = new[] {"GetIdentityPoolRoles"}, SelectReturnType = typeof(Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse",
        "This cmdlet returns an Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCGIIdentityPoolRoleCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse, GetCGIIdentityPoolRoleCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.GetIdentityPoolRolesRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetIdentityPoolRolesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String IdentityPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentity.Model.GetIdentityPoolRolesResponse, GetCGIIdentityPoolRoleCmdlet, object> Select { get; set; } =
