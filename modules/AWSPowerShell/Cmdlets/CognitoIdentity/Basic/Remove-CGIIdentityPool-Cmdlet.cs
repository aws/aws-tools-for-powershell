...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    public partial class RemoveCGIIdentityPoolCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentity.Model.DeleteIdentityPoolResponse, RemoveCGIIdentityPoolCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentity.Model.DeleteIdentityPoolResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.DeleteIdentityPoolRequest request)
        {
            ...
            try
            {
                return client.DeleteIdentityPoolAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String IdentityPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentity.Model.DeleteIdentityPoolResponse, RemoveCGIIdentityPoolCmdlet, object> Select { get; set; } =
