...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "CGIIdentityPool")]
    [OutputType("Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse")]
    [AWSCmdlet("Calls the Amazon Cognito Identity DescribeIdentityPool API operation.", Operation = new[] {"DescribeIdentityPool"}, SelectReturnType = typeof(Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse",
        "This cmdlet returns an Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCGIIdentityPoolCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse, GetCGIIdentityPoolCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.DescribeIdentityPoolRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity", "DescribeIdentityPool");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String IdentityPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentity.Model.DescribeIdentityPoolResponse, GetCGIIdentityPoolCmdlet, object> Select { get; set; } =
