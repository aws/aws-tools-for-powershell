...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "CGIResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddCGIResourceTagCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to assign to the identity pool.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CGIResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentity.Model.TagResourceResponse, AddCGIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentity.Model.TagResourceRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CognitoIdentity.Model.TagResourceResponse, AddCGIResourceTagCmdlet, object> Select { get; set; } =
