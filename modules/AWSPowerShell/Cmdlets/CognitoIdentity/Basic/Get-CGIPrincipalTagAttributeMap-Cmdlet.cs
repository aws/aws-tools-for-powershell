...
namespace Amazon.PowerShell.Cmdlets.CGI
{
    ...
    public partial class GetCGIPrincipalTagAttributeMapCmdlet : AmazonCognitoIdentityClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentity.Model.GetPrincipalTagAttributeMapResponse, GetCGIPrincipalTagAttributeMapCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentity.Model.GetPrincipalTagAttributeMapRequest();
        ...
        private Amazon.CognitoIdentity.Model.GetPrincipalTagAttributeMapResponse CallAWSServiceOperation(IAmazonCognitoIdentity client, Amazon.CognitoIdentity.Model.GetPrincipalTagAttributeMapRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity", "GetPrincipalTagAttributeMap");
            try
            {
                #if DESKTOP
                return client.GetPrincipalTagAttributeMap(request);
                #elif CORECLR
                return client.GetPrincipalTagAttributeMapAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String IdentityPoolId { get; set; }
            public System.String IdentityProviderName { get; set; }
            public System.Func<Amazon.CognitoIdentity.Model.GetPrincipalTagAttributeMapResponse, GetCGIPrincipalTagAttributeMapCmdlet, object> Select { get; set; } =
