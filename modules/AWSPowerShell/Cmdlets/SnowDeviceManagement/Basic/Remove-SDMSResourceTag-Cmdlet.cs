...
namespace Amazon.PowerShell.Cmdlets.SDMS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SDMSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSDMSResourceTagCmdlet : AmazonSnowDeviceManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SDMSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SnowDeviceManagement.Model.UntagResourceResponse, RemoveSDMSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SnowDeviceManagement.Model.UntagResourceRequest();
        ...
        private Amazon.SnowDeviceManagement.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonSnowDeviceManagement client, Amazon.SnowDeviceManagement.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Snow Device Management", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.SnowDeviceManagement.Model.UntagResourceResponse, RemoveSDMSResourceTagCmdlet, object> Select { get; set; } =
