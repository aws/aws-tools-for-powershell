...
namespace Amazon.PowerShell.Cmdlets.SDMS
{
    ...
    [AWSCmdletOutput("System.String or Amazon.SnowDeviceManagement.Model.CreateTaskResponse",
        ...
        "The service call response (type Amazon.SnowDeviceManagement.Model.CreateTaskResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewSDMSTaskCmdlet : AmazonSnowDeviceManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of managed device IDs.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
