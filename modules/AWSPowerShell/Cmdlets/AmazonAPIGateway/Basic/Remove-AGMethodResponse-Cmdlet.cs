...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the DeleteMethodResponse operation against Amazon API Gateway.", Operation = new[] {"DeleteMethodResponse"})]
    ...
    public class RemoveAGMethodResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteMethodResponse(request);
