...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Get", "AGDocumentationVersionList")]
    [OutputType("Amazon.APIGateway.Model.DocumentationVersion")]
    [AWSCmdlet("Invokes the GetDocumentationVersions operation against Amazon API Gateway.", Operation = new[] {"GetDocumentationVersions"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.DocumentationVersion",
        "This cmdlet returns a collection of DocumentationVersion objects.",
    ...
    public partial class GetAGDocumentationVersionListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The position of the returned <code>DocumentationVersion</code> in the <a>DocumentationVersions</a>
        /// collection.</para>
        /// </para>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetDocumentationVersionsRequest();
        ...
        private static Amazon.APIGateway.Model.GetDocumentationVersionsResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetDocumentationVersionsRequest request)
        {
            ...
            var task = client.GetDocumentationVersionsAsync(request);
            return task.Result;
            #else
