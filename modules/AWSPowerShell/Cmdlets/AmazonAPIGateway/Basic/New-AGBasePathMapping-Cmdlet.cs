...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the CreateBasePathMapping operation against Amazon API Gateway.", Operation = new[] {"CreateBasePathMapping"})]
    ...
    public class NewAGBasePathMappingCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.CreateBasePathMapping(request);
