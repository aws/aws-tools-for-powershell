...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the UpdateDomainName operation against Amazon API Gateway.", Operation = new[] {"UpdateDomainName"})]
    ...
    public class UpdateAGDomainNameCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.UpdateDomainNameResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateDomainNameRequest request)
        {
