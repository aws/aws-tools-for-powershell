...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the GetRequestValidator operation against Amazon API Gateway.", Operation = new[] {"GetRequestValidator"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.GetRequestValidatorResponse",
        "This cmdlet returns a Amazon.APIGateway.Model.GetRequestValidatorResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAGRequestValidatorCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>[Required] The identifier of the <a>RestApi</a> to which the specified <a>RequestValidator</a>
        /// belongs.</para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.APIGateway.Model.GetRequestValidatorResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetRequestValidatorRequest request)
        {
            #if DESKTOP
            return client.GetRequestValidator(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetRequestValidatorAsync(request);
            return task.Result;
            #else
