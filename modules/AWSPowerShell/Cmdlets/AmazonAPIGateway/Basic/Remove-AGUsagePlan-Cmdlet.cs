...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AGUsagePlan", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteUsagePlan API operation.", Operation = new[] {"DeleteUsagePlan"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the UsagePlanId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveAGUsagePlanCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AGUsagePlan (DeleteUsagePlan)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.DeleteUsagePlanRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.UsagePlanId;
        ...
        private Amazon.APIGateway.Model.DeleteUsagePlanResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteUsagePlanRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteUsagePlanAsync(request).GetAwaiter().GetResult();
                #else
