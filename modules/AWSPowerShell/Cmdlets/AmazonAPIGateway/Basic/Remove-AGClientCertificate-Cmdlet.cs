...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the DeleteClientCertificate operation against Amazon API Gateway.", Operation = new[] {"DeleteClientCertificate"})]
    ...
    public class RemoveAGClientCertificateCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.DeleteClientCertificateResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteClientCertificateRequest request)
        {
