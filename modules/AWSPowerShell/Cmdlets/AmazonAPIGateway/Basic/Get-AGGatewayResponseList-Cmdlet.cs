...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the GetGatewayResponses operation against Amazon API Gateway.", Operation = new[] {"GetGatewayResponses"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.GatewayResponse",
        "This cmdlet returns a collection of GatewayResponse objects.",
    ...
    public partial class GetAGGatewayResponseListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.GetGatewayResponsesResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetGatewayResponsesRequest request)
        {
            ...
            var task = client.GetGatewayResponsesAsync(request);
            return task.Result;
            #else
