...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Get", "AGVpcLinkList")]
    [OutputType("Amazon.APIGateway.Model.VpcLink")]
    [AWSCmdlet("Calls the Amazon API Gateway GetVpcLinks API operation.", Operation = new[] {"GetVpcLinks"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.VpcLink",
        "This cmdlet returns a collection of VpcLink objects.",
        "The service call response (type Amazon.APIGateway.Model.GetVpcLinksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetAGVpcLinkListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetVpcLinksRequest();
            ...
            bool _userControllingPaging = ParameterWasBound("Position") || ParameterWasBound("Limit");
        ...
        private Amazon.APIGateway.Model.GetVpcLinksResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetVpcLinksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetVpcLinks");
            try
            {
                #if DESKTOP
                return client.GetVpcLinks(request);
                #elif CORECLR
                return client.GetVpcLinksAsync(request).GetAwaiter().GetResult();
                #else
