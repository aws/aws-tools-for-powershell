...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the CreateDocumentationPart operation against Amazon API Gateway.", Operation = new[] {"CreateDocumentationPart"})]
    ...
    public partial class NewAGDocumentationPartCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.CreateDocumentationPartResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.CreateDocumentationPartRequest request)
        {
            #if DESKTOP
