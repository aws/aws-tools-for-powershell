...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the DeleteApiKey operation against Amazon API Gateway.", Operation = new[] {"DeleteApiKey"})]
    ...
    public class RemoveAGApiKeyCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.DeleteApiKeyResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteApiKeyRequest request)
        {
