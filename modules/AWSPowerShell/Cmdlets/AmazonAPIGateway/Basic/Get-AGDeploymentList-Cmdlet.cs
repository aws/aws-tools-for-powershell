...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetDeployments API operation.", Operation = new[] {"GetDeployments"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.Deployment",
    ...
    public partial class GetAGDeploymentListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetDeploymentsRequest();
        ...
        private Amazon.APIGateway.Model.GetDeploymentsResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetDeploymentsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDeploymentsAsync(request);
                return task.Result;
                #else
