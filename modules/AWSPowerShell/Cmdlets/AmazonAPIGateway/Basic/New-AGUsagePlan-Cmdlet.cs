...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the CreateUsagePlan operation against Amazon API Gateway.", Operation = new[] {"CreateUsagePlan"})]
    ...
    public partial class NewAGUsagePlanCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.CreateUsagePlanResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.CreateUsagePlanRequest request)
        {
            #if DESKTOP
