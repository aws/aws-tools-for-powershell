...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public class GetAGClientCertificateCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.GetClientCertificateResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetClientCertificateRequest request)
        {
