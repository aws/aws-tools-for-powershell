...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AGDocumentationPart", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteDocumentationPart API operation.", Operation = new[] {"DeleteDocumentationPart"})]
    ...
    public partial class RemoveAGDocumentationPartCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AGDocumentationPart (DeleteDocumentationPart)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.DeleteDocumentationPartRequest();
        ...
        private Amazon.APIGateway.Model.DeleteDocumentationPartResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteDocumentationPartRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteDocumentationPartAsync(request).GetAwaiter().GetResult();
                #else
