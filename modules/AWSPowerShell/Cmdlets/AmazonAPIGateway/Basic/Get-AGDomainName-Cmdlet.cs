...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// be called.
    /// </summary>
    [Cmdlet("Get", "AGDomainName")]
    [OutputType("Amazon.APIGateway.Model.GetDomainNameResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway GetDomainName API operation.", Operation = new[] {"GetDomainName"})]
    ...
    public partial class GetAGDomainNameCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.GetDomainNameRequest();
        ...
        private Amazon.APIGateway.Model.GetDomainNameResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetDomainNameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetDomainName");
            try
            {
                #if DESKTOP
