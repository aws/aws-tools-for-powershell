...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Update", "AGMethodResponse", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.APIGateway.Model.UpdateMethodResponseResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway UpdateMethodResponse API operation.", Operation = new[] {"UpdateMethodResponse"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateMethodResponseResponse",
        "This cmdlet returns a Amazon.APIGateway.Model.UpdateMethodResponseResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAGMethodResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AGMethodResponse (UpdateMethodResponse)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.UpdateMethodResponseRequest();
        ...
        private Amazon.APIGateway.Model.UpdateMethodResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateMethodResponseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "UpdateMethodResponse");
            try
            {
                #if DESKTOP
                return client.UpdateMethodResponse(request);
                #elif CORECLR
                return client.UpdateMethodResponseAsync(request).GetAwaiter().GetResult();
                #else
