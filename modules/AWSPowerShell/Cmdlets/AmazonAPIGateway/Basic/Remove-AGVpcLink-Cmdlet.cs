...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway DeleteVpcLink API operation.", Operation = new[] {"DeleteVpcLink"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the VpcLinkId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveAGVpcLinkCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.DeleteVpcLinkResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteVpcLinkRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteVpcLinkAsync(request);
                return task.Result;
                #else
