...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Get", "AGSdkTypeList")]
    [OutputType("Amazon.APIGateway.Model.SdkType")]
    [AWSCmdlet("Calls the Amazon API Gateway GetSdkTypes API operation.", Operation = new[] {"GetSdkTypes"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.SdkType",
        "This cmdlet returns a collection of SdkType objects.",
    ...
    public partial class GetAGSdkTypeListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetSdkTypesRequest();
        ...
        private Amazon.APIGateway.Model.GetSdkTypesResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetSdkTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetSdkTypes");
            try
            {
                #if DESKTOP
                return client.GetSdkTypes(request);
                #elif CORECLR
                return client.GetSdkTypesAsync(request).GetAwaiter().GetResult();
                #else
