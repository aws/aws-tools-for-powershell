...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class GetAGSdkTypeListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The position of the last fetched element in the <a>SdkTypes</a> collection.</para>
        /// </para>
        /// <para>
        ...
        private static Amazon.APIGateway.Model.GetSdkTypesResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetSdkTypesRequest request)
        {
            #if DESKTOP
