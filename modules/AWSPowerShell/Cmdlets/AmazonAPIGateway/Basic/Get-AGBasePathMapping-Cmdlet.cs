...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the GetBasePathMapping operation against Amazon API Gateway.", Operation = new[] {"GetBasePathMapping"})]
    ...
    public class GetAGBasePathMappingCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.GetBasePathMappingResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetBasePathMappingRequest request)
        {
