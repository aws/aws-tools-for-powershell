...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetUsagePlan API operation.", Operation = new[] {"GetUsagePlan"})]
    ...
    public partial class GetAGUsagePlanCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.GetUsagePlanResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetUsagePlanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetUsagePlan");
            try
            {
                #if DESKTOP
                return client.GetUsagePlan(request);
                #elif CORECLR
                return client.GetUsagePlanAsync(request).GetAwaiter().GetResult();
                #else
