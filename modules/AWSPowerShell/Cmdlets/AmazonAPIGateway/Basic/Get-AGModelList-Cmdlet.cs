...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Invokes the GetModels operation against Amazon API Gateway.", Operation = new[] {"GetModels"})]
    [AWSCmdletOutput("Amazon.APIGateway.Model.Model",
        "This cmdlet returns a collection of Model objects.",
    ...
    public partial class GetAGModelListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.APIGateway.Model.GetModelsResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetModelsRequest request)
        {
            #if DESKTOP
            return client.GetModels(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetModelsAsync(request);
            return task.Result;
            #else
