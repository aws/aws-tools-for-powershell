...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Sync SetIdentityPoolConfiguration API operation.", Operation = new[] {"SetIdentityPoolConfiguration"})]
    [AWSCmdletOutput("Amazon.CognitoSync.Model.SetIdentityPoolConfigurationResponse",
        "This cmdlet returns a Amazon.CognitoSync.Model.SetIdentityPoolConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetCGISIdentityPoolConfigurationCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.CognitoStreams = this.CognitoStream;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.CognitoStreams != null)
            {
                request.CognitoStreams = cmdletContext.CognitoStreams;
            }
        ...
        private Amazon.CognitoSync.Model.SetIdentityPoolConfigurationResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.SetIdentityPoolConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SetIdentityPoolConfigurationAsync(request);
                return task.Result;
                #else
        ...
        {
            public Amazon.CognitoSync.Model.CognitoStreams CognitoStreams { get; set; }
            public System.String IdentityPoolId { get; set; }
            public Amazon.CognitoSync.Model.PushSync PushSync { get; set; }
        }
