...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Sync DescribeIdentityPoolUsage API operation.", Operation = new[] {"DescribeIdentityPoolUsage"})]
    [AWSCmdletOutput("Amazon.CognitoSync.Model.IdentityPoolUsage",
        "This cmdlet returns a IdentityPoolUsage object.",
    ...
    public partial class GetCGISIdentityPoolUsageCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.IdentityPoolUsage;
        ...
        private Amazon.CognitoSync.Model.DescribeIdentityPoolUsageResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.DescribeIdentityPoolUsageRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeIdentityPoolUsageAsync(request);
                return task.Result;
                #else
