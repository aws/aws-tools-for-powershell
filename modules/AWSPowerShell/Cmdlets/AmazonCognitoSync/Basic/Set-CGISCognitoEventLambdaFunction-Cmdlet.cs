...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Sync SetCognitoEvents API operation.", Operation = new[] {"SetCognitoEvents"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.CognitoSync.Model.SetCognitoEventsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetCGISCognitoEventLambdaFunctionCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Event != null)
            {
                context.Events = new Dictionary<System.String, System.String>(StringComparer.Ordinal);
                foreach (var hashKey in this.Event.Keys)
                {
                    context.Events.Add((String)hashKey, (String)(this.Event[hashKey]));
                }
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Events != null)
            {
                request.Events = cmdletContext.Events;
            }
        ...
        private Amazon.CognitoSync.Model.SetCognitoEventsResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.SetCognitoEventsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SetCognitoEventsAsync(request);
                return task.Result;
                #else
        ...
        {
            public Dictionary<System.String, System.String> Events { get; set; }
            public System.String IdentityPoolId { get; set; }
        }
