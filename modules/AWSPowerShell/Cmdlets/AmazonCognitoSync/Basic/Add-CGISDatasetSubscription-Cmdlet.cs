...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "CGISDatasetSubscription", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon Cognito Sync SubscribeToDataset API operation.", Operation = new[] {"SubscribeToDataset"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the DatasetName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class AddCGISDatasetSubscriptionCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CGISDatasetSubscription (SubscribeToDataset)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoSync.Model.SubscribeToDatasetRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.DatasetName;
        ...
        private Amazon.CognitoSync.Model.SubscribeToDatasetResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.SubscribeToDatasetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Sync", "SubscribeToDataset");
            try
            {
                #if DESKTOP
                return client.SubscribeToDataset(request);
                #elif CORECLR
                return client.SubscribeToDatasetAsync(request).GetAwaiter().GetResult();
                #else
