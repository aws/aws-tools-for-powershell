...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CGISDatasetList")]
    [OutputType("Amazon.CognitoSync.Model.Dataset")]
    [AWSCmdlet("Calls the Amazon Cognito Sync ListDatasets API operation.", Operation = new[] {"ListDatasets"})]
    [AWSCmdletOutput("Amazon.CognitoSync.Model.Dataset",
        "This cmdlet returns a collection of Dataset objects.",
        "The service call response (type Amazon.CognitoSync.Model.ListDatasetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: Count (type System.Int32), NextToken (type System.String)"
    )]
    public partial class GetCGISDatasetListCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CognitoSync.Model.ListDatasetsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Datasets;
        ...
        private Amazon.CognitoSync.Model.ListDatasetsResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.ListDatasetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Sync", "ListDatasets");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListDatasetsAsync(request);
                return task.Result;
                #else
