...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    [AWSCmdlet("Calls the AWS Resource Groups CreateGroup API operation.", Operation = new[] {"CreateGroup"})]
    [AWSCmdletOutput("Amazon.ResourceGroups.Model.CreateGroupResponse",
        "This cmdlet returns a Amazon.ResourceGroups.Model.CreateGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewRGGroupCmdlet : AmazonResourceGroupsClientCmdlet, IExecutor
    {
        ...
        /// have a maximum length of 255 characters.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        [Alias("Tags")]
