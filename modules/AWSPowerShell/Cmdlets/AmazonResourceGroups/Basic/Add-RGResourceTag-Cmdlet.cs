...
namespace Amazon.PowerShell.Cmdlets.RG
{
    ...
    [AWSCmdlet("Calls the AWS Resource Groups Tag API operation.", Operation = new[] {"Tag"})]
    [AWSCmdletOutput("Amazon.ResourceGroups.Model.TagResponse",
        "This cmdlet returns a Amazon.ResourceGroups.Model.TagResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
