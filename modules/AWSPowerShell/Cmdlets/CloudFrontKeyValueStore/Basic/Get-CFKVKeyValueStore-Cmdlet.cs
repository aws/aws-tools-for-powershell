...
namespace Amazon.PowerShell.Cmdlets.CFKV
{
    ...
    public partial class GetCFKVKeyValueStoreCmdlet : AmazonCloudFrontKeyValueStoreClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudFrontKeyValueStore.Model.DescribeKeyValueStoreResponse, GetCFKVKeyValueStoreCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudFrontKeyValueStore.Model.DescribeKeyValueStoreRequest();
        ...
        private Amazon.CloudFrontKeyValueStore.Model.DescribeKeyValueStoreResponse CallAWSServiceOperation(IAmazonCloudFrontKeyValueStore client, Amazon.CloudFrontKeyValueStore.Model.DescribeKeyValueStoreRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudFront KeyValueStore", "DescribeKeyValueStore");
            try
            {
                #if DESKTOP
                return client.DescribeKeyValueStore(request);
                #elif CORECLR
                return client.DescribeKeyValueStoreAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String KvsARN { get; set; }
            public System.Func<Amazon.CloudFrontKeyValueStore.Model.DescribeKeyValueStoreResponse, GetCFKVKeyValueStoreCmdlet, object> Select { get; set; } =
