...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DGURUNotificationChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDGURUNotificationChannelCmdlet : AmazonDevOpsGuruClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DGURUNotificationChannel (RemoveNotificationChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsGuru.Model.RemoveNotificationChannelResponse, RemoveDGURUNotificationChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DevOpsGuru.Model.RemoveNotificationChannelRequest();
        ...
        private Amazon.DevOpsGuru.Model.RemoveNotificationChannelResponse CallAWSServiceOperation(IAmazonDevOpsGuru client, Amazon.DevOpsGuru.Model.RemoveNotificationChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DevOps Guru", "RemoveNotificationChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.DevOpsGuru.Model.RemoveNotificationChannelResponse, RemoveDGURUNotificationChannelCmdlet, object> Select { get; set; } =
