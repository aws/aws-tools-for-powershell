...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    [AWSCmdletOutput("Amazon.DevOpsGuru.Model.SearchOrganizationInsightsResponse",
        "This cmdlet returns an Amazon.DevOpsGuru.Model.SearchOrganizationInsightsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
