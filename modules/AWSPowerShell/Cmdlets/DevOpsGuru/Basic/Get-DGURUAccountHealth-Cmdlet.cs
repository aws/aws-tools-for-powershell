...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    public partial class GetDGURUAccountHealthCmdlet : AmazonDevOpsGuruClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsGuru.Model.DescribeAccountHealthResponse, GetDGURUAccountHealthCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DevOpsGuru.Model.DescribeAccountHealthRequest();
        ...
        private Amazon.DevOpsGuru.Model.DescribeAccountHealthResponse CallAWSServiceOperation(IAmazonDevOpsGuru client, Amazon.DevOpsGuru.Model.DescribeAccountHealthRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DevOps Guru", "DescribeAccountHealth");
            try
            {
                #if DESKTOP
                return client.DescribeAccountHealth(request);
                #elif CORECLR
                return client.DescribeAccountHealthAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.DevOpsGuru.Model.DescribeAccountHealthResponse, GetDGURUAccountHealthCmdlet, object> Select { get; set; } =
