...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    [AWSCmdletOutput("Amazon.DevOpsGuru.Model.Recommendation or Amazon.DevOpsGuru.Model.ListRecommendationsResponse",
        ...
        "The service call response (type Amazon.DevOpsGuru.Model.ListRecommendationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
