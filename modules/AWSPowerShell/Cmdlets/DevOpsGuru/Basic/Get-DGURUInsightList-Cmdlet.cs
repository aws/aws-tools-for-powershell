...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    [AWSCmdlet("Calls the Amazon DevOps Guru ListInsights API operation.", Operation = new[] {"ListInsights"}, SelectReturnType = typeof(Amazon.DevOpsGuru.Model.ListInsightsResponse))]
    [AWSCmdletOutput("Amazon.DevOpsGuru.Model.ListInsightsResponse",
        "This cmdlet returns an Amazon.DevOpsGuru.Model.ListInsightsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDGURUInsightListCmdlet : AmazonDevOpsGuruClientCmdlet, IExecutor
    {
        ...
        public Amazon.DevOpsGuru.Model.ListInsightsStatusFilter StatusFilter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsGuru.Model.ListInsightsResponse, GetDGURUInsightListCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.StatusFilter == null && ParameterWasBound(nameof(this.StatusFilter)))
            {
                WriteWarning("You are passing $null as a value for parameter StatusFilter which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DevOpsGuru.Model.ListInsightsRequest();
        ...
        private Amazon.DevOpsGuru.Model.ListInsightsResponse CallAWSServiceOperation(IAmazonDevOpsGuru client, Amazon.DevOpsGuru.Model.ListInsightsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DevOps Guru", "ListInsights");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.DevOpsGuru.Model.ListInsightsStatusFilter StatusFilter { get; set; }
            public System.Func<Amazon.DevOpsGuru.Model.ListInsightsResponse, GetDGURUInsightListCmdlet, object> Select { get; set; } =
