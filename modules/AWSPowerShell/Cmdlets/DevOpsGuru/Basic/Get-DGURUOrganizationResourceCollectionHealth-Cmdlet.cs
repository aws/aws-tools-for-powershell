...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    [AWSCmdletOutput("Amazon.DevOpsGuru.Model.DescribeOrganizationResourceCollectionHealthResponse",
        "This cmdlet returns an Amazon.DevOpsGuru.Model.DescribeOrganizationResourceCollectionHealthResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDGURUOrganizationResourceCollectionHealthCmdlet : AmazonDevOpsGuruClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^OrganizationResourceCollectionType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.OrganizationResourceCollectionType;
            }
        ...
        private Amazon.DevOpsGuru.Model.DescribeOrganizationResourceCollectionHealthResponse CallAWSServiceOperation(IAmazonDevOpsGuru client, Amazon.DevOpsGuru.Model.DescribeOrganizationResourceCollectionHealthRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeOrganizationResourceCollectionHealthAsync(request).GetAwaiter().GetResult();
                #else
