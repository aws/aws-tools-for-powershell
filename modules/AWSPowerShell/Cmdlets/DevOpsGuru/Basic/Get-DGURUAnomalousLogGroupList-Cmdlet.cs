...
namespace Amazon.PowerShell.Cmdlets.DGURU
{
    ...
    /// </summary>
    [Cmdlet("Get", "DGURUAnomalousLogGroupList")]
    [OutputType("Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse")]
    [AWSCmdlet("Calls the Amazon DevOps Guru ListAnomalousLogGroups API operation.", Operation = new[] {"ListAnomalousLogGroups"}, SelectReturnType = typeof(Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse))]
    [AWSCmdletOutput("Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse",
        "This cmdlet returns an Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDGURUAnomalousLogGroupListCmdlet : AmazonDevOpsGuruClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse, GetDGURUAnomalousLogGroupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsRequest();
        ...
        private Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse CallAWSServiceOperation(IAmazonDevOpsGuru client, Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DevOps Guru", "ListAnomalousLogGroups");
            try
            {
                #if DESKTOP
                return client.ListAnomalousLogGroups(request);
                #elif CORECLR
                return client.ListAnomalousLogGroupsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DevOpsGuru.Model.ListAnomalousLogGroupsResponse, GetDGURUAnomalousLogGroupListCmdlet, object> Select { get; set; } =
