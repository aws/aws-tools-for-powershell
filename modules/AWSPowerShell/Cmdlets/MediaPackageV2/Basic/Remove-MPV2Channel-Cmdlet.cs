...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MPV2Channel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMPV2ChannelCmdlet : AmazonMediaPackageV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackageV2.Model.DeleteChannelResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MPV2Channel (DeleteChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackageV2.Model.DeleteChannelResponse, RemoveMPV2ChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackageV2.Model.DeleteChannelRequest();
        ...
        private Amazon.MediaPackageV2.Model.DeleteChannelResponse CallAWSServiceOperation(IAmazonMediaPackageV2 client, Amazon.MediaPackageV2.Model.DeleteChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage v2", "DeleteChannel");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChannelGroupName { get; set; }
            public System.String ChannelName { get; set; }
            public System.Func<Amazon.MediaPackageV2.Model.DeleteChannelResponse, RemoveMPV2ChannelCmdlet, object> Select { get; set; } =
