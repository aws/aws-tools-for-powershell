...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    public partial class GetMPV2ChannelGroupCmdlet : AmazonMediaPackageV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackageV2.Model.GetChannelGroupResponse).
        /// Specifying the name of a property of type Amazon.MediaPackageV2.Model.GetChannelGroupResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackageV2.Model.GetChannelGroupResponse, GetMPV2ChannelGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackageV2.Model.GetChannelGroupRequest();
        ...
        private Amazon.MediaPackageV2.Model.GetChannelGroupResponse CallAWSServiceOperation(IAmazonMediaPackageV2 client, Amazon.MediaPackageV2.Model.GetChannelGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage v2", "GetChannelGroup");
            try
            {
                #if DESKTOP
                return client.GetChannelGroup(request);
                #elif CORECLR
                return client.GetChannelGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ChannelGroupName { get; set; }
            public System.Func<Amazon.MediaPackageV2.Model.GetChannelGroupResponse, GetMPV2ChannelGroupCmdlet, object> Select { get; set; } =
