...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    /// using.
    /// </summary>
    [Cmdlet("Get", "MPV2OriginEndpoint")]
    [OutputType("Amazon.MediaPackageV2.Model.GetOriginEndpointResponse")]
    [AWSCmdlet("Calls the AWS Elemental MediaPackage v2 GetOriginEndpoint API operation.", Operation = new[] {"GetOriginEndpoint"}, SelectReturnType = typeof(Amazon.MediaPackageV2.Model.GetOriginEndpointResponse))]
    [AWSCmdletOutput("Amazon.MediaPackageV2.Model.GetOriginEndpointResponse",
        "This cmdlet returns an Amazon.MediaPackageV2.Model.GetOriginEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMPV2OriginEndpointCmdlet : AmazonMediaPackageV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackageV2.Model.GetOriginEndpointResponse).
        /// Specifying the name of a property of type Amazon.MediaPackageV2.Model.GetOriginEndpointResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackageV2.Model.GetOriginEndpointResponse, GetMPV2OriginEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackageV2.Model.GetOriginEndpointRequest();
        ...
        private Amazon.MediaPackageV2.Model.GetOriginEndpointResponse CallAWSServiceOperation(IAmazonMediaPackageV2 client, Amazon.MediaPackageV2.Model.GetOriginEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage v2", "GetOriginEndpoint");
            try
            {
                #if DESKTOP
                return client.GetOriginEndpoint(request);
                #elif CORECLR
                return client.GetOriginEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelName { get; set; }
            public System.String OriginEndpointName { get; set; }
            public System.Func<Amazon.MediaPackageV2.Model.GetOriginEndpointResponse, GetMPV2OriginEndpointCmdlet, object> Select { get; set; } =
