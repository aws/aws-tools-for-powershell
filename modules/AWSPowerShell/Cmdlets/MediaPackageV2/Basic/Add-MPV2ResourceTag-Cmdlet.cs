...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "MPV2ResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddMPV2ResourceTagCmdlet : AmazonMediaPackageV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the MediaPackage resource that you're adding tags to.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackageV2.Model.TagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-MPV2ResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackageV2.Model.TagResourceResponse, AddMPV2ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackageV2.Model.TagResourceRequest();
        ...
        private Amazon.MediaPackageV2.Model.TagResourceResponse CallAWSServiceOperation(IAmazonMediaPackageV2 client, Amazon.MediaPackageV2.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage v2", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MediaPackageV2.Model.TagResourceResponse, AddMPV2ResourceTagCmdlet, object> Select { get; set; } =
