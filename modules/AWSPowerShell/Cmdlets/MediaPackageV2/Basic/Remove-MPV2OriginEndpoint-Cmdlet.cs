...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MPV2OriginEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMPV2OriginEndpointCmdlet : AmazonMediaPackageV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackageV2.Model.DeleteOriginEndpointResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MPV2OriginEndpoint (DeleteOriginEndpoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackageV2.Model.DeleteOriginEndpointResponse, RemoveMPV2OriginEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackageV2.Model.DeleteOriginEndpointRequest();
        ...
        private Amazon.MediaPackageV2.Model.DeleteOriginEndpointResponse CallAWSServiceOperation(IAmazonMediaPackageV2 client, Amazon.MediaPackageV2.Model.DeleteOriginEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage v2", "DeleteOriginEndpoint");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelName { get; set; }
            public System.String OriginEndpointName { get; set; }
            public System.Func<Amazon.MediaPackageV2.Model.DeleteOriginEndpointResponse, RemoveMPV2OriginEndpointCmdlet, object> Select { get; set; } =
