...
namespace Amazon.PowerShell.Cmdlets.MPV2
{
    ...
    [AWSCmdletOutput("Amazon.MediaPackageV2.Model.GetChannelResponse",
        "This cmdlet returns an Amazon.MediaPackageV2.Model.GetChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
