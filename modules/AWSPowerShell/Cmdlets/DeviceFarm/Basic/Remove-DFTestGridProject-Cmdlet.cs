...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class RemoveDFTestGridProjectCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DFTestGridProject (DeleteTestGridProject)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.DeleteTestGridProjectResponse, RemoveDFTestGridProjectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DeviceFarm.Model.DeleteTestGridProjectRequest();
        ...
        private Amazon.DeviceFarm.Model.DeleteTestGridProjectResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.DeleteTestGridProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "DeleteTestGridProject");
            try
            {
                #if DESKTOP
                return client.DeleteTestGridProject(request);
                #elif CORECLR
                return client.DeleteTestGridProjectAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ProjectArn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.DeleteTestGridProjectResponse, RemoveDFTestGridProjectCmdlet, object> Select { get; set; } =
