...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// </summary>
    [Cmdlet("Get", "DFJobList")]
    [OutputType("Amazon.DeviceFarm.Model.Job")]
    [AWSCmdlet("Calls the AWS Device Farm ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Job or Amazon.DeviceFarm.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.Job objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFJobListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListJobsResponse, GetDFJobListCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.ListJobsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "ListJobs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Arn { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListJobsResponse, GetDFJobListCmdlet, object> Select { get; set; } =
