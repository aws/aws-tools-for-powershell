...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class UpdateDFProjectCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.UpdateProjectResponse, UpdateDFProjectCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.UpdateProjectResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.UpdateProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "UpdateProject");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcConfig_VpcId { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.UpdateProjectResponse, UpdateDFProjectCmdlet, object> Select { get; set; } =
