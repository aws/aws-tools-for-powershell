...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class RemoveDFNetworkProfileCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.DeleteNetworkProfileResponse, RemoveDFNetworkProfileCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.DeleteNetworkProfileResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.DeleteNetworkProfileRequest request)
        {
            ...
            try
            {
                return client.DeleteNetworkProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.DeleteNetworkProfileResponse, RemoveDFNetworkProfileCmdlet, object> Select { get; set; } =
