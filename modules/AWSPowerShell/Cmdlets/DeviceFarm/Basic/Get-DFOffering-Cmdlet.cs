...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// to invoke the operation. If you must be able to invoke this operation, contact <a href="mailto:aws-devicefarm-support@amazon.com">aws-devicefarm-support@amazon.com</a>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "DFOffering")]
    [OutputType("Amazon.DeviceFarm.Model.Offering")]
    [AWSCmdlet("Calls the AWS Device Farm ListOfferings API operation.", Operation = new[] {"ListOfferings"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListOfferingsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Offering or Amazon.DeviceFarm.Model.ListOfferingsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.Offering objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListOfferingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFOfferingCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListOfferingsResponse, GetDFOfferingCmdlet>(Select) ??
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListOfferingsResponse, GetDFOfferingCmdlet, object> Select { get; set; } =
