...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class StopDFRemoteAccessSessionCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.StopRemoteAccessSessionResponse, StopDFRemoteAccessSessionCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.StopRemoteAccessSessionResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.StopRemoteAccessSessionRequest request)
        {
            ...
            try
            {
                return client.StopRemoteAccessSessionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.StopRemoteAccessSessionResponse, StopDFRemoteAccessSessionCmdlet, object> Select { get; set; } =
