...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class RemoveDFDevicePoolCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.DeleteDevicePoolResponse, RemoveDFDevicePoolCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.DeleteDevicePoolResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.DeleteDevicePoolRequest request)
        {
            ...
            try
            {
                return client.DeleteDevicePoolAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.DeleteDevicePoolResponse, RemoveDFDevicePoolCmdlet, object> Select { get; set; } =
