...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Calls the AWS Device Farm ListOfferingPromotions API operation.", Operation = new[] {"ListOfferingPromotions"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.OfferingPromotion or Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.OfferingPromotion objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFOfferingPromotionCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OfferingPromotions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse, GetDFOfferingPromotionCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListOfferingPromotionsRequest request)
        {
            ...
            try
            {
                return client.ListOfferingPromotionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListOfferingPromotionsResponse, GetDFOfferingPromotionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OfferingPromotions;
        }
