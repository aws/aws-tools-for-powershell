...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// </summary>
    [Cmdlet("Get", "DFRunList")]
    [OutputType("Amazon.DeviceFarm.Model.Run")]
    [AWSCmdlet("Calls the AWS Device Farm ListRuns API operation.", Operation = new[] {"ListRuns"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListRunsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Run or Amazon.DeviceFarm.Model.ListRunsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.Run objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListRunsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFRunListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListRunsResponse, GetDFRunListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DeviceFarm.Model.ListRunsRequest();
        ...
        private Amazon.DeviceFarm.Model.ListRunsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListRunsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "ListRuns");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Arn { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListRunsResponse, GetDFRunListCmdlet, object> Select { get; set; } =
