...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// </summary>
    [Cmdlet("Get", "DFProjectList")]
    [OutputType("Amazon.DeviceFarm.Model.Project")]
    [AWSCmdlet("Calls the AWS Device Farm ListProjects API operation.", Operation = new[] {"ListProjects"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListProjectsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Project or Amazon.DeviceFarm.Model.ListProjectsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.Project objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListProjectsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFProjectListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListProjectsResponse, GetDFProjectListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DeviceFarm.Model.ListProjectsRequest();
        ...
        private Amazon.DeviceFarm.Model.ListProjectsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListProjectsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "ListProjects");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Arn { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListProjectsResponse, GetDFProjectListCmdlet, object> Select { get; set; } =
