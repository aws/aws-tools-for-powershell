...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Calls the AWS Device Farm GetJob API operation.", Operation = new[] {"GetJob"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.GetJobResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Job or Amazon.DeviceFarm.Model.GetJobResponse",
        "This cmdlet returns an Amazon.DeviceFarm.Model.Job object.",
        "The service call response (type Amazon.DeviceFarm.Model.GetJobResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFJobCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.GetJobResponse, GetDFJobCmdlet>(Select) ??
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.GetJobResponse, GetDFJobCmdlet, object> Select { get; set; } =
