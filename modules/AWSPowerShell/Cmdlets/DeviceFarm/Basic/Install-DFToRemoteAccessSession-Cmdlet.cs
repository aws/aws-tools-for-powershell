...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class InstallDFToRemoteAccessSessionCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        #region Parameter RemoteAccessSessionArn
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AppUpload";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Install-DFToRemoteAccessSession (InstallToRemoteAccessSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.InstallToRemoteAccessSessionResponse, InstallDFToRemoteAccessSessionCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.RemoteAccessSessionArn == null && ParameterWasBound(nameof(this.RemoteAccessSessionArn)))
            {
                WriteWarning("You are passing $null as a value for parameter RemoteAccessSessionArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DeviceFarm.Model.InstallToRemoteAccessSessionRequest();
            
            if (cmdletContext.AppArn != null)
            {
                request.AppArn = cmdletContext.AppArn;
            }
            if (cmdletContext.RemoteAccessSessionArn != null)
            {
                request.RemoteAccessSessionArn = cmdletContext.RemoteAccessSessionArn;
            }
        ...
        private Amazon.DeviceFarm.Model.InstallToRemoteAccessSessionResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.InstallToRemoteAccessSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "InstallToRemoteAccessSession");
            try
            {
                return client.InstallToRemoteAccessSessionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppArn { get; set; }
            public System.String RemoteAccessSessionArn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.InstallToRemoteAccessSessionResponse, InstallDFToRemoteAccessSessionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AppUpload;
        }
