...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Calls the AWS Device Farm UpdateDeviceInstance API operation.", Operation = new[] {"UpdateDeviceInstance"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.DeviceInstance or Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse",
        "This cmdlet returns an Amazon.DeviceFarm.Model.DeviceInstance object.",
        "The service call response (type Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateDFDeviceInstanceCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of strings that you want to associate with the device instance.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeviceInstance";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse, UpdateDFDeviceInstanceCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.UpdateDeviceInstanceRequest request)
        {
            ...
            try
            {
                return client.UpdateDeviceInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProfileArn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.UpdateDeviceInstanceResponse, UpdateDFDeviceInstanceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeviceInstance;
        }
