...
{
    /// <summary>
    /// Gets information about unique problems.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "DFUniqueProblemList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Device Farm ListUniqueProblems API operation.", Operation = new[] {"ListUniqueProblems"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListUniqueProblemsResponse))]
    [AWSCmdletOutput("System.String or Amazon.DeviceFarm.Model.ListUniqueProblemsResponse",
    ...
    public partial class GetDFUniqueProblemListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "UniqueProblems";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListUniqueProblemsResponse, GetDFUniqueProblemListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DeviceFarm.Model.ListUniqueProblemsRequest();
        ...
        private Amazon.DeviceFarm.Model.ListUniqueProblemsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListUniqueProblemsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListUniqueProblemsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Arn { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListUniqueProblemsResponse, GetDFUniqueProblemListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.UniqueProblems;
        }
