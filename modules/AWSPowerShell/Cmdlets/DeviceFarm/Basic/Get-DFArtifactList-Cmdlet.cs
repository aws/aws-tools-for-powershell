...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [OutputType("Amazon.DeviceFarm.Model.Artifact")]
    [AWSCmdlet("Calls the AWS Device Farm ListArtifacts API operation.", Operation = new[] {"ListArtifacts"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListArtifactsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Artifact or Amazon.DeviceFarm.Model.ListArtifactsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.Artifact objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListArtifactsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFArtifactListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListArtifactsResponse, GetDFArtifactListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.DeviceFarm.ArtifactCategory Type { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListArtifactsResponse, GetDFArtifactListCmdlet, object> Select { get; set; } =
