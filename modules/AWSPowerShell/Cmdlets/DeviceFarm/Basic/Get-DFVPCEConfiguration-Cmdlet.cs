...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    public partial class GetDFVPCEConfigurationCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.GetVPCEConfigurationResponse, GetDFVPCEConfigurationCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.GetVPCEConfigurationResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.GetVPCEConfigurationRequest request)
        {
            ...
            try
            {
                return client.GetVPCEConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.GetVPCEConfigurationResponse, GetDFVPCEConfigurationCmdlet, object> Select { get; set; } =
