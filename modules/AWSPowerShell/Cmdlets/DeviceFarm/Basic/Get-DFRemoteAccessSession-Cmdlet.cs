...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// </summary>
    [Cmdlet("Get", "DFRemoteAccessSession")]
    [OutputType("Amazon.DeviceFarm.Model.RemoteAccessSession")]
    [AWSCmdlet("Calls the AWS Device Farm GetRemoteAccessSession API operation.", Operation = new[] {"GetRemoteAccessSession"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.RemoteAccessSession or Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse",
        "This cmdlet returns an Amazon.DeviceFarm.Model.RemoteAccessSession object.",
        "The service call response (type Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDFRemoteAccessSessionCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse, GetDFRemoteAccessSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DeviceFarm.Model.GetRemoteAccessSessionRequest();
        ...
        private Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.GetRemoteAccessSessionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetRemoteAccessSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.GetRemoteAccessSessionResponse, GetDFRemoteAccessSessionCmdlet, object> Select { get; set; } =
