...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Calls the AWS Device Farm ListVPCEConfigurations API operation.", Operation = new[] {"ListVPCEConfigurations"}, SelectReturnType = typeof(Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.VPCEConfiguration or Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.DeviceFarm.Model.VPCEConfiguration objects.",
        "The service call response (type Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDFVPCEConfigurationListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "VpceConfigurations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse, GetDFVPCEConfigurationListCmdlet>(Select) ??
        ...
        private Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListVPCEConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListVPCEConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DeviceFarm.Model.ListVPCEConfigurationsResponse, GetDFVPCEConfigurationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.VpceConfigurations;
        }
