...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.TestGridSession or Amazon.DeviceFarm.Model.ListTestGridSessionsResponse",
        ...
        "The service call response (type Amazon.DeviceFarm.Model.ListTestGridSessionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
