...
namespace Amazon.PowerShell.Cmdlets.MSKC
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKCWorkerConfiguration")]
    [OutputType("Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse")]
    [AWSCmdlet("Calls the Managed Streaming for Kafka Connect DescribeWorkerConfiguration API operation.", Operation = new[] {"DescribeWorkerConfiguration"}, SelectReturnType = typeof(Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse))]
    [AWSCmdletOutput("Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse",
        "This cmdlet returns an Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKCWorkerConfigurationCmdlet : AmazonKafkaConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse, GetMSKCWorkerConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KafkaConnect.Model.DescribeWorkerConfigurationRequest();
        ...
        private Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse CallAWSServiceOperation(IAmazonKafkaConnect client, Amazon.KafkaConnect.Model.DescribeWorkerConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka Connect", "DescribeWorkerConfiguration");
            try
            {
                #if DESKTOP
                return client.DescribeWorkerConfiguration(request);
                #elif CORECLR
                return client.DescribeWorkerConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String WorkerConfigurationArn { get; set; }
            public System.Func<Amazon.KafkaConnect.Model.DescribeWorkerConfigurationResponse, GetMSKCWorkerConfigurationCmdlet, object> Select { get; set; } =
