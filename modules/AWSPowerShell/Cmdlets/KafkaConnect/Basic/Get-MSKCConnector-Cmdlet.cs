...
namespace Amazon.PowerShell.Cmdlets.MSKC
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKCConnector")]
    [OutputType("Amazon.KafkaConnect.Model.DescribeConnectorResponse")]
    [AWSCmdlet("Calls the Managed Streaming for Kafka Connect DescribeConnector API operation.", Operation = new[] {"DescribeConnector"}, SelectReturnType = typeof(Amazon.KafkaConnect.Model.DescribeConnectorResponse))]
    [AWSCmdletOutput("Amazon.KafkaConnect.Model.DescribeConnectorResponse",
        "This cmdlet returns an Amazon.KafkaConnect.Model.DescribeConnectorResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKCConnectorCmdlet : AmazonKafkaConnectClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KafkaConnect.Model.DescribeConnectorResponse, GetMSKCConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KafkaConnect.Model.DescribeConnectorRequest();
        ...
        private Amazon.KafkaConnect.Model.DescribeConnectorResponse CallAWSServiceOperation(IAmazonKafkaConnect client, Amazon.KafkaConnect.Model.DescribeConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka Connect", "DescribeConnector");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ConnectorArn { get; set; }
            public System.Func<Amazon.KafkaConnect.Model.DescribeConnectorResponse, GetMSKCConnectorCmdlet, object> Select { get; set; } =
