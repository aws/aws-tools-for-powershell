...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.AssetRevision or Amazon.DataZone.Model.ListAssetRevisionsResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListAssetRevisionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZAssetRevisionListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of revisions to return in a single call to <code>ListAssetRevisions</code>.
        ...
        /// call to <code>ListAssetRevisions</code> to list the next set of revisions.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of revisions is greater than the default value for the <code>MaxResults</code>
        ...
        private Amazon.DataZone.Model.ListAssetRevisionsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListAssetRevisionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListAssetRevisions(request);
                #elif CORECLR
                return client.ListAssetRevisionsAsync(request).GetAwaiter().GetResult();
                #else
