...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZEnvironmentBlueprintConfiguration")]
    ...
    public partial class GetDZEnvironmentBlueprintConfigurationCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.GetEnvironmentBlueprintConfigurationResponse, GetDZEnvironmentBlueprintConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.GetEnvironmentBlueprintConfigurationRequest();
        ...
        private Amazon.DataZone.Model.GetEnvironmentBlueprintConfigurationResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetEnvironmentBlueprintConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "GetEnvironmentBlueprintConfiguration");
            try
            {
                #if DESKTOP
                return client.GetEnvironmentBlueprintConfiguration(request);
                #elif CORECLR
                return client.GetEnvironmentBlueprintConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainIdentifier { get; set; }
            public System.String EnvironmentBlueprintIdentifier { get; set; }
            public System.Func<Amazon.DataZone.Model.GetEnvironmentBlueprintConfigurationResponse, GetDZEnvironmentBlueprintConfigurationCmdlet, object> Select { get; set; } =
