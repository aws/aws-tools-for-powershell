...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Update", "DZProjectProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.UpdateProjectProfileResponse")]
    [AWSCmdlet("Calls the Amazon DataZone UpdateProjectProfile API operation.", Operation = new[] {"UpdateProjectProfile"}, SelectReturnType = typeof(Amazon.DataZone.Model.UpdateProjectProfileResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.UpdateProjectProfileResponse",
        "This cmdlet returns an Amazon.DataZone.Model.UpdateProjectProfileResponse object containing multiple properties."
    )]
    public partial class UpdateDZProjectProfileCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The environment configurations of a project profile.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-DZProjectProfile (UpdateProjectProfile)"))
            {
                return;
            }
        ...
        private Amazon.DataZone.Model.UpdateProjectProfileResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.UpdateProjectProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "UpdateProjectProfile");
            try
            {
                return client.UpdateProjectProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
