...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.LineageNodeSummary or Amazon.DataZone.Model.ListLineageNodeHistoryResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListLineageNodeHistoryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
