...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZConnectionList")]
    [OutputType("Amazon.DataZone.Model.ConnectionSummary")]
    [AWSCmdlet("Calls the Amazon DataZone ListConnections API operation.", Operation = new[] {"ListConnections"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListConnectionsResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.ConnectionSummary or Amazon.DataZone.Model.ListConnectionsResponse",
        "This cmdlet returns a collection of Amazon.DataZone.Model.ConnectionSummary objects.",
        "The service call response (type Amazon.DataZone.Model.ListConnectionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDZConnectionListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.DataZone.SortFieldConnection")]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.DataZone.ConnectionType")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.ListConnectionsResponse, GetDZConnectionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.ListConnectionsRequest();
        ...
        private Amazon.DataZone.Model.ListConnectionsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListConnectionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListConnections");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.SortOrder SortOrder { get; set; }
            public Amazon.DataZone.ConnectionType Type { get; set; }
            public System.Func<Amazon.DataZone.Model.ListConnectionsResponse, GetDZConnectionListCmdlet, object> Select { get; set; } =
