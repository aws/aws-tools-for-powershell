...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.GetGlossaryTermResponse",
        "This cmdlet returns an Amazon.DataZone.Model.GetGlossaryTermResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZGlossaryTermCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataZone.Model.GetGlossaryTermResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetGlossaryTermRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetGlossaryTerm(request);
                #elif CORECLR
                return client.GetGlossaryTermAsync(request).GetAwaiter().GetResult();
                #else
