...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.ProjectMember or Amazon.DataZone.Model.ListProjectMembershipsResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListProjectMembershipsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZProjectMembershipListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of memberships to return in a single call to <code>ListProjectMemberships</code>.
        ...
        /// call to <code>ListProjectMemberships</code> to list the next set of memberships.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of memberships is greater than the default value for the <code>MaxResults</code>
