...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DZTimeSeriesDataPoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon DataZone DeleteTimeSeriesDataPoints API operation.", Operation = new[] {"DeleteTimeSeriesDataPoints"}, SelectReturnType = typeof(Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse))]
    [AWSCmdletOutput("None or Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveDZTimeSeriesDataPointCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZTimeSeriesDataPoint (DeleteTimeSeriesDataPoints)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse, RemoveDZTimeSeriesDataPointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DeleteTimeSeriesDataPointsRequest();
        ...
        private Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DeleteTimeSeriesDataPointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DeleteTimeSeriesDataPoints");
            try
            {
                #if DESKTOP
                return client.DeleteTimeSeriesDataPoints(request);
                #elif CORECLR
                return client.DeleteTimeSeriesDataPointsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.TimeSeriesEntityType EntityType { get; set; }
            public System.String FormName { get; set; }
            public System.Func<Amazon.DataZone.Model.DeleteTimeSeriesDataPointsResponse, RemoveDZTimeSeriesDataPointCmdlet, object> Select { get; set; } =
