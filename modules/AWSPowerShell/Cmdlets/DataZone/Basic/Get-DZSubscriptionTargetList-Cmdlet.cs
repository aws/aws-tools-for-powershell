...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZSubscriptionTargetList")]
    [OutputType("Amazon.DataZone.Model.ListSubscriptionTargetsResponse")]
    [AWSCmdlet("Calls the Amazon DataZone ListSubscriptionTargets API operation.", Operation = new[] {"ListSubscriptionTargets"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListSubscriptionTargetsResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.ListSubscriptionTargetsResponse",
        "This cmdlet returns an Amazon.DataZone.Model.ListSubscriptionTargetsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZSubscriptionTargetListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of subscription targets to return in a single call to <code>ListSubscriptionTargets</code>.
        ...
        /// next set of subscription targets. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.ListSubscriptionTargetsResponse, GetDZSubscriptionTargetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.ListSubscriptionTargetsRequest();
        ...
        private Amazon.DataZone.Model.ListSubscriptionTargetsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListSubscriptionTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListSubscriptionTargets");
            try
            {
                #if DESKTOP
                return client.ListSubscriptionTargets(request);
                #elif CORECLR
                return client.ListSubscriptionTargetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.SortKey SortBy { get; set; }
            public Amazon.DataZone.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.DataZone.Model.ListSubscriptionTargetsResponse, GetDZSubscriptionTargetListCmdlet, object> Select { get; set; } =
