...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class GetDZLineageNodeCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.GetLineageNodeResponse, GetDZLineageNodeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.GetLineageNodeRequest();
        ...
        private Amazon.DataZone.Model.GetLineageNodeResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetLineageNodeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "GetLineageNode");
            try
            {
                #if DESKTOP
                return client.GetLineageNode(request);
                #elif CORECLR
                return client.GetLineageNodeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? EventTimestamp { get; set; }
            public System.String Identifier { get; set; }
            public System.Func<Amazon.DataZone.Model.GetLineageNodeResponse, GetDZLineageNodeCmdlet, object> Select { get; set; } =
