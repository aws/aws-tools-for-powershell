...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class NewDZAssetRevisionCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The metadata forms to be attached to the asset as part of asset revision.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The glossary terms to be attached to the asset as part of asset revision.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.DataZone.Model.CreateAssetRevisionResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateAssetRevisionRequest request)
        {
            ...
            try
            {
                return client.CreateAssetRevisionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
