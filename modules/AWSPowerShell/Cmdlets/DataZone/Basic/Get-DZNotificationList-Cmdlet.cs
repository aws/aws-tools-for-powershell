...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.NotificationOutput or Amazon.DataZone.Model.ListNotificationsResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListNotificationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZNotificationListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of notifications to return in a single call to <code>ListNotifications</code>.
        ...
        /// call to <code>ListNotifications</code> to list the next set of notifications.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of notifications is greater than the default value for the <code>MaxResults</code>
