...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("New", "DZRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.CreateRuleResponse")]
    [AWSCmdlet("Calls the Amazon DataZone CreateRule API operation.", Operation = new[] {"CreateRule"}, SelectReturnType = typeof(Amazon.DataZone.Model.CreateRuleResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.CreateRuleResponse",
        "This cmdlet returns an Amazon.DataZone.Model.CreateRuleResponse object containing multiple properties."
    )]
    public partial class NewDZRuleCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public Amazon.DataZone.Model.RuleTarget Target { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DZRule (CreateRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.CreateRuleResponse, NewDZRuleCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.Detail == null && ParameterWasBound(nameof(this.Detail)))
            {
                WriteWarning("You are passing $null as a value for parameter Detail which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.CreateRuleRequest();
        ...
        private Amazon.DataZone.Model.CreateRuleResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "CreateRule");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.Model.RuleScope Scope { get; set; }
            public Amazon.DataZone.Model.RuleTarget Target { get; set; }
            public System.Func<Amazon.DataZone.Model.CreateRuleResponse, NewDZRuleCmdlet, object> Select { get; set; } =
