...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.GetTimeSeriesDataPointResponse",
        "This cmdlet returns an Amazon.DataZone.Model.GetTimeSeriesDataPointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZTimeSeriesDataPointCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataZone.Model.GetTimeSeriesDataPointResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetTimeSeriesDataPointRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetTimeSeriesDataPoint(request);
                #elif CORECLR
                return client.GetTimeSeriesDataPointAsync(request).GetAwaiter().GetResult();
                #else
