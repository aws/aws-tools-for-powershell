...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZProjectProfileList")]
    [OutputType("Amazon.DataZone.Model.ProjectProfileSummary")]
    [AWSCmdlet("Calls the Amazon DataZone ListProjectProfiles API operation.", Operation = new[] {"ListProjectProfiles"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListProjectProfilesResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.ProjectProfileSummary or Amazon.DataZone.Model.ListProjectProfilesResponse",
        "This cmdlet returns a collection of Amazon.DataZone.Model.ProjectProfileSummary objects.",
        "The service call response (type Amazon.DataZone.Model.ListProjectProfilesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDZProjectProfileListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.ListProjectProfilesResponse, GetDZProjectProfileListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.ListProjectProfilesRequest();
        ...
        private Amazon.DataZone.Model.ListProjectProfilesResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListProjectProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListProjectProfiles");
            try
            {
                #if DESKTOP
                return client.ListProjectProfiles(request);
                #elif CORECLR
                return client.ListProjectProfilesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.SortFieldProject SortBy { get; set; }
            public Amazon.DataZone.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.DataZone.Model.ListProjectProfilesResponse, GetDZProjectProfileListCmdlet, object> Select { get; set; } =
