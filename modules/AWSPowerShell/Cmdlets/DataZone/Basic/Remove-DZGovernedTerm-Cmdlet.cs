...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DZGovernedTerm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon DataZone DisassociateGovernedTerms API operation.", Operation = new[] {"DisassociateGovernedTerms"}, SelectReturnType = typeof(Amazon.DataZone.Model.DisassociateGovernedTermsResponse))]
    [AWSCmdletOutput("None or Amazon.DataZone.Model.DisassociateGovernedTermsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DataZone.Model.DisassociateGovernedTermsResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveDZGovernedTermCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the domain where you want to disassociate restricted terms from an asset.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of an asset from which you want to disassociate restricted terms.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The type of the asset from which you want to disassociate restricted terms.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The restricted glossary terms that you want to disassociate from an asset.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DataZone.Model.DisassociateGovernedTermsResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZGovernedTerm (DisassociateGovernedTerms)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DisassociateGovernedTermsResponse, RemoveDZGovernedTermCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DisassociateGovernedTermsRequest();
        ...
        private Amazon.DataZone.Model.DisassociateGovernedTermsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DisassociateGovernedTermsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DisassociateGovernedTerms");
            try
            {
                #if DESKTOP
                return client.DisassociateGovernedTerms(request);
                #elif CORECLR
                return client.DisassociateGovernedTermsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DataZone.Model.DisassociateGovernedTermsResponse, RemoveDZGovernedTermCmdlet, object> Select { get; set; } =
