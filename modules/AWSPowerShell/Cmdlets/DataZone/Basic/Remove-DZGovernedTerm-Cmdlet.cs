...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class RemoveDZGovernedTermCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The restricted glossary terms that you want to disassociate from an asset.</para><para />
        ...
        private Amazon.DataZone.Model.DisassociateGovernedTermsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DisassociateGovernedTermsRequest request)
        {
            ...
            try
            {
                return client.DisassociateGovernedTermsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
