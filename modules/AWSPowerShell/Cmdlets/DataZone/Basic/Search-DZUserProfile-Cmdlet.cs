...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Search", "DZUserProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.SearchUserProfilesResponse")]
    [AWSCmdlet("Calls the Amazon DataZone SearchUserProfiles API operation.", Operation = new[] {"SearchUserProfiles"}, SelectReturnType = typeof(Amazon.DataZone.Model.SearchUserProfilesResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.SearchUserProfilesResponse",
        "This cmdlet returns an Amazon.DataZone.Model.SearchUserProfilesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchDZUserProfileCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.DataZone.UserSearchType")]
        public Amazon.DataZone.UserSearchType UserType { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^UserType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-DZUserProfile (SearchUserProfiles)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.SearchUserProfilesResponse, SearchDZUserProfileCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.UserType;
            }
            ...
            #if MODULAR
            if (this.UserType == null && ParameterWasBound(nameof(this.UserType)))
            {
                WriteWarning("You are passing $null as a value for parameter UserType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.SearchUserProfilesRequest();
        ...
        private Amazon.DataZone.Model.SearchUserProfilesResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.SearchUserProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "SearchUserProfiles");
            try
            {
                #if DESKTOP
                return client.SearchUserProfiles(request);
                #elif CORECLR
                return client.SearchUserProfilesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SearchText { get; set; }
            public Amazon.DataZone.UserSearchType UserType { get; set; }
            public System.Func<Amazon.DataZone.Model.SearchUserProfilesResponse, SearchDZUserProfileCmdlet, object> Select { get; set; } =
