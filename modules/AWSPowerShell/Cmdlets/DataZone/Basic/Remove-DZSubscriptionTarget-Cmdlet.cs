...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DZSubscriptionTarget", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDZSubscriptionTargetCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZSubscriptionTarget (DeleteSubscriptionTarget)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DeleteSubscriptionTargetResponse, RemoveDZSubscriptionTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DeleteSubscriptionTargetRequest();
        ...
        private Amazon.DataZone.Model.DeleteSubscriptionTargetResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DeleteSubscriptionTargetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DeleteSubscriptionTarget");
            try
            {
                #if DESKTOP
                return client.DeleteSubscriptionTarget(request);
                #elif CORECLR
                return client.DeleteSubscriptionTargetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EnvironmentIdentifier { get; set; }
            public System.String Identifier { get; set; }
            public System.Func<Amazon.DataZone.Model.DeleteSubscriptionTargetResponse, RemoveDZSubscriptionTargetCmdlet, object> Select { get; set; } =
