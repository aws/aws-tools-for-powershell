...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class SearchDZListingCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results to return in a single call to <code>SearchListings</code>.
        ...
        /// call to <code>SearchListings</code> to list the next set of results. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
