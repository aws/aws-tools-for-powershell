...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZIamPortalLoginUrl")]
    ...
    public partial class GetDZIamPortalLoginUrlCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.GetIamPortalLoginUrlResponse, GetDZIamPortalLoginUrlCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.GetIamPortalLoginUrlRequest();
        ...
        private Amazon.DataZone.Model.GetIamPortalLoginUrlResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetIamPortalLoginUrlRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "GetIamPortalLoginUrl");
            try
            {
                #if DESKTOP
                return client.GetIamPortalLoginUrl(request);
                #elif CORECLR
                return client.GetIamPortalLoginUrlAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DomainIdentifier { get; set; }
            public System.Func<Amazon.DataZone.Model.GetIamPortalLoginUrlResponse, GetDZIamPortalLoginUrlCmdlet, object> Select { get; set; } =
