...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class SearchDZResourceCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies additional attributes for the <code>Search</code> action.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results to return in a single call to <code>Search</code>. When
        ...
        /// call to <code>Search</code> to list the next set of results.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// You can specify this <code>NextToken</code> value in a subsequent call to <code>Search</code>
