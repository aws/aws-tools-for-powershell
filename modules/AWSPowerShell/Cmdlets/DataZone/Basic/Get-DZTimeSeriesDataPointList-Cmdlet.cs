...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.ListTimeSeriesDataPointsResponse",
        "This cmdlet returns an Amazon.DataZone.Model.ListTimeSeriesDataPointsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZTimeSeriesDataPointListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataZone.Model.ListTimeSeriesDataPointsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListTimeSeriesDataPointsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListTimeSeriesDataPoints(request);
                #elif CORECLR
                return client.ListTimeSeriesDataPointsAsync(request).GetAwaiter().GetResult();
                #else
