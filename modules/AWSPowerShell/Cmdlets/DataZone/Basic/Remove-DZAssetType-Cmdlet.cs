...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class RemoveDZAssetTypeCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZAssetType (DeleteAssetType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DeleteAssetTypeResponse, RemoveDZAssetTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DeleteAssetTypeRequest();
        ...
        private Amazon.DataZone.Model.DeleteAssetTypeResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DeleteAssetTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DeleteAssetType");
            try
            {
                #if DESKTOP
                return client.DeleteAssetType(request);
                #elif CORECLR
                return client.DeleteAssetTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainIdentifier { get; set; }
            public System.String Identifier { get; set; }
            public System.Func<Amazon.DataZone.Model.DeleteAssetTypeResponse, RemoveDZAssetTypeCmdlet, object> Select { get; set; } =
