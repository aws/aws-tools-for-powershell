...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZDataSourceList")]
    [OutputType("Amazon.DataZone.Model.DataSourceSummary")]
    [AWSCmdlet("Calls the Amazon DataZone ListDataSources API operation.", Operation = new[] {"ListDataSources"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListDataSourcesResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.DataSourceSummary or Amazon.DataZone.Model.ListDataSourcesResponse",
        "This cmdlet returns a collection of Amazon.DataZone.Model.DataSourceSummary objects.",
        "The service call response (type Amazon.DataZone.Model.ListDataSourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZDataSourceListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.DataZone.DataSourceStatus")]
        public Amazon.DataZone.DataSourceStatus Status { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of data sources to return in a single call to <code>ListDataSources</code>.
        ...
        /// call to <code>ListDataSources</code> to list the next set of data sources.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of data sources is greater than the default value for the <code>MaxResults</code>
        ...
        private Amazon.DataZone.Model.ListDataSourcesResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListDataSourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListDataSources");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.DataSourceStatus Status { get; set; }
            public System.String Type { get; set; }
            public System.Func<Amazon.DataZone.Model.ListDataSourcesResponse, GetDZDataSourceListCmdlet, object> Select { get; set; } =
