...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Update", "DZUserProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.UpdateUserProfileResponse")]
    [AWSCmdlet("Calls the Amazon DataZone UpdateUserProfile API operation.", Operation = new[] {"UpdateUserProfile"}, SelectReturnType = typeof(Amazon.DataZone.Model.UpdateUserProfileResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.UpdateUserProfileResponse",
        "This cmdlet returns an Amazon.DataZone.Model.UpdateUserProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateDZUserProfileCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.DataZone.UserProfileStatus")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.UserIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-DZUserProfile (UpdateUserProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.UpdateUserProfileResponse, UpdateDZUserProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.UpdateUserProfileRequest();
        ...
        private Amazon.DataZone.Model.UpdateUserProfileResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.UpdateUserProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "UpdateUserProfile");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataZone.UserProfileType Type { get; set; }
            public System.String UserIdentifier { get; set; }
            public System.Func<Amazon.DataZone.Model.UpdateUserProfileResponse, UpdateDZUserProfileCmdlet, object> Select { get; set; } =
