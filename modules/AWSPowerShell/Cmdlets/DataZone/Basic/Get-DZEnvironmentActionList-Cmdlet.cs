...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZEnvironmentActionList")]
    [OutputType("Amazon.DataZone.Model.EnvironmentActionSummary")]
    [AWSCmdlet("Calls the Amazon DataZone ListEnvironmentActions API operation.", Operation = new[] {"ListEnvironmentActions"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListEnvironmentActionsResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.EnvironmentActionSummary or Amazon.DataZone.Model.ListEnvironmentActionsResponse",
        "This cmdlet returns a collection of Amazon.DataZone.Model.EnvironmentActionSummary objects.",
        "The service call response (type Amazon.DataZone.Model.ListEnvironmentActionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZEnvironmentActionListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.ListEnvironmentActionsResponse, GetDZEnvironmentActionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.ListEnvironmentActionsRequest();
        ...
        private Amazon.DataZone.Model.ListEnvironmentActionsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListEnvironmentActionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListEnvironmentActions");
            try
            {
                #if DESKTOP
                return client.ListEnvironmentActions(request);
                #elif CORECLR
                return client.ListEnvironmentActionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DataZone.Model.ListEnvironmentActionsResponse, GetDZEnvironmentActionListCmdlet, object> Select { get; set; } =
