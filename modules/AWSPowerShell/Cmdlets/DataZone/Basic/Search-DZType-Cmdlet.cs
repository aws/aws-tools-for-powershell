...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Search", "DZType", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.SearchTypesResponse")]
    [AWSCmdlet("Calls the Amazon DataZone SearchTypes API operation.", Operation = new[] {"SearchTypes"}, SelectReturnType = typeof(Amazon.DataZone.Model.SearchTypesResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.SearchTypesResponse",
        "This cmdlet returns an Amazon.DataZone.Model.SearchTypesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchDZTypeCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the Amazon DataZone domain in which to invoke the <code>SearchTypes</code>
        /// action.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.DataZone.TypesSearchScope")]
        public Amazon.DataZone.TypesSearchScope SearchScope { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results to return in a single call to <code>SearchTypes</code>.
        ...
        /// call to <code>SearchTypes</code> to list the next set of results. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SearchScope' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-DZType (SearchTypes)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.SearchTypesResponse, SearchDZTypeCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SearchScope;
            }
            ...
            #if MODULAR
            if (this.Managed == null && ParameterWasBound(nameof(this.Managed)))
            {
                WriteWarning("You are passing $null as a value for parameter Managed which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.SearchTypesRequest();
        ...
        private Amazon.DataZone.Model.SearchTypesResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.SearchTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "SearchTypes");
            try
            {
                #if DESKTOP
                return client.SearchTypes(request);
                #elif CORECLR
                return client.SearchTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Sort_Attribute { get; set; }
            public Amazon.DataZone.SortOrder Sort_Order { get; set; }
            public System.Func<Amazon.DataZone.Model.SearchTypesResponse, SearchDZTypeCmdlet, object> Select { get; set; } =
