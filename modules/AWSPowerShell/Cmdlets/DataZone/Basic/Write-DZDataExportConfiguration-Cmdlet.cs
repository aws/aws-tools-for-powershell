...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </para></li></ol></note>
    /// </summary>
    [Cmdlet("Write", "DZDataExportConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon DataZone PutDataExportConfiguration API operation.", Operation = new[] {"PutDataExportConfiguration"}, SelectReturnType = typeof(Amazon.DataZone.Model.PutDataExportConfigurationResponse))]
    [AWSCmdletOutput("None or Amazon.DataZone.Model.PutDataExportConfigurationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DataZone.Model.PutDataExportConfigurationResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteDZDataExportConfigurationCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The domain ID for which you want to create data export configuration details.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        #region Parameter EnableExport
        /// <summary>
        /// <para>
        /// <para>Specifies that the export is to be enabled as part of creating data export configuration
        /// details.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.Boolean? EnableExport { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The server-side encryption algorithm to use. Valid values are AES256 for S3-managed
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DataZone.Model.PutDataExportConfigurationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-DZDataExportConfiguration (PutDataExportConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.PutDataExportConfigurationResponse, WriteDZDataExportConfigurationCmdlet>(Select) ??
            ...
            #endif
            context.EnableExport = this.EnableExport;
            #if MODULAR
            if (this.EnableExport == null && ParameterWasBound(nameof(this.EnableExport)))
            {
                WriteWarning("You are passing $null as a value for parameter EnableExport which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.PutDataExportConfigurationRequest();
            ...
            if (cmdletContext.EnableExport != null)
            {
                request.EnableExport = cmdletContext.EnableExport.Value;
            }
            
             // populate EncryptionConfiguration
            var requestEncryptionConfigurationIsNull = true;
            request.EncryptionConfiguration = new Amazon.DataZone.Model.EncryptionConfiguration();
        ...
        private Amazon.DataZone.Model.PutDataExportConfigurationResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.PutDataExportConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "PutDataExportConfiguration");
            try
            {
                #if DESKTOP
                return client.PutDataExportConfiguration(request);
                #elif CORECLR
                return client.PutDataExportConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EncryptionConfiguration_KmsKeyArn { get; set; }
            public System.String EncryptionConfiguration_SseAlgorithm { get; set; }
            public System.Func<Amazon.DataZone.Model.PutDataExportConfigurationResponse, WriteDZDataExportConfigurationCmdlet, object> Select { get; set; } =
