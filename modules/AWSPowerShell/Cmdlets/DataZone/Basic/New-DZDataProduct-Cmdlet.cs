...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.CreateDataProductResponse",
        "This cmdlet returns an Amazon.DataZone.Model.CreateDataProductResponse object containing multiple properties."
    )]
    public partial class NewDZDataProductCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The metadata forms of the data product.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The glossary terms of the data product.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The data assets of the data product.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.DataZone.Model.CreateDataProductResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateDataProductRequest request)
        {
            ...
            try
            {
                return client.CreateDataProductAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
