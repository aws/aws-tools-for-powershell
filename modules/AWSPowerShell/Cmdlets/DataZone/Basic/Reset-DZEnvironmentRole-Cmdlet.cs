...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Reset", "DZEnvironmentRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class ResetDZEnvironmentRoleCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Reset-DZEnvironmentRole (DisassociateEnvironmentRole)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DisassociateEnvironmentRoleResponse, ResetDZEnvironmentRoleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DisassociateEnvironmentRoleRequest();
        ...
        private Amazon.DataZone.Model.DisassociateEnvironmentRoleResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DisassociateEnvironmentRoleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DisassociateEnvironmentRole");
            try
            {
                #if DESKTOP
                return client.DisassociateEnvironmentRole(request);
                #elif CORECLR
                return client.DisassociateEnvironmentRoleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String EnvironmentIdentifier { get; set; }
            public System.String EnvironmentRoleArn { get; set; }
            public System.Func<Amazon.DataZone.Model.DisassociateEnvironmentRoleResponse, ResetDZEnvironmentRoleCmdlet, object> Select { get; set; } =
