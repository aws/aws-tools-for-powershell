...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.EnvironmentBlueprintSummary or Amazon.DataZone.Model.ListEnvironmentBlueprintsResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListEnvironmentBlueprintsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZEnvironmentBlueprintListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of blueprints to return in a single call to <code>ListEnvironmentBlueprints</code>.
        /// When the number of blueprints to be listed is greater than the value of <code>MaxResults</code>,
        /// the response contains a <code>NextToken</code> value that you can use in a subsequent
        /// call to <code>ListEnvironmentBlueprints</code> to list the next set of blueprints.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// list the next set of blueprints.</para>
        /// </para>
        /// <para>
