...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.DataSourceRunSummary or Amazon.DataZone.Model.ListDataSourceRunsResponse",
        ...
        "The service call response (type Amazon.DataZone.Model.ListDataSourceRunsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZDataSourceRunListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the Amazon DataZone domain in which to invoke the <code>ListDataSourceRuns</code>
        /// action.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of runs to return in a single call to <code>ListDataSourceRuns</code>.
        /// When the number of runs to be listed is greater than the value of <code>MaxResults</code>,
        /// the response contains a <code>NextToken</code> value that you can use in a subsequent
        /// call to <code>ListDataSourceRuns</code> to list the next set of runs.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of runs is greater than the default value for the <code>MaxResults</code>
        /// parameter, or if you explicitly specify a value for <code>MaxResults</code> that is
        /// less than the number of runs, the response includes a pagination token named <code>NextToken</code>.
        /// You can specify this <code>NextToken</code> value in a subsequent call to <code>ListDataSourceRuns</code>
        ...
        private Amazon.DataZone.Model.ListDataSourceRunsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListDataSourceRunsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListDataSourceRuns(request);
                #elif CORECLR
                return client.ListDataSourceRunsAsync(request).GetAwaiter().GetResult();
                #else
