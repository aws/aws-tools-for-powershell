...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("New", "DZNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.CreateNotebookResponse")]
    [AWSCmdlet("Calls the Amazon DataZone CreateNotebook API operation.", Operation = new[] {"CreateNotebook"}, SelectReturnType = typeof(Amazon.DataZone.Model.CreateNotebookResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.CreateNotebookResponse",
        "This cmdlet returns an Amazon.DataZone.Model.CreateNotebookResponse object containing multiple properties."
    )]
    public partial class NewDZNotebookCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the Amazon SageMaker Unified Studio domain in which to create the
        /// notebook.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the project that owns the notebook.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DataZone.Model.CreateNotebookResponse).
        /// Specifying the name of a property of type Amazon.DataZone.Model.CreateNotebookResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.CreateNotebookResponse, NewDZNotebookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.CreateNotebookRequest();
        ...
        private Amazon.DataZone.Model.CreateNotebookResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateNotebookRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "CreateNotebook");
            try
            {
                return client.CreateNotebookAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
