...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.GetUserProfileResponse",
        "This cmdlet returns an Amazon.DataZone.Model.GetUserProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZUserProfileCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^UserIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.UserIdentifier;
            }
        ...
        private Amazon.DataZone.Model.GetUserProfileResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.GetUserProfileRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetUserProfileAsync(request).GetAwaiter().GetResult();
                #else
