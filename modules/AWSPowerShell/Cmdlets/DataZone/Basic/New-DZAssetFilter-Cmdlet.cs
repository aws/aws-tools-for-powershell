...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("New", "DZAssetFilter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewDZAssetFilterCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DZAssetFilter (CreateAssetFilter)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.CreateAssetFilterResponse, NewDZAssetFilterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.CreateAssetFilterRequest();
        ...
        private Amazon.DataZone.Model.CreateAssetFilterResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateAssetFilterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "CreateAssetFilter");
            try
            {
                #if DESKTOP
                return client.CreateAssetFilter(request);
                #elif CORECLR
                return client.CreateAssetFilterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DomainIdentifier { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.DataZone.Model.CreateAssetFilterResponse, NewDZAssetFilterCmdlet, object> Select { get; set; } =
