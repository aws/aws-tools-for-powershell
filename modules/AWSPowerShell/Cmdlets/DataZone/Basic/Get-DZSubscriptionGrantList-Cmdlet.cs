...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Get", "DZSubscriptionGrantList")]
    [OutputType("Amazon.DataZone.Model.ListSubscriptionGrantsResponse")]
    [AWSCmdlet("Calls the Amazon DataZone ListSubscriptionGrants API operation.", Operation = new[] {"ListSubscriptionGrants"}, SelectReturnType = typeof(Amazon.DataZone.Model.ListSubscriptionGrantsResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.ListSubscriptionGrantsResponse",
        "This cmdlet returns an Amazon.DataZone.Model.ListSubscriptionGrantsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDZSubscriptionGrantListCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        #region Parameter SubscriptionTargetId
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String SubscriptionTargetId { get; set; }
        #endregion
        
        #region Parameter MaxResult
        /// <summary>
        /// <para>
        /// <para>The maximum number of subscription grants to return in a single call to <code>ListSubscriptionGrants</code>.
        ...
        /// call to <code>ListSubscriptionGrants</code> to list the next set of subscription grants.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        /// <summary>
        /// <para>
        /// <para>When the number of subscription grants is greater than the default value for the <code>MaxResults</code>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.ListSubscriptionGrantsResponse, GetDZSubscriptionGrantListCmdlet>(Select) ??
            ...
            context.SubscriptionTargetId = this.SubscriptionTargetId;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataZone.Model.ListSubscriptionGrantsRequest();
            ...
            if (cmdletContext.SubscriptionTargetId != null)
            {
                request.SubscriptionTargetId = cmdletContext.SubscriptionTargetId;
            }
        ...
        private Amazon.DataZone.Model.ListSubscriptionGrantsResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.ListSubscriptionGrantsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "ListSubscriptionGrants");
            try
            {
                #if DESKTOP
                return client.ListSubscriptionGrants(request);
                #elif CORECLR
                return client.ListSubscriptionGrantsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SubscriptionId { get; set; }
            public System.String SubscriptionTargetId { get; set; }
            public System.Func<Amazon.DataZone.Model.ListSubscriptionGrantsResponse, GetDZSubscriptionGrantListCmdlet, object> Select { get; set; } =
