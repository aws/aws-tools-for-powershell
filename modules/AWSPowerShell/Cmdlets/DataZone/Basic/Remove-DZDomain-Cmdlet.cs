...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DZDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.DataZone.DomainStatus")]
    ...
    public partial class RemoveDZDomainCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZDomain (DeleteDomain)"))
            {
                return;
            }
        ...
        private Amazon.DataZone.Model.DeleteDomainResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DeleteDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DeleteDomain");
            try
            {
                #if DESKTOP
