...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    /// </summary>
    [Cmdlet("New", "DZAssetType", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DataZone.Model.CreateAssetTypeResponse")]
    [AWSCmdlet("Calls the Amazon DataZone CreateAssetType API operation.", Operation = new[] {"CreateAssetType"}, SelectReturnType = typeof(Amazon.DataZone.Model.CreateAssetTypeResponse))]
    [AWSCmdletOutput("Amazon.DataZone.Model.CreateAssetTypeResponse",
        "This cmdlet returns an Amazon.DataZone.Model.CreateAssetTypeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewDZAssetTypeCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.Collections.Hashtable FormsInput { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DZAssetType (CreateAssetType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.CreateAssetTypeResponse, NewDZAssetTypeCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.FormsInput == null && ParameterWasBound(nameof(this.FormsInput)))
            {
                WriteWarning("You are passing $null as a value for parameter FormsInput which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.CreateAssetTypeRequest();
        ...
        private Amazon.DataZone.Model.CreateAssetTypeResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.CreateAssetTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "CreateAssetType");
            try
            {
                #if DESKTOP
                return client.CreateAssetType(request);
                #elif CORECLR
                return client.CreateAssetTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.String DomainIdentifier { get; set; }
            public Dictionary<System.String, Amazon.DataZone.Model.FormEntryInput> FormsInput { get; set; }
            public System.String Name { get; set; }
            public System.String OwningProjectIdentifier { get; set; }
            public System.Func<Amazon.DataZone.Model.CreateAssetTypeResponse, NewDZAssetTypeCmdlet, object> Select { get; set; } =
