...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    public partial class RemoveDZFormTypeCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.FormTypeIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DZFormType (DeleteFormType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataZone.Model.DeleteFormTypeResponse, RemoveDZFormTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataZone.Model.DeleteFormTypeRequest();
        ...
        private Amazon.DataZone.Model.DeleteFormTypeResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.DeleteFormTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DataZone", "DeleteFormType");
            try
            {
                #if DESKTOP
                return client.DeleteFormType(request);
                #elif CORECLR
                return client.DeleteFormTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainIdentifier { get; set; }
            public System.String FormTypeIdentifier { get; set; }
            public System.Func<Amazon.DataZone.Model.DeleteFormTypeResponse, RemoveDZFormTypeCmdlet, object> Select { get; set; } =
