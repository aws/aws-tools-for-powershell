...
namespace Amazon.PowerShell.Cmdlets.DZ
{
    ...
    [AWSCmdletOutput("Amazon.DataZone.Model.StartMetadataGenerationRunResponse",
        "This cmdlet returns an Amazon.DataZone.Model.StartMetadataGenerationRunResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartDZMetadataGenerationRunCmdlet : AmazonDataZoneClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataZone.Model.StartMetadataGenerationRunResponse CallAWSServiceOperation(IAmazonDataZone client, Amazon.DataZone.Model.StartMetadataGenerationRunRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StartMetadataGenerationRun(request);
                #elif CORECLR
                return client.StartMetadataGenerationRunAsync(request).GetAwaiter().GetResult();
                #else
