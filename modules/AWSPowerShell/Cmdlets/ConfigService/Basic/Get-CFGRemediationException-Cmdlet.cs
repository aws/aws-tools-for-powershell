...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    /// </summary>
    [Cmdlet("Get", "CFGRemediationException")]
    [OutputType("Amazon.ConfigService.Model.RemediationException")]
    [AWSCmdlet("Calls the AWS Config DescribeRemediationExceptions API operation.", Operation = new[] {"DescribeRemediationExceptions"}, SelectReturnType = typeof(Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.RemediationException or Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.RemediationException objects.",
        "The service call response (type Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFGRemediationExceptionCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RemediationExceptions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse, GetCFGRemediationExceptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ConfigService.Model.DescribeRemediationExceptionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RemediationExceptions?.Count ?? 0;
        ...
        private Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DescribeRemediationExceptionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "DescribeRemediationExceptions");
            try
            {
                #if DESKTOP
                return client.DescribeRemediationExceptions(request);
                #elif CORECLR
                return client.DescribeRemediationExceptionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConfigService.Model.DescribeRemediationExceptionsResponse, GetCFGRemediationExceptionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RemediationExceptions;
        }
