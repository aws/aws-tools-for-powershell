...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdletOutput("Amazon.ConfigService.Model.ConformancePackEvaluationResult or Amazon.ConfigService.Model.GetConformancePackComplianceDetailsResponse",
        ...
        "The service call response (type Amazon.ConfigService.Model.GetConformancePackComplianceDetailsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ConformancePackRuleEvaluationResults.Count;
