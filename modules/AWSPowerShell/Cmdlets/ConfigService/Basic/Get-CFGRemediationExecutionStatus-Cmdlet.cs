...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config DescribeRemediationExecutionStatus API operation.", Operation = new[] {"DescribeRemediationExecutionStatus"}, SelectReturnType = typeof(Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.RemediationExecutionStatus or Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.RemediationExecutionStatus objects.",
        "The service call response (type Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFGRemediationExecutionStatusCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RemediationExecutionStatuses";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse, GetCFGRemediationExecutionStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RemediationExecutionStatuses?.Count ?? 0;
        ...
        private Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DescribeRemediationExecutionStatusRequest request)
        {
            ...
            try
            {
                return client.DescribeRemediationExecutionStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConfigService.Model.DescribeRemediationExecutionStatusResponse, GetCFGRemediationExecutionStatusCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RemediationExecutionStatuses;
        }
