...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config GetComplianceDetailsByConfigRule API operation.", Operation = new[] {"GetComplianceDetailsByConfigRule"}, SelectReturnType = typeof(Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.EvaluationResult or Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.EvaluationResult objects.",
        "The service call response (type Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFGComplianceDetailsByConfigRuleCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// as a <c>ComplianceType</c> for filtering results.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse, GetCFGComplianceDetailsByConfigRuleCmdlet>(Select) ??
        ...
        private Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "GetComplianceDetailsByConfigRule");
            try
            {
                return client.GetComplianceDetailsByConfigRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConfigService.Model.GetComplianceDetailsByConfigRuleResponse, GetCFGComplianceDetailsByConfigRuleCmdlet, object> Select { get; set; } =
