...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    /// with the aggregator.
    /// </summary>
    [Cmdlet("Remove", "CFGConfigurationAggregator", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCFGConfigurationAggregatorCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CFGConfigurationAggregator (DeleteConfigurationAggregator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DeleteConfigurationAggregatorResponse, RemoveCFGConfigurationAggregatorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConfigService.Model.DeleteConfigurationAggregatorRequest();
        ...
        private Amazon.ConfigService.Model.DeleteConfigurationAggregatorResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DeleteConfigurationAggregatorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "DeleteConfigurationAggregator");
            try
            {
                return client.DeleteConfigurationAggregatorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ConfigurationAggregatorName { get; set; }
            public System.Func<Amazon.ConfigService.Model.DeleteConfigurationAggregatorResponse, RemoveCFGConfigurationAggregatorCmdlet, object> Select { get; set; } =
