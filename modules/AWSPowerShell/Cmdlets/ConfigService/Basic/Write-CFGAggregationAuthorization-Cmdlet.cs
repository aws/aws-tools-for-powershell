...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    /// and region. 
    /// 
    ///  <note><para><c>PutAggregationAuthorization</c> is an idempotent API. Subsequent requests won’t
    ...
    public partial class WriteCFGAggregationAuthorizationCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AuthorizedAccountId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AuthorizedAccountId;
            }
