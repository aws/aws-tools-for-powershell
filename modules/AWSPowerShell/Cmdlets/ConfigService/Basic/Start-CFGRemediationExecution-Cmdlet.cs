...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class StartCFGRemediationExecutionCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ResourceKey' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ResourceKey), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.StartRemediationExecutionResponse, StartCFGRemediationExecutionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ResourceKey;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConfigService.Model.StartRemediationExecutionResponse, StartCFGRemediationExecutionCmdlet, object> Select { get; set; } =
