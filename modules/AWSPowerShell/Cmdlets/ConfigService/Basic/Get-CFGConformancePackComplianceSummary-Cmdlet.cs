...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    /// </summary>
    [Cmdlet("Get", "CFGConformancePackComplianceSummary")]
    [OutputType("Amazon.ConfigService.Model.ConformancePackComplianceSummary")]
    [AWSCmdlet("Calls the AWS Config GetConformancePackComplianceSummary API operation.", Operation = new[] {"GetConformancePackComplianceSummary"}, SelectReturnType = typeof(Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.ConformancePackComplianceSummary or Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.ConformancePackComplianceSummary objects.",
        "The service call response (type Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFGConformancePackComplianceSummaryCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConformancePackComplianceSummaryList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse, GetCFGConformancePackComplianceSummaryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ConfigService.Model.GetConformancePackComplianceSummaryRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ConformancePackComplianceSummaryList.Count;
        ...
        private Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.GetConformancePackComplianceSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "GetConformancePackComplianceSummary");
            try
            {
                #if DESKTOP
                return client.GetConformancePackComplianceSummary(request);
                #elif CORECLR
                return client.GetConformancePackComplianceSummaryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConfigService.Model.GetConformancePackComplianceSummaryResponse, GetCFGConformancePackComplianceSummaryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConformancePackComplianceSummaryList;
        }
