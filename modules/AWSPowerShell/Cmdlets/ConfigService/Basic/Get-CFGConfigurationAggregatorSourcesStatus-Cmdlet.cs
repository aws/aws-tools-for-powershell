...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class GetCFGConfigurationAggregatorSourcesStatusCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AggregatedSourceStatusList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DescribeConfigurationAggregatorSourcesStatusResponse, GetCFGConfigurationAggregatorSourcesStatusCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConfigService.Model.DescribeConfigurationAggregatorSourcesStatusResponse, GetCFGConfigurationAggregatorSourcesStatusCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AggregatedSourceStatusList;
        }
