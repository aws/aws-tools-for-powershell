...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class RemoveCFGEvaluationResultCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CFGEvaluationResult (DeleteEvaluationResults)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DeleteEvaluationResultsResponse, RemoveCFGEvaluationResultCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConfigService.Model.DeleteEvaluationResultsRequest();
        ...
        private Amazon.ConfigService.Model.DeleteEvaluationResultsResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DeleteEvaluationResultsRequest request)
        {
            ...
            try
            {
                return client.DeleteEvaluationResultsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ConfigRuleName { get; set; }
            public System.Func<Amazon.ConfigService.Model.DeleteEvaluationResultsResponse, RemoveCFGEvaluationResultCmdlet, object> Select { get; set; } =
