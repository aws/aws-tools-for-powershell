...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config DescribeConfigurationAggregators API operation.", Operation = new[] {"DescribeConfigurationAggregators"}, SelectReturnType = typeof(Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.ConfigurationAggregator or Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.ConfigurationAggregator objects.",
        "The service call response (type Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFGConfigurationAggregatorListCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the configuration aggregators.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConfigurationAggregators";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse, GetCFGConfigurationAggregatorListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.ConfigurationAggregatorName != null)
            {
                context.ConfigurationAggregatorName = new List<System.String>(this.ConfigurationAggregatorName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.ConfigurationAggregatorNames = cmdletContext.ConfigurationAggregatorName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ConfigurationAggregators?.Count ?? 0;
        ...
        private Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DescribeConfigurationAggregatorsRequest request)
        {
            ...
            try
            {
                return client.DescribeConfigurationAggregatorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<System.String> ConfigurationAggregatorName { get; set; }
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConfigService.Model.DescribeConfigurationAggregatorsResponse, GetCFGConfigurationAggregatorListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConfigurationAggregators;
        }
