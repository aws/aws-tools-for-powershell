...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class RemoveCFGPendingAggregationRequestCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RequesterAccountId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RequesterAccountId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DeletePendingAggregationRequestResponse, RemoveCFGPendingAggregationRequestCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RequesterAccountId;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.RequesterAccountId = this.RequesterAccountId;
            #if MODULAR
            if (this.RequesterAccountId == null && ParameterWasBound(nameof(this.RequesterAccountId)))
            {
                WriteWarning("You are passing $null as a value for parameter RequesterAccountId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.RequesterAwsRegion = this.RequesterAwsRegion;
            #if MODULAR
            if (this.RequesterAwsRegion == null && ParameterWasBound(nameof(this.RequesterAwsRegion)))
            {
                WriteWarning("You are passing $null as a value for parameter RequesterAwsRegion which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.ConfigService.Model.DeletePendingAggregationRequestResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DeletePendingAggregationRequestRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeletePendingAggregationRequestAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RequesterAccountId { get; set; }
            public System.String RequesterAwsRegion { get; set; }
            public System.Func<Amazon.ConfigService.Model.DeletePendingAggregationRequestResponse, RemoveCFGPendingAggregationRequestCmdlet, object> Select { get; set; } =
