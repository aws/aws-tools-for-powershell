...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class RemoveCFGRetentionConfigurationCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RetentionConfigurationName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RetentionConfigurationName), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DeleteRetentionConfigurationResponse, RemoveCFGRetentionConfigurationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RetentionConfigurationName;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.RetentionConfigurationName = this.RetentionConfigurationName;
            #if MODULAR
            if (this.RetentionConfigurationName == null && ParameterWasBound(nameof(this.RetentionConfigurationName)))
            {
                WriteWarning("You are passing $null as a value for parameter RetentionConfigurationName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        {
            public System.String RetentionConfigurationName { get; set; }
            public System.Func<Amazon.ConfigService.Model.DeleteRetentionConfigurationResponse, RemoveCFGRetentionConfigurationCmdlet, object> Select { get; set; } =
