...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    public partial class RemoveCFGAggregationAuthorizationCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DeleteAggregationAuthorizationResponse, RemoveCFGAggregationAuthorizationCmdlet>(Select) ??
        ...
        private Amazon.ConfigService.Model.DeleteAggregationAuthorizationResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DeleteAggregationAuthorizationRequest request)
        {
            ...
            try
            {
                return client.DeleteAggregationAuthorizationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AuthorizedAccountId { get; set; }
            public System.String AuthorizedAwsRegion { get; set; }
            public System.Func<Amazon.ConfigService.Model.DeleteAggregationAuthorizationResponse, RemoveCFGAggregationAuthorizationCmdlet, object> Select { get; set; } =
