...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config SelectResourceConfig API operation.", Operation = new[] {"SelectResourceConfig"}, SelectReturnType = typeof(Amazon.ConfigService.Model.SelectResourceConfigResponse))]
    [AWSCmdletOutput("System.String or Amazon.ConfigService.Model.SelectResourceConfigResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.ConfigService.Model.SelectResourceConfigResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SelectCFGResourceConfigCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.Expression), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Select-CFGResourceConfig (SelectResourceConfig)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.SelectResourceConfigResponse, SelectCFGResourceConfigCmdlet>(Select) ??
        ...
        private Amazon.ConfigService.Model.SelectResourceConfigResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.SelectResourceConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "SelectResourceConfig");
            try
            {
                #if DESKTOP
                return client.SelectResourceConfig(request);
                #elif CORECLR
                return client.SelectResourceConfigAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConfigService.Model.SelectResourceConfigResponse, SelectCFGResourceConfigCmdlet, object> Select { get; set; } =
