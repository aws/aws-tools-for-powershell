...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdletOutput("Amazon.ConfigService.Model.GetAggregateConformancePackComplianceSummaryResponse",
        "This cmdlet returns an Amazon.ConfigService.Model.GetAggregateConformancePackComplianceSummaryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
