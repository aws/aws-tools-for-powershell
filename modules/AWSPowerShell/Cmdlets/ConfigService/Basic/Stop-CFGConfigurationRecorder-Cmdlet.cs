...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Config StopConfigurationRecorder API operation.", Operation = new[] {"StopConfigurationRecorder"}, SelectReturnType = typeof(Amazon.ConfigService.Model.StopConfigurationRecorderResponse))]
    [AWSCmdletOutput("None or Amazon.ConfigService.Model.StopConfigurationRecorderResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ConfigService.Model.StopConfigurationRecorderResponse) be returned by specifying '-Select *'."
    )]
    public partial class StopCFGConfigurationRecorderCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.StopConfigurationRecorderResponse, StopCFGConfigurationRecorderCmdlet>(Select) ??
        ...
        private Amazon.ConfigService.Model.StopConfigurationRecorderResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.StopConfigurationRecorderRequest request)
        {
            ...
            try
            {
                return client.StopConfigurationRecorderAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ConfigurationRecorderName { get; set; }
            public System.Func<Amazon.ConfigService.Model.StopConfigurationRecorderResponse, StopCFGConfigurationRecorderCmdlet, object> Select { get; set; } =
