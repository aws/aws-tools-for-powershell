...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config DescribeAggregationAuthorizations API operation.", Operation = new[] {"DescribeAggregationAuthorizations"}, SelectReturnType = typeof(Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse))]
    [AWSCmdletOutput("Amazon.ConfigService.Model.AggregationAuthorization or Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse",
        "This cmdlet returns a collection of Amazon.ConfigService.Model.AggregationAuthorization objects.",
        "The service call response (type Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCFGAggregationAuthorizationListCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AggregationAuthorizations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse, GetCFGAggregationAuthorizationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AggregationAuthorizations?.Count ?? 0;
        ...
        private Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.DescribeAggregationAuthorizationsRequest request)
        {
            ...
            try
            {
                return client.DescribeAggregationAuthorizationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ConfigService.Model.DescribeAggregationAuthorizationsResponse, GetCFGAggregationAuthorizationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AggregationAuthorizations;
        }
