...
namespace Amazon.PowerShell.Cmdlets.DOPS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DOPSAssetFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS DevOps Agent Service DeleteAssetFile API operation.", Operation = new[] {"DeleteAssetFile"}, SelectReturnType = typeof(Amazon.DevOpsAgent.Model.DeleteAssetFileResponse))]
    [AWSCmdletOutput("None or Amazon.DevOpsAgent.Model.DeleteAssetFileResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DevOpsAgent.Model.DeleteAssetFileResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveDOPSAssetFileCmdlet : AmazonDevOpsAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the asset containing the file</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The path of the file within the asset to delete</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DevOpsAgent.Model.DeleteAssetFileResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DOPSAssetFile (DeleteAssetFile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsAgent.Model.DeleteAssetFileResponse, RemoveDOPSAssetFileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DevOpsAgent.Model.DeleteAssetFileRequest();
        ...
        private Amazon.DevOpsAgent.Model.DeleteAssetFileResponse CallAWSServiceOperation(IAmazonDevOpsAgent client, Amazon.DevOpsAgent.Model.DeleteAssetFileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DevOps Agent Service", "DeleteAssetFile");
            try
            {
                return client.DeleteAssetFileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AssetId { get; set; }
            public System.String Path { get; set; }
            public System.Func<Amazon.DevOpsAgent.Model.DeleteAssetFileResponse, RemoveDOPSAssetFileCmdlet, object> Select { get; set; } =
