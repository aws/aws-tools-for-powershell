...
namespace Amazon.PowerShell.Cmdlets.DOPS
{
    ...
    /// on success.
    /// </summary>
    [Cmdlet("Update", "DOPSAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DevOpsAgent.Model.UpdateAssociationResponse")]
    [AWSCmdlet("Calls the AWS DevOps Agent Service UpdateAssociation API operation.", Operation = new[] {"UpdateAssociation"}, SelectReturnType = typeof(Amazon.DevOpsAgent.Model.UpdateAssociationResponse))]
    [AWSCmdletOutput("Amazon.DevOpsAgent.Model.UpdateAssociationResponse",
        "This cmdlet returns an Amazon.DevOpsAgent.Model.UpdateAssociationResponse object containing multiple properties."
    )]
    public partial class UpdateDOPSAssociationCmdlet : AmazonDevOpsAgentClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DevOpsAgent.Model.UpdateAssociationResponse).
        /// Specifying the name of a property of type Amazon.DevOpsAgent.Model.UpdateAssociationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-DOPSAssociation (UpdateAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsAgent.Model.UpdateAssociationResponse, UpdateDOPSAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DevOpsAgent.Model.UpdateAssociationRequest();
        ...
        private Amazon.DevOpsAgent.Model.UpdateAssociationResponse CallAWSServiceOperation(IAmazonDevOpsAgent client, Amazon.DevOpsAgent.Model.UpdateAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DevOps Agent Service", "UpdateAssociation");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Configuration_SourceAws_AssumableRoleArn { get; set; }
            public System.String Configuration_SourceAws_ExternalId { get; set; }
            public System.Func<Amazon.DevOpsAgent.Model.UpdateAssociationResponse, UpdateDOPSAssociationCmdlet, object> Select { get; set; } =
