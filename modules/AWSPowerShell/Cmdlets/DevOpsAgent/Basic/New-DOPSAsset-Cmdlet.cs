...
namespace Amazon.PowerShell.Cmdlets.DOPS
{
    ...
    /// </summary>
    [Cmdlet("New", "DOPSAsset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DevOpsAgent.Model.Asset")]
    [AWSCmdlet("Calls the AWS DevOps Agent Service CreateAsset API operation.", Operation = new[] {"CreateAsset"}, SelectReturnType = typeof(Amazon.DevOpsAgent.Model.CreateAssetResponse))]
    [AWSCmdletOutput("Amazon.DevOpsAgent.Model.Asset or Amazon.DevOpsAgent.Model.CreateAssetResponse",
        "This cmdlet returns an Amazon.DevOpsAgent.Model.Asset object.",
        "The service call response (type Amazon.DevOpsAgent.Model.CreateAssetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewDOPSAssetCmdlet : AmazonDevOpsAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier for the agent space where the asset will be created</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The type of asset to create</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The metadata describing this asset</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A unique, case-sensitive identifier used for idempotent asset creation</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DevOpsAgent.Model.CreateAssetResponse).
        /// Specifying the name of a property of type Amazon.DevOpsAgent.Model.CreateAssetResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-DOPSAsset (CreateAsset)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsAgent.Model.CreateAssetResponse, NewDOPSAssetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.DevOpsAgent.Model.CreateAssetRequest();
        ...
        private Amazon.DevOpsAgent.Model.CreateAssetResponse CallAWSServiceOperation(IAmazonDevOpsAgent client, Amazon.DevOpsAgent.Model.CreateAssetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DevOps Agent Service", "CreateAsset");
            try
            {
