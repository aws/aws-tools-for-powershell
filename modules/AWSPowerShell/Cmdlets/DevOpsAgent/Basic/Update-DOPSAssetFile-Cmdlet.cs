...
namespace Amazon.PowerShell.Cmdlets.DOPS
{
    ...
    /// </summary>
    [Cmdlet("Update", "DOPSAssetFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.DevOpsAgent.Model.AssetFile")]
    [AWSCmdlet("Calls the AWS DevOps Agent Service UpdateAssetFile API operation.", Operation = new[] {"UpdateAssetFile"}, SelectReturnType = typeof(Amazon.DevOpsAgent.Model.UpdateAssetFileResponse))]
    [AWSCmdletOutput("Amazon.DevOpsAgent.Model.AssetFile or Amazon.DevOpsAgent.Model.UpdateAssetFileResponse",
        "This cmdlet returns an Amazon.DevOpsAgent.Model.AssetFile object.",
        "The service call response (type Amazon.DevOpsAgent.Model.UpdateAssetFileResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateDOPSAssetFileCmdlet : AmazonDevOpsAgentClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The path of the file within the asset to update</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A unique, case-sensitive identifier used for idempotent asset file update</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.DevOpsAgent.Model.UpdateAssetFileResponse).
        /// Specifying the name of a property of type Amazon.DevOpsAgent.Model.UpdateAssetFileResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-DOPSAssetFile (UpdateAssetFile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DevOpsAgent.Model.UpdateAssetFileResponse, UpdateDOPSAssetFileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                // create request
                var request = new Amazon.DevOpsAgent.Model.UpdateAssetFileRequest();
        ...
        private Amazon.DevOpsAgent.Model.UpdateAssetFileResponse CallAWSServiceOperation(IAmazonDevOpsAgent client, Amazon.DevOpsAgent.Model.UpdateAssetFileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DevOps Agent Service", "UpdateAssetFile");
            try
            {
                return client.UpdateAssetFileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Management.Automation.PSObject Metadata { get; set; }
            public System.String Path { get; set; }
            public System.Func<Amazon.DevOpsAgent.Model.UpdateAssetFileResponse, UpdateDOPSAssetFileCmdlet, object> Select { get; set; } =
