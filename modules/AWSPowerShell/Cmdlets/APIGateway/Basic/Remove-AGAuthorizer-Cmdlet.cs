...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteAuthorizer API operation.", Operation = new[] {"DeleteAuthorizer"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteAuthorizerResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteAuthorizerResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteAuthorizerResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGAuthorizerCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteAuthorizerResponse, RemoveAGAuthorizerCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteAuthorizerResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteAuthorizerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "DeleteAuthorizer");
            try
            {
                return client.DeleteAuthorizerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AuthorizerId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteAuthorizerResponse, RemoveAGAuthorizerCmdlet, object> Select { get; set; } =
