...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteGatewayResponse API operation.", Operation = new[] {"DeleteGatewayResponse"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteGatewayResponseResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteGatewayResponseResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteGatewayResponseResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGGatewayResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteGatewayResponseResponse, RemoveAGGatewayResponseCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteGatewayResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteGatewayResponseRequest request)
        {
            ...
            try
            {
                return client.DeleteGatewayResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.APIGateway.GatewayResponseType ResponseType { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteGatewayResponseResponse, RemoveAGGatewayResponseCmdlet, object> Select { get; set; } =
