...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway UpdateVpcLink API operation.", Operation = new[] {"UpdateVpcLink"}, SelectReturnType = typeof(Amazon.APIGateway.Model.UpdateVpcLinkResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateVpcLinkResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.UpdateVpcLinkResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAGVpcLinkCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^VpcLinkId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AGVpcLink (UpdateVpcLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.UpdateVpcLinkResponse, UpdateAGVpcLinkCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.VpcLinkId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.UpdateVpcLinkRequest();
        ...
        private Amazon.APIGateway.Model.UpdateVpcLinkResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateVpcLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "UpdateVpcLink");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcLinkId { get; set; }
            public System.Func<Amazon.APIGateway.Model.UpdateVpcLinkResponse, UpdateAGVpcLinkCmdlet, object> Select { get; set; } =
