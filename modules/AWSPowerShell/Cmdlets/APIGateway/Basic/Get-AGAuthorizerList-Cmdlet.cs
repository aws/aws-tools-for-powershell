...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetAuthorizers API operation.", Operation = new[] {"GetAuthorizers"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetAuthorizersResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.Authorizer or Amazon.APIGateway.Model.GetAuthorizersResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.Authorizer objects.",
        "The service call response (type Amazon.APIGateway.Model.GetAuthorizersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGAuthorizerListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetAuthorizersResponse, GetAGAuthorizerListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Position { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetAuthorizersResponse, GetAGAuthorizerListCmdlet, object> Select { get; set; } =
