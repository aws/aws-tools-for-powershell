...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteIntegration API operation.", Operation = new[] {"DeleteIntegration"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteIntegrationResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteIntegrationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteIntegrationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGIntegrationCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AGIntegration (DeleteIntegration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteIntegrationResponse, RemoveAGIntegrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.DeleteIntegrationRequest();
        ...
        private Amazon.APIGateway.Model.DeleteIntegrationResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteIntegrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "DeleteIntegration");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteIntegrationResponse, RemoveAGIntegrationCmdlet, object> Select { get; set; } =
