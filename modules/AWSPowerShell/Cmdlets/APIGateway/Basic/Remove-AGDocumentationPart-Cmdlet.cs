...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class RemoveAGDocumentationPartCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteDocumentationPartResponse, RemoveAGDocumentationPartCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteDocumentationPartResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteDocumentationPartRequest request)
        {
            ...
            try
            {
                return client.DeleteDocumentationPartAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DocumentationPartId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteDocumentationPartResponse, RemoveAGDocumentationPartCmdlet, object> Select { get; set; } =
