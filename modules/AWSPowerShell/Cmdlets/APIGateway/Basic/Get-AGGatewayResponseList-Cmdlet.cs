...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetGatewayResponses API operation.", Operation = new[] {"GetGatewayResponses"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetGatewayResponsesResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.GatewayResponse or Amazon.APIGateway.Model.GetGatewayResponsesResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.GatewayResponse objects.",
        "The service call response (type Amazon.APIGateway.Model.GetGatewayResponsesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAGGatewayResponseListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetGatewayResponsesResponse, GetAGGatewayResponseListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetGatewayResponsesRequest();
        ...
        private Amazon.APIGateway.Model.GetGatewayResponsesResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetGatewayResponsesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetGatewayResponses");
            try
            {
                #if DESKTOP
                return client.GetGatewayResponses(request);
                #elif CORECLR
                return client.GetGatewayResponsesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Position { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetGatewayResponsesResponse, GetAGGatewayResponseListCmdlet, object> Select { get; set; } =
