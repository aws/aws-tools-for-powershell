...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class RemoveAGRequestValidatorCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RequestValidatorId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteRequestValidatorResponse, RemoveAGRequestValidatorCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RequestValidatorId;
            }
        ...
        private Amazon.APIGateway.Model.DeleteRequestValidatorResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteRequestValidatorRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteRequestValidatorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RequestValidatorId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteRequestValidatorResponse, RemoveAGRequestValidatorCmdlet, object> Select { get; set; } =
