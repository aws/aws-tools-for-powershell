...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway CreateDocumentationVersion API operation.", Operation = new[] {"CreateDocumentationVersion"}, SelectReturnType = typeof(Amazon.APIGateway.Model.CreateDocumentationVersionResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.CreateDocumentationVersionResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.CreateDocumentationVersionResponse object containing multiple properties."
    )]
    public partial class NewAGDocumentationVersionCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.CreateDocumentationVersionResponse, NewAGDocumentationVersionCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.CreateDocumentationVersionResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.CreateDocumentationVersionRequest request)
        {
            ...
            try
            {
                return client.CreateDocumentationVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RestApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.APIGateway.Model.CreateDocumentationVersionResponse, NewAGDocumentationVersionCmdlet, object> Select { get; set; } =
