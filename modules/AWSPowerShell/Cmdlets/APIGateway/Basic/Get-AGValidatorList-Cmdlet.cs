...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class GetAGValidatorListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetRequestValidatorsResponse, GetAGValidatorListCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.GetRequestValidatorsResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetRequestValidatorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetRequestValidators");
            try
            {
                return client.GetRequestValidatorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Position { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetRequestValidatorsResponse, GetAGValidatorListCmdlet, object> Select { get; set; } =
