...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetModels API operation.", Operation = new[] {"GetModels"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetModelsResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.Model or Amazon.APIGateway.Model.GetModelsResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.Model objects.",
        "The service call response (type Amazon.APIGateway.Model.GetModelsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGModelListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetModelsResponse, GetAGModelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetModelsRequest();
        ...
        private Amazon.APIGateway.Model.GetModelsResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetModelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetModels");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Position { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetModelsResponse, GetAGModelListCmdlet, object> Select { get; set; } =
