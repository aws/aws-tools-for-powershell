...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway FlushStageAuthorizersCache API operation.", Operation = new[] {"FlushStageAuthorizersCache"}, SelectReturnType = typeof(Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse) be returned by specifying '-Select *'."
    )]
    public partial class ClearAGStageAuthorizersCacheCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse, ClearAGStageAuthorizersCacheCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.FlushStageAuthorizersCacheRequest request)
        {
            ...
            try
            {
                return client.FlushStageAuthorizersCacheAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RestApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.APIGateway.Model.FlushStageAuthorizersCacheResponse, ClearAGStageAuthorizersCacheCmdlet, object> Select { get; set; } =
