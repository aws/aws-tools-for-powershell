...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetGatewayResponse API operation.", Operation = new[] {"GetGatewayResponse"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetGatewayResponseResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.GetGatewayResponseResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.GetGatewayResponseResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAGGatewayResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetGatewayResponseResponse, GetAGGatewayResponseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.GetGatewayResponseRequest();
        ...
        private Amazon.APIGateway.Model.GetGatewayResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetGatewayResponseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetGatewayResponse");
            try
            {
                #if DESKTOP
                return client.GetGatewayResponse(request);
                #elif CORECLR
                return client.GetGatewayResponseAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.APIGateway.GatewayResponseType ResponseType { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetGatewayResponseResponse, GetAGGatewayResponseCmdlet, object> Select { get; set; } =
