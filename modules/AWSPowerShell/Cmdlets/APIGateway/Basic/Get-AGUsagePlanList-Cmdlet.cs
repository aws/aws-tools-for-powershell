...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetUsagePlans API operation.", Operation = new[] {"GetUsagePlans"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetUsagePlansResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UsagePlan or Amazon.APIGateway.Model.GetUsagePlansResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.UsagePlan objects.",
        "The service call response (type Amazon.APIGateway.Model.GetUsagePlansResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGUsagePlanListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetUsagePlansResponse, GetAGUsagePlanListCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.GetUsagePlansResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetUsagePlansRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetUsagePlans");
            try
            {
                return client.GetUsagePlansAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? Limit { get; set; }
            public System.String Position { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetUsagePlansResponse, GetAGUsagePlanListCmdlet, object> Select { get; set; } =
