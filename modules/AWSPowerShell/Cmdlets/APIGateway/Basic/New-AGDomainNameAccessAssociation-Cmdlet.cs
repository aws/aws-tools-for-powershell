...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class NewAGDomainNameAccessAssociationCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the DomainNameArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^DomainNameArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DomainNameArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.DomainNameArn;
            }
        ...
        private Amazon.APIGateway.Model.CreateDomainNameAccessAssociationResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.CreateDomainNameAccessAssociationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateDomainNameAccessAssociation(request);
                #elif CORECLR
                return client.CreateDomainNameAccessAssociationAsync(request).GetAwaiter().GetResult();
                #else
