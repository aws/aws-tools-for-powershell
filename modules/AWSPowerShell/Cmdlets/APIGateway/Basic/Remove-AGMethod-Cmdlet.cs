...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteMethod API operation.", Operation = new[] {"DeleteMethod"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteMethodResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteMethodResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteMethodResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGMethodCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteMethodResponse, RemoveAGMethodCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteMethodResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteMethodRequest request)
        {
            ...
            try
            {
                return client.DeleteMethodAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteMethodResponse, RemoveAGMethodCmdlet, object> Select { get; set; } =
