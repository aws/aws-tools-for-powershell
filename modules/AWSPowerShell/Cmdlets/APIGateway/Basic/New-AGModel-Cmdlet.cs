...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.CreateModelResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.CreateModelResponse object containing multiple properties."
    )]
    public partial class NewAGModelCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.CreateModelResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.CreateModelRequest request)
        {
            ...
            try
            {
                return client.CreateModelAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
