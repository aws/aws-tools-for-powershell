...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteIntegrationResponse API operation.", Operation = new[] {"DeleteIntegrationResponse"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteIntegrationResponseResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteIntegrationResponseResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteIntegrationResponseResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGIntegrationResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteIntegrationResponseResponse, RemoveAGIntegrationResponseCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteIntegrationResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteIntegrationResponseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "DeleteIntegrationResponse");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RestApiId { get; set; }
            public System.String StatusCode { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteIntegrationResponseResponse, RemoveAGIntegrationResponseCmdlet, object> Select { get; set; } =
