...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Disable", "AGDomainNameAccessAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway RejectDomainNameAccessAssociation API operation.", Operation = new[] {"RejectDomainNameAccessAssociation"}, SelectReturnType = typeof(Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse) be returned by specifying '-Select *'."
    )]
    public partial class DisableAGDomainNameAccessAssociationCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-AGDomainNameAccessAssociation (RejectDomainNameAccessAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse, DisableAGDomainNameAccessAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.RejectDomainNameAccessAssociationRequest();
        ...
        private Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.RejectDomainNameAccessAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "RejectDomainNameAccessAssociation");
            try
            {
                #if DESKTOP
                return client.RejectDomainNameAccessAssociation(request);
                #elif CORECLR
                return client.RejectDomainNameAccessAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainNameAccessAssociationArn { get; set; }
            public System.String DomainNameArn { get; set; }
            public System.Func<Amazon.APIGateway.Model.RejectDomainNameAccessAssociationResponse, DisableAGDomainNameAccessAssociationCmdlet, object> Select { get; set; } =
