...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateMethodResponseResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.UpdateMethodResponseResponse object containing multiple properties."
    )]
    public partial class UpdateAGMethodResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.UpdateMethodResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateMethodResponseRequest request)
        {
            ...
            try
            {
                return client.UpdateMethodResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
