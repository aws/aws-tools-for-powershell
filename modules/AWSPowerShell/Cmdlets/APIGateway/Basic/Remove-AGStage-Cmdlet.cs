...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AGStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteStage API operation.", Operation = new[] {"DeleteStage"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteStageResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteStageResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteStageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAGStageCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AGStage (DeleteStage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteStageResponse, RemoveAGStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.DeleteStageRequest();
        ...
        private Amazon.APIGateway.Model.DeleteStageResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "DeleteStage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RestApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteStageResponse, RemoveAGStageCmdlet, object> Select { get; set; } =
