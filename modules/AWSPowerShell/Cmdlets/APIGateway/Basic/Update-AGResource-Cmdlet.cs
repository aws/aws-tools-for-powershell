...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway UpdateResource API operation.", Operation = new[] {"UpdateResource"}, SelectReturnType = typeof(Amazon.APIGateway.Model.UpdateResourceResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateResourceResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.UpdateResourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAGResourceCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.UpdateResourceResponse, UpdateAGResourceCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceId { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.UpdateResourceResponse, UpdateAGResourceCmdlet, object> Select { get; set; } =
