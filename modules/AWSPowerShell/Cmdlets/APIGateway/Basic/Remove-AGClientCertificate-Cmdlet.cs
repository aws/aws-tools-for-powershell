...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteClientCertificate API operation.", Operation = new[] {"DeleteClientCertificate"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteClientCertificateResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteClientCertificateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteClientCertificateResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGClientCertificateCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteClientCertificateResponse, RemoveAGClientCertificateCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteClientCertificateResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteClientCertificateRequest request)
        {
            ...
            try
            {
                return client.DeleteClientCertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ClientCertificateId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteClientCertificateResponse, RemoveAGClientCertificateCmdlet, object> Select { get; set; } =
