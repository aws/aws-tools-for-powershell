...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteModel API operation.", Operation = new[] {"DeleteModel"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteModelResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteModelResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteModelResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGModelCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteModelResponse, RemoveAGModelCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteModelResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "DeleteModel");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ModelName { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteModelResponse, RemoveAGModelCmdlet, object> Select { get; set; } =
