...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetRestApis API operation.", Operation = new[] {"GetRestApis"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetRestApisResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.RestApi or Amazon.APIGateway.Model.GetRestApisResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.RestApi objects.",
        "The service call response (type Amazon.APIGateway.Model.GetRestApisResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGRestApiListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetRestApisResponse, GetAGRestApiListCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.GetRestApisResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetRestApisRequest request)
        {
            ...
            try
            {
                return client.GetRestApisAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String Position { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetRestApisResponse, GetAGRestApiListCmdlet, object> Select { get; set; } =
