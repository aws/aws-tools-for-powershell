...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetVpcLinks API operation.", Operation = new[] {"GetVpcLinks"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetVpcLinksResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.VpcLink or Amazon.APIGateway.Model.GetVpcLinksResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.VpcLink objects.",
        "The service call response (type Amazon.APIGateway.Model.GetVpcLinksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGVpcLinkListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetVpcLinksResponse, GetAGVpcLinkListCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.GetVpcLinksResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetVpcLinksRequest request)
        {
            ...
            try
            {
                return client.GetVpcLinksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? Limit { get; set; }
            public System.String Position { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetVpcLinksResponse, GetAGVpcLinkListCmdlet, object> Select { get; set; } =
