...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.GetMethodResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.GetMethodResponse object containing multiple properties."
    )]
    public partial class GetAGMethodCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.GetMethodResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetMethodRequest request)
        {
            ...
            try
            {
                return client.GetMethodAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
