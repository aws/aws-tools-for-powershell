...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetStage API operation.", Operation = new[] {"GetStage"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetStageResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.GetStageResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.GetStageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAGStageCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetStageResponse, GetAGStageCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RestApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetStageResponse, GetAGStageCmdlet, object> Select { get; set; } =
