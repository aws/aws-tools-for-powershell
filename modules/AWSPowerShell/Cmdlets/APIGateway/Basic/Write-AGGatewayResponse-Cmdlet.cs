...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.PutGatewayResponseResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.PutGatewayResponseResponse object containing multiple properties."
    )]
    public partial class WriteAGGatewayResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        /// string-to-string map of key-value pairs.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Response templates of the GatewayResponse as a string-to-string map of key-value pairs.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.APIGateway.Model.PutGatewayResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.PutGatewayResponseRequest request)
        {
            ...
            try
            {
                return client.PutGatewayResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
