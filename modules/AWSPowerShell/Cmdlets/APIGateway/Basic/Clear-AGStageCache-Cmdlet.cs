...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    public partial class ClearAGStageCacheCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.FlushStageCacheResponse, ClearAGStageCacheCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.FlushStageCacheResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.FlushStageCacheRequest request)
        {
            ...
            try
            {
                return client.FlushStageCacheAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String RestApiId { get; set; }
            public System.String StageName { get; set; }
            public System.Func<Amazon.APIGateway.Model.FlushStageCacheResponse, ClearAGStageCacheCmdlet, object> Select { get; set; } =
