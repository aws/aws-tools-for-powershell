...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    /// </summary>
    [Cmdlet("Update", "AGRestApi", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.APIGateway.Model.UpdateRestApiResponse")]
    [AWSCmdlet("Calls the Amazon API Gateway UpdateRestApi API operation.", Operation = new[] {"UpdateRestApi"}, SelectReturnType = typeof(Amazon.APIGateway.Model.UpdateRestApiResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateRestApiResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.UpdateRestApiResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAGRestApiCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-AGRestApi (UpdateRestApi)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.UpdateRestApiResponse, UpdateAGRestApiCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.APIGateway.Model.UpdateRestApiRequest();
        ...
        private Amazon.APIGateway.Model.UpdateRestApiResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateRestApiRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "UpdateRestApi");
            try
            {
                #if DESKTOP
                return client.UpdateRestApi(request);
                #elif CORECLR
                return client.UpdateRestApiAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.UpdateRestApiResponse, UpdateAGRestApiCmdlet, object> Select { get; set; } =
