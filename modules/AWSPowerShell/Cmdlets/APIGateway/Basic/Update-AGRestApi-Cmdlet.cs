...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.UpdateRestApiResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.UpdateRestApiResponse object containing multiple properties."
    )]
    public partial class UpdateAGRestApiCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.UpdateRestApiResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.UpdateRestApiRequest request)
        {
            ...
            try
            {
                return client.UpdateRestApiAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
