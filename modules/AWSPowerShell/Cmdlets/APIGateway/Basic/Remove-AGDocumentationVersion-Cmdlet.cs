...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon API Gateway DeleteDocumentationVersion API operation.", Operation = new[] {"DeleteDocumentationVersion"}, SelectReturnType = typeof(Amazon.APIGateway.Model.DeleteDocumentationVersionResponse))]
    [AWSCmdletOutput("None or Amazon.APIGateway.Model.DeleteDocumentationVersionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.APIGateway.Model.DeleteDocumentationVersionResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAGDocumentationVersionCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.DeleteDocumentationVersionResponse, RemoveAGDocumentationVersionCmdlet>(Select) ??
        ...
        private Amazon.APIGateway.Model.DeleteDocumentationVersionResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.DeleteDocumentationVersionRequest request)
        {
            ...
            try
            {
                return client.DeleteDocumentationVersionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DocumentationVersion { get; set; }
            public System.String RestApiId { get; set; }
            public System.Func<Amazon.APIGateway.Model.DeleteDocumentationVersionResponse, RemoveAGDocumentationVersionCmdlet, object> Select { get; set; } =
