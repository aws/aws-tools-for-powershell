...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway GetUsagePlanKeys API operation.", Operation = new[] {"GetUsagePlanKeys"}, SelectReturnType = typeof(Amazon.APIGateway.Model.GetUsagePlanKeysResponse))]
    [AWSCmdletOutput("Amazon.APIGateway.Model.UsagePlanKey or Amazon.APIGateway.Model.GetUsagePlanKeysResponse",
        "This cmdlet returns a collection of Amazon.APIGateway.Model.UsagePlanKey objects.",
        "The service call response (type Amazon.APIGateway.Model.GetUsagePlanKeysResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAGUsagePlanKeyListCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.APIGateway.Model.GetUsagePlanKeysResponse, GetAGUsagePlanKeyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.APIGateway.Model.GetUsagePlanKeysRequest();
        ...
        private Amazon.APIGateway.Model.GetUsagePlanKeysResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetUsagePlanKeysRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway", "GetUsagePlanKeys");
            try
            {
                #if DESKTOP
                return client.GetUsagePlanKeys(request);
                #elif CORECLR
                return client.GetUsagePlanKeysAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Position { get; set; }
            public System.String UsagePlanId { get; set; }
            public System.Func<Amazon.APIGateway.Model.GetUsagePlanKeysResponse, GetAGUsagePlanKeyListCmdlet, object> Select { get; set; } =
