...
namespace Amazon.PowerShell.Cmdlets.AG
{
    ...
    [AWSCmdletOutput("Amazon.APIGateway.Model.GetMethodResponseResponse",
        "This cmdlet returns an Amazon.APIGateway.Model.GetMethodResponseResponse object containing multiple properties."
    )]
    public partial class GetAGMethodResponseCmdlet : AmazonAPIGatewayClientCmdlet, IExecutor
    {
        ...
        private Amazon.APIGateway.Model.GetMethodResponseResponse CallAWSServiceOperation(IAmazonAPIGateway client, Amazon.APIGateway.Model.GetMethodResponseRequest request)
        {
            ...
            try
            {
                return client.GetMethodResponseAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
