...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    public partial class GetDDBTableReplicaAutoScalingCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DynamoDBv2.Model.DescribeTableReplicaAutoScalingResponse, GetDDBTableReplicaAutoScalingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DynamoDBv2.Model.DescribeTableReplicaAutoScalingRequest();
        ...
        private Amazon.DynamoDBv2.Model.DescribeTableReplicaAutoScalingResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.DescribeTableReplicaAutoScalingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB", "DescribeTableReplicaAutoScaling");
            try
            {
                #if DESKTOP
                return client.DescribeTableReplicaAutoScaling(request);
                #elif CORECLR
                return client.DescribeTableReplicaAutoScalingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TableName { get; set; }
            public System.Func<Amazon.DynamoDBv2.Model.DescribeTableReplicaAutoScalingResponse, GetDDBTableReplicaAutoScalingCmdlet, object> Select { get; set; } =
