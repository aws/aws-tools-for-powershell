...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdletOutput("System.String or Amazon.DynamoDBv2.Model.DeleteItemResponse",
        ...
        "The service call response (type Amazon.DynamoDBv2.Model.DeleteItemResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveDDBItemCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A condition that must be satisfied in order for a conditional <c>DeleteItem</c> to
        /// succeed.</para><para>An expression can contain any of the following:</para><ul><li><para>Functions: <c>attribute_exists | attribute_not_exists | attribute_type | contains
        /// | begins_with | size</c></para><para>These function names are case-sensitive.</para></li><li><para>Comparison operators: <c>= | &lt;&gt; | &lt; | &gt; | &lt;= | &gt;= | BETWEEN | IN
        /// </c></para></li><li><para> Logical operators: <c>AND | OR | NOT</c></para></li></ul><para>For more information about condition expressions, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html">Condition
        ...
        /// key of the item to delete.</para><para>For the primary key, you must provide all of the key attributes. For example, with
        ...
        /// they were deleted. For <c>DeleteItem</c>, the valid values are:</para><ul><li><para><c>NONE</c> - If <c>ReturnValues</c> is not specified, or if its value is <c>NONE</c>,
        /// then nothing is returned. (This setting is the default for <c>ReturnValues</c>.)</para></li><li><para><c>ALL_OLD</c> - The content of the old item is returned.</para></li></ul><para>There is no additional cost associated with requesting a return value aside from the
        ...
        /// <c>DeleteItem</c> does not recognize any values other than <c>NONE</c> or <c>ALL_OLD</c>.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("ReturnValues")]
        ...
        /// <summary>
        /// <para>
        /// <para>An optional parameter that returns the item attributes for a <c>DeleteItem</c> operation
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the table from which to delete the item. You can also provide the Amazon
        ...
        private Amazon.DynamoDBv2.Model.DeleteItemResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.DeleteItemRequest request)
        {
            ...
            try
            {
                return client.DeleteItemAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
