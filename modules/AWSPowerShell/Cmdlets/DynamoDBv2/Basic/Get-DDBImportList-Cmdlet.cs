...
{
    /// <summary>
    /// Lists completed imports within the past 90 days.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.DynamoDBv2.Model.ImportSummary or Amazon.DynamoDBv2.Model.ListImportsResponse",
        ...
        "The service call response (type Amazon.DynamoDBv2.Model.ListImportsResponse) can be returned by specifying '-Select *'."
    )]
