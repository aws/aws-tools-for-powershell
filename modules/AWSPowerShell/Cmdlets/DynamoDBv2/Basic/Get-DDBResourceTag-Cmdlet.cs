...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB ListTagsOfResource API operation.", Operation = new[] {"ListTagsOfResource"}, SelectReturnType = typeof(Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse))]
    [AWSCmdletOutput("Amazon.DynamoDBv2.Model.Tag or Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse",
        "This cmdlet returns a collection of Amazon.DynamoDBv2.Model.Tag objects.",
        "The service call response (type Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDDBResourceTagCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse, GetDDBResourceTagCmdlet>(Select) ??
        ...
        private Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.ListTagsOfResourceRequest request)
        {
            ...
            try
            {
                return client.ListTagsOfResourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.DynamoDBv2.Model.ListTagsOfResourceResponse, GetDDBResourceTagCmdlet, object> Select { get; set; } =
