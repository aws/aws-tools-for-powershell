...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    public partial class GetDDBTableListCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TableNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DynamoDBv2.Model.ListTablesResponse, GetDDBTableListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var _nextToken = cmdletContext.ExclusiveStartTableName;
            var _userControllingPaging = this.NoAutoIteration.IsPresent || ParameterWasBound(nameof(this.ExclusiveStartTableName));
            
            var client = Client ?? CreateClient(_CurrentCredentials, _RegionEndpoint);
            do
            {
                request.ExclusiveStartTableName = _nextToken;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                _nextToken = cmdletContext.ExclusiveStartTableName;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ExclusiveStartTableName { get; set; }
            public int? Limit { get; set; }
            public System.Func<Amazon.DynamoDBv2.Model.ListTablesResponse, GetDDBTableListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TableNames;
        }
