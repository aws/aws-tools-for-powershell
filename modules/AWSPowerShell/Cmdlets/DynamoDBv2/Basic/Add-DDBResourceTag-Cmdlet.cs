...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    /// account. 
    /// 
    ///  <ul><li><para><c>TagResource</c> is an asynchronous operation. If you issue a <a>ListTagsOfResource</a>
    ...
    public partial class AddDDBResourceTagCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to be assigned to the Amazon DynamoDB resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DynamoDBv2.Model.TagResourceResponse, AddDDBResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.DynamoDBv2.Model.Tag>(this.Tag);
            }
            #if MODULAR
        ...
        {
            public System.String ResourceArn { get; set; }
            public List<Amazon.DynamoDBv2.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.DynamoDBv2.Model.TagResourceResponse, AddDDBResourceTagCmdlet, object> Select { get; set; } =
