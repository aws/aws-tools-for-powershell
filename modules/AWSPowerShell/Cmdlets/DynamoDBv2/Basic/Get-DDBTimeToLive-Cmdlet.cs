...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    public partial class GetDDBTimeToLiveCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the table to be described. You can also provide the Amazon Resource Name
        ...
        public string Select { get; set; } = "TimeToLiveDescription";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DynamoDBv2.Model.DescribeTimeToLiveResponse, GetDDBTimeToLiveCmdlet>(Select) ??
        ...
        private Amazon.DynamoDBv2.Model.DescribeTimeToLiveResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.DescribeTimeToLiveRequest request)
        {
            ...
            try
            {
                return client.DescribeTimeToLiveAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String TableName { get; set; }
            public System.Func<Amazon.DynamoDBv2.Model.DescribeTimeToLiveResponse, GetDDBTimeToLiveCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TimeToLiveDescription;
        }
