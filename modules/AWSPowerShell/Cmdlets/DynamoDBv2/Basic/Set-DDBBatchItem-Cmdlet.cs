...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    /// 
    ///  <note><para><c>BatchWriteItem</c> cannot update items. If you perform a <c>BatchWriteItem</c>
    ...
    public partial class SetDDBBatchItemCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        /// and the sort key.</para></li></ul></li><li><para><c>PutRequest</c> - Perform a <c>PutItem</c> operation on the specified item. The
        /// item to be put is identified by an <c>Item</c> subelement:</para><ul><li><para><c>Item</c> - A map of attributes and their values. Each entry in this map consists
