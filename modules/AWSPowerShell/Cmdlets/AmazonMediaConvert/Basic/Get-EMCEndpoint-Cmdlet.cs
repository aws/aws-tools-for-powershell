...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConvert DescribeEndpoints API operation.", Operation = new[] {"DescribeEndpoints"})]
    [AWSCmdletOutput("Amazon.MediaConvert.Model.Endpoint",
