...
namespace Amazon.PowerShell.Cmdlets.EMC
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConvert ListJobTemplates API operation.", Operation = new[] {"ListJobTemplates"})]
    [AWSCmdletOutput("Amazon.MediaConvert.Model.JobTemplate",
        "This cmdlet returns a collection of JobTemplate objects.",
        "The service call response (type Amazon.MediaConvert.Model.ListJobTemplatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.JobTemplates;
