...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "CGISBulkPublishDetail")]
    ...
    public partial class GetCGISBulkPublishDetailCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoSync.Model.GetBulkPublishDetailsResponse, GetCGISBulkPublishDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoSync.Model.GetBulkPublishDetailsRequest();
        ...
        private Amazon.CognitoSync.Model.GetBulkPublishDetailsResponse CallAWSServiceOperation(IAmazonCognitoSync client, Amazon.CognitoSync.Model.GetBulkPublishDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Sync", "GetBulkPublishDetails");
            try
            {
                #if DESKTOP
                return client.GetBulkPublishDetails(request);
                #elif CORECLR
                return client.GetBulkPublishDetailsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String IdentityPoolId { get; set; }
            public System.Func<Amazon.CognitoSync.Model.GetBulkPublishDetailsResponse, GetCGISBulkPublishDetailCmdlet, object> Select { get; set; } =
