...
namespace Amazon.PowerShell.Cmdlets.CGIS
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Sync ListDatasets API operation.", Operation = new[] {"ListDatasets"}, SelectReturnType = typeof(Amazon.CognitoSync.Model.ListDatasetsResponse))]
    [AWSCmdletOutput("Amazon.CognitoSync.Model.Dataset or Amazon.CognitoSync.Model.ListDatasetsResponse",
        "This cmdlet returns a collection of Amazon.CognitoSync.Model.Dataset objects.",
        "The service call response (type Amazon.CognitoSync.Model.ListDatasetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGISDatasetListCmdlet : AmazonCognitoSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoSync.Model.ListDatasetsResponse, GetCGISDatasetListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CognitoSync.Model.ListDatasetsResponse, GetCGISDatasetListCmdlet, object> Select { get; set; } =
