...
namespace Amazon.PowerShell.Cmdlets.HC
{
    ...
    /// in a workbook.
    /// </summary>
    [Cmdlet("Get", "HCTableColumnList")]
    [OutputType("Amazon.Honeycode.Model.ListTableColumnsResponse")]
    [AWSCmdlet("Calls the Amazon Honeycode ListTableColumns API operation.", Operation = new[] {"ListTableColumns"}, SelectReturnType = typeof(Amazon.Honeycode.Model.ListTableColumnsResponse))]
    [AWSCmdletOutput("Amazon.Honeycode.Model.ListTableColumnsResponse",
        "This cmdlet returns an Amazon.Honeycode.Model.ListTableColumnsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetHCTableColumnListCmdlet : AmazonHoneycodeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Honeycode.Model.ListTableColumnsResponse, GetHCTableColumnListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Honeycode.Model.ListTableColumnsRequest();
        ...
        private Amazon.Honeycode.Model.ListTableColumnsResponse CallAWSServiceOperation(IAmazonHoneycode client, Amazon.Honeycode.Model.ListTableColumnsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Honeycode", "ListTableColumns");
            try
            {
                #if DESKTOP
                return client.ListTableColumns(request);
                #elif CORECLR
                return client.ListTableColumnsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableId { get; set; }
            public System.String WorkbookId { get; set; }
            public System.Func<Amazon.Honeycode.Model.ListTableColumnsResponse, GetHCTableColumnListCmdlet, object> Select { get; set; } =
