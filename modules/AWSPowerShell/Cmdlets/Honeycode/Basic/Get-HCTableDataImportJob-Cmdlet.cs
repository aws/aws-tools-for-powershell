...
namespace Amazon.PowerShell.Cmdlets.HC
{
    ...
    /// </summary>
    [Cmdlet("Get", "HCTableDataImportJob")]
    [OutputType("Amazon.Honeycode.Model.DescribeTableDataImportJobResponse")]
    [AWSCmdlet("Calls the Amazon Honeycode DescribeTableDataImportJob API operation.", Operation = new[] {"DescribeTableDataImportJob"}, SelectReturnType = typeof(Amazon.Honeycode.Model.DescribeTableDataImportJobResponse))]
    [AWSCmdletOutput("Amazon.Honeycode.Model.DescribeTableDataImportJobResponse",
        "This cmdlet returns an Amazon.Honeycode.Model.DescribeTableDataImportJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetHCTableDataImportJobCmdlet : AmazonHoneycodeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Honeycode.Model.DescribeTableDataImportJobResponse, GetHCTableDataImportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Honeycode.Model.DescribeTableDataImportJobRequest();
        ...
        private Amazon.Honeycode.Model.DescribeTableDataImportJobResponse CallAWSServiceOperation(IAmazonHoneycode client, Amazon.Honeycode.Model.DescribeTableDataImportJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Honeycode", "DescribeTableDataImportJob");
            try
            {
                #if DESKTOP
                return client.DescribeTableDataImportJob(request);
                #elif CORECLR
                return client.DescribeTableDataImportJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TableId { get; set; }
            public System.String WorkbookId { get; set; }
            public System.Func<Amazon.Honeycode.Model.DescribeTableDataImportJobResponse, GetHCTableDataImportJobCmdlet, object> Select { get; set; } =
