...
namespace Amazon.PowerShell.Cmdlets.HC
{
    ...
    /// </summary>
    [Cmdlet("Get", "HCTableList")]
    [OutputType("Amazon.Honeycode.Model.ListTablesResponse")]
    [AWSCmdlet("Calls the Amazon Honeycode ListTables API operation.", Operation = new[] {"ListTables"}, SelectReturnType = typeof(Amazon.Honeycode.Model.ListTablesResponse))]
    [AWSCmdletOutput("Amazon.Honeycode.Model.ListTablesResponse",
        "This cmdlet returns an Amazon.Honeycode.Model.ListTablesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetHCTableListCmdlet : AmazonHoneycodeClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^WorkbookId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Honeycode.Model.ListTablesResponse, GetHCTableListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.WorkbookId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Honeycode.Model.ListTablesRequest();
        ...
        private Amazon.Honeycode.Model.ListTablesResponse CallAWSServiceOperation(IAmazonHoneycode client, Amazon.Honeycode.Model.ListTablesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Honeycode", "ListTables");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkbookId { get; set; }
            public System.Func<Amazon.Honeycode.Model.ListTablesResponse, GetHCTableListCmdlet, object> Select { get; set; } =
