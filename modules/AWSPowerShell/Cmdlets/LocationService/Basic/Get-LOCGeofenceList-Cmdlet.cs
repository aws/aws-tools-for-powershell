...
{
    /// <summary>
    /// Lists geofences stored in a given geofence collection.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.ListGeofenceResponseEntry or Amazon.LocationService.Model.ListGeofencesResponse",
        ...
        "The service call response (type Amazon.LocationService.Model.ListGeofencesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLOCGeofenceListCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An optional limit for the number of geofences returned in a single call. </para><para>Default value: <c>100</c></para>
        /// </para>
        /// <para>
        ...
        private Amazon.LocationService.Model.ListGeofencesResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.ListGeofencesRequest request)
        {
            ...
            try
            {
                return client.ListGeofencesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
