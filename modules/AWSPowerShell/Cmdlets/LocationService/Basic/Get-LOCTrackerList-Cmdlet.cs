...
{
    /// <summary>
    /// Lists tracker resources in your Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.ListTrackersResponseEntry or Amazon.LocationService.Model.ListTrackersResponse",
        ...
        "The service call response (type Amazon.LocationService.Model.ListTrackersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLOCTrackerListCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LocationService.Model.ListTrackersResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.ListTrackersRequest request)
        {
            ...
            try
            {
                return client.ListTrackersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
