...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.BatchGetDevicePositionResponse",
        "This cmdlet returns an Amazon.LocationService.Model.BatchGetDevicePositionResponse object containing multiple properties."
    )]
    public partial class GetLOCDevicePositionBatchCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LocationService.Model.BatchGetDevicePositionResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.BatchGetDevicePositionRequest request)
        {
            ...
            try
            {
                return client.BatchGetDevicePositionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
