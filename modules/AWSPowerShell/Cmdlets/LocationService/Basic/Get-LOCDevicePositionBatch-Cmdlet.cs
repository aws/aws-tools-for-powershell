...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    [AWSCmdlet("Calls the Amazon Location Service BatchGetDevicePosition API operation.", Operation = new[] {"BatchGetDevicePosition"}, SelectReturnType = typeof(Amazon.LocationService.Model.BatchGetDevicePositionResponse))]
    [AWSCmdletOutput("Amazon.LocationService.Model.BatchGetDevicePositionResponse",
        "This cmdlet returns an Amazon.LocationService.Model.BatchGetDevicePositionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLOCDevicePositionBatchCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LocationService.Model.BatchGetDevicePositionResponse, GetLOCDevicePositionBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LocationService.Model.BatchGetDevicePositionRequest();
        ...
        private Amazon.LocationService.Model.BatchGetDevicePositionResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.BatchGetDevicePositionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Location Service", "BatchGetDevicePosition");
            try
            {
                #if DESKTOP
                return client.BatchGetDevicePosition(request);
                #elif CORECLR
                return client.BatchGetDevicePositionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TrackerName { get; set; }
            public System.Func<Amazon.LocationService.Model.BatchGetDevicePositionResponse, GetLOCDevicePositionBatchCmdlet, object> Select { get; set; } =
