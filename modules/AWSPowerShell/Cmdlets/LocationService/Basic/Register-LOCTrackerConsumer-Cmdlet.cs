...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    [AWSCmdletOutput("None or Amazon.LocationService.Model.AssociateTrackerConsumerResponse",
        ...
        "The service response (type Amazon.LocationService.Model.AssociateTrackerConsumerResponse) be returned by specifying '-Select *'."
    )]
    public partial class RegisterLOCTrackerConsumerCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        /// resource. Used when you need to specify a resource across all Amazon Web Services.</para><ul><li><para>Format example: <c>arn:aws:geo:region:account-id:geofence-collection/ExampleGeofenceCollectionConsumer</c></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.LocationService.Model.AssociateTrackerConsumerResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.AssociateTrackerConsumerRequest request)
        {
            ...
            try
            {
                return client.AssociateTrackerConsumerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
