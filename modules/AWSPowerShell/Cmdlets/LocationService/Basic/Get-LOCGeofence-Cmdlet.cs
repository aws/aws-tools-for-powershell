...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    public partial class GetLOCGeofenceCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Geometry.Polygon";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LocationService.Model.GetGeofenceResponse, GetLOCGeofenceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LocationService.Model.GetGeofenceRequest();
        ...
        private Amazon.LocationService.Model.GetGeofenceResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.GetGeofenceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Location Service", "GetGeofence");
            try
            {
                #if DESKTOP
                return client.GetGeofence(request);
                #elif CORECLR
                return client.GetGeofenceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CollectionName { get; set; }
            public System.String GeofenceId { get; set; }
            public System.Func<Amazon.LocationService.Model.GetGeofenceResponse, GetLOCGeofenceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Geometry.Polygon;
        }
