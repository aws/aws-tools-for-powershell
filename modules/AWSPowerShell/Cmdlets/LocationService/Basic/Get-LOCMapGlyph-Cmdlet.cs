...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    /// upgrading to <a href="https://docs.aws.amazon.com/location/latest/APIReference/API_geomaps_GetGlyphs.html"><c>GetGlyphs</c></a> unless you require <c>Grab</c> data.
    /// </para><ul><li><para><c>GetMapGlyphs</c> is part of a previous Amazon Location Service Maps API (version
