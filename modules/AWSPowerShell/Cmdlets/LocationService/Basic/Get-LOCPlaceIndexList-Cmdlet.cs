...
{
    /// <summary>
    /// Lists place index resources in your Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.ListPlaceIndexesResponseEntry or Amazon.LocationService.Model.ListPlaceIndexesResponse",
        ...
        "The service call response (type Amazon.LocationService.Model.ListPlaceIndexesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLOCPlaceIndexListCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LocationService.Model.ListPlaceIndexesResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.ListPlaceIndexesRequest request)
        {
            ...
            try
            {
                return client.ListPlaceIndexesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
