...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    /// upgrading to <a href="https://docs.aws.amazon.com/location/latest/APIReference/API_geomaps_GetSprites.html"><c>GetSprites</c></a> unless you require <c>Grab</c> data.
    /// </para><ul><li><para><c>GetMapSprites</c> is part of a previous Amazon Location Service Maps API (version
