...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    /// </para><ul><li><para><c>DeleteRouteCalculator</c> is part of a previous Amazon Location Service Routes
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Location Service DeleteRouteCalculator API operation.", Operation = new[] {"DeleteRouteCalculator"}, SelectReturnType = typeof(Amazon.LocationService.Model.DeleteRouteCalculatorResponse))]
    [AWSCmdletOutput("None or Amazon.LocationService.Model.DeleteRouteCalculatorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LocationService.Model.DeleteRouteCalculatorResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveLOCRouteCalculatorCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LOCRouteCalculator (DeleteRouteCalculator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LocationService.Model.DeleteRouteCalculatorResponse, RemoveLOCRouteCalculatorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LocationService.Model.DeleteRouteCalculatorRequest();
        ...
        private Amazon.LocationService.Model.DeleteRouteCalculatorResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.DeleteRouteCalculatorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Location Service", "DeleteRouteCalculator");
            try
            {
                return client.DeleteRouteCalculatorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String CalculatorName { get; set; }
            public System.Func<Amazon.LocationService.Model.DeleteRouteCalculatorResponse, RemoveLOCRouteCalculatorCmdlet, object> Select { get; set; } =
