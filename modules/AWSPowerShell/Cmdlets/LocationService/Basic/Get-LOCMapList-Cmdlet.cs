...
{
    /// <summary>
    /// Lists map resources in your Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.ListMapsResponseEntry or Amazon.LocationService.Model.ListMapsResponse",
        ...
        "The service call response (type Amazon.LocationService.Model.ListMapsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLOCMapListCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LocationService.Model.ListMapsResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.ListMapsRequest request)
        {
            ...
            try
            {
                return client.ListMapsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
