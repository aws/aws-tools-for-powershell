...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    /// </para><ul><li><para><c>CreatePlaceIndex</c> is part of a previous Amazon Location Service Places API
    ...
    public partial class NewLOCPlaceIndexCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        /// Web Services service terms</a> for Amazon Location Service.</para></important></li></ul><para>For additional information , see <a href="https://docs.aws.amazon.com/location/previous/developerguide/what-is-data-provider.html">Data
        ...
        private Amazon.LocationService.Model.CreatePlaceIndexResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.CreatePlaceIndexRequest request)
        {
            ...
            try
            {
                return client.CreatePlaceIndexAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
