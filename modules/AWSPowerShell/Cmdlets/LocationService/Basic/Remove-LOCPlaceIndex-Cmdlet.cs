...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    /// </para><ul><li><para><c>DeletePlaceIndex</c> is part of a previous Amazon Location Service Places API
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Location Service DeletePlaceIndex API operation.", Operation = new[] {"DeletePlaceIndex"}, SelectReturnType = typeof(Amazon.LocationService.Model.DeletePlaceIndexResponse))]
    [AWSCmdletOutput("None or Amazon.LocationService.Model.DeletePlaceIndexResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.LocationService.Model.DeletePlaceIndexResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveLOCPlaceIndexCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LOCPlaceIndex (DeletePlaceIndex)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LocationService.Model.DeletePlaceIndexResponse, RemoveLOCPlaceIndexCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LocationService.Model.DeletePlaceIndexRequest();
        ...
        private Amazon.LocationService.Model.DeletePlaceIndexResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.DeletePlaceIndexRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Location Service", "DeletePlaceIndex");
            try
            {
                return client.DeletePlaceIndexAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String IndexName { get; set; }
            public System.Func<Amazon.LocationService.Model.DeletePlaceIndexResponse, RemoveLOCPlaceIndexCmdlet, object> Select { get; set; } =
