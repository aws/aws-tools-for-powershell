...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    [AWSCmdletOutput("None or Amazon.LocationService.Model.TagResourceResponse",
        ...
        "The service response (type Amazon.LocationService.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
