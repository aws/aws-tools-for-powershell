...
namespace Amazon.PowerShell.Cmdlets.LOC
{
    ...
    [AWSCmdletOutput("Amazon.LocationService.Model.DescribeMapResponse",
        "This cmdlet returns an Amazon.LocationService.Model.DescribeMapResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLOCMapCmdlet : AmazonLocationServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.LocationService.Model.DescribeMapResponse CallAWSServiceOperation(IAmazonLocationService client, Amazon.LocationService.Model.DescribeMapRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeMap(request);
                #elif CORECLR
                return client.DescribeMapAsync(request).GetAwaiter().GetResult();
                #else
