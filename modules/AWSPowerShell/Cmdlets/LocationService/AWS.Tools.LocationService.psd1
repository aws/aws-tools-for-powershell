#
# Module manifest for module 'AWS.Tools.LocationService'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.LocationService.dll'
    ...
    GUID = 'dd598514-2bd7-4d02-bdb8-98fc4c9f18c5'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.LocationService.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.LocationService.Completers.psm1',
        'AWS.Tools.LocationService.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.LocationService.dll-Help.xml'
    )
