...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Invokes the PurchaseOffering operation against AWS Device Farm.", Operation = new[] {"PurchaseOffering"})]
    ...
    public class NewDFOfferingPurchaseCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.PurchaseOffering(request);
