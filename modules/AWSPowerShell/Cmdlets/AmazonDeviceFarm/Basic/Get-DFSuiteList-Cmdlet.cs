...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    /// </summary>
    [Cmdlet("Get", "DFSuiteList")]
    [OutputType("Amazon.DeviceFarm.Model.Suite")]
    [AWSCmdlet("Calls the AWS Device Farm ListSuites API operation.", Operation = new[] {"ListSuites"})]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Suite",
        "This cmdlet returns a collection of Suite objects.",
    ...
    public partial class GetDFSuiteListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DeviceFarm.Model.ListSuitesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Suites;
                        ...
                        {
                            int _receivedThisCall = response.Suites.Count;
        ...
        private Amazon.DeviceFarm.Model.ListSuitesResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListSuitesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "ListSuites");
            try
            {
                #if DESKTOP
                return client.ListSuites(request);
                #elif CORECLR
                return client.ListSuitesAsync(request).GetAwaiter().GetResult();
                #else
