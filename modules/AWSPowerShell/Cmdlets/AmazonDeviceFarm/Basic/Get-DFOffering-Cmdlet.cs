...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Invokes the ListOfferings operation against AWS Device Farm.", Operation = new[] {"ListOfferings"})]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Offering",
    ...
    public partial class GetDFOfferingCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DeviceFarm.Model.ListOfferingsRequest();
        ...
        private Amazon.DeviceFarm.Model.ListOfferingsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListOfferingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Device Farm", "ListOfferings");
            try
            {
                #if DESKTOP
