...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Invokes the ListOfferingTransactions operation against AWS Device Farm.", Operation = new[] {"ListOfferingTransactions"})]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.OfferingTransaction",
        "This cmdlet returns a collection of OfferingTransaction objects.",
    ...
    public class GetDFOfferingTransactionCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.OfferingTransactions;
                        ...
                        {
                            int _receivedThisCall = response.OfferingTransactions.Count;
        ...
        private static Amazon.DeviceFarm.Model.ListOfferingTransactionsResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.ListOfferingTransactionsRequest request)
        {
