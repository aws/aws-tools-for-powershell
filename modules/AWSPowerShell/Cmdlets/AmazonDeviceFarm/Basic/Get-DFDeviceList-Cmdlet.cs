...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Invokes the ListDevices operation against AWS Device Farm.", Operation = new[] {"ListDevices"})]
    [AWSCmdletOutput("Amazon.DeviceFarm.Model.Device",
        "This cmdlet returns a collection of Device objects.",
        "The service call response (type ListDevicesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type String)"
    )]
    public class GetDFDeviceListCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListDevices(request);
