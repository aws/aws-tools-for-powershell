...
namespace Amazon.PowerShell.Cmdlets.DF
{
    ...
    [AWSCmdlet("Invokes the UpdateNetworkProfile operation against AWS Device Farm.", Operation = new[] {"UpdateNetworkProfile"})]
    ...
    public partial class UpdateDFNetworkProfileCmdlet : AmazonDeviceFarmClientCmdlet, IExecutor
    {
        ...
        private static Amazon.DeviceFarm.Model.UpdateNetworkProfileResponse CallAWSServiceOperation(IAmazonDeviceFarm client, Amazon.DeviceFarm.Model.UpdateNetworkProfileRequest request)
        {
            ...
            var task = client.UpdateNetworkProfileAsync(request);
            return task.Result;
            #else
