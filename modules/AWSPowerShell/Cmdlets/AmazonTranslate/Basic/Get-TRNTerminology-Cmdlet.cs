...
namespace Amazon.PowerShell.Cmdlets.TRN
{
    ...
    [AWSCmdlet("Calls the Amazon Translate GetTerminology API operation.", Operation = new[] {"GetTerminology"})]
    [AWSCmdletOutput("Amazon.Translate.Model.GetTerminologyResponse",
        "This cmdlet returns a Amazon.Translate.Model.GetTerminologyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTRNTerminologyCmdlet : AmazonTranslateClientCmdlet, IExecutor
    {
        ...
        private Amazon.Translate.Model.GetTerminologyResponse CallAWSServiceOperation(IAmazonTranslate client, Amazon.Translate.Model.GetTerminologyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetTerminologyAsync(request);
                return task.Result;
                #else
