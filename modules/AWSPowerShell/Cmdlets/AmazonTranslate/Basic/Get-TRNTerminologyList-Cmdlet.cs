...
namespace Amazon.PowerShell.Cmdlets.TRN
{
    ...
    [AWSCmdlet("Calls the Amazon Translate ListTerminologies API operation.", Operation = new[] {"ListTerminologies"})]
    [AWSCmdletOutput("Amazon.Translate.Model.TerminologyProperties",
        "This cmdlet returns a collection of TerminologyProperties objects.",
    ...
    public partial class GetTRNTerminologyListCmdlet : AmazonTranslateClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TerminologyPropertiesList;
        ...
        private Amazon.Translate.Model.ListTerminologiesResponse CallAWSServiceOperation(IAmazonTranslate client, Amazon.Translate.Model.ListTerminologiesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListTerminologiesAsync(request);
                return task.Result;
                #else
