...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    public partial class EditEMRInstanceGroupCmdlet : AmazonElasticMapReduceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.ElasticMapReduce.Model.ModifyInstanceGroupsResponse CallAWSServiceOperation(IAmazonElasticMapReduce client, Amazon.ElasticMapReduce.Model.ModifyInstanceGroupsRequest request)
        {
            #if DESKTOP
            return client.ModifyInstanceGroups(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ModifyInstanceGroupsAsync(request);
            return task.Result;
            #else
