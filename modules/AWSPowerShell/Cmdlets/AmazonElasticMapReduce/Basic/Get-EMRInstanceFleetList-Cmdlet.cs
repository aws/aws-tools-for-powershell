...
namespace Amazon.PowerShell.Cmdlets.EMR
{
    ...
    [AWSCmdlet("Invokes the ListInstanceFleets operation against Amazon Elastic MapReduce.", Operation = new[] {"ListInstanceFleets"}, LegacyAlias="Get-EMRInstanceFleets")]
