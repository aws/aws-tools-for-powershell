...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS AppStream EnableUser API operation.", Operation = new[] {"EnableUser"})]
    ...
    public partial class EnableAPSUserCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "EnableUser");
            try
            {
                #if DESKTOP
