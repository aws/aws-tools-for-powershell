...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Invokes the AssociateFleet operation against AWS AppStream.", Operation = new[] {"AssociateFleet"})]
    ...
    public partial class RegisterAPSFleetCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        private static Amazon.AppStream.Model.AssociateFleetResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.AssociateFleetRequest request)
        {
            #if DESKTOP
