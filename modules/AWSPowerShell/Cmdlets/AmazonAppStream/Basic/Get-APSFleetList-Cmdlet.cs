...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Invokes the DescribeFleets operation against AWS AppStream.", Operation = new[] {"DescribeFleets"})]
    [AWSCmdletOutput("Amazon.AppStream.Model.Fleet",
        "This cmdlet returns a collection of Fleet objects.",
    ...
    public partial class GetAPSFleetListCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        private static Amazon.AppStream.Model.DescribeFleetsResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DescribeFleetsRequest request)
        {
            #if DESKTOP
