...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RemoveAPSFleetCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        
        #region Parameter Name
        /// <summary>
        /// <para>
        /// <para>The name of the fleet to be deleted.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APSFleet (DeleteFleet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.DeleteFleetRequest();
