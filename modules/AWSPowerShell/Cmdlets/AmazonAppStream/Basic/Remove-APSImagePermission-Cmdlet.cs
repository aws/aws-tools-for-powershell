...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the AWS AppStream DeleteImagePermissions API operation.", Operation = new[] {"DeleteImagePermissions"})]
    ...
    public partial class RemoveAPSImagePermissionCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "DeleteImagePermissions");
            try
            {
                #if DESKTOP
