...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Invokes the StartImageBuilder operation against AWS AppStream.", Operation = new[] {"StartImageBuilder"})]
    ...
    public partial class StartAPSImageBuilderCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-APSImageBuilder (StartImageBuilder)"))
            {
                return;
            }
        ...
        private Amazon.AppStream.Model.StartImageBuilderResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.StartImageBuilderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "StartImageBuilder");
            try
            {
                #if DESKTOP
