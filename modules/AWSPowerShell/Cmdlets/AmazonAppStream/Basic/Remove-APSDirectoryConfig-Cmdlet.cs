...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class RemoveAPSDirectoryConfigCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-APSDirectoryConfig (DeleteDirectoryConfig)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.DeleteDirectoryConfigRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.DirectoryName;
        ...
        private Amazon.AppStream.Model.DeleteDirectoryConfigResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.DeleteDirectoryConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "DeleteDirectoryConfig");
            try
            {
                #if DESKTOP
                return client.DeleteDirectoryConfig(request);
                #elif CORECLR
                return client.DeleteDirectoryConfigAsync(request).GetAwaiter().GetResult();
                #else
