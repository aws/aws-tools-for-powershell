...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    [AWSCmdlet("Calls the AWS AppStream DescribeUsers API operation.", Operation = new[] {"DescribeUsers"})]
    [AWSCmdletOutput("Amazon.AppStream.Model.User",
    ...
    public partial class GetAPSUserCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "DescribeUsers");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeUsersAsync(request);
                return task.Result;
                #else
