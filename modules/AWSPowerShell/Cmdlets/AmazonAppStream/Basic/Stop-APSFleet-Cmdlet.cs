...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class StopAPSFleetCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the fleet to stop.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-APSFleet (StopFleet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppStream.Model.StopFleetRequest();
        ...
        private Amazon.AppStream.Model.StopFleetResponse CallAWSServiceOperation(IAmazonAppStream client, Amazon.AppStream.Model.StopFleetRequest request)
        {
            ...
            var task = client.StopFleetAsync(request);
            return task.Result;
            #else
