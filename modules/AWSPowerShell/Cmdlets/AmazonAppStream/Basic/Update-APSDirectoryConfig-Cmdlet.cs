...
namespace Amazon.PowerShell.Cmdlets.APS
{
    ...
    public partial class UpdateAPSDirectoryConfigCmdlet : AmazonAppStreamClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the existing directory configuration to be updated.</para>
        /// </para>
        /// </summary>
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS AppStream", "UpdateDirectoryConfig");
            #if DESKTOP
            return client.UpdateDirectoryConfig(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.UpdateDirectoryConfigAsync(request);
            return task.Result;
            #else
