...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    public partial class ResetIOTWAllResourceLogLevelCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Reset-IOTWAllResourceLogLevel (ResetAllResourceLogLevels)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.ResetAllResourceLogLevelsResponse, ResetIOTWAllResourceLogLevelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.ResetAllResourceLogLevelsRequest();
        ...
        private Amazon.IoTWireless.Model.ResetAllResourceLogLevelsResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ResetAllResourceLogLevelsRequest request)
        {
        ...
        {
            public System.Func<Amazon.IoTWireless.Model.ResetAllResourceLogLevelsResponse, ResetIOTWAllResourceLogLevelCmdlet, object> Select { get; set; } =
