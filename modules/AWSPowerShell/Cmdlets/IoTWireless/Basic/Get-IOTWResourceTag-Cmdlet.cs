...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTWResourceTag")]
    [OutputType("Amazon.IoTWireless.Model.Tag")]
    ...
    public partial class GetIOTWResourceTagCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.ListTagsForResourceResponse, GetIOTWResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.ListTagsForResourceRequest();
        ...
        private Amazon.IoTWireless.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.IoTWireless.Model.ListTagsForResourceResponse, GetIOTWResourceTagCmdlet, object> Select { get; set; } =
