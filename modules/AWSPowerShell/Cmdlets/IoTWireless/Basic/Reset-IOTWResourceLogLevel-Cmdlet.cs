...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    public partial class ResetIOTWResourceLogLevelCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Reset-IOTWResourceLogLevel (ResetResourceLogLevel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.ResetResourceLogLevelResponse, ResetIOTWResourceLogLevelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.ResetResourceLogLevelRequest();
        ...
        private Amazon.IoTWireless.Model.ResetResourceLogLevelResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ResetResourceLogLevelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "ResetResourceLogLevel");
            try
            {
                #if DESKTOP
                return client.ResetResourceLogLevel(request);
                #elif CORECLR
                return client.ResetResourceLogLevelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceIdentifier { get; set; }
            public System.String ResourceType { get; set; }
            public System.Func<Amazon.IoTWireless.Model.ResetResourceLogLevelResponse, ResetIOTWResourceLogLevelCmdlet, object> Select { get; set; } =
