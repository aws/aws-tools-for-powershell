...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTWPositionConfiguration")]
    ...
    public partial class GetIOTWPositionConfigurationCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.GetPositionConfigurationResponse, GetIOTWPositionConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.GetPositionConfigurationRequest();
        ...
        private Amazon.IoTWireless.Model.GetPositionConfigurationResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.GetPositionConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "GetPositionConfiguration");
            try
            {
                #if DESKTOP
                return client.GetPositionConfiguration(request);
                #elif CORECLR
                return client.GetPositionConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceIdentifier { get; set; }
            public Amazon.IoTWireless.PositionResourceType ResourceType { get; set; }
            public System.Func<Amazon.IoTWireless.Model.GetPositionConfigurationResponse, GetIOTWPositionConfigurationCmdlet, object> Select { get; set; } =
