...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    public partial class WriteIOTWResourceLogLevelCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        public Amazon.IoTWireless.LogLevel LogLevel { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-IOTWResourceLogLevel (PutResourceLogLevel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.PutResourceLogLevelResponse, WriteIOTWResourceLogLevelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.PutResourceLogLevelRequest();
        ...
        private Amazon.IoTWireless.Model.PutResourceLogLevelResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.PutResourceLogLevelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "PutResourceLogLevel");
            try
            {
                #if DESKTOP
                return client.PutResourceLogLevel(request);
                #elif CORECLR
                return client.PutResourceLogLevelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ResourceIdentifier { get; set; }
            public System.String ResourceType { get; set; }
            public System.Func<Amazon.IoTWireless.Model.PutResourceLogLevelResponse, WriteIOTWResourceLogLevelCmdlet, object> Select { get; set; } =
