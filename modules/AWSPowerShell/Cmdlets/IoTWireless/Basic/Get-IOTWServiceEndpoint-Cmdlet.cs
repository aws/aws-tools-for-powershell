...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    [AWSCmdletOutput("Amazon.IoTWireless.Model.GetServiceEndpointResponse",
        "This cmdlet returns an Amazon.IoTWireless.Model.GetServiceEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTWServiceEndpointCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        /// Network Server endpoint or <code>CLAIM</code> for the global endpoint.</para>
        /// </para>
        /// </summary>
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ServiceType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ServiceType;
            }
        ...
        private Amazon.IoTWireless.Model.GetServiceEndpointResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.GetServiceEndpointRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetServiceEndpoint(request);
                #elif CORECLR
                return client.GetServiceEndpointAsync(request).GetAwaiter().GetResult();
                #else
