...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    public partial class SplitIOTWAwsAccountFromPartnerAccountCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Split-IOTWAwsAccountFromPartnerAccount (DisassociateAwsAccountFromPartnerAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.DisassociateAwsAccountFromPartnerAccountResponse, SplitIOTWAwsAccountFromPartnerAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.DisassociateAwsAccountFromPartnerAccountRequest();
        ...
        private Amazon.IoTWireless.Model.DisassociateAwsAccountFromPartnerAccountResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.DisassociateAwsAccountFromPartnerAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "DisassociateAwsAccountFromPartnerAccount");
            try
            {
                #if DESKTOP
                return client.DisassociateAwsAccountFromPartnerAccount(request);
                #elif CORECLR
                return client.DisassociateAwsAccountFromPartnerAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PartnerAccountId { get; set; }
            public Amazon.IoTWireless.PartnerType PartnerType { get; set; }
            public System.Func<Amazon.IoTWireless.Model.DisassociateAwsAccountFromPartnerAccountResponse, SplitIOTWAwsAccountFromPartnerAccountCmdlet, object> Select { get; set; } =
