...
{
    /// <summary>
    /// List all multicast groups associated with a FUOTA task.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetIOTWMulticastGroupsByFuotaTaskListCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.ListMulticastGroupsByFuotaTaskResponse, GetIOTWMulticastGroupsByFuotaTaskListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTWireless.Model.ListMulticastGroupsByFuotaTaskRequest();
        ...
        private Amazon.IoTWireless.Model.ListMulticastGroupsByFuotaTaskResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ListMulticastGroupsByFuotaTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "ListMulticastGroupsByFuotaTask");
            try
            {
                return client.ListMulticastGroupsByFuotaTaskAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.IoTWireless.Model.ListMulticastGroupsByFuotaTaskResponse, GetIOTWMulticastGroupsByFuotaTaskListCmdlet, object> Select { get; set; } =
