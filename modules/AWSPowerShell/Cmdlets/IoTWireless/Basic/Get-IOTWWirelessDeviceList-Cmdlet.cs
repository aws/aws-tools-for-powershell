...
{
    /// <summary>
    /// Lists the wireless devices registered to your AWS account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetIOTWWirelessDeviceListCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTWireless.Model.ListWirelessDevicesResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ListWirelessDevicesRequest request)
        {
            ...
            try
            {
                return client.ListWirelessDevicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
