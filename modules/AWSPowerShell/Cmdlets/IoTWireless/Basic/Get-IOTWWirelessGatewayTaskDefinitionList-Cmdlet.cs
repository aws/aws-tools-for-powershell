...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    [AWSCmdletOutput("Amazon.IoTWireless.Model.UpdateWirelessGatewayTaskEntry or Amazon.IoTWireless.Model.ListWirelessGatewayTaskDefinitionsResponse",
        ...
        "The service call response (type Amazon.IoTWireless.Model.ListWirelessGatewayTaskDefinitionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTWWirelessGatewayTaskDefinitionListCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TaskDefinitionType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TaskDefinitionType;
            }
        ...
        private Amazon.IoTWireless.Model.ListWirelessGatewayTaskDefinitionsResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.ListWirelessGatewayTaskDefinitionsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListWirelessGatewayTaskDefinitions(request);
                #elif CORECLR
                return client.ListWirelessGatewayTaskDefinitionsAsync(request).GetAwaiter().GetResult();
                #else
