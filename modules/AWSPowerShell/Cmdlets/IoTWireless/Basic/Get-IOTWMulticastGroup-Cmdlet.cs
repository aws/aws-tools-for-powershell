...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    public partial class GetIOTWMulticastGroupCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.GetMulticastGroupResponse, GetIOTWMulticastGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.GetMulticastGroupRequest();
        ...
        private Amazon.IoTWireless.Model.GetMulticastGroupResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.GetMulticastGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "GetMulticastGroup");
            try
            {
                #if DESKTOP
                return client.GetMulticastGroup(request);
                #elif CORECLR
                return client.GetMulticastGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.IoTWireless.Model.GetMulticastGroupResponse, GetIOTWMulticastGroupCmdlet, object> Select { get; set; } =
