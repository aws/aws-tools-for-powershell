...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    [AWSCmdletOutput("None or Amazon.IoTWireless.Model.UpdatePartnerAccountResponse",
        ...
        "The service response (type Amazon.IoTWireless.Model.UpdatePartnerAccountResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
