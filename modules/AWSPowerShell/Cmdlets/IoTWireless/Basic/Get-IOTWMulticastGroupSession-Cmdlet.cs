...
namespace Amazon.PowerShell.Cmdlets.IOTW
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTWMulticastGroupSession")]
    [OutputType("Amazon.IoTWireless.Model.LoRaWANMulticastSession")]
    ...
    public partial class GetIOTWMulticastGroupSessionCmdlet : AmazonIoTWirelessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTWireless.Model.GetMulticastGroupSessionResponse, GetIOTWMulticastGroupSessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTWireless.Model.GetMulticastGroupSessionRequest();
        ...
        private Amazon.IoTWireless.Model.GetMulticastGroupSessionResponse CallAWSServiceOperation(IAmazonIoTWireless client, Amazon.IoTWireless.Model.GetMulticastGroupSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT Wireless", "GetMulticastGroupSession");
            try
            {
                #if DESKTOP
                return client.GetMulticastGroupSession(request);
                #elif CORECLR
                return client.GetMulticastGroupSessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.IoTWireless.Model.GetMulticastGroupSessionResponse, GetIOTWMulticastGroupSessionCmdlet, object> Select { get; set; } =
