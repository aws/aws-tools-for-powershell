...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53RFirewallRuleGroup")]
    [OutputType("Amazon.Route53Resolver.Model.FirewallRuleGroup")]
    [AWSCmdlet("Calls the Amazon Route 53 Resolver GetFirewallRuleGroup API operation.", Operation = new[] {"GetFirewallRuleGroup"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.FirewallRuleGroup or Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse",
        "This cmdlet returns an Amazon.Route53Resolver.Model.FirewallRuleGroup object.",
        "The service call response (type Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53RFirewallRuleGroupCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse, GetR53RFirewallRuleGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Resolver.Model.GetFirewallRuleGroupRequest();
        ...
        private Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.GetFirewallRuleGroupRequest request)
        {
        ...
        {
            public System.String FirewallRuleGroupId { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.GetFirewallRuleGroupResponse, GetR53RFirewallRuleGroupCmdlet, object> Select { get; set; } =
