...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverRules API operation.", Operation = new[] {"ListResolverRules"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.ListResolverRulesResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverRule or Amazon.Route53Resolver.Model.ListResolverRulesResponse",
        "This cmdlet returns a collection of Amazon.Route53Resolver.Model.ResolverRule objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListResolverRulesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53RResolverRuleListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResolverRules";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.ListResolverRulesResponse, GetR53RResolverRuleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ResolverRules?.Count ?? 0;
        ...
        private Amazon.Route53Resolver.Model.ListResolverRulesResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListResolverRulesRequest request)
        {
            ...
            try
            {
                return client.ListResolverRulesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.ListResolverRulesResponse, GetR53RResolverRuleListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResolverRules;
        }
