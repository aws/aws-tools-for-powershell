...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverEndpoints API operation.", Operation = new[] {"ListResolverEndpoints"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.ListResolverEndpointsResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverEndpoint or Amazon.Route53Resolver.Model.ListResolverEndpointsResponse",
        "This cmdlet returns a collection of Amazon.Route53Resolver.Model.ResolverEndpoint objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListResolverEndpointsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53RResolverEndpointListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        /// any, as in the previous request.</para></note><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResolverEndpoints";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.ListResolverEndpointsResponse, GetR53RResolverEndpointListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53Resolver.Model.ListResolverEndpointsRequest();
        ...
        private Amazon.Route53Resolver.Model.ListResolverEndpointsResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListResolverEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Resolver", "ListResolverEndpoints");
            try
            {
                return client.ListResolverEndpointsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.ListResolverEndpointsResponse, GetR53RResolverEndpointListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResolverEndpoints;
        }
