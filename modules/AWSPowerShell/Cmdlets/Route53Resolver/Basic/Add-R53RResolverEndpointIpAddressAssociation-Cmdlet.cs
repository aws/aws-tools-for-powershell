...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver AssociateResolverEndpointIpAddress API operation.", Operation = new[] {"AssociateResolverEndpointIpAddress"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverEndpoint or Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse",
        "This cmdlet returns an Amazon.Route53Resolver.Model.ResolverEndpoint object.",
        "The service call response (type Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse) can be returned by specifying '-Select *'."
    )]
    public partial class AddR53RResolverEndpointIpAddressAssociationCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse, AddR53RResolverEndpointIpAddressAssociationCmdlet>(Select) ??
        ...
        private Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressRequest request)
        {
            ...
            try
            {
                return client.AssociateResolverEndpointIpAddressAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.Route53Resolver.Model.IpAddressUpdate IpAddress { get; set; }
            public System.String ResolverEndpointId { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.AssociateResolverEndpointIpAddressResponse, AddR53RResolverEndpointIpAddressAssociationCmdlet, object> Select { get; set; } =
