...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListResolverRuleAssociations API operation.", Operation = new[] {"ListResolverRuleAssociations"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.ResolverRuleAssociation or Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse",
        "This cmdlet returns a collection of Amazon.Route53Resolver.Model.ResolverRuleAssociation objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53RResolverRuleAssociationListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        /// Resolver returns up to 100 rule associations. </para>
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// <para>For the first <c>ListResolverRuleAssociation</c> request, omit this value.</para><para>If you have more than <c>MaxResults</c> rule associations, you can submit another
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResolverRuleAssociations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse, GetR53RResolverRuleAssociationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ResolverRuleAssociations?.Count ?? 0;
        ...
        private Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.ListResolverRuleAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListResolverRuleAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.ListResolverRuleAssociationsResponse, GetR53RResolverRuleAssociationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResolverRuleAssociations;
        }
