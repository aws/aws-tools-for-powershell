...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.FirewallDomainListMetadata or Amazon.Route53Resolver.Model.ListFirewallDomainListsResponse",
        ...
        "The service call response (type Amazon.Route53Resolver.Model.ListFirewallDomainListsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
