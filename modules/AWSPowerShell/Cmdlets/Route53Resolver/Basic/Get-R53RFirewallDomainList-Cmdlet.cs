...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53RFirewallDomainList")]
    [OutputType("Amazon.Route53Resolver.Model.FirewallDomainList")]
    [AWSCmdlet("Calls the Amazon Route 53 Resolver GetFirewallDomainList API operation.", Operation = new[] {"GetFirewallDomainList"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.GetFirewallDomainListResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.FirewallDomainList or Amazon.Route53Resolver.Model.GetFirewallDomainListResponse",
        "This cmdlet returns an Amazon.Route53Resolver.Model.FirewallDomainList object.",
        "The service call response (type Amazon.Route53Resolver.Model.GetFirewallDomainListResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53RFirewallDomainListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.GetFirewallDomainListResponse, GetR53RFirewallDomainListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53Resolver.Model.GetFirewallDomainListRequest();
        ...
        private Amazon.Route53Resolver.Model.GetFirewallDomainListResponse CallAWSServiceOperation(IAmazonRoute53Resolver client, Amazon.Route53Resolver.Model.GetFirewallDomainListRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Resolver", "GetFirewallDomainList");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String FirewallDomainListId { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.GetFirewallDomainListResponse, GetR53RFirewallDomainListCmdlet, object> Select { get; set; } =
