...
namespace Amazon.PowerShell.Cmdlets.R53R
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Resolver ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.Route53Resolver.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.Route53Resolver.Model.Tag or Amazon.Route53Resolver.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.Route53Resolver.Model.Tag objects.",
        "The service call response (type Amazon.Route53Resolver.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetR53RResourceTagListCmdlet : AmazonRoute53ResolverClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53Resolver.Model.ListTagsForResourceResponse, GetR53RResourceTagListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.Route53Resolver.Model.ListTagsForResourceResponse, GetR53RResourceTagListCmdlet, object> Select { get; set; } =
