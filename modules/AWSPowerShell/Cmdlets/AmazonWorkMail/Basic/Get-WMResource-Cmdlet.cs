...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail DescribeResource API operation.", Operation = new[] {"DescribeResource"})]
    [AWSCmdletOutput("Amazon.WorkMail.Model.DescribeResourceResponse",
        "This cmdlet returns a Amazon.WorkMail.Model.DescribeResourceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
