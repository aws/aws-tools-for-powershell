...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail ListGroupMembers API operation.", Operation = new[] {"ListGroupMembers"})]
    [AWSCmdletOutput("Amazon.WorkMail.Model.Member",
        "This cmdlet returns a collection of Member objects.",
        "The service call response (type Amazon.WorkMail.Model.ListGroupMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetWMMemberListCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkMail.Model.ListGroupMembersRequest();
        ...
        private Amazon.WorkMail.Model.ListGroupMembersResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.ListGroupMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkMail", "ListGroupMembers");
            try
            {
                #if DESKTOP
