...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail UpdatePrimaryEmailAddress API operation.", Operation = new[] {"UpdatePrimaryEmailAddress"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the Email parameter. Otherwise, this cmdlet does not return any output. " +
