...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail DeleteGroup API operation.", Operation = new[] {"DeleteGroup"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.WorkMail.Model.DeleteGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
