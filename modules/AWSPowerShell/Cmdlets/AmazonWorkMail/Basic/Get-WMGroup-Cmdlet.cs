...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail DescribeGroup API operation.", Operation = new[] {"DescribeGroup"})]
    [AWSCmdletOutput("Amazon.WorkMail.Model.DescribeGroupResponse",
        "This cmdlet returns a Amazon.WorkMail.Model.DescribeGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWMGroupCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        private Amazon.WorkMail.Model.DescribeGroupResponse CallAWSServiceOperation(IAmazonWorkMail client, Amazon.WorkMail.Model.DescribeGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeGroupAsync(request);
                return task.Result;
                #else
