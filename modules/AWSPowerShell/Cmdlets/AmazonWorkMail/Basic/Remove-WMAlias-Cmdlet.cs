...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail DeleteAlias API operation.", Operation = new[] {"DeleteAlias"})]
    ...
    public partial class RemoveWMAliasCmdlet : AmazonWorkMailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("Alias", MyInvocation.BoundParameters);
