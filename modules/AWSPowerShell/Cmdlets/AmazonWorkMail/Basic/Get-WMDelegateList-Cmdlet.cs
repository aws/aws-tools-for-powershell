...
namespace Amazon.PowerShell.Cmdlets.WM
{
    ...
    [AWSCmdlet("Calls the Amazon WorkMail ListResourceDelegates API operation.", Operation = new[] {"ListResourceDelegates"})]
    [AWSCmdletOutput("Amazon.WorkMail.Model.Delegate",
        "This cmdlet returns a collection of Delegate objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Delegates;
