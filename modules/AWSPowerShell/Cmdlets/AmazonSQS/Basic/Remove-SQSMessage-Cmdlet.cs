...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    [AWSCmdlet("Invokes the DeleteMessage operation against Amazon Simple Queue Service.", Operation = new[] {"DeleteMessage"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteMessageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
