...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    public partial class NewSQSQueueCmdlet : AmazonSQSClientCmdlet, IExecutor
    {
        ...
        /// the <code>CreateQueue</code> action uses:</para><ul><li><para><code>DelaySeconds</code> - The time in seconds that the delivery of all messages
        ...
        /// of AWS IAM Policies</a> in the <i>Amazon IAM User Guide</i>.</para></li><li><para><code>ReceiveMessageWaitTimeSeconds</code> - The time for which a <a>ReceiveMessage</a>
        /// call will wait for a message to arrive. An integer from 0 to 20 (seconds). The default
        /// for this attribute is 0.</para></li><li><para><code>RedrivePolicy</code> - The parameters for dead letter queue functionality of
        ...
        /// Amazon SQS Dead Letter Queues</a> in the <i>Amazon SQS Developer Guide</i>.</para></li><li><para><code>VisibilityTimeout</code> - The visibility timeout for the queue. An integer
        ...
        /// Timeout</a> in the <i>Amazon SQS Developer Guide</i>.</para></li></ul><para>Any other valid special request parameters that are specified (such as <code>ApproximateNumberOfMessages</code>,
        ...
        /// <summary>
        /// <para>
        /// <para>The name for the queue to be created.</para><para>Queue names are case-sensitive.</para>
        /// </para>
        /// </summary>
