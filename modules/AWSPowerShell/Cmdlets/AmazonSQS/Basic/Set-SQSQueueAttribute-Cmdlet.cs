...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    public partial class SetSQSQueueAttributeCmdlet : AmazonSQSClientCmdlet, IExecutor
    {
        ...
        /// default is 0 (zero). </para></li><li><para><code>MaximumMessageSize</code> - The limit of how many bytes a message can contain
        /// before Amazon SQS rejects it. Valid values: An integer from 1,024 bytes (1 KiB) up
        /// to 262,144 bytes (256 KiB). The default is 262,144 (256 KiB). </para></li><li><para><code>MessageRetentionPeriod</code> - The number of seconds for which Amazon SQS
        ...
        /// an integer from 0 to 20 (seconds). The default is 0. </para></li><li><para><code>RedrivePolicy</code> - The parameters for the dead letter queue functionality
