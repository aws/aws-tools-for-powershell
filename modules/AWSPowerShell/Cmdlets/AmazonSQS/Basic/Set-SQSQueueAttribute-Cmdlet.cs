...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    public partial class SetSQSQueueAttributeCmdlet : AmazonSQSClientCmdlet, IExecutor
    {
        ...
        /// minutes). The default is 0 (zero). </para></li><li><para><code>MaximumMessageSize</code> - The limit of how many bytes a message can contain
        /// before Amazon SQS rejects it. Valid values: An integer from 1,024 bytes (1 KiB) up
        /// to 262,144 bytes (256 KiB). The default is 262,144 (256 KiB). </para></li><li><para><code>MessageRetentionPeriod</code> - The length of time, in seconds, for which Amazon
        /// SQS retains a message. Valid values: An integer representing seconds, from 60 (1 minute)
        /// to 1,209,600 (14 days). The default is 345,600 (4 days). </para></li><li><para><code>Policy</code> - The queue's policy. A valid AWS policy. For more information
        ...
        /// Valid values: an integer from 0 to 20 (seconds). The default is 0. </para></li><li><para><code>RedrivePolicy</code> - The string that includes the parameters for the dead-letter
        ...
        /// <summary>
        /// <para>
        /// <para>The URL of the Amazon SQS queue whose attributes are set.</para><para>Queue URLs are case-sensitive.</para>
        /// </para>
        /// </summary>
