...
namespace Amazon.PowerShell.Cmdlets.SQS
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Queue Service ListQueues API operation.", Operation = new[] {"ListQueues"})]
    ...
    public partial class GetSQSQueueCmdlet : AmazonSQSClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Queue Service", "ListQueues");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListQueuesAsync(request);
                return task.Result;
                #else
