...
{
    /// <summary>
    /// Retrieves the status of automated sensitive data discovery for one or more accounts.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMAC2AutomatedDiscoveryAccountListCmdlet : AmazonMacie2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.Macie2.Model.ListAutomatedDiscoveryAccountsResponse CallAWSServiceOperation(IAmazonMacie2 client, Amazon.Macie2.Model.ListAutomatedDiscoveryAccountsRequest request)
        {
            ...
            try
            {
                return client.ListAutomatedDiscoveryAccountsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
