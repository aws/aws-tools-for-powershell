...
namespace Amazon.PowerShell.Cmdlets.MAC2
{
    ...
    public partial class GetMAC2ClassificationExportConfigurationCmdlet : AmazonMacie2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Macie2.Model.GetClassificationExportConfigurationResponse, GetMAC2ClassificationExportConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Macie2.Model.GetClassificationExportConfigurationRequest();
        ...
        private Amazon.Macie2.Model.GetClassificationExportConfigurationResponse CallAWSServiceOperation(IAmazonMacie2 client, Amazon.Macie2.Model.GetClassificationExportConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Macie 2", "GetClassificationExportConfiguration");
            try
            {
                #if DESKTOP
                return client.GetClassificationExportConfiguration(request);
                #elif CORECLR
                return client.GetClassificationExportConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.Macie2.Model.GetClassificationExportConfigurationResponse, GetMAC2ClassificationExportConfigurationCmdlet, object> Select { get; set; } =
