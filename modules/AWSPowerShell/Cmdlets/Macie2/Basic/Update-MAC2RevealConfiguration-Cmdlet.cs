...
namespace Amazon.PowerShell.Cmdlets.MAC2
{
    ...
    [AWSCmdletOutput("Amazon.Macie2.Model.RevealConfiguration or Amazon.Macie2.Model.UpdateRevealConfigurationResponse",
        ...
        "The service call response (type Amazon.Macie2.Model.UpdateRevealConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateMAC2RevealConfigurationCmdlet : AmazonMacie2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the Configuration_Status parameter.
        /// The -PassThru parameter is deprecated, use -Select '^Configuration_Status' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Configuration_Status' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.Configuration_Status;
            }
        ...
        private Amazon.Macie2.Model.UpdateRevealConfigurationResponse CallAWSServiceOperation(IAmazonMacie2 client, Amazon.Macie2.Model.UpdateRevealConfigurationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateRevealConfiguration(request);
                #elif CORECLR
                return client.UpdateRevealConfigurationAsync(request).GetAwaiter().GetResult();
                #else
