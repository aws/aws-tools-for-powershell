...
namespace Amazon.PowerShell.Cmdlets.MAC2
{
    ...
    public partial class GetMAC2SensitiveDataOccurrenceCmdlet : AmazonMacie2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Macie2.Model.GetSensitiveDataOccurrencesResponse).
        /// Specifying the name of a property of type Amazon.Macie2.Model.GetSensitiveDataOccurrencesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Macie2.Model.GetSensitiveDataOccurrencesResponse, GetMAC2SensitiveDataOccurrenceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Macie2.Model.GetSensitiveDataOccurrencesRequest();
        ...
        private Amazon.Macie2.Model.GetSensitiveDataOccurrencesResponse CallAWSServiceOperation(IAmazonMacie2 client, Amazon.Macie2.Model.GetSensitiveDataOccurrencesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Macie 2", "GetSensitiveDataOccurrences");
            try
            {
                #if DESKTOP
                return client.GetSensitiveDataOccurrences(request);
                #elif CORECLR
                return client.GetSensitiveDataOccurrencesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FindingId { get; set; }
            public System.Func<Amazon.Macie2.Model.GetSensitiveDataOccurrencesResponse, GetMAC2SensitiveDataOccurrenceCmdlet, object> Select { get; set; } =
