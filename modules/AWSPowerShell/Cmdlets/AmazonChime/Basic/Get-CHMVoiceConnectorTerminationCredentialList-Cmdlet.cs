...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListVoiceConnectorTerminationCredentials API operation.", Operation = new[] {"ListVoiceConnectorTerminationCredentials"})]
    ...
    public partial class GetCHMVoiceConnectorTerminationCredentialListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Usernames;
