...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime GetPhoneNumber API operation.", Operation = new[] {"GetPhoneNumber"})]
    [AWSCmdletOutput("Amazon.Chime.Model.PhoneNumber",
        "This cmdlet returns a PhoneNumber object.",
        "The service call response (type Amazon.Chime.Model.GetPhoneNumberResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
