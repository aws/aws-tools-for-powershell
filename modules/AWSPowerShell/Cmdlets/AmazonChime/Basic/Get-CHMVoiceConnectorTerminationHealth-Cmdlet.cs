...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime GetVoiceConnectorTerminationHealth API operation.", Operation = new[] {"GetVoiceConnectorTerminationHealth"})]
    [AWSCmdletOutput("Amazon.Chime.Model.TerminationHealth",
        "This cmdlet returns a TerminationHealth object.",
    ...
    public partial class GetCHMVoiceConnectorTerminationHealthCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.TerminationHealth;
