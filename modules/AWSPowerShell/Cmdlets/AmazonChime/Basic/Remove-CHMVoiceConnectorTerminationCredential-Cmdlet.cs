...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime DeleteVoiceConnectorTerminationCredentials API operation.", Operation = new[] {"DeleteVoiceConnectorTerminationCredentials"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.Chime.Model.DeleteVoiceConnectorTerminationCredentialsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMVoiceConnectorTerminationCredentialCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Usernames = new List<System.String>(this.Username);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Usernames != null)
            {
                request.Usernames = cmdletContext.Usernames;
            }
        ...
        {
            public List<System.String> Usernames { get; set; }
            public System.String VoiceConnectorId { get; set; }
        }
