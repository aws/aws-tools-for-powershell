...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime UpdatePhoneNumber API operation.", Operation = new[] {"UpdatePhoneNumber"})]
    [AWSCmdletOutput("Amazon.Chime.Model.PhoneNumber",
        "This cmdlet returns a PhoneNumber object.",
        "The service call response (type Amazon.Chime.Model.UpdatePhoneNumberResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
