...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime BatchDeletePhoneNumber API operation.", Operation = new[] {"BatchDeletePhoneNumber"})]
    ...
    public partial class RemoveCHMPhoneNumberBatchCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.PhoneNumberIds = new List<System.String>(this.PhoneNumberId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.PhoneNumberIds != null)
            {
                request.PhoneNumberIds = cmdletContext.PhoneNumberIds;
            }
        ...
        {
            public List<System.String> PhoneNumberIds { get; set; }
        }
