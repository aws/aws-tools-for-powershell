...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the DeleteGroup operation against AWS Identity and Access Management.", Operation = new[] {"DeleteGroup"})]
    ...
    public partial class RemoveIAMGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the IAM group to delete.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMGroup (DeleteGroup)"))
            {
                return;
            }
        ...
        private static Amazon.IdentityManagement.Model.DeleteGroupResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteGroupRequest request)
        {
            #if DESKTOP
