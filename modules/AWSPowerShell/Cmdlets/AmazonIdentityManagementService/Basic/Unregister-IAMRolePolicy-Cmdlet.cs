...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class UnregisterIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name (friendly name, not ARN) of the IAM role to detach the policy from.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.DetachRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DetachRolePolicyRequest request)
        {
            #if DESKTOP
            return client.DetachRolePolicy(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DetachRolePolicyAsync(request);
            return task.Result;
            #else
