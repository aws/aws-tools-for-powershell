...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "IAMGroupForUser")]
    [OutputType("Amazon.IdentityManagement.Model.Group")]
    [AWSCmdlet("Invokes the ListGroupsForUser operation against AWS Identity and Access Management.", Operation = new[] {"ListGroupsForUser"})]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Group",
        "This cmdlet returns a collection of Group objects.",
        "The service call response (type ListGroupsForUserResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetIAMGroupForUserCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// <para> Use this only when paginating results to indicate the maximum number of groups you
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListGroupsForUser(request);
