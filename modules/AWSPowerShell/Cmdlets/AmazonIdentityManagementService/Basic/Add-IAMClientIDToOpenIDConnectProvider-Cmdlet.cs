...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management AddClientIDToOpenIDConnectProvider API operation.", Operation = new[] {"AddClientIDToOpenIDConnectProvider"})]
