...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListAttachedUserPolicies API operation.", Operation = new[] {"ListAttachedUserPolicies"}, LegacyAlias="Get-IAMAttachedUserPolicies")]
