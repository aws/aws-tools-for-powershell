...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListAttachedUserPolicies operation against AWS Identity and Access Management.", Operation = new[] {"ListAttachedUserPolicies"}, LegacyAlias="Get-IAMAttachedUserPolicies")]
