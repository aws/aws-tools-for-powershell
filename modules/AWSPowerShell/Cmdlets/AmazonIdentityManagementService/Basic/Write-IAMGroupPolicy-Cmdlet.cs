...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class WriteIAMGroupPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the group to associate the policy with.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        /// <summary>
        /// <para>
        /// <para>The policy document.</para><para>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> used to validate this
        ...
        private static Amazon.IdentityManagement.Model.PutGroupPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.PutGroupPolicyRequest request)
        {
            #if DESKTOP
            return client.PutGroupPolicy(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.PutGroupPolicyAsync(request);
            return task.Result;
            #else
