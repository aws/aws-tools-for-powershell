...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMLoginProfileCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.IdentityManagement.Model.GetLoginProfileResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetLoginProfileRequest request)
        {
            #if DESKTOP
            return client.GetLoginProfile(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetLoginProfileAsync(request);
            return task.Result;
            #else
