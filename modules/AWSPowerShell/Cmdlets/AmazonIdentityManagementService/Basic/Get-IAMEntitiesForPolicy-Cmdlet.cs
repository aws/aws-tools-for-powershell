...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMEntitiesForPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// included, it defaults to a slash (/), listing all entities.</para><para>This paramater allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.ListEntitiesForPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListEntitiesForPolicyRequest request)
        {
            #if DESKTOP
            return client.ListEntitiesForPolicy(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListEntitiesForPolicyAsync(request);
            return task.Result;
            #else
