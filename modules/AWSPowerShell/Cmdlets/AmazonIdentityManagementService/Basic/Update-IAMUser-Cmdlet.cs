...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class UpdateIAMUserCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// path.</para><para>This paramater allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.UpdateUserResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.UpdateUserRequest request)
        {
            #if DESKTOP
