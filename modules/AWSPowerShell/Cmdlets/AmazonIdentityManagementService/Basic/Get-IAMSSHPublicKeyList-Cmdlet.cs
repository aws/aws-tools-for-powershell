...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.SSHPublicKeyMetadata",
        ...
        "The service call response (type ListSSHPublicKeysResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetIAMSSHPublicKeyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListSSHPublicKeys(request);
                        Dictionary<string, object> notes = null;
                        object pipelineOutput = response.SSHPublicKeys;
                        ...
                        int _receivedThisCall = response.SSHPublicKeys.Count;
