...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAttachedUserPolicies")]
    [OutputType("Amazon.IdentityManagement.Model.AttachedPolicyType")]
    [AWSCmdlet("Invokes the ListAttachedUserPolicies operation against AWS Identity and Access Management.", Operation = new[] {"ListAttachedUserPolicies"})]
    ...
    public partial class GetIAMAttachedUserPoliciesCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name (friendly name, not ARN) of the user to list attached policies for.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.ListAttachedUserPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListAttachedUserPoliciesRequest request)
        {
            ...
            var task = client.ListAttachedUserPoliciesAsync(request);
            return task.Result;
            #else
