...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the GetServiceLinkedRoleDeletionStatus operation against AWS Identity and Access Management.", Operation = new[] {"GetServiceLinkedRoleDeletionStatus"})]
