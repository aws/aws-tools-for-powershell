...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management GetRolePolicy API operation.", Operation = new[] {"GetRolePolicy"})]
    ...
    public partial class GetIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the role associated with the policy.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        /// a string of characters consisting of upper and lowercase alphanumeric characters with
        /// no spaces. You can also include any of the following characters: _+=,.@-</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.IdentityManagement.Model.GetRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetRolePolicyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRolePolicyAsync(request);
                return task.Result;
                #else
