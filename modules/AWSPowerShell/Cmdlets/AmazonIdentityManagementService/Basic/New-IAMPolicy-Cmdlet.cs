...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management CreatePolicy API operation.", Operation = new[] {"CreatePolicy"})]
    ...
    public partial class NewIAMPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The friendly name of the policy.</para><para>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex
