...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListUserPolicies operation against AWS Identity and Access Management.", Operation = new[] {"ListUserPolicies"}, LegacyAlias="Get-IAMUserPolicies")]
    ...
    public partial class GetIAMUserPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the user to list policies for.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.ListUserPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListUserPoliciesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListUserPoliciesAsync(request);
                return task.Result;
                #else
