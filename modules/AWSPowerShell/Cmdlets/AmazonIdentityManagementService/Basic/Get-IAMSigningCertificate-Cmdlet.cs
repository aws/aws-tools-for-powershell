...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListSigningCertificates operation against AWS Identity and Access Management.", Operation = new[] {"ListSigningCertificates"})]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.SigningCertificate",
        "This cmdlet returns a collection of SigningCertificate objects.",
    ...
    public partial class GetIAMSigningCertificateCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the IAM user whose signing certificates you want to examine.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.ListSigningCertificatesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListSigningCertificatesRequest request)
        {
            ...
            var task = client.ListSigningCertificatesAsync(request);
            return task.Result;
            #else
