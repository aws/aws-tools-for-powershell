...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMAttachedGroupPolicyList")]
    [OutputType("Amazon.IdentityManagement.Model.AttachedPolicyType")]
    [AWSCmdlet("Invokes the ListAttachedGroupPolicies operation against AWS Identity and Access Management.", Operation = new[] {"ListAttachedGroupPolicies"}, LegacyAlias="Get-IAMAttachedGroupPolicies")]
    ...
    public partial class GetIAMAttachedGroupPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter GroupName
        /// <summary>
        /// <para>
        /// <para>The name (friendly name, not ARN) of the group to list attached policies for.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        /// included, it defaults to a slash (/), listing all policies.</para><para>This paramater allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListAttachedGroupPolicies");
            #if DESKTOP
            return client.ListAttachedGroupPolicies(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListAttachedGroupPoliciesAsync(request);
            return task.Result;
            #else
