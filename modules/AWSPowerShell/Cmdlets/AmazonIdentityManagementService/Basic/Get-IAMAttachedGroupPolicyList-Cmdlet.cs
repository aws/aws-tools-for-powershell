...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListAttachedGroupPolicies API operation.", Operation = new[] {"ListAttachedGroupPolicies"}, LegacyAlias="Get-IAMAttachedGroupPolicies")]
    ...
    public partial class GetIAMAttachedGroupPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// included, it defaults to a slash (/), listing all policies.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
