...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class NewIAMServiceLinkedRoleCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS service to which this role is attached. You use a string similar to a URL
        /// but without the http:// in front. For example: <code>elasticbeanstalk.amazonaws.com</code></para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>A string that you provide, which is combined with the service name to form the complete
