...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management DeleteSigningCertificate API operation.", Operation = new[] {"DeleteSigningCertificate"})]
    ...
    public partial class RemoveIAMSigningCertificateCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the user the signing certificate belongs to.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.DeleteSigningCertificateResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteSigningCertificateRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteSigningCertificateAsync(request);
                return task.Result;
                #else
