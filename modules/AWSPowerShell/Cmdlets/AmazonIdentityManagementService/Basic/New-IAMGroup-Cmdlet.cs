...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management CreateGroup API operation.", Operation = new[] {"CreateGroup"})]
    ...
    public partial class NewIAMGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the group to create. Do not include the path in this value.</para><para>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex
        /// pattern</a>) a string of characters consisting of upper and lowercase alphanumeric
        /// characters with no spaces. You can also include any of the following characters: _+=,.@-.
        /// The group name must be unique within the account. Group names are not distinguished
        /// by case. For example, you cannot create groups named both "ADMINS" and "admins".</para>
        /// </para>
        /// </summary>
