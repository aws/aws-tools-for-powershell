...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class NewIAMGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the group to create. Do not include the path in this value.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.CreateGroupResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.CreateGroupRequest request)
        {
            #if DESKTOP
