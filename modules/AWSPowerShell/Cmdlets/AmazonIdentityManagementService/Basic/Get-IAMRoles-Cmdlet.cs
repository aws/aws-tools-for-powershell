...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Role",
        ...
        "The service call response (type ListRolesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetIAMRolesCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.ListRoles(request);
