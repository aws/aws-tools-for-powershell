...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListPolicyVersions operation against AWS Identity and Access Management.", Operation = new[] {"ListPolicyVersions"})]
    ...
    public partial class GetIAMPolicyVersionsCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
