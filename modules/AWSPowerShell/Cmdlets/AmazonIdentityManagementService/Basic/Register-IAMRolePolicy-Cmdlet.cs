...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Register", "IAMRolePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Invokes the AttachRolePolicy operation against AWS Identity and Access Management.", Operation = new[] {"AttachRolePolicy"})]
    ...
    public partial class RegisterIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name (friendly name, not ARN) of the role to attach the policy to.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-IAMRolePolicy (AttachRolePolicy)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.AttachRolePolicyRequest();
        ...
        private static Amazon.IdentityManagement.Model.AttachRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AttachRolePolicyRequest request)
        {
            ...
            var task = client.AttachRolePolicyAsync(request);
            return task.Result;
            #else
