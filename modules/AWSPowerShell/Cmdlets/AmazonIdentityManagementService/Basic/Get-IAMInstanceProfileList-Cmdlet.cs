...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListInstanceProfiles API operation.", Operation = new[] {"ListInstanceProfiles"}, LegacyAlias="Get-IAMInstanceProfiles")]
    ...
    public partial class GetIAMInstanceProfileListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// all instance profiles. This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex
