...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListGroupPolicies operation against AWS Identity and Access Management.", Operation = new[] {"ListGroupPolicies"}, LegacyAlias="Get-IAMGroupPolicies")]
    ...
    public partial class GetIAMGroupPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the group to list policies for.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.ListGroupPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListGroupPoliciesRequest request)
        {
            ...
            var task = client.ListGroupPoliciesAsync(request);
            return task.Result;
            #else
