...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListGroupPolicies API operation.", Operation = new[] {"ListGroupPolicies"}, LegacyAlias="Get-IAMGroupPolicies")]
