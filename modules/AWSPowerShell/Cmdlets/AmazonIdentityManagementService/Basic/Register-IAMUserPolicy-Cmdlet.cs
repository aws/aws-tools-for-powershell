...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public class RegisterIAMUserPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.IdentityManagement.Model.AttachUserPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AttachUserPolicyRequest request)
        {
