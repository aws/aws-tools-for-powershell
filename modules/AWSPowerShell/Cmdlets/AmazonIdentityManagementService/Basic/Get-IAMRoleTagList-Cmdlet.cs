...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMRoleTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListRoleTags API operation.", Operation = new[] {"ListRoleTags"})]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag",
        "This cmdlet returns a collection of Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListRoleTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetIAMRoleTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListRoleTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListRoleTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListRoleTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListRoleTags");
            try
            {
                #if DESKTOP
                return client.ListRoleTags(request);
                #elif CORECLR
                return client.ListRoleTagsAsync(request).GetAwaiter().GetResult();
                #else
