...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management DetachUserPolicy API operation.", Operation = new[] {"DetachUserPolicy"})]
    ...
    public partial class UnregisterIAMUserPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name (friendly name, not ARN) of the IAM user to detach the policy from.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private Amazon.IdentityManagement.Model.DetachUserPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DetachUserPolicyRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DetachUserPolicyAsync(request);
                return task.Result;
                #else
