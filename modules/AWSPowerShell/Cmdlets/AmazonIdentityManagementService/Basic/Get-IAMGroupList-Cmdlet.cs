...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListGroups API operation.", Operation = new[] {"ListGroups"}, LegacyAlias="Get-IAMGroups")]
    ...
    public partial class GetIAMGroupListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// all groups. This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex
