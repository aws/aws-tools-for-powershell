...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMGroupList")]
    [OutputType("Amazon.IdentityManagement.Model.Group")]
    [AWSCmdlet("Invokes the ListGroups operation against AWS Identity and Access Management.", Operation = new[] {"ListGroups"}, LegacyAlias="Get-IAMGroups")]
    ...
    public partial class GetIAMGroupListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// all groups. This paramater allows (per its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        private Amazon.IdentityManagement.Model.ListGroupsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListGroups");
            try
            {
                #if DESKTOP
