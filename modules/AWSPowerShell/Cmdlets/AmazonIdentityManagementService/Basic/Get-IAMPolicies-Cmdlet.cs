...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMPoliciesCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// included, it defaults to a slash (/), listing all policies. This paramater allows
        ...
        /// begin and end with forward slashes, containing any ASCII character from the ! (\u0021)
        /// thru the DEL character (\u007F), including most punctuation characters, digits, and
        /// upper and lowercased letters.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        private static Amazon.IdentityManagement.Model.ListPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListPoliciesRequest request)
        {
            #if DESKTOP
            return client.ListPolicies(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListPoliciesAsync(request);
            return task.Result;
            #else
