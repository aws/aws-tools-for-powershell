...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMServerCertificateCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the server certificate you want to retrieve information about.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.GetServerCertificateResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetServerCertificateRequest request)
        {
            #if DESKTOP
            return client.GetServerCertificate(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetServerCertificateAsync(request);
            return task.Result;
            #else
