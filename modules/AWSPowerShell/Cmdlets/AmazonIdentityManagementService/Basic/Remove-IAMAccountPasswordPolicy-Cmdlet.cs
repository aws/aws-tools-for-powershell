...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class RemoveIAMAccountPasswordPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.DeleteAccountPasswordPolicyRequest();
        ...
        private Amazon.IdentityManagement.Model.DeleteAccountPasswordPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteAccountPasswordPolicyRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteAccountPasswordPolicyAsync(request).GetAwaiter().GetResult();
                #else
