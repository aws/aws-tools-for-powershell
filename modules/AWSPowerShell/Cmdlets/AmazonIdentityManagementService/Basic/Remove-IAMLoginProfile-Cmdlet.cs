...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the DeleteLoginProfile operation against AWS Identity and Access Management.", Operation = new[] {"DeleteLoginProfile"})]
    ...
    public partial class RemoveIAMLoginProfileCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the user whose password you want to delete.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.DeleteLoginProfileResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteLoginProfileRequest request)
        {
            #if DESKTOP
            return client.DeleteLoginProfile(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeleteLoginProfileAsync(request);
            return task.Result;
            #else
