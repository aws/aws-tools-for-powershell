...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMSAMLProviderCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.IdentityManagement.Model.GetSAMLProviderResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetSAMLProviderRequest request)
        {
            #if DESKTOP
            return client.GetSAMLProvider(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetSAMLProviderAsync(request);
            return task.Result;
            #else
