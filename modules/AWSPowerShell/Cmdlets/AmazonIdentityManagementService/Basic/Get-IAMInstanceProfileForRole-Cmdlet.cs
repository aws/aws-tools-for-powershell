...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the ListInstanceProfilesForRole operation against AWS Identity and Access Management.", Operation = new[] {"ListInstanceProfilesForRole"})]
    ...
    public partial class GetIAMInstanceProfileForRoleCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the role to list instance profiles for.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        private static Amazon.IdentityManagement.Model.ListInstanceProfilesForRoleResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListInstanceProfilesForRoleRequest request)
        {
            #if DESKTOP
            return client.ListInstanceProfilesForRole(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListInstanceProfilesForRoleAsync(request);
            return task.Result;
            #else
