...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Invokes the AddUserToGroup operation against AWS Identity and Access Management.", Operation = new[] {"AddUserToGroup"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.IdentityManagement.Model.AddUserToGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIAMUserToGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the group to update.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the user to add.</para><para>This parameter allows (per its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>)
        /// a string of characters consisting of upper and lowercase alphanumeric characters with
        /// no spaces. You can also include any of the following characters: =,.@-</para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.IdentityManagement.Model.AddUserToGroupResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AddUserToGroupRequest request)
        {
            #if DESKTOP
            return client.AddUserToGroup(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.AddUserToGroupAsync(request);
            return task.Result;
            #else
