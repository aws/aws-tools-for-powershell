...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListSAMLProviders API operation.", Operation = new[] {"ListSAMLProviders"}, LegacyAlias="Get-IAMSAMLProviders")]
