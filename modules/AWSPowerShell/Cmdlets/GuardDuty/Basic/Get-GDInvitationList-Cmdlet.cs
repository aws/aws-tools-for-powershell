...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdletOutput("Amazon.GuardDuty.Model.Invitation or Amazon.GuardDuty.Model.ListInvitationsResponse",
        ...
        "The service call response (type Amazon.GuardDuty.Model.ListInvitationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
