...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Backup", "GDFinding", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class BackupGDFindingCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the findings that you want to archive.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Backup-GDFinding (ArchiveFindings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ArchiveFindingsResponse, BackupGDFindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.ArchiveFindingsRequest();
        ...
        private Amazon.GuardDuty.Model.ArchiveFindingsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ArchiveFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "ArchiveFindings");
            try
            {
                return client.ArchiveFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GuardDuty.Model.ArchiveFindingsResponse, BackupGDFindingCmdlet, object> Select { get; set; } =
