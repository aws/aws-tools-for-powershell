...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon GuardDuty DeleteFilter API operation.", Operation = new[] {"DeleteFilter"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.DeleteFilterResponse))]
    [AWSCmdletOutput("None or Amazon.GuardDuty.Model.DeleteFilterResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GuardDuty.Model.DeleteFilterResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGDFilterCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID of the detector that is associated with the filter.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.DeleteFilterResponse, RemoveGDFilterCmdlet>(Select) ??
        ...
        private Amazon.GuardDuty.Model.DeleteFilterResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DeleteFilterRequest request)
        {
            ...
            try
            {
                return client.DeleteFilterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DetectorId { get; set; }
            public System.String FilterName { get; set; }
            public System.Func<Amazon.GuardDuty.Model.DeleteFilterResponse, RemoveGDFilterCmdlet, object> Select { get; set; } =
