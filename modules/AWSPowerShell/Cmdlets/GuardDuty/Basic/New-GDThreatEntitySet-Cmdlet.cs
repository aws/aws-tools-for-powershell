...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty CreateThreatEntitySet API operation.", Operation = new[] {"CreateThreatEntitySet"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.CreateThreatEntitySetResponse))]
    [AWSCmdletOutput("System.String or Amazon.GuardDuty.Model.CreateThreatEntitySetResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.GuardDuty.Model.CreateThreatEntitySetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewGDThreatEntitySetCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A boolean value that indicates whether GuardDuty should start using the uploaded threat
        /// entity set to generate findings.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// a threat entity set.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// <summary>
        /// <para>
        /// <para>The format of the file that contains the threat entity set.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.GuardDuty.ThreatEntitySetFormat")]
        public Amazon.GuardDuty.ThreatEntitySetFormat Format { get; set; }
        #endregion
        
        #region Parameter Location
        /// <summary>
        /// <para>
        /// <para>The URI of the file that contains the threat entity set. The format of the <c>Location</c>
        ...
        /// <i>Amazon GuardDuty User Guide</i>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A user-friendly name to identify the threat entity set.</para><para>The name of your list can include lowercase letters, uppercase letters, numbers, dash
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to be added to a new threat entity set resource.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ThreatEntitySetId'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.GuardDuty.Model.CreateThreatEntitySetResponse).
        /// Specifying the name of a property of type Amazon.GuardDuty.Model.CreateThreatEntitySetResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThreatEntitySetId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-GDThreatEntitySet (CreateThreatEntitySet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.CreateThreatEntitySetResponse, NewGDThreatEntitySetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.CreateThreatEntitySetRequest();
        ...
        private Amazon.GuardDuty.Model.CreateThreatEntitySetResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.CreateThreatEntitySetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "CreateThreatEntitySet");
            try
            {
                #if DESKTOP
                return client.CreateThreatEntitySet(request);
                #elif CORECLR
                return client.CreateThreatEntitySetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GuardDuty.Model.CreateThreatEntitySetResponse, NewGDThreatEntitySetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThreatEntitySetId;
        }
