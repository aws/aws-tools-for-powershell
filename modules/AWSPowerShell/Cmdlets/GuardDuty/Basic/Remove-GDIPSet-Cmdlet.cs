...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdletOutput("None or Amazon.GuardDuty.Model.DeleteIPSetResponse",
        ...
        "The service response (type Amazon.GuardDuty.Model.DeleteIPSetResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGDIPSetCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID of the detector associated with the IPSet.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        private Amazon.GuardDuty.Model.DeleteIPSetResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DeleteIPSetRequest request)
        {
            ...
            try
            {
                return client.DeleteIPSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
