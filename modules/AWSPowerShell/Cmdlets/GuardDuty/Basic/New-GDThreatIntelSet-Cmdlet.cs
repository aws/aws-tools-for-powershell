...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class NewGDThreatIntelSetCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags to be added to a new threat list resource.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThreatIntelSetId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.CreateThreatIntelSetResponse, NewGDThreatIntelSetCmdlet>(Select) ??
        ...
        private Amazon.GuardDuty.Model.CreateThreatIntelSetResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.CreateThreatIntelSetRequest request)
        {
            ...
            try
            {
                return client.CreateThreatIntelSetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GuardDuty.Model.CreateThreatIntelSetResponse, NewGDThreatIntelSetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThreatIntelSetId;
        }
