...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class DisableGDOrganizationAdminAccountCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The AWS Account ID for the organizations account to be disabled as a GuardDuty delegated
        /// administrator.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-GDOrganizationAdminAccount (DisableOrganizationAdminAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.DisableOrganizationAdminAccountResponse, DisableGDOrganizationAdminAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.DisableOrganizationAdminAccountRequest();
        ...
        private Amazon.GuardDuty.Model.DisableOrganizationAdminAccountResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DisableOrganizationAdminAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "DisableOrganizationAdminAccount");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String AdminAccountId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.DisableOrganizationAdminAccountResponse, DisableGDOrganizationAdminAccountCmdlet, object> Select { get; set; } =
