...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon GuardDuty UnarchiveFindings API operation.", Operation = new[] {"UnarchiveFindings"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.UnarchiveFindingsResponse))]
    [AWSCmdletOutput("None or Amazon.GuardDuty.Model.UnarchiveFindingsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GuardDuty.Model.UnarchiveFindingsResponse) be returned by specifying '-Select *'."
    )]
    public partial class RestoreGDFindingCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the detector associated with the findings to unarchive.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the findings to unarchive.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-GDFinding (UnarchiveFindings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.UnarchiveFindingsResponse, RestoreGDFindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.UnarchiveFindingsRequest();
        ...
        private Amazon.GuardDuty.Model.UnarchiveFindingsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.UnarchiveFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "UnarchiveFindings");
            try
            {
                return client.UnarchiveFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GuardDuty.Model.UnarchiveFindingsResponse, RestoreGDFindingCmdlet, object> Select { get; set; } =
