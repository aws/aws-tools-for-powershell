...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdletOutput("Amazon.GuardDuty.Model.Destination or Amazon.GuardDuty.Model.ListPublishingDestinationsResponse",
        ...
        "The service call response (type Amazon.GuardDuty.Model.ListPublishingDestinationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
