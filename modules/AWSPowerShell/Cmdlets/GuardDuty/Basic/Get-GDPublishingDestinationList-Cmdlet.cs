...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty ListPublishingDestinations API operation.", Operation = new[] {"ListPublishingDestinations"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.ListPublishingDestinationsResponse))]
    [AWSCmdletOutput("Amazon.GuardDuty.Model.Destination or Amazon.GuardDuty.Model.ListPublishingDestinationsResponse",
        "This cmdlet returns a collection of Amazon.GuardDuty.Model.Destination objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListPublishingDestinationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGDPublishingDestinationListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The detector ID for which you want to retrieve the publishing destination.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ListPublishingDestinationsResponse, GetGDPublishingDestinationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GuardDuty.Model.ListPublishingDestinationsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Destinations?.Count ?? 0;
        ...
        private Amazon.GuardDuty.Model.ListPublishingDestinationsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListPublishingDestinationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "ListPublishingDestinations");
            try
            {
                #if DESKTOP
                return client.ListPublishingDestinations(request);
                #elif CORECLR
                return client.ListPublishingDestinationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GuardDuty.Model.ListPublishingDestinationsResponse, GetGDPublishingDestinationListCmdlet, object> Select { get; set; } =
