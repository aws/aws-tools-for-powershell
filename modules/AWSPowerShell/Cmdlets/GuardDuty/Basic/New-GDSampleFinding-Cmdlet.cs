...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class NewGDSampleFindingCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The types of sample findings to generate.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-GDSampleFinding (CreateSampleFindings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.CreateSampleFindingsResponse, NewGDSampleFindingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.CreateSampleFindingsRequest();
        ...
        private Amazon.GuardDuty.Model.CreateSampleFindingsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.CreateSampleFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "CreateSampleFindings");
            try
            {
                return client.CreateSampleFindingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GuardDuty.Model.CreateSampleFindingsResponse, NewGDSampleFindingCmdlet, object> Select { get; set; } =
