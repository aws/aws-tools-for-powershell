...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    /// </summary>
    [Cmdlet("Get", "GDInvestigationList")]
    [OutputType("Amazon.GuardDuty.Model.InvestigationSummary")]
    [AWSCmdlet("Calls the Amazon GuardDuty ListInvestigations API operation.", Operation = new[] {"ListInvestigations"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.ListInvestigationsResponse))]
    [AWSCmdletOutput("Amazon.GuardDuty.Model.InvestigationSummary or Amazon.GuardDuty.Model.ListInvestigationsResponse",
        "This cmdlet returns a collection of Amazon.GuardDuty.Model.InvestigationSummary objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListInvestigationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGDInvestigationListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The attribute by which to sort investigations.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.GuardDuty.InvestigationSortField")]
        public Amazon.GuardDuty.InvestigationSortField SortCriteria_AttributeName { get; set; }
        #endregion
        
        #region Parameter DetectorId
        /// <summary>
        /// <para>
        /// <para>The unique ID of the GuardDuty detector whose investigations you want to list.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// <summary>
        /// <para>
        /// <para>The order in which the sorted results are to be displayed.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'Investigations'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.GuardDuty.Model.ListInvestigationsResponse).
        /// Specifying the name of a property of type Amazon.GuardDuty.Model.ListInvestigationsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Investigations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ListInvestigationsResponse, GetGDInvestigationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GuardDuty.Model.ListInvestigationsRequest();
            ...
            request.SortCriteria = new Amazon.GuardDuty.Model.InvestigationSortCriteria();
            Amazon.GuardDuty.InvestigationSortField requestSortCriteria_sortCriteria_AttributeName = null;
        ...
        private Amazon.GuardDuty.Model.ListInvestigationsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListInvestigationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "ListInvestigations");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.GuardDuty.InvestigationSortField SortCriteria_AttributeName { get; set; }
            public Amazon.GuardDuty.OrderBy SortCriteria_OrderBy { get; set; }
            public System.Func<Amazon.GuardDuty.Model.ListInvestigationsResponse, GetGDInvestigationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Investigations;
        }
