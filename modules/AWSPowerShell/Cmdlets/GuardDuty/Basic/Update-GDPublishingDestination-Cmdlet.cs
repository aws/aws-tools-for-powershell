...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    /// </summary>
    [Cmdlet("Update", "GDPublishingDestination", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateGDPublishingDestinationCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the detector associated with the publishing destinations to update.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GDPublishingDestination (UpdatePublishingDestination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.UpdatePublishingDestinationResponse, UpdateGDPublishingDestinationCmdlet>(Select) ??
        ...
        private Amazon.GuardDuty.Model.UpdatePublishingDestinationResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.UpdatePublishingDestinationRequest request)
        {
            ...
            try
            {
                return client.UpdatePublishingDestinationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DestinationProperties_KmsKeyArn { get; set; }
            public System.String DetectorId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.UpdatePublishingDestinationResponse, UpdateGDPublishingDestinationCmdlet, object> Select { get; set; } =
