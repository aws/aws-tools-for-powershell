...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty ListIPSets API operation.", Operation = new[] {"ListIPSets"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.ListIPSetsResponse))]
    [AWSCmdletOutput("System.String or Amazon.GuardDuty.Model.ListIPSetsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListIPSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGDIPSetListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID of the detector that is associated with IPSet.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IpSetIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ListIPSetsResponse, GetGDIPSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.IpSetIds?.Count ?? 0;
        ...
        private Amazon.GuardDuty.Model.ListIPSetsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListIPSetsRequest request)
        {
            ...
            try
            {
                return client.ListIPSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GuardDuty.Model.ListIPSetsResponse, GetGDIPSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IpSetIds;
        }
