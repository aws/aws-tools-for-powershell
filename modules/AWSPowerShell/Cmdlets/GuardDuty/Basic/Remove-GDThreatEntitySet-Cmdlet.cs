...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GDThreatEntitySet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon GuardDuty DeleteThreatEntitySet API operation.", Operation = new[] {"DeleteThreatEntitySet"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse))]
    [AWSCmdletOutput("None or Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveGDThreatEntitySetCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID that helps GuardDuty identify which threat entity set needs to be deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GDThreatEntitySet (DeleteThreatEntitySet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse, RemoveGDThreatEntitySetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.DeleteThreatEntitySetRequest();
        ...
        private Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DeleteThreatEntitySetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "DeleteThreatEntitySet");
            try
            {
                #if DESKTOP
                return client.DeleteThreatEntitySet(request);
                #elif CORECLR
                return client.DeleteThreatEntitySetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DetectorId { get; set; }
            public System.String ThreatEntitySetId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.DeleteThreatEntitySetResponse, RemoveGDThreatEntitySetCmdlet, object> Select { get; set; } =
