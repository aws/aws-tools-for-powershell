...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    /// </summary>
    [Cmdlet("Get", "GDFilterList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon GuardDuty ListFilters API operation.", Operation = new[] {"ListFilters"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.ListFiltersResponse))]
    [AWSCmdletOutput("System.String or Amazon.GuardDuty.Model.ListFiltersResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListFiltersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGDFilterListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FilterNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ListFiltersResponse, GetGDFilterListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GuardDuty.Model.ListFiltersRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.FilterNames?.Count ?? 0;
        ...
        private Amazon.GuardDuty.Model.ListFiltersResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListFiltersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "ListFilters");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GuardDuty.Model.ListFiltersResponse, GetGDFilterListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FilterNames;
        }
