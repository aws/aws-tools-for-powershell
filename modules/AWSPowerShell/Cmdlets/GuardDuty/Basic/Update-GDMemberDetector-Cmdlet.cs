...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class UpdateGDMemberDetectorCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of member account IDs to be updated.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of features that will be updated for the specified member accounts.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.GuardDuty.Model.UpdateMemberDetectorsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.UpdateMemberDetectorsRequest request)
        {
            ...
            try
            {
                return client.UpdateMemberDetectorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
