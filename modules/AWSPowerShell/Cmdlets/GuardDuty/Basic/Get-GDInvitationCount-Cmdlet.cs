...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdletOutput("System.Int32 or Amazon.GuardDuty.Model.GetInvitationsCountResponse",
        ...
        "The service call response (type Amazon.GuardDuty.Model.GetInvitationsCountResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGDInvitationCountCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.GetInvitationsCountResponse, GetGDInvitationCountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.GetInvitationsCountRequest();
        ...
        private Amazon.GuardDuty.Model.GetInvitationsCountResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.GetInvitationsCountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "GetInvitationsCount");
            try
            {
                #if DESKTOP
        ...
        {
            public System.Func<Amazon.GuardDuty.Model.GetInvitationsCountResponse, GetGDInvitationCountCmdlet, object> Select { get; set; } =
