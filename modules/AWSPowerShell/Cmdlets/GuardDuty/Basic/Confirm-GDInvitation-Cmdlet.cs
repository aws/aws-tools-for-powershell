...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class ConfirmGDInvitationCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-GDInvitation (AcceptInvitation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.AcceptInvitationResponse, ConfirmGDInvitationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.AcceptInvitationRequest();
        ...
        private Amazon.GuardDuty.Model.AcceptInvitationResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.AcceptInvitationRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String InvitationId { get; set; }
            public System.String MasterId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.AcceptInvitationResponse, ConfirmGDInvitationCmdlet, object> Select { get; set; } =
