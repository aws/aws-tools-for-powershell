...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty ListThreatIntelSets API operation.", Operation = new[] {"ListThreatIntelSets"}, SelectReturnType = typeof(Amazon.GuardDuty.Model.ListThreatIntelSetsResponse))]
    [AWSCmdletOutput("System.String or Amazon.GuardDuty.Model.ListThreatIntelSetsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListThreatIntelSetsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetGDThreatIntelSetListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique ID of the detector that is associated with the threatIntelSet.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ThreatIntelSetIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.ListThreatIntelSetsResponse, GetGDThreatIntelSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ThreatIntelSetIds?.Count ?? 0;
        ...
        private Amazon.GuardDuty.Model.ListThreatIntelSetsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListThreatIntelSetsRequest request)
        {
            ...
            try
            {
                return client.ListThreatIntelSetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.GuardDuty.Model.ListThreatIntelSetsResponse, GetGDThreatIntelSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ThreatIntelSetIds;
        }
