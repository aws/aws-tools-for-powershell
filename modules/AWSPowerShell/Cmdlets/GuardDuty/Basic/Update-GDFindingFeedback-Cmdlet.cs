...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdletOutput("None or Amazon.GuardDuty.Model.UpdateFindingsFeedbackResponse",
        ...
        "The service response (type Amazon.GuardDuty.Model.UpdateFindingsFeedbackResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateGDFindingFeedbackCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// update the feedback.</para><para>To find the <c>detectorId</c> in the current Region, see the Settings page in the
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the findings that you want to mark as useful or not useful.</para><para />
        ...
        private Amazon.GuardDuty.Model.UpdateFindingsFeedbackResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.UpdateFindingsFeedbackRequest request)
        {
            ...
            try
            {
                return client.UpdateFindingsFeedbackAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
