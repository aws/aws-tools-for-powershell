...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class RemoveGDDetectorCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.DeleteDetectorResponse, RemoveGDDetectorCmdlet>(Select) ??
        ...
        private Amazon.GuardDuty.Model.DeleteDetectorResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DeleteDetectorRequest request)
        {
            ...
            try
            {
                return client.DeleteDetectorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DetectorId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.DeleteDetectorResponse, RemoveGDDetectorCmdlet, object> Select { get; set; } =
