...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    public partial class GetGDMemberDetectorCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of member account IDs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GuardDuty.Model.GetMemberDetectorsResponse, GetGDMemberDetectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.GetMemberDetectorsRequest();
        ...
        private Amazon.GuardDuty.Model.GetMemberDetectorsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.GetMemberDetectorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "GetMemberDetectors");
            try
            {
                return client.GetMemberDetectorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DetectorId { get; set; }
            public System.Func<Amazon.GuardDuty.Model.GetMemberDetectorsResponse, GetGDMemberDetectorCmdlet, object> Select { get; set; } =
