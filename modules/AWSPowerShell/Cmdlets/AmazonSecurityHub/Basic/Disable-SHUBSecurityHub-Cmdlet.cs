...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Security Hub DisableSecurityHub API operation.", Operation = new[] {"DisableSecurityHub"})]
    [AWSCmdletOutput("None",
        "This cmdlet does not generate any output. " +
        "The service response (type Amazon.SecurityHub.Model.DisableSecurityHubResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisableSHUBSecurityHubCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        private Amazon.SecurityHub.Model.DisableSecurityHubResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DisableSecurityHubRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DisableSecurityHubAsync(request);
                return task.Result;
                #else
