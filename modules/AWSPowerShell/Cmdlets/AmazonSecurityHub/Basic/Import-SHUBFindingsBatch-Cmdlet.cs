...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub BatchImportFindings API operation.", Operation = new[] {"BatchImportFindings"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.BatchImportFindingsResponse",
        "This cmdlet returns a Amazon.SecurityHub.Model.BatchImportFindingsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ImportSHUBFindingsBatchCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("Finding", MyInvocation.BoundParameters);
            ...
            {
                context.Findings = new List<Amazon.SecurityHub.Model.AwsSecurityFinding>(this.Finding);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Findings != null)
            {
                request.Findings = cmdletContext.Findings;
            }
        ...
        private Amazon.SecurityHub.Model.BatchImportFindingsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.BatchImportFindingsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.BatchImportFindingsAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<Amazon.SecurityHub.Model.AwsSecurityFinding> Findings { get; set; }
        }
