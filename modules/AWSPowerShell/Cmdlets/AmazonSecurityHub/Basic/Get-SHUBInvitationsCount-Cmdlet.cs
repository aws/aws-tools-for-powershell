...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetInvitationsCount API operation.", Operation = new[] {"GetInvitationsCount"})]
    ...
    public partial class GetSHUBInvitationsCountCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.InvitationsCount;
