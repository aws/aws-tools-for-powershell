...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetInsightResults API operation.", Operation = new[] {"GetInsightResults"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.InsightResults",
        "This cmdlet returns a InsightResults object.",
    ...
    public partial class GetSHUBInsightResultCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.InsightResults;
        ...
        private Amazon.SecurityHub.Model.GetInsightResultsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetInsightResultsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetInsightResultsAsync(request);
                return task.Result;
                #else
