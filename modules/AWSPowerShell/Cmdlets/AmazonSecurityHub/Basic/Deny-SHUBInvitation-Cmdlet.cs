...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub DeclineInvitations API operation.", Operation = new[] {"DeclineInvitations"})]
    ...
    public partial class DenySHUBInvitationCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-SHUBInvitation (DeclineInvitations)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityHub.Model.DeclineInvitationsRequest();
        ...
        private Amazon.SecurityHub.Model.DeclineInvitationsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.DeclineInvitationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "DeclineInvitations");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeclineInvitationsAsync(request);
                return task.Result;
                #else
