...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetInsights API operation.", Operation = new[] {"GetInsights"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Insight",
        "This cmdlet returns a collection of Insight objects.",
    ...
    public partial class GetSHUBInsightCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.InsightArns = new List<System.String>(this.InsightArn);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.InsightArns != null)
            {
                request.InsightArns = cmdletContext.InsightArns;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Insights;
        ...
        private Amazon.SecurityHub.Model.GetInsightsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetInsightsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetInsightsAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<System.String> InsightArns { get; set; }
