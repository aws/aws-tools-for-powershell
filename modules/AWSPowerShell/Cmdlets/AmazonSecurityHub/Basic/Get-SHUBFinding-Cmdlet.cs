...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetFindings API operation.", Operation = new[] {"GetFindings"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.AwsSecurityFinding",
        "This cmdlet returns a collection of AwsSecurityFinding objects.",
        "The service call response (type Amazon.SecurityHub.Model.GetFindingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSHUBFindingCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.SortCriteria = new List<Amazon.SecurityHub.Model.SortCriterion>(this.SortCriterion);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityHub.Model.GetFindingsRequest();
        ...
        private Amazon.SecurityHub.Model.GetFindingsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetFindingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "GetFindings");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetFindingsAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<Amazon.SecurityHub.Model.SortCriterion> SortCriteria { get; set; }
        }
