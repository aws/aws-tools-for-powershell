...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    /// </summary>
    [Cmdlet("Get", "SHUBEnabledStandard")]
    [OutputType("Amazon.SecurityHub.Model.StandardsSubscription")]
    [AWSCmdlet("Calls the AWS Security Hub GetEnabledStandards API operation.", Operation = new[] {"GetEnabledStandards"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.StandardsSubscription",
        ...
        "The service call response (type Amazon.SecurityHub.Model.GetEnabledStandardsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSHUBEnabledStandardCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.StandardsSubscriptionArns = new List<System.String>(this.StandardsSubscriptionArn);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.StandardsSubscriptionArns != null)
            {
                request.StandardsSubscriptionArns = cmdletContext.StandardsSubscriptionArns;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.StandardsSubscriptions.Count;
        ...
        private Amazon.SecurityHub.Model.GetEnabledStandardsResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.GetEnabledStandardsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "GetEnabledStandards");
            try
            {
                #if DESKTOP
                return client.GetEnabledStandards(request);
                #elif CORECLR
                return client.GetEnabledStandardsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> StandardsSubscriptionArns { get; set; }
        }
