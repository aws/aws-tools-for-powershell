...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub BatchDisableStandards API operation.", Operation = new[] {"BatchDisableStandards"})]
    ...
    public partial class DisableSHUBStandardsBatchCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("StandardsSubscriptionArn", MyInvocation.BoundParameters);
