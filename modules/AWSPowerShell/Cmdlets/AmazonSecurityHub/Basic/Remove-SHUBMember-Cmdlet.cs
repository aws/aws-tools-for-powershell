...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub DeleteMembers API operation.", Operation = new[] {"DeleteMembers"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Result",
        "This cmdlet returns a collection of Result objects.",
        "The service call response (type Amazon.SecurityHub.Model.DeleteMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
