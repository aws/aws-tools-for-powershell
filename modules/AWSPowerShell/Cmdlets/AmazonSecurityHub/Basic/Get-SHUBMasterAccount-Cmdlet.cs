...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    [AWSCmdlet("Calls the AWS Security Hub GetMasterAccount API operation.", Operation = new[] {"GetMasterAccount"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Invitation",
        "This cmdlet returns a Invitation object.",
