...
namespace Amazon.PowerShell.Cmdlets.SHUB
{
    ...
    /// </summary>
    [Cmdlet("Get", "SHUBMemberList")]
    [OutputType("Amazon.SecurityHub.Model.Member")]
    [AWSCmdlet("Calls the AWS Security Hub ListMembers API operation.", Operation = new[] {"ListMembers"})]
    [AWSCmdletOutput("Amazon.SecurityHub.Model.Member",
        "This cmdlet returns a collection of Member objects.",
        "The service call response (type Amazon.SecurityHub.Model.ListMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSHUBMemberListCmdlet : AmazonSecurityHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("OnlyAssociated"))
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SecurityHub.Model.ListMembersRequest();
        ...
        private Amazon.SecurityHub.Model.ListMembersResponse CallAWSServiceOperation(IAmazonSecurityHub client, Amazon.SecurityHub.Model.ListMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Security Hub", "ListMembers");
            try
            {
                #if DESKTOP
