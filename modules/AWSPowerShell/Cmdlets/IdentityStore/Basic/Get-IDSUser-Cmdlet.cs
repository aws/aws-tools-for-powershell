...
namespace Amazon.PowerShell.Cmdlets.IDS
{
    ...
    public partial class GetIDSUserCmdlet : AmazonIdentityStoreClientCmdlet, IExecutor
    {
        ...
        private Amazon.IdentityStore.Model.DescribeUserResponse CallAWSServiceOperation(IAmazonIdentityStore client, Amazon.IdentityStore.Model.DescribeUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity Store", "DescribeUser");
            try
            {
