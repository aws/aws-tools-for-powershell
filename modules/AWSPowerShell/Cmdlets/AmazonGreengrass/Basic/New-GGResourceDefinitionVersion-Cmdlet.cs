...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass CreateResourceDefinitionVersion API operation.", Operation = new[] {"CreateResourceDefinitionVersion"})]
    [AWSCmdletOutput("Amazon.Greengrass.Model.CreateResourceDefinitionVersionResponse",
        "This cmdlet returns a Amazon.Greengrass.Model.CreateResourceDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGGResourceDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Resources = new List<Amazon.Greengrass.Model.Resource>(this.Resource);
            }
        ...
        private Amazon.Greengrass.Model.CreateResourceDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.CreateResourceDefinitionVersionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateResourceDefinitionVersionAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AmznClientToken { get; set; }
            public System.String ResourceDefinitionId { get; set; }
            public List<Amazon.Greengrass.Model.Resource> Resources { get; set; }
        }
