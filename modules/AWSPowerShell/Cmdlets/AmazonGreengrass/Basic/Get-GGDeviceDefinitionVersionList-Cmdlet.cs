...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Invokes the ListDeviceDefinitionVersions operation against AWS Greengrass.", Operation = new[] {"ListDeviceDefinitionVersions"})]
    ...
    public partial class GetGGDeviceDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        private Amazon.Greengrass.Model.ListDeviceDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListDeviceDefinitionVersionsRequest request)
        {
            ...
            var task = client.ListDeviceDefinitionVersionsAsync(request);
            return task.Result;
            #else
