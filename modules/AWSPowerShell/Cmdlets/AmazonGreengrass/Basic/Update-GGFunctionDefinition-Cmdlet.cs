...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class UpdateGGFunctionDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GGFunctionDefinition (UpdateFunctionDefinition)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.UpdateFunctionDefinitionRequest();
        ...
        private Amazon.Greengrass.Model.UpdateFunctionDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.UpdateFunctionDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "UpdateFunctionDefinition");
            try
            {
                #if DESKTOP
                return client.UpdateFunctionDefinition(request);
                #elif CORECLR
                return client.UpdateFunctionDefinitionAsync(request).GetAwaiter().GetResult();
                #else
