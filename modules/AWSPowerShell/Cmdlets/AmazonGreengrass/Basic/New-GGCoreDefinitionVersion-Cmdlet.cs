...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Invokes the CreateCoreDefinitionVersion operation against AWS Greengrass.", Operation = new[] {"CreateCoreDefinitionVersion"})]
    [AWSCmdletOutput("Amazon.Greengrass.Model.CreateCoreDefinitionVersionResponse",
        "This cmdlet returns a Amazon.Greengrass.Model.CreateCoreDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGGCoreDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Core != null)
            {
                context.Cores = new List<Amazon.Greengrass.Model.Core>(this.Core);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Cores != null)
            {
                request.Cores = cmdletContext.Cores;
            }
        ...
        private Amazon.Greengrass.Model.CreateCoreDefinitionVersionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.CreateCoreDefinitionVersionRequest request)
        {
            ...
            var task = client.CreateCoreDefinitionVersionAsync(request);
            return task.Result;
            #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AmznClientToken { get; set; }
            public System.String CoreDefinitionId { get; set; }
            public List<Amazon.Greengrass.Model.Core> Cores { get; set; }
        }
