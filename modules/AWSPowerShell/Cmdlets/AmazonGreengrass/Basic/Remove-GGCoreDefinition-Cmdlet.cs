...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class RemoveGGCoreDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("CoreDefinitionId", MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGCoreDefinition (DeleteCoreDefinition)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.DeleteCoreDefinitionRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.CoreDefinitionId;
        ...
        private Amazon.Greengrass.Model.DeleteCoreDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DeleteCoreDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "DeleteCoreDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteCoreDefinition(request);
                #elif CORECLR
                return client.DeleteCoreDefinitionAsync(request).GetAwaiter().GetResult();
                #else
