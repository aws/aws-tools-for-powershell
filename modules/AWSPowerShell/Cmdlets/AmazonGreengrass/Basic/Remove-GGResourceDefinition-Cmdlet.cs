...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass DeleteResourceDefinition API operation.", Operation = new[] {"DeleteResourceDefinition"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ResourceDefinitionId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveGGResourceDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ResourceDefinitionId;
        ...
        private Amazon.Greengrass.Model.DeleteResourceDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DeleteResourceDefinitionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteResourceDefinitionAsync(request);
                return task.Result;
                #else
