...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGFunctionDefinitionVersionList")]
    [OutputType("Amazon.Greengrass.Model.VersionInformation")]
    [AWSCmdlet("Calls the AWS Greengrass ListFunctionDefinitionVersions API operation.", Operation = new[] {"ListFunctionDefinitionVersions"})]
    [AWSCmdletOutput("Amazon.Greengrass.Model.VersionInformation",
        "This cmdlet returns a collection of VersionInformation objects.",
        "The service call response (type Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetGGFunctionDefinitionVersionListCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Greengrass.Model.ListFunctionDefinitionVersionsRequest();
        ...
        private Amazon.Greengrass.Model.ListFunctionDefinitionVersionsResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.ListFunctionDefinitionVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "ListFunctionDefinitionVersions");
            try
            {
                #if DESKTOP
                return client.ListFunctionDefinitionVersions(request);
                #elif CORECLR
                return client.ListFunctionDefinitionVersionsAsync(request).GetAwaiter().GetResult();
                #else
