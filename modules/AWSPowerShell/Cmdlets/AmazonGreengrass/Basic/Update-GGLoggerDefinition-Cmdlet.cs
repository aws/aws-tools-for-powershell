...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass UpdateLoggerDefinition API operation.", Operation = new[] {"UpdateLoggerDefinition"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.Greengrass.Model.UpdateLoggerDefinitionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateGGLoggerDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        private Amazon.Greengrass.Model.UpdateLoggerDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.UpdateLoggerDefinitionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateLoggerDefinition(request);
                #elif CORECLR
                return client.UpdateLoggerDefinitionAsync(request).GetAwaiter().GetResult();
                #else
