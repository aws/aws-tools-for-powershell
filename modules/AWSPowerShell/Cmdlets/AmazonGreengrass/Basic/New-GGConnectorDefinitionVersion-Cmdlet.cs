...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    [AWSCmdlet("Calls the AWS Greengrass CreateConnectorDefinitionVersion API operation.", Operation = new[] {"CreateConnectorDefinitionVersion"})]
    [AWSCmdletOutput("Amazon.Greengrass.Model.CreateConnectorDefinitionVersionResponse",
        "This cmdlet returns a Amazon.Greengrass.Model.CreateConnectorDefinitionVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewGGConnectorDefinitionVersionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Connectors = new List<Amazon.Greengrass.Model.Connector>(this.Connector);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Connectors != null)
            {
                request.Connectors = cmdletContext.Connectors;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AmznClientToken { get; set; }
            public System.String ConnectorDefinitionId { get; set; }
            public List<Amazon.Greengrass.Model.Connector> Connectors { get; set; }
        }
