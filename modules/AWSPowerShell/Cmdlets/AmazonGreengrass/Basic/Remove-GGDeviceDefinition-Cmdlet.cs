...
namespace Amazon.PowerShell.Cmdlets.GG
{
    ...
    public partial class RemoveGGDeviceDefinitionCmdlet : AmazonGreengrassClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGDeviceDefinition (DeleteDeviceDefinition)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Greengrass.Model.DeleteDeviceDefinitionRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.DeviceDefinitionId;
        ...
        private Amazon.Greengrass.Model.DeleteDeviceDefinitionResponse CallAWSServiceOperation(IAmazonGreengrass client, Amazon.Greengrass.Model.DeleteDeviceDefinitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Greengrass", "DeleteDeviceDefinition");
            try
            {
                #if DESKTOP
                return client.DeleteDeviceDefinition(request);
                #elif CORECLR
                return client.DeleteDeviceDefinitionAsync(request).GetAwaiter().GetResult();
                #else
