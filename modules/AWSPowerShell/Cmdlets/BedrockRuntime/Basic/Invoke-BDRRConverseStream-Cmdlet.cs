...
namespace Amazon.PowerShell.Cmdlets.BDRR
{
    ...
    [OutputType("Amazon.BedrockRuntime.Model.ConverseStreamOutput")]
    ...
    public partial class InvokeBDRRConverseStreamCmdlet : AmazonBedrockRuntimeClientCmdlet, IExecutor
    {
        ...
        /// parameters that <c>ConverseStream</c> supports in the <c>inferenceConfig</c> field.</para>
        /// </para>
        /// </summary>
        ...
        /// field is not in the model response, it is ignored by <c>ConverseStream</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A system prompt to send to the model.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Invoke-BDRRConverseStream (ConverseStream)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BedrockRuntime.Model.ConverseStreamResponse, InvokeBDRRConverseStreamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BedrockRuntime.Model.ConverseStreamRequest();
        ...
        private Amazon.BedrockRuntime.Model.ConverseStreamResponse CallAWSServiceOperation(IAmazonBedrockRuntime client, Amazon.BedrockRuntime.Model.ConverseStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Bedrock Runtime", "ConverseStream");
            try
            {
                #if DESKTOP
                return client.ConverseStream(request);
                #elif CORECLR
                return client.ConverseStreamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BedrockRuntime.Model.ConverseStreamResponse, InvokeBDRRConverseStreamCmdlet, object> Select { get; set; } =
