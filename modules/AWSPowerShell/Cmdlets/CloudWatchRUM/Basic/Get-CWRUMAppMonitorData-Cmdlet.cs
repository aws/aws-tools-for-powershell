...
namespace Amazon.PowerShell.Cmdlets.CWRUM
{
    ...
    /// so that you can do your own processing or analysis of this data.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCWRUMAppMonitorDataCmdlet : AmazonCloudWatchRUMClientCmdlet, IExecutor
    {
        ...
        /// one or more sets of key-value pairs that you specify.</para><para />
        ...
        private Amazon.CloudWatchRUM.Model.GetAppMonitorDataResponse CallAWSServiceOperation(IAmazonCloudWatchRUM client, Amazon.CloudWatchRUM.Model.GetAppMonitorDataRequest request)
        {
            ...
            try
            {
                return client.GetAppMonitorDataAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
