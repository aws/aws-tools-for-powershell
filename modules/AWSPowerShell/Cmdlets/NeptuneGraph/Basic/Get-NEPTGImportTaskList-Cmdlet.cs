...
{
    /// <summary>
    /// Lists import tasks.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "NEPTGImportTaskList")]
    [OutputType("Amazon.NeptuneGraph.Model.ImportTaskSummary")]
    [AWSCmdlet("Calls the Amazon Neptune Graph ListImportTasks API operation.", Operation = new[] {"ListImportTasks"}, SelectReturnType = typeof(Amazon.NeptuneGraph.Model.ListImportTasksResponse))]
    [AWSCmdletOutput("Amazon.NeptuneGraph.Model.ImportTaskSummary or Amazon.NeptuneGraph.Model.ListImportTasksResponse",
        "This cmdlet returns a collection of Amazon.NeptuneGraph.Model.ImportTaskSummary objects.",
        "The service call response (type Amazon.NeptuneGraph.Model.ListImportTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNEPTGImportTaskListCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        private Amazon.NeptuneGraph.Model.ListImportTasksResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.ListImportTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune Graph", "ListImportTasks");
            try
            {
                return client.ListImportTasksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
