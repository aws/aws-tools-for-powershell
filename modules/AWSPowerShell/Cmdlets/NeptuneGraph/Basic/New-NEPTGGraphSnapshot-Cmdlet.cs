...
namespace Amazon.PowerShell.Cmdlets.NEPTG
{
    ...
    /// </summary>
    [Cmdlet("New", "NEPTGGraphSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse")]
    [AWSCmdlet("Calls the Amazon Neptune Graph CreateGraphSnapshot API operation.", Operation = new[] {"CreateGraphSnapshot"}, SelectReturnType = typeof(Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse))]
    [AWSCmdletOutput("Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse",
        "This cmdlet returns an Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewNEPTGGraphSnapshotCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The snapshot name. For example: <code>my-snapshot-1</code>.</para><para>The name must contain from 1 to 63 letters, numbers, or hyphens, and its first character
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-NEPTGGraphSnapshot (CreateGraphSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse, NewNEPTGGraphSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NeptuneGraph.Model.CreateGraphSnapshotRequest();
        ...
        private Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.CreateGraphSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune Graph", "CreateGraphSnapshot");
            try
            {
                #if DESKTOP
                return client.CreateGraphSnapshot(request);
                #elif CORECLR
                return client.CreateGraphSnapshotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.NeptuneGraph.Model.CreateGraphSnapshotResponse, NewNEPTGGraphSnapshotCmdlet, object> Select { get; set; } =
