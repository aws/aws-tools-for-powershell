...
namespace Amazon.PowerShell.Cmdlets.NEPTG
{
    ...
    /// </summary>
    [Cmdlet("Add", "NEPTGResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddNEPTGResourceTagCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-NEPTGResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NeptuneGraph.Model.TagResourceResponse, AddNEPTGResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NeptuneGraph.Model.TagResourceRequest();
        ...
        private Amazon.NeptuneGraph.Model.TagResourceResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune Graph", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.NeptuneGraph.Model.TagResourceResponse, AddNEPTGResourceTagCmdlet, object> Select { get; set; } =
