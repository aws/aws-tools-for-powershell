...
namespace Amazon.PowerShell.Cmdlets.NEPTG
{
    ...
    /// </summary>
    [Cmdlet("Get", "NEPTGPrivateGraphEndpoint")]
    [OutputType("Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse")]
    [AWSCmdlet("Calls the Amazon Neptune Graph GetPrivateGraphEndpoint API operation.", Operation = new[] {"GetPrivateGraphEndpoint"}, SelectReturnType = typeof(Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse))]
    [AWSCmdletOutput("Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse",
        "This cmdlet returns an Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNEPTGPrivateGraphEndpointCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse, GetNEPTGPrivateGraphEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointRequest();
        ...
        private Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune Graph", "GetPrivateGraphEndpoint");
            try
            {
                #if DESKTOP
                return client.GetPrivateGraphEndpoint(request);
                #elif CORECLR
                return client.GetPrivateGraphEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GraphIdentifier { get; set; }
            public System.String VpcId { get; set; }
            public System.Func<Amazon.NeptuneGraph.Model.GetPrivateGraphEndpointResponse, GetNEPTGPrivateGraphEndpointCmdlet, object> Select { get; set; } =
