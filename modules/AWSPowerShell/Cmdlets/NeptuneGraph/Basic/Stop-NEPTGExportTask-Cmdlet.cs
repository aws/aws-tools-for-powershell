...
namespace Amazon.PowerShell.Cmdlets.NEPTG
{
    ...
    /// </summary>
    [Cmdlet("Stop", "NEPTGExportTask", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NeptuneGraph.Model.CancelExportTaskResponse")]
    [AWSCmdlet("Calls the Amazon Neptune Graph CancelExportTask API operation.", Operation = new[] {"CancelExportTask"}, SelectReturnType = typeof(Amazon.NeptuneGraph.Model.CancelExportTaskResponse))]
    [AWSCmdletOutput("Amazon.NeptuneGraph.Model.CancelExportTaskResponse",
        "This cmdlet returns an Amazon.NeptuneGraph.Model.CancelExportTaskResponse object containing multiple properties."
    )]
    public partial class StopNEPTGExportTaskCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-NEPTGExportTask (CancelExportTask)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NeptuneGraph.Model.CancelExportTaskRequest();
        ...
        private Amazon.NeptuneGraph.Model.CancelExportTaskResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.CancelExportTaskRequest request)
        {
        ...
        {
            public System.String TaskIdentifier { get; set; }
            public System.Func<Amazon.NeptuneGraph.Model.CancelExportTaskResponse, StopNEPTGExportTaskCmdlet, object> Select { get; set; } =
