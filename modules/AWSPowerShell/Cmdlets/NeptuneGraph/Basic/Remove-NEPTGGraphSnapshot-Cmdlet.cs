...
namespace Amazon.PowerShell.Cmdlets.NEPTG
{
    ...
    public partial class RemoveNEPTGGraphSnapshotCmdlet : AmazonNeptuneGraphClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NEPTGGraphSnapshot (DeleteGraphSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NeptuneGraph.Model.DeleteGraphSnapshotResponse, RemoveNEPTGGraphSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NeptuneGraph.Model.DeleteGraphSnapshotRequest();
        ...
        private Amazon.NeptuneGraph.Model.DeleteGraphSnapshotResponse CallAWSServiceOperation(IAmazonNeptuneGraph client, Amazon.NeptuneGraph.Model.DeleteGraphSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune Graph", "DeleteGraphSnapshot");
            try
            {
                #if DESKTOP
                return client.DeleteGraphSnapshot(request);
                #elif CORECLR
                return client.DeleteGraphSnapshotAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SnapshotIdentifier { get; set; }
            public System.Func<Amazon.NeptuneGraph.Model.DeleteGraphSnapshotResponse, RemoveNEPTGGraphSnapshotCmdlet, object> Select { get; set; } =
