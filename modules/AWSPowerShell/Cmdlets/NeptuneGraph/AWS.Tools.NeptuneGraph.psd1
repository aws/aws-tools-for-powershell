#
# Module manifest for module 'AWS.Tools.NeptuneGraph'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.NeptuneGraph.dll'
    ...
    GUID = 'b2acb06e-7ce4-49d9-ac20-f67076ff94ab'
    ...
    Description = 'The NeptuneGraph module of AWS Tools for PowerShell lets developers and administrators manage Amazon Neptune Graph from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.NeptuneGraph.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.NeptuneGraph.Completers.psm1',
        'AWS.Tools.NeptuneGraph.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.NeptuneGraph.dll-Help.xml'
    )
