...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    [OutputType("Amazon.IAMRolesAnywhere.Model.Tag")]
    ...
    public partial class GetIAMRAResourceTagCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.ListTagsForResourceResponse, GetIAMRAResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.ListTagsForResourceRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.ListTagsForResourceResponse, GetIAMRAResourceTagCmdlet, object> Select { get; set; } =
