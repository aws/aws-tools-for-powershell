...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    [AWSCmdlet("Calls the IAM Roles Anywhere DeleteProfile API operation.", Operation = new[] {"DeleteProfile"}, SelectReturnType = typeof(Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse))]
    [AWSCmdletOutput("Amazon.IAMRolesAnywhere.Model.ProfileDetail or Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse",
        "This cmdlet returns an Amazon.IAMRolesAnywhere.Model.ProfileDetail object.",
        "The service call response (type Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveIAMRAProfileCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMRAProfile (DeleteProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse, RemoveIAMRAProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.DeleteProfileRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.DeleteProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "DeleteProfile");
            try
            {
        ...
        {
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.DeleteProfileResponse, RemoveIAMRAProfileCmdlet, object> Select { get; set; } =
