...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    public partial class GetIAMRAProfileCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.GetProfileResponse, GetIAMRAProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.GetProfileRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.GetProfileResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.GetProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "GetProfile");
            try
            {
        ...
        {
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.GetProfileResponse, GetIAMRAProfileCmdlet, object> Select { get; set; } =
