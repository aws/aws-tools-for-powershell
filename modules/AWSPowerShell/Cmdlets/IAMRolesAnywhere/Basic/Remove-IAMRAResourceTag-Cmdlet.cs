...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "IAMRAResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveIAMRAResourceTagCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of keys. Tag keys are the unique identifiers of tags. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMRAResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.UntagResourceResponse, RemoveIAMRAResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.UntagResourceRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IAMRolesAnywhere.Model.UntagResourceResponse, RemoveIAMRAResourceTagCmdlet, object> Select { get; set; } =
