...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    public partial class DisableIAMRAProfileCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-IAMRAProfile (DisableProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.DisableProfileResponse, DisableIAMRAProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.DisableProfileRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.DisableProfileResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.DisableProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "DisableProfile");
            try
            {
                #if DESKTOP
                return client.DisableProfile(request);
                #elif CORECLR
                return client.DisableProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.DisableProfileResponse, DisableIAMRAProfileCmdlet, object> Select { get; set; } =
