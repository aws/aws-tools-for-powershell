...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    [AWSCmdlet("Calls the IAM Roles Anywhere DisableTrustAnchor API operation.", Operation = new[] {"DisableTrustAnchor"}, SelectReturnType = typeof(Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse))]
    [AWSCmdletOutput("Amazon.IAMRolesAnywhere.Model.TrustAnchorDetail or Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse",
        "This cmdlet returns an Amazon.IAMRolesAnywhere.Model.TrustAnchorDetail object.",
        "The service call response (type Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DisableIAMRATrustAnchorCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-IAMRATrustAnchor (DisableTrustAnchor)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse, DisableIAMRATrustAnchorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "DisableTrustAnchor");
            try
            {
                #if DESKTOP
                return client.DisableTrustAnchor(request);
                #elif CORECLR
                return client.DisableTrustAnchorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String TrustAnchorId { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.DisableTrustAnchorResponse, DisableIAMRATrustAnchorCmdlet, object> Select { get; set; } =
