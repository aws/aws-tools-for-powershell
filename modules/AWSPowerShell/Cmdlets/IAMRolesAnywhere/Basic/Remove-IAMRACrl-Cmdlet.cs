...
namespace Amazon.PowerShell.Cmdlets.IAMRA
{
    ...
    public partial class RemoveIAMRACrlCmdlet : AmazonIAMRolesAnywhereClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMRACrl (DeleteCrl)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IAMRolesAnywhere.Model.DeleteCrlResponse, RemoveIAMRACrlCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IAMRolesAnywhere.Model.DeleteCrlRequest();
        ...
        private Amazon.IAMRolesAnywhere.Model.DeleteCrlResponse CallAWSServiceOperation(IAmazonIAMRolesAnywhere client, Amazon.IAMRolesAnywhere.Model.DeleteCrlRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "IAM Roles Anywhere", "DeleteCrl");
            try
            {
                #if DESKTOP
                return client.DeleteCrl(request);
                #elif CORECLR
                return client.DeleteCrlAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CrlId { get; set; }
            public System.Func<Amazon.IAMRolesAnywhere.Model.DeleteCrlResponse, RemoveIAMRACrlCmdlet, object> Select { get; set; } =
