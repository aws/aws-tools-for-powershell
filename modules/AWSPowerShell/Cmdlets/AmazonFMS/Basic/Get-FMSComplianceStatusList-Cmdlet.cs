...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service ListComplianceStatus API operation.", Operation = new[] {"ListComplianceStatus"})]
    [AWSCmdletOutput("Amazon.FMS.Model.PolicyComplianceStatus",
        "This cmdlet returns a collection of PolicyComplianceStatus objects.",
        "The service call response (type Amazon.FMS.Model.ListComplianceStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetFMSComplianceStatusListCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.FMS.Model.ListComplianceStatusRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.PolicyComplianceStatusList;
                        ...
                        int _receivedThisCall = response.PolicyComplianceStatusList.Count;
        ...
        private Amazon.FMS.Model.ListComplianceStatusResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.ListComplianceStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Firewall Management Service", "ListComplianceStatus");
            try
            {
                #if DESKTOP
                return client.ListComplianceStatus(request);
                #elif CORECLR
                return client.ListComplianceStatusAsync(request).GetAwaiter().GetResult();
                #else
