...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service ListPolicies API operation.", Operation = new[] {"ListPolicies"})]
    [AWSCmdletOutput("Amazon.FMS.Model.PolicySummary",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.PolicyList;
