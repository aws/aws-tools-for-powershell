...
namespace Amazon.PowerShell.Cmdlets.FMS
{
    ...
    [AWSCmdlet("Calls the Firewall Management Service GetNotificationChannel API operation.", Operation = new[] {"GetNotificationChannel"})]
    [AWSCmdletOutput("Amazon.FMS.Model.GetNotificationChannelResponse",
        "This cmdlet returns a Amazon.FMS.Model.GetNotificationChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetFMSNotificationChannelCmdlet : AmazonFMSClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.FMS.Model.GetNotificationChannelRequest();
        ...
        private Amazon.FMS.Model.GetNotificationChannelResponse CallAWSServiceOperation(IAmazonFMS client, Amazon.FMS.Model.GetNotificationChannelRequest request)
        {
