...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    [OutputType("None","Amazon.Shield.AutoRenew")]
    [AWSCmdlet("Calls the AWS Shield UpdateSubscription API operation.", Operation = new[] {"UpdateSubscription"})]
    [AWSCmdletOutput("None or Amazon.Shield.AutoRenew",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the AutoRenew parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class UpdateSHLDSubscriptionCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("AutoRenew", MyInvocation.BoundParameters);
        ...
        private Amazon.Shield.Model.UpdateSubscriptionResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.UpdateSubscriptionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateSubscriptionAsync(request);
                return task.Result;
                #else
