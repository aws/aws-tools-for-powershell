...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    public partial class RemoveSHLDSubscriptionCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SHLDSubscription (DeleteSubscription)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Shield.Model.DeleteSubscriptionRequest();
        ...
        private Amazon.Shield.Model.DeleteSubscriptionResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.DeleteSubscriptionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteSubscriptionAsync(request).GetAwaiter().GetResult();
                #else
