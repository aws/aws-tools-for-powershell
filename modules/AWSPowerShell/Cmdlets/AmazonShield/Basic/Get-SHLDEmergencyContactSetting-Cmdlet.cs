...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    [AWSCmdlet("Calls the AWS Shield DescribeEmergencyContactSettings API operation.", Operation = new[] {"DescribeEmergencyContactSettings"})]
    [AWSCmdletOutput("Amazon.Shield.Model.EmergencyContact",
        "This cmdlet returns a collection of EmergencyContact objects.",
    ...
    public partial class GetSHLDEmergencyContactSettingCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.EmergencyContactList;
        ...
        private Amazon.Shield.Model.DescribeEmergencyContactSettingsResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.DescribeEmergencyContactSettingsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeEmergencyContactSettingsAsync(request);
                return task.Result;
                #else
