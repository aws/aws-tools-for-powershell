...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    [AWSCmdlet("Calls the AWS Shield GetSubscriptionState API operation.", Operation = new[] {"GetSubscriptionState"})]
    [AWSCmdletOutput("Amazon.Shield.SubscriptionState",
        "This cmdlet returns a SubscriptionState object.",
    ...
    public partial class GetSHLDSubscriptionStateCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SubscriptionState;
        ...
        private Amazon.Shield.Model.GetSubscriptionStateResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.GetSubscriptionStateRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetSubscriptionStateAsync(request);
                return task.Result;
                #else
