...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    [AWSCmdlet("Invokes the ListProtections operation against AWS Shield.", Operation = new[] {"ListProtections"})]
    [AWSCmdletOutput("Amazon.Shield.Model.Protection",
        "This cmdlet returns a collection of Protection objects.",
    ...
    public partial class GetSHLDProtectionListCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Protections;
        ...
        private Amazon.Shield.Model.ListProtectionsResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.ListProtectionsRequest request)
        {
            ...
            var task = client.ListProtectionsAsync(request);
            return task.Result;
            #else
