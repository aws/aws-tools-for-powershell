...
namespace Amazon.PowerShell.Cmdlets.SHLD
{
    ...
    [AWSCmdlet("Invokes the ListAttacks operation against AWS Shield.", Operation = new[] {"ListAttacks"})]
    ...
    public partial class GetSHLDAttackListCmdlet : AmazonShieldClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Shield.Model.ListAttacksResponse CallAWSServiceOperation(IAmazonShield client, Amazon.Shield.Model.ListAttacksRequest request)
        {
            #if DESKTOP
