...
namespace Amazon.PowerShell.Cmdlets.SSOOIDC
{
    ...
    /// </summary>
    [Cmdlet("Start", "SSOOIDCDeviceAuthorization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartSSOOIDCDeviceAuthorizationCmdlet : AmazonSSOOIDCClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier string for the client that is registered with Amazon Web Services
        ...
        /// the AWS access portal</a> in the <i>Amazon Web Services SSO User Guide</i>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String StartUrl { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-SSOOIDCDeviceAuthorization (StartDeviceAuthorization)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSOOIDC.Model.StartDeviceAuthorizationResponse, StartSSOOIDCDeviceAuthorizationCmdlet>(Select) ??
            ...
            #endif
            context.StartUrl = this.StartUrl;
            #if MODULAR
            if (this.StartUrl == null && ParameterWasBound(nameof(this.StartUrl)))
            {
                WriteWarning("You are passing $null as a value for parameter StartUrl which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSOOIDC.Model.StartDeviceAuthorizationRequest();
            ...
            if (cmdletContext.StartUrl != null)
            {
                request.StartUrl = cmdletContext.StartUrl;
            }
        ...
        private Amazon.SSOOIDC.Model.StartDeviceAuthorizationResponse CallAWSServiceOperation(IAmazonSSOOIDC client, Amazon.SSOOIDC.Model.StartDeviceAuthorizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Single Sign-On OIDC", "StartDeviceAuthorization");
            try
            {
                #if DESKTOP
                return client.StartDeviceAuthorization(request);
                #elif CORECLR
                return client.StartDeviceAuthorizationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientSecret { get; set; }
            public System.String StartUrl { get; set; }
            public System.Func<Amazon.SSOOIDC.Model.StartDeviceAuthorizationResponse, StartSSOOIDCDeviceAuthorizationCmdlet, object> Select { get; set; } =
