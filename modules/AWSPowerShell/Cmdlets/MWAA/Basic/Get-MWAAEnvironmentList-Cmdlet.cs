...
namespace Amazon.PowerShell.Cmdlets.MWAA
{
    ...
    public partial class GetMWAAEnvironmentListCmdlet : AmazonMWAAClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MWAA.Model.ListEnvironmentsResponse, GetMWAAEnvironmentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MWAA.Model.ListEnvironmentsRequest();
        ...
        private Amazon.MWAA.Model.ListEnvironmentsResponse CallAWSServiceOperation(IAmazonMWAA client, Amazon.MWAA.Model.ListEnvironmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AmazonMWAA", "ListEnvironments");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MWAA.Model.ListEnvironmentsResponse, GetMWAAEnvironmentListCmdlet, object> Select { get; set; } =
