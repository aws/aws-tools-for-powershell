...
namespace Amazon.PowerShell.Cmdlets.MWAA
{
    ...
    public partial class NewMWAAWebLoginTokenCmdlet : AmazonMWAAClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-MWAAWebLoginToken (CreateWebLoginToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MWAA.Model.CreateWebLoginTokenResponse, NewMWAAWebLoginTokenCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MWAA.Model.CreateWebLoginTokenRequest();
        ...
        private Amazon.MWAA.Model.CreateWebLoginTokenResponse CallAWSServiceOperation(IAmazonMWAA client, Amazon.MWAA.Model.CreateWebLoginTokenRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AmazonMWAA", "CreateWebLoginToken");
            try
            {
                #if DESKTOP
                return client.CreateWebLoginToken(request);
                #elif CORECLR
                return client.CreateWebLoginTokenAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.MWAA.Model.CreateWebLoginTokenResponse, NewMWAAWebLoginTokenCmdlet, object> Select { get; set; } =
