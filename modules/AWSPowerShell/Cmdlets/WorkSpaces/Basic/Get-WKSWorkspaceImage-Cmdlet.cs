...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </summary>
    [Cmdlet("Get", "WKSWorkspaceImage")]
    [OutputType("Amazon.WorkSpaces.Model.WorkspaceImage")]
    [AWSCmdlet("Calls the Amazon WorkSpaces DescribeWorkspaceImages API operation.", Operation = new[] {"DescribeWorkspaceImages"}, SelectReturnType = typeof(Amazon.WorkSpaces.Model.DescribeWorkspaceImagesResponse))]
    [AWSCmdletOutput("Amazon.WorkSpaces.Model.WorkspaceImage or Amazon.WorkSpaces.Model.DescribeWorkspaceImagesResponse",
        "This cmdlet returns a collection of Amazon.WorkSpaces.Model.WorkspaceImage objects.",
        "The service call response (type Amazon.WorkSpaces.Model.DescribeWorkspaceImagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWKSWorkspaceImageCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DescribeWorkspaceImagesResponse, GetWKSWorkspaceImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkSpaces.Model.DescribeWorkspaceImagesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Images?.Count ?? 0;
        ...
        private Amazon.WorkSpaces.Model.DescribeWorkspaceImagesResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeWorkspaceImagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DescribeWorkspaceImages");
            try
            {
                #if DESKTOP
                return client.DescribeWorkspaceImages(request);
                #elif CORECLR
                return client.DescribeWorkspaceImagesAsync(request).GetAwaiter().GetResult();
                #else
