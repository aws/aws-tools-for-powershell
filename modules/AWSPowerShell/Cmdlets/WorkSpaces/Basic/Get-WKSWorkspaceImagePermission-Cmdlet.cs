...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdlet("Calls the Amazon WorkSpaces DescribeWorkspaceImagePermissions API operation.", Operation = new[] {"DescribeWorkspaceImagePermissions"}, SelectReturnType = typeof(Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse))]
    [AWSCmdletOutput("Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse",
        "This cmdlet returns an Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWKSWorkspaceImagePermissionCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse, GetWKSWorkspaceImagePermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsRequest();
        ...
        private Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DescribeWorkspaceImagePermissions");
            try
            {
                #if DESKTOP
                return client.DescribeWorkspaceImagePermissions(request);
                #elif CORECLR
                return client.DescribeWorkspaceImagePermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.DescribeWorkspaceImagePermissionsResponse, GetWKSWorkspaceImagePermissionCmdlet, object> Select { get; set; } =
