...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </summary>
    [Cmdlet("New", "WKSWorkspaceImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWKSWorkspaceImageCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// to use <c>workspaces:CreateTags</c>.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WKSWorkspaceImage (CreateWorkspaceImage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.CreateWorkspaceImageResponse, NewWKSWorkspaceImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.CreateWorkspaceImageRequest();
        ...
        private Amazon.WorkSpaces.Model.CreateWorkspaceImageResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.CreateWorkspaceImageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "CreateWorkspaceImage");
            try
            {
                return client.CreateWorkspaceImageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String WorkspaceId { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.CreateWorkspaceImageResponse, NewWKSWorkspaceImageCmdlet, object> Select { get; set; } =
