...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// rules.
    /// </summary>
    [Cmdlet("Update", "WKSRulesOfIpGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateWKSRulesOfIpGroupCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more rules.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WKSRulesOfIpGroup (UpdateRulesOfIpGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.UpdateRulesOfIpGroupResponse, UpdateWKSRulesOfIpGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.UpdateRulesOfIpGroupRequest();
        ...
        private Amazon.WorkSpaces.Model.UpdateRulesOfIpGroupResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.UpdateRulesOfIpGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "UpdateRulesOfIpGroup");
            try
            {
                return client.UpdateRulesOfIpGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkSpaces.Model.UpdateRulesOfIpGroupResponse, UpdateWKSRulesOfIpGroupCmdlet, object> Select { get; set; } =
