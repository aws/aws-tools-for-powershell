...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WKSAccountLinkInvitation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveWKSAccountLinkInvitationCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationResponse).
        /// Specifying the name of a property of type Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WKSAccountLinkInvitation (DeleteAccountLinkInvitation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationResponse, RemoveWKSAccountLinkInvitationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationRequest();
        ...
        private Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DeleteAccountLinkInvitation");
            try
            {
                #if DESKTOP
                return client.DeleteAccountLinkInvitation(request);
                #elif CORECLR
                return client.DeleteAccountLinkInvitationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String LinkId { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.DeleteAccountLinkInvitationResponse, RemoveWKSAccountLinkInvitationCmdlet, object> Select { get; set; } =
