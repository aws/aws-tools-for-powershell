...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    public partial class GetWKSWorkspaceBundleCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifiers of the bundles. You cannot combine this parameter with any other filter.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The owner of the bundles. You cannot combine this parameter with any other filter.</para><para>To describe the bundles provided by Amazon Web Services, specify <c>AMAZON</c>. To
        /// describe the bundles that belong to your account, don't specify a value.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.WorkSpaces.Model.DescribeWorkspaceBundlesResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeWorkspaceBundlesRequest request)
        {
            ...
            try
            {
                return client.DescribeWorkspaceBundlesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
