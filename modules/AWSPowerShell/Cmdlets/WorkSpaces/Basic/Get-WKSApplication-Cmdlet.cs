...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdletOutput("Amazon.WorkSpaces.Model.WorkSpaceApplication or Amazon.WorkSpaces.Model.DescribeApplicationsResponse",
        ...
        "The service call response (type Amazon.WorkSpaces.Model.DescribeApplicationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
