...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </summary>
    [Cmdlet("Get", "WKSImageAssociation")]
    [OutputType("Amazon.WorkSpaces.Model.ImageResourceAssociation")]
    ...
    public partial class GetWKSImageAssociationCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WorkSpaces.Model.DescribeImageAssociationsResponse).
        /// Specifying the name of a property of type Amazon.WorkSpaces.Model.DescribeImageAssociationsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DescribeImageAssociationsResponse, GetWKSImageAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.DescribeImageAssociationsRequest();
        ...
        private Amazon.WorkSpaces.Model.DescribeImageAssociationsResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeImageAssociationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DescribeImageAssociations");
            try
            {
                #if DESKTOP
                return client.DescribeImageAssociations(request);
                #elif CORECLR
                return client.DescribeImageAssociationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ImageId { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.DescribeImageAssociationsResponse, GetWKSImageAssociationCmdlet, object> Select { get; set; } =
