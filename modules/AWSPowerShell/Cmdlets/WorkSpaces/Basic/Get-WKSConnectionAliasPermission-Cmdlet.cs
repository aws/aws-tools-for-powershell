...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    public partial class GetWKSConnectionAliasPermissionCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DescribeConnectionAliasPermissionsResponse, GetWKSConnectionAliasPermissionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WorkSpaces.Model.DescribeConnectionAliasPermissionsRequest();
        ...
        private Amazon.WorkSpaces.Model.DescribeConnectionAliasPermissionsResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeConnectionAliasPermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DescribeConnectionAliasPermissions");
            try
            {
                #if DESKTOP
                return client.DescribeConnectionAliasPermissions(request);
                #elif CORECLR
                return client.DescribeConnectionAliasPermissionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.DescribeConnectionAliasPermissionsResponse, GetWKSConnectionAliasPermissionCmdlet, object> Select { get; set; } =
