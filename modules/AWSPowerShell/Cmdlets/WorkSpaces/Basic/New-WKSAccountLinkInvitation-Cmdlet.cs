...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdletOutput("Amazon.WorkSpaces.Model.AccountLink or Amazon.WorkSpaces.Model.CreateAccountLinkInvitationResponse",
        ...
        "The service call response (type Amazon.WorkSpaces.Model.CreateAccountLinkInvitationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWKSAccountLinkInvitationCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TargetAccountId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TargetAccountId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TargetAccountId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TargetAccountId;
            }
        ...
        private Amazon.WorkSpaces.Model.CreateAccountLinkInvitationResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.CreateAccountLinkInvitationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateAccountLinkInvitation(request);
                #elif CORECLR
                return client.CreateAccountLinkInvitationAsync(request).GetAwaiter().GetResult();
                #else
