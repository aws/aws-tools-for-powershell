...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "WKSIpGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWKSIpGroupCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WKSIpGroup (DeleteIpGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.DeleteIpGroupResponse, RemoveWKSIpGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.DeleteIpGroupRequest();
        ...
        private Amazon.WorkSpaces.Model.DeleteIpGroupResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DeleteIpGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "DeleteIpGroup");
            try
            {
                #if DESKTOP
                return client.DeleteIpGroup(request);
                #elif CORECLR
                return client.DeleteIpGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String GroupId { get; set; }
            public System.Func<Amazon.WorkSpaces.Model.DeleteIpGroupResponse, RemoveWKSIpGroupCmdlet, object> Select { get; set; } =
