...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    [AWSCmdletOutput("Amazon.WorkSpaces.Model.WorkspaceDirectory or Amazon.WorkSpaces.Model.DescribeWorkspaceDirectoriesResponse",
        ...
        "The service call response (type Amazon.WorkSpaces.Model.DescribeWorkspaceDirectoriesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWKSWorkspaceDirectoryCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifiers of the directories. If the value is null, all directories are retrieved.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The filter condition for the WorkSpaces.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the WorkSpace directories.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.WorkSpaces.Model.DescribeWorkspaceDirectoriesResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.DescribeWorkspaceDirectoriesRequest request)
        {
            ...
            try
            {
                return client.DescribeWorkspaceDirectoriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
