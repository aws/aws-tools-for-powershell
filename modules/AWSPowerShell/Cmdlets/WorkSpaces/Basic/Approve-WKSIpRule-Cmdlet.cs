...
namespace Amazon.PowerShell.Cmdlets.WKS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Approve", "WKSIpRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class ApproveWKSIpRuleCmdlet : AmazonWorkSpacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The rules to add to the group.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-WKSIpRule (AuthorizeIpRules)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpaces.Model.AuthorizeIpRulesResponse, ApproveWKSIpRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpaces.Model.AuthorizeIpRulesRequest();
        ...
        private Amazon.WorkSpaces.Model.AuthorizeIpRulesResponse CallAWSServiceOperation(IAmazonWorkSpaces client, Amazon.WorkSpaces.Model.AuthorizeIpRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces", "AuthorizeIpRules");
            try
            {
                return client.AuthorizeIpRulesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkSpaces.Model.AuthorizeIpRulesResponse, ApproveWKSIpRuleCmdlet, object> Select { get; set; } =
