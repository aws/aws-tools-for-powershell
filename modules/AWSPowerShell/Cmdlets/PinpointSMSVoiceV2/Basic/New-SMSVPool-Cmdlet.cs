...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    public partial class NewSMSVPoolCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// can be used to get the values for SenderId and SenderIdArn.</para><para>After the pool is created you can add more origination identities to the pool by using
        /// <a href="https://docs.aws.amazon.com/pinpoint/latest/apireference_smsvoicev2/API_AssociateOriginationIdentity.html">AssociateOriginationIdentity</a>.</para><important><para>If you are using a shared End User Messaging SMS resource then you must use the full
