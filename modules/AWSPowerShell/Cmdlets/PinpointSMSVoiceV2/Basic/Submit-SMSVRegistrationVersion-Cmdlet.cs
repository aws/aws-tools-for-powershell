...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    /// </summary>
    [Cmdlet("Submit", "SMSVRegistrationVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class SubmitSMSVRegistrationVersionCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PinpointSMSVoiceV2.Model.SubmitRegistrationVersionResponse).
        /// Specifying the name of a property of type Amazon.PinpointSMSVoiceV2.Model.SubmitRegistrationVersionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Submit-SMSVRegistrationVersion (SubmitRegistrationVersion)"))
            {
                return;
            }
        ...
        private Amazon.PinpointSMSVoiceV2.Model.SubmitRegistrationVersionResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.SubmitRegistrationVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint SMS Voice V2", "SubmitRegistrationVersion");
            try
            {
                #if DESKTOP
                return client.SubmitRegistrationVersion(request);
                #elif CORECLR
                return client.SubmitRegistrationVersionAsync(request).GetAwaiter().GetResult();
                #else
