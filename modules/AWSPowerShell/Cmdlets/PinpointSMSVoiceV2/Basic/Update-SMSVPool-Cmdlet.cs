...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    public partial class UpdateSMSVPoolCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// PoolArn.</para><important><para>If you are using a shared End User Messaging SMS resource then you must use the full
        /// Amazon Resource Name(ARN).</para></important>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.PinpointSMSVoiceV2.Model.UpdatePoolResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.UpdatePoolRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdatePool(request);
                #elif CORECLR
                return client.UpdatePoolAsync(request).GetAwaiter().GetResult();
                #else
