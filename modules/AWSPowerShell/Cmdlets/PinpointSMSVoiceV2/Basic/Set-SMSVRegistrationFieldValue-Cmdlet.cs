...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.PutRegistrationFieldValueResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.PutRegistrationFieldValueResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetSMSVRegistrationFieldValueCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of values for the form field.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("SelectChoices")]
        ...
        private Amazon.PinpointSMSVoiceV2.Model.PutRegistrationFieldValueResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.PutRegistrationFieldValueRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.PutRegistrationFieldValue(request);
                #elif CORECLR
                return client.PutRegistrationFieldValueAsync(request).GetAwaiter().GetResult();
                #else
