...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    /// number.
    /// </summary>
    [Cmdlet("Send", "SMSVNotifyVoiceMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint SMS Voice V2 SendNotifyVoiceMessage API operation.", Operation = new[] {"SendNotifyVoiceMessage"}, SelectReturnType = typeof(Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse))]
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse object containing multiple properties."
    )]
    public partial class SendSMSVNotifyVoiceMessageCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>How long the voice message is valid for, in seconds. By default this is 72 hours.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The voice ID to use for the voice message.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse).
        /// Specifying the name of a property of type Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Send-SMSVNotifyVoiceMessage (SendNotifyVoiceMessage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse, SendSMSVNotifyVoiceMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageRequest();
        ...
        private Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint SMS Voice V2", "SendNotifyVoiceMessage");
            try
            {
                return client.SendNotifyVoiceMessageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? TimeToLive { get; set; }
            public Amazon.PinpointSMSVoiceV2.VoiceId VoiceId { get; set; }
            public System.Func<Amazon.PinpointSMSVoiceV2.Model.SendNotifyVoiceMessageResponse, SendSMSVNotifyVoiceMessageCmdlet, object> Select { get; set; } =
