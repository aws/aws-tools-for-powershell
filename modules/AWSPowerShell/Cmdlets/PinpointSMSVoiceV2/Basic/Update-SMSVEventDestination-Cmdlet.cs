...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.UpdateEventDestinationResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.UpdateEventDestinationResponse object containing multiple properties."
    )]
    public partial class UpdateSMSVEventDestinationCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of event types that determine which events to log.</para><note><para>The <c>TEXT_SENT</c> event type is not supported.</para></note><para />
        ...
        private Amazon.PinpointSMSVoiceV2.Model.UpdateEventDestinationResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.UpdateEventDestinationRequest request)
        {
            ...
            try
            {
                return client.UpdateEventDestinationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
