...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    /// </summary>
    [Cmdlet("Request", "SMSVSenderId", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class RequestSMSVSenderIdCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The sender ID string to request. The sender ID can be 1-11 alphanumeric characters
        /// including letters (A-Z, a-z), numbers (0-9), or hyphens (-). The sender ID must contain
        /// at least one letter and cannot start or end with a hyphen.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdResponse).
        /// Specifying the name of a property of type Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Request-SMSVSenderId (RequestSenderId)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdResponse, RequestSMSVSenderIdCmdlet>(Select) ??
            ...
            {
                context.MessageType = new List<System.String>(this.MessageType);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdRequest();
            ...
            {
                request.MessageTypes = cmdletContext.MessageType;
            }
        ...
        private Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? DeletionProtectionEnabled { get; set; }
            public System.String IsoCountryCode { get; set; }
            public List<System.String> MessageType { get; set; }
            public System.String SenderId { get; set; }
            public List<Amazon.PinpointSMSVoiceV2.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.PinpointSMSVoiceV2.Model.RequestSenderIdResponse, RequestSMSVSenderIdCmdlet, object> Select { get; set; } =
