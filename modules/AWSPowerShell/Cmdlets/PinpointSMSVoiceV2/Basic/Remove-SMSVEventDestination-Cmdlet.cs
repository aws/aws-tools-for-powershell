...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "SMSVEventDestination", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint SMS Voice V2 DeleteEventDestination API operation.", Operation = new[] {"DeleteEventDestination"}, SelectReturnType = typeof(Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse))]
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMSVEventDestinationCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SMSVEventDestination (DeleteEventDestination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse, RemoveSMSVEventDestinationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationRequest();
        ...
        private Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint SMS Voice V2", "DeleteEventDestination");
            try
            {
                #if DESKTOP
                return client.DeleteEventDestination(request);
                #elif CORECLR
                return client.DeleteEventDestinationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfigurationSetName { get; set; }
            public System.String EventDestinationName { get; set; }
            public System.Func<Amazon.PinpointSMSVoiceV2.Model.DeleteEventDestinationResponse, RemoveSMSVEventDestinationCmdlet, object> Select { get; set; } =
