...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.DeleteOptedOutNumberResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.DeleteOptedOutNumberResponse object containing multiple properties."
    )]
    public partial class RemoveSMSVOptedOutNumberCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The OptOutListName or OptOutListArn to remove the phone number from.</para><important><para>If you are using a shared End User Messaging SMS resource then you must use the full
        ...
        private Amazon.PinpointSMSVoiceV2.Model.DeleteOptedOutNumberResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.DeleteOptedOutNumberRequest request)
        {
            ...
            try
            {
                return client.DeleteOptedOutNumberAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
