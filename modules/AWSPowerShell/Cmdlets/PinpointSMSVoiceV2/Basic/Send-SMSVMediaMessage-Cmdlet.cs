...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    public partial class SendSMSVMediaMessageCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array of URLs to each media file to send. </para><para>The media files have to be stored in a publicly available S3 bucket. Supported media
        ...
        /// objects</a> in the S3 user guide.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MediaUrls")]
        ...
        private Amazon.PinpointSMSVoiceV2.Model.SendMediaMessageResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.SendMediaMessageRequest request)
        {
            ...
            try
            {
                return client.SendMediaMessageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
