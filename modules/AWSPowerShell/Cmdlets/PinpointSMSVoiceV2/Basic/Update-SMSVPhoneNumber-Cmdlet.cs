...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    public partial class UpdateSMSVPhoneNumberCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The OptOutList to add the phone number to. You can use either the opt out list name
        /// or the opt out list ARN.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// the PhoneNumberId or PhoneNumberArn.</para><important><para>If you are using a shared End User Messaging SMS resource then you must use the full
        ...
        /// requests. You're also responsible for tracking and honoring opt-out requests.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
