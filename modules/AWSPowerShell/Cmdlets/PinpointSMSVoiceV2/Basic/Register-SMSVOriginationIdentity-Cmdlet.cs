...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.AssociateOriginationIdentityResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.AssociateOriginationIdentityResponse object containing multiple properties."
    )]
    public partial class RegisterSMSVOriginationIdentityCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// identity types that are not country-specific, such as RCS agents.</para>
        /// </para>
        /// </summary>
        ...
        /// and you can find these values using <a href="https://docs.aws.amazon.com/pinpoint/latest/apireference_smsvoicev2/API_DescribePools.html">DescribePools</a>.</para><important><para>If you are using a shared End User Messaging SMS; resource then you must use the full
        /// Amazon Resource Name(ARN).</para></important>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.PinpointSMSVoiceV2.Model.AssociateOriginationIdentityResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.AssociateOriginationIdentityRequest request)
        {
            ...
            try
            {
                return client.AssociateOriginationIdentityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
