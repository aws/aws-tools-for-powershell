...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.DeletePoolResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.DeletePoolResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveSMSVPoolCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        /// the values for PoolId and PoolArn .</para><important><para>If you are using a shared AWS End User Messaging SMS and Voice resource then you must
        ...
        private Amazon.PinpointSMSVoiceV2.Model.DeletePoolResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.DeletePoolRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeletePoolAsync(request).GetAwaiter().GetResult();
                #else
