...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    [AWSCmdletOutput("Amazon.PinpointSMSVoiceV2.Model.DescribeKeywordsResponse",
        "This cmdlet returns an Amazon.PinpointSMSVoiceV2.Model.DescribeKeywordsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMSVKeywordCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.PinpointSMSVoiceV2.Model.DescribeKeywordsResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.DescribeKeywordsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeKeywords(request);
                #elif CORECLR
                return client.DescribeKeywordsAsync(request).GetAwaiter().GetResult();
                #else
