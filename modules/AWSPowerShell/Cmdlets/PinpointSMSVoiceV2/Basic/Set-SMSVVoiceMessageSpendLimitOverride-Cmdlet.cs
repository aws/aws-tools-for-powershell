...
namespace Amazon.PowerShell.Cmdlets.SMSV
{
    ...
    /// </summary>
    [Cmdlet("Set", "SMSVVoiceMessageSpendLimitOverride", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class SetSMSVVoiceMessageSpendLimitOverrideCmdlet : AmazonPinpointSMSVoiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-SMSVVoiceMessageSpendLimitOverride (SetVoiceMessageSpendLimitOverride)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointSMSVoiceV2.Model.SetVoiceMessageSpendLimitOverrideResponse, SetSMSVVoiceMessageSpendLimitOverrideCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointSMSVoiceV2.Model.SetVoiceMessageSpendLimitOverrideRequest();
        ...
        private Amazon.PinpointSMSVoiceV2.Model.SetVoiceMessageSpendLimitOverrideResponse CallAWSServiceOperation(IAmazonPinpointSMSVoiceV2 client, Amazon.PinpointSMSVoiceV2.Model.SetVoiceMessageSpendLimitOverrideRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint SMS Voice V2", "SetVoiceMessageSpendLimitOverride");
            try
            {
                #if DESKTOP
                return client.SetVoiceMessageSpendLimitOverride(request);
                #elif CORECLR
                return client.SetVoiceMessageSpendLimitOverrideAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Int64? MonthlyLimit { get; set; }
            public System.Func<Amazon.PinpointSMSVoiceV2.Model.SetVoiceMessageSpendLimitOverrideResponse, SetSMSVVoiceMessageSpendLimitOverrideCmdlet, object> Select { get; set; } =
