...
namespace Amazon.PowerShell.Cmdlets.SDBV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "SDBV2Export")]
    [OutputType("Amazon.SimpleDBv2.Model.GetExportResponse")]
    [AWSCmdlet("Calls the Amazon SimpleDB v2 GetExport API operation.", Operation = new[] {"GetExport"}, SelectReturnType = typeof(Amazon.SimpleDBv2.Model.GetExportResponse))]
    [AWSCmdletOutput("Amazon.SimpleDBv2.Model.GetExportResponse",
        "This cmdlet returns an Amazon.SimpleDBv2.Model.GetExportResponse object containing multiple properties."
    )]
    public partial class GetSDBV2ExportCmdlet : AmazonSimpleDBv2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleDBv2.Model.GetExportResponse, GetSDBV2ExportCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleDBv2.Model.GetExportRequest();
        ...
        private Amazon.SimpleDBv2.Model.GetExportResponse CallAWSServiceOperation(IAmazonSimpleDBv2 client, Amazon.SimpleDBv2.Model.GetExportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon SimpleDB v2", "GetExport");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ExportArn { get; set; }
            public System.Func<Amazon.SimpleDBv2.Model.GetExportResponse, GetSDBV2ExportCmdlet, object> Select { get; set; } =
