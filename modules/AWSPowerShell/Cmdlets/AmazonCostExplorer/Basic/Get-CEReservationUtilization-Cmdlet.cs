...
namespace Amazon.PowerShell.Cmdlets.CE
{
    ...
    public partial class GetCEReservationUtilizationCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Sets the AWS cost granularity to <code>MONTHLY</code> or <code>DAILY</code>. If both
        /// <code>GroupBy</code> and <code>granularity</code> are not set, <code>GetReservationUtilization</code>
        /// defaults to <code>DAILY</code>. If <code>GroupBy</code> is set, <code>Granularity</code>
        /// can't be set, and the response object doesn't include <code>MONTHLY</code> or <code>DAILY</code>
        /// granularity.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        /// <summary>
        /// <para>
        /// <para>Groups only by <code>SubscriptionId</code>. Metadata is included.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
