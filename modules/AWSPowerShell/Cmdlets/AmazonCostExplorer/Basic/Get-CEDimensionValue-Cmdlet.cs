...
namespace Amazon.PowerShell.Cmdlets.CE
{
    ...
    public partial class GetCEDimensionValueCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        /// for searching:</para><ul><li><para>AZ - The Availability Zone. An example is us-east-1a.</para></li><li><para>INSTANCE_TYPE - The type of EC2 instance. An example is m4.xlarge.</para></li><li><para>LINKED_ACCOUNT - The description in the attribute map that includes the full name
        /// of the member account. The value field contains the AWS ID of the member account</para></li><li><para>OPERATION - The action performed. Examples include RunInstance and CreateBucket.</para></li><li><para>PURCHASE_TYPE - The reservation type of the purchase to which this usage is related.
        /// Examples include: On Demand Instances and Standard Reserved Instances</para></li><li><para>SERVICE - The AWS service such as DynamoDB.</para></li><li><para>USAGE_TYPE - The type of usage. An example is DataTransfer-In-Bytes. The response
        /// for the GetDimensionValues action includes a unit attribute, examples of which include
        /// GB and Hrs.</para></li><li><para>USAGE_TYPE_GROUP - The grouping of common usage types. An example is EC2: CloudWatch
        /// – Alarms. The response for this action includes a unit attribute.</para></li><li><para>RECORD_TYPE - The different types of charges such as RI fees, usage costs, tax refunds,
        /// and credits.</para></li></ul><para>If you set the context to <code>RESERVATIONS</code>, you can use the following dimensions
        /// for searching:</para><ul><li><para>AZ - The Availability Zone. An example is us-east-1a.</para></li><li><para>INSTANCE_TYPE - The type of EC2 instance. An example is m4.xlarge.</para></li><li><para>LINKED_ACCOUNT - The description in the attribute map that includes the full name
        /// of the member account. The value field contains the AWS ID of the member account</para></li><li><para>PLATFORM - The operating system. Examples are Windows or Linux.</para></li><li><para>REGION - The AWS region.</para></li><li><para>SCOPE - The scope of a reserved instance (RI). Values are regional or a single availability
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the dimension. Each <code>Dimensions</code>is available for different
