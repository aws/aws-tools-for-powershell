...
namespace Amazon.PowerShell.Cmdlets.CE
{
    ...
    public partial class GetCEDimensionValueCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        /// for searching:</para><ul><li><para>AZ - The Availability Zone. An example is <code>us-east-1a</code>.</para></li><li><para>INSTANCE_TYPE - The type of instance. An example is an EC2 <code>m4.xlarge</code>.</para></li><li><para>LINKED_ACCOUNT - The description in the attribute map that includes the full name
        /// of the member account. The value field contains the AWS ID of the member account.</para></li><li><para>OPERATION - The action performed. Examples include <code>RunInstance</code> and <code>CreateBucket</code>.</para></li><li><para>PURCHASE_TYPE - The reservation type of the purchase to which this usage is related.
        /// Examples include On-Demand Instances and Standard Reserved Instances.</para></li><li><para>SERVICE - The AWS service such as DynamoDB.</para></li><li><para>USAGE_TYPE - The type of usage. An example is <code>DataTransfer-In-Bytes</code>.
        /// The response for the <code>GetDimensionValues</code> operation includes a unit attribute,
        /// examples of which include GB and Hrs.</para></li><li><para>USAGE_TYPE_GROUP - The grouping of common usage types. An example is EC2: CloudWatch
        ...
        /// for searching:</para><ul><li><para>AZ - The Availability Zone. An example is <code>us-east-1a</code>.</para></li><li><para>INSTANCE_TYPE - The type of instance. An example is an EC2 <code>m4.xlarge</code>.</para></li><li><para>LINKED_ACCOUNT - The description in the attribute map that includes the full name
        /// of the member account. The value field contains the AWS ID of the member account.</para></li><li><para>PLATFORM - The specific combination of operating system, license model, and software
        /// on an instance. For example, a Windows instance with SQL Server Web and no license,
        /// or a Red Hat Enterprise Linux instance.</para></li><li><para>REGION - The AWS Region.</para></li><li><para>SCOPE - The scope of a Reserved Instance (RI). Values are regional or a single Availability
