...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    [AWSCmdlet("Calls the Amazon Textract StartDocumentAnalysis API operation.", Operation = new[] {"StartDocumentAnalysis"})]
    ...
    public partial class StartTXTDocumentAnalysisCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        /// FORMS to <code>FeatureTypes</code>.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier you specify to identify the job in the completion status that's
        /// published to the Amazon SNS topic.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
