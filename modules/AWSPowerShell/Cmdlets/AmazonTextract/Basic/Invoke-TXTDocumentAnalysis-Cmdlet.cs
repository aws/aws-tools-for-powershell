...
namespace Amazon.PowerShell.Cmdlets.TXT
{
    ...
    [AWSCmdlet("Calls the Amazon Textract AnalyzeDocument API operation.", Operation = new[] {"AnalyzeDocument"})]
    ...
    public partial class InvokeTXTDocumentAnalysisCmdlet : AmazonTextractClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.FeatureTypes = new List<System.String>(this.FeatureType);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (cmdletContext.FeatureTypes != null)
                {
                    request.FeatureTypes = cmdletContext.FeatureTypes;
                }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public List<System.String> FeatureTypes { get; set; }
        }
