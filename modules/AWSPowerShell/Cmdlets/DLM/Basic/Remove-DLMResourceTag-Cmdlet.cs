...
namespace Amazon.PowerShell.Cmdlets.DLM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "DLMResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveDLMResourceTagCmdlet : AmazonDLMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DLMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DLM.Model.UntagResourceResponse, RemoveDLMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DLM.Model.UntagResourceRequest();
        ...
        private Amazon.DLM.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonDLM client, Amazon.DLM.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Data Lifecycle Manager", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.DLM.Model.UntagResourceResponse, RemoveDLMResourceTagCmdlet, object> Select { get; set; } =
