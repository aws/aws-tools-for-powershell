...
namespace Amazon.PowerShell.Cmdlets.DLM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Data Lifecycle Manager DeleteLifecyclePolicy API operation.", Operation = new[] {"DeleteLifecyclePolicy"}, SelectReturnType = typeof(Amazon.DLM.Model.DeleteLifecyclePolicyResponse))]
    [AWSCmdletOutput("None or Amazon.DLM.Model.DeleteLifecyclePolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.DLM.Model.DeleteLifecyclePolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveDLMLifecyclePolicyCmdlet : AmazonDLMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-DLMLifecyclePolicy (DeleteLifecyclePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DLM.Model.DeleteLifecyclePolicyResponse, RemoveDLMLifecyclePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DLM.Model.DeleteLifecyclePolicyRequest();
        ...
        private Amazon.DLM.Model.DeleteLifecyclePolicyResponse CallAWSServiceOperation(IAmazonDLM client, Amazon.DLM.Model.DeleteLifecyclePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Data Lifecycle Manager", "DeleteLifecyclePolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String PolicyId { get; set; }
            public System.Func<Amazon.DLM.Model.DeleteLifecyclePolicyResponse, RemoveDLMLifecyclePolicyCmdlet, object> Select { get; set; } =
