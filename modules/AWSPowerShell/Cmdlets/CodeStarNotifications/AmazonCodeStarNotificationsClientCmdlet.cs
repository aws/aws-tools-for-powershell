...
{
    [AWSClientCmdlet("AWS CodeStar Notifications", "CSTN", "2019-10-15", "CodeStarNotifications")]
    public abstract partial class AmazonCodeStarNotificationsClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonCodeStarNotificationsConfig.ServiceId.ToString();
