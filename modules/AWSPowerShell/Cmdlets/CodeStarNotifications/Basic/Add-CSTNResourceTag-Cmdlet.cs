...
namespace Amazon.PowerShell.Cmdlets.CSTN
{
    ...
    /// </summary>
    [Cmdlet("Add", "CSTNResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddCSTNResourceTagCmdlet : AmazonCodeStarNotificationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of tags to associate with the resource. Tag key names cannot start with "<c>aws</c>".</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CSTNResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarNotifications.Model.TagResourceResponse, AddCSTNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarNotifications.Model.TagResourceRequest();
        ...
        private Amazon.CodeStarNotifications.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCodeStarNotifications client, Amazon.CodeStarNotifications.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Notifications", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeStarNotifications.Model.TagResourceResponse, AddCSTNResourceTagCmdlet, object> Select { get; set; } =
