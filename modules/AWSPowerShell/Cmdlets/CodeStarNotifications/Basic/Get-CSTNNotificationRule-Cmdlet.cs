...
namespace Amazon.PowerShell.Cmdlets.CSTN
{
    ...
    /// </summary>
    [Cmdlet("Get", "CSTNNotificationRule")]
    ...
    public partial class GetCSTNNotificationRuleCmdlet : AmazonCodeStarNotificationsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarNotifications.Model.DescribeNotificationRuleResponse, GetCSTNNotificationRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarNotifications.Model.DescribeNotificationRuleRequest();
        ...
        private Amazon.CodeStarNotifications.Model.DescribeNotificationRuleResponse CallAWSServiceOperation(IAmazonCodeStarNotifications client, Amazon.CodeStarNotifications.Model.DescribeNotificationRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Notifications", "DescribeNotificationRule");
            try
            {
                #if DESKTOP
                return client.DescribeNotificationRule(request);
                #elif CORECLR
                return client.DescribeNotificationRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.CodeStarNotifications.Model.DescribeNotificationRuleResponse, GetCSTNNotificationRuleCmdlet, object> Select { get; set; } =
