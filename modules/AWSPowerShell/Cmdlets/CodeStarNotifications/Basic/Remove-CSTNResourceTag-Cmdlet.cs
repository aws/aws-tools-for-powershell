...
namespace Amazon.PowerShell.Cmdlets.CSTN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CSTNResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCSTNResourceTagCmdlet : AmazonCodeStarNotificationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key names of the tags to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CSTNResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarNotifications.Model.UntagResourceResponse, RemoveCSTNResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarNotifications.Model.UntagResourceRequest();
        ...
        private Amazon.CodeStarNotifications.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonCodeStarNotifications client, Amazon.CodeStarNotifications.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Notifications", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeStarNotifications.Model.UntagResourceResponse, RemoveCSTNResourceTagCmdlet, object> Select { get; set; } =
