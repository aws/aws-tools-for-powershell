...
namespace Amazon.PowerShell.Cmdlets.CSTN
{
    ...
    /// subscribers to that topic stop receiving notifications when the events described in
    ...
    public partial class RemoveCSTNSubscriptionCmdlet : AmazonCodeStarNotificationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the SNS topic to unsubscribe from the notification rule.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CSTNSubscription (Unsubscribe)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarNotifications.Model.UnsubscribeResponse, RemoveCSTNSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStarNotifications.Model.UnsubscribeRequest();
        ...
        private Amazon.CodeStarNotifications.Model.UnsubscribeResponse CallAWSServiceOperation(IAmazonCodeStarNotifications client, Amazon.CodeStarNotifications.Model.UnsubscribeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar Notifications", "Unsubscribe");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Arn { get; set; }
            public System.String TargetAddress { get; set; }
            public System.Func<Amazon.CodeStarNotifications.Model.UnsubscribeResponse, RemoveCSTNSubscriptionCmdlet, object> Select { get; set; } =
