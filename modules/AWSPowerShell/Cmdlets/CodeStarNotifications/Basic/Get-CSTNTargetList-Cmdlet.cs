...
{
    /// <summary>
    /// Returns a list of the notification rule targets for an AWS account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CSTNTargetList")]
    [OutputType("Amazon.CodeStarNotifications.Model.TargetSummary")]
    ...
    public partial class GetCSTNTargetListCmdlet : AmazonCodeStarNotificationsClientCmdlet, IExecutor
    {
        ...
        [Alias("Filters")]
        public Amazon.CodeStarNotifications.Model.ListTargetsFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStarNotifications.Model.ListTargetsResponse, GetCSTNTargetListCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.CodeStarNotifications.Model.ListTargetsFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeStarNotifications.Model.ListTargetsRequest();
        ...
        private Amazon.CodeStarNotifications.Model.ListTargetsResponse CallAWSServiceOperation(IAmazonCodeStarNotifications client, Amazon.CodeStarNotifications.Model.ListTargetsRequest request)
        {
        ...
        {
            public List<Amazon.CodeStarNotifications.Model.ListTargetsFilter> Filter { get; set; }
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodeStarNotifications.Model.ListTargetsResponse, GetCSTNTargetListCmdlet, object> Select { get; set; } =
