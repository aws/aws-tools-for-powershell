...
namespace Amazon.PowerShell.Cmdlets.BAKS
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKSSearchResultExportJobList")]
    [OutputType("Amazon.BackupSearch.Model.ExportJobSummary")]
    [AWSCmdlet("Calls the AWS Backup Search ListSearchResultExportJobs API operation.", Operation = new[] {"ListSearchResultExportJobs"}, SelectReturnType = typeof(Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse))]
    [AWSCmdletOutput("Amazon.BackupSearch.Model.ExportJobSummary or Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse",
        "This cmdlet returns a collection of Amazon.BackupSearch.Model.ExportJobSummary objects.",
        "The service call response (type Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBAKSSearchResultExportJobListCmdlet : AmazonBackupSearchClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.BackupSearch.ExportJobStatus")]
        public Amazon.BackupSearch.ExportJobStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse, GetBAKSSearchResultExportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BackupSearch.Model.ListSearchResultExportJobsRequest();
        ...
        private Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse CallAWSServiceOperation(IAmazonBackupSearch client, Amazon.BackupSearch.Model.ListSearchResultExportJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Backup Search", "ListSearchResultExportJobs");
            try
            {
                #if DESKTOP
                return client.ListSearchResultExportJobs(request);
                #elif CORECLR
                return client.ListSearchResultExportJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SearchJobIdentifier { get; set; }
            public Amazon.BackupSearch.ExportJobStatus Status { get; set; }
            public System.Func<Amazon.BackupSearch.Model.ListSearchResultExportJobsResponse, GetBAKSSearchResultExportJobListCmdlet, object> Select { get; set; } =
