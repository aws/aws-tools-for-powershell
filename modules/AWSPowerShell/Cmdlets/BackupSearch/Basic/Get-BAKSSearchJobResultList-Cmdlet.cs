...
namespace Amazon.PowerShell.Cmdlets.BAKS
{
    ...
    /// </summary>
    [Cmdlet("Get", "BAKSSearchJobResultList")]
    [OutputType("Amazon.BackupSearch.Model.ListSearchJobResultsResponse")]
    [AWSCmdlet("Calls the AWS Backup Search ListSearchJobResults API operation.", Operation = new[] {"ListSearchJobResults"}, SelectReturnType = typeof(Amazon.BackupSearch.Model.ListSearchJobResultsResponse))]
    [AWSCmdletOutput("Amazon.BackupSearch.Model.ListSearchJobResultsResponse",
        "This cmdlet returns an Amazon.BackupSearch.Model.ListSearchJobResultsResponse object containing multiple properties."
    )]
    public partial class GetBAKSSearchJobResultListCmdlet : AmazonBackupSearchClientCmdlet, IExecutor
    {
        ...
        private Amazon.BackupSearch.Model.ListSearchJobResultsResponse CallAWSServiceOperation(IAmazonBackupSearch client, Amazon.BackupSearch.Model.ListSearchJobResultsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SearchJobIdentifier { get; set; }
            public System.Func<Amazon.BackupSearch.Model.ListSearchJobResultsResponse, GetBAKSSearchJobResultListCmdlet, object> Select { get; set; } =
