#
# Module manifest for module 'AWS.Tools.BackupSearch'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BackupSearch.dll'
    ...
    GUID = '8ee622ec-b239-48e0-a3d9-fbf59416519a'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.BackupSearch.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BackupSearch.Completers.psm1',
        'AWS.Tools.BackupSearch.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.BackupSearch.dll-Help.xml'
    )
