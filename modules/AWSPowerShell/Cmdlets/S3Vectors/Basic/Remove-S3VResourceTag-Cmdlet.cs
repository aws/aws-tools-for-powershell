...
namespace Amazon.PowerShell.Cmdlets.S3V
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Remove", "S3VResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Vectors UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.S3Vectors.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.S3Vectors.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Vectors.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveS3VResourceTagCmdlet : AmazonS3VectorsClientCmdlet, IExecutor
    {
        ...
        /// for cost allocation or attribute-based access control (ABAC)</a>.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3VResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Vectors.Model.UntagResourceResponse, RemoveS3VResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Vectors.Model.UntagResourceRequest();
        ...
        private Amazon.S3Vectors.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonS3Vectors client, Amazon.S3Vectors.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Vectors", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.S3Vectors.Model.UntagResourceResponse, RemoveS3VResourceTagCmdlet, object> Select { get; set; } =
