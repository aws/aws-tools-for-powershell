...
namespace Amazon.PowerShell.Cmdlets.S3V
{
    ...
    /// </summary>
    [Cmdlet("Get", "S3VVectorBucketPolicy")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon S3 Vectors GetVectorBucketPolicy API operation.", Operation = new[] {"GetVectorBucketPolicy"}, SelectReturnType = typeof(Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3VVectorBucketPolicyCmdlet : AmazonS3VectorsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse, GetS3VVectorBucketPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Vectors.Model.GetVectorBucketPolicyRequest();
        ...
        private Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse CallAWSServiceOperation(IAmazonS3Vectors client, Amazon.S3Vectors.Model.GetVectorBucketPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Vectors", "GetVectorBucketPolicy");
            try
            {
                #if DESKTOP
                return client.GetVectorBucketPolicy(request);
                #elif CORECLR
                return client.GetVectorBucketPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String VectorBucketArn { get; set; }
            public System.String VectorBucketName { get; set; }
            public System.Func<Amazon.S3Vectors.Model.GetVectorBucketPolicyResponse, GetS3VVectorBucketPolicyCmdlet, object> Select { get; set; } =
