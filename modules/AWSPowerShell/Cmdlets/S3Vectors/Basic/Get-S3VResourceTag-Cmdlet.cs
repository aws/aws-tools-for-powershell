...
namespace Amazon.PowerShell.Cmdlets.S3V
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Get", "S3VResourceTag")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon S3 Vectors ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.S3Vectors.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("System.String or Amazon.S3Vectors.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.S3Vectors.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3VResourceTagCmdlet : AmazonS3VectorsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Vectors.Model.ListTagsForResourceResponse, GetS3VResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Vectors.Model.ListTagsForResourceRequest();
        ...
        private Amazon.S3Vectors.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonS3Vectors client, Amazon.S3Vectors.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Vectors", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.S3Vectors.Model.ListTagsForResourceResponse, GetS3VResourceTagCmdlet, object> Select { get; set; } =
