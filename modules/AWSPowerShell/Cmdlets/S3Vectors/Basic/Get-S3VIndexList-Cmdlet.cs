...
namespace Amazon.PowerShell.Cmdlets.S3V
{
    ...
    /// </summary>
    [Cmdlet("Get", "S3VIndexList")]
    [OutputType("Amazon.S3Vectors.Model.IndexSummary")]
    [AWSCmdlet("Calls the Amazon S3 Vectors ListIndexes API operation.", Operation = new[] {"ListIndexes"}, SelectReturnType = typeof(Amazon.S3Vectors.Model.ListIndexesResponse))]
    [AWSCmdletOutput("Amazon.S3Vectors.Model.IndexSummary or Amazon.S3Vectors.Model.ListIndexesResponse",
        "This cmdlet returns a collection of Amazon.S3Vectors.Model.IndexSummary objects.",
        "The service call response (type Amazon.S3Vectors.Model.ListIndexesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetS3VIndexListCmdlet : AmazonS3VectorsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Vectors.Model.ListIndexesResponse, GetS3VIndexListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.S3Vectors.Model.ListIndexesRequest();
        ...
        private Amazon.S3Vectors.Model.ListIndexesResponse CallAWSServiceOperation(IAmazonS3Vectors client, Amazon.S3Vectors.Model.ListIndexesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Vectors", "ListIndexes");
            try
            {
                #if DESKTOP
                return client.ListIndexes(request);
                #elif CORECLR
                return client.ListIndexesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VectorBucketArn { get; set; }
            public System.String VectorBucketName { get; set; }
            public System.Func<Amazon.S3Vectors.Model.ListIndexesResponse, GetS3VIndexListCmdlet, object> Select { get; set; } =
