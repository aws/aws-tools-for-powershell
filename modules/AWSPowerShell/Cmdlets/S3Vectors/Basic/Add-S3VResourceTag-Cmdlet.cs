...
namespace Amazon.PowerShell.Cmdlets.S3V
{
    ...
    /// </para></dd></dl>
    /// </summary>
    [Cmdlet("Add", "S3VResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon S3 Vectors TagResource API operation.", Operation = new[] {"TagResource"}, SelectReturnType = typeof(Amazon.S3Vectors.Model.TagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.S3Vectors.Model.TagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.S3Vectors.Model.TagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddS3VResourceTagCmdlet : AmazonS3VectorsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-S3VResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.S3Vectors.Model.TagResourceResponse, AddS3VResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3Vectors.Model.TagResourceRequest();
        ...
        private Amazon.S3Vectors.Model.TagResourceResponse CallAWSServiceOperation(IAmazonS3Vectors client, Amazon.S3Vectors.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon S3 Vectors", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.S3Vectors.Model.TagResourceResponse, AddS3VResourceTagCmdlet, object> Select { get; set; } =
