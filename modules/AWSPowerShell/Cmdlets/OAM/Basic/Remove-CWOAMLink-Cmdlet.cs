...
namespace Amazon.PowerShell.Cmdlets.CWOAM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CWOAMLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCWOAMLinkCmdlet : AmazonOAMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWOAMLink (DeleteLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OAM.Model.DeleteLinkResponse, RemoveCWOAMLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OAM.Model.DeleteLinkRequest();
        ...
        private Amazon.OAM.Model.DeleteLinkResponse CallAWSServiceOperation(IAmazonOAM client, Amazon.OAM.Model.DeleteLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Access Manager", "DeleteLink");
            try
            {
        ...
        {
            public System.String Identifier { get; set; }
            public System.Func<Amazon.OAM.Model.DeleteLinkResponse, RemoveCWOAMLinkCmdlet, object> Select { get; set; } =
