...
namespace Amazon.PowerShell.Cmdlets.CWOAM
{
    ...
    /// </para></important>
    /// </summary>
    [Cmdlet("Remove", "CWOAMResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the CloudWatch Observability Access Manager UntagResource API operation.", Operation = new[] {"UntagResource"}, SelectReturnType = typeof(Amazon.OAM.Model.UntagResourceResponse))]
    [AWSCmdletOutput("None or Amazon.OAM.Model.UntagResourceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.OAM.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCWOAMResourceTagCmdlet : AmazonOAMClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWOAMResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OAM.Model.UntagResourceResponse, RemoveCWOAMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OAM.Model.UntagResourceRequest();
        ...
        private Amazon.OAM.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonOAM client, Amazon.OAM.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "CloudWatch Observability Access Manager", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OAM.Model.UntagResourceResponse, RemoveCWOAMResourceTagCmdlet, object> Select { get; set; } =
