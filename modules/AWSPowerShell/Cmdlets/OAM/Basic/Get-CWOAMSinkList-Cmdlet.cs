...
namespace Amazon.PowerShell.Cmdlets.CWOAM
{
    ...
    /// that account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCWOAMSinkListCmdlet : AmazonOAMClientCmdlet, IExecutor
    {
        ...
        private Amazon.OAM.Model.ListSinksResponse CallAWSServiceOperation(IAmazonOAM client, Amazon.OAM.Model.ListSinksRequest request)
        {
            ...
            try
            {
                return client.ListSinksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
