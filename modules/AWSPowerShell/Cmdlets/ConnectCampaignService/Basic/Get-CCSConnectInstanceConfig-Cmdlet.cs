...
namespace Amazon.PowerShell.Cmdlets.CCS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCSConnectInstanceConfig")]
    [OutputType("Amazon.ConnectCampaignService.Model.InstanceConfig")]
    ...
    public partial class GetCCSConnectInstanceConfigCmdlet : AmazonConnectCampaignServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectCampaignService.Model.GetConnectInstanceConfigResponse, GetCCSConnectInstanceConfigCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectCampaignService.Model.GetConnectInstanceConfigRequest();
        ...
        private Amazon.ConnectCampaignService.Model.GetConnectInstanceConfigResponse CallAWSServiceOperation(IAmazonConnectCampaignService client, Amazon.ConnectCampaignService.Model.GetConnectInstanceConfigRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Campaign Service", "GetConnectInstanceConfig");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ConnectInstanceId { get; set; }
            public System.Func<Amazon.ConnectCampaignService.Model.GetConnectInstanceConfigResponse, GetCCSConnectInstanceConfigCmdlet, object> Select { get; set; } =
