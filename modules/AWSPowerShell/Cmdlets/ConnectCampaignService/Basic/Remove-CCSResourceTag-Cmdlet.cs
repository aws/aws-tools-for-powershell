...
namespace Amazon.PowerShell.Cmdlets.CCS
{
    ...
    /// Untag a resource.
    /// </summary>
    [Cmdlet("Remove", "CCSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCCSResourceTagCmdlet : AmazonConnectCampaignServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CCSResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectCampaignService.Model.UntagResourceResponse, RemoveCCSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectCampaignService.Model.UntagResourceRequest();
        ...
        private Amazon.ConnectCampaignService.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonConnectCampaignService client, Amazon.ConnectCampaignService.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Campaign Service", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConnectCampaignService.Model.UntagResourceResponse, RemoveCCSResourceTagCmdlet, object> Select { get; set; } =
