...
namespace Amazon.PowerShell.Cmdlets.CCS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCSCampaignStateBatch")]
    ...
    public partial class GetCCSCampaignStateBatchCmdlet : AmazonConnectCampaignServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ConnectCampaignService.Model.GetCampaignStateBatchResponse, GetCCSCampaignStateBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ConnectCampaignService.Model.GetCampaignStateBatchRequest();
        ...
        private Amazon.ConnectCampaignService.Model.GetCampaignStateBatchResponse CallAWSServiceOperation(IAmazonConnectCampaignService client, Amazon.ConnectCampaignService.Model.GetCampaignStateBatchRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Connect Campaign Service", "GetCampaignStateBatch");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ConnectCampaignService.Model.GetCampaignStateBatchResponse, GetCCSCampaignStateBatchCmdlet, object> Select { get; set; } =
