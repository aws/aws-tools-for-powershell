...
{
    [AWSClientCmdlet("Amazon Connect Campaign Service", "CCS", "2021-01-30", "ConnectCampaignService")]
    public abstract partial class AmazonConnectCampaignServiceClientCmdlet : ServiceCmdlet
    {
        ...
        {
            base.AWSServiceId = AmazonConnectCampaignServiceConfig.ServiceId.ToString();
