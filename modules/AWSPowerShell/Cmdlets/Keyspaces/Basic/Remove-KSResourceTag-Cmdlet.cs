...
namespace Amazon.PowerShell.Cmdlets.KS
{
    ...
    [AWSCmdletOutput("None or Amazon.Keyspaces.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.Keyspaces.Model.UntagResourceResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveKSResourceTagCmdlet : AmazonKeyspacesClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of existing tags to be removed from the Amazon Keyspaces resource.</para><para />
