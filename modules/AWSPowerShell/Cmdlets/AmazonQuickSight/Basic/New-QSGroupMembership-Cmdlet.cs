...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight CreateGroupMembership API operation.", Operation = new[] {"CreateGroupMembership"})]
    [AWSCmdletOutput("Amazon.QuickSight.Model.GroupMember",
        "This cmdlet returns a GroupMember object.",
    ...
    public partial class NewQSGroupMembershipCmdlet : AmazonQuickSightClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("MemberName", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.GroupMember;
