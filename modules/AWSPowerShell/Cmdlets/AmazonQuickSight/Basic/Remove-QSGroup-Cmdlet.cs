...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteGroup API operation.", Operation = new[] {"DeleteGroup"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.QuickSight.Model.DeleteGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
