...
namespace Amazon.PowerShell.Cmdlets.QS
{
    ...
    [AWSCmdlet("Calls the Amazon QuickSight DeleteUser API operation.", Operation = new[] {"DeleteUser"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.QuickSight.Model.DeleteUserResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
