...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Calls the Amazon Rekognition StopStreamProcessor API operation.", Operation = new[] {"StopStreamProcessor"})]
    ...
    public partial class StopREKStreamProcessorCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-REKStreamProcessor (StopStreamProcessor)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Rekognition.Model.StopStreamProcessorRequest();
        ...
        private Amazon.Rekognition.Model.StopStreamProcessorResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.StopStreamProcessorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Rekognition", "StopStreamProcessor");
            try
            {
                #if DESKTOP
                return client.StopStreamProcessor(request);
                #elif CORECLR
                return client.StopStreamProcessorAsync(request).GetAwaiter().GetResult();
                #else
