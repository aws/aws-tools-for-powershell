...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Invokes the DetectFaces operation against Amazon Rekognition.", Operation = new[] {"DetectFaces"})]
    ...
    public partial class FindREKFaceCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of facial attributes you would like to be returned. By default, the API returns
        ...
        private static Amazon.Rekognition.Model.DetectFacesResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DetectFacesRequest request)
        {
            #if DESKTOP
