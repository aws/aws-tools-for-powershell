...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Invokes the SearchFacesByImage operation against Amazon Rekognition.", Operation = new[] {"SearchFacesByImage"})]
    ...
    public partial class SearchREKFacesByImageCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Rekognition.Model.SearchFacesByImageResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.SearchFacesByImageRequest request)
        {
            #if DESKTOP
