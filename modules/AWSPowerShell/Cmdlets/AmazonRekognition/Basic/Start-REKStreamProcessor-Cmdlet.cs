...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Calls the Amazon Rekognition StartStreamProcessor API operation.", Operation = new[] {"StartStreamProcessor"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.Rekognition.Model.StartStreamProcessorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartREKStreamProcessorCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        private Amazon.Rekognition.Model.StartStreamProcessorResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.StartStreamProcessorRequest request)
        {
            ...
            try
            {
                ...
                var task = client.StartStreamProcessorAsync(request);
                return task.Result;
                #else
