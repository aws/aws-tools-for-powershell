...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Invokes the ListCollections operation against Amazon Rekognition.", Operation = new[] {"ListCollections"})]
    ...
    public partial class GetREKCollectionIdListCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CollectionIds;
                        ...
                        int _receivedThisCall = response.CollectionIds.Count;
        ...
        private static Amazon.Rekognition.Model.ListCollectionsResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.ListCollectionsRequest request)
        {
            #if DESKTOP
