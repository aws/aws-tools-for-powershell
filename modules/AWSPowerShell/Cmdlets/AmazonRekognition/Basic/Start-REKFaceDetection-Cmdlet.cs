...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Calls the Amazon Rekognition StartFaceDetection API operation.", Operation = new[] {"StartFaceDetection"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a String object.",
        "The service call response (type Amazon.Rekognition.Model.StartFaceDetectionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartREKFaceDetectionCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            context.FaceAttributes = this.FaceAttribute;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.FaceAttributes != null)
            {
                request.FaceAttributes = cmdletContext.FaceAttributes;
            }
        ...
        private Amazon.Rekognition.Model.StartFaceDetectionResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.StartFaceDetectionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.StartFaceDetectionAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.String ClientRequestToken { get; set; }
            public Amazon.Rekognition.FaceAttributes FaceAttributes { get; set; }
            public System.String JobTag { get; set; }
            public System.String NotificationChannel_RoleArn { get; set; }
            public System.String NotificationChannel_SNSTopicArn { get; set; }
            public Amazon.Rekognition.Model.Video Video { get; set; }
