...
namespace Amazon.PowerShell.Cmdlets.REK
{
    ...
    [AWSCmdlet("Invokes the DetectLabels operation against Amazon Rekognition.", Operation = new[] {"DetectLabels"})]
    ...
    public partial class FindREKLabelCmdlet : AmazonRekognitionClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Rekognition.Model.DetectLabelsResponse CallAWSServiceOperation(IAmazonRekognition client, Amazon.Rekognition.Model.DetectLabelsRequest request)
        {
            #if DESKTOP
