...
namespace Amazon.PowerShell.Cmdlets.CMPM
{
    ...
    [AWSCmdlet("Calls the AWS Comprehend Medical DetectEntities API operation.", Operation = new[] {"DetectEntities"})]
    [AWSCmdletOutput("Amazon.ComprehendMedical.Model.DetectEntitiesResponse",
        "This cmdlet returns a Amazon.ComprehendMedical.Model.DetectEntitiesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
