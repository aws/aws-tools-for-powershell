...
namespace Amazon.PowerShell.Cmdlets.EMP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EMPResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEMPResourceTagCmdlet : AmazonMediaPackageClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackage.Model.UntagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EMPResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackage.Model.UntagResourceResponse, RemoveEMPResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MediaPackage.Model.UntagResourceRequest();
        ...
        private Amazon.MediaPackage.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonMediaPackage client, Amazon.MediaPackage.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaPackage", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MediaPackage.Model.UntagResourceResponse, RemoveEMPResourceTagCmdlet, object> Select { get; set; } =
