...
namespace Amazon.PowerShell.Cmdlets.EMP
{
    ...
    public partial class InvokeEMPIngestEndpointCredentialRotationCmdlet : AmazonMediaPackageClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MediaPackage.Model.RotateIngestEndpointCredentialsResponse).
        /// Specifying the name of a property of type Amazon.MediaPackage.Model.RotateIngestEndpointCredentialsResponse will result in that property being returned.
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the IngestEndpointId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^IngestEndpointId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^IngestEndpointId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.IngestEndpointId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MediaPackage.Model.RotateIngestEndpointCredentialsResponse, InvokeEMPIngestEndpointCredentialRotationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.IngestEndpointId;
            }
            ...
            #if MODULAR
            if (this.IngestEndpointId == null && ParameterWasBound(nameof(this.IngestEndpointId)))
            {
                WriteWarning("You are passing $null as a value for parameter IngestEndpointId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String IngestEndpointId { get; set; }
            public System.Func<Amazon.MediaPackage.Model.RotateIngestEndpointCredentialsResponse, InvokeEMPIngestEndpointCredentialRotationCmdlet, object> Select { get; set; } =
