...
namespace Amazon.PowerShell.Cmdlets.KV
{
    ...
    [AWSCmdlet("Calls the Amazon Kinesis Video Streams ListStreams API operation.", Operation = new[] {"ListStreams"})]
    [AWSCmdletOutput("Amazon.KinesisVideo.Model.StreamInfo",
        "This cmdlet returns a collection of StreamInfo objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.StreamInfoList;
                    ...
                    ProcessOutput(output);
                    // The service has a maximum page size of 10000 and the user has set a retrieval limit.
