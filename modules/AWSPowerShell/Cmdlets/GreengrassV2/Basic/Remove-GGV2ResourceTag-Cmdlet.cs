...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    public partial class RemoveGGV2ResourceTagCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of keys for tags to remove from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGV2ResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GreengrassV2.Model.UntagResourceResponse, RemoveGGV2ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GreengrassV2.Model.UntagResourceRequest();
        ...
        private Amazon.GreengrassV2.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS GreengrassV2", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GreengrassV2.Model.UntagResourceResponse, RemoveGGV2ResourceTagCmdlet, object> Select { get; set; } =
