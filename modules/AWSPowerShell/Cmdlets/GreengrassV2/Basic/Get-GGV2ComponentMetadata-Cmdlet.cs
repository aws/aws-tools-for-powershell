...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    /// </summary>
    [Cmdlet("Get", "GGV2ComponentMetadata")]
    ...
    public partial class GetGGV2ComponentMetadataCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GreengrassV2.Model.DescribeComponentResponse, GetGGV2ComponentMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GreengrassV2.Model.DescribeComponentRequest();
        ...
        private Amazon.GreengrassV2.Model.DescribeComponentResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.DescribeComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS GreengrassV2", "DescribeComponent");
            try
            {
                return client.DescribeComponentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.GreengrassV2.Model.DescribeComponentResponse, GetGGV2ComponentMetadataCmdlet, object> Select { get; set; } =
