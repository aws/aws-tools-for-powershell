...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    /// core devices.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetGGV2EffectiveDeploymentListCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.GreengrassV2.Model.ListEffectiveDeploymentsResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.ListEffectiveDeploymentsRequest request)
        {
            ...
            try
            {
                return client.ListEffectiveDeploymentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
