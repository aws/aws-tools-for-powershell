...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    [AWSCmdlet("Calls the AWS GreengrassV2 GetDeployment API operation.", Operation = new[] {"GetDeployment"}, SelectReturnType = typeof(Amazon.GreengrassV2.Model.GetDeploymentResponse))]
    [AWSCmdletOutput("Amazon.GreengrassV2.Model.GetDeploymentResponse",
        "This cmdlet returns an Amazon.GreengrassV2.Model.GetDeploymentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGGV2DeploymentCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GreengrassV2.Model.GetDeploymentResponse, GetGGV2DeploymentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GreengrassV2.Model.GetDeploymentRequest();
        ...
        private Amazon.GreengrassV2.Model.GetDeploymentResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.GetDeploymentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS GreengrassV2", "GetDeployment");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DeploymentId { get; set; }
            public System.Func<Amazon.GreengrassV2.Model.GetDeploymentResponse, GetGGV2DeploymentCmdlet, object> Select { get; set; } =
