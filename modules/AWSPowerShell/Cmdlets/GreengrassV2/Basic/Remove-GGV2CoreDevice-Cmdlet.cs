...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    public partial class RemoveGGV2CoreDeviceCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GGV2CoreDevice (DeleteCoreDevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GreengrassV2.Model.DeleteCoreDeviceResponse, RemoveGGV2CoreDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GreengrassV2.Model.DeleteCoreDeviceRequest();
        ...
        private Amazon.GreengrassV2.Model.DeleteCoreDeviceResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.DeleteCoreDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS GreengrassV2", "DeleteCoreDevice");
            try
            {
                #if DESKTOP
                return client.DeleteCoreDevice(request);
                #elif CORECLR
                return client.DeleteCoreDeviceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CoreDeviceThingName { get; set; }
            public System.Func<Amazon.GreengrassV2.Model.DeleteCoreDeviceResponse, RemoveGGV2CoreDeviceCmdlet, object> Select { get; set; } =
