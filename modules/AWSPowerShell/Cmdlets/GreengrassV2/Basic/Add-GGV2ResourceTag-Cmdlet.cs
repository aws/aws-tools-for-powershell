...
namespace Amazon.PowerShell.Cmdlets.GGV2
{
    ...
    public partial class AddGGV2ResourceTagCmdlet : AmazonGreengrassV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-GGV2ResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.GreengrassV2.Model.TagResourceResponse, AddGGV2ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GreengrassV2.Model.TagResourceRequest();
        ...
        private Amazon.GreengrassV2.Model.TagResourceResponse CallAWSServiceOperation(IAmazonGreengrassV2 client, Amazon.GreengrassV2.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS GreengrassV2", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.GreengrassV2.Model.TagResourceResponse, AddGGV2ResourceTagCmdlet, object> Select { get; set; } =
