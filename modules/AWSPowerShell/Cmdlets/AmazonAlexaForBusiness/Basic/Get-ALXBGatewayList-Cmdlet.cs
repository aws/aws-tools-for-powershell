...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListGateways API operation.", Operation = new[] {"ListGateways"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.GatewaySummary",
        "This cmdlet returns a collection of GatewaySummary objects.",
