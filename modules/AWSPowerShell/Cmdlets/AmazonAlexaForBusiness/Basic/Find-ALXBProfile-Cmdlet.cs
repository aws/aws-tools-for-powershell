...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchProfiles API operation.", Operation = new[] {"SearchProfiles"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.ProfileData",
        "This cmdlet returns a collection of ProfileData objects.",
    ...
    public partial class FindALXBProfileCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Profiles;
        ...
        private Amazon.AlexaForBusiness.Model.SearchProfilesResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchProfilesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SearchProfilesAsync(request);
                return task.Result;
                #else
