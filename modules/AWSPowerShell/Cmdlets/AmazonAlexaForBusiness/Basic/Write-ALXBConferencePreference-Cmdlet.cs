...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business PutConferencePreference API operation.", Operation = new[] {"PutConferencePreference"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ConferencePreference_DefaultConferenceProviderArn parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class WriteALXBConferencePreferenceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ConferencePreference_DefaultConferenceProviderArn", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            bool requestConferencePreferenceIsNull = true;
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ConferencePreference_DefaultConferenceProviderArn;
        ...
        private Amazon.AlexaForBusiness.Model.PutConferencePreferenceResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.PutConferencePreferenceRequest request)
        {
            ...
            try
            {
                ...
                var task = client.PutConferencePreferenceAsync(request);
                return task.Result;
                #else
