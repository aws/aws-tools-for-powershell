...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ApproveSkill API operation.", Operation = new[] {"ApproveSkill"})]
    ...
    public partial class ApproveALXBSkillCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-ALXBSkill (ApproveSkill)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.ApproveSkillRequest();
        ...
        private Amazon.AlexaForBusiness.Model.ApproveSkillResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ApproveSkillRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ApproveSkill");
            try
            {
                #if DESKTOP
                return client.ApproveSkill(request);
                #elif CORECLR
                return client.ApproveSkillAsync(request).GetAwaiter().GetResult();
                #else
