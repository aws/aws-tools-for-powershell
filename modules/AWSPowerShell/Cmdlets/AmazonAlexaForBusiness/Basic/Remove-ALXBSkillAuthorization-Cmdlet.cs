...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business DeleteSkillAuthorization API operation.", Operation = new[] {"DeleteSkillAuthorization"})]
    ...
    public partial class RemoveALXBSkillAuthorizationCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ALXBSkillAuthorization (DeleteSkillAuthorization)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.DeleteSkillAuthorizationRequest();
        ...
        private Amazon.AlexaForBusiness.Model.DeleteSkillAuthorizationResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.DeleteSkillAuthorizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "DeleteSkillAuthorization");
            try
            {
                #if DESKTOP
