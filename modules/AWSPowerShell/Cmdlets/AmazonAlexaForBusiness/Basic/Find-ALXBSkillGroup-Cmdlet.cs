...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchSkillGroups API operation.", Operation = new[] {"SearchSkillGroups"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.SkillGroupData",
        "This cmdlet returns a collection of SkillGroupData objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SkillGroups;
