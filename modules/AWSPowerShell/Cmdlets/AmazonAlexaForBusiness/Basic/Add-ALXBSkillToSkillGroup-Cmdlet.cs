...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business AssociateSkillWithSkillGroup API operation.", Operation = new[] {"AssociateSkillWithSkillGroup"})]
    ...
    public partial class AddALXBSkillToSkillGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        private Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.AssociateSkillWithSkillGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.AssociateSkillWithSkillGroupAsync(request);
                return task.Result;
                #else
