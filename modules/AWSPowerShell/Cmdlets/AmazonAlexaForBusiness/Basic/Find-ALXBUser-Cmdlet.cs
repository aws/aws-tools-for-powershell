...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchUsers API operation.", Operation = new[] {"SearchUsers"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.UserData",
        "This cmdlet returns a collection of UserData objects.",
    ...
    public partial class FindALXBUserCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        private Amazon.AlexaForBusiness.Model.SearchUsersResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchUsersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SearchUsersAsync(request);
                return task.Result;
                #else
