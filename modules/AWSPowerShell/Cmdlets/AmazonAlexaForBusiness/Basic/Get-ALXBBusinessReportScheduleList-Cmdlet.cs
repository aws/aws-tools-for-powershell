...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListBusinessReportSchedules API operation.", Operation = new[] {"ListBusinessReportSchedules"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.BusinessReportSchedule",
        "This cmdlet returns a collection of BusinessReportSchedule objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BusinessReportSchedules;
