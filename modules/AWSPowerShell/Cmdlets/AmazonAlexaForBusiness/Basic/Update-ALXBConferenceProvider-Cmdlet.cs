...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business UpdateConferenceProvider API operation.", Operation = new[] {"UpdateConferenceProvider"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ConferenceProviderArn parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class UpdateALXBConferenceProviderCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ConferenceProviderArn", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ConferenceProviderArn;
        ...
        private Amazon.AlexaForBusiness.Model.UpdateConferenceProviderResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.UpdateConferenceProviderRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateConferenceProviderAsync(request);
                return task.Result;
                #else
