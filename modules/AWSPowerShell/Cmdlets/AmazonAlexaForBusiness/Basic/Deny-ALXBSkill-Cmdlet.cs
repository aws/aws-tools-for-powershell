...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business RejectSkill API operation.", Operation = new[] {"RejectSkill"})]
    ...
    public partial class DenyALXBSkillCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-ALXBSkill (RejectSkill)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.RejectSkillRequest();
        ...
        private Amazon.AlexaForBusiness.Model.RejectSkillResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.RejectSkillRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "RejectSkill");
            try
            {
                #if DESKTOP
                return client.RejectSkill(request);
                #elif CORECLR
                return client.RejectSkillAsync(request).GetAwaiter().GetResult();
                #else
