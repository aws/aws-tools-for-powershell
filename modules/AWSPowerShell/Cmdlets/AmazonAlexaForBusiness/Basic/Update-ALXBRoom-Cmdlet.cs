...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business UpdateRoom API operation.", Operation = new[] {"UpdateRoom"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the RoomName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class UpdateALXBRoomCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("RoomName", MyInvocation.BoundParameters);
        ...
        private Amazon.AlexaForBusiness.Model.UpdateRoomResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.UpdateRoomRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateRoomAsync(request);
                return task.Result;
                #else
