...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business UpdateSkillGroup API operation.", Operation = new[] {"UpdateSkillGroup"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the SkillGroupName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class UpdateALXBSkillGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-ALXBSkillGroup (UpdateSkillGroup)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AlexaForBusiness.Model.UpdateSkillGroupRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.SkillGroupName;
        ...
        private Amazon.AlexaForBusiness.Model.UpdateSkillGroupResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.UpdateSkillGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "UpdateSkillGroup");
            try
            {
                #if DESKTOP
                return client.UpdateSkillGroup(request);
                #elif CORECLR
                return client.UpdateSkillGroupAsync(request).GetAwaiter().GetResult();
                #else
