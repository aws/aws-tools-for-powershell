...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchRooms API operation.", Operation = new[] {"SearchRooms"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.RoomData",
        "This cmdlet returns a collection of RoomData objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Rooms;
