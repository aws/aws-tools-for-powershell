...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListDeviceEvents API operation.", Operation = new[] {"ListDeviceEvents"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.DeviceEvent",
        "This cmdlet returns a collection of DeviceEvent objects.",
    ...
    public partial class GetALXBDeviceEventListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DeviceEvents;
        ...
        private Amazon.AlexaForBusiness.Model.ListDeviceEventsResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ListDeviceEventsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListDeviceEventsAsync(request);
                return task.Result;
                #else
