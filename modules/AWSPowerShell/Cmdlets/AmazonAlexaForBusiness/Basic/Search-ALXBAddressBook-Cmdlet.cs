...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchAddressBooks API operation.", Operation = new[] {"SearchAddressBooks"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.AddressBookData",
        "This cmdlet returns a collection of AddressBookData objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.AddressBooks;
