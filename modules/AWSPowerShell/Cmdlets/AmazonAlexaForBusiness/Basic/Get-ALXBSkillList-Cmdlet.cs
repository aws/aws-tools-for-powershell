...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business ListSkills API operation.", Operation = new[] {"ListSkills"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.SkillSummary",
        "This cmdlet returns a collection of SkillSummary objects.",
    ...
    public partial class GetALXBSkillListCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SkillSummaries;
                        ...
                        int _receivedThisCall = response.SkillSummaries.Count;
        ...
        private Amazon.AlexaForBusiness.Model.ListSkillsResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.ListSkillsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Alexa For Business", "ListSkills");
            try
            {
                #if DESKTOP
