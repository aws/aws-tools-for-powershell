...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business SearchDevices API operation.", Operation = new[] {"SearchDevices"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.DeviceData",
        "This cmdlet returns a collection of DeviceData objects.",
    ...
    public partial class FindALXBDeviceCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        private Amazon.AlexaForBusiness.Model.SearchDevicesResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.SearchDevicesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SearchDevicesAsync(request);
                return task.Result;
                #else
