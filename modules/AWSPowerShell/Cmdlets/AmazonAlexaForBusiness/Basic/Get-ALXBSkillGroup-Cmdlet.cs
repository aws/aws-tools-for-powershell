...
namespace Amazon.PowerShell.Cmdlets.ALXB
{
    ...
    [AWSCmdlet("Calls the Alexa For Business GetSkillGroup API operation.", Operation = new[] {"GetSkillGroup"})]
    [AWSCmdletOutput("Amazon.AlexaForBusiness.Model.SkillGroup",
        "This cmdlet returns a SkillGroup object.",
    ...
    public partial class GetALXBSkillGroupCmdlet : AmazonAlexaForBusinessClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SkillGroup;
        ...
        private Amazon.AlexaForBusiness.Model.GetSkillGroupResponse CallAWSServiceOperation(IAmazonAlexaForBusiness client, Amazon.AlexaForBusiness.Model.GetSkillGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetSkillGroupAsync(request);
                return task.Result;
                #else
