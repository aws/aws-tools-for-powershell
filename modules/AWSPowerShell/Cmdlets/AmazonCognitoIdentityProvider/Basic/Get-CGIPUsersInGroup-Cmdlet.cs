...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the ListUsersInGroup operation against Amazon Cognito Identity Provider.", Operation = new[] {"ListUsersInGroup"})]
    ...
    public partial class GetCGIPUsersInGroupCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private Amazon.CognitoIdentityProvider.Model.ListUsersInGroupResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.ListUsersInGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListUsersInGroupAsync(request);
                return task.Result;
                #else
