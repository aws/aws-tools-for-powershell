...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the DeleteUserPool operation against Amazon Cognito Identity Provider.", Operation = new[] {"DeleteUserPool"})]
    ...
    public class RemoveCGIPUserPoolCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteUserPool(request);
