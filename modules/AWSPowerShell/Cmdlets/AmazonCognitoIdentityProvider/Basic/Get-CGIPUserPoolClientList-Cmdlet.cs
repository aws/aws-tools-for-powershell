...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the ListUserPoolClients operation against Amazon Cognito Identity Provider.", Operation = new[] {"ListUserPoolClients"})]
    ...
    public partial class GetCGIPUserPoolClientListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CognitoIdentityProvider.Model.ListUserPoolClientsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.ListUserPoolClientsRequest request)
        {
            ...
            var task = client.ListUserPoolClientsAsync(request);
            return task.Result;
            #else
