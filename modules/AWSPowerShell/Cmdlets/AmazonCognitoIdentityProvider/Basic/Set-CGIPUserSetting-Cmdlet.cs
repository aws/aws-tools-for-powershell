...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Invokes the SetUserSettings operation against Amazon Cognito Identity Provider. This operation uses anonymous authentication and does not require credential parameters to be supplied.", Operation = new[] {"SetUserSettings"})]
    ...
    public class SetCGIPUserSettingCmdlet : AnonymousAmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CognitoIdentityProvider.Model.SetUserSettingsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.SetUserSettingsRequest request)
        {
