...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the DeleteUser operation against Amazon Cognito Identity Provider. This operation uses anonymous authentication and does not require credential parameters to be supplied.", Operation = new[] {"DeleteUser"})]
    ...
    public class RemoveCGIPUserCmdlet : AnonymousAmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CognitoIdentityProvider.Model.DeleteUserResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DeleteUserRequest request)
        {
