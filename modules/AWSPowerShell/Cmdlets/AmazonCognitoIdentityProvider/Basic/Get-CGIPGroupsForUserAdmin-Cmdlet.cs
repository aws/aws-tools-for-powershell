...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class GetCGIPGroupsForUserAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "AdminListGroupsForUser");
            try
            {
                #if DESKTOP
                return client.AdminListGroupsForUser(request);
                #elif CORECLR
                return client.AdminListGroupsForUserAsync(request).GetAwaiter().GetResult();
                #else
