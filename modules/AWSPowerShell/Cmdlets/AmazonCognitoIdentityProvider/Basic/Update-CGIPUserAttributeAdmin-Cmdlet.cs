...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the AdminUpdateUserAttributes operation against Amazon Cognito Identity Provider.", Operation = new[] {"AdminUpdateUserAttributes"})]
    ...
    public class UpdateCGIPUserAttributeAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.AdminUpdateUserAttributes(request);
