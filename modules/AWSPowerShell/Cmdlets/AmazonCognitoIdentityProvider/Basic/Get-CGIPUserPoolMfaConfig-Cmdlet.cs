...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider GetUserPoolMfaConfig API operation.", Operation = new[] {"GetUserPoolMfaConfig"})]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.GetUserPoolMfaConfigResponse",
        "This cmdlet returns a Amazon.CognitoIdentityProvider.Model.GetUserPoolMfaConfigResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCGIPUserPoolMfaConfigCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private Amazon.CognitoIdentityProvider.Model.GetUserPoolMfaConfigResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.GetUserPoolMfaConfigRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetUserPoolMfaConfigAsync(request);
                return task.Result;
                #else
