...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the DescribeUserPoolDomain operation against Amazon Cognito Identity Provider.", Operation = new[] {"DescribeUserPoolDomain"})]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.DomainDescriptionType",
        "This cmdlet returns a DomainDescriptionType object.",
    ...
    public partial class GetCGIPUserPoolDomainCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.DomainDescription;
        ...
        private Amazon.CognitoIdentityProvider.Model.DescribeUserPoolDomainResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DescribeUserPoolDomainRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeUserPoolDomainAsync(request);
                return task.Result;
                #else
