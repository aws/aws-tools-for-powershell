...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminUpdateAuthEventFeedback API operation.", Operation = new[] {"AdminUpdateAuthEventFeedback"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCGIPAuthEventFeedbackAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CGIPAuthEventFeedbackAdmin (AdminUpdateAuthEventFeedback)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "AdminUpdateAuthEventFeedback");
            try
            {
                #if DESKTOP
                return client.AdminUpdateAuthEventFeedback(request);
                #elif CORECLR
                return client.AdminUpdateAuthEventFeedbackAsync(request).GetAwaiter().GetResult();
                #else
