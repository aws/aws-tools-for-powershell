...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminListUserAuthEvents API operation.", Operation = new[] {"AdminListUserAuthEvents"})]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.AuthEventType",
        "This cmdlet returns a collection of AuthEventType objects.",
    ...
    public partial class GetCGIPUserAuthEventListAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.AuthEvents;
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.AdminListUserAuthEventsAsync(request);
                return task.Result;
                #else
