...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the ListUserPools operation against Amazon Cognito Identity Provider.", Operation = new[] {"ListUserPools"})]
    ...
    public partial class GetCGIPUserPoolListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.ListUserPoolsRequest request)
        {
            ...
            var task = client.ListUserPoolsAsync(request);
            return task.Result;
            #else
