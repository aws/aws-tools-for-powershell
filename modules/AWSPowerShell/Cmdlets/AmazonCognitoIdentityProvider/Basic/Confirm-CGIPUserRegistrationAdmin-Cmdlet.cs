...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Invokes the AdminConfirmSignUp operation against Amazon Cognito Identity Provider.", Operation = new[] {"AdminConfirmSignUp"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.CognitoIdentityProvider.Model.AdminConfirmSignUpResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class ConfirmCGIPUserRegistrationAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-CGIPUserRegistrationAdmin (AdminConfirmSignUp)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.AdminConfirmSignUpRequest();
            ...
            try
            {
                var response = client.AdminConfirmSignUp(request);
