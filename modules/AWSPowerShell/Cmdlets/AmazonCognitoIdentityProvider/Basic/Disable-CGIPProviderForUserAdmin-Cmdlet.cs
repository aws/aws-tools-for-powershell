...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    /// <code>DestinationUser</code>) signs in, they must create a new user account. See <a href="API_AdminLinkProviderForUser.html">AdminLinkProviderForUser</a>.
    /// 
    ///  
    /// <para>
    ...
    [AWSCmdlet("Invokes the AdminDisableProviderForUser operation against Amazon Cognito Identity Provider.", Operation = new[] {"AdminDisableProviderForUser"})]
