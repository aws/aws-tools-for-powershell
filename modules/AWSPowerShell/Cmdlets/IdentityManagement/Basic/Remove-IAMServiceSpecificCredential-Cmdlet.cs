...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management DeleteServiceSpecificCredential API operation.", Operation = new[] {"DeleteServiceSpecificCredential"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIAMServiceSpecificCredentialCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse, RemoveIAMServiceSpecificCredentialCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialRequest request)
        {
            ...
            try
            {
                return client.DeleteServiceSpecificCredentialAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ServiceSpecificCredentialId { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DeleteServiceSpecificCredentialResponse, RemoveIAMServiceSpecificCredentialCmdlet, object> Select { get; set; } =
