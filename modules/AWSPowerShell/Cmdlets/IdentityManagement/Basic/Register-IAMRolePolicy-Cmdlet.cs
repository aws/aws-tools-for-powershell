...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// is created at the same time as the role, using <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html"><c>CreateRole</c></a>. You can update a role's trust policy using <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_UpdateAssumeRolePolicy.html"><c>UpdateAssumerolePolicy</c></a>.
    /// </para></note><para>
    /// Use this operation to attach a <i>managed</i> policy to a role. To embed an inline
    /// policy in a role, use <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutRolePolicy.html"><c>PutRolePolicy</c></a>. For more information about policies, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
    ...
    public partial class RegisterIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.AttachRolePolicyResponse, RegisterIAMRolePolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.AttachRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AttachRolePolicyRequest request)
        {
            ...
            try
            {
                return client.AttachRolePolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyArn { get; set; }
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.AttachRolePolicyResponse, RegisterIAMRolePolicyCmdlet, object> Select { get; set; } =
