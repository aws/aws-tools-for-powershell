...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management DeleteGroupPolicy API operation.", Operation = new[] {"DeleteGroupPolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIAMGroupPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse, RemoveIAMGroupPolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteGroupPolicyRequest request)
        {
            ...
            try
            {
                return client.DeleteGroupPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupName { get; set; }
            public System.String PolicyName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DeleteGroupPolicyResponse, RemoveIAMGroupPolicyCmdlet, object> Select { get; set; } =
