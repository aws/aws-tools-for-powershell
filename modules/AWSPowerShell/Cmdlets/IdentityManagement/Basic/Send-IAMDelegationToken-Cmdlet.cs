...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Send", "IAMDelegationToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management SendDelegationToken API operation.", Operation = new[] {"SendDelegationToken"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.SendDelegationTokenResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.SendDelegationTokenResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.SendDelegationTokenResponse) be returned by specifying '-Select *'."
    )]
    public partial class SendIAMDelegationTokenCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the delegation request for which to send the token.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IdentityManagement.Model.SendDelegationTokenResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Send-IAMDelegationToken (SendDelegationToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.SendDelegationTokenResponse, SendIAMDelegationTokenCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.SendDelegationTokenRequest();
        ...
        private Amazon.IdentityManagement.Model.SendDelegationTokenResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.SendDelegationTokenRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "SendDelegationToken");
            try
            {
                #if DESKTOP
                return client.SendDelegationToken(request);
                #elif CORECLR
                return client.SendDelegationTokenAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DelegationRequestId { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.SendDelegationTokenResponse, SendIAMDelegationTokenCmdlet, object> Select { get; set; } =
