...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListAttachedGroupPolicies API operation.", Operation = new[] {"ListAttachedGroupPolicies"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse), LegacyAlias="Get-IAMAttachedGroupPolicies")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.AttachedPolicyType or Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.AttachedPolicyType objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMAttachedGroupPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse, GetIAMAttachedGroupPolicyListCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesRequest request)
        {
            ...
            try
            {
                return client.ListAttachedGroupPoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PathPrefix { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListAttachedGroupPoliciesResponse, GetIAMAttachedGroupPolicyListCmdlet, object> Select { get; set; } =
