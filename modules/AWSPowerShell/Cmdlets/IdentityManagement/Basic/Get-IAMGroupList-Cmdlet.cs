...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListGroups API operation.", Operation = new[] {"ListGroups"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListGroupsResponse), LegacyAlias="Get-IAMGroups")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Group or Amazon.IdentityManagement.Model.ListGroupsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Group objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMGroupListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The path prefix for filtering the results. For example, the prefix <c>/division_abc/subdivision_xyz/</c>
        /// gets all groups whose path starts with <c>/division_abc/subdivision_xyz/</c>.</para><para>This parameter is optional. If it is not included, it defaults to a slash (/), listing
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListGroupsResponse, GetIAMGroupListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PathPrefix { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListGroupsResponse, GetIAMGroupListCmdlet, object> Select { get; set; } =
