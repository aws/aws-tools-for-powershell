...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListSigningCertificates API operation.", Operation = new[] {"ListSigningCertificates"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListSigningCertificatesResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.SigningCertificate or Amazon.IdentityManagement.Model.ListSigningCertificatesResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.SigningCertificate objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListSigningCertificatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMSigningCertificateCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListSigningCertificatesResponse, GetIAMSigningCertificateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListSigningCertificatesRequest();
        ...
        private Amazon.IdentityManagement.Model.ListSigningCertificatesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListSigningCertificatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListSigningCertificates");
            try
            {
                #if DESKTOP
                return client.ListSigningCertificates(request);
                #elif CORECLR
                return client.ListSigningCertificatesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListSigningCertificatesResponse, GetIAMSigningCertificateCmdlet, object> Select { get; set; } =
