...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.GenerateCredentialReportResponse",
        "This cmdlet returns an Amazon.IdentityManagement.Model.GenerateCredentialReportResponse object containing multiple properties."
    )]
    public partial class RequestIAMCredentialReportCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.IdentityManagement.Model.GenerateCredentialReportResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GenerateCredentialReportRequest request)
        {
            ...
            try
            {
                return client.GenerateCredentialReportAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
