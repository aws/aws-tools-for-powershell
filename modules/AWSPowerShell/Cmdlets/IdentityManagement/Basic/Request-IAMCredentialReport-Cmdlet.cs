...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management GenerateCredentialReport API operation.", Operation = new[] {"GenerateCredentialReport"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.GenerateCredentialReportResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.GenerateCredentialReportResponse",
        "This cmdlet returns an Amazon.IdentityManagement.Model.GenerateCredentialReportResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RequestIAMCredentialReportCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.GenerateCredentialReportResponse, RequestIAMCredentialReportCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.GenerateCredentialReportResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GenerateCredentialReportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "GenerateCredentialReport");
            try
            {
                #if DESKTOP
                return client.GenerateCredentialReport(request);
                #elif CORECLR
                return client.GenerateCredentialReportAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.IdentityManagement.Model.GenerateCredentialReportResponse, RequestIAMCredentialReportCmdlet, object> Select { get; set; } =
