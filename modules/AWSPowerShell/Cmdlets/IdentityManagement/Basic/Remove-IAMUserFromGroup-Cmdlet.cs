...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management RemoveUserFromGroup API operation.", Operation = new[] {"RemoveUserFromGroup"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIAMUserFromGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse, RemoveIAMUserFromGroupCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.RemoveUserFromGroupRequest request)
        {
            ...
            try
            {
                return client.RemoveUserFromGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupName { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.RemoveUserFromGroupResponse, RemoveIAMUserFromGroupCmdlet, object> Select { get; set; } =
