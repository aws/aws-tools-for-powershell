...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management GetGroupPolicy API operation.", Operation = new[] {"GetGroupPolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.GetGroupPolicyResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.GetGroupPolicyResponse",
        "This cmdlet returns an Amazon.IdentityManagement.Model.GetGroupPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMGroupPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.GetGroupPolicyResponse, GetIAMGroupPolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.GetGroupPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetGroupPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "GetGroupPolicy");
            try
            {
                #if DESKTOP
                return client.GetGroupPolicy(request);
                #elif CORECLR
                return client.GetGroupPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupName { get; set; }
            public System.String PolicyName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.GetGroupPolicyResponse, GetIAMGroupPolicyCmdlet, object> Select { get; set; } =
