...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para></li></ul></note>
    /// </summary>
    [Cmdlet("Add", "IAMInstanceProfileTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management TagInstanceProfile API operation.", Operation = new[] {"TagInstanceProfile"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.TagInstanceProfileResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.TagInstanceProfileResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.TagInstanceProfileResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIAMInstanceProfileTagCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter InstanceProfileName
        /// <summary>
        /// <para>
        /// <para>The name of the IAM instance profile to which you want to add tags.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IAMInstanceProfileTag (TagInstanceProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.TagInstanceProfileResponse, AddIAMInstanceProfileTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.TagInstanceProfileRequest();
        ...
        private Amazon.IdentityManagement.Model.TagInstanceProfileResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.TagInstanceProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "TagInstanceProfile");
            try
            {
                #if DESKTOP
                return client.TagInstanceProfile(request);
                #elif CORECLR
                return client.TagInstanceProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IdentityManagement.Model.TagInstanceProfileResponse, AddIAMInstanceProfileTagCmdlet, object> Select { get; set; } =
