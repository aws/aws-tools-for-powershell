...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// policy in a user, use <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutUserPolicy.html"><c>PutUserPolicy</c></a>.
    /// </para><para>
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management AttachUserPolicy API operation.", Operation = new[] {"AttachUserPolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.AttachUserPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.AttachUserPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.AttachUserPolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class RegisterIAMUserPolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.AttachUserPolicyResponse, RegisterIAMUserPolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.AttachUserPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AttachUserPolicyRequest request)
        {
            ...
            try
            {
                return client.AttachUserPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyArn { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.AttachUserPolicyResponse, RegisterIAMUserPolicyCmdlet, object> Select { get; set; } =
