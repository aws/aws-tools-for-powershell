...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMAccessKeyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccessKeyMetadata";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListAccessKeysResponse, GetIAMAccessKeyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListAccessKeysRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AccessKeyMetadata?.Count ?? 0;
        ...
        private Amazon.IdentityManagement.Model.ListAccessKeysResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListAccessKeysRequest request)
        {
            ...
            try
            {
                return client.ListAccessKeysAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListAccessKeysResponse, GetIAMAccessKeyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccessKeyMetadata;
        }
