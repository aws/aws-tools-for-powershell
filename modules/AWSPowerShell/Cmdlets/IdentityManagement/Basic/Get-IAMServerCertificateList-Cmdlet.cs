...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListServerCertificates API operation.", Operation = new[] {"ListServerCertificates"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListServerCertificatesResponse), LegacyAlias="Get-IAMServerCertificates")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.ServerCertificateMetadata or Amazon.IdentityManagement.Model.ListServerCertificatesResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.ServerCertificateMetadata objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListServerCertificatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMServerCertificateListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The path prefix for filtering the results. For example: <c>/company/servercerts</c>
        /// would get all server certificates for which the path starts with <c>/company/servercerts</c>.</para><para>This parameter is optional. If it is not included, it defaults to a slash (/), listing
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ServerCertificateMetadataList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListServerCertificatesResponse, GetIAMServerCertificateListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ServerCertificateMetadataList?.Count ?? 0;
        ...
        private Amazon.IdentityManagement.Model.ListServerCertificatesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListServerCertificatesRequest request)
        {
            ...
            try
            {
                return client.ListServerCertificatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PathPrefix { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListServerCertificatesResponse, GetIAMServerCertificateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ServerCertificateMetadataList;
        }
