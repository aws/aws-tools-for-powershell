...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management DeleteRolePolicy API operation.", Operation = new[] {"DeleteRolePolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.DeleteRolePolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.DeleteRolePolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.DeleteRolePolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DeleteRolePolicyResponse, RemoveIAMRolePolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.DeleteRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteRolePolicyRequest request)
        {
            ...
            try
            {
                return client.DeleteRolePolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyName { get; set; }
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DeleteRolePolicyResponse, RemoveIAMRolePolicyCmdlet, object> Select { get; set; } =
