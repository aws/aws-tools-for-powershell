...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IAMSAMLProviderTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management UntagSAMLProvider API operation.", Operation = new[] {"UntagSAMLProvider"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.UntagSAMLProviderResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.UntagSAMLProviderResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.UntagSAMLProviderResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIAMSAMLProviderTagCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the SAML identity provider in IAM from which you want to remove tags.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMSAMLProviderTag (UntagSAMLProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.UntagSAMLProviderResponse, RemoveIAMSAMLProviderTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.UntagSAMLProviderRequest();
        ...
        private Amazon.IdentityManagement.Model.UntagSAMLProviderResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.UntagSAMLProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "UntagSAMLProvider");
            try
            {
                #if DESKTOP
                return client.UntagSAMLProvider(request);
                #elif CORECLR
                return client.UntagSAMLProviderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IdentityManagement.Model.UntagSAMLProviderResponse, RemoveIAMSAMLProviderTagCmdlet, object> Select { get; set; } =
