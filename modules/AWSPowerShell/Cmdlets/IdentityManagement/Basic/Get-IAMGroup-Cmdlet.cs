...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// the results using the <c>MaxItems</c> and <c>Marker</c> parameters.<br/><br/>In the AWS.Tools.IdentityManagement module, this cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "IAMGroup")]
    [OutputType("Amazon.IdentityManagement.Model.GetGroupResponse")]
    [AWSCmdlet("Calls the AWS Identity and Access Management GetGroup API operation.", Operation = new[] {"GetGroup"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.GetGroupResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.GetGroupResponse",
        "This cmdlet returns an Amazon.IdentityManagement.Model.GetGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMGroupCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.GetGroupResponse, GetIAMGroupCmdlet>(Select) ??
