...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMSAMLProviderTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListSAMLProviderTags API operation.", Operation = new[] {"ListSAMLProviderTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMSAMLProviderTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// you want to see.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse, GetIAMSAMLProviderTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListSAMLProviderTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListSAMLProviderTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListSAMLProviderTags");
            try
            {
                #if DESKTOP
                return client.ListSAMLProviderTags(request);
                #elif CORECLR
                return client.ListSAMLProviderTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxItem { get; set; }
            public System.String SAMLProviderArn { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListSAMLProviderTagsResponse, GetIAMSAMLProviderTagListCmdlet, object> Select { get; set; } =
