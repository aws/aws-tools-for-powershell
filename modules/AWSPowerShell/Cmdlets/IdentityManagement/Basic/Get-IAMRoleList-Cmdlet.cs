...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListRoles API operation.", Operation = new[] {"ListRoles"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListRolesResponse), LegacyAlias="Get-IAMRoles")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Role or Amazon.IdentityManagement.Model.ListRolesResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Role objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListRolesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMRoleListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PathPrefix' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListRolesResponse, GetIAMRoleListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.PathPrefix;
            }
        ...
        private Amazon.IdentityManagement.Model.ListRolesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListRolesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListRoles");
            try
            {
                #if DESKTOP
                return client.ListRoles(request);
                #elif CORECLR
                return client.ListRolesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PathPrefix { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListRolesResponse, GetIAMRoleListCmdlet, object> Select { get; set; } =
