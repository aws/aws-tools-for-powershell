...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class RemoveIAMRolePermissionsBoundaryCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMRolePermissionsBoundary (DeleteRolePermissionsBoundary)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DeleteRolePermissionsBoundaryResponse, RemoveIAMRolePermissionsBoundaryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.DeleteRolePermissionsBoundaryRequest();
        ...
        private Amazon.IdentityManagement.Model.DeleteRolePermissionsBoundaryResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteRolePermissionsBoundaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "DeleteRolePermissionsBoundary");
            try
            {
                #if DESKTOP
                return client.DeleteRolePermissionsBoundary(request);
                #elif CORECLR
                return client.DeleteRolePermissionsBoundaryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DeleteRolePermissionsBoundaryResponse, RemoveIAMRolePermissionsBoundaryCmdlet, object> Select { get; set; } =
