...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management DetachRolePolicy API operation.", Operation = new[] {"DetachRolePolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.DetachRolePolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.DetachRolePolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.DetachRolePolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class UnregisterIAMRolePolicyCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-IAMRolePolicy (DetachRolePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DetachRolePolicyResponse, UnregisterIAMRolePolicyCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.DetachRolePolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DetachRolePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "DetachRolePolicy");
            try
            {
                #if DESKTOP
                return client.DetachRolePolicy(request);
                #elif CORECLR
                return client.DetachRolePolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyArn { get; set; }
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DetachRolePolicyResponse, UnregisterIAMRolePolicyCmdlet, object> Select { get; set; } =
