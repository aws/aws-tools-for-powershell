...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.UpdateLoginProfileResponse",
        ...
        "The service response (type Amazon.IdentityManagement.Model.UpdateLoginProfileResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateIAMLoginProfileCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// return (<c>\u000D</c>)</para></li></ul><para>However, the format can be further restricted by the account administrator by setting
        /// a password policy on the Amazon Web Services account. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_UpdateAccountPasswordPolicy.html">UpdateAccountPasswordPolicy</a>.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.IdentityManagement.Model.UpdateLoginProfileResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.UpdateLoginProfileRequest request)
        {
            ...
            try
            {
                return client.UpdateLoginProfileAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
