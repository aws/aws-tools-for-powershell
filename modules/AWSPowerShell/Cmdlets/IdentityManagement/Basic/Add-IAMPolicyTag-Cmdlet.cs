...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management TagPolicy API operation.", Operation = new[] {"TagPolicy"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.TagPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.TagPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.TagPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIAMPolicyTagCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the IAM customer managed policy to which you want to add tags.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IAMPolicyTag (TagPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.TagPolicyResponse, AddIAMPolicyTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.TagPolicyRequest();
        ...
        private Amazon.IdentityManagement.Model.TagPolicyResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.TagPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "TagPolicy");
            try
            {
                #if DESKTOP
                return client.TagPolicy(request);
                #elif CORECLR
                return client.TagPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IdentityManagement.Model.TagPolicyResponse, AddIAMPolicyTagCmdlet, object> Select { get; set; } =
