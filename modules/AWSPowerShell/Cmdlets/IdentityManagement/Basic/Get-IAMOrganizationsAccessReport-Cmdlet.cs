...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// generated using the <c><a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GenerateOrganizationsAccessReport.html">GenerateOrganizationsAccessReport</a></c> operation. This operation retrieves the status of your report job and the report
    /// contents.
    /// 
    ///  
    /// <para>
    ...
    public partial class GetIAMOrganizationsAccessReportCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the request generated by the <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GenerateOrganizationsAccessReport.html">GenerateOrganizationsAccessReport</a>
        /// operation.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.IdentityManagement.Model.GetOrganizationsAccessReportResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetOrganizationsAccessReportRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetOrganizationsAccessReport(request);
                #elif CORECLR
                return client.GetOrganizationsAccessReportAsync(request).GetAwaiter().GetResult();
                #else
