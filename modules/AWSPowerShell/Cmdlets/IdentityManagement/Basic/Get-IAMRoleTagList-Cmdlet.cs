...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// IAM Identities</a> in the <i>IAM User Guide</i>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "IAMRoleTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListRoleTags API operation.", Operation = new[] {"ListRoleTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListRoleTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListRoleTagsResponse",
    ...
    public partial class GetIAMRoleTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListRoleTagsResponse, GetIAMRoleTagListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListRoleTagsResponse, GetIAMRoleTagListCmdlet, object> Select { get; set; } =
