...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListRoleTagsResponse",
        ...
        "The service call response (type Amazon.IdentityManagement.Model.ListRoleTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMRoleTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.IdentityManagement.Model.ListRoleTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListRoleTagsRequest request)
        {
            ...
            try
            {
                return client.ListRoleTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
