...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMServerCertificateTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListServerCertificateTags API operation.", Operation = new[] {"ListServerCertificateTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMServerCertificateTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter ServerCertificateName
        /// <summary>
        /// <para>
        /// <para>The name of the IAM server certificate whose tags you want to see.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse, GetIAMServerCertificateTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListServerCertificateTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListServerCertificateTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListServerCertificateTags");
            try
            {
                #if DESKTOP
                return client.ListServerCertificateTags(request);
                #elif CORECLR
                return client.ListServerCertificateTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxItem { get; set; }
            public System.String ServerCertificateName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListServerCertificateTagsResponse, GetIAMServerCertificateTagListCmdlet, object> Select { get; set; } =
