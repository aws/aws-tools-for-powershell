...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMPolicyTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListPolicyTags API operation.", Operation = new[] {"ListPolicyTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListPolicyTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListPolicyTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListPolicyTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMPolicyTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter PolicyArn
        /// <summary>
        /// <para>
        /// <para>The ARN of the IAM customer managed policy whose tags you want to see.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListPolicyTagsResponse, GetIAMPolicyTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListPolicyTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListPolicyTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListPolicyTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListPolicyTags");
            try
            {
                #if DESKTOP
                return client.ListPolicyTags(request);
                #elif CORECLR
                return client.ListPolicyTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxItem { get; set; }
            public System.String PolicyArn { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListPolicyTagsResponse, GetIAMPolicyTagListCmdlet, object> Select { get; set; } =
