...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMInstanceProfileTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListInstanceProfileTags API operation.", Operation = new[] {"ListInstanceProfileTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMInstanceProfileTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter InstanceProfileName
        /// <summary>
        /// <para>
        /// <para>The name of the IAM instance profile whose tags you want to see.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse, GetIAMInstanceProfileTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListInstanceProfileTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListInstanceProfileTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListInstanceProfileTags");
            try
            {
                #if DESKTOP
                return client.ListInstanceProfileTags(request);
                #elif CORECLR
                return client.ListInstanceProfileTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxItem { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListInstanceProfileTagsResponse, GetIAMInstanceProfileTagListCmdlet, object> Select { get; set; } =
