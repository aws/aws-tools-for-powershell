...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class UpdateIAMRoleCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// applied. This setting can have a value from 1 hour to 12 hours.</para><para>Anyone who assumes the role from the CLI or API can use the <code>DurationSeconds</code>
