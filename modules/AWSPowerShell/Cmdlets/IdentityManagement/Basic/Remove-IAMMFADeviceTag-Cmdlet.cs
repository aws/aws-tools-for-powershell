...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "IAMMFADeviceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management UntagMFADevice API operation.", Operation = new[] {"UntagMFADevice"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.UntagMFADeviceResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.UntagMFADeviceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.UntagMFADeviceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIAMMFADeviceTagCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// tags. For virtual MFA devices, the serial number is the same as the ARN.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IAMMFADeviceTag (UntagMFADevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.UntagMFADeviceResponse, RemoveIAMMFADeviceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.UntagMFADeviceRequest();
        ...
        private Amazon.IdentityManagement.Model.UntagMFADeviceResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.UntagMFADeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "UntagMFADevice");
            try
            {
                #if DESKTOP
                return client.UntagMFADevice(request);
                #elif CORECLR
                return client.UntagMFADeviceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IdentityManagement.Model.UntagMFADeviceResponse, RemoveIAMMFADeviceTagCmdlet, object> Select { get; set; } =
