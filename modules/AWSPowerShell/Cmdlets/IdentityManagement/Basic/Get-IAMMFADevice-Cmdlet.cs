...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListMFADevices API operation.", Operation = new[] {"ListMFADevices"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListMFADevicesResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.MFADevice or Amazon.IdentityManagement.Model.ListMFADevicesResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.MFADevice objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListMFADevicesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMMFADeviceCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MFADevices";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListMFADevicesResponse, GetIAMMFADeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.MFADevices?.Count ?? 0;
        ...
        private Amazon.IdentityManagement.Model.ListMFADevicesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListMFADevicesRequest request)
        {
            ...
            try
            {
                return client.ListMFADevicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListMFADevicesResponse, GetIAMMFADeviceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MFADevices;
        }
