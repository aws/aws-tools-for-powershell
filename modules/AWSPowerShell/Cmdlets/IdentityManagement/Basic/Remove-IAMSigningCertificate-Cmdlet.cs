...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class RemoveIAMSigningCertificateCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.DeleteSigningCertificateResponse, RemoveIAMSigningCertificateCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.DeleteSigningCertificateResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.DeleteSigningCertificateRequest request)
        {
            ...
            try
            {
                return client.DeleteSigningCertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CertificateId { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.DeleteSigningCertificateResponse, RemoveIAMSigningCertificateCmdlet, object> Select { get; set; } =
