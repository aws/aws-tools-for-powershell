...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class GetIAMAccountSummaryCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "SummaryMap";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.GetAccountSummaryResponse, GetIAMAccountSummaryCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.GetAccountSummaryResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.GetAccountSummaryRequest request)
        {
            ...
            try
            {
                return client.GetAccountSummaryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.IdentityManagement.Model.GetAccountSummaryResponse, GetIAMAccountSummaryCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SummaryMap;
        }
