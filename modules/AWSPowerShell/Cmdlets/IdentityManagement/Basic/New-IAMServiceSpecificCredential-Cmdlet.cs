...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    public partial class NewIAMServiceSpecificCredentialCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// When not specified, the credential will not expire.</para><para>To see which services support long-term API keys, refer to <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_api_keys_for_aws_services.html">API
        /// keys for Amazon Web Services services</a> in the <i>IAM User Guide</i>.</para>
        /// </para>
        /// </summary>
        ...
        private Amazon.IdentityManagement.Model.CreateServiceSpecificCredentialResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.CreateServiceSpecificCredentialRequest request)
        {
            ...
            try
            {
                return client.CreateServiceSpecificCredentialAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
