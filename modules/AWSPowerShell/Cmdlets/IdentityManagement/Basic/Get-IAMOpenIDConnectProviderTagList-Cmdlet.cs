...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMOpenIDConnectProviderTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListOpenIDConnectProviderTags API operation.", Operation = new[] {"ListOpenIDConnectProviderTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMOpenIDConnectProviderTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter OpenIDConnectProviderArn
        /// <summary>
        /// <para>
        /// <para>The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse, GetIAMOpenIDConnectProviderTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListOpenIDConnectProviderTags");
            try
            {
                #if DESKTOP
                return client.ListOpenIDConnectProviderTags(request);
                #elif CORECLR
                return client.ListOpenIDConnectProviderTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxItem { get; set; }
            public System.String OpenIDConnectProviderArn { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListOpenIDConnectProviderTagsResponse, GetIAMOpenIDConnectProviderTagListCmdlet, object> Select { get; set; } =
