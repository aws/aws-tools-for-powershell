...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Register", "IAMDelegationRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management AssociateDelegationRequest API operation.", Operation = new[] {"AssociateDelegationRequest"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse) be returned by specifying '-Select *'."
    )]
    public partial class RegisterIAMDelegationRequestCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the delegation request to associate.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-IAMDelegationRequest (AssociateDelegationRequest)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse, RegisterIAMDelegationRequestCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.AssociateDelegationRequestRequest();
        ...
        private Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.AssociateDelegationRequestRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "AssociateDelegationRequest");
            try
            {
                #if DESKTOP
                return client.AssociateDelegationRequest(request);
                #elif CORECLR
                return client.AssociateDelegationRequestAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DelegationRequestId { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.AssociateDelegationRequestResponse, RegisterIAMDelegationRequestCmdlet, object> Select { get; set; } =
