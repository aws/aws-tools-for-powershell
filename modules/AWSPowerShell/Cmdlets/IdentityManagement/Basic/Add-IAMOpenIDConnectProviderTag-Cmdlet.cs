...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </para></li></ul></note>
    /// </summary>
    [Cmdlet("Add", "IAMOpenIDConnectProviderTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Identity and Access Management TagOpenIDConnectProvider API operation.", Operation = new[] {"TagOpenIDConnectProvider"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse))]
    [AWSCmdletOutput("None or Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIAMOpenIDConnectProviderTagCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        
        #region Parameter OpenIDConnectProviderArn
        /// <summary>
        /// <para>
        /// <para>The ARN of the OIDC identity provider in IAM to which you want to add tags.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-IAMOpenIDConnectProviderTag (TagOpenIDConnectProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse, AddIAMOpenIDConnectProviderTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IdentityManagement.Model.TagOpenIDConnectProviderRequest();
        ...
        private Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.TagOpenIDConnectProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "TagOpenIDConnectProvider");
            try
            {
                #if DESKTOP
                return client.TagOpenIDConnectProvider(request);
                #elif CORECLR
                return client.TagOpenIDConnectProviderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IdentityManagement.Model.TagOpenIDConnectProviderResponse, AddIAMOpenIDConnectProviderTagCmdlet, object> Select { get; set; } =
