...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMMFADeviceTagList")]
    [OutputType("Amazon.IdentityManagement.Model.Tag")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListMFADeviceTags API operation.", Operation = new[] {"ListMFADeviceTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Tag objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIAMMFADeviceTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// virtual MFA devices, the serial number is the same as the ARN.</para><para>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse, GetIAMMFADeviceTagListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListMFADeviceTagsRequest();
        ...
        private Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListMFADeviceTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListMFADeviceTags");
            try
            {
                #if DESKTOP
                return client.ListMFADeviceTags(request);
                #elif CORECLR
                return client.ListMFADeviceTagsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxItem { get; set; }
            public System.String SerialNumber { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListMFADeviceTagsResponse, GetIAMMFADeviceTagListCmdlet, object> Select { get; set; } =
