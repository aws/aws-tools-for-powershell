...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMUserPolicyList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListUserPolicies API operation.", Operation = new[] {"ListUserPolicies"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListUserPoliciesResponse), LegacyAlias="Get-IAMUserPolicies")]
    [AWSCmdletOutput("System.String or Amazon.IdentityManagement.Model.ListUserPoliciesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListUserPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMUserPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PolicyNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListUserPoliciesResponse, GetIAMUserPolicyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IdentityManagement.Model.ListUserPoliciesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.PolicyNames?.Count ?? 0;
        ...
        private Amazon.IdentityManagement.Model.ListUserPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListUserPoliciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Identity and Access Management", "ListUserPolicies");
            try
            {
                #if DESKTOP
                return client.ListUserPolicies(request);
                #elif CORECLR
                return client.ListUserPoliciesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListUserPoliciesResponse, GetIAMUserPolicyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PolicyNames;
        }
