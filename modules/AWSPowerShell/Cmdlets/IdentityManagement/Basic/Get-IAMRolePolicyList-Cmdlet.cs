...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListRolePolicies API operation.", Operation = new[] {"ListRolePolicies"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListRolePoliciesResponse), LegacyAlias="Get-IAMRolePolicies")]
    [AWSCmdletOutput("System.String or Amazon.IdentityManagement.Model.ListRolePoliciesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListRolePoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMRolePolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListRolePoliciesResponse, GetIAMRolePolicyListCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.ListRolePoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListRolePoliciesRequest request)
        {
            ...
            try
            {
                return client.ListRolePoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String RoleName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListRolePoliciesResponse, GetIAMRolePolicyListCmdlet, object> Select { get; set; } =
