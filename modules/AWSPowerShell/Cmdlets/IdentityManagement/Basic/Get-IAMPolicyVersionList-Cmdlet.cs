...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListPolicyVersions API operation.", Operation = new[] {"ListPolicyVersions"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListPolicyVersionsResponse), LegacyAlias="Get-IAMPolicyVersions")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.PolicyVersion or Amazon.IdentityManagement.Model.ListPolicyVersionsResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.PolicyVersion objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListPolicyVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMPolicyVersionListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListPolicyVersionsResponse, GetIAMPolicyVersionListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PolicyArn { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListPolicyVersionsResponse, GetIAMPolicyVersionListCmdlet, object> Select { get; set; } =
