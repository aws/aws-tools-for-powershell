...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    /// </summary>
    [Cmdlet("Get", "IAMGroupPolicyList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Identity and Access Management ListGroupPolicies API operation.", Operation = new[] {"ListGroupPolicies"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListGroupPoliciesResponse), LegacyAlias="Get-IAMGroupPolicies")]
    [AWSCmdletOutput("System.String or Amazon.IdentityManagement.Model.ListGroupPoliciesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListGroupPoliciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMGroupPolicyListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListGroupPoliciesResponse, GetIAMGroupPolicyListCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.ListGroupPoliciesResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListGroupPoliciesRequest request)
        {
            ...
            try
            {
                return client.ListGroupPoliciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxItem { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListGroupPoliciesResponse, GetIAMGroupPolicyListCmdlet, object> Select { get; set; } =
