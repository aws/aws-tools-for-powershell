...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListGroupsForUser API operation.", Operation = new[] {"ListGroupsForUser"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListGroupsForUserResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Group or Amazon.IdentityManagement.Model.ListGroupsForUserResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.Group objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListGroupsForUserResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMGroupForUserCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListGroupsForUserResponse, GetIAMGroupForUserCmdlet>(Select) ??
        ...
        private Amazon.IdentityManagement.Model.ListGroupsForUserResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListGroupsForUserRequest request)
        {
            ...
            try
            {
                return client.ListGroupsForUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListGroupsForUserResponse, GetIAMGroupForUserCmdlet, object> Select { get; set; } =
