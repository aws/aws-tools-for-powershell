...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListUserTags API operation.", Operation = new[] {"ListUserTags"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListUserTagsResponse))]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListUserTagsResponse",
    ...
    public partial class GetIAMUserTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListUserTagsResponse, GetIAMUserTagListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String UserName { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListUserTagsResponse, GetIAMUserTagListCmdlet, object> Select { get; set; } =
