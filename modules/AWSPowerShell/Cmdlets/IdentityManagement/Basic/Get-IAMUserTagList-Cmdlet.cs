...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.Tag or Amazon.IdentityManagement.Model.ListUserTagsResponse",
        ...
        "The service call response (type Amazon.IdentityManagement.Model.ListUserTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMUserTagListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.IdentityManagement.Model.ListUserTagsResponse CallAWSServiceOperation(IAmazonIdentityManagementService client, Amazon.IdentityManagement.Model.ListUserTagsRequest request)
        {
            ...
            try
            {
                return client.ListUserTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
