...
namespace Amazon.PowerShell.Cmdlets.IAM
{
    ...
    [AWSCmdlet("Calls the AWS Identity and Access Management ListUsers API operation.", Operation = new[] {"ListUsers"}, SelectReturnType = typeof(Amazon.IdentityManagement.Model.ListUsersResponse), LegacyAlias="Get-IAMUsers")]
    [AWSCmdletOutput("Amazon.IdentityManagement.Model.User or Amazon.IdentityManagement.Model.ListUsersResponse",
        "This cmdlet returns a collection of Amazon.IdentityManagement.Model.User objects.",
        "The service call response (type Amazon.IdentityManagement.Model.ListUsersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIAMUserListCmdlet : AmazonIdentityManagementServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The path prefix for filtering the results. For example: <c>/division_abc/subdivision_xyz/</c>,
        /// which would get all user names whose path starts with <c>/division_abc/subdivision_xyz/</c>.</para><para>This parameter is optional. If it is not included, it defaults to a slash (/), listing
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IdentityManagement.Model.ListUsersResponse, GetIAMUserListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxItem { get; set; }
            public System.String PathPrefix { get; set; }
            public System.Func<Amazon.IdentityManagement.Model.ListUsersResponse, GetIAMUserListCmdlet, object> Select { get; set; } =
