...
{
    /// <summary>
    /// Returns a list of all ingestion destinations configured for an ingestion.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AFABIngestionDestinationList")]
    [OutputType("Amazon.AppFabric.Model.IngestionDestinationSummary")]
    [AWSCmdlet("Calls the Amazon Web Services AppFabric ListIngestionDestinations API operation.", Operation = new[] {"ListIngestionDestinations"}, SelectReturnType = typeof(Amazon.AppFabric.Model.ListIngestionDestinationsResponse))]
    [AWSCmdletOutput("Amazon.AppFabric.Model.IngestionDestinationSummary or Amazon.AppFabric.Model.ListIngestionDestinationsResponse",
        "This cmdlet returns a collection of Amazon.AppFabric.Model.IngestionDestinationSummary objects.",
        "The service call response (type Amazon.AppFabric.Model.ListIngestionDestinationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAFABIngestionDestinationListCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "IngestionDestinations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.ListIngestionDestinationsResponse, GetAFABIngestionDestinationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppFabric.Model.ListIngestionDestinationsRequest();
        ...
        private Amazon.AppFabric.Model.ListIngestionDestinationsResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.ListIngestionDestinationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "ListIngestionDestinations");
            try
            {
                return client.ListIngestionDestinationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppFabric.Model.ListIngestionDestinationsResponse, GetAFABIngestionDestinationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.IngestionDestinations;
        }
