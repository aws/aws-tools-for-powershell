...
{
    /// <summary>
    /// Returns a list of all app authorizations configured for an app bundle.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AFABAppAuthorizationList")]
    [OutputType("Amazon.AppFabric.Model.AppAuthorizationSummary")]
    [AWSCmdlet("Calls the Amazon Web Services AppFabric ListAppAuthorizations API operation.", Operation = new[] {"ListAppAuthorizations"}, SelectReturnType = typeof(Amazon.AppFabric.Model.ListAppAuthorizationsResponse))]
    [AWSCmdletOutput("Amazon.AppFabric.Model.AppAuthorizationSummary or Amazon.AppFabric.Model.ListAppAuthorizationsResponse",
        "This cmdlet returns a collection of Amazon.AppFabric.Model.AppAuthorizationSummary objects.",
        "The service call response (type Amazon.AppFabric.Model.ListAppAuthorizationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAFABAppAuthorizationListCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.ListAppAuthorizationsResponse, GetAFABAppAuthorizationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppFabric.Model.ListAppAuthorizationsRequest();
        ...
        private Amazon.AppFabric.Model.ListAppAuthorizationsResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.ListAppAuthorizationsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppFabric.Model.ListAppAuthorizationsResponse, GetAFABAppAuthorizationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AppAuthorizationSummaryList;
        }
