...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Add", "AFABResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddAFABResourceTagCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-AFABResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.TagResourceResponse, AddAFABResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.TagResourceRequest();
        ...
        private Amazon.AppFabric.Model.TagResourceResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppFabric.Model.TagResourceResponse, AddAFABResourceTagCmdlet, object> Select { get; set; } =
