...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Get", "AFABAppBundle")]
    [OutputType("Amazon.AppFabric.Model.AppBundle")]
    [AWSCmdlet("Calls the Amazon Web Services AppFabric GetAppBundle API operation.", Operation = new[] {"GetAppBundle"}, SelectReturnType = typeof(Amazon.AppFabric.Model.GetAppBundleResponse))]
    [AWSCmdletOutput("Amazon.AppFabric.Model.AppBundle or Amazon.AppFabric.Model.GetAppBundleResponse",
        "This cmdlet returns an Amazon.AppFabric.Model.AppBundle object.",
        "The service call response (type Amazon.AppFabric.Model.GetAppBundleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAFABAppBundleCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.GetAppBundleResponse, GetAFABAppBundleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.GetAppBundleRequest();
        ...
        private Amazon.AppFabric.Model.GetAppBundleResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.GetAppBundleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "GetAppBundle");
            try
            {
                #if DESKTOP
                return client.GetAppBundle(request);
                #elif CORECLR
                return client.GetAppBundleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppBundleIdentifier { get; set; }
            public System.Func<Amazon.AppFabric.Model.GetAppBundleResponse, GetAFABAppBundleCmdlet, object> Select { get; set; } =
