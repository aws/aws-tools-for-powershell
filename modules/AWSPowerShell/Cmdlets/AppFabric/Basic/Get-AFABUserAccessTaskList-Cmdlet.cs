...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "AFABUserAccessTaskList")]
    [OutputType("Amazon.AppFabric.Model.UserAccessResultItem")]
    ...
    public partial class GetAFABUserAccessTaskListCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        #region Parameter TaskIdList
        /// <summary>
        /// <para>
        /// <para>The tasks IDs to use for the request.</para><para />
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        public System.String[] TaskIdList { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "UserAccessResultsList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.BatchGetUserAccessTasksResponse, GetAFABUserAccessTaskListCmdlet>(Select) ??
            ...
            {
                context.TaskIdList = new List<System.String>(this.TaskIdList);
            }
            #if MODULAR
            if (this.TaskIdList == null && ParameterWasBound(nameof(this.TaskIdList)))
            {
                WriteWarning("You are passing $null as a value for parameter TaskIdList which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.BatchGetUserAccessTasksRequest();
            
            if (cmdletContext.AppBundleIdentifier != null)
            {
                request.AppBundleIdentifier = cmdletContext.AppBundleIdentifier;
            }
            if (cmdletContext.TaskIdList != null)
            {
                request.TaskIdList = cmdletContext.TaskIdList;
            }
        ...
        private Amazon.AppFabric.Model.BatchGetUserAccessTasksResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.BatchGetUserAccessTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "BatchGetUserAccessTasks");
            try
            {
                return client.BatchGetUserAccessTasksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AppBundleIdentifier { get; set; }
            public List<System.String> TaskIdList { get; set; }
            public System.Func<Amazon.AppFabric.Model.BatchGetUserAccessTasksResponse, GetAFABUserAccessTaskListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.UserAccessResultsList;
        }
