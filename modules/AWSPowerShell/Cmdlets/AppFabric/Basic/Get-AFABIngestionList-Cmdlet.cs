...
{
    /// <summary>
    /// Returns a list of all ingestions configured for an app bundle.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "AFABIngestionList")]
    [OutputType("Amazon.AppFabric.Model.IngestionSummary")]
    ...
    public partial class GetAFABIngestionListCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Ingestions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.ListIngestionsResponse, GetAFABIngestionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AppFabric.Model.ListIngestionsRequest();
        ...
        private Amazon.AppFabric.Model.ListIngestionsResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.ListIngestionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "ListIngestions");
            try
            {
                return client.ListIngestionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AppFabric.Model.ListIngestionsResponse, GetAFABIngestionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Ingestions;
        }
