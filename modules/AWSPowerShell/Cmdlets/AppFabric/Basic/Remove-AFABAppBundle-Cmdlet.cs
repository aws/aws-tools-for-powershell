...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AFABAppBundle", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAFABAppBundleCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AFABAppBundle (DeleteAppBundle)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.DeleteAppBundleResponse, RemoveAFABAppBundleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.DeleteAppBundleRequest();
        ...
        private Amazon.AppFabric.Model.DeleteAppBundleResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.DeleteAppBundleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "DeleteAppBundle");
            try
            {
                #if DESKTOP
                return client.DeleteAppBundle(request);
                #elif CORECLR
                return client.DeleteAppBundleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppBundleIdentifier { get; set; }
            public System.Func<Amazon.AppFabric.Model.DeleteAppBundleResponse, RemoveAFABAppBundleCmdlet, object> Select { get; set; } =
