...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Get", "AFABResourceTag")]
    [OutputType("Amazon.AppFabric.Model.Tag")]
    ...
    public partial class GetAFABResourceTagCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.ListTagsForResourceResponse, GetAFABResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.ListTagsForResourceRequest();
        ...
        private Amazon.AppFabric.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.AppFabric.Model.ListTagsForResourceResponse, GetAFABResourceTagCmdlet, object> Select { get; set; } =
