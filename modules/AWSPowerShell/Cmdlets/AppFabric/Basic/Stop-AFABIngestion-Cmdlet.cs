...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Stop", "AFABIngestion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StopAFABIngestionCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-AFABIngestion (StopIngestion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.StopIngestionResponse, StopAFABIngestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.StopIngestionRequest();
        ...
        private Amazon.AppFabric.Model.StopIngestionResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.StopIngestionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "StopIngestion");
            try
            {
                #if DESKTOP
                return client.StopIngestion(request);
                #elif CORECLR
                return client.StopIngestionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppBundleIdentifier { get; set; }
            public System.String IngestionIdentifier { get; set; }
            public System.Func<Amazon.AppFabric.Model.StopIngestionResponse, StopAFABIngestionCmdlet, object> Select { get; set; } =
