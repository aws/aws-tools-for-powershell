...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AFABAppAuthorization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAFABAppAuthorizationCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AppAuthorizationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AFABAppAuthorization (DeleteAppAuthorization)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.DeleteAppAuthorizationResponse, RemoveAFABAppAuthorizationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.AppAuthorizationIdentifier;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.DeleteAppAuthorizationRequest();
        ...
        private Amazon.AppFabric.Model.DeleteAppAuthorizationResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.DeleteAppAuthorizationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "DeleteAppAuthorization");
            try
            {
                #if DESKTOP
                return client.DeleteAppAuthorization(request);
                #elif CORECLR
                return client.DeleteAppAuthorizationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppAuthorizationIdentifier { get; set; }
            public System.String AppBundleIdentifier { get; set; }
            public System.Func<Amazon.AppFabric.Model.DeleteAppAuthorizationResponse, RemoveAFABAppAuthorizationCmdlet, object> Select { get; set; } =
