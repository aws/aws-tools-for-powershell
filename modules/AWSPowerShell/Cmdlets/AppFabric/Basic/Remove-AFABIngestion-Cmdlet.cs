...
namespace Amazon.PowerShell.Cmdlets.AFAB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "AFABIngestion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveAFABIngestionCmdlet : AmazonAppFabricClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AFABIngestion (DeleteIngestion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppFabric.Model.DeleteIngestionResponse, RemoveAFABIngestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppFabric.Model.DeleteIngestionRequest();
        ...
        private Amazon.AppFabric.Model.DeleteIngestionResponse CallAWSServiceOperation(IAmazonAppFabric client, Amazon.AppFabric.Model.DeleteIngestionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Web Services AppFabric", "DeleteIngestion");
            try
            {
                #if DESKTOP
                return client.DeleteIngestion(request);
                #elif CORECLR
                return client.DeleteIngestionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppBundleIdentifier { get; set; }
            public System.String IngestionIdentifier { get; set; }
            public System.Func<Amazon.AppFabric.Model.DeleteIngestionResponse, RemoveAFABIngestionCmdlet, object> Select { get; set; } =
