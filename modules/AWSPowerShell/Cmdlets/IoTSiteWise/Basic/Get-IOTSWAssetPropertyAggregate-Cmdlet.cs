...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.AggregatedValue or Amazon.IoTSiteWise.Model.GetAssetPropertyAggregatesResponse",
        ...
        "The service call response (type Amazon.IoTSiteWise.Model.GetAssetPropertyAggregatesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSWAssetPropertyAggregateCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// The maximum value of <code>maxResults</code> is 250.</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
        ...
        private Amazon.IoTSiteWise.Model.GetAssetPropertyAggregatesResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.GetAssetPropertyAggregatesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetAssetPropertyAggregates(request);
                #elif CORECLR
                return client.GetAssetPropertyAggregatesAsync(request).GetAwaiter().GetResult();
                #else
