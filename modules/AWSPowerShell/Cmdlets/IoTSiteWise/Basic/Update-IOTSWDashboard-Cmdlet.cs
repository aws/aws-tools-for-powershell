...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("None or Amazon.IoTSiteWise.Model.UpdateDashboardResponse",
        ...
        "The service response (type Amazon.IoTSiteWise.Model.UpdateDashboardResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateIOTSWDashboardCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The new dashboard definition, as specified in a JSON literal.</para><ul><li><para>IoT SiteWise Monitor (Classic) see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/create-dashboards-using-aws-cli.html">Create
