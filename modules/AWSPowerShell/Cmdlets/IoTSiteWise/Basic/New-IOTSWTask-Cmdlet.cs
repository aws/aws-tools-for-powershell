...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "IOTSWTask", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTSiteWise.Model.CreateTaskResponse")]
    [AWSCmdlet("Calls the AWS IoT SiteWise CreateTask API operation.", Operation = new[] {"CreateTask"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.CreateTaskResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.CreateTaskResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.CreateTaskResponse object containing multiple properties."
    )]
    public partial class NewIOTSWTaskCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the task to create. Must be unique within the workspace.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTSiteWise.Model.CreateTaskResponse).
        /// Specifying the name of a property of type Amazon.IoTSiteWise.Model.CreateTaskResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IOTSWTask (CreateTask)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.CreateTaskResponse, NewIOTSWTaskCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.CreateTaskRequest();
        ...
        private Amazon.IoTSiteWise.Model.CreateTaskResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.CreateTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "CreateTask");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TaskName { get; set; }
            public System.String WorkspaceName { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.CreateTaskResponse, NewIOTSWTaskCmdlet, object> Select { get; set; } =
