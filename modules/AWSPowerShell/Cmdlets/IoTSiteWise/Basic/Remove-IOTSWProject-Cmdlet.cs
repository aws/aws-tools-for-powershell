...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT SiteWise DeleteProject API operation.", Operation = new[] {"DeleteProject"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.DeleteProjectResponse))]
    [AWSCmdletOutput("None or Amazon.IoTSiteWise.Model.DeleteProjectResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoTSiteWise.Model.DeleteProjectResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIOTSWProjectCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTSWProject (DeleteProject)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DeleteProjectResponse, RemoveIOTSWProjectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DeleteProjectRequest();
        ...
        private Amazon.IoTSiteWise.Model.DeleteProjectResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DeleteProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DeleteProject");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String ProjectId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DeleteProjectResponse, RemoveIOTSWProjectCmdlet, object> Select { get; set; } =
