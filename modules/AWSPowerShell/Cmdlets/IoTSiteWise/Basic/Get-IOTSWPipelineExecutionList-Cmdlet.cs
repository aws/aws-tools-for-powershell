...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// return executions in terminal states, as in-progress executions have no endTime.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "IOTSWPipelineExecutionList")]
    [OutputType("Amazon.IoTSiteWise.Model.PipelineExecutionSummary")]
    [AWSCmdlet("Calls the AWS IoT SiteWise ListPipelineExecutions API operation.", Operation = new[] {"ListPipelineExecutions"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.PipelineExecutionSummary or Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse",
        "This cmdlet returns a collection of Amazon.IoTSiteWise.Model.PipelineExecutionSummary objects.",
        "The service call response (type Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetIOTSWPipelineExecutionListCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Inclusive lower bound on execution end time (ISO-8601). Only executions with endTime
        /// &gt;= endTimeAfter are returned. Cannot be combined with startTimeAfter or startTimeBefore.
        /// Only matches executions in terminal states.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Exclusive upper bound on execution end time (ISO-8601). Only executions with endTime
        ...
        /// <summary>
        /// <para>
        /// <para>Inclusive lower bound on execution start time (ISO-8601). Only executions with startTime
        /// &gt;= startTimeAfter are returned. Cannot be combined with endTimeAfter or endTimeBefore.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Exclusive upper bound on execution start time (ISO-8601). Only executions with startTime
        /// &lt; startTimeBefore are returned. Cannot be combined with endTimeAfter or endTimeBefore.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Filter by execution state. If not specified, executions in all states are returned.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.IoTSiteWise.PipelineExecutionState")]
        public Amazon.IoTSiteWise.PipelineExecutionState State { get; set; }
        #endregion
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of results to return per request. This is an upper bound; the actual
        /// number of results may be less. Default: 50.</para>
        /// </para>
        /// <para>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse).
        /// Specifying the name of a property of type Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse, GetIOTSWPipelineExecutionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.IoTSiteWise.Model.ListPipelineExecutionsRequest();
        ...
        private Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.ListPipelineExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "ListPipelineExecutions");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.IoTSiteWise.PipelineExecutionState State { get; set; }
            public System.String WorkspaceName { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.ListPipelineExecutionsResponse, GetIOTSWPipelineExecutionListCmdlet, object> Select { get; set; } =
