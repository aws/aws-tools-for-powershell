...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.BatchGetAssetPropertyValueHistoryResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.BatchGetAssetPropertyValueHistoryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSWBatchAssetPropertyValueHistoryCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTSiteWise.Model.BatchGetAssetPropertyValueHistoryResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.BatchGetAssetPropertyValueHistoryRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchGetAssetPropertyValueHistory(request);
                #elif CORECLR
                return client.BatchGetAssetPropertyValueHistoryAsync(request).GetAwaiter().GetResult();
                #else
