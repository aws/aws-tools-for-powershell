...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdlet("Calls the AWS IoT SiteWise CreateProject API operation.", Operation = new[] {"CreateProject"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.CreateProjectResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.CreateProjectResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.CreateProjectResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIOTSWProjectCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IOTSWProject (CreateProject)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.CreateProjectResponse, NewIOTSWProjectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.CreateProjectRequest();
        ...
        private Amazon.IoTSiteWise.Model.CreateProjectResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.CreateProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "CreateProject");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTSiteWise.Model.CreateProjectResponse, NewIOTSWProjectCmdlet, object> Select { get; set; } =
