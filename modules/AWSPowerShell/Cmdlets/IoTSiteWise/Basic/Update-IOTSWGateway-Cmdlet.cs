...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// </summary>
    [Cmdlet("Update", "IOTSWGateway", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT SiteWise UpdateGateway API operation.", Operation = new[] {"UpdateGateway"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.UpdateGatewayResponse))]
    [AWSCmdletOutput("None or Amazon.IoTSiteWise.Model.UpdateGatewayResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.IoTSiteWise.Model.UpdateGatewayResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTSWGatewayCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTSWGateway (UpdateGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.UpdateGatewayResponse, UpdateIOTSWGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.UpdateGatewayRequest();
        ...
        private Amazon.IoTSiteWise.Model.UpdateGatewayResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.UpdateGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "UpdateGateway");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayId { get; set; }
            public System.String GatewayName { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.UpdateGatewayResponse, UpdateIOTSWGatewayCmdlet, object> Select { get; set; } =
