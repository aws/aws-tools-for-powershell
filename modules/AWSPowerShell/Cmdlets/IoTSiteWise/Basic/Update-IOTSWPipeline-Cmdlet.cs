...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// nodes independently.
    /// </summary>
    [Cmdlet("Update", "IOTSWPipeline", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTSiteWise.Model.UpdatePipelineResponse")]
    [AWSCmdlet("Calls the AWS IoT SiteWise UpdatePipeline API operation.", Operation = new[] {"UpdatePipeline"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.UpdatePipelineResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.UpdatePipelineResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.UpdatePipelineResponse object containing multiple properties."
    )]
    public partial class UpdateIOTSWPipelineCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Updated list of compute nodes forming the pipeline DAG.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A new description for the pipeline.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>Updated environment variables shared across all compute nodes.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTSiteWise.Model.UpdatePipelineResponse).
        /// Specifying the name of a property of type Amazon.IoTSiteWise.Model.UpdatePipelineResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTSWPipeline (UpdatePipeline)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.UpdatePipelineResponse, UpdateIOTSWPipelineCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.UpdatePipelineRequest();
        ...
        private Amazon.IoTSiteWise.Model.UpdatePipelineResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.UpdatePipelineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "UpdatePipeline");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PipelineName { get; set; }
            public System.String WorkspaceName { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.UpdatePipelineResponse, UpdateIOTSWPipelineCmdlet, object> Select { get; set; } =
