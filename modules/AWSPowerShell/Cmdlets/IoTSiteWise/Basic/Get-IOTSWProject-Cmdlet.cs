...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    public partial class GetIOTSWProjectCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DescribeProjectResponse, GetIOTSWProjectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DescribeProjectRequest();
        ...
        private Amazon.IoTSiteWise.Model.DescribeProjectResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DescribeProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DescribeProject");
            try
            {
                return client.DescribeProjectAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ProjectId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DescribeProjectResponse, GetIOTSWProjectCmdlet, object> Select { get; set; } =
