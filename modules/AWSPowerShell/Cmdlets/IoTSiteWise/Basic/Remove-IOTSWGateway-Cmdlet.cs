...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    public partial class RemoveIOTSWGatewayCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTSWGateway (DeleteGateway)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DeleteGatewayResponse, RemoveIOTSWGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DeleteGatewayRequest();
        ...
        private Amazon.IoTSiteWise.Model.DeleteGatewayResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DeleteGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DeleteGateway");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GatewayId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DeleteGatewayResponse, RemoveIOTSWGatewayCmdlet, object> Select { get; set; } =
