...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.AssetErrorDetails or Amazon.IoTSiteWise.Model.BatchDisassociateProjectAssetsResponse",
        ...
        "The service call response (type Amazon.IoTSiteWise.Model.BatchDisassociateProjectAssetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
