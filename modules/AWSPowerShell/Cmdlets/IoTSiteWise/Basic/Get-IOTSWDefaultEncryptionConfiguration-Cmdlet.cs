...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    public partial class GetIOTSWDefaultEncryptionConfigurationCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DescribeDefaultEncryptionConfigurationResponse, GetIOTSWDefaultEncryptionConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DescribeDefaultEncryptionConfigurationRequest();
        ...
        private Amazon.IoTSiteWise.Model.DescribeDefaultEncryptionConfigurationResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DescribeDefaultEncryptionConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DescribeDefaultEncryptionConfiguration");
            try
            {
                #if DESKTOP
                return client.DescribeDefaultEncryptionConfiguration(request);
                #elif CORECLR
                return client.DescribeDefaultEncryptionConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.IoTSiteWise.Model.DescribeDefaultEncryptionConfigurationResponse, GetIOTSWDefaultEncryptionConfigurationCmdlet, object> Select { get; set; } =
