...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    public partial class RemoveIOTSWDashboardCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IOTSWDashboard (DeleteDashboard)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DeleteDashboardResponse, RemoveIOTSWDashboardCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DeleteDashboardRequest();
        ...
        private Amazon.IoTSiteWise.Model.DeleteDashboardResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DeleteDashboardRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DeleteDashboard");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String DashboardId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DeleteDashboardResponse, RemoveIOTSWDashboardCmdlet, object> Select { get; set; } =
