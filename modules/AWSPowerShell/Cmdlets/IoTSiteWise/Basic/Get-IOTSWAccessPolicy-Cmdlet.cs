...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [OutputType("Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse")]
    [AWSCmdlet("Calls the AWS IoT SiteWise DescribeAccessPolicy API operation.", Operation = new[] {"DescribeAccessPolicy"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSWAccessPolicyCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse, GetIOTSWAccessPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DescribeAccessPolicyRequest();
        ...
        private Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DescribeAccessPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DescribeAccessPolicy");
            try
            {
                #if DESKTOP
                return client.DescribeAccessPolicy(request);
                #elif CORECLR
                return client.DescribeAccessPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AccessPolicyId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DescribeAccessPolicyResponse, GetIOTSWAccessPolicyCmdlet, object> Select { get; set; } =
