...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTSWGateway")]
    [OutputType("Amazon.IoTSiteWise.Model.DescribeGatewayResponse")]
    [AWSCmdlet("Calls the AWS IoT SiteWise DescribeGateway API operation.", Operation = new[] {"DescribeGateway"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.DescribeGatewayResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.DescribeGatewayResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.DescribeGatewayResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSWGatewayCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.DescribeGatewayResponse, GetIOTSWGatewayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.DescribeGatewayRequest();
        ...
        private Amazon.IoTSiteWise.Model.DescribeGatewayResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.DescribeGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "DescribeGateway");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GatewayId { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.DescribeGatewayResponse, GetIOTSWGatewayCmdlet, object> Select { get; set; } =
