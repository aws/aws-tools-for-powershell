...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    /// </summary>
    [Cmdlet("New", "IOTSWComputationModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.IoTSiteWise.Model.CreateComputationModelResponse")]
    [AWSCmdlet("Calls the AWS IoT SiteWise CreateComputationModel API operation.", Operation = new[] {"CreateComputationModel"}, SelectReturnType = typeof(Amazon.IoTSiteWise.Model.CreateComputationModelResponse))]
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.CreateComputationModelResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.CreateComputationModelResponse object containing multiple properties."
    )]
    public partial class NewIOTSWComputationModelCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.IoTSiteWise.Model.CreateComputationModelResponse).
        /// Specifying the name of a property of type Amazon.IoTSiteWise.Model.CreateComputationModelResponse will result in that property being returned.
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ComputationModelName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ComputationModelName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ComputationModelName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ComputationModelName), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-IOTSWComputationModel (CreateComputationModel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.CreateComputationModelResponse, NewIOTSWComputationModelCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ComputationModelName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.CreateComputationModelRequest();
        ...
        private Amazon.IoTSiteWise.Model.CreateComputationModelResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.CreateComputationModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "CreateComputationModel");
            try
            {
                #if DESKTOP
                return client.CreateComputationModel(request);
                #elif CORECLR
                return client.CreateComputationModelAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.IoTSiteWise.Model.CreateComputationModelResponse, NewIOTSWComputationModelCmdlet, object> Select { get; set; } =
