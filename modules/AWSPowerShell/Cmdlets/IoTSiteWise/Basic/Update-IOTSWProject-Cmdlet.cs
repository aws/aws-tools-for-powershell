...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    public partial class UpdateIOTSWProjectCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-IOTSWProject (UpdateProject)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IoTSiteWise.Model.UpdateProjectResponse, UpdateIOTSWProjectCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IoTSiteWise.Model.UpdateProjectRequest();
        ...
        private Amazon.IoTSiteWise.Model.UpdateProjectResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.UpdateProjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT SiteWise", "UpdateProject");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProjectId { get; set; }
            public System.String ProjectName { get; set; }
            public System.Func<Amazon.IoTSiteWise.Model.UpdateProjectResponse, UpdateIOTSWProjectCmdlet, object> Select { get; set; } =
