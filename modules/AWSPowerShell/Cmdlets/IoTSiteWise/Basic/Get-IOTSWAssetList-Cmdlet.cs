...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.AssetSummary or Amazon.IoTSiteWise.Model.ListAssetsResponse",
        ...
        "The service call response (type Amazon.IoTSiteWise.Model.ListAssetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
