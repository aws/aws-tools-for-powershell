...
namespace Amazon.PowerShell.Cmdlets.IOTSW
{
    ...
    [AWSCmdletOutput("Amazon.IoTSiteWise.Model.BatchGetAssetPropertyAggregatesResponse",
        "This cmdlet returns an Amazon.IoTSiteWise.Model.BatchGetAssetPropertyAggregatesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetIOTSWBatchAssetPropertyAggregateCmdlet : AmazonIoTSiteWiseClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoTSiteWise.Model.BatchGetAssetPropertyAggregatesResponse CallAWSServiceOperation(IAmazonIoTSiteWise client, Amazon.IoTSiteWise.Model.BatchGetAssetPropertyAggregatesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchGetAssetPropertyAggregates(request);
                #elif CORECLR
                return client.BatchGetAssetPropertyAggregatesAsync(request).GetAwaiter().GetResult();
                #else
