...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// </summary>
    [Cmdlet("Add", "ESTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddESTagCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ESTag (AddTags)"))
            {
                return;
            }
        ...
        private static Amazon.Elasticsearch.Model.AddTagsResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.AddTagsRequest request)
        {
            #if DESKTOP
