...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch IndexDocuments API operation.", Operation = new[] {"IndexDocuments"}, SelectReturnType = typeof(Amazon.CloudSearch.Model.IndexDocumentsResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudSearch.Model.IndexDocumentsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudSearch.Model.IndexDocumentsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class StartCSIndexCmdlet : AmazonCloudSearchClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "FieldNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudSearch.Model.IndexDocumentsResponse, StartCSIndexCmdlet>(Select) ??
        ...
        private Amazon.CloudSearch.Model.IndexDocumentsResponse CallAWSServiceOperation(IAmazonCloudSearch client, Amazon.CloudSearch.Model.IndexDocumentsRequest request)
        {
            ...
            try
            {
                return client.IndexDocumentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.CloudSearch.Model.IndexDocumentsResponse, StartCSIndexCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FieldNames;
        }
