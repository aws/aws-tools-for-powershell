...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch DeleteSuggester API operation.", Operation = new[] {"DeleteSuggester"}, SelectReturnType = typeof(Amazon.CloudSearch.Model.DeleteSuggesterResponse))]
    [AWSCmdletOutput("Amazon.CloudSearch.Model.SuggesterStatus or Amazon.CloudSearch.Model.DeleteSuggesterResponse",
        "This cmdlet returns an Amazon.CloudSearch.Model.SuggesterStatus object.",
        "The service call response (type Amazon.CloudSearch.Model.DeleteSuggesterResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveCSSuggesterCmdlet : AmazonCloudSearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SuggesterName), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudSearch.Model.DeleteSuggesterResponse, RemoveCSSuggesterCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.SuggesterName == null && ParameterWasBound(nameof(this.SuggesterName)))
            {
                WriteWarning("You are passing $null as a value for parameter SuggesterName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.CloudSearch.Model.DeleteSuggesterResponse CallAWSServiceOperation(IAmazonCloudSearch client, Amazon.CloudSearch.Model.DeleteSuggesterRequest request)
        {
            ...
            try
            {
                return client.DeleteSuggesterAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String SuggesterName { get; set; }
            public System.Func<Amazon.CloudSearch.Model.DeleteSuggesterResponse, RemoveCSSuggesterCmdlet, object> Select { get; set; } =
