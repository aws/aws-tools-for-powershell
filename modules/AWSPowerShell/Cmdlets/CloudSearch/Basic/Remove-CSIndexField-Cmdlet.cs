...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch DeleteIndexField API operation.", Operation = new[] {"DeleteIndexField"}, SelectReturnType = typeof(Amazon.CloudSearch.Model.DeleteIndexFieldResponse))]
    [AWSCmdletOutput("Amazon.CloudSearch.Model.IndexFieldStatus or Amazon.CloudSearch.Model.DeleteIndexFieldResponse",
        "This cmdlet returns an Amazon.CloudSearch.Model.IndexFieldStatus object.",
        "The service call response (type Amazon.CloudSearch.Model.DeleteIndexFieldResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveCSIndexFieldCmdlet : AmazonCloudSearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.IndexFieldName), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudSearch.Model.DeleteIndexFieldResponse, RemoveCSIndexFieldCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.IndexFieldName == null && ParameterWasBound(nameof(this.IndexFieldName)))
            {
                WriteWarning("You are passing $null as a value for parameter IndexFieldName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.CloudSearch.Model.DeleteIndexFieldResponse CallAWSServiceOperation(IAmazonCloudSearch client, Amazon.CloudSearch.Model.DeleteIndexFieldRequest request)
        {
            ...
            try
            {
                return client.DeleteIndexFieldAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String IndexFieldName { get; set; }
            public System.Func<Amazon.CloudSearch.Model.DeleteIndexFieldResponse, RemoveCSIndexFieldCmdlet, object> Select { get; set; } =
