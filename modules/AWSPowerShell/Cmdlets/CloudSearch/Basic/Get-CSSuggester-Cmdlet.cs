...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch DescribeSuggesters API operation.", Operation = new[] {"DescribeSuggesters"}, SelectReturnType = typeof(Amazon.CloudSearch.Model.DescribeSuggestersResponse))]
    [AWSCmdletOutput("Amazon.CloudSearch.Model.SuggesterStatus or Amazon.CloudSearch.Model.DescribeSuggestersResponse",
        "This cmdlet returns a collection of Amazon.CloudSearch.Model.SuggesterStatus objects.",
        "The service call response (type Amazon.CloudSearch.Model.DescribeSuggestersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCSSuggesterCmdlet : AmazonCloudSearchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The suggesters you want to describe.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Suggesters";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudSearch.Model.DescribeSuggestersResponse, GetCSSuggesterCmdlet>(Select) ??
            ...
            {
                context.SuggesterName = new List<System.String>(this.SuggesterName);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                request.SuggesterNames = cmdletContext.SuggesterName;
            }
        ...
        private Amazon.CloudSearch.Model.DescribeSuggestersResponse CallAWSServiceOperation(IAmazonCloudSearch client, Amazon.CloudSearch.Model.DescribeSuggestersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudSearch", "DescribeSuggesters");
            try
            {
                return client.DescribeSuggestersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? Deployed { get; set; }
            public System.String DomainName { get; set; }
            public List<System.String> SuggesterName { get; set; }
            public System.Func<Amazon.CloudSearch.Model.DescribeSuggestersResponse, GetCSSuggesterCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Suggesters;
        }
