...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    /// Developer Guide</i>.
    /// </summary>
    [Cmdlet("Get", "CSDomainEndpointOption")]
    [OutputType("Amazon.CloudSearch.Model.DomainEndpointOptionsStatus")]
    [AWSCmdlet("Calls the Amazon CloudSearch DescribeDomainEndpointOptions API operation.", Operation = new[] {"DescribeDomainEndpointOptions"}, SelectReturnType = typeof(Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse))]
    [AWSCmdletOutput("Amazon.CloudSearch.Model.DomainEndpointOptionsStatus or Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse",
        "This cmdlet returns an Amazon.CloudSearch.Model.DomainEndpointOptionsStatus object.",
        "The service call response (type Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCSDomainEndpointOptionCmdlet : AmazonCloudSearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse, GetCSDomainEndpointOptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsRequest();
        ...
        private Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse CallAWSServiceOperation(IAmazonCloudSearch client, Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsRequest request)
        {
            ...
            try
            {
                return client.DescribeDomainEndpointOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? Deployed { get; set; }
            public System.String DomainName { get; set; }
            public System.Func<Amazon.CloudSearch.Model.DescribeDomainEndpointOptionsResponse, GetCSDomainEndpointOptionCmdlet, object> Select { get; set; } =
