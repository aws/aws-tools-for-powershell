...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch DescribeServiceAccessPolicies API operation.", Operation = new[] {"DescribeServiceAccessPolicies"}, LegacyAlias="Get-CSServiceAccessPolicies")]
