...
namespace Amazon.PowerShell.Cmdlets.CS
{
    ...
    [AWSCmdlet("Calls the Amazon CloudSearch UpdateScalingParameters API operation.", Operation = new[] {"UpdateScalingParameters"}, LegacyAlias="Update-CSScalingParameters")]
