...
namespace Amazon.PowerShell.Cmdlets.EMI
{
    ...
    public partial class NewEMIFeedCmdlet : AmazonElementalInferenceClientCmdlet, IExecutor
    {
        ...
        /// feature. For example, an output might represent the crop feature. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>If you want to include tags, add them now. You won't be able to add them later.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.ElementalInference.Model.CreateFeedResponse CallAWSServiceOperation(IAmazonElementalInference client, Amazon.ElementalInference.Model.CreateFeedRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateFeed(request);
                #elif CORECLR
                return client.CreateFeedAsync(request).GetAwaiter().GetResult();
                #else
