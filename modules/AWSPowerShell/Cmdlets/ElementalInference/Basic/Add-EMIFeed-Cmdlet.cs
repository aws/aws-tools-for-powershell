...
namespace Amazon.PowerShell.Cmdlets.EMI
{
    ...
    public partial class AddEMIFeedCmdlet : AmazonElementalInferenceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An identifier for the resource. This name must not resemble an ARN.</para><para>The resource is the source media that the feed will process. The name you assign should
        /// help you to later identify the source media that belongs to the feed. In this way,
        /// you will know which source media to push to the feed (using PutMedia). </para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Set to true if you want to do a dry run of the associate action.</para><para>Elemental Inference will validate that the real request would succeed without actually
        ...
        /// returns a 4xx error code. After you've fixed the errors, resubmit the request. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>An array of one or more outputs that you want to add to this feed now, to supplement
        /// any outputs that you specified when you created or updated the feed. </para><para />
