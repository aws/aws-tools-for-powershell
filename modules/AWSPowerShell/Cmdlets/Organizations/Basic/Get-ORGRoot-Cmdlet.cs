...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Calls the AWS Organizations ListRoots API operation.", Operation = new[] {"ListRoots"}, SelectReturnType = typeof(Amazon.Organizations.Model.ListRootsResponse))]
    [AWSCmdletOutput("Amazon.Organizations.Model.Root or Amazon.Organizations.Model.ListRootsResponse",
        "This cmdlet returns a collection of Amazon.Organizations.Model.Root objects.",
        "The service call response (type Amazon.Organizations.Model.ListRootsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetORGRootCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Roots";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Organizations.Model.ListRootsResponse, GetORGRootCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Organizations.Model.ListRootsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Roots?.Count ?? 0;
        ...
        private Amazon.Organizations.Model.ListRootsResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListRootsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Organizations", "ListRoots");
            try
            {
                return client.ListRootsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Organizations.Model.ListRootsResponse, GetORGRootCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Roots;
        }
