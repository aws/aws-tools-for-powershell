...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    /// </summary>
    [Cmdlet("Get", "ORGDelegatedServicesForAccountList")]
    [OutputType("Amazon.Organizations.Model.DelegatedService")]
    [AWSCmdlet("Calls the AWS Organizations ListDelegatedServicesForAccount API operation.", Operation = new[] {"ListDelegatedServicesForAccount"}, SelectReturnType = typeof(Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse))]
    [AWSCmdletOutput("Amazon.Organizations.Model.DelegatedService or Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse",
        "This cmdlet returns a collection of Amazon.Organizations.Model.DelegatedService objects.",
        "The service call response (type Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetORGDelegatedServicesForAccountListCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DelegatedServices";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse, GetORGDelegatedServicesForAccountListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Organizations.Model.ListDelegatedServicesForAccountRequest();
        ...
        private Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListDelegatedServicesForAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Organizations", "ListDelegatedServicesForAccount");
            try
            {
                #if DESKTOP
                return client.ListDelegatedServicesForAccount(request);
                #elif CORECLR
                return client.ListDelegatedServicesForAccountAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Organizations.Model.ListDelegatedServicesForAccountResponse, GetORGDelegatedServicesForAccountListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DelegatedServices;
        }
