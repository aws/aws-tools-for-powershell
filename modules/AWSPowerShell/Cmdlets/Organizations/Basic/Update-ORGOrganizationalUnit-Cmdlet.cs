...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdletOutput("Amazon.Organizations.Model.OrganizationalUnit or Amazon.Organizations.Model.UpdateOrganizationalUnitResponse",
        ...
        "The service call response (type Amazon.Organizations.Model.UpdateOrganizationalUnitResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateORGOrganizationalUnitCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ID for the OU that you want to rename. You can get the ID from the <a>ListOrganizationalUnitsForParent</a>
        /// operation.</para><para>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for an organizational
        ...
        private Amazon.Organizations.Model.UpdateOrganizationalUnitResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.UpdateOrganizationalUnitRequest request)
        {
            ...
            try
            {
                return client.UpdateOrganizationalUnitAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
