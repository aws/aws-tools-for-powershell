...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    public partial class NewORGOrganizationCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// AWS GovCloud (US) Region.</para></li><li><para><code>ALL</code>: In addition to all the features that consolidated billing feature
        /// set supports, the master account can also apply any policy type to any member account
