...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    public partial class RemoveORGOrganizationalUnitCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ID for the organizational unit that you want to delete. You can get the ID from the
        /// <a>ListOrganizationalUnitsForParent</a> operation.</para><para>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for an organizational
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Organizations.Model.DeleteOrganizationalUnitResponse, RemoveORGOrganizationalUnitCmdlet>(Select) ??
        ...
        private Amazon.Organizations.Model.DeleteOrganizationalUnitResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.DeleteOrganizationalUnitRequest request)
        {
            ...
            try
            {
                return client.DeleteOrganizationalUnitAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String OrganizationalUnitId { get; set; }
            public System.Func<Amazon.Organizations.Model.DeleteOrganizationalUnitResponse, RemoveORGOrganizationalUnitCmdlet, object> Select { get; set; } =
