...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Calls the AWS Organizations ListOrganizationalUnitsForParent API operation.", Operation = new[] {"ListOrganizationalUnitsForParent"}, SelectReturnType = typeof(Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse))]
    [AWSCmdletOutput("Amazon.Organizations.Model.OrganizationalUnit or Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse",
        "This cmdlet returns a collection of Amazon.Organizations.Model.OrganizationalUnit objects.",
        "The service call response (type Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetORGOrganizationalUnitListCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>ID for the root or OU whose child OUs you want to list.</para><para>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a parent ID string
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse, GetORGOrganizationalUnitListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OrganizationalUnits?.Count ?? 0;
        ...
        private Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListOrganizationalUnitsForParentRequest request)
        {
            ...
            try
            {
                return client.ListOrganizationalUnitsForParentAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ParentId { get; set; }
            public System.Func<Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse, GetORGOrganizationalUnitListCmdlet, object> Select { get; set; } =
