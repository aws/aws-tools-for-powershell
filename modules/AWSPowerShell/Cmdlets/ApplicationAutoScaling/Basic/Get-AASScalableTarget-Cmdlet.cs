...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    public partial class GetAASScalableTargetCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// dimension, you must also specify a resource ID.</para><ul><li><para><c>ecs:service:DesiredCount</c> - The desired task count of an ECS service.</para></li><li><para><c>elasticmapreduce:instancegroup:InstanceCount</c> - The instance count of an EMR
