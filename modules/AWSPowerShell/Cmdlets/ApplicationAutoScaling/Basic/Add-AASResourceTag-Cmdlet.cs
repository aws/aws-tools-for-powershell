...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    [AWSCmdletOutput("None or Amazon.ApplicationAutoScaling.Model.TagResourceResponse",
        ...
        "The service response (type Amazon.ApplicationAutoScaling.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddAASResourceTagCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags assigned to the resource. A tag is a label that you assign to an AWS resource.</para><para>Each tag consists of a tag key and a tag value.</para><para>You cannot have more than one tag on an Application Auto Scaling scalable target with
