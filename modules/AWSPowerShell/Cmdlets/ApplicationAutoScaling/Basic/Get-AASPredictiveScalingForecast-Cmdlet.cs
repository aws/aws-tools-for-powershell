...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "AASPredictiveScalingForecast")]
    [OutputType("Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse")]
    [AWSCmdlet("Calls the Application Auto Scaling GetPredictiveScalingForecast API operation.", Operation = new[] {"GetPredictiveScalingForecast"}, SelectReturnType = typeof(Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse))]
    [AWSCmdletOutput("Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse",
        "This cmdlet returns an Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse object containing multiple properties."
    )]
    public partial class GetAASPredictiveScalingForecastCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// time duration between the start and end time is 30 days. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para> The scalable dimension. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para> The namespace of the Amazon Web Services service that provides the resource. For
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse).
        /// Specifying the name of a property of type Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse, GetAASPredictiveScalingForecastCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastRequest();
        ...
        private Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse CallAWSServiceOperation(IAmazonApplicationAutoScaling client, Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Auto Scaling", "GetPredictiveScalingForecast");
            try
            {
                #if DESKTOP
                return client.GetPredictiveScalingForecast(request);
                #elif CORECLR
                return client.GetPredictiveScalingForecastAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.ApplicationAutoScaling.ServiceNamespace ServiceNamespace { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.ApplicationAutoScaling.Model.GetPredictiveScalingForecastResponse, GetAASPredictiveScalingForecastCmdlet, object> Select { get; set; } =
