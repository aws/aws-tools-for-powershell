...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Application Auto Scaling DeleteScalingPolicy API operation.", Operation = new[] {"DeleteScalingPolicy"}, SelectReturnType = typeof(Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveAASScalingPolicyCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse, RemoveAASScalingPolicyCmdlet>(Select) ??
        ...
        private Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse CallAWSServiceOperation(IAmazonApplicationAutoScaling client, Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyRequest request)
        {
            ...
            try
            {
                return client.DeleteScalingPolicyAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.ApplicationAutoScaling.ScalableDimension ScalableDimension { get; set; }
            public Amazon.ApplicationAutoScaling.ServiceNamespace ServiceNamespace { get; set; }
            public System.Func<Amazon.ApplicationAutoScaling.Model.DeleteScalingPolicyResponse, RemoveAASScalingPolicyCmdlet, object> Select { get; set; } =
