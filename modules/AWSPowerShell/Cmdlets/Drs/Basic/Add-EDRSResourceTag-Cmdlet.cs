...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// </summary>
    [Cmdlet("Add", "EDRSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddEDRSResourceTagCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Array of tags to be added or updated.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-EDRSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.TagResourceResponse, AddEDRSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.TagResourceRequest();
        ...
        private Amazon.Drs.Model.TagResourceResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Drs.Model.TagResourceResponse, AddEDRSResourceTagCmdlet, object> Select { get; set; } =
