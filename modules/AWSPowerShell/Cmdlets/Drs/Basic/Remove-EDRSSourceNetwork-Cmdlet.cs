...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EDRSSourceNetwork", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEDRSSourceNetworkCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EDRSSourceNetwork (DeleteSourceNetwork)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.DeleteSourceNetworkResponse, RemoveEDRSSourceNetworkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.DeleteSourceNetworkRequest();
        ...
        private Amazon.Drs.Model.DeleteSourceNetworkResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.DeleteSourceNetworkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "DeleteSourceNetwork");
            try
            {
                #if DESKTOP
                return client.DeleteSourceNetwork(request);
                #elif CORECLR
                return client.DeleteSourceNetworkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SourceNetworkID { get; set; }
            public System.Func<Amazon.Drs.Model.DeleteSourceNetworkResponse, RemoveEDRSSourceNetworkCmdlet, object> Select { get; set; } =
