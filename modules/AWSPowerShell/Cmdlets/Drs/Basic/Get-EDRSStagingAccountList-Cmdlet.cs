...
{
    /// <summary>
    /// Returns an array of staging accounts for existing extended source servers.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEDRSStagingAccountListCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Drs.Model.ListStagingAccountsResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.ListStagingAccountsRequest request)
        {
            ...
            try
            {
                return client.ListStagingAccountsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
