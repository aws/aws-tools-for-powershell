...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// server on the Account we’re reading from is not an extension of another source server.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEDRSExtensibleSourceServerListCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Drs.Model.ListExtensibleSourceServersResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.ListExtensibleSourceServersRequest request)
        {
            ...
            try
            {
                return client.ListExtensibleSourceServersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
