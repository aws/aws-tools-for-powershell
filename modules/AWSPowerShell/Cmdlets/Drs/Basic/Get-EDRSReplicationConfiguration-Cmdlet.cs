...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "EDRSReplicationConfiguration")]
    [OutputType("Amazon.Drs.Model.GetReplicationConfigurationResponse")]
    [AWSCmdlet("Calls the Elastic Disaster Recovery Service GetReplicationConfiguration API operation.", Operation = new[] {"GetReplicationConfiguration"}, SelectReturnType = typeof(Amazon.Drs.Model.GetReplicationConfigurationResponse))]
    [AWSCmdletOutput("Amazon.Drs.Model.GetReplicationConfigurationResponse",
        "This cmdlet returns an Amazon.Drs.Model.GetReplicationConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEDRSReplicationConfigurationCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.GetReplicationConfigurationResponse, GetEDRSReplicationConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.GetReplicationConfigurationRequest();
        ...
        private Amazon.Drs.Model.GetReplicationConfigurationResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.GetReplicationConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "GetReplicationConfiguration");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Drs.Model.GetReplicationConfigurationResponse, GetEDRSReplicationConfigurationCmdlet, object> Select { get; set; } =
