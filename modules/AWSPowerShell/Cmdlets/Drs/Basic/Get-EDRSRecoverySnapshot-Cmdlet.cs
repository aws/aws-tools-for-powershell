...
{
    /// <summary>
    /// Lists all Recovery Snapshots for a single Source Server.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEDRSRecoverySnapshotCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Drs.Model.DescribeRecoverySnapshotsResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.DescribeRecoverySnapshotsRequest request)
        {
            ...
            try
            {
                return client.DescribeRecoverySnapshotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
