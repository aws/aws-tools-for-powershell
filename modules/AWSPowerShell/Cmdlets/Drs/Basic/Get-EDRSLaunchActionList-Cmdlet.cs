...
{
    /// <summary>
    /// Lists resource launch actions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEDRSLaunchActionListCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Launch actions Ids.</para><para />
        ...
        private Amazon.Drs.Model.ListLaunchActionsResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.ListLaunchActionsRequest request)
        {
            ...
            try
            {
                return client.ListLaunchActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
