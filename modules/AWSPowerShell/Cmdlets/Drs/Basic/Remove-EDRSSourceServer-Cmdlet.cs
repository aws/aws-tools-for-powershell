...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EDRSSourceServer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveEDRSSourceServerCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EDRSSourceServer (DeleteSourceServer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.DeleteSourceServerResponse, RemoveEDRSSourceServerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.DeleteSourceServerRequest();
        ...
        private Amazon.Drs.Model.DeleteSourceServerResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.DeleteSourceServerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "DeleteSourceServer");
            try
            {
                return client.DeleteSourceServerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Drs.Model.DeleteSourceServerResponse, RemoveEDRSSourceServerCmdlet, object> Select { get; set; } =
