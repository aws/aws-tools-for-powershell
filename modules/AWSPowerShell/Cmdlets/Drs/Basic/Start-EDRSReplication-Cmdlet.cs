...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// </summary>
    [Cmdlet("Start", "EDRSReplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Drs.Model.SourceServer")]
    [AWSCmdlet("Calls the Elastic Disaster Recovery Service StartReplication API operation.", Operation = new[] {"StartReplication"}, SelectReturnType = typeof(Amazon.Drs.Model.StartReplicationResponse))]
    [AWSCmdletOutput("Amazon.Drs.Model.SourceServer or Amazon.Drs.Model.StartReplicationResponse",
        "This cmdlet returns an Amazon.Drs.Model.SourceServer object.",
        "The service call response (type Amazon.Drs.Model.StartReplicationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartEDRSReplicationCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-EDRSReplication (StartReplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.StartReplicationResponse, StartEDRSReplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.StartReplicationRequest();
        ...
        private Amazon.Drs.Model.StartReplicationResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.StartReplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "StartReplication");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SourceServerID { get; set; }
            public System.Func<Amazon.Drs.Model.StartReplicationResponse, StartEDRSReplicationCmdlet, object> Select { get; set; } =
