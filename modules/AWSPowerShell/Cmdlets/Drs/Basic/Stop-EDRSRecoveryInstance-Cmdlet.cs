...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// service.
    /// </summary>
    [Cmdlet("Stop", "EDRSRecoveryInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopEDRSRecoveryInstanceCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IDs of the Recovery Instances that should be terminated.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RecoveryInstanceIDs), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-EDRSRecoveryInstance (TerminateRecoveryInstances)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Drs.Model.TerminateRecoveryInstancesResponse, StopEDRSRecoveryInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Drs.Model.TerminateRecoveryInstancesRequest();
        ...
        private Amazon.Drs.Model.TerminateRecoveryInstancesResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.TerminateRecoveryInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Elastic Disaster Recovery Service", "TerminateRecoveryInstances");
            try
            {
                return client.TerminateRecoveryInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Drs.Model.TerminateRecoveryInstancesResponse, StopEDRSRecoveryInstanceCmdlet, object> Select { get; set; } =
