...
namespace Amazon.PowerShell.Cmdlets.EDRS
{
    ...
    /// IDs<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEDRSLaunchConfigurationTemplateCmdlet : AmazonDrsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Drs.Model.DescribeLaunchConfigurationTemplatesResponse CallAWSServiceOperation(IAmazonDrs client, Amazon.Drs.Model.DescribeLaunchConfigurationTemplatesRequest request)
        {
            ...
            try
            {
                return client.DescribeLaunchConfigurationTemplatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
