#
# Module manifest for module 'AWS.Tools.AIOps'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.AIOps.dll'
    ...
    GUID = '8665a852-0028-4d0f-86ff-3a6ab2d39864'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.AIOps.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.AIOps.Completers.psm1',
        'AWS.Tools.AIOps.Aliases.psm1'
    )
