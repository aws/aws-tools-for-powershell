...
namespace Amazon.PowerShell.Cmdlets.ABC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ABCBillingGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveABCBillingGroupCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ABCBillingGroup (DeleteBillingGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BillingConductor.Model.DeleteBillingGroupResponse, RemoveABCBillingGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BillingConductor.Model.DeleteBillingGroupRequest();
        ...
        private Amazon.BillingConductor.Model.DeleteBillingGroupResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.DeleteBillingGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSBillingConductor", "DeleteBillingGroup");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.BillingConductor.Model.DeleteBillingGroupResponse, RemoveABCBillingGroupCmdlet, object> Select { get; set; } =
