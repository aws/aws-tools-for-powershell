...
namespace Amazon.PowerShell.Cmdlets.ABC
{
    ...
    /// not changed.
    /// </summary>
    [Cmdlet("Add", "ABCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddABCResourceTagCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The tags to add to the resource as a list of key-value pairs. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ABCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BillingConductor.Model.TagResourceResponse, AddABCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BillingConductor.Model.TagResourceRequest();
        ...
        private Amazon.BillingConductor.Model.TagResourceResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSBillingConductor", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BillingConductor.Model.TagResourceResponse, AddABCResourceTagCmdlet, object> Select { get; set; } =
