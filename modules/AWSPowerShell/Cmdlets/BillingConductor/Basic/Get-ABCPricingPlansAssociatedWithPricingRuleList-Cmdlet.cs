...
{
    /// <summary>
    /// A list of the pricing plans that are associated with a pricing rule.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetABCPricingPlansAssociatedWithPricingRuleListCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        private Amazon.BillingConductor.Model.ListPricingPlansAssociatedWithPricingRuleResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.ListPricingPlansAssociatedWithPricingRuleRequest request)
        {
            ...
            try
            {
                return client.ListPricingPlansAssociatedWithPricingRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
