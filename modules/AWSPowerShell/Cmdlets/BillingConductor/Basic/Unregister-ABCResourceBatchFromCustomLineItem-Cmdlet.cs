...
namespace Amazon.PowerShell.Cmdlets.ABC
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "ABCResourceBatchFromCustomLineItem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UnregisterABCResourceBatchFromCustomLineItemCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-ABCResourceBatchFromCustomLineItem (BatchDisassociateResourcesFromCustomLineItem)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BillingConductor.Model.BatchDisassociateResourcesFromCustomLineItemRequest();
        ...
        private Amazon.BillingConductor.Model.BatchDisassociateResourcesFromCustomLineItemResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.BatchDisassociateResourcesFromCustomLineItemRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TargetArn { get; set; }
            public System.Func<Amazon.BillingConductor.Model.BatchDisassociateResourcesFromCustomLineItemResponse, UnregisterABCResourceBatchFromCustomLineItemCmdlet, object> Select { get; set; } =
