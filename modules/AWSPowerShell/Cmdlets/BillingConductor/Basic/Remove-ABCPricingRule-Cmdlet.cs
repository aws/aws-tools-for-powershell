...
namespace Amazon.PowerShell.Cmdlets.ABC
{
    ...
    public partial class RemoveABCPricingRuleCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ABCPricingRule (DeletePricingRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BillingConductor.Model.DeletePricingRuleResponse, RemoveABCPricingRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BillingConductor.Model.DeletePricingRuleRequest();
        ...
        private Amazon.BillingConductor.Model.DeletePricingRuleResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.DeletePricingRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSBillingConductor", "DeletePricingRule");
            try
            {
                #if DESKTOP
                return client.DeletePricingRule(request);
                #elif CORECLR
                return client.DeletePricingRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.BillingConductor.Model.DeletePricingRuleResponse, RemoveABCPricingRuleCmdlet, object> Select { get; set; } =
