...
namespace Amazon.PowerShell.Cmdlets.ABC
{
    ...
    /// </summary>
    [Cmdlet("Register", "ABCAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class RegisterABCAccountCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-ABCAccount (AssociateAccounts)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BillingConductor.Model.AssociateAccountsResponse, RegisterABCAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BillingConductor.Model.AssociateAccountsRequest();
        ...
        private Amazon.BillingConductor.Model.AssociateAccountsResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.AssociateAccountsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSBillingConductor", "AssociateAccounts");
            try
            {
                #if DESKTOP
                return client.AssociateAccounts(request);
                #elif CORECLR
                return client.AssociateAccountsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Arn { get; set; }
            public System.Func<Amazon.BillingConductor.Model.AssociateAccountsResponse, RegisterABCAccountCmdlet, object> Select { get; set; } =
