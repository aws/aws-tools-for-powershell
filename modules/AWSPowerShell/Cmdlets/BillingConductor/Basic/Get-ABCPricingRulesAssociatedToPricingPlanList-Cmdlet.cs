...
{
    /// <summary>
    /// Lists the pricing rules that are associated with a pricing plan.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetABCPricingRulesAssociatedToPricingPlanListCmdlet : AmazonBillingConductorClientCmdlet, IExecutor
    {
        ...
        private Amazon.BillingConductor.Model.ListPricingRulesAssociatedToPricingPlanResponse CallAWSServiceOperation(IAmazonBillingConductor client, Amazon.BillingConductor.Model.ListPricingRulesAssociatedToPricingPlanRequest request)
        {
            ...
            try
            {
                return client.ListPricingRulesAssociatedToPricingPlanAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
