...
namespace Amazon.PowerShell.Cmdlets.ETS
{
    ...
    public partial class StopETSJobCmdlet : AmazonElasticTranscoderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the job that you want to cancel.</para><para>To get a list of the jobs (including their <c>jobId</c>) that have a status of <c>Submitted</c>,
        /// use the <a>ListJobsByStatus</a> API action.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticTranscoder.Model.CancelJobResponse, StopETSJobCmdlet>(Select) ??
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ElasticTranscoder.Model.CancelJobResponse, StopETSJobCmdlet, object> Select { get; set; } =
