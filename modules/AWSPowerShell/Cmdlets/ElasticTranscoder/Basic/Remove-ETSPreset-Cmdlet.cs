...
namespace Amazon.PowerShell.Cmdlets.ETS
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "ETSPreset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveETSPresetCmdlet : AmazonElasticTranscoderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ETSPreset (DeletePreset)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ElasticTranscoder.Model.DeletePresetResponse, RemoveETSPresetCmdlet>(Select) ??
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.ElasticTranscoder.Model.DeletePresetResponse, RemoveETSPresetCmdlet, object> Select { get; set; } =
