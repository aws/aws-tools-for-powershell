...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "DSYNLocationList")]
    [OutputType("Amazon.DataSync.Model.LocationListEntry")]
    [AWSCmdlet("Calls the AWS DataSync ListLocations API operation.", Operation = new[] {"ListLocations"}, SelectReturnType = typeof(Amazon.DataSync.Model.ListLocationsResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.LocationListEntry or Amazon.DataSync.Model.ListLocationsResponse",
        "This cmdlet returns a collection of Amazon.DataSync.Model.LocationListEntry objects.",
        "The service call response (type Amazon.DataSync.Model.ListLocationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSYNLocationListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        /// with filter name <c>LocationType S3</c> and <c>Operator Equals</c>.</para><para />
