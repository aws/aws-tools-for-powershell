...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdletOutput("Amazon.DataSync.Model.LocationListEntry or Amazon.DataSync.Model.ListLocationsResponse",
        ...
        "The service call response (type Amazon.DataSync.Model.ListLocationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
