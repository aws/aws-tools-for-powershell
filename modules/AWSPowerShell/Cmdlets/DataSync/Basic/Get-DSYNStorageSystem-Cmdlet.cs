...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    public partial class GetDSYNStorageSystemCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.DescribeStorageSystemResponse, GetDSYNStorageSystemCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataSync.Model.DescribeStorageSystemRequest();
        ...
        private Amazon.DataSync.Model.DescribeStorageSystemResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DescribeStorageSystemRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "DescribeStorageSystem");
            try
            {
                #if DESKTOP
                return client.DescribeStorageSystem(request);
                #elif CORECLR
                return client.DescribeStorageSystemAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StorageSystemArn { get; set; }
            public System.Func<Amazon.DataSync.Model.DescribeStorageSystemResponse, GetDSYNStorageSystemCmdlet, object> Select { get; set; } =
