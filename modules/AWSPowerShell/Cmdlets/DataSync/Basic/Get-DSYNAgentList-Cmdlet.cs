...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [OutputType("Amazon.DataSync.Model.AgentListEntry")]
    [AWSCmdlet("Calls the AWS DataSync ListAgents API operation.", Operation = new[] {"ListAgents"}, SelectReturnType = typeof(Amazon.DataSync.Model.ListAgentsResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.AgentListEntry or Amazon.DataSync.Model.ListAgentsResponse",
        "This cmdlet returns a collection of Amazon.DataSync.Model.AgentListEntry objects.",
        "The service call response (type Amazon.DataSync.Model.ListAgentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNAgentListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Agents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.ListAgentsResponse, GetDSYNAgentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataSync.Model.ListAgentsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Agents?.Count ?? 0;
        ...
        private Amazon.DataSync.Model.ListAgentsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.ListAgentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "ListAgents");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.DataSync.Model.ListAgentsResponse, GetDSYNAgentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Agents;
        }
