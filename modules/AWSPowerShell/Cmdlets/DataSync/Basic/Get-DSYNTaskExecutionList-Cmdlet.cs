...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync ListTaskExecutions API operation.", Operation = new[] {"ListTaskExecutions"}, SelectReturnType = typeof(Amazon.DataSync.Model.ListTaskExecutionsResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.TaskExecutionListEntry or Amazon.DataSync.Model.ListTaskExecutionsResponse",
        "This cmdlet returns a collection of Amazon.DataSync.Model.TaskExecutionListEntry objects.",
        "The service call response (type Amazon.DataSync.Model.ListTaskExecutionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNTaskExecutionListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TaskExecutions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.ListTaskExecutionsResponse, GetDSYNTaskExecutionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataSync.Model.ListTaskExecutionsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TaskExecutions?.Count ?? 0;
        ...
        private Amazon.DataSync.Model.ListTaskExecutionsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.ListTaskExecutionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "ListTaskExecutions");
            try
            {
                #if DESKTOP
                return client.ListTaskExecutions(request);
                #elif CORECLR
                return client.ListTaskExecutionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TaskArn { get; set; }
            public System.Func<Amazon.DataSync.Model.ListTaskExecutionsResponse, GetDSYNTaskExecutionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TaskExecutions;
        }
