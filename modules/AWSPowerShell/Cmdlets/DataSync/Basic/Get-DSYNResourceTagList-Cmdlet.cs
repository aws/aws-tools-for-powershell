...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.DataSync.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.TagListEntry or Amazon.DataSync.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.DataSync.Model.TagListEntry objects.",
        "The service call response (type Amazon.DataSync.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetDSYNResourceTagListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.ListTagsForResourceResponse, GetDSYNResourceTagListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.DataSync.Model.ListTagsForResourceResponse, GetDSYNResourceTagListCmdlet, object> Select { get; set; } =
