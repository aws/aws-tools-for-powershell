...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "DSYNTaskList")]
    [OutputType("Amazon.DataSync.Model.TaskListEntry")]
    [AWSCmdlet("Calls the AWS DataSync ListTasks API operation.", Operation = new[] {"ListTasks"}, SelectReturnType = typeof(Amazon.DataSync.Model.ListTasksResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.TaskListEntry or Amazon.DataSync.Model.ListTasksResponse",
        "This cmdlet returns a collection of Amazon.DataSync.Model.TaskListEntry objects.",
        "The service call response (type Amazon.DataSync.Model.ListTasksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNTaskListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataSync.Model.ListTasksResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.ListTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "ListTasks");
            try
            {
                #if DESKTOP
