...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdletOutput("Amazon.DataSync.Model.DiscoveryJobListEntry or Amazon.DataSync.Model.ListDiscoveryJobsResponse",
        ...
        "The service call response (type Amazon.DataSync.Model.ListDiscoveryJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
