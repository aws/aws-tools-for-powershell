...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdletOutput("System.String or Amazon.DataSync.Model.AddStorageSystemResponse",
        ...
        "The service call response (type Amazon.DataSync.Model.AddStorageSystemResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddDSYNStorageSystemCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SystemType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.SystemType;
            }
        ...
        private Amazon.DataSync.Model.AddStorageSystemResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.AddStorageSystemRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.AddStorageSystem(request);
                #elif CORECLR
                return client.AddStorageSystemAsync(request).GetAwaiter().GetResult();
                #else
