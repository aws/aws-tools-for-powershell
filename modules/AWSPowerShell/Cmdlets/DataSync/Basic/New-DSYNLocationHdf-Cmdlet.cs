...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    public partial class NewDSYNLocationHdfCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        /// the file's address.</para><note><para>If <c>KERBEROS</c> is specified for <c>AuthenticationType</c>, this parameter is required.
        /// </para></note>
        /// </para>
        ...
        /// information to map blocks of data to the DataNodes.</para><para>The number of NameNodes you can specify depends on the task mode:</para><ul><li><para><b>Enhanced mode</b> – You can specify multiple NameNodes for HDFS High Availability
        /// (HA) configurations.</para></li><li><para><b>Basic mode</b> – You can specify only one NameNode.</para></li></ul><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// value can be an empty string. We recommend using tags to name your resources. </para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.DataSync.Model.CreateLocationHdfsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.CreateLocationHdfsRequest request)
        {
            ...
            try
            {
                return client.CreateLocationHdfsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
