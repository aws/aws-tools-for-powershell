...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync DescribeLocationHdfs API operation.", Operation = new[] {"DescribeLocationHdfs"}, SelectReturnType = typeof(Amazon.DataSync.Model.DescribeLocationHdfsResponse))]
    [AWSCmdletOutput("Amazon.DataSync.Model.DescribeLocationHdfsResponse",
        "This cmdlet returns an Amazon.DataSync.Model.DescribeLocationHdfsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNLocationHdfCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.DescribeLocationHdfsResponse, GetDSYNLocationHdfCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DataSync.Model.DescribeLocationHdfsRequest();
        ...
        private Amazon.DataSync.Model.DescribeLocationHdfsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DescribeLocationHdfsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "DescribeLocationHdfs");
            try
            {
                #if DESKTOP
                return client.DescribeLocationHdfs(request);
                #elif CORECLR
                return client.DescribeLocationHdfsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String LocationArn { get; set; }
            public System.Func<Amazon.DataSync.Model.DescribeLocationHdfsResponse, GetDSYNLocationHdfCmdlet, object> Select { get; set; } =
