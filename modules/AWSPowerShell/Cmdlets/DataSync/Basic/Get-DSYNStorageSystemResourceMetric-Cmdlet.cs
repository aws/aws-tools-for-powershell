...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    /// </summary>
    [Cmdlet("Get", "DSYNStorageSystemResourceMetric")]
    [OutputType("Amazon.DataSync.Model.ResourceMetrics")]
    ...
    public partial class GetDSYNStorageSystemResourceMetricCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.DataSync.Model.DescribeStorageSystemResourceMetricsResponse, GetDSYNStorageSystemResourceMetricCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.DataSync.Model.DescribeStorageSystemResourceMetricsRequest();
        ...
        private Amazon.DataSync.Model.DescribeStorageSystemResourceMetricsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DescribeStorageSystemResourceMetricsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS DataSync", "DescribeStorageSystemResourceMetrics");
            try
            {
                #if DESKTOP
                return client.DescribeStorageSystemResourceMetrics(request);
                #elif CORECLR
                return client.DescribeStorageSystemResourceMetricsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.DataSync.DiscoveryResourceType ResourceType { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.DataSync.Model.DescribeStorageSystemResourceMetricsResponse, GetDSYNStorageSystemResourceMetricCmdlet, object> Select { get; set; } =
