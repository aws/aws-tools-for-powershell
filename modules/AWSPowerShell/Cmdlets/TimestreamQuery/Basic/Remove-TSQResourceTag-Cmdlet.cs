...
namespace Amazon.PowerShell.Cmdlets.TSQ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "TSQResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveTSQResourceTagCmdlet : AmazonTimestreamQueryClientCmdlet, IExecutor
    {
        ...
        /// list will be removed from the Timestream resource. </para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TSQResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TimestreamQuery.Model.UntagResourceResponse, RemoveTSQResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TimestreamQuery.Model.UntagResourceRequest();
        ...
        private Amazon.TimestreamQuery.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonTimestreamQuery client, Amazon.TimestreamQuery.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Timestream Query", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.TimestreamQuery.Model.UntagResourceResponse, RemoveTSQResourceTagCmdlet, object> Select { get; set; } =
