...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// clusters.
    /// </summary>
    [Cmdlet("Remove", "MDBUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveMDBUserCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MDBUser (DeleteUser)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.DeleteUserResponse, RemoveMDBUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.DeleteUserRequest();
        ...
        private Amazon.MemoryDB.Model.DeleteUserResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DeleteUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "DeleteUser");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String UserName { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DeleteUserResponse, RemoveMDBUserCmdlet, object> Select { get; set; } =
