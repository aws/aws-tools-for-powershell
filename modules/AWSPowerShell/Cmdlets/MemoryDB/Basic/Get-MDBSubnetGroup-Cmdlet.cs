...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// the list contains only the description of that group.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "MDBSubnetGroup")]
    ...
    public partial class GetMDBSubnetGroupCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MemoryDB.Model.DescribeSubnetGroupsRequest();
        ...
        private Amazon.MemoryDB.Model.DescribeSubnetGroupsResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DescribeSubnetGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "DescribeSubnetGroups");
            try
            {
                return client.DescribeSubnetGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SubnetGroupName { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DescribeSubnetGroupsResponse, GetMDBSubnetGroupCmdlet, object> Select { get; set; } =
