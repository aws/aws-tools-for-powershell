...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// </summary>
    [Cmdlet("Get", "MDBCluster")]
    [OutputType("Amazon.MemoryDB.Model.Cluster")]
    [AWSCmdlet("Calls the Amazon MemoryDB DescribeClusters API operation.", Operation = new[] {"DescribeClusters"}, SelectReturnType = typeof(Amazon.MemoryDB.Model.DescribeClustersResponse))]
    [AWSCmdletOutput("Amazon.MemoryDB.Model.Cluster or Amazon.MemoryDB.Model.DescribeClustersResponse",
        "This cmdlet returns a collection of Amazon.MemoryDB.Model.Cluster objects.",
        "The service call response (type Amazon.MemoryDB.Model.DescribeClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMDBClusterCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        #region Parameter ShowShardDetail
        /// <summary>
        /// <para>
        ...
        [Alias("ShowShardDetails")]
        public System.Boolean? ShowShardDetail { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.DescribeClustersResponse, GetMDBClusterCmdlet>(Select) ??
            ...
            context.ShowShardDetail = this.ShowShardDetail;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.DescribeClustersRequest();
            ...
            if (cmdletContext.ShowShardDetail != null)
            {
                request.ShowShardDetails = cmdletContext.ShowShardDetail.Value;
            }
        ...
        private Amazon.MemoryDB.Model.DescribeClustersResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DescribeClustersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "DescribeClusters");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.Boolean? ShowShardDetail { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DescribeClustersResponse, GetMDBClusterCmdlet, object> Select { get; set; } =
