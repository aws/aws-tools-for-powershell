...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MDBMultiRegionCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.MemoryDB.Model.MultiRegionCluster")]
    [AWSCmdlet("Calls the Amazon MemoryDB DeleteMultiRegionCluster API operation.", Operation = new[] {"DeleteMultiRegionCluster"}, SelectReturnType = typeof(Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse))]
    [AWSCmdletOutput("Amazon.MemoryDB.Model.MultiRegionCluster or Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse",
        "This cmdlet returns an Amazon.MemoryDB.Model.MultiRegionCluster object.",
        "The service call response (type Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveMDBMultiRegionClusterCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse).
        /// Specifying the name of a property of type Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MDBMultiRegionCluster (DeleteMultiRegionCluster)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.DeleteMultiRegionClusterRequest();
        ...
        private Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DeleteMultiRegionClusterRequest request)
        {
        ...
        {
            public System.String MultiRegionClusterName { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DeleteMultiRegionClusterResponse, RemoveMDBMultiRegionClusterCmdlet, object> Select { get; set; } =
