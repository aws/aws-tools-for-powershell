...
{
    /// <summary>
    /// Returns the detailed parameter list for a particular parameter group.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "MDBParameter")]
    [OutputType("Amazon.MemoryDB.Model.Parameter")]
    [AWSCmdlet("Calls the Amazon MemoryDB DescribeParameters API operation.", Operation = new[] {"DescribeParameters"}, SelectReturnType = typeof(Amazon.MemoryDB.Model.DescribeParametersResponse))]
    [AWSCmdletOutput("Amazon.MemoryDB.Model.Parameter or Amazon.MemoryDB.Model.DescribeParametersResponse",
        "This cmdlet returns a collection of Amazon.MemoryDB.Model.Parameter objects.",
        "The service call response (type Amazon.MemoryDB.Model.DescribeParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMDBParameterCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.DescribeParametersResponse, GetMDBParameterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MemoryDB.Model.DescribeParametersRequest();
        ...
        private Amazon.MemoryDB.Model.DescribeParametersResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DescribeParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "DescribeParameters");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ParameterGroupName { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DescribeParametersResponse, GetMDBParameterCmdlet, object> Select { get; set; } =
