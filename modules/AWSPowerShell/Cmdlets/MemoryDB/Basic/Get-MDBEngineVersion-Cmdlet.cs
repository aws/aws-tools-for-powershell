...
{
    /// <summary>
    /// Returns a list of the available Redis OSS engine versions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMDBEngineVersionCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        private Amazon.MemoryDB.Model.DescribeEngineVersionsResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DescribeEngineVersionsRequest request)
        {
            ...
            try
            {
                return client.DescribeEngineVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
