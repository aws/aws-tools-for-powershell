...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    public partial class RemoveMDBClusterCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MDBCluster (DeleteCluster)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.DeleteClusterRequest();
        ...
        private Amazon.MemoryDB.Model.DeleteClusterResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DeleteClusterRequest request)
        {
