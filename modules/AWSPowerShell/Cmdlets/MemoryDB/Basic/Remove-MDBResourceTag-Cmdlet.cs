...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    public partial class RemoveMDBResourceTagCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of keys of the tags that are to be removed.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MDBResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.UntagResourceResponse, RemoveMDBResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.UntagResourceRequest();
        ...
        private Amazon.MemoryDB.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MemoryDB.Model.UntagResourceResponse, RemoveMDBResourceTagCmdlet, object> Select { get; set; } =
