...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    public partial class UpdateMDBUpdateClusterBatchCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ServiceUpdate_ServiceUpdateNameToApply' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ServiceUpdate_ServiceUpdateNameToApply;
            }
