...
{
    /// <summary>
    /// Returns details of the service updates.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetMDBServiceUpdateCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        private Amazon.MemoryDB.Model.DescribeServiceUpdatesResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DescribeServiceUpdatesRequest request)
        {
            ...
            try
            {
                return client.DescribeServiceUpdatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
