...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// </summary>
    [Cmdlet("New", "MDBSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MemoryDB.Model.Snapshot")]
    [AWSCmdlet("Calls the Amazon MemoryDB CreateSnapshot API operation.", Operation = new[] {"CreateSnapshot"}, SelectReturnType = typeof(Amazon.MemoryDB.Model.CreateSnapshotResponse))]
    [AWSCmdletOutput("Amazon.MemoryDB.Model.Snapshot or Amazon.MemoryDB.Model.CreateSnapshotResponse",
        "This cmdlet returns an Amazon.MemoryDB.Model.Snapshot object.",
        "The service call response (type Amazon.MemoryDB.Model.CreateSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewMDBSnapshotCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-MDBSnapshot (CreateSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.CreateSnapshotResponse, NewMDBSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.CreateSnapshotRequest();
        ...
        private Amazon.MemoryDB.Model.CreateSnapshotResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.CreateSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "CreateSnapshot");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.MemoryDB.Model.CreateSnapshotResponse, NewMDBSnapshotCmdlet, object> Select { get; set; } =
