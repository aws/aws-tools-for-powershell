...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    public partial class NewMDBMultiRegionClusterCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A suffix to be added to the multi-Region cluster name.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the MultiRegionClusterNameSuffix parameter.
        /// The -PassThru parameter is deprecated, use -Select '^MultiRegionClusterNameSuffix' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MultiRegionClusterNameSuffix' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.MultiRegionClusterNameSuffix;
            }
        ...
        private Amazon.MemoryDB.Model.CreateMultiRegionClusterResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.CreateMultiRegionClusterRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateMultiRegionCluster(request);
                #elif CORECLR
                return client.CreateMultiRegionClusterAsync(request).GetAwaiter().GetResult();
                #else
