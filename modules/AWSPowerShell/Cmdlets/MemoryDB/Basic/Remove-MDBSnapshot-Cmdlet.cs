...
namespace Amazon.PowerShell.Cmdlets.MDB
{
    ...
    /// operation.
    /// </summary>
    [Cmdlet("Remove", "MDBSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.MemoryDB.Model.Snapshot")]
    [AWSCmdlet("Calls the Amazon MemoryDB DeleteSnapshot API operation.", Operation = new[] {"DeleteSnapshot"}, SelectReturnType = typeof(Amazon.MemoryDB.Model.DeleteSnapshotResponse))]
    [AWSCmdletOutput("Amazon.MemoryDB.Model.Snapshot or Amazon.MemoryDB.Model.DeleteSnapshotResponse",
        "This cmdlet returns an Amazon.MemoryDB.Model.Snapshot object.",
        "The service call response (type Amazon.MemoryDB.Model.DeleteSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveMDBSnapshotCmdlet : AmazonMemoryDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MDBSnapshot (DeleteSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MemoryDB.Model.DeleteSnapshotResponse, RemoveMDBSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MemoryDB.Model.DeleteSnapshotRequest();
        ...
        private Amazon.MemoryDB.Model.DeleteSnapshotResponse CallAWSServiceOperation(IAmazonMemoryDB client, Amazon.MemoryDB.Model.DeleteSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MemoryDB", "DeleteSnapshot");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SnapshotName { get; set; }
            public System.Func<Amazon.MemoryDB.Model.DeleteSnapshotResponse, RemoveMDBSnapshotCmdlet, object> Select { get; set; } =
