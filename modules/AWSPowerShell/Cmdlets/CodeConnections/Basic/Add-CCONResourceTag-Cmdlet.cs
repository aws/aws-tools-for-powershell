...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("Add", "CCONResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddCCONResourceTagCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags you want to modify or add to the resource.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.TagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CCONResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.TagResourceResponse, AddCCONResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.TagResourceRequest();
        ...
        private Amazon.CodeConnections.Model.TagResourceResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeConnections.Model.TagResourceResponse, AddCCONResourceTagCmdlet, object> Select { get; set; } =
