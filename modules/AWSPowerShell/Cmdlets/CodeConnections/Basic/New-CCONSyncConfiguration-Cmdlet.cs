...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("New", "CCONSyncConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CodeConnections.Model.SyncConfiguration")]
    [AWSCmdlet("Calls the AWS CodeConnections CreateSyncConfiguration API operation.", Operation = new[] {"CreateSyncConfiguration"}, SelectReturnType = typeof(Amazon.CodeConnections.Model.CreateSyncConfigurationResponse))]
    [AWSCmdletOutput("Amazon.CodeConnections.Model.SyncConfiguration or Amazon.CodeConnections.Model.CreateSyncConfigurationResponse",
        "This cmdlet returns an Amazon.CodeConnections.Model.SyncConfiguration object.",
        "The service call response (type Amazon.CodeConnections.Model.CreateSyncConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCCONSyncConfigurationCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.CreateSyncConfigurationResponse).
        /// Specifying the name of a property of type Amazon.CodeConnections.Model.CreateSyncConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CCONSyncConfiguration (CreateSyncConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.CreateSyncConfigurationResponse, NewCCONSyncConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.CreateSyncConfigurationRequest();
        ...
        private Amazon.CodeConnections.Model.CreateSyncConfigurationResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.CreateSyncConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "CreateSyncConfiguration");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.CodeConnections.SyncConfigurationType SyncType { get; set; }
            public Amazon.CodeConnections.TriggerResourceUpdateOn TriggerResourceUpdateOn { get; set; }
            public System.Func<Amazon.CodeConnections.Model.CreateSyncConfigurationResponse, NewCCONSyncConfigurationCmdlet, object> Select { get; set; } =
