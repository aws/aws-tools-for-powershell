...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("Update", "CCONHost", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateCCONHostCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.UpdateHostResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CCONHost (UpdateHost)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.UpdateHostResponse, UpdateCCONHostCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.UpdateHostRequest();
        ...
        private Amazon.CodeConnections.Model.UpdateHostResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.UpdateHostRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "UpdateHost");
            try
            {
                return client.UpdateHostAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcConfiguration_TlsCertificate { get; set; }
            public System.String VpcConfiguration_VpcId { get; set; }
            public System.Func<Amazon.CodeConnections.Model.UpdateHostResponse, UpdateCCONHostCmdlet, object> Select { get; set; } =
