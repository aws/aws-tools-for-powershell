...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CCONRepositoryLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCCONRepositoryLinkCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.DeleteRepositoryLinkResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CCONRepositoryLink (DeleteRepositoryLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.DeleteRepositoryLinkResponse, RemoveCCONRepositoryLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.DeleteRepositoryLinkRequest();
        ...
        private Amazon.CodeConnections.Model.DeleteRepositoryLinkResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.DeleteRepositoryLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "DeleteRepositoryLink");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String RepositoryLinkId { get; set; }
            public System.Func<Amazon.CodeConnections.Model.DeleteRepositoryLinkResponse, RemoveCCONRepositoryLinkCmdlet, object> Select { get; set; } =
