...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCONSyncBlockerSummary")]
    [OutputType("Amazon.CodeConnections.Model.SyncBlockerSummary")]
    ...
    public partial class GetCCONSyncBlockerSummaryCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.GetSyncBlockerSummaryResponse).
        /// Specifying the name of a property of type Amazon.CodeConnections.Model.GetSyncBlockerSummaryResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.GetSyncBlockerSummaryResponse, GetCCONSyncBlockerSummaryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.GetSyncBlockerSummaryRequest();
        ...
        private Amazon.CodeConnections.Model.GetSyncBlockerSummaryResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.GetSyncBlockerSummaryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "GetSyncBlockerSummary");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceName { get; set; }
            public Amazon.CodeConnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeConnections.Model.GetSyncBlockerSummaryResponse, GetCCONSyncBlockerSummaryCmdlet, object> Select { get; set; } =
