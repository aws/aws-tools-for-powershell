...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// </summary>
    [Cmdlet("Get", "CCONSyncConfiguration")]
    [OutputType("Amazon.CodeConnections.Model.SyncConfiguration")]
    ...
    public partial class GetCCONSyncConfigurationCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.GetSyncConfigurationResponse).
        /// Specifying the name of a property of type Amazon.CodeConnections.Model.GetSyncConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.GetSyncConfigurationResponse, GetCCONSyncConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.GetSyncConfigurationRequest();
        ...
        private Amazon.CodeConnections.Model.GetSyncConfigurationResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.GetSyncConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "GetSyncConfiguration");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceName { get; set; }
            public Amazon.CodeConnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeConnections.Model.GetSyncConfigurationResponse, GetCCONSyncConfigurationCmdlet, object> Select { get; set; } =
