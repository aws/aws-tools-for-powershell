...
namespace Amazon.PowerShell.Cmdlets.CCON
{
    ...
    /// resource.
    /// </summary>
    [Cmdlet("Get", "CCONResourceSyncStatus")]
    ...
    public partial class GetCCONResourceSyncStatusCmdlet : AmazonCodeConnectionsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeConnections.Model.GetResourceSyncStatusResponse).
        /// Specifying the name of a property of type Amazon.CodeConnections.Model.GetResourceSyncStatusResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeConnections.Model.GetResourceSyncStatusResponse, GetCCONResourceSyncStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeConnections.Model.GetResourceSyncStatusRequest();
        ...
        private Amazon.CodeConnections.Model.GetResourceSyncStatusResponse CallAWSServiceOperation(IAmazonCodeConnections client, Amazon.CodeConnections.Model.GetResourceSyncStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeConnections", "GetResourceSyncStatus");
            try
            {
                #if DESKTOP
                return client.GetResourceSyncStatus(request);
                #elif CORECLR
                return client.GetResourceSyncStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceName { get; set; }
            public Amazon.CodeConnections.SyncConfigurationType SyncType { get; set; }
            public System.Func<Amazon.CodeConnections.Model.GetResourceSyncStatusResponse, GetCCONResourceSyncStatusCmdlet, object> Select { get; set; } =
