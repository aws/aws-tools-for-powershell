...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty StopMonitoringMembers API operation.", Operation = new[] {"StopMonitoringMembers"})]
    [AWSCmdletOutput("Amazon.GuardDuty.Model.UnprocessedAccount",
        "This cmdlet returns a collection of UnprocessedAccount objects.",
        "The service call response (type Amazon.GuardDuty.Model.StopMonitoringMembersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopGDMonitoringMemberCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        private Amazon.GuardDuty.Model.StopMonitoringMembersResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.StopMonitoringMembersRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StopMonitoringMembers(request);
                #elif CORECLR
                return client.StopMonitoringMembersAsync(request).GetAwaiter().GetResult();
                #else
