...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty GetDetector API operation.", Operation = new[] {"GetDetector"})]
    [AWSCmdletOutput("Amazon.GuardDuty.Model.GetDetectorResponse",
        "This cmdlet returns a Amazon.GuardDuty.Model.GetDetectorResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGDDetectorCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        private Amazon.GuardDuty.Model.GetDetectorResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.GetDetectorRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDetectorAsync(request);
                return task.Result;
                #else
