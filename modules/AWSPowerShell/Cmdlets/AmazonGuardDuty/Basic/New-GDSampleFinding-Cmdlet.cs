...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty CreateSampleFindings API operation.", Operation = new[] {"CreateSampleFindings"})]
    ...
    public partial class NewGDSampleFindingCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.FindingTypes = new List<System.String>(this.FindingType);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.FindingTypes != null)
            {
                request.FindingTypes = cmdletContext.FindingTypes;
            }
        ...
        private Amazon.GuardDuty.Model.CreateSampleFindingsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.CreateSampleFindingsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateSampleFindingsAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.String DetectorId { get; set; }
            public List<System.String> FindingTypes { get; set; }
        }
