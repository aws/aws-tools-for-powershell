...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty DeleteIPSet API operation.", Operation = new[] {"DeleteIPSet"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the IpSetId parameter. Otherwise, this cmdlet does not return any output. " +
