...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty StartMonitoringMembers API operation.", Operation = new[] {"StartMonitoringMembers"})]
    ...
    public partial class StartGDMonitoringMemberCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-GDMonitoringMember (StartMonitoringMembers)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.StartMonitoringMembersRequest();
        ...
        private Amazon.GuardDuty.Model.StartMonitoringMembersResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.StartMonitoringMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "StartMonitoringMembers");
            try
            {
                #if DESKTOP
                return client.StartMonitoringMembers(request);
                #elif CORECLR
                return client.StartMonitoringMembersAsync(request).GetAwaiter().GetResult();
                #else
