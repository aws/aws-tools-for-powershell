...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty GetMasterAccount API operation.", Operation = new[] {"GetMasterAccount"})]
    [AWSCmdletOutput("Amazon.GuardDuty.Model.Master",
        "This cmdlet returns a Master object.",
    ...
    public partial class GetGDMasterAccountCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Master;
        ...
        private Amazon.GuardDuty.Model.GetMasterAccountResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.GetMasterAccountRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetMasterAccountAsync(request);
                return task.Result;
                #else
