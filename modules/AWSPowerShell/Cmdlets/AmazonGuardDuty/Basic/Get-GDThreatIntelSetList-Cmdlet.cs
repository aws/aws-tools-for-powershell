...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty ListThreatIntelSets API operation.", Operation = new[] {"ListThreatIntelSets"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.GuardDuty.Model.ListThreatIntelSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetGDThreatIntelSetListCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.GuardDuty.Model.ListThreatIntelSetsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ThreatIntelSetIds;
                        ...
                        int _receivedThisCall = response.ThreatIntelSetIds.Count;
        ...
        private Amazon.GuardDuty.Model.ListThreatIntelSetsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.ListThreatIntelSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "ListThreatIntelSets");
            try
            {
                #if DESKTOP
                return client.ListThreatIntelSets(request);
                #elif CORECLR
                return client.ListThreatIntelSetsAsync(request).GetAwaiter().GetResult();
                #else
