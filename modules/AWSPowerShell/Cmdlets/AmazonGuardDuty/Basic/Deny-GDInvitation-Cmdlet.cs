...
namespace Amazon.PowerShell.Cmdlets.GD
{
    ...
    [AWSCmdlet("Calls the Amazon GuardDuty DeclineInvitations API operation.", Operation = new[] {"DeclineInvitations"})]
    ...
    public partial class DenyGDInvitationCmdlet : AmazonGuardDutyClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Deny-GDInvitation (DeclineInvitations)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GuardDuty.Model.DeclineInvitationsRequest();
        ...
        private Amazon.GuardDuty.Model.DeclineInvitationsResponse CallAWSServiceOperation(IAmazonGuardDuty client, Amazon.GuardDuty.Model.DeclineInvitationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GuardDuty", "DeclineInvitations");
            try
            {
                #if DESKTOP
