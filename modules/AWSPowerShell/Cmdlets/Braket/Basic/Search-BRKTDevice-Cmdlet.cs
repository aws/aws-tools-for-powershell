...
namespace Amazon.PowerShell.Cmdlets.BRKT
{
    ...
    /// </summary>
    [Cmdlet("Search", "BRKTDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Braket.Model.DeviceSummary")]
    ...
    public partial class SearchBRKTDeviceCmdlet : AmazonBraketClientCmdlet, IExecutor
    {
        ...
        [Alias("Filters")]
        public Amazon.Braket.Model.SearchDevicesFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-BRKTDevice (SearchDevices)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Braket.Model.SearchDevicesResponse, SearchBRKTDeviceCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.Braket.Model.SearchDevicesFilter>(this.Filter);
            }
            #if MODULAR
        ...
        private Amazon.Braket.Model.SearchDevicesResponse CallAWSServiceOperation(IAmazonBraket client, Amazon.Braket.Model.SearchDevicesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Braket", "SearchDevices");
            try
            {
                return client.SearchDevicesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public List<Amazon.Braket.Model.SearchDevicesFilter> Filter { get; set; }
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Braket.Model.SearchDevicesResponse, SearchBRKTDeviceCmdlet, object> Select { get; set; } =
