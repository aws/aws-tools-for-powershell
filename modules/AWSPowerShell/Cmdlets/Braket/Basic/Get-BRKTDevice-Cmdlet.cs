...
namespace Amazon.PowerShell.Cmdlets.BRKT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "BRKTDevice")]
    [OutputType("Amazon.Braket.Model.GetDeviceResponse")]
    [AWSCmdlet("Calls the Amazon Braket GetDevice API operation.", Operation = new[] {"GetDevice"}, SelectReturnType = typeof(Amazon.Braket.Model.GetDeviceResponse))]
    [AWSCmdletOutput("Amazon.Braket.Model.GetDeviceResponse",
        "This cmdlet returns an Amazon.Braket.Model.GetDeviceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetBRKTDeviceCmdlet : AmazonBraketClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Braket.Model.GetDeviceResponse, GetBRKTDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Braket.Model.GetDeviceRequest();
        ...
        private Amazon.Braket.Model.GetDeviceResponse CallAWSServiceOperation(IAmazonBraket client, Amazon.Braket.Model.GetDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Braket", "GetDevice");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DeviceArn { get; set; }
            public System.Func<Amazon.Braket.Model.GetDeviceResponse, GetBRKTDeviceCmdlet, object> Select { get; set; } =
