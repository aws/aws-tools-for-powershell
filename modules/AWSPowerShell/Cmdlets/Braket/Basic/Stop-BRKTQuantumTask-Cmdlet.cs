...
namespace Amazon.PowerShell.Cmdlets.BRKT
{
    ...
    [AWSCmdletOutput("Amazon.Braket.Model.CancelQuantumTaskResponse",
        "This cmdlet returns an Amazon.Braket.Model.CancelQuantumTaskResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopBRKTQuantumTaskCmdlet : AmazonBraketClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^QuantumTaskArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.Braket.Model.CancelQuantumTaskResponse CallAWSServiceOperation(IAmazonBraket client, Amazon.Braket.Model.CancelQuantumTaskRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CancelQuantumTask(request);
                #elif CORECLR
                return client.CancelQuantumTaskAsync(request).GetAwaiter().GetResult();
                #else
