...
namespace Amazon.PowerShell.Cmdlets.MHC
{
    ...
    [AWSCmdletOutput("Amazon.MigrationHubConfig.Model.HomeRegionControl or Amazon.MigrationHubConfig.Model.DescribeHomeRegionControlsResponse",
        ...
        "The service call response (type Amazon.MigrationHubConfig.Model.DescribeHomeRegionControlsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
