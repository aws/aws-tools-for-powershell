...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    [AWSCmdletOutput("None or Amazon.ApplicationInsights.Model.TagResourceResponse",
        ...
        "The service response (type Amazon.ApplicationInsights.Model.TagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
