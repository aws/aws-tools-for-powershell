...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWAIComponentConfiguration")]
    ...
    public partial class GetCWAIComponentConfigurationCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.DescribeComponentConfigurationResponse, GetCWAIComponentConfigurationCmdlet>(Select) ??
        ...
        private Amazon.ApplicationInsights.Model.DescribeComponentConfigurationResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.DescribeComponentConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "DescribeComponentConfiguration");
            try
            {
                #if DESKTOP
                return client.DescribeComponentConfiguration(request);
                #elif CORECLR
                return client.DescribeComponentConfigurationAsync(request).GetAwaiter().GetResult();
                #else
