...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Application Insights ListLogPatterns API operation.", Operation = new[] {"ListLogPatterns"}, SelectReturnType = typeof(Amazon.ApplicationInsights.Model.ListLogPatternsResponse))]
    [AWSCmdletOutput("Amazon.ApplicationInsights.Model.LogPattern or Amazon.ApplicationInsights.Model.ListLogPatternsResponse",
        "This cmdlet returns a collection of Amazon.ApplicationInsights.Model.LogPattern objects.",
        "The service call response (type Amazon.ApplicationInsights.Model.ListLogPatternsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWAILogPatternListCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LogPatterns";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.ListLogPatternsResponse, GetCWAILogPatternListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApplicationInsights.Model.ListLogPatternsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.LogPatterns?.Count ?? 0;
        ...
        private Amazon.ApplicationInsights.Model.ListLogPatternsResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.ListLogPatternsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "ListLogPatterns");
            try
            {
                #if DESKTOP
                return client.ListLogPatterns(request);
                #elif CORECLR
                return client.ListLogPatternsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PatternSetName { get; set; }
            public System.String ResourceGroupName { get; set; }
            public System.Func<Amazon.ApplicationInsights.Model.ListLogPatternsResponse, GetCWAILogPatternListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LogPatterns;
        }
