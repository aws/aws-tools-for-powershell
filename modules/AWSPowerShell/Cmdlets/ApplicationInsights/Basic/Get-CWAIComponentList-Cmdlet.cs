...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWAIComponentList")]
    [OutputType("Amazon.ApplicationInsights.Model.ApplicationComponent")]
    [AWSCmdlet("Calls the Amazon CloudWatch Application Insights ListComponents API operation.", Operation = new[] {"ListComponents"}, SelectReturnType = typeof(Amazon.ApplicationInsights.Model.ListComponentsResponse))]
    [AWSCmdletOutput("Amazon.ApplicationInsights.Model.ApplicationComponent or Amazon.ApplicationInsights.Model.ListComponentsResponse",
        "This cmdlet returns a collection of Amazon.ApplicationInsights.Model.ApplicationComponent objects.",
        "The service call response (type Amazon.ApplicationInsights.Model.ListComponentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWAIComponentListCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ApplicationComponentList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.ListComponentsResponse, GetCWAIComponentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ApplicationComponentList.Count;
        ...
        private Amazon.ApplicationInsights.Model.ListComponentsResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.ListComponentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "ListComponents");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceGroupName { get; set; }
            public System.Func<Amazon.ApplicationInsights.Model.ListComponentsResponse, GetCWAIComponentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ApplicationComponentList;
        }
