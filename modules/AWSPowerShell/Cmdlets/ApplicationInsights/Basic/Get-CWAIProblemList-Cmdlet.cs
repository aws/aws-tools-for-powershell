...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWAIProblemList")]
    [OutputType("Amazon.ApplicationInsights.Model.Problem")]
    [AWSCmdlet("Calls the Amazon CloudWatch Application Insights ListProblems API operation.", Operation = new[] {"ListProblems"}, SelectReturnType = typeof(Amazon.ApplicationInsights.Model.ListProblemsResponse))]
    [AWSCmdletOutput("Amazon.ApplicationInsights.Model.Problem or Amazon.ApplicationInsights.Model.ListProblemsResponse",
        "This cmdlet returns a collection of Amazon.ApplicationInsights.Model.Problem objects.",
        "The service call response (type Amazon.ApplicationInsights.Model.ListProblemsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWAIProblemListCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ProblemList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.ListProblemsResponse, GetCWAIProblemListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ProblemList.Count;
        ...
        private Amazon.ApplicationInsights.Model.ListProblemsResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.ListProblemsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "ListProblems");
            try
            {
                #if DESKTOP
                return client.ListProblems(request);
                #elif CORECLR
                return client.ListProblemsAsync(request).GetAwaiter().GetResult();
                #else
