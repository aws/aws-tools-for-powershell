...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWAILogPatternSetList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon CloudWatch Application Insights ListLogPatternSets API operation.", Operation = new[] {"ListLogPatternSets"}, SelectReturnType = typeof(Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse))]
    [AWSCmdletOutput("System.String or Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWAILogPatternSetListCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LogPatternSets";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse, GetCWAILogPatternSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApplicationInsights.Model.ListLogPatternSetsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                // The service has a maximum page size of 40. If the user has
                // asked for more items than page max, and there is no page size
                // configured, we rely on the service ignoring the set maximum
                // and giving us 40 items back. If a page size is set, that will
            ...
            do
            {
                ...
                {
                    int correctPageSize = AutoIterationHelpers.Min(40, _emitLimit.Value);
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.LogPatternSets.Count;
        ...
        private Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.ListLogPatternSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "ListLogPatternSets");
            try
            {
                #if DESKTOP
                return client.ListLogPatternSets(request);
                #elif CORECLR
                return client.ListLogPatternSetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceGroupName { get; set; }
            public System.Func<Amazon.ApplicationInsights.Model.ListLogPatternSetsResponse, GetCWAILogPatternSetListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LogPatternSets;
        }
