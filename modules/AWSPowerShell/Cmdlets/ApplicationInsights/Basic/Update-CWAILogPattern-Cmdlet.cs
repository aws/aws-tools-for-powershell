...
namespace Amazon.PowerShell.Cmdlets.CWAI
{
    ...
    /// </summary>
    [Cmdlet("Update", "CWAILogPattern", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCWAILogPatternCmdlet : AmazonApplicationInsightsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWAILogPattern (UpdateLogPattern)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationInsights.Model.UpdateLogPatternResponse, UpdateCWAILogPatternCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationInsights.Model.UpdateLogPatternRequest();
        ...
        private Amazon.ApplicationInsights.Model.UpdateLogPatternResponse CallAWSServiceOperation(IAmazonApplicationInsights client, Amazon.ApplicationInsights.Model.UpdateLogPatternRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Insights", "UpdateLogPattern");
            try
            {
                #if DESKTOP
                return client.UpdateLogPattern(request);
                #elif CORECLR
                return client.UpdateLogPatternAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? Rank { get; set; }
            public System.String ResourceGroupName { get; set; }
            public System.Func<Amazon.ApplicationInsights.Model.UpdateLogPatternResponse, UpdateCWAILogPatternCmdlet, object> Select { get; set; } =
