...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    public partial class GetCAResourceTagCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeArtifact.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.CodeArtifact.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeArtifact.Model.ListTagsForResourceResponse, GetCAResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeArtifact.Model.ListTagsForResourceRequest();
        ...
        private Amazon.CodeArtifact.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonCodeArtifact client, Amazon.CodeArtifact.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeArtifact", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.CodeArtifact.Model.ListTagsForResourceResponse, GetCAResourceTagCmdlet, object> Select { get; set; } =
