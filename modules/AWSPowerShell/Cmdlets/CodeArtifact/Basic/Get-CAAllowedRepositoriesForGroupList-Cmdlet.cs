...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    /// group origin controls</a> in the <i>CodeArtifact User Guide</i>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCAAllowedRepositoriesForGroupListCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeArtifact.Model.ListAllowedRepositoriesForGroupResponse CallAWSServiceOperation(IAmazonCodeArtifact client, Amazon.CodeArtifact.Model.ListAllowedRepositoriesForGroupRequest request)
        {
            ...
            try
            {
                return client.ListAllowedRepositoriesForGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
