...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    public partial class UpdateCAPackageVersionsStatusCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The domain that contains the repository that contains the package versions with a
        /// status to be updated. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// valid values are: </para><ul><li><para><code>npm</code></para></li><li><para><code>pypi</code></para></li><li><para><code>maven</code></para></li><li><para><code>nuget</code></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
