...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    public partial class GetCAPackageVersionAssetCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The domain that contains the repository that contains the package version with the
        /// requested asset. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// file. The valid values are: </para><ul><li><para><code>npm</code></para></li><li><para><code>pypi</code></para></li><li><para><code>maven</code></para></li><li><para><code>nuget</code></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
