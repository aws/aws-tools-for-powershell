...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    /// 
    ///  <ul><li><para><code>npm</code></para></li><li><para><code>pypi</code></para></li><li><para><code>maven</code></para></li><li><para><code>nuget</code></para></li></ul>
    /// </summary>
    ...
    public partial class GetCARepositoryEndpointCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The 12-digit account number of the AWS account that owns the domain that contains
        /// the repository. It does not include dashes or spaces. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// each package format: </para><ul><li><para><code>npm</code></para></li><li><para><code>pypi</code></para></li><li><para><code>maven</code></para></li><li><para><code>nuget</code></para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
