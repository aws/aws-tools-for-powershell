...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    /// the specified domain and that matches the input parameters.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CodeArtifact.Model.RepositorySummary or Amazon.CodeArtifact.Model.ListRepositoriesInDomainResponse",
        ...
        "The service call response (type Amazon.CodeArtifact.Model.ListRepositoriesInDomainResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCARepositoriesInDomainListCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeArtifact.Model.ListRepositoriesInDomainResponse CallAWSServiceOperation(IAmazonCodeArtifact client, Amazon.CodeArtifact.Model.ListRepositoriesInDomainRequest request)
        {
            ...
            try
            {
                return client.ListRepositoriesInDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
