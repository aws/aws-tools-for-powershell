...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    /// Each returned <c>DomainSummary</c> object contains information about a domain.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CodeArtifact.Model.DomainSummary or Amazon.CodeArtifact.Model.ListDomainsResponse",
        ...
        "The service call response (type Amazon.CodeArtifact.Model.ListDomainsResponse) can be returned by specifying '-Select *'."
    )]
