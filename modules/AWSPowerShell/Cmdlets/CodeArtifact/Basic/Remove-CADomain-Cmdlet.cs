...
namespace Amazon.PowerShell.Cmdlets.CA
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CADomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveCADomainCmdlet : AmazonCodeArtifactClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The name of the domain to delete. </para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CodeArtifact.Model.DeleteDomainResponse).
        /// Specifying the name of a property of type Amazon.CodeArtifact.Model.DeleteDomainResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CADomain (DeleteDomain)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeArtifact.Model.DeleteDomainResponse, RemoveCADomainCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeArtifact.Model.DeleteDomainRequest();
        ...
        private Amazon.CodeArtifact.Model.DeleteDomainResponse CallAWSServiceOperation(IAmazonCodeArtifact client, Amazon.CodeArtifact.Model.DeleteDomainRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeArtifact", "DeleteDomain");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Domain { get; set; }
            public System.String DomainOwner { get; set; }
            public System.Func<Amazon.CodeArtifact.Model.DeleteDomainResponse, RemoveCADomainCmdlet, object> Select { get; set; } =
