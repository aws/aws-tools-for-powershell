...
namespace Amazon.PowerShell.Cmdlets.EBS
{
    ...
    [AWSCmdletOutput("Amazon.EBS.Model.GetSnapshotBlockResponse",
        "This cmdlet returns an Amazon.EBS.Model.GetSnapshotBlockResponse object containing multiple properties."
    )]
    public partial class GetEBSSnapshotBlockCmdlet : AmazonEBSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The block token of the block from which to get data. You can obtain the <c>BlockToken</c>
        /// by running the <c>ListChangedBlocks</c> or <c>ListSnapshotBlocks</c> operations.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.EBS.Model.GetSnapshotBlockResponse CallAWSServiceOperation(IAmazonEBS client, Amazon.EBS.Model.GetSnapshotBlockRequest request)
        {
            ...
            try
            {
                return client.GetSnapshotBlockAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
