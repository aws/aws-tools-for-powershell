...
namespace Amazon.PowerShell.Cmdlets.EBS
{
    ...
    public partial class StartEBSSnapshotCmdlet : AmazonEBSClientCmdlet, IExecutor
    {
        ...
        /// <code>true</code>. To create an unencrypted snapshot, omit this parameter.</para><para>If you specify a value for <b>ParentSnapshotId</b>, omit this parameter.</para><para>If you specify <code>true</code>, the snapshot is encrypted using the CMK specified
        ...
        /// the default AWS managed CMK is used.</para><para>If you specify a <b>ParentSnapshotId</b>, omit this parameter; the snapshot will be
        /// encrypted using the same CMK that was used to encrypt the parent snapshot.</para><para>If <b>Encrypted</b> is set to <code>true</code>, you must specify a CMK ARN. </para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The size of the volume, in GiB. The maximum size is <code>16384</code> GiB (16 TiB).</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// request and they have no additional effect.</para><para>If you do not specify a client token, one is automatically generated by the AWS SDK.</para><para>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-direct-api-idempotency.html">
