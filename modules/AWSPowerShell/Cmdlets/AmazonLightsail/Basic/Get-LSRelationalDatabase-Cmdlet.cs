...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabase API operation.", Operation = new[] {"GetRelationalDatabase"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabase",
        "This cmdlet returns a RelationalDatabase object.",
    ...
    public partial class GetLSRelationalDatabaseCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.RelationalDatabase;
