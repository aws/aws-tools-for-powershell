    ...
    public partial class GetLSInstanceSnapshotCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.InstanceSnapshot;
        ...
        private static Amazon.Lightsail.Model.GetInstanceSnapshotResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstanceSnapshotRequest request)
        {
            #if DESKTOP
            return client.GetInstanceSnapshot(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetInstanceSnapshotAsync(request);
            return task.Result;
            #else
