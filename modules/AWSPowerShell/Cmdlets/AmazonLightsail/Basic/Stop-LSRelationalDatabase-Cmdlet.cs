...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail StopRelationalDatabase API operation.", Operation = new[] {"StopRelationalDatabase"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation",
        "This cmdlet returns a collection of Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.StopRelationalDatabaseResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopLSRelationalDatabaseCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lightsail.Model.StopRelationalDatabaseResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.StopRelationalDatabaseRequest request)
        {
            ...
            try
            {
                ...
                var task = client.StopRelationalDatabaseAsync(request);
                return task.Result;
                #else
