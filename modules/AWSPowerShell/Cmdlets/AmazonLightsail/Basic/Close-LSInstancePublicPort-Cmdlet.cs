...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class CloseLSInstancePublicPortCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.CloseInstancePublicPortsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CloseInstancePublicPortsRequest request)
        {
            #if DESKTOP
