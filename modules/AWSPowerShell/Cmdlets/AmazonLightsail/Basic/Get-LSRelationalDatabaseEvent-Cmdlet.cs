...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseEvents API operation.", Operation = new[] {"GetRelationalDatabaseEvents"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabaseEvent",
        "This cmdlet returns a collection of RelationalDatabaseEvent objects.",
    ...
    public partial class GetLSRelationalDatabaseEventCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("DurationInMinute"))
                context.DurationInMinutes = this.DurationInMinute;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.DurationInMinutes != null)
            {
                request.DurationInMinutes = cmdletContext.DurationInMinutes.Value;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.RelationalDatabaseEvents;
                        ...
                        {
                            int _receivedThisCall = response.RelationalDatabaseEvents.Count;
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseEventsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseEventsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRelationalDatabaseEventsAsync(request);
                return task.Result;
                #else
