...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the DetachStaticIp operation against Amazon Lightsail.", Operation = new[] {"DetachStaticIp"})]
    ...
    public partial class DismountLSStaticIpCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.DetachStaticIpResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.DetachStaticIpRequest request)
        {
            #if DESKTOP
