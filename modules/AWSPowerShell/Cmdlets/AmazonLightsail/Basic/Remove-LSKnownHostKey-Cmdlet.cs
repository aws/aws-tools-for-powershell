...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail DeleteKnownHostKeys API operation.", Operation = new[] {"DeleteKnownHostKeys"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation",
        "This cmdlet returns a collection of Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.DeleteKnownHostKeysResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveLSKnownHostKeyCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lightsail.Model.DeleteKnownHostKeysResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.DeleteKnownHostKeysRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteKnownHostKeys(request);
                #elif CORECLR
                return client.DeleteKnownHostKeysAsync(request).GetAwaiter().GetResult();
                #else
