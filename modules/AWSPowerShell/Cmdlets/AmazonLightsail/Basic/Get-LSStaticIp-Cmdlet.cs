...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the GetStaticIp operation against Amazon Lightsail.", Operation = new[] {"GetStaticIp"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.StaticIp",
        "This cmdlet returns a StaticIp object.",
    ...
    public partial class GetLSStaticIpCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.StaticIp;
        ...
        private Amazon.Lightsail.Model.GetStaticIpResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetStaticIpRequest request)
        {
            ...
            var task = client.GetStaticIpAsync(request);
            return task.Result;
            #else
