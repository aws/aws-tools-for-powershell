...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseLogStreams API operation.", Operation = new[] {"GetRelationalDatabaseLogStreams"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Lightsail.Model.GetRelationalDatabaseLogStreamsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSRelationalDatabaseLogStreamCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseLogStreamsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseLogStreamsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRelationalDatabaseLogStreamsAsync(request);
                return task.Result;
                #else
