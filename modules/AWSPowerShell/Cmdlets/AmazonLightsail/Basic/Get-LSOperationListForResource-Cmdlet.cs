...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSOperationListForResourceCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.GetOperationsForResourceResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetOperationsForResourceRequest request)
        {
            #if DESKTOP
