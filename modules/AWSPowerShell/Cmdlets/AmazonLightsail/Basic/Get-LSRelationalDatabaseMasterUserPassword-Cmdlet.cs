...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseMasterUserPassword API operation.", Operation = new[] {"GetRelationalDatabaseMasterUserPassword"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.GetRelationalDatabaseMasterUserPasswordResponse",
        "This cmdlet returns a Amazon.Lightsail.Model.GetRelationalDatabaseMasterUserPasswordResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
