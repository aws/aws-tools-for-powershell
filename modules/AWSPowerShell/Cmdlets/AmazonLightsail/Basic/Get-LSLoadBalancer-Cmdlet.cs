...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetLoadBalancer API operation.", Operation = new[] {"GetLoadBalancer"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.LoadBalancer",
    ...
    public partial class GetLSLoadBalancerCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.LoadBalancer;
        ...
        private Amazon.Lightsail.Model.GetLoadBalancerResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetLoadBalancerRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetLoadBalancerAsync(request);
                return task.Result;
                #else
