...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Get", "LSInstanceList")]
    [OutputType("Amazon.Lightsail.Model.Instance")]
    [AWSCmdlet("Calls the Amazon Lightsail GetInstances API operation.", Operation = new[] {"GetInstances"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Instance",
    ...
    public partial class GetLSInstanceListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetInstancesRequest();
        ...
        private Amazon.Lightsail.Model.GetInstancesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetInstances");
            try
            {
                #if DESKTOP
                return client.GetInstances(request);
                #elif CORECLR
                return client.GetInstancesAsync(request).GetAwaiter().GetResult();
                #else
