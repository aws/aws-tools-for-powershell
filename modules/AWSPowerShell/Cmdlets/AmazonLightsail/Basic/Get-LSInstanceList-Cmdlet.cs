...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSInstanceListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.GetInstancesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstancesRequest request)
        {
            #if DESKTOP
