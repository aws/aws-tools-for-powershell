...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseBundles API operation.", Operation = new[] {"GetRelationalDatabaseBundles"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabaseBundle",
        "This cmdlet returns a collection of RelationalDatabaseBundle objects.",
    ...
    public partial class GetLSRelationalDatabaseBundleCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseBundlesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseBundlesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRelationalDatabaseBundlesAsync(request);
                return task.Result;
                #else
