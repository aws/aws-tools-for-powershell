...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the GetStaticIps operation against Amazon Lightsail.", Operation = new[] {"GetStaticIps"})]
    ...
    public partial class GetLSStaticIpListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.GetStaticIpsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetStaticIpsRequest request)
        {
            #if DESKTOP
            return client.GetStaticIps(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetStaticIpsAsync(request);
            return task.Result;
            #else
