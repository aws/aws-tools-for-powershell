...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSInstanceStateCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.GetInstanceStateResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstanceStateRequest request)
        {
            #if DESKTOP
