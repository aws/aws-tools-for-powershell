...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSActiveNameListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ActiveNames;
                        ...
                        {
                            int _receivedThisCall = response.ActiveNames.Count;
        ...
        private static Amazon.Lightsail.Model.GetActiveNamesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetActiveNamesRequest request)
        {
            #if DESKTOP
            return client.GetActiveNames(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetActiveNamesAsync(request);
            return task.Result;
            #else
