...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetDiskSnapshots API operation.", Operation = new[] {"GetDiskSnapshots"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.DiskSnapshot",
        "This cmdlet returns a collection of DiskSnapshot objects.",
        "The service call response (type Amazon.Lightsail.Model.GetDiskSnapshotsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DiskSnapshots;
                        ...
                        {
                            int _receivedThisCall = response.DiskSnapshots.Count;
