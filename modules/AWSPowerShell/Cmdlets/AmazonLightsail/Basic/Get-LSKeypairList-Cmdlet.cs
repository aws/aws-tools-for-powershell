...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSKeypairListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetKeyPairsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        {
                            int _receivedThisCall = response.KeyPairs.Count;
        ...
        private Amazon.Lightsail.Model.GetKeyPairsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetKeyPairsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetKeyPairs");
            try
            {
                #if DESKTOP
                return client.GetKeyPairs(request);
                #elif CORECLR
                return client.GetKeyPairsAsync(request).GetAwaiter().GetResult();
                #else
