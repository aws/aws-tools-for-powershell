...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail DownloadDefaultKeyPair API operation.", Operation = new[] {"DownloadDefaultKeyPair"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.DownloadDefaultKeyPairResponse",
        "This cmdlet returns a Amazon.Lightsail.Model.DownloadDefaultKeyPairResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ReadLSDefaultKeyPairCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Read-LSDefaultKeyPair (DownloadDefaultKeyPair)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.DownloadDefaultKeyPairRequest();
        ...
        private Amazon.Lightsail.Model.DownloadDefaultKeyPairResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.DownloadDefaultKeyPairRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DownloadDefaultKeyPairAsync(request).GetAwaiter().GetResult();
                #else
