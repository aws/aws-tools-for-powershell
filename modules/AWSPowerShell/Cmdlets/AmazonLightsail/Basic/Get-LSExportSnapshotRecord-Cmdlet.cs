...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetExportSnapshotRecords API operation.", Operation = new[] {"GetExportSnapshotRecords"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.ExportSnapshotRecord",
        "This cmdlet returns a collection of ExportSnapshotRecord objects.",
    ...
    public partial class GetLSExportSnapshotRecordCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ExportSnapshotRecords;
                        ...
                        {
                            int _receivedThisCall = response.ExportSnapshotRecords.Count;
        ...
        private Amazon.Lightsail.Model.GetExportSnapshotRecordsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetExportSnapshotRecordsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetExportSnapshotRecordsAsync(request);
                return task.Result;
                #else
