...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the CreateDomainEntry operation against Amazon Lightsail.", Operation = new[] {"CreateDomainEntry"})]
    ...
    public partial class NewLSDomainEntryCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.CreateDomainEntryResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CreateDomainEntryRequest request)
        {
            #if DESKTOP
