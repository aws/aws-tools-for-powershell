...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseParameters API operation.", Operation = new[] {"GetRelationalDatabaseParameters"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabaseParameter",
        "This cmdlet returns a collection of RelationalDatabaseParameter objects.",
    ...
    public partial class GetLSRelationalDatabaseParameterCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseParametersResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseParametersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRelationalDatabaseParametersAsync(request);
                return task.Result;
                #else
