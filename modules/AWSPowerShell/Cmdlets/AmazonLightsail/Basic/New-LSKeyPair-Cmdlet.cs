...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class NewLSKeyPairCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.CreateKeyPairResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CreateKeyPairRequest request)
        {
            #if DESKTOP
