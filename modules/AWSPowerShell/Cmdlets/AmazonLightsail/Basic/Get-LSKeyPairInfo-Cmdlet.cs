...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the GetKeyPair operation against Amazon Lightsail.", Operation = new[] {"GetKeyPair"})]
    ...
    public partial class GetLSKeyPairInfoCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Lightsail.Model.GetKeyPairResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetKeyPairRequest request)
        {
            #if DESKTOP
            return client.GetKeyPair(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetKeyPairAsync(request);
            return task.Result;
            #else
