...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Invokes the ReleaseStaticIp operation against Amazon Lightsail.", Operation = new[] {"ReleaseStaticIp"})]
    ...
    public partial class RemoveLSStaticIpCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("StaticIpName", MyInvocation.BoundParameters);
        ...
        private static Amazon.Lightsail.Model.ReleaseStaticIpResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.ReleaseStaticIpRequest request)
        {
            #if DESKTOP
            return client.ReleaseStaticIp(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ReleaseStaticIpAsync(request);
            return task.Result;
            #else
