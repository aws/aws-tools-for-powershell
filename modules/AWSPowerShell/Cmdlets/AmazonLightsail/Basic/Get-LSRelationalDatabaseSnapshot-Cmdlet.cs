...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabaseSnapshot API operation.", Operation = new[] {"GetRelationalDatabaseSnapshot"})]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabaseSnapshot",
        "This cmdlet returns a RelationalDatabaseSnapshot object.",
        "The service call response (type Amazon.Lightsail.Model.GetRelationalDatabaseSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSRelationalDatabaseSnapshotCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.RelationalDatabaseSnapshot;
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseSnapshotResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseSnapshotRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRelationalDatabaseSnapshotAsync(request);
                return task.Result;
                #else
