...
namespace Amazon.PowerShell.Cmdlets.TNB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "TNBSolNetworkInstance")]
    [OutputType("Amazon.Tnb.Model.GetSolNetworkInstanceResponse")]
    [AWSCmdlet("Calls the AWS Telco Network Builder GetSolNetworkInstance API operation.", Operation = new[] {"GetSolNetworkInstance"}, SelectReturnType = typeof(Amazon.Tnb.Model.GetSolNetworkInstanceResponse))]
    [AWSCmdletOutput("Amazon.Tnb.Model.GetSolNetworkInstanceResponse",
        "This cmdlet returns an Amazon.Tnb.Model.GetSolNetworkInstanceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTNBSolNetworkInstanceCmdlet : AmazonTnbClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Tnb.Model.GetSolNetworkInstanceResponse, GetTNBSolNetworkInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Tnb.Model.GetSolNetworkInstanceRequest();
        ...
        private Amazon.Tnb.Model.GetSolNetworkInstanceResponse CallAWSServiceOperation(IAmazonTnb client, Amazon.Tnb.Model.GetSolNetworkInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Telco Network Builder", "GetSolNetworkInstance");
            try
            {
                #if DESKTOP
                return client.GetSolNetworkInstance(request);
                #elif CORECLR
                return client.GetSolNetworkInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NsInstanceId { get; set; }
            public System.Func<Amazon.Tnb.Model.GetSolNetworkInstanceResponse, GetTNBSolNetworkInstanceCmdlet, object> Select { get; set; } =
