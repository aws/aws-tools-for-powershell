...
namespace Amazon.PowerShell.Cmdlets.TNB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "TNBSolNetworkPackage")]
    [OutputType("Amazon.Tnb.Model.GetSolNetworkPackageResponse")]
    [AWSCmdlet("Calls the AWS Telco Network Builder GetSolNetworkPackage API operation.", Operation = new[] {"GetSolNetworkPackage"}, SelectReturnType = typeof(Amazon.Tnb.Model.GetSolNetworkPackageResponse))]
    [AWSCmdletOutput("Amazon.Tnb.Model.GetSolNetworkPackageResponse",
        "This cmdlet returns an Amazon.Tnb.Model.GetSolNetworkPackageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTNBSolNetworkPackageCmdlet : AmazonTnbClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Tnb.Model.GetSolNetworkPackageResponse, GetTNBSolNetworkPackageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Tnb.Model.GetSolNetworkPackageRequest();
        ...
        private Amazon.Tnb.Model.GetSolNetworkPackageResponse CallAWSServiceOperation(IAmazonTnb client, Amazon.Tnb.Model.GetSolNetworkPackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Telco Network Builder", "GetSolNetworkPackage");
            try
            {
                #if DESKTOP
                return client.GetSolNetworkPackage(request);
                #elif CORECLR
                return client.GetSolNetworkPackageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NsdInfoId { get; set; }
            public System.Func<Amazon.Tnb.Model.GetSolNetworkPackageResponse, GetTNBSolNetworkPackageCmdlet, object> Select { get; set; } =
