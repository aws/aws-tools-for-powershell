...
namespace Amazon.PowerShell.Cmdlets.TNB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "TNBResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveTNBResourceTagCmdlet : AmazonTnbClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TNBResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Tnb.Model.UntagResourceResponse, RemoveTNBResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Tnb.Model.UntagResourceRequest();
        ...
        private Amazon.Tnb.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonTnb client, Amazon.Tnb.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Telco Network Builder", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Tnb.Model.UntagResourceResponse, RemoveTNBResourceTagCmdlet, object> Select { get; set; } =
