...
namespace Amazon.PowerShell.Cmdlets.TNB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "TNBSolNetworkPackageList")]
    [OutputType("Amazon.Tnb.Model.ListSolNetworkPackageInfo")]
    ...
    public partial class GetTNBSolNetworkPackageListCmdlet : AmazonTnbClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NetworkPackages";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Tnb.Model.ListSolNetworkPackagesResponse, GetTNBSolNetworkPackageListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Tnb.Model.ListSolNetworkPackagesRequest();
        ...
        private Amazon.Tnb.Model.ListSolNetworkPackagesResponse CallAWSServiceOperation(IAmazonTnb client, Amazon.Tnb.Model.ListSolNetworkPackagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Telco Network Builder", "ListSolNetworkPackages");
            try
            {
                #if DESKTOP
                return client.ListSolNetworkPackages(request);
                #elif CORECLR
                return client.ListSolNetworkPackagesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Tnb.Model.ListSolNetworkPackagesResponse, GetTNBSolNetworkPackageListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NetworkPackages;
        }
