...
namespace Amazon.PowerShell.Cmdlets.TNB
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Telco Network Builder DeleteSolNetworkPackage API operation.", Operation = new[] {"DeleteSolNetworkPackage"}, SelectReturnType = typeof(Amazon.Tnb.Model.DeleteSolNetworkPackageResponse))]
    [AWSCmdletOutput("None or Amazon.Tnb.Model.DeleteSolNetworkPackageResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Tnb.Model.DeleteSolNetworkPackageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveTNBSolNetworkPackageCmdlet : AmazonTnbClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TNBSolNetworkPackage (DeleteSolNetworkPackage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Tnb.Model.DeleteSolNetworkPackageResponse, RemoveTNBSolNetworkPackageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Tnb.Model.DeleteSolNetworkPackageRequest();
        ...
        private Amazon.Tnb.Model.DeleteSolNetworkPackageResponse CallAWSServiceOperation(IAmazonTnb client, Amazon.Tnb.Model.DeleteSolNetworkPackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Telco Network Builder", "DeleteSolNetworkPackage");
            try
            {
                #if DESKTOP
                return client.DeleteSolNetworkPackage(request);
                #elif CORECLR
                return client.DeleteSolNetworkPackageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String NsdInfoId { get; set; }
            public System.Func<Amazon.Tnb.Model.DeleteSolNetworkPackageResponse, RemoveTNBSolNetworkPackageCmdlet, object> Select { get; set; } =
