...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINEConfigurationSetList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon Pinpoint Email ListConfigurationSets API operation.", Operation = new[] {"ListConfigurationSets"}, SelectReturnType = typeof(Amazon.PinpointEmail.Model.ListConfigurationSetsResponse))]
    [AWSCmdletOutput("System.String or Amazon.PinpointEmail.Model.ListConfigurationSetsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.PinpointEmail.Model.ListConfigurationSetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINEConfigurationSetListCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.ListConfigurationSetsResponse, GetPINEConfigurationSetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.PinpointEmail.Model.ListConfigurationSetsRequest();
        ...
        private Amazon.PinpointEmail.Model.ListConfigurationSetsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.ListConfigurationSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "ListConfigurationSets");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.PinpointEmail.Model.ListConfigurationSetsResponse, GetPINEConfigurationSetListCmdlet, object> Select { get; set; } =
