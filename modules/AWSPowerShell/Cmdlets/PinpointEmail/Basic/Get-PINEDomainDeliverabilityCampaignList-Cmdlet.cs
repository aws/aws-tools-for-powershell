...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.DomainDeliverabilityCampaign or Amazon.PinpointEmail.Model.ListDomainDeliverabilityCampaignsResponse",
        ...
        "The service call response (type Amazon.PinpointEmail.Model.ListDomainDeliverabilityCampaignsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DomainDeliverabilityCampaigns?.Count ?? 0;
