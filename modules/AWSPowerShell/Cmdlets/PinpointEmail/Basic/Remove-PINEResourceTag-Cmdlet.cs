...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PINEResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePINEResourceTagCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        /// <c>/v1/email/tags?ResourceArn=ResourceArn&amp;TagKeys=Key1&amp;TagKeys=Key2</c></para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PINEResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.UntagResourceResponse, RemovePINEResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointEmail.Model.UntagResourceRequest();
        ...
        private Amazon.PinpointEmail.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PinpointEmail.Model.UntagResourceResponse, RemovePINEResourceTagCmdlet, object> Select { get; set; } =
