...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Pinpoint Email PutConfigurationSetReputationOptions API operation.", Operation = new[] {"PutConfigurationSetReputationOptions"}, SelectReturnType = typeof(Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse))]
    [AWSCmdletOutput("None or Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse) be returned by specifying '-Select *'."
    )]
    public partial class WritePINEConfigurationSetReputationOptionCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse, WritePINEConfigurationSetReputationOptionCmdlet>(Select) ??
        ...
        private Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsRequest request)
        {
            ...
            try
            {
                return client.PutConfigurationSetReputationOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfigurationSetName { get; set; }
            public System.Boolean? ReputationMetricsEnabled { get; set; }
            public System.Func<Amazon.PinpointEmail.Model.PutConfigurationSetReputationOptionsResponse, WritePINEConfigurationSetReputationOptionCmdlet, object> Select { get; set; } =
