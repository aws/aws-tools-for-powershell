...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    /// </summary>
    [Cmdlet("Get", "PINEEmailIdentityList")]
    [OutputType("Amazon.PinpointEmail.Model.IdentityInfo")]
    [AWSCmdlet("Calls the Amazon Pinpoint Email ListEmailIdentities API operation.", Operation = new[] {"ListEmailIdentities"}, SelectReturnType = typeof(Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse))]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.IdentityInfo or Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse",
        "This cmdlet returns a collection of Amazon.PinpointEmail.Model.IdentityInfo objects.",
        "The service call response (type Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPINEEmailIdentityListCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse, GetPINEEmailIdentityListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.PinpointEmail.Model.ListEmailIdentitiesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.EmailIdentities?.Count ?? 0;
        ...
        private Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.ListEmailIdentitiesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "ListEmailIdentities");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.PinpointEmail.Model.ListEmailIdentitiesResponse, GetPINEEmailIdentityListCmdlet, object> Select { get; set; } =
