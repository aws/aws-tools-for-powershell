...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    public partial class GetPINEAccountCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.GetAccountResponse, GetPINEAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointEmail.Model.GetAccountRequest();
        ...
        private Amazon.PinpointEmail.Model.GetAccountResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.GetAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "GetAccount");
            try
            {
                return client.GetAccountAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.PinpointEmail.Model.GetAccountResponse, GetPINEAccountCmdlet, object> Select { get; set; } =
