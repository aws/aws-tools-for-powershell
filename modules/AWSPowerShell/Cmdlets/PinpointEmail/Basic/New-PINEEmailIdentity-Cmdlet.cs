...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "PINEEmailIdentity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.PinpointEmail.Model.CreateEmailIdentityResponse")]
    [AWSCmdlet("Calls the Amazon Pinpoint Email CreateEmailIdentity API operation.", Operation = new[] {"CreateEmailIdentity"}, SelectReturnType = typeof(Amazon.PinpointEmail.Model.CreateEmailIdentityResponse))]
    [AWSCmdletOutput("Amazon.PinpointEmail.Model.CreateEmailIdentityResponse",
        "This cmdlet returns an Amazon.PinpointEmail.Model.CreateEmailIdentityResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewPINEEmailIdentityCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-PINEEmailIdentity (CreateEmailIdentity)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.CreateEmailIdentityResponse, NewPINEEmailIdentityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PinpointEmail.Model.CreateEmailIdentityRequest();
        ...
        private Amazon.PinpointEmail.Model.CreateEmailIdentityResponse CallAWSServiceOperation(IAmazonPinpointEmail client, Amazon.PinpointEmail.Model.CreateEmailIdentityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Pinpoint Email", "CreateEmailIdentity");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PinpointEmail.Model.CreateEmailIdentityResponse, NewPINEEmailIdentityCmdlet, object> Select { get; set; } =
