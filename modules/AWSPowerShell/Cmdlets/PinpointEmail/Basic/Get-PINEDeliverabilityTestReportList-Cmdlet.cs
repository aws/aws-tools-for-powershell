...
namespace Amazon.PowerShell.Cmdlets.PINE
{
    ...
    public partial class GetPINEDeliverabilityTestReportListCmdlet : AmazonPinpointEmailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PinpointEmail.Model.ListDeliverabilityTestReportsResponse, GetPINEDeliverabilityTestReportListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NextToken { get; set; }
            public int? PageSize { get; set; }
            public System.Func<Amazon.PinpointEmail.Model.ListDeliverabilityTestReportsResponse, GetPINEDeliverabilityTestReportListCmdlet, object> Select { get; set; } =
