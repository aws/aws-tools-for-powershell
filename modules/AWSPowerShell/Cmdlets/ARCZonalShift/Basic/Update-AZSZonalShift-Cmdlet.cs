...
namespace Amazon.PowerShell.Cmdlets.AZS
{
    ...
    [AWSCmdletOutput("Amazon.ARCZonalShift.Model.UpdateZonalShiftResponse",
        "This cmdlet returns an Amazon.ARCZonalShift.Model.UpdateZonalShiftResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
