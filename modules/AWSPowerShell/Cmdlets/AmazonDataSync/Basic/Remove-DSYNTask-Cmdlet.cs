...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync DeleteTask API operation.", Operation = new[] {"DeleteTask"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the TaskArn parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveDSYNTaskCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataSync.Model.DeleteTaskResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DeleteTaskRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteTaskAsync(request);
                return task.Result;
                #else
