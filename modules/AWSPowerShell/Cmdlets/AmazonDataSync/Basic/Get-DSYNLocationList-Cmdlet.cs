...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync ListLocations API operation.", Operation = new[] {"ListLocations"})]
    [AWSCmdletOutput("Amazon.DataSync.Model.LocationListEntry",
        "This cmdlet returns a collection of LocationListEntry objects.",
    ...
    public partial class GetDSYNLocationListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataSync.Model.ListLocationsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.ListLocationsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListLocationsAsync(request);
                return task.Result;
                #else
