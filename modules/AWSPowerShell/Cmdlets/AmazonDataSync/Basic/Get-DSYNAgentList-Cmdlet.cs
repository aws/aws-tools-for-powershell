...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync ListAgents API operation.", Operation = new[] {"ListAgents"})]
    [AWSCmdletOutput("Amazon.DataSync.Model.AgentListEntry",
        "This cmdlet returns a collection of AgentListEntry objects.",
    ...
    public partial class GetDSYNAgentListCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Agents;
        ...
        private Amazon.DataSync.Model.ListAgentsResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.ListAgentsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListAgentsAsync(request);
                return task.Result;
                #else
