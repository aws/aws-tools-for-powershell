...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync CancelTaskExecution API operation.", Operation = new[] {"CancelTaskExecution"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the TaskExecutionArn parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class StopDSYNTaskExecutionCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("TaskExecutionArn", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.TaskExecutionArn;
        ...
        private Amazon.DataSync.Model.CancelTaskExecutionResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.CancelTaskExecutionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CancelTaskExecutionAsync(request);
                return task.Result;
                #else
