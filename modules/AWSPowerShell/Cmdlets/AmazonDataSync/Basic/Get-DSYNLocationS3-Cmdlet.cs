...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync DescribeLocationS3 API operation.", Operation = new[] {"DescribeLocationS3"})]
    [AWSCmdletOutput("Amazon.DataSync.Model.DescribeLocationS3Response",
        "This cmdlet returns a Amazon.DataSync.Model.DescribeLocationS3Response object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNLocationS3Cmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataSync.Model.DescribeLocationS3Response CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DescribeLocationS3Request request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeLocationS3(request);
                #elif CORECLR
                return client.DescribeLocationS3Async(request).GetAwaiter().GetResult();
                #else
