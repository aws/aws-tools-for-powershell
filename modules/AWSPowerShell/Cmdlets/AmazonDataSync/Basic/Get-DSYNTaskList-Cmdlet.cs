...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync ListTasks API operation.", Operation = new[] {"ListTasks"})]
    [AWSCmdletOutput("Amazon.DataSync.Model.TaskListEntry",
        "This cmdlet returns a collection of TaskListEntry objects.",
