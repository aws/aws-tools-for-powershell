...
namespace Amazon.PowerShell.Cmdlets.DSYN
{
    ...
    [AWSCmdlet("Calls the AWS DataSync DescribeTaskExecution API operation.", Operation = new[] {"DescribeTaskExecution"})]
    [AWSCmdletOutput("Amazon.DataSync.Model.DescribeTaskExecutionResponse",
        "This cmdlet returns a Amazon.DataSync.Model.DescribeTaskExecutionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDSYNTaskExecutionCmdlet : AmazonDataSyncClientCmdlet, IExecutor
    {
        ...
        private Amazon.DataSync.Model.DescribeTaskExecutionResponse CallAWSServiceOperation(IAmazonDataSync client, Amazon.DataSync.Model.DescribeTaskExecutionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeTaskExecutionAsync(request);
                return task.Result;
                #else
