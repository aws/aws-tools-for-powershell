...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend ListDocumentClassifiers API operation.", Operation = new[] {"ListDocumentClassifiers"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.DocumentClassifierProperties",
        "This cmdlet returns a collection of DocumentClassifierProperties objects.",
    ...
    public partial class GetCOMPDocumentClassifierListCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DocumentClassifierPropertiesList;
        ...
        private Amazon.Comprehend.Model.ListDocumentClassifiersResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.ListDocumentClassifiersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListDocumentClassifiersAsync(request);
                return task.Result;
                #else
