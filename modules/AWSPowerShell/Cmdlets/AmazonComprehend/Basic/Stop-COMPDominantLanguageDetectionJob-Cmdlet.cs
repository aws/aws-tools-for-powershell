...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend StopDominantLanguageDetectionJob API operation.", Operation = new[] {"StopDominantLanguageDetectionJob"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StopDominantLanguageDetectionJobResponse",
        "This cmdlet returns a Amazon.Comprehend.Model.StopDominantLanguageDetectionJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopCOMPDominantLanguageDetectionJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        private Amazon.Comprehend.Model.StopDominantLanguageDetectionJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StopDominantLanguageDetectionJobRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.StopDominantLanguageDetectionJob(request);
                #elif CORECLR
                return client.StopDominantLanguageDetectionJobAsync(request).GetAwaiter().GetResult();
                #else
