...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend DescribeSentimentDetectionJob API operation.", Operation = new[] {"DescribeSentimentDetectionJob"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.SentimentDetectionJobProperties",
        "This cmdlet returns a SentimentDetectionJobProperties object.",
    ...
    public partial class GetCOMPSentimentDetectionJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SentimentDetectionJobProperties;
        ...
        private Amazon.Comprehend.Model.DescribeSentimentDetectionJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.DescribeSentimentDetectionJobRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeSentimentDetectionJobAsync(request);
                return task.Result;
                #else
