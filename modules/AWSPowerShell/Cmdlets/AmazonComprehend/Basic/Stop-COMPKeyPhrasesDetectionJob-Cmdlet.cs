...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend StopKeyPhrasesDetectionJob API operation.", Operation = new[] {"StopKeyPhrasesDetectionJob"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StopKeyPhrasesDetectionJobResponse",
        "This cmdlet returns a Amazon.Comprehend.Model.StopKeyPhrasesDetectionJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
