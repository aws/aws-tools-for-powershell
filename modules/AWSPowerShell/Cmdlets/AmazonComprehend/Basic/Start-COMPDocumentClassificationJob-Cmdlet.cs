...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend StartDocumentClassificationJob API operation.", Operation = new[] {"StartDocumentClassificationJob"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StartDocumentClassificationJobResponse",
        "This cmdlet returns a Amazon.Comprehend.Model.StartDocumentClassificationJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
