...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    /// </summary>
    [Cmdlet("Start", "COMPKeyPhrasesDetectionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobResponse")]
    [AWSCmdlet("Calls the Amazon Comprehend StartKeyPhrasesDetectionJob API operation.", Operation = new[] {"StartKeyPhrasesDetectionJob"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobResponse",
        "This cmdlet returns a Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartCOMPKeyPhrasesDetectionJobCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobRequest();
        ...
        private Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.StartKeyPhrasesDetectionJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Comprehend", "StartKeyPhrasesDetectionJob");
            try
            {
                #if DESKTOP
                return client.StartKeyPhrasesDetectionJob(request);
                #elif CORECLR
                return client.StartKeyPhrasesDetectionJobAsync(request).GetAwaiter().GetResult();
                #else
