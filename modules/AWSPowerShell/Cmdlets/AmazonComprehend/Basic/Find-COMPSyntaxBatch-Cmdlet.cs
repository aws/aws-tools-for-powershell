...
namespace Amazon.PowerShell.Cmdlets.COMP
{
    ...
    [AWSCmdlet("Calls the Amazon Comprehend BatchDetectSyntax API operation.", Operation = new[] {"BatchDetectSyntax"})]
    [AWSCmdletOutput("Amazon.Comprehend.Model.BatchDetectSyntaxResponse",
        "This cmdlet returns a Amazon.Comprehend.Model.BatchDetectSyntaxResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class FindCOMPSyntaxBatchCmdlet : AmazonComprehendClientCmdlet, IExecutor
    {
        ...
        private Amazon.Comprehend.Model.BatchDetectSyntaxResponse CallAWSServiceOperation(IAmazonComprehend client, Amazon.Comprehend.Model.BatchDetectSyntaxRequest request)
        {
            ...
            try
            {
                ...
                var task = client.BatchDetectSyntaxAsync(request);
                return task.Result;
                #else
