...
namespace Amazon.PowerShell.Cmdlets.MHO
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MHOWorkflowStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveMHOWorkflowStepCmdlet : AmazonMigrationHubOrchestratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MHOWorkflowStep (DeleteWorkflowStep)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubOrchestrator.Model.DeleteWorkflowStepResponse, RemoveMHOWorkflowStepCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubOrchestrator.Model.DeleteWorkflowStepRequest();
        ...
        private Amazon.MigrationHubOrchestrator.Model.DeleteWorkflowStepResponse CallAWSServiceOperation(IAmazonMigrationHubOrchestrator client, Amazon.MigrationHubOrchestrator.Model.DeleteWorkflowStepRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Orchestrator", "DeleteWorkflowStep");
            try
            {
                #if DESKTOP
                return client.DeleteWorkflowStep(request);
                #elif CORECLR
                return client.DeleteWorkflowStepAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StepGroupId { get; set; }
            public System.String WorkflowId { get; set; }
            public System.Func<Amazon.MigrationHubOrchestrator.Model.DeleteWorkflowStepResponse, RemoveMHOWorkflowStepCmdlet, object> Select { get; set; } =
