...
namespace Amazon.PowerShell.Cmdlets.MHO
{
    ...
    /// </summary>
    [Cmdlet("Get", "MHOTemplateStepGroup")]
    ...
    public partial class GetMHOTemplateStepGroupCmdlet : AmazonMigrationHubOrchestratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubOrchestrator.Model.GetTemplateStepGroupResponse, GetMHOTemplateStepGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubOrchestrator.Model.GetTemplateStepGroupRequest();
        ...
        private Amazon.MigrationHubOrchestrator.Model.GetTemplateStepGroupResponse CallAWSServiceOperation(IAmazonMigrationHubOrchestrator client, Amazon.MigrationHubOrchestrator.Model.GetTemplateStepGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Orchestrator", "GetTemplateStepGroup");
            try
            {
                #if DESKTOP
                return client.GetTemplateStepGroup(request);
                #elif CORECLR
                return client.GetTemplateStepGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String TemplateId { get; set; }
            public System.Func<Amazon.MigrationHubOrchestrator.Model.GetTemplateStepGroupResponse, GetMHOTemplateStepGroupCmdlet, object> Select { get; set; } =
