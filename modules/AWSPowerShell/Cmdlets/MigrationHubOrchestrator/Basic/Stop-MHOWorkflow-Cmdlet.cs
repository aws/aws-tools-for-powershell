...
namespace Amazon.PowerShell.Cmdlets.MHO
{
    ...
    /// </summary>
    [Cmdlet("Stop", "MHOWorkflow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopMHOWorkflowCmdlet : AmazonMigrationHubOrchestratorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-MHOWorkflow (StopWorkflow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubOrchestrator.Model.StopWorkflowResponse, StopMHOWorkflowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubOrchestrator.Model.StopWorkflowRequest();
        ...
        private Amazon.MigrationHubOrchestrator.Model.StopWorkflowResponse CallAWSServiceOperation(IAmazonMigrationHubOrchestrator client, Amazon.MigrationHubOrchestrator.Model.StopWorkflowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Orchestrator", "StopWorkflow");
            try
            {
                #if DESKTOP
                return client.StopWorkflow(request);
                #elif CORECLR
                return client.StopWorkflowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.MigrationHubOrchestrator.Model.StopWorkflowResponse, StopMHOWorkflowCmdlet, object> Select { get; set; } =
