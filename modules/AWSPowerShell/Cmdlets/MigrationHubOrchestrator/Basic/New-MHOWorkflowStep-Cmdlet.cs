...
namespace Amazon.PowerShell.Cmdlets.MHO
{
    ...
    /// </summary>
    [Cmdlet("New", "MHOWorkflowStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse")]
    [AWSCmdlet("Calls the AWS Migration Hub Orchestrator CreateWorkflowStep API operation.", Operation = new[] {"CreateWorkflowStep"}, SelectReturnType = typeof(Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse))]
    [AWSCmdletOutput("Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse",
        "This cmdlet returns an Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewMHOWorkflowStepCmdlet : AmazonMigrationHubOrchestratorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The key value pairs added for the expected output.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Outputs")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-MHOWorkflowStep (CreateWorkflowStep)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse, NewMHOWorkflowStepCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.StepActionType == null && ParameterWasBound(nameof(this.StepActionType)))
            {
                WriteWarning("You are passing $null as a value for parameter StepActionType which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepRequest();
        ...
        private Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse CallAWSServiceOperation(IAmazonMigrationHubOrchestrator client, Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Migration Hub Orchestrator", "CreateWorkflowStep");
            try
            {
                #if DESKTOP
                return client.CreateWorkflowStep(request);
                #elif CORECLR
                return client.CreateWorkflowStepAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ScriptLocationS3Key_Window { get; set; }
            public Amazon.MigrationHubOrchestrator.TargetType WorkflowStepAutomationConfiguration_TargetType { get; set; }
            public System.Func<Amazon.MigrationHubOrchestrator.Model.CreateWorkflowStepResponse, NewMHOWorkflowStepCmdlet, object> Select { get; set; } =
