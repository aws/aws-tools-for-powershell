...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConnect DescribeFlow API operation.", Operation = new[] {"DescribeFlow"})]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.DescribeFlowResponse",
        "This cmdlet returns a Amazon.MediaConnect.Model.DescribeFlowResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMCNFlowCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        private Amazon.MediaConnect.Model.DescribeFlowResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.DescribeFlowRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeFlowAsync(request);
                return task.Result;
                #else
