...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConnect ListEntitlements API operation.", Operation = new[] {"ListEntitlements"})]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.ListedEntitlement",
        "This cmdlet returns a collection of ListedEntitlement objects.",
        "The service call response (type Amazon.MediaConnect.Model.ListEntitlementsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetEMCNEntitlementListCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MediaConnect.Model.ListEntitlementsRequest();
        ...
        private Amazon.MediaConnect.Model.ListEntitlementsResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.ListEntitlementsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Elemental MediaConnect", "ListEntitlements");
            try
            {
                #if DESKTOP
                return client.ListEntitlements(request);
                #elif CORECLR
                return client.ListEntitlementsAsync(request).GetAwaiter().GetResult();
                #else
