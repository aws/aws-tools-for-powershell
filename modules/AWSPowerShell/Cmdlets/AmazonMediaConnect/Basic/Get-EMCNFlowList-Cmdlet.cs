...
namespace Amazon.PowerShell.Cmdlets.EMCN
{
    ...
    [AWSCmdlet("Calls the AWS Elemental MediaConnect ListFlows API operation.", Operation = new[] {"ListFlows"})]
    [AWSCmdletOutput("Amazon.MediaConnect.Model.ListedFlow",
        "This cmdlet returns a collection of ListedFlow objects.",
    ...
    public partial class GetEMCNFlowListCmdlet : AmazonMediaConnectClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Flows;
        ...
        private Amazon.MediaConnect.Model.ListFlowsResponse CallAWSServiceOperation(IAmazonMediaConnect client, Amazon.MediaConnect.Model.ListFlowsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListFlowsAsync(request);
                return task.Result;
                #else
