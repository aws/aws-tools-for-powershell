...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSClusterTrack")]
    [OutputType("Amazon.Redshift.Model.MaintenanceTrack")]
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterTracks API operation.", Operation = new[] {"DescribeClusterTracks"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeClusterTracksResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.MaintenanceTrack or Amazon.Redshift.Model.DescribeClusterTracksResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.MaintenanceTrack objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeClusterTracksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRSClusterTrackCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "MaintenanceTracks";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MaintenanceTrackName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeClusterTracksResponse, GetRSClusterTrackCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.MaintenanceTrackName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Redshift.Model.DescribeClusterTracksRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.MaintenanceTracks.Count;
        ...
        private Amazon.Redshift.Model.DescribeClusterTracksResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterTracksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DescribeClusterTracks");
            try
            {
                #if DESKTOP
                return client.DescribeClusterTracks(request);
                #elif CORECLR
                return client.DescribeClusterTracksAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeClusterTracksResponse, GetRSClusterTrackCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.MaintenanceTracks;
        }
