...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift RotateEncryptionKey API operation.", Operation = new[] {"RotateEncryptionKey"}, SelectReturnType = typeof(Amazon.Redshift.Model.RotateEncryptionKeyResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.Cluster or Amazon.Redshift.Model.RotateEncryptionKeyResponse",
        "This cmdlet returns an Amazon.Redshift.Model.Cluster object.",
        "The service call response (type Amazon.Redshift.Model.RotateEncryptionKeyResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SwitchRSEncryptionKeyCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Switch-RSEncryptionKey (RotateEncryptionKey)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.RotateEncryptionKeyResponse, SwitchRSEncryptionKeyCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.RotateEncryptionKeyResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.RotateEncryptionKeyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "RotateEncryptionKey");
            try
            {
                #if DESKTOP
                return client.RotateEncryptionKey(request);
                #elif CORECLR
                return client.RotateEncryptionKeyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClusterIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.RotateEncryptionKeyResponse, SwitchRSEncryptionKeyCmdlet, object> Select { get; set; } =
