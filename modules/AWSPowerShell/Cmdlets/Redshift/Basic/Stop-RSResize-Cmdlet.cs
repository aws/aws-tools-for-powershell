...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class StopRSResizeCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-RSResize (CancelResize)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.CancelResizeResponse, StopRSResizeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.CancelResizeRequest();
        ...
        private Amazon.Redshift.Model.CancelResizeResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.CancelResizeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "CancelResize");
            try
            {
                #if DESKTOP
                return client.CancelResize(request);
                #elif CORECLR
                return client.CancelResizeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClusterIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.CancelResizeResponse, StopRSResizeCmdlet, object> Select { get; set; } =
