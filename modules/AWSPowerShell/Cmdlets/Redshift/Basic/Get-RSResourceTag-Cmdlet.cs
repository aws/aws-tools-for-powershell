...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class GetRSResourceTagCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of resource with which you want to view tags. Valid resource types are: </para><ul><li><para>Cluster</para></li><li><para>CIDR/IP</para></li><li><para>EC2 security group</para></li><li><para>Snapshot</para></li><li><para>Cluster security group</para></li><li><para>Subnet group</para></li><li><para>HSM connection</para></li><li><para>HSM certificate</para></li><li><para>Parameter group</para></li><li><para>Snapshot copy grant</para></li><li><para>Integration (zero-ETL integration)</para><note><para>To describe the tags associated with an <c>integration</c>, don't specify <c>ResourceType</c>,
