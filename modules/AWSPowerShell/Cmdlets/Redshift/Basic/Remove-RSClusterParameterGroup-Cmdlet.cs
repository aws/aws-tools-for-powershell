...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteClusterParameterGroup API operation.", Operation = new[] {"DeleteClusterParameterGroup"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteClusterParameterGroupResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteClusterParameterGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteClusterParameterGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveRSClusterParameterGroupCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSClusterParameterGroup (DeleteClusterParameterGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteClusterParameterGroupResponse, RemoveRSClusterParameterGroupCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.DeleteClusterParameterGroupResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteClusterParameterGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteClusterParameterGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ParameterGroupName { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteClusterParameterGroupResponse, RemoveRSClusterParameterGroupCmdlet, object> Select { get; set; } =
