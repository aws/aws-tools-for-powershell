...
{
    /// <summary>
    /// Contains information about custom domain associations for a cluster.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Redshift.Model.Association or Amazon.Redshift.Model.DescribeCustomDomainAssociationsResponse",
        ...
        "The service call response (type Amazon.Redshift.Model.DescribeCustomDomainAssociationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSCustomDomainAssociationCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        private Amazon.Redshift.Model.DescribeCustomDomainAssociationsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeCustomDomainAssociationsRequest request)
        {
            ...
            try
            {
                return client.DescribeCustomDomainAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
