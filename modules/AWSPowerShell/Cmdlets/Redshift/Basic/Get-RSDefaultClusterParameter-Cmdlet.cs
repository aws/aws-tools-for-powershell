...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeDefaultClusterParameters API operation.", Operation = new[] {"DescribeDefaultClusterParameters"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse), LegacyAlias="Get-RSDefaultClusterParameters")]
    [AWSCmdletOutput("Amazon.Redshift.Model.Parameter or Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.Parameter objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSDefaultClusterParameterCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DefaultClusterParameters.Parameters";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ParameterGroupFamily' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse, GetRSDefaultClusterParameterCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ParameterGroupFamily;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    _nextToken = response.DefaultClusterParameters.Marker;
                }
                catch (Exception e)
                {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String ParameterGroupFamily { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse, GetRSDefaultClusterParameterCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DefaultClusterParameters.Parameters;
        }
