...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class GetRSDefaultClusterParameterCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DefaultClusterParameters.Parameters?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeDefaultClusterParametersResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeDefaultClusterParametersRequest request)
        {
            ...
            try
            {
                return client.DescribeDefaultClusterParametersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
