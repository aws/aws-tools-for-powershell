...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSClusterParameter")]
    [OutputType("Amazon.Redshift.Model.Parameter")]
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterParameters API operation.", Operation = new[] {"DescribeClusterParameters"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeClusterParametersResponse), LegacyAlias="Get-RSClusterParameters")]
    [AWSCmdletOutput("Amazon.Redshift.Model.Parameter or Amazon.Redshift.Model.DescribeClusterParametersResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.Parameter objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeClusterParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSClusterParameterCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The parameter types to return. Specify <c>user</c> to show parameters that are different
        /// form the default. Similarly, specify <c>engine-default</c> to show parameters that
        /// are the same as the default parameter group. </para><para>Default: All parameter types returned.</para><para>Valid Values: <c>user</c> | <c>engine-default</c></para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeClusterParametersResponse, GetRSClusterParameterCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.DescribeClusterParametersResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DescribeClusterParameters");
            try
            {
                #if DESKTOP
                return client.DescribeClusterParameters(request);
                #elif CORECLR
                return client.DescribeClusterParametersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ParameterGroupName { get; set; }
            public System.String Source { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeClusterParametersResponse, GetRSClusterParameterCmdlet, object> Select { get; set; } =
