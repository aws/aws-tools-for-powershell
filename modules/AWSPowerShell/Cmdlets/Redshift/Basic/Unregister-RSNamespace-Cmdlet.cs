...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// Catalog.
    /// </summary>
    [Cmdlet("Unregister", "RSNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Redshift.NamespaceRegistrationStatus")]
    [AWSCmdlet("Calls the Amazon Redshift DeregisterNamespace API operation.", Operation = new[] {"DeregisterNamespace"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeregisterNamespaceResponse))]
    [AWSCmdletOutput("Amazon.Redshift.NamespaceRegistrationStatus or Amazon.Redshift.Model.DeregisterNamespaceResponse",
        "This cmdlet returns an Amazon.Redshift.NamespaceRegistrationStatus object.",
        "The service call response (type Amazon.Redshift.Model.DeregisterNamespaceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UnregisterRSNamespaceCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>An array containing the ID of the consumer account that you want to deregister the
        /// cluster or serverless namespace from.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.DeregisterNamespaceResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.DeregisterNamespaceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-RSNamespace (DeregisterNamespace)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeregisterNamespaceResponse, UnregisterRSNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeregisterNamespaceRequest();
        ...
        private Amazon.Redshift.Model.DeregisterNamespaceResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeregisterNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeregisterNamespace");
            try
            {
                #if DESKTOP
                return client.DeregisterNamespace(request);
                #elif CORECLR
                return client.DeregisterNamespaceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ServerlessIdentifier_NamespaceIdentifier { get; set; }
            public System.String ServerlessIdentifier_WorkgroupIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.DeregisterNamespaceResponse, UnregisterRSNamespaceCmdlet, object> Select { get; set; } =
