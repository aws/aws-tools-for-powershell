...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSReservedNode")]
    [OutputType("Amazon.Redshift.Model.ReservedNode")]
    [AWSCmdlet("Calls the Amazon Redshift DescribeReservedNodes API operation.", Operation = new[] {"DescribeReservedNodes"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeReservedNodesResponse), LegacyAlias="Get-RSReservedNodes")]
    [AWSCmdletOutput("Amazon.Redshift.Model.ReservedNode or Amazon.Redshift.Model.DescribeReservedNodesResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.ReservedNode objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeReservedNodesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSReservedNodeCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeReservedNodesResponse, GetRSReservedNodeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ReservedNodes?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String ReservedNodeId { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeReservedNodesResponse, GetRSReservedNodeCmdlet, object> Select { get; set; } =
