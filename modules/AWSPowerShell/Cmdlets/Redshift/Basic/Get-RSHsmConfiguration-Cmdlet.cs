...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdletOutput("Amazon.Redshift.Model.HsmConfiguration or Amazon.Redshift.Model.DescribeHsmConfigurationsResponse",
        ...
        "The service call response (type Amazon.Redshift.Model.DescribeHsmConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSHsmConfigurationCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// by your Amazon Web Services account.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeHsmConfigurationsResponse, GetRSHsmConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.HsmConfigurations?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeHsmConfigurationsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeHsmConfigurationsRequest request)
        {
            ...
            try
            {
                return client.DescribeHsmConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Redshift.Model.DescribeHsmConfigurationsResponse, GetRSHsmConfigurationCmdlet, object> Select { get; set; } =
