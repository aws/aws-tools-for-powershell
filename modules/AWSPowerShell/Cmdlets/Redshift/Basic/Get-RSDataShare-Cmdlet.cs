...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSDataShare")]
    [OutputType("Amazon.Redshift.Model.DataShare")]
    [AWSCmdlet("Calls the Amazon Redshift DescribeDataShares API operation.", Operation = new[] {"DescribeDataShares"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeDataSharesResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.DataShare or Amazon.Redshift.Model.DescribeDataSharesResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.DataShare objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeDataSharesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRSDataShareCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.DescribeDataSharesResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.DescribeDataSharesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeDataSharesResponse, GetRSDataShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Redshift.Model.DescribeDataSharesRequest();
        ...
        private Amazon.Redshift.Model.DescribeDataSharesResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeDataSharesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DescribeDataShares");
            try
            {
                #if DESKTOP
                return client.DescribeDataShares(request);
                #elif CORECLR
                return client.DescribeDataSharesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public System.Int32? MaxRecord { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeDataSharesResponse, GetRSDataShareCmdlet, object> Select { get; set; } =
