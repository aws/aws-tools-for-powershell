...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSUsageLimit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteUsageLimit API operation.", Operation = new[] {"DeleteUsageLimit"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteUsageLimitResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteUsageLimitResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteUsageLimitResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRSUsageLimitCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSUsageLimit (DeleteUsageLimit)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteUsageLimitResponse, RemoveRSUsageLimitCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeleteUsageLimitRequest();
        ...
        private Amazon.Redshift.Model.DeleteUsageLimitResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteUsageLimitRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeleteUsageLimit");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String UsageLimitId { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteUsageLimitResponse, RemoveRSUsageLimitCmdlet, object> Select { get; set; } =
