...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeTableRestoreStatus API operation.", Operation = new[] {"DescribeTableRestoreStatus"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeTableRestoreStatusResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.TableRestoreStatus or Amazon.Redshift.Model.DescribeTableRestoreStatusResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.TableRestoreStatus objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeTableRestoreStatusResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSTableRestoreStatusCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TableRestoreStatusDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeTableRestoreStatusResponse, GetRSTableRestoreStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Redshift.Model.DescribeTableRestoreStatusRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.TableRestoreStatusDetails?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeTableRestoreStatusResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeTableRestoreStatusRequest request)
        {
            ...
            try
            {
                return client.DescribeTableRestoreStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String TableRestoreRequestId { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeTableRestoreStatusResponse, GetRSTableRestoreStatusCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TableRestoreStatusDetails;
        }
