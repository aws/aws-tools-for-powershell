...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSSnapshotSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteSnapshotSchedule API operation.", Operation = new[] {"DeleteSnapshotSchedule"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteSnapshotScheduleResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteSnapshotScheduleResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteSnapshotScheduleResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRSSnapshotScheduleCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSSnapshotSchedule (DeleteSnapshotSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteSnapshotScheduleResponse, RemoveRSSnapshotScheduleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeleteSnapshotScheduleRequest();
        ...
        private Amazon.Redshift.Model.DeleteSnapshotScheduleResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteSnapshotScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeleteSnapshotSchedule");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ScheduleIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteSnapshotScheduleResponse, RemoveRSSnapshotScheduleCmdlet, object> Select { get; set; } =
