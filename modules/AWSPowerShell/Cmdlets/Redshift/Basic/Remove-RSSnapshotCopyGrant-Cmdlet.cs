...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class RemoveRSSnapshotCopyGrantCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SnapshotCopyGrantName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteSnapshotCopyGrantResponse, RemoveRSSnapshotCopyGrantCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SnapshotCopyGrantName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeleteSnapshotCopyGrantRequest();
        ...
        private Amazon.Redshift.Model.DeleteSnapshotCopyGrantResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteSnapshotCopyGrantRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteSnapshotCopyGrantAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SnapshotCopyGrantName { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteSnapshotCopyGrantResponse, RemoveRSSnapshotCopyGrantCmdlet, object> Select { get; set; } =
