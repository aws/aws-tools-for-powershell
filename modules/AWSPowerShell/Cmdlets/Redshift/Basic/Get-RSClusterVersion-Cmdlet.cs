...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterVersions API operation.", Operation = new[] {"DescribeClusterVersions"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeClusterVersionsResponse), LegacyAlias="Get-RSClusterVersions")]
    [AWSCmdletOutput("Amazon.Redshift.Model.ClusterVersion or Amazon.Redshift.Model.DescribeClusterVersionsResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.ClusterVersion objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeClusterVersionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSClusterVersionCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeClusterVersionsResponse, GetRSClusterVersionCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeClusterVersionsResponse, GetRSClusterVersionCmdlet, object> Select { get; set; } =
