...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class GetRSOrderableClusterOptionCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.OrderableClusterOptions?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeOrderableClusterOptionsRequest request)
        {
            ...
            try
            {
                return client.DescribeOrderableClusterOptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
