...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeOrderableClusterOptions API operation.", Operation = new[] {"DescribeOrderableClusterOptions"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse), LegacyAlias="Get-RSOrderableClusterOptions")]
    [AWSCmdletOutput("Amazon.Redshift.Model.OrderableClusterOption or Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.OrderableClusterOption objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSOrderableClusterOptionCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OrderableClusterOptions";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ClusterVersion' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse, GetRSOrderableClusterOptionCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ClusterVersion;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String NodeType { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeOrderableClusterOptionsResponse, GetRSOrderableClusterOptionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OrderableClusterOptions;
        }
