...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSPartner")]
    [OutputType("Amazon.Redshift.Model.PartnerIntegrationInfo")]
    ...
    public partial class GetRSPartnerCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The cluster identifier of the cluster whose partner integration is being described.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the database whose partner integration is being described. If database
        /// name is not specified, then all databases in the cluster are described.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the partner that is being described. If partner name is not specified,
        /// then all partner integrations are described.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'PartnerIntegrationInfoList'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.DescribePartnersResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.DescribePartnersResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribePartnersResponse, GetRSPartnerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DescribePartnersRequest();
        ...
        private Amazon.Redshift.Model.DescribePartnersResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribePartnersRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DatabaseName { get; set; }
            public System.String PartnerName { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribePartnersResponse, GetRSPartnerCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PartnerIntegrationInfoList;
        }
