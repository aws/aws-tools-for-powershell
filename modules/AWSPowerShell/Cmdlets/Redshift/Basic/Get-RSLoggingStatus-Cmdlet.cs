...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class GetRSLoggingStatusCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeLoggingStatusResponse, GetRSLoggingStatusCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.DescribeLoggingStatusResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeLoggingStatusRequest request)
        {
            ...
            try
            {
                return client.DescribeLoggingStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ClusterIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeLoggingStatusResponse, GetRSLoggingStatusCmdlet, object> Select { get; set; } =
