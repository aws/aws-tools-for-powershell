...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeReservedNodeOfferings API operation.", Operation = new[] {"DescribeReservedNodeOfferings"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse), LegacyAlias="Get-RSReservedNodeOfferings")]
    [AWSCmdletOutput("Amazon.Redshift.Model.ReservedNodeOffering or Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.ReservedNodeOffering objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSReservedNodeOfferingCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReservedNodeOfferings";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse, GetRSReservedNodeOfferingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ReservedNodeOfferings?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeReservedNodeOfferingsRequest request)
        {
            ...
            try
            {
                return client.DescribeReservedNodeOfferingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String ReservedNodeOfferingId { get; set; }
            public System.Func<Amazon.Redshift.Model.DescribeReservedNodeOfferingsResponse, GetRSReservedNodeOfferingCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReservedNodeOfferings;
        }
