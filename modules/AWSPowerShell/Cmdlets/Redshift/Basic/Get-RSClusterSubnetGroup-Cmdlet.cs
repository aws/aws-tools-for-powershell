...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift DescribeClusterSubnetGroups API operation.", Operation = new[] {"DescribeClusterSubnetGroups"}, SelectReturnType = typeof(Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse), LegacyAlias="Get-RSClusterSubnetGroups")]
    [AWSCmdletOutput("Amazon.Redshift.Model.ClusterSubnetGroup or Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse",
        "This cmdlet returns a collection of Amazon.Redshift.Model.ClusterSubnetGroup objects.",
        "The service call response (type Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSClusterSubnetGroupCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ClusterSubnetGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse, GetRSClusterSubnetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ClusterSubnetGroups?.Count ?? 0;
        ...
        private Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DescribeClusterSubnetGroupsRequest request)
        {
            ...
            try
            {
                return client.DescribeClusterSubnetGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Redshift.Model.DescribeClusterSubnetGroupsResponse, GetRSClusterSubnetGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ClusterSubnetGroups;
        }
