...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Add", "RSPartner", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddRSPartnerCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.AddPartnerResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.AddPartnerResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-RSPartner (AddPartner)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.AddPartnerResponse, AddRSPartnerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.AddPartnerRequest();
        ...
        private Amazon.Redshift.Model.AddPartnerResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.AddPartnerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "AddPartner");
            try
            {
                #if DESKTOP
                return client.AddPartner(request);
                #elif CORECLR
                return client.AddPartnerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DatabaseName { get; set; }
            public System.String PartnerName { get; set; }
            public System.Func<Amazon.Redshift.Model.AddPartnerResponse, AddRSPartnerCmdlet, object> Select { get; set; } =
