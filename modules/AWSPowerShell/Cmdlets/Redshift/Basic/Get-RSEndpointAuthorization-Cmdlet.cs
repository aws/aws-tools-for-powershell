...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdletOutput("Amazon.Redshift.Model.EndpointAuthorization or Amazon.Redshift.Model.DescribeEndpointAuthorizationResponse",
        ...
        "The service call response (type Amazon.Redshift.Model.DescribeEndpointAuthorizationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
