...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteClusterSecurityGroup API operation.", Operation = new[] {"DeleteClusterSecurityGroup"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveRSClusterSecurityGroupCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse, RemoveRSClusterSecurityGroupCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteClusterSecurityGroupRequest request)
        {
            ...
            try
            {
                return client.DeleteClusterSecurityGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ClusterSecurityGroupName { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteClusterSecurityGroupResponse, RemoveRSClusterSecurityGroupCmdlet, object> Select { get; set; } =
