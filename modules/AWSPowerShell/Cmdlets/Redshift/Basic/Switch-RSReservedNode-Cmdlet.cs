...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift AcceptReservedNodeExchange API operation.", Operation = new[] {"AcceptReservedNodeExchange"}, SelectReturnType = typeof(Amazon.Redshift.Model.AcceptReservedNodeExchangeResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.ReservedNode or Amazon.Redshift.Model.AcceptReservedNodeExchangeResponse",
        "This cmdlet returns an Amazon.Redshift.Model.ReservedNode object.",
        "The service call response (type Amazon.Redshift.Model.AcceptReservedNodeExchangeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class SwitchRSReservedNodeCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ExchangedReservedNode";
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ReservedNodeId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ReservedNodeId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.AcceptReservedNodeExchangeResponse, SwitchRSReservedNodeCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ReservedNodeId;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.ReservedNodeId = this.ReservedNodeId;
            #if MODULAR
            if (this.ReservedNodeId == null && ParameterWasBound(nameof(this.ReservedNodeId)))
            {
                WriteWarning("You are passing $null as a value for parameter ReservedNodeId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.TargetReservedNodeOfferingId = this.TargetReservedNodeOfferingId;
            #if MODULAR
            if (this.TargetReservedNodeOfferingId == null && ParameterWasBound(nameof(this.TargetReservedNodeOfferingId)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetReservedNodeOfferingId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ReservedNodeId { get; set; }
            public System.String TargetReservedNodeOfferingId { get; set; }
            public System.Func<Amazon.Redshift.Model.AcceptReservedNodeExchangeResponse, SwitchRSReservedNodeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ExchangedReservedNode;
        }
