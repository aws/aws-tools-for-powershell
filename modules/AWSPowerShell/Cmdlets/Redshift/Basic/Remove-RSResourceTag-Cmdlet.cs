...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class RemoveRSResourceTagCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag key that you want to delete.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSResourceTag (DeleteTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteTagsResponse, RemoveRSResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Redshift.Model.DeleteTagsResponse, RemoveRSResourceTagCmdlet, object> Select { get; set; } =
