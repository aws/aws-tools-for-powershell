...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class RemoveRSHsmClientCertificateCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteHsmClientCertificateResponse, RemoveRSHsmClientCertificateCmdlet>(Select) ??
        ...
        private Amazon.Redshift.Model.DeleteHsmClientCertificateResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteHsmClientCertificateRequest request)
        {
            ...
            try
            {
                return client.DeleteHsmClientCertificateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String HsmClientCertificateIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteHsmClientCertificateResponse, RemoveRSHsmClientCertificateCmdlet, object> Select { get; set; } =
