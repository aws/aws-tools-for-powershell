...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class RevokeRSDataShareCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.DeauthorizeDataShareResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.DeauthorizeDataShareResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Revoke-RSDataShare (DeauthorizeDataShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeauthorizeDataShareResponse, RevokeRSDataShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeauthorizeDataShareRequest();
        ...
        private Amazon.Redshift.Model.DeauthorizeDataShareResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeauthorizeDataShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeauthorizeDataShare");
            try
            {
                #if DESKTOP
                return client.DeauthorizeDataShare(request);
                #elif CORECLR
                return client.DeauthorizeDataShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConsumerIdentifier { get; set; }
            public System.String DataShareArn { get; set; }
            public System.Func<Amazon.Redshift.Model.DeauthorizeDataShareResponse, RevokeRSDataShareCmdlet, object> Select { get; set; } =
