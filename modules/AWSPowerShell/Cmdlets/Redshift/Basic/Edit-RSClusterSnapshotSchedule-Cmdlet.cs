...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Edit", "RSClusterSnapshotSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class EditRSClusterSnapshotScheduleCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        #region Parameter DisassociateSchedule
        /// <summary>
        /// <para>
        ...
        public System.Boolean? DisassociateSchedule { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-RSClusterSnapshotSchedule (ModifyClusterSnapshotSchedule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.ModifyClusterSnapshotScheduleResponse, EditRSClusterSnapshotScheduleCmdlet>(Select) ??
            ...
            #endif
            context.DisassociateSchedule = this.DisassociateSchedule;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.ModifyClusterSnapshotScheduleRequest();
            
            if (cmdletContext.ClusterIdentifier != null)
            {
                request.ClusterIdentifier = cmdletContext.ClusterIdentifier;
            }
            if (cmdletContext.DisassociateSchedule != null)
            {
                request.DisassociateSchedule = cmdletContext.DisassociateSchedule.Value;
            }
        ...
        private Amazon.Redshift.Model.ModifyClusterSnapshotScheduleResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.ModifyClusterSnapshotScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "ModifyClusterSnapshotSchedule");
            try
            {
                #if DESKTOP
                return client.ModifyClusterSnapshotSchedule(request);
                #elif CORECLR
                return client.ModifyClusterSnapshotScheduleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? DisassociateSchedule { get; set; }
            public System.String ScheduleIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.ModifyClusterSnapshotScheduleResponse, EditRSClusterSnapshotScheduleCmdlet, object> Select { get; set; } =
