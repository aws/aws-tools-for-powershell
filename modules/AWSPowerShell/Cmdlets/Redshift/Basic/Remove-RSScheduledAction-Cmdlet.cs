...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSScheduledAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteScheduledAction API operation.", Operation = new[] {"DeleteScheduledAction"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteScheduledActionResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteScheduledActionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteScheduledActionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRSScheduledActionCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSScheduledAction (DeleteScheduledAction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteScheduledActionResponse, RemoveRSScheduledActionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.DeleteScheduledActionRequest();
        ...
        private Amazon.Redshift.Model.DeleteScheduledActionResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteScheduledActionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "DeleteScheduledAction");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ScheduledActionName { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteScheduledActionResponse, RemoveRSScheduledActionCmdlet, object> Select { get; set; } =
