...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSHsmConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Redshift DeleteHsmConfiguration API operation.", Operation = new[] {"DeleteHsmConfiguration"}, SelectReturnType = typeof(Amazon.Redshift.Model.DeleteHsmConfigurationResponse))]
    [AWSCmdletOutput("None or Amazon.Redshift.Model.DeleteHsmConfigurationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Redshift.Model.DeleteHsmConfigurationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveRSHsmConfigurationCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^HsmConfigurationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.HsmConfigurationIdentifier), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSHsmConfiguration (DeleteHsmConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.DeleteHsmConfigurationResponse, RemoveRSHsmConfigurationCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.HsmConfigurationIdentifier;
            }
        ...
        private Amazon.Redshift.Model.DeleteHsmConfigurationResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.DeleteHsmConfigurationRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteHsmConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String HsmConfigurationIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.DeleteHsmConfigurationResponse, RemoveRSHsmConfigurationCmdlet, object> Select { get; set; } =
