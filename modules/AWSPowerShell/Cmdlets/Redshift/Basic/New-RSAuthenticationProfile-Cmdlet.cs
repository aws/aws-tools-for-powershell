...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("New", "RSAuthenticationProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewRSAuthenticationProfileCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The content of the authentication profile in JSON format. The maximum length of the
        /// JSON string is determined by a quota for your account.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the authentication profile to be created.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.CreateAuthenticationProfileResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.CreateAuthenticationProfileResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-RSAuthenticationProfile (CreateAuthenticationProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.CreateAuthenticationProfileResponse, NewRSAuthenticationProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.CreateAuthenticationProfileRequest();
        ...
        private Amazon.Redshift.Model.CreateAuthenticationProfileResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.CreateAuthenticationProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "CreateAuthenticationProfile");
            try
            {
                #if DESKTOP
                return client.CreateAuthenticationProfile(request);
                #elif CORECLR
                return client.CreateAuthenticationProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AuthenticationProfileContent { get; set; }
            public System.String AuthenticationProfileName { get; set; }
            public System.Func<Amazon.Redshift.Model.CreateAuthenticationProfileResponse, NewRSAuthenticationProfileCmdlet, object> Select { get; set; } =
