...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    /// </summary>
    [Cmdlet("Start", "RSCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Redshift.Model.Cluster")]
    [AWSCmdlet("Calls the Amazon Redshift ResumeCluster API operation.", Operation = new[] {"ResumeCluster"}, SelectReturnType = typeof(Amazon.Redshift.Model.ResumeClusterResponse))]
    [AWSCmdletOutput("Amazon.Redshift.Model.Cluster or Amazon.Redshift.Model.ResumeClusterResponse",
        "This cmdlet returns an Amazon.Redshift.Model.Cluster object.",
        "The service call response (type Amazon.Redshift.Model.ResumeClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartRSClusterCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-RSCluster (ResumeCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.ResumeClusterResponse, StartRSClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.ResumeClusterRequest();
        ...
        private Amazon.Redshift.Model.ResumeClusterResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.ResumeClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "ResumeCluster");
            try
            {
                #if DESKTOP
                return client.ResumeCluster(request);
                #elif CORECLR
                return client.ResumeClusterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ClusterIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.ResumeClusterResponse, StartRSClusterCmdlet, object> Select { get; set; } =
