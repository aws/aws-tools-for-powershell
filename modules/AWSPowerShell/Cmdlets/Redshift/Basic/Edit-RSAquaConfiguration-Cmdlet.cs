...
namespace Amazon.PowerShell.Cmdlets.RS
{
    ...
    public partial class EditRSAquaConfigurationCmdlet : AmazonRedshiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The identifier of the cluster to be modified.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'AquaConfiguration'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Redshift.Model.ModifyAquaConfigurationResponse).
        /// Specifying the name of a property of type Amazon.Redshift.Model.ModifyAquaConfigurationResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AquaConfiguration";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Edit-RSAquaConfiguration (ModifyAquaConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Redshift.Model.ModifyAquaConfigurationResponse, EditRSAquaConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Redshift.Model.ModifyAquaConfigurationRequest();
        ...
        private Amazon.Redshift.Model.ModifyAquaConfigurationResponse CallAWSServiceOperation(IAmazonRedshift client, Amazon.Redshift.Model.ModifyAquaConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift", "ModifyAquaConfiguration");
            try
            {
                #if DESKTOP
                return client.ModifyAquaConfiguration(request);
                #elif CORECLR
                return client.ModifyAquaConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.Redshift.AquaConfigurationStatus AquaConfigurationStatus { get; set; }
            public System.String ClusterIdentifier { get; set; }
            public System.Func<Amazon.Redshift.Model.ModifyAquaConfigurationResponse, EditRSAquaConfigurationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AquaConfiguration;
        }
