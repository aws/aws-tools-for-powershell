...
namespace Amazon.PowerShell.Cmdlets.KINA
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Kinesis Analytics DeleteApplication API operation.", Operation = new[] {"DeleteApplication"}, SelectReturnType = typeof(Amazon.KinesisAnalytics.Model.DeleteApplicationResponse))]
    [AWSCmdletOutput("None or Amazon.KinesisAnalytics.Model.DeleteApplicationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.KinesisAnalytics.Model.DeleteApplicationResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveKINAApplicationCmdlet : AmazonKinesisAnalyticsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.KinesisAnalytics.Model.DeleteApplicationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalytics.Model.DeleteApplicationResponse, RemoveKINAApplicationCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ApplicationName { get; set; }
            public System.DateTime? CreateTimestamp { get; set; }
            public System.Func<Amazon.KinesisAnalytics.Model.DeleteApplicationResponse, RemoveKINAApplicationCmdlet, object> Select { get; set; } =
