...
namespace Amazon.PowerShell.Cmdlets.KINA
{
    ...
    /// Tagging</a>.
    /// </summary>
    [Cmdlet("Get", "KINAResourceTag")]
    [OutputType("Amazon.KinesisAnalytics.Model.Tag")]
    ...
    public partial class GetKINAResourceTagCmdlet : AmazonKinesisAnalyticsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.KinesisAnalytics.Model.ListTagsForResourceResponse).
        /// Specifying the name of a property of type Amazon.KinesisAnalytics.Model.ListTagsForResourceResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalytics.Model.ListTagsForResourceResponse, GetKINAResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.KinesisAnalytics.Model.ListTagsForResourceRequest();
        ...
        private Amazon.KinesisAnalytics.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonKinesisAnalytics client, Amazon.KinesisAnalytics.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.KinesisAnalytics.Model.ListTagsForResourceResponse, GetKINAResourceTagCmdlet, object> Select { get; set; } =
