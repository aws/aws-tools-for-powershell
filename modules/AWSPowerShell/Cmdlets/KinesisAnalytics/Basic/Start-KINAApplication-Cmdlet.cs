...
namespace Amazon.PowerShell.Cmdlets.KINA
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Kinesis Analytics StartApplication API operation.", Operation = new[] {"StartApplication"}, SelectReturnType = typeof(Amazon.KinesisAnalytics.Model.StartApplicationResponse))]
    [AWSCmdletOutput("None or Amazon.KinesisAnalytics.Model.StartApplicationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.KinesisAnalytics.Model.StartApplicationResponse) be returned by specifying '-Select *'."
    )]
    public partial class StartKINAApplicationCmdlet : AmazonKinesisAnalyticsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.KinesisAnalytics.Model.StartApplicationResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.KinesisAnalytics.Model.StartApplicationResponse, StartKINAApplicationCmdlet>(Select) ??
            ...
            {
                context.InputConfiguration = new List<Amazon.KinesisAnalytics.Model.InputConfiguration>(this.InputConfiguration);
            }
            #if MODULAR
            if (this.InputConfiguration == null && ParameterWasBound(nameof(this.InputConfiguration)))
            {
                WriteWarning("You are passing $null as a value for parameter InputConfiguration which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.InputConfiguration != null)
            {
                request.InputConfigurations = cmdletContext.InputConfiguration;
            }
        ...
        private Amazon.KinesisAnalytics.Model.StartApplicationResponse CallAWSServiceOperation(IAmazonKinesisAnalytics client, Amazon.KinesisAnalytics.Model.StartApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Kinesis Analytics", "StartApplication");
            try
            {
        ...
        {
            public System.String ApplicationName { get; set; }
            public List<Amazon.KinesisAnalytics.Model.InputConfiguration> InputConfiguration { get; set; }
            public System.Func<Amazon.KinesisAnalytics.Model.StartApplicationResponse, StartKINAApplicationCmdlet, object> Select { get; set; } =
