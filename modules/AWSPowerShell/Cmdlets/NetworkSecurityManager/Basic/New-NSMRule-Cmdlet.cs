...
namespace Amazon.PowerShell.Cmdlets.NSM
{
    ...
    /// </summary>
    [Cmdlet("New", "NSMRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.NetworkSecurityManager.Model.CreateRuleResponse")]
    [AWSCmdlet("Calls the AWS Network Security Manager Customer API CreateRule API operation.", Operation = new[] {"CreateRule"}, SelectReturnType = typeof(Amazon.NetworkSecurityManager.Model.CreateRuleResponse))]
    [AWSCmdletOutput("Amazon.NetworkSecurityManager.Model.CreateRuleResponse",
        "This cmdlet returns an Amazon.NetworkSecurityManager.Model.CreateRuleResponse object containing multiple properties."
    )]
    public partial class NewNSMRuleCmdlet : AmazonNetworkSecurityManagerClientCmdlet, IExecutor
    {
        ...
        public Amazon.NetworkSecurityManager.RuleFirewallType FirewallType { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.NetworkSecurityManager.Model.CreateRuleResponse).
        /// Specifying the name of a property of type Amazon.NetworkSecurityManager.Model.CreateRuleResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-NSMRule (CreateRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.NetworkSecurityManager.Model.CreateRuleResponse, NewNSMRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.NetworkSecurityManager.Model.CreateRuleRequest();
        ...
        private Amazon.NetworkSecurityManager.Model.CreateRuleResponse CallAWSServiceOperation(IAmazonNetworkSecurityManager client, Amazon.NetworkSecurityManager.Model.CreateRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Network Security Manager Customer API", "CreateRule");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.NetworkSecurityManager.Model.CreateRuleResponse, NewNSMRuleCmdlet, object> Select { get; set; } =
