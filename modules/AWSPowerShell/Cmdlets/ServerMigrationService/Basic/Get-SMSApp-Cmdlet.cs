...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    public partial class GetSMSAppCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.GetAppResponse, GetSMSAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServerMigrationService.Model.GetAppRequest();
        ...
        private Amazon.ServerMigrationService.Model.GetAppResponse CallAWSServiceOperation(IAmazonServerMigrationService client, Amazon.ServerMigrationService.Model.GetAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "GetApp");
            try
            {
                return client.GetAppAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String AppId { get; set; }
            public System.Func<Amazon.ServerMigrationService.Model.GetAppResponse, GetSMSAppCmdlet, object> Select { get; set; } =
