...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.GetServersResponse",
        "This cmdlet returns an Amazon.ServerMigrationService.Model.GetServersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
