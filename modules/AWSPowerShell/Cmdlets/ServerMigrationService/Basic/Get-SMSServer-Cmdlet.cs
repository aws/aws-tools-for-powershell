...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the AWS Server Migration Service GetServers API operation.", Operation = new[] {"GetServers"}, SelectReturnType = typeof(Amazon.ServerMigrationService.Model.GetServersResponse))]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.GetServersResponse",
        "This cmdlet returns an Amazon.ServerMigrationService.Model.GetServersResponse object containing multiple properties."
    )]
    public partial class GetSMSServerCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The server addresses.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.GetServersResponse, GetSMSServerCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "GetServers");
            try
            {
                return client.GetServersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
