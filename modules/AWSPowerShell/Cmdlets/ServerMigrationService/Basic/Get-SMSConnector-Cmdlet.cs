...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the AWS Server Migration Service GetConnectors API operation.", Operation = new[] {"GetConnectors"}, SelectReturnType = typeof(Amazon.ServerMigrationService.Model.GetConnectorsResponse))]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.Connector or Amazon.ServerMigrationService.Model.GetConnectorsResponse",
        "This cmdlet returns a collection of Amazon.ServerMigrationService.Model.Connector objects.",
        "The service call response (type Amazon.ServerMigrationService.Model.GetConnectorsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMSConnectorCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConnectorList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.GetConnectorsResponse, GetSMSConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServerMigrationService.Model.GetConnectorsRequest();
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "GetConnectors");
            try
            {
                return client.GetConnectorsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ServerMigrationService.Model.GetConnectorsResponse, GetSMSConnectorCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConnectorList;
        }
