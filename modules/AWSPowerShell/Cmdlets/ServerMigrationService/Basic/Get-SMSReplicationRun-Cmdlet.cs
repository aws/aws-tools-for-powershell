...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    public partial class GetSMSReplicationRunCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.GetReplicationRunsResponse, GetSMSReplicationRunCmdlet>(Select) ??
        ...
        private Amazon.ServerMigrationService.Model.GetReplicationRunsResponse CallAWSServiceOperation(IAmazonServerMigrationService client, Amazon.ServerMigrationService.Model.GetReplicationRunsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "GetReplicationRuns");
            try
            {
                return client.GetReplicationRunsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
