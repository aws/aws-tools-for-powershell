...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    /// </summary>
    [Cmdlet("Get", "SMSAppList")]
    [OutputType("Amazon.ServerMigrationService.Model.AppSummary")]
    [AWSCmdlet("Calls the AWS Server Migration Service ListApps API operation.", Operation = new[] {"ListApps"}, SelectReturnType = typeof(Amazon.ServerMigrationService.Model.ListAppsResponse))]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.AppSummary or Amazon.ServerMigrationService.Model.ListAppsResponse",
        "This cmdlet returns a collection of Amazon.ServerMigrationService.Model.AppSummary objects.",
        "The service call response (type Amazon.ServerMigrationService.Model.ListAppsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSMSAppListCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.ListAppsResponse, GetSMSAppListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServerMigrationService.Model.ListAppsRequest();
        ...
        private Amazon.ServerMigrationService.Model.ListAppsResponse CallAWSServiceOperation(IAmazonServerMigrationService client, Amazon.ServerMigrationService.Model.ListAppsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "ListApps");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ServerMigrationService.Model.ListAppsResponse, GetSMSAppListCmdlet, object> Select { get; set; } =
