...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    public partial class ImportSMSServerCatalogCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.ImportServerCatalogResponse, ImportSMSServerCatalogCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "ImportServerCatalog");
            try
            {
                return client.ImportServerCatalogAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.ServerMigrationService.Model.ImportServerCatalogResponse, ImportSMSServerCatalogCmdlet, object> Select { get; set; } =
