...
namespace Amazon.PowerShell.Cmdlets.SMS
{
    ...
    [AWSCmdlet("Calls the AWS Server Migration Service GetReplicationJobs API operation.", Operation = new[] {"GetReplicationJobs"}, SelectReturnType = typeof(Amazon.ServerMigrationService.Model.GetReplicationJobsResponse))]
    [AWSCmdletOutput("Amazon.ServerMigrationService.Model.ReplicationJob or Amazon.ServerMigrationService.Model.GetReplicationJobsResponse",
        "This cmdlet returns a collection of Amazon.ServerMigrationService.Model.ReplicationJob objects.",
        "The service call response (type Amazon.ServerMigrationService.Model.GetReplicationJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSMSReplicationJobCmdlet : AmazonServerMigrationServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ReplicationJobList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServerMigrationService.Model.GetReplicationJobsResponse, GetSMSReplicationJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServerMigrationService.Model.GetReplicationJobsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ReplicationJobList?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Server Migration Service", "GetReplicationJobs");
            try
            {
                return client.GetReplicationJobsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ReplicationJobId { get; set; }
            public System.Func<Amazon.ServerMigrationService.Model.GetReplicationJobsResponse, GetSMSReplicationJobCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ReplicationJobList;
        }
