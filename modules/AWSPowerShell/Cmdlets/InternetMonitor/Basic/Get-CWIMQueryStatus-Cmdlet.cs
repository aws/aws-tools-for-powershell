...
namespace Amazon.PowerShell.Cmdlets.CWIM
{
    ...
    /// 
    ///  <ul><li><para><code>QUEUED</code>: The query is scheduled to run.
    /// </para></li><li><para><code>RUNNING</code>: The query is in progress but not complete.
    /// </para></li><li><para><code>SUCCEEDED</code>: The query completed sucessfully.
    /// </para></li><li><para><code>FAILED</code>: The query failed due to an error.
    /// </para></li><li><para><code>CANCELED</code>: The query was canceled.
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Get", "CWIMQueryStatus")]
    [OutputType("Amazon.InternetMonitor.QueryStatus")]
    ...
    public partial class GetCWIMQueryStatusCmdlet : AmazonInternetMonitorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the query that you want to return the status for. A <code>QueryId</code>
        /// is an internally-generated dentifier for a specific query.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.InternetMonitor.Model.GetQueryStatusResponse, GetCWIMQueryStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.InternetMonitor.Model.GetQueryStatusRequest();
        ...
        private Amazon.InternetMonitor.Model.GetQueryStatusResponse CallAWSServiceOperation(IAmazonInternetMonitor client, Amazon.InternetMonitor.Model.GetQueryStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Internet Monitor", "GetQueryStatus");
            try
            {
                #if DESKTOP
                return client.GetQueryStatus(request);
                #elif CORECLR
                return client.GetQueryStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String MonitorName { get; set; }
            public System.String QueryId { get; set; }
            public System.Func<Amazon.InternetMonitor.Model.GetQueryStatusResponse, GetCWIMQueryStatusCmdlet, object> Select { get; set; } =
