...
namespace Amazon.PowerShell.Cmdlets.CWIM
{
    ...
    public partial class AddCWIMResourceTagCmdlet : AmazonInternetMonitorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tags that you add to a resource. You can add a maximum of 50 tags in Internet Monitor.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CWIMResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.InternetMonitor.Model.TagResourceResponse, AddCWIMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.InternetMonitor.Model.TagResourceRequest();
        ...
        private Amazon.InternetMonitor.Model.TagResourceResponse CallAWSServiceOperation(IAmazonInternetMonitor client, Amazon.InternetMonitor.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Internet Monitor", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.InternetMonitor.Model.TagResourceResponse, AddCWIMResourceTagCmdlet, object> Select { get; set; } =
