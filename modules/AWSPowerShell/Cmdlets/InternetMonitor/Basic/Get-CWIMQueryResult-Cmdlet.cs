...
namespace Amazon.PowerShell.Cmdlets.CWIM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CWIMQueryResult")]
    [OutputType("Amazon.InternetMonitor.Model.GetQueryResultsResponse")]
    [AWSCmdlet("Calls the Amazon CloudWatch Internet Monitor GetQueryResults API operation.", Operation = new[] {"GetQueryResults"}, SelectReturnType = typeof(Amazon.InternetMonitor.Model.GetQueryResultsResponse))]
    [AWSCmdletOutput("Amazon.InternetMonitor.Model.GetQueryResultsResponse",
        "This cmdlet returns an Amazon.InternetMonitor.Model.GetQueryResultsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWIMQueryResultCmdlet : AmazonInternetMonitorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.InternetMonitor.Model.GetQueryResultsResponse, GetCWIMQueryResultCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.InternetMonitor.Model.GetQueryResultsRequest();
        ...
        private Amazon.InternetMonitor.Model.GetQueryResultsResponse CallAWSServiceOperation(IAmazonInternetMonitor client, Amazon.InternetMonitor.Model.GetQueryResultsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueryId { get; set; }
            public System.Func<Amazon.InternetMonitor.Model.GetQueryResultsResponse, GetCWIMQueryResultCmdlet, object> Select { get; set; } =
