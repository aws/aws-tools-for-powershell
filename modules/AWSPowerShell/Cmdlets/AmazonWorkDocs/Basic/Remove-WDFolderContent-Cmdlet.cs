...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    public partial class RemoveWDFolderContentCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WDFolderContent (DeleteFolderContents)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkDocs.Model.DeleteFolderContentsRequest();
        ...
        private Amazon.WorkDocs.Model.DeleteFolderContentsResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.DeleteFolderContentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkDocs", "DeleteFolderContents");
            try
            {
                #if DESKTOP
                return client.DeleteFolderContents(request);
                #elif CORECLR
                return client.DeleteFolderContentsAsync(request).GetAwaiter().GetResult();
                #else
