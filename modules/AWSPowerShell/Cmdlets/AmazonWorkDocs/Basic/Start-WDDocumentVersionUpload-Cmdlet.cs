...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdlet("Invokes the InitiateDocumentVersionUpload operation against Amazon WorkDocs.", Operation = new[] {"InitiateDocumentVersionUpload"})]
    ...
    public partial class StartWDDocumentVersionUploadCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WorkDocs.Model.InitiateDocumentVersionUploadResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.InitiateDocumentVersionUploadRequest request)
        {
            #if DESKTOP
