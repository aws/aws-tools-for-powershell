...
namespace Amazon.PowerShell.Cmdlets.WD
{
    ...
    [AWSCmdlet("Invokes the CreateUser operation against Amazon WorkDocs.", Operation = new[] {"CreateUser"})]
    ...
    public partial class NewWDUserCmdlet : AmazonWorkDocsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WorkDocs.Model.CreateUserResponse CallAWSServiceOperation(IAmazonWorkDocs client, Amazon.WorkDocs.Model.CreateUserRequest request)
        {
            #if DESKTOP
