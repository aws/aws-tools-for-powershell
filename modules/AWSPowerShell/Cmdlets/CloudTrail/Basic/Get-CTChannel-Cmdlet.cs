...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    [AWSCmdlet("Calls the AWS CloudTrail GetChannel API operation.", Operation = new[] {"GetChannel"}, SelectReturnType = typeof(Amazon.CloudTrail.Model.GetChannelResponse))]
    [AWSCmdletOutput("Amazon.CloudTrail.Model.GetChannelResponse",
        "This cmdlet returns an Amazon.CloudTrail.Model.GetChannelResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCTChannelCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudTrail.Model.GetChannelResponse, GetCTChannelCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudTrail.Model.GetChannelRequest();
        ...
        private Amazon.CloudTrail.Model.GetChannelResponse CallAWSServiceOperation(IAmazonCloudTrail client, Amazon.CloudTrail.Model.GetChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudTrail", "GetChannel");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Channel { get; set; }
            public System.Func<Amazon.CloudTrail.Model.GetChannelResponse, GetCTChannelCmdlet, object> Select { get; set; } =
