...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    public partial class UpdateCTTrailCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        /// leader Region (for example, us-east-1).</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        #region Parameter RecursiveLogging
        /// <summary>
        /// <para>
        /// <para>Specifies whether recursive logging is enabled for the trail. If you set <c>RecursiveLogging</c>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.Boolean? RecursiveLogging { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            #endif
            context.RecursiveLogging = this.RecursiveLogging;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.RecursiveLogging != null)
            {
                request.RecursiveLogging = cmdletContext.RecursiveLogging.Value;
            }
