...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    [AWSCmdletOutput("Amazon.CloudTrail.Model.EnableFederationResponse",
        "This cmdlet returns an Amazon.CloudTrail.Model.EnableFederationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
