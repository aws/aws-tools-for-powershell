...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    /// </summary>
    [Cmdlet("New", "CTChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewCTChannelCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more event data stores to which events arriving through a channel will be logged.</para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        public Amazon.CloudTrail.Model.Tag[] Tag { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CTChannel (CreateChannel)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudTrail.Model.CreateChannelResponse, NewCTChannelCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.CloudTrail.Model.Tag>(this.Tag);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudTrail.Model.CreateChannelRequest();
        ...
        private Amazon.CloudTrail.Model.CreateChannelResponse CallAWSServiceOperation(IAmazonCloudTrail client, Amazon.CloudTrail.Model.CreateChannelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudTrail", "CreateChannel");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String Source { get; set; }
            public List<Amazon.CloudTrail.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.CloudTrail.Model.CreateChannelResponse, NewCTChannelCmdlet, object> Select { get; set; } =
