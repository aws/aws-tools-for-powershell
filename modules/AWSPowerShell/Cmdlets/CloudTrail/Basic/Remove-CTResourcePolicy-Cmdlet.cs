...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    /// or channel.
    /// </summary>
    [Cmdlet("Remove", "CTResourcePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCTResourcePolicyCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        /// channel you're deleting the resource-based policy from.</para><para>Example event data store ARN format: <c>arn:aws:cloudtrail:us-east-2:123456789012:eventdatastore/EXAMPLE-f852-4e8f-8bd1-bcf6cEXAMPLE</c></para><para>Example dashboard ARN format: <c>arn:aws:cloudtrail:us-east-1:123456789012:dashboard/exampleDash</c></para><para>Example channel ARN format: <c>arn:aws:cloudtrail:us-east-2:123456789012:channel/01234567890</c></para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CTResourcePolicy (DeleteResourcePolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudTrail.Model.DeleteResourcePolicyResponse, RemoveCTResourcePolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudTrail.Model.DeleteResourcePolicyRequest();
        ...
        private Amazon.CloudTrail.Model.DeleteResourcePolicyResponse CallAWSServiceOperation(IAmazonCloudTrail client, Amazon.CloudTrail.Model.DeleteResourcePolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudTrail", "DeleteResourcePolicy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.CloudTrail.Model.DeleteResourcePolicyResponse, RemoveCTResourcePolicyCmdlet, object> Select { get; set; } =
