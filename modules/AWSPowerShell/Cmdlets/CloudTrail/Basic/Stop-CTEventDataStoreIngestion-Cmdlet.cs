...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CloudTrail StopEventDataStoreIngestion API operation.", Operation = new[] {"StopEventDataStoreIngestion"}, SelectReturnType = typeof(Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse))]
    [AWSCmdletOutput("None or Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopCTEventDataStoreIngestionCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-CTEventDataStoreIngestion (StopEventDataStoreIngestion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse, StopCTEventDataStoreIngestionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudTrail.Model.StopEventDataStoreIngestionRequest();
        ...
        private Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse CallAWSServiceOperation(IAmazonCloudTrail client, Amazon.CloudTrail.Model.StopEventDataStoreIngestionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CloudTrail", "StopEventDataStoreIngestion");
            try
            {
                #if DESKTOP
                return client.StopEventDataStoreIngestion(request);
                #elif CORECLR
                return client.StopEventDataStoreIngestionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EventDataStore { get; set; }
            public System.Func<Amazon.CloudTrail.Model.StopEventDataStoreIngestionResponse, StopCTEventDataStoreIngestionCmdlet, object> Select { get; set; } =
