...
namespace Amazon.PowerShell.Cmdlets.CT
{
    ...
    public partial class StartCTLoggingCmdlet : AmazonCloudTrailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudTrail.Model.StartLoggingResponse, StartCTLoggingCmdlet>(Select) ??
        ...
        private Amazon.CloudTrail.Model.StartLoggingResponse CallAWSServiceOperation(IAmazonCloudTrail client, Amazon.CloudTrail.Model.StartLoggingRequest request)
        {
            ...
            try
            {
                return client.StartLoggingAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudTrail.Model.StartLoggingResponse, StartCTLoggingCmdlet, object> Select { get; set; } =
