...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    public partial class RemoveC9ResourceTagCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag names of the tags to remove from the given Cloud9 development environment.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-C9ResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Cloud9.Model.UntagResourceResponse, RemoveC9ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Cloud9.Model.UntagResourceRequest();
        ...
        private Amazon.Cloud9.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Cloud9.Model.UntagResourceResponse, RemoveC9ResourceTagCmdlet, object> Select { get; set; } =
