...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Cloud9 DeleteEnvironmentMembership API operation.", Operation = new[] {"DeleteEnvironmentMembership"}, SelectReturnType = typeof(Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse))]
    [AWSCmdletOutput("None or Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveC9EnvironmentMembershipCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse, RemoveC9EnvironmentMembershipCmdlet>(Select) ??
        ...
        private Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.DeleteEnvironmentMembershipRequest request)
        {
            ...
            try
            {
                return client.DeleteEnvironmentMembershipAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String EnvironmentId { get; set; }
            public System.String UserArn { get; set; }
            public System.Func<Amazon.Cloud9.Model.DeleteEnvironmentMembershipResponse, RemoveC9EnvironmentMembershipCmdlet, object> Select { get; set; } =
