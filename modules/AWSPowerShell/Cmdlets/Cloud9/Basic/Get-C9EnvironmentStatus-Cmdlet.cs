...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    public partial class GetC9EnvironmentStatusCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Cloud9.Model.DescribeEnvironmentStatusResponse, GetC9EnvironmentStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Cloud9.Model.DescribeEnvironmentStatusRequest();
        ...
        private Amazon.Cloud9.Model.DescribeEnvironmentStatusResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.DescribeEnvironmentStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "DescribeEnvironmentStatus");
            try
            {
                #if DESKTOP
                return client.DescribeEnvironmentStatus(request);
                #elif CORECLR
                return client.DescribeEnvironmentStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EnvironmentId { get; set; }
            public System.Func<Amazon.Cloud9.Model.DescribeEnvironmentStatusResponse, GetC9EnvironmentStatusCmdlet, object> Select { get; set; } =
