...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    public partial class GetC9ResourceTagCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Cloud9.Model.ListTagsForResourceResponse, GetC9ResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Cloud9.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Cloud9.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.Cloud9.Model.ListTagsForResourceResponse, GetC9ResourceTagCmdlet, object> Select { get; set; } =
