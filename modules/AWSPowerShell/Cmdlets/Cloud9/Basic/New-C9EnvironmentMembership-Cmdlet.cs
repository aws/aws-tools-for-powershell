...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    /// </summary>
    [Cmdlet("New", "C9EnvironmentMembership", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Cloud9.Model.EnvironmentMember")]
    [AWSCmdlet("Calls the AWS Cloud9 CreateEnvironmentMembership API operation.", Operation = new[] {"CreateEnvironmentMembership"}, SelectReturnType = typeof(Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse))]
    [AWSCmdletOutput("Amazon.Cloud9.Model.EnvironmentMember or Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse",
        "This cmdlet returns an Amazon.Cloud9.Model.EnvironmentMember object.",
        "The service call response (type Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewC9EnvironmentMembershipCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-C9EnvironmentMembership (CreateEnvironmentMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse, NewC9EnvironmentMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Cloud9.Model.CreateEnvironmentMembershipRequest();
        ...
        private Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.CreateEnvironmentMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "CreateEnvironmentMembership");
            try
            {
                #if DESKTOP
                return client.CreateEnvironmentMembership(request);
                #elif CORECLR
                return client.CreateEnvironmentMembershipAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Cloud9.MemberPermissions Permission { get; set; }
            public System.String UserArn { get; set; }
            public System.Func<Amazon.Cloud9.Model.CreateEnvironmentMembershipResponse, NewC9EnvironmentMembershipCmdlet, object> Select { get; set; } =
