...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    [AWSCmdlet("Calls the AWS Cloud9 ListEnvironments API operation.", Operation = new[] {"ListEnvironments"}, SelectReturnType = typeof(Amazon.Cloud9.Model.ListEnvironmentsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Cloud9.Model.ListEnvironmentsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Cloud9.Model.ListEnvironmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetC9EnvironmentListCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "EnvironmentIds";
        #endregion
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Cloud9.Model.ListEnvironmentsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.EnvironmentIds?.Count ?? 0;
        ...
        private Amazon.Cloud9.Model.ListEnvironmentsResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.ListEnvironmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "ListEnvironments");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Cloud9.Model.ListEnvironmentsResponse, GetC9EnvironmentListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.EnvironmentIds;
        }
