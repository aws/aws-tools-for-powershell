...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF ListActivatedRulesInRuleGroup API operation.", Operation = new[] {"ListActivatedRulesInRuleGroup"})]
    [AWSCmdletOutput("Amazon.WAF.Model.ActivatedRule",
        "This cmdlet returns a collection of ActivatedRule objects.",
    ...
    public partial class GetWAFActivatedRulesInRuleGroupListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ActivatedRules;
        ...
        private Amazon.WAF.Model.ListActivatedRulesInRuleGroupResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListActivatedRulesInRuleGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListActivatedRulesInRuleGroupAsync(request);
                return task.Result;
                #else
