...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WAFByteMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWAFByteMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFByteMatchSet (CreateByteMatchSet)"))
            {
                return;
            }
        ...
        private static Amazon.WAF.Model.CreateByteMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.CreateByteMatchSetRequest request)
        {
            #if DESKTOP
            return client.CreateByteMatchSet(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.CreateByteMatchSetAsync(request);
            return task.Result;
            #else
