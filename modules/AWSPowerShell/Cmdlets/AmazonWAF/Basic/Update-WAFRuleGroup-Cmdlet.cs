...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF UpdateRuleGroup API operation.", Operation = new[] {"UpdateRuleGroup"})]
    ...
    public partial class UpdateWAFRuleGroupCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        /// from a <a>RuleGroup</a>.</para><para>You can only insert <code>REGULAR</code> rules into a rule group.</para><para>The <code>Action</code> data type within <code>ActivatedRule</code> is used only when
        /// submitting an <code>UpdateWebACL</code> request. <code>ActivatedRule|Action</code>
        /// is not applicable and therefore not available for <code>UpdateRuleGroup</code>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        [Alias("Updates")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAF.Model.RuleGroupUpdate>(this.Update);
            }
        ...
        private Amazon.WAF.Model.UpdateRuleGroupResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.UpdateRuleGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateRuleGroupAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RuleGroupId { get; set; }
            public List<Amazon.WAF.Model.RuleGroupUpdate> Updates { get; set; }
        }
