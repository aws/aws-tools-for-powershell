...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFSubscribedRuleGroupList")]
    [OutputType("Amazon.WAF.Model.SubscribedRuleGroupSummary")]
    [AWSCmdlet("Calls the AWS WAF ListSubscribedRuleGroups API operation.", Operation = new[] {"ListSubscribedRuleGroups"})]
    [AWSCmdletOutput("Amazon.WAF.Model.SubscribedRuleGroupSummary",
        "This cmdlet returns a collection of SubscribedRuleGroupSummary objects.",
        "The service call response (type Amazon.WAF.Model.ListSubscribedRuleGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetWAFSubscribedRuleGroupListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListSubscribedRuleGroupsRequest();
        ...
        private Amazon.WAF.Model.ListSubscribedRuleGroupsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListSubscribedRuleGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListSubscribedRuleGroups");
            try
            {
                #if DESKTOP
