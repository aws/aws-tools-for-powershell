...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFSizeConstraintSetList")]
    [OutputType("Amazon.WAF.Model.SizeConstraintSetSummary")]
    [AWSCmdlet("Calls the AWS WAF ListSizeConstraintSets API operation.", Operation = new[] {"ListSizeConstraintSets"})]
    [AWSCmdletOutput("Amazon.WAF.Model.SizeConstraintSetSummary",
        "This cmdlet returns a collection of SizeConstraintSetSummary objects.",
    ...
    public partial class GetWAFSizeConstraintSetListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAF.Model.ListSizeConstraintSetsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SizeConstraintSets;
        ...
        private Amazon.WAF.Model.ListSizeConstraintSetsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListSizeConstraintSetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "ListSizeConstraintSets");
            try
            {
                #if DESKTOP
                return client.ListSizeConstraintSets(request);
                #elif CORECLR
                return client.ListSizeConstraintSetsAsync(request).GetAwaiter().GetResult();
                #else
