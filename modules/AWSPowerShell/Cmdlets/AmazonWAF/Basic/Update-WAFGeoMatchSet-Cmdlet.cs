...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Invokes the UpdateGeoMatchSet operation against AWS WAF.", Operation = new[] {"UpdateGeoMatchSet"})]
    ...
    public partial class UpdateWAFGeoMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAF.Model.GeoMatchSetUpdate>(this.Update);
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String GeoMatchSetId { get; set; }
            public List<Amazon.WAF.Model.GeoMatchSetUpdate> Updates { get; set; }
        }
