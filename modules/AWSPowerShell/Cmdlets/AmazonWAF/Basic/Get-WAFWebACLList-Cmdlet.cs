...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Invokes the ListWebACLs operation against AWS WAF.", Operation = new[] {"ListWebACLs"})]
    [AWSCmdletOutput("Amazon.WAF.Model.WebACLSummary",
        "This cmdlet returns a collection of WebACLSummary objects.",
        "The service call response (type ListWebACLsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetWAFWebACLListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new ListWebACLsRequest();
