...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para></li></ol>
    /// </summary>
    [Cmdlet("Remove", "WAFRateBasedRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Invokes the DeleteRateBasedRule operation against AWS WAF.", Operation = new[] {"DeleteRateBasedRule"})]
    ...
    public partial class RemoveWAFRateBasedRuleCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFRateBasedRule (DeleteRateBasedRule)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.DeleteRateBasedRuleRequest();
        ...
        private Amazon.WAF.Model.DeleteRateBasedRuleResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteRateBasedRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "DeleteRateBasedRule");
            try
            {
                #if DESKTOP
