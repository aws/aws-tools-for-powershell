...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF ListRuleGroups API operation.", Operation = new[] {"ListRuleGroups"})]
    [AWSCmdletOutput("Amazon.WAF.Model.RuleGroupSummary",
        "This cmdlet returns a collection of RuleGroupSummary objects.",
    ...
    public partial class GetWAFRuleGroupListCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        private Amazon.WAF.Model.ListRuleGroupsResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.ListRuleGroupsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListRuleGroupsAsync(request);
                return task.Result;
                #else
