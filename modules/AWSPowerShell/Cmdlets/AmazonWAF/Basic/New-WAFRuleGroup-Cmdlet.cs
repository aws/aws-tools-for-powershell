...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF CreateRuleGroup API operation.", Operation = new[] {"CreateRuleGroup"})]
    [AWSCmdletOutput("Amazon.WAF.Model.CreateRuleGroupResponse",
        "This cmdlet returns a Amazon.WAF.Model.CreateRuleGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
