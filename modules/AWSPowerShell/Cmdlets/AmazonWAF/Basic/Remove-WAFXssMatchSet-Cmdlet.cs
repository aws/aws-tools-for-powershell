...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Invokes the DeleteXssMatchSet operation against AWS WAF.", Operation = new[] {"DeleteXssMatchSet"})]
    ...
    public class RemoveWAFXssMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFXssMatchSet (DeleteXssMatchSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.DeleteXssMatchSetRequest();
            ...
            try
            {
                var response = client.DeleteXssMatchSet(request);
