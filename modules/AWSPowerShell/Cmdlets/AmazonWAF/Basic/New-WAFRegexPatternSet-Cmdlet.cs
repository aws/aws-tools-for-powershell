...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WAFRegexPatternSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WAF.Model.CreateRegexPatternSetResponse")]
    [AWSCmdlet("Invokes the CreateRegexPatternSet operation against AWS WAF.", Operation = new[] {"CreateRegexPatternSet"})]
    [AWSCmdletOutput("Amazon.WAF.Model.CreateRegexPatternSetResponse",
        "This cmdlet returns a Amazon.WAF.Model.CreateRegexPatternSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWAFRegexPatternSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFRegexPatternSet (CreateRegexPatternSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.CreateRegexPatternSetRequest();
        ...
        private Amazon.WAF.Model.CreateRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.CreateRegexPatternSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "CreateRegexPatternSet");
            try
            {
                #if DESKTOP
