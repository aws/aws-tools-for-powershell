...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Calls the AWS WAF PutLoggingConfiguration API operation.", Operation = new[] {"PutLoggingConfiguration"})]
    [AWSCmdletOutput("Amazon.WAF.Model.LoggingConfiguration",
        "This cmdlet returns a LoggingConfiguration object.",
        "The service call response (type Amazon.WAF.Model.PutLoggingConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteWAFLoggingConfigurationCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.LoggingConfiguration_RedactedFields = new List<Amazon.WAF.Model.FieldToMatch>(this.LoggingConfiguration_RedactedField);
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public List<Amazon.WAF.Model.FieldToMatch> LoggingConfiguration_RedactedFields { get; set; }
            public System.String LoggingConfiguration_ResourceArn { get; set; }
        }
