...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WAFLoggingConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the AWS WAF DeleteLoggingConfiguration API operation.", Operation = new[] {"DeleteLoggingConfiguration"})]
    ...
    public partial class RemoveWAFLoggingConfigurationCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFLoggingConfiguration (DeleteLoggingConfiguration)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.DeleteLoggingConfigurationRequest();
        ...
        private Amazon.WAF.Model.DeleteLoggingConfigurationResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.DeleteLoggingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "DeleteLoggingConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteLoggingConfigurationAsync(request);
                return task.Result;
                #else
