...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// <code>ChangeToken</code> parameter of a <code>CreateSizeConstraintSet</code> request.</li><li>Submit a <code>CreateSizeConstraintSet</code> request.</li><li>Use <code>GetChangeToken</code>
    ...
    [AWSCmdlet("Invokes the CreateSizeConstraintSet operation against AWS WAF.", Operation = new[] {"CreateSizeConstraintSet"})]
    [AWSCmdletOutput("Amazon.WAF.Model.CreateSizeConstraintSetResponse",
        "This cmdlet returns a Amazon.WAF.Model.CreateSizeConstraintSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class NewWAFSizeConstraintSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAF.Model.CreateSizeConstraintSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.CreateSizeConstraintSetRequest request)
        {
