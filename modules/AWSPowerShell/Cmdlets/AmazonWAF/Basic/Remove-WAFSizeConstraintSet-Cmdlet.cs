...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    [AWSCmdlet("Invokes the DeleteSizeConstraintSet operation against AWS WAF.", Operation = new[] {"DeleteSizeConstraintSet"})]
    ...
    public class RemoveWAFSizeConstraintSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteSizeConstraintSet(request);
