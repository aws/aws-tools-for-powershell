...
namespace Amazon.PowerShell.Cmdlets.WAF
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "WAFRegexMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WAF.Model.CreateRegexMatchSetResponse")]
    [AWSCmdlet("Invokes the CreateRegexMatchSet operation against AWS WAF.", Operation = new[] {"CreateRegexMatchSet"})]
    [AWSCmdletOutput("Amazon.WAF.Model.CreateRegexMatchSetResponse",
        "This cmdlet returns a Amazon.WAF.Model.CreateRegexMatchSetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewWAFRegexMatchSetCmdlet : AmazonWAFClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WAFRegexMatchSet (CreateRegexMatchSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAF.Model.CreateRegexMatchSetRequest();
        ...
        private Amazon.WAF.Model.CreateRegexMatchSetResponse CallAWSServiceOperation(IAmazonWAF client, Amazon.WAF.Model.CreateRegexMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF", "CreateRegexMatchSet");
            try
            {
                #if DESKTOP
