...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListDeploymentJobs API operation.", Operation = new[] {"ListDeploymentJobs"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.DeploymentJob",
        "This cmdlet returns a collection of DeploymentJob objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DeploymentJobs;
