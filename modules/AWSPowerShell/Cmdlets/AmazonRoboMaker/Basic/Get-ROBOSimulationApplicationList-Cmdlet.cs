...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListSimulationApplications API operation.", Operation = new[] {"ListSimulationApplications"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.SimulationApplicationSummary",
        "This cmdlet returns a collection of SimulationApplicationSummary objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SimulationApplicationSummaries;
