...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListFleets API operation.", Operation = new[] {"ListFleets"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.Fleet",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.FleetDetails;
