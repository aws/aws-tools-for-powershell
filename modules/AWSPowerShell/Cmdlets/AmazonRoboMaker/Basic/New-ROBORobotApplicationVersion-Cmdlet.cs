...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker CreateRobotApplicationVersion API operation.", Operation = new[] {"CreateRobotApplicationVersion"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.CreateRobotApplicationVersionResponse",
        "This cmdlet returns a Amazon.RoboMaker.Model.CreateRobotApplicationVersionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewROBORobotApplicationVersionCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.RoboMaker.Model.CreateRobotApplicationVersionResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.CreateRobotApplicationVersionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateRobotApplicationVersionAsync(request);
                return task.Result;
                #else
