...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker UpdateRobotApplication API operation.", Operation = new[] {"UpdateRobotApplication"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.UpdateRobotApplicationResponse",
        "This cmdlet returns a Amazon.RoboMaker.Model.UpdateRobotApplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateROBORobotApplicationCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.RoboMaker.Model.UpdateRobotApplicationResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.UpdateRobotApplicationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateRobotApplicationAsync(request);
                return task.Result;
                #else
