...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    /// </summary>
    [Cmdlet("Get", "ROBOSimulationJobSummary")]
    [OutputType("Amazon.RoboMaker.Model.SimulationJobSummary")]
    [AWSCmdlet("Calls the AWS RoboMaker ListSimulationJobs API operation.", Operation = new[] {"ListSimulationJobs"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.SimulationJobSummary",
        "This cmdlet returns a collection of SimulationJobSummary objects.",
        "The service call response (type Amazon.RoboMaker.Model.ListSimulationJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetROBOSimulationJobSummaryCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.RoboMaker.Model.Filter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListSimulationJobsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SimulationJobSummaries;
                        ...
                        int _receivedThisCall = response.SimulationJobSummaries.Count;
        ...
        private Amazon.RoboMaker.Model.ListSimulationJobsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListSimulationJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListSimulationJobs");
            try
            {
                #if DESKTOP
                return client.ListSimulationJobs(request);
                #elif CORECLR
                return client.ListSimulationJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<Amazon.RoboMaker.Model.Filter> Filters { get; set; }
