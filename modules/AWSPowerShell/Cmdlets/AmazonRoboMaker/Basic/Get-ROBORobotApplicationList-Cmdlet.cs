...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListRobotApplications API operation.", Operation = new[] {"ListRobotApplications"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.RobotApplicationSummary",
        "This cmdlet returns a collection of RobotApplicationSummary objects.",
    ...
    public partial class GetROBORobotApplicationListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.RobotApplicationSummaries;
        ...
        private Amazon.RoboMaker.Model.ListRobotApplicationsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListRobotApplicationsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListRobotApplicationsAsync(request);
                return task.Result;
                #else
