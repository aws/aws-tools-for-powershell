...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker ListRobots API operation.", Operation = new[] {"ListRobots"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.Robot",
        "This cmdlet returns a collection of Robot objects.",
    ...
    public partial class GetROBORobotListCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.RoboMaker.Model.ListRobotsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Robots;
        ...
        private Amazon.RoboMaker.Model.ListRobotsResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.ListRobotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RoboMaker", "ListRobots");
            try
            {
                #if DESKTOP
