...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker DeleteSimulationApplication API operation.", Operation = new[] {"DeleteSimulationApplication"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the Application parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveROBOSimulationApplicationCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.Application;
        ...
        private Amazon.RoboMaker.Model.DeleteSimulationApplicationResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DeleteSimulationApplicationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteSimulationApplicationAsync(request);
                return task.Result;
                #else
