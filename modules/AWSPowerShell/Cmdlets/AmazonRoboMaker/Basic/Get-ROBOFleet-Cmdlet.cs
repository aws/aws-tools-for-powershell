...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker DescribeFleet API operation.", Operation = new[] {"DescribeFleet"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.DescribeFleetResponse",
        "This cmdlet returns a Amazon.RoboMaker.Model.DescribeFleetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetROBOFleetCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.RoboMaker.Model.DescribeFleetResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DescribeFleetRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeFleetAsync(request);
                return task.Result;
                #else
