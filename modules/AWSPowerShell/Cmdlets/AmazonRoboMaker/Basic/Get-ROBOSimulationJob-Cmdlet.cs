...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker DescribeSimulationJob API operation.", Operation = new[] {"DescribeSimulationJob"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.DescribeSimulationJobResponse",
        "This cmdlet returns a Amazon.RoboMaker.Model.DescribeSimulationJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetROBOSimulationJobCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        private Amazon.RoboMaker.Model.DescribeSimulationJobResponse CallAWSServiceOperation(IAmazonRoboMaker client, Amazon.RoboMaker.Model.DescribeSimulationJobRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeSimulationJobAsync(request);
                return task.Result;
                #else
