...
namespace Amazon.PowerShell.Cmdlets.ROBO
{
    ...
    [AWSCmdlet("Calls the AWS RoboMaker CreateDeploymentJob API operation.", Operation = new[] {"CreateDeploymentJob"})]
    [AWSCmdletOutput("Amazon.RoboMaker.Model.CreateDeploymentJobResponse",
        "This cmdlet returns a Amazon.RoboMaker.Model.CreateDeploymentJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewROBODeploymentJobCmdlet : AmazonRoboMakerClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.DeploymentApplicationConfigs = new List<Amazon.RoboMaker.Model.DeploymentApplicationConfig>(this.DeploymentApplicationConfig);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.DeploymentApplicationConfigs != null)
            {
                request.DeploymentApplicationConfigs = cmdletContext.DeploymentApplicationConfigs;
            }
