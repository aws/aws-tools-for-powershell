...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    [AWSCmdlet("Calls the AWS CodePipeline ListWebhooks API operation.", Operation = new[] {"ListWebhooks"})]
    [AWSCmdletOutput("Amazon.CodePipeline.Model.ListWebhookItem",
        "This cmdlet returns a collection of ListWebhookItem objects.",
    ...
    public partial class GetCPWebhookListCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Webhooks;
        ...
        private Amazon.CodePipeline.Model.ListWebhooksResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.ListWebhooksRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListWebhooksAsync(request);
                return task.Result;
                #else
