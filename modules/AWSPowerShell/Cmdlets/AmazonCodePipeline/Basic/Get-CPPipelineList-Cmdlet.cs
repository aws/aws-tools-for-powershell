...
namespace Amazon.PowerShell.Cmdlets.CP
{
    ...
    public partial class GetCPPipelineListCmdlet : AmazonCodePipelineClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CodePipeline.Model.ListPipelinesResponse CallAWSServiceOperation(IAmazonCodePipeline client, Amazon.CodePipeline.Model.ListPipelinesRequest request)
        {
            #if DESKTOP
