...
namespace Amazon.PowerShell.Cmdlets.RGT
{
    ...
    /// </para><para><c>s3://amzn-s3-demo-bucket/AwsTagPolicies/o-exampleorgid/YYYY-MM-ddTHH:mm:ssZ/report.csv</c></para><para>
    ...
    public partial class StartRGTReportCreationCmdlet : AmazonResourceGroupsTaggingAPIClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the Amazon S3 bucket where the report will be stored; for example:</para><para><c>amzn-s3-demo-bucket</c></para><para>For more information on S3 bucket requirements, including an example bucket policy,
        /// see the example Amazon S3 bucket policy on this page.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        private Amazon.ResourceGroupsTaggingAPI.Model.StartReportCreationResponse CallAWSServiceOperation(IAmazonResourceGroupsTaggingAPI client, Amazon.ResourceGroupsTaggingAPI.Model.StartReportCreationRequest request)
        {
            ...
            try
            {
                return client.StartReportCreationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
