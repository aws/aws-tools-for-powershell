...
namespace Amazon.PowerShell.Cmdlets.AHL
{
    ...
    [AWSCmdletOutput("Amazon.HealthLake.Model.ImportJobProperties or Amazon.HealthLake.Model.ListFHIRImportJobsResponse",
        ...
        "The service call response (type Amazon.HealthLake.Model.ListFHIRImportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
