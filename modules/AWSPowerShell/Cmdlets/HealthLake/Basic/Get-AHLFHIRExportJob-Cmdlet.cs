...
namespace Amazon.PowerShell.Cmdlets.AHL
{
    ...
    public partial class GetAHLFHIRExportJobCmdlet : AmazonHealthLakeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.HealthLake.Model.DescribeFHIRExportJobResponse, GetAHLFHIRExportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.HealthLake.Model.DescribeFHIRExportJobRequest();
        ...
        private Amazon.HealthLake.Model.DescribeFHIRExportJobResponse CallAWSServiceOperation(IAmazonHealthLake client, Amazon.HealthLake.Model.DescribeFHIRExportJobRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DatastoreId { get; set; }
            public System.String JobId { get; set; }
            public System.Func<Amazon.HealthLake.Model.DescribeFHIRExportJobResponse, GetAHLFHIRExportJobCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ExportJobProperties;
        }
