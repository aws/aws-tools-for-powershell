...
namespace Amazon.PowerShell.Cmdlets.AHL
{
    ...
    public partial class RemoveAHLResourceTagCmdlet : AmazonHealthLakeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AHLResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.HealthLake.Model.UntagResourceResponse, RemoveAHLResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.HealthLake.Model.UntagResourceRequest();
        ...
        private Amazon.HealthLake.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonHealthLake client, Amazon.HealthLake.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon HealthLake", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.HealthLake.Model.UntagResourceResponse, RemoveAHLResourceTagCmdlet, object> Select { get; set; } =
