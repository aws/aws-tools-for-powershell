...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("Amazon.ChimeSDKMessaging.Model.ChannelMessageStatusStructure")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging GetChannelMessageStatus API operation.", Operation = new[] {"GetChannelMessageStatus"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ChannelMessageStatusStructure or Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ChannelMessageStatusStructure object.",
        "The service call response (type Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGChannelMessageStatusCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MessageId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse, GetCHMMGChannelMessageStatusCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.MessageId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "GetChannelMessageStatus");
            try
            {
                #if DESKTOP
                return client.GetChannelMessageStatus(request);
                #elif CORECLR
                return client.GetChannelMessageStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MessageId { get; set; }
            public System.String SubChannelId { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.GetChannelMessageStatusResponse, GetCHMMGChannelMessageStatusCmdlet, object> Select { get; set; } =
