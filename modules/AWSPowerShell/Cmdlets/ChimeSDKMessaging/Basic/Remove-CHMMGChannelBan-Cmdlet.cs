...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DeleteChannelBan API operation.", Operation = new[] {"DeleteChannelBan"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMMGChannelBanCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMGChannelBan (DeleteChannelBan)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse, RemoveCHMMGChannelBanCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DeleteChannelBanRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DeleteChannelBanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DeleteChannelBan");
            try
            {
                #if DESKTOP
                return client.DeleteChannelBan(request);
                #elif CORECLR
                return client.DeleteChannelBanAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MemberArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DeleteChannelBanResponse, RemoveCHMMGChannelBanCmdlet, object> Select { get; set; } =
