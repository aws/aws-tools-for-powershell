...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DeleteChannelModerator API operation.", Operation = new[] {"DeleteChannelModerator"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMMGChannelModeratorCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMGChannelModerator (DeleteChannelModerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse, RemoveCHMMGChannelModeratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DeleteChannelModerator");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelModeratorArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DeleteChannelModeratorResponse, RemoveCHMMGChannelModeratorCmdlet, object> Select { get; set; } =
