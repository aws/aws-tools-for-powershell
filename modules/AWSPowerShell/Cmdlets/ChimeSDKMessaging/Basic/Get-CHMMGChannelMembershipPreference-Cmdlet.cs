...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging GetChannelMembershipPreferences API operation.", Operation = new[] {"GetChannelMembershipPreferences"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGChannelMembershipPreferenceCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse, GetCHMMGChannelMembershipPreferenceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "GetChannelMembershipPreferences");
            try
            {
                #if DESKTOP
                return client.GetChannelMembershipPreferences(request);
                #elif CORECLR
                return client.GetChannelMembershipPreferencesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MemberArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.GetChannelMembershipPreferencesResponse, GetCHMMGChannelMembershipPreferenceCmdlet, object> Select { get; set; } =
