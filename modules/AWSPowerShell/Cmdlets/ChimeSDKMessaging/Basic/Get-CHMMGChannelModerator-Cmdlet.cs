...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "CHMMGChannelModerator")]
    [OutputType("Amazon.ChimeSDKMessaging.Model.ChannelModerator")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DescribeChannelModerator API operation.", Operation = new[] {"DescribeChannelModerator"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ChannelModerator or Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ChannelModerator object.",
        "The service call response (type Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGChannelModeratorCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse, GetCHMMGChannelModeratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DescribeChannelModerator");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelModeratorArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratorResponse, GetCHMMGChannelModeratorCmdlet, object> Select { get; set; } =
