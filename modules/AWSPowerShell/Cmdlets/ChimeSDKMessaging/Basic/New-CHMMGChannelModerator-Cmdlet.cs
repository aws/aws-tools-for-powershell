...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging CreateChannelModerator API operation.", Operation = new[] {"CreateChannelModerator"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCHMMGChannelModeratorCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CHMMGChannelModerator (CreateChannelModerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse, NewCHMMGChannelModeratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "CreateChannelModerator");
            try
            {
                #if DESKTOP
                return client.CreateChannelModerator(request);
                #elif CORECLR
                return client.CreateChannelModeratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelModeratorArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.CreateChannelModeratorResponse, NewCHMMGChannelModeratorCmdlet, object> Select { get; set; } =
