...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "CHMMGChannelBan")]
    [OutputType("Amazon.ChimeSDKMessaging.Model.ChannelBan")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DescribeChannelBan API operation.", Operation = new[] {"DescribeChannelBan"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ChannelBan or Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ChannelBan object.",
        "The service call response (type Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGChannelBanCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ChannelBan";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse, GetCHMMGChannelBanCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DescribeChannelBanRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DescribeChannelBanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DescribeChannelBan");
            try
            {
                #if DESKTOP
                return client.DescribeChannelBan(request);
                #elif CORECLR
                return client.DescribeChannelBanAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MemberArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DescribeChannelBanResponse, GetCHMMGChannelBanCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ChannelBan;
        }
