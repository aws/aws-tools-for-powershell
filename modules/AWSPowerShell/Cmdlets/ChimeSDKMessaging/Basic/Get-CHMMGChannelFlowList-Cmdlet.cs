...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// is a developer API.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "CHMMGChannelFlowList")]
    [OutputType("Amazon.ChimeSDKMessaging.Model.ChannelFlowSummary")]
    ...
    public partial class GetCHMMGChannelFlowListCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ChannelFlows";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.ListChannelFlowsResponse, GetCHMMGChannelFlowListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ChimeSDKMessaging.Model.ListChannelFlowsRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.ListChannelFlowsResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.ListChannelFlowsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "ListChannelFlows");
            try
            {
                return client.ListChannelFlowsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.ListChannelFlowsResponse, GetCHMMGChannelFlowListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ChannelFlows;
        }
