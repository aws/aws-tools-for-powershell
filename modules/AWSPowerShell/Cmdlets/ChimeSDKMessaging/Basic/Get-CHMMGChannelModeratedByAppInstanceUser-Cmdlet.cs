...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "CHMMGChannelModeratedByAppInstanceUser")]
    [OutputType("Amazon.ChimeSDKMessaging.Model.ChannelModeratedByAppInstanceUserSummary")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DescribeChannelModeratedByAppInstanceUser API operation.", Operation = new[] {"DescribeChannelModeratedByAppInstanceUser"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ChannelModeratedByAppInstanceUserSummary or Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ChannelModeratedByAppInstanceUserSummary object.",
        "The service call response (type Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCHMMGChannelModeratedByAppInstanceUserCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse, GetCHMMGChannelModeratedByAppInstanceUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DescribeChannelModeratedByAppInstanceUser");
            try
            {
                return client.DescribeChannelModeratedByAppInstanceUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DescribeChannelModeratedByAppInstanceUserResponse, GetCHMMGChannelModeratedByAppInstanceUserCmdlet, object> Select { get; set; } =
