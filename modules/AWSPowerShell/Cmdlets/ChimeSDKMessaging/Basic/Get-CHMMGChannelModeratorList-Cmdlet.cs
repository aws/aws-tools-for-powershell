...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "CHMMGChannelModeratorList")]
    [OutputType("Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging ListChannelModerators API operation.", Operation = new[] {"ListChannelModerators"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGChannelModeratorListCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse, GetCHMMGChannelModeratorListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "ListChannelModerators");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.ListChannelModeratorsResponse, GetCHMMGChannelModeratorListCmdlet, object> Select { get; set; } =
