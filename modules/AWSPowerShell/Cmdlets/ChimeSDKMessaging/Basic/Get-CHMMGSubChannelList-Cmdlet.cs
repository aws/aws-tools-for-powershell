...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// only to the app instance admins and channel moderators of elastic channels.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.ListSubChannelsResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.ListSubChannelsResponse object containing multiple properties."
    )]
    public partial class GetCHMMGSubChannelListCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        private Amazon.ChimeSDKMessaging.Model.ListSubChannelsResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.ListSubChannelsRequest request)
        {
            ...
            try
            {
                return client.ListSubChannelsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
