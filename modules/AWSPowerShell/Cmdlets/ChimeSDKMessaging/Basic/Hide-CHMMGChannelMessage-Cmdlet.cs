...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging RedactChannelMessage API operation.", Operation = new[] {"RedactChannelMessage"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class HideCHMMGChannelMessageCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Hide-CHMMGChannelMessage (RedactChannelMessage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse, HideCHMMGChannelMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.RedactChannelMessageRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.RedactChannelMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "RedactChannelMessage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MessageId { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.RedactChannelMessageResponse, HideCHMMGChannelMessageCmdlet, object> Select { get; set; } =
