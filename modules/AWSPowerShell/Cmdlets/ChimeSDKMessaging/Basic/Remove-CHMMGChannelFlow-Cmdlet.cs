...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging DeleteChannelFlow API operation.", Operation = new[] {"DeleteChannelFlow"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMMGChannelFlowCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMGChannelFlow (DeleteChannelFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse, RemoveCHMMGChannelFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DeleteChannelFlow");
            try
            {
                #if DESKTOP
                return client.DeleteChannelFlow(request);
                #elif CORECLR
                return client.DeleteChannelFlowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ChannelFlowArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DeleteChannelFlowResponse, RemoveCHMMGChannelFlowCmdlet, object> Select { get; set; } =
