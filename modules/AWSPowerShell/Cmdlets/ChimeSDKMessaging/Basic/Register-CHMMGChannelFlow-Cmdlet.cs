...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging AssociateChannelFlow API operation.", Operation = new[] {"AssociateChannelFlow"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterCHMMGChannelFlowCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-CHMMGChannelFlow (AssociateChannelFlow)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse, RegisterCHMMGChannelFlowCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "AssociateChannelFlow");
            try
            {
                #if DESKTOP
                return client.AssociateChannelFlow(request);
                #elif CORECLR
                return client.AssociateChannelFlowAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelFlowArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.AssociateChannelFlowResponse, RegisterCHMMGChannelFlowCmdlet, object> Select { get; set; } =
