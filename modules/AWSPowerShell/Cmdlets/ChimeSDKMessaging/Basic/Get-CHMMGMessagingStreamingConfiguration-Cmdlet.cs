...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging GetMessagingStreamingConfigurations API operation.", Operation = new[] {"GetMessagingStreamingConfigurations"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.StreamingConfiguration or Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.ChimeSDKMessaging.Model.StreamingConfiguration objects.",
        "The service call response (type Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMMGMessagingStreamingConfigurationCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse, GetCHMMGMessagingStreamingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "GetMessagingStreamingConfigurations");
            try
            {
                #if DESKTOP
                return client.GetMessagingStreamingConfigurations(request);
                #elif CORECLR
                return client.GetMessagingStreamingConfigurationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.GetMessagingStreamingConfigurationsResponse, GetCHMMGMessagingStreamingConfigurationCmdlet, object> Select { get; set; } =
