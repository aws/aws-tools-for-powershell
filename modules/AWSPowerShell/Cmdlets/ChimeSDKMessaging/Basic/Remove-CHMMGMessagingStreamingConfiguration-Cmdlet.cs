...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMMGMessagingStreamingConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMMGMessagingStreamingConfigurationCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMGMessagingStreamingConfiguration (DeleteMessagingStreamingConfigurations)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.DeleteMessagingStreamingConfigurationsResponse, RemoveCHMMGMessagingStreamingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.DeleteMessagingStreamingConfigurationsRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.DeleteMessagingStreamingConfigurationsResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.DeleteMessagingStreamingConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "DeleteMessagingStreamingConfigurations");
            try
            {
                #if DESKTOP
                return client.DeleteMessagingStreamingConfigurations(request);
                #elif CORECLR
                return client.DeleteMessagingStreamingConfigurationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.DeleteMessagingStreamingConfigurationsResponse, RemoveCHMMGMessagingStreamingConfigurationCmdlet, object> Select { get; set; } =
