...
namespace Amazon.PowerShell.Cmdlets.CHMMG
{
    ...
    [OutputType("Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse")]
    [AWSCmdlet("Calls the Amazon Chime SDK Messaging CreateChannelBan API operation.", Operation = new[] {"CreateChannelBan"}, SelectReturnType = typeof(Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse",
        "This cmdlet returns an Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCHMMGChannelBanCmdlet : AmazonChimeSDKMessagingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CHMMGChannelBan (CreateChannelBan)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse, NewCHMMGChannelBanCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMessaging.Model.CreateChannelBanRequest();
        ...
        private Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse CallAWSServiceOperation(IAmazonChimeSDKMessaging client, Amazon.ChimeSDKMessaging.Model.CreateChannelBanRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Messaging", "CreateChannelBan");
            try
            {
                #if DESKTOP
                return client.CreateChannelBan(request);
                #elif CORECLR
                return client.CreateChannelBanAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MemberArn { get; set; }
            public System.Func<Amazon.ChimeSDKMessaging.Model.CreateChannelBanResponse, NewCHMMGChannelBanCmdlet, object> Select { get; set; } =
