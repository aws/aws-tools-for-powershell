...
namespace Amazon.PowerShell.Cmdlets.BCMD
{
    ...
    /// preferred layout.
    /// </summary>
    [Cmdlet("New", "BCMDDashboard", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Billing and Cost Management Dashboards CreateDashboard API operation.", Operation = new[] {"CreateDashboard"}, SelectReturnType = typeof(Amazon.BCMDashboards.Model.CreateDashboardResponse))]
    [AWSCmdletOutput("System.String or Amazon.BCMDashboards.Model.CreateDashboardResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.BCMDashboards.Model.CreateDashboardResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewBCMDDashboardCmdlet : AmazonBCMDashboardsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-BCMDDashboard (CreateDashboard)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BCMDashboards.Model.CreateDashboardResponse, NewBCMDDashboardCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.Widget == null && ParameterWasBound(nameof(this.Widget)))
            {
                WriteWarning("You are passing $null as a value for parameter Widget which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BCMDashboards.Model.CreateDashboardRequest();
        ...
        private Amazon.BCMDashboards.Model.CreateDashboardResponse CallAWSServiceOperation(IAmazonBCMDashboards client, Amazon.BCMDashboards.Model.CreateDashboardRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Billing and Cost Management Dashboards", "CreateDashboard");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BCMDashboards.Model.CreateDashboardResponse, NewBCMDDashboardCmdlet, object> Select { get; set; } =
