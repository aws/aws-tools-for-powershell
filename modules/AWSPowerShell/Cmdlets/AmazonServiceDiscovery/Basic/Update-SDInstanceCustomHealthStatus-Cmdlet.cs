...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming UpdateInstanceCustomHealthStatus API operation.", Operation = new[] {"UpdateInstanceCustomHealthStatus"})]
    ...
    public partial class UpdateSDInstanceCustomHealthStatusCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "UpdateInstanceCustomHealthStatus");
            try
            {
                #if DESKTOP
                ...
                var task = client.UpdateInstanceCustomHealthStatusAsync(request);
                return task.Result;
                #else
