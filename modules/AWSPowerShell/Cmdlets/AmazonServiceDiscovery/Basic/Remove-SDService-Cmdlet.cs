...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming DeleteService API operation.", Operation = new[] {"DeleteService"})]
    ...
    public partial class RemoveSDServiceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SDService (DeleteService)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceDiscovery.Model.DeleteServiceRequest();
        ...
        private Amazon.ServiceDiscovery.Model.DeleteServiceResponse CallAWSServiceOperation(IAmazonServiceDiscovery client, Amazon.ServiceDiscovery.Model.DeleteServiceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "DeleteService");
            try
            {
                #if DESKTOP
