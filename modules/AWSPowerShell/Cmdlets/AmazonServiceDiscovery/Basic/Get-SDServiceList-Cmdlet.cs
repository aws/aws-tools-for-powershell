...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming ListServices API operation.", Operation = new[] {"ListServices"})]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.ServiceSummary",
        "This cmdlet returns a collection of ServiceSummary objects.",
    ...
    public partial class GetSDServiceListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.ServiceDiscovery.Model.ServiceFilter>(this.Filter);
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "ListServices");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListServicesAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<Amazon.ServiceDiscovery.Model.ServiceFilter> Filters { get; set; }
