...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming ListOperations API operation.", Operation = new[] {"ListOperations"})]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.OperationSummary",
    ...
    public partial class GetSDOperationListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The maximum number of items that you want Amazon Route 53 to return in the response
        /// to a <code>ListOperations</code> request. If you don't specify a value for <code>MaxResults</code>,
        /// Route 53 returns up to 100 operations.</para>
        /// </para>
        /// <para>
        ...
        /// from the previous response in the next request.</para><note><para>Route 53 gets <code>MaxResults</code> operations and then filters them based on the
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.ServiceDiscovery.Model.OperationFilter>(this.Filter);
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "ListOperations");
            try
            {
                #if DESKTOP
        ...
        {
            public List<Amazon.ServiceDiscovery.Model.OperationFilter> Filters { get; set; }
