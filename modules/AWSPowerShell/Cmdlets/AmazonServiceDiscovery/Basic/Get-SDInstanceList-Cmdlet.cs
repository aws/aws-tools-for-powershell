...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    /// </summary>
    [Cmdlet("Get", "SDInstanceList")]
    [OutputType("Amazon.ServiceDiscovery.Model.InstanceSummary")]
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming ListInstances API operation.", Operation = new[] {"ListInstances"})]
    [AWSCmdletOutput("Amazon.ServiceDiscovery.Model.InstanceSummary",
        "This cmdlet returns a collection of InstanceSummary objects.",
        "The service call response (type Amazon.ServiceDiscovery.Model.ListInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetSDInstanceListCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceDiscovery.Model.ListInstancesRequest();
        ...
        private Amazon.ServiceDiscovery.Model.ListInstancesResponse CallAWSServiceOperation(IAmazonServiceDiscovery client, Amazon.ServiceDiscovery.Model.ListInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "ListInstances");
            try
            {
                #if DESKTOP
