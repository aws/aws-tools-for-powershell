...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming DeleteNamespace API operation.", Operation = new[] {"DeleteNamespace"})]
    ...
    public partial class RemoveSDNamespaceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "DeleteNamespace");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteNamespaceAsync(request);
                return task.Result;
                #else
