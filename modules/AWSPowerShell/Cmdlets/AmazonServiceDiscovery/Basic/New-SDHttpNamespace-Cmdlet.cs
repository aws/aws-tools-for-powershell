...
namespace Amazon.PowerShell.Cmdlets.SD
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 Auto Naming CreateHttpNamespace API operation.", Operation = new[] {"CreateHttpNamespace"})]
    ...
    public partial class NewSDHttpNamespaceCmdlet : AmazonServiceDiscoveryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Route 53 Auto Naming", "CreateHttpNamespace");
            try
            {
                #if DESKTOP
                ...
                var task = client.CreateHttpNamespaceAsync(request);
                return task.Result;
                #else
