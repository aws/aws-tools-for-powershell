...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    /// </summary>
    [Cmdlet("Get", "AVPPolicyTemplate")]
    [OutputType("Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse")]
    [AWSCmdlet("Calls the Amazon Verified Permissions GetPolicyTemplate API operation.", Operation = new[] {"GetPolicyTemplate"}, SelectReturnType = typeof(Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse))]
    [AWSCmdletOutput("Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse",
        "This cmdlet returns an Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse object containing multiple properties."
    )]
    public partial class GetAVPPolicyTemplateCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        /// information about.</para><para>To specify a policy store, use its ID or alias name. When using an alias name, prefix
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the ID of the policy template that you want information about.</para><para>You can use the policy template name in place of the policy template ID. When using
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse, GetAVPPolicyTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VerifiedPermissions.Model.GetPolicyTemplateRequest();
        ...
        private Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse CallAWSServiceOperation(IAmazonVerifiedPermissions client, Amazon.VerifiedPermissions.Model.GetPolicyTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Verified Permissions", "GetPolicyTemplate");
            try
            {
                #if DESKTOP
                return client.GetPolicyTemplate(request);
                #elif CORECLR
                return client.GetPolicyTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyStoreId { get; set; }
            public System.String PolicyTemplateId { get; set; }
            public System.Func<Amazon.VerifiedPermissions.Model.GetPolicyTemplateResponse, GetAVPPolicyTemplateCmdlet, object> Select { get; set; } =
