...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    public partial class GetAVPPolicyStoreAliasListCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the Filter_PolicyStoreId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^Filter_PolicyStoreId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Filter_PolicyStoreId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.Filter_PolicyStoreId;
            }
        ...
        private Amazon.VerifiedPermissions.Model.ListPolicyStoreAliasesResponse CallAWSServiceOperation(IAmazonVerifiedPermissions client, Amazon.VerifiedPermissions.Model.ListPolicyStoreAliasesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListPolicyStoreAliases(request);
                #elif CORECLR
                return client.ListPolicyStoreAliasesAsync(request).GetAwaiter().GetResult();
                #else
