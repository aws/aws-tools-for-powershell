...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    public partial class GetAVPPolicyCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the ID of the policy you want information about.</para><para>You can use the policy name in place of the policy ID. When using a name, prefix it
