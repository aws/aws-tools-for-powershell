...
{
    /// <summary>
    /// Returns a paginated list of all policy stores in the calling Amazon Web Services account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.VerifiedPermissions.Model.PolicyStoreItem or Amazon.VerifiedPermissions.Model.ListPolicyStoresResponse",
        ...
        "The service call response (type Amazon.VerifiedPermissions.Model.ListPolicyStoresResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetAVPPolicyStoreListCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        private Amazon.VerifiedPermissions.Model.ListPolicyStoresResponse CallAWSServiceOperation(IAmazonVerifiedPermissions client, Amazon.VerifiedPermissions.Model.ListPolicyStoresRequest request)
        {
            ...
            try
            {
                return client.ListPolicyStoresAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
