...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    [AWSCmdletOutput("Amazon.VerifiedPermissions.Model.GetSchemaResponse",
        "This cmdlet returns an Amazon.VerifiedPermissions.Model.GetSchemaResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
