...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    public partial class GetAVPPolicyStoreCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the policy store that you want information about.</para><para>To specify a policy store, use its ID or alias name. When using an alias name, prefix
