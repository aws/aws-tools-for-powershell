...
namespace Amazon.PowerShell.Cmdlets.AVP
{
    ...
    /// </para></important>
    /// </summary>
    [Cmdlet("Remove", "AVPPolicyTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Verified Permissions DeletePolicyTemplate API operation.", Operation = new[] {"DeletePolicyTemplate"}, SelectReturnType = typeof(Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse))]
    [AWSCmdletOutput("None or Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAVPPolicyTemplateCmdlet : AmazonVerifiedPermissionsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AVPPolicyTemplate (DeletePolicyTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse, RemoveAVPPolicyTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.VerifiedPermissions.Model.DeletePolicyTemplateRequest();
        ...
        private Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse CallAWSServiceOperation(IAmazonVerifiedPermissions client, Amazon.VerifiedPermissions.Model.DeletePolicyTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Verified Permissions", "DeletePolicyTemplate");
            try
            {
                #if DESKTOP
                return client.DeletePolicyTemplate(request);
                #elif CORECLR
                return client.DeletePolicyTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String PolicyStoreId { get; set; }
            public System.String PolicyTemplateId { get; set; }
            public System.Func<Amazon.VerifiedPermissions.Model.DeletePolicyTemplateResponse, RemoveAVPPolicyTemplateCmdlet, object> Select { get; set; } =
