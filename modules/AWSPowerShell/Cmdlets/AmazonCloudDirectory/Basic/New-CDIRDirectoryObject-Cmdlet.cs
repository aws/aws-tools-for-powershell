...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Invokes the CreateObject operation against AWS Cloud Directory.", Operation = new[] {"CreateObject"})]
    ...
    public partial class NewCDIRDirectoryObjectCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CloudDirectory.Model.CreateObjectResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.CreateObjectRequest request)
        {
            #if DESKTOP
            return client.CreateObject(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.CreateObjectAsync(request);
            return task.Result;
            #else
