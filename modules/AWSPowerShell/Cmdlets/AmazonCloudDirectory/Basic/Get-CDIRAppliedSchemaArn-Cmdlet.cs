...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Invokes the ListAppliedSchemaArns operation against AWS Cloud Directory.", Operation = new[] {"ListAppliedSchemaArns"})]
    ...
    public partial class GetCDIRAppliedSchemaArnCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CloudDirectory.Model.ListAppliedSchemaArnsResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListAppliedSchemaArnsRequest request)
        {
            #if DESKTOP
            return client.ListAppliedSchemaArns(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListAppliedSchemaArnsAsync(request);
            return task.Result;
            #else
