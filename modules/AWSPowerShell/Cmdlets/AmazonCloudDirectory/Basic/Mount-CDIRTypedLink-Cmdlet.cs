...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class MountCDIRTypedLinkCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Attributes = new List<Amazon.CloudDirectory.Model.AttributeNameAndValue>(this.Attribute);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            bool requestSourceObjectReferenceIsNull = true;
            ...
            bool requestTargetObjectReferenceIsNull = true;
            ...
            bool requestTypedLinkFacetIsNull = true;
            ...
            try
            {
                ...
                object pipelineOutput = response.TypedLinkSpecifier;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "AttachTypedLink");
            try
            {
                #if DESKTOP
                ...
                var task = client.AttachTypedLinkAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<Amazon.CloudDirectory.Model.AttributeNameAndValue> Attributes { get; set; }
            public System.String DirectoryArn { get; set; }
            public System.String SourceObjectReference_Selector { get; set; }
            public System.String TargetObjectReference_Selector { get; set; }
            public System.String TypedLinkFacet_SchemaArn { get; set; }
