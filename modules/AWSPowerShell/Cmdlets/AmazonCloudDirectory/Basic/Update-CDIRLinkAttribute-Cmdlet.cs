...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Directory UpdateLinkAttributes API operation.", Operation = new[] {"UpdateLinkAttributes"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.CloudDirectory.Model.UpdateLinkAttributesResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCDIRLinkAttributeCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// typed link resides. For more information, see <a>arns</a> or <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed
        /// link</a>.</para>
        /// </para>
        /// </summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.AttributeUpdates = new List<Amazon.CloudDirectory.Model.LinkAttributeUpdate>(this.AttributeUpdate);
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "UpdateLinkAttributes");
            try
            {
                #if DESKTOP
                ...
                var task = client.UpdateLinkAttributesAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<Amazon.CloudDirectory.Model.LinkAttributeUpdate> AttributeUpdates { get; set; }
            public System.String DirectoryArn { get; set; }
