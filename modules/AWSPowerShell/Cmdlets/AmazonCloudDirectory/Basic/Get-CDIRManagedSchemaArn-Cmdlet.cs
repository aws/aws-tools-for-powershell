...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Directory ListManagedSchemaArns API operation.", Operation = new[] {"ListManagedSchemaArns"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListManagedSchemaArnsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetCDIRManagedSchemaArnCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "ListManagedSchemaArns");
            try
            {
                #if DESKTOP
                return client.ListManagedSchemaArns(request);
                #elif CORECLR
                return client.ListManagedSchemaArnsAsync(request).GetAwaiter().GetResult();
                #else
