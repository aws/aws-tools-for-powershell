...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CDIRDirectoryObject", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Invokes the DeleteObject operation against AWS Cloud Directory.", Operation = new[] {"DeleteObject"})]
    ...
    public partial class RemoveCDIRDirectoryObjectCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CDIRDirectoryObject (DeleteObject)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudDirectory.Model.DeleteObjectRequest();
        ...
        private Amazon.CloudDirectory.Model.DeleteObjectResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.DeleteObjectRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "DeleteObject");
            #if DESKTOP
