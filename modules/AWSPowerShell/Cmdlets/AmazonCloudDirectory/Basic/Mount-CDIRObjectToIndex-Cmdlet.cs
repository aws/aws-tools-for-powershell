...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Invokes the AttachToIndex operation against AWS Cloud Directory.", Operation = new[] {"AttachToIndex"})]
    ...
    public partial class MountCDIRObjectToIndexCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ARN of the directory where the object and index exist.</para>
        /// </para>
        /// </summary>
