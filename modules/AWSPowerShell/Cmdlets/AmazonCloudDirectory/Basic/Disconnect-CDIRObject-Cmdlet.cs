...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class DisconnectCDIRObjectCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Link name associated with the object that needs to be detached.</para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.CloudDirectory.Model.DetachObjectResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.DetachObjectRequest request)
        {
            #if DESKTOP
