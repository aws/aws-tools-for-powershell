...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Invokes the ListObjectAttributes operation against AWS Cloud Directory.", Operation = new[] {"ListObjectAttributes"})]
    ...
    public partial class GetCDIRObjectAttributeCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        private static Amazon.CloudDirectory.Model.ListObjectAttributesResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListObjectAttributesRequest request)
        {
            #if DESKTOP
