...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Invokes the AddFacetToObject operation against AWS Cloud Directory.", Operation = new[] {"AddFacetToObject"})]
    ...
    public partial class AddCDIRFacetToObjectCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Attributes on the facet you are adding to the object.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        private static Amazon.CloudDirectory.Model.AddFacetToObjectResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.AddFacetToObjectRequest request)
        {
            #if DESKTOP
