...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    /// </summary>
    [Cmdlet("Get", "CDIRDevelopmentSchemaArn")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Cloud Directory ListDevelopmentSchemaArns API operation.", Operation = new[] {"ListDevelopmentSchemaArns"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.CloudDirectory.Model.ListDevelopmentSchemaArnsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetCDIRDevelopmentSchemaArnCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CloudDirectory.Model.ListDevelopmentSchemaArnsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.SchemaArns;
                        ...
                        {
                            int _receivedThisCall = response.SchemaArns.Count;
        ...
        private Amazon.CloudDirectory.Model.ListDevelopmentSchemaArnsResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.ListDevelopmentSchemaArnsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListDevelopmentSchemaArnsAsync(request).GetAwaiter().GetResult();
                #else
