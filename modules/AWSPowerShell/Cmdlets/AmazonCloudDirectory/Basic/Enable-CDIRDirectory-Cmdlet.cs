...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    public partial class EnableCDIRDirectoryCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-CDIRDirectory (EnableDirectory)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudDirectory.Model.EnableDirectoryRequest();
        ...
        private Amazon.CloudDirectory.Model.EnableDirectoryResponse CallAWSServiceOperation(IAmazonCloudDirectory client, Amazon.CloudDirectory.Model.EnableDirectoryRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.EnableDirectoryAsync(request).GetAwaiter().GetResult();
                #else
