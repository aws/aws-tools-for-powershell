...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Directory GetObjectInformation API operation.", Operation = new[] {"GetObjectInformation"})]
    ...
    public partial class GetCDIRObjectInformationCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "GetObjectInformation");
            try
            {
                #if DESKTOP
