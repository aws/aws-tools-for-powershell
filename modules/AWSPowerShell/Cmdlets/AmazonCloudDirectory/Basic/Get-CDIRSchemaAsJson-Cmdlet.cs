...
namespace Amazon.PowerShell.Cmdlets.CDIR
{
    ...
    [AWSCmdlet("Calls the AWS Cloud Directory GetSchemaAsJson API operation.", Operation = new[] {"GetSchemaAsJson"})]
    ...
    public partial class GetCDIRSchemaAsJsonCmdlet : AmazonCloudDirectoryClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud Directory", "GetSchemaAsJson");
            try
            {
                #if DESKTOP
