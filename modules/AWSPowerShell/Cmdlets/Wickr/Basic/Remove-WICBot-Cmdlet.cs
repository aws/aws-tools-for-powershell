...
namespace Amazon.PowerShell.Cmdlets.WIC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WICBot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Wickr Admin API DeleteBot API operation.", Operation = new[] {"DeleteBot"}, SelectReturnType = typeof(Amazon.Wickr.Model.DeleteBotResponse))]
    [AWSCmdletOutput("System.String or Amazon.Wickr.Model.DeleteBotResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Wickr.Model.DeleteBotResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveWICBotCmdlet : AmazonWickrClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the bot to be deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the Wickr network from which the bot will be deleted.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Wickr.Model.DeleteBotResponse).
        /// Specifying the name of a property of type Amazon.Wickr.Model.DeleteBotResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WICBot (DeleteBot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Wickr.Model.DeleteBotResponse, RemoveWICBotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Wickr.Model.DeleteBotRequest();
        ...
        private Amazon.Wickr.Model.DeleteBotResponse CallAWSServiceOperation(IAmazonWickr client, Amazon.Wickr.Model.DeleteBotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Wickr Admin API", "DeleteBot");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BotId { get; set; }
            public System.String NetworkId { get; set; }
            public System.Func<Amazon.Wickr.Model.DeleteBotResponse, RemoveWICBotCmdlet, object> Select { get; set; } =
