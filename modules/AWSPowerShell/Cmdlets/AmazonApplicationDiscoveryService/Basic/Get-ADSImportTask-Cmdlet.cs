...
namespace Amazon.PowerShell.Cmdlets.ADS
{
    ...
    [AWSCmdlet("Calls the Application Discovery Service DescribeImportTasks API operation.", Operation = new[] {"DescribeImportTasks"})]
    [AWSCmdletOutput("Amazon.ApplicationDiscoveryService.Model.ImportTask",
        "This cmdlet returns a collection of ImportTask objects.",
    ...
    public partial class GetADSImportTaskCmdlet : AmazonApplicationDiscoveryServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.ApplicationDiscoveryService.Model.ImportTaskFilter>(this.Filter);
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Application Discovery Service", "DescribeImportTasks");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeImportTasksAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<Amazon.ApplicationDiscoveryService.Model.ImportTaskFilter> Filters { get; set; }
