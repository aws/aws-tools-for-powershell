...
namespace Amazon.PowerShell.Cmdlets.SQ
{
    ...
    /// to the quota.
    /// </summary>
    [Cmdlet("Add", "SQResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddSQResourceTagCmdlet : AmazonServiceQuotasClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tags that you want to add to the resource.</para><para />
        ...
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [Alias("Tags")]
        public Amazon.ServiceQuotas.Model.Tag[] Tag { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-SQResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceQuotas.Model.TagResourceResponse, AddSQResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.ServiceQuotas.Model.Tag>(this.Tag);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceQuotas.Model.TagResourceRequest();
        ...
        private Amazon.ServiceQuotas.Model.TagResourceResponse CallAWSServiceOperation(IAmazonServiceQuotas client, Amazon.ServiceQuotas.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Quotas", "TagResource");
            try
            {
        ...
        {
            public System.String ResourceARN { get; set; }
            public List<Amazon.ServiceQuotas.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.ServiceQuotas.Model.TagResourceResponse, AddSQResourceTagCmdlet, object> Select { get; set; } =
