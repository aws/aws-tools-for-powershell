...
namespace Amazon.PowerShell.Cmdlets.SQ
{
    ...
    public partial class GetSQServiceQuotaListCmdlet : AmazonServiceQuotasClientCmdlet, IExecutor
    {
        ...
        public Amazon.ServiceQuotas.AppliedLevelEnum QuotaAppliedAtLevel { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            context.QuotaAppliedAtLevel = this.QuotaAppliedAtLevel;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.QuotaAppliedAtLevel != null)
            {
                request.QuotaAppliedAtLevel = cmdletContext.QuotaAppliedAtLevel;
            }
