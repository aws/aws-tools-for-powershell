...
namespace Amazon.PowerShell.Cmdlets.SQ
{
    ...
    /// or all levels. Responses include any open or closed requests within 90 days.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "SQRequestedServiceQuotaChangeHistoryList")]
    [OutputType("Amazon.ServiceQuotas.Model.RequestedServiceQuotaChange")]
    [AWSCmdlet("Calls the AWS Service Quotas ListRequestedServiceQuotaChangeHistory API operation.", Operation = new[] {"ListRequestedServiceQuotaChangeHistory"}, SelectReturnType = typeof(Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse))]
    [AWSCmdletOutput("Amazon.ServiceQuotas.Model.RequestedServiceQuotaChange or Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse",
        "This cmdlet returns a collection of Amazon.ServiceQuotas.Model.RequestedServiceQuotaChange objects.",
        "The service call response (type Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSQRequestedServiceQuotaChangeHistoryListCmdlet : AmazonServiceQuotasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse, GetSQRequestedServiceQuotaChangeHistoryListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryRequest();
        ...
        private Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse CallAWSServiceOperation(IAmazonServiceQuotas client, Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Quotas", "ListRequestedServiceQuotaChangeHistory");
            try
            {
                #if DESKTOP
                return client.ListRequestedServiceQuotaChangeHistory(request);
                #elif CORECLR
                return client.ListRequestedServiceQuotaChangeHistoryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ServiceCode { get; set; }
            public Amazon.ServiceQuotas.RequestStatus Status { get; set; }
            public System.Func<Amazon.ServiceQuotas.Model.ListRequestedServiceQuotaChangeHistoryResponse, GetSQRequestedServiceQuotaChangeHistoryListCmdlet, object> Select { get; set; } =
