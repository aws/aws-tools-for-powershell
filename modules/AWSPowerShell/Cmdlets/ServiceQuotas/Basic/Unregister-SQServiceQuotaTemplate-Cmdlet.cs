...
namespace Amazon.PowerShell.Cmdlets.SQ
{
    ...
    public partial class UnregisterSQServiceQuotaTemplateCmdlet : AmazonServiceQuotasClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-SQServiceQuotaTemplate (DisassociateServiceQuotaTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ServiceQuotas.Model.DisassociateServiceQuotaTemplateResponse, UnregisterSQServiceQuotaTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ServiceQuotas.Model.DisassociateServiceQuotaTemplateRequest();
        ...
        private Amazon.ServiceQuotas.Model.DisassociateServiceQuotaTemplateResponse CallAWSServiceOperation(IAmazonServiceQuotas client, Amazon.ServiceQuotas.Model.DisassociateServiceQuotaTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Quotas", "DisassociateServiceQuotaTemplate");
            try
            {
                #if DESKTOP
                return client.DisassociateServiceQuotaTemplate(request);
                #elif CORECLR
                return client.DisassociateServiceQuotaTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.ServiceQuotas.Model.DisassociateServiceQuotaTemplateResponse, UnregisterSQServiceQuotaTemplateCmdlet, object> Select { get; set; } =
