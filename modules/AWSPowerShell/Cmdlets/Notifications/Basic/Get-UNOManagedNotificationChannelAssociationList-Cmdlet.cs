...
namespace Amazon.PowerShell.Cmdlets.UNO
{
    ...
    /// in paginated format.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetUNOManagedNotificationChannelAssociationListCmdlet : AmazonNotificationsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Notifications.Model.ListManagedNotificationChannelAssociationsResponse CallAWSServiceOperation(IAmazonNotifications client, Amazon.Notifications.Model.ListManagedNotificationChannelAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListManagedNotificationChannelAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
