...
namespace Amazon.PowerShell.Cmdlets.UNO
{
    ...
    /// </summary>
    [Cmdlet("Add", "UNOOrganizationalUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS User Notifications AssociateOrganizationalUnit API operation.", Operation = new[] {"AssociateOrganizationalUnit"}, SelectReturnType = typeof(Amazon.Notifications.Model.AssociateOrganizationalUnitResponse))]
    [AWSCmdletOutput("None or Amazon.Notifications.Model.AssociateOrganizationalUnitResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Notifications.Model.AssociateOrganizationalUnitResponse) be returned by specifying '-Select *'."
    )]
    public partial class AddUNOOrganizationalUnitCmdlet : AmazonNotificationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the notification configuration to associate with
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the organizational unit to associate.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Notifications.Model.AssociateOrganizationalUnitResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-UNOOrganizationalUnit (AssociateOrganizationalUnit)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Notifications.Model.AssociateOrganizationalUnitResponse, AddUNOOrganizationalUnitCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Notifications.Model.AssociateOrganizationalUnitRequest();
        ...
        private Amazon.Notifications.Model.AssociateOrganizationalUnitResponse CallAWSServiceOperation(IAmazonNotifications client, Amazon.Notifications.Model.AssociateOrganizationalUnitRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS User Notifications", "AssociateOrganizationalUnit");
            try
            {
                #if DESKTOP
                return client.AssociateOrganizationalUnit(request);
                #elif CORECLR
                return client.AssociateOrganizationalUnitAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NotificationConfigurationArn { get; set; }
            public System.String OrganizationalUnitId { get; set; }
            public System.Func<Amazon.Notifications.Model.AssociateOrganizationalUnitResponse, AddUNOOrganizationalUnitCmdlet, object> Select { get; set; } =
