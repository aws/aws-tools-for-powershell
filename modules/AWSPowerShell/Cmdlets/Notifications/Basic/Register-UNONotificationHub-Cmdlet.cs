...
namespace Amazon.PowerShell.Cmdlets.UNO
{
    ...
    public partial class RegisterUNONotificationHubCmdlet : AmazonNotificationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the NotificationHubRegion parameter.
        /// The -PassThru parameter is deprecated, use -Select '^NotificationHubRegion' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^NotificationHubRegion' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.NotificationHubRegion;
            }
        ...
        private Amazon.Notifications.Model.RegisterNotificationHubResponse CallAWSServiceOperation(IAmazonNotifications client, Amazon.Notifications.Model.RegisterNotificationHubRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.RegisterNotificationHub(request);
                #elif CORECLR
                return client.RegisterNotificationHubAsync(request).GetAwaiter().GetResult();
                #else
