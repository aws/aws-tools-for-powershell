...
{
    /// <summary>
    /// Returns a list of <c>NotificationHubs</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetUNONotificationHubListCmdlet : AmazonNotificationsClientCmdlet, IExecutor
    {
        ...
        private Amazon.Notifications.Model.ListNotificationHubsResponse CallAWSServiceOperation(IAmazonNotifications client, Amazon.Notifications.Model.ListNotificationHubsRequest request)
        {
            ...
            try
            {
                return client.ListNotificationHubsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
