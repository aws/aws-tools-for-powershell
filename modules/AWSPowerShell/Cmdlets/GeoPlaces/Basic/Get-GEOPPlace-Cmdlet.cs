...
namespace Amazon.PowerShell.Cmdlets.GEOP
{
    ...
    public partial class GetGEOPPlaceCmdlet : AmazonGeoPlacesClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.GeoPlaces.GetPlaceAddressNamesMode")]
        public Amazon.GeoPlaces.GetPlaceAddressNamesMode AddressNamesMode { get; set; }
        #endregion
        ...
        /// customers. </para><note><para>When storing <c>GetPlace</c> responses, you <i>must</i> set this field to <c>Storage</c>
