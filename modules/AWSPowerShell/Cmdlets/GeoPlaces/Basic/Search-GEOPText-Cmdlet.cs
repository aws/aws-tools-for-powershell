...
namespace Amazon.PowerShell.Cmdlets.GEOP
{
    ...
    public partial class SearchGEOPTextCmdlet : AmazonGeoPlacesClientCmdlet, IExecutor
    {
        ...
        /// to <c>SingleUse</c> (not stored). </para><note><para>When storing <c>SearchText</c> responses, you <i>must</i> set this field to <c>Storage</c>
        ...
        /// customers.</para><note><para>Exactly one of the following fields must be set: <c>QueryText</c> or <c>QueryId</c>.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [AWSConstantClassSource("Amazon.GeoPlaces.SearchTextTravelMode")]
        public Amazon.GeoPlaces.SearchTextTravelMode TravelMode { get; set; }
        #endregion
