...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service DeleteBotVersion API operation.", Operation = new[] {"DeleteBotVersion"})]
    ...
    public partial class RemoveLMBBotVersionCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LMBBotVersion (DeleteBotVersion)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexModelBuildingService.Model.DeleteBotVersionRequest();
        ...
        private Amazon.LexModelBuildingService.Model.DeleteBotVersionResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.DeleteBotVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "DeleteBotVersion");
            try
            {
                #if DESKTOP
                return client.DeleteBotVersion(request);
                #elif CORECLR
                return client.DeleteBotVersionAsync(request).GetAwaiter().GetResult();
                #else
