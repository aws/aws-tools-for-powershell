...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [OutputType("Amazon.LexModelBuildingService.Model.BuiltinSlotTypeMetadata")]
    [AWSCmdlet("Invokes the GetBuiltinSlotTypes operation against Amazon Lex Model Building Service.", Operation = new[] {"GetBuiltinSlotTypes"})]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BuiltinSlotTypeMetadata",
        "This cmdlet returns a collection of BuiltinSlotTypeMetadata objects.",
    ...
    public partial class GetLMBBuiltinSlotTypeCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetBuiltinSlotTypesRequest();
        ...
        private Amazon.LexModelBuildingService.Model.GetBuiltinSlotTypesResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBuiltinSlotTypesRequest request)
        {
