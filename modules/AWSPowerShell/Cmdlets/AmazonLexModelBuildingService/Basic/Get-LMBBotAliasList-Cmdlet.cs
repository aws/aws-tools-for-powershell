...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Invokes the GetBotAliases operation against Amazon Lex Model Building Service.", Operation = new[] {"GetBotAliases"})]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotAliasMetadata",
        "This cmdlet returns a collection of BotAliasMetadata objects.",
    ...
    public partial class GetLMBBotAliasListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BotAliases;
        ...
        private Amazon.LexModelBuildingService.Model.GetBotAliasesResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotAliasesRequest request)
        {
            ...
            var task = client.GetBotAliasesAsync(request);
            return task.Result;
            #else
