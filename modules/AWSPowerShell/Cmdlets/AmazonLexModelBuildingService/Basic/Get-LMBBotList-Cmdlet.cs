...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    /// </summary>
    [Cmdlet("Get", "LMBBotList")]
    [OutputType("Amazon.LexModelBuildingService.Model.BotMetadata")]
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetBots API operation.", Operation = new[] {"GetBots"})]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.BotMetadata",
        "This cmdlet returns a collection of BotMetadata objects.",
        "The service call response (type Amazon.LexModelBuildingService.Model.GetBotsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetLMBBotListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetBotsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Bots;
        ...
        private Amazon.LexModelBuildingService.Model.GetBotsResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetBotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetBots");
            try
            {
                #if DESKTOP
                return client.GetBots(request);
                #elif CORECLR
                return client.GetBotsAsync(request).GetAwaiter().GetResult();
                #else
