...
namespace Amazon.PowerShell.Cmdlets.LMB
{
    ...
    [AWSCmdlet("Calls the Amazon Lex Model Building Service GetSlotTypes API operation.", Operation = new[] {"GetSlotTypes"})]
    [AWSCmdletOutput("Amazon.LexModelBuildingService.Model.SlotTypeMetadata",
        ...
        "The service call response (type Amazon.LexModelBuildingService.Model.GetSlotTypesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetLMBSlotTypeListCmdlet : AmazonLexModelBuildingServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.LexModelBuildingService.Model.GetSlotTypesRequest();
        ...
        private Amazon.LexModelBuildingService.Model.GetSlotTypesResponse CallAWSServiceOperation(IAmazonLexModelBuildingService client, Amazon.LexModelBuildingService.Model.GetSlotTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Model Building Service", "GetSlotTypes");
            try
            {
                #if DESKTOP
                return client.GetSlotTypes(request);
                #elif CORECLR
                return client.GetSlotTypesAsync(request).GetAwaiter().GetResult();
                #else
