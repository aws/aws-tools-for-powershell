...
{
    /// <summary>
    /// Lists information about requested configured audience model associations.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCRSConfiguredAudienceModelAssociationListCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRooms.Model.ListConfiguredAudienceModelAssociationsResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.ListConfiguredAudienceModelAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListConfiguredAudienceModelAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
