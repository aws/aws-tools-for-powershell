...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Update", "CRSConfiguredTableAssociationAnalysisRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTableAssociationAnalysisRule")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service UpdateConfiguredTableAssociationAnalysisRule API operation.", Operation = new[] {"UpdateConfiguredTableAssociationAnalysisRule"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredTableAssociationAnalysisRule or Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredTableAssociationAnalysisRule object.",
        "The service call response (type Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCRSConfiguredTableAssociationAnalysisRuleCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The analysis rule type that you want to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para> The identifier for the configured table association to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse).
        /// Specifying the name of a property of type Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CRSConfiguredTableAssociationAnalysisRule (UpdateConfiguredTableAssociationAnalysisRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse, UpdateCRSConfiguredTableAssociationAnalysisRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleRequest();
        ...
        private Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "UpdateConfiguredTableAssociationAnalysisRule");
            try
            {
                #if DESKTOP
                return client.UpdateConfiguredTableAssociationAnalysisRule(request);
                #elif CORECLR
                return client.UpdateConfiguredTableAssociationAnalysisRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ConfiguredTableAssociationIdentifier { get; set; }
            public System.String MembershipIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationAnalysisRuleResponse, UpdateCRSConfiguredTableAssociationAnalysisRuleCmdlet, object> Select { get; set; } =
