...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CRSCollaboration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCRSCollaborationCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CRSCollaboration (DeleteCollaboration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.DeleteCollaborationResponse, RemoveCRSCollaborationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.DeleteCollaborationRequest();
        ...
        private Amazon.CleanRooms.Model.DeleteCollaborationResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.DeleteCollaborationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "DeleteCollaboration");
            try
            {
                #if DESKTOP
                return client.DeleteCollaboration(request);
                #elif CORECLR
                return client.DeleteCollaborationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CollaborationIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.DeleteCollaborationResponse, RemoveCRSCollaborationCmdlet, object> Select { get; set; } =
