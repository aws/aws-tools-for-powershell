...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    public partial class GetCRSMembershipCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetMembershipResponse, GetCRSMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetMembershipRequest();
        ...
        private Amazon.CleanRooms.Model.GetMembershipResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetMembership");
            try
            {
                #if DESKTOP
                return client.GetMembership(request);
                #elif CORECLR
                return client.GetMembershipAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MembershipIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetMembershipResponse, GetCRSMembershipCmdlet, object> Select { get; set; } =
