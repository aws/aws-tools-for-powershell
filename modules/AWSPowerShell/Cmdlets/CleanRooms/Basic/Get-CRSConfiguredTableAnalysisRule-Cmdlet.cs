...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSConfiguredTableAnalysisRule")]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTableAnalysisRule")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetConfiguredTableAnalysisRule API operation.", Operation = new[] {"GetConfiguredTableAnalysisRule"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredTableAnalysisRule or Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredTableAnalysisRule object.",
        "The service call response (type Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSConfiguredTableAnalysisRuleCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse, GetCRSConfiguredTableAnalysisRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleRequest();
        ...
        private Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetConfiguredTableAnalysisRule");
            try
            {
                #if DESKTOP
                return client.GetConfiguredTableAnalysisRule(request);
                #elif CORECLR
                return client.GetConfiguredTableAnalysisRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.CleanRooms.ConfiguredTableAnalysisRuleType AnalysisRuleType { get; set; }
            public System.String ConfiguredTableIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetConfiguredTableAnalysisRuleResponse, GetCRSConfiguredTableAnalysisRuleCmdlet, object> Select { get; set; } =
