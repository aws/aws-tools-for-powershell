...
{
    /// <summary>
    /// Lists configured tables.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "CRSConfiguredTableList")]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTableSummary")]
    ...
    public partial class GetCRSConfiguredTableListCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConfiguredTableSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.ListConfiguredTablesResponse, GetCRSConfiguredTableListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CleanRooms.Model.ListConfiguredTablesRequest();
        ...
        private Amazon.CleanRooms.Model.ListConfiguredTablesResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.ListConfiguredTablesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "ListConfiguredTables");
            try
            {
                return client.ListConfiguredTablesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CleanRooms.Model.ListConfiguredTablesResponse, GetCRSConfiguredTableListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ConfiguredTableSummaries;
        }
