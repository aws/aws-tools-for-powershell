...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CRSMember", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service DeleteMember API operation.", Operation = new[] {"DeleteMember"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.DeleteMemberResponse))]
    [AWSCmdletOutput("None or Amazon.CleanRooms.Model.DeleteMemberResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CleanRooms.Model.DeleteMemberResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCRSMemberCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CRSMember (DeleteMember)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.DeleteMemberResponse, RemoveCRSMemberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.DeleteMemberRequest();
        ...
        private Amazon.CleanRooms.Model.DeleteMemberResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.DeleteMemberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "DeleteMember");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String CollaborationIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.DeleteMemberResponse, RemoveCRSMemberCmdlet, object> Select { get; set; } =
