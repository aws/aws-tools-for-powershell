...
{
    /// <summary>
    /// Lists collaborations the caller owns, is active in, or has been invited to.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CleanRooms.Model.CollaborationSummary or Amazon.CleanRooms.Model.ListCollaborationsResponse",
        ...
        "The service call response (type Amazon.CleanRooms.Model.ListCollaborationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRSCollaborationListCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRooms.Model.ListCollaborationsResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.ListCollaborationsRequest request)
        {
            ...
            try
            {
                return client.ListCollaborationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
