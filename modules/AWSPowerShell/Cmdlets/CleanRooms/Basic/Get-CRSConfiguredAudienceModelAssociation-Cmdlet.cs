...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSConfiguredAudienceModelAssociation")]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredAudienceModelAssociation")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetConfiguredAudienceModelAssociation API operation.", Operation = new[] {"GetConfiguredAudienceModelAssociation"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredAudienceModelAssociation or Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredAudienceModelAssociation object.",
        "The service call response (type Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSConfiguredAudienceModelAssociationCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse, GetCRSConfiguredAudienceModelAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationRequest();
        ...
        private Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetConfiguredAudienceModelAssociation");
            try
            {
                #if DESKTOP
                return client.GetConfiguredAudienceModelAssociation(request);
                #elif CORECLR
                return client.GetConfiguredAudienceModelAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfiguredAudienceModelAssociationIdentifier { get; set; }
            public System.String MembershipIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetConfiguredAudienceModelAssociationResponse, GetCRSConfiguredAudienceModelAssociationCmdlet, object> Select { get; set; } =
