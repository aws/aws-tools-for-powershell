...
{
    /// <summary>
    /// Lists protected queries, sorted by the most recent query.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCRSProtectedQueryListCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRooms.Model.ListProtectedQueriesResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.ListProtectedQueriesRequest request)
        {
            ...
            try
            {
                return client.ListProtectedQueriesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
