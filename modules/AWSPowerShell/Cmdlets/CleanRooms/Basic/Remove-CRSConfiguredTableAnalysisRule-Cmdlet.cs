...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CRSConfiguredTableAnalysisRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service DeleteConfiguredTableAnalysisRule API operation.", Operation = new[] {"DeleteConfiguredTableAnalysisRule"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse))]
    [AWSCmdletOutput("None or Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCRSConfiguredTableAnalysisRuleCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CRSConfiguredTableAnalysisRule (DeleteConfiguredTableAnalysisRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse, RemoveCRSConfiguredTableAnalysisRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleRequest();
        ...
        private Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "DeleteConfiguredTableAnalysisRule");
            try
            {
                #if DESKTOP
                return client.DeleteConfiguredTableAnalysisRule(request);
                #elif CORECLR
                return client.DeleteConfiguredTableAnalysisRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public Amazon.CleanRooms.ConfiguredTableAnalysisRuleType AnalysisRuleType { get; set; }
            public System.String ConfiguredTableIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.DeleteConfiguredTableAnalysisRuleResponse, RemoveCRSConfiguredTableAnalysisRuleCmdlet, object> Select { get; set; } =
