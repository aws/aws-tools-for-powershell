...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// Names (ARNs).
    /// </summary>
    [Cmdlet("Get", "CRSBatchCollaborationAnalysisTemplate")]
    [OutputType("Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service BatchGetCollaborationAnalysisTemplate API operation.", Operation = new[] {"BatchGetCollaborationAnalysisTemplate"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSBatchCollaborationAnalysisTemplateCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse, GetCRSBatchCollaborationAnalysisTemplateCmdlet>(Select) ??
            ...
            if (this.AnalysisTemplateArn != null)
            {
                context.AnalysisTemplateArn = new List<System.String>(this.AnalysisTemplateArn);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateRequest();
            
            if (cmdletContext.AnalysisTemplateArn != null)
            {
                request.AnalysisTemplateArns = cmdletContext.AnalysisTemplateArn;
            }
        ...
        private Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "BatchGetCollaborationAnalysisTemplate");
            try
            {
                #if DESKTOP
                return client.BatchGetCollaborationAnalysisTemplate(request);
                #elif CORECLR
                return client.BatchGetCollaborationAnalysisTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<System.String> AnalysisTemplateArn { get; set; }
            public System.String CollaborationIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.BatchGetCollaborationAnalysisTemplateResponse, GetCRSBatchCollaborationAnalysisTemplateCmdlet, object> Select { get; set; } =
