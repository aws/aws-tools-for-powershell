...
{
    /// <summary>
    /// Lists analysis templates that the caller owns.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.CleanRooms.Model.AnalysisTemplateSummary or Amazon.CleanRooms.Model.ListAnalysisTemplatesResponse",
        ...
        "The service call response (type Amazon.CleanRooms.Model.ListAnalysisTemplatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRSAnalysisTemplateListCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        private Amazon.CleanRooms.Model.ListAnalysisTemplatesResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.ListAnalysisTemplatesRequest request)
        {
            ...
            try
            {
                return client.ListAnalysisTemplatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
