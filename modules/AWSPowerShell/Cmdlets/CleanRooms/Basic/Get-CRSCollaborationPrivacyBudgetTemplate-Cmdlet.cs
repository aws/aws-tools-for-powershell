...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSCollaborationPrivacyBudgetTemplate")]
    [OutputType("Amazon.CleanRooms.Model.CollaborationPrivacyBudgetTemplate")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetCollaborationPrivacyBudgetTemplate API operation.", Operation = new[] {"GetCollaborationPrivacyBudgetTemplate"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.CollaborationPrivacyBudgetTemplate or Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.CollaborationPrivacyBudgetTemplate object.",
        "The service call response (type Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSCollaborationPrivacyBudgetTemplateCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "CollaborationPrivacyBudgetTemplate";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse, GetCRSCollaborationPrivacyBudgetTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateRequest();
        ...
        private Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetCollaborationPrivacyBudgetTemplate");
            try
            {
                #if DESKTOP
                return client.GetCollaborationPrivacyBudgetTemplate(request);
                #elif CORECLR
                return client.GetCollaborationPrivacyBudgetTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CollaborationIdentifier { get; set; }
            public System.String PrivacyBudgetTemplateIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetCollaborationPrivacyBudgetTemplateResponse, GetCRSCollaborationPrivacyBudgetTemplateCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.CollaborationPrivacyBudgetTemplate;
        }
