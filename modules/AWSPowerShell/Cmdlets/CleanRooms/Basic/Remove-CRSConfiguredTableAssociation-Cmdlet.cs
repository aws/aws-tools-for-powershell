...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CRSConfiguredTableAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service DeleteConfiguredTableAssociation API operation.", Operation = new[] {"DeleteConfiguredTableAssociation"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse))]
    [AWSCmdletOutput("None or Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCRSConfiguredTableAssociationCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CRSConfiguredTableAssociation (DeleteConfiguredTableAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse, RemoveCRSConfiguredTableAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationRequest();
        ...
        private Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "DeleteConfiguredTableAssociation");
            try
            {
                #if DESKTOP
                return client.DeleteConfiguredTableAssociation(request);
                #elif CORECLR
                return client.DeleteConfiguredTableAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfiguredTableAssociationIdentifier { get; set; }
            public System.String MembershipIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.DeleteConfiguredTableAssociationResponse, RemoveCRSConfiguredTableAssociationCmdlet, object> Select { get; set; } =
