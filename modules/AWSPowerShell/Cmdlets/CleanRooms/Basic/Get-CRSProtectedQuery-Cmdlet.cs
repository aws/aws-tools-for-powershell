...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSProtectedQuery")]
    [OutputType("Amazon.CleanRooms.Model.ProtectedQuery")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetProtectedQuery API operation.", Operation = new[] {"GetProtectedQuery"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetProtectedQueryResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ProtectedQuery or Amazon.CleanRooms.Model.GetProtectedQueryResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ProtectedQuery object.",
        "The service call response (type Amazon.CleanRooms.Model.GetProtectedQueryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSProtectedQueryCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetProtectedQueryResponse, GetCRSProtectedQueryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetProtectedQueryRequest();
        ...
        private Amazon.CleanRooms.Model.GetProtectedQueryResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetProtectedQueryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetProtectedQuery");
            try
            {
                #if DESKTOP
                return client.GetProtectedQuery(request);
                #elif CORECLR
                return client.GetProtectedQueryAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String MembershipIdentifier { get; set; }
            public System.String ProtectedQueryIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetProtectedQueryResponse, GetCRSProtectedQueryCmdlet, object> Select { get; set; } =
