...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSSchema")]
    [OutputType("Amazon.CleanRooms.Model.Schema")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetSchema API operation.", Operation = new[] {"GetSchema"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetSchemaResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.Schema or Amazon.CleanRooms.Model.GetSchemaResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.Schema object.",
        "The service call response (type Amazon.CleanRooms.Model.GetSchemaResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCRSSchemaCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetSchemaResponse, GetCRSSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetSchemaRequest();
        ...
        private Amazon.CleanRooms.Model.GetSchemaResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetSchemaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetSchema");
            try
            {
                return client.GetSchemaAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CollaborationIdentifier { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetSchemaResponse, GetCRSSchemaCmdlet, object> Select { get; set; } =
