...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSConfiguredTableAssociation")]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTableAssociation")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetConfiguredTableAssociation API operation.", Operation = new[] {"GetConfiguredTableAssociation"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredTableAssociation or Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredTableAssociation object.",
        "The service call response (type Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSConfiguredTableAssociationCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse, GetCRSConfiguredTableAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetConfiguredTableAssociationRequest();
        ...
        private Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetConfiguredTableAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetConfiguredTableAssociation");
            try
            {
                #if DESKTOP
                return client.GetConfiguredTableAssociation(request);
                #elif CORECLR
                return client.GetConfiguredTableAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConfiguredTableAssociationIdentifier { get; set; }
            public System.String MembershipIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetConfiguredTableAssociationResponse, GetCRSConfiguredTableAssociationCmdlet, object> Select { get; set; } =
