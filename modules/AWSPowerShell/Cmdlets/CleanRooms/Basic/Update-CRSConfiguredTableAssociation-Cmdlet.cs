...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Update", "CRSConfiguredTableAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTableAssociation")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service UpdateConfiguredTableAssociation API operation.", Operation = new[] {"UpdateConfiguredTableAssociation"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredTableAssociation or Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredTableAssociation object.",
        "The service call response (type Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCRSConfiguredTableAssociationCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ConfiguredTableAssociation";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CRSConfiguredTableAssociation (UpdateConfiguredTableAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse, UpdateCRSConfiguredTableAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationRequest();
        ...
        private Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "UpdateConfiguredTableAssociation");
            try
            {
                #if DESKTOP
                return client.UpdateConfiguredTableAssociation(request);
                #elif CORECLR
                return client.UpdateConfiguredTableAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MembershipIdentifier { get; set; }
            public System.String RoleArn { get; set; }
            public System.Func<Amazon.CleanRooms.Model.UpdateConfiguredTableAssociationResponse, UpdateCRSConfiguredTableAssociationCmdlet, object> Select { get; set; } =
