...
namespace Amazon.PowerShell.Cmdlets.CRS
{
    ...
    /// </summary>
    [Cmdlet("Get", "CRSConfiguredTable")]
    [OutputType("Amazon.CleanRooms.Model.ConfiguredTable")]
    [AWSCmdlet("Calls the AWS Clean Rooms Service GetConfiguredTable API operation.", Operation = new[] {"GetConfiguredTable"}, SelectReturnType = typeof(Amazon.CleanRooms.Model.GetConfiguredTableResponse))]
    [AWSCmdletOutput("Amazon.CleanRooms.Model.ConfiguredTable or Amazon.CleanRooms.Model.GetConfiguredTableResponse",
        "This cmdlet returns an Amazon.CleanRooms.Model.ConfiguredTable object.",
        "The service call response (type Amazon.CleanRooms.Model.GetConfiguredTableResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCRSConfiguredTableCmdlet : AmazonCleanRoomsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CleanRooms.Model.GetConfiguredTableResponse, GetCRSConfiguredTableCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CleanRooms.Model.GetConfiguredTableRequest();
        ...
        private Amazon.CleanRooms.Model.GetConfiguredTableResponse CallAWSServiceOperation(IAmazonCleanRooms client, Amazon.CleanRooms.Model.GetConfiguredTableRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Clean Rooms Service", "GetConfiguredTable");
            try
            {
                #if DESKTOP
                return client.GetConfiguredTable(request);
                #elif CORECLR
                return client.GetConfiguredTableAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ConfiguredTableIdentifier { get; set; }
            public System.Func<Amazon.CleanRooms.Model.GetConfiguredTableResponse, GetCRSConfiguredTableCmdlet, object> Select { get; set; } =
