...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    public partial class RemoveB2BIProfileCmdlet : AmazonB2biClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-B2BIProfile (DeleteProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.B2bi.Model.DeleteProfileResponse, RemoveB2BIProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.B2bi.Model.DeleteProfileRequest();
        ...
        private Amazon.B2bi.Model.DeleteProfileResponse CallAWSServiceOperation(IAmazonB2bi client, Amazon.B2bi.Model.DeleteProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS B2B Data Interchange", "DeleteProfile");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ProfileId { get; set; }
            public System.Func<Amazon.B2bi.Model.DeleteProfileResponse, RemoveB2BIProfileCmdlet, object> Select { get; set; } =
