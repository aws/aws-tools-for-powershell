...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    [AWSCmdletOutput("Amazon.B2bi.Model.GetProfileResponse",
        "This cmdlet returns an Amazon.B2bi.Model.GetProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
