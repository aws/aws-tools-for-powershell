...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    /// incoming EDI documents into JSON or XML outputs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.B2bi.Model.CapabilitySummary or Amazon.B2bi.Model.ListCapabilitiesResponse",
        ...
        "The service call response (type Amazon.B2bi.Model.ListCapabilitiesResponse) can be returned by specifying '-Select *'."
    )]
