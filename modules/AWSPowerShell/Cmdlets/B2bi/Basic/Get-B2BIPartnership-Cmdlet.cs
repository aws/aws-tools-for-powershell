...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    [AWSCmdlet("Calls the AWS B2B Data Interchange GetPartnership API operation.", Operation = new[] {"GetPartnership"}, SelectReturnType = typeof(Amazon.B2bi.Model.GetPartnershipResponse))]
    [AWSCmdletOutput("Amazon.B2bi.Model.GetPartnershipResponse",
        "This cmdlet returns an Amazon.B2bi.Model.GetPartnershipResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetB2BIPartnershipCmdlet : AmazonB2biClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^PartnershipId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.B2bi.Model.GetPartnershipResponse, GetB2BIPartnershipCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.PartnershipId;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.B2bi.Model.GetPartnershipRequest();
        ...
        private Amazon.B2bi.Model.GetPartnershipResponse CallAWSServiceOperation(IAmazonB2bi client, Amazon.B2bi.Model.GetPartnershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS B2B Data Interchange", "GetPartnership");
            try
            {
                #if DESKTOP
                return client.GetPartnership(request);
                #elif CORECLR
                return client.GetPartnershipAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PartnershipId { get; set; }
            public System.Func<Amazon.B2bi.Model.GetPartnershipResponse, GetB2BIPartnershipCmdlet, object> Select { get; set; } =
