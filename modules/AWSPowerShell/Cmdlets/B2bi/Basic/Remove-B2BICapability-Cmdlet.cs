...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS B2B Data Interchange DeleteCapability API operation.", Operation = new[] {"DeleteCapability"}, SelectReturnType = typeof(Amazon.B2bi.Model.DeleteCapabilityResponse))]
    [AWSCmdletOutput("None or Amazon.B2bi.Model.DeleteCapabilityResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.B2bi.Model.DeleteCapabilityResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveB2BICapabilityCmdlet : AmazonB2biClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-B2BICapability (DeleteCapability)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.B2bi.Model.DeleteCapabilityResponse, RemoveB2BICapabilityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.B2bi.Model.DeleteCapabilityRequest();
        ...
        private Amazon.B2bi.Model.DeleteCapabilityResponse CallAWSServiceOperation(IAmazonB2bi client, Amazon.B2bi.Model.DeleteCapabilityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS B2B Data Interchange", "DeleteCapability");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String CapabilityId { get; set; }
            public System.Func<Amazon.B2bi.Model.DeleteCapabilityResponse, RemoveB2BICapabilityCmdlet, object> Select { get; set; } =
