...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "B2BIResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddB2BIResourceTagCmdlet : AmazonB2biClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-B2BIResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.B2bi.Model.TagResourceResponse, AddB2BIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.B2bi.Model.TagResourceRequest();
        ...
        private Amazon.B2bi.Model.TagResourceResponse CallAWSServiceOperation(IAmazonB2bi client, Amazon.B2bi.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS B2B Data Interchange", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.B2bi.Model.TagResourceResponse, AddB2BIResourceTagCmdlet, object> Select { get; set; } =
