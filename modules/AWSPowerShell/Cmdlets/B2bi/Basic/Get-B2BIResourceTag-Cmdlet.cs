...
namespace Amazon.PowerShell.Cmdlets.B2BI
{
    ...
    /// </summary>
    [Cmdlet("Get", "B2BIResourceTag")]
    [OutputType("Amazon.B2bi.Model.Tag")]
    ...
    public partial class GetB2BIResourceTagCmdlet : AmazonB2biClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.B2bi.Model.ListTagsForResourceResponse, GetB2BIResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.B2bi.Model.ListTagsForResourceRequest();
        ...
        private Amazon.B2bi.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonB2bi client, Amazon.B2bi.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS B2B Data Interchange", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.B2bi.Model.ListTagsForResourceResponse, GetB2BIResourceTagCmdlet, object> Select { get; set; } =
