...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "NPTGlobalCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveNPTGlobalClusterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Neptune.Model.DeleteGlobalClusterResponse).
        /// Specifying the name of a property of type Amazon.Neptune.Model.DeleteGlobalClusterResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NPTGlobalCluster (DeleteGlobalCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DeleteGlobalClusterResponse, RemoveNPTGlobalClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptune.Model.DeleteGlobalClusterRequest();
        ...
        private Amazon.Neptune.Model.DeleteGlobalClusterResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DeleteGlobalClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DeleteGlobalCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String GlobalClusterIdentifier { get; set; }
            public System.Func<Amazon.Neptune.Model.DeleteGlobalClusterResponse, RemoveNPTGlobalClusterCmdlet, object> Select { get; set; } =
