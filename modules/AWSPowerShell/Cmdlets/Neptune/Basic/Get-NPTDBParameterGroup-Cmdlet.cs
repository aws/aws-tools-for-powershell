...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NPTDBParameterGroup")]
    [OutputType("Amazon.Neptune.Model.DBParameterGroup")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBParameterGroups API operation.", Operation = new[] {"DescribeDBParameterGroups"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribeDBParameterGroupsResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBParameterGroup or Amazon.Neptune.Model.DescribeDBParameterGroupsResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.DBParameterGroup objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBParameterGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNPTDBParameterGroupCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DBParameterGroups";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribeDBParameterGroupsResponse, GetNPTDBParameterGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeDBParameterGroupsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DBParameterGroups?.Count ?? 0;
        ...
        private Amazon.Neptune.Model.DescribeDBParameterGroupsResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeDBParameterGroupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeDBParameterGroups");
            try
            {
                return client.DescribeDBParameterGroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribeDBParameterGroupsResponse, GetNPTDBParameterGroupCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DBParameterGroups;
        }
