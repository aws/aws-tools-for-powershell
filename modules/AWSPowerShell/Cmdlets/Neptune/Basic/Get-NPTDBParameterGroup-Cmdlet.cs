...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdletOutput("Amazon.Neptune.Model.DBParameterGroup or Amazon.Neptune.Model.DescribeDBParameterGroupsResponse",
        ...
        "The service call response (type Amazon.Neptune.Model.DescribeDBParameterGroupsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
