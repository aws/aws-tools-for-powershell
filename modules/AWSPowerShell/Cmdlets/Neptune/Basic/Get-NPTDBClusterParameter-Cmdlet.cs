...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NPTDBClusterParameter")]
    [OutputType("Amazon.Neptune.Model.Parameter")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBClusterParameters API operation.", Operation = new[] {"DescribeDBClusterParameters"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribeDBClusterParametersResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.Parameter or Amazon.Neptune.Model.DescribeDBClusterParametersResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.Parameter objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBClusterParametersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNPTDBClusterParameterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribeDBClusterParametersResponse, GetNPTDBClusterParameterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeDBClusterParametersRequest();
        ...
        private Amazon.Neptune.Model.DescribeDBClusterParametersResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeDBClusterParametersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeDBClusterParameters");
            try
            {
                return client.DescribeDBClusterParametersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String Source { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribeDBClusterParametersResponse, GetNPTDBClusterParameterCmdlet, object> Select { get; set; } =
