...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdletOutput("Amazon.Neptune.Model.Parameter or Amazon.Neptune.Model.DescribeDBClusterParametersResponse",
        ...
        "The service call response (type Amazon.Neptune.Model.DescribeDBClusterParametersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
