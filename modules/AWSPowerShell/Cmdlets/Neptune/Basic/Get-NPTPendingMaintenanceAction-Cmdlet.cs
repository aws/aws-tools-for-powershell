...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune DescribePendingMaintenanceActions API operation.", Operation = new[] {"DescribePendingMaintenanceActions"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribePendingMaintenanceActionsResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.ResourcePendingMaintenanceActions or Amazon.Neptune.Model.DescribePendingMaintenanceActionsResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.ResourcePendingMaintenanceActions objects.",
        "The service call response (type Amazon.Neptune.Model.DescribePendingMaintenanceActionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNPTPendingMaintenanceActionCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        /// DB clusters identified by these ARNs.</para></li><li><para><c>db-instance-id</c> - Accepts DB instance identifiers and DB instance ARNs. The
        /// results list will only include pending maintenance actions for the DB instances identified
        /// by these ARNs.</para></li></ul><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribePendingMaintenanceActionsResponse, GetNPTPendingMaintenanceActionCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String ResourceIdentifier { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribePendingMaintenanceActionsResponse, GetNPTPendingMaintenanceActionCmdlet, object> Select { get; set; } =
