...
{
    /// <summary>
    /// Returns information about provisioned DB clusters. This API supports pagination.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "NPTDBCluster")]
    [OutputType("Amazon.Neptune.Model.DBCluster")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBClusters API operation.", Operation = new[] {"DescribeDBClusters"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribeDBClustersResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBCluster or Amazon.Neptune.Model.DescribeDBClustersResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.DBCluster objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBClustersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNPTDBClusterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribeDBClustersResponse, GetNPTDBClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeDBClustersRequest();
        ...
        private Amazon.Neptune.Model.DescribeDBClustersResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeDBClustersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeDBClusters");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribeDBClustersResponse, GetNPTDBClusterCmdlet, object> Select { get; set; } =
