...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdletOutput("Amazon.Neptune.Model.DBCluster or Amazon.Neptune.Model.DescribeDBClustersResponse",
        ...
        "The service call response (type Amazon.Neptune.Model.DescribeDBClustersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNPTDBClusterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        /// DB clusters are returned, you could use the following command:</para><para />
