...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune DescribeDBClusterParameterGroups API operation.", Operation = new[] {"DescribeDBClusterParameterGroups"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBClusterParameterGroup or Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.DBClusterParameterGroup objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetNPTDBClusterParameterGroupCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse, GetNPTDBClusterParameterGroupCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Marker { get; set; }
            public int? MaxRecord { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribeDBClusterParameterGroupsResponse, GetNPTDBClusterParameterGroupCmdlet, object> Select { get; set; } =
