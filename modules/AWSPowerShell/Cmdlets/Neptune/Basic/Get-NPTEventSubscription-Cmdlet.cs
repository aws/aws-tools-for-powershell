...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NPTEventSubscription")]
    [OutputType("Amazon.Neptune.Model.EventSubscription")]
    [AWSCmdlet("Calls the Amazon Neptune DescribeEventSubscriptions API operation.", Operation = new[] {"DescribeEventSubscriptions"}, SelectReturnType = typeof(Amazon.Neptune.Model.DescribeEventSubscriptionsResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.EventSubscription or Amazon.Neptune.Model.DescribeEventSubscriptionsResponse",
        "This cmdlet returns a collection of Amazon.Neptune.Model.EventSubscription objects.",
        "The service call response (type Amazon.Neptune.Model.DescribeEventSubscriptionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNPTEventSubscriptionCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DescribeEventSubscriptionsResponse, GetNPTEventSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Neptune.Model.DescribeEventSubscriptionsRequest();
        ...
        private Amazon.Neptune.Model.DescribeEventSubscriptionsResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DescribeEventSubscriptionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DescribeEventSubscriptions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String SubscriptionName { get; set; }
            public System.Func<Amazon.Neptune.Model.DescribeEventSubscriptionsResponse, GetNPTEventSubscriptionCmdlet, object> Select { get; set; } =
