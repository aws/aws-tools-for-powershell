...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </summary>
    [Cmdlet("Add", "NPTSourceIdentifierToSubscription", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Neptune.Model.EventSubscription")]
    [AWSCmdlet("Calls the Amazon Neptune AddSourceIdentifierToSubscription API operation.", Operation = new[] {"AddSourceIdentifierToSubscription"}, SelectReturnType = typeof(Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.EventSubscription or Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse",
        "This cmdlet returns an Amazon.Neptune.Model.EventSubscription object.",
        "The service call response (type Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddNPTSourceIdentifierToSubscriptionCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse, AddNPTSourceIdentifierToSubscriptionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionRequest();
        ...
        private Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "AddSourceIdentifierToSubscription");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String SourceIdentifier { get; set; }
            public System.String SubscriptionName { get; set; }
            public System.Func<Amazon.Neptune.Model.AddSourceIdentifierToSubscriptionResponse, AddNPTSourceIdentifierToSubscriptionCmdlet, object> Select { get; set; } =
