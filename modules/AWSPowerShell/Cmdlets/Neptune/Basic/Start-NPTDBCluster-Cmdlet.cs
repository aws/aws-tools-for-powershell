...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune StartDBCluster API operation.", Operation = new[] {"StartDBCluster"}, SelectReturnType = typeof(Amazon.Neptune.Model.StartDBClusterResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBCluster or Amazon.Neptune.Model.StartDBClusterResponse",
        "This cmdlet returns an Amazon.Neptune.Model.DBCluster object.",
        "The service call response (type Amazon.Neptune.Model.StartDBClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartNPTDBClusterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-NPTDBCluster (StartDBCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.StartDBClusterResponse, StartNPTDBClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptune.Model.StartDBClusterRequest();
        ...
        private Amazon.Neptune.Model.StartDBClusterResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.StartDBClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "StartDBCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DBClusterIdentifier { get; set; }
            public System.Func<Amazon.Neptune.Model.StartDBClusterResponse, StartNPTDBClusterCmdlet, object> Select { get; set; } =
