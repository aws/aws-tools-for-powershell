...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdlet("Calls the Amazon Neptune DeleteDBClusterSnapshot API operation.", Operation = new[] {"DeleteDBClusterSnapshot"}, SelectReturnType = typeof(Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBClusterSnapshot or Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse",
        "This cmdlet returns an Amazon.Neptune.Model.DBClusterSnapshot object.",
        "The service call response (type Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveNPTDBClusterSnapshotCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-NPTDBClusterSnapshot (DeleteDBClusterSnapshot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse, RemoveNPTDBClusterSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptune.Model.DeleteDBClusterSnapshotRequest();
        ...
        private Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.DeleteDBClusterSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "DeleteDBClusterSnapshot");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DBClusterSnapshotIdentifier { get; set; }
            public System.Func<Amazon.Neptune.Model.DeleteDBClusterSnapshotResponse, RemoveNPTDBClusterSnapshotCmdlet, object> Select { get; set; } =
