...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    [AWSCmdletOutput("Amazon.Neptune.Model.GlobalCluster or Amazon.Neptune.Model.RemoveFromGlobalClusterResponse",
        ...
        "The service call response (type Amazon.Neptune.Model.RemoveFromGlobalClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
