...
namespace Amazon.PowerShell.Cmdlets.NPT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Stop", "NPTDBCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Neptune.Model.DBCluster")]
    [AWSCmdlet("Calls the Amazon Neptune StopDBCluster API operation.", Operation = new[] {"StopDBCluster"}, SelectReturnType = typeof(Amazon.Neptune.Model.StopDBClusterResponse))]
    [AWSCmdletOutput("Amazon.Neptune.Model.DBCluster or Amazon.Neptune.Model.StopDBClusterResponse",
        "This cmdlet returns an Amazon.Neptune.Model.DBCluster object.",
        "The service call response (type Amazon.Neptune.Model.StopDBClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StopNPTDBClusterCmdlet : AmazonNeptuneClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-NPTDBCluster (StopDBCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptune.Model.StopDBClusterResponse, StopNPTDBClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptune.Model.StopDBClusterRequest();
        ...
        private Amazon.Neptune.Model.StopDBClusterResponse CallAWSServiceOperation(IAmazonNeptune client, Amazon.Neptune.Model.StopDBClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Neptune", "StopDBCluster");
            try
            {
                #if DESKTOP
                return client.StopDBCluster(request);
                #elif CORECLR
                return client.StopDBClusterAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DBClusterIdentifier { get; set; }
            public System.Func<Amazon.Neptune.Model.StopDBClusterResponse, StopNPTDBClusterCmdlet, object> Select { get; set; } =
