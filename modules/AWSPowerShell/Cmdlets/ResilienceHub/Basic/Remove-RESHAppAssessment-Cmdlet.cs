...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdlet("Calls the AWS Resilience Hub DeleteAppAssessment API operation.", Operation = new[] {"DeleteAppAssessment"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRESHAppAssessmentCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RESHAppAssessment (DeleteAppAssessment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse, RemoveRESHAppAssessmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DeleteAppAssessmentRequest();
        ...
        private Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DeleteAppAssessmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DeleteAppAssessment");
            try
            {
                #if DESKTOP
                return client.DeleteAppAssessment(request);
                #elif CORECLR
                return client.DeleteAppAssessmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssessmentArn { get; set; }
            public System.String ClientToken { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DeleteAppAssessmentResponse, RemoveRESHAppAssessmentCmdlet, object> Select { get; set; } =
