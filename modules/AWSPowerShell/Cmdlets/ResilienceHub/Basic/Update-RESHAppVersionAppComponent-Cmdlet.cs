...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Update", "RESHAppVersionAppComponent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse")]
    [AWSCmdlet("Calls the AWS Resilience Hub UpdateAppVersionAppComponent API operation.", Operation = new[] {"UpdateAppVersionAppComponent"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateRESHAppVersionAppComponentCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-RESHAppVersionAppComponent (UpdateAppVersionAppComponent)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse, UpdateRESHAppVersionAppComponentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentRequest();
        ...
        private Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "UpdateAppVersionAppComponent");
            try
            {
                #if DESKTOP
                return client.UpdateAppVersionAppComponent(request);
                #elif CORECLR
                return client.UpdateAppVersionAppComponentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Name { get; set; }
            public System.String Type { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.UpdateAppVersionAppComponentResponse, UpdateRESHAppVersionAppComponentCmdlet, object> Select { get; set; } =
