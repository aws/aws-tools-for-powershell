...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.AppAssessment or Amazon.ResilienceHub.Model.StartAppAssessmentResponse",
        ...
        "The service call response (type Amazon.ResilienceHub.Model.StartAppAssessmentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
