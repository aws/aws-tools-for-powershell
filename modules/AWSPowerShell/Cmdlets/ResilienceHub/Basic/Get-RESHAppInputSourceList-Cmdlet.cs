...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.AppInputSource or Amazon.ResilienceHub.Model.ListAppInputSourcesResponse",
        ...
        "The service call response (type Amazon.ResilienceHub.Model.ListAppInputSourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHAppInputSourceListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Maximum number of input sources to be displayed per AWS Resilience Hub application.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("MaxResults")]
