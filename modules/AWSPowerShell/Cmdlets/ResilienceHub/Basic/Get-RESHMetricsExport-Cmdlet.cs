...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    public partial class GetRESHMetricsExportCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^MetricsExportId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.MetricsExportId;
            }
        ...
        private Amazon.ResilienceHub.Model.DescribeMetricsExportResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DescribeMetricsExportRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeMetricsExport(request);
                #elif CORECLR
                return client.DescribeMetricsExportAsync(request).GetAwaiter().GetResult();
                #else
