...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdlet("Calls the AWS Resilience Hub ListUnsupportedAppVersionResources API operation.", Operation = new[] {"ListUnsupportedAppVersionResources"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHUnsupportedAppVersionResourceListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse, GetRESHUnsupportedAppVersionResourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesRequest();
        ...
        private Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListUnsupportedAppVersionResources");
            try
            {
                #if DESKTOP
                return client.ListUnsupportedAppVersionResources(request);
                #elif CORECLR
                return client.ListUnsupportedAppVersionResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResolutionId { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.ListUnsupportedAppVersionResourcesResponse, GetRESHUnsupportedAppVersionResourceListCmdlet, object> Select { get; set; } =
