...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdlet("Calls the AWS Resilience Hub ListSopRecommendations API operation.", Operation = new[] {"ListSopRecommendations"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListSopRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.SopRecommendation or Amazon.ResilienceHub.Model.ListSopRecommendationsResponse",
        "This cmdlet returns a collection of Amazon.ResilienceHub.Model.SopRecommendation objects.",
        "The service call response (type Amazon.ResilienceHub.Model.ListSopRecommendationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHSopRecommendationListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Amazon Resource Name (ARN) of the assessment. The format for this ARN is: arn:<code>partition</code>:dcps:<code>region</code>:<code>account</code>:app-assessment/<code>app-id</code>.
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SopRecommendations";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListSopRecommendationsResponse, GetRESHSopRecommendationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListSopRecommendationsRequest();
        ...
        private Amazon.ResilienceHub.Model.ListSopRecommendationsResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListSopRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListSopRecommendations");
            try
            {
                #if DESKTOP
                return client.ListSopRecommendations(request);
                #elif CORECLR
                return client.ListSopRecommendationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.ListSopRecommendationsResponse, GetRESHSopRecommendationListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SopRecommendations;
        }
