...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Get", "RESHAppVersionTemplate")]
    [OutputType("Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse")]
    [AWSCmdlet("Calls the AWS Resilience Hub DescribeAppVersionTemplate API operation.", Operation = new[] {"DescribeAppVersionTemplate"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHAppVersionTemplateCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse, GetRESHAppVersionTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DescribeAppVersionTemplateRequest();
        ...
        private Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DescribeAppVersionTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DescribeAppVersionTemplate");
            try
            {
                #if DESKTOP
                return client.DescribeAppVersionTemplate(request);
                #elif CORECLR
                return client.DescribeAppVersionTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AppArn { get; set; }
            public System.String AppVersion { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DescribeAppVersionTemplateResponse, GetRESHAppVersionTemplateCmdlet, object> Select { get; set; } =
