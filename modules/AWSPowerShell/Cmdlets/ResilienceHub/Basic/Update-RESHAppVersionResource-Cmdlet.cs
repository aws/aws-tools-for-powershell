...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.UpdateAppVersionResourceResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.UpdateAppVersionResourceResponse object containing multiple properties."
    )]
    public partial class UpdateRESHAppVersionResourceCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Currently, there is no supported additional information for resources.</para><para />
        ...
        /// is not part of the Resilience Hub application, it will be added.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.ResilienceHub.Model.UpdateAppVersionResourceResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.UpdateAppVersionResourceRequest request)
        {
            ...
            try
            {
                return client.UpdateAppVersionResourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
