...
{
    /// <summary>
    /// Lists all the resources in an AWS Resilience Hub application.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "RESHAppVersionResourceList")]
    [OutputType("Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse")]
    [AWSCmdlet("Calls the AWS Resilience Hub ListAppVersionResources API operation.", Operation = new[] {"ListAppVersionResources"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHAppVersionResourceListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public System.String ResolutionId { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse, GetRESHAppVersionResourceListCmdlet>(Select) ??
            ...
            context.ResolutionId = this.ResolutionId;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListAppVersionResourcesRequest();
            ...
            if (cmdletContext.ResolutionId != null)
            {
                request.ResolutionId = cmdletContext.ResolutionId;
            }
        ...
        private Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListAppVersionResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListAppVersionResources");
            try
            {
                #if DESKTOP
                return client.ListAppVersionResources(request);
                #elif CORECLR
                return client.ListAppVersionResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResolutionId { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.ListAppVersionResourcesResponse, GetRESHAppVersionResourceListCmdlet, object> Select { get; set; } =
