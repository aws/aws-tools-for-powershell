...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RESHResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveRESHResourceTagCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The keys of the tags you want to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RESHResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.UntagResourceResponse, RemoveRESHResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.UntagResourceRequest();
        ...
        private Amazon.ResilienceHub.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.ResilienceHub.Model.UntagResourceResponse, RemoveRESHResourceTagCmdlet, object> Select { get; set; } =
