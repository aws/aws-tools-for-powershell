...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    public partial class RemoveRESHAppCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RESHApp (DeleteApp)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DeleteAppResponse, RemoveRESHAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DeleteAppRequest();
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientToken { get; set; }
            public System.Boolean? ForceDelete { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DeleteAppResponse, RemoveRESHAppCmdlet, object> Select { get; set; } =
