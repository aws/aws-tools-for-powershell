...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RESHResiliencyPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Resilience Hub DeleteResiliencyPolicy API operation.", Operation = new[] {"DeleteResiliencyPolicy"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse))]
    [AWSCmdletOutput("System.String or Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRESHResiliencyPolicyCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PolicyArn";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RESHResiliencyPolicy (DeleteResiliencyPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse, RemoveRESHResiliencyPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DeleteResiliencyPolicyRequest();
        ...
        private Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DeleteResiliencyPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DeleteResiliencyPolicy");
            try
            {
                #if DESKTOP
                return client.DeleteResiliencyPolicy(request);
                #elif CORECLR
                return client.DeleteResiliencyPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String PolicyArn { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DeleteResiliencyPolicyResponse, RemoveRESHResiliencyPolicyCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PolicyArn;
        }
