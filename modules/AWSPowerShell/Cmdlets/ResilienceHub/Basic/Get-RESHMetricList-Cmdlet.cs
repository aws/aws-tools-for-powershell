...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Get", "RESHMetricList")]
    [OutputType("System.Collections.Generic.List<System.String>")]
    [AWSCmdlet("Calls the AWS Resilience Hub ListMetrics API operation.", Operation = new[] {"ListMetrics"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListMetricsResponse))]
    [AWSCmdletOutput("System.Collections.Generic.List<System.String> or Amazon.ResilienceHub.Model.ListMetricsResponse",
        "This cmdlet returns a collection of List<System.String> objects.",
        "The service call response (type Amazon.ResilienceHub.Model.ListMetricsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRESHMetricListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        [Alias("Conditions")]
        public Amazon.ResilienceHub.Model.Condition[] Condition { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Fields")]
        public Amazon.ResilienceHub.Model.Field[] Field { get; set; }
        #endregion
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Sorts")]
        public Amazon.ResilienceHub.Model.Sort[] Sort { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^DataSource' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListMetricsResponse, GetRESHMetricListCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.DataSource;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            if (this.Condition != null)
            {
                context.Condition = new List<Amazon.ResilienceHub.Model.Condition>(this.Condition);
            }
            context.DataSource = this.DataSource;
            if (this.Field != null)
            {
                context.Field = new List<Amazon.ResilienceHub.Model.Field>(this.Field);
            }
            context.MaxResult = this.MaxResult;
            context.NextToken = this.NextToken;
            if (this.Sort != null)
            {
                context.Sort = new List<Amazon.ResilienceHub.Model.Sort>(this.Sort);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListMetricsRequest();
        ...
        private Amazon.ResilienceHub.Model.ListMetricsResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListMetricsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListMetrics");
            try
            {
                #if DESKTOP
        ...
        {
            public List<Amazon.ResilienceHub.Model.Condition> Condition { get; set; }
            public System.String DataSource { get; set; }
            public List<Amazon.ResilienceHub.Model.Field> Field { get; set; }
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public List<Amazon.ResilienceHub.Model.Sort> Sort { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.ListMetricsResponse, GetRESHMetricListCmdlet, object> Select { get; set; } =
