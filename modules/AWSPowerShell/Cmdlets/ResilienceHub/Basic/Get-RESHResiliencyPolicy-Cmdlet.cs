...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Get", "RESHResiliencyPolicy")]
    [OutputType("Amazon.ResilienceHub.Model.ResiliencyPolicy")]
    [AWSCmdlet("Calls the AWS Resilience Hub DescribeResiliencyPolicy API operation.", Operation = new[] {"DescribeResiliencyPolicy"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.ResiliencyPolicy or Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse",
        "This cmdlet returns an Amazon.ResilienceHub.Model.ResiliencyPolicy object.",
        "The service call response (type Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHResiliencyPolicyCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse, GetRESHResiliencyPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DescribeResiliencyPolicyRequest();
        ...
        private Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DescribeResiliencyPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DescribeResiliencyPolicy");
            try
            {
                #if DESKTOP
                return client.DescribeResiliencyPolicy(request);
                #elif CORECLR
                return client.DescribeResiliencyPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PolicyArn { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DescribeResiliencyPolicyResponse, GetRESHResiliencyPolicyCmdlet, object> Select { get; set; } =
