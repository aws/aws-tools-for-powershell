...
{
    /// <summary>
    /// Lists the different versions for the AWS Resilience Hub applications.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "RESHAppVersionList")]
    [OutputType("Amazon.ResilienceHub.Model.AppVersionSummary")]
    [AWSCmdlet("Calls the AWS Resilience Hub ListAppVersions API operation.", Operation = new[] {"ListAppVersions"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListAppVersionsResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.AppVersionSummary or Amazon.ResilienceHub.Model.ListAppVersionsResponse",
        "This cmdlet returns a collection of Amazon.ResilienceHub.Model.AppVersionSummary objects.",
        "The service call response (type Amazon.ResilienceHub.Model.ListAppVersionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHAppVersionListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AppVersions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListAppVersionsResponse, GetRESHAppVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListAppVersionsRequest();
        ...
        private Amazon.ResilienceHub.Model.ListAppVersionsResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListAppVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListAppVersions");
            try
            {
                #if DESKTOP
                return client.ListAppVersions(request);
                #elif CORECLR
                return client.ListAppVersionsAsync(request).GetAwaiter().GetResult();
                #else
