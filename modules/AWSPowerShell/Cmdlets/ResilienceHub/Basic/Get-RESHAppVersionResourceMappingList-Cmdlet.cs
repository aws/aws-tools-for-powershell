...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Get", "RESHAppVersionResourceMappingList")]
    [OutputType("Amazon.ResilienceHub.Model.ResourceMapping")]
    [AWSCmdlet("Calls the AWS Resilience Hub ListAppVersionResourceMappings API operation.", Operation = new[] {"ListAppVersionResourceMappings"}, SelectReturnType = typeof(Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse))]
    [AWSCmdletOutput("Amazon.ResilienceHub.Model.ResourceMapping or Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse",
        "This cmdlet returns a collection of Amazon.ResilienceHub.Model.ResourceMapping objects.",
        "The service call response (type Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRESHAppVersionResourceMappingListCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResourceMappings";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse, GetRESHAppVersionResourceMappingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsRequest();
        ...
        private Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "ListAppVersionResourceMappings");
            try
            {
                #if DESKTOP
                return client.ListAppVersionResourceMappings(request);
                #elif CORECLR
                return client.ListAppVersionResourceMappingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.ListAppVersionResourceMappingsResponse, GetRESHAppVersionResourceMappingListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResourceMappings;
        }
