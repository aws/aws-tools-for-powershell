...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    public partial class WriteRESHDraftAppVersionTemplateCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// in the <i>Examples</i> section.</para><para>The <code>appTemplateBody</code> JSON string has the following structure:</para><ul><li><para><b><code>resources</code></b></para><para>The list of logical resources that must be included in the Resilience Hub application.</para><para>Type: Array</para><note><para>Don't add the resources that you want to exclude.</para></note><para>Each <code>resources</code> array item includes the following fields:</para><ul><li><para><i><code>logicalResourceId</code></i></para><para>Logical identifier of the resource.</para><para>Type: Object</para><para>Each <code>logicalResourceId</code> object includes the following fields:</para><ul><li><para><code>identifier</code></para><para>Identifier of the resource.</para><para>Type: String</para></li><li><para><code>logicalStackName</code></para><para>The name of the CloudFormation stack this resource belongs to.</para><para>Type: String</para></li><li><para><code>resourceGroupName</code></para><para>The name of the resource group this resource belongs to.</para><para>Type: String</para></li><li><para><code>terraformSourceName</code></para><para>The name of the Terraform S3 state file this resource belongs to.</para><para>Type: String</para></li><li><para><code>eksSourceName</code></para><para>Name of the Amazon Elastic Kubernetes Service cluster and namespace this resource
        /// belongs to.</para><note><para>This parameter accepts values in "eks-cluster/namespace" format.</para></note><para>Type: String</para></li></ul></li><li><para><i><code>type</code></i></para><para>The type of resource.</para><para>Type: string</para></li><li><para><i><code>name</code></i></para><para>The name of the resource.</para><para>Type: String</para></li><li><para><code>additionalInfo</code></para><para>Additional configuration parameters for an Resilience Hub application. If you want
        ...
        /// one failover region and one associated account.</para><para>Key: <code>"failover-regions"</code></para><para>Value: <code>"[{"region":"&lt;REGION&gt;", "accounts":[{"id":"&lt;ACCOUNT_ID&gt;"}]}]"</code></para></note></li></ul></li><li><para><b><code>appComponents</code></b></para><para>List of Application Components that this resource belongs to. If an Application Component
        /// is not part of the Resilience Hub application, it will be added.</para><para>Type: Array</para><para>Each <code>appComponents</code> array item includes the following fields:</para><ul><li><para><code>name</code></para><para>Name of the Application Component.</para><para>Type: String</para></li><li><para><code>type</code></para><para>Type of Application Component. For more information about the types of Application
        ...
        /// than using an API call, see <a href="https://docs.aws.amazon.com/resilience-hub/latest/userguide/app-config-param.html">Configure
        /// the application configuration parameters</a>.</para><note><para>Currently, this parameter accepts a key-value mapping (in a string format) of only
        /// one failover region and one associated account.</para><para>Key: <code>"failover-regions"</code></para><para>Value: <code>"[{"region":"&lt;REGION&gt;", "accounts":[{"id":"&lt;ACCOUNT_ID&gt;"}]}]"</code></para></note></li></ul></li><li><para><b><code>excludedResources</code></b></para><para>The list of logical resource identifiers to be excluded from the application.</para><para>Type: Array</para><note><para>Don't add the resources that you want to include.</para></note><para>Each <code>excludedResources</code> array item includes the following fields:</para><ul><li><para><i><code>logicalResourceIds</code></i></para><para>Logical identifier of the resource.</para><para>Type: Object</para><note><para>You can configure only one of the following fields:</para><ul><li><para><code>logicalStackName</code></para></li><li><para><code>resourceGroupName</code></para></li><li><para><code>terraformSourceName</code></para></li><li><para><code>eksSourceName</code></para></li></ul></note><para>Each <code>logicalResourceIds</code> object includes the following fields:</para><ul><li><para><code>identifier</code></para><para>Identifier of the resource.</para><para>Type: String</para></li><li><para><code>logicalStackName</code></para><para>The name of the CloudFormation stack this resource belongs to.</para><para>Type: String</para></li><li><para><code>resourceGroupName</code></para><para>The name of the resource group this resource belongs to.</para><para>Type: String</para></li><li><para><code>terraformSourceName</code></para><para>The name of the Terraform S3 state file this resource belongs to.</para><para>Type: String</para></li><li><para><code>eksSourceName</code></para><para>Name of the Amazon Elastic Kubernetes Service cluster and namespace this resource
        /// belongs to.</para><note><para>This parameter accepts values in "eks-cluster/namespace" format.</para></note><para>Type: String</para></li></ul></li></ul></li><li><para><b><code>version</code></b></para><para>Resilience Hub application version.</para></li><li><para><code>additionalInfo</code></para><para>Additional configuration parameters for an Resilience Hub application. If you want
        /// to implement <code>additionalInfo</code> through the Resilience Hub console rather
        /// than using an API call, see <a href="https://docs.aws.amazon.com/resilience-hub/latest/userguide/app-config-param.html">Configure
        /// the application configuration parameters</a>.</para><note><para>Currently, this parameter accepts a key-value mapping (in a string format) of only
