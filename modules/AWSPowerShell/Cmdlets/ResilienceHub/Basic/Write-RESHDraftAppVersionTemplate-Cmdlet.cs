...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    public partial class WriteRESHDraftAppVersionTemplateCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// belongs to.</para><note><para>This parameter accepts values in "eks-cluster/namespace" format.</para></note><para>Type: String</para></li></ul></li></ul></li><li><para><b><code>version</code></b></para><para>The Resilience Hub application version.</para></li><li><para><code>additionalInfo</code></para><para>Additional configuration parameters for an Resilience Hub application. If you want
        /// to implement <code>additionalInfo</code> through the Resilience Hub console rather
        /// than using an API call, see <a href="https://docs.aws.amazon.com/resilience-hub/latest/userguide/app-config-param.html">Configure
        /// the application configuration parameters</a>.</para><note><para>Currently, this parameter accepts a key-value mapping (in a string format) of only
