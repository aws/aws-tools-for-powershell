...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// is returned.
    /// </summary>
    [Cmdlet("Get", "RESHAppVersionResourcesResolutionStatus")]
    ...
    public partial class GetRESHAppVersionResourcesResolutionStatusCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DescribeAppVersionResourcesResolutionStatusResponse, GetRESHAppVersionResourcesResolutionStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DescribeAppVersionResourcesResolutionStatusRequest();
        ...
        private Amazon.ResilienceHub.Model.DescribeAppVersionResourcesResolutionStatusResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DescribeAppVersionResourcesResolutionStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DescribeAppVersionResourcesResolutionStatus");
            try
            {
                #if DESKTOP
                return client.DescribeAppVersionResourcesResolutionStatus(request);
                #elif CORECLR
                return client.DescribeAppVersionResourcesResolutionStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String AppVersion { get; set; }
            public System.String ResolutionId { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DescribeAppVersionResourcesResolutionStatusResponse, GetRESHAppVersionResourcesResolutionStatusCmdlet, object> Select { get; set; } =
