...
namespace Amazon.PowerShell.Cmdlets.RESH
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RESHRecommendationTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveRESHRecommendationTemplateCmdlet : AmazonResilienceHubClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RecommendationTemplateArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.RecommendationTemplateArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RESHRecommendationTemplate (DeleteRecommendationTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ResilienceHub.Model.DeleteRecommendationTemplateResponse, RemoveRESHRecommendationTemplateCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.RecommendationTemplateArn;
            }
            #pragma warning restore CS0618, CS0612 //A class member was marked with the Obsolete attribute
            context.ClientToken = this.ClientToken;
            context.RecommendationTemplateArn = this.RecommendationTemplateArn;
            #if MODULAR
            if (this.RecommendationTemplateArn == null && ParameterWasBound(nameof(this.RecommendationTemplateArn)))
            {
                WriteWarning("You are passing $null as a value for parameter RecommendationTemplateArn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ResilienceHub.Model.DeleteRecommendationTemplateRequest();
        ...
        private Amazon.ResilienceHub.Model.DeleteRecommendationTemplateResponse CallAWSServiceOperation(IAmazonResilienceHub client, Amazon.ResilienceHub.Model.DeleteRecommendationTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Resilience Hub", "DeleteRecommendationTemplate");
            try
            {
                #if DESKTOP
                return client.DeleteRecommendationTemplate(request);
                #elif CORECLR
                return client.DeleteRecommendationTemplateAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String RecommendationTemplateArn { get; set; }
            public System.Func<Amazon.ResilienceHub.Model.DeleteRecommendationTemplateResponse, RemoveRESHRecommendationTemplateCmdlet, object> Select { get; set; } =
