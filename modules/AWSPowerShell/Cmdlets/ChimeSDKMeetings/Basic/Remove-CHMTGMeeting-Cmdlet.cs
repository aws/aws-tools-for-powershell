...
namespace Amazon.PowerShell.Cmdlets.CHMTG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMTGMeeting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Meetings DeleteMeeting API operation.", Operation = new[] {"DeleteMeeting"}, SelectReturnType = typeof(Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMTGMeetingCmdlet : AmazonChimeSDKMeetingsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMTGMeeting (DeleteMeeting)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse, RemoveCHMTGMeetingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMeetings.Model.DeleteMeetingRequest();
        ...
        private Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse CallAWSServiceOperation(IAmazonChimeSDKMeetings client, Amazon.ChimeSDKMeetings.Model.DeleteMeetingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Meetings", "DeleteMeeting");
            try
            {
                #if DESKTOP
                return client.DeleteMeeting(request);
                #elif CORECLR
                return client.DeleteMeetingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MeetingId { get; set; }
            public System.Func<Amazon.ChimeSDKMeetings.Model.DeleteMeetingResponse, RemoveCHMTGMeetingCmdlet, object> Select { get; set; } =
