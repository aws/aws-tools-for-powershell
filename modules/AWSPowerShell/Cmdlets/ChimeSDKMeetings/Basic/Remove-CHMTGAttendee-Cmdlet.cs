...
namespace Amazon.PowerShell.Cmdlets.CHMTG
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMTGAttendee", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Meetings DeleteAttendee API operation.", Operation = new[] {"DeleteAttendee"}, SelectReturnType = typeof(Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMTGAttendeeCmdlet : AmazonChimeSDKMeetingsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.AttendeeId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMTGAttendee (DeleteAttendee)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse, RemoveCHMTGAttendeeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMeetings.Model.DeleteAttendeeRequest();
        ...
        private Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse CallAWSServiceOperation(IAmazonChimeSDKMeetings client, Amazon.ChimeSDKMeetings.Model.DeleteAttendeeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Meetings", "DeleteAttendee");
            try
            {
                #if DESKTOP
                return client.DeleteAttendee(request);
                #elif CORECLR
                return client.DeleteAttendeeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AttendeeId { get; set; }
            public System.String MeetingId { get; set; }
            public System.Func<Amazon.ChimeSDKMeetings.Model.DeleteAttendeeResponse, RemoveCHMTGAttendeeCmdlet, object> Select { get; set; } =
