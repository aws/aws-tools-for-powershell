...
namespace Amazon.PowerShell.Cmdlets.CHMTG
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMTGMeeting")]
    [OutputType("Amazon.ChimeSDKMeetings.Model.Meeting")]
    [AWSCmdlet("Calls the Amazon Chime SDK Meetings GetMeeting API operation.", Operation = new[] {"GetMeeting"}, SelectReturnType = typeof(Amazon.ChimeSDKMeetings.Model.GetMeetingResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKMeetings.Model.Meeting or Amazon.ChimeSDKMeetings.Model.GetMeetingResponse",
        "This cmdlet returns an Amazon.ChimeSDKMeetings.Model.Meeting object.",
        "The service call response (type Amazon.ChimeSDKMeetings.Model.GetMeetingResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMTGMeetingCmdlet : AmazonChimeSDKMeetingsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMeetings.Model.GetMeetingResponse, GetCHMTGMeetingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKMeetings.Model.GetMeetingRequest();
        ...
        private Amazon.ChimeSDKMeetings.Model.GetMeetingResponse CallAWSServiceOperation(IAmazonChimeSDKMeetings client, Amazon.ChimeSDKMeetings.Model.GetMeetingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Meetings", "GetMeeting");
            try
            {
                #if DESKTOP
                return client.GetMeeting(request);
                #elif CORECLR
                return client.GetMeetingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MeetingId { get; set; }
            public System.Func<Amazon.ChimeSDKMeetings.Model.GetMeetingResponse, GetCHMTGMeetingCmdlet, object> Select { get; set; } =
