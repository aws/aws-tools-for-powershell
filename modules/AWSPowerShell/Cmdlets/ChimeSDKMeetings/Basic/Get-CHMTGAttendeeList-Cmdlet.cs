...
namespace Amazon.PowerShell.Cmdlets.CHMTG
{
    ...
    public partial class GetCHMTGAttendeeListCmdlet : AmazonChimeSDKMeetingsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKMeetings.Model.ListAttendeesResponse, GetCHMTGAttendeeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ChimeSDKMeetings.Model.ListAttendeesRequest();
        ...
        private Amazon.ChimeSDKMeetings.Model.ListAttendeesResponse CallAWSServiceOperation(IAmazonChimeSDKMeetings client, Amazon.ChimeSDKMeetings.Model.ListAttendeesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Meetings", "ListAttendees");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeetingId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.ChimeSDKMeetings.Model.ListAttendeesResponse, GetCHMTGAttendeeListCmdlet, object> Select { get; set; } =
