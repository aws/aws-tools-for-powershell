...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Voice GetSipRule API operation.", Operation = new[] {"GetSipRule"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.GetSipRuleResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.SipRule or Amazon.ChimeSDKVoice.Model.GetSipRuleResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.SipRule object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.GetSipRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOSipRuleCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetSipRuleResponse, GetCHMVOSipRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetSipRuleRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetSipRuleResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetSipRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetSipRule");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SipRuleId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetSipRuleResponse, GetCHMVOSipRuleCmdlet, object> Select { get; set; } =
