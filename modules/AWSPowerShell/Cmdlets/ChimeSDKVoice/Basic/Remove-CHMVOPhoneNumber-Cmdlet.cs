...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdletOutput("None or Amazon.ChimeSDKVoice.Model.DeletePhoneNumberResponse",
        ...
        "The service response (type Amazon.ChimeSDKVoice.Model.DeletePhoneNumberResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
