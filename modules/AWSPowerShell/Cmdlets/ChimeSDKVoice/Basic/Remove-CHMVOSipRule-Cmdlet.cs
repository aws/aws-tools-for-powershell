...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// Deletes a SIP rule.
    /// </summary>
    [Cmdlet("Remove", "CHMVOSipRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMVOSipRuleCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMVOSipRule (DeleteSipRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.DeleteSipRuleResponse, RemoveCHMVOSipRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.DeleteSipRuleRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.DeleteSipRuleResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.DeleteSipRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "DeleteSipRule");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SipRuleId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.DeleteSipRuleResponse, RemoveCHMVOSipRuleCmdlet, object> Select { get; set; } =
