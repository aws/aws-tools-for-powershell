...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Voice ListProxySessions API operation.", Operation = new[] {"ListProxySessions"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.ProxySession or Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse",
        "This cmdlet returns a collection of Amazon.ChimeSDKVoice.Model.ProxySession objects.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOProxySessionListCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.ChimeSDKVoice.ProxySessionStatus")]
        public Amazon.ChimeSDKVoice.ProxySessionStatus Status { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse, GetCHMVOProxySessionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.ListProxySessionsRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.ListProxySessionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "ListProxySessions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.ChimeSDKVoice.ProxySessionStatus Status { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.ListProxySessionsResponse, GetCHMVOProxySessionListCmdlet, object> Select { get; set; } =
