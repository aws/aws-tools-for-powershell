...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMVOVoiceConnectorTermination")]
    [OutputType("Amazon.ChimeSDKVoice.Model.Termination")]
    [AWSCmdlet("Calls the Amazon Chime SDK Voice GetVoiceConnectorTermination API operation.", Operation = new[] {"GetVoiceConnectorTermination"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.Termination or Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.Termination object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOVoiceConnectorTerminationCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse, GetCHMVOVoiceConnectorTerminationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetVoiceConnectorTermination");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetVoiceConnectorTerminationResponse, GetCHMVOVoiceConnectorTerminationCmdlet, object> Select { get; set; } =
