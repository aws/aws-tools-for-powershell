...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime SDK Voice DeleteVoiceConnectorProxy API operation.", Operation = new[] {"DeleteVoiceConnectorProxy"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse))]
    [AWSCmdletOutput("None or Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMVOVoiceConnectorProxyCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMVOVoiceConnectorProxy (DeleteVoiceConnectorProxy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse, RemoveCHMVOVoiceConnectorProxyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "DeleteVoiceConnectorProxy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorProxyResponse, RemoveCHMVOVoiceConnectorProxyCmdlet, object> Select { get; set; } =
