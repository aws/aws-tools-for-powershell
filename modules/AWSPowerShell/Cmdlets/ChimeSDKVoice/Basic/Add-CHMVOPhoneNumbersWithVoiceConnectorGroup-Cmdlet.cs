...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// </summary>
    [Cmdlet("Add", "CHMVOPhoneNumbersWithVoiceConnectorGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.ChimeSDKVoice.Model.PhoneNumberError")]
    [AWSCmdlet("Calls the Amazon Chime SDK Voice AssociatePhoneNumbersWithVoiceConnectorGroup API operation.", Operation = new[] {"AssociatePhoneNumbersWithVoiceConnectorGroup"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.PhoneNumberError or Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse",
        "This cmdlet returns a collection of Amazon.ChimeSDKVoice.Model.PhoneNumberError objects.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddCHMVOPhoneNumbersWithVoiceConnectorGroupCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CHMVOPhoneNumbersWithVoiceConnectorGroup (AssociatePhoneNumbersWithVoiceConnectorGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse, AddCHMVOPhoneNumbersWithVoiceConnectorGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "AssociatePhoneNumbersWithVoiceConnectorGroup");
            try
            {
                #if DESKTOP
                return client.AssociatePhoneNumbersWithVoiceConnectorGroup(request);
                #elif CORECLR
                return client.AssociatePhoneNumbersWithVoiceConnectorGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? ForceAssociate { get; set; }
            public System.String VoiceConnectorGroupId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse, AddCHMVOPhoneNumbersWithVoiceConnectorGroupCmdlet, object> Select { get; set; } =
