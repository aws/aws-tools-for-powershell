...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdletOutput("None or Amazon.ChimeSDKVoice.Model.DeleteProxySessionResponse",
        ...
        "The service response (type Amazon.ChimeSDKVoice.Model.DeleteProxySessionResponse) be returned by specifying '-Select *'."
    )]
    [System.ObsoleteAttribute("End of support notice: On April 7, 2026, AWS ended support for Amazon Chime SDK proxy sessions. For more information, refer to https://docs.aws.amazon.com/chime-sdk/latest/APIReference/API_voice-chime_DeleteProxySession.html")]
