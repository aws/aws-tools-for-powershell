...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Voice GetPhoneNumberOrder API operation.", Operation = new[] {"GetPhoneNumberOrder"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.PhoneNumberOrder or Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.PhoneNumberOrder object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOPhoneNumberOrderCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse, GetCHMVOPhoneNumberOrderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetPhoneNumberOrder");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String PhoneNumberOrderId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetPhoneNumberOrderResponse, GetCHMVOPhoneNumberOrderCmdlet, object> Select { get; set; } =
