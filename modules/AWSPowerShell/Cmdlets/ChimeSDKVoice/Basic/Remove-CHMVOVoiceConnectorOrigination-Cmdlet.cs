...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "CHMVOVoiceConnectorOrigination", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMVOVoiceConnectorOriginationCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMVOVoiceConnectorOrigination (DeleteVoiceConnectorOrigination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorOriginationResponse, RemoveCHMVOVoiceConnectorOriginationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorOriginationRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorOriginationResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorOriginationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "DeleteVoiceConnectorOrigination");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorOriginationResponse, RemoveCHMVOVoiceConnectorOriginationCmdlet, object> Select { get; set; } =
