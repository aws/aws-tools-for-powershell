...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    public partial class GetCHMVOPhoneNumberCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetPhoneNumberResponse, GetCHMVOPhoneNumberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetPhoneNumberRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetPhoneNumberResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetPhoneNumberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetPhoneNumber");
            try
            {
                return client.GetPhoneNumberAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PhoneNumberId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetPhoneNumberResponse, GetCHMVOPhoneNumberCmdlet, object> Select { get; set; } =
