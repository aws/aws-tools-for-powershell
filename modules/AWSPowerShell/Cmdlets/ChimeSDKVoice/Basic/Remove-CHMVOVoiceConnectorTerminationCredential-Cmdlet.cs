...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdletOutput("None or Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorTerminationCredentialsResponse",
        ...
        "The service response (type Amazon.ChimeSDKVoice.Model.DeleteVoiceConnectorTerminationCredentialsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
