...
{
    /// <summary>
    /// Searches the provisioned phone numbers in an organization.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("System.String or Amazon.ChimeSDKVoice.Model.SearchAvailablePhoneNumbersResponse",
        ...
        "The service call response (type Amazon.ChimeSDKVoice.Model.SearchAvailablePhoneNumbersResponse) can be returned by specifying '-Select *'."
    )]
