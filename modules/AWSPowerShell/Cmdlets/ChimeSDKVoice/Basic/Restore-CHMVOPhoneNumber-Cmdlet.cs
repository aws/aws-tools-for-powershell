...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    [AWSCmdlet("Calls the Amazon Chime SDK Voice RestorePhoneNumber API operation.", Operation = new[] {"RestorePhoneNumber"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.PhoneNumber or Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.PhoneNumber object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RestoreCHMVOPhoneNumberCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Restore-CHMVOPhoneNumber (RestorePhoneNumber)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse, RestoreCHMVOPhoneNumberCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.RestorePhoneNumberRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.RestorePhoneNumberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "RestorePhoneNumber");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String PhoneNumberId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.RestorePhoneNumberResponse, RestoreCHMVOPhoneNumberCmdlet, object> Select { get; set; } =
