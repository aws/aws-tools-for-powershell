...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMVOVoiceConnector")]
    [OutputType("Amazon.ChimeSDKVoice.Model.VoiceConnector")]
    [AWSCmdlet("Calls the Amazon Chime SDK Voice GetVoiceConnector API operation.", Operation = new[] {"GetVoiceConnector"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.VoiceConnector or Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.VoiceConnector object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOVoiceConnectorCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse, GetCHMVOVoiceConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetVoiceConnectorRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetVoiceConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetVoiceConnector");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetVoiceConnectorResponse, GetCHMVOVoiceConnectorCmdlet, object> Select { get; set; } =
