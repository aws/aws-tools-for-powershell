...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    public partial class NewCHMVOVoiceConnectorCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The connectors for use with Connect Customer.</para><para>The following options are available:</para><ul><li><para><c>CONNECT_CALL_TRANSFER_CONNECTOR</c> - Enables enterprises to integrate Connect
