...
namespace Amazon.PowerShell.Cmdlets.CHMVO
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMVOSipMediaApplicationLoggingConfiguration")]
    [OutputType("Amazon.ChimeSDKVoice.Model.SipMediaApplicationLoggingConfiguration")]
    [AWSCmdlet("Calls the Amazon Chime SDK Voice GetSipMediaApplicationLoggingConfiguration API operation.", Operation = new[] {"GetSipMediaApplicationLoggingConfiguration"}, SelectReturnType = typeof(Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse))]
    [AWSCmdletOutput("Amazon.ChimeSDKVoice.Model.SipMediaApplicationLoggingConfiguration or Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse",
        "This cmdlet returns an Amazon.ChimeSDKVoice.Model.SipMediaApplicationLoggingConfiguration object.",
        "The service call response (type Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMVOSipMediaApplicationLoggingConfigurationCmdlet : AmazonChimeSDKVoiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse, GetCHMVOSipMediaApplicationLoggingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationRequest();
        ...
        private Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse CallAWSServiceOperation(IAmazonChimeSDKVoice client, Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime SDK Voice", "GetSipMediaApplicationLoggingConfiguration");
            try
            {
                #if DESKTOP
                return client.GetSipMediaApplicationLoggingConfiguration(request);
                #elif CORECLR
                return client.GetSipMediaApplicationLoggingConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SipMediaApplicationId { get; set; }
            public System.Func<Amazon.ChimeSDKVoice.Model.GetSipMediaApplicationLoggingConfigurationResponse, GetCHMVOSipMediaApplicationLoggingConfigurationCmdlet, object> Select { get; set; } =
