...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Get", "LSContainerImage")]
    [OutputType("Amazon.Lightsail.Model.ContainerImage")]
    [AWSCmdlet("Calls the Amazon Lightsail GetContainerImages API operation.", Operation = new[] {"GetContainerImages"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetContainerImagesResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.ContainerImage or Amazon.Lightsail.Model.GetContainerImagesResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.ContainerImage objects.",
        "The service call response (type Amazon.Lightsail.Model.GetContainerImagesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSContainerImageCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "ContainerImages";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetContainerImagesResponse, GetLSContainerImageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetContainerImagesRequest();
        ...
        private Amazon.Lightsail.Model.GetContainerImagesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetContainerImagesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetContainerImages");
            try
            {
                #if DESKTOP
                return client.GetContainerImages(request);
                #elif CORECLR
                return client.GetContainerImagesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ServiceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetContainerImagesResponse, GetLSContainerImageCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ContainerImages;
        }
