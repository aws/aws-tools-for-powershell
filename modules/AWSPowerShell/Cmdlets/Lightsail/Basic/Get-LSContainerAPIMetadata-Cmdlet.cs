...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Get", "LSContainerAPIMetadata")]
    ...
    public partial class GetLSContainerAPIMetadataCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetContainerAPIMetadataResponse, GetLSContainerAPIMetadataCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetContainerAPIMetadataRequest();
        ...
        private Amazon.Lightsail.Model.GetContainerAPIMetadataResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetContainerAPIMetadataRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetContainerAPIMetadata");
            try
            {
                #if DESKTOP
                return client.GetContainerAPIMetadata(request);
                #elif CORECLR
                return client.GetContainerAPIMetadataAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.Lightsail.Model.GetContainerAPIMetadataResponse, GetLSContainerAPIMetadataCmdlet, object> Select { get; set; } =
