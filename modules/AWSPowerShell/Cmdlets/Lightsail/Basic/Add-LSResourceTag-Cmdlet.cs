...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Add", "LSResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddLSResourceTagCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag key and optional value.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-LSResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.TagResourceResponse, AddLSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.TagResourceRequest();
        ...
        private Amazon.Lightsail.Model.TagResourceResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Lightsail.Model.TagResourceResponse, AddLSResourceTagCmdlet, object> Select { get; set; } =
