...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Get", "LSDomainList")]
    [OutputType("Amazon.Lightsail.Model.Domain")]
    [AWSCmdlet("Calls the Amazon Lightsail GetDomains API operation.", Operation = new[] {"GetDomains"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetDomainsResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Domain or Amazon.Lightsail.Model.GetDomainsResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.Domain objects.",
        "The service call response (type Amazon.Lightsail.Model.GetDomainsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSDomainListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetDomains</c> request. If your results
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetDomainsResponse, GetLSDomainListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetDomainsRequest();
        ...
        private Amazon.Lightsail.Model.GetDomainsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetDomainsRequest request)
        {
            ...
            try
            {
                return client.GetDomainsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetDomainsResponse, GetLSDomainListCmdlet, object> Select { get; set; } =
