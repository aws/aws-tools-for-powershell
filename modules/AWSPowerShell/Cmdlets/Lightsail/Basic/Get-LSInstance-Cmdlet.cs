...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// private server.
    /// </summary>
    [Cmdlet("Get", "LSInstance")]
    [OutputType("Amazon.Lightsail.Model.Instance")]
    [AWSCmdlet("Calls the Amazon Lightsail GetInstance API operation.", Operation = new[] {"GetInstance"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetInstanceResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Instance or Amazon.Lightsail.Model.GetInstanceResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.Instance object.",
        "The service call response (type Amazon.Lightsail.Model.GetInstanceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSInstanceCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetInstanceResponse, GetLSInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetInstanceRequest();
        ...
        private Amazon.Lightsail.Model.GetInstanceResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetInstance");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String InstanceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetInstanceResponse, GetLSInstanceCmdlet, object> Select { get; set; } =
