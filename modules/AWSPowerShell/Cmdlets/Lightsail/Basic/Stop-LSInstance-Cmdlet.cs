...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Stop", "LSInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopLSInstanceCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-LSInstance (StopInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.StopInstanceResponse, StopLSInstanceCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.StopInstanceResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.StopInstanceRequest request)
        {
            ...
            try
            {
                return client.StopInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Boolean? OverrideStuck { get; set; }
            public System.String InstanceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.StopInstanceResponse, StopLSInstanceCmdlet, object> Select { get; set; } =
