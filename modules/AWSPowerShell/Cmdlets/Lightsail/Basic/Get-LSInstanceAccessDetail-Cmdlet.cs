...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetInstanceAccessDetails API operation.", Operation = new[] {"GetInstanceAccessDetails"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.InstanceAccessDetails or Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.InstanceAccessDetails object.",
        "The service call response (type Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSInstanceAccessDetailCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The protocol to use to connect to your instance. Defaults to <c>ssh</c>.</para>
        /// </para>
        /// </summary>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccessDetails";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse, GetLSInstanceAccessDetailCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstanceAccessDetailsRequest request)
        {
            ...
            try
            {
                return client.GetInstanceAccessDetailsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceName { get; set; }
            public Amazon.Lightsail.InstanceAccessProtocol Protocol { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetInstanceAccessDetailsResponse, GetLSInstanceAccessDetailCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccessDetails;
        }
