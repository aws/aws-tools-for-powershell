...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetAutoSnapshots API operation.", Operation = new[] {"GetAutoSnapshots"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetAutoSnapshotsResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.GetAutoSnapshotsResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.GetAutoSnapshotsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSAutoSnapshotCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetAutoSnapshotsResponse, GetLSAutoSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetAutoSnapshotsRequest();
        ...
        private Amazon.Lightsail.Model.GetAutoSnapshotsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetAutoSnapshotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetAutoSnapshots");
            try
            {
                #if DESKTOP
                return client.GetAutoSnapshots(request);
                #elif CORECLR
                return client.GetAutoSnapshotsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetAutoSnapshotsResponse, GetLSAutoSnapshotCmdlet, object> Select { get; set; } =
