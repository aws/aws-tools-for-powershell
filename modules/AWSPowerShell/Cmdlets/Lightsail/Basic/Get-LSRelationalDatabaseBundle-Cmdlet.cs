...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabaseBundle or Amazon.Lightsail.Model.GetRelationalDatabaseBundlesResponse",
        ...
        "The service call response (type Amazon.Lightsail.Model.GetRelationalDatabaseBundlesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSRelationalDatabaseBundleCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetRelationalDatabaseBundles</c> request.
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseBundlesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseBundlesRequest request)
        {
            ...
            try
            {
                return client.GetRelationalDatabaseBundlesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
