...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class NewLSDomainEntryCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.CreateDomainEntryResponse, NewLSDomainEntryCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.CreateDomainEntryResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CreateDomainEntryRequest request)
        {
            ...
            try
            {
                return client.CreateDomainEntryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DomainEntry_Type { get; set; }
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Lightsail.Model.CreateDomainEntryResponse, NewLSDomainEntryCmdlet, object> Select { get; set; } =
