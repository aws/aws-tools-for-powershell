...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Get", "LSInstanceSnapshotList")]
    [OutputType("Amazon.Lightsail.Model.InstanceSnapshot")]
    [AWSCmdlet("Calls the Amazon Lightsail GetInstanceSnapshots API operation.", Operation = new[] {"GetInstanceSnapshots"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetInstanceSnapshotsResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.InstanceSnapshot or Amazon.Lightsail.Model.GetInstanceSnapshotsResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.InstanceSnapshot objects.",
        "The service call response (type Amazon.Lightsail.Model.GetInstanceSnapshotsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSInstanceSnapshotListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetInstanceSnapshots</c> request. If your
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InstanceSnapshots";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetInstanceSnapshotsResponse, GetLSInstanceSnapshotListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetInstanceSnapshotsRequest();
        ...
        private Amazon.Lightsail.Model.GetInstanceSnapshotsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstanceSnapshotsRequest request)
        {
            ...
            try
            {
                return client.GetInstanceSnapshotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetInstanceSnapshotsResponse, GetLSInstanceSnapshotListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InstanceSnapshots;
        }
