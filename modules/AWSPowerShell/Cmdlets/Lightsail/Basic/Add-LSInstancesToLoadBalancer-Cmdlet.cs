...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class AddLSInstancesToLoadBalancerCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.AttachInstancesToLoadBalancerResponse, AddLSInstancesToLoadBalancerCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.AttachInstancesToLoadBalancerResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.AttachInstancesToLoadBalancerRequest request)
        {
            ...
            try
            {
                return client.AttachInstancesToLoadBalancerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LoadBalancerName { get; set; }
            public System.Func<Amazon.Lightsail.Model.AttachInstancesToLoadBalancerResponse, AddLSInstancesToLoadBalancerCmdlet, object> Select { get; set; } =
