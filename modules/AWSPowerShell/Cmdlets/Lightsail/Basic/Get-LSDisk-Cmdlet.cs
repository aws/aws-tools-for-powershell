...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetDisk API operation.", Operation = new[] {"GetDisk"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetDiskResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Disk or Amazon.Lightsail.Model.GetDiskResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.Disk object.",
        "The service call response (type Amazon.Lightsail.Model.GetDiskResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSDiskCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "Disk";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetDiskResponse, GetLSDiskCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetDiskResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetDiskRequest request)
        {
            ...
            try
            {
                return client.GetDiskAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DiskName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetDiskResponse, GetLSDiskCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Disk;
        }
