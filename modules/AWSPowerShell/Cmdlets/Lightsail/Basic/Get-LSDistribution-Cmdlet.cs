...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdletOutput("Amazon.Lightsail.Model.LightsailDistribution or Amazon.Lightsail.Model.GetDistributionsResponse",
        ...
        "The service call response (type Amazon.Lightsail.Model.GetDistributionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
