...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class DismountLSInstancesFromLoadBalancerCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Dismount-LSInstancesFromLoadBalancer (DetachInstancesFromLoadBalancer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.DetachInstancesFromLoadBalancerResponse, DismountLSInstancesFromLoadBalancerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.DetachInstancesFromLoadBalancerRequest();
        ...
        private Amazon.Lightsail.Model.DetachInstancesFromLoadBalancerResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.DetachInstancesFromLoadBalancerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "DetachInstancesFromLoadBalancer");
            try
            {
                return client.DetachInstancesFromLoadBalancerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LoadBalancerName { get; set; }
            public System.Func<Amazon.Lightsail.Model.DetachInstancesFromLoadBalancerResponse, DismountLSInstancesFromLoadBalancerCmdlet, object> Select { get; set; } =
