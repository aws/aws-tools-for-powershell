...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSInstanceListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetInstances</c> request. If your results
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetInstancesResponse, GetLSInstanceListCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetInstancesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstancesRequest request)
        {
            ...
            try
            {
                return client.GetInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetInstancesResponse, GetLSInstanceListCmdlet, object> Select { get; set; } =
