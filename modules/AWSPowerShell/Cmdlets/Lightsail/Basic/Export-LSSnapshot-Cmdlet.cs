...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail ExportSnapshot API operation.", Operation = new[] {"ExportSnapshot"}, SelectReturnType = typeof(Amazon.Lightsail.Model.ExportSnapshotResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation or Amazon.Lightsail.Model.ExportSnapshotResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.ExportSnapshotResponse) can be returned by specifying '-Select *'."
    )]
    public partial class ExportLSSnapshotCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.ExportSnapshotResponse, ExportLSSnapshotCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.ExportSnapshotResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.ExportSnapshotRequest request)
        {
            ...
            try
            {
                return client.ExportSnapshotAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String SourceSnapshotName { get; set; }
            public System.Func<Amazon.Lightsail.Model.ExportSnapshotResponse, ExportLSSnapshotCmdlet, object> Select { get; set; } =
