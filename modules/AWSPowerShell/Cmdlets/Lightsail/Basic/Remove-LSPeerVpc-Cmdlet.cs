...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class RemoveLSPeerVpcCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LSPeerVpc (UnpeerVpc)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.UnpeerVpcResponse, RemoveLSPeerVpcCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.UnpeerVpcRequest();
        ...
        private Amazon.Lightsail.Model.UnpeerVpcResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.UnpeerVpcRequest request)
        {
            ...
            try
            {
                return client.UnpeerVpcAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.Lightsail.Model.UnpeerVpcResponse, RemoveLSPeerVpcCmdlet, object> Select { get; set; } =
