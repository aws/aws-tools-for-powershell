...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetActiveNames API operation.", Operation = new[] {"GetActiveNames"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetActiveNamesResponse))]
    [AWSCmdletOutput("System.String or Amazon.Lightsail.Model.GetActiveNamesResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Lightsail.Model.GetActiveNamesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSActiveNameListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetActiveNames</c> request. If your results
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ActiveNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetActiveNamesResponse, GetLSActiveNameListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetActiveNamesRequest();
        ...
        private Amazon.Lightsail.Model.GetActiveNamesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetActiveNamesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetActiveNames");
            try
            {
                #if DESKTOP
                return client.GetActiveNames(request);
                #elif CORECLR
                return client.GetActiveNamesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetActiveNamesResponse, GetLSActiveNameListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ActiveNames;
        }
