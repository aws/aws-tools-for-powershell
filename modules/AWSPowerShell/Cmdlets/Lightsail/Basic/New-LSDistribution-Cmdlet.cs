...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class NewLSDistributionCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// retrieve publicly accessible objects directly from the bucket's endpoint.</para><note><para>You can enable private origin access only when the distribution's origin is a Lightsail
        ...
        private Amazon.Lightsail.Model.CreateDistributionResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CreateDistributionRequest request)
        {
            ...
            try
            {
                return client.CreateDistributionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
