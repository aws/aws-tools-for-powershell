...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail SetResourceAccessForBucket API operation.", Operation = new[] {"SetResourceAccessForBucket"}, SelectReturnType = typeof(Amazon.Lightsail.Model.SetResourceAccessForBucketResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation or Amazon.Lightsail.Model.SetResourceAccessForBucketResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.SetResourceAccessForBucketResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SetLSResourceAccessForBucketCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.Lightsail.ResourceBucketAccess")]
        public Amazon.Lightsail.ResourceBucketAccess Access { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-LSResourceAccessForBucket (SetResourceAccessForBucket)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.SetResourceAccessForBucketResponse, SetLSResourceAccessForBucketCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.SetResourceAccessForBucketRequest();
        ...
        private Amazon.Lightsail.Model.SetResourceAccessForBucketResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.SetResourceAccessForBucketRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "SetResourceAccessForBucket");
            try
            {
                #if DESKTOP
                return client.SetResourceAccessForBucket(request);
                #elif CORECLR
                return client.SetResourceAccessForBucketAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BucketName { get; set; }
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.SetResourceAccessForBucketResponse, SetLSResourceAccessForBucketCmdlet, object> Select { get; set; } =
