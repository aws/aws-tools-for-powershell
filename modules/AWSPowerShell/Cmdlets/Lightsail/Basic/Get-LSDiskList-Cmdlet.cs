...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSDiskListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetDisks</c> request. If your results are
        /// paginated, the response will return a next page token that you can specify as the
        /// page token in a subsequent request.</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Disks";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetDisksResponse, GetLSDiskListCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetDisksResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetDisksRequest request)
        {
            ...
            try
            {
                return client.GetDisksAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetDisksResponse, GetLSDiskListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Disks;
        }
