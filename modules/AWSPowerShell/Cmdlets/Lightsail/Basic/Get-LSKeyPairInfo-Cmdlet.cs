...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class GetLSKeyPairInfoCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetKeyPairResponse, GetLSKeyPairInfoCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetKeyPairRequest();
        ...
        private Amazon.Lightsail.Model.GetKeyPairResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetKeyPairRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetKeyPair");
            try
            {
                #if DESKTOP
                return client.GetKeyPair(request);
                #elif CORECLR
                return client.GetKeyPairAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String KeyPairName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetKeyPairResponse, GetLSKeyPairInfoCmdlet, object> Select { get; set; } =
