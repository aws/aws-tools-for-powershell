...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetRelationalDatabases API operation.", Operation = new[] {"GetRelationalDatabases"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetRelationalDatabasesResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.RelationalDatabase or Amazon.Lightsail.Model.GetRelationalDatabasesResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.RelationalDatabase objects.",
        "The service call response (type Amazon.Lightsail.Model.GetRelationalDatabasesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSRelationalDatabaseListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetRelationalDatabases</c> request. If
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RelationalDatabases";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetRelationalDatabasesResponse, GetLSRelationalDatabaseListCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabasesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabasesRequest request)
        {
            ...
            try
            {
                return client.GetRelationalDatabasesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetRelationalDatabasesResponse, GetLSRelationalDatabaseListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RelationalDatabases;
        }
