...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Get", "LSRelationalDatabase")]
    ...
    public partial class GetLSRelationalDatabaseCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "RelationalDatabase";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetRelationalDatabaseResponse, GetLSRelationalDatabaseCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetRelationalDatabaseRequest();
        ...
        private Amazon.Lightsail.Model.GetRelationalDatabaseResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetRelationalDatabaseRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "GetRelationalDatabase");
            try
            {
                #if DESKTOP
                return client.GetRelationalDatabase(request);
                #elif CORECLR
                return client.GetRelationalDatabaseAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RelationalDatabaseName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetRelationalDatabaseResponse, GetLSRelationalDatabaseCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RelationalDatabase;
        }
