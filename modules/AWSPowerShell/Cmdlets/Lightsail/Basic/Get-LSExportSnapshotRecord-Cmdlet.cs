...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdletOutput("Amazon.Lightsail.Model.ExportSnapshotRecord or Amazon.Lightsail.Model.GetExportSnapshotRecordsResponse",
        ...
        "The service call response (type Amazon.Lightsail.Model.GetExportSnapshotRecordsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSExportSnapshotRecordCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The token to advance to the next page of results from your request.</para><para>To get a page token, perform an initial <c>GetExportSnapshotRecords</c> request. If
        ...
        private Amazon.Lightsail.Model.GetExportSnapshotRecordsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetExportSnapshotRecordsRequest request)
        {
            ...
            try
            {
                return client.GetExportSnapshotRecordsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
