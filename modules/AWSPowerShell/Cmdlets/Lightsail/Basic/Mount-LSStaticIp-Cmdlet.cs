...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </summary>
    [Cmdlet("Mount", "LSStaticIp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Lightsail.Model.Operation")]
    [AWSCmdlet("Calls the Amazon Lightsail AttachStaticIp API operation.", Operation = new[] {"AttachStaticIp"}, SelectReturnType = typeof(Amazon.Lightsail.Model.AttachStaticIpResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation or Amazon.Lightsail.Model.AttachStaticIpResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.AttachStaticIpResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class MountLSStaticIpCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^StaticIpName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Mount-LSStaticIp (AttachStaticIp)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.AttachStaticIpResponse, MountLSStaticIpCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.StaticIpName;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.AttachStaticIpRequest();
        ...
        private Amazon.Lightsail.Model.AttachStaticIpResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.AttachStaticIpRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "AttachStaticIp");
            try
            {
                #if DESKTOP
                return client.AttachStaticIp(request);
                #elif CORECLR
                return client.AttachStaticIpAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String InstanceName { get; set; }
            public System.String StaticIpName { get; set; }
            public System.Func<Amazon.Lightsail.Model.AttachStaticIpResponse, MountLSStaticIpCmdlet, object> Select { get; set; } =
