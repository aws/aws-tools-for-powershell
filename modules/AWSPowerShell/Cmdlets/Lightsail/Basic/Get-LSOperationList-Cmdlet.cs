...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetOperations API operation.", Operation = new[] {"GetOperations"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetOperationsResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation or Amazon.Lightsail.Model.GetOperationsResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.Operation objects.",
        "The service call response (type Amazon.Lightsail.Model.GetOperationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSOperationListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetOperationsResponse, GetLSOperationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Lightsail.Model.GetOperationsRequest();
        ...
        private Amazon.Lightsail.Model.GetOperationsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetOperationsRequest request)
        {
            ...
            try
            {
                return client.GetOperationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String PageToken { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetOperationsResponse, GetLSOperationListCmdlet, object> Select { get; set; } =
