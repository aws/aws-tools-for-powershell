...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Dismount", "LSCertificateFromDistribution", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Lightsail.Model.Operation")]
    [AWSCmdlet("Calls the Amazon Lightsail DetachCertificateFromDistribution API operation.", Operation = new[] {"DetachCertificateFromDistribution"}, SelectReturnType = typeof(Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.Operation or Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.Operation object.",
        "The service call response (type Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class DismountLSCertificateFromDistributionCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Dismount-LSCertificateFromDistribution (DetachCertificateFromDistribution)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse, DismountLSCertificateFromDistributionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.DetachCertificateFromDistributionRequest();
        ...
        private Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.DetachCertificateFromDistributionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "DetachCertificateFromDistribution");
            try
            {
                #if DESKTOP
                return client.DetachCertificateFromDistribution(request);
                #elif CORECLR
                return client.DetachCertificateFromDistributionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String DistributionName { get; set; }
            public System.Func<Amazon.Lightsail.Model.DetachCertificateFromDistributionResponse, DismountLSCertificateFromDistributionCmdlet, object> Select { get; set; } =
