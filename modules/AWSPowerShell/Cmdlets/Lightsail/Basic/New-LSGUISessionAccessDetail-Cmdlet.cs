...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    public partial class NewLSGUISessionAccessDetailCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.Lightsail.Model.CreateGUISessionAccessDetailsResponse).
        /// Specifying the name of a property of type Amazon.Lightsail.Model.CreateGUISessionAccessDetailsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-LSGUISessionAccessDetail (CreateGUISessionAccessDetails)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.CreateGUISessionAccessDetailsResponse, NewLSGUISessionAccessDetailCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.CreateGUISessionAccessDetailsRequest();
        ...
        private Amazon.Lightsail.Model.CreateGUISessionAccessDetailsResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.CreateGUISessionAccessDetailsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lightsail", "CreateGUISessionAccessDetails");
            try
            {
                #if DESKTOP
                return client.CreateGUISessionAccessDetails(request);
                #elif CORECLR
                return client.CreateGUISessionAccessDetailsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ResourceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.CreateGUISessionAccessDetailsResponse, NewLSGUISessionAccessDetailCmdlet, object> Select { get; set; } =
