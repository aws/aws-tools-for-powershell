...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetInstancePortStates API operation.", Operation = new[] {"GetInstancePortStates"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetInstancePortStatesResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.InstancePortState or Amazon.Lightsail.Model.GetInstancePortStatesResponse",
        "This cmdlet returns a collection of Amazon.Lightsail.Model.InstancePortState objects.",
        "The service call response (type Amazon.Lightsail.Model.GetInstancePortStatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetLSInstancePortStateListCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "PortStates";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetInstancePortStatesResponse, GetLSInstancePortStateListCmdlet>(Select) ??
        ...
        private Amazon.Lightsail.Model.GetInstancePortStatesResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetInstancePortStatesRequest request)
        {
            ...
            try
            {
                return client.GetInstancePortStatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InstanceName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetInstancePortStatesResponse, GetLSInstancePortStateListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PortStates;
        }
