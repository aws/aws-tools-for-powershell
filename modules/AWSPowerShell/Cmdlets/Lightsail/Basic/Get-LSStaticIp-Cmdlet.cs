...
namespace Amazon.PowerShell.Cmdlets.LS
{
    ...
    [AWSCmdlet("Calls the Amazon Lightsail GetStaticIp API operation.", Operation = new[] {"GetStaticIp"}, SelectReturnType = typeof(Amazon.Lightsail.Model.GetStaticIpResponse))]
    [AWSCmdletOutput("Amazon.Lightsail.Model.StaticIp or Amazon.Lightsail.Model.GetStaticIpResponse",
        "This cmdlet returns an Amazon.Lightsail.Model.StaticIp object.",
        "The service call response (type Amazon.Lightsail.Model.GetStaticIpResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetLSStaticIpCmdlet : AmazonLightsailClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "StaticIp";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Lightsail.Model.GetStaticIpResponse, GetLSStaticIpCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Lightsail.Model.GetStaticIpRequest();
        ...
        private Amazon.Lightsail.Model.GetStaticIpResponse CallAWSServiceOperation(IAmazonLightsail client, Amazon.Lightsail.Model.GetStaticIpRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetStaticIpAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StaticIpName { get; set; }
            public System.Func<Amazon.Lightsail.Model.GetStaticIpResponse, GetLSStaticIpCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.StaticIp;
        }
