...
namespace Amazon.PowerShell.Cmdlets.C9
{
    ...
    [AWSCmdlet("Calls the AWS Cloud9 DeleteEnvironment API operation.", Operation = new[] {"DeleteEnvironment"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the EnvironmentId parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveC9EnvironmentCmdlet : AmazonCloud9ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-C9Environment (DeleteEnvironment)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Cloud9.Model.DeleteEnvironmentRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.EnvironmentId;
        ...
        private Amazon.Cloud9.Model.DeleteEnvironmentResponse CallAWSServiceOperation(IAmazonCloud9 client, Amazon.Cloud9.Model.DeleteEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Cloud9", "DeleteEnvironment");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteEnvironmentAsync(request);
                return task.Result;
                #else
