...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Searches for steps.
    /// </summary>
    [Cmdlet("Search", "ADCStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Deadline.Model.SearchStepsResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud SearchSteps API operation.", Operation = new[] {"SearchSteps"}, SelectReturnType = typeof(Amazon.Deadline.Model.SearchStepsResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.SearchStepsResponse",
        "This cmdlet returns an Amazon.Deadline.Model.SearchStepsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchADCStepCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-ADCStep (SearchSteps)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.SearchStepsResponse, SearchADCStepCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.SearchStepsRequest();
        ...
        private Amazon.Deadline.Model.SearchStepsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.SearchStepsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "SearchSteps");
            try
            {
                #if DESKTOP
                return client.SearchSteps(request);
                #elif CORECLR
                return client.SearchStepsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Deadline.Model.SearchStepsResponse, SearchADCStepCmdlet, object> Select { get; set; } =
