...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("Amazon.Deadline.Model.SearchStepsResponse",
        "This cmdlet returns an Amazon.Deadline.Model.SearchStepsResponse object containing multiple properties."
    )]
    public partial class SearchADCStepCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The queue IDs in the step search.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.Deadline.Model.SearchStepsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.SearchStepsRequest request)
        {
            ...
            try
            {
                return client.SearchStepsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
