...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCStorageProfile")]
    [OutputType("Amazon.Deadline.Model.GetStorageProfileResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetStorageProfile API operation.", Operation = new[] {"GetStorageProfile"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetStorageProfileResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetStorageProfileResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetStorageProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCStorageProfileCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetStorageProfileResponse, GetADCStorageProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetStorageProfileRequest();
        ...
        private Amazon.Deadline.Model.GetStorageProfileResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetStorageProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetStorageProfile");
            try
            {
                #if DESKTOP
                return client.GetStorageProfile(request);
                #elif CORECLR
                return client.GetStorageProfileAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FarmId { get; set; }
            public System.String StorageProfileId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetStorageProfileResponse, GetADCStorageProfileCmdlet, object> Select { get; set; } =
