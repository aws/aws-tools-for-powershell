...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ADCQueueFleetAssociation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveADCQueueFleetAssociationCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCQueueFleetAssociation (DeleteQueueFleetAssociation)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DeleteQueueFleetAssociationResponse, RemoveADCQueueFleetAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DeleteQueueFleetAssociationRequest();
        ...
        private Amazon.Deadline.Model.DeleteQueueFleetAssociationResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DeleteQueueFleetAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DeleteQueueFleetAssociation");
            try
            {
                #if DESKTOP
                return client.DeleteQueueFleetAssociation(request);
                #elif CORECLR
                return client.DeleteQueueFleetAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FleetId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.DeleteQueueFleetAssociationResponse, RemoveADCQueueFleetAssociationCmdlet, object> Select { get; set; } =
