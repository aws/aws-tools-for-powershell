...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ADCMonitor", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveADCMonitorCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCMonitor (DeleteMonitor)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DeleteMonitorResponse, RemoveADCMonitorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DeleteMonitorRequest();
        ...
        private Amazon.Deadline.Model.DeleteMonitorResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DeleteMonitorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DeleteMonitor");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String MonitorId { get; set; }
            public System.Func<Amazon.Deadline.Model.DeleteMonitorResponse, RemoveADCMonitorCmdlet, object> Select { get; set; } =
