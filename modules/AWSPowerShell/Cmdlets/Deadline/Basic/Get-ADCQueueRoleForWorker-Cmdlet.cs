...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCQueueRoleForWorker")]
    [OutputType("Amazon.Deadline.Model.AwsCredentials")]
    [AWSCmdlet("Calls the AWSDeadlineCloud AssumeQueueRoleForWorker API operation.", Operation = new[] {"AssumeQueueRoleForWorker"}, SelectReturnType = typeof(Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.AwsCredentials or Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse",
        "This cmdlet returns an Amazon.Deadline.Model.AwsCredentials object.",
        "The service call response (type Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCQueueRoleForWorkerCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse, GetADCQueueRoleForWorkerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.AssumeQueueRoleForWorkerRequest();
        ...
        private Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.AssumeQueueRoleForWorkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "AssumeQueueRoleForWorker");
            try
            {
                #if DESKTOP
                return client.AssumeQueueRoleForWorker(request);
                #elif CORECLR
                return client.AssumeQueueRoleForWorkerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.Deadline.Model.AssumeQueueRoleForWorkerResponse, GetADCQueueRoleForWorkerCmdlet, object> Select { get; set; } =
