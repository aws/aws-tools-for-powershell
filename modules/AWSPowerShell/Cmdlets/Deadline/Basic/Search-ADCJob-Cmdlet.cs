...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Searches for jobs.
    /// </summary>
    [Cmdlet("Search", "ADCJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Deadline.Model.SearchJobsResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud SearchJobs API operation.", Operation = new[] {"SearchJobs"}, SelectReturnType = typeof(Amazon.Deadline.Model.SearchJobsResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.SearchJobsResponse",
        "This cmdlet returns an Amazon.Deadline.Model.SearchJobsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class SearchADCJobCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Search-ADCJob (SearchJobs)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.SearchJobsResponse, SearchADCJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.SearchJobsRequest();
        ...
        private Amazon.Deadline.Model.SearchJobsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.SearchJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "SearchJobs");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Deadline.Model.SearchJobsResponse, SearchADCJobCmdlet, object> Select { get; set; } =
