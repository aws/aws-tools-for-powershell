...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Deletes a worker.
    /// </summary>
    [Cmdlet("Remove", "ADCWorker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveADCWorkerCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCWorker (DeleteWorker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DeleteWorkerResponse, RemoveADCWorkerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DeleteWorkerRequest();
        ...
        private Amazon.Deadline.Model.DeleteWorkerResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DeleteWorkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DeleteWorker");
            try
            {
                #if DESKTOP
                return client.DeleteWorker(request);
                #elif CORECLR
                return client.DeleteWorkerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FleetId { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.Deadline.Model.DeleteWorkerResponse, RemoveADCWorkerCmdlet, object> Select { get; set; } =
