...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    public partial class GetADCTaskCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetTaskResponse, GetADCTaskCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetTaskRequest();
        ...
        private Amazon.Deadline.Model.GetTaskResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetTaskRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetTask");
            try
            {
                return client.GetTaskAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StepId { get; set; }
            public System.String TaskId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetTaskResponse, GetADCTaskCmdlet, object> Select { get; set; } =
