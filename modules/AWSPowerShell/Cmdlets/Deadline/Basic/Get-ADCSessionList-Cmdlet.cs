...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Lists sessions.
    /// </summary>
    [Cmdlet("Get", "ADCSessionList")]
    [OutputType("Amazon.Deadline.Model.SessionSummary")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListSessions API operation.", Operation = new[] {"ListSessions"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListSessionsResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.SessionSummary or Amazon.Deadline.Model.ListSessionsResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.SessionSummary objects.",
        "The service call response (type Amazon.Deadline.Model.ListSessionsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCSessionListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListSessionsResponse, GetADCSessionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.ListSessionsRequest();
        ...
        private Amazon.Deadline.Model.ListSessionsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListSessionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListSessions");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListSessionsResponse, GetADCSessionListCmdlet, object> Select { get; set; } =
