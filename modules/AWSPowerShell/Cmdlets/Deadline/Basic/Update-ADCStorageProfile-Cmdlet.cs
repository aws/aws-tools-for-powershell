...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("None or Amazon.Deadline.Model.UpdateStorageProfileResponse",
        ...
        "The service response (type Amazon.Deadline.Model.UpdateStorageProfileResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateADCStorageProfileCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The display name of the storage profile to update.</para>
        /// </para>
        /// </summary>
