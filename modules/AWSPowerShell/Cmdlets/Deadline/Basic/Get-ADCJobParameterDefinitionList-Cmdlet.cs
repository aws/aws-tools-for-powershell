...
{
    /// <summary>
    /// Lists parameter definitions of a job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCJobParameterDefinitionList")]
    ...
    public partial class GetADCJobParameterDefinitionListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "JobParameterDefinitions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListJobParameterDefinitionsResponse, GetADCJobParameterDefinitionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListJobParameterDefinitionsRequest();
        ...
        private Amazon.Deadline.Model.ListJobParameterDefinitionsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListJobParameterDefinitionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListJobParameterDefinitions");
            try
            {
                return client.ListJobParameterDefinitionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListJobParameterDefinitionsResponse, GetADCJobParameterDefinitionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.JobParameterDefinitions;
        }
