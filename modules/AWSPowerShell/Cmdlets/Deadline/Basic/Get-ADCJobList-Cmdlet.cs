...
{
    /// <summary>
    /// Lists jobs.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCJobList")]
    [OutputType("Amazon.Deadline.Model.JobSummary")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListJobs API operation.", Operation = new[] {"ListJobs"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListJobsResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.JobSummary or Amazon.Deadline.Model.ListJobsResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.JobSummary objects.",
        "The service call response (type Amazon.Deadline.Model.ListJobsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCJobListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListJobsResponse, GetADCJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListJobsRequest();
        ...
        private Amazon.Deadline.Model.ListJobsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListJobs");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListJobsResponse, GetADCJobListCmdlet, object> Select { get; set; } =
