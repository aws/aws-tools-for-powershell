...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Get a budget.
    /// </summary>
    [Cmdlet("Get", "ADCBudget")]
    [OutputType("Amazon.Deadline.Model.GetBudgetResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetBudget API operation.", Operation = new[] {"GetBudget"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetBudgetResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetBudgetResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetBudgetResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCBudgetCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetBudgetResponse, GetADCBudgetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetBudgetRequest();
        ...
        private Amazon.Deadline.Model.GetBudgetResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetBudgetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetBudget");
            try
            {
                #if DESKTOP
                return client.GetBudget(request);
                #elif CORECLR
                return client.GetBudgetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String BudgetId { get; set; }
            public System.String FarmId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetBudgetResponse, GetADCBudgetCmdlet, object> Select { get; set; } =
