...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCQueueRoleForUser")]
    [OutputType("Amazon.Deadline.Model.AwsCredentials")]
    [AWSCmdlet("Calls the AWSDeadlineCloud AssumeQueueRoleForUser API operation.", Operation = new[] {"AssumeQueueRoleForUser"}, SelectReturnType = typeof(Amazon.Deadline.Model.AssumeQueueRoleForUserResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.AwsCredentials or Amazon.Deadline.Model.AssumeQueueRoleForUserResponse",
        "This cmdlet returns an Amazon.Deadline.Model.AwsCredentials object.",
        "The service call response (type Amazon.Deadline.Model.AssumeQueueRoleForUserResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCQueueRoleForUserCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.AssumeQueueRoleForUserResponse, GetADCQueueRoleForUserCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.AssumeQueueRoleForUserRequest();
        ...
        private Amazon.Deadline.Model.AssumeQueueRoleForUserResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.AssumeQueueRoleForUserRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "AssumeQueueRoleForUser");
            try
            {
                #if DESKTOP
                return client.AssumeQueueRoleForUser(request);
                #elif CORECLR
                return client.AssumeQueueRoleForUserAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FarmId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.AssumeQueueRoleForUserResponse, GetADCQueueRoleForUserCmdlet, object> Select { get; set; } =
