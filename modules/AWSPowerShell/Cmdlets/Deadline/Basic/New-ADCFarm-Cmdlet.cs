...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// for large projects.
    /// </summary>
    [Cmdlet("New", "ADCFarm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWSDeadlineCloud CreateFarm API operation.", Operation = new[] {"CreateFarm"}, SelectReturnType = typeof(Amazon.Deadline.Model.CreateFarmResponse))]
    [AWSCmdletOutput("System.String or Amazon.Deadline.Model.CreateFarmResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Deadline.Model.CreateFarmResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewADCFarmCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FarmId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-ADCFarm (CreateFarm)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.CreateFarmResponse, NewADCFarmCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.CreateFarmRequest();
        ...
        private Amazon.Deadline.Model.CreateFarmResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.CreateFarmRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "CreateFarm");
            try
            {
                #if DESKTOP
                return client.CreateFarm(request);
                #elif CORECLR
                return client.CreateFarmAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Deadline.Model.CreateFarmResponse, NewADCFarmCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FarmId;
        }
