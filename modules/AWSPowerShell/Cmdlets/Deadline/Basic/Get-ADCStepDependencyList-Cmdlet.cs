...
{
    /// <summary>
    /// Lists the dependencies for a step.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCStepDependencyList")]
    [OutputType("Amazon.Deadline.Model.StepDependency")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListStepDependencies API operation.", Operation = new[] {"ListStepDependencies"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListStepDependenciesResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.StepDependency or Amazon.Deadline.Model.ListStepDependenciesResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.StepDependency objects.",
        "The service call response (type Amazon.Deadline.Model.ListStepDependenciesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCStepDependencyListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListStepDependenciesResponse, GetADCStepDependencyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListStepDependenciesRequest();
        ...
        private Amazon.Deadline.Model.ListStepDependenciesResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListStepDependenciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListStepDependencies");
            try
            {
                return client.ListStepDependenciesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String StepId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListStepDependenciesResponse, GetADCStepDependencyListCmdlet, object> Select { get; set; } =
