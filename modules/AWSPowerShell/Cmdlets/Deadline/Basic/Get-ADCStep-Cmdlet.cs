...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("Amazon.Deadline.Model.GetStepResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetStepResponse object containing multiple properties."
    )]
    public partial class GetADCStepCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        private Amazon.Deadline.Model.GetStepResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetStepRequest request)
        {
            ...
            try
            {
                return client.GetStepAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
