...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCStep")]
    [OutputType("Amazon.Deadline.Model.GetStepResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetStep API operation.", Operation = new[] {"GetStep"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetStepResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetStepResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetStepResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCStepCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetStepResponse, GetADCStepCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetStepRequest();
        ...
        private Amazon.Deadline.Model.GetStepResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetStepRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetStep");
            try
            {
                #if DESKTOP
                return client.GetStep(request);
                #elif CORECLR
                return client.GetStepAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String StepId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetStepResponse, GetADCStepCmdlet, object> Select { get; set; } =
