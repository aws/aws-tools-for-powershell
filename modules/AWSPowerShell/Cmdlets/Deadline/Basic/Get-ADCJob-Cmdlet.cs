...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCJob")]
    [OutputType("Amazon.Deadline.Model.GetJobResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetJob API operation.", Operation = new[] {"GetJob"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetJobResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetJobResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCJobCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetJobResponse, GetADCJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetJobRequest();
        ...
        private Amazon.Deadline.Model.GetJobResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetJob");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String JobId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetJobResponse, GetADCJobCmdlet, object> Select { get; set; } =
