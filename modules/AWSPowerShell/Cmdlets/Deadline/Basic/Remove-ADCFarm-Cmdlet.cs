...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Deletes a farm.
    /// </summary>
    [Cmdlet("Remove", "ADCFarm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveADCFarmCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCFarm (DeleteFarm)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DeleteFarmResponse, RemoveADCFarmCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DeleteFarmRequest();
        ...
        private Amazon.Deadline.Model.DeleteFarmResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DeleteFarmRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DeleteFarm");
            try
            {
                #if DESKTOP
                return client.DeleteFarm(request);
                #elif CORECLR
                return client.DeleteFarmAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FarmId { get; set; }
            public System.Func<Amazon.Deadline.Model.DeleteFarmResponse, RemoveADCFarmCmdlet, object> Select { get; set; } =
