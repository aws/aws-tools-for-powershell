...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("None or Amazon.Deadline.Model.UpdateJobResponse",
        ...
        "The service response (type Amazon.Deadline.Model.UpdateJobResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
