...
{
    /// <summary>
    /// Lists tasks for a job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCTaskList")]
    [OutputType("Amazon.Deadline.Model.TaskSummary")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListTasks API operation.", Operation = new[] {"ListTasks"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListTasksResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.TaskSummary or Amazon.Deadline.Model.ListTasksResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.TaskSummary objects.",
        "The service call response (type Amazon.Deadline.Model.ListTasksResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCTaskListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListTasksResponse, GetADCTaskListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListTasksRequest();
        ...
        private Amazon.Deadline.Model.ListTasksResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListTasksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListTasks");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String StepId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListTasksResponse, GetADCTaskListCmdlet, object> Select { get; set; } =
