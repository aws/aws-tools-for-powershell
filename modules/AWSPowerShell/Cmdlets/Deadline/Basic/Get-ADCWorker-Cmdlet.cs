...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("Amazon.Deadline.Model.GetWorkerResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetWorkerResponse object containing multiple properties."
    )]
    public partial class GetADCWorkerCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        private Amazon.Deadline.Model.GetWorkerResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetWorkerRequest request)
        {
            ...
            try
            {
                return client.GetWorkerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
