...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Gets a worker.
    /// </summary>
    [Cmdlet("Get", "ADCWorker")]
    [OutputType("Amazon.Deadline.Model.GetWorkerResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetWorker API operation.", Operation = new[] {"GetWorker"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetWorkerResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetWorkerResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetWorkerResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCWorkerCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetWorkerResponse, GetADCWorkerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetWorkerRequest();
        ...
        private Amazon.Deadline.Model.GetWorkerResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetWorkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetWorker");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FleetId { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetWorkerResponse, GetADCWorkerCmdlet, object> Select { get; set; } =
