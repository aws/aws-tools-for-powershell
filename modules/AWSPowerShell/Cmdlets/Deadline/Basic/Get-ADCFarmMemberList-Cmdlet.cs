...
{
    /// <summary>
    /// Lists the members of a farm.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCFarmMemberList")]
    [OutputType("Amazon.Deadline.Model.FarmMember")]
    ...
    public partial class GetADCFarmMemberListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListFarmMembersResponse, GetADCFarmMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListFarmMembersRequest();
        ...
        private Amazon.Deadline.Model.ListFarmMembersResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListFarmMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListFarmMembers");
            try
            {
                return client.ListFarmMembersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Deadline.Model.ListFarmMembersResponse, GetADCFarmMemberListCmdlet, object> Select { get; set; } =
