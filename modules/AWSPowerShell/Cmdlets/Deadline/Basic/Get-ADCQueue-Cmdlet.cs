...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCQueue")]
    [OutputType("Amazon.Deadline.Model.GetQueueResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetQueue API operation.", Operation = new[] {"GetQueue"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetQueueResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetQueueResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetQueueResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCQueueCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetQueueResponse, GetADCQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetQueueRequest();
        ...
        private Amazon.Deadline.Model.GetQueueResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetQueue");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FarmId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetQueueResponse, GetADCQueueCmdlet, object> Select { get; set; } =
