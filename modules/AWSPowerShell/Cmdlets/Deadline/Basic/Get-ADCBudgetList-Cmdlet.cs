...
{
    /// <summary>
    /// A list of budgets in a farm.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetADCBudgetListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        private Amazon.Deadline.Model.ListBudgetsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListBudgetsRequest request)
        {
            ...
            try
            {
                return client.ListBudgetsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
