...
{
    /// <summary>
    /// Lists members on a job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCJobMemberList")]
    [OutputType("Amazon.Deadline.Model.JobMember")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListJobMembers API operation.", Operation = new[] {"ListJobMembers"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListJobMembersResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.JobMember or Amazon.Deadline.Model.ListJobMembersResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.JobMember objects.",
        "The service call response (type Amazon.Deadline.Model.ListJobMembersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCJobMemberListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListJobMembersResponse, GetADCJobMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListJobMembersRequest();
        ...
        private Amazon.Deadline.Model.ListJobMembersResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListJobMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListJobMembers");
            try
            {
                return client.ListJobMembersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListJobMembersResponse, GetADCJobMemberListCmdlet, object> Select { get; set; } =
