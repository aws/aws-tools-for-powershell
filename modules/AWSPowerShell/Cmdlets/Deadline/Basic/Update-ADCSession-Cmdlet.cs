...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Updates a session.
    /// </summary>
    [Cmdlet("Update", "ADCSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateADCSessionCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        #region Parameter TargetLifecycleStatus
        /// <summary>
        /// <para>
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.Deadline.SessionLifecycleTargetStatus")]
        public Amazon.Deadline.SessionLifecycleTargetStatus TargetLifecycleStatus { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-ADCSession (UpdateSession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.UpdateSessionResponse, UpdateADCSessionCmdlet>(Select) ??
            ...
            #endif
            context.TargetLifecycleStatus = this.TargetLifecycleStatus;
            #if MODULAR
            if (this.TargetLifecycleStatus == null && ParameterWasBound(nameof(this.TargetLifecycleStatus)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetLifecycleStatus which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.UpdateSessionRequest();
            ...
            if (cmdletContext.TargetLifecycleStatus != null)
            {
                request.TargetLifecycleStatus = cmdletContext.TargetLifecycleStatus;
            }
        ...
        private Amazon.Deadline.Model.UpdateSessionResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.UpdateSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "UpdateSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SessionId { get; set; }
            public Amazon.Deadline.SessionLifecycleTargetStatus TargetLifecycleStatus { get; set; }
            public System.Func<Amazon.Deadline.Model.UpdateSessionResponse, UpdateADCSessionCmdlet, object> Select { get; set; } =
