...
{
    /// <summary>
    /// Lists sessions for a worker.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCSessionsForWorkerList")]
    [OutputType("Amazon.Deadline.Model.WorkerSessionSummary")]
    ...
    public partial class GetADCSessionsForWorkerListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListSessionsForWorkerResponse, GetADCSessionsForWorkerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListSessionsForWorkerRequest();
        ...
        private Amazon.Deadline.Model.ListSessionsForWorkerResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListSessionsForWorkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListSessionsForWorker");
            try
            {
                return client.ListSessionsForWorkerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkerId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListSessionsForWorkerResponse, GetADCSessionsForWorkerListCmdlet, object> Select { get; set; } =
