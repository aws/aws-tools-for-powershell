...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// on Deadline Cloud.
    /// </summary>
    [Cmdlet("New", "ADCLicenseEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWSDeadlineCloud CreateLicenseEndpoint API operation.", Operation = new[] {"CreateLicenseEndpoint"}, SelectReturnType = typeof(Amazon.Deadline.Model.CreateLicenseEndpointResponse))]
    [AWSCmdletOutput("System.String or Amazon.Deadline.Model.CreateLicenseEndpointResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Deadline.Model.CreateLicenseEndpointResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewADCLicenseEndpointCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "LicenseEndpointId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-ADCLicenseEndpoint (CreateLicenseEndpoint)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.CreateLicenseEndpointResponse, NewADCLicenseEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.CreateLicenseEndpointRequest();
        ...
        private Amazon.Deadline.Model.CreateLicenseEndpointResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.CreateLicenseEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "CreateLicenseEndpoint");
            try
            {
                #if DESKTOP
                return client.CreateLicenseEndpoint(request);
                #elif CORECLR
                return client.CreateLicenseEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VpcId { get; set; }
            public System.Func<Amazon.Deadline.Model.CreateLicenseEndpointResponse, NewADCLicenseEndpointCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.LicenseEndpointId;
        }
