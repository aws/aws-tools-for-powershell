...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    [AWSCmdletOutput("None or Amazon.Deadline.Model.UpdateQueueResponse",
        ...
        "The service response (type Amazon.Deadline.Model.UpdateQueueResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateADCQueueCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The description of the queue to update.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The display name of the queue to update.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
