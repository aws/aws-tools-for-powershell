...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCQueueFleetAssociation")]
    [OutputType("Amazon.Deadline.Model.GetQueueFleetAssociationResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetQueueFleetAssociation API operation.", Operation = new[] {"GetQueueFleetAssociation"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetQueueFleetAssociationResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetQueueFleetAssociationResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetQueueFleetAssociationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCQueueFleetAssociationCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetQueueFleetAssociationResponse, GetADCQueueFleetAssociationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetQueueFleetAssociationRequest();
        ...
        private Amazon.Deadline.Model.GetQueueFleetAssociationResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetQueueFleetAssociationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetQueueFleetAssociation");
            try
            {
                #if DESKTOP
                return client.GetQueueFleetAssociation(request);
                #elif CORECLR
                return client.GetQueueFleetAssociationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String FleetId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetQueueFleetAssociationResponse, GetADCQueueFleetAssociationCmdlet, object> Select { get; set; } =
