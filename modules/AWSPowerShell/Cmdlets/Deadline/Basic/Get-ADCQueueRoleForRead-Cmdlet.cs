...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCQueueRoleForRead")]
    [OutputType("Amazon.Deadline.Model.AwsCredentials")]
    [AWSCmdlet("Calls the AWSDeadlineCloud AssumeQueueRoleForRead API operation.", Operation = new[] {"AssumeQueueRoleForRead"}, SelectReturnType = typeof(Amazon.Deadline.Model.AssumeQueueRoleForReadResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.AwsCredentials or Amazon.Deadline.Model.AssumeQueueRoleForReadResponse",
        "This cmdlet returns an Amazon.Deadline.Model.AwsCredentials object.",
        "The service call response (type Amazon.Deadline.Model.AssumeQueueRoleForReadResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCQueueRoleForReadCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.AssumeQueueRoleForReadResponse, GetADCQueueRoleForReadCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.AssumeQueueRoleForReadRequest();
        ...
        private Amazon.Deadline.Model.AssumeQueueRoleForReadResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.AssumeQueueRoleForReadRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "AssumeQueueRoleForRead");
            try
            {
                #if DESKTOP
                return client.AssumeQueueRoleForRead(request);
                #elif CORECLR
                return client.AssumeQueueRoleForReadAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String FarmId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.AssumeQueueRoleForReadResponse, GetADCQueueRoleForReadCmdlet, object> Select { get; set; } =
