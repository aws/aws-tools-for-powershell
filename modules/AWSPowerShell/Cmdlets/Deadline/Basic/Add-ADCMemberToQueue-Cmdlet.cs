...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Add", "ADCMemberToQueue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWSDeadlineCloud AssociateMemberToQueue API operation.", Operation = new[] {"AssociateMemberToQueue"}, SelectReturnType = typeof(Amazon.Deadline.Model.AssociateMemberToQueueResponse))]
    [AWSCmdletOutput("None or Amazon.Deadline.Model.AssociateMemberToQueueResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Deadline.Model.AssociateMemberToQueueResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddADCMemberToQueueCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ADCMemberToQueue (AssociateMemberToQueue)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.AssociateMemberToQueueResponse, AddADCMemberToQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.AssociateMemberToQueueRequest();
        ...
        private Amazon.Deadline.Model.AssociateMemberToQueueResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.AssociateMemberToQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "AssociateMemberToQueue");
            try
            {
                #if DESKTOP
                return client.AssociateMemberToQueue(request);
                #elif CORECLR
                return client.AssociateMemberToQueueAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Deadline.PrincipalType PrincipalType { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.AssociateMemberToQueueResponse, AddADCMemberToQueueCmdlet, object> Select { get; set; } =
