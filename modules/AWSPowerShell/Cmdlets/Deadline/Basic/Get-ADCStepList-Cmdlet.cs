...
{
    /// <summary>
    /// Lists steps for a job.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.Deadline.Model.StepSummary or Amazon.Deadline.Model.ListStepsResponse",
        ...
        "The service call response (type Amazon.Deadline.Model.ListStepsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCStepListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        private Amazon.Deadline.Model.ListStepsResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListStepsRequest request)
        {
            ...
            try
            {
                return client.ListStepsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
