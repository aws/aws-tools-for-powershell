...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// Updates a step.
    /// </summary>
    [Cmdlet("Update", "ADCStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UpdateADCStepCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.Deadline.StepTargetTaskRunStatus")]
        public Amazon.Deadline.StepTargetTaskRunStatus TargetTaskRunStatus { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-ADCStep (UpdateStep)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.UpdateStepResponse, UpdateADCStepCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.TargetTaskRunStatus == null && ParameterWasBound(nameof(this.TargetTaskRunStatus)))
            {
                WriteWarning("You are passing $null as a value for parameter TargetTaskRunStatus which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.UpdateStepRequest();
        ...
        private Amazon.Deadline.Model.UpdateStepResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.UpdateStepRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "UpdateStep");
            try
            {
                #if DESKTOP
                return client.UpdateStep(request);
                #elif CORECLR
                return client.UpdateStepAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String StepId { get; set; }
            public Amazon.Deadline.StepTargetTaskRunStatus TargetTaskRunStatus { get; set; }
            public System.Func<Amazon.Deadline.Model.UpdateStepResponse, UpdateADCStepCmdlet, object> Select { get; set; } =
