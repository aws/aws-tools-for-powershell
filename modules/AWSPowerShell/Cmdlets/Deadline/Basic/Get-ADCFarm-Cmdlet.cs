...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCFarm")]
    [OutputType("Amazon.Deadline.Model.GetFarmResponse")]
    [AWSCmdlet("Calls the AWSDeadlineCloud GetFarm API operation.", Operation = new[] {"GetFarm"}, SelectReturnType = typeof(Amazon.Deadline.Model.GetFarmResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.GetFarmResponse",
        "This cmdlet returns an Amazon.Deadline.Model.GetFarmResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetADCFarmCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetFarmResponse, GetADCFarmCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetFarmRequest();
        ...
        private Amazon.Deadline.Model.GetFarmResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetFarmRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetFarm");
            try
            {
                #if DESKTOP
                return client.GetFarm(request);
                #elif CORECLR
                return client.GetFarmAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String FarmId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetFarmResponse, GetADCFarmCmdlet, object> Select { get; set; } =
