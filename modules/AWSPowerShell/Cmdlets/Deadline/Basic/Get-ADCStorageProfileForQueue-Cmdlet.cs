...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCStorageProfileForQueue")]
    ...
    public partial class GetADCStorageProfileForQueueCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.GetStorageProfileForQueueResponse, GetADCStorageProfileForQueueCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.GetStorageProfileForQueueRequest();
        ...
        private Amazon.Deadline.Model.GetStorageProfileForQueueResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.GetStorageProfileForQueueRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "GetStorageProfileForQueue");
            try
            {
                #if DESKTOP
                return client.GetStorageProfileForQueue(request);
                #elif CORECLR
                return client.GetStorageProfileForQueueAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String StorageProfileId { get; set; }
            public System.Func<Amazon.Deadline.Model.GetStorageProfileForQueueResponse, GetADCStorageProfileForQueueCmdlet, object> Select { get; set; } =
