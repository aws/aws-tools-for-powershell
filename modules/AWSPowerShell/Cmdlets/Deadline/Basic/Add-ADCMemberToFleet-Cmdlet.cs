...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Add", "ADCMemberToFleet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddADCMemberToFleetCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-ADCMemberToFleet (AssociateMemberToFleet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.AssociateMemberToFleetResponse, AddADCMemberToFleetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.AssociateMemberToFleetRequest();
        ...
        private Amazon.Deadline.Model.AssociateMemberToFleetResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.AssociateMemberToFleetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "AssociateMemberToFleet");
            try
            {
                #if DESKTOP
                return client.AssociateMemberToFleet(request);
                #elif CORECLR
                return client.AssociateMemberToFleetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public Amazon.Deadline.PrincipalType PrincipalType { get; set; }
            public System.Func<Amazon.Deadline.Model.AssociateMemberToFleetResponse, AddADCMemberToFleetCmdlet, object> Select { get; set; } =
