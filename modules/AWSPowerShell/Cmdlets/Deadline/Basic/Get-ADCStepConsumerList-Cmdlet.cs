...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Get", "ADCStepConsumerList")]
    [OutputType("Amazon.Deadline.Model.StepConsumer")]
    ...
    public partial class GetADCStepConsumerListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListStepConsumersResponse, GetADCStepConsumerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.ListStepConsumersRequest();
        ...
        private Amazon.Deadline.Model.ListStepConsumersResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListStepConsumersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListStepConsumers");
            try
            {
                #if DESKTOP
                return client.ListStepConsumers(request);
                #elif CORECLR
                return client.ListStepConsumersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueId { get; set; }
            public System.String StepId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListStepConsumersResponse, GetADCStepConsumerListCmdlet, object> Select { get; set; } =
