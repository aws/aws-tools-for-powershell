...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ADCQueueEnvironment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWSDeadlineCloud DeleteQueueEnvironment API operation.", Operation = new[] {"DeleteQueueEnvironment"}, SelectReturnType = typeof(Amazon.Deadline.Model.DeleteQueueEnvironmentResponse))]
    [AWSCmdletOutput("None or Amazon.Deadline.Model.DeleteQueueEnvironmentResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Deadline.Model.DeleteQueueEnvironmentResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveADCQueueEnvironmentCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCQueueEnvironment (DeleteQueueEnvironment)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DeleteQueueEnvironmentResponse, RemoveADCQueueEnvironmentCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DeleteQueueEnvironmentRequest();
        ...
        private Amazon.Deadline.Model.DeleteQueueEnvironmentResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DeleteQueueEnvironmentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DeleteQueueEnvironment");
            try
            {
                #if DESKTOP
                return client.DeleteQueueEnvironment(request);
                #elif CORECLR
                return client.DeleteQueueEnvironmentAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QueueEnvironmentId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.DeleteQueueEnvironmentResponse, RemoveADCQueueEnvironmentCmdlet, object> Select { get; set; } =
