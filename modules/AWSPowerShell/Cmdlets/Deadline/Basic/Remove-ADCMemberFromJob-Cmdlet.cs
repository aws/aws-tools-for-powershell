...
namespace Amazon.PowerShell.Cmdlets.ADC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ADCMemberFromJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWSDeadlineCloud DisassociateMemberFromJob API operation.", Operation = new[] {"DisassociateMemberFromJob"}, SelectReturnType = typeof(Amazon.Deadline.Model.DisassociateMemberFromJobResponse))]
    [AWSCmdletOutput("None or Amazon.Deadline.Model.DisassociateMemberFromJobResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Deadline.Model.DisassociateMemberFromJobResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveADCMemberFromJobCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ADCMemberFromJob (DisassociateMemberFromJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.DisassociateMemberFromJobResponse, RemoveADCMemberFromJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Deadline.Model.DisassociateMemberFromJobRequest();
        ...
        private Amazon.Deadline.Model.DisassociateMemberFromJobResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.DisassociateMemberFromJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "DisassociateMemberFromJob");
            try
            {
                #if DESKTOP
                return client.DisassociateMemberFromJob(request);
                #elif CORECLR
                return client.DisassociateMemberFromJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PrincipalId { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.DisassociateMemberFromJobResponse, RemoveADCMemberFromJobCmdlet, object> Select { get; set; } =
