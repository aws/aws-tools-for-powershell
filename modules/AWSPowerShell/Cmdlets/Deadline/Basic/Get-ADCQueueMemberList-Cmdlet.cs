...
{
    /// <summary>
    /// Lists the members in a queue.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "ADCQueueMemberList")]
    [OutputType("Amazon.Deadline.Model.QueueMember")]
    [AWSCmdlet("Calls the AWSDeadlineCloud ListQueueMembers API operation.", Operation = new[] {"ListQueueMembers"}, SelectReturnType = typeof(Amazon.Deadline.Model.ListQueueMembersResponse))]
    [AWSCmdletOutput("Amazon.Deadline.Model.QueueMember or Amazon.Deadline.Model.ListQueueMembersResponse",
        "This cmdlet returns a collection of Amazon.Deadline.Model.QueueMember objects.",
        "The service call response (type Amazon.Deadline.Model.ListQueueMembersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetADCQueueMemberListCmdlet : AmazonDeadlineClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Deadline.Model.ListQueueMembersResponse, GetADCQueueMemberListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Deadline.Model.ListQueueMembersRequest();
        ...
        private Amazon.Deadline.Model.ListQueueMembersResponse CallAWSServiceOperation(IAmazonDeadline client, Amazon.Deadline.Model.ListQueueMembersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWSDeadlineCloud", "ListQueueMembers");
            try
            {
                return client.ListQueueMembersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String QueueId { get; set; }
            public System.Func<Amazon.Deadline.Model.ListQueueMembersResponse, GetADCQueueMemberListCmdlet, object> Select { get; set; } =
