...
namespace Amazon.PowerShell.Cmdlets.PCB
{
    ...
    public partial class NewPCBBenefitApplicationCmdlet : AmazonPartnerCentralBenefitsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>AWS resources that are associated with this benefit application.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Supporting documents and files attached to the benefit application.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Contact information for partner representatives responsible for this benefit application.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Key-value pairs to categorize and organize the benefit application.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.PartnerCentralBenefits.Model.CreateBenefitApplicationResponse CallAWSServiceOperation(IAmazonPartnerCentralBenefits client, Amazon.PartnerCentralBenefits.Model.CreateBenefitApplicationRequest request)
        {
            ...
            try
            {
                return client.CreateBenefitApplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
