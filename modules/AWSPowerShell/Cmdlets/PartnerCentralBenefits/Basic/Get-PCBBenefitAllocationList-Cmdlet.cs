...
namespace Amazon.PowerShell.Cmdlets.PCB
{
    ...
    public partial class GetPCBBenefitAllocationListCmdlet : AmazonPartnerCentralBenefitsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Filter benefit allocations by specific benefit application identifiers.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Filter benefit allocations by specific benefit identifiers.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Filter benefit allocations by specific fulfillment types.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>Filter benefit allocations by their current status.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.PartnerCentralBenefits.Model.ListBenefitAllocationsResponse CallAWSServiceOperation(IAmazonPartnerCentralBenefits client, Amazon.PartnerCentralBenefits.Model.ListBenefitAllocationsRequest request)
        {
            ...
            try
            {
                return client.ListBenefitAllocationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
