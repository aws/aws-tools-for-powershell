...
namespace Amazon.PowerShell.Cmdlets.BCMDE
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "BCMDEExport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewBCMDEExportCmdlet : AmazonBCMDataExportsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-BCMDEExport (CreateExport)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BCMDataExports.Model.CreateExportResponse, NewBCMDEExportCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.BCMDataExports.Model.CreateExportRequest();
        ...
        private Amazon.BCMDataExports.Model.CreateExportResponse CallAWSServiceOperation(IAmazonBCMDataExports client, Amazon.BCMDataExports.Model.CreateExportRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.BCMDataExports.Model.CreateExportResponse, NewBCMDEExportCmdlet, object> Select { get; set; } =
