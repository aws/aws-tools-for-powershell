...
{
    /// <summary>
    /// Lists the line items associated with a bill estimate.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetBCMPCBillEstimateLineItemListCmdlet : AmazonBCMPricingCalculatorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Filters to apply to the list of line items. </para><para />
