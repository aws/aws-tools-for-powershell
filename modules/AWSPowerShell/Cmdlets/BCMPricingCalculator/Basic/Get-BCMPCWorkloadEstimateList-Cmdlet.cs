...
{
    /// <summary>
    /// Lists all workload estimates for the account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetBCMPCWorkloadEstimateListCmdlet : AmazonBCMPricingCalculatorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Filters to apply to the list of workload estimates. </para><para />
        ...
        private Amazon.BCMPricingCalculator.Model.ListWorkloadEstimatesResponse CallAWSServiceOperation(IAmazonBCMPricingCalculator client, Amazon.BCMPricingCalculator.Model.ListWorkloadEstimatesRequest request)
        {
            ...
            try
            {
                return client.ListWorkloadEstimatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
