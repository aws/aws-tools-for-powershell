...
{
    /// <summary>
    /// Lists all bill scenarios for the account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "BCMPCBillScenarioList")]
    [OutputType("Amazon.BCMPricingCalculator.Model.BillScenarioSummary")]
    [AWSCmdlet("Calls the AWS Pricing Calculator ListBillScenarios API operation.", Operation = new[] {"ListBillScenarios"}, SelectReturnType = typeof(Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse))]
    [AWSCmdletOutput("Amazon.BCMPricingCalculator.Model.BillScenarioSummary or Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse",
        "This cmdlet returns a collection of Amazon.BCMPricingCalculator.Model.BillScenarioSummary objects.",
        "The service call response (type Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBCMPCBillScenarioListCmdlet : AmazonBCMPricingCalculatorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Filters to apply to the list of bill scenarios. </para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Filters")]
        public Amazon.BCMPricingCalculator.Model.ListBillScenariosFilter[] Filter { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse).
        /// Specifying the name of a property of type Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse, GetBCMPCBillScenarioListCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.BCMPricingCalculator.Model.ListBillScenariosFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BCMPricingCalculator.Model.ListBillScenariosRequest();
        ...
        private Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse CallAWSServiceOperation(IAmazonBCMPricingCalculator client, Amazon.BCMPricingCalculator.Model.ListBillScenariosRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? ExpiresAtFilter_AfterTimestamp { get; set; }
            public System.DateTime? ExpiresAtFilter_BeforeTimestamp { get; set; }
            public List<Amazon.BCMPricingCalculator.Model.ListBillScenariosFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BCMPricingCalculator.Model.ListBillScenariosResponse, GetBCMPCBillScenarioListCmdlet, object> Select { get; set; } =
