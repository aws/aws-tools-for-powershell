...
{
    /// <summary>
    /// Lists the input commitment modifications associated with a bill estimate.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetBCMPCBillEstimateInputCommitmentModificationListCmdlet : AmazonBCMPricingCalculatorClientCmdlet, IExecutor
    {
        ...
        private Amazon.BCMPricingCalculator.Model.ListBillEstimateInputCommitmentModificationsResponse CallAWSServiceOperation(IAmazonBCMPricingCalculator client, Amazon.BCMPricingCalculator.Model.ListBillEstimateInputCommitmentModificationsRequest request)
        {
            ...
            try
            {
                return client.ListBillEstimateInputCommitmentModificationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
