...
{
    /// <summary>
    /// Lists all bill estimates for the account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "BCMPCBillEstimateList")]
    [OutputType("Amazon.BCMPricingCalculator.Model.BillEstimateSummary")]
    [AWSCmdlet("Calls the AWS Pricing Calculator ListBillEstimates API operation.", Operation = new[] {"ListBillEstimates"}, SelectReturnType = typeof(Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse))]
    [AWSCmdletOutput("Amazon.BCMPricingCalculator.Model.BillEstimateSummary or Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse",
        "This cmdlet returns a collection of Amazon.BCMPricingCalculator.Model.BillEstimateSummary objects.",
        "The service call response (type Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetBCMPCBillEstimateListCmdlet : AmazonBCMPricingCalculatorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> Filters to apply to the list of bill estimates. </para><para />
        ...
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Filters")]
        public Amazon.BCMPricingCalculator.Model.ListBillEstimatesFilter[] Filter { get; set; }
        #endregion
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse).
        /// Specifying the name of a property of type Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse, GetBCMPCBillEstimateListCmdlet>(Select) ??
            ...
            if (this.Filter != null)
            {
                context.Filter = new List<Amazon.BCMPricingCalculator.Model.ListBillEstimatesFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.BCMPricingCalculator.Model.ListBillEstimatesRequest();
        ...
        private Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse CallAWSServiceOperation(IAmazonBCMPricingCalculator client, Amazon.BCMPricingCalculator.Model.ListBillEstimatesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Pricing Calculator", "ListBillEstimates");
            try
            {
                return client.ListBillEstimatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.DateTime? ExpiresAtFilter_AfterTimestamp { get; set; }
            public System.DateTime? ExpiresAtFilter_BeforeTimestamp { get; set; }
            public List<Amazon.BCMPricingCalculator.Model.ListBillEstimatesFilter> Filter { get; set; }
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.BCMPricingCalculator.Model.ListBillEstimatesResponse, GetBCMPCBillEstimateListCmdlet, object> Select { get; set; } =
