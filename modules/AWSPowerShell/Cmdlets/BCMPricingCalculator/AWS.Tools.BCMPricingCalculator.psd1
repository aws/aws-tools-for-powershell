#
# Module manifest for module 'AWS.Tools.BCMPricingCalculator'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.BCMPricingCalculator.dll'
    ...
    GUID = 'db74072d-53af-4fb4-82f9-935b02c3f5a7'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.BCMPricingCalculator.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.BCMPricingCalculator.Completers.psm1',
        'AWS.Tools.BCMPricingCalculator.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'New-BCMPCCreateBillScenarioCommitmentModification', 
    ...
    FileList = @(
        'AWS.Tools.BCMPricingCalculator.dll-Help.xml'
    )
