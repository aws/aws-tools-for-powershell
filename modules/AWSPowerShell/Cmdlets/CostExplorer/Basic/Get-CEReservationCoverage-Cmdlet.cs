...
namespace Amazon.PowerShell.Cmdlets.CE
{
    ...
    public partial class GetCEReservationCoverageCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        /// dimension. You can nest only one level deep.</para><para>If you don't provide a <code>SERVICE</code> filter, Cost Explorer defaults to EC2.</para><para>Cost category is also supported.</para>
        /// </para>
        /// </summary>
