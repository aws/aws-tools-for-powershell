...
{
    /// <summary>
    /// Retrieves a list of your historical cost allocation tag backfill requests.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetCECostAllocationTagBackfillHistoryListCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        private Amazon.CostExplorer.Model.ListCostAllocationTagBackfillHistoryResponse CallAWSServiceOperation(IAmazonCostExplorer client, Amazon.CostExplorer.Model.ListCostAllocationTagBackfillHistoryRequest request)
        {
            ...
            try
            {
                return client.ListCostAllocationTagBackfillHistoryAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
