...
{
    /// <summary>
    /// Lists the commitment purchase analyses for your account based on the last 30 days.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCECommitmentPurchaseAnalysisListCmdlet : AmazonCostExplorerClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The analysis IDs associated with the commitment purchase analyses.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AnalysisStatus parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AnalysisStatus' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AnalysisStatus' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AnalysisStatus;
            }
        ...
        private Amazon.CostExplorer.Model.ListCommitmentPurchaseAnalysesResponse CallAWSServiceOperation(IAmazonCostExplorer client, Amazon.CostExplorer.Model.ListCommitmentPurchaseAnalysesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.ListCommitmentPurchaseAnalyses(request);
                #elif CORECLR
                return client.ListCommitmentPurchaseAnalysesAsync(request).GetAwaiter().GetResult();
                #else
