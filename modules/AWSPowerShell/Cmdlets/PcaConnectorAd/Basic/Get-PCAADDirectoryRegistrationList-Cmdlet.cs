...
namespace Amazon.PowerShell.Cmdlets.PCAAD
{
    ...
    /// action.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.PcaConnectorAd.Model.DirectoryRegistrationSummary or Amazon.PcaConnectorAd.Model.ListDirectoryRegistrationsResponse",
        ...
        "The service call response (type Amazon.PcaConnectorAd.Model.ListDirectoryRegistrationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPCAADDirectoryRegistrationListCmdlet : AmazonPcaConnectorAdClientCmdlet, IExecutor
    {
        ...
        private Amazon.PcaConnectorAd.Model.ListDirectoryRegistrationsResponse CallAWSServiceOperation(IAmazonPcaConnectorAd client, Amazon.PcaConnectorAd.Model.ListDirectoryRegistrationsRequest request)
        {
            ...
            try
            {
                return client.ListDirectoryRegistrationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
