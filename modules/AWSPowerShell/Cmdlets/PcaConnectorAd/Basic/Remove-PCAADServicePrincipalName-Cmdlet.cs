...
namespace Amazon.PowerShell.Cmdlets.PCAAD
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PCAADServicePrincipalName", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePCAADServicePrincipalNameCmdlet : AmazonPcaConnectorAdClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PCAADServicePrincipalName (DeleteServicePrincipalName)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameResponse, RemovePCAADServicePrincipalNameCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameRequest();
        ...
        private Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameResponse CallAWSServiceOperation(IAmazonPcaConnectorAd client, Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Pca Connector Ad", "DeleteServicePrincipalName");
            try
            {
                #if DESKTOP
                return client.DeleteServicePrincipalName(request);
                #elif CORECLR
                return client.DeleteServicePrincipalNameAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ConnectorArn { get; set; }
            public System.String DirectoryRegistrationArn { get; set; }
            public System.Func<Amazon.PcaConnectorAd.Model.DeleteServicePrincipalNameResponse, RemovePCAADServicePrincipalNameCmdlet, object> Select { get; set; } =
