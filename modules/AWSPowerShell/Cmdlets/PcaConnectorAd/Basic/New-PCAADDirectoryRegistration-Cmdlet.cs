...
namespace Amazon.PowerShell.Cmdlets.PCAAD
{
    ...
    /// </summary>
    [Cmdlet("New", "PCAADDirectoryRegistration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewPCAADDirectoryRegistrationCmdlet : AmazonPcaConnectorAdClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Metadata assigned to a directory registration consisting of a key-value pair.</para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'DirectoryRegistrationArn'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationResponse).
        /// Specifying the name of a property of type Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DirectoryRegistrationArn";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-PCAADDirectoryRegistration (CreateDirectoryRegistration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationResponse, NewPCAADDirectoryRegistrationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationRequest();
        ...
        private Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationResponse CallAWSServiceOperation(IAmazonPcaConnectorAd client, Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Pca Connector Ad", "CreateDirectoryRegistration");
            try
            {
                #if DESKTOP
                return client.CreateDirectoryRegistration(request);
                #elif CORECLR
                return client.CreateDirectoryRegistrationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.PcaConnectorAd.Model.CreateDirectoryRegistrationResponse, NewPCAADDirectoryRegistrationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DirectoryRegistrationArn;
        }
