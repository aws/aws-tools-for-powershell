#
# Module manifest for module 'AWS.Tools.CognitoIdentityProvider'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.CognitoIdentityProvider.dll'
    ...
    GUID = '33933d0d-16f2-4659-8dae-d93fc7aa6b6a'
...
'
    ...
    NestedModules = @(
        'AWS.Tools.CognitoIdentityProvider.Completers.psm1',
        'AWS.Tools.CognitoIdentityProvider.Aliases.psm1'
    )
