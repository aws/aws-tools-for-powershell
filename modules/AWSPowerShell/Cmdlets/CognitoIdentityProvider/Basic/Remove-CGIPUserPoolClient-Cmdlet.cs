...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider DeleteUserPoolClient API operation.", Operation = new[] {"DeleteUserPoolClient"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCGIPUserPoolClientCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse, RemoveCGIPUserPoolClientCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientRequest request)
        {
            ...
            try
            {
                return client.DeleteUserPoolClientAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientId { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.DeleteUserPoolClientResponse, RemoveCGIPUserPoolClientCmdlet, object> Select { get; set; } =
