...
{
    /// <summary>
    /// Amazon.CognitoIdentityProvider.IAmazonCognitoIdentityProvider.AdminListUserAuthEvents<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CGIPUserAuthEventListAdmin")]
    [OutputType("Amazon.CognitoIdentityProvider.Model.AuthEventType")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminListUserAuthEvents API operation.", Operation = new[] {"AdminListUserAuthEvents"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.AuthEventType or Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse",
        "This cmdlet returns a collection of Amazon.CognitoIdentityProvider.Model.AuthEventType objects.",
    ...
    public partial class GetCGIPUserAuthEventListAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AuthEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse, GetCGIPUserAuthEventListAdminCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AuthEvents.Count;
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "AdminListUserAuthEvents");
            try
            {
                #if DESKTOP
                return client.AdminListUserAuthEvents(request);
                #elif CORECLR
                return client.AdminListUserAuthEventsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminListUserAuthEventsResponse, GetCGIPUserAuthEventListAdminCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AuthEvents;
        }
