...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.GroupType or Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse",
        ...
        "The service call response (type Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGIPGroupsForUserAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserRequest request)
        {
            ...
            try
            {
                return client.AdminListGroupsForUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
