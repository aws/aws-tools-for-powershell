...
{
    /// <summary>
    /// Amazon.CognitoIdentityProvider.IAmazonCognitoIdentityProvider.AdminListGroupsForUser<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CGIPGroupsForUserAdmin")]
    [OutputType("Amazon.CognitoIdentityProvider.Model.GroupType")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminListGroupsForUser API operation.", Operation = new[] {"AdminListGroupsForUser"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.GroupType or Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse",
        "This cmdlet returns a collection of Amazon.CognitoIdentityProvider.Model.GroupType objects.",
    ...
    public partial class GetCGIPGroupsForUserAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse, GetCGIPGroupsForUserAdminCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminListGroupsForUserResponse, GetCGIPGroupsForUserAdminCmdlet, object> Select { get; set; } =
