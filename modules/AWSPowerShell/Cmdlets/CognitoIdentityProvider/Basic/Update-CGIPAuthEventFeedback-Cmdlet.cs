...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider UpdateAuthEventFeedback API operation.", Operation = new[] {"UpdateAuthEventFeedback"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCGIPAuthEventFeedbackCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse, UpdateCGIPAuthEventFeedbackCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.FeedbackToken == null && ParameterWasBound(nameof(this.FeedbackToken)))
            {
                WriteWarning("You are passing $null as a value for parameter FeedbackToken which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
            context.FeedbackValue = this.FeedbackValue;
            #if MODULAR
            if (this.FeedbackValue == null && ParameterWasBound(nameof(this.FeedbackValue)))
            {
                WriteWarning("You are passing $null as a value for parameter FeedbackValue which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackRequest request)
        {
            ...
            try
            {
                return client.UpdateAuthEventFeedbackAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.UpdateAuthEventFeedbackResponse, UpdateCGIPAuthEventFeedbackCmdlet, object> Select { get; set; } =
