...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class RemoveCGIPUserAttributeAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminDeleteUserAttributesResponse, RemoveCGIPUserAttributeAdminCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminDeleteUserAttributesResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminDeleteUserAttributesRequest request)
        {
            ...
            try
            {
                return client.AdminDeleteUserAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminDeleteUserAttributesResponse, RemoveCGIPUserAttributeAdminCmdlet, object> Select { get; set; } =
