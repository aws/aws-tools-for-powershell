...
{
    /// <summary>
    /// Amazon.CognitoIdentityProvider.IAmazonCognitoIdentityProvider.ListUserPools<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CGIPUserPoolList")]
    [OutputType("Amazon.CognitoIdentityProvider.Model.UserPoolDescriptionType")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider ListUserPools API operation.", Operation = new[] {"ListUserPools"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.UserPoolDescriptionType or Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse",
        "This cmdlet returns a collection of Amazon.CognitoIdentityProvider.Model.UserPoolDescriptionType objects.",
    ...
    public partial class GetCGIPUserPoolListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "UserPools";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse, GetCGIPUserPoolListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CognitoIdentityProvider.Model.ListUserPoolsRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.ListUserPoolsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "ListUserPools");
            try
            {
                #if DESKTOP
                return client.ListUserPools(request);
                #elif CORECLR
                return client.ListUserPoolsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.ListUserPoolsResponse, GetCGIPUserPoolListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.UserPools;
        }
