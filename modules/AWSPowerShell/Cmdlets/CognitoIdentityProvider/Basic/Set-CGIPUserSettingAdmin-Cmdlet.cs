...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminSetUserSettings API operation.", Operation = new[] {"AdminSetUserSettings"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse) be returned by specifying '-Select *'."
    )]
    public partial class SetCGIPUserSettingAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>You can use this parameter only to set an SMS configuration that uses SMS for delivery.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-CGIPUserSettingAdmin (AdminSetUserSettings)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse, SetCGIPUserSettingAdminCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "AdminSetUserSettings");
            try
            {
                return client.AdminSetUserSettingsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminSetUserSettingsResponse, SetCGIPUserSettingAdminCmdlet, object> Select { get; set; } =
