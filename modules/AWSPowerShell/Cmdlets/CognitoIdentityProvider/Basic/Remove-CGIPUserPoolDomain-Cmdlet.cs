...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class RemoveCGIPUserPoolDomainCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.DeleteUserPoolDomainResponse, RemoveCGIPUserPoolDomainCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.DeleteUserPoolDomainResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DeleteUserPoolDomainRequest request)
        {
            ...
            try
            {
                return client.DeleteUserPoolDomainAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Domain { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.DeleteUserPoolDomainResponse, RemoveCGIPUserPoolDomainCmdlet, object> Select { get; set; } =
