...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Revoke", "CGIPToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class RevokeCGIPTokenCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Revoke-CGIPToken (RevokeToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.RevokeTokenResponse, RevokeCGIPTokenCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.RevokeTokenRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.RevokeTokenResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.RevokeTokenRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "RevokeToken");
            try
            {
                #if DESKTOP
                return client.RevokeToken(request);
                #elif CORECLR
                return client.RevokeTokenAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ClientSecret { get; set; }
            public System.String Token { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.RevokeTokenResponse, RevokeCGIPTokenCmdlet, object> Select { get; set; } =
