...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class RemoveCGIPResourceServerCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.DeleteResourceServerResponse, RemoveCGIPResourceServerCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.DeleteResourceServerResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DeleteResourceServerRequest request)
        {
            ...
            try
            {
                return client.DeleteResourceServerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Identifier { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.DeleteResourceServerResponse, RemoveCGIPResourceServerCmdlet, object> Select { get; set; } =
