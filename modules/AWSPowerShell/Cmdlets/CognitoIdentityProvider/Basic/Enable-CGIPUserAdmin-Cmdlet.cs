...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminEnableUser API operation.", Operation = new[] {"AdminEnableUser"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse) be returned by specifying '-Select *'."
    )]
    public partial class EnableCGIPUserAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse, EnableCGIPUserAdminCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminEnableUserRequest request)
        {
            ...
            try
            {
                return client.AdminEnableUserAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminEnableUserResponse, EnableCGIPUserAdminCmdlet, object> Select { get; set; } =
