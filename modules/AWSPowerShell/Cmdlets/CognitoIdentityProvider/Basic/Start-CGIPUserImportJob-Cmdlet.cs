...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class StartCGIPUserImportJobCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-CGIPUserImportJob (StartUserImportJob)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.StartUserImportJobResponse, StartCGIPUserImportJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.StartUserImportJobRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.StartUserImportJobResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.StartUserImportJobRequest request)
        {
            ...
            try
            {
                return client.StartUserImportJobAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String JobId { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.StartUserImportJobResponse, StartCGIPUserImportJobCmdlet, object> Select { get; set; } =
