...
{
    /// <summary>
    /// Amazon.CognitoIdentityProvider.IAmazonCognitoIdentityProvider.ListGroups<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CGIPGroupList")]
    [OutputType("Amazon.CognitoIdentityProvider.Model.GroupType")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider ListGroups API operation.", Operation = new[] {"ListGroups"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.ListGroupsResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.GroupType or Amazon.CognitoIdentityProvider.Model.ListGroupsResponse",
    ...
    public partial class GetCGIPGroupListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.ListGroupsResponse, GetCGIPGroupListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.ListGroupsResponse, GetCGIPGroupListCmdlet, object> Select { get; set; } =
