...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CGIPManagedLoginBranding", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider DeleteManagedLoginBranding API operation.", Operation = new[] {"DeleteManagedLoginBranding"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse) be returned by specifying '-Select *'."
    )]
    public partial class RemoveCGIPManagedLoginBrandingCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CGIPManagedLoginBranding (DeleteManagedLoginBranding)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse, RemoveCGIPManagedLoginBrandingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "DeleteManagedLoginBranding");
            try
            {
                #if DESKTOP
                return client.DeleteManagedLoginBranding(request);
                #elif CORECLR
                return client.DeleteManagedLoginBrandingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ManagedLoginBrandingId { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.DeleteManagedLoginBrandingResponse, RemoveCGIPManagedLoginBrandingCmdlet, object> Select { get; set; } =
