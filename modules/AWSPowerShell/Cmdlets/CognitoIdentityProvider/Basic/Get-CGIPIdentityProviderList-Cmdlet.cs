...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider ListIdentityProviders API operation.", Operation = new[] {"ListIdentityProviders"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.ListIdentityProvidersResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.ProviderDescription or Amazon.CognitoIdentityProvider.Model.ListIdentityProvidersResponse",
        "This cmdlet returns a collection of Amazon.CognitoIdentityProvider.Model.ProviderDescription objects.",
        "The service call response (type Amazon.CognitoIdentityProvider.Model.ListIdentityProvidersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGIPIdentityProviderListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Providers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.ListIdentityProvidersResponse, GetCGIPIdentityProviderListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Providers?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.ListIdentityProvidersResponse, GetCGIPIdentityProviderListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Providers;
        }
