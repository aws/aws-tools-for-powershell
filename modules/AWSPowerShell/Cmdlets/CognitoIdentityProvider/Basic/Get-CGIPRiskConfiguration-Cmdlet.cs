...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider DescribeRiskConfiguration API operation.", Operation = new[] {"DescribeRiskConfiguration"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.RiskConfigurationType or Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse",
        "This cmdlet returns an Amazon.CognitoIdentityProvider.Model.RiskConfigurationType object.",
        "The service call response (type Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGIPRiskConfigurationCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse, GetCGIPRiskConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "DescribeRiskConfiguration");
            try
            {
                return client.DescribeRiskConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientId { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.DescribeRiskConfigurationResponse, GetCGIPRiskConfigurationCmdlet, object> Select { get; set; } =
