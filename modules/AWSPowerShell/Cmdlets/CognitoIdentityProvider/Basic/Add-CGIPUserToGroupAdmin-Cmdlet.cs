...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    public partial class AddCGIPUserToGroupAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CGIPUserToGroupAdmin (AdminAddUserToGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminAddUserToGroupResponse, AddCGIPUserToGroupAdminCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CognitoIdentityProvider.Model.AdminAddUserToGroupRequest();
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminAddUserToGroupResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminAddUserToGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Cognito Identity Provider", "AdminAddUserToGroup");
            try
            {
                #if DESKTOP
                return client.AdminAddUserToGroup(request);
                #elif CORECLR
                return client.AdminAddUserToGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminAddUserToGroupResponse, AddCGIPUserToGroupAdminCmdlet, object> Select { get; set; } =
