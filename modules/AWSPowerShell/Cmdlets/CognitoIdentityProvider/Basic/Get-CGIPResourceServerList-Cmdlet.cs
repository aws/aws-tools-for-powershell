...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider ListResourceServers API operation.", Operation = new[] {"ListResourceServers"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse))]
    [AWSCmdletOutput("Amazon.CognitoIdentityProvider.Model.ResourceServerType or Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse",
        "This cmdlet returns a collection of Amazon.CognitoIdentityProvider.Model.ResourceServerType objects.",
        "The service call response (type Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCGIPResourceServerListCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ResourceServers";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse, GetCGIPResourceServerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ResourceServers?.Count ?? 0;
        ...
        private Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.ListResourceServersRequest request)
        {
            ...
            try
            {
                return client.ListResourceServersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.ListResourceServersResponse, GetCGIPResourceServerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ResourceServers;
        }
