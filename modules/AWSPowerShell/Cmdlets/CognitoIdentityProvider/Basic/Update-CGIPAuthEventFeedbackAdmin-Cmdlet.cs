...
namespace Amazon.PowerShell.Cmdlets.CGIP
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Cognito Identity Provider AdminUpdateAuthEventFeedback API operation.", Operation = new[] {"AdminUpdateAuthEventFeedback"}, SelectReturnType = typeof(Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse))]
    [AWSCmdletOutput("None or Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse) be returned by specifying '-Select *'."
    )]
    public partial class UpdateCGIPAuthEventFeedbackAdminCmdlet : AmazonCognitoIdentityProviderClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse, UpdateCGIPAuthEventFeedbackAdminCmdlet>(Select) ??
        ...
        private Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse CallAWSServiceOperation(IAmazonCognitoIdentityProvider client, Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackRequest request)
        {
            ...
            try
            {
                return client.AdminUpdateAuthEventFeedbackAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Username { get; set; }
            public System.String UserPoolId { get; set; }
            public System.Func<Amazon.CognitoIdentityProvider.Model.AdminUpdateAuthEventFeedbackResponse, UpdateCGIPAuthEventFeedbackAdminCmdlet, object> Select { get; set; } =
