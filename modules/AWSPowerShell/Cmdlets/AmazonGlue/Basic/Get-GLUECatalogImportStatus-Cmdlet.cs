...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetCatalogImportStatus API operation.", Operation = new[] {"GetCatalogImportStatus"})]
    [AWSCmdletOutput("Amazon.Glue.Model.CatalogImportStatus",
        "This cmdlet returns a CatalogImportStatus object.",
    ...
    public partial class GetGLUECatalogImportStatusCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.ImportStatus;
        ...
        private Amazon.Glue.Model.GetCatalogImportStatusResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetCatalogImportStatusRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetCatalogImportStatusAsync(request);
                return task.Result;
                #else
