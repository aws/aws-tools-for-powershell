...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDataCatalogEncryptionSettings API operation.", Operation = new[] {"GetDataCatalogEncryptionSettings"})]
    [AWSCmdletOutput("Amazon.Glue.Model.DataCatalogEncryptionSettings",
        "This cmdlet returns a DataCatalogEncryptionSettings object.",
    ...
    public partial class GetGLUEDataCatalogEncryptionSettingCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.DataCatalogEncryptionSettings;
        ...
        private Amazon.Glue.Model.GetDataCatalogEncryptionSettingsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDataCatalogEncryptionSettingsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDataCatalogEncryptionSettingsAsync(request);
                return task.Result;
                #else
