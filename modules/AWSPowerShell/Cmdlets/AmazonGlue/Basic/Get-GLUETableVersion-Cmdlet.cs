...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetTableVersion API operation.", Operation = new[] {"GetTableVersion"})]
    [AWSCmdletOutput("Amazon.Glue.Model.TableVersion",
        "This cmdlet returns a TableVersion object.",
    ...
    public partial class GetGLUETableVersionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID value of the table version to be retrieved.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.TableVersion;
        ...
        private Amazon.Glue.Model.GetTableVersionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetTableVersionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetTableVersionAsync(request);
                return task.Result;
                #else
