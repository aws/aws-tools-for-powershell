...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUEJobNameList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Glue ListJobs API operation.", Operation = new[] {"ListJobs"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Glue.Model.ListJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetGLUEJobNameListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.ListJobsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.JobNames;
                        ...
                        int _receivedThisCall = response.JobNames.Count;
        ...
        private Amazon.Glue.Model.ListJobsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.ListJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "ListJobs");
            try
            {
                #if DESKTOP
