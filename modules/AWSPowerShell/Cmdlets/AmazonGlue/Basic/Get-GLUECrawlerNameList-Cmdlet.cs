...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue ListCrawlers API operation.", Operation = new[] {"ListCrawlers"})]
    ...
    public partial class GetGLUECrawlerNameListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CrawlerNames;
        ...
        private Amazon.Glue.Model.ListCrawlersResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.ListCrawlersRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListCrawlersAsync(request);
                return task.Result;
                #else
