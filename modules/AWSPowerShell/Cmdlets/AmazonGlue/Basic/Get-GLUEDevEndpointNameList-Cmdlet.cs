...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue ListDevEndpoints API operation.", Operation = new[] {"ListDevEndpoints"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a collection of String objects.",
        "The service call response (type Amazon.Glue.Model.ListDevEndpointsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetGLUEDevEndpointNameListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Glue.Model.ListDevEndpointsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DevEndpointNames;
                        ...
                        int _receivedThisCall = response.DevEndpointNames.Count;
        ...
        private Amazon.Glue.Model.ListDevEndpointsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.ListDevEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "ListDevEndpoints");
            try
            {
                #if DESKTOP
                return client.ListDevEndpoints(request);
                #elif CORECLR
                return client.ListDevEndpointsAsync(request).GetAwaiter().GetResult();
                #else
