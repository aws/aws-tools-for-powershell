...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetTags API operation.", Operation = new[] {"GetTags"})]
    ...
    public partial class GetGLUETagCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetTagsRequest();
        ...
        private Amazon.Glue.Model.GetTagsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetTags");
            try
            {
                #if DESKTOP
