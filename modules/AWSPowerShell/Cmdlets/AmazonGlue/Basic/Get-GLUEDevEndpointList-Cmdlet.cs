...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDevEndpoints API operation.", Operation = new[] {"GetDevEndpoints"})]
    [AWSCmdletOutput("Amazon.Glue.Model.DevEndpoint",
        "This cmdlet returns a collection of DevEndpoint objects.",
    ...
    public partial class GetGLUEDevEndpointListCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DevEndpoints;
        ...
        private Amazon.Glue.Model.GetDevEndpointsResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDevEndpointsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDevEndpointsAsync(request);
                return task.Result;
                #else
