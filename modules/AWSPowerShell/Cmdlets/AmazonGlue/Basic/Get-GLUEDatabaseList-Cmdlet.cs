...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDatabases API operation.", Operation = new[] {"GetDatabases"})]
    [AWSCmdletOutput("Amazon.Glue.Model.Database",
        "This cmdlet returns a collection of Database objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.DatabaseList;
