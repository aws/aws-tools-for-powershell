...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDataflowGraph API operation.", Operation = new[] {"GetDataflowGraph"})]
    [AWSCmdletOutput("Amazon.Glue.Model.GetDataflowGraphResponse",
        "This cmdlet returns a Amazon.Glue.Model.GetDataflowGraphResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUEDataflowGraphCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        private Amazon.Glue.Model.GetDataflowGraphResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDataflowGraphRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetDataflowGraph(request);
                #elif CORECLR
                return client.GetDataflowGraphAsync(request).GetAwaiter().GetResult();
                #else
