...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetTable API operation.", Operation = new[] {"GetTable"})]
    [AWSCmdletOutput("Amazon.Glue.Model.Table",
        "This cmdlet returns a Table object.",
        "The service call response (type Amazon.Glue.Model.GetTableResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetGLUETableCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        private Amazon.Glue.Model.GetTableResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetTableRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetTableAsync(request);
                return task.Result;
                #else
