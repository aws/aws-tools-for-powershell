...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    [AWSCmdlet("Calls the AWS Glue GetDatabase API operation.", Operation = new[] {"GetDatabase"})]
    [AWSCmdletOutput("Amazon.Glue.Model.Database",
        "This cmdlet returns a Database object.",
    ...
    public partial class GetGLUEDatabaseCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Database;
        ...
        private Amazon.Glue.Model.GetDatabaseResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetDatabaseRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetDatabaseAsync(request);
                return task.Result;
                #else
