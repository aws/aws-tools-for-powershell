...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Get", "GLUEPartition")]
    [OutputType("Amazon.Glue.Model.Partition")]
    [AWSCmdlet("Calls the AWS Glue GetPartition API operation.", Operation = new[] {"GetPartition"})]
    [AWSCmdletOutput("Amazon.Glue.Model.Partition",
        "This cmdlet returns a Partition object.",
    ...
    public partial class GetGLUEPartitionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.GetPartitionRequest();
            ...
            try
            {
                ...
                object pipelineOutput = response.Partition;
        ...
        private Amazon.Glue.Model.GetPartitionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.GetPartitionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "GetPartition");
            try
            {
                #if DESKTOP
