...
namespace Amazon.PowerShell.Cmdlets.GLUE
{
    ...
    /// </summary>
    [Cmdlet("Update", "GLUEUserDefinedFunction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the AWS Glue UpdateUserDefinedFunction API operation.", Operation = new[] {"UpdateUserDefinedFunction"})]
    ...
    public partial class UpdateGLUEUserDefinedFunctionCmdlet : AmazonGlueClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-GLUEUserDefinedFunction (UpdateUserDefinedFunction)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Glue.Model.UpdateUserDefinedFunctionRequest();
        ...
        private Amazon.Glue.Model.UpdateUserDefinedFunctionResponse CallAWSServiceOperation(IAmazonGlue client, Amazon.Glue.Model.UpdateUserDefinedFunctionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Glue", "UpdateUserDefinedFunction");
            try
            {
                #if DESKTOP
                return client.UpdateUserDefinedFunction(request);
                #elif CORECLR
                return client.UpdateUserDefinedFunctionAsync(request).GetAwaiter().GetResult();
                #else
