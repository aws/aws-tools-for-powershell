...
namespace Amazon.PowerShell.Cmdlets.ASP
{
    ...
    [AWSCmdletOutput("Amazon.AutoScalingPlans.Model.ScalingPlan or Amazon.AutoScalingPlans.Model.DescribeScalingPlansResponse",
        ...
        "The service call response (type Amazon.AutoScalingPlans.Model.DescribeScalingPlansResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASPScalingPlanCmdlet : AmazonAutoScalingPlansClientCmdlet, IExecutor
    {
        ...
        /// cannot specify application sources.</para><para />
        ...
        /// cannot specify scaling plan names.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        /// <summary>
        /// <para>
        /// <para>The version number of the scaling plan. Currently, the only valid value is <c>1</c>.</para><note><para>If you specify a scaling plan version, you must also specify a scaling plan name.</para></note>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ScalingPlans?.Count ?? 0;
        ...
        private Amazon.AutoScalingPlans.Model.DescribeScalingPlansResponse CallAWSServiceOperation(IAmazonAutoScalingPlans client, Amazon.AutoScalingPlans.Model.DescribeScalingPlansRequest request)
        {
            ...
            try
            {
                return client.DescribeScalingPlansAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
