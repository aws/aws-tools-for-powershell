...
namespace Amazon.PowerShell.Cmdlets.ASP
{
    ...
    /// </summary>
    [Cmdlet("Get", "ASPScalingPlanResource")]
    [OutputType("Amazon.AutoScalingPlans.Model.ScalingPlanResource")]
    [AWSCmdlet("Calls the AWS Auto Scaling Plans DescribeScalingPlanResources API operation.", Operation = new[] {"DescribeScalingPlanResources"}, SelectReturnType = typeof(Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse))]
    [AWSCmdletOutput("Amazon.AutoScalingPlans.Model.ScalingPlanResource or Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse",
        "This cmdlet returns a collection of Amazon.AutoScalingPlans.Model.ScalingPlanResource objects.",
        "The service call response (type Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetASPScalingPlanResourceCmdlet : AmazonAutoScalingPlansClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ScalingPlanResources";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse, GetASPScalingPlanResourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ScalingPlanResources?.Count ?? 0;
        ...
        private Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse CallAWSServiceOperation(IAmazonAutoScalingPlans client, Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling Plans", "DescribeScalingPlanResources");
            try
            {
                #if DESKTOP
                return client.DescribeScalingPlanResources(request);
                #elif CORECLR
                return client.DescribeScalingPlanResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ScalingPlanName { get; set; }
            public System.Int64? ScalingPlanVersion { get; set; }
            public System.Func<Amazon.AutoScalingPlans.Model.DescribeScalingPlanResourcesResponse, GetASPScalingPlanResourceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ScalingPlanResources;
        }
