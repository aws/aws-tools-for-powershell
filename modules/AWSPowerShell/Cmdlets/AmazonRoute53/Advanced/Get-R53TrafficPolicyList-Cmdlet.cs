...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    /// </para></ul>
    /// <para>
    /// Note: For scripts written against earlier versions of this module this cmdlet can also be invoked with the alias <i>Get-R53TrafficPolicies</i>.
    /// </para>
    /// </summary>
    ...
    public class GetR53TrafficPolicyListCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route 53", "ListTrafficPolicies");
#if DESKTOP
