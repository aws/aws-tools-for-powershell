...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [AWSCmdlet("Invokes the ListTrafficPolicyInstancesByPolicy operation against Amazon Route 53.", Operation = new[] {"ListTrafficPolicyInstancesByPolicy"})]
    ...
    public class GetR53TrafficPolicyInstancesByPolicyCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.ListTrafficPolicyInstancesByPolicy(request);
