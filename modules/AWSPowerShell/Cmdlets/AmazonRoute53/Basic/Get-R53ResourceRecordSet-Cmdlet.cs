...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [OutputType("Amazon.Route53.Model.ListResourceRecordSetsResult")]
    [AWSCmdlet("Invokes the ListResourceRecordSets operation against AWS Route 53.", Operation = new[] {"ListResourceRecordSets"})]
    [AWSCmdletOutput("Amazon.Route53.Model.ListResourceRecordSetsResult",
        "This cmdlet returns a ListResourceRecordSetsResult object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
