...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [OutputType("Amazon.Route53.Model.CreateHostedZoneResult")]
    [AWSCmdlet("Invokes the CreateHostedZone operation against AWS Route 53.", Operation = new[] {"CreateHostedZone"})]
    [AWSCmdletOutput("Amazon.Route53.Model.CreateHostedZoneResult",
        "This cmdlet returns a CreateHostedZoneResult object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
