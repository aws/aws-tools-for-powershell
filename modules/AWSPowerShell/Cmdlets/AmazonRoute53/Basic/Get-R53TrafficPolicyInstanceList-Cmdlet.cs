...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 ListTrafficPolicyInstances API operation.", Operation = new[] {"ListTrafficPolicyInstances"}, LegacyAlias="Get-R53TrafficPolicyInstances")]
