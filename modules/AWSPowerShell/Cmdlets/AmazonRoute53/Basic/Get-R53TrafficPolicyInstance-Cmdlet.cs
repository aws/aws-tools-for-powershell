...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53TrafficPolicyInstanceCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Route53.Model.GetTrafficPolicyInstanceResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetTrafficPolicyInstanceRequest request)
        {
            #if DESKTOP
            return client.GetTrafficPolicyInstance(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetTrafficPolicyInstanceAsync(request);
            return task.Result;
            #else
