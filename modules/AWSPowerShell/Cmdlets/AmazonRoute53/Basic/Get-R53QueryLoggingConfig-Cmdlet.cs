...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    [AWSCmdlet("Calls the Amazon Route 53 GetQueryLoggingConfig API operation.", Operation = new[] {"GetQueryLoggingConfig"})]
    [AWSCmdletOutput("Amazon.Route53.Model.QueryLoggingConfig",
        "This cmdlet returns a QueryLoggingConfig object.",
        "The service call response (type Amazon.Route53.Model.GetQueryLoggingConfigResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53QueryLoggingConfigCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.QueryLoggingConfig;
        ...
        private Amazon.Route53.Model.GetQueryLoggingConfigResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetQueryLoggingConfigRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetQueryLoggingConfig(request);
                #elif CORECLR
                return client.GetQueryLoggingConfigAsync(request).GetAwaiter().GetResult();
                #else
