...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53VPCAssociationAuthorizationListCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Route53.Model.ListVPCAssociationAuthorizationsResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.ListVPCAssociationAuthorizationsRequest request)
        {
            #if DESKTOP
