...
namespace Amazon.PowerShell.Cmdlets.R53
{
    ...
    public partial class GetR53TrafficPolicyCmdlet : AmazonRoute53ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Route53.Model.GetTrafficPolicyResponse CallAWSServiceOperation(IAmazonRoute53 client, Amazon.Route53.Model.GetTrafficPolicyRequest request)
        {
            #if DESKTOP
