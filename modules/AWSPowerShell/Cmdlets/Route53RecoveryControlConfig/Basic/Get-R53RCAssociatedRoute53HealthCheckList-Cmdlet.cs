...
namespace Amazon.PowerShell.Cmdlets.R53RC
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53RCAssociatedRoute53HealthCheckList")]
    ...
    public partial class GetR53RCAssociatedRoute53HealthCheckListCmdlet : AmazonRoute53RecoveryControlConfigClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "HealthCheckIds";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryControlConfig.Model.ListAssociatedRoute53HealthChecksResponse, GetR53RCAssociatedRoute53HealthCheckListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53RecoveryControlConfig.Model.ListAssociatedRoute53HealthChecksRequest();
        ...
        private Amazon.Route53RecoveryControlConfig.Model.ListAssociatedRoute53HealthChecksResponse CallAWSServiceOperation(IAmazonRoute53RecoveryControlConfig client, Amazon.Route53RecoveryControlConfig.Model.ListAssociatedRoute53HealthChecksRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Control Config", "ListAssociatedRoute53HealthChecks");
            try
            {
                #if DESKTOP
                return client.ListAssociatedRoute53HealthChecks(request);
                #elif CORECLR
                return client.ListAssociatedRoute53HealthChecksAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RoutingControlArn { get; set; }
            public System.Func<Amazon.Route53RecoveryControlConfig.Model.ListAssociatedRoute53HealthChecksResponse, GetR53RCAssociatedRoute53HealthCheckListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.HealthCheckIds;
        }
