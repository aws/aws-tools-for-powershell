...
namespace Amazon.PowerShell.Cmdlets.R53RC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "R53RCRoutingControl", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Route53 Recovery Control Config DeleteRoutingControl API operation.", Operation = new[] {"DeleteRoutingControl"}, SelectReturnType = typeof(Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse))]
    [AWSCmdletOutput("None or Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveR53RCRoutingControlCmdlet : AmazonRoute53RecoveryControlConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-R53RCRoutingControl (DeleteRoutingControl)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse, RemoveR53RCRoutingControlCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlRequest();
        ...
        private Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse CallAWSServiceOperation(IAmazonRoute53RecoveryControlConfig client, Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Control Config", "DeleteRoutingControl");
            try
            {
                #if DESKTOP
                return client.DeleteRoutingControl(request);
                #elif CORECLR
                return client.DeleteRoutingControlAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String RoutingControlArn { get; set; }
            public System.Func<Amazon.Route53RecoveryControlConfig.Model.DeleteRoutingControlResponse, RemoveR53RCRoutingControlCmdlet, object> Select { get; set; } =
