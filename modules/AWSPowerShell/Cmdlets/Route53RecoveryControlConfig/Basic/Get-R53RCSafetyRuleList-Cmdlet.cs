...
namespace Amazon.PowerShell.Cmdlets.R53RC
{
    ...
    /// </summary>
    [Cmdlet("Get", "R53RCSafetyRuleList")]
    [OutputType("Amazon.Route53RecoveryControlConfig.Model.Rule")]
    [AWSCmdlet("Calls the AWS Route53 Recovery Control Config ListSafetyRules API operation.", Operation = new[] {"ListSafetyRules"}, SelectReturnType = typeof(Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse))]
    [AWSCmdletOutput("Amazon.Route53RecoveryControlConfig.Model.Rule or Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse",
        "This cmdlet returns a collection of Amazon.Route53RecoveryControlConfig.Model.Rule objects.",
        "The service call response (type Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetR53RCSafetyRuleListCmdlet : AmazonRoute53RecoveryControlConfigClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "SafetyRules";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse, GetR53RCSafetyRuleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesRequest();
        ...
        private Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse CallAWSServiceOperation(IAmazonRoute53RecoveryControlConfig client, Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Control Config", "ListSafetyRules");
            try
            {
                #if DESKTOP
                return client.ListSafetyRules(request);
                #elif CORECLR
                return client.ListSafetyRulesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Route53RecoveryControlConfig.Model.ListSafetyRulesResponse, GetR53RCSafetyRuleListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.SafetyRules;
        }
