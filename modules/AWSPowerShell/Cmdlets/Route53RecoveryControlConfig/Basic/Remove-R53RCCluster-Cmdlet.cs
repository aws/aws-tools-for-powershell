...
namespace Amazon.PowerShell.Cmdlets.R53RC
{
    ...
    /// Delete a cluster.
    /// </summary>
    [Cmdlet("Remove", "R53RCCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveR53RCClusterCmdlet : AmazonRoute53RecoveryControlConfigClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-R53RCCluster (DeleteCluster)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Route53RecoveryControlConfig.Model.DeleteClusterResponse, RemoveR53RCClusterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Route53RecoveryControlConfig.Model.DeleteClusterRequest();
        ...
        private Amazon.Route53RecoveryControlConfig.Model.DeleteClusterResponse CallAWSServiceOperation(IAmazonRoute53RecoveryControlConfig client, Amazon.Route53RecoveryControlConfig.Model.DeleteClusterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Route53 Recovery Control Config", "DeleteCluster");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ClusterArn { get; set; }
            public System.Func<Amazon.Route53RecoveryControlConfig.Model.DeleteClusterResponse, RemoveR53RCClusterCmdlet, object> Select { get; set; } =
