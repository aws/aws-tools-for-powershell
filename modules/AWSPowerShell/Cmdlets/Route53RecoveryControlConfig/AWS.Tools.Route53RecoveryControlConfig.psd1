#
# Module manifest for module 'AWS.Tools.Route53RecoveryControlConfig'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.Route53RecoveryControlConfig.dll'
    ...
    GUID = 'f3994353-a65e-4449-ba43-4c3642c3db10'
...
'
    ...
    FormatsToProcess = @(
        'AWS.Tools.Route53RecoveryControlConfig.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.Route53RecoveryControlConfig.Completers.psm1',
        'AWS.Tools.Route53RecoveryControlConfig.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.Route53RecoveryControlConfig.dll-Help.xml'
    )
