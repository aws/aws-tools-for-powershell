...
namespace Amazon.PowerShell.Cmdlets.XR
{
    ...
    [AWSCmdlet("Invokes the GetServiceGraph operation against AWS X-Ray.", Operation = new[] {"GetServiceGraph"})]
    ...
    public partial class GetXRServiceGraphCmdlet : AmazonXRayClientCmdlet, IExecutor
    {
        ...
        private static Amazon.XRay.Model.GetServiceGraphResponse CallAWSServiceOperation(IAmazonXRay client, Amazon.XRay.Model.GetServiceGraphRequest request)
        {
            #if DESKTOP
            return client.GetServiceGraph(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetServiceGraphAsync(request);
            return task.Result;
            #else
