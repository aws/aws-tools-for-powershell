...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service V2 (SES V2) GetEmailIdentity API operation.", Operation = new[] {"GetEmailIdentity"}, SelectReturnType = typeof(Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse))]
    [AWSCmdletOutput("Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse",
        "This cmdlet returns an Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSES2EmailIdentityCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse, GetSES2EmailIdentityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.GetEmailIdentityRequest();
        ...
        private Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.GetEmailIdentityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service V2 (SES V2)", "GetEmailIdentity");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String EmailIdentity { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.GetEmailIdentityResponse, GetSES2EmailIdentityCmdlet, object> Select { get; set; } =
