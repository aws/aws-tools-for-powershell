...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    public partial class UpdateSES2ConfigurationSetEventDestinationCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SES2ConfigurationSetEventDestination (UpdateConfigurationSetEventDestination)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.UpdateConfigurationSetEventDestinationRequest();
        ...
        private Amazon.SimpleEmailV2.Model.UpdateConfigurationSetEventDestinationResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.UpdateConfigurationSetEventDestinationRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SnsDestination_TopicArn { get; set; }
            public System.String EventDestinationName { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.UpdateConfigurationSetEventDestinationResponse, UpdateSES2ConfigurationSetEventDestinationCmdlet, object> Select { get; set; } =
