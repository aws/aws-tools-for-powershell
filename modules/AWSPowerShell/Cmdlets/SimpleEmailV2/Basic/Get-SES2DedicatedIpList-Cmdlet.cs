...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("Amazon.SimpleEmailV2.Model.DedicatedIp or Amazon.SimpleEmailV2.Model.GetDedicatedIpsResponse",
        ...
        "The service call response (type Amazon.SimpleEmailV2.Model.GetDedicatedIpsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
