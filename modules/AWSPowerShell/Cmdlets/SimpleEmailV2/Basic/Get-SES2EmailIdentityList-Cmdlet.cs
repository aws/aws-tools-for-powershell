...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    public partial class GetSES2EmailIdentityListCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A token returned from a previous call to <c>ListEmailIdentities</c> to indicate the
        /// position in the list of identities.</para>
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// <para>The number of results to show in a single call to <c>ListEmailIdentities</c>. If the
        ...
        /// results.</para><para>The value you specify has to be at least 0, and can be no more than 1000.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.SimpleEmailV2.Model.ListEmailIdentitiesResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.ListEmailIdentitiesRequest request)
        {
            ...
            try
            {
                return client.ListEmailIdentitiesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
