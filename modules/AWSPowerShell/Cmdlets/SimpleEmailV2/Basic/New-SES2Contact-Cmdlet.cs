...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("None or Amazon.SimpleEmailV2.Model.CreateContactResponse",
        ...
        "The service response (type Amazon.SimpleEmailV2.Model.CreateContactResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
