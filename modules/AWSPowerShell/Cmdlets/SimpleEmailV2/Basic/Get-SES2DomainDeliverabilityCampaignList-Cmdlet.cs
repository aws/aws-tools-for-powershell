...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("Amazon.SimpleEmailV2.Model.DomainDeliverabilityCampaign or Amazon.SimpleEmailV2.Model.ListDomainDeliverabilityCampaignsResponse",
        ...
        "The service call response (type Amazon.SimpleEmailV2.Model.ListDomainDeliverabilityCampaignsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
