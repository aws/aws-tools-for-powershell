...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    /// </summary>
    [Cmdlet("Write", "SES2DedicatedIpWarmupAttribute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteSES2DedicatedIpWarmupAttributeCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-SES2DedicatedIpWarmupAttribute (PutDedicatedIpWarmupAttributes)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmailV2.Model.PutDedicatedIpWarmupAttributesResponse, WriteSES2DedicatedIpWarmupAttributeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.PutDedicatedIpWarmupAttributesRequest();
        ...
        private Amazon.SimpleEmailV2.Model.PutDedicatedIpWarmupAttributesResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.PutDedicatedIpWarmupAttributesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service V2 (SES V2)", "PutDedicatedIpWarmupAttributes");
            try
            {
                return client.PutDedicatedIpWarmupAttributesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Ip { get; set; }
            public System.Int32? WarmupPercentage { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.PutDedicatedIpWarmupAttributesResponse, WriteSES2DedicatedIpWarmupAttributeCmdlet, object> Select { get; set; } =
