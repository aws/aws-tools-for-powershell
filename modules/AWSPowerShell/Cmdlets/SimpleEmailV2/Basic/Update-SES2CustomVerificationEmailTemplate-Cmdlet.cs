...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("None or Amazon.SimpleEmailV2.Model.UpdateCustomVerificationEmailTemplateResponse",
        ...
        "The service response (type Amazon.SimpleEmailV2.Model.UpdateCustomVerificationEmailTemplateResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
