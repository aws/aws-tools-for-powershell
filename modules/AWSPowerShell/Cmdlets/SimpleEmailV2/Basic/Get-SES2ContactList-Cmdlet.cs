...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    /// present in the list.
    /// </summary>
    [Cmdlet("Get", "SES2ContactList")]
    [OutputType("Amazon.SimpleEmailV2.Model.GetContactListResponse")]
    [AWSCmdlet("Calls the Amazon Simple Email Service V2 (SES V2) GetContactList API operation.", Operation = new[] {"GetContactList"}, SelectReturnType = typeof(Amazon.SimpleEmailV2.Model.GetContactListResponse))]
    [AWSCmdletOutput("Amazon.SimpleEmailV2.Model.GetContactListResponse",
        "This cmdlet returns an Amazon.SimpleEmailV2.Model.GetContactListResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSES2ContactListCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmailV2.Model.GetContactListResponse, GetSES2ContactListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.GetContactListRequest();
        ...
        private Amazon.SimpleEmailV2.Model.GetContactListResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.GetContactListRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service V2 (SES V2)", "GetContactList");
            try
            {
                #if DESKTOP
                return client.GetContactList(request);
                #elif CORECLR
                return client.GetContactListAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ContactListName { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.GetContactListResponse, GetSES2ContactListCmdlet, object> Select { get; set; } =
