...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    /// name.
    /// </summary>
    [Cmdlet("Remove", "SES2EmailIdentity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSES2EmailIdentityCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SES2EmailIdentity (DeleteEmailIdentity)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmailV2.Model.DeleteEmailIdentityResponse, RemoveSES2EmailIdentityCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.DeleteEmailIdentityRequest();
        ...
        private Amazon.SimpleEmailV2.Model.DeleteEmailIdentityResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.DeleteEmailIdentityRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service V2 (SES V2)", "DeleteEmailIdentity");
            try
            {
                return client.DeleteEmailIdentityAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String EmailIdentity { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.DeleteEmailIdentityResponse, RemoveSES2EmailIdentityCmdlet, object> Select { get; set; } =
