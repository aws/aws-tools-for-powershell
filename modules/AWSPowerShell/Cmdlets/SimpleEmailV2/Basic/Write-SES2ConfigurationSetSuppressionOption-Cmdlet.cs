...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("None or Amazon.SimpleEmailV2.Model.PutConfigurationSetSuppressionOptionsResponse",
        ...
        "The service response (type Amazon.SimpleEmailV2.Model.PutConfigurationSetSuppressionOptionsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
