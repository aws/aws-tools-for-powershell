...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("None or Amazon.SimpleEmailV2.Model.PutAccountDetailsResponse",
        ...
        "The service response (type Amazon.SimpleEmailV2.Model.PutAccountDetailsResponse) be returned by specifying '-Select *'."
    )]
    public partial class WriteSES2AccountDetailCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        /// Amazon Web Services Region.</para><para>If the value is <c>false</c>, then your account is in the <i>sandbox</i>. When your
        /// account is in the sandbox, you can only send email to verified identities. </para><para>If the value is <c>true</c>, then your account has production access. When your account
        /// has production access, you can send email to any address. The sending quota and maximum
        /// sending rate for your account vary based on your specific use case.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.SimpleEmailV2.Model.PutAccountDetailsResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.PutAccountDetailsRequest request)
        {
            ...
            try
            {
                return client.PutAccountDetailsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
