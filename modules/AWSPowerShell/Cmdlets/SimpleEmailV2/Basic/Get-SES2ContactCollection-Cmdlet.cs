...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    [AWSCmdletOutput("Amazon.SimpleEmailV2.Model.Contact or Amazon.SimpleEmailV2.Model.ListContactsResponse",
        ...
        "The service call response (type Amazon.SimpleEmailV2.Model.ListContactsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
