...
namespace Amazon.PowerShell.Cmdlets.SES2
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Update", "SES2EmailIdentityPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Simple Email Service V2 (SES V2) UpdateEmailIdentityPolicy API operation.", Operation = new[] {"UpdateEmailIdentityPolicy"}, SelectReturnType = typeof(Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse))]
    [AWSCmdletOutput("None or Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSES2EmailIdentityPolicyCmdlet : AmazonSimpleEmailServiceV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SES2EmailIdentityPolicy (UpdateEmailIdentityPolicy)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse, UpdateSES2EmailIdentityPolicyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyRequest();
        ...
        private Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse CallAWSServiceOperation(IAmazonSimpleEmailServiceV2 client, Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service V2 (SES V2)", "UpdateEmailIdentityPolicy");
            try
            {
                #if DESKTOP
                return client.UpdateEmailIdentityPolicy(request);
                #elif CORECLR
                return client.UpdateEmailIdentityPolicyAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Policy { get; set; }
            public System.String PolicyName { get; set; }
            public System.Func<Amazon.SimpleEmailV2.Model.UpdateEmailIdentityPolicyResponse, UpdateSES2EmailIdentityPolicyCmdlet, object> Select { get; set; } =
