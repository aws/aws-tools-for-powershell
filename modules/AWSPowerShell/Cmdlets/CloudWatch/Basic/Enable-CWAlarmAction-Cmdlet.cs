...
namespace Amazon.PowerShell.Cmdlets.CW
{
    ...
    public partial class EnableCWAlarmActionCmdlet : AmazonCloudWatchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the alarms.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatch.Model.EnableAlarmActionsResponse, EnableCWAlarmActionCmdlet>(Select) ??
        ...
        private Amazon.CloudWatch.Model.EnableAlarmActionsResponse CallAWSServiceOperation(IAmazonCloudWatch client, Amazon.CloudWatch.Model.EnableAlarmActionsRequest request)
        {
            ...
            try
            {
                return client.EnableAlarmActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudWatch.Model.EnableAlarmActionsResponse, EnableCWAlarmActionCmdlet, object> Select { get; set; } =
