...
namespace Amazon.PowerShell.Cmdlets.CW
{
    ...
    public partial class WriteCWAlarmMuteRuleCmdlet : AmazonCloudWatchClientCmdlet, IExecutor
    {
        ...
        /// match existing alarms in your Amazon Web Services account and region.</para>
        /// </para>
        /// </summary>
        ...
        /// to categorize and manage your mute rules.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Tags")]
        ...
        private Amazon.CloudWatch.Model.PutAlarmMuteRuleResponse CallAWSServiceOperation(IAmazonCloudWatch client, Amazon.CloudWatch.Model.PutAlarmMuteRuleRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.PutAlarmMuteRule(request);
                #elif CORECLR
                return client.PutAlarmMuteRuleAsync(request).GetAwaiter().GetResult();
                #else
