...
namespace Amazon.PowerShell.Cmdlets.CW
{
    ...
    public partial class WriteCWDashboardCmdlet : AmazonCloudWatchClientCmdlet, IExecutor
    {
        ...
        /// to include and their location on the dashboard. This parameter is required.</para><para>For more information about the syntax, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Dashboard-Body-Structure.html">Dashboard
        ...
        /// <summary>
        /// <para>
        /// <para>A list of key-value pairs to associate with the dashboard. You can associate as many
        /// as 50 tags with a dashboard.</para><para>Tags can help you organize and categorize your dashboards. You can also use them to
        /// scope user permissions by granting a user permission to access or change only dashboards
        /// with certain tag values.</para><para>You can use this parameter only when creating a new dashboard. If you specify <c>Tags</c>
        ...
        /// To remove tags, use <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_UntagResource.html">UntagResource</a>.</para><para />
        ...
        private Amazon.CloudWatch.Model.PutDashboardResponse CallAWSServiceOperation(IAmazonCloudWatch client, Amazon.CloudWatch.Model.PutDashboardRequest request)
        {
            ...
            try
            {
                return client.PutDashboardAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
