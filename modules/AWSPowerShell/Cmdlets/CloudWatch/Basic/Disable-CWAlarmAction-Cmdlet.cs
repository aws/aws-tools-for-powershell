...
namespace Amazon.PowerShell.Cmdlets.CW
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon CloudWatch DisableAlarmActions API operation.", Operation = new[] {"DisableAlarmActions"}, SelectReturnType = typeof(Amazon.CloudWatch.Model.DisableAlarmActionsResponse))]
    [AWSCmdletOutput("None or Amazon.CloudWatch.Model.DisableAlarmActionsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.CloudWatch.Model.DisableAlarmActionsResponse) be returned by specifying '-Select *'."
    )]
    public partial class DisableCWAlarmActionCmdlet : AmazonCloudWatchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatch.Model.DisableAlarmActionsResponse, DisableCWAlarmActionCmdlet>(Select) ??
        ...
        private Amazon.CloudWatch.Model.DisableAlarmActionsResponse CallAWSServiceOperation(IAmazonCloudWatch client, Amazon.CloudWatch.Model.DisableAlarmActionsRequest request)
        {
            ...
            try
            {
                return client.DisableAlarmActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CloudWatch.Model.DisableAlarmActionsResponse, DisableCWAlarmActionCmdlet, object> Select { get; set; } =
