...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Logs StopQuery API operation.", Operation = new[] {"StopQuery"})]
    ...
    public partial class StopCWLQueryCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("QueryId", MyInvocation.BoundParameters);
