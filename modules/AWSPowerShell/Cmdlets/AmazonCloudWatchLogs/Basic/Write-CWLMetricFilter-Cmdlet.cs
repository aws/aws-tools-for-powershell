...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Logs PutMetricFilter API operation.", Operation = new[] {"PutMetricFilter"})]
    ...
    public partial class WriteCWLMetricFilterCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.MetricTransformations != null)
            {
                request.MetricTransformations = cmdletContext.MetricTransformations;
            }
