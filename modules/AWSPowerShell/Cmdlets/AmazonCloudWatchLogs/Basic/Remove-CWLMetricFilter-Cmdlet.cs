...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Invokes the DeleteMetricFilter operation against Amazon CloudWatch Logs.", Operation = new[] {"DeleteMetricFilter"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteMetricFilterResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveCWLMetricFilterCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteMetricFilter(request);
