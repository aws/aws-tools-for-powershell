...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    [AWSCmdlet("Invokes the DescribeMetricFilters operation against Amazon CloudWatch Logs.", Operation = new[] {"DescribeMetricFilters"}, LegacyAlias="Get-CWLMetricFilters")]
