...
namespace Amazon.PowerShell.Cmdlets.CWL
{
    ...
    public partial class GetCWLResourcePolicyCmdlet : AmazonCloudWatchLogsClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ResourcePolicies;
        ...
        private Amazon.CloudWatchLogs.Model.DescribeResourcePoliciesResponse CallAWSServiceOperation(IAmazonCloudWatchLogs client, Amazon.CloudWatchLogs.Model.DescribeResourcePoliciesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeResourcePoliciesAsync(request);
                return task.Result;
                #else
