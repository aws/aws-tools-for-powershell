...
namespace Amazon.PowerShell.Cmdlets.LLMS
{
    ...
    /// the returned results will include data aggregated across your accounts in Organizations.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetLLMSLinuxSubscriptionListCmdlet : AmazonLicenseManagerLinuxSubscriptionsClientCmdlet, IExecutor
    {
        ...
        private Amazon.LicenseManagerLinuxSubscriptions.Model.ListLinuxSubscriptionsResponse CallAWSServiceOperation(IAmazonLicenseManagerLinuxSubscriptions client, Amazon.LicenseManagerLinuxSubscriptions.Model.ListLinuxSubscriptionsRequest request)
        {
            ...
            try
            {
                return client.ListLinuxSubscriptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
