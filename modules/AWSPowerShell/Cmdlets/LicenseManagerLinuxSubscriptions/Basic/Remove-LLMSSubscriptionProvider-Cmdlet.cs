...
namespace Amazon.PowerShell.Cmdlets.LLMS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "LLMSSubscriptionProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveLLMSSubscriptionProviderCmdlet : AmazonLicenseManagerLinuxSubscriptionsClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SubscriptionProviderArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SubscriptionProviderArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-LLMSSubscriptionProvider (DeregisterSubscriptionProvider)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LicenseManagerLinuxSubscriptions.Model.DeregisterSubscriptionProviderResponse, RemoveLLMSSubscriptionProviderCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SubscriptionProviderArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LicenseManagerLinuxSubscriptions.Model.DeregisterSubscriptionProviderRequest();
        ...
        private Amazon.LicenseManagerLinuxSubscriptions.Model.DeregisterSubscriptionProviderResponse CallAWSServiceOperation(IAmazonLicenseManagerLinuxSubscriptions client, Amazon.LicenseManagerLinuxSubscriptions.Model.DeregisterSubscriptionProviderRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS License Manager - Linux Subscriptions", "DeregisterSubscriptionProvider");
            try
            {
                #if DESKTOP
                return client.DeregisterSubscriptionProvider(request);
                #elif CORECLR
                return client.DeregisterSubscriptionProviderAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SubscriptionProviderArn { get; set; }
            public System.Func<Amazon.LicenseManagerLinuxSubscriptions.Model.DeregisterSubscriptionProviderResponse, RemoveLLMSSubscriptionProviderCmdlet, object> Select { get; set; } =
