...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    public partial class GetFSXS3AccessPointAttachmentCmdlet : AmazonFSxClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Enter a filter Name and Values pair to view a select set of S3 access point attachments.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The names of the S3 access point attachments whose descriptions you want to retrieve.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.FSx.Model.DescribeS3AccessPointAttachmentsResponse CallAWSServiceOperation(IAmazonFSx client, Amazon.FSx.Model.DescribeS3AccessPointAttachmentsRequest request)
        {
            ...
            try
            {
                return client.DescribeS3AccessPointAttachmentsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
