...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    [AWSCmdletOutput("Amazon.FSx.Model.StorageVirtualMachine or Amazon.FSx.Model.DescribeStorageVirtualMachinesResponse",
        ...
        "The service call response (type Amazon.FSx.Model.DescribeStorageVirtualMachinesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFSXStorageVirtualMachineCmdlet : AmazonFSxClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Enter a filter name:value pair to view a select set of SVMs.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>Enter the ID of one or more SVMs that you want to view.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.FSx.Model.DescribeStorageVirtualMachinesResponse CallAWSServiceOperation(IAmazonFSx client, Amazon.FSx.Model.DescribeStorageVirtualMachinesRequest request)
        {
            ...
            try
            {
                return client.DescribeStorageVirtualMachinesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
