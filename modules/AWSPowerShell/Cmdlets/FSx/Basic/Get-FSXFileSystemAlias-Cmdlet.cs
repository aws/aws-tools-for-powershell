...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    [AWSCmdletOutput("Amazon.FSx.Model.Alias or Amazon.FSx.Model.DescribeFileSystemAliasesResponse",
        ...
        "The service call response (type Amazon.FSx.Model.DescribeFileSystemAliasesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
