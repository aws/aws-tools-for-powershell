...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    public partial class UpdateFSXFileSystemCmdlet : AmazonFSxClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The configuration update for this Microsoft Windows file system. The only supported
        /// options are for backup and maintenance and for self-managed Active Directory configuration.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
