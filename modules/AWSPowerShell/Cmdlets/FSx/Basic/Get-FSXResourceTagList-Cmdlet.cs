...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    [AWSCmdlet("Calls the Amazon FSx ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.FSx.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.FSx.Model.Tag or Amazon.FSx.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.FSx.Model.Tag objects.",
        "The service call response (type Amazon.FSx.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetFSXResourceTagListCmdlet : AmazonFSxClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Opaque pagination token returned from a previous <c>ListTagsForResource</c> operation
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.FSx.Model.ListTagsForResourceResponse, GetFSXResourceTagListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.FSx.Model.ListTagsForResourceResponse, GetFSXResourceTagListCmdlet, object> Select { get; set; } =
