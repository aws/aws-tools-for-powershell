#
# Module manifest for module 'AWS.Tools.SecurityIR'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SecurityIR.dll'
    ...
    GUID = '718af742-d7fd-4a20-bf18-b63116fe60fd'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SecurityIR.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SecurityIR.Completers.psm1',
        'AWS.Tools.SecurityIR.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'Get-SecurityIRGetMemberAccountDetail', 
    ...
    FileList = @(
        'AWS.Tools.SecurityIR.dll-Help.xml'
    )
