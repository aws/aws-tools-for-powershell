...
namespace Amazon.PowerShell.Cmdlets.SecurityIR
{
    ...
    [AWSCmdlet("Calls the Security Incident Response UpdateResolverType API operation.", Operation = new[] {"UpdateResolverType"}, SelectReturnType = typeof(Amazon.SecurityIR.Model.UpdateResolverTypeResponse))]
    [AWSCmdletOutput("Amazon.SecurityIR.Model.UpdateResolverTypeResponse",
        "This cmdlet returns an Amazon.SecurityIR.Model.UpdateResolverTypeResponse object containing multiple properties."
    )]
    public partial class UpdateSecurityIRResolverTypeCmdlet : AmazonSecurityIRClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Required element for UpdateResolverType to identify the case to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>Required element for UpdateResolverType to identify the new resolver.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.SecurityIR.Model.UpdateResolverTypeResponse).
        /// Specifying the name of a property of type Amazon.SecurityIR.Model.UpdateResolverTypeResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-SecurityIRResolverType (UpdateResolverType)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SecurityIR.Model.UpdateResolverTypeResponse, UpdateSecurityIRResolverTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SecurityIR.Model.UpdateResolverTypeRequest();
        ...
        private Amazon.SecurityIR.Model.UpdateResolverTypeResponse CallAWSServiceOperation(IAmazonSecurityIR client, Amazon.SecurityIR.Model.UpdateResolverTypeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Security Incident Response", "UpdateResolverType");
            try
            {
                #if DESKTOP
                return client.UpdateResolverType(request);
                #elif CORECLR
                return client.UpdateResolverTypeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String CaseId { get; set; }
            public Amazon.SecurityIR.ResolverType ResolverType { get; set; }
            public System.Func<Amazon.SecurityIR.Model.UpdateResolverTypeResponse, UpdateSecurityIRResolverTypeCmdlet, object> Select { get; set; } =
