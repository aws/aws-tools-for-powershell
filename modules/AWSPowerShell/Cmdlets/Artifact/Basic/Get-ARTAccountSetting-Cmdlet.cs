...
namespace Amazon.PowerShell.Cmdlets.ART
{
    ...
    public partial class GetARTAccountSettingCmdlet : AmazonArtifactClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Artifact.Model.GetAccountSettingsResponse, GetARTAccountSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Artifact.Model.GetAccountSettingsRequest();
        ...
        private Amazon.Artifact.Model.GetAccountSettingsResponse CallAWSServiceOperation(IAmazonArtifact client, Amazon.Artifact.Model.GetAccountSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Artifact", "GetAccountSettings");
            try
            {
        ...
        {
            public System.Func<Amazon.Artifact.Model.GetAccountSettingsResponse, GetARTAccountSettingCmdlet, object> Select { get; set; } =
