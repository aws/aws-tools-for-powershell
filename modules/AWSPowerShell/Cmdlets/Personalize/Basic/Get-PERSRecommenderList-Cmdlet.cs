...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </summary>
    [Cmdlet("Get", "PERSRecommenderList")]
    [OutputType("Amazon.Personalize.Model.RecommenderSummary")]
    [AWSCmdlet("Calls the AWS Personalize ListRecommenders API operation.", Operation = new[] {"ListRecommenders"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListRecommendersResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.RecommenderSummary or Amazon.Personalize.Model.ListRecommendersResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.RecommenderSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListRecommendersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSRecommenderListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A token returned from the previous call to <code>ListRecommenders</code> for getting
        /// the next set of recommenders (if they exist).</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListRecommendersResponse, GetPERSRecommenderListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListRecommendersRequest();
        ...
        private Amazon.Personalize.Model.ListRecommendersResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListRecommendersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListRecommenders");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Personalize.Model.ListRecommendersResponse, GetPERSRecommenderListCmdlet, object> Select { get; set; } =
