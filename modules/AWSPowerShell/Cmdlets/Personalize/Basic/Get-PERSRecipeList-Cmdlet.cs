...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </summary>
    [Cmdlet("Get", "PERSRecipeList")]
    [OutputType("Amazon.Personalize.Model.RecipeSummary")]
    [AWSCmdlet("Calls the AWS Personalize ListRecipes API operation.", Operation = new[] {"ListRecipes"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListRecipesResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.RecipeSummary or Amazon.Personalize.Model.ListRecipesResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.RecipeSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListRecipesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSRecipeListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        [AWSConstantClassSource("Amazon.Personalize.RecipeProvider")]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RecipeProvider parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RecipeProvider' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RecipeProvider' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListRecipesResponse, GetPERSRecipeListCmdlet>(Select) ??
            ...
            context.RecipeProvider = this.RecipeProvider;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Recipes.Count;
        ...
        private Amazon.Personalize.Model.ListRecipesResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListRecipesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListRecipes");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.Personalize.RecipeProvider RecipeProvider { get; set; }
            public System.Func<Amazon.Personalize.Model.ListRecipesResponse, GetPERSRecipeListCmdlet, object> Select { get; set; } =
