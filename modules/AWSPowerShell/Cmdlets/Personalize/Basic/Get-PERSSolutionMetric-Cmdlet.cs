...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    public partial class GetPERSSolutionMetricCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the SolutionVersionArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^SolutionVersionArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SolutionVersionArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.GetSolutionMetricsResponse, GetPERSSolutionMetricCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SolutionVersionArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.GetSolutionMetricsRequest();
        ...
        private Amazon.Personalize.Model.GetSolutionMetricsResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.GetSolutionMetricsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "GetSolutionMetrics");
            try
            {
                #if DESKTOP
                return client.GetSolutionMetrics(request);
                #elif CORECLR
                return client.GetSolutionMetricsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SolutionVersionArn { get; set; }
            public System.Func<Amazon.Personalize.Model.GetSolutionMetricsResponse, GetPERSSolutionMetricCmdlet, object> Select { get; set; } =
