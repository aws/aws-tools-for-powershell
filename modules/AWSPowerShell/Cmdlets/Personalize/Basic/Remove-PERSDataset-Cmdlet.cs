...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Personalize DeleteDataset API operation.", Operation = new[] {"DeleteDataset"}, SelectReturnType = typeof(Amazon.Personalize.Model.DeleteDatasetResponse))]
    [AWSCmdletOutput("None or Amazon.Personalize.Model.DeleteDatasetResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Personalize.Model.DeleteDatasetResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePERSDatasetCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSDataset (DeleteDataset)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteDatasetResponse, RemovePERSDatasetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteDatasetRequest();
        ...
        private Amazon.Personalize.Model.DeleteDatasetResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteDatasetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteDataset");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DatasetArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteDatasetResponse, RemovePERSDatasetCmdlet, object> Select { get; set; } =
