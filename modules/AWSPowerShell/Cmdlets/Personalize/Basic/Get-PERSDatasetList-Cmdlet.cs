...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// information on datasets, see <a>CreateDataset</a>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "PERSDatasetList")]
    [OutputType("Amazon.Personalize.Model.DatasetSummary")]
    [AWSCmdlet("Calls the AWS Personalize ListDatasets API operation.", Operation = new[] {"ListDatasets"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListDatasetsResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.DatasetSummary or Amazon.Personalize.Model.ListDatasetsResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.DatasetSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListDatasetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSDatasetListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListDatasetsResponse, GetPERSDatasetListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListDatasetsRequest();
        ...
        private Amazon.Personalize.Model.ListDatasetsResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListDatasetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListDatasets");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Personalize.Model.ListDatasetsResponse, GetPERSDatasetListCmdlet, object> Select { get; set; } =
