...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    public partial class NewPERSFilterCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        /// to apply to the filter.</para><para />
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FilterArn";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-PERSFilter (CreateFilter)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.CreateFilterResponse, NewPERSFilterCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.FilterExpression == null && ParameterWasBound(nameof(this.FilterExpression)))
            {
                WriteWarning("You are passing $null as a value for parameter FilterExpression which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.CreateFilterRequest();
        ...
        private Amazon.Personalize.Model.CreateFilterResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.CreateFilterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "CreateFilter");
            try
            {
