...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// Deletes a filter.
    /// </summary>
    [Cmdlet("Remove", "PERSFilter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Personalize DeleteFilter API operation.", Operation = new[] {"DeleteFilter"}, SelectReturnType = typeof(Amazon.Personalize.Model.DeleteFilterResponse))]
    [AWSCmdletOutput("None or Amazon.Personalize.Model.DeleteFilterResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Personalize.Model.DeleteFilterResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePERSFilterCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSFilter (DeleteFilter)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteFilterResponse, RemovePERSFilterCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteFilterRequest();
        ...
        private Amazon.Personalize.Model.DeleteFilterResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteFilterRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteFilter");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String FilterArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteFilterResponse, RemovePERSFilterCmdlet, object> Select { get; set; } =
