...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </summary>
    [Cmdlet("Get", "PERSDatasetImportJobList")]
    [OutputType("Amazon.Personalize.Model.DatasetImportJobSummary")]
    [AWSCmdlet("Calls the AWS Personalize ListDatasetImportJobs API operation.", Operation = new[] {"ListDatasetImportJobs"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListDatasetImportJobsResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.DatasetImportJobSummary or Amazon.Personalize.Model.ListDatasetImportJobsResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.DatasetImportJobSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListDatasetImportJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSDatasetImportJobListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DatasetImportJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListDatasetImportJobsResponse, GetPERSDatasetImportJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListDatasetImportJobsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.DatasetImportJobs?.Count ?? 0;
        ...
        private Amazon.Personalize.Model.ListDatasetImportJobsResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListDatasetImportJobsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Personalize.Model.ListDatasetImportJobsResponse, GetPERSDatasetImportJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DatasetImportJobs;
        }
