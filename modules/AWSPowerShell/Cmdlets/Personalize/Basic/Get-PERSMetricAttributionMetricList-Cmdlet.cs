...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    [AWSCmdletOutput("Amazon.Personalize.Model.MetricAttribute or Amazon.Personalize.Model.ListMetricAttributionMetricsResponse",
        ...
        "The service call response (type Amazon.Personalize.Model.ListMetricAttributionMetricsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
