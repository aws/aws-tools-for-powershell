...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </para></li></ul>
    /// </summary>
    [Cmdlet("Remove", "PERSDatasetGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePERSDatasetGroupCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSDatasetGroup (DeleteDatasetGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteDatasetGroupResponse, RemovePERSDatasetGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteDatasetGroupRequest();
        ...
        private Amazon.Personalize.Model.DeleteDatasetGroupResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteDatasetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteDatasetGroup");
            try
            {
                return client.DeleteDatasetGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DatasetGroupArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteDatasetGroupResponse, RemovePERSDatasetGroupCmdlet, object> Select { get; set; } =
