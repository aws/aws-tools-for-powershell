...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PERSMetricAttribution", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePERSMetricAttributionCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSMetricAttribution (DeleteMetricAttribution)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteMetricAttributionResponse, RemovePERSMetricAttributionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteMetricAttributionRequest();
        ...
        private Amazon.Personalize.Model.DeleteMetricAttributionResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteMetricAttributionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteMetricAttribution");
            try
            {
                #if DESKTOP
                return client.DeleteMetricAttribution(request);
                #elif CORECLR
                return client.DeleteMetricAttributionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String MetricAttributionArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteMetricAttributionResponse, RemovePERSMetricAttributionCmdlet, object> Select { get; set; } =
