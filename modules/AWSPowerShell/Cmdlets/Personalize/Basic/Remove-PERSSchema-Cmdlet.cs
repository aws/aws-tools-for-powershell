...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Personalize DeleteSchema API operation.", Operation = new[] {"DeleteSchema"}, SelectReturnType = typeof(Amazon.Personalize.Model.DeleteSchemaResponse))]
    [AWSCmdletOutput("None or Amazon.Personalize.Model.DeleteSchemaResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Personalize.Model.DeleteSchemaResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemovePERSSchemaCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSSchema (DeleteSchema)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteSchemaResponse, RemovePERSSchemaCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteSchemaRequest();
        ...
        private Amazon.Personalize.Model.DeleteSchemaResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteSchemaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteSchema");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SchemaArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteSchemaResponse, RemovePERSSchemaCmdlet, object> Select { get; set; } =
