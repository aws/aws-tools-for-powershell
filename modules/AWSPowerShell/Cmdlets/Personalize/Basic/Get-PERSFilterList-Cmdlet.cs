...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </summary>
    [Cmdlet("Get", "PERSFilterList")]
    [OutputType("Amazon.Personalize.Model.FilterSummary")]
    [AWSCmdlet("Calls the AWS Personalize ListFilters API operation.", Operation = new[] {"ListFilters"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListFiltersResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.FilterSummary or Amazon.Personalize.Model.ListFiltersResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.FilterSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListFiltersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSFilterListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A token returned from the previous call to <code>ListFilters</code> for getting the
        /// next set of filters (if they exist).</para>
        /// </para>
        /// <para>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListFiltersResponse, GetPERSFilterListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListFiltersRequest();
        ...
        private Amazon.Personalize.Model.ListFiltersResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListFiltersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListFilters");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Personalize.Model.ListFiltersResponse, GetPERSFilterListCmdlet, object> Select { get; set; } =
