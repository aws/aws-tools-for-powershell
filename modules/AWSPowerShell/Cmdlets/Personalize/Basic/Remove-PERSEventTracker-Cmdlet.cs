...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    public partial class RemovePERSEventTrackerCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.EventTrackerArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PERSEventTracker (DeleteEventTracker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DeleteEventTrackerResponse, RemovePERSEventTrackerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DeleteEventTrackerRequest();
        ...
        private Amazon.Personalize.Model.DeleteEventTrackerResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DeleteEventTrackerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "DeleteEventTracker");
            try
            {
                #if DESKTOP
                return client.DeleteEventTracker(request);
                #elif CORECLR
                return client.DeleteEventTrackerAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EventTrackerArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DeleteEventTrackerResponse, RemovePERSEventTrackerCmdlet, object> Select { get; set; } =
