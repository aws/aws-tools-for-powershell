...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    [AWSCmdlet("Calls the AWS Personalize ListSchemas API operation.", Operation = new[] {"ListSchemas"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListSchemasResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.DatasetSchemaSummary or Amazon.Personalize.Model.ListSchemasResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.DatasetSchemaSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListSchemasResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSSchemaListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListSchemasResponse, GetPERSSchemaListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListSchemasRequest();
        ...
        private Amazon.Personalize.Model.ListSchemasResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListSchemasRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListSchemas");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Personalize.Model.ListSchemasResponse, GetPERSSchemaListCmdlet, object> Select { get; set; } =
