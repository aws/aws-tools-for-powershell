...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    [AWSCmdlet("Calls the AWS Personalize ListCampaigns API operation.", Operation = new[] {"ListCampaigns"}, SelectReturnType = typeof(Amazon.Personalize.Model.ListCampaignsResponse))]
    [AWSCmdletOutput("Amazon.Personalize.Model.CampaignSummary or Amazon.Personalize.Model.ListCampaignsResponse",
        "This cmdlet returns a collection of Amazon.Personalize.Model.CampaignSummary objects.",
        "The service call response (type Amazon.Personalize.Model.ListCampaignsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPERSCampaignListCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.ListCampaignsResponse, GetPERSCampaignListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Personalize.Model.ListCampaignsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Campaigns?.Count ?? 0;
        ...
        private Amazon.Personalize.Model.ListCampaignsResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.ListCampaignsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Personalize", "ListCampaigns");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SolutionArn { get; set; }
            public System.Func<Amazon.Personalize.Model.ListCampaignsResponse, GetPERSCampaignListCmdlet, object> Select { get; set; } =
