...
namespace Amazon.PowerShell.Cmdlets.PERS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "PERSRecommender")]
    [OutputType("Amazon.Personalize.Model.Recommender")]
    ...
    public partial class GetPERSRecommenderCmdlet : AmazonPersonalizeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Personalize.Model.DescribeRecommenderResponse, GetPERSRecommenderCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Personalize.Model.DescribeRecommenderRequest();
        ...
        private Amazon.Personalize.Model.DescribeRecommenderResponse CallAWSServiceOperation(IAmazonPersonalize client, Amazon.Personalize.Model.DescribeRecommenderRequest request)
        {
        ...
        {
            public System.String RecommenderArn { get; set; }
            public System.Func<Amazon.Personalize.Model.DescribeRecommenderResponse, GetPERSRecommenderCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Recommender;
        }
