...
namespace Amazon.PowerShell.Cmdlets.R53D
{
    ...
    [AWSCmdlet("Invokes the GetOperationDetail operation against Amazon Route 53 Domains.", Operation = new[] {"GetOperationDetail"})]
    ...
    public partial class GetR53DOperationDetailCmdlet : AmazonRoute53DomainsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Route53Domains.Model.GetOperationDetailResponse CallAWSServiceOperation(IAmazonRoute53Domains client, Amazon.Route53Domains.Model.GetOperationDetailRequest request)
        {
            #if DESKTOP
            return client.GetOperationDetail(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetOperationDetailAsync(request);
            return task.Result;
            #else
