...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Events ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.CloudWatchEvents.Model.Tag",
