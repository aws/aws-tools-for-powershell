...
namespace Amazon.PowerShell.Cmdlets.PCS
{
    ...
    public partial class NewPCSComputeNodeGroupCmdlet : AmazonPCSClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para> The ID of the Amazon Machine Image (AMI) that PCS uses to launch compute nodes (Amazon
        /// EC2 instances). If you don't provide this value, PCS uses the AMI ID specified in
        /// the custom launch template.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>A list of EC2 instance configurations that PCS can provision in the compute node group.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ComputeNodeGroupName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ComputeNodeGroupName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ComputeNodeGroupName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ComputeNodeGroupName;
            }
        ...
        private Amazon.PCS.Model.CreateComputeNodeGroupResponse CallAWSServiceOperation(IAmazonPCS client, Amazon.PCS.Model.CreateComputeNodeGroupRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateComputeNodeGroup(request);
                #elif CORECLR
                return client.CreateComputeNodeGroupAsync(request).GetAwaiter().GetResult();
                #else
