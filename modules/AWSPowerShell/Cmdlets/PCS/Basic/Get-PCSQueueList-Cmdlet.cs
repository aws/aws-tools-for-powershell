...
{
    /// <summary>
    /// Returns a list of all queues associated with a cluster.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.PCS.Model.QueueSummary or Amazon.PCS.Model.ListQueuesResponse",
        ...
        "The service call response (type Amazon.PCS.Model.ListQueuesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetPCSQueueListCmdlet : AmazonPCSClientCmdlet, IExecutor
    {
        ...
        private Amazon.PCS.Model.ListQueuesResponse CallAWSServiceOperation(IAmazonPCS client, Amazon.PCS.Model.ListQueuesRequest request)
        {
            ...
            try
            {
                return client.ListQueuesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
