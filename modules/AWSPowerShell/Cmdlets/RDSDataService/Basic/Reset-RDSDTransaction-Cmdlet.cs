...
namespace Amazon.PowerShell.Cmdlets.RDSD
{
    ...
    /// </summary>
    [Cmdlet("Reset", "RDSDTransaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class ResetRDSDTransactionCmdlet : AmazonRDSDataServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Reset-RDSDTransaction (RollbackTransaction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDSDataService.Model.RollbackTransactionResponse, ResetRDSDTransactionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDSDataService.Model.RollbackTransactionRequest();
        ...
        private Amazon.RDSDataService.Model.RollbackTransactionResponse CallAWSServiceOperation(IAmazonRDSDataService client, Amazon.RDSDataService.Model.RollbackTransactionRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SecretArn { get; set; }
            public System.String TransactionId { get; set; }
            public System.Func<Amazon.RDSDataService.Model.RollbackTransactionResponse, ResetRDSDTransactionCmdlet, object> Select { get; set; } =
