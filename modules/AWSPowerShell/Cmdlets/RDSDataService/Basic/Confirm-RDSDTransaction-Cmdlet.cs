...
namespace Amazon.PowerShell.Cmdlets.RDSD
{
    ...
    public partial class ConfirmRDSDTransactionCmdlet : AmazonRDSDataServiceClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "TransactionStatus";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Confirm-RDSDTransaction (CommitTransaction)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RDSDataService.Model.CommitTransactionResponse, ConfirmRDSDTransactionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RDSDataService.Model.CommitTransactionRequest();
        ...
        private Amazon.RDSDataService.Model.CommitTransactionResponse CallAWSServiceOperation(IAmazonRDSDataService client, Amazon.RDSDataService.Model.CommitTransactionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS RDS DataService", "CommitTransaction");
            try
            {
                #if DESKTOP
                return client.CommitTransaction(request);
                #elif CORECLR
                return client.CommitTransactionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SecretArn { get; set; }
            public System.String TransactionId { get; set; }
            public System.Func<Amazon.RDSDataService.Model.CommitTransactionResponse, ConfirmRDSDTransactionCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.TransactionStatus;
        }
