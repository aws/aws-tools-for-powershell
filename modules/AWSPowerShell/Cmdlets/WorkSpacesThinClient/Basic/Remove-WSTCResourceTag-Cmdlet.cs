...
namespace Amazon.PowerShell.Cmdlets.WSTC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSTCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSTCResourceTagCmdlet : AmazonWorkSpacesThinClientClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSTCResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesThinClient.Model.UntagResourceResponse, RemoveWSTCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesThinClient.Model.UntagResourceRequest();
        ...
        private Amazon.WorkSpacesThinClient.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonWorkSpacesThinClient client, Amazon.WorkSpacesThinClient.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Thin Client", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkSpacesThinClient.Model.UntagResourceResponse, RemoveWSTCResourceTagCmdlet, object> Select { get; set; } =
