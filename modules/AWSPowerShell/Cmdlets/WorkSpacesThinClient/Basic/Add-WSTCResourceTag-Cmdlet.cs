...
namespace Amazon.PowerShell.Cmdlets.WSTC
{
    ...
    /// </summary>
    [Cmdlet("Add", "WSTCResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class AddWSTCResourceTagCmdlet : AmazonWorkSpacesThinClientClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WSTCResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesThinClient.Model.TagResourceResponse, AddWSTCResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesThinClient.Model.TagResourceRequest();
        ...
        private Amazon.WorkSpacesThinClient.Model.TagResourceResponse CallAWSServiceOperation(IAmazonWorkSpacesThinClient client, Amazon.WorkSpacesThinClient.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Thin Client", "TagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.WorkSpacesThinClient.Model.TagResourceResponse, AddWSTCResourceTagCmdlet, object> Select { get; set; } =
