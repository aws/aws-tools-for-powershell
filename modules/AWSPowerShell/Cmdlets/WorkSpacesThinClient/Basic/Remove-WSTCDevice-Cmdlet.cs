...
namespace Amazon.PowerShell.Cmdlets.WSTC
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WSTCDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWSTCDeviceCmdlet : AmazonWorkSpacesThinClientClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WSTCDevice (DeleteDevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesThinClient.Model.DeleteDeviceResponse, RemoveWSTCDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesThinClient.Model.DeleteDeviceRequest();
        ...
        private Amazon.WorkSpacesThinClient.Model.DeleteDeviceResponse CallAWSServiceOperation(IAmazonWorkSpacesThinClient client, Amazon.WorkSpacesThinClient.Model.DeleteDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Thin Client", "DeleteDevice");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ClientToken { get; set; }
            public System.String Id { get; set; }
            public System.Func<Amazon.WorkSpacesThinClient.Model.DeleteDeviceResponse, RemoveWSTCDeviceCmdlet, object> Select { get; set; } =
