...
namespace Amazon.PowerShell.Cmdlets.WSTC
{
    ...
    /// </summary>
    [Cmdlet("Get", "WSTCDevice")]
    [OutputType("Amazon.WorkSpacesThinClient.Model.Device")]
    ...
    public partial class GetWSTCDeviceCmdlet : AmazonWorkSpacesThinClientClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WorkSpacesThinClient.Model.GetDeviceResponse, GetWSTCDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WorkSpacesThinClient.Model.GetDeviceRequest();
        ...
        private Amazon.WorkSpacesThinClient.Model.GetDeviceResponse CallAWSServiceOperation(IAmazonWorkSpacesThinClient client, Amazon.WorkSpacesThinClient.Model.GetDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon WorkSpaces Thin Client", "GetDevice");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Id { get; set; }
            public System.Func<Amazon.WorkSpacesThinClient.Model.GetDeviceResponse, GetWSTCDeviceCmdlet, object> Select { get; set; } =
