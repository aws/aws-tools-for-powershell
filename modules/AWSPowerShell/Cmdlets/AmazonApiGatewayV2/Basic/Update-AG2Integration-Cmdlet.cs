...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdateIntegration API operation.", Operation = new[] {"UpdateIntegration"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdateIntegrationResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.UpdateIntegrationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAG2IntegrationCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("IntegrationId", MyInvocation.BoundParameters);
