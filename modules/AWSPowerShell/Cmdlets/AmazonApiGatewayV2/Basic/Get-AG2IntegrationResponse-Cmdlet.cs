...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetIntegrationResponse API operation.", Operation = new[] {"GetIntegrationResponse"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.GetIntegrationResponseResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.GetIntegrationResponseResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2IntegrationResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.GetIntegrationResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetIntegrationResponseRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetIntegrationResponseAsync(request);
                return task.Result;
                #else
