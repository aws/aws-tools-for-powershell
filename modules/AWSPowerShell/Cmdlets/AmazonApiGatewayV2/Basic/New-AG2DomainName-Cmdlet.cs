...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 CreateDomainName API operation.", Operation = new[] {"CreateDomainName"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.CreateDomainNameResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.CreateDomainNameResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
