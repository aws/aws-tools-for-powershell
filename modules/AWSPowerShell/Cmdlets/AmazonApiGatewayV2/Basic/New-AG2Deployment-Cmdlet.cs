...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 CreateDeployment API operation.", Operation = new[] {"CreateDeployment"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.CreateDeploymentResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.CreateDeploymentResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
