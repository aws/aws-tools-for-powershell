...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdateApi API operation.", Operation = new[] {"UpdateApi"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdateApiResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.UpdateApiResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAG2ApiCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.UpdateApiResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.UpdateApiRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateApi(request);
                #elif CORECLR
                return client.UpdateApiAsync(request).GetAwaiter().GetResult();
                #else
