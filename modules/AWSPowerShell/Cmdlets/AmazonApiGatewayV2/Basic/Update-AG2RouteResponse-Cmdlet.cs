...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdateRouteResponse API operation.", Operation = new[] {"UpdateRouteResponse"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdateRouteResponseResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.UpdateRouteResponseResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateAG2RouteResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.UpdateRouteResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.UpdateRouteResponseRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateRouteResponseAsync(request);
                return task.Result;
                #else
