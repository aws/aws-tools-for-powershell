...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetDeployments API operation.", Operation = new[] {"GetDeployments"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.Deployment",
