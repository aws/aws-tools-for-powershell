...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 CreateRoute API operation.", Operation = new[] {"CreateRoute"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.CreateRouteResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.CreateRouteResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
