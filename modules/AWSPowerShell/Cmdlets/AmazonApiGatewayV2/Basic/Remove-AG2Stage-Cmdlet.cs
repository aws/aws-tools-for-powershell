...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteStage API operation.", Operation = new[] {"DeleteStage"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.ApiGatewayV2.Model.DeleteStageResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveAG2StageCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.DeleteStageResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteStageRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteStage(request);
                #elif CORECLR
                return client.DeleteStageAsync(request).GetAwaiter().GetResult();
                #else
