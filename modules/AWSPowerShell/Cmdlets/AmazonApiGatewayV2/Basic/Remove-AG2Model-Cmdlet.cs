...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// Deletes a Model.
    /// </summary>
    [Cmdlet("Remove", "AG2Model", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 DeleteModel API operation.", Operation = new[] {"DeleteModel"})]
    ...
    public partial class RemoveAG2ModelCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ModelId", MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-AG2Model (DeleteModel)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApiGatewayV2.Model.DeleteModelRequest();
        ...
        private Amazon.ApiGatewayV2.Model.DeleteModelResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.DeleteModelRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "DeleteModel");
            try
            {
                #if DESKTOP
