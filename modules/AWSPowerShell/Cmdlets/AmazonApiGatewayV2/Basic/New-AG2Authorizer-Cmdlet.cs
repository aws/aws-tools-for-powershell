...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 CreateAuthorizer API operation.", Operation = new[] {"CreateAuthorizer"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.CreateAuthorizerResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.CreateAuthorizerResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
