...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 UpdateStage API operation.", Operation = new[] {"UpdateStage"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.UpdateStageResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.UpdateStageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
