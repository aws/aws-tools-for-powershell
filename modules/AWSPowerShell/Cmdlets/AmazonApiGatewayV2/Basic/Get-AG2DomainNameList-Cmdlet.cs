...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    /// </summary>
    [Cmdlet("Get", "AG2DomainNameList")]
    [OutputType("Amazon.ApiGatewayV2.Model.DomainName")]
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetDomainNames API operation.", Operation = new[] {"GetDomainNames"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.DomainName",
        "This cmdlet returns a collection of DomainName objects.",
        "The service call response (type Amazon.ApiGatewayV2.Model.GetDomainNamesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetAG2DomainNameListCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.GetDomainNamesResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetDomainNamesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon API Gateway V2", "GetDomainNames");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetDomainNamesAsync(request);
                return task.Result;
                #else
