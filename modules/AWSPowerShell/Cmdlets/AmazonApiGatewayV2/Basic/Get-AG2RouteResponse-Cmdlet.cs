...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetRouteResponse API operation.", Operation = new[] {"GetRouteResponse"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.GetRouteResponseResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.GetRouteResponseResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetAG2RouteResponseCmdlet : AmazonApiGatewayV2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.ApiGatewayV2.Model.GetRouteResponseResponse CallAWSServiceOperation(IAmazonApiGatewayV2 client, Amazon.ApiGatewayV2.Model.GetRouteResponseRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.GetRouteResponse(request);
                #elif CORECLR
                return client.GetRouteResponseAsync(request).GetAwaiter().GetResult();
                #else
