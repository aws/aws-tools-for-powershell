...
namespace Amazon.PowerShell.Cmdlets.AG2
{
    ...
    [AWSCmdlet("Calls the Amazon API Gateway V2 GetApiMapping API operation.", Operation = new[] {"GetApiMapping"})]
    [AWSCmdletOutput("Amazon.ApiGatewayV2.Model.GetApiMappingResponse",
        "This cmdlet returns a Amazon.ApiGatewayV2.Model.GetApiMappingResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
