...
namespace Amazon.PowerShell.Cmdlets.EMRC
{
    ...
    [AWSCmdlet("Calls the Amazon EMR Containers DescribeManagedEndpoint API operation.", Operation = new[] {"DescribeManagedEndpoint"}, SelectReturnType = typeof(Amazon.EMRContainers.Model.DescribeManagedEndpointResponse))]
    [AWSCmdletOutput("Amazon.EMRContainers.Model.Endpoint or Amazon.EMRContainers.Model.DescribeManagedEndpointResponse",
        "This cmdlet returns an Amazon.EMRContainers.Model.Endpoint object.",
        "The service call response (type Amazon.EMRContainers.Model.DescribeManagedEndpointResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetEMRCManagedEndpointCmdlet : AmazonEMRContainersClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EMRContainers.Model.DescribeManagedEndpointResponse, GetEMRCManagedEndpointCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EMRContainers.Model.DescribeManagedEndpointRequest();
        ...
        private Amazon.EMRContainers.Model.DescribeManagedEndpointResponse CallAWSServiceOperation(IAmazonEMRContainers client, Amazon.EMRContainers.Model.DescribeManagedEndpointRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EMR Containers", "DescribeManagedEndpoint");
            try
            {
                #if DESKTOP
                return client.DescribeManagedEndpoint(request);
                #elif CORECLR
                return client.DescribeManagedEndpointAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String VirtualClusterId { get; set; }
            public System.Func<Amazon.EMRContainers.Model.DescribeManagedEndpointResponse, GetEMRCManagedEndpointCmdlet, object> Select { get; set; } =
