...
namespace Amazon.PowerShell.Cmdlets.EMRC
{
    ...
    /// </summary>
    [Cmdlet("Get", "EMRCJobRun")]
    [OutputType("Amazon.EMRContainers.Model.JobRun")]
    [AWSCmdlet("Calls the Amazon EMR Containers DescribeJobRun API operation.", Operation = new[] {"DescribeJobRun"}, SelectReturnType = typeof(Amazon.EMRContainers.Model.DescribeJobRunResponse))]
    [AWSCmdletOutput("Amazon.EMRContainers.Model.JobRun or Amazon.EMRContainers.Model.DescribeJobRunResponse",
        "This cmdlet returns an Amazon.EMRContainers.Model.JobRun object.",
        "The service call response (type Amazon.EMRContainers.Model.DescribeJobRunResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetEMRCJobRunCmdlet : AmazonEMRContainersClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EMRContainers.Model.DescribeJobRunResponse, GetEMRCJobRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EMRContainers.Model.DescribeJobRunRequest();
        ...
        private Amazon.EMRContainers.Model.DescribeJobRunResponse CallAWSServiceOperation(IAmazonEMRContainers client, Amazon.EMRContainers.Model.DescribeJobRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EMR Containers", "DescribeJobRun");
            try
            {
                return client.DescribeJobRunAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String VirtualClusterId { get; set; }
            public System.Func<Amazon.EMRContainers.Model.DescribeJobRunResponse, GetEMRCJobRunCmdlet, object> Select { get; set; } =
