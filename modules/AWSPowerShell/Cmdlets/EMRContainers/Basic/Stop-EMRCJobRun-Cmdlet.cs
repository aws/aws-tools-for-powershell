...
namespace Amazon.PowerShell.Cmdlets.EMRC
{
    ...
    /// </summary>
    [Cmdlet("Stop", "EMRCJobRun", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopEMRCJobRunCmdlet : AmazonEMRContainersClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-EMRCJobRun (CancelJobRun)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EMRContainers.Model.CancelJobRunResponse, StopEMRCJobRunCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EMRContainers.Model.CancelJobRunRequest();
        ...
        private Amazon.EMRContainers.Model.CancelJobRunResponse CallAWSServiceOperation(IAmazonEMRContainers client, Amazon.EMRContainers.Model.CancelJobRunRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EMR Containers", "CancelJobRun");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String VirtualClusterId { get; set; }
            public System.Func<Amazon.EMRContainers.Model.CancelJobRunResponse, StopEMRCJobRunCmdlet, object> Select { get; set; } =
