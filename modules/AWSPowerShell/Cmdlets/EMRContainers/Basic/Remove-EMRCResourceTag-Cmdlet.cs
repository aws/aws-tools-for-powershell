...
namespace Amazon.PowerShell.Cmdlets.EMRC
{
    ...
    [AWSCmdletOutput("None or Amazon.EMRContainers.Model.UntagResourceResponse",
        ...
        "The service response (type Amazon.EMRContainers.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
