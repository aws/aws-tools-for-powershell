...
namespace Amazon.PowerShell.Cmdlets.EMRC
{
    ...
    /// a Spark jar, PySpark script, or SparkSQL query, that you submit to Amazon EMR on EKS.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetEMRCJobRunListCmdlet : AmazonEMRContainersClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The states of the job run.</para><para />
