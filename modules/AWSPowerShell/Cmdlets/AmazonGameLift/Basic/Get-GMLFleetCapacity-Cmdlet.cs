...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    /// </para></note><ul><li><para><a>CreateFleet</a></para></li><li><para><a>ListFleets</a></para></li><li><para><a>DeleteFleet</a></para></li><li><para>
    /// Describe fleets:
    ...
    [AWSCmdlet("Calls the Amazon GameLift Service DescribeFleetCapacity API operation.", Operation = new[] {"DescribeFleetCapacity"})]
    [AWSCmdletOutput("Amazon.GameLift.Model.FleetCapacity",
        "This cmdlet returns a collection of FleetCapacity objects.",
    ...
    public partial class GetGMLFleetCapacityCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.FleetCapacity;
        ...
        private Amazon.GameLift.Model.DescribeFleetCapacityResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.DescribeFleetCapacityRequest request)
        {
