...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    [AWSCmdlet("Invokes the UpdateMatchmakingConfiguration operation against Amazon GameLift Service.", Operation = new[] {"UpdateMatchmakingConfiguration"})]
    ...
    public partial class UpdateGMLMatchmakingConfigurationCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>SNS topic ARN that is set up to receive matchmaking notifications. See <a href="http://docs.aws.amazon.com/gamelift/latest/developerguide/match-notification.html">
        ...
        private Amazon.GameLift.Model.UpdateMatchmakingConfigurationResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.UpdateMatchmakingConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateMatchmakingConfigurationAsync(request);
                return task.Result;
                #else
