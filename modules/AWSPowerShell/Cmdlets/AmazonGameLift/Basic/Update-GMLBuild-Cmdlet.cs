...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public class UpdateGMLBuildCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Unique identifier for the build you want to update. </para>
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// <para>Descriptive label associated with this build. Build names do not need to be unique.</para>
        /// </para>
        /// </summary>
