...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    /// </summary>
    [Cmdlet("Remove", "GMLMatchmakingRuleSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon GameLift Service DeleteMatchmakingRuleSet API operation.", Operation = new[] {"DeleteMatchmakingRuleSet"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.GameLift.Model.DeleteMatchmakingRuleSetResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveGMLMatchmakingRuleSetCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GMLMatchmakingRuleSet (DeleteMatchmakingRuleSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameLift.Model.DeleteMatchmakingRuleSetRequest();
        ...
        private Amazon.GameLift.Model.DeleteMatchmakingRuleSetResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.DeleteMatchmakingRuleSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon GameLift Service", "DeleteMatchmakingRuleSet");
            try
            {
                #if DESKTOP
                return client.DeleteMatchmakingRuleSet(request);
                #elif CORECLR
                return client.DeleteMatchmakingRuleSetAsync(request).GetAwaiter().GetResult();
                #else
