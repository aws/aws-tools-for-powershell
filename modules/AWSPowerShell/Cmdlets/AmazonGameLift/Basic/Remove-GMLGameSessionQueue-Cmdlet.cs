...
namespace Amazon.PowerShell.Cmdlets.GML
{
    ...
    public partial class RemoveGMLGameSessionQueueCmdlet : AmazonGameLiftClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-GMLGameSessionQueue (DeleteGameSessionQueue)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.GameLift.Model.DeleteGameSessionQueueRequest();
        ...
        private Amazon.GameLift.Model.DeleteGameSessionQueueResponse CallAWSServiceOperation(IAmazonGameLift client, Amazon.GameLift.Model.DeleteGameSessionQueueRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteGameSessionQueueAsync(request).GetAwaiter().GetResult();
                #else
