...
namespace Amazon.PowerShell.Cmdlets.MCAT
{
    ...
    public partial class GetMCATChangeSetCmdlet : AmazonMarketplaceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MarketplaceCatalog.Model.DescribeChangeSetResponse, GetMCATChangeSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MarketplaceCatalog.Model.DescribeChangeSetRequest();
        ...
        private Amazon.MarketplaceCatalog.Model.DescribeChangeSetResponse CallAWSServiceOperation(IAmazonMarketplaceCatalog client, Amazon.MarketplaceCatalog.Model.DescribeChangeSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Marketplace Catalog Service", "DescribeChangeSet");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Catalog { get; set; }
            public System.String ChangeSetId { get; set; }
            public System.Func<Amazon.MarketplaceCatalog.Model.DescribeChangeSetResponse, GetMCATChangeSetCmdlet, object> Select { get; set; } =
