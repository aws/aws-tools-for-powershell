...
namespace Amazon.PowerShell.Cmdlets.MCAT
{
    ...
    public partial class StopMCATChangeSetCmdlet : AmazonMarketplaceCatalogClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.ChangeSetId), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-MCATChangeSet (CancelChangeSet)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MarketplaceCatalog.Model.CancelChangeSetResponse, StopMCATChangeSetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MarketplaceCatalog.Model.CancelChangeSetRequest();
        ...
        private Amazon.MarketplaceCatalog.Model.CancelChangeSetResponse CallAWSServiceOperation(IAmazonMarketplaceCatalog client, Amazon.MarketplaceCatalog.Model.CancelChangeSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Marketplace Catalog Service", "CancelChangeSet");
            try
            {
                #if DESKTOP
                return client.CancelChangeSet(request);
                #elif CORECLR
                return client.CancelChangeSetAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Catalog { get; set; }
            public System.String ChangeSetId { get; set; }
            public System.Func<Amazon.MarketplaceCatalog.Model.CancelChangeSetResponse, StopMCATChangeSetCmdlet, object> Select { get; set; } =
