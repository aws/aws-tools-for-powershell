...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    public partial class InvokeNEPTFastResetCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The fast reset action. One of the following values:</para><ul><li><para><b><c>initiateDatabaseReset</c></b> - This action generates a unique token needed
        /// to actually perform the fast reset.</para></li><li><para><b><c>performDatabaseReset</c></b> - This action uses the token generated by the
        /// <c>initiateDatabaseReset</c> action to actually perform the fast reset.</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
