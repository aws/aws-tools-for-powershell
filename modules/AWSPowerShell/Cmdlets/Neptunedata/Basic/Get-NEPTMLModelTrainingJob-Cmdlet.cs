...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    public partial class GetNEPTMLModelTrainingJobCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptunedata.Model.GetMLModelTrainingJobResponse, GetNEPTMLModelTrainingJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptunedata.Model.GetMLModelTrainingJobRequest();
        ...
        private Amazon.Neptunedata.Model.GetMLModelTrainingJobResponse CallAWSServiceOperation(IAmazonNeptunedata client, Amazon.Neptunedata.Model.GetMLModelTrainingJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon NeptuneData", "GetMLModelTrainingJob");
            try
            {
                #if DESKTOP
                return client.GetMLModelTrainingJob(request);
                #elif CORECLR
                return client.GetMLModelTrainingJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Id { get; set; }
            public System.String NeptuneIamRoleArn { get; set; }
            public System.Func<Amazon.Neptunedata.Model.GetMLModelTrainingJobResponse, GetNEPTMLModelTrainingJobCmdlet, object> Select { get; set; } =
