...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    /// </summary>
    [Cmdlet("Get", "NEPTMLModelTrainingJobList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon NeptuneData ListMLModelTrainingJobs API operation.", Operation = new[] {"ListMLModelTrainingJobs"}, SelectReturnType = typeof(Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse))]
    [AWSCmdletOutput("System.String or Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNEPTMLModelTrainingJobListCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse, GetNEPTMLModelTrainingJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptunedata.Model.ListMLModelTrainingJobsRequest();
        ...
        private Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse CallAWSServiceOperation(IAmazonNeptunedata client, Amazon.Neptunedata.Model.ListMLModelTrainingJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon NeptuneData", "ListMLModelTrainingJobs");
            try
            {
                #if DESKTOP
                return client.ListMLModelTrainingJobs(request);
                #elif CORECLR
                return client.ListMLModelTrainingJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxItem { get; set; }
            public System.String NeptuneIamRoleArn { get; set; }
            public System.Func<Amazon.Neptunedata.Model.ListMLModelTrainingJobsResponse, GetNEPTMLModelTrainingJobListCmdlet, object> Select { get; set; } =
