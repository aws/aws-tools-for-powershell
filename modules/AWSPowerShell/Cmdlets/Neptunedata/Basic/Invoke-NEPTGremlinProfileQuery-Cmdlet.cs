...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    [AWSCmdletOutput("System.IO.MemoryStream or Amazon.Neptunedata.Model.ExecuteGremlinProfileQueryResponse",
        ...
        "The service call response (type Amazon.Neptunedata.Model.ExecuteGremlinProfileQueryResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class InvokeNEPTGremlinProfileQueryCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If this flag is set to <code>TRUE</code>, the results include a detailed report of
        /// all index operations that took place during query execution and serialization.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("IndexOps")]
        ...
        /// <summary>
        /// <para>
        /// <para>If this flag is set to <code>TRUE</code>, the query results are gathered and displayed
        /// as part of the profile report. If <code>FALSE</code>, only the result count is displayed.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        [Alias("Results")]
