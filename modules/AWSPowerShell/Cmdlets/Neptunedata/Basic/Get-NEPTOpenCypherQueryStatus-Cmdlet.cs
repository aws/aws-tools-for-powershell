...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "NEPTOpenCypherQueryStatus")]
    [OutputType("Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse")]
    [AWSCmdlet("Calls the Amazon NeptuneData GetOpenCypherQueryStatus API operation.", Operation = new[] {"GetOpenCypherQueryStatus"}, SelectReturnType = typeof(Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse))]
    [AWSCmdletOutput("Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse",
        "This cmdlet returns an Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetNEPTOpenCypherQueryStatusCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse, GetNEPTOpenCypherQueryStatusCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptunedata.Model.GetOpenCypherQueryStatusRequest();
        ...
        private Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse CallAWSServiceOperation(IAmazonNeptunedata client, Amazon.Neptunedata.Model.GetOpenCypherQueryStatusRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon NeptuneData", "GetOpenCypherQueryStatus");
            try
            {
                #if DESKTOP
                return client.GetOpenCypherQueryStatus(request);
                #elif CORECLR
                return client.GetOpenCypherQueryStatusAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String QueryId { get; set; }
            public System.Func<Amazon.Neptunedata.Model.GetOpenCypherQueryStatusResponse, GetNEPTOpenCypherQueryStatusCmdlet, object> Select { get; set; } =
