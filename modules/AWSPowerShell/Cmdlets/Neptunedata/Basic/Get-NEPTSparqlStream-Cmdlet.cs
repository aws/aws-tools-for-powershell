...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    public partial class GetNEPTSparqlStreamCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptunedata.Model.GetSparqlStreamResponse, GetNEPTSparqlStreamCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptunedata.Model.GetSparqlStreamRequest();
        ...
        private Amazon.Neptunedata.Model.GetSparqlStreamResponse CallAWSServiceOperation(IAmazonNeptunedata client, Amazon.Neptunedata.Model.GetSparqlStreamRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon NeptuneData", "GetSparqlStream");
            try
            {
                #if DESKTOP
                return client.GetSparqlStream(request);
                #elif CORECLR
                return client.GetSparqlStreamAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int64? Limit { get; set; }
            public System.Int64? OpNum { get; set; }
            public System.Func<Amazon.Neptunedata.Model.GetSparqlStreamResponse, GetNEPTSparqlStreamCmdlet, object> Select { get; set; } =
