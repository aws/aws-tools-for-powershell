...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    public partial class StartNEPTMLDataProcessingJobCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        /// <code>training-data-configuration.json</code>.</para>
        /// </para>
        /// </summary>
        ...
        /// models (<code>heterogeneous</code>), and knowledge graph (<code>kge</code>). The default
        /// is none. If not specified, Neptune ML chooses the model type automatically based on
        /// the data.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
