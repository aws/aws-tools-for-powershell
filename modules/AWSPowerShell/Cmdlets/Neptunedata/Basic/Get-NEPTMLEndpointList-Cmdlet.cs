...
namespace Amazon.PowerShell.Cmdlets.NEPT
{
    ...
    public partial class GetNEPTMLEndpointListCmdlet : AmazonNeptunedataClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Neptunedata.Model.ListMLEndpointsResponse, GetNEPTMLEndpointListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Neptunedata.Model.ListMLEndpointsRequest();
        ...
        private Amazon.Neptunedata.Model.ListMLEndpointsResponse CallAWSServiceOperation(IAmazonNeptunedata client, Amazon.Neptunedata.Model.ListMLEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon NeptuneData", "ListMLEndpoints");
            try
            {
                #if DESKTOP
                return client.ListMLEndpoints(request);
                #elif CORECLR
                return client.ListMLEndpointsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxItem { get; set; }
            public System.String NeptuneIamRoleArn { get; set; }
            public System.Func<Amazon.Neptunedata.Model.ListMLEndpointsResponse, GetNEPTMLEndpointListCmdlet, object> Select { get; set; } =
