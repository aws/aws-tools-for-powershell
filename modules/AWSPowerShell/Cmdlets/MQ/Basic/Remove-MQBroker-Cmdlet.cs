...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    public partial class RemoveMQBrokerCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.DeleteBrokerResponse, RemoveMQBrokerCmdlet>(Select) ??
        ...
        private Amazon.MQ.Model.DeleteBrokerResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.DeleteBrokerRequest request)
        {
            ...
            try
            {
                return client.DeleteBrokerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String BrokerId { get; set; }
            public System.Func<Amazon.MQ.Model.DeleteBrokerResponse, RemoveMQBrokerCmdlet, object> Select { get; set; } =
