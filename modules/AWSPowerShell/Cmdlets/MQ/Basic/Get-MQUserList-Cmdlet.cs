...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ ListUsers API operation.", Operation = new[] {"ListUsers"}, SelectReturnType = typeof(Amazon.MQ.Model.ListUsersResponse))]
    [AWSCmdletOutput("Amazon.MQ.Model.UserSummary or Amazon.MQ.Model.ListUsersResponse",
        "This cmdlet returns a collection of Amazon.MQ.Model.UserSummary objects.",
        "The service call response (type Amazon.MQ.Model.ListUsersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMQUserListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.ListUsersResponse, GetMQUserListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MQ.Model.ListUsersResponse, GetMQUserListCmdlet, object> Select { get; set; } =
