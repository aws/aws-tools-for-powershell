...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Get", "MQBrokerList")]
    [OutputType("Amazon.MQ.Model.BrokerSummary")]
    [AWSCmdlet("Calls the Amazon MQ ListBrokers API operation.", Operation = new[] {"ListBrokers"}, SelectReturnType = typeof(Amazon.MQ.Model.ListBrokersResponse))]
    [AWSCmdletOutput("Amazon.MQ.Model.BrokerSummary or Amazon.MQ.Model.ListBrokersResponse",
        "This cmdlet returns a collection of Amazon.MQ.Model.BrokerSummary objects.",
        "The service call response (type Amazon.MQ.Model.ListBrokersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMQBrokerListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BrokerSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.ListBrokersResponse, GetMQBrokerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MQ.Model.ListBrokersRequest();
        ...
        private Amazon.MQ.Model.ListBrokersResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.ListBrokersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "ListBrokers");
            try
            {
                #if DESKTOP
                return client.ListBrokers(request);
                #elif CORECLR
                return client.ListBrokersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MQ.Model.ListBrokersResponse, GetMQBrokerListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BrokerSummaries;
        }
