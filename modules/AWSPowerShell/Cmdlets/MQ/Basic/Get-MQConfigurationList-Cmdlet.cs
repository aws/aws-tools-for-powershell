...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ ListConfigurations API operation.", Operation = new[] {"ListConfigurations"}, SelectReturnType = typeof(Amazon.MQ.Model.ListConfigurationsResponse))]
    [AWSCmdletOutput("Amazon.MQ.Model.Configuration or Amazon.MQ.Model.ListConfigurationsResponse",
        "This cmdlet returns a collection of Amazon.MQ.Model.Configuration objects.",
        "The service call response (type Amazon.MQ.Model.ListConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMQConfigurationListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.ListConfigurationsResponse, GetMQConfigurationListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MQ.Model.ListConfigurationsResponse, GetMQConfigurationListCmdlet, object> Select { get; set; } =
