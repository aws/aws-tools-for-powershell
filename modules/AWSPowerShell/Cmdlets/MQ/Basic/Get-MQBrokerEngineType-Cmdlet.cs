...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Get", "MQBrokerEngineType")]
    [OutputType("Amazon.MQ.Model.BrokerEngineType")]
    ...
    public partial class GetMQBrokerEngineTypeCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        public System.String EngineType { get; set; }
        #endregion
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "BrokerEngineTypes";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.DescribeBrokerEngineTypesResponse, GetMQBrokerEngineTypeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MQ.Model.DescribeBrokerEngineTypesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.BrokerEngineTypes?.Count ?? 0;
        ...
        private Amazon.MQ.Model.DescribeBrokerEngineTypesResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.DescribeBrokerEngineTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "DescribeBrokerEngineTypes");
            try
            {
                #if DESKTOP
                return client.DescribeBrokerEngineTypes(request);
                #elif CORECLR
                return client.DescribeBrokerEngineTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MQ.Model.DescribeBrokerEngineTypesResponse, GetMQBrokerEngineTypeCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.BrokerEngineTypes;
        }
