...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ ListConfigurationRevisions API operation.", Operation = new[] {"ListConfigurationRevisions"}, SelectReturnType = typeof(Amazon.MQ.Model.ListConfigurationRevisionsResponse))]
    [AWSCmdletOutput("Amazon.MQ.Model.ConfigurationRevision or Amazon.MQ.Model.ListConfigurationRevisionsResponse",
        "This cmdlet returns a collection of Amazon.MQ.Model.ConfigurationRevision objects.",
        "The service call response (type Amazon.MQ.Model.ListConfigurationRevisionsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMQConfigurationRevisionListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MQ.Model.ListConfigurationRevisionsResponse, GetMQConfigurationRevisionListCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MQ.Model.ListConfigurationRevisionsResponse, GetMQConfigurationRevisionListCmdlet, object> Select { get; set; } =
