...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT AssociateTargetsWithJob API operation.", Operation = new[] {"AssociateTargetsWithJob"})]
    [AWSCmdletOutput("Amazon.IoT.Model.AssociateTargetsWithJobResponse",
        "This cmdlet returns a Amazon.IoT.Model.AssociateTargetsWithJobResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class AddIOTTargetsWithJobCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.AssociateTargetsWithJobResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AssociateTargetsWithJobRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.AssociateTargetsWithJob(request);
                #elif CORECLR
                return client.AssociateTargetsWithJobAsync(request).GetAwaiter().GetResult();
                #else
