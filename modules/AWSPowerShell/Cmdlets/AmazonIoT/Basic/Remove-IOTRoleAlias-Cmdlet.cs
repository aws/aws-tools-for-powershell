...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DeleteRoleAlias API operation.", Operation = new[] {"DeleteRoleAlias"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the RoleAlias parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveIOTRoleAliasCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("RoleAlias", MyInvocation.BoundParameters);
        ...
        private Amazon.IoT.Model.DeleteRoleAliasResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteRoleAliasRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteRoleAliasAsync(request);
                return task.Result;
                #else
