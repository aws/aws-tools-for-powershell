...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdletOutput("System.String",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String), ReportType (type Amazon.IoT.ReportType)"
    )]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ResourceLinks;
                        notes = new Dictionary<string, object>();
                        notes["NextToken"] = response.NextToken;
                        notes["ReportType"] = response.ReportType;
