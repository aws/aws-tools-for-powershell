...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS IoT SetV2LoggingOptions API operation.", Operation = new[] {"SetV2LoggingOptions"})]
    ...
    public partial class SetIOTV2LoggingOptionCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("DisableAllLog"))
                context.DisableAllLogs = this.DisableAllLog;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.DisableAllLogs != null)
            {
                request.DisableAllLogs = cmdletContext.DisableAllLogs.Value;
            }
        ...
        private Amazon.IoT.Model.SetV2LoggingOptionsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.SetV2LoggingOptionsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.SetV2LoggingOptionsAsync(request);
                return task.Result;
                #else
        ...
        {
            public Amazon.IoT.LogLevel DefaultLogLevel { get; set; }
            public System.Boolean? DisableAllLogs { get; set; }
            public System.String RoleArn { get; set; }
        }
