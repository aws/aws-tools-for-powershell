...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListBillingGroups API operation.", Operation = new[] {"ListBillingGroups"})]
    ...
    public partial class GetIOTBillingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BillingGroups;
        ...
        private Amazon.IoT.Model.ListBillingGroupsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListBillingGroupsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListBillingGroupsAsync(request);
                return task.Result;
                #else
