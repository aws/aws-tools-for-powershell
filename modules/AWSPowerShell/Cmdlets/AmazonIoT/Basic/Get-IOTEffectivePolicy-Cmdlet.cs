...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT GetEffectivePolicies API operation.", Operation = new[] {"GetEffectivePolicies"})]
    [AWSCmdletOutput("Amazon.IoT.Model.EffectivePolicy",
        "This cmdlet returns a collection of EffectivePolicy objects.",
    ...
    public partial class GetIOTEffectivePolicyCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.EffectivePolicies;
        ...
        private Amazon.IoT.Model.GetEffectivePoliciesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetEffectivePoliciesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetEffectivePoliciesAsync(request);
                return task.Result;
                #else
