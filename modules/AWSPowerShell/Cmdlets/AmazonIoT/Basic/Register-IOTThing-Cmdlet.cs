...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT RegisterThing API operation.", Operation = new[] {"RegisterThing"})]
    [AWSCmdletOutput("Amazon.IoT.Model.RegisterThingResponse",
        "This cmdlet returns a Amazon.IoT.Model.RegisterThingResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterIOTThingCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.RegisterThingResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.RegisterThingRequest request)
        {
            ...
            try
            {
                ...
                var task = client.RegisterThingAsync(request);
                return task.Result;
                #else
