...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT CreateBillingGroup API operation.", Operation = new[] {"CreateBillingGroup"})]
    [AWSCmdletOutput("Amazon.IoT.Model.CreateBillingGroupResponse",
        "This cmdlet returns a Amazon.IoT.Model.CreateBillingGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIOTBillingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.CreateBillingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.CreateBillingGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateBillingGroupAsync(request);
                return task.Result;
                #else
