...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT UpdateScheduledAudit API operation.", Operation = new[] {"UpdateScheduledAudit"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a String object.",
        "The service call response (type Amazon.IoT.Model.UpdateScheduledAuditResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateIOTScheduledAuditCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.UpdateScheduledAuditResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.UpdateScheduledAuditRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateScheduledAuditAsync(request);
                return task.Result;
                #else
