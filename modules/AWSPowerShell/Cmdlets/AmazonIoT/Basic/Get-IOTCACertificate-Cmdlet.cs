...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Invokes the DescribeCACertificate operation against AWS IoT.", Operation = new[] {"DescribeCACertificate"})]
    ...
    public class GetIOTCACertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private static Amazon.IoT.Model.DescribeCACertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeCACertificateRequest request)
        {
