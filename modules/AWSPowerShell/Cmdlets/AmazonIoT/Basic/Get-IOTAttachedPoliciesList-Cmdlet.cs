...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IOTAttachedPoliciesList")]
    [OutputType("Amazon.IoT.Model.Policy")]
    [AWSCmdlet("Calls the AWS IoT ListAttachedPolicies API operation.", Operation = new[] {"ListAttachedPolicies"})]
    ...
    public partial class GetIOTAttachedPoliciesListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
