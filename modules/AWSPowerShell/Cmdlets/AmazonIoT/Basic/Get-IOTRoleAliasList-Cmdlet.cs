...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class GetIOTRoleAliasListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.RoleAliases.Count;
        ...
        private Amazon.IoT.Model.ListRoleAliasesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListRoleAliasesRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListRoleAliasesAsync(request).GetAwaiter().GetResult();
                #else
