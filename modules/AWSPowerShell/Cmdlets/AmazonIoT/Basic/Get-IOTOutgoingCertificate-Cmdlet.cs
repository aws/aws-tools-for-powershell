...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListOutgoingCertificates API operation.", Operation = new[] {"ListOutgoingCertificates"})]
    [AWSCmdletOutput("Amazon.IoT.Model.OutgoingCertificate",
        "This cmdlet returns a collection of OutgoingCertificate objects.",
    ...
    public partial class GetIOTOutgoingCertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.OutgoingCertificates;
                        ...
                        int _receivedThisCall = response.OutgoingCertificates.Count;
        ...
        private Amazon.IoT.Model.ListOutgoingCertificatesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListOutgoingCertificatesRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListOutgoingCertificatesAsync(request).GetAwaiter().GetResult();
                #else
