...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// version.
    /// </summary>
    [Cmdlet("Get", "IOTPolicy")]
    [OutputType("Amazon.IoT.Model.GetPolicyResponse")]
    [AWSCmdlet("Calls the AWS IoT GetPolicy API operation.", Operation = new[] {"GetPolicy"})]
    ...
    public partial class GetIOTPolicyCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.GetPolicyResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.GetPolicyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "GetPolicy");
            try
            {
                #if DESKTOP
