...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DescribeRoleAlias API operation.", Operation = new[] {"DescribeRoleAlias"})]
    [AWSCmdletOutput("Amazon.IoT.Model.RoleAliasDescription",
        "This cmdlet returns a RoleAliasDescription object.",
    ...
    public partial class GetIOTRoleAliasCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.RoleAliasDescription;
        ...
        private Amazon.IoT.Model.DescribeRoleAliasResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeRoleAliasRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DescribeRoleAlias(request);
                #elif CORECLR
                return client.DescribeRoleAliasAsync(request).GetAwaiter().GetResult();
                #else
