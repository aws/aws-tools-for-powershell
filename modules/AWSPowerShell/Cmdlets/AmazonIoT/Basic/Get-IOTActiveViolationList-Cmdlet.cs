...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListActiveViolations API operation.", Operation = new[] {"ListActiveViolations"})]
    [AWSCmdletOutput("Amazon.IoT.Model.ActiveViolation",
        "This cmdlet returns a collection of ActiveViolation objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ActiveViolations;
