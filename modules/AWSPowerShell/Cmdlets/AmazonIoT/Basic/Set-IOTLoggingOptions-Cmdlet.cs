...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    /// </summary>
    [Cmdlet("Set", "IOTLoggingOptions", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public class SetIOTLoggingOptionsCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Set-IOTLoggingOptions (SetLoggingOptions)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.SetLoggingOptions(request);
