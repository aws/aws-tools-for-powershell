...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListPolicyVersions API operation.", Operation = new[] {"ListPolicyVersions"})]
    ...
    public partial class GetIOTPolicyVersionListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.ListPolicyVersionsResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListPolicyVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListPolicyVersions");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListPolicyVersionsAsync(request);
                return task.Result;
                #else
