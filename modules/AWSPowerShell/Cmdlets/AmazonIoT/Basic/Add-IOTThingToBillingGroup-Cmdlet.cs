...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT AddThingToBillingGroup API operation.", Operation = new[] {"AddThingToBillingGroup"})]
    ...
    public partial class AddIOTThingToBillingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ThingArn", MyInvocation.BoundParameters);
        ...
        private Amazon.IoT.Model.AddThingToBillingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.AddThingToBillingGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.AddThingToBillingGroupAsync(request);
                return task.Result;
                #else
