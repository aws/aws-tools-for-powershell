...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    public partial class RegisterIOTCertificateCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private static Amazon.IoT.Model.RegisterCertificateResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.RegisterCertificateRequest request)
        {
            #if DESKTOP
