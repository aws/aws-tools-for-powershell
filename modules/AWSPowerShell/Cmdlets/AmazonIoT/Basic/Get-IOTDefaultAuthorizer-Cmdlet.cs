...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DescribeDefaultAuthorizer API operation.", Operation = new[] {"DescribeDefaultAuthorizer"})]
    [AWSCmdletOutput("Amazon.IoT.Model.AuthorizerDescription",
        "This cmdlet returns a AuthorizerDescription object.",
    ...
    public partial class GetIOTDefaultAuthorizerCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.AuthorizerDescription;
        ...
        private Amazon.IoT.Model.DescribeDefaultAuthorizerResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DescribeDefaultAuthorizerRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeDefaultAuthorizerAsync(request);
                return task.Result;
                #else
