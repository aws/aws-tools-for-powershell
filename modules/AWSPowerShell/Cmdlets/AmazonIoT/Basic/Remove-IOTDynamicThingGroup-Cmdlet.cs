...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DeleteDynamicThingGroup API operation.", Operation = new[] {"DeleteDynamicThingGroup"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ThingGroupName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveIOTDynamicThingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ThingGroupName;
        ...
        private Amazon.IoT.Model.DeleteDynamicThingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteDynamicThingGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteDynamicThingGroupAsync(request);
                return task.Result;
                #else
