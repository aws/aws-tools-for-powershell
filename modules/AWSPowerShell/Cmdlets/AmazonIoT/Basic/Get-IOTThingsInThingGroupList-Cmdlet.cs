...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListThingsInThingGroup API operation.", Operation = new[] {"ListThingsInThingGroup"})]
    ...
    public partial class GetIOTThingsInThingGroupListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.ListThingsInThingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingsInThingGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListThingsInThingGroupAsync(request);
                return task.Result;
                #else
