...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT ListThingTypes API operation.", Operation = new[] {"ListThingTypes"})]
    ...
    public partial class GetIOTThingTypesListCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.ListThingTypesResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.ListThingTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS IoT", "ListThingTypes");
            try
            {
                #if DESKTOP
                ...
                var task = client.ListThingTypesAsync(request);
                return task.Result;
                #else
