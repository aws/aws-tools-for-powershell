...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT DeleteBillingGroup API operation.", Operation = new[] {"DeleteBillingGroup"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the BillingGroupName parameter. Otherwise, this cmdlet does not return any output. " +
        "The service response (type Amazon.IoT.Model.DeleteBillingGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveIOTBillingGroupCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.BillingGroupName;
        ...
        private Amazon.IoT.Model.DeleteBillingGroupResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.DeleteBillingGroupRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteBillingGroupAsync(request);
                return task.Result;
                #else
