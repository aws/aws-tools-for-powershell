...
namespace Amazon.PowerShell.Cmdlets.IOT
{
    ...
    [AWSCmdlet("Calls the AWS IoT CreateRoleAlias API operation.", Operation = new[] {"CreateRoleAlias"})]
    [AWSCmdletOutput("Amazon.IoT.Model.CreateRoleAliasResponse",
        "This cmdlet returns a Amazon.IoT.Model.CreateRoleAliasResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIOTRoleAliasCmdlet : AmazonIoTClientCmdlet, IExecutor
    {
        ...
        private Amazon.IoT.Model.CreateRoleAliasResponse CallAWSServiceOperation(IAmazonIoT client, Amazon.IoT.Model.CreateRoleAliasRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CreateRoleAliasAsync(request);
                return task.Result;
                #else
