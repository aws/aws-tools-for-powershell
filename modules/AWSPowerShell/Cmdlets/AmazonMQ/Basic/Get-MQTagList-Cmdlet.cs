...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Get", "MQTagList")]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the Amazon MQ ListTags API operation.", Operation = new[] {"ListTags"})]
    ...
    public partial class GetMQTagListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MQ.Model.ListTagsRequest();
        ...
        private Amazon.MQ.Model.ListTagsResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.ListTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "ListTags");
            try
            {
                #if DESKTOP
