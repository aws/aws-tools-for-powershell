...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ ListBrokers API operation.", Operation = new[] {"ListBrokers"})]
    [AWSCmdletOutput("Amazon.MQ.Model.BrokerSummary",
        "This cmdlet returns a collection of BrokerSummary objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BrokerSummaries;
