...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ DescribeBrokerInstanceOptions API operation.", Operation = new[] {"DescribeBrokerInstanceOptions"})]
    [AWSCmdletOutput("Amazon.MQ.Model.BrokerInstanceOption",
        "This cmdlet returns a collection of BrokerInstanceOption objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BrokerInstanceOptions;
