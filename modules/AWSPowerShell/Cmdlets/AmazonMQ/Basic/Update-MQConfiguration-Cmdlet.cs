...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ UpdateConfiguration API operation.", Operation = new[] {"UpdateConfiguration"})]
    [AWSCmdletOutput("Amazon.MQ.Model.UpdateConfigurationResponse",
        "This cmdlet returns a Amazon.MQ.Model.UpdateConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateMQConfigurationCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        private Amazon.MQ.Model.UpdateConfigurationResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.UpdateConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateConfigurationAsync(request);
                return task.Result;
                #else
