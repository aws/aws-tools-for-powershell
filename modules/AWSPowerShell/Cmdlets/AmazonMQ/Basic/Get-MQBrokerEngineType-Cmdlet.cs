...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ DescribeBrokerEngineTypes API operation.", Operation = new[] {"DescribeBrokerEngineTypes"})]
    [AWSCmdletOutput("Amazon.MQ.Model.BrokerEngineType",
        "This cmdlet returns a collection of BrokerEngineType objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BrokerEngineTypes;
