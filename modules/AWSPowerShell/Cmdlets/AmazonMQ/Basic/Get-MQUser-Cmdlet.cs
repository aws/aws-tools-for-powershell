...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ DescribeUser API operation.", Operation = new[] {"DescribeUser"})]
    [AWSCmdletOutput("Amazon.MQ.Model.DescribeUserResponse",
        "This cmdlet returns a Amazon.MQ.Model.DescribeUserResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
