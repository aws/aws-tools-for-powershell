...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Get", "MQConfigurationList")]
    [OutputType("Amazon.MQ.Model.Configuration")]
    [AWSCmdlet("Calls the Amazon MQ ListConfigurations API operation.", Operation = new[] {"ListConfigurations"})]
    [AWSCmdletOutput("Amazon.MQ.Model.Configuration",
        "This cmdlet returns a collection of Configuration objects.",
        "The service call response (type Amazon.MQ.Model.ListConfigurationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetMQConfigurationListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MQ.Model.ListConfigurationsRequest();
        ...
        private Amazon.MQ.Model.ListConfigurationsResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.ListConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "ListConfigurations");
            try
            {
                #if DESKTOP
