...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Get", "MQUserList")]
    [OutputType("Amazon.MQ.Model.UserSummary")]
    [AWSCmdlet("Calls the Amazon MQ ListUsers API operation.", Operation = new[] {"ListUsers"})]
    [AWSCmdletOutput("Amazon.MQ.Model.UserSummary",
        "This cmdlet returns a collection of UserSummary objects.",
        "The service call response (type Amazon.MQ.Model.ListUsersResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: BrokerId (type System.String), MaxResults (type System.Int32), NextToken (type System.String)"
    )]
    public partial class GetMQUserListCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MQ.Model.ListUsersRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        notes["BrokerId"] = response.BrokerId;
        ...
        private Amazon.MQ.Model.ListUsersResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.ListUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "ListUsers");
            try
            {
                #if DESKTOP
