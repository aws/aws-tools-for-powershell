...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    [AWSCmdlet("Calls the Amazon MQ DescribeConfiguration API operation.", Operation = new[] {"DescribeConfiguration"})]
    [AWSCmdletOutput("Amazon.MQ.Model.DescribeConfigurationResponse",
        "This cmdlet returns a Amazon.MQ.Model.DescribeConfigurationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMQConfigurationCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        private Amazon.MQ.Model.DescribeConfigurationResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.DescribeConfigurationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeConfigurationAsync(request);
                return task.Result;
                #else
