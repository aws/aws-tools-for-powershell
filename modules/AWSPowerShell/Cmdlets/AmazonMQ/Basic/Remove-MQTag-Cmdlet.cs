...
namespace Amazon.PowerShell.Cmdlets.MQ
{
    ...
    /// </summary>
    [Cmdlet("Remove", "MQTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon MQ DeleteTags API operation.", Operation = new[] {"DeleteTags"})]
    ...
    public partial class RemoveMQTagCmdlet : AmazonMQClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-MQTag (DeleteTags)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.MQ.Model.DeleteTagsRequest();
        ...
        private Amazon.MQ.Model.DeleteTagsResponse CallAWSServiceOperation(IAmazonMQ client, Amazon.MQ.Model.DeleteTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon MQ", "DeleteTags");
            try
            {
                #if DESKTOP
