...
namespace Amazon.PowerShell.Cmdlets.XR
{
    ...
    public partial class RemoveXRResourceTagCmdlet : AmazonXRayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-XRResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.XRay.Model.UntagResourceResponse, RemoveXRResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.XRay.Model.UntagResourceRequest();
        ...
        private Amazon.XRay.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonXRay client, Amazon.XRay.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS X-Ray", "UntagResource");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.XRay.Model.UntagResourceResponse, RemoveXRResourceTagCmdlet, object> Select { get; set; } =
