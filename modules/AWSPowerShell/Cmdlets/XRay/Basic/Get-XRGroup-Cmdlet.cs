...
namespace Amazon.PowerShell.Cmdlets.XR
{
    ...
    public partial class GetXRGroupCmdlet : AmazonXRayClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.XRay.Model.GetGroupResponse, GetXRGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.XRay.Model.GetGroupRequest();
        ...
        private Amazon.XRay.Model.GetGroupResponse CallAWSServiceOperation(IAmazonXRay client, Amazon.XRay.Model.GetGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS X-Ray", "GetGroup");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GroupARN { get; set; }
            public System.String GroupName { get; set; }
            public System.Func<Amazon.XRay.Model.GetGroupResponse, GetXRGroupCmdlet, object> Select { get; set; } =
