...
namespace Amazon.PowerShell.Cmdlets.XR
{
    ...
    /// </summary>
    [Cmdlet("Get", "XRInsightEvent")]
    [OutputType("Amazon.XRay.Model.InsightEvent")]
    [AWSCmdlet("Calls the AWS X-Ray GetInsightEvents API operation.", Operation = new[] {"GetInsightEvents"}, SelectReturnType = typeof(Amazon.XRay.Model.GetInsightEventsResponse))]
    [AWSCmdletOutput("Amazon.XRay.Model.InsightEvent or Amazon.XRay.Model.GetInsightEventsResponse",
        "This cmdlet returns a collection of Amazon.XRay.Model.InsightEvent objects.",
        "The service call response (type Amazon.XRay.Model.GetInsightEventsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetXRInsightEventCmdlet : AmazonXRayClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "InsightEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.XRay.Model.GetInsightEventsResponse, GetXRInsightEventCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.XRay.Model.GetInsightEventsRequest();
        ...
        private Amazon.XRay.Model.GetInsightEventsResponse CallAWSServiceOperation(IAmazonXRay client, Amazon.XRay.Model.GetInsightEventsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS X-Ray", "GetInsightEvents");
            try
            {
                #if DESKTOP
                return client.GetInsightEvents(request);
                #elif CORECLR
                return client.GetInsightEventsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.XRay.Model.GetInsightEventsResponse, GetXRInsightEventCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.InsightEvents;
        }
