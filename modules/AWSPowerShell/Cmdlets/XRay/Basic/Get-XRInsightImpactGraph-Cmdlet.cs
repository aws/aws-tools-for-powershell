...
namespace Amazon.PowerShell.Cmdlets.XR
{
    ...
    [AWSCmdletOutput("Amazon.XRay.Model.GetInsightImpactGraphResponse",
        "This cmdlet returns an Amazon.XRay.Model.GetInsightImpactGraphResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
