...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "SCARResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSCARResourceTagCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of the tag keys to remove from the specified resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCARResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRegistry.Model.UntagResourceResponse, RemoveSCARResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRegistry.Model.UntagResourceRequest();
        ...
        private Amazon.AppRegistry.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonAppRegistry client, Amazon.AppRegistry.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog App Registry", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppRegistry.Model.UntagResourceResponse, RemoveSCARResourceTagCmdlet, object> Select { get; set; } =
