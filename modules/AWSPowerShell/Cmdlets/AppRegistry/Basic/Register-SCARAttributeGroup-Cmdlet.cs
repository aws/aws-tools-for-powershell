...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    [AWSCmdlet("Calls the AWS Service Catalog App Registry AssociateAttributeGroup API operation.", Operation = new[] {"AssociateAttributeGroup"}, SelectReturnType = typeof(Amazon.AppRegistry.Model.AssociateAttributeGroupResponse))]
    [AWSCmdletOutput("Amazon.AppRegistry.Model.AssociateAttributeGroupResponse",
        "This cmdlet returns an Amazon.AppRegistry.Model.AssociateAttributeGroupResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterSCARAttributeGroupCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-SCARAttributeGroup (AssociateAttributeGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRegistry.Model.AssociateAttributeGroupResponse, RegisterSCARAttributeGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRegistry.Model.AssociateAttributeGroupRequest();
        ...
        private Amazon.AppRegistry.Model.AssociateAttributeGroupResponse CallAWSServiceOperation(IAmazonAppRegistry client, Amazon.AppRegistry.Model.AssociateAttributeGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog App Registry", "AssociateAttributeGroup");
            try
            {
                #if DESKTOP
                return client.AssociateAttributeGroup(request);
                #elif CORECLR
                return client.AssociateAttributeGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Application { get; set; }
            public System.String AttributeGroup { get; set; }
            public System.Func<Amazon.AppRegistry.Model.AssociateAttributeGroupResponse, RegisterSCARAttributeGroupCmdlet, object> Select { get; set; } =
