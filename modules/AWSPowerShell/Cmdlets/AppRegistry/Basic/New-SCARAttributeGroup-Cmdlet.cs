...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    /// tools.
    /// </summary>
    [Cmdlet("New", "SCARAttributeGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewSCARAttributeGroupCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Key-value pairs you can use to associate with the attribute group.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-SCARAttributeGroup (CreateAttributeGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRegistry.Model.CreateAttributeGroupResponse, NewSCARAttributeGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRegistry.Model.CreateAttributeGroupRequest();
        ...
        private Amazon.AppRegistry.Model.CreateAttributeGroupResponse CallAWSServiceOperation(IAmazonAppRegistry client, Amazon.AppRegistry.Model.CreateAttributeGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog App Registry", "CreateAttributeGroup");
            try
            {
                return client.CreateAttributeGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AppRegistry.Model.CreateAttributeGroupResponse, NewSCARAttributeGroupCmdlet, object> Select { get; set; } =
