...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    public partial class RemoveSCARAttributeGroupCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.AttributeGroup), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SCARAttributeGroup (DeleteAttributeGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AppRegistry.Model.DeleteAttributeGroupResponse, RemoveSCARAttributeGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AppRegistry.Model.DeleteAttributeGroupRequest();
        ...
        private Amazon.AppRegistry.Model.DeleteAttributeGroupResponse CallAWSServiceOperation(IAmazonAppRegistry client, Amazon.AppRegistry.Model.DeleteAttributeGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Service Catalog App Registry", "DeleteAttributeGroup");
            try
            {
                #if DESKTOP
                return client.DeleteAttributeGroup(request);
                #elif CORECLR
                return client.DeleteAttributeGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AttributeGroup { get; set; }
            public System.Func<Amazon.AppRegistry.Model.DeleteAttributeGroupResponse, RemoveSCARAttributeGroupCmdlet, object> Select { get; set; } =
