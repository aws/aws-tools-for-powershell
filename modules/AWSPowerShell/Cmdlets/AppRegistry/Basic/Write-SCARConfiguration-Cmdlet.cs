...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    public partial class WriteSCARConfigurationCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TagQueryConfiguration_TagKey parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TagQueryConfiguration_TagKey' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TagQueryConfiguration_TagKey' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TagQueryConfiguration_TagKey;
            }
