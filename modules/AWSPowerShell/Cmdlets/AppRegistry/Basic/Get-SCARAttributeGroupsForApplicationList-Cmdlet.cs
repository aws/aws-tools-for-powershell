...
namespace Amazon.PowerShell.Cmdlets.SCAR
{
    ...
    /// The results display in pages.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.AppRegistry.Model.AttributeGroupDetails or Amazon.AppRegistry.Model.ListAttributeGroupsForApplicationResponse",
        ...
        "The service call response (type Amazon.AppRegistry.Model.ListAttributeGroupsForApplicationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetSCARAttributeGroupsForApplicationListCmdlet : AmazonAppRegistryClientCmdlet, IExecutor
    {
        ...
        private Amazon.AppRegistry.Model.ListAttributeGroupsForApplicationResponse CallAWSServiceOperation(IAmazonAppRegistry client, Amazon.AppRegistry.Model.ListAttributeGroupsForApplicationRequest request)
        {
            ...
            try
            {
                return client.ListAttributeGroupsForApplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
