...
namespace Amazon.PowerShell.Cmdlets.MOBL
{
    ...
    [AWSCmdlet("Calls the AWS Mobile DeleteProject API operation.", Operation = new[] {"DeleteProject"}, SelectReturnType = typeof(Amazon.Mobile.Model.DeleteProjectResponse))]
    [AWSCmdletOutput("Amazon.Mobile.Model.DeleteProjectResponse",
        "This cmdlet returns an Amazon.Mobile.Model.DeleteProjectResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveMOBLProjectCmdlet : AmazonMobileClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mobile.Model.DeleteProjectResponse, RemoveMOBLProjectCmdlet>(Select) ??
        ...
        {
            public System.String ProjectId { get; set; }
            public System.Func<Amazon.Mobile.Model.DeleteProjectResponse, RemoveMOBLProjectCmdlet, object> Select { get; set; } =
