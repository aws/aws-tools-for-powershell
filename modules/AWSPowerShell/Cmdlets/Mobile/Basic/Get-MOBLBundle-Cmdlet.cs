...
namespace Amazon.PowerShell.Cmdlets.MOBL
{
    ...
    /// </summary>
    [Cmdlet("Get", "MOBLBundle")]
    [OutputType("Amazon.Mobile.Model.BundleDetails")]
    [AWSCmdlet("Calls the AWS Mobile DescribeBundle API operation.", Operation = new[] {"DescribeBundle"}, SelectReturnType = typeof(Amazon.Mobile.Model.DescribeBundleResponse))]
    [AWSCmdletOutput("Amazon.Mobile.Model.BundleDetails or Amazon.Mobile.Model.DescribeBundleResponse",
        "This cmdlet returns an Amazon.Mobile.Model.BundleDetails object.",
        "The service call response (type Amazon.Mobile.Model.DescribeBundleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMOBLBundleCmdlet : AmazonMobileClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mobile.Model.DescribeBundleResponse, GetMOBLBundleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Mobile.Model.DescribeBundleRequest();
        ...
        private Amazon.Mobile.Model.DescribeBundleResponse CallAWSServiceOperation(IAmazonMobile client, Amazon.Mobile.Model.DescribeBundleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Mobile", "DescribeBundle");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String BundleId { get; set; }
            public System.Func<Amazon.Mobile.Model.DescribeBundleResponse, GetMOBLBundleCmdlet, object> Select { get; set; } =
