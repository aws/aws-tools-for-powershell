...
namespace Amazon.PowerShell.Cmdlets.MOBL
{
    ...
    [AWSCmdlet("Calls the AWS Mobile ExportProject API operation.", Operation = new[] {"ExportProject"}, SelectReturnType = typeof(Amazon.Mobile.Model.ExportProjectResponse))]
    [AWSCmdletOutput("Amazon.Mobile.Model.ExportProjectResponse",
        "This cmdlet returns an Amazon.Mobile.Model.ExportProjectResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ExportMOBLProjectCmdlet : AmazonMobileClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Mobile.Model.ExportProjectResponse, ExportMOBLProjectCmdlet>(Select) ??
        ...
        {
            public System.String ProjectId { get; set; }
            public System.Func<Amazon.Mobile.Model.ExportProjectResponse, ExportMOBLProjectCmdlet, object> Select { get; set; } =
