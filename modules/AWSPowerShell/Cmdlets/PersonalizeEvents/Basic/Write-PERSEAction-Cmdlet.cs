...
namespace Amazon.PowerShell.Cmdlets.PERSE
{
    ...
    /// </summary>
    [Cmdlet("Write", "PERSEAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Personalize Events PutActions API operation.", Operation = new[] {"PutActions"}, SelectReturnType = typeof(Amazon.PersonalizeEvents.Model.PutActionsResponse))]
    [AWSCmdletOutput("None or Amazon.PersonalizeEvents.Model.PutActionsResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.PersonalizeEvents.Model.PutActionsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WritePERSEActionCmdlet : AmazonPersonalizeEventsClientCmdlet, IExecutor
    {
        ...
        [Alias("Actions")]
        public Amazon.PersonalizeEvents.Model.Action[] Action { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-PERSEAction (PutActions)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.PersonalizeEvents.Model.PutActionsResponse, WritePERSEActionCmdlet>(Select) ??
            ...
            if (this.Action != null)
            {
                context.Action = new List<Amazon.PersonalizeEvents.Model.Action>(this.Action);
            }
            #if MODULAR
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.PersonalizeEvents.Model.PutActionsRequest();
        ...
        private Amazon.PersonalizeEvents.Model.PutActionsResponse CallAWSServiceOperation(IAmazonPersonalizeEvents client, Amazon.PersonalizeEvents.Model.PutActionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Personalize Events", "PutActions");
            try
            {
                #if DESKTOP
                return client.PutActions(request);
                #elif CORECLR
                return client.PutActionsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public List<Amazon.PersonalizeEvents.Model.Action> Action { get; set; }
            public System.String DatasetArn { get; set; }
            public System.Func<Amazon.PersonalizeEvents.Model.PutActionsResponse, WritePERSEActionCmdlet, object> Select { get; set; } =
