...
namespace Amazon.PowerShell.Cmdlets.TA
{
    ...
    public partial class UpdateTARecommendationLifecycleCmdlet : AmazonTrustedAdvisorClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RecommendationIdentifier parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RecommendationIdentifier' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RecommendationIdentifier' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
