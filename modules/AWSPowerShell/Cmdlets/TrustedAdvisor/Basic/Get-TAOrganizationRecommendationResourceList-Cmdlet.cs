...
namespace Amazon.PowerShell.Cmdlets.TA
{
    ...
    /// </summary>
    [Cmdlet("Get", "TAOrganizationRecommendationResourceList")]
    [OutputType("Amazon.TrustedAdvisor.Model.OrganizationRecommendationResourceSummary")]
    [AWSCmdlet("Calls the Trusted Advisor ListOrganizationRecommendationResources API operation.", Operation = new[] {"ListOrganizationRecommendationResources"}, SelectReturnType = typeof(Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse))]
    [AWSCmdletOutput("Amazon.TrustedAdvisor.Model.OrganizationRecommendationResourceSummary or Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse",
        "This cmdlet returns a collection of Amazon.TrustedAdvisor.Model.OrganizationRecommendationResourceSummary objects.",
        "The service call response (type Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTAOrganizationRecommendationResourceListCmdlet : AmazonTrustedAdvisorClientCmdlet, IExecutor
    {
        
        protected override bool IsGeneratedCmdlet { get; set; } = true;
        
        #region Parameter AffectedAccountId
        /// <summary>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OrganizationRecommendationResourceSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse, GetTAOrganizationRecommendationResourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesRequest();
        ...
        private Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse CallAWSServiceOperation(IAmazonTrustedAdvisor client, Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Trusted Advisor", "ListOrganizationRecommendationResources");
            try
            {
                #if DESKTOP
                return client.ListOrganizationRecommendationResources(request);
                #elif CORECLR
                return client.ListOrganizationRecommendationResourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String RegionCode { get; set; }
            public Amazon.TrustedAdvisor.ResourceStatus Status { get; set; }
            public System.Func<Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationResourcesResponse, GetTAOrganizationRecommendationResourceListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OrganizationRecommendationResourceSummaries;
        }
