...
namespace Amazon.PowerShell.Cmdlets.TA
{
    ...
    public partial class GetTAOrganizationRecommendationAccountListCmdlet : AmazonTrustedAdvisorClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AccountRecommendationLifecycleSummaries";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationAccountsResponse, GetTAOrganizationRecommendationAccountListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationAccountsRequest();
        ...
        private Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationAccountsResponse CallAWSServiceOperation(IAmazonTrustedAdvisor client, Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationAccountsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Trusted Advisor", "ListOrganizationRecommendationAccounts");
            try
            {
                #if DESKTOP
                return client.ListOrganizationRecommendationAccounts(request);
                #elif CORECLR
                return client.ListOrganizationRecommendationAccountsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String OrganizationRecommendationIdentifier { get; set; }
            public System.Func<Amazon.TrustedAdvisor.Model.ListOrganizationRecommendationAccountsResponse, GetTAOrganizationRecommendationAccountListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AccountRecommendationLifecycleSummaries;
        }
