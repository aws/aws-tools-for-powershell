...
namespace Amazon.PowerShell.Cmdlets.TA
{
    ...
    [AWSCmdlet("Calls the Trusted Advisor ListRecommendations API operation.", Operation = new[] {"ListRecommendations"}, SelectReturnType = typeof(Amazon.TrustedAdvisor.Model.ListRecommendationsResponse))]
    [AWSCmdletOutput("Amazon.TrustedAdvisor.Model.RecommendationSummary or Amazon.TrustedAdvisor.Model.ListRecommendationsResponse",
        "This cmdlet returns a collection of Amazon.TrustedAdvisor.Model.RecommendationSummary objects.",
        "The service call response (type Amazon.TrustedAdvisor.Model.ListRecommendationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetTARecommendationListCmdlet : AmazonTrustedAdvisorClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TrustedAdvisor.Model.ListRecommendationsResponse, GetTARecommendationListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TrustedAdvisor.Model.ListRecommendationsRequest();
        ...
        private Amazon.TrustedAdvisor.Model.ListRecommendationsResponse CallAWSServiceOperation(IAmazonTrustedAdvisor client, Amazon.TrustedAdvisor.Model.ListRecommendationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Trusted Advisor", "ListRecommendations");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.TrustedAdvisor.RecommendationStatus Status { get; set; }
            public Amazon.TrustedAdvisor.RecommendationType Type { get; set; }
            public System.Func<Amazon.TrustedAdvisor.Model.ListRecommendationsResponse, GetTARecommendationListCmdlet, object> Select { get; set; } =
