...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    [AWSCmdlet("Calls the Application Auto Scaling DeleteScheduledAction API operation.", Operation = new[] {"DeleteScheduledAction"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ScheduledActionName parameter. Otherwise, this cmdlet does not return any output. " +
    ...
    public partial class RemoveAASScheduledActionCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("ScheduledActionName", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ScheduledActionName;
        ...
        private Amazon.ApplicationAutoScaling.Model.DeleteScheduledActionResponse CallAWSServiceOperation(IAmazonApplicationAutoScaling client, Amazon.ApplicationAutoScaling.Model.DeleteScheduledActionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteScheduledActionAsync(request);
                return task.Result;
                #else
