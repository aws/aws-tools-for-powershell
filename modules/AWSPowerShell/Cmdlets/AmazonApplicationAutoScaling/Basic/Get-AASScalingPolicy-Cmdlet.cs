...
namespace Amazon.PowerShell.Cmdlets.AAS
{
    ...
    [AWSCmdlet("Invokes the DescribeScalingPolicies operation against Application Auto Scaling.", Operation = new[] {"DescribeScalingPolicies"})]
    ...
    public class GetAASScalingPolicyCmdlet : AmazonApplicationAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// by the cluster name, and then the service name, such as <code>service/default/sample-webapp</code>.
        ...
        /// with. The scalable dimension contains the service namespace, the resource type, and
        /// the scaling property, such as <code>ecs:service:DesiredCount</code> for the desired
        /// task count for an Amazon ECS service. If you specify a scalable dimension, you must
        /// also specify a resource ID.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.DescribeScalingPolicies(request);
