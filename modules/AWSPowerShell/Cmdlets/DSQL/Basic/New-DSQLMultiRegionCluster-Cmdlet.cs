...
namespace Amazon.PowerShell.Cmdlets.DSQL
{
    ...
    public partial class NewDSQLMultiRegionClusterCmdlet : AmazonDSQLClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^WitnessRegion' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.WitnessRegion;
            }
        ...
        private Amazon.DSQL.Model.CreateMultiRegionClustersResponse CallAWSServiceOperation(IAmazonDSQL client, Amazon.DSQL.Model.CreateMultiRegionClustersRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.CreateMultiRegionClusters(request);
                #elif CORECLR
                return client.CreateMultiRegionClustersAsync(request).GetAwaiter().GetResult();
                #else
