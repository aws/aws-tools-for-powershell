...
namespace Amazon.PowerShell.Cmdlets.DSQL
{
    ...
    /// </para></li></ul></dd></dl><dl><dt>dsql:PutWitnessRegion</dt><dd><para>
    ...
    public partial class UpdateDSQLClusterCmdlet : AmazonDSQLClientCmdlet, IExecutor
    {
        ...
        /// key for you.</para><para>To switch to the key owned by Amazon Web Services, specify the reserved value <c>AWS_OWNED_KMS_KEY</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
