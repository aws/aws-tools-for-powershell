#
# Module manifest for module 'AWS.Tools.DSQL'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.DSQL.dll'
    ...
    GUID = 'fc014fe2-b3bb-473c-923c-e3aa083294ce'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.DSQL.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.DSQL.Completers.psm1',
        'AWS.Tools.DSQL.Aliases.psm1'
    )
