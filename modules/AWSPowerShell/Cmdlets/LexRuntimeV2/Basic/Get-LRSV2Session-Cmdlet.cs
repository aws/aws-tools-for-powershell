...
namespace Amazon.PowerShell.Cmdlets.LRSV2
{
    ...
    public partial class GetLRSV2SessionCmdlet : AmazonLexRuntimeV2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.LexRuntimeV2.Model.GetSessionResponse, GetLRSV2SessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.LexRuntimeV2.Model.GetSessionRequest();
        ...
        private Amazon.LexRuntimeV2.Model.GetSessionResponse CallAWSServiceOperation(IAmazonLexRuntimeV2 client, Amazon.LexRuntimeV2.Model.GetSessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Lex Runtime V2", "GetSession");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LocaleId { get; set; }
            public System.String SessionId { get; set; }
            public System.Func<Amazon.LexRuntimeV2.Model.GetSessionResponse, GetLRSV2SessionCmdlet, object> Select { get; set; } =
