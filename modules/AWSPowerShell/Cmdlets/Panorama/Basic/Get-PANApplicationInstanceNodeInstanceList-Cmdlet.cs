...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANApplicationInstanceNodeInstanceList")]
    [OutputType("Amazon.Panorama.Model.NodeInstance")]
    [AWSCmdlet("Calls the AWS Panorama ListApplicationInstanceNodeInstances API operation.", Operation = new[] {"ListApplicationInstanceNodeInstances"}, SelectReturnType = typeof(Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse))]
    [AWSCmdletOutput("Amazon.Panorama.Model.NodeInstance or Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse",
        "This cmdlet returns a collection of Amazon.Panorama.Model.NodeInstance objects.",
        "The service call response (type Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPANApplicationInstanceNodeInstanceListCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NodeInstances";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse, GetPANApplicationInstanceNodeInstanceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesRequest();
        ...
        private Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "ListApplicationInstanceNodeInstances");
            try
            {
                #if DESKTOP
                return client.ListApplicationInstanceNodeInstances(request);
                #elif CORECLR
                return client.ListApplicationInstanceNodeInstancesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Panorama.Model.ListApplicationInstanceNodeInstancesResponse, GetPANApplicationInstanceNodeInstanceListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NodeInstances;
        }
