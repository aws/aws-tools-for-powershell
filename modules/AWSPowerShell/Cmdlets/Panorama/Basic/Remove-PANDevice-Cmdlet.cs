...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// Deletes a device.
    /// </summary>
    [Cmdlet("Remove", "PANDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemovePANDeviceCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PANDevice (DeleteDevice)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.DeleteDeviceResponse, RemovePANDeviceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.DeleteDeviceRequest();
        ...
        private Amazon.Panorama.Model.DeleteDeviceResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.DeleteDeviceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "DeleteDevice");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String DeviceId { get; set; }
            public System.Func<Amazon.Panorama.Model.DeleteDeviceResponse, RemovePANDeviceCmdlet, object> Select { get; set; } =
