...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANDeviceList")]
    [OutputType("Amazon.Panorama.Model.Device")]
    [AWSCmdlet("Calls the AWS Panorama ListDevices API operation.", Operation = new[] {"ListDevices"}, SelectReturnType = typeof(Amazon.Panorama.Model.ListDevicesResponse))]
    [AWSCmdletOutput("Amazon.Panorama.Model.Device or Amazon.Panorama.Model.ListDevicesResponse",
        "This cmdlet returns a collection of Amazon.Panorama.Model.Device objects.",
        "The service call response (type Amazon.Panorama.Model.ListDevicesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPANDeviceListCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        private Amazon.Panorama.Model.ListDevicesResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.ListDevicesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "ListDevices");
            try
            {
                #if DESKTOP
