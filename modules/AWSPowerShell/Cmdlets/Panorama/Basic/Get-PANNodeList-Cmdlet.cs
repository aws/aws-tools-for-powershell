...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    [AWSCmdletOutput("Amazon.Panorama.Model.Node or Amazon.Panorama.Model.ListNodesResponse",
        ...
        "The service call response (type Amazon.Panorama.Model.ListNodesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
