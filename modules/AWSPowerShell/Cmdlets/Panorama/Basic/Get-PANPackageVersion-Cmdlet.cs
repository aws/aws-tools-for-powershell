...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    public partial class GetPANPackageVersionCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.DescribePackageVersionResponse, GetPANPackageVersionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.DescribePackageVersionRequest();
        ...
        private Amazon.Panorama.Model.DescribePackageVersionResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.DescribePackageVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "DescribePackageVersion");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PackageVersion { get; set; }
            public System.String PatchVersion { get; set; }
            public System.Func<Amazon.Panorama.Model.DescribePackageVersionResponse, GetPANPackageVersionCmdlet, object> Select { get; set; } =
