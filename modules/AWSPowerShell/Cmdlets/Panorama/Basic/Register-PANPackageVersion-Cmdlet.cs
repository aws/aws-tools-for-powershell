...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Register", "PANPackageVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class RegisterPANPackageVersionCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        public System.Boolean? MarkLatest { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-PANPackageVersion (RegisterPackageVersion)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.RegisterPackageVersionResponse, RegisterPANPackageVersionCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            context.MarkLatest = this.MarkLatest;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.RegisterPackageVersionRequest();
            
            if (cmdletContext.MarkLatest != null)
            {
                request.MarkLatest = cmdletContext.MarkLatest.Value;
            }
        ...
        private Amazon.Panorama.Model.RegisterPackageVersionResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.RegisterPackageVersionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "RegisterPackageVersion");
            try
            {
                #if DESKTOP
                return client.RegisterPackageVersion(request);
                #elif CORECLR
                return client.RegisterPackageVersionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String PackageVersion { get; set; }
            public System.String PatchVersion { get; set; }
            public System.Func<Amazon.Panorama.Model.RegisterPackageVersionResponse, RegisterPANPackageVersionCmdlet, object> Select { get; set; } =
