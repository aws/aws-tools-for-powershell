...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANNode")]
    [OutputType("Amazon.Panorama.Model.DescribeNodeResponse")]
    [AWSCmdlet("Calls the AWS Panorama DescribeNode API operation.", Operation = new[] {"DescribeNode"}, SelectReturnType = typeof(Amazon.Panorama.Model.DescribeNodeResponse))]
    [AWSCmdletOutput("Amazon.Panorama.Model.DescribeNodeResponse",
        "This cmdlet returns an Amazon.Panorama.Model.DescribeNodeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPANNodeCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.DescribeNodeResponse, GetPANNodeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.DescribeNodeRequest();
        ...
        private Amazon.Panorama.Model.DescribeNodeResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.DescribeNodeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "DescribeNode");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String NodeId { get; set; }
            public System.String OwnerAccount { get; set; }
            public System.Func<Amazon.Panorama.Model.DescribeNodeResponse, GetPANNodeCmdlet, object> Select { get; set; } =
