...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANApplicationInstanceDependencyList")]
    [OutputType("Amazon.Panorama.Model.PackageObject")]
    [AWSCmdlet("Calls the AWS Panorama ListApplicationInstanceDependencies API operation.", Operation = new[] {"ListApplicationInstanceDependencies"}, SelectReturnType = typeof(Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse))]
    [AWSCmdletOutput("Amazon.Panorama.Model.PackageObject or Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse",
        "This cmdlet returns a collection of Amazon.Panorama.Model.PackageObject objects.",
        "The service call response (type Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPANApplicationInstanceDependencyListCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "PackageObjects";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse, GetPANApplicationInstanceDependencyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Panorama.Model.ListApplicationInstanceDependenciesRequest();
        ...
        private Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.ListApplicationInstanceDependenciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "ListApplicationInstanceDependencies");
            try
            {
                #if DESKTOP
                return client.ListApplicationInstanceDependencies(request);
                #elif CORECLR
                return client.ListApplicationInstanceDependenciesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Panorama.Model.ListApplicationInstanceDependenciesResponse, GetPANApplicationInstanceDependencyListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.PackageObjects;
        }
