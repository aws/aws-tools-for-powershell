...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANDevicesJobList")]
    [OutputType("Amazon.Panorama.Model.DeviceJob")]
    [AWSCmdlet("Calls the AWS Panorama ListDevicesJobs API operation.", Operation = new[] {"ListDevicesJobs"}, SelectReturnType = typeof(Amazon.Panorama.Model.ListDevicesJobsResponse))]
    [AWSCmdletOutput("Amazon.Panorama.Model.DeviceJob or Amazon.Panorama.Model.ListDevicesJobsResponse",
        "This cmdlet returns a collection of Amazon.Panorama.Model.DeviceJob objects.",
        "The service call response (type Amazon.Panorama.Model.ListDevicesJobsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetPANDevicesJobListCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeviceJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.ListDevicesJobsResponse, GetPANDevicesJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Panorama.Model.ListDevicesJobsRequest();
        ...
        private Amazon.Panorama.Model.ListDevicesJobsResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.ListDevicesJobsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "ListDevicesJobs");
            try
            {
                #if DESKTOP
                return client.ListDevicesJobs(request);
                #elif CORECLR
                return client.ListDevicesJobsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Panorama.Model.ListDevicesJobsResponse, GetPANDevicesJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeviceJobs;
        }
