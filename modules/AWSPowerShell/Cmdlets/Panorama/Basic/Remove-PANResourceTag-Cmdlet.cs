...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PANResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePANResourceTagCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Tag keys to remove.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PANResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.UntagResourceResponse, RemovePANResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.UntagResourceRequest();
        ...
        private Amazon.Panorama.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Panorama.Model.UntagResourceResponse, RemovePANResourceTagCmdlet, object> Select { get; set; } =
