...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Remove", "PANApplicationInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemovePANApplicationInstanceCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-PANApplicationInstance (RemoveApplicationInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.RemoveApplicationInstanceResponse, RemovePANApplicationInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.RemoveApplicationInstanceRequest();
        ...
        private Amazon.Panorama.Model.RemoveApplicationInstanceResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.RemoveApplicationInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "RemoveApplicationInstance");
            try
            {
                #if DESKTOP
                return client.RemoveApplicationInstance(request);
                #elif CORECLR
                return client.RemoveApplicationInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String ApplicationInstanceId { get; set; }
            public System.Func<Amazon.Panorama.Model.RemoveApplicationInstanceResponse, RemovePANApplicationInstanceCmdlet, object> Select { get; set; } =
