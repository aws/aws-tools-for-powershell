...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANNodeFromTemplateJobList")]
    [OutputType("Amazon.Panorama.Model.NodeFromTemplateJob")]
    ...
    public partial class GetPANNodeFromTemplateJobListCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "NodeFromTemplateJobs";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.ListNodeFromTemplateJobsResponse, GetPANNodeFromTemplateJobListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Panorama.Model.ListNodeFromTemplateJobsRequest();
        ...
        private Amazon.Panorama.Model.ListNodeFromTemplateJobsResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.ListNodeFromTemplateJobsRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Panorama.Model.ListNodeFromTemplateJobsResponse, GetPANNodeFromTemplateJobListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.NodeFromTemplateJobs;
        }
