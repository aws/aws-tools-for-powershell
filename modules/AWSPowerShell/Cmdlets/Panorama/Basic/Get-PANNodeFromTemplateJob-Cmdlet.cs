...
namespace Amazon.PowerShell.Cmdlets.PAN
{
    ...
    /// </summary>
    [Cmdlet("Get", "PANNodeFromTemplateJob")]
    ...
    public partial class GetPANNodeFromTemplateJobCmdlet : AmazonPanoramaClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Panorama.Model.DescribeNodeFromTemplateJobResponse, GetPANNodeFromTemplateJobCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Panorama.Model.DescribeNodeFromTemplateJobRequest();
        ...
        private Amazon.Panorama.Model.DescribeNodeFromTemplateJobResponse CallAWSServiceOperation(IAmazonPanorama client, Amazon.Panorama.Model.DescribeNodeFromTemplateJobRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Panorama", "DescribeNodeFromTemplateJob");
            try
            {
                #if DESKTOP
                return client.DescribeNodeFromTemplateJob(request);
                #elif CORECLR
                return client.DescribeNodeFromTemplateJobAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String JobId { get; set; }
            public System.Func<Amazon.Panorama.Model.DescribeNodeFromTemplateJobResponse, GetPANNodeFromTemplateJobCmdlet, object> Select { get; set; } =
