...
namespace Amazon.PowerShell.Cmdlets.RBIN
{
    ...
    public partial class AddRBINResourceTagCmdlet : AmazonRecycleBinClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-RBINResourceTag (TagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RecycleBin.Model.TagResourceResponse, AddRBINResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RecycleBin.Model.TagResourceRequest();
        ...
        private Amazon.RecycleBin.Model.TagResourceResponse CallAWSServiceOperation(IAmazonRecycleBin client, Amazon.RecycleBin.Model.TagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Recycle Bin", "TagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RecycleBin.Model.TagResourceResponse, AddRBINResourceTagCmdlet, object> Select { get; set; } =
