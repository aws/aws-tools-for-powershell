...
namespace Amazon.PowerShell.Cmdlets.RBIN
{
    ...
    public partial class RemoveRBINRuleCmdlet : AmazonRecycleBinClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RBINRule (DeleteRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RecycleBin.Model.DeleteRuleResponse, RemoveRBINRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RecycleBin.Model.DeleteRuleRequest();
        ...
        private Amazon.RecycleBin.Model.DeleteRuleResponse CallAWSServiceOperation(IAmazonRecycleBin client, Amazon.RecycleBin.Model.DeleteRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Recycle Bin", "DeleteRule");
            try
            {
        ...
        {
            public System.String Identifier { get; set; }
            public System.Func<Amazon.RecycleBin.Model.DeleteRuleResponse, RemoveRBINRuleCmdlet, object> Select { get; set; } =
