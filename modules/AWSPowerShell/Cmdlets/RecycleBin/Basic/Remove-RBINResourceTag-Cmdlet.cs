...
namespace Amazon.PowerShell.Cmdlets.RBIN
{
    ...
    public partial class RemoveRBINResourceTagCmdlet : AmazonRecycleBinClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RBINResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RecycleBin.Model.UntagResourceResponse, RemoveRBINResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RecycleBin.Model.UntagResourceRequest();
        ...
        private Amazon.RecycleBin.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonRecycleBin client, Amazon.RecycleBin.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Recycle Bin", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RecycleBin.Model.UntagResourceResponse, RemoveRBINResourceTagCmdlet, object> Select { get; set; } =
