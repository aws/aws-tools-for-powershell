...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public class DenyEC2VpcPeeringConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.RejectVpcPeeringConnectionResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.RejectVpcPeeringConnectionRequest request)
        {
