...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud AttachClassicLinkVpc API operation.", Operation = new[] {"AttachClassicLinkVpc"})]
    ...
    public partial class AddEC2ClassicLinkVpcCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "AttachClassicLinkVpc");
            try
            {
                #if DESKTOP
