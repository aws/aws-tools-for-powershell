...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public class RemoveEC2VpnConnectionRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.DeleteVpnConnectionRouteResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteVpnConnectionRouteRequest request)
        {
