...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the PurchaseHostReservation operation against Amazon Elastic Compute Cloud.", Operation = new[] {"PurchaseHostReservation"})]
    ...
    public partial class NewEC2HostReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.PurchaseHostReservationResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.PurchaseHostReservationRequest request)
        {
            #if DESKTOP
