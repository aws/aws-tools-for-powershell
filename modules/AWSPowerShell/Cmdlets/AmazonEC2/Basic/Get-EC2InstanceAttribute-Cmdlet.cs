...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeInstanceAttribute API operation.", Operation = new[] {"DescribeInstanceAttribute"})]
    ...
    public partial class GetEC2InstanceAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeInstanceAttribute");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeInstanceAttributeAsync(request);
                return task.Result;
                #else
