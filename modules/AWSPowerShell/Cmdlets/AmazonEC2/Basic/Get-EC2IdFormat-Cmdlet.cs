...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeIdFormat API operation.", Operation = new[] {"DescribeIdFormat"})]
    ...
    public partial class GetEC2IdFormatCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeIdFormat");
            try
            {
                #if DESKTOP
