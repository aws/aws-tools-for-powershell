...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2TransitGatewayRouteTable")]
    [OutputType("Amazon.EC2.Model.TransitGatewayRouteTable")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeTransitGatewayRouteTables API operation.", Operation = new[] {"DescribeTransitGatewayRouteTables"})]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayRouteTable",
        "This cmdlet returns a collection of TransitGatewayRouteTable objects.",
        "The service call response (type Amazon.EC2.Model.DescribeTransitGatewayRouteTablesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetEC2TransitGatewayRouteTableCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter]
        [Alias("TransitGatewayRouteTableIds")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.TransitGatewayRouteTableId != null)
            {
                context.TransitGatewayRouteTableIds = new List<System.String>(this.TransitGatewayRouteTableId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeTransitGatewayRouteTablesRequest();
            if (cmdletContext.Filters != null)
            {
                request.Filters = cmdletContext.Filters;
            }
            if (cmdletContext.TransitGatewayRouteTableIds != null)
            {
                request.TransitGatewayRouteTableIds = cmdletContext.TransitGatewayRouteTableIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TransitGatewayRouteTables;
                        ...
                        int _receivedThisCall = response.TransitGatewayRouteTables.Count;
        ...
        private Amazon.EC2.Model.DescribeTransitGatewayRouteTablesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeTransitGatewayRouteTablesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeTransitGatewayRouteTables");
            try
            {
                #if DESKTOP
                return client.DescribeTransitGatewayRouteTables(request);
                #elif CORECLR
                return client.DescribeTransitGatewayRouteTablesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> TransitGatewayRouteTableIds { get; set; }
        }
