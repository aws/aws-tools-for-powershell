...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ModifyVpcEndpointServiceConfiguration API operation.", Operation = new[] {"ModifyVpcEndpointServiceConfiguration"})]
    ...
    public partial class EditEC2VpcEndpointServiceConfigurationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.AddNetworkLoadBalancerArns = new List<System.String>(this.AddNetworkLoadBalancerArn);
            }
            if (this.RemoveNetworkLoadBalancerArn != null)
            {
                context.RemoveNetworkLoadBalancerArns = new List<System.String>(this.RemoveNetworkLoadBalancerArn);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.AddNetworkLoadBalancerArns != null)
            {
                request.AddNetworkLoadBalancerArns = cmdletContext.AddNetworkLoadBalancerArns;
            }
            if (cmdletContext.RemoveNetworkLoadBalancerArns != null)
            {
                request.RemoveNetworkLoadBalancerArns = cmdletContext.RemoveNetworkLoadBalancerArns;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ModifyVpcEndpointServiceConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.ModifyVpcEndpointServiceConfigurationAsync(request);
                return task.Result;
                #else
        ...
        {
            public System.Boolean? AcceptanceRequired { get; set; }
            public List<System.String> AddNetworkLoadBalancerArns { get; set; }
            public List<System.String> RemoveNetworkLoadBalancerArns { get; set; }
            public System.String ServiceId { get; set; }
        }
