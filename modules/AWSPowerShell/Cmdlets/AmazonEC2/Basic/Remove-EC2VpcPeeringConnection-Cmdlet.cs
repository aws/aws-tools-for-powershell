...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteVpcPeeringConnection API operation.", Operation = new[] {"DeleteVpcPeeringConnection"})]
    ...
    public partial class RemoveEC2VpcPeeringConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DeleteVpcPeeringConnection");
            try
            {
                #if DESKTOP
