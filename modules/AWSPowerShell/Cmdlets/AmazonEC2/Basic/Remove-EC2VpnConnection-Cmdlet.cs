...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteVpnConnection API operation.", Operation = new[] {"DeleteVpnConnection"})]
    ...
    public partial class RemoveEC2VpnConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DeleteVpnConnection");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteVpnConnectionAsync(request);
                return task.Result;
                #else
