...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DescribeFpgaImages operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeFpgaImages"})]
    ...
    public partial class GetEC2FpgaImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// is independent of the <code>tag-key</code> filter.</para></li><li><para><code>update-time</code> - The time of the most recent update.</para></li></ul>
        /// </para>
        /// </summary>
