...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EditEC2VolumeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.ModifyVolumeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ModifyVolumeRequest request)
        {
            #if DESKTOP
            return client.ModifyVolume(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ModifyVolumeAsync(request);
            return task.Result;
            #else
