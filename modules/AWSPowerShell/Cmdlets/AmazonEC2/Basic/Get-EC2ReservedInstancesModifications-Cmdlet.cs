...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2ReservedInstancesModificationsCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeReservedInstancesModifications");
            #if DESKTOP
            return client.DescribeReservedInstancesModifications(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeReservedInstancesModificationsAsync(request);
            return task.Result;
            #else
