...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class AddEC2InternetGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.AttachInternetGatewayResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AttachInternetGatewayRequest request)
        {
            #if DESKTOP
            return client.AttachInternetGateway(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.AttachInternetGatewayAsync(request);
            return task.Result;
            #else
