...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class EnableEC2VpcClassicLinkCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.EnableVpcClassicLinkResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.EnableVpcClassicLinkRequest request)
        {
            #if DESKTOP
