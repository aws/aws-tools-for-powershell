...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ReplaceNetworkAclEntry API operation.", Operation = new[] {"ReplaceNetworkAclEntry"})]
    ...
    public partial class SetEC2NetworkAclEntryCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The IP protocol. You can specify <code>all</code> or <code>-1</code> to mean all protocols.
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ReplaceNetworkAclEntry");
            try
            {
                #if DESKTOP
                ...
                var task = client.ReplaceNetworkAclEntryAsync(request);
                return task.Result;
                #else
