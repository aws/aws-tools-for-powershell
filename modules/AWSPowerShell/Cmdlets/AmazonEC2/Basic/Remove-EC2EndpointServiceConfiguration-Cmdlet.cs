...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteVpcEndpointServiceConfigurations API operation.", Operation = new[] {"DeleteVpcEndpointServiceConfigurations"})]
    ...
    public partial class RemoveEC2EndpointServiceConfigurationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DeleteVpcEndpointServiceConfigurations");
            try
            {
                #if DESKTOP
