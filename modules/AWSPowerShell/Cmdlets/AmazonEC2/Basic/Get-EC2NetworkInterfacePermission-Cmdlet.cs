...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2NetworkInterfacePermission")]
    [OutputType("Amazon.EC2.Model.NetworkInterfacePermission")]
    [AWSCmdlet("Invokes the DescribeNetworkInterfacePermissions operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeNetworkInterfacePermissions"})]
    [AWSCmdletOutput("Amazon.EC2.Model.NetworkInterfacePermission",
        "This cmdlet returns a collection of NetworkInterfacePermission objects.",
    ...
    public partial class GetEC2NetworkInterfacePermissionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter]
        [Alias("NetworkInterfacePermissionIds")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.NetworkInterfacePermissionIds = new List<System.String>(this.NetworkInterfacePermissionId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeNetworkInterfacePermissionsRequest();
            if (cmdletContext.Filters != null)
            {
                request.Filters = cmdletContext.Filters;
            }
            if (cmdletContext.NetworkInterfacePermissionIds != null)
            {
                request.NetworkInterfacePermissionIds = cmdletContext.NetworkInterfacePermissionIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.NetworkInterfacePermissions;
        ...
        private Amazon.EC2.Model.DescribeNetworkInterfacePermissionsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeNetworkInterfacePermissionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeNetworkInterfacePermissions");
            #if DESKTOP
            return client.DescribeNetworkInterfacePermissions(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeNetworkInterfacePermissionsAsync(request);
            return task.Result;
            #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public List<System.String> NetworkInterfacePermissionIds { get; set; }
            public System.String NextToken { get; set; }
        }
