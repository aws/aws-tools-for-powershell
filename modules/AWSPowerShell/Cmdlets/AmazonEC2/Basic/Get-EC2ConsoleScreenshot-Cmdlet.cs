...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2ConsoleScreenshotCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.GetConsoleScreenshotResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.GetConsoleScreenshotRequest request)
        {
            #if DESKTOP
