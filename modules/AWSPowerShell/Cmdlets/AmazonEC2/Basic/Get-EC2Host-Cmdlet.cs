...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeHosts API operation.", Operation = new[] {"DescribeHosts"}, LegacyAlias="Get-EC2Hosts")]
    ...
    public partial class GetEC2HostCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeHostsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeHostsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeHostsAsync(request).GetAwaiter().GetResult();
                #else
