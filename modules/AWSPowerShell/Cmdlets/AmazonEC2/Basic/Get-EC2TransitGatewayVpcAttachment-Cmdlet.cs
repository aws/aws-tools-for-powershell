...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2TransitGatewayVpcAttachment")]
    [OutputType("Amazon.EC2.Model.TransitGatewayVpcAttachment")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeTransitGatewayVpcAttachments API operation.", Operation = new[] {"DescribeTransitGatewayVpcAttachments"})]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayVpcAttachment",
        "This cmdlet returns a collection of TransitGatewayVpcAttachment objects.",
        "The service call response (type Amazon.EC2.Model.DescribeTransitGatewayVpcAttachmentsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetEC2TransitGatewayVpcAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeTransitGatewayVpcAttachmentsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.TransitGatewayVpcAttachments;
                        ...
                        int _receivedThisCall = response.TransitGatewayVpcAttachments.Count;
        ...
        private Amazon.EC2.Model.DescribeTransitGatewayVpcAttachmentsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeTransitGatewayVpcAttachmentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeTransitGatewayVpcAttachments");
            try
            {
                #if DESKTOP
                return client.DescribeTransitGatewayVpcAttachments(request);
                #elif CORECLR
                return client.DescribeTransitGatewayVpcAttachmentsAsync(request).GetAwaiter().GetResult();
                #else
