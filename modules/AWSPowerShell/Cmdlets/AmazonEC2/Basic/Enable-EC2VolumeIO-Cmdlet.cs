...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Enable", "EC2VolumeIO", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud EnableVolumeIO API operation.", Operation = new[] {"EnableVolumeIO"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.EC2.Model.EnableVolumeIOResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class EnableEC2VolumeIOCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Enable-EC2VolumeIO (EnableVolumeIO)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.EnableVolumeIORequest();
        ...
        private Amazon.EC2.Model.EnableVolumeIOResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.EnableVolumeIORequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.EnableVolumeIOAsync(request).GetAwaiter().GetResult();
                #else
