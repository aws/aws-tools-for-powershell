...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2RouteTable", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteRouteTable API operation.", Operation = new[] {"DeleteRouteTable"})]
    ...
    public partial class RemoveEC2RouteTableCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2RouteTable (DeleteRouteTable)"))
            {
                return;
            }
        ...
        private Amazon.EC2.Model.DeleteRouteTableResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteRouteTableRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteRouteTableAsync(request).GetAwaiter().GetResult();
                #else
