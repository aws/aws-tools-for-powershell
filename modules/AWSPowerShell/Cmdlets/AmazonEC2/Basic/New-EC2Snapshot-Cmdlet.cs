...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud CreateSnapshot API operation.", Operation = new[] {"CreateSnapshot"})]
    ...
    public partial class NewEC2SnapshotCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "CreateSnapshot");
            try
            {
                #if DESKTOP
