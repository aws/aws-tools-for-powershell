...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2PrefixListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.PrefixListIds != null)
            {
                request.PrefixListIds = cmdletContext.PrefixListIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.PrefixLists.Count;
        ...
        private Amazon.EC2.Model.DescribePrefixListsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribePrefixListsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribePrefixListsAsync(request).GetAwaiter().GetResult();
                #else
