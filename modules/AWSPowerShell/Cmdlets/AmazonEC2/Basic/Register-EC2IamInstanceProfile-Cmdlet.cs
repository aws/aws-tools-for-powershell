...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Register", "EC2IamInstanceProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EC2.Model.IamInstanceProfileAssociation")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud AssociateIamInstanceProfile API operation.", Operation = new[] {"AssociateIamInstanceProfile"})]
    [AWSCmdletOutput("Amazon.EC2.Model.IamInstanceProfileAssociation",
        "This cmdlet returns a IamInstanceProfileAssociation object.",
        "The service call response (type Amazon.EC2.Model.AssociateIamInstanceProfileResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RegisterEC2IamInstanceProfileCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Register-EC2IamInstanceProfile (AssociateIamInstanceProfile)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.AssociateIamInstanceProfileRequest();
        ...
        private Amazon.EC2.Model.AssociateIamInstanceProfileResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.AssociateIamInstanceProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "AssociateIamInstanceProfile");
            try
            {
                #if DESKTOP
                return client.AssociateIamInstanceProfile(request);
                #elif CORECLR
                return client.AssociateIamInstanceProfileAsync(request).GetAwaiter().GetResult();
                #else
