...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeVpcEndpointServiceConfigurations API operation.", Operation = new[] {"DescribeVpcEndpointServiceConfigurations"})]
    [AWSCmdletOutput("Amazon.EC2.Model.ServiceConfiguration",
        "This cmdlet returns a collection of ServiceConfiguration objects.",
    ...
    public partial class GetEC2EndpointServiceConfigurationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters.</para><ul><li><para><code>service-name</code> - The ARN of the service.</para></li><li><para><code>vpc-endpoint-service-id</code> - The ID of the service.</para></li><li><para><code>vpc-endpoint-service-state</code> - The state of the service (<code>Pending</code>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.ServiceIds = new List<System.String>(this.ServiceId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.ServiceIds != null)
            {
                request.ServiceIds = cmdletContext.ServiceIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ServiceConfigurations;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeVpcEndpointServiceConfigurations");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeVpcEndpointServiceConfigurationsAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> ServiceIds { get; set; }
        }
