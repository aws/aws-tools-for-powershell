...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DescribeExportTasks operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeExportTasks"}, LegacyAlias="Get-EC2ExportTasks")]
