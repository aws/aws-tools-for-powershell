...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud AcceptReservedInstancesExchangeQuote API operation.", Operation = new[] {"AcceptReservedInstancesExchangeQuote"})]
    ...
    public partial class ConfirmEC2ReservedInstancesExchangeQuoteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "AcceptReservedInstancesExchangeQuote");
            try
            {
                #if DESKTOP
