...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud CreateDefaultSubnet API operation.", Operation = new[] {"CreateDefaultSubnet"})]
    ...
    public partial class NewEC2DefaultSubnetCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("AvailabilityZone", MyInvocation.BoundParameters);
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "CreateDefaultSubnet");
            try
            {
                #if DESKTOP
                ...
                var task = client.CreateDefaultSubnetAsync(request);
                return task.Result;
                #else
