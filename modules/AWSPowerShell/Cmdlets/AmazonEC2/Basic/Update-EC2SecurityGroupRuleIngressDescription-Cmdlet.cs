...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the UpdateSecurityGroupRuleDescriptionsIngress operation against Amazon Elastic Compute Cloud.", Operation = new[] {"UpdateSecurityGroupRuleDescriptionsIngress"})]
    ...
    public partial class UpdateEC2SecurityGroupRuleIngressDescriptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateSecurityGroupRuleDescriptionsIngressAsync(request);
                return task.Result;
                #else
