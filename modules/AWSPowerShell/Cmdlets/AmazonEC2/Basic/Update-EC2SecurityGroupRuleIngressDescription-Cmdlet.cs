...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud UpdateSecurityGroupRuleDescriptionsIngress API operation.", Operation = new[] {"UpdateSecurityGroupRuleDescriptionsIngress"})]
    [AWSCmdletOutput("System.Boolean",
        "This cmdlet returns a Boolean object.",
        "The service call response (type Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateEC2SecurityGroupRuleIngressDescriptionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-EC2SecurityGroupRuleIngressDescription (UpdateSecurityGroupRuleDescriptionsIngress)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressRequest();
        ...
        private Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.UpdateSecurityGroupRuleDescriptionsIngressRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "UpdateSecurityGroupRuleDescriptionsIngress");
            try
            {
                #if DESKTOP
                return client.UpdateSecurityGroupRuleDescriptionsIngress(request);
                #elif CORECLR
                return client.UpdateSecurityGroupRuleDescriptionsIngressAsync(request).GetAwaiter().GetResult();
                #else
