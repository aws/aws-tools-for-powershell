...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public class ResetEC2NetworkInterfaceAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.ResetNetworkInterfaceAttributeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ResetNetworkInterfaceAttributeRequest request)
        {
