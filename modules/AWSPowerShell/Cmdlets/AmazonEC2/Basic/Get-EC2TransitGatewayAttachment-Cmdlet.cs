...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2TransitGatewayAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more filters. The possible values are:</para><ul><li><para><code>association-id</code> - The ID of the association.</para></li><li><para><code>association-route-table-id</code> - The ID of the route table for the transit
        /// gateway.</para></li><li><para><code>associate-state</code> - The state of the association (<code>associating</code>
        /// | <code>associated</code> | <code>disassociating</code>).</para></li><li><para><code>resource-id</code> - The ID of the resource.</para></li><li><para><code>resource-type</code> - The resource type (<code>vpc</code> | <code>vpn</code>).</para></li><li><para><code>state</code> - The state of the attachment (<code>pendingAcceptance</code>
        /// | <code>pending</code> | <code>available</code> | <code>modifying</code> | <code>deleting</code>
        /// | <code>deleted</code> | <code>failed</code> | <code>rejected</code>).</para></li><li><para><code>transit-gateway-attachment-id</code> - The ID of the attachment.</para></li><li><para><code>transit-gateway-id</code> - The ID of the transit gateway.</para></li><li><para><code>transit-gateway-owner</code> - The ID of the AWS account that owns the transit
        /// gateway.</para></li></ul>
        /// </para>
        /// </summary>
        ...
        private Amazon.EC2.Model.DescribeTransitGatewayAttachmentsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeTransitGatewayAttachmentsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeTransitGatewayAttachmentsAsync(request);
                return task.Result;
                #else
