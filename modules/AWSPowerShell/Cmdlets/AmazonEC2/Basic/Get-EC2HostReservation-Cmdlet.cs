...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeHostReservations API operation.", Operation = new[] {"DescribeHostReservations"})]
    ...
    public partial class GetEC2HostReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeHostReservations");
            try
            {
                #if DESKTOP
