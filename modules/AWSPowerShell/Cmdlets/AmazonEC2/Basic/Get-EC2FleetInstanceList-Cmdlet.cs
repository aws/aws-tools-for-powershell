...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeFleetInstances API operation.", Operation = new[] {"DescribeFleetInstances"})]
    [AWSCmdletOutput("Amazon.EC2.Model.ActiveInstance",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: FleetId (type System.String), NextToken (type System.String)"
    )]
    public partial class GetEC2FleetInstanceListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeFleetInstances");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeFleetInstancesAsync(request);
                return task.Result;
                #else
