...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type EnableVgwRoutePropagationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class EnableEC2VgwRoutePropagationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new EnableVgwRoutePropagationRequest();
            ...
            try
            {
                var response = client.EnableVgwRoutePropagation(request);
