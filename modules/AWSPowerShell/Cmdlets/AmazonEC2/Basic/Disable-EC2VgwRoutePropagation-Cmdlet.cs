...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DisableVgwRoutePropagation API operation.", Operation = new[] {"DisableVgwRoutePropagation"})]
    ...
    public partial class DisableEC2VgwRoutePropagationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DisableVgwRoutePropagation");
            try
            {
                #if DESKTOP
