...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ClassicLinkInstance",
        ...
        "The service call response (type DescribeClassicLinkInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetEC2ClassicLinkInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new DescribeClassicLinkInstancesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        var response = client.DescribeClassicLinkInstances(request);
