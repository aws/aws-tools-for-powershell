...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DescribeClassicLinkInstances operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeClassicLinkInstances"})]
    ...
    public partial class GetEC2ClassicLinkInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeClassicLinkInstancesResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeClassicLinkInstancesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeClassicLinkInstancesAsync(request);
                return task.Result;
                #else
