...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Get", "EC2EndpointConnectionNotification")]
    [OutputType("Amazon.EC2.Model.ConnectionNotification")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeVpcEndpointConnectionNotifications API operation.", Operation = new[] {"DescribeVpcEndpointConnectionNotifications"})]
    [AWSCmdletOutput("Amazon.EC2.Model.ConnectionNotification",
        "This cmdlet returns a collection of ConnectionNotification objects.",
        "The service call response (type Amazon.EC2.Model.DescribeVpcEndpointConnectionNotificationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetEC2EndpointConnectionNotificationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeVpcEndpointConnectionNotificationsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ConnectionNotificationSet;
                        ...
                        int _receivedThisCall = response.ConnectionNotificationSet.Count;
        ...
        private Amazon.EC2.Model.DescribeVpcEndpointConnectionNotificationsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVpcEndpointConnectionNotificationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeVpcEndpointConnectionNotifications");
            try
            {
                #if DESKTOP
                return client.DescribeVpcEndpointConnectionNotifications(request);
                #elif CORECLR
                return client.DescribeVpcEndpointConnectionNotificationsAsync(request).GetAwaiter().GetResult();
                #else
