...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud CreateNetworkAclEntry API operation.", Operation = new[] {"CreateNetworkAclEntry"})]
    ...
    public partial class NewEC2NetworkAclEntryCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "CreateNetworkAclEntry");
            try
            {
                #if DESKTOP
                ...
                var task = client.CreateNetworkAclEntryAsync(request);
                return task.Result;
                #else
