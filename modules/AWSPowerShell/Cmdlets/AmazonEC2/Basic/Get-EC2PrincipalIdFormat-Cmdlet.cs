...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribePrincipalIdFormat API operation.", Operation = new[] {"DescribePrincipalIdFormat"})]
    [AWSCmdletOutput("Amazon.EC2.Model.PrincipalIdFormat",
        "This cmdlet returns a collection of PrincipalIdFormat objects.",
    ...
    public partial class GetEC2PrincipalIdFormatCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribePrincipalIdFormat");
            try
            {
                #if DESKTOP
