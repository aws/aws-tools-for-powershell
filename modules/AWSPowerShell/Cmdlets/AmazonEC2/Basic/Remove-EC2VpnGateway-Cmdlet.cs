...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2VpnGateway", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteVpnGateway API operation.", Operation = new[] {"DeleteVpnGateway"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the VpnGatewayId parameter. Otherwise, this cmdlet does not return any output. " +
        "The service response (type Amazon.EC2.Model.DeleteVpnGatewayResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2VpnGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2VpnGateway (DeleteVpnGateway)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteVpnGatewayRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.VpnGatewayId;
        ...
        private Amazon.EC2.Model.DeleteVpnGatewayResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteVpnGatewayRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DeleteVpnGatewayAsync(request).GetAwaiter().GetResult();
                #else
