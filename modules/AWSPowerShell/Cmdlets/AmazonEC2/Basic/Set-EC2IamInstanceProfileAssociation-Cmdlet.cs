...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the ReplaceIamInstanceProfileAssociation operation against Amazon Elastic Compute Cloud.", Operation = new[] {"ReplaceIamInstanceProfileAssociation"})]
    ...
    public partial class SetEC2IamInstanceProfileAssociationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.ReplaceIamInstanceProfileAssociationResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ReplaceIamInstanceProfileAssociationRequest request)
        {
            #if DESKTOP
