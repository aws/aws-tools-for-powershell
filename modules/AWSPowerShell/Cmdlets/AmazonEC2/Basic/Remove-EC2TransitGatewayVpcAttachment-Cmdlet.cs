...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteTransitGatewayVpcAttachment API operation.", Operation = new[] {"DeleteTransitGatewayVpcAttachment"})]
    ...
    public partial class RemoveEC2TransitGatewayVpcAttachmentCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DeleteTransitGatewayVpcAttachment");
            try
            {
                #if DESKTOP
