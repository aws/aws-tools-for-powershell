...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ApplySecurityGroupsToClientVpnTargetNetwork API operation.", Operation = new[] {"ApplySecurityGroupsToClientVpnTargetNetwork"})]
    ...
    public partial class AddEC2SecurityGroupToClientVpnTargetNetworkCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ApplySecurityGroupsToClientVpnTargetNetwork");
            try
            {
                #if DESKTOP
                return client.ApplySecurityGroupsToClientVpnTargetNetwork(request);
                #elif CORECLR
                return client.ApplySecurityGroupsToClientVpnTargetNetworkAsync(request).GetAwaiter().GetResult();
                #else
