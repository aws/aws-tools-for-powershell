...
{
    /// <summary>
    /// Describes one or more of your EC2 Fleets.<br/><br/>This operation automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output.
    /// </summary>
    [Cmdlet("Get", "EC2FleetList")]
    [OutputType("Amazon.EC2.Model.FleetData")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeFleets API operation.", Operation = new[] {"DescribeFleets"})]
    [AWSCmdletOutput("Amazon.EC2.Model.FleetData",
        "This cmdlet returns a collection of FleetData objects.",
        "The service call response (type Amazon.EC2.Model.DescribeFleetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetEC2FleetListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.EC2.Model.DescribeFleetsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Fleets;
                        ...
                        int _receivedThisCall = response.Fleets.Count;
        ...
        private Amazon.EC2.Model.DescribeFleetsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeFleetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeFleets");
            try
            {
                #if DESKTOP
                return client.DescribeFleets(request);
                #elif CORECLR
                return client.DescribeFleetsAsync(request).GetAwaiter().GetResult();
                #else
