...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class ResetEC2FpgaImageAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ResetFpgaImageAttribute");
            try
            {
                #if DESKTOP
                ...
                var task = client.ResetFpgaImageAttributeAsync(request);
                return task.Result;
                #else
