...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DescribeNatGateways operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeNatGateways"})]
    ...
    public partial class GetEC2NatGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// | <code>available</code> | <code>deleting</code> | <code>deleted</code>).</para></li><li><para><code>subnet-id</code> - The ID of the subnet in which the NAT gateway resides.</para></li><li><para><code>tag</code>:<i>key</i>=<i>value</i> - The key/value combination of a tag assigned
        ...
        /// is independent of the <code>tag-key</code> filter.</para></li><li><para><code>vpc-id</code> - The ID of the VPC in which the NAT gateway resides.</para></li></ul>
        /// </para>
        /// </summary>
        ...
        private Amazon.EC2.Model.DescribeNatGatewaysResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeNatGatewaysRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeNatGatewaysAsync(request);
                return task.Result;
                #else
