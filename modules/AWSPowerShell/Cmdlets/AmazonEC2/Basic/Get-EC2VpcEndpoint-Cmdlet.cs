...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DescribeVpcEndpoints operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DescribeVpcEndpoints"})]
    [AWSCmdletOutput("Amazon.EC2.Model.VpcEndpoint",
        "This cmdlet returns a collection of VpcEndpoint objects.",
    ...
    public partial class GetEC2VpcEndpointCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.VpcEndpoints;
        ...
        private static Amazon.EC2.Model.DescribeVpcEndpointsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeVpcEndpointsRequest request)
        {
            #if DESKTOP
            return client.DescribeVpcEndpoints(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeVpcEndpointsAsync(request);
            return task.Result;
            #else
