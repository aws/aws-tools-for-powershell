...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DetachVpnGateway API operation.", Operation = new[] {"DetachVpnGateway"})]
    ...
    public partial class DismountEC2VpnGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DetachVpnGateway");
            try
            {
                #if DESKTOP
