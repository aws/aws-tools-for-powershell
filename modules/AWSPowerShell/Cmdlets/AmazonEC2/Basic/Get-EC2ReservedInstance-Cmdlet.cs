...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeReservedInstances API operation.", Operation = new[] {"DescribeReservedInstances"})]
    ...
    public partial class GetEC2ReservedInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeReservedInstances");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeReservedInstancesAsync(request);
                return task.Result;
                #else
