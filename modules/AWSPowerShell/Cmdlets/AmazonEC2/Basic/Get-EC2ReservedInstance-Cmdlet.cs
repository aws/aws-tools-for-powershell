...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ReservedInstances",
        ...
        "The service call response (type DescribeReservedInstancesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class GetEC2ReservedInstanceCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        /// in seconds (<code>31536000</code> | <code>94608000</code>).</para></li><li><para><code>end</code> - The time when the Reserved Instance expires (for example, 2014-08-07T11:54:42.000Z).</para></li><li><para><code>fixed-price</code> - The purchase price of the Reserved Instance (for example,
        /// 9800.0).</para></li><li><para><code>instance-type</code> - The instance type on which the Reserved Instance can
        /// be used.</para></li><li><para><code>product-description</code> - The product description of the Reserved Instance
        /// (<code>Linux/UNIX</code> | <code>Linux/UNIX (Amazon VPC)</code> | <code>Windows</code>
        /// | <code>Windows (Amazon VPC)</code>).</para></li><li><para><code>reserved-instances-id</code> - The ID of the Reserved Instance.</para></li><li><para><code>start</code> - The time at which the Reserved Instance purchase request was
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new DescribeReservedInstancesRequest();
