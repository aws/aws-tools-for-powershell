...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud CreateTransitGateway API operation.", Operation = new[] {"CreateTransitGateway"})]
    ...
    public partial class NewEC2TransitGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ParameterWasBound("Options_AmazonSideAsn"))
                context.Options_AmazonSideAsn = this.Options_AmazonSideAsn;
            context.Options_AutoAcceptSharedAttachments = this.Options_AutoAcceptSharedAttachment;
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.Options_AutoAcceptSharedAttachments != null)
            {
                requestOptions_options_AutoAcceptSharedAttachment = cmdletContext.Options_AutoAcceptSharedAttachments;
            }
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "CreateTransitGateway");
            try
            {
                #if DESKTOP
                ...
                var task = client.CreateTransitGatewayAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Description { get; set; }
            public System.Int64? Options_AmazonSideAsn { get; set; }
            public Amazon.EC2.AutoAcceptSharedAttachmentsValue Options_AutoAcceptSharedAttachments { get; set; }
            public Amazon.EC2.DefaultRouteTableAssociationValue Options_DefaultRouteTableAssociation { get; set; }
            public Amazon.EC2.DefaultRouteTablePropagationValue Options_DefaultRouteTablePropagation { get; set; }
            public Amazon.EC2.DnsSupportValue Options_DnsSupport { get; set; }
            public Amazon.EC2.VpnEcmpSupportValue Options_VpnEcmpSupport { get; set; }
