...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeClientVpnAuthorizationRules API operation.", Operation = new[] {"DescribeClientVpnAuthorizationRules"})]
    [AWSCmdletOutput("Amazon.EC2.Model.AuthorizationRule",
        "This cmdlet returns a collection of AuthorizationRule objects.",
    ...
    public partial class GetEC2ClientVpnAuthorizationRuleCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.AuthorizationRules;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeClientVpnAuthorizationRules");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeClientVpnAuthorizationRulesAsync(request);
                return task.Result;
                #else
