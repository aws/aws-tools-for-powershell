...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class DismountEC2InternetGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Dismount-EC2InternetGateway (DetachInternetGateway)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DetachInternetGatewayRequest();
        ...
        private Amazon.EC2.Model.DetachInternetGatewayResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DetachInternetGatewayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DetachInternetGateway");
            try
            {
                #if DESKTOP
                return client.DetachInternetGateway(request);
                #elif CORECLR
                return client.DetachInternetGatewayAsync(request).GetAwaiter().GetResult();
                #else
