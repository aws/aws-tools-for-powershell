...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class DismountEC2InternetGatewayCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.DetachInternetGatewayResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DetachInternetGatewayRequest request)
        {
            #if DESKTOP
