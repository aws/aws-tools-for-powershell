...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ReplaceTransitGatewayRoute API operation.", Operation = new[] {"ReplaceTransitGatewayRoute"})]
    ...
    public partial class SetEC2TransitGatewayRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ReplaceTransitGatewayRoute");
            try
            {
                #if DESKTOP
                ...
                var task = client.ReplaceTransitGatewayRouteAsync(request);
                return task.Result;
                #else
