...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeCapacityReservations API operation.", Operation = new[] {"DescribeCapacityReservations"})]
    [AWSCmdletOutput("Amazon.EC2.Model.CapacityReservation",
        "This cmdlet returns a collection of CapacityReservation objects.",
    ...
    public partial class GetEC2CapacityReservationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.CapacityReservationIds = new List<System.String>(this.CapacityReservationId);
            }
            if (this.Filter != null)
            {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.CapacityReservationIds != null)
            {
                request.CapacityReservationIds = cmdletContext.CapacityReservationIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CapacityReservations;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeCapacityReservations");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeCapacityReservationsAsync(request);
                return task.Result;
                #else
        ...
        {
            public List<System.String> CapacityReservationIds { get; set; }
