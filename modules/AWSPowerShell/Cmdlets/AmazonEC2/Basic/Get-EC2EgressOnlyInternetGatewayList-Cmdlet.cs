...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2EgressOnlyInternetGatewayListCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.EgressOnlyInternetGatewayIds = new List<System.String>(this.EgressOnlyInternetGatewayId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.EgressOnlyInternetGatewayIds != null)
            {
                request.EgressOnlyInternetGatewayIds = cmdletContext.EgressOnlyInternetGatewayIds;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.EgressOnlyInternetGateways;
        ...
        {
            public List<System.String> EgressOnlyInternetGatewayIds { get; set; }
