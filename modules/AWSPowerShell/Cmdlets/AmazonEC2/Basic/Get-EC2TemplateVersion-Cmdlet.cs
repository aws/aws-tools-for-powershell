...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeLaunchTemplateVersions API operation.", Operation = new[] {"DescribeLaunchTemplateVersions"})]
    [AWSCmdletOutput("Amazon.EC2.Model.LaunchTemplateVersion",
        "This cmdlet returns a collection of LaunchTemplateVersion objects.",
    ...
    public partial class GetEC2TemplateVersionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.LaunchTemplateVersions;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeLaunchTemplateVersions");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeLaunchTemplateVersionsAsync(request);
                return task.Result;
                #else
