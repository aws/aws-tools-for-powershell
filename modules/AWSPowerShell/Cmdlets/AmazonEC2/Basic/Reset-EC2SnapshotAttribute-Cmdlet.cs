...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ResetSnapshotAttribute API operation.", Operation = new[] {"ResetSnapshotAttribute"})]
    ...
    public partial class ResetEC2SnapshotAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.ResetSnapshotAttributeResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.ResetSnapshotAttributeRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ResetSnapshotAttributeAsync(request).GetAwaiter().GetResult();
                #else
