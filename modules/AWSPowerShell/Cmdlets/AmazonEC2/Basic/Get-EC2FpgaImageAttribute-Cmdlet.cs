...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class GetEC2FpgaImageAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeFpgaImageAttribute");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeFpgaImageAttributeAsync(request);
                return task.Result;
                #else
