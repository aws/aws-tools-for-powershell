...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud RejectVpcEndpointConnections API operation.", Operation = new[] {"RejectVpcEndpointConnections"})]
    ...
    public partial class DenyEC2EndpointConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "RejectVpcEndpointConnections");
            try
            {
                #if DESKTOP
