...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    public partial class ApproveEC2VpcPeeringConnectionCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "AcceptVpcPeeringConnection");
            #if DESKTOP
            return client.AcceptVpcPeeringConnection(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.AcceptVpcPeeringConnectionAsync(request);
            return task.Result;
            #else
