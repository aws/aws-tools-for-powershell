...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeVolumeAttribute API operation.", Operation = new[] {"DescribeVolumeAttribute"})]
    ...
    public partial class GetEC2VolumeAttributeCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeVolumeAttribute");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeVolumeAttributeAsync(request);
                return task.Result;
                #else
