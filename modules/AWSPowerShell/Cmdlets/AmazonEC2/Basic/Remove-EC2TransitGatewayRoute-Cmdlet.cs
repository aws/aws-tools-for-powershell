...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    /// </summary>
    [Cmdlet("Remove", "EC2TransitGatewayRoute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.EC2.Model.TransitGatewayRoute")]
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DeleteTransitGatewayRoute API operation.", Operation = new[] {"DeleteTransitGatewayRoute"})]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayRoute",
        "This cmdlet returns a TransitGatewayRoute object.",
        "The service call response (type Amazon.EC2.Model.DeleteTransitGatewayRouteResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveEC2TransitGatewayRouteCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-EC2TransitGatewayRoute (DeleteTransitGatewayRoute)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EC2.Model.DeleteTransitGatewayRouteRequest();
        ...
        private Amazon.EC2.Model.DeleteTransitGatewayRouteResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DeleteTransitGatewayRouteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DeleteTransitGatewayRoute");
            try
            {
                #if DESKTOP
