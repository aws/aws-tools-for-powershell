...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeVpcs API operation.", Operation = new[] {"DescribeVpcs"})]
    ...
    public partial class GetEC2VpcCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeVpcs");
            try
            {
                #if DESKTOP
                ...
                var task = client.DescribeVpcsAsync(request);
                return task.Result;
                #else
