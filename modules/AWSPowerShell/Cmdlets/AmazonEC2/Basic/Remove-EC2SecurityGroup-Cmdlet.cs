...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DeleteSecurityGroup operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DeleteSecurityGroup"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteSecurityGroupResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveEC2SecurityGroupCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteSecurityGroup(request);
