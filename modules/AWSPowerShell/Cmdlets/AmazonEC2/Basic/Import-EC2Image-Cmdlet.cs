...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud ImportImage API operation.", Operation = new[] {"ImportImage"})]
    ...
    public partial class ImportEC2ImageCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "ImportImage");
            try
            {
                #if DESKTOP
