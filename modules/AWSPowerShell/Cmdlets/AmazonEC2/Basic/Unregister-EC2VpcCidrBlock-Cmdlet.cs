...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Invokes the DisassociateVpcCidrBlock operation against Amazon Elastic Compute Cloud.", Operation = new[] {"DisassociateVpcCidrBlock"})]
    ...
    public partial class UnregisterEC2VpcCidrBlockCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.EC2.Model.DisassociateVpcCidrBlockResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DisassociateVpcCidrBlockRequest request)
        {
            #if DESKTOP
