...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdletOutput("Amazon.EC2.Model.ImportImageTask",
        ...
        "The service call response (type DescribeImportImageTasksResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public class GetEC2ImportImageTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new DescribeImportImageTasksRequest();
