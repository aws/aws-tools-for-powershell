...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeImportImageTasks API operation.", Operation = new[] {"DescribeImportImageTasks"})]
    ...
    public partial class GetEC2ImportImageTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DescribeImportImageTasks");
            try
            {
                #if DESKTOP
