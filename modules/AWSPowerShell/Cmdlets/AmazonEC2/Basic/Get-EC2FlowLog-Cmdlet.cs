...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DescribeFlowLogs API operation.", Operation = new[] {"DescribeFlowLogs"}, LegacyAlias="Get-EC2FlowLogs")]
    ...
    public partial class GetEC2FlowLogCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        private Amazon.EC2.Model.DescribeFlowLogsResponse CallAWSServiceOperation(IAmazonEC2 client, Amazon.EC2.Model.DescribeFlowLogsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeFlowLogsAsync(request).GetAwaiter().GetResult();
                #else
