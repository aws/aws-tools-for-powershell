...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud BundleInstance API operation.", Operation = new[] {"BundleInstance"})]
    ...
    public partial class NewEC2InstanceBundleCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "BundleInstance");
            try
            {
                #if DESKTOP
