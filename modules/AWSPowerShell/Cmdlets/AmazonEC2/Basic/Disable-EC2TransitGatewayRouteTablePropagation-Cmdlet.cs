...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud DisableTransitGatewayRouteTablePropagation API operation.", Operation = new[] {"DisableTransitGatewayRouteTablePropagation"})]
    [AWSCmdletOutput("Amazon.EC2.Model.TransitGatewayPropagation",
        "This cmdlet returns a TransitGatewayPropagation object.",
    ...
    public partial class DisableEC2TransitGatewayRouteTablePropagationCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Propagation;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "DisableTransitGatewayRouteTablePropagation");
            try
            {
                #if DESKTOP
                ...
                var task = client.DisableTransitGatewayRouteTablePropagationAsync(request);
                return task.Result;
                #else
