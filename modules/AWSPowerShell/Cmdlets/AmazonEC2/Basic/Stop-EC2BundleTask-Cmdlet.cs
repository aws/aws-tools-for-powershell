...
namespace Amazon.PowerShell.Cmdlets.EC2
{
    ...
    [AWSCmdlet("Calls the Amazon Elastic Compute Cloud CancelBundleTask API operation.", Operation = new[] {"CancelBundleTask"})]
    ...
    public partial class StopEC2BundleTaskCmdlet : AmazonEC2ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elastic Compute Cloud", "CancelBundleTask");
            try
            {
                #if DESKTOP
