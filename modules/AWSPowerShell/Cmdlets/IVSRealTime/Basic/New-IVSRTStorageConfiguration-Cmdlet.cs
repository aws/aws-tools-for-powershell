...
namespace Amazon.PowerShell.Cmdlets.IVSRT
{
    ...
    [AWSCmdletOutput("Amazon.IVSRealTime.Model.StorageConfiguration or Amazon.IVSRealTime.Model.CreateStorageConfigurationResponse",
        ...
        "The service call response (type Amazon.IVSRealTime.Model.CreateStorageConfigurationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewIVSRTStorageConfigurationCmdlet : AmazonIVSRealTimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the S3_BucketName parameter.
        /// The -PassThru parameter is deprecated, use -Select '^S3_BucketName' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^S3_BucketName' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.S3_BucketName;
            }
