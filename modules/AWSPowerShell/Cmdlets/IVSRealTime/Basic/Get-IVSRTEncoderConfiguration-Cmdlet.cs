...
namespace Amazon.PowerShell.Cmdlets.IVSRT
{
    ...
    /// </summary>
    [Cmdlet("Get", "IVSRTEncoderConfiguration")]
    ...
    public partial class GetIVSRTEncoderConfigurationCmdlet : AmazonIVSRealTimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVSRealTime.Model.GetEncoderConfigurationResponse, GetIVSRTEncoderConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVSRealTime.Model.GetEncoderConfigurationRequest();
        ...
        private Amazon.IVSRealTime.Model.GetEncoderConfigurationResponse CallAWSServiceOperation(IAmazonIVSRealTime client, Amazon.IVSRealTime.Model.GetEncoderConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service RealTime", "GetEncoderConfiguration");
            try
            {
                #if DESKTOP
                return client.GetEncoderConfiguration(request);
                #elif CORECLR
                return client.GetEncoderConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVSRealTime.Model.GetEncoderConfigurationResponse, GetIVSRTEncoderConfigurationCmdlet, object> Select { get; set; } =
