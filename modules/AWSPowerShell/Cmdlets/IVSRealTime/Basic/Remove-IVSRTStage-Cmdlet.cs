...
namespace Amazon.PowerShell.Cmdlets.IVSRT
{
    ...
    public partial class RemoveIVSRTStageCmdlet : AmazonIVSRealTimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-IVSRTStage (DeleteStage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.IVSRealTime.Model.DeleteStageResponse, RemoveIVSRTStageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.IVSRealTime.Model.DeleteStageRequest();
        ...
        private Amazon.IVSRealTime.Model.DeleteStageResponse CallAWSServiceOperation(IAmazonIVSRealTime client, Amazon.IVSRealTime.Model.DeleteStageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Interactive Video Service RealTime", "DeleteStage");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String Arn { get; set; }
            public System.Func<Amazon.IVSRealTime.Model.DeleteStageResponse, RemoveIVSRTStageCmdlet, object> Select { get; set; } =
