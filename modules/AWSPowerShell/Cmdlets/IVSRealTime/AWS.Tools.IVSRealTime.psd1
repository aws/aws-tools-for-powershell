#
# Module manifest for module 'AWS.Tools.IVSRealTime'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.IVSRealTime.dll'
    ...
    GUID = 'BFF6FB10-A5A2-42B7-8BDE-E5E37DEA2B28'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.IVSRealTime.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.IVSRealTime.Completers.psm1',
        'AWS.Tools.IVSRealTime.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.IVSRealTime.dll-Help.xml'
    )
