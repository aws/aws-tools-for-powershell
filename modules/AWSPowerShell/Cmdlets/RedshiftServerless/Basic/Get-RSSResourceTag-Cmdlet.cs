...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSSResourceTag")]
    [OutputType("Amazon.RedshiftServerless.Model.Tag")]
    [AWSCmdlet("Calls the Amazon Redshift Serverless ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ListTagsForResourceResponse))]
    ...
    public partial class GetRSSResourceTagCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftServerless.Model.ListTagsForResourceResponse, GetRSSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.ListTagsForResourceRequest();
        ...
        private Amazon.RedshiftServerless.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.RedshiftServerless.Model.ListTagsForResourceResponse, GetRSSResourceTagCmdlet, object> Select { get; set; } =
