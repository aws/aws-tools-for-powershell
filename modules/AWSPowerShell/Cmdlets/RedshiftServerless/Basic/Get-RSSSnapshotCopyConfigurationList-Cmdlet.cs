...
{
    /// <summary>
    /// Returns a list of snapshot copy configurations.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.SnapshotCopyConfiguration or Amazon.RedshiftServerless.Model.ListSnapshotCopyConfigurationsResponse",
        ...
        "The service call response (type Amazon.RedshiftServerless.Model.ListSnapshotCopyConfigurationsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSSSnapshotCopyConfigurationListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListSnapshotCopyConfigurationsResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListSnapshotCopyConfigurationsRequest request)
        {
            ...
            try
            {
                return client.ListSnapshotCopyConfigurationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
