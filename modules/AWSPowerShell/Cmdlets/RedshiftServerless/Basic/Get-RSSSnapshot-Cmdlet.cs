...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSSSnapshot")]
    [OutputType("Amazon.RedshiftServerless.Model.Snapshot")]
    [AWSCmdlet("Calls the Redshift Serverless GetSnapshot API operation.", Operation = new[] {"GetSnapshot"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.GetSnapshotResponse))]
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.Snapshot or Amazon.RedshiftServerless.Model.GetSnapshotResponse",
        "This cmdlet returns an Amazon.RedshiftServerless.Model.Snapshot object.",
        "The service call response (type Amazon.RedshiftServerless.Model.GetSnapshotResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSSSnapshotCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftServerless.Model.GetSnapshotResponse, GetRSSSnapshotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.GetSnapshotRequest();
        ...
        private Amazon.RedshiftServerless.Model.GetSnapshotResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.GetSnapshotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Redshift Serverless", "GetSnapshot");
            try
            {
                return client.GetSnapshotAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SnapshotArn { get; set; }
            public System.String SnapshotName { get; set; }
            public System.Func<Amazon.RedshiftServerless.Model.GetSnapshotResponse, GetRSSSnapshotCmdlet, object> Select { get; set; } =
