...
{
    /// <summary>
    /// Returns a list of snapshots.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.Snapshot or Amazon.RedshiftServerless.Model.ListSnapshotsResponse",
        ...
        "The service call response (type Amazon.RedshiftServerless.Model.ListSnapshotsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSSSnapshotListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListSnapshotsResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListSnapshotsRequest request)
        {
            ...
            try
            {
                return client.ListSnapshotsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
