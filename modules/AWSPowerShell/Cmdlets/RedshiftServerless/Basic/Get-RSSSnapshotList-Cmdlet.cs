...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless ListSnapshots API operation.", Operation = new[] {"ListSnapshots"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ListSnapshotsResponse))]
    ...
    public partial class GetRSSSnapshotListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ListSnapshots");
            try
            {
                #if DESKTOP
