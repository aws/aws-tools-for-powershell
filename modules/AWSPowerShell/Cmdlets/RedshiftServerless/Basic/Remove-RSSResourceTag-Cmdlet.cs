...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    public partial class RemoveRSSResourceTagCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The tag or set of tags to remove from the resource.</para><para />
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Redshift Serverless", "UntagResource");
            try
            {
