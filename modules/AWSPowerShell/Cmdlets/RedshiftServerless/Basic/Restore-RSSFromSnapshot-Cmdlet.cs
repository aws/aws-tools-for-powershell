...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless RestoreFromSnapshot API operation.", Operation = new[] {"RestoreFromSnapshot"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.RestoreFromSnapshotResponse))]
    ...
    public partial class RestoreRSSFromSnapshotCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "RestoreFromSnapshot");
            try
            {
                #if DESKTOP
