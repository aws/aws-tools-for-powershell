...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSSSnapshotCopyConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveRSSSnapshotCopyConfigurationCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The ID of the snapshot copy configuration to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationResponse).
        /// Specifying the name of a property of type Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSSSnapshotCopyConfiguration (DeleteSnapshotCopyConfiguration)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationRequest();
        ...
        private Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationRequest request)
        {
        ...
        {
            public System.String SnapshotCopyConfigurationId { get; set; }
            public System.Func<Amazon.RedshiftServerless.Model.DeleteSnapshotCopyConfigurationResponse, RemoveRSSSnapshotCopyConfigurationCmdlet, object> Select { get; set; } =
