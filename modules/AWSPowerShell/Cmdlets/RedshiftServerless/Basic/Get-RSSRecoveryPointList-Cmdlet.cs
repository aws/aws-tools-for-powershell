...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless ListRecoveryPoints API operation.", Operation = new[] {"ListRecoveryPoints"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ListRecoveryPointsResponse))]
    ...
    public partial class GetRSSRecoveryPointListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ListRecoveryPoints");
            try
            {
                #if DESKTOP
