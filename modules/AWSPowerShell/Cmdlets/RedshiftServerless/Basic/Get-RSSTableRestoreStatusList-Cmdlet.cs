...
{
    /// <summary>
    /// Returns information about an array of <c>TableRestoreStatus</c> objects.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetRSSTableRestoreStatusListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListTableRestoreStatusResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListTableRestoreStatusRequest request)
        {
            ...
            try
            {
                return client.ListTableRestoreStatusAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
