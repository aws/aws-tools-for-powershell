...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// scheduled actions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetRSSScheduledActionListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListScheduledActionsResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListScheduledActionsRequest request)
        {
            ...
            try
            {
                return client.ListScheduledActionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
