...
{
    /// <summary>
    /// Returns information about a list of specified namespaces.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.Namespace or Amazon.RedshiftServerless.Model.ListNamespacesResponse",
        ...
        "The service call response (type Amazon.RedshiftServerless.Model.ListNamespacesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetRSSNamespaceListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>If your initial <c>ListNamespaces</c> operation returns a <c>nextToken</c>, you can
