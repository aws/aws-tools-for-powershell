...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless ListNamespaces API operation.", Operation = new[] {"ListNamespaces"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ListNamespacesResponse))]
    ...
    public partial class GetRSSNamespaceListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ListNamespaces");
            try
            {
                #if DESKTOP
