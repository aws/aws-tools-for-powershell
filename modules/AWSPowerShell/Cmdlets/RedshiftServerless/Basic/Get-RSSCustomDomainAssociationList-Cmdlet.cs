...
{
    /// <summary>
    /// Lists custom domain associations for Amazon Redshift Serverless.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetRSSCustomDomainAssociationListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListCustomDomainAssociationsResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListCustomDomainAssociationsRequest request)
        {
            ...
            try
            {
                return client.ListCustomDomainAssociationsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
