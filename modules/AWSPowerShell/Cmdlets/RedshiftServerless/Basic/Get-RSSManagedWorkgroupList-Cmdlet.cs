...
{
    /// <summary>
    /// Returns information about a list of specified managed workgroups in your account.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetRSSManagedWorkgroupListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        private Amazon.RedshiftServerless.Model.ListManagedWorkgroupsResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.ListManagedWorkgroupsRequest request)
        {
            ...
            try
            {
                return client.ListManagedWorkgroupsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
