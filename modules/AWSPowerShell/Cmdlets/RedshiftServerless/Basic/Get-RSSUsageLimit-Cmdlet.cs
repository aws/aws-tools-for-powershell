...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless GetUsageLimit API operation.", Operation = new[] {"GetUsageLimit"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.GetUsageLimitResponse))]
    ...
    public partial class GetRSSUsageLimitCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "GetUsageLimit");
            try
            {
                #if DESKTOP
