...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    public partial class GetRSSIdentityCenterAuthTokenCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// token.</para><para>Constraints:</para><ul><li><para>Must contain between 1 and 20 workgroup names.</para></li><li><para>Each workgroup name must be a valid Amazon Redshift Serverless workgroup identifier.</para></li><li><para>All specified workgroups must have Identity Center integration enabled.</para></li></ul>
        /// </para>
        /// </summary>
        #if !MODULAR
