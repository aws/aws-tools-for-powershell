...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless GetCredentials API operation.", Operation = new[] {"GetCredentials"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.GetCredentialsResponse))]
    ...
    public partial class GetRSSCredentialCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "GetCredentials");
            try
            {
                #if DESKTOP
