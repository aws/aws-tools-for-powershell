...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "RSSEndpointAccess", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.RedshiftServerless.Model.EndpointAccess")]
    [AWSCmdlet("Calls the Amazon Redshift Serverless DeleteEndpointAccess API operation.", Operation = new[] {"DeleteEndpointAccess"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse))]
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.EndpointAccess or Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse",
        "This cmdlet returns an Amazon.RedshiftServerless.Model.EndpointAccess object.",
        "The service call response (type Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveRSSEndpointAccessCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-RSSEndpointAccess (DeleteEndpointAccess)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse, RemoveRSSEndpointAccessCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.DeleteEndpointAccessRequest();
        ...
        private Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.DeleteEndpointAccessRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "DeleteEndpointAccess");
            try
            {
                #if DESKTOP
                return client.DeleteEndpointAccess(request);
                #elif CORECLR
                return client.DeleteEndpointAccessAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String EndpointName { get; set; }
            public System.Func<Amazon.RedshiftServerless.Model.DeleteEndpointAccessResponse, RemoveRSSEndpointAccessCmdlet, object> Select { get; set; } =
