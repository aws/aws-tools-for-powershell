...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// </summary>
    [Cmdlet("Get", "RSSNamespace")]
    [OutputType("Amazon.RedshiftServerless.Model.Namespace")]
    [AWSCmdlet("Calls the Amazon Redshift Serverless GetNamespace API operation.", Operation = new[] {"GetNamespace"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.GetNamespaceResponse))]
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.Namespace or Amazon.RedshiftServerless.Model.GetNamespaceResponse",
        "This cmdlet returns an Amazon.RedshiftServerless.Model.Namespace object.",
        "The service call response (type Amazon.RedshiftServerless.Model.GetNamespaceResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetRSSNamespaceCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RedshiftServerless.Model.GetNamespaceResponse, GetRSSNamespaceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.GetNamespaceRequest();
        ...
        private Amazon.RedshiftServerless.Model.GetNamespaceResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.GetNamespaceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "GetNamespace");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String NamespaceName { get; set; }
            public System.Func<Amazon.RedshiftServerless.Model.GetNamespaceResponse, GetRSSNamespaceCmdlet, object> Select { get; set; } =
