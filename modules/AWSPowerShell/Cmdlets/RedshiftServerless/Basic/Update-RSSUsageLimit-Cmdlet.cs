...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless UpdateUsageLimit API operation.", Operation = new[] {"UpdateUsageLimit"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.UpdateUsageLimitResponse))]
    [AWSCmdletOutput("Amazon.RedshiftServerless.Model.UsageLimit or Amazon.RedshiftServerless.Model.UpdateUsageLimitResponse",
        ...
        "The service call response (type Amazon.RedshiftServerless.Model.UpdateUsageLimitResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateRSSUsageLimitCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The new limit amount. For more information about this parameter.</para>
        /// </para>
        /// </summary>
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "UpdateUsageLimit");
            try
            {
                #if DESKTOP
