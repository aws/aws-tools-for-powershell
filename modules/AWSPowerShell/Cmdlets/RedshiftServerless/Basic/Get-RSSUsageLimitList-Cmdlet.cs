...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless ListUsageLimits API operation.", Operation = new[] {"ListUsageLimits"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ListUsageLimitsResponse))]
    ...
    public partial class GetRSSUsageLimitListCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ListUsageLimits");
            try
            {
                #if DESKTOP
