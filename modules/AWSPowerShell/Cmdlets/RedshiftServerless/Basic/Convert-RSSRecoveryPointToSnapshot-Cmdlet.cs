...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    [AWSCmdlet("Calls the Amazon Redshift Serverless ConvertRecoveryPointToSnapshot API operation.", Operation = new[] {"ConvertRecoveryPointToSnapshot"}, SelectReturnType = typeof(Amazon.RedshiftServerless.Model.ConvertRecoveryPointToSnapshotResponse))]
    ...
    public partial class ConvertRSSRecoveryPointToSnapshotCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Redshift Serverless", "ConvertRecoveryPointToSnapshot");
            try
            {
                #if DESKTOP
