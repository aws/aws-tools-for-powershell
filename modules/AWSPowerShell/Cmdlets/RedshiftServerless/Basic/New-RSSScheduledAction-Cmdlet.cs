...
namespace Amazon.PowerShell.Cmdlets.RSS
{
    ...
    /// API operation.
    /// </summary>
    [Cmdlet("New", "RSSScheduledAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewRSSScheduledActionCmdlet : AmazonRedshiftServerlessClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Indicates whether the schedule is enabled. If false, the scheduled action does not
        /// trigger. For more information about <c>state</c> of the scheduled action, see <a href="https://docs.aws.amazon.com/redshift-serverless/latest/APIReference/API_ScheduledAction.html">ScheduledAction</a>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The end time in UTC when the schedule is no longer active. After this time, the scheduled
        /// action does not trigger.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The name of the namespace for which to create a scheduled action.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// <summary>
        /// <para>
        /// <para>The start time in UTC when the schedule is active. Before this time, the scheduled
        /// action does not trigger.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying the name of a property of type Amazon.RedshiftServerless.Model.CreateScheduledActionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-RSSScheduledAction (CreateScheduledAction)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RedshiftServerless.Model.CreateScheduledActionRequest();
        ...
        private Amazon.RedshiftServerless.Model.CreateScheduledActionResponse CallAWSServiceOperation(IAmazonRedshiftServerless client, Amazon.RedshiftServerless.Model.CreateScheduledActionRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RedshiftServerless.Model.CreateScheduledActionResponse, NewRSSScheduledActionCmdlet, object> Select { get; set; } =
