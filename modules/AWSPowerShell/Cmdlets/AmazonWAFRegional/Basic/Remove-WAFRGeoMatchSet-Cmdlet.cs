...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </para></li></ol>
    /// </summary>
    [Cmdlet("Remove", "WAFRGeoMatchSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS WAF Regional DeleteGeoMatchSet API operation.", Operation = new[] {"DeleteGeoMatchSet"})]
    [AWSCmdletOutput("System.String",
        "This cmdlet returns a String object.",
        "The service call response (type Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveWAFRGeoMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFRGeoMatchSet (DeleteGeoMatchSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.DeleteGeoMatchSetRequest();
        ...
        private Amazon.WAFRegional.Model.DeleteGeoMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteGeoMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "DeleteGeoMatchSet");
            try
            {
                #if DESKTOP
                return client.DeleteGeoMatchSet(request);
                #elif CORECLR
                return client.DeleteGeoMatchSetAsync(request).GetAwaiter().GetResult();
                #else
