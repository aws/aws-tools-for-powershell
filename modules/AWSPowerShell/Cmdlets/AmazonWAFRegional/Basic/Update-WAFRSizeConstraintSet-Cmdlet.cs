...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateSizeConstraintSet operation against AWS WAF Regional.", Operation = new[] {"UpdateSizeConstraintSet"})]
    ...
    public partial class UpdateWAFRSizeConstraintSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.SizeConstraintSetUpdate>(this.Update);
            }
        ...
        private static Amazon.WAFRegional.Model.UpdateSizeConstraintSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateSizeConstraintSetRequest request)
        {
            #if DESKTOP
        ...
        internal class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String SizeConstraintSetId { get; set; }
            public List<Amazon.WAFRegional.Model.SizeConstraintSetUpdate> Updates { get; set; }
        }
