...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRRuleList")]
    [OutputType("Amazon.WAFRegional.Model.RuleSummary")]
    [AWSCmdlet("Invokes the ListRules operation against AWS WAF Regional.", Operation = new[] {"ListRules"})]
    ...
    public partial class GetWAFRRuleListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListRulesRequest();
        ...
        private Amazon.WAFRegional.Model.ListRulesResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListRules");
            #if DESKTOP
