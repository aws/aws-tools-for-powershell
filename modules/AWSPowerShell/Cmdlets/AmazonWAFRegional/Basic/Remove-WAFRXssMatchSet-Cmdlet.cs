...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the DeleteXssMatchSet operation against AWS WAF Regional.", Operation = new[] {"DeleteXssMatchSet"})]
    ...
    public partial class RemoveWAFRXssMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.DeleteXssMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteXssMatchSetRequest request)
        {
            #if DESKTOP
