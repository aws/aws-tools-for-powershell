...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the ListWebACLs operation against AWS WAF Regional.", Operation = new[] {"ListWebACLs"})]
    ...
    public partial class GetWAFRWebACLListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.ListWebACLsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListWebACLsRequest request)
        {
            #if DESKTOP
            return client.ListWebACLs(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListWebACLsAsync(request);
            return task.Result;
            #else
