...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListSubscribedRuleGroups API operation.", Operation = new[] {"ListSubscribedRuleGroups"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.SubscribedRuleGroupSummary",
        "This cmdlet returns a collection of SubscribedRuleGroupSummary objects.",
    ...
    public partial class GetWAFRSubscribedRuleGroupCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            bool _userControllingPaging = ParameterWasBound("NextMarker") || ParameterWasBound("Limit");
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.RuleGroups;
