...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the DeleteRule operation against AWS WAF Regional.", Operation = new[] {"DeleteRule"})]
    ...
    public partial class RemoveWAFRRuleCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.DeleteRuleResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteRuleRequest request)
        {
            #if DESKTOP
