...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the CreateIPSet operation against AWS WAF Regional.", Operation = new[] {"CreateIPSet"})]
    ...
    public partial class NewWAFRIPSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.CreateIPSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.CreateIPSetRequest request)
        {
            #if DESKTOP
