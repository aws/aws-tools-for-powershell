...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateRegexPatternSet operation against AWS WAF Regional.", Operation = new[] {"UpdateRegexPatternSet"})]
    ...
    public partial class UpdateWAFRRegexPatternSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.RegexPatternSetUpdate>(this.Update);
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexPatternSetId { get; set; }
            public List<Amazon.WAFRegional.Model.RegexPatternSetUpdate> Updates { get; set; }
        }
