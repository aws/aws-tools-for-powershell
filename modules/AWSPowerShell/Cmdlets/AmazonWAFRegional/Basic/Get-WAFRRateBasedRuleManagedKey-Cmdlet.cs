...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional GetRateBasedRuleManagedKeys API operation.", Operation = new[] {"GetRateBasedRuleManagedKeys"})]
    ...
    public partial class GetWAFRRateBasedRuleManagedKeyCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (ParameterWasBound("NextMarker"))
            {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ManagedKeys;
                        ...
                        {
                            int _receivedThisCall = response.ManagedKeys.Count;
        ...
        private Amazon.WAFRegional.Model.GetRateBasedRuleManagedKeysResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetRateBasedRuleManagedKeysRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRateBasedRuleManagedKeysAsync(request);
                return task.Result;
                #else
