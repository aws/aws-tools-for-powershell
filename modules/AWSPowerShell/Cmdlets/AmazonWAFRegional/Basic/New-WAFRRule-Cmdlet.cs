...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class NewWAFRRuleCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.CreateRuleResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.CreateRuleRequest request)
        {
            #if DESKTOP
