...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    /// </summary>
    [Cmdlet("Get", "WAFRLoggingConfigurationList")]
    [OutputType("Amazon.WAFRegional.Model.LoggingConfiguration")]
    [AWSCmdlet("Calls the AWS WAF Regional ListLoggingConfigurations API operation.", Operation = new[] {"ListLoggingConfigurations"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.LoggingConfiguration",
        ...
        "The service call response (type Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetWAFRLoggingConfigurationListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WAFRegional.Model.ListLoggingConfigurationsRequest();
        ...
        private Amazon.WAFRegional.Model.ListLoggingConfigurationsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListLoggingConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "ListLoggingConfigurations");
            try
            {
                #if DESKTOP
