...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetRegexMatchSet operation against AWS WAF Regional.", Operation = new[] {"GetRegexMatchSet"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RegexMatchSet",
