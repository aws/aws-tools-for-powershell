...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the DeleteSqlInjectionMatchSet operation against AWS WAF Regional.", Operation = new[] {"DeleteSqlInjectionMatchSet"})]
    ...
    public partial class RemoveWAFRSqlInjectionMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.DeleteSqlInjectionMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteSqlInjectionMatchSetRequest request)
        {
            #if DESKTOP
