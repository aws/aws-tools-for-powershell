...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the DeleteByteMatchSet operation against AWS WAF Regional.", Operation = new[] {"DeleteByteMatchSet"})]
    ...
    public partial class RemoveWAFRByteMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.DeleteByteMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteByteMatchSetRequest request)
        {
            #if DESKTOP
