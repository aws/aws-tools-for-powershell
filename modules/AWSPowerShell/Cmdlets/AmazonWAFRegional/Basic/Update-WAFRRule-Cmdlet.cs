...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateRule operation against AWS WAF Regional.", Operation = new[] {"UpdateRule"})]
    ...
    public partial class UpdateWAFRRuleCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.UpdateRuleResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateRuleRequest request)
        {
            #if DESKTOP
