...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateSqlInjectionMatchSet operation against AWS WAF Regional.", Operation = new[] {"UpdateSqlInjectionMatchSet"})]
    ...
    public partial class UpdateWAFRSqlInjectionMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.SqlInjectionMatchSetUpdate>(this.Update);
            }
        ...
        private static Amazon.WAFRegional.Model.UpdateSqlInjectionMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateSqlInjectionMatchSetRequest request)
        {
            #if DESKTOP
        ...
        internal class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String SqlInjectionMatchSetId { get; set; }
            public List<Amazon.WAFRegional.Model.SqlInjectionMatchSetUpdate> Updates { get; set; }
        }
