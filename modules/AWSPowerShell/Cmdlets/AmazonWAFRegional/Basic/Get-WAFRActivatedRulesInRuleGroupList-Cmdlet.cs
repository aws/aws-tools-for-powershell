...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListActivatedRulesInRuleGroup API operation.", Operation = new[] {"ListActivatedRulesInRuleGroup"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.ActivatedRule",
