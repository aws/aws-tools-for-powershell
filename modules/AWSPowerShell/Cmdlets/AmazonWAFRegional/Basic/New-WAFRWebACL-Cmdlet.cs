...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the CreateWebACL operation against AWS WAF Regional.", Operation = new[] {"CreateWebACL"})]
    ...
    public partial class NewWAFRWebACLCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.CreateWebACLResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.CreateWebACLRequest request)
        {
            #if DESKTOP
