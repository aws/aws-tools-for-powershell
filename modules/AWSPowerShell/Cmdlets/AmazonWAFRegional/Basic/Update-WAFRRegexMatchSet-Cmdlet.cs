...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateRegexMatchSet operation against AWS WAF Regional.", Operation = new[] {"UpdateRegexMatchSet"})]
    ...
    public partial class UpdateWAFRRegexMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.RegexMatchSetUpdate>(this.Update);
            }
        ...
        private Amazon.WAFRegional.Model.UpdateRegexMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateRegexMatchSetRequest request)
        {
            ...
            try
            {
                ...
                var task = client.UpdateRegexMatchSetAsync(request);
                return task.Result;
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public System.String RegexMatchSetId { get; set; }
            public List<Amazon.WAFRegional.Model.RegexMatchSetUpdate> Updates { get; set; }
        }
