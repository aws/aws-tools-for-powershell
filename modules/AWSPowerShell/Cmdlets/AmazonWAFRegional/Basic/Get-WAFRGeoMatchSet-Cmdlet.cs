...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class GetWAFRGeoMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.GetGeoMatchSetRequest();
            ...
            try
            {
                ...
                object pipelineOutput = response.GeoMatchSet;
        ...
        private Amazon.WAFRegional.Model.GetGeoMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetGeoMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "GetGeoMatchSet");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetGeoMatchSetAsync(request);
                return task.Result;
                #else
