...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the ListByteMatchSets operation against AWS WAF Regional.", Operation = new[] {"ListByteMatchSets"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.ByteMatchSetSummary",
    ...
    public partial class GetWAFRByteMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ByteMatchSets;
        ...
        private static Amazon.WAFRegional.Model.ListByteMatchSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListByteMatchSetsRequest request)
        {
            #if DESKTOP
