...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetSizeConstraintSet operation against AWS WAF Regional.", Operation = new[] {"GetSizeConstraintSet"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.SizeConstraintSet",
    ...
    public partial class GetWAFRSizeConstraintSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.GetSizeConstraintSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetSizeConstraintSetRequest request)
        {
            #if DESKTOP
