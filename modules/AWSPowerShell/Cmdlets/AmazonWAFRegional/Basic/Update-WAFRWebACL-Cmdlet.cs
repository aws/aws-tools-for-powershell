...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateWebACL operation against AWS WAF Regional.", Operation = new[] {"UpdateWebACL"})]
    ...
    public partial class UpdateWAFRWebACLCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.WebACLUpdate>(this.Update);
            }
        ...
        private static Amazon.WAFRegional.Model.UpdateWebACLResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateWebACLRequest request)
        {
            #if DESKTOP
        ...
        internal class CmdletContext : ExecutorContext
        {
            public System.String ChangeToken { get; set; }
            public Amazon.WAFRegional.WafActionType DefaultAction_Type { get; set; }
            public List<Amazon.WAFRegional.Model.WebACLUpdate> Updates { get; set; }
            public System.String WebACLId { get; set; }
        }
