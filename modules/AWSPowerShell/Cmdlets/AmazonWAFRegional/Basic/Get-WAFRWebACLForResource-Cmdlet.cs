...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetWebACLForResource operation against AWS WAF Regional.", Operation = new[] {"GetWebACLForResource"})]
    ...
    public partial class GetWAFRWebACLForResourceCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.GetWebACLForResourceResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetWebACLForResourceRequest request)
        {
            #if DESKTOP
