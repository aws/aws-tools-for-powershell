...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetByteMatchSet operation against AWS WAF Regional.", Operation = new[] {"GetByteMatchSet"})]
    ...
    public partial class GetWAFRByteMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.GetByteMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetByteMatchSetRequest request)
        {
            #if DESKTOP
