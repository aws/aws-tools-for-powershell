...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the ListGeoMatchSets operation against AWS WAF Regional.", Operation = new[] {"ListGeoMatchSets"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.GeoMatchSetSummary",
        "This cmdlet returns a collection of GeoMatchSetSummary objects.",
    ...
    public partial class GetWAFRGeoMatchSetListCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.GeoMatchSets;
        ...
        private Amazon.WAFRegional.Model.ListGeoMatchSetsResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.ListGeoMatchSetsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListGeoMatchSetsAsync(request);
                return task.Result;
                #else
