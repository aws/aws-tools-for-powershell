...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetChangeToken operation against AWS WAF Regional.", Operation = new[] {"GetChangeToken"})]
    ...
    public partial class GetWAFRChangeTokenCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        private static Amazon.WAFRegional.Model.GetChangeTokenResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetChangeTokenRequest request)
        {
            #if DESKTOP
