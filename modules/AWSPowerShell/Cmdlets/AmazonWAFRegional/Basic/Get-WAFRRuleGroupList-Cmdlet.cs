...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Calls the AWS WAF Regional ListRuleGroups API operation.", Operation = new[] {"ListRuleGroups"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RuleGroupSummary",
