...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the GetRegexPatternSet operation against AWS WAF Regional.", Operation = new[] {"GetRegexPatternSet"})]
    [AWSCmdletOutput("Amazon.WAFRegional.Model.RegexPatternSet",
        "This cmdlet returns a RegexPatternSet object.",
    ...
    public partial class GetWAFRRegexPatternSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.RegexPatternSet;
        ...
        private Amazon.WAFRegional.Model.GetRegexPatternSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.GetRegexPatternSetRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetRegexPatternSetAsync(request);
                return task.Result;
                #else
