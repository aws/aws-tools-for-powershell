...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    [AWSCmdlet("Invokes the UpdateXssMatchSet operation against AWS WAF Regional.", Operation = new[] {"UpdateXssMatchSet"})]
    ...
    public partial class UpdateWAFRXssMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Update != null)
            {
                context.Updates = new List<Amazon.WAFRegional.Model.XssMatchSetUpdate>(this.Update);
            }
        ...
        private static Amazon.WAFRegional.Model.UpdateXssMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.UpdateXssMatchSetRequest request)
        {
            #if DESKTOP
        ...
        {
            public System.String ChangeToken { get; set; }
            public List<Amazon.WAFRegional.Model.XssMatchSetUpdate> Updates { get; set; }
            public System.String XssMatchSetId { get; set; }
        }
