...
namespace Amazon.PowerShell.Cmdlets.WAFR
{
    ...
    public partial class RemoveWAFRRegexMatchSetCmdlet : AmazonWAFRegionalClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WAFRRegexMatchSet (DeleteRegexMatchSet)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WAFRegional.Model.DeleteRegexMatchSetRequest();
        ...
        private Amazon.WAFRegional.Model.DeleteRegexMatchSetResponse CallAWSServiceOperation(IAmazonWAFRegional client, Amazon.WAFRegional.Model.DeleteRegexMatchSetRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS WAF Regional", "DeleteRegexMatchSet");
            try
            {
                #if DESKTOP
