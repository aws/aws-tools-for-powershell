...
namespace Amazon.PowerShell.Cmdlets.OWCM
{
    ...
    public partial class NewOWCMBackupCmdlet : AmazonOpsWorksCMClientCmdlet, IExecutor
    {
        ...
        /// or separators, or the following special characters: <c>+ - = . _ : /</c></para></li><li><para>Leading and trailing white spaces are trimmed from both the key and value.</para></li><li><para>A maximum of 50 user-applied tags is allowed for tag-supported OpsWorks CM resources.</para></li></ul><para />
