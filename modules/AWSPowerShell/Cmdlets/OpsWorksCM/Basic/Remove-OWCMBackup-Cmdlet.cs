...
namespace Amazon.PowerShell.Cmdlets.OWCM
{
    ...
    public partial class RemoveOWCMBackupCmdlet : AmazonOpsWorksCMClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorksCM.Model.DeleteBackupResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorksCM.Model.DeleteBackupResponse, RemoveOWCMBackupCmdlet>(Select) ??
        ...
        private Amazon.OpsWorksCM.Model.DeleteBackupResponse CallAWSServiceOperation(IAmazonOpsWorksCM client, Amazon.OpsWorksCM.Model.DeleteBackupRequest request)
        {
            ...
            try
            {
                return client.DeleteBackupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String BackupId { get; set; }
            public System.Func<Amazon.OpsWorksCM.Model.DeleteBackupResponse, RemoveOWCMBackupCmdlet, object> Select { get; set; } =
