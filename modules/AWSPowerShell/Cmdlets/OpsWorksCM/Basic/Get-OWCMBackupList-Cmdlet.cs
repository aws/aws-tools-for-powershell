...
namespace Amazon.PowerShell.Cmdlets.OWCM
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorksCM DescribeBackups API operation.", Operation = new[] {"DescribeBackups"}, SelectReturnType = typeof(Amazon.OpsWorksCM.Model.DescribeBackupsResponse))]
    [AWSCmdletOutput("Amazon.OpsWorksCM.Model.Backup or Amazon.OpsWorksCM.Model.DescribeBackupsResponse",
        "This cmdlet returns a collection of Amazon.OpsWorksCM.Model.Backup objects.",
        "The service call response (type Amazon.OpsWorksCM.Model.DescribeBackupsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOWCMBackupListCmdlet : AmazonOpsWorksCMClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorksCM.Model.DescribeBackupsResponse).
        /// Specifying the name of a property of type Amazon.OpsWorksCM.Model.DescribeBackupsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorksCM.Model.DescribeBackupsResponse, GetOWCMBackupListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpsWorksCM.Model.DescribeBackupsRequest();
        ...
        private Amazon.OpsWorksCM.Model.DescribeBackupsResponse CallAWSServiceOperation(IAmazonOpsWorksCM client, Amazon.OpsWorksCM.Model.DescribeBackupsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorksCM", "DescribeBackups");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServerName { get; set; }
            public System.Func<Amazon.OpsWorksCM.Model.DescribeBackupsResponse, GetOWCMBackupListCmdlet, object> Select { get; set; } =
