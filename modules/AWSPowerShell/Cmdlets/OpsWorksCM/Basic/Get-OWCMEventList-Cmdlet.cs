...
namespace Amazon.PowerShell.Cmdlets.OWCM
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorksCM DescribeEvents API operation.", Operation = new[] {"DescribeEvents"}, SelectReturnType = typeof(Amazon.OpsWorksCM.Model.DescribeEventsResponse))]
    [AWSCmdletOutput("Amazon.OpsWorksCM.Model.ServerEvent or Amazon.OpsWorksCM.Model.DescribeEventsResponse",
        "This cmdlet returns a collection of Amazon.OpsWorksCM.Model.ServerEvent objects.",
        "The service call response (type Amazon.OpsWorksCM.Model.DescribeEventsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetOWCMEventListCmdlet : AmazonOpsWorksCMClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ServerEvents'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorksCM.Model.DescribeEventsResponse).
        /// Specifying the name of a property of type Amazon.OpsWorksCM.Model.DescribeEventsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ServerEvents";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorksCM.Model.DescribeEventsResponse, GetOWCMEventListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.OpsWorksCM.Model.DescribeEventsRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.ServerEvents?.Count ?? 0;
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String ServerName { get; set; }
            public System.Func<Amazon.OpsWorksCM.Model.DescribeEventsResponse, GetOWCMEventListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ServerEvents;
        }
