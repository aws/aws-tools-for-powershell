...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMVoiceConnectorOrigination")]
    [OutputType("Amazon.Chime.Model.Origination")]
    [AWSCmdlet("Calls the Amazon Chime GetVoiceConnectorOrigination API operation.", Operation = new[] {"GetVoiceConnectorOrigination"}, SelectReturnType = typeof(Amazon.Chime.Model.GetVoiceConnectorOriginationResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Origination or Amazon.Chime.Model.GetVoiceConnectorOriginationResponse",
        "This cmdlet returns an Amazon.Chime.Model.Origination object.",
        "The service call response (type Amazon.Chime.Model.GetVoiceConnectorOriginationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetVoiceConnectorOrigination in the Amazon Chime SDK Voice Namespace")]
    public partial class GetCHMVoiceConnectorOriginationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetVoiceConnectorOriginationResponse, GetCHMVoiceConnectorOriginationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetVoiceConnectorOriginationRequest();
        ...
        private Amazon.Chime.Model.GetVoiceConnectorOriginationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetVoiceConnectorOriginationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetVoiceConnectorOrigination");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.GetVoiceConnectorOriginationResponse, GetCHMVoiceConnectorOriginationCmdlet, object> Select { get; set; } =
