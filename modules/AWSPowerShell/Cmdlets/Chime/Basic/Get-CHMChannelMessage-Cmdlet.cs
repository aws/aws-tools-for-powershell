...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// 
    ///  <note><para>
    /// The x-amz-chime-bearer request header is mandatory. Use the <c>AppInstanceUserArn</c>
    ...
    /// </summary>
    [Cmdlet("Get", "CHMChannelMessage")]
    [OutputType("Amazon.Chime.Model.ChannelMessage")]
    [AWSCmdlet("Calls the Amazon Chime GetChannelMessage API operation.", Operation = new[] {"GetChannelMessage"}, SelectReturnType = typeof(Amazon.Chime.Model.GetChannelMessageResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.ChannelMessage or Amazon.Chime.Model.GetChannelMessageResponse",
        "This cmdlet returns an Amazon.Chime.Model.ChannelMessage object.",
        "The service call response (type Amazon.Chime.Model.GetChannelMessageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetChannelMessage in the Amazon Chime SDK Messaging Namespace")]
    public partial class GetCHMChannelMessageCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetChannelMessageResponse, GetCHMChannelMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetChannelMessageRequest();
        ...
        private Amazon.Chime.Model.GetChannelMessageResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetChannelMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetChannelMessage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MessageId { get; set; }
            public System.Func<Amazon.Chime.Model.GetChannelMessageResponse, GetCHMChannelMessageCmdlet, object> Select { get; set; } =
