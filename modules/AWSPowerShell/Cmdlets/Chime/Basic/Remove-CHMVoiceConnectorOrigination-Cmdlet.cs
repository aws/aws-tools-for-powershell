...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMVoiceConnectorOrigination", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteVoiceConnectorOrigination API operation.", Operation = new[] {"DeleteVoiceConnectorOrigination"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteVoiceConnectorOrigination in the Amazon Chime SDK Voice Namespace")]
    public partial class RemoveCHMVoiceConnectorOriginationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMVoiceConnectorOrigination (DeleteVoiceConnectorOrigination)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse, RemoveCHMVoiceConnectorOriginationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteVoiceConnectorOriginationRequest();
        ...
        private Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteVoiceConnectorOriginationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteVoiceConnectorOrigination");
            try
            {
                #if DESKTOP
                return client.DeleteVoiceConnectorOrigination(request);
                #elif CORECLR
                return client.DeleteVoiceConnectorOriginationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteVoiceConnectorOriginationResponse, RemoveCHMVoiceConnectorOriginationCmdlet, object> Select { get; set; } =
