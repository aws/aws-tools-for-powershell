...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Add", "CHMMeeting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime TagMeeting API operation.", Operation = new[] {"TagMeeting"}, SelectReturnType = typeof(Amazon.Chime.Model.TagMeetingResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.TagMeetingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.TagMeetingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Use TagResource in the Amazon Chime SDK Meetings Namespace.")]
    public partial class AddCHMMeetingCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CHMMeeting (TagMeeting)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.TagMeetingResponse, AddCHMMeetingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.TagMeetingRequest();
        ...
        private Amazon.Chime.Model.TagMeetingResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.TagMeetingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "TagMeeting");
            try
            {
                #if DESKTOP
                return client.TagMeeting(request);
                #elif CORECLR
                return client.TagMeetingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.TagMeetingResponse, AddCHMMeetingCmdlet, object> Select { get; set; } =
