...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Add", "CHMPhoneNumbersToVoiceConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Chime.Model.PhoneNumberError")]
    [AWSCmdlet("Calls the Amazon Chime AssociatePhoneNumbersWithVoiceConnector API operation.", Operation = new[] {"AssociatePhoneNumbersWithVoiceConnector"}, SelectReturnType = typeof(Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.PhoneNumberError or Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.PhoneNumberError objects.",
        "The service call response (type Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse) can be returned by specifying '-Select *'."
    )]
    [System.ObsoleteAttribute("Replaced by AssociatePhoneNumbersWithVoiceConnector in the Amazon Chime SDK Voice Namespace")]
    public partial class AddCHMPhoneNumbersToVoiceConnectorCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CHMPhoneNumbersToVoiceConnector (AssociatePhoneNumbersWithVoiceConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse, AddCHMPhoneNumbersToVoiceConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorRequest();
        ...
        private Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "AssociatePhoneNumbersWithVoiceConnector");
            try
            {
                return client.AssociatePhoneNumbersWithVoiceConnectorAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? ForceAssociate { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorResponse, AddCHMPhoneNumbersToVoiceConnectorCmdlet, object> Select { get; set; } =
