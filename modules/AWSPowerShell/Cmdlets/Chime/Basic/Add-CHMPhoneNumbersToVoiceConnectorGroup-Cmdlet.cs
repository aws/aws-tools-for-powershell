...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Add", "CHMPhoneNumbersToVoiceConnectorGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class AddCHMPhoneNumbersToVoiceConnectorGroupCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CHMPhoneNumbersToVoiceConnectorGroup (AssociatePhoneNumbersWithVoiceConnectorGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse, AddCHMPhoneNumbersToVoiceConnectorGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
        ...
        private Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "AssociatePhoneNumbersWithVoiceConnectorGroup");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? ForceAssociate { get; set; }
            public System.String VoiceConnectorGroupId { get; set; }
            public System.Func<Amazon.Chime.Model.AssociatePhoneNumbersWithVoiceConnectorGroupResponse, AddCHMPhoneNumbersToVoiceConnectorGroupCmdlet, object> Select { get; set; } =
