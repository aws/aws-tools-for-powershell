...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// account.
    /// </summary>
    [Cmdlet("Remove", "CHMSigninDelegateGroupsFromAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMSigninDelegateGroupsFromAccountCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The sign-in delegate group names.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMSigninDelegateGroupsFromAccount (DisassociateSigninDelegateGroupsFromAccount)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DisassociateSigninDelegateGroupsFromAccountResponse, RemoveCHMSigninDelegateGroupsFromAccountCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DisassociateSigninDelegateGroupsFromAccountRequest();
        ...
        private Amazon.Chime.Model.DisassociateSigninDelegateGroupsFromAccountResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DisassociateSigninDelegateGroupsFromAccountRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DisassociateSigninDelegateGroupsFromAccount");
            try
            {
                return client.DisassociateSigninDelegateGroupsFromAccountAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.DisassociateSigninDelegateGroupsFromAccountResponse, RemoveCHMSigninDelegateGroupsFromAccountCmdlet, object> Select { get; set; } =
