...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"}, SelectReturnType = typeof(Amazon.Chime.Model.ListTagsForResourceResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Tag or Amazon.Chime.Model.ListTagsForResourceResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.Tag objects.",
        "The service call response (type Amazon.Chime.Model.ListTagsForResourceResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetCHMResourceTagCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListTagsForResourceResponse, GetCHMResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.ListTagsForResourceRequest();
        ...
        private Amazon.Chime.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceARN { get; set; }
            public System.Func<Amazon.Chime.Model.ListTagsForResourceResponse, GetCHMResourceTagCmdlet, object> Select { get; set; } =
