...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class NewCHMSipRuleCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The type of trigger whose value is assigned to the SIP rule in <code>TriggerValue</code>.
        /// Allowed trigger values are <code>RequestUriHostname</code> and <code>ToPhoneNumber</code>.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>If <code>TriggerType</code> is <code>RequestUriHostname</code> then the value can
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TriggerValue' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TriggerValue;
            }
