...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class ResetCHMPersonalPINCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ResetPersonalPINResponse, ResetCHMPersonalPINCmdlet>(Select) ??
        ...
        private Amazon.Chime.Model.ResetPersonalPINResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ResetPersonalPINRequest request)
        {
            ...
            try
            {
                return client.ResetPersonalPINAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String UserId { get; set; }
            public System.Func<Amazon.Chime.Model.ResetPersonalPINResponse, ResetCHMPersonalPINCmdlet, object> Select { get; set; } =
