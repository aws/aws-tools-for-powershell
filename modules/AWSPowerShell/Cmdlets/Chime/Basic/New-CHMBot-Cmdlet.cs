...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("New", "CHMBot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Chime.Model.Bot")]
    [AWSCmdlet("Calls the Amazon Chime CreateBot API operation.", Operation = new[] {"CreateBot"}, SelectReturnType = typeof(Amazon.Chime.Model.CreateBotResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Bot or Amazon.Chime.Model.CreateBotResponse",
        "This cmdlet returns an Amazon.Chime.Model.Bot object.",
        "The service call response (type Amazon.Chime.Model.CreateBotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCHMBotCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.CreateBotResponse, NewCHMBotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.CreateBotRequest();
        ...
        private Amazon.Chime.Model.CreateBotResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.CreateBotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "CreateBot");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String DisplayName { get; set; }
            public System.String Domain { get; set; }
            public System.Func<Amazon.Chime.Model.CreateBotResponse, NewCHMBotCmdlet, object> Select { get; set; } =
