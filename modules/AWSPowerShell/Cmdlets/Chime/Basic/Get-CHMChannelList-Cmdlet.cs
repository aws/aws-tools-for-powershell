...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListChannels API operation.", Operation = new[] {"ListChannels"}, SelectReturnType = typeof(Amazon.Chime.Model.ListChannelsResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.ChannelSummary or Amazon.Chime.Model.ListChannelsResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.ChannelSummary objects.",
        "The service call response (type Amazon.Chime.Model.ListChannelsResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetCHMChannelListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListChannelsResponse, GetCHMChannelListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListChannelsRequest();
        ...
        private Amazon.Chime.Model.ListChannelsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListChannelsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListChannels");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public Amazon.Chime.ChannelPrivacy Privacy { get; set; }
            public System.Func<Amazon.Chime.Model.ListChannelsResponse, GetCHMChannelListCmdlet, object> Select { get; set; } =
