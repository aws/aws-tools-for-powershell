...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListMeetings API operation.", Operation = new[] {"ListMeetings"}, SelectReturnType = typeof(Amazon.Chime.Model.ListMeetingsResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Meeting or Amazon.Chime.Model.ListMeetingsResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.Meeting objects.",
        "The service call response (type Amazon.Chime.Model.ListMeetingsResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class GetCHMMeetingListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Meetings";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListMeetingsResponse, GetCHMMeetingListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListMeetingsRequest();
        ...
        private Amazon.Chime.Model.ListMeetingsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListMeetingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListMeetings");
            try
            {
                #if DESKTOP
                return client.ListMeetings(request);
                #elif CORECLR
                return client.ListMeetingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Chime.Model.ListMeetingsResponse, GetCHMMeetingListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Meetings;
        }
