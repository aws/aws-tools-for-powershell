...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Update", "CHMVoiceConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Chime.Model.VoiceConnector")]
    [AWSCmdlet("Calls the Amazon Chime UpdateVoiceConnector API operation.", Operation = new[] {"UpdateVoiceConnector"}, SelectReturnType = typeof(Amazon.Chime.Model.UpdateVoiceConnectorResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.VoiceConnector or Amazon.Chime.Model.UpdateVoiceConnectorResponse",
        "This cmdlet returns an Amazon.Chime.Model.VoiceConnector object.",
        "The service call response (type Amazon.Chime.Model.UpdateVoiceConnectorResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by UpdateVoiceConnector in the Amazon Chime SDK Voice Namespace")]
    public partial class UpdateCHMVoiceConnectorCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHMVoiceConnector (UpdateVoiceConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.UpdateVoiceConnectorResponse, UpdateCHMVoiceConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.UpdateVoiceConnectorRequest();
        ...
        private Amazon.Chime.Model.UpdateVoiceConnectorResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.UpdateVoiceConnectorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "UpdateVoiceConnector");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? RequireEncryption { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.UpdateVoiceConnectorResponse, UpdateCHMVoiceConnectorCmdlet, object> Select { get; set; } =
