...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMPhoneNumbersFromVoiceConnectorGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.Chime.Model.PhoneNumberError")]
    [AWSCmdlet("Calls the Amazon Chime DisassociatePhoneNumbersFromVoiceConnectorGroup API operation.", Operation = new[] {"DisassociatePhoneNumbersFromVoiceConnectorGroup"}, SelectReturnType = typeof(Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.PhoneNumberError or Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.PhoneNumberError objects.",
        "The service call response (type Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DisassociatePhoneNumbersFromVoiceConnectorGroup in the Amazon Chime SDK Voice Namespace")]
    public partial class RemoveCHMPhoneNumbersFromVoiceConnectorGroupCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMPhoneNumbersFromVoiceConnectorGroup (DisassociatePhoneNumbersFromVoiceConnectorGroup)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse, RemoveCHMPhoneNumbersFromVoiceConnectorGroupCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest();
        ...
        private Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DisassociatePhoneNumbersFromVoiceConnectorGroup");
            try
            {
                #if DESKTOP
                return client.DisassociatePhoneNumbersFromVoiceConnectorGroup(request);
                #elif CORECLR
                return client.DisassociatePhoneNumbersFromVoiceConnectorGroupAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String VoiceConnectorGroupId { get; set; }
            public System.Func<Amazon.Chime.Model.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse, RemoveCHMPhoneNumbersFromVoiceConnectorGroupCmdlet, object> Select { get; set; } =
