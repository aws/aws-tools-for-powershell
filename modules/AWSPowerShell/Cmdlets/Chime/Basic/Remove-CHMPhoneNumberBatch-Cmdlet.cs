...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class RemoveCHMPhoneNumberBatchCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>List of phone number IDs.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMPhoneNumberBatch (BatchDeletePhoneNumber)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.BatchDeletePhoneNumberResponse, RemoveCHMPhoneNumberBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.BatchDeletePhoneNumberRequest();
        ...
        private Amazon.Chime.Model.BatchDeletePhoneNumberResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.BatchDeletePhoneNumberRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "BatchDeletePhoneNumber");
            try
            {
                return client.BatchDeletePhoneNumberAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.BatchDeletePhoneNumberResponse, RemoveCHMPhoneNumberBatchCmdlet, object> Select { get; set; } =
