...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMAppInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteAppInstance API operation.", Operation = new[] {"DeleteAppInstance"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteAppInstanceResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteAppInstanceResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteAppInstanceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteAppInstance in the Amazon Chime SDK Identity Namespace")]
    public partial class RemoveCHMAppInstanceCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMAppInstance (DeleteAppInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteAppInstanceResponse, RemoveCHMAppInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteAppInstanceRequest();
        ...
        private Amazon.Chime.Model.DeleteAppInstanceResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteAppInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteAppInstance");
            try
            {
                #if DESKTOP
                return client.DeleteAppInstance(request);
                #elif CORECLR
                return client.DeleteAppInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteAppInstanceResponse, RemoveCHMAppInstanceCmdlet, object> Select { get; set; } =
