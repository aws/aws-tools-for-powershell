...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMSupportedPhoneNumberCountryList")]
    [OutputType("Amazon.Chime.Model.PhoneNumberCountry")]
    ...
    public partial class GetCHMSupportedPhoneNumberCountryListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListSupportedPhoneNumberCountriesResponse, GetCHMSupportedPhoneNumberCountryListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.ListSupportedPhoneNumberCountriesRequest();
        ...
        private Amazon.Chime.Model.ListSupportedPhoneNumberCountriesResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListSupportedPhoneNumberCountriesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListSupportedPhoneNumberCountries");
            try
            {
                #if DESKTOP
        ...
        {
            public Amazon.Chime.PhoneNumberProductType ProductType { get; set; }
            public System.Func<Amazon.Chime.Model.ListSupportedPhoneNumberCountriesResponse, GetCHMSupportedPhoneNumberCountryListCmdlet, object> Select { get; set; } =
