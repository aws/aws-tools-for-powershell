...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMProxySession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteProxySession API operation.", Operation = new[] {"DeleteProxySession"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteProxySessionResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteProxySessionResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteProxySessionResponse) be returned by specifying '-Select *'."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteProxySession in the Amazon Chime SDK Voice Namespace")]
    public partial class RemoveCHMProxySessionCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMProxySession (DeleteProxySession)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteProxySessionResponse, RemoveCHMProxySessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteProxySessionRequest();
        ...
        private Amazon.Chime.Model.DeleteProxySessionResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteProxySessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteProxySession");
            try
            {
                return client.DeleteProxySessionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ProxySessionId { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteProxySessionResponse, RemoveCHMProxySessionCmdlet, object> Select { get; set; } =
