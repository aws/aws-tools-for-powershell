...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteProxySessionResponse",
        ...
        "The service response (type Amazon.Chime.Model.DeleteProxySessionResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
