...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMAttendeeList")]
    [OutputType("Amazon.Chime.Model.Attendee")]
    [AWSCmdlet("Calls the Amazon Chime ListAttendees API operation.", Operation = new[] {"ListAttendees"}, SelectReturnType = typeof(Amazon.Chime.Model.ListAttendeesResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Attendee or Amazon.Chime.Model.ListAttendeesResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.Attendee objects.",
        "The service call response (type Amazon.Chime.Model.ListAttendeesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by ListAttendees in the Amazon Chime SDK Meetings Namespace")]
    public partial class GetCHMAttendeeListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "Attendees";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListAttendeesResponse, GetCHMAttendeeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListAttendeesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.Attendees?.Count ?? 0;
        ...
        private Amazon.Chime.Model.ListAttendeesResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListAttendeesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListAttendees");
            try
            {
                #if DESKTOP
                return client.ListAttendees(request);
                #elif CORECLR
                return client.ListAttendeesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MeetingId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Chime.Model.ListAttendeesResponse, GetCHMAttendeeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.Attendees;
        }
