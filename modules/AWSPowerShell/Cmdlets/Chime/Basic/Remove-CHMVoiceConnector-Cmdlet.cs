...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMVoiceConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteVoiceConnector API operation.", Operation = new[] {"DeleteVoiceConnector"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteVoiceConnectorResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteVoiceConnectorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteVoiceConnectorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteVoiceConnector in the Amazon Chime SDK Voice Namespace")]
    public partial class RemoveCHMVoiceConnectorCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMVoiceConnector (DeleteVoiceConnector)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteVoiceConnectorResponse, RemoveCHMVoiceConnectorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteVoiceConnectorRequest();
        ...
        private Amazon.Chime.Model.DeleteVoiceConnectorResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteVoiceConnectorRequest request)
        {
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteVoiceConnectorResponse, RemoveCHMVoiceConnectorCmdlet, object> Select { get; set; } =
