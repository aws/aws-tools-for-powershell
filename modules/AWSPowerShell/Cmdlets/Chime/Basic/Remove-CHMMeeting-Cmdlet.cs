...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// no longer join the meeting. For more information about the Amazon Chime SDK, see <a href="https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html">Using the Amazon
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteMeeting API operation.", Operation = new[] {"DeleteMeeting"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteMeetingResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteMeetingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteMeetingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveCHMMeetingCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMeeting (DeleteMeeting)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteMeetingResponse, RemoveCHMMeetingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteMeetingRequest();
        ...
        private Amazon.Chime.Model.DeleteMeetingResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteMeetingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteMeeting");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String MeetingId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteMeetingResponse, RemoveCHMMeetingCmdlet, object> Select { get; set; } =
