...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMMeetingTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime UntagMeeting API operation.", Operation = new[] {"UntagMeeting"}, SelectReturnType = typeof(Amazon.Chime.Model.UntagMeetingResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.UntagMeetingResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.UntagMeetingResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Use UntagResource in the Amazon Chime SDK Meetings Namespace.")]
    public partial class RemoveCHMMeetingTagCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMMeetingTag (UntagMeeting)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.UntagMeetingResponse, RemoveCHMMeetingTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.UntagMeetingRequest();
        ...
        private Amazon.Chime.Model.UntagMeetingResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.UntagMeetingRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "UntagMeeting");
            try
            {
                #if DESKTOP
                return client.UntagMeeting(request);
                #elif CORECLR
                return client.UntagMeetingAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.UntagMeetingResponse, RemoveCHMMeetingTagCmdlet, object> Select { get; set; } =
