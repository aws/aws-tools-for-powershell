...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMAttendee")]
    [OutputType("Amazon.Chime.Model.Attendee")]
    [AWSCmdlet("Calls the Amazon Chime GetAttendee API operation.", Operation = new[] {"GetAttendee"}, SelectReturnType = typeof(Amazon.Chime.Model.GetAttendeeResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Attendee or Amazon.Chime.Model.GetAttendeeResponse",
        "This cmdlet returns an Amazon.Chime.Model.Attendee object.",
        "The service call response (type Amazon.Chime.Model.GetAttendeeResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetAttendee in the Amazon Chime SDK Meetings Namespace")]
    public partial class GetCHMAttendeeCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetAttendeeResponse, GetCHMAttendeeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetAttendeeRequest();
        ...
        private Amazon.Chime.Model.GetAttendeeResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetAttendeeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetAttendee");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AttendeeId { get; set; }
            public System.String MeetingId { get; set; }
            public System.Func<Amazon.Chime.Model.GetAttendeeResponse, GetCHMAttendeeCmdlet, object> Select { get; set; } =
