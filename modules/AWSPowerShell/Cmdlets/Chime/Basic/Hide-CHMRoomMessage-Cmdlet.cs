...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class HideCHMRoomMessageCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Hide-CHMRoomMessage (RedactRoomMessage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.RedactRoomMessageResponse, HideCHMRoomMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.RedactRoomMessageRequest();
        ...
        private Amazon.Chime.Model.RedactRoomMessageResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.RedactRoomMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "RedactRoomMessage");
            try
            {
                #if DESKTOP
                return client.RedactRoomMessage(request);
                #elif CORECLR
                return client.RedactRoomMessageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MessageId { get; set; }
            public System.String RoomId { get; set; }
            public System.Func<Amazon.Chime.Model.RedactRoomMessageResponse, HideCHMRoomMessageCmdlet, object> Select { get; set; } =
