...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMEventsConfiguration")]
    ...
    public partial class GetCHMEventsConfigurationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetEventsConfigurationResponse, GetCHMEventsConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetEventsConfigurationRequest();
        ...
        private Amazon.Chime.Model.GetEventsConfigurationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetEventsConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetEventsConfiguration");
            try
            {
                #if DESKTOP
                return client.GetEventsConfiguration(request);
                #elif CORECLR
                return client.GetEventsConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String BotId { get; set; }
            public System.Func<Amazon.Chime.Model.GetEventsConfigurationResponse, GetCHMEventsConfigurationCmdlet, object> Select { get; set; } =
