...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdletOutput("Amazon.Chime.Model.SipRule or Amazon.Chime.Model.ListSipRulesResponse",
        ...
        "The service call response (type Amazon.Chime.Model.ListSipRulesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
