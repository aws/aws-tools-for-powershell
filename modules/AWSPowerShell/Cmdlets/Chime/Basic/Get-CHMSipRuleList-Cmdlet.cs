...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMSipRuleList")]
    [OutputType("Amazon.Chime.Model.SipRule")]
    [AWSCmdlet("Calls the Amazon Chime ListSipRules API operation.", Operation = new[] {"ListSipRules"}, SelectReturnType = typeof(Amazon.Chime.Model.ListSipRulesResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.SipRule or Amazon.Chime.Model.ListSipRulesResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.SipRule objects.",
        "The service call response (type Amazon.Chime.Model.ListSipRulesResponse) can be returned by specifying '-Select *'."
    )]
    [System.ObsoleteAttribute("Replaced by ListSipRules in the Amazon Chime SDK Voice Namespace")]
    public partial class GetCHMSipRuleListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListSipRulesResponse, GetCHMSipRuleListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListSipRulesRequest();
        ...
        private Amazon.Chime.Model.ListSipRulesResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListSipRulesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListSipRules");
            try
            {
                return client.ListSipRulesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String SipMediaApplicationId { get; set; }
            public System.Func<Amazon.Chime.Model.ListSipRulesResponse, GetCHMSipRuleListCmdlet, object> Select { get; set; } =
