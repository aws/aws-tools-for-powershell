...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class GetCHMRetentionSettingCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetRetentionSettingsResponse, GetCHMRetentionSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetRetentionSettingsRequest();
        ...
        private Amazon.Chime.Model.GetRetentionSettingsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetRetentionSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetRetentionSettings");
            try
            {
                #if DESKTOP
                return client.GetRetentionSettings(request);
                #elif CORECLR
                return client.GetRetentionSettingsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AccountId { get; set; }
            public System.Func<Amazon.Chime.Model.GetRetentionSettingsResponse, GetCHMRetentionSettingCmdlet, object> Select { get; set; } =
