...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Update", "CHMBot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Chime.Model.Bot")]
    [AWSCmdlet("Calls the Amazon Chime UpdateBot API operation.", Operation = new[] {"UpdateBot"}, SelectReturnType = typeof(Amazon.Chime.Model.UpdateBotResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Bot or Amazon.Chime.Model.UpdateBotResponse",
        "This cmdlet returns an Amazon.Chime.Model.Bot object.",
        "The service call response (type Amazon.Chime.Model.UpdateBotResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCHMBotCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHMBot (UpdateBot)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.UpdateBotResponse, UpdateCHMBotCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.UpdateBotRequest();
        ...
        private Amazon.Chime.Model.UpdateBotResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.UpdateBotRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "UpdateBot");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String BotId { get; set; }
            public System.Boolean? Disabled { get; set; }
            public System.Func<Amazon.Chime.Model.UpdateBotResponse, UpdateCHMBotCmdlet, object> Select { get; set; } =
