...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class GetCHMChannelMembershipCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DescribeChannelMembershipResponse, GetCHMChannelMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DescribeChannelMembershipRequest();
        ...
        private Amazon.Chime.Model.DescribeChannelMembershipResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DescribeChannelMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DescribeChannelMembership");
            try
            {
                #if DESKTOP
