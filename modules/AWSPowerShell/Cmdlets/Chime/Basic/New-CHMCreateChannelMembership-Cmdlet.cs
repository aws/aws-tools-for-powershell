...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("New", "CHMCreateChannelMembership", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.Chime.Model.BatchCreateChannelMembershipResponse")]
    [AWSCmdlet("Calls the Amazon Chime BatchCreateChannelMembership API operation.", Operation = new[] {"BatchCreateChannelMembership"}, SelectReturnType = typeof(Amazon.Chime.Model.BatchCreateChannelMembershipResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.BatchCreateChannelMembershipResponse",
        "This cmdlet returns an Amazon.Chime.Model.BatchCreateChannelMembershipResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by BatchCreateChannelMembership in the Amazon Chime SDK Messaging Namespace")]
    public partial class NewCHMCreateChannelMembershipCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CHMCreateChannelMembership (BatchCreateChannelMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.BatchCreateChannelMembershipResponse, NewCHMCreateChannelMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.BatchCreateChannelMembershipRequest();
        ...
        private Amazon.Chime.Model.BatchCreateChannelMembershipResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.BatchCreateChannelMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "BatchCreateChannelMembership");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Chime.ChannelMembershipType Type { get; set; }
            public System.Func<Amazon.Chime.Model.BatchCreateChannelMembershipResponse, NewCHMCreateChannelMembershipCmdlet, object> Select { get; set; } =
