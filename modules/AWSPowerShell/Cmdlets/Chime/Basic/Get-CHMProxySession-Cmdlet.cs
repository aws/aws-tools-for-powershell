...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMProxySession")]
    [OutputType("Amazon.Chime.Model.ProxySession")]
    [AWSCmdlet("Calls the Amazon Chime GetProxySession API operation.", Operation = new[] {"GetProxySession"}, SelectReturnType = typeof(Amazon.Chime.Model.GetProxySessionResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.ProxySession or Amazon.Chime.Model.GetProxySessionResponse",
        "This cmdlet returns an Amazon.Chime.Model.ProxySession object.",
        "The service call response (type Amazon.Chime.Model.GetProxySessionResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetProxySession in the Amazon Chime SDK Voice Namespace")]
    public partial class GetCHMProxySessionCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetProxySessionResponse, GetCHMProxySessionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetProxySessionRequest();
        ...
        private Amazon.Chime.Model.GetProxySessionResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetProxySessionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetProxySession");
            try
            {
                #if DESKTOP
                return client.GetProxySession(request);
                #elif CORECLR
                return client.GetProxySessionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ProxySessionId { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.GetProxySessionResponse, GetCHMProxySessionCmdlet, object> Select { get; set; } =
