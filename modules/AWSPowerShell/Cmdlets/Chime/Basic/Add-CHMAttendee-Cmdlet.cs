...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class AddCHMAttendeeCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-CHMAttendee (TagAttendee)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.TagAttendeeResponse, AddCHMAttendeeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.TagAttendeeRequest();
        ...
        private Amazon.Chime.Model.TagAttendeeResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.TagAttendeeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "TagAttendee");
            try
            {
                #if DESKTOP
                return client.TagAttendee(request);
                #elif CORECLR
                return client.TagAttendeeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.TagAttendeeResponse, AddCHMAttendeeCmdlet, object> Select { get; set; } =
