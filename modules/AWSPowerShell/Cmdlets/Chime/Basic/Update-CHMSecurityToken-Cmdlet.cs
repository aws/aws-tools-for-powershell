...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Update", "CHMSecurityToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCHMSecurityTokenCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHMSecurityToken (RegenerateSecurityToken)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.RegenerateSecurityTokenResponse, UpdateCHMSecurityTokenCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.RegenerateSecurityTokenRequest();
        ...
        private Amazon.Chime.Model.RegenerateSecurityTokenResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.RegenerateSecurityTokenRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "RegenerateSecurityToken");
            try
            {
                #if DESKTOP
                return client.RegenerateSecurityToken(request);
                #elif CORECLR
                return client.RegenerateSecurityTokenAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String BotId { get; set; }
            public System.Func<Amazon.Chime.Model.RegenerateSecurityTokenResponse, UpdateCHMSecurityTokenCmdlet, object> Select { get; set; } =
