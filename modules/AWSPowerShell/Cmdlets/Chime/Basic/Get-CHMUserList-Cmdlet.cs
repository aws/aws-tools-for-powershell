...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListUsers API operation.", Operation = new[] {"ListUsers"}, SelectReturnType = typeof(Amazon.Chime.Model.ListUsersResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.User or Amazon.Chime.Model.ListUsersResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.User objects.",
        "The service call response (type Amazon.Chime.Model.ListUsersResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCHMUserListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListUsersResponse, GetCHMUserListCmdlet>(Select) ??
