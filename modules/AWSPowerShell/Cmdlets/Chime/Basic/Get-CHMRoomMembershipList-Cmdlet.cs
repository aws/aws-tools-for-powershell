...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// addresses, and member names.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetCHMRoomMembershipListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        private Amazon.Chime.Model.ListRoomMembershipsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListRoomMembershipsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListRoomMemberships");
            try
            {
                #if DESKTOP
                return client.ListRoomMemberships(request);
                #elif CORECLR
                return client.ListRoomMembershipsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String RoomId { get; set; }
            public System.Func<Amazon.Chime.Model.ListRoomMembershipsResponse, GetCHMRoomMembershipListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RoomMemberships;
        }
