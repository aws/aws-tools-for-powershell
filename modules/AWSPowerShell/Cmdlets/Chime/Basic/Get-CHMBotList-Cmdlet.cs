...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMBotList")]
    [OutputType("Amazon.Chime.Model.Bot")]
    [AWSCmdlet("Calls the Amazon Chime ListBots API operation.", Operation = new[] {"ListBots"}, SelectReturnType = typeof(Amazon.Chime.Model.ListBotsResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Bot or Amazon.Chime.Model.ListBotsResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.Bot objects.",
        "The service call response (type Amazon.Chime.Model.ListBotsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMBotListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListBotsResponse, GetCHMBotListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListBotsRequest();
        ...
        private Amazon.Chime.Model.ListBotsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListBotsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListBots");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Chime.Model.ListBotsResponse, GetCHMBotListCmdlet, object> Select { get; set; } =
