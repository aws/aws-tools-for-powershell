...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class RemoveCHMAttendeeTagCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMAttendeeTag (UntagAttendee)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.UntagAttendeeResponse, RemoveCHMAttendeeTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.UntagAttendeeRequest();
        ...
        private Amazon.Chime.Model.UntagAttendeeResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.UntagAttendeeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "UntagAttendee");
            try
            {
                #if DESKTOP
                return client.UntagAttendee(request);
                #elif CORECLR
                return client.UntagAttendeeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Chime.Model.UntagAttendeeResponse, RemoveCHMAttendeeTagCmdlet, object> Select { get; set; } =
