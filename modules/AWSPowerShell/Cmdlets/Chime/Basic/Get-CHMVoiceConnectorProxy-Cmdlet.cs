...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMVoiceConnectorProxy")]
    [OutputType("Amazon.Chime.Model.Proxy")]
    [AWSCmdlet("Calls the Amazon Chime GetVoiceConnectorProxy API operation.", Operation = new[] {"GetVoiceConnectorProxy"}, SelectReturnType = typeof(Amazon.Chime.Model.GetVoiceConnectorProxyResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Proxy or Amazon.Chime.Model.GetVoiceConnectorProxyResponse",
        "This cmdlet returns an Amazon.Chime.Model.Proxy object.",
        "The service call response (type Amazon.Chime.Model.GetVoiceConnectorProxyResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetVoiceConnectorProxy in the Amazon Chime SDK Voice Namespace")]
    public partial class GetCHMVoiceConnectorProxyCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetVoiceConnectorProxyResponse, GetCHMVoiceConnectorProxyCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetVoiceConnectorProxyRequest();
        ...
        private Amazon.Chime.Model.GetVoiceConnectorProxyResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetVoiceConnectorProxyRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetVoiceConnectorProxy");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.GetVoiceConnectorProxyResponse, GetCHMVoiceConnectorProxyCmdlet, object> Select { get; set; } =
