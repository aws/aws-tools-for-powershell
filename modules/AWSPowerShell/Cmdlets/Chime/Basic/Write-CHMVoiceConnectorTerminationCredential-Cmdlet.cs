...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Write", "CHMVoiceConnectorTerminationCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class WriteCHMVoiceConnectorTerminationCredentialCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        #region Parameter TerminationCredential
        /// <summary>
        /// <para>
        ...
        public Amazon.Chime.Model.Credential[] TerminationCredential { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Write-CHMVoiceConnectorTerminationCredential (PutVoiceConnectorTerminationCredentials)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.PutVoiceConnectorTerminationCredentialsResponse, WriteCHMVoiceConnectorTerminationCredentialCmdlet>(Select) ??
                    throw new System.ArgumentException("Invalid value for -Select parameter.", nameof(this.Select));
            }
            if (this.TerminationCredential != null)
            {
                context.TerminationCredential = new List<Amazon.Chime.Model.Credential>(this.TerminationCredential);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.PutVoiceConnectorTerminationCredentialsRequest();
            
            if (cmdletContext.TerminationCredential != null)
            {
                request.Credentials = cmdletContext.TerminationCredential;
            }
        ...
        private Amazon.Chime.Model.PutVoiceConnectorTerminationCredentialsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.PutVoiceConnectorTerminationCredentialsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "PutVoiceConnectorTerminationCredentials");
            try
            {
                #if DESKTOP
        ...
        {
            public List<Amazon.Chime.Model.Credential> TerminationCredential { get; set; }
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.PutVoiceConnectorTerminationCredentialsResponse, WriteCHMVoiceConnectorTerminationCredentialCmdlet, object> Select { get; set; } =
