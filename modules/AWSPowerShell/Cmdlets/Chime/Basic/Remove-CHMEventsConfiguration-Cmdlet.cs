...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMEventsConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMEventsConfigurationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMEventsConfiguration (DeleteEventsConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteEventsConfigurationResponse, RemoveCHMEventsConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteEventsConfigurationRequest();
        ...
        private Amazon.Chime.Model.DeleteEventsConfigurationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteEventsConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteEventsConfiguration");
            try
            {
                #if DESKTOP
                return client.DeleteEventsConfiguration(request);
                #elif CORECLR
                return client.DeleteEventsConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AccountId { get; set; }
            public System.String BotId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteEventsConfigurationResponse, RemoveCHMEventsConfigurationCmdlet, object> Select { get; set; } =
