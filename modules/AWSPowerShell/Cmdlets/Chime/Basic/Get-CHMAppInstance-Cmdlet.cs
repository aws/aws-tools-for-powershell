...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMAppInstance")]
    [OutputType("Amazon.Chime.Model.AppInstance")]
    ...
    public partial class GetCHMAppInstanceCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "AppInstance";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DescribeAppInstanceResponse, GetCHMAppInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DescribeAppInstanceRequest();
        ...
        private Amazon.Chime.Model.DescribeAppInstanceResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DescribeAppInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DescribeAppInstance");
            try
            {
                #if DESKTOP
                return client.DescribeAppInstance(request);
                #elif CORECLR
                return client.DescribeAppInstanceAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.Chime.Model.DescribeAppInstanceResponse, GetCHMAppInstanceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AppInstance;
        }
