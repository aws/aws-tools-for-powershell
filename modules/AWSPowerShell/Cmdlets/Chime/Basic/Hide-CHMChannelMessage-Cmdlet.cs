...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class HideCHMChannelMessageCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Hide-CHMChannelMessage (RedactChannelMessage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.RedactChannelMessageResponse, HideCHMChannelMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.RedactChannelMessageRequest();
        ...
        private Amazon.Chime.Model.RedactChannelMessageResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.RedactChannelMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "RedactChannelMessage");
            try
            {
                #if DESKTOP
                return client.RedactChannelMessage(request);
                #elif CORECLR
                return client.RedactChannelMessageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MessageId { get; set; }
            public System.Func<Amazon.Chime.Model.RedactChannelMessageResponse, HideCHMChannelMessageCmdlet, object> Select { get; set; } =
