...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListRooms API operation.", Operation = new[] {"ListRooms"}, SelectReturnType = typeof(Amazon.Chime.Model.ListRoomsResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.Room or Amazon.Chime.Model.ListRoomsResponse",
        "This cmdlet returns a collection of Amazon.Chime.Model.Room objects.",
        "The service call response (type Amazon.Chime.Model.ListRoomsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCHMRoomListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListRoomsResponse, GetCHMRoomListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListRoomsRequest();
        ...
        private Amazon.Chime.Model.ListRoomsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListRoomsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListRooms");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemberId { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Chime.Model.ListRoomsResponse, GetCHMRoomListCmdlet, object> Select { get; set; } =
