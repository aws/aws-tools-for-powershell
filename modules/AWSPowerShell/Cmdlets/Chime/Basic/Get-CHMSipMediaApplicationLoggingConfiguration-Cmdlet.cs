...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class GetCHMSipMediaApplicationLoggingConfigurationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetSipMediaApplicationLoggingConfigurationResponse, GetCHMSipMediaApplicationLoggingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetSipMediaApplicationLoggingConfigurationRequest();
        ...
        private Amazon.Chime.Model.GetSipMediaApplicationLoggingConfigurationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetSipMediaApplicationLoggingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetSipMediaApplicationLoggingConfiguration");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String SipMediaApplicationId { get; set; }
            public System.Func<Amazon.Chime.Model.GetSipMediaApplicationLoggingConfigurationResponse, GetCHMSipMediaApplicationLoggingConfigurationCmdlet, object> Select { get; set; } =
