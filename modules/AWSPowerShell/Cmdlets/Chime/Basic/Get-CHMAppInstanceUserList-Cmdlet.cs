...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime ListAppInstanceUsers API operation.", Operation = new[] {"ListAppInstanceUsers"}, SelectReturnType = typeof(Amazon.Chime.Model.ListAppInstanceUsersResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.ListAppInstanceUsersResponse",
        "This cmdlet returns an Amazon.Chime.Model.ListAppInstanceUsersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by ListAppInstanceUsers in the Amazon Chime SDK Identity Namespace")]
    public partial class GetCHMAppInstanceUserListCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.ListAppInstanceUsersResponse, GetCHMAppInstanceUserListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Chime.Model.ListAppInstanceUsersRequest();
        ...
        private Amazon.Chime.Model.ListAppInstanceUsersResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.ListAppInstanceUsersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "ListAppInstanceUsers");
            try
            {
                #if DESKTOP
                return client.ListAppInstanceUsers(request);
                #elif CORECLR
                return client.ListAppInstanceUsersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.Chime.Model.ListAppInstanceUsersResponse, GetCHMAppInstanceUserListCmdlet, object> Select { get; set; } =
