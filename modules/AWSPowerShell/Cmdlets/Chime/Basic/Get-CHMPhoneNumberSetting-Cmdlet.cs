...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMPhoneNumberSetting")]
    ...
    public partial class GetCHMPhoneNumberSettingCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetPhoneNumberSettingsResponse, GetCHMPhoneNumberSettingCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetPhoneNumberSettingsRequest();
        ...
        private Amazon.Chime.Model.GetPhoneNumberSettingsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetPhoneNumberSettingsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetPhoneNumberSettings");
            try
            {
                #if DESKTOP
        ...
        {
            public System.Func<Amazon.Chime.Model.GetPhoneNumberSettingsResponse, GetCHMPhoneNumberSettingCmdlet, object> Select { get; set; } =
