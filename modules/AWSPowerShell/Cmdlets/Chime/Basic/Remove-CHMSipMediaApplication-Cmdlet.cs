...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMSipMediaApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveCHMSipMediaApplicationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMSipMediaApplication (DeleteSipMediaApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteSipMediaApplicationResponse, RemoveCHMSipMediaApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteSipMediaApplicationRequest();
        ...
        private Amazon.Chime.Model.DeleteSipMediaApplicationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteSipMediaApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteSipMediaApplication");
            try
            {
                return client.DeleteSipMediaApplicationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String SipMediaApplicationId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteSipMediaApplicationResponse, RemoveCHMSipMediaApplicationCmdlet, object> Select { get; set; } =
