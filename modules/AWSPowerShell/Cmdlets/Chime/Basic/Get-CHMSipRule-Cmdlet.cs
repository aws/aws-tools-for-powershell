...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMSipRule")]
    [OutputType("Amazon.Chime.Model.SipRule")]
    [AWSCmdlet("Calls the Amazon Chime GetSipRule API operation.", Operation = new[] {"GetSipRule"}, SelectReturnType = typeof(Amazon.Chime.Model.GetSipRuleResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.SipRule or Amazon.Chime.Model.GetSipRuleResponse",
        "This cmdlet returns an Amazon.Chime.Model.SipRule object.",
        "The service call response (type Amazon.Chime.Model.GetSipRuleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by GetSipRule in the Amazon Chime SDK Voice Namespace")]
    public partial class GetCHMSipRuleCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetSipRuleResponse, GetCHMSipRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetSipRuleRequest();
        ...
        private Amazon.Chime.Model.GetSipRuleResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetSipRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetSipRule");
            try
            {
                #if DESKTOP
                return client.GetSipRule(request);
                #elif CORECLR
                return client.GetSipRuleAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String SipRuleId { get; set; }
            public System.Func<Amazon.Chime.Model.GetSipRuleResponse, GetCHMSipRuleCmdlet, object> Select { get; set; } =
