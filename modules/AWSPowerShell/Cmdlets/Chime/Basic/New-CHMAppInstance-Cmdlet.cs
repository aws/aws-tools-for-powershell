...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [AWSCmdlet("Calls the Amazon Chime CreateAppInstance API operation.", Operation = new[] {"CreateAppInstance"}, SelectReturnType = typeof(Amazon.Chime.Model.CreateAppInstanceResponse))]
    [AWSCmdletOutput("System.String or Amazon.Chime.Model.CreateAppInstanceResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.Chime.Model.CreateAppInstanceResponse) can be returned by specifying '-Select *'."
    )]
    ...
    public partial class NewCHMAppInstanceCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CHMAppInstance (CreateAppInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.CreateAppInstanceResponse, NewCHMAppInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.CreateAppInstanceRequest();
        ...
        private Amazon.Chime.Model.CreateAppInstanceResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.CreateAppInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "CreateAppInstance");
            try
            {
