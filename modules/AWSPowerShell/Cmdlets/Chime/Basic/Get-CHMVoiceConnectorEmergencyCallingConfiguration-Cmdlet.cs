...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class GetCHMVoiceConnectorEmergencyCallingConfigurationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetVoiceConnectorEmergencyCallingConfigurationResponse, GetCHMVoiceConnectorEmergencyCallingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetVoiceConnectorEmergencyCallingConfigurationRequest();
        ...
        private Amazon.Chime.Model.GetVoiceConnectorEmergencyCallingConfigurationResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetVoiceConnectorEmergencyCallingConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetVoiceConnectorEmergencyCallingConfiguration");
            try
            {
                #if DESKTOP
                return client.GetVoiceConnectorEmergencyCallingConfiguration(request);
                #elif CORECLR
                return client.GetVoiceConnectorEmergencyCallingConfigurationAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String VoiceConnectorId { get; set; }
            public System.Func<Amazon.Chime.Model.GetVoiceConnectorEmergencyCallingConfigurationResponse, GetCHMVoiceConnectorEmergencyCallingConfigurationCmdlet, object> Select { get; set; } =
