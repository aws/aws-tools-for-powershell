...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Update", "CHMChannelReadMarker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCHMChannelReadMarkerCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CHMChannelReadMarker (UpdateChannelReadMarker)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.UpdateChannelReadMarkerResponse, UpdateCHMChannelReadMarkerCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.UpdateChannelReadMarkerRequest();
        ...
        private Amazon.Chime.Model.UpdateChannelReadMarkerResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.UpdateChannelReadMarkerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "UpdateChannelReadMarker");
            try
            {
                return client.UpdateChannelReadMarkerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ChannelArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.Chime.Model.UpdateChannelReadMarkerResponse, UpdateCHMChannelReadMarkerCmdlet, object> Select { get; set; } =
