...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    [OutputType("Amazon.Chime.Model.SendChannelMessageResponse")]
    [AWSCmdlet("Calls the Amazon Chime SendChannelMessage API operation.", Operation = new[] {"SendChannelMessage"}, SelectReturnType = typeof(Amazon.Chime.Model.SendChannelMessageResponse))]
    [AWSCmdletOutput("Amazon.Chime.Model.SendChannelMessageResponse",
        "This cmdlet returns an Amazon.Chime.Model.SendChannelMessageResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by SendChannelMessage in the Amazon Chime SDK Messaging Namespace")]
    public partial class SendCHMChannelMessageCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.Chime.ChannelMessagePersistenceType")]
        public Amazon.Chime.ChannelMessagePersistenceType Persistence { get; set; }
        #endregion
        ...
        #endif
        [Amazon.PowerShell.Common.AWSRequiredParameter]
        [AWSConstantClassSource("Amazon.Chime.ChannelMessageType")]
        public Amazon.Chime.ChannelMessageType Type { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Send-CHMChannelMessage (SendChannelMessage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.SendChannelMessageResponse, SendCHMChannelMessageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.SendChannelMessageRequest();
        ...
        private Amazon.Chime.Model.SendChannelMessageResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.SendChannelMessageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "SendChannelMessage");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.Chime.ChannelMessagePersistenceType Persistence { get; set; }
            public Amazon.Chime.ChannelMessageType Type { get; set; }
            public System.Func<Amazon.Chime.Model.SendChannelMessageResponse, SendCHMChannelMessageCmdlet, object> Select { get; set; } =
