...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Get", "CHMAppInstanceStreamingConfiguration")]
    ...
    public partial class GetCHMAppInstanceStreamingConfigurationCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.GetAppInstanceStreamingConfigurationsResponse, GetCHMAppInstanceStreamingConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.GetAppInstanceStreamingConfigurationsRequest();
        ...
        private Amazon.Chime.Model.GetAppInstanceStreamingConfigurationsResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.GetAppInstanceStreamingConfigurationsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "GetAppInstanceStreamingConfigurations");
            try
            {
                #if DESKTOP
                return client.GetAppInstanceStreamingConfigurations(request);
                #elif CORECLR
                return client.GetAppInstanceStreamingConfigurationsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String AppInstanceArn { get; set; }
            public System.Func<Amazon.Chime.Model.GetAppInstanceStreamingConfigurationsResponse, GetCHMAppInstanceStreamingConfigurationCmdlet, object> Select { get; set; } =
