...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMChannelModerator", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteChannelModerator API operation.", Operation = new[] {"DeleteChannelModerator"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteChannelModeratorResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteChannelModeratorResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteChannelModeratorResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteChannelModerator in the Amazon Chime SDK Messaging Namespace")]
    public partial class RemoveCHMChannelModeratorCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMChannelModerator (DeleteChannelModerator)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteChannelModeratorResponse, RemoveCHMChannelModeratorCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteChannelModeratorRequest();
        ...
        private Amazon.Chime.Model.DeleteChannelModeratorResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteChannelModeratorRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteChannelModerator");
            try
            {
                #if DESKTOP
                return client.DeleteChannelModerator(request);
                #elif CORECLR
                return client.DeleteChannelModeratorAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChannelModeratorArn { get; set; }
            public System.String ChimeBearer { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteChannelModeratorResponse, RemoveCHMChannelModeratorCmdlet, object> Select { get; set; } =
