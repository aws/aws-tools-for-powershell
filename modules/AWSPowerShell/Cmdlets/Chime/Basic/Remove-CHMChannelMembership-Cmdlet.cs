...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CHMChannelMembership", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the Amazon Chime DeleteChannelMembership API operation.", Operation = new[] {"DeleteChannelMembership"}, SelectReturnType = typeof(Amazon.Chime.Model.DeleteChannelMembershipResponse))]
    [AWSCmdletOutput("None or Amazon.Chime.Model.DeleteChannelMembershipResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.Chime.Model.DeleteChannelMembershipResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    [System.ObsoleteAttribute("Replaced by DeleteChannelMembership in the Amazon Chime SDK Messaging Namespace")]
    public partial class RemoveCHMChannelMembershipCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMChannelMembership (DeleteChannelMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteChannelMembershipResponse, RemoveCHMChannelMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteChannelMembershipRequest();
        ...
        private Amazon.Chime.Model.DeleteChannelMembershipResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteChannelMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteChannelMembership");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChimeBearer { get; set; }
            public System.String MemberArn { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteChannelMembershipResponse, RemoveCHMChannelMembershipCmdlet, object> Select { get; set; } =
