...
namespace Amazon.PowerShell.Cmdlets.CHM
{
    ...
    public partial class RemoveCHMRoomMembershipCmdlet : AmazonChimeClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CHMRoomMembership (DeleteRoomMembership)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Chime.Model.DeleteRoomMembershipResponse, RemoveCHMRoomMembershipCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Chime.Model.DeleteRoomMembershipRequest();
        ...
        private Amazon.Chime.Model.DeleteRoomMembershipResponse CallAWSServiceOperation(IAmazonChime client, Amazon.Chime.Model.DeleteRoomMembershipRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Chime", "DeleteRoomMembership");
            try
            {
                #if DESKTOP
                return client.DeleteRoomMembership(request);
                #elif CORECLR
                return client.DeleteRoomMembershipAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MemberId { get; set; }
            public System.String RoomId { get; set; }
            public System.Func<Amazon.Chime.Model.DeleteRoomMembershipResponse, RemoveCHMRoomMembershipCmdlet, object> Select { get; set; } =
