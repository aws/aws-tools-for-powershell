...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    [AWSCmdlet("Calls the Amazon EC2 Container Registry ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.ECR.Model.Tag",
