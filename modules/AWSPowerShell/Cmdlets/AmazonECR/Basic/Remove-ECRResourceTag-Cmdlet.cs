...
namespace Amazon.PowerShell.Cmdlets.ECR
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ECRResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None","System.String")]
    [AWSCmdlet("Calls the Amazon EC2 Container Registry UntagResource API operation.", Operation = new[] {"UntagResource"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.ECR.Model.UntagResourceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveECRResourceTagCmdlet : AmazonECRClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ECRResourceTag (UntagResource)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ECR.Model.UntagResourceRequest();
        ...
        private Amazon.ECR.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonECR client, Amazon.ECR.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon EC2 Container Registry", "UntagResource");
            try
            {
                #if DESKTOP
