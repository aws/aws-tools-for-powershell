...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    public partial class DisableCWEEventSourceCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.DeactivateEventSourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Disable-CWEEventSource (DeactivateEventSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.DeactivateEventSourceResponse, DisableCWEEventSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvents.Model.DeactivateEventSourceRequest();
        ...
        private Amazon.CloudWatchEvents.Model.DeactivateEventSourceResponse CallAWSServiceOperation(IAmazonCloudWatchEvents client, Amazon.CloudWatchEvents.Model.DeactivateEventSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Events", "DeactivateEventSource");
            try
            {
                return client.DeactivateEventSourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.DeactivateEventSourceResponse, DisableCWEEventSourceCmdlet, object> Select { get; set; } =
