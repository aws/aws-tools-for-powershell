...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    /// </summary>
    [Cmdlet("Stop", "CWEReplay", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StopCWEReplayCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.CancelReplayResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchEvents.Model.CancelReplayResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Stop-CWEReplay (CancelReplay)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.CancelReplayResponse, StopCWEReplayCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvents.Model.CancelReplayRequest();
        ...
        private Amazon.CloudWatchEvents.Model.CancelReplayResponse CallAWSServiceOperation(IAmazonCloudWatchEvents client, Amazon.CloudWatchEvents.Model.CancelReplayRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Events", "CancelReplay");
            try
            {
                return client.CancelReplayAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String ReplayName { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.CancelReplayResponse, StopCWEReplayCmdlet, object> Select { get; set; } =
