...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Events ListRules API operation.", Operation = new[] {"ListRules"}, SelectReturnType = typeof(Amazon.CloudWatchEvents.Model.ListRulesResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchEvents.Model.Rule or Amazon.CloudWatchEvents.Model.ListRulesResponse",
        "This cmdlet returns a collection of Amazon.CloudWatchEvents.Model.Rule objects.",
        "The service call response (type Amazon.CloudWatchEvents.Model.ListRulesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWERuleCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.ListRulesResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchEvents.Model.ListRulesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.ListRulesResponse, GetCWERuleCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NamePrefix { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.ListRulesResponse, GetCWERuleCmdlet, object> Select { get; set; } =
