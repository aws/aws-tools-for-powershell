...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Events DescribeEventBus API operation.", Operation = new[] {"DescribeEventBus"}, SelectReturnType = typeof(Amazon.CloudWatchEvents.Model.DescribeEventBusResponse))]
    [AWSCmdletOutput("Amazon.CloudWatchEvents.Model.DescribeEventBusResponse",
        "This cmdlet returns an Amazon.CloudWatchEvents.Model.DescribeEventBusResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWEEventBusCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.DescribeEventBusResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchEvents.Model.DescribeEventBusResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.DescribeEventBusResponse, GetCWEEventBusCmdlet>(Select) ??
        ...
        {
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.DescribeEventBusResponse, GetCWEEventBusCmdlet, object> Select { get; set; } =
