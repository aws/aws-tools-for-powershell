...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    public partial class RemoveCWEPartnerEventSourceCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWEPartnerEventSource (DeletePartnerEventSource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceResponse, RemoveCWEPartnerEventSourceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceRequest();
        ...
        private Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceResponse CallAWSServiceOperation(IAmazonCloudWatchEvents client, Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Events", "DeletePartnerEventSource");
            try
            {
                return client.DeletePartnerEventSourceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Account { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.DeletePartnerEventSourceResponse, RemoveCWEPartnerEventSourceCmdlet, object> Select { get; set; } =
