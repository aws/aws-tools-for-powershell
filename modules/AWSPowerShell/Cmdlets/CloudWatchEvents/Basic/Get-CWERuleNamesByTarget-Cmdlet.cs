...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    [AWSCmdlet("Calls the Amazon CloudWatch Events ListRuleNamesByTarget API operation.", Operation = new[] {"ListRuleNamesByTarget"}, SelectReturnType = typeof(Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse))]
    [AWSCmdletOutput("System.String or Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse",
        "This cmdlet returns a collection of System.String objects.",
        "The service call response (type Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetCWERuleNamesByTargetCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "RuleNames";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse, GetCWERuleNamesByTargetCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.RuleNames?.Count ?? 0;
        ...
        private Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse CallAWSServiceOperation(IAmazonCloudWatchEvents client, Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetRequest request)
        {
            ...
            try
            {
                return client.ListRuleNamesByTargetAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String TargetArn { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.ListRuleNamesByTargetResponse, GetCWERuleNamesByTargetCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.RuleNames;
        }
