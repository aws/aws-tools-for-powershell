...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    [AWSCmdletOutput("Amazon.CloudWatchEvents.Model.UpdateApiDestinationResponse",
        "This cmdlet returns an Amazon.CloudWatchEvents.Model.UpdateApiDestinationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
