...
namespace Amazon.PowerShell.Cmdlets.CWE
{
    ...
    /// </summary>
    [Cmdlet("Update", "CWEConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class UpdateCWEConnectionCmdlet : AmazonCloudWatchEventsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.CloudWatchEvents.Model.UpdateConnectionResponse).
        /// Specifying the name of a property of type Amazon.CloudWatchEvents.Model.UpdateConnectionResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-CWEConnection (UpdateConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CloudWatchEvents.Model.UpdateConnectionResponse, UpdateCWEConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CloudWatchEvents.Model.UpdateConnectionRequest();
            ...
            request.AuthParameters = new Amazon.CloudWatchEvents.Model.UpdateConnectionAuthRequestParameters();
            Amazon.CloudWatchEvents.Model.UpdateConnectionApiKeyAuthRequestParameters requestAuthParameters_authParameters_ApiKeyAuthParameters = null;
            
             // populate ApiKeyAuthParameters
            var requestAuthParameters_authParameters_ApiKeyAuthParametersIsNull = true;
            requestAuthParameters_authParameters_ApiKeyAuthParameters = new Amazon.CloudWatchEvents.Model.UpdateConnectionApiKeyAuthRequestParameters();
            ...
            Amazon.CloudWatchEvents.Model.UpdateConnectionBasicAuthRequestParameters requestAuthParameters_authParameters_BasicAuthParameters = null;
            
             // populate BasicAuthParameters
            var requestAuthParameters_authParameters_BasicAuthParametersIsNull = true;
            requestAuthParameters_authParameters_BasicAuthParameters = new Amazon.CloudWatchEvents.Model.UpdateConnectionBasicAuthRequestParameters();
            ...
            Amazon.CloudWatchEvents.Model.UpdateConnectionOAuthRequestParameters requestAuthParameters_authParameters_OAuthParameters = null;
            
             // populate OAuthParameters
            var requestAuthParameters_authParameters_OAuthParametersIsNull = true;
            requestAuthParameters_authParameters_OAuthParameters = new Amazon.CloudWatchEvents.Model.UpdateConnectionOAuthRequestParameters();
            ...
            Amazon.CloudWatchEvents.Model.UpdateConnectionOAuthClientRequestParameters requestAuthParameters_authParameters_OAuthParameters_authParameters_OAuthParameters_ClientParameters = null;
            ...
            requestAuthParameters_authParameters_OAuthParameters_authParameters_OAuthParameters_ClientParameters = new Amazon.CloudWatchEvents.Model.UpdateConnectionOAuthClientRequestParameters();
        ...
        private Amazon.CloudWatchEvents.Model.UpdateConnectionResponse CallAWSServiceOperation(IAmazonCloudWatchEvents client, Amazon.CloudWatchEvents.Model.UpdateConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Events", "UpdateConnection");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Description { get; set; }
            public System.String Name { get; set; }
            public System.Func<Amazon.CloudWatchEvents.Model.UpdateConnectionResponse, UpdateCWEConnectionCmdlet, object> Select { get; set; } =
