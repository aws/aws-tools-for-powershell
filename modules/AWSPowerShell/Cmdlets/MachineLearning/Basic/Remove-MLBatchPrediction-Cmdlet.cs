...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    public partial class RemoveMLBatchPredictionCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^BatchPredictionId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.BatchPredictionId;
            }
