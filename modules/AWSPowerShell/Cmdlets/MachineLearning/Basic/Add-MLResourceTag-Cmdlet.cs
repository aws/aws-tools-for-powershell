...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    public partial class AddMLResourceTagCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        /// a value, Amazon ML creates a tag with the specified key and a value of null.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MachineLearning.Model.AddTagsResponse, AddMLResourceTagCmdlet>(Select) ??
            ...
            if (this.Tag != null)
            {
                context.Tag = new List<Amazon.MachineLearning.Model.Tag>(this.Tag);
            }
            #if MODULAR
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ResourceId { get; set; }
            public Amazon.MachineLearning.TaggableResourceType ResourceType { get; set; }
            public List<Amazon.MachineLearning.Model.Tag> Tag { get; set; }
            public System.Func<Amazon.MachineLearning.Model.AddTagsResponse, AddMLResourceTagCmdlet, object> Select { get; set; } =
