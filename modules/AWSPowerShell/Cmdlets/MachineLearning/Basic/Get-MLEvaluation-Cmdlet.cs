...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    [AWSCmdletOutput("Amazon.MachineLearning.Model.GetEvaluationResponse",
        "This cmdlet returns an Amazon.MachineLearning.Model.GetEvaluationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMLEvaluationCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^EvaluationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.EvaluationId;
            }
        ...
        private Amazon.MachineLearning.Model.GetEvaluationResponse CallAWSServiceOperation(IAmazonMachineLearning client, Amazon.MachineLearning.Model.GetEvaluationRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.GetEvaluationAsync(request).GetAwaiter().GetResult();
                #else
