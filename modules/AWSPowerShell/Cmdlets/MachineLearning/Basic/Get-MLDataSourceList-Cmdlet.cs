...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    [AWSCmdlet("Calls the Amazon Machine Learning DescribeDataSources API operation.", Operation = new[] {"DescribeDataSources"}, SelectReturnType = typeof(Amazon.MachineLearning.Model.DescribeDataSourcesResponse), LegacyAlias="Get-MLDataSources")]
    [AWSCmdletOutput("Amazon.MachineLearning.Model.DataSource or Amazon.MachineLearning.Model.DescribeDataSourcesResponse",
        "This cmdlet returns a collection of Amazon.MachineLearning.Model.DataSource objects.",
        "The service call response (type Amazon.MachineLearning.Model.DescribeDataSourcesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMLDataSourceListCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MachineLearning.Model.DescribeDataSourcesResponse, GetMLDataSourceListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MachineLearning.Model.DescribeDataSourcesRequest();
        ...
        private Amazon.MachineLearning.Model.DescribeDataSourcesResponse CallAWSServiceOperation(IAmazonMachineLearning client, Amazon.MachineLearning.Model.DescribeDataSourcesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Machine Learning", "DescribeDataSources");
            try
            {
                #if DESKTOP
                return client.DescribeDataSources(request);
                #elif CORECLR
                return client.DescribeDataSourcesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Prefix { get; set; }
            public Amazon.MachineLearning.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.MachineLearning.Model.DescribeDataSourcesResponse, GetMLDataSourceListCmdlet, object> Select { get; set; } =
