...
namespace Amazon.PowerShell.Cmdlets.ML
{
    ...
    [AWSCmdlet("Calls the Amazon Machine Learning DescribeMLModels API operation.", Operation = new[] {"DescribeMLModels"}, SelectReturnType = typeof(Amazon.MachineLearning.Model.DescribeMLModelsResponse), LegacyAlias="Get-MLModels")]
    [AWSCmdletOutput("Amazon.MachineLearning.Model.MLModel or Amazon.MachineLearning.Model.DescribeMLModelsResponse",
        "This cmdlet returns a collection of Amazon.MachineLearning.Model.MLModel objects.",
        "The service call response (type Amazon.MachineLearning.Model.DescribeMLModelsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetMLModelListCmdlet : AmazonMachineLearningClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MachineLearning.Model.DescribeMLModelsResponse, GetMLModelListCmdlet>(Select) ??
        ...
        private Amazon.MachineLearning.Model.DescribeMLModelsResponse CallAWSServiceOperation(IAmazonMachineLearning client, Amazon.MachineLearning.Model.DescribeMLModelsRequest request)
        {
            ...
            try
            {
                return client.DescribeMLModelsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Prefix { get; set; }
            public Amazon.MachineLearning.SortOrder SortOrder { get; set; }
            public System.Func<Amazon.MachineLearning.Model.DescribeMLModelsResponse, GetMLModelListCmdlet, object> Select { get; set; } =
