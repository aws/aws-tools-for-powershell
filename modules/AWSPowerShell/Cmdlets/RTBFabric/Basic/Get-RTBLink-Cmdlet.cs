...
namespace Amazon.PowerShell.Cmdlets.RTB
{
    ...
    /// </summary>
    [Cmdlet("Get", "RTBLink")]
    [OutputType("Amazon.RTBFabric.Model.GetLinkResponse")]
    [AWSCmdlet("Calls the Amazon RTBFabric GetLink API operation.", Operation = new[] {"GetLink"}, SelectReturnType = typeof(Amazon.RTBFabric.Model.GetLinkResponse))]
    [AWSCmdletOutput("Amazon.RTBFabric.Model.GetLinkResponse",
        "This cmdlet returns an Amazon.RTBFabric.Model.GetLinkResponse object containing multiple properties."
    )]
    public partial class GetRTBLinkCmdlet : AmazonRTBFabricClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.RTBFabric.Model.GetLinkResponse).
        /// Specifying the name of a property of type Amazon.RTBFabric.Model.GetLinkResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RTBFabric.Model.GetLinkResponse, GetRTBLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RTBFabric.Model.GetLinkRequest();
        ...
        private Amazon.RTBFabric.Model.GetLinkResponse CallAWSServiceOperation(IAmazonRTBFabric client, Amazon.RTBFabric.Model.GetLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon RTBFabric", "GetLink");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String GatewayId { get; set; }
            public System.String LinkId { get; set; }
            public System.Func<Amazon.RTBFabric.Model.GetLinkResponse, GetRTBLinkCmdlet, object> Select { get; set; } =
