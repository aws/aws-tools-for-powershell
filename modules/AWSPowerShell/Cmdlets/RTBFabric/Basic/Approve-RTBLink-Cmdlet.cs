...
namespace Amazon.PowerShell.Cmdlets.RTB
{
    ...
    [OutputType("Amazon.RTBFabric.Model.AcceptLinkResponse")]
    [AWSCmdlet("Calls the Amazon RTBFabric AcceptLink API operation.", Operation = new[] {"AcceptLink"}, SelectReturnType = typeof(Amazon.RTBFabric.Model.AcceptLinkResponse))]
    [AWSCmdletOutput("Amazon.RTBFabric.Model.AcceptLinkResponse",
        "This cmdlet returns an Amazon.RTBFabric.Model.AcceptLinkResponse object containing multiple properties."
    )]
    public partial class ApproveRTBLinkCmdlet : AmazonRTBFabricClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.RTBFabric.Model.AcceptLinkResponse).
        /// Specifying the name of a property of type Amazon.RTBFabric.Model.AcceptLinkResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Approve-RTBLink (AcceptLink)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RTBFabric.Model.AcceptLinkResponse, ApproveRTBLinkCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RTBFabric.Model.AcceptLinkRequest();
        ...
        private Amazon.RTBFabric.Model.AcceptLinkResponse CallAWSServiceOperation(IAmazonRTBFabric client, Amazon.RTBFabric.Model.AcceptLinkRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon RTBFabric", "AcceptLink");
            try
            {
                #if DESKTOP
                return client.AcceptLink(request);
                #elif CORECLR
                return client.AcceptLinkAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Double? Sampling_ErrorLog { get; set; }
            public System.Double? Sampling_FilterLog { get; set; }
            public System.Func<Amazon.RTBFabric.Model.AcceptLinkResponse, ApproveRTBLinkCmdlet, object> Select { get; set; } =
