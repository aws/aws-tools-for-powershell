...
namespace Amazon.PowerShell.Cmdlets.RTB
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("New", "RTBLinkRoutingRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse")]
    [AWSCmdlet("Calls the Amazon RTBFabric CreateLinkRoutingRule API operation.", Operation = new[] {"CreateLinkRoutingRule"}, SelectReturnType = typeof(Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse))]
    [AWSCmdletOutput("Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse",
        "This cmdlet returns an Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse object containing multiple properties."
    )]
    public partial class NewRTBLinkRoutingRuleCmdlet : AmazonRTBFabricClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The priority of the routing rule. Lower numbers are evaluated first. Valid values
        /// are 1 to 1000. Priority must be unique among non-deleted rules within a link.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse).
        /// Specifying the name of a property of type Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-RTBLinkRoutingRule (CreateLinkRoutingRule)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse, NewRTBLinkRoutingRuleCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.RTBFabric.Model.CreateLinkRoutingRuleRequest();
        ...
        private Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse CallAWSServiceOperation(IAmazonRTBFabric client, Amazon.RTBFabric.Model.CreateLinkRoutingRuleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon RTBFabric", "CreateLinkRoutingRule");
            try
            {
                return client.CreateLinkRoutingRuleAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.RTBFabric.Model.CreateLinkRoutingRuleResponse, NewRTBLinkRoutingRuleCmdlet, object> Select { get; set; } =
