#
# Module manifest for module 'AWS.Tools.RTBFabric'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.RTBFabric.dll'
    ...
    GUID = 'D830BD3A-E1C3-4985-8D40-A93C55C00947'
    ...
    Description = 'The RTBFabric module of AWS Tools for PowerShell lets developers and administrators manage Amazon RTBFabric from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.RTBFabric.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.RTBFabric.Completers.psm1',
        'AWS.Tools.RTBFabric.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.RTBFabric.dll-Help.xml'
    )
