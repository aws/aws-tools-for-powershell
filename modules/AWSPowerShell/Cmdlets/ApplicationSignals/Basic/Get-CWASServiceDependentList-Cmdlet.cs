...
namespace Amazon.PowerShell.Cmdlets.CWAS
{
    ...
    /// clients that are instrumented with CloudWatch RUM app monitors.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CWASServiceDependentList")]
    ...
    public partial class GetCWASServiceDependentListCmdlet : AmazonApplicationSignalsClientCmdlet, IExecutor
    {
        ...
        /// set of service dependents.</para>
        /// </para>
        /// <para>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApplicationSignals.Model.ListServiceDependentsResponse).
        /// Specifying the name of a property of type Amazon.ApplicationSignals.Model.ListServiceDependentsResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationSignals.Model.ListServiceDependentsResponse, GetCWASServiceDependentListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApplicationSignals.Model.ListServiceDependentsRequest();
        ...
        private Amazon.ApplicationSignals.Model.ListServiceDependentsResponse CallAWSServiceOperation(IAmazonApplicationSignals client, Amazon.ApplicationSignals.Model.ListServiceDependentsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Signals", "ListServiceDependents");
            try
            {
                #if DESKTOP
                return client.ListServiceDependents(request);
                #elif CORECLR
                return client.ListServiceDependentsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.ApplicationSignals.Model.ListServiceDependentsResponse, GetCWASServiceDependentListCmdlet, object> Select { get; set; } =
