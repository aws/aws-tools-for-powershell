...
namespace Amazon.PowerShell.Cmdlets.CWAS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "CWASInstrumentationConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.ApplicationSignals.DynamicInstrumentationDeletionStatus")]
    [AWSCmdlet("Calls the Amazon CloudWatch Application Signals DeleteInstrumentationConfiguration API operation.", Operation = new[] {"DeleteInstrumentationConfiguration"}, SelectReturnType = typeof(Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse))]
    [AWSCmdletOutput("Amazon.ApplicationSignals.DynamicInstrumentationDeletionStatus or Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse",
        "This cmdlet returns an Amazon.ApplicationSignals.DynamicInstrumentationDeletionStatus object.",
        "The service call response (type Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RemoveCWASInstrumentationConfigurationCmdlet : AmazonApplicationSignalsClientCmdlet, IExecutor
    {
        ...
        /// the configuration to delete.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'DeletionStatus'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse).
        /// Specifying the name of a property of type Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "DeletionStatus";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-CWASInstrumentationConfiguration (DeleteInstrumentationConfiguration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse, RemoveCWASInstrumentationConfigurationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationRequest();
        ...
        private Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse CallAWSServiceOperation(IAmazonApplicationSignals client, Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Signals", "DeleteInstrumentationConfiguration");
            try
            {
                return client.DeleteInstrumentationConfigurationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Service { get; set; }
            public Amazon.ApplicationSignals.DynamicInstrumentationSignalType SignalType { get; set; }
            public System.Func<Amazon.ApplicationSignals.Model.DeleteInstrumentationConfigurationResponse, RemoveCWASInstrumentationConfigurationCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.DeletionStatus;
        }
