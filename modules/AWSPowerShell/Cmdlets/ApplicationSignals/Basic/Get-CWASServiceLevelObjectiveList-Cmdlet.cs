...
namespace Amazon.PowerShell.Cmdlets.CWAS
{
    ...
    public partial class GetCWASServiceLevelObjectiveListCmdlet : AmazonApplicationSignalsClientCmdlet, IExecutor
    {
        ...
        /// in the output. Supported types are:</para><ul><li><para>Service operation</para></li><li><para>Service dependency</para></li><li><para>Service</para></li><li><para>CloudWatch metric</para></li><li><para>AppMonitor</para></li><li><para>Canary</para></li></ul>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
