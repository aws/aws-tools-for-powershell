...
namespace Amazon.PowerShell.Cmdlets.CWAS
{
    ...
    [AWSCmdletOutput("Amazon.ApplicationSignals.Model.ServiceLevelObjectiveSummary or Amazon.ApplicationSignals.Model.ListServiceLevelObjectivesResponse",
        ...
        "The service call response (type Amazon.ApplicationSignals.Model.ListServiceLevelObjectivesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
