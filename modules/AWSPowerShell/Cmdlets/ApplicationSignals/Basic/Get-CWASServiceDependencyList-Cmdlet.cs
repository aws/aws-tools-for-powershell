...
namespace Amazon.PowerShell.Cmdlets.CWAS
{
    ...
    /// services.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    [Cmdlet("Get", "CWASServiceDependencyList")]
    [OutputType("Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse")]
    [AWSCmdlet("Calls the Amazon CloudWatch Application Signals ListServiceDependencies API operation.", Operation = new[] {"ListServiceDependencies"}, SelectReturnType = typeof(Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse))]
    [AWSCmdletOutput("Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse",
        "This cmdlet returns an Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCWASServiceDependencyListCmdlet : AmazonApplicationSignalsClientCmdlet, IExecutor
    {
        ...
        /// set of service dependencies.</para>
        /// </para>
        /// <para>
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse).
        /// Specifying the name of a property of type Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse, GetCWASServiceDependencyListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ApplicationSignals.Model.ListServiceDependenciesRequest();
        ...
        private Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse CallAWSServiceOperation(IAmazonApplicationSignals client, Amazon.ApplicationSignals.Model.ListServiceDependenciesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon CloudWatch Application Signals", "ListServiceDependencies");
            try
            {
                #if DESKTOP
                return client.ListServiceDependencies(request);
                #elif CORECLR
                return client.ListServiceDependenciesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.DateTime? StartTime { get; set; }
            public System.Func<Amazon.ApplicationSignals.Model.ListServiceDependenciesResponse, GetCWASServiceDependencyListCmdlet, object> Select { get; set; } =
