#
# Module manifest for module 'AWS.Tools.ApplicationSignals'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ApplicationSignals.dll'
    ...
    GUID = '10c671d6-9570-40b8-b87d-ff9be495b4f6'
    ...
    Description = 'The ApplicationSignals module of AWS Tools for PowerShell lets developers and administrators manage Amazon CloudWatch Application Signals from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.ApplicationSignals.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ApplicationSignals.Completers.psm1',
        'AWS.Tools.ApplicationSignals.Aliases.psm1'
    )
    ...
    CmdletsToExport = @(
        ...
        'Remove-CWASInstrumentationConfigurationBatch', 
    ...
    FileList = @(
        'AWS.Tools.ApplicationSignals.dll-Help.xml'
    )
