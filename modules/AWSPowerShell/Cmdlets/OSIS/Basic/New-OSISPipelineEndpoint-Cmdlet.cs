...
namespace Amazon.PowerShell.Cmdlets.OSIS
{
    ...
    public partial class NewOSISPipelineEndpointCmdlet : AmazonOSISClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>A list of security group IDs that control network access to the pipeline endpoint.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>A list of subnet IDs where the pipeline endpoint network interfaces are created.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        private Amazon.OSIS.Model.CreatePipelineEndpointResponse CallAWSServiceOperation(IAmazonOSIS client, Amazon.OSIS.Model.CreatePipelineEndpointRequest request)
        {
            ...
            try
            {
                return client.CreatePipelineEndpointAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
