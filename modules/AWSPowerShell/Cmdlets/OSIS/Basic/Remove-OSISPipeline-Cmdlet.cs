...
namespace Amazon.PowerShell.Cmdlets.OSIS
{
    ...
    public partial class RemoveOSISPipelineCmdlet : AmazonOSISClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OSIS.Model.DeletePipelineResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OSISPipeline (DeletePipeline)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OSIS.Model.DeletePipelineResponse, RemoveOSISPipelineCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OSIS.Model.DeletePipelineRequest();
        ...
        private Amazon.OSIS.Model.DeletePipelineResponse CallAWSServiceOperation(IAmazonOSIS client, Amazon.OSIS.Model.DeletePipelineRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon OpenSearch Ingestion", "DeletePipeline");
            try
            {
        ...
        {
            public System.String PipelineName { get; set; }
            public System.Func<Amazon.OSIS.Model.DeletePipelineResponse, RemoveOSISPipelineCmdlet, object> Select { get; set; } =
