...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class AddOPSResourceTagCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// or separators, or the following special characters: <c>+ - = . _ : /</c></para></li><li><para>Leading and trailing white spaces are trimmed from both the key and value.</para></li><li><para>A maximum of 40 tags is allowed for any resource.</para></li></ul><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.TagResourceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.TagResourceResponse, AddOPSResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OpsWorks.Model.TagResourceResponse, AddOPSResourceTagCmdlet, object> Select { get; set; } =
