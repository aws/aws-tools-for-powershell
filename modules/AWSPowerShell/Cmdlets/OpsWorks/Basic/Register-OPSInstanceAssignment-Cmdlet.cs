...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// </para></li></ul><para><b>Required Permissions</b>: To use this action, an Identity and Access Management
    ...
    public partial class RegisterOPSInstanceAssignmentCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// instance to a built-in layer.</para><para />
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.AssignInstanceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.AssignInstanceResponse, RegisterOPSInstanceAssignmentCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.AssignInstanceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.AssignInstanceRequest request)
        {
            ...
            try
            {
                return client.AssignInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.OpsWorks.Model.AssignInstanceResponse, RegisterOPSInstanceAssignmentCmdlet, object> Select { get; set; } =
