...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class UpdateOPSUserProfileCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.UpdateUserProfileResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.UpdateUserProfileResponse, UpdateOPSUserProfileCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.UpdateUserProfileResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UpdateUserProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "UpdateUserProfile");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SshPublicKey { get; set; }
            public System.String SshUsername { get; set; }
            public System.Func<Amazon.OpsWorks.Model.UpdateUserProfileResponse, UpdateOPSUserProfileCmdlet, object> Select { get; set; } =
