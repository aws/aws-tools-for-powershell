...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "OPSLayer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveOPSLayerCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DeleteLayerResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OPSLayer (DeleteLayer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DeleteLayerResponse, RemoveOPSLayerCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.DeleteLayerResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DeleteLayerRequest request)
        {
            ...
            try
            {
                return client.DeleteLayerAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String LayerId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.DeleteLayerResponse, RemoveOPSLayerCmdlet, object> Select { get; set; } =
