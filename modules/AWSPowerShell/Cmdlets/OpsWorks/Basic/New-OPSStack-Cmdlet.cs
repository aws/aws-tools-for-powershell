...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class NewOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The stack's AWS region, such as <c>ap-south-1</c>. For more information about Amazon
        /// regions, see <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html">Regions
        /// and Endpoints</a>.</para><note><para>In the AWS CLI, this API maps to the <c>--stack-region</c> parameter. If the <c>--stack-region</c>
        ...
        /// cannot be used to specify a classic AWS OpsWorks Stacks region.</para></note>
        /// </para>
        /// </summary>
        #if !MODULAR
