...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorks DescribeStackProvisioningParameters API operation.", Operation = new[] {"DescribeStackProvisioningParameters"}, SelectReturnType = typeof(Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse), LegacyAlias="Get-OPSStackProvisioningParameters")]
    [AWSCmdletOutput("Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse",
        "This cmdlet returns an Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetOPSStackProvisioningParameterCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse).
        /// Specifying the name of a property of type Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse, GetOPSStackProvisioningParameterCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DescribeStackProvisioningParametersRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.DescribeStackProvisioningParametersAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String StackId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.DescribeStackProvisioningParametersResponse, GetOPSStackProvisioningParameterCmdlet, object> Select { get; set; } =
