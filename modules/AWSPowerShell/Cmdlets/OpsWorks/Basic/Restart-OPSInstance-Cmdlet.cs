...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class RestartOPSInstanceCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.RebootInstanceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.RebootInstanceResponse, RestartOPSInstanceCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.RebootInstanceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.RebootInstanceRequest request)
        {
            ...
            try
            {
                return client.RebootInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.RebootInstanceResponse, RestartOPSInstanceCmdlet, object> Select { get; set; } =
