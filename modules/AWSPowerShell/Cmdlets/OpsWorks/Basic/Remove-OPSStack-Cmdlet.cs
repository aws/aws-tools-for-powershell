...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class RemoveOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DeleteStackResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OPSStack (DeleteStack)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DeleteStackResponse, RemoveOPSStackCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpsWorks.Model.DeleteStackRequest();
        ...
        private Amazon.OpsWorks.Model.DeleteStackResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DeleteStackRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "DeleteStack");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String StackId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.DeleteStackResponse, RemoveOPSStackCmdlet, object> Select { get; set; } =
