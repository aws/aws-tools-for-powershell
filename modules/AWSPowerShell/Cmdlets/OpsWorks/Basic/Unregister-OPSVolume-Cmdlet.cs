...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class UnregisterOPSVolumeCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The OpsWorks Stacks volume ID, which is the GUID that OpsWorks Stacks assigned to
        /// the instance when you registered the volume with the stack, not the Amazon EC2 volume
        /// ID.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DeregisterVolumeResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DeregisterVolumeResponse, UnregisterOPSVolumeCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.DeregisterVolumeResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DeregisterVolumeRequest request)
        {
            ...
            try
            {
                return client.DeregisterVolumeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String VolumeId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.DeregisterVolumeResponse, UnregisterOPSVolumeCmdlet, object> Select { get; set; } =
