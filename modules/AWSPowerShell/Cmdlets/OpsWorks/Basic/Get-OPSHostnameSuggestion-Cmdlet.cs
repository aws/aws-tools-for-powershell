...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdletOutput("Amazon.OpsWorks.Model.GetHostnameSuggestionResponse",
        "This cmdlet returns an Amazon.OpsWorks.Model.GetHostnameSuggestionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
