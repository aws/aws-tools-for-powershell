...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class RemoveOPSAppCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DeleteAppResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OPSApp (DeleteApp)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DeleteAppResponse, RemoveOPSAppCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpsWorks.Model.DeleteAppRequest();
        ...
        private Amazon.OpsWorks.Model.DeleteAppResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DeleteAppRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "DeleteApp");
            try
            {
        ...
        {
            public System.String AppId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.DeleteAppResponse, RemoveOPSAppCmdlet, object> Select { get; set; } =
