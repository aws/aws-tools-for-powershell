...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class UnregisterOPSRdsDbInstanceCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the RdsDbInstanceArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^RdsDbInstanceArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^RdsDbInstanceArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.RdsDbInstanceArn;
            }
