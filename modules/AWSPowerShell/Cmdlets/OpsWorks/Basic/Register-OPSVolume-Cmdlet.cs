...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorks RegisterVolume API operation.", Operation = new[] {"RegisterVolume"}, SelectReturnType = typeof(Amazon.OpsWorks.Model.RegisterVolumeResponse))]
    [AWSCmdletOutput("System.String or Amazon.OpsWorks.Model.RegisterVolumeResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.OpsWorks.Model.RegisterVolumeResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RegisterOPSVolumeCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.RegisterVolumeResponse).
        /// Specifying the name of a property of type Amazon.OpsWorks.Model.RegisterVolumeResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.RegisterVolumeResponse, RegisterOPSVolumeCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.RegisterVolumeResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.RegisterVolumeRequest request)
        {
            ...
            try
            {
                return client.RegisterVolumeAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String Ec2VolumeId { get; set; }
            public System.String StackId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.RegisterVolumeResponse, RegisterOPSVolumeCmdlet, object> Select { get; set; } =
