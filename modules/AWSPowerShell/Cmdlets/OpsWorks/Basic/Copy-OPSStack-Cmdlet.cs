...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    [AWSCmdlet("Calls the AWS OpsWorks CloneStack API operation.", Operation = new[] {"CloneStack"}, SelectReturnType = typeof(Amazon.OpsWorks.Model.CloneStackResponse))]
    [AWSCmdletOutput("System.String or Amazon.OpsWorks.Model.CloneStackResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.OpsWorks.Model.CloneStackResponse) can be returned by specifying '-Select *'."
    )]
    public partial class CopyOPSStackCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.CloneStackResponse).
        /// Specifying the name of a property of type Amazon.OpsWorks.Model.CloneStackResponse will result in that property being returned.
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the SourceStackId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^SourceStackId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^SourceStackId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.SourceStackId), MyInvocation.BoundParameters);
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.CloneStackResponse, CopyOPSStackCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.SourceStackId;
            }
            ...
            {
                context.CloneAppId = new List<System.String>(this.CloneAppId);
            }
            context.ClonePermission = this.ClonePermission;
            ...
            #if MODULAR
            if (this.SourceStackId == null && ParameterWasBound(nameof(this.SourceStackId)))
            {
                WriteWarning("You are passing $null as a value for parameter SourceStackId which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.CloneAppId != null)
            {
                request.CloneAppIds = cmdletContext.CloneAppId;
            }
            if (cmdletContext.ClonePermission != null)
            {
                request.ClonePermissions = cmdletContext.ClonePermission.Value;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ChefConfiguration_BerkshelfVersion { get; set; }
            public System.Boolean? ChefConfiguration_ManageBerkshelf { get; set; }
            public List<System.String> CloneAppId { get; set; }
            public System.Boolean? ClonePermission { get; set; }
            public System.String ConfigurationManager_Name { get; set; }
            public System.String ConfigurationManager_Version { get; set; }
            public System.String CustomCookbooksSource_Password { get; set; }
            ...
            public System.Boolean? UseOpsworksSecurityGroup { get; set; }
            public System.String VpcId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.CloneStackResponse, CopyOPSStackCmdlet, object> Select { get; set; } =
