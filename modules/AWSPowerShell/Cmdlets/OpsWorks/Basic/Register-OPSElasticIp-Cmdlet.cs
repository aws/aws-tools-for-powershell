...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// deregister it by calling <a>DeregisterElasticIp</a>. For more information, see <a href="https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html">Resource
    /// Management</a>.
    /// 
    ///  
    ...
    [AWSCmdlet("Calls the AWS OpsWorks RegisterElasticIp API operation.", Operation = new[] {"RegisterElasticIp"}, SelectReturnType = typeof(Amazon.OpsWorks.Model.RegisterElasticIpResponse))]
    [AWSCmdletOutput("System.String or Amazon.OpsWorks.Model.RegisterElasticIpResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.OpsWorks.Model.RegisterElasticIpResponse) can be returned by specifying '-Select *'."
    )]
    public partial class RegisterOPSElasticIpCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'ElasticIp'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.RegisterElasticIpResponse).
        /// Specifying the name of a property of type Amazon.OpsWorks.Model.RegisterElasticIpResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ElasticIp";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.RegisterElasticIpResponse, RegisterOPSElasticIpCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.RegisterElasticIpResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.RegisterElasticIpRequest request)
        {
            ...
            try
            {
                return client.RegisterElasticIpAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String ElasticIp { get; set; }
            public System.String StackId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.RegisterElasticIpResponse, RegisterOPSElasticIpCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ElasticIp;
        }
