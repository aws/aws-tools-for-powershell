...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Remove", "OPSVolume", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS OpsWorks UnassignVolume API operation.", Operation = new[] {"UnassignVolume"}, SelectReturnType = typeof(Amazon.OpsWorks.Model.UnassignVolumeResponse))]
    [AWSCmdletOutput("None or Amazon.OpsWorks.Model.UnassignVolumeResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.OpsWorks.Model.UnassignVolumeResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveOPSVolumeCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.UnassignVolumeResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-OPSVolume (UnassignVolume)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.UnassignVolumeResponse, RemoveOPSVolumeCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.OpsWorks.Model.UnassignVolumeRequest();
        ...
        private Amazon.OpsWorks.Model.UnassignVolumeResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.UnassignVolumeRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "UnassignVolume");
            try
            {
                #if DESKTOP
                return client.UnassignVolume(request);
                #elif CORECLR
                return client.UnassignVolumeAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String VolumeId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.UnassignVolumeResponse, RemoveOPSVolumeCmdlet, object> Select { get; set; } =
