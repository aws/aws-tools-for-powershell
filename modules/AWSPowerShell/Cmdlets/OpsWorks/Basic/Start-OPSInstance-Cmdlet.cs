...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Start", "OPSInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class StartOPSInstanceCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.StartInstanceResponse).
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-OPSInstance (StartInstance)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.StartInstanceResponse, StartOPSInstanceCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.StartInstanceResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.StartInstanceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS OpsWorks", "StartInstance");
            try
            {
                return client.StartInstanceAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String InstanceId { get; set; }
            public System.Func<Amazon.OpsWorks.Model.StartInstanceResponse, StartOPSInstanceCmdlet, object> Select { get; set; } =
