...
namespace Amazon.PowerShell.Cmdlets.OPS
{
    ...
    public partial class GetOPSOperatingSystemCmdlet : AmazonOpsWorksClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Use the -Select parameter to control the cmdlet output. The default value is 'OperatingSystems'.
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.OpsWorks.Model.DescribeOperatingSystemsResponse).
        /// Specifying the name of a property of type Amazon.OpsWorks.Model.DescribeOperatingSystemsResponse will result in that property being returned.
        /// Specifying -Select '^ParameterName' will result in the cmdlet returning the selected cmdlet parameter value.
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "OperatingSystems";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.OpsWorks.Model.DescribeOperatingSystemsResponse, GetOPSOperatingSystemCmdlet>(Select) ??
        ...
        private Amazon.OpsWorks.Model.DescribeOperatingSystemsResponse CallAWSServiceOperation(IAmazonOpsWorks client, Amazon.OpsWorks.Model.DescribeOperatingSystemsRequest request)
        {
            ...
            try
            {
                return client.DescribeOperatingSystemsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.Func<Amazon.OpsWorks.Model.DescribeOperatingSystemsResponse, GetOPSOperatingSystemCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.OperatingSystems;
        }
