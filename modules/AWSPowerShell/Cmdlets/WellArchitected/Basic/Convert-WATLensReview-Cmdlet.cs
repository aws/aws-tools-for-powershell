...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool UpgradeLensReview API operation.", Operation = new[] {"UpgradeLensReview"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.UpgradeLensReviewResponse))]
    [AWSCmdletOutput("None or Amazon.WellArchitected.Model.UpgradeLensReviewResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WellArchitected.Model.UpgradeLensReviewResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ConvertWATLensReviewCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Convert-WATLensReview (UpgradeLensReview)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.UpgradeLensReviewResponse, ConvertWATLensReviewCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.UpgradeLensReviewRequest();
        ...
        private Amazon.WellArchitected.Model.UpgradeLensReviewResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.UpgradeLensReviewRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "UpgradeLensReview");
            try
            {
                #if DESKTOP
                return client.UpgradeLensReview(request);
                #elif CORECLR
                return client.UpgradeLensReviewAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MilestoneName { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.UpgradeLensReviewResponse, ConvertWATLensReviewCmdlet, object> Select { get; set; } =
