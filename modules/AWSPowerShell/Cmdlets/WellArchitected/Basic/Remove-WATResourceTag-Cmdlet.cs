...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    public partial class RemoveWATResourceTagCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        /// are removed from the resource.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.WorkloadArn), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WATResourceTag (UntagResource)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.UntagResourceResponse, RemoveWATResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.UntagResourceRequest();
        ...
        private Amazon.WellArchitected.Model.UntagResourceResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.UntagResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "UntagResource");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String WorkloadArn { get; set; }
            public System.Func<Amazon.WellArchitected.Model.UntagResourceResponse, RemoveWATResourceTagCmdlet, object> Select { get; set; } =
