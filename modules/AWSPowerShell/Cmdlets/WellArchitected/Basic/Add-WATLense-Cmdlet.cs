...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Add", "WATLense", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool AssociateLenses API operation.", Operation = new[] {"AssociateLenses"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.AssociateLensesResponse))]
    ...
    public partial class AddWATLenseCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Add-WATLense (AssociateLenses)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.AssociateLensesResponse, AddWATLenseCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.AssociateLensesResponse, AddWATLenseCmdlet, object> Select { get; set; } =
