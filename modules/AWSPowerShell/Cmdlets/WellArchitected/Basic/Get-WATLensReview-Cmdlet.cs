...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    public partial class GetWATLensReviewCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.GetLensReviewResponse, GetWATLensReviewCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.GetLensReviewRequest();
        ...
        private Amazon.WellArchitected.Model.GetLensReviewResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.GetLensReviewRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "GetLensReview");
            try
            {
                #if DESKTOP
                return client.GetLensReview(request);
                #elif CORECLR
                return client.GetLensReviewAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MilestoneNumber { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.GetLensReviewResponse, GetWATLensReviewCmdlet, object> Select { get; set; } =
