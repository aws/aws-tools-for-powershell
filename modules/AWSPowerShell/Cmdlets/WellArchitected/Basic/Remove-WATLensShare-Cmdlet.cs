...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "WATLensShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool DeleteLensShare API operation.", Operation = new[] {"DeleteLensShare"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.DeleteLensShareResponse))]
    [AWSCmdletOutput("None or Amazon.WellArchitected.Model.DeleteLensShareResponse",
        "This cmdlet does not generate any output." +
        "The service response (type Amazon.WellArchitected.Model.DeleteLensShareResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveWATLensShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WATLensShare (DeleteLensShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.DeleteLensShareResponse, RemoveWATLensShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.DeleteLensShareRequest();
        ...
        private Amazon.WellArchitected.Model.DeleteLensShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.DeleteLensShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "DeleteLensShare");
            try
            {
                #if DESKTOP
                return client.DeleteLensShare(request);
                #elif CORECLR
                return client.DeleteLensShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LensAlias { get; set; }
            public System.String ShareId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.DeleteLensShareResponse, RemoveWATLensShareCmdlet, object> Select { get; set; } =
