...
{
    /// <summary>
    /// List of Trusted Advisor check details by account related to the workload.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetWATCheckDetailListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        private Amazon.WellArchitected.Model.ListCheckDetailsResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListCheckDetailsRequest request)
        {
            ...
            try
            {
                return client.ListCheckDetailsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
