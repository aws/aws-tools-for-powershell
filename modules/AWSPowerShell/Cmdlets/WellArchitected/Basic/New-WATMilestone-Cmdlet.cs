...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("New", "WATMilestone", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWATMilestoneCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WATMilestone (CreateMilestone)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.CreateMilestoneResponse, NewWATMilestoneCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.MilestoneName == null && ParameterWasBound(nameof(this.MilestoneName)))
            {
                WriteWarning("You are passing $null as a value for parameter MilestoneName which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.CreateMilestoneRequest();
        ...
        private Amazon.WellArchitected.Model.CreateMilestoneResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.CreateMilestoneRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "CreateMilestone");
            try
            {
                #if DESKTOP
                return client.CreateMilestone(request);
                #elif CORECLR
                return client.CreateMilestoneAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String MilestoneName { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.CreateMilestoneResponse, NewWATMilestoneCmdlet, object> Select { get; set; } =
