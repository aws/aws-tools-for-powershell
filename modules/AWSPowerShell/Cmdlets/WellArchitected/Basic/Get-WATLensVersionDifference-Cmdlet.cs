...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    [AWSCmdletOutput("Amazon.WellArchitected.Model.GetLensVersionDifferenceResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.GetLensVersionDifferenceResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
