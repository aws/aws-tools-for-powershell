...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    [AWSCmdlet("Calls the AWS Well-Architected Tool UpdateAnswer API operation.", Operation = new[] {"UpdateAnswer"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.UpdateAnswerResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.UpdateAnswerResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.UpdateAnswerResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateWATAnswerCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WATAnswer (UpdateAnswer)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.UpdateAnswerResponse, UpdateWATAnswerCmdlet>(Select) ??
        ...
        private Amazon.WellArchitected.Model.UpdateAnswerResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.UpdateAnswerRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "UpdateAnswer");
            try
            {
                #if DESKTOP
                return client.UpdateAnswer(request);
                #elif CORECLR
                return client.UpdateAnswerAsync(request).GetAwaiter().GetResult();
                #else
