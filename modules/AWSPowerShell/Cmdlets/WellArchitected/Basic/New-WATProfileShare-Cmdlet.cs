...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("New", "WATProfileShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWATProfileShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WATProfileShare (CreateProfileShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.CreateProfileShareResponse, NewWATProfileShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.CreateProfileShareRequest();
        ...
        private Amazon.WellArchitected.Model.CreateProfileShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.CreateProfileShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "CreateProfileShare");
            try
            {
                #if DESKTOP
                return client.CreateProfileShare(request);
                #elif CORECLR
                return client.CreateProfileShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProfileArn { get; set; }
            public System.String SharedWith { get; set; }
            public System.Func<Amazon.WellArchitected.Model.CreateProfileShareResponse, NewWATProfileShareCmdlet, object> Select { get; set; } =
