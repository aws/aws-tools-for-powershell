...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    [AWSCmdlet("Calls the AWS Well-Architected Tool ListLensReviews API operation.", Operation = new[] {"ListLensReviews"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.ListLensReviewsResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ListLensReviewsResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.ListLensReviewsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWATLensReviewListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.ListLensReviewsResponse, GetWATLensReviewListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.ListLensReviewsRequest();
        ...
        private Amazon.WellArchitected.Model.ListLensReviewsResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListLensReviewsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "ListLensReviews");
            try
            {
                #if DESKTOP
                return client.ListLensReviews(request);
                #elif CORECLR
                return client.ListLensReviewsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.ListLensReviewsResponse, GetWATLensReviewListCmdlet, object> Select { get; set; } =
