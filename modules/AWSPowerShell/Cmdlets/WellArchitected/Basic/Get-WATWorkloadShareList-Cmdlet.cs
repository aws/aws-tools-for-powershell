...
{
    /// <summary>
    /// List the workload shares associated with the workload.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ListWorkloadSharesResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.ListWorkloadSharesResponse object containing multiple properties."
    )]
    public partial class GetWATWorkloadShareListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        private Amazon.WellArchitected.Model.ListWorkloadSharesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListWorkloadSharesRequest request)
        {
            ...
            try
            {
                return client.ListWorkloadSharesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
