...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Remove", "WATProfileShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveWATProfileShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WATProfileShare (DeleteProfileShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.DeleteProfileShareResponse, RemoveWATProfileShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.DeleteProfileShareRequest();
        ...
        private Amazon.WellArchitected.Model.DeleteProfileShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.DeleteProfileShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "DeleteProfileShare");
            try
            {
                #if DESKTOP
                return client.DeleteProfileShare(request);
                #elif CORECLR
                return client.DeleteProfileShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProfileArn { get; set; }
            public System.String ShareId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.DeleteProfileShareResponse, RemoveWATProfileShareCmdlet, object> Select { get; set; } =
