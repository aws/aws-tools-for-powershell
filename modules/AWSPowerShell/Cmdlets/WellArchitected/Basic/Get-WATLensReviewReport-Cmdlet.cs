...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Get", "WATLensReviewReport")]
    [OutputType("Amazon.WellArchitected.Model.GetLensReviewReportResponse")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool GetLensReviewReport API operation.", Operation = new[] {"GetLensReviewReport"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.GetLensReviewReportResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.GetLensReviewReportResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.GetLensReviewReportResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetWATLensReviewReportCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.GetLensReviewReportResponse, GetWATLensReviewReportCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.GetLensReviewReportRequest();
        ...
        private Amazon.WellArchitected.Model.GetLensReviewReportResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.GetLensReviewReportRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "GetLensReviewReport");
            try
            {
                #if DESKTOP
                return client.GetLensReviewReport(request);
                #elif CORECLR
                return client.GetLensReviewReportAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Int32? MilestoneNumber { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.GetLensReviewReportResponse, GetWATLensReviewReportCmdlet, object> Select { get; set; } =
