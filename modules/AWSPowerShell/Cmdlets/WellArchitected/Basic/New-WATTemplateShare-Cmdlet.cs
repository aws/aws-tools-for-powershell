...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("New", "WATTemplateShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWATTemplateShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WATTemplateShare (CreateTemplateShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.CreateTemplateShareResponse, NewWATTemplateShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.CreateTemplateShareRequest();
        ...
        private Amazon.WellArchitected.Model.CreateTemplateShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.CreateTemplateShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "CreateTemplateShare");
            try
            {
                #if DESKTOP
                return client.CreateTemplateShare(request);
                #elif CORECLR
                return client.CreateTemplateShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SharedWith { get; set; }
            public System.String TemplateArn { get; set; }
            public System.Func<Amazon.WellArchitected.Model.CreateTemplateShareResponse, NewWATTemplateShareCmdlet, object> Select { get; set; } =
