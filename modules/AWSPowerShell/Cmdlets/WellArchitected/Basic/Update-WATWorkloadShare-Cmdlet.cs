...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Update", "WATWorkloadShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WellArchitected.Model.UpdateWorkloadShareResponse")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool UpdateWorkloadShare API operation.", Operation = new[] {"UpdateWorkloadShare"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.UpdateWorkloadShareResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.UpdateWorkloadShareResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.UpdateWorkloadShareResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateWATWorkloadShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WATWorkloadShare (UpdateWorkloadShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.UpdateWorkloadShareResponse, UpdateWATWorkloadShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.UpdateWorkloadShareRequest();
        ...
        private Amazon.WellArchitected.Model.UpdateWorkloadShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.UpdateWorkloadShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "UpdateWorkloadShare");
            try
            {
                #if DESKTOP
                return client.UpdateWorkloadShare(request);
                #elif CORECLR
                return client.UpdateWorkloadShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ShareId { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.UpdateWorkloadShareResponse, UpdateWATWorkloadShareCmdlet, object> Select { get; set; } =
