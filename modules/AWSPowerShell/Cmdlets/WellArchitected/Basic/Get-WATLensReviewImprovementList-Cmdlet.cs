...
{
    /// <summary>
    /// List the improvements of a particular lens review.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "WATLensReviewImprovementList")]
    [OutputType("Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool ListLensReviewImprovements API operation.", Operation = new[] {"ListLensReviewImprovements"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse object containing multiple properties."
    )]
    public partial class GetWATLensReviewImprovementListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse, GetWATLensReviewImprovementListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WellArchitected.Model.ListLensReviewImprovementsRequest();
        ...
        private Amazon.WellArchitected.Model.ListLensReviewImprovementsResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListLensReviewImprovementsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "ListLensReviewImprovements");
            try
            {
                return client.ListLensReviewImprovementsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
