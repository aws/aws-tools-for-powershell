...
{
    /// <summary>
    /// List review templates.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetWATReviewTemplateListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        private Amazon.WellArchitected.Model.ListReviewTemplatesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListReviewTemplatesRequest request)
        {
            ...
            try
            {
                return client.ListReviewTemplatesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
