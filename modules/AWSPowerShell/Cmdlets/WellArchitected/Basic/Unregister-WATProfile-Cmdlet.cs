...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Unregister", "WATProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("None")]
    ...
    public partial class UnregisterWATProfileCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The list of profile ARNs to disassociate from the workload.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Unregister-WATProfile (DisassociateProfiles)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.DisassociateProfilesResponse, UnregisterWATProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.DisassociateProfilesRequest();
        ...
        private Amazon.WellArchitected.Model.DisassociateProfilesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.DisassociateProfilesRequest request)
        {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.DisassociateProfilesResponse, UnregisterWATProfileCmdlet, object> Select { get; set; } =
