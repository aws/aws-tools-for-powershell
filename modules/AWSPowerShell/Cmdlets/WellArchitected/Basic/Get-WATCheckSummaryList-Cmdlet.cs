...
{
    /// <summary>
    /// List of Trusted Advisor checks summarized for all accounts related to the workload.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "WATCheckSummaryList")]
    [OutputType("Amazon.WellArchitected.Model.CheckSummary")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool ListCheckSummaries API operation.", Operation = new[] {"ListCheckSummaries"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.ListCheckSummariesResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.CheckSummary or Amazon.WellArchitected.Model.ListCheckSummariesResponse",
        "This cmdlet returns a collection of Amazon.WellArchitected.Model.CheckSummary objects.",
        "The service call response (type Amazon.WellArchitected.Model.ListCheckSummariesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWATCheckSummaryListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.ListCheckSummariesResponse, GetWATCheckSummaryListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WellArchitected.Model.ListCheckSummariesRequest();
        ...
        private Amazon.WellArchitected.Model.ListCheckSummariesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListCheckSummariesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "ListCheckSummaries");
            try
            {
                return client.ListCheckSummariesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String QuestionId { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.ListCheckSummariesResponse, GetWATCheckSummaryListCmdlet, object> Select { get; set; } =
