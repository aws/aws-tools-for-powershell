...
{
    /// <summary>
    /// List of answers for a particular workload and lens.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "WATAnswerList")]
    [OutputType("Amazon.WellArchitected.Model.ListAnswersResponse")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool ListAnswers API operation.", Operation = new[] {"ListAnswers"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.ListAnswersResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ListAnswersResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.ListAnswersResponse object containing multiple properties."
    )]
    public partial class GetWATAnswerListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.ListAnswersResponse, GetWATAnswerListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.WellArchitected.Model.ListAnswersRequest();
        ...
        private Amazon.WellArchitected.Model.ListAnswersResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListAnswersRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "ListAnswers");
            try
            {
                return client.ListAnswersAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public Amazon.WellArchitected.QuestionPriority QuestionPriority { get; set; }
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.ListAnswersResponse, GetWATAnswerListCmdlet, object> Select { get; set; } =
