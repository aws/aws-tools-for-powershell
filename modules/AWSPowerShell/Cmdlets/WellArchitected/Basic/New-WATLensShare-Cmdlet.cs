...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("New", "WATLensShare", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class NewWATLensShareCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ShareId";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WATLensShare (CreateLensShare)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.CreateLensShareResponse, NewWATLensShareCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.CreateLensShareRequest();
        ...
        private Amazon.WellArchitected.Model.CreateLensShareResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.CreateLensShareRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "CreateLensShare");
            try
            {
                #if DESKTOP
                return client.CreateLensShare(request);
                #elif CORECLR
                return client.CreateLensShareAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String LensAlias { get; set; }
            public System.String SharedWith { get; set; }
            public System.Func<Amazon.WellArchitected.Model.CreateLensShareResponse, NewWATLensShareCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ShareId;
        }
