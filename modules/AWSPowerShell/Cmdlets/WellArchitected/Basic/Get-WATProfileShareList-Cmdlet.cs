...
{
    /// <summary>
    /// List profile shares.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ProfileShareSummary or Amazon.WellArchitected.Model.ListProfileSharesResponse",
        ...
        "The service call response (type Amazon.WellArchitected.Model.ListProfileSharesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetWATProfileShareListCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        private Amazon.WellArchitected.Model.ListProfileSharesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.ListProfileSharesRequest request)
        {
            ...
            try
            {
                return client.ListProfileSharesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
