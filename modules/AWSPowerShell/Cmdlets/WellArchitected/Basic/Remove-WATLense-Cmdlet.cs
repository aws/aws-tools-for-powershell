...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "WATLense", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool DisassociateLenses API operation.", Operation = new[] {"DisassociateLenses"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.DisassociateLensesResponse))]
    ...
    public partial class RemoveWATLenseCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-WATLense (DisassociateLenses)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.DisassociateLensesResponse, RemoveWATLenseCmdlet>(Select) ??
        ...
        private Amazon.WellArchitected.Model.DisassociateLensesResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.DisassociateLensesRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DisassociateLenses(request);
                #elif CORECLR
                return client.DisassociateLensesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String WorkloadId { get; set; }
            public System.Func<Amazon.WellArchitected.Model.DisassociateLensesResponse, RemoveWATLenseCmdlet, object> Select { get; set; } =
