...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("New", "WATReviewTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("System.String")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool CreateReviewTemplate API operation.", Operation = new[] {"CreateReviewTemplate"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.CreateReviewTemplateResponse))]
    [AWSCmdletOutput("System.String or Amazon.WellArchitected.Model.CreateReviewTemplateResponse",
        "This cmdlet returns a System.String object.",
        "The service call response (type Amazon.WellArchitected.Model.CreateReviewTemplateResponse) can be returned by specifying '-Select *'."
    )]
    public partial class NewWATReviewTemplateCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Lenses applied to the review template.</para><para />
        ...
        /// <summary>
        /// <para>
        /// <para>The tags assigned to the review template.</para><para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
        /// from the service the property will also be null. This was changed to improve performance and allow the SDK and caller
        /// to distinguish between a property not set or a property being empty to clear out a value. To retain the previous
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-WATReviewTemplate (CreateReviewTemplate)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.CreateReviewTemplateResponse, NewWATReviewTemplateCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.CreateReviewTemplateRequest();
        ...
        private Amazon.WellArchitected.Model.CreateReviewTemplateResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.CreateReviewTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "CreateReviewTemplate");
            try
            {
                return client.CreateReviewTemplateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String TemplateName { get; set; }
            public System.Func<Amazon.WellArchitected.Model.CreateReviewTemplateResponse, NewWATReviewTemplateCmdlet, object> Select { get; set; } =
