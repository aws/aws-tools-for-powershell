...
namespace Amazon.PowerShell.Cmdlets.WAT
{
    ...
    /// </summary>
    [Cmdlet("Update", "WATAgentContext", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.WellArchitected.Model.ContextSummary")]
    [AWSCmdlet("Calls the AWS Well-Architected Tool UpdateAgentContext API operation.", Operation = new[] {"UpdateAgentContext"}, SelectReturnType = typeof(Amazon.WellArchitected.Model.UpdateAgentContextResponse))]
    [AWSCmdletOutput("Amazon.WellArchitected.Model.ContextSummary or Amazon.WellArchitected.Model.UpdateAgentContextResponse",
        "This cmdlet returns an Amazon.WellArchitected.Model.ContextSummary object.",
        "The service call response (type Amazon.WellArchitected.Model.UpdateAgentContextResponse) can be returned by specifying '-Select *'."
    )]
    public partial class UpdateWATAgentContextCmdlet : AmazonWellArchitectedClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The unique identifier of the context to update.</para>
        /// </para>
        /// </summary>
        #if !MODULAR
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// <para>
        /// <para>The updated title of the context.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.WellArchitected.Model.UpdateAgentContextResponse).
        /// Specifying the name of a property of type Amazon.WellArchitected.Model.UpdateAgentContextResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                nameof(this.Id),
                nameof(this.ProfileArn)
            };
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(targetParameterNames, MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Update-WATAgentContext (UpdateAgentContext)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.WellArchitected.Model.UpdateAgentContextResponse, UpdateWATAgentContextCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.WellArchitected.Model.UpdateAgentContextRequest();
        ...
        private Amazon.WellArchitected.Model.UpdateAgentContextResponse CallAWSServiceOperation(IAmazonWellArchitected client, Amazon.WellArchitected.Model.UpdateAgentContextRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Well-Architected Tool", "UpdateAgentContext");
            try
            {
                return client.UpdateAgentContextAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String ProfileArn { get; set; }
            public System.String Title { get; set; }
            public System.Func<Amazon.WellArchitected.Model.UpdateAgentContextResponse, UpdateWATAgentContextCmdlet, object> Select { get; set; } =
