...
namespace Amazon.PowerShell.Cmdlets.UXC
{
    ...
    public partial class UpdateUXCAccountCustomizationCmdlet : AmazonUxcClientCmdlet, IExecutor
    {
        ...
        /// makes all services visible. For valid service identifiers, call <a href="https://docs.aws.amazon.com/awsconsolehelpdocs/latest/APIReference/API_ListServices.html">ListServices</a>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AccountColor parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AccountColor' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AccountColor' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AccountColor;
            }
        ...
        private Amazon.Uxc.Model.UpdateAccountCustomizationsResponse CallAWSServiceOperation(IAmazonUxc client, Amazon.Uxc.Model.UpdateAccountCustomizationsRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdateAccountCustomizations(request);
                #elif CORECLR
                return client.UpdateAccountCustomizationsAsync(request).GetAwaiter().GetResult();
                #else
