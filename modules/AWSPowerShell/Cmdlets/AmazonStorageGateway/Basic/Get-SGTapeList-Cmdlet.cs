...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeTapes API operation.", Operation = new[] {"DescribeTapes"}, LegacyAlias="Get-SGTapes")]
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.Tapes;
