...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdletOutput("System.String",
        ...
        "The service call response (type StartGatewayResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class StartSGGatewayCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new StartGatewayRequest();
