...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeSMBFileShares API operation.", Operation = new[] {"DescribeSMBFileShares"})]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.SMBFileShareInfo",
        "This cmdlet returns a collection of SMBFileShareInfo objects.",
    ...
    public partial class GetSGSMBFileShareCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.SMBFileShareInfoList;
        ...
        private Amazon.StorageGateway.Model.DescribeSMBFileSharesResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.DescribeSMBFileSharesRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeSMBFileSharesAsync(request);
                return task.Result;
                #else
