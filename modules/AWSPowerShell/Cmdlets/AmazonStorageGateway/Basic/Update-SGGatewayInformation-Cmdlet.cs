...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdletOutput("System.String",
        ...
        "The service call response (type UpdateGatewayInformationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
