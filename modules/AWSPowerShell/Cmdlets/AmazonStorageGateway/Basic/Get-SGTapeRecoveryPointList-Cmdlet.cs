...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway DescribeTapeRecoveryPoints API operation.", Operation = new[] {"DescribeTapeRecoveryPoints"}, LegacyAlias="Get-SGTapeRecoveryPoints")]
