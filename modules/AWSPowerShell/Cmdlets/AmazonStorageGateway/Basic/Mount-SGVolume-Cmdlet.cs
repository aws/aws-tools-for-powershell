...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway AttachVolume API operation.", Operation = new[] {"AttachVolume"})]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.AttachVolumeResponse",
        "This cmdlet returns a Amazon.StorageGateway.Model.AttachVolumeResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
