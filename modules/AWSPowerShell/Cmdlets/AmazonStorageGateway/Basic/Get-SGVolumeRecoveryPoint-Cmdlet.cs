...
namespace Amazon.PowerShell.Cmdlets.SG
{
    ...
    [AWSCmdlet("Calls the AWS Storage Gateway ListVolumeRecoveryPoints API operation.", Operation = new[] {"ListVolumeRecoveryPoints"})]
    [AWSCmdletOutput("Amazon.StorageGateway.Model.ListVolumeRecoveryPointsResponse",
        "This cmdlet returns a Amazon.StorageGateway.Model.ListVolumeRecoveryPointsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSGVolumeRecoveryPointCmdlet : AmazonStorageGatewayClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.StorageGateway.Model.ListVolumeRecoveryPointsRequest();
        ...
        private Amazon.StorageGateway.Model.ListVolumeRecoveryPointsResponse CallAWSServiceOperation(IAmazonStorageGateway client, Amazon.StorageGateway.Model.ListVolumeRecoveryPointsRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ListVolumeRecoveryPointsAsync(request).GetAwaiter().GetResult();
                #else
