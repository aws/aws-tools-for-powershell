...
{
    /// <summary>
    /// List image set versions.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    [Cmdlet("Get", "MISImageSetVersionList")]
    [OutputType("Amazon.MedicalImaging.Model.ImageSetProperties")]
    ...
    public partial class GetMISImageSetVersionListCmdlet : AmazonMedicalImagingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ImageSetPropertiesList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.MedicalImaging.Model.ListImageSetVersionsResponse, GetMISImageSetVersionListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.MedicalImaging.Model.ListImageSetVersionsRequest();
        ...
        private Amazon.MedicalImaging.Model.ListImageSetVersionsResponse CallAWSServiceOperation(IAmazonMedicalImaging client, Amazon.MedicalImaging.Model.ListImageSetVersionsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Medical Imaging Service", "ListImageSetVersions");
            try
            {
                return client.ListImageSetVersionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.MedicalImaging.Model.ListImageSetVersionsResponse, GetMISImageSetVersionListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.ImageSetPropertiesList;
        }
