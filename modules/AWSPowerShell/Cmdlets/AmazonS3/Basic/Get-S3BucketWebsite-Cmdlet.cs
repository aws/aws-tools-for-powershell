...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetBucketWebsite API operation.", Operation = new[] {"GetBucketWebsite"})]
    ...
    public partial class GetS3BucketWebsiteCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.WebsiteConfiguration;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetBucketWebsite");
            try
            {
                #if DESKTOP
