...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class RemoveS3BucketWebsiteCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.DeleteBucketWebsiteResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketWebsiteRequest request)
        {
            #if DESKTOP
