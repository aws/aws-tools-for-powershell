...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service DeleteBucketWebsite API operation.", Operation = new[] {"DeleteBucketWebsite"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.S3.Model.DeleteBucketWebsiteResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class RemoveS3BucketWebsiteCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-S3BucketWebsite (DeleteBucketWebsite)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.S3.Model.DeleteBucketWebsiteRequest();
        ...
        private Amazon.S3.Model.DeleteBucketWebsiteResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketWebsiteRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "DeleteBucketWebsite");
            try
            {
                #if DESKTOP
                return client.DeleteBucketWebsite(request);
                #elif CORECLR
                return client.DeleteBucketWebsiteAsync(request).GetAwaiter().GetResult();
                #else
