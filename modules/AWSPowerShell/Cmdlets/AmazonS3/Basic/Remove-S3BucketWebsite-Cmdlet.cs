...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the DeleteBucketWebsite operation against Amazon Simple Storage Service.", Operation = new[] {"DeleteBucketWebsite"})]
    ...
    public partial class RemoveS3BucketWebsiteCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private Amazon.S3.Model.DeleteBucketWebsiteResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketWebsiteRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DeleteBucketWebsiteAsync(request);
                return task.Result;
                #else
