...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the GetBucketAnalyticsConfiguration operation against Amazon Simple Storage Service.", Operation = new[] {"GetBucketAnalyticsConfiguration"})]
    [AWSCmdletOutput("Amazon.S3.Model.AnalyticsConfiguration",
        "This cmdlet returns a AnalyticsConfiguration object.",
    ...
    public partial class GetS3BucketAnalyticsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.AnalyticsConfiguration;
        ...
        private static Amazon.S3.Model.GetBucketAnalyticsConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketAnalyticsConfigurationRequest request)
        {
            #if DESKTOP
            return client.GetBucketAnalyticsConfiguration(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetBucketAnalyticsConfigurationAsync(request);
            return task.Result;
            #else
