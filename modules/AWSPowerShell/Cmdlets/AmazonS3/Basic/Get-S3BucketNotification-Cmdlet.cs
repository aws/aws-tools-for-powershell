...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetBucketNotification API operation.", Operation = new[] {"GetBucketNotification"})]
    ...
    public partial class GetS3BucketNotificationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetBucketNotification");
            try
            {
                #if DESKTOP
