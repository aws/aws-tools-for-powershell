...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the DeleteBucketMetricsConfiguration operation against Amazon Simple Storage Service.", Operation = new[] {"DeleteBucketMetricsConfiguration"})]
    ...
    public partial class RemoveS3BucketMetricsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.DeleteBucketMetricsConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketMetricsConfigurationRequest request)
        {
            #if DESKTOP
            return client.DeleteBucketMetricsConfiguration(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeleteBucketMetricsConfigurationAsync(request);
            return task.Result;
            #else
