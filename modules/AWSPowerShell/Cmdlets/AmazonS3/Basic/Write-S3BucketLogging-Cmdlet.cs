...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service PutBucketLogging API operation.", Operation = new[] {"PutBucketLogging"})]
    ...
    public partial class WriteS3BucketLoggingCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "PutBucketLogging");
            try
            {
                #if DESKTOP
