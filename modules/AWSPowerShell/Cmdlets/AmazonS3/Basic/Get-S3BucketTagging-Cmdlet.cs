...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public class GetS3BucketTaggingCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.TagSet;
        ...
        private static Amazon.S3.Model.GetBucketTaggingResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketTaggingRequest request)
        {
