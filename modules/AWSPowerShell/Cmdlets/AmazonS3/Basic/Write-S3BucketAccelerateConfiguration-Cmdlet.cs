...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public class WriteS3BucketAccelerateConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.PutBucketAccelerateConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.PutBucketAccelerateConfigurationRequest request)
        {
