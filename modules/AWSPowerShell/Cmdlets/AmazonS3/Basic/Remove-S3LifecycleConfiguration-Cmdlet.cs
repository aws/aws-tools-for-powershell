...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class RemoveS3LifecycleConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "DeleteLifecycleConfiguration");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteLifecycleConfigurationAsync(request);
                return task.Result;
                #else
