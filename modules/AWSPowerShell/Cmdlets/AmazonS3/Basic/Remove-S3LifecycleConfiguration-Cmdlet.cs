...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the DeleteLifecycleConfiguration operation against Amazon Simple Storage Service.", Operation = new[] {"DeleteLifecycleConfiguration"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteLifecycleConfigurationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveS3LifecycleConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
