    ...
    public partial class GetS3BucketInventoryConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.InventoryConfiguration;
        ...
        private static Amazon.S3.Model.GetBucketInventoryConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketInventoryConfigurationRequest request)
        {
            #if DESKTOP
            return client.GetBucketInventoryConfiguration(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetBucketInventoryConfigurationAsync(request);
            return task.Result;
            #else
