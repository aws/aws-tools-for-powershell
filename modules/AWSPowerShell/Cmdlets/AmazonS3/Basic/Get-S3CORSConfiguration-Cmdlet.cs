...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public class GetS3CORSConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.GetCORSConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetCORSConfigurationRequest request)
        {
