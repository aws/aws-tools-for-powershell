...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service PutBucketVersioning API operation.", Operation = new[] {"PutBucketVersioning"})]
    ...
    public partial class WriteS3BucketVersioningCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "PutBucketVersioning");
            try
            {
                #if DESKTOP
