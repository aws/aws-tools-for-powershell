...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the GetBucketMetricsConfiguration operation against Amazon Simple Storage Service.", Operation = new[] {"GetBucketMetricsConfiguration"})]
    [AWSCmdletOutput("Amazon.S3.Model.MetricsConfiguration",
        "This cmdlet returns a MetricsConfiguration object.",
    ...
    public partial class GetS3BucketMetricsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.MetricsConfiguration;
        ...
        private static Amazon.S3.Model.GetBucketMetricsConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketMetricsConfigurationRequest request)
        {
            #if DESKTOP
            return client.GetBucketMetricsConfiguration(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetBucketMetricsConfigurationAsync(request);
            return task.Result;
            #else
