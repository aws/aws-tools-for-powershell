...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the GetObjectTagging operation against Amazon Simple Storage Service.", Operation = new[] {"GetObjectTagging"})]
    ...
    public partial class GetS3ObjectTagSetCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Tagging;
        ...
        private Amazon.S3.Model.GetObjectTaggingResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetObjectTaggingRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetObjectTaggingAsync(request);
                return task.Result;
                #else
