...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetObjectLegalHold API operation.", Operation = new[] {"GetObjectLegalHold"})]
    [AWSCmdletOutput("Amazon.S3.Model.ObjectLockLegalHold",
        "This cmdlet returns a ObjectLockLegalHold object.",
    ...
    public partial class GetS3ObjectLegalHoldCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.LegalHold;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetObjectLegalHold");
            try
            {
                #if DESKTOP
