...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetObjectRetention API operation.", Operation = new[] {"GetObjectRetention"})]
    [AWSCmdletOutput("Amazon.S3.Model.ObjectLockRetention",
        "This cmdlet returns a ObjectLockRetention object.",
    ...
    public partial class GetS3ObjectRetentionCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Retention;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetObjectRetention");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetObjectRetentionAsync(request);
                return task.Result;
                #else
