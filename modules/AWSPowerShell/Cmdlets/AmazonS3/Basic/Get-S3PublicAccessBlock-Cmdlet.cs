...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetPublicAccessBlock API operation.", Operation = new[] {"GetPublicAccessBlock"})]
    [AWSCmdletOutput("Amazon.S3.Model.PublicAccessBlockConfiguration",
        "This cmdlet returns a PublicAccessBlockConfiguration object.",
    ...
    public partial class GetS3PublicAccessBlockCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.PublicAccessBlockConfiguration;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetPublicAccessBlock");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetPublicAccessBlockAsync(request);
                return task.Result;
                #else
