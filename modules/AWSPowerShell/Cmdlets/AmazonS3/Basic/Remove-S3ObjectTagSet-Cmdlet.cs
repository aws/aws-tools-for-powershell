...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the DeleteObjectTagging operation against Amazon Simple Storage Service.", Operation = new[] {"DeleteObjectTagging"})]
    ...
    public partial class RemoveS3ObjectTagSetCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "DeleteObjectTagging");
            #if DESKTOP
            return client.DeleteObjectTagging(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeleteObjectTaggingAsync(request);
            return task.Result;
            #else
