...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public partial class RemoveS3BucketAnalyticsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.DeleteBucketAnalyticsConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketAnalyticsConfigurationRequest request)
        {
            #if DESKTOP
