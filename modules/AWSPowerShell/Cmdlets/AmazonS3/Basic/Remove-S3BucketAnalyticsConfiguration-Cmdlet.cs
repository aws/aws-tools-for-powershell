...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service DeleteBucketAnalyticsConfiguration API operation.", Operation = new[] {"DeleteBucketAnalyticsConfiguration"})]
    ...
    public partial class RemoveS3BucketAnalyticsConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "DeleteBucketAnalyticsConfiguration");
            try
            {
                #if DESKTOP
