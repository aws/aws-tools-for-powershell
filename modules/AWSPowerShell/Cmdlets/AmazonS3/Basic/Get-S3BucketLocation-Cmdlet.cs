...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdletOutput("Amazon.S3.S3Region",
        ...
        "The service call response (type GetBucketLocationResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class GetS3BucketLocationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        /// Amazon.S3.Model.GetBucketLocationRequest.BucketName
        /// </para>
        /// </summary>
