...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetBucketPolicyStatus API operation.", Operation = new[] {"GetBucketPolicyStatus"})]
    [AWSCmdletOutput("Amazon.S3.Model.PolicyStatus",
        "This cmdlet returns a PolicyStatus object.",
        "The service call response (type Amazon.S3.Model.GetBucketPolicyStatusResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetS3BucketPolicyStatusCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.PolicyStatus;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Storage Service", "GetBucketPolicyStatus");
            try
            {
                #if DESKTOP
                return client.GetBucketPolicyStatus(request);
                #elif CORECLR
                return client.GetBucketPolicyStatusAsync(request).GetAwaiter().GetResult();
                #else
