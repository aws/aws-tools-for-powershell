...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type DeleteCORSConfigurationResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveS3CORSConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        /// <summary>
        /// <para>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.DeleteCORSConfiguration(request);
