...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    public class RemoveS3CORSConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.DeleteCORSConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteCORSConfigurationRequest request)
        {
