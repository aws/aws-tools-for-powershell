...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Invokes the DeleteBucketInventoryConfiguration operation against Amazon Simple Storage Service.", Operation = new[] {"DeleteBucketInventoryConfiguration"})]
    ...
    public partial class RemoveS3BucketInventoryConfigurationCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        private static Amazon.S3.Model.DeleteBucketInventoryConfigurationResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.DeleteBucketInventoryConfigurationRequest request)
        {
            ...
            var task = client.DeleteBucketInventoryConfigurationAsync(request);
            return task.Result;
            #else
