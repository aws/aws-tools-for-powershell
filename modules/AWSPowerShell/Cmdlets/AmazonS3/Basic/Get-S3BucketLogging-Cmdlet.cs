...
namespace Amazon.PowerShell.Cmdlets.S3
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Storage Service GetBucketLogging API operation.", Operation = new[] {"GetBucketLogging"})]
    ...
    public partial class GetS3BucketLoggingCmdlet : AmazonS3ClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.BucketLoggingConfig;
        ...
        private Amazon.S3.Model.GetBucketLoggingResponse CallAWSServiceOperation(IAmazonS3 client, Amazon.S3.Model.GetBucketLoggingRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetBucketLoggingAsync(request);
                return task.Result;
                #else
