...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit GetCommentsForComparedCommit API operation.", Operation = new[] {"GetCommentsForComparedCommit"})]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.CommentsForComparedCommit",
        "This cmdlet returns a collection of CommentsForComparedCommit objects.",
    ...
    public partial class GetCCCommentsForComparedCommitCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CommentsForComparedCommitData;
                        ...
                        {
                            int _receivedThisCall = response.CommentsForComparedCommitData.Count;
        ...
        private Amazon.CodeCommit.Model.GetCommentsForComparedCommitResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.GetCommentsForComparedCommitRequest request)
        {
            ...
            try
            {
                ...
                var task = client.GetCommentsForComparedCommitAsync(request);
                return task.Result;
                #else
