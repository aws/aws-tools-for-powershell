...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit UpdatePullRequestTitle API operation.", Operation = new[] {"UpdatePullRequestTitle"})]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.PullRequest",
        "This cmdlet returns a PullRequest object.",
        "The service call response (type Amazon.CodeCommit.Model.UpdatePullRequestTitleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCCPullRequestTitleCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
        ...
        private Amazon.CodeCommit.Model.UpdatePullRequestTitleResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.UpdatePullRequestTitleRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.UpdatePullRequestTitle(request);
                #elif CORECLR
                return client.UpdatePullRequestTitleAsync(request).GetAwaiter().GetResult();
                #else
