...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit ListPullRequests API operation.", Operation = new[] {"ListPullRequests"})]
    ...
    public partial class GetCCPullRequestListCmdlet : AmazonCodeCommitClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.PullRequestIds;
                        ...
                        {
                            int _receivedThisCall = response.PullRequestIds.Count;
        ...
        private Amazon.CodeCommit.Model.ListPullRequestsResponse CallAWSServiceOperation(IAmazonCodeCommit client, Amazon.CodeCommit.Model.ListPullRequestsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListPullRequestsAsync(request);
                return task.Result;
                #else
