...
namespace Amazon.PowerShell.Cmdlets.CC
{
    ...
    [AWSCmdlet("Calls the AWS CodeCommit GetCommentsForPullRequest API operation.", Operation = new[] {"GetCommentsForPullRequest"})]
    [AWSCmdletOutput("Amazon.CodeCommit.Model.CommentsForPullRequest",
        "This cmdlet returns a collection of CommentsForPullRequest objects.",
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CommentsForPullRequestData;
                        ...
                        {
                            int _receivedThisCall = response.CommentsForPullRequestData.Count;
