...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    [AWSCmdlet("Calls the Managed Streaming for Kafka TagResource API operation.", Operation = new[] {"TagResource"})]
    ...
    public partial class AddMSKResourceTagCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka", "TagResource");
            try
            {
                #if DESKTOP
