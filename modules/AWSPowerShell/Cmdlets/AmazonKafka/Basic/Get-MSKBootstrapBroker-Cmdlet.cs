...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    [AWSCmdlet("Calls the Managed Streaming for Kafka GetBootstrapBrokers API operation.", Operation = new[] {"GetBootstrapBrokers"})]
    ...
    public partial class GetMSKBootstrapBrokerCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.BootstrapBrokerString;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka", "GetBootstrapBrokers");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetBootstrapBrokersAsync(request);
                return task.Result;
                #else
