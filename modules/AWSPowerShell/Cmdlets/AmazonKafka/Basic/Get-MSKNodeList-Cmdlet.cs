...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    /// </summary>
    [Cmdlet("Get", "MSKNodeList")]
    [OutputType("Amazon.Kafka.Model.NodeInfo")]
    [AWSCmdlet("Calls the Managed Streaming for Kafka ListNodes API operation.", Operation = new[] {"ListNodes"})]
    [AWSCmdletOutput("Amazon.Kafka.Model.NodeInfo",
        "This cmdlet returns a collection of NodeInfo objects.",
        "The service call response (type Amazon.Kafka.Model.ListNodesResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetMSKNodeListCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Kafka.Model.ListNodesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.NodeInfoList;
                        ...
                        int _receivedThisCall = response.NodeInfoList.Count;
        ...
        private Amazon.Kafka.Model.ListNodesResponse CallAWSServiceOperation(IAmazonKafka client, Amazon.Kafka.Model.ListNodesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka", "ListNodes");
            try
            {
                #if DESKTOP
