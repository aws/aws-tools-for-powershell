...
namespace Amazon.PowerShell.Cmdlets.MSK
{
    ...
    [AWSCmdlet("Calls the Managed Streaming for Kafka DescribeCluster API operation.", Operation = new[] {"DescribeCluster"})]
    [AWSCmdletOutput("Amazon.Kafka.Model.ClusterInfo",
        "This cmdlet returns a ClusterInfo object.",
        "The service call response (type Amazon.Kafka.Model.DescribeClusterResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetMSKClusterCmdlet : AmazonKafkaClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.ClusterInfo;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Managed Streaming for Kafka", "DescribeCluster");
            try
            {
                #if DESKTOP
