...
namespace Amazon.PowerShell.Cmdlets.EMRS
{
    ...
    /// </summary>
    [Cmdlet("New", "EMRSApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType("Amazon.EMRServerlessWebService.Model.CreateApplicationResponse")]
    [AWSCmdlet("Calls the EMR Serverless Web Service CreateApplication API operation.", Operation = new[] {"CreateApplication"}, SelectReturnType = typeof(Amazon.EMRServerlessWebService.Model.CreateApplicationResponse))]
    [AWSCmdletOutput("Amazon.EMRServerlessWebService.Model.CreateApplicationResponse",
        "This cmdlet returns an Amazon.EMRServerlessWebService.Model.CreateApplicationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewEMRSApplicationCmdlet : AmazonEMRServerlessWebServiceClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.EMRServerlessWebService.Model.CreateApplicationResponse).
        /// Specifying the name of a property of type Amazon.EMRServerlessWebService.Model.CreateApplicationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-EMRSApplication (CreateApplication)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.EMRServerlessWebService.Model.CreateApplicationResponse, NewEMRSApplicationCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.EMRServerlessWebService.Model.CreateApplicationRequest();
        ...
        private Amazon.EMRServerlessWebService.Model.CreateApplicationResponse CallAWSServiceOperation(IAmazonEMRServerlessWebService client, Amazon.EMRServerlessWebService.Model.CreateApplicationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "EMR Serverless Web Service", "CreateApplication");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String Type { get; set; }
            public System.Func<Amazon.EMRServerlessWebService.Model.CreateApplicationResponse, NewEMRSApplicationCmdlet, object> Select { get; set; } =
