...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    [AWSCmdlet("Calls the AWS CodeStar DeleteUserProfile API operation.", Operation = new[] {"DeleteUserProfile"}, SelectReturnType = typeof(Amazon.CodeStar.Model.DeleteUserProfileResponse))]
    [AWSCmdletOutput("System.String or Amazon.CodeStar.Model.DeleteUserProfileResponse",
    ...
    public partial class RemoveCSTUserProfileCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStar.Model.DeleteUserProfileResponse, RemoveCSTUserProfileCmdlet>(Select) ??
        ...
        {
            public System.String UserArn { get; set; }
            public System.Func<Amazon.CodeStar.Model.DeleteUserProfileResponse, RemoveCSTUserProfileCmdlet, object> Select { get; set; } =
