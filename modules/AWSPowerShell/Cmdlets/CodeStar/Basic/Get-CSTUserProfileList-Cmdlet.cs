...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    [AWSCmdlet("Calls the AWS CodeStar ListUserProfiles API operation.", Operation = new[] {"ListUserProfiles"}, SelectReturnType = typeof(Amazon.CodeStar.Model.ListUserProfilesResponse))]
    [AWSCmdletOutput("Amazon.CodeStar.Model.UserProfileSummary or Amazon.CodeStar.Model.ListUserProfilesResponse",
        "This cmdlet returns a collection of Amazon.CodeStar.Model.UserProfileSummary objects.",
    ...
    public partial class GetCSTUserProfileListCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStar.Model.ListUserProfilesResponse, GetCSTUserProfileListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.CodeStar.Model.ListUserProfilesRequest();
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.UserProfiles.Count;
        ...
        private Amazon.CodeStar.Model.ListUserProfilesResponse CallAWSServiceOperation(IAmazonCodeStar client, Amazon.CodeStar.Model.ListUserProfilesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar", "ListUserProfiles");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public int? MaxResult { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.CodeStar.Model.ListUserProfilesResponse, GetCSTUserProfileListCmdlet, object> Select { get; set; } =
