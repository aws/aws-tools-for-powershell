...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    [OutputType("None")]
    [AWSCmdlet("Calls the AWS CodeStar UntagProject API operation.", Operation = new[] {"UntagProject"}, SelectReturnType = typeof(Amazon.CodeStar.Model.UntagProjectResponse))]
    [AWSCmdletOutput("None or Amazon.CodeStar.Model.UntagProjectResponse",
    ...
    public partial class RemoveCSTTagsForProjectCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStar.Model.UntagProjectResponse, RemoveCSTTagsForProjectCmdlet>(Select) ??
        ...
        private Amazon.CodeStar.Model.UntagProjectResponse CallAWSServiceOperation(IAmazonCodeStar client, Amazon.CodeStar.Model.UntagProjectRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.UntagProjectAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.CodeStar.Model.UntagProjectResponse, RemoveCSTTagsForProjectCmdlet, object> Select { get; set; } =
