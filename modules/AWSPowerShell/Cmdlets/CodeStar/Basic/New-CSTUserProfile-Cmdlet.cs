...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    [AWSCmdlet("Calls the AWS CodeStar CreateUserProfile API operation.", Operation = new[] {"CreateUserProfile"}, SelectReturnType = typeof(Amazon.CodeStar.Model.CreateUserProfileResponse))]
    [AWSCmdletOutput("Amazon.CodeStar.Model.CreateUserProfileResponse",
        "This cmdlet returns an Amazon.CodeStar.Model.CreateUserProfileResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class NewCSTUserProfileCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "New-CSTUserProfile (CreateUserProfile)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStar.Model.CreateUserProfileResponse, NewCSTUserProfileCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.CodeStar.Model.CreateUserProfileRequest();
        ...
        private Amazon.CodeStar.Model.CreateUserProfileResponse CallAWSServiceOperation(IAmazonCodeStar client, Amazon.CodeStar.Model.CreateUserProfileRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS CodeStar", "CreateUserProfile");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String SshPublicKey { get; set; }
            public System.String UserArn { get; set; }
            public System.Func<Amazon.CodeStar.Model.CreateUserProfileResponse, NewCSTUserProfileCmdlet, object> Select { get; set; } =
