...
namespace Amazon.PowerShell.Cmdlets.CST
{
    ...
    [AWSCmdlet("Calls the AWS CodeStar UpdateTeamMember API operation.", Operation = new[] {"UpdateTeamMember"}, SelectReturnType = typeof(Amazon.CodeStar.Model.UpdateTeamMemberResponse))]
    [AWSCmdletOutput("Amazon.CodeStar.Model.UpdateTeamMemberResponse",
        "This cmdlet returns an Amazon.CodeStar.Model.UpdateTeamMemberResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateCSTTeamMemberCmdlet : AmazonCodeStarClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.CodeStar.Model.UpdateTeamMemberResponse, UpdateCSTTeamMemberCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? RemoteAccessAllowed { get; set; }
            public System.String UserArn { get; set; }
            public System.Func<Amazon.CodeStar.Model.UpdateTeamMemberResponse, UpdateCSTTeamMemberCmdlet, object> Select { get; set; } =
