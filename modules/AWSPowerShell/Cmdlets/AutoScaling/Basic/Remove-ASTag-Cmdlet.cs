...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ASTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveASTagCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^Tag' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASTag (DeleteTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.DeleteTagsResponse, RemoveASTagCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.Tag;
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AutoScaling.Model.DeleteTagsResponse, RemoveASTagCmdlet, object> Select { get; set; } =
