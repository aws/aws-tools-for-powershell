...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class GetASScalingActivityCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// with the request, only results matching all filter criteria can be returned. </para><para>Array Members: Maximum number of 50 IDs.</para>
        /// </para>
        /// </summary>
        ...
        /// in the <i>Amazon EC2 Auto Scaling API Reference</i>. </para></li></ul>
        /// </para>
        /// </summary>
