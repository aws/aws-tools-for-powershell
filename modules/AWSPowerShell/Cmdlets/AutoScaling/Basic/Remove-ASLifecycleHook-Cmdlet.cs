...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class RemoveASLifecycleHookCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg(nameof(this.LifecycleHookName), MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ASLifecycleHook (DeleteLifecycleHook)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.DeleteLifecycleHookResponse, RemoveASLifecycleHookCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.AutoScaling.Model.DeleteLifecycleHookRequest();
        ...
        private Amazon.AutoScaling.Model.DeleteLifecycleHookResponse CallAWSServiceOperation(IAmazonAutoScaling client, Amazon.AutoScaling.Model.DeleteLifecycleHookRequest request)
        {
            ...
            try
            {
                return client.DeleteLifecycleHookAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AutoScalingGroupName { get; set; }
            public System.String LifecycleHookName { get; set; }
            public System.Func<Amazon.AutoScaling.Model.DeleteLifecycleHookResponse, RemoveASLifecycleHookCmdlet, object> Select { get; set; } =
