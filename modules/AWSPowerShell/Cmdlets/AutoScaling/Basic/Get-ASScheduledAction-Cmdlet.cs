...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    /// <a>DescribeScalingActivities</a>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration.
    /// </summary>
    ...
    public partial class GetASScheduledActionCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "ScheduledUpdateGroupActions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.DescribeScheduledActionsResponse, GetASScheduledActionCmdlet>(Select) ??
