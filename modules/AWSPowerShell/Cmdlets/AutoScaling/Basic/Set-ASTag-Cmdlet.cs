...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class SetASTagCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.CreateOrUpdateTagsResponse, SetASTagCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling", "CreateOrUpdateTags");
            try
            {
                return client.CreateOrUpdateTagsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AutoScaling.Model.CreateOrUpdateTagsResponse, SetASTagCmdlet, object> Select { get; set; } =
