...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class SetASInstanceProtectionCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>One or more instance IDs. You can specify up to 50 instances.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.SetInstanceProtectionResponse, SetASInstanceProtectionCmdlet>(Select) ??
            ...
            #if MODULAR
            if (this.ProtectedFromScaleIn == null && ParameterWasBound(nameof(this.ProtectedFromScaleIn)))
            {
                WriteWarning("You are passing $null as a value for parameter ProtectedFromScaleIn which is marked as required. In case you believe this parameter was incorrectly marked as required, report this by opening an issue at https://github.com/aws/aws-tools-for-powershell/issues.");
            }
            #endif
        ...
        private Amazon.AutoScaling.Model.SetInstanceProtectionResponse CallAWSServiceOperation(IAmazonAutoScaling client, Amazon.AutoScaling.Model.SetInstanceProtectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling", "SetInstanceProtection");
            try
            {
                return client.SetInstanceProtectionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Boolean? ProtectedFromScaleIn { get; set; }
            public System.Func<Amazon.AutoScaling.Model.SetInstanceProtectionResponse, SetASInstanceProtectionCmdlet, object> Select { get; set; } =
