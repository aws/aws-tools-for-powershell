...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the AWS Auto Scaling DescribeAutoScalingInstances API operation.", Operation = new[] {"DescribeAutoScalingInstances"}, SelectReturnType = typeof(Amazon.AutoScaling.Model.DescribeAutoScalingInstancesResponse))]
    [AWSCmdletOutput("Amazon.AutoScaling.Model.AutoScalingInstanceDetails or Amazon.AutoScaling.Model.DescribeAutoScalingInstancesResponse",
        "This cmdlet returns a collection of Amazon.AutoScaling.Model.AutoScalingInstanceDetails objects.",
        "The service call response (type Amazon.AutoScaling.Model.DescribeAutoScalingInstancesResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASAutoScalingInstanceCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// described. If you specify an ID that does not exist, it is ignored with no error.</para><para>Array Members: Maximum number of 50 items.</para><para />
        ...
        /// and the maximum value is <c>50</c>.</para>
        /// </para>
        /// <para>
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "AutoScalingInstances";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.DescribeAutoScalingInstancesResponse, GetASAutoScalingInstanceCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    int _receivedThisCall = response.AutoScalingInstances?.Count ?? 0;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling", "DescribeAutoScalingInstances");
            try
            {
                return client.DescribeAutoScalingInstancesAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AutoScaling.Model.DescribeAutoScalingInstancesResponse, GetASAutoScalingInstanceCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.AutoScalingInstances;
        }
