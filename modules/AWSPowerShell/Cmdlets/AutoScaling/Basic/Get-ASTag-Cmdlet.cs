...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    [AWSCmdlet("Calls the AWS Auto Scaling DescribeTags API operation.", Operation = new[] {"DescribeTags"}, SelectReturnType = typeof(Amazon.AutoScaling.Model.DescribeTagsResponse))]
    [AWSCmdletOutput("Amazon.AutoScaling.Model.TagDescription or Amazon.AutoScaling.Model.DescribeTagsResponse",
        "This cmdlet returns a collection of Amazon.AutoScaling.Model.TagDescription objects.",
        "The service call response (type Amazon.AutoScaling.Model.DescribeTagsResponse) can be returned by specifying '-Select *'."
    )]
    public partial class GetASTagCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// filter type (for example, <c>auto-scaling-group</c>) is 1000.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.DescribeTagsResponse, GetASTagCmdlet>(Select) ??
        ...
        private Amazon.AutoScaling.Model.DescribeTagsResponse CallAWSServiceOperation(IAmazonAutoScaling client, Amazon.AutoScaling.Model.DescribeTagsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling", "DescribeTags");
            try
            {
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public int? MaxRecord { get; set; }
            public System.String NextToken { get; set; }
            public System.Func<Amazon.AutoScaling.Model.DescribeTagsResponse, GetASTagCmdlet, object> Select { get; set; } =
