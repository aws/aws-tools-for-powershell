...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class RemoveASScheduledActionBatchCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        public string Select { get; set; } = "FailedScheduledActions";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.AutoScaling.Model.BatchDeleteScheduledActionResponse, RemoveASScheduledActionBatchCmdlet>(Select) ??
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Auto Scaling", "BatchDeleteScheduledAction");
            try
            {
                return client.BatchDeleteScheduledActionAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.AutoScaling.Model.BatchDeleteScheduledActionResponse, RemoveASScheduledActionBatchCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.FailedScheduledActions;
        }
