...
namespace Amazon.PowerShell.Cmdlets.AS
{
    ...
    public partial class UpdateASAutoScalingGroupCmdlet : AmazonAutoScalingClientCmdlet, IExecutor
    {
        ...
        /// EC2 Auto Scaling User Guide</i>.</para><para>You can remove the Distribution Segments configuration by specifying <c>OnDemandBaseCapacity</c>
        /// or <c>OnDemandPercentageAboveBaseCapacity</c>. You can also remove it explicitly by
        /// specifying an empty list for <c>DistributionSegments</c>.</para>
        /// </para>
        /// </summary>
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        private Amazon.AutoScaling.Model.UpdateAutoScalingGroupResponse CallAWSServiceOperation(IAmazonAutoScaling client, Amazon.AutoScaling.Model.UpdateAutoScalingGroupRequest request)
        {
            ...
            try
            {
                return client.UpdateAutoScalingGroupAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
