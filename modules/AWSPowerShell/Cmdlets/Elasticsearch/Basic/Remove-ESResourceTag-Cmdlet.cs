...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// </summary>
    [Cmdlet("Remove", "ESResourceTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveESResourceTagCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Specifies the <c>TagKey</c> list which you want to remove from the Elasticsearch domain.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ESResourceTag (RemoveTags)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.RemoveTagsResponse, RemoveESResourceTagCmdlet>(Select) ??
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Elasticsearch.Model.RemoveTagsResponse, RemoveESResourceTagCmdlet, object> Select { get; set; } =
