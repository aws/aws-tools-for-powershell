...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// connection.
    /// </summary>
    [Cmdlet("Remove", "ESInboundCrossClusterSearchConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveESInboundCrossClusterSearchConnectionCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ESInboundCrossClusterSearchConnection (DeleteInboundCrossClusterSearchConnection)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.DeleteInboundCrossClusterSearchConnectionResponse, RemoveESInboundCrossClusterSearchConnectionCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Elasticsearch.Model.DeleteInboundCrossClusterSearchConnectionRequest();
        ...
        private Amazon.Elasticsearch.Model.DeleteInboundCrossClusterSearchConnectionResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.DeleteInboundCrossClusterSearchConnectionRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elasticsearch", "DeleteInboundCrossClusterSearchConnection");
            try
            {
                #if DESKTOP
                return client.DeleteInboundCrossClusterSearchConnection(request);
                #elif CORECLR
                return client.DeleteInboundCrossClusterSearchConnectionAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.String CrossClusterSearchConnectionId { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.DeleteInboundCrossClusterSearchConnectionResponse, RemoveESInboundCrossClusterSearchConnectionCmdlet, object> Select { get; set; } =
