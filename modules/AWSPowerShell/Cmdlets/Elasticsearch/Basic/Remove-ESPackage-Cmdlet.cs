...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// Delete the package.
    /// </summary>
    [Cmdlet("Remove", "ESPackage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public partial class RemoveESPackageCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Internal ID of the package that you want to delete. Use <c>DescribePackages</c> to
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ESPackage (DeletePackage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.DeletePackageResponse, RemoveESPackageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Elasticsearch.Model.DeletePackageRequest();
        ...
        private Amazon.Elasticsearch.Model.DeletePackageResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.DeletePackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elasticsearch", "DeletePackage");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String PackageID { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.DeletePackageResponse, RemoveESPackageCmdlet, object> Select { get; set; } =
