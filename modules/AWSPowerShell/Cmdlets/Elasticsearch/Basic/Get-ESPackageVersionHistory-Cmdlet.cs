...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// </summary>
    [Cmdlet("Get", "ESPackageVersionHistory")]
    [OutputType("Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse")]
    [AWSCmdlet("Calls the Amazon Elasticsearch GetPackageVersionHistory API operation.", Operation = new[] {"GetPackageVersionHistory"}, SelectReturnType = typeof(Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse))]
    [AWSCmdletOutput("Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse",
        "This cmdlet returns an Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetESPackageVersionHistoryCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse, GetESPackageVersionHistoryCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Elasticsearch.Model.GetPackageVersionHistoryRequest();
        ...
        private Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.GetPackageVersionHistoryRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elasticsearch", "GetPackageVersionHistory");
            try
            {
                #if DESKTOP
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PackageID { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.GetPackageVersionHistoryResponse, GetESPackageVersionHistoryCmdlet, object> Select { get; set; } =
