...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// </summary>
    [Cmdlet("Start", "ESDissociatePackage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public partial class StartESDissociatePackageCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Internal ID of the package that you want to associate with a domain. Use <c>DescribePackages</c>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Start-ESDissociatePackage (DissociatePackage)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.DissociatePackageResponse, StartESDissociatePackageCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Elasticsearch.Model.DissociatePackageRequest();
        ...
        private Amazon.Elasticsearch.Model.DissociatePackageResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.DissociatePackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elasticsearch", "DissociatePackage");
            try
            {
                return client.DissociatePackageAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String DomainName { get; set; }
            public System.String PackageID { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.DissociatePackageResponse, StartESDissociatePackageCmdlet, object> Select { get; set; } =
