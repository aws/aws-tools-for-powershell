...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    public partial class GetESDomainListCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The Elasticsearch domains for which you want information.</para><para />
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.DescribeElasticsearchDomainsResponse, GetESDomainListCmdlet>(Select) ??
        ...
        private Amazon.Elasticsearch.Model.DescribeElasticsearchDomainsResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.DescribeElasticsearchDomainsRequest request)
        {
            ...
            try
            {
                return client.DescribeElasticsearchDomainsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.Elasticsearch.Model.DescribeElasticsearchDomainsResponse, GetESDomainListCmdlet, object> Select { get; set; } =
