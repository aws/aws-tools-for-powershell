...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    public partial class StartESElasticsearchServiceSoftwareUpdateCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.StartElasticsearchServiceSoftwareUpdateResponse, StartESElasticsearchServiceSoftwareUpdateCmdlet>(Select) ??
        ...
        private Amazon.Elasticsearch.Model.StartElasticsearchServiceSoftwareUpdateResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.StartElasticsearchServiceSoftwareUpdateRequest request)
        {
            ...
            try
            {
                return client.StartElasticsearchServiceSoftwareUpdateAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        {
            public System.String DomainName { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.StartElasticsearchServiceSoftwareUpdateResponse, StartESElasticsearchServiceSoftwareUpdateCmdlet, object> Select { get; set; } =
