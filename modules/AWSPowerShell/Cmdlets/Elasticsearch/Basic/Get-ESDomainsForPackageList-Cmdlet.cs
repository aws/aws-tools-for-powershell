...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    /// </summary>
    [Cmdlet("Get", "ESDomainsForPackageList")]
    [OutputType("Amazon.Elasticsearch.Model.DomainPackageDetails")]
    [AWSCmdlet("Calls the Amazon Elasticsearch ListDomainsForPackage API operation.", Operation = new[] {"ListDomainsForPackage"}, SelectReturnType = typeof(Amazon.Elasticsearch.Model.ListDomainsForPackageResponse))]
    [AWSCmdletOutput("Amazon.Elasticsearch.Model.DomainPackageDetails or Amazon.Elasticsearch.Model.ListDomainsForPackageResponse",
        "This cmdlet returns a collection of Amazon.Elasticsearch.Model.DomainPackageDetails objects.",
        "The service call response (type Amazon.Elasticsearch.Model.ListDomainsForPackageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetESDomainsForPackageListCmdlet : AmazonElasticsearchClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.Elasticsearch.Model.ListDomainsForPackageResponse, GetESDomainsForPackageListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Elasticsearch.Model.ListDomainsForPackageRequest();
        ...
        private Amazon.Elasticsearch.Model.ListDomainsForPackageResponse CallAWSServiceOperation(IAmazonElasticsearch client, Amazon.Elasticsearch.Model.ListDomainsForPackageRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Elasticsearch", "ListDomainsForPackage");
            try
            {
                #if DESKTOP
                return client.ListDomainsForPackage(request);
                #elif CORECLR
                return client.ListDomainsForPackageAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public System.String PackageID { get; set; }
            public System.Func<Amazon.Elasticsearch.Model.ListDomainsForPackageResponse, GetESDomainsForPackageListCmdlet, object> Select { get; set; } =
