...
namespace Amazon.PowerShell.Cmdlets.ES
{
    ...
    [AWSCmdletOutput("Amazon.Elasticsearch.Model.PackageDetails or Amazon.Elasticsearch.Model.CreatePackageResponse",
        ...
        "The service call response (type Amazon.Elasticsearch.Model.CreatePackageResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
