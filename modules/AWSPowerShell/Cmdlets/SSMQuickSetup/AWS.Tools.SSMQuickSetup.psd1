#
# Module manifest for module 'AWS.Tools.SSMQuickSetup'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.SSMQuickSetup.dll'
    ...
    GUID = '4b1dfdad-f468-43cc-895b-9f517e93479c'
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.SSMQuickSetup.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.SSMQuickSetup.Completers.psm1',
        'AWS.Tools.SSMQuickSetup.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.SSMQuickSetup.dll-Help.xml'
    )
