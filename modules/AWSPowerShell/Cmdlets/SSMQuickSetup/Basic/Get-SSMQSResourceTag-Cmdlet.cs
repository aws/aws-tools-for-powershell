...
namespace Amazon.PowerShell.Cmdlets.SSMQS
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMQSResourceTag")]
    [OutputType("Amazon.SSMQuickSetup.Model.TagEntry")]
    ...
    public partial class GetSSMQSResourceTagCmdlet : AmazonSSMQuickSetupClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMQuickSetup.Model.ListTagsForResourceResponse, GetSSMQSResourceTagCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMQuickSetup.Model.ListTagsForResourceRequest();
        ...
        private Amazon.SSMQuickSetup.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonSSMQuickSetup client, Amazon.SSMQuickSetup.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager QuickSetup", "ListTagsForResource");
            try
            {
                #if DESKTOP
        ...
        {
            public System.String ResourceArn { get; set; }
            public System.Func<Amazon.SSMQuickSetup.Model.ListTagsForResourceResponse, GetSSMQSResourceTagCmdlet, object> Select { get; set; } =
