...
namespace Amazon.PowerShell.Cmdlets.SSMQS
{
    ...
    [AWSCmdletOutput("None or Amazon.SSMQuickSetup.Model.UpdateServiceSettingsResponse",
        ...
        "The service response (type Amazon.SSMQuickSetup.Model.UpdateServiceSettingsResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class UpdateSSMQSServiceSettingCmdlet : AmazonSSMQuickSetupClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ExplorerEnablingRoleArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ExplorerEnablingRoleArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ExplorerEnablingRoleArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ExplorerEnablingRoleArn;
            }
