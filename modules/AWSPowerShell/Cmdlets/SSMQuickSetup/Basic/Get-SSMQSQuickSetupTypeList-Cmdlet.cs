...
namespace Amazon.PowerShell.Cmdlets.SSMQS
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMQSQuickSetupTypeList")]
    [OutputType("Amazon.SSMQuickSetup.Model.QuickSetupTypeOutput")]
    ...
    public partial class GetSSMQSQuickSetupTypeListCmdlet : AmazonSSMQuickSetupClientCmdlet, IExecutor
    {
        ...
        public string Select { get; set; } = "QuickSetupTypeList";
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMQuickSetup.Model.ListQuickSetupTypesResponse, GetSSMQSQuickSetupTypeListCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMQuickSetup.Model.ListQuickSetupTypesRequest();
        ...
        private Amazon.SSMQuickSetup.Model.ListQuickSetupTypesResponse CallAWSServiceOperation(IAmazonSSMQuickSetup client, Amazon.SSMQuickSetup.Model.ListQuickSetupTypesRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager QuickSetup", "ListQuickSetupTypes");
            try
            {
                #if DESKTOP
                return client.ListQuickSetupTypes(request);
                #elif CORECLR
                return client.ListQuickSetupTypesAsync(request).GetAwaiter().GetResult();
                #else
        ...
        {
            public System.Func<Amazon.SSMQuickSetup.Model.ListQuickSetupTypesResponse, GetSSMQSQuickSetupTypeListCmdlet, object> Select { get; set; } =
                (response, cmdlet) => response.QuickSetupTypeList;
        }
