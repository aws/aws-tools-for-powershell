...
namespace Amazon.PowerShell.Cmdlets.SSMQS
{
    ...
    /// </summary>
    [Cmdlet("Remove", "SSMQSConfigurationManager", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("None")]
    ...
    public partial class RemoveSSMQSConfigurationManagerCmdlet : AmazonSSMQuickSetupClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ManagerArn parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ManagerArn' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ManagerArn' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSMQSConfigurationManager (DeleteConfigurationManager)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.SSMQuickSetup.Model.DeleteConfigurationManagerResponse, RemoveSSMQSConfigurationManagerCmdlet>(Select) ??
            ...
            {
                context.Select = (response, cmdlet) => this.ManagerArn;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SSMQuickSetup.Model.DeleteConfigurationManagerRequest();
        ...
        private Amazon.SSMQuickSetup.Model.DeleteConfigurationManagerResponse CallAWSServiceOperation(IAmazonSSMQuickSetup client, Amazon.SSMQuickSetup.Model.DeleteConfigurationManagerRequest request)
        {
        ...
        {
            public System.String ManagerArn { get; set; }
            public System.Func<Amazon.SSMQuickSetup.Model.DeleteConfigurationManagerResponse, RemoveSSMQSConfigurationManagerCmdlet, object> Select { get; set; } =
