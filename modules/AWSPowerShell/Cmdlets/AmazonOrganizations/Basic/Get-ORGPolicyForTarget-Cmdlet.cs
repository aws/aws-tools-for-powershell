...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the ListPoliciesForTarget operation against AWS Organizations.", Operation = new[] {"ListPoliciesForTarget"})]
    [AWSCmdletOutput("Amazon.Organizations.Model.PolicySummary",
        "This cmdlet returns a collection of PolicySummary objects.",
        "The service call response (type Amazon.Organizations.Model.ListPoliciesForTargetResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
    ...
    public partial class GetORGPolicyForTargetCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.ListPoliciesForTargetResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListPoliciesForTargetRequest request)
        {
            #if DESKTOP
            return client.ListPoliciesForTarget(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListPoliciesForTargetAsync(request);
            return task.Result;
            #else
