...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    public partial class NewORGPolicyCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>The policy content to add to the new policy. For example, if you create a <a href="http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html">service
        ...
        /// for SCPs</a> in the <i>AWS Organizations User Guide</i>.</para>
        /// </para>
        /// </summary>
        ...
        private static Amazon.Organizations.Model.CreatePolicyResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.CreatePolicyRequest request)
        {
            #if DESKTOP
