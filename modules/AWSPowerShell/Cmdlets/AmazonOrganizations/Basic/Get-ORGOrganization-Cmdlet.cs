...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the DescribeOrganization operation against AWS Organizations.", Operation = new[] {"DescribeOrganization"})]
    ...
    public partial class GetORGOrganizationCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.DescribeOrganizationResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.DescribeOrganizationRequest request)
        {
            #if DESKTOP
