...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the ListParents operation against AWS Organizations.", Operation = new[] {"ListParents"})]
    ...
    public partial class GetORGParentCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.ListParentsResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListParentsRequest request)
        {
            #if DESKTOP
            return client.ListParents(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListParentsAsync(request);
            return task.Result;
            #else
