...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    public partial class RemoveORGOrganizationalUnitCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("OrganizationalUnitId", MyInvocation.BoundParameters);
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-ORGOrganizationalUnit (DeleteOrganizationalUnit)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.Organizations.Model.DeleteOrganizationalUnitRequest();
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.OrganizationalUnitId;
        ...
        private Amazon.Organizations.Model.DeleteOrganizationalUnitResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.DeleteOrganizationalUnitRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Organizations", "DeleteOrganizationalUnit");
            try
            {
                #if DESKTOP
                return client.DeleteOrganizationalUnit(request);
                #elif CORECLR
                return client.DeleteOrganizationalUnitAsync(request).GetAwaiter().GetResult();
                #else
