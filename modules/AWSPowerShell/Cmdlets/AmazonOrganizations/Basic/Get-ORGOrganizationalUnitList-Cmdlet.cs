...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    /// </summary>
    [Cmdlet("Get", "ORGOrganizationalUnitList")]
    [OutputType("Amazon.Organizations.Model.OrganizationalUnit")]
    [AWSCmdlet("Invokes the ListOrganizationalUnitsForParent operation against AWS Organizations.", Operation = new[] {"ListOrganizationalUnitsForParent"})]
    [AWSCmdletOutput("Amazon.Organizations.Model.OrganizationalUnit",
        "This cmdlet returns a collection of OrganizationalUnit objects.",
        "The service call response (type Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetORGOrganizationalUnitListCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.Organizations.Model.ListOrganizationalUnitsForParentRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.OrganizationalUnits;
                        ...
                        int _receivedThisCall = response.OrganizationalUnits.Count;
        ...
        private Amazon.Organizations.Model.ListOrganizationalUnitsForParentResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListOrganizationalUnitsForParentRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Organizations", "ListOrganizationalUnitsForParent");
            try
            {
                #if DESKTOP
