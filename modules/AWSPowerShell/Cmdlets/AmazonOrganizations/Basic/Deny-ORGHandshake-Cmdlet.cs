...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the DeclineHandshake operation against AWS Organizations.", Operation = new[] {"DeclineHandshake"})]
    ...
    public partial class DenyORGHandshakeCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.DeclineHandshakeResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.DeclineHandshakeRequest request)
        {
            #if DESKTOP
