...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the ListPolicies operation against AWS Organizations.", Operation = new[] {"ListPolicies"})]
    ...
    public partial class GetORGPolicyListCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.ListPoliciesResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListPoliciesRequest request)
        {
            #if DESKTOP
