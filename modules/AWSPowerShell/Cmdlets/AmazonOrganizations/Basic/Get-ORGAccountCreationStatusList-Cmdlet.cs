...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the ListCreateAccountStatus operation against AWS Organizations.", Operation = new[] {"ListCreateAccountStatus"})]
    [AWSCmdletOutput("Amazon.Organizations.Model.CreateAccountStatus",
        "This cmdlet returns a collection of CreateAccountStatus objects.",
    ...
    public partial class GetORGAccountCreationStatusListCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.State != null)
            {
                context.States = new List<System.String>(this.State);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.States != null)
            {
                request.States = cmdletContext.States;
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.CreateAccountStatuses;
        ...
        private static Amazon.Organizations.Model.ListCreateAccountStatusResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListCreateAccountStatusRequest request)
        {
            #if DESKTOP
            return client.ListCreateAccountStatus(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListCreateAccountStatusAsync(request);
            return task.Result;
            #else
        ...
        internal class CmdletContext : ExecutorContext
        {
            ...
            public System.String NextToken { get; set; }
            public List<System.String> States { get; set; }
        }
