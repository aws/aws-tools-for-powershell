...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Invokes the CreateOrganizationalUnit operation against AWS Organizations.", Operation = new[] {"CreateOrganizationalUnit"})]
    ...
    public partial class NewORGOrganizationalUnitCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
        ...
        private static Amazon.Organizations.Model.CreateOrganizationalUnitResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.CreateOrganizationalUnitRequest request)
        {
            ...
            var task = client.CreateOrganizationalUnitAsync(request);
            return task.Result;
            #else
