...
namespace Amazon.PowerShell.Cmdlets.ORG
{
    ...
    [AWSCmdlet("Calls the AWS Organizations ListAWSServiceAccessForOrganization API operation.", Operation = new[] {"ListAWSServiceAccessForOrganization"})]
    [AWSCmdletOutput("Amazon.Organizations.Model.EnabledServicePrincipal",
        "This cmdlet returns a collection of EnabledServicePrincipal objects.",
    ...
    public partial class GetORGAWSServiceAccessForOrganizationCmdlet : AmazonOrganizationsClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.EnabledServicePrincipals;
        ...
        private Amazon.Organizations.Model.ListAWSServiceAccessForOrganizationResponse CallAWSServiceOperation(IAmazonOrganizations client, Amazon.Organizations.Model.ListAWSServiceAccessForOrganizationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.ListAWSServiceAccessForOrganizationAsync(request);
                return task.Result;
                #else
