...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager StartAssociationsOnce API operation.", Operation = new[] {"StartAssociationsOnce"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.SimpleSystemsManagement.Model.StartAssociationsOnceResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class StartSSMAssociationsOnceCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private Amazon.SimpleSystemsManagement.Model.StartAssociationsOnceResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.StartAssociationsOnceRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.StartAssociationsOnceAsync(request).GetAwaiter().GetResult();
                #else
