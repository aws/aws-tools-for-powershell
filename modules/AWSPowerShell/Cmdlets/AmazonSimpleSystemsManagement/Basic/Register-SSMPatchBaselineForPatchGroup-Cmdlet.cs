...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the RegisterPatchBaselineForPatchGroup operation against Amazon Simple Systems Management.", Operation = new[] {"RegisterPatchBaselineForPatchGroup"})]
    ...
    public partial class RegisterSSMPatchBaselineForPatchGroupCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.RegisterPatchBaselineForPatchGroupResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.RegisterPatchBaselineForPatchGroupRequest request)
        {
            #if DESKTOP
