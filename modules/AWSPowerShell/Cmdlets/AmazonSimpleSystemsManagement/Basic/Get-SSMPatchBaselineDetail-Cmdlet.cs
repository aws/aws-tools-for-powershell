...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the GetPatchBaseline operation against Amazon Simple Systems Management.", Operation = new[] {"GetPatchBaseline"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.GetPatchBaselineResponse",
        "This cmdlet returns a Amazon.SimpleSystemsManagement.Model.GetPatchBaselineResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSSMPatchBaselineDetailCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.GetPatchBaselineResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetPatchBaselineRequest request)
        {
            #if DESKTOP
            return client.GetPatchBaseline(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetPatchBaselineAsync(request);
            return task.Result;
            #else
