...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager DescribeMaintenanceWindowsForTarget API operation.", Operation = new[] {"DescribeMaintenanceWindowsForTarget"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.MaintenanceWindowIdentityForTarget",
        "This cmdlet returns a collection of MaintenanceWindowIdentityForTarget objects.",
