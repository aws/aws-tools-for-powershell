...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public class GetSSMActivationCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.SimpleSystemsManagement.Model.DescribeActivationsFilter>(this.Filter);
            }
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ActivationList;
        ...
        private static Amazon.SimpleSystemsManagement.Model.DescribeActivationsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeActivationsRequest request)
        {
