...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager ResumeSession API operation.", Operation = new[] {"ResumeSession"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.ResumeSessionResponse",
        "This cmdlet returns a Amazon.SimpleSystemsManagement.Model.ResumeSessionResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class ResumeSSMSessionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private Amazon.SimpleSystemsManagement.Model.ResumeSessionResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.ResumeSessionRequest request)
        {
            ...
            try
            {
                ...
                #elif CORECLR
                return client.ResumeSessionAsync(request).GetAwaiter().GetResult();
                #else
