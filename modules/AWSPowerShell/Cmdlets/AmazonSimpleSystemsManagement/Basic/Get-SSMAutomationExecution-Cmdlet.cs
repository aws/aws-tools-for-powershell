...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Systems Management GetAutomationExecution API operation.", Operation = new[] {"GetAutomationExecution"})]
    ...
    public partial class GetSSMAutomationExecutionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Systems Management", "GetAutomationExecution");
            try
            {
                #if DESKTOP
