...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the DescribeMaintenanceWindowTasks operation against Amazon Simple Systems Management.", Operation = new[] {"DescribeMaintenanceWindowTasks"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.MaintenanceWindowTask",
        "This cmdlet returns a collection of MaintenanceWindowTask objects.",
    ...
    public partial class GetSSMMaintenanceWindowTaskListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Systems Management", "DescribeMaintenanceWindowTasks");
            #if DESKTOP
            return client.DescribeMaintenanceWindowTasks(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeMaintenanceWindowTasksAsync(request);
            return task.Result;
            #else
