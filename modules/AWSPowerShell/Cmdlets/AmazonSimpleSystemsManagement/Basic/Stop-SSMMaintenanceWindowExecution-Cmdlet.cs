...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager CancelMaintenanceWindowExecution API operation.", Operation = new[] {"CancelMaintenanceWindowExecution"})]
    ...
    public partial class StopSSMMaintenanceWindowExecutionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("WindowExecutionId", MyInvocation.BoundParameters);
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.WindowExecutionId;
        ...
        private Amazon.SimpleSystemsManagement.Model.CancelMaintenanceWindowExecutionResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.CancelMaintenanceWindowExecutionRequest request)
        {
            ...
            try
            {
                ...
                var task = client.CancelMaintenanceWindowExecutionAsync(request);
                return task.Result;
                #else
