...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMAssociationExecutionTarget")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.AssociationExecutionTarget")]
    [AWSCmdlet("Calls the AWS Systems Manager DescribeAssociationExecutionTargets API operation.", Operation = new[] {"DescribeAssociationExecutionTargets"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.AssociationExecutionTarget",
        "This cmdlet returns a collection of AssociationExecutionTarget objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionTargetsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSSMAssociationExecutionTargetCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        [System.Management.Automation.Parameter]
        [Alias("Filters")]
        public Amazon.SimpleSystemsManagement.Model.AssociationExecutionTargetsFilter[] Filter { get; set; }
        #endregion
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Filter != null)
            {
                context.Filters = new List<Amazon.SimpleSystemsManagement.Model.AssociationExecutionTargetsFilter>(this.Filter);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionTargetsRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.AssociationExecutionTargets;
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionTargetsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeAssociationExecutionTargetsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DescribeAssociationExecutionTargets");
            try
            {
                #if DESKTOP
                return client.DescribeAssociationExecutionTargets(request);
                #elif CORECLR
                return client.DescribeAssociationExecutionTargetsAsync(request).GetAwaiter().GetResult();
                #else
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            public System.String AssociationId { get; set; }
            public System.String ExecutionId { get; set; }
            public List<Amazon.SimpleSystemsManagement.Model.AssociationExecutionTargetsFilter> Filters { get; set; }
