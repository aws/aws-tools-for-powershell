...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMMaintenanceWindowTargets")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.MaintenanceWindowTarget")]
    [AWSCmdlet("Invokes the DescribeMaintenanceWindowTargets operation against Amazon Simple Systems Management.", Operation = new[] {"DescribeMaintenanceWindowTargets"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.MaintenanceWindowTarget",
        "This cmdlet returns a collection of MaintenanceWindowTarget objects.",
    ...
    public partial class GetSSMMaintenanceWindowTargetsCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Systems Management", "DescribeMaintenanceWindowTargets");
            #if DESKTOP
            return client.DescribeMaintenanceWindowTargets(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeMaintenanceWindowTargetsAsync(request);
            return task.Result;
            #else
