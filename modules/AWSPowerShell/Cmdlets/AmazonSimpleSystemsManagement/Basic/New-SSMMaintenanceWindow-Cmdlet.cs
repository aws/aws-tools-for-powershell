...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Systems Management CreateMaintenanceWindow API operation.", Operation = new[] {"CreateMaintenanceWindow"})]
    ...
    public partial class NewSSMMaintenanceWindowCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Systems Management", "CreateMaintenanceWindow");
            try
            {
                #if DESKTOP
