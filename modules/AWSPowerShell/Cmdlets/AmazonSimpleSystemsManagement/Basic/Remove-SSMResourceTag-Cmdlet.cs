...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the RemoveTagsFromResource operation against Amazon Simple Systems Management.", Operation = new[] {"RemoveTagsFromResource"})]
    ...
    public class RemoveSSMResourceTagCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.RemoveTagsFromResourceResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.RemoveTagsFromResourceRequest request)
        {
