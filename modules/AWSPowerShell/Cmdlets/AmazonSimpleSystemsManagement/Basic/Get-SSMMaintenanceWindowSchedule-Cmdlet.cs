...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    /// </summary>
    [Cmdlet("Get", "SSMMaintenanceWindowSchedule")]
    [OutputType("Amazon.SimpleSystemsManagement.Model.ScheduledWindowExecution")]
    [AWSCmdlet("Calls the AWS Systems Manager DescribeMaintenanceWindowSchedule API operation.", Operation = new[] {"DescribeMaintenanceWindowSchedule"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.ScheduledWindowExecution",
        "This cmdlet returns a collection of ScheduledWindowExecution objects.",
        "The service call response (type Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowScheduleResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack.",
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String)"
    )]
    public partial class GetSSMMaintenanceWindowScheduleCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowScheduleRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.ScheduledWindowExecutions;
                        ...
                        int _receivedThisCall = response.ScheduledWindowExecutions.Count;
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowScheduleResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeMaintenanceWindowScheduleRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DescribeMaintenanceWindowSchedule");
            try
            {
                #if DESKTOP
                return client.DescribeMaintenanceWindowSchedule(request);
                #elif CORECLR
                return client.DescribeMaintenanceWindowScheduleAsync(request).GetAwaiter().GetResult();
                #else
