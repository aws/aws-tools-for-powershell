...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the DescribeInstanceAssociationsStatus operation against Amazon Simple Systems Management.", Operation = new[] {"DescribeInstanceAssociationsStatus"})]
    ...
    public partial class GetSSMInstanceAssociationsStatusCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribeInstanceAssociationsStatusRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.InstanceAssociationStatusInfos;
                        ...
                        int _receivedThisCall = response.InstanceAssociationStatusInfos.Count;
        ...
        private static Amazon.SimpleSystemsManagement.Model.DescribeInstanceAssociationsStatusResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeInstanceAssociationsStatusRequest request)
        {
            ...
            var task = client.DescribeInstanceAssociationsStatusAsync(request);
            return task.Result;
            #else
