...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the DescribeAvailablePatches operation against Amazon Simple Systems Management.", Operation = new[] {"DescribeAvailablePatches"})]
    [AWSCmdletOutput("Amazon.SimpleSystemsManagement.Model.Patch",
        "This cmdlet returns a collection of Patch objects.",
    ...
    public partial class GetSSMAvailablePatchCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.DescribeAvailablePatchesResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeAvailablePatchesRequest request)
        {
            #if DESKTOP
            return client.DescribeAvailablePatches(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeAvailablePatchesAsync(request);
            return task.Result;
            #else
