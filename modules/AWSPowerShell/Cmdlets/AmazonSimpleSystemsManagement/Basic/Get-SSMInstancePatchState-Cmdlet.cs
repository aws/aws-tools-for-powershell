...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the DescribeInstancePatchStates operation against Amazon Simple Systems Management.", Operation = new[] {"DescribeInstancePatchStates"})]
    ...
    public partial class GetSSMInstancePatchStateCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.DescribeInstancePatchStatesResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeInstancePatchStatesRequest request)
        {
            #if DESKTOP
            return client.DescribeInstancePatchStates(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DescribeInstancePatchStatesAsync(request);
            return task.Result;
            #else
