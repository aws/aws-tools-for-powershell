...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the DeletePatchBaseline operation against Amazon Simple Systems Management.", Operation = new[] {"DeletePatchBaseline"})]
    ...
    public partial class RemoveSSMPatchBaselineCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SSMPatchBaseline (DeletePatchBaseline)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineRequest();
        ...
        private static Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DeletePatchBaselineRequest request)
        {
            #if DESKTOP
            return client.DeletePatchBaseline(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeletePatchBaselineAsync(request);
            return task.Result;
            #else
