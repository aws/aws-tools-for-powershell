...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager DeleteParameters API operation.", Operation = new[] {"DeleteParameters"})]
    ...
    public partial class RemoveSSMParameterCollectionCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "DeleteParameters");
            try
            {
                #if DESKTOP
                return client.DeleteParameters(request);
                #elif CORECLR
                return client.DeleteParametersAsync(request).GetAwaiter().GetResult();
                #else
