...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMParameterListCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.DescribeParametersResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribeParametersRequest request)
        {
            #if DESKTOP
