...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the ListCommands operation against Amazon Simple Systems Management.", Operation = new[] {"ListCommands"})]
    ...
    public partial class GetSSMCommandCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        int _receivedThisCall = response.Commands.Count;
        ...
        private Amazon.SimpleSystemsManagement.Model.ListCommandsResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.ListCommandsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Systems Management", "ListCommands");
            #if DESKTOP
            return client.ListCommands(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.ListCommandsAsync(request);
            return task.Result;
            #else
