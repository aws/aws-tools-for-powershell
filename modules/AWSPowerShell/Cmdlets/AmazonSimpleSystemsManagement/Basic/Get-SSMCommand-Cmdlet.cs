...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Calls the AWS Systems Manager ListCommands API operation.", Operation = new[] {"ListCommands"})]
    ...
    public partial class GetSSMCommandCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Systems Manager", "ListCommands");
            try
            {
                #if DESKTOP
                return client.ListCommands(request);
                #elif CORECLR
                return client.ListCommandsAsync(request).GetAwaiter().GetResult();
                #else
