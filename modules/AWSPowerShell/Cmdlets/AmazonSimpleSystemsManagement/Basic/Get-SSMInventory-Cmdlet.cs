...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    [AWSCmdlet("Invokes the GetInventory operation against Amazon Simple Systems Management.", Operation = new[] {"GetInventory"})]
    ...
    public partial class GetSSMInventoryCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleSystemsManagement.Model.GetInventoryResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.GetInventoryRequest request)
        {
            #if DESKTOP
            return client.GetInventory(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.GetInventoryAsync(request);
            return task.Result;
            #else
