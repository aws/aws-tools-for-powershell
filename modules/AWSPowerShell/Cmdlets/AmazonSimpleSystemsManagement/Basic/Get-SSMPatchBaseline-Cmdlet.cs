...
namespace Amazon.PowerShell.Cmdlets.SSM
{
    ...
    public partial class GetSSMPatchBaselineCmdlet : AmazonSimpleSystemsManagementClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// <para>
        /// <para>Each element in the array is a structure containing: </para><para>Key: (string, “NAME_PREFIX” or “OWNER”)</para><para>Value: (array of strings, exactly 1 entry, 1 ≤ length ≤ 255)</para>
        /// </para>
        /// </summary>
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.SimpleSystemsManagement.Model.DescribePatchBaselinesRequest();
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.BaselineIdentities;
        ...
        private Amazon.SimpleSystemsManagement.Model.DescribePatchBaselinesResponse CallAWSServiceOperation(IAmazonSimpleSystemsManagement client, Amazon.SimpleSystemsManagement.Model.DescribePatchBaselinesRequest request)
        {
            ...
            var task = client.DescribePatchBaselinesAsync(request);
            return task.Result;
            #else
