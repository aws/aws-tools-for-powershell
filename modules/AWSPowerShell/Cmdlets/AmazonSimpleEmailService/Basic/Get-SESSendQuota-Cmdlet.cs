...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service GetSendQuota API operation.", Operation = new[] {"GetSendQuota"})]
    ...
    public partial class GetSESSendQuotaCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        private Amazon.SimpleEmail.Model.GetSendQuotaResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.GetSendQuotaRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "GetSendQuota");
            try
            {
                #if DESKTOP
                return client.GetSendQuota(request);
                #elif CORECLR
                return client.GetSendQuotaAsync(request).GetAwaiter().GetResult();
                #else
