...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service GetCustomVerificationEmailTemplate API operation.", Operation = new[] {"GetCustomVerificationEmailTemplate"})]
    [AWSCmdletOutput("Amazon.SimpleEmail.Model.GetCustomVerificationEmailTemplateResponse",
        "This cmdlet returns a Amazon.SimpleEmail.Model.GetCustomVerificationEmailTemplateResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetSESCustomVerificationEmailTemplateCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "GetCustomVerificationEmailTemplate");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetCustomVerificationEmailTemplateAsync(request);
                return task.Result;
                #else
