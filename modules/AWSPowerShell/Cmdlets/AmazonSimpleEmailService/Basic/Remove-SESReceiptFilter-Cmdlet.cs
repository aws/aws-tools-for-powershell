...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    public partial class RemoveSESReceiptFilterCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleEmail.Model.DeleteReceiptFilterResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.DeleteReceiptFilterRequest request)
        {
            #if DESKTOP
            return client.DeleteReceiptFilter(request);
            #elif CORECLR
            // todo: handle AggregateException and extract true service exception for rethrow
            var task = client.DeleteReceiptFilterAsync(request);
            return task.Result;
            #else
