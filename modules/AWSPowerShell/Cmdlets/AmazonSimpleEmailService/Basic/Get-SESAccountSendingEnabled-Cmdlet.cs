...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service GetAccountSendingEnabled API operation.", Operation = new[] {"GetAccountSendingEnabled"})]
    ...
    public partial class GetSESAccountSendingEnabledCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.Enabled;
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "GetAccountSendingEnabled");
            try
            {
                #if DESKTOP
                ...
                var task = client.GetAccountSendingEnabledAsync(request);
                return task.Result;
                #else
