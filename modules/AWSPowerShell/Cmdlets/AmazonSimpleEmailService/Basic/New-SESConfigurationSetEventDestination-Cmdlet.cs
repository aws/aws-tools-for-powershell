...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service CreateConfigurationSetEventDestination API operation.", Operation = new[] {"CreateConfigurationSetEventDestination"})]
