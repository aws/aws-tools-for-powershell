...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Invokes the CreateConfigurationSetEventDestination operation against Amazon Simple Email Service.", Operation = new[] {"CreateConfigurationSetEventDestination"})]
    ...
    public partial class NewSESConfigurationSetEventDestinationCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.CreateConfigurationSetEventDestinationRequest request)
        {
            #if DESKTOP
