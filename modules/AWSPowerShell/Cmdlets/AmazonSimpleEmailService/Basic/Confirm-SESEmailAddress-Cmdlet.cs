...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service VerifyEmailAddress API operation.", Operation = new[] {"VerifyEmailAddress"})]
    ...
    public partial class ConfirmSESEmailAddressCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "VerifyEmailAddress");
            try
            {
                #if DESKTOP
                ...
                var task = client.VerifyEmailAddressAsync(request);
                return task.Result;
                #else
