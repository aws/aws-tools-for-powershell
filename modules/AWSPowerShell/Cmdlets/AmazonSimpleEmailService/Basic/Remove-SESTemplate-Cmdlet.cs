...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    public partial class RemoveSESTemplateCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-SESTemplate (DeleteTemplate)"))
            {
                return;
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.SimpleEmail.Model.DeleteTemplateRequest();
        ...
        private Amazon.SimpleEmail.Model.DeleteTemplateResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.DeleteTemplateRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "DeleteTemplate");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteTemplateAsync(request);
                return task.Result;
                #else
