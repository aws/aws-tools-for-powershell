...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Invokes the CreateConfigurationSetTrackingOptions operation against Amazon Simple Email Service.", Operation = new[] {"CreateConfigurationSetTrackingOptions"})]
