...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Invokes the SetIdentityMailFromDomain operation against Amazon Simple Email Service.", Operation = new[] {"SetIdentityMailFromDomain"})]
    ...
    public class SetSESIdentityMailFromDomainCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.SetIdentityMailFromDomain(request);
