...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service ListReceiptRuleSets API operation.", Operation = new[] {"ListReceiptRuleSets"}, LegacyAlias="Get-SESReceiptRuleSets")]
