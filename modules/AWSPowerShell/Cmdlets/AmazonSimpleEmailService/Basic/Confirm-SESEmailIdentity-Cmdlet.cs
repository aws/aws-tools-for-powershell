...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    public partial class ConfirmSESEmailIdentityCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleEmail.Model.VerifyEmailIdentityResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.VerifyEmailIdentityRequest request)
        {
            #if DESKTOP
