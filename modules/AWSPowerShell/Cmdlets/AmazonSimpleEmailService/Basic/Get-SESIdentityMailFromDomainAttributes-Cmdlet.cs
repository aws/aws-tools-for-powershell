...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet("Get", "SESIdentityMailFromDomainAttributes")]
    [OutputType("System.String")]
    [AWSCmdlet("Invokes the GetIdentityMailFromDomainAttributes operation against Amazon Simple Email Service.", Operation = new[] {"GetIdentityMailFromDomainAttributes"})]
    ...
    public class GetSESIdentityMailFromDomainAttributesCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                var response = client.GetIdentityMailFromDomainAttributes(request);
