...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Invokes the DeleteConfigurationSetTrackingOptions operation against Amazon Simple Email Service.", Operation = new[] {"DeleteConfigurationSetTrackingOptions"})]
    ...
    public partial class RemoveSESConfigurationSetTrackingOptionCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "DeleteConfigurationSetTrackingOptions");
            try
            {
                #if DESKTOP
                ...
                var task = client.DeleteConfigurationSetTrackingOptionsAsync(request);
                return task.Result;
                #else
