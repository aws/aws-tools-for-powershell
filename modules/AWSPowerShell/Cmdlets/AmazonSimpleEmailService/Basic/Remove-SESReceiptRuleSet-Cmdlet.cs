...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Invokes the DeleteReceiptRuleSet operation against Amazon Simple Email Service.", Operation = new[] {"DeleteReceiptRuleSet"})]
    [AWSCmdletOutput("None or System.String",
        ...
        "The service response (type Amazon.SimpleEmail.Model.DeleteReceiptRuleSetResponse) can be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public class RemoveSESReceiptRuleSetCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        private static Amazon.SimpleEmail.Model.DeleteReceiptRuleSetResponse CallAWSServiceOperation(IAmazonSimpleEmailService client, Amazon.SimpleEmail.Model.DeleteReceiptRuleSetRequest request)
        {
