...
namespace Amazon.PowerShell.Cmdlets.SES
{
    ...
    [AWSCmdlet("Calls the Amazon Simple Email Service DeleteReceiptRuleSet API operation.", Operation = new[] {"DeleteReceiptRuleSet"})]
    ...
    public partial class RemoveSESReceiptRuleSetCmdlet : AmazonSimpleEmailServiceClientCmdlet, IExecutor
    {
        ...
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon Simple Email Service", "DeleteReceiptRuleSet");
            try
            {
                #if DESKTOP
                return client.DeleteReceiptRuleSet(request);
                #elif CORECLR
                return client.DeleteReceiptRuleSetAsync(request).GetAwaiter().GetResult();
                #else
