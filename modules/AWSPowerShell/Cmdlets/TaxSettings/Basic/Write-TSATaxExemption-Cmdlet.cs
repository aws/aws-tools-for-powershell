...
namespace Amazon.PowerShell.Cmdlets.TSA
{
    ...
    public partial class WriteTSATaxExemptionCmdlet : AmazonTaxSettingsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the ExemptionType parameter.
        /// The -PassThru parameter is deprecated, use -Select '^ExemptionType' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^ExemptionType' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.ExemptionType;
            }
        ...
        private Amazon.TaxSettings.Model.PutTaxExemptionResponse CallAWSServiceOperation(IAmazonTaxSettings client, Amazon.TaxSettings.Model.PutTaxExemptionRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.PutTaxExemption(request);
                #elif CORECLR
                return client.PutTaxExemptionAsync(request).GetAwaiter().GetResult();
                #else
