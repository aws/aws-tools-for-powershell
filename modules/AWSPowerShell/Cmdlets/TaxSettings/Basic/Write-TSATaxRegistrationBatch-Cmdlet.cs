...
namespace Amazon.PowerShell.Cmdlets.TSA
{
    ...
    [AWSCmdletOutput("Amazon.TaxSettings.Model.BatchPutTaxRegistrationResponse",
        "This cmdlet returns an Amazon.TaxSettings.Model.BatchPutTaxRegistrationResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class WriteTSATaxRegistrationBatchCmdlet : AmazonTaxSettingsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the TaxRegistrationEntry_RegistrationId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^TaxRegistrationEntry_RegistrationId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^TaxRegistrationEntry_RegistrationId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.TaxRegistrationEntry_RegistrationId;
            }
        ...
        private Amazon.TaxSettings.Model.BatchPutTaxRegistrationResponse CallAWSServiceOperation(IAmazonTaxSettings client, Amazon.TaxSettings.Model.BatchPutTaxRegistrationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.BatchPutTaxRegistration(request);
                #elif CORECLR
                return client.BatchPutTaxRegistrationAsync(request).GetAwaiter().GetResult();
                #else
