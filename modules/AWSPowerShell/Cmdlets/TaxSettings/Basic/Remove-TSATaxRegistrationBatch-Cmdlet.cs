...
namespace Amazon.PowerShell.Cmdlets.TSA
{
    ...
    /// </para></note>
    /// </summary>
    [Cmdlet("Remove", "TSATaxRegistrationBatch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType("Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationError")]
    ...
    public partial class RemoveTSATaxRegistrationBatchCmdlet : AmazonTaxSettingsClientCmdlet, IExecutor
    {
        ...
        /// Specifying -Select '*' will result in the cmdlet returning the whole service response (Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationResponse).
        /// Specifying the name of a property of type Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationResponse will result in that property being returned.
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmShouldProceed(this.Force.IsPresent, resourceIdentifiersText, "Remove-TSATaxRegistrationBatch (BatchDeleteTaxRegistration)"))
            {
                return;
            }
            ...
            {
                context.Select = CreateSelectDelegate<Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationResponse, RemoveTSATaxRegistrationBatchCmdlet>(Select) ??
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationRequest();
        ...
        private Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationResponse CallAWSServiceOperation(IAmazonTaxSettings client, Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Tax Settings", "BatchDeleteTaxRegistration");
            try
            {
                return client.BatchDeleteTaxRegistrationAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
        ...
        internal partial class CmdletContext : ExecutorContext
        {
            ...
            public System.Func<Amazon.TaxSettings.Model.BatchDeleteTaxRegistrationResponse, RemoveTSATaxRegistrationBatchCmdlet, object> Select { get; set; } =
