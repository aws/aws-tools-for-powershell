...
namespace Amazon.PowerShell.Cmdlets.TSA
{
    ...
    /// IAM action is <c>tax:GetExemptions</c>.<br/><br/>This cmdlet automatically pages all available results to the pipeline - parameters related to iteration are only needed if you want to manually control the paginated output. To disable autopagination, use -NoAutoIteration. This cmdlet didn't autopaginate in V4, auto-pagination support was added in V5.
    /// </summary>
    ...
    public partial class GetTSATaxExemptionListCmdlet : AmazonTaxSettingsClientCmdlet, IExecutor
    {
        ...
        private Amazon.TaxSettings.Model.ListTaxExemptionsResponse CallAWSServiceOperation(IAmazonTaxSettings client, Amazon.TaxSettings.Model.ListTaxExemptionsRequest request)
        {
            ...
            try
            {
                return client.ListTaxExemptionsAsync(request, _cancellationTokenSource.Token).GetAwaiter().GetResult();
            }
