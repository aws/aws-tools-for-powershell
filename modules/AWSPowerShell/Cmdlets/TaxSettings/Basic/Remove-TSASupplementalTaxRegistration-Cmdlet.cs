...
namespace Amazon.PowerShell.Cmdlets.TSA
{
    ...
    public partial class RemoveTSASupplementalTaxRegistrationCmdlet : AmazonTaxSettingsClientCmdlet, IExecutor
    {
        ...
        /// <summary>
        /// Changes the cmdlet behavior to return the value passed to the AuthorityId parameter.
        /// The -PassThru parameter is deprecated, use -Select '^AuthorityId' instead. This parameter will be removed in a future version.
        /// </summary>
        [System.Obsolete("The -PassThru parameter is deprecated, use -Select '^AuthorityId' instead. This parameter will be removed in a future version.")]
        [System.Management.Automation.Parameter(ValueFromPipelineByPropertyName = true)]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.Select = (response, cmdlet) => this.AuthorityId;
            }
        ...
        private Amazon.TaxSettings.Model.DeleteSupplementalTaxRegistrationResponse CallAWSServiceOperation(IAmazonTaxSettings client, Amazon.TaxSettings.Model.DeleteSupplementalTaxRegistrationRequest request)
        {
            ...
            {
                #if DESKTOP
                return client.DeleteSupplementalTaxRegistration(request);
                #elif CORECLR
                return client.DeleteSupplementalTaxRegistrationAsync(request).GetAwaiter().GetResult();
                #else
