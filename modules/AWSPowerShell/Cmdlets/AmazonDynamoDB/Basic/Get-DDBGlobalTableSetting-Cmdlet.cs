...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB DescribeGlobalTableSettings API operation.", Operation = new[] {"DescribeGlobalTableSettings"})]
    [AWSCmdletOutput("Amazon.DynamoDBv2.Model.DescribeGlobalTableSettingsResponse",
        "This cmdlet returns a Amazon.DynamoDBv2.Model.DescribeGlobalTableSettingsResponse object containing multiple properties. The object can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetDDBGlobalTableSettingCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        private Amazon.DynamoDBv2.Model.DescribeGlobalTableSettingsResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.DescribeGlobalTableSettingsRequest request)
        {
            ...
            try
            {
                ...
                var task = client.DescribeGlobalTableSettingsAsync(request);
                return task.Result;
                #else
