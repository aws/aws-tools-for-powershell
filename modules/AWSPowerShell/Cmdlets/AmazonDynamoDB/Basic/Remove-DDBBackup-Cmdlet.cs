...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB DeleteBackup API operation.", Operation = new[] {"DeleteBackup"})]
    ...
    public partial class RemoveDDBBackupCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("BackupArn", MyInvocation.BoundParameters);
