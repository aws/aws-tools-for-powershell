...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdlet("Calls the Amazon DynamoDB DescribeEndpoints API operation.", Operation = new[] {"DescribeEndpoints"})]
    [AWSCmdletOutput("Amazon.DynamoDBv2.Model.Endpoint",
    ...
    public partial class GetDDBEndpointCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            // create request
            var request = new Amazon.DynamoDBv2.Model.DescribeEndpointsRequest();
        ...
        private Amazon.DynamoDBv2.Model.DescribeEndpointsResponse CallAWSServiceOperation(IAmazonDynamoDB client, Amazon.DynamoDBv2.Model.DescribeEndpointsRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "Amazon DynamoDB", "DescribeEndpoints");
            try
            {
                #if DESKTOP
