...
namespace Amazon.PowerShell.Cmdlets.DDB
{
    ...
    [AWSCmdletOutput("Amazon.DynamoDBv2.Model.GlobalTable",
        "This cmdlet returns a collection of GlobalTable objects.",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: LastEvaluatedGlobalTableName (type System.String)"
    )]
    public partial class GetDDBGlobalTableListCmdlet : AmazonDynamoDBClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            {
                _nextMarker = cmdletContext.ExclusiveStartGlobalTableName;
            }
            if (AutoIterationHelpers.HasValue(cmdletContext.Limit))
            {
                _emitLimit = cmdletContext.Limit;
            }
            bool _userControllingPaging = ParameterWasBound("ExclusiveStartGlobalTableName") || ParameterWasBound("Limit");
            ...
            try
            {
                do
                {
                    request.ExclusiveStartGlobalTableName = _nextMarker;
                    ...
                    try
                    {
                        ...
                        object pipelineOutput = response.GlobalTables;
                        notes = new Dictionary<string, object>();
                        notes["LastEvaluatedGlobalTableName"] = response.LastEvaluatedGlobalTableName;
                        ...
                        {
                            WriteProgressRecord("Retrieving", string.Format("Retrieved {0} records starting from marker '{1}'", _receivedThisCall, request.ExclusiveStartGlobalTableName));
                        }
                        
                        _nextMarker = response.LastEvaluatedGlobalTableName;
