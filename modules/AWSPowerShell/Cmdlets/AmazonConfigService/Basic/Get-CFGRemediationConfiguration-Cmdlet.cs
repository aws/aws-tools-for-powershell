...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config DescribeRemediationConfigurations API operation.", Operation = new[] {"DescribeRemediationConfigurations"})]
    [AWSCmdletOutput("Amazon.ConfigService.Model.RemediationConfiguration",
        "This cmdlet returns a collection of RemediationConfiguration objects.",
        "The service call response (type Amazon.ConfigService.Model.DescribeRemediationConfigurationsResponse) can also be referenced from properties attached to the cmdlet entry in the $AWSHistory stack."
    )]
    public partial class GetCFGRemediationConfigurationCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.RemediationConfigurations;
