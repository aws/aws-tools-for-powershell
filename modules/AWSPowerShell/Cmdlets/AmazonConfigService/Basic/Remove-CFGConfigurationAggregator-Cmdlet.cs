...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config DeleteConfigurationAggregator API operation.", Operation = new[] {"DeleteConfigurationAggregator"})]
    [AWSCmdletOutput("None or System.String",
        "When you use the PassThru parameter, this cmdlet outputs the value supplied to the ConfigurationAggregatorName parameter. Otherwise, this cmdlet does not return any output. " +
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                if (this.PassThru.IsPresent)
                    pipelineOutput = this.ConfigurationAggregatorName;
