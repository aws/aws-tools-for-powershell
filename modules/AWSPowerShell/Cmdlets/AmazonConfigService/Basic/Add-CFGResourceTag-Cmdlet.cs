...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config TagResource API operation.", Operation = new[] {"TagResource"})]
    ...
    public partial class AddCFGResourceTagCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.Tag != null)
            {
                context.Tags = new List<Amazon.ConfigService.Model.Tag>(this.Tag);
            }
        ...
        {
            public System.String ResourceArn { get; set; }
            public List<Amazon.ConfigService.Model.Tag> Tags { get; set; }
        }
