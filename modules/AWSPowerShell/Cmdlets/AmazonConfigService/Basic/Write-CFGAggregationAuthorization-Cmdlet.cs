...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config PutAggregationAuthorization API operation.", Operation = new[] {"PutAggregationAuthorization"})]
    [AWSCmdletOutput("Amazon.ConfigService.Model.AggregationAuthorization",
        "This cmdlet returns a AggregationAuthorization object.",
    ...
    public partial class WriteCFGAggregationAuthorizationCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            try
            {
                ...
                object pipelineOutput = response.AggregationAuthorization;
        ...
        private Amazon.ConfigService.Model.PutAggregationAuthorizationResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.PutAggregationAuthorizationRequest request)
        {
            ...
            try
            {
                ...
                var task = client.PutAggregationAuthorizationAsync(request);
                return task.Result;
                #else
