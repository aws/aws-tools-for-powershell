...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    [AWSCmdlet("Calls the AWS Config SelectResourceConfig API operation.", Operation = new[] {"SelectResourceConfig"})]
    [AWSCmdletOutput("System.String",
        ...
        "Additionally, the following properties are added as Note properties to the service response type instance for the cmdlet entry in the $AWSHistory stack: NextToken (type System.String), QueryInfo (type Amazon.ConfigService.Model.QueryInfo)"
    )]
    public partial class SelectCFGResourceConfigCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var resourceIdentifiersText = FormatParameterValuesForConfirmationMsg("Expression", MyInvocation.BoundParameters);
            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        notes["QueryInfo"] = response.QueryInfo;
