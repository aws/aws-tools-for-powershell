...
namespace Amazon.PowerShell.Cmdlets.CFG
{
    ...
    /// </summary>
    [Cmdlet("Get", "CFGResourceTag")]
    [OutputType("Amazon.ConfigService.Model.Tag")]
    [AWSCmdlet("Calls the AWS Config ListTagsForResource API operation.", Operation = new[] {"ListTagsForResource"})]
    [AWSCmdletOutput("Amazon.ConfigService.Model.Tag",
    ...
    public partial class GetCFGResourceTagCmdlet : AmazonConfigServiceClientCmdlet, IExecutor
    {
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            var request = new Amazon.ConfigService.Model.ListTagsForResourceRequest();
        ...
        private Amazon.ConfigService.Model.ListTagsForResourceResponse CallAWSServiceOperation(IAmazonConfigService client, Amazon.ConfigService.Model.ListTagsForResourceRequest request)
        {
            Utils.Common.WriteVerboseEndpointMessage(this, client.Config, "AWS Config", "ListTagsForResource");
            try
            {
                #if DESKTOP
