...
namespace Amazon.PowerShell.Cmdlets.FSX
{
    ...
    [AWSCmdlet("Calls the Amazon FSx DescribeFileSystems API operation.", Operation = new[] {"DescribeFileSystems"})]
    [AWSCmdletOutput("Amazon.FSx.Model.FileSystem",
        "This cmdlet returns a collection of FileSystem objects.",
    ...
    public partial class GetFSXFileSystemCmdlet : AmazonFSxClientCmdlet, IExecutor
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                context.FileSystemIds = new List<System.String>(this.FileSystemId);
            }
        ...
        public object Execute(ExecutorContext context)
        {
            ...
            if (cmdletContext.FileSystemIds != null)
            {
                request.FileSystemIds = cmdletContext.FileSystemIds;
            }
        ...
        {
            public List<System.String> FileSystemIds { get; set; }
