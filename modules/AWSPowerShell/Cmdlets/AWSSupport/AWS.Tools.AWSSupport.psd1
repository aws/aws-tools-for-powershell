#
# Module manifest for module 'AWS.Tools.AWSSupport'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.AWSSupport.dll'
    ...
    GUID = 'ef6dc104-1126-4de6-a7f1-bfe16e9b2799'
    ...
    Description = 'The AWSSupport module of AWS Tools for PowerShell lets developers and administrators manage AWS Support from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
# Assemblies that must be loaded prior to importing this module.
    ...
    FormatsToProcess = @(
        'AWS.Tools.AWSSupport.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.AWSSupport.Completers.psm1',
        'AWS.Tools.AWSSupport.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.AWSSupport.dll-Help.xml'
    )
