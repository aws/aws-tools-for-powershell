### 4.1.1032 (2026-06-02 00:49Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1252.1 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.1021 (2026-03-17 20:42Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1244.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Elastic MapReduce
...
### 4.1.1004 (2026-02-19 21:49Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1227.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Private CA Connector for SCEP
    * Modified cmdlet New-PCASCEPConnector: added parameter VpcEndpointId.

### 4.1.1003 (2026-02-18 21:43Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1226.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.1002 (2026-02-17 21:58Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1225.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Elastic Compute Cloud (EC2)
...
### 4.1.1001 (2026-02-16 21:56Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1224.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.991 (2026-02-02 21:12Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1214.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Bedrock Agent Core Control Plane Fronting Layer
...
### 4.1.990 (2026-01-30 21:27Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1213.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.987 (2026-01-27 21:36Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1210.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon AWSDeadlineCloud
...
### 4.1.982 (2026-01-20 22:00Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1205.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Auto Scaling
