...
### 5.0.304 (2026-09-22 19:07Z)
  ...
  * Amazon CloudWatch Observability Admin Service
    ...
    * Added cmdlet Get-CWOADMNDatasetIntegrationList leveraging the ListDatasetIntegrations service API.
    * Added cmdlet New-CWOADMNDatasetIntegration leveraging the CreateDatasetIntegration service API.
    * Added cmdlet Remove-CWOADMNDatasetIntegration leveraging the DeleteDatasetIntegration service API.
    * Added cmdlet Update-CWOADMNDatasetIntegration leveraging the UpdateDatasetIntegration service API.
    * Modified cmdlet New-CWOADMNCentralizationRuleForOrganization: added parameter Rule_Source_SourceContextGraphConfiguration.
    * Modified cmdlet Update-CWOADMNCentralizationRuleForOrganization: added parameter Rule_Source_SourceContextGraphConfiguration.
  * Amazon CloudWatch Omni. Added cmdlets to support the service. Cmdlets for the service have the noun prefix CWOM and can be listed using the command 'Get-AWSCmdletName -Service CWOM'.
  * Amazon Elastic Compute Cloud
    * Added cmdlet Get-EC2CapacityReservationDateChangeQuoteDetail leveraging the DescribeCapacityReservationDateChangeQuotes service API.
    * Added cmdlet New-EC2CapacityReservationDateChangeQuote leveraging the CreateCapacityReservationDateChangeQuote service API.
    * Modified cmdlet Edit-EC2CapacityReservation: added parameters AcceptModificationTerm, QuoteId and StartDate.
  * Amazon QuickSight
    * Modified cmdlet New-QSCustomPermission: added parameters Capabilities_AdobeAction, Capabilities_AirtableAction, Capabilities_BeeAction, Capabilities_CiscoWebexMeetingsAction, Capabilities_CiscoWebexVidcastAction, Capabilities_CreateAndUpdateAdobeAction, Capabilities_CreateAndUpdateAirtableAction, Capabilities_CreateAndUpdateBeeAction, Capabilities_CreateAndUpdateCiscoWebexMeetingsAction, Capabilities_CreateAndUpdateCiscoWebexVidcastAction, Capabilities_CreateAndUpdateDropboxAction, Capabilities_CreateAndUpdateDunAndBradstreetAction, Capabilities_CreateAndUpdateFigmaAction, Capabilities_CreateAndUpdateGmailAction, Capabilities_CreateAndUpdateGoogleAnalyticsAction, Capabilities_CreateAndUpdateGoogleChatAction, Capabilities_CreateAndUpdateGoogleDocsAction, Capabilities_CreateAndUpdateGoogleDriveAction, Capabilities_CreateAndUpdateGoogleMeetAction, Capabilities_CreateAndUpdateGoogleSheetsAction, Capabilities_CreateAndUpdateGoogleSlidesAction, Capabilities_CreateAndUpdateHGInsightsAction, Capabilities_CreateAndUpdateMoodysAction, Capabilities_CreateAndUpdateOneNoteAction, Capabilities_CreateAndUpdatePagerDutyAgentAction, Capabilities_CreateAndUpdateQuickBooksAction, Capabilities_CreateAndUpdateShopifyAction, Capabilities_CreateAndUpdateSnowFlakeAction, Capabilities_CreateAndUpdateVisierAgentAction, Capabilities_CreateAndUpdateWhatsAppAction, Capabilities_CreateAndUpdateZapierAction, Capabilities_CreateAndUpdateZoomAction, Capabilities_CreateAndUpdateZoomInfoAction, Capabilities_DropboxAction, Capabilities_DunAndBradstreetAction, Capabilities_FigmaAction, Capabilities_GmailAction, Capabilities_GoogleAnalyticsAction, Capabilities_GoogleChatAction, Capabilities_GoogleDocsAction, Capabilities_GoogleDriveAction, Capabilities_GoogleMeetAction, Capabilities_GoogleSheetsAction, Capabilities_GoogleSlidesAction, Capabilities_HGInsightsAction, Capabilities_MoodysAction, Capabilities_OneNoteAction, Capabilities_PagerDutyAgentAction, Capabilities_QuickBooksAction, Capabilities_ShareAdobeAction, Capabilities_ShareAirtableAction, Capabilities_ShareBeeAction, Capabilities_ShareCiscoWebexMeetingsAction, Capabilities_ShareCiscoWebexVidcastAction, Capabilities_ShareDropboxAction, Capabilities_ShareDunAndBradstreetAction, Capabilities_ShareFigmaAction, Capabilities_ShareGmailAction, Capabilities_ShareGoogleAnalyticsAction, Capabilities_ShareGoogleChatAction, Capabilities_ShareGoogleDocsAction, Capabilities_ShareGoogleDriveAction, Capabilities_ShareGoogleMeetAction, Capabilities_ShareGoogleSheetsAction, Capabilities_ShareGoogleSlidesAction, Capabilities_ShareHGInsightsAction, Capabilities_ShareMoodysAction, Capabilities_ShareOneNoteAction, Capabilities_SharePagerDutyAgentAction, Capabilities_ShareQuickBooksAction, Capabilities_ShareShopifyAction, Capabilities_ShareSnowFlakeAction, Capabilities_ShareVisierAgentAction, Capabilities_ShareWhatsAppAction, Capabilities_ShareZapierAction, Capabilities_ShareZoomAction, Capabilities_ShareZoomInfoAction, Capabilities_ShopifyAction, Capabilities_SnowFlakeAction, Capabilities_UseAdobeAction, Capabilities_UseAirtableAction, Capabilities_UseBeeAction, Capabilities_UseCiscoWebexMeetingsAction, Capabilities_UseCiscoWebexVidcastAction, Capabilities_UseDropboxAction, Capabilities_UseDunAndBradstreetAction, Capabilities_UseFigmaAction, Capabilities_UseGmailAction, Capabilities_UseGoogleAnalyticsAction, Capabilities_UseGoogleChatAction, Capabilities_UseGoogleDocsAction, Capabilities_UseGoogleDriveAction, Capabilities_UseGoogleMeetAction, Capabilities_UseGoogleSheetsAction, Capabilities_UseGoogleSlidesAction, Capabilities_UseHGInsightsAction, Capabilities_UseMoodysAction, Capabilities_UseOneNoteAction, Capabilities_UsePagerDutyAgentAction, Capabilities_UseQuickBooksAction, Capabilities_UseShopifyAction, Capabilities_UseSnowFlakeAction, Capabilities_UseVisierAgentAction, Capabilities_UseWhatsAppAction, Capabilities_UseZapierAction, Capabilities_UseZoomAction, Capabilities_UseZoomInfoAction, Capabilities_VisierAgentAction, Capabilities_WhatsAppAction, Capabilities_ZapierAction, Capabilities_ZoomAction and Capabilities_ZoomInfoAction.
    * Modified cmdlet Update-QSCustomPermission: added parameters Capabilities_AdobeAction, Capabilities_AirtableAction, Capabilities_BeeAction, Capabilities_CiscoWebexMeetingsAction, Capabilities_CiscoWebexVidcastAction, Capabilities_CreateAndUpdateAdobeAction, Capabilities_CreateAndUpdateAirtableAction, Capabilities_CreateAndUpdateBeeAction, Capabilities_CreateAndUpdateCiscoWebexMeetingsAction, Capabilities_CreateAndUpdateCiscoWebexVidcastAction, Capabilities_CreateAndUpdateDropboxAction, Capabilities_CreateAndUpdateDunAndBradstreetAction, Capabilities_CreateAndUpdateFigmaAction, Capabilities_CreateAndUpdateGmailAction, Capabilities_CreateAndUpdateGoogleAnalyticsAction, Capabilities_CreateAndUpdateGoogleChatAction, Capabilities_CreateAndUpdateGoogleDocsAction, Capabilities_CreateAndUpdateGoogleDriveAction, Capabilities_CreateAndUpdateGoogleMeetAction, Capabilities_CreateAndUpdateGoogleSheetsAction, Capabilities_CreateAndUpdateGoogleSlidesAction, Capabilities_CreateAndUpdateHGInsightsAction, Capabilities_CreateAndUpdateMoodysAction, Capabilities_CreateAndUpdateOneNoteAction, Capabilities_CreateAndUpdatePagerDutyAgentAction, Capabilities_CreateAndUpdateQuickBooksAction, Capabilities_CreateAndUpdateShopifyAction, Capabilities_CreateAndUpdateSnowFlakeAction, Capabilities_CreateAndUpdateVisierAgentAction, Capabilities_CreateAndUpdateWhatsAppAction, Capabilities_CreateAndUpdateZapierAction, Capabilities_CreateAndUpdateZoomAction, Capabilities_CreateAndUpdateZoomInfoAction, Capabilities_DropboxAction, Capabilities_DunAndBradstreetAction, Capabilities_FigmaAction, Capabilities_GmailAction, Capabilities_GoogleAnalyticsAction, Capabilities_GoogleChatAction, Capabilities_GoogleDocsAction, Capabilities_GoogleDriveAction, Capabilities_GoogleMeetAction, Capabilities_GoogleSheetsAction, Capabilities_GoogleSlidesAction, Capabilities_HGInsightsAction, Capabilities_MoodysAction, Capabilities_OneNoteAction, Capabilities_PagerDutyAgentAction, Capabilities_QuickBooksAction, Capabilities_ShareAdobeAction, Capabilities_ShareAirtableAction, Capabilities_ShareBeeAction, Capabilities_ShareCiscoWebexMeetingsAction, Capabilities_ShareCiscoWebexVidcastAction, Capabilities_ShareDropboxAction, Capabilities_ShareDunAndBradstreetAction, Capabilities_ShareFigmaAction, Capabilities_ShareGmailAction, Capabilities_ShareGoogleAnalyticsAction, Capabilities_ShareGoogleChatAction, Capabilities_ShareGoogleDocsAction, Capabilities_ShareGoogleDriveAction, Capabilities_ShareGoogleMeetAction, Capabilities_ShareGoogleSheetsAction, Capabilities_ShareGoogleSlidesAction, Capabilities_ShareHGInsightsAction, Capabilities_ShareMoodysAction, Capabilities_ShareOneNoteAction, Capabilities_SharePagerDutyAgentAction, Capabilities_ShareQuickBooksAction, Capabilities_ShareShopifyAction, Capabilities_ShareSnowFlakeAction, Capabilities_ShareVisierAgentAction, Capabilities_ShareWhatsAppAction, Capabilities_ShareZapierAction, Capabilities_ShareZoomAction, Capabilities_ShareZoomInfoAction, Capabilities_ShopifyAction, Capabilities_SnowFlakeAction, Capabilities_UseAdobeAction, Capabilities_UseAirtableAction, Capabilities_UseBeeAction, Capabilities_UseCiscoWebexMeetingsAction, Capabilities_UseCiscoWebexVidcastAction, Capabilities_UseDropboxAction, Capabilities_UseDunAndBradstreetAction, Capabilities_UseFigmaAction, Capabilities_UseGmailAction, Capabilities_UseGoogleAnalyticsAction, Capabilities_UseGoogleChatAction, Capabilities_UseGoogleDocsAction, Capabilities_UseGoogleDriveAction, Capabilities_UseGoogleMeetAction, Capabilities_UseGoogleSheetsAction, Capabilities_UseGoogleSlidesAction, Capabilities_UseHGInsightsAction, Capabilities_UseMoodysAction, Capabilities_UseOneNoteAction, Capabilities_UsePagerDutyAgentAction, Capabilities_UseQuickBooksAction, Capabilities_UseShopifyAction, Capabilities_UseSnowFlakeAction, Capabilities_UseVisierAgentAction, Capabilities_UseWhatsAppAction, Capabilities_UseZapierAction, Capabilities_UseZoomAction, Capabilities_UseZoomInfoAction, Capabilities_VisierAgentAction, Capabilities_WhatsAppAction, Capabilities_ZapierAction, Capabilities_ZoomAction and Capabilities_ZoomInfoAction.
...
### 5.0.236 (2026-06-17 19:35Z)
  ...
  * Amazon Agents for Amazon Bedrock
    ...
    * Added cmdlet Remove-AABResourcePolicy leveraging the DeleteResourcePolicy service API.
    * Added cmdlet Write-AABResourcePolicy leveraging the PutResourcePolicy service API.
    * Modified cmdlet New-AABDataSource: added parameters DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_ConnectorParameter, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_DeletionProtectionConfiguration_DeletionProtectionStatus, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_DeletionProtectionConfiguration_DeletionProtectionThreshold, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_AudioExtractionConfiguration_AudioExtractionStatus, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_ImageExtractionConfiguration_ImageExtractionStatus and DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_VideoExtractionConfiguration_VideoExtractionStatus.
    * Modified cmdlet New-AABKnowledgeBase: added parameters KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelArn, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Audio, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Dimension, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_EmbeddingDataType, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Video, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelType and KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_ServerSideEncryptionConfiguration_KmsKeyArn.
    * Modified cmdlet Update-AABDataSource: added parameters DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_ConnectorParameter, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_DeletionProtectionConfiguration_DeletionProtectionStatus, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_DeletionProtectionConfiguration_DeletionProtectionThreshold, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_AudioExtractionConfiguration_AudioExtractionStatus, DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_ImageExtractionConfiguration_ImageExtractionStatus and DataSourceConfiguration_ManagedKnowledgeBaseConnectorConfiguration_MediaExtractionConfiguration_VideoExtractionConfiguration_VideoExtractionStatus.
    * Modified cmdlet Update-AABKnowledgeBase: added parameters KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelArn, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Audio, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Dimension, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_EmbeddingDataType, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelConfiguration_BedrockEmbeddingModelConfiguration_Video, KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_EmbeddingModelType and KnowledgeBaseConfiguration_ManagedKnowledgeBaseConfiguration_ServerSideEncryptionConfiguration_KmsKeyArn.
  * Amazon Bedrock Agent Core Control Plane Fronting Layer
    * Added cmdlet Get-BACCHarnessEndpoint leveraging the GetHarnessEndpoint service API.
    * Added cmdlet Get-BACCHarnessEndpointList leveraging the ListHarnessEndpoints service API.
    * Added cmdlet Get-BACCHarnessVersionList leveraging the ListHarnessVersions service API.
    * Added cmdlet New-BACCHarnessEndpoint leveraging the CreateHarnessEndpoint service API.
    * Added cmdlet Remove-BACCHarnessEndpoint leveraging the DeleteHarnessEndpoint service API.
    * Added cmdlet Update-BACCHarnessEndpoint leveraging the UpdateHarnessEndpoint service API.
    * Modified cmdlet Get-BACCHarness: added parameter HarnessVersion.
    * Modified cmdlet New-BACCAgentRuntime: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet New-BACCGateway: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet New-BACCGatewayTarget: added parameters TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_InlinePayload, TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_S3_BucketOwnerAccountId, TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_S3_Uri, TargetConfiguration_Http_Passthrough_Endpoint, TargetConfiguration_Http_Passthrough_ProtocolType, TargetConfiguration_Http_Passthrough_Schema_Source_InlinePayload, TargetConfiguration_Http_Passthrough_Schema_Source_S3_BucketOwnerAccountId, TargetConfiguration_Http_Passthrough_Schema_Source_S3_Uri, TargetConfiguration_Http_Passthrough_StickinessConfiguration_Identifier, TargetConfiguration_Http_Passthrough_StickinessConfiguration_Timeout, TargetConfiguration_Inference_Connector_Source_ConnectorId, TargetConfiguration_Inference_Provider_Endpoint, TargetConfiguration_Inference_Provider_ModelMapping_ProviderPrefix_Separator, TargetConfiguration_Inference_Provider_ModelMapping_ProviderPrefix_Strip, TargetConfiguration_Inference_Provider_Operation, TargetConfiguration_Mcp_Connector_Configuration, TargetConfiguration_Mcp_Connector_Enabled and TargetConfiguration_Mcp_Connector_Source_ConnectorId.
    * Modified cmdlet New-BACCHarness: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment, AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity, Memory_Disabled, Memory_ManagedMemoryConfiguration_Arn, Memory_ManagedMemoryConfiguration_EncryptionKeyArn, Memory_ManagedMemoryConfiguration_EventExpiryDuration and Memory_ManagedMemoryConfiguration_Strategy.
    * Modified cmdlet New-BACCPaymentManager: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet New-BACCPolicy: added parameters Definition_Policy_Statement and EnforcementMode.
    * Modified cmdlet New-BACCRegistry: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet Remove-BACCHarness: added parameter DeleteManagedMemory.
    * Modified cmdlet Update-BACCAgentRuntime: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet Update-BACCGateway: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment, AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity, CustomTransformConfiguration_Lambda_Arn and WafConfiguration_FailureMode.
    * Modified cmdlet Update-BACCGatewayTarget: added parameters TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_InlinePayload, TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_S3_BucketOwnerAccountId, TargetConfiguration_Http_AgentcoreRuntime_Schema_Source_S3_Uri, TargetConfiguration_Http_Passthrough_Endpoint, TargetConfiguration_Http_Passthrough_ProtocolType, TargetConfiguration_Http_Passthrough_Schema_Source_InlinePayload, TargetConfiguration_Http_Passthrough_Schema_Source_S3_BucketOwnerAccountId, TargetConfiguration_Http_Passthrough_Schema_Source_S3_Uri, TargetConfiguration_Http_Passthrough_StickinessConfiguration_Identifier, TargetConfiguration_Http_Passthrough_StickinessConfiguration_Timeout, TargetConfiguration_Inference_Connector_Source_ConnectorId, TargetConfiguration_Inference_Provider_Endpoint, TargetConfiguration_Inference_Provider_ModelMapping_ProviderPrefix_Separator, TargetConfiguration_Inference_Provider_ModelMapping_ProviderPrefix_Strip, TargetConfiguration_Inference_Provider_Operation, TargetConfiguration_Mcp_Connector_Configuration, TargetConfiguration_Mcp_Connector_Enabled and TargetConfiguration_Mcp_Connector_Source_ConnectorId.
    * Modified cmdlet Update-BACCHarness: added parameters AuthorizerConfiguration_OptionalValue_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment, AuthorizerConfiguration_OptionalValue_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity, Memory_OptionalValue_Disabled, Memory_OptionalValue_ManagedMemoryConfiguration_Arn, Memory_OptionalValue_ManagedMemoryConfiguration_EncryptionKeyArn, Memory_OptionalValue_ManagedMemoryConfiguration_EventExpiryDuration and Memory_OptionalValue_ManagedMemoryConfiguration_Strategy.
    * Modified cmdlet Update-BACCPaymentManager: added parameters AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
    * Modified cmdlet Update-BACCPolicy: added parameters Definition_Policy_Statement and EnforcementMode.
    * Modified cmdlet Update-BACCRegistry: added parameters AuthorizerConfiguration_OptionalValue_CustomJWTAuthorizer_AllowedWorkloadConfiguration_HostingEnvironment and AuthorizerConfiguration_OptionalValue_CustomJWTAuthorizer_AllowedWorkloadConfiguration_WorkloadIdentity.
  * Amazon Bedrock Agent Runtime
    * Added cmdlet Get-BARDocumentContent leveraging the GetDocumentContent service API.
    * Added cmdlet Invoke-BARAgenticRetrieveStream leveraging the AgenticRetrieveStream service API.
    * Modified cmdlet Invoke-BARRetrieve: added parameters RetrievalConfiguration_ManagedSearchConfiguration_Filter_AndAll, RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_OrAll, RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Value, RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Key, RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Value, RetrievalConfiguration_ManagedSearchConfiguration_NumberOfResult, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectionMode, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToExclude, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToInclude, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_AdditionalModelRequestField, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_ModelArn, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_NumberOfRerankedResult, RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_Type, RetrievalConfiguration_ManagedSearchConfiguration_RerankingModelType and UserContext_UserId.
    * Modified cmdlet Invoke-BARRetrieveAndGenerate: added parameters RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_AndAll, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_OrAll, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_NumberOfResult, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectionMode, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToExclude, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToInclude, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_AdditionalModelRequestField, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_ModelArn, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_NumberOfRerankedResult, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_Type, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingModelType and UserContext_UserId.
    * Modified cmdlet Invoke-BARRetrieveAndGenerateStream: added parameters RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_AndAll, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_Equals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThan_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_GreaterThanOrEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_In_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThan_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_LessThanOrEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_ListContains_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotEquals_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_NotIn_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_OrAll, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StartsWith_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Key, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_Filter_StringContains_Value, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_NumberOfResult, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectionMode, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToExclude, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_MetadataConfiguration_SelectiveModeConfiguration_FieldsToInclude, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_AdditionalModelRequestField, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_ModelConfiguration_ModelArn, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_BedrockRerankingConfiguration_NumberOfRerankedResult, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingConfiguration_Type, RetrieveAndGenerateConfiguration_KnowledgeBaseConfiguration_RetrievalConfiguration_ManagedSearchConfiguration_RerankingModelType and UserContext_UserId.
  * Amazon Bedrock AgentCore Data Plane Fronting Layer
    * Modified cmdlet Invoke-BACHarness: added parameter Qualifier.
    * [Breaking Change] Modified cmdlet Start-BACBatchEvaluation: removed parameters DataSourceConfig_OnlineEvaluationConfigSource_SessionFilterConfig_EndTime and DataSourceConfig_OnlineEvaluationConfigSource_SessionFilterConfig_StartTime; added parameters DataSourceConfig_OnlineEvaluationConfigSource_TimeRange_EndTime and DataSourceConfig_OnlineEvaluationConfigSource_TimeRange_StartTime.
  * Amazon DevOps Agent Service
    * Modified cmdlet Add-DOPSService: added parameters Capability, Configuration_Github_RuntimeRoleArn, Configuration_Gitlab_RuntimeRoleArn, Configuration_Remoteagent and Configuration_Remoteagentsigv4.
    * Modified cmdlet New-DOPSAsset: added parameter Content_SourceUrl_Url.
    * Modified cmdlet Register-DOPSService: added parameters ServiceDetails_Remoteagent_AuthorizationConfig_ApiKey_ApiKeyHeader, ServiceDetails_Remoteagent_AuthorizationConfig_ApiKey_ApiKeyName, ServiceDetails_Remoteagent_AuthorizationConfig_ApiKey_ApiKeyValue, ServiceDetails_Remoteagent_AuthorizationConfig_BearerToken_AuthorizationHeader, ServiceDetails_Remoteagent_AuthorizationConfig_BearerToken_TokenName, ServiceDetails_Remoteagent_AuthorizationConfig_BearerToken_TokenValue, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_ClientId, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_ClientName, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_ClientSecret, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_ExchangeParameter, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_ExchangeUrl, ServiceDetails_Remoteagent_AuthorizationConfig_OAuthClientCredentials_Scope, ServiceDetails_Remoteagent_Description, ServiceDetails_Remoteagent_Endpoint, ServiceDetails_Remoteagent_Name, ServiceDetails_Remoteagentsigv4_AuthorizationConfig_Region, ServiceDetails_Remoteagentsigv4_AuthorizationConfig_RoleArn, ServiceDetails_Remoteagentsigv4_AuthorizationConfig_Service, ServiceDetails_Remoteagentsigv4_Description, ServiceDetails_Remoteagentsigv4_Endpoint and ServiceDetails_Remoteagentsigv4_Name.
    * Modified cmdlet Update-DOPSAsset: added parameter Content_SourceUrl_Url.
    * Modified cmdlet Update-DOPSAssociation: added parameters Capability, Configuration_Github_RuntimeRoleArn, Configuration_Gitlab_RuntimeRoleArn, Configuration_Remoteagent and Configuration_Remoteagentsigv4.
  * Amazon EC2 Container Service
    * Modified cmdlet New-ECSExpressGatewayService: added parameter TaskDefinitionArn.
    * Modified cmdlet Update-ECSExpressGatewayService: added parameter TaskDefinitionArn.
  * Amazon Glue
    * Added cmdlet Add-GLUEGlossaryTerm leveraging the AssociateGlossaryTerms service API.
    * Added cmdlet Get-GLUEAsset leveraging the GetAsset service API.
    * Added cmdlet Get-GLUEAssetType leveraging the GetAssetType service API.
    * Added cmdlet Get-GLUEAssetTypeList leveraging the ListAssetTypes service API.
    * Added cmdlet Get-GLUEFormType leveraging the GetFormType service API.
    * Added cmdlet Get-GLUEFormTypeList leveraging the ListFormTypes service API.
    * Added cmdlet Get-GLUEGlossary leveraging the GetGlossary service API.
    * Added cmdlet Get-GLUEGlossaryList leveraging the ListGlossaries service API.
    * Added cmdlet Get-GLUEGlossaryTerm leveraging the GetGlossaryTerm service API.
    * Added cmdlet Get-GLUEGlossaryTermList leveraging the ListGlossaryTerms service API.
    * Added cmdlet Get-GLUEIterableFormBatch leveraging the BatchGetIterableForms service API.
    * Added cmdlet Get-GLUEIterableFormList leveraging the ListIterableForms service API.
    * Added cmdlet Invoke-GLUESearch leveraging the Search service API.
    * Added cmdlet New-GLUEGlossary leveraging the CreateGlossary service API.
    * Added cmdlet New-GLUEGlossaryTerm leveraging the CreateGlossaryTerm service API.
    * Added cmdlet Remove-GLUEAsset leveraging the DeleteAsset service API.
    * Added cmdlet Remove-GLUEAssetType leveraging the DeleteAssetType service API.
    * Added cmdlet Remove-GLUEAttachment leveraging the DeleteAttachment service API.
    * Added cmdlet Remove-GLUEFormType leveraging the DeleteFormType service API.
    * Added cmdlet Remove-GLUEGlossary leveraging the DeleteGlossary service API.
    * Added cmdlet Remove-GLUEGlossaryTerm leveraging the DeleteGlossaryTerm service API.
    * Added cmdlet Unregister-GLUEGlossaryTerm leveraging the DisassociateGlossaryTerms service API.
    * Added cmdlet Update-GLUEGlossary leveraging the UpdateGlossary service API.
    * Added cmdlet Update-GLUEGlossaryTerm leveraging the UpdateGlossaryTerm service API.
    * Added cmdlet Write-GLUEAsset leveraging the PutAsset service API.
    * Added cmdlet Write-GLUEAssetType leveraging the PutAssetType service API.
    * Added cmdlet Write-GLUEAttachment leveraging the PutAttachment service API.
    * Added cmdlet Write-GLUEFormType leveraging the PutFormType service API.
  * Amazon MQ
    * Added cmdlet Get-MQSharedResourceDetail leveraging the DescribeSharedResources service API.
    * Modified cmdlet Update-MQBroker: added parameter ResourceShareArn.
  * Amazon OpenSearch Service
    * Modified cmdlet Update-OSApplication: added parameters IamIdentityCenterOptions_Enabled, IamIdentityCenterOptions_IamIdentityCenterInstanceArn and IamIdentityCenterOptions_IamRoleForIdentityCenterApplicationArn.
  * Amazon Security Agent
    * Added cmdlet Get-SECAGPrivateConnectionDetail leveraging the DescribePrivateConnection service API.
    * Added cmdlet Get-SECAGPrivateConnectionList leveraging the ListPrivateConnections service API.
    * Added cmdlet Get-SECAGSecurityRequirementBatch leveraging the BatchGetSecurityRequirements service API.
    * Added cmdlet Get-SECAGSecurityRequirementList leveraging the ListSecurityRequirements service API.
    * Added cmdlet Get-SECAGSecurityRequirementPack leveraging the GetSecurityRequirementPack service API.
    * Added cmdlet Get-SECAGSecurityRequirementPackList leveraging the ListSecurityRequirementPacks service API.
    * Added cmdlet Get-SECAGThreatBatch leveraging the BatchGetThreats service API.
    * Added cmdlet Get-SECAGThreatList leveraging the ListThreats service API.
    * Added cmdlet Get-SECAGThreatModelBatch leveraging the BatchGetThreatModels service API.
    * Added cmdlet Get-SECAGThreatModelJobBatch leveraging the BatchGetThreatModelJobs service API.
    * Added cmdlet Get-SECAGThreatModelJobList leveraging the ListThreatModelJobs service API.
    * Added cmdlet Get-SECAGThreatModelJobTaskBatch leveraging the BatchGetThreatModelJobTasks service API.
    * Added cmdlet Get-SECAGThreatModelJobTaskList leveraging the ListThreatModelJobTasks service API.
    * Added cmdlet Get-SECAGThreatModelList leveraging the ListThreatModels service API.
    * Added cmdlet Import-SECAGSecurityRequirement leveraging the ImportSecurityRequirements service API.
    * Added cmdlet New-SECAGPrivateConnection leveraging the CreatePrivateConnection service API.
    * Added cmdlet New-SECAGSecurityRequirementBatch leveraging the BatchCreateSecurityRequirements service API.
    * Added cmdlet New-SECAGSecurityRequirementPack leveraging the CreateSecurityRequirementPack service API.
    * Added cmdlet New-SECAGThreat leveraging the CreateThreat service API.
    * Added cmdlet New-SECAGThreatModel leveraging the CreateThreatModel service API.
    * Added cmdlet Remove-SECAGPrivateConnection leveraging the DeletePrivateConnection service API.
    * Added cmdlet Remove-SECAGSecurityRequirementBatch leveraging the BatchDeleteSecurityRequirements service API.
    * Added cmdlet Remove-SECAGSecurityRequirementPack leveraging the DeleteSecurityRequirementPack service API.
    * Added cmdlet Remove-SECAGThreatModelBatch leveraging the BatchDeleteThreatModels service API.
    * Added cmdlet Start-SECAGThreatModelJob leveraging the StartThreatModelJob service API.
    * Added cmdlet Stop-SECAGThreatModelJob leveraging the StopThreatModelJob service API.
    * Added cmdlet Update-SECAGPrivateConnectionCertificate leveraging the UpdatePrivateConnectionCertificate service API.
    * Added cmdlet Update-SECAGSecurityRequirementBatch leveraging the BatchUpdateSecurityRequirements service API.
    * Added cmdlet Update-SECAGSecurityRequirementPack leveraging the UpdateSecurityRequirementPack service API.
    * Added cmdlet Update-SECAGThreat leveraging the UpdateThreat service API.
    * Added cmdlet Update-SECAGThreatModel leveraging the UpdateThreatModel service API.
    * Modified cmdlet New-SECAGCodeReview: added parameter ValidationMode.
    * Modified cmdlet New-SECAGIntegration: added parameters Input_Bitbucket_Code, Input_Bitbucket_InstallationId, Input_Bitbucket_State, Input_Bitbucket_Workspace, Input_Confluence_Code, Input_Confluence_InstallationId, Input_Confluence_SiteUrl, Input_Confluence_State, Input_Github_InstallationId, Input_Github_TargetUrl, Input_Gitlab_AccessToken, Input_Gitlab_GroupId, Input_Gitlab_TargetUrl, Input_Gitlab_TokenType and PrivateConnectionName.
    * Modified cmdlet New-SECAGPentest: added parameter DisableManagedSkill.
    * Modified cmdlet Start-SECAGCodeReviewJob: added parameter DiffSource_S3Uri.
    * Modified cmdlet Update-SECAGCodeReview: added parameter ValidationMode.
    * Modified cmdlet Update-SECAGFinding: added parameters AttackScript, CustomerNote, Description, Name, Reasoning, RiskScore and RiskType.
    * Modified cmdlet Update-SECAGPentest: added parameter DisableManagedSkill.
