...
### 4.1.967 (2025-12-22 21:19Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1190.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.962 (2025-12-15 21:00Z)
  ...
  * Amazon CloudWatch Logs
    ...
    * Modified cmdlet Get-CWLAggregateLogGroupSummaryList: added parameter NoAutoIteration.
  * Amazon Connect Service
...
### 4.1.959 (2025-12-11 01:25Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1182.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.952 (2025-12-01 03:47Z)
  ...
  * Amazon AppIntegrations Service
    * Modified cmdlet Get-AISApplicationList: added parameters ApplicationType and PassThru.
  ...
  * Amazon Bedrock Agent Runtime
    * Modified cmdlet Invoke-BARRetrieve: added parameters Image_Format, Image_InlineContent and RetrievalQuery_Type.
  * Amazon Clean Rooms Service
...
### 4.1.951 (2025-11-26 21:10Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1174.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
...
### 4.1.948 (2025-11-22 00:34Z)
  ...
  * Amazon Oracle Database@Amazon Web Services
    ...
    * Modified cmdlet Initialize-ODBService: added parameters OciIdentityDomain and PassThru.
...
### 4.1.945 (2025-11-19 01:02Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1168.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Auto Scaling
...
### 4.1.941 (2025-11-12 22:00Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1164.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Connect Service
...
### 4.1.940 (2025-11-11 21:06Z)
  * AWS Tools for PowerShell now use AWS .NET SDK 3.7.1163.0 and leverage its new features and improvements. Please find a description of the changes at https://github.com/aws/aws-sdk-net/blob/aws-sdk-net-v3.7/changelogs/SDK.CHANGELOG.ALL.md.
  * Amazon Data Automation for Amazon Bedrock
...
### 4.1.932 (2025-10-30 21:26Z)
  ...
  * Amazon Glue
    ...
    * Modified cmdlet Update-GLUEGlueIdentityCenterConfiguration: added parameters PassThru and UserBackgroundSessionsEnabled.
